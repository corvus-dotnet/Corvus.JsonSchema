    ...
    public readonly partial struct Opentelemetry
    {
        ...
        public readonly partial struct Exporters
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredHostAndNameArray.Mutable Otlp
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OtlpUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredHostAndNameArray.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredNameArray.Mutable Prometheus
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PrometheusUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredNameArray.Mutable value))
                        {
                            return value;
                        }
                ...
                /// <summary>
                /// Set the <c>otlp</c> property.
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetOtlp(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredHostAndNameArray.Source value)
                {
                    CheckValidInstance();

                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.OtlpUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OtlpUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                    ...
                    else
                    {
                        ...
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Otlp, ref cvb);
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetOtlp<TContext>(in Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredHostAndNameArray.Source<TContext> value)
                ...
                /// <summary>
                /// Remove the <c>otlp</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveOtlp()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.OtlpUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetPrometheus(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredNameArray.Source value)
                {
                    CheckValidInstance();

                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.PrometheusUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PrometheusUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Prometheus, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetPrometheus<TContext>(in Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredNameArray.Source<TContext> value)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
                ...
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemovePrometheus()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.PrometheusUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredHostAndNameArray.Source _createArg1;
                private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredNameArray.Source _createArg2;
                ...
                internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredHostAndNameArray.Source arg1, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredNameArray.Source arg2)
                {
                    _createArg1 = arg1;
                    _createArg2 = arg2;
                    _kind = Kind.Create;
                ...
                #endif
            {
                ...
                private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredHostAndNameArray.Source<TContext> _createArg1;
                private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredNameArray.Source<TContext> _createArg2;
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredHostAndNameArray.Source<TContext> arg1, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredNameArray.Source<TContext> arg2)
                {
                    _context = context;
                    _createArg1 = arg1;
                    _createArg2 = arg2;
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredHostAndNameArray.Source otlp = default,
                    in Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredNameArray.Source prometheus = default)
                {
                    otlp.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Otlp, ref builder);
                    prometheus.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Prometheus, ref builder);
                }

                /// <summary>
                /// Creates an instance of a <see cref="Exporters"/>.
                /// </summary>
                public void Create(in Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredHostAndNameArray.Source otlp = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredNameArray.Source prometheus = default)
                {
                    Create(ref _builder, otlp, prometheus);
                }
                ...
                internal static void Create<TContext>(
                    in TContext context,
                    ref ComplexValueBuilder builder,
                    in Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredHostAndNameArray.Source<TContext> otlp = default,
                    in Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredNameArray.Source<TContext> prometheus = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
                ...
                #endif
                {
                    Create(context, ref _builder, otlp, prometheus);
                }
                ...
                internal static void BuildCreateValue(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredHostAndNameArray.Source arg1, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredNameArray.Source arg2, ref ComplexValueBuilder o)
                {
                    o.StartObject();
            ...
            /// </summary>
            /// <param name="otlp">The value of the <c>"otlp"</c> property.</param>
            /// <param name="prometheus">The value of the <c>"prometheus"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredHostAndNameArray.Source otlp = default, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredNameArray.Source prometheus = default)
            {
                return new Source(otlp, prometheus);
            }
            ...
            /// <param name="prometheus">The value of the <c>"prometheus"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredHostAndNameArray.Source<TContext> otlp = default, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredNameArray.Source<TContext> prometheus = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                return new Source<TContext>(context, otlp, prometheus);
            }
            ...
            /// </summary>
            /// <param name="workspace">The JSON workspace.</param>
            /// <param name="otlp">The value of the property.</param>
            /// <param name="prometheus">The value of the property.</param>
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredHostAndNameArray.Source otlp = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredNameArray.Source prometheus = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(otlp, prometheus);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredHostAndNameArray.Source<TContext> otlp = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredNameArray.Source<TContext> prometheus = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                ...
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(context, otlp, prometheus);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            public static ParsedJsonDocument<Exporters> Create(in Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredHostAndNameArray.Source otlp = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredNameArray.Source prometheus = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
            public static ParsedJsonDocument<Exporters> Create<TContext>(in TContext context, in Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredHostAndNameArray.Source<TContext> otlp = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredNameArray.Source<TContext> prometheus = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
