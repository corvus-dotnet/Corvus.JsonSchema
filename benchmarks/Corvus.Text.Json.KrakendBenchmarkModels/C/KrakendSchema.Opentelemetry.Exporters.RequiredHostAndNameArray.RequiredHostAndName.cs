        ...
        public readonly partial struct Exporters
        {
            ...
            public readonly partial struct RequiredHostAndNameArray
            {
...
#endif
                {
                    ...
                    internal RequiredHostAndName(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredHostAndNameArray.RequiredHostAndName.DisableMetrics DisableMetricsValue
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DisableMetricsValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredHostAndNameArray.RequiredHostAndName.DisableMetrics value))
                            {
                                return value;
                            }

                            return Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredHostAndNameArray.RequiredHostAndName.DisableMetrics.DefaultInstance;
                        }
                    }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredHostAndNameArray.RequiredHostAndName.DisableTraces DisableTracesValue
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DisableTracesValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredHostAndNameArray.RequiredHostAndName.DisableTraces value))
                            {
                                return value;
                            }

                            return Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredHostAndNameArray.RequiredHostAndName.DisableTraces.DefaultInstance;
                        }
                    }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredHostAndNameArray.RequiredHostAndName.Port PortValue
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PortValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredHostAndNameArray.RequiredHostAndName.Port value))
                            {
                                return value;
                            }

                            return Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredHostAndNameArray.RequiredHostAndName.Port.DefaultInstance;
                        }
                    }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.KrakendBenchmark.Current.JsonBoolean UseHttp
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UseHttpUtf8, out Corvus.KrakendBenchmark.Current.JsonBoolean value))
                            {
                                return value;
                            }
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in RequiredHostAndName left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    public static implicit operator JsonElement(RequiredHostAndName instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RequiredHostAndName(JsonElement instance)
                    {
                        return RequiredHostAndName.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RequiredHostAndName From<T>(in T instance)
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RequiredHostAndName ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        #pragma warning disable CS0618 // Type or member is obsolete
                        return JsonElementHelpers.ParseValue<RequiredHostAndName>(utf8Json, options);
                    ...
                    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RequiredHostAndName ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        #pragma warning disable CS0618 // Type or member is obsolete
                        return JsonElementHelpers.ParseValue<RequiredHostAndName>(json, options);
                        #pragma warning restore CS0618
                    }
                    ...
                    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RequiredHostAndName ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        #pragma warning disable CS0618 // Type or member is obsolete
                        return JsonElementHelpers.ParseValue<RequiredHostAndName>(json, options);
                        #pragma warning restore CS0618
                    ...
                    /// </exception>
                    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                    public static RequiredHostAndName ParseValue(ref Utf8JsonReader reader)
                    {
                        #pragma warning disable CS0618 // Type or member is obsolete
                        return JsonElementHelpers.ParseValue<RequiredHostAndName>(ref reader);
                        #pragma warning restore CS0618
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredHostAndName? result)
                    {
                        return JsonElementHelpers.TryParseValue<RequiredHostAndName>(ref reader, out result);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new RequiredHostAndName(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                    static RequiredHostAndName IJsonElement<RequiredHostAndName>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RequiredHostAndName: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="RequiredHostAndName"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="RequiredHostAndName"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public RequiredHostAndName Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<RequiredHostAndName>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="RequiredHostAndName"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public RequiredHostAndName Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<RequiredHostAndName>(_idx);
                        }
                    ...
                    private static class JsonPropertyNamesEscaped
                    {
                        ...
                        /// <summary>
                        /// Gets the escaped UTF-8 JSON property name for <see cref="UseHttp"/>.
                        /// </summary>
                        public static ReadOnlySpan<byte> UseHttp => "use_http"u8;
                    }
                    ...
                    private static class JsonPropertyNamesPrebaked
                    {
                        ...
                        /// <summary>
                        /// Gets the pre-baked property name blob for <see cref="UseHttp"/>.
                        /// </summary>
                        public static ReadOnlySpan<byte> UseHttp => [0xA5, 0x00, 0x00, 0x00, 0x22, 0x75, 0x73, 0x65, 0x5F, 0x68, 0x74, 0x74, 0x70, 0x22];
                    }
                }
            }
        }
