            ...
            public readonly partial struct RequiredNameArray
            {
                ...
                public readonly partial struct RequiredName
                {
...
#endif
                    {
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredNameArray.RequiredName.DisableMetrics.Mutable DisableMetricsValue
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DisableMetricsValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredNameArray.RequiredName.DisableMetrics.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.KrakendBenchmark.Current.JsonBoolean.Mutable GoMetrics
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.GoMetricsUtf8, out Corvus.KrakendBenchmark.Current.JsonBoolean.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredNameArray.RequiredName.ListenIp.Mutable ListenIpValue
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ListenIpValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredNameArray.RequiredName.ListenIp.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredNameArray.RequiredName.Port.Mutable PortValue
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PortValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredNameArray.RequiredName.Port.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.KrakendBenchmark.Current.JsonBoolean.Mutable ProcessMetrics
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ProcessMetricsUtf8, out Corvus.KrakendBenchmark.Current.JsonBoolean.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        public void SetDisableMetricsValue(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredNameArray.RequiredName.DisableMetrics.Source value)
                        {
                            ...
                            {
                                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.DisableMetricsValueUtf8);
                                _documentVersion = _parent.Version;
                                return;
                            }

                            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DisableMetricsValueUtf8, out IJsonDocument? elementParent, out int elementIdx))
                            {
                            ...
                            else
                            {
                                ...
                                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.DisableMetricsValue, ref cvb);
                        ...
                        public bool RemoveDisableMetricsValue()
                        {
                            CheckValidInstance();
                            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.DisableMetricsValueUtf8);
                            _documentVersion = _parent.Version;
                            return result;
                        }
                        ...
                        public void SetGoMetrics(scoped in Corvus.KrakendBenchmark.Current.JsonBoolean.Source value)
                        {
                            ...
                            if (value.IsUndefined)
                            {
                                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.GoMetricsUtf8);
                                _documentVersion = _parent.Version;
                                return;
                            }

                            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.GoMetricsUtf8, out IJsonDocument? elementParent, out int elementIdx))
                            {
                                // We are going to replace just the value
                                value.AddAsItem(ref cvb);
                                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                            ...
                            {
                                // We are going to insert the new value
                                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.GoMetrics, ref cvb);
                                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                            }
                        ...
                        /// <summary>
                        /// Remove the <c>go_metrics</c> property, if present.
                        /// </summary>
                        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                        public bool RemoveGoMetrics()
                        {
                            CheckValidInstance();
                            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.GoMetricsUtf8);
                            _documentVersion = _parent.Version;
                            return result;
                        }
                        ...
                        public void SetProcessMetrics(scoped in Corvus.KrakendBenchmark.Current.JsonBoolean.Source value)
                        {
                            ...
                            if (value.IsUndefined)
                            {
                                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ProcessMetricsUtf8);
                                _documentVersion = _parent.Version;
                                return;
                            }

                            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ProcessMetricsUtf8, out IJsonDocument? elementParent, out int elementIdx))
                            {
                                // We are going to replace just the value
                                value.AddAsItem(ref cvb);
                                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                            ...
                            {
                                // We are going to insert the new value
                                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ProcessMetrics, ref cvb);
                                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                            }
                        ...
                        /// <summary>
                        /// Remove the <c>process_metrics</c> property, if present.
                        /// </summary>
                        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                        public bool RemoveProcessMetrics()
                        {
                            CheckValidInstance();
                            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ProcessMetricsUtf8);
                            _documentVersion = _parent.Version;
                            return result;
                        }
                    ...
                    public ref struct Source
                    {
                        ...
                        private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredNameArray.RequiredName.DisableMetrics.Source _createArg2;
                        private readonly Corvus.KrakendBenchmark.Current.JsonBoolean.Source _createArg3;
                        private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredNameArray.RequiredName.ListenIp.Source _createArg4;
                        private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredNameArray.RequiredName.Port.Source _createArg5;
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredNameArray.RequiredName.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    public ref struct Builder
                    {
                        ...
                        internal static void Create(
                            ...
                            in Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredNameArray.RequiredName.DisableMetrics.Source disableMetrics = default,
                            in Corvus.KrakendBenchmark.Current.JsonBoolean.Source goMetrics = default,
                            in Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredNameArray.RequiredName.ListenIp.Source listenIp = default,
                            in Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredNameArray.RequiredName.Port.Source port = default,
                            in Corvus.KrakendBenchmark.Current.JsonBoolean.Source processMetrics = default)
                        {
                            name.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Name, ref builder);
                            disableMetrics.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.DisableMetricsValue, ref builder);
                            goMetrics.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.GoMetrics, ref builder);
                            ...
                            processMetrics.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ProcessMetrics, ref builder);
                        }
                        ...
                        public void Create(
                            ...
                            in Corvus.KrakendBenchmark.Current.JsonBoolean.Source processMetrics = default)
                        {
                            Create(ref _builder, name, disableMetrics, goMetrics, listenIp, port, processMetrics);
                        }
                    ...
                    /// <param name="disableMetrics">The value of the <c>"disable_metrics"</c> property.</param>
                    /// <param name="goMetrics">The value of the <c>"go_metrics"</c> property.</param>
                    /// <param name="listenIp">The value of the <c>"listen_ip"</c> property.</param>
                    ...
                    /// <param name="goMetrics">The value of the property.</param>
                    /// <param name="listenIp">The value of the property.</param>
                    /// <param name="port">The value of the property.</param>
                    /// <param name="processMetrics">The value of the property.</param>
                    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.JsonString.Source name, in Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredNameArray.RequiredName.DisableMetrics.Source disableMetrics = default, in Corvus.KrakendBenchmark.Current.JsonBoolean.Source goMetrics = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredNameArray.RequiredName.ListenIp.Source listenIp = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredNameArray.RequiredName.Port.Source port = default, in Corvus.KrakendBenchmark.Current.JsonBoolean.Source processMetrics = default, int initialCapacity = 30)
                    {
                        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                        cvb.StartObject();
                        Builder ovb = new(cvb);
                        ovb.Create(name, disableMetrics, goMetrics, listenIp, port, processMetrics);
                        cvb = ovb._builder;
                        cvb.EndObject();
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder;
                    ...
                    public static ParsedJsonDocument<RequiredName> Create(in Corvus.KrakendBenchmark.Current.JsonString.Source name, in Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredNameArray.RequiredName.DisableMetrics.Source disableMetrics = default, in Corvus.KrakendBenchmark.Current.JsonBoolean.Source goMetrics = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredNameArray.RequiredName.ListenIp.Source listenIp = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredNameArray.RequiredName.Port.Source port = default, in Corvus.KrakendBenchmark.Current.JsonBoolean.Source processMetrics = default, int initialCapacity = 30)
                    {
                        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                        try
                        {
