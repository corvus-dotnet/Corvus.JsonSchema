                ...
                public readonly partial struct RequiredName
                {
                    ...
                    public readonly partial struct Port
                    {
...
#endif
                        {
                            ...
                            /// </remarks>
                            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<Port, Mutable>(Port.DefaultInstance);
                        ...
                        public static ParsedJsonDocument<Port> Create(
                            scoped in Source value, int initialCapacity = 1)
                        {
                            ...
                            try
                            {
                                ...
                                Debug.Assert(cvb.MemberCount == 1);
                                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                return documentBuilder.ToParsedJsonDocument<Port>();
                            }
                            finally
                            {
