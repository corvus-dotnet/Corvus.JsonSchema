...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Opentelemetry
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredHostAndNameArray Otlp
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OtlpUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredHostAndNameArray value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredNameArray Prometheus
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PrometheusUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters.RequiredNameArray value))
                    {
                        return value;
                    }
            ...
            private static class JsonPropertyNamesPrebaked
            {
                ...
                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="Prometheus"/>.
                /// </summary>
                public static ReadOnlySpan<byte> Prometheus => [0xC5, 0x00, 0x00, 0x00, 0x22, 0x70, 0x72, 0x6F, 0x6D, 0x65, 0x74, 0x68, 0x65, 0x75, 0x73, 0x22];
            }
        }
    }
}
