                ...
                public readonly partial struct MetricsEntity
                {
                    ...
                    public readonly partial struct DetailedHttpConnectionMetrics
                    {
...
#endif
                        {
                            ...
                            /// </remarks>
                            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DetailedHttpConnectionMetrics, Mutable>(DetailedHttpConnectionMetrics.DefaultInstance);
                        ...
                        public static ParsedJsonDocument<DetailedHttpConnectionMetrics> Create(
                            scoped in Source value, int initialCapacity = 1)
                        {
                            ...
                            try
                            {
                                ...
                                Debug.Assert(cvb.MemberCount == 1);
                                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                return documentBuilder.ToParsedJsonDocument<DetailedHttpConnectionMetrics>();
                            }
                            finally
                            {
