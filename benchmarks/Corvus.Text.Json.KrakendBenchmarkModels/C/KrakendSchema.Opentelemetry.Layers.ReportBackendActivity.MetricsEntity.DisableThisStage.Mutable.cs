                ...
                public readonly partial struct MetricsEntity
                {
                    ...
                    public readonly partial struct DisableThisStage
                    {
...
#endif
                        {
                            ...
                            /// </remarks>
                            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DisableThisStage, Mutable>(DisableThisStage.DefaultInstance);
                        ...
                        public static ParsedJsonDocument<DisableThisStage> Create(
                            scoped in Source value, int initialCapacity = 1)
                        {
                            ...
                            try
                            {
                                ...
                                Debug.Assert(cvb.MemberCount == 1);
                                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                return documentBuilder.ToParsedJsonDocument<DisableThisStage>();
                            }
                            finally
                            {
