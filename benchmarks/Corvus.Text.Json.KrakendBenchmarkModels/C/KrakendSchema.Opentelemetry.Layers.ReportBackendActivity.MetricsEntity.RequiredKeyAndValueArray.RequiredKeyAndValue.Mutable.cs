                    ...
                    public readonly partial struct RequiredKeyAndValueArray
                    {
                        ...
                        public readonly partial struct RequiredKeyAndValue
                        {
...
#endif
                            {
                                ...
                                public static explicit operator Mutable(RequiredKeyAndValue instance)
                                {
                                ...
                                /// <returns>An immutable instance of a <see cref="RequiredKeyAndValue"/>, initialized from the <see cref="Mutable"/> value.</returns>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static implicit operator RequiredKeyAndValue(Mutable instance)
                                {
                                ...
                                {
                                    return
                                        (obj is IJsonElement value && Equals(new RequiredKeyAndValue(value.ParentDocument, value.ParentDocumentIndex))) ||
                                ...
                                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                private string DebuggerDisplay => $"RequiredKeyAndValue.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                                ...
                                /// <summary>
                                /// Gets a <see cref="RequiredKeyAndValue"/> which can be safely stored beyond the lifetime of the
                                /// original document.
                                /// </summary>
                                /// <returns>
                                /// A <see cref="RequiredKeyAndValue"/> which can be safely stored beyond the lifetime of the
                                /// original document.
                                /// </returns>
                                /// <remarks>
                                /// <para>
                                ...
                                /// </para>
                                /// </remarks>
                                public readonly RequiredKeyAndValue Clone()
                                {
                                    CheckValidInstance();
                                    return _parent.CloneElement<RequiredKeyAndValue>(_idx);
                                }
                                ...
                                /// </summary>
                                /// <returns>
                                /// An immutable <see cref="RequiredKeyAndValue"/> that lives for the lifetime of its
                                ...
                                /// </para>
                                /// </remarks>
                                public readonly RequiredKeyAndValue Freeze()
                                {
                                    CheckValidInstance();
                                    return _parent.FreezeElement<RequiredKeyAndValue>(_idx);
                                }
                            }
                            ...
                            public ref struct Source
                            {
                                ...
                                internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Layers.ReportBackendActivity.MetricsEntity.RequiredKeyAndValueArray.RequiredKeyAndValue.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                                ...
                                public static implicit operator Source(RequiredKeyAndValue instance) => new(JsonElement.From(instance));
                                ...
                                #endif
                            {
                                ...
                                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Layers.ReportBackendActivity.MetricsEntity.RequiredKeyAndValueArray.RequiredKeyAndValue.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                            ...
                            public ref struct Builder
                            {
                                ...
                                internal static void Create(
                                    ...
                                    in Corvus.KrakendBenchmark.Current.JsonString.Source key,
                                ...
                                /// Creates an instance of a <see cref="RequiredKeyAndValue"/>.
                                /// </summary>
                                public void Create(in Corvus.KrakendBenchmark.Current.JsonString.Source key, in Corvus.KrakendBenchmark.Current.JsonString.Source value)
                                {
                                    Create(ref _builder, key, value);
                                }
                            ...
                            /// <returns>The source from which to build the value.</returns>
                            public static Source Build(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source key, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source value)
                            {
                            ...
                            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.JsonString.Source key, in Corvus.KrakendBenchmark.Current.JsonString.Source value, int initialCapacity = 30)
                            {
                                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                                cvb.StartObject();
                                Builder ovb = new(cvb);
                                ovb.Create(key, value);
                                cvb = ovb._builder;
                                cvb.EndObject();
                                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                return documentBuilder;
                            ...
                            {
                                return workspace.CreateBuilder<RequiredKeyAndValue, Mutable>(this);
                            }
                            ...
                            public static ParsedJsonDocument<RequiredKeyAndValue> Create(
                                scoped in Source value, int initialCapacity = 30)
                            {
                                ...
                                try
                                {
                                    ...
                                    Debug.Assert(cvb.MemberCount == 1);
                                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                    return documentBuilder.ToParsedJsonDocument<RequiredKeyAndValue>();
                                }
                                finally
                                {
                            ...
                            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                            public static ParsedJsonDocument<RequiredKeyAndValue> Create<TContext>(
                            ...
                            public static ParsedJsonDocument<RequiredKeyAndValue> Create(in Corvus.KrakendBenchmark.Current.JsonString.Source key, in Corvus.KrakendBenchmark.Current.JsonString.Source value, int initialCapacity = 30)
                            {
                                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                                try
                                {
