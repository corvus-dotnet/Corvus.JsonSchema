            ...
            public readonly partial struct ReportBackendActivity
            {
                ...
                public readonly partial struct MetricsEntity
                {
...
#endif
                    {
                        ...
                        public Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Layers.ReportBackendActivity.MetricsEntity.RequiredKeyAndValueArray.RequiredKeyAndValue this[int index]
                        {
                            get
                            {
                                CheckValidInstance();
                                return _parent.GetArrayIndexElement<Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Layers.ReportBackendActivity.MetricsEntity.RequiredKeyAndValueArray.RequiredKeyAndValue>(_idx, index);
                            }
                        }
                        ...
                        /// </summary>
                        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                        public ArrayEnumerator<Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Layers.ReportBackendActivity.MetricsEntity.RequiredKeyAndValueArray.RequiredKeyAndValue> EnumerateArray()
                        {
                            CheckValidInstance();
                            return EnumeratorCreator.CreateArrayEnumerator<Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Layers.ReportBackendActivity.MetricsEntity.RequiredKeyAndValueArray.RequiredKeyAndValue>(_parent, _idx);
                        }
