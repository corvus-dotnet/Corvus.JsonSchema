                ...
                public readonly partial struct TracesEntity
                {
                    ...
                    public readonly partial struct DetailedHttpConnection
                    {
...
#endif
                        {
                            ...
                            /// </remarks>
                            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DetailedHttpConnection, Mutable>(DetailedHttpConnection.DefaultInstance);
                            ...
                            public static explicit operator Mutable(DetailedHttpConnection instance)
                            {
                            ...
                            /// <returns>An immutable instance of a <see cref="DetailedHttpConnection"/>, initialized from the <see cref="Mutable"/> value.</returns>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator DetailedHttpConnection(Mutable instance)
                            {
                            ...
                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            private string DebuggerDisplay => $"DetailedHttpConnection.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly DetailedHttpConnection Clone()
                            {
                                CheckValidInstance();
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly DetailedHttpConnection Freeze()
                            {
                                CheckValidInstance();
                                return _parent.FreezeElement<DetailedHttpConnection>(_idx);
                            }
                        }
                        ...
                        public ref struct Source
                        {
                            ...
                            public static implicit operator Source(DetailedHttpConnection instance) => new(JsonElement.From(instance));
                        ...
                        {
                            return workspace.CreateBuilder<DetailedHttpConnection, Mutable>(this);
                        }
                        ...
                        public static ParsedJsonDocument<DetailedHttpConnection> Create(
                            scoped in Source value, int initialCapacity = 1)
                        {
                            ...
                            try
                            {
                                ...
                                Debug.Assert(cvb.MemberCount == 1);
                                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                return documentBuilder.ToParsedJsonDocument<DetailedHttpConnection>();
                            }
                            finally
                            {
