                ...
                public readonly partial struct TracesEntity
                {
                    ...
                    public readonly partial struct DetailedPayloadRead
                    {
...
#endif
                        {
                            ...
                            /// </remarks>
                            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DetailedPayloadRead, Mutable>(DetailedPayloadRead.DefaultInstance);
                        ...
                        public static ParsedJsonDocument<DetailedPayloadRead> Create(
                            scoped in Source value, int initialCapacity = 1)
                        {
                            ...
                            try
                            {
                                ...
                                Debug.Assert(cvb.MemberCount == 1);
                                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                return documentBuilder.ToParsedJsonDocument<DetailedPayloadRead>();
                            }
                            finally
                            {
