                ...
                public readonly partial struct TracesEntity
                {
                    ...
                    public readonly partial struct DetailedRoundTrip
                    {
...
#endif
                        {
                            ...
                            /// </remarks>
                            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DetailedRoundTrip, Mutable>(DetailedRoundTrip.DefaultInstance);
                            ...
                            public static explicit operator Mutable(DetailedRoundTrip instance)
                            {
                            ...
                            /// <returns>An immutable instance of a <see cref="DetailedRoundTrip"/>, initialized from the <see cref="Mutable"/> value.</returns>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator DetailedRoundTrip(Mutable instance)
                            {
                            ...
                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            private string DebuggerDisplay => $"DetailedRoundTrip.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly DetailedRoundTrip Clone()
                            {
                                CheckValidInstance();
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly DetailedRoundTrip Freeze()
                            {
                                CheckValidInstance();
                                return _parent.FreezeElement<DetailedRoundTrip>(_idx);
                            }
                        }
                        ...
                        public ref struct Source
                        {
                            ...
                            public static implicit operator Source(DetailedRoundTrip instance) => new(JsonElement.From(instance));
                        ...
                        {
                            return workspace.CreateBuilder<DetailedRoundTrip, Mutable>(this);
                        }
                        ...
                        public static ParsedJsonDocument<DetailedRoundTrip> Create(
                            scoped in Source value, int initialCapacity = 1)
                        {
                            ...
                            try
                            {
                                ...
                                Debug.Assert(cvb.MemberCount == 1);
                                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                return documentBuilder.ToParsedJsonDocument<DetailedRoundTrip>();
                            }
                            finally
                            {
