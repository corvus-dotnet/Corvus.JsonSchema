        ...
        public readonly partial struct Layers
        {
            ...
            public readonly partial struct ReportBackendActivity
            {
                ...
                public readonly partial struct TracesEntity
                {
                    ...
                    public readonly partial struct DisableThisStage
#if NET8_0_OR_GREATER
                        : IJsonElement<DisableThisStage>,
                          IFormattable,
                          ISpanFormattable,
...
#endif
                    {
                        ...
                        /// <summary>
                        /// Initializes a new instance of the <see cref="DisableThisStage"/> struct.
                        /// </summary>
                        /// <param name="value">The value from which to construct the instance.</param>
                        internal DisableThisStage(IJsonDocument parent, int idx)
                        {
                            Debug.Assert(idx >= 0);
                            _parent = parent;
                            _idx = idx;
                        ...
                        /// </summary>
                        public static DisableThisStage DefaultInstance { get; } = ParsedJsonDocument<DisableThisStage>.False;
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator bool(DisableThisStage value)
                        {
                        ...
                        /// </returns>
                        public static bool operator ==(in DisableThisStage left, in DisableThisStage right)
                        {
                        ...
                        /// <c>True</c> if the values are equal.
                        /// </returns>
                        public static bool operator ==(in DisableThisStage left, in JsonElement right)
                        {
                            return left.Equals(right);
                        }
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator JsonElement(DisableThisStage instance)
                        {
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator DisableThisStage(JsonElement instance)
                        {
                            return DisableThisStage.From(instance);
                        }
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static DisableThisStage From<T>(in T instance)
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static DisableThisStage ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<DisableThisStage>(utf8Json, options);
                        }
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static DisableThisStage ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<DisableThisStage>(json, options);
                        }
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static DisableThisStage ParseValue(string json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<DisableThisStage>(json, options);
                        }
                        ...
                        /// </exception>
                        public static DisableThisStage ParseValue(ref Utf8JsonReader reader)
                        {
                            return JsonElementHelpers.ParseValue<DisableThisStage>(ref reader);
                        }
                        ...
                        ///   A value could not be read from the reader.
                        /// </exception>
                        public static bool TryParseValue(ref Utf8JsonReader reader, out DisableThisStage? result)
                        {
                            return JsonElementHelpers.TryParseValue<DisableThisStage>(ref reader, out result);
                        }
                        ...
                        {
                            return
                                (obj is IJsonElement value && Equals(new DisableThisStage(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                        static DisableThisStage IJsonElement<DisableThisStage>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"DisableThisStage: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// <summary>
                        /// Gets a <see cref="DisableThisStage"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </summary>
                        /// <returns>
                        /// A <see cref="DisableThisStage"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </returns>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public DisableThisStage Clone()
                        {
                            CheckValidInstance();
                            return _parent.CloneElement<DisableThisStage>(_idx);
                        }
                        ...
                        /// </summary>
                        /// <returns>
                        /// An immutable <see cref="DisableThisStage"/> that lives for the lifetime of its
                        ...
                        /// </para>
                        /// </remarks>
                        public DisableThisStage Freeze()
                        {
                            CheckValidInstance();
                            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                            {
                                return mutable.FreezeElement<DisableThisStage>(_idx);
                            }
