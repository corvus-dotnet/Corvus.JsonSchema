                ...
                public readonly partial struct TracesEntity
                {
                    ...
                    public readonly partial struct ReportHeaders
                    {
...
#endif
                        {
                            ...
                            /// </remarks>
                            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ReportHeaders, Mutable>(ReportHeaders.DefaultInstance);
                        ...
                        public static ParsedJsonDocument<ReportHeaders> Create(
                            scoped in Source value, int initialCapacity = 1)
                        {
                            ...
                            try
                            {
                                ...
                                Debug.Assert(cvb.MemberCount == 1);
                                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                return documentBuilder.ToParsedJsonDocument<ReportHeaders>();
                            }
                            finally
                            {
