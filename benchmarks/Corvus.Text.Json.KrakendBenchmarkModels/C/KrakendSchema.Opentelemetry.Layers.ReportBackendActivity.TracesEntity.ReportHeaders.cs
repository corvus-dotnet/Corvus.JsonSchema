        ...
        public readonly partial struct Layers
        {
            ...
            public readonly partial struct ReportBackendActivity
            {
                ...
                public readonly partial struct TracesEntity
                {
                    ...
                    public readonly partial struct ReportHeaders
#if NET8_0_OR_GREATER
                        : IJsonElement<ReportHeaders>,
                          IFormattable,
                          ISpanFormattable,
...
#endif
                    {
                        ...
                        /// <summary>
                        /// Initializes a new instance of the <see cref="ReportHeaders"/> struct.
                        /// </summary>
                        /// <param name="value">The value from which to construct the instance.</param>
                        internal ReportHeaders(IJsonDocument parent, int idx)
                        {
                            Debug.Assert(idx >= 0);
                            _parent = parent;
                            _idx = idx;
                        ...
                        /// </summary>
                        public static ReportHeaders DefaultInstance { get; } = ParsedJsonDocument<ReportHeaders>.False;
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator bool(ReportHeaders value)
                        {
                        ...
                        /// </returns>
                        public static bool operator ==(in ReportHeaders left, in ReportHeaders right)
                        {
                        ...
                        /// <c>True</c> if the values are equal.
                        /// </returns>
                        public static bool operator ==(in ReportHeaders left, in JsonElement right)
                        {
                            return left.Equals(right);
                        }
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator JsonElement(ReportHeaders instance)
                        {
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator ReportHeaders(JsonElement instance)
                        {
                            return ReportHeaders.From(instance);
                        }
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static ReportHeaders From<T>(in T instance)
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static ReportHeaders ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<ReportHeaders>(utf8Json, options);
                        }
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static ReportHeaders ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<ReportHeaders>(json, options);
                        }
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static ReportHeaders ParseValue(string json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<ReportHeaders>(json, options);
                        }
                        ...
                        /// </exception>
                        public static ReportHeaders ParseValue(ref Utf8JsonReader reader)
                        {
                            return JsonElementHelpers.ParseValue<ReportHeaders>(ref reader);
                        }
                        ...
                        ///   A value could not be read from the reader.
                        /// </exception>
                        public static bool TryParseValue(ref Utf8JsonReader reader, out ReportHeaders? result)
                        {
                            return JsonElementHelpers.TryParseValue<ReportHeaders>(ref reader, out result);
                        }
                        ...
                        {
                            return
                                (obj is IJsonElement value && Equals(new ReportHeaders(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                        static ReportHeaders IJsonElement<ReportHeaders>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"ReportHeaders: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// <summary>
                        /// Gets a <see cref="ReportHeaders"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </summary>
                        /// <returns>
                        /// A <see cref="ReportHeaders"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </returns>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public ReportHeaders Clone()
                        {
                            CheckValidInstance();
                            return _parent.CloneElement<ReportHeaders>(_idx);
                        }
                        ...
                        /// </summary>
                        /// <returns>
                        /// An immutable <see cref="ReportHeaders"/> that lives for the lifetime of its
