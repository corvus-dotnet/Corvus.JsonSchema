    ...
    public readonly partial struct Opentelemetry
    {
        ...
        public readonly partial struct Layers
        {
...
#endif
            {
                ...
                /// </summary>
                public Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Layers.ReportBackendActivity.MetricsEntity Metrics
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MetricsUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Layers.ReportBackendActivity.MetricsEntity value))
                        {
                            return value;
                        }
                ...
                /// </summary>
                public Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Layers.ReportBackendActivity.TracesEntity Traces
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TracesUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Layers.ReportBackendActivity.TracesEntity value))
                        {
                            return value;
                        }
