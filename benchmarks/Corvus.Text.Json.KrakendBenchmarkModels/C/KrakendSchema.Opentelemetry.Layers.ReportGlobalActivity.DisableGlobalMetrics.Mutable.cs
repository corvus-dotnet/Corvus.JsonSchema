            ...
            public readonly partial struct ReportGlobalActivity
            {
                ...
                public readonly partial struct DisableGlobalMetrics
                {
...
#endif
                    {
                        ...
                        /// </remarks>
                        public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DisableGlobalMetrics, Mutable>(DisableGlobalMetrics.DefaultInstance);
                        ...
                        public static explicit operator Mutable(DisableGlobalMetrics instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="DisableGlobalMetrics"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator DisableGlobalMetrics(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"DisableGlobalMetrics.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly DisableGlobalMetrics Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly DisableGlobalMetrics Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<DisableGlobalMetrics>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(DisableGlobalMetrics instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<DisableGlobalMetrics, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<DisableGlobalMetrics> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<DisableGlobalMetrics>();
                        }
                        finally
                        {
