    ...
    public readonly partial struct Opentelemetry
    {
        ...
        public readonly partial struct Layers
        {
            ...
            public readonly partial struct ReportGlobalActivity
            {
                ...
                public readonly partial struct DisableGlobalTrace
#if NET8_0_OR_GREATER
                    : IJsonElement<DisableGlobalTrace>,
                      IFormattable,
                      ISpanFormattable,
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="DisableGlobalTrace"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal DisableGlobalTrace(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static DisableGlobalTrace DefaultInstance { get; } = ParsedJsonDocument<DisableGlobalTrace>.False;
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator bool(DisableGlobalTrace value)
                    {
                    ...
                    /// </returns>
                    public static bool operator ==(in DisableGlobalTrace left, in DisableGlobalTrace right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in DisableGlobalTrace left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator JsonElement(DisableGlobalTrace instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator DisableGlobalTrace(JsonElement instance)
                    {
                        return DisableGlobalTrace.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static DisableGlobalTrace From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static DisableGlobalTrace ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<DisableGlobalTrace>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static DisableGlobalTrace ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<DisableGlobalTrace>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static DisableGlobalTrace ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<DisableGlobalTrace>(json, options);
                    }
                    ...
                    /// </exception>
                    public static DisableGlobalTrace ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<DisableGlobalTrace>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out DisableGlobalTrace? result)
                    {
                        return JsonElementHelpers.TryParseValue<DisableGlobalTrace>(ref reader, out result);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new DisableGlobalTrace(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                    static DisableGlobalTrace IJsonElement<DisableGlobalTrace>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"DisableGlobalTrace: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="DisableGlobalTrace"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="DisableGlobalTrace"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public DisableGlobalTrace Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<DisableGlobalTrace>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="DisableGlobalTrace"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public DisableGlobalTrace Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<DisableGlobalTrace>(_idx);
                        }
