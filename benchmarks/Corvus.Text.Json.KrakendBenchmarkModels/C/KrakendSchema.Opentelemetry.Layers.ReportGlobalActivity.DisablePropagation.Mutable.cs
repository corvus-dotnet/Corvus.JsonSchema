            ...
            public readonly partial struct ReportGlobalActivity
            {
                ...
                public readonly partial struct DisablePropagation
                {
...
#endif
                    {
                        ...
                        /// </remarks>
                        public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DisablePropagation, Mutable>(DisablePropagation.DefaultInstance);
                        ...
                        public static explicit operator Mutable(DisablePropagation instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="DisablePropagation"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator DisablePropagation(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"DisablePropagation.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly DisablePropagation Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly DisablePropagation Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<DisablePropagation>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(DisablePropagation instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<DisablePropagation, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<DisablePropagation> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<DisablePropagation>();
                        }
                        finally
                        {
