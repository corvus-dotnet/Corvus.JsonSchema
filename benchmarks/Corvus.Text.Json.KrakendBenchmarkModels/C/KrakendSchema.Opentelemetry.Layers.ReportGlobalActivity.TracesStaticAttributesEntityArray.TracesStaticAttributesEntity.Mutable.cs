                ...
                public readonly partial struct TracesStaticAttributesEntityArray
                {
                    ...
                    public readonly partial struct TracesStaticAttributesEntity
                    {
                        ...
                        public ref struct Source
                        {
                            ...
                            internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Layers.ReportGlobalActivity.TracesStaticAttributesEntityArray.TracesStaticAttributesEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                            ...
                            #endif
                        {
                            ...
                            internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Layers.ReportGlobalActivity.TracesStaticAttributesEntityArray.TracesStaticAttributesEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                        ...
                        public static ParsedJsonDocument<TracesStaticAttributesEntity> Create(
                            scoped in Source value, int initialCapacity = 30)
                        {
                            ...
                            try
                            {
                                ...
                                Debug.Assert(cvb.MemberCount == 1);
                                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                return documentBuilder.ToParsedJsonDocument<TracesStaticAttributesEntity>();
                            }
                            finally
                            {
                        ...
                        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                        public static ParsedJsonDocument<TracesStaticAttributesEntity> Create<TContext>(
                        ...
                        public static ParsedJsonDocument<TracesStaticAttributesEntity> Create(in Corvus.KrakendBenchmark.Current.JsonString.Source key = default, in Corvus.KrakendBenchmark.Current.JsonString.Source value = default, int initialCapacity = 30)
                        {
                            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                            try
                            {
