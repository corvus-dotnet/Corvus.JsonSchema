            ...
            public readonly partial struct ReportProxyActivity
            {
                ...
                public readonly partial struct DisableProxyMetrics
                {
...
#endif
                    {
                        ...
                        /// </remarks>
                        public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DisableProxyMetrics, Mutable>(DisableProxyMetrics.DefaultInstance);
                    ...
                    public static ParsedJsonDocument<DisableProxyMetrics> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<DisableProxyMetrics>();
                        }
                        finally
                        {
