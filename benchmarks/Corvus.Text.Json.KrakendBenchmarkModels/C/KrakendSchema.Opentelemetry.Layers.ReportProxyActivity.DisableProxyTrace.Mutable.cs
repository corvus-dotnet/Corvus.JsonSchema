            ...
            public readonly partial struct ReportProxyActivity
            {
                ...
                public readonly partial struct DisableProxyTrace
                {
...
#endif
                    {
                        ...
                        /// </remarks>
                        public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DisableProxyTrace, Mutable>(DisableProxyTrace.DefaultInstance);
                    ...
                    public static ParsedJsonDocument<DisableProxyTrace> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<DisableProxyTrace>();
                        }
                        finally
                        {
