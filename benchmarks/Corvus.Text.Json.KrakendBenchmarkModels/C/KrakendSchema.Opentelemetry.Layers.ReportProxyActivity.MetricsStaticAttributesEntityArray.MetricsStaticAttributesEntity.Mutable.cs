            ...
            public readonly partial struct ReportProxyActivity
            {
                ...
                public readonly partial struct MetricsStaticAttributesEntityArray
                {
                    ...
                    public readonly partial struct MetricsStaticAttributesEntity
                    {
                        ...
                        public static ParsedJsonDocument<MetricsStaticAttributesEntity> Create(
                            scoped in Source value, int initialCapacity = 30)
                        {
                            ...
                            try
                            {
                                ...
                                Debug.Assert(cvb.MemberCount == 1);
                                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                return documentBuilder.ToParsedJsonDocument<MetricsStaticAttributesEntity>();
                            }
                            finally
                            {
                        ...
                        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                        public static ParsedJsonDocument<MetricsStaticAttributesEntity> Create<TContext>(
                        ...
                        public static ParsedJsonDocument<MetricsStaticAttributesEntity> Create(in Corvus.KrakendBenchmark.Current.JsonString.Source key = default, in Corvus.KrakendBenchmark.Current.JsonString.Source value = default, int initialCapacity = 30)
                        {
                            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                            try
                            {
