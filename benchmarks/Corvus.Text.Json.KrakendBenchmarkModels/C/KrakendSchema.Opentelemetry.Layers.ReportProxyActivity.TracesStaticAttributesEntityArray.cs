        ...
        public readonly partial struct Layers
        {
            ...
            public readonly partial struct ReportProxyActivity
            {
...
#endif
                {
                    ...
                    public Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Layers.ReportProxyActivity.TracesStaticAttributesEntityArray.TracesStaticAttributesEntity this[int index]
                    {
                        get
                        {
                            CheckValidInstance();
                            return _parent.GetArrayIndexElement<Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Layers.ReportProxyActivity.TracesStaticAttributesEntityArray.TracesStaticAttributesEntity>(_idx, index);
                        }
                    }
                    ...
                    /// </summary>
                    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                    public ArrayEnumerator<Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Layers.ReportProxyActivity.TracesStaticAttributesEntityArray.TracesStaticAttributesEntity> EnumerateArray()
                    {
                        CheckValidInstance();
                        return EnumeratorCreator.CreateArrayEnumerator<Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Layers.ReportProxyActivity.TracesStaticAttributesEntityArray.TracesStaticAttributesEntity>(_parent, _idx);
                    }
