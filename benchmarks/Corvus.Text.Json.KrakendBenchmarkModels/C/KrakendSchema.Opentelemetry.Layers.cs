...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Opentelemetry
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Layers.ReportBackendActivity Backend
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BackendUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Layers.ReportBackendActivity value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Layers.ReportGlobalActivity Global
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.GlobalUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Layers.ReportGlobalActivity value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Layers.ReportProxyActivity Proxy
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ProxyUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Layers.ReportProxyActivity value))
                    {
                        return value;
                    }
