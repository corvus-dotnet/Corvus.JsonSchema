    ...
    public readonly partial struct Opentelemetry
    {
        ...
        public readonly partial struct TraceSampleRate
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<TraceSampleRate, Mutable>(TraceSampleRate.DefaultInstance);
            ...
            public static ParsedJsonDocument<TraceSampleRate> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TraceSampleRate>();
                }
                finally
                {
