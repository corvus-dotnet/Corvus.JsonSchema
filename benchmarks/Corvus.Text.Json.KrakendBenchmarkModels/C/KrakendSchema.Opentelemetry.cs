...
public readonly partial struct KrakendSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Opentelemetry"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal Opentelemetry(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static Opentelemetry DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters ExportersValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExportersValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Exporters value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Layers LayersValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LayersValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.Layers value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.ReportingPeriod MetricReportingPeriod
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MetricReportingPeriodUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.ReportingPeriod value))
                {
                    return value;
                }

                return Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.ReportingPeriod.DefaultInstance;
            }
        }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.JsonStringArray SkipPaths
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SkipPathsUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.JsonStringArray value))
                {
                    return value;
                }

                return Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.JsonStringArray.DefaultInstance;
            }
        }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.TraceSampleRate TraceSampleRateValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TraceSampleRateValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.TraceSampleRate value))
                {
                    return value;
                }

                return Corvus.KrakendBenchmark.Current.KrakendSchema.Opentelemetry.TraceSampleRate.DefaultInstance;
            }
        }
        ...
        /// </returns>
        public static bool operator ==(in Opentelemetry left, in Opentelemetry right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Opentelemetry left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(Opentelemetry instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Opentelemetry(JsonElement instance)
        {
            return Opentelemetry.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Opentelemetry From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Opentelemetry ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<Opentelemetry>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Opentelemetry ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<Opentelemetry>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Opentelemetry ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<Opentelemetry>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static Opentelemetry ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<Opentelemetry>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Opentelemetry? result)
        {
            return JsonElementHelpers.TryParseValue<Opentelemetry>(ref reader, out result);
        }
...
#if NET
        static Opentelemetry IJsonElement<Opentelemetry>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Opentelemetry: ValueKind = {ValueKind} : \"{ToString()}\"";
