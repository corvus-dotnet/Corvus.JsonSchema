    ...
    public readonly partial struct OpentelemetryBackend
    {
        ...
        public readonly partial struct ReportBackendActivity
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryBackend.ReportBackendActivity.MetricsEntity.DisableThisStage DisableStage
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DisableStageUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryBackend.ReportBackendActivity.MetricsEntity.DisableThisStage value))
                        {
                            return value;
                        }

                        return Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryBackend.ReportBackendActivity.MetricsEntity.DisableThisStage.DefaultInstance;
                    }
                }
