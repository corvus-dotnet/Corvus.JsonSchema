    ...
    public readonly partial struct OpentelemetryBackend
    {
        ...
        public readonly partial struct ReportBackendActivity
        {
...
#endif
            {
                ...
                /// </summary>
                public Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryBackend.ReportBackendActivity.MetricsEntity.Mutable Metrics
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MetricsUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryBackend.ReportBackendActivity.MetricsEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </summary>
                public Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryBackend.ReportBackendActivity.TracesEntity.Mutable Traces
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TracesUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryBackend.ReportBackendActivity.TracesEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetMetrics<TContext>(in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryBackend.ReportBackendActivity.MetricsEntity.Source<TContext> value)
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetTraces<TContext>(in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryBackend.ReportBackendActivity.TracesEntity.Source<TContext> value)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryBackend.ReportBackendActivity.MetricsEntity.Source _createArg1;
                private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryBackend.ReportBackendActivity.TracesEntity.Source _createArg2;
                ...
                #endif
            {
                ...
                private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryBackend.ReportBackendActivity.MetricsEntity.Source<TContext> _createArg1;
                private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryBackend.ReportBackendActivity.TracesEntity.Source<TContext> _createArg2;
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryBackend.ReportBackendActivity.MetricsEntity.Source metrics = default,
                    in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryBackend.ReportBackendActivity.TracesEntity.Source traces = default)
                {
                ...
                /// Creates an instance of a <see cref="ReportBackendActivity"/>.
                /// </summary>
                public void Create(in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryBackend.ReportBackendActivity.MetricsEntity.Source metrics = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryBackend.ReportBackendActivity.TracesEntity.Source traces = default)
                {
                ...
                internal static void Create<TContext>(
                    in TContext context,
                    ref ComplexValueBuilder builder,
                    in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryBackend.ReportBackendActivity.MetricsEntity.Source<TContext> metrics = default,
                    in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryBackend.ReportBackendActivity.TracesEntity.Source<TContext> traces = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryBackend.ReportBackendActivity.MetricsEntity.Source metrics = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryBackend.ReportBackendActivity.TracesEntity.Source traces = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryBackend.ReportBackendActivity.MetricsEntity.Source<TContext> metrics = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryBackend.ReportBackendActivity.TracesEntity.Source<TContext> traces = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
            ...
            public static ParsedJsonDocument<ReportBackendActivity> Create(in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryBackend.ReportBackendActivity.MetricsEntity.Source metrics = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryBackend.ReportBackendActivity.TracesEntity.Source traces = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
            public static ParsedJsonDocument<ReportBackendActivity> Create<TContext>(in TContext context, in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryBackend.ReportBackendActivity.MetricsEntity.Source<TContext> metrics = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryBackend.ReportBackendActivity.TracesEntity.Source<TContext> traces = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
