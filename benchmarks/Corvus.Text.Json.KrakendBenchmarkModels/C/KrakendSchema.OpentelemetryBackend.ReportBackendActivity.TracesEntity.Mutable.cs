        ...
        public readonly partial struct ReportBackendActivity
        {
            ...
            public readonly partial struct TracesEntity
            {
...
#endif
                {
                    ...
                    public void SetDisableStage(in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryBackend.ReportBackendActivity.TracesEntity.DisableThisStage.Source value)
                    {
                        CheckValidInstance();
                ...
                public ref struct Source
                {
                    ...
                    internal Source(in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryBackend.ReportBackendActivity.TracesEntity.DisableThisStage.Source arg1)
                    {
                        _createArg1 = arg1;
                        _kind = Kind.Create;
                    }
                ...
                public ref struct Builder
                {
                    ...
                    internal static void BuildCreateValue(in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryBackend.ReportBackendActivity.TracesEntity.DisableThisStage.Source arg1, ref ComplexValueBuilder o)
                    {
                        o.StartObject();
                        Create(ref o, arg1);
                        o.EndObject();
                ...
                /// <returns>The source from which to build the value.</returns>
                public static Source Build(in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryBackend.ReportBackendActivity.TracesEntity.DisableThisStage.Source disableStage = default)
                {
