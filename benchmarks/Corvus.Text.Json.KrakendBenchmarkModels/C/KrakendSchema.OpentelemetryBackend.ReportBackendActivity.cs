...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct OpentelemetryBackend
    {
...
#endif
        {
            ...
            /// </summary>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryBackend.ReportBackendActivity.MetricsEntity Metrics
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MetricsUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryBackend.ReportBackendActivity.MetricsEntity value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryBackend.ReportBackendActivity.TracesEntity Traces
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TracesUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryBackend.ReportBackendActivity.TracesEntity value))
                    {
                        return value;
                    }
