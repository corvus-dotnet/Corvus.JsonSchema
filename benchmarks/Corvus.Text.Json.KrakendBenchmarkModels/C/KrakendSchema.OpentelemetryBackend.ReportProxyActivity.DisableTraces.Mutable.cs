...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct OpentelemetryBackend
    {
        ...
        public readonly partial struct ReportProxyActivity
        {
            ...
            public readonly partial struct DisableTraces
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DisableTraces, Mutable>(DisableTraces.DefaultInstance);
                    ...
                    public static explicit operator Mutable(DisableTraces instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="DisableTraces"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator DisableTraces(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new DisableTraces(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"DisableTraces.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="DisableTraces"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="DisableTraces"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DisableTraces Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<DisableTraces>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="DisableTraces"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DisableTraces Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<DisableTraces>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(DisableTraces instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<DisableTraces, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<DisableTraces> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<DisableTraces>();
                    }
                    finally
                    {
