...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct OpentelemetryBackend
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryBackend.ReportProxyActivity.DisableMetrics DisableMetricsValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DisableMetricsValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryBackend.ReportProxyActivity.DisableMetrics value))
                    {
                        return value;
                    }

                    return Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryBackend.ReportProxyActivity.DisableMetrics.DefaultInstance;
                }
            }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryBackend.ReportProxyActivity.DisableTraces DisableTracesValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DisableTracesValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryBackend.ReportProxyActivity.DisableTraces value))
                    {
                        return value;
                    }

                    return Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryBackend.ReportProxyActivity.DisableTraces.DefaultInstance;
                }
            }
            ...
            {
                /// <summary>
                /// Gets the JSON property name for <see cref="DisableMetricsValue"/>.
                /// </summary>
                public const string DisableMetricsValue = "disable_metrics";

                /// <summary>
                /// Gets the JSON property name for <see cref="DisableTracesValue"/>.
                /// </summary>
                public const string DisableTracesValue = "disable_traces";

                /// <summary>
                /// Gets the JSON property name for <see cref="DisableMetricsValue"/>.
                /// </summary>
                public static ReadOnlySpan<byte> DisableMetricsValueUtf8 => "disable_metrics"u8;

                /// <summary>
                /// Gets the JSON property name for <see cref="DisableTracesValue"/>.
                /// </summary>
                public static ReadOnlySpan<byte> DisableTracesValueUtf8 => "disable_traces"u8;
            }
            ...
            {
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="DisableMetricsValue"/>.
                /// </summary>
                public static ReadOnlySpan<byte> DisableMetricsValue => "disable_metrics"u8;

                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="DisableTracesValue"/>.
                /// </summary>
                public static ReadOnlySpan<byte> DisableTracesValue => "disable_traces"u8;
            }
            ...
            {
                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="DisableMetricsValue"/>.
                /// </summary>
                public static ReadOnlySpan<byte> DisableMetricsValue => [0x15, 0x01, 0x00, 0x00, 0x22, 0x64, 0x69, 0x73, 0x61, 0x62, 0x6C, 0x65, 0x5F, 0x6D, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x22];

                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="DisableTracesValue"/>.
                /// </summary>
                public static ReadOnlySpan<byte> DisableTracesValue => [0x05, 0x01, 0x00, 0x00, 0x22, 0x64, 0x69, 0x73, 0x61, 0x62, 0x6C, 0x65, 0x5F, 0x74, 0x72, 0x61, 0x63, 0x65, 0x73, 0x22];
            }
        }
    }
}
