    ...
    public readonly partial struct OpentelemetryEndpoint
    {
            ...
            : IJsonElement<ExportersOverride>
        {
            public static partial class JsonSchema
            {
                ...
                private static void MatchMetricReportingPeriod(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                ...
                private static void MatchTraceSampleRateValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
