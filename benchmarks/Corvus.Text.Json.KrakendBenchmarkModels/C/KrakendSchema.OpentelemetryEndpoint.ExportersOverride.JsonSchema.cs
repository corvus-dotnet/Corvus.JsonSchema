    ...
    public readonly partial struct OpentelemetryEndpoint
    {
            ...
            : IJsonElement<ExportersOverride>
        {
            public static partial class JsonSchema
            {
                ...
                private static void MatchMetricExporters(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                {
                ...
                private static void MatchMetricReportingPeriod(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext1 =
                        Corvus.KrakendBenchmark.Current.JsonInteger.JsonSchema.PushChildContextUnescaped(
                            ...
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.MetricReportingPeriodUtf8,
                            evaluationPath: MetricReportingPeriodSchemaEvaluationPath);
                ...
                private static void MatchTraceExporters(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                ...
                private static void MatchTraceSampleRateValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext3 =
                        Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryEndpoint.ExportersOverride.TraceSampleRate.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.TraceSampleRateValueUtf8,
                            evaluationPath: TraceSampleRateValueSchemaEvaluationPath);

                    Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryEndpoint.ExportersOverride.TraceSampleRate.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext3);
