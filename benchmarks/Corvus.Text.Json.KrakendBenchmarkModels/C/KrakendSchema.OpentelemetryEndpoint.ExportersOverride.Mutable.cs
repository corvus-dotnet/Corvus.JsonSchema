    ...
    public readonly partial struct OpentelemetryEndpoint
    {
        ...
        public readonly partial struct ExportersOverride
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.JsonInteger.Mutable MetricReportingPeriod
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MetricReportingPeriodUtf8, out Corvus.KrakendBenchmark.Current.JsonInteger.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryEndpoint.ExportersOverride.TraceSampleRate.Mutable TraceSampleRateValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TraceSampleRateValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryEndpoint.ExportersOverride.TraceSampleRate.Mutable value))
                        {
                            return value;
                        }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryEndpoint.ExportersOverride.TraceSampleRate.Source _createArg4;
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryEndpoint.ExportersOverride.TraceSampleRate.Source traceSampleRate = default)
                {
            ...
            /// </summary>
            /// <param name="metricExporters">The value of the <c>"metric_exporters"</c> property.</param>
            /// <param name="metricReportingPeriod">The value of the <c>"metric_reporting_period"</c> property.</param>
            ...
            public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.JsonArray.Source<TContext> metricExporters = default, scoped in Corvus.KrakendBenchmark.Current.JsonInteger.Source metricReportingPeriod = default, scoped in Corvus.KrakendBenchmark.Current.JsonArray.Source<TContext> traceExporters = default, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryEndpoint.ExportersOverride.TraceSampleRate.Source traceSampleRate = default)
                ...
                #endif
            {
                return new Source<TContext>(context, metricExporters, metricReportingPeriod, traceExporters, traceSampleRate);
            }
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.JsonArray.Source metricExporters = default, in Corvus.KrakendBenchmark.Current.JsonInteger.Source metricReportingPeriod = default, in Corvus.KrakendBenchmark.Current.JsonArray.Source traceExporters = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryEndpoint.ExportersOverride.TraceSampleRate.Source traceSampleRate = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.KrakendBenchmark.Current.JsonArray.Source<TContext> metricExporters = default, in Corvus.KrakendBenchmark.Current.JsonInteger.Source metricReportingPeriod = default, in Corvus.KrakendBenchmark.Current.JsonArray.Source<TContext> traceExporters = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryEndpoint.ExportersOverride.TraceSampleRate.Source traceSampleRate = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
            ...
            public static ParsedJsonDocument<ExportersOverride> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ExportersOverride>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<ExportersOverride> Create<TContext>(
            ...
            public static ParsedJsonDocument<ExportersOverride> Create(in Corvus.KrakendBenchmark.Current.JsonArray.Source metricExporters = default, in Corvus.KrakendBenchmark.Current.JsonInteger.Source metricReportingPeriod = default, in Corvus.KrakendBenchmark.Current.JsonArray.Source traceExporters = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryEndpoint.ExportersOverride.TraceSampleRate.Source traceSampleRate = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
            public static ParsedJsonDocument<ExportersOverride> Create<TContext>(in TContext context, in Corvus.KrakendBenchmark.Current.JsonArray.Source<TContext> metricExporters = default, in Corvus.KrakendBenchmark.Current.JsonInteger.Source metricReportingPeriod = default, in Corvus.KrakendBenchmark.Current.JsonArray.Source<TContext> traceExporters = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryEndpoint.ExportersOverride.TraceSampleRate.Source traceSampleRate = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
