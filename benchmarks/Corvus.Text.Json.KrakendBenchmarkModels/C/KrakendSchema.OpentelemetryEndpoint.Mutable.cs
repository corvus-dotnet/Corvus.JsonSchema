...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct OpentelemetryEndpoint
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(OpentelemetryEndpoint instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="OpentelemetryEndpoint"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator OpentelemetryEndpoint(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryEndpoint.ExportersOverride.Mutable ExportersOverrideValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExportersOverrideValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryEndpoint.ExportersOverride.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryEndpoint.ReportProxyActivity.Mutable Proxy
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ProxyUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryEndpoint.ReportProxyActivity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetExportersOverrideValue<TContext>(in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryEndpoint.ExportersOverride.Source<TContext> value)
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetProxy<TContext>(in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryEndpoint.ReportProxyActivity.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"OpentelemetryEndpoint.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly OpentelemetryEndpoint Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly OpentelemetryEndpoint Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<OpentelemetryEndpoint>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryEndpoint.ExportersOverride.Source _createArg1;
            private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryEndpoint.ReportProxyActivity.Source _createArg2;
            ...
            public static implicit operator Source(OpentelemetryEndpoint instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryEndpoint.ExportersOverride.Source<TContext> _createArg1;
            private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryEndpoint.ReportProxyActivity.Source<TContext> _createArg2;
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="OpentelemetryEndpoint"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryEndpoint.ExportersOverride.Source exportersOverride = default,
                in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryEndpoint.ReportProxyActivity.Source proxy = default)
            {
            ...
            /// Creates an instance of a <see cref="OpentelemetryEndpoint"/>.
            /// </summary>
            public void Create(in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryEndpoint.ExportersOverride.Source exportersOverride = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryEndpoint.ReportProxyActivity.Source proxy = default)
            {
            ...
            internal static void Create<TContext>(
                in TContext context,
                ref ComplexValueBuilder builder,
                in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryEndpoint.ExportersOverride.Source<TContext> exportersOverride = default,
                in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryEndpoint.ReportProxyActivity.Source<TContext> proxy = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
        ...
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryEndpoint.ExportersOverride.Source<TContext> exportersOverride = default, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryEndpoint.ReportProxyActivity.Source<TContext> proxy = default)
            ...
            #endif
        {
            return new Source<TContext>(context, exportersOverride, proxy);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryEndpoint.ExportersOverride.Source exportersOverride = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryEndpoint.ReportProxyActivity.Source proxy = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryEndpoint.ExportersOverride.Source<TContext> exportersOverride = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryEndpoint.ReportProxyActivity.Source<TContext> proxy = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
        ...
        {
            return workspace.CreateBuilder<OpentelemetryEndpoint, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<OpentelemetryEndpoint> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<OpentelemetryEndpoint>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<OpentelemetryEndpoint> Create<TContext>(
        ...
        public static ParsedJsonDocument<OpentelemetryEndpoint> Create(in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryEndpoint.ExportersOverride.Source exportersOverride = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryEndpoint.ReportProxyActivity.Source proxy = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<OpentelemetryEndpoint> Create<TContext>(in TContext context, in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryEndpoint.ExportersOverride.Source<TContext> exportersOverride = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryEndpoint.ReportProxyActivity.Source<TContext> proxy = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
