...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct OpentelemetryEndpoint
        ...
        : IJsonElement<OpentelemetryEndpoint>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OpentelemetryEndpoint"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal OpentelemetryEndpoint(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static OpentelemetryEndpoint DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryEndpoint.ExportersOverride ExportersOverrideValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExportersOverrideValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryEndpoint.ExportersOverride value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryEndpoint.ReportProxyActivity Proxy
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ProxyUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetryEndpoint.ReportProxyActivity value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in OpentelemetryEndpoint left, in OpentelemetryEndpoint right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in OpentelemetryEndpoint left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(OpentelemetryEndpoint instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator OpentelemetryEndpoint(JsonElement instance)
        {
            return OpentelemetryEndpoint.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static OpentelemetryEndpoint From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static OpentelemetryEndpoint ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<OpentelemetryEndpoint>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static OpentelemetryEndpoint ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<OpentelemetryEndpoint>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static OpentelemetryEndpoint ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<OpentelemetryEndpoint>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static OpentelemetryEndpoint ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<OpentelemetryEndpoint>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out OpentelemetryEndpoint? result)
        {
            return JsonElementHelpers.TryParseValue<OpentelemetryEndpoint>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new OpentelemetryEndpoint(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static OpentelemetryEndpoint IJsonElement<OpentelemetryEndpoint>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"OpentelemetryEndpoint: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="OpentelemetryEndpoint"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="OpentelemetryEndpoint"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public OpentelemetryEndpoint Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<OpentelemetryEndpoint>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="OpentelemetryEndpoint"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public OpentelemetryEndpoint Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<OpentelemetryEndpoint>(_idx);
            }
