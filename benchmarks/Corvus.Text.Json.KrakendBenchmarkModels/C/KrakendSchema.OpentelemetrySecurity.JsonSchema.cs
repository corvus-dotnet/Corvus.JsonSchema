...
public readonly partial struct KrakendSchema
{
        ...
        : IJsonElement<OpentelemetrySecurity>
    {
        ...
        {
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyOtlpPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("otlp"u8, buffer, out written);
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyOtlpNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("otlp"u8, buffer, out written);

            private const int RequiredOffsetForOtlp = 0;
            private const uint RequiredBitForOtlp = 0b00000000000000000000000000000001;
            ...
            private static void MatchOtlp(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext =
                    Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetrySecurity.RequiredHeadersAndNameArray.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetrySecurity.RequiredHeadersAndNameArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                ...
                requiredBitBuffer[RequiredOffsetForOtlp] |= RequiredBitForOtlp;
            }
            ...
            {
                if (span.SequenceEqual(JsonPropertyNames.OtlpUtf8))
                {
                    matcher = MatchOtlp;
                    return true;
                }
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1telemetry~1opentelemetry-security.json"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1telemetry~1opentelemetry-security.json";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1telemetry~1opentelemetry-security.json"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyOtlpPresent, "otlp"u8, "required"u8);
                    }
                    ...
                    {
                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForOtlp] & RequiredBitForOtlp) == 0)
                        {
                            context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyOtlpNotPresent, "otlp"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyOtlpPresent, "otlp"u8, "required"u8);
