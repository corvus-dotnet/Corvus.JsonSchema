        ...
        public readonly partial struct RequiredHeadersAndNameArray
        {
            ...
            public readonly partial struct RequiredHeadersAndName
            {
...
#endif
                {
                    ...
                    public void SetHeadersValue(in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetrySecurity.RequiredHeadersAndNameArray.RequiredHeadersAndName.Headers.Source value)
                    {
                        CheckValidInstance();
                ...
                public ref struct Source
                {
                    ...
                    internal Source(in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetrySecurity.RequiredHeadersAndNameArray.RequiredHeadersAndName.Headers.Source arg1, in Corvus.KrakendBenchmark.Current.JsonString.Source arg2)
                    {
                        _createArg1 = arg1;
                        _createArg2 = arg2;
                        _kind = Kind.Create;
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetrySecurity.RequiredHeadersAndNameArray.RequiredHeadersAndName.Headers.Source<TContext> arg1, in Corvus.KrakendBenchmark.Current.JsonString.Source arg2)
                    {
                        _context = context;
                        _createArg1 = arg1;
                        _createArg2 = arg2;
                ...
                public ref struct Builder
                {
                    ...
                    internal static void BuildCreateValue(in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetrySecurity.RequiredHeadersAndNameArray.RequiredHeadersAndName.Headers.Source arg1, in Corvus.KrakendBenchmark.Current.JsonString.Source arg2, ref ComplexValueBuilder o)
                    {
                        o.StartObject();
                    ...
                    /// <param name="arg2">The value of the property.</param>
                    /// <param name="o">The complex value builder into which to write the object.</param>
                    internal static void BuildCreateValue<TContext>(scoped in TContext context, in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetrySecurity.RequiredHeadersAndNameArray.RequiredHeadersAndName.Headers.Source<TContext> arg1, in Corvus.KrakendBenchmark.Current.JsonString.Source arg2, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                        where TContext : allows ref struct
#endif
                    {
                ...
                /// <returns>The source from which to build the value.</returns>
                public static Source Build(in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetrySecurity.RequiredHeadersAndNameArray.RequiredHeadersAndName.Headers.Source headers, in Corvus.KrakendBenchmark.Current.JsonString.Source name)
                {
                ...
                /// <param name="name">The value of the <c>"name"</c> property.</param>
                /// <returns>The source from which to build the value.</returns>
                public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetrySecurity.RequiredHeadersAndNameArray.RequiredHeadersAndName.Headers.Source<TContext> headers, in Corvus.KrakendBenchmark.Current.JsonString.Source name)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
