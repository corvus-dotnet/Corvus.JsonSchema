        ...
        public readonly partial struct RequiredHeadersAndNameArray
        {
            ...
            public readonly partial struct RequiredHeadersAndName
            {
...
#endif
                {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetrySecurity.RequiredHeadersAndNameArray.RequiredHeadersAndName.Headers.Mutable HeadersValue
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HeadersValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetrySecurity.RequiredHeadersAndNameArray.RequiredHeadersAndName.Headers.Mutable value))
                            {
                                return value;
                            }
                    ...
                    public void SetHeadersValue(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetrySecurity.RequiredHeadersAndNameArray.RequiredHeadersAndName.Headers.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetHeadersValue<TContext>(in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetrySecurity.RequiredHeadersAndNameArray.RequiredHeadersAndName.Headers.Source<TContext> value)
                ...
                public ref struct Source
                {
                    ...
                    private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetrySecurity.RequiredHeadersAndNameArray.RequiredHeadersAndName.Headers.Source _createArg1;
                    ...
                    internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetrySecurity.RequiredHeadersAndNameArray.RequiredHeadersAndName.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    internal Source(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetrySecurity.RequiredHeadersAndNameArray.RequiredHeadersAndName.Headers.Source arg1, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg2)
                    {
                        _createArg1 = arg1;
                        _createArg2 = arg2;
                        _kind = Kind.Create;
                    ...
                    #endif
                {
                    ...
                    private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetrySecurity.RequiredHeadersAndNameArray.RequiredHeadersAndName.Headers.Source<TContext> _createArg1;
                    private readonly Corvus.KrakendBenchmark.Current.JsonString.Source _createArg2;
                    ...
                    internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetrySecurity.RequiredHeadersAndNameArray.RequiredHeadersAndName.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

                    internal Source(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetrySecurity.RequiredHeadersAndNameArray.RequiredHeadersAndName.Headers.Source<TContext> arg1, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg2)
                    {
                        _context = context;
                        _createArg1 = arg1;
                        _createArg2 = arg2;
                ...
                public ref struct Builder
                {
                    ...
                    internal static void Create(
                        ...
                        in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetrySecurity.RequiredHeadersAndNameArray.RequiredHeadersAndName.Headers.Source headers,
                    ...
                    /// Creates an instance of a <see cref="RequiredHeadersAndName"/>.
                    /// </summary>
                    public void Create(in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetrySecurity.RequiredHeadersAndNameArray.RequiredHeadersAndName.Headers.Source headers, in Corvus.KrakendBenchmark.Current.JsonString.Source name)
                    {
                    ...
                    internal static void Create<TContext>(
                        in TContext context,
                        ref ComplexValueBuilder builder,
                        in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetrySecurity.RequiredHeadersAndNameArray.RequiredHeadersAndName.Headers.Source<TContext> headers,
                        in Corvus.KrakendBenchmark.Current.JsonString.Source name)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                    ...
                    internal static void BuildCreateValue(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetrySecurity.RequiredHeadersAndNameArray.RequiredHeadersAndName.Headers.Source arg1, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg2, ref ComplexValueBuilder o)
                    {
                        o.StartObject();
                    ...
                    /// <param name="arg2">The value of the property.</param>
                    /// <param name="o">The complex value builder into which to write the object.</param>
                    internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetrySecurity.RequiredHeadersAndNameArray.RequiredHeadersAndName.Headers.Source<TContext> arg1, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg2, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                        where TContext : allows ref struct
#endif
                    {
                ...
                /// <returns>The source from which to build the value.</returns>
                public static Source Build(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetrySecurity.RequiredHeadersAndNameArray.RequiredHeadersAndName.Headers.Source headers, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source name)
                {
                    return new Source(headers, name);
                }
                ...
                /// <param name="name">The value of the <c>"name"</c> property.</param>
                /// <returns>The source from which to build the value.</returns>
                public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetrySecurity.RequiredHeadersAndNameArray.RequiredHeadersAndName.Headers.Source<TContext> headers, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source name)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
                    return new Source<TContext>(context, headers, name);
                }
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetrySecurity.RequiredHeadersAndNameArray.RequiredHeadersAndName.Headers.Source headers, in Corvus.KrakendBenchmark.Current.JsonString.Source name, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetrySecurity.RequiredHeadersAndNameArray.RequiredHeadersAndName.Headers.Source<TContext> headers, in Corvus.KrakendBenchmark.Current.JsonString.Source name, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
                ...
                public static ParsedJsonDocument<RequiredHeadersAndName> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<RequiredHeadersAndName>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<RequiredHeadersAndName> Create<TContext>(
                ...
                public static ParsedJsonDocument<RequiredHeadersAndName> Create(in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetrySecurity.RequiredHeadersAndNameArray.RequiredHeadersAndName.Headers.Source headers, in Corvus.KrakendBenchmark.Current.JsonString.Source name, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
                public static ParsedJsonDocument<RequiredHeadersAndName> Create<TContext>(in TContext context, in Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetrySecurity.RequiredHeadersAndNameArray.RequiredHeadersAndName.Headers.Source<TContext> headers, in Corvus.KrakendBenchmark.Current.JsonString.Source name, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
