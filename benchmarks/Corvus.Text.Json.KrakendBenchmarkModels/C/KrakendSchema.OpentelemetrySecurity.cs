...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct OpentelemetrySecurity
        ...
        : IJsonElement<OpentelemetrySecurity>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OpentelemetrySecurity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal OpentelemetrySecurity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static OpentelemetrySecurity DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetrySecurity.RequiredHeadersAndNameArray Otlp
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OtlpUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.OpentelemetrySecurity.RequiredHeadersAndNameArray value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in OpentelemetrySecurity left, in OpentelemetrySecurity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in OpentelemetrySecurity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(OpentelemetrySecurity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator OpentelemetrySecurity(JsonElement instance)
        {
            return OpentelemetrySecurity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static OpentelemetrySecurity From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static OpentelemetrySecurity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<OpentelemetrySecurity>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static OpentelemetrySecurity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<OpentelemetrySecurity>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static OpentelemetrySecurity ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<OpentelemetrySecurity>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static OpentelemetrySecurity ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<OpentelemetrySecurity>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out OpentelemetrySecurity? result)
        {
            return JsonElementHelpers.TryParseValue<OpentelemetrySecurity>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new OpentelemetrySecurity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static OpentelemetrySecurity IJsonElement<OpentelemetrySecurity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"OpentelemetrySecurity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="OpentelemetrySecurity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="OpentelemetrySecurity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public OpentelemetrySecurity Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<OpentelemetrySecurity>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="OpentelemetrySecurity"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public OpentelemetrySecurity Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<OpentelemetrySecurity>(_idx);
            }
        ...
        {
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="Otlp"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Otlp => [0x65, 0x00, 0x00, 0x00, 0x22, 0x6F, 0x74, 0x6C, 0x70, 0x22];
        }
    }
}
