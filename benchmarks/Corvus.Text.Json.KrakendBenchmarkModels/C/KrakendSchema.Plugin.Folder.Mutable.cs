    ...
    public readonly partial struct Plugin
    {
        ...
        public readonly partial struct Folder
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<Folder, Mutable>(Folder.DefaultInstance);
            ...
            public static ParsedJsonDocument<Folder> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<Folder>();
                }
                finally
                {
