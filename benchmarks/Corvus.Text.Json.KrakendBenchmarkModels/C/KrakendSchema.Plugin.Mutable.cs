...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Plugin
    {
...
#endif
        {
            ...
            public void SetFolderValue(in Corvus.KrakendBenchmark.Current.KrakendSchema.Plugin.Folder.Source value)
            {
                ...
                else
                {
                    ...
                    value.AddAsProperty(JsonPropertyNamesEscaped.FolderValue, ref cvb, escapeName: false, nameRequiresUnescaping: false);
            ...
            public void SetPatternValue(in Corvus.KrakendBenchmark.Current.KrakendSchema.Plugin.Pattern.Source value)
            {
                ...
                {
                    // We are going to insert the new value
                    value.AddAsProperty(JsonPropertyNamesEscaped.PatternValue, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
        ...
        public ref struct Builder
        {
            ...
            {
                folder.AddAsProperty(JsonPropertyNamesEscaped.FolderValue, ref builder, escapeName: false);
                pattern.AddAsProperty(JsonPropertyNamesEscaped.PatternValue, ref builder, escapeName: false);
            }
