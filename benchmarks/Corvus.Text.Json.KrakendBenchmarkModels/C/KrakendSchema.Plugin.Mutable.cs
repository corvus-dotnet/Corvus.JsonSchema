...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Plugin
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Plugin instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Plugin"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Plugin(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.Plugin.Folder.Mutable FolderValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FolderValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Plugin.Folder.Mutable value))
                    {
                        return value;
                    }

                    return Corvus.KrakendBenchmark.Current.KrakendSchema.Plugin.Folder.Mutable.DefaultInstance;
                }
            }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.Plugin.Pattern.Mutable PatternValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PatternValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Plugin.Pattern.Mutable value))
                    {
                        return value;
                    }

                    return Corvus.KrakendBenchmark.Current.KrakendSchema.Plugin.Pattern.Mutable.DefaultInstance;
                }
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Plugin(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetFolderValue(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Plugin.Folder.Source value)
            {
                ...
                {
                    CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("folder");
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FolderValueUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                ...
                else
                {
                    ...
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.FolderValue, ref cvb);
            ...
            public void SetPatternValue(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Plugin.Pattern.Source value)
            {
                ...
                if (value.IsUndefined)
                {
                    CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("pattern");
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PatternValueUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.PatternValue, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Plugin.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Plugin"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Plugin"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly Plugin Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<Plugin>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Plugin"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly Plugin Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Plugin>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Plugin.Folder.Source _createArg1;
            private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Plugin.Pattern.Source _createArg2;
            ...
            public static implicit operator Source(Plugin instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Plugin.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="Plugin"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.KrakendBenchmark.Current.KrakendSchema.Plugin.Folder.Source folder,
                in Corvus.KrakendBenchmark.Current.KrakendSchema.Plugin.Pattern.Source pattern)
            {
                folder.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.FolderValue, ref builder);
                pattern.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.PatternValue, ref builder);
            }

            /// <summary>
            /// Creates an instance of a <see cref="Plugin"/>.
            /// </summary>
            public void Create(in Corvus.KrakendBenchmark.Current.KrakendSchema.Plugin.Folder.Source folder, in Corvus.KrakendBenchmark.Current.KrakendSchema.Plugin.Pattern.Source pattern)
            {
                Create(ref _builder, folder, pattern);
            }
        ...
        /// </summary>
        /// <param name="workspace">The JSON workspace.</param>
        /// <param name="folder">The value of the property.</param>
        /// <param name="pattern">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.KrakendSchema.Plugin.Folder.Source folder, in Corvus.KrakendBenchmark.Current.KrakendSchema.Plugin.Pattern.Source pattern, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(folder, pattern);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<Plugin, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<Plugin> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Plugin>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Plugin> Create<TContext>(
        ...
        public static ParsedJsonDocument<Plugin> Create(in Corvus.KrakendBenchmark.Current.KrakendSchema.Plugin.Folder.Source folder, in Corvus.KrakendBenchmark.Current.KrakendSchema.Plugin.Pattern.Source pattern, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
