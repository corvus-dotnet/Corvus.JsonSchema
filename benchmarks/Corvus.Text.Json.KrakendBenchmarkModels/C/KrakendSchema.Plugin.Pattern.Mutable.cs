    ...
    public readonly partial struct Plugin
    {
        ...
        public readonly partial struct Pattern
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<Pattern, Mutable>(Pattern.DefaultInstance);
            ...
            public static ParsedJsonDocument<Pattern> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<Pattern>();
                }
                finally
                {
