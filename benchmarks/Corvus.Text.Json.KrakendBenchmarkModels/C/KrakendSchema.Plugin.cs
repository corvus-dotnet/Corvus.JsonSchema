...
public readonly partial struct KrakendSchema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.Plugin.Folder FolderValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FolderValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Plugin.Folder value))
                {
                    return value;
                }

                return Corvus.KrakendBenchmark.Current.KrakendSchema.Plugin.Folder.DefaultInstance;
            }
        }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.Plugin.Pattern PatternValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PatternValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Plugin.Pattern value))
                {
                    return value;
                }

                return Corvus.KrakendBenchmark.Current.KrakendSchema.Plugin.Pattern.DefaultInstance;
            }
        }
        ...
        {
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="FolderValue"/>.
            /// </summary>
            public static ReadOnlySpan<byte> FolderValue => [0x85, 0x00, 0x00, 0x00, 0x22, 0x66, 0x6F, 0x6C, 0x64, 0x65, 0x72, 0x22];
