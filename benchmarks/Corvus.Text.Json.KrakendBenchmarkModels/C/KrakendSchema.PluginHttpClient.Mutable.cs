...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct PluginHttpClient
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(PluginHttpClient instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="PluginHttpClient"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PluginHttpClient(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PluginHttpClient.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly PluginHttpClient Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly PluginHttpClient Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<PluginHttpClient>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.PluginHttpClient.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            public static implicit operator Source(PluginHttpClient instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.PluginHttpClient.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="PluginHttpClient"/>.
            /// </summary>
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source name = default)
        {
        ...
        {
            return workspace.CreateBuilder<PluginHttpClient, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<PluginHttpClient> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<PluginHttpClient>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<PluginHttpClient> Create<TContext>(
        ...
        public static ParsedJsonDocument<PluginHttpClient> Create(in Corvus.KrakendBenchmark.Current.JsonString.Source name = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
