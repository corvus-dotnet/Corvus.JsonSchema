...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct PluginHttpClient
#if NET8_0_OR_GREATER
        : IJsonElement<PluginHttpClient>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PluginHttpClient"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal PluginHttpClient(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static PluginHttpClient DefaultInstance { get; }
        ...
        /// </returns>
        public static bool operator ==(in PluginHttpClient left, in PluginHttpClient right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in PluginHttpClient left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(PluginHttpClient instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PluginHttpClient(JsonElement instance)
        {
            return PluginHttpClient.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PluginHttpClient From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PluginHttpClient ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PluginHttpClient>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PluginHttpClient ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PluginHttpClient>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PluginHttpClient ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PluginHttpClient>(json, options);
        }
        ...
        /// </exception>
        public static PluginHttpClient ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<PluginHttpClient>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out PluginHttpClient? result)
        {
            return JsonElementHelpers.TryParseValue<PluginHttpClient>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new PluginHttpClient(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static PluginHttpClient IJsonElement<PluginHttpClient>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PluginHttpClient: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="PluginHttpClient"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="PluginHttpClient"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public PluginHttpClient Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<PluginHttpClient>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="PluginHttpClient"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public PluginHttpClient Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<PluginHttpClient>(_idx);
            }
