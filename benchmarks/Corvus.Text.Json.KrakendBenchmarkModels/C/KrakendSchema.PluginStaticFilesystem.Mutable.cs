...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct PluginStaticFilesystem
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(PluginStaticFilesystem instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="PluginStaticFilesystem"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PluginStaticFilesystem(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new PluginStaticFilesystem(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PluginStaticFilesystem.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="PluginStaticFilesystem"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="PluginStaticFilesystem"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly PluginStaticFilesystem Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<PluginStaticFilesystem>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="PluginStaticFilesystem"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly PluginStaticFilesystem Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<PluginStaticFilesystem>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.PluginStaticFilesystem.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg1, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg2, scoped in Corvus.KrakendBenchmark.Current.JsonArray.Source arg3)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _createArg3 = arg3;
            ...
            public static implicit operator Source(PluginStaticFilesystem instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.PluginStaticFilesystem.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg1, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg2, scoped in Corvus.KrakendBenchmark.Current.JsonArray.Source<TContext> arg3)
            {
                _context = context;
                _createArg1 = arg1;
                _createArg2 = arg2;
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="PluginStaticFilesystem"/>.
            /// </summary>
            ...
            internal static void BuildCreateValue(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg1, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg2, scoped in Corvus.KrakendBenchmark.Current.JsonArray.Source arg3, ref ComplexValueBuilder o)
            {
                o.StartObject();
            ...
            /// <param name="arg3">The value of the property.</param>
            /// <param name="o">The complex value builder into which to write the object.</param>
            internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg1, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg2, scoped in Corvus.KrakendBenchmark.Current.JsonArray.Source<TContext> arg3, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source path, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source prefix, scoped in Corvus.KrakendBenchmark.Current.JsonArray.Source skip = default)
        {
            return new Source(path, prefix, skip);
        }
        ...
        /// <param name="skip">The value of the <c>"skip"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source path, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source prefix, scoped in Corvus.KrakendBenchmark.Current.JsonArray.Source<TContext> skip = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            return new Source<TContext>(context, path, prefix, skip);
        }
        ...
        {
            return workspace.CreateBuilder<PluginStaticFilesystem, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<PluginStaticFilesystem> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<PluginStaticFilesystem>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<PluginStaticFilesystem> Create<TContext>(
        ...
        public static ParsedJsonDocument<PluginStaticFilesystem> Create(in Corvus.KrakendBenchmark.Current.JsonString.Source path, in Corvus.KrakendBenchmark.Current.JsonString.Source prefix, in Corvus.KrakendBenchmark.Current.JsonArray.Source skip = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<PluginStaticFilesystem> Create<TContext>(in TContext context, in Corvus.KrakendBenchmark.Current.JsonString.Source path, in Corvus.KrakendBenchmark.Current.JsonString.Source prefix, in Corvus.KrakendBenchmark.Current.JsonArray.Source<TContext> skip = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
