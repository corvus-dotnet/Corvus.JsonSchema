    ...
    public readonly partial struct Policies
    {
        ...
        public readonly partial struct AutoJoinPolicies
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<AutoJoinPolicies, Mutable>(AutoJoinPolicies.DefaultInstance);
            ...
            public static ParsedJsonDocument<AutoJoinPolicies> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<AutoJoinPolicies>();
                }
                finally
                {
