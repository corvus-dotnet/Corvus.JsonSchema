    ...
    public readonly partial struct Policies
    {
        ...
        public readonly partial struct DisableAdvancedMacros
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DisableAdvancedMacros, Mutable>(DisableAdvancedMacros.DefaultInstance);
            ...
            public static ParsedJsonDocument<DisableAdvancedMacros> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<DisableAdvancedMacros>();
                }
                finally
                {
