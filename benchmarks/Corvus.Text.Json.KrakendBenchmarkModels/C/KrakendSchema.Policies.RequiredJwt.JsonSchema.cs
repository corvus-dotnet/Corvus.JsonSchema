    ...
    public readonly partial struct Policies
    {
            ...
            : IJsonElement<RequiredJwt>
        {
            public static partial class JsonSchema
            {
                ...
                private static void MatchJwt(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1security~1policies.json/anyOf/2"u8, buffer, out written);
