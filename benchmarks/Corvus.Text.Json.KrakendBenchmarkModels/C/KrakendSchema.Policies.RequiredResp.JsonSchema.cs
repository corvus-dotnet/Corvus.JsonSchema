...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Policies
    {
        ...
        public readonly partial struct RequiredResp
            : IJsonElement<RequiredResp>
        {
            public static partial class JsonSchema
            {
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyRespPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("resp"u8, buffer, out written);
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyRespNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("resp"u8, buffer, out written);

                private const int RequiredOffsetForResp = 0;
                private const uint RequiredBitForResp = 0b00000000000000000000000000000001;

                private const uint RequiredBitMask0 =
                    RequiredBitForResp;

                private static void MatchResp(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    requiredBitBuffer[RequiredOffsetForResp] |= RequiredBitForResp;
                }
                ...
                {
                    if (span.SequenceEqual(JsonPropertyNames.RespUtf8))
                    {
                        matcher = MatchResp;
                        return true;
                    }
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1security~1policies.json/anyOf/1"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1security~1policies.json/anyOf/1";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1security~1policies.json/anyOf/1"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.StartObject)
                    {
                        ...
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyRespPresent, "resp"u8, "required"u8);
                        }
                        ...
                        {
                            if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForResp] & RequiredBitForResp) == 0)
                            {
                                context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyRespNotPresent, "resp"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyRespPresent, "resp"u8, "required"u8);
