    ...
    public readonly partial struct Policies
    {
            ...
            : IJsonElement<RequiredResp>
        {
            public static partial class JsonSchema
            {
                ...
                private static void MatchResp(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                {
