    ...
    public readonly partial struct Policies
    {
        ...
        public readonly partial struct RequiredResp
        {
...
#endif
            {
                ...
                public void SetResp(in Corvus.Text.Json.JsonElement.Source value)
                {
                    CheckValidInstance();
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(in Corvus.Text.Json.JsonElement.Source resp)
            {
            ...
            /// <param name="resp">The value of the <c>"resp"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> resp)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
