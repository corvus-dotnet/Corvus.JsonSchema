            ...
            public readonly partial struct ErrorEntity
            {
                ...
                public readonly partial struct HttpStatusCode
                {
...
#endif
                    {
                        ...
                        /// </remarks>
                        public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<HttpStatusCode, Mutable>(HttpStatusCode.DefaultInstance);
                        ...
                        public static explicit operator Mutable(HttpStatusCode instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="HttpStatusCode"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator HttpStatusCode(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"HttpStatusCode.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly HttpStatusCode Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly HttpStatusCode Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<HttpStatusCode>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(HttpStatusCode instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<HttpStatusCode, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<HttpStatusCode> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<HttpStatusCode>();
                        }
                        finally
                        {
