    ...
    public readonly partial struct Policies
    {
        ...
        public readonly partial struct ResponsePolicies
        {
            ...
            public readonly partial struct ErrorEntity
            {
                ...
                public readonly partial struct HttpStatusCode
#if NET8_0_OR_GREATER
                    : IJsonElement<HttpStatusCode>,
                      IFormattable,
                      ISpanFormattable,
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="HttpStatusCode"/> struct.
                    /// </summary>
                    ...
                    internal HttpStatusCode(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static HttpStatusCode DefaultInstance { get; } = ParsedJsonDocument<HttpStatusCode>.NumberConstant([.."500"u8]);
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static explicit operator System.Numerics.BigInteger(HttpStatusCode value) => value._parent.TryGetValue(value._idx, out System.Numerics.BigInteger result) ? result : throw new FormatException();

                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static explicit operator decimal(HttpStatusCode value) => value._parent.TryGetValue(value._idx, out decimal result) ? result : throw new FormatException();

                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static explicit operator sbyte(HttpStatusCode value) => value._parent.TryGetValue(value._idx, out sbyte result) ? result : throw new FormatException();

                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static explicit operator byte(HttpStatusCode value) => value._parent.TryGetValue(value._idx, out byte result) ? result : throw new FormatException();

                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static explicit operator short(HttpStatusCode value) => value._parent.TryGetValue(value._idx, out short result) ? result : throw new FormatException();

                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static explicit operator ushort(HttpStatusCode value) => value._parent.TryGetValue(value._idx, out ushort result) ? result : throw new FormatException();

                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static explicit operator int(HttpStatusCode value) => value._parent.TryGetValue(value._idx, out int result) ? result : throw new FormatException();

                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static explicit operator uint(HttpStatusCode value) => value._parent.TryGetValue(value._idx, out uint result) ? result : throw new FormatException();

                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static explicit operator ulong(HttpStatusCode value) => value._parent.TryGetValue(value._idx, out ulong result) ? result : throw new FormatException();

                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static explicit operator float(HttpStatusCode value) => value._parent.TryGetValue(value._idx, out float result) ? result : throw new FormatException();

#if NET
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static explicit operator Int128(HttpStatusCode value) => value._parent.TryGetValue(value._idx, out Int128 result) ? result : throw new FormatException();
#endif

#if NET
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static explicit operator UInt128(HttpStatusCode value) => value._parent.TryGetValue(value._idx, out UInt128 result) ? result : throw new FormatException();
#endif

#if NET
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static explicit operator Half(HttpStatusCode value) => value._parent.TryGetValue(value._idx, out Half result) ? result : throw new FormatException();
#endif
                    ...
                    /// </returns>
                    public static bool operator ==(in HttpStatusCode left, in HttpStatusCode right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in HttpStatusCode left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator JsonElement(HttpStatusCode instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator HttpStatusCode(JsonElement instance)
                    {
                        return HttpStatusCode.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static HttpStatusCode From<T>(in T instance)
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static HttpStatusCode ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        #pragma warning disable CS0618 // Type or member is obsolete
                        return JsonElementHelpers.ParseValue<HttpStatusCode>(utf8Json, options);
                    ...
                    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static HttpStatusCode ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        #pragma warning disable CS0618 // Type or member is obsolete
                        return JsonElementHelpers.ParseValue<HttpStatusCode>(json, options);
                        #pragma warning restore CS0618
                    }
                    ...
                    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static HttpStatusCode ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        #pragma warning disable CS0618 // Type or member is obsolete
                        return JsonElementHelpers.ParseValue<HttpStatusCode>(json, options);
                        #pragma warning restore CS0618
                    ...
                    /// </exception>
                    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                    public static HttpStatusCode ParseValue(ref Utf8JsonReader reader)
                    {
                        #pragma warning disable CS0618 // Type or member is obsolete
                        return JsonElementHelpers.ParseValue<HttpStatusCode>(ref reader);
                        #pragma warning restore CS0618
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out HttpStatusCode? result)
                    {
                        return JsonElementHelpers.TryParseValue<HttpStatusCode>(ref reader, out result);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new HttpStatusCode(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                    static HttpStatusCode IJsonElement<HttpStatusCode>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"HttpStatusCode: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="HttpStatusCode"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="HttpStatusCode"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public HttpStatusCode Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<HttpStatusCode>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="HttpStatusCode"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public HttpStatusCode Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<HttpStatusCode>(_idx);
                        }
