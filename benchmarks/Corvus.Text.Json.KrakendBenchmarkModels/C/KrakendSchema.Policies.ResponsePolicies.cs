...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Policies
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ResponsePolicies"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ResponsePolicies(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ResponsePolicies DefaultInstance { get; }
            ...
            /// </summary>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.Policies.ResponsePolicies.ErrorEntity Error
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ErrorUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Policies.ResponsePolicies.ErrorEntity value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.Policies.ResponsePolicies.JsonStringArray Policies
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PoliciesUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Policies.ResponsePolicies.JsonStringArray value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in ResponsePolicies left, in ResponsePolicies right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ResponsePolicies left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(ResponsePolicies instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ResponsePolicies(JsonElement instance)
            {
                return ResponsePolicies.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ResponsePolicies From<T>(in T instance)
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ResponsePolicies ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<ResponsePolicies>(utf8Json, options);
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ResponsePolicies ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<ResponsePolicies>(json, options);
                #pragma warning restore CS0618
            }
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ResponsePolicies ParseValue(string json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<ResponsePolicies>(json, options);
                #pragma warning restore CS0618
            ...
            /// </exception>
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            public static ResponsePolicies ParseValue(ref Utf8JsonReader reader)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<ResponsePolicies>(ref reader);
                #pragma warning restore CS0618
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ResponsePolicies? result)
            {
                return JsonElementHelpers.TryParseValue<ResponsePolicies>(ref reader, out result);
            }
...
#if NET
            static ResponsePolicies IJsonElement<ResponsePolicies>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ResponsePolicies: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public ResponsePolicies Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ResponsePolicies>(_idx);
                }
            ...
            private static class JsonPropertyNamesEscaped
            {
                ...
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="Policies"/>.
                /// </summary>
                public static ReadOnlySpan<byte> Policies => "policies"u8;
            }
            ...
            private static class JsonPropertyNamesPrebaked
            {
                ...
                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="Policies"/>.
                /// </summary>
                public static ReadOnlySpan<byte> Policies => [0xA5, 0x00, 0x00, 0x00, 0x22, 0x70, 0x6F, 0x6C, 0x69, 0x63, 0x69, 0x65, 0x73, 0x22];
            }
        }
    }
}
