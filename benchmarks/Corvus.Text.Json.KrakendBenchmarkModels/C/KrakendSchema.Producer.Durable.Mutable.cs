    ...
    public readonly partial struct Producer
    {
        ...
        public readonly partial struct Durable
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<Durable, Mutable>(Durable.DefaultInstance);
                ...
                public static explicit operator Mutable(Durable instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="Durable"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Durable(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Durable.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly Durable Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<Durable>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(Durable instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<Durable, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<Durable> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<Durable>();
                }
                finally
                {
