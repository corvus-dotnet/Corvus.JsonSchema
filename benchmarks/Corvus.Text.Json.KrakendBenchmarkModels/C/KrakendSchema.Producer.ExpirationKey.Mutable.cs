...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Producer
    {
        ...
        public readonly partial struct ExpirationKey
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ExpirationKey, Mutable>(ExpirationKey.DefaultInstance);
                ...
                public static explicit operator Mutable(ExpirationKey instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ExpirationKey"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ExpirationKey(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ExpirationKey(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ExpirationKey.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ExpirationKey"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ExpirationKey"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ExpirationKey Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ExpirationKey>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ExpirationKey"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ExpirationKey Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ExpirationKey>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ExpirationKey instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ExpirationKey, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ExpirationKey> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ExpirationKey>();
                }
                finally
                {
