    ...
    public readonly partial struct Producer
    {
        ...
        public readonly partial struct Immediate
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<Immediate, Mutable>(Immediate.DefaultInstance);
            ...
            public static ParsedJsonDocument<Immediate> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<Immediate>();
                }
                finally
                {
