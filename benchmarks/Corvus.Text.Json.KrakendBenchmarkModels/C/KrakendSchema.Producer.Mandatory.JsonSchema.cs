    ...
    public readonly partial struct Producer
    {
            ...
            : IJsonElement<Mandatory>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1backend~1amqp~1producer.json/properties/mandatory"u8, buffer, out written);
