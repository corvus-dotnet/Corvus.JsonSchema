    ...
    public readonly partial struct Producer
    {
        ...
        public readonly partial struct Mandatory
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<Mandatory, Mutable>(Mandatory.DefaultInstance);
            ...
            public static ParsedJsonDocument<Mandatory> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<Mandatory>();
                }
                finally
                {
