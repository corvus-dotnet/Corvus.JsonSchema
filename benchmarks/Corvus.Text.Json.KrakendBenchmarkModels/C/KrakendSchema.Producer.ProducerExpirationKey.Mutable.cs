...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Producer
    {
        ...
        public readonly partial struct ProducerExpirationKey
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ProducerExpirationKey, Mutable>(ProducerExpirationKey.DefaultInstance);
                ...
                public static explicit operator Mutable(ProducerExpirationKey instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ProducerExpirationKey"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ProducerExpirationKey(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ProducerExpirationKey(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ProducerExpirationKey.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ProducerExpirationKey"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ProducerExpirationKey"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ProducerExpirationKey Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ProducerExpirationKey>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ProducerExpirationKey"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ProducerExpirationKey Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ProducerExpirationKey>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ProducerExpirationKey instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ProducerExpirationKey, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ProducerExpirationKey> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ProducerExpirationKey>();
                }
                finally
                {
