    ...
    public readonly partial struct Producer
    {
        ...
        public readonly partial struct ProducerExpirationKey1
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ProducerExpirationKey1, Mutable>(ProducerExpirationKey1.DefaultInstance);
                ...
                public static explicit operator Mutable(ProducerExpirationKey1 instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ProducerExpirationKey1"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ProducerExpirationKey1(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ProducerExpirationKey1(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ProducerExpirationKey1.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ProducerExpirationKey1"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ProducerExpirationKey1"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ProducerExpirationKey1 Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ProducerExpirationKey1>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ProducerExpirationKey1"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ProducerExpirationKey1 Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ProducerExpirationKey1>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ProducerExpirationKey1 instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ProducerExpirationKey1, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ProducerExpirationKey1> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ProducerExpirationKey1>();
                }
                finally
                {
