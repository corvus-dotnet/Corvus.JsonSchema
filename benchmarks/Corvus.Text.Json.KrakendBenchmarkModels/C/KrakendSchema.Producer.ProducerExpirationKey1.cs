...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Producer
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ProducerExpirationKey1"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ProducerExpirationKey1(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ProducerExpirationKey1 DefaultInstance { get; } = ParsedJsonDocument<ProducerExpirationKey1>.StringConstant([.."\"\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(ProducerExpirationKey1 value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in ProducerExpirationKey1 left, in ProducerExpirationKey1 right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ProducerExpirationKey1 left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ProducerExpirationKey1 instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ProducerExpirationKey1(JsonElement instance)
            {
                return ProducerExpirationKey1.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ProducerExpirationKey1 From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ProducerExpirationKey1 ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ProducerExpirationKey1>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ProducerExpirationKey1 ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ProducerExpirationKey1>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ProducerExpirationKey1 ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ProducerExpirationKey1>(json, options);
            }
            ...
            /// </exception>
            public static ProducerExpirationKey1 ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ProducerExpirationKey1>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ProducerExpirationKey1? result)
            {
                return JsonElementHelpers.TryParseValue<ProducerExpirationKey1>(ref reader, out result);
            }
...
#if NET
            static ProducerExpirationKey1 IJsonElement<ProducerExpirationKey1>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ProducerExpirationKey1: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public ProducerExpirationKey1 Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public ProducerExpirationKey1 Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ProducerExpirationKey1>(_idx);
                }
