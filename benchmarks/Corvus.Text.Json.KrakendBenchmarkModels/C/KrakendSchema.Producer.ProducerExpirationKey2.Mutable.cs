...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Producer
    {
        ...
        public readonly partial struct ProducerExpirationKey2
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ProducerExpirationKey2, Mutable>(ProducerExpirationKey2.DefaultInstance);
                ...
                public static explicit operator Mutable(ProducerExpirationKey2 instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ProducerExpirationKey2"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ProducerExpirationKey2(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ProducerExpirationKey2(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ProducerExpirationKey2.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ProducerExpirationKey2"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ProducerExpirationKey2"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ProducerExpirationKey2 Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ProducerExpirationKey2>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ProducerExpirationKey2"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ProducerExpirationKey2 Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ProducerExpirationKey2>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ProducerExpirationKey2 instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ProducerExpirationKey2, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ProducerExpirationKey2> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ProducerExpirationKey2>();
                }
                finally
                {
