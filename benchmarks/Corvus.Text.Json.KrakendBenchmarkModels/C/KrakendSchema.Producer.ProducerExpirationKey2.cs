...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Producer
    {
        ...
        public readonly partial struct ProducerExpirationKey2
            ...
            : IJsonElement<ProducerExpirationKey2>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ProducerExpirationKey2"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ProducerExpirationKey2(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ProducerExpirationKey2 DefaultInstance { get; } = ParsedJsonDocument<ProducerExpirationKey2>.StringConstant([.."\"\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(ProducerExpirationKey2 value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in ProducerExpirationKey2 left, in ProducerExpirationKey2 right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ProducerExpirationKey2 left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ProducerExpirationKey2 instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ProducerExpirationKey2(JsonElement instance)
            {
                return ProducerExpirationKey2.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ProducerExpirationKey2 From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ProducerExpirationKey2 ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ProducerExpirationKey2>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ProducerExpirationKey2 ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ProducerExpirationKey2>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ProducerExpirationKey2 ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ProducerExpirationKey2>(json, options);
            }
            ...
            /// </exception>
            public static ProducerExpirationKey2 ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ProducerExpirationKey2>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ProducerExpirationKey2? result)
            {
                return JsonElementHelpers.TryParseValue<ProducerExpirationKey2>(ref reader, out result);
            }
...
#if NET
            static ProducerExpirationKey2 IJsonElement<ProducerExpirationKey2>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ProducerExpirationKey2: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public ProducerExpirationKey2 Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public ProducerExpirationKey2 Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ProducerExpirationKey2>(_idx);
                }
