    ...
    public readonly partial struct Producer
    {
        ...
        public readonly partial struct RoutingKey
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<RoutingKey, Mutable>(RoutingKey.DefaultInstance);
            ...
            public static ParsedJsonDocument<RoutingKey> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RoutingKey>();
                }
                finally
                {
