    ...
    public readonly partial struct Producer
    {
        ...
        public readonly partial struct StaticRoutingKey
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<StaticRoutingKey, Mutable>(StaticRoutingKey.DefaultInstance);
                ...
                public static explicit operator Mutable(StaticRoutingKey instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="StaticRoutingKey"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator StaticRoutingKey(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"StaticRoutingKey.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly StaticRoutingKey Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly StaticRoutingKey Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<StaticRoutingKey>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(StaticRoutingKey instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<StaticRoutingKey, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<StaticRoutingKey> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<StaticRoutingKey>();
                }
                finally
                {
