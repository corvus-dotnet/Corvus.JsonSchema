    ...
    public readonly partial struct Proxy
    {
        ...
        public readonly partial struct TrafficShadowingOrMirroring
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<TrafficShadowingOrMirroring, Mutable>(TrafficShadowingOrMirroring.DefaultInstance);
            ...
            public static ParsedJsonDocument<TrafficShadowingOrMirroring> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TrafficShadowingOrMirroring>();
                }
                finally
                {
