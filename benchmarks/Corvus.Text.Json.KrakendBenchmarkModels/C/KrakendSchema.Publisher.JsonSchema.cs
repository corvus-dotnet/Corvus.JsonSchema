...
public readonly partial struct KrakendSchema
{
        ...
        : IJsonElement<Publisher>
    {
        ...
        {
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyTopicUrlPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("topic_url"u8, buffer, out written);
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyTopicUrlNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("topic_url"u8, buffer, out written);

            private const int RequiredOffsetForTopicUrl = 0;
            private const uint RequiredBitForTopicUrl = 0b00000000000000000000000000000001;

            private const uint RequiredBitMask0 =
                RequiredBitForTopicUrl;
            private static readonly JsonSchemaPathProvider TopicUrlSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/topic_url"u8, buffer, out written);

            private static void MatchTopicUrl(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                ...
                JsonSchemaContext childContext =
                    Corvus.KrakendBenchmark.Current.JsonString.JsonSchema.PushChildContextUnescaped(
                        ...
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.TopicUrlUtf8,
                        evaluationPath: TopicUrlSchemaEvaluationPath);
                ...
                requiredBitBuffer[RequiredOffsetForTopicUrl] |= RequiredBitForTopicUrl;
            }
            ...
            {
                if (span.SequenceEqual(JsonPropertyNames.TopicUrlUtf8))
                {
                    matcher = MatchTopicUrl;
                    return true;
                }
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1backend~1pubsub~1publisher.json"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1backend~1pubsub~1publisher.json";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1backend~1pubsub~1publisher.json"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyTopicUrlPresent, "topic_url"u8, "required"u8);
                    }
                    ...
                    {
                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForTopicUrl] & RequiredBitForTopicUrl) == 0)
                        {
                            context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyTopicUrlNotPresent, "topic_url"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyTopicUrlPresent, "topic_url"u8, "required"u8);
