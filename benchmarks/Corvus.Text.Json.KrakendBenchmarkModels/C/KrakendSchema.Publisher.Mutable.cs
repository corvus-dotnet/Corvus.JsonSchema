...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Publisher
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Publisher instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Publisher"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Publisher(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.JsonString.Mutable TopicUrl
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TopicUrlUtf8, out Corvus.KrakendBenchmark.Current.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetTopicUrl(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source value)
            {
                ...
                else
                {
                    ...
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.TopicUrl, ref cvb);
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Publisher.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly Publisher Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly Publisher Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Publisher>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(Publisher instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Publisher.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="Publisher"/>.
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.KrakendBenchmark.Current.JsonString.Source topicUrl)
            {
                topicUrl.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.TopicUrl, ref builder);
            }

            /// <summary>
            /// Creates an instance of a <see cref="Publisher"/>.
            /// </summary>
            public void Create(in Corvus.KrakendBenchmark.Current.JsonString.Source topicUrl)
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.JsonString.Source topicUrl, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        {
            return workspace.CreateBuilder<Publisher, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<Publisher> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Publisher>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Publisher> Create<TContext>(
        ...
        public static ParsedJsonDocument<Publisher> Create(in Corvus.KrakendBenchmark.Current.JsonString.Source topicUrl, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
