...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct RatelimitProxy
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(RatelimitProxy instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="RatelimitProxy"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RatelimitProxy(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.RatelimitProxy.Capacity.Mutable CapacityValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CapacityValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.RatelimitProxy.Capacity.Mutable value))
                    {
                        return value;
                    }

                    return Corvus.KrakendBenchmark.Current.KrakendSchema.RatelimitProxy.Capacity.Mutable.DefaultInstance;
                }
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RatelimitProxy(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetCapacityValue(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.RatelimitProxy.Capacity.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("capacity");
                }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RatelimitProxy.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RatelimitProxy"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RatelimitProxy"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly RatelimitProxy Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RatelimitProxy>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RatelimitProxy"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly RatelimitProxy Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<RatelimitProxy>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.RatelimitProxy.Capacity.Source _createArg1;
            ...
            internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.RatelimitProxy.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.RatelimitProxy.Capacity.Source arg1, scoped in Corvus.KrakendBenchmark.Current.JsonNumber.Source arg2, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Duration.Source arg3)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _createArg3 = arg3;
            ...
            public static implicit operator Source(RatelimitProxy instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.RatelimitProxy.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="RatelimitProxy"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.KrakendBenchmark.Current.KrakendSchema.RatelimitProxy.Capacity.Source capacity,
                in Corvus.KrakendBenchmark.Current.JsonNumber.Source maxRate,
            ...
            public void Create(
                ...
                in Corvus.KrakendBenchmark.Current.KrakendSchema.Duration.Source every = default)
            {
                Create(ref _builder, capacity, maxRate, every);
            }
            ...
            internal static void BuildCreateValue(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.RatelimitProxy.Capacity.Source arg1, scoped in Corvus.KrakendBenchmark.Current.JsonNumber.Source arg2, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Duration.Source arg3, ref ComplexValueBuilder o)
            {
                o.StartObject();
        ...
        /// </summary>
        /// <param name="capacity">The value of the <c>"capacity"</c> property.</param>
        /// <param name="maxRate">The value of the <c>"max_rate"</c> property.</param>
        /// <param name="every">The value of the <c>"every"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.RatelimitProxy.Capacity.Source capacity, scoped in Corvus.KrakendBenchmark.Current.JsonNumber.Source maxRate, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Duration.Source every = default)
        {
            return new Source(capacity, maxRate, every);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.KrakendSchema.RatelimitProxy.Capacity.Source capacity, in Corvus.KrakendBenchmark.Current.JsonNumber.Source maxRate, in Corvus.KrakendBenchmark.Current.KrakendSchema.Duration.Source every = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(capacity, maxRate, every);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<RatelimitProxy, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<RatelimitProxy> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<RatelimitProxy>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<RatelimitProxy> Create<TContext>(
        ...
        public static ParsedJsonDocument<RatelimitProxy> Create(in Corvus.KrakendBenchmark.Current.KrakendSchema.RatelimitProxy.Capacity.Source capacity, in Corvus.KrakendBenchmark.Current.JsonNumber.Source maxRate, in Corvus.KrakendBenchmark.Current.KrakendSchema.Duration.Source every = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
