...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct RedisRatelimit
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(RedisRatelimit instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="RedisRatelimit"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RedisRatelimit(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.RedisRatelimit.Tokenizer.Mutable TokenizerValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TokenizerValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.RedisRatelimit.Tokenizer.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RedisRatelimit(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RedisRatelimit.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RedisRatelimit"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RedisRatelimit"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly RedisRatelimit Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RedisRatelimit>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RedisRatelimit"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly RedisRatelimit Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<RedisRatelimit>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.KrakendBenchmark.Current.JsonInteger.Source _createArg1;
            private readonly Corvus.KrakendBenchmark.Current.JsonString.Source _createArg2;
            private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Duration.Source _createArg3;
            private readonly Corvus.KrakendBenchmark.Current.JsonInteger.Source _createArg4;
            private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.RedisRatelimit.Tokenizer.Source _createArg5;
            ...
            public static implicit operator Source(RedisRatelimit instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.RedisRatelimit.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="RedisRatelimit"/>.
            /// </summary>
            internal static void Create(
                ...
                in Corvus.KrakendBenchmark.Current.KrakendSchema.RedisRatelimit.Tokenizer.Source tokenizer,
        ...
        /// </summary>
        /// <param name="burst">The value of the <c>"burst"</c> property.</param>
        /// <param name="host">The value of the <c>"host"</c> property.</param>
        /// <param name="period">The value of the <c>"period"</c> property.</param>
        /// <param name="rate">The value of the <c>"rate"</c> property.</param>
        ...
        {
            return workspace.CreateBuilder<RedisRatelimit, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<RedisRatelimit> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<RedisRatelimit>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<RedisRatelimit> Create<TContext>(
        ...
        public static ParsedJsonDocument<RedisRatelimit> Create(in Corvus.KrakendBenchmark.Current.JsonInteger.Source burst, in Corvus.KrakendBenchmark.Current.JsonString.Source host, in Corvus.KrakendBenchmark.Current.KrakendSchema.Duration.Source period, in Corvus.KrakendBenchmark.Current.JsonInteger.Source rate, in Corvus.KrakendBenchmark.Current.KrakendSchema.RedisRatelimit.Tokenizer.Source tokenizer, in Corvus.KrakendBenchmark.Current.JsonString.Source tokenizerField = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
