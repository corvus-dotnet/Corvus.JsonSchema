    ...
    public readonly partial struct RedisRatelimit
    {
        ...
        public readonly partial struct Tokenizer
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(Tokenizer instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="Tokenizer"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Tokenizer(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Tokenizer.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly Tokenizer Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly Tokenizer Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<Tokenizer>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(Tokenizer instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (Tokenizer)value;
            ...
            {
                return workspace.CreateBuilder<Tokenizer, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<Tokenizer> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<Tokenizer>();
                }
                finally
                {
