...
public readonly partial struct KrakendSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RedisRatelimit"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal RedisRatelimit(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static RedisRatelimit DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.JsonInteger Burst
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BurstUtf8, out Corvus.KrakendBenchmark.Current.JsonInteger value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.Duration Period
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PeriodUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Duration value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.JsonInteger Rate
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RateUtf8, out Corvus.KrakendBenchmark.Current.JsonInteger value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.RedisRatelimit.Tokenizer TokenizerValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TokenizerValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.RedisRatelimit.Tokenizer value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.JsonString TokenizerField
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TokenizerFieldUtf8, out Corvus.KrakendBenchmark.Current.JsonString value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in RedisRatelimit left, in RedisRatelimit right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in RedisRatelimit left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(RedisRatelimit instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator RedisRatelimit(JsonElement instance)
        {
            return RedisRatelimit.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RedisRatelimit From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RedisRatelimit ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<RedisRatelimit>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RedisRatelimit ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<RedisRatelimit>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RedisRatelimit ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<RedisRatelimit>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static RedisRatelimit ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<RedisRatelimit>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out RedisRatelimit? result)
        {
            return JsonElementHelpers.TryParseValue<RedisRatelimit>(ref reader, out result);
        }
...
#if NET
        static RedisRatelimit IJsonElement<RedisRatelimit>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"RedisRatelimit: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public RedisRatelimit Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<RedisRatelimit>(_idx);
            }
        ...
        public static class JsonPropertyNames
        {
            ...
            /// <summary>
            /// Gets the JSON property name for <see cref="TokenizerValue"/>.
            /// </summary>
            public const string TokenizerValue = "tokenizer";
            ...
            /// Gets the JSON property name for <see cref="TokenizerValue"/>.
            /// </summary>
            public static ReadOnlySpan<byte> TokenizerValueUtf8 => "tokenizer"u8;
        ...
        {
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="Burst"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Burst => "burst"u8;
            ...
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="Period"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Period => "period"u8;

            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="Rate"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Rate => "rate"u8;

            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="TokenizerValue"/>.
            /// </summary>
            public static ReadOnlySpan<byte> TokenizerValue => "tokenizer"u8;

            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="TokenizerField"/>.
            /// </summary>
            public static ReadOnlySpan<byte> TokenizerField => "tokenizer_field"u8;
        }
        ...
        {
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="Burst"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Burst => [0x75, 0x00, 0x00, 0x00, 0x22, 0x62, 0x75, 0x72, 0x73, 0x74, 0x22];
            ...
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="Period"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Period => [0x85, 0x00, 0x00, 0x00, 0x22, 0x70, 0x65, 0x72, 0x69, 0x6F, 0x64, 0x22];

            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="Rate"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Rate => [0x65, 0x00, 0x00, 0x00, 0x22, 0x72, 0x61, 0x74, 0x65, 0x22];

            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="TokenizerValue"/>.
            /// </summary>
            public static ReadOnlySpan<byte> TokenizerValue => [0xB5, 0x00, 0x00, 0x00, 0x22, 0x74, 0x6F, 0x6B, 0x65, 0x6E, 0x69, 0x7A, 0x65, 0x72, 0x22];

            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="TokenizerField"/>.
            /// </summary>
            public static ReadOnlySpan<byte> TokenizerField => [0x15, 0x01, 0x00, 0x00, 0x22, 0x74, 0x6F, 0x6B, 0x65, 0x6E, 0x69, 0x7A, 0x65, 0x72, 0x5F, 0x66, 0x69, 0x65, 0x6C, 0x64, 0x22];
        }
    }
}
