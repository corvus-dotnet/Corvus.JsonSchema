...
public readonly partial struct KrakendSchema
{
        ...
        : IJsonElement<ReqRespModifier>
    {
        ...
        {
            private static readonly JsonSchemaPathProvider ContentReplacerValueSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/content-replacer/$ref"u8, buffer, out written);
            ...
            private static readonly JsonSchemaPathProvider ResponseSchemaValidatorValueSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/response-schema-validator/$ref"u8, buffer, out written);

            private static void MatchContentReplacerValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext =
                    Corvus.KrakendBenchmark.Current.KrakendSchema.ContentReplacer.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.ContentReplacerValueUtf8,
                        evaluationPath: ContentReplacerValueSchemaEvaluationPath);

                Corvus.KrakendBenchmark.Current.KrakendSchema.ContentReplacer.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                context.CommitChildContext(childContext.IsMatch, ref childContext);
            }

            private static void MatchIpFilterValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
            ...
            private static void MatchName(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                ...
                JsonSchemaContext childContext2 =
                    Corvus.KrakendBenchmark.Current.KrakendSchema.ReqRespModifier.PluginName.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.KrakendBenchmark.Current.KrakendSchema.ReqRespModifier.PluginName.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
                context.CommitChildContext(childContext2.IsMatch, ref childContext2);
            }

            private static void MatchResponseSchemaValidatorValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext3 =
                    Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseSchemaValidator.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.ResponseSchemaValidatorValueUtf8,
                        evaluationPath: ResponseSchemaValidatorValueSchemaEvaluationPath);

                Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseSchemaValidator.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext3);
            ...
            private static PropertySchemaMatchers<Corvus.KrakendBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
            {
                return new PropertySchemaMatchers<Corvus.KrakendBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator1>([
                    (static () => JsonPropertyNames.ContentReplacerValueUtf8, MatchContentReplacerValue),
                    (static () => JsonPropertyNames.IpFilterValueUtf8, MatchIpFilterValue),
                    (static () => JsonPropertyNames.NameUtf8, MatchName),
                    (static () => JsonPropertyNames.ResponseSchemaValidatorValueUtf8, MatchResponseSchemaValidatorValue),
                ]);
            }
