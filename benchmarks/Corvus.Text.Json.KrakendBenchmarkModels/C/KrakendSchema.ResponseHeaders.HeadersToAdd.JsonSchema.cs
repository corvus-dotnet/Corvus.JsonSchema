                    ...
                    else
                    {
                        ...
                        while (objectValidation_enumerator.MoveNext())
                        {
                            ...
                            if (objectValidation_unescapedPropertyName.Span.Length > 0)
                            {
                                ...
                                Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseHeaders.HeadersToAdd.JsonStringArray.JsonSchema.Evaluate(parentDocument, objectValidation_currentIndex, ref childContext);
