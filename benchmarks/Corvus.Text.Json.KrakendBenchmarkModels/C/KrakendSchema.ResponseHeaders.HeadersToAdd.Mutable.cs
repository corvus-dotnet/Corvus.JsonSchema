    ...
    public readonly partial struct ResponseHeaders
    {
        ...
        public readonly partial struct HeadersToAdd
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(HeadersToAdd instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="HeadersToAdd"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator HeadersToAdd(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"HeadersToAdd.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly HeadersToAdd Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly HeadersToAdd Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<HeadersToAdd>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseHeaders.HeadersToAdd.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(HeadersToAdd instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseHeaders.HeadersToAdd.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<HeadersToAdd, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<HeadersToAdd> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<HeadersToAdd>();
                }
                finally
                {
