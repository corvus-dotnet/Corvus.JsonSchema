...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct ResponseHeaders
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="HeadersToAdd"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal HeadersToAdd(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static HeadersToAdd DefaultInstance { get; }
            ...
            /// <see cref="Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseHeaders.HeadersToAdd.JsonStringArray"/>.
            /// </summary>
            ...
            public static bool MatchesPatternJsonStringArray(ReadOnlySpan<byte> propertyName)
            {
            ...
            /// <returns><see langword="true"/> if the property name matches the pattern, otherwise <see langword="false"/>.</returns>
            public static bool TryAsPatternJsonStringArray(ReadOnlySpan<byte> propertyName, in JsonElement value, out Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseHeaders.HeadersToAdd.JsonStringArray result)
            {
                if (MatchesPatternJsonStringArray(propertyName))
                {
                    result = Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseHeaders.HeadersToAdd.JsonStringArray.From(value);
                    return true;
                }
            ...
            public interface IPatternPropertyVisitor<TState>
            {
                ...
                /// </summary>
                bool VisitPatternJsonStringArray(ReadOnlySpan<byte> name, in Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseHeaders.HeadersToAdd.JsonStringArray value, ref TState state);
                ...
                where TVisitor : IPatternPropertyVisitor<TState>
            {
                ...
                foreach (var property in EnumerateObject())
                {
                    ...
                    {
                        matched = true;
                        Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseHeaders.HeadersToAdd.JsonStringArray typedValue = Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseHeaders.HeadersToAdd.JsonStringArray.From(property.Value);
                        if (!visitor.VisitPatternJsonStringArray(propertyName, in typedValue, ref state))
                        {
                            return false;
                        }
            ...
            /// </returns>
            public static bool operator ==(in HeadersToAdd left, in HeadersToAdd right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in HeadersToAdd left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(HeadersToAdd instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator HeadersToAdd(JsonElement instance)
            {
                return HeadersToAdd.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HeadersToAdd From<T>(in T instance)
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HeadersToAdd ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<HeadersToAdd>(utf8Json, options);
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HeadersToAdd ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<HeadersToAdd>(json, options);
                #pragma warning restore CS0618
            }
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HeadersToAdd ParseValue(string json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<HeadersToAdd>(json, options);
                #pragma warning restore CS0618
            ...
            /// </exception>
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            public static HeadersToAdd ParseValue(ref Utf8JsonReader reader)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<HeadersToAdd>(ref reader);
                #pragma warning restore CS0618
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out HeadersToAdd? result)
            {
                return JsonElementHelpers.TryParseValue<HeadersToAdd>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new HeadersToAdd(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static HeadersToAdd IJsonElement<HeadersToAdd>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"HeadersToAdd: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="HeadersToAdd"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="HeadersToAdd"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public HeadersToAdd Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<HeadersToAdd>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="HeadersToAdd"/> that lives for the lifetime of its
