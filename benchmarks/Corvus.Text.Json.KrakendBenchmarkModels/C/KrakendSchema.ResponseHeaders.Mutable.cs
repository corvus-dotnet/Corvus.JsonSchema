...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct ResponseHeaders
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ResponseHeaders instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ResponseHeaders"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ResponseHeaders(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseHeaders.HeadersToAdd.Mutable Add
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AddUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseHeaders.HeadersToAdd.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseHeaders.JsonStringArray.Mutable Delete
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DeleteUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseHeaders.JsonStringArray.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseHeaders.HeadersToReplace.Mutable Replace
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ReplaceUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseHeaders.HeadersToReplace.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetAdd<TContext>(in Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseHeaders.HeadersToAdd.Source<TContext> value)
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetDelete<TContext>(in Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseHeaders.JsonStringArray.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetReplace<TContext>(in Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseHeaders.HeadersToReplace.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ResponseHeaders.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ResponseHeaders Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ResponseHeaders Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ResponseHeaders>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseHeaders.HeadersToAdd.Source _createArg1;
            private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseHeaders.JsonStringArray.Source _createArg2;
            private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseHeaders.HeadersToReplace.Source _createArg3;
            ...
            public static implicit operator Source(ResponseHeaders instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseHeaders.HeadersToAdd.Source<TContext> _createArg1;
            private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseHeaders.JsonStringArray.Source<TContext> _createArg2;
            private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseHeaders.HeadersToReplace.Source<TContext> _createArg3;
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="ResponseHeaders"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseHeaders.HeadersToAdd.Source add = default,
                in Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseHeaders.JsonStringArray.Source delete = default,
                in Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseHeaders.HeadersToReplace.Source replace = default)
            {
            ...
            internal static void Create<TContext>(
                in TContext context,
                ref ComplexValueBuilder builder,
                in Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseHeaders.HeadersToAdd.Source<TContext> add = default,
                in Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseHeaders.JsonStringArray.Source<TContext> delete = default,
                in Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseHeaders.HeadersToReplace.Source<TContext> replace = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
        ...
        /// </summary>
        /// <param name="add">The value of the <c>"add"</c> property.</param>
        ...
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseHeaders.HeadersToAdd.Source<TContext> add = default, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseHeaders.JsonStringArray.Source<TContext> delete = default, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseHeaders.HeadersToReplace.Source<TContext> replace = default)
            ...
            #endif
        {
            return new Source<TContext>(context, add, delete, replace);
        }
        ...
        {
            return workspace.CreateBuilder<ResponseHeaders, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ResponseHeaders> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ResponseHeaders>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ResponseHeaders> Create<TContext>(
        ...
        public static ParsedJsonDocument<ResponseHeaders> Create(in Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseHeaders.HeadersToAdd.Source add = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseHeaders.JsonStringArray.Source delete = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseHeaders.HeadersToReplace.Source replace = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ResponseHeaders> Create<TContext>(in TContext context, in Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseHeaders.HeadersToAdd.Source<TContext> add = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseHeaders.JsonStringArray.Source<TContext> delete = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseHeaders.HeadersToReplace.Source<TContext> replace = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
