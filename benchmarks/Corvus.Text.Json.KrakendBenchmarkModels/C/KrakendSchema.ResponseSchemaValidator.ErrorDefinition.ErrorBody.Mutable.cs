...
public readonly partial struct KrakendSchema
{
    ...
    /// </para>
    /// </remarks>
    public readonly partial struct ResponseSchemaValidator
    {
        /// <summary>
        /// Error definition
        /// </summary>
        ...
        public readonly partial struct ErrorDefinition
        {
            ...
            public readonly partial struct ErrorBody
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ErrorBody, Mutable>(ErrorBody.DefaultInstance);
                    ...
                    public static explicit operator Mutable(ErrorBody instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ErrorBody"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ErrorBody(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ErrorBody.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ErrorBody Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ErrorBody Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ErrorBody>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(ErrorBody instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<ErrorBody, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<ErrorBody> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<ErrorBody>();
                    }
                    finally
                    {
