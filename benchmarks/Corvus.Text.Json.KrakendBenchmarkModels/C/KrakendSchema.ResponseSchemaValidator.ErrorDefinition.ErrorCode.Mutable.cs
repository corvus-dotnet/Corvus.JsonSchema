        ...
        public readonly partial struct ErrorDefinition
        {
            ...
            public readonly partial struct ErrorCode
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ErrorCode, Mutable>(ErrorCode.DefaultInstance);
                    ...
                    public static explicit operator Mutable(ErrorCode instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ErrorCode"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ErrorCode(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ErrorCode.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ErrorCode Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ErrorCode Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ErrorCode>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(ErrorCode instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<ErrorCode, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<ErrorCode> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<ErrorCode>();
                    }
                    finally
                    {
