    ...
    public readonly partial struct ResponseSchemaValidator
    {
        ...
        public readonly partial struct ErrorDefinition
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseSchemaValidator.ErrorDefinition.ErrorBody.Mutable Body
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BodyUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseSchemaValidator.ErrorDefinition.ErrorBody.Mutable value))
                        {
                            return value;
                        }

                        return Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseSchemaValidator.ErrorDefinition.ErrorBody.Mutable.DefaultInstance;
                    }
                }
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseSchemaValidator.ErrorDefinition.ErrorCode.Mutable Status
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StatusUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseSchemaValidator.ErrorDefinition.ErrorCode.Mutable value))
                        {
                            return value;
                        }

                        return Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseSchemaValidator.ErrorDefinition.ErrorCode.Mutable.DefaultInstance;
                    }
                }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseSchemaValidator.ErrorDefinition.ErrorBody.Source _createArg1;
                private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseSchemaValidator.ErrorDefinition.ErrorCode.Source _createArg2;
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseSchemaValidator.ErrorDefinition.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseSchemaValidator.ErrorDefinition.ErrorBody.Source body = default,
                    in Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseSchemaValidator.ErrorDefinition.ErrorCode.Source status = default)
                {
                ...
                /// Creates an instance of a <see cref="ErrorDefinition"/>.
                /// </summary>
                public void Create(in Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseSchemaValidator.ErrorDefinition.ErrorBody.Source body = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseSchemaValidator.ErrorDefinition.ErrorCode.Source status = default)
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseSchemaValidator.ErrorDefinition.ErrorBody.Source body = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseSchemaValidator.ErrorDefinition.ErrorCode.Source status = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            public static ParsedJsonDocument<ErrorDefinition> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ErrorDefinition>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<ErrorDefinition> Create<TContext>(
            ...
            public static ParsedJsonDocument<ErrorDefinition> Create(in Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseSchemaValidator.ErrorDefinition.ErrorBody.Source body = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseSchemaValidator.ErrorDefinition.ErrorCode.Source status = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
