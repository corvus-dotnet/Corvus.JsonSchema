...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct ResponseSchemaValidator
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ResponseSchemaValidator instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ResponseSchemaValidator"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ResponseSchemaValidator(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseSchemaValidator.ErrorDefinition.Mutable Error
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ErrorUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseSchemaValidator.ErrorDefinition.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ResponseSchemaValidator(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetError(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseSchemaValidator.ErrorDefinition.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetError<TContext>(in Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseSchemaValidator.ErrorDefinition.Source<TContext> value)
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetSchema(scoped in Corvus.KrakendBenchmark.Current.JsonObject.Source value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ResponseSchemaValidator.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ResponseSchemaValidator"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ResponseSchemaValidator"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly ResponseSchemaValidator Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ResponseSchemaValidator>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ResponseSchemaValidator"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly ResponseSchemaValidator Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ResponseSchemaValidator>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseSchemaValidator.ErrorDefinition.Source _createArg2;
            ...
            internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseSchemaValidator.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.KrakendBenchmark.Current.JsonObject.Source arg1, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseSchemaValidator.ErrorDefinition.Source arg2)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _kind = Kind.Create;
            ...
            public static implicit operator Source(ResponseSchemaValidator instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseSchemaValidator.ErrorDefinition.Source<TContext> _createArg2;
            ...
            internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseSchemaValidator.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.JsonObject.Source<TContext> arg1, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseSchemaValidator.ErrorDefinition.Source<TContext> arg2)
            {
                _context = context;
                _createArg1 = arg1;
                _createArg2 = arg2;
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="ResponseSchemaValidator"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.KrakendBenchmark.Current.JsonObject.Source schema,
                in Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseSchemaValidator.ErrorDefinition.Source error = default)
            {
            ...
            /// Creates an instance of a <see cref="ResponseSchemaValidator"/>.
            /// </summary>
            public void Create(in Corvus.KrakendBenchmark.Current.JsonObject.Source schema, in Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseSchemaValidator.ErrorDefinition.Source error = default)
            {
            ...
            internal static void Create<TContext>(
                ...
                in Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseSchemaValidator.ErrorDefinition.Source<TContext> error = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            internal static void BuildCreateValue(scoped in Corvus.KrakendBenchmark.Current.JsonObject.Source arg1, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseSchemaValidator.ErrorDefinition.Source arg2, ref ComplexValueBuilder o)
            {
                o.StartObject();
            ...
            /// <param name="arg2">The value of the property.</param>
            /// <param name="o">The complex value builder into which to write the object.</param>
            internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.JsonObject.Source<TContext> arg1, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseSchemaValidator.ErrorDefinition.Source<TContext> arg2, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.KrakendBenchmark.Current.JsonObject.Source schema, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseSchemaValidator.ErrorDefinition.Source error = default)
        {
            return new Source(schema, error);
        }
        ...
        /// <param name="error">The value of the <c>"error"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.JsonObject.Source<TContext> schema, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseSchemaValidator.ErrorDefinition.Source<TContext> error = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            return new Source<TContext>(context, schema, error);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.JsonObject.Source schema, in Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseSchemaValidator.ErrorDefinition.Source error = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.KrakendBenchmark.Current.JsonObject.Source<TContext> schema, in Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseSchemaValidator.ErrorDefinition.Source<TContext> error = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
        ...
        {
            return workspace.CreateBuilder<ResponseSchemaValidator, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ResponseSchemaValidator> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ResponseSchemaValidator>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ResponseSchemaValidator> Create<TContext>(
        ...
        public static ParsedJsonDocument<ResponseSchemaValidator> Create(in Corvus.KrakendBenchmark.Current.JsonObject.Source schema, in Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseSchemaValidator.ErrorDefinition.Source error = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ResponseSchemaValidator> Create<TContext>(in TContext context, in Corvus.KrakendBenchmark.Current.JsonObject.Source<TContext> schema, in Corvus.KrakendBenchmark.Current.KrakendSchema.ResponseSchemaValidator.ErrorDefinition.Source<TContext> error = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
