    ...
    public readonly partial struct Revoker
    {
        ...
        public readonly partial struct HashFunctionName
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(HashFunctionName instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="HashFunctionName"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator HashFunctionName(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"HashFunctionName.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly HashFunctionName Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly HashFunctionName Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<HashFunctionName>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(HashFunctionName instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (HashFunctionName)value;
            ...
            {
                return workspace.CreateBuilder<HashFunctionName, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<HashFunctionName> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<HashFunctionName>();
                }
                finally
                {
