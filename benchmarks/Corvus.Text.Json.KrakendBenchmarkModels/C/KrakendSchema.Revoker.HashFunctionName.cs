...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Revoker
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="HashFunctionName"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal HashFunctionName(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static HashFunctionName DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(HashFunctionName value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in HashFunctionName left, in HashFunctionName right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in HashFunctionName left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(HashFunctionName instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator HashFunctionName(JsonElement instance)
            {
                return HashFunctionName.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HashFunctionName From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HashFunctionName ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<HashFunctionName>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HashFunctionName ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<HashFunctionName>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HashFunctionName ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<HashFunctionName>(json, options);
            }
            ...
            /// </exception>
            public static HashFunctionName ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<HashFunctionName>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out HashFunctionName? result)
            {
                return JsonElementHelpers.TryParseValue<HashFunctionName>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new HashFunctionName(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static HashFunctionName IJsonElement<HashFunctionName>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"HashFunctionName: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="HashFunctionName"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="HashFunctionName"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public HashFunctionName Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<HashFunctionName>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="HashFunctionName"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public HashFunctionName Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<HashFunctionName>(_idx);
                }
            ...
            /// <param name="matchOptimal">Match 1st item.</param>
            /// <param name="matchDefault">Match 2nd item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchOptimal,
