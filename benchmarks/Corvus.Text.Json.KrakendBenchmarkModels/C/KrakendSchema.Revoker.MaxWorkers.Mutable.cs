    ...
    public readonly partial struct Revoker
    {
        ...
        public readonly partial struct MaxWorkers
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<MaxWorkers, Mutable>(MaxWorkers.DefaultInstance);
            ...
            public static ParsedJsonDocument<MaxWorkers> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<MaxWorkers>();
                }
                finally
                {
