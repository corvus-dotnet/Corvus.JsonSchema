    ...
    public readonly partial struct Revoker
    {
            ...
            : IJsonElement<RevokeServerMaxRetries>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1auth~1revoker.json/properties/revoke_server_max_retries"u8, buffer, out written);
