    ...
    public readonly partial struct Revoker
    {
        ...
        public readonly partial struct RevokeServerMaxRetries
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<RevokeServerMaxRetries, Mutable>(RevokeServerMaxRetries.DefaultInstance);
            ...
            public static ParsedJsonDocument<RevokeServerMaxRetries> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RevokeServerMaxRetries>();
                }
                finally
                {
