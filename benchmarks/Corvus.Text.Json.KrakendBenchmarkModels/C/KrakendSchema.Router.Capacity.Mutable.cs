    ...
    public readonly partial struct Router
    {
        ...
        public readonly partial struct Capacity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<Capacity, Mutable>(Capacity.DefaultInstance);
                ...
                public static explicit operator Mutable(Capacity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="Capacity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Capacity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new Capacity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Capacity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="Capacity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="Capacity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly Capacity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<Capacity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="Capacity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly Capacity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<Capacity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(Capacity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<Capacity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<Capacity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<Capacity>();
                }
                finally
                {
