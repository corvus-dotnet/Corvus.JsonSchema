    ...
    public readonly partial struct Router
    {
        ...
        public readonly partial struct CleanupThreads
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<CleanupThreads, Mutable>(CleanupThreads.DefaultInstance);
            ...
            public static ParsedJsonDocument<CleanupThreads> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<CleanupThreads>();
                }
                finally
                {
