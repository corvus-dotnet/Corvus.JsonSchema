    ...
    public readonly partial struct Router
    {
        ...
        public readonly partial struct ClientCapacity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ClientCapacity, Mutable>(ClientCapacity.DefaultInstance);
            ...
            public static ParsedJsonDocument<ClientCapacity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ClientCapacity>();
                }
                finally
                {
