    ...
    public readonly partial struct Router
    {
        ...
        public readonly partial struct NumShards
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<NumShards, Mutable>(NumShards.DefaultInstance);
                ...
                /// </para>
                /// </remarks>
                public readonly NumShards Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly NumShards Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<NumShards>(_idx);
                }
            }
            ...
            public static ParsedJsonDocument<NumShards> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<NumShards>();
                }
                finally
                {
