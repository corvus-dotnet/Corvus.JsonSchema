...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Router
    {
        ...
        public readonly partial struct RequiredClientMaxRate
        {
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(in Corvus.Text.Json.JsonElement.Source clientMaxRate)
            {
            ...
            /// <param name="clientMaxRate">The value of the <c>"client_max_rate"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> clientMaxRate)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
