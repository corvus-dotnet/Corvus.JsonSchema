...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Router
    {
        ...
        public readonly partial struct RequiredMaxRate
        {
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(in Corvus.Text.Json.JsonElement.Source maxRate)
            {
            ...
            /// <param name="maxRate">The value of the <c>"max_rate"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> maxRate)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
