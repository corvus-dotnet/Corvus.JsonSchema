            ...
            public readonly partial struct OpenTelemetrySettings
            {
                ...
                public readonly partial struct DisableMetrics
                {
...
#endif
                    {
                        ...
                        /// </remarks>
                        public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DisableMetrics, Mutable>(DisableMetrics.DefaultInstance);
                        ...
                        public static explicit operator Mutable(DisableMetrics instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="DisableMetrics"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator DisableMetrics(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"DisableMetrics.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly DisableMetrics Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly DisableMetrics Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<DisableMetrics>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(DisableMetrics instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<DisableMetrics, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<DisableMetrics> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<DisableMetrics>();
                        }
                        finally
                        {
