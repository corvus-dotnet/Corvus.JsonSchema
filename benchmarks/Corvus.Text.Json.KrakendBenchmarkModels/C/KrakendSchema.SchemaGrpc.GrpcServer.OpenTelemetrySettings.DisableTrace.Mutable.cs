            ...
            public readonly partial struct OpenTelemetrySettings
            {
                ...
                public readonly partial struct DisableTrace
                {
...
#endif
                    {
                        ...
                        /// </remarks>
                        public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DisableTrace, Mutable>(DisableTrace.DefaultInstance);
                    ...
                    public static ParsedJsonDocument<DisableTrace> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<DisableTrace>();
                        }
                        finally
                        {
