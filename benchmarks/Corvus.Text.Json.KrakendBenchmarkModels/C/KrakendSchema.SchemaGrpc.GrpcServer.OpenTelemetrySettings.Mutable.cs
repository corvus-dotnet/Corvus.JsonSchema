        ...
        public readonly partial struct GrpcServer
        {
            ...
            public readonly partial struct OpenTelemetrySettings
            {
...
#endif
                {
                    ...
                    public void SetDisableMetricsValue(in Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.OpenTelemetrySettings.DisableMetrics.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetDisableTraces(in Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.OpenTelemetrySettings.DisableTrace.Source value)
                    {
                        CheckValidInstance();
                ...
                public ref struct Source
                {
                    ...
                    internal Source(in Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.OpenTelemetrySettings.DisableMetrics.Source arg1, in Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.OpenTelemetrySettings.DisableTrace.Source arg2)
                    {
                        _createArg1 = arg1;
                        _createArg2 = arg2;
                        _kind = Kind.Create;
                ...
                public ref struct Builder
                {
                    ...
                    internal static void BuildCreateValue(in Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.OpenTelemetrySettings.DisableMetrics.Source arg1, in Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.OpenTelemetrySettings.DisableTrace.Source arg2, ref ComplexValueBuilder o)
                    {
                        o.StartObject();
                ...
                /// <returns>The source from which to build the value.</returns>
                public static Source Build(in Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.OpenTelemetrySettings.DisableMetrics.Source disableMetrics = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.OpenTelemetrySettings.DisableTrace.Source disableTraces = default)
                {
