        ...
        public readonly partial struct GrpcServer
        {
            ...
            public readonly partial struct OpenTelemetrySettings
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(OpenTelemetrySettings instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="OpenTelemetrySettings"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator OpenTelemetrySettings(Mutable instance)
                    {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.OpenTelemetrySettings.DisableMetrics.Mutable DisableMetricsValue
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DisableMetricsValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.OpenTelemetrySettings.DisableMetrics.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.OpenTelemetrySettings.DisableTrace.Mutable DisableTraces
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DisableTracesUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.OpenTelemetrySettings.DisableTrace.Mutable value))
                            {
                                return value;
                            }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new OpenTelemetrySettings(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    public void SetDisableMetricsValue(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.OpenTelemetrySettings.DisableMetrics.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetDisableTraces(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.OpenTelemetrySettings.DisableTrace.Source value)
                    {
                        CheckValidInstance();
                        ...
                        {
                            // We are going to insert the new value
                            value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.DisableTraces, ref cvb);
                            int endIndex = _idx + _parent.GetDbSize(_idx, false);
                            _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                        }
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"OpenTelemetrySettings.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="OpenTelemetrySettings"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="OpenTelemetrySettings"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly OpenTelemetrySettings Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<OpenTelemetrySettings>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="OpenTelemetrySettings"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly OpenTelemetrySettings Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<OpenTelemetrySettings>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.OpenTelemetrySettings.DisableMetrics.Source _createArg1;
                    private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.OpenTelemetrySettings.DisableTrace.Source _createArg2;
                    ...
                    internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.OpenTelemetrySettings.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    internal Source(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.OpenTelemetrySettings.DisableMetrics.Source arg1, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.OpenTelemetrySettings.DisableTrace.Source arg2)
                    {
                        _createArg1 = arg1;
                        _createArg2 = arg2;
                        _kind = Kind.Create;
                    ...
                    public static implicit operator Source(OpenTelemetrySettings instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.OpenTelemetrySettings.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// <summary>
                    /// Creates an instance of a <see cref="OpenTelemetrySettings"/>.
                    /// </summary>
                    internal static void Create(
                        ref ComplexValueBuilder builder,
                        in Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.OpenTelemetrySettings.DisableMetrics.Source disableMetrics = default,
                        in Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.OpenTelemetrySettings.DisableTrace.Source disableTraces = default)
                    {
                        disableMetrics.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.DisableMetricsValue, ref builder);
                        disableTraces.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.DisableTraces, ref builder);
                    }

                    /// <summary>
                    /// Creates an instance of a <see cref="OpenTelemetrySettings"/>.
                    /// </summary>
                    public void Create(in Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.OpenTelemetrySettings.DisableMetrics.Source disableMetrics = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.OpenTelemetrySettings.DisableTrace.Source disableTraces = default)
                    {
                    ...
                    internal static void BuildCreateValue(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.OpenTelemetrySettings.DisableMetrics.Source arg1, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.OpenTelemetrySettings.DisableTrace.Source arg2, ref ComplexValueBuilder o)
                    {
                        o.StartObject();
                ...
                /// <returns>The source from which to build the value.</returns>
                public static Source Build(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.OpenTelemetrySettings.DisableMetrics.Source disableMetrics = default, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.OpenTelemetrySettings.DisableTrace.Source disableTraces = default)
                {
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.OpenTelemetrySettings.DisableMetrics.Source disableMetrics = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.OpenTelemetrySettings.DisableTrace.Source disableTraces = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                ...
                {
                    return workspace.CreateBuilder<OpenTelemetrySettings, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<OpenTelemetrySettings> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<OpenTelemetrySettings>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<OpenTelemetrySettings> Create<TContext>(
                ...
                public static ParsedJsonDocument<OpenTelemetrySettings> Create(in Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.OpenTelemetrySettings.DisableMetrics.Source disableMetrics = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.OpenTelemetrySettings.DisableTrace.Source disableTraces = default, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
