    ...
    public readonly partial struct SchemaGrpc
    {
        ...
        public readonly partial struct GrpcServer
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.OpenTelemetrySettings.DisableMetrics DisableMetricsValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DisableMetricsValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.OpenTelemetrySettings.DisableMetrics value))
                        {
                            return value;
                        }

                        return Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.OpenTelemetrySettings.DisableMetrics.DefaultInstance;
                    }
                }
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.OpenTelemetrySettings.DisableTrace DisableTraces
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DisableTracesUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.OpenTelemetrySettings.DisableTrace value))
                        {
                            return value;
                        }

                        return Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.OpenTelemetrySettings.DisableTrace.DefaultInstance;
                    }
                }
