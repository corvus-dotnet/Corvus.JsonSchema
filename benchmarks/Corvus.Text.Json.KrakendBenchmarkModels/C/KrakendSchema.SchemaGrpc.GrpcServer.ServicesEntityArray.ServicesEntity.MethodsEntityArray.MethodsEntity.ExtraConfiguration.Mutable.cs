                        ...
                        public readonly partial struct MethodsEntity
                        {
                            ...
                            public readonly partial struct ExtraConfiguration
                            {
                                ...
                                public ref struct Source
                                {
                                    ...
                                    private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Validator.Source _createArg1;
                                    ...
                                    internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.ServicesEntityArray.ServicesEntity.MethodsEntityArray.MethodsEntity.ExtraConfiguration.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                                    internal Source(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Validator.Source arg1)
                                    {
                                        _createArg1 = arg1;
                                        _kind = Kind.Create;
                                    }
                                    ...
                                    #endif
                                {
                                    ...
                                    private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Validator.Source<TContext> _createArg1;
                                    ...
                                    internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.ServicesEntityArray.ServicesEntity.MethodsEntityArray.MethodsEntity.ExtraConfiguration.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

                                    internal Source(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Validator.Source<TContext> arg1)
                                    {
                                        _context = context;
                                        _createArg1 = arg1;
                                        _kind = Kind.Create;
                                ...
                                public ref struct Builder
                                {
                                    ...
                                    /// </summary>
                                    internal static void Create(ref ComplexValueBuilder builder, in Corvus.KrakendBenchmark.Current.KrakendSchema.Validator.Source authValidator = default)
                                    {
                                    ...
                                    /// Creates an instance of a <see cref="ExtraConfiguration"/>.
                                    /// </summary>
                                    public void Create(in Corvus.KrakendBenchmark.Current.KrakendSchema.Validator.Source authValidator = default)
                                    {
                                    ...
                                    /// Creates an instance of a <see cref="ExtraConfiguration"/>.
                                    /// </summary>
                                    public void Create<TContext>(in TContext context, in Corvus.KrakendBenchmark.Current.KrakendSchema.Validator.Source<TContext> authValidator = default)
                                    #if NET9_0_OR_GREATER
                                    where TContext : allows ref struct
                                    #endif
                                    {
                                    ...
                                    internal static void BuildCreateValue(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Validator.Source arg1, ref ComplexValueBuilder o)
                                    {
                                        o.StartObject();
                                        Create(ref o, arg1);
                                        o.EndObject();
                                    ...
                                    /// <param name="arg1">The value of the property.</param>
                                    /// <param name="o">The complex value builder into which to write the object.</param>
                                    internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Validator.Source<TContext> arg1, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                                        where TContext : allows ref struct
#endif
                                    {
                                ...
                                /// </summary>
                                /// <param name="authValidator">The value of the <c>"auth/validator"</c> property.</param>
                                /// <returns>The source from which to build the value.</returns>
                                public static Source Build(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Validator.Source authValidator = default)
                                {
                                    return new Source(authValidator);
                                }
                                ...
                                /// <param name="authValidator">The value of the <c>"auth/validator"</c> property.</param>
                                /// <returns>The source from which to build the value.</returns>
                                public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Validator.Source<TContext> authValidator = default)
                                    #if NET9_0_OR_GREATER
                                    where TContext : allows ref struct
                                    #endif
                                {
                                    return new Source<TContext>(context, authValidator);
                                }
                                ...
                                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.KrakendSchema.Validator.Source authValidator = default, int initialCapacity = 30)
                                {
                                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                                    cvb.StartObject();
                                ...
                                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                                /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                                public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.KrakendBenchmark.Current.KrakendSchema.Validator.Source<TContext> authValidator = default, int initialCapacity = 30)
                                    #if NET9_0_OR_GREATER
                                    where TContext : allows ref struct
                                    #endif
                                {
                                ...
                                public static ParsedJsonDocument<ExtraConfiguration> Create(
                                    scoped in Source value, int initialCapacity = 30)
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        Debug.Assert(cvb.MemberCount == 1);
                                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                        return documentBuilder.ToParsedJsonDocument<ExtraConfiguration>();
                                    }
                                    finally
                                    {
                                ...
                                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                                public static ParsedJsonDocument<ExtraConfiguration> Create<TContext>(
                                ...
                                public static ParsedJsonDocument<ExtraConfiguration> Create(in Corvus.KrakendBenchmark.Current.KrakendSchema.Validator.Source authValidator = default, int initialCapacity = 30)
                                {
                                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                                    try
                                    {
                                ...
                                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
                                public static ParsedJsonDocument<ExtraConfiguration> Create<TContext>(in TContext context, in Corvus.KrakendBenchmark.Current.KrakendSchema.Validator.Source<TContext> authValidator = default, int initialCapacity = 30)
                                    #if NET9_0_OR_GREATER
                                    where TContext : allows ref struct
                                    #endif
                                {
