                ...
                public readonly partial struct ServicesEntity
                {
                    ...
                    public readonly partial struct MethodsEntityArray
                    {
...
#endif
                        {
                            ...
                            /// <summary>
                            /// Initializes a new instance of the <see cref="MethodsEntity"/> struct.
                            /// </summary>
                            /// <param name="value">The value from which to construct the instance.</param>
                            internal MethodsEntity(IJsonDocument parent, int idx)
                            {
                                Debug.Assert(idx >= 0);
                                _parent = parent;
                                _idx = idx;
                            ...
                            /// </summary>
                            public static MethodsEntity DefaultInstance { get; }
                            ...
                            /// </para>
                            /// </remarks>
                            public Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.ServicesEntityArray.ServicesEntity.MethodsEntityArray.MethodsEntity.BackendArray Backend
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BackendUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.ServicesEntityArray.ServicesEntity.MethodsEntityArray.MethodsEntity.BackendArray value))
                                    {
                                        return value;
                                    }
                            ...
                            /// </para>
                            /// </remarks>
                            public Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.ServicesEntityArray.ServicesEntity.MethodsEntityArray.MethodsEntity.ExtraConfiguration ExtraConfig
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExtraConfigUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.ServicesEntityArray.ServicesEntity.MethodsEntityArray.MethodsEntity.ExtraConfiguration value))
                                    {
                                        return value;
                                    }
                            ...
                            /// </para>
                            /// </remarks>
                            public Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.ServicesEntityArray.ServicesEntity.MethodsEntityArray.MethodsEntity.JsonStringArray InputHeaders
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.InputHeadersUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.ServicesEntityArray.ServicesEntity.MethodsEntityArray.MethodsEntity.JsonStringArray value))
                                    {
                                        return value;
                                    }

                                    return Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.ServicesEntityArray.ServicesEntity.MethodsEntityArray.MethodsEntity.JsonStringArray.DefaultInstance;
                                }
                            }
                            ...
                            /// </para>
                            /// </remarks>
                            public Corvus.KrakendBenchmark.Current.JsonObject PayloadParams
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PayloadParamsUtf8, out Corvus.KrakendBenchmark.Current.JsonObject value))
                                    {
                                        return value;
                                    }
                            ...
                            /// </returns>
                            public static bool operator ==(in MethodsEntity left, in MethodsEntity right)
                            {
                            ...
                            /// <c>True</c> if the values are equal.
                            /// </returns>
                            public static bool operator ==(in MethodsEntity left, in JsonElement right)
                            {
                                return left.Equals(right);
                            }
                            ...
                            public static implicit operator JsonElement(MethodsEntity instance)
                            {
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator MethodsEntity(JsonElement instance)
                            {
                                return MethodsEntity.From(instance);
                            }
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static MethodsEntity From<T>(in T instance)
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static MethodsEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                            {
                                #pragma warning disable CS0618 // Type or member is obsolete
                                return JsonElementHelpers.ParseValue<MethodsEntity>(utf8Json, options);
                            ...
                            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static MethodsEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                            {
                                #pragma warning disable CS0618 // Type or member is obsolete
                                return JsonElementHelpers.ParseValue<MethodsEntity>(json, options);
                                #pragma warning restore CS0618
                            }
                            ...
                            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static MethodsEntity ParseValue(string json, JsonDocumentOptions options = default)
                            {
                                #pragma warning disable CS0618 // Type or member is obsolete
                                return JsonElementHelpers.ParseValue<MethodsEntity>(json, options);
                                #pragma warning restore CS0618
                            ...
                            /// </exception>
                            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                            public static MethodsEntity ParseValue(ref Utf8JsonReader reader)
                            {
                                #pragma warning disable CS0618 // Type or member is obsolete
                                return JsonElementHelpers.ParseValue<MethodsEntity>(ref reader);
                                #pragma warning restore CS0618
                            }
                            ...
                            ///   A value could not be read from the reader.
                            /// </exception>
                            public static bool TryParseValue(ref Utf8JsonReader reader, out MethodsEntity? result)
                            {
                                return JsonElementHelpers.TryParseValue<MethodsEntity>(ref reader, out result);
                            }
                            ...
                            {
                                return
                                    (obj is IJsonElement value && Equals(new MethodsEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                            static MethodsEntity IJsonElement<MethodsEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            private string DebuggerDisplay => $"MethodsEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                            ...
                            /// <summary>
                            /// Gets a <see cref="MethodsEntity"/> which can be safely stored beyond the lifetime of the
                            /// original document.
                            /// </summary>
                            /// <returns>
                            /// A <see cref="MethodsEntity"/> which can be safely stored beyond the lifetime of the
                            /// original document.
                            /// </returns>
                            /// <remarks>
                            /// <para>
                            ...
                            /// </para>
                            /// </remarks>
                            public MethodsEntity Clone()
                            {
                                CheckValidInstance();
                                return _parent.CloneElement<MethodsEntity>(_idx);
                            }
                            ...
                            /// </summary>
                            /// <returns>
                            /// An immutable <see cref="MethodsEntity"/> that lives for the lifetime of its
                            ...
                            private static class JsonPropertyNamesEscaped
                            {
                                ...
                                /// <summary>
                                /// Gets the escaped UTF-8 JSON property name for <see cref="PayloadParams"/>.
                                /// </summary>
                                public static ReadOnlySpan<byte> PayloadParams => "payload_params"u8;
                            }
                            ...
                            private static class JsonPropertyNamesPrebaked
                            {
                                ...
                                /// <summary>
                                /// Gets the pre-baked property name blob for <see cref="PayloadParams"/>.
                                /// </summary>
                                public static ReadOnlySpan<byte> PayloadParams => [0x05, 0x01, 0x00, 0x00, 0x22, 0x70, 0x61, 0x79, 0x6C, 0x6F, 0x61, 0x64, 0x5F, 0x70, 0x61, 0x72, 0x61, 0x6D, 0x73, 0x22];
                            }
                        }
                    }
                }
