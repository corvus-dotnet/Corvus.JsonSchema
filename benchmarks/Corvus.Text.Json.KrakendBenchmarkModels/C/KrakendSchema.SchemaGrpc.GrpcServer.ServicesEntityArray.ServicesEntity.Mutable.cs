            ...
            public readonly partial struct ServicesEntityArray
            {
                ...
                public readonly partial struct ServicesEntity
                {
...
#endif
                    {
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.ServicesEntityArray.ServicesEntity.MethodsEntityArray.Mutable Methods
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MethodsUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.ServicesEntityArray.ServicesEntity.MethodsEntityArray.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        public void SetMethods(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.ServicesEntityArray.ServicesEntity.MethodsEntityArray.Source value)
                        {
                            CheckValidInstance();
                        ...
                        /// </summary>
                        /// <param name="value">The value of the property to add.</param>
                        public void SetMethods<TContext>(in Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.ServicesEntityArray.ServicesEntity.MethodsEntityArray.Source<TContext> value)
                    ...
                    public ref struct Source
                    {
                        ...
                        private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.ServicesEntityArray.ServicesEntity.MethodsEntityArray.Source _createArg1;
                        ...
                        internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.ServicesEntityArray.ServicesEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                        internal Source(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.ServicesEntityArray.ServicesEntity.MethodsEntityArray.Source arg1, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg2)
                        {
                            _createArg1 = arg1;
                            _createArg2 = arg2;
                            _kind = Kind.Create;
                        ...
                        #endif
                    {
                        ...
                        private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.ServicesEntityArray.ServicesEntity.MethodsEntityArray.Source<TContext> _createArg1;
                        private readonly Corvus.KrakendBenchmark.Current.JsonString.Source _createArg2;
                        ...
                        internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.ServicesEntityArray.ServicesEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

                        internal Source(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.ServicesEntityArray.ServicesEntity.MethodsEntityArray.Source<TContext> arg1, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg2)
                        {
                            _context = context;
                            _createArg1 = arg1;
                            _createArg2 = arg2;
                    ...
                    public ref struct Builder
                    {
                        ...
                        internal static void Create(
                            ...
                            in Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.ServicesEntityArray.ServicesEntity.MethodsEntityArray.Source methods = default,
                        ...
                        /// Creates an instance of a <see cref="ServicesEntity"/>.
                        /// </summary>
                        public void Create(in Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.ServicesEntityArray.ServicesEntity.MethodsEntityArray.Source methods = default, in Corvus.KrakendBenchmark.Current.JsonString.Source name = default)
                        {
                        ...
                        internal static void Create<TContext>(
                            in TContext context,
                            ref ComplexValueBuilder builder,
                            in Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.ServicesEntityArray.ServicesEntity.MethodsEntityArray.Source<TContext> methods = default,
                            in Corvus.KrakendBenchmark.Current.JsonString.Source name = default)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                        ...
                        internal static void BuildCreateValue(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.ServicesEntityArray.ServicesEntity.MethodsEntityArray.Source arg1, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg2, ref ComplexValueBuilder o)
                        {
                            o.StartObject();
                        ...
                        /// <param name="arg2">The value of the property.</param>
                        /// <param name="o">The complex value builder into which to write the object.</param>
                        internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.ServicesEntityArray.ServicesEntity.MethodsEntityArray.Source<TContext> arg1, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg2, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                            where TContext : allows ref struct
#endif
                        {
                    ...
                    /// <returns>The source from which to build the value.</returns>
                    public static Source Build(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.ServicesEntityArray.ServicesEntity.MethodsEntityArray.Source methods = default, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source name = default)
                    {
                        return new Source(methods, name);
                    }
                    ...
                    /// <param name="name">The value of the <c>"name"</c> property.</param>
                    /// <returns>The source from which to build the value.</returns>
                    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.ServicesEntityArray.ServicesEntity.MethodsEntityArray.Source<TContext> methods = default, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source name = default)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                    {
                        return new Source<TContext>(context, methods, name);
                    }
                    ...
                    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.ServicesEntityArray.ServicesEntity.MethodsEntityArray.Source methods = default, in Corvus.KrakendBenchmark.Current.JsonString.Source name = default, int initialCapacity = 30)
                    {
                        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                        cvb.StartObject();
                    ...
                    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.ServicesEntityArray.ServicesEntity.MethodsEntityArray.Source<TContext> methods = default, in Corvus.KrakendBenchmark.Current.JsonString.Source name = default, int initialCapacity = 30)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                    {
                    ...
                    public static ParsedJsonDocument<ServicesEntity> Create(
                        scoped in Source value, int initialCapacity = 30)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<ServicesEntity>();
                        }
                        finally
                        {
                    ...
                    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                    public static ParsedJsonDocument<ServicesEntity> Create<TContext>(
                    ...
                    public static ParsedJsonDocument<ServicesEntity> Create(in Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.ServicesEntityArray.ServicesEntity.MethodsEntityArray.Source methods = default, in Corvus.KrakendBenchmark.Current.JsonString.Source name = default, int initialCapacity = 30)
                    {
                        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                        try
                        {
                    ...
                    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
                    public static ParsedJsonDocument<ServicesEntity> Create<TContext>(in TContext context, in Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.ServicesEntityArray.ServicesEntity.MethodsEntityArray.Source<TContext> methods = default, in Corvus.KrakendBenchmark.Current.JsonString.Source name = default, int initialCapacity = 30)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                    {
