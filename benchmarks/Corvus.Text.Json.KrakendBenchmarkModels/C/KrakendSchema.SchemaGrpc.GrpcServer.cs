...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct SchemaGrpc
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="GrpcServer"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal GrpcServer(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static GrpcServer DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.OpenTelemetrySettings Opentelemetry
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OpentelemetryUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.OpenTelemetrySettings value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.ServicesEntityArray Services
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ServicesUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.ServicesEntityArray value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in GrpcServer left, in GrpcServer right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in GrpcServer left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(GrpcServer instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator GrpcServer(JsonElement instance)
            {
                return GrpcServer.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static GrpcServer From<T>(in T instance)
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static GrpcServer ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<GrpcServer>(utf8Json, options);
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static GrpcServer ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<GrpcServer>(json, options);
                #pragma warning restore CS0618
            }
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static GrpcServer ParseValue(string json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<GrpcServer>(json, options);
                #pragma warning restore CS0618
            ...
            /// </exception>
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            public static GrpcServer ParseValue(ref Utf8JsonReader reader)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<GrpcServer>(ref reader);
                #pragma warning restore CS0618
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out GrpcServer? result)
            {
                return JsonElementHelpers.TryParseValue<GrpcServer>(ref reader, out result);
            }
...
#if NET
            static GrpcServer IJsonElement<GrpcServer>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"GrpcServer: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            {
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="Opentelemetry"/>.
                /// </summary>
                public static ReadOnlySpan<byte> Opentelemetry => "opentelemetry"u8;
            ...
            {
                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="Opentelemetry"/>.
                /// </summary>
                public static ReadOnlySpan<byte> Opentelemetry => [0xF5, 0x00, 0x00, 0x00, 0x22, 0x6F, 0x70, 0x65, 0x6E, 0x74, 0x65, 0x6C, 0x65, 0x6D, 0x65, 0x74, 0x72, 0x79, 0x22];

                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="Services"/>.
                /// </summary>
                public static ReadOnlySpan<byte> Services => [0xA5, 0x00, 0x00, 0x00, 0x22, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x22];
            }
        }
    }
}
