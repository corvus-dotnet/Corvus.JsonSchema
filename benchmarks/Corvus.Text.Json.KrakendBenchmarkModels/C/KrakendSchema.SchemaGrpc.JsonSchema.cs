...
public readonly partial struct KrakendSchema
{
        ...
        : IJsonElement<SchemaGrpc>
    {
        ...
        {
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyCatalogPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("catalog"u8, buffer, out written);
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyCatalogNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("catalog"u8, buffer, out written);

            private const int RequiredOffsetForCatalog = 0;
            private const uint RequiredBitForCatalog = 0b00000000000000000000000000000001;

            private const uint RequiredBitMask0 =
                RequiredBitForCatalog;
            private static readonly JsonSchemaPathProvider CatalogSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/catalog"u8, buffer, out written);
            ...
            private static void MatchCatalog(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext =
                    Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.JsonStringArray.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.CatalogUtf8,
                        evaluationPath: CatalogSchemaEvaluationPath);

                Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.JsonStringArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                ...
                requiredBitBuffer[RequiredOffsetForCatalog] |= RequiredBitForCatalog;
            }

            private static void MatchServer(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext1 =
                    Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaGrpc.GrpcServer.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
            ...
            private static PropertySchemaMatchers<Corvus.KrakendBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
            {
                return new PropertySchemaMatchers<Corvus.KrakendBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator>([
                    (static () => JsonPropertyNames.CatalogUtf8, MatchCatalog),
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1grpc.json"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1grpc.json";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1grpc.json"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyCatalogPresent, "catalog"u8, "required"u8);
                    }
                    ...
                    {
                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForCatalog] & RequiredBitForCatalog) == 0)
                        {
                            context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyCatalogNotPresent, "catalog"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyCatalogPresent, "catalog"u8, "required"u8);
