    ...
    public readonly partial struct SchemaRouter
    {
        ...
        public readonly partial struct CustomErrorBody
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(CustomErrorBody instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="CustomErrorBody"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator CustomErrorBody(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.JsonObject.Mutable V404
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.V404Utf8, out Corvus.KrakendBenchmark.Current.JsonObject.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.KrakendBenchmark.Current.JsonObject.Mutable V405
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.V405Utf8, out Corvus.KrakendBenchmark.Current.JsonObject.Mutable value))
                        {
                            return value;
                        }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new CustomErrorBody(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                /// <summary>
                /// Set the <c>404</c> property.
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetV404(scoped in Corvus.KrakendBenchmark.Current.JsonObject.Source value)
                {
                    CheckValidInstance();

                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.V404Utf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.V404Utf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                    ...
                    else
                    {
                        ...
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.V404, ref cvb);
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetV404<TContext>(in Corvus.KrakendBenchmark.Current.JsonObject.Source<TContext> value)
                ...
                /// <summary>
                /// Remove the <c>404</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveV404()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.V404Utf8);
                    _documentVersion = _parent.Version;
                    return result;
                }

                /// <summary>
                /// Set the <c>405</c> property.
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetV405(scoped in Corvus.KrakendBenchmark.Current.JsonObject.Source value)
                {
                    CheckValidInstance();

                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.V405Utf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.V405Utf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.V405, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetV405<TContext>(in Corvus.KrakendBenchmark.Current.JsonObject.Source<TContext> value)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
                ...
                /// <summary>
                /// Remove the <c>405</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveV405()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.V405Utf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"CustomErrorBody.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="CustomErrorBody"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="CustomErrorBody"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly CustomErrorBody Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<CustomErrorBody>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="CustomErrorBody"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly CustomErrorBody Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<CustomErrorBody>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.KrakendBenchmark.Current.JsonObject.Source _createArg1;
                private readonly Corvus.KrakendBenchmark.Current.JsonObject.Source _createArg2;
                ...
                internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaRouter.CustomErrorBody.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in Corvus.KrakendBenchmark.Current.JsonObject.Source arg1, scoped in Corvus.KrakendBenchmark.Current.JsonObject.Source arg2)
                {
                    _createArg1 = arg1;
                    _createArg2 = arg2;
                    _kind = Kind.Create;
                ...
                public static implicit operator Source(CustomErrorBody instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                private readonly Corvus.KrakendBenchmark.Current.JsonObject.Source<TContext> _createArg1;
                private readonly Corvus.KrakendBenchmark.Current.JsonObject.Source<TContext> _createArg2;
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.SchemaRouter.CustomErrorBody.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.JsonObject.Source<TContext> arg1, scoped in Corvus.KrakendBenchmark.Current.JsonObject.Source<TContext> arg2)
                {
                    _context = context;
                    _createArg1 = arg1;
                    _createArg2 = arg2;
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="CustomErrorBody"/>.
                /// </summary>
                internal static void Create(
                    ref ComplexValueBuilder builder,
                    in Corvus.KrakendBenchmark.Current.JsonObject.Source value404 = default,
                    in Corvus.KrakendBenchmark.Current.JsonObject.Source value405 = default)
                {
                    value404.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.V404, ref builder);
                    value405.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.V405, ref builder);
                }

                /// <summary>
                /// Creates an instance of a <see cref="CustomErrorBody"/>.
                /// </summary>
                public void Create(in Corvus.KrakendBenchmark.Current.JsonObject.Source value404 = default, in Corvus.KrakendBenchmark.Current.JsonObject.Source value405 = default)
                {
                    Create(ref _builder, value404, value405);
                }
                ...
                internal static void Create<TContext>(
                    in TContext context,
                    ref ComplexValueBuilder builder,
                    in Corvus.KrakendBenchmark.Current.JsonObject.Source<TContext> value404 = default,
                    in Corvus.KrakendBenchmark.Current.JsonObject.Source<TContext> value405 = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
                ...
                #endif
                {
                    Create(context, ref _builder, value404, value405);
                }
                ...
                internal static void BuildCreateValue(scoped in Corvus.KrakendBenchmark.Current.JsonObject.Source arg1, scoped in Corvus.KrakendBenchmark.Current.JsonObject.Source arg2, ref ComplexValueBuilder o)
                {
                    o.StartObject();
                ...
                /// <param name="arg2">The value of the property.</param>
                /// <param name="o">The complex value builder into which to write the object.</param>
                internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.JsonObject.Source<TContext> arg1, scoped in Corvus.KrakendBenchmark.Current.JsonObject.Source<TContext> arg2, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
            ...
            /// </summary>
            /// <param name="value404">The value of the <c>"404"</c> property.</param>
            /// <param name="value405">The value of the <c>"405"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.KrakendBenchmark.Current.JsonObject.Source value404 = default, scoped in Corvus.KrakendBenchmark.Current.JsonObject.Source value405 = default)
            {
                return new Source(value404, value405);
            }
            ...
            /// <param name="value405">The value of the <c>"405"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.JsonObject.Source<TContext> value404 = default, scoped in Corvus.KrakendBenchmark.Current.JsonObject.Source<TContext> value405 = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                return new Source<TContext>(context, value404, value405);
            }
            ...
            /// </summary>
            /// <param name="workspace">The JSON workspace.</param>
            /// <param name="value404">The value of the property.</param>
            /// <param name="value405">The value of the property.</param>
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.JsonObject.Source value404 = default, in Corvus.KrakendBenchmark.Current.JsonObject.Source value405 = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(value404, value405);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.KrakendBenchmark.Current.JsonObject.Source<TContext> value404 = default, in Corvus.KrakendBenchmark.Current.JsonObject.Source<TContext> value405 = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                ...
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(context, value404, value405);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<CustomErrorBody, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<CustomErrorBody> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<CustomErrorBody>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<CustomErrorBody> Create<TContext>(
            ...
            public static ParsedJsonDocument<CustomErrorBody> Create(in Corvus.KrakendBenchmark.Current.JsonObject.Source value404 = default, in Corvus.KrakendBenchmark.Current.JsonObject.Source value405 = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
            public static ParsedJsonDocument<CustomErrorBody> Create<TContext>(in TContext context, in Corvus.KrakendBenchmark.Current.JsonObject.Source<TContext> value404 = default, in Corvus.KrakendBenchmark.Current.JsonObject.Source<TContext> value405 = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
