    ...
    public readonly partial struct SchemaRouter
    {
        ...
        public readonly partial struct DecompressGzip
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DecompressGzip, Mutable>(DecompressGzip.DefaultInstance);
            ...
            public static ParsedJsonDocument<DecompressGzip> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<DecompressGzip>();
                }
                finally
                {
