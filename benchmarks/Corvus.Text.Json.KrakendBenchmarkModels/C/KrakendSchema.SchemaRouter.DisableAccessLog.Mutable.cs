    ...
    public readonly partial struct SchemaRouter
    {
        ...
        public readonly partial struct DisableAccessLog
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DisableAccessLog, Mutable>(DisableAccessLog.DefaultInstance);
                ...
                public static explicit operator Mutable(DisableAccessLog instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DisableAccessLog"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DisableAccessLog(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DisableAccessLog.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly DisableAccessLog Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly DisableAccessLog Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DisableAccessLog>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(DisableAccessLog instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<DisableAccessLog, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<DisableAccessLog> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<DisableAccessLog>();
                }
                finally
                {
