    ...
    public readonly partial struct SchemaRouter
    {
        ...
        public readonly partial struct DisableGzipCompression
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DisableGzipCompression, Mutable>(DisableGzipCompression.DefaultInstance);
                ...
                public static explicit operator Mutable(DisableGzipCompression instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DisableGzipCompression"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DisableGzipCompression(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DisableGzipCompression.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly DisableGzipCompression Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly DisableGzipCompression Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DisableGzipCompression>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(DisableGzipCompression instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<DisableGzipCompression, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<DisableGzipCompression> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<DisableGzipCompression>();
                }
                finally
                {
