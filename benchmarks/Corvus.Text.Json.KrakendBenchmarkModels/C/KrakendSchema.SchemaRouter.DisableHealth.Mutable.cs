    ...
    public readonly partial struct SchemaRouter
    {
        ...
        public readonly partial struct DisableHealth
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DisableHealth, Mutable>(DisableHealth.DefaultInstance);
                ...
                public static explicit operator Mutable(DisableHealth instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DisableHealth"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DisableHealth(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DisableHealth.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly DisableHealth Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly DisableHealth Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DisableHealth>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(DisableHealth instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<DisableHealth, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<DisableHealth> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<DisableHealth>();
                }
                finally
                {
