    ...
    public readonly partial struct SchemaRouter
    {
        ...
        public readonly partial struct EnableH2c
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<EnableH2c, Mutable>(EnableH2c.DefaultInstance);
            ...
            public static ParsedJsonDocument<EnableH2c> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<EnableH2c>();
                }
                finally
                {
