    ...
    public readonly partial struct SchemaRouter
    {
        ...
        public readonly partial struct ForwardedByClientIp
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ForwardedByClientIp, Mutable>(ForwardedByClientIp.DefaultInstance);
            ...
            public static ParsedJsonDocument<ForwardedByClientIp> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ForwardedByClientIp>();
                }
                finally
                {
