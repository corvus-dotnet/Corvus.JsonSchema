    ...
    public readonly partial struct SchemaRouter
    {
        ...
        public readonly partial struct HealthEndpointPath
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<HealthEndpointPath, Mutable>(HealthEndpointPath.DefaultInstance);
            ...
            public static ParsedJsonDocument<HealthEndpointPath> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<HealthEndpointPath>();
                }
                finally
                {
