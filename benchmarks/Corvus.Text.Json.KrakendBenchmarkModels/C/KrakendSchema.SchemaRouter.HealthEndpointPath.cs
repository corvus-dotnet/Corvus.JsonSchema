...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct SchemaRouter
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="HealthEndpointPath"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal HealthEndpointPath(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static HealthEndpointPath DefaultInstance { get; } = ParsedJsonDocument<HealthEndpointPath>.StringConstant([.."\"/__health\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(HealthEndpointPath value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in HealthEndpointPath left, in HealthEndpointPath right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in HealthEndpointPath left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(HealthEndpointPath instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator HealthEndpointPath(JsonElement instance)
            {
                return HealthEndpointPath.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HealthEndpointPath From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HealthEndpointPath ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<HealthEndpointPath>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HealthEndpointPath ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<HealthEndpointPath>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HealthEndpointPath ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<HealthEndpointPath>(json, options);
            }
            ...
            /// </exception>
            public static HealthEndpointPath ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<HealthEndpointPath>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out HealthEndpointPath? result)
            {
                return JsonElementHelpers.TryParseValue<HealthEndpointPath>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new HealthEndpointPath(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static HealthEndpointPath IJsonElement<HealthEndpointPath>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"HealthEndpointPath: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="HealthEndpointPath"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="HealthEndpointPath"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public HealthEndpointPath Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<HealthEndpointPath>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="HealthEndpointPath"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public HealthEndpointPath Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<HealthEndpointPath>(_idx);
                }
