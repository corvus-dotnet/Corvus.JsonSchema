    ...
    public readonly partial struct SchemaRouter
    {
        ...
        public readonly partial struct HideVersionHeader
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<HideVersionHeader, Mutable>(HideVersionHeader.DefaultInstance);
            ...
            public static ParsedJsonDocument<HideVersionHeader> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<HideVersionHeader>();
                }
                finally
                {
