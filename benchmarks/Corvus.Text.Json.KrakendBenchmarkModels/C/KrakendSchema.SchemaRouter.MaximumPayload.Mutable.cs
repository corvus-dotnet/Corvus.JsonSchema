    ...
    public readonly partial struct SchemaRouter
    {
        ...
        public readonly partial struct MaximumPayload
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<MaximumPayload, Mutable>(MaximumPayload.DefaultInstance);
            ...
            public static ParsedJsonDocument<MaximumPayload> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<MaximumPayload>();
                }
                finally
                {
