    ...
    public readonly partial struct SchemaRouter
    {
            ...
            : IJsonElement<RemoveExtraSlash>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1router.json/properties/remove_extra_slash"u8, buffer, out written);
