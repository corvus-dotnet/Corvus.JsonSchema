    ...
    public readonly partial struct SchemaRouter
    {
        ...
        public readonly partial struct RemoveExtraSlash
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<RemoveExtraSlash, Mutable>(RemoveExtraSlash.DefaultInstance);
            ...
            public static ParsedJsonDocument<RemoveExtraSlash> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RemoveExtraSlash>();
                }
                finally
                {
