    ...
    public readonly partial struct SchemaRouter
    {
        ...
        public readonly partial struct ReturningTheGatewayErrorMessage
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ReturningTheGatewayErrorMessage, Mutable>(ReturningTheGatewayErrorMessage.DefaultInstance);
                ...
                public static explicit operator Mutable(ReturningTheGatewayErrorMessage instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ReturningTheGatewayErrorMessage"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ReturningTheGatewayErrorMessage(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ReturningTheGatewayErrorMessage.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ReturningTheGatewayErrorMessage Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ReturningTheGatewayErrorMessage Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ReturningTheGatewayErrorMessage>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ReturningTheGatewayErrorMessage instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ReturningTheGatewayErrorMessage, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ReturningTheGatewayErrorMessage> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ReturningTheGatewayErrorMessage>();
                }
                finally
                {
