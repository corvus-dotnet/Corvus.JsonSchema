...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct SequentialStart
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SequentialStart, Mutable>(SequentialStart.DefaultInstance);
            ...
            public static explicit operator Mutable(SequentialStart instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="SequentialStart"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SequentialStart(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SequentialStart.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly SequentialStart Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly SequentialStart Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<SequentialStart>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(SequentialStart instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<SequentialStart, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<SequentialStart> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<SequentialStart>();
            }
            finally
            {
