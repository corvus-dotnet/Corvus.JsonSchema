...
public readonly partial struct KrakendSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SequentialStart"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal SequentialStart(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static SequentialStart DefaultInstance { get; } = ParsedJsonDocument<SequentialStart>.False;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator bool(SequentialStart value)
        {
        ...
        /// </returns>
        public static bool operator ==(in SequentialStart left, in SequentialStart right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in SequentialStart left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(SequentialStart instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator SequentialStart(JsonElement instance)
        {
            return SequentialStart.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SequentialStart From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SequentialStart ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SequentialStart>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SequentialStart ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SequentialStart>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SequentialStart ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SequentialStart>(json, options);
        }
        ...
        /// </exception>
        public static SequentialStart ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<SequentialStart>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out SequentialStart? result)
        {
            return JsonElementHelpers.TryParseValue<SequentialStart>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new SequentialStart(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static SequentialStart IJsonElement<SequentialStart>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"SequentialStart: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="SequentialStart"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="SequentialStart"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public SequentialStart Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<SequentialStart>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="SequentialStart"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public SequentialStart Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<SequentialStart>(_idx);
            }
