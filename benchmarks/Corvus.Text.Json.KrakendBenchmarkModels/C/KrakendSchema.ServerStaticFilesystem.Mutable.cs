...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct ServerStaticFilesystem
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ServerStaticFilesystem instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ServerStaticFilesystem"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ServerStaticFilesystem(Mutable instance)
            {
            ...
            /// <summary>
            /// Gets the (optional) <c>directory_listing</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.ServerStaticFilesystem.WhetherToAllowDirectoryListingsOrNot.Mutable DirectoryListing
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DirectoryListingUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.ServerStaticFilesystem.WhetherToAllowDirectoryListingsOrNot.Mutable value))
                    {
                        return value;
                    }

                    return Corvus.KrakendBenchmark.Current.KrakendSchema.ServerStaticFilesystem.WhetherToAllowDirectoryListingsOrNot.Mutable.DefaultInstance;
                }
            }
            ...
            /// <summary>
            /// Gets the (optional) <c>skip</c> property.
            /// Skip paths
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ServerStaticFilesystem(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetDirectoryListing(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.ServerStaticFilesystem.WhetherToAllowDirectoryListingsOrNot.Source value)
            {
                ...
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.DirectoryListingUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DirectoryListingUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
            ...
            /// <summary>
            /// Remove the <c>directory_listing</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveDirectoryListing()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.DirectoryListingUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            public void SetPrefix(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source value)
            {
                ...
                if (value.IsUndefined)
                {
                    CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("prefix");
                }
            ...
            public void SetSkip(scoped in Corvus.KrakendBenchmark.Current.JsonArray.Source value)
            {
                ...
                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.SkipUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SkipUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            /// <summary>
            /// Remove the <c>skip</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveSkip()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.SkipUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ServerStaticFilesystem.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ServerStaticFilesystem"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ServerStaticFilesystem"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly ServerStaticFilesystem Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ServerStaticFilesystem>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ServerStaticFilesystem"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly ServerStaticFilesystem Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ServerStaticFilesystem>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.ServerStaticFilesystem.WhetherToAllowDirectoryListingsOrNot.Source _createArg3;
            ...
            public static implicit operator Source(ServerStaticFilesystem instance) => new(JsonElement.From(instance));
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="ServerStaticFilesystem"/>.
            /// </summary>
            internal static void Create(
                ...
                in Corvus.KrakendBenchmark.Current.KrakendSchema.ServerStaticFilesystem.WhetherToAllowDirectoryListingsOrNot.Source directoryListing = default,
            ...
            #endif
            {
                Create(context, ref _builder, path, prefix, directoryListing, skip);
            }
        ...
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source path, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source prefix, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.ServerStaticFilesystem.WhetherToAllowDirectoryListingsOrNot.Source directoryListing = default, scoped in Corvus.KrakendBenchmark.Current.JsonArray.Source<TContext> skip = default)
            ...
            #endif
        {
            return new Source<TContext>(context, path, prefix, directoryListing, skip);
        }
        ...
        /// <param name="directoryListing">The value of the property.</param>
        /// <param name="skip">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.JsonString.Source path, in Corvus.KrakendBenchmark.Current.JsonString.Source prefix, in Corvus.KrakendBenchmark.Current.KrakendSchema.ServerStaticFilesystem.WhetherToAllowDirectoryListingsOrNot.Source directoryListing = default, in Corvus.KrakendBenchmark.Current.JsonArray.Source skip = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(path, prefix, directoryListing, skip);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.KrakendBenchmark.Current.JsonString.Source path, in Corvus.KrakendBenchmark.Current.JsonString.Source prefix, in Corvus.KrakendBenchmark.Current.KrakendSchema.ServerStaticFilesystem.WhetherToAllowDirectoryListingsOrNot.Source directoryListing = default, in Corvus.KrakendBenchmark.Current.JsonArray.Source<TContext> skip = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            ...
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(context, path, prefix, directoryListing, skip);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<ServerStaticFilesystem, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ServerStaticFilesystem> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ServerStaticFilesystem>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ServerStaticFilesystem> Create<TContext>(
        ...
        public static ParsedJsonDocument<ServerStaticFilesystem> Create(in Corvus.KrakendBenchmark.Current.JsonString.Source path, in Corvus.KrakendBenchmark.Current.JsonString.Source prefix, in Corvus.KrakendBenchmark.Current.KrakendSchema.ServerStaticFilesystem.WhetherToAllowDirectoryListingsOrNot.Source directoryListing = default, in Corvus.KrakendBenchmark.Current.JsonArray.Source skip = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ServerStaticFilesystem> Create<TContext>(in TContext context, in Corvus.KrakendBenchmark.Current.JsonString.Source path, in Corvus.KrakendBenchmark.Current.JsonString.Source prefix, in Corvus.KrakendBenchmark.Current.KrakendSchema.ServerStaticFilesystem.WhetherToAllowDirectoryListingsOrNot.Source directoryListing = default, in Corvus.KrakendBenchmark.Current.JsonArray.Source<TContext> skip = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
