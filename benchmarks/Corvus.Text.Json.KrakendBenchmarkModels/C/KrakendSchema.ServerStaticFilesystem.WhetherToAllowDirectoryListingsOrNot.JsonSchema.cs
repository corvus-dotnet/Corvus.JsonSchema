    ...
    public readonly partial struct ServerStaticFilesystem
    {
            ...
            : IJsonElement<WhetherToAllowDirectoryListingsOrNot>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1server~1static-filesystem.json/properties/directory_listing"u8, buffer, out written);
