...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct ServerStaticFilesystem
    {
        ...
        public readonly partial struct WhetherToAllowDirectoryListingsOrNot
#if NET8_0_OR_GREATER
            : IJsonElement<WhetherToAllowDirectoryListingsOrNot>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="WhetherToAllowDirectoryListingsOrNot"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal WhetherToAllowDirectoryListingsOrNot(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static WhetherToAllowDirectoryListingsOrNot DefaultInstance { get; } = ParsedJsonDocument<WhetherToAllowDirectoryListingsOrNot>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(WhetherToAllowDirectoryListingsOrNot value)
            {
            ...
            /// </returns>
            public static bool operator ==(in WhetherToAllowDirectoryListingsOrNot left, in WhetherToAllowDirectoryListingsOrNot right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in WhetherToAllowDirectoryListingsOrNot left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(WhetherToAllowDirectoryListingsOrNot instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator WhetherToAllowDirectoryListingsOrNot(JsonElement instance)
            {
                return WhetherToAllowDirectoryListingsOrNot.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WhetherToAllowDirectoryListingsOrNot From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WhetherToAllowDirectoryListingsOrNot ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<WhetherToAllowDirectoryListingsOrNot>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WhetherToAllowDirectoryListingsOrNot ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<WhetherToAllowDirectoryListingsOrNot>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WhetherToAllowDirectoryListingsOrNot ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<WhetherToAllowDirectoryListingsOrNot>(json, options);
            }
            ...
            /// </exception>
            public static WhetherToAllowDirectoryListingsOrNot ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<WhetherToAllowDirectoryListingsOrNot>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out WhetherToAllowDirectoryListingsOrNot? result)
            {
                return JsonElementHelpers.TryParseValue<WhetherToAllowDirectoryListingsOrNot>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new WhetherToAllowDirectoryListingsOrNot(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static WhetherToAllowDirectoryListingsOrNot IJsonElement<WhetherToAllowDirectoryListingsOrNot>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"WhetherToAllowDirectoryListingsOrNot: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="WhetherToAllowDirectoryListingsOrNot"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="WhetherToAllowDirectoryListingsOrNot"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public WhetherToAllowDirectoryListingsOrNot Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<WhetherToAllowDirectoryListingsOrNot>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="WhetherToAllowDirectoryListingsOrNot"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public WhetherToAllowDirectoryListingsOrNot Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<WhetherToAllowDirectoryListingsOrNot>(_idx);
                }
