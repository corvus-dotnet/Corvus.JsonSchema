...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct ServerStaticFilesystem
        ...
        : IJsonElement<ServerStaticFilesystem>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ServerStaticFilesystem"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ServerStaticFilesystem(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ServerStaticFilesystem DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.ServerStaticFilesystem.WhetherToAllowDirectoryListingsOrNot DirectoryListing
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DirectoryListingUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.ServerStaticFilesystem.WhetherToAllowDirectoryListingsOrNot value))
                {
                    return value;
                }

                return Corvus.KrakendBenchmark.Current.KrakendSchema.ServerStaticFilesystem.WhetherToAllowDirectoryListingsOrNot.DefaultInstance;
            }
        }
        ...
        /// </returns>
        public static bool operator ==(in ServerStaticFilesystem left, in ServerStaticFilesystem right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ServerStaticFilesystem left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(ServerStaticFilesystem instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ServerStaticFilesystem(JsonElement instance)
        {
            return ServerStaticFilesystem.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ServerStaticFilesystem From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ServerStaticFilesystem ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ServerStaticFilesystem>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ServerStaticFilesystem ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ServerStaticFilesystem>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ServerStaticFilesystem ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ServerStaticFilesystem>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static ServerStaticFilesystem ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ServerStaticFilesystem>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ServerStaticFilesystem? result)
        {
            return JsonElementHelpers.TryParseValue<ServerStaticFilesystem>(ref reader, out result);
        }
...
#if NET
        static ServerStaticFilesystem IJsonElement<ServerStaticFilesystem>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ServerStaticFilesystem: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public ServerStaticFilesystem Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public ServerStaticFilesystem Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ServerStaticFilesystem>(_idx);
            }
