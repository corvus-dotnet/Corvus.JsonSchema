...
public readonly partial struct KrakendSchema
{
        ...
        : IJsonElement<ServerVirtualhost>
    {
        public static partial class JsonSchema
        {
            ...
            private static void MatchAliasedHosts(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext =
                    Corvus.KrakendBenchmark.Current.KrakendSchema.ServerVirtualhost.VirtualhostsWithAlias.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.KrakendBenchmark.Current.KrakendSchema.ServerVirtualhost.VirtualhostsWithAlias.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                context.CommitChildContext(childContext.IsMatch, ref childContext);
            }

            private static void MatchHosts(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext1 =
                    Corvus.KrakendBenchmark.Current.KrakendSchema.ServerVirtualhost.JsonStringArray.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.KrakendBenchmark.Current.KrakendSchema.ServerVirtualhost.JsonStringArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                ...
                ref JsonSchemaContext context)
            {
                ...
                JsonSchemaContext oneOfContext0 =
                    Corvus.KrakendBenchmark.Current.KrakendSchema.ServerVirtualhost.RequiredHosts.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf0SchemaEvaluationPath);
                Corvus.KrakendBenchmark.Current.KrakendSchema.ServerVirtualhost.RequiredHosts.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext0);
                ...
                JsonSchemaContext oneOfContext1 =
                    Corvus.KrakendBenchmark.Current.KrakendSchema.ServerVirtualhost.RequiredAliasedHosts.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf1SchemaEvaluationPath);
                Corvus.KrakendBenchmark.Current.KrakendSchema.ServerVirtualhost.RequiredAliasedHosts.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext1);
