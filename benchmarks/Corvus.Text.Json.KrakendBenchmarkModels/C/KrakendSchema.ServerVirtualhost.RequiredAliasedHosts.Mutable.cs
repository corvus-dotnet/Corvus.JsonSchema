...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct ServerVirtualhost
    {
        ...
        public readonly partial struct RequiredAliasedHosts
        {
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(in Corvus.Text.Json.JsonElement.Source aliasedHosts)
            {
            ...
            /// <param name="aliasedHosts">The value of the <c>"aliased_hosts"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> aliasedHosts)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
