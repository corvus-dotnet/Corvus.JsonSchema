...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct ServerVirtualhost
    {
        ...
        public readonly partial struct RequiredHosts
        {
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(in Corvus.Text.Json.JsonElement.Source hosts)
            {
            ...
            /// <param name="hosts">The value of the <c>"hosts"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> hosts)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
