    ...
    public readonly partial struct ServerVirtualhost
    {
            ...
            : IJsonElement<VirtualhostsWithAlias>
        {
            public static partial class JsonSchema
            {
                ...
                private static void MatchAz09(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/https:~1~1www.krakend.io~1schema~1v2.7~1server~1virtualhost.json/properties/aliased_hosts"u8, buffer, out written);
