    ...
    public readonly partial struct ServerVirtualhost
    {
        ...
        public readonly partial struct VirtualhostsWithAlias
        {
...
#endif
            {
                ...
                public void SetAZ09(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source value)
                {
                    CheckValidInstance();
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.ServerVirtualhost.VirtualhostsWithAlias.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.ServerVirtualhost.VirtualhostsWithAlias.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            /// </summary>
            /// <param name="aZ09">The value of the <c>"[a-z0-9_]"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source aZ09 = default)
            {
                return new Source(aZ09);
            }
            ...
            public static ParsedJsonDocument<VirtualhostsWithAlias> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<VirtualhostsWithAlias>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<VirtualhostsWithAlias> Create<TContext>(
            ...
            public static ParsedJsonDocument<VirtualhostsWithAlias> Create(in Corvus.KrakendBenchmark.Current.JsonString.Source aZ09 = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
