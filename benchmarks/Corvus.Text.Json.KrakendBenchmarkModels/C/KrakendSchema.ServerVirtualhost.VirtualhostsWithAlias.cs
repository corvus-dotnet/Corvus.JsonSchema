...
public readonly partial struct KrakendSchema
{
    ...
    /// </para>
    /// </remarks>
    public readonly partial struct ServerVirtualhost
    {
        /// <summary>
        ...
        public readonly partial struct VirtualhostsWithAlias
#if NET8_0_OR_GREATER
            : IJsonElement<VirtualhostsWithAlias>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="VirtualhostsWithAlias"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal VirtualhostsWithAlias(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static VirtualhostsWithAlias DefaultInstance { get; }
            ...
            /// <summary>
            /// Gets the (optional) <c>[a-z0-9_]</c> property.
            /// Virtualhost
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.JsonString AZ09
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AZ09Utf8, out Corvus.KrakendBenchmark.Current.JsonString value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in VirtualhostsWithAlias left, in VirtualhostsWithAlias right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in VirtualhostsWithAlias left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(VirtualhostsWithAlias instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator VirtualhostsWithAlias(JsonElement instance)
            {
                return VirtualhostsWithAlias.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static VirtualhostsWithAlias From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static VirtualhostsWithAlias ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<VirtualhostsWithAlias>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static VirtualhostsWithAlias ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<VirtualhostsWithAlias>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static VirtualhostsWithAlias ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<VirtualhostsWithAlias>(json, options);
            }
            ...
            /// </exception>
            public static VirtualhostsWithAlias ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<VirtualhostsWithAlias>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out VirtualhostsWithAlias? result)
            {
                return JsonElementHelpers.TryParseValue<VirtualhostsWithAlias>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new VirtualhostsWithAlias(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static VirtualhostsWithAlias IJsonElement<VirtualhostsWithAlias>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"VirtualhostsWithAlias: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="VirtualhostsWithAlias"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="VirtualhostsWithAlias"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public VirtualhostsWithAlias Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<VirtualhostsWithAlias>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="VirtualhostsWithAlias"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public VirtualhostsWithAlias Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<VirtualhostsWithAlias>(_idx);
                }
            ...
            {
                /// <summary>
                /// Gets the JSON property name for <see cref="AZ09"/>.
                /// </summary>
                public const string AZ09 = "[a-z0-9_]";

                /// <summary>
                /// Gets the JSON property name for <see cref="AZ09"/>.
                /// </summary>
                public static ReadOnlySpan<byte> AZ09Utf8 => "[a-z0-9_]"u8;
            }
            ...
            {
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="AZ09"/>.
                /// </summary>
                public static ReadOnlySpan<byte> AZ09 => "[a-z0-9_]"u8;
            }
            ...
            {
                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="AZ09"/>.
                /// </summary>
                public static ReadOnlySpan<byte> AZ09 => [0xB5, 0x00, 0x00, 0x00, 0x22, 0x5B, 0x61, 0x2D, 0x7A, 0x30, 0x2D, 0x39, 0x5F, 0x5D, 0x22];
            }
        }
    }
}
