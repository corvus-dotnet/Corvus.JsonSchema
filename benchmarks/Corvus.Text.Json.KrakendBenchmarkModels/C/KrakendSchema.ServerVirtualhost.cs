...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct ServerVirtualhost
        ...
        : IJsonElement<ServerVirtualhost>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ServerVirtualhost"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ServerVirtualhost(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ServerVirtualhost DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.ServerVirtualhost.VirtualhostsWithAlias AliasedHosts
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AliasedHostsUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.ServerVirtualhost.VirtualhostsWithAlias value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.ServerVirtualhost.JsonStringArray Hosts
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HostsUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.ServerVirtualhost.JsonStringArray value))
                {
                    return value;
                }
        ...
        public static explicit operator Corvus.KrakendBenchmark.Current.KrakendSchema.ServerVirtualhost.RequiredHosts(ServerVirtualhost value)
        {
            return Corvus.KrakendBenchmark.Current.KrakendSchema.ServerVirtualhost.RequiredHosts.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ServerVirtualhost(Corvus.KrakendBenchmark.Current.KrakendSchema.ServerVirtualhost.RequiredHosts value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.KrakendBenchmark.Current.KrakendSchema.ServerVirtualhost.RequiredAliasedHosts(ServerVirtualhost value)
        {
            return Corvus.KrakendBenchmark.Current.KrakendSchema.ServerVirtualhost.RequiredAliasedHosts.From(value);
        }
        ...
        /// </returns>
        public static bool operator ==(in ServerVirtualhost left, in ServerVirtualhost right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ServerVirtualhost left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(ServerVirtualhost instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ServerVirtualhost(JsonElement instance)
        {
            return ServerVirtualhost.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ServerVirtualhost From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ServerVirtualhost ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ServerVirtualhost>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ServerVirtualhost ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ServerVirtualhost>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ServerVirtualhost ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ServerVirtualhost>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static ServerVirtualhost ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ServerVirtualhost>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ServerVirtualhost? result)
        {
            return JsonElementHelpers.TryParseValue<ServerVirtualhost>(ref reader, out result);
        }
...
#if NET
        static ServerVirtualhost IJsonElement<ServerVirtualhost>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ServerVirtualhost: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public ServerVirtualhost Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public ServerVirtualhost Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ServerVirtualhost>(_idx);
            }
        ...
        public bool TryGetAsRequiredHosts(out Corvus.KrakendBenchmark.Current.KrakendSchema.ServerVirtualhost.RequiredHosts result)
        {
            ...
            {
                result = Corvus.KrakendBenchmark.Current.KrakendSchema.ServerVirtualhost.RequiredHosts.From(this);
                return true;
            }
        ...
        public bool TryGetAsRequiredAliasedHosts(out Corvus.KrakendBenchmark.Current.KrakendSchema.ServerVirtualhost.RequiredAliasedHosts result)
        {
            ...
            {
                result = Corvus.KrakendBenchmark.Current.KrakendSchema.ServerVirtualhost.RequiredAliasedHosts.From(this);
                return true;
            }
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.KrakendBenchmark.Current.KrakendSchema.ServerVirtualhost, TContext, TResult> defaultMatch)
...
#endif
        {
            if (Corvus.KrakendBenchmark.Current.KrakendSchema.ServerVirtualhost.RequiredHosts.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredHosts(Corvus.KrakendBenchmark.Current.KrakendSchema.ServerVirtualhost.RequiredHosts.From(this), context);
            }

            if (Corvus.KrakendBenchmark.Current.KrakendSchema.ServerVirtualhost.RequiredAliasedHosts.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredAliasedHosts(Corvus.KrakendBenchmark.Current.KrakendSchema.ServerVirtualhost.RequiredAliasedHosts.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.KrakendBenchmark.Current.KrakendSchema.ServerVirtualhost, TResult> defaultMatch)
        {
            if (Corvus.KrakendBenchmark.Current.KrakendSchema.ServerVirtualhost.RequiredHosts.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredHosts(Corvus.KrakendBenchmark.Current.KrakendSchema.ServerVirtualhost.RequiredHosts.From(this));
            }

            if (Corvus.KrakendBenchmark.Current.KrakendSchema.ServerVirtualhost.RequiredAliasedHosts.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredAliasedHosts(Corvus.KrakendBenchmark.Current.KrakendSchema.ServerVirtualhost.RequiredAliasedHosts.From(this));
            }
