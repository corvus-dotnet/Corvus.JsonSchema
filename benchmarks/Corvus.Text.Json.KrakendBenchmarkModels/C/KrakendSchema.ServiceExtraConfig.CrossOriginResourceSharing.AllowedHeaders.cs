    ...
    public readonly partial struct ServiceExtraConfig
    {
        ...
        public readonly partial struct CrossOriginResourceSharing
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="AllowedHeaders"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal AllowedHeaders(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static AllowedHeaders DefaultInstance { get; } = AllowedHeaders.ParseValue("[]"u8);
                ...
                /// </returns>
                public static bool operator ==(in AllowedHeaders left, in AllowedHeaders right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in AllowedHeaders left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(AllowedHeaders instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AllowedHeaders(JsonElement instance)
                {
                    return AllowedHeaders.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AllowedHeaders From<T>(in T instance)
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out AllowedHeaders? result)
                {
                    return JsonElementHelpers.TryParseValue<AllowedHeaders>(ref reader, out result);
                }
...
#if NET
                static AllowedHeaders IJsonElement<AllowedHeaders>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AllowedHeaders: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public AllowedHeaders Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<AllowedHeaders>(_idx);
                    }
