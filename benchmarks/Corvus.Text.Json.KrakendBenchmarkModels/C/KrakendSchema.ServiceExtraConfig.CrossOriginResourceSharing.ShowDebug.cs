...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct ServiceExtraConfig
    {
        ...
        public readonly partial struct CrossOriginResourceSharing
        {
            ...
            public readonly partial struct ShowDebug
#if NET8_0_OR_GREATER
                : IJsonElement<ShowDebug>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="ShowDebug"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal ShowDebug(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static ShowDebug DefaultInstance { get; } = ParsedJsonDocument<ShowDebug>.True;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(ShowDebug value)
                {
                ...
                /// </returns>
                public static bool operator ==(in ShowDebug left, in ShowDebug right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in ShowDebug left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(ShowDebug instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ShowDebug(JsonElement instance)
                {
                    return ShowDebug.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ShowDebug From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ShowDebug ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ShowDebug>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ShowDebug ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ShowDebug>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ShowDebug ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ShowDebug>(json, options);
                }
                ...
                /// </exception>
                public static ShowDebug ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<ShowDebug>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out ShowDebug? result)
                {
                    return JsonElementHelpers.TryParseValue<ShowDebug>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ShowDebug(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static ShowDebug IJsonElement<ShowDebug>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ShowDebug: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ShowDebug"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ShowDebug"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public ShowDebug Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ShowDebug>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ShowDebug"/> that lives for the lifetime of its
