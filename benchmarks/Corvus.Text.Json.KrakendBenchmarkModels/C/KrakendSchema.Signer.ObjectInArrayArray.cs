    ...
    public readonly partial struct Signer
    {
...
#endif
        {
            ...
            public bool TryGetNumericValues(Span<double> items, out int written)
            {
                CheckValidInstance();
                written = 0;
                foreach (Corvus.KrakendBenchmark.Current.KrakendSchema.Signer.ObjectInArrayArray.ObjectInArray item in EnumerateArray())
                {
            ...
            public Corvus.KrakendBenchmark.Current.KrakendSchema.Signer.ObjectInArrayArray.ObjectInArray this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.KrakendBenchmark.Current.KrakendSchema.Signer.ObjectInArrayArray.ObjectInArray>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.KrakendBenchmark.Current.KrakendSchema.Signer.ObjectInArrayArray.ObjectInArray> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.KrakendBenchmark.Current.KrakendSchema.Signer.ObjectInArrayArray.ObjectInArray>(_parent, _idx);
            }
