    ...
    public readonly partial struct Signer
    {
        ...
        public readonly partial struct RequiredAlgAndDisableJwkSecurityAndJwkLocalPath
        {
            ...
            public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.JsonElement.Source<TContext> alg, scoped in Corvus.Text.Json.JsonElement.Source<TContext> disableJwkSecurity, scoped in Corvus.Text.Json.JsonElement.Source<TContext> jwkLocalPath)
                ...
                #endif
            {
                return new Source<TContext>(context, alg, disableJwkSecurity, jwkLocalPath);
            }
            ...
            public static ParsedJsonDocument<RequiredAlgAndDisableJwkSecurityAndJwkLocalPath> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RequiredAlgAndDisableJwkSecurityAndJwkLocalPath>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RequiredAlgAndDisableJwkSecurityAndJwkLocalPath> Create<TContext>(
            ...
            public static ParsedJsonDocument<RequiredAlgAndDisableJwkSecurityAndJwkLocalPath> Create(in Corvus.Text.Json.JsonElement.Source alg, in Corvus.Text.Json.JsonElement.Source disableJwkSecurity, in Corvus.Text.Json.JsonElement.Source jwkLocalPath, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RequiredAlgAndDisableJwkSecurityAndJwkLocalPath> Create<TContext>(in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> alg, in Corvus.Text.Json.JsonElement.Source<TContext> disableJwkSecurity, in Corvus.Text.Json.JsonElement.Source<TContext> jwkLocalPath, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
