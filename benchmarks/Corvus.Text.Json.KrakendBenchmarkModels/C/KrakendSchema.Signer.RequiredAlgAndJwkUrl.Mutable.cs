    ...
    public readonly partial struct Signer
    {
        ...
        public readonly partial struct RequiredAlgAndJwkUrl
        {
...
#endif
            {
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetJwkUrl(in Corvus.Text.Json.JsonElement.Source value)
                {
                    CheckValidInstance();
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(in Corvus.Text.Json.JsonElement.Source alg, in Corvus.Text.Json.JsonElement.Source jwkUrl)
            {
            ...
            /// <param name="jwkUrl">The value of the <c>"jwk_url"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> alg, in Corvus.Text.Json.JsonElement.Source<TContext> jwkUrl)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
