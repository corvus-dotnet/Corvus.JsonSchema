...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Soap
    {
        ...
        public readonly partial struct RequiredTemplate
        {
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(in Corvus.Text.Json.JsonElement.Source template)
            {
            ...
            /// <param name="template">The value of the <c>"template"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> template)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
