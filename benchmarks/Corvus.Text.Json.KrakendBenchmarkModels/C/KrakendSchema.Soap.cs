...
public readonly partial struct KrakendSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Soap"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal Soap(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static Soap DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.Soap.ContentType ContentTypeValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ContentTypeValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Soap.ContentType value))
                {
                    return value;
                }

                return Corvus.KrakendBenchmark.Current.KrakendSchema.Soap.ContentType.DefaultInstance;
            }
        }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.Soap.EnableDebug DebugValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DebugValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Soap.EnableDebug value))
                {
                    return value;
                }

                return Corvus.KrakendBenchmark.Current.KrakendSchema.Soap.EnableDebug.DefaultInstance;
            }
        }
        ...
        public static explicit operator Corvus.KrakendBenchmark.Current.KrakendSchema.Soap.RequiredPath(Soap value)
        {
            return Corvus.KrakendBenchmark.Current.KrakendSchema.Soap.RequiredPath.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Soap(Corvus.KrakendBenchmark.Current.KrakendSchema.Soap.RequiredPath value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.KrakendBenchmark.Current.KrakendSchema.Soap.RequiredTemplate(Soap value)
        {
            return Corvus.KrakendBenchmark.Current.KrakendSchema.Soap.RequiredTemplate.From(value);
        }
        ...
        /// </returns>
        public static bool operator ==(in Soap left, in Soap right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Soap left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(Soap instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Soap(JsonElement instance)
        {
            return Soap.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Soap From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Soap ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Soap>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Soap ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Soap>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Soap ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Soap>(json, options);
        }
        ...
        /// </exception>
        public static Soap ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<Soap>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Soap? result)
        {
            return JsonElementHelpers.TryParseValue<Soap>(ref reader, out result);
        }
...
#if NET
        static Soap IJsonElement<Soap>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Soap: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public Soap Freeze()
        {
            ...
            {
                return mutable.FreezeElement<Soap>(_idx);
            }
        ...
        public bool TryGetAsRequiredPath(out Corvus.KrakendBenchmark.Current.KrakendSchema.Soap.RequiredPath result)
        {
            ...
            {
                result = Corvus.KrakendBenchmark.Current.KrakendSchema.Soap.RequiredPath.From(this);
                return true;
            }
        ...
        public bool TryGetAsRequiredTemplate(out Corvus.KrakendBenchmark.Current.KrakendSchema.Soap.RequiredTemplate result)
        {
            ...
            {
                result = Corvus.KrakendBenchmark.Current.KrakendSchema.Soap.RequiredTemplate.From(this);
                return true;
            }
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.KrakendBenchmark.Current.KrakendSchema.Soap, TContext, TResult> defaultMatch)
...
#endif
        {
            if (Corvus.KrakendBenchmark.Current.KrakendSchema.Soap.RequiredPath.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredPath(Corvus.KrakendBenchmark.Current.KrakendSchema.Soap.RequiredPath.From(this), context);
            }

            if (Corvus.KrakendBenchmark.Current.KrakendSchema.Soap.RequiredTemplate.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredTemplate(Corvus.KrakendBenchmark.Current.KrakendSchema.Soap.RequiredTemplate.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.KrakendBenchmark.Current.KrakendSchema.Soap, TResult> defaultMatch)
        {
            if (Corvus.KrakendBenchmark.Current.KrakendSchema.Soap.RequiredPath.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredPath(Corvus.KrakendBenchmark.Current.KrakendSchema.Soap.RequiredPath.From(this));
            }

            if (Corvus.KrakendBenchmark.Current.KrakendSchema.Soap.RequiredTemplate.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredTemplate(Corvus.KrakendBenchmark.Current.KrakendSchema.Soap.RequiredTemplate.From(this));
            }
