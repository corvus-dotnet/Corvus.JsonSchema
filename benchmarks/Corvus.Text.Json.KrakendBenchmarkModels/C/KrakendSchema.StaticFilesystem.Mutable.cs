...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct StaticFilesystem
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(StaticFilesystem instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="StaticFilesystem"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator StaticFilesystem(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.StaticFilesystem.WhetherToAllowDirectoryListingsOrNot.Mutable DirectoryListing
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DirectoryListingUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.StaticFilesystem.WhetherToAllowDirectoryListingsOrNot.Mutable value))
                    {
                        return value;
                    }

                    return Corvus.KrakendBenchmark.Current.KrakendSchema.StaticFilesystem.WhetherToAllowDirectoryListingsOrNot.Mutable.DefaultInstance;
                }
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new StaticFilesystem(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetDirectoryListing(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.StaticFilesystem.WhetherToAllowDirectoryListingsOrNot.Source value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"StaticFilesystem.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="StaticFilesystem"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="StaticFilesystem"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly StaticFilesystem Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<StaticFilesystem>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="StaticFilesystem"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly StaticFilesystem Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<StaticFilesystem>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.StaticFilesystem.WhetherToAllowDirectoryListingsOrNot.Source _createArg2;
            ...
            internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.StaticFilesystem.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg1, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.StaticFilesystem.WhetherToAllowDirectoryListingsOrNot.Source arg2)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _kind = Kind.Create;
            ...
            public static implicit operator Source(StaticFilesystem instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.StaticFilesystem.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="StaticFilesystem"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.KrakendBenchmark.Current.JsonString.Source path,
                in Corvus.KrakendBenchmark.Current.KrakendSchema.StaticFilesystem.WhetherToAllowDirectoryListingsOrNot.Source directoryListing = default)
            {
            ...
            /// Creates an instance of a <see cref="StaticFilesystem"/>.
            /// </summary>
            public void Create(in Corvus.KrakendBenchmark.Current.JsonString.Source path, in Corvus.KrakendBenchmark.Current.KrakendSchema.StaticFilesystem.WhetherToAllowDirectoryListingsOrNot.Source directoryListing = default)
            {
                Create(ref _builder, path, directoryListing);
            }
            ...
            internal static void BuildCreateValue(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg1, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.StaticFilesystem.WhetherToAllowDirectoryListingsOrNot.Source arg2, ref ComplexValueBuilder o)
            {
                o.StartObject();
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source path, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.StaticFilesystem.WhetherToAllowDirectoryListingsOrNot.Source directoryListing = default)
        {
            return new Source(path, directoryListing);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.JsonString.Source path, in Corvus.KrakendBenchmark.Current.KrakendSchema.StaticFilesystem.WhetherToAllowDirectoryListingsOrNot.Source directoryListing = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(path, directoryListing);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<StaticFilesystem, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<StaticFilesystem> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<StaticFilesystem>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<StaticFilesystem> Create<TContext>(
        ...
        public static ParsedJsonDocument<StaticFilesystem> Create(in Corvus.KrakendBenchmark.Current.JsonString.Source path, in Corvus.KrakendBenchmark.Current.KrakendSchema.StaticFilesystem.WhetherToAllowDirectoryListingsOrNot.Source directoryListing = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
