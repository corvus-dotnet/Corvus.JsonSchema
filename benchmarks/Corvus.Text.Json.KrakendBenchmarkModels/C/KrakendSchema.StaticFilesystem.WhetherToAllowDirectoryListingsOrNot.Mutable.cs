    ...
    public readonly partial struct StaticFilesystem
    {
        ...
        public readonly partial struct WhetherToAllowDirectoryListingsOrNot
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<WhetherToAllowDirectoryListingsOrNot, Mutable>(WhetherToAllowDirectoryListingsOrNot.DefaultInstance);
            ...
            public static ParsedJsonDocument<WhetherToAllowDirectoryListingsOrNot> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<WhetherToAllowDirectoryListingsOrNot>();
                }
                finally
                {
