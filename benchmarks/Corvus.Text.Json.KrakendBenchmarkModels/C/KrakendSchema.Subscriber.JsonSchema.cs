...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Subscriber
        : IJsonElement<Subscriber>
    {
        public static partial class JsonSchema
        {
            ...
            private static void MatchSubscriptionUrl(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
            {
