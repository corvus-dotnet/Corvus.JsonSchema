...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Subscriber
    {
...
#endif
        {
            ...
            public void SetSubscriptionUrl(in Corvus.KrakendBenchmark.Current.JsonString.Source value)
            {
                CheckValidInstance();
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(in Corvus.KrakendBenchmark.Current.JsonString.Source subscriptionUrl)
        {
