...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Subscriber
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Subscriber instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Subscriber"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Subscriber(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.JsonString.Mutable SubscriptionUrl
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SubscriptionUrlUtf8, out Corvus.KrakendBenchmark.Current.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Subscriber(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetSubscriptionUrl(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source value)
            {
                CheckValidInstance();
                ...
                else
                {
                    ...
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.SubscriptionUrl, ref cvb);
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Subscriber.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Subscriber"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Subscriber"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly Subscriber Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<Subscriber>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Subscriber"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly Subscriber Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Subscriber>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Subscriber.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            public static implicit operator Source(Subscriber instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Subscriber.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="Subscriber"/>.
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.KrakendBenchmark.Current.JsonString.Source subscriptionUrl)
            {
                subscriptionUrl.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.SubscriptionUrl, ref builder);
            }

            /// <summary>
            /// Creates an instance of a <see cref="Subscriber"/>.
            /// </summary>
            public void Create(in Corvus.KrakendBenchmark.Current.JsonString.Source subscriptionUrl)
            {
        ...
        /// </summary>
        /// <param name="subscriptionUrl">The value of the <c>"subscription_url"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source subscriptionUrl)
        {
            return new Source(subscriptionUrl);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.JsonString.Source subscriptionUrl, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        {
            return workspace.CreateBuilder<Subscriber, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<Subscriber> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Subscriber>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Subscriber> Create<TContext>(
        ...
        public static ParsedJsonDocument<Subscriber> Create(in Corvus.KrakendBenchmark.Current.JsonString.Source subscriptionUrl, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
