...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Tiered
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Tiered instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Tiered"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Tiered(Mutable instance)
            {
            ...
            /// <summary>
            /// Gets the <c>tier_key</c> property.
            /// Tier key
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.JsonString.Mutable TierKey
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TierKeyUtf8, out Corvus.KrakendBenchmark.Current.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.Mutable Tiers
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TiersUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Tiered(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            /// <summary>
            /// Set the <c>tier_key</c> property.
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetTierKey(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("tier_key");
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TierKeyUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                ...
                else
                {
                    ...
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.TierKey, ref cvb);
            ...
            /// <summary>
            /// Set the <c>tiers</c> property.
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetTiers(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("tiers");
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TiersUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Tiers, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetTiers<TContext>(in Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.Source<TContext> value)
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Tiered.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Tiered"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Tiered"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly Tiered Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<Tiered>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Tiered"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly Tiered Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Tiered>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.Source _createArg2;
            ...
            internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg1, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.Source arg2)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _kind = Kind.Create;
            ...
            public static implicit operator Source(Tiered instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            private readonly Corvus.KrakendBenchmark.Current.JsonString.Source _createArg1;
            private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.Source<TContext> _createArg2;
            ...
            internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg1, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.Source<TContext> arg2)
            {
                _context = context;
                _createArg1 = arg1;
                _createArg2 = arg2;
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="Tiered"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.KrakendBenchmark.Current.JsonString.Source tierKey,
                in Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.Source tiers)
            {
                tierKey.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.TierKey, ref builder);
                tiers.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Tiers, ref builder);
            }

            /// <summary>
            /// Creates an instance of a <see cref="Tiered"/>.
            /// </summary>
            public void Create(in Corvus.KrakendBenchmark.Current.JsonString.Source tierKey, in Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.Source tiers)
            {
                Create(ref _builder, tierKey, tiers);
            }
            ...
            internal static void Create<TContext>(
                ...
                ref ComplexValueBuilder builder,
                in Corvus.KrakendBenchmark.Current.JsonString.Source tierKey,
                in Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.Source<TContext> tiers)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            #endif
            {
                Create(context, ref _builder, tierKey, tiers);
            }
            ...
            internal static void BuildCreateValue(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg1, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.Source arg2, ref ComplexValueBuilder o)
            {
                o.StartObject();
            ...
            /// <param name="arg2">The value of the property.</param>
            /// <param name="o">The complex value builder into which to write the object.</param>
            internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source arg1, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.Source<TContext> arg2, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        /// </summary>
        /// <param name="tierKey">The value of the <c>"tier_key"</c> property.</param>
        /// <param name="tiers">The value of the <c>"tiers"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.KrakendBenchmark.Current.JsonString.Source tierKey, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.Source tiers)
        {
            return new Source(tierKey, tiers);
        }
        ...
        /// <param name="tiers">The value of the <c>"tiers"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.JsonString.Source tierKey, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.Source<TContext> tiers)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            return new Source<TContext>(context, tierKey, tiers);
        }
        ...
        /// </summary>
        /// <param name="workspace">The JSON workspace.</param>
        /// <param name="tierKey">The value of the property.</param>
        /// <param name="tiers">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.JsonString.Source tierKey, in Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.Source tiers, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(tierKey, tiers);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.KrakendBenchmark.Current.JsonString.Source tierKey, in Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.Source<TContext> tiers, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            ...
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(context, tierKey, tiers);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<Tiered, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<Tiered> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Tiered>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Tiered> Create<TContext>(
        ...
        public static ParsedJsonDocument<Tiered> Create(in Corvus.KrakendBenchmark.Current.JsonString.Source tierKey, in Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.Source tiers, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Tiered> Create<TContext>(in TContext context, in Corvus.KrakendBenchmark.Current.JsonString.Source tierKey, in Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.Source<TContext> tiers, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
