                ...
                : IJsonElement<TiersEntity>
            {
                public static partial class JsonSchema
                {
                    ...
                    private static void MatchRatelimit(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                    {
                        ...
                        Corvus.KrakendBenchmark.Current.KrakendSchema.Router.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                    ...
                    private static void MatchTierValueValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                    {
                        ...
                        JsonSchemaContext childContext1 =
                            Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.TiersEntity.TierValue.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                                parentDocumentIndex,
                                ref context,
                        ...
                        Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.TiersEntity.TierValue.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                    ...
                    private static void MatchTierValueAsValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                    {
                        ...
                        JsonSchemaContext childContext2 =
                            Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.TiersEntity.TierValueAs.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                                parentDocumentIndex,
                                ref context,
                        ...
                        Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.TiersEntity.TierValueAs.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
