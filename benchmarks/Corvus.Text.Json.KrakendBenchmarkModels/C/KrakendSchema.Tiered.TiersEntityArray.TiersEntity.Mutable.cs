        ...
        public readonly partial struct TiersEntityArray
        {
            ...
            public readonly partial struct TiersEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(TiersEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="TiersEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator TiersEntity(Mutable instance)
                    {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.KrakendBenchmark.Current.KrakendSchema.Router.Mutable Ratelimit
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RatelimitUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Router.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.TiersEntity.TierValue.Mutable TierValueValue
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TierValueValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.TiersEntity.TierValue.Mutable value))
                            {
                                return value;
                            }

                            return Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.TiersEntity.TierValue.Mutable.DefaultInstance;
                        }
                    }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.TiersEntity.TierValueAs.Mutable TierValueAsValue
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TierValueAsValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.TiersEntity.TierValueAs.Mutable value))
                            {
                                return value;
                            }

                            return Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.TiersEntity.TierValueAs.Mutable.DefaultInstance;
                        }
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new TiersEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    public void SetRatelimit(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Router.Source value)
                    {
                        ...
                        {
                            JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.RatelimitUtf8);
                            _documentVersion = _parent.Version;
                            return;
                        }

                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RatelimitUtf8, out IJsonDocument? elementParent, out int elementIdx))
                        {
                        ...
                        else
                        {
                            ...
                            value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Ratelimit, ref cvb);
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetRatelimit<TContext>(in Corvus.KrakendBenchmark.Current.KrakendSchema.Router.Source<TContext> value)
                    ...
                    /// <summary>
                    /// Remove the <c>ratelimit</c> property, if present.
                    /// </summary>
                    /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                    public bool RemoveRatelimit()
                    {
                        CheckValidInstance();
                        bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.RatelimitUtf8);
                        _documentVersion = _parent.Version;
                        return result;
                    }
                    ...
                    public void SetTierValueValue(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.TiersEntity.TierValue.Source value)
                    {
                        ...
                        if (value.IsUndefined)
                        {
                            JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.TierValueValueUtf8);
                            _documentVersion = _parent.Version;
                            return;
                        }

                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TierValueValueUtf8, out IJsonDocument? elementParent, out int elementIdx))
                        {
                            // We are going to replace just the value
                            value.AddAsItem(ref cvb);
                            _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                        ...
                        {
                            // We are going to insert the new value
                            value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.TierValueValue, ref cvb);
                            int endIndex = _idx + _parent.GetDbSize(_idx, false);
                            _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                        }
                    ...
                    /// <summary>
                    /// Remove the <c>tier_value</c> property, if present.
                    /// </summary>
                    /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                    public bool RemoveTierValueValue()
                    {
                        CheckValidInstance();
                        bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.TierValueValueUtf8);
                        _documentVersion = _parent.Version;
                        return result;
                    }
                    ...
                    public void SetTierValueAsValue(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.TiersEntity.TierValueAs.Source value)
                    {
                        ...
                        if (value.IsUndefined)
                        {
                            JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.TierValueAsValueUtf8);
                            _documentVersion = _parent.Version;
                            return;
                        }

                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TierValueAsValueUtf8, out IJsonDocument? elementParent, out int elementIdx))
                        {
                            // We are going to replace just the value
                            value.AddAsItem(ref cvb);
                            _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                        ...
                        {
                            // We are going to insert the new value
                            value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.TierValueAsValue, ref cvb);
                            int endIndex = _idx + _parent.GetDbSize(_idx, false);
                            _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                        }
                    ...
                    /// <summary>
                    /// Remove the <c>tier_value_as</c> property, if present.
                    /// </summary>
                    /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                    public bool RemoveTierValueAsValue()
                    {
                        CheckValidInstance();
                        bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.TierValueAsValueUtf8);
                        _documentVersion = _parent.Version;
                        return result;
                    }
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"TiersEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="TiersEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="TiersEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly TiersEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<TiersEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="TiersEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly TiersEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<TiersEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Router.Source _createArg1;
                    private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.TiersEntity.TierValue.Source _createArg2;
                    private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.TiersEntity.TierValueAs.Source _createArg3;
                    ...
                    public static implicit operator Source(TiersEntity instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Router.Source<TContext> _createArg1;
                    private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.TiersEntity.TierValue.Source _createArg2;
                    private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.TiersEntity.TierValueAs.Source _createArg3;
                ...
                public ref struct Builder
                {
                    ...
                    internal static void Create(
                        ...
                        in Corvus.KrakendBenchmark.Current.KrakendSchema.Router.Source ratelimit = default,
                        in Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.TiersEntity.TierValue.Source tierValue = default,
                        in Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.TiersEntity.TierValueAs.Source tierValueAs = default)
                    {
                        ratelimit.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Ratelimit, ref builder);
                        tierValue.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.TierValueValue, ref builder);
                        tierValueAs.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.TierValueAsValue, ref builder);
                    }
                    ...
                    public void Create(
                        ...
                        in Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.TiersEntity.TierValueAs.Source tierValueAs = default)
                    {
                        Create(ref _builder, ratelimit, tierValue, tierValueAs);
                    }
                    ...
                    internal static void Create<TContext>(
                        in TContext context,
                        ref ComplexValueBuilder builder,
                        in Corvus.KrakendBenchmark.Current.KrakendSchema.Router.Source<TContext> ratelimit = default,
                        in Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.TiersEntity.TierValue.Source tierValue = default,
                        in Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.TiersEntity.TierValueAs.Source tierValueAs = default)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    ...
                    #endif
                    {
                        Create(context, ref _builder, ratelimit, tierValue, tierValueAs);
                    }
                ...
                /// </summary>
                /// <param name="ratelimit">The value of the <c>"ratelimit"</c> property.</param>
                ...
                public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Router.Source<TContext> ratelimit = default, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.TiersEntity.TierValue.Source tierValue = default, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.TiersEntity.TierValueAs.Source tierValueAs = default)
                    ...
                    #endif
                {
                    return new Source<TContext>(context, ratelimit, tierValue, tierValueAs);
                }
                ...
                /// </summary>
                /// <param name="workspace">The JSON workspace.</param>
                /// <param name="ratelimit">The value of the property.</param>
                /// <param name="tierValue">The value of the property.</param>
                /// <param name="tierValueAs">The value of the property.</param>
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.KrakendSchema.Router.Source ratelimit = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.TiersEntity.TierValue.Source tierValue = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.TiersEntity.TierValueAs.Source tierValueAs = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                    Builder ovb = new(cvb);
                    ovb.Create(ratelimit, tierValue, tierValueAs);
                    cvb = ovb._builder;
                    cvb.EndObject();
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.KrakendBenchmark.Current.KrakendSchema.Router.Source<TContext> ratelimit = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.TiersEntity.TierValue.Source tierValue = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.TiersEntity.TierValueAs.Source tierValueAs = default, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
                    ...
                    cvb.StartObject();
                    Builder ovb = new(cvb);
                    ovb.Create(context, ratelimit, tierValue, tierValueAs);
                    cvb = ovb._builder;
                    cvb.EndObject();
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
                ...
                {
                    return workspace.CreateBuilder<TiersEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<TiersEntity> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<TiersEntity>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<TiersEntity> Create<TContext>(
                ...
                public static ParsedJsonDocument<TiersEntity> Create(in Corvus.KrakendBenchmark.Current.KrakendSchema.Router.Source ratelimit = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.TiersEntity.TierValue.Source tierValue = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.TiersEntity.TierValueAs.Source tierValueAs = default, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
                public static ParsedJsonDocument<TiersEntity> Create<TContext>(in TContext context, in Corvus.KrakendBenchmark.Current.KrakendSchema.Router.Source<TContext> ratelimit = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.TiersEntity.TierValue.Source tierValue = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Tiered.TiersEntityArray.TiersEntity.TierValueAs.Source tierValueAs = default, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
