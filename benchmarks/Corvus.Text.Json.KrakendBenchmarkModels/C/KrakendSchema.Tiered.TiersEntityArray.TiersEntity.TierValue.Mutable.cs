            ...
            public readonly partial struct TiersEntity
            {
                ...
                public readonly partial struct TierValue
                {
...
#endif
                    {
                        ...
                        /// </remarks>
                        public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<TierValue, Mutable>(TierValue.DefaultInstance);
                    ...
                    public static ParsedJsonDocument<TierValue> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<TierValue>();
                        }
                        finally
                        {
