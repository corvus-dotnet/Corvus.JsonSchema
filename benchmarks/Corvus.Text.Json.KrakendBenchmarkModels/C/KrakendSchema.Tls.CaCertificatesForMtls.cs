...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Tls
    {
        ...
        public readonly partial struct CaCertificatesForMtls
#if NET8_0_OR_GREATER
            : IJsonElement<CaCertificatesForMtls>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="CaCertificatesForMtls"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal CaCertificatesForMtls(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static CaCertificatesForMtls DefaultInstance { get; } = CaCertificatesForMtls.ParseValue("[]"u8);
            ...
            /// </returns>
            public static bool operator ==(in CaCertificatesForMtls left, in CaCertificatesForMtls right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in CaCertificatesForMtls left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(CaCertificatesForMtls instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator CaCertificatesForMtls(JsonElement instance)
            {
                return CaCertificatesForMtls.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CaCertificatesForMtls From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CaCertificatesForMtls ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CaCertificatesForMtls>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CaCertificatesForMtls ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CaCertificatesForMtls>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CaCertificatesForMtls ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CaCertificatesForMtls>(json, options);
            }
            ...
            /// </exception>
            public static CaCertificatesForMtls ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<CaCertificatesForMtls>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out CaCertificatesForMtls? result)
            {
                return JsonElementHelpers.TryParseValue<CaCertificatesForMtls>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new CaCertificatesForMtls(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static CaCertificatesForMtls IJsonElement<CaCertificatesForMtls>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"CaCertificatesForMtls: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="CaCertificatesForMtls"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="CaCertificatesForMtls"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public CaCertificatesForMtls Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<CaCertificatesForMtls>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="CaCertificatesForMtls"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public CaCertificatesForMtls Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<CaCertificatesForMtls>(_idx);
                }
