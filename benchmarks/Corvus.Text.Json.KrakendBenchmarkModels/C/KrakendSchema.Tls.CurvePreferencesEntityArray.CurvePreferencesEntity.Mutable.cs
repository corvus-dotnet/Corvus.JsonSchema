        ...
        public readonly partial struct CurvePreferencesEntityArray
        {
            ...
            public readonly partial struct CurvePreferencesEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(CurvePreferencesEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="CurvePreferencesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator CurvePreferencesEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"CurvePreferencesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly CurvePreferencesEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly CurvePreferencesEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<CurvePreferencesEntity>(_idx);
                    }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(CurvePreferencesEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<CurvePreferencesEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<CurvePreferencesEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<CurvePreferencesEntity>();
                    }
                    finally
                    {
