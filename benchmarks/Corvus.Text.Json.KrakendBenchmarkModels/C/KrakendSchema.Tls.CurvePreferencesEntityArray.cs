    ...
    public readonly partial struct Tls
    {
...
#endif
        {
            ...
            public bool TryGetNumericValues(Span<double> items, out int written)
            {
                CheckValidInstance();
                written = 0;
                foreach (Corvus.KrakendBenchmark.Current.KrakendSchema.Tls.CurvePreferencesEntityArray.CurvePreferencesEntity item in EnumerateArray())
                {
            ...
            public Corvus.KrakendBenchmark.Current.KrakendSchema.Tls.CurvePreferencesEntityArray.CurvePreferencesEntity this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.KrakendBenchmark.Current.KrakendSchema.Tls.CurvePreferencesEntityArray.CurvePreferencesEntity>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.KrakendBenchmark.Current.KrakendSchema.Tls.CurvePreferencesEntityArray.CurvePreferencesEntity> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.KrakendBenchmark.Current.KrakendSchema.Tls.CurvePreferencesEntityArray.CurvePreferencesEntity>(_parent, _idx);
            }
