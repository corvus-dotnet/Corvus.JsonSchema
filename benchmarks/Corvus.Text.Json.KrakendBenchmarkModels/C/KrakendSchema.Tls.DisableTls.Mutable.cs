    ...
    public readonly partial struct Tls
    {
        ...
        public readonly partial struct DisableTls
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DisableTls, Mutable>(DisableTls.DefaultInstance);
                ...
                public static explicit operator Mutable(DisableTls instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DisableTls"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DisableTls(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DisableTls.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly DisableTls Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly DisableTls Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DisableTls>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(DisableTls instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<DisableTls, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<DisableTls> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<DisableTls>();
                }
                finally
                {
