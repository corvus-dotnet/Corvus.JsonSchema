    ...
    public readonly partial struct Tls
    {
        ...
        public readonly partial struct EnableMutualAuthentication
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<EnableMutualAuthentication, Mutable>(EnableMutualAuthentication.DefaultInstance);
                ...
                public static explicit operator Mutable(EnableMutualAuthentication instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="EnableMutualAuthentication"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator EnableMutualAuthentication(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"EnableMutualAuthentication.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly EnableMutualAuthentication Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly EnableMutualAuthentication Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<EnableMutualAuthentication>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(EnableMutualAuthentication instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<EnableMutualAuthentication, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<EnableMutualAuthentication> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<EnableMutualAuthentication>();
                }
                finally
                {
