        ...
        public readonly partial struct KeysEntityArray
        {
            ...
            public readonly partial struct KeysEntity
            {
...
#endif
                {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.KrakendBenchmark.Current.KrakendSchema.Tls.KeysEntityArray.KeysEntity.PrivateKey.Mutable PrivateKeyValue
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PrivateKeyValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Tls.KeysEntityArray.KeysEntity.PrivateKey.Mutable value))
                            {
                                return value;
                            }

                            return Corvus.KrakendBenchmark.Current.KrakendSchema.Tls.KeysEntityArray.KeysEntity.PrivateKey.Mutable.DefaultInstance;
                        }
                    }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.KrakendBenchmark.Current.KrakendSchema.Tls.KeysEntityArray.KeysEntity.PublicKey.Mutable PublicKeyValue
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PublicKeyValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Tls.KeysEntityArray.KeysEntity.PublicKey.Mutable value))
                            {
                                return value;
                            }

                            return Corvus.KrakendBenchmark.Current.KrakendSchema.Tls.KeysEntityArray.KeysEntity.PublicKey.Mutable.DefaultInstance;
                        }
                    }
                    ...
                    public void SetPrivateKeyValue(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Tls.KeysEntityArray.KeysEntity.PrivateKey.Source value)
                    {
                        CheckValidInstance();

                        if (value.IsUndefined)
                        {
                            JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.PrivateKeyValueUtf8);
                            _documentVersion = _parent.Version;
                            return;
                        }

                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PrivateKeyValueUtf8, out IJsonDocument? elementParent, out int elementIdx))
                        {
                        ...
                        else
                        {
                            ...
                            value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.PrivateKeyValue, ref cvb);
                    ...
                    /// <summary>
                    /// Remove the <c>private_key</c> property, if present.
                    /// </summary>
                    /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                    public bool RemovePrivateKeyValue()
                    {
                        CheckValidInstance();
                        bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.PrivateKeyValueUtf8);
                        _documentVersion = _parent.Version;
                        return result;
                    }
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetPublicKeyValue(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Tls.KeysEntityArray.KeysEntity.PublicKey.Source value)
                    {
                        CheckValidInstance();

                        if (value.IsUndefined)
                        {
                            JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.PublicKeyValueUtf8);
                            _documentVersion = _parent.Version;
                            return;
                        }

                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PublicKeyValueUtf8, out IJsonDocument? elementParent, out int elementIdx))
                        {
                            // We are going to replace just the value
                            value.AddAsItem(ref cvb);
                            _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                        ...
                        {
                            // We are going to insert the new value
                            value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.PublicKeyValue, ref cvb);
                            int endIndex = _idx + _parent.GetDbSize(_idx, false);
                            _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                        }
                    ...
                    /// <summary>
                    /// Remove the <c>public_key</c> property, if present.
                    /// </summary>
                    /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                    public bool RemovePublicKeyValue()
                    {
                        CheckValidInstance();
                        bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.PublicKeyValueUtf8);
                        _documentVersion = _parent.Version;
                        return result;
                    }
                    ...
                    /// <summary>
                    /// Gets a <see cref="KeysEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="KeysEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly KeysEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<KeysEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="KeysEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly KeysEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<KeysEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Tls.KeysEntityArray.KeysEntity.PrivateKey.Source _createArg1;
                    private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Tls.KeysEntityArray.KeysEntity.PublicKey.Source _createArg2;
                    ...
                    internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Tls.KeysEntityArray.KeysEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    internal Source(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Tls.KeysEntityArray.KeysEntity.PrivateKey.Source arg1, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Tls.KeysEntityArray.KeysEntity.PublicKey.Source arg2)
                    {
                        _createArg1 = arg1;
                        _createArg2 = arg2;
                        _kind = Kind.Create;
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Tls.KeysEntityArray.KeysEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    internal static void Create(
                        ...
                        in Corvus.KrakendBenchmark.Current.KrakendSchema.Tls.KeysEntityArray.KeysEntity.PrivateKey.Source privateKey = default,
                        in Corvus.KrakendBenchmark.Current.KrakendSchema.Tls.KeysEntityArray.KeysEntity.PublicKey.Source publicKey = default)
                    {
                        privateKey.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.PrivateKeyValue, ref builder);
                        publicKey.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.PublicKeyValue, ref builder);
                    }

                    /// <summary>
                    /// Creates an instance of a <see cref="KeysEntity"/>.
                    /// </summary>
                    public void Create(in Corvus.KrakendBenchmark.Current.KrakendSchema.Tls.KeysEntityArray.KeysEntity.PrivateKey.Source privateKey = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Tls.KeysEntityArray.KeysEntity.PublicKey.Source publicKey = default)
                    {
                        Create(ref _builder, privateKey, publicKey);
                    }
                    ...
                    internal static void BuildCreateValue(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Tls.KeysEntityArray.KeysEntity.PrivateKey.Source arg1, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Tls.KeysEntityArray.KeysEntity.PublicKey.Source arg2, ref ComplexValueBuilder o)
                    {
                        o.StartObject();
                ...
                /// <returns>The source from which to build the value.</returns>
                public static Source Build(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Tls.KeysEntityArray.KeysEntity.PrivateKey.Source privateKey = default, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Tls.KeysEntityArray.KeysEntity.PublicKey.Source publicKey = default)
                {
                    return new Source(privateKey, publicKey);
                }
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.KrakendSchema.Tls.KeysEntityArray.KeysEntity.PrivateKey.Source privateKey = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Tls.KeysEntityArray.KeysEntity.PublicKey.Source publicKey = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                    Builder ovb = new(cvb);
                    ovb.Create(privateKey, publicKey);
                    cvb = ovb._builder;
                    cvb.EndObject();
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
                ...
                public static ParsedJsonDocument<KeysEntity> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<KeysEntity>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<KeysEntity> Create<TContext>(
                ...
                public static ParsedJsonDocument<KeysEntity> Create(in Corvus.KrakendBenchmark.Current.KrakendSchema.Tls.KeysEntityArray.KeysEntity.PrivateKey.Source privateKey = default, in Corvus.KrakendBenchmark.Current.KrakendSchema.Tls.KeysEntityArray.KeysEntity.PublicKey.Source publicKey = default, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
