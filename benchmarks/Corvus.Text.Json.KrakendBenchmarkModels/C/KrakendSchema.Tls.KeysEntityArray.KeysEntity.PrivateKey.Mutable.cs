            ...
            public readonly partial struct KeysEntity
            {
                ...
                public readonly partial struct PrivateKey
                {
...
#endif
                    {
                        ...
                        /// </remarks>
                        public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<PrivateKey, Mutable>(PrivateKey.DefaultInstance);
                        ...
                        public static explicit operator Mutable(PrivateKey instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="PrivateKey"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator PrivateKey(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"PrivateKey.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly PrivateKey Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly PrivateKey Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<PrivateKey>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(PrivateKey instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<PrivateKey, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<PrivateKey> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<PrivateKey>();
                        }
                        finally
                        {
