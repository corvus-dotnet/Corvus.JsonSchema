            ...
            public readonly partial struct KeysEntity
            {
                ...
                public readonly partial struct PublicKey
                {
...
#endif
                    {
                        ...
                        /// </remarks>
                        public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<PublicKey, Mutable>(PublicKey.DefaultInstance);
                        ...
                        public static explicit operator Mutable(PublicKey instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="PublicKey"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator PublicKey(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"PublicKey.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly PublicKey Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly PublicKey Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<PublicKey>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(PublicKey instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<PublicKey, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<PublicKey> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<PublicKey>();
                        }
                        finally
                        {
