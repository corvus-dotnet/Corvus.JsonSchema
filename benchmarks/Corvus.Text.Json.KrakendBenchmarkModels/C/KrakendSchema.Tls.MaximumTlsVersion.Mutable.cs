    ...
    public readonly partial struct Tls
    {
        ...
        public readonly partial struct MaximumTlsVersion
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<MaximumTlsVersion, Mutable>(MaximumTlsVersion.DefaultInstance);
                ...
                public static explicit operator Mutable(MaximumTlsVersion instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="MaximumTlsVersion"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator MaximumTlsVersion(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new MaximumTlsVersion(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"MaximumTlsVersion.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="MaximumTlsVersion"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="MaximumTlsVersion"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly MaximumTlsVersion Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<MaximumTlsVersion>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="MaximumTlsVersion"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly MaximumTlsVersion Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<MaximumTlsVersion>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(MaximumTlsVersion instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (MaximumTlsVersion)value;
            ...
            {
                return workspace.CreateBuilder<MaximumTlsVersion, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<MaximumTlsVersion> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<MaximumTlsVersion>();
                }
                finally
                {
