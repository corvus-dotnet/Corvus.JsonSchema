    ...
    public readonly partial struct Tls
    {
        ...
        public readonly partial struct MinimumTlsVersion
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<MinimumTlsVersion, Mutable>(MinimumTlsVersion.DefaultInstance);
            ...
            public ref struct Source
            {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (MinimumTlsVersion)value;
            ...
            public static ParsedJsonDocument<MinimumTlsVersion> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<MinimumTlsVersion>();
                }
                finally
                {
