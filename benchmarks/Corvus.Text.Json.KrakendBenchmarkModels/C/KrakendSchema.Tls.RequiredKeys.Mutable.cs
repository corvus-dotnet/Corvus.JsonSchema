    ...
    public readonly partial struct Tls
    {
        ...
        public readonly partial struct RequiredKeys
        {
...
#endif
            {
                ...
                public void SetKeys(in Corvus.Text.Json.JsonElement.Source value)
                {
                    CheckValidInstance();
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(in Corvus.Text.Json.JsonElement.Source keys)
            {
            ...
            /// <param name="keys">The value of the <c>"keys"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> keys)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
