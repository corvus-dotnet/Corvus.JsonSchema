    ...
    public readonly partial struct UrlRewrite
    {
            ...
            : IJsonElement<RequiredLiteral>
        {
            public static partial class JsonSchema
            {
                ...
                private static void MatchLiteral(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                {
