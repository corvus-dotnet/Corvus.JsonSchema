    ...
    public readonly partial struct UrlRewrite
    {
        ...
        public readonly partial struct RequiredRegexp
        {
...
#endif
            {
                ...
                public void SetRegexp(in Corvus.Text.Json.JsonElement.Source value)
                {
                    CheckValidInstance();
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(in Corvus.Text.Json.JsonElement.Source regexp)
            {
            ...
            /// <param name="regexp">The value of the <c>"regexp"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> regexp)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
