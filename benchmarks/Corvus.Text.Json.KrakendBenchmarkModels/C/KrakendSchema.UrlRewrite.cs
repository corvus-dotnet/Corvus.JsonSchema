...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct UrlRewrite
#if NET8_0_OR_GREATER
        : IJsonElement<UrlRewrite>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UrlRewrite"/> struct.
        /// </summary>
        ...
        internal UrlRewrite(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static UrlRewrite DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.JsonObject Literal
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LiteralUtf8, out Corvus.KrakendBenchmark.Current.JsonObject value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.KrakendBenchmark.Current.KrakendSchema.UrlRewrite.JsonArrayArray Regexp
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RegexpUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.UrlRewrite.JsonArrayArray value))
                {
                    return value;
                }
        ...
        /// <summary>
        /// Conversion to <see cref="Corvus.KrakendBenchmark.Current.KrakendSchema.UrlRewrite.RequiredLiteral"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.KrakendBenchmark.Current.KrakendSchema.UrlRewrite.RequiredLiteral(UrlRewrite value)
        {
            return Corvus.KrakendBenchmark.Current.KrakendSchema.UrlRewrite.RequiredLiteral.From(value);
        }

        /// <summary>
        /// Conversion from <see cref="Corvus.KrakendBenchmark.Current.KrakendSchema.UrlRewrite.RequiredLiteral"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator UrlRewrite(Corvus.KrakendBenchmark.Current.KrakendSchema.UrlRewrite.RequiredLiteral value)
        {
            return From(value);
        }

        /// <summary>
        /// Conversion from the <see cref="Corvus.KrakendBenchmark.Current.KrakendSchema.UrlRewrite.RequiredLiteral"/> mutable view.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator UrlRewrite(Corvus.KrakendBenchmark.Current.KrakendSchema.UrlRewrite.RequiredLiteral.Mutable value)
        {
            return From(value);
        }

        /// <summary>
        /// Conversion to <see cref="Corvus.KrakendBenchmark.Current.KrakendSchema.UrlRewrite.RequiredRegexp"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.KrakendBenchmark.Current.KrakendSchema.UrlRewrite.RequiredRegexp(UrlRewrite value)
        {
            return Corvus.KrakendBenchmark.Current.KrakendSchema.UrlRewrite.RequiredRegexp.From(value);
        }

        /// <summary>
        /// Conversion from <see cref="Corvus.KrakendBenchmark.Current.KrakendSchema.UrlRewrite.RequiredRegexp"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator UrlRewrite(Corvus.KrakendBenchmark.Current.KrakendSchema.UrlRewrite.RequiredRegexp value)
        {
            return From(value);
        }

        /// <summary>
        /// Conversion from the <see cref="Corvus.KrakendBenchmark.Current.KrakendSchema.UrlRewrite.RequiredRegexp"/> mutable view.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator UrlRewrite(Corvus.KrakendBenchmark.Current.KrakendSchema.UrlRewrite.RequiredRegexp.Mutable value)
        {
            return From(value);
        }
        ...
        /// </returns>
        public static bool operator ==(in UrlRewrite left, in UrlRewrite right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in UrlRewrite left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(UrlRewrite instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator UrlRewrite(JsonElement instance)
        {
            return UrlRewrite.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static UrlRewrite From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static UrlRewrite ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<UrlRewrite>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static UrlRewrite ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<UrlRewrite>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static UrlRewrite ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<UrlRewrite>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static UrlRewrite ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<UrlRewrite>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out UrlRewrite? result)
        {
            return JsonElementHelpers.TryParseValue<UrlRewrite>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new UrlRewrite(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static UrlRewrite IJsonElement<UrlRewrite>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"UrlRewrite: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="UrlRewrite"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="UrlRewrite"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        {
            CheckValidInstance();
            return _parent.CloneElement<UrlRewrite>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="UrlRewrite"/> that lives for the lifetime of its
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.KrakendBenchmark.Current.KrakendSchema.UrlRewrite.RequiredLiteral" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsRequiredLiteral(out Corvus.KrakendBenchmark.Current.KrakendSchema.UrlRewrite.RequiredLiteral result)
        {
            if (Corvus.KrakendBenchmark.Current.KrakendSchema.UrlRewrite.RequiredLiteral.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.KrakendBenchmark.Current.KrakendSchema.UrlRewrite.RequiredLiteral.From(this);
                return true;
            }
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.KrakendBenchmark.Current.KrakendSchema.UrlRewrite.RequiredRegexp" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsRequiredRegexp(out Corvus.KrakendBenchmark.Current.KrakendSchema.UrlRewrite.RequiredRegexp result)
        {
            if (Corvus.KrakendBenchmark.Current.KrakendSchema.UrlRewrite.RequiredRegexp.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.KrakendBenchmark.Current.KrakendSchema.UrlRewrite.RequiredRegexp.From(this);
                return true;
            }
        ...
        public TResult Match<TContext, TResult>(
            in TContext context,
            Matcher<Corvus.KrakendBenchmark.Current.KrakendSchema.UrlRewrite.RequiredLiteral, TContext, TResult> matchRequiredLiteral,
            Matcher<Corvus.KrakendBenchmark.Current.KrakendSchema.UrlRewrite.RequiredRegexp, TContext, TResult> matchRequiredRegexp,
            Matcher<Corvus.KrakendBenchmark.Current.KrakendSchema.UrlRewrite, TContext, TResult> defaultMatch)
...
#endif
        {
            if (Corvus.KrakendBenchmark.Current.KrakendSchema.UrlRewrite.RequiredLiteral.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredLiteral(Corvus.KrakendBenchmark.Current.KrakendSchema.UrlRewrite.RequiredLiteral.From(this), context);
            }

            if (Corvus.KrakendBenchmark.Current.KrakendSchema.UrlRewrite.RequiredRegexp.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredRegexp(Corvus.KrakendBenchmark.Current.KrakendSchema.UrlRewrite.RequiredRegexp.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            Matcher<Corvus.KrakendBenchmark.Current.KrakendSchema.UrlRewrite.RequiredLiteral, TResult> matchRequiredLiteral,
            Matcher<Corvus.KrakendBenchmark.Current.KrakendSchema.UrlRewrite.RequiredRegexp, TResult> matchRequiredRegexp,
            Matcher<Corvus.KrakendBenchmark.Current.KrakendSchema.UrlRewrite, TResult> defaultMatch)
        {
            if (Corvus.KrakendBenchmark.Current.KrakendSchema.UrlRewrite.RequiredLiteral.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredLiteral(Corvus.KrakendBenchmark.Current.KrakendSchema.UrlRewrite.RequiredLiteral.From(this));
            }

            if (Corvus.KrakendBenchmark.Current.KrakendSchema.UrlRewrite.RequiredRegexp.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredRegexp(Corvus.KrakendBenchmark.Current.KrakendSchema.UrlRewrite.RequiredRegexp.From(this));
            }
        ...
        public TAccumulator MatchEvery<TAccumulator>(
            ...
            Matcher<Corvus.KrakendBenchmark.Current.KrakendSchema.UrlRewrite, TAccumulator, TAccumulator> defaultMatch)
        {
            bool matched = false;
            ...
            {
                matched = true;
                accumulator = matchRequiredLiteral(Corvus.KrakendBenchmark.Current.KrakendSchema.UrlRewrite.RequiredLiteral.From(this), accumulator);
            }

            if (Corvus.KrakendBenchmark.Current.KrakendSchema.UrlRewrite.RequiredRegexp.JsonSchema.Evaluate(_parent, _idx))
            {
                matched = true;
                accumulator = matchRequiredRegexp(Corvus.KrakendBenchmark.Current.KrakendSchema.UrlRewrite.RequiredRegexp.From(this), accumulator);
            }
        ...
        {
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="Literal"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Literal => [0x95, 0x00, 0x00, 0x00, 0x22, 0x6C, 0x69, 0x74, 0x65, 0x72, 0x61, 0x6C, 0x22];

            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="Regexp"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Regexp => [0x85, 0x00, 0x00, 0x00, 0x22, 0x72, 0x65, 0x67, 0x65, 0x78, 0x70, 0x22];
        }
    }
}
