...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Validator
    {
...
#endif
        {
            ...
            internal Algorithm(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static Algorithm DefaultInstance { get; } = ParsedJsonDocument<Algorithm>.StringConstant([.."\"RS256\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(Algorithm value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in Algorithm left, in Algorithm right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in Algorithm left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(Algorithm instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Algorithm(JsonElement instance)
            {
                return Algorithm.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Algorithm From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Algorithm ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Algorithm>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Algorithm ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Algorithm>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Algorithm ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Algorithm>(json, options);
            }
            ...
            /// </exception>
            public static Algorithm ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<Algorithm>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out Algorithm? result)
            {
                return JsonElementHelpers.TryParseValue<Algorithm>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Algorithm(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static Algorithm IJsonElement<Algorithm>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Algorithm: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Algorithm"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Algorithm"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            {
                CheckValidInstance();
                return _parent.CloneElement<Algorithm>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Algorithm"/> that lives for the lifetime of its
            ...
            /// <param name="matchEdDsa">Match 1st item.</param>
            /// <param name="matchHs256">Match 2nd item.</param>
            /// <param name="matchHs384">Match 3rd item.</param>
            /// <param name="matchHs512">Match 4th item.</param>
            /// <param name="matchRs256">Match 5th item.</param>
            /// <param name="matchRs384">Match 6th item.</param>
            /// <param name="matchRs512">Match 7th item.</param>
            /// <param name="matchEs256">Match 8th item.</param>
            /// <param name="matchEs384">Match 9th item.</param>
            /// <param name="matchEs512">Match 10th item.</param>
            /// <param name="matchPs256">Match 11th item.</param>
            /// <param name="matchPs384">Match 12th item.</param>
            /// <param name="matchPs512">Match 13th item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchEdDsa,
                Func<TContext, TResult> matchHs256,
                Func<TContext, TResult> matchHs384,
                Func<TContext, TResult> matchHs512,
                Func<TContext, TResult> matchRs256,
                Func<TContext, TResult> matchRs384,
                Func<TContext, TResult> matchRs512,
                Func<TContext, TResult> matchEs256,
                Func<TContext, TResult> matchEs384,
                Func<TContext, TResult> matchEs512,
                Func<TContext, TResult> matchPs256,
                Func<TContext, TResult> matchPs384,
                Func<TContext, TResult> matchPs512,
            ...
            public TResult Match<TResult>(
                Func<TResult> matchEdDsa,
                Func<TResult> matchHs256,
                Func<TResult> matchHs384,
                Func<TResult> matchHs512,
                Func<TResult> matchRs256,
                Func<TResult> matchRs384,
                Func<TResult> matchRs512,
                Func<TResult> matchEs256,
                Func<TResult> matchEs384,
                Func<TResult> matchEs512,
                Func<TResult> matchPs256,
                Func<TResult> matchPs384,
                Func<TResult> matchPs512,
