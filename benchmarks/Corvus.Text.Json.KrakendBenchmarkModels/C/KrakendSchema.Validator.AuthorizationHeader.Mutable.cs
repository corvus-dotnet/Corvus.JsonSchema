...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Validator
    {
        ...
        public readonly partial struct AuthorizationHeader
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<AuthorizationHeader, Mutable>(AuthorizationHeader.DefaultInstance);
                ...
                public static explicit operator Mutable(AuthorizationHeader instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="AuthorizationHeader"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AuthorizationHeader(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new AuthorizationHeader(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AuthorizationHeader.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="AuthorizationHeader"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="AuthorizationHeader"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly AuthorizationHeader Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<AuthorizationHeader>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="AuthorizationHeader"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly AuthorizationHeader Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<AuthorizationHeader>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(AuthorizationHeader instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<AuthorizationHeader, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<AuthorizationHeader> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<AuthorizationHeader>();
                }
                finally
                {
