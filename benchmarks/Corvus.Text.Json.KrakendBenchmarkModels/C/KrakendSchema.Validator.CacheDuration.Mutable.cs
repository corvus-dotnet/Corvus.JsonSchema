    ...
    public readonly partial struct Validator
    {
        ...
        public readonly partial struct CacheDuration
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<CacheDuration, Mutable>(CacheDuration.DefaultInstance);
            ...
            public static ParsedJsonDocument<CacheDuration> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<CacheDuration>();
                }
                finally
                {
