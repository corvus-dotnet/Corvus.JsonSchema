    ...
    public readonly partial struct Validator
    {
        ...
        public readonly partial struct DebugEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DebugEntity, Mutable>(DebugEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(DebugEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DebugEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DebugEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DebugEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly DebugEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly DebugEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DebugEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(DebugEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<DebugEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<DebugEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<DebugEntity>();
                }
                finally
                {
