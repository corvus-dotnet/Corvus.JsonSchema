    ...
    public readonly partial struct Validator
    {
        ...
        public readonly partial struct KeyIdentifyStrategy
        {
            ...
            public ref struct Source
            {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (KeyIdentifyStrategy)value;
            ...
            public static ParsedJsonDocument<KeyIdentifyStrategy> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<KeyIdentifyStrategy>();
                }
                finally
                {
