...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Validator
    {
        ...
        public readonly partial struct PropagateClaimsArrayArray
#if NET8_0_OR_GREATER
            : IJsonElement<PropagateClaimsArrayArray>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="PropagateClaimsArrayArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal PropagateClaimsArrayArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static PropagateClaimsArrayArray DefaultInstance { get; }
            ...
            public Corvus.KrakendBenchmark.Current.KrakendSchema.Validator.PropagateClaimsArrayArray.JsonStringArray this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.KrakendBenchmark.Current.KrakendSchema.Validator.PropagateClaimsArrayArray.JsonStringArray>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.KrakendBenchmark.Current.KrakendSchema.Validator.PropagateClaimsArrayArray.JsonStringArray> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.KrakendBenchmark.Current.KrakendSchema.Validator.PropagateClaimsArrayArray.JsonStringArray>(_parent, _idx);
            }
            ...
            /// </returns>
            public static bool operator ==(in PropagateClaimsArrayArray left, in PropagateClaimsArrayArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in PropagateClaimsArrayArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(PropagateClaimsArrayArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PropagateClaimsArrayArray(JsonElement instance)
            {
                return PropagateClaimsArrayArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PropagateClaimsArrayArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PropagateClaimsArrayArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PropagateClaimsArrayArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PropagateClaimsArrayArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PropagateClaimsArrayArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PropagateClaimsArrayArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PropagateClaimsArrayArray>(json, options);
            }
            ...
            /// </exception>
            public static PropagateClaimsArrayArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<PropagateClaimsArrayArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out PropagateClaimsArrayArray? result)
            {
                return JsonElementHelpers.TryParseValue<PropagateClaimsArrayArray>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new PropagateClaimsArrayArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static PropagateClaimsArrayArray IJsonElement<PropagateClaimsArrayArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PropagateClaimsArrayArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="PropagateClaimsArrayArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="PropagateClaimsArrayArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public PropagateClaimsArrayArray Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<PropagateClaimsArrayArray>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="PropagateClaimsArrayArray"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public PropagateClaimsArrayArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<PropagateClaimsArrayArray>(_idx);
                }
