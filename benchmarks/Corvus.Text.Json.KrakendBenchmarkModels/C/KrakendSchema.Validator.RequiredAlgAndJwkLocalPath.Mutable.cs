...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Validator
    {
        ...
        public readonly partial struct RequiredAlgAndJwkLocalPath
        {
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(in Corvus.Text.Json.JsonElement.Source alg, in Corvus.Text.Json.JsonElement.Source jwkLocalPath)
            {
            ...
            /// <param name="jwkLocalPath">The value of the <c>"jwk_local_path"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> alg, in Corvus.Text.Json.JsonElement.Source<TContext> jwkLocalPath)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
