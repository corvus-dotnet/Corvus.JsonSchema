    ...
    public readonly partial struct Validator
    {
        ...
        public readonly partial struct RequiredAlgAndJwkLocalPath
        {
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Validator.RequiredAlgAndJwkLocalPath.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Validator.RequiredAlgAndJwkLocalPath.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.Text.Json.JsonElement.Source alg, scoped in Corvus.Text.Json.JsonElement.Source jwkLocalPath)
            {
                return new Source(alg, jwkLocalPath);
            }
            ...
            /// <param name="jwkLocalPath">The value of the <c>"jwk_local_path"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.JsonElement.Source<TContext> alg, scoped in Corvus.Text.Json.JsonElement.Source<TContext> jwkLocalPath)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                return new Source<TContext>(context, alg, jwkLocalPath);
            }
            ...
            public static ParsedJsonDocument<RequiredAlgAndJwkLocalPath> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RequiredAlgAndJwkLocalPath>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RequiredAlgAndJwkLocalPath> Create<TContext>(
            ...
            public static ParsedJsonDocument<RequiredAlgAndJwkLocalPath> Create(in Corvus.Text.Json.JsonElement.Source alg, in Corvus.Text.Json.JsonElement.Source jwkLocalPath, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RequiredAlgAndJwkLocalPath> Create<TContext>(in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> alg, in Corvus.Text.Json.JsonElement.Source<TContext> jwkLocalPath, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
