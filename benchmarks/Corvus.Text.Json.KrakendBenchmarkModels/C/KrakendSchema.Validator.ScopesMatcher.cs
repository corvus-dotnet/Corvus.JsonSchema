...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Validator
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ScopesMatcher"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ScopesMatcher(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ScopesMatcher DefaultInstance { get; } = ParsedJsonDocument<ScopesMatcher>.StringConstant([.."\"any\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(ScopesMatcher value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in ScopesMatcher left, in ScopesMatcher right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ScopesMatcher left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ScopesMatcher instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ScopesMatcher(JsonElement instance)
            {
                return ScopesMatcher.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ScopesMatcher From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ScopesMatcher ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ScopesMatcher>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ScopesMatcher ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ScopesMatcher>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ScopesMatcher ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ScopesMatcher>(json, options);
            }
            ...
            /// </exception>
            public static ScopesMatcher ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ScopesMatcher>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ScopesMatcher? result)
            {
                return JsonElementHelpers.TryParseValue<ScopesMatcher>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ScopesMatcher(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static ScopesMatcher IJsonElement<ScopesMatcher>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ScopesMatcher: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ScopesMatcher"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ScopesMatcher"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public ScopesMatcher Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ScopesMatcher>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ScopesMatcher"/> that lives for the lifetime of its
            ...
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchAny,
