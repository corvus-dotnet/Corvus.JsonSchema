...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Validator
    {
        ...
        public readonly partial struct ValidatorJArray
#if NET8_0_OR_GREATER
            : IJsonElement<ValidatorJArray>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ValidatorJArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ValidatorJArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ValidatorJArray DefaultInstance { get; }
            ...
            public Corvus.KrakendBenchmark.Current.JsonString this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.KrakendBenchmark.Current.JsonString>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.KrakendBenchmark.Current.JsonString> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.KrakendBenchmark.Current.JsonString>(_parent, _idx);
            }
            ...
            /// </returns>
            public static bool operator ==(in ValidatorJArray left, in ValidatorJArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ValidatorJArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(ValidatorJArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ValidatorJArray(JsonElement instance)
            {
                return ValidatorJArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ValidatorJArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ValidatorJArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ValidatorJArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ValidatorJArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ValidatorJArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ValidatorJArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ValidatorJArray>(json, options);
            }
            ...
            /// </exception>
            public static ValidatorJArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ValidatorJArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ValidatorJArray? result)
            {
                return JsonElementHelpers.TryParseValue<ValidatorJArray>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ValidatorJArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static ValidatorJArray IJsonElement<ValidatorJArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ValidatorJArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ValidatorJArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ValidatorJArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public ValidatorJArray Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ValidatorJArray>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ValidatorJArray"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public ValidatorJArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ValidatorJArray>(_idx);
                }
