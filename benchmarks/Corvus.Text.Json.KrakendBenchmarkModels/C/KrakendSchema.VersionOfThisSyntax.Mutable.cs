...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct VersionOfThisSyntax
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(VersionOfThisSyntax instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="VersionOfThisSyntax"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator VersionOfThisSyntax(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"VersionOfThisSyntax.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly VersionOfThisSyntax Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly VersionOfThisSyntax Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<VersionOfThisSyntax>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(VersionOfThisSyntax instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<VersionOfThisSyntax, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<VersionOfThisSyntax> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<VersionOfThisSyntax>();
            }
            finally
            {
