...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Virtualhost
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Virtualhost instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Virtualhost"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Virtualhost(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.KrakendBenchmark.Current.KrakendSchema.Virtualhost.JsonStringArray.Mutable Hosts
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HostsUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.Virtualhost.JsonStringArray.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetHosts(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Virtualhost.JsonStringArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetHosts<TContext>(in Corvus.KrakendBenchmark.Current.KrakendSchema.Virtualhost.JsonStringArray.Source<TContext> value)
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Virtualhost.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly Virtualhost Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly Virtualhost Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Virtualhost>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Virtualhost.JsonStringArray.Source _createArg1;
            ...
            internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.Virtualhost.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Virtualhost.JsonStringArray.Source arg1)
            {
                _createArg1 = arg1;
                _kind = Kind.Create;
            }

            public static implicit operator Source(Virtualhost instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.Virtualhost.JsonStringArray.Source<TContext> _createArg1;
            ...
            internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.Virtualhost.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Virtualhost.JsonStringArray.Source<TContext> arg1)
            {
                _context = context;
                _createArg1 = arg1;
                _kind = Kind.Create;
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="Virtualhost"/>.
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.KrakendBenchmark.Current.KrakendSchema.Virtualhost.JsonStringArray.Source hosts)
            {
            ...
            /// Creates an instance of a <see cref="Virtualhost"/>.
            /// </summary>
            public void Create(in Corvus.KrakendBenchmark.Current.KrakendSchema.Virtualhost.JsonStringArray.Source hosts)
            {
            ...
            internal static void Create<TContext>(
                ...
                in Corvus.KrakendBenchmark.Current.KrakendSchema.Virtualhost.JsonStringArray.Source<TContext> hosts)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            /// Creates an instance of a <see cref="Virtualhost"/>.
            /// </summary>
            public void Create<TContext>(in TContext context, in Corvus.KrakendBenchmark.Current.KrakendSchema.Virtualhost.JsonStringArray.Source<TContext> hosts)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            internal static void BuildCreateValue(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Virtualhost.JsonStringArray.Source arg1, ref ComplexValueBuilder o)
            {
                o.StartObject();
                Create(ref o, arg1);
                o.EndObject();
            ...
            /// <param name="arg1">The value of the property.</param>
            /// <param name="o">The complex value builder into which to write the object.</param>
            internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Virtualhost.JsonStringArray.Source<TContext> arg1, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Virtualhost.JsonStringArray.Source hosts)
        {
            return new Source(hosts);
        }
        ...
        /// <param name="hosts">The value of the <c>"hosts"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.Virtualhost.JsonStringArray.Source<TContext> hosts)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            return new Source<TContext>(context, hosts);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.KrakendSchema.Virtualhost.JsonStringArray.Source hosts, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.KrakendBenchmark.Current.KrakendSchema.Virtualhost.JsonStringArray.Source<TContext> hosts, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
        ...
        {
            return workspace.CreateBuilder<Virtualhost, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<Virtualhost> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Virtualhost>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Virtualhost> Create<TContext>(
        ...
        public static ParsedJsonDocument<Virtualhost> Create(in Corvus.KrakendBenchmark.Current.KrakendSchema.Virtualhost.JsonStringArray.Source hosts, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Virtualhost> Create<TContext>(in TContext context, in Corvus.KrakendBenchmark.Current.KrakendSchema.Virtualhost.JsonStringArray.Source<TContext> hosts, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
