    ...
    public readonly partial struct Websocket
    {
        ...
        public readonly partial struct BackoffStrategy
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<BackoffStrategy, Mutable>(BackoffStrategy.DefaultInstance);
                ...
                public static explicit operator Mutable(BackoffStrategy instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="BackoffStrategy"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator BackoffStrategy(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"BackoffStrategy.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly BackoffStrategy Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly BackoffStrategy Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<BackoffStrategy>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(BackoffStrategy instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (BackoffStrategy)value;
            ...
            {
                return workspace.CreateBuilder<BackoffStrategy, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<BackoffStrategy> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<BackoffStrategy>();
                }
                finally
                {
