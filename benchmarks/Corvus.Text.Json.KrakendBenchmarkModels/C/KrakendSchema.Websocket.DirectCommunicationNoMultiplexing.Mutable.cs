    ...
    public readonly partial struct Websocket
    {
        ...
        public readonly partial struct DirectCommunicationNoMultiplexing
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DirectCommunicationNoMultiplexing, Mutable>(DirectCommunicationNoMultiplexing.DefaultInstance);
                ...
                public static explicit operator Mutable(DirectCommunicationNoMultiplexing instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DirectCommunicationNoMultiplexing"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DirectCommunicationNoMultiplexing(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DirectCommunicationNoMultiplexing.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly DirectCommunicationNoMultiplexing Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly DirectCommunicationNoMultiplexing Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DirectCommunicationNoMultiplexing>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(DirectCommunicationNoMultiplexing instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<DirectCommunicationNoMultiplexing, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<DirectCommunicationNoMultiplexing> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<DirectCommunicationNoMultiplexing>();
                }
                finally
                {
