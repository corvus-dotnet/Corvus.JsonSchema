    ...
    public readonly partial struct Websocket
    {
        ...
        public readonly partial struct MaxRetries
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<MaxRetries, Mutable>(MaxRetries.DefaultInstance);
                ...
                public static explicit operator Mutable(MaxRetries instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="MaxRetries"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator MaxRetries(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"MaxRetries.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly MaxRetries Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly MaxRetries Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<MaxRetries>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(MaxRetries instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<MaxRetries, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<MaxRetries> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<MaxRetries>();
                }
                finally
                {
