    ...
    public readonly partial struct Websocket
    {
        ...
        public readonly partial struct MaximumMessageSize
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<MaximumMessageSize, Mutable>(MaximumMessageSize.DefaultInstance);
            ...
            public static ParsedJsonDocument<MaximumMessageSize> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<MaximumMessageSize>();
                }
                finally
                {
