    ...
    public readonly partial struct Websocket
    {
        ...
        public readonly partial struct MessageBufferSize
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<MessageBufferSize, Mutable>(MessageBufferSize.DefaultInstance);
                ...
                public static explicit operator Mutable(MessageBufferSize instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="MessageBufferSize"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator MessageBufferSize(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"MessageBufferSize.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly MessageBufferSize Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly MessageBufferSize Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<MessageBufferSize>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(MessageBufferSize instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<MessageBufferSize, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<MessageBufferSize> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<MessageBufferSize>();
                }
                finally
                {
