    ...
    public readonly partial struct Websocket
    {
        ...
        public readonly partial struct NotifyConnections
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<NotifyConnections, Mutable>(NotifyConnections.DefaultInstance);
            ...
            public static ParsedJsonDocument<NotifyConnections> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<NotifyConnections>();
                }
                finally
                {
