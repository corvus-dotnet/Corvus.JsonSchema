...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Websocket
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="NotifyConnections"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal NotifyConnections(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static NotifyConnections DefaultInstance { get; } = ParsedJsonDocument<NotifyConnections>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(NotifyConnections value)
            {
            ...
            /// </returns>
            public static bool operator ==(in NotifyConnections left, in NotifyConnections right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in NotifyConnections left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(NotifyConnections instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator NotifyConnections(JsonElement instance)
            {
                return NotifyConnections.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NotifyConnections From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NotifyConnections ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<NotifyConnections>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NotifyConnections ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<NotifyConnections>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NotifyConnections ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<NotifyConnections>(json, options);
            }
            ...
            /// </exception>
            public static NotifyConnections ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<NotifyConnections>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out NotifyConnections? result)
            {
                return JsonElementHelpers.TryParseValue<NotifyConnections>(ref reader, out result);
            }
...
#if NET
            static NotifyConnections IJsonElement<NotifyConnections>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"NotifyConnections: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public NotifyConnections Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public NotifyConnections Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<NotifyConnections>(_idx);
                }
