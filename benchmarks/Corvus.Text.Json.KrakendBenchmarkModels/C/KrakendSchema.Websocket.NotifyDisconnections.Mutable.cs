    ...
    public readonly partial struct Websocket
    {
        ...
        public readonly partial struct NotifyDisconnections
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<NotifyDisconnections, Mutable>(NotifyDisconnections.DefaultInstance);
            ...
            public static ParsedJsonDocument<NotifyDisconnections> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<NotifyDisconnections>();
                }
                finally
                {
