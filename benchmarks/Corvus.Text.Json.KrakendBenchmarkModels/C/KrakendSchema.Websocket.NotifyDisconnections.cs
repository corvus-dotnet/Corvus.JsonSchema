...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Websocket
    {
        ...
        public readonly partial struct NotifyDisconnections
#if NET8_0_OR_GREATER
            : IJsonElement<NotifyDisconnections>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="NotifyDisconnections"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal NotifyDisconnections(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static NotifyDisconnections DefaultInstance { get; } = ParsedJsonDocument<NotifyDisconnections>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(NotifyDisconnections value)
            {
            ...
            /// </returns>
            public static bool operator ==(in NotifyDisconnections left, in NotifyDisconnections right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in NotifyDisconnections left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(NotifyDisconnections instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator NotifyDisconnections(JsonElement instance)
            {
                return NotifyDisconnections.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NotifyDisconnections From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NotifyDisconnections ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<NotifyDisconnections>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NotifyDisconnections ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<NotifyDisconnections>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NotifyDisconnections ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<NotifyDisconnections>(json, options);
            }
            ...
            /// </exception>
            public static NotifyDisconnections ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<NotifyDisconnections>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out NotifyDisconnections? result)
            {
                return JsonElementHelpers.TryParseValue<NotifyDisconnections>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new NotifyDisconnections(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static NotifyDisconnections IJsonElement<NotifyDisconnections>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"NotifyDisconnections: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="NotifyDisconnections"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="NotifyDisconnections"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public NotifyDisconnections Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<NotifyDisconnections>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="NotifyDisconnections"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public NotifyDisconnections Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<NotifyDisconnections>(_idx);
                }
