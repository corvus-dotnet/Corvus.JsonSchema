    ...
    public readonly partial struct Websocket
    {
        ...
        public readonly partial struct ReadBufferSize
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ReadBufferSize, Mutable>(ReadBufferSize.DefaultInstance);
            ...
            public static ParsedJsonDocument<ReadBufferSize> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ReadBufferSize>();
                }
                finally
                {
