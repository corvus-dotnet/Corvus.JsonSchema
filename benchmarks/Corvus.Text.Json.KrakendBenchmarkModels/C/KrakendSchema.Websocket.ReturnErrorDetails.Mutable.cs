    ...
    public readonly partial struct Websocket
    {
        ...
        public readonly partial struct ReturnErrorDetails
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ReturnErrorDetails, Mutable>(ReturnErrorDetails.DefaultInstance);
            ...
            public static ParsedJsonDocument<ReturnErrorDetails> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ReturnErrorDetails>();
                }
                finally
                {
