    ...
    public readonly partial struct Websocket
    {
        ...
        public readonly partial struct WriteBufferSize
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<WriteBufferSize, Mutable>(WriteBufferSize.DefaultInstance);
            ...
            public static ParsedJsonDocument<WriteBufferSize> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<WriteBufferSize>();
                }
                finally
                {
