...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Workflow
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="BackendArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal BackendArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static BackendArray DefaultInstance { get; }
            ...
            public Corvus.KrakendBenchmark.Current.KrakendSchema.Backend this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.KrakendBenchmark.Current.KrakendSchema.Backend>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.KrakendBenchmark.Current.KrakendSchema.Backend> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.KrakendBenchmark.Current.KrakendSchema.Backend>(_parent, _idx);
            }
            ...
            /// </returns>
            public static bool operator ==(in BackendArray left, in BackendArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in BackendArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(BackendArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator BackendArray(JsonElement instance)
            {
                return BackendArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static BackendArray From<T>(in T instance)
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out BackendArray? result)
            {
                return JsonElementHelpers.TryParseValue<BackendArray>(ref reader, out result);
            }
...
#if NET
            static BackendArray IJsonElement<BackendArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"BackendArray: ValueKind = {ValueKind} : \"{ToString()}\"";
