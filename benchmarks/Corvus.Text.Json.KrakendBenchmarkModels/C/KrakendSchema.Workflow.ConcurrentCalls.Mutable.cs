    ...
    public readonly partial struct Workflow
    {
        ...
        public readonly partial struct ConcurrentCalls
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ConcurrentCalls, Mutable>(ConcurrentCalls.DefaultInstance);
            ...
            public static ParsedJsonDocument<ConcurrentCalls> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ConcurrentCalls>();
                }
                finally
                {
