    ...
    public readonly partial struct Workflow
    {
        ...
        public readonly partial struct IgnoreErrors
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<IgnoreErrors, Mutable>(IgnoreErrors.DefaultInstance);
                ...
                public static explicit operator Mutable(IgnoreErrors instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="IgnoreErrors"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator IgnoreErrors(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"IgnoreErrors.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly IgnoreErrors Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly IgnoreErrors Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<IgnoreErrors>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(IgnoreErrors instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<IgnoreErrors, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<IgnoreErrors> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<IgnoreErrors>();
                }
                finally
                {
