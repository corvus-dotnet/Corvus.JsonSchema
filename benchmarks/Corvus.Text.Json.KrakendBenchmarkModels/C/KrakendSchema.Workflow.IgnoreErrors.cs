...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Workflow
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="IgnoreErrors"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal IgnoreErrors(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static IgnoreErrors DefaultInstance { get; } = ParsedJsonDocument<IgnoreErrors>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(IgnoreErrors value)
            {
            ...
            /// </returns>
            public static bool operator ==(in IgnoreErrors left, in IgnoreErrors right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in IgnoreErrors left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(IgnoreErrors instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator IgnoreErrors(JsonElement instance)
            {
                return IgnoreErrors.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static IgnoreErrors From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static IgnoreErrors ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<IgnoreErrors>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static IgnoreErrors ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<IgnoreErrors>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static IgnoreErrors ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<IgnoreErrors>(json, options);
            }
            ...
            /// </exception>
            public static IgnoreErrors ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<IgnoreErrors>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out IgnoreErrors? result)
            {
                return JsonElementHelpers.TryParseValue<IgnoreErrors>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new IgnoreErrors(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static IgnoreErrors IJsonElement<IgnoreErrors>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"IgnoreErrors: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="IgnoreErrors"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="IgnoreErrors"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public IgnoreErrors Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<IgnoreErrors>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="IgnoreErrors"/> that lives for the lifetime of its
