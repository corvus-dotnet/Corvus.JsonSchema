    ...
    public readonly partial struct Workflow
    {
        ...
        public readonly partial struct OutputEncoding
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<OutputEncoding, Mutable>(OutputEncoding.DefaultInstance);
                ...
                public static explicit operator Mutable(OutputEncoding instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="OutputEncoding"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator OutputEncoding(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"OutputEncoding.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly OutputEncoding Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly OutputEncoding Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<OutputEncoding>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(OutputEncoding instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (OutputEncoding)value;
            ...
            {
                return workspace.CreateBuilder<OutputEncoding, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<OutputEncoding> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<OutputEncoding>();
                }
                finally
                {
