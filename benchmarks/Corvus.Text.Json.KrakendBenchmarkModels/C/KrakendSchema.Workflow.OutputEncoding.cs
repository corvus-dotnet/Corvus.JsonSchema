...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct Workflow
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="OutputEncoding"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal OutputEncoding(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static OutputEncoding DefaultInstance { get; } = ParsedJsonDocument<OutputEncoding>.StringConstant([.."\"json\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(OutputEncoding value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in OutputEncoding left, in OutputEncoding right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in OutputEncoding left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(OutputEncoding instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator OutputEncoding(JsonElement instance)
            {
                return OutputEncoding.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OutputEncoding From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OutputEncoding ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OutputEncoding>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OutputEncoding ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OutputEncoding>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OutputEncoding ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OutputEncoding>(json, options);
            }
            ...
            /// </exception>
            public static OutputEncoding ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<OutputEncoding>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out OutputEncoding? result)
            {
                return JsonElementHelpers.TryParseValue<OutputEncoding>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new OutputEncoding(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static OutputEncoding IJsonElement<OutputEncoding>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"OutputEncoding: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="OutputEncoding"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="OutputEncoding"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public OutputEncoding Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<OutputEncoding>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="OutputEncoding"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public OutputEncoding Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<OutputEncoding>(_idx);
                }
            ...
            /// <param name="matchJsonCollection">Match 2nd item.</param>
            /// <param name="matchFastJson">Match 3rd item.</param>
            /// <param name="matchXml">Match 4th item.</param>
            /// <param name="matchNegotiate">Match 5th item.</param>
            /// <param name="matchString">Match 6th item.</param>
            /// <param name="matchNoOp">Match 7th item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchJson,
                Func<TContext, TResult> matchJsonCollection,
                Func<TContext, TResult> matchFastJson,
                Func<TContext, TResult> matchXml,
                Func<TContext, TResult> matchNegotiate,
                Func<TContext, TResult> matchString,
                Func<TContext, TResult> matchNoOp,
...
#endif
            {
                ...
                {
                    return matchJsonCollection(context);
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchFastJson(context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Func<TResult> matchJsonCollection,
                Func<TResult> matchFastJson,
                Func<TResult> matchXml,
                Func<TResult> matchNegotiate,
                Func<TResult> matchString,
                Func<TResult> matchNoOp,
                Func<TResult> defaultMatch)
            {
                ...
                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchJsonCollection();
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchFastJson();
                }
