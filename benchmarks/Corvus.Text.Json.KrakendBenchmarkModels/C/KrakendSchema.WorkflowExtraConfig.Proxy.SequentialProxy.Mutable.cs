...
public readonly partial struct KrakendSchema
{
    ...
    public readonly partial struct WorkflowExtraConfig
    {
        ...
        public readonly partial struct Proxy
        {
            ...
            public readonly partial struct SequentialProxy
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SequentialProxy, Mutable>(SequentialProxy.DefaultInstance);
                    ...
                    public static explicit operator Mutable(SequentialProxy instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="SequentialProxy"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator SequentialProxy(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new SequentialProxy(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"SequentialProxy.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="SequentialProxy"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="SequentialProxy"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly SequentialProxy Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<SequentialProxy>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="SequentialProxy"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly SequentialProxy Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<SequentialProxy>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(SequentialProxy instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<SequentialProxy, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<SequentialProxy> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<SequentialProxy>();
                    }
                    finally
                    {
