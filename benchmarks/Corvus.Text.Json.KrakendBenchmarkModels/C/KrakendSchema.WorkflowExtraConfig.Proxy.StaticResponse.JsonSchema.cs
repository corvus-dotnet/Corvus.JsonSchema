        ...
        public readonly partial struct Proxy
        {
                ...
                : IJsonElement<StaticResponse>
            {
                public static partial class JsonSchema
                {
                    ...
                    private static void MatchData(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                    {
                    ...
                    private static void MatchStrategyValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                    {
                        ...
                        JsonSchemaContext childContext1 =
                            Corvus.KrakendBenchmark.Current.KrakendSchema.WorkflowExtraConfig.Proxy.StaticResponse.Strategy.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                                parentDocumentIndex,
                                ref context,
                        ...
                        Corvus.KrakendBenchmark.Current.KrakendSchema.WorkflowExtraConfig.Proxy.StaticResponse.Strategy.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
