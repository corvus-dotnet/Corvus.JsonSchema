        ...
        public readonly partial struct Proxy
        {
            ...
            public readonly partial struct StaticResponse
            {
...
#endif
                {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.KrakendBenchmark.Current.KrakendSchema.WorkflowExtraConfig.Proxy.StaticResponse.Strategy.Mutable StrategyValue
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StrategyValueUtf8, out Corvus.KrakendBenchmark.Current.KrakendSchema.WorkflowExtraConfig.Proxy.StaticResponse.Strategy.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetStrategyValue(scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.WorkflowExtraConfig.Proxy.StaticResponse.Strategy.Source value)
                    {
                        CheckValidInstance();
                ...
                public ref struct Source
                {
                    ...
                    private readonly Corvus.KrakendBenchmark.Current.KrakendSchema.WorkflowExtraConfig.Proxy.StaticResponse.Strategy.Source _createArg2;
                    ...
                    internal Source(Corvus.KrakendBenchmark.Current.KrakendSchema.WorkflowExtraConfig.Proxy.StaticResponse.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    internal Source(scoped in Corvus.KrakendBenchmark.Current.JsonObject.Source arg1, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.WorkflowExtraConfig.Proxy.StaticResponse.Strategy.Source arg2)
                    {
                        _createArg1 = arg1;
                        _createArg2 = arg2;
                        _kind = Kind.Create;
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.KrakendBenchmark.Current.KrakendSchema.WorkflowExtraConfig.Proxy.StaticResponse.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

                    internal Source(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.JsonObject.Source<TContext> arg1, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.WorkflowExtraConfig.Proxy.StaticResponse.Strategy.Source arg2)
                    {
                        _context = context;
                        _createArg1 = arg1;
                        _createArg2 = arg2;
                ...
                public ref struct Builder
                {
                    ...
                    internal static void Create(
                        ...
                        in Corvus.KrakendBenchmark.Current.KrakendSchema.WorkflowExtraConfig.Proxy.StaticResponse.Strategy.Source strategy)
                    {
                    ...
                    /// Creates an instance of a <see cref="StaticResponse"/>.
                    /// </summary>
                    public void Create(in Corvus.KrakendBenchmark.Current.JsonObject.Source data, in Corvus.KrakendBenchmark.Current.KrakendSchema.WorkflowExtraConfig.Proxy.StaticResponse.Strategy.Source strategy)
                    {
                    ...
                    internal static void BuildCreateValue(scoped in Corvus.KrakendBenchmark.Current.JsonObject.Source arg1, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.WorkflowExtraConfig.Proxy.StaticResponse.Strategy.Source arg2, ref ComplexValueBuilder o)
                    {
                        o.StartObject();
                    ...
                    /// <param name="arg2">The value of the property.</param>
                    /// <param name="o">The complex value builder into which to write the object.</param>
                    internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.JsonObject.Source<TContext> arg1, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.WorkflowExtraConfig.Proxy.StaticResponse.Strategy.Source arg2, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                        where TContext : allows ref struct
#endif
                    {
                ...
                /// <returns>The source from which to build the value.</returns>
                public static Source Build(scoped in Corvus.KrakendBenchmark.Current.JsonObject.Source data, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.WorkflowExtraConfig.Proxy.StaticResponse.Strategy.Source strategy)
                {
                ...
                /// <param name="strategy">The value of the <c>"strategy"</c> property.</param>
                /// <returns>The source from which to build the value.</returns>
                public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.KrakendBenchmark.Current.JsonObject.Source<TContext> data, scoped in Corvus.KrakendBenchmark.Current.KrakendSchema.WorkflowExtraConfig.Proxy.StaticResponse.Strategy.Source strategy)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.KrakendBenchmark.Current.JsonObject.Source data, in Corvus.KrakendBenchmark.Current.KrakendSchema.WorkflowExtraConfig.Proxy.StaticResponse.Strategy.Source strategy, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.KrakendBenchmark.Current.JsonObject.Source<TContext> data, in Corvus.KrakendBenchmark.Current.KrakendSchema.WorkflowExtraConfig.Proxy.StaticResponse.Strategy.Source strategy, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
                ...
                public static ParsedJsonDocument<StaticResponse> Create(in Corvus.KrakendBenchmark.Current.JsonObject.Source data, in Corvus.KrakendBenchmark.Current.KrakendSchema.WorkflowExtraConfig.Proxy.StaticResponse.Strategy.Source strategy, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
                public static ParsedJsonDocument<StaticResponse> Create<TContext>(in TContext context, in Corvus.KrakendBenchmark.Current.JsonObject.Source<TContext> data, in Corvus.KrakendBenchmark.Current.KrakendSchema.WorkflowExtraConfig.Proxy.StaticResponse.Strategy.Source strategy, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
