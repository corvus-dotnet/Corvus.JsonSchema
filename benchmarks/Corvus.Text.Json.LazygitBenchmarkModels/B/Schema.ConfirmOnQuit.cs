...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ConfirmOnQuit
#if NET8_0_OR_GREATER
        : IJsonElement<ConfirmOnQuit>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfirmOnQuit"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ConfirmOnQuit(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ConfirmOnQuit DefaultInstance { get; } = ParsedJsonDocument<ConfirmOnQuit>.False;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator bool(ConfirmOnQuit value)
        {
        ...
        /// </returns>
        public static bool operator ==(in ConfirmOnQuit left, in ConfirmOnQuit right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ConfirmOnQuit left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(ConfirmOnQuit instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ConfirmOnQuit(JsonElement instance)
        {
            return ConfirmOnQuit.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ConfirmOnQuit From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ConfirmOnQuit ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ConfirmOnQuit>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ConfirmOnQuit ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ConfirmOnQuit>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ConfirmOnQuit ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ConfirmOnQuit>(json, options);
        }
        ...
        /// </exception>
        public static ConfirmOnQuit ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ConfirmOnQuit>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ConfirmOnQuit? result)
        {
            return JsonElementHelpers.TryParseValue<ConfirmOnQuit>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ConfirmOnQuit(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static ConfirmOnQuit IJsonElement<ConfirmOnQuit>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ConfirmOnQuit: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ConfirmOnQuit"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ConfirmOnQuit"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public ConfirmOnQuit Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ConfirmOnQuit>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ConfirmOnQuit"/> that lives for the lifetime of its
