...
public readonly partial struct Schema
{
    ...
    public readonly partial struct DisableStartupPopups
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(DisableStartupPopups instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="DisableStartupPopups"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DisableStartupPopups(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new DisableStartupPopups(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DisableStartupPopups.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="DisableStartupPopups"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="DisableStartupPopups"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly DisableStartupPopups Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<DisableStartupPopups>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="DisableStartupPopups"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly DisableStartupPopups Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<DisableStartupPopups>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(DisableStartupPopups instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<DisableStartupPopups, Mutable>(this);
        }
    }
}
