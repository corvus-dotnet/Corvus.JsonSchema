...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Git
    {
        ...
        public readonly partial struct AllBranchesLogCmd
#if NET8_0_OR_GREATER
            : IJsonElement<AllBranchesLogCmd>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="AllBranchesLogCmd"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal AllBranchesLogCmd(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static AllBranchesLogCmd DefaultInstance { get; } = ParsedJsonDocument<AllBranchesLogCmd>.StringConstant([.."\"git log --graph --all --color=always --abbrev-commit --decorate --date=relative --pretty=medium\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(AllBranchesLogCmd value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in AllBranchesLogCmd left, in AllBranchesLogCmd right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in AllBranchesLogCmd left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(AllBranchesLogCmd instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AllBranchesLogCmd(JsonElement instance)
            {
                return AllBranchesLogCmd.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AllBranchesLogCmd From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AllBranchesLogCmd ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AllBranchesLogCmd>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AllBranchesLogCmd ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AllBranchesLogCmd>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AllBranchesLogCmd ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AllBranchesLogCmd>(json, options);
            }
            ...
            /// </exception>
            public static AllBranchesLogCmd ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<AllBranchesLogCmd>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out AllBranchesLogCmd? result)
            {
                return JsonElementHelpers.TryParseValue<AllBranchesLogCmd>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new AllBranchesLogCmd(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static AllBranchesLogCmd IJsonElement<AllBranchesLogCmd>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AllBranchesLogCmd: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="AllBranchesLogCmd"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="AllBranchesLogCmd"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public AllBranchesLogCmd Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<AllBranchesLogCmd>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="AllBranchesLogCmd"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public AllBranchesLogCmd Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<AllBranchesLogCmd>(_idx);
                }
