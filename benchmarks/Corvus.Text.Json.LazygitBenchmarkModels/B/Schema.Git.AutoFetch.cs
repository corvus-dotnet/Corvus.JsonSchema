...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Git
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="AutoFetch"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal AutoFetch(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static AutoFetch DefaultInstance { get; } = ParsedJsonDocument<AutoFetch>.True;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(AutoFetch value)
            {
            ...
            /// </returns>
            public static bool operator ==(in AutoFetch left, in AutoFetch right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in AutoFetch left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(AutoFetch instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AutoFetch(JsonElement instance)
            {
                return AutoFetch.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AutoFetch From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AutoFetch ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AutoFetch>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AutoFetch ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AutoFetch>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AutoFetch ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AutoFetch>(json, options);
            }
            ...
            /// </exception>
            public static AutoFetch ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<AutoFetch>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out AutoFetch? result)
            {
                return JsonElementHelpers.TryParseValue<AutoFetch>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new AutoFetch(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static AutoFetch IJsonElement<AutoFetch>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AutoFetch: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="AutoFetch"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="AutoFetch"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public AutoFetch Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<AutoFetch>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="AutoFetch"/> that lives for the lifetime of its
