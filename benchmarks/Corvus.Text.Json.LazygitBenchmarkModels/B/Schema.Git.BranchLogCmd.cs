...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Git
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="BranchLogCmd"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal BranchLogCmd(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static BranchLogCmd DefaultInstance { get; } = ParsedJsonDocument<BranchLogCmd>.StringConstant([.."\"git log --graph --color=always --abbrev-commit --decorate --date=relative --pretty=medium {{branchName}} --\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(BranchLogCmd value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in BranchLogCmd left, in BranchLogCmd right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in BranchLogCmd left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(BranchLogCmd instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator BranchLogCmd(JsonElement instance)
            {
                return BranchLogCmd.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static BranchLogCmd From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static BranchLogCmd ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<BranchLogCmd>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static BranchLogCmd ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<BranchLogCmd>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static BranchLogCmd ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<BranchLogCmd>(json, options);
            }
            ...
            /// </exception>
            public static BranchLogCmd ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<BranchLogCmd>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out BranchLogCmd? result)
            {
                return JsonElementHelpers.TryParseValue<BranchLogCmd>(ref reader, out result);
            }
...
#if NET
            static BranchLogCmd IJsonElement<BranchLogCmd>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"BranchLogCmd: ValueKind = {ValueKind} : \"{ToString()}\"";
