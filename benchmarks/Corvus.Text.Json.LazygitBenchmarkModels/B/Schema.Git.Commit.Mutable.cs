    ...
    public readonly partial struct Git
    {
        ...
        public readonly partial struct Commit
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.LazygitBenchmark.Baseline.Schema.Git.Commit.SignOff.Mutable SignOffValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SignOffValueUtf8, out Corvus.LazygitBenchmark.Baseline.Schema.Git.Commit.SignOff.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetSignOffValue(in Corvus.LazygitBenchmark.Baseline.Schema.Git.Commit.SignOff.Source value)
                {
                    CheckValidInstance();
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.LazygitBenchmark.Baseline.Schema.Git.Commit.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.LazygitBenchmark.Baseline.Schema.Git.Commit.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.LazygitBenchmark.Baseline.Schema.Git.Commit.SignOff.Source signOff = default)
                {
                ...
                /// Creates an instance of a <see cref="Commit"/>.
                /// </summary>
                public void Create(in Corvus.LazygitBenchmark.Baseline.Schema.Git.Commit.SignOff.Source signOff = default)
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.LazygitBenchmark.Baseline.Schema.Git.Commit.SignOff.Source signOff = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
