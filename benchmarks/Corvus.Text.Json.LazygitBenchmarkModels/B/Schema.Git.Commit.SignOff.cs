...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Git
    {
        ...
        public readonly partial struct Commit
        {
            ...
            public readonly partial struct SignOff
#if NET8_0_OR_GREATER
                : IJsonElement<SignOff>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="SignOff"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal SignOff(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static SignOff DefaultInstance { get; } = ParsedJsonDocument<SignOff>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(SignOff value)
                {
                ...
                /// </returns>
                public static bool operator ==(in SignOff left, in SignOff right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in SignOff left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(SignOff instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SignOff(JsonElement instance)
                {
                    return SignOff.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SignOff From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SignOff ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<SignOff>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SignOff ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<SignOff>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SignOff ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<SignOff>(json, options);
                }
                ...
                /// </exception>
                public static SignOff ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<SignOff>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out SignOff? result)
                {
                    return JsonElementHelpers.TryParseValue<SignOff>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new SignOff(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static SignOff IJsonElement<SignOff>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SignOff: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="SignOff"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="SignOff"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public SignOff Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<SignOff>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="SignOff"/> that lives for the lifetime of its
