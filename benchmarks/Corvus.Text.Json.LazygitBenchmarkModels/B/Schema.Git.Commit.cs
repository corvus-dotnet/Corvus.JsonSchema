...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Git
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.LazygitBenchmark.Baseline.Schema.Git.Commit.SignOff SignOffValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SignOffValueUtf8, out Corvus.LazygitBenchmark.Baseline.Schema.Git.Commit.SignOff value))
                    {
                        return value;
                    }

                    return Corvus.LazygitBenchmark.Baseline.Schema.Git.Commit.SignOff.DefaultInstance;
                }
            }
