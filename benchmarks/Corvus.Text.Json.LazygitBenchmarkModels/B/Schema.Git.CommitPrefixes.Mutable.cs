    ...
    public readonly partial struct Git
    {
        ...
        public readonly partial struct CommitPrefixes
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(CommitPrefixes instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="CommitPrefixes"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator CommitPrefixes(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"CommitPrefixes.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly CommitPrefixes Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly CommitPrefixes Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<CommitPrefixes>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.LazygitBenchmark.Baseline.Schema.Git.CommitPrefixes.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(CommitPrefixes instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.LazygitBenchmark.Baseline.Schema.Git.CommitPrefixes.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<CommitPrefixes, Mutable>(this);
            }
        }
    }
}
