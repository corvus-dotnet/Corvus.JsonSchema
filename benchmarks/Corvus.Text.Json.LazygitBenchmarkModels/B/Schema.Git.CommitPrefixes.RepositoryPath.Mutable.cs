        ...
        public readonly partial struct CommitPrefixes
        {
            ...
            public readonly partial struct RepositoryPath
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(RepositoryPath instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="RepositoryPath"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RepositoryPath(Mutable instance)
                    {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.LazygitBenchmark.Baseline.Schema.Git.CommitPrefixes.RepositoryPath.Pattern.Mutable PatternValue
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PatternValueUtf8, out Corvus.LazygitBenchmark.Baseline.Schema.Git.CommitPrefixes.RepositoryPath.Pattern.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.LazygitBenchmark.Baseline.Schema.Git.CommitPrefixes.RepositoryPath.Replace.Mutable ReplaceValue
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ReplaceValueUtf8, out Corvus.LazygitBenchmark.Baseline.Schema.Git.CommitPrefixes.RepositoryPath.Replace.Mutable value))
                            {
                                return value;
                            }
                    ...
                    public void SetPatternValue(in Corvus.LazygitBenchmark.Baseline.Schema.Git.CommitPrefixes.RepositoryPath.Pattern.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetReplaceValue(in Corvus.LazygitBenchmark.Baseline.Schema.Git.CommitPrefixes.RepositoryPath.Replace.Source value)
                    {
                        CheckValidInstance();
                        ...
                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ReplaceValueUtf8, out IJsonDocument? elementParent, out int elementIdx))
                        {
                            // We are going to replace just the value
                            value.AddAsItem(ref cvb);
                            _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                        ...
                        {
                            // We are going to insert the new value
                            value.AddAsProperty(JsonPropertyNamesEscaped.ReplaceValue, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                            int endIndex = _idx + _parent.GetDbSize(_idx, false);
                            _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                        }
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RepositoryPath.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RepositoryPath Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RepositoryPath Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<RepositoryPath>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.LazygitBenchmark.Baseline.Schema.Git.CommitPrefixes.RepositoryPath.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(RepositoryPath instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.LazygitBenchmark.Baseline.Schema.Git.CommitPrefixes.RepositoryPath.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// <summary>
                    /// Creates an instance of a <see cref="RepositoryPath"/>.
                    /// </summary>
                    internal static void Create(
                        ref ComplexValueBuilder builder,
                        in Corvus.LazygitBenchmark.Baseline.Schema.Git.CommitPrefixes.RepositoryPath.Pattern.Source pattern,
                        in Corvus.LazygitBenchmark.Baseline.Schema.Git.CommitPrefixes.RepositoryPath.Replace.Source replace)
                    {
                        pattern.AddAsProperty(JsonPropertyNamesEscaped.PatternValue, ref builder, escapeName: false);
                        replace.AddAsProperty(JsonPropertyNamesEscaped.ReplaceValue, ref builder, escapeName: false);
                    }

                    /// <summary>
                    /// Creates an instance of a <see cref="RepositoryPath"/>.
                    /// </summary>
                    public void Create(in Corvus.LazygitBenchmark.Baseline.Schema.Git.CommitPrefixes.RepositoryPath.Pattern.Source pattern, in Corvus.LazygitBenchmark.Baseline.Schema.Git.CommitPrefixes.RepositoryPath.Replace.Source replace)
                    {
                        Create(ref _builder, pattern, replace);
                    }
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.LazygitBenchmark.Baseline.Schema.Git.CommitPrefixes.RepositoryPath.Pattern.Source pattern, in Corvus.LazygitBenchmark.Baseline.Schema.Git.CommitPrefixes.RepositoryPath.Replace.Source replace, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                    Builder ovb = new(cvb);
                    ovb.Create(pattern, replace);
                    cvb = ovb._builder;
                    cvb.EndObject();
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
                ...
                {
                    return workspace.CreateBuilder<RepositoryPath, Mutable>(this);
                }
            }
        }
    }
