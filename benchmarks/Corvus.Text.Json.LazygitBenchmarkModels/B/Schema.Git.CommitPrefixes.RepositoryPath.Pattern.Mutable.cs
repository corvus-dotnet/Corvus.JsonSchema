            ...
            public readonly partial struct RepositoryPath
            {
                ...
                public readonly partial struct Pattern
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(Pattern instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="Pattern"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator Pattern(Mutable instance)
                        {
                        ...
                        {
                            return
                                (obj is IJsonElement value && Equals(new Pattern(value.ParentDocument, value.ParentDocumentIndex))) ||
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"Pattern.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// <summary>
                        /// Gets a <see cref="Pattern"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </summary>
                        /// <returns>
                        /// A <see cref="Pattern"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </returns>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly Pattern Clone()
                        {
                            CheckValidInstance();
                            return _parent.CloneElement<Pattern>(_idx);
                        }
                        ...
                        /// </summary>
                        /// <returns>
                        /// An immutable <see cref="Pattern"/> that lives for the lifetime of its
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly Pattern Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<Pattern>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(Pattern instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<Pattern, Mutable>(this);
                    }
                }
            }
        }
