    ...
    public readonly partial struct Git
    {
        ...
        public readonly partial struct CommitPrefixes
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.LazygitBenchmark.Baseline.Schema.Git.CommitPrefixes.RepositoryPath.Pattern PatternValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PatternValueUtf8, out Corvus.LazygitBenchmark.Baseline.Schema.Git.CommitPrefixes.RepositoryPath.Pattern value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.LazygitBenchmark.Baseline.Schema.Git.CommitPrefixes.RepositoryPath.Replace ReplaceValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ReplaceValueUtf8, out Corvus.LazygitBenchmark.Baseline.Schema.Git.CommitPrefixes.RepositoryPath.Replace value))
                        {
                            return value;
                        }
