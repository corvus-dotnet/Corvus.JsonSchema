...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Git
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="CommitPrefixes"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal CommitPrefixes(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static CommitPrefixes DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in CommitPrefixes left, in CommitPrefixes right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in CommitPrefixes left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(CommitPrefixes instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator CommitPrefixes(JsonElement instance)
            {
                return CommitPrefixes.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CommitPrefixes From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CommitPrefixes ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CommitPrefixes>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CommitPrefixes ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CommitPrefixes>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CommitPrefixes ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CommitPrefixes>(json, options);
            }
            ...
            /// </exception>
            public static CommitPrefixes ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<CommitPrefixes>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out CommitPrefixes? result)
            {
                return JsonElementHelpers.TryParseValue<CommitPrefixes>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new CommitPrefixes(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static CommitPrefixes IJsonElement<CommitPrefixes>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"CommitPrefixes: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="CommitPrefixes"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="CommitPrefixes"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public CommitPrefixes Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<CommitPrefixes>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="CommitPrefixes"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public CommitPrefixes Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<CommitPrefixes>(_idx);
                }
