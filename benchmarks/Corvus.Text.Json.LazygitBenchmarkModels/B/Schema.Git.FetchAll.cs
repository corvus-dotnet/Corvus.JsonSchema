...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Git
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="FetchAll"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal FetchAll(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static FetchAll DefaultInstance { get; } = ParsedJsonDocument<FetchAll>.True;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(FetchAll value)
            {
            ...
            /// </returns>
            public static bool operator ==(in FetchAll left, in FetchAll right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in FetchAll left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(FetchAll instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator FetchAll(JsonElement instance)
            {
                return FetchAll.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static FetchAll From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static FetchAll ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<FetchAll>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static FetchAll ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<FetchAll>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static FetchAll ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<FetchAll>(json, options);
            }
            ...
            /// </exception>
            public static FetchAll ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<FetchAll>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out FetchAll? result)
            {
                return JsonElementHelpers.TryParseValue<FetchAll>(ref reader, out result);
            }
...
#if NET
            static FetchAll IJsonElement<FetchAll>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"FetchAll: ValueKind = {ValueKind} : \"{ToString()}\"";
