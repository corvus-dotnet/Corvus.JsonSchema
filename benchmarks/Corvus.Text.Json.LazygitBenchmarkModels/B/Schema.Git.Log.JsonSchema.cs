...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Git
    {
            ...
            : IJsonElement<Log>
        {
            ...
            {
                private static readonly JsonSchemaPathProvider OrderValueSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/order"u8, buffer, out written);
                private static readonly JsonSchemaPathProvider ShowGraphValueSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/showGraph"u8, buffer, out written);
                private static readonly JsonSchemaPathProvider ShowWholeGraphValueSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/showWholeGraph"u8, buffer, out written);

                private static void MatchOrderValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext =
                        Corvus.LazygitBenchmark.Baseline.Schema.Git.Log.Order.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.OrderValueUtf8,
                            evaluationPath: OrderValueSchemaEvaluationPath);

                    Corvus.LazygitBenchmark.Baseline.Schema.Git.Log.Order.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                    context.CommitChildContext(childContext.IsMatch, ref childContext);
                }

                private static void MatchShowGraphValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext1 =
                        Corvus.LazygitBenchmark.Baseline.Schema.Git.Log.ShowGraph.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.ShowGraphValueUtf8,
                            evaluationPath: ShowGraphValueSchemaEvaluationPath);

                    Corvus.LazygitBenchmark.Baseline.Schema.Git.Log.ShowGraph.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                    context.CommitChildContext(childContext1.IsMatch, ref childContext1);
                }

                private static void MatchShowWholeGraphValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext2 =
                        Corvus.LazygitBenchmark.Baseline.Schema.Git.Log.ShowWholeGraph.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.ShowWholeGraphValueUtf8,
                            evaluationPath: ShowWholeGraphValueSchemaEvaluationPath);

                    Corvus.LazygitBenchmark.Baseline.Schema.Git.Log.ShowWholeGraph.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
                ...
                private static PropertySchemaMatchers<Corvus.LazygitBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
                {
                    return new PropertySchemaMatchers<Corvus.LazygitBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator>([
                        (static () => JsonPropertyNames.OrderValueUtf8, MatchOrderValue),
                        (static () => JsonPropertyNames.ShowGraphValueUtf8, MatchShowGraphValue),
                        (static () => JsonPropertyNames.ShowWholeGraphValueUtf8, MatchShowWholeGraphValue),
                    ]);
                }
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://json.schemastore.org/lazygit.json#/properties/git/properties/log"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "https://json.schemastore.org/lazygit.json#/properties/git/properties/log";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://json.schemastore.org/lazygit.json#/properties/git/properties/log"u8;
