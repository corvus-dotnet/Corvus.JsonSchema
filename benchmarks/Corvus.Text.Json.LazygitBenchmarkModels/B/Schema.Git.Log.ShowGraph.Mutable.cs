        ...
        public readonly partial struct Log
        {
            ...
            public readonly partial struct ShowGraph
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(ShowGraph instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ShowGraph"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ShowGraph(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new ShowGraph(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ShowGraph.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="ShowGraph"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="ShowGraph"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ShowGraph Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<ShowGraph>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="ShowGraph"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ShowGraph Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ShowGraph>(_idx);
                    }
                    ...
                    /// <param name="matchWhenMaximised">Match 3rd item.</param>
                    ...
                    public TResult Match<TContext, TResult>(
                        ...
                        Func<TContext, TResult> matchWhenMaximised,
...
#endif
                    {
                        ...
                        {
                            return matchWhenMaximised(context);
                        }
                    ...
                    public TResult Match<TResult>(
                        ...
                        Func<TResult> matchWhenMaximised,
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(ShowGraph instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<ShowGraph, Mutable>(this);
                }
            }
        }
    }
