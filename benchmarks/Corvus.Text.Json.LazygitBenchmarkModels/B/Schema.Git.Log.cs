...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Git
    {
...
#endif
        {
            ...
            internal Log(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static Log DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.LazygitBenchmark.Baseline.Schema.Git.Log.Order OrderValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OrderValueUtf8, out Corvus.LazygitBenchmark.Baseline.Schema.Git.Log.Order value))
                    {
                        return value;
                    }

                    return Corvus.LazygitBenchmark.Baseline.Schema.Git.Log.Order.DefaultInstance;
                }
            }
            ...
            /// </para>
            /// </remarks>
            public Corvus.LazygitBenchmark.Baseline.Schema.Git.Log.ShowGraph ShowGraphValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ShowGraphValueUtf8, out Corvus.LazygitBenchmark.Baseline.Schema.Git.Log.ShowGraph value))
                    {
                        return value;
                    }

                    return Corvus.LazygitBenchmark.Baseline.Schema.Git.Log.ShowGraph.DefaultInstance;
                }
            }
            ...
            /// </para>
            /// </remarks>
            public Corvus.LazygitBenchmark.Baseline.Schema.Git.Log.ShowWholeGraph ShowWholeGraphValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ShowWholeGraphValueUtf8, out Corvus.LazygitBenchmark.Baseline.Schema.Git.Log.ShowWholeGraph value))
                    {
                        return value;
                    }

                    return Corvus.LazygitBenchmark.Baseline.Schema.Git.Log.ShowWholeGraph.DefaultInstance;
                }
            }
            ...
            /// </returns>
            public static bool operator ==(in Log left, in Log right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in Log left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(Log instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Log(JsonElement instance)
            {
                return Log.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Log From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Log ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Log>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Log ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Log>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Log ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Log>(json, options);
            }
            ...
            /// </exception>
            public static Log ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<Log>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out Log? result)
            {
                return JsonElementHelpers.TryParseValue<Log>(ref reader, out result);
            }
...
#if NET
            static Log IJsonElement<Log>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Log: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            public Log Freeze()
            {
                ...
                {
                    return mutable.FreezeElement<Log>(_idx);
                }
            ...
            {
                /// <summary>
                /// Gets the JSON property name for <see cref="OrderValue"/>.
                /// </summary>
                public const string OrderValue = "order";

                /// <summary>
                /// Gets the JSON property name for <see cref="ShowGraphValue"/>.
                /// </summary>
                public const string ShowGraphValue = "showGraph";

                /// <summary>
                /// Gets the JSON property name for <see cref="ShowWholeGraphValue"/>.
                /// </summary>
                public const string ShowWholeGraphValue = "showWholeGraph";

                /// <summary>
                /// Gets the JSON property name for <see cref="OrderValue"/>.
                /// </summary>
                public static ReadOnlySpan<byte> OrderValueUtf8 => "order"u8;

                /// <summary>
                /// Gets the JSON property name for <see cref="ShowGraphValue"/>.
                /// </summary>
                public static ReadOnlySpan<byte> ShowGraphValueUtf8 => "showGraph"u8;

                /// <summary>
                /// Gets the JSON property name for <see cref="ShowWholeGraphValue"/>.
                /// </summary>
                public static ReadOnlySpan<byte> ShowWholeGraphValueUtf8 => "showWholeGraph"u8;
            }
            ...
            {
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="OrderValue"/>.
                /// </summary>
                public static ReadOnlySpan<byte> OrderValue => "order"u8;

                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="ShowGraphValue"/>.
                /// </summary>
                public static ReadOnlySpan<byte> ShowGraphValue => "showGraph"u8;

                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="ShowWholeGraphValue"/>.
                /// </summary>
                public static ReadOnlySpan<byte> ShowWholeGraphValue => "showWholeGraph"u8;
            }
        }
    }
}
