    ...
    public readonly partial struct Git
    {
        ...
        public readonly partial struct MainBranchesEntityArray
        {
...
#endif
            {
                ...
                public Corvus.LazygitBenchmark.Baseline.Schema.Git.MainBranchesEntityArray.MainBranchesEntity.Mutable this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.LazygitBenchmark.Baseline.Schema.Git.MainBranchesEntityArray.MainBranchesEntity.Mutable>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.LazygitBenchmark.Baseline.Schema.Git.MainBranchesEntityArray.MainBranchesEntity.Mutable> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.LazygitBenchmark.Baseline.Schema.Git.MainBranchesEntityArray.MainBranchesEntity.Mutable>(_parent, _idx);
                }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetItem(int itemIndex, in Corvus.LazygitBenchmark.Baseline.Schema.Git.MainBranchesEntityArray.MainBranchesEntity.Source value)
                {
                    CheckValidInstance();
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void InsertItem(int itemIndex, in Corvus.LazygitBenchmark.Baseline.Schema.Git.MainBranchesEntityArray.MainBranchesEntity.Source value)
                {
                    CheckValidInstance();
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void AddItem(in Corvus.LazygitBenchmark.Baseline.Schema.Git.MainBranchesEntityArray.MainBranchesEntity.Source value)
                {
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Remove(in Corvus.LazygitBenchmark.Baseline.Schema.Git.MainBranchesEntityArray.MainBranchesEntity item)
                {
                    CheckValidInstance();
                    if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.LazygitBenchmark.Baseline.Schema.Git.MainBranchesEntityArray.MainBranchesEntity>(this, in item))
                    {
                        return false;
                    }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void RemoveWhere(JsonPredicate<Corvus.LazygitBenchmark.Baseline.Schema.Git.MainBranchesEntityArray.MainBranchesEntity> predicate)
                {
                    CheckValidInstance();
                    JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.LazygitBenchmark.Baseline.Schema.Git.MainBranchesEntityArray.MainBranchesEntity>(this, predicate);
                    _documentVersion = _parent.Version;
                }
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Replace(in Corvus.LazygitBenchmark.Baseline.Schema.Git.MainBranchesEntityArray.MainBranchesEntity oldItem, in Corvus.LazygitBenchmark.Baseline.Schema.Git.MainBranchesEntityArray.MainBranchesEntity.Source newItem)
                {
                    CheckValidInstance();
                    ...
                    var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.LazygitBenchmark.Baseline.Schema.Git.MainBranchesEntityArray.MainBranchesEntity>(_parent, _idx);

                    while (enumerator.MoveNext())
                    {
                        Corvus.LazygitBenchmark.Baseline.Schema.Git.MainBranchesEntityArray.MainBranchesEntity current = enumerator.Current;
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.LazygitBenchmark.Baseline.Schema.Git.MainBranchesEntityArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.LazygitBenchmark.Baseline.Schema.Git.MainBranchesEntityArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
