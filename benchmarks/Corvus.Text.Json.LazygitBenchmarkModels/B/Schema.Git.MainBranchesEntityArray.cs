...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Git
    {
...
#endif
        {
            ...
            public Corvus.LazygitBenchmark.Baseline.Schema.Git.MainBranchesEntityArray.MainBranchesEntity this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.LazygitBenchmark.Baseline.Schema.Git.MainBranchesEntityArray.MainBranchesEntity>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.LazygitBenchmark.Baseline.Schema.Git.MainBranchesEntityArray.MainBranchesEntity> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.LazygitBenchmark.Baseline.Schema.Git.MainBranchesEntityArray.MainBranchesEntity>(_parent, _idx);
            }
