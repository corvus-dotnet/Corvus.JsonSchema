...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Git
    {
        ...
        public readonly partial struct Merging
        {
            ...
            public readonly partial struct ManualCommit
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(ManualCommit instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ManualCommit"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ManualCommit(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new ManualCommit(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ManualCommit.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="ManualCommit"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="ManualCommit"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ManualCommit Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<ManualCommit>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="ManualCommit"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ManualCommit Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ManualCommit>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(ManualCommit instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<ManualCommit, Mutable>(this);
                }
            }
        }
    }
