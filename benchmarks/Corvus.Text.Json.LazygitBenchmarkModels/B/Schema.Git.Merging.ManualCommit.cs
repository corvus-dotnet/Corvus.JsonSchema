    ...
    public readonly partial struct Git
    {
        ...
        public readonly partial struct Merging
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="ManualCommit"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal ManualCommit(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static ManualCommit DefaultInstance { get; } = ParsedJsonDocument<ManualCommit>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(ManualCommit value)
                {
                ...
                /// </returns>
                public static bool operator ==(in ManualCommit left, in ManualCommit right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in ManualCommit left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(ManualCommit instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ManualCommit(JsonElement instance)
                {
                    return ManualCommit.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ManualCommit From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ManualCommit ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ManualCommit>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ManualCommit ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ManualCommit>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ManualCommit ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ManualCommit>(json, options);
                }
                ...
                /// </exception>
                public static ManualCommit ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<ManualCommit>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out ManualCommit? result)
                {
                    return JsonElementHelpers.TryParseValue<ManualCommit>(ref reader, out result);
                }
...
#if NET
                static ManualCommit IJsonElement<ManualCommit>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ManualCommit: ValueKind = {ValueKind} : \"{ToString()}\"";
