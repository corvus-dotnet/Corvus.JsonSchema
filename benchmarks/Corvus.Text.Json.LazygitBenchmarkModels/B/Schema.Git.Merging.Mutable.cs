    ...
    public readonly partial struct Git
    {
        ...
        public readonly partial struct Merging
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.LazygitBenchmark.Baseline.Schema.Git.Merging.Arguments.Mutable Args
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ArgsUtf8, out Corvus.LazygitBenchmark.Baseline.Schema.Git.Merging.Arguments.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.LazygitBenchmark.Baseline.Schema.Git.Merging.ManualCommit.Mutable ManualCommitValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ManualCommitValueUtf8, out Corvus.LazygitBenchmark.Baseline.Schema.Git.Merging.ManualCommit.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetArgs(in Corvus.LazygitBenchmark.Baseline.Schema.Git.Merging.Arguments.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetManualCommitValue(in Corvus.LazygitBenchmark.Baseline.Schema.Git.Merging.ManualCommit.Source value)
                {
                    CheckValidInstance();
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.LazygitBenchmark.Baseline.Schema.Git.Merging.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.LazygitBenchmark.Baseline.Schema.Git.Merging.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.LazygitBenchmark.Baseline.Schema.Git.Merging.Arguments.Source args = default,
                    in Corvus.LazygitBenchmark.Baseline.Schema.Git.Merging.ManualCommit.Source manualCommit = default)
                {
                ...
                /// Creates an instance of a <see cref="Merging"/>.
                /// </summary>
                public void Create(in Corvus.LazygitBenchmark.Baseline.Schema.Git.Merging.Arguments.Source args = default, in Corvus.LazygitBenchmark.Baseline.Schema.Git.Merging.ManualCommit.Source manualCommit = default)
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.LazygitBenchmark.Baseline.Schema.Git.Merging.Arguments.Source args = default, in Corvus.LazygitBenchmark.Baseline.Schema.Git.Merging.ManualCommit.Source manualCommit = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
