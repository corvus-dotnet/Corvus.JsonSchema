...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Git
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.LazygitBenchmark.Baseline.Schema.Git.Merging.Arguments Args
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ArgsUtf8, out Corvus.LazygitBenchmark.Baseline.Schema.Git.Merging.Arguments value))
                    {
                        return value;
                    }

                    return Corvus.LazygitBenchmark.Baseline.Schema.Git.Merging.Arguments.DefaultInstance;
                }
            }
            ...
            /// </para>
            /// </remarks>
            public Corvus.LazygitBenchmark.Baseline.Schema.Git.Merging.ManualCommit ManualCommitValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ManualCommitValueUtf8, out Corvus.LazygitBenchmark.Baseline.Schema.Git.Merging.ManualCommit value))
                    {
                        return value;
                    }

                    return Corvus.LazygitBenchmark.Baseline.Schema.Git.Merging.ManualCommit.DefaultInstance;
                }
            }
