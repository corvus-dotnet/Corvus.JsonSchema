    ...
    public readonly partial struct Git
    {
        ...
        public readonly partial struct OverrideGpg
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(OverrideGpg instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="OverrideGpg"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator OverrideGpg(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"OverrideGpg.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly OverrideGpg Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly OverrideGpg Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<OverrideGpg>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(OverrideGpg instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<OverrideGpg, Mutable>(this);
            }
        }
    }
}
