        ...
        public readonly partial struct Paging
        {
            ...
            public readonly partial struct ColorArgument
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(ColorArgument instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ColorArgument"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ColorArgument(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ColorArgument.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ColorArgument Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ColorArgument Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ColorArgument>(_idx);
                    }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(ColorArgument instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<ColorArgument, Mutable>(this);
                }
            }
        }
    }
