        ...
        public readonly partial struct Paging
        {
            ...
            public readonly partial struct Pager
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(Pager instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="Pager"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Pager(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"Pager.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly Pager Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<Pager>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(Pager instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<Pager, Mutable>(this);
                }
            }
        }
    }
