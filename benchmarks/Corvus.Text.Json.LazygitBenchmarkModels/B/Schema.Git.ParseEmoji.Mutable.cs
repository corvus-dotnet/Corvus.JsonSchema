    ...
    public readonly partial struct Git
    {
        ...
        public readonly partial struct ParseEmoji
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ParseEmoji instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ParseEmoji"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ParseEmoji(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ParseEmoji.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ParseEmoji Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ParseEmoji Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ParseEmoji>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ParseEmoji instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ParseEmoji, Mutable>(this);
            }
        }
    }
}
