...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Gui
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="AnimateExplosion"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal AnimateExplosion(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static AnimateExplosion DefaultInstance { get; } = ParsedJsonDocument<AnimateExplosion>.True;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(AnimateExplosion value)
            {
            ...
            /// </returns>
            public static bool operator ==(in AnimateExplosion left, in AnimateExplosion right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in AnimateExplosion left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(AnimateExplosion instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AnimateExplosion(JsonElement instance)
            {
                return AnimateExplosion.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AnimateExplosion From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AnimateExplosion ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AnimateExplosion>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AnimateExplosion ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AnimateExplosion>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AnimateExplosion ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AnimateExplosion>(json, options);
            }
            ...
            /// </exception>
            public static AnimateExplosion ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<AnimateExplosion>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out AnimateExplosion? result)
            {
                return JsonElementHelpers.TryParseValue<AnimateExplosion>(ref reader, out result);
            }
...
#if NET
            static AnimateExplosion IJsonElement<AnimateExplosion>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AnimateExplosion: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public AnimateExplosion Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<AnimateExplosion>(_idx);
                }
