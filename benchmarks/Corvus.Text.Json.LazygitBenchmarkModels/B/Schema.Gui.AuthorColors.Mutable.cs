    ...
    public readonly partial struct Gui
    {
        ...
        public readonly partial struct AuthorColors
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(AuthorColors instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="AuthorColors"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AuthorColors(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AuthorColors.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly AuthorColors Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly AuthorColors Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<AuthorColors>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.LazygitBenchmark.Baseline.Schema.Gui.AuthorColors.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(AuthorColors instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.LazygitBenchmark.Baseline.Schema.Gui.AuthorColors.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<AuthorColors, Mutable>(this);
            }
        }
    }
}
