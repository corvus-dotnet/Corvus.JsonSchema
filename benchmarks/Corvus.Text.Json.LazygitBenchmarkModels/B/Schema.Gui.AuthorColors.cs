...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Gui
    {
        ...
        public readonly partial struct AuthorColors
#if NET8_0_OR_GREATER
            : IJsonElement<AuthorColors>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="AuthorColors"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal AuthorColors(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static AuthorColors DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in AuthorColors left, in AuthorColors right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in AuthorColors left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(AuthorColors instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AuthorColors(JsonElement instance)
            {
                return AuthorColors.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AuthorColors From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AuthorColors ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AuthorColors>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AuthorColors ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AuthorColors>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AuthorColors ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AuthorColors>(json, options);
            }
            ...
            /// </exception>
            public static AuthorColors ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<AuthorColors>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out AuthorColors? result)
            {
                return JsonElementHelpers.TryParseValue<AuthorColors>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new AuthorColors(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static AuthorColors IJsonElement<AuthorColors>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AuthorColors: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="AuthorColors"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="AuthorColors"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public AuthorColors Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<AuthorColors>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="AuthorColors"/> that lives for the lifetime of its
