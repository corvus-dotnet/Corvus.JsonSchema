...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Gui
    {
        ...
        public readonly partial struct CommitLength
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(CommitLength instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="CommitLength"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator CommitLength(Mutable instance)
                {
                ...
                /// <summary>
                /// Gets the (optional) <c>show</c> property.
                /// show
                /// </summary>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public Corvus.LazygitBenchmark.Baseline.Schema.Gui.CommitLength.Show.Mutable ShowValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ShowValueUtf8, out Corvus.LazygitBenchmark.Baseline.Schema.Gui.CommitLength.Show.Mutable value))
                        {
                            return value;
                        }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new CommitLength(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                /// <summary>
                /// Set the <c>show</c> property.
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetShowValue(in Corvus.LazygitBenchmark.Baseline.Schema.Gui.CommitLength.Show.Source value)
                {
                    CheckValidInstance();

                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ShowValueUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ShowValueUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                    ...
                    else
                    {
                        ...
                        value.AddAsProperty(JsonPropertyNamesEscaped.ShowValue, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                ...
                /// <summary>
                /// Remove the <c>show</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveShowValue()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ShowValueUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"CommitLength.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="CommitLength"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="CommitLength"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly CommitLength Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<CommitLength>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="CommitLength"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly CommitLength Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<CommitLength>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.LazygitBenchmark.Baseline.Schema.Gui.CommitLength.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(CommitLength instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.LazygitBenchmark.Baseline.Schema.Gui.CommitLength.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="CommitLength"/>.
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.LazygitBenchmark.Baseline.Schema.Gui.CommitLength.Show.Source show = default)
                {
                    show.AddAsProperty(JsonPropertyNamesEscaped.ShowValue, ref builder, escapeName: false);
                }

                /// <summary>
                /// Creates an instance of a <see cref="CommitLength"/>.
                /// </summary>
                public void Create(in Corvus.LazygitBenchmark.Baseline.Schema.Gui.CommitLength.Show.Source show = default)
                {
                    Create(ref _builder, show);
                }
            ...
            /// </summary>
            /// <param name="workspace">The JSON workspace.</param>
            /// <param name="show">The value of the property.</param>
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.LazygitBenchmark.Baseline.Schema.Gui.CommitLength.Show.Source show = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            {
                return workspace.CreateBuilder<CommitLength, Mutable>(this);
            }
        }
    }
}
