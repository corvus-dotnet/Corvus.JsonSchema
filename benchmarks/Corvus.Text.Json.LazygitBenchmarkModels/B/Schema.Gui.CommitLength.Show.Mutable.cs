        ...
        public readonly partial struct CommitLength
        {
            ...
            public readonly partial struct Show
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(Show instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="Show"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Show(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"Show.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly Show Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<Show>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(Show instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<Show, Mutable>(this);
                }
            }
        }
    }
