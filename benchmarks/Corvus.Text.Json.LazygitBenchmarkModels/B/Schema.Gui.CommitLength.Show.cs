    ...
    public readonly partial struct Gui
    {
        ...
        public readonly partial struct CommitLength
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="Show"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal Show(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static Show DefaultInstance { get; } = ParsedJsonDocument<Show>.True;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(Show value)
                {
                ...
                /// </returns>
                public static bool operator ==(in Show left, in Show right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in Show left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(Show instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Show(JsonElement instance)
                {
                    return Show.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Show From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Show ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<Show>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Show ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<Show>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Show ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<Show>(json, options);
                }
                ...
                /// </exception>
                public static Show ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<Show>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out Show? result)
                {
                    return JsonElementHelpers.TryParseValue<Show>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new Show(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static Show IJsonElement<Show>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Show: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="Show"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="Show"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                {
                    CheckValidInstance();
                    return _parent.CloneElement<Show>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="Show"/> that lives for the lifetime of its
                ...
                public Show Freeze()
                {
                    ...
                    {
                        return mutable.FreezeElement<Show>(_idx);
                    }
