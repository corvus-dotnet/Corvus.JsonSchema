...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Gui
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.LazygitBenchmark.Baseline.Schema.Gui.CommitLength.Show ShowValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ShowValueUtf8, out Corvus.LazygitBenchmark.Baseline.Schema.Gui.CommitLength.Show value))
                    {
                        return value;
                    }

                    return Corvus.LazygitBenchmark.Baseline.Schema.Gui.CommitLength.Show.DefaultInstance;
                }
            }
