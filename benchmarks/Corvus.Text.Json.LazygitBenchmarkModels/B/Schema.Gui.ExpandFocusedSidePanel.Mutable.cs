...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Gui
    {
        ...
        public readonly partial struct ExpandFocusedSidePanel
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ExpandFocusedSidePanel instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ExpandFocusedSidePanel"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ExpandFocusedSidePanel(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ExpandFocusedSidePanel(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ExpandFocusedSidePanel.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ExpandFocusedSidePanel"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ExpandFocusedSidePanel"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ExpandFocusedSidePanel Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ExpandFocusedSidePanel>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ExpandFocusedSidePanel"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ExpandFocusedSidePanel Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ExpandFocusedSidePanel>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ExpandFocusedSidePanel instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ExpandFocusedSidePanel, Mutable>(this);
            }
        }
    }
}
