...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Gui
    {
        ...
        public readonly partial struct ExpandFocusedSidePanel
            ...
            : IJsonElement<ExpandFocusedSidePanel>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ExpandFocusedSidePanel"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ExpandFocusedSidePanel(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ExpandFocusedSidePanel DefaultInstance { get; } = ParsedJsonDocument<ExpandFocusedSidePanel>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(ExpandFocusedSidePanel value)
            {
            ...
            /// </returns>
            public static bool operator ==(in ExpandFocusedSidePanel left, in ExpandFocusedSidePanel right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ExpandFocusedSidePanel left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ExpandFocusedSidePanel instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ExpandFocusedSidePanel(JsonElement instance)
            {
                return ExpandFocusedSidePanel.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ExpandFocusedSidePanel From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ExpandFocusedSidePanel ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ExpandFocusedSidePanel>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ExpandFocusedSidePanel ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ExpandFocusedSidePanel>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ExpandFocusedSidePanel ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ExpandFocusedSidePanel>(json, options);
            }
            ...
            /// </exception>
            public static ExpandFocusedSidePanel ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ExpandFocusedSidePanel>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ExpandFocusedSidePanel? result)
            {
                return JsonElementHelpers.TryParseValue<ExpandFocusedSidePanel>(ref reader, out result);
            }
...
#if NET
            static ExpandFocusedSidePanel IJsonElement<ExpandFocusedSidePanel>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ExpandFocusedSidePanel: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public ExpandFocusedSidePanel Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public ExpandFocusedSidePanel Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ExpandFocusedSidePanel>(_idx);
                }
