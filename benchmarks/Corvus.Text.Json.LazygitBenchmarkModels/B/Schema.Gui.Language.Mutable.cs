    ...
    public readonly partial struct Gui
    {
        ...
        public readonly partial struct Language
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(Language instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="Language"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Language(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Language.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly Language Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly Language Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<Language>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(Language instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<Language, Mutable>(this);
            }
        }
    }
}
