...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Gui
    {
        ...
        public readonly partial struct MouseEvents
#if NET8_0_OR_GREATER
            : IJsonElement<MouseEvents>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="MouseEvents"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal MouseEvents(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static MouseEvents DefaultInstance { get; } = ParsedJsonDocument<MouseEvents>.True;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(MouseEvents value)
            {
            ...
            /// </returns>
            public static bool operator ==(in MouseEvents left, in MouseEvents right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in MouseEvents left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(MouseEvents instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MouseEvents(JsonElement instance)
            {
                return MouseEvents.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MouseEvents From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MouseEvents ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MouseEvents>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MouseEvents ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MouseEvents>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MouseEvents ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MouseEvents>(json, options);
            }
            ...
            /// </exception>
            public static MouseEvents ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<MouseEvents>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out MouseEvents? result)
            {
                return JsonElementHelpers.TryParseValue<MouseEvents>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new MouseEvents(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static MouseEvents IJsonElement<MouseEvents>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MouseEvents: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="MouseEvents"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="MouseEvents"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public MouseEvents Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<MouseEvents>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="MouseEvents"/> that lives for the lifetime of its
