    ...
    public readonly partial struct Gui
    {
        ...
        public readonly partial struct ShortTimeFormat
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ShortTimeFormat instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ShortTimeFormat"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ShortTimeFormat(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ShortTimeFormat.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ShortTimeFormat Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ShortTimeFormat Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ShortTimeFormat>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ShortTimeFormat instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ShortTimeFormat, Mutable>(this);
            }
        }
    }
}
