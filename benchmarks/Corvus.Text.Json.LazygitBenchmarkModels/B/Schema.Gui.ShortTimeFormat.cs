...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Gui
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ShortTimeFormat"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ShortTimeFormat(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ShortTimeFormat DefaultInstance { get; } = ParsedJsonDocument<ShortTimeFormat>.StringConstant([.."\"3:04PM\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(ShortTimeFormat value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in ShortTimeFormat left, in ShortTimeFormat right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ShortTimeFormat left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ShortTimeFormat instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ShortTimeFormat(JsonElement instance)
            {
                return ShortTimeFormat.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ShortTimeFormat From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ShortTimeFormat ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ShortTimeFormat>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ShortTimeFormat ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ShortTimeFormat>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ShortTimeFormat ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ShortTimeFormat>(json, options);
            }
            ...
            /// </exception>
            public static ShortTimeFormat ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ShortTimeFormat>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ShortTimeFormat? result)
            {
                return JsonElementHelpers.TryParseValue<ShortTimeFormat>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ShortTimeFormat(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static ShortTimeFormat IJsonElement<ShortTimeFormat>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ShortTimeFormat: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ShortTimeFormat"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ShortTimeFormat"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public ShortTimeFormat Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ShortTimeFormat>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ShortTimeFormat"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public ShortTimeFormat Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ShortTimeFormat>(_idx);
                }
