    ...
    public readonly partial struct Gui
    {
        ...
        public readonly partial struct ShowBottomLine
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ShowBottomLine instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ShowBottomLine"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ShowBottomLine(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ShowBottomLine.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ShowBottomLine Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ShowBottomLine Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ShowBottomLine>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ShowBottomLine instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ShowBottomLine, Mutable>(this);
            }
        }
    }
}
