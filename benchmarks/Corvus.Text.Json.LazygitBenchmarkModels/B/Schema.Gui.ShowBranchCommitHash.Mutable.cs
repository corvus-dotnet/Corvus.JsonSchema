...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Gui
    {
        ...
        public readonly partial struct ShowBranchCommitHash
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ShowBranchCommitHash instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ShowBranchCommitHash"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ShowBranchCommitHash(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ShowBranchCommitHash(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ShowBranchCommitHash.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ShowBranchCommitHash"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ShowBranchCommitHash"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ShowBranchCommitHash Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ShowBranchCommitHash>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ShowBranchCommitHash"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ShowBranchCommitHash Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ShowBranchCommitHash>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ShowBranchCommitHash instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ShowBranchCommitHash, Mutable>(this);
            }
        }
    }
}
