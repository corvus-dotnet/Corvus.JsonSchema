    ...
    public readonly partial struct Gui
    {
        ...
        public readonly partial struct ShowCommandLog
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ShowCommandLog instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ShowCommandLog"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ShowCommandLog(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ShowCommandLog.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ShowCommandLog Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ShowCommandLog Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ShowCommandLog>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ShowCommandLog instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ShowCommandLog, Mutable>(this);
            }
        }
    }
}
