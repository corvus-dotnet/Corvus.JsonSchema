...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Gui
    {
        ...
        public readonly partial struct SkipRewordInEditorWarning
#if NET8_0_OR_GREATER
            : IJsonElement<SkipRewordInEditorWarning>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="SkipRewordInEditorWarning"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal SkipRewordInEditorWarning(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static SkipRewordInEditorWarning DefaultInstance { get; } = ParsedJsonDocument<SkipRewordInEditorWarning>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(SkipRewordInEditorWarning value)
            {
            ...
            /// </returns>
            public static bool operator ==(in SkipRewordInEditorWarning left, in SkipRewordInEditorWarning right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in SkipRewordInEditorWarning left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(SkipRewordInEditorWarning instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SkipRewordInEditorWarning(JsonElement instance)
            {
                return SkipRewordInEditorWarning.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SkipRewordInEditorWarning From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SkipRewordInEditorWarning ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SkipRewordInEditorWarning>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SkipRewordInEditorWarning ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SkipRewordInEditorWarning>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SkipRewordInEditorWarning ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SkipRewordInEditorWarning>(json, options);
            }
            ...
            /// </exception>
            public static SkipRewordInEditorWarning ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<SkipRewordInEditorWarning>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out SkipRewordInEditorWarning? result)
            {
                return JsonElementHelpers.TryParseValue<SkipRewordInEditorWarning>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new SkipRewordInEditorWarning(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static SkipRewordInEditorWarning IJsonElement<SkipRewordInEditorWarning>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SkipRewordInEditorWarning: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="SkipRewordInEditorWarning"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="SkipRewordInEditorWarning"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public SkipRewordInEditorWarning Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<SkipRewordInEditorWarning>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="SkipRewordInEditorWarning"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public SkipRewordInEditorWarning Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<SkipRewordInEditorWarning>(_idx);
                }
