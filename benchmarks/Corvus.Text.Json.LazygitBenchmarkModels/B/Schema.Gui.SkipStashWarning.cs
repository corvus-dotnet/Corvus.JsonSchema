...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Gui
    {
        ...
        public readonly partial struct SkipStashWarning
#if NET8_0_OR_GREATER
            : IJsonElement<SkipStashWarning>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="SkipStashWarning"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal SkipStashWarning(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static SkipStashWarning DefaultInstance { get; } = ParsedJsonDocument<SkipStashWarning>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(SkipStashWarning value)
            {
            ...
            /// </returns>
            public static bool operator ==(in SkipStashWarning left, in SkipStashWarning right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in SkipStashWarning left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(SkipStashWarning instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SkipStashWarning(JsonElement instance)
            {
                return SkipStashWarning.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SkipStashWarning From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SkipStashWarning ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SkipStashWarning>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SkipStashWarning ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SkipStashWarning>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SkipStashWarning ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SkipStashWarning>(json, options);
            }
            ...
            /// </exception>
            public static SkipStashWarning ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<SkipStashWarning>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out SkipStashWarning? result)
            {
                return JsonElementHelpers.TryParseValue<SkipStashWarning>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new SkipStashWarning(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static SkipStashWarning IJsonElement<SkipStashWarning>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SkipStashWarning: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="SkipStashWarning"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="SkipStashWarning"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public SkipStashWarning Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<SkipStashWarning>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="SkipStashWarning"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public SkipStashWarning Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<SkipStashWarning>(_idx);
                }
