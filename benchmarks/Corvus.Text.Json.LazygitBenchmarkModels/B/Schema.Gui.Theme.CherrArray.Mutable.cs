        ...
        public readonly partial struct Theme
        {
            ...
            public readonly partial struct CherrArray
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(CherrArray instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="CherrArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator CherrArray(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"CherrArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    /// <summary>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly CherrArray Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly CherrArray Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<CherrArray>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.LazygitBenchmark.Baseline.Schema.Gui.Theme.CherrArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(CherrArray instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.LazygitBenchmark.Baseline.Schema.Gui.Theme.CherrArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
                ...
                {
                    return workspace.CreateBuilder<CherrArray, Mutable>(this);
                }
            }
        }
    }
