...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Gui
    {
        ...
        public readonly partial struct Theme
        {
            ...
            public readonly partial struct OptioArray
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(OptioArray instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="OptioArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator OptioArray(Mutable instance)
                    {
                    ...
                    public Corvus.LazygitBenchmark.Baseline.Schema.Color.Mutable this[int index]
                    {
                        get
                        {
                            CheckValidInstance();
                            return _parent.GetArrayIndexElement<Corvus.LazygitBenchmark.Baseline.Schema.Color.Mutable>(_idx, index);
                        }
                    }
                    ...
                    /// </summary>
                    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                    public ArrayEnumerator<Corvus.LazygitBenchmark.Baseline.Schema.Color.Mutable> EnumerateArray()
                    {
                        CheckValidInstance();
                        return EnumeratorCreator.CreateArrayEnumerator<Corvus.LazygitBenchmark.Baseline.Schema.Color.Mutable>(_parent, _idx);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new OptioArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"OptioArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    /// <summary>
                    ...
                    /// </remarks>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void SetItem(int itemIndex, in Corvus.LazygitBenchmark.Baseline.Schema.Color.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </remarks>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void InsertItem(int itemIndex, in Corvus.LazygitBenchmark.Baseline.Schema.Color.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void AddItem(in Corvus.LazygitBenchmark.Baseline.Schema.Color.Source value)
                    {
                    ...
                    ///   The parent <see cref="JsonDocument"/> has been disposed.
                    /// </exception>
                    public bool Remove(in Corvus.LazygitBenchmark.Baseline.Schema.Color item)
                    {
                        CheckValidInstance();
                        if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.LazygitBenchmark.Baseline.Schema.Color>(this, in item))
                        {
                            return false;
                        }
                    ...
                    /// </remarks>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void RemoveWhere(JsonPredicate<Corvus.LazygitBenchmark.Baseline.Schema.Color> predicate)
                    {
                        CheckValidInstance();
                        JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.LazygitBenchmark.Baseline.Schema.Color>(this, predicate);
                        _documentVersion = _parent.Version;
                    }
                    ...
                    ///   The parent <see cref="JsonDocument"/> has been disposed.
                    /// </exception>
                    public bool Replace(in Corvus.LazygitBenchmark.Baseline.Schema.Color oldItem, in Corvus.LazygitBenchmark.Baseline.Schema.Color.Source newItem)
                    {
                        CheckValidInstance();
                        ...
                        var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.LazygitBenchmark.Baseline.Schema.Color>(_parent, _idx);

                        while (enumerator.MoveNext())
                        {
                            Corvus.LazygitBenchmark.Baseline.Schema.Color current = enumerator.Current;
                    ...
                    /// <summary>
                    /// Gets a <see cref="OptioArray"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="OptioArray"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly OptioArray Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<OptioArray>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="OptioArray"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly OptioArray Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<OptioArray>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.LazygitBenchmark.Baseline.Schema.Gui.Theme.OptioArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(OptioArray instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.LazygitBenchmark.Baseline.Schema.Gui.Theme.OptioArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
                ...
                {
                    return workspace.CreateBuilder<OptioArray, Mutable>(this);
                }
            }
        }
    }
