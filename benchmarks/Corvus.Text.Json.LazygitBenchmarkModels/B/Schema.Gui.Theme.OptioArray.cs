    ...
    public readonly partial struct Gui
    {
        ...
        public readonly partial struct Theme
        {
...
#endif
            {
                ...
                public Corvus.LazygitBenchmark.Baseline.Schema.Color this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.LazygitBenchmark.Baseline.Schema.Color>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.LazygitBenchmark.Baseline.Schema.Color> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.LazygitBenchmark.Baseline.Schema.Color>(_parent, _idx);
                }
