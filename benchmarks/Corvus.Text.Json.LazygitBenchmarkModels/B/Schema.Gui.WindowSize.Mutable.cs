...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Gui
    {
        ...
        public readonly partial struct WindowSize
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(WindowSize instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="WindowSize"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator WindowSize(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new WindowSize(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"WindowSize.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="WindowSize"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="WindowSize"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly WindowSize Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<WindowSize>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="WindowSize"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly WindowSize Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<WindowSize>(_idx);
                }
                ...
                /// <param name="matchNormal">Match 1st item.</param>
                /// <param name="matchHalf">Match 2nd item.</param>
                /// <param name="matchFull">Match 3rd item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> matchNormal,
                    Func<TContext, TResult> matchHalf,
...
#endif
                {
                    ...
                    {
                        return matchNormal(context);
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchHalf(context);
                    }
                ...
                public TResult Match<TResult>(
                    Func<TResult> matchNormal,
                    Func<TResult> matchHalf,
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(WindowSize instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<WindowSize, Mutable>(this);
            }
        }
    }
}
