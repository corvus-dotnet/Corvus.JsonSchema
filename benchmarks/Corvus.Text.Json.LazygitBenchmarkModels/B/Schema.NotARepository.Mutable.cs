...
public readonly partial struct Schema
{
    ...
    public readonly partial struct NotARepository
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(NotARepository instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="NotARepository"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator NotARepository(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"NotARepository.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly NotARepository Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly NotARepository Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<NotARepository>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(NotARepository instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<NotARepository, Mutable>(this);
        }
    }
}
