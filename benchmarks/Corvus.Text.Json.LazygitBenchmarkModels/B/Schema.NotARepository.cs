...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NotARepository"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal NotARepository(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static NotARepository DefaultInstance { get; } = ParsedJsonDocument<NotARepository>.StringConstant([.."\"prompt\""u8]);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(NotARepository value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in NotARepository left, in NotARepository right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in NotARepository left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(NotARepository instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator NotARepository(JsonElement instance)
        {
            return NotARepository.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static NotARepository From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static NotARepository ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<NotARepository>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static NotARepository ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<NotARepository>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static NotARepository ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<NotARepository>(json, options);
        }
        ...
        /// </exception>
        public static NotARepository ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<NotARepository>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out NotARepository? result)
        {
            return JsonElementHelpers.TryParseValue<NotARepository>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new NotARepository(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static NotARepository IJsonElement<NotARepository>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"NotARepository: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="NotARepository"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="NotARepository"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public NotARepository Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<NotARepository>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="NotARepository"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public NotARepository Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<NotARepository>(_idx);
            }
        ...
        /// <param name="matchPrompt">Match 1st item.</param>
        /// <param name="matchCreate">Match 2nd item.</param>
        /// <param name="matchSkip">Match 3rd item.</param>
        /// <param name="matchQuit">Match 4th item.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Func<TContext, TResult> matchPrompt,
            Func<TContext, TResult> matchCreate,
            Func<TContext, TResult> matchSkip,
            Func<TContext, TResult> matchQuit,
        ...
        public TResult Match<TResult>(
            Func<TResult> matchPrompt,
            Func<TResult> matchCreate,
            Func<TResult> matchSkip,
            Func<TResult> matchQuit,
