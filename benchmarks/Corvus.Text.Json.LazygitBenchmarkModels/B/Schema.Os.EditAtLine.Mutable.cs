    ...
    public readonly partial struct Os
    {
        ...
        public readonly partial struct EditAtLine
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(EditAtLine instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="EditAtLine"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator EditAtLine(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"EditAtLine.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly EditAtLine Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly EditAtLine Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<EditAtLine>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(EditAtLine instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<EditAtLine, Mutable>(this);
            }
        }
    }
}
