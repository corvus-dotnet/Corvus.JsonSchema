...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Os
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="EditAtLine"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal EditAtLine(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static EditAtLine DefaultInstance { get; } = ParsedJsonDocument<EditAtLine>.StringConstant([.."\"\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(EditAtLine value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in EditAtLine left, in EditAtLine right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in EditAtLine left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(EditAtLine instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EditAtLine(JsonElement instance)
            {
                return EditAtLine.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EditAtLine From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EditAtLine ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EditAtLine>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EditAtLine ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EditAtLine>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EditAtLine ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EditAtLine>(json, options);
            }
            ...
            /// </exception>
            public static EditAtLine ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<EditAtLine>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out EditAtLine? result)
            {
                return JsonElementHelpers.TryParseValue<EditAtLine>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new EditAtLine(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static EditAtLine IJsonElement<EditAtLine>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EditAtLine: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="EditAtLine"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="EditAtLine"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public EditAtLine Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<EditAtLine>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="EditAtLine"/> that lives for the lifetime of its
