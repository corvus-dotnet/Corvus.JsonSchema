    ...
    public readonly partial struct Os
    {
        ...
        public readonly partial struct EditPreset
        {
...
#endif
            {
                ...
                public static explicit operator Corvus.LazygitBenchmark.Baseline.Schema.Os.EditPreset.OneOf0Entity.Mutable(Mutable value)
                {
                    return Corvus.LazygitBenchmark.Baseline.Schema.Os.EditPreset.OneOf0Entity.Mutable.From(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.LazygitBenchmark.Baseline.Schema.Os.EditPreset.OneOf0Entity.Mutable value)
                {
                    return From(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static explicit operator Corvus.LazygitBenchmark.Baseline.Schema.Os.EditPreset.OneOf1Entity.Mutable(Mutable value)
                {
                    return Corvus.LazygitBenchmark.Baseline.Schema.Os.EditPreset.OneOf1Entity.Mutable.From(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.LazygitBenchmark.Baseline.Schema.Os.EditPreset.OneOf1Entity.Mutable value)
                {
                    return From(value);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.LazygitBenchmark.Baseline.Schema.Os.EditPreset.Mutable, TContext, TResult> defaultMatch)
...
#endif
                {
                    ...
                    {
                        return matchOneOf0Entity(Corvus.LazygitBenchmark.Baseline.Schema.Os.EditPreset.OneOf0Entity.Mutable.From(this), context);
                    }

                    if (Corvus.LazygitBenchmark.Baseline.Schema.Os.EditPreset.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchOneOf1Entity(Corvus.LazygitBenchmark.Baseline.Schema.Os.EditPreset.OneOf1Entity.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.LazygitBenchmark.Baseline.Schema.Os.EditPreset.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.LazygitBenchmark.Baseline.Schema.Os.EditPreset.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchOneOf0Entity(Corvus.LazygitBenchmark.Baseline.Schema.Os.EditPreset.OneOf0Entity.Mutable.From(this));
                    }

                    if (Corvus.LazygitBenchmark.Baseline.Schema.Os.EditPreset.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchOneOf1Entity(Corvus.LazygitBenchmark.Baseline.Schema.Os.EditPreset.OneOf1Entity.Mutable.From(this));
                    }
                ...
                public bool TryGetAsOneOf0Entity(out Corvus.LazygitBenchmark.Baseline.Schema.Os.EditPreset.OneOf0Entity result)
                {
                    if (Corvus.LazygitBenchmark.Baseline.Schema.Os.EditPreset.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.LazygitBenchmark.Baseline.Schema.Os.EditPreset.OneOf0Entity.Mutable.From(this);
                        return true;
                    }
                ...
                public bool TryGetAsOneOf1Entity(out Corvus.LazygitBenchmark.Baseline.Schema.Os.EditPreset.OneOf1Entity result)
                {
                    if (Corvus.LazygitBenchmark.Baseline.Schema.Os.EditPreset.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.LazygitBenchmark.Baseline.Schema.Os.EditPreset.OneOf1Entity.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.LazygitBenchmark.Baseline.Schema.Os.EditPreset.OneOf0Entity instance) => new(JsonElement.From(instance));

                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.LazygitBenchmark.Baseline.Schema.Os.EditPreset.OneOf1Entity instance) => new(JsonElement.From(instance));
