...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Os
    {
        ...
        public readonly partial struct Open
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(Open instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="Open"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Open(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new Open(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Open.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="Open"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="Open"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly Open Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<Open>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="Open"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly Open Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<Open>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(Open instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<Open, Mutable>(this);
            }
        }
    }
}
