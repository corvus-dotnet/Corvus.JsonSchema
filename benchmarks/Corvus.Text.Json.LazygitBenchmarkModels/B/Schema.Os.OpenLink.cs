...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Os
    {
        ...
        public readonly partial struct OpenLink
#if NET8_0_OR_GREATER
            : IJsonElement<OpenLink>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="OpenLink"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal OpenLink(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static OpenLink DefaultInstance { get; } = ParsedJsonDocument<OpenLink>.StringConstant([.."\"\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(OpenLink value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in OpenLink left, in OpenLink right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in OpenLink left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(OpenLink instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator OpenLink(JsonElement instance)
            {
                return OpenLink.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OpenLink From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OpenLink ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OpenLink>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OpenLink ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OpenLink>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OpenLink ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OpenLink>(json, options);
            }
            ...
            /// </exception>
            public static OpenLink ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<OpenLink>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out OpenLink? result)
            {
                return JsonElementHelpers.TryParseValue<OpenLink>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new OpenLink(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static OpenLink IJsonElement<OpenLink>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"OpenLink: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="OpenLink"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="OpenLink"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            {
                CheckValidInstance();
                return _parent.CloneElement<OpenLink>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="OpenLink"/> that lives for the lifetime of its
