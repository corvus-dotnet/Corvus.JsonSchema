...
public readonly partial struct Schema
{
    ...
    public readonly partial struct QuitOnTopLevelReturn
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(QuitOnTopLevelReturn instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="QuitOnTopLevelReturn"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator QuitOnTopLevelReturn(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new QuitOnTopLevelReturn(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"QuitOnTopLevelReturn.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="QuitOnTopLevelReturn"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="QuitOnTopLevelReturn"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly QuitOnTopLevelReturn Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<QuitOnTopLevelReturn>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="QuitOnTopLevelReturn"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly QuitOnTopLevelReturn Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<QuitOnTopLevelReturn>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(QuitOnTopLevelReturn instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<QuitOnTopLevelReturn, Mutable>(this);
        }
    }
}
