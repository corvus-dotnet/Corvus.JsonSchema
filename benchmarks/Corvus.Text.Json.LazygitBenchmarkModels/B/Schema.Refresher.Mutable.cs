...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Refresher
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Refresher instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Refresher"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Refresher(Mutable instance)
            {
            ...
            /// <summary>
            /// Gets the (optional) <c>fetchInterval</c> property.
            /// fetch interval
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.LazygitBenchmark.Baseline.Schema.Refresher.FetchInterval.Mutable FetchIntervalValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FetchIntervalValueUtf8, out Corvus.LazygitBenchmark.Baseline.Schema.Refresher.FetchInterval.Mutable value))
                    {
                        return value;
                    }
            ...
            /// <summary>
            /// Gets the (optional) <c>refreshInterval</c> property.
            /// refresh interval
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.LazygitBenchmark.Baseline.Schema.Refresher.RefreshInterval.Mutable RefreshIntervalValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RefreshIntervalValueUtf8, out Corvus.LazygitBenchmark.Baseline.Schema.Refresher.RefreshInterval.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Refresher(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetFetchIntervalValue(in Corvus.LazygitBenchmark.Baseline.Schema.Refresher.FetchInterval.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.FetchIntervalValueUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FetchIntervalValueUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                ...
                else
                {
                    ...
                    value.AddAsProperty(JsonPropertyNamesEscaped.FetchIntervalValue, ref cvb, escapeName: false, nameRequiresUnescaping: false);
            ...
            /// <summary>
            /// Remove the <c>fetchInterval</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveFetchIntervalValue()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.FetchIntervalValueUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetRefreshIntervalValue(in Corvus.LazygitBenchmark.Baseline.Schema.Refresher.RefreshInterval.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.RefreshIntervalValueUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RefreshIntervalValueUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsProperty(JsonPropertyNamesEscaped.RefreshIntervalValue, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// <summary>
            /// Remove the <c>refreshInterval</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveRefreshIntervalValue()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.RefreshIntervalValueUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Refresher.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Refresher"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Refresher"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly Refresher Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<Refresher>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Refresher"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly Refresher Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Refresher>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.LazygitBenchmark.Baseline.Schema.Refresher.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(Refresher instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.LazygitBenchmark.Baseline.Schema.Refresher.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="Refresher"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.LazygitBenchmark.Baseline.Schema.Refresher.FetchInterval.Source fetchInterval = default,
                in Corvus.LazygitBenchmark.Baseline.Schema.Refresher.RefreshInterval.Source refreshInterval = default)
            {
                fetchInterval.AddAsProperty(JsonPropertyNamesEscaped.FetchIntervalValue, ref builder, escapeName: false);
                refreshInterval.AddAsProperty(JsonPropertyNamesEscaped.RefreshIntervalValue, ref builder, escapeName: false);
            }

            /// <summary>
            /// Creates an instance of a <see cref="Refresher"/>.
            /// </summary>
            public void Create(in Corvus.LazygitBenchmark.Baseline.Schema.Refresher.FetchInterval.Source fetchInterval = default, in Corvus.LazygitBenchmark.Baseline.Schema.Refresher.RefreshInterval.Source refreshInterval = default)
            {
                Create(ref _builder, fetchInterval, refreshInterval);
            }
        ...
        /// </summary>
        /// <param name="workspace">The JSON workspace.</param>
        /// <param name="fetchInterval">The value of the property.</param>
        /// <param name="refreshInterval">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.LazygitBenchmark.Baseline.Schema.Refresher.FetchInterval.Source fetchInterval = default, in Corvus.LazygitBenchmark.Baseline.Schema.Refresher.RefreshInterval.Source refreshInterval = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(fetchInterval, refreshInterval);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<Refresher, Mutable>(this);
        }
    }
}
