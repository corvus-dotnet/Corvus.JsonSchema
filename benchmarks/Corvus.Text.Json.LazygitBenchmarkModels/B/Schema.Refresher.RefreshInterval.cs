...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Refresher
    {
        ...
        public readonly partial struct RefreshInterval
#if NET8_0_OR_GREATER
            : IJsonElement<RefreshInterval>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RefreshInterval"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RefreshInterval(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RefreshInterval DefaultInstance { get; } = ParsedJsonDocument<RefreshInterval>.NumberConstant([.."10"u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator long(RefreshInterval value) => value._parent.TryGetValue(value._idx, out long result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator double(RefreshInterval value) => value._parent.TryGetValue(value._idx, out double result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator Corvus.Numerics.BigNumber(RefreshInterval value) => value._parent.TryGetValue(value._idx, out Corvus.Numerics.BigNumber result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator System.Numerics.BigInteger(RefreshInterval value) => value._parent.TryGetValue(value._idx, out System.Numerics.BigInteger result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator decimal(RefreshInterval value) => value._parent.TryGetValue(value._idx, out decimal result) ? result : throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in RefreshInterval left, in RefreshInterval right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RefreshInterval left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(RefreshInterval instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RefreshInterval(JsonElement instance)
            {
                return RefreshInterval.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RefreshInterval From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RefreshInterval ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RefreshInterval>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RefreshInterval ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RefreshInterval>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RefreshInterval ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RefreshInterval>(json, options);
            }
            ...
            /// </exception>
            public static RefreshInterval ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RefreshInterval>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RefreshInterval? result)
            {
                return JsonElementHelpers.TryParseValue<RefreshInterval>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RefreshInterval(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static RefreshInterval IJsonElement<RefreshInterval>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RefreshInterval: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RefreshInterval"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RefreshInterval"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public RefreshInterval Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RefreshInterval>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RefreshInterval"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public RefreshInterval Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RefreshInterval>(_idx);
                }
