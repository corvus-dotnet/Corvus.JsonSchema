...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Refresher"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal Refresher(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static Refresher DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.LazygitBenchmark.Baseline.Schema.Refresher.FetchInterval FetchIntervalValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FetchIntervalValueUtf8, out Corvus.LazygitBenchmark.Baseline.Schema.Refresher.FetchInterval value))
                {
                    return value;
                }

                return Corvus.LazygitBenchmark.Baseline.Schema.Refresher.FetchInterval.DefaultInstance;
            }
        }
        ...
        /// </para>
        /// </remarks>
        public Corvus.LazygitBenchmark.Baseline.Schema.Refresher.RefreshInterval RefreshIntervalValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RefreshIntervalValueUtf8, out Corvus.LazygitBenchmark.Baseline.Schema.Refresher.RefreshInterval value))
                {
                    return value;
                }

                return Corvus.LazygitBenchmark.Baseline.Schema.Refresher.RefreshInterval.DefaultInstance;
            }
        }
        ...
        /// </returns>
        public static bool operator ==(in Refresher left, in Refresher right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Refresher left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(Refresher instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Refresher(JsonElement instance)
        {
            return Refresher.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Refresher From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Refresher ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Refresher>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Refresher ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Refresher>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Refresher ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Refresher>(json, options);
        }
        ...
        /// </exception>
        public static Refresher ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<Refresher>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Refresher? result)
        {
            return JsonElementHelpers.TryParseValue<Refresher>(ref reader, out result);
        }
...
#if NET
        static Refresher IJsonElement<Refresher>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Refresher: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        {
            /// <summary>
            /// Gets the JSON property name for <see cref="FetchIntervalValue"/>.
            /// </summary>
            public const string FetchIntervalValue = "fetchInterval";

            /// <summary>
            /// Gets the JSON property name for <see cref="RefreshIntervalValue"/>.
            /// </summary>
            public const string RefreshIntervalValue = "refreshInterval";

            /// <summary>
            /// Gets the JSON property name for <see cref="FetchIntervalValue"/>.
            /// </summary>
            public static ReadOnlySpan<byte> FetchIntervalValueUtf8 => "fetchInterval"u8;

            /// <summary>
            /// Gets the JSON property name for <see cref="RefreshIntervalValue"/>.
            /// </summary>
            public static ReadOnlySpan<byte> RefreshIntervalValueUtf8 => "refreshInterval"u8;
        }
        ...
        {
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="FetchIntervalValue"/>.
            /// </summary>
            public static ReadOnlySpan<byte> FetchIntervalValue => "fetchInterval"u8;

            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="RefreshIntervalValue"/>.
            /// </summary>
