    ...
    public readonly partial struct RequiredCommandAndContextAndKeyArray
    {
        ...
        public readonly partial struct RequiredCommandAndContextAndKey
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.LazygitBenchmark.Baseline.Schema.RequiredCommandAndContextAndKeyArray.RequiredCommandAndContextAndKey.After.CheckForConflicts CheckForConflictsValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CheckForConflictsValueUtf8, out Corvus.LazygitBenchmark.Baseline.Schema.RequiredCommandAndContextAndKeyArray.RequiredCommandAndContextAndKey.After.CheckForConflicts value))
                        {
                            return value;
                        }

                        return Corvus.LazygitBenchmark.Baseline.Schema.RequiredCommandAndContextAndKeyArray.RequiredCommandAndContextAndKey.After.CheckForConflicts.DefaultInstance;
                    }
                }
