        ...
        public readonly partial struct RequiredCommandAndContextAndKey
        {
            ...
            public readonly partial struct Stream
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(Stream instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="Stream"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Stream(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"Stream.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly Stream Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<Stream>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(Stream instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<Stream, Mutable>(this);
                }
            }
        }
    }
