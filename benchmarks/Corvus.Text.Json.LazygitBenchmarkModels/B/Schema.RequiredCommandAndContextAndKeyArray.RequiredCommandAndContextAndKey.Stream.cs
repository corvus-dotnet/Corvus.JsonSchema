...
public readonly partial struct Schema
{
    ...
    public readonly partial struct RequiredCommandAndContextAndKeyArray
    {
        ...
        public readonly partial struct RequiredCommandAndContextAndKey
        {
            ...
            public readonly partial struct Stream
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="Stream"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal Stream(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static Stream DefaultInstance { get; } = ParsedJsonDocument<Stream>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(Stream value)
                {
                ...
                /// </returns>
                public static bool operator ==(in Stream left, in Stream right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in Stream left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(Stream instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Stream(JsonElement instance)
                {
                    return Stream.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Stream From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Stream ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<Stream>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Stream ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<Stream>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Stream ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<Stream>(json, options);
                }
                ...
                /// </exception>
                public static Stream ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<Stream>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out Stream? result)
                {
                    return JsonElementHelpers.TryParseValue<Stream>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new Stream(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static Stream IJsonElement<Stream>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Stream: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="Stream"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="Stream"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                {
                    CheckValidInstance();
                    return _parent.CloneElement<Stream>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="Stream"/> that lives for the lifetime of its
                ...
                public Stream Freeze()
                {
                    ...
                    {
                        return mutable.FreezeElement<Stream>(_idx);
                    }
