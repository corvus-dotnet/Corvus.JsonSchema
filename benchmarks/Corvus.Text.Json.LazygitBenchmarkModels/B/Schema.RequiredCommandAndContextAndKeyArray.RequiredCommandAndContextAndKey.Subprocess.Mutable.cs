        ...
        public readonly partial struct RequiredCommandAndContextAndKey
        {
            ...
            public readonly partial struct Subprocess
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(Subprocess instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="Subprocess"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Subprocess(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"Subprocess.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(Subprocess instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<Subprocess, Mutable>(this);
                }
            }
        }
    }
