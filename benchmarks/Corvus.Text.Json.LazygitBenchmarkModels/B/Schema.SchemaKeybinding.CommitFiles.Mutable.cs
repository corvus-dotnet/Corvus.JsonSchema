    ...
    public readonly partial struct SchemaKeybinding
    {
        ...
        public readonly partial struct CommitFiles
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.LazygitBenchmark.Baseline.Schema.Keybinding.Mutable CheckoutCommitFile
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CheckoutCommitFileUtf8, out Corvus.LazygitBenchmark.Baseline.Schema.Keybinding.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetCheckoutCommitFile(in Corvus.LazygitBenchmark.Baseline.Schema.Keybinding.Source value)
                {
                    CheckValidInstance();
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.LazygitBenchmark.Baseline.Schema.SchemaKeybinding.CommitFiles.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.LazygitBenchmark.Baseline.Schema.SchemaKeybinding.CommitFiles.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.LazygitBenchmark.Baseline.Schema.Keybinding.Source checkoutCommitFile = default)
                {
                ...
                /// Creates an instance of a <see cref="CommitFiles"/>.
                /// </summary>
                public void Create(in Corvus.LazygitBenchmark.Baseline.Schema.Keybinding.Source checkoutCommitFile = default)
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.LazygitBenchmark.Baseline.Schema.Keybinding.Source checkoutCommitFile = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
