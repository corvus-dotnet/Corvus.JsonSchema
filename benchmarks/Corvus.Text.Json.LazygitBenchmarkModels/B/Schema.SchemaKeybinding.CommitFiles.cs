...
public readonly partial struct Schema
{
    ...
    public readonly partial struct SchemaKeybinding
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="CommitFiles"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal CommitFiles(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static CommitFiles DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.LazygitBenchmark.Baseline.Schema.Keybinding CheckoutCommitFile
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CheckoutCommitFileUtf8, out Corvus.LazygitBenchmark.Baseline.Schema.Keybinding value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in CommitFiles left, in CommitFiles right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in CommitFiles left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(CommitFiles instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator CommitFiles(JsonElement instance)
            {
                return CommitFiles.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CommitFiles From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CommitFiles ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CommitFiles>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CommitFiles ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CommitFiles>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CommitFiles ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CommitFiles>(json, options);
            }
            ...
            /// </exception>
            public static CommitFiles ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<CommitFiles>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out CommitFiles? result)
            {
                return JsonElementHelpers.TryParseValue<CommitFiles>(ref reader, out result);
            }
...
#if NET
            static CommitFiles IJsonElement<CommitFiles>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"CommitFiles: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            {
                /// <summary>
                /// Gets the JSON property name for <see cref="CheckoutCommitFile"/>.
                /// </summary>
                public const string CheckoutCommitFile = "checkoutCommitFile";

                /// <summary>
                /// Gets the JSON property name for <see cref="CheckoutCommitFile"/>.
                /// </summary>
                public static ReadOnlySpan<byte> CheckoutCommitFileUtf8 => "checkoutCommitFile"u8;
            }
            ...
            {
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="CheckoutCommitFile"/>.
                /// </summary>
                public static ReadOnlySpan<byte> CheckoutCommitFile => "checkoutCommitFile"u8;
            }
        }
    }
}
