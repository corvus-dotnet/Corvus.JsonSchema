    ...
    public readonly partial struct SchemaKeybinding
    {
        ...
        public readonly partial struct Status
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(Status instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="Status"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Status(Mutable instance)
                {
                ...
                /// <summary>
                /// Gets the (optional) <c>checkForUpdate</c> property.
                /// check for update
                /// </summary>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public Corvus.LazygitBenchmark.Baseline.Schema.Keybinding.Mutable CheckForUpdate
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CheckForUpdateUtf8, out Corvus.LazygitBenchmark.Baseline.Schema.Keybinding.Mutable value))
                        {
                            return value;
                        }
                ...
                /// <summary>
                /// Gets the (optional) <c>recentRepos</c> property.
                /// recent repos
                /// </summary>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public Corvus.LazygitBenchmark.Baseline.Schema.Keybinding.Mutable RecentRepos
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RecentReposUtf8, out Corvus.LazygitBenchmark.Baseline.Schema.Keybinding.Mutable value))
                        {
                            return value;
                        }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new Status(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                public void SetCheckForUpdate(in Corvus.LazygitBenchmark.Baseline.Schema.Keybinding.Source value)
                {
                    CheckValidInstance();

                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.CheckForUpdateUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CheckForUpdateUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                    ...
                    else
                    {
                        ...
                        value.AddAsProperty(JsonPropertyNamesEscaped.CheckForUpdate, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                ...
                /// <summary>
                /// Remove the <c>checkForUpdate</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveCheckForUpdate()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.CheckForUpdateUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetRecentRepos(in Corvus.LazygitBenchmark.Baseline.Schema.Keybinding.Source value)
                {
                    CheckValidInstance();

                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.RecentReposUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RecentReposUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsProperty(JsonPropertyNamesEscaped.RecentRepos, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                /// <summary>
                /// Remove the <c>recentRepos</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveRecentRepos()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.RecentReposUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Status.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="Status"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="Status"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly Status Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<Status>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="Status"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly Status Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<Status>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.LazygitBenchmark.Baseline.Schema.SchemaKeybinding.Status.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(Status instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.LazygitBenchmark.Baseline.Schema.SchemaKeybinding.Status.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="Status"/>.
                /// </summary>
                internal static void Create(
                    ref ComplexValueBuilder builder,
                    in Corvus.LazygitBenchmark.Baseline.Schema.Keybinding.Source checkForUpdate = default,
                    in Corvus.LazygitBenchmark.Baseline.Schema.Keybinding.Source recentRepos = default)
                {
                    checkForUpdate.AddAsProperty(JsonPropertyNamesEscaped.CheckForUpdate, ref builder, escapeName: false);
                    recentRepos.AddAsProperty(JsonPropertyNamesEscaped.RecentRepos, ref builder, escapeName: false);
                }

                /// <summary>
                /// Creates an instance of a <see cref="Status"/>.
                /// </summary>
                public void Create(in Corvus.LazygitBenchmark.Baseline.Schema.Keybinding.Source checkForUpdate = default, in Corvus.LazygitBenchmark.Baseline.Schema.Keybinding.Source recentRepos = default)
                {
                    Create(ref _builder, checkForUpdate, recentRepos);
                }
            ...
            /// </summary>
            /// <param name="workspace">The JSON workspace.</param>
            /// <param name="checkForUpdate">The value of the property.</param>
            /// <param name="recentRepos">The value of the property.</param>
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.LazygitBenchmark.Baseline.Schema.Keybinding.Source checkForUpdate = default, in Corvus.LazygitBenchmark.Baseline.Schema.Keybinding.Source recentRepos = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(checkForUpdate, recentRepos);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<Status, Mutable>(this);
            }
        }
    }
}
