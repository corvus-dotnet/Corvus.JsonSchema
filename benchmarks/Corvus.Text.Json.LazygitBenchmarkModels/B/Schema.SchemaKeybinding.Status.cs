...
public readonly partial struct Schema
{
    ...
    public readonly partial struct SchemaKeybinding
    {
...
#endif
        {
            ...
            internal Status(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static Status DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.LazygitBenchmark.Baseline.Schema.Keybinding CheckForUpdate
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CheckForUpdateUtf8, out Corvus.LazygitBenchmark.Baseline.Schema.Keybinding value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.LazygitBenchmark.Baseline.Schema.Keybinding RecentRepos
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RecentReposUtf8, out Corvus.LazygitBenchmark.Baseline.Schema.Keybinding value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in Status left, in Status right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in Status left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(Status instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Status(JsonElement instance)
            {
                return Status.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Status From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Status ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Status>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Status ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Status>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Status ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Status>(json, options);
            }
            ...
            /// </exception>
            public static Status ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<Status>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out Status? result)
            {
                return JsonElementHelpers.TryParseValue<Status>(ref reader, out result);
            }
...
#if NET
            static Status IJsonElement<Status>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Status: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            public Status Freeze()
            {
                ...
                {
                    return mutable.FreezeElement<Status>(_idx);
                }
            ...
            {
                /// <summary>
                /// Gets the JSON property name for <see cref="CheckForUpdate"/>.
                /// </summary>
                public const string CheckForUpdate = "checkForUpdate";

                /// <summary>
                /// Gets the JSON property name for <see cref="RecentRepos"/>.
                /// </summary>
                public const string RecentRepos = "recentRepos";

                /// <summary>
                /// Gets the JSON property name for <see cref="CheckForUpdate"/>.
                /// </summary>
                public static ReadOnlySpan<byte> CheckForUpdateUtf8 => "checkForUpdate"u8;

                /// <summary>
                /// Gets the JSON property name for <see cref="RecentRepos"/>.
                /// </summary>
                public static ReadOnlySpan<byte> RecentReposUtf8 => "recentRepos"u8;
            }
            ...
            {
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="CheckForUpdate"/>.
                /// </summary>
                public static ReadOnlySpan<byte> CheckForUpdate => "checkForUpdate"u8;

                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="RecentRepos"/>.
                /// </summary>
                public static ReadOnlySpan<byte> RecentRepos => "recentRepos"u8;
            }
        }
    }
}
