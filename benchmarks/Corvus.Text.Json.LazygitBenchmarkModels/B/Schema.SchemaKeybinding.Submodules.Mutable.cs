    ...
    public readonly partial struct SchemaKeybinding
    {
        ...
        public readonly partial struct Submodules
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.LazygitBenchmark.Baseline.Schema.Keybinding.Mutable BulkMenu
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BulkMenuUtf8, out Corvus.LazygitBenchmark.Baseline.Schema.Keybinding.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.LazygitBenchmark.Baseline.Schema.Keybinding.Mutable Init
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.InitUtf8, out Corvus.LazygitBenchmark.Baseline.Schema.Keybinding.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.LazygitBenchmark.Baseline.Schema.Keybinding.Mutable Update
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UpdateUtf8, out Corvus.LazygitBenchmark.Baseline.Schema.Keybinding.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetBulkMenu(in Corvus.LazygitBenchmark.Baseline.Schema.Keybinding.Source value)
                {
                    CheckValidInstance();
                    ...
                    else
                    {
                        ...
                        value.AddAsProperty(JsonPropertyNamesEscaped.BulkMenu, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetInit(in Corvus.LazygitBenchmark.Baseline.Schema.Keybinding.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetUpdate(in Corvus.LazygitBenchmark.Baseline.Schema.Keybinding.Source value)
                {
                    CheckValidInstance();
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsProperty(JsonPropertyNamesEscaped.Update, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.LazygitBenchmark.Baseline.Schema.SchemaKeybinding.Submodules.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.LazygitBenchmark.Baseline.Schema.SchemaKeybinding.Submodules.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.LazygitBenchmark.Baseline.Schema.Keybinding.Source bulkMenu = default,
                    in Corvus.LazygitBenchmark.Baseline.Schema.Keybinding.Source init = default,
                    in Corvus.LazygitBenchmark.Baseline.Schema.Keybinding.Source update = default)
                {
                    bulkMenu.AddAsProperty(JsonPropertyNamesEscaped.BulkMenu, ref builder, escapeName: false);
                    init.AddAsProperty(JsonPropertyNamesEscaped.Init, ref builder, escapeName: false);
                    update.AddAsProperty(JsonPropertyNamesEscaped.Update, ref builder, escapeName: false);
                }
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.LazygitBenchmark.Baseline.Schema.Keybinding.Source bulkMenu = default, in Corvus.LazygitBenchmark.Baseline.Schema.Keybinding.Source init = default, in Corvus.LazygitBenchmark.Baseline.Schema.Keybinding.Source update = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
