...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Update
    {
        ...
        public readonly partial struct Days
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(Days instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="Days"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Days(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new Days(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Days.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="Days"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="Days"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly Days Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<Days>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="Days"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly Days Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<Days>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(Days instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<Days, Mutable>(this);
            }
        }
    }
}
