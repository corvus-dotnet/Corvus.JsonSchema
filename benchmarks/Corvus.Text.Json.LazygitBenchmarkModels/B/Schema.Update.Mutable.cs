...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Update
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.LazygitBenchmark.Baseline.Schema.Update.Days.Mutable DaysValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DaysValueUtf8, out Corvus.LazygitBenchmark.Baseline.Schema.Update.Days.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.LazygitBenchmark.Baseline.Schema.Update.Method.Mutable MethodValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MethodValueUtf8, out Corvus.LazygitBenchmark.Baseline.Schema.Update.Method.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetDaysValue(in Corvus.LazygitBenchmark.Baseline.Schema.Update.Days.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetMethodValue(in Corvus.LazygitBenchmark.Baseline.Schema.Update.Method.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.LazygitBenchmark.Baseline.Schema.Update.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.LazygitBenchmark.Baseline.Schema.Update.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.LazygitBenchmark.Baseline.Schema.Update.Days.Source days = default,
                in Corvus.LazygitBenchmark.Baseline.Schema.Update.Method.Source method = default)
            {
            ...
            /// Creates an instance of a <see cref="Update"/>.
            /// </summary>
            public void Create(in Corvus.LazygitBenchmark.Baseline.Schema.Update.Days.Source days = default, in Corvus.LazygitBenchmark.Baseline.Schema.Update.Method.Source method = default)
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.LazygitBenchmark.Baseline.Schema.Update.Days.Source days = default, in Corvus.LazygitBenchmark.Baseline.Schema.Update.Method.Source method = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
