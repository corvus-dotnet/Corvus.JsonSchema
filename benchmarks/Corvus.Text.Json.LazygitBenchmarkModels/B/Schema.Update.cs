...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Update"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal Update(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static Update DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.LazygitBenchmark.Baseline.Schema.Update.Days DaysValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DaysValueUtf8, out Corvus.LazygitBenchmark.Baseline.Schema.Update.Days value))
                {
                    return value;
                }

                return Corvus.LazygitBenchmark.Baseline.Schema.Update.Days.DefaultInstance;
            }
        }
        ...
        /// </para>
        /// </remarks>
        public Corvus.LazygitBenchmark.Baseline.Schema.Update.Method MethodValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MethodValueUtf8, out Corvus.LazygitBenchmark.Baseline.Schema.Update.Method value))
                {
                    return value;
                }

                return Corvus.LazygitBenchmark.Baseline.Schema.Update.Method.DefaultInstance;
            }
        }
        ...
        /// </returns>
        public static bool operator ==(in Update left, in Update right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Update left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(Update instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Update(JsonElement instance)
        {
            return Update.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Update From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Update ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Update>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Update ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Update>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Update ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Update>(json, options);
        }
        ...
        /// </exception>
        public static Update ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<Update>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Update? result)
        {
            return JsonElementHelpers.TryParseValue<Update>(ref reader, out result);
        }
...
#if NET
        static Update IJsonElement<Update>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Update: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        {
            /// <summary>
            /// Gets the JSON property name for <see cref="DaysValue"/>.
            /// </summary>
            ...
            /// Gets the JSON property name for <see cref="DaysValue"/>.
            /// </summary>
            public static ReadOnlySpan<byte> DaysValueUtf8 => "days"u8;
        ...
        {
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="DaysValue"/>.
            /// </summary>
            public static ReadOnlySpan<byte> DaysValue => "days"u8;
