...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct Color
    {
...
#endif
        {
            ...
            /// <summary>
            /// Conversion to <see cref="Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf0Entity"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf0Entity.Mutable(Mutable value)
            {
                return Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf0Entity.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf0Entity"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf0Entity.Mutable value)
            {
                return From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf1Entity.Mutable(Mutable value)
            {
                return Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf1Entity.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf1Entity"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf1Entity.Mutable value)
            {
                return From(value);
            }
            ...
            public static explicit operator Mutable(Color instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Color"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Color(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Color(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Color.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Color"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Color"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            {
                CheckValidInstance();
                return _parent.CloneElement<Color>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Color"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly Color Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Color>(_idx);
            }
            ...
            /// <param name="matchOneOf0Entity">Match a <see cref="Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf0Entity"/>.</param>
            /// <param name="matchOneOf1Entity">Match a <see cref="Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf1Entity"/>.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Matcher<Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf0Entity, TContext, TResult> matchOneOf0Entity,
                Matcher<Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf1Entity, TContext, TResult> matchOneOf1Entity,
                Matcher<Corvus.LazygitBenchmark.Current.LazygitSchema.Color.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
            {
                if (Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchOneOf0Entity(Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf0Entity.Mutable.From(this), context);
                }

                if (Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchOneOf1Entity(Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf1Entity.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                Matcher<Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf0Entity, TResult> matchOneOf0Entity,
                Matcher<Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf1Entity, TResult> matchOneOf1Entity,
                Matcher<Corvus.LazygitBenchmark.Current.LazygitSchema.Color.Mutable, TResult> defaultMatch)
            {
                if (Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchOneOf0Entity(Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf0Entity.Mutable.From(this));
                }

                if (Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchOneOf1Entity(Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf1Entity.Mutable.From(this));
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf0Entity.Mutable" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsOneOf0Entity(out Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf0Entity.Mutable result)
            {
                if (Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf0Entity.Mutable.From(this);
                    return true;
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf1Entity.Mutable" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsOneOf1Entity(out Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf1Entity.Mutable result)
            {
                if (Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf1Entity.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(Color instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf0Entity instance) => new(JsonElement.From(instance));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf1Entity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<Color, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<Color> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Color>();
            }
            finally
            {
