...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct Color
    {
...
#endif
        {
            ...
            /// <param name="matchBlack">Match 1st item.</param>
            /// <param name="matchRed">Match 2nd item.</param>
            /// <param name="matchGreen">Match 3rd item.</param>
            /// <param name="matchYellow">Match 4th item.</param>
            /// <param name="matchBlue">Match 5th item.</param>
            /// <param name="matchMagenta">Match 6th item.</param>
            /// <param name="matchCyan">Match 7th item.</param>
            /// <param name="matchWhite">Match 8th item.</param>
            /// <param name="matchBold">Match 9th item.</param>
            /// <param name="matchDefault">Match 10th item.</param>
            /// <param name="matchReverse">Match 11th item.</param>
            /// <param name="matchUnderline">Match 12th item.</param>
            /// <param name="matchStrikethrough">Match 13th item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchBlack,
                Func<TContext, TResult> matchRed,
                Func<TContext, TResult> matchGreen,
                Func<TContext, TResult> matchYellow,
                Func<TContext, TResult> matchBlue,
                Func<TContext, TResult> matchMagenta,
                Func<TContext, TResult> matchCyan,
                Func<TContext, TResult> matchWhite,
                Func<TContext, TResult> matchBold,
                Func<TContext, TResult> matchDefault,
                Func<TContext, TResult> matchReverse,
                Func<TContext, TResult> matchUnderline,
                Func<TContext, TResult> matchStrikethrough,
...
#endif
            {
                ...
                {
                    return matchReverse(context);
                }

                if (this.ValueEquals(Constants.Enum12))
                {
                    return matchUnderline(context);
                }

                if (this.ValueEquals(Constants.Enum13))
                {
                    return matchStrikethrough(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchBlack,
                Func<TResult> matchRed,
                Func<TResult> matchGreen,
                Func<TResult> matchYellow,
                Func<TResult> matchBlue,
                Func<TResult> matchMagenta,
                Func<TResult> matchCyan,
                Func<TResult> matchWhite,
                Func<TResult> matchBold,
                Func<TResult> matchDefault,
                Func<TResult> matchReverse,
                Func<TResult> matchUnderline,
                Func<TResult> matchStrikethrough,
