...
public readonly partial struct LazygitSchema
{
...
#endif
    {
        ...
        internal Color(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static Color DefaultInstance { get; }
        ...
        public static explicit operator Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf0Entity(Color value)
        {
            return Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf0Entity.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Color(Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf0Entity value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf1Entity(Color value)
        {
            return Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf1Entity.From(value);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(Color value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Color left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(Color instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Color(JsonElement instance)
        {
            return Color.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Color From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Color ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Color>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Color ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Color>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Color ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Color>(json, options);
        }
        ...
        /// </exception>
        public static Color ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<Color>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Color? result)
        {
            return JsonElementHelpers.TryParseValue<Color>(ref reader, out result);
        }
...
#if NET
        static Color IJsonElement<Color>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Color: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public Color Freeze()
        {
            ...
            {
                return mutable.FreezeElement<Color>(_idx);
            }
        ...
        public bool TryGetAsOneOf0Entity(out Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf0Entity result)
        {
            ...
            {
                result = Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf0Entity.From(this);
                return true;
            }
        ...
        public bool TryGetAsOneOf1Entity(out Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf1Entity result)
        {
            ...
            {
                result = Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf1Entity.From(this);
                return true;
            }
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.LazygitBenchmark.Current.LazygitSchema.Color, TContext, TResult> defaultMatch)
...
#endif
        {
            if (Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchOneOf0Entity(Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf0Entity.From(this), context);
            }

            if (Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchOneOf1Entity(Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf1Entity.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.LazygitBenchmark.Current.LazygitSchema.Color, TResult> defaultMatch)
        {
            if (Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchOneOf0Entity(Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf0Entity.From(this));
            }

            if (Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchOneOf1Entity(Corvus.LazygitBenchmark.Current.LazygitSchema.Color.OneOf1Entity.From(this));
            }
