...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct ConfirmOnQuit
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ConfirmOnQuit, Mutable>(ConfirmOnQuit.DefaultInstance);
            ...
            public static explicit operator Mutable(ConfirmOnQuit instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ConfirmOnQuit"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ConfirmOnQuit(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ConfirmOnQuit.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ConfirmOnQuit Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ConfirmOnQuit Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ConfirmOnQuit>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ConfirmOnQuit instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<ConfirmOnQuit, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ConfirmOnQuit> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ConfirmOnQuit>();
            }
            finally
            {
