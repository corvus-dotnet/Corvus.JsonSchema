...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct CustomCommandsPromptsTypeProperty
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(CustomCommandsPromptsTypeProperty instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="CustomCommandsPromptsTypeProperty"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator CustomCommandsPromptsTypeProperty(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new CustomCommandsPromptsTypeProperty(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"CustomCommandsPromptsTypeProperty.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="CustomCommandsPromptsTypeProperty"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="CustomCommandsPromptsTypeProperty"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly CustomCommandsPromptsTypeProperty Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<CustomCommandsPromptsTypeProperty>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="CustomCommandsPromptsTypeProperty"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly CustomCommandsPromptsTypeProperty Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<CustomCommandsPromptsTypeProperty>(_idx);
            }
            ...
            /// <param name="matchInput">Match 1st item.</param>
            /// <param name="matchConfirm">Match 2nd item.</param>
            /// <param name="matchMenu">Match 3rd item.</param>
            /// <param name="matchMenuFromCommand">Match 4th item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchInput,
                Func<TContext, TResult> matchConfirm,
                Func<TContext, TResult> matchMenu,
                Func<TContext, TResult> matchMenuFromCommand,
...
#endif
            {
                ...
                {
                    return matchMenuFromCommand(context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Func<TResult> matchConfirm,
                Func<TResult> matchMenu,
                Func<TResult> matchMenuFromCommand,
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(CustomCommandsPromptsTypeProperty instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (CustomCommandsPromptsTypeProperty)value;
        ...
        {
            return workspace.CreateBuilder<CustomCommandsPromptsTypeProperty, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<CustomCommandsPromptsTypeProperty> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<CustomCommandsPromptsTypeProperty>();
            }
            finally
            {
