...
public readonly partial struct LazygitSchema
{
...
#endif
    {
        ...
        /// </summary>
        public static CustomCommandsPromptsTypeProperty DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(CustomCommandsPromptsTypeProperty value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in CustomCommandsPromptsTypeProperty left, in CustomCommandsPromptsTypeProperty right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in CustomCommandsPromptsTypeProperty left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        {
            return CustomCommandsPromptsTypeProperty.From(instance);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CustomCommandsPromptsTypeProperty ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<CustomCommandsPromptsTypeProperty>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CustomCommandsPromptsTypeProperty ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<CustomCommandsPromptsTypeProperty>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static CustomCommandsPromptsTypeProperty ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<CustomCommandsPromptsTypeProperty>(json, options);
        }
        ...
        /// </exception>
        public static CustomCommandsPromptsTypeProperty ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<CustomCommandsPromptsTypeProperty>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out CustomCommandsPromptsTypeProperty? result)
        {
            return JsonElementHelpers.TryParseValue<CustomCommandsPromptsTypeProperty>(ref reader, out result);
        }
...
#if NET
        static CustomCommandsPromptsTypeProperty IJsonElement<CustomCommandsPromptsTypeProperty>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"CustomCommandsPromptsTypeProperty: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public CustomCommandsPromptsTypeProperty Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public CustomCommandsPromptsTypeProperty Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<CustomCommandsPromptsTypeProperty>(_idx);
            }
