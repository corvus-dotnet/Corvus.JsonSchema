...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct DisableStartupPopups
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DisableStartupPopups, Mutable>(DisableStartupPopups.DefaultInstance);
        ...
        public static ParsedJsonDocument<DisableStartupPopups> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<DisableStartupPopups>();
            }
            finally
            {
