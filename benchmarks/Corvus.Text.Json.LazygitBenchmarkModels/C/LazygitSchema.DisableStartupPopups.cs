...
public readonly partial struct LazygitSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DisableStartupPopups"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal DisableStartupPopups(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static DisableStartupPopups DefaultInstance { get; } = ParsedJsonDocument<DisableStartupPopups>.False;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator bool(DisableStartupPopups value)
        {
        ...
        /// </returns>
        public static bool operator ==(in DisableStartupPopups left, in DisableStartupPopups right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in DisableStartupPopups left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(DisableStartupPopups instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator DisableStartupPopups(JsonElement instance)
        {
            return DisableStartupPopups.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DisableStartupPopups From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DisableStartupPopups ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<DisableStartupPopups>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DisableStartupPopups ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<DisableStartupPopups>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DisableStartupPopups ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<DisableStartupPopups>(json, options);
        }
        ...
        /// </exception>
        public static DisableStartupPopups ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<DisableStartupPopups>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out DisableStartupPopups? result)
        {
            return JsonElementHelpers.TryParseValue<DisableStartupPopups>(ref reader, out result);
        }
...
#if NET
        static DisableStartupPopups IJsonElement<DisableStartupPopups>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"DisableStartupPopups: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public DisableStartupPopups Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public DisableStartupPopups Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<DisableStartupPopups>(_idx);
            }
