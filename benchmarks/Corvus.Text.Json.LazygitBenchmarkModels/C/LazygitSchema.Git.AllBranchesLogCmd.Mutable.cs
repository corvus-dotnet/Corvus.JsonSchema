    ...
    public readonly partial struct Git
    {
        ...
        public readonly partial struct AllBranchesLogCmd
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<AllBranchesLogCmd, Mutable>(AllBranchesLogCmd.DefaultInstance);
                ...
                public static explicit operator Mutable(AllBranchesLogCmd instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="AllBranchesLogCmd"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AllBranchesLogCmd(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AllBranchesLogCmd.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly AllBranchesLogCmd Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly AllBranchesLogCmd Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<AllBranchesLogCmd>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(AllBranchesLogCmd instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<AllBranchesLogCmd, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<AllBranchesLogCmd> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<AllBranchesLogCmd>();
                }
                finally
                {
