    ...
    public readonly partial struct Git
    {
        ...
        public readonly partial struct AutoFetch
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<AutoFetch, Mutable>(AutoFetch.DefaultInstance);
                ...
                public static explicit operator Mutable(AutoFetch instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="AutoFetch"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AutoFetch(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AutoFetch.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly AutoFetch Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly AutoFetch Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<AutoFetch>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(AutoFetch instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<AutoFetch, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<AutoFetch> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<AutoFetch>();
                }
                finally
                {
