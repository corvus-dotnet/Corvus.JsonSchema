    ...
    public readonly partial struct Git
    {
        ...
        public readonly partial struct AutoRefresh
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<AutoRefresh, Mutable>(AutoRefresh.DefaultInstance);
                ...
                public static explicit operator Mutable(AutoRefresh instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="AutoRefresh"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AutoRefresh(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AutoRefresh.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly AutoRefresh Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly AutoRefresh Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<AutoRefresh>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(AutoRefresh instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<AutoRefresh, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<AutoRefresh> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<AutoRefresh>();
                }
                finally
                {
