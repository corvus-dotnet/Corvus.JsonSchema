...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct Git
    {
        ...
        public readonly partial struct AutoRefresh
#if NET8_0_OR_GREATER
            : IJsonElement<AutoRefresh>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="AutoRefresh"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal AutoRefresh(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static AutoRefresh DefaultInstance { get; } = ParsedJsonDocument<AutoRefresh>.True;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(AutoRefresh value)
            {
            ...
            /// </returns>
            public static bool operator ==(in AutoRefresh left, in AutoRefresh right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in AutoRefresh left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(AutoRefresh instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AutoRefresh(JsonElement instance)
            {
                return AutoRefresh.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AutoRefresh From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AutoRefresh ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AutoRefresh>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AutoRefresh ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AutoRefresh>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AutoRefresh ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AutoRefresh>(json, options);
            }
            ...
            /// </exception>
            public static AutoRefresh ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<AutoRefresh>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out AutoRefresh? result)
            {
                return JsonElementHelpers.TryParseValue<AutoRefresh>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new AutoRefresh(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static AutoRefresh IJsonElement<AutoRefresh>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AutoRefresh: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="AutoRefresh"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="AutoRefresh"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            {
                CheckValidInstance();
                return _parent.CloneElement<AutoRefresh>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="AutoRefresh"/> that lives for the lifetime of its
