...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct Git
    {
        ...
        public readonly partial struct BranchLogCmd
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<BranchLogCmd, Mutable>(BranchLogCmd.DefaultInstance);
                ...
                public static explicit operator Mutable(BranchLogCmd instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="BranchLogCmd"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator BranchLogCmd(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new BranchLogCmd(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"BranchLogCmd.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="BranchLogCmd"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="BranchLogCmd"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly BranchLogCmd Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<BranchLogCmd>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="BranchLogCmd"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly BranchLogCmd Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<BranchLogCmd>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(BranchLogCmd instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<BranchLogCmd, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<BranchLogCmd> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<BranchLogCmd>();
                }
                finally
                {
