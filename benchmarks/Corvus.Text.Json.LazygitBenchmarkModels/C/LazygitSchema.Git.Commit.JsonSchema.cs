    ...
    public readonly partial struct Git
    {
            ...
            : IJsonElement<Commit>
        {
            public static partial class JsonSchema
            {
                ...
                private static void MatchSignOffValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/properties/git/properties/commit"u8, buffer, out written);
