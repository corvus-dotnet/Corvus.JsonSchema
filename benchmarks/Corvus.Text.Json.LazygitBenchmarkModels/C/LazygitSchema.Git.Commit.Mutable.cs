...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct Git
    {
        ...
        public readonly partial struct Commit
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(Commit instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="Commit"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Commit(Mutable instance)
                {
                ...
                /// <summary>
                /// Gets the (optional) <c>signOff</c> property.
                /// sign off
                /// </summary>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Commit.SignOff.Mutable SignOffValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SignOffValueUtf8, out Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Commit.SignOff.Mutable value))
                        {
                            return value;
                        }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new Commit(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                public void SetSignOffValue(scoped in Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Commit.SignOff.Source value)
                {
                    ...
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.SignOffValueUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SignOffValueUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                    ...
                    else
                    {
                        ...
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.SignOffValue, ref cvb);
                ...
                /// <summary>
                /// Remove the <c>signOff</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveSignOffValue()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.SignOffValueUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Commit.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="Commit"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="Commit"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly Commit Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<Commit>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="Commit"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly Commit Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<Commit>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Commit.SignOff.Source _createArg1;
                ...
                public static implicit operator Source(Commit instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Commit.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="Commit"/>.
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Commit.SignOff.Source signOff = default)
                {
                    signOff.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.SignOffValue, ref builder);
                }

                /// <summary>
                /// Creates an instance of a <see cref="Commit"/>.
                /// </summary>
                public void Create(in Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Commit.SignOff.Source signOff = default)
                {
                    Create(ref _builder, signOff);
                }
            ...
            /// </summary>
            /// <param name="workspace">The JSON workspace.</param>
            /// <param name="signOff">The value of the property.</param>
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Commit.SignOff.Source signOff = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            {
                return workspace.CreateBuilder<Commit, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<Commit> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<Commit>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<Commit> Create<TContext>(
            ...
            public static ParsedJsonDocument<Commit> Create(in Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Commit.SignOff.Source signOff = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
