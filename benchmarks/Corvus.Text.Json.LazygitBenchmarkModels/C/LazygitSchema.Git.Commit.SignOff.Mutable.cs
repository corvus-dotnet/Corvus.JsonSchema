        ...
        public readonly partial struct Commit
        {
            ...
            public readonly partial struct SignOff
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SignOff, Mutable>(SignOff.DefaultInstance);
                    ...
                    public static explicit operator Mutable(SignOff instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="SignOff"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator SignOff(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"SignOff.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly SignOff Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<SignOff>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(SignOff instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<SignOff, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<SignOff> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<SignOff>();
                    }
                    finally
                    {
