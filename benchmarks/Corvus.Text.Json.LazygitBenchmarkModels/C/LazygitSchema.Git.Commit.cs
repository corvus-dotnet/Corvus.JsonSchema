...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct Git
    {
...
#endif
        {
            ...
            internal Commit(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static Commit DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Commit.SignOff SignOffValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SignOffValueUtf8, out Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Commit.SignOff value))
                    {
                        return value;
                    }

                    return Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Commit.SignOff.DefaultInstance;
                }
            }
            ...
            /// </returns>
            public static bool operator ==(in Commit left, in Commit right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in Commit left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(Commit instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Commit(JsonElement instance)
            {
                return Commit.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Commit From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Commit ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Commit>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Commit ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Commit>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Commit ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Commit>(json, options);
            }
            ...
            /// </exception>
            public static Commit ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<Commit>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out Commit? result)
            {
                return JsonElementHelpers.TryParseValue<Commit>(ref reader, out result);
            }
...
#if NET
            static Commit IJsonElement<Commit>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Commit: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            {
                /// <summary>
                /// Gets the JSON property name for <see cref="SignOffValue"/>.
                /// </summary>
                public const string SignOffValue = "signOff";

                /// <summary>
                /// Gets the JSON property name for <see cref="SignOffValue"/>.
                /// </summary>
                public static ReadOnlySpan<byte> SignOffValueUtf8 => "signOff"u8;
            }
            ...
            {
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="SignOffValue"/>.
                /// </summary>
                public static ReadOnlySpan<byte> SignOffValue => "signOff"u8;
            }
            ...
            {
                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="SignOffValue"/>.
                /// </summary>
                public static ReadOnlySpan<byte> SignOffValue => [0x95, 0x00, 0x00, 0x00, 0x22, 0x73, 0x69, 0x67, 0x6E, 0x4F, 0x66, 0x66, 0x22];
            }
        }
    }
}
