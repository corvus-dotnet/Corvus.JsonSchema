            ...
            public readonly partial struct RepositoryPath
            {
                ...
                public readonly partial struct Replace
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(Replace instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="Replace"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator Replace(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"Replace.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly Replace Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<Replace>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(Replace instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<Replace, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<Replace> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<Replace>();
                        }
                        finally
                        {
