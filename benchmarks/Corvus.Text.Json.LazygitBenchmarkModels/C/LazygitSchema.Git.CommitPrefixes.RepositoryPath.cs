    ...
    public readonly partial struct Git
    {
        ...
        public readonly partial struct CommitPrefixes
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="RepositoryPath"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal RepositoryPath(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static RepositoryPath DefaultInstance { get; }
                ...
                /// </para>
                /// </remarks>
                public Corvus.LazygitBenchmark.Current.LazygitSchema.Git.CommitPrefixes.RepositoryPath.Pattern PatternValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PatternValueUtf8, out Corvus.LazygitBenchmark.Current.LazygitSchema.Git.CommitPrefixes.RepositoryPath.Pattern value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.LazygitBenchmark.Current.LazygitSchema.Git.CommitPrefixes.RepositoryPath.Replace ReplaceValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ReplaceValueUtf8, out Corvus.LazygitBenchmark.Current.LazygitSchema.Git.CommitPrefixes.RepositoryPath.Replace value))
                        {
                            return value;
                        }
                ...
                /// </returns>
                public static bool operator ==(in RepositoryPath left, in RepositoryPath right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in RepositoryPath left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(RepositoryPath instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepositoryPath(JsonElement instance)
                {
                    return RepositoryPath.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RepositoryPath From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RepositoryPath ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RepositoryPath>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RepositoryPath ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RepositoryPath>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RepositoryPath ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RepositoryPath>(json, options);
                }
                ...
                /// </exception>
                public static RepositoryPath ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<RepositoryPath>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out RepositoryPath? result)
                {
                    return JsonElementHelpers.TryParseValue<RepositoryPath>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new RepositoryPath(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static RepositoryPath IJsonElement<RepositoryPath>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepositoryPath: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="RepositoryPath"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="RepositoryPath"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public RepositoryPath Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<RepositoryPath>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="RepositoryPath"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public RepositoryPath Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<RepositoryPath>(_idx);
                    }
                ...
                {
                    /// <summary>
                    /// Gets the JSON property name for <see cref="PatternValue"/>.
                    /// </summary>
                    public const string PatternValue = "pattern";

                    /// <summary>
                    /// Gets the JSON property name for <see cref="ReplaceValue"/>.
                    /// </summary>
                    public const string ReplaceValue = "replace";

                    /// <summary>
                    /// Gets the JSON property name for <see cref="PatternValue"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> PatternValueUtf8 => "pattern"u8;

                    /// <summary>
                    /// Gets the JSON property name for <see cref="ReplaceValue"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> ReplaceValueUtf8 => "replace"u8;
                }
                ...
                {
                    /// <summary>
                    /// Gets the escaped UTF-8 JSON property name for <see cref="PatternValue"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> PatternValue => "pattern"u8;

                    /// <summary>
                    /// Gets the escaped UTF-8 JSON property name for <see cref="ReplaceValue"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> ReplaceValue => "replace"u8;
                }
                ...
                {
                    /// <summary>
                    /// Gets the pre-baked property name blob for <see cref="PatternValue"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> PatternValue => [0x95, 0x00, 0x00, 0x00, 0x22, 0x70, 0x61, 0x74, 0x74, 0x65, 0x72, 0x6E, 0x22];

                    /// <summary>
                    /// Gets the pre-baked property name blob for <see cref="ReplaceValue"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> ReplaceValue => [0x95, 0x00, 0x00, 0x00, 0x22, 0x72, 0x65, 0x70, 0x6C, 0x61, 0x63, 0x65, 0x22];
                }
            }
        }
    }
