...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct Git
    {
...
#endif
        {
            ...
            public bool TryGetProperty(ReadOnlySpan<byte> propertyName, out Corvus.LazygitBenchmark.Current.LazygitSchema.Git.CommitPrefixes.RepositoryPath value)
            {
                CheckValidInstance();
            ...
            /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public bool TryGetProperty(ReadOnlySpan<char> propertyName, out Corvus.LazygitBenchmark.Current.LazygitSchema.Git.CommitPrefixes.RepositoryPath value)
            {
                CheckValidInstance();
                return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
            }
            ...
            /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public bool TryGetProperty(string propertyName, out Corvus.LazygitBenchmark.Current.LazygitSchema.Git.CommitPrefixes.RepositoryPath value)
            {
                CheckValidInstance();
                return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
            }
            ...
            /// <see cref="Corvus.LazygitBenchmark.Current.LazygitSchema.Git.CommitPrefixes.RepositoryPath"/>.
            /// </summary>
            ...
            public static bool MatchesPatternRepositoryPath(ReadOnlySpan<byte> propertyName)
            {
            ...
            /// <returns><see langword="true"/> if the property name matches the pattern, otherwise <see langword="false"/>.</returns>
            public static bool TryAsPatternRepositoryPath(ReadOnlySpan<byte> propertyName, in JsonElement value, out Corvus.LazygitBenchmark.Current.LazygitSchema.Git.CommitPrefixes.RepositoryPath result)
            {
                if (MatchesPatternRepositoryPath(propertyName))
                {
                    result = Corvus.LazygitBenchmark.Current.LazygitSchema.Git.CommitPrefixes.RepositoryPath.From(value);
                    return true;
                }
            ...
            public interface IPatternPropertyVisitor<TState>
            {
                ...
                /// </summary>
                bool VisitPatternRepositoryPath(ReadOnlySpan<byte> name, in Corvus.LazygitBenchmark.Current.LazygitSchema.Git.CommitPrefixes.RepositoryPath value, ref TState state);
                ...
                where TVisitor : IPatternPropertyVisitor<TState>
            {
                ...
                foreach (var property in EnumerateObject())
                {
                    ...
                    {
                        matched = true;
                        Corvus.LazygitBenchmark.Current.LazygitSchema.Git.CommitPrefixes.RepositoryPath typedValue = Corvus.LazygitBenchmark.Current.LazygitSchema.Git.CommitPrefixes.RepositoryPath.From(property.Value);
                        if (!visitor.VisitPatternRepositoryPath(propertyName, in typedValue, ref state))
                        {
                            return false;
                        }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public ObjectEnumerator<Corvus.LazygitBenchmark.Current.LazygitSchema.Git.CommitPrefixes.RepositoryPath> EnumerateObject()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateObjectEnumerator<Corvus.LazygitBenchmark.Current.LazygitSchema.Git.CommitPrefixes.RepositoryPath>(_parent, _idx);
            }
