    ...
    public readonly partial struct Git
    {
        ...
        public readonly partial struct DiffContextSize
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DiffContextSize, Mutable>(DiffContextSize.DefaultInstance);
                ...
                public static explicit operator Mutable(DiffContextSize instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DiffContextSize"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DiffContextSize(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DiffContextSize.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly DiffContextSize Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly DiffContextSize Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DiffContextSize>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(DiffContextSize instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<DiffContextSize, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<DiffContextSize> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<DiffContextSize>();
                }
                finally
                {
