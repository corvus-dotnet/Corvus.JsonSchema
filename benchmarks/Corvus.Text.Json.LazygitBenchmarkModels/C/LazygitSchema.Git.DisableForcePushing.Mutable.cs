...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct Git
    {
        ...
        public readonly partial struct DisableForcePushing
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DisableForcePushing, Mutable>(DisableForcePushing.DefaultInstance);
                ...
                public static explicit operator Mutable(DisableForcePushing instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DisableForcePushing"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DisableForcePushing(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new DisableForcePushing(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DisableForcePushing.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="DisableForcePushing"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="DisableForcePushing"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly DisableForcePushing Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<DisableForcePushing>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="DisableForcePushing"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly DisableForcePushing Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DisableForcePushing>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(DisableForcePushing instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<DisableForcePushing, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<DisableForcePushing> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<DisableForcePushing>();
                }
                finally
                {
