...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct Git
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="DisableForcePushing"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal DisableForcePushing(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static DisableForcePushing DefaultInstance { get; } = ParsedJsonDocument<DisableForcePushing>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(DisableForcePushing value)
            {
            ...
            /// </returns>
            public static bool operator ==(in DisableForcePushing left, in DisableForcePushing right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in DisableForcePushing left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(DisableForcePushing instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DisableForcePushing(JsonElement instance)
            {
                return DisableForcePushing.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DisableForcePushing From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DisableForcePushing ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DisableForcePushing>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DisableForcePushing ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DisableForcePushing>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DisableForcePushing ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DisableForcePushing>(json, options);
            }
            ...
            /// </exception>
            public static DisableForcePushing ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<DisableForcePushing>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out DisableForcePushing? result)
            {
                return JsonElementHelpers.TryParseValue<DisableForcePushing>(ref reader, out result);
            }
...
#if NET
            static DisableForcePushing IJsonElement<DisableForcePushing>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DisableForcePushing: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public DisableForcePushing Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public DisableForcePushing Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<DisableForcePushing>(_idx);
                }
