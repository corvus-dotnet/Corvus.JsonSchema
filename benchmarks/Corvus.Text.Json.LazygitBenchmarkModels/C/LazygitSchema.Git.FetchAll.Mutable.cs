...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct Git
    {
        ...
        public readonly partial struct FetchAll
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<FetchAll, Mutable>(FetchAll.DefaultInstance);
                ...
                public static explicit operator Mutable(FetchAll instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="FetchAll"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator FetchAll(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new FetchAll(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"FetchAll.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="FetchAll"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="FetchAll"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly FetchAll Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<FetchAll>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="FetchAll"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly FetchAll Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<FetchAll>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(FetchAll instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<FetchAll, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<FetchAll> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<FetchAll>();
                }
                finally
                {
