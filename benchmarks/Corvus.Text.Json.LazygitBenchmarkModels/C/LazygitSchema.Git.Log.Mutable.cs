    ...
    public readonly partial struct Git
    {
        ...
        public readonly partial struct Log
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(Log instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="Log"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Log(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Log.Order.Mutable OrderValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OrderValueUtf8, out Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Log.Order.Mutable value))
                        {
                            return value;
                        }
                ...
                /// <summary>
                /// Gets the (optional) <c>showGraph</c> property.
                /// show graph
                /// </summary>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Log.ShowGraph.Mutable ShowGraphValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ShowGraphValueUtf8, out Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Log.ShowGraph.Mutable value))
                        {
                            return value;
                        }
                ...
                /// <summary>
                /// Gets the (optional) <c>showWholeGraph</c> property.
                /// show whole graph
                /// </summary>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Log.ShowWholeGraph.Mutable ShowWholeGraphValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ShowWholeGraphValueUtf8, out Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Log.ShowWholeGraph.Mutable value))
                        {
                            return value;
                        }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new Log(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                public void SetOrderValue(scoped in Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Log.Order.Source value)
                {
                    ...
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.OrderValueUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OrderValueUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                    ...
                    else
                    {
                        ...
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.OrderValue, ref cvb);
                ...
                public bool RemoveOrderValue()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.OrderValueUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                public void SetShowGraphValue(scoped in Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Log.ShowGraph.Source value)
                {
                    ...
                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ShowGraphValueUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ShowGraphValueUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ShowGraphValue, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                /// <summary>
                /// Remove the <c>showGraph</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveShowGraphValue()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ShowGraphValueUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                public void SetShowWholeGraphValue(scoped in Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Log.ShowWholeGraph.Source value)
                {
                    ...
                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ShowWholeGraphValueUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ShowWholeGraphValueUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ShowWholeGraphValue, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                /// <summary>
                /// Remove the <c>showWholeGraph</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveShowWholeGraphValue()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ShowWholeGraphValueUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Log.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="Log"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="Log"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly Log Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<Log>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="Log"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly Log Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<Log>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Log.Order.Source _createArg1;
                private readonly Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Log.ShowGraph.Source _createArg2;
                private readonly Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Log.ShowWholeGraph.Source _createArg3;
                ...
                public static implicit operator Source(Log instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Log.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="Log"/>.
                /// </summary>
                internal static void Create(
                    ref ComplexValueBuilder builder,
                    in Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Log.Order.Source order = default,
                    in Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Log.ShowGraph.Source showGraph = default,
                    in Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Log.ShowWholeGraph.Source showWholeGraph = default)
                {
                    order.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.OrderValue, ref builder);
                    showGraph.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ShowGraphValue, ref builder);
                    showWholeGraph.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ShowWholeGraphValue, ref builder);
                }
                ...
                public void Create(
                    ...
                    in Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Log.ShowWholeGraph.Source showWholeGraph = default)
                {
                    Create(ref _builder, order, showGraph, showWholeGraph);
                }
            ...
            /// <param name="showGraph">The value of the property.</param>
            /// <param name="showWholeGraph">The value of the property.</param>
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Log.Order.Source order = default, in Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Log.ShowGraph.Source showGraph = default, in Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Log.ShowWholeGraph.Source showWholeGraph = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(order, showGraph, showWholeGraph);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<Log, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<Log> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<Log>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<Log> Create<TContext>(
            ...
            public static ParsedJsonDocument<Log> Create(in Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Log.Order.Source order = default, in Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Log.ShowGraph.Source showGraph = default, in Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Log.ShowWholeGraph.Source showWholeGraph = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
