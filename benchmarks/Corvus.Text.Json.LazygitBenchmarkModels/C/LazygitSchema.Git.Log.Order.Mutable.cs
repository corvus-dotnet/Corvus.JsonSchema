        ...
        public readonly partial struct Log
        {
            ...
            public readonly partial struct Order
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<Order, Mutable>(Order.DefaultInstance);
                    ...
                    public static explicit operator Mutable(Order instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="Order"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Order(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"Order.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly Order Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<Order>(_idx);
                    }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(Order instance) => new(JsonElement.From(instance));
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Source(KnownValues value) => (Order)value;
                ...
                {
                    return workspace.CreateBuilder<Order, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<Order> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<Order>();
                    }
                    finally
                    {
