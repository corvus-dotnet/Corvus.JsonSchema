    ...
    public readonly partial struct Git
    {
        ...
        public readonly partial struct Log
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="Order"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal Order(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static Order DefaultInstance { get; } = ParsedJsonDocument<Order>.StringConstant([.."\"topo-order\""u8]);
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(Order value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in Order left, in Order right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in Order left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(Order instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Order(JsonElement instance)
                {
                    return Order.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Order From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Order ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<Order>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Order ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<Order>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Order ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<Order>(json, options);
                }
                ...
                /// </exception>
                public static Order ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<Order>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out Order? result)
                {
                    return JsonElementHelpers.TryParseValue<Order>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new Order(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static Order IJsonElement<Order>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Order: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="Order"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="Order"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                {
                    CheckValidInstance();
                    return _parent.CloneElement<Order>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="Order"/> that lives for the lifetime of its
                ...
                public Order Freeze()
                {
                    ...
                    {
                        return mutable.FreezeElement<Order>(_idx);
                    }
                ...
                /// <param name="matchDateOrder">Match 1st item.</param>
                /// <param name="matchAuthorDateOrder">Match 2nd item.</param>
                /// <param name="matchTopoOrder">Match 3rd item.</param>
                /// <param name="matchDefault">Match 4th item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> matchDateOrder,
                    Func<TContext, TResult> matchAuthorDateOrder,
                    Func<TContext, TResult> matchTopoOrder,
...
#endif
                {
                    ...
                    {
                        return matchDateOrder(context);
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchAuthorDateOrder(context);
                    }

                    if (this.ValueEquals(Constants.Enum3))
                    {
                        return matchTopoOrder(context);
                    }
                ...
                public TResult Match<TResult>(
                    Func<TResult> matchDateOrder,
                    Func<TResult> matchAuthorDateOrder,
                    Func<TResult> matchTopoOrder,
                    Func<TResult> matchDefault,
                    Func<TResult> defaultMatch)
                {
                    if (this.ValueEquals(Constants.Enum1))
                    {
                        return matchDateOrder();
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchAuthorDateOrder();
                    }

                    if (this.ValueEquals(Constants.Enum3))
                    {
                        return matchTopoOrder();
                    }
