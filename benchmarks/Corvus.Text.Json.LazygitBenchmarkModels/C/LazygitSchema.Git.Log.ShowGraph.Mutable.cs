        ...
        public readonly partial struct Log
        {
            ...
            public readonly partial struct ShowGraph
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ShowGraph, Mutable>(ShowGraph.DefaultInstance);
                ...
                public ref struct Source
                {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Source(KnownValues value) => (ShowGraph)value;
                ...
                public static ParsedJsonDocument<ShowGraph> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<ShowGraph>();
                    }
                    finally
                    {
