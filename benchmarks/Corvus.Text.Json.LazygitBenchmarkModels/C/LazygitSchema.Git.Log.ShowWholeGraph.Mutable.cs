        ...
        public readonly partial struct Log
        {
            ...
            public readonly partial struct ShowWholeGraph
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ShowWholeGraph, Mutable>(ShowWholeGraph.DefaultInstance);
                    ...
                    public static explicit operator Mutable(ShowWholeGraph instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ShowWholeGraph"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ShowWholeGraph(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new ShowWholeGraph(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ShowWholeGraph.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="ShowWholeGraph"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="ShowWholeGraph"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ShowWholeGraph Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<ShowWholeGraph>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="ShowWholeGraph"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ShowWholeGraph Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ShowWholeGraph>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(ShowWholeGraph instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<ShowWholeGraph, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<ShowWholeGraph> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<ShowWholeGraph>();
                    }
                    finally
                    {
