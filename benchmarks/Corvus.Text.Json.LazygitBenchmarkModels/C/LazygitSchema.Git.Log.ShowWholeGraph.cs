    ...
    public readonly partial struct Git
    {
        ...
        public readonly partial struct Log
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="ShowWholeGraph"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal ShowWholeGraph(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static ShowWholeGraph DefaultInstance { get; } = ParsedJsonDocument<ShowWholeGraph>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(ShowWholeGraph value)
                {
                ...
                /// </returns>
                public static bool operator ==(in ShowWholeGraph left, in ShowWholeGraph right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in ShowWholeGraph left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(ShowWholeGraph instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ShowWholeGraph(JsonElement instance)
                {
                    return ShowWholeGraph.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ShowWholeGraph From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ShowWholeGraph ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ShowWholeGraph>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ShowWholeGraph ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ShowWholeGraph>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ShowWholeGraph ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ShowWholeGraph>(json, options);
                }
                ...
                /// </exception>
                public static ShowWholeGraph ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<ShowWholeGraph>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out ShowWholeGraph? result)
                {
                    return JsonElementHelpers.TryParseValue<ShowWholeGraph>(ref reader, out result);
                }
...
#if NET
                static ShowWholeGraph IJsonElement<ShowWholeGraph>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ShowWholeGraph: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public ShowWholeGraph Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<ShowWholeGraph>(_idx);
                    }
