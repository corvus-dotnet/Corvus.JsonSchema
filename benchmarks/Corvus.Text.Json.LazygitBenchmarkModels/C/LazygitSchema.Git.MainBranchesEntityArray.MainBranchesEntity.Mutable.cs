        ...
        public readonly partial struct MainBranchesEntityArray
        {
            ...
            public readonly partial struct MainBranchesEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(MainBranchesEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="MainBranchesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator MainBranchesEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"MainBranchesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly MainBranchesEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly MainBranchesEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<MainBranchesEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(MainBranchesEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<MainBranchesEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<MainBranchesEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<MainBranchesEntity>();
                    }
                    finally
                    {
