        ...
        public readonly partial struct Merging
        {
            ...
            public readonly partial struct Arguments
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<Arguments, Mutable>(Arguments.DefaultInstance);
                    ...
                    public static explicit operator Mutable(Arguments instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="Arguments"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Arguments(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"Arguments.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly Arguments Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly Arguments Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<Arguments>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(Arguments instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<Arguments, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<Arguments> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<Arguments>();
                    }
                    finally
                    {
