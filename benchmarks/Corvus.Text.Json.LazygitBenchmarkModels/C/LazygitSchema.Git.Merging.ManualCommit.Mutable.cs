        ...
        public readonly partial struct Merging
        {
            ...
            public readonly partial struct ManualCommit
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ManualCommit, Mutable>(ManualCommit.DefaultInstance);
                ...
                public static ParsedJsonDocument<ManualCommit> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<ManualCommit>();
                    }
                    finally
                    {
