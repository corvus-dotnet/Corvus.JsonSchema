        ...
        public readonly partial struct Merging
        {
...
#endif
            {
                ...
                public void SetManualCommitValue(in Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Merging.ManualCommit.Source value)
                {
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsProperty(JsonPropertyNamesEscaped.ManualCommitValue, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
            ...
            public ref struct Builder
            {
                    ...
                    in Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Merging.ManualCommit.Source manualCommit = default)
                {
                    ...
                    manualCommit.AddAsProperty(JsonPropertyNamesEscaped.ManualCommitValue, ref builder, escapeName: false);
                }
