...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct Git
    {
        ...
        public readonly partial struct Merging
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(Merging instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="Merging"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Merging(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Merging.Arguments.Mutable Args
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ArgsUtf8, out Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Merging.Arguments.Mutable value))
                        {
                            return value;
                        }

                        return Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Merging.Arguments.Mutable.DefaultInstance;
                    }
                }

                /// <summary>
                /// Gets the (optional) <c>manualCommit</c> property.
                /// manual commit
                /// </summary>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Merging.ManualCommit.Mutable ManualCommitValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ManualCommitValueUtf8, out Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Merging.ManualCommit.Mutable value))
                        {
                            return value;
                        }

                        return Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Merging.ManualCommit.Mutable.DefaultInstance;
                    }
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new Merging(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                public void SetManualCommitValue(scoped in Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Merging.ManualCommit.Source value)
                {
                    ...
                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ManualCommitValueUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ManualCommitValueUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ManualCommitValue, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                /// <summary>
                /// Remove the <c>manualCommit</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveManualCommitValue()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ManualCommitValueUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Merging.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="Merging"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="Merging"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly Merging Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<Merging>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="Merging"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly Merging Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<Merging>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Merging.Arguments.Source _createArg1;
                private readonly Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Merging.ManualCommit.Source _createArg2;
                ...
                public static implicit operator Source(Merging instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Merging.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="Merging"/>.
                /// </summary>
                internal static void Create(
                    ref ComplexValueBuilder builder,
                    in Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Merging.Arguments.Source args = default,
                    in Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Merging.ManualCommit.Source manualCommit = default)
                {
                    args.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Args, ref builder);
                    manualCommit.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ManualCommitValue, ref builder);
                }

                /// <summary>
                /// Creates an instance of a <see cref="Merging"/>.
                /// </summary>
                public void Create(in Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Merging.Arguments.Source args = default, in Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Merging.ManualCommit.Source manualCommit = default)
                {
                    Create(ref _builder, args, manualCommit);
                }
            ...
            /// <param name="manualCommit">The value of the property.</param>
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Merging.Arguments.Source args = default, in Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Merging.ManualCommit.Source manualCommit = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(args, manualCommit);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<Merging, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<Merging> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<Merging>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<Merging> Create<TContext>(
            ...
            public static ParsedJsonDocument<Merging> Create(in Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Merging.Arguments.Source args = default, in Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Merging.ManualCommit.Source manualCommit = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
