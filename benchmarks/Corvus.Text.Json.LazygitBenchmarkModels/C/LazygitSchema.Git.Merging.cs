...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct Git
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="Merging"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal Merging(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static Merging DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Merging.Arguments Args
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ArgsUtf8, out Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Merging.Arguments value))
                    {
                        return value;
                    }

                    return Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Merging.Arguments.DefaultInstance;
                }
            }
            ...
            /// </para>
            /// </remarks>
            public Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Merging.ManualCommit ManualCommitValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ManualCommitValueUtf8, out Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Merging.ManualCommit value))
                    {
                        return value;
                    }

                    return Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Merging.ManualCommit.DefaultInstance;
                }
            }
            ...
            /// </returns>
            public static bool operator ==(in Merging left, in Merging right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in Merging left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(Merging instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Merging(JsonElement instance)
            {
                return Merging.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Merging From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Merging ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Merging>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Merging ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Merging>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Merging ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Merging>(json, options);
            }
            ...
            /// </exception>
            public static Merging ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<Merging>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out Merging? result)
            {
                return JsonElementHelpers.TryParseValue<Merging>(ref reader, out result);
            }
...
#if NET
            static Merging IJsonElement<Merging>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Merging: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            public static class JsonPropertyNames
            {
                ...
                /// <summary>
                /// Gets the JSON property name for <see cref="ManualCommitValue"/>.
                /// </summary>
                public const string ManualCommitValue = "manualCommit";
                ...
                /// Gets the JSON property name for <see cref="ManualCommitValue"/>.
                /// </summary>
                public static ReadOnlySpan<byte> ManualCommitValueUtf8 => "manualCommit"u8;
            }
            ...
            private static class JsonPropertyNamesEscaped
            {
                ...
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="ManualCommitValue"/>.
                /// </summary>
                public static ReadOnlySpan<byte> ManualCommitValue => "manualCommit"u8;
            }
            ...
            private static class JsonPropertyNamesPrebaked
            {
                ...
                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="ManualCommitValue"/>.
                /// </summary>
                public static ReadOnlySpan<byte> ManualCommitValue => [0xE5, 0x00, 0x00, 0x00, 0x22, 0x6D, 0x61, 0x6E, 0x75, 0x61, 0x6C, 0x43, 0x6F, 0x6D, 0x6D, 0x69, 0x74, 0x22];
            }
        }
    }
}
