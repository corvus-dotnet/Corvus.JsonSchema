    ...
    public readonly partial struct Git
    {
        ...
        public readonly partial struct OverrideGpg
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<OverrideGpg, Mutable>(OverrideGpg.DefaultInstance);
            ...
            public static ParsedJsonDocument<OverrideGpg> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<OverrideGpg>();
                }
                finally
                {
