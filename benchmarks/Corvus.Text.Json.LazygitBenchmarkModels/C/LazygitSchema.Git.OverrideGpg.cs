...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct Git
    {
        ...
        public readonly partial struct OverrideGpg
#if NET8_0_OR_GREATER
            : IJsonElement<OverrideGpg>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="OverrideGpg"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal OverrideGpg(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static OverrideGpg DefaultInstance { get; } = ParsedJsonDocument<OverrideGpg>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(OverrideGpg value)
            {
            ...
            /// </returns>
            public static bool operator ==(in OverrideGpg left, in OverrideGpg right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in OverrideGpg left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(OverrideGpg instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator OverrideGpg(JsonElement instance)
            {
                return OverrideGpg.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OverrideGpg From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OverrideGpg ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OverrideGpg>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OverrideGpg ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OverrideGpg>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OverrideGpg ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OverrideGpg>(json, options);
            }
            ...
            /// </exception>
            public static OverrideGpg ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<OverrideGpg>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out OverrideGpg? result)
            {
                return JsonElementHelpers.TryParseValue<OverrideGpg>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new OverrideGpg(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static OverrideGpg IJsonElement<OverrideGpg>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"OverrideGpg: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="OverrideGpg"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="OverrideGpg"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public OverrideGpg Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<OverrideGpg>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="OverrideGpg"/> that lives for the lifetime of its
