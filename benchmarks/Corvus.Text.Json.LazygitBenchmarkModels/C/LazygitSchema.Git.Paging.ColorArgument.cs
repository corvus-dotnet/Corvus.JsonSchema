...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct Git
    {
        ...
        public readonly partial struct Paging
        {
            ...
            public readonly partial struct ColorArgument
#if NET8_0_OR_GREATER
                : IJsonElement<ColorArgument>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="ColorArgument"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal ColorArgument(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static ColorArgument DefaultInstance { get; } = ParsedJsonDocument<ColorArgument>.StringConstant([.."\"always\""u8]);
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(ColorArgument value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in ColorArgument left, in ColorArgument right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in ColorArgument left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(ColorArgument instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ColorArgument(JsonElement instance)
                {
                    return ColorArgument.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ColorArgument From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ColorArgument ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ColorArgument>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ColorArgument ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ColorArgument>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ColorArgument ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ColorArgument>(json, options);
                }
                ...
                /// </exception>
                public static ColorArgument ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<ColorArgument>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out ColorArgument? result)
                {
                    return JsonElementHelpers.TryParseValue<ColorArgument>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ColorArgument(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static ColorArgument IJsonElement<ColorArgument>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ColorArgument: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ColorArgument"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ColorArgument"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public ColorArgument Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ColorArgument>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ColorArgument"/> that lives for the lifetime of its
