    ...
    public readonly partial struct Git
    {
        ...
        public readonly partial struct Paging
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Paging.ColorArgument.Mutable ColorArg
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ColorArgUtf8, out Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Paging.ColorArgument.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Paging.Pager.Mutable PagerValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PagerValueUtf8, out Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Paging.Pager.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Paging.UseConfig.Mutable UseConfigValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UseConfigValueUtf8, out Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Paging.UseConfig.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetColorArg(scoped in Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Paging.ColorArgument.Source value)
                {
                    ...
                    else
                    {
                        ...
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ColorArg, ref cvb);
                ...
                public void SetPagerValue(scoped in Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Paging.Pager.Source value)
                {
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.PagerValue, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                public void SetUseConfigValue(scoped in Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Paging.UseConfig.Source value)
                {
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.UseConfigValue, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Paging.ColorArgument.Source _createArg1;
                private readonly Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Paging.Pager.Source _createArg2;
                private readonly Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Paging.UseConfig.Source _createArg3;
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Paging.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Paging.Pager.Source pager = default,
                    in Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Paging.UseConfig.Source useConfig = default)
                {
                    colorArg.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ColorArg, ref builder);
                    pager.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.PagerValue, ref builder);
                    useConfig.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.UseConfigValue, ref builder);
                }
            ...
            /// </summary>
            /// <param name="colorArg">The value of the <c>"colorArg"</c> property.</param>
            ...
            public static ParsedJsonDocument<Paging> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<Paging>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<Paging> Create<TContext>(
            ...
            public static ParsedJsonDocument<Paging> Create(in Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Paging.ColorArgument.Source colorArg = default, in Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Paging.Pager.Source pager = default, in Corvus.LazygitBenchmark.Current.LazygitSchema.Git.Paging.UseConfig.Source useConfig = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
