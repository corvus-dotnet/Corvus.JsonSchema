        ...
        public readonly partial struct Paging
        {
            ...
            public readonly partial struct UseConfig
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<UseConfig, Mutable>(UseConfig.DefaultInstance);
                    ...
                    public static explicit operator Mutable(UseConfig instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="UseConfig"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator UseConfig(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"UseConfig.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly UseConfig Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly UseConfig Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<UseConfig>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(UseConfig instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<UseConfig, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<UseConfig> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<UseConfig>();
                    }
                    finally
                    {
