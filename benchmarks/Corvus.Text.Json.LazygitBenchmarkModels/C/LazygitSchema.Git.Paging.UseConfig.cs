...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct Git
    {
        ...
        public readonly partial struct Paging
        {
            ...
            public readonly partial struct UseConfig
#if NET8_0_OR_GREATER
                : IJsonElement<UseConfig>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="UseConfig"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal UseConfig(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static UseConfig DefaultInstance { get; } = ParsedJsonDocument<UseConfig>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(UseConfig value)
                {
                ...
                /// </returns>
                public static bool operator ==(in UseConfig left, in UseConfig right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in UseConfig left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(UseConfig instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator UseConfig(JsonElement instance)
                {
                    return UseConfig.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static UseConfig From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static UseConfig ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<UseConfig>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static UseConfig ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<UseConfig>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static UseConfig ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<UseConfig>(json, options);
                }
                ...
                /// </exception>
                public static UseConfig ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<UseConfig>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out UseConfig? result)
                {
                    return JsonElementHelpers.TryParseValue<UseConfig>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new UseConfig(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static UseConfig IJsonElement<UseConfig>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"UseConfig: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="UseConfig"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="UseConfig"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public UseConfig Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<UseConfig>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="UseConfig"/> that lives for the lifetime of its
