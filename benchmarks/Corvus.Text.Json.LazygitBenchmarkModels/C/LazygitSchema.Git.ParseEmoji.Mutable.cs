    ...
    public readonly partial struct Git
    {
        ...
        public readonly partial struct ParseEmoji
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ParseEmoji, Mutable>(ParseEmoji.DefaultInstance);
            ...
            public static ParsedJsonDocument<ParseEmoji> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ParseEmoji>();
                }
                finally
                {
