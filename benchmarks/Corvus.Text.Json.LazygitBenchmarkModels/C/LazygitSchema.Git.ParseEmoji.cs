...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct Git
    {
        ...
        public readonly partial struct ParseEmoji
#if NET8_0_OR_GREATER
            : IJsonElement<ParseEmoji>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ParseEmoji"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ParseEmoji(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ParseEmoji DefaultInstance { get; } = ParsedJsonDocument<ParseEmoji>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(ParseEmoji value)
            {
            ...
            /// </returns>
            public static bool operator ==(in ParseEmoji left, in ParseEmoji right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ParseEmoji left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ParseEmoji instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ParseEmoji(JsonElement instance)
            {
                return ParseEmoji.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ParseEmoji From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ParseEmoji ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ParseEmoji>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ParseEmoji ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ParseEmoji>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ParseEmoji ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ParseEmoji>(json, options);
            }
            ...
            /// </exception>
            public static ParseEmoji ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ParseEmoji>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ParseEmoji? result)
            {
                return JsonElementHelpers.TryParseValue<ParseEmoji>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ParseEmoji(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static ParseEmoji IJsonElement<ParseEmoji>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ParseEmoji: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ParseEmoji"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ParseEmoji"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public ParseEmoji Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ParseEmoji>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ParseEmoji"/> that lives for the lifetime of its
