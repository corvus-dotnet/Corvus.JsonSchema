    ...
    public readonly partial struct Git
    {
        ...
        public readonly partial struct SkipHookPrefix
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SkipHookPrefix, Mutable>(SkipHookPrefix.DefaultInstance);
                ...
                public static explicit operator Mutable(SkipHookPrefix instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SkipHookPrefix"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SkipHookPrefix(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SkipHookPrefix.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly SkipHookPrefix Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly SkipHookPrefix Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SkipHookPrefix>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SkipHookPrefix instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<SkipHookPrefix, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<SkipHookPrefix> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SkipHookPrefix>();
                }
                finally
                {
