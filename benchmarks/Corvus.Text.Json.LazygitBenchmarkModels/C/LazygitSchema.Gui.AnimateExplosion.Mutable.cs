...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct Gui
    {
        ...
        public readonly partial struct AnimateExplosion
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<AnimateExplosion, Mutable>(AnimateExplosion.DefaultInstance);
                ...
                public static explicit operator Mutable(AnimateExplosion instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="AnimateExplosion"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AnimateExplosion(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new AnimateExplosion(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AnimateExplosion.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="AnimateExplosion"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="AnimateExplosion"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly AnimateExplosion Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<AnimateExplosion>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="AnimateExplosion"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly AnimateExplosion Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<AnimateExplosion>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(AnimateExplosion instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<AnimateExplosion, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<AnimateExplosion> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<AnimateExplosion>();
                }
                finally
                {
