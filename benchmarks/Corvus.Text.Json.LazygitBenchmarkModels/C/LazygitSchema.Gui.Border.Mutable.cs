    ...
    public readonly partial struct Gui
    {
        ...
        public readonly partial struct Border
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<Border, Mutable>(Border.DefaultInstance);
                ...
                public static explicit operator Mutable(Border instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="Border"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Border(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new Border(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Border.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="Border"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="Border"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly Border Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<Border>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="Border"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly Border Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<Border>(_idx);
                }
                ...
                /// <param name="matchSingle">Match 1st item.</param>
                /// <param name="matchDouble">Match 2nd item.</param>
                /// <param name="matchRounded">Match 3rd item.</param>
                /// <param name="matchHidden">Match 4th item.</param>
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Func<TContext, TResult> matchRounded,
                    Func<TContext, TResult> matchHidden,
...
#endif
                {
                    ...
                    {
                        return matchRounded(context);
                    }

                    if (this.ValueEquals(Constants.Enum4))
                    {
                        return matchHidden(context);
                    }
                ...
                public TResult Match<TResult>(
                    ...
                    Func<TResult> matchRounded,
                    Func<TResult> matchHidden,
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(Border instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (Border)value;
            ...
            {
                return workspace.CreateBuilder<Border, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<Border> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<Border>();
                }
                finally
                {
