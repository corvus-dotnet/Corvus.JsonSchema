...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct Gui
    {
        ...
        public readonly partial struct BranchColors
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(BranchColors instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="BranchColors"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator BranchColors(Mutable instance)
                {
                ...
                public bool TryGetProperty(ReadOnlySpan<byte> propertyName, out Corvus.LazygitBenchmark.Current.LazygitSchema.Color.Mutable value)
                {
                    CheckValidInstance();
                ...
                /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public bool TryGetProperty(ReadOnlySpan<char> propertyName, out Corvus.LazygitBenchmark.Current.LazygitSchema.Color.Mutable value)
                {
                    CheckValidInstance();
                    return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
                }
                ...
                /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public bool TryGetProperty(string propertyName, out Corvus.LazygitBenchmark.Current.LazygitSchema.Color.Mutable value)
                {
                    CheckValidInstance();
                    return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public ObjectEnumerator<Corvus.LazygitBenchmark.Current.LazygitSchema.Color.Mutable> EnumerateObject()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateObjectEnumerator<Corvus.LazygitBenchmark.Current.LazygitSchema.Color.Mutable>(_parent, _idx);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new BranchColors(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"BranchColors.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetProperty(string propertyName, scoped in Corvus.LazygitBenchmark.Current.LazygitSchema.Color.Source value)
                {
                ...
                ///   </para>
                /// </remarks>
                public void SetProperty(ReadOnlySpan<char> propertyName, scoped in Corvus.LazygitBenchmark.Current.LazygitSchema.Color.Source value)
                {
                    CheckValidInstance();
                ...
                ///   </para>
                /// </remarks>
                public void SetProperty(ReadOnlySpan<byte> propertyName, scoped in Corvus.LazygitBenchmark.Current.LazygitSchema.Color.Source value)
                {
                    CheckValidInstance();
                ...
                /// <summary>
                /// Gets a <see cref="BranchColors"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="BranchColors"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly BranchColors Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<BranchColors>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="BranchColors"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly BranchColors Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<BranchColors>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.LazygitBenchmark.Current.LazygitSchema.Gui.BranchColors.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(BranchColors instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.LazygitBenchmark.Current.LazygitSchema.Gui.BranchColors.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<BranchColors, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<BranchColors> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<BranchColors>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<BranchColors> Create<TContext>(
