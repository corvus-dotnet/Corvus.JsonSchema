...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct Gui
    {
        ...
        public readonly partial struct CommandLogSize
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<CommandLogSize, Mutable>(CommandLogSize.DefaultInstance);
                ...
                public static explicit operator Mutable(CommandLogSize instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="CommandLogSize"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator CommandLogSize(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new CommandLogSize(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"CommandLogSize.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="CommandLogSize"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="CommandLogSize"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly CommandLogSize Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<CommandLogSize>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="CommandLogSize"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly CommandLogSize Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<CommandLogSize>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(CommandLogSize instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<CommandLogSize, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<CommandLogSize> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<CommandLogSize>();
                }
                finally
                {
