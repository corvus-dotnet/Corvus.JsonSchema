    ...
    public readonly partial struct Gui
    {
            ...
            : IJsonElement<CommitLength>
        {
            public static partial class JsonSchema
            {
                ...
                private static void MatchShowValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/properties/gui/properties/commitLength"u8, buffer, out written);
