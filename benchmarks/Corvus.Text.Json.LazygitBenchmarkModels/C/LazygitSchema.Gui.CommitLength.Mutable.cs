    ...
    public readonly partial struct Gui
    {
        ...
        public readonly partial struct CommitLength
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.LazygitBenchmark.Current.LazygitSchema.Gui.CommitLength.Show.Mutable ShowValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ShowValueUtf8, out Corvus.LazygitBenchmark.Current.LazygitSchema.Gui.CommitLength.Show.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetShowValue(scoped in Corvus.LazygitBenchmark.Current.LazygitSchema.Gui.CommitLength.Show.Source value)
                {
                    CheckValidInstance();
                    ...
                    else
                    {
                        ...
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ShowValue, ref cvb);
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.LazygitBenchmark.Current.LazygitSchema.Gui.CommitLength.Show.Source _createArg1;
                ...
                internal Source(Corvus.LazygitBenchmark.Current.LazygitSchema.Gui.CommitLength.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in Corvus.LazygitBenchmark.Current.LazygitSchema.Gui.CommitLength.Show.Source arg1)
                {
                    _createArg1 = arg1;
                    _kind = Kind.Create;
                }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.LazygitBenchmark.Current.LazygitSchema.Gui.CommitLength.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.LazygitBenchmark.Current.LazygitSchema.Gui.CommitLength.Show.Source show = default)
                {
                    show.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ShowValue, ref builder);
                }

                /// <summary>
                /// Creates an instance of a <see cref="CommitLength"/>.
                /// </summary>
                public void Create(in Corvus.LazygitBenchmark.Current.LazygitSchema.Gui.CommitLength.Show.Source show = default)
                {
                ...
                internal static void BuildCreateValue(scoped in Corvus.LazygitBenchmark.Current.LazygitSchema.Gui.CommitLength.Show.Source arg1, ref ComplexValueBuilder o)
                {
                    o.StartObject();
                    Create(ref o, arg1);
                    o.EndObject();
            ...
            /// </summary>
            /// <param name="show">The value of the <c>"show"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.LazygitBenchmark.Current.LazygitSchema.Gui.CommitLength.Show.Source show = default)
            {
                return new Source(show);
            }
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.LazygitBenchmark.Current.LazygitSchema.Gui.CommitLength.Show.Source show = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            public static ParsedJsonDocument<CommitLength> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<CommitLength>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<CommitLength> Create<TContext>(
            ...
            public static ParsedJsonDocument<CommitLength> Create(in Corvus.LazygitBenchmark.Current.LazygitSchema.Gui.CommitLength.Show.Source show = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
