...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct Gui
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="CommitLength"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal CommitLength(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static CommitLength DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.LazygitBenchmark.Current.LazygitSchema.Gui.CommitLength.Show ShowValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ShowValueUtf8, out Corvus.LazygitBenchmark.Current.LazygitSchema.Gui.CommitLength.Show value))
                    {
                        return value;
                    }

                    return Corvus.LazygitBenchmark.Current.LazygitSchema.Gui.CommitLength.Show.DefaultInstance;
                }
            }
            ...
            /// </returns>
            public static bool operator ==(in CommitLength left, in CommitLength right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in CommitLength left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(CommitLength instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator CommitLength(JsonElement instance)
            {
                return CommitLength.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CommitLength From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CommitLength ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CommitLength>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CommitLength ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CommitLength>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CommitLength ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CommitLength>(json, options);
            }
            ...
            /// </exception>
            public static CommitLength ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<CommitLength>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out CommitLength? result)
            {
                return JsonElementHelpers.TryParseValue<CommitLength>(ref reader, out result);
            }
...
#if NET
            static CommitLength IJsonElement<CommitLength>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"CommitLength: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            {
                /// <summary>
                /// Gets the JSON property name for <see cref="ShowValue"/>.
                /// </summary>
                ...
                /// Gets the JSON property name for <see cref="ShowValue"/>.
                /// </summary>
                public static ReadOnlySpan<byte> ShowValueUtf8 => "show"u8;
            }
            ...
            {
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="ShowValue"/>.
                /// </summary>
                public static ReadOnlySpan<byte> ShowValue => "show"u8;
            }
            ...
            {
                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="ShowValue"/>.
                /// </summary>
                public static ReadOnlySpan<byte> ShowValue => [0x65, 0x00, 0x00, 0x00, 0x22, 0x73, 0x68, 0x6F, 0x77, 0x22];
            }
        }
    }
}
