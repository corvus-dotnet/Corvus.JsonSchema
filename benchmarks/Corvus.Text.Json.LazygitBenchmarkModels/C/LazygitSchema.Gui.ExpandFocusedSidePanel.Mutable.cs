    ...
    public readonly partial struct Gui
    {
        ...
        public readonly partial struct ExpandFocusedSidePanel
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ExpandFocusedSidePanel, Mutable>(ExpandFocusedSidePanel.DefaultInstance);
            ...
            public static ParsedJsonDocument<ExpandFocusedSidePanel> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ExpandFocusedSidePanel>();
                }
                finally
                {
