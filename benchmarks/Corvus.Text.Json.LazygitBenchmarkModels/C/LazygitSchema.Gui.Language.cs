...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct Gui
    {
...
#endif
        {
            ...
            /// </summary>
            public static Language DefaultInstance { get; } = ParsedJsonDocument<Language>.StringConstant([.."\"auto\""u8]);
            ...
            /// <summary>
            /// Gets a <see cref="Language"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Language"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            {
                CheckValidInstance();
                return _parent.CloneElement<Language>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Language"/> that lives for the lifetime of its
            ...
            /// <param name="matchEn">Match 2nd item.</param>
            /// <param name="matchZhCn">Match 3rd item.</param>
            /// <param name="matchZhTw">Match 4th item.</param>
            /// <param name="matchPl">Match 5th item.</param>
            /// <param name="matchNl">Match 6th item.</param>
            /// <param name="matchJa">Match 7th item.</param>
            /// <param name="matchKo">Match 8th item.</param>
            /// <param name="matchRu">Match 9th item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchAuto,
                Func<TContext, TResult> matchEn,
                Func<TContext, TResult> matchZhCn,
                Func<TContext, TResult> matchZhTw,
                Func<TContext, TResult> matchPl,
                Func<TContext, TResult> matchNl,
                Func<TContext, TResult> matchJa,
                Func<TContext, TResult> matchKo,
                Func<TContext, TResult> matchRu,
            ...
            public TResult Match<TResult>(
                ...
                Func<TResult> matchEn,
                Func<TResult> matchZhCn,
                Func<TResult> matchZhTw,
                Func<TResult> matchPl,
                Func<TResult> matchNl,
                Func<TResult> matchJa,
                Func<TResult> matchKo,
                Func<TResult> matchRu,
