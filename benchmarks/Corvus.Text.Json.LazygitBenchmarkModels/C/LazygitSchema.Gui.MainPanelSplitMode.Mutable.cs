    ...
    public readonly partial struct Gui
    {
        ...
        public readonly partial struct MainPanelSplitMode
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<MainPanelSplitMode, Mutable>(MainPanelSplitMode.DefaultInstance);
            ...
            public ref struct Source
            {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (MainPanelSplitMode)value;
            ...
            public static ParsedJsonDocument<MainPanelSplitMode> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<MainPanelSplitMode>();
                }
                finally
                {
