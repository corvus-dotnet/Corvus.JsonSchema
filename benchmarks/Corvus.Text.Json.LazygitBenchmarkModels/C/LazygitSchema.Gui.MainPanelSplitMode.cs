...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct Gui
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="MainPanelSplitMode"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal MainPanelSplitMode(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static MainPanelSplitMode DefaultInstance { get; } = ParsedJsonDocument<MainPanelSplitMode>.StringConstant([.."\"flexible\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(MainPanelSplitMode value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in MainPanelSplitMode left, in MainPanelSplitMode right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in MainPanelSplitMode left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(MainPanelSplitMode instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MainPanelSplitMode(JsonElement instance)
            {
                return MainPanelSplitMode.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MainPanelSplitMode From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MainPanelSplitMode ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MainPanelSplitMode>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MainPanelSplitMode ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MainPanelSplitMode>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MainPanelSplitMode ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MainPanelSplitMode>(json, options);
            }
            ...
            /// </exception>
            public static MainPanelSplitMode ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<MainPanelSplitMode>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out MainPanelSplitMode? result)
            {
                return JsonElementHelpers.TryParseValue<MainPanelSplitMode>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new MainPanelSplitMode(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static MainPanelSplitMode IJsonElement<MainPanelSplitMode>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MainPanelSplitMode: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="MainPanelSplitMode"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="MainPanelSplitMode"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public MainPanelSplitMode Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<MainPanelSplitMode>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="MainPanelSplitMode"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public MainPanelSplitMode Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<MainPanelSplitMode>(_idx);
                }
            ...
            /// <param name="matchHorizontal">Match 1st item.</param>
            /// <param name="matchFlexible">Match 2nd item.</param>
            /// <param name="matchVertical">Match 3rd item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchHorizontal,
                Func<TContext, TResult> matchFlexible,
                Func<TContext, TResult> matchVertical,
...
#endif
            {
                ...
                {
                    return matchHorizontal(context);
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchFlexible(context);
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchVertical(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchHorizontal,
                Func<TResult> matchFlexible,
                Func<TResult> matchVertical,
