    ...
    public readonly partial struct Gui
    {
        ...
        public readonly partial struct MouseEvents
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<MouseEvents, Mutable>(MouseEvents.DefaultInstance);
                ...
                public static explicit operator Mutable(MouseEvents instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="MouseEvents"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator MouseEvents(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"MouseEvents.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly MouseEvents Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly MouseEvents Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<MouseEvents>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(MouseEvents instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<MouseEvents, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<MouseEvents> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<MouseEvents>();
                }
                finally
                {
