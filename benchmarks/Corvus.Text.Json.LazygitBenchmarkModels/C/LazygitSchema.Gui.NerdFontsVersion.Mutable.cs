    ...
    public readonly partial struct Gui
    {
        ...
        public readonly partial struct NerdFontsVersion
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<NerdFontsVersion, Mutable>(NerdFontsVersion.DefaultInstance);
                ...
                public static explicit operator Mutable(NerdFontsVersion instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="NerdFontsVersion"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator NerdFontsVersion(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new NerdFontsVersion(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"NerdFontsVersion.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="NerdFontsVersion"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="NerdFontsVersion"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly NerdFontsVersion Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<NerdFontsVersion>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="NerdFontsVersion"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly NerdFontsVersion Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<NerdFontsVersion>(_idx);
                }
                ...
                /// <param name="matchTwo">Match 1st item.</param>
                /// <param name="matchThree">Match 2nd item.</param>
                /// <param name="matchValue">Match 3rd item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> matchTwo,
                    Func<TContext, TResult> matchThree,
                    Func<TContext, TResult> matchValue,
...
#endif
                {
                    ...
                    {
                        return matchTwo(context);
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchThree(context);
                    }

                    if (this.ValueEquals(Constants.Enum3))
                    {
                        return matchValue(context);
                    }
                ...
                public TResult Match<TResult>(
                    Func<TResult> matchTwo,
                    Func<TResult> matchThree,
                    Func<TResult> matchValue,
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(NerdFontsVersion instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (NerdFontsVersion)value;
            ...
            {
                return workspace.CreateBuilder<NerdFontsVersion, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<NerdFontsVersion> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<NerdFontsVersion>();
                }
                finally
                {
