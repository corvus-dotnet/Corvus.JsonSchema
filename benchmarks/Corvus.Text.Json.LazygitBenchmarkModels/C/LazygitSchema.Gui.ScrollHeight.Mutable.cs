    ...
    public readonly partial struct Gui
    {
        ...
        public readonly partial struct ScrollHeight
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ScrollHeight, Mutable>(ScrollHeight.DefaultInstance);
                ...
                public static explicit operator Mutable(ScrollHeight instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ScrollHeight"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ScrollHeight(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ScrollHeight.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ScrollHeight Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ScrollHeight Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ScrollHeight>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ScrollHeight instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ScrollHeight, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ScrollHeight> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ScrollHeight>();
                }
                finally
                {
