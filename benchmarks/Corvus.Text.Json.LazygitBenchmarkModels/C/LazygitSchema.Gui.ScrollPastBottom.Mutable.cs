    ...
    public readonly partial struct Gui
    {
        ...
        public readonly partial struct ScrollPastBottom
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ScrollPastBottom, Mutable>(ScrollPastBottom.DefaultInstance);
                ...
                /// <summary>
                /// Gets a <see cref="ScrollPastBottom"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ScrollPastBottom"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ScrollPastBottom Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ScrollPastBottom>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ScrollPastBottom"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ScrollPastBottom Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ScrollPastBottom>(_idx);
                }
            }
            ...
            public static ParsedJsonDocument<ScrollPastBottom> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ScrollPastBottom>();
                }
                finally
                {
