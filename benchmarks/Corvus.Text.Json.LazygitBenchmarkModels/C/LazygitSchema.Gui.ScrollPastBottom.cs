...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct Gui
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ScrollPastBottom"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ScrollPastBottom(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ScrollPastBottom DefaultInstance { get; } = ParsedJsonDocument<ScrollPastBottom>.True;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(ScrollPastBottom value)
            {
            ...
            /// </returns>
            public static bool operator ==(in ScrollPastBottom left, in ScrollPastBottom right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ScrollPastBottom left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ScrollPastBottom instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ScrollPastBottom(JsonElement instance)
            {
                return ScrollPastBottom.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ScrollPastBottom From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ScrollPastBottom ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ScrollPastBottom>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ScrollPastBottom ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ScrollPastBottom>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ScrollPastBottom ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ScrollPastBottom>(json, options);
            }
            ...
            /// </exception>
            public static ScrollPastBottom ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ScrollPastBottom>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ScrollPastBottom? result)
            {
                return JsonElementHelpers.TryParseValue<ScrollPastBottom>(ref reader, out result);
            }
...
#if NET
            static ScrollPastBottom IJsonElement<ScrollPastBottom>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ScrollPastBottom: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public ScrollPastBottom Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ScrollPastBottom>(_idx);
                }
