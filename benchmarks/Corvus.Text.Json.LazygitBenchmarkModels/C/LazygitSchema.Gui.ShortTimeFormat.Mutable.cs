    ...
    public readonly partial struct Gui
    {
        ...
        public readonly partial struct ShortTimeFormat
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ShortTimeFormat, Mutable>(ShortTimeFormat.DefaultInstance);
            ...
            public static ParsedJsonDocument<ShortTimeFormat> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ShortTimeFormat>();
                }
                finally
                {
