    ...
    public readonly partial struct Gui
    {
        ...
        public readonly partial struct ShowBottomLine
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ShowBottomLine, Mutable>(ShowBottomLine.DefaultInstance);
            ...
            public static ParsedJsonDocument<ShowBottomLine> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ShowBottomLine>();
                }
                finally
                {
