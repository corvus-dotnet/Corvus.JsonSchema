    ...
    public readonly partial struct Gui
    {
        ...
        public readonly partial struct ShowBranchCommitHash
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ShowBranchCommitHash, Mutable>(ShowBranchCommitHash.DefaultInstance);
            ...
            public static ParsedJsonDocument<ShowBranchCommitHash> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ShowBranchCommitHash>();
                }
                finally
                {
