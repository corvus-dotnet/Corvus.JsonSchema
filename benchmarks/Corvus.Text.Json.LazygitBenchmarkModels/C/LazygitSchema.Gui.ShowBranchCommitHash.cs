...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct Gui
    {
        ...
        public readonly partial struct ShowBranchCommitHash
            ...
            : IJsonElement<ShowBranchCommitHash>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ShowBranchCommitHash"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ShowBranchCommitHash(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ShowBranchCommitHash DefaultInstance { get; } = ParsedJsonDocument<ShowBranchCommitHash>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(ShowBranchCommitHash value)
            {
            ...
            /// </returns>
            public static bool operator ==(in ShowBranchCommitHash left, in ShowBranchCommitHash right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ShowBranchCommitHash left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ShowBranchCommitHash instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ShowBranchCommitHash(JsonElement instance)
            {
                return ShowBranchCommitHash.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ShowBranchCommitHash From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ShowBranchCommitHash ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ShowBranchCommitHash>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ShowBranchCommitHash ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ShowBranchCommitHash>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ShowBranchCommitHash ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ShowBranchCommitHash>(json, options);
            }
            ...
            /// </exception>
            public static ShowBranchCommitHash ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ShowBranchCommitHash>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ShowBranchCommitHash? result)
            {
                return JsonElementHelpers.TryParseValue<ShowBranchCommitHash>(ref reader, out result);
            }
...
#if NET
            static ShowBranchCommitHash IJsonElement<ShowBranchCommitHash>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ShowBranchCommitHash: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public ShowBranchCommitHash Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public ShowBranchCommitHash Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ShowBranchCommitHash>(_idx);
                }
