    ...
    public readonly partial struct Gui
    {
        ...
        public readonly partial struct ShowCommandLog
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ShowCommandLog, Mutable>(ShowCommandLog.DefaultInstance);
            ...
            public static ParsedJsonDocument<ShowCommandLog> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ShowCommandLog>();
                }
                finally
                {
