...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct Gui
    {
        ...
        public readonly partial struct ShowCommandLog
#if NET8_0_OR_GREATER
            : IJsonElement<ShowCommandLog>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ShowCommandLog"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ShowCommandLog(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ShowCommandLog DefaultInstance { get; } = ParsedJsonDocument<ShowCommandLog>.True;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(ShowCommandLog value)
            {
            ...
            /// </returns>
            public static bool operator ==(in ShowCommandLog left, in ShowCommandLog right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ShowCommandLog left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ShowCommandLog instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ShowCommandLog(JsonElement instance)
            {
                return ShowCommandLog.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ShowCommandLog From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ShowCommandLog ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ShowCommandLog>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ShowCommandLog ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ShowCommandLog>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ShowCommandLog ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ShowCommandLog>(json, options);
            }
            ...
            /// </exception>
            public static ShowCommandLog ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ShowCommandLog>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ShowCommandLog? result)
            {
                return JsonElementHelpers.TryParseValue<ShowCommandLog>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ShowCommandLog(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static ShowCommandLog IJsonElement<ShowCommandLog>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ShowCommandLog: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ShowCommandLog"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ShowCommandLog"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public ShowCommandLog Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ShowCommandLog>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ShowCommandLog"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public ShowCommandLog Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ShowCommandLog>(_idx);
                }
