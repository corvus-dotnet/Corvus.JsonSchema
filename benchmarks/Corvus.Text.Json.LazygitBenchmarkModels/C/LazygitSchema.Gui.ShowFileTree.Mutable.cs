...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct Gui
    {
        ...
        public readonly partial struct ShowFileTree
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ShowFileTree, Mutable>(ShowFileTree.DefaultInstance);
                ...
                public static explicit operator Mutable(ShowFileTree instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ShowFileTree"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ShowFileTree(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ShowFileTree(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ShowFileTree.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ShowFileTree"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ShowFileTree"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ShowFileTree Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ShowFileTree>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ShowFileTree"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ShowFileTree Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ShowFileTree>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ShowFileTree instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ShowFileTree, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ShowFileTree> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ShowFileTree>();
                }
                finally
                {
