    ...
    public readonly partial struct Gui
    {
        ...
        public readonly partial struct ShowListFooter
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ShowListFooter, Mutable>(ShowListFooter.DefaultInstance);
                ...
                public static explicit operator Mutable(ShowListFooter instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ShowListFooter"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ShowListFooter(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ShowListFooter.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ShowListFooter Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ShowListFooter Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ShowListFooter>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ShowListFooter instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ShowListFooter, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ShowListFooter> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ShowListFooter>();
                }
                finally
                {
