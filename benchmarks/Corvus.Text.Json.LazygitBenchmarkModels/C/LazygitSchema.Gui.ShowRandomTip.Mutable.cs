    ...
    public readonly partial struct Gui
    {
        ...
        public readonly partial struct ShowRandomTip
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ShowRandomTip, Mutable>(ShowRandomTip.DefaultInstance);
                ...
                public static explicit operator Mutable(ShowRandomTip instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ShowRandomTip"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ShowRandomTip(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ShowRandomTip.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ShowRandomTip Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ShowRandomTip Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ShowRandomTip>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ShowRandomTip instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ShowRandomTip, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ShowRandomTip> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ShowRandomTip>();
                }
                finally
                {
