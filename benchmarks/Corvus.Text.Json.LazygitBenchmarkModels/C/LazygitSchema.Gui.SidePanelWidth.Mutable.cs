...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct Gui
    {
        ...
        public readonly partial struct SidePanelWidth
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SidePanelWidth, Mutable>(SidePanelWidth.DefaultInstance);
                ...
                public static explicit operator Mutable(SidePanelWidth instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SidePanelWidth"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SidePanelWidth(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new SidePanelWidth(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SidePanelWidth.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="SidePanelWidth"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="SidePanelWidth"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly SidePanelWidth Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<SidePanelWidth>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="SidePanelWidth"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly SidePanelWidth Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SidePanelWidth>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SidePanelWidth instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<SidePanelWidth, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<SidePanelWidth> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SidePanelWidth>();
                }
                finally
                {
