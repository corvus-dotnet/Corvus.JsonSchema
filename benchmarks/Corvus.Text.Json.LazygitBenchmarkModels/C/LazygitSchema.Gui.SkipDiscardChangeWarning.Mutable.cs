    ...
    public readonly partial struct Gui
    {
        ...
        public readonly partial struct SkipDiscardChangeWarning
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SkipDiscardChangeWarning, Mutable>(SkipDiscardChangeWarning.DefaultInstance);
                ...
                public static explicit operator Mutable(SkipDiscardChangeWarning instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SkipDiscardChangeWarning"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SkipDiscardChangeWarning(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SkipDiscardChangeWarning.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly SkipDiscardChangeWarning Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly SkipDiscardChangeWarning Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SkipDiscardChangeWarning>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SkipDiscardChangeWarning instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<SkipDiscardChangeWarning, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<SkipDiscardChangeWarning> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SkipDiscardChangeWarning>();
                }
                finally
                {
