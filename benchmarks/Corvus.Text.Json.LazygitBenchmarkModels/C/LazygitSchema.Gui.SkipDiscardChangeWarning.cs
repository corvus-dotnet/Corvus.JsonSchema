...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct Gui
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="SkipDiscardChangeWarning"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal SkipDiscardChangeWarning(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static SkipDiscardChangeWarning DefaultInstance { get; } = ParsedJsonDocument<SkipDiscardChangeWarning>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(SkipDiscardChangeWarning value)
            {
            ...
            /// </returns>
            public static bool operator ==(in SkipDiscardChangeWarning left, in SkipDiscardChangeWarning right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in SkipDiscardChangeWarning left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(SkipDiscardChangeWarning instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SkipDiscardChangeWarning(JsonElement instance)
            {
                return SkipDiscardChangeWarning.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SkipDiscardChangeWarning From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SkipDiscardChangeWarning ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SkipDiscardChangeWarning>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SkipDiscardChangeWarning ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SkipDiscardChangeWarning>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SkipDiscardChangeWarning ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SkipDiscardChangeWarning>(json, options);
            }
            ...
            /// </exception>
            public static SkipDiscardChangeWarning ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<SkipDiscardChangeWarning>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out SkipDiscardChangeWarning? result)
            {
                return JsonElementHelpers.TryParseValue<SkipDiscardChangeWarning>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new SkipDiscardChangeWarning(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static SkipDiscardChangeWarning IJsonElement<SkipDiscardChangeWarning>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SkipDiscardChangeWarning: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="SkipDiscardChangeWarning"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="SkipDiscardChangeWarning"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public SkipDiscardChangeWarning Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<SkipDiscardChangeWarning>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="SkipDiscardChangeWarning"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public SkipDiscardChangeWarning Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<SkipDiscardChangeWarning>(_idx);
                }
