    ...
    public readonly partial struct Gui
    {
        ...
        public readonly partial struct SkipRewordInEditorWarning
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SkipRewordInEditorWarning, Mutable>(SkipRewordInEditorWarning.DefaultInstance);
            ...
            public static ParsedJsonDocument<SkipRewordInEditorWarning> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SkipRewordInEditorWarning>();
                }
                finally
                {
