    ...
    public readonly partial struct Gui
    {
        ...
        public readonly partial struct SkipStashWarning
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SkipStashWarning, Mutable>(SkipStashWarning.DefaultInstance);
                ...
                public static explicit operator Mutable(SkipStashWarning instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SkipStashWarning"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SkipStashWarning(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SkipStashWarning.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly SkipStashWarning Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly SkipStashWarning Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SkipStashWarning>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SkipStashWarning instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<SkipStashWarning, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<SkipStashWarning> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SkipStashWarning>();
                }
                finally
                {
