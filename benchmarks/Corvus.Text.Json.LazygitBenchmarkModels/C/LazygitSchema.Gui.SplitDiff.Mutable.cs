    ...
    public readonly partial struct Gui
    {
        ...
        public readonly partial struct SplitDiff
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SplitDiff, Mutable>(SplitDiff.DefaultInstance);
                ...
                public static explicit operator Mutable(SplitDiff instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SplitDiff"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SplitDiff(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SplitDiff.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly SplitDiff Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly SplitDiff Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SplitDiff>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SplitDiff instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (SplitDiff)value;
            ...
            {
                return workspace.CreateBuilder<SplitDiff, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<SplitDiff> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SplitDiff>();
                }
                finally
                {
