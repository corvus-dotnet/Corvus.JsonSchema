...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct Gui
    {
        ...
        public readonly partial struct SplitDiff
#if NET8_0_OR_GREATER
            : IJsonElement<SplitDiff>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="SplitDiff"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal SplitDiff(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static SplitDiff DefaultInstance { get; } = ParsedJsonDocument<SplitDiff>.StringConstant([.."\"auto\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(SplitDiff value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in SplitDiff left, in SplitDiff right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in SplitDiff left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(SplitDiff instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SplitDiff(JsonElement instance)
            {
                return SplitDiff.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SplitDiff From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SplitDiff ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SplitDiff>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SplitDiff ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SplitDiff>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SplitDiff ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SplitDiff>(json, options);
            }
            ...
            /// </exception>
            public static SplitDiff ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<SplitDiff>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out SplitDiff? result)
            {
                return JsonElementHelpers.TryParseValue<SplitDiff>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new SplitDiff(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static SplitDiff IJsonElement<SplitDiff>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SplitDiff: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="SplitDiff"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="SplitDiff"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public SplitDiff Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<SplitDiff>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="SplitDiff"/> that lives for the lifetime of its
