...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct Gui
    {
        ...
        public readonly partial struct Theme
        {
            ...
            public readonly partial struct InactArray
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(InactArray instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="InactArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator InactArray(Mutable instance)
                    {
                    ...
                    public Corvus.LazygitBenchmark.Current.LazygitSchema.Color.Mutable this[int index]
                    {
                        get
                        {
                            CheckValidInstance();
                            return _parent.GetArrayIndexElement<Corvus.LazygitBenchmark.Current.LazygitSchema.Color.Mutable>(_idx, index);
                        }
                    }
                    ...
                    /// </summary>
                    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                    public ArrayEnumerator<Corvus.LazygitBenchmark.Current.LazygitSchema.Color.Mutable> EnumerateArray()
                    {
                        CheckValidInstance();
                        return EnumeratorCreator.CreateArrayEnumerator<Corvus.LazygitBenchmark.Current.LazygitSchema.Color.Mutable>(_parent, _idx);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new InactArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"InactArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    /// <summary>
                    ...
                    /// </remarks>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void SetItem(int itemIndex, in Corvus.LazygitBenchmark.Current.LazygitSchema.Color.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </remarks>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void InsertItem(int itemIndex, scoped in Corvus.LazygitBenchmark.Current.LazygitSchema.Color.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void AddItem(scoped in Corvus.LazygitBenchmark.Current.LazygitSchema.Color.Source value)
                    {
                    ...
                    ///   The parent <see cref="JsonDocument"/> has been disposed.
                    /// </exception>
                    public bool Remove(in Corvus.LazygitBenchmark.Current.LazygitSchema.Color item)
                    {
                        CheckValidInstance();
                        if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.LazygitBenchmark.Current.LazygitSchema.Color>(this, in item))
                        {
                            return false;
                        }
                    ...
                    /// </remarks>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void RemoveWhere(JsonPredicate<Corvus.LazygitBenchmark.Current.LazygitSchema.Color> predicate)
                    {
                        CheckValidInstance();
                        JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.LazygitBenchmark.Current.LazygitSchema.Color>(this, predicate);
                        _documentVersion = _parent.Version;
                    }
                    ...
                    ///   The parent <see cref="JsonDocument"/> has been disposed.
                    /// </exception>
                    public bool Replace(in Corvus.LazygitBenchmark.Current.LazygitSchema.Color oldItem, in Corvus.LazygitBenchmark.Current.LazygitSchema.Color.Source newItem)
                    {
                        CheckValidInstance();
                        ...
                        var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.LazygitBenchmark.Current.LazygitSchema.Color>(_parent, _idx);

                        while (enumerator.MoveNext())
                        {
                            Corvus.LazygitBenchmark.Current.LazygitSchema.Color current = enumerator.Current;
                    ...
                    /// <summary>
                    /// Gets a <see cref="InactArray"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="InactArray"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly InactArray Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<InactArray>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="InactArray"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly InactArray Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<InactArray>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.LazygitBenchmark.Current.LazygitSchema.Gui.Theme.InactArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(InactArray instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.LazygitBenchmark.Current.LazygitSchema.Gui.Theme.InactArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// </summary>
                    public void AddItem(in Corvus.LazygitBenchmark.Current.LazygitSchema.Color.Source value)
                    {
                ...
                {
                    return workspace.CreateBuilder<InactArray, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<InactArray> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<InactArray>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<InactArray> Create<TContext>(
