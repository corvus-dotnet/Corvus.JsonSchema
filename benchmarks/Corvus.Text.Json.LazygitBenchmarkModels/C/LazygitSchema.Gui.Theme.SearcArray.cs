    ...
    public readonly partial struct Gui
    {
        ...
        public readonly partial struct Theme
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="SearcArray"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal SearcArray(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static SearcArray DefaultInstance { get; }
                ...
                public Corvus.LazygitBenchmark.Current.LazygitSchema.Color this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.LazygitBenchmark.Current.LazygitSchema.Color>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.LazygitBenchmark.Current.LazygitSchema.Color> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.LazygitBenchmark.Current.LazygitSchema.Color>(_parent, _idx);
                }
                ...
                /// </returns>
                public static bool operator ==(in SearcArray left, in SearcArray right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in SearcArray left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(SearcArray instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SearcArray(JsonElement instance)
                {
                    return SearcArray.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SearcArray From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SearcArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<SearcArray>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SearcArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<SearcArray>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SearcArray ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<SearcArray>(json, options);
                }
                ...
                /// </exception>
                public static SearcArray ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<SearcArray>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out SearcArray? result)
                {
                    return JsonElementHelpers.TryParseValue<SearcArray>(ref reader, out result);
                }
...
#if NET
                static SearcArray IJsonElement<SearcArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SearcArray: ValueKind = {ValueKind} : \"{ToString()}\"";
