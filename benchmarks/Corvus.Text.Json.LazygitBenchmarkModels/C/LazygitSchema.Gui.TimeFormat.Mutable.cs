    ...
    public readonly partial struct Gui
    {
        ...
        public readonly partial struct TimeFormat
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<TimeFormat, Mutable>(TimeFormat.DefaultInstance);
                ...
                public static explicit operator Mutable(TimeFormat instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TimeFormat"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TimeFormat(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TimeFormat.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly TimeFormat Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly TimeFormat Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TimeFormat>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(TimeFormat instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<TimeFormat, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<TimeFormat> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TimeFormat>();
                }
                finally
                {
