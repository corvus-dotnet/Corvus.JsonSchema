...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct Gui
    {
            ...
            : IJsonElement<WindowSize>
        {
            ...
            {
                /// <summary>
                /// Corresponds to the JSON string "normal".
                /// </summary>
                Normal = 0,
                /// <summary>
                /// Corresponds to the JSON string "half".
                /// </summary>
                Half = 1,
                /// <summary>
                /// Corresponds to the JSON string "full".
                /// </summary>
                Full = 2,
            }
            ...
            public static implicit operator WindowSize(KnownValues value)
            {
                return value switch
                {
                    KnownValues.Normal => Constants.EnumJson1,
                    KnownValues.Half => Constants.EnumJson2,
                    KnownValues.Full => Constants.EnumJson3,
            ...
            public static implicit operator KnownValues(WindowSize value)
            {
            ...
            public bool TryGetKnownValue(out KnownValues result)
            {
                ...
                {
                    result = KnownValues.Normal;
                    return true;
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    result = KnownValues.Half;
                    return true;
                }
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/properties/gui/properties/windowSize"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated, as a JSON Pointer within <see cref="SchemaDocument"/>.
                /// </summary>
                public const string SchemaLocation = "/properties/gui/properties/windowSize";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/properties/gui/properties/windowSize"u8;
                ...
                private static readonly global::Corvus.Text.Json.RuntimeEvaluator.JsonSchemaEvaluator Evaluator = global::Corvus.LazygitBenchmark.Current.CorvusJsonSchemaProgram.Entry(119);
