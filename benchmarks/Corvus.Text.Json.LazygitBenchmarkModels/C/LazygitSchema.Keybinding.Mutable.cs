...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct Keybinding
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Keybinding instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Keybinding"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Keybinding(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Keybinding(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Keybinding.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Keybinding"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Keybinding"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly Keybinding Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<Keybinding>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Keybinding"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly Keybinding Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Keybinding>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(Keybinding instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<Keybinding, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<Keybinding> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Keybinding>();
            }
            finally
            {
