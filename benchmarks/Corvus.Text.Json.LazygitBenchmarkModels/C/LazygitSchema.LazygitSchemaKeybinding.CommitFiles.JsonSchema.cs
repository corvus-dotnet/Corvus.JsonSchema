    ...
    public readonly partial struct LazygitSchemaKeybinding
    {
            ...
            : IJsonElement<CommitFiles>
        {
            public static partial class JsonSchema
            {
                ...
                private static void MatchCheckoutCommitFile(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/properties/keybinding/properties/commitFiles"u8, buffer, out written);
