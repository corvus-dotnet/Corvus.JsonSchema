...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct LazygitSchemaKeybinding
    {
        ...
        public readonly partial struct CommitFiles
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(CommitFiles instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="CommitFiles"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator CommitFiles(Mutable instance)
                {
                ...
                /// <summary>
                /// Gets the (optional) <c>checkoutCommitFile</c> property.
                ...
                /// </para>
                /// </remarks>
                public Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Mutable CheckoutCommitFile
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CheckoutCommitFileUtf8, out Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Mutable value))
                        {
                            return value;
                        }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new CommitFiles(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                public void SetCheckoutCommitFile(scoped in Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Source value)
                {
                    ...
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.CheckoutCommitFileUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CheckoutCommitFileUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                    ...
                    else
                    {
                        ...
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.CheckoutCommitFile, ref cvb);
                ...
                /// <summary>
                /// Remove the <c>checkoutCommitFile</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveCheckoutCommitFile()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.CheckoutCommitFileUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"CommitFiles.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="CommitFiles"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="CommitFiles"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly CommitFiles Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<CommitFiles>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="CommitFiles"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly CommitFiles Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<CommitFiles>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(CommitFiles instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.LazygitBenchmark.Current.LazygitSchema.LazygitSchemaKeybinding.CommitFiles.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="CommitFiles"/>.
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Source checkoutCommitFile = default)
                {
                    checkoutCommitFile.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.CheckoutCommitFile, ref builder);
                }

                /// <summary>
                /// Creates an instance of a <see cref="CommitFiles"/>.
                /// </summary>
                public void Create(in Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Source checkoutCommitFile = default)
                {
                    Create(ref _builder, checkoutCommitFile);
                }
            ...
            /// </summary>
            /// <param name="workspace">The JSON workspace.</param>
            /// <param name="checkoutCommitFile">The value of the property.</param>
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Source checkoutCommitFile = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(checkoutCommitFile);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<CommitFiles, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<CommitFiles> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<CommitFiles>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<CommitFiles> Create<TContext>(
            ...
            public static ParsedJsonDocument<CommitFiles> Create(in Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Source checkoutCommitFile = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
