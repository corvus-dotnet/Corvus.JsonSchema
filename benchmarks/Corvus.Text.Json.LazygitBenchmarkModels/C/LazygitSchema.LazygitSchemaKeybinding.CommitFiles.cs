...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct LazygitSchemaKeybinding
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding CheckoutCommitFile
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CheckoutCommitFileUtf8, out Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding value))
                    {
                        return value;
                    }
            ...
            {
                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="CheckoutCommitFile"/>.
                /// </summary>
                public static ReadOnlySpan<byte> CheckoutCommitFile => [0x45, 0x01, 0x00, 0x00, 0x22, 0x63, 0x68, 0x65, 0x63, 0x6B, 0x6F, 0x75, 0x74, 0x43, 0x6F, 0x6D, 0x6D, 0x69, 0x74, 0x46, 0x69, 0x6C, 0x65, 0x22];
            }
        }
    }
}
