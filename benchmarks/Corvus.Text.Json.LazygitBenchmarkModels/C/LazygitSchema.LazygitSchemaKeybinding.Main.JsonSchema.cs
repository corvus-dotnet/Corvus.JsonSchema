...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct LazygitSchemaKeybinding
    {
            ...
            : IJsonElement<Main>
        {
            ...
            {
                private static readonly JsonSchemaPathProvider PickBothHunksSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/pickBothHunks/$ref"u8, buffer, out written);
                private static readonly JsonSchemaPathProvider ToggleDragSelectSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/toggleDragSelect/$ref"u8, buffer, out written);
                private static readonly JsonSchemaPathProvider ToggleDragSelectAltSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/toggleDragSelect-alt/$ref"u8, buffer, out written);
                private static readonly JsonSchemaPathProvider ToggleSelectHunkSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/toggleSelectHunk/$ref"u8, buffer, out written);

                private static void MatchPickBothHunks(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    ...
                    JsonSchemaContext childContext =
                        Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.JsonSchema.PushChildContextUnescaped(
                            ...
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.PickBothHunksUtf8,
                            evaluationPath: PickBothHunksSchemaEvaluationPath);
                ...
                private static void MatchToggleDragSelect(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext1 =
                        Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.JsonSchema.PushChildContextUnescaped(
                            ...
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.ToggleDragSelectUtf8,
                            evaluationPath: ToggleDragSelectSchemaEvaluationPath);
                ...
                private static void MatchToggleDragSelectAlt(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext2 =
                        Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.JsonSchema.PushChildContextUnescaped(
                            ...
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.ToggleDragSelectAltUtf8,
                            evaluationPath: ToggleDragSelectAltSchemaEvaluationPath);
                ...
                private static void MatchToggleSelectHunk(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext3 =
                        Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.JsonSchema.PushChildContextUnescaped(
                            ...
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.ToggleSelectHunkUtf8,
                            evaluationPath: ToggleSelectHunkSchemaEvaluationPath);
                ...
                private static PropertySchemaMatchers<Corvus.LazygitBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
                {
                    return new PropertySchemaMatchers<Corvus.LazygitBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator>([
                        (static () => JsonPropertyNames.PickBothHunksUtf8, MatchPickBothHunks),
                        (static () => JsonPropertyNames.ToggleDragSelectUtf8, MatchToggleDragSelect),
                        (static () => JsonPropertyNames.ToggleDragSelectAltUtf8, MatchToggleDragSelectAlt),
                        (static () => JsonPropertyNames.ToggleSelectHunkUtf8, MatchToggleSelectHunk),
                    ]);
                }
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://json.schemastore.org/lazygit.json#/properties/keybinding/properties/main"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "https://json.schemastore.org/lazygit.json#/properties/keybinding/properties/main";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://json.schemastore.org/lazygit.json#/properties/keybinding/properties/main"u8;
