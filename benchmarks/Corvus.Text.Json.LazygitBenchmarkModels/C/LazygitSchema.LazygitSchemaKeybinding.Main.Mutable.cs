...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct LazygitSchemaKeybinding
    {
        ...
        public readonly partial struct Main
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(Main instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="Main"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Main(Mutable instance)
                {
                ...
                /// <summary>
                /// Gets the (optional) <c>pickBothHunks</c> property.
                /// pick both hunks
                /// </summary>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Mutable PickBothHunks
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PickBothHunksUtf8, out Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Mutable value))
                        {
                            return value;
                        }
                ...
                /// <summary>
                /// Gets the (optional) <c>toggleDragSelect</c> property.
                /// toggle drag select
                /// </summary>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Mutable ToggleDragSelect
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ToggleDragSelectUtf8, out Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Mutable value))
                        {
                            return value;
                        }
                ...
                /// <summary>
                /// Gets the (optional) <c>toggleDragSelect-alt</c> property.
                /// toggle drag select-alt
                /// </summary>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Mutable ToggleDragSelectAlt
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ToggleDragSelectAltUtf8, out Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Mutable value))
                        {
                            return value;
                        }
                ...
                /// <summary>
                /// Gets the (optional) <c>toggleSelectHunk</c> property.
                /// toggle select hunk
                /// </summary>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Mutable ToggleSelectHunk
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ToggleSelectHunkUtf8, out Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Mutable value))
                        {
                            return value;
                        }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new Main(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                public void SetPickBothHunks(scoped in Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Source value)
                {
                    ...
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.PickBothHunksUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PickBothHunksUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                ...
                /// <summary>
                /// Remove the <c>pickBothHunks</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemovePickBothHunks()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.PickBothHunksUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                public void SetToggleDragSelect(scoped in Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Source value)
                {
                    ...
                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ToggleDragSelectUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ToggleDragSelectUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                /// <summary>
                /// Remove the <c>toggleDragSelect</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveToggleDragSelect()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ToggleDragSelectUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                public void SetToggleDragSelectAlt(scoped in Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Source value)
                {
                    ...
                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ToggleDragSelectAltUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ToggleDragSelectAltUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                /// <summary>
                /// Remove the <c>toggleDragSelect-alt</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveToggleDragSelectAlt()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ToggleDragSelectAltUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                public void SetToggleSelectHunk(scoped in Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Source value)
                {
                    ...
                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ToggleSelectHunkUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ToggleSelectHunkUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                /// <summary>
                /// Remove the <c>toggleSelectHunk</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveToggleSelectHunk()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ToggleSelectHunkUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Main.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="Main"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="Main"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly Main Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<Main>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="Main"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly Main Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<Main>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(Main instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.LazygitBenchmark.Current.LazygitSchema.LazygitSchemaKeybinding.Main.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="Main"/>.
                /// </summary>
                internal static void Create(
                    ref ComplexValueBuilder builder,
                    in Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Source pickBothHunks = default,
                    in Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Source toggleDragSelect = default,
                ...
                public void Create(
                    ...
                    in Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Source toggleSelectHunk = default)
                {
                    Create(ref _builder, pickBothHunks, toggleDragSelect, toggleDragSelectAlt, toggleSelectHunk);
                }
            ...
            /// </summary>
            /// <param name="pickBothHunks">The value of the <c>"pickBothHunks"</c> property.</param>
            /// <param name="toggleDragSelect">The value of the <c>"toggleDragSelect"</c> property.</param>
            ...
            /// </summary>
            /// <param name="workspace">The JSON workspace.</param>
            /// <param name="pickBothHunks">The value of the property.</param>
            /// <param name="toggleDragSelect">The value of the property.</param>
            /// <param name="toggleDragSelectAlt">The value of the property.</param>
            /// <param name="toggleSelectHunk">The value of the property.</param>
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Source pickBothHunks = default, in Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Source toggleDragSelect = default, in Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Source toggleDragSelectAlt = default, in Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Source toggleSelectHunk = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(pickBothHunks, toggleDragSelect, toggleDragSelectAlt, toggleSelectHunk);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<Main, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<Main> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<Main>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<Main> Create<TContext>(
            ...
            public static ParsedJsonDocument<Main> Create(in Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Source pickBothHunks = default, in Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Source toggleDragSelect = default, in Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Source toggleDragSelectAlt = default, in Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Source toggleSelectHunk = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
