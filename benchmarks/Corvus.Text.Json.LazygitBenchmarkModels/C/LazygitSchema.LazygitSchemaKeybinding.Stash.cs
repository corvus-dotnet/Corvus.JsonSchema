...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct LazygitSchemaKeybinding
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="Stash"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal Stash(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static Stash DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding PopStash
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PopStashUtf8, out Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding RenameStash
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RenameStashUtf8, out Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in Stash left, in Stash right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in Stash left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(Stash instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Stash(JsonElement instance)
            {
                return Stash.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Stash From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Stash ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Stash>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Stash ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Stash>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Stash ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Stash>(json, options);
            }
            ...
            /// </exception>
            public static Stash ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<Stash>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out Stash? result)
            {
                return JsonElementHelpers.TryParseValue<Stash>(ref reader, out result);
            }
...
#if NET
            static Stash IJsonElement<Stash>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Stash: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            public Stash Freeze()
            {
                ...
                {
                    return mutable.FreezeElement<Stash>(_idx);
                }
            ...
            {
                /// <summary>
                /// Gets the JSON property name for <see cref="PopStash"/>.
                /// </summary>
                public const string PopStash = "popStash";

                /// <summary>
                /// Gets the JSON property name for <see cref="RenameStash"/>.
                /// </summary>
                public const string RenameStash = "renameStash";

                /// <summary>
                /// Gets the JSON property name for <see cref="PopStash"/>.
                /// </summary>
                public static ReadOnlySpan<byte> PopStashUtf8 => "popStash"u8;

                /// <summary>
                /// Gets the JSON property name for <see cref="RenameStash"/>.
                /// </summary>
                public static ReadOnlySpan<byte> RenameStashUtf8 => "renameStash"u8;
            }
            ...
            {
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="PopStash"/>.
                /// </summary>
                public static ReadOnlySpan<byte> PopStash => "popStash"u8;

                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="RenameStash"/>.
                /// </summary>
                public static ReadOnlySpan<byte> RenameStash => "renameStash"u8;
            }
            ...
            {
                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="PopStash"/>.
                /// </summary>
                public static ReadOnlySpan<byte> PopStash => [0xA5, 0x00, 0x00, 0x00, 0x22, 0x70, 0x6F, 0x70, 0x53, 0x74, 0x61, 0x73, 0x68, 0x22];

                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="RenameStash"/>.
                /// </summary>
                public static ReadOnlySpan<byte> RenameStash => [0xD5, 0x00, 0x00, 0x00, 0x22, 0x72, 0x65, 0x6E, 0x61, 0x6D, 0x65, 0x53, 0x74, 0x61, 0x73, 0x68, 0x22];
            }
        }
    }
}
