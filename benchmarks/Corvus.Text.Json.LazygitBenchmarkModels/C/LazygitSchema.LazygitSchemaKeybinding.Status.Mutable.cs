    ...
    public readonly partial struct LazygitSchemaKeybinding
    {
        ...
        public readonly partial struct Status
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Mutable CheckForUpdate
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CheckForUpdateUtf8, out Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Mutable RecentRepos
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RecentReposUtf8, out Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetCheckForUpdate(scoped in Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Source value)
                {
                    ...
                    else
                    {
                        ...
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.CheckForUpdate, ref cvb);
                ...
                public void SetRecentRepos(scoped in Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Source value)
                {
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.RecentRepos, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.LazygitBenchmark.Current.LazygitSchema.LazygitSchemaKeybinding.Status.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Source checkForUpdate = default,
                    in Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Source recentRepos = default)
                {
                    checkForUpdate.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.CheckForUpdate, ref builder);
                    recentRepos.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.RecentRepos, ref builder);
                }

                /// <summary>
                /// Creates an instance of a <see cref="Status"/>.
                /// </summary>
                public void Create(in Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Source checkForUpdate = default, in Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Source recentRepos = default)
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Source checkForUpdate = default, in Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Source recentRepos = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            public static ParsedJsonDocument<Status> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<Status>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<Status> Create<TContext>(
            ...
            public static ParsedJsonDocument<Status> Create(in Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Source checkForUpdate = default, in Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Source recentRepos = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
