...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct LazygitSchemaKeybinding
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding CheckForUpdate
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CheckForUpdateUtf8, out Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding RecentRepos
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RecentReposUtf8, out Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding value))
                    {
                        return value;
                    }
            ...
            {
                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="CheckForUpdate"/>.
                /// </summary>
                public static ReadOnlySpan<byte> CheckForUpdate => [0x05, 0x01, 0x00, 0x00, 0x22, 0x63, 0x68, 0x65, 0x63, 0x6B, 0x46, 0x6F, 0x72, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x22];

                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="RecentRepos"/>.
                /// </summary>
                public static ReadOnlySpan<byte> RecentRepos => [0xD5, 0x00, 0x00, 0x00, 0x22, 0x72, 0x65, 0x63, 0x65, 0x6E, 0x74, 0x52, 0x65, 0x70, 0x6F, 0x73, 0x22];
            }
        }
    }
}
