    ...
    public readonly partial struct LazygitSchemaKeybinding
    {
        ...
        public readonly partial struct Submodules
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(Submodules instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="Submodules"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Submodules(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Mutable BulkMenu
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BulkMenuUtf8, out Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Mutable Init
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.InitUtf8, out Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Mutable Update
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UpdateUtf8, out Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetBulkMenu(scoped in Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Source value)
                {
                    ...
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.BulkMenuUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BulkMenuUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                    ...
                    else
                    {
                        ...
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.BulkMenu, ref cvb);
                ...
                /// <summary>
                /// Remove the <c>bulkMenu</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveBulkMenu()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.BulkMenuUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                public void SetUpdate(scoped in Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Source value)
                {
                    ...
                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.UpdateUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UpdateUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Update, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveUpdate()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.UpdateUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Submodules.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly Submodules Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly Submodules Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<Submodules>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(Submodules instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.LazygitBenchmark.Current.LazygitSchema.LazygitSchemaKeybinding.Submodules.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="Submodules"/>.
                /// </summary>
                internal static void Create(
                    ref ComplexValueBuilder builder,
                    in Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Source bulkMenu = default,
                    in Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Source init = default,
                    in Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Source update = default)
                {
                    bulkMenu.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.BulkMenu, ref builder);
                    init.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Init, ref builder);
                    update.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Update, ref builder);
                }
                ...
                public void Create(
                    ...
                    in Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Source update = default)
                {
                    Create(ref _builder, bulkMenu, init, update);
                }
            ...
            /// </summary>
            /// <param name="bulkMenu">The value of the <c>"bulkMenu"</c> property.</param>
            ...
            /// </summary>
            /// <param name="workspace">The JSON workspace.</param>
            /// <param name="bulkMenu">The value of the property.</param>
            /// <param name="init">The value of the property.</param>
            /// <param name="update">The value of the property.</param>
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Source bulkMenu = default, in Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Source init = default, in Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Source update = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(bulkMenu, init, update);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<Submodules, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<Submodules> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<Submodules>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<Submodules> Create<TContext>(
            ...
            public static ParsedJsonDocument<Submodules> Create(in Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Source bulkMenu = default, in Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Source init = default, in Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding.Source update = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
