...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct LazygitSchemaKeybinding
    {
        ...
        public readonly partial struct Submodules
#if NET8_0_OR_GREATER
            : IJsonElement<Submodules>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="Submodules"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal Submodules(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static Submodules DefaultInstance { get; }

            /// <summary>
            /// Gets the (optional) <c>bulkMenu</c> property.
            /// bulk menu
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding BulkMenu
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BulkMenuUtf8, out Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding Init
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.InitUtf8, out Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding Update
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UpdateUtf8, out Corvus.LazygitBenchmark.Current.LazygitSchema.Keybinding value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in Submodules left, in Submodules right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in Submodules left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(Submodules instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Submodules(JsonElement instance)
            {
                return Submodules.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Submodules From<T>(in T instance)
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out Submodules? result)
            {
                return JsonElementHelpers.TryParseValue<Submodules>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Submodules(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static Submodules IJsonElement<Submodules>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Submodules: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Submodules"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Submodules"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Submodules Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<Submodules>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Submodules"/> that lives for the lifetime of its
            ...
            {
                /// <summary>
                /// Gets the JSON property name for <see cref="BulkMenu"/>.
                /// </summary>
                public const string BulkMenu = "bulkMenu";
                ...
                /// Gets the JSON property name for <see cref="BulkMenu"/>.
                /// </summary>
                public static ReadOnlySpan<byte> BulkMenuUtf8 => "bulkMenu"u8;
            ...
            {
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="BulkMenu"/>.
                /// </summary>
                public static ReadOnlySpan<byte> BulkMenu => "bulkMenu"u8;
                ...
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="Update"/>.
                /// </summary>
