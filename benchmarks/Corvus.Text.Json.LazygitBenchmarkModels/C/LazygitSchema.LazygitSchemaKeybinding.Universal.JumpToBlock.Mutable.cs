...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct LazygitSchemaKeybinding
    {
        ...
        public readonly partial struct Universal
        {
            ...
            public readonly partial struct JumpToBlock
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<JumpToBlock, Mutable>(JumpToBlock.DefaultInstance);
                    ...
                    public static explicit operator Mutable(JumpToBlock instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="JumpToBlock"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator JumpToBlock(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new JumpToBlock(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"JumpToBlock.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    /// <summary>
                    ...
                    /// <summary>
                    /// Gets a <see cref="JumpToBlock"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="JumpToBlock"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly JumpToBlock Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<JumpToBlock>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="JumpToBlock"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly JumpToBlock Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<JumpToBlock>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.LazygitBenchmark.Current.LazygitSchema.LazygitSchemaKeybinding.Universal.JumpToBlock.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(JumpToBlock instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.LazygitBenchmark.Current.LazygitSchema.LazygitSchemaKeybinding.Universal.JumpToBlock.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
                ...
                {
                    return workspace.CreateBuilder<JumpToBlock, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<JumpToBlock> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<JumpToBlock>();
                    }
                    finally
                    {
