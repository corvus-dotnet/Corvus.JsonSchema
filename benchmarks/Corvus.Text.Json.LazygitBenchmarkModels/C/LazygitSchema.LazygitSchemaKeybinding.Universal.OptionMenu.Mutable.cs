...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct LazygitSchemaKeybinding
    {
        ...
        public readonly partial struct Universal
        {
            ...
            public readonly partial struct OptionMenu
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<OptionMenu, Mutable>(OptionMenu.DefaultInstance);
                    ...
                    public static explicit operator Mutable(OptionMenu instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="OptionMenu"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator OptionMenu(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new OptionMenu(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"OptionMenu.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="OptionMenu"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="OptionMenu"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly OptionMenu Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<OptionMenu>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="OptionMenu"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly OptionMenu Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<OptionMenu>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(OptionMenu instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<OptionMenu, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<OptionMenu> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<OptionMenu>();
                    }
                    finally
                    {
