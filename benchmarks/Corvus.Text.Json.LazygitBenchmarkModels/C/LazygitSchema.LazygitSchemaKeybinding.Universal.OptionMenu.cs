    ...
    public readonly partial struct LazygitSchemaKeybinding
    {
        ...
        public readonly partial struct Universal
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="OptionMenu"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal OptionMenu(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static OptionMenu DefaultInstance { get; } = ParsedJsonDocument<OptionMenu>.Null;
                ...
                /// </returns>
                public static bool operator ==(in OptionMenu left, in OptionMenu right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in OptionMenu left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(OptionMenu instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator OptionMenu(JsonElement instance)
                {
                    return OptionMenu.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static OptionMenu From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static OptionMenu ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<OptionMenu>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static OptionMenu ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<OptionMenu>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static OptionMenu ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<OptionMenu>(json, options);
                }
                ...
                /// </exception>
                public static OptionMenu ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<OptionMenu>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out OptionMenu? result)
                {
                    return JsonElementHelpers.TryParseValue<OptionMenu>(ref reader, out result);
                }
...
#if NET
                static OptionMenu IJsonElement<OptionMenu>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"OptionMenu: ValueKind = {ValueKind} : \"{ToString()}\"";
