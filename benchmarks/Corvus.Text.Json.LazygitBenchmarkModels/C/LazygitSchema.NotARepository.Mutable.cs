...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct NotARepository
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<NotARepository, Mutable>(NotARepository.DefaultInstance);
        ...
        public ref struct Source
        {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (NotARepository)value;
        ...
        public static ParsedJsonDocument<NotARepository> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<NotARepository>();
            }
            finally
            {
