    ...
    public readonly partial struct Os
    {
        ...
        public readonly partial struct CopyToClipboardCmd
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<CopyToClipboardCmd, Mutable>(CopyToClipboardCmd.DefaultInstance);
                ...
                public static explicit operator Mutable(CopyToClipboardCmd instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="CopyToClipboardCmd"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator CopyToClipboardCmd(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"CopyToClipboardCmd.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly CopyToClipboardCmd Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly CopyToClipboardCmd Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<CopyToClipboardCmd>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(CopyToClipboardCmd instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<CopyToClipboardCmd, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<CopyToClipboardCmd> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<CopyToClipboardCmd>();
                }
                finally
                {
