...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct Os
    {
        ...
        public readonly partial struct CopyToClipboardCmd
#if NET8_0_OR_GREATER
            : IJsonElement<CopyToClipboardCmd>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="CopyToClipboardCmd"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal CopyToClipboardCmd(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static CopyToClipboardCmd DefaultInstance { get; } = ParsedJsonDocument<CopyToClipboardCmd>.StringConstant([.."\"\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(CopyToClipboardCmd value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in CopyToClipboardCmd left, in CopyToClipboardCmd right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in CopyToClipboardCmd left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(CopyToClipboardCmd instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator CopyToClipboardCmd(JsonElement instance)
            {
                return CopyToClipboardCmd.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CopyToClipboardCmd From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CopyToClipboardCmd ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CopyToClipboardCmd>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CopyToClipboardCmd ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CopyToClipboardCmd>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CopyToClipboardCmd ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CopyToClipboardCmd>(json, options);
            }
            ...
            /// </exception>
            public static CopyToClipboardCmd ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<CopyToClipboardCmd>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out CopyToClipboardCmd? result)
            {
                return JsonElementHelpers.TryParseValue<CopyToClipboardCmd>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new CopyToClipboardCmd(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static CopyToClipboardCmd IJsonElement<CopyToClipboardCmd>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"CopyToClipboardCmd: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="CopyToClipboardCmd"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="CopyToClipboardCmd"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public CopyToClipboardCmd Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<CopyToClipboardCmd>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="CopyToClipboardCmd"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public CopyToClipboardCmd Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<CopyToClipboardCmd>(_idx);
                }
