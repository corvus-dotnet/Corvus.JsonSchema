    ...
    public readonly partial struct Os
    {
        ...
        public readonly partial struct Edit
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<Edit, Mutable>(Edit.DefaultInstance);
                ...
                public static explicit operator Mutable(Edit instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="Edit"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Edit(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Edit.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly Edit Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<Edit>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(Edit instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<Edit, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<Edit> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<Edit>();
                }
                finally
                {
