...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct Os
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="Edit"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal Edit(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static Edit DefaultInstance { get; } = ParsedJsonDocument<Edit>.StringConstant([.."\"\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(Edit value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in Edit left, in Edit right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in Edit left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(Edit instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Edit(JsonElement instance)
            {
                return Edit.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Edit From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Edit ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Edit>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Edit ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Edit>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Edit ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Edit>(json, options);
            }
            ...
            /// </exception>
            public static Edit ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<Edit>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out Edit? result)
            {
                return JsonElementHelpers.TryParseValue<Edit>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Edit(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static Edit IJsonElement<Edit>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Edit: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Edit"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Edit"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            {
                CheckValidInstance();
                return _parent.CloneElement<Edit>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Edit"/> that lives for the lifetime of its
            ...
            public Edit Freeze()
            {
                ...
                {
                    return mutable.FreezeElement<Edit>(_idx);
                }
