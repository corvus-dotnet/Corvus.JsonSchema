    ...
    public readonly partial struct Os
    {
        ...
        public readonly partial struct EditAtLine
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<EditAtLine, Mutable>(EditAtLine.DefaultInstance);
            ...
            public static ParsedJsonDocument<EditAtLine> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<EditAtLine>();
                }
                finally
                {
