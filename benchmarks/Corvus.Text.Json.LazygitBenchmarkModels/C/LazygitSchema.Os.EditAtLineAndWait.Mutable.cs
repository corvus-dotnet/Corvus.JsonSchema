    ...
    public readonly partial struct Os
    {
        ...
        public readonly partial struct EditAtLineAndWait
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<EditAtLineAndWait, Mutable>(EditAtLineAndWait.DefaultInstance);
                ...
                public static explicit operator Mutable(EditAtLineAndWait instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="EditAtLineAndWait"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator EditAtLineAndWait(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new EditAtLineAndWait(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"EditAtLineAndWait.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="EditAtLineAndWait"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="EditAtLineAndWait"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly EditAtLineAndWait Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<EditAtLineAndWait>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="EditAtLineAndWait"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly EditAtLineAndWait Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<EditAtLineAndWait>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(EditAtLineAndWait instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<EditAtLineAndWait, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<EditAtLineAndWait> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<EditAtLineAndWait>();
                }
                finally
                {
