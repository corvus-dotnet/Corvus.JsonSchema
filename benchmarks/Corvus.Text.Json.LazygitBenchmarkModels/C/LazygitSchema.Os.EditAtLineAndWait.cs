...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct Os
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="EditAtLineAndWait"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal EditAtLineAndWait(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static EditAtLineAndWait DefaultInstance { get; } = ParsedJsonDocument<EditAtLineAndWait>.StringConstant([.."\"\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(EditAtLineAndWait value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in EditAtLineAndWait left, in EditAtLineAndWait right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in EditAtLineAndWait left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(EditAtLineAndWait instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EditAtLineAndWait(JsonElement instance)
            {
                return EditAtLineAndWait.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EditAtLineAndWait From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EditAtLineAndWait ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EditAtLineAndWait>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EditAtLineAndWait ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EditAtLineAndWait>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EditAtLineAndWait ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EditAtLineAndWait>(json, options);
            }
            ...
            /// </exception>
            public static EditAtLineAndWait ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<EditAtLineAndWait>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out EditAtLineAndWait? result)
            {
                return JsonElementHelpers.TryParseValue<EditAtLineAndWait>(ref reader, out result);
            }
...
#if NET
            static EditAtLineAndWait IJsonElement<EditAtLineAndWait>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EditAtLineAndWait: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public EditAtLineAndWait Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public EditAtLineAndWait Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<EditAtLineAndWait>(_idx);
                }
