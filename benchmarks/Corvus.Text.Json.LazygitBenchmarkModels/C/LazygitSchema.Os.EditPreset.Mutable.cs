    ...
    public readonly partial struct Os
    {
        ...
        public readonly partial struct EditPreset
        {
...
#endif
            {
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.LazygitBenchmark.Current.LazygitSchema.Os.EditPreset.OneOf0Entity" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsOneOf0Entity(out Corvus.LazygitBenchmark.Current.LazygitSchema.Os.EditPreset.OneOf0Entity result)
                {
                    if (Corvus.LazygitBenchmark.Current.LazygitSchema.Os.EditPreset.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.LazygitBenchmark.Current.LazygitSchema.Os.EditPreset.OneOf1Entity" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsOneOf1Entity(out Corvus.LazygitBenchmark.Current.LazygitSchema.Os.EditPreset.OneOf1Entity result)
                {
                    if (Corvus.LazygitBenchmark.Current.LazygitSchema.Os.EditPreset.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
