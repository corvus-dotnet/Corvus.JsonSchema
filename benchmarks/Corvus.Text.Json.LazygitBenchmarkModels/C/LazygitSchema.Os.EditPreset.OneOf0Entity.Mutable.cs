        ...
        public readonly partial struct EditPreset
        {
            ...
            public readonly partial struct OneOf0Entity
            {
...
#endif
                {
                    ...
                    /// <param name="matchVim">Match 1st item.</param>
                    /// <param name="matchNvim">Match 2nd item.</param>
                    /// <param name="matchEmacs">Match 3rd item.</param>
                    /// <param name="matchNano">Match 4th item.</param>
                    /// <param name="matchVscode">Match 5th item.</param>
                    /// <param name="matchSublime">Match 6th item.</param>
                    /// <param name="matchBbedit">Match 7th item.</param>
                    /// <param name="matchKakoune">Match 8th item.</param>
                    /// <param name="matchHelix">Match 9th item.</param>
                    /// <param name="matchXcode">Match 10th item.</param>
                    /// <param name="defaultMatch">Match any other value.</param>
                    /// <returns>An instance of the value returned by the match function.</returns>
                    public TResult Match<TContext, TResult>(
                        in TContext context,
                        Func<TContext, TResult> matchVim,
                        Func<TContext, TResult> matchNvim,
                        Func<TContext, TResult> matchEmacs,
                        Func<TContext, TResult> matchNano,
                        Func<TContext, TResult> matchVscode,
                        Func<TContext, TResult> matchSublime,
                        Func<TContext, TResult> matchBbedit,
                        Func<TContext, TResult> matchKakoune,
                        Func<TContext, TResult> matchHelix,
                        Func<TContext, TResult> matchXcode,
                    ...
                    public TResult Match<TResult>(
                        ...
                        Func<TResult> matchNvim,
                        Func<TResult> matchEmacs,
                        Func<TResult> matchNano,
                        Func<TResult> matchVscode,
                        Func<TResult> matchSublime,
                        Func<TResult> matchBbedit,
                        Func<TResult> matchKakoune,
                        Func<TResult> matchHelix,
                        Func<TResult> matchXcode,
