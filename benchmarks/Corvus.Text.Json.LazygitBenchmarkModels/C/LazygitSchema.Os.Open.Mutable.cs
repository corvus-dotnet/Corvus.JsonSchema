    ...
    public readonly partial struct Os
    {
        ...
        public readonly partial struct Open
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<Open, Mutable>(Open.DefaultInstance);
            ...
            public static ParsedJsonDocument<Open> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<Open>();
                }
                finally
                {
