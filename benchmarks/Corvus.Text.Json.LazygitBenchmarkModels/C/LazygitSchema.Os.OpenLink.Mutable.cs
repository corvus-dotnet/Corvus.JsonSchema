    ...
    public readonly partial struct Os
    {
        ...
        public readonly partial struct OpenLink
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<OpenLink, Mutable>(OpenLink.DefaultInstance);
                ...
                public static explicit operator Mutable(OpenLink instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="OpenLink"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator OpenLink(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"OpenLink.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly OpenLink Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly OpenLink Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<OpenLink>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(OpenLink instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<OpenLink, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<OpenLink> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<OpenLink>();
                }
                finally
                {
