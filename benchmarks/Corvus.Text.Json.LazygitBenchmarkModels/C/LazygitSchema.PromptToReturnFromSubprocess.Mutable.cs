...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct PromptToReturnFromSubprocess
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<PromptToReturnFromSubprocess, Mutable>(PromptToReturnFromSubprocess.DefaultInstance);
            ...
            public static explicit operator Mutable(PromptToReturnFromSubprocess instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="PromptToReturnFromSubprocess"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PromptToReturnFromSubprocess(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PromptToReturnFromSubprocess.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly PromptToReturnFromSubprocess Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly PromptToReturnFromSubprocess Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<PromptToReturnFromSubprocess>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(PromptToReturnFromSubprocess instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<PromptToReturnFromSubprocess, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<PromptToReturnFromSubprocess> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<PromptToReturnFromSubprocess>();
            }
            finally
            {
