...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct PromptToReturnFromSubprocess
#if NET8_0_OR_GREATER
        : IJsonElement<PromptToReturnFromSubprocess>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PromptToReturnFromSubprocess"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal PromptToReturnFromSubprocess(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static PromptToReturnFromSubprocess DefaultInstance { get; } = ParsedJsonDocument<PromptToReturnFromSubprocess>.True;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator bool(PromptToReturnFromSubprocess value)
        {
        ...
        /// </returns>
        public static bool operator ==(in PromptToReturnFromSubprocess left, in PromptToReturnFromSubprocess right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in PromptToReturnFromSubprocess left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(PromptToReturnFromSubprocess instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PromptToReturnFromSubprocess(JsonElement instance)
        {
            return PromptToReturnFromSubprocess.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PromptToReturnFromSubprocess From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PromptToReturnFromSubprocess ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PromptToReturnFromSubprocess>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PromptToReturnFromSubprocess ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PromptToReturnFromSubprocess>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PromptToReturnFromSubprocess ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PromptToReturnFromSubprocess>(json, options);
        }
        ...
        /// </exception>
        public static PromptToReturnFromSubprocess ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<PromptToReturnFromSubprocess>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out PromptToReturnFromSubprocess? result)
        {
            return JsonElementHelpers.TryParseValue<PromptToReturnFromSubprocess>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new PromptToReturnFromSubprocess(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static PromptToReturnFromSubprocess IJsonElement<PromptToReturnFromSubprocess>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PromptToReturnFromSubprocess: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="PromptToReturnFromSubprocess"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="PromptToReturnFromSubprocess"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public PromptToReturnFromSubprocess Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<PromptToReturnFromSubprocess>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="PromptToReturnFromSubprocess"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public PromptToReturnFromSubprocess Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<PromptToReturnFromSubprocess>(_idx);
            }
