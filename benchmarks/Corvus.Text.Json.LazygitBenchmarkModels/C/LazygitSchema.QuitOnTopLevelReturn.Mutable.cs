...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct QuitOnTopLevelReturn
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<QuitOnTopLevelReturn, Mutable>(QuitOnTopLevelReturn.DefaultInstance);
        ...
        public static ParsedJsonDocument<QuitOnTopLevelReturn> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<QuitOnTopLevelReturn>();
            }
            finally
            {
