...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct QuitOnTopLevelReturn
        ...
        : IJsonElement<QuitOnTopLevelReturn>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="QuitOnTopLevelReturn"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal QuitOnTopLevelReturn(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static QuitOnTopLevelReturn DefaultInstance { get; } = ParsedJsonDocument<QuitOnTopLevelReturn>.False;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator bool(QuitOnTopLevelReturn value)
        {
        ...
        /// </returns>
        public static bool operator ==(in QuitOnTopLevelReturn left, in QuitOnTopLevelReturn right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in QuitOnTopLevelReturn left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(QuitOnTopLevelReturn instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator QuitOnTopLevelReturn(JsonElement instance)
        {
            return QuitOnTopLevelReturn.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static QuitOnTopLevelReturn From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static QuitOnTopLevelReturn ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<QuitOnTopLevelReturn>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static QuitOnTopLevelReturn ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<QuitOnTopLevelReturn>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static QuitOnTopLevelReturn ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<QuitOnTopLevelReturn>(json, options);
        }
        ...
        /// </exception>
        public static QuitOnTopLevelReturn ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<QuitOnTopLevelReturn>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out QuitOnTopLevelReturn? result)
        {
            return JsonElementHelpers.TryParseValue<QuitOnTopLevelReturn>(ref reader, out result);
        }
...
#if NET
        static QuitOnTopLevelReturn IJsonElement<QuitOnTopLevelReturn>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"QuitOnTopLevelReturn: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public QuitOnTopLevelReturn Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public QuitOnTopLevelReturn Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<QuitOnTopLevelReturn>(_idx);
            }
