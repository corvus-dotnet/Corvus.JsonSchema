    ...
    public readonly partial struct Refresher
    {
        ...
        public readonly partial struct FetchInterval
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<FetchInterval, Mutable>(FetchInterval.DefaultInstance);
                ...
                public static explicit operator Mutable(FetchInterval instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="FetchInterval"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator FetchInterval(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"FetchInterval.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly FetchInterval Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly FetchInterval Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<FetchInterval>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(FetchInterval instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<FetchInterval, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<FetchInterval> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<FetchInterval>();
                }
                finally
                {
