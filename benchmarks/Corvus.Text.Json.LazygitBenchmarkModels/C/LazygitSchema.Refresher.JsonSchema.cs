...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct Refresher
        : IJsonElement<Refresher>
    {
        public static partial class JsonSchema
        {
            private static readonly JsonSchemaPathProvider FetchIntervalValueSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/fetchInterval"u8, buffer, out written);
            private static readonly JsonSchemaPathProvider RefreshIntervalValueSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/refreshInterval"u8, buffer, out written);

            private static void MatchFetchIntervalValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext =
                    Corvus.LazygitBenchmark.Current.LazygitSchema.Refresher.FetchInterval.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.FetchIntervalValueUtf8,
                        evaluationPath: FetchIntervalValueSchemaEvaluationPath);

                Corvus.LazygitBenchmark.Current.LazygitSchema.Refresher.FetchInterval.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                context.CommitChildContext(childContext.IsMatch, ref childContext);
            }

            private static void MatchRefreshIntervalValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext1 =
                    Corvus.LazygitBenchmark.Current.LazygitSchema.Refresher.RefreshInterval.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.RefreshIntervalValueUtf8,
                        evaluationPath: RefreshIntervalValueSchemaEvaluationPath);

                Corvus.LazygitBenchmark.Current.LazygitSchema.Refresher.RefreshInterval.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
            ...
            private static PropertySchemaMatchers<Corvus.LazygitBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
            {
                return new PropertySchemaMatchers<Corvus.LazygitBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator>([
                    (static () => JsonPropertyNames.FetchIntervalValueUtf8, MatchFetchIntervalValue),
                    (static () => JsonPropertyNames.RefreshIntervalValueUtf8, MatchRefreshIntervalValue),
                ]);
            }
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://json.schemastore.org/lazygit.json#/properties/refresher"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "https://json.schemastore.org/lazygit.json#/properties/refresher";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://json.schemastore.org/lazygit.json#/properties/refresher"u8;
