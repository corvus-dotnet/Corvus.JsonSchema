...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct Refresher
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.LazygitBenchmark.Current.LazygitSchema.Refresher.FetchInterval.Mutable FetchIntervalValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FetchIntervalValueUtf8, out Corvus.LazygitBenchmark.Current.LazygitSchema.Refresher.FetchInterval.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.LazygitBenchmark.Current.LazygitSchema.Refresher.RefreshInterval.Mutable RefreshIntervalValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RefreshIntervalValueUtf8, out Corvus.LazygitBenchmark.Current.LazygitSchema.Refresher.RefreshInterval.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetFetchIntervalValue(scoped in Corvus.LazygitBenchmark.Current.LazygitSchema.Refresher.FetchInterval.Source value)
            {
                ...
                else
                {
                    ...
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.FetchIntervalValue, ref cvb);
            ...
            public void SetRefreshIntervalValue(scoped in Corvus.LazygitBenchmark.Current.LazygitSchema.Refresher.RefreshInterval.Source value)
            {
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.RefreshIntervalValue, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.LazygitBenchmark.Current.LazygitSchema.Refresher.FetchInterval.Source _createArg1;
            private readonly Corvus.LazygitBenchmark.Current.LazygitSchema.Refresher.RefreshInterval.Source _createArg2;
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.LazygitBenchmark.Current.LazygitSchema.Refresher.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.LazygitBenchmark.Current.LazygitSchema.Refresher.FetchInterval.Source fetchInterval = default,
                in Corvus.LazygitBenchmark.Current.LazygitSchema.Refresher.RefreshInterval.Source refreshInterval = default)
            {
                fetchInterval.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.FetchIntervalValue, ref builder);
                refreshInterval.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.RefreshIntervalValue, ref builder);
            }

            /// <summary>
            /// Creates an instance of a <see cref="Refresher"/>.
            /// </summary>
            public void Create(in Corvus.LazygitBenchmark.Current.LazygitSchema.Refresher.FetchInterval.Source fetchInterval = default, in Corvus.LazygitBenchmark.Current.LazygitSchema.Refresher.RefreshInterval.Source refreshInterval = default)
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.LazygitBenchmark.Current.LazygitSchema.Refresher.FetchInterval.Source fetchInterval = default, in Corvus.LazygitBenchmark.Current.LazygitSchema.Refresher.RefreshInterval.Source refreshInterval = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        public static ParsedJsonDocument<Refresher> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Refresher>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Refresher> Create<TContext>(
        ...
        public static ParsedJsonDocument<Refresher> Create(in Corvus.LazygitBenchmark.Current.LazygitSchema.Refresher.FetchInterval.Source fetchInterval = default, in Corvus.LazygitBenchmark.Current.LazygitSchema.Refresher.RefreshInterval.Source refreshInterval = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
