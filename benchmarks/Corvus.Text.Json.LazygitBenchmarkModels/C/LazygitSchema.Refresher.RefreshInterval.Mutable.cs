    ...
    public readonly partial struct Refresher
    {
        ...
        public readonly partial struct RefreshInterval
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<RefreshInterval, Mutable>(RefreshInterval.DefaultInstance);
                ...
                public static explicit operator Mutable(RefreshInterval instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RefreshInterval"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RefreshInterval(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RefreshInterval.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RefreshInterval Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RefreshInterval Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RefreshInterval>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RefreshInterval instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RefreshInterval, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RefreshInterval> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RefreshInterval>();
                }
                finally
                {
