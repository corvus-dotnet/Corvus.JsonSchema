            ...
            public readonly partial struct After
            {
                ...
                public readonly partial struct CheckForConflicts
                {
...
#endif
                    {
                        ...
                        /// </remarks>
                        public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<CheckForConflicts, Mutable>(CheckForConflicts.DefaultInstance);
                        ...
                        public static explicit operator Mutable(CheckForConflicts instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="CheckForConflicts"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator CheckForConflicts(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"CheckForConflicts.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly CheckForConflicts Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly CheckForConflicts Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<CheckForConflicts>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(CheckForConflicts instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<CheckForConflicts, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<CheckForConflicts> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<CheckForConflicts>();
                        }
                        finally
                        {
