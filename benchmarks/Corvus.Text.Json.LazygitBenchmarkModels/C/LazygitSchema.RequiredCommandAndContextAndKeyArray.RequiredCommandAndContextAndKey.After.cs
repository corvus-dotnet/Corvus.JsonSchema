    ...
    public readonly partial struct RequiredCommandAndContextAndKeyArray
    {
        ...
        public readonly partial struct RequiredCommandAndContextAndKey
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="After"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal After(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static After DefaultInstance { get; }

                /// <summary>
                /// Gets the (optional) <c>checkForConflicts</c> property.
                /// check for conflicts
                /// </summary>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public Corvus.LazygitBenchmark.Current.LazygitSchema.RequiredCommandAndContextAndKeyArray.RequiredCommandAndContextAndKey.After.CheckForConflicts CheckForConflictsValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CheckForConflictsValueUtf8, out Corvus.LazygitBenchmark.Current.LazygitSchema.RequiredCommandAndContextAndKeyArray.RequiredCommandAndContextAndKey.After.CheckForConflicts value))
                        {
                            return value;
                        }

                        return Corvus.LazygitBenchmark.Current.LazygitSchema.RequiredCommandAndContextAndKeyArray.RequiredCommandAndContextAndKey.After.CheckForConflicts.DefaultInstance;
                    }
                }
                ...
                /// </returns>
                public static bool operator ==(in After left, in After right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in After left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(After instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator After(JsonElement instance)
                {
                    return After.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static After From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static After ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<After>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static After ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<After>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static After ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<After>(json, options);
                }
                ...
                /// </exception>
                public static After ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<After>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out After? result)
                {
                    return JsonElementHelpers.TryParseValue<After>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new After(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static After IJsonElement<After>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"After: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="After"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="After"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                {
                    CheckValidInstance();
                    return _parent.CloneElement<After>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="After"/> that lives for the lifetime of its
                ...
                public After Freeze()
                {
                    ...
                    {
                        return mutable.FreezeElement<After>(_idx);
                    }
                ...
                {
                    /// <summary>
                    /// Gets the JSON property name for <see cref="CheckForConflictsValue"/>.
                    /// </summary>
                    public const string CheckForConflictsValue = "checkForConflicts";

                    /// <summary>
                    /// Gets the JSON property name for <see cref="CheckForConflictsValue"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> CheckForConflictsValueUtf8 => "checkForConflicts"u8;
                }
                ...
                {
                    /// <summary>
                    /// Gets the escaped UTF-8 JSON property name for <see cref="CheckForConflictsValue"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> CheckForConflictsValue => "checkForConflicts"u8;
                }
                ...
                {
                    /// <summary>
                    /// Gets the pre-baked property name blob for <see cref="CheckForConflictsValue"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> CheckForConflictsValue => [0x35, 0x01, 0x00, 0x00, 0x22, 0x63, 0x68, 0x65, 0x63, 0x6B, 0x46, 0x6F, 0x72, 0x43, 0x6F, 0x6E, 0x66, 0x6C, 0x69, 0x63, 0x74, 0x73, 0x22];
                }
            }
        }
    }
