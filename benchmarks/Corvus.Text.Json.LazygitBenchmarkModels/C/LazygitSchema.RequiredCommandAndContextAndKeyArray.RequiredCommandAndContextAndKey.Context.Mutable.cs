        ...
        public readonly partial struct RequiredCommandAndContextAndKey
        {
            ...
            public readonly partial struct Context
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(Context instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="Context"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Context(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"Context.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly Context Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<Context>(_idx);
                    }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(Context instance) => new(JsonElement.From(instance));
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Source(KnownValues value) => (Context)value;
                ...
                {
                    return workspace.CreateBuilder<Context, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<Context> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<Context>();
                    }
                    finally
                    {
