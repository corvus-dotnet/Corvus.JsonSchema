        ...
        public readonly partial struct RequiredCommandAndContextAndKey
        {
            ...
            public readonly partial struct LoadingText
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<LoadingText, Mutable>(LoadingText.DefaultInstance);
                    ...
                    public static explicit operator Mutable(LoadingText instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="LoadingText"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator LoadingText(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"LoadingText.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly LoadingText Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly LoadingText Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<LoadingText>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(LoadingText instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<LoadingText, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<LoadingText> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<LoadingText>();
                    }
                    finally
                    {
