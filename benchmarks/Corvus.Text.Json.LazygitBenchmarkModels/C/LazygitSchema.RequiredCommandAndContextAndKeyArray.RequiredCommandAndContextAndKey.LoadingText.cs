...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct RequiredCommandAndContextAndKeyArray
    {
        ...
        public readonly partial struct RequiredCommandAndContextAndKey
        {
            ...
            public readonly partial struct LoadingText
#if NET8_0_OR_GREATER
                : IJsonElement<LoadingText>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="LoadingText"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal LoadingText(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static LoadingText DefaultInstance { get; } = ParsedJsonDocument<LoadingText>.StringConstant([.."\"\""u8]);
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(LoadingText value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in LoadingText left, in LoadingText right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in LoadingText left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(LoadingText instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator LoadingText(JsonElement instance)
                {
                    return LoadingText.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static LoadingText From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static LoadingText ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<LoadingText>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static LoadingText ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<LoadingText>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static LoadingText ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<LoadingText>(json, options);
                }
                ...
                /// </exception>
                public static LoadingText ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<LoadingText>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out LoadingText? result)
                {
                    return JsonElementHelpers.TryParseValue<LoadingText>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new LoadingText(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static LoadingText IJsonElement<LoadingText>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"LoadingText: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="LoadingText"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="LoadingText"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public LoadingText Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<LoadingText>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="LoadingText"/> that lives for the lifetime of its
