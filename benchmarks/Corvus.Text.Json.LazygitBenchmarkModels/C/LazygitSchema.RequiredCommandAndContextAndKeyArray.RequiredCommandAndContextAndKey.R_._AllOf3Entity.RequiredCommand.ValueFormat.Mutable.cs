                        ...
                        public readonly partial struct RequiredCommand
                        {
                            ...
                            public readonly partial struct ValueFormat
                            {
...
#endif
                                {
                                    ...
                                    /// </remarks>
                                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ValueFormat, Mutable>(ValueFormat.DefaultInstance);
                                    ...
                                    public static explicit operator Mutable(ValueFormat instance)
                                    {
                                    ...
                                    /// <returns>An immutable instance of a <see cref="ValueFormat"/>, initialized from the <see cref="Mutable"/> value.</returns>
                                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                    public static implicit operator ValueFormat(Mutable instance)
                                    {
                                    ...
                                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                    private string DebuggerDisplay => $"ValueFormat.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                                    ...
                                    /// </para>
                                    /// </remarks>
                                    public readonly ValueFormat Clone()
                                    {
                                        CheckValidInstance();
                                    ...
                                    /// </para>
                                    /// </remarks>
                                    public readonly ValueFormat Freeze()
                                    {
                                        CheckValidInstance();
                                        return _parent.FreezeElement<ValueFormat>(_idx);
                                    }
                                }
                                ...
                                public ref struct Source
                                {
                                    ...
                                    public static implicit operator Source(ValueFormat instance) => new(JsonElement.From(instance));
                                ...
                                {
                                    return workspace.CreateBuilder<ValueFormat, Mutable>(this);
                                }
                                ...
                                public static ParsedJsonDocument<ValueFormat> Create(
                                    scoped in Source value, int initialCapacity = 1)
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        Debug.Assert(cvb.MemberCount == 1);
                                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                        return documentBuilder.ToParsedJsonDocument<ValueFormat>();
                                    }
                                    finally
                                    {
