                                ...
                                public readonly partial struct AnOption
                                {
                                    ...
                                    public readonly partial struct Description
                                    {
...
#endif
                                        {
                                            ...
                                            /// </remarks>
                                            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<Description, Mutable>(Description.DefaultInstance);
                                            ...
                                            public static explicit operator Mutable(Description instance)
                                            {
                                            ...
                                            /// <returns>An immutable instance of a <see cref="Description"/>, initialized from the <see cref="Mutable"/> value.</returns>
                                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                            public static implicit operator Description(Mutable instance)
                                            {
                                            ...
                                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                            private string DebuggerDisplay => $"Description.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                                            ...
                                            /// </para>
                                            /// </remarks>
                                            public readonly Description Clone()
                                            {
                                                CheckValidInstance();
                                            ...
                                            /// </para>
                                            /// </remarks>
                                            public readonly Description Freeze()
                                            {
                                                CheckValidInstance();
                                                return _parent.FreezeElement<Description>(_idx);
                                            }
                                        }
                                        ...
                                        public ref struct Source
                                        {
                                            ...
                                            public static implicit operator Source(Description instance) => new(JsonElement.From(instance));
                                        ...
                                        {
                                            return workspace.CreateBuilder<Description, Mutable>(this);
                                        }
                                        ...
                                        public static ParsedJsonDocument<Description> Create(
                                            scoped in Source value, int initialCapacity = 1)
                                        {
                                            ...
                                            try
                                            {
                                                ...
                                                Debug.Assert(cvb.MemberCount == 1);
                                                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                                return documentBuilder.ToParsedJsonDocument<Description>();
                                            }
                                            finally
                                            {
