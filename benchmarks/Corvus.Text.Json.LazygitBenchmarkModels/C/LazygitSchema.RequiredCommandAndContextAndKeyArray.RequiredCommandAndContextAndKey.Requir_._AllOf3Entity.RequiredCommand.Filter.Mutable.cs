                        ...
                        public readonly partial struct RequiredCommand
                        {
                            ...
                            public readonly partial struct Filter
                            {
...
#endif
                                {
                                    ...
                                    /// </remarks>
                                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<Filter, Mutable>(Filter.DefaultInstance);
                                    ...
                                    /// </para>
                                    /// </remarks>
                                    public readonly Filter Freeze()
                                    {
                                        CheckValidInstance();
                                        return _parent.FreezeElement<Filter>(_idx);
                                    }
                                }
                                ...
                                public static ParsedJsonDocument<Filter> Create(
                                    scoped in Source value, int initialCapacity = 1)
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        Debug.Assert(cvb.MemberCount == 1);
                                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                        return documentBuilder.ToParsedJsonDocument<Filter>();
                                    }
                                    finally
                                    {
