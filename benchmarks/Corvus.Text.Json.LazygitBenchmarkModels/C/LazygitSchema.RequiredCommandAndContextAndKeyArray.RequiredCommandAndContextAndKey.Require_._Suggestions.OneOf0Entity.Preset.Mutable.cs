                                ...
                                public readonly partial struct OneOf0Entity
                                {
                                    ...
                                    public readonly partial struct Preset
                                    {
...
#endif
                                        {
                                            ...
                                            public static explicit operator Mutable(Preset instance)
                                            {
                                            ...
                                            /// <returns>An immutable instance of a <see cref="Preset"/>, initialized from the <see cref="Mutable"/> value.</returns>
                                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                            public static implicit operator Preset(Mutable instance)
                                            {
                                            ...
                                            {
                                                return
                                                    (obj is IJsonElement value && Equals(new Preset(value.ParentDocument, value.ParentDocumentIndex))) ||
                                            ...
                                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                            private string DebuggerDisplay => $"Preset.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                                            ...
                                            /// <summary>
                                            /// Gets a <see cref="Preset"/> which can be safely stored beyond the lifetime of the
                                            /// original document.
                                            /// </summary>
                                            /// <returns>
                                            /// A <see cref="Preset"/> which can be safely stored beyond the lifetime of the
                                            /// original document.
                                            /// </returns>
                                            /// <remarks>
                                            /// <para>
                                            ...
                                            /// </para>
                                            /// </remarks>
                                            public readonly Preset Clone()
                                            {
                                                CheckValidInstance();
                                                return _parent.CloneElement<Preset>(_idx);
                                            }
                                            ...
                                            /// </summary>
                                            /// <returns>
                                            /// An immutable <see cref="Preset"/> that lives for the lifetime of its
                                            ...
                                            /// </para>
                                            /// </remarks>
                                            public readonly Preset Freeze()
                                            {
                                                CheckValidInstance();
                                                return _parent.FreezeElement<Preset>(_idx);
                                            }
                                            ...
                                            /// <param name="matchAuthors">Match 1st item.</param>
                                            /// <param name="matchBranches">Match 2nd item.</param>
                                            /// <param name="matchFiles">Match 3rd item.</param>
                                            /// <param name="matchRefs">Match 4th item.</param>
                                            ...
                                            public TResult Match<TContext, TResult>(
                                                in TContext context,
                                                Func<TContext, TResult> matchAuthors,
                                                Func<TContext, TResult> matchBranches,
                                                Func<TContext, TResult> matchFiles,
                                                Func<TContext, TResult> matchRefs,
...
#endif
                                            {
                                                ...
                                                {
                                                    return matchAuthors(context);
                                                }

                                                if (this.ValueEquals(Constants.Enum2))
                                                {
                                                    return matchBranches(context);
                                                }
                                            ...
                                            public TResult Match<TResult>(
                                                Func<TResult> matchAuthors,
                                                Func<TResult> matchBranches,
                                                Func<TResult> matchFiles,
                                                Func<TResult> matchRefs,
                                        ...
                                        public ref struct Source
                                        {
                                            ...
                                            public static implicit operator Source(Preset instance) => new(JsonElement.From(instance));
                                        ...
                                        {
                                            return workspace.CreateBuilder<Preset, Mutable>(this);
                                        }
                                        ...
                                        public static ParsedJsonDocument<Preset> Create(
                                            scoped in Source value, int initialCapacity = 1)
                                        {
                                            ...
                                            try
                                            {
                                                ...
                                                Debug.Assert(cvb.MemberCount == 1);
                                                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                                return documentBuilder.ToParsedJsonDocument<Preset>();
                                            }
                                            finally
                                            {
