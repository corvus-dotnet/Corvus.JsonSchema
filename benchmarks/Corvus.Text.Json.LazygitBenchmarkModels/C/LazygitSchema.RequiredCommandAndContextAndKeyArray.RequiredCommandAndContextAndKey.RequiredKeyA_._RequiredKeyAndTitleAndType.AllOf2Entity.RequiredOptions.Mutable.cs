                    ...
                    public readonly partial struct AllOf2Entity
                    {
                        ...
                        public readonly partial struct RequiredOptions
                        {
...
#endif
                            {
                                ...
                                public static explicit operator Mutable(RequiredOptions instance)
                                {
                                ...
                                /// <returns>An immutable instance of a <see cref="RequiredOptions"/>, initialized from the <see cref="Mutable"/> value.</returns>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static implicit operator RequiredOptions(Mutable instance)
                                {
                                ...
                                {
                                    return
                                        (obj is IJsonElement value && Equals(new RequiredOptions(value.ParentDocument, value.ParentDocumentIndex))) ||
                                ...
                                public void SetOptions(in Corvus.LazygitBenchmark.Current.LazygitSchema.RequiredCommandAndContextAndKeyArray.RequiredCommandAndContextAndKey.RequiredKeyAndTitleAndTypeArray.RequiredKeyAndTitleAndType.AllOf2Entity.RequiredOptions.AnOptionArray.Source value)
                                {
                                    ...
                                    if (value.IsUndefined)
                                    {
                                        CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("options");
                                    }
                                ...
                                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                private string DebuggerDisplay => $"RequiredOptions.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                                ...
                                /// <summary>
                                /// Gets a <see cref="RequiredOptions"/> which can be safely stored beyond the lifetime of the
                                /// original document.
                                /// </summary>
                                /// <returns>
                                /// A <see cref="RequiredOptions"/> which can be safely stored beyond the lifetime of the
                                /// original document.
                                /// </returns>
                                /// <remarks>
                                /// <para>
                                ...
                                /// </para>
                                /// </remarks>
                                public readonly RequiredOptions Clone()
                                {
                                    CheckValidInstance();
                                    return _parent.CloneElement<RequiredOptions>(_idx);
                                }
                                ...
                                /// </summary>
                                /// <returns>
                                /// An immutable <see cref="RequiredOptions"/> that lives for the lifetime of its
                                ...
                                /// </para>
                                /// </remarks>
                                public readonly RequiredOptions Freeze()
                                {
                                    CheckValidInstance();
                                    return _parent.FreezeElement<RequiredOptions>(_idx);
                                }
                            }
                            ...
                            public ref struct Source
                            {
                                ...
                                internal Source(Corvus.LazygitBenchmark.Current.LazygitSchema.RequiredCommandAndContextAndKeyArray.RequiredCommandAndContextAndKey.RequiredKeyAndTitleAndTypeArray.RequiredKeyAndTitleAndType.AllOf2Entity.RequiredOptions.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                                public static implicit operator Source(RequiredOptions instance) => new(JsonElement.From(instance));
                            ...
                            public ref struct Builder
                            {
                                ...
                                /// <summary>
                                /// Creates an instance of a <see cref="RequiredOptions"/>.
                                /// </summary>
                                internal static void Create(
                                    ref ComplexValueBuilder builder,
                                    in Corvus.LazygitBenchmark.Current.LazygitSchema.RequiredCommandAndContextAndKeyArray.RequiredCommandAndContextAndKey.RequiredKeyAndTitleAndTypeArray.RequiredKeyAndTitleAndType.AllOf2Entity.RequiredOptions.AnOptionArray.Source options,
                                ...
                                public void Create(
                                    ...
                                    in Corvus.LazygitBenchmark.Current.LazygitSchema.CustomCommandsPromptsTypeProperty.Source type = default)
                                {
                                    Create(ref _builder, options, key, title, type);
                                }
                                ...
                                internal static void Create<TContext>(
                                    in TContext context,
                                    ref ComplexValueBuilder builder,
                                    in Corvus.LazygitBenchmark.Current.LazygitSchema.RequiredCommandAndContextAndKeyArray.RequiredCommandAndContextAndKey.RequiredKeyAndTitleAndTypeArray.RequiredKeyAndTitleAndType.AllOf2Entity.RequiredOptions.AnOptionArray.Source<TContext> options,
                                    in Corvus.LazygitBenchmark.Current.JsonString.Source key = default,
                                    in Corvus.LazygitBenchmark.Current.JsonString.Source title = default,
                                    in Corvus.LazygitBenchmark.Current.LazygitSchema.CustomCommandsPromptsTypeProperty.Source type = default)
                                #if NET9_0_OR_GREATER
                                ...
                                #endif
                                {
                                    Create(context, ref _builder, options, key, title, type);
                                }
                            ...
                            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.LazygitBenchmark.Current.LazygitSchema.RequiredCommandAndContextAndKeyArray.RequiredCommandAndContextAndKey.RequiredKeyAndTitleAndTypeArray.RequiredKeyAndTitleAndType.AllOf2Entity.RequiredOptions.AnOptionArray.Source options, in Corvus.LazygitBenchmark.Current.JsonString.Source key = default, in Corvus.LazygitBenchmark.Current.JsonString.Source title = default, in Corvus.LazygitBenchmark.Current.LazygitSchema.CustomCommandsPromptsTypeProperty.Source type = default, int initialCapacity = 30)
                            {
                                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                                cvb.StartObject();
                                Builder ovb = new(cvb);
                                ovb.Create(options, key, title, type);
                                cvb = ovb._builder;
                                cvb.EndObject();
                                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                return documentBuilder;
                                ...
                                #endif
                            {
                                ...
                                cvb.StartObject();
                                Builder ovb = new(cvb);
                                ovb.Create(context, options, key, title, type);
                                cvb = ovb._builder;
                                cvb.EndObject();
                                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                return documentBuilder;
                            ...
                            {
                                return workspace.CreateBuilder<RequiredOptions, Mutable>(this);
                            }
                        }
                    }
                }
