                                ...
                                public readonly partial struct AnOption
                                {
                                    ...
                                    public readonly partial struct Value
                                    {
...
#endif
                                        {
                                            ...
                                            public static explicit operator Mutable(Value instance)
                                            {
                                            ...
                                            /// <returns>An immutable instance of a <see cref="Value"/>, initialized from the <see cref="Mutable"/> value.</returns>
                                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                            public static implicit operator Value(Mutable instance)
                                            {
                                            ...
                                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                            private string DebuggerDisplay => $"Value.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                                            ...
                                            /// </para>
                                            /// </remarks>
                                            public readonly Value Freeze()
                                            {
                                                CheckValidInstance();
                                                return _parent.FreezeElement<Value>(_idx);
                                            }
                                        }
                                        ...
                                        public ref struct Source
                                        {
                                            ...
                                            public static implicit operator Source(Value instance) => new(JsonElement.From(instance));
                                        ...
                                        {
                                            return workspace.CreateBuilder<Value, Mutable>(this);
                                        }
                                        ...
                                        public static ParsedJsonDocument<Value> Create(
                                            scoped in Source value, int initialCapacity = 1)
                                        {
                                            ...
                                            try
                                            {
                                                ...
                                                Debug.Assert(cvb.MemberCount == 1);
                                                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                                return documentBuilder.ToParsedJsonDocument<Value>();
                                            }
                                            finally
                                            {
