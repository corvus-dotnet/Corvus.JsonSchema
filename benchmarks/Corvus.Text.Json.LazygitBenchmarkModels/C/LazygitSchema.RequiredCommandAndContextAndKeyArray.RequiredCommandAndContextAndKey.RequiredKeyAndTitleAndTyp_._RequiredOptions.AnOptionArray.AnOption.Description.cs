                            ...
                            public readonly partial struct AnOptionArray
                            {
                                ...
                                public readonly partial struct AnOption
                                {
...
#endif
                                    {
                                        ...
                                        internal Description(IJsonDocument parent, int idx)
                                        {
                                            Debug.Assert(idx >= 0);
                                            _parent = parent;
                                            _idx = idx;
                                        ...
                                        /// </summary>
                                        public static Description DefaultInstance { get; } = ParsedJsonDocument<Description>.StringConstant([.."\"\""u8]);
                                        ...
                                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                        public static explicit operator string(Description value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                                        ...
                                        /// <c>True</c> if the values are equal.
                                        /// </returns>
                                        public static bool operator ==(in Description left, in JsonElement right)
                                        {
                                            return left.Equals(right);
                                        }
                                        ...
                                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                        public static implicit operator JsonElement(Description instance)
                                        {
                                        ...
                                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                        public static implicit operator Description(JsonElement instance)
                                        {
                                            return Description.From(instance);
                                        }
                                        ...
                                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                        public static Description From<T>(in T instance)
                                        ...
                                        /// </exception>
                                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                        public static Description ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                                        {
                                            return JsonElementHelpers.ParseValue<Description>(utf8Json, options);
                                        }
                                        ...
                                        /// </exception>
                                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                        public static Description ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                                        {
                                            return JsonElementHelpers.ParseValue<Description>(json, options);
                                        }
                                        ...
                                        /// </exception>
                                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                        public static Description ParseValue(string json, JsonDocumentOptions options = default)
                                        {
                                            return JsonElementHelpers.ParseValue<Description>(json, options);
                                        }
                                        ...
                                        /// </exception>
                                        public static Description ParseValue(ref Utf8JsonReader reader)
                                        {
                                            return JsonElementHelpers.ParseValue<Description>(ref reader);
                                        }
                                        ...
                                        ///   A value could not be read from the reader.
                                        /// </exception>
                                        public static bool TryParseValue(ref Utf8JsonReader reader, out Description? result)
                                        {
                                            return JsonElementHelpers.TryParseValue<Description>(ref reader, out result);
                                        }
                                        ...
                                        {
                                            return
                                                (obj is IJsonElement value && Equals(new Description(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                                        static Description IJsonElement<Description>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                        private string DebuggerDisplay => $"Description: ValueKind = {ValueKind} : \"{ToString()}\"";
                                        ...
                                        /// <summary>
                                        /// Gets a <see cref="Description"/> which can be safely stored beyond the lifetime of the
                                        /// original document.
                                        /// </summary>
                                        /// <returns>
                                        /// A <see cref="Description"/> which can be safely stored beyond the lifetime of the
                                        /// original document.
                                        /// </returns>
                                        /// <remarks>
                                        /// <para>
                                        ...
                                        {
                                            CheckValidInstance();
                                            return _parent.CloneElement<Description>(_idx);
                                        }
                                        ...
                                        /// </summary>
                                        /// <returns>
                                        /// An immutable <see cref="Description"/> that lives for the lifetime of its
                                        ...
                                        public Description Freeze()
                                        {
                                            ...
                                            {
                                                return mutable.FreezeElement<Description>(_idx);
                                            }
