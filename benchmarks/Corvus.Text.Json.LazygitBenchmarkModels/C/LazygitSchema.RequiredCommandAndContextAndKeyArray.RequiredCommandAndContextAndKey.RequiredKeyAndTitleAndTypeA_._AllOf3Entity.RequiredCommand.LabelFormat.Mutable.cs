                        ...
                        public readonly partial struct RequiredCommand
                        {
                            ...
                            public readonly partial struct LabelFormat
                            {
...
#endif
                                {
                                    ...
                                    public static explicit operator Mutable(LabelFormat instance)
                                    {
                                    ...
                                    /// <returns>An immutable instance of a <see cref="LabelFormat"/>, initialized from the <see cref="Mutable"/> value.</returns>
                                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                    public static implicit operator LabelFormat(Mutable instance)
                                    {
                                    ...
                                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                    private string DebuggerDisplay => $"LabelFormat.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                                    ...
                                    /// </para>
                                    /// </remarks>
                                    public readonly LabelFormat Clone()
                                    {
                                        CheckValidInstance();
                                    ...
                                    /// </para>
                                    /// </remarks>
                                    public readonly LabelFormat Freeze()
                                    {
                                        CheckValidInstance();
                                        return _parent.FreezeElement<LabelFormat>(_idx);
                                    }
                                }
                                ...
                                public ref struct Source
                                {
                                    ...
                                    public static implicit operator Source(LabelFormat instance) => new(JsonElement.From(instance));
                                ...
                                {
                                    return workspace.CreateBuilder<LabelFormat, Mutable>(this);
                                }
                            }
                        }
                    }
