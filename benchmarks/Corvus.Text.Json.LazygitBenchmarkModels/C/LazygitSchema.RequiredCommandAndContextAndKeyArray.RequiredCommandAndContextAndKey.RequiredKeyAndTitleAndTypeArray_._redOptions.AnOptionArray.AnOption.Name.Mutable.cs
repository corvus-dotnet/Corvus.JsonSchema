                                ...
                                public readonly partial struct AnOption
                                {
                                    ...
                                    public readonly partial struct Name
                                    {
...
#endif
                                        {
                                            ...
                                            /// </remarks>
                                            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<Name, Mutable>(Name.DefaultInstance);
                                            ...
                                            public static explicit operator Mutable(Name instance)
                                            {
                                            ...
                                            /// <returns>An immutable instance of a <see cref="Name"/>, initialized from the <see cref="Mutable"/> value.</returns>
                                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                            public static implicit operator Name(Mutable instance)
                                            {
                                            ...
                                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                            private string DebuggerDisplay => $"Name.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                                            ...
                                            /// </para>
                                            /// </remarks>
                                            public readonly Name Freeze()
                                            {
                                                CheckValidInstance();
                                                return _parent.FreezeElement<Name>(_idx);
                                            }
                                        }
                                        ...
                                        public ref struct Source
                                        {
                                            ...
                                            public static implicit operator Source(Name instance) => new(JsonElement.From(instance));
                                        ...
                                        {
                                            return workspace.CreateBuilder<Name, Mutable>(this);
                                        }
                                        ...
                                        public static ParsedJsonDocument<Name> Create(
                                            scoped in Source value, int initialCapacity = 1)
                                        {
                                            ...
                                            try
                                            {
                                                ...
                                                Debug.Assert(cvb.MemberCount == 1);
                                                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                                return documentBuilder.ToParsedJsonDocument<Name>();
                                            }
                                            finally
                                            {
