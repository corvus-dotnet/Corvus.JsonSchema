                        ...
                        public readonly partial struct ThenEntity
                        {
                            ...
                            public readonly partial struct Suggestions
                            {
                                ...
                                public readonly partial struct OneOf0Entity
                                {
                                    ...
                                    public static ParsedJsonDocument<OneOf0Entity> Create(in Corvus.LazygitBenchmark.Current.LazygitSchema.RequiredCommandAndContextAndKeyArray.RequiredCommandAndContextAndKey.RequiredKeyAndTitleAndTypeArray.RequiredKeyAndTitleAndType.AllOf0Entity.ThenEntity.Suggestions.OneOf0Entity.Preset.Source preset = default, int initialCapacity = 30)
                                    {
                                        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                                        try
                                        {
