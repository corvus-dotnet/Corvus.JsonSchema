                ...
                public readonly partial struct RequiredKeyAndTitleAndType
                {
                    ...
                    public readonly partial struct AllOf3Entity
                    {
                        ...
                        public readonly partial struct RequiredCommand
                        {
                            ...
                            public readonly partial struct ValueFormat
#if NET8_0_OR_GREATER
                                : IJsonElement<ValueFormat>,
                                  IFormattable,
                                  ISpanFormattable,
...
#endif
                            {
                                ...
                                /// <summary>
                                /// Initializes a new instance of the <see cref="ValueFormat"/> struct.
                                /// </summary>
                                /// <param name="value">The value from which to construct the instance.</param>
                                internal ValueFormat(IJsonDocument parent, int idx)
                                {
                                    Debug.Assert(idx >= 0);
                                    _parent = parent;
                                    _idx = idx;
                                ...
                                /// </summary>
                                public static ValueFormat DefaultInstance { get; } = ParsedJsonDocument<ValueFormat>.StringConstant([.."\"\""u8]);
                                ...
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static explicit operator string(ValueFormat value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                                ...
                                /// </returns>
                                public static bool operator ==(in ValueFormat left, in ValueFormat right)
                                {
                                ...
                                /// <c>True</c> if the values are equal.
                                /// </returns>
                                public static bool operator ==(in ValueFormat left, in JsonElement right)
                                {
                                    return left.Equals(right);
                                }
                                ...
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static implicit operator JsonElement(ValueFormat instance)
                                {
                                ...
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static implicit operator ValueFormat(JsonElement instance)
                                {
                                    return ValueFormat.From(instance);
                                }
                                ...
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static ValueFormat From<T>(in T instance)
                                ...
                                /// </exception>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static ValueFormat ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                                {
                                    return JsonElementHelpers.ParseValue<ValueFormat>(utf8Json, options);
                                }
                                ...
                                /// </exception>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static ValueFormat ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                                {
                                    return JsonElementHelpers.ParseValue<ValueFormat>(json, options);
                                }
                                ...
                                /// </exception>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static ValueFormat ParseValue(string json, JsonDocumentOptions options = default)
                                {
                                    return JsonElementHelpers.ParseValue<ValueFormat>(json, options);
                                }
                                ...
                                /// </exception>
                                public static ValueFormat ParseValue(ref Utf8JsonReader reader)
                                {
                                    return JsonElementHelpers.ParseValue<ValueFormat>(ref reader);
                                }
                                ...
                                ///   A value could not be read from the reader.
                                /// </exception>
                                public static bool TryParseValue(ref Utf8JsonReader reader, out ValueFormat? result)
                                {
                                    return JsonElementHelpers.TryParseValue<ValueFormat>(ref reader, out result);
                                }
                                ...
                                {
                                    return
                                        (obj is IJsonElement value && Equals(new ValueFormat(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                                static ValueFormat IJsonElement<ValueFormat>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                private string DebuggerDisplay => $"ValueFormat: ValueKind = {ValueKind} : \"{ToString()}\"";
                                ...
                                /// <summary>
                                /// Gets a <see cref="ValueFormat"/> which can be safely stored beyond the lifetime of the
                                /// original document.
                                /// </summary>
                                /// <returns>
                                /// A <see cref="ValueFormat"/> which can be safely stored beyond the lifetime of the
                                /// original document.
                                /// </returns>
                                /// <remarks>
                                /// <para>
                                ...
                                {
                                    CheckValidInstance();
                                    return _parent.CloneElement<ValueFormat>(_idx);
                                }
                                ...
                                /// </summary>
                                /// <returns>
                                /// An immutable <see cref="ValueFormat"/> that lives for the lifetime of its
