...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct RequiredCommandAndContextAndKeyArray
    {
        ...
        public readonly partial struct RequiredCommandAndContextAndKey
        {
            ...
            public readonly partial struct Subprocess
#if NET8_0_OR_GREATER
                : IJsonElement<Subprocess>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="Subprocess"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal Subprocess(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static Subprocess DefaultInstance { get; } = ParsedJsonDocument<Subprocess>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(Subprocess value)
                {
                ...
                /// </returns>
                public static bool operator ==(in Subprocess left, in Subprocess right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in Subprocess left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(Subprocess instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Subprocess(JsonElement instance)
                {
                    return Subprocess.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Subprocess From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Subprocess ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<Subprocess>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Subprocess ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<Subprocess>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Subprocess ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<Subprocess>(json, options);
                }
                ...
                /// </exception>
                public static Subprocess ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<Subprocess>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out Subprocess? result)
                {
                    return JsonElementHelpers.TryParseValue<Subprocess>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new Subprocess(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static Subprocess IJsonElement<Subprocess>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Subprocess: ValueKind = {ValueKind} : \"{ToString()}\"";
