                ...
                public readonly partial struct RequiredKeyAndTitleAndType
                {
                    ...
                    public readonly partial struct AllOf3Entity
                    {
                        ...
                        public readonly partial struct WithTypeMenuFromCommand
                            ...
                            : IJsonElement<WithTypeMenuFromCommand>,
                              IFormattable,
                              ISpanFormattable,
...
#endif
                        {
                            ...
                            /// <summary>
                            /// Initializes a new instance of the <see cref="WithTypeMenuFromCommand"/> struct.
                            /// </summary>
                            /// <param name="value">The value from which to construct the instance.</param>
                            internal WithTypeMenuFromCommand(IJsonDocument parent, int idx)
                            {
                                Debug.Assert(idx >= 0);
                                _parent = parent;
                                _idx = idx;
                            ...
                            /// </summary>
                            public static WithTypeMenuFromCommand DefaultInstance { get; }
                            ...
                            /// </summary>
                            public Corvus.LazygitBenchmark.Current.LazygitSchema.RequiredCommandAndContextAndKeyArray.RequiredCommandAndContextAndKey.RequiredKeyAndTitleAndTypeArray.RequiredKeyAndTitleAndType.AllOf3Entity.WithTypeMenuFromCommand.TypeEntity Type
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.LazygitBenchmark.Current.LazygitSchema.RequiredCommandAndContextAndKeyArray.RequiredCommandAndContextAndKey.RequiredKeyAndTitleAndTypeArray.RequiredKeyAndTitleAndType.AllOf3Entity.WithTypeMenuFromCommand.TypeEntity value))
                                    {
                                        return value;
                                    }
                            ...
                            /// </returns>
                            public static bool operator ==(in WithTypeMenuFromCommand left, in WithTypeMenuFromCommand right)
                            {
                            ...
                            /// <c>True</c> if the values are equal.
                            /// </returns>
                            public static bool operator ==(in WithTypeMenuFromCommand left, in JsonElement right)
                            {
                                return left.Equals(right);
                            }
                            ...
                            public static implicit operator JsonElement(WithTypeMenuFromCommand instance)
                            {
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator WithTypeMenuFromCommand(JsonElement instance)
                            {
                                return WithTypeMenuFromCommand.From(instance);
                            }
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static WithTypeMenuFromCommand From<T>(in T instance)
                            ...
                            /// </exception>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static WithTypeMenuFromCommand ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                            {
                                return JsonElementHelpers.ParseValue<WithTypeMenuFromCommand>(utf8Json, options);
                            }
                            ...
                            /// </exception>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static WithTypeMenuFromCommand ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                            {
                                return JsonElementHelpers.ParseValue<WithTypeMenuFromCommand>(json, options);
                            }
                            ...
                            /// </exception>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static WithTypeMenuFromCommand ParseValue(string json, JsonDocumentOptions options = default)
                            {
                                return JsonElementHelpers.ParseValue<WithTypeMenuFromCommand>(json, options);
                            }
                            ...
                            /// </exception>
                            public static WithTypeMenuFromCommand ParseValue(ref Utf8JsonReader reader)
                            {
                                return JsonElementHelpers.ParseValue<WithTypeMenuFromCommand>(ref reader);
                            }
                            ...
                            ///   A value could not be read from the reader.
                            /// </exception>
                            public static bool TryParseValue(ref Utf8JsonReader reader, out WithTypeMenuFromCommand? result)
                            {
                                return JsonElementHelpers.TryParseValue<WithTypeMenuFromCommand>(ref reader, out result);
                            }
...
#if NET
                            static WithTypeMenuFromCommand IJsonElement<WithTypeMenuFromCommand>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            private string DebuggerDisplay => $"WithTypeMenuFromCommand: ValueKind = {ValueKind} : \"{ToString()}\"";
                            ...
                            /// </para>
                            /// </remarks>
                            public WithTypeMenuFromCommand Clone()
                            {
                                CheckValidInstance();
                            ...
                            /// </para>
                            /// </remarks>
                            public WithTypeMenuFromCommand Freeze()
                            {
                                CheckValidInstance();
                                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                                {
                                    return mutable.FreezeElement<WithTypeMenuFromCommand>(_idx);
                                }
