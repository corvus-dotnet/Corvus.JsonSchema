                    ...
                    public readonly partial struct AllOf0Entity
                    {
                            ...
                            : IJsonElement<ThenEntity>
                        {
                            public static partial class JsonSchema
                            {
                                ...
                                private static void MatchInitialValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                                {
                                ...
                                private static void MatchSuggestionsValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                                {
                                    context.AddLocalEvaluatedProperty(propertyCount);
