    ...
    public readonly partial struct Services
    {
        ...
        public readonly partial struct Service
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(Service instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="Service"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Service(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new Service(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Service.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="Service"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="Service"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly Service Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<Service>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="Service"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly Service Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<Service>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(Service instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<Service, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<Service> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<Service>();
                }
                finally
                {
