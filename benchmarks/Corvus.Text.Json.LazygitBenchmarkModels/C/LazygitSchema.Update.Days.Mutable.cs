    ...
    public readonly partial struct Update
    {
        ...
        public readonly partial struct Days
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<Days, Mutable>(Days.DefaultInstance);
            ...
            public static ParsedJsonDocument<Days> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<Days>();
                }
                finally
                {
