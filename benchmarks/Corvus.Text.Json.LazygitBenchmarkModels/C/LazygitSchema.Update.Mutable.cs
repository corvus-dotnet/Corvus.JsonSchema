...
public readonly partial struct LazygitSchema
{
    ...
    public readonly partial struct Update
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Update instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Update"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Update(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.LazygitBenchmark.Current.LazygitSchema.Update.Days.Mutable DaysValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DaysValueUtf8, out Corvus.LazygitBenchmark.Current.LazygitSchema.Update.Days.Mutable value))
                    {
                        return value;
                    }

                    return Corvus.LazygitBenchmark.Current.LazygitSchema.Update.Days.Mutable.DefaultInstance;
                }
            }
            ...
            /// </para>
            /// </remarks>
            public Corvus.LazygitBenchmark.Current.LazygitSchema.Update.Method.Mutable MethodValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MethodValueUtf8, out Corvus.LazygitBenchmark.Current.LazygitSchema.Update.Method.Mutable value))
                    {
                        return value;
                    }

                    return Corvus.LazygitBenchmark.Current.LazygitSchema.Update.Method.Mutable.DefaultInstance;
                }
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Update(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            /// <summary>
            /// Set the <c>days</c> property.
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetDaysValue(scoped in Corvus.LazygitBenchmark.Current.LazygitSchema.Update.Days.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.DaysValueUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DaysValueUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                ...
                else
                {
                    ...
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.DaysValue, ref cvb);
            ...
            /// <summary>
            /// Remove the <c>days</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveDaysValue()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.DaysValueUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetMethodValue(scoped in Corvus.LazygitBenchmark.Current.LazygitSchema.Update.Method.Source value)
            {
                CheckValidInstance();
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.MethodValue, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Update.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Update"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Update"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly Update Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<Update>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Update"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly Update Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Update>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.LazygitBenchmark.Current.LazygitSchema.Update.Days.Source _createArg1;
            private readonly Corvus.LazygitBenchmark.Current.LazygitSchema.Update.Method.Source _createArg2;
            ...
            internal Source(Corvus.LazygitBenchmark.Current.LazygitSchema.Update.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.LazygitBenchmark.Current.LazygitSchema.Update.Days.Source arg1, scoped in Corvus.LazygitBenchmark.Current.LazygitSchema.Update.Method.Source arg2)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _kind = Kind.Create;
            ...
            public static implicit operator Source(Update instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.LazygitBenchmark.Current.LazygitSchema.Update.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="Update"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.LazygitBenchmark.Current.LazygitSchema.Update.Days.Source days = default,
                in Corvus.LazygitBenchmark.Current.LazygitSchema.Update.Method.Source method = default)
            {
                days.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.DaysValue, ref builder);
                method.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.MethodValue, ref builder);
            }

            /// <summary>
            /// Creates an instance of a <see cref="Update"/>.
            /// </summary>
            public void Create(in Corvus.LazygitBenchmark.Current.LazygitSchema.Update.Days.Source days = default, in Corvus.LazygitBenchmark.Current.LazygitSchema.Update.Method.Source method = default)
            {
                Create(ref _builder, days, method);
            }
            ...
            internal static void BuildCreateValue(scoped in Corvus.LazygitBenchmark.Current.LazygitSchema.Update.Days.Source arg1, scoped in Corvus.LazygitBenchmark.Current.LazygitSchema.Update.Method.Source arg2, ref ComplexValueBuilder o)
            {
                o.StartObject();
        ...
        /// </summary>
        /// <param name="days">The value of the <c>"days"</c> property.</param>
        /// <param name="method">The value of the <c>"method"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.LazygitBenchmark.Current.LazygitSchema.Update.Days.Source days = default, scoped in Corvus.LazygitBenchmark.Current.LazygitSchema.Update.Method.Source method = default)
        {
            return new Source(days, method);
        }
        ...
        /// </summary>
        /// <param name="workspace">The JSON workspace.</param>
        /// <param name="days">The value of the property.</param>
        /// <param name="method">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.LazygitBenchmark.Current.LazygitSchema.Update.Days.Source days = default, in Corvus.LazygitBenchmark.Current.LazygitSchema.Update.Method.Source method = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(days, method);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<Update, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<Update> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Update>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Update> Create<TContext>(
        ...
        public static ParsedJsonDocument<Update> Create(in Corvus.LazygitBenchmark.Current.LazygitSchema.Update.Days.Source days = default, in Corvus.LazygitBenchmark.Current.LazygitSchema.Update.Method.Source method = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
