...
public readonly partial struct LazygitSchema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.LazygitBenchmark.Current.LazygitSchema.Update.Days DaysValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DaysValueUtf8, out Corvus.LazygitBenchmark.Current.LazygitSchema.Update.Days value))
                {
                    return value;
                }

                return Corvus.LazygitBenchmark.Current.LazygitSchema.Update.Days.DefaultInstance;
            }
        }
        ...
        /// </para>
        /// </remarks>
        public Corvus.LazygitBenchmark.Current.LazygitSchema.Update.Method MethodValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MethodValueUtf8, out Corvus.LazygitBenchmark.Current.LazygitSchema.Update.Method value))
                {
                    return value;
                }

                return Corvus.LazygitBenchmark.Current.LazygitSchema.Update.Method.DefaultInstance;
            }
        }
