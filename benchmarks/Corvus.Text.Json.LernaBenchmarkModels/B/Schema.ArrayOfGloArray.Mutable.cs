...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ArrayOfGloArray
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ArrayOfGloArray instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ArrayOfGloArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ArrayOfGloArray(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ArrayOfGloArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </para>
            /// </remarks>
            public readonly ArrayOfGloArray Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ArrayOfGloArray Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ArrayOfGloArray>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.LernaBenchmark.Baseline.Schema.ArrayOfGloArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(ArrayOfGloArray instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.LernaBenchmark.Baseline.Schema.ArrayOfGloArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<ArrayOfGloArray, Mutable>(this);
        }
    }
}
