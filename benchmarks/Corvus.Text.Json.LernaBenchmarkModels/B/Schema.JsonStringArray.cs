...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        public Corvus.LernaBenchmark.Baseline.JsonString this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.LernaBenchmark.Baseline.JsonString>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.LernaBenchmark.Baseline.JsonString> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.LernaBenchmark.Baseline.JsonString>(_parent, _idx);
        }
