...
public readonly partial struct Schema
{
    ...
    public readonly partial struct NpmClientAArray
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(NpmClientAArray instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="NpmClientAArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator NpmClientAArray(Mutable instance)
            {
            ...
            public Corvus.LernaBenchmark.Baseline.JsonString.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.LernaBenchmark.Baseline.JsonString.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.LernaBenchmark.Baseline.JsonString.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.LernaBenchmark.Baseline.JsonString.Mutable>(_parent, _idx);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new NpmClientAArray(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"NpmClientAArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Corvus.LernaBenchmark.Baseline.JsonString.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, in Corvus.LernaBenchmark.Baseline.JsonString.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(in Corvus.LernaBenchmark.Baseline.JsonString.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Corvus.LernaBenchmark.Baseline.JsonString item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.LernaBenchmark.Baseline.JsonString>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Corvus.LernaBenchmark.Baseline.JsonString> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.LernaBenchmark.Baseline.JsonString>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Corvus.LernaBenchmark.Baseline.JsonString oldItem, in Corvus.LernaBenchmark.Baseline.JsonString.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.LernaBenchmark.Baseline.JsonString>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Corvus.LernaBenchmark.Baseline.JsonString current = enumerator.Current;
            ...
            /// <summary>
            /// Gets a <see cref="NpmClientAArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="NpmClientAArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly NpmClientAArray Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<NpmClientAArray>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="NpmClientAArray"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly NpmClientAArray Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<NpmClientAArray>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.LernaBenchmark.Baseline.Schema.NpmClientAArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(NpmClientAArray instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.LernaBenchmark.Baseline.Schema.NpmClientAArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<NpmClientAArray, Mutable>(this);
        }
    }
}
