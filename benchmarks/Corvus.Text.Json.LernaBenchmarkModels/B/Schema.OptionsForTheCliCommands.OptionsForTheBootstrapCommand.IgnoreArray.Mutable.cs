        ...
        public readonly partial struct OptionsForTheBootstrapCommand
        {
            ...
            public readonly partial struct IgnoreArray
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(IgnoreArray instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="IgnoreArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator IgnoreArray(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"IgnoreArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    /// <summary>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly IgnoreArray Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly IgnoreArray Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<IgnoreArray>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.LernaBenchmark.Baseline.Schema.OptionsForTheCliCommands.OptionsForTheBootstrapCommand.IgnoreArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(IgnoreArray instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.LernaBenchmark.Baseline.Schema.OptionsForTheCliCommands.OptionsForTheBootstrapCommand.IgnoreArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
                ...
                {
                    return workspace.CreateBuilder<IgnoreArray, Mutable>(this);
                }
            }
        }
    }
