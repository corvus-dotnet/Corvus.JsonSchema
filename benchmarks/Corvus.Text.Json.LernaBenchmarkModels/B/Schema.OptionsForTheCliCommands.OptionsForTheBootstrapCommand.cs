...
public readonly partial struct Schema
{
    ...
    public readonly partial struct OptionsForTheCliCommands
    {
        ...
        public readonly partial struct OptionsForTheBootstrapCommand
            ...
            : IJsonElement<OptionsForTheBootstrapCommand>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="OptionsForTheBootstrapCommand"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal OptionsForTheBootstrapCommand(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static OptionsForTheBootstrapCommand DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.LernaBenchmark.Baseline.Schema.OptionsForTheCliCommands.OptionsForTheBootstrapCommand.IgnoreArray Ignore
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IgnoreUtf8, out Corvus.LernaBenchmark.Baseline.Schema.OptionsForTheCliCommands.OptionsForTheBootstrapCommand.IgnoreArray value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.LernaBenchmark.Baseline.Schema.OptionsForTheCliCommands.OptionsForTheBootstrapCommand.JsonStringArray NpmClientArgs
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NpmClientArgsUtf8, out Corvus.LernaBenchmark.Baseline.Schema.OptionsForTheCliCommands.OptionsForTheBootstrapCommand.JsonStringArray value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in OptionsForTheBootstrapCommand left, in OptionsForTheBootstrapCommand right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in OptionsForTheBootstrapCommand left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(OptionsForTheBootstrapCommand instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator OptionsForTheBootstrapCommand(JsonElement instance)
            {
                return OptionsForTheBootstrapCommand.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OptionsForTheBootstrapCommand From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OptionsForTheBootstrapCommand ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OptionsForTheBootstrapCommand>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OptionsForTheBootstrapCommand ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OptionsForTheBootstrapCommand>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OptionsForTheBootstrapCommand ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OptionsForTheBootstrapCommand>(json, options);
            }
            ...
            /// </exception>
            public static OptionsForTheBootstrapCommand ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<OptionsForTheBootstrapCommand>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out OptionsForTheBootstrapCommand? result)
            {
                return JsonElementHelpers.TryParseValue<OptionsForTheBootstrapCommand>(ref reader, out result);
            }
...
#if NET
            static OptionsForTheBootstrapCommand IJsonElement<OptionsForTheBootstrapCommand>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"OptionsForTheBootstrapCommand: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public OptionsForTheBootstrapCommand Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public OptionsForTheBootstrapCommand Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<OptionsForTheBootstrapCommand>(_idx);
                }
            ...
            public static class JsonPropertyNames
            {
                ...
                /// <summary>
                /// Gets the JSON property name for <see cref="NpmClientArgs"/>.
                /// </summary>
                public const string NpmClientArgs = "npmClientArgs";
                ...
                /// Gets the JSON property name for <see cref="NpmClientArgs"/>.
                /// </summary>
                public static ReadOnlySpan<byte> NpmClientArgsUtf8 => "npmClientArgs"u8;
            }
            ...
            private static class JsonPropertyNamesEscaped
            {
                ...
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="NpmClientArgs"/>.
                /// </summary>
