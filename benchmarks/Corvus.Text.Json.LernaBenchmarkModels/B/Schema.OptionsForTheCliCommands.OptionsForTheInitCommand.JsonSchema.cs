...
public readonly partial struct Schema
{
    ...
    public readonly partial struct OptionsForTheCliCommands
    {
            ...
            : IJsonElement<OptionsForTheInitCommand>
        {
            ...
            {
                private static readonly JsonSchemaPathProvider ExactSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/exact"u8, buffer, out written);

                private static void MatchExact(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    ...
                    JsonSchemaContext childContext =
                        Corvus.LernaBenchmark.Baseline.JsonBoolean.JsonSchema.PushChildContextUnescaped(
                            ...
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.ExactUtf8,
                            evaluationPath: ExactSchemaEvaluationPath);

                    Corvus.LernaBenchmark.Baseline.JsonBoolean.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                ...
                {
                    if (span.SequenceEqual(JsonPropertyNames.ExactUtf8))
                    {
                        matcher = MatchExact;
                        return true;
                    }
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://json.schemastore.org/lerna#/properties/command/properties/init"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "https://json.schemastore.org/lerna#/properties/command/properties/init";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://json.schemastore.org/lerna#/properties/command/properties/init"u8;
