    ...
    public readonly partial struct OptionsForTheCliCommands
    {
        ...
        public readonly partial struct OptionsForTheInitCommand
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(OptionsForTheInitCommand instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="OptionsForTheInitCommand"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator OptionsForTheInitCommand(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.LernaBenchmark.Baseline.JsonBoolean.Mutable Exact
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExactUtf8, out Corvus.LernaBenchmark.Baseline.JsonBoolean.Mutable value))
                        {
                            return value;
                        }
                ...
                /// <summary>
                /// Set the <c>exact</c> property.
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetExact(in Corvus.LernaBenchmark.Baseline.JsonBoolean.Source value)
                {
                    CheckValidInstance();

                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ExactUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExactUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                    ...
                    else
                    {
                        ...
                        value.AddAsProperty(JsonPropertyNamesEscaped.Exact, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                ...
                /// <summary>
                /// Remove the <c>exact</c> property, if present.
                /// </summary>
                ...
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ExactUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"OptionsForTheInitCommand.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly OptionsForTheInitCommand Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly OptionsForTheInitCommand Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<OptionsForTheInitCommand>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.LernaBenchmark.Baseline.Schema.OptionsForTheCliCommands.OptionsForTheInitCommand.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(OptionsForTheInitCommand instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.LernaBenchmark.Baseline.Schema.OptionsForTheCliCommands.OptionsForTheInitCommand.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="OptionsForTheInitCommand"/>.
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.LernaBenchmark.Baseline.JsonBoolean.Source exact = default)
                {
                    exact.AddAsProperty(JsonPropertyNamesEscaped.Exact, ref builder, escapeName: false);
                }

                /// <summary>
                /// Creates an instance of a <see cref="OptionsForTheInitCommand"/>.
                /// </summary>
                public void Create(in Corvus.LernaBenchmark.Baseline.JsonBoolean.Source exact = default)
                {
                    Create(ref _builder, exact);
                }
            ...
            /// </summary>
            /// <param name="workspace">The JSON workspace.</param>
            /// <param name="exact">The value of the property.</param>
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.LernaBenchmark.Baseline.JsonBoolean.Source exact = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            {
                return workspace.CreateBuilder<OptionsForTheInitCommand, Mutable>(this);
            }
        }
    }
}
