        ...
        public readonly partial struct OptionsForThePublishCommand
        {
            ...
            public readonly partial struct IgnoreChangesArray
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(IgnoreChangesArray instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="IgnoreChangesArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator IgnoreChangesArray(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"IgnoreChangesArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    /// <summary>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly IgnoreChangesArray Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly IgnoreChangesArray Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<IgnoreChangesArray>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.LernaBenchmark.Baseline.Schema.OptionsForTheCliCommands.OptionsForThePublishCommand.IgnoreChangesArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(IgnoreChangesArray instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.LernaBenchmark.Baseline.Schema.OptionsForTheCliCommands.OptionsForThePublishCommand.IgnoreChangesArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
                ...
                {
                    return workspace.CreateBuilder<IgnoreChangesArray, Mutable>(this);
                }
            }
        }
    }
