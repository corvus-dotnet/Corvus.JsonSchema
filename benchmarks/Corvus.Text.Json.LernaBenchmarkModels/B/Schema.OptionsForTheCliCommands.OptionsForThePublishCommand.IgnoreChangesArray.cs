    ...
    public readonly partial struct OptionsForTheCliCommands
    {
        ...
        public readonly partial struct OptionsForThePublishCommand
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="IgnoreChangesArray"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal IgnoreChangesArray(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static IgnoreChangesArray DefaultInstance { get; }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(IgnoreChangesArray value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in IgnoreChangesArray left, in IgnoreChangesArray right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in IgnoreChangesArray left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(IgnoreChangesArray instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator IgnoreChangesArray(JsonElement instance)
                {
                    return IgnoreChangesArray.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static IgnoreChangesArray From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static IgnoreChangesArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<IgnoreChangesArray>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static IgnoreChangesArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<IgnoreChangesArray>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static IgnoreChangesArray ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<IgnoreChangesArray>(json, options);
                }
                ...
                /// </exception>
                public static IgnoreChangesArray ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<IgnoreChangesArray>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out IgnoreChangesArray? result)
                {
                    return JsonElementHelpers.TryParseValue<IgnoreChangesArray>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new IgnoreChangesArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static IgnoreChangesArray IJsonElement<IgnoreChangesArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"IgnoreChangesArray: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="IgnoreChangesArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="IgnoreChangesArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public IgnoreChangesArray Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<IgnoreChangesArray>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="IgnoreChangesArray"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public IgnoreChangesArray Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<IgnoreChangesArray>(_idx);
                    }
