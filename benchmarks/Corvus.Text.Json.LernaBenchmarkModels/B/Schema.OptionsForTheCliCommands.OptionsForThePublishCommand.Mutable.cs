    ...
    public readonly partial struct OptionsForTheCliCommands
    {
        ...
        public readonly partial struct OptionsForThePublishCommand
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(OptionsForThePublishCommand instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="OptionsForThePublishCommand"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator OptionsForThePublishCommand(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.LernaBenchmark.Baseline.Schema.OptionsForTheCliCommands.OptionsForThePublishCommand.IgnoreChangesArray.Mutable IgnoreChanges
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IgnoreChangesUtf8, out Corvus.LernaBenchmark.Baseline.Schema.OptionsForTheCliCommands.OptionsForThePublishCommand.IgnoreChangesArray.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.LernaBenchmark.Baseline.JsonString.Mutable Message
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MessageUtf8, out Corvus.LernaBenchmark.Baseline.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new OptionsForThePublishCommand(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                public void SetIgnoreChanges(in Corvus.LernaBenchmark.Baseline.Schema.OptionsForTheCliCommands.OptionsForThePublishCommand.IgnoreChangesArray.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetIgnoreChanges<TContext>(in Corvus.LernaBenchmark.Baseline.Schema.OptionsForTheCliCommands.OptionsForThePublishCommand.IgnoreChangesArray.Source<TContext> value)
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetMessage(in Corvus.LernaBenchmark.Baseline.JsonString.Source value)
                {
                    CheckValidInstance();
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"OptionsForThePublishCommand.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="OptionsForThePublishCommand"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="OptionsForThePublishCommand"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly OptionsForThePublishCommand Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<OptionsForThePublishCommand>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="OptionsForThePublishCommand"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly OptionsForThePublishCommand Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<OptionsForThePublishCommand>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.LernaBenchmark.Baseline.Schema.OptionsForTheCliCommands.OptionsForThePublishCommand.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(OptionsForThePublishCommand instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.LernaBenchmark.Baseline.Schema.OptionsForTheCliCommands.OptionsForThePublishCommand.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="OptionsForThePublishCommand"/>.
                /// </summary>
                internal static void Create(
                    ref ComplexValueBuilder builder,
                    in Corvus.LernaBenchmark.Baseline.Schema.OptionsForTheCliCommands.OptionsForThePublishCommand.IgnoreChangesArray.Source ignoreChanges = default,
                    in Corvus.LernaBenchmark.Baseline.JsonString.Source message = default)
                {
                ...
                /// Creates an instance of a <see cref="OptionsForThePublishCommand"/>.
                /// </summary>
                public void Create(in Corvus.LernaBenchmark.Baseline.Schema.OptionsForTheCliCommands.OptionsForThePublishCommand.IgnoreChangesArray.Source ignoreChanges = default, in Corvus.LernaBenchmark.Baseline.JsonString.Source message = default)
                {
                    Create(ref _builder, ignoreChanges, message);
                }
                ...
                internal static void Create<TContext>(
                    in TContext context,
                    ref ComplexValueBuilder builder,
                    in Corvus.LernaBenchmark.Baseline.Schema.OptionsForTheCliCommands.OptionsForThePublishCommand.IgnoreChangesArray.Source<TContext> ignoreChanges = default,
                    in Corvus.LernaBenchmark.Baseline.JsonString.Source message = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                ...
                #endif
                {
                    Create(context, ref _builder, ignoreChanges, message);
                }
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.LernaBenchmark.Baseline.Schema.OptionsForTheCliCommands.OptionsForThePublishCommand.IgnoreChangesArray.Source ignoreChanges = default, in Corvus.LernaBenchmark.Baseline.JsonString.Source message = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(ignoreChanges, message);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.LernaBenchmark.Baseline.Schema.OptionsForTheCliCommands.OptionsForThePublishCommand.IgnoreChangesArray.Source<TContext> ignoreChanges = default, in Corvus.LernaBenchmark.Baseline.JsonString.Source message = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                ...
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(context, ignoreChanges, message);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<OptionsForThePublishCommand, Mutable>(this);
            }
        }
    }
}
