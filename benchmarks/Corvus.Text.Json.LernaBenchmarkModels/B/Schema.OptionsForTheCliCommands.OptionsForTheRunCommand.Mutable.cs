    ...
    public readonly partial struct OptionsForTheCliCommands
    {
        ...
        public readonly partial struct OptionsForTheRunCommand
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(OptionsForTheRunCommand instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="OptionsForTheRunCommand"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator OptionsForTheRunCommand(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"OptionsForTheRunCommand.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly OptionsForTheRunCommand Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly OptionsForTheRunCommand Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<OptionsForTheRunCommand>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.LernaBenchmark.Baseline.Schema.OptionsForTheCliCommands.OptionsForTheRunCommand.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(OptionsForTheRunCommand instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.LernaBenchmark.Baseline.Schema.OptionsForTheCliCommands.OptionsForTheRunCommand.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="OptionsForTheRunCommand"/>.
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.LernaBenchmark.Baseline.JsonString.Source npmClient = default)
                {
                ...
                /// Creates an instance of a <see cref="OptionsForTheRunCommand"/>.
                /// </summary>
                public void Create(in Corvus.LernaBenchmark.Baseline.JsonString.Source npmClient = default)
                {
                    Create(ref _builder, npmClient);
                }
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.LernaBenchmark.Baseline.JsonString.Source npmClient = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(npmClient);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<OptionsForTheRunCommand, Mutable>(this);
            }
        }
    }
}
