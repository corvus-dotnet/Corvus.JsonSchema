...
public readonly partial struct Schema
{
    ...
    public readonly partial struct OptionsForTheCliCommands
    {
            ...
            : IJsonElement<OptionsForTheVersionCommand>
        {
            ...
            {
                private static readonly JsonSchemaPathProvider AllowBranchSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/allowBranch"u8, buffer, out written);
                ...
                private static void MatchAllowBranch(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext =
                        Corvus.LernaBenchmark.Baseline.Schema.OptionsForTheCliCommands.OptionsForTheVersionCommand.AllowBranchArray.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.AllowBranchUtf8,
                            evaluationPath: AllowBranchSchemaEvaluationPath);

                    Corvus.LernaBenchmark.Baseline.Schema.OptionsForTheCliCommands.OptionsForTheVersionCommand.AllowBranchArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                ...
                private static void MatchMessage(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    ...
                    JsonSchemaContext childContext1 =
                        Corvus.LernaBenchmark.Baseline.JsonString.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Corvus.LernaBenchmark.Baseline.JsonString.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                    context.CommitChildContext(childContext1.IsMatch, ref childContext1);
                }

                private static PropertySchemaMatchers<Corvus.LernaBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
                {
                    return new PropertySchemaMatchers<Corvus.LernaBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator>([
                        (static () => JsonPropertyNames.AllowBranchUtf8, MatchAllowBranch),
                        (static () => JsonPropertyNames.MessageUtf8, MatchMessage),
                    ]);
                }

                private static PropertySchemaMatchers<Corvus.LernaBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator> Matchers { get; } = MatchersBuilder();

                private static bool TryGetNamedMatcher(ReadOnlySpan<byte> span,
#if NET
                [NotNullWhen(true)]
#endif
                out Corvus.LernaBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator? matcher)
                {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://json.schemastore.org/lerna#/properties/command/properties/version"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "https://json.schemastore.org/lerna#/properties/command/properties/version";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://json.schemastore.org/lerna#/properties/command/properties/version"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        while (objectValidation_enumerator.MoveNext())
                        {
                            ...
                            if (TryGetNamedMatcher(objectValidation_unescapedPropertyName.Span, out Corvus.LernaBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator? validator))
                            {
