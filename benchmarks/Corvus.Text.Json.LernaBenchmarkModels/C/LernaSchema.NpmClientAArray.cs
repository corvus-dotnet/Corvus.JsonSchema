...
public readonly partial struct LernaSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NpmClientAArray"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal NpmClientAArray(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static NpmClientAArray DefaultInstance { get; }
        ...
        /// </returns>
        public static bool operator ==(in NpmClientAArray left, in NpmClientAArray right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in NpmClientAArray left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(NpmClientAArray instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator NpmClientAArray(JsonElement instance)
        {
            return NpmClientAArray.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static NpmClientAArray From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static NpmClientAArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<NpmClientAArray>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static NpmClientAArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<NpmClientAArray>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static NpmClientAArray ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<NpmClientAArray>(json, options);
        }
        ...
        /// </exception>
        public static NpmClientAArray ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<NpmClientAArray>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out NpmClientAArray? result)
        {
            return JsonElementHelpers.TryParseValue<NpmClientAArray>(ref reader, out result);
        }
...
#if NET
        static NpmClientAArray IJsonElement<NpmClientAArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"NpmClientAArray: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public NpmClientAArray Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<NpmClientAArray>(_idx);
            }
