        ...
        public readonly partial struct OptionsForTheBootstrapCommand
        {
            ...
            public readonly partial struct IgnoreArray
            {
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.LernaBenchmark.Current.LernaSchema.OptionsForTheCliCommands.OptionsForTheBootstrapCommand.IgnoreArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.LernaBenchmark.Current.LernaSchema.OptionsForTheCliCommands.OptionsForTheBootstrapCommand.IgnoreArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
                ...
                public static ParsedJsonDocument<IgnoreArray> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<IgnoreArray>();
                    }
                    finally
                    {
