    ...
    public readonly partial struct OptionsForTheCliCommands
    {
        ...
        public readonly partial struct OptionsForTheBootstrapCommand
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="IgnoreArray"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal IgnoreArray(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static IgnoreArray DefaultInstance { get; }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(IgnoreArray value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in IgnoreArray left, in IgnoreArray right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in IgnoreArray left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(IgnoreArray instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator IgnoreArray(JsonElement instance)
                {
                    return IgnoreArray.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static IgnoreArray From<T>(in T instance)
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out IgnoreArray? result)
                {
                    return JsonElementHelpers.TryParseValue<IgnoreArray>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new IgnoreArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static IgnoreArray IJsonElement<IgnoreArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"IgnoreArray: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="IgnoreArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="IgnoreArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public IgnoreArray Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<IgnoreArray>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="IgnoreArray"/> that lives for the lifetime of its
