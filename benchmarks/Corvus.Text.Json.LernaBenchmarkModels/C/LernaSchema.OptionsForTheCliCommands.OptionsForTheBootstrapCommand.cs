...
public readonly partial struct LernaSchema
{
    ...
    public readonly partial struct OptionsForTheCliCommands
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.LernaBenchmark.Current.LernaSchema.OptionsForTheCliCommands.OptionsForTheBootstrapCommand.IgnoreArray Ignore
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IgnoreUtf8, out Corvus.LernaBenchmark.Current.LernaSchema.OptionsForTheCliCommands.OptionsForTheBootstrapCommand.IgnoreArray value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.LernaBenchmark.Current.LernaSchema.OptionsForTheCliCommands.OptionsForTheBootstrapCommand.JsonStringArray NpmClientArgs
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NpmClientArgsUtf8, out Corvus.LernaBenchmark.Current.LernaSchema.OptionsForTheCliCommands.OptionsForTheBootstrapCommand.JsonStringArray value))
                    {
                        return value;
                    }
