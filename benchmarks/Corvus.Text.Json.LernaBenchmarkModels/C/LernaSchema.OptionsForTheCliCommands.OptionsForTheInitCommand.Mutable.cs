    ...
    public readonly partial struct OptionsForTheCliCommands
    {
        ...
        public readonly partial struct OptionsForTheInitCommand
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.LernaBenchmark.Current.JsonBoolean.Mutable Exact
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExactUtf8, out Corvus.LernaBenchmark.Current.JsonBoolean.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetExact(scoped in Corvus.LernaBenchmark.Current.JsonBoolean.Source value)
                {
                    CheckValidInstance();
                    ...
                    else
                    {
                        ...
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Exact, ref cvb);
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.LernaBenchmark.Current.JsonBoolean.Source _createArg1;
                ...
                internal Source(Corvus.LernaBenchmark.Current.LernaSchema.OptionsForTheCliCommands.OptionsForTheInitCommand.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in Corvus.LernaBenchmark.Current.JsonBoolean.Source arg1)
                {
                    _createArg1 = arg1;
                    _kind = Kind.Create;
                }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.LernaBenchmark.Current.LernaSchema.OptionsForTheCliCommands.OptionsForTheInitCommand.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.LernaBenchmark.Current.JsonBoolean.Source exact = default)
                {
                    exact.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Exact, ref builder);
                }

                /// <summary>
                /// Creates an instance of a <see cref="OptionsForTheInitCommand"/>.
                /// </summary>
                public void Create(in Corvus.LernaBenchmark.Current.JsonBoolean.Source exact = default)
                {
                ...
                internal static void BuildCreateValue(scoped in Corvus.LernaBenchmark.Current.JsonBoolean.Source arg1, ref ComplexValueBuilder o)
                {
                    o.StartObject();
                    Create(ref o, arg1);
                    o.EndObject();
            ...
            /// </summary>
            /// <param name="exact">The value of the <c>"exact"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.LernaBenchmark.Current.JsonBoolean.Source exact = default)
            {
                return new Source(exact);
            }
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.LernaBenchmark.Current.JsonBoolean.Source exact = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            public static ParsedJsonDocument<OptionsForTheInitCommand> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<OptionsForTheInitCommand>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<OptionsForTheInitCommand> Create<TContext>(
            ...
            public static ParsedJsonDocument<OptionsForTheInitCommand> Create(in Corvus.LernaBenchmark.Current.JsonBoolean.Source exact = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
