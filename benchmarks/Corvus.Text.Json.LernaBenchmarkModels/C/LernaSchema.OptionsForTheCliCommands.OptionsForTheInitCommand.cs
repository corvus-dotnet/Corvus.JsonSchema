...
public readonly partial struct LernaSchema
{
    ...
    public readonly partial struct OptionsForTheCliCommands
    {
        ...
        public readonly partial struct OptionsForTheInitCommand
#if NET8_0_OR_GREATER
            : IJsonElement<OptionsForTheInitCommand>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="OptionsForTheInitCommand"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal OptionsForTheInitCommand(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static OptionsForTheInitCommand DefaultInstance { get; }
            ...
            /// <summary>
            /// Gets the (optional) <c>exact</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.LernaBenchmark.Current.JsonBoolean Exact
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExactUtf8, out Corvus.LernaBenchmark.Current.JsonBoolean value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in OptionsForTheInitCommand left, in OptionsForTheInitCommand right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in OptionsForTheInitCommand left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(OptionsForTheInitCommand instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator OptionsForTheInitCommand(JsonElement instance)
            {
                return OptionsForTheInitCommand.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OptionsForTheInitCommand From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OptionsForTheInitCommand ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OptionsForTheInitCommand>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OptionsForTheInitCommand ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OptionsForTheInitCommand>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OptionsForTheInitCommand ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OptionsForTheInitCommand>(json, options);
            }
            ...
            /// </exception>
            public static OptionsForTheInitCommand ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<OptionsForTheInitCommand>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out OptionsForTheInitCommand? result)
            {
                return JsonElementHelpers.TryParseValue<OptionsForTheInitCommand>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new OptionsForTheInitCommand(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static OptionsForTheInitCommand IJsonElement<OptionsForTheInitCommand>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"OptionsForTheInitCommand: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="OptionsForTheInitCommand"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="OptionsForTheInitCommand"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public OptionsForTheInitCommand Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<OptionsForTheInitCommand>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="OptionsForTheInitCommand"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public OptionsForTheInitCommand Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<OptionsForTheInitCommand>(_idx);
                }
            ...
            {
                /// <summary>
                /// Gets the JSON property name for <see cref="Exact"/>.
                /// </summary>
                ...
                /// Gets the JSON property name for <see cref="Exact"/>.
                /// </summary>
                public static ReadOnlySpan<byte> ExactUtf8 => "exact"u8;
            }
            ...
            {
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="Exact"/>.
                /// </summary>
                public static ReadOnlySpan<byte> Exact => "exact"u8;
            }
            ...
            {
                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="Exact"/>.
                /// </summary>
                public static ReadOnlySpan<byte> Exact => [0x75, 0x00, 0x00, 0x00, 0x22, 0x65, 0x78, 0x61, 0x63, 0x74, 0x22];
            }
        }
    }
}
