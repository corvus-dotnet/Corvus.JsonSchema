        ...
        public readonly partial struct OptionsForThePublishCommand
        {
            ...
            public readonly partial struct IgnoreChangesArray
            {
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.LernaBenchmark.Current.LernaSchema.OptionsForTheCliCommands.OptionsForThePublishCommand.IgnoreChangesArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.LernaBenchmark.Current.LernaSchema.OptionsForTheCliCommands.OptionsForThePublishCommand.IgnoreChangesArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
                ...
                public static ParsedJsonDocument<IgnoreChangesArray> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<IgnoreChangesArray>();
                    }
                    finally
                    {
