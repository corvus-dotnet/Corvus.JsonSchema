    ...
    public readonly partial struct OptionsForTheCliCommands
    {
        ...
        public readonly partial struct OptionsForThePublishCommand
        {
...
#endif
            {
                ...
                public void SetIgnoreChanges(in Corvus.LernaBenchmark.Current.LernaSchema.OptionsForTheCliCommands.OptionsForThePublishCommand.IgnoreChangesArray.Source value)
                {
                    CheckValidInstance();
            ...
            public ref struct Source
            {
                ...
                internal Source(in Corvus.LernaBenchmark.Current.LernaSchema.OptionsForTheCliCommands.OptionsForThePublishCommand.IgnoreChangesArray.Source arg1, in Corvus.LernaBenchmark.Current.JsonString.Source arg2)
                {
                    _createArg1 = arg1;
                    _createArg2 = arg2;
                    _kind = Kind.Create;
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, in Corvus.LernaBenchmark.Current.LernaSchema.OptionsForTheCliCommands.OptionsForThePublishCommand.IgnoreChangesArray.Source<TContext> arg1, in Corvus.LernaBenchmark.Current.JsonString.Source arg2)
                {
                    _context = context;
                    _createArg1 = arg1;
                    _createArg2 = arg2;
            ...
            public ref struct Builder
            {
                ...
                internal static void BuildCreateValue(in Corvus.LernaBenchmark.Current.LernaSchema.OptionsForTheCliCommands.OptionsForThePublishCommand.IgnoreChangesArray.Source arg1, in Corvus.LernaBenchmark.Current.JsonString.Source arg2, ref ComplexValueBuilder o)
                {
                    o.StartObject();
                ...
                /// <param name="arg2">The value of the property.</param>
                /// <param name="o">The complex value builder into which to write the object.</param>
                internal static void BuildCreateValue<TContext>(scoped in TContext context, in Corvus.LernaBenchmark.Current.LernaSchema.OptionsForTheCliCommands.OptionsForThePublishCommand.IgnoreChangesArray.Source<TContext> arg1, in Corvus.LernaBenchmark.Current.JsonString.Source arg2, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(in Corvus.LernaBenchmark.Current.LernaSchema.OptionsForTheCliCommands.OptionsForThePublishCommand.IgnoreChangesArray.Source ignoreChanges = default, in Corvus.LernaBenchmark.Current.JsonString.Source message = default)
            {
            ...
            /// <param name="message">The value of the <c>"message"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.LernaBenchmark.Current.LernaSchema.OptionsForTheCliCommands.OptionsForThePublishCommand.IgnoreChangesArray.Source<TContext> ignoreChanges = default, in Corvus.LernaBenchmark.Current.JsonString.Source message = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
