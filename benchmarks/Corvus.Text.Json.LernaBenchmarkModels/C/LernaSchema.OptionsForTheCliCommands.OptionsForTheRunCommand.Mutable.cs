    ...
    public readonly partial struct OptionsForTheCliCommands
    {
        ...
        public readonly partial struct OptionsForTheRunCommand
        {
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.LernaBenchmark.Current.JsonString.Source _createArg1;
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.LernaBenchmark.Current.LernaSchema.OptionsForTheCliCommands.OptionsForTheRunCommand.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.LernaBenchmark.Current.JsonString.Source npmClient = default)
                {
                ...
                /// Creates an instance of a <see cref="OptionsForTheRunCommand"/>.
                /// </summary>
                public void Create(in Corvus.LernaBenchmark.Current.JsonString.Source npmClient = default)
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.LernaBenchmark.Current.JsonString.Source npmClient = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            public static ParsedJsonDocument<OptionsForTheRunCommand> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<OptionsForTheRunCommand>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<OptionsForTheRunCommand> Create<TContext>(
            ...
            public static ParsedJsonDocument<OptionsForTheRunCommand> Create(in Corvus.LernaBenchmark.Current.JsonString.Source npmClient = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
