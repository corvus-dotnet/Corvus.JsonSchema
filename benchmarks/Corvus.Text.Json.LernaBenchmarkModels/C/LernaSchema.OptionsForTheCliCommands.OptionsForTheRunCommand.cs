...
public readonly partial struct LernaSchema
{
    ...
    public readonly partial struct OptionsForTheCliCommands
    {
        ...
        public readonly partial struct OptionsForTheRunCommand
#if NET8_0_OR_GREATER
            : IJsonElement<OptionsForTheRunCommand>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="OptionsForTheRunCommand"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal OptionsForTheRunCommand(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static OptionsForTheRunCommand DefaultInstance { get; }
            ...
            /// <summary>
            /// Gets the (optional) <c>npmClient</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.LernaBenchmark.Current.JsonString NpmClient
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NpmClientUtf8, out Corvus.LernaBenchmark.Current.JsonString value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in OptionsForTheRunCommand left, in OptionsForTheRunCommand right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in OptionsForTheRunCommand left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(OptionsForTheRunCommand instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator OptionsForTheRunCommand(JsonElement instance)
            {
                return OptionsForTheRunCommand.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OptionsForTheRunCommand From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OptionsForTheRunCommand ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OptionsForTheRunCommand>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OptionsForTheRunCommand ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OptionsForTheRunCommand>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OptionsForTheRunCommand ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OptionsForTheRunCommand>(json, options);
            }
            ...
            /// </exception>
            public static OptionsForTheRunCommand ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<OptionsForTheRunCommand>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out OptionsForTheRunCommand? result)
            {
                return JsonElementHelpers.TryParseValue<OptionsForTheRunCommand>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new OptionsForTheRunCommand(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static OptionsForTheRunCommand IJsonElement<OptionsForTheRunCommand>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"OptionsForTheRunCommand: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="OptionsForTheRunCommand"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="OptionsForTheRunCommand"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public OptionsForTheRunCommand Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<OptionsForTheRunCommand>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="OptionsForTheRunCommand"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public OptionsForTheRunCommand Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<OptionsForTheRunCommand>(_idx);
                }
            ...
            {
                /// <summary>
                /// Gets the JSON property name for <see cref="NpmClient"/>.
                /// </summary>
                public const string NpmClient = "npmClient";

                /// <summary>
                /// Gets the JSON property name for <see cref="NpmClient"/>.
                /// </summary>
                public static ReadOnlySpan<byte> NpmClientUtf8 => "npmClient"u8;
            }
            ...
            {
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="NpmClient"/>.
                /// </summary>
                public static ReadOnlySpan<byte> NpmClient => "npmClient"u8;
            }
