    ...
    public readonly partial struct OptionsForTheCliCommands
    {
        ...
        public readonly partial struct OptionsForTheVersionCommand
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(OptionsForTheVersionCommand instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="OptionsForTheVersionCommand"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator OptionsForTheVersionCommand(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.LernaBenchmark.Current.LernaSchema.OptionsForTheCliCommands.OptionsForTheVersionCommand.AllowBranchArray.Mutable AllowBranch
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AllowBranchUtf8, out Corvus.LernaBenchmark.Current.LernaSchema.OptionsForTheCliCommands.OptionsForTheVersionCommand.AllowBranchArray.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.LernaBenchmark.Current.JsonString.Mutable Message
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MessageUtf8, out Corvus.LernaBenchmark.Current.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetAllowBranch(scoped in Corvus.LernaBenchmark.Current.LernaSchema.OptionsForTheCliCommands.OptionsForTheVersionCommand.AllowBranchArray.Source value)
                {
                    ...
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.AllowBranchUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AllowBranchUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetAllowBranch<TContext>(in Corvus.LernaBenchmark.Current.LernaSchema.OptionsForTheCliCommands.OptionsForTheVersionCommand.AllowBranchArray.Source<TContext> value)
                ...
                /// <summary>
                /// Remove the <c>allowBranch</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveAllowBranch()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.AllowBranchUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"OptionsForTheVersionCommand.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly OptionsForTheVersionCommand Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly OptionsForTheVersionCommand Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<OptionsForTheVersionCommand>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.LernaBenchmark.Current.LernaSchema.OptionsForTheCliCommands.OptionsForTheVersionCommand.AllowBranchArray.Source _createArg1;
                private readonly Corvus.LernaBenchmark.Current.JsonString.Source _createArg2;
                ...
                public static implicit operator Source(OptionsForTheVersionCommand instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                private readonly Corvus.LernaBenchmark.Current.LernaSchema.OptionsForTheCliCommands.OptionsForTheVersionCommand.AllowBranchArray.Source<TContext> _createArg1;
                private readonly Corvus.LernaBenchmark.Current.JsonString.Source _createArg2;
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="OptionsForTheVersionCommand"/>.
                /// </summary>
                ...
                /// Creates an instance of a <see cref="OptionsForTheVersionCommand"/>.
                /// </summary>
                public void Create(in Corvus.LernaBenchmark.Current.LernaSchema.OptionsForTheCliCommands.OptionsForTheVersionCommand.AllowBranchArray.Source allowBranch = default, in Corvus.LernaBenchmark.Current.JsonString.Source message = default)
                {
                    Create(ref _builder, allowBranch, message);
                }
                ...
                internal static void Create<TContext>(
                    in TContext context,
                    ref ComplexValueBuilder builder,
                    in Corvus.LernaBenchmark.Current.LernaSchema.OptionsForTheCliCommands.OptionsForTheVersionCommand.AllowBranchArray.Source<TContext> allowBranch = default,
                    in Corvus.LernaBenchmark.Current.JsonString.Source message = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                ...
                #endif
                {
                    Create(context, ref _builder, allowBranch, message);
                }
            ...
            public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.LernaBenchmark.Current.LernaSchema.OptionsForTheCliCommands.OptionsForTheVersionCommand.AllowBranchArray.Source<TContext> allowBranch = default, scoped in Corvus.LernaBenchmark.Current.JsonString.Source message = default)
                ...
                #endif
            {
                return new Source<TContext>(context, allowBranch, message);
            }
            ...
            /// </summary>
            /// <param name="workspace">The JSON workspace.</param>
            /// <param name="allowBranch">The value of the property.</param>
            /// <param name="message">The value of the property.</param>
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.LernaBenchmark.Current.LernaSchema.OptionsForTheCliCommands.OptionsForTheVersionCommand.AllowBranchArray.Source allowBranch = default, in Corvus.LernaBenchmark.Current.JsonString.Source message = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(allowBranch, message);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.LernaBenchmark.Current.LernaSchema.OptionsForTheCliCommands.OptionsForTheVersionCommand.AllowBranchArray.Source<TContext> allowBranch = default, in Corvus.LernaBenchmark.Current.JsonString.Source message = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                ...
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(context, allowBranch, message);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<OptionsForTheVersionCommand, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<OptionsForTheVersionCommand> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<OptionsForTheVersionCommand>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<OptionsForTheVersionCommand> Create<TContext>(
            ...
            public static ParsedJsonDocument<OptionsForTheVersionCommand> Create(in Corvus.LernaBenchmark.Current.LernaSchema.OptionsForTheCliCommands.OptionsForTheVersionCommand.AllowBranchArray.Source allowBranch = default, in Corvus.LernaBenchmark.Current.JsonString.Source message = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
            public static ParsedJsonDocument<OptionsForTheVersionCommand> Create<TContext>(in TContext context, in Corvus.LernaBenchmark.Current.LernaSchema.OptionsForTheCliCommands.OptionsForTheVersionCommand.AllowBranchArray.Source<TContext> allowBranch = default, in Corvus.LernaBenchmark.Current.JsonString.Source message = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
