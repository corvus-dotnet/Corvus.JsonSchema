...
public readonly partial struct LernaSchema
{
    ...
    public readonly partial struct OptionsForTheCliCommands
    {
        ...
        public readonly partial struct OptionsForTheVersionCommand
#if NET8_0_OR_GREATER
            : IJsonElement<OptionsForTheVersionCommand>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="OptionsForTheVersionCommand"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal OptionsForTheVersionCommand(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static OptionsForTheVersionCommand DefaultInstance { get; }
            ...
            /// <summary>
            /// Gets the (optional) <c>allowBranch</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.LernaBenchmark.Current.LernaSchema.OptionsForTheCliCommands.OptionsForTheVersionCommand.AllowBranchArray AllowBranch
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AllowBranchUtf8, out Corvus.LernaBenchmark.Current.LernaSchema.OptionsForTheCliCommands.OptionsForTheVersionCommand.AllowBranchArray value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.LernaBenchmark.Current.JsonString Message
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MessageUtf8, out Corvus.LernaBenchmark.Current.JsonString value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in OptionsForTheVersionCommand left, in OptionsForTheVersionCommand right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in OptionsForTheVersionCommand left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(OptionsForTheVersionCommand instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator OptionsForTheVersionCommand(JsonElement instance)
            {
                return OptionsForTheVersionCommand.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OptionsForTheVersionCommand From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OptionsForTheVersionCommand ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OptionsForTheVersionCommand>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OptionsForTheVersionCommand ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OptionsForTheVersionCommand>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OptionsForTheVersionCommand ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OptionsForTheVersionCommand>(json, options);
            }
            ...
            /// </exception>
            public static OptionsForTheVersionCommand ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<OptionsForTheVersionCommand>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out OptionsForTheVersionCommand? result)
            {
                return JsonElementHelpers.TryParseValue<OptionsForTheVersionCommand>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new OptionsForTheVersionCommand(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static OptionsForTheVersionCommand IJsonElement<OptionsForTheVersionCommand>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"OptionsForTheVersionCommand: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="OptionsForTheVersionCommand"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="OptionsForTheVersionCommand"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public OptionsForTheVersionCommand Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<OptionsForTheVersionCommand>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="OptionsForTheVersionCommand"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public OptionsForTheVersionCommand Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<OptionsForTheVersionCommand>(_idx);
                }
            ...
            {
                /// <summary>
                /// Gets the JSON property name for <see cref="AllowBranch"/>.
                /// </summary>
                public const string AllowBranch = "allowBranch";
                ...
                /// Gets the JSON property name for <see cref="AllowBranch"/>.
                /// </summary>
                public static ReadOnlySpan<byte> AllowBranchUtf8 => "allowBranch"u8;
            ...
            {
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="AllowBranch"/>.
                /// </summary>
                public static ReadOnlySpan<byte> AllowBranch => "allowBranch"u8;
            ...
            {
                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="AllowBranch"/>.
                /// </summary>
                public static ReadOnlySpan<byte> AllowBranch => [0xD5, 0x00, 0x00, 0x00, 0x22, 0x61, 0x6C, 0x6C, 0x6F, 0x77, 0x42, 0x72, 0x61, 0x6E, 0x63, 0x68, 0x22];
