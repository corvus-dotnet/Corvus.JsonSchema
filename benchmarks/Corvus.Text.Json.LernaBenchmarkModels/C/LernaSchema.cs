...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="LernaSchema"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal LernaSchema(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static LernaSchema DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public Corvus.LernaBenchmark.Current.LernaSchema.OptionsForTheCliCommands Command
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CommandUtf8, out Corvus.LernaBenchmark.Current.LernaSchema.OptionsForTheCliCommands value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.LernaBenchmark.Current.LernaSchema.JsonStringArray IgnoreChanges
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IgnoreChangesUtf8, out Corvus.LernaBenchmark.Current.LernaSchema.JsonStringArray value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.LernaBenchmark.Current.LernaSchema.NpmClientAArray NpmClientArgs
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NpmClientArgsUtf8, out Corvus.LernaBenchmark.Current.LernaSchema.NpmClientAArray value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.LernaBenchmark.Current.LernaSchema.ArrayOfGloArray Packages
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PackagesUtf8, out Corvus.LernaBenchmark.Current.LernaSchema.ArrayOfGloArray value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.LernaBenchmark.Current.JsonBoolean UseWorkspaces
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UseWorkspacesUtf8, out Corvus.LernaBenchmark.Current.JsonBoolean value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.LernaBenchmark.Current.JsonString Version
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionUtf8, out Corvus.LernaBenchmark.Current.JsonString value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.LernaBenchmark.Current.LernaSchema.ArrayOfGloArray Workspaces
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.WorkspacesUtf8, out Corvus.LernaBenchmark.Current.LernaSchema.ArrayOfGloArray value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in LernaSchema left, in LernaSchema right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in LernaSchema left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(LernaSchema instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator LernaSchema(JsonElement instance)
    {
        return LernaSchema.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static LernaSchema From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static LernaSchema ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<LernaSchema>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static LernaSchema ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<LernaSchema>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static LernaSchema ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<LernaSchema>(json, options);
    }
    ...
    /// </exception>
    public static LernaSchema ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<LernaSchema>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out LernaSchema? result)
    {
        return JsonElementHelpers.TryParseValue<LernaSchema>(ref reader, out result);
    }
...
#if NET
    static LernaSchema IJsonElement<LernaSchema>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"LernaSchema: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    public static class JsonPropertyNames
    {
        ...
        /// <summary>
        /// Gets the JSON property name for <see cref="IgnoreChanges"/>.
        /// </summary>
        public const string IgnoreChanges = "ignoreChanges";
        ...
        /// <summary>
        /// Gets the JSON property name for <see cref="Packages"/>.
        /// </summary>
        public const string Packages = "packages";

        /// <summary>
        /// Gets the JSON property name for <see cref="UseWorkspaces"/>.
        /// </summary>
        public const string UseWorkspaces = "useWorkspaces";
        ...
        /// <summary>
        /// Gets the JSON property name for <see cref="Workspaces"/>.
        /// </summary>
        ...
        /// Gets the JSON property name for <see cref="IgnoreChanges"/>.
        /// </summary>
        public static ReadOnlySpan<byte> IgnoreChangesUtf8 => "ignoreChanges"u8;
        ...
        /// Gets the JSON property name for <see cref="Packages"/>.
        /// </summary>
        public static ReadOnlySpan<byte> PackagesUtf8 => "packages"u8;

        /// <summary>
        /// Gets the JSON property name for <see cref="UseWorkspaces"/>.
        /// </summary>
        public static ReadOnlySpan<byte> UseWorkspacesUtf8 => "useWorkspaces"u8;
    ...
    private static class JsonPropertyNamesEscaped
    {
        ...
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="IgnoreChanges"/>.
        /// </summary>
        public static ReadOnlySpan<byte> IgnoreChanges => "ignoreChanges"u8;
        ...
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="Packages"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Packages => "packages"u8;

        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="UseWorkspaces"/>.
        /// </summary>
        public static ReadOnlySpan<byte> UseWorkspaces => "useWorkspaces"u8;
        ...
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="Workspaces"/>.
        /// </summary>
