...
public readonly partial struct Schema
{
    ...
    public readonly partial struct CollectionEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(CollectionEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="CollectionEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator CollectionEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"CollectionEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly CollectionEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly CollectionEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<CollectionEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(CollectionEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<CollectionEntity, Mutable>(this);
        }
    }
}
