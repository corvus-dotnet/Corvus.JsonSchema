...
public readonly partial struct Schema
{
    ...
    public readonly partial struct CompilerOptions
    {
        ...
        public readonly partial struct AssetsOptionsArray
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(AssetsOptionsArray instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="AssetsOptionsArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AssetsOptionsArray(Mutable instance)
                {
                ...
                public Corvus.NestCliBenchmark.Baseline.Schema.AssetsOptions.Mutable this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.NestCliBenchmark.Baseline.Schema.AssetsOptions.Mutable>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.NestCliBenchmark.Baseline.Schema.AssetsOptions.Mutable> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.NestCliBenchmark.Baseline.Schema.AssetsOptions.Mutable>(_parent, _idx);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new AssetsOptionsArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AssetsOptionsArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetItem(int itemIndex, in Corvus.NestCliBenchmark.Baseline.Schema.AssetsOptions.Source value)
                {
                    CheckValidInstance();
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void InsertItem(int itemIndex, in Corvus.NestCliBenchmark.Baseline.Schema.AssetsOptions.Source value)
                {
                    CheckValidInstance();
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void AddItem(in Corvus.NestCliBenchmark.Baseline.Schema.AssetsOptions.Source value)
                {
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Remove(in Corvus.NestCliBenchmark.Baseline.Schema.AssetsOptions item)
                {
                    CheckValidInstance();
                    if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.NestCliBenchmark.Baseline.Schema.AssetsOptions>(this, in item))
                    {
                        return false;
                    }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void RemoveWhere(JsonPredicate<Corvus.NestCliBenchmark.Baseline.Schema.AssetsOptions> predicate)
                {
                    CheckValidInstance();
                    JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.NestCliBenchmark.Baseline.Schema.AssetsOptions>(this, predicate);
                    _documentVersion = _parent.Version;
                }
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Replace(in Corvus.NestCliBenchmark.Baseline.Schema.AssetsOptions oldItem, in Corvus.NestCliBenchmark.Baseline.Schema.AssetsOptions.Source newItem)
                {
                    CheckValidInstance();
                    ...
                    var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.NestCliBenchmark.Baseline.Schema.AssetsOptions>(_parent, _idx);

                    while (enumerator.MoveNext())
                    {
                        Corvus.NestCliBenchmark.Baseline.Schema.AssetsOptions current = enumerator.Current;
                ...
                /// <summary>
                /// Gets a <see cref="AssetsOptionsArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="AssetsOptionsArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly AssetsOptionsArray Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<AssetsOptionsArray>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="AssetsOptionsArray"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly AssetsOptionsArray Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<AssetsOptionsArray>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.NestCliBenchmark.Baseline.Schema.CompilerOptions.AssetsOptionsArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(AssetsOptionsArray instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.NestCliBenchmark.Baseline.Schema.CompilerOptions.AssetsOptionsArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<AssetsOptionsArray, Mutable>(this);
            }
        }
    }
}
