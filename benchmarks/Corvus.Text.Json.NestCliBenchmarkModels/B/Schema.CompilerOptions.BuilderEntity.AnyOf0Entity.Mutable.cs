        ...
        public readonly partial struct BuilderEntity
        {
            ...
            public readonly partial struct AnyOf0Entity
            {
...
#endif
                {
                    ...
                    /// <param name="matchTsc">Match 1st item.</param>
                    /// <param name="matchWebpack">Match 2nd item.</param>
                    /// <param name="matchSwc">Match 3rd item.</param>
                    /// <param name="defaultMatch">Match any other value.</param>
                    /// <returns>An instance of the value returned by the match function.</returns>
                    public TResult Match<TContext, TResult>(
                        in TContext context,
                        Func<TContext, TResult> matchTsc,
                        Func<TContext, TResult> matchWebpack,
                        Func<TContext, TResult> matchSwc,
...
#endif
                    {
                        ...
                        {
                            return matchTsc(context);
                        }

                        if (this.ValueEquals(Constants.Enum2))
                        {
                            return matchWebpack(context);
                        }

                        if (this.ValueEquals(Constants.Enum3))
                        {
                            return matchSwc(context);
                        }
                    ...
                    public TResult Match<TResult>(
                        Func<TResult> matchTsc,
                        Func<TResult> matchWebpack,
                        Func<TResult> matchSwc,
