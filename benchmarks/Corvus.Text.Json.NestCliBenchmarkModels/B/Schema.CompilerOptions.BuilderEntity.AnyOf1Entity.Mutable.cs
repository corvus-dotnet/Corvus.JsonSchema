        ...
        public readonly partial struct BuilderEntity
        {
            ...
            public readonly partial struct AnyOf1Entity
            {
...
#endif
                {
                    ...
                    /// </summary>
                    public Corvus.NestCliBenchmark.Baseline.Schema.CompilerOptions.BuilderEntity.AnyOf1Entity.OptionsEntity.Mutable Options
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OptionsUtf8, out Corvus.NestCliBenchmark.Baseline.Schema.CompilerOptions.BuilderEntity.AnyOf1Entity.OptionsEntity.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.NestCliBenchmark.Baseline.Schema.CompilerOptions.BuilderEntity.AnyOf1Entity.TypeEntity.Mutable Type
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.NestCliBenchmark.Baseline.Schema.CompilerOptions.BuilderEntity.AnyOf1Entity.TypeEntity.Mutable value))
                            {
                                return value;
                            }
                    ...
                    public void SetOptions(in Corvus.NestCliBenchmark.Baseline.Schema.CompilerOptions.BuilderEntity.AnyOf1Entity.OptionsEntity.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetOptions<TContext>(in Corvus.NestCliBenchmark.Baseline.Schema.CompilerOptions.BuilderEntity.AnyOf1Entity.OptionsEntity.Source<TContext> value)
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetType(in Corvus.NestCliBenchmark.Baseline.Schema.CompilerOptions.BuilderEntity.AnyOf1Entity.TypeEntity.Source value)
                    {
                        CheckValidInstance();
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.NestCliBenchmark.Baseline.Schema.CompilerOptions.BuilderEntity.AnyOf1Entity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.NestCliBenchmark.Baseline.Schema.CompilerOptions.BuilderEntity.AnyOf1Entity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    internal static void Create(
                        ...
                        in Corvus.NestCliBenchmark.Baseline.Schema.CompilerOptions.BuilderEntity.AnyOf1Entity.OptionsEntity.Source options = default,
                        in Corvus.NestCliBenchmark.Baseline.Schema.CompilerOptions.BuilderEntity.AnyOf1Entity.TypeEntity.Source type = default)
                    {
                    ...
                    /// Creates an instance of a <see cref="AnyOf1Entity"/>.
                    /// </summary>
                    public void Create(in Corvus.NestCliBenchmark.Baseline.Schema.CompilerOptions.BuilderEntity.AnyOf1Entity.OptionsEntity.Source options = default, in Corvus.NestCliBenchmark.Baseline.Schema.CompilerOptions.BuilderEntity.AnyOf1Entity.TypeEntity.Source type = default)
                    {
                    ...
                    internal static void Create<TContext>(
                        in TContext context,
                        ref ComplexValueBuilder builder,
                        in Corvus.NestCliBenchmark.Baseline.Schema.CompilerOptions.BuilderEntity.AnyOf1Entity.OptionsEntity.Source<TContext> options = default,
                        in Corvus.NestCliBenchmark.Baseline.Schema.CompilerOptions.BuilderEntity.AnyOf1Entity.TypeEntity.Source type = default)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.NestCliBenchmark.Baseline.Schema.CompilerOptions.BuilderEntity.AnyOf1Entity.OptionsEntity.Source options = default, in Corvus.NestCliBenchmark.Baseline.Schema.CompilerOptions.BuilderEntity.AnyOf1Entity.TypeEntity.Source type = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
