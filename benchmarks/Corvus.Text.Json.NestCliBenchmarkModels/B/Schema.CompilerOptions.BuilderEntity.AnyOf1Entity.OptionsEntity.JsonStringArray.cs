            ...
            public readonly partial struct AnyOf1Entity
            {
                ...
                public readonly partial struct OptionsEntity
                {
...
#endif
                    {
                        ...
                        public Corvus.NestCliBenchmark.Baseline.JsonString this[int index]
                        {
                            get
                            {
                                CheckValidInstance();
                                return _parent.GetArrayIndexElement<Corvus.NestCliBenchmark.Baseline.JsonString>(_idx, index);
                            }
                        }
                        ...
                        /// </summary>
                        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                        public ArrayEnumerator<Corvus.NestCliBenchmark.Baseline.JsonString> EnumerateArray()
                        {
                            CheckValidInstance();
                            return EnumeratorCreator.CreateArrayEnumerator<Corvus.NestCliBenchmark.Baseline.JsonString>(_parent, _idx);
                        }
