    ...
    public readonly partial struct CompilerOptions
    {
        ...
        public readonly partial struct DeleteOutDirEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(DeleteOutDirEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DeleteOutDirEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DeleteOutDirEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DeleteOutDirEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly DeleteOutDirEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly DeleteOutDirEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DeleteOutDirEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(DeleteOutDirEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<DeleteOutDirEntity, Mutable>(this);
            }
        }
    }
}
