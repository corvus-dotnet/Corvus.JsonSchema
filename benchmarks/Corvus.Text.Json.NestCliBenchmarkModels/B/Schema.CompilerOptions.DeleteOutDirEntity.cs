...
public readonly partial struct Schema
{
    ...
    public readonly partial struct CompilerOptions
    {
        ...
        public readonly partial struct DeleteOutDirEntity
#if NET8_0_OR_GREATER
            : IJsonElement<DeleteOutDirEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="DeleteOutDirEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal DeleteOutDirEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static DeleteOutDirEntity DefaultInstance { get; } = ParsedJsonDocument<DeleteOutDirEntity>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(DeleteOutDirEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in DeleteOutDirEntity left, in DeleteOutDirEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in DeleteOutDirEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(DeleteOutDirEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DeleteOutDirEntity(JsonElement instance)
            {
                return DeleteOutDirEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DeleteOutDirEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DeleteOutDirEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DeleteOutDirEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DeleteOutDirEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DeleteOutDirEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DeleteOutDirEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DeleteOutDirEntity>(json, options);
            }
            ...
            /// </exception>
            public static DeleteOutDirEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<DeleteOutDirEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out DeleteOutDirEntity? result)
            {
                return JsonElementHelpers.TryParseValue<DeleteOutDirEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new DeleteOutDirEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static DeleteOutDirEntity IJsonElement<DeleteOutDirEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DeleteOutDirEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="DeleteOutDirEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="DeleteOutDirEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public DeleteOutDirEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<DeleteOutDirEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="DeleteOutDirEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public DeleteOutDirEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<DeleteOutDirEntity>(_idx);
                }
