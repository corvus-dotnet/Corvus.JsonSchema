    ...
    public readonly partial struct CompilerOptions
    {
        ...
        public readonly partial struct PluginItemsArray
        {
...
#endif
            {
                ...
                public Corvus.NestCliBenchmark.Baseline.Schema.PluginItems.Mutable this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.NestCliBenchmark.Baseline.Schema.PluginItems.Mutable>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.NestCliBenchmark.Baseline.Schema.PluginItems.Mutable> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.NestCliBenchmark.Baseline.Schema.PluginItems.Mutable>(_parent, _idx);
                }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetItem(int itemIndex, in Corvus.NestCliBenchmark.Baseline.Schema.PluginItems.Source value)
                {
                    CheckValidInstance();
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void InsertItem(int itemIndex, in Corvus.NestCliBenchmark.Baseline.Schema.PluginItems.Source value)
                {
                    CheckValidInstance();
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void AddItem(in Corvus.NestCliBenchmark.Baseline.Schema.PluginItems.Source value)
                {
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Remove(in Corvus.NestCliBenchmark.Baseline.Schema.PluginItems item)
                {
                    CheckValidInstance();
                    if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.NestCliBenchmark.Baseline.Schema.PluginItems>(this, in item))
                    {
                        return false;
                    }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void RemoveWhere(JsonPredicate<Corvus.NestCliBenchmark.Baseline.Schema.PluginItems> predicate)
                {
                    CheckValidInstance();
                    JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.NestCliBenchmark.Baseline.Schema.PluginItems>(this, predicate);
                    _documentVersion = _parent.Version;
                }
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Replace(in Corvus.NestCliBenchmark.Baseline.Schema.PluginItems oldItem, in Corvus.NestCliBenchmark.Baseline.Schema.PluginItems.Source newItem)
                {
                    CheckValidInstance();
                    ...
                    var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.NestCliBenchmark.Baseline.Schema.PluginItems>(_parent, _idx);

                    while (enumerator.MoveNext())
                    {
                        Corvus.NestCliBenchmark.Baseline.Schema.PluginItems current = enumerator.Current;
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.NestCliBenchmark.Baseline.Schema.CompilerOptions.PluginItemsArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.NestCliBenchmark.Baseline.Schema.CompilerOptions.PluginItemsArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
