...
public readonly partial struct Schema
{
    ...
    public readonly partial struct CompilerOptions
    {
...
#endif
        {
            ...
            public Corvus.NestCliBenchmark.Baseline.Schema.PluginItems this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.NestCliBenchmark.Baseline.Schema.PluginItems>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.NestCliBenchmark.Baseline.Schema.PluginItems> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.NestCliBenchmark.Baseline.Schema.PluginItems>(_parent, _idx);
            }
