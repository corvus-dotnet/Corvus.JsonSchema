...
public readonly partial struct Schema
{
    ...
    public readonly partial struct CompilerOptions
    {
        ...
        public readonly partial struct WebpackConfigPathEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(WebpackConfigPathEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="WebpackConfigPathEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator WebpackConfigPathEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new WebpackConfigPathEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"WebpackConfigPathEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="WebpackConfigPathEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="WebpackConfigPathEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly WebpackConfigPathEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<WebpackConfigPathEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="WebpackConfigPathEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly WebpackConfigPathEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<WebpackConfigPathEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(WebpackConfigPathEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<WebpackConfigPathEntity, Mutable>(this);
            }
        }
    }
}
