...
public readonly partial struct Schema
{
    ...
    public readonly partial struct GenerateFlatOptions
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(GenerateFlatOptions instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="GenerateFlatOptions"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator GenerateFlatOptions(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new GenerateFlatOptions(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"GenerateFlatOptions.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="GenerateFlatOptions"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="GenerateFlatOptions"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly GenerateFlatOptions Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<GenerateFlatOptions>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="GenerateFlatOptions"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly GenerateFlatOptions Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<GenerateFlatOptions>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(GenerateFlatOptions instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<GenerateFlatOptions, Mutable>(this);
        }
    }
}
