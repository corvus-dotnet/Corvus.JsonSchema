...
public readonly partial struct Schema
{
    ...
    public readonly partial struct GenerateOptions
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(GenerateOptions instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="GenerateOptions"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator GenerateOptions(Mutable instance)
            {
            ...
            /// <summary>
            /// Gets the (optional) <c>baseDir</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            /// Base directory
            /// </para>
            /// </remarks>
            public Corvus.NestCliBenchmark.Baseline.Schema.GenerateBaseDirOptions.Mutable BaseDir
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BaseDirUtf8, out Corvus.NestCliBenchmark.Baseline.Schema.GenerateBaseDirOptions.Mutable value))
                    {
                        return value;
                    }
            ...
            /// <summary>
            /// Gets the (optional) <c>flat</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.NestCliBenchmark.Baseline.Schema.GenerateFlatOptions.Mutable Flat
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FlatUtf8, out Corvus.NestCliBenchmark.Baseline.Schema.GenerateFlatOptions.Mutable value))
                    {
                        return value;
                    }
            ...
            /// <summary>
            /// Gets the (optional) <c>spec</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.NestCliBenchmark.Baseline.Schema.GenerateSpecOptions.Mutable Spec
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SpecUtf8, out Corvus.NestCliBenchmark.Baseline.Schema.GenerateSpecOptions.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new GenerateOptions(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetBaseDir(in Corvus.NestCliBenchmark.Baseline.Schema.GenerateBaseDirOptions.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.BaseDirUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BaseDirUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                ...
                else
                {
                    ...
                    value.AddAsProperty(JsonPropertyNamesEscaped.BaseDir, ref cvb, escapeName: false, nameRequiresUnescaping: false);
            ...
            /// <summary>
            /// Remove the <c>baseDir</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveBaseDir()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.BaseDirUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetFlat(in Corvus.NestCliBenchmark.Baseline.Schema.GenerateFlatOptions.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.FlatUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FlatUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsProperty(JsonPropertyNamesEscaped.Flat, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// <summary>
            /// Remove the <c>flat</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveFlat()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.FlatUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetSpec(in Corvus.NestCliBenchmark.Baseline.Schema.GenerateSpecOptions.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.SpecUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SpecUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsProperty(JsonPropertyNamesEscaped.Spec, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetSpec<TContext>(in Corvus.NestCliBenchmark.Baseline.Schema.GenerateSpecOptions.Source<TContext> value)
            ...
            /// <summary>
            /// Remove the <c>spec</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveSpec()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.SpecUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"GenerateOptions.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="GenerateOptions"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="GenerateOptions"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly GenerateOptions Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<GenerateOptions>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="GenerateOptions"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly GenerateOptions Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<GenerateOptions>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.NestCliBenchmark.Baseline.Schema.GenerateOptions.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(GenerateOptions instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.NestCliBenchmark.Baseline.Schema.GenerateOptions.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="GenerateOptions"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.NestCliBenchmark.Baseline.Schema.GenerateBaseDirOptions.Source baseDir = default,
                in Corvus.NestCliBenchmark.Baseline.Schema.GenerateFlatOptions.Source flat = default,
                in Corvus.NestCliBenchmark.Baseline.Schema.GenerateSpecOptions.Source spec = default)
            {
                baseDir.AddAsProperty(JsonPropertyNamesEscaped.BaseDir, ref builder, escapeName: false);
                flat.AddAsProperty(JsonPropertyNamesEscaped.Flat, ref builder, escapeName: false);
                spec.AddAsProperty(JsonPropertyNamesEscaped.Spec, ref builder, escapeName: false);
            }
            ...
            public void Create(
                ...
                in Corvus.NestCliBenchmark.Baseline.Schema.GenerateSpecOptions.Source spec = default)
            {
                Create(ref _builder, baseDir, flat, spec);
            }
            ...
            internal static void Create<TContext>(
                ...
                in Corvus.NestCliBenchmark.Baseline.Schema.GenerateBaseDirOptions.Source baseDir = default,
                in Corvus.NestCliBenchmark.Baseline.Schema.GenerateFlatOptions.Source flat = default,
                in Corvus.NestCliBenchmark.Baseline.Schema.GenerateSpecOptions.Source<TContext> spec = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            #endif
            {
                Create(context, ref _builder, baseDir, flat, spec);
            }
        ...
        /// </summary>
        /// <param name="workspace">The JSON workspace.</param>
        /// <param name="baseDir">The value of the property.</param>
        /// <param name="flat">The value of the property.</param>
        /// <param name="spec">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.NestCliBenchmark.Baseline.Schema.GenerateBaseDirOptions.Source baseDir = default, in Corvus.NestCliBenchmark.Baseline.Schema.GenerateFlatOptions.Source flat = default, in Corvus.NestCliBenchmark.Baseline.Schema.GenerateSpecOptions.Source spec = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(baseDir, flat, spec);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
            ...
            #endif
        {
            ...
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(context, baseDir, flat, spec);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<GenerateOptions, Mutable>(this);
        }
    }
}
