...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GenerateOptions"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal GenerateOptions(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static GenerateOptions DefaultInstance { get; } = GenerateOptions.ParseValue("{}"u8);
        ...
        /// </para>
        /// </remarks>
        public Corvus.NestCliBenchmark.Baseline.Schema.GenerateBaseDirOptions BaseDir
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BaseDirUtf8, out Corvus.NestCliBenchmark.Baseline.Schema.GenerateBaseDirOptions value))
                {
                    return value;
                }

                return Corvus.NestCliBenchmark.Baseline.Schema.GenerateBaseDirOptions.DefaultInstance;
            }
        }
        ...
        /// </para>
        /// </remarks>
        public Corvus.NestCliBenchmark.Baseline.Schema.GenerateFlatOptions Flat
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FlatUtf8, out Corvus.NestCliBenchmark.Baseline.Schema.GenerateFlatOptions value))
                {
                    return value;
                }

                return Corvus.NestCliBenchmark.Baseline.Schema.GenerateFlatOptions.DefaultInstance;
            }
        }
        ...
        /// </para>
        /// </remarks>
        public Corvus.NestCliBenchmark.Baseline.Schema.GenerateSpecOptions Spec
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SpecUtf8, out Corvus.NestCliBenchmark.Baseline.Schema.GenerateSpecOptions value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in GenerateOptions left, in GenerateOptions right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in GenerateOptions left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(GenerateOptions instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GenerateOptions(JsonElement instance)
        {
            return GenerateOptions.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GenerateOptions From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GenerateOptions ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<GenerateOptions>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GenerateOptions ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<GenerateOptions>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GenerateOptions ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<GenerateOptions>(json, options);
        }
        ...
        /// </exception>
        public static GenerateOptions ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<GenerateOptions>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out GenerateOptions? result)
        {
            return JsonElementHelpers.TryParseValue<GenerateOptions>(ref reader, out result);
        }
...
#if NET
        static GenerateOptions IJsonElement<GenerateOptions>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GenerateOptions: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public GenerateOptions Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<GenerateOptions>(_idx);
            }
        ...
        {
            /// <summary>
            /// Gets the JSON property name for <see cref="BaseDir"/>.
            /// </summary>
            public const string BaseDir = "baseDir";

            /// <summary>
            /// Gets the JSON property name for <see cref="Flat"/>.
            /// </summary>
            public const string Flat = "flat";

            /// <summary>
            /// Gets the JSON property name for <see cref="Spec"/>.
            /// </summary>
            ...
            /// Gets the JSON property name for <see cref="BaseDir"/>.
            /// </summary>
            public static ReadOnlySpan<byte> BaseDirUtf8 => "baseDir"u8;

            /// <summary>
            /// Gets the JSON property name for <see cref="Flat"/>.
            /// </summary>
            public static ReadOnlySpan<byte> FlatUtf8 => "flat"u8;

            /// <summary>
            /// Gets the JSON property name for <see cref="Spec"/>.
            /// </summary>
            public static ReadOnlySpan<byte> SpecUtf8 => "spec"u8;
        }
        ...
        {
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="BaseDir"/>.
            /// </summary>
            public static ReadOnlySpan<byte> BaseDir => "baseDir"u8;

            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="Flat"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Flat => "flat"u8;

            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="Spec"/>.
            /// </summary>
