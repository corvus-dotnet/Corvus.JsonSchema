...
public readonly partial struct Schema
{
        ...
        : IJsonElement<GraphQlPluginOptions>
    {
        ...
        {
            private static readonly JsonSchemaPathProvider TypeFileNameSuffixSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/typeFileNameSuffix"u8, buffer, out written);

            private static void MatchTypeFileNameSuffix(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext =
                    Corvus.NestCliBenchmark.Baseline.Schema.GraphQlPluginOptions.TypeFileNameSuffixArray.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.TypeFileNameSuffixUtf8,
                        evaluationPath: TypeFileNameSuffixSchemaEvaluationPath);

                Corvus.NestCliBenchmark.Baseline.Schema.GraphQlPluginOptions.TypeFileNameSuffixArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            {
                if (span.SequenceEqual(JsonPropertyNames.TypeFileNameSuffixUtf8))
                {
                    matcher = MatchTypeFileNameSuffix;
                    return true;
                }
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://json.schemastore.org/nest-cli.json#/definitions/GraphQLPluginOptions"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "https://json.schemastore.org/nest-cli.json#/definitions/GraphQLPluginOptions";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://json.schemastore.org/nest-cli.json#/definitions/GraphQLPluginOptions"u8;
