...
public readonly partial struct Schema
{
    ...
    public readonly partial struct GraphQlPluginOptions
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.NestCliBenchmark.Baseline.Schema.GraphQlPluginOptions.TypeFileNameSuffixArray.Mutable TypeFileNameSuffix
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeFileNameSuffixUtf8, out Corvus.NestCliBenchmark.Baseline.Schema.GraphQlPluginOptions.TypeFileNameSuffixArray.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetTypeFileNameSuffix(in Corvus.NestCliBenchmark.Baseline.Schema.GraphQlPluginOptions.TypeFileNameSuffixArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetTypeFileNameSuffix<TContext>(in Corvus.NestCliBenchmark.Baseline.Schema.GraphQlPluginOptions.TypeFileNameSuffixArray.Source<TContext> value)
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.NestCliBenchmark.Baseline.Schema.GraphQlPluginOptions.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.NestCliBenchmark.Baseline.Schema.GraphQlPluginOptions.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.NestCliBenchmark.Baseline.Schema.GraphQlPluginOptions.TypeFileNameSuffixArray.Source typeFileNameSuffix = default)
            {
            ...
            /// Creates an instance of a <see cref="GraphQlPluginOptions"/>.
            /// </summary>
            public void Create(in Corvus.NestCliBenchmark.Baseline.Schema.GraphQlPluginOptions.TypeFileNameSuffixArray.Source typeFileNameSuffix = default)
            {
            ...
            internal static void Create<TContext>(
                ...
                in Corvus.NestCliBenchmark.Baseline.Schema.GraphQlPluginOptions.TypeFileNameSuffixArray.Source<TContext> typeFileNameSuffix = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            /// Creates an instance of a <see cref="GraphQlPluginOptions"/>.
            /// </summary>
            public void Create<TContext>(in TContext context, in Corvus.NestCliBenchmark.Baseline.Schema.GraphQlPluginOptions.TypeFileNameSuffixArray.Source<TContext> typeFileNameSuffix = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.NestCliBenchmark.Baseline.Schema.GraphQlPluginOptions.TypeFileNameSuffixArray.Source typeFileNameSuffix = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.NestCliBenchmark.Baseline.Schema.GraphQlPluginOptions.TypeFileNameSuffixArray.Source<TContext> typeFileNameSuffix = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
