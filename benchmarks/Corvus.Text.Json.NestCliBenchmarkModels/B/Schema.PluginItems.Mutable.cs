...
public readonly partial struct Schema
{
    ...
    public readonly partial struct PluginItems
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.NestCliBenchmark.Baseline.JsonString.Mutable Name
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out Corvus.NestCliBenchmark.Baseline.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public Corvus.NestCliBenchmark.Baseline.Schema.PluginItems.OptionsEntity.Mutable Options
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OptionsUtf8, out Corvus.NestCliBenchmark.Baseline.Schema.PluginItems.OptionsEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetName(in Corvus.NestCliBenchmark.Baseline.JsonString.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetOptions(in Corvus.NestCliBenchmark.Baseline.Schema.PluginItems.OptionsEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetOptions<TContext>(in Corvus.NestCliBenchmark.Baseline.Schema.PluginItems.OptionsEntity.Source<TContext> value)
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.NestCliBenchmark.Baseline.Schema.PluginItems.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.NestCliBenchmark.Baseline.Schema.PluginItems.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.NestCliBenchmark.Baseline.JsonString.Source name = default,
                in Corvus.NestCliBenchmark.Baseline.Schema.PluginItems.OptionsEntity.Source options = default)
            {
            ...
            /// Creates an instance of a <see cref="PluginItems"/>.
            /// </summary>
            public void Create(in Corvus.NestCliBenchmark.Baseline.JsonString.Source name = default, in Corvus.NestCliBenchmark.Baseline.Schema.PluginItems.OptionsEntity.Source options = default)
            {
            ...
            internal static void Create<TContext>(
                ...
                ref ComplexValueBuilder builder,
                in Corvus.NestCliBenchmark.Baseline.JsonString.Source name = default,
                in Corvus.NestCliBenchmark.Baseline.Schema.PluginItems.OptionsEntity.Source<TContext> options = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.NestCliBenchmark.Baseline.JsonString.Source name = default, in Corvus.NestCliBenchmark.Baseline.Schema.PluginItems.OptionsEntity.Source options = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.NestCliBenchmark.Baseline.JsonString.Source name = default, in Corvus.NestCliBenchmark.Baseline.Schema.PluginItems.OptionsEntity.Source<TContext> options = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
