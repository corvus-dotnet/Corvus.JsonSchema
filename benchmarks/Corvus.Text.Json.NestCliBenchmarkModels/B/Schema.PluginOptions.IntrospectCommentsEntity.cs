...
public readonly partial struct Schema
{
    ...
    public readonly partial struct PluginOptions
    {
        ...
        public readonly partial struct IntrospectCommentsEntity
#if NET8_0_OR_GREATER
            : IJsonElement<IntrospectCommentsEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="IntrospectCommentsEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal IntrospectCommentsEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static IntrospectCommentsEntity DefaultInstance { get; } = ParsedJsonDocument<IntrospectCommentsEntity>.True;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(IntrospectCommentsEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in IntrospectCommentsEntity left, in IntrospectCommentsEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in IntrospectCommentsEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(IntrospectCommentsEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator IntrospectCommentsEntity(JsonElement instance)
            {
                return IntrospectCommentsEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static IntrospectCommentsEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static IntrospectCommentsEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<IntrospectCommentsEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static IntrospectCommentsEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<IntrospectCommentsEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static IntrospectCommentsEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<IntrospectCommentsEntity>(json, options);
            }
            ...
            /// </exception>
            public static IntrospectCommentsEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<IntrospectCommentsEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out IntrospectCommentsEntity? result)
            {
                return JsonElementHelpers.TryParseValue<IntrospectCommentsEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new IntrospectCommentsEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static IntrospectCommentsEntity IJsonElement<IntrospectCommentsEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"IntrospectCommentsEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="IntrospectCommentsEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="IntrospectCommentsEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public IntrospectCommentsEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<IntrospectCommentsEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="IntrospectCommentsEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public IntrospectCommentsEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<IntrospectCommentsEntity>(_idx);
                }
