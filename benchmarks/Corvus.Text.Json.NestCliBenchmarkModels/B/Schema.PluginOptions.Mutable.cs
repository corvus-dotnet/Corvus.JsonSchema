...
public readonly partial struct Schema
{
    ...
    public readonly partial struct PluginOptions
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.NestCliBenchmark.Baseline.Schema.PluginOptions.IntrospectCommentsEntity.Mutable IntrospectComments
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IntrospectCommentsUtf8, out Corvus.NestCliBenchmark.Baseline.Schema.PluginOptions.IntrospectCommentsEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetIntrospectComments(in Corvus.NestCliBenchmark.Baseline.Schema.PluginOptions.IntrospectCommentsEntity.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.NestCliBenchmark.Baseline.Schema.PluginOptions.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.NestCliBenchmark.Baseline.Schema.PluginOptions.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.NestCliBenchmark.Baseline.Schema.PluginOptions.IntrospectCommentsEntity.Source introspectComments = default)
            {
            ...
            /// Creates an instance of a <see cref="PluginOptions"/>.
            /// </summary>
            public void Create(in Corvus.NestCliBenchmark.Baseline.Schema.PluginOptions.IntrospectCommentsEntity.Source introspectComments = default)
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.NestCliBenchmark.Baseline.Schema.PluginOptions.IntrospectCommentsEntity.Source introspectComments = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
