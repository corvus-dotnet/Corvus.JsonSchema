...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PluginOptions"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal PluginOptions(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static PluginOptions DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.NestCliBenchmark.Baseline.Schema.PluginOptions.IntrospectCommentsEntity IntrospectComments
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IntrospectCommentsUtf8, out Corvus.NestCliBenchmark.Baseline.Schema.PluginOptions.IntrospectCommentsEntity value))
                {
                    return value;
                }

                return Corvus.NestCliBenchmark.Baseline.Schema.PluginOptions.IntrospectCommentsEntity.DefaultInstance;
            }
        }
        ...
        /// </returns>
        public static bool operator ==(in PluginOptions left, in PluginOptions right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in PluginOptions left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(PluginOptions instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PluginOptions(JsonElement instance)
        {
            return PluginOptions.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PluginOptions From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PluginOptions ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PluginOptions>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PluginOptions ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PluginOptions>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PluginOptions ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PluginOptions>(json, options);
        }
        ...
        /// </exception>
        public static PluginOptions ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<PluginOptions>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out PluginOptions? result)
        {
            return JsonElementHelpers.TryParseValue<PluginOptions>(ref reader, out result);
        }
...
#if NET
        static PluginOptions IJsonElement<PluginOptions>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PluginOptions: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        {
            /// <summary>
            /// Gets the JSON property name for <see cref="IntrospectComments"/>.
            /// </summary>
            public const string IntrospectComments = "introspectComments";

            /// <summary>
            /// Gets the JSON property name for <see cref="IntrospectComments"/>.
            /// </summary>
            public static ReadOnlySpan<byte> IntrospectCommentsUtf8 => "introspectComments"u8;
        }
        ...
        {
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="IntrospectComments"/>.
            /// </summary>
            public static ReadOnlySpan<byte> IntrospectComments => "introspectComments"u8;
        }
    }
}
