...
public readonly partial struct Schema
{
    ...
    public readonly partial struct RootEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(RootEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="RootEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RootEntity(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RootEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RootEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RootEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RootEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly RootEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RootEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RootEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly RootEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<RootEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(RootEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<RootEntity, Mutable>(this);
        }
    }
}
