    ...
    public readonly partial struct SwaggerPluginOptions
    {
        ...
        public readonly partial struct DtoKeyOfCommentEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(DtoKeyOfCommentEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DtoKeyOfCommentEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DtoKeyOfCommentEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new DtoKeyOfCommentEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DtoKeyOfCommentEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="DtoKeyOfCommentEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="DtoKeyOfCommentEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly DtoKeyOfCommentEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<DtoKeyOfCommentEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="DtoKeyOfCommentEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly DtoKeyOfCommentEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DtoKeyOfCommentEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(DtoKeyOfCommentEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<DtoKeyOfCommentEntity, Mutable>(this);
            }
        }
    }
}
