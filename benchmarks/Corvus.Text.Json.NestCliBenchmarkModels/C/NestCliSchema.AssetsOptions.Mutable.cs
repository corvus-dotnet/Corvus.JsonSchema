...
public readonly partial struct NestCliSchema
{
    ...
    public readonly partial struct AssetsOptions
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.NestCliBenchmark.Current.JsonString.Mutable Exclude
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExcludeUtf8, out Corvus.NestCliBenchmark.Current.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.NestCliBenchmark.Current.JsonString.Mutable Include
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IncludeUtf8, out Corvus.NestCliBenchmark.Current.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.NestCliBenchmark.Current.JsonBoolean.Mutable WatchAssets
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.WatchAssetsUtf8, out Corvus.NestCliBenchmark.Current.JsonBoolean.Mutable value))
                    {
                        return value;
                    }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.NestCliBenchmark.Current.JsonString.Source _createArg3;
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.NestCliBenchmark.Current.NestCliSchema.AssetsOptions.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.NestCliBenchmark.Current.JsonString.Source exclude = default,
                in Corvus.NestCliBenchmark.Current.JsonString.Source include = default,
                in Corvus.NestCliBenchmark.Current.JsonString.Source outDir = default,
                in Corvus.NestCliBenchmark.Current.JsonBoolean.Source watchAssets = default)
            {
        ...
        public static ParsedJsonDocument<AssetsOptions> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<AssetsOptions>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<AssetsOptions> Create<TContext>(
        ...
        public static ParsedJsonDocument<AssetsOptions> Create(in Corvus.NestCliBenchmark.Current.JsonString.Source exclude = default, in Corvus.NestCliBenchmark.Current.JsonString.Source include = default, in Corvus.NestCliBenchmark.Current.JsonString.Source outDir = default, in Corvus.NestCliBenchmark.Current.JsonBoolean.Source watchAssets = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
