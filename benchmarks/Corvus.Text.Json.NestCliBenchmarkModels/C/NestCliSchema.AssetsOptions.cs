...
public readonly partial struct NestCliSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AssetsOptions"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal AssetsOptions(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static AssetsOptions DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.NestCliBenchmark.Current.JsonString Exclude
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExcludeUtf8, out Corvus.NestCliBenchmark.Current.JsonString value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.NestCliBenchmark.Current.JsonString Include
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IncludeUtf8, out Corvus.NestCliBenchmark.Current.JsonString value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.NestCliBenchmark.Current.JsonBoolean WatchAssets
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.WatchAssetsUtf8, out Corvus.NestCliBenchmark.Current.JsonBoolean value))
                {
                    return value;
                }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(AssetsOptions value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in AssetsOptions left, in AssetsOptions right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in AssetsOptions left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(AssetsOptions instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator AssetsOptions(JsonElement instance)
        {
            return AssetsOptions.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AssetsOptions From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AssetsOptions ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AssetsOptions>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AssetsOptions ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AssetsOptions>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AssetsOptions ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AssetsOptions>(json, options);
        }
        ...
        /// </exception>
        public static AssetsOptions ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<AssetsOptions>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out AssetsOptions? result)
        {
            return JsonElementHelpers.TryParseValue<AssetsOptions>(ref reader, out result);
        }
...
#if NET
        static AssetsOptions IJsonElement<AssetsOptions>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"AssetsOptions: ValueKind = {ValueKind} : \"{ToString()}\"";
