...
public readonly partial struct NestCliSchema
{
    ...
    public readonly partial struct CollectionEntity
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<CollectionEntity, Mutable>(CollectionEntity.DefaultInstance);
        ...
        public static ParsedJsonDocument<CollectionEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<CollectionEntity>();
            }
            finally
            {
