                ...
                public readonly partial struct OptionsEntity
                {
                    ...
                    public readonly partial struct ArrayOfFilArray
                    {
...
#endif
                        {
                            ...
                            public static explicit operator Mutable(ArrayOfFilArray instance)
                            {
                            ...
                            /// <returns>An immutable instance of a <see cref="ArrayOfFilArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator ArrayOfFilArray(Mutable instance)
                            {
                            ...
                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            private string DebuggerDisplay => $"ArrayOfFilArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                            /// <summary>
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly ArrayOfFilArray Clone()
                            {
                                CheckValidInstance();
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly ArrayOfFilArray Freeze()
                            {
                                CheckValidInstance();
                                return _parent.FreezeElement<ArrayOfFilArray>(_idx);
                            }
                        }
                        ...
                        public ref struct Source
                        {
                            ...
                            internal Source(Corvus.NestCliBenchmark.Current.NestCliSchema.CompilerOptions.BuilderEntity.AnyOf1Entity.OptionsEntity.ArrayOfFilArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                            public static implicit operator Source(ArrayOfFilArray instance) => new(JsonElement.From(instance));
                            ...
                            #endif
                        {
                            ...
                            internal Source(scoped in TContext context, Corvus.NestCliBenchmark.Current.NestCliSchema.CompilerOptions.BuilderEntity.AnyOf1Entity.OptionsEntity.ArrayOfFilArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
                        ...
                        {
                            return workspace.CreateBuilder<ArrayOfFilArray, Mutable>(this);
                        }
                        ...
                        public static ParsedJsonDocument<ArrayOfFilArray> Create(
                            scoped in Source value, int initialCapacity = 30)
                        {
                            ...
                            try
                            {
                                ...
                                Debug.Assert(cvb.MemberCount == 1);
                                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                return documentBuilder.ToParsedJsonDocument<ArrayOfFilArray>();
                            }
                            finally
                            {
                        ...
                        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                        public static ParsedJsonDocument<ArrayOfFilArray> Create<TContext>(
