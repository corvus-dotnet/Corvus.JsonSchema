        ...
        public readonly partial struct BuilderEntity
        {
            ...
            public readonly partial struct AnyOf1Entity
            {
                ...
                public readonly partial struct OptionsEntity
                {
                    ...
                    public readonly partial struct ArrayOfFilArray
#if NET8_0_OR_GREATER
                        : IJsonElement<ArrayOfFilArray>,
                          IFormattable,
                          ISpanFormattable,
...
#endif
                    {
                        ...
                        /// <summary>
                        /// Initializes a new instance of the <see cref="ArrayOfFilArray"/> struct.
                        /// </summary>
                        /// <param name="value">The value from which to construct the instance.</param>
                        internal ArrayOfFilArray(IJsonDocument parent, int idx)
                        {
                            Debug.Assert(idx >= 0);
                            _parent = parent;
                            _idx = idx;
                        ...
                        /// </summary>
                        public static ArrayOfFilArray DefaultInstance { get; }
                        ...
                        public Corvus.NestCliBenchmark.Current.JsonString this[int index]
                        {
                            get
                            {
                                CheckValidInstance();
                                return _parent.GetArrayIndexElement<Corvus.NestCliBenchmark.Current.JsonString>(_idx, index);
                            }
                        }
                        ...
                        /// </summary>
                        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                        public ArrayEnumerator<Corvus.NestCliBenchmark.Current.JsonString> EnumerateArray()
                        {
                            CheckValidInstance();
                            return EnumeratorCreator.CreateArrayEnumerator<Corvus.NestCliBenchmark.Current.JsonString>(_parent, _idx);
                        }
                        ...
                        /// </returns>
                        public static bool operator ==(in ArrayOfFilArray left, in ArrayOfFilArray right)
                        {
                        ...
                        /// <c>True</c> if the values are equal.
                        /// </returns>
                        public static bool operator ==(in ArrayOfFilArray left, in JsonElement right)
                        {
                            return left.Equals(right);
                        }
                        ...
                        public static implicit operator JsonElement(ArrayOfFilArray instance)
                        {
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator ArrayOfFilArray(JsonElement instance)
                        {
                            return ArrayOfFilArray.From(instance);
                        }
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static ArrayOfFilArray From<T>(in T instance)
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static ArrayOfFilArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<ArrayOfFilArray>(utf8Json, options);
                        }
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static ArrayOfFilArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<ArrayOfFilArray>(json, options);
                        }
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static ArrayOfFilArray ParseValue(string json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<ArrayOfFilArray>(json, options);
                        }
                        ...
                        /// </exception>
                        public static ArrayOfFilArray ParseValue(ref Utf8JsonReader reader)
                        {
                            return JsonElementHelpers.ParseValue<ArrayOfFilArray>(ref reader);
                        }
                        ...
                        ///   A value could not be read from the reader.
                        /// </exception>
                        public static bool TryParseValue(ref Utf8JsonReader reader, out ArrayOfFilArray? result)
                        {
                            return JsonElementHelpers.TryParseValue<ArrayOfFilArray>(ref reader, out result);
                        }
                        ...
                        {
                            return
                                (obj is IJsonElement value && Equals(new ArrayOfFilArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                        static ArrayOfFilArray IJsonElement<ArrayOfFilArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"ArrayOfFilArray: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// <summary>
                        /// Gets a <see cref="ArrayOfFilArray"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </summary>
                        /// <returns>
                        /// A <see cref="ArrayOfFilArray"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </returns>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public ArrayOfFilArray Clone()
                        {
                            CheckValidInstance();
                            return _parent.CloneElement<ArrayOfFilArray>(_idx);
                        }
                        ...
                        /// </summary>
                        /// <returns>
                        /// An immutable <see cref="ArrayOfFilArray"/> that lives for the lifetime of its
                        ...
                        /// </para>
                        /// </remarks>
                        public ArrayOfFilArray Freeze()
                        {
                            CheckValidInstance();
                            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                            {
                                return mutable.FreezeElement<ArrayOfFilArray>(_idx);
                            }
