...
public readonly partial struct NestCliSchema
{
    ...
    public readonly partial struct CompilerOptions
    {
...
#endif
        {
            ...
            public static explicit operator Corvus.NestCliBenchmark.Current.NestCliSchema.CompilerOptions.BuilderEntity.AnyOf0Entity(BuilderEntity value)
            {
                return Corvus.NestCliBenchmark.Current.NestCliSchema.CompilerOptions.BuilderEntity.AnyOf0Entity.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator BuilderEntity(Corvus.NestCliBenchmark.Current.NestCliSchema.CompilerOptions.BuilderEntity.AnyOf0Entity value)
            {
                return From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.NestCliBenchmark.Current.NestCliSchema.CompilerOptions.BuilderEntity.AnyOf1Entity(BuilderEntity value)
            {
                return Corvus.NestCliBenchmark.Current.NestCliSchema.CompilerOptions.BuilderEntity.AnyOf1Entity.From(value);
            }
            ...
            public bool TryGetAsAnyOf0Entity(out Corvus.NestCliBenchmark.Current.NestCliSchema.CompilerOptions.BuilderEntity.AnyOf0Entity result)
            {
                ...
                {
                    result = Corvus.NestCliBenchmark.Current.NestCliSchema.CompilerOptions.BuilderEntity.AnyOf0Entity.From(this);
                    return true;
                }
            ...
            public bool TryGetAsAnyOf1Entity(out Corvus.NestCliBenchmark.Current.NestCliSchema.CompilerOptions.BuilderEntity.AnyOf1Entity result)
            {
                ...
                {
                    result = Corvus.NestCliBenchmark.Current.NestCliSchema.CompilerOptions.BuilderEntity.AnyOf1Entity.From(this);
                    return true;
                }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.NestCliBenchmark.Current.NestCliSchema.CompilerOptions.BuilderEntity, TContext, TResult> defaultMatch)
...
#endif
            {
                if (Corvus.NestCliBenchmark.Current.NestCliSchema.CompilerOptions.BuilderEntity.AnyOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchAnyOf0Entity(Corvus.NestCliBenchmark.Current.NestCliSchema.CompilerOptions.BuilderEntity.AnyOf0Entity.From(this), context);
                }

                if (Corvus.NestCliBenchmark.Current.NestCliSchema.CompilerOptions.BuilderEntity.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchAnyOf1Entity(Corvus.NestCliBenchmark.Current.NestCliSchema.CompilerOptions.BuilderEntity.AnyOf1Entity.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.NestCliBenchmark.Current.NestCliSchema.CompilerOptions.BuilderEntity, TResult> defaultMatch)
            {
                if (Corvus.NestCliBenchmark.Current.NestCliSchema.CompilerOptions.BuilderEntity.AnyOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchAnyOf0Entity(Corvus.NestCliBenchmark.Current.NestCliSchema.CompilerOptions.BuilderEntity.AnyOf0Entity.From(this));
                }

                if (Corvus.NestCliBenchmark.Current.NestCliSchema.CompilerOptions.BuilderEntity.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchAnyOf1Entity(Corvus.NestCliBenchmark.Current.NestCliSchema.CompilerOptions.BuilderEntity.AnyOf1Entity.From(this));
                }
            ...
            public TAccumulator MatchEvery<TAccumulator>(
                ...
                Matcher<Corvus.NestCliBenchmark.Current.NestCliSchema.CompilerOptions.BuilderEntity, TAccumulator, TAccumulator> defaultMatch)
            {
                bool matched = false;
                ...
                {
                    matched = true;
                    accumulator = matchAnyOf0Entity(Corvus.NestCliBenchmark.Current.NestCliSchema.CompilerOptions.BuilderEntity.AnyOf0Entity.From(this), accumulator);
                }

                if (Corvus.NestCliBenchmark.Current.NestCliSchema.CompilerOptions.BuilderEntity.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    matched = true;
                    accumulator = matchAnyOf1Entity(Corvus.NestCliBenchmark.Current.NestCliSchema.CompilerOptions.BuilderEntity.AnyOf1Entity.From(this), accumulator);
                }
