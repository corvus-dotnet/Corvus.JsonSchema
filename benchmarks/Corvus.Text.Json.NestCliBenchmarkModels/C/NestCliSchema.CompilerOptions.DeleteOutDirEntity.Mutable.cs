    ...
    public readonly partial struct CompilerOptions
    {
        ...
        public readonly partial struct DeleteOutDirEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DeleteOutDirEntity, Mutable>(DeleteOutDirEntity.DefaultInstance);
            ...
            public static ParsedJsonDocument<DeleteOutDirEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<DeleteOutDirEntity>();
                }
                finally
                {
