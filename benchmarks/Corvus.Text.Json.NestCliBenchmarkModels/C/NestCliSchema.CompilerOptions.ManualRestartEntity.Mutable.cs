    ...
    public readonly partial struct CompilerOptions
    {
        ...
        public readonly partial struct ManualRestartEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ManualRestartEntity, Mutable>(ManualRestartEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(ManualRestartEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ManualRestartEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ManualRestartEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ManualRestartEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ManualRestartEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ManualRestartEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ManualRestartEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ManualRestartEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ManualRestartEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ManualRestartEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ManualRestartEntity>();
                }
                finally
                {
