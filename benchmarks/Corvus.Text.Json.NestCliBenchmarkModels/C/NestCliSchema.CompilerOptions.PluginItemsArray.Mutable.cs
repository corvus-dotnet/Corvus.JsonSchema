    ...
    public readonly partial struct CompilerOptions
    {
        ...
        public readonly partial struct PluginItemsArray
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<PluginItemsArray, Mutable>(PluginItemsArray.DefaultInstance);
                ...
                public static explicit operator Mutable(PluginItemsArray instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="PluginItemsArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator PluginItemsArray(Mutable instance)
                {
                ...
                public Corvus.NestCliBenchmark.Current.NestCliSchema.PluginItems.Mutable this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.NestCliBenchmark.Current.NestCliSchema.PluginItems.Mutable>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.NestCliBenchmark.Current.NestCliSchema.PluginItems.Mutable> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.NestCliBenchmark.Current.NestCliSchema.PluginItems.Mutable>(_parent, _idx);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new PluginItemsArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"PluginItemsArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetItem(int itemIndex, in Corvus.NestCliBenchmark.Current.NestCliSchema.PluginItems.Source value)
                {
                    CheckValidInstance();
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void InsertItem(int itemIndex, scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.PluginItems.Source value)
                {
                    CheckValidInstance();
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void AddItem(scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.PluginItems.Source value)
                {
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Remove(in Corvus.NestCliBenchmark.Current.NestCliSchema.PluginItems item)
                {
                    CheckValidInstance();
                    if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.NestCliBenchmark.Current.NestCliSchema.PluginItems>(this, in item))
                    {
                        return false;
                    }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void RemoveWhere(JsonPredicate<Corvus.NestCliBenchmark.Current.NestCliSchema.PluginItems> predicate)
                {
                    CheckValidInstance();
                    JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.NestCliBenchmark.Current.NestCliSchema.PluginItems>(this, predicate);
                    _documentVersion = _parent.Version;
                }
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Replace(in Corvus.NestCliBenchmark.Current.NestCliSchema.PluginItems oldItem, in Corvus.NestCliBenchmark.Current.NestCliSchema.PluginItems.Source newItem)
                {
                    CheckValidInstance();
                    ...
                    var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.NestCliBenchmark.Current.NestCliSchema.PluginItems>(_parent, _idx);

                    while (enumerator.MoveNext())
                    {
                        Corvus.NestCliBenchmark.Current.NestCliSchema.PluginItems current = enumerator.Current;
                ...
                /// <summary>
                /// Gets a <see cref="PluginItemsArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="PluginItemsArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly PluginItemsArray Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<PluginItemsArray>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="PluginItemsArray"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly PluginItemsArray Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<PluginItemsArray>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.NestCliBenchmark.Current.NestCliSchema.CompilerOptions.PluginItemsArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(PluginItemsArray instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.NestCliBenchmark.Current.NestCliSchema.CompilerOptions.PluginItemsArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// </summary>
                public void AddItem(in Corvus.NestCliBenchmark.Current.NestCliSchema.PluginItems.Source value)
                {
                ...
                /// Add an item to the array.
                /// </summary>
                public void AddItem<TContext>(in Corvus.NestCliBenchmark.Current.NestCliSchema.PluginItems.Source<TContext> value)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
            ...
            {
                return workspace.CreateBuilder<PluginItemsArray, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<PluginItemsArray> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<PluginItemsArray>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<PluginItemsArray> Create<TContext>(
