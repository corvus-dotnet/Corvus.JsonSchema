    ...
    public readonly partial struct CompilerOptions
    {
        ...
        public readonly partial struct TypeCheckEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<TypeCheckEntity, Mutable>(TypeCheckEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(TypeCheckEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TypeCheckEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TypeCheckEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TypeCheckEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(TypeCheckEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<TypeCheckEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<TypeCheckEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TypeCheckEntity>();
                }
                finally
                {
