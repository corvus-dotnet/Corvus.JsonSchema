    ...
    public readonly partial struct CompilerOptions
    {
        ...
        public readonly partial struct WatchAssetsEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<WatchAssetsEntity, Mutable>(WatchAssetsEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(WatchAssetsEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="WatchAssetsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator WatchAssetsEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"WatchAssetsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly WatchAssetsEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly WatchAssetsEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<WatchAssetsEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(WatchAssetsEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<WatchAssetsEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<WatchAssetsEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<WatchAssetsEntity>();
                }
                finally
                {
