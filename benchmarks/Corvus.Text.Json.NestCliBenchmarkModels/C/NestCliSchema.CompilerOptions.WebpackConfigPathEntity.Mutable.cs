    ...
    public readonly partial struct CompilerOptions
    {
        ...
        public readonly partial struct WebpackConfigPathEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<WebpackConfigPathEntity, Mutable>(WebpackConfigPathEntity.DefaultInstance);
            ...
            public static ParsedJsonDocument<WebpackConfigPathEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<WebpackConfigPathEntity>();
                }
                finally
                {
