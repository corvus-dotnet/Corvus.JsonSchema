    ...
    public readonly partial struct CompilerOptions
    {
        ...
        public readonly partial struct WebpackEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<WebpackEntity, Mutable>(WebpackEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(WebpackEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="WebpackEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator WebpackEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"WebpackEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly WebpackEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly WebpackEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<WebpackEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(WebpackEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<WebpackEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<WebpackEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<WebpackEntity>();
                }
                finally
                {
