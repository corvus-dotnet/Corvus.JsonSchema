...
public readonly partial struct NestCliSchema
{
    ...
    public readonly partial struct GenerateBaseDirOptions
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<GenerateBaseDirOptions, Mutable>(GenerateBaseDirOptions.DefaultInstance);
            ...
            public static explicit operator Mutable(GenerateBaseDirOptions instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="GenerateBaseDirOptions"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator GenerateBaseDirOptions(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"GenerateBaseDirOptions.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly GenerateBaseDirOptions Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly GenerateBaseDirOptions Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<GenerateBaseDirOptions>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(GenerateBaseDirOptions instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<GenerateBaseDirOptions, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<GenerateBaseDirOptions> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<GenerateBaseDirOptions>();
            }
            finally
            {
