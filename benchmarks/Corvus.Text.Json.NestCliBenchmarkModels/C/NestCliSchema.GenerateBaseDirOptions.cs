...
public readonly partial struct NestCliSchema
{
    ...
    public readonly partial struct GenerateBaseDirOptions
#if NET8_0_OR_GREATER
        : IJsonElement<GenerateBaseDirOptions>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GenerateBaseDirOptions"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal GenerateBaseDirOptions(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static GenerateBaseDirOptions DefaultInstance { get; } = ParsedJsonDocument<GenerateBaseDirOptions>.StringConstant([.."\"\""u8]);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(GenerateBaseDirOptions value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in GenerateBaseDirOptions left, in GenerateBaseDirOptions right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in GenerateBaseDirOptions left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(GenerateBaseDirOptions instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GenerateBaseDirOptions(JsonElement instance)
        {
            return GenerateBaseDirOptions.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GenerateBaseDirOptions From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GenerateBaseDirOptions ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<GenerateBaseDirOptions>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GenerateBaseDirOptions ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<GenerateBaseDirOptions>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GenerateBaseDirOptions ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<GenerateBaseDirOptions>(json, options);
        }
        ...
        /// </exception>
        public static GenerateBaseDirOptions ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<GenerateBaseDirOptions>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out GenerateBaseDirOptions? result)
        {
            return JsonElementHelpers.TryParseValue<GenerateBaseDirOptions>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new GenerateBaseDirOptions(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static GenerateBaseDirOptions IJsonElement<GenerateBaseDirOptions>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GenerateBaseDirOptions: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="GenerateBaseDirOptions"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="GenerateBaseDirOptions"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public GenerateBaseDirOptions Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<GenerateBaseDirOptions>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="GenerateBaseDirOptions"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public GenerateBaseDirOptions Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<GenerateBaseDirOptions>(_idx);
            }
