...
public readonly partial struct NestCliSchema
{
    ...
    public readonly partial struct GenerateFlatOptions
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<GenerateFlatOptions, Mutable>(GenerateFlatOptions.DefaultInstance);
        ...
        public static ParsedJsonDocument<GenerateFlatOptions> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<GenerateFlatOptions>();
            }
            finally
            {
