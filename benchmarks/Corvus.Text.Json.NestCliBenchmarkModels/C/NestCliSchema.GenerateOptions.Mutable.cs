...
public readonly partial struct NestCliSchema
{
    ...
    public readonly partial struct GenerateOptions
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.NestCliBenchmark.Current.NestCliSchema.GenerateBaseDirOptions.Mutable BaseDir
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BaseDirUtf8, out Corvus.NestCliBenchmark.Current.NestCliSchema.GenerateBaseDirOptions.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.NestCliBenchmark.Current.NestCliSchema.GenerateFlatOptions.Mutable Flat
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FlatUtf8, out Corvus.NestCliBenchmark.Current.NestCliSchema.GenerateFlatOptions.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.NestCliBenchmark.Current.NestCliSchema.GenerateSpecOptions.Mutable Spec
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SpecUtf8, out Corvus.NestCliBenchmark.Current.NestCliSchema.GenerateSpecOptions.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetBaseDir(scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.GenerateBaseDirOptions.Source value)
            {
                ...
                else
                {
                    ...
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.BaseDir, ref cvb);
            ...
            public void SetFlat(scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.GenerateFlatOptions.Source value)
            {
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Flat, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            public void SetSpec(scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.GenerateSpecOptions.Source value)
            {
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Spec, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetSpec<TContext>(in Corvus.NestCliBenchmark.Current.NestCliSchema.GenerateSpecOptions.Source<TContext> value)
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.NestCliBenchmark.Current.NestCliSchema.GenerateBaseDirOptions.Source _createArg1;
            private readonly Corvus.NestCliBenchmark.Current.NestCliSchema.GenerateFlatOptions.Source _createArg2;
            private readonly Corvus.NestCliBenchmark.Current.NestCliSchema.GenerateSpecOptions.Source _createArg3;
            ...
            #endif
        {
            ...
            private readonly Corvus.NestCliBenchmark.Current.NestCliSchema.GenerateBaseDirOptions.Source _createArg1;
            private readonly Corvus.NestCliBenchmark.Current.NestCliSchema.GenerateFlatOptions.Source _createArg2;
            private readonly Corvus.NestCliBenchmark.Current.NestCliSchema.GenerateSpecOptions.Source<TContext> _createArg3;
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.NestCliBenchmark.Current.NestCliSchema.GenerateBaseDirOptions.Source baseDir = default,
                in Corvus.NestCliBenchmark.Current.NestCliSchema.GenerateFlatOptions.Source flat = default,
                in Corvus.NestCliBenchmark.Current.NestCliSchema.GenerateSpecOptions.Source spec = default)
            {
                baseDir.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.BaseDir, ref builder);
                flat.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Flat, ref builder);
                spec.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Spec, ref builder);
            }
            ...
            internal static void Create<TContext>(
                ...
                in Corvus.NestCliBenchmark.Current.NestCliSchema.GenerateBaseDirOptions.Source baseDir = default,
                in Corvus.NestCliBenchmark.Current.NestCliSchema.GenerateFlatOptions.Source flat = default,
                in Corvus.NestCliBenchmark.Current.NestCliSchema.GenerateSpecOptions.Source<TContext> spec = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
        ...
        /// </summary>
        /// <param name="baseDir">The value of the <c>"baseDir"</c> property.</param>
        ...
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.GenerateBaseDirOptions.Source baseDir = default, scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.GenerateFlatOptions.Source flat = default, scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.GenerateSpecOptions.Source<TContext> spec = default)
            ...
            #endif
        {
            return new Source<TContext>(context, baseDir, flat, spec);
        }
        ...
        public static ParsedJsonDocument<GenerateOptions> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<GenerateOptions>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<GenerateOptions> Create<TContext>(
        ...
        public static ParsedJsonDocument<GenerateOptions> Create(in Corvus.NestCliBenchmark.Current.NestCliSchema.GenerateBaseDirOptions.Source baseDir = default, in Corvus.NestCliBenchmark.Current.NestCliSchema.GenerateFlatOptions.Source flat = default, in Corvus.NestCliBenchmark.Current.NestCliSchema.GenerateSpecOptions.Source spec = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<GenerateOptions> Create<TContext>(in TContext context, in Corvus.NestCliBenchmark.Current.NestCliSchema.GenerateBaseDirOptions.Source baseDir = default, in Corvus.NestCliBenchmark.Current.NestCliSchema.GenerateFlatOptions.Source flat = default, in Corvus.NestCliBenchmark.Current.NestCliSchema.GenerateSpecOptions.Source<TContext> spec = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
