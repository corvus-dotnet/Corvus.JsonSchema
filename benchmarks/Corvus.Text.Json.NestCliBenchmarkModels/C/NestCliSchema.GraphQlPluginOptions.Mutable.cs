...
public readonly partial struct NestCliSchema
{
    ...
    public readonly partial struct GraphQlPluginOptions
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(GraphQlPluginOptions instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="GraphQlPluginOptions"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator GraphQlPluginOptions(Mutable instance)
            {
            ...
            /// <summary>
            /// Gets the (optional) <c>typeFileNameSuffix</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.NestCliBenchmark.Current.NestCliSchema.GraphQlPluginOptions.TypeFileNameSuffixArray.Mutable TypeFileNameSuffix
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeFileNameSuffixUtf8, out Corvus.NestCliBenchmark.Current.NestCliSchema.GraphQlPluginOptions.TypeFileNameSuffixArray.Mutable value))
                    {
                        return value;
                    }

                    return Corvus.NestCliBenchmark.Current.NestCliSchema.GraphQlPluginOptions.TypeFileNameSuffixArray.Mutable.DefaultInstance;
                }
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new GraphQlPluginOptions(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            /// <summary>
            /// Set the <c>typeFileNameSuffix</c> property.
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetTypeFileNameSuffix(scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.GraphQlPluginOptions.TypeFileNameSuffixArray.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.TypeFileNameSuffixUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeFileNameSuffixUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                ...
                else
                {
                    ...
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.TypeFileNameSuffix, ref cvb);
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetTypeFileNameSuffix<TContext>(in Corvus.NestCliBenchmark.Current.NestCliSchema.GraphQlPluginOptions.TypeFileNameSuffixArray.Source<TContext> value)
            ...
            /// <summary>
            /// Remove the <c>typeFileNameSuffix</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveTypeFileNameSuffix()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.TypeFileNameSuffixUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"GraphQlPluginOptions.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="GraphQlPluginOptions"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="GraphQlPluginOptions"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly GraphQlPluginOptions Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<GraphQlPluginOptions>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="GraphQlPluginOptions"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly GraphQlPluginOptions Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<GraphQlPluginOptions>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.NestCliBenchmark.Current.NestCliSchema.GraphQlPluginOptions.TypeFileNameSuffixArray.Source _createArg1;
            ...
            internal Source(Corvus.NestCliBenchmark.Current.NestCliSchema.GraphQlPluginOptions.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.GraphQlPluginOptions.TypeFileNameSuffixArray.Source arg1)
            {
                _createArg1 = arg1;
                _kind = Kind.Create;
            }

            public static implicit operator Source(GraphQlPluginOptions instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            private readonly Corvus.NestCliBenchmark.Current.NestCliSchema.GraphQlPluginOptions.TypeFileNameSuffixArray.Source<TContext> _createArg1;
            ...
            internal Source(scoped in TContext context, Corvus.NestCliBenchmark.Current.NestCliSchema.GraphQlPluginOptions.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in TContext context, scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.GraphQlPluginOptions.TypeFileNameSuffixArray.Source<TContext> arg1)
            {
                _context = context;
                _createArg1 = arg1;
                _kind = Kind.Create;
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="GraphQlPluginOptions"/>.
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.NestCliBenchmark.Current.NestCliSchema.GraphQlPluginOptions.TypeFileNameSuffixArray.Source typeFileNameSuffix = default)
            {
                typeFileNameSuffix.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.TypeFileNameSuffix, ref builder);
            }

            /// <summary>
            /// Creates an instance of a <see cref="GraphQlPluginOptions"/>.
            /// </summary>
            public void Create(in Corvus.NestCliBenchmark.Current.NestCliSchema.GraphQlPluginOptions.TypeFileNameSuffixArray.Source typeFileNameSuffix = default)
            {
                Create(ref _builder, typeFileNameSuffix);
            }
            ...
            internal static void Create<TContext>(
                ...
                in Corvus.NestCliBenchmark.Current.NestCliSchema.GraphQlPluginOptions.TypeFileNameSuffixArray.Source<TContext> typeFileNameSuffix = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            /// Creates an instance of a <see cref="GraphQlPluginOptions"/>.
            /// </summary>
            public void Create<TContext>(in TContext context, in Corvus.NestCliBenchmark.Current.NestCliSchema.GraphQlPluginOptions.TypeFileNameSuffixArray.Source<TContext> typeFileNameSuffix = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
                Create(context, ref _builder, typeFileNameSuffix);
            }
            ...
            internal static void BuildCreateValue(scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.GraphQlPluginOptions.TypeFileNameSuffixArray.Source arg1, ref ComplexValueBuilder o)
            {
                o.StartObject();
                Create(ref o, arg1);
                o.EndObject();
            ...
            /// <param name="arg1">The value of the property.</param>
            /// <param name="o">The complex value builder into which to write the object.</param>
            internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.GraphQlPluginOptions.TypeFileNameSuffixArray.Source<TContext> arg1, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        /// </summary>
        /// <param name="typeFileNameSuffix">The value of the <c>"typeFileNameSuffix"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.GraphQlPluginOptions.TypeFileNameSuffixArray.Source typeFileNameSuffix = default)
        {
            return new Source(typeFileNameSuffix);
        }
        ...
        /// <param name="typeFileNameSuffix">The value of the <c>"typeFileNameSuffix"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.GraphQlPluginOptions.TypeFileNameSuffixArray.Source<TContext> typeFileNameSuffix = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            return new Source<TContext>(context, typeFileNameSuffix);
        }
        ...
        /// </summary>
        /// <param name="workspace">The JSON workspace.</param>
        /// <param name="typeFileNameSuffix">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.NestCliBenchmark.Current.NestCliSchema.GraphQlPluginOptions.TypeFileNameSuffixArray.Source typeFileNameSuffix = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(typeFileNameSuffix);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.NestCliBenchmark.Current.NestCliSchema.GraphQlPluginOptions.TypeFileNameSuffixArray.Source<TContext> typeFileNameSuffix = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            ...
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(context, typeFileNameSuffix);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<GraphQlPluginOptions, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<GraphQlPluginOptions> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<GraphQlPluginOptions>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<GraphQlPluginOptions> Create<TContext>(
        ...
        public static ParsedJsonDocument<GraphQlPluginOptions> Create(in Corvus.NestCliBenchmark.Current.NestCliSchema.GraphQlPluginOptions.TypeFileNameSuffixArray.Source typeFileNameSuffix = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<GraphQlPluginOptions> Create<TContext>(in TContext context, in Corvus.NestCliBenchmark.Current.NestCliSchema.GraphQlPluginOptions.TypeFileNameSuffixArray.Source<TContext> typeFileNameSuffix = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
