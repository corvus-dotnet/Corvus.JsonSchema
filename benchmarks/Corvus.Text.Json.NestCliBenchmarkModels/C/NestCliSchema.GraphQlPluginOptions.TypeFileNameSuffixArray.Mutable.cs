...
public readonly partial struct NestCliSchema
{
    ...
    public readonly partial struct GraphQlPluginOptions
    {
        ...
        public readonly partial struct TypeFileNameSuffixArray
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<TypeFileNameSuffixArray, Mutable>(TypeFileNameSuffixArray.DefaultInstance);
                ...
                public static explicit operator Mutable(TypeFileNameSuffixArray instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TypeFileNameSuffixArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TypeFileNameSuffixArray(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new TypeFileNameSuffixArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TypeFileNameSuffixArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// <summary>
                /// Gets a <see cref="TypeFileNameSuffixArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="TypeFileNameSuffixArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly TypeFileNameSuffixArray Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<TypeFileNameSuffixArray>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="TypeFileNameSuffixArray"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly TypeFileNameSuffixArray Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TypeFileNameSuffixArray>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.NestCliBenchmark.Current.NestCliSchema.GraphQlPluginOptions.TypeFileNameSuffixArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(TypeFileNameSuffixArray instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.NestCliBenchmark.Current.NestCliSchema.GraphQlPluginOptions.TypeFileNameSuffixArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<TypeFileNameSuffixArray, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<TypeFileNameSuffixArray> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TypeFileNameSuffixArray>();
                }
                finally
                {
