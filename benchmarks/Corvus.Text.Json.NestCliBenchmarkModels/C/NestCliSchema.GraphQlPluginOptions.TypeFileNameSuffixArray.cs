...
public readonly partial struct NestCliSchema
{
    ...
    public readonly partial struct GraphQlPluginOptions
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="TypeFileNameSuffixArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal TypeFileNameSuffixArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </returns>
            public static bool operator ==(in TypeFileNameSuffixArray left, in TypeFileNameSuffixArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in TypeFileNameSuffixArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(TypeFileNameSuffixArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TypeFileNameSuffixArray(JsonElement instance)
            {
                return TypeFileNameSuffixArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TypeFileNameSuffixArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TypeFileNameSuffixArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TypeFileNameSuffixArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TypeFileNameSuffixArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TypeFileNameSuffixArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TypeFileNameSuffixArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TypeFileNameSuffixArray>(json, options);
            }
            ...
            /// </exception>
            public static TypeFileNameSuffixArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<TypeFileNameSuffixArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out TypeFileNameSuffixArray? result)
            {
                return JsonElementHelpers.TryParseValue<TypeFileNameSuffixArray>(ref reader, out result);
            }
...
#if NET
            static TypeFileNameSuffixArray IJsonElement<TypeFileNameSuffixArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TypeFileNameSuffixArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public TypeFileNameSuffixArray Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public TypeFileNameSuffixArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<TypeFileNameSuffixArray>(_idx);
                }
