...
public readonly partial struct NestCliSchema
{
    ...
    public readonly partial struct GraphQlPluginOptions
        ...
        : IJsonElement<GraphQlPluginOptions>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GraphQlPluginOptions"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal GraphQlPluginOptions(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static GraphQlPluginOptions DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.NestCliBenchmark.Current.NestCliSchema.GraphQlPluginOptions.TypeFileNameSuffixArray TypeFileNameSuffix
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeFileNameSuffixUtf8, out Corvus.NestCliBenchmark.Current.NestCliSchema.GraphQlPluginOptions.TypeFileNameSuffixArray value))
                {
                    return value;
                }

                return Corvus.NestCliBenchmark.Current.NestCliSchema.GraphQlPluginOptions.TypeFileNameSuffixArray.DefaultInstance;
            }
        }
        ...
        /// </returns>
        public static bool operator ==(in GraphQlPluginOptions left, in GraphQlPluginOptions right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in GraphQlPluginOptions left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(GraphQlPluginOptions instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GraphQlPluginOptions(JsonElement instance)
        {
            return GraphQlPluginOptions.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GraphQlPluginOptions From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GraphQlPluginOptions ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<GraphQlPluginOptions>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GraphQlPluginOptions ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<GraphQlPluginOptions>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GraphQlPluginOptions ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<GraphQlPluginOptions>(json, options);
        }
        ...
        /// </exception>
        public static GraphQlPluginOptions ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<GraphQlPluginOptions>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out GraphQlPluginOptions? result)
        {
            return JsonElementHelpers.TryParseValue<GraphQlPluginOptions>(ref reader, out result);
        }
...
#if NET
        static GraphQlPluginOptions IJsonElement<GraphQlPluginOptions>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GraphQlPluginOptions: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public GraphQlPluginOptions Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public GraphQlPluginOptions Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<GraphQlPluginOptions>(_idx);
            }
        ...
        {
            /// <summary>
            /// Gets the JSON property name for <see cref="TypeFileNameSuffix"/>.
            /// </summary>
            public const string TypeFileNameSuffix = "typeFileNameSuffix";

            /// <summary>
            /// Gets the JSON property name for <see cref="TypeFileNameSuffix"/>.
            /// </summary>
            public static ReadOnlySpan<byte> TypeFileNameSuffixUtf8 => "typeFileNameSuffix"u8;
        }
        ...
        {
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="TypeFileNameSuffix"/>.
            /// </summary>
            public static ReadOnlySpan<byte> TypeFileNameSuffix => "typeFileNameSuffix"u8;
        }
        ...
        {
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="TypeFileNameSuffix"/>.
            /// </summary>
            public static ReadOnlySpan<byte> TypeFileNameSuffix => [0x45, 0x01, 0x00, 0x00, 0x22, 0x74, 0x79, 0x70, 0x65, 0x46, 0x69, 0x6C, 0x65, 0x4E, 0x61, 0x6D, 0x65, 0x53, 0x75, 0x66, 0x66, 0x69, 0x78, 0x22];
        }
    }
}
