...
public readonly partial struct NestCliSchema
{
    ...
    public readonly partial struct LanguageEntity
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<LanguageEntity, Mutable>(LanguageEntity.DefaultInstance);
            ...
            public static explicit operator Mutable(LanguageEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="LanguageEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator LanguageEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"LanguageEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly LanguageEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly LanguageEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<LanguageEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(LanguageEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<LanguageEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<LanguageEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<LanguageEntity>();
            }
            finally
            {
