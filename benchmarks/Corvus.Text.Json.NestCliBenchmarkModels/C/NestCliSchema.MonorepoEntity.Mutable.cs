...
public readonly partial struct NestCliSchema
{
    ...
    public readonly partial struct MonorepoEntity
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<MonorepoEntity, Mutable>(MonorepoEntity.DefaultInstance);
            ...
            public static explicit operator Mutable(MonorepoEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MonorepoEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MonorepoEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MonorepoEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly MonorepoEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly MonorepoEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MonorepoEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(MonorepoEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<MonorepoEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<MonorepoEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<MonorepoEntity>();
            }
            finally
            {
