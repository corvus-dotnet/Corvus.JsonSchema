...
public readonly partial struct NestCliSchema
{
...
#endif
    {
        ...
        public void SetCollection(scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.CollectionEntity.Source value)
        {
            CheckValidInstance();
            ...
            else
            {
                ...
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Collection, ref cvb);
        ...
        public void SetCompilerOptionsValue(scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.CompilerOptions.Source value)
        {
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.CompilerOptionsValue, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetDefaultLibraryPrefix(scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.DefaultImportPrefixForNewlyGeneratedLibraries.Source value)
        {
            CheckValidInstance();
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.DefaultLibraryPrefix, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetEntryFile(scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.TheEntryFileWhereNestStartWorkWithDefaultToMain.Source value)
        {
            CheckValidInstance();
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.EntryFile, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        public void SetGenerateOptionsValue(scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.GenerateOptions.Source value)
        {
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.GenerateOptionsValue, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetLanguage(scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.LanguageEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetMonorepo(scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.MonorepoEntity.Source value)
        {
            CheckValidInstance();
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Monorepo, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetProjects(scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.ProjectsEntity.Source value)
        {
            CheckValidInstance();
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Projects, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetRoot(scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.RootEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetSourceRoot(scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.SourceRootEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// <summary>
        /// Gets a <see cref="NestCliSchema"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="NestCliSchema"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly NestCliSchema Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<NestCliSchema>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="NestCliSchema"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly NestCliSchema Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<NestCliSchema>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.CollectionEntity.Source arg1, scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.CompilerOptions.Source arg2, scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.DefaultImportPrefixForNewlyGeneratedLibraries.Source arg3, scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.TheEntryFileWhereNestStartWorkWithDefaultToMain.Source arg4, scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.GenerateOptions.Source arg5, scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.LanguageEntity.Source arg6, scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.MonorepoEntity.Source arg7, scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.ProjectsEntity.Source arg8, scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.RootEntity.Source arg9, scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.SourceRootEntity.Source arg10)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.CollectionEntity.Source arg1, scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.CompilerOptions.Source<TContext> arg2, scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.DefaultImportPrefixForNewlyGeneratedLibraries.Source arg3, scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.TheEntryFileWhereNestStartWorkWithDefaultToMain.Source arg4, scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.GenerateOptions.Source<TContext> arg5, scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.LanguageEntity.Source arg6, scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.MonorepoEntity.Source arg7, scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.ProjectsEntity.Source<TContext> arg8, scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.RootEntity.Source arg9, scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.SourceRootEntity.Source arg10)
        {
            _context = context;
            _createArg1 = arg1;
            _createArg2 = arg2;
    ...
    public ref struct Builder
    {
        ...
        {
            collection.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Collection, ref builder);
            compilerOptions.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.CompilerOptionsValue, ref builder);
            defaultLibraryPrefix.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.DefaultLibraryPrefix, ref builder);
            entryFile.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.EntryFile, ref builder);
            generateOptions.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.GenerateOptionsValue, ref builder);
            language.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Language, ref builder);
            monorepo.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Monorepo, ref builder);
            projects.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Projects, ref builder);
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.CollectionEntity.Source collection = default, scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.CompilerOptions.Source compilerOptions = default, scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.DefaultImportPrefixForNewlyGeneratedLibraries.Source defaultLibraryPrefix = default, scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.TheEntryFileWhereNestStartWorkWithDefaultToMain.Source entryFile = default, scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.GenerateOptions.Source generateOptions = default, scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.LanguageEntity.Source language = default, scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.MonorepoEntity.Source monorepo = default, scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.ProjectsEntity.Source projects = default, scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.RootEntity.Source root = default, scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.SourceRootEntity.Source sourceRoot = default)
    {
    ...
    public static ParsedJsonDocument<NestCliSchema> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<NestCliSchema>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<NestCliSchema> Create<TContext>(
    ...
    public static ParsedJsonDocument<NestCliSchema> Create(in Corvus.NestCliBenchmark.Current.NestCliSchema.CollectionEntity.Source collection = default, in Corvus.NestCliBenchmark.Current.NestCliSchema.CompilerOptions.Source compilerOptions = default, in Corvus.NestCliBenchmark.Current.NestCliSchema.DefaultImportPrefixForNewlyGeneratedLibraries.Source defaultLibraryPrefix = default, in Corvus.NestCliBenchmark.Current.NestCliSchema.TheEntryFileWhereNestStartWorkWithDefaultToMain.Source entryFile = default, in Corvus.NestCliBenchmark.Current.NestCliSchema.GenerateOptions.Source generateOptions = default, in Corvus.NestCliBenchmark.Current.NestCliSchema.LanguageEntity.Source language = default, in Corvus.NestCliBenchmark.Current.NestCliSchema.MonorepoEntity.Source monorepo = default, in Corvus.NestCliBenchmark.Current.NestCliSchema.ProjectsEntity.Source projects = default, in Corvus.NestCliBenchmark.Current.NestCliSchema.RootEntity.Source root = default, in Corvus.NestCliBenchmark.Current.NestCliSchema.SourceRootEntity.Source sourceRoot = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<NestCliSchema> Create<TContext>(in TContext context, in Corvus.NestCliBenchmark.Current.NestCliSchema.CollectionEntity.Source collection = default, in Corvus.NestCliBenchmark.Current.NestCliSchema.CompilerOptions.Source<TContext> compilerOptions = default, in Corvus.NestCliBenchmark.Current.NestCliSchema.DefaultImportPrefixForNewlyGeneratedLibraries.Source defaultLibraryPrefix = default, in Corvus.NestCliBenchmark.Current.NestCliSchema.TheEntryFileWhereNestStartWorkWithDefaultToMain.Source entryFile = default, in Corvus.NestCliBenchmark.Current.NestCliSchema.GenerateOptions.Source<TContext> generateOptions = default, in Corvus.NestCliBenchmark.Current.NestCliSchema.LanguageEntity.Source language = default, in Corvus.NestCliBenchmark.Current.NestCliSchema.MonorepoEntity.Source monorepo = default, in Corvus.NestCliBenchmark.Current.NestCliSchema.ProjectsEntity.Source<TContext> projects = default, in Corvus.NestCliBenchmark.Current.NestCliSchema.RootEntity.Source root = default, in Corvus.NestCliBenchmark.Current.NestCliSchema.SourceRootEntity.Source sourceRoot = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
