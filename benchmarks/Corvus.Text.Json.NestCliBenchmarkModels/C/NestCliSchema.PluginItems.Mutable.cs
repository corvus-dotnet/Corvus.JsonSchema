...
public readonly partial struct NestCliSchema
{
    ...
    public readonly partial struct PluginItems
    {
...
#endif
        {
            ...
            public void SetName(in Corvus.NestCliBenchmark.Current.JsonString.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetOptions(in Corvus.NestCliBenchmark.Current.NestCliSchema.PluginItems.OptionsEntity.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(in Corvus.NestCliBenchmark.Current.JsonString.Source arg1, in Corvus.NestCliBenchmark.Current.NestCliSchema.PluginItems.OptionsEntity.Source arg2)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _kind = Kind.Create;
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, in Corvus.NestCliBenchmark.Current.JsonString.Source arg1, in Corvus.NestCliBenchmark.Current.NestCliSchema.PluginItems.OptionsEntity.Source<TContext> arg2)
            {
                _context = context;
                _createArg1 = arg1;
                _createArg2 = arg2;
        ...
        public ref struct Builder
        {
            ...
            internal static void BuildCreateValue(in Corvus.NestCliBenchmark.Current.JsonString.Source arg1, in Corvus.NestCliBenchmark.Current.NestCliSchema.PluginItems.OptionsEntity.Source arg2, ref ComplexValueBuilder o)
            {
                o.StartObject();
            ...
            /// <param name="arg2">The value of the property.</param>
            /// <param name="o">The complex value builder into which to write the object.</param>
            internal static void BuildCreateValue<TContext>(scoped in TContext context, in Corvus.NestCliBenchmark.Current.JsonString.Source arg1, in Corvus.NestCliBenchmark.Current.NestCliSchema.PluginItems.OptionsEntity.Source<TContext> arg2, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(in Corvus.NestCliBenchmark.Current.JsonString.Source name = default, in Corvus.NestCliBenchmark.Current.NestCliSchema.PluginItems.OptionsEntity.Source options = default)
        {
        ...
        /// <param name="options">The value of the <c>"options"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.NestCliBenchmark.Current.JsonString.Source name = default, in Corvus.NestCliBenchmark.Current.NestCliSchema.PluginItems.OptionsEntity.Source<TContext> options = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
