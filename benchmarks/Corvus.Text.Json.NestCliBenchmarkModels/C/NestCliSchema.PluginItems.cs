...
public readonly partial struct NestCliSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PluginItems"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal PluginItems(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static PluginItems DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.NestCliBenchmark.Current.JsonString Name
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out Corvus.NestCliBenchmark.Current.JsonString value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.NestCliBenchmark.Current.NestCliSchema.PluginItems.OptionsEntity Options
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OptionsUtf8, out Corvus.NestCliBenchmark.Current.NestCliSchema.PluginItems.OptionsEntity value))
                {
                    return value;
                }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(PluginItems value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in PluginItems left, in PluginItems right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in PluginItems left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(PluginItems instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PluginItems(JsonElement instance)
        {
            return PluginItems.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PluginItems From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PluginItems ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PluginItems>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PluginItems ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PluginItems>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PluginItems ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PluginItems>(json, options);
        }
        ...
        /// </exception>
        public static PluginItems ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<PluginItems>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out PluginItems? result)
        {
            return JsonElementHelpers.TryParseValue<PluginItems>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new PluginItems(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static PluginItems IJsonElement<PluginItems>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PluginItems: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="PluginItems"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="PluginItems"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public PluginItems Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<PluginItems>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="PluginItems"/> that lives for the lifetime of its
