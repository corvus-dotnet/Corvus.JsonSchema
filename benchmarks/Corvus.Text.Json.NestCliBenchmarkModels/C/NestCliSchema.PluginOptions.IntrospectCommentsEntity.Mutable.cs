    ...
    public readonly partial struct PluginOptions
    {
        ...
        public readonly partial struct IntrospectCommentsEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<IntrospectCommentsEntity, Mutable>(IntrospectCommentsEntity.DefaultInstance);
            ...
            public static ParsedJsonDocument<IntrospectCommentsEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<IntrospectCommentsEntity>();
                }
                finally
                {
