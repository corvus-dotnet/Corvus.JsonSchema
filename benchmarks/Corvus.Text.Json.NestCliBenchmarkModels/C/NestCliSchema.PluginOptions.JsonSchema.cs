...
public readonly partial struct NestCliSchema
{
        ...
        : IJsonElement<PluginOptions>
    {
        ...
        {
            private static readonly JsonSchemaPathProvider IntrospectCommentsSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/introspectComments"u8, buffer, out written);

            private static void MatchIntrospectComments(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext =
                    Corvus.NestCliBenchmark.Current.NestCliSchema.PluginOptions.IntrospectCommentsEntity.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.IntrospectCommentsUtf8,
                        evaluationPath: IntrospectCommentsSchemaEvaluationPath);

                Corvus.NestCliBenchmark.Current.NestCliSchema.PluginOptions.IntrospectCommentsEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            {
                if (span.SequenceEqual(JsonPropertyNames.IntrospectCommentsUtf8))
                {
                    matcher = MatchIntrospectComments;
                    return true;
                }
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://json.schemastore.org/nest-cli.json#/definitions/PluginOptions"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "https://json.schemastore.org/nest-cli.json#/definitions/PluginOptions";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://json.schemastore.org/nest-cli.json#/definitions/PluginOptions"u8;
