...
public readonly partial struct NestCliSchema
{
    ...
    public readonly partial struct PluginOptions
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(PluginOptions instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="PluginOptions"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PluginOptions(Mutable instance)
            {
            ...
            /// <summary>
            /// Gets the (optional) <c>introspectComments</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.NestCliBenchmark.Current.NestCliSchema.PluginOptions.IntrospectCommentsEntity.Mutable IntrospectComments
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IntrospectCommentsUtf8, out Corvus.NestCliBenchmark.Current.NestCliSchema.PluginOptions.IntrospectCommentsEntity.Mutable value))
                    {
                        return value;
                    }

                    return Corvus.NestCliBenchmark.Current.NestCliSchema.PluginOptions.IntrospectCommentsEntity.Mutable.DefaultInstance;
                }
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new PluginOptions(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetIntrospectComments(scoped in Corvus.NestCliBenchmark.Current.NestCliSchema.PluginOptions.IntrospectCommentsEntity.Source value)
            {
                ...
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.IntrospectCommentsUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IntrospectCommentsUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                ...
                else
                {
                    ...
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.IntrospectComments, ref cvb);
            ...
            /// <summary>
            /// Remove the <c>introspectComments</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveIntrospectComments()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.IntrospectCommentsUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PluginOptions.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="PluginOptions"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="PluginOptions"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly PluginOptions Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<PluginOptions>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="PluginOptions"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly PluginOptions Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<PluginOptions>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.NestCliBenchmark.Current.NestCliSchema.PluginOptions.IntrospectCommentsEntity.Source _createArg1;
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.NestCliBenchmark.Current.NestCliSchema.PluginOptions.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="PluginOptions"/>.
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.NestCliBenchmark.Current.NestCliSchema.PluginOptions.IntrospectCommentsEntity.Source introspectComments = default)
            {
                introspectComments.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.IntrospectComments, ref builder);
            }

            /// <summary>
            /// Creates an instance of a <see cref="PluginOptions"/>.
            /// </summary>
            public void Create(in Corvus.NestCliBenchmark.Current.NestCliSchema.PluginOptions.IntrospectCommentsEntity.Source introspectComments = default)
            {
                Create(ref _builder, introspectComments);
            }
        ...
        /// </summary>
        /// <param name="workspace">The JSON workspace.</param>
        /// <param name="introspectComments">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.NestCliBenchmark.Current.NestCliSchema.PluginOptions.IntrospectCommentsEntity.Source introspectComments = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(introspectComments);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<PluginOptions, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<PluginOptions> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<PluginOptions>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<PluginOptions> Create<TContext>(
        ...
        public static ParsedJsonDocument<PluginOptions> Create(in Corvus.NestCliBenchmark.Current.NestCliSchema.PluginOptions.IntrospectCommentsEntity.Source introspectComments = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
