...
public readonly partial struct NestCliSchema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.NestCliBenchmark.Current.NestCliSchema.PluginOptions.IntrospectCommentsEntity IntrospectComments
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IntrospectCommentsUtf8, out Corvus.NestCliBenchmark.Current.NestCliSchema.PluginOptions.IntrospectCommentsEntity value))
                {
                    return value;
                }

                return Corvus.NestCliBenchmark.Current.NestCliSchema.PluginOptions.IntrospectCommentsEntity.DefaultInstance;
            }
        }
        ...
        {
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="IntrospectComments"/>.
            /// </summary>
            public static ReadOnlySpan<byte> IntrospectComments => [0x45, 0x01, 0x00, 0x00, 0x22, 0x69, 0x6E, 0x74, 0x72, 0x6F, 0x73, 0x70, 0x65, 0x63, 0x74, 0x43, 0x6F, 0x6D, 0x6D, 0x65, 0x6E, 0x74, 0x73, 0x22];
        }
    }
}
