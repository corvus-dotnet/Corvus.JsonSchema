...
public readonly partial struct NestCliSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectConfiguration"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ProjectConfiguration(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ProjectConfiguration DefaultInstance { get; }
        ...
        /// </summary>
        public Corvus.NestCliBenchmark.Current.JsonString EntryFile
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EntryFileUtf8, out Corvus.NestCliBenchmark.Current.JsonString value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.NestCliBenchmark.Current.JsonString Root
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RootUtf8, out Corvus.NestCliBenchmark.Current.JsonString value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.NestCliBenchmark.Current.JsonString SourceRoot
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SourceRootUtf8, out Corvus.NestCliBenchmark.Current.JsonString value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.NestCliBenchmark.Current.JsonString Type
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.NestCliBenchmark.Current.JsonString value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in ProjectConfiguration left, in ProjectConfiguration right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ProjectConfiguration left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(ProjectConfiguration instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ProjectConfiguration(JsonElement instance)
        {
            return ProjectConfiguration.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ProjectConfiguration From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ProjectConfiguration ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ProjectConfiguration>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ProjectConfiguration ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ProjectConfiguration>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ProjectConfiguration ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ProjectConfiguration>(json, options);
        }
        ...
        /// </exception>
        public static ProjectConfiguration ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ProjectConfiguration>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ProjectConfiguration? result)
        {
            return JsonElementHelpers.TryParseValue<ProjectConfiguration>(ref reader, out result);
        }
...
#if NET
        static ProjectConfiguration IJsonElement<ProjectConfiguration>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ProjectConfiguration: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public ProjectConfiguration Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ProjectConfiguration>(_idx);
            }
