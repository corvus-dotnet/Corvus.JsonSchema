...
public readonly partial struct NestCliSchema
{
    ...
    public readonly partial struct SourceRootEntity
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SourceRootEntity, Mutable>(SourceRootEntity.DefaultInstance);
            ...
            public static explicit operator Mutable(SourceRootEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="SourceRootEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SourceRootEntity(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new SourceRootEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SourceRootEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="SourceRootEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="SourceRootEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly SourceRootEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<SourceRootEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="SourceRootEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly SourceRootEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<SourceRootEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(SourceRootEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<SourceRootEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<SourceRootEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<SourceRootEntity>();
            }
            finally
            {
