    ...
    public readonly partial struct SwaggerPluginOptions
    {
        ...
        public readonly partial struct ClassValidatorShimEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ClassValidatorShimEntity, Mutable>(ClassValidatorShimEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(ClassValidatorShimEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ClassValidatorShimEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ClassValidatorShimEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ClassValidatorShimEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ClassValidatorShimEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ClassValidatorShimEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ClassValidatorShimEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ClassValidatorShimEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ClassValidatorShimEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ClassValidatorShimEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ClassValidatorShimEntity>();
                }
                finally
                {
