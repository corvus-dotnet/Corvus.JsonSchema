...
public readonly partial struct NestCliSchema
{
    ...
    public readonly partial struct SwaggerPluginOptions
    {
        ...
        public readonly partial struct ClassValidatorShimEntity
#if NET8_0_OR_GREATER
            : IJsonElement<ClassValidatorShimEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ClassValidatorShimEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ClassValidatorShimEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ClassValidatorShimEntity DefaultInstance { get; } = ParsedJsonDocument<ClassValidatorShimEntity>.True;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(ClassValidatorShimEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in ClassValidatorShimEntity left, in ClassValidatorShimEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ClassValidatorShimEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ClassValidatorShimEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ClassValidatorShimEntity(JsonElement instance)
            {
                return ClassValidatorShimEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ClassValidatorShimEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ClassValidatorShimEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ClassValidatorShimEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ClassValidatorShimEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ClassValidatorShimEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ClassValidatorShimEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ClassValidatorShimEntity>(json, options);
            }
            ...
            /// </exception>
            public static ClassValidatorShimEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ClassValidatorShimEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ClassValidatorShimEntity? result)
            {
                return JsonElementHelpers.TryParseValue<ClassValidatorShimEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ClassValidatorShimEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static ClassValidatorShimEntity IJsonElement<ClassValidatorShimEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ClassValidatorShimEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ClassValidatorShimEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ClassValidatorShimEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public ClassValidatorShimEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ClassValidatorShimEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ClassValidatorShimEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public ClassValidatorShimEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ClassValidatorShimEntity>(_idx);
                }
