...
public readonly partial struct NestCliSchema
{
    ...
    public readonly partial struct SwaggerPluginOptions
    {
        ...
        public readonly partial struct ControllerKeyOfCommentEntity
#if NET8_0_OR_GREATER
            : IJsonElement<ControllerKeyOfCommentEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ControllerKeyOfCommentEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ControllerKeyOfCommentEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ControllerKeyOfCommentEntity DefaultInstance { get; } = ParsedJsonDocument<ControllerKeyOfCommentEntity>.StringConstant([.."\"description\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(ControllerKeyOfCommentEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in ControllerKeyOfCommentEntity left, in ControllerKeyOfCommentEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ControllerKeyOfCommentEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ControllerKeyOfCommentEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ControllerKeyOfCommentEntity(JsonElement instance)
            {
                return ControllerKeyOfCommentEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ControllerKeyOfCommentEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ControllerKeyOfCommentEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ControllerKeyOfCommentEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ControllerKeyOfCommentEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ControllerKeyOfCommentEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ControllerKeyOfCommentEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ControllerKeyOfCommentEntity>(json, options);
            }
            ...
            /// </exception>
            public static ControllerKeyOfCommentEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ControllerKeyOfCommentEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ControllerKeyOfCommentEntity? result)
            {
                return JsonElementHelpers.TryParseValue<ControllerKeyOfCommentEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ControllerKeyOfCommentEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static ControllerKeyOfCommentEntity IJsonElement<ControllerKeyOfCommentEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ControllerKeyOfCommentEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ControllerKeyOfCommentEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ControllerKeyOfCommentEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public ControllerKeyOfCommentEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ControllerKeyOfCommentEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ControllerKeyOfCommentEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public ControllerKeyOfCommentEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ControllerKeyOfCommentEntity>(_idx);
                }
