    ...
    public readonly partial struct SwaggerPluginOptions
    {
        ...
        public readonly partial struct DtoKeyOfCommentEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DtoKeyOfCommentEntity, Mutable>(DtoKeyOfCommentEntity.DefaultInstance);
            ...
            public static ParsedJsonDocument<DtoKeyOfCommentEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<DtoKeyOfCommentEntity>();
                }
                finally
                {
