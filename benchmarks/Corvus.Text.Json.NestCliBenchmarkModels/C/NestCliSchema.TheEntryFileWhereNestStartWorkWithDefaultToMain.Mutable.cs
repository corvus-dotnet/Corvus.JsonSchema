...
public readonly partial struct NestCliSchema
{
    ...
    public readonly partial struct TheEntryFileWhereNestStartWorkWithDefaultToMain
    {
        ...
        public static ParsedJsonDocument<TheEntryFileWhereNestStartWorkWithDefaultToMain> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<TheEntryFileWhereNestStartWorkWithDefaultToMain>();
            }
            finally
            {
