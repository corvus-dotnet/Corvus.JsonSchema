...
public readonly partial struct NestCliSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TheEntryFileWhereNestStartWorkWithDefaultToMain"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal TheEntryFileWhereNestStartWorkWithDefaultToMain(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static TheEntryFileWhereNestStartWorkWithDefaultToMain DefaultInstance { get; } = ParsedJsonDocument<TheEntryFileWhereNestStartWorkWithDefaultToMain>.StringConstant([.."\"main\""u8]);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(TheEntryFileWhereNestStartWorkWithDefaultToMain value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in TheEntryFileWhereNestStartWorkWithDefaultToMain left, in TheEntryFileWhereNestStartWorkWithDefaultToMain right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in TheEntryFileWhereNestStartWorkWithDefaultToMain left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(TheEntryFileWhereNestStartWorkWithDefaultToMain instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TheEntryFileWhereNestStartWorkWithDefaultToMain(JsonElement instance)
        {
            return TheEntryFileWhereNestStartWorkWithDefaultToMain.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheEntryFileWhereNestStartWorkWithDefaultToMain From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheEntryFileWhereNestStartWorkWithDefaultToMain ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<TheEntryFileWhereNestStartWorkWithDefaultToMain>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheEntryFileWhereNestStartWorkWithDefaultToMain ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<TheEntryFileWhereNestStartWorkWithDefaultToMain>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheEntryFileWhereNestStartWorkWithDefaultToMain ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<TheEntryFileWhereNestStartWorkWithDefaultToMain>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static TheEntryFileWhereNestStartWorkWithDefaultToMain ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<TheEntryFileWhereNestStartWorkWithDefaultToMain>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out TheEntryFileWhereNestStartWorkWithDefaultToMain? result)
        {
            return JsonElementHelpers.TryParseValue<TheEntryFileWhereNestStartWorkWithDefaultToMain>(ref reader, out result);
        }
...
#if NET
        static TheEntryFileWhereNestStartWorkWithDefaultToMain IJsonElement<TheEntryFileWhereNestStartWorkWithDefaultToMain>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TheEntryFileWhereNestStartWorkWithDefaultToMain: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public TheEntryFileWhereNestStartWorkWithDefaultToMain Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public TheEntryFileWhereNestStartWorkWithDefaultToMain Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<TheEntryFileWhereNestStartWorkWithDefaultToMain>(_idx);
            }
