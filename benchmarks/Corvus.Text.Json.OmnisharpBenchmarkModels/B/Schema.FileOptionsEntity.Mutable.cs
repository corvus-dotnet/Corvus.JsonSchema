...
public readonly partial struct Schema
{
    ...
    public readonly partial struct FileOptionsEntity
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.OmnisharpBenchmark.Baseline.Schema.FileOptionsEntity.JsonStringArray.Mutable ExcludeSearchPatterns
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExcludeSearchPatternsUtf8, out Corvus.OmnisharpBenchmark.Baseline.Schema.FileOptionsEntity.JsonStringArray.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.OmnisharpBenchmark.Baseline.Schema.FileOptionsEntity.RecommendeArray.Mutable SystemExcludeSearchPatterns
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SystemExcludeSearchPatternsUtf8, out Corvus.OmnisharpBenchmark.Baseline.Schema.FileOptionsEntity.RecommendeArray.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetExcludeSearchPatterns(in Corvus.OmnisharpBenchmark.Baseline.Schema.FileOptionsEntity.JsonStringArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetExcludeSearchPatterns<TContext>(in Corvus.OmnisharpBenchmark.Baseline.Schema.FileOptionsEntity.JsonStringArray.Source<TContext> value)
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetSystemExcludeSearchPatterns(in Corvus.OmnisharpBenchmark.Baseline.Schema.FileOptionsEntity.RecommendeArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetSystemExcludeSearchPatterns<TContext>(in Corvus.OmnisharpBenchmark.Baseline.Schema.FileOptionsEntity.RecommendeArray.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.OmnisharpBenchmark.Baseline.Schema.FileOptionsEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.OmnisharpBenchmark.Baseline.Schema.FileOptionsEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.OmnisharpBenchmark.Baseline.Schema.FileOptionsEntity.JsonStringArray.Source excludeSearchPatterns = default,
                in Corvus.OmnisharpBenchmark.Baseline.Schema.FileOptionsEntity.RecommendeArray.Source systemExcludeSearchPatterns = default)
            {
            ...
            /// Creates an instance of a <see cref="FileOptionsEntity"/>.
            /// </summary>
            public void Create(in Corvus.OmnisharpBenchmark.Baseline.Schema.FileOptionsEntity.JsonStringArray.Source excludeSearchPatterns = default, in Corvus.OmnisharpBenchmark.Baseline.Schema.FileOptionsEntity.RecommendeArray.Source systemExcludeSearchPatterns = default)
            {
            ...
            internal static void Create<TContext>(
                in TContext context,
                ref ComplexValueBuilder builder,
                in Corvus.OmnisharpBenchmark.Baseline.Schema.FileOptionsEntity.JsonStringArray.Source<TContext> excludeSearchPatterns = default,
                in Corvus.OmnisharpBenchmark.Baseline.Schema.FileOptionsEntity.RecommendeArray.Source<TContext> systemExcludeSearchPatterns = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OmnisharpBenchmark.Baseline.Schema.FileOptionsEntity.JsonStringArray.Source excludeSearchPatterns = default, in Corvus.OmnisharpBenchmark.Baseline.Schema.FileOptionsEntity.RecommendeArray.Source systemExcludeSearchPatterns = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.OmnisharpBenchmark.Baseline.Schema.FileOptionsEntity.JsonStringArray.Source<TContext> excludeSearchPatterns = default, in Corvus.OmnisharpBenchmark.Baseline.Schema.FileOptionsEntity.RecommendeArray.Source<TContext> systemExcludeSearchPatterns = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
