...
public readonly partial struct Schema
{
    ...
    public readonly partial struct FileOptionsEntity
    {
...
#endif
        {
            ...
            public Corvus.OmnisharpBenchmark.Baseline.JsonString this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.OmnisharpBenchmark.Baseline.JsonString>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.OmnisharpBenchmark.Baseline.JsonString> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.OmnisharpBenchmark.Baseline.JsonString>(_parent, _idx);
            }
