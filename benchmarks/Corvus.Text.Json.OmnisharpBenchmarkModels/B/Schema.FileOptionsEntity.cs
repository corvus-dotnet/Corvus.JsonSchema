...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.OmnisharpBenchmark.Baseline.Schema.FileOptionsEntity.JsonStringArray ExcludeSearchPatterns
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExcludeSearchPatternsUtf8, out Corvus.OmnisharpBenchmark.Baseline.Schema.FileOptionsEntity.JsonStringArray value))
                {
                    return value;
                }

                return Corvus.OmnisharpBenchmark.Baseline.Schema.FileOptionsEntity.JsonStringArray.DefaultInstance;
            }
        }
        ...
        /// </para>
        /// </remarks>
        public Corvus.OmnisharpBenchmark.Baseline.Schema.FileOptionsEntity.RecommendeArray SystemExcludeSearchPatterns
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SystemExcludeSearchPatternsUtf8, out Corvus.OmnisharpBenchmark.Baseline.Schema.FileOptionsEntity.RecommendeArray value))
                {
                    return value;
                }

                return Corvus.OmnisharpBenchmark.Baseline.Schema.FileOptionsEntity.RecommendeArray.DefaultInstance;
            }
        }
