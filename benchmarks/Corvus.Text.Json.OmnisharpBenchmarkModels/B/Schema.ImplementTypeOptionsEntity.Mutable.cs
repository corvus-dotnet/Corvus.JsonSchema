...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ImplementTypeOptionsEntity
    {
...
#endif
        {
            ...
            /// </summary>
            public Corvus.OmnisharpBenchmark.Baseline.Schema.ImplementTypeOptionsEntity.InsertionBehaviorEntity.Mutable InsertionBehavior
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.InsertionBehaviorUtf8, out Corvus.OmnisharpBenchmark.Baseline.Schema.ImplementTypeOptionsEntity.InsertionBehaviorEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public Corvus.OmnisharpBenchmark.Baseline.Schema.ImplementTypeOptionsEntity.PropertyGenerationBehaviorEntity.Mutable PropertyGenerationBehavior
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PropertyGenerationBehaviorUtf8, out Corvus.OmnisharpBenchmark.Baseline.Schema.ImplementTypeOptionsEntity.PropertyGenerationBehaviorEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetInsertionBehavior(in Corvus.OmnisharpBenchmark.Baseline.Schema.ImplementTypeOptionsEntity.InsertionBehaviorEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetPropertyGenerationBehavior(in Corvus.OmnisharpBenchmark.Baseline.Schema.ImplementTypeOptionsEntity.PropertyGenerationBehaviorEntity.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.OmnisharpBenchmark.Baseline.Schema.ImplementTypeOptionsEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.OmnisharpBenchmark.Baseline.Schema.ImplementTypeOptionsEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.OmnisharpBenchmark.Baseline.Schema.ImplementTypeOptionsEntity.InsertionBehaviorEntity.Source insertionBehavior = default,
                in Corvus.OmnisharpBenchmark.Baseline.Schema.ImplementTypeOptionsEntity.PropertyGenerationBehaviorEntity.Source propertyGenerationBehavior = default)
            {
            ...
            /// Creates an instance of a <see cref="ImplementTypeOptionsEntity"/>.
            /// </summary>
            public void Create(in Corvus.OmnisharpBenchmark.Baseline.Schema.ImplementTypeOptionsEntity.InsertionBehaviorEntity.Source insertionBehavior = default, in Corvus.OmnisharpBenchmark.Baseline.Schema.ImplementTypeOptionsEntity.PropertyGenerationBehaviorEntity.Source propertyGenerationBehavior = default)
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OmnisharpBenchmark.Baseline.Schema.ImplementTypeOptionsEntity.InsertionBehaviorEntity.Source insertionBehavior = default, in Corvus.OmnisharpBenchmark.Baseline.Schema.ImplementTypeOptionsEntity.PropertyGenerationBehaviorEntity.Source propertyGenerationBehavior = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
