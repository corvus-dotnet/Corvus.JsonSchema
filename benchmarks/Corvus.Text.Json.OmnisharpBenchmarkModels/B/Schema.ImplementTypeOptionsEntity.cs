...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ImplementTypeOptionsEntity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ImplementTypeOptionsEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ImplementTypeOptionsEntity DefaultInstance { get; }
        ...
        /// </summary>
        public Corvus.OmnisharpBenchmark.Baseline.Schema.ImplementTypeOptionsEntity.InsertionBehaviorEntity InsertionBehavior
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.InsertionBehaviorUtf8, out Corvus.OmnisharpBenchmark.Baseline.Schema.ImplementTypeOptionsEntity.InsertionBehaviorEntity value))
                {
                    return value;
                }

                return Corvus.OmnisharpBenchmark.Baseline.Schema.ImplementTypeOptionsEntity.InsertionBehaviorEntity.DefaultInstance;
            }
        }
        ...
        /// </summary>
        public Corvus.OmnisharpBenchmark.Baseline.Schema.ImplementTypeOptionsEntity.PropertyGenerationBehaviorEntity PropertyGenerationBehavior
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PropertyGenerationBehaviorUtf8, out Corvus.OmnisharpBenchmark.Baseline.Schema.ImplementTypeOptionsEntity.PropertyGenerationBehaviorEntity value))
                {
                    return value;
                }

                return Corvus.OmnisharpBenchmark.Baseline.Schema.ImplementTypeOptionsEntity.PropertyGenerationBehaviorEntity.DefaultInstance;
            }
        }
        ...
        /// </returns>
        public static bool operator ==(in ImplementTypeOptionsEntity left, in ImplementTypeOptionsEntity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ImplementTypeOptionsEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(ImplementTypeOptionsEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ImplementTypeOptionsEntity(JsonElement instance)
        {
            return ImplementTypeOptionsEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ImplementTypeOptionsEntity From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ImplementTypeOptionsEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ImplementTypeOptionsEntity>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ImplementTypeOptionsEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ImplementTypeOptionsEntity>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ImplementTypeOptionsEntity ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ImplementTypeOptionsEntity>(json, options);
        }
        ...
        /// </exception>
        public static ImplementTypeOptionsEntity ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ImplementTypeOptionsEntity>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ImplementTypeOptionsEntity? result)
        {
            return JsonElementHelpers.TryParseValue<ImplementTypeOptionsEntity>(ref reader, out result);
        }
...
#if NET
        static ImplementTypeOptionsEntity IJsonElement<ImplementTypeOptionsEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ImplementTypeOptionsEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public ImplementTypeOptionsEntity Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public ImplementTypeOptionsEntity Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ImplementTypeOptionsEntity>(_idx);
            }
        ...
        {
            /// <summary>
            /// Gets the JSON property name for <see cref="InsertionBehavior"/>.
            /// </summary>
            public const string InsertionBehavior = "InsertionBehavior";

            /// <summary>
            /// Gets the JSON property name for <see cref="PropertyGenerationBehavior"/>.
            /// </summary>
            public const string PropertyGenerationBehavior = "PropertyGenerationBehavior";

            /// <summary>
            /// Gets the JSON property name for <see cref="InsertionBehavior"/>.
            /// </summary>
            public static ReadOnlySpan<byte> InsertionBehaviorUtf8 => "InsertionBehavior"u8;

            /// <summary>
            /// Gets the JSON property name for <see cref="PropertyGenerationBehavior"/>.
            /// </summary>
            public static ReadOnlySpan<byte> PropertyGenerationBehaviorUtf8 => "PropertyGenerationBehavior"u8;
        }
        ...
        {
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="InsertionBehavior"/>.
            /// </summary>
            public static ReadOnlySpan<byte> InsertionBehavior => "InsertionBehavior"u8;

            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="PropertyGenerationBehavior"/>.
            /// </summary>
            public static ReadOnlySpan<byte> PropertyGenerationBehavior => "PropertyGenerationBehavior"u8;
        }
    }
}
