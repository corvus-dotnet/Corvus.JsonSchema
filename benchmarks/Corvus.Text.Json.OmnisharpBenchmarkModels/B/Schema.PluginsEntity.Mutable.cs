...
public readonly partial struct Schema
{
    ...
    public readonly partial struct PluginsEntity
    {
...
#endif
        {
            ...
            /// </summary>
            public Corvus.OmnisharpBenchmark.Baseline.Schema.PluginsEntity.JsonStringArray.Mutable LocationPaths
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LocationPathsUtf8, out Corvus.OmnisharpBenchmark.Baseline.Schema.PluginsEntity.JsonStringArray.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetLocationPaths(in Corvus.OmnisharpBenchmark.Baseline.Schema.PluginsEntity.JsonStringArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetLocationPaths<TContext>(in Corvus.OmnisharpBenchmark.Baseline.Schema.PluginsEntity.JsonStringArray.Source<TContext> value)
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.OmnisharpBenchmark.Baseline.Schema.PluginsEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.OmnisharpBenchmark.Baseline.Schema.PluginsEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.OmnisharpBenchmark.Baseline.Schema.PluginsEntity.JsonStringArray.Source locationPaths = default)
            {
            ...
            /// Creates an instance of a <see cref="PluginsEntity"/>.
            /// </summary>
            public void Create(in Corvus.OmnisharpBenchmark.Baseline.Schema.PluginsEntity.JsonStringArray.Source locationPaths = default)
            {
            ...
            internal static void Create<TContext>(
                ...
                in Corvus.OmnisharpBenchmark.Baseline.Schema.PluginsEntity.JsonStringArray.Source<TContext> locationPaths = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            /// Creates an instance of a <see cref="PluginsEntity"/>.
            /// </summary>
            public void Create<TContext>(in TContext context, in Corvus.OmnisharpBenchmark.Baseline.Schema.PluginsEntity.JsonStringArray.Source<TContext> locationPaths = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OmnisharpBenchmark.Baseline.Schema.PluginsEntity.JsonStringArray.Source locationPaths = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.OmnisharpBenchmark.Baseline.Schema.PluginsEntity.JsonStringArray.Source<TContext> locationPaths = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
