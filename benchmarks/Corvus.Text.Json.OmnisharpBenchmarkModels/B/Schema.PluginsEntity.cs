...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// </summary>
        public Corvus.OmnisharpBenchmark.Baseline.Schema.PluginsEntity.JsonStringArray LocationPaths
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LocationPathsUtf8, out Corvus.OmnisharpBenchmark.Baseline.Schema.PluginsEntity.JsonStringArray value))
                {
                    return value;
                }

                return Corvus.OmnisharpBenchmark.Baseline.Schema.PluginsEntity.JsonStringArray.DefaultInstance;
            }
        }
