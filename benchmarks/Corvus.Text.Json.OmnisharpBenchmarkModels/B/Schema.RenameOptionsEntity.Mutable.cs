...
public readonly partial struct Schema
{
    ...
    public readonly partial struct RenameOptionsEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(RenameOptionsEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="RenameOptionsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RenameOptionsEntity(Mutable instance)
            {
            ...
            /// <summary>
            /// Gets the (optional) <c>RenameInComments</c> property.
            /// </summary>
            public Corvus.OmnisharpBenchmark.Baseline.Schema.RenameOptionsEntity.RenameInCommentsEntity.Mutable RenameInComments
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RenameInCommentsUtf8, out Corvus.OmnisharpBenchmark.Baseline.Schema.RenameOptionsEntity.RenameInCommentsEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// <summary>
            /// Gets the (optional) <c>RenameInStrings</c> property.
            /// </summary>
            public Corvus.OmnisharpBenchmark.Baseline.Schema.RenameOptionsEntity.RenameInStringsEntity.Mutable RenameInStrings
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RenameInStringsUtf8, out Corvus.OmnisharpBenchmark.Baseline.Schema.RenameOptionsEntity.RenameInStringsEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// <summary>
            /// Gets the (optional) <c>RenameOverloads</c> property.
            /// </summary>
            public Corvus.OmnisharpBenchmark.Baseline.Schema.RenameOptionsEntity.RenameOverloadsEntity.Mutable RenameOverloads
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RenameOverloadsUtf8, out Corvus.OmnisharpBenchmark.Baseline.Schema.RenameOptionsEntity.RenameOverloadsEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RenameOptionsEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetRenameInComments(in Corvus.OmnisharpBenchmark.Baseline.Schema.RenameOptionsEntity.RenameInCommentsEntity.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.RenameInCommentsUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RenameInCommentsUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                ...
                else
                {
                    ...
                    value.AddAsProperty(JsonPropertyNamesEscaped.RenameInComments, ref cvb, escapeName: false, nameRequiresUnescaping: false);
            ...
            /// <summary>
            /// Remove the <c>RenameInComments</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveRenameInComments()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.RenameInCommentsUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetRenameInStrings(in Corvus.OmnisharpBenchmark.Baseline.Schema.RenameOptionsEntity.RenameInStringsEntity.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.RenameInStringsUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RenameInStringsUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsProperty(JsonPropertyNamesEscaped.RenameInStrings, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// <summary>
            /// Remove the <c>RenameInStrings</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveRenameInStrings()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.RenameInStringsUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetRenameOverloads(in Corvus.OmnisharpBenchmark.Baseline.Schema.RenameOptionsEntity.RenameOverloadsEntity.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.RenameOverloadsUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RenameOverloadsUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsProperty(JsonPropertyNamesEscaped.RenameOverloads, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// <summary>
            /// Remove the <c>RenameOverloads</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveRenameOverloads()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.RenameOverloadsUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RenameOptionsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RenameOptionsEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RenameOptionsEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly RenameOptionsEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RenameOptionsEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RenameOptionsEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly RenameOptionsEntity Freeze()
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.OmnisharpBenchmark.Baseline.Schema.RenameOptionsEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.OmnisharpBenchmark.Baseline.Schema.RenameOptionsEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="RenameOptionsEntity"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.OmnisharpBenchmark.Baseline.Schema.RenameOptionsEntity.RenameInCommentsEntity.Source renameInComments = default,
                in Corvus.OmnisharpBenchmark.Baseline.Schema.RenameOptionsEntity.RenameInStringsEntity.Source renameInStrings = default,
                in Corvus.OmnisharpBenchmark.Baseline.Schema.RenameOptionsEntity.RenameOverloadsEntity.Source renameOverloads = default)
            {
                renameInComments.AddAsProperty(JsonPropertyNamesEscaped.RenameInComments, ref builder, escapeName: false);
                renameInStrings.AddAsProperty(JsonPropertyNamesEscaped.RenameInStrings, ref builder, escapeName: false);
                renameOverloads.AddAsProperty(JsonPropertyNamesEscaped.RenameOverloads, ref builder, escapeName: false);
            }
            ...
            public void Create(
                ...
                in Corvus.OmnisharpBenchmark.Baseline.Schema.RenameOptionsEntity.RenameOverloadsEntity.Source renameOverloads = default)
            {
                Create(ref _builder, renameInComments, renameInStrings, renameOverloads);
            }
        ...
        /// </summary>
        /// <param name="workspace">The JSON workspace.</param>
        /// <param name="renameInComments">The value of the property.</param>
        /// <param name="renameInStrings">The value of the property.</param>
        /// <param name="renameOverloads">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OmnisharpBenchmark.Baseline.Schema.RenameOptionsEntity.RenameInCommentsEntity.Source renameInComments = default, in Corvus.OmnisharpBenchmark.Baseline.Schema.RenameOptionsEntity.RenameInStringsEntity.Source renameInStrings = default, in Corvus.OmnisharpBenchmark.Baseline.Schema.RenameOptionsEntity.RenameOverloadsEntity.Source renameOverloads = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(renameInComments, renameInStrings, renameOverloads);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<RenameOptionsEntity, Mutable>(this);
        }
    }
}
