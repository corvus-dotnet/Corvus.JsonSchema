    ...
    public readonly partial struct RoslynExtensionsOptionsEntity
    {
        ...
        public readonly partial struct EnableDecompilationSupportEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(EnableDecompilationSupportEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="EnableDecompilationSupportEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator EnableDecompilationSupportEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"EnableDecompilationSupportEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly EnableDecompilationSupportEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly EnableDecompilationSupportEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<EnableDecompilationSupportEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(EnableDecompilationSupportEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<EnableDecompilationSupportEntity, Mutable>(this);
            }
        }
    }
}
