...
public readonly partial struct Schema
{
    ...
    public readonly partial struct RoslynExtensionsOptionsEntity
    {
        ...
        public readonly partial struct IfSetToFalseOnlyRefactoringsAreAvailable
#if NET8_0_OR_GREATER
            : IJsonElement<IfSetToFalseOnlyRefactoringsAreAvailable>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="IfSetToFalseOnlyRefactoringsAreAvailable"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal IfSetToFalseOnlyRefactoringsAreAvailable(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static IfSetToFalseOnlyRefactoringsAreAvailable DefaultInstance { get; } = ParsedJsonDocument<IfSetToFalseOnlyRefactoringsAreAvailable>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(IfSetToFalseOnlyRefactoringsAreAvailable value)
            {
            ...
            /// </returns>
            public static bool operator ==(in IfSetToFalseOnlyRefactoringsAreAvailable left, in IfSetToFalseOnlyRefactoringsAreAvailable right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in IfSetToFalseOnlyRefactoringsAreAvailable left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(IfSetToFalseOnlyRefactoringsAreAvailable instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator IfSetToFalseOnlyRefactoringsAreAvailable(JsonElement instance)
            {
                return IfSetToFalseOnlyRefactoringsAreAvailable.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static IfSetToFalseOnlyRefactoringsAreAvailable From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static IfSetToFalseOnlyRefactoringsAreAvailable ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<IfSetToFalseOnlyRefactoringsAreAvailable>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static IfSetToFalseOnlyRefactoringsAreAvailable ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<IfSetToFalseOnlyRefactoringsAreAvailable>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static IfSetToFalseOnlyRefactoringsAreAvailable ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<IfSetToFalseOnlyRefactoringsAreAvailable>(json, options);
            }
            ...
            /// </exception>
            public static IfSetToFalseOnlyRefactoringsAreAvailable ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<IfSetToFalseOnlyRefactoringsAreAvailable>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out IfSetToFalseOnlyRefactoringsAreAvailable? result)
            {
                return JsonElementHelpers.TryParseValue<IfSetToFalseOnlyRefactoringsAreAvailable>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new IfSetToFalseOnlyRefactoringsAreAvailable(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static IfSetToFalseOnlyRefactoringsAreAvailable IJsonElement<IfSetToFalseOnlyRefactoringsAreAvailable>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"IfSetToFalseOnlyRefactoringsAreAvailable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="IfSetToFalseOnlyRefactoringsAreAvailable"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="IfSetToFalseOnlyRefactoringsAreAvailable"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public IfSetToFalseOnlyRefactoringsAreAvailable Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<IfSetToFalseOnlyRefactoringsAreAvailable>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="IfSetToFalseOnlyRefactoringsAreAvailable"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public IfSetToFalseOnlyRefactoringsAreAvailable Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<IfSetToFalseOnlyRefactoringsAreAvailable>(_idx);
                }
