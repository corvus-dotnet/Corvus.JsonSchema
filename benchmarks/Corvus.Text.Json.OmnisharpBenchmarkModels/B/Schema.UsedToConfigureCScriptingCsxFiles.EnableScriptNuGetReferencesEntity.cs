...
public readonly partial struct Schema
{
    ...
    public readonly partial struct UsedToConfigureCScriptingCsxFiles
    {
        ...
        public readonly partial struct EnableScriptNuGetReferencesEntity
#if NET8_0_OR_GREATER
            : IJsonElement<EnableScriptNuGetReferencesEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="EnableScriptNuGetReferencesEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal EnableScriptNuGetReferencesEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static EnableScriptNuGetReferencesEntity DefaultInstance { get; } = ParsedJsonDocument<EnableScriptNuGetReferencesEntity>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(EnableScriptNuGetReferencesEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in EnableScriptNuGetReferencesEntity left, in EnableScriptNuGetReferencesEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in EnableScriptNuGetReferencesEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(EnableScriptNuGetReferencesEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EnableScriptNuGetReferencesEntity(JsonElement instance)
            {
                return EnableScriptNuGetReferencesEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EnableScriptNuGetReferencesEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EnableScriptNuGetReferencesEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EnableScriptNuGetReferencesEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EnableScriptNuGetReferencesEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EnableScriptNuGetReferencesEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EnableScriptNuGetReferencesEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EnableScriptNuGetReferencesEntity>(json, options);
            }
            ...
            /// </exception>
            public static EnableScriptNuGetReferencesEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<EnableScriptNuGetReferencesEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out EnableScriptNuGetReferencesEntity? result)
            {
                return JsonElementHelpers.TryParseValue<EnableScriptNuGetReferencesEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new EnableScriptNuGetReferencesEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static EnableScriptNuGetReferencesEntity IJsonElement<EnableScriptNuGetReferencesEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EnableScriptNuGetReferencesEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="EnableScriptNuGetReferencesEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="EnableScriptNuGetReferencesEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public EnableScriptNuGetReferencesEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<EnableScriptNuGetReferencesEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="EnableScriptNuGetReferencesEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public EnableScriptNuGetReferencesEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<EnableScriptNuGetReferencesEntity>(_idx);
                }
