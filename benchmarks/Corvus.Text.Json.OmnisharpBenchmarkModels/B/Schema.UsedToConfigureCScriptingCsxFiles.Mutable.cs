...
public readonly partial struct Schema
{
    ...
    public readonly partial struct UsedToConfigureCScriptingCsxFiles
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(UsedToConfigureCScriptingCsxFiles instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="UsedToConfigureCScriptingCsxFiles"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator UsedToConfigureCScriptingCsxFiles(Mutable instance)
            {
            ...
            /// <summary>
            /// Gets the (optional) <c>defaultTargetFramework</c> property.
            /// </summary>
            public Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCScriptingCsxFiles.DefaultTargetFrameworkEntity.Mutable DefaultTargetFramework
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DefaultTargetFrameworkUtf8, out Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCScriptingCsxFiles.DefaultTargetFrameworkEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCScriptingCsxFiles.EnabledEntity.Mutable Enabled
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EnabledUtf8, out Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCScriptingCsxFiles.EnabledEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// <summary>
            /// Gets the (optional) <c>enableScriptNuGetReferences</c> property.
            /// </summary>
            public Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCScriptingCsxFiles.EnableScriptNuGetReferencesEntity.Mutable EnableScriptNuGetReferences
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EnableScriptNuGetReferencesUtf8, out Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCScriptingCsxFiles.EnableScriptNuGetReferencesEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// <summary>
            /// Gets the (optional) <c>rspFilePath</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCScriptingCsxFiles.RspFilePathEntity.Mutable RspFilePath
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RspFilePathUtf8, out Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCScriptingCsxFiles.RspFilePathEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new UsedToConfigureCScriptingCsxFiles(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetDefaultTargetFramework(in Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCScriptingCsxFiles.DefaultTargetFrameworkEntity.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.DefaultTargetFrameworkUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DefaultTargetFrameworkUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                ...
                else
                {
                    ...
                    value.AddAsProperty(JsonPropertyNamesEscaped.DefaultTargetFramework, ref cvb, escapeName: false, nameRequiresUnescaping: false);
            ...
            /// <summary>
            /// Remove the <c>defaultTargetFramework</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveDefaultTargetFramework()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.DefaultTargetFrameworkUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetEnabled(in Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCScriptingCsxFiles.EnabledEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetEnableScriptNuGetReferences(in Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCScriptingCsxFiles.EnableScriptNuGetReferencesEntity.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.EnableScriptNuGetReferencesUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EnableScriptNuGetReferencesUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsProperty(JsonPropertyNamesEscaped.EnableScriptNuGetReferences, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// <summary>
            /// Remove the <c>enableScriptNuGetReferences</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveEnableScriptNuGetReferences()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.EnableScriptNuGetReferencesUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetRspFilePath(in Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCScriptingCsxFiles.RspFilePathEntity.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.RspFilePathUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RspFilePathUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsProperty(JsonPropertyNamesEscaped.RspFilePath, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// <summary>
            /// Remove the <c>rspFilePath</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveRspFilePath()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.RspFilePathUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"UsedToConfigureCScriptingCsxFiles.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="UsedToConfigureCScriptingCsxFiles"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="UsedToConfigureCScriptingCsxFiles"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly UsedToConfigureCScriptingCsxFiles Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<UsedToConfigureCScriptingCsxFiles>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="UsedToConfigureCScriptingCsxFiles"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly UsedToConfigureCScriptingCsxFiles Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<UsedToConfigureCScriptingCsxFiles>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCScriptingCsxFiles.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(UsedToConfigureCScriptingCsxFiles instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCScriptingCsxFiles.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="UsedToConfigureCScriptingCsxFiles"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCScriptingCsxFiles.DefaultTargetFrameworkEntity.Source defaultTargetFramework = default,
                in Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCScriptingCsxFiles.EnabledEntity.Source enabled = default,
                in Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCScriptingCsxFiles.EnableScriptNuGetReferencesEntity.Source enableScriptNuGetReferences = default,
                in Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCScriptingCsxFiles.RspFilePathEntity.Source rspFilePath = default)
            {
                defaultTargetFramework.AddAsProperty(JsonPropertyNamesEscaped.DefaultTargetFramework, ref builder, escapeName: false);
                enabled.AddAsProperty(JsonPropertyNamesEscaped.Enabled, ref builder, escapeName: false);
                enableScriptNuGetReferences.AddAsProperty(JsonPropertyNamesEscaped.EnableScriptNuGetReferences, ref builder, escapeName: false);
                rspFilePath.AddAsProperty(JsonPropertyNamesEscaped.RspFilePath, ref builder, escapeName: false);
            }
            ...
            public void Create(
                ...
                in Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCScriptingCsxFiles.RspFilePathEntity.Source rspFilePath = default)
            {
                Create(ref _builder, defaultTargetFramework, enabled, enableScriptNuGetReferences, rspFilePath);
            }
        ...
        /// </summary>
        /// <param name="workspace">The JSON workspace.</param>
        /// <param name="defaultTargetFramework">The value of the property.</param>
        /// <param name="enabled">The value of the property.</param>
        /// <param name="enableScriptNuGetReferences">The value of the property.</param>
        /// <param name="rspFilePath">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCScriptingCsxFiles.DefaultTargetFrameworkEntity.Source defaultTargetFramework = default, in Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCScriptingCsxFiles.EnabledEntity.Source enabled = default, in Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCScriptingCsxFiles.EnableScriptNuGetReferencesEntity.Source enableScriptNuGetReferences = default, in Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCScriptingCsxFiles.RspFilePathEntity.Source rspFilePath = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(defaultTargetFramework, enabled, enableScriptNuGetReferences, rspFilePath);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<UsedToConfigureCScriptingCsxFiles, Mutable>(this);
        }
    }
}
