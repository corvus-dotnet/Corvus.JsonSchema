...
public readonly partial struct Schema
{
    ...
    public readonly partial struct UsedToConfigureCakeCakeFiles
        : IJsonElement<UsedToConfigureCakeCakeFiles>
    {
        public static partial class JsonSchema
        {
            private static readonly JsonSchemaPathProvider BakeryPathSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/bakeryPath"u8, buffer, out written);
            ...
            private static void MatchBakeryPath(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext =
                    Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCakeCakeFiles.BakeryPathEntity.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.BakeryPathUtf8,
                        evaluationPath: BakeryPathSchemaEvaluationPath);

                Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCakeCakeFiles.BakeryPathEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            private static void MatchEnabled(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                ...
                JsonSchemaContext childContext1 =
                    Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCakeCakeFiles.EnabledEntity.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCakeCakeFiles.EnabledEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
            ...
            private static PropertySchemaMatchers<Corvus.OmnisharpBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
            {
                return new PropertySchemaMatchers<Corvus.OmnisharpBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator>([
                    (static () => JsonPropertyNames.BakeryPathUtf8, MatchBakeryPath),
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://json.schemastore.org/omnisharp.json#/properties/cake"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "https://json.schemastore.org/omnisharp.json#/properties/cake";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://json.schemastore.org/omnisharp.json#/properties/cake"u8;
