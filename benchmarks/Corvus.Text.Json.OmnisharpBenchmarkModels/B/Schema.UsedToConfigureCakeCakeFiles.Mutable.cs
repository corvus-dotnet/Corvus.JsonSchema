...
public readonly partial struct Schema
{
    ...
    public readonly partial struct UsedToConfigureCakeCakeFiles
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(UsedToConfigureCakeCakeFiles instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="UsedToConfigureCakeCakeFiles"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator UsedToConfigureCakeCakeFiles(Mutable instance)
            {
            ...
            /// <summary>
            /// Gets the (optional) <c>bakeryPath</c> property.
            /// </summary>
            public Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCakeCakeFiles.BakeryPathEntity.Mutable BakeryPath
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BakeryPathUtf8, out Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCakeCakeFiles.BakeryPathEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCakeCakeFiles.EnabledEntity.Mutable Enabled
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EnabledUtf8, out Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCakeCakeFiles.EnabledEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new UsedToConfigureCakeCakeFiles(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetBakeryPath(in Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCakeCakeFiles.BakeryPathEntity.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.BakeryPathUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BakeryPathUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                ...
                else
                {
                    ...
                    value.AddAsProperty(JsonPropertyNamesEscaped.BakeryPath, ref cvb, escapeName: false, nameRequiresUnescaping: false);
            ...
            /// <summary>
            /// Remove the <c>bakeryPath</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveBakeryPath()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.BakeryPathUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetEnabled(in Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCakeCakeFiles.EnabledEntity.Source value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"UsedToConfigureCakeCakeFiles.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="UsedToConfigureCakeCakeFiles"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="UsedToConfigureCakeCakeFiles"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly UsedToConfigureCakeCakeFiles Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<UsedToConfigureCakeCakeFiles>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="UsedToConfigureCakeCakeFiles"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly UsedToConfigureCakeCakeFiles Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<UsedToConfigureCakeCakeFiles>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCakeCakeFiles.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(UsedToConfigureCakeCakeFiles instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCakeCakeFiles.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="UsedToConfigureCakeCakeFiles"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCakeCakeFiles.BakeryPathEntity.Source bakeryPath = default,
                in Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCakeCakeFiles.EnabledEntity.Source enabled = default)
            {
                bakeryPath.AddAsProperty(JsonPropertyNamesEscaped.BakeryPath, ref builder, escapeName: false);
            ...
            /// Creates an instance of a <see cref="UsedToConfigureCakeCakeFiles"/>.
            /// </summary>
            public void Create(in Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCakeCakeFiles.BakeryPathEntity.Source bakeryPath = default, in Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCakeCakeFiles.EnabledEntity.Source enabled = default)
            {
                Create(ref _builder, bakeryPath, enabled);
            }
        ...
        /// </summary>
        /// <param name="workspace">The JSON workspace.</param>
        /// <param name="bakeryPath">The value of the property.</param>
        /// <param name="enabled">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCakeCakeFiles.BakeryPathEntity.Source bakeryPath = default, in Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCakeCakeFiles.EnabledEntity.Source enabled = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(bakeryPath, enabled);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<UsedToConfigureCakeCakeFiles, Mutable>(this);
        }
    }
}
