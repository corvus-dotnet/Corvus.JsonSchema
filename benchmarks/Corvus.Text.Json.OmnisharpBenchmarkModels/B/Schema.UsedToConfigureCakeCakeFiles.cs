...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UsedToConfigureCakeCakeFiles"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal UsedToConfigureCakeCakeFiles(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static UsedToConfigureCakeCakeFiles DefaultInstance { get; }
        ...
        /// </summary>
        public Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCakeCakeFiles.BakeryPathEntity BakeryPath
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BakeryPathUtf8, out Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCakeCakeFiles.BakeryPathEntity value))
                {
                    return value;
                }

                return Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCakeCakeFiles.BakeryPathEntity.DefaultInstance;
            }
        }
        ...
        /// </summary>
        public Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCakeCakeFiles.EnabledEntity Enabled
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EnabledUtf8, out Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCakeCakeFiles.EnabledEntity value))
                {
                    return value;
                }

                return Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCakeCakeFiles.EnabledEntity.DefaultInstance;
            }
        }
        ...
        /// </returns>
        public static bool operator ==(in UsedToConfigureCakeCakeFiles left, in UsedToConfigureCakeCakeFiles right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in UsedToConfigureCakeCakeFiles left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(UsedToConfigureCakeCakeFiles instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator UsedToConfigureCakeCakeFiles(JsonElement instance)
        {
            return UsedToConfigureCakeCakeFiles.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static UsedToConfigureCakeCakeFiles From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static UsedToConfigureCakeCakeFiles ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<UsedToConfigureCakeCakeFiles>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static UsedToConfigureCakeCakeFiles ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<UsedToConfigureCakeCakeFiles>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static UsedToConfigureCakeCakeFiles ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<UsedToConfigureCakeCakeFiles>(json, options);
        }
        ...
        /// </exception>
        public static UsedToConfigureCakeCakeFiles ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<UsedToConfigureCakeCakeFiles>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out UsedToConfigureCakeCakeFiles? result)
        {
            return JsonElementHelpers.TryParseValue<UsedToConfigureCakeCakeFiles>(ref reader, out result);
        }
...
#if NET
        static UsedToConfigureCakeCakeFiles IJsonElement<UsedToConfigureCakeCakeFiles>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"UsedToConfigureCakeCakeFiles: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public UsedToConfigureCakeCakeFiles Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public UsedToConfigureCakeCakeFiles Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<UsedToConfigureCakeCakeFiles>(_idx);
            }
        ...
        {
            /// <summary>
            /// Gets the JSON property name for <see cref="BakeryPath"/>.
            /// </summary>
            public const string BakeryPath = "bakeryPath";
            ...
            /// Gets the JSON property name for <see cref="BakeryPath"/>.
            /// </summary>
            public static ReadOnlySpan<byte> BakeryPathUtf8 => "bakeryPath"u8;
        ...
        {
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="BakeryPath"/>.
            /// </summary>
            public static ReadOnlySpan<byte> BakeryPath => "bakeryPath"u8;
