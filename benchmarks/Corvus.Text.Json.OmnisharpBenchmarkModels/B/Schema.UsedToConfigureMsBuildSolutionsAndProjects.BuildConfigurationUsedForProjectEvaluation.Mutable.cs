    ...
    public readonly partial struct UsedToConfigureMsBuildSolutionsAndProjects
    {
        ...
        public readonly partial struct BuildConfigurationUsedForProjectEvaluation
        {
...
#endif
            {
                ...
                /// <summary>
                /// Conversion to <see cref="Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureMsBuildSolutionsAndProjects.BuildConfigurationUsedForProjectEvaluation.AnyOf0Entity"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static explicit operator Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureMsBuildSolutionsAndProjects.BuildConfigurationUsedForProjectEvaluation.AnyOf0Entity.Mutable(Mutable value)
                {
                    return Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureMsBuildSolutionsAndProjects.BuildConfigurationUsedForProjectEvaluation.AnyOf0Entity.Mutable.From(value);
                }

                /// <summary>
                /// Conversion from <see cref="Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureMsBuildSolutionsAndProjects.BuildConfigurationUsedForProjectEvaluation.AnyOf0Entity"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureMsBuildSolutionsAndProjects.BuildConfigurationUsedForProjectEvaluation.AnyOf0Entity.Mutable value)
                {
                    return From(value);
                }
                ...
                public static explicit operator Mutable(BuildConfigurationUsedForProjectEvaluation instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="BuildConfigurationUsedForProjectEvaluation"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator BuildConfigurationUsedForProjectEvaluation(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"BuildConfigurationUsedForProjectEvaluation.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly BuildConfigurationUsedForProjectEvaluation Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly BuildConfigurationUsedForProjectEvaluation Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<BuildConfigurationUsedForProjectEvaluation>(_idx);
                }
                ...
                /// <param name="matchAnyOf0Entity">Match a <see cref="Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureMsBuildSolutionsAndProjects.BuildConfigurationUsedForProjectEvaluation.AnyOf0Entity"/>.</param>
                ...
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Matcher<Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureMsBuildSolutionsAndProjects.BuildConfigurationUsedForProjectEvaluation.AnyOf0Entity, TContext, TResult> matchAnyOf0Entity,
                    Matcher<Corvus.OmnisharpBenchmark.Baseline.JsonString, TContext, TResult> matchJsonString,
                    Matcher<Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureMsBuildSolutionsAndProjects.BuildConfigurationUsedForProjectEvaluation.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
                {
                    if (Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureMsBuildSolutionsAndProjects.BuildConfigurationUsedForProjectEvaluation.AnyOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchAnyOf0Entity(Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureMsBuildSolutionsAndProjects.BuildConfigurationUsedForProjectEvaluation.AnyOf0Entity.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    Matcher<Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureMsBuildSolutionsAndProjects.BuildConfigurationUsedForProjectEvaluation.AnyOf0Entity, TResult> matchAnyOf0Entity,
                    Matcher<Corvus.OmnisharpBenchmark.Baseline.JsonString, TResult> matchJsonString,
                    Matcher<Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureMsBuildSolutionsAndProjects.BuildConfigurationUsedForProjectEvaluation.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureMsBuildSolutionsAndProjects.BuildConfigurationUsedForProjectEvaluation.AnyOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchAnyOf0Entity(Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureMsBuildSolutionsAndProjects.BuildConfigurationUsedForProjectEvaluation.AnyOf0Entity.Mutable.From(this));
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureMsBuildSolutionsAndProjects.BuildConfigurationUsedForProjectEvaluation.AnyOf0Entity" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsAnyOf0Entity(out Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureMsBuildSolutionsAndProjects.BuildConfigurationUsedForProjectEvaluation.AnyOf0Entity result)
                {
                    if (Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureMsBuildSolutionsAndProjects.BuildConfigurationUsedForProjectEvaluation.AnyOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureMsBuildSolutionsAndProjects.BuildConfigurationUsedForProjectEvaluation.AnyOf0Entity.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(BuildConfigurationUsedForProjectEvaluation instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureMsBuildSolutionsAndProjects.BuildConfigurationUsedForProjectEvaluation.AnyOf0Entity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<BuildConfigurationUsedForProjectEvaluation, Mutable>(this);
            }
        }
    }
}
