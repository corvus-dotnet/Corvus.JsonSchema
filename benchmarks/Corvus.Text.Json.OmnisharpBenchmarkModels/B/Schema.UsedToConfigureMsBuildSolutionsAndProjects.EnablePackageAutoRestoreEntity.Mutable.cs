...
public readonly partial struct Schema
{
    ...
    public readonly partial struct UsedToConfigureMsBuildSolutionsAndProjects
    {
        ...
        public readonly partial struct EnablePackageAutoRestoreEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(EnablePackageAutoRestoreEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="EnablePackageAutoRestoreEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator EnablePackageAutoRestoreEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new EnablePackageAutoRestoreEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"EnablePackageAutoRestoreEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="EnablePackageAutoRestoreEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="EnablePackageAutoRestoreEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly EnablePackageAutoRestoreEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<EnablePackageAutoRestoreEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="EnablePackageAutoRestoreEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly EnablePackageAutoRestoreEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<EnablePackageAutoRestoreEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(EnablePackageAutoRestoreEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<EnablePackageAutoRestoreEntity, Mutable>(this);
            }
        }
    }
}
