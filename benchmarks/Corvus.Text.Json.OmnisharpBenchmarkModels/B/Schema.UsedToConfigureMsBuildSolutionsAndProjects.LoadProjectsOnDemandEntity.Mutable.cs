...
public readonly partial struct Schema
{
    ...
    public readonly partial struct UsedToConfigureMsBuildSolutionsAndProjects
    {
        ...
        public readonly partial struct LoadProjectsOnDemandEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(LoadProjectsOnDemandEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="LoadProjectsOnDemandEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator LoadProjectsOnDemandEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new LoadProjectsOnDemandEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"LoadProjectsOnDemandEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="LoadProjectsOnDemandEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="LoadProjectsOnDemandEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly LoadProjectsOnDemandEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<LoadProjectsOnDemandEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="LoadProjectsOnDemandEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly LoadProjectsOnDemandEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<LoadProjectsOnDemandEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(LoadProjectsOnDemandEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<LoadProjectsOnDemandEntity, Mutable>(this);
            }
        }
    }
}
