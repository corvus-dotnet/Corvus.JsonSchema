...
public readonly partial struct Schema
{
    ...
    public readonly partial struct UsedToConfigureMsBuildSolutionsAndProjects
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="LocalRoslynPathEGMsBuildPathCurrentBinRoslyn"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal LocalRoslynPathEGMsBuildPathCurrentBinRoslyn(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static LocalRoslynPathEGMsBuildPathCurrentBinRoslyn DefaultInstance { get; } = ParsedJsonDocument<LocalRoslynPathEGMsBuildPathCurrentBinRoslyn>.Null;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(LocalRoslynPathEGMsBuildPathCurrentBinRoslyn value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in LocalRoslynPathEGMsBuildPathCurrentBinRoslyn left, in LocalRoslynPathEGMsBuildPathCurrentBinRoslyn right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in LocalRoslynPathEGMsBuildPathCurrentBinRoslyn left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(LocalRoslynPathEGMsBuildPathCurrentBinRoslyn instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator LocalRoslynPathEGMsBuildPathCurrentBinRoslyn(JsonElement instance)
            {
                return LocalRoslynPathEGMsBuildPathCurrentBinRoslyn.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LocalRoslynPathEGMsBuildPathCurrentBinRoslyn From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LocalRoslynPathEGMsBuildPathCurrentBinRoslyn ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<LocalRoslynPathEGMsBuildPathCurrentBinRoslyn>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LocalRoslynPathEGMsBuildPathCurrentBinRoslyn ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<LocalRoslynPathEGMsBuildPathCurrentBinRoslyn>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LocalRoslynPathEGMsBuildPathCurrentBinRoslyn ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<LocalRoslynPathEGMsBuildPathCurrentBinRoslyn>(json, options);
            }
            ...
            /// </exception>
            public static LocalRoslynPathEGMsBuildPathCurrentBinRoslyn ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<LocalRoslynPathEGMsBuildPathCurrentBinRoslyn>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out LocalRoslynPathEGMsBuildPathCurrentBinRoslyn? result)
            {
                return JsonElementHelpers.TryParseValue<LocalRoslynPathEGMsBuildPathCurrentBinRoslyn>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new LocalRoslynPathEGMsBuildPathCurrentBinRoslyn(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static LocalRoslynPathEGMsBuildPathCurrentBinRoslyn IJsonElement<LocalRoslynPathEGMsBuildPathCurrentBinRoslyn>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"LocalRoslynPathEGMsBuildPathCurrentBinRoslyn: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="LocalRoslynPathEGMsBuildPathCurrentBinRoslyn"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="LocalRoslynPathEGMsBuildPathCurrentBinRoslyn"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public LocalRoslynPathEGMsBuildPathCurrentBinRoslyn Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<LocalRoslynPathEGMsBuildPathCurrentBinRoslyn>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="LocalRoslynPathEGMsBuildPathCurrentBinRoslyn"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public LocalRoslynPathEGMsBuildPathCurrentBinRoslyn Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<LocalRoslynPathEGMsBuildPathCurrentBinRoslyn>(_idx);
                }
