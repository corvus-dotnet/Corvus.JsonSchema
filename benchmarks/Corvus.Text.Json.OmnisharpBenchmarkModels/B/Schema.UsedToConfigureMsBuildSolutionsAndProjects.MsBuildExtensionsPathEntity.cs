...
public readonly partial struct Schema
{
    ...
    public readonly partial struct UsedToConfigureMsBuildSolutionsAndProjects
    {
        ...
        public readonly partial struct MsBuildExtensionsPathEntity
#if NET8_0_OR_GREATER
            : IJsonElement<MsBuildExtensionsPathEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="MsBuildExtensionsPathEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal MsBuildExtensionsPathEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static MsBuildExtensionsPathEntity DefaultInstance { get; } = ParsedJsonDocument<MsBuildExtensionsPathEntity>.Null;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(MsBuildExtensionsPathEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in MsBuildExtensionsPathEntity left, in MsBuildExtensionsPathEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in MsBuildExtensionsPathEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(MsBuildExtensionsPathEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MsBuildExtensionsPathEntity(JsonElement instance)
            {
                return MsBuildExtensionsPathEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MsBuildExtensionsPathEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MsBuildExtensionsPathEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MsBuildExtensionsPathEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MsBuildExtensionsPathEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MsBuildExtensionsPathEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MsBuildExtensionsPathEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MsBuildExtensionsPathEntity>(json, options);
            }
            ...
            /// </exception>
            public static MsBuildExtensionsPathEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<MsBuildExtensionsPathEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out MsBuildExtensionsPathEntity? result)
            {
                return JsonElementHelpers.TryParseValue<MsBuildExtensionsPathEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new MsBuildExtensionsPathEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static MsBuildExtensionsPathEntity IJsonElement<MsBuildExtensionsPathEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MsBuildExtensionsPathEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="MsBuildExtensionsPathEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="MsBuildExtensionsPathEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public MsBuildExtensionsPathEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<MsBuildExtensionsPathEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="MsBuildExtensionsPathEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public MsBuildExtensionsPathEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<MsBuildExtensionsPathEntity>(_idx);
                }
