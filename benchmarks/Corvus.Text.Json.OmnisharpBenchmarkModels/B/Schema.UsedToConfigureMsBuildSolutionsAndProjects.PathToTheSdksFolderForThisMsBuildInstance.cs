...
public readonly partial struct Schema
{
    ...
    public readonly partial struct UsedToConfigureMsBuildSolutionsAndProjects
    {
        ...
        public readonly partial struct PathToTheSdksFolderForThisMsBuildInstance
            ...
            : IJsonElement<PathToTheSdksFolderForThisMsBuildInstance>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="PathToTheSdksFolderForThisMsBuildInstance"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal PathToTheSdksFolderForThisMsBuildInstance(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static PathToTheSdksFolderForThisMsBuildInstance DefaultInstance { get; } = ParsedJsonDocument<PathToTheSdksFolderForThisMsBuildInstance>.Null;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(PathToTheSdksFolderForThisMsBuildInstance value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in PathToTheSdksFolderForThisMsBuildInstance left, in PathToTheSdksFolderForThisMsBuildInstance right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in PathToTheSdksFolderForThisMsBuildInstance left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(PathToTheSdksFolderForThisMsBuildInstance instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PathToTheSdksFolderForThisMsBuildInstance(JsonElement instance)
            {
                return PathToTheSdksFolderForThisMsBuildInstance.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PathToTheSdksFolderForThisMsBuildInstance From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PathToTheSdksFolderForThisMsBuildInstance ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PathToTheSdksFolderForThisMsBuildInstance>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PathToTheSdksFolderForThisMsBuildInstance ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PathToTheSdksFolderForThisMsBuildInstance>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PathToTheSdksFolderForThisMsBuildInstance ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PathToTheSdksFolderForThisMsBuildInstance>(json, options);
            }
            ...
            /// </exception>
            public static PathToTheSdksFolderForThisMsBuildInstance ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<PathToTheSdksFolderForThisMsBuildInstance>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out PathToTheSdksFolderForThisMsBuildInstance? result)
            {
                return JsonElementHelpers.TryParseValue<PathToTheSdksFolderForThisMsBuildInstance>(ref reader, out result);
            }
...
#if NET
            static PathToTheSdksFolderForThisMsBuildInstance IJsonElement<PathToTheSdksFolderForThisMsBuildInstance>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PathToTheSdksFolderForThisMsBuildInstance: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public PathToTheSdksFolderForThisMsBuildInstance Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public PathToTheSdksFolderForThisMsBuildInstance Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<PathToTheSdksFolderForThisMsBuildInstance>(_idx);
                }
