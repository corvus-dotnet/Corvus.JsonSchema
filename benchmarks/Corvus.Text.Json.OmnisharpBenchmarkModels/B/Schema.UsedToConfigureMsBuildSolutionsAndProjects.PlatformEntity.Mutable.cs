    ...
    public readonly partial struct UsedToConfigureMsBuildSolutionsAndProjects
    {
        ...
        public readonly partial struct PlatformEntity
        {
...
#endif
            {
                ...
                public static explicit operator Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureMsBuildSolutionsAndProjects.PlatformEntity.AnyOf0Entity.Mutable(Mutable value)
                {
                    return Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureMsBuildSolutionsAndProjects.PlatformEntity.AnyOf0Entity.Mutable.From(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureMsBuildSolutionsAndProjects.PlatformEntity.AnyOf0Entity.Mutable value)
                {
                    return From(value);
                }
                ...
                public static explicit operator Mutable(PlatformEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="PlatformEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator PlatformEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"PlatformEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly PlatformEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly PlatformEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<PlatformEntity>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureMsBuildSolutionsAndProjects.PlatformEntity.Mutable, TContext, TResult> defaultMatch)
...
#endif
                {
                    ...
                    {
                        return matchAnyOf0Entity(Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureMsBuildSolutionsAndProjects.PlatformEntity.AnyOf0Entity.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureMsBuildSolutionsAndProjects.PlatformEntity.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureMsBuildSolutionsAndProjects.PlatformEntity.AnyOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchAnyOf0Entity(Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureMsBuildSolutionsAndProjects.PlatformEntity.AnyOf0Entity.Mutable.From(this));
                    }
                ...
                public bool TryGetAsAnyOf0Entity(out Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureMsBuildSolutionsAndProjects.PlatformEntity.AnyOf0Entity result)
                {
                    if (Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureMsBuildSolutionsAndProjects.PlatformEntity.AnyOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureMsBuildSolutionsAndProjects.PlatformEntity.AnyOf0Entity.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(PlatformEntity instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureMsBuildSolutionsAndProjects.PlatformEntity.AnyOf0Entity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<PlatformEntity, Mutable>(this);
            }
        }
    }
}
