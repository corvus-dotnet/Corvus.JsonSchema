...
public readonly partial struct Schema
{
    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct IndentationSizeEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(IndentationSizeEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="IndentationSizeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator IndentationSizeEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new IndentationSizeEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"IndentationSizeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="IndentationSizeEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="IndentationSizeEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly IndentationSizeEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<IndentationSizeEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="IndentationSizeEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly IndentationSizeEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<IndentationSizeEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(IndentationSizeEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<IndentationSizeEntity, Mutable>(this);
            }
        }
    }
}
