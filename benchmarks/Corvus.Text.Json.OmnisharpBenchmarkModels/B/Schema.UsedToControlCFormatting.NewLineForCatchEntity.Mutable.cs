    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct NewLineForCatchEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(NewLineForCatchEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="NewLineForCatchEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator NewLineForCatchEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"NewLineForCatchEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly NewLineForCatchEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly NewLineForCatchEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<NewLineForCatchEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(NewLineForCatchEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<NewLineForCatchEntity, Mutable>(this);
            }
        }
    }
}
