...
public readonly partial struct Schema
{
    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct NewLineForMembersInObjectInitEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(NewLineForMembersInObjectInitEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="NewLineForMembersInObjectInitEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator NewLineForMembersInObjectInitEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new NewLineForMembersInObjectInitEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"NewLineForMembersInObjectInitEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="NewLineForMembersInObjectInitEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="NewLineForMembersInObjectInitEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly NewLineForMembersInObjectInitEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<NewLineForMembersInObjectInitEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="NewLineForMembersInObjectInitEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly NewLineForMembersInObjectInitEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<NewLineForMembersInObjectInitEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(NewLineForMembersInObjectInitEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<NewLineForMembersInObjectInitEntity, Mutable>(this);
            }
        }
    }
}
