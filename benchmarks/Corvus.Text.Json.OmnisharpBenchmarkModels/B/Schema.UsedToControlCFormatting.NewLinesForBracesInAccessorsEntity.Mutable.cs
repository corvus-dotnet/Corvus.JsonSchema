...
public readonly partial struct Schema
{
    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct NewLinesForBracesInAccessorsEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(NewLinesForBracesInAccessorsEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="NewLinesForBracesInAccessorsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator NewLinesForBracesInAccessorsEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new NewLinesForBracesInAccessorsEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"NewLinesForBracesInAccessorsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="NewLinesForBracesInAccessorsEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="NewLinesForBracesInAccessorsEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly NewLinesForBracesInAccessorsEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<NewLinesForBracesInAccessorsEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="NewLinesForBracesInAccessorsEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly NewLinesForBracesInAccessorsEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<NewLinesForBracesInAccessorsEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(NewLinesForBracesInAccessorsEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<NewLinesForBracesInAccessorsEntity, Mutable>(this);
            }
        }
    }
}
