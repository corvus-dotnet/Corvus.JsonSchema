...
public readonly partial struct Schema
{
    ...
    public readonly partial struct UsedToControlCFormatting
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="SpaceBeforeColonInBaseTypeDeclarationEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal SpaceBeforeColonInBaseTypeDeclarationEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static SpaceBeforeColonInBaseTypeDeclarationEntity DefaultInstance { get; } = ParsedJsonDocument<SpaceBeforeColonInBaseTypeDeclarationEntity>.True;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(SpaceBeforeColonInBaseTypeDeclarationEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in SpaceBeforeColonInBaseTypeDeclarationEntity left, in SpaceBeforeColonInBaseTypeDeclarationEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in SpaceBeforeColonInBaseTypeDeclarationEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(SpaceBeforeColonInBaseTypeDeclarationEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SpaceBeforeColonInBaseTypeDeclarationEntity(JsonElement instance)
            {
                return SpaceBeforeColonInBaseTypeDeclarationEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpaceBeforeColonInBaseTypeDeclarationEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpaceBeforeColonInBaseTypeDeclarationEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SpaceBeforeColonInBaseTypeDeclarationEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpaceBeforeColonInBaseTypeDeclarationEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SpaceBeforeColonInBaseTypeDeclarationEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpaceBeforeColonInBaseTypeDeclarationEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SpaceBeforeColonInBaseTypeDeclarationEntity>(json, options);
            }
            ...
            /// </exception>
            public static SpaceBeforeColonInBaseTypeDeclarationEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<SpaceBeforeColonInBaseTypeDeclarationEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out SpaceBeforeColonInBaseTypeDeclarationEntity? result)
            {
                return JsonElementHelpers.TryParseValue<SpaceBeforeColonInBaseTypeDeclarationEntity>(ref reader, out result);
            }
...
#if NET
            static SpaceBeforeColonInBaseTypeDeclarationEntity IJsonElement<SpaceBeforeColonInBaseTypeDeclarationEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SpaceBeforeColonInBaseTypeDeclarationEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public SpaceBeforeColonInBaseTypeDeclarationEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public SpaceBeforeColonInBaseTypeDeclarationEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<SpaceBeforeColonInBaseTypeDeclarationEntity>(_idx);
                }
