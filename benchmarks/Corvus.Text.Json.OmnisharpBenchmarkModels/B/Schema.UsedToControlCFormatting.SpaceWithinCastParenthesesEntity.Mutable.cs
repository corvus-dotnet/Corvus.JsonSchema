    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct SpaceWithinCastParenthesesEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(SpaceWithinCastParenthesesEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SpaceWithinCastParenthesesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SpaceWithinCastParenthesesEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new SpaceWithinCastParenthesesEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SpaceWithinCastParenthesesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="SpaceWithinCastParenthesesEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="SpaceWithinCastParenthesesEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly SpaceWithinCastParenthesesEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<SpaceWithinCastParenthesesEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="SpaceWithinCastParenthesesEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly SpaceWithinCastParenthesesEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SpaceWithinCastParenthesesEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SpaceWithinCastParenthesesEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<SpaceWithinCastParenthesesEntity, Mutable>(this);
            }
        }
    }
}
