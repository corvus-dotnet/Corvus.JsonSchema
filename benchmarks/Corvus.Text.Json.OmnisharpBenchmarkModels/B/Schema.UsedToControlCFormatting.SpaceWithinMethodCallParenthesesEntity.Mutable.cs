    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct SpaceWithinMethodCallParenthesesEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(SpaceWithinMethodCallParenthesesEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SpaceWithinMethodCallParenthesesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SpaceWithinMethodCallParenthesesEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SpaceWithinMethodCallParenthesesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly SpaceWithinMethodCallParenthesesEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly SpaceWithinMethodCallParenthesesEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SpaceWithinMethodCallParenthesesEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SpaceWithinMethodCallParenthesesEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<SpaceWithinMethodCallParenthesesEntity, Mutable>(this);
            }
        }
    }
}
