    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct SpaceWithinSquareBracketsEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(SpaceWithinSquareBracketsEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SpaceWithinSquareBracketsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SpaceWithinSquareBracketsEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SpaceWithinSquareBracketsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly SpaceWithinSquareBracketsEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly SpaceWithinSquareBracketsEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SpaceWithinSquareBracketsEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SpaceWithinSquareBracketsEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<SpaceWithinSquareBracketsEntity, Mutable>(this);
            }
        }
    }
}
