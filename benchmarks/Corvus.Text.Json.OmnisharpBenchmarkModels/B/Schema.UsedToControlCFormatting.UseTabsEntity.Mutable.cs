    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct UseTabsEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(UseTabsEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="UseTabsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator UseTabsEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"UseTabsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly UseTabsEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly UseTabsEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<UseTabsEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(UseTabsEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<UseTabsEntity, Mutable>(this);
            }
        }
    }
}
