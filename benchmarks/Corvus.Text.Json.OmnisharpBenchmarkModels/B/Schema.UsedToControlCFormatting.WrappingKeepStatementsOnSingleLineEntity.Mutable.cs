    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct WrappingKeepStatementsOnSingleLineEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(WrappingKeepStatementsOnSingleLineEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="WrappingKeepStatementsOnSingleLineEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator WrappingKeepStatementsOnSingleLineEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"WrappingKeepStatementsOnSingleLineEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly WrappingKeepStatementsOnSingleLineEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly WrappingKeepStatementsOnSingleLineEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<WrappingKeepStatementsOnSingleLineEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(WrappingKeepStatementsOnSingleLineEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<WrappingKeepStatementsOnSingleLineEntity, Mutable>(this);
            }
        }
    }
}
