...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCakeCakeFiles Cake
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CakeUtf8, out Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCakeCakeFiles value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.OmnisharpBenchmark.Baseline.Schema.FileOptionsEntity FileOptions
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FileOptionsUtf8, out Corvus.OmnisharpBenchmark.Baseline.Schema.FileOptionsEntity value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToControlCFormatting FormattingOptions
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FormattingOptionsUtf8, out Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToControlCFormatting value))
            {
                return value;
            }
    ...
    /// </summary>
    public Corvus.OmnisharpBenchmark.Baseline.Schema.ImplementTypeOptionsEntity ImplementTypeOptions
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ImplementTypeOptionsUtf8, out Corvus.OmnisharpBenchmark.Baseline.Schema.ImplementTypeOptionsEntity value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureMsBuildSolutionsAndProjects Msbuild
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MsbuildUtf8, out Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureMsBuildSolutionsAndProjects value))
            {
                return value;
            }
    ...
    /// </summary>
    public Corvus.OmnisharpBenchmark.Baseline.Schema.PluginsEntity Plugins
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PluginsUtf8, out Corvus.OmnisharpBenchmark.Baseline.Schema.PluginsEntity value))
            {
                return value;
            }
    ...
    /// </summary>
    public Corvus.OmnisharpBenchmark.Baseline.Schema.RenameOptionsEntity RenameOptions
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RenameOptionsUtf8, out Corvus.OmnisharpBenchmark.Baseline.Schema.RenameOptionsEntity value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.OmnisharpBenchmark.Baseline.Schema.RoslynExtensionsOptionsEntity RoslynExtensionsOptions
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RoslynExtensionsOptionsUtf8, out Corvus.OmnisharpBenchmark.Baseline.Schema.RoslynExtensionsOptionsEntity value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCScriptingCsxFiles Script
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ScriptUtf8, out Corvus.OmnisharpBenchmark.Baseline.Schema.UsedToConfigureCScriptingCsxFiles value))
            {
                return value;
            }
