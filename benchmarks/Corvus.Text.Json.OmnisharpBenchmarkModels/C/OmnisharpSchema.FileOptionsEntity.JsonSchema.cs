...
public readonly partial struct OmnisharpSchema
{
    ...
    public readonly partial struct FileOptionsEntity
        : IJsonElement<FileOptionsEntity>
    {
        public static partial class JsonSchema
        {
            private static readonly JsonSchemaPathProvider ExcludeSearchPatternsSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/ExcludeSearchPatterns"u8, buffer, out written);
            private static readonly JsonSchemaPathProvider SystemExcludeSearchPatternsSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/SystemExcludeSearchPatterns"u8, buffer, out written);

            private static void MatchExcludeSearchPatterns(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext =
                    Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.FileOptionsEntity.JsonStringArray.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.ExcludeSearchPatternsUtf8,
                        evaluationPath: ExcludeSearchPatternsSchemaEvaluationPath);

                Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.FileOptionsEntity.JsonStringArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                context.CommitChildContext(childContext.IsMatch, ref childContext);
            }

            private static void MatchSystemExcludeSearchPatterns(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext1 =
                    Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.FileOptionsEntity.RecommendeArray.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.SystemExcludeSearchPatternsUtf8,
                        evaluationPath: SystemExcludeSearchPatternsSchemaEvaluationPath);

                Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.FileOptionsEntity.RecommendeArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
            ...
            private static PropertySchemaMatchers<Corvus.OmnisharpBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
            {
                return new PropertySchemaMatchers<Corvus.OmnisharpBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator>([
                    (static () => JsonPropertyNames.ExcludeSearchPatternsUtf8, MatchExcludeSearchPatterns),
                    (static () => JsonPropertyNames.SystemExcludeSearchPatternsUtf8, MatchSystemExcludeSearchPatterns),
                ]);
            }
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://json.schemastore.org/omnisharp.json#/properties/FileOptions"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "https://json.schemastore.org/omnisharp.json#/properties/FileOptions";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://json.schemastore.org/omnisharp.json#/properties/FileOptions"u8;
