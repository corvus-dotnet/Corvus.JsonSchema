...
public readonly partial struct OmnisharpSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FileOptionsEntity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal FileOptionsEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static FileOptionsEntity DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.FileOptionsEntity.JsonStringArray ExcludeSearchPatterns
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExcludeSearchPatternsUtf8, out Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.FileOptionsEntity.JsonStringArray value))
                {
                    return value;
                }

                return Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.FileOptionsEntity.JsonStringArray.DefaultInstance;
            }
        }
        ...
        /// </para>
        /// </remarks>
        public Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.FileOptionsEntity.RecommendeArray SystemExcludeSearchPatterns
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SystemExcludeSearchPatternsUtf8, out Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.FileOptionsEntity.RecommendeArray value))
                {
                    return value;
                }

                return Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.FileOptionsEntity.RecommendeArray.DefaultInstance;
            }
        }
        ...
        /// </returns>
        public static bool operator ==(in FileOptionsEntity left, in FileOptionsEntity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in FileOptionsEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(FileOptionsEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator FileOptionsEntity(JsonElement instance)
        {
            return FileOptionsEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static FileOptionsEntity From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static FileOptionsEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<FileOptionsEntity>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static FileOptionsEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<FileOptionsEntity>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static FileOptionsEntity ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<FileOptionsEntity>(json, options);
        }
        ...
        /// </exception>
        public static FileOptionsEntity ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<FileOptionsEntity>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out FileOptionsEntity? result)
        {
            return JsonElementHelpers.TryParseValue<FileOptionsEntity>(ref reader, out result);
        }
...
#if NET
        static FileOptionsEntity IJsonElement<FileOptionsEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"FileOptionsEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public FileOptionsEntity Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public FileOptionsEntity Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<FileOptionsEntity>(_idx);
            }
        ...
        {
            /// <summary>
            /// Gets the JSON property name for <see cref="ExcludeSearchPatterns"/>.
            /// </summary>
            public const string ExcludeSearchPatterns = "ExcludeSearchPatterns";

            /// <summary>
            /// Gets the JSON property name for <see cref="SystemExcludeSearchPatterns"/>.
            /// </summary>
            public const string SystemExcludeSearchPatterns = "SystemExcludeSearchPatterns";

            /// <summary>
            /// Gets the JSON property name for <see cref="ExcludeSearchPatterns"/>.
            /// </summary>
            public static ReadOnlySpan<byte> ExcludeSearchPatternsUtf8 => "ExcludeSearchPatterns"u8;

            /// <summary>
            /// Gets the JSON property name for <see cref="SystemExcludeSearchPatterns"/>.
            /// </summary>
            public static ReadOnlySpan<byte> SystemExcludeSearchPatternsUtf8 => "SystemExcludeSearchPatterns"u8;
        }
        ...
        {
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="ExcludeSearchPatterns"/>.
            /// </summary>
            public static ReadOnlySpan<byte> ExcludeSearchPatterns => "ExcludeSearchPatterns"u8;

            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="SystemExcludeSearchPatterns"/>.
            /// </summary>
            public static ReadOnlySpan<byte> SystemExcludeSearchPatterns => "SystemExcludeSearchPatterns"u8;
        }
        ...
        {
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="ExcludeSearchPatterns"/>.
            /// </summary>
            public static ReadOnlySpan<byte> ExcludeSearchPatterns => [0x75, 0x01, 0x00, 0x00, 0x22, 0x45, 0x78, 0x63, 0x6C, 0x75, 0x64, 0x65, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x50, 0x61, 0x74, 0x74, 0x65, 0x72, 0x6E, 0x73, 0x22];

            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="SystemExcludeSearchPatterns"/>.
            /// </summary>
            public static ReadOnlySpan<byte> SystemExcludeSearchPatterns => [0xD5, 0x01, 0x00, 0x00, 0x22, 0x53, 0x79, 0x73, 0x74, 0x65, 0x6D, 0x45, 0x78, 0x63, 0x6C, 0x75, 0x64, 0x65, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x50, 0x61, 0x74, 0x74, 0x65, 0x72, 0x6E, 0x73, 0x22];
        }
    }
}
