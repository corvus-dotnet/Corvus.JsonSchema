    ...
    public readonly partial struct ImplementTypeOptionsEntity
    {
        ...
        public readonly partial struct InsertionBehaviorEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<InsertionBehaviorEntity, Mutable>(InsertionBehaviorEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(InsertionBehaviorEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="InsertionBehaviorEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator InsertionBehaviorEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"InsertionBehaviorEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly InsertionBehaviorEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly InsertionBehaviorEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<InsertionBehaviorEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(InsertionBehaviorEntity instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (InsertionBehaviorEntity)value;
            ...
            {
                return workspace.CreateBuilder<InsertionBehaviorEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<InsertionBehaviorEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<InsertionBehaviorEntity>();
                }
                finally
                {
