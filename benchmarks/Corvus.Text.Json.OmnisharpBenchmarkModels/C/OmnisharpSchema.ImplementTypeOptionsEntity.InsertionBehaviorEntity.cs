...
public readonly partial struct OmnisharpSchema
{
    ...
    public readonly partial struct ImplementTypeOptionsEntity
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="InsertionBehaviorEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal InsertionBehaviorEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static InsertionBehaviorEntity DefaultInstance { get; } = ParsedJsonDocument<InsertionBehaviorEntity>.StringConstant([.."\"WithOtherMembersOfTheSameKind\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(InsertionBehaviorEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in InsertionBehaviorEntity left, in InsertionBehaviorEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in InsertionBehaviorEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(InsertionBehaviorEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator InsertionBehaviorEntity(JsonElement instance)
            {
                return InsertionBehaviorEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static InsertionBehaviorEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static InsertionBehaviorEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<InsertionBehaviorEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static InsertionBehaviorEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<InsertionBehaviorEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static InsertionBehaviorEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<InsertionBehaviorEntity>(json, options);
            }
            ...
            /// </exception>
            public static InsertionBehaviorEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<InsertionBehaviorEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out InsertionBehaviorEntity? result)
            {
                return JsonElementHelpers.TryParseValue<InsertionBehaviorEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new InsertionBehaviorEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static InsertionBehaviorEntity IJsonElement<InsertionBehaviorEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"InsertionBehaviorEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="InsertionBehaviorEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="InsertionBehaviorEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public InsertionBehaviorEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<InsertionBehaviorEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="InsertionBehaviorEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public InsertionBehaviorEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<InsertionBehaviorEntity>(_idx);
                }
            ...
            /// <param name="matchWithOtherMembersOfTheSameKind">Match 1st item.</param>
            /// <param name="matchAtTheEnd">Match 2nd item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchWithOtherMembersOfTheSameKind,
                Func<TContext, TResult> matchAtTheEnd,
...
#endif
            {
                ...
                {
                    return matchWithOtherMembersOfTheSameKind(context);
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchAtTheEnd(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchWithOtherMembersOfTheSameKind,
                Func<TResult> matchAtTheEnd,
                Func<TResult> defaultMatch)
            {
                if (this.ValueEquals(Constants.Enum1))
                {
                    return matchWithOtherMembersOfTheSameKind();
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchAtTheEnd();
                }
