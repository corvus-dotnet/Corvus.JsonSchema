...
public readonly partial struct OmnisharpSchema
{
        ...
        : IJsonElement<ImplementTypeOptionsEntity>
    {
        public static partial class JsonSchema
        {
            ...
            private static void MatchInsertionBehavior(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext =
                    Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.ImplementTypeOptionsEntity.InsertionBehaviorEntity.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.ImplementTypeOptionsEntity.InsertionBehaviorEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                context.CommitChildContext(childContext.IsMatch, ref childContext);
            }

            private static void MatchPropertyGenerationBehavior(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext1 =
                    Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.ImplementTypeOptionsEntity.PropertyGenerationBehaviorEntity.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.ImplementTypeOptionsEntity.PropertyGenerationBehaviorEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/properties/ImplementTypeOptions"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/properties/ImplementTypeOptions";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/properties/ImplementTypeOptions"u8;
