...
public readonly partial struct OmnisharpSchema
{
    ...
    public readonly partial struct ImplementTypeOptionsEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ImplementTypeOptionsEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ImplementTypeOptionsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ImplementTypeOptionsEntity(Mutable instance)
            {
            ...
            /// <summary>
            /// Gets the (optional) <c>InsertionBehavior</c> property.
            /// </summary>
            public Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.ImplementTypeOptionsEntity.InsertionBehaviorEntity.Mutable InsertionBehavior
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.InsertionBehaviorUtf8, out Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.ImplementTypeOptionsEntity.InsertionBehaviorEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// <summary>
            /// Gets the (optional) <c>PropertyGenerationBehavior</c> property.
            /// </summary>
            public Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.ImplementTypeOptionsEntity.PropertyGenerationBehaviorEntity.Mutable PropertyGenerationBehavior
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PropertyGenerationBehaviorUtf8, out Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.ImplementTypeOptionsEntity.PropertyGenerationBehaviorEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ImplementTypeOptionsEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetInsertionBehavior(scoped in Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.ImplementTypeOptionsEntity.InsertionBehaviorEntity.Source value)
            {
                ...
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.InsertionBehaviorUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.InsertionBehaviorUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
            ...
            /// <summary>
            /// Remove the <c>InsertionBehavior</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveInsertionBehavior()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.InsertionBehaviorUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            public void SetPropertyGenerationBehavior(scoped in Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.ImplementTypeOptionsEntity.PropertyGenerationBehaviorEntity.Source value)
            {
                ...
                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.PropertyGenerationBehaviorUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PropertyGenerationBehaviorUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            /// <summary>
            /// Remove the <c>PropertyGenerationBehavior</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemovePropertyGenerationBehavior()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.PropertyGenerationBehaviorUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ImplementTypeOptionsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ImplementTypeOptionsEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ImplementTypeOptionsEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly ImplementTypeOptionsEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ImplementTypeOptionsEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ImplementTypeOptionsEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly ImplementTypeOptionsEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ImplementTypeOptionsEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.ImplementTypeOptionsEntity.InsertionBehaviorEntity.Source _createArg1;
            private readonly Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.ImplementTypeOptionsEntity.PropertyGenerationBehaviorEntity.Source _createArg2;
            ...
            public static implicit operator Source(ImplementTypeOptionsEntity instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.ImplementTypeOptionsEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="ImplementTypeOptionsEntity"/>.
            /// </summary>
            ...
            /// Creates an instance of a <see cref="ImplementTypeOptionsEntity"/>.
            /// </summary>
            public void Create(in Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.ImplementTypeOptionsEntity.InsertionBehaviorEntity.Source insertionBehavior = default, in Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.ImplementTypeOptionsEntity.PropertyGenerationBehaviorEntity.Source propertyGenerationBehavior = default)
            {
                Create(ref _builder, insertionBehavior, propertyGenerationBehavior);
            }
        ...
        /// </summary>
        /// <param name="workspace">The JSON workspace.</param>
        /// <param name="insertionBehavior">The value of the property.</param>
        /// <param name="propertyGenerationBehavior">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.ImplementTypeOptionsEntity.InsertionBehaviorEntity.Source insertionBehavior = default, in Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.ImplementTypeOptionsEntity.PropertyGenerationBehaviorEntity.Source propertyGenerationBehavior = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(insertionBehavior, propertyGenerationBehavior);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<ImplementTypeOptionsEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ImplementTypeOptionsEntity> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ImplementTypeOptionsEntity>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ImplementTypeOptionsEntity> Create<TContext>(
        ...
        public static ParsedJsonDocument<ImplementTypeOptionsEntity> Create(in Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.ImplementTypeOptionsEntity.InsertionBehaviorEntity.Source insertionBehavior = default, in Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.ImplementTypeOptionsEntity.PropertyGenerationBehaviorEntity.Source propertyGenerationBehavior = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
