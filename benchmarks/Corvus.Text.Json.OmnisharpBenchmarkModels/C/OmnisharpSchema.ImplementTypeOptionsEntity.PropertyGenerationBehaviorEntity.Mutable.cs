    ...
    public readonly partial struct ImplementTypeOptionsEntity
    {
        ...
        public readonly partial struct PropertyGenerationBehaviorEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<PropertyGenerationBehaviorEntity, Mutable>(PropertyGenerationBehaviorEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(PropertyGenerationBehaviorEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="PropertyGenerationBehaviorEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator PropertyGenerationBehaviorEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"PropertyGenerationBehaviorEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly PropertyGenerationBehaviorEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly PropertyGenerationBehaviorEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<PropertyGenerationBehaviorEntity>(_idx);
                }
                ...
                public bool TryGetKnownValue(out KnownValues result)
                {
                    if (this.ValueEquals(Constants.Enum1))
                    {
                        result = KnownValues.PreferThrowingProperties;
                        return true;
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        result = KnownValues.PreferAutoProperties;
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(PropertyGenerationBehaviorEntity instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (PropertyGenerationBehaviorEntity)value;
            ...
            {
                return workspace.CreateBuilder<PropertyGenerationBehaviorEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<PropertyGenerationBehaviorEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<PropertyGenerationBehaviorEntity>();
                }
                finally
                {
