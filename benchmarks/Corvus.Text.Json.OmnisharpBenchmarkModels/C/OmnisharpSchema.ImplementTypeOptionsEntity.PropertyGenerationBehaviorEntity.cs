...
public readonly partial struct OmnisharpSchema
{
    ...
    public readonly partial struct ImplementTypeOptionsEntity
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="PropertyGenerationBehaviorEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal PropertyGenerationBehaviorEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static PropertyGenerationBehaviorEntity DefaultInstance { get; } = ParsedJsonDocument<PropertyGenerationBehaviorEntity>.StringConstant([.."\"PreferThrowingProperties\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(PropertyGenerationBehaviorEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in PropertyGenerationBehaviorEntity left, in PropertyGenerationBehaviorEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in PropertyGenerationBehaviorEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(PropertyGenerationBehaviorEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PropertyGenerationBehaviorEntity(JsonElement instance)
            {
                return PropertyGenerationBehaviorEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PropertyGenerationBehaviorEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PropertyGenerationBehaviorEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PropertyGenerationBehaviorEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PropertyGenerationBehaviorEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PropertyGenerationBehaviorEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PropertyGenerationBehaviorEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PropertyGenerationBehaviorEntity>(json, options);
            }
            ...
            /// </exception>
            public static PropertyGenerationBehaviorEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<PropertyGenerationBehaviorEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out PropertyGenerationBehaviorEntity? result)
            {
                return JsonElementHelpers.TryParseValue<PropertyGenerationBehaviorEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new PropertyGenerationBehaviorEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static PropertyGenerationBehaviorEntity IJsonElement<PropertyGenerationBehaviorEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PropertyGenerationBehaviorEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="PropertyGenerationBehaviorEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="PropertyGenerationBehaviorEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public PropertyGenerationBehaviorEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<PropertyGenerationBehaviorEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="PropertyGenerationBehaviorEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public PropertyGenerationBehaviorEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<PropertyGenerationBehaviorEntity>(_idx);
                }
            ...
            /// <param name="matchPreferThrowingProperties">Match 1st item.</param>
            /// <param name="matchPreferAutoProperties">Match 2nd item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchPreferThrowingProperties,
                Func<TContext, TResult> matchPreferAutoProperties,
...
#endif
            {
                ...
                {
                    return matchPreferThrowingProperties(context);
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchPreferAutoProperties(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchPreferThrowingProperties,
                Func<TResult> matchPreferAutoProperties,
                Func<TResult> defaultMatch)
            {
                if (this.ValueEquals(Constants.Enum1))
                {
                    return matchPreferThrowingProperties();
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchPreferAutoProperties();
                }
