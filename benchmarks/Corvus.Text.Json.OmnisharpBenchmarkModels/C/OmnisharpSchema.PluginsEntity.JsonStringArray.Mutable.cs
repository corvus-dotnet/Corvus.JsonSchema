    ...
    public readonly partial struct PluginsEntity
    {
        ...
        public readonly partial struct JsonStringArray
        {
...
#endif
            {
                ...
                public Corvus.OmnisharpBenchmark.Current.JsonString.Mutable this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.OmnisharpBenchmark.Current.JsonString.Mutable>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.OmnisharpBenchmark.Current.JsonString.Mutable> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.OmnisharpBenchmark.Current.JsonString.Mutable>(_parent, _idx);
                }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetItem(int itemIndex, in Corvus.OmnisharpBenchmark.Current.JsonString.Source value)
                {
                    CheckValidInstance();
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Remove(in Corvus.OmnisharpBenchmark.Current.JsonString item)
                {
                    CheckValidInstance();
                    if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.OmnisharpBenchmark.Current.JsonString>(this, in item))
                    {
                        return false;
                    }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void RemoveWhere(JsonPredicate<Corvus.OmnisharpBenchmark.Current.JsonString> predicate)
                {
                    CheckValidInstance();
                    JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.OmnisharpBenchmark.Current.JsonString>(this, predicate);
                    _documentVersion = _parent.Version;
                }
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Replace(in Corvus.OmnisharpBenchmark.Current.JsonString oldItem, in Corvus.OmnisharpBenchmark.Current.JsonString.Source newItem)
                {
                    CheckValidInstance();
                    ...
                    var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.OmnisharpBenchmark.Current.JsonString>(_parent, _idx);

                    while (enumerator.MoveNext())
                    {
                        Corvus.OmnisharpBenchmark.Current.JsonString current = enumerator.Current;
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.PluginsEntity.JsonStringArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.PluginsEntity.JsonStringArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
