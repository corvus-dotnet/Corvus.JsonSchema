...
public readonly partial struct OmnisharpSchema
{
...
#endif
    {
        ...
        /// </summary>
        public Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.PluginsEntity.JsonStringArray LocationPaths
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LocationPathsUtf8, out Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.PluginsEntity.JsonStringArray value))
                {
                    return value;
                }

                return Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.PluginsEntity.JsonStringArray.DefaultInstance;
            }
        }
