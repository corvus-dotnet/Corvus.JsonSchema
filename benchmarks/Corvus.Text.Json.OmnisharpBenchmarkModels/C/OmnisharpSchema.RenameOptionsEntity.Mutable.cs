...
public readonly partial struct OmnisharpSchema
{
    ...
    public readonly partial struct RenameOptionsEntity
    {
...
#endif
        {
            ...
            /// </summary>
            public Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.RenameOptionsEntity.RenameInCommentsEntity.Mutable RenameInComments
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RenameInCommentsUtf8, out Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.RenameOptionsEntity.RenameInCommentsEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.RenameOptionsEntity.RenameInStringsEntity.Mutable RenameInStrings
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RenameInStringsUtf8, out Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.RenameOptionsEntity.RenameInStringsEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.RenameOptionsEntity.RenameOverloadsEntity.Mutable RenameOverloads
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RenameOverloadsUtf8, out Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.RenameOptionsEntity.RenameOverloadsEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetRenameInComments(scoped in Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.RenameOptionsEntity.RenameInCommentsEntity.Source value)
            {
                ...
                else
                {
                    ...
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.RenameInComments, ref cvb);
            ...
            public void SetRenameInStrings(scoped in Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.RenameOptionsEntity.RenameInStringsEntity.Source value)
            {
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.RenameInStrings, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            public void SetRenameOverloads(scoped in Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.RenameOptionsEntity.RenameOverloadsEntity.Source value)
            {
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.RenameOverloads, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.RenameOptionsEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.RenameOptionsEntity.RenameInCommentsEntity.Source renameInComments = default,
                in Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.RenameOptionsEntity.RenameInStringsEntity.Source renameInStrings = default,
                in Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.RenameOptionsEntity.RenameOverloadsEntity.Source renameOverloads = default)
            {
                renameInComments.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.RenameInComments, ref builder);
                renameInStrings.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.RenameInStrings, ref builder);
                renameOverloads.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.RenameOverloads, ref builder);
            }
        ...
        public static ParsedJsonDocument<RenameOptionsEntity> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<RenameOptionsEntity>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<RenameOptionsEntity> Create<TContext>(
        ...
        public static ParsedJsonDocument<RenameOptionsEntity> Create(in Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.RenameOptionsEntity.RenameInCommentsEntity.Source renameInComments = default, in Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.RenameOptionsEntity.RenameInStringsEntity.Source renameInStrings = default, in Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.RenameOptionsEntity.RenameOverloadsEntity.Source renameOverloads = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
