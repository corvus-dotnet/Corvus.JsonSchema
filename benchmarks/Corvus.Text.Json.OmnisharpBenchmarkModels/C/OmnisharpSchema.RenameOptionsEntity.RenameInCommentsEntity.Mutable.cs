    ...
    public readonly partial struct RenameOptionsEntity
    {
        ...
        public readonly partial struct RenameInCommentsEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<RenameInCommentsEntity, Mutable>(RenameInCommentsEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(RenameInCommentsEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RenameInCommentsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RenameInCommentsEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RenameInCommentsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RenameInCommentsEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RenameInCommentsEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RenameInCommentsEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RenameInCommentsEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RenameInCommentsEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RenameInCommentsEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RenameInCommentsEntity>();
                }
                finally
                {
