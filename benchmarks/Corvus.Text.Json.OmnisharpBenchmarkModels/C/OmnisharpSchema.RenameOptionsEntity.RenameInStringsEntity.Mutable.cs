    ...
    public readonly partial struct RenameOptionsEntity
    {
        ...
        public readonly partial struct RenameInStringsEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<RenameInStringsEntity, Mutable>(RenameInStringsEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(RenameInStringsEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RenameInStringsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RenameInStringsEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RenameInStringsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RenameInStringsEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RenameInStringsEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RenameInStringsEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RenameInStringsEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RenameInStringsEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RenameInStringsEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RenameInStringsEntity>();
                }
                finally
                {
