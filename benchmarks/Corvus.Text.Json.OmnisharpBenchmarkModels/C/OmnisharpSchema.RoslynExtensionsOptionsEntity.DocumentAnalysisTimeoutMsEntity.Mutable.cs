    ...
    public readonly partial struct RoslynExtensionsOptionsEntity
    {
        ...
        public readonly partial struct DocumentAnalysisTimeoutMsEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DocumentAnalysisTimeoutMsEntity, Mutable>(DocumentAnalysisTimeoutMsEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(DocumentAnalysisTimeoutMsEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DocumentAnalysisTimeoutMsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DocumentAnalysisTimeoutMsEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DocumentAnalysisTimeoutMsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly DocumentAnalysisTimeoutMsEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly DocumentAnalysisTimeoutMsEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DocumentAnalysisTimeoutMsEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(DocumentAnalysisTimeoutMsEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<DocumentAnalysisTimeoutMsEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<DocumentAnalysisTimeoutMsEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<DocumentAnalysisTimeoutMsEntity>();
                }
                finally
                {
