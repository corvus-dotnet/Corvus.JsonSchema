...
public readonly partial struct OmnisharpSchema
{
    ...
    public readonly partial struct RoslynExtensionsOptionsEntity
    {
        ...
        public readonly partial struct EnableDecompilationSupportEntity
#if NET8_0_OR_GREATER
            : IJsonElement<EnableDecompilationSupportEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="EnableDecompilationSupportEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal EnableDecompilationSupportEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static EnableDecompilationSupportEntity DefaultInstance { get; } = ParsedJsonDocument<EnableDecompilationSupportEntity>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(EnableDecompilationSupportEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in EnableDecompilationSupportEntity left, in EnableDecompilationSupportEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in EnableDecompilationSupportEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(EnableDecompilationSupportEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EnableDecompilationSupportEntity(JsonElement instance)
            {
                return EnableDecompilationSupportEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EnableDecompilationSupportEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EnableDecompilationSupportEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EnableDecompilationSupportEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EnableDecompilationSupportEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EnableDecompilationSupportEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EnableDecompilationSupportEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EnableDecompilationSupportEntity>(json, options);
            }
            ...
            /// </exception>
            public static EnableDecompilationSupportEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<EnableDecompilationSupportEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out EnableDecompilationSupportEntity? result)
            {
                return JsonElementHelpers.TryParseValue<EnableDecompilationSupportEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new EnableDecompilationSupportEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static EnableDecompilationSupportEntity IJsonElement<EnableDecompilationSupportEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EnableDecompilationSupportEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="EnableDecompilationSupportEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="EnableDecompilationSupportEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public EnableDecompilationSupportEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<EnableDecompilationSupportEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="EnableDecompilationSupportEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public EnableDecompilationSupportEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<EnableDecompilationSupportEntity>(_idx);
                }
