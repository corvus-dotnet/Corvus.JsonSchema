    ...
    public readonly partial struct RoslynExtensionsOptionsEntity
    {
        ...
        public readonly partial struct IfSetToFalseOnlyRefactoringsAreAvailable
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<IfSetToFalseOnlyRefactoringsAreAvailable, Mutable>(IfSetToFalseOnlyRefactoringsAreAvailable.DefaultInstance);
                ...
                public static explicit operator Mutable(IfSetToFalseOnlyRefactoringsAreAvailable instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="IfSetToFalseOnlyRefactoringsAreAvailable"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator IfSetToFalseOnlyRefactoringsAreAvailable(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"IfSetToFalseOnlyRefactoringsAreAvailable.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly IfSetToFalseOnlyRefactoringsAreAvailable Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly IfSetToFalseOnlyRefactoringsAreAvailable Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<IfSetToFalseOnlyRefactoringsAreAvailable>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(IfSetToFalseOnlyRefactoringsAreAvailable instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<IfSetToFalseOnlyRefactoringsAreAvailable, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<IfSetToFalseOnlyRefactoringsAreAvailable> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<IfSetToFalseOnlyRefactoringsAreAvailable>();
                }
                finally
                {
