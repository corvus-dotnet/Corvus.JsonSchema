...
public readonly partial struct OmnisharpSchema
{
    ...
    public readonly partial struct RoslynExtensionsOptionsEntity
    {
        ...
        public readonly partial struct LocationPathsArray
#if NET8_0_OR_GREATER
            : IJsonElement<LocationPathsArray>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="LocationPathsArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal LocationPathsArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static LocationPathsArray DefaultInstance { get; } = ParsedJsonDocument<LocationPathsArray>.Null;
            ...
            /// </returns>
            public static bool operator ==(in LocationPathsArray left, in LocationPathsArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in LocationPathsArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(LocationPathsArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator LocationPathsArray(JsonElement instance)
            {
                return LocationPathsArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LocationPathsArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LocationPathsArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<LocationPathsArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LocationPathsArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<LocationPathsArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LocationPathsArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<LocationPathsArray>(json, options);
            }
            ...
            /// </exception>
            public static LocationPathsArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<LocationPathsArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out LocationPathsArray? result)
            {
                return JsonElementHelpers.TryParseValue<LocationPathsArray>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new LocationPathsArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static LocationPathsArray IJsonElement<LocationPathsArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"LocationPathsArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="LocationPathsArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="LocationPathsArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public LocationPathsArray Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<LocationPathsArray>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="LocationPathsArray"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public LocationPathsArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<LocationPathsArray>(_idx);
                }
