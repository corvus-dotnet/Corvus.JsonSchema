    ...
    public readonly partial struct UsedToConfigureCScriptingCsxFiles
    {
        ...
        public readonly partial struct DefaultTargetFrameworkEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DefaultTargetFrameworkEntity, Mutable>(DefaultTargetFrameworkEntity.DefaultInstance);
                ...
                public static explicit operator Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCScriptingCsxFiles.DefaultTargetFrameworkEntity.AnyOf0Entity.Mutable(Mutable value)
                {
                    return Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCScriptingCsxFiles.DefaultTargetFrameworkEntity.AnyOf0Entity.Mutable.From(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCScriptingCsxFiles.DefaultTargetFrameworkEntity.AnyOf0Entity.Mutable value)
                {
                    return From(value);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCScriptingCsxFiles.DefaultTargetFrameworkEntity.Mutable, TContext, TResult> defaultMatch)
...
#endif
                {
                    ...
                    {
                        return matchAnyOf0Entity(Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCScriptingCsxFiles.DefaultTargetFrameworkEntity.AnyOf0Entity.Mutable.From(this), context);
                    }

                    if (Corvus.OmnisharpBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchJsonString(Corvus.OmnisharpBenchmark.Current.JsonString.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCScriptingCsxFiles.DefaultTargetFrameworkEntity.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCScriptingCsxFiles.DefaultTargetFrameworkEntity.AnyOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchAnyOf0Entity(Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCScriptingCsxFiles.DefaultTargetFrameworkEntity.AnyOf0Entity.Mutable.From(this));
                    }

                    if (Corvus.OmnisharpBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchJsonString(Corvus.OmnisharpBenchmark.Current.JsonString.Mutable.From(this));
                    }
                ...
                public TAccumulator MatchEvery<TAccumulator>(
                    ...
                    Matcher<Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCScriptingCsxFiles.DefaultTargetFrameworkEntity.Mutable, TAccumulator, TAccumulator> defaultMatch)
                {
                    bool matched = false;
                    ...
                    {
                        matched = true;
                        accumulator = matchAnyOf0Entity(Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCScriptingCsxFiles.DefaultTargetFrameworkEntity.AnyOf0Entity.Mutable.From(this), accumulator);
                    }

                    if (Corvus.OmnisharpBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                    {
                        matched = true;
                        accumulator = matchJsonString(Corvus.OmnisharpBenchmark.Current.JsonString.Mutable.From(this), accumulator);
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCScriptingCsxFiles.DefaultTargetFrameworkEntity.AnyOf0Entity.Mutable" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsAnyOf0Entity(out Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCScriptingCsxFiles.DefaultTargetFrameworkEntity.AnyOf0Entity.Mutable result)
                {
                    if (Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCScriptingCsxFiles.DefaultTargetFrameworkEntity.AnyOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCScriptingCsxFiles.DefaultTargetFrameworkEntity.AnyOf0Entity.Mutable.From(this);
                        return true;
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.OmnisharpBenchmark.Current.JsonString.Mutable" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsJsonString(out Corvus.OmnisharpBenchmark.Current.JsonString.Mutable result)
                {
                    if (Corvus.OmnisharpBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.OmnisharpBenchmark.Current.JsonString.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.OmnisharpBenchmark.Current.JsonString instance) => new(JsonElement.From(instance));

                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCScriptingCsxFiles.DefaultTargetFrameworkEntity.AnyOf0Entity instance) => new(JsonElement.From(instance));
            ...
            public static ParsedJsonDocument<DefaultTargetFrameworkEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<DefaultTargetFrameworkEntity>();
                }
                finally
                {
