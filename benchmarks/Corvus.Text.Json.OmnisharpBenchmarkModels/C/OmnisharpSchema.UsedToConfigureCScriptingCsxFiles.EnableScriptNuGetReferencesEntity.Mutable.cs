    ...
    public readonly partial struct UsedToConfigureCScriptingCsxFiles
    {
        ...
        public readonly partial struct EnableScriptNuGetReferencesEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<EnableScriptNuGetReferencesEntity, Mutable>(EnableScriptNuGetReferencesEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(EnableScriptNuGetReferencesEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="EnableScriptNuGetReferencesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator EnableScriptNuGetReferencesEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"EnableScriptNuGetReferencesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly EnableScriptNuGetReferencesEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly EnableScriptNuGetReferencesEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<EnableScriptNuGetReferencesEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(EnableScriptNuGetReferencesEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<EnableScriptNuGetReferencesEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<EnableScriptNuGetReferencesEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<EnableScriptNuGetReferencesEntity>();
                }
                finally
                {
