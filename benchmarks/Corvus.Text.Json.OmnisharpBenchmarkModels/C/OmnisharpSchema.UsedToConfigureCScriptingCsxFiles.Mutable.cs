...
public readonly partial struct OmnisharpSchema
{
    ...
    public readonly partial struct UsedToConfigureCScriptingCsxFiles
    {
...
#endif
        {
            ...
            /// </summary>
            public Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCScriptingCsxFiles.DefaultTargetFrameworkEntity.Mutable DefaultTargetFramework
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DefaultTargetFrameworkUtf8, out Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCScriptingCsxFiles.DefaultTargetFrameworkEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCScriptingCsxFiles.EnabledEntity.Mutable Enabled
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EnabledUtf8, out Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCScriptingCsxFiles.EnabledEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCScriptingCsxFiles.EnableScriptNuGetReferencesEntity.Mutable EnableScriptNuGetReferences
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EnableScriptNuGetReferencesUtf8, out Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCScriptingCsxFiles.EnableScriptNuGetReferencesEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCScriptingCsxFiles.RspFilePathEntity.Mutable RspFilePath
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RspFilePathUtf8, out Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCScriptingCsxFiles.RspFilePathEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetDefaultTargetFramework(scoped in Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCScriptingCsxFiles.DefaultTargetFrameworkEntity.Source value)
            {
                ...
                else
                {
                    ...
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.DefaultTargetFramework, ref cvb);
            ...
            public void SetEnableScriptNuGetReferences(scoped in Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCScriptingCsxFiles.EnableScriptNuGetReferencesEntity.Source value)
            {
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.EnableScriptNuGetReferences, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            public void SetRspFilePath(scoped in Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCScriptingCsxFiles.RspFilePathEntity.Source value)
            {
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.RspFilePath, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCScriptingCsxFiles.DefaultTargetFrameworkEntity.Source _createArg1;
            private readonly Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCScriptingCsxFiles.EnabledEntity.Source _createArg2;
            private readonly Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCScriptingCsxFiles.EnableScriptNuGetReferencesEntity.Source _createArg3;
            private readonly Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCScriptingCsxFiles.RspFilePathEntity.Source _createArg4;
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCScriptingCsxFiles.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCScriptingCsxFiles.DefaultTargetFrameworkEntity.Source defaultTargetFramework = default,
                in Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCScriptingCsxFiles.EnabledEntity.Source enabled = default,
                in Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCScriptingCsxFiles.EnableScriptNuGetReferencesEntity.Source enableScriptNuGetReferences = default,
                in Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCScriptingCsxFiles.RspFilePathEntity.Source rspFilePath = default)
            {
                defaultTargetFramework.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.DefaultTargetFramework, ref builder);
                enabled.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Enabled, ref builder);
                enableScriptNuGetReferences.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.EnableScriptNuGetReferences, ref builder);
                rspFilePath.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.RspFilePath, ref builder);
            }
        ...
        /// </summary>
        /// <param name="defaultTargetFramework">The value of the <c>"defaultTargetFramework"</c> property.</param>
        ...
        public static ParsedJsonDocument<UsedToConfigureCScriptingCsxFiles> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<UsedToConfigureCScriptingCsxFiles>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<UsedToConfigureCScriptingCsxFiles> Create<TContext>(
        ...
        public static ParsedJsonDocument<UsedToConfigureCScriptingCsxFiles> Create(in Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCScriptingCsxFiles.DefaultTargetFrameworkEntity.Source defaultTargetFramework = default, in Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCScriptingCsxFiles.EnabledEntity.Source enabled = default, in Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCScriptingCsxFiles.EnableScriptNuGetReferencesEntity.Source enableScriptNuGetReferences = default, in Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCScriptingCsxFiles.RspFilePathEntity.Source rspFilePath = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
