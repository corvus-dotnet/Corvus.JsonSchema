...
public readonly partial struct OmnisharpSchema
{
    ...
    public readonly partial struct UsedToConfigureCScriptingCsxFiles
    {
        ...
        public readonly partial struct RspFilePathEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<RspFilePathEntity, Mutable>(RspFilePathEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(RspFilePathEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RspFilePathEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RspFilePathEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new RspFilePathEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RspFilePathEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="RspFilePathEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="RspFilePathEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly RspFilePathEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<RspFilePathEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="RspFilePathEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly RspFilePathEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RspFilePathEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RspFilePathEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RspFilePathEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RspFilePathEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RspFilePathEntity>();
                }
                finally
                {
