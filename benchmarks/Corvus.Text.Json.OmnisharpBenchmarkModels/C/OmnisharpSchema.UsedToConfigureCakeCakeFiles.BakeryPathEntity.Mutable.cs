...
public readonly partial struct OmnisharpSchema
{
    ...
    public readonly partial struct UsedToConfigureCakeCakeFiles
    {
        ...
        public readonly partial struct BakeryPathEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<BakeryPathEntity, Mutable>(BakeryPathEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(BakeryPathEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="BakeryPathEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator BakeryPathEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new BakeryPathEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"BakeryPathEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="BakeryPathEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="BakeryPathEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly BakeryPathEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<BakeryPathEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="BakeryPathEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly BakeryPathEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<BakeryPathEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(BakeryPathEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<BakeryPathEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<BakeryPathEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<BakeryPathEntity>();
                }
                finally
                {
