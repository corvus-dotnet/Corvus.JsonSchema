    ...
    public readonly partial struct UsedToConfigureCakeCakeFiles
    {
        ...
        public readonly partial struct EnabledEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<EnabledEntity, Mutable>(EnabledEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(EnabledEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="EnabledEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator EnabledEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"EnabledEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly EnabledEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly EnabledEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<EnabledEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(EnabledEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<EnabledEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<EnabledEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<EnabledEntity>();
                }
                finally
                {
