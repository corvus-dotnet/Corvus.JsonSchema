...
public readonly partial struct OmnisharpSchema
{
    ...
    public readonly partial struct UsedToConfigureCakeCakeFiles
    {
...
#endif
        {
            ...
            /// </summary>
            public Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCakeCakeFiles.BakeryPathEntity.Mutable BakeryPath
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BakeryPathUtf8, out Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCakeCakeFiles.BakeryPathEntity.Mutable value))
                    {
                        return value;
                    }

                    return Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCakeCakeFiles.BakeryPathEntity.Mutable.DefaultInstance;
                }
            }
            ...
            /// </summary>
            public Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCakeCakeFiles.EnabledEntity.Mutable Enabled
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EnabledUtf8, out Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCakeCakeFiles.EnabledEntity.Mutable value))
                    {
                        return value;
                    }

                    return Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCakeCakeFiles.EnabledEntity.Mutable.DefaultInstance;
                }
            }
            ...
            public void SetBakeryPath(scoped in Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCakeCakeFiles.BakeryPathEntity.Source value)
            {
                ...
                else
                {
                    ...
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.BakeryPath, ref cvb);
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCakeCakeFiles.BakeryPathEntity.Source _createArg1;
            private readonly Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCakeCakeFiles.EnabledEntity.Source _createArg2;
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCakeCakeFiles.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCakeCakeFiles.BakeryPathEntity.Source bakeryPath = default,
                in Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCakeCakeFiles.EnabledEntity.Source enabled = default)
            {
                bakeryPath.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.BakeryPath, ref builder);
            ...
            /// Creates an instance of a <see cref="UsedToConfigureCakeCakeFiles"/>.
            /// </summary>
            public void Create(in Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCakeCakeFiles.BakeryPathEntity.Source bakeryPath = default, in Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCakeCakeFiles.EnabledEntity.Source enabled = default)
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCakeCakeFiles.BakeryPathEntity.Source bakeryPath = default, in Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCakeCakeFiles.EnabledEntity.Source enabled = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        public static ParsedJsonDocument<UsedToConfigureCakeCakeFiles> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<UsedToConfigureCakeCakeFiles>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<UsedToConfigureCakeCakeFiles> Create<TContext>(
        ...
        public static ParsedJsonDocument<UsedToConfigureCakeCakeFiles> Create(in Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCakeCakeFiles.BakeryPathEntity.Source bakeryPath = default, in Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCakeCakeFiles.EnabledEntity.Source enabled = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
