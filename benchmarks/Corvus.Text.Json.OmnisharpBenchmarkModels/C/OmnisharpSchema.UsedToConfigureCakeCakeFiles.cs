...
public readonly partial struct OmnisharpSchema
{
...
#endif
    {
        ...
        /// </summary>
        public Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCakeCakeFiles.BakeryPathEntity BakeryPath
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BakeryPathUtf8, out Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCakeCakeFiles.BakeryPathEntity value))
                {
                    return value;
                }

                return Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCakeCakeFiles.BakeryPathEntity.DefaultInstance;
            }
        }
        ...
        /// </summary>
        public Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCakeCakeFiles.EnabledEntity Enabled
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EnabledUtf8, out Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCakeCakeFiles.EnabledEntity value))
                {
                    return value;
                }

                return Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureCakeCakeFiles.EnabledEntity.DefaultInstance;
            }
        }
        ...
        {
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="BakeryPath"/>.
            /// </summary>
            public static ReadOnlySpan<byte> BakeryPath => [0xC5, 0x00, 0x00, 0x00, 0x22, 0x62, 0x61, 0x6B, 0x65, 0x72, 0x79, 0x50, 0x61, 0x74, 0x68, 0x22];
