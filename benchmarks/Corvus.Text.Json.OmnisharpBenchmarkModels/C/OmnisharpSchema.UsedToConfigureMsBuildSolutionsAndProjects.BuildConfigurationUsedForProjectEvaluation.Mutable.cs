    ...
    public readonly partial struct UsedToConfigureMsBuildSolutionsAndProjects
    {
        ...
        public readonly partial struct BuildConfigurationUsedForProjectEvaluation
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<BuildConfigurationUsedForProjectEvaluation, Mutable>(BuildConfigurationUsedForProjectEvaluation.DefaultInstance);
                ...
                public static explicit operator Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureMsBuildSolutionsAndProjects.BuildConfigurationUsedForProjectEvaluation.AnyOf0Entity.Mutable(Mutable value)
                {
                    return Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureMsBuildSolutionsAndProjects.BuildConfigurationUsedForProjectEvaluation.AnyOf0Entity.Mutable.From(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureMsBuildSolutionsAndProjects.BuildConfigurationUsedForProjectEvaluation.AnyOf0Entity.Mutable value)
                {
                    return From(value);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureMsBuildSolutionsAndProjects.BuildConfigurationUsedForProjectEvaluation.Mutable, TContext, TResult> defaultMatch)
...
#endif
                {
                    ...
                    {
                        return matchAnyOf0Entity(Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureMsBuildSolutionsAndProjects.BuildConfigurationUsedForProjectEvaluation.AnyOf0Entity.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureMsBuildSolutionsAndProjects.BuildConfigurationUsedForProjectEvaluation.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureMsBuildSolutionsAndProjects.BuildConfigurationUsedForProjectEvaluation.AnyOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchAnyOf0Entity(Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureMsBuildSolutionsAndProjects.BuildConfigurationUsedForProjectEvaluation.AnyOf0Entity.Mutable.From(this));
                    }
                ...
                public TAccumulator MatchEvery<TAccumulator>(
                    ...
                    Matcher<Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureMsBuildSolutionsAndProjects.BuildConfigurationUsedForProjectEvaluation.Mutable, TAccumulator, TAccumulator> defaultMatch)
                {
                    bool matched = false;
                    ...
                    {
                        matched = true;
                        accumulator = matchAnyOf0Entity(Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureMsBuildSolutionsAndProjects.BuildConfigurationUsedForProjectEvaluation.AnyOf0Entity.Mutable.From(this), accumulator);
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureMsBuildSolutionsAndProjects.BuildConfigurationUsedForProjectEvaluation.AnyOf0Entity.Mutable" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsAnyOf0Entity(out Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureMsBuildSolutionsAndProjects.BuildConfigurationUsedForProjectEvaluation.AnyOf0Entity.Mutable result)
                {
                    if (Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureMsBuildSolutionsAndProjects.BuildConfigurationUsedForProjectEvaluation.AnyOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureMsBuildSolutionsAndProjects.BuildConfigurationUsedForProjectEvaluation.AnyOf0Entity.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.OmnisharpBenchmark.Current.OmnisharpSchema.UsedToConfigureMsBuildSolutionsAndProjects.BuildConfigurationUsedForProjectEvaluation.AnyOf0Entity instance) => new(JsonElement.From(instance));
            ...
            public static ParsedJsonDocument<BuildConfigurationUsedForProjectEvaluation> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<BuildConfigurationUsedForProjectEvaluation>();
                }
                finally
                {
