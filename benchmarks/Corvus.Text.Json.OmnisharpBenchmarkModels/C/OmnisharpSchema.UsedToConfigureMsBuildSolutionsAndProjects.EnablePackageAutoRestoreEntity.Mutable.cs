    ...
    public readonly partial struct UsedToConfigureMsBuildSolutionsAndProjects
    {
        ...
        public readonly partial struct EnablePackageAutoRestoreEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<EnablePackageAutoRestoreEntity, Mutable>(EnablePackageAutoRestoreEntity.DefaultInstance);
            ...
            public static ParsedJsonDocument<EnablePackageAutoRestoreEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<EnablePackageAutoRestoreEntity>();
                }
                finally
                {
