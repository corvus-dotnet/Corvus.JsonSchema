...
public readonly partial struct OmnisharpSchema
{
    ...
    public readonly partial struct UsedToConfigureMsBuildSolutionsAndProjects
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="EnablePackageAutoRestoreEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal EnablePackageAutoRestoreEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static EnablePackageAutoRestoreEntity DefaultInstance { get; } = ParsedJsonDocument<EnablePackageAutoRestoreEntity>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(EnablePackageAutoRestoreEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in EnablePackageAutoRestoreEntity left, in EnablePackageAutoRestoreEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in EnablePackageAutoRestoreEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(EnablePackageAutoRestoreEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EnablePackageAutoRestoreEntity(JsonElement instance)
            {
                return EnablePackageAutoRestoreEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EnablePackageAutoRestoreEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EnablePackageAutoRestoreEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EnablePackageAutoRestoreEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EnablePackageAutoRestoreEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EnablePackageAutoRestoreEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EnablePackageAutoRestoreEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EnablePackageAutoRestoreEntity>(json, options);
            }
            ...
            /// </exception>
            public static EnablePackageAutoRestoreEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<EnablePackageAutoRestoreEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out EnablePackageAutoRestoreEntity? result)
            {
                return JsonElementHelpers.TryParseValue<EnablePackageAutoRestoreEntity>(ref reader, out result);
            }
...
#if NET
            static EnablePackageAutoRestoreEntity IJsonElement<EnablePackageAutoRestoreEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EnablePackageAutoRestoreEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public EnablePackageAutoRestoreEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public EnablePackageAutoRestoreEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<EnablePackageAutoRestoreEntity>(_idx);
                }
