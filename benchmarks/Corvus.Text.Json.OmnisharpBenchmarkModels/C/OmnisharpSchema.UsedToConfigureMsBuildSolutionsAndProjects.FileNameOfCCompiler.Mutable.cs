    ...
    public readonly partial struct UsedToConfigureMsBuildSolutionsAndProjects
    {
        ...
        public readonly partial struct FileNameOfCCompiler
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<FileNameOfCCompiler, Mutable>(FileNameOfCCompiler.DefaultInstance);
                ...
                public static explicit operator Mutable(FileNameOfCCompiler instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="FileNameOfCCompiler"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator FileNameOfCCompiler(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"FileNameOfCCompiler.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly FileNameOfCCompiler Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly FileNameOfCCompiler Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<FileNameOfCCompiler>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(FileNameOfCCompiler instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<FileNameOfCCompiler, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<FileNameOfCCompiler> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<FileNameOfCCompiler>();
                }
                finally
                {
