...
public readonly partial struct OmnisharpSchema
{
    ...
    public readonly partial struct UsedToConfigureMsBuildSolutionsAndProjects
    {
        ...
        public readonly partial struct FileNameOfCCompiler
#if NET8_0_OR_GREATER
            : IJsonElement<FileNameOfCCompiler>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="FileNameOfCCompiler"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal FileNameOfCCompiler(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static FileNameOfCCompiler DefaultInstance { get; } = ParsedJsonDocument<FileNameOfCCompiler>.StringConstant([.."\"csc.exe\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(FileNameOfCCompiler value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in FileNameOfCCompiler left, in FileNameOfCCompiler right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in FileNameOfCCompiler left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(FileNameOfCCompiler instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator FileNameOfCCompiler(JsonElement instance)
            {
                return FileNameOfCCompiler.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static FileNameOfCCompiler From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static FileNameOfCCompiler ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<FileNameOfCCompiler>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static FileNameOfCCompiler ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<FileNameOfCCompiler>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static FileNameOfCCompiler ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<FileNameOfCCompiler>(json, options);
            }
            ...
            /// </exception>
            public static FileNameOfCCompiler ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<FileNameOfCCompiler>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out FileNameOfCCompiler? result)
            {
                return JsonElementHelpers.TryParseValue<FileNameOfCCompiler>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new FileNameOfCCompiler(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static FileNameOfCCompiler IJsonElement<FileNameOfCCompiler>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"FileNameOfCCompiler: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="FileNameOfCCompiler"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="FileNameOfCCompiler"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public FileNameOfCCompiler Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<FileNameOfCCompiler>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="FileNameOfCCompiler"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public FileNameOfCCompiler Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<FileNameOfCCompiler>(_idx);
                }
