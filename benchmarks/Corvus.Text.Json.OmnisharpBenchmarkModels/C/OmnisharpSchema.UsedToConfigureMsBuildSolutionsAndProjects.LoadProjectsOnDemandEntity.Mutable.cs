    ...
    public readonly partial struct UsedToConfigureMsBuildSolutionsAndProjects
    {
        ...
        public readonly partial struct LoadProjectsOnDemandEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<LoadProjectsOnDemandEntity, Mutable>(LoadProjectsOnDemandEntity.DefaultInstance);
            ...
            public static ParsedJsonDocument<LoadProjectsOnDemandEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<LoadProjectsOnDemandEntity>();
                }
                finally
                {
