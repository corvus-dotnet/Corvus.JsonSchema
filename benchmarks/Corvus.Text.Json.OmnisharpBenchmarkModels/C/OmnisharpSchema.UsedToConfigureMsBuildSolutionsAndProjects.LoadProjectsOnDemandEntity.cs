...
public readonly partial struct OmnisharpSchema
{
    ...
    public readonly partial struct UsedToConfigureMsBuildSolutionsAndProjects
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="LoadProjectsOnDemandEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal LoadProjectsOnDemandEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static LoadProjectsOnDemandEntity DefaultInstance { get; } = ParsedJsonDocument<LoadProjectsOnDemandEntity>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(LoadProjectsOnDemandEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in LoadProjectsOnDemandEntity left, in LoadProjectsOnDemandEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in LoadProjectsOnDemandEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(LoadProjectsOnDemandEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator LoadProjectsOnDemandEntity(JsonElement instance)
            {
                return LoadProjectsOnDemandEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LoadProjectsOnDemandEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LoadProjectsOnDemandEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<LoadProjectsOnDemandEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LoadProjectsOnDemandEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<LoadProjectsOnDemandEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LoadProjectsOnDemandEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<LoadProjectsOnDemandEntity>(json, options);
            }
            ...
            /// </exception>
            public static LoadProjectsOnDemandEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<LoadProjectsOnDemandEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out LoadProjectsOnDemandEntity? result)
            {
                return JsonElementHelpers.TryParseValue<LoadProjectsOnDemandEntity>(ref reader, out result);
            }
...
#if NET
            static LoadProjectsOnDemandEntity IJsonElement<LoadProjectsOnDemandEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"LoadProjectsOnDemandEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public LoadProjectsOnDemandEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public LoadProjectsOnDemandEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<LoadProjectsOnDemandEntity>(_idx);
                }
