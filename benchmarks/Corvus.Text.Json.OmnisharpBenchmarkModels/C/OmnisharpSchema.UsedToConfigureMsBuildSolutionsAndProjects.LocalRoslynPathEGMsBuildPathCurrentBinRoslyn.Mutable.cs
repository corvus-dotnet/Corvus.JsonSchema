    ...
    public readonly partial struct UsedToConfigureMsBuildSolutionsAndProjects
    {
        ...
        public readonly partial struct LocalRoslynPathEGMsBuildPathCurrentBinRoslyn
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<LocalRoslynPathEGMsBuildPathCurrentBinRoslyn, Mutable>(LocalRoslynPathEGMsBuildPathCurrentBinRoslyn.DefaultInstance);
                ...
                public static explicit operator Mutable(LocalRoslynPathEGMsBuildPathCurrentBinRoslyn instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="LocalRoslynPathEGMsBuildPathCurrentBinRoslyn"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator LocalRoslynPathEGMsBuildPathCurrentBinRoslyn(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"LocalRoslynPathEGMsBuildPathCurrentBinRoslyn.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly LocalRoslynPathEGMsBuildPathCurrentBinRoslyn Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly LocalRoslynPathEGMsBuildPathCurrentBinRoslyn Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<LocalRoslynPathEGMsBuildPathCurrentBinRoslyn>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(LocalRoslynPathEGMsBuildPathCurrentBinRoslyn instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<LocalRoslynPathEGMsBuildPathCurrentBinRoslyn, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<LocalRoslynPathEGMsBuildPathCurrentBinRoslyn> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<LocalRoslynPathEGMsBuildPathCurrentBinRoslyn>();
                }
                finally
                {
