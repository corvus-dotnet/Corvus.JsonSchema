    ...
    public readonly partial struct UsedToConfigureMsBuildSolutionsAndProjects
    {
        ...
        public readonly partial struct MsBuildExtensionsPathEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<MsBuildExtensionsPathEntity, Mutable>(MsBuildExtensionsPathEntity.DefaultInstance);
            ...
            public static ParsedJsonDocument<MsBuildExtensionsPathEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<MsBuildExtensionsPathEntity>();
                }
                finally
                {
