...
public readonly partial struct OmnisharpSchema
{
    ...
    public readonly partial struct UsedToConfigureMsBuildSolutionsAndProjects
    {
        ...
        public readonly partial struct PathToTheSdksFolderForThisMsBuildInstance
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<PathToTheSdksFolderForThisMsBuildInstance, Mutable>(PathToTheSdksFolderForThisMsBuildInstance.DefaultInstance);
                ...
                public static explicit operator Mutable(PathToTheSdksFolderForThisMsBuildInstance instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="PathToTheSdksFolderForThisMsBuildInstance"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator PathToTheSdksFolderForThisMsBuildInstance(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new PathToTheSdksFolderForThisMsBuildInstance(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"PathToTheSdksFolderForThisMsBuildInstance.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="PathToTheSdksFolderForThisMsBuildInstance"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="PathToTheSdksFolderForThisMsBuildInstance"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly PathToTheSdksFolderForThisMsBuildInstance Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<PathToTheSdksFolderForThisMsBuildInstance>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="PathToTheSdksFolderForThisMsBuildInstance"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly PathToTheSdksFolderForThisMsBuildInstance Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<PathToTheSdksFolderForThisMsBuildInstance>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(PathToTheSdksFolderForThisMsBuildInstance instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<PathToTheSdksFolderForThisMsBuildInstance, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<PathToTheSdksFolderForThisMsBuildInstance> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<PathToTheSdksFolderForThisMsBuildInstance>();
                }
                finally
                {
