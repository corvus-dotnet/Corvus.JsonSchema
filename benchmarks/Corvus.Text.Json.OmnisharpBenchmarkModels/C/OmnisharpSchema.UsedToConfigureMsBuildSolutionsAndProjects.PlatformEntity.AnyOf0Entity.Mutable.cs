        ...
        public readonly partial struct PlatformEntity
        {
            ...
            public readonly partial struct AnyOf0Entity
            {
...
#endif
                {
                    ...
                    /// <summary>
                    /// Gets a <see cref="AnyOf0Entity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="AnyOf0Entity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly AnyOf0Entity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<AnyOf0Entity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="AnyOf0Entity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly AnyOf0Entity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<AnyOf0Entity>(_idx);
                    }
                    ...
                    /// <param name="matchAnyCpu">Match 1st item.</param>
                    /// <param name="matchX86">Match 2nd item.</param>
                    /// <param name="matchX64">Match 3rd item.</param>
                    /// <param name="matchArm">Match 4th item.</param>
                    /// <param name="matchArm64">Match 5th item.</param>
                    /// <param name="matchItanium">Match 6th item.</param>
                    /// <param name="defaultMatch">Match any other value.</param>
                    /// <returns>An instance of the value returned by the match function.</returns>
                    public TResult Match<TContext, TResult>(
                        in TContext context,
                        Func<TContext, TResult> matchAnyCpu,
                        Func<TContext, TResult> matchX86,
                        Func<TContext, TResult> matchX64,
                        Func<TContext, TResult> matchArm,
                        Func<TContext, TResult> matchArm64,
                        Func<TContext, TResult> matchItanium,
                    ...
                    public TResult Match<TResult>(
                        Func<TResult> matchAnyCpu,
                        Func<TResult> matchX86,
                        Func<TResult> matchX64,
                        Func<TResult> matchArm,
                        Func<TResult> matchArm64,
                        Func<TResult> matchItanium,
                ...
                public static ParsedJsonDocument<AnyOf0Entity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<AnyOf0Entity>();
                    }
                    finally
                    {
