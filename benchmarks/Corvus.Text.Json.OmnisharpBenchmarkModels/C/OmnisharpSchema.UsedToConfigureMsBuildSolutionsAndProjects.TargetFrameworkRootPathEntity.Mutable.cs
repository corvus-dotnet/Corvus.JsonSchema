...
public readonly partial struct OmnisharpSchema
{
    ...
    public readonly partial struct UsedToConfigureMsBuildSolutionsAndProjects
    {
        ...
        public readonly partial struct TargetFrameworkRootPathEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<TargetFrameworkRootPathEntity, Mutable>(TargetFrameworkRootPathEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(TargetFrameworkRootPathEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TargetFrameworkRootPathEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TargetFrameworkRootPathEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new TargetFrameworkRootPathEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TargetFrameworkRootPathEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="TargetFrameworkRootPathEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="TargetFrameworkRootPathEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly TargetFrameworkRootPathEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<TargetFrameworkRootPathEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="TargetFrameworkRootPathEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly TargetFrameworkRootPathEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TargetFrameworkRootPathEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(TargetFrameworkRootPathEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<TargetFrameworkRootPathEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<TargetFrameworkRootPathEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TargetFrameworkRootPathEntity>();
                }
                finally
                {
