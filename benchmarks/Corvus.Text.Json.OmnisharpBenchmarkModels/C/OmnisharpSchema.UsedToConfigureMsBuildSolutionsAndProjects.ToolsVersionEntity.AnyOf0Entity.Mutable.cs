        ...
        public readonly partial struct ToolsVersionEntity
        {
            ...
            public readonly partial struct AnyOf0Entity
            {
...
#endif
                {
                    ...
                    /// <param name="matchCurrent">Match 1st item.</param>
                    /// <param name="match20">Match 2nd item.</param>
                    /// <param name="match35">Match 3rd item.</param>
                    /// <param name="match40">Match 4th item.</param>
                    /// <param name="match150">Match 5th item.</param>
                    /// <param name="defaultMatch">Match any other value.</param>
                    /// <returns>An instance of the value returned by the match function.</returns>
                    public TResult Match<TContext, TResult>(
                        in TContext context,
                        Func<TContext, TResult> matchCurrent,
