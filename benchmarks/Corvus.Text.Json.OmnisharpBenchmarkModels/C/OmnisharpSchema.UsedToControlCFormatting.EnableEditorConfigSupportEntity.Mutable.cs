...
public readonly partial struct OmnisharpSchema
{
    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct EnableEditorConfigSupportEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<EnableEditorConfigSupportEntity, Mutable>(EnableEditorConfigSupportEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(EnableEditorConfigSupportEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="EnableEditorConfigSupportEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator EnableEditorConfigSupportEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new EnableEditorConfigSupportEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"EnableEditorConfigSupportEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="EnableEditorConfigSupportEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="EnableEditorConfigSupportEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly EnableEditorConfigSupportEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<EnableEditorConfigSupportEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="EnableEditorConfigSupportEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly EnableEditorConfigSupportEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<EnableEditorConfigSupportEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(EnableEditorConfigSupportEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<EnableEditorConfigSupportEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<EnableEditorConfigSupportEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<EnableEditorConfigSupportEntity>();
                }
                finally
                {
