...
public readonly partial struct OmnisharpSchema
{
    ...
    public readonly partial struct UsedToControlCFormatting
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="EnableEditorConfigSupportEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal EnableEditorConfigSupportEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static EnableEditorConfigSupportEntity DefaultInstance { get; } = ParsedJsonDocument<EnableEditorConfigSupportEntity>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(EnableEditorConfigSupportEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in EnableEditorConfigSupportEntity left, in EnableEditorConfigSupportEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in EnableEditorConfigSupportEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(EnableEditorConfigSupportEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EnableEditorConfigSupportEntity(JsonElement instance)
            {
                return EnableEditorConfigSupportEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EnableEditorConfigSupportEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EnableEditorConfigSupportEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EnableEditorConfigSupportEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EnableEditorConfigSupportEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EnableEditorConfigSupportEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EnableEditorConfigSupportEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EnableEditorConfigSupportEntity>(json, options);
            }
            ...
            /// </exception>
            public static EnableEditorConfigSupportEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<EnableEditorConfigSupportEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out EnableEditorConfigSupportEntity? result)
            {
                return JsonElementHelpers.TryParseValue<EnableEditorConfigSupportEntity>(ref reader, out result);
            }
...
#if NET
            static EnableEditorConfigSupportEntity IJsonElement<EnableEditorConfigSupportEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EnableEditorConfigSupportEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public EnableEditorConfigSupportEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public EnableEditorConfigSupportEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<EnableEditorConfigSupportEntity>(_idx);
                }
