    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct IndentBlockEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<IndentBlockEntity, Mutable>(IndentBlockEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(IndentBlockEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="IndentBlockEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator IndentBlockEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"IndentBlockEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly IndentBlockEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly IndentBlockEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<IndentBlockEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(IndentBlockEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<IndentBlockEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<IndentBlockEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<IndentBlockEntity>();
                }
                finally
                {
