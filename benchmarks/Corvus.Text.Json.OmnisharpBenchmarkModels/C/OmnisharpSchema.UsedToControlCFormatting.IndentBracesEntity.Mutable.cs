...
public readonly partial struct OmnisharpSchema
{
    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct IndentBracesEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<IndentBracesEntity, Mutable>(IndentBracesEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(IndentBracesEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="IndentBracesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator IndentBracesEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new IndentBracesEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"IndentBracesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="IndentBracesEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="IndentBracesEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly IndentBracesEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<IndentBracesEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="IndentBracesEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly IndentBracesEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<IndentBracesEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(IndentBracesEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<IndentBracesEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<IndentBracesEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<IndentBracesEntity>();
                }
                finally
                {
