...
public readonly partial struct OmnisharpSchema
{
    ...
    public readonly partial struct UsedToControlCFormatting
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="IndentSwitchCaseSectionEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal IndentSwitchCaseSectionEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static IndentSwitchCaseSectionEntity DefaultInstance { get; } = ParsedJsonDocument<IndentSwitchCaseSectionEntity>.True;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(IndentSwitchCaseSectionEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in IndentSwitchCaseSectionEntity left, in IndentSwitchCaseSectionEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in IndentSwitchCaseSectionEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(IndentSwitchCaseSectionEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator IndentSwitchCaseSectionEntity(JsonElement instance)
            {
                return IndentSwitchCaseSectionEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static IndentSwitchCaseSectionEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static IndentSwitchCaseSectionEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<IndentSwitchCaseSectionEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static IndentSwitchCaseSectionEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<IndentSwitchCaseSectionEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static IndentSwitchCaseSectionEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<IndentSwitchCaseSectionEntity>(json, options);
            }
            ...
            /// </exception>
            public static IndentSwitchCaseSectionEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<IndentSwitchCaseSectionEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out IndentSwitchCaseSectionEntity? result)
            {
                return JsonElementHelpers.TryParseValue<IndentSwitchCaseSectionEntity>(ref reader, out result);
            }
...
#if NET
            static IndentSwitchCaseSectionEntity IJsonElement<IndentSwitchCaseSectionEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"IndentSwitchCaseSectionEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public IndentSwitchCaseSectionEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public IndentSwitchCaseSectionEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<IndentSwitchCaseSectionEntity>(_idx);
                }
