    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct IndentSwitchCaseSectionWhenBlockEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<IndentSwitchCaseSectionWhenBlockEntity, Mutable>(IndentSwitchCaseSectionWhenBlockEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(IndentSwitchCaseSectionWhenBlockEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="IndentSwitchCaseSectionWhenBlockEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator IndentSwitchCaseSectionWhenBlockEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"IndentSwitchCaseSectionWhenBlockEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly IndentSwitchCaseSectionWhenBlockEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly IndentSwitchCaseSectionWhenBlockEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<IndentSwitchCaseSectionWhenBlockEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(IndentSwitchCaseSectionWhenBlockEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<IndentSwitchCaseSectionWhenBlockEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<IndentSwitchCaseSectionWhenBlockEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<IndentSwitchCaseSectionWhenBlockEntity>();
                }
                finally
                {
