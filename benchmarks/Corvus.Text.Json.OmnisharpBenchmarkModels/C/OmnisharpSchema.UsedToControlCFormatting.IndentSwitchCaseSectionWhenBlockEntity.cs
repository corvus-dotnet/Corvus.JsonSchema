...
public readonly partial struct OmnisharpSchema
{
    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct IndentSwitchCaseSectionWhenBlockEntity
#if NET8_0_OR_GREATER
            : IJsonElement<IndentSwitchCaseSectionWhenBlockEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="IndentSwitchCaseSectionWhenBlockEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal IndentSwitchCaseSectionWhenBlockEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static IndentSwitchCaseSectionWhenBlockEntity DefaultInstance { get; } = ParsedJsonDocument<IndentSwitchCaseSectionWhenBlockEntity>.True;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(IndentSwitchCaseSectionWhenBlockEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in IndentSwitchCaseSectionWhenBlockEntity left, in IndentSwitchCaseSectionWhenBlockEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in IndentSwitchCaseSectionWhenBlockEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(IndentSwitchCaseSectionWhenBlockEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator IndentSwitchCaseSectionWhenBlockEntity(JsonElement instance)
            {
                return IndentSwitchCaseSectionWhenBlockEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static IndentSwitchCaseSectionWhenBlockEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static IndentSwitchCaseSectionWhenBlockEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<IndentSwitchCaseSectionWhenBlockEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static IndentSwitchCaseSectionWhenBlockEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<IndentSwitchCaseSectionWhenBlockEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static IndentSwitchCaseSectionWhenBlockEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<IndentSwitchCaseSectionWhenBlockEntity>(json, options);
            }
            ...
            /// </exception>
            public static IndentSwitchCaseSectionWhenBlockEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<IndentSwitchCaseSectionWhenBlockEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out IndentSwitchCaseSectionWhenBlockEntity? result)
            {
                return JsonElementHelpers.TryParseValue<IndentSwitchCaseSectionWhenBlockEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new IndentSwitchCaseSectionWhenBlockEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static IndentSwitchCaseSectionWhenBlockEntity IJsonElement<IndentSwitchCaseSectionWhenBlockEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"IndentSwitchCaseSectionWhenBlockEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="IndentSwitchCaseSectionWhenBlockEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="IndentSwitchCaseSectionWhenBlockEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public IndentSwitchCaseSectionWhenBlockEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<IndentSwitchCaseSectionWhenBlockEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="IndentSwitchCaseSectionWhenBlockEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public IndentSwitchCaseSectionWhenBlockEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<IndentSwitchCaseSectionWhenBlockEntity>(_idx);
                }
