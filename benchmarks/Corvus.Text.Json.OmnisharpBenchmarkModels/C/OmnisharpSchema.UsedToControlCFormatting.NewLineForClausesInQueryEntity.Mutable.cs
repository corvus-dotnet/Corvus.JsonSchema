    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct NewLineForClausesInQueryEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<NewLineForClausesInQueryEntity, Mutable>(NewLineForClausesInQueryEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(NewLineForClausesInQueryEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="NewLineForClausesInQueryEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator NewLineForClausesInQueryEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"NewLineForClausesInQueryEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly NewLineForClausesInQueryEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly NewLineForClausesInQueryEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<NewLineForClausesInQueryEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(NewLineForClausesInQueryEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<NewLineForClausesInQueryEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<NewLineForClausesInQueryEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<NewLineForClausesInQueryEntity>();
                }
                finally
                {
