...
public readonly partial struct OmnisharpSchema
{
    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct NewLineForClausesInQueryEntity
#if NET8_0_OR_GREATER
            : IJsonElement<NewLineForClausesInQueryEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="NewLineForClausesInQueryEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal NewLineForClausesInQueryEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static NewLineForClausesInQueryEntity DefaultInstance { get; } = ParsedJsonDocument<NewLineForClausesInQueryEntity>.True;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(NewLineForClausesInQueryEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in NewLineForClausesInQueryEntity left, in NewLineForClausesInQueryEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in NewLineForClausesInQueryEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(NewLineForClausesInQueryEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator NewLineForClausesInQueryEntity(JsonElement instance)
            {
                return NewLineForClausesInQueryEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NewLineForClausesInQueryEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NewLineForClausesInQueryEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<NewLineForClausesInQueryEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NewLineForClausesInQueryEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<NewLineForClausesInQueryEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NewLineForClausesInQueryEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<NewLineForClausesInQueryEntity>(json, options);
            }
            ...
            /// </exception>
            public static NewLineForClausesInQueryEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<NewLineForClausesInQueryEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out NewLineForClausesInQueryEntity? result)
            {
                return JsonElementHelpers.TryParseValue<NewLineForClausesInQueryEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new NewLineForClausesInQueryEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static NewLineForClausesInQueryEntity IJsonElement<NewLineForClausesInQueryEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"NewLineForClausesInQueryEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="NewLineForClausesInQueryEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="NewLineForClausesInQueryEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public NewLineForClausesInQueryEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<NewLineForClausesInQueryEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="NewLineForClausesInQueryEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public NewLineForClausesInQueryEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<NewLineForClausesInQueryEntity>(_idx);
                }
