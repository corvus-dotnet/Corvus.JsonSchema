    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct NewLineForFinallyEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<NewLineForFinallyEntity, Mutable>(NewLineForFinallyEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(NewLineForFinallyEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="NewLineForFinallyEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator NewLineForFinallyEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"NewLineForFinallyEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly NewLineForFinallyEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly NewLineForFinallyEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<NewLineForFinallyEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(NewLineForFinallyEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<NewLineForFinallyEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<NewLineForFinallyEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<NewLineForFinallyEntity>();
                }
                finally
                {
