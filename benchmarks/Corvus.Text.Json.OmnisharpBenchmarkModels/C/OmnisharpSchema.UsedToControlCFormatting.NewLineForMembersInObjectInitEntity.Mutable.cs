    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct NewLineForMembersInObjectInitEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<NewLineForMembersInObjectInitEntity, Mutable>(NewLineForMembersInObjectInitEntity.DefaultInstance);
            ...
            public static ParsedJsonDocument<NewLineForMembersInObjectInitEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<NewLineForMembersInObjectInitEntity>();
                }
                finally
                {
