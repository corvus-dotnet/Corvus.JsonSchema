...
public readonly partial struct OmnisharpSchema
{
    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct NewLineForMembersInObjectInitEntity
            ...
            : IJsonElement<NewLineForMembersInObjectInitEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="NewLineForMembersInObjectInitEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal NewLineForMembersInObjectInitEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static NewLineForMembersInObjectInitEntity DefaultInstance { get; } = ParsedJsonDocument<NewLineForMembersInObjectInitEntity>.True;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(NewLineForMembersInObjectInitEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in NewLineForMembersInObjectInitEntity left, in NewLineForMembersInObjectInitEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in NewLineForMembersInObjectInitEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(NewLineForMembersInObjectInitEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator NewLineForMembersInObjectInitEntity(JsonElement instance)
            {
                return NewLineForMembersInObjectInitEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NewLineForMembersInObjectInitEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NewLineForMembersInObjectInitEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<NewLineForMembersInObjectInitEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NewLineForMembersInObjectInitEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<NewLineForMembersInObjectInitEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NewLineForMembersInObjectInitEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<NewLineForMembersInObjectInitEntity>(json, options);
            }
            ...
            /// </exception>
            public static NewLineForMembersInObjectInitEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<NewLineForMembersInObjectInitEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out NewLineForMembersInObjectInitEntity? result)
            {
                return JsonElementHelpers.TryParseValue<NewLineForMembersInObjectInitEntity>(ref reader, out result);
            }
...
#if NET
            static NewLineForMembersInObjectInitEntity IJsonElement<NewLineForMembersInObjectInitEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"NewLineForMembersInObjectInitEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public NewLineForMembersInObjectInitEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public NewLineForMembersInObjectInitEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<NewLineForMembersInObjectInitEntity>(_idx);
                }
