    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct NewLinesForBracesInAccessorsEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<NewLinesForBracesInAccessorsEntity, Mutable>(NewLinesForBracesInAccessorsEntity.DefaultInstance);
            ...
            public static ParsedJsonDocument<NewLinesForBracesInAccessorsEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<NewLinesForBracesInAccessorsEntity>();
                }
                finally
                {
