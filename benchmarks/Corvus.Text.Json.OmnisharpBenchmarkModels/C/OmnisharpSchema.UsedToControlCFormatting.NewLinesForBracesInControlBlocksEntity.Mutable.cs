    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct NewLinesForBracesInControlBlocksEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<NewLinesForBracesInControlBlocksEntity, Mutable>(NewLinesForBracesInControlBlocksEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(NewLinesForBracesInControlBlocksEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="NewLinesForBracesInControlBlocksEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator NewLinesForBracesInControlBlocksEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"NewLinesForBracesInControlBlocksEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly NewLinesForBracesInControlBlocksEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly NewLinesForBracesInControlBlocksEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<NewLinesForBracesInControlBlocksEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(NewLinesForBracesInControlBlocksEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<NewLinesForBracesInControlBlocksEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<NewLinesForBracesInControlBlocksEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<NewLinesForBracesInControlBlocksEntity>();
                }
                finally
                {
