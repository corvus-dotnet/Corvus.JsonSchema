...
public readonly partial struct OmnisharpSchema
{
    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct NewLinesForBracesInControlBlocksEntity
#if NET8_0_OR_GREATER
            : IJsonElement<NewLinesForBracesInControlBlocksEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="NewLinesForBracesInControlBlocksEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal NewLinesForBracesInControlBlocksEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static NewLinesForBracesInControlBlocksEntity DefaultInstance { get; } = ParsedJsonDocument<NewLinesForBracesInControlBlocksEntity>.True;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(NewLinesForBracesInControlBlocksEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in NewLinesForBracesInControlBlocksEntity left, in NewLinesForBracesInControlBlocksEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in NewLinesForBracesInControlBlocksEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(NewLinesForBracesInControlBlocksEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator NewLinesForBracesInControlBlocksEntity(JsonElement instance)
            {
                return NewLinesForBracesInControlBlocksEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NewLinesForBracesInControlBlocksEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NewLinesForBracesInControlBlocksEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<NewLinesForBracesInControlBlocksEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NewLinesForBracesInControlBlocksEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<NewLinesForBracesInControlBlocksEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NewLinesForBracesInControlBlocksEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<NewLinesForBracesInControlBlocksEntity>(json, options);
            }
            ...
            /// </exception>
            public static NewLinesForBracesInControlBlocksEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<NewLinesForBracesInControlBlocksEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out NewLinesForBracesInControlBlocksEntity? result)
            {
                return JsonElementHelpers.TryParseValue<NewLinesForBracesInControlBlocksEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new NewLinesForBracesInControlBlocksEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static NewLinesForBracesInControlBlocksEntity IJsonElement<NewLinesForBracesInControlBlocksEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"NewLinesForBracesInControlBlocksEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="NewLinesForBracesInControlBlocksEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="NewLinesForBracesInControlBlocksEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public NewLinesForBracesInControlBlocksEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<NewLinesForBracesInControlBlocksEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="NewLinesForBracesInControlBlocksEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public NewLinesForBracesInControlBlocksEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<NewLinesForBracesInControlBlocksEntity>(_idx);
                }
