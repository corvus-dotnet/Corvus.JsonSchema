...
public readonly partial struct OmnisharpSchema
{
    ...
    public readonly partial struct UsedToControlCFormatting
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="NewLinesForBracesInMethodsEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal NewLinesForBracesInMethodsEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static NewLinesForBracesInMethodsEntity DefaultInstance { get; } = ParsedJsonDocument<NewLinesForBracesInMethodsEntity>.True;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(NewLinesForBracesInMethodsEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in NewLinesForBracesInMethodsEntity left, in NewLinesForBracesInMethodsEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in NewLinesForBracesInMethodsEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(NewLinesForBracesInMethodsEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator NewLinesForBracesInMethodsEntity(JsonElement instance)
            {
                return NewLinesForBracesInMethodsEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NewLinesForBracesInMethodsEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NewLinesForBracesInMethodsEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<NewLinesForBracesInMethodsEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NewLinesForBracesInMethodsEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<NewLinesForBracesInMethodsEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NewLinesForBracesInMethodsEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<NewLinesForBracesInMethodsEntity>(json, options);
            }
            ...
            /// </exception>
            public static NewLinesForBracesInMethodsEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<NewLinesForBracesInMethodsEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out NewLinesForBracesInMethodsEntity? result)
            {
                return JsonElementHelpers.TryParseValue<NewLinesForBracesInMethodsEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new NewLinesForBracesInMethodsEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static NewLinesForBracesInMethodsEntity IJsonElement<NewLinesForBracesInMethodsEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"NewLinesForBracesInMethodsEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="NewLinesForBracesInMethodsEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="NewLinesForBracesInMethodsEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public NewLinesForBracesInMethodsEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<NewLinesForBracesInMethodsEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="NewLinesForBracesInMethodsEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public NewLinesForBracesInMethodsEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<NewLinesForBracesInMethodsEntity>(_idx);
                }
