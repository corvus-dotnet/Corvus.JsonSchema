    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct NewLinesForBracesInTypesEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<NewLinesForBracesInTypesEntity, Mutable>(NewLinesForBracesInTypesEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(NewLinesForBracesInTypesEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="NewLinesForBracesInTypesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator NewLinesForBracesInTypesEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"NewLinesForBracesInTypesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly NewLinesForBracesInTypesEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly NewLinesForBracesInTypesEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<NewLinesForBracesInTypesEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(NewLinesForBracesInTypesEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<NewLinesForBracesInTypesEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<NewLinesForBracesInTypesEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<NewLinesForBracesInTypesEntity>();
                }
                finally
                {
