    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct SpaceAfterColonInBaseTypeDeclarationEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SpaceAfterColonInBaseTypeDeclarationEntity, Mutable>(SpaceAfterColonInBaseTypeDeclarationEntity.DefaultInstance);
            ...
            public static ParsedJsonDocument<SpaceAfterColonInBaseTypeDeclarationEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SpaceAfterColonInBaseTypeDeclarationEntity>();
                }
                finally
                {
