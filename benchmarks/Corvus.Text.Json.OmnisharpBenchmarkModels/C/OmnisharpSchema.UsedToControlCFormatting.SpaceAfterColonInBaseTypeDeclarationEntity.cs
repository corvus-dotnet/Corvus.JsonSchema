...
public readonly partial struct OmnisharpSchema
{
    ...
    public readonly partial struct UsedToControlCFormatting
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="SpaceAfterColonInBaseTypeDeclarationEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal SpaceAfterColonInBaseTypeDeclarationEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static SpaceAfterColonInBaseTypeDeclarationEntity DefaultInstance { get; } = ParsedJsonDocument<SpaceAfterColonInBaseTypeDeclarationEntity>.True;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(SpaceAfterColonInBaseTypeDeclarationEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in SpaceAfterColonInBaseTypeDeclarationEntity left, in SpaceAfterColonInBaseTypeDeclarationEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in SpaceAfterColonInBaseTypeDeclarationEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(SpaceAfterColonInBaseTypeDeclarationEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SpaceAfterColonInBaseTypeDeclarationEntity(JsonElement instance)
            {
                return SpaceAfterColonInBaseTypeDeclarationEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpaceAfterColonInBaseTypeDeclarationEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpaceAfterColonInBaseTypeDeclarationEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SpaceAfterColonInBaseTypeDeclarationEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpaceAfterColonInBaseTypeDeclarationEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SpaceAfterColonInBaseTypeDeclarationEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpaceAfterColonInBaseTypeDeclarationEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SpaceAfterColonInBaseTypeDeclarationEntity>(json, options);
            }
            ...
            /// </exception>
            public static SpaceAfterColonInBaseTypeDeclarationEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<SpaceAfterColonInBaseTypeDeclarationEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out SpaceAfterColonInBaseTypeDeclarationEntity? result)
            {
                return JsonElementHelpers.TryParseValue<SpaceAfterColonInBaseTypeDeclarationEntity>(ref reader, out result);
            }
...
#if NET
            static SpaceAfterColonInBaseTypeDeclarationEntity IJsonElement<SpaceAfterColonInBaseTypeDeclarationEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SpaceAfterColonInBaseTypeDeclarationEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public SpaceAfterColonInBaseTypeDeclarationEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public SpaceAfterColonInBaseTypeDeclarationEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<SpaceAfterColonInBaseTypeDeclarationEntity>(_idx);
                }
