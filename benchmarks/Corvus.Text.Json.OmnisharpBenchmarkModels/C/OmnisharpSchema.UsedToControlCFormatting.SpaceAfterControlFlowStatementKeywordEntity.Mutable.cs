    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct SpaceAfterControlFlowStatementKeywordEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SpaceAfterControlFlowStatementKeywordEntity, Mutable>(SpaceAfterControlFlowStatementKeywordEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(SpaceAfterControlFlowStatementKeywordEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SpaceAfterControlFlowStatementKeywordEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SpaceAfterControlFlowStatementKeywordEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SpaceAfterControlFlowStatementKeywordEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly SpaceAfterControlFlowStatementKeywordEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly SpaceAfterControlFlowStatementKeywordEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SpaceAfterControlFlowStatementKeywordEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SpaceAfterControlFlowStatementKeywordEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<SpaceAfterControlFlowStatementKeywordEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<SpaceAfterControlFlowStatementKeywordEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SpaceAfterControlFlowStatementKeywordEntity>();
                }
                finally
                {
