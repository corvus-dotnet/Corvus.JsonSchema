...
public readonly partial struct OmnisharpSchema
{
    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct SpaceAfterControlFlowStatementKeywordEntity
#if NET8_0_OR_GREATER
            : IJsonElement<SpaceAfterControlFlowStatementKeywordEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="SpaceAfterControlFlowStatementKeywordEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal SpaceAfterControlFlowStatementKeywordEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static SpaceAfterControlFlowStatementKeywordEntity DefaultInstance { get; } = ParsedJsonDocument<SpaceAfterControlFlowStatementKeywordEntity>.True;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(SpaceAfterControlFlowStatementKeywordEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in SpaceAfterControlFlowStatementKeywordEntity left, in SpaceAfterControlFlowStatementKeywordEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in SpaceAfterControlFlowStatementKeywordEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(SpaceAfterControlFlowStatementKeywordEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SpaceAfterControlFlowStatementKeywordEntity(JsonElement instance)
            {
                return SpaceAfterControlFlowStatementKeywordEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpaceAfterControlFlowStatementKeywordEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpaceAfterControlFlowStatementKeywordEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SpaceAfterControlFlowStatementKeywordEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpaceAfterControlFlowStatementKeywordEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SpaceAfterControlFlowStatementKeywordEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpaceAfterControlFlowStatementKeywordEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SpaceAfterControlFlowStatementKeywordEntity>(json, options);
            }
            ...
            /// </exception>
            public static SpaceAfterControlFlowStatementKeywordEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<SpaceAfterControlFlowStatementKeywordEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out SpaceAfterControlFlowStatementKeywordEntity? result)
            {
                return JsonElementHelpers.TryParseValue<SpaceAfterControlFlowStatementKeywordEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new SpaceAfterControlFlowStatementKeywordEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static SpaceAfterControlFlowStatementKeywordEntity IJsonElement<SpaceAfterControlFlowStatementKeywordEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SpaceAfterControlFlowStatementKeywordEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="SpaceAfterControlFlowStatementKeywordEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="SpaceAfterControlFlowStatementKeywordEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public SpaceAfterControlFlowStatementKeywordEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<SpaceAfterControlFlowStatementKeywordEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="SpaceAfterControlFlowStatementKeywordEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public SpaceAfterControlFlowStatementKeywordEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<SpaceAfterControlFlowStatementKeywordEntity>(_idx);
                }
