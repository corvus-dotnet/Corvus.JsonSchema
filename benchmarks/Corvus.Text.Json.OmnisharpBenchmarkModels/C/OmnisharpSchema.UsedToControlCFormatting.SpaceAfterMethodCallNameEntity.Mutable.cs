    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct SpaceAfterMethodCallNameEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SpaceAfterMethodCallNameEntity, Mutable>(SpaceAfterMethodCallNameEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(SpaceAfterMethodCallNameEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SpaceAfterMethodCallNameEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SpaceAfterMethodCallNameEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SpaceAfterMethodCallNameEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly SpaceAfterMethodCallNameEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly SpaceAfterMethodCallNameEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SpaceAfterMethodCallNameEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SpaceAfterMethodCallNameEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<SpaceAfterMethodCallNameEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<SpaceAfterMethodCallNameEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SpaceAfterMethodCallNameEntity>();
                }
                finally
                {
