...
public readonly partial struct OmnisharpSchema
{
    ...
    public readonly partial struct UsedToControlCFormatting
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="SpaceAfterMethodCallNameEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal SpaceAfterMethodCallNameEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static SpaceAfterMethodCallNameEntity DefaultInstance { get; } = ParsedJsonDocument<SpaceAfterMethodCallNameEntity>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(SpaceAfterMethodCallNameEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in SpaceAfterMethodCallNameEntity left, in SpaceAfterMethodCallNameEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in SpaceAfterMethodCallNameEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(SpaceAfterMethodCallNameEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SpaceAfterMethodCallNameEntity(JsonElement instance)
            {
                return SpaceAfterMethodCallNameEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpaceAfterMethodCallNameEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpaceAfterMethodCallNameEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SpaceAfterMethodCallNameEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpaceAfterMethodCallNameEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SpaceAfterMethodCallNameEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpaceAfterMethodCallNameEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SpaceAfterMethodCallNameEntity>(json, options);
            }
            ...
            /// </exception>
            public static SpaceAfterMethodCallNameEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<SpaceAfterMethodCallNameEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out SpaceAfterMethodCallNameEntity? result)
            {
                return JsonElementHelpers.TryParseValue<SpaceAfterMethodCallNameEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new SpaceAfterMethodCallNameEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static SpaceAfterMethodCallNameEntity IJsonElement<SpaceAfterMethodCallNameEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SpaceAfterMethodCallNameEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="SpaceAfterMethodCallNameEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="SpaceAfterMethodCallNameEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public SpaceAfterMethodCallNameEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<SpaceAfterMethodCallNameEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="SpaceAfterMethodCallNameEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public SpaceAfterMethodCallNameEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<SpaceAfterMethodCallNameEntity>(_idx);
                }
