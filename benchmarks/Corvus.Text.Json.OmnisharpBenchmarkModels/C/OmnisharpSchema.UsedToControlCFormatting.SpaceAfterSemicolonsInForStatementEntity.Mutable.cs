    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct SpaceAfterSemicolonsInForStatementEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SpaceAfterSemicolonsInForStatementEntity, Mutable>(SpaceAfterSemicolonsInForStatementEntity.DefaultInstance);
            ...
            public static ParsedJsonDocument<SpaceAfterSemicolonsInForStatementEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SpaceAfterSemicolonsInForStatementEntity>();
                }
                finally
                {
