...
public readonly partial struct OmnisharpSchema
{
    ...
    public readonly partial struct UsedToControlCFormatting
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="SpaceAfterSemicolonsInForStatementEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal SpaceAfterSemicolonsInForStatementEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static SpaceAfterSemicolonsInForStatementEntity DefaultInstance { get; } = ParsedJsonDocument<SpaceAfterSemicolonsInForStatementEntity>.True;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(SpaceAfterSemicolonsInForStatementEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in SpaceAfterSemicolonsInForStatementEntity left, in SpaceAfterSemicolonsInForStatementEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in SpaceAfterSemicolonsInForStatementEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(SpaceAfterSemicolonsInForStatementEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SpaceAfterSemicolonsInForStatementEntity(JsonElement instance)
            {
                return SpaceAfterSemicolonsInForStatementEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpaceAfterSemicolonsInForStatementEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpaceAfterSemicolonsInForStatementEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SpaceAfterSemicolonsInForStatementEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpaceAfterSemicolonsInForStatementEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SpaceAfterSemicolonsInForStatementEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpaceAfterSemicolonsInForStatementEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SpaceAfterSemicolonsInForStatementEntity>(json, options);
            }
            ...
            /// </exception>
            public static SpaceAfterSemicolonsInForStatementEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<SpaceAfterSemicolonsInForStatementEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out SpaceAfterSemicolonsInForStatementEntity? result)
            {
                return JsonElementHelpers.TryParseValue<SpaceAfterSemicolonsInForStatementEntity>(ref reader, out result);
            }
...
#if NET
            static SpaceAfterSemicolonsInForStatementEntity IJsonElement<SpaceAfterSemicolonsInForStatementEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SpaceAfterSemicolonsInForStatementEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public SpaceAfterSemicolonsInForStatementEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public SpaceAfterSemicolonsInForStatementEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<SpaceAfterSemicolonsInForStatementEntity>(_idx);
                }
