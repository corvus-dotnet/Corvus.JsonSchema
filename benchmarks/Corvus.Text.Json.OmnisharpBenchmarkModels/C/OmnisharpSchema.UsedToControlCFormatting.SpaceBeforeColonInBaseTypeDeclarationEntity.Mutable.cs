...
public readonly partial struct OmnisharpSchema
{
    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct SpaceBeforeColonInBaseTypeDeclarationEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SpaceBeforeColonInBaseTypeDeclarationEntity, Mutable>(SpaceBeforeColonInBaseTypeDeclarationEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(SpaceBeforeColonInBaseTypeDeclarationEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SpaceBeforeColonInBaseTypeDeclarationEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SpaceBeforeColonInBaseTypeDeclarationEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new SpaceBeforeColonInBaseTypeDeclarationEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SpaceBeforeColonInBaseTypeDeclarationEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="SpaceBeforeColonInBaseTypeDeclarationEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="SpaceBeforeColonInBaseTypeDeclarationEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly SpaceBeforeColonInBaseTypeDeclarationEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<SpaceBeforeColonInBaseTypeDeclarationEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="SpaceBeforeColonInBaseTypeDeclarationEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly SpaceBeforeColonInBaseTypeDeclarationEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SpaceBeforeColonInBaseTypeDeclarationEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SpaceBeforeColonInBaseTypeDeclarationEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<SpaceBeforeColonInBaseTypeDeclarationEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<SpaceBeforeColonInBaseTypeDeclarationEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SpaceBeforeColonInBaseTypeDeclarationEntity>();
                }
                finally
                {
