    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct SpaceBeforeDotEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SpaceBeforeDotEntity, Mutable>(SpaceBeforeDotEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(SpaceBeforeDotEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SpaceBeforeDotEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SpaceBeforeDotEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SpaceBeforeDotEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly SpaceBeforeDotEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly SpaceBeforeDotEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SpaceBeforeDotEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SpaceBeforeDotEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<SpaceBeforeDotEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<SpaceBeforeDotEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SpaceBeforeDotEntity>();
                }
                finally
                {
