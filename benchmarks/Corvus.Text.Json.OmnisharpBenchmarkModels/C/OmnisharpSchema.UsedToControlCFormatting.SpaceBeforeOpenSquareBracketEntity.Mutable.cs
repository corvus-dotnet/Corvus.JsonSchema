    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct SpaceBeforeOpenSquareBracketEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SpaceBeforeOpenSquareBracketEntity, Mutable>(SpaceBeforeOpenSquareBracketEntity.DefaultInstance);
            ...
            public static ParsedJsonDocument<SpaceBeforeOpenSquareBracketEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SpaceBeforeOpenSquareBracketEntity>();
                }
                finally
                {
