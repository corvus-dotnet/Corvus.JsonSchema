...
public readonly partial struct OmnisharpSchema
{
    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct SpaceBeforeOpenSquareBracketEntity
#if NET8_0_OR_GREATER
            : IJsonElement<SpaceBeforeOpenSquareBracketEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="SpaceBeforeOpenSquareBracketEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal SpaceBeforeOpenSquareBracketEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static SpaceBeforeOpenSquareBracketEntity DefaultInstance { get; } = ParsedJsonDocument<SpaceBeforeOpenSquareBracketEntity>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(SpaceBeforeOpenSquareBracketEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in SpaceBeforeOpenSquareBracketEntity left, in SpaceBeforeOpenSquareBracketEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in SpaceBeforeOpenSquareBracketEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(SpaceBeforeOpenSquareBracketEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SpaceBeforeOpenSquareBracketEntity(JsonElement instance)
            {
                return SpaceBeforeOpenSquareBracketEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpaceBeforeOpenSquareBracketEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpaceBeforeOpenSquareBracketEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SpaceBeforeOpenSquareBracketEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpaceBeforeOpenSquareBracketEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SpaceBeforeOpenSquareBracketEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpaceBeforeOpenSquareBracketEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SpaceBeforeOpenSquareBracketEntity>(json, options);
            }
            ...
            /// </exception>
            public static SpaceBeforeOpenSquareBracketEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<SpaceBeforeOpenSquareBracketEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out SpaceBeforeOpenSquareBracketEntity? result)
            {
                return JsonElementHelpers.TryParseValue<SpaceBeforeOpenSquareBracketEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new SpaceBeforeOpenSquareBracketEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static SpaceBeforeOpenSquareBracketEntity IJsonElement<SpaceBeforeOpenSquareBracketEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SpaceBeforeOpenSquareBracketEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="SpaceBeforeOpenSquareBracketEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="SpaceBeforeOpenSquareBracketEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public SpaceBeforeOpenSquareBracketEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<SpaceBeforeOpenSquareBracketEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="SpaceBeforeOpenSquareBracketEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public SpaceBeforeOpenSquareBracketEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<SpaceBeforeOpenSquareBracketEntity>(_idx);
                }
