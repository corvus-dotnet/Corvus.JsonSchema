...
public readonly partial struct OmnisharpSchema
{
    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct SpaceBeforeSemicolonsInForStatementEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SpaceBeforeSemicolonsInForStatementEntity, Mutable>(SpaceBeforeSemicolonsInForStatementEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(SpaceBeforeSemicolonsInForStatementEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SpaceBeforeSemicolonsInForStatementEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SpaceBeforeSemicolonsInForStatementEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new SpaceBeforeSemicolonsInForStatementEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SpaceBeforeSemicolonsInForStatementEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="SpaceBeforeSemicolonsInForStatementEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="SpaceBeforeSemicolonsInForStatementEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly SpaceBeforeSemicolonsInForStatementEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<SpaceBeforeSemicolonsInForStatementEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="SpaceBeforeSemicolonsInForStatementEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly SpaceBeforeSemicolonsInForStatementEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SpaceBeforeSemicolonsInForStatementEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SpaceBeforeSemicolonsInForStatementEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<SpaceBeforeSemicolonsInForStatementEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<SpaceBeforeSemicolonsInForStatementEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SpaceBeforeSemicolonsInForStatementEntity>();
                }
                finally
                {
