...
public readonly partial struct OmnisharpSchema
{
    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct SpaceBeforeSemicolonsInForStatementEntity
            ...
            : IJsonElement<SpaceBeforeSemicolonsInForStatementEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="SpaceBeforeSemicolonsInForStatementEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal SpaceBeforeSemicolonsInForStatementEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static SpaceBeforeSemicolonsInForStatementEntity DefaultInstance { get; } = ParsedJsonDocument<SpaceBeforeSemicolonsInForStatementEntity>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(SpaceBeforeSemicolonsInForStatementEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in SpaceBeforeSemicolonsInForStatementEntity left, in SpaceBeforeSemicolonsInForStatementEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in SpaceBeforeSemicolonsInForStatementEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(SpaceBeforeSemicolonsInForStatementEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SpaceBeforeSemicolonsInForStatementEntity(JsonElement instance)
            {
                return SpaceBeforeSemicolonsInForStatementEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpaceBeforeSemicolonsInForStatementEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpaceBeforeSemicolonsInForStatementEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SpaceBeforeSemicolonsInForStatementEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpaceBeforeSemicolonsInForStatementEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SpaceBeforeSemicolonsInForStatementEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpaceBeforeSemicolonsInForStatementEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SpaceBeforeSemicolonsInForStatementEntity>(json, options);
            }
            ...
            /// </exception>
            public static SpaceBeforeSemicolonsInForStatementEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<SpaceBeforeSemicolonsInForStatementEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out SpaceBeforeSemicolonsInForStatementEntity? result)
            {
                return JsonElementHelpers.TryParseValue<SpaceBeforeSemicolonsInForStatementEntity>(ref reader, out result);
            }
...
#if NET
            static SpaceBeforeSemicolonsInForStatementEntity IJsonElement<SpaceBeforeSemicolonsInForStatementEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SpaceBeforeSemicolonsInForStatementEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public SpaceBeforeSemicolonsInForStatementEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public SpaceBeforeSemicolonsInForStatementEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<SpaceBeforeSemicolonsInForStatementEntity>(_idx);
                }
