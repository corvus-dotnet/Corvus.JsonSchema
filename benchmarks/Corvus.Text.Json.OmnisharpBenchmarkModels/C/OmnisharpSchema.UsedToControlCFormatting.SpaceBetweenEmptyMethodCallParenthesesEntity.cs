...
public readonly partial struct OmnisharpSchema
{
    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct SpaceBetweenEmptyMethodCallParenthesesEntity
            ...
            : IJsonElement<SpaceBetweenEmptyMethodCallParenthesesEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="SpaceBetweenEmptyMethodCallParenthesesEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal SpaceBetweenEmptyMethodCallParenthesesEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static SpaceBetweenEmptyMethodCallParenthesesEntity DefaultInstance { get; } = ParsedJsonDocument<SpaceBetweenEmptyMethodCallParenthesesEntity>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(SpaceBetweenEmptyMethodCallParenthesesEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in SpaceBetweenEmptyMethodCallParenthesesEntity left, in SpaceBetweenEmptyMethodCallParenthesesEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in SpaceBetweenEmptyMethodCallParenthesesEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(SpaceBetweenEmptyMethodCallParenthesesEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SpaceBetweenEmptyMethodCallParenthesesEntity(JsonElement instance)
            {
                return SpaceBetweenEmptyMethodCallParenthesesEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpaceBetweenEmptyMethodCallParenthesesEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpaceBetweenEmptyMethodCallParenthesesEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SpaceBetweenEmptyMethodCallParenthesesEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpaceBetweenEmptyMethodCallParenthesesEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SpaceBetweenEmptyMethodCallParenthesesEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpaceBetweenEmptyMethodCallParenthesesEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SpaceBetweenEmptyMethodCallParenthesesEntity>(json, options);
            }
            ...
            /// </exception>
            public static SpaceBetweenEmptyMethodCallParenthesesEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<SpaceBetweenEmptyMethodCallParenthesesEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out SpaceBetweenEmptyMethodCallParenthesesEntity? result)
            {
                return JsonElementHelpers.TryParseValue<SpaceBetweenEmptyMethodCallParenthesesEntity>(ref reader, out result);
            }
...
#if NET
            static SpaceBetweenEmptyMethodCallParenthesesEntity IJsonElement<SpaceBetweenEmptyMethodCallParenthesesEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SpaceBetweenEmptyMethodCallParenthesesEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public SpaceBetweenEmptyMethodCallParenthesesEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public SpaceBetweenEmptyMethodCallParenthesesEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<SpaceBetweenEmptyMethodCallParenthesesEntity>(_idx);
                }
