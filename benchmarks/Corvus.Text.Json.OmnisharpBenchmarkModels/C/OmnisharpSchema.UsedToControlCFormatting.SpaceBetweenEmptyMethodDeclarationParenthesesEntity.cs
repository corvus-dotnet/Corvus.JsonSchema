...
public readonly partial struct OmnisharpSchema
{
    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct SpaceBetweenEmptyMethodDeclarationParenthesesEntity
            ...
            : IJsonElement<SpaceBetweenEmptyMethodDeclarationParenthesesEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="SpaceBetweenEmptyMethodDeclarationParenthesesEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal SpaceBetweenEmptyMethodDeclarationParenthesesEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static SpaceBetweenEmptyMethodDeclarationParenthesesEntity DefaultInstance { get; } = ParsedJsonDocument<SpaceBetweenEmptyMethodDeclarationParenthesesEntity>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(SpaceBetweenEmptyMethodDeclarationParenthesesEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in SpaceBetweenEmptyMethodDeclarationParenthesesEntity left, in SpaceBetweenEmptyMethodDeclarationParenthesesEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in SpaceBetweenEmptyMethodDeclarationParenthesesEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(SpaceBetweenEmptyMethodDeclarationParenthesesEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SpaceBetweenEmptyMethodDeclarationParenthesesEntity(JsonElement instance)
            {
                return SpaceBetweenEmptyMethodDeclarationParenthesesEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpaceBetweenEmptyMethodDeclarationParenthesesEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpaceBetweenEmptyMethodDeclarationParenthesesEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SpaceBetweenEmptyMethodDeclarationParenthesesEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpaceBetweenEmptyMethodDeclarationParenthesesEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SpaceBetweenEmptyMethodDeclarationParenthesesEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpaceBetweenEmptyMethodDeclarationParenthesesEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SpaceBetweenEmptyMethodDeclarationParenthesesEntity>(json, options);
            }
            ...
            /// </exception>
            public static SpaceBetweenEmptyMethodDeclarationParenthesesEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<SpaceBetweenEmptyMethodDeclarationParenthesesEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out SpaceBetweenEmptyMethodDeclarationParenthesesEntity? result)
            {
                return JsonElementHelpers.TryParseValue<SpaceBetweenEmptyMethodDeclarationParenthesesEntity>(ref reader, out result);
            }
...
#if NET
            static SpaceBetweenEmptyMethodDeclarationParenthesesEntity IJsonElement<SpaceBetweenEmptyMethodDeclarationParenthesesEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SpaceBetweenEmptyMethodDeclarationParenthesesEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public SpaceBetweenEmptyMethodDeclarationParenthesesEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public SpaceBetweenEmptyMethodDeclarationParenthesesEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<SpaceBetweenEmptyMethodDeclarationParenthesesEntity>(_idx);
                }
