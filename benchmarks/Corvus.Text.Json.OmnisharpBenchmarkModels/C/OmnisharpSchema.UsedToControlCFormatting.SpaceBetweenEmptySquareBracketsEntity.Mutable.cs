    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct SpaceBetweenEmptySquareBracketsEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SpaceBetweenEmptySquareBracketsEntity, Mutable>(SpaceBetweenEmptySquareBracketsEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(SpaceBetweenEmptySquareBracketsEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SpaceBetweenEmptySquareBracketsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SpaceBetweenEmptySquareBracketsEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SpaceBetweenEmptySquareBracketsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly SpaceBetweenEmptySquareBracketsEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly SpaceBetweenEmptySquareBracketsEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SpaceBetweenEmptySquareBracketsEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SpaceBetweenEmptySquareBracketsEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<SpaceBetweenEmptySquareBracketsEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<SpaceBetweenEmptySquareBracketsEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SpaceBetweenEmptySquareBracketsEntity>();
                }
                finally
                {
