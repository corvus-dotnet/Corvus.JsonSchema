...
public readonly partial struct OmnisharpSchema
{
    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct SpaceBetweenEmptySquareBracketsEntity
#if NET8_0_OR_GREATER
            : IJsonElement<SpaceBetweenEmptySquareBracketsEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="SpaceBetweenEmptySquareBracketsEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal SpaceBetweenEmptySquareBracketsEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static SpaceBetweenEmptySquareBracketsEntity DefaultInstance { get; } = ParsedJsonDocument<SpaceBetweenEmptySquareBracketsEntity>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(SpaceBetweenEmptySquareBracketsEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in SpaceBetweenEmptySquareBracketsEntity left, in SpaceBetweenEmptySquareBracketsEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in SpaceBetweenEmptySquareBracketsEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(SpaceBetweenEmptySquareBracketsEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SpaceBetweenEmptySquareBracketsEntity(JsonElement instance)
            {
                return SpaceBetweenEmptySquareBracketsEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpaceBetweenEmptySquareBracketsEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpaceBetweenEmptySquareBracketsEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SpaceBetweenEmptySquareBracketsEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpaceBetweenEmptySquareBracketsEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SpaceBetweenEmptySquareBracketsEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpaceBetweenEmptySquareBracketsEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SpaceBetweenEmptySquareBracketsEntity>(json, options);
            }
            ...
            /// </exception>
            public static SpaceBetweenEmptySquareBracketsEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<SpaceBetweenEmptySquareBracketsEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out SpaceBetweenEmptySquareBracketsEntity? result)
            {
                return JsonElementHelpers.TryParseValue<SpaceBetweenEmptySquareBracketsEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new SpaceBetweenEmptySquareBracketsEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static SpaceBetweenEmptySquareBracketsEntity IJsonElement<SpaceBetweenEmptySquareBracketsEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SpaceBetweenEmptySquareBracketsEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="SpaceBetweenEmptySquareBracketsEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="SpaceBetweenEmptySquareBracketsEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public SpaceBetweenEmptySquareBracketsEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<SpaceBetweenEmptySquareBracketsEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="SpaceBetweenEmptySquareBracketsEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public SpaceBetweenEmptySquareBracketsEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<SpaceBetweenEmptySquareBracketsEntity>(_idx);
                }
