    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct SpaceWithinCastParenthesesEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SpaceWithinCastParenthesesEntity, Mutable>(SpaceWithinCastParenthesesEntity.DefaultInstance);
            ...
            public static ParsedJsonDocument<SpaceWithinCastParenthesesEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SpaceWithinCastParenthesesEntity>();
                }
                finally
                {
