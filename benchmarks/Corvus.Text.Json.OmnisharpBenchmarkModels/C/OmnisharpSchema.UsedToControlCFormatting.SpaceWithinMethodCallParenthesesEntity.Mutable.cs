    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct SpaceWithinMethodCallParenthesesEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SpaceWithinMethodCallParenthesesEntity, Mutable>(SpaceWithinMethodCallParenthesesEntity.DefaultInstance);
            ...
            public static ParsedJsonDocument<SpaceWithinMethodCallParenthesesEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SpaceWithinMethodCallParenthesesEntity>();
                }
                finally
                {
