    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct SpaceWithinOtherParenthesesEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SpaceWithinOtherParenthesesEntity, Mutable>(SpaceWithinOtherParenthesesEntity.DefaultInstance);
            ...
            public static ParsedJsonDocument<SpaceWithinOtherParenthesesEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SpaceWithinOtherParenthesesEntity>();
                }
                finally
                {
