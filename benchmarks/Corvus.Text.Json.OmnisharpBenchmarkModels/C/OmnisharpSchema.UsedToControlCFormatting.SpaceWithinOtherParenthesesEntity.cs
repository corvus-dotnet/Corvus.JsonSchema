...
public readonly partial struct OmnisharpSchema
{
    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct SpaceWithinOtherParenthesesEntity
#if NET8_0_OR_GREATER
            : IJsonElement<SpaceWithinOtherParenthesesEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="SpaceWithinOtherParenthesesEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal SpaceWithinOtherParenthesesEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static SpaceWithinOtherParenthesesEntity DefaultInstance { get; } = ParsedJsonDocument<SpaceWithinOtherParenthesesEntity>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(SpaceWithinOtherParenthesesEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in SpaceWithinOtherParenthesesEntity left, in SpaceWithinOtherParenthesesEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in SpaceWithinOtherParenthesesEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(SpaceWithinOtherParenthesesEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SpaceWithinOtherParenthesesEntity(JsonElement instance)
            {
                return SpaceWithinOtherParenthesesEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpaceWithinOtherParenthesesEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpaceWithinOtherParenthesesEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SpaceWithinOtherParenthesesEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpaceWithinOtherParenthesesEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SpaceWithinOtherParenthesesEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SpaceWithinOtherParenthesesEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SpaceWithinOtherParenthesesEntity>(json, options);
            }
            ...
            /// </exception>
            public static SpaceWithinOtherParenthesesEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<SpaceWithinOtherParenthesesEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out SpaceWithinOtherParenthesesEntity? result)
            {
                return JsonElementHelpers.TryParseValue<SpaceWithinOtherParenthesesEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new SpaceWithinOtherParenthesesEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static SpaceWithinOtherParenthesesEntity IJsonElement<SpaceWithinOtherParenthesesEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SpaceWithinOtherParenthesesEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="SpaceWithinOtherParenthesesEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="SpaceWithinOtherParenthesesEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public SpaceWithinOtherParenthesesEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<SpaceWithinOtherParenthesesEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="SpaceWithinOtherParenthesesEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public SpaceWithinOtherParenthesesEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<SpaceWithinOtherParenthesesEntity>(_idx);
                }
