    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct SpacesIgnoreAroundVariableDeclarationEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(SpacesIgnoreAroundVariableDeclarationEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SpacesIgnoreAroundVariableDeclarationEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SpacesIgnoreAroundVariableDeclarationEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SpacesIgnoreAroundVariableDeclarationEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly SpacesIgnoreAroundVariableDeclarationEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly SpacesIgnoreAroundVariableDeclarationEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SpacesIgnoreAroundVariableDeclarationEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SpacesIgnoreAroundVariableDeclarationEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<SpacesIgnoreAroundVariableDeclarationEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<SpacesIgnoreAroundVariableDeclarationEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SpacesIgnoreAroundVariableDeclarationEntity>();
                }
                finally
                {
