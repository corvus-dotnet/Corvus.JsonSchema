    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct SpacingAfterMethodDeclarationNameEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SpacingAfterMethodDeclarationNameEntity, Mutable>(SpacingAfterMethodDeclarationNameEntity.DefaultInstance);
            ...
            public static ParsedJsonDocument<SpacingAfterMethodDeclarationNameEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SpacingAfterMethodDeclarationNameEntity>();
                }
                finally
                {
