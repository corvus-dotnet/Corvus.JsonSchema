...
public readonly partial struct OmnisharpSchema
{
    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct TabSizeEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<TabSizeEntity, Mutable>(TabSizeEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(TabSizeEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TabSizeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TabSizeEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new TabSizeEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TabSizeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="TabSizeEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="TabSizeEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly TabSizeEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<TabSizeEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="TabSizeEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly TabSizeEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TabSizeEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(TabSizeEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<TabSizeEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<TabSizeEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TabSizeEntity>();
                }
                finally
                {
