    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct WrappingKeepStatementsOnSingleLineEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<WrappingKeepStatementsOnSingleLineEntity, Mutable>(WrappingKeepStatementsOnSingleLineEntity.DefaultInstance);
            ...
            public static ParsedJsonDocument<WrappingKeepStatementsOnSingleLineEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<WrappingKeepStatementsOnSingleLineEntity>();
                }
                finally
                {
