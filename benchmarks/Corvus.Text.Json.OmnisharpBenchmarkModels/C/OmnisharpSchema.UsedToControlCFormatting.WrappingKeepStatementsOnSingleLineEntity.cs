...
public readonly partial struct OmnisharpSchema
{
    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct WrappingKeepStatementsOnSingleLineEntity
#if NET8_0_OR_GREATER
            : IJsonElement<WrappingKeepStatementsOnSingleLineEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="WrappingKeepStatementsOnSingleLineEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal WrappingKeepStatementsOnSingleLineEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static WrappingKeepStatementsOnSingleLineEntity DefaultInstance { get; } = ParsedJsonDocument<WrappingKeepStatementsOnSingleLineEntity>.True;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(WrappingKeepStatementsOnSingleLineEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in WrappingKeepStatementsOnSingleLineEntity left, in WrappingKeepStatementsOnSingleLineEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in WrappingKeepStatementsOnSingleLineEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(WrappingKeepStatementsOnSingleLineEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator WrappingKeepStatementsOnSingleLineEntity(JsonElement instance)
            {
                return WrappingKeepStatementsOnSingleLineEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WrappingKeepStatementsOnSingleLineEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WrappingKeepStatementsOnSingleLineEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<WrappingKeepStatementsOnSingleLineEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WrappingKeepStatementsOnSingleLineEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<WrappingKeepStatementsOnSingleLineEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WrappingKeepStatementsOnSingleLineEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<WrappingKeepStatementsOnSingleLineEntity>(json, options);
            }
            ...
            /// </exception>
            public static WrappingKeepStatementsOnSingleLineEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<WrappingKeepStatementsOnSingleLineEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out WrappingKeepStatementsOnSingleLineEntity? result)
            {
                return JsonElementHelpers.TryParseValue<WrappingKeepStatementsOnSingleLineEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new WrappingKeepStatementsOnSingleLineEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static WrappingKeepStatementsOnSingleLineEntity IJsonElement<WrappingKeepStatementsOnSingleLineEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"WrappingKeepStatementsOnSingleLineEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="WrappingKeepStatementsOnSingleLineEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="WrappingKeepStatementsOnSingleLineEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public WrappingKeepStatementsOnSingleLineEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<WrappingKeepStatementsOnSingleLineEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="WrappingKeepStatementsOnSingleLineEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public WrappingKeepStatementsOnSingleLineEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<WrappingKeepStatementsOnSingleLineEntity>(_idx);
                }
