    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct WrappingPreserveSingleLineEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<WrappingPreserveSingleLineEntity, Mutable>(WrappingPreserveSingleLineEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(WrappingPreserveSingleLineEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="WrappingPreserveSingleLineEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator WrappingPreserveSingleLineEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"WrappingPreserveSingleLineEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly WrappingPreserveSingleLineEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly WrappingPreserveSingleLineEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<WrappingPreserveSingleLineEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(WrappingPreserveSingleLineEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<WrappingPreserveSingleLineEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<WrappingPreserveSingleLineEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<WrappingPreserveSingleLineEntity>();
                }
                finally
                {
