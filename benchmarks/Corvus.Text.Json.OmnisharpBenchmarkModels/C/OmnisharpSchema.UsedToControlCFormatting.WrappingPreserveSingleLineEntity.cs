...
public readonly partial struct OmnisharpSchema
{
    ...
    public readonly partial struct UsedToControlCFormatting
    {
        ...
        public readonly partial struct WrappingPreserveSingleLineEntity
#if NET8_0_OR_GREATER
            : IJsonElement<WrappingPreserveSingleLineEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="WrappingPreserveSingleLineEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal WrappingPreserveSingleLineEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static WrappingPreserveSingleLineEntity DefaultInstance { get; } = ParsedJsonDocument<WrappingPreserveSingleLineEntity>.True;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(WrappingPreserveSingleLineEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in WrappingPreserveSingleLineEntity left, in WrappingPreserveSingleLineEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in WrappingPreserveSingleLineEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(WrappingPreserveSingleLineEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator WrappingPreserveSingleLineEntity(JsonElement instance)
            {
                return WrappingPreserveSingleLineEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WrappingPreserveSingleLineEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WrappingPreserveSingleLineEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<WrappingPreserveSingleLineEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WrappingPreserveSingleLineEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<WrappingPreserveSingleLineEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WrappingPreserveSingleLineEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<WrappingPreserveSingleLineEntity>(json, options);
            }
            ...
            /// </exception>
            public static WrappingPreserveSingleLineEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<WrappingPreserveSingleLineEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out WrappingPreserveSingleLineEntity? result)
            {
                return JsonElementHelpers.TryParseValue<WrappingPreserveSingleLineEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new WrappingPreserveSingleLineEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static WrappingPreserveSingleLineEntity IJsonElement<WrappingPreserveSingleLineEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"WrappingPreserveSingleLineEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="WrappingPreserveSingleLineEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="WrappingPreserveSingleLineEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public WrappingPreserveSingleLineEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<WrappingPreserveSingleLineEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="WrappingPreserveSingleLineEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public WrappingPreserveSingleLineEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<WrappingPreserveSingleLineEntity>(_idx);
                }
