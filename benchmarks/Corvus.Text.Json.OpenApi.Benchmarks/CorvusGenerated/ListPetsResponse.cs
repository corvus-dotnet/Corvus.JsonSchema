...
public struct ListPetsResponse : IApiResponse<ListPetsResponse>
{
    ...
    /// </summary>
    public PetstoreBenchmark.CorvusClient.Pets OkBody { get; private set; }
    ...
    public PetstoreBenchmark.CorvusClient.JsonString XNextHeader
    {
        get
        {
            ...
            {
                this.xNextHeaderValue = Corvus.Text.Json.OpenApi.HeaderValueParser.ParseString<PetstoreBenchmark.CorvusClient.JsonString>(rawValue, this.workspace);
            }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (statusCode == 200)
        {
            var okDoc = await ParsedJsonDocument<PetstoreBenchmark.CorvusClient.Pets>.ParseAsync(contentStream, default, cancellationToken).ConfigureAwait(false);
    ...
    public bool TryGetOk(out PetstoreBenchmark.CorvusClient.Pets result)
    {
    ...
    public TResult MatchResult<TResult>(
        ResponseMatcher<PetstoreBenchmark.CorvusClient.Pets, TResult> matchOk,
    ...
    public TResult MatchResult<TContext, TResult>(
        in TContext context,
        ResponseMatcher<PetstoreBenchmark.CorvusClient.Pets, TContext, TResult> matchOk,
