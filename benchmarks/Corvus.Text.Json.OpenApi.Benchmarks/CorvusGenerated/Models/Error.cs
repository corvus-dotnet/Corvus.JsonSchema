...
#endif
{
    ...
    internal Error(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static Error DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public PetstoreBenchmark.CorvusClient.JsonInt32 Code
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CodeUtf8, out PetstoreBenchmark.CorvusClient.JsonInt32 value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public PetstoreBenchmark.CorvusClient.JsonString Message
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MessageUtf8, out PetstoreBenchmark.CorvusClient.JsonString value))
            {
                return value;
            }
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in Error left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(Error instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator Error(JsonElement instance)
    {
        return Error.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Error From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Error ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<Error>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Error ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<Error>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Error ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<Error>(json, options);
    }
    ...
    /// </exception>
    public static Error ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<Error>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out Error? result)
    {
        return JsonElementHelpers.TryParseValue<Error>(ref reader, out result);
    }
...
#if NET
    static Error IJsonElement<Error>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"Error: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    public Error Freeze()
    {
        ...
        {
            return mutable.FreezeElement<Error>(_idx);
        }
