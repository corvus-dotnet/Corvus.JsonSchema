...
public readonly partial struct NewPet
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public PetstoreBenchmark.CorvusClient.JsonString.Mutable Name
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out PetstoreBenchmark.CorvusClient.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public PetstoreBenchmark.CorvusClient.JsonString.Mutable Tag
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TagUtf8, out PetstoreBenchmark.CorvusClient.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        public void SetName(in PetstoreBenchmark.CorvusClient.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTag(in PetstoreBenchmark.CorvusClient.JsonString.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(PetstoreBenchmark.CorvusClient.NewPet.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, PetstoreBenchmark.CorvusClient.NewPet.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in PetstoreBenchmark.CorvusClient.JsonString.Source name,
            in PetstoreBenchmark.CorvusClient.JsonString.Source tag = default)
        {
        ...
        /// Creates an instance of a <see cref="NewPet"/>.
        /// </summary>
        public void Create(in PetstoreBenchmark.CorvusClient.JsonString.Source name, in PetstoreBenchmark.CorvusClient.JsonString.Source tag = default)
        {
            Create(ref _builder, name, tag);
        }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in PetstoreBenchmark.CorvusClient.JsonString.Source name, in PetstoreBenchmark.CorvusClient.JsonString.Source tag = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
