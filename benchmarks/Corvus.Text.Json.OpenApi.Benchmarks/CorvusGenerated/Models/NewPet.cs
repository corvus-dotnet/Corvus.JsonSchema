...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public PetstoreBenchmark.CorvusClient.JsonString Name
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out PetstoreBenchmark.CorvusClient.JsonString value))
            {
                return value;
            }
    ...
    /// </summary>
    public PetstoreBenchmark.CorvusClient.JsonString Tag
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TagUtf8, out PetstoreBenchmark.CorvusClient.JsonString value))
            {
                return value;
            }
