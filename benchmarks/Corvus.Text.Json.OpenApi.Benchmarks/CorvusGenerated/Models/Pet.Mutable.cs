...
public readonly partial struct Pet
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public PetstoreBenchmark.CorvusClient.JsonInt64.Mutable Id
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IdUtf8, out PetstoreBenchmark.CorvusClient.JsonInt64.Mutable value))
                {
                    return value;
                }
        ...
        public void SetId(in PetstoreBenchmark.CorvusClient.JsonInt64.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(PetstoreBenchmark.CorvusClient.Pet.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, PetstoreBenchmark.CorvusClient.Pet.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in PetstoreBenchmark.CorvusClient.JsonInt64.Source id,
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in PetstoreBenchmark.CorvusClient.JsonInt64.Source id, in PetstoreBenchmark.CorvusClient.JsonString.Source name, in PetstoreBenchmark.CorvusClient.JsonString.Source tag = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
