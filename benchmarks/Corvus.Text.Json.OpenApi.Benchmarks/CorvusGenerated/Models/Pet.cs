...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public PetstoreBenchmark.CorvusClient.JsonInt64 Id
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IdUtf8, out PetstoreBenchmark.CorvusClient.JsonInt64 value))
            {
                return value;
            }
