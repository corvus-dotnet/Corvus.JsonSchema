...
public readonly partial struct Pets
{
...
#endif
    {
        ...
        public PetstoreBenchmark.CorvusClient.Pet.Mutable this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<PetstoreBenchmark.CorvusClient.Pet.Mutable>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<PetstoreBenchmark.CorvusClient.Pet.Mutable> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<PetstoreBenchmark.CorvusClient.Pet.Mutable>(_parent, _idx);
        }
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetItem(int itemIndex, in PetstoreBenchmark.CorvusClient.Pet.Source value)
        {
            CheckValidInstance();
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void InsertItem(int itemIndex, in PetstoreBenchmark.CorvusClient.Pet.Source value)
        {
            CheckValidInstance();
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void AddItem(in PetstoreBenchmark.CorvusClient.Pet.Source value)
        {
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool Remove(in PetstoreBenchmark.CorvusClient.Pet item)
        {
            CheckValidInstance();
            if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, PetstoreBenchmark.CorvusClient.Pet>(this, in item))
            {
                return false;
            }
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void RemoveWhere(JsonPredicate<PetstoreBenchmark.CorvusClient.Pet> predicate)
        {
            CheckValidInstance();
            JsonElementHelpers.RemoveWhereUnsafe<Mutable, PetstoreBenchmark.CorvusClient.Pet>(this, predicate);
            _documentVersion = _parent.Version;
        }
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool Replace(in PetstoreBenchmark.CorvusClient.Pet oldItem, in PetstoreBenchmark.CorvusClient.Pet.Source newItem)
        {
            CheckValidInstance();
            ...
            var enumerator = EnumeratorCreator.CreateArrayEnumerator<PetstoreBenchmark.CorvusClient.Pet>(_parent, _idx);

            while (enumerator.MoveNext())
            {
                PetstoreBenchmark.CorvusClient.Pet current = enumerator.Current;
    ...
    public ref struct Source
    {
        ...
        internal Source(PetstoreBenchmark.CorvusClient.Pets.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, PetstoreBenchmark.CorvusClient.Pets.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
