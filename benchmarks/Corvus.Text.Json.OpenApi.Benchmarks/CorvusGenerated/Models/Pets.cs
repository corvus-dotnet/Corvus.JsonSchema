...
#endif
{
    ...
    public PetstoreBenchmark.CorvusClient.Pet this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<PetstoreBenchmark.CorvusClient.Pet>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<PetstoreBenchmark.CorvusClient.Pet> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<PetstoreBenchmark.CorvusClient.Pet>(_parent, _idx);
    }
