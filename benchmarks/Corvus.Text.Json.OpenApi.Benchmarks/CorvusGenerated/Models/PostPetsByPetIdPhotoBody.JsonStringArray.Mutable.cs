...
/// </summary>
public readonly partial struct PostPetsByPetIdPhotoBody
{
    /// <summary>
    /// Generated from JSON Schema.
    /// </summary>
    ...
    public readonly partial struct JsonStringArray
    {
...
#endif
        {
            ...
            public PetstoreBenchmark.CorvusClient.JsonString.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<PetstoreBenchmark.CorvusClient.JsonString.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<PetstoreBenchmark.CorvusClient.JsonString.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<PetstoreBenchmark.CorvusClient.JsonString.Mutable>(_parent, _idx);
            }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in PetstoreBenchmark.CorvusClient.JsonString.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, in PetstoreBenchmark.CorvusClient.JsonString.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(in PetstoreBenchmark.CorvusClient.JsonString.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in PetstoreBenchmark.CorvusClient.JsonString item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, PetstoreBenchmark.CorvusClient.JsonString>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<PetstoreBenchmark.CorvusClient.JsonString> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, PetstoreBenchmark.CorvusClient.JsonString>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in PetstoreBenchmark.CorvusClient.JsonString oldItem, in PetstoreBenchmark.CorvusClient.JsonString.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<PetstoreBenchmark.CorvusClient.JsonString>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    PetstoreBenchmark.CorvusClient.JsonString current = enumerator.Current;
        ...
        public ref struct Source
        {
            ...
            internal Source(PetstoreBenchmark.CorvusClient.PostPetsByPetIdPhotoBody.JsonStringArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, PetstoreBenchmark.CorvusClient.PostPetsByPetIdPhotoBody.JsonStringArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
