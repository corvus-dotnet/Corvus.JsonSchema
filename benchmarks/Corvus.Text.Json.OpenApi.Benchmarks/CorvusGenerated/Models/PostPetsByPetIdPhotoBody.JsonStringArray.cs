...
public readonly partial struct PostPetsByPetIdPhotoBody
{
...
#endif
    {
        ...
        public PetstoreBenchmark.CorvusClient.JsonString this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<PetstoreBenchmark.CorvusClient.JsonString>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<PetstoreBenchmark.CorvusClient.JsonString> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<PetstoreBenchmark.CorvusClient.JsonString>(_parent, _idx);
        }
