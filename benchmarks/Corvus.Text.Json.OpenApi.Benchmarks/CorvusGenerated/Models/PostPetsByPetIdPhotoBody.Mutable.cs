...
public readonly partial struct PostPetsByPetIdPhotoBody
{
...
#endif
    {
        ...
        public static explicit operator Mutable(PostPetsByPetIdPhotoBody instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="PostPetsByPetIdPhotoBody"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PostPetsByPetIdPhotoBody(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public PetstoreBenchmark.CorvusClient.JsonString.Mutable Caption
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CaptionUtf8, out PetstoreBenchmark.CorvusClient.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public PetstoreBenchmark.CorvusClient.JsonBinary.Mutable Photo
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PhotoUtf8, out PetstoreBenchmark.CorvusClient.JsonBinary.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        public PetstoreBenchmark.CorvusClient.PostPetsByPetIdPhotoBody.JsonStringArray.Mutable Tags
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TagsUtf8, out PetstoreBenchmark.CorvusClient.PostPetsByPetIdPhotoBody.JsonStringArray.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new PostPetsByPetIdPhotoBody(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetCaption(in PetstoreBenchmark.CorvusClient.JsonString.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("caption");
            }
        ...
        /// <summary>
        /// Set the <c>photo</c> property.
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetPhoto(in PetstoreBenchmark.CorvusClient.JsonBinary.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("photo");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PhotoUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Photo, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTags(in PetstoreBenchmark.CorvusClient.PostPetsByPetIdPhotoBody.JsonStringArray.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetTags<TContext>(in PetstoreBenchmark.CorvusClient.PostPetsByPetIdPhotoBody.JsonStringArray.Source<TContext> value)
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PostPetsByPetIdPhotoBody.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="PostPetsByPetIdPhotoBody"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="PostPetsByPetIdPhotoBody"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly PostPetsByPetIdPhotoBody Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<PostPetsByPetIdPhotoBody>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="PostPetsByPetIdPhotoBody"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly PostPetsByPetIdPhotoBody Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<PostPetsByPetIdPhotoBody>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(PetstoreBenchmark.CorvusClient.PostPetsByPetIdPhotoBody.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(PostPetsByPetIdPhotoBody instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, PetstoreBenchmark.CorvusClient.PostPetsByPetIdPhotoBody.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="PostPetsByPetIdPhotoBody"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in PetstoreBenchmark.CorvusClient.JsonString.Source caption,
            in PetstoreBenchmark.CorvusClient.JsonBinary.Source photo,
            in PetstoreBenchmark.CorvusClient.PostPetsByPetIdPhotoBody.JsonStringArray.Source tags = default)
        {
            caption.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Caption, ref builder);
            photo.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Photo, ref builder);
        ...
        public void Create(
            ...
            in PetstoreBenchmark.CorvusClient.PostPetsByPetIdPhotoBody.JsonStringArray.Source tags = default)
        {
            Create(ref _builder, caption, photo, tags);
        }
        ...
        internal static void Create<TContext>(
            ...
            in PetstoreBenchmark.CorvusClient.JsonString.Source caption,
            in PetstoreBenchmark.CorvusClient.JsonBinary.Source photo,
            in PetstoreBenchmark.CorvusClient.PostPetsByPetIdPhotoBody.JsonStringArray.Source<TContext> tags = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
        ...
        #endif
        {
            Create(context, ref _builder, caption, photo, tags);
        }
    ...
    /// <param name="photo">The value of the property.</param>
    /// <param name="tags">The value of the property.</param>
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in PetstoreBenchmark.CorvusClient.JsonString.Source caption, in PetstoreBenchmark.CorvusClient.JsonBinary.Source photo, in PetstoreBenchmark.CorvusClient.PostPetsByPetIdPhotoBody.JsonStringArray.Source tags = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(caption, photo, tags);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in PetstoreBenchmark.CorvusClient.JsonString.Source caption, in PetstoreBenchmark.CorvusClient.JsonBinary.Source photo, in PetstoreBenchmark.CorvusClient.PostPetsByPetIdPhotoBody.JsonStringArray.Source<TContext> tags = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, caption, photo, tags);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<PostPetsByPetIdPhotoBody, Mutable>(this);
    }
}
