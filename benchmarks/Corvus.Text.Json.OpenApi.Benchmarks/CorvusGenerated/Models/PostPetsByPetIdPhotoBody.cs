...
public readonly partial struct PostPetsByPetIdPhotoBody
    ...
    : IJsonElement<PostPetsByPetIdPhotoBody>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PostPetsByPetIdPhotoBody"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal PostPetsByPetIdPhotoBody(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static PostPetsByPetIdPhotoBody DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public PetstoreBenchmark.CorvusClient.JsonString Caption
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CaptionUtf8, out PetstoreBenchmark.CorvusClient.JsonString value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public PetstoreBenchmark.CorvusClient.JsonBinary Photo
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PhotoUtf8, out PetstoreBenchmark.CorvusClient.JsonBinary value))
            {
                return value;
            }
    ...
    /// </summary>
    public PetstoreBenchmark.CorvusClient.PostPetsByPetIdPhotoBody.JsonStringArray Tags
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TagsUtf8, out PetstoreBenchmark.CorvusClient.PostPetsByPetIdPhotoBody.JsonStringArray value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in PostPetsByPetIdPhotoBody left, in PostPetsByPetIdPhotoBody right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in PostPetsByPetIdPhotoBody left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(PostPetsByPetIdPhotoBody instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator PostPetsByPetIdPhotoBody(JsonElement instance)
    {
        return PostPetsByPetIdPhotoBody.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostPetsByPetIdPhotoBody From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostPetsByPetIdPhotoBody ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PostPetsByPetIdPhotoBody>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostPetsByPetIdPhotoBody ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PostPetsByPetIdPhotoBody>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PostPetsByPetIdPhotoBody ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PostPetsByPetIdPhotoBody>(json, options);
    }
    ...
    /// </exception>
    public static PostPetsByPetIdPhotoBody ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<PostPetsByPetIdPhotoBody>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out PostPetsByPetIdPhotoBody? result)
    {
        return JsonElementHelpers.TryParseValue<PostPetsByPetIdPhotoBody>(ref reader, out result);
    }
...
#if NET
    static PostPetsByPetIdPhotoBody IJsonElement<PostPetsByPetIdPhotoBody>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"PostPetsByPetIdPhotoBody: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public PostPetsByPetIdPhotoBody Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public PostPetsByPetIdPhotoBody Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<PostPetsByPetIdPhotoBody>(_idx);
        }
    ...
    public static class JsonPropertyNames
    {
        ...
        /// <summary>
        /// Gets the JSON property name for <see cref="Photo"/>.
        /// </summary>
        ...
        /// Gets the JSON property name for <see cref="Photo"/>.
        /// </summary>
        public static ReadOnlySpan<byte> PhotoUtf8 => "photo"u8;
    ...
    private static class JsonPropertyNamesEscaped
    {
        ...
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="Photo"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Photo => "photo"u8;
    ...
    private static class JsonPropertyNamesPrebaked
    {
        ...
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="Photo"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Photo => [0x75, 0x00, 0x00, 0x00, 0x22, 0x70, 0x68, 0x6F, 0x74, 0x6F, 0x22];
