...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="JsonEmailNotAsserted"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal JsonEmailNotAsserted(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static JsonEmailNotAsserted DefaultInstance { get; }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator string(JsonEmailNotAsserted value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
    ...
    /// </returns>
    public static bool operator ==(in JsonEmailNotAsserted left, in JsonEmailNotAsserted right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in JsonEmailNotAsserted left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator JsonElement(JsonEmailNotAsserted instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator JsonEmailNotAsserted(JsonElement instance)
    {
        return JsonEmailNotAsserted.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static JsonEmailNotAsserted From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static JsonEmailNotAsserted ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<JsonEmailNotAsserted>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static JsonEmailNotAsserted ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<JsonEmailNotAsserted>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static JsonEmailNotAsserted ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<JsonEmailNotAsserted>(json, options);
    }
    ...
    /// </exception>
    public static JsonEmailNotAsserted ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<JsonEmailNotAsserted>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out JsonEmailNotAsserted? result)
    {
        return JsonElementHelpers.TryParseValue<JsonEmailNotAsserted>(ref reader, out result);
    }
...
#if NET
    static JsonEmailNotAsserted IJsonElement<JsonEmailNotAsserted>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"JsonEmailNotAsserted: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public JsonEmailNotAsserted Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public JsonEmailNotAsserted Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<JsonEmailNotAsserted>(_idx);
        }
