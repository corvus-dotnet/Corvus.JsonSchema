...
public readonly partial struct JsonMediaRangeNotAsserted
#if NET8_0_OR_GREATER
    : IJsonElement<JsonMediaRangeNotAsserted>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="JsonMediaRangeNotAsserted"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal JsonMediaRangeNotAsserted(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static JsonMediaRangeNotAsserted DefaultInstance { get; }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator string(JsonMediaRangeNotAsserted value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
    ...
    /// </returns>
    public static bool operator ==(in JsonMediaRangeNotAsserted left, in JsonMediaRangeNotAsserted right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in JsonMediaRangeNotAsserted left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator JsonElement(JsonMediaRangeNotAsserted instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator JsonMediaRangeNotAsserted(JsonElement instance)
    {
        return JsonMediaRangeNotAsserted.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static JsonMediaRangeNotAsserted From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static JsonMediaRangeNotAsserted ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<JsonMediaRangeNotAsserted>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static JsonMediaRangeNotAsserted ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<JsonMediaRangeNotAsserted>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static JsonMediaRangeNotAsserted ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<JsonMediaRangeNotAsserted>(json, options);
    }
    ...
    /// </exception>
    public static JsonMediaRangeNotAsserted ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<JsonMediaRangeNotAsserted>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out JsonMediaRangeNotAsserted? result)
    {
        return JsonElementHelpers.TryParseValue<JsonMediaRangeNotAsserted>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new JsonMediaRangeNotAsserted(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static JsonMediaRangeNotAsserted IJsonElement<JsonMediaRangeNotAsserted>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"JsonMediaRangeNotAsserted: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="JsonMediaRangeNotAsserted"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="JsonMediaRangeNotAsserted"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public JsonMediaRangeNotAsserted Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<JsonMediaRangeNotAsserted>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="JsonMediaRangeNotAsserted"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public JsonMediaRangeNotAsserted Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<JsonMediaRangeNotAsserted>(_idx);
        }
