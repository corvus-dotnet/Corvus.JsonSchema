...
public readonly partial struct JsonUriNotAsserted
{
...
#endif
    {
        ...
        public static explicit operator Mutable(JsonUriNotAsserted instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="JsonUriNotAsserted"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonUriNotAsserted(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new JsonUriNotAsserted(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"JsonUriNotAsserted.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="JsonUriNotAsserted"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="JsonUriNotAsserted"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly JsonUriNotAsserted Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<JsonUriNotAsserted>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="JsonUriNotAsserted"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly JsonUriNotAsserted Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<JsonUriNotAsserted>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(JsonUriNotAsserted instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<JsonUriNotAsserted, Mutable>(this);
    }
}
