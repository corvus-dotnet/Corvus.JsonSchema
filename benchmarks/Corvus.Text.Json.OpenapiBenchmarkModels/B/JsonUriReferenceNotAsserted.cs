...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="JsonUriReferenceNotAsserted"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal JsonUriReferenceNotAsserted(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static JsonUriReferenceNotAsserted DefaultInstance { get; }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator Utf8UriReferenceValue(JsonUriReferenceNotAsserted value) => Utf8UriReferenceValue.TryGetValue(value._parent, value._idx, out Utf8UriReferenceValue result) ? result : throw new FormatException();

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator string(JsonUriReferenceNotAsserted value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
    ...
    /// </returns>
    public static bool operator ==(in JsonUriReferenceNotAsserted left, in JsonUriReferenceNotAsserted right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in JsonUriReferenceNotAsserted left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator JsonElement(JsonUriReferenceNotAsserted instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator JsonUriReferenceNotAsserted(JsonElement instance)
    {
        return JsonUriReferenceNotAsserted.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static JsonUriReferenceNotAsserted From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static JsonUriReferenceNotAsserted ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<JsonUriReferenceNotAsserted>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static JsonUriReferenceNotAsserted ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<JsonUriReferenceNotAsserted>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static JsonUriReferenceNotAsserted ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<JsonUriReferenceNotAsserted>(json, options);
    }
    ...
    /// </exception>
    public static JsonUriReferenceNotAsserted ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<JsonUriReferenceNotAsserted>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out JsonUriReferenceNotAsserted? result)
    {
        return JsonElementHelpers.TryParseValue<JsonUriReferenceNotAsserted>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new JsonUriReferenceNotAsserted(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static JsonUriReferenceNotAsserted IJsonElement<JsonUriReferenceNotAsserted>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"JsonUriReferenceNotAsserted: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="JsonUriReferenceNotAsserted"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="JsonUriReferenceNotAsserted"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public JsonUriReferenceNotAsserted Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<JsonUriReferenceNotAsserted>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="JsonUriReferenceNotAsserted"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public JsonUriReferenceNotAsserted Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<JsonUriReferenceNotAsserted>(_idx);
        }
