...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Callbacks
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Callbacks instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Callbacks"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Callbacks(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Callbacks(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Callbacks.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Callbacks"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Callbacks"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly Callbacks Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<Callbacks>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Callbacks"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly Callbacks Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Callbacks>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.OpenapiBenchmark.Baseline.Schema.Callbacks.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(Callbacks instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Baseline.Schema.Callbacks.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<Callbacks, Mutable>(this);
        }
    }
}
