...
public readonly partial struct Schema
{
    ...
    public readonly partial struct CallbacksOrReference
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(CallbacksOrReference instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="CallbacksOrReference"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator CallbacksOrReference(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"CallbacksOrReference.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly CallbacksOrReference Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly CallbacksOrReference Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<CallbacksOrReference>(_idx);
            }
            ...
            /// <param name="matchCorvusOpenapiBenchmarkBaselineSchemaCallbacks">Match a <see cref="Corvus.OpenapiBenchmark.Baseline.Schema.Callbacks"/>.</param>
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.OpenapiBenchmark.Baseline.Schema.Callbacks, TContext, TResult> matchCorvusOpenapiBenchmarkBaselineSchemaCallbacks)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
            {
                if (Corvus.OpenapiBenchmark.Baseline.Schema.CallbacksOrReference.RequiredRef.JsonSchema.Evaluate(_parent, _idx))
                {
                ...
                {
                    return matchCorvusOpenapiBenchmarkBaselineSchemaCallbacks(Corvus.OpenapiBenchmark.Baseline.Schema.Callbacks.From(this), context);
                }
            }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.OpenapiBenchmark.Baseline.Schema.Callbacks, TResult> matchCorvusOpenapiBenchmarkBaselineSchemaCallbacks)
            {
                if (Corvus.OpenapiBenchmark.Baseline.Schema.CallbacksOrReference.RequiredRef.JsonSchema.Evaluate(_parent, _idx))
                {
                ...
                {
                    return matchCorvusOpenapiBenchmarkBaselineSchemaCallbacks(Corvus.OpenapiBenchmark.Baseline.Schema.Callbacks.From(this));
                }
            }

            /// <summary>
            /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Baseline.Schema.Callbacks" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsCallbacks(out Corvus.OpenapiBenchmark.Baseline.Schema.Callbacks result)
            {
                if (Corvus.OpenapiBenchmark.Baseline.Schema.Callbacks.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.OpenapiBenchmark.Baseline.Schema.Callbacks.Mutable.From(this);
                    return true;
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Baseline.Schema.CallbacksOrReference.RequiredRef" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsRequiredRef(out Corvus.OpenapiBenchmark.Baseline.Schema.CallbacksOrReference.RequiredRef result)
            {
                if (Corvus.OpenapiBenchmark.Baseline.Schema.CallbacksOrReference.RequiredRef.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.OpenapiBenchmark.Baseline.Schema.CallbacksOrReference.RequiredRef.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.OpenapiBenchmark.Baseline.Schema.CallbacksOrReference.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(CallbacksOrReference instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Baseline.Schema.CallbacksOrReference.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<CallbacksOrReference, Mutable>(this);
        }
    }
}
