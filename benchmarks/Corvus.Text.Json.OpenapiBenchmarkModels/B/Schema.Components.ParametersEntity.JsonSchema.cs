                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        while (objectValidation_enumerator.MoveNext())
                        {
                            ...
                            {
                                JsonSchemaContext childContext = Corvus.OpenapiBenchmark.Baseline.Schema.ParameterOrReference.JsonSchema.PushChildContextUnescaped(
                                    parentDocument,
                                ...
                                Corvus.OpenapiBenchmark.Baseline.Schema.ParameterOrReference.JsonSchema.Evaluate(parentDocument, objectValidation_currentIndex, ref childContext);
