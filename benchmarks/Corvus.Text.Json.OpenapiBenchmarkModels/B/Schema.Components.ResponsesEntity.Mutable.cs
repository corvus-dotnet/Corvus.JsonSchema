    ...
    public readonly partial struct Components
    {
        ...
        public readonly partial struct ResponsesEntity
        {
...
#endif
            {
                ...
                public Corvus.OpenapiBenchmark.Baseline.Schema.ResponseOrReference.Mutable this[ReadOnlySpan<byte> propertyName]
                {
                    get
                    {
                        CheckValidInstance();
                        if (!_parent.TryGetNamedPropertyValue(_idx, propertyName, out Corvus.OpenapiBenchmark.Baseline.Schema.ResponseOrReference.Mutable value))
                        {
                            return default;
                        }
                ...
                /// <returns>The value of the property with the given name.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public Corvus.OpenapiBenchmark.Baseline.Schema.ResponseOrReference.Mutable this[ReadOnlySpan<char> propertyName]
                {
                    get
                    {
                        CheckValidInstance();
                ...
                /// <returns>The value of the property with the given name.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public Corvus.OpenapiBenchmark.Baseline.Schema.ResponseOrReference.Mutable this[string propertyName]
                {
                    get
                    {
                        CheckValidInstance();
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public bool TryGetProperty(ReadOnlySpan<byte> propertyName, out Corvus.OpenapiBenchmark.Baseline.Schema.ResponseOrReference.Mutable value)
                {
                    CheckValidInstance();
                ...
                /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public bool TryGetProperty(ReadOnlySpan<char> propertyName, out Corvus.OpenapiBenchmark.Baseline.Schema.ResponseOrReference.Mutable value)
                {
                    CheckValidInstance();
                    return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
                }
                ...
                /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public bool TryGetProperty(string propertyName, out Corvus.OpenapiBenchmark.Baseline.Schema.ResponseOrReference.Mutable value)
                {
                    CheckValidInstance();
                    return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public ObjectEnumerator<Corvus.OpenapiBenchmark.Baseline.Schema.ResponseOrReference.Mutable> EnumerateObject()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateObjectEnumerator<Corvus.OpenapiBenchmark.Baseline.Schema.ResponseOrReference.Mutable>(_parent, _idx);
                }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetProperty(string propertyName, in Corvus.OpenapiBenchmark.Baseline.Schema.ResponseOrReference.Source value)
                {
                ...
                ///   </para>
                /// </remarks>
                public void SetProperty(ReadOnlySpan<char> propertyName, in Corvus.OpenapiBenchmark.Baseline.Schema.ResponseOrReference.Source value)
                {
                    CheckValidInstance();
                ...
                ///   </para>
                /// </remarks>
                public void SetProperty(ReadOnlySpan<byte> propertyName, in Corvus.OpenapiBenchmark.Baseline.Schema.ResponseOrReference.Source value)
                {
                    CheckValidInstance();
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.OpenapiBenchmark.Baseline.Schema.Components.ResponsesEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Baseline.Schema.Components.ResponsesEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                public void AddProperty(ReadOnlySpan<byte> propertyName, in Corvus.OpenapiBenchmark.Baseline.Schema.ResponseOrReference.Source value)
                {
                ...
                /// <param name="propertyName">The name of the property to add.</param>
                /// <param name="value">The value of the property to add.</param>
                public void AddProperty(ReadOnlySpan<char> propertyName, in Corvus.OpenapiBenchmark.Baseline.Schema.ResponseOrReference.Source value)
                {
                    value.AddAsProperty(propertyName, ref _builder);
                }
                ...
                /// <param name="propertyName">The name of the property to add.</param>
                /// <param name="value">The value of the property to add.</param>
                public void AddProperty(string propertyName, in Corvus.OpenapiBenchmark.Baseline.Schema.ResponseOrReference.Source value)
                {
                    value.AddAsProperty(propertyName, ref _builder);
                }
