                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    while (objectValidation_enumerator.MoveNext())
                    {
                        ...
                        using (var fixedJsonString = FixedStringJsonDocument<Corvus.OpenapiBenchmark.Baseline.Schema.Content.PropertyNamesEntity>.Parse(parentDocument.GetPropertyNameRaw(objectValidation_currentIndex, true), parentDocument.ValueIsEscaped(objectValidation_currentIndex, true)))
                        {
                            JsonSchemaContext childContext =
                                Corvus.OpenapiBenchmark.Baseline.Schema.Content.PropertyNamesEntity.JsonSchema.PushChildContext(
                                    fixedJsonString,
                                    0,
                                    ref context,
                                    schemaEvaluationPath: PropertyNamesSchemaEvaluationPath);

                            Corvus.OpenapiBenchmark.Baseline.Schema.Content.PropertyNamesEntity.JsonSchema.Evaluate(fixedJsonString, 0, ref childContext);
                        ...
                        {
                            JsonSchemaContext childContext1 = Corvus.OpenapiBenchmark.Baseline.Schema.MediaType.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                            ...
                            Corvus.OpenapiBenchmark.Baseline.Schema.MediaType.JsonSchema.Evaluate(parentDocument, objectValidation_currentIndex, ref childContext1);
