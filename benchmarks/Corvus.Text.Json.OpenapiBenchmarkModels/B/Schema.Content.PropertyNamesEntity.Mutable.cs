    ...
    public readonly partial struct Content
    {
        ...
        public readonly partial struct PropertyNamesEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(PropertyNamesEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="PropertyNamesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator PropertyNamesEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"PropertyNamesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly PropertyNamesEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly PropertyNamesEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<PropertyNamesEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.OpenapiBenchmark.Baseline.Schema.Content.PropertyNamesEntity.ObjectBuilder.Build value) {_objectBuilder = value; _kind = Kind.ObjectBuilder; }

                internal Source(Corvus.OpenapiBenchmark.Baseline.Schema.Content.PropertyNamesEntity.ArrayBuilder.Build value) {_arrayBuilder = value; _kind = Kind.ArrayBuilder; }

                public static implicit operator Source(PropertyNamesEntity instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Baseline.Schema.Content.PropertyNamesEntity.ObjectBuilder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.ObjectBuilder; }

                internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Baseline.Schema.Content.PropertyNamesEntity.ArrayBuilder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.ArrayBuilder; }
            ...
            {
                return workspace.CreateBuilder<PropertyNamesEntity, Mutable>(this);
            }
        }
    }
}
