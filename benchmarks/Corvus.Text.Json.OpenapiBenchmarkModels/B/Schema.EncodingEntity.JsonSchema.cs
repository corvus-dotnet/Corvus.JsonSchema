...
public readonly partial struct Schema
{
        ...
        : IJsonElement<EncodingEntity>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://spec.openapis.org/oas/3.1/schema/2022-10-07?dynamicScope=D%3A%2Fsource%2Fcorvus-dotnet%2FCorvus.JsonSchema%2Fbenchmarks%2FCorvus.Text.Json.OpenapiBenchmarkModels%2Fopenapi-schema.json#/$defs/media-type/properties/encoding"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "https://spec.openapis.org/oas/3.1/schema/2022-10-07?dynamicScope=D%3A%2Fsource%2Fcorvus-dotnet%2FCorvus.JsonSchema%2Fbenchmarks%2FCorvus.Text.Json.OpenapiBenchmarkModels%2Fopenapi-schema.json#/$defs/media-type/properties/encoding";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://spec.openapis.org/oas/3.1/schema/2022-10-07?dynamicScope=D%3A%2Fsource%2Fcorvus-dotnet%2FCorvus.JsonSchema%2Fbenchmarks%2FCorvus.Text.Json.OpenapiBenchmarkModels%2Fopenapi-schema.json#/$defs/media-type/properties/encoding"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    while (objectValidation_enumerator.MoveNext())
                    {
                        ...
                        {
                            JsonSchemaContext childContext = Corvus.OpenapiBenchmark.Baseline.Schema.Encoding.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                            ...
                            Corvus.OpenapiBenchmark.Baseline.Schema.Encoding.JsonSchema.Evaluate(parentDocument, objectValidation_currentIndex, ref childContext);
