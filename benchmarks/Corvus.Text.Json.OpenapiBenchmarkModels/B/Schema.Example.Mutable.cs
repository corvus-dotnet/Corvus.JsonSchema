...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Example
    {
...
#endif
        {
            ...
            /// </summary>
            public Corvus.OpenapiBenchmark.Baseline.JsonUriNotAsserted.Mutable ExternalValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExternalValueUtf8, out Corvus.OpenapiBenchmark.Baseline.JsonUriNotAsserted.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetExternalValue(in Corvus.OpenapiBenchmark.Baseline.JsonUriNotAsserted.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ExternalValueUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }
            ...
            /// <summary>
            /// Remove the <c>externalValue</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveExternalValue()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ExternalValueUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.OpenapiBenchmark.Baseline.Schema.Example.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Baseline.Schema.Example.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.OpenapiBenchmark.Baseline.JsonUriNotAsserted.Source externalValue = default,
            ...
            public void Create(
                ...
                in Corvus.Text.Json.JsonElement.Source value = default)
            {
                Create(ref _builder, description, externalValue, summary, value);
            }
            ...
            #endif
            {
                Create(context, ref _builder, description, externalValue, summary, value);
            }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OpenapiBenchmark.Baseline.JsonString.Source description = default, in Corvus.OpenapiBenchmark.Baseline.JsonUriNotAsserted.Source externalValue = default, in Corvus.OpenapiBenchmark.Baseline.JsonString.Source summary = default, in Corvus.Text.Json.JsonElement.Source value = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(description, externalValue, summary, value);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.OpenapiBenchmark.Baseline.JsonString.Source description = default, in Corvus.OpenapiBenchmark.Baseline.JsonUriNotAsserted.Source externalValue = default, in Corvus.OpenapiBenchmark.Baseline.JsonString.Source summary = default, in Corvus.Text.Json.JsonElement.Source<TContext> value = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            ...
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(context, description, externalValue, summary, value);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
