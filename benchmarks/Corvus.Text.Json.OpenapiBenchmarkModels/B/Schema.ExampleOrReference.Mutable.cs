    ...
    public readonly partial struct ExampleOrReference
    {
...
#endif
        {
            ...
            public bool TryGetAsExample(out Corvus.OpenapiBenchmark.Baseline.Schema.Example result)
            {
                ...
                {
                    result = Corvus.OpenapiBenchmark.Baseline.Schema.Example.Mutable.From(this);
                    return true;
                }
            ...
            public bool TryGetAsRequiredRef(out Corvus.OpenapiBenchmark.Baseline.Schema.ExampleOrReference.RequiredRef result)
            {
                if (Corvus.OpenapiBenchmark.Baseline.Schema.ExampleOrReference.RequiredRef.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.OpenapiBenchmark.Baseline.Schema.ExampleOrReference.RequiredRef.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.OpenapiBenchmark.Baseline.Schema.ExampleOrReference.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Baseline.Schema.ExampleOrReference.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
