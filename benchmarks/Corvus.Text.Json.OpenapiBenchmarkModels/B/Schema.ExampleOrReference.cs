...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        internal ExampleOrReference(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ExampleOrReference left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(ExampleOrReference instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ExampleOrReference(JsonElement instance)
        {
            return ExampleOrReference.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ExampleOrReference From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ExampleOrReference ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ExampleOrReference>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ExampleOrReference ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ExampleOrReference>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ExampleOrReference ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ExampleOrReference>(json, options);
        }
        ...
        /// </exception>
        public static ExampleOrReference ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ExampleOrReference>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ExampleOrReference? result)
        {
            return JsonElementHelpers.TryParseValue<ExampleOrReference>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ExampleOrReference(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static ExampleOrReference IJsonElement<ExampleOrReference>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ExampleOrReference: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ExampleOrReference"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ExampleOrReference"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        {
            CheckValidInstance();
            return _parent.CloneElement<ExampleOrReference>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ExampleOrReference"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public ExampleOrReference Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ExampleOrReference>(_idx);
            }
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Baseline.Schema.Example" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsExample(out Corvus.OpenapiBenchmark.Baseline.Schema.Example result)
        {
            if (Corvus.OpenapiBenchmark.Baseline.Schema.Example.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.OpenapiBenchmark.Baseline.Schema.Example.From(this);
                return true;
            }
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Baseline.Schema.ExampleOrReference.RequiredRef" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsRequiredRef(out Corvus.OpenapiBenchmark.Baseline.Schema.ExampleOrReference.RequiredRef result)
        {
            if (Corvus.OpenapiBenchmark.Baseline.Schema.ExampleOrReference.RequiredRef.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.OpenapiBenchmark.Baseline.Schema.ExampleOrReference.RequiredRef.From(this);
                return true;
            }
        ...
        /// <param name="matchCorvusOpenapiBenchmarkBaselineSchemaExample">Match a <see cref="Corvus.OpenapiBenchmark.Baseline.Schema.Example"/>.</param>
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.OpenapiBenchmark.Baseline.Schema.Example, TContext, TResult> matchCorvusOpenapiBenchmarkBaselineSchemaExample)
...
#endif
        {
            ...
            {
                return matchCorvusOpenapiBenchmarkBaselineSchemaExample(Corvus.OpenapiBenchmark.Baseline.Schema.Example.From(this), context);
            }
        }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.OpenapiBenchmark.Baseline.Schema.Example, TResult> matchCorvusOpenapiBenchmarkBaselineSchemaExample)
        {
            if (Corvus.OpenapiBenchmark.Baseline.Schema.ExampleOrReference.RequiredRef.JsonSchema.Evaluate(_parent, _idx))
            {
            ...
            {
                return matchCorvusOpenapiBenchmarkBaselineSchemaExample(Corvus.OpenapiBenchmark.Baseline.Schema.Example.From(this));
            }
        }
