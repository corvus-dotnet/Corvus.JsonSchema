                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        while (objectValidation_enumerator.MoveNext())
                        {
                            ...
                            {
                                JsonSchemaContext childContext = Corvus.OpenapiBenchmark.Baseline.Schema.ExampleOrReference.JsonSchema.PushChildContextUnescaped(
                                    parentDocument,
                                ...
                                Corvus.OpenapiBenchmark.Baseline.Schema.ExampleOrReference.JsonSchema.Evaluate(parentDocument, objectValidation_currentIndex, ref childContext);
