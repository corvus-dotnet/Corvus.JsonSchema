...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Examples
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Examples instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Examples"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Examples(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Examples(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Examples.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Examples"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Examples"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly Examples Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<Examples>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Examples"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly Examples Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Examples>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.OpenapiBenchmark.Baseline.Schema.Examples.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(Examples instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Baseline.Schema.Examples.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// Creates an instance of a <see cref="Examples"/>.
            /// </summary>
            public void Create(in Corvus.Text.Json.JsonElement.Source example = default, in Corvus.OpenapiBenchmark.Baseline.Schema.Examples.ExamplesEntity.Source examples = default)
            {
                Create(ref _builder, example, examples);
            }
            ...
            #endif
            {
                Create(context, ref _builder, example, examples);
            }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.JsonElement.Source example = default, in Corvus.OpenapiBenchmark.Baseline.Schema.Examples.ExamplesEntity.Source examples = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(example, examples);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> example = default, in Corvus.OpenapiBenchmark.Baseline.Schema.Examples.ExamplesEntity.Source<TContext> examples = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            ...
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(context, example, examples);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<Examples, Mutable>(this);
        }
    }
}
