...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Header
    {
            ...
            : IJsonElement<RequiredSchema>
        {
            ...
            {
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertySchemaPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("schema"u8, buffer, out written);
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertySchemaNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("schema"u8, buffer, out written);

                private const int RequiredOffsetForSchema = 0;
                private const uint RequiredBitForSchema = 0b00000000000000000000000000000001;

                private const uint RequiredBitMask0 =
                    RequiredBitForSchema;
                ...
                {
                    requiredBitBuffer[RequiredOffsetForSchema] |= RequiredBitForSchema;
                }
                ...
                {
                    if (span.SequenceEqual(JsonPropertyNames.SchemaUtf8))
                    {
                        matcher = MatchSchema;
                        return true;
                    }
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/header/oneOf/0"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/header/oneOf/0";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/header/oneOf/0"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.StartObject)
                    {
                        ...
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertySchemaPresent, "schema"u8, "required"u8);
                        }
                        ...
                        {
                            if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForSchema] & RequiredBitForSchema) == 0)
                            {
                                context.EvaluatedKeywordForProperty(false, 0, RequiredPropertySchemaNotPresent, "schema"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertySchemaPresent, "schema"u8, "required"u8);
