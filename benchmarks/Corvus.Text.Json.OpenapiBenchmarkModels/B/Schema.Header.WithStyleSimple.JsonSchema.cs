            ...
            public static partial class JsonSchema
            {
                ...
                private static void MatchExplode(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    ...
                    JsonSchemaContext childContext =
                        Corvus.OpenapiBenchmark.Baseline.Schema.Header.WithStyleSimple.ExplodeEntity.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Corvus.OpenapiBenchmark.Baseline.Schema.Header.WithStyleSimple.ExplodeEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                ...
                private static void MatchStyle(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    ...
                    JsonSchemaContext childContext1 =
                        Corvus.OpenapiBenchmark.Baseline.Schema.Header.WithStyleSimple.StyleEntity.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Corvus.OpenapiBenchmark.Baseline.Schema.Header.WithStyleSimple.StyleEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.StartObject)
                    {
                        JsonSchemaContext hoistedAllOf0_context =
                            Corvus.OpenapiBenchmark.Baseline.Schema.Examples.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: Ref0SchemaEvaluationPath);
                        ...
                        while (objectValidation_enumerator.MoveNext())
                        {
                            ...
                            else if (objectValidation_unescapedPropertyName.Span.SequenceEqual("examples"u8))
                            {
                                ...
                                Corvus.OpenapiBenchmark.Baseline.Schema.Examples.ExamplesEntity.JsonSchema.Evaluate(parentDocument, objectValidation_currentIndex, ref hoistedChildContext1);
