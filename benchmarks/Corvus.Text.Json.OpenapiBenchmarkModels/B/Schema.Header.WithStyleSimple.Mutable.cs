    ...
    public readonly partial struct Header
    {
        ...
        public readonly partial struct WithStyleSimple
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(WithStyleSimple instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="WithStyleSimple"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator WithStyleSimple(Mutable instance)
                {
                ...
                /// </summary>
                public Corvus.OpenapiBenchmark.Baseline.Schema.Examples.ExamplesEntity.Mutable Examples
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExamplesUtf8, out Corvus.OpenapiBenchmark.Baseline.Schema.Examples.ExamplesEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </summary>
                public Corvus.OpenapiBenchmark.Baseline.Schema.Header.WithStyleSimple.ExplodeEntity.Mutable Explode
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExplodeUtf8, out Corvus.OpenapiBenchmark.Baseline.Schema.Header.WithStyleSimple.ExplodeEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </summary>
                public Corvus.OpenapiBenchmark.Baseline.Schema.Header.WithStyleSimple.StyleEntity.Mutable Style
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StyleUtf8, out Corvus.OpenapiBenchmark.Baseline.Schema.Header.WithStyleSimple.StyleEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new WithStyleSimple(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetExamples(in Corvus.OpenapiBenchmark.Baseline.Schema.Examples.ExamplesEntity.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetExamples<TContext>(in Corvus.OpenapiBenchmark.Baseline.Schema.Examples.ExamplesEntity.Source<TContext> value)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetExplode(in Corvus.OpenapiBenchmark.Baseline.Schema.Header.WithStyleSimple.ExplodeEntity.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetStyle(in Corvus.OpenapiBenchmark.Baseline.Schema.Header.WithStyleSimple.StyleEntity.Source value)
                {
                    CheckValidInstance();
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"WithStyleSimple.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="WithStyleSimple"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="WithStyleSimple"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly WithStyleSimple Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<WithStyleSimple>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="WithStyleSimple"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly WithStyleSimple Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<WithStyleSimple>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.OpenapiBenchmark.Baseline.Schema.Header.WithStyleSimple.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Baseline.Schema.Header.WithStyleSimple.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.OpenapiBenchmark.Baseline.Schema.Header.WithStyleSimple.ExplodeEntity.Source explode = default,
                    in Corvus.OpenapiBenchmark.Baseline.Schema.Header.WithStyleSimple.StyleEntity.Source style = default)
                {
                ...
                public void Create(
                    ...
                    in Corvus.OpenapiBenchmark.Baseline.Schema.Header.WithStyleSimple.StyleEntity.Source style = default)
                {
                    Create(ref _builder, example, examples, explode, style);
                }
                ...
                #endif
                {
                    Create(context, ref _builder, example, examples, explode, style);
                }
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.JsonElement.Source example = default, in Corvus.OpenapiBenchmark.Baseline.Schema.Examples.ExamplesEntity.Source examples = default, in Corvus.OpenapiBenchmark.Baseline.Schema.Header.WithStyleSimple.ExplodeEntity.Source explode = default, in Corvus.OpenapiBenchmark.Baseline.Schema.Header.WithStyleSimple.StyleEntity.Source style = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(example, examples, explode, style);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> example = default, in Corvus.OpenapiBenchmark.Baseline.Schema.Examples.ExamplesEntity.Source<TContext> examples = default, in Corvus.OpenapiBenchmark.Baseline.Schema.Header.WithStyleSimple.ExplodeEntity.Source explode = default, in Corvus.OpenapiBenchmark.Baseline.Schema.Header.WithStyleSimple.StyleEntity.Source style = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                ...
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(context, example, examples, explode, style);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<WithStyleSimple, Mutable>(this);
            }
        }
    }
}
