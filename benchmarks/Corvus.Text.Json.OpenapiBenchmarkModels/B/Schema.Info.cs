...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// </summary>
        public Corvus.OpenapiBenchmark.Baseline.Schema.Contact ContactValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ContactValueUtf8, out Corvus.OpenapiBenchmark.Baseline.Schema.Contact value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.OpenapiBenchmark.Baseline.Schema.License LicenseValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LicenseValueUtf8, out Corvus.OpenapiBenchmark.Baseline.Schema.License value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.OpenapiBenchmark.Baseline.JsonUriNotAsserted TermsOfService
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TermsOfServiceUtf8, out Corvus.OpenapiBenchmark.Baseline.JsonUriNotAsserted value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.OpenapiBenchmark.Baseline.JsonString Title
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TitleUtf8, out Corvus.OpenapiBenchmark.Baseline.JsonString value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.OpenapiBenchmark.Baseline.JsonString Version
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionUtf8, out Corvus.OpenapiBenchmark.Baseline.JsonString value))
                {
                    return value;
                }
        ...
        public static implicit operator Corvus.OpenapiBenchmark.Baseline.Schema.SpecificationExtensions(Info value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Info(Corvus.OpenapiBenchmark.Baseline.Schema.SpecificationExtensions value)
        {
            return From(value);
        }
