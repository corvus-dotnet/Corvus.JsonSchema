...
public readonly partial struct Schema
{
    ...
    public readonly partial struct JsonSchemaDialectEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(JsonSchemaDialectEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="JsonSchemaDialectEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonSchemaDialectEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"JsonSchemaDialectEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly JsonSchemaDialectEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly JsonSchemaDialectEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<JsonSchemaDialectEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(JsonSchemaDialectEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<JsonSchemaDialectEntity, Mutable>(this);
        }
    }
}
