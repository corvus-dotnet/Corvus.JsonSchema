        ...
        public static partial class JsonSchema
        {
                ...
                ref JsonSchemaContext context)
            {
                ...
                JsonSchemaContext ifContext =
                    Corvus.OpenapiBenchmark.Baseline.Schema.LinkOrReference.RequiredRef.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: IfSchemaEvaluationPath);
                Corvus.OpenapiBenchmark.Baseline.Schema.LinkOrReference.RequiredRef.JsonSchema.Evaluate(parentDocument, parentIndex, ref ifContext);
                ...
                else
                {
                    JsonSchemaContext elseContext =
                        Corvus.OpenapiBenchmark.Baseline.Schema.Link.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: ElseSchemaEvaluationPath);
                    Corvus.OpenapiBenchmark.Baseline.Schema.Link.JsonSchema.Evaluate(parentDocument, parentIndex, ref elseContext);
