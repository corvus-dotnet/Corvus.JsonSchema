...
public readonly partial struct Schema
{
    ...
    public readonly partial struct LinkOrReference
    {
...
#endif
        {
            ...
            /// </summary>
            public Corvus.OpenapiBenchmark.Baseline.Schema.Server.Mutable Body
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BodyUtf8, out Corvus.OpenapiBenchmark.Baseline.Schema.Server.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public Corvus.OpenapiBenchmark.Baseline.Schema.MapOfStrings.Mutable Parameters
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ParametersUtf8, out Corvus.OpenapiBenchmark.Baseline.Schema.MapOfStrings.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetBody(in Corvus.OpenapiBenchmark.Baseline.Schema.Server.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetBody<TContext>(in Corvus.OpenapiBenchmark.Baseline.Schema.Server.Source<TContext> value)
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetParameters(in Corvus.OpenapiBenchmark.Baseline.Schema.MapOfStrings.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetParameters<TContext>(in Corvus.OpenapiBenchmark.Baseline.Schema.MapOfStrings.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
            ...
            public bool TryGetAsLink(out Corvus.OpenapiBenchmark.Baseline.Schema.Link result)
            {
                ...
                {
                    result = Corvus.OpenapiBenchmark.Baseline.Schema.Link.Mutable.From(this);
                    return true;
                }
            ...
            public bool TryGetAsRequiredRef(out Corvus.OpenapiBenchmark.Baseline.Schema.LinkOrReference.RequiredRef result)
            {
                if (Corvus.OpenapiBenchmark.Baseline.Schema.LinkOrReference.RequiredRef.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.OpenapiBenchmark.Baseline.Schema.LinkOrReference.RequiredRef.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.OpenapiBenchmark.Baseline.Schema.LinkOrReference.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Baseline.Schema.LinkOrReference.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.OpenapiBenchmark.Baseline.JsonUriReferenceNotAsserted.Source refValue = default, in Corvus.OpenapiBenchmark.Baseline.Schema.Server.Source<TContext> body = default, in Corvus.OpenapiBenchmark.Baseline.JsonString.Source description = default, in Corvus.OpenapiBenchmark.Baseline.JsonString.Source operationId = default, in Corvus.OpenapiBenchmark.Baseline.JsonUriReferenceNotAsserted.Source operationRef = default, in Corvus.OpenapiBenchmark.Baseline.Schema.MapOfStrings.Source<TContext> parameters = default, in Corvus.Text.Json.JsonElement.Source<TContext> requestBody = default, in Corvus.OpenapiBenchmark.Baseline.JsonString.Source summary = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
