...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// </summary>
        public Corvus.OpenapiBenchmark.Baseline.JsonUriReferenceNotAsserted OperationRef
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OperationRefUtf8, out Corvus.OpenapiBenchmark.Baseline.JsonUriReferenceNotAsserted value))
                {
                    return value;
                }
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Baseline.Schema.Link" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsLink(out Corvus.OpenapiBenchmark.Baseline.Schema.Link result)
        {
            if (Corvus.OpenapiBenchmark.Baseline.Schema.Link.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.OpenapiBenchmark.Baseline.Schema.Link.From(this);
                return true;
            }
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Baseline.Schema.LinkOrReference.RequiredRef" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsRequiredRef(out Corvus.OpenapiBenchmark.Baseline.Schema.LinkOrReference.RequiredRef result)
        {
            if (Corvus.OpenapiBenchmark.Baseline.Schema.LinkOrReference.RequiredRef.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.OpenapiBenchmark.Baseline.Schema.LinkOrReference.RequiredRef.From(this);
                return true;
            }
        ...
        /// <param name="matchCorvusOpenapiBenchmarkBaselineSchemaLink">Match a <see cref="Corvus.OpenapiBenchmark.Baseline.Schema.Link"/>.</param>
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.OpenapiBenchmark.Baseline.Schema.Link, TContext, TResult> matchCorvusOpenapiBenchmarkBaselineSchemaLink)
...
#endif
        {
            ...
            {
                return matchCorvusOpenapiBenchmarkBaselineSchemaLink(Corvus.OpenapiBenchmark.Baseline.Schema.Link.From(this), context);
            }
        }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.OpenapiBenchmark.Baseline.Schema.Link, TResult> matchCorvusOpenapiBenchmarkBaselineSchemaLink)
        {
            if (Corvus.OpenapiBenchmark.Baseline.Schema.LinkOrReference.RequiredRef.JsonSchema.Evaluate(_parent, _idx))
            {
            ...
            {
                return matchCorvusOpenapiBenchmarkBaselineSchemaLink(Corvus.OpenapiBenchmark.Baseline.Schema.Link.From(this));
            }
        }
