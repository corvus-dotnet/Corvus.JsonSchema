    ...
    public readonly partial struct OauthFlows
    {
        ...
        public readonly partial struct RequiredAuthorizationUrlAndScopesAndTokenUrl
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.OpenapiBenchmark.Baseline.JsonUriNotAsserted.Mutable AuthorizationUrl
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AuthorizationUrlUtf8, out Corvus.OpenapiBenchmark.Baseline.JsonUriNotAsserted.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetAuthorizationUrl(in Corvus.OpenapiBenchmark.Baseline.JsonUriNotAsserted.Source value)
                {
                    CheckValidInstance();
                    ...
                    else
                    {
                        ...
                        value.AddAsProperty(JsonPropertyNamesEscaped.AuthorizationUrl, ref cvb, escapeName: false, nameRequiresUnescaping: false);
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.OpenapiBenchmark.Baseline.Schema.OauthFlows.RequiredAuthorizationUrlAndScopesAndTokenUrl.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Baseline.Schema.OauthFlows.RequiredAuthorizationUrlAndScopesAndTokenUrl.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.OpenapiBenchmark.Baseline.JsonUriNotAsserted.Source authorizationUrl,
                ...
                {
                    authorizationUrl.AddAsProperty(JsonPropertyNamesEscaped.AuthorizationUrl, ref builder, escapeName: false);
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.OpenapiBenchmark.Baseline.JsonUriNotAsserted.Source authorizationUrl, in Corvus.OpenapiBenchmark.Baseline.Schema.MapOfStrings.Source<TContext> scopes, in Corvus.OpenapiBenchmark.Baseline.JsonUriNotAsserted.Source tokenUrl, in Corvus.OpenapiBenchmark.Baseline.JsonUriNotAsserted.Source refreshUrl = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
