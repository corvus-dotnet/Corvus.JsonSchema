    ...
    public readonly partial struct OauthFlows
    {
        ...
        public readonly partial struct RequiredScopesAndTokenUrl
        {
...
#endif
            {
                ...
                /// </summary>
                public Corvus.OpenapiBenchmark.Baseline.JsonUri.Mutable RefreshUrl
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RefreshUrlUtf8, out Corvus.OpenapiBenchmark.Baseline.JsonUri.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.OpenapiBenchmark.Baseline.JsonUri.Mutable TokenUrl
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TokenUrlUtf8, out Corvus.OpenapiBenchmark.Baseline.JsonUri.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetRefreshUrl(in Corvus.OpenapiBenchmark.Baseline.JsonUri.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetTokenUrl(in Corvus.OpenapiBenchmark.Baseline.JsonUri.Source value)
                {
                    CheckValidInstance();
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.OpenapiBenchmark.Baseline.JsonUri.Source tokenUrl,
                    in Corvus.OpenapiBenchmark.Baseline.JsonUri.Source refreshUrl = default)
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OpenapiBenchmark.Baseline.Schema.MapOfStrings.Source scopes, in Corvus.OpenapiBenchmark.Baseline.JsonUri.Source tokenUrl, in Corvus.OpenapiBenchmark.Baseline.JsonUri.Source refreshUrl = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.OpenapiBenchmark.Baseline.Schema.MapOfStrings.Source<TContext> scopes, in Corvus.OpenapiBenchmark.Baseline.JsonUri.Source tokenUrl, in Corvus.OpenapiBenchmark.Baseline.JsonUri.Source refreshUrl = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
