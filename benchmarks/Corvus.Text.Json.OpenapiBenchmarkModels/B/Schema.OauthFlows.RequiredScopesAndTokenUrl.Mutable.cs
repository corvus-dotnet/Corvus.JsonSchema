...
public readonly partial struct Schema
{
    ...
    public readonly partial struct OauthFlows
    {
        ...
        public readonly partial struct RequiredScopesAndTokenUrl
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RequiredScopesAndTokenUrl instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RequiredScopesAndTokenUrl"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RequiredScopesAndTokenUrl(Mutable instance)
                {
                ...
                /// </summary>
                public Corvus.OpenapiBenchmark.Baseline.JsonUriNotAsserted.Mutable RefreshUrl
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RefreshUrlUtf8, out Corvus.OpenapiBenchmark.Baseline.JsonUriNotAsserted.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.OpenapiBenchmark.Baseline.Schema.MapOfStrings.Mutable Scopes
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ScopesUtf8, out Corvus.OpenapiBenchmark.Baseline.Schema.MapOfStrings.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.OpenapiBenchmark.Baseline.JsonUriNotAsserted.Mutable TokenUrl
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TokenUrlUtf8, out Corvus.OpenapiBenchmark.Baseline.JsonUriNotAsserted.Mutable value))
                        {
                            return value;
                        }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new RequiredScopesAndTokenUrl(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                public void SetRefreshUrl(in Corvus.OpenapiBenchmark.Baseline.JsonUriNotAsserted.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetScopes(in Corvus.OpenapiBenchmark.Baseline.Schema.MapOfStrings.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetScopes<TContext>(in Corvus.OpenapiBenchmark.Baseline.Schema.MapOfStrings.Source<TContext> value)
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetTokenUrl(in Corvus.OpenapiBenchmark.Baseline.JsonUriNotAsserted.Source value)
                {
                    CheckValidInstance();
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RequiredScopesAndTokenUrl.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="RequiredScopesAndTokenUrl"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="RequiredScopesAndTokenUrl"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredScopesAndTokenUrl Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<RequiredScopesAndTokenUrl>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="RequiredScopesAndTokenUrl"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredScopesAndTokenUrl Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RequiredScopesAndTokenUrl>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.OpenapiBenchmark.Baseline.Schema.OauthFlows.RequiredScopesAndTokenUrl.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(RequiredScopesAndTokenUrl instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Baseline.Schema.OauthFlows.RequiredScopesAndTokenUrl.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="RequiredScopesAndTokenUrl"/>.
                /// </summary>
                internal static void Create(
                    ref ComplexValueBuilder builder,
                    in Corvus.OpenapiBenchmark.Baseline.Schema.MapOfStrings.Source scopes,
                    in Corvus.OpenapiBenchmark.Baseline.JsonUriNotAsserted.Source tokenUrl,
                    in Corvus.OpenapiBenchmark.Baseline.JsonUriNotAsserted.Source refreshUrl = default)
                {
                ...
                internal static void Create<TContext>(
                    in TContext context,
                    ref ComplexValueBuilder builder,
                    in Corvus.OpenapiBenchmark.Baseline.Schema.MapOfStrings.Source<TContext> scopes,
                    in Corvus.OpenapiBenchmark.Baseline.JsonUriNotAsserted.Source tokenUrl,
                    in Corvus.OpenapiBenchmark.Baseline.JsonUriNotAsserted.Source refreshUrl = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OpenapiBenchmark.Baseline.Schema.MapOfStrings.Source scopes, in Corvus.OpenapiBenchmark.Baseline.JsonUriNotAsserted.Source tokenUrl, in Corvus.OpenapiBenchmark.Baseline.JsonUriNotAsserted.Source refreshUrl = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.OpenapiBenchmark.Baseline.Schema.MapOfStrings.Source<TContext> scopes, in Corvus.OpenapiBenchmark.Baseline.JsonUriNotAsserted.Source tokenUrl, in Corvus.OpenapiBenchmark.Baseline.JsonUriNotAsserted.Source refreshUrl = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
            ...
            {
                return workspace.CreateBuilder<RequiredScopesAndTokenUrl, Mutable>(this);
            }
        }
    }
}
