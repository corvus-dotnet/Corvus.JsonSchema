...
public readonly partial struct Schema
{
    ...
    public readonly partial struct OauthFlows
    {
        ...
        public readonly partial struct RequiredScopesAndTokenUrl
            ...
            : IJsonElement<RequiredScopesAndTokenUrl>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RequiredScopesAndTokenUrl"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RequiredScopesAndTokenUrl(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RequiredScopesAndTokenUrl DefaultInstance { get; }
            ...
            /// </summary>
            public Corvus.OpenapiBenchmark.Baseline.JsonUriNotAsserted RefreshUrl
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RefreshUrlUtf8, out Corvus.OpenapiBenchmark.Baseline.JsonUriNotAsserted value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.OpenapiBenchmark.Baseline.Schema.MapOfStrings Scopes
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ScopesUtf8, out Corvus.OpenapiBenchmark.Baseline.Schema.MapOfStrings value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.OpenapiBenchmark.Baseline.JsonUriNotAsserted TokenUrl
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TokenUrlUtf8, out Corvus.OpenapiBenchmark.Baseline.JsonUriNotAsserted value))
                    {
                        return value;
                    }
            ...
            public static implicit operator Corvus.OpenapiBenchmark.Baseline.Schema.SpecificationExtensions(RequiredScopesAndTokenUrl value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator RequiredScopesAndTokenUrl(Corvus.OpenapiBenchmark.Baseline.Schema.SpecificationExtensions value)
            {
                return From(value);
            }
            ...
            /// </returns>
            public static bool operator ==(in RequiredScopesAndTokenUrl left, in RequiredScopesAndTokenUrl right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RequiredScopesAndTokenUrl left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(RequiredScopesAndTokenUrl instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RequiredScopesAndTokenUrl(JsonElement instance)
            {
                return RequiredScopesAndTokenUrl.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredScopesAndTokenUrl From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredScopesAndTokenUrl ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredScopesAndTokenUrl>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredScopesAndTokenUrl ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredScopesAndTokenUrl>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredScopesAndTokenUrl ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredScopesAndTokenUrl>(json, options);
            }
            ...
            /// </exception>
            public static RequiredScopesAndTokenUrl ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RequiredScopesAndTokenUrl>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredScopesAndTokenUrl? result)
            {
                return JsonElementHelpers.TryParseValue<RequiredScopesAndTokenUrl>(ref reader, out result);
            }
...
#if NET
            static RequiredScopesAndTokenUrl IJsonElement<RequiredScopesAndTokenUrl>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RequiredScopesAndTokenUrl: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public RequiredScopesAndTokenUrl Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public RequiredScopesAndTokenUrl Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RequiredScopesAndTokenUrl>(_idx);
                }
