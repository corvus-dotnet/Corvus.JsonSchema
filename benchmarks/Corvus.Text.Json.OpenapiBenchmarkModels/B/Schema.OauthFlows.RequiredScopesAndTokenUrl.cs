...
public readonly partial struct Schema
{
    ...
    public readonly partial struct OauthFlows
    {
...
#endif
        {
            ...
            /// </summary>
            public Corvus.OpenapiBenchmark.Baseline.JsonUri RefreshUrl
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RefreshUrlUtf8, out Corvus.OpenapiBenchmark.Baseline.JsonUri value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.OpenapiBenchmark.Baseline.JsonUri TokenUrl
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TokenUrlUtf8, out Corvus.OpenapiBenchmark.Baseline.JsonUri value))
                    {
                        return value;
                    }
