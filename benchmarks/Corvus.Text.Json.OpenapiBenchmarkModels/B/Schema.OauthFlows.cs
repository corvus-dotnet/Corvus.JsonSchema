...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OauthFlows"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal OauthFlows(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static OauthFlows DefaultInstance { get; }
        ...
        /// </summary>
        public Corvus.OpenapiBenchmark.Baseline.Schema.OauthFlows.RequiredAuthorizationUrlAndScopesAndTokenUrl AuthorizationCode
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AuthorizationCodeUtf8, out Corvus.OpenapiBenchmark.Baseline.Schema.OauthFlows.RequiredAuthorizationUrlAndScopesAndTokenUrl value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.OpenapiBenchmark.Baseline.Schema.OauthFlows.RequiredScopesAndTokenUrl ClientCredentials
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ClientCredentialsUtf8, out Corvus.OpenapiBenchmark.Baseline.Schema.OauthFlows.RequiredScopesAndTokenUrl value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.OpenapiBenchmark.Baseline.Schema.OauthFlows.RequiredAuthorizationUrlAndScopes Implicit
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ImplicitUtf8, out Corvus.OpenapiBenchmark.Baseline.Schema.OauthFlows.RequiredAuthorizationUrlAndScopes value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.OpenapiBenchmark.Baseline.Schema.OauthFlows.OauthFlowsRequiredScopesAndTokenUrl Password
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PasswordUtf8, out Corvus.OpenapiBenchmark.Baseline.Schema.OauthFlows.OauthFlowsRequiredScopesAndTokenUrl value))
                {
                    return value;
                }
        ...
        public static implicit operator Corvus.OpenapiBenchmark.Baseline.Schema.SpecificationExtensions(OauthFlows value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator OauthFlows(Corvus.OpenapiBenchmark.Baseline.Schema.SpecificationExtensions value)
        {
            return From(value);
        }
        ...
        /// </returns>
        public static bool operator ==(in OauthFlows left, in OauthFlows right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in OauthFlows left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(OauthFlows instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator OauthFlows(JsonElement instance)
        {
            return OauthFlows.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static OauthFlows From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static OauthFlows ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<OauthFlows>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static OauthFlows ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<OauthFlows>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static OauthFlows ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<OauthFlows>(json, options);
        }
        ...
        /// </exception>
        public static OauthFlows ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<OauthFlows>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out OauthFlows? result)
        {
            return JsonElementHelpers.TryParseValue<OauthFlows>(ref reader, out result);
        }
...
#if NET
        static OauthFlows IJsonElement<OauthFlows>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"OauthFlows: ValueKind = {ValueKind} : \"{ToString()}\"";
