...
public readonly partial struct Schema
{
    ...
    public readonly partial struct OpenapiEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(OpenapiEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="OpenapiEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator OpenapiEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"OpenapiEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly OpenapiEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly OpenapiEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<OpenapiEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(OpenapiEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<OpenapiEntity, Mutable>(this);
        }
    }
}
