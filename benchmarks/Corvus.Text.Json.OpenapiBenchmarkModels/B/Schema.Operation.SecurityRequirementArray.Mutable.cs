    ...
    public readonly partial struct Operation
    {
        ...
        public readonly partial struct SecurityRequirementArray
        {
...
#endif
            {
                ...
                public Corvus.OpenapiBenchmark.Baseline.Schema.SecurityRequirement.Mutable this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.OpenapiBenchmark.Baseline.Schema.SecurityRequirement.Mutable>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.OpenapiBenchmark.Baseline.Schema.SecurityRequirement.Mutable> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.OpenapiBenchmark.Baseline.Schema.SecurityRequirement.Mutable>(_parent, _idx);
                }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetItem(int itemIndex, in Corvus.OpenapiBenchmark.Baseline.Schema.SecurityRequirement.Source value)
                {
                    CheckValidInstance();
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void InsertItem(int itemIndex, in Corvus.OpenapiBenchmark.Baseline.Schema.SecurityRequirement.Source value)
                {
                    CheckValidInstance();
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void AddItem(in Corvus.OpenapiBenchmark.Baseline.Schema.SecurityRequirement.Source value)
                {
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Remove(in Corvus.OpenapiBenchmark.Baseline.Schema.SecurityRequirement item)
                {
                    CheckValidInstance();
                    if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.OpenapiBenchmark.Baseline.Schema.SecurityRequirement>(this, in item))
                    {
                        return false;
                    }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void RemoveWhere(JsonPredicate<Corvus.OpenapiBenchmark.Baseline.Schema.SecurityRequirement> predicate)
                {
                    CheckValidInstance();
                    JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.OpenapiBenchmark.Baseline.Schema.SecurityRequirement>(this, predicate);
                    _documentVersion = _parent.Version;
                }
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Replace(in Corvus.OpenapiBenchmark.Baseline.Schema.SecurityRequirement oldItem, in Corvus.OpenapiBenchmark.Baseline.Schema.SecurityRequirement.Source newItem)
                {
                    CheckValidInstance();
                    ...
                    var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.OpenapiBenchmark.Baseline.Schema.SecurityRequirement>(_parent, _idx);

                    while (enumerator.MoveNext())
                    {
                        Corvus.OpenapiBenchmark.Baseline.Schema.SecurityRequirement current = enumerator.Current;
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.OpenapiBenchmark.Baseline.Schema.Operation.SecurityRequirementArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Baseline.Schema.Operation.SecurityRequirementArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
