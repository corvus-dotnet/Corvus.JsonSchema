...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Parameter
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.RequiredIn.InEntity In
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.InUtf8, out Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.RequiredIn.InEntity value))
                    {
                        return value;
                    }
