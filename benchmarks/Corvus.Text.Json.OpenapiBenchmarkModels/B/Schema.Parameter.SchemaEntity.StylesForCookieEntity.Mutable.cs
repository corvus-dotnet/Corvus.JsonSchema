        ...
        public readonly partial struct SchemaEntity
        {
            ...
            public readonly partial struct StylesForCookieEntity
            {
...
#endif
                {
                    ...
                    /// </summary>
                    public Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForCookieEntity.WithStyleForm.StyleEntity.Mutable Style
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StyleUtf8, out Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForCookieEntity.WithStyleForm.StyleEntity.Mutable value))
                            {
                                return value;
                            }
                    ...
                    public void SetStyle(in Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForCookieEntity.WithStyleForm.StyleEntity.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// <param name="matchCorvusOpenapiBenchmarkBaselineSchemaParameterSchemaEntityStylesForCookieEntityWithStyleForm">Match a <see cref="Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForCookieEntity.WithStyleForm"/>.</param>
                    ...
                    public TResult Match<TContext, TResult>(
                        in TContext context,
                        Matcher<Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForCookieEntity.WithStyleForm, TContext, TResult> matchCorvusOpenapiBenchmarkBaselineSchemaParameterSchemaEntityStylesForCookieEntityWithStyleForm,
                        Matcher<StylesForCookieEntity, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                    {
                        if (Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForCookieEntity.RequiredIn.JsonSchema.Evaluate(_parent, _idx))
                        {
                            return matchCorvusOpenapiBenchmarkBaselineSchemaParameterSchemaEntityStylesForCookieEntityWithStyleForm(Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForCookieEntity.WithStyleForm.From(this), context);
                        }
                    ...
                    public TResult Match<TResult>(
                        Matcher<Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForCookieEntity.WithStyleForm, TResult> matchCorvusOpenapiBenchmarkBaselineSchemaParameterSchemaEntityStylesForCookieEntityWithStyleForm,
                        Matcher<StylesForCookieEntity, TResult> defaultMatch)
                    {
                        if (Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForCookieEntity.RequiredIn.JsonSchema.Evaluate(_parent, _idx))
                        {
                            return matchCorvusOpenapiBenchmarkBaselineSchemaParameterSchemaEntityStylesForCookieEntityWithStyleForm(Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForCookieEntity.WithStyleForm.From(this));
                        }
                    ...
                    /// <summary>
                    /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForCookieEntity.RequiredIn" />.
                    /// </summary>
                    /// <param name="result">The result of the conversions.</param>
                    /// <returns><see langword="true" /> if the conversion was valid.</returns>
                    public bool TryGetAsRequiredIn(out Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForCookieEntity.RequiredIn result)
                    {
                        if (Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForCookieEntity.RequiredIn.JsonSchema.Evaluate(_parent, _idx))
                        {
                            result = Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForCookieEntity.RequiredIn.Mutable.From(this);
                            return true;
                        }
                    ...
                    /// <summary>
                    /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForCookieEntity.WithStyleForm" />.
                    /// </summary>
                    /// <param name="result">The result of the conversions.</param>
                    /// <returns><see langword="true" /> if the conversion was valid.</returns>
                    public bool TryGetAsWithStyleForm(out Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForCookieEntity.WithStyleForm result)
                    {
                        if (Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForCookieEntity.WithStyleForm.JsonSchema.Evaluate(_parent, _idx))
                        {
                            result = Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForCookieEntity.WithStyleForm.Mutable.From(this);
                            return true;
                        }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForCookieEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForCookieEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// </summary>
                    internal static void Create(ref ComplexValueBuilder builder, in Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForCookieEntity.WithStyleForm.StyleEntity.Source style = default)
                    {
                    ...
                    /// Creates an instance of a <see cref="StylesForCookieEntity"/>.
                    /// </summary>
                    public void Create(in Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForCookieEntity.WithStyleForm.StyleEntity.Source style = default)
                    {
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForCookieEntity.WithStyleForm.StyleEntity.Source style = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
