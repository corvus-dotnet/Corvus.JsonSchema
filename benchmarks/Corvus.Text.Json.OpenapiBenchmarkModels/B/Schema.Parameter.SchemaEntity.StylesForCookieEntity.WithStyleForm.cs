        ...
        public readonly partial struct SchemaEntity
        {
            ...
            public readonly partial struct StylesForCookieEntity
            {
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="WithStyleForm"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal WithStyleForm(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static WithStyleForm DefaultInstance { get; }
                    ...
                    /// </summary>
                    public Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForCookieEntity.WithStyleForm.StyleEntity Style
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StyleUtf8, out Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForCookieEntity.WithStyleForm.StyleEntity value))
                            {
                                return value;
                            }

                            return Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForCookieEntity.WithStyleForm.StyleEntity.DefaultInstance;
                        }
                    }
                    ...
                    /// </returns>
                    public static bool operator ==(in WithStyleForm left, in WithStyleForm right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in WithStyleForm left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    public static implicit operator JsonElement(WithStyleForm instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator WithStyleForm(JsonElement instance)
                    {
                        return WithStyleForm.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static WithStyleForm From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static WithStyleForm ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<WithStyleForm>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static WithStyleForm ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<WithStyleForm>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static WithStyleForm ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<WithStyleForm>(json, options);
                    }
                    ...
                    /// </exception>
                    public static WithStyleForm ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<WithStyleForm>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out WithStyleForm? result)
                    {
                        return JsonElementHelpers.TryParseValue<WithStyleForm>(ref reader, out result);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new WithStyleForm(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                    static WithStyleForm IJsonElement<WithStyleForm>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"WithStyleForm: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="WithStyleForm"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="WithStyleForm"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public WithStyleForm Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<WithStyleForm>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="WithStyleForm"/> that lives for the lifetime of its
