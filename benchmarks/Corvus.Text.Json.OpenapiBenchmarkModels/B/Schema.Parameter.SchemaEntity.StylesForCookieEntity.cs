    ...
    public readonly partial struct Parameter
    {
        ...
        public readonly partial struct SchemaEntity
        {
...
#endif
            {
                ...
                internal StylesForCookieEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in StylesForCookieEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(StylesForCookieEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator StylesForCookieEntity(JsonElement instance)
                {
                    return StylesForCookieEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static StylesForCookieEntity From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static StylesForCookieEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<StylesForCookieEntity>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static StylesForCookieEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<StylesForCookieEntity>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static StylesForCookieEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<StylesForCookieEntity>(json, options);
                }
                ...
                /// </exception>
                public static StylesForCookieEntity ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<StylesForCookieEntity>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out StylesForCookieEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<StylesForCookieEntity>(ref reader, out result);
                }
...
#if NET
                static StylesForCookieEntity IJsonElement<StylesForCookieEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"StylesForCookieEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public StylesForCookieEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public StylesForCookieEntity Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<StylesForCookieEntity>(_idx);
                    }
                ...
                public bool TryGetAsRequiredIn(out Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForCookieEntity.RequiredIn result)
                {
                    ...
                    {
                        result = Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForCookieEntity.RequiredIn.From(this);
                        return true;
                    }
                ...
                public bool TryGetAsWithStyleForm(out Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForCookieEntity.WithStyleForm result)
                {
                    ...
                    {
                        result = Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForCookieEntity.WithStyleForm.From(this);
                        return true;
                    }
