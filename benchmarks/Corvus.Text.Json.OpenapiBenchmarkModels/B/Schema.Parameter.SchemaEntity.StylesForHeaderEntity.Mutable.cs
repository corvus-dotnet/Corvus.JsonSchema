        ...
        public readonly partial struct SchemaEntity
        {
            ...
            public readonly partial struct StylesForHeaderEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(StylesForHeaderEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="StylesForHeaderEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator StylesForHeaderEntity(Mutable instance)
                    {
                    ...
                    /// </summary>
                    public Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForHeaderEntity.WithStyleSimple.StyleEntity.Mutable Style
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StyleUtf8, out Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForHeaderEntity.WithStyleSimple.StyleEntity.Mutable value))
                            {
                                return value;
                            }
                    ...
                    public void SetStyle(in Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForHeaderEntity.WithStyleSimple.StyleEntity.Source value)
                    {
                        CheckValidInstance();
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"StylesForHeaderEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly StylesForHeaderEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly StylesForHeaderEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<StylesForHeaderEntity>(_idx);
                    }
                    ...
                    /// <param name="matchCorvusOpenapiBenchmarkBaselineSchemaParameterSchemaEntityStylesForHeaderEntityWithStyleSimple">Match a <see cref="Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForHeaderEntity.WithStyleSimple"/>.</param>
                    ...
                    public TResult Match<TContext, TResult>(
                        in TContext context,
                        Matcher<Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForHeaderEntity.WithStyleSimple, TContext, TResult> matchCorvusOpenapiBenchmarkBaselineSchemaParameterSchemaEntityStylesForHeaderEntityWithStyleSimple,
                        Matcher<StylesForHeaderEntity, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                    {
                        if (Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForHeaderEntity.RequiredIn.JsonSchema.Evaluate(_parent, _idx))
                        {
                            return matchCorvusOpenapiBenchmarkBaselineSchemaParameterSchemaEntityStylesForHeaderEntityWithStyleSimple(Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForHeaderEntity.WithStyleSimple.From(this), context);
                        }
                    ...
                    public TResult Match<TResult>(
                        Matcher<Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForHeaderEntity.WithStyleSimple, TResult> matchCorvusOpenapiBenchmarkBaselineSchemaParameterSchemaEntityStylesForHeaderEntityWithStyleSimple,
                        Matcher<StylesForHeaderEntity, TResult> defaultMatch)
                    {
                        if (Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForHeaderEntity.RequiredIn.JsonSchema.Evaluate(_parent, _idx))
                        {
                            return matchCorvusOpenapiBenchmarkBaselineSchemaParameterSchemaEntityStylesForHeaderEntityWithStyleSimple(Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForHeaderEntity.WithStyleSimple.From(this));
                        }
                    ...
                    /// <summary>
                    /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForHeaderEntity.RequiredIn" />.
                    /// </summary>
                    /// <param name="result">The result of the conversions.</param>
                    /// <returns><see langword="true" /> if the conversion was valid.</returns>
                    public bool TryGetAsRequiredIn(out Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForHeaderEntity.RequiredIn result)
                    {
                        if (Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForHeaderEntity.RequiredIn.JsonSchema.Evaluate(_parent, _idx))
                        {
                            result = Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForHeaderEntity.RequiredIn.Mutable.From(this);
                            return true;
                        }
                    ...
                    /// <summary>
                    /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForHeaderEntity.WithStyleSimple" />.
                    /// </summary>
                    /// <param name="result">The result of the conversions.</param>
                    /// <returns><see langword="true" /> if the conversion was valid.</returns>
                    public bool TryGetAsWithStyleSimple(out Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForHeaderEntity.WithStyleSimple result)
                    {
                        if (Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForHeaderEntity.WithStyleSimple.JsonSchema.Evaluate(_parent, _idx))
                        {
                            result = Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForHeaderEntity.WithStyleSimple.Mutable.From(this);
                            return true;
                        }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForHeaderEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(StylesForHeaderEntity instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForHeaderEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// </summary>
                    internal static void Create(ref ComplexValueBuilder builder, in Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForHeaderEntity.WithStyleSimple.StyleEntity.Source style = default)
                    {
                    ...
                    /// Creates an instance of a <see cref="StylesForHeaderEntity"/>.
                    /// </summary>
                    public void Create(in Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForHeaderEntity.WithStyleSimple.StyleEntity.Source style = default)
                    {
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForHeaderEntity.WithStyleSimple.StyleEntity.Source style = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                ...
                {
                    return workspace.CreateBuilder<StylesForHeaderEntity, Mutable>(this);
                }
            }
        }
    }
