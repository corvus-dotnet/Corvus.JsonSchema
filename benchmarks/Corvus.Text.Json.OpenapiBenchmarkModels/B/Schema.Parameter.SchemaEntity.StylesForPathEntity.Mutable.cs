        ...
        public readonly partial struct SchemaEntity
        {
            ...
            public readonly partial struct StylesForPathEntity
            {
...
#endif
                {
                    ...
                    /// <param name="matchCorvusOpenapiBenchmarkBaselineSchemaParameterSchemaEntityStylesForPathEntityRequiredRequired">Match a <see cref="Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForPathEntity.RequiredRequired"/>.</param>
                    ...
                    public TResult Match<TContext, TResult>(
                        in TContext context,
                        Matcher<Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForPathEntity.RequiredRequired, TContext, TResult> matchCorvusOpenapiBenchmarkBaselineSchemaParameterSchemaEntityStylesForPathEntityRequiredRequired,
                        Matcher<StylesForPathEntity, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                    {
                        if (Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForPathEntity.RequiredIn.JsonSchema.Evaluate(_parent, _idx))
                        {
                            return matchCorvusOpenapiBenchmarkBaselineSchemaParameterSchemaEntityStylesForPathEntityRequiredRequired(Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForPathEntity.RequiredRequired.From(this), context);
                        }
                    ...
                    public TResult Match<TResult>(
                        Matcher<Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForPathEntity.RequiredRequired, TResult> matchCorvusOpenapiBenchmarkBaselineSchemaParameterSchemaEntityStylesForPathEntityRequiredRequired,
                        Matcher<StylesForPathEntity, TResult> defaultMatch)
                    {
                        if (Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForPathEntity.RequiredIn.JsonSchema.Evaluate(_parent, _idx))
                        {
                            return matchCorvusOpenapiBenchmarkBaselineSchemaParameterSchemaEntityStylesForPathEntityRequiredRequired(Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForPathEntity.RequiredRequired.From(this));
                        }
                    ...
                    /// <summary>
                    /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForPathEntity.RequiredIn" />.
                    /// </summary>
                    /// <param name="result">The result of the conversions.</param>
                    /// <returns><see langword="true" /> if the conversion was valid.</returns>
                    public bool TryGetAsRequiredIn(out Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForPathEntity.RequiredIn result)
                    {
                        if (Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForPathEntity.RequiredIn.JsonSchema.Evaluate(_parent, _idx))
                        {
                            result = Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForPathEntity.RequiredIn.Mutable.From(this);
                            return true;
                        }
                    ...
                    /// <summary>
                    /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForPathEntity.RequiredRequired" />.
                    /// </summary>
                    /// <param name="result">The result of the conversions.</param>
                    /// <returns><see langword="true" /> if the conversion was valid.</returns>
                    public bool TryGetAsRequiredRequired(out Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForPathEntity.RequiredRequired result)
                    {
                        if (Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForPathEntity.RequiredRequired.JsonSchema.Evaluate(_parent, _idx))
                        {
                            result = Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForPathEntity.RequiredRequired.Mutable.From(this);
                            return true;
                        }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForPathEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForPathEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    internal static void Create(
                        ...
                        in Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForPathEntity.RequiredRequired.StyleEntity.Source style = default)
                    {
                    ...
                    /// Creates an instance of a <see cref="StylesForPathEntity"/>.
                    /// </summary>
                    public void Create(in Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForPathEntity.RequiredRequired.RequiredEntity.Source required = default, in Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForPathEntity.RequiredRequired.StyleEntity.Source style = default)
                    {
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForPathEntity.RequiredRequired.RequiredEntity.Source required = default, in Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForPathEntity.RequiredRequired.StyleEntity.Source style = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
