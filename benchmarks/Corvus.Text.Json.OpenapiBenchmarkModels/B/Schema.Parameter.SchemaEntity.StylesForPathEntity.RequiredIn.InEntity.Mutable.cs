                ...
                public readonly partial struct RequiredIn
                {
                    ...
                    public readonly partial struct InEntity
                    {
...
#endif
                        {
                            ...
                            public static explicit operator Mutable(InEntity instance)
                            {
                            ...
                            /// <returns>An immutable instance of a <see cref="InEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator InEntity(Mutable instance)
                            {
                            ...
                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            private string DebuggerDisplay => $"InEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly InEntity Clone()
                            {
                                CheckValidInstance();
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly InEntity Freeze()
                            {
                                CheckValidInstance();
                                return _parent.FreezeElement<InEntity>(_idx);
                            }
                        }
                        ...
                        public ref struct Source
                        {
                            ...
                            public static implicit operator Source(InEntity instance) => new(JsonElement.From(instance));
                        ...
                        {
                            return workspace.CreateBuilder<InEntity, Mutable>(this);
                        }
                    }
                }
            }
