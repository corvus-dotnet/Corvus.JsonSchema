            ...
            public readonly partial struct StylesForPathEntity
            {
                ...
                public readonly partial struct RequiredRequired
                {
...
#endif
                    {
                        ...
                        /// </summary>
                        public Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForPathEntity.RequiredRequired.StyleEntity.Mutable Style
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StyleUtf8, out Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForPathEntity.RequiredRequired.StyleEntity.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        /// </summary>
                        /// <param name="value">The value of the property to add.</param>
                        public void SetStyle(in Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForPathEntity.RequiredRequired.StyleEntity.Source value)
                        {
                            CheckValidInstance();
                    ...
                    public ref struct Source
                    {
                        ...
                        internal Source(Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForPathEntity.RequiredRequired.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForPathEntity.RequiredRequired.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    public ref struct Builder
                    {
                        ...
                        /// </summary>
                        internal static void Create(ref ComplexValueBuilder builder, in Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForPathEntity.RequiredRequired.StyleEntity.Source style = default)
                        {
                            builder.AddProperty(JsonPropertyNamesEscaped.Required, Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForPathEntity.RequiredRequired.RequiredEntity.ConstInstance);
                        ...
                        /// Creates an instance of a <see cref="RequiredRequired"/>.
                        /// </summary>
                        public void Create(in Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForPathEntity.RequiredRequired.StyleEntity.Source style = default)
                        {
                    ...
                    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForPathEntity.RequiredRequired.StyleEntity.Source style = default, int initialCapacity = 30)
                    {
                        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                        cvb.StartObject();
