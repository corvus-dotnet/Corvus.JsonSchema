            ...
            public readonly partial struct StylesForQueryEntity
            {
...
#endif
                {
                    ...
                    public bool TryGetAsRequiredIn(out Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForQueryEntity.RequiredIn result)
                    {
                        if (Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForQueryEntity.RequiredIn.JsonSchema.Evaluate(_parent, _idx))
                        {
                            result = Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForQueryEntity.RequiredIn.Mutable.From(this);
                            return true;
                        }
                    ...
                    public bool TryGetAsThenEntity(out Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForQueryEntity.ThenEntity result)
                    {
                        ...
                        {
                            result = Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForQueryEntity.ThenEntity.Mutable.From(this);
                            return true;
                        }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForQueryEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForQueryEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
