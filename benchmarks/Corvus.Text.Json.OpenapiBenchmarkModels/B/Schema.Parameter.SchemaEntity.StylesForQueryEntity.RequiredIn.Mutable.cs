            ...
            public readonly partial struct StylesForQueryEntity
            {
                ...
                public readonly partial struct RequiredIn
                {
...
#endif
                    {
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForQueryEntity.RequiredIn.InEntity.Mutable In
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.InUtf8, out Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForQueryEntity.RequiredIn.InEntity.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        public void SetIn(in Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForQueryEntity.RequiredIn.InEntity.Source value)
                        {
                            CheckValidInstance();
                    ...
                    public ref struct Source
                    {
                        ...
                        internal Source(Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForQueryEntity.RequiredIn.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForQueryEntity.RequiredIn.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    public ref struct Builder
                    {
                        ...
                        {
                            builder.AddProperty(JsonPropertyNamesEscaped.In, Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForQueryEntity.RequiredIn.InEntity.ConstInstance);
                        }
