        ...
        public readonly partial struct SchemaEntity
        {
            ...
            public readonly partial struct StylesForQueryEntity
            {
...
#endif
                {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForQueryEntity.RequiredIn.InEntity In
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.InUtf8, out Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.SchemaEntity.StylesForQueryEntity.RequiredIn.InEntity value))
                            {
                                return value;
                            }
