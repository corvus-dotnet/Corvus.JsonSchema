...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Parameter
    {
            ...
            : IJsonElement<ThenEntity>
        {
            ...
            {
                private static readonly JsonSchemaPathProvider AllowEmptyValueSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/allowEmptyValue"u8, buffer, out written);

                private static void MatchAllowEmptyValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext =
                        Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.ThenEntity.AllowEmptyValueEntity.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.AllowEmptyValueUtf8,
                            evaluationPath: AllowEmptyValueSchemaEvaluationPath);

                    Corvus.OpenapiBenchmark.Baseline.Schema.Parameter.ThenEntity.AllowEmptyValueEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                ...
                {
                    if (span.SequenceEqual(JsonPropertyNames.AllowEmptyValueUtf8))
                    {
                        matcher = MatchAllowEmptyValue;
                        return true;
                    }
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/parameter/then"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/parameter/then";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/parameter/then"u8;
