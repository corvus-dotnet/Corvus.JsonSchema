...
public readonly partial struct Schema
{
    ...
    public readonly partial struct PathItem
    {
...
#endif
        {
            ...
            public Corvus.OpenapiBenchmark.Baseline.Schema.ParameterOrReference this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.OpenapiBenchmark.Baseline.Schema.ParameterOrReference>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.OpenapiBenchmark.Baseline.Schema.ParameterOrReference> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.OpenapiBenchmark.Baseline.Schema.ParameterOrReference>(_parent, _idx);
            }
