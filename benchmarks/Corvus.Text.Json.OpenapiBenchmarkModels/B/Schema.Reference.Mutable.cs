...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Reference
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Reference instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Reference"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Reference(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Reference(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Reference.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Reference"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Reference"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly Reference Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<Reference>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Reference"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly Reference Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Reference>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.OpenapiBenchmark.Baseline.Schema.Reference.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(Reference instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Baseline.Schema.Reference.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            public void Create(
                ...
                in Corvus.OpenapiBenchmark.Baseline.JsonString.Source summary = default)
            {
                Create(ref _builder, refValue, description, summary);
            }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OpenapiBenchmark.Baseline.JsonUriReferenceNotAsserted.Source refValue = default, in Corvus.OpenapiBenchmark.Baseline.JsonString.Source description = default, in Corvus.OpenapiBenchmark.Baseline.JsonString.Source summary = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(refValue, description, summary);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<Reference, Mutable>(this);
        }
    }
}
