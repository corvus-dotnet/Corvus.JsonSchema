...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        internal Reference(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Reference left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(Reference instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Reference(JsonElement instance)
        {
            return Reference.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Reference From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Reference ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Reference>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Reference ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Reference>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Reference ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Reference>(json, options);
        }
        ...
        /// </exception>
        public static Reference ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<Reference>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Reference? result)
        {
            return JsonElementHelpers.TryParseValue<Reference>(ref reader, out result);
        }
...
#if NET
        static Reference IJsonElement<Reference>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Reference: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public Reference Freeze()
        {
            ...
            {
                return mutable.FreezeElement<Reference>(_idx);
            }
