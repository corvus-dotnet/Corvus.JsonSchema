...
public readonly partial struct Schema
{
    ...
    public readonly partial struct RequestBodyOrReference
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(RequestBodyOrReference instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="RequestBodyOrReference"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RequestBodyOrReference(Mutable instance)
            {
            ...
            /// </summary>
            public Corvus.OpenapiBenchmark.Baseline.Schema.RequestBody.RequiredEntity.Mutable Required
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RequiredUtf8, out Corvus.OpenapiBenchmark.Baseline.Schema.RequestBody.RequiredEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetRequired(in Corvus.OpenapiBenchmark.Baseline.Schema.RequestBody.RequiredEntity.Source value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RequestBodyOrReference.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly RequestBodyOrReference Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly RequestBodyOrReference Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<RequestBodyOrReference>(_idx);
            }
            ...
            /// <param name="matchCorvusOpenapiBenchmarkBaselineSchemaRequestBody">Match a <see cref="Corvus.OpenapiBenchmark.Baseline.Schema.RequestBody"/>.</param>
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.OpenapiBenchmark.Baseline.Schema.RequestBody, TContext, TResult> matchCorvusOpenapiBenchmarkBaselineSchemaRequestBody)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
            {
                if (Corvus.OpenapiBenchmark.Baseline.Schema.RequestBodyOrReference.RequiredRef.JsonSchema.Evaluate(_parent, _idx))
                {
                ...
                {
                    return matchCorvusOpenapiBenchmarkBaselineSchemaRequestBody(Corvus.OpenapiBenchmark.Baseline.Schema.RequestBody.From(this), context);
                }
            }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.OpenapiBenchmark.Baseline.Schema.RequestBody, TResult> matchCorvusOpenapiBenchmarkBaselineSchemaRequestBody)
            {
                if (Corvus.OpenapiBenchmark.Baseline.Schema.RequestBodyOrReference.RequiredRef.JsonSchema.Evaluate(_parent, _idx))
                {
                ...
                {
                    return matchCorvusOpenapiBenchmarkBaselineSchemaRequestBody(Corvus.OpenapiBenchmark.Baseline.Schema.RequestBody.From(this));
                }
            }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Baseline.Schema.RequestBody" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsRequestBody(out Corvus.OpenapiBenchmark.Baseline.Schema.RequestBody result)
            {
                if (Corvus.OpenapiBenchmark.Baseline.Schema.RequestBody.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.OpenapiBenchmark.Baseline.Schema.RequestBody.Mutable.From(this);
                    return true;
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Baseline.Schema.RequestBodyOrReference.RequiredRef" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsRequiredRef(out Corvus.OpenapiBenchmark.Baseline.Schema.RequestBodyOrReference.RequiredRef result)
            {
                if (Corvus.OpenapiBenchmark.Baseline.Schema.RequestBodyOrReference.RequiredRef.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.OpenapiBenchmark.Baseline.Schema.RequestBodyOrReference.RequiredRef.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.OpenapiBenchmark.Baseline.Schema.RequestBodyOrReference.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(RequestBodyOrReference instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Baseline.Schema.RequestBodyOrReference.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.OpenapiBenchmark.Baseline.Schema.RequestBody.RequiredEntity.Source required = default,
            ...
            public void Create(
                ...
                in Corvus.OpenapiBenchmark.Baseline.JsonString.Source summary = default)
            {
                Create(ref _builder, refValue, content, description, required, summary);
            }
            ...
            #endif
            {
                Create(context, ref _builder, refValue, content, description, required, summary);
            }
            ...
            #endif
        {
            ...
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(context, refValue, content, description, required, summary);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<RequestBodyOrReference, Mutable>(this);
        }
    }
}
