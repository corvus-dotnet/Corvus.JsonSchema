...
public readonly partial struct Schema
{
    ...
    public readonly partial struct RequiredComponents
        ...
        : IJsonElement<RequiredComponents>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RequiredComponents"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal RequiredComponents(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static RequiredComponents DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.JsonElement Components
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ComponentsUtf8, out Corvus.Text.Json.JsonElement value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in RequiredComponents left, in RequiredComponents right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in RequiredComponents left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(RequiredComponents instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator RequiredComponents(JsonElement instance)
        {
            return RequiredComponents.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiredComponents From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiredComponents ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RequiredComponents>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiredComponents ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RequiredComponents>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiredComponents ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RequiredComponents>(json, options);
        }
        ...
        /// </exception>
        public static RequiredComponents ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<RequiredComponents>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredComponents? result)
        {
            return JsonElementHelpers.TryParseValue<RequiredComponents>(ref reader, out result);
        }
...
#if NET
        static RequiredComponents IJsonElement<RequiredComponents>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"RequiredComponents: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public RequiredComponents Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public RequiredComponents Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<RequiredComponents>(_idx);
            }
        ...
        {
            /// <summary>
            /// Gets the JSON property name for <see cref="Components"/>.
            /// </summary>
        ...
        {
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="Components"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Components => "components"u8;
        }
    }
}
