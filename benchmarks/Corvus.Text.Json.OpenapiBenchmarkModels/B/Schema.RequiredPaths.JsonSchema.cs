...
public readonly partial struct Schema
{
        ...
        : IJsonElement<RequiredPaths>
    {
        ...
        {
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyPathsPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("paths"u8, buffer, out written);
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyPathsNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("paths"u8, buffer, out written);

            private const int RequiredOffsetForPaths = 0;
            private const uint RequiredBitForPaths = 0b00000000000000000000000000000001;

            private const uint RequiredBitMask0 =
                RequiredBitForPaths;

            private static void MatchPaths(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                requiredBitBuffer[RequiredOffsetForPaths] |= RequiredBitForPaths;
            }
            ...
            {
                if (span.SequenceEqual(JsonPropertyNames.PathsUtf8))
                {
                    matcher = MatchPaths;
                    return true;
                }
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://spec.openapis.org/oas/3.1/schema/2022-10-07#/anyOf/0"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "https://spec.openapis.org/oas/3.1/schema/2022-10-07#/anyOf/0";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://spec.openapis.org/oas/3.1/schema/2022-10-07#/anyOf/0"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                if (tokenType == JsonTokenType.StartObject)
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyPathsPresent, "paths"u8, "required"u8);
                    }
                    ...
                    {
                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForPaths] & RequiredBitForPaths) == 0)
                        {
                            context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyPathsNotPresent, "paths"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyPathsPresent, "paths"u8, "required"u8);
