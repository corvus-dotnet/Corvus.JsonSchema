...
public readonly partial struct Schema
{
    ...
    public readonly partial struct RequiredPaths
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(RequiredPaths instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="RequiredPaths"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RequiredPaths(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.JsonElement.Mutable Paths
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PathsUtf8, out Corvus.Text.Json.JsonElement.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RequiredPaths(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetPaths(in Corvus.Text.Json.JsonElement.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("paths");
                }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetPaths<TContext>(in Corvus.Text.Json.JsonElement.Source<TContext> value)
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RequiredPaths.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RequiredPaths"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RequiredPaths"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly RequiredPaths Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RequiredPaths>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RequiredPaths"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly RequiredPaths Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<RequiredPaths>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.OpenapiBenchmark.Baseline.Schema.RequiredPaths.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(RequiredPaths instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Baseline.Schema.RequiredPaths.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.Text.Json.JsonElement.Source paths)
            {
            ...
            /// Creates an instance of a <see cref="RequiredPaths"/>.
            /// </summary>
            public void Create(in Corvus.Text.Json.JsonElement.Source paths)
            {
            ...
            internal static void Create<TContext>(
                ...
                in Corvus.Text.Json.JsonElement.Source<TContext> paths)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            /// Creates an instance of a <see cref="RequiredPaths"/>.
            /// </summary>
            public void Create<TContext>(in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> paths)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.JsonElement.Source paths, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> paths, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
        ...
        {
            return workspace.CreateBuilder<RequiredPaths, Mutable>(this);
        }
    }
}
