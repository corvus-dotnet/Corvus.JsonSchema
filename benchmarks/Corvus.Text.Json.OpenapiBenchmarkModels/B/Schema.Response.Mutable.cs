...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Response
    {
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.OpenapiBenchmark.Baseline.Schema.Response.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Baseline.Schema.Response.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.OpenapiBenchmark.Baseline.JsonString.Source description,
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OpenapiBenchmark.Baseline.JsonString.Source description, in Corvus.OpenapiBenchmark.Baseline.Schema.Content.Source content = default, in Corvus.OpenapiBenchmark.Baseline.Schema.Response.HeadersEntity.Source headers = default, in Corvus.OpenapiBenchmark.Baseline.Schema.Response.LinksEntity.Source links = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.OpenapiBenchmark.Baseline.JsonString.Source description, in Corvus.OpenapiBenchmark.Baseline.Schema.Content.Source<TContext> content = default, in Corvus.OpenapiBenchmark.Baseline.Schema.Response.HeadersEntity.Source<TContext> headers = default, in Corvus.OpenapiBenchmark.Baseline.Schema.Response.LinksEntity.Source<TContext> links = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
