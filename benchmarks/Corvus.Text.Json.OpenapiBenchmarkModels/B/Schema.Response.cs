...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        internal Response(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static Response DefaultInstance { get; }
        ...
        /// </summary>
        public Corvus.OpenapiBenchmark.Baseline.Schema.Content ContentValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ContentValueUtf8, out Corvus.OpenapiBenchmark.Baseline.Schema.Content value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.OpenapiBenchmark.Baseline.Schema.Response.HeadersEntity Headers
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HeadersUtf8, out Corvus.OpenapiBenchmark.Baseline.Schema.Response.HeadersEntity value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.OpenapiBenchmark.Baseline.Schema.Response.LinksEntity Links
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LinksUtf8, out Corvus.OpenapiBenchmark.Baseline.Schema.Response.LinksEntity value))
                {
                    return value;
                }
        ...
        public static implicit operator Corvus.OpenapiBenchmark.Baseline.Schema.SpecificationExtensions(Response value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Response(Corvus.OpenapiBenchmark.Baseline.Schema.SpecificationExtensions value)
        {
            return From(value);
        }
        ...
        /// </returns>
        public static bool operator ==(in Response left, in Response right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Response left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(Response instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Response(JsonElement instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Response From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Response ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Response>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Response ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Response>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Response ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Response>(json, options);
        }
        ...
        /// </exception>
        public static Response ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<Response>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Response? result)
        {
            return JsonElementHelpers.TryParseValue<Response>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new Response(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static Response IJsonElement<Response>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Response: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="Response"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="Response"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        {
            CheckValidInstance();
            return _parent.CloneElement<Response>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="Response"/> that lives for the lifetime of its
        ...
        public Response Freeze()
        {
            ...
            {
                return mutable.FreezeElement<Response>(_idx);
            }
