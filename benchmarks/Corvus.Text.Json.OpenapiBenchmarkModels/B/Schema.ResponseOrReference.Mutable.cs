...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ResponseOrReference
    {
...
#endif
        {
            ...
            /// </summary>
            public Corvus.OpenapiBenchmark.Baseline.JsonUriReferenceNotAsserted.Mutable Ref
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RefUtf8, out Corvus.OpenapiBenchmark.Baseline.JsonUriReferenceNotAsserted.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetRef(in Corvus.OpenapiBenchmark.Baseline.JsonUriReferenceNotAsserted.Source value)
            {
                CheckValidInstance();
            ...
            /// <summary>
            /// Gets a <see cref="ResponseOrReference"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ResponseOrReference"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly ResponseOrReference Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ResponseOrReference>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ResponseOrReference"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly ResponseOrReference Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ResponseOrReference>(_idx);
            }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.OpenapiBenchmark.Baseline.JsonUriReferenceNotAsserted.Source refValue = default,
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.OpenapiBenchmark.Baseline.JsonUriReferenceNotAsserted.Source refValue = default, in Corvus.OpenapiBenchmark.Baseline.Schema.Content.Source<TContext> content = default, in Corvus.OpenapiBenchmark.Baseline.JsonString.Source description = default, in Corvus.OpenapiBenchmark.Baseline.Schema.Response.HeadersEntity.Source<TContext> headers = default, in Corvus.OpenapiBenchmark.Baseline.Schema.Response.LinksEntity.Source<TContext> links = default, in Corvus.OpenapiBenchmark.Baseline.JsonString.Source summary = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
