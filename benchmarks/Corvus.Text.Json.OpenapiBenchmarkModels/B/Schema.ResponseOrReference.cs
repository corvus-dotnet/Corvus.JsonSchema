...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ResponseOrReference
        ...
        : IJsonElement<ResponseOrReference>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        internal ResponseOrReference(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public Corvus.OpenapiBenchmark.Baseline.Schema.Content Content
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ContentUtf8, out Corvus.OpenapiBenchmark.Baseline.Schema.Content value))
                {
                    return value;
                }
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ResponseOrReference left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(ResponseOrReference instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ResponseOrReference(JsonElement instance)
        {
            return ResponseOrReference.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ResponseOrReference From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ResponseOrReference ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ResponseOrReference>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ResponseOrReference ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ResponseOrReference>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ResponseOrReference ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ResponseOrReference>(json, options);
        }
        ...
        /// </exception>
        public static ResponseOrReference ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ResponseOrReference>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ResponseOrReference? result)
        {
            return JsonElementHelpers.TryParseValue<ResponseOrReference>(ref reader, out result);
        }
...
#if NET
        static ResponseOrReference IJsonElement<ResponseOrReference>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ResponseOrReference: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public ResponseOrReference Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ResponseOrReference>(_idx);
            }
        ...
        public bool TryGetAsResponse(out Corvus.OpenapiBenchmark.Baseline.Schema.Response result)
        {
            ...
            {
                result = Corvus.OpenapiBenchmark.Baseline.Schema.Response.From(this);
                return true;
            }
        ...
        public bool TryGetAsRequiredRef(out Corvus.OpenapiBenchmark.Baseline.Schema.ResponseOrReference.RequiredRef result)
        {
            ...
            {
                result = Corvus.OpenapiBenchmark.Baseline.Schema.ResponseOrReference.RequiredRef.From(this);
                return true;
            }
