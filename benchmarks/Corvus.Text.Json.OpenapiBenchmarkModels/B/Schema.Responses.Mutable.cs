...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Responses
    {
...
#endif
        {
            ...
            /// </summary>
            public Corvus.OpenapiBenchmark.Baseline.Schema.ResponseOrReference.Mutable Default
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DefaultUtf8, out Corvus.OpenapiBenchmark.Baseline.Schema.ResponseOrReference.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetDefault(in Corvus.OpenapiBenchmark.Baseline.Schema.ResponseOrReference.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetDefault<TContext>(in Corvus.OpenapiBenchmark.Baseline.Schema.ResponseOrReference.Source<TContext> value)
            ...
            public bool TryGetAsIfEntity(out Corvus.OpenapiBenchmark.Baseline.Schema.Responses.IfEntity result)
            {
                if (Corvus.OpenapiBenchmark.Baseline.Schema.Responses.IfEntity.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.OpenapiBenchmark.Baseline.Schema.Responses.IfEntity.Mutable.From(this);
                    return true;
                }
            ...
            public bool TryGetAsRequiredDefault(out Corvus.OpenapiBenchmark.Baseline.Schema.Responses.RequiredDefault result)
            {
                ...
                {
                    result = Corvus.OpenapiBenchmark.Baseline.Schema.Responses.RequiredDefault.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.OpenapiBenchmark.Baseline.Schema.Responses.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Baseline.Schema.Responses.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.OpenapiBenchmark.Baseline.Schema.ResponseOrReference.Source defaultValue = default)
            {
            ...
            /// Creates an instance of a <see cref="Responses"/>.
            /// </summary>
            public void Create(in Corvus.OpenapiBenchmark.Baseline.Schema.ResponseOrReference.Source defaultValue = default)
            {
            ...
            internal static void Create<TContext>(
                ...
                in Corvus.OpenapiBenchmark.Baseline.Schema.ResponseOrReference.Source<TContext> defaultValue = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            /// Creates an instance of a <see cref="Responses"/>.
            /// </summary>
            public void Create<TContext>(in TContext context, in Corvus.OpenapiBenchmark.Baseline.Schema.ResponseOrReference.Source<TContext> defaultValue = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OpenapiBenchmark.Baseline.Schema.ResponseOrReference.Source defaultValue = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.OpenapiBenchmark.Baseline.Schema.ResponseOrReference.Source<TContext> defaultValue = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
