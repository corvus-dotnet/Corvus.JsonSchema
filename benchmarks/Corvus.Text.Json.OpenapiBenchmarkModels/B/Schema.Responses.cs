...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        internal Responses(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public Corvus.OpenapiBenchmark.Baseline.Schema.ResponseOrReference Default
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DefaultUtf8, out Corvus.OpenapiBenchmark.Baseline.Schema.ResponseOrReference value))
                {
                    return value;
                }
        ...
        public static implicit operator Corvus.OpenapiBenchmark.Baseline.Schema.SpecificationExtensions(Responses value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Responses(Corvus.OpenapiBenchmark.Baseline.Schema.SpecificationExtensions value)
        {
            return From(value);
        }
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Responses left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(Responses instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Responses(JsonElement instance)
        {
            return Responses.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Responses From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Responses ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Responses>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Responses ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Responses>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Responses ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Responses>(json, options);
        }
        ...
        /// </exception>
        public static Responses ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<Responses>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Responses? result)
        {
            return JsonElementHelpers.TryParseValue<Responses>(ref reader, out result);
        }
...
#if NET
        static Responses IJsonElement<Responses>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Responses: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Baseline.Schema.Responses.IfEntity" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsIfEntity(out Corvus.OpenapiBenchmark.Baseline.Schema.Responses.IfEntity result)
        {
            if (Corvus.OpenapiBenchmark.Baseline.Schema.Responses.IfEntity.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.OpenapiBenchmark.Baseline.Schema.Responses.IfEntity.From(this);
                return true;
            }
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Baseline.Schema.Responses.RequiredDefault" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsRequiredDefault(out Corvus.OpenapiBenchmark.Baseline.Schema.Responses.RequiredDefault result)
        {
            if (Corvus.OpenapiBenchmark.Baseline.Schema.Responses.RequiredDefault.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.OpenapiBenchmark.Baseline.Schema.Responses.RequiredDefault.From(this);
                return true;
            }
        ...
        /// <param name="matchCorvusOpenapiBenchmarkBaselineSchemaResponsesRequiredDefault">Match a <see cref="Corvus.OpenapiBenchmark.Baseline.Schema.Responses.RequiredDefault"/>.</param>
        ...
        public TResult Match<TContext, TResult>(
            in TContext context,
            Matcher<Corvus.OpenapiBenchmark.Baseline.Schema.Responses.RequiredDefault, TContext, TResult> matchCorvusOpenapiBenchmarkBaselineSchemaResponsesRequiredDefault,
...
#endif
        {
            if (Corvus.OpenapiBenchmark.Baseline.Schema.Responses.IfEntity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchCorvusOpenapiBenchmarkBaselineSchemaResponsesRequiredDefault(Corvus.OpenapiBenchmark.Baseline.Schema.Responses.RequiredDefault.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            Matcher<Corvus.OpenapiBenchmark.Baseline.Schema.Responses.RequiredDefault, TResult> matchCorvusOpenapiBenchmarkBaselineSchemaResponsesRequiredDefault,
            Matcher<Responses, TResult> defaultMatch)
        {
            if (Corvus.OpenapiBenchmark.Baseline.Schema.Responses.IfEntity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchCorvusOpenapiBenchmarkBaselineSchemaResponsesRequiredDefault(Corvus.OpenapiBenchmark.Baseline.Schema.Responses.RequiredDefault.From(this));
            }
