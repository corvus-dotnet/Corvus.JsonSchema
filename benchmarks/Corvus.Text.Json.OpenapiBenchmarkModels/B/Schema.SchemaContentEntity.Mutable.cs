...
public readonly partial struct Schema
{
    ...
    public readonly partial struct SchemaContentEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(SchemaContentEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="SchemaContentEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SchemaContentEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SchemaContentEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly SchemaContentEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly SchemaContentEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<SchemaContentEntity>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.OpenapiBenchmark.Baseline.Schema.SchemaContentEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(SchemaContentEntity instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Baseline.Schema.SchemaContentEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<SchemaContentEntity, Mutable>(this);
        }
    }
}
