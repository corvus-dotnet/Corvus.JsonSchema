...
public readonly partial struct Schema
{
    ...
    public readonly partial struct SchemaHeadersEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(SchemaHeadersEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="SchemaHeadersEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SchemaHeadersEntity(Mutable instance)
            {
            ...
            public Corvus.OpenapiBenchmark.Baseline.Schema.HeaderOrReference.Mutable this[ReadOnlySpan<byte> propertyName]
            {
                get
                {
                    CheckValidInstance();
                    if (!_parent.TryGetNamedPropertyValue(_idx, propertyName, out Corvus.OpenapiBenchmark.Baseline.Schema.HeaderOrReference.Mutable value))
                    {
                        return default;
                    }
            ...
            /// <returns>The value of the property with the given name.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public Corvus.OpenapiBenchmark.Baseline.Schema.HeaderOrReference.Mutable this[ReadOnlySpan<char> propertyName]
            {
                get
                {
                    CheckValidInstance();
            ...
            /// <returns>The value of the property with the given name.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public Corvus.OpenapiBenchmark.Baseline.Schema.HeaderOrReference.Mutable this[string propertyName]
            {
                get
                {
                    CheckValidInstance();
            ...
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public bool TryGetProperty(ReadOnlySpan<byte> propertyName, out Corvus.OpenapiBenchmark.Baseline.Schema.HeaderOrReference.Mutable value)
            {
                CheckValidInstance();
            ...
            /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public bool TryGetProperty(ReadOnlySpan<char> propertyName, out Corvus.OpenapiBenchmark.Baseline.Schema.HeaderOrReference.Mutable value)
            {
                CheckValidInstance();
                return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
            }
            ...
            /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public bool TryGetProperty(string propertyName, out Corvus.OpenapiBenchmark.Baseline.Schema.HeaderOrReference.Mutable value)
            {
                CheckValidInstance();
                return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public ObjectEnumerator<Corvus.OpenapiBenchmark.Baseline.Schema.HeaderOrReference.Mutable> EnumerateObject()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateObjectEnumerator<Corvus.OpenapiBenchmark.Baseline.Schema.HeaderOrReference.Mutable>(_parent, _idx);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new SchemaHeadersEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SchemaHeadersEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetProperty(string propertyName, in Corvus.OpenapiBenchmark.Baseline.Schema.HeaderOrReference.Source value)
            {
            ...
            ///   </para>
            /// </remarks>
            public void SetProperty(ReadOnlySpan<char> propertyName, in Corvus.OpenapiBenchmark.Baseline.Schema.HeaderOrReference.Source value)
            {
                CheckValidInstance();
            ...
            ///   </para>
            /// </remarks>
            public void SetProperty(ReadOnlySpan<byte> propertyName, in Corvus.OpenapiBenchmark.Baseline.Schema.HeaderOrReference.Source value)
            {
                CheckValidInstance();
            ...
            /// <summary>
            /// Gets a <see cref="SchemaHeadersEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="SchemaHeadersEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly SchemaHeadersEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<SchemaHeadersEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="SchemaHeadersEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly SchemaHeadersEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<SchemaHeadersEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.OpenapiBenchmark.Baseline.Schema.SchemaHeadersEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(SchemaHeadersEntity instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Baseline.Schema.SchemaHeadersEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            public void AddProperty(ReadOnlySpan<byte> propertyName, in Corvus.OpenapiBenchmark.Baseline.Schema.HeaderOrReference.Source value)
            {
            ...
            /// <param name="propertyName">The name of the property to add.</param>
            /// <param name="value">The value of the property to add.</param>
            public void AddProperty(ReadOnlySpan<char> propertyName, in Corvus.OpenapiBenchmark.Baseline.Schema.HeaderOrReference.Source value)
            {
                value.AddAsProperty(propertyName, ref _builder);
            }
            ...
            /// <param name="propertyName">The name of the property to add.</param>
            /// <param name="value">The value of the property to add.</param>
            public void AddProperty(string propertyName, in Corvus.OpenapiBenchmark.Baseline.Schema.HeaderOrReference.Source value)
            {
                value.AddAsProperty(propertyName, ref _builder);
            }
        ...
        {
            return workspace.CreateBuilder<SchemaHeadersEntity, Mutable>(this);
        }
    }
}
