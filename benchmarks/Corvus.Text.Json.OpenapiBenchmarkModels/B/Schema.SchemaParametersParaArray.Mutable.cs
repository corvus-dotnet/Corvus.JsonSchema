...
public readonly partial struct Schema
{
    ...
    public readonly partial struct SchemaParametersParaArray
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(SchemaParametersParaArray instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="SchemaParametersParaArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SchemaParametersParaArray(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SchemaParametersParaArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </para>
            /// </remarks>
            public readonly SchemaParametersParaArray Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly SchemaParametersParaArray Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<SchemaParametersParaArray>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.OpenapiBenchmark.Baseline.Schema.SchemaParametersParaArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(SchemaParametersParaArray instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Baseline.Schema.SchemaParametersParaArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<SchemaParametersParaArray, Mutable>(this);
        }
    }
}
