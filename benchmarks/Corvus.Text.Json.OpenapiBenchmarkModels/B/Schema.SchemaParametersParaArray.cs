...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SchemaParametersParaArray"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal SchemaParametersParaArray(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static SchemaParametersParaArray DefaultInstance { get; }
        ...
        /// </returns>
        public static bool operator ==(in SchemaParametersParaArray left, in SchemaParametersParaArray right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in SchemaParametersParaArray left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(SchemaParametersParaArray instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator SchemaParametersParaArray(JsonElement instance)
        {
            return SchemaParametersParaArray.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SchemaParametersParaArray From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SchemaParametersParaArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SchemaParametersParaArray>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SchemaParametersParaArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SchemaParametersParaArray>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SchemaParametersParaArray ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SchemaParametersParaArray>(json, options);
        }
        ...
        /// </exception>
        public static SchemaParametersParaArray ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<SchemaParametersParaArray>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out SchemaParametersParaArray? result)
        {
            return JsonElementHelpers.TryParseValue<SchemaParametersParaArray>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new SchemaParametersParaArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static SchemaParametersParaArray IJsonElement<SchemaParametersParaArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"SchemaParametersParaArray: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="SchemaParametersParaArray"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="SchemaParametersParaArray"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public SchemaParametersParaArray Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<SchemaParametersParaArray>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="SchemaParametersParaArray"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public SchemaParametersParaArray Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<SchemaParametersParaArray>(_idx);
            }
