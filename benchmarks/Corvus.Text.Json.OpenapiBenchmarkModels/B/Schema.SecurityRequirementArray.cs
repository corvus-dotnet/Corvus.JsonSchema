...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        public Corvus.OpenapiBenchmark.Baseline.Schema.SecurityRequirement this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.OpenapiBenchmark.Baseline.Schema.SecurityRequirement>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.OpenapiBenchmark.Baseline.Schema.SecurityRequirement> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.OpenapiBenchmark.Baseline.Schema.SecurityRequirement>(_parent, _idx);
        }
