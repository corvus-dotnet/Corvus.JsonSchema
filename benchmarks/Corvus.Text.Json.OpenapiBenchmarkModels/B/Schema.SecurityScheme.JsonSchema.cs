        ...
        : IJsonElement<SecurityScheme>
    {
        public static partial class JsonSchema
        {
            ...
            private static void MatchDescription(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                ...
                Corvus.OpenapiBenchmark.Baseline.JsonString.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            private static void MatchType(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                ...
                JsonSchemaContext childContext1 =
                    Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeEntity.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/security-scheme"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/security-scheme";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/security-scheme"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                JsonSchemaContext allOfContext1 =
                    Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeApikeyEntity.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: AllOf1SchemaEvaluationPath);
                Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeApikeyEntity.JsonSchema.Evaluate(parentDocument, parentIndex, ref allOfContext1);
                ...
                JsonSchemaContext allOfContext2 =
                    Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpEntity.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: AllOf2SchemaEvaluationPath);
                Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpEntity.JsonSchema.Evaluate(parentDocument, parentIndex, ref allOfContext2);
                ...
                JsonSchemaContext allOfContext3 =
                    Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpBearerEntity.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: AllOf3SchemaEvaluationPath);
                Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpBearerEntity.JsonSchema.Evaluate(parentDocument, parentIndex, ref allOfContext3);
                ...
                JsonSchemaContext allOfContext4 =
                    Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOauth2Entity.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: AllOf4SchemaEvaluationPath);
                Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOauth2Entity.JsonSchema.Evaluate(parentDocument, parentIndex, ref allOfContext4);
                ...
                JsonSchemaContext allOfContext5 =
                    Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOidcEntity.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: AllOf5SchemaEvaluationPath);
                Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOidcEntity.JsonSchema.Evaluate(parentDocument, parentIndex, ref allOfContext5);
