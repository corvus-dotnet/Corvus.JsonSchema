    ...
    public readonly partial struct SecurityScheme
    {
        ...
        public readonly partial struct TypeApikeyEntity
        {
...
#endif
            {
                ...
                /// <param name="matchCorvusOpenapiBenchmarkBaselineSchemaSecuritySchemeTypeApikeyEntityRequiredInAndName">Match a <see cref="Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeApikeyEntity.RequiredInAndName"/>.</param>
                ...
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Matcher<Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeApikeyEntity.RequiredInAndName, TContext, TResult> matchCorvusOpenapiBenchmarkBaselineSchemaSecuritySchemeTypeApikeyEntityRequiredInAndName,
                    Matcher<TypeApikeyEntity, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
                {
                    if (Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeApikeyEntity.RequiredType.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchCorvusOpenapiBenchmarkBaselineSchemaSecuritySchemeTypeApikeyEntityRequiredInAndName(Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeApikeyEntity.RequiredInAndName.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    Matcher<Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeApikeyEntity.RequiredInAndName, TResult> matchCorvusOpenapiBenchmarkBaselineSchemaSecuritySchemeTypeApikeyEntityRequiredInAndName,
                    Matcher<TypeApikeyEntity, TResult> defaultMatch)
                {
                    if (Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeApikeyEntity.RequiredType.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchCorvusOpenapiBenchmarkBaselineSchemaSecuritySchemeTypeApikeyEntityRequiredInAndName(Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeApikeyEntity.RequiredInAndName.From(this));
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeApikeyEntity.RequiredType" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsRequiredType(out Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeApikeyEntity.RequiredType result)
                {
                    if (Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeApikeyEntity.RequiredType.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeApikeyEntity.RequiredType.Mutable.From(this);
                        return true;
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeApikeyEntity.RequiredInAndName" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsRequiredInAndName(out Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeApikeyEntity.RequiredInAndName result)
                {
                    if (Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeApikeyEntity.RequiredInAndName.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeApikeyEntity.RequiredInAndName.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeApikeyEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeApikeyEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// Creates an instance of a <see cref="TypeApikeyEntity"/>.
                /// </summary>
                public void Create(in Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeApikeyEntity.RequiredInAndName.InEntity.Source inValue = default, in Corvus.OpenapiBenchmark.Baseline.JsonString.Source name = default)
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeApikeyEntity.RequiredInAndName.InEntity.Source inValue = default, in Corvus.OpenapiBenchmark.Baseline.JsonString.Source name = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
