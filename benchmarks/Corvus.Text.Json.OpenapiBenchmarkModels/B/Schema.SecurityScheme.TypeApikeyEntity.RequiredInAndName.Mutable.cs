        ...
        public readonly partial struct TypeApikeyEntity
        {
            ...
            public readonly partial struct RequiredInAndName
            {
...
#endif
                {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeApikeyEntity.RequiredInAndName.InEntity.Mutable In
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.InUtf8, out Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeApikeyEntity.RequiredInAndName.InEntity.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.OpenapiBenchmark.Baseline.JsonString.Mutable Name
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out Corvus.OpenapiBenchmark.Baseline.JsonString.Mutable value))
                            {
                                return value;
                            }
                    ...
                    public void SetIn(in Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeApikeyEntity.RequiredInAndName.InEntity.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetName(in Corvus.OpenapiBenchmark.Baseline.JsonString.Source value)
                    {
                        CheckValidInstance();
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeApikeyEntity.RequiredInAndName.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeApikeyEntity.RequiredInAndName.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    internal static void Create(
                        ...
                        in Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeApikeyEntity.RequiredInAndName.InEntity.Source inValue,
                        in Corvus.OpenapiBenchmark.Baseline.JsonString.Source name)
                    {
                    ...
                    /// Creates an instance of a <see cref="RequiredInAndName"/>.
                    /// </summary>
                    public void Create(in Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeApikeyEntity.RequiredInAndName.InEntity.Source inValue, in Corvus.OpenapiBenchmark.Baseline.JsonString.Source name)
                    {
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeApikeyEntity.RequiredInAndName.InEntity.Source inValue, in Corvus.OpenapiBenchmark.Baseline.JsonString.Source name, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
