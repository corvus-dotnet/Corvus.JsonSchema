    ...
    public readonly partial struct SecurityScheme
    {
        ...
        public readonly partial struct TypeApikeyEntity
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeApikeyEntity.RequiredType.TypeEntity Type
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeApikeyEntity.RequiredType.TypeEntity value))
                        {
                            return value;
                        }
