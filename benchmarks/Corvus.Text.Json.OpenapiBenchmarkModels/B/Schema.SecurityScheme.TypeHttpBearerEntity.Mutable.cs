    ...
    public readonly partial struct SecurityScheme
    {
        ...
        public readonly partial struct TypeHttpBearerEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(TypeHttpBearerEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TypeHttpBearerEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TypeHttpBearerEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TypeHttpBearerEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly TypeHttpBearerEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly TypeHttpBearerEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TypeHttpBearerEntity>(_idx);
                }
                ...
                /// <param name="matchCorvusOpenapiBenchmarkBaselineSchemaSecuritySchemeTypeHttpBearerEntityThenEntity">Match a <see cref="Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpBearerEntity.ThenEntity"/>.</param>
                ...
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Matcher<Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpBearerEntity.ThenEntity, TContext, TResult> matchCorvusOpenapiBenchmarkBaselineSchemaSecuritySchemeTypeHttpBearerEntityThenEntity,
                    Matcher<TypeHttpBearerEntity, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
                {
                    if (Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchCorvusOpenapiBenchmarkBaselineSchemaSecuritySchemeTypeHttpBearerEntityThenEntity(Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpBearerEntity.ThenEntity.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    Matcher<Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpBearerEntity.ThenEntity, TResult> matchCorvusOpenapiBenchmarkBaselineSchemaSecuritySchemeTypeHttpBearerEntityThenEntity,
                    Matcher<TypeHttpBearerEntity, TResult> defaultMatch)
                {
                    if (Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchCorvusOpenapiBenchmarkBaselineSchemaSecuritySchemeTypeHttpBearerEntityThenEntity(Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpBearerEntity.ThenEntity.From(this));
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsRequiredSchemeAndType(out Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType result)
                {
                    if (Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.Mutable.From(this);
                        return true;
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpBearerEntity.ThenEntity" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsThenEntity(out Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpBearerEntity.ThenEntity result)
                {
                    if (Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpBearerEntity.ThenEntity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpBearerEntity.ThenEntity.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpBearerEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(TypeHttpBearerEntity instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpBearerEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<TypeHttpBearerEntity, Mutable>(this);
            }
        }
    }
}
