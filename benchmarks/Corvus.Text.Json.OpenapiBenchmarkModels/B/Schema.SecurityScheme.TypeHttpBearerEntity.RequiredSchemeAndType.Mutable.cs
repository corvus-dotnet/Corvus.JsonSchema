        ...
        public readonly partial struct TypeHttpBearerEntity
        {
            ...
            public readonly partial struct RequiredSchemeAndType
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(RequiredSchemeAndType instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="RequiredSchemeAndType"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RequiredSchemeAndType(Mutable instance)
                    {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.SchemeEntity.Mutable Scheme
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SchemeUtf8, out Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.SchemeEntity.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.TypeEntity.Mutable Type
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.TypeEntity.Mutable value))
                            {
                                return value;
                            }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new RequiredSchemeAndType(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    public void SetScheme(in Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.SchemeEntity.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetType(in Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.TypeEntity.Source value)
                    {
                        CheckValidInstance();
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RequiredSchemeAndType.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="RequiredSchemeAndType"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="RequiredSchemeAndType"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RequiredSchemeAndType Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<RequiredSchemeAndType>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="RequiredSchemeAndType"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RequiredSchemeAndType Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<RequiredSchemeAndType>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(RequiredSchemeAndType instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// <summary>
                    /// Creates an instance of a <see cref="RequiredSchemeAndType"/>.
                    /// </summary>
                    internal static void Create(ref ComplexValueBuilder builder, in Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.SchemeEntity.Source scheme)
                    {
                        scheme.AddAsProperty(JsonPropertyNamesEscaped.Scheme, ref builder, escapeName: false);
                        builder.AddProperty(JsonPropertyNamesEscaped.Type, Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.TypeEntity.ConstInstance);
                    }

                    /// <summary>
                    /// Creates an instance of a <see cref="RequiredSchemeAndType"/>.
                    /// </summary>
                    public void Create(in Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.SchemeEntity.Source scheme)
                    {
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.SchemeEntity.Source scheme, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                ...
                {
                    return workspace.CreateBuilder<RequiredSchemeAndType, Mutable>(this);
                }
            }
        }
    }
