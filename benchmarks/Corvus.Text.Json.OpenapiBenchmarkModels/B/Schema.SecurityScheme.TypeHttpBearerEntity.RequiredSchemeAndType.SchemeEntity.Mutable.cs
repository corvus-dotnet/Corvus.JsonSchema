            ...
            public readonly partial struct RequiredSchemeAndType
            {
                ...
                public readonly partial struct SchemeEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(SchemeEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="SchemeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator SchemeEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"SchemeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly SchemeEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly SchemeEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<SchemeEntity>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(SchemeEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<SchemeEntity, Mutable>(this);
                    }
                }
            }
        }
