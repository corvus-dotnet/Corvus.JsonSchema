    ...
    public readonly partial struct SecurityScheme
    {
        ...
        public readonly partial struct TypeHttpBearerEntity
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.SchemeEntity Scheme
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SchemeUtf8, out Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.SchemeEntity value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.TypeEntity Type
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.TypeEntity value))
                        {
                            return value;
                        }
