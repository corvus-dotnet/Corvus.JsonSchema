    ...
    public readonly partial struct SecurityScheme
    {
...
#endif
        {
            ...
            public bool TryGetAsRequiredSchemeAndType(out Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType result)
            {
                ...
                {
                    result = Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.From(this);
                    return true;
                }
            ...
            public bool TryGetAsThenEntity(out Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpBearerEntity.ThenEntity result)
            {
                ...
                {
                    result = Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpBearerEntity.ThenEntity.From(this);
                    return true;
                }
