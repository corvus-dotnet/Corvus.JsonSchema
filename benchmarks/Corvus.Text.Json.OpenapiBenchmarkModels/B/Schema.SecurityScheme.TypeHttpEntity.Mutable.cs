    ...
    public readonly partial struct SecurityScheme
    {
        ...
        public readonly partial struct TypeHttpEntity
        {
...
#endif
            {
                ...
                /// </summary>
                public Corvus.OpenapiBenchmark.Baseline.JsonString.Mutable Scheme
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SchemeUtf8, out Corvus.OpenapiBenchmark.Baseline.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetScheme(in Corvus.OpenapiBenchmark.Baseline.JsonString.Source value)
                {
                    CheckValidInstance();
                ...
                /// <param name="matchCorvusOpenapiBenchmarkBaselineSchemaSecuritySchemeTypeHttpEntityRequiredScheme">Match a <see cref="Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpEntity.RequiredScheme"/>.</param>
                ...
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Matcher<Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpEntity.RequiredScheme, TContext, TResult> matchCorvusOpenapiBenchmarkBaselineSchemaSecuritySchemeTypeHttpEntityRequiredScheme,
                    Matcher<TypeHttpEntity, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
                {
                    if (Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpEntity.RequiredType.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchCorvusOpenapiBenchmarkBaselineSchemaSecuritySchemeTypeHttpEntityRequiredScheme(Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpEntity.RequiredScheme.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    Matcher<Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpEntity.RequiredScheme, TResult> matchCorvusOpenapiBenchmarkBaselineSchemaSecuritySchemeTypeHttpEntityRequiredScheme,
                    Matcher<TypeHttpEntity, TResult> defaultMatch)
                {
                    if (Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpEntity.RequiredType.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchCorvusOpenapiBenchmarkBaselineSchemaSecuritySchemeTypeHttpEntityRequiredScheme(Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpEntity.RequiredScheme.From(this));
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpEntity.RequiredType" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsRequiredType(out Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpEntity.RequiredType result)
                {
                    if (Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpEntity.RequiredType.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpEntity.RequiredType.Mutable.From(this);
                        return true;
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpEntity.RequiredScheme" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsRequiredScheme(out Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpEntity.RequiredScheme result)
                {
                    if (Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpEntity.RequiredScheme.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpEntity.RequiredScheme.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.OpenapiBenchmark.Baseline.JsonString.Source scheme = default)
                {
                ...
                /// Creates an instance of a <see cref="TypeHttpEntity"/>.
                /// </summary>
                public void Create(in Corvus.OpenapiBenchmark.Baseline.JsonString.Source scheme = default)
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OpenapiBenchmark.Baseline.JsonString.Source scheme = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
