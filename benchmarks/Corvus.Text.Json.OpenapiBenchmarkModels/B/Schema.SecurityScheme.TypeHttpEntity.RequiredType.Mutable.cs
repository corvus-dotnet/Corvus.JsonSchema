        ...
        public readonly partial struct TypeHttpEntity
        {
            ...
            public readonly partial struct RequiredType
            {
...
#endif
                {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpEntity.RequiredType.TypeEntity.Mutable Type
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpEntity.RequiredType.TypeEntity.Mutable value))
                            {
                                return value;
                            }
                    ...
                    public void SetType(in Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpEntity.RequiredType.TypeEntity.Source value)
                    {
                        CheckValidInstance();
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpEntity.RequiredType.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpEntity.RequiredType.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    {
                        builder.AddProperty(JsonPropertyNamesEscaped.Type, Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpEntity.RequiredType.TypeEntity.ConstInstance);
                    }
