...
public readonly partial struct Schema
{
    ...
    public readonly partial struct SecurityScheme
    {
...
#endif
        {
            ...
            internal TypeHttpEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static TypeHttpEntity DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in TypeHttpEntity left, in TypeHttpEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in TypeHttpEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(TypeHttpEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TypeHttpEntity(JsonElement instance)
            {
                return TypeHttpEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TypeHttpEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TypeHttpEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TypeHttpEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TypeHttpEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TypeHttpEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TypeHttpEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TypeHttpEntity>(json, options);
            }
            ...
            /// </exception>
            public static TypeHttpEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<TypeHttpEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out TypeHttpEntity? result)
            {
                return JsonElementHelpers.TryParseValue<TypeHttpEntity>(ref reader, out result);
            }
...
#if NET
            static TypeHttpEntity IJsonElement<TypeHttpEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TypeHttpEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public TypeHttpEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<TypeHttpEntity>(_idx);
                }
            ...
            public bool TryGetAsRequiredType(out Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpEntity.RequiredType result)
            {
                ...
                {
                    result = Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpEntity.RequiredType.From(this);
                    return true;
                }
            ...
            public bool TryGetAsRequiredScheme(out Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpEntity.RequiredScheme result)
            {
                ...
                {
                    result = Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeHttpEntity.RequiredScheme.From(this);
                    return true;
                }
