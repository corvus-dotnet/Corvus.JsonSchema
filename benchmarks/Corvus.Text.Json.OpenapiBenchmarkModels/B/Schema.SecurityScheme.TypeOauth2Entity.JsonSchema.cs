            ...
            public static partial class JsonSchema
            {
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    JsonSchemaContext ifContext =
                        Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOauth2Entity.RequiredType.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: IfSchemaEvaluationPath);
                    Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOauth2Entity.RequiredType.JsonSchema.Evaluate(parentDocument, parentIndex, ref ifContext);
                    ...
                    if (ifContext.IsMatch)
                    {
                        ...
                        JsonSchemaContext thenContext =
                            Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOauth2Entity.RequiredFlows.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: ThenSchemaEvaluationPath);
                        Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOauth2Entity.RequiredFlows.JsonSchema.Evaluate(parentDocument, parentIndex, ref thenContext);
