    ...
    public readonly partial struct SecurityScheme
    {
        ...
        public readonly partial struct TypeOauth2Entity
        {
...
#endif
            {
                ...
                /// <param name="matchCorvusOpenapiBenchmarkBaselineSchemaSecuritySchemeTypeOauth2EntityRequiredFlows">Match a <see cref="Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOauth2Entity.RequiredFlows"/>.</param>
                ...
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Matcher<Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOauth2Entity.RequiredFlows, TContext, TResult> matchCorvusOpenapiBenchmarkBaselineSchemaSecuritySchemeTypeOauth2EntityRequiredFlows,
                    Matcher<TypeOauth2Entity, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
                {
                    if (Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOauth2Entity.RequiredType.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchCorvusOpenapiBenchmarkBaselineSchemaSecuritySchemeTypeOauth2EntityRequiredFlows(Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOauth2Entity.RequiredFlows.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    Matcher<Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOauth2Entity.RequiredFlows, TResult> matchCorvusOpenapiBenchmarkBaselineSchemaSecuritySchemeTypeOauth2EntityRequiredFlows,
                    Matcher<TypeOauth2Entity, TResult> defaultMatch)
                {
                    if (Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOauth2Entity.RequiredType.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchCorvusOpenapiBenchmarkBaselineSchemaSecuritySchemeTypeOauth2EntityRequiredFlows(Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOauth2Entity.RequiredFlows.From(this));
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOauth2Entity.RequiredType" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsRequiredType(out Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOauth2Entity.RequiredType result)
                {
                    if (Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOauth2Entity.RequiredType.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOauth2Entity.RequiredType.Mutable.From(this);
                        return true;
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOauth2Entity.RequiredFlows" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsRequiredFlows(out Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOauth2Entity.RequiredFlows result)
                {
                    if (Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOauth2Entity.RequiredFlows.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOauth2Entity.RequiredFlows.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOauth2Entity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOauth2Entity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.OpenapiBenchmark.Baseline.Schema.OauthFlows.Source flows = default)
                {
                ...
                /// Creates an instance of a <see cref="TypeOauth2Entity"/>.
                /// </summary>
                public void Create(in Corvus.OpenapiBenchmark.Baseline.Schema.OauthFlows.Source flows = default)
                {
                ...
                /// Creates an instance of a <see cref="TypeOauth2Entity"/>.
                /// </summary>
                public void Create<TContext>(in TContext context, in Corvus.OpenapiBenchmark.Baseline.Schema.OauthFlows.Source<TContext> flows = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OpenapiBenchmark.Baseline.Schema.OauthFlows.Source flows = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.OpenapiBenchmark.Baseline.Schema.OauthFlows.Source<TContext> flows = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
