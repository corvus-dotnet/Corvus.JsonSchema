    ...
    public readonly partial struct SecurityScheme
    {
        ...
        public readonly partial struct TypeOauth2Entity
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOauth2Entity.RequiredType.TypeEntity Type
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOauth2Entity.RequiredType.TypeEntity value))
                        {
                            return value;
                        }
