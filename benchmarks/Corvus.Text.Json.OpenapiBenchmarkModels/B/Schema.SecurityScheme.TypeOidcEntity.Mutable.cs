    ...
    public readonly partial struct SecurityScheme
    {
        ...
        public readonly partial struct TypeOidcEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(TypeOidcEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TypeOidcEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TypeOidcEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new TypeOidcEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TypeOidcEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <param name="matchCorvusOpenapiBenchmarkBaselineSchemaSecuritySchemeTypeOidcEntityRequiredOpenIdConnectUrl">Match a <see cref="Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOidcEntity.RequiredOpenIdConnectUrl"/>.</param>
                ...
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Matcher<Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOidcEntity.RequiredOpenIdConnectUrl, TContext, TResult> matchCorvusOpenapiBenchmarkBaselineSchemaSecuritySchemeTypeOidcEntityRequiredOpenIdConnectUrl,
                    Matcher<TypeOidcEntity, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
                {
                    if (Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOidcEntity.RequiredType.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchCorvusOpenapiBenchmarkBaselineSchemaSecuritySchemeTypeOidcEntityRequiredOpenIdConnectUrl(Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOidcEntity.RequiredOpenIdConnectUrl.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    Matcher<Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOidcEntity.RequiredOpenIdConnectUrl, TResult> matchCorvusOpenapiBenchmarkBaselineSchemaSecuritySchemeTypeOidcEntityRequiredOpenIdConnectUrl,
                    Matcher<TypeOidcEntity, TResult> defaultMatch)
                {
                    if (Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOidcEntity.RequiredType.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchCorvusOpenapiBenchmarkBaselineSchemaSecuritySchemeTypeOidcEntityRequiredOpenIdConnectUrl(Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOidcEntity.RequiredOpenIdConnectUrl.From(this));
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOidcEntity.RequiredType" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsRequiredType(out Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOidcEntity.RequiredType result)
                {
                    if (Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOidcEntity.RequiredType.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOidcEntity.RequiredType.Mutable.From(this);
                        return true;
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOidcEntity.RequiredOpenIdConnectUrl" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsRequiredOpenIdConnectUrl(out Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOidcEntity.RequiredOpenIdConnectUrl result)
                {
                    if (Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOidcEntity.RequiredOpenIdConnectUrl.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOidcEntity.RequiredOpenIdConnectUrl.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOidcEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(TypeOidcEntity instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOidcEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<TypeOidcEntity, Mutable>(this);
            }
        }
    }
}
