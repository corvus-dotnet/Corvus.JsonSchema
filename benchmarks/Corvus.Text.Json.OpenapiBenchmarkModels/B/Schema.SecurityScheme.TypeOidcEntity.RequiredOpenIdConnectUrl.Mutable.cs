        ...
        public readonly partial struct TypeOidcEntity
        {
            ...
            public readonly partial struct RequiredOpenIdConnectUrl
            {
                ...
                public ref struct Builder
                {
                    ...
                    /// </summary>
                    internal static void Create(ref ComplexValueBuilder builder, in Corvus.OpenapiBenchmark.Baseline.JsonUri.Source openIdConnectUrl)
                    {
                    ...
                    /// Creates an instance of a <see cref="RequiredOpenIdConnectUrl"/>.
                    /// </summary>
                    public void Create(in Corvus.OpenapiBenchmark.Baseline.JsonUri.Source openIdConnectUrl)
                    {
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OpenapiBenchmark.Baseline.JsonUri.Source openIdConnectUrl, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
