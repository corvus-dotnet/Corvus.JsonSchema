        ...
        public readonly partial struct TypeOidcEntity
        {
            ...
            public readonly partial struct RequiredOpenIdConnectUrl
            {
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOidcEntity.RequiredOpenIdConnectUrl.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOidcEntity.RequiredOpenIdConnectUrl.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// </summary>
                    internal static void Create(ref ComplexValueBuilder builder, in Corvus.OpenapiBenchmark.Baseline.JsonUriNotAsserted.Source openIdConnectUrl)
                    {
                    ...
                    /// Creates an instance of a <see cref="RequiredOpenIdConnectUrl"/>.
                    /// </summary>
                    public void Create(in Corvus.OpenapiBenchmark.Baseline.JsonUriNotAsserted.Source openIdConnectUrl)
                    {
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OpenapiBenchmark.Baseline.JsonUriNotAsserted.Source openIdConnectUrl, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
