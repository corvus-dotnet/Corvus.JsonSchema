    ...
    public readonly partial struct SecurityScheme
    {
        ...
        public readonly partial struct TypeOidcEntity
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOidcEntity.RequiredType.TypeEntity Type
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.OpenapiBenchmark.Baseline.Schema.SecurityScheme.TypeOidcEntity.RequiredType.TypeEntity value))
                        {
                            return value;
                        }
