...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Server
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.OpenapiBenchmark.Baseline.JsonUriReferenceNotAsserted.Mutable Url
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UrlUtf8, out Corvus.OpenapiBenchmark.Baseline.JsonUriReferenceNotAsserted.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public Corvus.OpenapiBenchmark.Baseline.Schema.Server.VariablesEntity.Mutable Variables
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VariablesUtf8, out Corvus.OpenapiBenchmark.Baseline.Schema.Server.VariablesEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetUrl(in Corvus.OpenapiBenchmark.Baseline.JsonUriReferenceNotAsserted.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetVariables(in Corvus.OpenapiBenchmark.Baseline.Schema.Server.VariablesEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetVariables<TContext>(in Corvus.OpenapiBenchmark.Baseline.Schema.Server.VariablesEntity.Source<TContext> value)
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.OpenapiBenchmark.Baseline.Schema.Server.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Baseline.Schema.Server.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.OpenapiBenchmark.Baseline.JsonUriReferenceNotAsserted.Source url,
                in Corvus.OpenapiBenchmark.Baseline.JsonString.Source description = default,
                in Corvus.OpenapiBenchmark.Baseline.Schema.Server.VariablesEntity.Source variables = default)
            {
            ...
            public void Create(
                ...
                in Corvus.OpenapiBenchmark.Baseline.Schema.Server.VariablesEntity.Source variables = default)
            {
                Create(ref _builder, url, description, variables);
            }
            ...
            internal static void Create<TContext>(
                ...
                in Corvus.OpenapiBenchmark.Baseline.JsonUriReferenceNotAsserted.Source url,
                in Corvus.OpenapiBenchmark.Baseline.JsonString.Source description = default,
                in Corvus.OpenapiBenchmark.Baseline.Schema.Server.VariablesEntity.Source<TContext> variables = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            #endif
            {
                Create(context, ref _builder, url, description, variables);
            }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OpenapiBenchmark.Baseline.JsonUriReferenceNotAsserted.Source url, in Corvus.OpenapiBenchmark.Baseline.JsonString.Source description = default, in Corvus.OpenapiBenchmark.Baseline.Schema.Server.VariablesEntity.Source variables = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(url, description, variables);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.OpenapiBenchmark.Baseline.JsonUriReferenceNotAsserted.Source url, in Corvus.OpenapiBenchmark.Baseline.JsonString.Source description = default, in Corvus.OpenapiBenchmark.Baseline.Schema.Server.VariablesEntity.Source<TContext> variables = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            ...
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(context, url, description, variables);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
