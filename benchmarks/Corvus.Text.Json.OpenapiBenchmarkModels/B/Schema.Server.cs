...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.OpenapiBenchmark.Baseline.JsonUriReferenceNotAsserted Url
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UrlUtf8, out Corvus.OpenapiBenchmark.Baseline.JsonUriReferenceNotAsserted value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.OpenapiBenchmark.Baseline.Schema.Server.VariablesEntity Variables
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VariablesUtf8, out Corvus.OpenapiBenchmark.Baseline.Schema.Server.VariablesEntity value))
                {
                    return value;
                }
        ...
        public static implicit operator Corvus.OpenapiBenchmark.Baseline.Schema.SpecificationExtensions(Server value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Server(Corvus.OpenapiBenchmark.Baseline.Schema.SpecificationExtensions value)
        {
            return From(value);
        }
        ...
        /// <summary>
        /// Gets a <see cref="Server"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="Server"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="Server"/> that lives for the lifetime of its
