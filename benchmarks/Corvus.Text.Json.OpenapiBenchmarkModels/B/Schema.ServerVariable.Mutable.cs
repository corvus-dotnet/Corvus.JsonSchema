...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ServerVariable
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.OpenapiBenchmark.Baseline.JsonString.Mutable Default
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DefaultUtf8, out Corvus.OpenapiBenchmark.Baseline.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public Corvus.OpenapiBenchmark.Baseline.Schema.ServerVariable.JsonStringArray.Mutable Enum
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EnumUtf8, out Corvus.OpenapiBenchmark.Baseline.Schema.ServerVariable.JsonStringArray.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetDefault(in Corvus.OpenapiBenchmark.Baseline.JsonString.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetEnum(in Corvus.OpenapiBenchmark.Baseline.Schema.ServerVariable.JsonStringArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetEnum<TContext>(in Corvus.OpenapiBenchmark.Baseline.Schema.ServerVariable.JsonStringArray.Source<TContext> value)
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.OpenapiBenchmark.Baseline.Schema.ServerVariable.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Baseline.Schema.ServerVariable.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.OpenapiBenchmark.Baseline.JsonString.Source defaultValue,
                in Corvus.OpenapiBenchmark.Baseline.JsonString.Source description = default,
                in Corvus.OpenapiBenchmark.Baseline.Schema.ServerVariable.JsonStringArray.Source enumValue = default)
            {
            ...
            internal static void Create<TContext>(
                ...
                in Corvus.OpenapiBenchmark.Baseline.JsonString.Source defaultValue,
                in Corvus.OpenapiBenchmark.Baseline.JsonString.Source description = default,
                in Corvus.OpenapiBenchmark.Baseline.Schema.ServerVariable.JsonStringArray.Source<TContext> enumValue = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OpenapiBenchmark.Baseline.JsonString.Source defaultValue, in Corvus.OpenapiBenchmark.Baseline.JsonString.Source description = default, in Corvus.OpenapiBenchmark.Baseline.Schema.ServerVariable.JsonStringArray.Source enumValue = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
