...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.OpenapiBenchmark.Baseline.JsonString Default
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DefaultUtf8, out Corvus.OpenapiBenchmark.Baseline.JsonString value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.OpenapiBenchmark.Baseline.Schema.ServerVariable.JsonStringArray Enum
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EnumUtf8, out Corvus.OpenapiBenchmark.Baseline.Schema.ServerVariable.JsonStringArray value))
                {
                    return value;
                }
        ...
        public static implicit operator Corvus.OpenapiBenchmark.Baseline.Schema.SpecificationExtensions(ServerVariable value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator ServerVariable(Corvus.OpenapiBenchmark.Baseline.Schema.SpecificationExtensions value)
        {
            return From(value);
        }
