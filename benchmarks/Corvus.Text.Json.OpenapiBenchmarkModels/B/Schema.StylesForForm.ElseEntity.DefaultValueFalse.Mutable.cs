        ...
        public readonly partial struct ElseEntity
        {
            ...
            public readonly partial struct DefaultValueFalse
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(DefaultValueFalse instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="DefaultValueFalse"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator DefaultValueFalse(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new DefaultValueFalse(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"DefaultValueFalse.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="DefaultValueFalse"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="DefaultValueFalse"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DefaultValueFalse Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<DefaultValueFalse>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="DefaultValueFalse"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DefaultValueFalse Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<DefaultValueFalse>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(DefaultValueFalse instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<DefaultValueFalse, Mutable>(this);
                }
            }
        }
    }
