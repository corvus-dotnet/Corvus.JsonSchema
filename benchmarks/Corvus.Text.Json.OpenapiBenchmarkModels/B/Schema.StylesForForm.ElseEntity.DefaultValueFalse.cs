    ...
    public readonly partial struct StylesForForm
    {
        ...
        public readonly partial struct ElseEntity
        {
...
#endif
            {
                ...
                internal DefaultValueFalse(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static DefaultValueFalse DefaultInstance { get; } = ParsedJsonDocument<DefaultValueFalse>.False;
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in DefaultValueFalse left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(DefaultValueFalse instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DefaultValueFalse(JsonElement instance)
                {
                    return DefaultValueFalse.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DefaultValueFalse From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DefaultValueFalse ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<DefaultValueFalse>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DefaultValueFalse ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<DefaultValueFalse>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DefaultValueFalse ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<DefaultValueFalse>(json, options);
                }
                ...
                /// </exception>
                public static DefaultValueFalse ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<DefaultValueFalse>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out DefaultValueFalse? result)
                {
                    return JsonElementHelpers.TryParseValue<DefaultValueFalse>(ref reader, out result);
                }
...
#if NET
                static DefaultValueFalse IJsonElement<DefaultValueFalse>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DefaultValueFalse: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public DefaultValueFalse Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public DefaultValueFalse Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<DefaultValueFalse>(_idx);
                    }
