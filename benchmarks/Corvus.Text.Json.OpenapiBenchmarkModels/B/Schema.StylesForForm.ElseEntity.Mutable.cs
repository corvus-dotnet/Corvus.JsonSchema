    ...
    public readonly partial struct StylesForForm
    {
        ...
        public readonly partial struct ElseEntity
        {
...
#endif
            {
                ...
                /// </summary>
                public Corvus.OpenapiBenchmark.Baseline.Schema.StylesForForm.ElseEntity.DefaultValueFalse.Mutable Explode
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExplodeUtf8, out Corvus.OpenapiBenchmark.Baseline.Schema.StylesForForm.ElseEntity.DefaultValueFalse.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetExplode(in Corvus.OpenapiBenchmark.Baseline.Schema.StylesForForm.ElseEntity.DefaultValueFalse.Source value)
                {
                    CheckValidInstance();
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.OpenapiBenchmark.Baseline.Schema.StylesForForm.ElseEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Baseline.Schema.StylesForForm.ElseEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.OpenapiBenchmark.Baseline.Schema.StylesForForm.ElseEntity.DefaultValueFalse.Source explode = default)
                {
                ...
                /// Creates an instance of a <see cref="ElseEntity"/>.
                /// </summary>
                public void Create(in Corvus.OpenapiBenchmark.Baseline.Schema.StylesForForm.ElseEntity.DefaultValueFalse.Source explode = default)
                {
                    Create(ref _builder, explode);
                }
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OpenapiBenchmark.Baseline.Schema.StylesForForm.ElseEntity.DefaultValueFalse.Source explode = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
