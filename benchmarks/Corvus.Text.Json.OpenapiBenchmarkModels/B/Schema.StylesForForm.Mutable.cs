...
public readonly partial struct Schema
{
    ...
    public readonly partial struct StylesForForm
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(StylesForForm instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="StylesForForm"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator StylesForForm(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"StylesForForm.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly StylesForForm Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly StylesForForm Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<StylesForForm>(_idx);
            }
            ...
            public bool TryGetAsElseEntity(out Corvus.OpenapiBenchmark.Baseline.Schema.StylesForForm.ElseEntity result)
            {
                ...
                {
                    result = Corvus.OpenapiBenchmark.Baseline.Schema.StylesForForm.ElseEntity.Mutable.From(this);
                    return true;
                }
            ...
            public bool TryGetAsRequiredStyle(out Corvus.OpenapiBenchmark.Baseline.Schema.StylesForForm.RequiredStyle result)
            {
                if (Corvus.OpenapiBenchmark.Baseline.Schema.StylesForForm.RequiredStyle.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.OpenapiBenchmark.Baseline.Schema.StylesForForm.RequiredStyle.Mutable.From(this);
                    return true;
                }
            ...
            public bool TryGetAsThenEntity(out Corvus.OpenapiBenchmark.Baseline.Schema.StylesForForm.ThenEntity result)
            {
                ...
                {
                    result = Corvus.OpenapiBenchmark.Baseline.Schema.StylesForForm.ThenEntity.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.OpenapiBenchmark.Baseline.Schema.StylesForForm.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(StylesForForm instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Baseline.Schema.StylesForForm.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<StylesForForm, Mutable>(this);
        }
    }
}
