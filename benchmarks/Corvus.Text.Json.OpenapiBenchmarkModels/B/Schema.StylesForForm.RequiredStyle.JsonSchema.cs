...
public readonly partial struct Schema
{
    ...
    public readonly partial struct StylesForForm
    {
        ...
        public readonly partial struct RequiredStyle
            : IJsonElement<RequiredStyle>
        {
            public static partial class JsonSchema
            {
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyStylePresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("style"u8, buffer, out written);
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyStyleNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("style"u8, buffer, out written);

                private const int RequiredOffsetForStyle = 0;
                private const uint RequiredBitForStyle = 0b00000000000000000000000000000001;
                ...
                private static void MatchStyle(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    ...
                    JsonSchemaContext childContext =
                        Corvus.OpenapiBenchmark.Baseline.Schema.StylesForForm.RequiredStyle.StyleEntity.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Corvus.OpenapiBenchmark.Baseline.Schema.StylesForForm.RequiredStyle.StyleEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                    ...
                    requiredBitBuffer[RequiredOffsetForStyle] |= RequiredBitForStyle;
                }
                ...
                {
                    if (span.SequenceEqual(JsonPropertyNames.StyleUtf8))
                    {
                        matcher = MatchStyle;
                        return true;
                    }
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/styles-for-form/if"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/styles-for-form/if";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/styles-for-form/if"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.StartObject)
                    {
                        ...
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyStylePresent, "style"u8, "required"u8);
                        }
                        ...
                        {
                            if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForStyle] & RequiredBitForStyle) == 0)
                            {
                                context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyStyleNotPresent, "style"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyStylePresent, "style"u8, "required"u8);
