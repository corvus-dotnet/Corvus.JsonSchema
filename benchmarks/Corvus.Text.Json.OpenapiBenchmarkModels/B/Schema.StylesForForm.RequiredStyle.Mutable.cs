    ...
    public readonly partial struct StylesForForm
    {
        ...
        public readonly partial struct RequiredStyle
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.OpenapiBenchmark.Baseline.Schema.StylesForForm.RequiredStyle.StyleEntity.Mutable Style
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StyleUtf8, out Corvus.OpenapiBenchmark.Baseline.Schema.StylesForForm.RequiredStyle.StyleEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetStyle(in Corvus.OpenapiBenchmark.Baseline.Schema.StylesForForm.RequiredStyle.StyleEntity.Source value)
                {
                    CheckValidInstance();
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.OpenapiBenchmark.Baseline.Schema.StylesForForm.RequiredStyle.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Baseline.Schema.StylesForForm.RequiredStyle.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                {
                    builder.AddProperty(JsonPropertyNamesEscaped.Style, Corvus.OpenapiBenchmark.Baseline.Schema.StylesForForm.RequiredStyle.StyleEntity.ConstInstance);
                }
