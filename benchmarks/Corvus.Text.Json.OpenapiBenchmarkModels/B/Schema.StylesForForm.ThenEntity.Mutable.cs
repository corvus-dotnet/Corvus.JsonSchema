    ...
    public readonly partial struct StylesForForm
    {
        ...
        public readonly partial struct ThenEntity
        {
...
#endif
            {
                ...
                /// </summary>
                public Corvus.OpenapiBenchmark.Baseline.Schema.StylesForForm.ThenEntity.DefaultValueTrue.Mutable Explode
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExplodeUtf8, out Corvus.OpenapiBenchmark.Baseline.Schema.StylesForForm.ThenEntity.DefaultValueTrue.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetExplode(in Corvus.OpenapiBenchmark.Baseline.Schema.StylesForForm.ThenEntity.DefaultValueTrue.Source value)
                {
                    CheckValidInstance();
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.OpenapiBenchmark.Baseline.Schema.StylesForForm.ThenEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Baseline.Schema.StylesForForm.ThenEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.OpenapiBenchmark.Baseline.Schema.StylesForForm.ThenEntity.DefaultValueTrue.Source explode = default)
                {
                ...
                /// Creates an instance of a <see cref="ThenEntity"/>.
                /// </summary>
                public void Create(in Corvus.OpenapiBenchmark.Baseline.Schema.StylesForForm.ThenEntity.DefaultValueTrue.Source explode = default)
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OpenapiBenchmark.Baseline.Schema.StylesForForm.ThenEntity.DefaultValueTrue.Source explode = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
