...
public readonly partial struct Schema
{
    ...
    public readonly partial struct StylesForForm
    {
...
#endif
        {
            ...
            /// </summary>
            public Corvus.OpenapiBenchmark.Baseline.Schema.StylesForForm.ThenEntity.DefaultValueTrue Explode
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExplodeUtf8, out Corvus.OpenapiBenchmark.Baseline.Schema.StylesForForm.ThenEntity.DefaultValueTrue value))
                    {
                        return value;
                    }

                    return Corvus.OpenapiBenchmark.Baseline.Schema.StylesForForm.ThenEntity.DefaultValueTrue.DefaultInstance;
                }
            }
