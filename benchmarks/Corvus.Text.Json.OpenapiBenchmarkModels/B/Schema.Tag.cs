...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// </summary>
        public Corvus.OpenapiBenchmark.Baseline.Schema.ExternalDocumentation ExternalDocs
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExternalDocsUtf8, out Corvus.OpenapiBenchmark.Baseline.Schema.ExternalDocumentation value))
                {
                    return value;
                }
        ...
        public static implicit operator Corvus.OpenapiBenchmark.Baseline.Schema.SpecificationExtensions(Tag value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Tag(Corvus.OpenapiBenchmark.Baseline.Schema.SpecificationExtensions value)
        {
            return From(value);
        }
