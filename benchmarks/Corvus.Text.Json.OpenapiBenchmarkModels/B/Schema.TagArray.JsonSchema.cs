                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    while (arrayValidation_enumerator.MoveNext())
                    {
                        ...
                        JsonSchemaContext childContext = Corvus.OpenapiBenchmark.Baseline.Schema.Tag.JsonSchema.PushChildContext(
                            parentDocument,
                        ...
                        Corvus.OpenapiBenchmark.Baseline.Schema.Tag.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
