...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        public Corvus.OpenapiBenchmark.Baseline.Schema.Tag this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.OpenapiBenchmark.Baseline.Schema.Tag>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.OpenapiBenchmark.Baseline.Schema.Tag> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.OpenapiBenchmark.Baseline.Schema.Tag>(_parent, _idx);
        }
