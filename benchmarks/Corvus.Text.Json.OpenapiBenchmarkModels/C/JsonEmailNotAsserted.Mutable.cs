...
public readonly partial struct JsonEmailNotAsserted
{
...
#endif
    {
        ...
        public static explicit operator Mutable(JsonEmailNotAsserted instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="JsonEmailNotAsserted"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonEmailNotAsserted(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new JsonEmailNotAsserted(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"JsonEmailNotAsserted.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="JsonEmailNotAsserted"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="JsonEmailNotAsserted"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly JsonEmailNotAsserted Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<JsonEmailNotAsserted>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="JsonEmailNotAsserted"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly JsonEmailNotAsserted Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<JsonEmailNotAsserted>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(JsonEmailNotAsserted instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<JsonEmailNotAsserted, Mutable>(this);
    }
}
