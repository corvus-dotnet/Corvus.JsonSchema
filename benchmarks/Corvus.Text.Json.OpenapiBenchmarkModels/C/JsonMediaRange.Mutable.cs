...
public readonly partial struct JsonMediaRange
{
...
#endif
    {
        ...
        public static explicit operator Mutable(JsonMediaRange instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="JsonMediaRange"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonMediaRange(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"JsonMediaRange.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly JsonMediaRange Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly JsonMediaRange Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<JsonMediaRange>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(JsonMediaRange instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<JsonMediaRange, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<JsonMediaRange> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<JsonMediaRange>();
        }
        finally
        {
