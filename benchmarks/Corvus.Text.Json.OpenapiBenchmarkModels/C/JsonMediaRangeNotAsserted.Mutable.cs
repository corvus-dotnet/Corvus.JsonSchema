...
public readonly partial struct JsonMediaRangeNotAsserted
{
...
#endif
    {
        ...
        public static explicit operator Mutable(JsonMediaRangeNotAsserted instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="JsonMediaRangeNotAsserted"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonMediaRangeNotAsserted(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"JsonMediaRangeNotAsserted.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly JsonMediaRangeNotAsserted Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly JsonMediaRangeNotAsserted Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<JsonMediaRangeNotAsserted>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(JsonMediaRangeNotAsserted instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<JsonMediaRangeNotAsserted, Mutable>(this);
    }
}
