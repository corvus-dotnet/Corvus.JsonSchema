...
public readonly partial struct JsonUri
{
...
#endif
    {
        ...
        public static explicit operator Utf8UriValue(Mutable value) => Utf8UriValue.TryGetValue(value._parent, value._idx, out Utf8UriValue result) ? result : throw new FormatException();
        ...
        public static explicit operator Mutable(JsonUri instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="JsonUri"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonUri(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"JsonUri.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="JsonUri"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="JsonUri"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly JsonUri Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<JsonUri>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="JsonUri"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly JsonUri Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<JsonUri>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(JsonUri instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<JsonUri, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<JsonUri> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<JsonUri>();
        }
        finally
        {
