    ...
    public readonly partial struct CallbacksOrReference
    {
        ...
        public readonly partial struct RequiredRef
        {
...
#endif
            {
                ...
                public void SetRef(in Corvus.Text.Json.JsonElement.Source value)
                {
                    CheckValidInstance();
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(in Corvus.Text.Json.JsonElement.Source refValue)
            {
            ...
            /// <param name="refValue">The value of the <c>"$ref"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> refValue)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
