...
public readonly partial struct OpenapiSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Gets a <see cref="CallbacksOrReference"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="CallbacksOrReference"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public CallbacksOrReference Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<CallbacksOrReference>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="CallbacksOrReference"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public CallbacksOrReference Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<CallbacksOrReference>(_idx);
            }
