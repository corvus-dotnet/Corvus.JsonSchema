...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct Contact
    {
...
#endif
        {
            ...
            public void SetEmail(scoped in Corvus.OpenapiBenchmark.Current.JsonEmail.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.OpenapiBenchmark.Current.JsonEmail.Source _createArg1;
            ...
            internal Source(Corvus.OpenapiBenchmark.Current.OpenapiSchema.Contact.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.OpenapiBenchmark.Current.JsonEmail.Source arg1, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source arg2, scoped in Corvus.OpenapiBenchmark.Current.JsonUri.Source arg3)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _createArg3 = arg3;
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Current.OpenapiSchema.Contact.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void BuildCreateValue(scoped in Corvus.OpenapiBenchmark.Current.JsonEmail.Source arg1, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source arg2, scoped in Corvus.OpenapiBenchmark.Current.JsonUri.Source arg3, ref ComplexValueBuilder o)
            {
                o.StartObject();
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.OpenapiBenchmark.Current.JsonEmail.Source email = default, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source name = default, scoped in Corvus.OpenapiBenchmark.Current.JsonUri.Source url = default)
        {
        ...
        public static ParsedJsonDocument<Contact> Create(in Corvus.OpenapiBenchmark.Current.JsonEmail.Source email = default, in Corvus.OpenapiBenchmark.Current.JsonString.Source name = default, in Corvus.OpenapiBenchmark.Current.JsonUri.Source url = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
