...
public readonly partial struct OpenapiSchema
{
...
#endif
    {
        ...
        /// </summary>
        public Corvus.OpenapiBenchmark.Current.JsonEmail Email
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EmailUtf8, out Corvus.OpenapiBenchmark.Current.JsonEmail value))
                {
                    return value;
                }
