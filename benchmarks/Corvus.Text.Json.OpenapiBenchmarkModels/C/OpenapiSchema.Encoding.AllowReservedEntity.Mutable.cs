    ...
    public readonly partial struct Encoding
    {
        ...
        public readonly partial struct AllowReservedEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<AllowReservedEntity, Mutable>(AllowReservedEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(AllowReservedEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="AllowReservedEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AllowReservedEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AllowReservedEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly AllowReservedEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly AllowReservedEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<AllowReservedEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(AllowReservedEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<AllowReservedEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<AllowReservedEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<AllowReservedEntity>();
                }
                finally
                {
