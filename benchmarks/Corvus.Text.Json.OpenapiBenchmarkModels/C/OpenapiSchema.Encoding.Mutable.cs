...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct Encoding
    {
...
#endif
        {
            ...
            /// </summary>
            public Corvus.OpenapiBenchmark.Current.OpenapiSchema.Encoding.AllowReservedEntity.Mutable AllowReserved
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AllowReservedUtf8, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.Encoding.AllowReservedEntity.Mutable value))
                    {
                        return value;
                    }

                    return Corvus.OpenapiBenchmark.Current.OpenapiSchema.Encoding.AllowReservedEntity.Mutable.DefaultInstance;
                }
            }
            ...
            /// </summary>
            public Corvus.OpenapiBenchmark.Current.OpenapiSchema.Encoding.HeadersEntity.Mutable Headers
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HeadersUtf8, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.Encoding.HeadersEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public Corvus.OpenapiBenchmark.Current.OpenapiSchema.Encoding.StyleEntity.Mutable Style
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StyleUtf8, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.Encoding.StyleEntity.Mutable value))
                    {
                        return value;
                    }

                    return Corvus.OpenapiBenchmark.Current.OpenapiSchema.Encoding.StyleEntity.Mutable.DefaultInstance;
                }
            }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetHeaders<TContext>(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Encoding.HeadersEntity.Source<TContext> value)
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.OpenapiBenchmark.Current.OpenapiSchema.Encoding.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
            {
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.OpenapiBenchmark.Current.OpenapiSchema.Encoding.Mutable, TResult> defaultMatch)
            {
                if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.SpecificationExtensions.JsonSchema.Evaluate(_parent, _idx))
                {
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.OpenapiBenchmark.Current.OpenapiSchema.Encoding.AllowReservedEntity.Source _createArg1;
            private readonly Corvus.OpenapiBenchmark.Current.JsonMediaRange.Source _createArg2;
            private readonly Corvus.OpenapiBenchmark.Current.JsonBoolean.Source _createArg3;
            private readonly Corvus.OpenapiBenchmark.Current.OpenapiSchema.Encoding.HeadersEntity.Source _createArg4;
            private readonly Corvus.OpenapiBenchmark.Current.OpenapiSchema.Encoding.StyleEntity.Source _createArg5;
            ...
            #endif
        {
            ...
            private readonly Corvus.OpenapiBenchmark.Current.JsonMediaRange.Source _createArg2;
            private readonly Corvus.OpenapiBenchmark.Current.JsonBoolean.Source _createArg3;
            private readonly Corvus.OpenapiBenchmark.Current.OpenapiSchema.Encoding.HeadersEntity.Source<TContext> _createArg4;
            private readonly Corvus.OpenapiBenchmark.Current.OpenapiSchema.Encoding.StyleEntity.Source _createArg5;
        ...
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Encoding.AllowReservedEntity.Source allowReserved = default, scoped in Corvus.OpenapiBenchmark.Current.JsonMediaRange.Source contentType = default, scoped in Corvus.OpenapiBenchmark.Current.JsonBoolean.Source explode = default, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Encoding.HeadersEntity.Source<TContext> headers = default, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Encoding.StyleEntity.Source style = default)
            ...
            #endif
        {
            return new Source<TContext>(context, allowReserved, contentType, explode, headers, style);
        }
        ...
        public static ParsedJsonDocument<Encoding> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Encoding>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Encoding> Create<TContext>(
        ...
        public static ParsedJsonDocument<Encoding> Create(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Encoding.AllowReservedEntity.Source allowReserved = default, in Corvus.OpenapiBenchmark.Current.JsonMediaRange.Source contentType = default, in Corvus.OpenapiBenchmark.Current.JsonBoolean.Source explode = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Encoding.HeadersEntity.Source headers = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Encoding.StyleEntity.Source style = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Encoding> Create<TContext>(in TContext context, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Encoding.AllowReservedEntity.Source allowReserved = default, in Corvus.OpenapiBenchmark.Current.JsonMediaRange.Source contentType = default, in Corvus.OpenapiBenchmark.Current.JsonBoolean.Source explode = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Encoding.HeadersEntity.Source<TContext> headers = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Encoding.StyleEntity.Source style = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
