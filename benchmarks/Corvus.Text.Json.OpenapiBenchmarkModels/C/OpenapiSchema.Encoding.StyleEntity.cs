...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct Encoding
    {
...
#endif
        {
            ...
            internal StyleEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static StyleEntity DefaultInstance { get; } = ParsedJsonDocument<StyleEntity>.StringConstant([.."\"form\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(StyleEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in StyleEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(StyleEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator StyleEntity(JsonElement instance)
            {
                return StyleEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static StyleEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static StyleEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<StyleEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static StyleEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<StyleEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static StyleEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<StyleEntity>(json, options);
            }
            ...
            /// </exception>
            public static StyleEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<StyleEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out StyleEntity? result)
            {
                return JsonElementHelpers.TryParseValue<StyleEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new StyleEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static StyleEntity IJsonElement<StyleEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"StyleEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="StyleEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="StyleEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public StyleEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<StyleEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="StyleEntity"/> that lives for the lifetime of its
            ...
            /// <param name="matchForm">Match 1st item.</param>
            /// <param name="matchSpaceDelimited">Match 2nd item.</param>
            /// <param name="matchPipeDelimited">Match 3rd item.</param>
            /// <param name="matchDeepObject">Match 4th item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchForm,
                Func<TContext, TResult> matchSpaceDelimited,
                Func<TContext, TResult> matchPipeDelimited,
                Func<TContext, TResult> matchDeepObject,
            ...
            public TResult Match<TResult>(
                Func<TResult> matchForm,
                Func<TResult> matchSpaceDelimited,
                Func<TResult> matchPipeDelimited,
                Func<TResult> matchDeepObject,
