...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct Example
    {
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.OpenapiBenchmark.Current.OpenapiSchema.Example.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source arg1, scoped in Corvus.OpenapiBenchmark.Current.JsonUri.Source arg2, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source arg3, scoped in Corvus.Text.Json.JsonElement.Source arg4)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _createArg3 = arg3;
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Current.OpenapiSchema.Example.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in TContext context, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source arg1, scoped in Corvus.OpenapiBenchmark.Current.JsonUri.Source arg2, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source arg3, scoped in Corvus.Text.Json.JsonElement.Source<TContext> arg4)
            {
                _context = context;
                _createArg1 = arg1;
                _createArg2 = arg2;
        ...
        public ref struct Builder
        {
            ...
            internal static void BuildCreateValue(scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source arg1, scoped in Corvus.OpenapiBenchmark.Current.JsonUri.Source arg2, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source arg3, scoped in Corvus.Text.Json.JsonElement.Source arg4, ref ComplexValueBuilder o)
            {
                o.StartObject();
            ...
            /// <param name="arg4">The value of the property.</param>
            /// <param name="o">The complex value builder into which to write the object.</param>
            internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source arg1, scoped in Corvus.OpenapiBenchmark.Current.JsonUri.Source arg2, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source arg3, scoped in Corvus.Text.Json.JsonElement.Source<TContext> arg4, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default, scoped in Corvus.OpenapiBenchmark.Current.JsonUri.Source externalValue = default, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source summary = default, scoped in Corvus.Text.Json.JsonElement.Source value = default)
        {
            return new Source(description, externalValue, summary, value);
        }
        ...
        /// <param name="value">The value of the <c>"value"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default, scoped in Corvus.OpenapiBenchmark.Current.JsonUri.Source externalValue = default, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source summary = default, scoped in Corvus.Text.Json.JsonElement.Source<TContext> value = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            return new Source<TContext>(context, description, externalValue, summary, value);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default, in Corvus.OpenapiBenchmark.Current.JsonUri.Source externalValue = default, in Corvus.OpenapiBenchmark.Current.JsonString.Source summary = default, in Corvus.Text.Json.JsonElement.Source value = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default, in Corvus.OpenapiBenchmark.Current.JsonUri.Source externalValue = default, in Corvus.OpenapiBenchmark.Current.JsonString.Source summary = default, in Corvus.Text.Json.JsonElement.Source<TContext> value = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Example> Create<TContext>(
        ...
        public static ParsedJsonDocument<Example> Create(in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default, in Corvus.OpenapiBenchmark.Current.JsonUri.Source externalValue = default, in Corvus.OpenapiBenchmark.Current.JsonString.Source summary = default, in Corvus.Text.Json.JsonElement.Source value = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Example> Create<TContext>(in TContext context, in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default, in Corvus.OpenapiBenchmark.Current.JsonUri.Source externalValue = default, in Corvus.OpenapiBenchmark.Current.JsonString.Source summary = default, in Corvus.Text.Json.JsonElement.Source<TContext> value = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
