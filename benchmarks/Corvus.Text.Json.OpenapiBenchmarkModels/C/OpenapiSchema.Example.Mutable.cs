...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct Example
    {
        ...
        public ref struct Source
        {
            ...
            internal Source(in Corvus.OpenapiBenchmark.Current.JsonString.Source arg1, in Corvus.OpenapiBenchmark.Current.JsonUri.Source arg2, in Corvus.OpenapiBenchmark.Current.JsonString.Source arg3, in Corvus.Text.Json.JsonElement.Source arg4)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _createArg3 = arg3;
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, in Corvus.OpenapiBenchmark.Current.JsonString.Source arg1, in Corvus.OpenapiBenchmark.Current.JsonUri.Source arg2, in Corvus.OpenapiBenchmark.Current.JsonString.Source arg3, in Corvus.Text.Json.JsonElement.Source<TContext> arg4)
            {
                _context = context;
                _createArg1 = arg1;
                _createArg2 = arg2;
        ...
        public ref struct Builder
        {
            ...
            internal static void BuildCreateValue(in Corvus.OpenapiBenchmark.Current.JsonString.Source arg1, in Corvus.OpenapiBenchmark.Current.JsonUri.Source arg2, in Corvus.OpenapiBenchmark.Current.JsonString.Source arg3, in Corvus.Text.Json.JsonElement.Source arg4, ref ComplexValueBuilder o)
            {
                o.StartObject();
            ...
            /// <param name="arg4">The value of the property.</param>
            /// <param name="o">The complex value builder into which to write the object.</param>
            internal static void BuildCreateValue<TContext>(scoped in TContext context, in Corvus.OpenapiBenchmark.Current.JsonString.Source arg1, in Corvus.OpenapiBenchmark.Current.JsonUri.Source arg2, in Corvus.OpenapiBenchmark.Current.JsonString.Source arg3, in Corvus.Text.Json.JsonElement.Source<TContext> arg4, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default, in Corvus.OpenapiBenchmark.Current.JsonUri.Source externalValue = default, in Corvus.OpenapiBenchmark.Current.JsonString.Source summary = default, in Corvus.Text.Json.JsonElement.Source value = default)
        {
        ...
        /// <param name="value">The value of the <c>"value"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default, in Corvus.OpenapiBenchmark.Current.JsonUri.Source externalValue = default, in Corvus.OpenapiBenchmark.Current.JsonString.Source summary = default, in Corvus.Text.Json.JsonElement.Source<TContext> value = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
