    ...
    public readonly partial struct Example
    {
        ...
        public readonly partial struct RequiredExternalValueAndValue
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RequiredExternalValueAndValue instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RequiredExternalValueAndValue"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RequiredExternalValueAndValue(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.Text.Json.JsonElement.Mutable ExternalValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExternalValueUtf8, out Corvus.Text.Json.JsonElement.Mutable value))
                        {
                            return value;
                        }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new RequiredExternalValueAndValue(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                public void SetExternalValue(scoped in Corvus.Text.Json.JsonElement.Source value)
                {
                    ...
                    {
                        CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("externalValue");
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExternalValueUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                    ...
                    else
                    {
                        ...
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ExternalValue, ref cvb);
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetExternalValue<TContext>(in Corvus.Text.Json.JsonElement.Source<TContext> value)
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RequiredExternalValueAndValue.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="RequiredExternalValueAndValue"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="RequiredExternalValueAndValue"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredExternalValueAndValue Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<RequiredExternalValueAndValue>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="RequiredExternalValueAndValue"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredExternalValueAndValue Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RequiredExternalValueAndValue>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RequiredExternalValueAndValue instance) => new(JsonElement.From(instance));
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="RequiredExternalValueAndValue"/>.
                /// </summary>
                internal static void Create(
                    ref ComplexValueBuilder builder,
                    in Corvus.Text.Json.JsonElement.Source externalValue,
                    in Corvus.Text.Json.JsonElement.Source value)
                {
                    externalValue.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ExternalValue, ref builder);
                ...
                /// Creates an instance of a <see cref="RequiredExternalValueAndValue"/>.
                /// </summary>
                public void Create(in Corvus.Text.Json.JsonElement.Source externalValue, in Corvus.Text.Json.JsonElement.Source value)
                {
                    Create(ref _builder, externalValue, value);
                }
                ...
                internal static void Create<TContext>(
                    in TContext context,
                    ref ComplexValueBuilder builder,
                    in Corvus.Text.Json.JsonElement.Source<TContext> externalValue,
                    in Corvus.Text.Json.JsonElement.Source<TContext> value)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
                ...
                #endif
                {
                    Create(context, ref _builder, externalValue, value);
                }
            ...
            public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.JsonElement.Source<TContext> externalValue, scoped in Corvus.Text.Json.JsonElement.Source<TContext> value)
                ...
                #endif
            {
                return new Source<TContext>(context, externalValue, value);
            }
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.JsonElement.Source externalValue, in Corvus.Text.Json.JsonElement.Source value, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(externalValue, value);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> externalValue, in Corvus.Text.Json.JsonElement.Source<TContext> value, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                ...
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(context, externalValue, value);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<RequiredExternalValueAndValue, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RequiredExternalValueAndValue> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RequiredExternalValueAndValue>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RequiredExternalValueAndValue> Create<TContext>(
            ...
            public static ParsedJsonDocument<RequiredExternalValueAndValue> Create(in Corvus.Text.Json.JsonElement.Source externalValue, in Corvus.Text.Json.JsonElement.Source value, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RequiredExternalValueAndValue> Create<TContext>(in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> externalValue, in Corvus.Text.Json.JsonElement.Source<TContext> value, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
