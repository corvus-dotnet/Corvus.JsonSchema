...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct Example
    {
        ...
        public readonly partial struct RequiredExternalValueAndValue
            ...
            : IJsonElement<RequiredExternalValueAndValue>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            internal RequiredExternalValueAndValue(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </para>
            /// </remarks>
            public Corvus.Text.Json.JsonElement ExternalValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExternalValueUtf8, out Corvus.Text.Json.JsonElement value))
                    {
                        return value;
                    }
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RequiredExternalValueAndValue left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(RequiredExternalValueAndValue instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RequiredExternalValueAndValue(JsonElement instance)
            {
                return RequiredExternalValueAndValue.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredExternalValueAndValue From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredExternalValueAndValue ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredExternalValueAndValue>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredExternalValueAndValue ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredExternalValueAndValue>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredExternalValueAndValue ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredExternalValueAndValue>(json, options);
            }
            ...
            /// </exception>
            public static RequiredExternalValueAndValue ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RequiredExternalValueAndValue>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredExternalValueAndValue? result)
            {
                return JsonElementHelpers.TryParseValue<RequiredExternalValueAndValue>(ref reader, out result);
            }
...
#if NET
            static RequiredExternalValueAndValue IJsonElement<RequiredExternalValueAndValue>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RequiredExternalValueAndValue: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public RequiredExternalValueAndValue Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public RequiredExternalValueAndValue Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RequiredExternalValueAndValue>(_idx);
                }
