...
public readonly partial struct OpenapiSchema
{
...
#endif
    {
        ...
        internal Example(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static Example DefaultInstance { get; }
        ...
        /// </summary>
        public Corvus.OpenapiBenchmark.Current.JsonUri ExternalValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExternalValueUtf8, out Corvus.OpenapiBenchmark.Current.JsonUri value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.Text.Json.JsonElement Value
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ValueUtf8, out Corvus.Text.Json.JsonElement value))
                {
                    return value;
                }
        ...
        public static implicit operator Corvus.OpenapiBenchmark.Current.OpenapiSchema.SpecificationExtensions(Example value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Example(Corvus.OpenapiBenchmark.Current.OpenapiSchema.SpecificationExtensions value)
        {
            return From(value);
        }
        ...
        /// </returns>
        public static bool operator ==(in Example left, in Example right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Example left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(Example instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Example(JsonElement instance)
        {
            return Example.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Example From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Example ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Example>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Example ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Example>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Example ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Example>(json, options);
        }
        ...
        /// </exception>
        public static Example ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<Example>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Example? result)
        {
            return JsonElementHelpers.TryParseValue<Example>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new Example(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static Example IJsonElement<Example>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Example: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        private static class JsonPropertyNamesEscaped
        {
            ...
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="ExternalValue"/>.
            /// </summary>
            public static ReadOnlySpan<byte> ExternalValue => "externalValue"u8;
        ...
        private static class JsonPropertyNamesPrebaked
        {
            ...
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="ExternalValue"/>.
            /// </summary>
            public static ReadOnlySpan<byte> ExternalValue => [0xF5, 0x00, 0x00, 0x00, 0x22, 0x65, 0x78, 0x74, 0x65, 0x72, 0x6E, 0x61, 0x6C, 0x56, 0x61, 0x6C, 0x75, 0x65, 0x22];
