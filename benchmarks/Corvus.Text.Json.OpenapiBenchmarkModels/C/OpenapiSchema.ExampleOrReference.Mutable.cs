...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct ExampleOrReference
    {
...
#endif
        {
            ...
            /// </summary>
            public Corvus.OpenapiBenchmark.Current.JsonUriNotAsserted.Mutable ExternalValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExternalValueUtf8, out Corvus.OpenapiBenchmark.Current.JsonUriNotAsserted.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetExternalValue(in Corvus.OpenapiBenchmark.Current.JsonUriNotAsserted.Source value)
            {
                CheckValidInstance();
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.Example" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsExample(out Corvus.OpenapiBenchmark.Current.OpenapiSchema.Example result)
            {
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.ExampleOrReference.RequiredRef" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsRequiredRef(out Corvus.OpenapiBenchmark.Current.OpenapiSchema.ExampleOrReference.RequiredRef result)
            {
                if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.ExampleOrReference.RequiredRef.JsonSchema.Evaluate(_parent, _idx))
                {
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.OpenapiBenchmark.Current.JsonUriNotAsserted.Source externalValue = default,
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OpenapiBenchmark.Current.JsonUriReferenceNotAsserted.Source refValue = default, in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default, in Corvus.OpenapiBenchmark.Current.JsonUriNotAsserted.Source externalValue = default, in Corvus.OpenapiBenchmark.Current.JsonString.Source summary = default, in Corvus.Text.Json.JsonElement.Source value = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.OpenapiBenchmark.Current.JsonUriReferenceNotAsserted.Source refValue = default, in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default, in Corvus.OpenapiBenchmark.Current.JsonUriNotAsserted.Source externalValue = default, in Corvus.OpenapiBenchmark.Current.JsonString.Source summary = default, in Corvus.Text.Json.JsonElement.Source<TContext> value = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
