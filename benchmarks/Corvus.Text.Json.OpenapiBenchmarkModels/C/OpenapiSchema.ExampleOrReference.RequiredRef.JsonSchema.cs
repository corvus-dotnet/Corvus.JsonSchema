    ...
    public readonly partial struct ExampleOrReference
    {
            ...
            : IJsonElement<RequiredRef>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/example-or-reference/if"u8, buffer, out written);
