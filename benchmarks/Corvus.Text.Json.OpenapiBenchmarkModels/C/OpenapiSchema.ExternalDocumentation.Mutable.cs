...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct ExternalDocumentation
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ExternalDocumentation instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ExternalDocumentation"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ExternalDocumentation(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ExternalDocumentation(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ExternalDocumentation.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ExternalDocumentation"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ExternalDocumentation"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly ExternalDocumentation Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ExternalDocumentation>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ExternalDocumentation"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly ExternalDocumentation Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ExternalDocumentation>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.OpenapiBenchmark.Current.JsonUri.Source _createArg1;
            ...
            internal Source(Corvus.OpenapiBenchmark.Current.OpenapiSchema.ExternalDocumentation.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.OpenapiBenchmark.Current.JsonUri.Source arg1, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source arg2)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _kind = Kind.Create;
            ...
            public static implicit operator Source(ExternalDocumentation instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Current.OpenapiSchema.ExternalDocumentation.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.OpenapiBenchmark.Current.JsonUri.Source url,
            ...
            /// Creates an instance of a <see cref="ExternalDocumentation"/>.
            /// </summary>
            public void Create(in Corvus.OpenapiBenchmark.Current.JsonUri.Source url, in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default)
            {
            ...
            internal static void BuildCreateValue(scoped in Corvus.OpenapiBenchmark.Current.JsonUri.Source arg1, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source arg2, ref ComplexValueBuilder o)
            {
                o.StartObject();
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.OpenapiBenchmark.Current.JsonUri.Source url, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default)
        {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OpenapiBenchmark.Current.JsonUri.Source url, in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        {
            return workspace.CreateBuilder<ExternalDocumentation, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ExternalDocumentation> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ExternalDocumentation>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ExternalDocumentation> Create<TContext>(
        ...
        public static ParsedJsonDocument<ExternalDocumentation> Create(in Corvus.OpenapiBenchmark.Current.JsonUri.Source url, in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
