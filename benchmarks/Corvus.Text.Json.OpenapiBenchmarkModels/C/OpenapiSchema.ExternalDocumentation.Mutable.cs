...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct ExternalDocumentation
    {
        ...
        public ref struct Source
        {
            ...
            internal Source(in Corvus.OpenapiBenchmark.Current.JsonUri.Source arg1, in Corvus.OpenapiBenchmark.Current.JsonString.Source arg2)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _kind = Kind.Create;
        ...
        public ref struct Builder
        {
            ...
            internal static void BuildCreateValue(in Corvus.OpenapiBenchmark.Current.JsonUri.Source arg1, in Corvus.OpenapiBenchmark.Current.JsonString.Source arg2, ref ComplexValueBuilder o)
            {
                o.StartObject();
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(in Corvus.OpenapiBenchmark.Current.JsonUri.Source url, in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default)
        {
