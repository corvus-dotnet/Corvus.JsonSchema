    ...
    public readonly partial struct Header
    {
        ...
        public readonly partial struct ContentEntity
        {
...
#endif
            {
                ...
                public static implicit operator Corvus.OpenapiBenchmark.Current.OpenapiSchema.Content.Mutable(Mutable value)
                {
                    return Corvus.OpenapiBenchmark.Current.OpenapiSchema.Content.Mutable.From(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static explicit operator Mutable(Corvus.OpenapiBenchmark.Current.OpenapiSchema.Content.Mutable value)
                {
                    return From(value);
                }
                ...
                /// </remarks>
                public void Apply(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Content value)
                {
                    CheckValidInstance();
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.ContentEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.ContentEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public static ParsedJsonDocument<ContentEntity> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ContentEntity>();
                }
                finally
                {
