...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct Header
    {
...
#endif
        {
            ...
            /// <summary>
            /// Conversion to <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredSchema"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredSchema.Mutable(Mutable value)
            {
                return Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredSchema.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredSchema"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredSchema.Mutable value)
            {
                return From(value);
            }

            /// <summary>
            /// Conversion to <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredContent"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredContent.Mutable(Mutable value)
            {
                return Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredContent.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredContent"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredContent.Mutable value)
            {
                return From(value);
            }
            ...
            public static explicit operator Mutable(Header instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Header"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Header(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Header(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            /// This will add or update any property values provided by the <paramref name="value"/>.
            /// </remarks>
            public void Apply(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredSchema value)
            {
                CheckValidInstance();
            ...
            /// This will add or update any property values provided by the <paramref name="value"/>.
            /// </remarks>
            public void Apply(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredContent value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Header.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Header"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Header"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly Header Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<Header>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Header"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly Header Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Header>(_idx);
            }
            ...
            /// <param name="matchRequiredSchema">Match a <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredSchema"/>.</param>
            /// <param name="matchRequiredContent">Match a <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredContent"/>.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Matcher<Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredSchema, TContext, TResult> matchRequiredSchema,
                Matcher<Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredContent, TContext, TResult> matchRequiredContent,
                Matcher<Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
            {
                if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredSchema.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchRequiredSchema(Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredSchema.Mutable.From(this), context);
                }

                if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredContent.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchRequiredContent(Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredContent.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                Matcher<Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredSchema, TResult> matchRequiredSchema,
                Matcher<Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredContent, TResult> matchRequiredContent,
                Matcher<Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.Mutable, TResult> defaultMatch)
            {
                if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredSchema.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchRequiredSchema(Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredSchema.Mutable.From(this));
                }

                if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredContent.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchRequiredContent(Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredContent.Mutable.From(this));
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredSchema.Mutable" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsRequiredSchema(out Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredSchema.Mutable result)
            {
                if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredSchema.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredSchema.Mutable.From(this);
                    return true;
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredContent.Mutable" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsRequiredContent(out Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredContent.Mutable result)
            {
                if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredContent.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredContent.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.ContentEntity.Source _createArg1;
            private readonly Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.DeprecatedEntity.Source _createArg2;
            ...
            private readonly Corvus.OpenapiBenchmark.Current.OpenapiSchema.Examples.ExamplesEntity.Source _createArg5;
            private readonly Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.WithStyleSimple.ExplodeEntity.Source _createArg6;
            private readonly Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredEntity.Source _createArg7;
            private readonly Corvus.OpenapiBenchmark.Current.OpenapiSchema.Schema.Source _createArg8;
            private readonly Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.WithStyleSimple.StyleEntity.Source _createArg9;
            ...
            public static implicit operator Source(Header instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            private readonly Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.ContentEntity.Source<TContext> _createArg1;
            private readonly Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.DeprecatedEntity.Source _createArg2;
            private readonly Corvus.OpenapiBenchmark.Current.JsonString.Source _createArg3;
            private readonly Corvus.Text.Json.JsonElement.Source<TContext> _createArg4;
            private readonly Corvus.OpenapiBenchmark.Current.OpenapiSchema.Examples.ExamplesEntity.Source<TContext> _createArg5;
            private readonly Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.WithStyleSimple.ExplodeEntity.Source _createArg6;
            private readonly Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredEntity.Source _createArg7;
            private readonly Corvus.OpenapiBenchmark.Current.OpenapiSchema.Schema.Source<TContext> _createArg8;
            private readonly Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.WithStyleSimple.StyleEntity.Source _createArg9;
        ...
        public ref struct Builder
        {
            ...
            public void Create(
                ...
                in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.WithStyleSimple.StyleEntity.Source style = default)
            {
                Create(ref _builder, content, deprecated, description, example, examples, explode, required, schema, style);
            }
            ...
            #endif
            {
                Create(context, ref _builder, content, deprecated, description, example, examples, explode, required, schema, style);
            }
        ...
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.ContentEntity.Source<TContext> content = default, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.DeprecatedEntity.Source deprecated = default, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default, scoped in Corvus.Text.Json.JsonElement.Source<TContext> example = default, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Examples.ExamplesEntity.Source<TContext> examples = default, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.WithStyleSimple.ExplodeEntity.Source explode = default, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredEntity.Source required = default, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Schema.Source<TContext> schema = default, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.WithStyleSimple.StyleEntity.Source style = default)
            ...
            #endif
        {
            return new Source<TContext>(context, content, deprecated, description, example, examples, explode, required, schema, style);
        }
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredContent.Source Build(
            scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredContent.Builder.Build buildValue, int initialCapacity = 1)
        {
            return new Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredContent.Source(buildValue);
        }
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredContent.Source<TContext> Build<TContext>(
            scoped in TContext context, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredContent.Builder.Build<TContext> buildValue, int initialCapacity = 1)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            return new Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredContent.Source<TContext>(context, buildValue);
        }
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredSchema.Source Build(
            scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredSchema.Builder.Build buildValue, int initialCapacity = 1)
        {
            return new Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredSchema.Source(buildValue);
        }
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredSchema.Source<TContext> Build<TContext>(
            scoped in TContext context, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredSchema.Builder.Build<TContext> buildValue, int initialCapacity = 1)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            return new Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredSchema.Source<TContext>(context, buildValue);
        }
        ...
        /// <returns>An instance of a mutable document initialized with the given value.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(
            JsonWorkspace workspace, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredContent.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
        {
            // Create the document builder without a MetadataDb
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            var source = new Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredContent.Source(value);
            source.AddAsItem(ref cvb);
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        /// <returns>An instance of a mutable document initialized with the given value.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(
            JsonWorkspace workspace, scoped in TContext context, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredContent.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            ...
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            var source = new Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredContent.Source<TContext>(context, value);
            source.AddAsItem(ref cvb);
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        /// <returns>An instance of a mutable document initialized with the given value.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(
            JsonWorkspace workspace, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredSchema.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
        {
            // Create the document builder without a MetadataDb
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            var source = new Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredSchema.Source(value);
            source.AddAsItem(ref cvb);
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        /// <returns>An instance of a mutable document initialized with the given value.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(
            JsonWorkspace workspace, scoped in TContext context, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredSchema.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            ...
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            var source = new Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredSchema.Source<TContext>(context, value);
            source.AddAsItem(ref cvb);
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.ContentEntity.Source content = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.DeprecatedEntity.Source deprecated = default, in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default, in Corvus.Text.Json.JsonElement.Source example = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Examples.ExamplesEntity.Source examples = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.WithStyleSimple.ExplodeEntity.Source explode = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredEntity.Source required = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Schema.Source schema = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.WithStyleSimple.StyleEntity.Source style = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(content, deprecated, description, example, examples, explode, required, schema, style);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.ContentEntity.Source<TContext> content = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.DeprecatedEntity.Source deprecated = default, in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default, in Corvus.Text.Json.JsonElement.Source<TContext> example = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Examples.ExamplesEntity.Source<TContext> examples = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.WithStyleSimple.ExplodeEntity.Source explode = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredEntity.Source required = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Schema.Source<TContext> schema = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.WithStyleSimple.StyleEntity.Source style = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            ...
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(context, content, deprecated, description, example, examples, explode, required, schema, style);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<Header, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<Header> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Header>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Header> Create<TContext>(
        ...
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Header> Create(
            scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredContent.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent(initialValueBufferSize);
            try
            {
        ...
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Header> Create<TContext>(
            scoped in TContext context, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredContent.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
        ...
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Header> Create(
            scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredSchema.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent(initialValueBufferSize);
            try
            {
        ...
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Header> Create<TContext>(
            scoped in TContext context, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredSchema.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
        ...
        public static ParsedJsonDocument<Header> Create(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.ContentEntity.Source content = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.DeprecatedEntity.Source deprecated = default, in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default, in Corvus.Text.Json.JsonElement.Source example = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Examples.ExamplesEntity.Source examples = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.WithStyleSimple.ExplodeEntity.Source explode = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredEntity.Source required = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Schema.Source schema = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.WithStyleSimple.StyleEntity.Source style = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Header> Create<TContext>(in TContext context, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.ContentEntity.Source<TContext> content = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.DeprecatedEntity.Source deprecated = default, in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default, in Corvus.Text.Json.JsonElement.Source<TContext> example = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Examples.ExamplesEntity.Source<TContext> examples = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.WithStyleSimple.ExplodeEntity.Source explode = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.RequiredEntity.Source required = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Schema.Source<TContext> schema = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.WithStyleSimple.StyleEntity.Source style = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
