    ...
    public readonly partial struct Header
    {
            ...
            : IJsonElement<RequiredSchema>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/header/oneOf/0"u8, buffer, out written);
