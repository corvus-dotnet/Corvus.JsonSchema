    ...
    public readonly partial struct Header
    {
        ...
        public readonly partial struct RequiredSchema
        {
...
#endif
            {
                ...
                public void SetSchema(in Corvus.Text.Json.JsonElement.Source value)
                {
                    CheckValidInstance();
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(in Corvus.Text.Json.JsonElement.Source schema)
            {
            ...
            /// <param name="schema">The value of the <c>"schema"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> schema)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
