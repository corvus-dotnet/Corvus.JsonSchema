        ...
        public readonly partial struct WithStyleSimple
        {
            ...
            public readonly partial struct ExplodeEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ExplodeEntity, Mutable>(ExplodeEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(ExplodeEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ExplodeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ExplodeEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ExplodeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ExplodeEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ExplodeEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ExplodeEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(ExplodeEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<ExplodeEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<ExplodeEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<ExplodeEntity>();
                    }
                    finally
                    {
