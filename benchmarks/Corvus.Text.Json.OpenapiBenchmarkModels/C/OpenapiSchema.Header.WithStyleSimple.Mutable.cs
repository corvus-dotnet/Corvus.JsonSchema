    ...
    public readonly partial struct Header
    {
        ...
        public readonly partial struct WithStyleSimple
        {
            ...
            public ref struct Source
            {
                ...
                internal Source(scoped in Corvus.Text.Json.JsonElement.Source arg1, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Examples.ExamplesEntity.Source arg2, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.WithStyleSimple.ExplodeEntity.Source arg3, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.WithStyleSimple.StyleEntity.Source arg4)
                {
                    _createArg1 = arg1;
                    _createArg2 = arg2;
                    _createArg3 = arg3;
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, scoped in Corvus.Text.Json.JsonElement.Source<TContext> arg1, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Examples.ExamplesEntity.Source<TContext> arg2, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.WithStyleSimple.ExplodeEntity.Source arg3, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.WithStyleSimple.StyleEntity.Source arg4)
                {
                    _context = context;
                    _createArg1 = arg1;
                    _createArg2 = arg2;
            ...
            public ref struct Builder
            {
                ...
                internal static void BuildCreateValue(scoped in Corvus.Text.Json.JsonElement.Source arg1, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Examples.ExamplesEntity.Source arg2, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.WithStyleSimple.ExplodeEntity.Source arg3, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.WithStyleSimple.StyleEntity.Source arg4, ref ComplexValueBuilder o)
                {
                    o.StartObject();
                ...
                /// <param name="arg4">The value of the property.</param>
                /// <param name="o">The complex value builder into which to write the object.</param>
                internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.JsonElement.Source<TContext> arg1, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Examples.ExamplesEntity.Source<TContext> arg2, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.WithStyleSimple.ExplodeEntity.Source arg3, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.WithStyleSimple.StyleEntity.Source arg4, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.Text.Json.JsonElement.Source example = default, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Examples.ExamplesEntity.Source examples = default, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.WithStyleSimple.ExplodeEntity.Source explode = default, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.WithStyleSimple.StyleEntity.Source style = default)
            {
            ...
            /// <param name="style">The value of the <c>"style"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.JsonElement.Source<TContext> example = default, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Examples.ExamplesEntity.Source<TContext> examples = default, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.WithStyleSimple.ExplodeEntity.Source explode = default, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.WithStyleSimple.StyleEntity.Source style = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.JsonElement.Source example = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Examples.ExamplesEntity.Source examples = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.WithStyleSimple.ExplodeEntity.Source explode = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.WithStyleSimple.StyleEntity.Source style = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> example = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Examples.ExamplesEntity.Source<TContext> examples = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.WithStyleSimple.ExplodeEntity.Source explode = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.WithStyleSimple.StyleEntity.Source style = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
            ...
            public static ParsedJsonDocument<WithStyleSimple> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<WithStyleSimple>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<WithStyleSimple> Create<TContext>(
            ...
            public static ParsedJsonDocument<WithStyleSimple> Create(in Corvus.Text.Json.JsonElement.Source example = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Examples.ExamplesEntity.Source examples = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.WithStyleSimple.ExplodeEntity.Source explode = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.WithStyleSimple.StyleEntity.Source style = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
            public static ParsedJsonDocument<WithStyleSimple> Create<TContext>(in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> example = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Examples.ExamplesEntity.Source<TContext> examples = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.WithStyleSimple.ExplodeEntity.Source explode = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.WithStyleSimple.StyleEntity.Source style = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
