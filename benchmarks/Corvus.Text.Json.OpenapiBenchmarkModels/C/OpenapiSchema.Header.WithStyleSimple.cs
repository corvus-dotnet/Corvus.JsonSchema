...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct Header
    {
...
#endif
        {
            ...
            public static implicit operator Corvus.OpenapiBenchmark.Current.OpenapiSchema.Examples(WithStyleSimple value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator WithStyleSimple(Corvus.OpenapiBenchmark.Current.OpenapiSchema.Examples value)
            {
                return From(value);
            }
