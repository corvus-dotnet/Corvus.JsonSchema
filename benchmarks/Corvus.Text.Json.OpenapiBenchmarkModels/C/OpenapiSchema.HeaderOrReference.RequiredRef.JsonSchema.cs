    ...
    public readonly partial struct HeaderOrReference
    {
            ...
            : IJsonElement<RequiredRef>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/header-or-reference/if"u8, buffer, out written);
