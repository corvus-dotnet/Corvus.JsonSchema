...
public readonly partial struct OpenapiSchema
{
...
#endif
    {
        ...
        public bool TryGetAsHeader(out Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header result)
        {
            ...
            {
                result = Corvus.OpenapiBenchmark.Current.OpenapiSchema.Header.From(this);
                return true;
            }
        ...
        public bool TryGetAsRequiredRef(out Corvus.OpenapiBenchmark.Current.OpenapiSchema.HeaderOrReference.RequiredRef result)
        {
            ...
            {
                result = Corvus.OpenapiBenchmark.Current.OpenapiSchema.HeaderOrReference.RequiredRef.From(this);
                return true;
            }
