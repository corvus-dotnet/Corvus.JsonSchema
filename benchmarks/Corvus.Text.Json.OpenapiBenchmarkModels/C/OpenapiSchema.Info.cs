...
public readonly partial struct OpenapiSchema
{
...
#endif
    {
        ...
        /// </summary>
        public Corvus.OpenapiBenchmark.Current.OpenapiSchema.Contact ContactValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ContactValueUtf8, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.Contact value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.OpenapiBenchmark.Current.OpenapiSchema.License LicenseValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LicenseValueUtf8, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.License value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.OpenapiBenchmark.Current.JsonString Title
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TitleUtf8, out Corvus.OpenapiBenchmark.Current.JsonString value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.OpenapiBenchmark.Current.JsonString Version
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionUtf8, out Corvus.OpenapiBenchmark.Current.JsonString value))
                {
                    return value;
                }
        ...
        public static implicit operator Corvus.OpenapiBenchmark.Current.OpenapiSchema.SpecificationExtensions(Info value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Info(Corvus.OpenapiBenchmark.Current.OpenapiSchema.SpecificationExtensions value)
        {
            return From(value);
        }
