...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct JsonSchemaDialectEntity
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<JsonSchemaDialectEntity, Mutable>(JsonSchemaDialectEntity.DefaultInstance);
        ...
        public static ParsedJsonDocument<JsonSchemaDialectEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<JsonSchemaDialectEntity>();
            }
            finally
            {
