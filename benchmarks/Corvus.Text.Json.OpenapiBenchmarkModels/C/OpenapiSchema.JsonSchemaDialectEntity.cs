...
public readonly partial struct OpenapiSchema
{
...
#endif
    {
        ...
        internal JsonSchemaDialectEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static JsonSchemaDialectEntity DefaultInstance { get; } = ParsedJsonDocument<JsonSchemaDialectEntity>.StringConstant([.."\"https://spec.openapis.org/oas/3.1/dialect/base\""u8]);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Utf8UriValue(JsonSchemaDialectEntity value) => Utf8UriValue.TryGetValue(value._parent, value._idx, out Utf8UriValue result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(JsonSchemaDialectEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in JsonSchemaDialectEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(JsonSchemaDialectEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonSchemaDialectEntity(JsonElement instance)
        {
            return JsonSchemaDialectEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static JsonSchemaDialectEntity From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static JsonSchemaDialectEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<JsonSchemaDialectEntity>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static JsonSchemaDialectEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<JsonSchemaDialectEntity>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static JsonSchemaDialectEntity ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<JsonSchemaDialectEntity>(json, options);
        }
        ...
        /// </exception>
        public static JsonSchemaDialectEntity ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<JsonSchemaDialectEntity>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out JsonSchemaDialectEntity? result)
        {
            return JsonElementHelpers.TryParseValue<JsonSchemaDialectEntity>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new JsonSchemaDialectEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static JsonSchemaDialectEntity IJsonElement<JsonSchemaDialectEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"JsonSchemaDialectEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="JsonSchemaDialectEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="JsonSchemaDialectEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public JsonSchemaDialectEntity Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<JsonSchemaDialectEntity>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="JsonSchemaDialectEntity"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public JsonSchemaDialectEntity Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<JsonSchemaDialectEntity>(_idx);
            }
