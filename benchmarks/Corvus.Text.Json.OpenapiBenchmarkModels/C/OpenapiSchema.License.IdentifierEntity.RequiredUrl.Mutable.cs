    ...
    public readonly partial struct License
    {
        ...
        public readonly partial struct IdentifierEntity
        {
            ...
            public readonly partial struct RequiredUrl
            {
                ...
                /// <returns>The source from which to build the value.</returns>
                public static Source Build(in Corvus.Text.Json.JsonElement.Source url)
                {
                ...
                /// <param name="url">The value of the <c>"url"</c> property.</param>
                /// <returns>The source from which to build the value.</returns>
                public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> url)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
