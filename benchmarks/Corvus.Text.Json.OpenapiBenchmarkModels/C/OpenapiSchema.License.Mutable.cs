...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct License
    {
...
#endif
        {
            ...
            /// </summary>
            public Corvus.OpenapiBenchmark.Current.JsonString.Mutable Identifier
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IdentifierUtf8, out Corvus.OpenapiBenchmark.Current.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Current.OpenapiSchema.License.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.OpenapiBenchmark.Current.JsonString.Source identifier = default,
            ...
            public void Create(
                ...
                in Corvus.OpenapiBenchmark.Current.JsonUri.Source url = default)
            {
                Create(ref _builder, name, identifier, url);
            }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OpenapiBenchmark.Current.JsonString.Source name, in Corvus.OpenapiBenchmark.Current.JsonString.Source identifier = default, in Corvus.OpenapiBenchmark.Current.JsonUri.Source url = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(name, identifier, url);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        public static ParsedJsonDocument<License> Create(in Corvus.OpenapiBenchmark.Current.JsonString.Source name, in Corvus.OpenapiBenchmark.Current.JsonString.Source identifier = default, in Corvus.OpenapiBenchmark.Current.JsonUri.Source url = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
