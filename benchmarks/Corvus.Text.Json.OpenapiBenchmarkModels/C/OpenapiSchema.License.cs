...
public readonly partial struct OpenapiSchema
{
...
#endif
    {
        ...
        /// </summary>
        public Corvus.OpenapiBenchmark.Current.JsonString Identifier
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IdentifierUtf8, out Corvus.OpenapiBenchmark.Current.JsonString value))
                {
                    return value;
                }
        ...
        public static implicit operator Corvus.OpenapiBenchmark.Current.OpenapiSchema.SpecificationExtensions(License value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator License(Corvus.OpenapiBenchmark.Current.OpenapiSchema.SpecificationExtensions value)
        {
            return From(value);
        }
