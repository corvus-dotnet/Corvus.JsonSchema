...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct Link
    {
        ...
        public readonly partial struct RequiredOperationId
        {
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(in Corvus.Text.Json.JsonElement.Source operationId)
            {
            ...
            /// <param name="operationId">The value of the <c>"operationId"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> operationId)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
