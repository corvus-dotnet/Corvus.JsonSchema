...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct Link
    {
            ...
            : IJsonElement<RequiredOperationRef>
        {
            ...
            {
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyOperationRefPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("operationRef"u8, buffer, out written);
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyOperationRefNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("operationRef"u8, buffer, out written);

                private const int RequiredOffsetForOperationRef = 0;
                private const uint RequiredBitForOperationRef = 0b00000000000000000000000000000001;

                private const uint RequiredBitMask0 =
                    RequiredBitForOperationRef;

                private static void MatchOperationRef(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    requiredBitBuffer[RequiredOffsetForOperationRef] |= RequiredBitForOperationRef;
                }
                ...
                {
                    if (span.SequenceEqual(JsonPropertyNames.OperationRefUtf8))
                    {
                        matcher = MatchOperationRef;
                        return true;
                    }
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/link/oneOf/0"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/link/oneOf/0";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/link/oneOf/0"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.StartObject)
                    {
                        ...
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyOperationRefPresent, "operationRef"u8, "required"u8);
                        }
                        ...
                        {
                            if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForOperationRef] & RequiredBitForOperationRef) == 0)
                            {
                                context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyOperationRefNotPresent, "operationRef"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyOperationRefPresent, "operationRef"u8, "required"u8);
