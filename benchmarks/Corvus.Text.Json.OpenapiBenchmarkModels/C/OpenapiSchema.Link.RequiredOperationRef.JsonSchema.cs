    ...
    public readonly partial struct Link
    {
            ...
            : IJsonElement<RequiredOperationRef>
        {
            public static partial class JsonSchema
            {
                ...
                private static void MatchOperationRef(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                {
