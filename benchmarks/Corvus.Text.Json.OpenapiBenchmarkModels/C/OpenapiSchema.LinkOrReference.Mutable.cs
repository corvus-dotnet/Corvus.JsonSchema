    ...
    public readonly partial struct LinkOrReference
    {
...
#endif
        {
            ...
            public void SetOperationRef(in Corvus.OpenapiBenchmark.Current.JsonUriReference.Source value)
            {
                ...
                {
                    // We are going to insert the new value
                    value.AddAsProperty(JsonPropertyNamesEscaped.OperationRef, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
        ...
        public ref struct Builder
        {
                ...
                in Corvus.OpenapiBenchmark.Current.JsonString.Source summary = default)
            {
                ...
                operationRef.AddAsProperty(JsonPropertyNamesEscaped.OperationRef, ref builder, escapeName: false);
