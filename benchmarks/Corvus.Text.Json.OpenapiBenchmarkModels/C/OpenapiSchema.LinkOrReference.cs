...
public readonly partial struct OpenapiSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LinkOrReference"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal LinkOrReference(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static LinkOrReference DefaultInstance { get; }
        ...
        /// </summary>
        public Corvus.OpenapiBenchmark.Current.OpenapiSchema.Server Body
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BodyUtf8, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.Server value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.OpenapiBenchmark.Current.JsonUriReference OperationRef
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OperationRefUtf8, out Corvus.OpenapiBenchmark.Current.JsonUriReference value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.OpenapiBenchmark.Current.OpenapiSchema.MapOfStrings Parameters
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ParametersUtf8, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.MapOfStrings value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in LinkOrReference left, in LinkOrReference right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in LinkOrReference left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(LinkOrReference instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator LinkOrReference(JsonElement instance)
        {
            return LinkOrReference.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static LinkOrReference From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static LinkOrReference ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<LinkOrReference>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static LinkOrReference ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<LinkOrReference>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static LinkOrReference ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<LinkOrReference>(json, options);
        }
        ...
        /// </exception>
        public static LinkOrReference ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<LinkOrReference>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out LinkOrReference? result)
        {
            return JsonElementHelpers.TryParseValue<LinkOrReference>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new LinkOrReference(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static LinkOrReference IJsonElement<LinkOrReference>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"LinkOrReference: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public LinkOrReference Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<LinkOrReference>(_idx);
            }
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.Link" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsLink(out Corvus.OpenapiBenchmark.Current.OpenapiSchema.Link result)
        {
            if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.Link.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.OpenapiBenchmark.Current.OpenapiSchema.Link.From(this);
                return true;
            }
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.LinkOrReference.RequiredRef" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsRequiredRef(out Corvus.OpenapiBenchmark.Current.OpenapiSchema.LinkOrReference.RequiredRef result)
        {
            if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.LinkOrReference.RequiredRef.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.OpenapiBenchmark.Current.OpenapiSchema.LinkOrReference.RequiredRef.From(this);
                return true;
            }
        ...
        /// <param name="matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaLink">Match a <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.Link"/>.</param>
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.OpenapiBenchmark.Current.OpenapiSchema.Link, TContext, TResult> matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaLink)
...
#endif
        {
            ...
            {
                return matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaLink(Corvus.OpenapiBenchmark.Current.OpenapiSchema.Link.From(this), context);
            }
        }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.OpenapiBenchmark.Current.OpenapiSchema.Link, TResult> matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaLink)
        {
            if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.LinkOrReference.RequiredRef.JsonSchema.Evaluate(_parent, _idx))
            {
            ...
            {
                return matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaLink(Corvus.OpenapiBenchmark.Current.OpenapiSchema.Link.From(this));
            }
        }
        ...
        private static class JsonPropertyNamesPrebaked
        {
            ...
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="OperationRef"/>.
            /// </summary>
            public static ReadOnlySpan<byte> OperationRef => [0xE5, 0x00, 0x00, 0x00, 0x22, 0x6F, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6F, 0x6E, 0x52, 0x65, 0x66, 0x22];
