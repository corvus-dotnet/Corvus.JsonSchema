...
public readonly partial struct OpenapiSchema
{
        ...
        : IJsonElement<MediaType>
    {
        ...
        {
            private static readonly JsonSchemaPathProvider HoistedAllOf1ExampleSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/example"u8, buffer, out written);

            private static readonly JsonSchemaPathProvider HoistedAllOf1ExamplesValueSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/examples"u8, buffer, out written);
            ...
            private static void MatchEncoding(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext =
                    Corvus.OpenapiBenchmark.Current.OpenapiSchema.MediaType.EncodingEntity.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.OpenapiBenchmark.Current.OpenapiSchema.MediaType.EncodingEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            private static void MatchSchemaValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                ...
                Corvus.OpenapiBenchmark.Current.OpenapiSchema.Schema.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/media-type"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/media-type";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/media-type"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                if (tokenType == JsonTokenType.StartObject)
                {
                    JsonSchemaContext hoistedAllOf1_context =
                        Corvus.OpenapiBenchmark.Current.OpenapiSchema.Examples.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: AllOf1SchemaEvaluationPath);
                        ...
                        if (objectValidation_unescapedPropertyName.Span.SequenceEqual("example"u8))
                        {
                            ...
                            JsonSchemaContext hoistedChildContext =
                                Corvus.Text.Json.JsonElement.JsonSchema.PushChildContextUnescaped(
                                    ...
                                    "example"u8,
                                    evaluationPath: HoistedAllOf1ExampleSchemaEvaluationPath);
                        ...
                        else if (objectValidation_unescapedPropertyName.Span.SequenceEqual("examples"u8))
                        {
                            ...
                            JsonSchemaContext hoistedChildContext1 =
                                Corvus.OpenapiBenchmark.Current.OpenapiSchema.Examples.ExamplesEntity.JsonSchema.PushChildContextUnescaped(
                                    ...
                                    ref hoistedAllOf1_context,
                                    "examples"u8,
                                    evaluationPath: HoistedAllOf1ExamplesValueSchemaEvaluationPath);
