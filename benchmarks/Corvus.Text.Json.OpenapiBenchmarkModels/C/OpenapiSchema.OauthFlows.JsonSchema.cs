...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct OauthFlows
        : IJsonElement<OauthFlows>
    {
        public static partial class JsonSchema
        {
            private static readonly JsonSchemaPathProvider AuthorizationCodeSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/authorizationCode/$ref"u8, buffer, out written);
            private static readonly JsonSchemaPathProvider ClientCredentialsSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/clientCredentials/$ref"u8, buffer, out written);
            private static readonly JsonSchemaPathProvider ImplicitSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/implicit/$ref"u8, buffer, out written);
            private static readonly JsonSchemaPathProvider PasswordSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/password/$ref"u8, buffer, out written);

            private static void MatchAuthorizationCode(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext =
                    Corvus.OpenapiBenchmark.Current.OpenapiSchema.OauthFlows.RequiredAuthorizationUrlAndScopesAndTokenUrl.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.AuthorizationCodeUtf8,
                        evaluationPath: AuthorizationCodeSchemaEvaluationPath);

                Corvus.OpenapiBenchmark.Current.OpenapiSchema.OauthFlows.RequiredAuthorizationUrlAndScopesAndTokenUrl.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                context.CommitChildContext(childContext.IsMatch, ref childContext);
            }

            private static void MatchClientCredentials(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext1 =
                    Corvus.OpenapiBenchmark.Current.OpenapiSchema.OauthFlows.RequiredScopesAndTokenUrl.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.ClientCredentialsUtf8,
                        evaluationPath: ClientCredentialsSchemaEvaluationPath);

                Corvus.OpenapiBenchmark.Current.OpenapiSchema.OauthFlows.RequiredScopesAndTokenUrl.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                context.CommitChildContext(childContext1.IsMatch, ref childContext1);
            }

            private static void MatchImplicit(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext2 =
                    Corvus.OpenapiBenchmark.Current.OpenapiSchema.OauthFlows.RequiredAuthorizationUrlAndScopes.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.ImplicitUtf8,
                        evaluationPath: ImplicitSchemaEvaluationPath);

                Corvus.OpenapiBenchmark.Current.OpenapiSchema.OauthFlows.RequiredAuthorizationUrlAndScopes.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
                context.CommitChildContext(childContext2.IsMatch, ref childContext2);
            }

            private static void MatchPassword(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext3 =
                    Corvus.OpenapiBenchmark.Current.OpenapiSchema.OauthFlows.OauthFlowsRequiredScopesAndTokenUrl.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.OpenapiBenchmark.Current.OpenapiSchema.OauthFlows.OauthFlowsRequiredScopesAndTokenUrl.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext3);
            ...
            private static PropertySchemaMatchers<Corvus.OpenapiBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
            {
                return new PropertySchemaMatchers<Corvus.OpenapiBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator1>([
                    (static () => JsonPropertyNames.AuthorizationCodeUtf8, MatchAuthorizationCode),
                    (static () => JsonPropertyNames.ClientCredentialsUtf8, MatchClientCredentials),
                    (static () => JsonPropertyNames.ImplicitUtf8, MatchImplicit),
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/oauth-flows"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/oauth-flows";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/oauth-flows"u8;
