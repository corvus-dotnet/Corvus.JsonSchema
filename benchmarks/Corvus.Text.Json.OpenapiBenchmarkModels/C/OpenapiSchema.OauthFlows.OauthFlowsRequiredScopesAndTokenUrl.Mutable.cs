    ...
    public readonly partial struct OauthFlows
    {
        ...
        public readonly partial struct OauthFlowsRequiredScopesAndTokenUrl
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(OauthFlowsRequiredScopesAndTokenUrl instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="OauthFlowsRequiredScopesAndTokenUrl"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator OauthFlowsRequiredScopesAndTokenUrl(Mutable instance)
                {
                ...
                /// </summary>
                public Corvus.OpenapiBenchmark.Current.JsonUri.Mutable RefreshUrl
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RefreshUrlUtf8, out Corvus.OpenapiBenchmark.Current.JsonUri.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.OpenapiBenchmark.Current.OpenapiSchema.MapOfStrings.Mutable Scopes
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ScopesUtf8, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.MapOfStrings.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.OpenapiBenchmark.Current.JsonUri.Mutable TokenUrl
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TokenUrlUtf8, out Corvus.OpenapiBenchmark.Current.JsonUri.Mutable value))
                        {
                            return value;
                        }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new OauthFlowsRequiredScopesAndTokenUrl(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                public void SetRefreshUrl(scoped in Corvus.OpenapiBenchmark.Current.JsonUri.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetScopes(scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.MapOfStrings.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetScopes<TContext>(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.MapOfStrings.Source<TContext> value)
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetTokenUrl(scoped in Corvus.OpenapiBenchmark.Current.JsonUri.Source value)
                {
                    CheckValidInstance();
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"OauthFlowsRequiredScopesAndTokenUrl.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="OauthFlowsRequiredScopesAndTokenUrl"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="OauthFlowsRequiredScopesAndTokenUrl"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly OauthFlowsRequiredScopesAndTokenUrl Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<OauthFlowsRequiredScopesAndTokenUrl>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="OauthFlowsRequiredScopesAndTokenUrl"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly OauthFlowsRequiredScopesAndTokenUrl Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<OauthFlowsRequiredScopesAndTokenUrl>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.OpenapiBenchmark.Current.OpenapiSchema.MapOfStrings.Source _createArg1;
                private readonly Corvus.OpenapiBenchmark.Current.JsonUri.Source _createArg2;
                private readonly Corvus.OpenapiBenchmark.Current.JsonUri.Source _createArg3;
                ...
                internal Source(Corvus.OpenapiBenchmark.Current.OpenapiSchema.OauthFlows.OauthFlowsRequiredScopesAndTokenUrl.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.MapOfStrings.Source arg1, scoped in Corvus.OpenapiBenchmark.Current.JsonUri.Source arg2, scoped in Corvus.OpenapiBenchmark.Current.JsonUri.Source arg3)
                {
                    _createArg1 = arg1;
                    _createArg2 = arg2;
                    _createArg3 = arg3;
                ...
                public static implicit operator Source(OauthFlowsRequiredScopesAndTokenUrl instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                private readonly Corvus.OpenapiBenchmark.Current.OpenapiSchema.MapOfStrings.Source<TContext> _createArg1;
                private readonly Corvus.OpenapiBenchmark.Current.JsonUri.Source _createArg2;
                private readonly Corvus.OpenapiBenchmark.Current.JsonUri.Source _createArg3;
                ...
                internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Current.OpenapiSchema.OauthFlows.OauthFlowsRequiredScopesAndTokenUrl.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in TContext context, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.MapOfStrings.Source<TContext> arg1, scoped in Corvus.OpenapiBenchmark.Current.JsonUri.Source arg2, scoped in Corvus.OpenapiBenchmark.Current.JsonUri.Source arg3)
                {
                    _context = context;
                    _createArg1 = arg1;
                    _createArg2 = arg2;
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.OpenapiBenchmark.Current.OpenapiSchema.MapOfStrings.Source scopes,
                    in Corvus.OpenapiBenchmark.Current.JsonUri.Source tokenUrl,
                    in Corvus.OpenapiBenchmark.Current.JsonUri.Source refreshUrl = default)
                {
                ...
                public void Create(
                    ...
                    in Corvus.OpenapiBenchmark.Current.JsonUri.Source refreshUrl = default)
                {
                    Create(ref _builder, scopes, tokenUrl, refreshUrl);
                }
                ...
                internal static void Create<TContext>(
                    in TContext context,
                    ref ComplexValueBuilder builder,
                    in Corvus.OpenapiBenchmark.Current.OpenapiSchema.MapOfStrings.Source<TContext> scopes,
                    in Corvus.OpenapiBenchmark.Current.JsonUri.Source tokenUrl,
                    in Corvus.OpenapiBenchmark.Current.JsonUri.Source refreshUrl = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                ...
                #endif
                {
                    Create(context, ref _builder, scopes, tokenUrl, refreshUrl);
                }
                ...
                internal static void BuildCreateValue(scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.MapOfStrings.Source arg1, scoped in Corvus.OpenapiBenchmark.Current.JsonUri.Source arg2, scoped in Corvus.OpenapiBenchmark.Current.JsonUri.Source arg3, ref ComplexValueBuilder o)
                {
                    o.StartObject();
                ...
                /// <param name="arg3">The value of the property.</param>
                /// <param name="o">The complex value builder into which to write the object.</param>
                internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.MapOfStrings.Source<TContext> arg1, scoped in Corvus.OpenapiBenchmark.Current.JsonUri.Source arg2, scoped in Corvus.OpenapiBenchmark.Current.JsonUri.Source arg3, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.MapOfStrings.Source scopes, scoped in Corvus.OpenapiBenchmark.Current.JsonUri.Source tokenUrl, scoped in Corvus.OpenapiBenchmark.Current.JsonUri.Source refreshUrl = default)
            {
                return new Source(scopes, tokenUrl, refreshUrl);
            }
            ...
            /// <param name="refreshUrl">The value of the <c>"refreshUrl"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.MapOfStrings.Source<TContext> scopes, scoped in Corvus.OpenapiBenchmark.Current.JsonUri.Source tokenUrl, scoped in Corvus.OpenapiBenchmark.Current.JsonUri.Source refreshUrl = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                return new Source<TContext>(context, scopes, tokenUrl, refreshUrl);
            }
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.MapOfStrings.Source scopes, in Corvus.OpenapiBenchmark.Current.JsonUri.Source tokenUrl, in Corvus.OpenapiBenchmark.Current.JsonUri.Source refreshUrl = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(scopes, tokenUrl, refreshUrl);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.MapOfStrings.Source<TContext> scopes, in Corvus.OpenapiBenchmark.Current.JsonUri.Source tokenUrl, in Corvus.OpenapiBenchmark.Current.JsonUri.Source refreshUrl = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                ...
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(context, scopes, tokenUrl, refreshUrl);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<OauthFlowsRequiredScopesAndTokenUrl, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<OauthFlowsRequiredScopesAndTokenUrl> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<OauthFlowsRequiredScopesAndTokenUrl>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<OauthFlowsRequiredScopesAndTokenUrl> Create<TContext>(
            ...
            public static ParsedJsonDocument<OauthFlowsRequiredScopesAndTokenUrl> Create(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.MapOfStrings.Source scopes, in Corvus.OpenapiBenchmark.Current.JsonUri.Source tokenUrl, in Corvus.OpenapiBenchmark.Current.JsonUri.Source refreshUrl = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
            public static ParsedJsonDocument<OauthFlowsRequiredScopesAndTokenUrl> Create<TContext>(in TContext context, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.MapOfStrings.Source<TContext> scopes, in Corvus.OpenapiBenchmark.Current.JsonUri.Source tokenUrl, in Corvus.OpenapiBenchmark.Current.JsonUri.Source refreshUrl = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
