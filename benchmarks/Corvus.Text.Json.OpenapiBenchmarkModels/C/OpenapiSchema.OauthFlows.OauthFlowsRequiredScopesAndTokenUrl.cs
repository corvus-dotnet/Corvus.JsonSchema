...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct OauthFlows
    {
        ...
        public readonly partial struct OauthFlowsRequiredScopesAndTokenUrl
            ...
            : IJsonElement<OauthFlowsRequiredScopesAndTokenUrl>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            internal OauthFlowsRequiredScopesAndTokenUrl(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </para>
            /// </remarks>
            public Corvus.OpenapiBenchmark.Current.OpenapiSchema.MapOfStrings Scopes
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ScopesUtf8, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.MapOfStrings value))
                    {
                        return value;
                    }
            ...
            public static implicit operator Corvus.OpenapiBenchmark.Current.OpenapiSchema.SpecificationExtensions(OauthFlowsRequiredScopesAndTokenUrl value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator OauthFlowsRequiredScopesAndTokenUrl(Corvus.OpenapiBenchmark.Current.OpenapiSchema.SpecificationExtensions value)
            {
                return From(value);
            }
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in OauthFlowsRequiredScopesAndTokenUrl left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(OauthFlowsRequiredScopesAndTokenUrl instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator OauthFlowsRequiredScopesAndTokenUrl(JsonElement instance)
            {
                return OauthFlowsRequiredScopesAndTokenUrl.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OauthFlowsRequiredScopesAndTokenUrl From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OauthFlowsRequiredScopesAndTokenUrl ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OauthFlowsRequiredScopesAndTokenUrl>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OauthFlowsRequiredScopesAndTokenUrl ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OauthFlowsRequiredScopesAndTokenUrl>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OauthFlowsRequiredScopesAndTokenUrl ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OauthFlowsRequiredScopesAndTokenUrl>(json, options);
            }
            ...
            /// </exception>
            public static OauthFlowsRequiredScopesAndTokenUrl ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<OauthFlowsRequiredScopesAndTokenUrl>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out OauthFlowsRequiredScopesAndTokenUrl? result)
            {
                return JsonElementHelpers.TryParseValue<OauthFlowsRequiredScopesAndTokenUrl>(ref reader, out result);
            }
...
#if NET
            static OauthFlowsRequiredScopesAndTokenUrl IJsonElement<OauthFlowsRequiredScopesAndTokenUrl>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"OauthFlowsRequiredScopesAndTokenUrl: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public OauthFlowsRequiredScopesAndTokenUrl Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public OauthFlowsRequiredScopesAndTokenUrl Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<OauthFlowsRequiredScopesAndTokenUrl>(_idx);
                }
