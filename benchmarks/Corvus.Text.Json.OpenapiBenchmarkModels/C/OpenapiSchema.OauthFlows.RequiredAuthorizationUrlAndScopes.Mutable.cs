    ...
    public readonly partial struct OauthFlows
    {
        ...
        public readonly partial struct RequiredAuthorizationUrlAndScopes
        {
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.OpenapiBenchmark.Current.OpenapiSchema.OauthFlows.RequiredAuthorizationUrlAndScopes.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in Corvus.OpenapiBenchmark.Current.JsonUri.Source arg1, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.MapOfStrings.Source arg2, scoped in Corvus.OpenapiBenchmark.Current.JsonUri.Source arg3)
                {
                    _createArg1 = arg1;
                    _createArg2 = arg2;
                    _createArg3 = arg3;
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Current.OpenapiSchema.OauthFlows.RequiredAuthorizationUrlAndScopes.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in TContext context, scoped in Corvus.OpenapiBenchmark.Current.JsonUri.Source arg1, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.MapOfStrings.Source<TContext> arg2, scoped in Corvus.OpenapiBenchmark.Current.JsonUri.Source arg3)
                {
                    _context = context;
                    _createArg1 = arg1;
                    _createArg2 = arg2;
            ...
            public ref struct Builder
            {
                ...
                public void Create(
                    ...
                    in Corvus.OpenapiBenchmark.Current.JsonUri.Source refreshUrl = default)
                {
                    Create(ref _builder, authorizationUrl, scopes, refreshUrl);
                }
                ...
                #endif
                {
                    Create(context, ref _builder, authorizationUrl, scopes, refreshUrl);
                }
                ...
                internal static void BuildCreateValue(scoped in Corvus.OpenapiBenchmark.Current.JsonUri.Source arg1, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.MapOfStrings.Source arg2, scoped in Corvus.OpenapiBenchmark.Current.JsonUri.Source arg3, ref ComplexValueBuilder o)
                {
                    o.StartObject();
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.OpenapiBenchmark.Current.JsonUri.Source authorizationUrl, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.MapOfStrings.Source scopes, scoped in Corvus.OpenapiBenchmark.Current.JsonUri.Source refreshUrl = default)
            {
                return new Source(authorizationUrl, scopes, refreshUrl);
            }
                ...
                #endif
            {
                ...
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(context, authorizationUrl, scopes, refreshUrl);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            public static ParsedJsonDocument<RequiredAuthorizationUrlAndScopes> Create(in Corvus.OpenapiBenchmark.Current.JsonUri.Source authorizationUrl, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.MapOfStrings.Source scopes, in Corvus.OpenapiBenchmark.Current.JsonUri.Source refreshUrl = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RequiredAuthorizationUrlAndScopes> Create<TContext>(in TContext context, in Corvus.OpenapiBenchmark.Current.JsonUri.Source authorizationUrl, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.MapOfStrings.Source<TContext> scopes, in Corvus.OpenapiBenchmark.Current.JsonUri.Source refreshUrl = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
