...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct OauthFlows
    {
...
#endif
        {
            ...
            public static implicit operator Corvus.OpenapiBenchmark.Current.OpenapiSchema.SpecificationExtensions(RequiredAuthorizationUrlAndScopes value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator RequiredAuthorizationUrlAndScopes(Corvus.OpenapiBenchmark.Current.OpenapiSchema.SpecificationExtensions value)
            {
                return From(value);
            }
