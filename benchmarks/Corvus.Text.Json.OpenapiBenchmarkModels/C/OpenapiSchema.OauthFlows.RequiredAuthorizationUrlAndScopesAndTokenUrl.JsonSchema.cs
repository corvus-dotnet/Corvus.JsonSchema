            ...
            public static partial class JsonSchema
            {
                ...
                private static void MatchScopes(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    ...
                    JsonSchemaContext childContext2 =
                        Corvus.OpenapiBenchmark.Current.OpenapiSchema.MapOfStrings.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Corvus.OpenapiBenchmark.Current.OpenapiSchema.MapOfStrings.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
                ...
                private static void MatchTokenUrl(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    ...
                    Corvus.OpenapiBenchmark.Current.JsonUriNotAsserted.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext3);
                ...
                private static PropertySchemaMatchers<Corvus.OpenapiBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
                {
                    return new PropertySchemaMatchers<Corvus.OpenapiBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator>([
                ...
                private static PropertySchemaMatchers<Corvus.OpenapiBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator> Matchers { get; } = MatchersBuilder();

                private static bool TryGetNamedMatcher(ReadOnlySpan<byte> span,
#if NET
                [NotNullWhen(true)]
#endif
                out Corvus.OpenapiBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator? matcher)
                {
