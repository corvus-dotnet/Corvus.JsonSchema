...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct OauthFlows
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.OpenapiBenchmark.Current.JsonUriNotAsserted AuthorizationUrl
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AuthorizationUrlUtf8, out Corvus.OpenapiBenchmark.Current.JsonUriNotAsserted value))
                    {
                        return value;
                    }
            ...
            public static implicit operator Corvus.OpenapiBenchmark.Current.OpenapiSchema.SpecificationExtensions(RequiredAuthorizationUrlAndScopesAndTokenUrl value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator RequiredAuthorizationUrlAndScopesAndTokenUrl(Corvus.OpenapiBenchmark.Current.OpenapiSchema.SpecificationExtensions value)
            {
                return From(value);
            }
