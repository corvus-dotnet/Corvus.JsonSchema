    ...
    public readonly partial struct OauthFlows
    {
            ...
            : IJsonElement<RequiredScopesAndTokenUrl>
        {
            public static partial class JsonSchema
            {
                ...
                private const uint RequiredBitForScopes = 0b00000000000000000000000000000001;
                ...
                private const uint RequiredBitForTokenUrl = 0b00000000000000000000000000000010;

                private const uint RequiredBitMask0 =
                    RequiredBitForScopes | RequiredBitForTokenUrl;
                ...
                private static void MatchScopes(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    ...
                    Corvus.OpenapiBenchmark.Current.OpenapiSchema.MapOfStrings.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/oauth-flows/$defs/client-credentials"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/oauth-flows/$defs/client-credentials";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/oauth-flows/$defs/client-credentials"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.StartObject)
                    {
                        ...
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyScopesPresent, "scopes"u8, "required"u8);
                            context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyTokenUrlPresent, "tokenUrl"u8, "required"u8);
                        }
                        ...
                        else
                        {
                            ...
                            {
                                context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyScopesNotPresent, "scopes"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyScopesPresent, "scopes"u8, "required"u8);
                            ...
                            {
                                context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyTokenUrlNotPresent, "tokenUrl"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyTokenUrlPresent, "tokenUrl"u8, "required"u8);
