    ...
    public readonly partial struct OauthFlows
    {
        ...
        public readonly partial struct RequiredScopesAndTokenUrl
        {
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.OpenapiBenchmark.Current.OpenapiSchema.OauthFlows.RequiredScopesAndTokenUrl.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Current.OpenapiSchema.OauthFlows.RequiredScopesAndTokenUrl.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public static ParsedJsonDocument<RequiredScopesAndTokenUrl> Create(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.MapOfStrings.Source scopes, in Corvus.OpenapiBenchmark.Current.JsonUri.Source tokenUrl, in Corvus.OpenapiBenchmark.Current.JsonUri.Source refreshUrl = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RequiredScopesAndTokenUrl> Create<TContext>(in TContext context, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.MapOfStrings.Source<TContext> scopes, in Corvus.OpenapiBenchmark.Current.JsonUri.Source tokenUrl, in Corvus.OpenapiBenchmark.Current.JsonUri.Source refreshUrl = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
