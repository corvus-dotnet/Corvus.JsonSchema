...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct OauthFlows
    {
...
#endif
        {
            ...
            public static implicit operator Corvus.OpenapiBenchmark.Current.OpenapiSchema.SpecificationExtensions(RequiredScopesAndTokenUrl value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator RequiredScopesAndTokenUrl(Corvus.OpenapiBenchmark.Current.OpenapiSchema.SpecificationExtensions value)
            {
                return From(value);
            }
