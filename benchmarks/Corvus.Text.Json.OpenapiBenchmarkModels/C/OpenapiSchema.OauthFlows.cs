...
public readonly partial struct OpenapiSchema
{
...
#endif
    {
        ...
        /// </summary>
        public Corvus.OpenapiBenchmark.Current.OpenapiSchema.OauthFlows.RequiredAuthorizationUrlAndScopesAndTokenUrl AuthorizationCode
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AuthorizationCodeUtf8, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.OauthFlows.RequiredAuthorizationUrlAndScopesAndTokenUrl value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.OpenapiBenchmark.Current.OpenapiSchema.OauthFlows.RequiredScopesAndTokenUrl ClientCredentials
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ClientCredentialsUtf8, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.OauthFlows.RequiredScopesAndTokenUrl value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.OpenapiBenchmark.Current.OpenapiSchema.OauthFlows.RequiredAuthorizationUrlAndScopes Implicit
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ImplicitUtf8, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.OauthFlows.RequiredAuthorizationUrlAndScopes value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.OpenapiBenchmark.Current.OpenapiSchema.OauthFlows.OauthFlowsRequiredScopesAndTokenUrl Password
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PasswordUtf8, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.OauthFlows.OauthFlowsRequiredScopesAndTokenUrl value))
                {
                    return value;
                }
        ...
        public static implicit operator Corvus.OpenapiBenchmark.Current.OpenapiSchema.SpecificationExtensions(OauthFlows value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator OauthFlows(Corvus.OpenapiBenchmark.Current.OpenapiSchema.SpecificationExtensions value)
        {
            return From(value);
        }
