...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct OpenapiSchemaContentEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(OpenapiSchemaContentEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="OpenapiSchemaContentEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator OpenapiSchemaContentEntity(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new OpenapiSchemaContentEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"OpenapiSchemaContentEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="OpenapiSchemaContentEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="OpenapiSchemaContentEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly OpenapiSchemaContentEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<OpenapiSchemaContentEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="OpenapiSchemaContentEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly OpenapiSchemaContentEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<OpenapiSchemaContentEntity>(_idx);
            }

            /// <summary>
            /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.Content.Mutable" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsContent(out Corvus.OpenapiBenchmark.Current.OpenapiSchema.Content.Mutable result)
            {
                if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.Content.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.OpenapiBenchmark.Current.OpenapiSchema.Content.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.OpenapiBenchmark.Current.OpenapiSchema.OpenapiSchemaContentEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(OpenapiSchemaContentEntity instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Current.OpenapiSchema.OpenapiSchemaContentEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<OpenapiSchemaContentEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<OpenapiSchemaContentEntity> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<OpenapiSchemaContentEntity>();
            }
            finally
            {
