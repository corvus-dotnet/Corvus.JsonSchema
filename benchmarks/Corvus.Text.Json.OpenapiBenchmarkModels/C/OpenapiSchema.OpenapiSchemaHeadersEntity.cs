...
public readonly partial struct OpenapiSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OpenapiSchemaHeadersEntity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal OpenapiSchemaHeadersEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static OpenapiSchemaHeadersEntity DefaultInstance { get; }
        ...
        /// </returns>
        public static bool operator ==(in OpenapiSchemaHeadersEntity left, in OpenapiSchemaHeadersEntity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in OpenapiSchemaHeadersEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(OpenapiSchemaHeadersEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator OpenapiSchemaHeadersEntity(JsonElement instance)
        {
            return OpenapiSchemaHeadersEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static OpenapiSchemaHeadersEntity From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static OpenapiSchemaHeadersEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<OpenapiSchemaHeadersEntity>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static OpenapiSchemaHeadersEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<OpenapiSchemaHeadersEntity>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static OpenapiSchemaHeadersEntity ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<OpenapiSchemaHeadersEntity>(json, options);
        }
        ...
        /// </exception>
        public static OpenapiSchemaHeadersEntity ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<OpenapiSchemaHeadersEntity>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out OpenapiSchemaHeadersEntity? result)
        {
            return JsonElementHelpers.TryParseValue<OpenapiSchemaHeadersEntity>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new OpenapiSchemaHeadersEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static OpenapiSchemaHeadersEntity IJsonElement<OpenapiSchemaHeadersEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"OpenapiSchemaHeadersEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="OpenapiSchemaHeadersEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="OpenapiSchemaHeadersEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public OpenapiSchemaHeadersEntity Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<OpenapiSchemaHeadersEntity>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="OpenapiSchemaHeadersEntity"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public OpenapiSchemaHeadersEntity Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<OpenapiSchemaHeadersEntity>(_idx);
            }
