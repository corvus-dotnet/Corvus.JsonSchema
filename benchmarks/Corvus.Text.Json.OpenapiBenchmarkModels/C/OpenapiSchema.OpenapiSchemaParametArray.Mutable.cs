...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct OpenapiSchemaParametArray
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(OpenapiSchemaParametArray instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="OpenapiSchemaParametArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator OpenapiSchemaParametArray(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new OpenapiSchemaParametArray(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"OpenapiSchemaParametArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// <summary>
            /// Gets a <see cref="OpenapiSchemaParametArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="OpenapiSchemaParametArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly OpenapiSchemaParametArray Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<OpenapiSchemaParametArray>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="OpenapiSchemaParametArray"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly OpenapiSchemaParametArray Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<OpenapiSchemaParametArray>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.OpenapiBenchmark.Current.OpenapiSchema.OpenapiSchemaParametArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(OpenapiSchemaParametArray instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Current.OpenapiSchema.OpenapiSchemaParametArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<OpenapiSchemaParametArray, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<OpenapiSchemaParametArray> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<OpenapiSchemaParametArray>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<OpenapiSchemaParametArray> Create<TContext>(
