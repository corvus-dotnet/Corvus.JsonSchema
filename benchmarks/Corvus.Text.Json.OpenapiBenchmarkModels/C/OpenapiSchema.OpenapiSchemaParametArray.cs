...
public readonly partial struct OpenapiSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OpenapiSchemaParametArray"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal OpenapiSchemaParametArray(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static OpenapiSchemaParametArray DefaultInstance { get; }
        ...
        /// </returns>
        public static bool operator ==(in OpenapiSchemaParametArray left, in OpenapiSchemaParametArray right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in OpenapiSchemaParametArray left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(OpenapiSchemaParametArray instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator OpenapiSchemaParametArray(JsonElement instance)
        {
            return OpenapiSchemaParametArray.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static OpenapiSchemaParametArray From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static OpenapiSchemaParametArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<OpenapiSchemaParametArray>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static OpenapiSchemaParametArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<OpenapiSchemaParametArray>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static OpenapiSchemaParametArray ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<OpenapiSchemaParametArray>(json, options);
        }
        ...
        /// </exception>
        public static OpenapiSchemaParametArray ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<OpenapiSchemaParametArray>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out OpenapiSchemaParametArray? result)
        {
            return JsonElementHelpers.TryParseValue<OpenapiSchemaParametArray>(ref reader, out result);
        }
...
#if NET
        static OpenapiSchemaParametArray IJsonElement<OpenapiSchemaParametArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"OpenapiSchemaParametArray: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public OpenapiSchemaParametArray Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public OpenapiSchemaParametArray Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<OpenapiSchemaParametArray>(_idx);
            }
