    ...
    public readonly partial struct Operation
    {
        ...
        public readonly partial struct ParameterOrReferenceArray
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ParameterOrReferenceArray instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ParameterOrReferenceArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ParameterOrReferenceArray(Mutable instance)
                {
                ...
                public Corvus.OpenapiBenchmark.Current.OpenapiSchema.ParameterOrReference.Mutable this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.OpenapiBenchmark.Current.OpenapiSchema.ParameterOrReference.Mutable>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.OpenapiBenchmark.Current.OpenapiSchema.ParameterOrReference.Mutable> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.OpenapiBenchmark.Current.OpenapiSchema.ParameterOrReference.Mutable>(_parent, _idx);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ParameterOrReferenceArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ParameterOrReferenceArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetItem(int itemIndex, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.ParameterOrReference.Source value)
                {
                    CheckValidInstance();
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void InsertItem(int itemIndex, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.ParameterOrReference.Source value)
                {
                    CheckValidInstance();
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void AddItem(scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.ParameterOrReference.Source value)
                {
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Remove(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.ParameterOrReference item)
                {
                    CheckValidInstance();
                    if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.OpenapiBenchmark.Current.OpenapiSchema.ParameterOrReference>(this, in item))
                    {
                        return false;
                    }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void RemoveWhere(JsonPredicate<Corvus.OpenapiBenchmark.Current.OpenapiSchema.ParameterOrReference> predicate)
                {
                    CheckValidInstance();
                    JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.OpenapiBenchmark.Current.OpenapiSchema.ParameterOrReference>(this, predicate);
                    _documentVersion = _parent.Version;
                }
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Replace(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.ParameterOrReference oldItem, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.ParameterOrReference.Source newItem)
                {
                    CheckValidInstance();
                    ...
                    var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.OpenapiBenchmark.Current.OpenapiSchema.ParameterOrReference>(_parent, _idx);

                    while (enumerator.MoveNext())
                    {
                        Corvus.OpenapiBenchmark.Current.OpenapiSchema.ParameterOrReference current = enumerator.Current;
                ...
                /// <summary>
                /// Gets a <see cref="ParameterOrReferenceArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ParameterOrReferenceArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ParameterOrReferenceArray Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ParameterOrReferenceArray>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ParameterOrReferenceArray"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ParameterOrReferenceArray Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ParameterOrReferenceArray>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.OpenapiBenchmark.Current.OpenapiSchema.Operation.ParameterOrReferenceArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(ParameterOrReferenceArray instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Current.OpenapiSchema.Operation.ParameterOrReferenceArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// </summary>
                public void AddItem(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.ParameterOrReference.Source value)
                {
                ...
                /// Add an item to the array.
                /// </summary>
                public void AddItem<TContext>(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.ParameterOrReference.Source<TContext> value)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
            ...
            {
                return workspace.CreateBuilder<ParameterOrReferenceArray, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ParameterOrReferenceArray> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ParameterOrReferenceArray>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<ParameterOrReferenceArray> Create<TContext>(
