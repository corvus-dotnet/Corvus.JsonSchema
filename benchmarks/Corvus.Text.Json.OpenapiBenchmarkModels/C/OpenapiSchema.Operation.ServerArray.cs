...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct Operation
    {
...
#endif
        {
            ...
            public Corvus.OpenapiBenchmark.Current.OpenapiSchema.Server this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.OpenapiBenchmark.Current.OpenapiSchema.Server>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.OpenapiBenchmark.Current.OpenapiSchema.Server> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.OpenapiBenchmark.Current.OpenapiSchema.Server>(_parent, _idx);
            }
