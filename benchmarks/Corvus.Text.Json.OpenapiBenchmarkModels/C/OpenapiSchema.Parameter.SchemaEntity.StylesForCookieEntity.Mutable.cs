        ...
        public readonly partial struct SchemaEntity
        {
            ...
            public readonly partial struct StylesForCookieEntity
            {
...
#endif
                {
                    ...
                    /// <summary>
                    /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForCookieEntity.RequiredIn" />.
                    /// </summary>
                    /// <param name="result">The result of the conversions.</param>
                    /// <returns><see langword="true" /> if the conversion was valid.</returns>
                    public bool TryGetAsRequiredIn(out Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForCookieEntity.RequiredIn result)
                    {
                        if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForCookieEntity.RequiredIn.JsonSchema.Evaluate(_parent, _idx))
                        {
                    ...
                    /// <summary>
                    /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForCookieEntity.WithStyleForm" />.
                    /// </summary>
                    /// <param name="result">The result of the conversions.</param>
                    /// <returns><see langword="true" /> if the conversion was valid.</returns>
                    public bool TryGetAsWithStyleForm(out Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForCookieEntity.WithStyleForm result)
                    {
