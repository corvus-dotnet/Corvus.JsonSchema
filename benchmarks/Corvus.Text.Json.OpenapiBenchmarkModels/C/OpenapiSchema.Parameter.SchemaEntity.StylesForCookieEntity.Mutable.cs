        ...
        public readonly partial struct SchemaEntity
        {
            ...
            public readonly partial struct StylesForCookieEntity
            {
...
#endif
                {
                    ...
                    public void SetStyle(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForCookieEntity.WithStyleForm.StyleEntity.Source value)
                    {
                        CheckValidInstance();
                ...
                public ref struct Source
                {
                    ...
                    internal Source(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForCookieEntity.WithStyleForm.StyleEntity.Source arg1)
                    {
                        _createArg1 = arg1;
                        _kind = Kind.Create;
                    }
                ...
                public ref struct Builder
                {
                    ...
                    internal static void BuildCreateValue(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForCookieEntity.WithStyleForm.StyleEntity.Source arg1, ref ComplexValueBuilder o)
                    {
                        o.StartObject();
                        Create(ref o, arg1);
                        o.EndObject();
                ...
                /// <returns>The source from which to build the value.</returns>
                public static Source Build(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForCookieEntity.WithStyleForm.StyleEntity.Source style = default)
                {
