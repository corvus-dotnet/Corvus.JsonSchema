        ...
        public readonly partial struct SchemaEntity
        {
            ...
            public readonly partial struct StylesForCookieEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(StylesForCookieEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="StylesForCookieEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator StylesForCookieEntity(Mutable instance)
                    {
                    ...
                    /// </summary>
                    public Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForCookieEntity.WithStyleForm.StyleEntity.Mutable Style
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StyleUtf8, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForCookieEntity.WithStyleForm.StyleEntity.Mutable value))
                            {
                                return value;
                            }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new StylesForCookieEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    public void SetStyle(scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForCookieEntity.WithStyleForm.StyleEntity.Source value)
                    {
                        CheckValidInstance();
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"StylesForCookieEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="StylesForCookieEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="StylesForCookieEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly StylesForCookieEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<StylesForCookieEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="StylesForCookieEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly StylesForCookieEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<StylesForCookieEntity>(_idx);
                    }
                    ...
                    /// <param name="matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaParameterSchemaEntityStylesForCookieEntityWithStyleForm">Match a <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForCookieEntity.WithStyleForm"/>.</param>
                    ...
                    public TResult Match<TContext, TResult>(
                        in TContext context,
                        Matcher<Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForCookieEntity.WithStyleForm, TContext, TResult> matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaParameterSchemaEntityStylesForCookieEntityWithStyleForm,
                        Matcher<StylesForCookieEntity, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                    {
                        if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForCookieEntity.RequiredIn.JsonSchema.Evaluate(_parent, _idx))
                        {
                            return matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaParameterSchemaEntityStylesForCookieEntityWithStyleForm(Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForCookieEntity.WithStyleForm.From(this), context);
                        }
                    ...
                    public TResult Match<TResult>(
                        Matcher<Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForCookieEntity.WithStyleForm, TResult> matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaParameterSchemaEntityStylesForCookieEntityWithStyleForm,
                        Matcher<StylesForCookieEntity, TResult> defaultMatch)
                    {
                        if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForCookieEntity.RequiredIn.JsonSchema.Evaluate(_parent, _idx))
                        {
                            return matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaParameterSchemaEntityStylesForCookieEntityWithStyleForm(Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForCookieEntity.WithStyleForm.From(this));
                        }
                    ...
                    /// <summary>
                    /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForCookieEntity.RequiredIn.Mutable" />.
                    /// </summary>
                    /// <param name="result">The result of the conversions.</param>
                    /// <returns><see langword="true" /> if the conversion was valid.</returns>
                    public bool TryGetAsRequiredIn(out Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForCookieEntity.RequiredIn.Mutable result)
                    {
                        if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForCookieEntity.RequiredIn.JsonSchema.Evaluate(_parent, _idx))
                        {
                            result = Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForCookieEntity.RequiredIn.Mutable.From(this);
                            return true;
                        }
                    ...
                    /// <summary>
                    /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForCookieEntity.WithStyleForm.Mutable" />.
                    /// </summary>
                    /// <param name="result">The result of the conversions.</param>
                    /// <returns><see langword="true" /> if the conversion was valid.</returns>
                    public bool TryGetAsWithStyleForm(out Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForCookieEntity.WithStyleForm.Mutable result)
                    {
                        if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForCookieEntity.WithStyleForm.JsonSchema.Evaluate(_parent, _idx))
                        {
                            result = Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForCookieEntity.WithStyleForm.Mutable.From(this);
                            return true;
                        }
                ...
                public ref struct Source
                {
                    ...
                    private readonly Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForCookieEntity.WithStyleForm.StyleEntity.Source _createArg1;
                    ...
                    internal Source(Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForCookieEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    internal Source(scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForCookieEntity.WithStyleForm.StyleEntity.Source arg1)
                    {
                        _createArg1 = arg1;
                        _kind = Kind.Create;
                    }

                    public static implicit operator Source(StylesForCookieEntity instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForCookieEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// </summary>
                    internal static void Create(ref ComplexValueBuilder builder, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForCookieEntity.WithStyleForm.StyleEntity.Source style = default)
                    {
                    ...
                    /// Creates an instance of a <see cref="StylesForCookieEntity"/>.
                    /// </summary>
                    public void Create(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForCookieEntity.WithStyleForm.StyleEntity.Source style = default)
                    {
                        Create(ref _builder, style);
                    }
                    ...
                    internal static void BuildCreateValue(scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForCookieEntity.WithStyleForm.StyleEntity.Source arg1, ref ComplexValueBuilder o)
                    {
                        o.StartObject();
                        Create(ref o, arg1);
                        o.EndObject();
                ...
                /// <returns>The source from which to build the value.</returns>
                public static Source Build(scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForCookieEntity.WithStyleForm.StyleEntity.Source style = default)
                {
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForCookieEntity.WithStyleForm.StyleEntity.Source style = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                ...
                {
                    return workspace.CreateBuilder<StylesForCookieEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<StylesForCookieEntity> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<StylesForCookieEntity>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<StylesForCookieEntity> Create<TContext>(
                ...
                public static ParsedJsonDocument<StylesForCookieEntity> Create(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForCookieEntity.WithStyleForm.StyleEntity.Source style = default, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
