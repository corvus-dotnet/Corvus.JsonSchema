        ...
        public readonly partial struct SchemaEntity
        {
            ...
            public readonly partial struct StylesForHeaderEntity
            {
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="WithStyleSimple"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal WithStyleSimple(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static WithStyleSimple DefaultInstance { get; }
                    ...
                    /// </returns>
                    public static bool operator ==(in WithStyleSimple left, in WithStyleSimple right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in WithStyleSimple left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    public static implicit operator JsonElement(WithStyleSimple instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator WithStyleSimple(JsonElement instance)
                    {
                        return WithStyleSimple.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static WithStyleSimple From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static WithStyleSimple ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<WithStyleSimple>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static WithStyleSimple ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<WithStyleSimple>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static WithStyleSimple ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<WithStyleSimple>(json, options);
                    }
                    ...
                    /// </exception>
                    public static WithStyleSimple ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<WithStyleSimple>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out WithStyleSimple? result)
                    {
                        return JsonElementHelpers.TryParseValue<WithStyleSimple>(ref reader, out result);
                    }
...
#if NET
                    static WithStyleSimple IJsonElement<WithStyleSimple>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"WithStyleSimple: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public WithStyleSimple Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<WithStyleSimple>(_idx);
                        }
