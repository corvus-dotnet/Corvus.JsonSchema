    ...
    public readonly partial struct Parameter
    {
        ...
        public readonly partial struct SchemaEntity
        {
            ...
            public readonly partial struct StylesForHeaderEntity
                ...
                : IJsonElement<StylesForHeaderEntity>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                internal StylesForHeaderEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static StylesForHeaderEntity DefaultInstance { get; }
                ...
                /// </summary>
                public Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForHeaderEntity.WithStyleSimple.StyleEntity Style
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StyleUtf8, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForHeaderEntity.WithStyleSimple.StyleEntity value))
                        {
                            return value;
                        }

                        return Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForHeaderEntity.WithStyleSimple.StyleEntity.DefaultInstance;
                    }
                }
                ...
                /// </returns>
                public static bool operator ==(in StylesForHeaderEntity left, in StylesForHeaderEntity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in StylesForHeaderEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(StylesForHeaderEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator StylesForHeaderEntity(JsonElement instance)
                {
                    return StylesForHeaderEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static StylesForHeaderEntity From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static StylesForHeaderEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<StylesForHeaderEntity>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static StylesForHeaderEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<StylesForHeaderEntity>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static StylesForHeaderEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<StylesForHeaderEntity>(json, options);
                }
                ...
                /// </exception>
                public static StylesForHeaderEntity ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<StylesForHeaderEntity>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out StylesForHeaderEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<StylesForHeaderEntity>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new StylesForHeaderEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static StylesForHeaderEntity IJsonElement<StylesForHeaderEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"StylesForHeaderEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="StylesForHeaderEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="StylesForHeaderEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public StylesForHeaderEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<StylesForHeaderEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="StylesForHeaderEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public StylesForHeaderEntity Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<StylesForHeaderEntity>(_idx);
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForHeaderEntity.RequiredIn" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsRequiredIn(out Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForHeaderEntity.RequiredIn result)
                {
                    if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForHeaderEntity.RequiredIn.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForHeaderEntity.RequiredIn.From(this);
                        return true;
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForHeaderEntity.WithStyleSimple" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsWithStyleSimple(out Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForHeaderEntity.WithStyleSimple result)
                {
                    if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForHeaderEntity.WithStyleSimple.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForHeaderEntity.WithStyleSimple.From(this);
                        return true;
                    }
                ...
                /// <param name="matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaParameterSchemaEntityStylesForHeaderEntityWithStyleSimple">Match a <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForHeaderEntity.WithStyleSimple"/>.</param>
                ...
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Matcher<Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForHeaderEntity.WithStyleSimple, TContext, TResult> matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaParameterSchemaEntityStylesForHeaderEntityWithStyleSimple,
                    Matcher<StylesForHeaderEntity, TContext, TResult> defaultMatch)
...
#endif
                {
                    if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForHeaderEntity.RequiredIn.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaParameterSchemaEntityStylesForHeaderEntityWithStyleSimple(Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForHeaderEntity.WithStyleSimple.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    Matcher<Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForHeaderEntity.WithStyleSimple, TResult> matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaParameterSchemaEntityStylesForHeaderEntityWithStyleSimple,
                    Matcher<StylesForHeaderEntity, TResult> defaultMatch)
                {
                    if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForHeaderEntity.RequiredIn.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaParameterSchemaEntityStylesForHeaderEntityWithStyleSimple(Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForHeaderEntity.WithStyleSimple.From(this));
                    }
