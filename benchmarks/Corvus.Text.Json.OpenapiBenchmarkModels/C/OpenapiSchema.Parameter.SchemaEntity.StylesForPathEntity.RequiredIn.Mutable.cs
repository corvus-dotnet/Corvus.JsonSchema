            ...
            public readonly partial struct StylesForPathEntity
            {
                ...
                public readonly partial struct RequiredIn
                {
...
#endif
                    {
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForPathEntity.RequiredIn.InEntity.Mutable In
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.InUtf8, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForPathEntity.RequiredIn.InEntity.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        public void SetIn(scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForPathEntity.RequiredIn.InEntity.Source value)
                        {
                            CheckValidInstance();
                    ...
                    public ref struct Source
                    {
                        ...
                        internal Source(Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForPathEntity.RequiredIn.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForPathEntity.RequiredIn.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    public ref struct Builder
                    {
                        ...
                        {
                            builder.AddPrebakedProperty(JsonPropertyNamesPrebaked.In, Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForPathEntity.RequiredIn.InEntity.ConstInstance);
                        }
