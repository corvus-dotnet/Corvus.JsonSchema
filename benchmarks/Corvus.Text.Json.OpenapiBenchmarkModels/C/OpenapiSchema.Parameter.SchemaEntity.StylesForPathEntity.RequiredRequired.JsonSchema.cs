            ...
            public readonly partial struct StylesForPathEntity
            {
                    ...
                    : IJsonElement<RequiredRequired>
                {
                    public static partial class JsonSchema
                    {
                        ...
                        /// </summary>
                        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/parameter/dependentSchemas/schema/$defs/styles-for-path/then"u8, buffer, out written);

                        /// <summary>
                        /// Gets the schema location from which this type was generated.
                        /// </summary>
                        public const string SchemaLocation = "/$defs/parameter/dependentSchemas/schema/$defs/styles-for-path/then";

                        /// <summary>
                        /// Gets the schema location from which this type was generated as a UTF-8 string.
                        /// </summary>
                        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/parameter/dependentSchemas/schema/$defs/styles-for-path/then"u8;
