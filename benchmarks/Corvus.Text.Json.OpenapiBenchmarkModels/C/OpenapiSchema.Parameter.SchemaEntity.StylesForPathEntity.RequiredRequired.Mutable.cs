            ...
            public readonly partial struct StylesForPathEntity
            {
                ...
                public readonly partial struct RequiredRequired
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(RequiredRequired instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="RequiredRequired"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator RequiredRequired(Mutable instance)
                        {
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForPathEntity.RequiredRequired.RequiredEntity.Mutable Required
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RequiredUtf8, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForPathEntity.RequiredRequired.RequiredEntity.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        /// </summary>
                        public Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForPathEntity.RequiredRequired.StyleEntity.Mutable Style
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StyleUtf8, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForPathEntity.RequiredRequired.StyleEntity.Mutable value))
                                {
                                    return value;
                                }

                                return Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForPathEntity.RequiredRequired.StyleEntity.Mutable.DefaultInstance;
                            }
                        }
                        ...
                        {
                            return
                                (obj is IJsonElement value && Equals(new RequiredRequired(value.ParentDocument, value.ParentDocumentIndex))) ||
                        ...
                        public void SetRequired(scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForPathEntity.RequiredRequired.RequiredEntity.Source value)
                        {
                            ...
                            {
                                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("required");
                            }
                        ...
                        /// </summary>
                        /// <param name="value">The value of the property to add.</param>
                        public void SetStyle(scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForPathEntity.RequiredRequired.StyleEntity.Source value)
                        {
                            CheckValidInstance();
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"RequiredRequired.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// <summary>
                        /// Gets a <see cref="RequiredRequired"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </summary>
                        /// <returns>
                        /// A <see cref="RequiredRequired"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </returns>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RequiredRequired Clone()
                        {
                            CheckValidInstance();
                            return _parent.CloneElement<RequiredRequired>(_idx);
                        }
                        ...
                        /// </summary>
                        /// <returns>
                        /// An immutable <see cref="RequiredRequired"/> that lives for the lifetime of its
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RequiredRequired Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<RequiredRequired>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        private readonly Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForPathEntity.RequiredRequired.StyleEntity.Source _createArg1;
                        ...
                        internal Source(Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForPathEntity.RequiredRequired.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                        internal Source(scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForPathEntity.RequiredRequired.StyleEntity.Source arg1)
                        {
                            _createArg1 = arg1;
                            _kind = Kind.Create;
                        }

                        public static implicit operator Source(RequiredRequired instance) => new(JsonElement.From(instance));
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForPathEntity.RequiredRequired.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    public ref struct Builder
                    {
                        ...
                        /// </summary>
                        internal static void Create(ref ComplexValueBuilder builder, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForPathEntity.RequiredRequired.StyleEntity.Source style = default)
                        {
                            builder.AddPrebakedProperty(JsonPropertyNamesPrebaked.Required, Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForPathEntity.RequiredRequired.RequiredEntity.ConstInstance);
                        ...
                        /// Creates an instance of a <see cref="RequiredRequired"/>.
                        /// </summary>
                        public void Create(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForPathEntity.RequiredRequired.StyleEntity.Source style = default)
                        {
                        ...
                        internal static void BuildCreateValue(scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForPathEntity.RequiredRequired.StyleEntity.Source arg1, ref ComplexValueBuilder o)
                        {
                            o.StartObject();
                            Create(ref o, arg1);
                            o.EndObject();
                    ...
                    /// <returns>The source from which to build the value.</returns>
                    public static Source Build(scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForPathEntity.RequiredRequired.StyleEntity.Source style = default)
                    {
                    ...
                    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForPathEntity.RequiredRequired.StyleEntity.Source style = default, int initialCapacity = 30)
                    {
                        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                        cvb.StartObject();
                    ...
                    {
                        return workspace.CreateBuilder<RequiredRequired, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<RequiredRequired> Create(
                        scoped in Source value, int initialCapacity = 30)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<RequiredRequired>();
                        }
                        finally
                        {
                    ...
                    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                    public static ParsedJsonDocument<RequiredRequired> Create<TContext>(
                    ...
                    public static ParsedJsonDocument<RequiredRequired> Create(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Parameter.SchemaEntity.StylesForPathEntity.RequiredRequired.StyleEntity.Source style = default, int initialCapacity = 30)
                    {
                        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                        try
                        {
