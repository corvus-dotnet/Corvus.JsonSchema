                ...
                public readonly partial struct RequiredRequired
                {
                    ...
                    public readonly partial struct RequiredEntity
                    {
...
#endif
                        {
                            ...
                            public static explicit operator Mutable(RequiredEntity instance)
                            {
                            ...
                            /// <returns>An immutable instance of a <see cref="RequiredEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator RequiredEntity(Mutable instance)
                            {
                            ...
                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            private string DebuggerDisplay => $"RequiredEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly RequiredEntity Clone()
                            {
                                CheckValidInstance();
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly RequiredEntity Freeze()
                            {
                                CheckValidInstance();
                                return _parent.FreezeElement<RequiredEntity>(_idx);
                            }
                        }
                        ...
                        public ref struct Source
                        {
                            ...
                            public static implicit operator Source(RequiredEntity instance) => new(JsonElement.From(instance));
                        ...
                        {
                            return workspace.CreateBuilder<RequiredEntity, Mutable>(this);
                        }
                        ...
                        public static ParsedJsonDocument<RequiredEntity> Create(
                            scoped in Source value, int initialCapacity = 1)
                        {
                            ...
                            try
                            {
                                ...
                                Debug.Assert(cvb.MemberCount == 1);
                                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                return documentBuilder.ToParsedJsonDocument<RequiredEntity>();
                            }
                            finally
                            {
