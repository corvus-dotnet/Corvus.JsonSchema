                ...
                public readonly partial struct ThenEntity
                {
                    ...
                    public readonly partial struct StyleEntity
                    {
...
#endif
                        {
                            ...
                            /// </remarks>
                            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<StyleEntity, Mutable>(StyleEntity.DefaultInstance);
                            ...
                            public static explicit operator Mutable(StyleEntity instance)
                            {
                            ...
                            /// <returns>An immutable instance of a <see cref="StyleEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator StyleEntity(Mutable instance)
                            {
                            ...
                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            private string DebuggerDisplay => $"StyleEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly StyleEntity Clone()
                            {
                                CheckValidInstance();
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly StyleEntity Freeze()
                            {
                                CheckValidInstance();
                                return _parent.FreezeElement<StyleEntity>(_idx);
                            }
                        ...
                        public ref struct Source
                        {
                            ...
                            public static implicit operator Source(StyleEntity instance) => new(JsonElement.From(instance));
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator Source(KnownValues value) => (StyleEntity)value;
                        ...
                        {
                            return workspace.CreateBuilder<StyleEntity, Mutable>(this);
                        }
                        ...
                        public static ParsedJsonDocument<StyleEntity> Create(
                            scoped in Source value, int initialCapacity = 1)
                        {
                            ...
                            try
                            {
                                ...
                                Debug.Assert(cvb.MemberCount == 1);
                                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                return documentBuilder.ToParsedJsonDocument<StyleEntity>();
                            }
                            finally
                            {
