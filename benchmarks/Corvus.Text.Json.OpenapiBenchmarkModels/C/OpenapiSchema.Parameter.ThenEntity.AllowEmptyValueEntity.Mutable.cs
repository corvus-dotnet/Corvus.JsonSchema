        ...
        public readonly partial struct ThenEntity
        {
            ...
            public readonly partial struct AllowEmptyValueEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<AllowEmptyValueEntity, Mutable>(AllowEmptyValueEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(AllowEmptyValueEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="AllowEmptyValueEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator AllowEmptyValueEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"AllowEmptyValueEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly AllowEmptyValueEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly AllowEmptyValueEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<AllowEmptyValueEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(AllowEmptyValueEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<AllowEmptyValueEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<AllowEmptyValueEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<AllowEmptyValueEntity>();
                    }
                    finally
                    {
