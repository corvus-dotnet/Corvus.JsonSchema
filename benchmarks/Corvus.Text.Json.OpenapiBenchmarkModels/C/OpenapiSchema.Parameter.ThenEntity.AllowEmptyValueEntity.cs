    ...
    public readonly partial struct Parameter
    {
        ...
        public readonly partial struct ThenEntity
        {
            ...
            public readonly partial struct AllowEmptyValueEntity
                ...
                : IJsonElement<AllowEmptyValueEntity>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                internal AllowEmptyValueEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static AllowEmptyValueEntity DefaultInstance { get; } = ParsedJsonDocument<AllowEmptyValueEntity>.False;
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in AllowEmptyValueEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(AllowEmptyValueEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AllowEmptyValueEntity(JsonElement instance)
                {
                    return AllowEmptyValueEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AllowEmptyValueEntity From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AllowEmptyValueEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<AllowEmptyValueEntity>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AllowEmptyValueEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<AllowEmptyValueEntity>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AllowEmptyValueEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<AllowEmptyValueEntity>(json, options);
                }
                ...
                /// </exception>
                public static AllowEmptyValueEntity ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<AllowEmptyValueEntity>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out AllowEmptyValueEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<AllowEmptyValueEntity>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new AllowEmptyValueEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static AllowEmptyValueEntity IJsonElement<AllowEmptyValueEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AllowEmptyValueEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="AllowEmptyValueEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="AllowEmptyValueEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public AllowEmptyValueEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<AllowEmptyValueEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="AllowEmptyValueEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public AllowEmptyValueEntity Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<AllowEmptyValueEntity>(_idx);
                    }
