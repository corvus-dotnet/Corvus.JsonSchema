...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct PathItem
    {
...
#endif
        {
            ...
            internal ParameterOrReferenceArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            public Corvus.OpenapiBenchmark.Current.OpenapiSchema.ParameterOrReference this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.OpenapiBenchmark.Current.OpenapiSchema.ParameterOrReference>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.OpenapiBenchmark.Current.OpenapiSchema.ParameterOrReference> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.OpenapiBenchmark.Current.OpenapiSchema.ParameterOrReference>(_parent, _idx);
            }
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ParameterOrReferenceArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(ParameterOrReferenceArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ParameterOrReferenceArray(JsonElement instance)
            {
                return ParameterOrReferenceArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ParameterOrReferenceArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ParameterOrReferenceArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ParameterOrReferenceArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ParameterOrReferenceArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ParameterOrReferenceArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ParameterOrReferenceArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ParameterOrReferenceArray>(json, options);
            }
            ...
            /// </exception>
            public static ParameterOrReferenceArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ParameterOrReferenceArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ParameterOrReferenceArray? result)
            {
                return JsonElementHelpers.TryParseValue<ParameterOrReferenceArray>(ref reader, out result);
            }
...
#if NET
            static ParameterOrReferenceArray IJsonElement<ParameterOrReferenceArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ParameterOrReferenceArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public ParameterOrReferenceArray Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public ParameterOrReferenceArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ParameterOrReferenceArray>(_idx);
                }
