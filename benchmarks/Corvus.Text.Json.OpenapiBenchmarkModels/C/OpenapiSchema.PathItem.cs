...
public readonly partial struct OpenapiSchema
{
...
#endif
    {
        ...
        internal PathItem(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public Corvus.OpenapiBenchmark.Current.OpenapiSchema.PathItem.ParameterOrReferenceArray Parameters
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ParametersUtf8, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.PathItem.ParameterOrReferenceArray value))
                {
                    return value;
                }
        ...
        public static implicit operator Corvus.OpenapiBenchmark.Current.OpenapiSchema.SpecificationExtensions(PathItem value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator PathItem(Corvus.OpenapiBenchmark.Current.OpenapiSchema.SpecificationExtensions value)
        {
            return From(value);
        }
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in PathItem left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(PathItem instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PathItem(JsonElement instance)
        {
            return PathItem.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PathItem From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PathItem ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PathItem>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PathItem ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PathItem>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PathItem ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PathItem>(json, options);
        }
        ...
        /// </exception>
        public static PathItem ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<PathItem>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out PathItem? result)
        {
            return JsonElementHelpers.TryParseValue<PathItem>(ref reader, out result);
        }
...
#if NET
        static PathItem IJsonElement<PathItem>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PathItem: ValueKind = {ValueKind} : \"{ToString()}\"";
