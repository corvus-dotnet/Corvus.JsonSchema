...
public readonly partial struct OpenapiSchema
{
        ...
        : IJsonElement<PathItemOrReference>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/path-item-or-reference"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/$defs/path-item-or-reference";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/path-item-or-reference"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                JsonSchemaContext ifContext =
                    Corvus.OpenapiBenchmark.Current.OpenapiSchema.PathItemOrReference.RequiredRef.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: IfSchemaEvaluationPath);
                Corvus.OpenapiBenchmark.Current.OpenapiSchema.PathItemOrReference.RequiredRef.JsonSchema.Evaluate(parentDocument, parentIndex, ref ifContext);
                ...
                else
                {
                    JsonSchemaContext elseContext =
                        Corvus.OpenapiBenchmark.Current.OpenapiSchema.PathItem.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: ElseSchemaEvaluationPath);
                    Corvus.OpenapiBenchmark.Current.OpenapiSchema.PathItem.JsonSchema.Evaluate(parentDocument, parentIndex, ref elseContext);
