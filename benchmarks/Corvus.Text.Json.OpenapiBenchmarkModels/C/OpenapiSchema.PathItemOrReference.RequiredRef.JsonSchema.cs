    ...
    public readonly partial struct PathItemOrReference
    {
            ...
            : IJsonElement<RequiredRef>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/path-item-or-reference/if"u8, buffer, out written);
