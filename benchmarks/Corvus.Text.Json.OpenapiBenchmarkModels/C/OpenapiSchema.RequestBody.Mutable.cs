...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct RequestBody
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(RequestBody instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="RequestBody"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RequestBody(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.OpenapiBenchmark.Current.OpenapiSchema.Content.Mutable ContentValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ContentValueUtf8, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.Content.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public Corvus.OpenapiBenchmark.Current.OpenapiSchema.RequestBody.RequiredEntity.Mutable Required
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RequiredUtf8, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.RequestBody.RequiredEntity.Mutable value))
                    {
                        return value;
                    }

                    return Corvus.OpenapiBenchmark.Current.OpenapiSchema.RequestBody.RequiredEntity.Mutable.DefaultInstance;
                }
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RequestBody(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetContentValue(scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Content.Source value)
            {
                ...
                {
                    CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("content");
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ContentValueUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                ...
                else
                {
                    ...
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ContentValue, ref cvb);
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetContentValue<TContext>(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Content.Source<TContext> value)
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetRequired(scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.RequestBody.RequiredEntity.Source value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RequestBody.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RequestBody"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RequestBody"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly RequestBody Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RequestBody>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RequestBody"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly RequestBody Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<RequestBody>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.OpenapiBenchmark.Current.OpenapiSchema.Content.Source _createArg1;
            private readonly Corvus.OpenapiBenchmark.Current.JsonString.Source _createArg2;
            private readonly Corvus.OpenapiBenchmark.Current.OpenapiSchema.RequestBody.RequiredEntity.Source _createArg3;
            ...
            internal Source(Corvus.OpenapiBenchmark.Current.OpenapiSchema.RequestBody.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Content.Source arg1, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source arg2, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.RequestBody.RequiredEntity.Source arg3)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _createArg3 = arg3;
            ...
            public static implicit operator Source(RequestBody instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            private readonly Corvus.OpenapiBenchmark.Current.OpenapiSchema.Content.Source<TContext> _createArg1;
            private readonly Corvus.OpenapiBenchmark.Current.JsonString.Source _createArg2;
            private readonly Corvus.OpenapiBenchmark.Current.OpenapiSchema.RequestBody.RequiredEntity.Source _createArg3;
            ...
            internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Current.OpenapiSchema.RequestBody.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in TContext context, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Content.Source<TContext> arg1, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source arg2, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.RequestBody.RequiredEntity.Source arg3)
            {
                _context = context;
                _createArg1 = arg1;
                _createArg2 = arg2;
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Content.Source content,
                in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default,
                in Corvus.OpenapiBenchmark.Current.OpenapiSchema.RequestBody.RequiredEntity.Source required = default)
            {
                content.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ContentValue, ref builder);
            ...
            public void Create(
                ...
                in Corvus.OpenapiBenchmark.Current.OpenapiSchema.RequestBody.RequiredEntity.Source required = default)
            {
                Create(ref _builder, content, description, required);
            }
            ...
            internal static void Create<TContext>(
                in TContext context,
                ref ComplexValueBuilder builder,
                in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Content.Source<TContext> content,
                in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default,
                in Corvus.OpenapiBenchmark.Current.OpenapiSchema.RequestBody.RequiredEntity.Source required = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            ...
            #endif
            {
                Create(context, ref _builder, content, description, required);
            }
            ...
            internal static void BuildCreateValue(scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Content.Source arg1, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source arg2, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.RequestBody.RequiredEntity.Source arg3, ref ComplexValueBuilder o)
            {
                o.StartObject();
            ...
            /// <param name="arg3">The value of the property.</param>
            /// <param name="o">The complex value builder into which to write the object.</param>
            internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Content.Source<TContext> arg1, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source arg2, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.RequestBody.RequiredEntity.Source arg3, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Content.Source content, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.RequestBody.RequiredEntity.Source required = default)
        {
            return new Source(content, description, required);
        }
        ...
        /// <param name="required">The value of the <c>"required"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Content.Source<TContext> content, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.RequestBody.RequiredEntity.Source required = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            return new Source<TContext>(context, content, description, required);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Content.Source content, in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.RequestBody.RequiredEntity.Source required = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(content, description, required);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Content.Source<TContext> content, in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.RequestBody.RequiredEntity.Source required = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            ...
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(context, content, description, required);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<RequestBody, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<RequestBody> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<RequestBody>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<RequestBody> Create<TContext>(
        ...
        public static ParsedJsonDocument<RequestBody> Create(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Content.Source content, in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.RequestBody.RequiredEntity.Source required = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<RequestBody> Create<TContext>(in TContext context, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Content.Source<TContext> content, in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.RequestBody.RequiredEntity.Source required = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
