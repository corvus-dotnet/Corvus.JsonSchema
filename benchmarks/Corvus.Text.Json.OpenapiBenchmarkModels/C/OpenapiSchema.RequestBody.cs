...
public readonly partial struct OpenapiSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RequestBody"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal RequestBody(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static RequestBody DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.OpenapiBenchmark.Current.OpenapiSchema.Content ContentValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ContentValueUtf8, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.Content value))
                {
                    return value;
                }
        ...
        public static implicit operator Corvus.OpenapiBenchmark.Current.OpenapiSchema.SpecificationExtensions(RequestBody value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator RequestBody(Corvus.OpenapiBenchmark.Current.OpenapiSchema.SpecificationExtensions value)
        {
            return From(value);
        }
        ...
        /// </returns>
        public static bool operator ==(in RequestBody left, in RequestBody right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in RequestBody left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(RequestBody instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator RequestBody(JsonElement instance)
        {
            return RequestBody.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequestBody From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequestBody ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RequestBody>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequestBody ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RequestBody>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequestBody ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RequestBody>(json, options);
        }
        ...
        /// </exception>
        public static RequestBody ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<RequestBody>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out RequestBody? result)
        {
            return JsonElementHelpers.TryParseValue<RequestBody>(ref reader, out result);
        }
...
#if NET
        static RequestBody IJsonElement<RequestBody>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"RequestBody: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        {
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="ContentValue"/>.
            /// </summary>
            public static ReadOnlySpan<byte> ContentValue => "content"u8;
        ...
        {
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="ContentValue"/>.
            /// </summary>
            public static ReadOnlySpan<byte> ContentValue => [0x95, 0x00, 0x00, 0x00, 0x22, 0x63, 0x6F, 0x6E, 0x74, 0x65, 0x6E, 0x74, 0x22];
