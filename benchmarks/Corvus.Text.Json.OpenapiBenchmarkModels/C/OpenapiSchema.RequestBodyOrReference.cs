...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct RequestBodyOrReference
        ...
        : IJsonElement<RequestBodyOrReference>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RequestBodyOrReference"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal RequestBodyOrReference(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static RequestBodyOrReference DefaultInstance { get; }
        ...
        /// </summary>
        public Corvus.OpenapiBenchmark.Current.OpenapiSchema.Content Content
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ContentUtf8, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.Content value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.OpenapiBenchmark.Current.OpenapiSchema.RequestBody.RequiredEntity Required
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RequiredUtf8, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.RequestBody.RequiredEntity value))
                {
                    return value;
                }

                return Corvus.OpenapiBenchmark.Current.OpenapiSchema.RequestBody.RequiredEntity.DefaultInstance;
            }
        }
        ...
        /// </returns>
        public static bool operator ==(in RequestBodyOrReference left, in RequestBodyOrReference right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in RequestBodyOrReference left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(RequestBodyOrReference instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator RequestBodyOrReference(JsonElement instance)
        {
            return RequestBodyOrReference.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequestBodyOrReference From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequestBodyOrReference ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RequestBodyOrReference>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequestBodyOrReference ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RequestBodyOrReference>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequestBodyOrReference ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RequestBodyOrReference>(json, options);
        }
        ...
        /// </exception>
        public static RequestBodyOrReference ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<RequestBodyOrReference>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out RequestBodyOrReference? result)
        {
            return JsonElementHelpers.TryParseValue<RequestBodyOrReference>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new RequestBodyOrReference(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static RequestBodyOrReference IJsonElement<RequestBodyOrReference>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"RequestBodyOrReference: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="RequestBodyOrReference"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="RequestBodyOrReference"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        {
            CheckValidInstance();
            return _parent.CloneElement<RequestBodyOrReference>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="RequestBodyOrReference"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public RequestBodyOrReference Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<RequestBodyOrReference>(_idx);
            }
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.RequestBody" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsRequestBody(out Corvus.OpenapiBenchmark.Current.OpenapiSchema.RequestBody result)
        {
            if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.RequestBody.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.OpenapiBenchmark.Current.OpenapiSchema.RequestBody.From(this);
                return true;
            }
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.RequestBodyOrReference.RequiredRef" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsRequiredRef(out Corvus.OpenapiBenchmark.Current.OpenapiSchema.RequestBodyOrReference.RequiredRef result)
        {
            if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.RequestBodyOrReference.RequiredRef.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.OpenapiBenchmark.Current.OpenapiSchema.RequestBodyOrReference.RequiredRef.From(this);
                return true;
            }
        ...
        /// <param name="matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaRequestBody">Match a <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.RequestBody"/>.</param>
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.OpenapiBenchmark.Current.OpenapiSchema.RequestBody, TContext, TResult> matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaRequestBody)
...
#endif
        {
            ...
            {
                return matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaRequestBody(Corvus.OpenapiBenchmark.Current.OpenapiSchema.RequestBody.From(this), context);
            }
        }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.OpenapiBenchmark.Current.OpenapiSchema.RequestBody, TResult> matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaRequestBody)
        {
            if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.RequestBodyOrReference.RequiredRef.JsonSchema.Evaluate(_parent, _idx))
            {
            ...
            {
                return matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaRequestBody(Corvus.OpenapiBenchmark.Current.OpenapiSchema.RequestBody.From(this));
            }
        }
