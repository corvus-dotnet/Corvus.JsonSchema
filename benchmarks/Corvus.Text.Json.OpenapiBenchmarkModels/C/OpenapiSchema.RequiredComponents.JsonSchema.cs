...
public readonly partial struct OpenapiSchema
{
        ...
        : IJsonElement<RequiredComponents>
    {
        ...
        {
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyComponentsPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("components"u8, buffer, out written);
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyComponentsNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("components"u8, buffer, out written);

            private const int RequiredOffsetForComponents = 0;
            private const uint RequiredBitForComponents = 0b00000000000000000000000000000001;

            private const uint RequiredBitMask0 =
                RequiredBitForComponents;
            ...
            {
                requiredBitBuffer[RequiredOffsetForComponents] |= RequiredBitForComponents;
            }
            ...
            {
                if (span.SequenceEqual(JsonPropertyNames.ComponentsUtf8))
                {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://spec.openapis.org/oas/3.1/schema/2022-10-07#/anyOf/1"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "https://spec.openapis.org/oas/3.1/schema/2022-10-07#/anyOf/1";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://spec.openapis.org/oas/3.1/schema/2022-10-07#/anyOf/1"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                if (tokenType == JsonTokenType.StartObject)
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyComponentsPresent, "components"u8, "required"u8);
                    }
                    ...
                    {
                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForComponents] & RequiredBitForComponents) == 0)
                        {
                            context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyComponentsNotPresent, "components"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyComponentsPresent, "components"u8, "required"u8);
