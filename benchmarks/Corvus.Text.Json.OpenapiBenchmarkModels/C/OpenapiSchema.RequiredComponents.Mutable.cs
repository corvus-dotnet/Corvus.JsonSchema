...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct RequiredComponents
    {
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(in Corvus.Text.Json.JsonElement.Source components)
        {
        ...
        /// <param name="components">The value of the <c>"components"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> components)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
