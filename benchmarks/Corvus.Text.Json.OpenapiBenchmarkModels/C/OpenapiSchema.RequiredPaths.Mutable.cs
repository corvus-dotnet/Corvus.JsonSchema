...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct RequiredPaths
    {
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(in Corvus.Text.Json.JsonElement.Source paths)
        {
        ...
        /// <param name="paths">The value of the <c>"paths"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> paths)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
