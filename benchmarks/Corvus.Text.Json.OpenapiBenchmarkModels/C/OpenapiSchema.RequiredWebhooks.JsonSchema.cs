...
public readonly partial struct OpenapiSchema
{
        ...
        : IJsonElement<RequiredWebhooks>
    {
        ...
        {
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyWebhooksPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("webhooks"u8, buffer, out written);
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyWebhooksNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("webhooks"u8, buffer, out written);

            private const int RequiredOffsetForWebhooks = 0;
            private const uint RequiredBitForWebhooks = 0b00000000000000000000000000000001;

            private const uint RequiredBitMask0 =
                RequiredBitForWebhooks;
            ...
            {
                requiredBitBuffer[RequiredOffsetForWebhooks] |= RequiredBitForWebhooks;
            }
            ...
            {
                if (span.SequenceEqual(JsonPropertyNames.WebhooksUtf8))
                {
                    matcher = MatchWebhooks;
                    return true;
                }
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://spec.openapis.org/oas/3.1/schema/2022-10-07#/anyOf/2"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "https://spec.openapis.org/oas/3.1/schema/2022-10-07#/anyOf/2";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://spec.openapis.org/oas/3.1/schema/2022-10-07#/anyOf/2"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                if (tokenType == JsonTokenType.StartObject)
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyWebhooksPresent, "webhooks"u8, "required"u8);
                    }
                    ...
                    {
                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForWebhooks] & RequiredBitForWebhooks) == 0)
                        {
                            context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyWebhooksNotPresent, "webhooks"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyWebhooksPresent, "webhooks"u8, "required"u8);
