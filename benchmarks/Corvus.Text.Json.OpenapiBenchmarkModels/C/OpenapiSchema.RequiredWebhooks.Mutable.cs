...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct RequiredWebhooks
    {
...
#endif
        {
            ...
            public void SetWebhooks(in Corvus.Text.Json.JsonElement.Source value)
            {
                CheckValidInstance();
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(in Corvus.Text.Json.JsonElement.Source webhooks)
        {
        ...
        /// <param name="webhooks">The value of the <c>"webhooks"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> webhooks)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
