...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct Response
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Response instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Response"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Response(Mutable instance)
            {
            ...
            public void SetContentValue(scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Content.Source value)
            {
                ...
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ContentValueUtf8);
            ...
            public bool RemoveContentValue()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ContentValueUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Response.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly Response Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly Response Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Response>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.OpenapiBenchmark.Current.OpenapiSchema.Response.HeadersEntity.Source _createArg3;
            private readonly Corvus.OpenapiBenchmark.Current.OpenapiSchema.Response.LinksEntity.Source _createArg4;
            ...
            public static implicit operator Source(Response instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            private readonly Corvus.OpenapiBenchmark.Current.OpenapiSchema.Response.HeadersEntity.Source<TContext> _createArg3;
            private readonly Corvus.OpenapiBenchmark.Current.OpenapiSchema.Response.LinksEntity.Source<TContext> _createArg4;
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.OpenapiBenchmark.Current.JsonString.Source description,
            ...
            public void Create(
                ...
                in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Response.LinksEntity.Source links = default)
            {
                Create(ref _builder, description, content, headers, links);
            }
            ...
            #endif
            {
                Create(context, ref _builder, description, content, headers, links);
            }
        ...
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source description, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Content.Source<TContext> content = default, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Response.HeadersEntity.Source<TContext> headers = default, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Response.LinksEntity.Source<TContext> links = default)
            ...
            #endif
        {
            return new Source<TContext>(context, description, content, headers, links);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OpenapiBenchmark.Current.JsonString.Source description, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Content.Source content = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Response.HeadersEntity.Source headers = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Response.LinksEntity.Source links = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(description, content, headers, links);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.OpenapiBenchmark.Current.JsonString.Source description, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Content.Source<TContext> content = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Response.HeadersEntity.Source<TContext> headers = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Response.LinksEntity.Source<TContext> links = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            ...
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(context, description, content, headers, links);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<Response, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<Response> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Response>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Response> Create<TContext>(
        ...
        public static ParsedJsonDocument<Response> Create(in Corvus.OpenapiBenchmark.Current.JsonString.Source description, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Content.Source content = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Response.HeadersEntity.Source headers = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Response.LinksEntity.Source links = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Response> Create<TContext>(in TContext context, in Corvus.OpenapiBenchmark.Current.JsonString.Source description, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Content.Source<TContext> content = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Response.HeadersEntity.Source<TContext> headers = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Response.LinksEntity.Source<TContext> links = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
