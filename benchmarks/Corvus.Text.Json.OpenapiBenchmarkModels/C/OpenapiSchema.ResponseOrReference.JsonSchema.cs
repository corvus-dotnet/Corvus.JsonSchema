...
public readonly partial struct OpenapiSchema
{
        ...
        : IJsonElement<ResponseOrReference>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/response-or-reference"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/response-or-reference";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/response-or-reference"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                JsonSchemaContext ifContext =
                    Corvus.OpenapiBenchmark.Current.OpenapiSchema.ResponseOrReference.RequiredRef.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: IfSchemaEvaluationPath);
                Corvus.OpenapiBenchmark.Current.OpenapiSchema.ResponseOrReference.RequiredRef.JsonSchema.Evaluate(parentDocument, parentIndex, ref ifContext);
                ...
                else
                {
                    JsonSchemaContext elseContext =
                        Corvus.OpenapiBenchmark.Current.OpenapiSchema.Response.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: ElseSchemaEvaluationPath);
                    Corvus.OpenapiBenchmark.Current.OpenapiSchema.Response.JsonSchema.Evaluate(parentDocument, parentIndex, ref elseContext);
