    ...
    public readonly partial struct ResponseOrReference
    {
            ...
            : IJsonElement<RequiredRef>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/response-or-reference/if"u8, buffer, out written);
