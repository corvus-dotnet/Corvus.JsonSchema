...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct Responses
    {
...
#endif
        {
            ...
            /// <see cref="Corvus.Text.Json.JsonElementForBooleanFalseSchema"/>.
            /// </summary>
            ...
            public static bool MatchesPatternJsonElementForBooleanFalseSchema(ReadOnlySpan<byte> propertyName)
            {
            ...
            /// <returns><see langword="true"/> if the property name matches the pattern, otherwise <see langword="false"/>.</returns>
            public static bool TryAsPatternJsonElementForBooleanFalseSchema(ReadOnlySpan<byte> propertyName, in JsonElement value, out Corvus.Text.Json.JsonElementForBooleanFalseSchema result)
            {
                if (MatchesPatternJsonElementForBooleanFalseSchema(propertyName))
                {
                    result = Corvus.Text.Json.JsonElementForBooleanFalseSchema.From(value);
                    return true;
                }
            ...
            public interface IPatternPropertyVisitor<TState>
            {
                ...
                /// </summary>
                bool VisitPatternJsonElementForBooleanFalseSchema(ReadOnlySpan<byte> name, in Corvus.Text.Json.JsonElementForBooleanFalseSchema value, ref TState state);
                ...
                where TVisitor : IPatternPropertyVisitor<TState>
            {
                ...
                foreach (var property in EnumerateObject())
                {
                    ...
                    {
                        matched = true;
                        Corvus.Text.Json.JsonElementForBooleanFalseSchema typedValue = Corvus.Text.Json.JsonElementForBooleanFalseSchema.From(property.Value);
                        if (!visitor.VisitPatternJsonElementForBooleanFalseSchema(propertyName, in typedValue, ref state))
                        {
                            return false;
                        }
