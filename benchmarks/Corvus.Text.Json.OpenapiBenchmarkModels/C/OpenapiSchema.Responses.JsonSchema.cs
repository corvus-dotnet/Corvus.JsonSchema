...
public readonly partial struct OpenapiSchema
{
        ...
        : IJsonElement<Responses>
    {
        ...
        {
            private static readonly JsonSchemaPathProvider DefaultSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/default/$ref"u8, buffer, out written);
            ...
            private static void MatchDefault(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                ...
                JsonSchemaContext childContext =
                    Corvus.OpenapiBenchmark.Current.OpenapiSchema.ResponseOrReference.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.OpenapiBenchmark.Current.OpenapiSchema.ResponseOrReference.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            {
                if (span.SequenceEqual(JsonPropertyNames.DefaultUtf8))
                {
                    matcher = MatchDefault;
                    return true;
                }
            ...
            private static readonly JsonSchemaPathProvider PatternPropertiesSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/patternProperties/^[1-5](?:[0-9]{2}|XX)$/$ref"u8, buffer, out written);
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/responses"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/responses";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/responses"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                JsonSchemaContext ifContext =
                    Corvus.OpenapiBenchmark.Current.OpenapiSchema.Responses.IfEntity.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: IfSchemaEvaluationPath);
                Corvus.OpenapiBenchmark.Current.OpenapiSchema.Responses.IfEntity.JsonSchema.Evaluate(parentDocument, parentIndex, ref ifContext);
                ...
                if (ifContext.IsMatch)
                {
                    ...
                    JsonSchemaContext thenContext =
                        Corvus.OpenapiBenchmark.Current.OpenapiSchema.Responses.RequiredDefault.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: ThenSchemaEvaluationPath);
                    Corvus.OpenapiBenchmark.Current.OpenapiSchema.Responses.RequiredDefault.JsonSchema.Evaluate(parentDocument, parentIndex, ref thenContext);
                    ...
                    while (objectValidation_enumerator.MoveNext())
                    {
                        ...
                        else
                        {
                            if (JsonSchemaEvaluation.MatchRegularExpression(objectValidation_unescapedPropertyName.Span, PatternProperties))
                            {
                                ...
                                Corvus.OpenapiBenchmark.Current.OpenapiSchema.ResponseOrReference.JsonSchema.Evaluate(parentDocument, objectValidation_currentIndex, ref childContext);
