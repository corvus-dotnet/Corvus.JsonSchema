...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct Responses
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Responses instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Responses"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Responses(Mutable instance)
            {
            ...
            public bool TryGetProperty(ReadOnlySpan<byte> propertyName, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.ResponseOrReference.Mutable value)
            {
                CheckValidInstance();
            ...
            /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public bool TryGetProperty(ReadOnlySpan<char> propertyName, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.ResponseOrReference.Mutable value)
            {
                CheckValidInstance();
                return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
            }
            ...
            /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public bool TryGetProperty(string propertyName, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.ResponseOrReference.Mutable value)
            {
                CheckValidInstance();
                return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
            }
            ...
            /// </summary>
            public Corvus.OpenapiBenchmark.Current.OpenapiSchema.ResponseOrReference.Mutable Default
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DefaultUtf8, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.ResponseOrReference.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public ObjectEnumerator<Corvus.OpenapiBenchmark.Current.OpenapiSchema.ResponseOrReference.Mutable> EnumerateObject()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateObjectEnumerator<Corvus.OpenapiBenchmark.Current.OpenapiSchema.ResponseOrReference.Mutable>(_parent, _idx);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Responses(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetDefault<TContext>(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.ResponseOrReference.Source<TContext> value)
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Responses.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Responses"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Responses"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly Responses Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<Responses>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Responses"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly Responses Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Responses>(_idx);
            }
            ...
            /// <param name="matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaResponsesRequiredDefault">Match a <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.Responses.RequiredDefault"/>.</param>
            ...
            public TResult Match<TContext, TResult>(
                in TContext context,
                Matcher<Corvus.OpenapiBenchmark.Current.OpenapiSchema.Responses.RequiredDefault, TContext, TResult> matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaResponsesRequiredDefault,
                Matcher<Responses, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
            {
                if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.Responses.IfEntity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaResponsesRequiredDefault(Corvus.OpenapiBenchmark.Current.OpenapiSchema.Responses.RequiredDefault.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                Matcher<Corvus.OpenapiBenchmark.Current.OpenapiSchema.Responses.RequiredDefault, TResult> matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaResponsesRequiredDefault,
                Matcher<Responses, TResult> defaultMatch)
            {
                if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.Responses.IfEntity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaResponsesRequiredDefault(Corvus.OpenapiBenchmark.Current.OpenapiSchema.Responses.RequiredDefault.From(this));
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.Responses.IfEntity.Mutable" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsIfEntity(out Corvus.OpenapiBenchmark.Current.OpenapiSchema.Responses.IfEntity.Mutable result)
            {
                if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.Responses.IfEntity.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.OpenapiBenchmark.Current.OpenapiSchema.Responses.IfEntity.Mutable.From(this);
                    return true;
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.Responses.RequiredDefault.Mutable" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsRequiredDefault(out Corvus.OpenapiBenchmark.Current.OpenapiSchema.Responses.RequiredDefault.Mutable result)
            {
                if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.Responses.RequiredDefault.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.OpenapiBenchmark.Current.OpenapiSchema.Responses.RequiredDefault.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.OpenapiBenchmark.Current.OpenapiSchema.ResponseOrReference.Source _createArg1;
            ...
            public static implicit operator Source(Responses instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            private readonly Corvus.OpenapiBenchmark.Current.OpenapiSchema.ResponseOrReference.Source<TContext> _createArg1;
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.ResponseOrReference.Source defaultValue = default)
            {
            ...
            /// Creates an instance of a <see cref="Responses"/>.
            /// </summary>
            public void Create(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.ResponseOrReference.Source defaultValue = default)
            {
                Create(ref _builder, defaultValue);
            }
            ...
            internal static void Create<TContext>(
                ...
                in Corvus.OpenapiBenchmark.Current.OpenapiSchema.ResponseOrReference.Source<TContext> defaultValue = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            /// Creates an instance of a <see cref="Responses"/>.
            /// </summary>
            public void Create<TContext>(in TContext context, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.ResponseOrReference.Source<TContext> defaultValue = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
                Create(context, ref _builder, defaultValue);
            }
        ...
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.ResponseOrReference.Source<TContext> defaultValue = default)
            ...
            #endif
        {
            return new Source<TContext>(context, defaultValue);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.ResponseOrReference.Source defaultValue = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(defaultValue);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.ResponseOrReference.Source<TContext> defaultValue = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            ...
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(context, defaultValue);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<Responses, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<Responses> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Responses>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Responses> Create<TContext>(
        ...
        public static ParsedJsonDocument<Responses> Create(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.ResponseOrReference.Source defaultValue = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Responses> Create<TContext>(in TContext context, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.ResponseOrReference.Source<TContext> defaultValue = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
