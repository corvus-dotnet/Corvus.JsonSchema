...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct Responses
    {
        ...
        public readonly partial struct RequiredDefault
        {
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(in Corvus.Text.Json.JsonElement.Source defaultValue)
            {
            ...
            /// <param name="defaultValue">The value of the <c>"default"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> defaultValue)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
