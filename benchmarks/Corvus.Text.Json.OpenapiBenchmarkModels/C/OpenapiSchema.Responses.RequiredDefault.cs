...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct Responses
    {
...
#endif
        {
            ...
            internal RequiredDefault(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RequiredDefault left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(RequiredDefault instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RequiredDefault(JsonElement instance)
            {
                return RequiredDefault.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredDefault From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredDefault ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredDefault>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredDefault ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredDefault>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredDefault ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredDefault>(json, options);
            }
            ...
            /// </exception>
            public static RequiredDefault ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RequiredDefault>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredDefault? result)
            {
                return JsonElementHelpers.TryParseValue<RequiredDefault>(ref reader, out result);
            }
...
#if NET
            static RequiredDefault IJsonElement<RequiredDefault>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RequiredDefault: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public RequiredDefault Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RequiredDefault>(_idx);
                }
