...
public readonly partial struct OpenapiSchema
{
...
#endif
    {
        ...
        public bool TryGetProperty(ReadOnlySpan<byte> propertyName, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.ResponseOrReference value)
        {
            CheckValidInstance();
        ...
        /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public bool TryGetProperty(ReadOnlySpan<char> propertyName, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.ResponseOrReference value)
        {
            CheckValidInstance();
            return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
        }
        ...
        /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public bool TryGetProperty(string propertyName, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.ResponseOrReference value)
        {
            CheckValidInstance();
            return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
        }
        ...
        /// </summary>
        public Corvus.OpenapiBenchmark.Current.OpenapiSchema.ResponseOrReference Default
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DefaultUtf8, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.ResponseOrReference value))
                {
                    return value;
                }
        ...
        /// <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.ResponseOrReference"/>.
        /// </summary>
        ...
        public static bool MatchesPatternResponseOrReference(ReadOnlySpan<byte> propertyName)
        {
        ...
        /// <returns><see langword="true"/> if the property name matches the pattern, otherwise <see langword="false"/>.</returns>
        public static bool TryAsPatternResponseOrReference(ReadOnlySpan<byte> propertyName, in JsonElement value, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.ResponseOrReference result)
        {
            if (MatchesPatternResponseOrReference(propertyName))
            {
                result = Corvus.OpenapiBenchmark.Current.OpenapiSchema.ResponseOrReference.From(value);
                return true;
            }
        ...
        {
            /// <summary>
            /// Visits a property matching '^[1-5](?:[0-9]{2}|XX)$'.
            /// </summary>
            bool VisitPatternResponseOrReference(ReadOnlySpan<byte> name, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.ResponseOrReference value, ref TState state);
            ...
            where TVisitor : IPatternPropertyVisitor<TState>
        {
            ...
            foreach (var property in EnumerateObject())
            {
                ...
                {
                    matched = true;
                    Corvus.OpenapiBenchmark.Current.OpenapiSchema.ResponseOrReference typedValue = Corvus.OpenapiBenchmark.Current.OpenapiSchema.ResponseOrReference.From(property.Value);
                    if (!visitor.VisitPatternResponseOrReference(propertyName, in typedValue, ref state))
                    {
                        return false;
                    }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public ObjectEnumerator<Corvus.OpenapiBenchmark.Current.OpenapiSchema.ResponseOrReference> EnumerateObject()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateObjectEnumerator<Corvus.OpenapiBenchmark.Current.OpenapiSchema.ResponseOrReference>(_parent, _idx);
        }
        ...
        public static implicit operator Corvus.OpenapiBenchmark.Current.OpenapiSchema.SpecificationExtensions(Responses value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Responses(Corvus.OpenapiBenchmark.Current.OpenapiSchema.SpecificationExtensions value)
        {
            return From(value);
        }
        ...
        public bool TryGetAsIfEntity(out Corvus.OpenapiBenchmark.Current.OpenapiSchema.Responses.IfEntity result)
        {
            ...
            {
                result = Corvus.OpenapiBenchmark.Current.OpenapiSchema.Responses.IfEntity.From(this);
                return true;
            }
        ...
        public bool TryGetAsRequiredDefault(out Corvus.OpenapiBenchmark.Current.OpenapiSchema.Responses.RequiredDefault result)
        {
            ...
            {
                result = Corvus.OpenapiBenchmark.Current.OpenapiSchema.Responses.RequiredDefault.From(this);
                return true;
            }
