...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct SecurityRequirement
        : IJsonElement<SecurityRequirement>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/security-requirement"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/security-requirement";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/security-requirement"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    while (objectValidation_enumerator.MoveNext())
                    {
                        ...
                        {
                            JsonSchemaContext childContext = Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityRequirement.JsonStringArray.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                            ...
                            Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityRequirement.JsonStringArray.JsonSchema.Evaluate(parentDocument, objectValidation_currentIndex, ref childContext);
