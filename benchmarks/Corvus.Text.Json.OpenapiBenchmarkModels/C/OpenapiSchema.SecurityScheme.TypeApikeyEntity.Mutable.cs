...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct SecurityScheme
    {
        ...
        public readonly partial struct TypeApikeyEntity
        {
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeApikeyEntity.RequiredInAndName.InEntity.Source inValue = default, in Corvus.OpenapiBenchmark.Current.JsonString.Source name = default)
            {
