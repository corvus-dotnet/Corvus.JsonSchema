    ...
    public readonly partial struct SecurityScheme
    {
        ...
        public readonly partial struct TypeApikeyEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(TypeApikeyEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TypeApikeyEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TypeApikeyEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new TypeApikeyEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TypeApikeyEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="TypeApikeyEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="TypeApikeyEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly TypeApikeyEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<TypeApikeyEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="TypeApikeyEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly TypeApikeyEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TypeApikeyEntity>(_idx);
                }
                ...
                /// <param name="matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaSecuritySchemeTypeApikeyEntityRequiredInAndName">Match a <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeApikeyEntity.RequiredInAndName"/>.</param>
                ...
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Matcher<Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeApikeyEntity.RequiredInAndName, TContext, TResult> matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaSecuritySchemeTypeApikeyEntityRequiredInAndName,
                    Matcher<TypeApikeyEntity, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
                {
                    if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeApikeyEntity.RequiredType.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaSecuritySchemeTypeApikeyEntityRequiredInAndName(Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeApikeyEntity.RequiredInAndName.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    Matcher<Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeApikeyEntity.RequiredInAndName, TResult> matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaSecuritySchemeTypeApikeyEntityRequiredInAndName,
                    Matcher<TypeApikeyEntity, TResult> defaultMatch)
                {
                    if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeApikeyEntity.RequiredType.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaSecuritySchemeTypeApikeyEntityRequiredInAndName(Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeApikeyEntity.RequiredInAndName.From(this));
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeApikeyEntity.RequiredType.Mutable" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsRequiredType(out Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeApikeyEntity.RequiredType.Mutable result)
                {
                    if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeApikeyEntity.RequiredType.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeApikeyEntity.RequiredType.Mutable.From(this);
                        return true;
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeApikeyEntity.RequiredInAndName.Mutable" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsRequiredInAndName(out Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeApikeyEntity.RequiredInAndName.Mutable result)
                {
                    if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeApikeyEntity.RequiredInAndName.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeApikeyEntity.RequiredInAndName.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeApikeyEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                public static implicit operator Source(TypeApikeyEntity instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeApikeyEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// Creates an instance of a <see cref="TypeApikeyEntity"/>.
                /// </summary>
                public void Create(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeApikeyEntity.RequiredInAndName.InEntity.Source inValue = default, in Corvus.OpenapiBenchmark.Current.JsonString.Source name = default)
                {
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeApikeyEntity.RequiredInAndName.InEntity.Source inValue = default, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source name = default)
            {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeApikeyEntity.RequiredInAndName.InEntity.Source inValue = default, in Corvus.OpenapiBenchmark.Current.JsonString.Source name = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            {
                return workspace.CreateBuilder<TypeApikeyEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<TypeApikeyEntity> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TypeApikeyEntity>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<TypeApikeyEntity> Create<TContext>(
            ...
            public static ParsedJsonDocument<TypeApikeyEntity> Create(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeApikeyEntity.RequiredInAndName.InEntity.Source inValue = default, in Corvus.OpenapiBenchmark.Current.JsonString.Source name = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
