        ...
        public readonly partial struct TypeApikeyEntity
        {
            ...
            public readonly partial struct RequiredInAndName
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(RequiredInAndName instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="RequiredInAndName"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RequiredInAndName(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new RequiredInAndName(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RequiredInAndName.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="RequiredInAndName"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="RequiredInAndName"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RequiredInAndName Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<RequiredInAndName>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="RequiredInAndName"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RequiredInAndName Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<RequiredInAndName>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    private readonly Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeApikeyEntity.RequiredInAndName.InEntity.Source _createArg1;
                    ...
                    internal Source(Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeApikeyEntity.RequiredInAndName.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    internal Source(scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeApikeyEntity.RequiredInAndName.InEntity.Source arg1, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source arg2)
                    {
                        _createArg1 = arg1;
                        _createArg2 = arg2;
                        _kind = Kind.Create;
                    ...
                    public static implicit operator Source(RequiredInAndName instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeApikeyEntity.RequiredInAndName.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    internal static void Create(
                        ...
                        in Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeApikeyEntity.RequiredInAndName.InEntity.Source inValue,
                    ...
                    /// Creates an instance of a <see cref="RequiredInAndName"/>.
                    /// </summary>
                    public void Create(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeApikeyEntity.RequiredInAndName.InEntity.Source inValue, in Corvus.OpenapiBenchmark.Current.JsonString.Source name)
                    {
                        Create(ref _builder, inValue, name);
                    }
                    ...
                    internal static void BuildCreateValue(scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeApikeyEntity.RequiredInAndName.InEntity.Source arg1, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source arg2, ref ComplexValueBuilder o)
                    {
                        o.StartObject();
                ...
                /// <returns>The source from which to build the value.</returns>
                public static Source Build(scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeApikeyEntity.RequiredInAndName.InEntity.Source inValue, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source name)
                {
                    return new Source(inValue, name);
                }
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeApikeyEntity.RequiredInAndName.InEntity.Source inValue, in Corvus.OpenapiBenchmark.Current.JsonString.Source name, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                    Builder ovb = new(cvb);
                    ovb.Create(inValue, name);
                    cvb = ovb._builder;
                    cvb.EndObject();
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
                ...
                {
                    return workspace.CreateBuilder<RequiredInAndName, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<RequiredInAndName> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<RequiredInAndName>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<RequiredInAndName> Create<TContext>(
                ...
                public static ParsedJsonDocument<RequiredInAndName> Create(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeApikeyEntity.RequiredInAndName.InEntity.Source inValue, in Corvus.OpenapiBenchmark.Current.JsonString.Source name, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
