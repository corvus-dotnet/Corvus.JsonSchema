    ...
    public readonly partial struct SecurityScheme
    {
            ...
            : IJsonElement<TypeEntity>
        {
            ...
            public enum KnownValues
            {
                ...
                Http = 1,
                /// <summary>
                /// Corresponds to the JSON string "mutualTLS".
                /// </summary>
                MutualTls = 2,
                /// <summary>
                /// Corresponds to the JSON string "oauth2".
                /// </summary>
                Oauth2 = 3,
                /// <summary>
                /// Corresponds to the JSON string "openIdConnect".
                /// </summary>
                OpenIdConnect = 4,
            }
            ...
            public static implicit operator TypeEntity(KnownValues value)
            {
                return value switch
                {
                    ...
                    KnownValues.Http => Constants.EnumJson2,
                    KnownValues.MutualTls => Constants.EnumJson3,
                    KnownValues.Oauth2 => Constants.EnumJson4,
                    KnownValues.OpenIdConnect => Constants.EnumJson5,
            ...
            public bool TryGetKnownValue(out KnownValues result)
            {
                ...
                {
                    result = KnownValues.MutualTls;
                    return true;
                }

                if (this.ValueEquals(Constants.Enum4))
                {
                    result = KnownValues.Oauth2;
                    return true;
                }

                if (this.ValueEquals(Constants.Enum5))
                {
                    result = KnownValues.OpenIdConnect;
                    return true;
                }
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/$defs/security-scheme/properties/type"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated, as a JSON Pointer within <see cref="SchemaDocument"/>.
                /// </summary>
                public const string SchemaLocation = "/$defs/security-scheme/properties/type";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/security-scheme/properties/type"u8;
                ...
                private static readonly global::Corvus.Text.Json.RuntimeEvaluator.JsonSchemaEvaluator Evaluator = global::Corvus.OpenapiBenchmark.Current.CorvusJsonSchemaProgram.Entry(155);
