        ...
        public readonly partial struct TypeHttpBearerEntity
        {
            ...
            public readonly partial struct RequiredSchemeAndType
            {
...
#endif
                {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.SchemeEntity.Mutable Scheme
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SchemeUtf8, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.SchemeEntity.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.TypeEntity.Mutable Type
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.TypeEntity.Mutable value))
                            {
                                return value;
                            }
                ...
                public ref struct Source
                {
                    ...
                    private readonly Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.SchemeEntity.Source _createArg1;
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// Creates an instance of a <see cref="RequiredSchemeAndType"/>.
                    /// </summary>
                    public void Create(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.SchemeEntity.Source scheme)
                    {
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.SchemeEntity.Source scheme, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                ...
                public static ParsedJsonDocument<RequiredSchemeAndType> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<RequiredSchemeAndType>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<RequiredSchemeAndType> Create<TContext>(
                ...
                public static ParsedJsonDocument<RequiredSchemeAndType> Create(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.SchemeEntity.Source scheme, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
