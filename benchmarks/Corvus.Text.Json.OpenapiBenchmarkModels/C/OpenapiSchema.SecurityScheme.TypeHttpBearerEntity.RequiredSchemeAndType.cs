    ...
    public readonly partial struct SecurityScheme
    {
        ...
        public readonly partial struct TypeHttpBearerEntity
        {
            ...
            public readonly partial struct RequiredSchemeAndType
                ...
                : IJsonElement<RequiredSchemeAndType>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="RequiredSchemeAndType"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal RequiredSchemeAndType(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static RequiredSchemeAndType DefaultInstance { get; }
                ...
                /// </para>
                /// </remarks>
                public Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.SchemeEntity Scheme
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SchemeUtf8, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.SchemeEntity value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.TypeEntity Type
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.TypeEntity value))
                        {
                            return value;
                        }
                ...
                /// </returns>
                public static bool operator ==(in RequiredSchemeAndType left, in RequiredSchemeAndType right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in RequiredSchemeAndType left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(RequiredSchemeAndType instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RequiredSchemeAndType(JsonElement instance)
                {
                    return RequiredSchemeAndType.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredSchemeAndType From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredSchemeAndType ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RequiredSchemeAndType>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredSchemeAndType ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RequiredSchemeAndType>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredSchemeAndType ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RequiredSchemeAndType>(json, options);
                }
                ...
                /// </exception>
                public static RequiredSchemeAndType ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<RequiredSchemeAndType>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredSchemeAndType? result)
                {
                    return JsonElementHelpers.TryParseValue<RequiredSchemeAndType>(ref reader, out result);
                }
...
#if NET
                static RequiredSchemeAndType IJsonElement<RequiredSchemeAndType>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RequiredSchemeAndType: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public RequiredSchemeAndType Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public RequiredSchemeAndType Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<RequiredSchemeAndType>(_idx);
                    }
