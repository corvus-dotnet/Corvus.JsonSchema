...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct SecurityScheme
    {
        ...
        public readonly partial struct TypeHttpBearerEntity
            ...
            : IJsonElement<TypeHttpBearerEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            internal TypeHttpBearerEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public Corvus.OpenapiBenchmark.Current.JsonString BearerFormat
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BearerFormatUtf8, out Corvus.OpenapiBenchmark.Current.JsonString value))
                    {
                        return value;
                    }
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in TypeHttpBearerEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(TypeHttpBearerEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TypeHttpBearerEntity(JsonElement instance)
            {
                return TypeHttpBearerEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TypeHttpBearerEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TypeHttpBearerEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TypeHttpBearerEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TypeHttpBearerEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TypeHttpBearerEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TypeHttpBearerEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TypeHttpBearerEntity>(json, options);
            }
            ...
            /// </exception>
            public static TypeHttpBearerEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<TypeHttpBearerEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out TypeHttpBearerEntity? result)
            {
                return JsonElementHelpers.TryParseValue<TypeHttpBearerEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new TypeHttpBearerEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static TypeHttpBearerEntity IJsonElement<TypeHttpBearerEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TypeHttpBearerEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="TypeHttpBearerEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="TypeHttpBearerEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public TypeHttpBearerEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<TypeHttpBearerEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="TypeHttpBearerEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public TypeHttpBearerEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<TypeHttpBearerEntity>(_idx);
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsRequiredSchemeAndType(out Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType result)
            {
                if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.From(this);
                    return true;
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpBearerEntity.ThenEntity" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsThenEntity(out Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpBearerEntity.ThenEntity result)
            {
                if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpBearerEntity.ThenEntity.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpBearerEntity.ThenEntity.From(this);
                    return true;
                }
            ...
            /// <param name="matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaSecuritySchemeTypeHttpBearerEntityThenEntity">Match a <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpBearerEntity.ThenEntity"/>.</param>
            ...
            public TResult Match<TContext, TResult>(
                in TContext context,
                Matcher<Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpBearerEntity.ThenEntity, TContext, TResult> matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaSecuritySchemeTypeHttpBearerEntityThenEntity,
                Matcher<TypeHttpBearerEntity, TContext, TResult> defaultMatch)
...
#endif
            {
                if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaSecuritySchemeTypeHttpBearerEntityThenEntity(Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpBearerEntity.ThenEntity.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                Matcher<Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpBearerEntity.ThenEntity, TResult> matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaSecuritySchemeTypeHttpBearerEntityThenEntity,
                Matcher<TypeHttpBearerEntity, TResult> defaultMatch)
            {
                if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpBearerEntity.RequiredSchemeAndType.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaSecuritySchemeTypeHttpBearerEntityThenEntity(Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpBearerEntity.ThenEntity.From(this));
                }
