    ...
    public readonly partial struct SecurityScheme
    {
        ...
        public readonly partial struct TypeHttpEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(TypeHttpEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TypeHttpEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TypeHttpEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new TypeHttpEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TypeHttpEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="TypeHttpEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="TypeHttpEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly TypeHttpEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<TypeHttpEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="TypeHttpEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly TypeHttpEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TypeHttpEntity>(_idx);
                }
                ...
                /// <param name="matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaSecuritySchemeTypeHttpEntityRequiredScheme">Match a <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpEntity.RequiredScheme"/>.</param>
                ...
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Matcher<Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpEntity.RequiredScheme, TContext, TResult> matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaSecuritySchemeTypeHttpEntityRequiredScheme,
                    Matcher<TypeHttpEntity, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
                {
                    if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpEntity.RequiredType.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaSecuritySchemeTypeHttpEntityRequiredScheme(Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpEntity.RequiredScheme.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    Matcher<Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpEntity.RequiredScheme, TResult> matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaSecuritySchemeTypeHttpEntityRequiredScheme,
                    Matcher<TypeHttpEntity, TResult> defaultMatch)
                {
                    if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpEntity.RequiredType.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaSecuritySchemeTypeHttpEntityRequiredScheme(Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpEntity.RequiredScheme.From(this));
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpEntity.RequiredType.Mutable" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsRequiredType(out Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpEntity.RequiredType.Mutable result)
                {
                    if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpEntity.RequiredType.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpEntity.RequiredType.Mutable.From(this);
                        return true;
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpEntity.RequiredScheme.Mutable" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsRequiredScheme(out Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpEntity.RequiredScheme.Mutable result)
                {
                    if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpEntity.RequiredScheme.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpEntity.RequiredScheme.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source arg1)
                {
                    _createArg1 = arg1;
                    _kind = Kind.Create;
                }

                public static implicit operator Source(TypeHttpEntity instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.OpenapiBenchmark.Current.JsonString.Source scheme = default)
                {
                ...
                /// Creates an instance of a <see cref="TypeHttpEntity"/>.
                /// </summary>
                public void Create(in Corvus.OpenapiBenchmark.Current.JsonString.Source scheme = default)
                {
                    Create(ref _builder, scheme);
                }
                ...
                internal static void BuildCreateValue(scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source arg1, ref ComplexValueBuilder o)
                {
                    o.StartObject();
                    Create(ref o, arg1);
                    o.EndObject();
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source scheme = default)
            {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OpenapiBenchmark.Current.JsonString.Source scheme = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            {
                return workspace.CreateBuilder<TypeHttpEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<TypeHttpEntity> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TypeHttpEntity>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<TypeHttpEntity> Create<TContext>(
            ...
            public static ParsedJsonDocument<TypeHttpEntity> Create(in Corvus.OpenapiBenchmark.Current.JsonString.Source scheme = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
