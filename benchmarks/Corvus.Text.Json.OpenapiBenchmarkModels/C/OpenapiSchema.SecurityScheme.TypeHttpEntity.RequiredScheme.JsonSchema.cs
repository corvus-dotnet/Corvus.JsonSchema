    ...
    public readonly partial struct SecurityScheme
    {
        ...
        public readonly partial struct TypeHttpEntity
        {
                ...
                : IJsonElement<RequiredScheme>
            {
                ...
                {
                    private static readonly JsonSchemaMessageProvider<int> RequiredPropertySchemePresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("scheme"u8, buffer, out written);
                    private static readonly JsonSchemaMessageProvider<int> RequiredPropertySchemeNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("scheme"u8, buffer, out written);

                    private const int RequiredOffsetForScheme = 0;
                    private const uint RequiredBitForScheme = 0b00000000000000000000000000000001;

                    private const uint RequiredBitMask0 =
                        RequiredBitForScheme;
                    ...
                    private static void MatchScheme(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                    {
                        ...
                        Corvus.OpenapiBenchmark.Current.JsonString.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                        ...
                        requiredBitBuffer[RequiredOffsetForScheme] |= RequiredBitForScheme;
                    }
                    ...
                    {
                        if (span.SequenceEqual(JsonPropertyNames.SchemeUtf8))
                        {
                            matcher = MatchScheme;
                            return true;
                        }
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/security-scheme/$defs/type-http/then"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/security-scheme/$defs/type-http/then";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/security-scheme/$defs/type-http/then"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        if (tokenType == JsonTokenType.StartObject)
                        {
                            ...
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertySchemePresent, "scheme"u8, "required"u8);
                            }
                            ...
                            {
                                if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForScheme] & RequiredBitForScheme) == 0)
                                {
                                    context.EvaluatedKeywordForProperty(false, 0, RequiredPropertySchemeNotPresent, "scheme"u8, "required"u8);
                                }
                                else
                                {
                                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertySchemePresent, "scheme"u8, "required"u8);
