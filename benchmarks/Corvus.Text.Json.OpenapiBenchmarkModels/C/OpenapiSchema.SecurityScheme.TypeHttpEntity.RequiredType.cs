    ...
    public readonly partial struct SecurityScheme
    {
        ...
        public readonly partial struct TypeHttpEntity
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpEntity.RequiredType.TypeEntity Type
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpEntity.RequiredType.TypeEntity value))
                        {
                            return value;
                        }
