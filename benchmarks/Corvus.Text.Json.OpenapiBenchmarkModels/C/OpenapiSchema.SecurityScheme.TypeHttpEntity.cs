    ...
    public readonly partial struct SecurityScheme
    {
...
#endif
        {
            ...
            public bool TryGetAsRequiredType(out Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpEntity.RequiredType result)
            {
                ...
                {
                    result = Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpEntity.RequiredType.From(this);
                    return true;
                }
            ...
            public bool TryGetAsRequiredScheme(out Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpEntity.RequiredScheme result)
            {
                ...
                {
                    result = Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeHttpEntity.RequiredScheme.From(this);
                    return true;
                }
