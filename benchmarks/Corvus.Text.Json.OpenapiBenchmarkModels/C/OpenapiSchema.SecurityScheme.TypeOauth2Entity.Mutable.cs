    ...
    public readonly partial struct SecurityScheme
    {
        ...
        public readonly partial struct TypeOauth2Entity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(TypeOauth2Entity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TypeOauth2Entity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TypeOauth2Entity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TypeOauth2Entity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly TypeOauth2Entity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly TypeOauth2Entity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TypeOauth2Entity>(_idx);
                }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOauth2Entity.RequiredType.Mutable" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsRequiredType(out Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOauth2Entity.RequiredType.Mutable result)
                {
                    if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOauth2Entity.RequiredType.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOauth2Entity.RequiredType.Mutable.From(this);
                        return true;
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOauth2Entity.RequiredFlows.Mutable" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsRequiredFlows(out Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOauth2Entity.RequiredFlows.Mutable result)
                {
                    ...
                    {
                        result = Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOauth2Entity.RequiredFlows.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.OpenapiBenchmark.Current.OpenapiSchema.OauthFlows.Source _createArg1;
                ...
                public static implicit operator Source(TypeOauth2Entity instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                private readonly Corvus.OpenapiBenchmark.Current.OpenapiSchema.OauthFlows.Source<TContext> _createArg1;
            ...
            public ref struct Builder
            {
                ...
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.OauthFlows.Source flows = default)
                {
                ...
                /// Creates an instance of a <see cref="TypeOauth2Entity"/>.
                /// </summary>
                public void Create(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.OauthFlows.Source flows = default)
                {
                    Create(ref _builder, flows);
                }
                ...
                /// Creates an instance of a <see cref="TypeOauth2Entity"/>.
                /// </summary>
                public void Create<TContext>(in TContext context, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.OauthFlows.Source<TContext> flows = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
                    Create(context, ref _builder, flows);
                }
            ...
            public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.OauthFlows.Source<TContext> flows = default)
                ...
                #endif
            {
                return new Source<TContext>(context, flows);
            }
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.OauthFlows.Source flows = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.OauthFlows.Source<TContext> flows = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
            ...
            {
                return workspace.CreateBuilder<TypeOauth2Entity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<TypeOauth2Entity> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TypeOauth2Entity>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<TypeOauth2Entity> Create<TContext>(
            ...
            public static ParsedJsonDocument<TypeOauth2Entity> Create(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.OauthFlows.Source flows = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
            public static ParsedJsonDocument<TypeOauth2Entity> Create<TContext>(in TContext context, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.OauthFlows.Source<TContext> flows = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
