        ...
        public readonly partial struct TypeOauth2Entity
        {
            ...
            public readonly partial struct RequiredFlows
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(RequiredFlows instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="RequiredFlows"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RequiredFlows(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new RequiredFlows(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RequiredFlows.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="RequiredFlows"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="RequiredFlows"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RequiredFlows Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<RequiredFlows>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="RequiredFlows"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RequiredFlows Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<RequiredFlows>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOauth2Entity.RequiredFlows.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    public static implicit operator Source(RequiredFlows instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOauth2Entity.RequiredFlows.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// </summary>
                    internal static void Create(ref ComplexValueBuilder builder, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.OauthFlows.Source flows)
                    {
                    ...
                    /// Creates an instance of a <see cref="RequiredFlows"/>.
                    /// </summary>
                    public void Create(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.OauthFlows.Source flows)
                    {
                    ...
                    internal static void Create<TContext>(
                        ...
                        in Corvus.OpenapiBenchmark.Current.OpenapiSchema.OauthFlows.Source<TContext> flows)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                    {
                    ...
                    /// Creates an instance of a <see cref="RequiredFlows"/>.
                    /// </summary>
                    public void Create<TContext>(in TContext context, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.OauthFlows.Source<TContext> flows)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                    {
                ...
                /// <returns>The source from which to build the value.</returns>
                public static Source Build(scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.OauthFlows.Source flows)
                {
                ...
                /// <param name="flows">The value of the <c>"flows"</c> property.</param>
                /// <returns>The source from which to build the value.</returns>
                public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.OauthFlows.Source<TContext> flows)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.OauthFlows.Source flows, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.OauthFlows.Source<TContext> flows, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
                ...
                {
                    return workspace.CreateBuilder<RequiredFlows, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<RequiredFlows> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<RequiredFlows>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<RequiredFlows> Create<TContext>(
                ...
                public static ParsedJsonDocument<RequiredFlows> Create(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.OauthFlows.Source flows, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
                public static ParsedJsonDocument<RequiredFlows> Create<TContext>(in TContext context, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.OauthFlows.Source<TContext> flows, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
