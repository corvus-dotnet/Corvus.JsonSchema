    ...
    public readonly partial struct SecurityScheme
    {
        ...
        public readonly partial struct TypeOauth2Entity
        {
            ...
            public readonly partial struct RequiredFlows
            {
                ...
                /// <returns>The source from which to build the value.</returns>
                public static Source Build(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.OauthFlows.Source flows)
                {
                ...
                /// <param name="flows">The value of the <c>"flows"</c> property.</param>
                /// <returns>The source from which to build the value.</returns>
                public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.OauthFlows.Source<TContext> flows)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
