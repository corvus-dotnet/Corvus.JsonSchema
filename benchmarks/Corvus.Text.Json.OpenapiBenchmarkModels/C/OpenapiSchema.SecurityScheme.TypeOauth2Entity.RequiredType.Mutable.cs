        ...
        public readonly partial struct TypeOauth2Entity
        {
            ...
            public readonly partial struct RequiredType
            {
...
#endif
                {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOauth2Entity.RequiredType.TypeEntity.Mutable Type
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOauth2Entity.RequiredType.TypeEntity.Mutable value))
                            {
                                return value;
                            }
                    ...
                    public void SetType(scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOauth2Entity.RequiredType.TypeEntity.Source value)
                    {
                        CheckValidInstance();
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOauth2Entity.RequiredType.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOauth2Entity.RequiredType.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    {
                        builder.AddPrebakedProperty(JsonPropertyNamesPrebaked.Type, Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOauth2Entity.RequiredType.TypeEntity.ConstInstance);
                    }
