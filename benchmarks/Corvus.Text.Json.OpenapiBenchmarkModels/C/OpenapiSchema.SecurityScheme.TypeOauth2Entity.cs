...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct SecurityScheme
    {
...
#endif
        {
            ...
            internal TypeOauth2Entity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public Corvus.OpenapiBenchmark.Current.OpenapiSchema.OauthFlows Flows
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FlowsUtf8, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.OauthFlows value))
                    {
                        return value;
                    }
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in TypeOauth2Entity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(TypeOauth2Entity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TypeOauth2Entity(JsonElement instance)
            {
                return TypeOauth2Entity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TypeOauth2Entity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TypeOauth2Entity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TypeOauth2Entity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TypeOauth2Entity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TypeOauth2Entity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TypeOauth2Entity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TypeOauth2Entity>(json, options);
            }
            ...
            /// </exception>
            public static TypeOauth2Entity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<TypeOauth2Entity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out TypeOauth2Entity? result)
            {
                return JsonElementHelpers.TryParseValue<TypeOauth2Entity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new TypeOauth2Entity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static TypeOauth2Entity IJsonElement<TypeOauth2Entity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TypeOauth2Entity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="TypeOauth2Entity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="TypeOauth2Entity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public TypeOauth2Entity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<TypeOauth2Entity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="TypeOauth2Entity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public TypeOauth2Entity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<TypeOauth2Entity>(_idx);
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOauth2Entity.RequiredType" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsRequiredType(out Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOauth2Entity.RequiredType result)
            {
                if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOauth2Entity.RequiredType.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOauth2Entity.RequiredType.From(this);
                    return true;
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOauth2Entity.RequiredFlows" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsRequiredFlows(out Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOauth2Entity.RequiredFlows result)
            {
                if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOauth2Entity.RequiredFlows.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOauth2Entity.RequiredFlows.From(this);
                    return true;
                }
            ...
            /// <param name="matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaSecuritySchemeTypeOauth2EntityRequiredFlows">Match a <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOauth2Entity.RequiredFlows"/>.</param>
            ...
            public TResult Match<TContext, TResult>(
                in TContext context,
                Matcher<Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOauth2Entity.RequiredFlows, TContext, TResult> matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaSecuritySchemeTypeOauth2EntityRequiredFlows,
                Matcher<TypeOauth2Entity, TContext, TResult> defaultMatch)
...
#endif
            {
                if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOauth2Entity.RequiredType.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaSecuritySchemeTypeOauth2EntityRequiredFlows(Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOauth2Entity.RequiredFlows.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                Matcher<Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOauth2Entity.RequiredFlows, TResult> matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaSecuritySchemeTypeOauth2EntityRequiredFlows,
                Matcher<TypeOauth2Entity, TResult> defaultMatch)
            {
                if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOauth2Entity.RequiredType.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaSecuritySchemeTypeOauth2EntityRequiredFlows(Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOauth2Entity.RequiredFlows.From(this));
                }
            ...
            {
                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="Flows"/>.
                /// </summary>
                public static ReadOnlySpan<byte> Flows => [0x75, 0x00, 0x00, 0x00, 0x22, 0x66, 0x6C, 0x6F, 0x77, 0x73, 0x22];
            }
        }
    }
}
