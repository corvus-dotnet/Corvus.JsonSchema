    ...
    public readonly partial struct SecurityScheme
    {
        ...
        public readonly partial struct TypeOidcEntity
        {
...
#endif
            {
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOidcEntity.RequiredType.Mutable" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsRequiredType(out Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOidcEntity.RequiredType.Mutable result)
                {
                    if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOidcEntity.RequiredType.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOidcEntity.RequiredType.Mutable.From(this);
                        return true;
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOidcEntity.RequiredOpenIdConnectUrl.Mutable" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsRequiredOpenIdConnectUrl(out Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOidcEntity.RequiredOpenIdConnectUrl.Mutable result)
                {
                    ...
                    {
                        result = Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOidcEntity.RequiredOpenIdConnectUrl.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOidcEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOidcEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.OpenapiBenchmark.Current.JsonUri.Source openIdConnectUrl = default)
                {
                ...
                /// Creates an instance of a <see cref="TypeOidcEntity"/>.
                /// </summary>
                public void Create(in Corvus.OpenapiBenchmark.Current.JsonUri.Source openIdConnectUrl = default)
                {
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.OpenapiBenchmark.Current.JsonUri.Source openIdConnectUrl = default)
            {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OpenapiBenchmark.Current.JsonUri.Source openIdConnectUrl = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            public static ParsedJsonDocument<TypeOidcEntity> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TypeOidcEntity>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<TypeOidcEntity> Create<TContext>(
            ...
            public static ParsedJsonDocument<TypeOidcEntity> Create(in Corvus.OpenapiBenchmark.Current.JsonUri.Source openIdConnectUrl = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
