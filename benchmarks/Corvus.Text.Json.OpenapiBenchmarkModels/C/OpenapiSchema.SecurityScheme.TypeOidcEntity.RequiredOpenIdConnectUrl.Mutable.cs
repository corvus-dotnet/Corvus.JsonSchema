        ...
        public readonly partial struct TypeOidcEntity
        {
            ...
            public readonly partial struct RequiredOpenIdConnectUrl
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(RequiredOpenIdConnectUrl instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="RequiredOpenIdConnectUrl"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RequiredOpenIdConnectUrl(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new RequiredOpenIdConnectUrl(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    public void SetOpenIdConnectUrl(scoped in Corvus.OpenapiBenchmark.Current.JsonUri.Source value)
                    {
                        ...
                        {
                            CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("openIdConnectUrl");
                        }
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RequiredOpenIdConnectUrl.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="RequiredOpenIdConnectUrl"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="RequiredOpenIdConnectUrl"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RequiredOpenIdConnectUrl Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<RequiredOpenIdConnectUrl>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="RequiredOpenIdConnectUrl"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RequiredOpenIdConnectUrl Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<RequiredOpenIdConnectUrl>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOidcEntity.RequiredOpenIdConnectUrl.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    internal Source(scoped in Corvus.OpenapiBenchmark.Current.JsonUri.Source arg1)
                    {
                        _createArg1 = arg1;
                        _kind = Kind.Create;
                    }

                    public static implicit operator Source(RequiredOpenIdConnectUrl instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOidcEntity.RequiredOpenIdConnectUrl.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    internal static void BuildCreateValue(scoped in Corvus.OpenapiBenchmark.Current.JsonUri.Source arg1, ref ComplexValueBuilder o)
                    {
                        o.StartObject();
                        Create(ref o, arg1);
                        o.EndObject();
                ...
                /// <returns>The source from which to build the value.</returns>
                public static Source Build(scoped in Corvus.OpenapiBenchmark.Current.JsonUri.Source openIdConnectUrl)
                {
                    return new Source(openIdConnectUrl);
                }
                ...
                {
                    return workspace.CreateBuilder<RequiredOpenIdConnectUrl, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<RequiredOpenIdConnectUrl> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<RequiredOpenIdConnectUrl>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<RequiredOpenIdConnectUrl> Create<TContext>(
                ...
                public static ParsedJsonDocument<RequiredOpenIdConnectUrl> Create(in Corvus.OpenapiBenchmark.Current.JsonUri.Source openIdConnectUrl, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
