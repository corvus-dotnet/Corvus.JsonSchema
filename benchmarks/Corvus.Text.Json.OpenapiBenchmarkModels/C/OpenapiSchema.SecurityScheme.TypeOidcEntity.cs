...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct SecurityScheme
    {
...
#endif
        {
            ...
            internal TypeOidcEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static TypeOidcEntity DefaultInstance { get; }
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in TypeOidcEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(TypeOidcEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TypeOidcEntity(JsonElement instance)
            {
                return TypeOidcEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TypeOidcEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TypeOidcEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TypeOidcEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TypeOidcEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TypeOidcEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TypeOidcEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TypeOidcEntity>(json, options);
            }
            ...
            /// </exception>
            public static TypeOidcEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<TypeOidcEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out TypeOidcEntity? result)
            {
                return JsonElementHelpers.TryParseValue<TypeOidcEntity>(ref reader, out result);
            }
...
#if NET
            static TypeOidcEntity IJsonElement<TypeOidcEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TypeOidcEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public TypeOidcEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<TypeOidcEntity>(_idx);
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOidcEntity.RequiredType" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsRequiredType(out Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOidcEntity.RequiredType result)
            {
                if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOidcEntity.RequiredType.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOidcEntity.RequiredType.From(this);
                    return true;
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOidcEntity.RequiredOpenIdConnectUrl" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsRequiredOpenIdConnectUrl(out Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOidcEntity.RequiredOpenIdConnectUrl result)
            {
                if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOidcEntity.RequiredOpenIdConnectUrl.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOidcEntity.RequiredOpenIdConnectUrl.From(this);
                    return true;
                }
            ...
            /// <param name="matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaSecuritySchemeTypeOidcEntityRequiredOpenIdConnectUrl">Match a <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOidcEntity.RequiredOpenIdConnectUrl"/>.</param>
            ...
            public TResult Match<TContext, TResult>(
                in TContext context,
                Matcher<Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOidcEntity.RequiredOpenIdConnectUrl, TContext, TResult> matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaSecuritySchemeTypeOidcEntityRequiredOpenIdConnectUrl,
...
#endif
            {
                if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOidcEntity.RequiredType.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaSecuritySchemeTypeOidcEntityRequiredOpenIdConnectUrl(Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOidcEntity.RequiredOpenIdConnectUrl.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                Matcher<Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOidcEntity.RequiredOpenIdConnectUrl, TResult> matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaSecuritySchemeTypeOidcEntityRequiredOpenIdConnectUrl,
                Matcher<TypeOidcEntity, TResult> defaultMatch)
            {
                if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOidcEntity.RequiredType.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchCorvusOpenapiBenchmarkCurrentOpenapiSchemaSecuritySchemeTypeOidcEntityRequiredOpenIdConnectUrl(Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.TypeOidcEntity.RequiredOpenIdConnectUrl.From(this));
                }
