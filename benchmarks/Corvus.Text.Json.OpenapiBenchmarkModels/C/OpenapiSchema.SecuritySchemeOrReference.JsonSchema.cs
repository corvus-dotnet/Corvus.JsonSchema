...
public readonly partial struct OpenapiSchema
{
        ...
        : IJsonElement<SecuritySchemeOrReference>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/$defs/security-scheme-or-reference"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/$defs/security-scheme-or-reference";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/$defs/security-scheme-or-reference"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                JsonSchemaContext ifContext =
                    Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecuritySchemeOrReference.RequiredRef.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: IfSchemaEvaluationPath);
                Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecuritySchemeOrReference.RequiredRef.JsonSchema.Evaluate(parentDocument, parentIndex, ref ifContext);
                ...
                else
                {
                    JsonSchemaContext elseContext =
                        Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: ElseSchemaEvaluationPath);
                    Corvus.OpenapiBenchmark.Current.OpenapiSchema.SecurityScheme.JsonSchema.Evaluate(parentDocument, parentIndex, ref elseContext);
