...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct Server
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.OpenapiBenchmark.Current.JsonUriReference.Mutable Url
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UrlUtf8, out Corvus.OpenapiBenchmark.Current.JsonUriReference.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public Corvus.OpenapiBenchmark.Current.OpenapiSchema.Server.VariablesEntity.Mutable Variables
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VariablesUtf8, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.Server.VariablesEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetUrl(scoped in Corvus.OpenapiBenchmark.Current.JsonUriReference.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetVariables(scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Server.VariablesEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetVariables<TContext>(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Server.VariablesEntity.Source<TContext> value)
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.OpenapiBenchmark.Current.OpenapiSchema.Server.VariablesEntity.Source _createArg3;
            ...
            internal Source(Corvus.OpenapiBenchmark.Current.OpenapiSchema.Server.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.OpenapiBenchmark.Current.JsonUriReference.Source arg1, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source arg2, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Server.VariablesEntity.Source arg3)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _createArg3 = arg3;
            ...
            #endif
        {
            ...
            private readonly Corvus.OpenapiBenchmark.Current.JsonUriReference.Source _createArg1;
            private readonly Corvus.OpenapiBenchmark.Current.JsonString.Source _createArg2;
            private readonly Corvus.OpenapiBenchmark.Current.OpenapiSchema.Server.VariablesEntity.Source<TContext> _createArg3;
            ...
            internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Current.OpenapiSchema.Server.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in TContext context, scoped in Corvus.OpenapiBenchmark.Current.JsonUriReference.Source arg1, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source arg2, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Server.VariablesEntity.Source<TContext> arg3)
            {
                _context = context;
                _createArg1 = arg1;
                _createArg2 = arg2;
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.OpenapiBenchmark.Current.JsonUriReference.Source url,
                in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default,
                in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Server.VariablesEntity.Source variables = default)
            {
            ...
            internal static void Create<TContext>(
                ...
                in Corvus.OpenapiBenchmark.Current.JsonUriReference.Source url,
                in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default,
                in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Server.VariablesEntity.Source<TContext> variables = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            internal static void BuildCreateValue(scoped in Corvus.OpenapiBenchmark.Current.JsonUriReference.Source arg1, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source arg2, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Server.VariablesEntity.Source arg3, ref ComplexValueBuilder o)
            {
                o.StartObject();
            ...
            /// <param name="arg3">The value of the property.</param>
            /// <param name="o">The complex value builder into which to write the object.</param>
            internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.OpenapiBenchmark.Current.JsonUriReference.Source arg1, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source arg2, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Server.VariablesEntity.Source<TContext> arg3, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.OpenapiBenchmark.Current.JsonUriReference.Source url, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Server.VariablesEntity.Source variables = default)
        {
            return new Source(url, description, variables);
        }
        ...
        /// <param name="variables">The value of the <c>"variables"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.OpenapiBenchmark.Current.JsonUriReference.Source url, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Server.VariablesEntity.Source<TContext> variables = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            return new Source<TContext>(context, url, description, variables);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OpenapiBenchmark.Current.JsonUriReference.Source url, in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Server.VariablesEntity.Source variables = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.OpenapiBenchmark.Current.JsonUriReference.Source url, in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Server.VariablesEntity.Source<TContext> variables = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
        ...
        public static ParsedJsonDocument<Server> Create(in Corvus.OpenapiBenchmark.Current.JsonUriReference.Source url, in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Server.VariablesEntity.Source variables = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Server> Create<TContext>(in TContext context, in Corvus.OpenapiBenchmark.Current.JsonUriReference.Source url, in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Server.VariablesEntity.Source<TContext> variables = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
