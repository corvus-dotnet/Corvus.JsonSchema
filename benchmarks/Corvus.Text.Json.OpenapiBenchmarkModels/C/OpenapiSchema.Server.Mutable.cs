...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct Server
    {
...
#endif
        {
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetUrl(in Corvus.OpenapiBenchmark.Current.JsonUriReference.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetVariables(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Server.VariablesEntity.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(in Corvus.OpenapiBenchmark.Current.JsonUriReference.Source arg1, in Corvus.OpenapiBenchmark.Current.JsonString.Source arg2, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Server.VariablesEntity.Source arg3)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _createArg3 = arg3;
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, in Corvus.OpenapiBenchmark.Current.JsonUriReference.Source arg1, in Corvus.OpenapiBenchmark.Current.JsonString.Source arg2, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Server.VariablesEntity.Source<TContext> arg3)
            {
                _context = context;
                _createArg1 = arg1;
                _createArg2 = arg2;
        ...
        public ref struct Builder
        {
            ...
            internal static void BuildCreateValue(in Corvus.OpenapiBenchmark.Current.JsonUriReference.Source arg1, in Corvus.OpenapiBenchmark.Current.JsonString.Source arg2, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Server.VariablesEntity.Source arg3, ref ComplexValueBuilder o)
            {
                o.StartObject();
            ...
            /// <param name="arg3">The value of the property.</param>
            /// <param name="o">The complex value builder into which to write the object.</param>
            internal static void BuildCreateValue<TContext>(scoped in TContext context, in Corvus.OpenapiBenchmark.Current.JsonUriReference.Source arg1, in Corvus.OpenapiBenchmark.Current.JsonString.Source arg2, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Server.VariablesEntity.Source<TContext> arg3, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(in Corvus.OpenapiBenchmark.Current.JsonUriReference.Source url, in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Server.VariablesEntity.Source variables = default)
        {
        ...
        /// <param name="variables">The value of the <c>"variables"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.OpenapiBenchmark.Current.JsonUriReference.Source url, in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Server.VariablesEntity.Source<TContext> variables = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
