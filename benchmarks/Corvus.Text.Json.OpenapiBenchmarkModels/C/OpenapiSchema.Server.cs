...
public readonly partial struct OpenapiSchema
{
...
#endif
    {
        ...
        /// </summary>
        public Corvus.OpenapiBenchmark.Current.OpenapiSchema.Server.VariablesEntity Variables
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VariablesUtf8, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.Server.VariablesEntity value))
                {
                    return value;
                }
        ...
        public static implicit operator Corvus.OpenapiBenchmark.Current.OpenapiSchema.SpecificationExtensions(Server value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Server(Corvus.OpenapiBenchmark.Current.OpenapiSchema.SpecificationExtensions value)
        {
            return From(value);
        }
