...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct ServerVariable
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ServerVariable instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ServerVariable"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ServerVariable(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.OpenapiBenchmark.Current.JsonString.Mutable Default
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DefaultUtf8, out Corvus.OpenapiBenchmark.Current.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public Corvus.OpenapiBenchmark.Current.OpenapiSchema.ServerVariable.JsonStringArray.Mutable Enum
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EnumUtf8, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.ServerVariable.JsonStringArray.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetDefault(scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetEnum(scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.ServerVariable.JsonStringArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetEnum<TContext>(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.ServerVariable.JsonStringArray.Source<TContext> value)
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ServerVariable.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ServerVariable Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ServerVariable Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ServerVariable>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.OpenapiBenchmark.Current.OpenapiSchema.ServerVariable.JsonStringArray.Source _createArg3;
            ...
            internal Source(Corvus.OpenapiBenchmark.Current.OpenapiSchema.ServerVariable.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source arg1, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source arg2, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.ServerVariable.JsonStringArray.Source arg3)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _createArg3 = arg3;
            ...
            public static implicit operator Source(ServerVariable instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            private readonly Corvus.OpenapiBenchmark.Current.JsonString.Source _createArg1;
            private readonly Corvus.OpenapiBenchmark.Current.JsonString.Source _createArg2;
            private readonly Corvus.OpenapiBenchmark.Current.OpenapiSchema.ServerVariable.JsonStringArray.Source<TContext> _createArg3;
            ...
            internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Current.OpenapiSchema.ServerVariable.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in TContext context, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source arg1, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source arg2, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.ServerVariable.JsonStringArray.Source<TContext> arg3)
            {
                _context = context;
                _createArg1 = arg1;
                _createArg2 = arg2;
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.OpenapiBenchmark.Current.JsonString.Source defaultValue,
                in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default,
                in Corvus.OpenapiBenchmark.Current.OpenapiSchema.ServerVariable.JsonStringArray.Source enumValue = default)
            {
            ...
            public void Create(
                ...
                in Corvus.OpenapiBenchmark.Current.OpenapiSchema.ServerVariable.JsonStringArray.Source enumValue = default)
            {
                Create(ref _builder, defaultValue, description, enumValue);
            }
            ...
            internal static void Create<TContext>(
                ...
                in Corvus.OpenapiBenchmark.Current.JsonString.Source defaultValue,
                in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default,
                in Corvus.OpenapiBenchmark.Current.OpenapiSchema.ServerVariable.JsonStringArray.Source<TContext> enumValue = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            #endif
            {
                Create(context, ref _builder, defaultValue, description, enumValue);
            }
            ...
            internal static void BuildCreateValue(scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source arg1, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source arg2, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.ServerVariable.JsonStringArray.Source arg3, ref ComplexValueBuilder o)
            {
                o.StartObject();
            ...
            /// <param name="arg3">The value of the property.</param>
            /// <param name="o">The complex value builder into which to write the object.</param>
            internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source arg1, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source arg2, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.ServerVariable.JsonStringArray.Source<TContext> arg3, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source defaultValue, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.ServerVariable.JsonStringArray.Source enumValue = default)
        {
            return new Source(defaultValue, description, enumValue);
        }
        ...
        /// <param name="enumValue">The value of the <c>"enum"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source defaultValue, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.ServerVariable.JsonStringArray.Source<TContext> enumValue = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            return new Source<TContext>(context, defaultValue, description, enumValue);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OpenapiBenchmark.Current.JsonString.Source defaultValue, in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.ServerVariable.JsonStringArray.Source enumValue = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(defaultValue, description, enumValue);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.OpenapiBenchmark.Current.JsonString.Source defaultValue, in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.ServerVariable.JsonStringArray.Source<TContext> enumValue = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            ...
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(context, defaultValue, description, enumValue);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<ServerVariable, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ServerVariable> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ServerVariable>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ServerVariable> Create<TContext>(
        ...
        public static ParsedJsonDocument<ServerVariable> Create(in Corvus.OpenapiBenchmark.Current.JsonString.Source defaultValue, in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.ServerVariable.JsonStringArray.Source enumValue = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ServerVariable> Create<TContext>(in TContext context, in Corvus.OpenapiBenchmark.Current.JsonString.Source defaultValue, in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.ServerVariable.JsonStringArray.Source<TContext> enumValue = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
