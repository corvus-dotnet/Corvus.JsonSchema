...
public readonly partial struct OpenapiSchema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.OpenapiBenchmark.Current.JsonString Default
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DefaultUtf8, out Corvus.OpenapiBenchmark.Current.JsonString value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.OpenapiBenchmark.Current.OpenapiSchema.ServerVariable.JsonStringArray Enum
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EnumUtf8, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.ServerVariable.JsonStringArray value))
                {
                    return value;
                }
        ...
        public static implicit operator Corvus.OpenapiBenchmark.Current.OpenapiSchema.SpecificationExtensions(ServerVariable value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator ServerVariable(Corvus.OpenapiBenchmark.Current.OpenapiSchema.SpecificationExtensions value)
        {
            return From(value);
        }
