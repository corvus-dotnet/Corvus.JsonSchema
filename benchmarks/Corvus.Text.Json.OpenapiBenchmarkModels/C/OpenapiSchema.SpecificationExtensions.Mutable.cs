...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct SpecificationExtensions
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(SpecificationExtensions instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="SpecificationExtensions"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SpecificationExtensions(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SpecificationExtensions.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly SpecificationExtensions Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly SpecificationExtensions Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<SpecificationExtensions>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.OpenapiBenchmark.Current.OpenapiSchema.SpecificationExtensions.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(SpecificationExtensions instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Current.OpenapiSchema.SpecificationExtensions.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<SpecificationExtensions, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<SpecificationExtensions> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<SpecificationExtensions>();
            }
            finally
            {
