...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct SpecificationExtensions
        ...
        : IJsonElement<SpecificationExtensions>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        internal SpecificationExtensions(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in SpecificationExtensions left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(SpecificationExtensions instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator SpecificationExtensions(JsonElement instance)
        {
            return SpecificationExtensions.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SpecificationExtensions From<T>(in T instance)
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out SpecificationExtensions? result)
        {
            return JsonElementHelpers.TryParseValue<SpecificationExtensions>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new SpecificationExtensions(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static SpecificationExtensions IJsonElement<SpecificationExtensions>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"SpecificationExtensions: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="SpecificationExtensions"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="SpecificationExtensions"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public SpecificationExtensions Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<SpecificationExtensions>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="SpecificationExtensions"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public SpecificationExtensions Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<SpecificationExtensions>(_idx);
            }
