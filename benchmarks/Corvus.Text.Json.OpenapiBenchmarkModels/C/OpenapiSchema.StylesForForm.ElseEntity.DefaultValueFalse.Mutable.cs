        ...
        public readonly partial struct ElseEntity
        {
            ...
            public readonly partial struct DefaultValueFalse
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DefaultValueFalse, Mutable>(DefaultValueFalse.DefaultInstance);
                ...
                public static ParsedJsonDocument<DefaultValueFalse> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<DefaultValueFalse>();
                    }
                    finally
                    {
