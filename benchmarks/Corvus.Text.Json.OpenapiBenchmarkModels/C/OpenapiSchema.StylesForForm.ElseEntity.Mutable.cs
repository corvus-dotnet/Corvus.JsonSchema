    ...
    public readonly partial struct StylesForForm
    {
        ...
        public readonly partial struct ElseEntity
        {
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.ElseEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.ElseEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public static ParsedJsonDocument<ElseEntity> Create(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.ElseEntity.DefaultValueFalse.Source explode = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
