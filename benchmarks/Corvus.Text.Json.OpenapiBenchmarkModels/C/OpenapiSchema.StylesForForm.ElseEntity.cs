...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct StylesForForm
    {
...
#endif
        {
            ...
            /// </summary>
            public Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.ElseEntity.DefaultValueFalse Explode
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExplodeUtf8, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.ElseEntity.DefaultValueFalse value))
                    {
                        return value;
                    }

                    return Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.ElseEntity.DefaultValueFalse.DefaultInstance;
                }
            }
