...
public readonly partial struct OpenapiSchema
{
        ...
        : IJsonElement<StylesForForm>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/styles-for-form"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/styles-for-form";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://spec.openapis.org/oas/3.1/schema/2022-10-07#/$defs/styles-for-form"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                JsonSchemaContext ifContext =
                    Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.RequiredStyle.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: IfSchemaEvaluationPath);
                Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.RequiredStyle.JsonSchema.Evaluate(parentDocument, parentIndex, ref ifContext);
                ...
                if (ifContext.IsMatch)
                {
                    ...
                    JsonSchemaContext thenContext =
                        Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.ThenEntity.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: ThenSchemaEvaluationPath);
                    Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.ThenEntity.JsonSchema.Evaluate(parentDocument, parentIndex, ref thenContext);
                ...
                else
                {
                    JsonSchemaContext elseContext =
                        Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.ElseEntity.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: ElseSchemaEvaluationPath);
                    Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.ElseEntity.JsonSchema.Evaluate(parentDocument, parentIndex, ref elseContext);
