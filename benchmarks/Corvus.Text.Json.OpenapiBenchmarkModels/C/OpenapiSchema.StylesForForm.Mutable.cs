...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct StylesForForm
    {
...
#endif
        {
            ...
            /// </summary>
            public Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.ElseEntity.DefaultValueFalse.Mutable Explode
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExplodeUtf8, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.ElseEntity.DefaultValueFalse.Mutable value))
                    {
                        return value;
                    }

                    return Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.ElseEntity.DefaultValueFalse.Mutable.DefaultInstance;
                }
            }
            ...
            public void SetExplode(scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.ElseEntity.DefaultValueFalse.Source value)
            {
                CheckValidInstance();
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.ElseEntity.Mutable" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsElseEntity(out Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.ElseEntity.Mutable result)
            {
                if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.ElseEntity.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.ElseEntity.Mutable.From(this);
                    return true;
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.RequiredStyle.Mutable" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsRequiredStyle(out Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.RequiredStyle.Mutable result)
            {
                if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.RequiredStyle.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.RequiredStyle.Mutable.From(this);
                    return true;
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.ThenEntity.Mutable" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsThenEntity(out Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.ThenEntity.Mutable result)
            {
                if (Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.ThenEntity.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.ThenEntity.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.ElseEntity.DefaultValueFalse.Source _createArg1;
            ...
            internal Source(Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.ElseEntity.DefaultValueFalse.Source arg1)
            {
                _createArg1 = arg1;
                _kind = Kind.Create;
            }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.ElseEntity.DefaultValueFalse.Source explode = default)
            {
            ...
            /// Creates an instance of a <see cref="StylesForForm"/>.
            /// </summary>
            public void Create(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.ElseEntity.DefaultValueFalse.Source explode = default)
            {
            ...
            internal static void BuildCreateValue(scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.ElseEntity.DefaultValueFalse.Source arg1, ref ComplexValueBuilder o)
            {
                o.StartObject();
                Create(ref o, arg1);
                o.EndObject();
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.ElseEntity.DefaultValueFalse.Source explode = default)
        {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.ElseEntity.DefaultValueFalse.Source explode = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        public static ParsedJsonDocument<StylesForForm> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<StylesForForm>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<StylesForForm> Create<TContext>(
        ...
        public static ParsedJsonDocument<StylesForForm> Create(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.ElseEntity.DefaultValueFalse.Source explode = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
