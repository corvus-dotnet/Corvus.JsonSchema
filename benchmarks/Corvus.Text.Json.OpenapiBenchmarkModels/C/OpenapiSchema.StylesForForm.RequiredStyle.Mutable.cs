    ...
    public readonly partial struct StylesForForm
    {
        ...
        public readonly partial struct RequiredStyle
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RequiredStyle instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RequiredStyle"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RequiredStyle(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.RequiredStyle.StyleEntity.Mutable Style
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StyleUtf8, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.RequiredStyle.StyleEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetStyle(scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.RequiredStyle.StyleEntity.Source value)
                {
                    CheckValidInstance();

                    if (value.IsUndefined)
                    {
                        CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("style");
                    }
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RequiredStyle.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredStyle Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredStyle Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RequiredStyle>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.RequiredStyle.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(RequiredStyle instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.RequiredStyle.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                {
                    builder.AddPrebakedProperty(JsonPropertyNamesPrebaked.Style, Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.RequiredStyle.StyleEntity.ConstInstance);
                }
            ...
            {
                return workspace.CreateBuilder<RequiredStyle, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RequiredStyle> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RequiredStyle>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RequiredStyle> Create<TContext>(
