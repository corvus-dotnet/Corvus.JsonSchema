        ...
        public readonly partial struct ThenEntity
        {
            ...
            public readonly partial struct DefaultValueTrue
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DefaultValueTrue, Mutable>(DefaultValueTrue.DefaultInstance);
                    ...
                    public static explicit operator Mutable(DefaultValueTrue instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="DefaultValueTrue"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator DefaultValueTrue(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"DefaultValueTrue.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DefaultValueTrue Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DefaultValueTrue Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<DefaultValueTrue>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(DefaultValueTrue instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<DefaultValueTrue, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<DefaultValueTrue> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<DefaultValueTrue>();
                    }
                    finally
                    {
