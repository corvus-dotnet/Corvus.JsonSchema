    ...
    public readonly partial struct StylesForForm
    {
        ...
        public readonly partial struct ThenEntity
        {
...
#endif
            {
                ...
                internal DefaultValueTrue(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static DefaultValueTrue DefaultInstance { get; } = ParsedJsonDocument<DefaultValueTrue>.True;
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in DefaultValueTrue left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(DefaultValueTrue instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DefaultValueTrue(JsonElement instance)
                {
                    return DefaultValueTrue.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DefaultValueTrue From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DefaultValueTrue ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<DefaultValueTrue>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DefaultValueTrue ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<DefaultValueTrue>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DefaultValueTrue ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<DefaultValueTrue>(json, options);
                }
                ...
                /// </exception>
                public static DefaultValueTrue ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<DefaultValueTrue>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out DefaultValueTrue? result)
                {
                    return JsonElementHelpers.TryParseValue<DefaultValueTrue>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new DefaultValueTrue(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static DefaultValueTrue IJsonElement<DefaultValueTrue>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DefaultValueTrue: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="DefaultValueTrue"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="DefaultValueTrue"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public DefaultValueTrue Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<DefaultValueTrue>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="DefaultValueTrue"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public DefaultValueTrue Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<DefaultValueTrue>(_idx);
                    }
