    ...
    public readonly partial struct StylesForForm
    {
        ...
        public readonly partial struct ThenEntity
        {
...
#endif
            {
                ...
                /// </summary>
                public Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.ThenEntity.DefaultValueTrue.Mutable Explode
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExplodeUtf8, out Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.ThenEntity.DefaultValueTrue.Mutable value))
                        {
                            return value;
                        }

                        return Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.ThenEntity.DefaultValueTrue.Mutable.DefaultInstance;
                    }
                }
                ...
                public void SetExplode(scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.ThenEntity.DefaultValueTrue.Source value)
                {
                    CheckValidInstance();
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.ThenEntity.DefaultValueTrue.Source _createArg1;
                ...
                internal Source(Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.ThenEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.ThenEntity.DefaultValueTrue.Source arg1)
                {
                    _createArg1 = arg1;
                    _kind = Kind.Create;
                }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.ThenEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.ThenEntity.DefaultValueTrue.Source explode = default)
                {
                ...
                /// Creates an instance of a <see cref="ThenEntity"/>.
                /// </summary>
                public void Create(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.ThenEntity.DefaultValueTrue.Source explode = default)
                {
                ...
                internal static void BuildCreateValue(scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.ThenEntity.DefaultValueTrue.Source arg1, ref ComplexValueBuilder o)
                {
                    o.StartObject();
                    Create(ref o, arg1);
                    o.EndObject();
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.ThenEntity.DefaultValueTrue.Source explode = default)
            {
                return new Source(explode);
            }
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.ThenEntity.DefaultValueTrue.Source explode = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            public static ParsedJsonDocument<ThenEntity> Create(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.StylesForForm.ThenEntity.DefaultValueTrue.Source explode = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
