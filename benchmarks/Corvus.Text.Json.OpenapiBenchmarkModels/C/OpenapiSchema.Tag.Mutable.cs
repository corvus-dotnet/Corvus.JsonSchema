...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct Tag
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Tag instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Tag"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Tag(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Tag.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly Tag Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Tag>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.OpenapiBenchmark.Current.OpenapiSchema.ExternalDocumentation.Source _createArg3;
            ...
            internal Source(Corvus.OpenapiBenchmark.Current.OpenapiSchema.Tag.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source arg1, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source arg2, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.ExternalDocumentation.Source arg3)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _createArg3 = arg3;
            ...
            public static implicit operator Source(Tag instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            private readonly Corvus.OpenapiBenchmark.Current.JsonString.Source _createArg1;
            private readonly Corvus.OpenapiBenchmark.Current.JsonString.Source _createArg2;
            private readonly Corvus.OpenapiBenchmark.Current.OpenapiSchema.ExternalDocumentation.Source<TContext> _createArg3;
            ...
            internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Current.OpenapiSchema.Tag.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in TContext context, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source arg1, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source arg2, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.ExternalDocumentation.Source<TContext> arg3)
            {
                _context = context;
                _createArg1 = arg1;
                _createArg2 = arg2;
        ...
        public ref struct Builder
        {
            ...
            public void Create(
                ...
                in Corvus.OpenapiBenchmark.Current.OpenapiSchema.ExternalDocumentation.Source externalDocs = default)
            {
                Create(ref _builder, name, description, externalDocs);
            }
            ...
            #endif
            {
                Create(context, ref _builder, name, description, externalDocs);
            }
            ...
            internal static void BuildCreateValue(scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source arg1, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source arg2, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.ExternalDocumentation.Source arg3, ref ComplexValueBuilder o)
            {
                o.StartObject();
            ...
            /// <param name="arg3">The value of the property.</param>
            /// <param name="o">The complex value builder into which to write the object.</param>
            internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source arg1, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source arg2, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.ExternalDocumentation.Source<TContext> arg3, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source name, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.ExternalDocumentation.Source externalDocs = default)
        {
            return new Source(name, description, externalDocs);
        }
        ...
        /// <param name="externalDocs">The value of the <c>"externalDocs"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source name, scoped in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.ExternalDocumentation.Source<TContext> externalDocs = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            return new Source<TContext>(context, name, description, externalDocs);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.OpenapiBenchmark.Current.JsonString.Source name, in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.ExternalDocumentation.Source externalDocs = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(name, description, externalDocs);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.OpenapiBenchmark.Current.JsonString.Source name, in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.ExternalDocumentation.Source<TContext> externalDocs = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            ...
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(context, name, description, externalDocs);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<Tag, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<Tag> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Tag>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Tag> Create<TContext>(
        ...
        public static ParsedJsonDocument<Tag> Create(in Corvus.OpenapiBenchmark.Current.JsonString.Source name, in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.ExternalDocumentation.Source externalDocs = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Tag> Create<TContext>(in TContext context, in Corvus.OpenapiBenchmark.Current.JsonString.Source name, in Corvus.OpenapiBenchmark.Current.JsonString.Source description = default, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.ExternalDocumentation.Source<TContext> externalDocs = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
