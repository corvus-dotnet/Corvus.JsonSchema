...
public readonly partial struct OpenapiSchema
{
    ...
    public readonly partial struct TagArray
    {
...
#endif
        {
            ...
            public Corvus.OpenapiBenchmark.Current.OpenapiSchema.Tag.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.OpenapiBenchmark.Current.OpenapiSchema.Tag.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.OpenapiBenchmark.Current.OpenapiSchema.Tag.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.OpenapiBenchmark.Current.OpenapiSchema.Tag.Mutable>(_parent, _idx);
            }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Tag.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Tag.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(scoped in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Tag.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Tag item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.OpenapiBenchmark.Current.OpenapiSchema.Tag>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Corvus.OpenapiBenchmark.Current.OpenapiSchema.Tag> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.OpenapiBenchmark.Current.OpenapiSchema.Tag>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Tag oldItem, in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Tag.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.OpenapiBenchmark.Current.OpenapiSchema.Tag>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Corvus.OpenapiBenchmark.Current.OpenapiSchema.Tag current = enumerator.Current;
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.OpenapiBenchmark.Current.OpenapiSchema.TagArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.OpenapiBenchmark.Current.OpenapiSchema.TagArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            public void AddItem(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Tag.Source value)
            {
            ...
            /// Add an item to the array.
            /// </summary>
            public void AddItem<TContext>(in Corvus.OpenapiBenchmark.Current.OpenapiSchema.Tag.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
