...
public readonly partial struct Schema
{
    ...
    public readonly partial struct FileTypes
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(FileTypes instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="FileTypes"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator FileTypes(Mutable instance)
            {
            ...
            public Corvus.PreCommitHooksBenchmark.Baseline.Schema.FileType.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.PreCommitHooksBenchmark.Baseline.Schema.FileType.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.PreCommitHooksBenchmark.Baseline.Schema.FileType.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.PreCommitHooksBenchmark.Baseline.Schema.FileType.Mutable>(_parent, _idx);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new FileTypes(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"FileTypes.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Corvus.PreCommitHooksBenchmark.Baseline.Schema.FileType.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, in Corvus.PreCommitHooksBenchmark.Baseline.Schema.FileType.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(in Corvus.PreCommitHooksBenchmark.Baseline.Schema.FileType.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Corvus.PreCommitHooksBenchmark.Baseline.Schema.FileType item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.PreCommitHooksBenchmark.Baseline.Schema.FileType>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Corvus.PreCommitHooksBenchmark.Baseline.Schema.FileType> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.PreCommitHooksBenchmark.Baseline.Schema.FileType>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Corvus.PreCommitHooksBenchmark.Baseline.Schema.FileType oldItem, in Corvus.PreCommitHooksBenchmark.Baseline.Schema.FileType.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.PreCommitHooksBenchmark.Baseline.Schema.FileType>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Corvus.PreCommitHooksBenchmark.Baseline.Schema.FileType current = enumerator.Current;
            ...
            /// <summary>
            /// Gets a <see cref="FileTypes"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="FileTypes"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly FileTypes Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<FileTypes>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="FileTypes"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly FileTypes Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<FileTypes>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.PreCommitHooksBenchmark.Baseline.Schema.FileTypes.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(FileTypes instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.PreCommitHooksBenchmark.Baseline.Schema.FileTypes.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<FileTypes, Mutable>(this);
        }
    }
}
