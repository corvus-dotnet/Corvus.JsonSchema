...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        public Corvus.PreCommitHooksBenchmark.Baseline.Schema.RequiredEntryAndIdAndLanguageAndName.Mutable this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.PreCommitHooksBenchmark.Baseline.Schema.RequiredEntryAndIdAndLanguageAndName.Mutable>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.PreCommitHooksBenchmark.Baseline.Schema.RequiredEntryAndIdAndLanguageAndName.Mutable> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.PreCommitHooksBenchmark.Baseline.Schema.RequiredEntryAndIdAndLanguageAndName.Mutable>(_parent, _idx);
        }
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetItem(int itemIndex, in Corvus.PreCommitHooksBenchmark.Baseline.Schema.RequiredEntryAndIdAndLanguageAndName.Source value)
        {
            CheckValidInstance();
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void InsertItem(int itemIndex, in Corvus.PreCommitHooksBenchmark.Baseline.Schema.RequiredEntryAndIdAndLanguageAndName.Source value)
        {
            CheckValidInstance();
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void AddItem(in Corvus.PreCommitHooksBenchmark.Baseline.Schema.RequiredEntryAndIdAndLanguageAndName.Source value)
        {
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool Remove(in Corvus.PreCommitHooksBenchmark.Baseline.Schema.RequiredEntryAndIdAndLanguageAndName item)
        {
            CheckValidInstance();
            if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.PreCommitHooksBenchmark.Baseline.Schema.RequiredEntryAndIdAndLanguageAndName>(this, in item))
            {
                return false;
            }
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void RemoveWhere(JsonPredicate<Corvus.PreCommitHooksBenchmark.Baseline.Schema.RequiredEntryAndIdAndLanguageAndName> predicate)
        {
            CheckValidInstance();
            JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.PreCommitHooksBenchmark.Baseline.Schema.RequiredEntryAndIdAndLanguageAndName>(this, predicate);
            _documentVersion = _parent.Version;
        }
        ...
        ///   The parent <see cref="JsonDocument"/> has been disposed.
        /// </exception>
        public bool Replace(in Corvus.PreCommitHooksBenchmark.Baseline.Schema.RequiredEntryAndIdAndLanguageAndName oldItem, in Corvus.PreCommitHooksBenchmark.Baseline.Schema.RequiredEntryAndIdAndLanguageAndName.Source newItem)
        {
            CheckValidInstance();
            ...
            var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.PreCommitHooksBenchmark.Baseline.Schema.RequiredEntryAndIdAndLanguageAndName>(_parent, _idx);

            while (enumerator.MoveNext())
            {
                Corvus.PreCommitHooksBenchmark.Baseline.Schema.RequiredEntryAndIdAndLanguageAndName current = enumerator.Current;
    ...
    public ref struct Source
    {
        ...
        internal Source(Corvus.PreCommitHooksBenchmark.Baseline.Schema.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.PreCommitHooksBenchmark.Baseline.Schema.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
