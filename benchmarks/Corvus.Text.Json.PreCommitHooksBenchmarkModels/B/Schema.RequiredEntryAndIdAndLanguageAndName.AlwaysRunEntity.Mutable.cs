    ...
    public readonly partial struct RequiredEntryAndIdAndLanguageAndName
    {
        ...
        public readonly partial struct AlwaysRunEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(AlwaysRunEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="AlwaysRunEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AlwaysRunEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AlwaysRunEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly AlwaysRunEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly AlwaysRunEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<AlwaysRunEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(AlwaysRunEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<AlwaysRunEntity, Mutable>(this);
            }
        }
    }
}
