...
public readonly partial struct Schema
{
    ...
    public readonly partial struct RequiredEntryAndIdAndLanguageAndName
    {
...
#endif
        {
            ...
            public Corvus.PreCommitHooksBenchmark.Baseline.JsonString this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.PreCommitHooksBenchmark.Baseline.JsonString>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.PreCommitHooksBenchmark.Baseline.JsonString> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.PreCommitHooksBenchmark.Baseline.JsonString>(_parent, _idx);
            }
