    ...
    public readonly partial struct RequiredEntryAndIdAndLanguageAndName
    {
        ...
        public readonly partial struct OptionalExcludeFilesThatWereMatchedByFiles
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(OptionalExcludeFilesThatWereMatchedByFiles instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="OptionalExcludeFilesThatWereMatchedByFiles"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator OptionalExcludeFilesThatWereMatchedByFiles(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"OptionalExcludeFilesThatWereMatchedByFiles.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly OptionalExcludeFilesThatWereMatchedByFiles Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly OptionalExcludeFilesThatWereMatchedByFiles Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<OptionalExcludeFilesThatWereMatchedByFiles>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(OptionalExcludeFilesThatWereMatchedByFiles instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<OptionalExcludeFilesThatWereMatchedByFiles, Mutable>(this);
            }
        }
    }
}
