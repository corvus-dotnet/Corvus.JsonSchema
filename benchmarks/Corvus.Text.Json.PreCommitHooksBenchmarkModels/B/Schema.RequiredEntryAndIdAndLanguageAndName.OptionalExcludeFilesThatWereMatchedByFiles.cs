...
public readonly partial struct Schema
{
    ...
    public readonly partial struct RequiredEntryAndIdAndLanguageAndName
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="OptionalExcludeFilesThatWereMatchedByFiles"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal OptionalExcludeFilesThatWereMatchedByFiles(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static OptionalExcludeFilesThatWereMatchedByFiles DefaultInstance { get; } = ParsedJsonDocument<OptionalExcludeFilesThatWereMatchedByFiles>.StringConstant([.."\"^$\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(OptionalExcludeFilesThatWereMatchedByFiles value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in OptionalExcludeFilesThatWereMatchedByFiles left, in OptionalExcludeFilesThatWereMatchedByFiles right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in OptionalExcludeFilesThatWereMatchedByFiles left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(OptionalExcludeFilesThatWereMatchedByFiles instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator OptionalExcludeFilesThatWereMatchedByFiles(JsonElement instance)
            {
                return OptionalExcludeFilesThatWereMatchedByFiles.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OptionalExcludeFilesThatWereMatchedByFiles From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OptionalExcludeFilesThatWereMatchedByFiles ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OptionalExcludeFilesThatWereMatchedByFiles>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OptionalExcludeFilesThatWereMatchedByFiles ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OptionalExcludeFilesThatWereMatchedByFiles>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OptionalExcludeFilesThatWereMatchedByFiles ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OptionalExcludeFilesThatWereMatchedByFiles>(json, options);
            }
            ...
            /// </exception>
            public static OptionalExcludeFilesThatWereMatchedByFiles ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<OptionalExcludeFilesThatWereMatchedByFiles>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out OptionalExcludeFilesThatWereMatchedByFiles? result)
            {
                return JsonElementHelpers.TryParseValue<OptionalExcludeFilesThatWereMatchedByFiles>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new OptionalExcludeFilesThatWereMatchedByFiles(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static OptionalExcludeFilesThatWereMatchedByFiles IJsonElement<OptionalExcludeFilesThatWereMatchedByFiles>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"OptionalExcludeFilesThatWereMatchedByFiles: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="OptionalExcludeFilesThatWereMatchedByFiles"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="OptionalExcludeFilesThatWereMatchedByFiles"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public OptionalExcludeFilesThatWereMatchedByFiles Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<OptionalExcludeFilesThatWereMatchedByFiles>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="OptionalExcludeFilesThatWereMatchedByFiles"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public OptionalExcludeFilesThatWereMatchedByFiles Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<OptionalExcludeFilesThatWereMatchedByFiles>(_idx);
                }
