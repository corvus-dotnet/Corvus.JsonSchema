    ...
    public readonly partial struct RequiredEntryAndIdAndLanguageAndName
    {
        ...
        public readonly partial struct OptionalIfFalseNoFilenamesWillBePassedToTheHook
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(OptionalIfFalseNoFilenamesWillBePassedToTheHook instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="OptionalIfFalseNoFilenamesWillBePassedToTheHook"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator OptionalIfFalseNoFilenamesWillBePassedToTheHook(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"OptionalIfFalseNoFilenamesWillBePassedToTheHook.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly OptionalIfFalseNoFilenamesWillBePassedToTheHook Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly OptionalIfFalseNoFilenamesWillBePassedToTheHook Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<OptionalIfFalseNoFilenamesWillBePassedToTheHook>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(OptionalIfFalseNoFilenamesWillBePassedToTheHook instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<OptionalIfFalseNoFilenamesWillBePassedToTheHook, Mutable>(this);
            }
        }
    }
}
