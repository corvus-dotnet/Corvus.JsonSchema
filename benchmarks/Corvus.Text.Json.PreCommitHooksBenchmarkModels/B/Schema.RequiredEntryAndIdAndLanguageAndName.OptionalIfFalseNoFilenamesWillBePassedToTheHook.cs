...
public readonly partial struct Schema
{
    ...
    public readonly partial struct RequiredEntryAndIdAndLanguageAndName
    {
        ...
        public readonly partial struct OptionalIfFalseNoFilenamesWillBePassedToTheHook
#if NET8_0_OR_GREATER
            : IJsonElement<OptionalIfFalseNoFilenamesWillBePassedToTheHook>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="OptionalIfFalseNoFilenamesWillBePassedToTheHook"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal OptionalIfFalseNoFilenamesWillBePassedToTheHook(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static OptionalIfFalseNoFilenamesWillBePassedToTheHook DefaultInstance { get; } = ParsedJsonDocument<OptionalIfFalseNoFilenamesWillBePassedToTheHook>.True;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(OptionalIfFalseNoFilenamesWillBePassedToTheHook value)
            {
            ...
            /// </returns>
            public static bool operator ==(in OptionalIfFalseNoFilenamesWillBePassedToTheHook left, in OptionalIfFalseNoFilenamesWillBePassedToTheHook right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in OptionalIfFalseNoFilenamesWillBePassedToTheHook left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(OptionalIfFalseNoFilenamesWillBePassedToTheHook instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator OptionalIfFalseNoFilenamesWillBePassedToTheHook(JsonElement instance)
            {
                return OptionalIfFalseNoFilenamesWillBePassedToTheHook.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OptionalIfFalseNoFilenamesWillBePassedToTheHook From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OptionalIfFalseNoFilenamesWillBePassedToTheHook ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OptionalIfFalseNoFilenamesWillBePassedToTheHook>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OptionalIfFalseNoFilenamesWillBePassedToTheHook ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OptionalIfFalseNoFilenamesWillBePassedToTheHook>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OptionalIfFalseNoFilenamesWillBePassedToTheHook ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OptionalIfFalseNoFilenamesWillBePassedToTheHook>(json, options);
            }
            ...
            /// </exception>
            public static OptionalIfFalseNoFilenamesWillBePassedToTheHook ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<OptionalIfFalseNoFilenamesWillBePassedToTheHook>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out OptionalIfFalseNoFilenamesWillBePassedToTheHook? result)
            {
                return JsonElementHelpers.TryParseValue<OptionalIfFalseNoFilenamesWillBePassedToTheHook>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new OptionalIfFalseNoFilenamesWillBePassedToTheHook(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static OptionalIfFalseNoFilenamesWillBePassedToTheHook IJsonElement<OptionalIfFalseNoFilenamesWillBePassedToTheHook>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"OptionalIfFalseNoFilenamesWillBePassedToTheHook: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="OptionalIfFalseNoFilenamesWillBePassedToTheHook"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="OptionalIfFalseNoFilenamesWillBePassedToTheHook"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public OptionalIfFalseNoFilenamesWillBePassedToTheHook Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<OptionalIfFalseNoFilenamesWillBePassedToTheHook>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="OptionalIfFalseNoFilenamesWillBePassedToTheHook"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public OptionalIfFalseNoFilenamesWillBePassedToTheHook Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<OptionalIfFalseNoFilenamesWillBePassedToTheHook>(_idx);
                }
