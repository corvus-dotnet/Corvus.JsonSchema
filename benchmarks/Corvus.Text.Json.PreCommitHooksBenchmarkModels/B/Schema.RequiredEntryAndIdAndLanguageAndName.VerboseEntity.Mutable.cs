    ...
    public readonly partial struct RequiredEntryAndIdAndLanguageAndName
    {
        ...
        public readonly partial struct VerboseEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(VerboseEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="VerboseEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator VerboseEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"VerboseEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly VerboseEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly VerboseEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<VerboseEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(VerboseEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<VerboseEntity, Mutable>(this);
            }
        }
    }
}
