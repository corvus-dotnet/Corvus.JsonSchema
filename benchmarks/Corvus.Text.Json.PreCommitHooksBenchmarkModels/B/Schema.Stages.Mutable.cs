...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Stages
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Stages instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Stages"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Stages(Mutable instance)
            {
            ...
            public Corvus.PreCommitHooksBenchmark.Baseline.Schema.Stage.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.PreCommitHooksBenchmark.Baseline.Schema.Stage.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.PreCommitHooksBenchmark.Baseline.Schema.Stage.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.PreCommitHooksBenchmark.Baseline.Schema.Stage.Mutable>(_parent, _idx);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Stages(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Stages.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Corvus.PreCommitHooksBenchmark.Baseline.Schema.Stage.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, in Corvus.PreCommitHooksBenchmark.Baseline.Schema.Stage.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(in Corvus.PreCommitHooksBenchmark.Baseline.Schema.Stage.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Corvus.PreCommitHooksBenchmark.Baseline.Schema.Stage item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.PreCommitHooksBenchmark.Baseline.Schema.Stage>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Corvus.PreCommitHooksBenchmark.Baseline.Schema.Stage> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.PreCommitHooksBenchmark.Baseline.Schema.Stage>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Corvus.PreCommitHooksBenchmark.Baseline.Schema.Stage oldItem, in Corvus.PreCommitHooksBenchmark.Baseline.Schema.Stage.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.PreCommitHooksBenchmark.Baseline.Schema.Stage>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Corvus.PreCommitHooksBenchmark.Baseline.Schema.Stage current = enumerator.Current;
            ...
            /// <summary>
            /// Gets a <see cref="Stages"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Stages"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly Stages Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<Stages>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Stages"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly Stages Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Stages>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.PreCommitHooksBenchmark.Baseline.Schema.Stages.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(Stages instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.PreCommitHooksBenchmark.Baseline.Schema.Stages.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<Stages, Mutable>(this);
        }
    }
}
