...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        public Corvus.PreCommitHooksBenchmark.Baseline.Schema.Stage this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.PreCommitHooksBenchmark.Baseline.Schema.Stage>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.PreCommitHooksBenchmark.Baseline.Schema.Stage> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.PreCommitHooksBenchmark.Baseline.Schema.Stage>(_parent, _idx);
        }
