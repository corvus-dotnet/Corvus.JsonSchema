...
#endif
{
    ...
    public Corvus.PreCommitHooksBenchmark.Baseline.Schema.RequiredEntryAndIdAndLanguageAndName this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<Corvus.PreCommitHooksBenchmark.Baseline.Schema.RequiredEntryAndIdAndLanguageAndName>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<Corvus.PreCommitHooksBenchmark.Baseline.Schema.RequiredEntryAndIdAndLanguageAndName> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<Corvus.PreCommitHooksBenchmark.Baseline.Schema.RequiredEntryAndIdAndLanguageAndName>(_parent, _idx);
    }
