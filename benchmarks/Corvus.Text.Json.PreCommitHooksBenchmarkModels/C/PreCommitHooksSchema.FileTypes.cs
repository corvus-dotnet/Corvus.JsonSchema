...
public readonly partial struct PreCommitHooksSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FileTypes"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal FileTypes(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static FileTypes DefaultInstance { get; }
        ...
        public Corvus.PreCommitHooksBenchmark.Current.PreCommitHooksSchema.FileType this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.PreCommitHooksBenchmark.Current.PreCommitHooksSchema.FileType>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.PreCommitHooksBenchmark.Current.PreCommitHooksSchema.FileType> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.PreCommitHooksBenchmark.Current.PreCommitHooksSchema.FileType>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in FileTypes left, in FileTypes right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in FileTypes left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(FileTypes instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator FileTypes(JsonElement instance)
        {
            return FileTypes.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static FileTypes From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static FileTypes ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<FileTypes>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static FileTypes ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<FileTypes>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static FileTypes ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<FileTypes>(json, options);
        }
        ...
        /// </exception>
        public static FileTypes ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<FileTypes>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out FileTypes? result)
        {
            return JsonElementHelpers.TryParseValue<FileTypes>(ref reader, out result);
        }
...
#if NET
        static FileTypes IJsonElement<FileTypes>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"FileTypes: ValueKind = {ValueKind} : \"{ToString()}\"";
