...
public readonly partial struct PreCommitHooksSchema
    : IJsonElement<PreCommitHooksSchema>
{
    public static partial class JsonSchema
    {
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("pre-commit-hooks-schema.json"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "pre-commit-hooks-schema.json";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "pre-commit-hooks-schema.json"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            else
            {
                ...
                while (arrayValidation_enumerator.MoveNext())
                {
                    ...
                    JsonSchemaContext childContext = Corvus.PreCommitHooksBenchmark.Current.PreCommitHooksSchema.RequiredEntryAndIdAndLanguageAndName.JsonSchema.PushChildContext(
                        parentDocument,
                    ...
                    Corvus.PreCommitHooksBenchmark.Current.PreCommitHooksSchema.RequiredEntryAndIdAndLanguageAndName.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
