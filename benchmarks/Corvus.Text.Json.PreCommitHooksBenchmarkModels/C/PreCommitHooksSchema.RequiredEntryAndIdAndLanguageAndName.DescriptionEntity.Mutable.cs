    ...
    public readonly partial struct RequiredEntryAndIdAndLanguageAndName
    {
        ...
        public readonly partial struct DescriptionEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DescriptionEntity, Mutable>(DescriptionEntity.DefaultInstance);
                ...
                /// <summary>
                /// Gets a <see cref="DescriptionEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="DescriptionEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly DescriptionEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<DescriptionEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="DescriptionEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly DescriptionEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DescriptionEntity>(_idx);
                }
            }
            ...
            public static ParsedJsonDocument<DescriptionEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<DescriptionEntity>();
                }
                finally
                {
