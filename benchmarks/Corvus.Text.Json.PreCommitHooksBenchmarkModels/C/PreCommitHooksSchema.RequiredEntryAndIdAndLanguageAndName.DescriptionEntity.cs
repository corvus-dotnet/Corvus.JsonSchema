...
public readonly partial struct PreCommitHooksSchema
{
    ...
    public readonly partial struct RequiredEntryAndIdAndLanguageAndName
    {
...
#endif
        {
            ...
            /// </summary>
            public static DescriptionEntity DefaultInstance { get; } = ParsedJsonDocument<DescriptionEntity>.StringConstant([.."\"\""u8]);
            ...
            /// </para>
            /// </remarks>
            public DescriptionEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public DescriptionEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<DescriptionEntity>(_idx);
                }
