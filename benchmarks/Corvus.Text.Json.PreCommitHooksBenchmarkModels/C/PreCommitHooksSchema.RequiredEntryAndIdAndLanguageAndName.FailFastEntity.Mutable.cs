    ...
    public readonly partial struct RequiredEntryAndIdAndLanguageAndName
    {
        ...
        public readonly partial struct FailFastEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<FailFastEntity, Mutable>(FailFastEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(FailFastEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="FailFastEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator FailFastEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new FailFastEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"FailFastEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="FailFastEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="FailFastEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly FailFastEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<FailFastEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="FailFastEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly FailFastEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<FailFastEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(FailFastEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<FailFastEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<FailFastEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<FailFastEntity>();
                }
                finally
                {
