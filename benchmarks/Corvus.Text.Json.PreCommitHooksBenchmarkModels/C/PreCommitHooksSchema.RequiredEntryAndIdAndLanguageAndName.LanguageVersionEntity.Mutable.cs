...
public readonly partial struct PreCommitHooksSchema
{
    ...
    public readonly partial struct RequiredEntryAndIdAndLanguageAndName
    {
        ...
        public readonly partial struct LanguageVersionEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<LanguageVersionEntity, Mutable>(LanguageVersionEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(LanguageVersionEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="LanguageVersionEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator LanguageVersionEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new LanguageVersionEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"LanguageVersionEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="LanguageVersionEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="LanguageVersionEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly LanguageVersionEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<LanguageVersionEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="LanguageVersionEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly LanguageVersionEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<LanguageVersionEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(LanguageVersionEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<LanguageVersionEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<LanguageVersionEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<LanguageVersionEntity>();
                }
                finally
                {
