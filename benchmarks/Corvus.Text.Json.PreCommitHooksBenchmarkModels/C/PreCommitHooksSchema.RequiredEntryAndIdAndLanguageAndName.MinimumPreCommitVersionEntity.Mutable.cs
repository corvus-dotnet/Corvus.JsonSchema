    ...
    public readonly partial struct RequiredEntryAndIdAndLanguageAndName
    {
        ...
        public readonly partial struct MinimumPreCommitVersionEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<MinimumPreCommitVersionEntity, Mutable>(MinimumPreCommitVersionEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(MinimumPreCommitVersionEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="MinimumPreCommitVersionEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator MinimumPreCommitVersionEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new MinimumPreCommitVersionEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"MinimumPreCommitVersionEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="MinimumPreCommitVersionEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="MinimumPreCommitVersionEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly MinimumPreCommitVersionEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<MinimumPreCommitVersionEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="MinimumPreCommitVersionEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly MinimumPreCommitVersionEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<MinimumPreCommitVersionEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(MinimumPreCommitVersionEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<MinimumPreCommitVersionEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<MinimumPreCommitVersionEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<MinimumPreCommitVersionEntity>();
                }
                finally
                {
