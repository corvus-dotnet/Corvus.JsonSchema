    ...
    public readonly partial struct RequiredEntryAndIdAndLanguageAndName
    {
        ...
        public readonly partial struct OptionalExcludeFilesThatWereMatchedByFiles
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<OptionalExcludeFilesThatWereMatchedByFiles, Mutable>(OptionalExcludeFilesThatWereMatchedByFiles.DefaultInstance);
            ...
            public static ParsedJsonDocument<OptionalExcludeFilesThatWereMatchedByFiles> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<OptionalExcludeFilesThatWereMatchedByFiles>();
                }
                finally
                {
