    ...
    public readonly partial struct RequiredEntryAndIdAndLanguageAndName
    {
        ...
        public readonly partial struct OptionalIfFalseNoFilenamesWillBePassedToTheHook
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<OptionalIfFalseNoFilenamesWillBePassedToTheHook, Mutable>(OptionalIfFalseNoFilenamesWillBePassedToTheHook.DefaultInstance);
            ...
            public static ParsedJsonDocument<OptionalIfFalseNoFilenamesWillBePassedToTheHook> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<OptionalIfFalseNoFilenamesWillBePassedToTheHook>();
                }
                finally
                {
