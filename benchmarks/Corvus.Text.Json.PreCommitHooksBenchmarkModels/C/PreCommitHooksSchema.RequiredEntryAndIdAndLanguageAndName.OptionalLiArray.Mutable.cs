...
public readonly partial struct PreCommitHooksSchema
{
    ...
    public readonly partial struct RequiredEntryAndIdAndLanguageAndName
    {
        ...
        public readonly partial struct OptionalLiArray
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<OptionalLiArray, Mutable>(OptionalLiArray.DefaultInstance);
                ...
                public static explicit operator Mutable(OptionalLiArray instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="OptionalLiArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator OptionalLiArray(Mutable instance)
                {
                ...
                public Corvus.PreCommitHooksBenchmark.Current.JsonString.Mutable this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.PreCommitHooksBenchmark.Current.JsonString.Mutable>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.PreCommitHooksBenchmark.Current.JsonString.Mutable> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.PreCommitHooksBenchmark.Current.JsonString.Mutable>(_parent, _idx);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new OptionalLiArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"OptionalLiArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetItem(int itemIndex, in Corvus.PreCommitHooksBenchmark.Current.JsonString.Source value)
                {
                    CheckValidInstance();
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void InsertItem(int itemIndex, scoped in Corvus.PreCommitHooksBenchmark.Current.JsonString.Source value)
                {
                    CheckValidInstance();
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void AddItem(scoped in Corvus.PreCommitHooksBenchmark.Current.JsonString.Source value)
                {
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Remove(in Corvus.PreCommitHooksBenchmark.Current.JsonString item)
                {
                    CheckValidInstance();
                    if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.PreCommitHooksBenchmark.Current.JsonString>(this, in item))
                    {
                        return false;
                    }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void RemoveWhere(JsonPredicate<Corvus.PreCommitHooksBenchmark.Current.JsonString> predicate)
                {
                    CheckValidInstance();
                    JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.PreCommitHooksBenchmark.Current.JsonString>(this, predicate);
                    _documentVersion = _parent.Version;
                }
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Replace(in Corvus.PreCommitHooksBenchmark.Current.JsonString oldItem, in Corvus.PreCommitHooksBenchmark.Current.JsonString.Source newItem)
                {
                    CheckValidInstance();
                    ...
                    var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.PreCommitHooksBenchmark.Current.JsonString>(_parent, _idx);

                    while (enumerator.MoveNext())
                    {
                        Corvus.PreCommitHooksBenchmark.Current.JsonString current = enumerator.Current;
                ...
                /// <summary>
                /// Gets a <see cref="OptionalLiArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="OptionalLiArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly OptionalLiArray Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<OptionalLiArray>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="OptionalLiArray"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly OptionalLiArray Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<OptionalLiArray>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.PreCommitHooksBenchmark.Current.PreCommitHooksSchema.RequiredEntryAndIdAndLanguageAndName.OptionalLiArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(OptionalLiArray instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.PreCommitHooksBenchmark.Current.PreCommitHooksSchema.RequiredEntryAndIdAndLanguageAndName.OptionalLiArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// </summary>
                public void AddItem(in Corvus.PreCommitHooksBenchmark.Current.JsonString.Source value)
                {
            ...
            {
                return workspace.CreateBuilder<OptionalLiArray, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<OptionalLiArray> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<OptionalLiArray>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<OptionalLiArray> Create<TContext>(
