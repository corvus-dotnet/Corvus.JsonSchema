    ...
    public readonly partial struct RequiredEntryAndIdAndLanguageAndName
    {
        ...
        public readonly partial struct OptionalThePatternOfFilesToRunOn
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<OptionalThePatternOfFilesToRunOn, Mutable>(OptionalThePatternOfFilesToRunOn.DefaultInstance);
            ...
            public static ParsedJsonDocument<OptionalThePatternOfFilesToRunOn> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<OptionalThePatternOfFilesToRunOn>();
                }
                finally
                {
