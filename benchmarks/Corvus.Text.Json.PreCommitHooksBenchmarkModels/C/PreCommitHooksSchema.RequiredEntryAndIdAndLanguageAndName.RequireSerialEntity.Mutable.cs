    ...
    public readonly partial struct RequiredEntryAndIdAndLanguageAndName
    {
        ...
        public readonly partial struct RequireSerialEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<RequireSerialEntity, Mutable>(RequireSerialEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(RequireSerialEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RequireSerialEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RequireSerialEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RequireSerialEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RequireSerialEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RequireSerialEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RequireSerialEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RequireSerialEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RequireSerialEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RequireSerialEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RequireSerialEntity>();
                }
                finally
                {
