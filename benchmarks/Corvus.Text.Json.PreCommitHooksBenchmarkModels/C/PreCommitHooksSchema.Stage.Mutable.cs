...
public readonly partial struct PreCommitHooksSchema
{
    ...
    public readonly partial struct Stage
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Stage instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Stage"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Stage(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Stage.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly Stage Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Stage>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(Stage instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<Stage, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<Stage> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Stage>();
            }
            finally
            {
