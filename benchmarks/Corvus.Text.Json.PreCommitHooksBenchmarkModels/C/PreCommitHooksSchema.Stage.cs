...
public readonly partial struct PreCommitHooksSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Stage"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal Stage(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static Stage DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(Stage value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in Stage left, in Stage right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Stage left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(Stage instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Stage(JsonElement instance)
        {
            return Stage.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Stage From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Stage ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Stage>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Stage ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Stage>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Stage ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Stage>(json, options);
        }
        ...
        /// </exception>
        public static Stage ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<Stage>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Stage? result)
        {
            return JsonElementHelpers.TryParseValue<Stage>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new Stage(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static Stage IJsonElement<Stage>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Stage: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="Stage"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="Stage"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        {
            CheckValidInstance();
            return _parent.CloneElement<Stage>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="Stage"/> that lives for the lifetime of its
        ...
        public Stage Freeze()
        {
            ...
            {
                return mutable.FreezeElement<Stage>(_idx);
            }
        ...
        /// <param name="matchCommit">Match 1st item.</param>
        /// <param name="matchMergeCommit">Match 2nd item.</param>
        /// <param name="matchPush">Match 3rd item.</param>
        /// <param name="matchPrepareCommitMsg">Match 4th item.</param>
        /// <param name="matchCommitMsg">Match 5th item.</param>
        /// <param name="matchPostCheckout">Match 6th item.</param>
        /// <param name="matchPostCommit">Match 7th item.</param>
        /// <param name="matchPostMerge">Match 8th item.</param>
        /// <param name="matchPostRewrite">Match 9th item.</param>
        /// <param name="matchPreCommit">Match 10th item.</param>
        /// <param name="matchPreMergeCommit">Match 11th item.</param>
        /// <param name="matchPrePush">Match 12th item.</param>
        /// <param name="matchPreRebase">Match 13th item.</param>
        /// <param name="matchManual">Match 14th item.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Func<TContext, TResult> matchCommit,
            Func<TContext, TResult> matchMergeCommit,
            Func<TContext, TResult> matchPush,
            Func<TContext, TResult> matchPrepareCommitMsg,
            Func<TContext, TResult> matchCommitMsg,
            Func<TContext, TResult> matchPostCheckout,
            Func<TContext, TResult> matchPostCommit,
            Func<TContext, TResult> matchPostMerge,
            Func<TContext, TResult> matchPostRewrite,
            Func<TContext, TResult> matchPreCommit,
            Func<TContext, TResult> matchPreMergeCommit,
            Func<TContext, TResult> matchPrePush,
            Func<TContext, TResult> matchPreRebase,
            Func<TContext, TResult> matchManual,
        ...
        public TResult Match<TResult>(
            Func<TResult> matchCommit,
            Func<TResult> matchMergeCommit,
            Func<TResult> matchPush,
            Func<TResult> matchPrepareCommitMsg,
            Func<TResult> matchCommitMsg,
            Func<TResult> matchPostCheckout,
            Func<TResult> matchPostCommit,
            Func<TResult> matchPostMerge,
            Func<TResult> matchPostRewrite,
            Func<TResult> matchPreCommit,
            Func<TResult> matchPreMergeCommit,
            Func<TResult> matchPrePush,
            Func<TResult> matchPreRebase,
            Func<TResult> matchManual,
            Func<TResult> defaultMatch)
        {
            ...
            if (this.ValueEquals(Constants.Enum4))
            {
                return matchPrepareCommitMsg();
            }

            if (this.ValueEquals(Constants.Enum5))
            {
                return matchCommitMsg();
            }

            if (this.ValueEquals(Constants.Enum6))
            {
                return matchPostCheckout();
            }

            if (this.ValueEquals(Constants.Enum7))
            {
                return matchPostCommit();
            }

            if (this.ValueEquals(Constants.Enum8))
            {
                return matchPostMerge();
            }

            if (this.ValueEquals(Constants.Enum9))
            {
                return matchPostRewrite();
            }

            if (this.ValueEquals(Constants.Enum10))
            {
                return matchPreCommit();
            }

            if (this.ValueEquals(Constants.Enum11))
            {
                return matchPreMergeCommit();
            }
