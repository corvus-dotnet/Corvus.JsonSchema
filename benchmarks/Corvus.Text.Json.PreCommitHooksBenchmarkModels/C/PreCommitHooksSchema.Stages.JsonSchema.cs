...
public readonly partial struct PreCommitHooksSchema
{
        ...
        : IJsonElement<Stages>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://json.schemastore.org/pre-commit-hooks.json#/definitions/stages"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "https://json.schemastore.org/pre-commit-hooks.json#/definitions/stages";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://json.schemastore.org/pre-commit-hooks.json#/definitions/stages"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    while (arrayValidation_enumerator.MoveNext())
                    {
                        ...
                        JsonSchemaContext childContext = Corvus.PreCommitHooksBenchmark.Current.PreCommitHooksSchema.Stage.JsonSchema.PushChildContext(
                            parentDocument,
                        ...
                        Corvus.PreCommitHooksBenchmark.Current.PreCommitHooksSchema.Stage.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
