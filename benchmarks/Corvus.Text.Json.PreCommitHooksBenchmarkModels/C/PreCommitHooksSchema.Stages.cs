...
public readonly partial struct PreCommitHooksSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Stages"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal Stages(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static Stages DefaultInstance { get; }
        ...
        public Corvus.PreCommitHooksBenchmark.Current.PreCommitHooksSchema.Stage this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.PreCommitHooksBenchmark.Current.PreCommitHooksSchema.Stage>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.PreCommitHooksBenchmark.Current.PreCommitHooksSchema.Stage> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.PreCommitHooksBenchmark.Current.PreCommitHooksSchema.Stage>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in Stages left, in Stages right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Stages left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(Stages instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Stages(JsonElement instance)
        {
            return Stages.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Stages From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Stages ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Stages>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Stages ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Stages>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Stages ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Stages>(json, options);
        }
        ...
        /// </exception>
        public static Stages ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<Stages>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Stages? result)
        {
            return JsonElementHelpers.TryParseValue<Stages>(ref reader, out result);
        }
...
#if NET
        static Stages IJsonElement<Stages>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Stages: ValueKind = {ValueKind} : \"{ToString()}\"";
