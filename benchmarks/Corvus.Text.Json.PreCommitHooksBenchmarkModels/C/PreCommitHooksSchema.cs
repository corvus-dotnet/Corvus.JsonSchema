...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PreCommitHooksSchema"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal PreCommitHooksSchema(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static PreCommitHooksSchema DefaultInstance { get; }
    ...
    public Corvus.PreCommitHooksBenchmark.Current.PreCommitHooksSchema.RequiredEntryAndIdAndLanguageAndName this[int index]
    {
        get
        {
            CheckValidInstance();
            return _parent.GetArrayIndexElement<Corvus.PreCommitHooksBenchmark.Current.PreCommitHooksSchema.RequiredEntryAndIdAndLanguageAndName>(_idx, index);
        }
    }
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
    public ArrayEnumerator<Corvus.PreCommitHooksBenchmark.Current.PreCommitHooksSchema.RequiredEntryAndIdAndLanguageAndName> EnumerateArray()
    {
        CheckValidInstance();
        return EnumeratorCreator.CreateArrayEnumerator<Corvus.PreCommitHooksBenchmark.Current.PreCommitHooksSchema.RequiredEntryAndIdAndLanguageAndName>(_parent, _idx);
    }
    ...
    /// </returns>
    public static bool operator ==(in PreCommitHooksSchema left, in PreCommitHooksSchema right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in PreCommitHooksSchema left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(PreCommitHooksSchema instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator PreCommitHooksSchema(JsonElement instance)
    {
        return PreCommitHooksSchema.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PreCommitHooksSchema From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PreCommitHooksSchema ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PreCommitHooksSchema>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PreCommitHooksSchema ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PreCommitHooksSchema>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PreCommitHooksSchema ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<PreCommitHooksSchema>(json, options);
    }
    ...
    /// </exception>
    public static PreCommitHooksSchema ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<PreCommitHooksSchema>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out PreCommitHooksSchema? result)
    {
        return JsonElementHelpers.TryParseValue<PreCommitHooksSchema>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new PreCommitHooksSchema(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static PreCommitHooksSchema IJsonElement<PreCommitHooksSchema>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"PreCommitHooksSchema: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="PreCommitHooksSchema"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="PreCommitHooksSchema"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public PreCommitHooksSchema Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<PreCommitHooksSchema>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="PreCommitHooksSchema"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public PreCommitHooksSchema Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<PreCommitHooksSchema>(_idx);
        }
