...
public readonly partial struct Schema
{
    ...
    public readonly partial struct AdditionalProjectOptions
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.PulumiBenchmark.Baseline.Schema.AdditionalProjectOptions.RefreshEntity.Mutable Refresh
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RefreshUtf8, out Corvus.PulumiBenchmark.Baseline.Schema.AdditionalProjectOptions.RefreshEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetRefresh(in Corvus.PulumiBenchmark.Baseline.Schema.AdditionalProjectOptions.RefreshEntity.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.PulumiBenchmark.Baseline.Schema.AdditionalProjectOptions.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.PulumiBenchmark.Baseline.Schema.AdditionalProjectOptions.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.PulumiBenchmark.Baseline.Schema.AdditionalProjectOptions.RefreshEntity.Source refresh = default)
            {
            ...
            /// Creates an instance of a <see cref="AdditionalProjectOptions"/>.
            /// </summary>
            public void Create(in Corvus.PulumiBenchmark.Baseline.Schema.AdditionalProjectOptions.RefreshEntity.Source refresh = default)
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.PulumiBenchmark.Baseline.Schema.AdditionalProjectOptions.RefreshEntity.Source refresh = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
