...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.PulumiBenchmark.Baseline.Schema.AdditionalProjectOptions.RefreshEntity Refresh
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RefreshUtf8, out Corvus.PulumiBenchmark.Baseline.Schema.AdditionalProjectOptions.RefreshEntity value))
                {
                    return value;
                }
