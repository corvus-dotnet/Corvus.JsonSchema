...
public readonly partial struct Schema
{
    ...
    public readonly partial struct BackendOfTheProject
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.PulumiBenchmark.Baseline.JsonString.Mutable Url
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UrlUtf8, out Corvus.PulumiBenchmark.Baseline.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetUrl(in Corvus.PulumiBenchmark.Baseline.JsonString.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.PulumiBenchmark.Baseline.Schema.BackendOfTheProject.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.PulumiBenchmark.Baseline.Schema.BackendOfTheProject.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.PulumiBenchmark.Baseline.JsonString.Source url = default)
            {
            ...
            /// Creates an instance of a <see cref="BackendOfTheProject"/>.
            /// </summary>
            public void Create(in Corvus.PulumiBenchmark.Baseline.JsonString.Source url = default)
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.PulumiBenchmark.Baseline.JsonString.Source url = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
