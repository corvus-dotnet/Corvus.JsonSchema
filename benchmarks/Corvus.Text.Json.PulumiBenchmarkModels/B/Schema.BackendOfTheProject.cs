...
public readonly partial struct Schema
{
    ...
    public readonly partial struct BackendOfTheProject
        ...
        : IJsonElement<BackendOfTheProject>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BackendOfTheProject"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal BackendOfTheProject(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static BackendOfTheProject DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.PulumiBenchmark.Baseline.JsonString Url
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UrlUtf8, out Corvus.PulumiBenchmark.Baseline.JsonString value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in BackendOfTheProject left, in BackendOfTheProject right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in BackendOfTheProject left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(BackendOfTheProject instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator BackendOfTheProject(JsonElement instance)
        {
            return BackendOfTheProject.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BackendOfTheProject From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BackendOfTheProject ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BackendOfTheProject>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BackendOfTheProject ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BackendOfTheProject>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BackendOfTheProject ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BackendOfTheProject>(json, options);
        }
        ...
        /// </exception>
        public static BackendOfTheProject ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<BackendOfTheProject>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out BackendOfTheProject? result)
        {
            return JsonElementHelpers.TryParseValue<BackendOfTheProject>(ref reader, out result);
        }
...
#if NET
        static BackendOfTheProject IJsonElement<BackendOfTheProject>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"BackendOfTheProject: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public BackendOfTheProject Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public BackendOfTheProject Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<BackendOfTheProject>(_idx);
            }
