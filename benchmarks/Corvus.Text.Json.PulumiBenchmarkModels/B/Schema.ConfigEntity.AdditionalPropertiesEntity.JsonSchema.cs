            ...
            public static partial class JsonSchema
            {
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    JsonSchemaContext oneOfContext0 =
                        Corvus.PulumiBenchmark.Baseline.JsonString.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf0SchemaEvaluationPath);
                    Corvus.PulumiBenchmark.Baseline.JsonString.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext0);
                    ...
                    JsonSchemaContext oneOfContext1 =
                        Corvus.PulumiBenchmark.Baseline.JsonInteger.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf1SchemaEvaluationPath);
                    Corvus.PulumiBenchmark.Baseline.JsonInteger.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext1);
                    ...
                    JsonSchemaContext oneOfContext2 =
                        Corvus.PulumiBenchmark.Baseline.JsonBoolean.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf2SchemaEvaluationPath);
                    Corvus.PulumiBenchmark.Baseline.JsonBoolean.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext2);
                    ...
                    JsonSchemaContext oneOfContext3 =
                        Corvus.PulumiBenchmark.Baseline.Schema.ConfigEntity.AdditionalPropertiesEntity.OneOf3Array.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf3SchemaEvaluationPath);
                    Corvus.PulumiBenchmark.Baseline.Schema.ConfigEntity.AdditionalPropertiesEntity.OneOf3Array.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext3);
                    ...
                    JsonSchemaContext oneOfContext4 =
                        Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf4SchemaEvaluationPath);
                    Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext4);
