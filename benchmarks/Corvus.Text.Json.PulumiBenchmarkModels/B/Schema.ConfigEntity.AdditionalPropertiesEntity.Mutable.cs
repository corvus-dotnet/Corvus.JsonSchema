    ...
    public readonly partial struct ConfigEntity
    {
        ...
        public readonly partial struct AdditionalPropertiesEntity
        {
...
#endif
            {
                ...
                public static explicit operator Corvus.PulumiBenchmark.Baseline.Schema.ConfigEntity.AdditionalPropertiesEntity.OneOf3Array.Mutable(Mutable value)
                {
                    return Corvus.PulumiBenchmark.Baseline.Schema.ConfigEntity.AdditionalPropertiesEntity.OneOf3Array.Mutable.From(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.PulumiBenchmark.Baseline.Schema.ConfigEntity.AdditionalPropertiesEntity.OneOf3Array.Mutable value)
                {
                    return From(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static explicit operator Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration.Mutable(Mutable value)
                {
                    return Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration.Mutable.From(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration.Mutable value)
                {
                    return From(value);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.PulumiBenchmark.Baseline.Schema.ConfigEntity.AdditionalPropertiesEntity.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
                {
                    ...
                    {
                        return matchJsonString(Corvus.PulumiBenchmark.Baseline.JsonString.Mutable.From(this), context);
                    }

                    if (Corvus.PulumiBenchmark.Baseline.JsonInteger.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchJsonInteger(Corvus.PulumiBenchmark.Baseline.JsonInteger.Mutable.From(this), context);
                    }

                    if (Corvus.PulumiBenchmark.Baseline.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchJsonBoolean(Corvus.PulumiBenchmark.Baseline.JsonBoolean.Mutable.From(this), context);
                    }
                    ...
                    {
                        return matchOneOf3Array(Corvus.PulumiBenchmark.Baseline.Schema.ConfigEntity.AdditionalPropertiesEntity.OneOf3Array.Mutable.From(this), context);
                    }

                    if (Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchConfigTypeDeclaration(Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.PulumiBenchmark.Baseline.Schema.ConfigEntity.AdditionalPropertiesEntity.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.PulumiBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchJsonString(Corvus.PulumiBenchmark.Baseline.JsonString.Mutable.From(this));
                    }

                    if (Corvus.PulumiBenchmark.Baseline.JsonInteger.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchJsonInteger(Corvus.PulumiBenchmark.Baseline.JsonInteger.Mutable.From(this));
                    }

                    if (Corvus.PulumiBenchmark.Baseline.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchJsonBoolean(Corvus.PulumiBenchmark.Baseline.JsonBoolean.Mutable.From(this));
                    }

                    if (Corvus.PulumiBenchmark.Baseline.Schema.ConfigEntity.AdditionalPropertiesEntity.OneOf3Array.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchOneOf3Array(Corvus.PulumiBenchmark.Baseline.Schema.ConfigEntity.AdditionalPropertiesEntity.OneOf3Array.Mutable.From(this));
                    }

                    if (Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchConfigTypeDeclaration(Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration.Mutable.From(this));
                    }
                ...
                public bool TryGetAsConfigTypeDeclaration(out Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration result)
                {
                    if (Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration.Mutable.From(this);
                        return true;
                    }
                ...
                public bool TryGetAsJsonString(out Corvus.PulumiBenchmark.Baseline.JsonString result)
                {
                    if (Corvus.PulumiBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.PulumiBenchmark.Baseline.JsonString.Mutable.From(this);
                        return true;
                    }
                ...
                public bool TryGetAsJsonInteger(out Corvus.PulumiBenchmark.Baseline.JsonInteger result)
                {
                    if (Corvus.PulumiBenchmark.Baseline.JsonInteger.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.PulumiBenchmark.Baseline.JsonInteger.Mutable.From(this);
                        return true;
                    }
                ...
                public bool TryGetAsJsonBoolean(out Corvus.PulumiBenchmark.Baseline.JsonBoolean result)
                {
                    if (Corvus.PulumiBenchmark.Baseline.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.PulumiBenchmark.Baseline.JsonBoolean.Mutable.From(this);
                        return true;
                    }
                ...
                public bool TryGetAsOneOf3Array(out Corvus.PulumiBenchmark.Baseline.Schema.ConfigEntity.AdditionalPropertiesEntity.OneOf3Array result)
                {
                    if (Corvus.PulumiBenchmark.Baseline.Schema.ConfigEntity.AdditionalPropertiesEntity.OneOf3Array.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.PulumiBenchmark.Baseline.Schema.ConfigEntity.AdditionalPropertiesEntity.OneOf3Array.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration.Builder.Build? _configTypeDeclarationBuilderInstance;
                ...
                internal Source(Corvus.PulumiBenchmark.Baseline.Schema.ConfigEntity.AdditionalPropertiesEntity.ArrayBuilder.Build value) {_arrayBuilder = value; _kind = Kind.ArrayBuilder; }

                public Source(Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration.Builder.Build value) {_configTypeDeclarationBuilderInstance = value; _kind = Kind.ConfigTypeDeclarationBuilder; }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.PulumiBenchmark.Baseline.JsonBoolean instance) => new(JsonElement.From(instance));

                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.PulumiBenchmark.Baseline.JsonInteger instance) => new(JsonElement.From(instance));

                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.PulumiBenchmark.Baseline.JsonString instance) => new(JsonElement.From(instance));

                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration instance) => new(JsonElement.From(instance));
                ...
                internal void AddAsProperty(ReadOnlySpan<byte> utf8Name, ref ComplexValueBuilder valueBuilder, bool escapeName = true, bool nameRequiresUnescaping = false)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.ConfigTypeDeclarationBuilder:
                            valueBuilder.AddProperty(utf8Name, _configTypeDeclarationBuilderInstance!, static (in b, ref o) => Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration.Builder.BuildValue(b, ref o), escapeName, nameRequiresUnescaping);
                            break;
                        default:
                ...
                internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.ArrayBuilder:
                            ...
                            break;
                        case Kind.ConfigTypeDeclarationBuilder:
                            valueBuilder.AddProperty(name, _configTypeDeclarationBuilderInstance!, static (in b, ref o) => Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration.Builder.BuildValue(b, ref o));
                            break;
                        default:
                            Debug.Fail("Unexpected Kind");
                            break;
                ...
                internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.ArrayBuilder:
                            ...
                            break;
                        case Kind.ConfigTypeDeclarationBuilder:
                            valueBuilder.AddItem(_configTypeDeclarationBuilderInstance!, static (in b, ref o) => Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration.Builder.BuildValue(b, ref o));
                            break;
                        default:
                            Debug.Fail("Unexpected Kind");
                            break;
                ...
                #endif
            {
                ...
                private readonly Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration.Builder.Build<TContext>? _configTypeDeclarationBuilderInstance;
                ...
                internal Source(scoped in TContext context, Corvus.PulumiBenchmark.Baseline.Schema.ConfigEntity.AdditionalPropertiesEntity.ArrayBuilder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.ArrayBuilder; }

                public Source(scoped in TContext context, Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration.Builder.Build<TContext> value) {_context = context; _configTypeDeclarationBuilderInstance = value; _kind = Kind.ConfigTypeDeclarationBuilder; }
                ...
                internal void AddAsProperty(ReadOnlySpan<byte> utf8Name, ref ComplexValueBuilder valueBuilder, bool escapeName = true, bool nameRequiresUnescaping = false)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.ArrayBuilder:
                            ...
                            break;
                        case Kind.ConfigTypeDeclarationBuilder:
                            valueBuilder.AddProperty(utf8Name, BuildWithContext.Create(_context, _configTypeDeclarationBuilderInstance!), static (in b, ref o) => Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration.Builder.BuildValue(b.Context, b.Build, ref o), escapeName, nameRequiresUnescaping);
                            break;
                        default:
                            Debug.Fail("Unexpected Kind");
                            break;
                ...
                internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.ArrayBuilder:
                            ...
                            break;
                        case Kind.ConfigTypeDeclarationBuilder:
                            valueBuilder.AddProperty(name, BuildWithContext.Create(_context, _configTypeDeclarationBuilderInstance!), static (in b, ref o) => Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration.Builder.BuildValue(b.Context, b.Build, ref o));
                            break;
                        default:
                            Debug.Fail("Unexpected Kind");
                            break;
                ...
                internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.ArrayBuilder:
                            ...
                            break;
                        case Kind.ConfigTypeDeclarationBuilder:
                            valueBuilder.AddItem(BuildWithContext.Create(_context, _configTypeDeclarationBuilderInstance!), static (in b, ref o) => Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration.Builder.BuildValue(b.Context, b.Build, ref o));
                            break;
                        default:
                            Debug.Fail("Unexpected Kind");
                            break;
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration.Source Build(
                scoped in Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration.Builder.Build buildValue, int initialCapacity = 1)
            {
                return new Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration.Source(buildValue);
            }
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration.Source<TContext> Build<TContext>(
                scoped in TContext context, scoped in Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration.Builder.Build<TContext> buildValue, int initialCapacity = 1)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                return new Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration.Source<TContext>(context, buildValue);
            }
            ...
            /// <returns>An instance of a mutable document initialized with the given value.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(
                JsonWorkspace workspace, scoped in Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
            {
                // Create the document builder without a MetadataDb
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                var source = new Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration.Source(value);
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(
                JsonWorkspace workspace, scoped in TContext context, scoped in Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                ...
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                var source = new Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration.Source<TContext>(context, value);
                source.AddAsItem(ref cvb);
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
