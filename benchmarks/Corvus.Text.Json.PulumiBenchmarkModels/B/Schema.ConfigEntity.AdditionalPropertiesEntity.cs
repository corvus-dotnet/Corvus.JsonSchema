...
namespace Corvus.PulumiBenchmark.Baseline;
...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ConfigEntity
    {
...
#endif
        {
            ...
            /// <summary>
            /// Conversion to <see cref="Corvus.PulumiBenchmark.Baseline.Schema.ConfigEntity.AdditionalPropertiesEntity.OneOf3Array"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.PulumiBenchmark.Baseline.Schema.ConfigEntity.AdditionalPropertiesEntity.OneOf3Array(AdditionalPropertiesEntity value)
            {
                return Corvus.PulumiBenchmark.Baseline.Schema.ConfigEntity.AdditionalPropertiesEntity.OneOf3Array.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.PulumiBenchmark.Baseline.Schema.ConfigEntity.AdditionalPropertiesEntity.OneOf3Array"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator AdditionalPropertiesEntity(Corvus.PulumiBenchmark.Baseline.Schema.ConfigEntity.AdditionalPropertiesEntity.OneOf3Array value)
            {
                return From(value);
            }

            /// <summary>
            /// Conversion to <see cref="Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration(AdditionalPropertiesEntity value)
            {
                return Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator AdditionalPropertiesEntity(Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration value)
            {
                return From(value);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator long(AdditionalPropertiesEntity value) => value._parent.TryGetValue(value._idx, out long result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator double(AdditionalPropertiesEntity value) => value._parent.TryGetValue(value._idx, out double result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator Corvus.Numerics.BigNumber(AdditionalPropertiesEntity value) => value._parent.TryGetValue(value._idx, out Corvus.Numerics.BigNumber result) ? result : throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator System.Numerics.BigInteger(AdditionalPropertiesEntity value) => value._parent.TryGetValue(value._idx, out System.Numerics.BigInteger result) ? result : throw new FormatException();
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsConfigTypeDeclaration(out Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration result)
            {
                if (Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration.From(this);
                    return true;
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.PulumiBenchmark.Baseline.JsonString" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsJsonString(out Corvus.PulumiBenchmark.Baseline.JsonString result)
            {
                if (Corvus.PulumiBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.PulumiBenchmark.Baseline.JsonString.From(this);
                    return true;
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.PulumiBenchmark.Baseline.JsonInteger" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsJsonInteger(out Corvus.PulumiBenchmark.Baseline.JsonInteger result)
            {
                if (Corvus.PulumiBenchmark.Baseline.JsonInteger.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.PulumiBenchmark.Baseline.JsonInteger.From(this);
                    return true;
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.PulumiBenchmark.Baseline.JsonBoolean" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsJsonBoolean(out Corvus.PulumiBenchmark.Baseline.JsonBoolean result)
            {
                if (Corvus.PulumiBenchmark.Baseline.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.PulumiBenchmark.Baseline.JsonBoolean.From(this);
                    return true;
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.PulumiBenchmark.Baseline.Schema.ConfigEntity.AdditionalPropertiesEntity.OneOf3Array" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsOneOf3Array(out Corvus.PulumiBenchmark.Baseline.Schema.ConfigEntity.AdditionalPropertiesEntity.OneOf3Array result)
            {
                if (Corvus.PulumiBenchmark.Baseline.Schema.ConfigEntity.AdditionalPropertiesEntity.OneOf3Array.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.PulumiBenchmark.Baseline.Schema.ConfigEntity.AdditionalPropertiesEntity.OneOf3Array.From(this);
                    return true;
                }
            ...
            /// <param name="matchJsonString">Match a <see cref="Corvus.PulumiBenchmark.Baseline.JsonString"/>.</param>
            /// <param name="matchJsonInteger">Match a <see cref="Corvus.PulumiBenchmark.Baseline.JsonInteger"/>.</param>
            /// <param name="matchJsonBoolean">Match a <see cref="Corvus.PulumiBenchmark.Baseline.JsonBoolean"/>.</param>
            /// <param name="matchOneOf3Array">Match a <see cref="Corvus.PulumiBenchmark.Baseline.Schema.ConfigEntity.AdditionalPropertiesEntity.OneOf3Array"/>.</param>
            /// <param name="matchConfigTypeDeclaration">Match a <see cref="Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration"/>.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Matcher<Corvus.PulumiBenchmark.Baseline.JsonString, TContext, TResult> matchJsonString,
                Matcher<Corvus.PulumiBenchmark.Baseline.JsonInteger, TContext, TResult> matchJsonInteger,
                Matcher<Corvus.PulumiBenchmark.Baseline.JsonBoolean, TContext, TResult> matchJsonBoolean,
                Matcher<Corvus.PulumiBenchmark.Baseline.Schema.ConfigEntity.AdditionalPropertiesEntity.OneOf3Array, TContext, TResult> matchOneOf3Array,
                Matcher<Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration, TContext, TResult> matchConfigTypeDeclaration,
                Matcher<Corvus.PulumiBenchmark.Baseline.Schema.ConfigEntity.AdditionalPropertiesEntity, TContext, TResult> defaultMatch)
...
#endif
            {
                if (Corvus.PulumiBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonString(Corvus.PulumiBenchmark.Baseline.JsonString.From(this), context);
                }

                if (Corvus.PulumiBenchmark.Baseline.JsonInteger.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonInteger(Corvus.PulumiBenchmark.Baseline.JsonInteger.From(this), context);
                }

                if (Corvus.PulumiBenchmark.Baseline.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonBoolean(Corvus.PulumiBenchmark.Baseline.JsonBoolean.From(this), context);
                }

                if (Corvus.PulumiBenchmark.Baseline.Schema.ConfigEntity.AdditionalPropertiesEntity.OneOf3Array.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchOneOf3Array(Corvus.PulumiBenchmark.Baseline.Schema.ConfigEntity.AdditionalPropertiesEntity.OneOf3Array.From(this), context);
                }

                if (Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchConfigTypeDeclaration(Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                Matcher<Corvus.PulumiBenchmark.Baseline.JsonString, TResult> matchJsonString,
                Matcher<Corvus.PulumiBenchmark.Baseline.JsonInteger, TResult> matchJsonInteger,
                Matcher<Corvus.PulumiBenchmark.Baseline.JsonBoolean, TResult> matchJsonBoolean,
                Matcher<Corvus.PulumiBenchmark.Baseline.Schema.ConfigEntity.AdditionalPropertiesEntity.OneOf3Array, TResult> matchOneOf3Array,
                Matcher<Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration, TResult> matchConfigTypeDeclaration,
                Matcher<Corvus.PulumiBenchmark.Baseline.Schema.ConfigEntity.AdditionalPropertiesEntity, TResult> defaultMatch)
            {
                if (Corvus.PulumiBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonString(Corvus.PulumiBenchmark.Baseline.JsonString.From(this));
                }

                if (Corvus.PulumiBenchmark.Baseline.JsonInteger.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonInteger(Corvus.PulumiBenchmark.Baseline.JsonInteger.From(this));
                }

                if (Corvus.PulumiBenchmark.Baseline.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonBoolean(Corvus.PulumiBenchmark.Baseline.JsonBoolean.From(this));
                }

                if (Corvus.PulumiBenchmark.Baseline.Schema.ConfigEntity.AdditionalPropertiesEntity.OneOf3Array.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchOneOf3Array(Corvus.PulumiBenchmark.Baseline.Schema.ConfigEntity.AdditionalPropertiesEntity.OneOf3Array.From(this));
                }

                if (Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchConfigTypeDeclaration(Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration.From(this));
                }
