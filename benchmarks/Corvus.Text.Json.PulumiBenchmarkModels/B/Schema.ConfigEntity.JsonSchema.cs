        ...
        public static partial class JsonSchema
        {
            ...
            private static void MatchSecret(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                ...
                JsonSchemaContext childContext =
                    Corvus.PulumiBenchmark.Baseline.Schema.ConfigEntity.IfTrueThisConfigurationValueShouldBeEncrypted.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.PulumiBenchmark.Baseline.Schema.ConfigEntity.IfTrueThisConfigurationValueShouldBeEncrypted.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            [NotNullWhen(true)]
#endif
            out Corvus.PulumiBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator1? matcher)
            {
                if (span.SequenceEqual(JsonPropertyNames.SecretUtf8))
                {
                    matcher = MatchSecret;
                    return true;
                }
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://json.schemastore.org/pulumi.json#/properties/config"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "https://json.schemastore.org/pulumi.json#/properties/config";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://json.schemastore.org/pulumi.json#/properties/config"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                if (tokenType == JsonTokenType.StartObject)
                {
                    ...
                    while (objectValidation_enumerator.MoveNext())
                    {
                        ...
                        if (TryGetNamedMatcher(objectValidation_unescapedPropertyName.Span, out Corvus.PulumiBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator1? validator))
                        {
