...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ConfigEntity
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.PulumiBenchmark.Baseline.Schema.ConfigEntity.IfTrueThisConfigurationValueShouldBeEncrypted.Mutable Secret
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SecretUtf8, out Corvus.PulumiBenchmark.Baseline.Schema.ConfigEntity.IfTrueThisConfigurationValueShouldBeEncrypted.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetSecret(in Corvus.PulumiBenchmark.Baseline.Schema.ConfigEntity.IfTrueThisConfigurationValueShouldBeEncrypted.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.PulumiBenchmark.Baseline.Schema.ConfigEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.PulumiBenchmark.Baseline.Schema.ConfigEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.PulumiBenchmark.Baseline.Schema.ConfigEntity.IfTrueThisConfigurationValueShouldBeEncrypted.Source secret = default)
            {
            ...
            /// Creates an instance of a <see cref="ConfigEntity"/>.
            /// </summary>
            public void Create(in Corvus.PulumiBenchmark.Baseline.Schema.ConfigEntity.IfTrueThisConfigurationValueShouldBeEncrypted.Source secret = default)
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.PulumiBenchmark.Baseline.Schema.ConfigEntity.IfTrueThisConfigurationValueShouldBeEncrypted.Source secret = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
