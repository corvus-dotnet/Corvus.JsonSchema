...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.PulumiBenchmark.Baseline.Schema.ConfigEntity.IfTrueThisConfigurationValueShouldBeEncrypted Secret
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SecretUtf8, out Corvus.PulumiBenchmark.Baseline.Schema.ConfigEntity.IfTrueThisConfigurationValueShouldBeEncrypted value))
                {
                    return value;
                }

                return Corvus.PulumiBenchmark.Baseline.Schema.ConfigEntity.IfTrueThisConfigurationValueShouldBeEncrypted.DefaultInstance;
            }
        }
