...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ConfigItemsType
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ConfigItemsType instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ConfigItemsType"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ConfigItemsType(Mutable instance)
            {
            ...
            /// </summary>
            public Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.Mutable Items
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ItemsUtf8, out Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.TypeEntity.Mutable Type
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.TypeEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ConfigItemsType(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetItems(in Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetItems<TContext>(in Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.Source<TContext> value)
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetType(in Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.TypeEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetType<TContext>(in Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.TypeEntity.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ConfigItemsType.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ConfigItemsType"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ConfigItemsType"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly ConfigItemsType Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ConfigItemsType>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ConfigItemsType"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly ConfigItemsType Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ConfigItemsType>(_idx);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<ConfigItemsType, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
            {
                if (Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.WithTypeArray.JsonSchema.Evaluate(_parent, _idx))
                {
            ...
            public TResult Match<TResult>(
                ...
                Matcher<ConfigItemsType, TResult> defaultMatch)
            {
                if (Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.WithTypeArray.JsonSchema.Evaluate(_parent, _idx))
                {
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.WithTypeArray" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsWithTypeArray(out Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.WithTypeArray result)
            {
                if (Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.WithTypeArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.WithTypeArray.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(ConfigItemsType instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="ConfigItemsType"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.TypeEntity.Source type,
                in Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.Source items = default)
            {
            ...
            /// Creates an instance of a <see cref="ConfigItemsType"/>.
            /// </summary>
            public void Create(in Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.TypeEntity.Source type, in Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.Source items = default)
            {
                Create(ref _builder, type, items);
            }
            ...
            internal static void Create<TContext>(
                in TContext context,
                ref ComplexValueBuilder builder,
                in Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.TypeEntity.Source<TContext> type,
                in Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.Source<TContext> items = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            #endif
            {
                Create(context, ref _builder, type, items);
            }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.TypeEntity.Source type, in Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.Source items = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(type, items);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.TypeEntity.Source<TContext> type, in Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.Source<TContext> items = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
        ...
        {
            return workspace.CreateBuilder<ConfigItemsType, Mutable>(this);
        }
    }
}
