    ...
    public readonly partial struct ConfigItemsType
    {
        ...
        public readonly partial struct TypeEntity
        {
...
#endif
            {
                ...
                public static explicit operator Corvus.PulumiBenchmark.Baseline.Schema.SimpleConfigType.Mutable(Mutable value)
                {
                    return Corvus.PulumiBenchmark.Baseline.Schema.SimpleConfigType.Mutable.From(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.PulumiBenchmark.Baseline.Schema.SimpleConfigType.Mutable value)
                {
                    return From(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static explicit operator Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.Mutable(Mutable value)
                {
                    return Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.Mutable.From(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.Mutable value)
                {
                    return From(value);
                }
                ...
                /// </remarks>
                public void Apply(in Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType value)
                {
                    CheckValidInstance();
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.TypeEntity.Mutable, TContext, TResult> defaultMatch)
...
#endif
                {
                    ...
                    {
                        return matchSimpleConfigType(Corvus.PulumiBenchmark.Baseline.Schema.SimpleConfigType.Mutable.From(this), context);
                    }

                    if (Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchConfigItemsType(Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.TypeEntity.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.PulumiBenchmark.Baseline.Schema.SimpleConfigType.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchSimpleConfigType(Corvus.PulumiBenchmark.Baseline.Schema.SimpleConfigType.Mutable.From(this));
                    }

                    if (Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchConfigItemsType(Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.Mutable.From(this));
                    }
                ...
                public bool TryGetAsConfigItemsType(out Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType result)
                {
                    if (Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.Mutable.From(this);
                        return true;
                    }
                ...
                public bool TryGetAsSimpleConfigType(out Corvus.PulumiBenchmark.Baseline.Schema.SimpleConfigType result)
                {
                    if (Corvus.PulumiBenchmark.Baseline.Schema.SimpleConfigType.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.PulumiBenchmark.Baseline.Schema.SimpleConfigType.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.Builder.Build? _configItemsTypeBuilderInstance;
                ...
                public Source(Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.Builder.Build value) {_configItemsTypeBuilderInstance = value; _kind = Kind.ConfigItemsTypeBuilder; }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType instance) => new(JsonElement.From(instance));

                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.PulumiBenchmark.Baseline.Schema.SimpleConfigType instance) => new(JsonElement.From(instance));
                ...
                internal void AddAsProperty(ReadOnlySpan<byte> utf8Name, ref ComplexValueBuilder valueBuilder, bool escapeName = true, bool nameRequiresUnescaping = false)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.ConfigItemsTypeBuilder:
                            valueBuilder.AddProperty(utf8Name, _configItemsTypeBuilderInstance!, static (in b, ref o) => Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.Builder.BuildValue(b, ref o), escapeName, nameRequiresUnescaping);
                            break;
                        default:
                ...
                internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.Utf16String:
                            ...
                            break;
                        case Kind.ConfigItemsTypeBuilder:
                            valueBuilder.AddProperty(name, _configItemsTypeBuilderInstance!, static (in b, ref o) => Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.Builder.BuildValue(b, ref o));
                            break;
                        default:
                            Debug.Fail("Unexpected Kind");
                            break;
                ...
                internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.Utf16String:
                            ...
                            break;
                        case Kind.ConfigItemsTypeBuilder:
                            valueBuilder.AddItem(_configItemsTypeBuilderInstance!, static (in b, ref o) => Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.Builder.BuildValue(b, ref o));
                            break;
                        default:
                            Debug.Fail("Unexpected Kind");
                            break;
                ...
                #endif
            {
                ...
                TContext _context;
                Source _source;
                private readonly Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.Builder.Build<TContext>? _configItemsTypeBuilderInstance;
                ...
                public Source(scoped in TContext context, Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.Builder.Build<TContext> value) {_context = context; _configItemsTypeBuilderInstance = value; _kind = Kind.ConfigItemsTypeBuilder; }
                ...
                internal void AddAsProperty(ReadOnlySpan<byte> utf8Name, ref ComplexValueBuilder valueBuilder, bool escapeName = true, bool nameRequiresUnescaping = false)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.Source:
                            ...
                            break;
                        case Kind.ConfigItemsTypeBuilder:
                            valueBuilder.AddProperty(utf8Name, BuildWithContext.Create(_context, _configItemsTypeBuilderInstance!), static (in b, ref o) => Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.Builder.BuildValue(b.Context, b.Build, ref o), escapeName, nameRequiresUnescaping);
                            break;
                        default:
                            Debug.Fail("Unexpected Kind");
                            break;
                ...
                internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.Source:
                            ...
                            break;
                        case Kind.ConfigItemsTypeBuilder:
                            valueBuilder.AddProperty(name, BuildWithContext.Create(_context, _configItemsTypeBuilderInstance!), static (in b, ref o) => Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.Builder.BuildValue(b.Context, b.Build, ref o));
                            break;
                        default:
                            Debug.Fail("Unexpected Kind");
                            break;
                ...
                internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.Source:
                            ...
                            break;
                        case Kind.ConfigItemsTypeBuilder:
                            valueBuilder.AddItem(BuildWithContext.Create(_context, _configItemsTypeBuilderInstance!), static (in b, ref o) => Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.Builder.BuildValue(b.Context, b.Build, ref o));
                            break;
                        default:
                            Debug.Fail("Unexpected Kind");
                            break;
            ...
            public static Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.Source Build(
                scoped in Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.Builder.Build buildValue, int initialCapacity = 1)
            {
                return new Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.Source(buildValue);
            }
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.Source<TContext> Build<TContext>(
                scoped in TContext context, scoped in Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.Builder.Build<TContext> buildValue, int initialCapacity = 1)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                return new Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.Source<TContext>(context, buildValue);
            }
            ...
            /// <returns>An instance of a mutable document initialized with the given value.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(
                JsonWorkspace workspace, scoped in Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
            {
                // Create the document builder without a MetadataDb
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                var source = new Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.Source(value);
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(
                JsonWorkspace workspace, scoped in TContext context, scoped in Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                ...
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                var source = new Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.Source<TContext>(context, value);
                source.AddAsItem(ref cvb);
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
