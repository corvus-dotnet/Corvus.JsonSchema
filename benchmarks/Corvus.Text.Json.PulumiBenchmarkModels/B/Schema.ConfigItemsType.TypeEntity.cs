...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ConfigItemsType
    {
...
#endif
        {
            ...
            /// <summary>
            /// Conversion to <see cref="Corvus.PulumiBenchmark.Baseline.Schema.SimpleConfigType"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.PulumiBenchmark.Baseline.Schema.SimpleConfigType(TypeEntity value)
            {
                return Corvus.PulumiBenchmark.Baseline.Schema.SimpleConfigType.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.PulumiBenchmark.Baseline.Schema.SimpleConfigType"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator TypeEntity(Corvus.PulumiBenchmark.Baseline.Schema.SimpleConfigType value)
            {
                return From(value);
            }

            /// <summary>
            /// Conversion to <see cref="Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType(TypeEntity value)
            {
                return Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator TypeEntity(Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType value)
            {
                return From(value);
            }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsConfigItemsType(out Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType result)
            {
                if (Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.From(this);
                    return true;
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.PulumiBenchmark.Baseline.Schema.SimpleConfigType" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsSimpleConfigType(out Corvus.PulumiBenchmark.Baseline.Schema.SimpleConfigType result)
            {
                if (Corvus.PulumiBenchmark.Baseline.Schema.SimpleConfigType.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.PulumiBenchmark.Baseline.Schema.SimpleConfigType.From(this);
                    return true;
                }
            ...
            /// <param name="matchSimpleConfigType">Match a <see cref="Corvus.PulumiBenchmark.Baseline.Schema.SimpleConfigType"/>.</param>
            /// <param name="matchConfigItemsType">Match a <see cref="Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType"/>.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Matcher<Corvus.PulumiBenchmark.Baseline.Schema.SimpleConfigType, TContext, TResult> matchSimpleConfigType,
                Matcher<Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType, TContext, TResult> matchConfigItemsType,
                Matcher<Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.TypeEntity, TContext, TResult> defaultMatch)
...
#endif
            {
                if (Corvus.PulumiBenchmark.Baseline.Schema.SimpleConfigType.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchSimpleConfigType(Corvus.PulumiBenchmark.Baseline.Schema.SimpleConfigType.From(this), context);
                }

                if (Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchConfigItemsType(Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                Matcher<Corvus.PulumiBenchmark.Baseline.Schema.SimpleConfigType, TResult> matchSimpleConfigType,
                Matcher<Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType, TResult> matchConfigItemsType,
                Matcher<Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.TypeEntity, TResult> defaultMatch)
            {
                if (Corvus.PulumiBenchmark.Baseline.Schema.SimpleConfigType.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchSimpleConfigType(Corvus.PulumiBenchmark.Baseline.Schema.SimpleConfigType.From(this));
                }

                if (Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchConfigItemsType(Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.From(this));
                }
