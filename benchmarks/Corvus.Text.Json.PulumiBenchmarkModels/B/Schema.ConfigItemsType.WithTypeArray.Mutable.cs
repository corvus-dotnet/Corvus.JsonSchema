...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ConfigItemsType
    {
        ...
        public readonly partial struct WithTypeArray
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(WithTypeArray instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="WithTypeArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator WithTypeArray(Mutable instance)
                {
                ...
                /// </summary>
                public Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.WithTypeArray.TypeEntity.Mutable Type
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.WithTypeArray.TypeEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new WithTypeArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                public void SetType(in Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.WithTypeArray.TypeEntity.Source value)
                {
                    CheckValidInstance();
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"WithTypeArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="WithTypeArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="WithTypeArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly WithTypeArray Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<WithTypeArray>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="WithTypeArray"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly WithTypeArray Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<WithTypeArray>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.WithTypeArray.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(WithTypeArray instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.WithTypeArray.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="WithTypeArray"/>.
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.WithTypeArray.TypeEntity.Source type = default)
                {
                ...
                /// Creates an instance of a <see cref="WithTypeArray"/>.
                /// </summary>
                public void Create(in Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.WithTypeArray.TypeEntity.Source type = default)
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.WithTypeArray.TypeEntity.Source type = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            {
                return workspace.CreateBuilder<WithTypeArray, Mutable>(this);
            }
        }
    }
}
