...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ConfigItemsType
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="WithTypeArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal WithTypeArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static WithTypeArray DefaultInstance { get; }
            ...
            /// </summary>
            public Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.WithTypeArray.TypeEntity Type
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.WithTypeArray.TypeEntity value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in WithTypeArray left, in WithTypeArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in WithTypeArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(WithTypeArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator WithTypeArray(JsonElement instance)
            {
                return WithTypeArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WithTypeArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WithTypeArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<WithTypeArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WithTypeArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<WithTypeArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WithTypeArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<WithTypeArray>(json, options);
            }
            ...
            /// </exception>
            public static WithTypeArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<WithTypeArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out WithTypeArray? result)
            {
                return JsonElementHelpers.TryParseValue<WithTypeArray>(ref reader, out result);
            }
...
#if NET
            static WithTypeArray IJsonElement<WithTypeArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"WithTypeArray: ValueKind = {ValueKind} : \"{ToString()}\"";
