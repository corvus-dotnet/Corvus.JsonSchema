...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ConfigTypeDeclaration
    {
...
#endif
        {
            ...
            /// </summary>
            public Corvus.PulumiBenchmark.Baseline.JsonString.Mutable Description
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DescriptionUtf8, out Corvus.PulumiBenchmark.Baseline.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public Corvus.PulumiBenchmark.Baseline.JsonBoolean.Mutable Secret
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SecretUtf8, out Corvus.PulumiBenchmark.Baseline.JsonBoolean.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public Corvus.PulumiBenchmark.Baseline.Schema.SimpleConfigType.Mutable Type
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.PulumiBenchmark.Baseline.Schema.SimpleConfigType.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetDescription(in Corvus.PulumiBenchmark.Baseline.JsonString.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetSecret(in Corvus.PulumiBenchmark.Baseline.JsonBoolean.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetType(in Corvus.PulumiBenchmark.Baseline.Schema.SimpleConfigType.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.PulumiBenchmark.Baseline.Schema.ConfigTypeDeclaration.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.PulumiBenchmark.Baseline.JsonString.Source description = default,
                in Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.Source items = default,
                in Corvus.PulumiBenchmark.Baseline.JsonBoolean.Source secret = default,
                in Corvus.PulumiBenchmark.Baseline.Schema.SimpleConfigType.Source type = default,
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.JsonElement.Source defaultValue = default, in Corvus.PulumiBenchmark.Baseline.JsonString.Source description = default, in Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.Source items = default, in Corvus.PulumiBenchmark.Baseline.JsonBoolean.Source secret = default, in Corvus.PulumiBenchmark.Baseline.Schema.SimpleConfigType.Source type = default, in Corvus.Text.Json.JsonElement.Source value = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> defaultValue = default, in Corvus.PulumiBenchmark.Baseline.JsonString.Source description = default, in Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType.Source<TContext> items = default, in Corvus.PulumiBenchmark.Baseline.JsonBoolean.Source secret = default, in Corvus.PulumiBenchmark.Baseline.Schema.SimpleConfigType.Source type = default, in Corvus.Text.Json.JsonElement.Source<TContext> value = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
