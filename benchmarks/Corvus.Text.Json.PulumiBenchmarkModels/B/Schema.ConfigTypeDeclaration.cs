...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// </summary>
        public Corvus.PulumiBenchmark.Baseline.JsonString Description
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DescriptionUtf8, out Corvus.PulumiBenchmark.Baseline.JsonString value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType Items
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ItemsUtf8, out Corvus.PulumiBenchmark.Baseline.Schema.ConfigItemsType value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.PulumiBenchmark.Baseline.JsonBoolean Secret
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SecretUtf8, out Corvus.PulumiBenchmark.Baseline.JsonBoolean value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.PulumiBenchmark.Baseline.Schema.SimpleConfigType Type
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.PulumiBenchmark.Baseline.Schema.SimpleConfigType value))
                {
                    return value;
                }
