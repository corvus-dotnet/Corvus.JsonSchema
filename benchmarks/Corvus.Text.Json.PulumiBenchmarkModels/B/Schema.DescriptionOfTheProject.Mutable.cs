...
public readonly partial struct Schema
{
    ...
    public readonly partial struct DescriptionOfTheProject
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(DescriptionOfTheProject instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="DescriptionOfTheProject"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DescriptionOfTheProject(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DescriptionOfTheProject.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly DescriptionOfTheProject Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly DescriptionOfTheProject Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<DescriptionOfTheProject>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(DescriptionOfTheProject instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<DescriptionOfTheProject, Mutable>(this);
        }
    }
}
