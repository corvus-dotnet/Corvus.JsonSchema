...
public readonly partial struct Schema
{
    ...
    public readonly partial struct LicenseEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(LicenseEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="LicenseEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator LicenseEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"LicenseEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly LicenseEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly LicenseEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<LicenseEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(LicenseEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<LicenseEntity, Mutable>(this);
        }
    }
}
