...
public readonly partial struct Schema
{
    ...
    public readonly partial struct MainEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(MainEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MainEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MainEntity(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new MainEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MainEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="MainEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="MainEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly MainEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<MainEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="MainEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly MainEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MainEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(MainEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<MainEntity, Mutable>(this);
        }
    }
}
