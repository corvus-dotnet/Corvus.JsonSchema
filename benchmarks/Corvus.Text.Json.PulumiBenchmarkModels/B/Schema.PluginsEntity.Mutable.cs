...
public readonly partial struct Schema
{
    ...
    public readonly partial struct PluginsEntity
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.PulumiBenchmark.Baseline.Schema.PluginsEntity.PluginOptionsArray.Mutable Analyzers
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AnalyzersUtf8, out Corvus.PulumiBenchmark.Baseline.Schema.PluginsEntity.PluginOptionsArray.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.PulumiBenchmark.Baseline.Schema.PluginsEntity.PluginsForLanArray.Mutable Languages
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LanguagesUtf8, out Corvus.PulumiBenchmark.Baseline.Schema.PluginsEntity.PluginsForLanArray.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.PulumiBenchmark.Baseline.Schema.PluginsEntity.PluginsForResArray.Mutable Providers
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ProvidersUtf8, out Corvus.PulumiBenchmark.Baseline.Schema.PluginsEntity.PluginsForResArray.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetAnalyzers(in Corvus.PulumiBenchmark.Baseline.Schema.PluginsEntity.PluginOptionsArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetAnalyzers<TContext>(in Corvus.PulumiBenchmark.Baseline.Schema.PluginsEntity.PluginOptionsArray.Source<TContext> value)
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetLanguages(in Corvus.PulumiBenchmark.Baseline.Schema.PluginsEntity.PluginsForLanArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetLanguages<TContext>(in Corvus.PulumiBenchmark.Baseline.Schema.PluginsEntity.PluginsForLanArray.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetProviders(in Corvus.PulumiBenchmark.Baseline.Schema.PluginsEntity.PluginsForResArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetProviders<TContext>(in Corvus.PulumiBenchmark.Baseline.Schema.PluginsEntity.PluginsForResArray.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.PulumiBenchmark.Baseline.Schema.PluginsEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.PulumiBenchmark.Baseline.Schema.PluginsEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.PulumiBenchmark.Baseline.Schema.PluginsEntity.PluginOptionsArray.Source analyzers = default,
                in Corvus.PulumiBenchmark.Baseline.Schema.PluginsEntity.PluginsForLanArray.Source languages = default,
                in Corvus.PulumiBenchmark.Baseline.Schema.PluginsEntity.PluginsForResArray.Source providers = default)
            {
            ...
            internal static void Create<TContext>(
                in TContext context,
                ref ComplexValueBuilder builder,
                in Corvus.PulumiBenchmark.Baseline.Schema.PluginsEntity.PluginOptionsArray.Source<TContext> analyzers = default,
                in Corvus.PulumiBenchmark.Baseline.Schema.PluginsEntity.PluginsForLanArray.Source<TContext> languages = default,
                in Corvus.PulumiBenchmark.Baseline.Schema.PluginsEntity.PluginsForResArray.Source<TContext> providers = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.PulumiBenchmark.Baseline.Schema.PluginsEntity.PluginOptionsArray.Source analyzers = default, in Corvus.PulumiBenchmark.Baseline.Schema.PluginsEntity.PluginsForLanArray.Source languages = default, in Corvus.PulumiBenchmark.Baseline.Schema.PluginsEntity.PluginsForResArray.Source providers = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.PulumiBenchmark.Baseline.Schema.PluginsEntity.PluginOptionsArray.Source<TContext> analyzers = default, in Corvus.PulumiBenchmark.Baseline.Schema.PluginsEntity.PluginsForLanArray.Source<TContext> languages = default, in Corvus.PulumiBenchmark.Baseline.Schema.PluginsEntity.PluginsForResArray.Source<TContext> providers = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
