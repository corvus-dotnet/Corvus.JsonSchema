    ...
    public readonly partial struct PluginsEntity
    {
        ...
        public readonly partial struct PluginOptionsArray
        {
...
#endif
            {
                ...
                public Corvus.PulumiBenchmark.Baseline.Schema.PluginOptions.Mutable this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.PulumiBenchmark.Baseline.Schema.PluginOptions.Mutable>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.PulumiBenchmark.Baseline.Schema.PluginOptions.Mutable> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.PulumiBenchmark.Baseline.Schema.PluginOptions.Mutable>(_parent, _idx);
                }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetItem(int itemIndex, in Corvus.PulumiBenchmark.Baseline.Schema.PluginOptions.Source value)
                {
                    CheckValidInstance();
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void InsertItem(int itemIndex, in Corvus.PulumiBenchmark.Baseline.Schema.PluginOptions.Source value)
                {
                    CheckValidInstance();
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void AddItem(in Corvus.PulumiBenchmark.Baseline.Schema.PluginOptions.Source value)
                {
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Remove(in Corvus.PulumiBenchmark.Baseline.Schema.PluginOptions item)
                {
                    CheckValidInstance();
                    if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.PulumiBenchmark.Baseline.Schema.PluginOptions>(this, in item))
                    {
                        return false;
                    }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void RemoveWhere(JsonPredicate<Corvus.PulumiBenchmark.Baseline.Schema.PluginOptions> predicate)
                {
                    CheckValidInstance();
                    JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.PulumiBenchmark.Baseline.Schema.PluginOptions>(this, predicate);
                    _documentVersion = _parent.Version;
                }
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Replace(in Corvus.PulumiBenchmark.Baseline.Schema.PluginOptions oldItem, in Corvus.PulumiBenchmark.Baseline.Schema.PluginOptions.Source newItem)
                {
                    CheckValidInstance();
                    ...
                    var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.PulumiBenchmark.Baseline.Schema.PluginOptions>(_parent, _idx);

                    while (enumerator.MoveNext())
                    {
                        Corvus.PulumiBenchmark.Baseline.Schema.PluginOptions current = enumerator.Current;
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.PulumiBenchmark.Baseline.Schema.PluginsEntity.PluginOptionsArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.PulumiBenchmark.Baseline.Schema.PluginsEntity.PluginOptionsArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
