...
public readonly partial struct Schema
{
    ...
    public readonly partial struct PluginsEntity
    {
        ...
        public readonly partial struct PluginOptionsArray
            ...
            : IJsonElement<PluginOptionsArray>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="PluginOptionsArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal PluginOptionsArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static PluginOptionsArray DefaultInstance { get; }
            ...
            public Corvus.PulumiBenchmark.Baseline.Schema.PluginOptions this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.PulumiBenchmark.Baseline.Schema.PluginOptions>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.PulumiBenchmark.Baseline.Schema.PluginOptions> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.PulumiBenchmark.Baseline.Schema.PluginOptions>(_parent, _idx);
            }
            ...
            /// </returns>
            public static bool operator ==(in PluginOptionsArray left, in PluginOptionsArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in PluginOptionsArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(PluginOptionsArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PluginOptionsArray(JsonElement instance)
            {
                return PluginOptionsArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PluginOptionsArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PluginOptionsArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PluginOptionsArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PluginOptionsArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PluginOptionsArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PluginOptionsArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PluginOptionsArray>(json, options);
            }
            ...
            /// </exception>
            public static PluginOptionsArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<PluginOptionsArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out PluginOptionsArray? result)
            {
                return JsonElementHelpers.TryParseValue<PluginOptionsArray>(ref reader, out result);
            }
...
#if NET
            static PluginOptionsArray IJsonElement<PluginOptionsArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PluginOptionsArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public PluginOptionsArray Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public PluginOptionsArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<PluginOptionsArray>(_idx);
                }
