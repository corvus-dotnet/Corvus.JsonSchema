...
public readonly partial struct Schema
{
    ...
    public readonly partial struct PluginsEntity
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="PluginsForLanArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal PluginsForLanArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static PluginsForLanArray DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in PluginsForLanArray left, in PluginsForLanArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in PluginsForLanArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(PluginsForLanArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PluginsForLanArray(JsonElement instance)
            {
                return PluginsForLanArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PluginsForLanArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PluginsForLanArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PluginsForLanArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PluginsForLanArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PluginsForLanArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PluginsForLanArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PluginsForLanArray>(json, options);
            }
            ...
            /// </exception>
            public static PluginsForLanArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<PluginsForLanArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out PluginsForLanArray? result)
            {
                return JsonElementHelpers.TryParseValue<PluginsForLanArray>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new PluginsForLanArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static PluginsForLanArray IJsonElement<PluginsForLanArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PluginsForLanArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="PluginsForLanArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="PluginsForLanArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public PluginsForLanArray Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<PluginsForLanArray>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="PluginsForLanArray"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public PluginsForLanArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<PluginsForLanArray>(_idx);
                }
