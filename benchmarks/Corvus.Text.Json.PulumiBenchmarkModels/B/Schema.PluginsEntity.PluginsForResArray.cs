...
public readonly partial struct Schema
{
    ...
    public readonly partial struct PluginsEntity
    {
        ...
        public readonly partial struct PluginsForResArray
#if NET8_0_OR_GREATER
            : IJsonElement<PluginsForResArray>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="PluginsForResArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal PluginsForResArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static PluginsForResArray DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in PluginsForResArray left, in PluginsForResArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in PluginsForResArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(PluginsForResArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PluginsForResArray(JsonElement instance)
            {
                return PluginsForResArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PluginsForResArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PluginsForResArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PluginsForResArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PluginsForResArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PluginsForResArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PluginsForResArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PluginsForResArray>(json, options);
            }
            ...
            /// </exception>
            public static PluginsForResArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<PluginsForResArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out PluginsForResArray? result)
            {
                return JsonElementHelpers.TryParseValue<PluginsForResArray>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new PluginsForResArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static PluginsForResArray IJsonElement<PluginsForResArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PluginsForResArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="PluginsForResArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="PluginsForResArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public PluginsForResArray Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<PluginsForResArray>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="PluginsForResArray"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public PluginsForResArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<PluginsForResArray>(_idx);
                }
