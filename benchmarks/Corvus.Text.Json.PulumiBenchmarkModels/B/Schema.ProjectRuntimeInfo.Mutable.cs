...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ProjectRuntimeInfo
    {
...
#endif
        {
            ...
            public static explicit operator Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.Name.Mutable(Mutable value)
            {
                return Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.Name.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.Name.Mutable value)
            {
                return From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Mutable(Mutable value)
            {
                return Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Mutable value)
            {
                return From(value);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.Mutable, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                {
                    return matchName(Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.Name.Mutable.From(this), context);
                }

                if (Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchOneOf1Entity(Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.Mutable, TResult> defaultMatch)
            {
                if (Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.Name.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchName(Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.Name.Mutable.From(this));
                }

                if (Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchOneOf1Entity(Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Mutable.From(this));
                }
            ...
            public bool TryGetAsName(out Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.Name result)
            {
                if (Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.Name.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.Name.Mutable.From(this);
                    return true;
                }
            ...
            public bool TryGetAsOneOf1Entity(out Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity result)
            {
                if (Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Builder.Build? _oneOf1EntityBuilderInstance;
            ...
            public Source(Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Builder.Build value) {_oneOf1EntityBuilderInstance = value; _kind = Kind.OneOf1EntityBuilder; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.Name instance) => new(JsonElement.From(instance));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity instance) => new(JsonElement.From(instance));
            ...
            internal void AddAsProperty(ReadOnlySpan<byte> utf8Name, ref ComplexValueBuilder valueBuilder, bool escapeName = true, bool nameRequiresUnescaping = false)
            {
                switch(_kind)
                {
                    ...
                    case Kind.OneOf1EntityBuilder:
                        valueBuilder.AddProperty(utf8Name, _oneOf1EntityBuilderInstance!, static (in b, ref o) => Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Builder.BuildValue(b, ref o), escapeName, nameRequiresUnescaping);
                        break;
                    default:
            ...
            internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
            {
                switch(_kind)
                {
                    ...
                    case Kind.Utf16String:
                        ...
                        break;
                    case Kind.OneOf1EntityBuilder:
                        valueBuilder.AddProperty(name, _oneOf1EntityBuilderInstance!, static (in b, ref o) => Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Builder.BuildValue(b, ref o));
                        break;
                    default:
                        Debug.Fail("Unexpected Kind");
                        break;
            ...
            internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
            {
                switch(_kind)
                {
                    ...
                    case Kind.Utf16String:
                        ...
                        break;
                    case Kind.OneOf1EntityBuilder:
                        valueBuilder.AddItem(_oneOf1EntityBuilderInstance!, static (in b, ref o) => Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Builder.BuildValue(b, ref o));
                        break;
                    default:
                        Debug.Fail("Unexpected Kind");
                        break;
            ...
            #endif
        {
            ...
            TContext _context;
            Source _source;
            private readonly Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Builder.Build<TContext>? _oneOf1EntityBuilderInstance;
            ...
            public Source(scoped in TContext context, Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Builder.Build<TContext> value) {_context = context; _oneOf1EntityBuilderInstance = value; _kind = Kind.OneOf1EntityBuilder; }
            ...
            internal void AddAsProperty(ReadOnlySpan<byte> utf8Name, ref ComplexValueBuilder valueBuilder, bool escapeName = true, bool nameRequiresUnescaping = false)
            {
                switch(_kind)
                {
                    ...
                    case Kind.Source:
                        ...
                        break;
                    case Kind.OneOf1EntityBuilder:
                        valueBuilder.AddProperty(utf8Name, BuildWithContext.Create(_context, _oneOf1EntityBuilderInstance!), static (in b, ref o) => Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Builder.BuildValue(b.Context, b.Build, ref o), escapeName, nameRequiresUnescaping);
                        break;
                    default:
                        Debug.Fail("Unexpected Kind");
                        break;
            ...
            internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
            {
                switch(_kind)
                {
                    ...
                    case Kind.Source:
                        ...
                        break;
                    case Kind.OneOf1EntityBuilder:
                        valueBuilder.AddProperty(name, BuildWithContext.Create(_context, _oneOf1EntityBuilderInstance!), static (in b, ref o) => Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Builder.BuildValue(b.Context, b.Build, ref o));
                        break;
                    default:
                        Debug.Fail("Unexpected Kind");
                        break;
            ...
            internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
            {
                switch(_kind)
                {
                    ...
                    case Kind.Source:
                        ...
                        break;
                    case Kind.OneOf1EntityBuilder:
                        valueBuilder.AddItem(BuildWithContext.Create(_context, _oneOf1EntityBuilderInstance!), static (in b, ref o) => Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Builder.BuildValue(b.Context, b.Build, ref o));
                        break;
                    default:
                        Debug.Fail("Unexpected Kind");
                        break;
        ...
        public static Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Source Build(
            scoped in Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Builder.Build buildValue, int initialCapacity = 1)
        {
            return new Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Source(buildValue);
        }
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Source<TContext> Build<TContext>(
            scoped in TContext context, scoped in Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Builder.Build<TContext> buildValue, int initialCapacity = 1)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            return new Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Source<TContext>(context, buildValue);
        }
        ...
        /// <returns>An instance of a mutable document initialized with the given value.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(
            JsonWorkspace workspace, scoped in Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
        {
            // Create the document builder without a MetadataDb
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            var source = new Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Source(value);
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(
            JsonWorkspace workspace, scoped in TContext context, scoped in Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            ...
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            var source = new Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Source<TContext>(context, value);
            source.AddAsItem(ref cvb);
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
