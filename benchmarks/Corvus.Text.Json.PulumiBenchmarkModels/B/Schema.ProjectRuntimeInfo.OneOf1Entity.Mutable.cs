    ...
    public readonly partial struct ProjectRuntimeInfo
    {
        ...
        public readonly partial struct OneOf1Entity
        {
...
#endif
            {
                ...
                /// Name
                /// </summary>
                public Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Name.Mutable NameValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameValueUtf8, out Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Name.Mutable value))
                        {
                            return value;
                        }
                ...
                /// Options
                /// </summary>
                public Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Options.Mutable OptionsValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OptionsValueUtf8, out Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Options.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetNameValue(in Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Name.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetOptionsValue(in Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Options.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetOptionsValue<TContext>(in Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Options.Source<TContext> value)
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Name.Source name = default,
                    in Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Options.Source options = default)
                {
                ...
                /// Creates an instance of a <see cref="OneOf1Entity"/>.
                /// </summary>
                public void Create(in Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Name.Source name = default, in Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Options.Source options = default)
                {
                ...
                internal static void Create<TContext>(
                    ...
                    ref ComplexValueBuilder builder,
                    in Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Name.Source name = default,
                    in Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Options.Source<TContext> options = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Name.Source name = default, in Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Options.Source options = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Name.Source name = default, in Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Options.Source<TContext> options = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
