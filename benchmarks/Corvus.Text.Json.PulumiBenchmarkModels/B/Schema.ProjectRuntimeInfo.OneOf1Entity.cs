...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ProjectRuntimeInfo
    {
...
#endif
        {
            ...
            /// Name
            /// </summary>
            public Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Name NameValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameValueUtf8, out Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Name value))
                    {
                        return value;
                    }
            ...
            /// Options
            /// </summary>
            public Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Options OptionsValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OptionsValueUtf8, out Corvus.PulumiBenchmark.Baseline.Schema.ProjectRuntimeInfo.OneOf1Entity.Options value))
                    {
                        return value;
                    }
            ...
            public static class JsonPropertyNames
            {
                ...
                /// <summary>
                /// Gets the JSON property name for <see cref="OptionsValue"/>.
                /// </summary>
                public const string OptionsValue = "options";
                ...
                /// Gets the JSON property name for <see cref="OptionsValue"/>.
                /// </summary>
                public static ReadOnlySpan<byte> OptionsValueUtf8 => "options"u8;
            }
            ...
            private static class JsonPropertyNamesEscaped
            {
                ...
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="OptionsValue"/>.
                /// </summary>
                public static ReadOnlySpan<byte> OptionsValue => "options"u8;
            }
        }
    }
}
