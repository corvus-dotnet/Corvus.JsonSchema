    ...
    public readonly partial struct ProjectTemplate
    {
        ...
        public readonly partial struct ConfigToApplyToEachStackInTheProject
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.PulumiBenchmark.Baseline.Schema.ProjectTemplate.ConfigToApplyToEachStackInTheProject.AdditionalPropertiesEntity.DescriptionOfTheConfig Description
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DescriptionUtf8, out Corvus.PulumiBenchmark.Baseline.Schema.ProjectTemplate.ConfigToApplyToEachStackInTheProject.AdditionalPropertiesEntity.DescriptionOfTheConfig value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.PulumiBenchmark.Baseline.Schema.ProjectTemplate.ConfigToApplyToEachStackInTheProject.AdditionalPropertiesEntity.SecretEntity Secret
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SecretUtf8, out Corvus.PulumiBenchmark.Baseline.Schema.ProjectTemplate.ConfigToApplyToEachStackInTheProject.AdditionalPropertiesEntity.SecretEntity value))
                        {
                            return value;
                        }
