...
public readonly partial struct Schema
{
    ...
    public readonly partial struct SimpleConfigType
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(SimpleConfigType instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="SimpleConfigType"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SimpleConfigType(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SimpleConfigType.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly SimpleConfigType Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly SimpleConfigType Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<SimpleConfigType>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(SimpleConfigType instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<SimpleConfigType, Mutable>(this);
        }
    }
}
