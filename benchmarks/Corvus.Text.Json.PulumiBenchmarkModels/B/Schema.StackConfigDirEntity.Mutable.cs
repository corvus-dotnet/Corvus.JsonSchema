...
public readonly partial struct Schema
{
    ...
    public readonly partial struct StackConfigDirEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(StackConfigDirEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="StackConfigDirEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator StackConfigDirEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"StackConfigDirEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly StackConfigDirEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly StackConfigDirEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<StackConfigDirEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(StackConfigDirEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<StackConfigDirEntity, Mutable>(this);
        }
    }
}
