...
public readonly partial struct Schema
{
    ...
    public readonly partial struct WebsiteEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(WebsiteEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="WebsiteEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator WebsiteEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"WebsiteEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly WebsiteEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly WebsiteEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<WebsiteEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(WebsiteEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<WebsiteEntity, Mutable>(this);
        }
    }
}
