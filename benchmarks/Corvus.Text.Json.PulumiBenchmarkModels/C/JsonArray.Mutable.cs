...
public readonly partial struct JsonArray
{
    ...
    public ref struct Source
    {
        ...
        internal Source(Corvus.PulumiBenchmark.Current.JsonArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.PulumiBenchmark.Current.JsonArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
