...
public readonly partial struct PulumiSchema
{
    ...
    public readonly partial struct AdditionalProjectOptions
    {
...
#endif
        {
            ...
            public void SetRefresh(in Corvus.PulumiBenchmark.Current.PulumiSchema.AdditionalProjectOptions.RefreshEntity.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(in Corvus.PulumiBenchmark.Current.PulumiSchema.AdditionalProjectOptions.RefreshEntity.Source arg1)
            {
                _createArg1 = arg1;
                _kind = Kind.Create;
            }
        ...
        public ref struct Builder
        {
            ...
            internal static void BuildCreateValue(in Corvus.PulumiBenchmark.Current.PulumiSchema.AdditionalProjectOptions.RefreshEntity.Source arg1, ref ComplexValueBuilder o)
            {
                o.StartObject();
                Create(ref o, arg1);
                o.EndObject();
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(in Corvus.PulumiBenchmark.Current.PulumiSchema.AdditionalProjectOptions.RefreshEntity.Source refresh = default)
        {
