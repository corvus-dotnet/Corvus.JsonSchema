...
public readonly partial struct PulumiSchema
{
    ...
    public readonly partial struct AdditionalProjectOptions
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(AdditionalProjectOptions instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="AdditionalProjectOptions"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AdditionalProjectOptions(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.PulumiBenchmark.Current.PulumiSchema.AdditionalProjectOptions.RefreshEntity.Mutable Refresh
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RefreshUtf8, out Corvus.PulumiBenchmark.Current.PulumiSchema.AdditionalProjectOptions.RefreshEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new AdditionalProjectOptions(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetRefresh(scoped in Corvus.PulumiBenchmark.Current.PulumiSchema.AdditionalProjectOptions.RefreshEntity.Source value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AdditionalProjectOptions.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="AdditionalProjectOptions"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="AdditionalProjectOptions"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly AdditionalProjectOptions Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<AdditionalProjectOptions>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="AdditionalProjectOptions"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly AdditionalProjectOptions Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<AdditionalProjectOptions>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.PulumiBenchmark.Current.PulumiSchema.AdditionalProjectOptions.RefreshEntity.Source _createArg1;
            ...
            internal Source(Corvus.PulumiBenchmark.Current.PulumiSchema.AdditionalProjectOptions.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.PulumiBenchmark.Current.PulumiSchema.AdditionalProjectOptions.RefreshEntity.Source arg1)
            {
                _createArg1 = arg1;
                _kind = Kind.Create;
            }

            public static implicit operator Source(AdditionalProjectOptions instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.PulumiBenchmark.Current.PulumiSchema.AdditionalProjectOptions.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="AdditionalProjectOptions"/>.
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.PulumiBenchmark.Current.PulumiSchema.AdditionalProjectOptions.RefreshEntity.Source refresh = default)
            {
            ...
            /// Creates an instance of a <see cref="AdditionalProjectOptions"/>.
            /// </summary>
            public void Create(in Corvus.PulumiBenchmark.Current.PulumiSchema.AdditionalProjectOptions.RefreshEntity.Source refresh = default)
            {
                Create(ref _builder, refresh);
            }
            ...
            internal static void BuildCreateValue(scoped in Corvus.PulumiBenchmark.Current.PulumiSchema.AdditionalProjectOptions.RefreshEntity.Source arg1, ref ComplexValueBuilder o)
            {
                o.StartObject();
                Create(ref o, arg1);
                o.EndObject();
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.PulumiBenchmark.Current.PulumiSchema.AdditionalProjectOptions.RefreshEntity.Source refresh = default)
        {
            return new Source(refresh);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.PulumiBenchmark.Current.PulumiSchema.AdditionalProjectOptions.RefreshEntity.Source refresh = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        {
            return workspace.CreateBuilder<AdditionalProjectOptions, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<AdditionalProjectOptions> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<AdditionalProjectOptions>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<AdditionalProjectOptions> Create<TContext>(
        ...
        public static ParsedJsonDocument<AdditionalProjectOptions> Create(in Corvus.PulumiBenchmark.Current.PulumiSchema.AdditionalProjectOptions.RefreshEntity.Source refresh = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
