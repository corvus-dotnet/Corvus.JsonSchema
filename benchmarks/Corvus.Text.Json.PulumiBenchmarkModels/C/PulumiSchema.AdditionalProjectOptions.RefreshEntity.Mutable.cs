    ...
    public readonly partial struct AdditionalProjectOptions
    {
        ...
        public readonly partial struct RefreshEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RefreshEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RefreshEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RefreshEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RefreshEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RefreshEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RefreshEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RefreshEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RefreshEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RefreshEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RefreshEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RefreshEntity>();
                }
                finally
                {
