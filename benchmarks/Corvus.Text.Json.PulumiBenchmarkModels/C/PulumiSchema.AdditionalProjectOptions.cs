...
public readonly partial struct PulumiSchema
{
    ...
    public readonly partial struct AdditionalProjectOptions
        ...
        : IJsonElement<AdditionalProjectOptions>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AdditionalProjectOptions"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal AdditionalProjectOptions(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static AdditionalProjectOptions DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.PulumiBenchmark.Current.PulumiSchema.AdditionalProjectOptions.RefreshEntity Refresh
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RefreshUtf8, out Corvus.PulumiBenchmark.Current.PulumiSchema.AdditionalProjectOptions.RefreshEntity value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in AdditionalProjectOptions left, in AdditionalProjectOptions right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in AdditionalProjectOptions left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(AdditionalProjectOptions instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator AdditionalProjectOptions(JsonElement instance)
        {
            return AdditionalProjectOptions.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AdditionalProjectOptions From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AdditionalProjectOptions ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AdditionalProjectOptions>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AdditionalProjectOptions ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AdditionalProjectOptions>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AdditionalProjectOptions ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AdditionalProjectOptions>(json, options);
        }
        ...
        /// </exception>
        public static AdditionalProjectOptions ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<AdditionalProjectOptions>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out AdditionalProjectOptions? result)
        {
            return JsonElementHelpers.TryParseValue<AdditionalProjectOptions>(ref reader, out result);
        }
...
#if NET
        static AdditionalProjectOptions IJsonElement<AdditionalProjectOptions>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"AdditionalProjectOptions: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public AdditionalProjectOptions Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public AdditionalProjectOptions Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<AdditionalProjectOptions>(_idx);
            }
