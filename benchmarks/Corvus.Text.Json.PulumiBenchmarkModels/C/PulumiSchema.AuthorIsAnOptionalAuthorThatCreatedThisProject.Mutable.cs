...
public readonly partial struct PulumiSchema
{
    ...
    public readonly partial struct AuthorIsAnOptionalAuthorThatCreatedThisProject
    {
        ...
        public static ParsedJsonDocument<AuthorIsAnOptionalAuthorThatCreatedThisProject> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<AuthorIsAnOptionalAuthorThatCreatedThisProject>();
            }
            finally
            {
