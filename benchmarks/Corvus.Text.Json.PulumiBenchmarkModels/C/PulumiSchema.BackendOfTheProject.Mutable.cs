...
public readonly partial struct PulumiSchema
{
    ...
    public readonly partial struct BackendOfTheProject
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(BackendOfTheProject instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="BackendOfTheProject"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator BackendOfTheProject(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.PulumiBenchmark.Current.JsonString.Mutable Url
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UrlUtf8, out Corvus.PulumiBenchmark.Current.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new BackendOfTheProject(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetUrl(scoped in Corvus.PulumiBenchmark.Current.JsonString.Source value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"BackendOfTheProject.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="BackendOfTheProject"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="BackendOfTheProject"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly BackendOfTheProject Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<BackendOfTheProject>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="BackendOfTheProject"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly BackendOfTheProject Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<BackendOfTheProject>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.PulumiBenchmark.Current.PulumiSchema.BackendOfTheProject.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.PulumiBenchmark.Current.JsonString.Source arg1)
            {
                _createArg1 = arg1;
                _kind = Kind.Create;
            }

            public static implicit operator Source(BackendOfTheProject instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.PulumiBenchmark.Current.PulumiSchema.BackendOfTheProject.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="BackendOfTheProject"/>.
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.PulumiBenchmark.Current.JsonString.Source url = default)
            {
            ...
            /// Creates an instance of a <see cref="BackendOfTheProject"/>.
            /// </summary>
            public void Create(in Corvus.PulumiBenchmark.Current.JsonString.Source url = default)
            {
            ...
            internal static void BuildCreateValue(scoped in Corvus.PulumiBenchmark.Current.JsonString.Source arg1, ref ComplexValueBuilder o)
            {
                o.StartObject();
                Create(ref o, arg1);
                o.EndObject();
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.PulumiBenchmark.Current.JsonString.Source url = default)
        {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.PulumiBenchmark.Current.JsonString.Source url = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        {
            return workspace.CreateBuilder<BackendOfTheProject, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<BackendOfTheProject> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<BackendOfTheProject>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<BackendOfTheProject> Create<TContext>(
        ...
        public static ParsedJsonDocument<BackendOfTheProject> Create(in Corvus.PulumiBenchmark.Current.JsonString.Source url = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
