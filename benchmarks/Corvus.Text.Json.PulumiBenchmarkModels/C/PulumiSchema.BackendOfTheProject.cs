...
public readonly partial struct PulumiSchema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.PulumiBenchmark.Current.JsonString Url
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UrlUtf8, out Corvus.PulumiBenchmark.Current.JsonString value))
                {
                    return value;
                }
