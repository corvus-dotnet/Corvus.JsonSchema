    ...
    public readonly partial struct ConfigEntity
    {
        ...
        public readonly partial struct AdditionalPropertiesEntity
        {
...
#endif
            {
                ...
                public static explicit operator Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigTypeDeclaration.Mutable(Mutable value)
                {
                    return Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigTypeDeclaration.Mutable.From(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigTypeDeclaration.Mutable value)
                {
                    return From(value);
                }
...
#endif
                {
                    ...
                    {
                        return matchJsonString(Corvus.PulumiBenchmark.Current.JsonString.Mutable.From(this), context);
                    }

                    if (Corvus.PulumiBenchmark.Current.JsonInteger.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchJsonInteger(Corvus.PulumiBenchmark.Current.JsonInteger.Mutable.From(this), context);
                    }
                    ...
                    {
                        return matchConfigTypeDeclaration(Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigTypeDeclaration.Mutable.From(this), context);
                    }
                    ...
                    Matcher<Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigEntity.AdditionalPropertiesEntity.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.PulumiBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchJsonString(Corvus.PulumiBenchmark.Current.JsonString.Mutable.From(this));
                    }

                    if (Corvus.PulumiBenchmark.Current.JsonInteger.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchJsonInteger(Corvus.PulumiBenchmark.Current.JsonInteger.Mutable.From(this));
                    }
                    ...
                    if (Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigTypeDeclaration.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchConfigTypeDeclaration(Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigTypeDeclaration.Mutable.From(this));
                    }
                ...
                public bool TryGetAsConfigTypeDeclaration(out Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigTypeDeclaration.Mutable result)
                {
                    if (Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigTypeDeclaration.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigTypeDeclaration.Mutable.From(this);
                        return true;
                    }
                ...
                public bool TryGetAsJsonString(out Corvus.PulumiBenchmark.Current.JsonString.Mutable result)
                {
                    if (Corvus.PulumiBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.PulumiBenchmark.Current.JsonString.Mutable.From(this);
                        return true;
                    }
                ...
                public bool TryGetAsJsonInteger(out Corvus.PulumiBenchmark.Current.JsonInteger.Mutable result)
                {
                    if (Corvus.PulumiBenchmark.Current.JsonInteger.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.PulumiBenchmark.Current.JsonInteger.Mutable.From(this);
                        return true;
                    }
                ...
                public bool TryGetAsJsonBoolean(out Corvus.PulumiBenchmark.Current.JsonBoolean.Mutable result)
                {
                    if (Corvus.PulumiBenchmark.Current.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.PulumiBenchmark.Current.JsonBoolean.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigEntity.AdditionalPropertiesEntity.ArrayBuilder.Build value) {_arrayBuilder = value; _kind = Kind.ArrayBuilder; }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.PulumiBenchmark.Current.JsonBoolean instance) => new(JsonElement.From(instance));

                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.PulumiBenchmark.Current.JsonInteger instance) => new(JsonElement.From(instance));

                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.PulumiBenchmark.Current.JsonString instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                private readonly Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigTypeDeclaration.Builder.Build<TContext>? _configTypeDeclarationBuilderInstance;
                ...
                internal Source(scoped in TContext context, Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigEntity.AdditionalPropertiesEntity.ArrayBuilder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.ArrayBuilder; }

                public Source(scoped in TContext context, Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigTypeDeclaration.Builder.Build<TContext> value) {_context = context; _configTypeDeclarationBuilderInstance = value; _kind = Kind.ConfigTypeDeclarationBuilder; }
                ...
                internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.ArrayBuilder:
                            ...
                            break;
                        case Kind.ConfigTypeDeclarationBuilder:
                            valueBuilder.AddProperty(name, BuildWithContext.Create(_context, _configTypeDeclarationBuilderInstance!), static (in b, ref o) => Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigTypeDeclaration.Builder.BuildValue(b.Context, b.Build, ref o));
                            break;
                        default:
                            Debug.Fail("Unexpected Kind");
                            break;
                ...
                internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.ArrayBuilder:
                            ...
                            break;
                        case Kind.ConfigTypeDeclarationBuilder:
                            valueBuilder.AddItem(BuildWithContext.Create(_context, _configTypeDeclarationBuilderInstance!), static (in b, ref o) => Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigTypeDeclaration.Builder.BuildValue(b.Context, b.Build, ref o));
                            break;
                        default:
                            Debug.Fail("Unexpected Kind");
                            break;
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigTypeDeclaration.Source Build(
                scoped in Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigTypeDeclaration.Builder.Build buildValue, int initialCapacity = 1)
            {
                return new Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigTypeDeclaration.Source(buildValue);
            }
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigTypeDeclaration.Source<TContext> Build<TContext>(
                scoped in TContext context, scoped in Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigTypeDeclaration.Builder.Build<TContext> buildValue, int initialCapacity = 1)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                return new Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigTypeDeclaration.Source<TContext>(context, buildValue);
            }
            ...
            /// <returns>An instance of a mutable document initialized with the given value.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(
                JsonWorkspace workspace, scoped in Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigTypeDeclaration.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
            {
                // Create the document builder without a MetadataDb
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                var source = new Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigTypeDeclaration.Source(value);
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(
                JsonWorkspace workspace, scoped in TContext context, scoped in Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigTypeDeclaration.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                ...
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                var source = new Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigTypeDeclaration.Source<TContext>(context, value);
                source.AddAsItem(ref cvb);
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<AdditionalPropertiesEntity> Create(
                scoped in Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigTypeDeclaration.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent(initialValueBufferSize);
                try
                {
            ...
            public static ParsedJsonDocument<AdditionalPropertiesEntity> Create<TContext>(
                scoped in TContext context, scoped in Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigTypeDeclaration.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
