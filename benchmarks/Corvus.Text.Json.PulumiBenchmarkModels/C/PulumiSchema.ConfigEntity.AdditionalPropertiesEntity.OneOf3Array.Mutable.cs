        ...
        public readonly partial struct AdditionalPropertiesEntity
        {
            ...
            public readonly partial struct OneOf3Array
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(OneOf3Array instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="OneOf3Array"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator OneOf3Array(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"OneOf3Array.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    /// <summary>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly OneOf3Array Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly OneOf3Array Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<OneOf3Array>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigEntity.AdditionalPropertiesEntity.OneOf3Array.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(OneOf3Array instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigEntity.AdditionalPropertiesEntity.OneOf3Array.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
                ...
                {
                    return workspace.CreateBuilder<OneOf3Array, Mutable>(this);
                }
            }
        }
    }
