...
public readonly partial struct PulumiSchema
{
    ...
    public readonly partial struct ConfigEntity
    {
        ...
        public readonly partial struct AdditionalPropertiesEntity
        {
            ...
            public readonly partial struct OneOf3Array
#if NET8_0_OR_GREATER
                : IJsonElement<OneOf3Array>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="OneOf3Array"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal OneOf3Array(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static OneOf3Array DefaultInstance { get; }
                ...
                /// </returns>
                public static bool operator ==(in OneOf3Array left, in OneOf3Array right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in OneOf3Array left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(OneOf3Array instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator OneOf3Array(JsonElement instance)
                {
                    return OneOf3Array.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static OneOf3Array From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static OneOf3Array ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<OneOf3Array>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static OneOf3Array ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<OneOf3Array>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static OneOf3Array ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<OneOf3Array>(json, options);
                }
                ...
                /// </exception>
                public static OneOf3Array ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<OneOf3Array>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out OneOf3Array? result)
                {
                    return JsonElementHelpers.TryParseValue<OneOf3Array>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new OneOf3Array(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static OneOf3Array IJsonElement<OneOf3Array>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"OneOf3Array: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="OneOf3Array"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="OneOf3Array"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public OneOf3Array Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<OneOf3Array>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="OneOf3Array"/> that lives for the lifetime of its
