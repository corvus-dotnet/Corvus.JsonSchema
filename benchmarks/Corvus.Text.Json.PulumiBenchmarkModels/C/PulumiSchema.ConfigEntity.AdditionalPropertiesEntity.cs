...
public readonly partial struct PulumiSchema
{
    ...
    public readonly partial struct ConfigEntity
    {
...
#endif
        {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigTypeDeclaration(AdditionalPropertiesEntity value)
            {
                return Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigTypeDeclaration.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigTypeDeclaration"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator AdditionalPropertiesEntity(Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigTypeDeclaration value)
            {
                return From(value);
            }
            ...
            public bool TryGetAsConfigTypeDeclaration(out Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigTypeDeclaration result)
            {
                ...
                {
                    result = Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigTypeDeclaration.From(this);
                    return true;
                }
            ...
            public bool TryGetAsJsonString(out Corvus.PulumiBenchmark.Current.JsonString result)
            {
                ...
                {
                    result = Corvus.PulumiBenchmark.Current.JsonString.From(this);
                    return true;
                }
            ...
            public bool TryGetAsJsonInteger(out Corvus.PulumiBenchmark.Current.JsonInteger result)
            {
                ...
                {
                    result = Corvus.PulumiBenchmark.Current.JsonInteger.From(this);
                    return true;
                }
            ...
            public bool TryGetAsJsonBoolean(out Corvus.PulumiBenchmark.Current.JsonBoolean result)
            {
                ...
                {
                    result = Corvus.PulumiBenchmark.Current.JsonBoolean.From(this);
                    return true;
                }
...
#endif
            {
                if (Corvus.PulumiBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonString(Corvus.PulumiBenchmark.Current.JsonString.From(this), context);
                }

                if (Corvus.PulumiBenchmark.Current.JsonInteger.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonInteger(Corvus.PulumiBenchmark.Current.JsonInteger.From(this), context);
                }
                ...
                if (Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigTypeDeclaration.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchConfigTypeDeclaration(Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigTypeDeclaration.From(this), context);
                }
                ...
                Matcher<Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigEntity.AdditionalPropertiesEntity, TResult> defaultMatch)
            {
                if (Corvus.PulumiBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonString(Corvus.PulumiBenchmark.Current.JsonString.From(this));
                }

                if (Corvus.PulumiBenchmark.Current.JsonInteger.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonInteger(Corvus.PulumiBenchmark.Current.JsonInteger.From(this));
                }
                ...
                if (Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigTypeDeclaration.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchConfigTypeDeclaration(Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigTypeDeclaration.From(this));
                }
