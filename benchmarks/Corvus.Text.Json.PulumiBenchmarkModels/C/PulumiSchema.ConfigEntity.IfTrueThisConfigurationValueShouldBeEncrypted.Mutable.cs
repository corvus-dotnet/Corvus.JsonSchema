    ...
    public readonly partial struct ConfigEntity
    {
        ...
        public readonly partial struct IfTrueThisConfigurationValueShouldBeEncrypted
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<IfTrueThisConfigurationValueShouldBeEncrypted, Mutable>(IfTrueThisConfigurationValueShouldBeEncrypted.DefaultInstance);
                ...
                public static explicit operator Mutable(IfTrueThisConfigurationValueShouldBeEncrypted instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="IfTrueThisConfigurationValueShouldBeEncrypted"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator IfTrueThisConfigurationValueShouldBeEncrypted(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"IfTrueThisConfigurationValueShouldBeEncrypted.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly IfTrueThisConfigurationValueShouldBeEncrypted Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly IfTrueThisConfigurationValueShouldBeEncrypted Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<IfTrueThisConfigurationValueShouldBeEncrypted>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(IfTrueThisConfigurationValueShouldBeEncrypted instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<IfTrueThisConfigurationValueShouldBeEncrypted, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<IfTrueThisConfigurationValueShouldBeEncrypted> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<IfTrueThisConfigurationValueShouldBeEncrypted>();
                }
                finally
                {
