...
public readonly partial struct PulumiSchema
{
    ...
    public readonly partial struct ConfigEntity
    {
        ...
        public readonly partial struct IfTrueThisConfigurationValueShouldBeEncrypted
#if NET8_0_OR_GREATER
            : IJsonElement<IfTrueThisConfigurationValueShouldBeEncrypted>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="IfTrueThisConfigurationValueShouldBeEncrypted"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal IfTrueThisConfigurationValueShouldBeEncrypted(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static IfTrueThisConfigurationValueShouldBeEncrypted DefaultInstance { get; } = ParsedJsonDocument<IfTrueThisConfigurationValueShouldBeEncrypted>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(IfTrueThisConfigurationValueShouldBeEncrypted value)
            {
            ...
            /// </returns>
            public static bool operator ==(in IfTrueThisConfigurationValueShouldBeEncrypted left, in IfTrueThisConfigurationValueShouldBeEncrypted right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in IfTrueThisConfigurationValueShouldBeEncrypted left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(IfTrueThisConfigurationValueShouldBeEncrypted instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator IfTrueThisConfigurationValueShouldBeEncrypted(JsonElement instance)
            {
                return IfTrueThisConfigurationValueShouldBeEncrypted.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static IfTrueThisConfigurationValueShouldBeEncrypted From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static IfTrueThisConfigurationValueShouldBeEncrypted ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<IfTrueThisConfigurationValueShouldBeEncrypted>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static IfTrueThisConfigurationValueShouldBeEncrypted ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<IfTrueThisConfigurationValueShouldBeEncrypted>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static IfTrueThisConfigurationValueShouldBeEncrypted ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<IfTrueThisConfigurationValueShouldBeEncrypted>(json, options);
            }
            ...
            /// </exception>
            public static IfTrueThisConfigurationValueShouldBeEncrypted ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<IfTrueThisConfigurationValueShouldBeEncrypted>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out IfTrueThisConfigurationValueShouldBeEncrypted? result)
            {
                return JsonElementHelpers.TryParseValue<IfTrueThisConfigurationValueShouldBeEncrypted>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new IfTrueThisConfigurationValueShouldBeEncrypted(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static IfTrueThisConfigurationValueShouldBeEncrypted IJsonElement<IfTrueThisConfigurationValueShouldBeEncrypted>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"IfTrueThisConfigurationValueShouldBeEncrypted: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="IfTrueThisConfigurationValueShouldBeEncrypted"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="IfTrueThisConfigurationValueShouldBeEncrypted"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public IfTrueThisConfigurationValueShouldBeEncrypted Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<IfTrueThisConfigurationValueShouldBeEncrypted>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="IfTrueThisConfigurationValueShouldBeEncrypted"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public IfTrueThisConfigurationValueShouldBeEncrypted Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<IfTrueThisConfigurationValueShouldBeEncrypted>(_idx);
                }
