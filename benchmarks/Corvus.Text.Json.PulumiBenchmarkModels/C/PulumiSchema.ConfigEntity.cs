...
public readonly partial struct PulumiSchema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigEntity.IfTrueThisConfigurationValueShouldBeEncrypted Secret
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SecretUtf8, out Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigEntity.IfTrueThisConfigurationValueShouldBeEncrypted value))
                {
                    return value;
                }

                return Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigEntity.IfTrueThisConfigurationValueShouldBeEncrypted.DefaultInstance;
            }
        }
