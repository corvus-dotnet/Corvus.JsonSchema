...
public readonly partial struct PulumiSchema
{
    ...
    public readonly partial struct ConfigItemsType
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.TypeEntity.Mutable Type
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.TypeEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetType<TContext>(in Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.TypeEntity.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
            ...
            public bool TryGetAsWithTypeArray(out Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.WithTypeArray.Mutable result)
            {
                if (Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.WithTypeArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.WithTypeArray.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.TypeEntity.Source type,
            ...
            /// Creates an instance of a <see cref="ConfigItemsType"/>.
            /// </summary>
            public void Create(in Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.TypeEntity.Source type, in Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.Source items = default)
            {
            ...
            internal static void Create<TContext>(
                in TContext context,
                ref ComplexValueBuilder builder,
                in Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.TypeEntity.Source<TContext> type,
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.TypeEntity.Source type, in Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.Source items = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.TypeEntity.Source<TContext> type, in Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.Source<TContext> items = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
        ...
        public static ParsedJsonDocument<ConfigItemsType> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ConfigItemsType>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ConfigItemsType> Create<TContext>(
        ...
        public static ParsedJsonDocument<ConfigItemsType> Create(in Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.TypeEntity.Source type, in Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.Source items = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ConfigItemsType> Create<TContext>(in TContext context, in Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.TypeEntity.Source<TContext> type, in Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.Source<TContext> items = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
