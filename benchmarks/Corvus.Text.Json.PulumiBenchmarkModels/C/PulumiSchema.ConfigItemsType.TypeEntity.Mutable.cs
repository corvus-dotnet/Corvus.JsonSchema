    ...
    public readonly partial struct ConfigItemsType
    {
        ...
        public readonly partial struct TypeEntity
        {
...
#endif
            {
                ...
                /// <summary>
                /// Conversion to <see cref="Corvus.PulumiBenchmark.Current.PulumiSchema.SimpleConfigType"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static explicit operator Corvus.PulumiBenchmark.Current.PulumiSchema.SimpleConfigType.Mutable(Mutable value)
                {
                    return Corvus.PulumiBenchmark.Current.PulumiSchema.SimpleConfigType.Mutable.From(value);
                }

                /// <summary>
                /// Conversion from <see cref="Corvus.PulumiBenchmark.Current.PulumiSchema.SimpleConfigType"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.PulumiBenchmark.Current.PulumiSchema.SimpleConfigType.Mutable value)
                {
                    return From(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static explicit operator Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.Mutable(Mutable value)
                {
                    return Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.Mutable.From(value);
                }

                /// <summary>
                /// Conversion from <see cref="Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.Mutable value)
                {
                    return From(value);
                }
                ...
                /// </remarks>
                public void Apply(in Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType value)
                {
                    CheckValidInstance();
                ...
                /// <param name="matchSimpleConfigType">Match a <see cref="Corvus.PulumiBenchmark.Current.PulumiSchema.SimpleConfigType"/>.</param>
                /// <param name="matchConfigItemsType">Match a <see cref="Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType"/>.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Matcher<Corvus.PulumiBenchmark.Current.PulumiSchema.SimpleConfigType, TContext, TResult> matchSimpleConfigType,
                    Matcher<Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType, TContext, TResult> matchConfigItemsType,
                    Matcher<Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.TypeEntity.Mutable, TContext, TResult> defaultMatch)
...
#endif
                {
                    ...
                    {
                        return matchSimpleConfigType(Corvus.PulumiBenchmark.Current.PulumiSchema.SimpleConfigType.Mutable.From(this), context);
                    }

                    if (Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchConfigItemsType(Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    Matcher<Corvus.PulumiBenchmark.Current.PulumiSchema.SimpleConfigType, TResult> matchSimpleConfigType,
                    Matcher<Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType, TResult> matchConfigItemsType,
                    Matcher<Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.TypeEntity.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.PulumiBenchmark.Current.PulumiSchema.SimpleConfigType.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchSimpleConfigType(Corvus.PulumiBenchmark.Current.PulumiSchema.SimpleConfigType.Mutable.From(this));
                    }

                    if (Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchConfigItemsType(Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.Mutable.From(this));
                    }
                ...
                public bool TryGetAsConfigItemsType(out Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.Mutable result)
                {
                    if (Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.Mutable.From(this);
                        return true;
                    }
                ...
                public bool TryGetAsSimpleConfigType(out Corvus.PulumiBenchmark.Current.PulumiSchema.SimpleConfigType.Mutable result)
                {
                    if (Corvus.PulumiBenchmark.Current.PulumiSchema.SimpleConfigType.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.PulumiBenchmark.Current.PulumiSchema.SimpleConfigType.Mutable.From(this);
                        return true;
                    }
                ...
                #endif
            {
                ...
                TContext _context;
                Source _source;
                private readonly Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.Builder.Build<TContext>? _configItemsTypeBuilderInstance;
                ...
                public Source(scoped in TContext context, Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.Builder.Build<TContext> value) {_context = context; _configItemsTypeBuilderInstance = value; _kind = Kind.ConfigItemsTypeBuilder; }
                ...
                internal void AddAsProperty(ReadOnlySpan<byte> utf8Name, ref ComplexValueBuilder valueBuilder, bool escapeName = true, bool nameRequiresUnescaping = false)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.Source:
                            ...
                            break;
                        case Kind.ConfigItemsTypeBuilder:
                            valueBuilder.AddProperty(utf8Name, BuildWithContext.Create(_context, _configItemsTypeBuilderInstance!), static (in b, ref o) => Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.Builder.BuildValue(b.Context, b.Build, ref o), escapeName, nameRequiresUnescaping);
                            break;
                        default:
                            Debug.Fail("Unexpected Kind");
                            break;
                ...
                internal void AddAsPrebakedProperty(ReadOnlySpan<byte> prebakedPropertyName, ref ComplexValueBuilder valueBuilder)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.Source:
                            ...
                            break;
                        case Kind.ConfigItemsTypeBuilder:
                            valueBuilder.AddPrebakedProperty(prebakedPropertyName, BuildWithContext.Create(_context, _configItemsTypeBuilderInstance!), static (in b, ref o) => Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.Builder.BuildValue(b.Context, b.Build, ref o));
                            break;
                        default:
                            Debug.Fail("Unexpected Kind");
                            break;
                ...
                internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.Source:
                            ...
                            break;
                        case Kind.ConfigItemsTypeBuilder:
                            valueBuilder.AddProperty(name, BuildWithContext.Create(_context, _configItemsTypeBuilderInstance!), static (in b, ref o) => Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.Builder.BuildValue(b.Context, b.Build, ref o));
                            break;
                        default:
                            Debug.Fail("Unexpected Kind");
                            break;
                ...
                internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.Source:
                            ...
                            break;
                        case Kind.ConfigItemsTypeBuilder:
                            valueBuilder.AddItem(BuildWithContext.Create(_context, _configItemsTypeBuilderInstance!), static (in b, ref o) => Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.Builder.BuildValue(b.Context, b.Build, ref o));
                            break;
                        default:
                            Debug.Fail("Unexpected Kind");
                            break;
            ...
            public static Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.Source Build(
                scoped in Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.Builder.Build buildValue, int initialCapacity = 1)
            {
                return new Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.Source(buildValue);
            }
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.Source<TContext> Build<TContext>(
                scoped in TContext context, scoped in Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.Builder.Build<TContext> buildValue, int initialCapacity = 1)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                return new Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.Source<TContext>(context, buildValue);
            }
            ...
            /// <returns>An instance of a mutable document initialized with the given value.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(
                JsonWorkspace workspace, scoped in Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
            {
                // Create the document builder without a MetadataDb
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                var source = new Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.Source(value);
            ...
            /// <returns>An instance of a mutable document initialized with the given value.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(
                JsonWorkspace workspace, scoped in TContext context, scoped in Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                ...
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                var source = new Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.Source<TContext>(context, value);
                source.AddAsItem(ref cvb);
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<TypeEntity> Create(
                scoped in Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent(initialValueBufferSize);
                try
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<TypeEntity> Create<TContext>(
                scoped in TContext context, scoped in Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
