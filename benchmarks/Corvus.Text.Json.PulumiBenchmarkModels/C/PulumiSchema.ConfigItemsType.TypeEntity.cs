...
public readonly partial struct PulumiSchema
{
    ...
    public readonly partial struct ConfigItemsType
    {
...
#endif
        {
            ...
            public static explicit operator Corvus.PulumiBenchmark.Current.PulumiSchema.SimpleConfigType(TypeEntity value)
            {
                return Corvus.PulumiBenchmark.Current.PulumiSchema.SimpleConfigType.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator TypeEntity(Corvus.PulumiBenchmark.Current.PulumiSchema.SimpleConfigType value)
            {
                return From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType(TypeEntity value)
            {
                return Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.From(value);
            }
            ...
            public bool TryGetAsConfigItemsType(out Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType result)
            {
                ...
                {
                    result = Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.From(this);
                    return true;
                }
            ...
            public bool TryGetAsSimpleConfigType(out Corvus.PulumiBenchmark.Current.PulumiSchema.SimpleConfigType result)
            {
                ...
                {
                    result = Corvus.PulumiBenchmark.Current.PulumiSchema.SimpleConfigType.From(this);
                    return true;
                }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.TypeEntity, TContext, TResult> defaultMatch)
...
#endif
            {
                if (Corvus.PulumiBenchmark.Current.PulumiSchema.SimpleConfigType.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchSimpleConfigType(Corvus.PulumiBenchmark.Current.PulumiSchema.SimpleConfigType.From(this), context);
                }

                if (Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchConfigItemsType(Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.TypeEntity, TResult> defaultMatch)
            {
                if (Corvus.PulumiBenchmark.Current.PulumiSchema.SimpleConfigType.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchSimpleConfigType(Corvus.PulumiBenchmark.Current.PulumiSchema.SimpleConfigType.From(this));
                }

                if (Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchConfigItemsType(Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.From(this));
                }
