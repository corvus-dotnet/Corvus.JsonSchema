    ...
    public readonly partial struct ConfigItemsType
    {
        ...
        public readonly partial struct WithTypeArray
        {
...
#endif
            {
                ...
                /// </summary>
                public Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.WithTypeArray.TypeEntity.Mutable Type
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.WithTypeArray.TypeEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetType(scoped in Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.WithTypeArray.TypeEntity.Source value)
                {
                    CheckValidInstance();
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.WithTypeArray.TypeEntity.Source _createArg1;
                ...
                internal Source(Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.WithTypeArray.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.WithTypeArray.TypeEntity.Source arg1)
                {
                    _createArg1 = arg1;
                    _kind = Kind.Create;
                }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.WithTypeArray.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.WithTypeArray.TypeEntity.Source type = default)
                {
                ...
                /// Creates an instance of a <see cref="WithTypeArray"/>.
                /// </summary>
                public void Create(in Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.WithTypeArray.TypeEntity.Source type = default)
                {
                ...
                internal static void BuildCreateValue(scoped in Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.WithTypeArray.TypeEntity.Source arg1, ref ComplexValueBuilder o)
                {
                    o.StartObject();
                    Create(ref o, arg1);
                    o.EndObject();
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.WithTypeArray.TypeEntity.Source type = default)
            {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.WithTypeArray.TypeEntity.Source type = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            public static ParsedJsonDocument<WithTypeArray> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<WithTypeArray>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<WithTypeArray> Create<TContext>(
            ...
            public static ParsedJsonDocument<WithTypeArray> Create(in Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.WithTypeArray.TypeEntity.Source type = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
