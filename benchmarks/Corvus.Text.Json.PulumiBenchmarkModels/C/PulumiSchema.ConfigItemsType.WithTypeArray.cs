...
public readonly partial struct PulumiSchema
{
    ...
    public readonly partial struct ConfigItemsType
    {
...
#endif
        {
            ...
            /// </summary>
            public Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.WithTypeArray.TypeEntity Type
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.WithTypeArray.TypeEntity value))
                    {
                        return value;
                    }
