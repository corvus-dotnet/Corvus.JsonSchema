...
public readonly partial struct PulumiSchema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.TypeEntity Type
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.TypeEntity value))
                {
                    return value;
                }
        ...
        public bool TryGetAsWithTypeArray(out Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.WithTypeArray result)
        {
            ...
            {
                result = Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.WithTypeArray.From(this);
                return true;
            }
