...
public readonly partial struct PulumiSchema
{
    ...
    public readonly partial struct ConfigTypeDeclaration
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ConfigTypeDeclaration instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ConfigTypeDeclaration"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ConfigTypeDeclaration(Mutable instance)
            {
            ...
            /// </summary>
            public Corvus.PulumiBenchmark.Current.JsonString.Mutable Description
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DescriptionUtf8, out Corvus.PulumiBenchmark.Current.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.Mutable Items
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ItemsUtf8, out Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public Corvus.PulumiBenchmark.Current.JsonBoolean.Mutable Secret
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SecretUtf8, out Corvus.PulumiBenchmark.Current.JsonBoolean.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public Corvus.PulumiBenchmark.Current.PulumiSchema.SimpleConfigType.Mutable Type
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.PulumiBenchmark.Current.PulumiSchema.SimpleConfigType.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ConfigTypeDeclaration(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetItems<TContext>(in Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ConfigTypeDeclaration.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ConfigTypeDeclaration"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ConfigTypeDeclaration"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly ConfigTypeDeclaration Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ConfigTypeDeclaration>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ConfigTypeDeclaration"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly ConfigTypeDeclaration Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ConfigTypeDeclaration>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.Source _createArg3;
            private readonly Corvus.PulumiBenchmark.Current.JsonBoolean.Source _createArg4;
            private readonly Corvus.PulumiBenchmark.Current.PulumiSchema.SimpleConfigType.Source _createArg5;
            ...
            public static implicit operator Source(ConfigTypeDeclaration instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            private readonly Corvus.PulumiBenchmark.Current.JsonString.Source _createArg2;
            private readonly Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.Source<TContext> _createArg3;
            private readonly Corvus.PulumiBenchmark.Current.JsonBoolean.Source _createArg4;
            private readonly Corvus.PulumiBenchmark.Current.PulumiSchema.SimpleConfigType.Source _createArg5;
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="ConfigTypeDeclaration"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.Text.Json.JsonElement.Source defaultValue = default,
                in Corvus.PulumiBenchmark.Current.JsonString.Source description = default,
                in Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.Source items = default,
                in Corvus.PulumiBenchmark.Current.JsonBoolean.Source secret = default,
                in Corvus.PulumiBenchmark.Current.PulumiSchema.SimpleConfigType.Source type = default,
            ...
            public void Create(
                ...
                in Corvus.Text.Json.JsonElement.Source value = default)
            {
                Create(ref _builder, defaultValue, description, items, secret, type, value);
            }
            ...
            internal static void Create<TContext>(
                ...
                in Corvus.PulumiBenchmark.Current.JsonString.Source description = default,
                in Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.Source<TContext> items = default,
                in Corvus.PulumiBenchmark.Current.JsonBoolean.Source secret = default,
                in Corvus.PulumiBenchmark.Current.PulumiSchema.SimpleConfigType.Source type = default,
            ...
            #endif
            {
                Create(context, ref _builder, defaultValue, description, items, secret, type, value);
            }
        ...
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.JsonElement.Source<TContext> defaultValue = default, scoped in Corvus.PulumiBenchmark.Current.JsonString.Source description = default, scoped in Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.Source<TContext> items = default, scoped in Corvus.PulumiBenchmark.Current.JsonBoolean.Source secret = default, scoped in Corvus.PulumiBenchmark.Current.PulumiSchema.SimpleConfigType.Source type = default, scoped in Corvus.Text.Json.JsonElement.Source<TContext> value = default)
            ...
            #endif
        {
            return new Source<TContext>(context, defaultValue, description, items, secret, type, value);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.JsonElement.Source defaultValue = default, in Corvus.PulumiBenchmark.Current.JsonString.Source description = default, in Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.Source items = default, in Corvus.PulumiBenchmark.Current.JsonBoolean.Source secret = default, in Corvus.PulumiBenchmark.Current.PulumiSchema.SimpleConfigType.Source type = default, in Corvus.Text.Json.JsonElement.Source value = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(defaultValue, description, items, secret, type, value);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> defaultValue = default, in Corvus.PulumiBenchmark.Current.JsonString.Source description = default, in Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.Source<TContext> items = default, in Corvus.PulumiBenchmark.Current.JsonBoolean.Source secret = default, in Corvus.PulumiBenchmark.Current.PulumiSchema.SimpleConfigType.Source type = default, in Corvus.Text.Json.JsonElement.Source<TContext> value = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            ...
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(context, defaultValue, description, items, secret, type, value);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<ConfigTypeDeclaration, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ConfigTypeDeclaration> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ConfigTypeDeclaration>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ConfigTypeDeclaration> Create<TContext>(
        ...
        public static ParsedJsonDocument<ConfigTypeDeclaration> Create(in Corvus.Text.Json.JsonElement.Source defaultValue = default, in Corvus.PulumiBenchmark.Current.JsonString.Source description = default, in Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.Source items = default, in Corvus.PulumiBenchmark.Current.JsonBoolean.Source secret = default, in Corvus.PulumiBenchmark.Current.PulumiSchema.SimpleConfigType.Source type = default, in Corvus.Text.Json.JsonElement.Source value = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ConfigTypeDeclaration> Create<TContext>(in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> defaultValue = default, in Corvus.PulumiBenchmark.Current.JsonString.Source description = default, in Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType.Source<TContext> items = default, in Corvus.PulumiBenchmark.Current.JsonBoolean.Source secret = default, in Corvus.PulumiBenchmark.Current.PulumiSchema.SimpleConfigType.Source type = default, in Corvus.Text.Json.JsonElement.Source<TContext> value = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
