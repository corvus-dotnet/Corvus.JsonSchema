...
public readonly partial struct PulumiSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfigTypeDeclaration"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ConfigTypeDeclaration(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ConfigTypeDeclaration DefaultInstance { get; }
        ...
        /// </summary>
        public Corvus.PulumiBenchmark.Current.JsonString Description
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DescriptionUtf8, out Corvus.PulumiBenchmark.Current.JsonString value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType Items
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ItemsUtf8, out Corvus.PulumiBenchmark.Current.PulumiSchema.ConfigItemsType value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.PulumiBenchmark.Current.JsonBoolean Secret
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SecretUtf8, out Corvus.PulumiBenchmark.Current.JsonBoolean value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.PulumiBenchmark.Current.PulumiSchema.SimpleConfigType Type
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.PulumiBenchmark.Current.PulumiSchema.SimpleConfigType value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in ConfigTypeDeclaration left, in ConfigTypeDeclaration right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ConfigTypeDeclaration left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(ConfigTypeDeclaration instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ConfigTypeDeclaration(JsonElement instance)
        {
            return ConfigTypeDeclaration.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ConfigTypeDeclaration From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ConfigTypeDeclaration ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ConfigTypeDeclaration>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ConfigTypeDeclaration ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ConfigTypeDeclaration>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ConfigTypeDeclaration ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ConfigTypeDeclaration>(json, options);
        }
        ...
        /// </exception>
        public static ConfigTypeDeclaration ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ConfigTypeDeclaration>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ConfigTypeDeclaration? result)
        {
            return JsonElementHelpers.TryParseValue<ConfigTypeDeclaration>(ref reader, out result);
        }
...
#if NET
        static ConfigTypeDeclaration IJsonElement<ConfigTypeDeclaration>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ConfigTypeDeclaration: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public ConfigTypeDeclaration Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public ConfigTypeDeclaration Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ConfigTypeDeclaration>(_idx);
            }
