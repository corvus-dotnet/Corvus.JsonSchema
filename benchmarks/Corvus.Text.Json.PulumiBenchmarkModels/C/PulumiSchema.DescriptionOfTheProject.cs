...
public readonly partial struct PulumiSchema
{
    ...
    public readonly partial struct DescriptionOfTheProject
#if NET8_0_OR_GREATER
        : IJsonElement<DescriptionOfTheProject>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DescriptionOfTheProject"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal DescriptionOfTheProject(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static DescriptionOfTheProject DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(DescriptionOfTheProject value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in DescriptionOfTheProject left, in DescriptionOfTheProject right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in DescriptionOfTheProject left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(DescriptionOfTheProject instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator DescriptionOfTheProject(JsonElement instance)
        {
            return DescriptionOfTheProject.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DescriptionOfTheProject From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DescriptionOfTheProject ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<DescriptionOfTheProject>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DescriptionOfTheProject ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<DescriptionOfTheProject>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DescriptionOfTheProject ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<DescriptionOfTheProject>(json, options);
        }
        ...
        /// </exception>
        public static DescriptionOfTheProject ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<DescriptionOfTheProject>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out DescriptionOfTheProject? result)
        {
            return JsonElementHelpers.TryParseValue<DescriptionOfTheProject>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new DescriptionOfTheProject(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static DescriptionOfTheProject IJsonElement<DescriptionOfTheProject>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"DescriptionOfTheProject: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="DescriptionOfTheProject"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="DescriptionOfTheProject"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public DescriptionOfTheProject Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<DescriptionOfTheProject>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="DescriptionOfTheProject"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public DescriptionOfTheProject Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<DescriptionOfTheProject>(_idx);
            }
