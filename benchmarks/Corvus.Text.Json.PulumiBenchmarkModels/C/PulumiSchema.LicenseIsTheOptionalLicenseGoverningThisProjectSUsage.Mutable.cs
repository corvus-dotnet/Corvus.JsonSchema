...
public readonly partial struct PulumiSchema
{
    ...
    public readonly partial struct LicenseIsTheOptionalLicenseGoverningThisProjectSUsage
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(LicenseIsTheOptionalLicenseGoverningThisProjectSUsage instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="LicenseIsTheOptionalLicenseGoverningThisProjectSUsage"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator LicenseIsTheOptionalLicenseGoverningThisProjectSUsage(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"LicenseIsTheOptionalLicenseGoverningThisProjectSUsage.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly LicenseIsTheOptionalLicenseGoverningThisProjectSUsage Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly LicenseIsTheOptionalLicenseGoverningThisProjectSUsage Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<LicenseIsTheOptionalLicenseGoverningThisProjectSUsage>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(LicenseIsTheOptionalLicenseGoverningThisProjectSUsage instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<LicenseIsTheOptionalLicenseGoverningThisProjectSUsage, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<LicenseIsTheOptionalLicenseGoverningThisProjectSUsage> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<LicenseIsTheOptionalLicenseGoverningThisProjectSUsage>();
            }
            finally
            {
