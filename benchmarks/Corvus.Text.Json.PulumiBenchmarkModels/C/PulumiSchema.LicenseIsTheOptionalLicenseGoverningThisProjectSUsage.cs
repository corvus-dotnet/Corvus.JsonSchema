...
public readonly partial struct PulumiSchema
{
    ...
    public readonly partial struct LicenseIsTheOptionalLicenseGoverningThisProjectSUsage
#if NET8_0_OR_GREATER
        : IJsonElement<LicenseIsTheOptionalLicenseGoverningThisProjectSUsage>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LicenseIsTheOptionalLicenseGoverningThisProjectSUsage"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal LicenseIsTheOptionalLicenseGoverningThisProjectSUsage(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static LicenseIsTheOptionalLicenseGoverningThisProjectSUsage DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(LicenseIsTheOptionalLicenseGoverningThisProjectSUsage value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in LicenseIsTheOptionalLicenseGoverningThisProjectSUsage left, in LicenseIsTheOptionalLicenseGoverningThisProjectSUsage right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in LicenseIsTheOptionalLicenseGoverningThisProjectSUsage left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(LicenseIsTheOptionalLicenseGoverningThisProjectSUsage instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator LicenseIsTheOptionalLicenseGoverningThisProjectSUsage(JsonElement instance)
        {
            return LicenseIsTheOptionalLicenseGoverningThisProjectSUsage.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static LicenseIsTheOptionalLicenseGoverningThisProjectSUsage From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static LicenseIsTheOptionalLicenseGoverningThisProjectSUsage ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<LicenseIsTheOptionalLicenseGoverningThisProjectSUsage>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static LicenseIsTheOptionalLicenseGoverningThisProjectSUsage ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<LicenseIsTheOptionalLicenseGoverningThisProjectSUsage>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static LicenseIsTheOptionalLicenseGoverningThisProjectSUsage ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<LicenseIsTheOptionalLicenseGoverningThisProjectSUsage>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static LicenseIsTheOptionalLicenseGoverningThisProjectSUsage ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<LicenseIsTheOptionalLicenseGoverningThisProjectSUsage>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out LicenseIsTheOptionalLicenseGoverningThisProjectSUsage? result)
        {
            return JsonElementHelpers.TryParseValue<LicenseIsTheOptionalLicenseGoverningThisProjectSUsage>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new LicenseIsTheOptionalLicenseGoverningThisProjectSUsage(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static LicenseIsTheOptionalLicenseGoverningThisProjectSUsage IJsonElement<LicenseIsTheOptionalLicenseGoverningThisProjectSUsage>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"LicenseIsTheOptionalLicenseGoverningThisProjectSUsage: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="LicenseIsTheOptionalLicenseGoverningThisProjectSUsage"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="LicenseIsTheOptionalLicenseGoverningThisProjectSUsage"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public LicenseIsTheOptionalLicenseGoverningThisProjectSUsage Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<LicenseIsTheOptionalLicenseGoverningThisProjectSUsage>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="LicenseIsTheOptionalLicenseGoverningThisProjectSUsage"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public LicenseIsTheOptionalLicenseGoverningThisProjectSUsage Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<LicenseIsTheOptionalLicenseGoverningThisProjectSUsage>(_idx);
            }
