...
public readonly partial struct PulumiSchema
{
    ...
    public readonly partial struct PluginOptions
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.PulumiBenchmark.Current.JsonString.Mutable Name
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out Corvus.PulumiBenchmark.Current.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.PulumiBenchmark.Current.JsonString.Mutable Path
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PathUtf8, out Corvus.PulumiBenchmark.Current.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.PulumiBenchmark.Current.JsonString.Mutable Version
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionUtf8, out Corvus.PulumiBenchmark.Current.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.PulumiBenchmark.Current.PulumiSchema.PluginOptions.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.PulumiBenchmark.Current.JsonString.Source name,
                in Corvus.PulumiBenchmark.Current.JsonString.Source path,
                in Corvus.PulumiBenchmark.Current.JsonString.Source version = default)
            {
            ...
            public void Create(
                ...
                in Corvus.PulumiBenchmark.Current.JsonString.Source version = default)
            {
                Create(ref _builder, name, path, version);
            }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.PulumiBenchmark.Current.JsonString.Source name, in Corvus.PulumiBenchmark.Current.JsonString.Source path, in Corvus.PulumiBenchmark.Current.JsonString.Source version = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(name, path, version);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        public static ParsedJsonDocument<PluginOptions> Create(in Corvus.PulumiBenchmark.Current.JsonString.Source name, in Corvus.PulumiBenchmark.Current.JsonString.Source path, in Corvus.PulumiBenchmark.Current.JsonString.Source version = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
