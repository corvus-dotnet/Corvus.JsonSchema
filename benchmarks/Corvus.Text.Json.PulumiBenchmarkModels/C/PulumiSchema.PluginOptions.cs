...
public readonly partial struct PulumiSchema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.PulumiBenchmark.Current.JsonString Name
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out Corvus.PulumiBenchmark.Current.JsonString value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.PulumiBenchmark.Current.JsonString Path
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PathUtf8, out Corvus.PulumiBenchmark.Current.JsonString value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.PulumiBenchmark.Current.JsonString Version
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionUtf8, out Corvus.PulumiBenchmark.Current.JsonString value))
                {
                    return value;
                }
