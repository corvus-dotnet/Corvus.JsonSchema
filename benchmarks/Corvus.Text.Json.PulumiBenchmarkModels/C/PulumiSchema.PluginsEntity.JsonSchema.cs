...
public readonly partial struct PulumiSchema
{
    ...
    public readonly partial struct PluginsEntity
        : IJsonElement<PluginsEntity>
    {
        public static partial class JsonSchema
        {
            private static readonly JsonSchemaPathProvider AnalyzersSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/analyzers"u8, buffer, out written);
            private static readonly JsonSchemaPathProvider LanguagesSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/languages"u8, buffer, out written);
            private static readonly JsonSchemaPathProvider ProvidersSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/providers"u8, buffer, out written);

            private static void MatchAnalyzers(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext =
                    Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginOptionsArray.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.AnalyzersUtf8,
                        evaluationPath: AnalyzersSchemaEvaluationPath);

                Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginOptionsArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                context.CommitChildContext(childContext.IsMatch, ref childContext);
            }

            private static void MatchLanguages(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext1 =
                    Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginsForLanArray.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.LanguagesUtf8,
                        evaluationPath: LanguagesSchemaEvaluationPath);

                Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginsForLanArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                context.CommitChildContext(childContext1.IsMatch, ref childContext1);
            }

            private static void MatchProviders(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext2 =
                    Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginsForResArray.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.ProvidersUtf8,
                        evaluationPath: ProvidersSchemaEvaluationPath);

                Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginsForResArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
                context.CommitChildContext(childContext2.IsMatch, ref childContext2);
            }

            private static PropertySchemaMatchers<Corvus.PulumiBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
            {
                return new PropertySchemaMatchers<Corvus.PulumiBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator1>([
                    (static () => JsonPropertyNames.AnalyzersUtf8, MatchAnalyzers),
                    (static () => JsonPropertyNames.LanguagesUtf8, MatchLanguages),
                    (static () => JsonPropertyNames.ProvidersUtf8, MatchProviders),
                ]);
            }

            private static PropertySchemaMatchers<Corvus.PulumiBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator1> Matchers { get; } = MatchersBuilder();

            private static bool TryGetNamedMatcher(ReadOnlySpan<byte> span,
#if NET
            [NotNullWhen(true)]
#endif
            out Corvus.PulumiBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator1? matcher)
            {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://json.schemastore.org/pulumi.json#/properties/plugins"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "https://json.schemastore.org/pulumi.json#/properties/plugins";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://json.schemastore.org/pulumi.json#/properties/plugins"u8;
