...
public readonly partial struct PulumiSchema
{
    ...
    public readonly partial struct PluginsEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(PluginsEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="PluginsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PluginsEntity(Mutable instance)
            {
            ...
            /// <summary>
            /// Gets the (optional) <c>analyzers</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginOptionsArray.Mutable Analyzers
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AnalyzersUtf8, out Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginOptionsArray.Mutable value))
                    {
                        return value;
                    }
            ...
            /// <summary>
            /// Gets the (optional) <c>languages</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginsForLanArray.Mutable Languages
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LanguagesUtf8, out Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginsForLanArray.Mutable value))
                    {
                        return value;
                    }
            ...
            /// <summary>
            /// Gets the (optional) <c>providers</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginsForResArray.Mutable Providers
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ProvidersUtf8, out Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginsForResArray.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new PluginsEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetAnalyzers(scoped in Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginOptionsArray.Source value)
            {
                ...
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.AnalyzersUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AnalyzersUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                ...
                else
                {
                    ...
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Analyzers, ref cvb);
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetAnalyzers<TContext>(in Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginOptionsArray.Source<TContext> value)
            ...
            /// <summary>
            /// Remove the <c>analyzers</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveAnalyzers()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.AnalyzersUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            public void SetLanguages(scoped in Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginsForLanArray.Source value)
            {
                ...
                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.LanguagesUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LanguagesUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Languages, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetLanguages<TContext>(in Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginsForLanArray.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
            ...
            /// <summary>
            /// Remove the <c>languages</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveLanguages()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.LanguagesUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            public void SetProviders(scoped in Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginsForResArray.Source value)
            {
                ...
                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ProvidersUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ProvidersUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Providers, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetProviders<TContext>(in Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginsForResArray.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
            ...
            /// <summary>
            /// Remove the <c>providers</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveProviders()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ProvidersUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PluginsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="PluginsEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="PluginsEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly PluginsEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<PluginsEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="PluginsEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly PluginsEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<PluginsEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginOptionsArray.Source _createArg1;
            private readonly Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginsForLanArray.Source _createArg2;
            private readonly Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginsForResArray.Source _createArg3;
            ...
            public static implicit operator Source(PluginsEntity instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            private readonly Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginOptionsArray.Source<TContext> _createArg1;
            private readonly Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginsForLanArray.Source<TContext> _createArg2;
            private readonly Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginsForResArray.Source<TContext> _createArg3;
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="PluginsEntity"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginOptionsArray.Source analyzers = default,
                in Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginsForLanArray.Source languages = default,
                in Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginsForResArray.Source providers = default)
            {
                analyzers.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Analyzers, ref builder);
                languages.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Languages, ref builder);
                providers.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Providers, ref builder);
            }
            ...
            public void Create(
                ...
                in Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginsForResArray.Source providers = default)
            {
                Create(ref _builder, analyzers, languages, providers);
            }
            ...
            internal static void Create<TContext>(
                in TContext context,
                ref ComplexValueBuilder builder,
                in Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginOptionsArray.Source<TContext> analyzers = default,
                in Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginsForLanArray.Source<TContext> languages = default,
                in Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginsForResArray.Source<TContext> providers = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            #endif
            {
                Create(context, ref _builder, analyzers, languages, providers);
            }
        ...
        /// </summary>
        /// <param name="analyzers">The value of the <c>"analyzers"</c> property.</param>
        ...
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginOptionsArray.Source<TContext> analyzers = default, scoped in Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginsForLanArray.Source<TContext> languages = default, scoped in Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginsForResArray.Source<TContext> providers = default)
            ...
            #endif
        {
            return new Source<TContext>(context, analyzers, languages, providers);
        }
        ...
        /// </summary>
        /// <param name="workspace">The JSON workspace.</param>
        /// <param name="analyzers">The value of the property.</param>
        /// <param name="languages">The value of the property.</param>
        /// <param name="providers">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginOptionsArray.Source analyzers = default, in Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginsForLanArray.Source languages = default, in Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginsForResArray.Source providers = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(analyzers, languages, providers);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginOptionsArray.Source<TContext> analyzers = default, in Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginsForLanArray.Source<TContext> languages = default, in Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginsForResArray.Source<TContext> providers = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            ...
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(context, analyzers, languages, providers);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<PluginsEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<PluginsEntity> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<PluginsEntity>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<PluginsEntity> Create<TContext>(
        ...
        public static ParsedJsonDocument<PluginsEntity> Create(in Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginOptionsArray.Source analyzers = default, in Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginsForLanArray.Source languages = default, in Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginsForResArray.Source providers = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<PluginsEntity> Create<TContext>(in TContext context, in Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginOptionsArray.Source<TContext> analyzers = default, in Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginsForLanArray.Source<TContext> languages = default, in Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginsForResArray.Source<TContext> providers = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
