...
public readonly partial struct PulumiSchema
{
    ...
    public readonly partial struct PluginsEntity
    {
        ...
        public readonly partial struct PluginOptionsArray
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(PluginOptionsArray instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="PluginOptionsArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator PluginOptionsArray(Mutable instance)
                {
                ...
                public Corvus.PulumiBenchmark.Current.PulumiSchema.PluginOptions.Mutable this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.PulumiBenchmark.Current.PulumiSchema.PluginOptions.Mutable>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.PulumiBenchmark.Current.PulumiSchema.PluginOptions.Mutable> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.PulumiBenchmark.Current.PulumiSchema.PluginOptions.Mutable>(_parent, _idx);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new PluginOptionsArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"PluginOptionsArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetItem(int itemIndex, in Corvus.PulumiBenchmark.Current.PulumiSchema.PluginOptions.Source value)
                {
                    CheckValidInstance();
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void InsertItem(int itemIndex, scoped in Corvus.PulumiBenchmark.Current.PulumiSchema.PluginOptions.Source value)
                {
                    CheckValidInstance();
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void AddItem(scoped in Corvus.PulumiBenchmark.Current.PulumiSchema.PluginOptions.Source value)
                {
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Remove(in Corvus.PulumiBenchmark.Current.PulumiSchema.PluginOptions item)
                {
                    CheckValidInstance();
                    if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.PulumiBenchmark.Current.PulumiSchema.PluginOptions>(this, in item))
                    {
                        return false;
                    }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void RemoveWhere(JsonPredicate<Corvus.PulumiBenchmark.Current.PulumiSchema.PluginOptions> predicate)
                {
                    CheckValidInstance();
                    JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.PulumiBenchmark.Current.PulumiSchema.PluginOptions>(this, predicate);
                    _documentVersion = _parent.Version;
                }
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Replace(in Corvus.PulumiBenchmark.Current.PulumiSchema.PluginOptions oldItem, in Corvus.PulumiBenchmark.Current.PulumiSchema.PluginOptions.Source newItem)
                {
                    CheckValidInstance();
                    ...
                    var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.PulumiBenchmark.Current.PulumiSchema.PluginOptions>(_parent, _idx);

                    while (enumerator.MoveNext())
                    {
                        Corvus.PulumiBenchmark.Current.PulumiSchema.PluginOptions current = enumerator.Current;
                ...
                /// <summary>
                /// Gets a <see cref="PluginOptionsArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="PluginOptionsArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly PluginOptionsArray Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<PluginOptionsArray>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="PluginOptionsArray"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly PluginOptionsArray Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<PluginOptionsArray>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginOptionsArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(PluginOptionsArray instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginOptionsArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// </summary>
                public void AddItem(in Corvus.PulumiBenchmark.Current.PulumiSchema.PluginOptions.Source value)
                {
                ...
                /// Add an item to the array.
                /// </summary>
                public void AddItem<TContext>(in Corvus.PulumiBenchmark.Current.PulumiSchema.PluginOptions.Source<TContext> value)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
            ...
            {
                return workspace.CreateBuilder<PluginOptionsArray, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<PluginOptionsArray> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<PluginOptionsArray>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<PluginOptionsArray> Create<TContext>(
