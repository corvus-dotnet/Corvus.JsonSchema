    ...
    public readonly partial struct PluginsEntity
    {
        ...
        public readonly partial struct PluginsForLanArray
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(PluginsForLanArray instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="PluginsForLanArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator PluginsForLanArray(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"PluginsForLanArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </para>
                /// </remarks>
                public readonly PluginsForLanArray Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly PluginsForLanArray Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<PluginsForLanArray>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginsForLanArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(PluginsForLanArray instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginsForLanArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<PluginsForLanArray, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<PluginsForLanArray> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<PluginsForLanArray>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<PluginsForLanArray> Create<TContext>(
