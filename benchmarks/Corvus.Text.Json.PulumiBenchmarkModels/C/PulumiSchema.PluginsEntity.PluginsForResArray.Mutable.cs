    ...
    public readonly partial struct PluginsEntity
    {
        ...
        public readonly partial struct PluginsForResArray
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(PluginsForResArray instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="PluginsForResArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator PluginsForResArray(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"PluginsForResArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </para>
                /// </remarks>
                public readonly PluginsForResArray Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly PluginsForResArray Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<PluginsForResArray>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginsForResArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(PluginsForResArray instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginsForResArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<PluginsForResArray, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<PluginsForResArray> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<PluginsForResArray>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<PluginsForResArray> Create<TContext>(
