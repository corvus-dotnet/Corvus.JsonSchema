...
public readonly partial struct PulumiSchema
{
    ...
    public readonly partial struct PluginsEntity
    {
...
#endif
        {
            ...
            public Corvus.PulumiBenchmark.Current.PulumiSchema.PluginOptions this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.PulumiBenchmark.Current.PulumiSchema.PluginOptions>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.PulumiBenchmark.Current.PulumiSchema.PluginOptions> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.PulumiBenchmark.Current.PulumiSchema.PluginOptions>(_parent, _idx);
            }
