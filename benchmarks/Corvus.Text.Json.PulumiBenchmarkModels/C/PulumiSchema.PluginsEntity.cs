...
public readonly partial struct PulumiSchema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginOptionsArray Analyzers
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AnalyzersUtf8, out Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginOptionsArray value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginsForLanArray Languages
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LanguagesUtf8, out Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginsForLanArray value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginsForResArray Providers
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ProvidersUtf8, out Corvus.PulumiBenchmark.Current.PulumiSchema.PluginsEntity.PluginsForResArray value))
                {
                    return value;
                }
        ...
        {
            /// <summary>
            /// Gets the JSON property name for <see cref="Analyzers"/>.
            /// </summary>
            public const string Analyzers = "analyzers";

            /// <summary>
            /// Gets the JSON property name for <see cref="Languages"/>.
            /// </summary>
            ...
            /// Gets the JSON property name for <see cref="Analyzers"/>.
            /// </summary>
            public static ReadOnlySpan<byte> AnalyzersUtf8 => "analyzers"u8;

            /// <summary>
            /// Gets the JSON property name for <see cref="Languages"/>.
            /// </summary>
            public static ReadOnlySpan<byte> LanguagesUtf8 => "languages"u8;
        ...
        {
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="Analyzers"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Analyzers => "analyzers"u8;

            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="Languages"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Languages => "languages"u8;
        ...
        {
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="Analyzers"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Analyzers => [0xB5, 0x00, 0x00, 0x00, 0x22, 0x61, 0x6E, 0x61, 0x6C, 0x79, 0x7A, 0x65, 0x72, 0x73, 0x22];

            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="Languages"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Languages => [0xB5, 0x00, 0x00, 0x00, 0x22, 0x6C, 0x61, 0x6E, 0x67, 0x75, 0x61, 0x67, 0x65, 0x73, 0x22];
