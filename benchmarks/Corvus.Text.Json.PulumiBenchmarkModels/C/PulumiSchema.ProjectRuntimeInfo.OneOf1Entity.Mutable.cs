    ...
    public readonly partial struct ProjectRuntimeInfo
    {
        ...
        public readonly partial struct OneOf1Entity
        {
...
#endif
            {
                ...
                /// Name
                /// </summary>
                public Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.OneOf1Entity.Name.Mutable NameValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameValueUtf8, out Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.OneOf1Entity.Name.Mutable value))
                        {
                            return value;
                        }
                ...
                /// Options
                /// </summary>
                public Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.OneOf1Entity.Options.Mutable OptionsValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OptionsValueUtf8, out Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.OneOf1Entity.Options.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetOptionsValue(scoped in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.OneOf1Entity.Options.Source value)
                {
                    ...
                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.OptionsValueUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OptionsValueUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.OptionsValue, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetOptionsValue<TContext>(in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.OneOf1Entity.Options.Source<TContext> value)
                ...
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveOptionsValue()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.OptionsValueUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.OneOf1Entity.Name.Source _createArg1;
                private readonly Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.OneOf1Entity.Options.Source _createArg2;
                ...
                #endif
            {
                ...
                private readonly Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.OneOf1Entity.Name.Source _createArg1;
                private readonly Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.OneOf1Entity.Options.Source<TContext> _createArg2;
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.OneOf1Entity.Name.Source name = default,
                    in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.OneOf1Entity.Options.Source options = default)
                {
                    name.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.NameValue, ref builder);
                    options.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.OptionsValue, ref builder);
                }

                /// <summary>
                /// Creates an instance of a <see cref="OneOf1Entity"/>.
                /// </summary>
                public void Create(in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.OneOf1Entity.Name.Source name = default, in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.OneOf1Entity.Options.Source options = default)
                {
                    Create(ref _builder, name, options);
                }
                ...
                internal static void Create<TContext>(
                    ...
                    ref ComplexValueBuilder builder,
                    in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.OneOf1Entity.Name.Source name = default,
                    in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.OneOf1Entity.Options.Source<TContext> options = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
                ...
                #endif
                {
                    Create(context, ref _builder, name, options);
                }
            ...
            public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.OneOf1Entity.Name.Source name = default, scoped in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.OneOf1Entity.Options.Source<TContext> options = default)
                ...
                #endif
            {
                return new Source<TContext>(context, name, options);
            }
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.OneOf1Entity.Name.Source name = default, in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.OneOf1Entity.Options.Source options = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(name, options);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.OneOf1Entity.Name.Source name = default, in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.OneOf1Entity.Options.Source<TContext> options = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                ...
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(context, name, options);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            public static ParsedJsonDocument<OneOf1Entity> Create(in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.OneOf1Entity.Name.Source name = default, in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.OneOf1Entity.Options.Source options = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
            public static ParsedJsonDocument<OneOf1Entity> Create<TContext>(in TContext context, in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.OneOf1Entity.Name.Source name = default, in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.OneOf1Entity.Options.Source<TContext> options = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
