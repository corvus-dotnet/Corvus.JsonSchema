        ...
        public readonly partial struct OneOf1Entity
        {
...
#endif
            {
                ...
                public void SetOptionsValue(in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.OneOf1Entity.Options.Source value)
                {
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsProperty(JsonPropertyNamesEscaped.OptionsValue, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
            ...
            public ref struct Builder
            {
                    ...
                    in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.OneOf1Entity.Options.Source options = default)
                {
                    ...
                    options.AddAsProperty(JsonPropertyNamesEscaped.OptionsValue, ref builder, escapeName: false);
                }
