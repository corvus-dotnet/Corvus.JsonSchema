...
public readonly partial struct PulumiSchema
{
    ...
    public readonly partial struct ProjectRuntimeInfo
    {
...
#endif
        {
            ...
            /// Name
            /// </summary>
            public Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.OneOf1Entity.Name NameValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameValueUtf8, out Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.OneOf1Entity.Name value))
                    {
                        return value;
                    }
            ...
            /// Options
            /// </summary>
            public Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.OneOf1Entity.Options OptionsValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OptionsValueUtf8, out Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.OneOf1Entity.Options value))
                    {
                        return value;
                    }
            ...
            private static class JsonPropertyNamesPrebaked
            {
                ...
                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="OptionsValue"/>.
                /// </summary>
                public static ReadOnlySpan<byte> OptionsValue => [0x95, 0x00, 0x00, 0x00, 0x22, 0x6F, 0x70, 0x74, 0x69, 0x6F, 0x6E, 0x73, 0x22];
            }
        }
    }
}
