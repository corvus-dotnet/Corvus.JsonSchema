...
public readonly partial struct PulumiSchema
{
...
#endif
    {
        ...
        public static explicit operator Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.Name(ProjectRuntimeInfo value)
        {
            return Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.Name.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ProjectRuntimeInfo(Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.Name value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.OneOf1Entity(ProjectRuntimeInfo value)
        {
            return Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.OneOf1Entity.From(value);
        }
        ...
        public bool TryGetAsName(out Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.Name result)
        {
            ...
            {
                result = Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.Name.From(this);
                return true;
            }
        ...
        public bool TryGetAsOneOf1Entity(out Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.OneOf1Entity result)
        {
            ...
            {
                result = Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.OneOf1Entity.From(this);
                return true;
            }
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo, TContext, TResult> defaultMatch)
...
#endif
        {
            if (Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.Name.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchName(Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.Name.From(this), context);
            }

            if (Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchOneOf1Entity(Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.OneOf1Entity.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo, TResult> defaultMatch)
        {
            if (Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.Name.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchName(Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.Name.From(this));
            }

            if (Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchOneOf1Entity(Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectRuntimeInfo.OneOf1Entity.From(this));
            }
