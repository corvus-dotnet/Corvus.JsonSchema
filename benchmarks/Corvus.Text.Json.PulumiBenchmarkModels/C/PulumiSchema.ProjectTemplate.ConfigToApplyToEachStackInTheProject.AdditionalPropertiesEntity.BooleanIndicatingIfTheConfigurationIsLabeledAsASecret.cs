        ...
        public readonly partial struct ConfigToApplyToEachStackInTheProject
        {
            ...
            public readonly partial struct AdditionalPropertiesEntity
            {
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="BooleanIndicatingIfTheConfigurationIsLabeledAsASecret"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal BooleanIndicatingIfTheConfigurationIsLabeledAsASecret(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static BooleanIndicatingIfTheConfigurationIsLabeledAsASecret DefaultInstance { get; }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static explicit operator bool(BooleanIndicatingIfTheConfigurationIsLabeledAsASecret value)
                    {
                    ...
                    /// </returns>
                    public static bool operator ==(in BooleanIndicatingIfTheConfigurationIsLabeledAsASecret left, in BooleanIndicatingIfTheConfigurationIsLabeledAsASecret right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in BooleanIndicatingIfTheConfigurationIsLabeledAsASecret left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator JsonElement(BooleanIndicatingIfTheConfigurationIsLabeledAsASecret instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator BooleanIndicatingIfTheConfigurationIsLabeledAsASecret(JsonElement instance)
                    {
                        return BooleanIndicatingIfTheConfigurationIsLabeledAsASecret.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static BooleanIndicatingIfTheConfigurationIsLabeledAsASecret From<T>(in T instance)
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static BooleanIndicatingIfTheConfigurationIsLabeledAsASecret ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        #pragma warning disable CS0618 // Type or member is obsolete
                        return JsonElementHelpers.ParseValue<BooleanIndicatingIfTheConfigurationIsLabeledAsASecret>(utf8Json, options);
                    ...
                    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static BooleanIndicatingIfTheConfigurationIsLabeledAsASecret ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        #pragma warning disable CS0618 // Type or member is obsolete
                        return JsonElementHelpers.ParseValue<BooleanIndicatingIfTheConfigurationIsLabeledAsASecret>(json, options);
                        #pragma warning restore CS0618
                    }
                    ...
                    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static BooleanIndicatingIfTheConfigurationIsLabeledAsASecret ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        #pragma warning disable CS0618 // Type or member is obsolete
                        return JsonElementHelpers.ParseValue<BooleanIndicatingIfTheConfigurationIsLabeledAsASecret>(json, options);
                        #pragma warning restore CS0618
                    ...
                    /// </exception>
                    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                    public static BooleanIndicatingIfTheConfigurationIsLabeledAsASecret ParseValue(ref Utf8JsonReader reader)
                    {
                        #pragma warning disable CS0618 // Type or member is obsolete
                        return JsonElementHelpers.ParseValue<BooleanIndicatingIfTheConfigurationIsLabeledAsASecret>(ref reader);
                        #pragma warning restore CS0618
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out BooleanIndicatingIfTheConfigurationIsLabeledAsASecret? result)
                    {
                        return JsonElementHelpers.TryParseValue<BooleanIndicatingIfTheConfigurationIsLabeledAsASecret>(ref reader, out result);
                    }
...
#if NET
                    static BooleanIndicatingIfTheConfigurationIsLabeledAsASecret IJsonElement<BooleanIndicatingIfTheConfigurationIsLabeledAsASecret>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"BooleanIndicatingIfTheConfigurationIsLabeledAsASecret: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public BooleanIndicatingIfTheConfigurationIsLabeledAsASecret Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public BooleanIndicatingIfTheConfigurationIsLabeledAsASecret Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<BooleanIndicatingIfTheConfigurationIsLabeledAsASecret>(_idx);
                        }
