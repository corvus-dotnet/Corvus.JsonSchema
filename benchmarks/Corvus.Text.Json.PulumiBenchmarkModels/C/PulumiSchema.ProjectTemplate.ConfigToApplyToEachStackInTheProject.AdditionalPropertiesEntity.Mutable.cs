        ...
        public readonly partial struct ConfigToApplyToEachStackInTheProject
        {
            ...
            public readonly partial struct AdditionalPropertiesEntity
            {
...
#endif
                {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.ConfigToApplyToEachStackInTheProject.AdditionalPropertiesEntity.DescriptionOfTheConfig.Mutable Description
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DescriptionUtf8, out Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.ConfigToApplyToEachStackInTheProject.AdditionalPropertiesEntity.DescriptionOfTheConfig.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.ConfigToApplyToEachStackInTheProject.AdditionalPropertiesEntity.BooleanIndicatingIfTheConfigurationIsLabeledAsASecret.Mutable Secret
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SecretUtf8, out Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.ConfigToApplyToEachStackInTheProject.AdditionalPropertiesEntity.BooleanIndicatingIfTheConfigurationIsLabeledAsASecret.Mutable value))
                            {
                                return value;
                            }
                ...
                public ref struct Source
                {
                    ...
                    private readonly Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.ConfigToApplyToEachStackInTheProject.AdditionalPropertiesEntity.DescriptionOfTheConfig.Source _createArg2;
                    private readonly Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.ConfigToApplyToEachStackInTheProject.AdditionalPropertiesEntity.BooleanIndicatingIfTheConfigurationIsLabeledAsASecret.Source _createArg3;
                ...
                public ref struct Builder
                {
                    ...
                    internal static void Create(
                        ...
                        in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.ConfigToApplyToEachStackInTheProject.AdditionalPropertiesEntity.BooleanIndicatingIfTheConfigurationIsLabeledAsASecret.Source secret = default)
                    {
                    ...
                    public void Create(
                        ...
                        in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.ConfigToApplyToEachStackInTheProject.AdditionalPropertiesEntity.BooleanIndicatingIfTheConfigurationIsLabeledAsASecret.Source secret = default)
                    {
                        Create(ref _builder, defaultValue, description, secret);
                    }
                    ...
                    #endif
                    {
                        Create(context, ref _builder, defaultValue, description, secret);
                    }
                ...
                public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.JsonElement.Source<TContext> defaultValue = default, scoped in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.ConfigToApplyToEachStackInTheProject.AdditionalPropertiesEntity.DescriptionOfTheConfig.Source description = default, scoped in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.ConfigToApplyToEachStackInTheProject.AdditionalPropertiesEntity.BooleanIndicatingIfTheConfigurationIsLabeledAsASecret.Source secret = default)
                    ...
                    #endif
                {
                    return new Source<TContext>(context, defaultValue, description, secret);
                }
                    ...
                    #endif
                {
                    ...
                    cvb.StartObject();
                    Builder ovb = new(cvb);
                    ovb.Create(context, defaultValue, description, secret);
                    cvb = ovb._builder;
                    cvb.EndObject();
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
                public static ParsedJsonDocument<AdditionalPropertiesEntity> Create<TContext>(in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> defaultValue = default, in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.ConfigToApplyToEachStackInTheProject.AdditionalPropertiesEntity.DescriptionOfTheConfig.Source description = default, in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.ConfigToApplyToEachStackInTheProject.AdditionalPropertiesEntity.BooleanIndicatingIfTheConfigurationIsLabeledAsASecret.Source secret = default, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
