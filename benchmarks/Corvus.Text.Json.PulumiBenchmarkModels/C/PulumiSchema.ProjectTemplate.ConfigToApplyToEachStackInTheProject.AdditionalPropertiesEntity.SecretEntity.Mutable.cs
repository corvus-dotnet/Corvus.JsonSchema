            ...
            public readonly partial struct AdditionalPropertiesEntity
            {
                ...
                public readonly partial struct SecretEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(SecretEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="SecretEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator SecretEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"SecretEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly SecretEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly SecretEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<SecretEntity>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(SecretEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<SecretEntity, Mutable>(this);
                    }
                }
            }
        }
