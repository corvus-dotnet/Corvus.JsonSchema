    ...
    public readonly partial struct ProjectTemplate
    {
        ...
        public readonly partial struct ConfigToApplyToEachStackInTheProject
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ConfigToApplyToEachStackInTheProject instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ConfigToApplyToEachStackInTheProject"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ConfigToApplyToEachStackInTheProject(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ConfigToApplyToEachStackInTheProject.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ConfigToApplyToEachStackInTheProject Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ConfigToApplyToEachStackInTheProject Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ConfigToApplyToEachStackInTheProject>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.ConfigToApplyToEachStackInTheProject.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(ConfigToApplyToEachStackInTheProject instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.ConfigToApplyToEachStackInTheProject.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<ConfigToApplyToEachStackInTheProject, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ConfigToApplyToEachStackInTheProject> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ConfigToApplyToEachStackInTheProject>();
                }
                finally
                {
