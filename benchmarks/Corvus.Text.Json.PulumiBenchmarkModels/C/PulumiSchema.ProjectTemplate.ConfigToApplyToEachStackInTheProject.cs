...
public readonly partial struct PulumiSchema
{
    ...
    /// </para>
    /// </remarks>
    public readonly partial struct ProjectTemplate
    {
        /// <summary>
        ...
        public readonly partial struct ConfigToApplyToEachStackInTheProject
#if NET8_0_OR_GREATER
            : IJsonElement<ConfigToApplyToEachStackInTheProject>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ConfigToApplyToEachStackInTheProject"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ConfigToApplyToEachStackInTheProject(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ConfigToApplyToEachStackInTheProject DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in ConfigToApplyToEachStackInTheProject left, in ConfigToApplyToEachStackInTheProject right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ConfigToApplyToEachStackInTheProject left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(ConfigToApplyToEachStackInTheProject instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ConfigToApplyToEachStackInTheProject(JsonElement instance)
            {
                return ConfigToApplyToEachStackInTheProject.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ConfigToApplyToEachStackInTheProject From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ConfigToApplyToEachStackInTheProject ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ConfigToApplyToEachStackInTheProject>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ConfigToApplyToEachStackInTheProject ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ConfigToApplyToEachStackInTheProject>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ConfigToApplyToEachStackInTheProject ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ConfigToApplyToEachStackInTheProject>(json, options);
            }
            ...
            /// </exception>
            public static ConfigToApplyToEachStackInTheProject ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ConfigToApplyToEachStackInTheProject>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ConfigToApplyToEachStackInTheProject? result)
            {
                return JsonElementHelpers.TryParseValue<ConfigToApplyToEachStackInTheProject>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ConfigToApplyToEachStackInTheProject(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static ConfigToApplyToEachStackInTheProject IJsonElement<ConfigToApplyToEachStackInTheProject>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ConfigToApplyToEachStackInTheProject: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ConfigToApplyToEachStackInTheProject"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ConfigToApplyToEachStackInTheProject"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public ConfigToApplyToEachStackInTheProject Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ConfigToApplyToEachStackInTheProject>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ConfigToApplyToEachStackInTheProject"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public ConfigToApplyToEachStackInTheProject Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ConfigToApplyToEachStackInTheProject>(_idx);
                }
