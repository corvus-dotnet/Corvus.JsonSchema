    ...
    public readonly partial struct ProjectTemplate
    {
        ...
        public readonly partial struct ConfigToApplyToEachStackInTheProject
        {
            ...
            public readonly partial struct AdditionalPropertiesEntity
            {
                ...
                public readonly partial struct BooleanIndicatingIfTheConfigurationIsLabeledAsASecret
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(BooleanIndicatingIfTheConfigurationIsLabeledAsASecret instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="BooleanIndicatingIfTheConfigurationIsLabeledAsASecret"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator BooleanIndicatingIfTheConfigurationIsLabeledAsASecret(Mutable instance)
                        {
                        ...
                        {
                            return
                                (obj is IJsonElement value && Equals(new BooleanIndicatingIfTheConfigurationIsLabeledAsASecret(value.ParentDocument, value.ParentDocumentIndex))) ||
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"BooleanIndicatingIfTheConfigurationIsLabeledAsASecret.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// <summary>
                        /// Gets a <see cref="BooleanIndicatingIfTheConfigurationIsLabeledAsASecret"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </summary>
                        /// <returns>
                        /// A <see cref="BooleanIndicatingIfTheConfigurationIsLabeledAsASecret"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </returns>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly BooleanIndicatingIfTheConfigurationIsLabeledAsASecret Clone()
                        {
                            CheckValidInstance();
                            return _parent.CloneElement<BooleanIndicatingIfTheConfigurationIsLabeledAsASecret>(_idx);
                        }
                        ...
                        /// </summary>
                        /// <returns>
                        /// An immutable <see cref="BooleanIndicatingIfTheConfigurationIsLabeledAsASecret"/> that lives for the lifetime of its
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly BooleanIndicatingIfTheConfigurationIsLabeledAsASecret Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<BooleanIndicatingIfTheConfigurationIsLabeledAsASecret>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(BooleanIndicatingIfTheConfigurationIsLabeledAsASecret instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<BooleanIndicatingIfTheConfigurationIsLabeledAsASecret, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<BooleanIndicatingIfTheConfigurationIsLabeledAsASecret> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<BooleanIndicatingIfTheConfigurationIsLabeledAsASecret>();
                        }
                        finally
                        {
