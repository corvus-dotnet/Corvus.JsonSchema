...
public readonly partial struct PulumiSchema
{
    ...
    public readonly partial struct ProjectTemplate
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="DescriptionOfTheTemplate"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal DescriptionOfTheTemplate(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static DescriptionOfTheTemplate DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(DescriptionOfTheTemplate value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in DescriptionOfTheTemplate left, in DescriptionOfTheTemplate right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in DescriptionOfTheTemplate left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(DescriptionOfTheTemplate instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DescriptionOfTheTemplate(JsonElement instance)
            {
                return DescriptionOfTheTemplate.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DescriptionOfTheTemplate From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DescriptionOfTheTemplate ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DescriptionOfTheTemplate>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DescriptionOfTheTemplate ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DescriptionOfTheTemplate>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DescriptionOfTheTemplate ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DescriptionOfTheTemplate>(json, options);
            }
            ...
            /// </exception>
            public static DescriptionOfTheTemplate ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<DescriptionOfTheTemplate>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out DescriptionOfTheTemplate? result)
            {
                return JsonElementHelpers.TryParseValue<DescriptionOfTheTemplate>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new DescriptionOfTheTemplate(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static DescriptionOfTheTemplate IJsonElement<DescriptionOfTheTemplate>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DescriptionOfTheTemplate: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="DescriptionOfTheTemplate"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="DescriptionOfTheTemplate"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public DescriptionOfTheTemplate Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<DescriptionOfTheTemplate>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="DescriptionOfTheTemplate"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public DescriptionOfTheTemplate Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<DescriptionOfTheTemplate>(_idx);
                }
