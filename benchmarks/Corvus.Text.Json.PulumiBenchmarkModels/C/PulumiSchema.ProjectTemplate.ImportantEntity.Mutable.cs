...
public readonly partial struct PulumiSchema
{
    ...
    public readonly partial struct ProjectTemplate
    {
        ...
        public readonly partial struct ImportantEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ImportantEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ImportantEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ImportantEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ImportantEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ImportantEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ImportantEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ImportantEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ImportantEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ImportantEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ImportantEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ImportantEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ImportantEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ImportantEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ImportantEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ImportantEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ImportantEntity>();
                }
                finally
                {
