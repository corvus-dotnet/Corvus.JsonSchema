...
public readonly partial struct PulumiSchema
{
    ...
    public readonly partial struct ProjectTemplate
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ProjectTemplate instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ProjectTemplate"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ProjectTemplate(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.ConfigToApplyToEachStackInTheProject.Mutable Config
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ConfigUtf8, out Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.ConfigToApplyToEachStackInTheProject.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.DescriptionOfTheTemplate.Mutable Description
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DescriptionUtf8, out Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.DescriptionOfTheTemplate.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.ImportantEntity.Mutable Important
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ImportantUtf8, out Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.ImportantEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// <summary>
            /// Gets the (optional) <c>quickstart</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.QuickstartEntity.Mutable Quickstart
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.QuickstartUtf8, out Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.QuickstartEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ProjectTemplate(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetConfig<TContext>(in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.ConfigToApplyToEachStackInTheProject.Source<TContext> value)
            ...
            public void SetQuickstart(scoped in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.QuickstartEntity.Source value)
            {
                ...
                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.QuickstartUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.QuickstartUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Quickstart, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// <summary>
            /// Remove the <c>quickstart</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveQuickstart()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.QuickstartUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ProjectTemplate.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ProjectTemplate"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ProjectTemplate"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly ProjectTemplate Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ProjectTemplate>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ProjectTemplate"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly ProjectTemplate Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ProjectTemplate>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.ConfigToApplyToEachStackInTheProject.Source _createArg1;
            private readonly Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.DescriptionOfTheTemplate.Source _createArg2;
            private readonly Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.ImportantEntity.Source _createArg3;
            private readonly Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.QuickstartEntity.Source _createArg4;
            ...
            public static implicit operator Source(ProjectTemplate instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            private readonly Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.ConfigToApplyToEachStackInTheProject.Source<TContext> _createArg1;
            private readonly Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.DescriptionOfTheTemplate.Source _createArg2;
            private readonly Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.ImportantEntity.Source _createArg3;
            private readonly Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.QuickstartEntity.Source _createArg4;
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="ProjectTemplate"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.ConfigToApplyToEachStackInTheProject.Source config = default,
                in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.DescriptionOfTheTemplate.Source description = default,
                in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.ImportantEntity.Source important = default,
                in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.QuickstartEntity.Source quickstart = default)
            {
                ...
                quickstart.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Quickstart, ref builder);
            }
            ...
            public void Create(
                ...
                in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.QuickstartEntity.Source quickstart = default)
            {
                Create(ref _builder, config, description, important, quickstart);
            }
            ...
            internal static void Create<TContext>(
                in TContext context,
                ref ComplexValueBuilder builder,
                in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.ConfigToApplyToEachStackInTheProject.Source<TContext> config = default,
                in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.DescriptionOfTheTemplate.Source description = default,
                in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.ImportantEntity.Source important = default,
                in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.QuickstartEntity.Source quickstart = default)
            #if NET9_0_OR_GREATER
            ...
            #endif
            {
                Create(context, ref _builder, config, description, important, quickstart);
            }
        ...
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.ConfigToApplyToEachStackInTheProject.Source<TContext> config = default, scoped in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.DescriptionOfTheTemplate.Source description = default, scoped in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.ImportantEntity.Source important = default, scoped in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.QuickstartEntity.Source quickstart = default)
            ...
            #endif
        {
            return new Source<TContext>(context, config, description, important, quickstart);
        }
        ...
        /// <param name="quickstart">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.ConfigToApplyToEachStackInTheProject.Source config = default, in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.DescriptionOfTheTemplate.Source description = default, in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.ImportantEntity.Source important = default, in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.QuickstartEntity.Source quickstart = default, int initialCapacity = 30)
        {
            ...
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(config, description, important, quickstart);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
            ...
            #endif
        {
            ...
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(context, config, description, important, quickstart);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<ProjectTemplate, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ProjectTemplate> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ProjectTemplate>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ProjectTemplate> Create<TContext>(
        ...
        public static ParsedJsonDocument<ProjectTemplate> Create(in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.ConfigToApplyToEachStackInTheProject.Source config = default, in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.DescriptionOfTheTemplate.Source description = default, in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.ImportantEntity.Source important = default, in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.QuickstartEntity.Source quickstart = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ProjectTemplate> Create<TContext>(in TContext context, in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.ConfigToApplyToEachStackInTheProject.Source<TContext> config = default, in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.DescriptionOfTheTemplate.Source description = default, in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.ImportantEntity.Source important = default, in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.QuickstartEntity.Source quickstart = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
