    ...
    public readonly partial struct ProjectTemplate
    {
...
#endif
        {
            ...
            public void SetQuickstart(in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.QuickstartEntity.Source value)
            {
                ...
                {
                    // We are going to insert the new value
                    value.AddAsProperty(JsonPropertyNamesEscaped.Quickstart, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
        ...
        public ref struct Builder
        {
                ...
                in Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.QuickstartEntity.Source quickstart = default)
            {
                ...
                quickstart.AddAsProperty(JsonPropertyNamesEscaped.Quickstart, ref builder, escapeName: false);
            }
