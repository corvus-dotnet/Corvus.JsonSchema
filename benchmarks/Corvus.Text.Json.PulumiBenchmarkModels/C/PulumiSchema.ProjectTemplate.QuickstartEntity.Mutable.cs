    ...
    public readonly partial struct ProjectTemplate
    {
        ...
        public readonly partial struct QuickstartEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(QuickstartEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="QuickstartEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator QuickstartEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"QuickstartEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly QuickstartEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly QuickstartEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<QuickstartEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(QuickstartEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<QuickstartEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<QuickstartEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<QuickstartEntity>();
                }
                finally
                {
