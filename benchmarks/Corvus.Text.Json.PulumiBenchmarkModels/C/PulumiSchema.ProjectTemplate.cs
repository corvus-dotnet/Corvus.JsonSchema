...
public readonly partial struct PulumiSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectTemplate"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ProjectTemplate(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ProjectTemplate DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.ConfigToApplyToEachStackInTheProject Config
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ConfigUtf8, out Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.ConfigToApplyToEachStackInTheProject value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.DescriptionOfTheTemplate Description
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DescriptionUtf8, out Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.DescriptionOfTheTemplate value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.ImportantEntity Important
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ImportantUtf8, out Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.ImportantEntity value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.QuickstartEntity Quickstart
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.QuickstartUtf8, out Corvus.PulumiBenchmark.Current.PulumiSchema.ProjectTemplate.QuickstartEntity value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in ProjectTemplate left, in ProjectTemplate right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ProjectTemplate left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(ProjectTemplate instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ProjectTemplate(JsonElement instance)
        {
            return ProjectTemplate.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ProjectTemplate From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ProjectTemplate ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ProjectTemplate>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ProjectTemplate ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ProjectTemplate>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ProjectTemplate ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ProjectTemplate>(json, options);
        }
        ...
        /// </exception>
        public static ProjectTemplate ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ProjectTemplate>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ProjectTemplate? result)
        {
            return JsonElementHelpers.TryParseValue<ProjectTemplate>(ref reader, out result);
        }
...
#if NET
        static ProjectTemplate IJsonElement<ProjectTemplate>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ProjectTemplate: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public ProjectTemplate Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ProjectTemplate>(_idx);
            }
        ...
        public static class JsonPropertyNames
        {
            ...
            /// <summary>
            /// Gets the JSON property name for <see cref="Quickstart"/>.
            /// </summary>
            ...
            /// Gets the JSON property name for <see cref="Quickstart"/>.
            /// </summary>
            public static ReadOnlySpan<byte> QuickstartUtf8 => "quickstart"u8;
        }
        ...
        private static class JsonPropertyNamesEscaped
        {
            ...
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="Quickstart"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Quickstart => "quickstart"u8;
        }
        ...
        private static class JsonPropertyNamesPrebaked
        {
            ...
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="Quickstart"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Quickstart => [0xC5, 0x00, 0x00, 0x00, 0x22, 0x71, 0x75, 0x69, 0x63, 0x6B, 0x73, 0x74, 0x61, 0x72, 0x74, 0x22];
        }
    }
}
