...
public readonly partial struct PulumiSchema
{
    ...
    public readonly partial struct SimpleConfigType
    {
        ...
        public ref struct Source
        {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (SimpleConfigType)value;
        ...
        public static ParsedJsonDocument<SimpleConfigType> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<SimpleConfigType>();
            }
            finally
            {
