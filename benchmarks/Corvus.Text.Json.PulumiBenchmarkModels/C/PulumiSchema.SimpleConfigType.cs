...
public readonly partial struct PulumiSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SimpleConfigType"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal SimpleConfigType(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static SimpleConfigType DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(SimpleConfigType value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in SimpleConfigType left, in SimpleConfigType right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in SimpleConfigType left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(SimpleConfigType instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator SimpleConfigType(JsonElement instance)
        {
            return SimpleConfigType.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SimpleConfigType From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SimpleConfigType ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SimpleConfigType>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SimpleConfigType ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SimpleConfigType>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SimpleConfigType ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SimpleConfigType>(json, options);
        }
        ...
        /// </exception>
        public static SimpleConfigType ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<SimpleConfigType>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out SimpleConfigType? result)
        {
            return JsonElementHelpers.TryParseValue<SimpleConfigType>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new SimpleConfigType(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static SimpleConfigType IJsonElement<SimpleConfigType>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"SimpleConfigType: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="SimpleConfigType"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="SimpleConfigType"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public SimpleConfigType Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<SimpleConfigType>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="SimpleConfigType"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public SimpleConfigType Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<SimpleConfigType>(_idx);
            }
        ...
        /// <param name="matchBoolean">Match 3rd item.</param>
        /// <param name="matchArray">Match 4th item.</param>
