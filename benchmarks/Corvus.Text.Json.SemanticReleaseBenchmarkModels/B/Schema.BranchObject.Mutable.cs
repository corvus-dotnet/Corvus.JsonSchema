...
public readonly partial struct Schema
{
    ...
    public readonly partial struct BranchObject
    {
...
#endif
        {
            ...
            /// </summary>
            public Corvus.SemanticReleaseBenchmark.Baseline.JsonString.Mutable Channel
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ChannelUtf8, out Corvus.SemanticReleaseBenchmark.Baseline.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.SemanticReleaseBenchmark.Baseline.JsonString.Mutable Name
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out Corvus.SemanticReleaseBenchmark.Baseline.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public Corvus.SemanticReleaseBenchmark.Baseline.Schema.BranchObject.PrereleaseEntity.Mutable Prerelease
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PrereleaseUtf8, out Corvus.SemanticReleaseBenchmark.Baseline.Schema.BranchObject.PrereleaseEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public Corvus.SemanticReleaseBenchmark.Baseline.JsonString.Mutable Range
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RangeUtf8, out Corvus.SemanticReleaseBenchmark.Baseline.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetChannel(in Corvus.SemanticReleaseBenchmark.Baseline.JsonString.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetName(in Corvus.SemanticReleaseBenchmark.Baseline.JsonString.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetPrerelease(in Corvus.SemanticReleaseBenchmark.Baseline.Schema.BranchObject.PrereleaseEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetRange(in Corvus.SemanticReleaseBenchmark.Baseline.JsonString.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.SemanticReleaseBenchmark.Baseline.Schema.BranchObject.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.SemanticReleaseBenchmark.Baseline.Schema.BranchObject.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.SemanticReleaseBenchmark.Baseline.JsonString.Source name,
                in Corvus.SemanticReleaseBenchmark.Baseline.JsonString.Source channel = default,
                in Corvus.SemanticReleaseBenchmark.Baseline.Schema.BranchObject.PrereleaseEntity.Source prerelease = default,
                in Corvus.SemanticReleaseBenchmark.Baseline.JsonString.Source range = default)
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.SemanticReleaseBenchmark.Baseline.JsonString.Source name, in Corvus.SemanticReleaseBenchmark.Baseline.JsonString.Source channel = default, in Corvus.SemanticReleaseBenchmark.Baseline.Schema.BranchObject.PrereleaseEntity.Source prerelease = default, in Corvus.SemanticReleaseBenchmark.Baseline.JsonString.Source range = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
