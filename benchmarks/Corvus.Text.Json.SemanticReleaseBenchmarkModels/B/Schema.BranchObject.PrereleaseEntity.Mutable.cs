    ...
    public readonly partial struct BranchObject
    {
        ...
        public readonly partial struct PrereleaseEntity
        {
...
#endif
            {
                ...
                /// <param name="matchJsonBoolean">Match a <see cref="Corvus.SemanticReleaseBenchmark.Baseline.JsonBoolean"/>.</param>
                ...
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Matcher<Corvus.SemanticReleaseBenchmark.Baseline.JsonBoolean, TContext, TResult> matchJsonBoolean,
                    Matcher<Corvus.SemanticReleaseBenchmark.Baseline.JsonString, TContext, TResult> matchJsonString,
                    Matcher<Corvus.SemanticReleaseBenchmark.Baseline.Schema.BranchObject.PrereleaseEntity.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
                {
                    if (Corvus.SemanticReleaseBenchmark.Baseline.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchJsonBoolean(Corvus.SemanticReleaseBenchmark.Baseline.JsonBoolean.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    Matcher<Corvus.SemanticReleaseBenchmark.Baseline.JsonBoolean, TResult> matchJsonBoolean,
                    Matcher<Corvus.SemanticReleaseBenchmark.Baseline.JsonString, TResult> matchJsonString,
                    Matcher<Corvus.SemanticReleaseBenchmark.Baseline.Schema.BranchObject.PrereleaseEntity.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.SemanticReleaseBenchmark.Baseline.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchJsonBoolean(Corvus.SemanticReleaseBenchmark.Baseline.JsonBoolean.Mutable.From(this));
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.SemanticReleaseBenchmark.Baseline.JsonBoolean" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsJsonBoolean(out Corvus.SemanticReleaseBenchmark.Baseline.JsonBoolean result)
                {
                    if (Corvus.SemanticReleaseBenchmark.Baseline.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.SemanticReleaseBenchmark.Baseline.JsonBoolean.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.SemanticReleaseBenchmark.Baseline.JsonBoolean instance) => new(JsonElement.From(instance));
