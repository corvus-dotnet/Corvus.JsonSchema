    ...
    public readonly partial struct BranchObject
    {
...
#endif
        {
            ...
            public bool TryGetAsJsonBoolean(out Corvus.SemanticReleaseBenchmark.Baseline.JsonBoolean result)
            {
                ...
                {
                    result = Corvus.SemanticReleaseBenchmark.Baseline.JsonBoolean.From(this);
                    return true;
                }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.SemanticReleaseBenchmark.Baseline.Schema.BranchObject.PrereleaseEntity, TContext, TResult> defaultMatch)
...
#endif
            {
                if (Corvus.SemanticReleaseBenchmark.Baseline.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonBoolean(Corvus.SemanticReleaseBenchmark.Baseline.JsonBoolean.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.SemanticReleaseBenchmark.Baseline.Schema.BranchObject.PrereleaseEntity, TResult> defaultMatch)
            {
                if (Corvus.SemanticReleaseBenchmark.Baseline.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonBoolean(Corvus.SemanticReleaseBenchmark.Baseline.JsonBoolean.From(this));
                }
