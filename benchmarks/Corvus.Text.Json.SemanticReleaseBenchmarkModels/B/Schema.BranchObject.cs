...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BranchObject"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal BranchObject(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static BranchObject DefaultInstance { get; }

        /// <summary>
        /// Gets the (optional) <c>channel</c> property.
        /// </summary>
        public Corvus.SemanticReleaseBenchmark.Baseline.JsonString Channel
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ChannelUtf8, out Corvus.SemanticReleaseBenchmark.Baseline.JsonString value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.SemanticReleaseBenchmark.Baseline.JsonString Name
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out Corvus.SemanticReleaseBenchmark.Baseline.JsonString value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.SemanticReleaseBenchmark.Baseline.Schema.BranchObject.PrereleaseEntity Prerelease
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PrereleaseUtf8, out Corvus.SemanticReleaseBenchmark.Baseline.Schema.BranchObject.PrereleaseEntity value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.SemanticReleaseBenchmark.Baseline.JsonString Range
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RangeUtf8, out Corvus.SemanticReleaseBenchmark.Baseline.JsonString value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in BranchObject left, in BranchObject right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in BranchObject left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(BranchObject instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator BranchObject(JsonElement instance)
        {
            return BranchObject.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BranchObject From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BranchObject ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BranchObject>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BranchObject ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BranchObject>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BranchObject ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BranchObject>(json, options);
        }
        ...
        /// </exception>
        public static BranchObject ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<BranchObject>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out BranchObject? result)
        {
            return JsonElementHelpers.TryParseValue<BranchObject>(ref reader, out result);
        }
...
#if NET
        static BranchObject IJsonElement<BranchObject>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"BranchObject: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public static class JsonPropertyNames
        {
            ...
            /// <summary>
            /// Gets the JSON property name for <see cref="Prerelease"/>.
            /// </summary>
            ...
            /// Gets the JSON property name for <see cref="Prerelease"/>.
            /// </summary>
            public static ReadOnlySpan<byte> PrereleaseUtf8 => "prerelease"u8;
        ...
        private static class JsonPropertyNamesEscaped
        {
            ...
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="Prerelease"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Prerelease => "prerelease"u8;
