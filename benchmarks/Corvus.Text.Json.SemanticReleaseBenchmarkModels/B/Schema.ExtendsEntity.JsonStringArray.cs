...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ExtendsEntity
    {
...
#endif
        {
            ...
            public Corvus.SemanticReleaseBenchmark.Baseline.JsonString this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.SemanticReleaseBenchmark.Baseline.JsonString>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.SemanticReleaseBenchmark.Baseline.JsonString> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.SemanticReleaseBenchmark.Baseline.JsonString>(_parent, _idx);
            }
