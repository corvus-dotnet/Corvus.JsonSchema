...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ExtendsEntity
    {
...
#endif
        {
            ...
            /// <summary>
            /// Conversion to <see cref="Corvus.SemanticReleaseBenchmark.Baseline.Schema.ExtendsEntity.JsonStringArray"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.SemanticReleaseBenchmark.Baseline.Schema.ExtendsEntity.JsonStringArray.Mutable(Mutable value)
            {
                return Corvus.SemanticReleaseBenchmark.Baseline.Schema.ExtendsEntity.JsonStringArray.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.SemanticReleaseBenchmark.Baseline.Schema.ExtendsEntity.JsonStringArray"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.SemanticReleaseBenchmark.Baseline.Schema.ExtendsEntity.JsonStringArray.Mutable value)
            {
                return From(value);
            }
            ...
            public static explicit operator Mutable(ExtendsEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ExtendsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ExtendsEntity(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ExtendsEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ExtendsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// <summary>
            /// Gets a <see cref="ExtendsEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ExtendsEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly ExtendsEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ExtendsEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ExtendsEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly ExtendsEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ExtendsEntity>(_idx);
            }
            ...
            /// <param name="matchJsonStringArray">Match a <see cref="Corvus.SemanticReleaseBenchmark.Baseline.Schema.ExtendsEntity.JsonStringArray"/>.</param>
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.SemanticReleaseBenchmark.Baseline.Schema.ExtendsEntity.JsonStringArray, TContext, TResult> matchJsonStringArray,
                Matcher<Corvus.SemanticReleaseBenchmark.Baseline.Schema.ExtendsEntity.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
            {
                ...
                if (Corvus.SemanticReleaseBenchmark.Baseline.Schema.ExtendsEntity.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonStringArray(Corvus.SemanticReleaseBenchmark.Baseline.Schema.ExtendsEntity.JsonStringArray.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.SemanticReleaseBenchmark.Baseline.Schema.ExtendsEntity.JsonStringArray, TResult> matchJsonStringArray,
                Matcher<Corvus.SemanticReleaseBenchmark.Baseline.Schema.ExtendsEntity.Mutable, TResult> defaultMatch)
            {
                if (Corvus.SemanticReleaseBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                ...
                if (Corvus.SemanticReleaseBenchmark.Baseline.Schema.ExtendsEntity.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonStringArray(Corvus.SemanticReleaseBenchmark.Baseline.Schema.ExtendsEntity.JsonStringArray.Mutable.From(this));
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.SemanticReleaseBenchmark.Baseline.Schema.ExtendsEntity.JsonStringArray" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsJsonStringArray(out Corvus.SemanticReleaseBenchmark.Baseline.Schema.ExtendsEntity.JsonStringArray result)
            {
                if (Corvus.SemanticReleaseBenchmark.Baseline.Schema.ExtendsEntity.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.SemanticReleaseBenchmark.Baseline.Schema.ExtendsEntity.JsonStringArray.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.SemanticReleaseBenchmark.Baseline.Schema.ExtendsEntity.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(ExtendsEntity instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.SemanticReleaseBenchmark.Baseline.Schema.ExtendsEntity.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<ExtendsEntity, Mutable>(this);
        }
    }
}
