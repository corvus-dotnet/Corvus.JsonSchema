...
public readonly partial struct Schema
{
    ...
    public readonly partial struct PluginsEntityArray
    {
...
#endif
        {
            ...
            public Corvus.SemanticReleaseBenchmark.Baseline.Schema.PluginsEntityArray.PluginsEntity.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.SemanticReleaseBenchmark.Baseline.Schema.PluginsEntityArray.PluginsEntity.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.SemanticReleaseBenchmark.Baseline.Schema.PluginsEntityArray.PluginsEntity.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.SemanticReleaseBenchmark.Baseline.Schema.PluginsEntityArray.PluginsEntity.Mutable>(_parent, _idx);
            }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Corvus.SemanticReleaseBenchmark.Baseline.Schema.PluginsEntityArray.PluginsEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, in Corvus.SemanticReleaseBenchmark.Baseline.Schema.PluginsEntityArray.PluginsEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(in Corvus.SemanticReleaseBenchmark.Baseline.Schema.PluginsEntityArray.PluginsEntity.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Corvus.SemanticReleaseBenchmark.Baseline.Schema.PluginsEntityArray.PluginsEntity item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.SemanticReleaseBenchmark.Baseline.Schema.PluginsEntityArray.PluginsEntity>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Corvus.SemanticReleaseBenchmark.Baseline.Schema.PluginsEntityArray.PluginsEntity> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.SemanticReleaseBenchmark.Baseline.Schema.PluginsEntityArray.PluginsEntity>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Corvus.SemanticReleaseBenchmark.Baseline.Schema.PluginsEntityArray.PluginsEntity oldItem, in Corvus.SemanticReleaseBenchmark.Baseline.Schema.PluginsEntityArray.PluginsEntity.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.SemanticReleaseBenchmark.Baseline.Schema.PluginsEntityArray.PluginsEntity>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Corvus.SemanticReleaseBenchmark.Baseline.Schema.PluginsEntityArray.PluginsEntity current = enumerator.Current;
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.SemanticReleaseBenchmark.Baseline.Schema.PluginsEntityArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.SemanticReleaseBenchmark.Baseline.Schema.PluginsEntityArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
