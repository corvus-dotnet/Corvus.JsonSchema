    ...
    public readonly partial struct PluginsEntityArray
    {
        ...
        public readonly partial struct PluginsEntity
        {
...
#endif
            {
                ...
                /// <summary>
                /// Conversion to <see cref="Corvus.SemanticReleaseBenchmark.Baseline.Schema.PluginsEntityArray.PluginsEntity.AnyOf1Array"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static explicit operator Corvus.SemanticReleaseBenchmark.Baseline.Schema.PluginsEntityArray.PluginsEntity.AnyOf1Array.Mutable(Mutable value)
                {
                    return Corvus.SemanticReleaseBenchmark.Baseline.Schema.PluginsEntityArray.PluginsEntity.AnyOf1Array.Mutable.From(value);
                }

                /// <summary>
                /// Conversion from <see cref="Corvus.SemanticReleaseBenchmark.Baseline.Schema.PluginsEntityArray.PluginsEntity.AnyOf1Array"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.SemanticReleaseBenchmark.Baseline.Schema.PluginsEntityArray.PluginsEntity.AnyOf1Array.Mutable value)
                {
                    return From(value);
                }
                ...
                /// <param name="matchAnyOf1Array">Match a <see cref="Corvus.SemanticReleaseBenchmark.Baseline.Schema.PluginsEntityArray.PluginsEntity.AnyOf1Array"/>.</param>
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.SemanticReleaseBenchmark.Baseline.Schema.PluginsEntityArray.PluginsEntity.AnyOf1Array, TContext, TResult> matchAnyOf1Array,
                    Matcher<Corvus.SemanticReleaseBenchmark.Baseline.Schema.PluginsEntityArray.PluginsEntity.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
                {
                    ...
                    if (Corvus.SemanticReleaseBenchmark.Baseline.Schema.PluginsEntityArray.PluginsEntity.AnyOf1Array.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchAnyOf1Array(Corvus.SemanticReleaseBenchmark.Baseline.Schema.PluginsEntityArray.PluginsEntity.AnyOf1Array.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.SemanticReleaseBenchmark.Baseline.Schema.PluginsEntityArray.PluginsEntity.AnyOf1Array, TResult> matchAnyOf1Array,
                    Matcher<Corvus.SemanticReleaseBenchmark.Baseline.Schema.PluginsEntityArray.PluginsEntity.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.SemanticReleaseBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                    {
                    ...
                    if (Corvus.SemanticReleaseBenchmark.Baseline.Schema.PluginsEntityArray.PluginsEntity.AnyOf1Array.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchAnyOf1Array(Corvus.SemanticReleaseBenchmark.Baseline.Schema.PluginsEntityArray.PluginsEntity.AnyOf1Array.Mutable.From(this));
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.SemanticReleaseBenchmark.Baseline.Schema.PluginsEntityArray.PluginsEntity.AnyOf1Array" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsAnyOf1Array(out Corvus.SemanticReleaseBenchmark.Baseline.Schema.PluginsEntityArray.PluginsEntity.AnyOf1Array result)
                {
                    if (Corvus.SemanticReleaseBenchmark.Baseline.Schema.PluginsEntityArray.PluginsEntity.AnyOf1Array.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.SemanticReleaseBenchmark.Baseline.Schema.PluginsEntityArray.PluginsEntity.AnyOf1Array.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.SemanticReleaseBenchmark.Baseline.Schema.PluginsEntityArray.PluginsEntity.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.SemanticReleaseBenchmark.Baseline.Schema.PluginsEntityArray.PluginsEntity.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
