...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        public Corvus.SemanticReleaseBenchmark.Baseline.Schema.PluginsEntityArray.PluginsEntity this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.SemanticReleaseBenchmark.Baseline.Schema.PluginsEntityArray.PluginsEntity>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.SemanticReleaseBenchmark.Baseline.Schema.PluginsEntityArray.PluginsEntity> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.SemanticReleaseBenchmark.Baseline.Schema.PluginsEntityArray.PluginsEntity>(_parent, _idx);
        }
