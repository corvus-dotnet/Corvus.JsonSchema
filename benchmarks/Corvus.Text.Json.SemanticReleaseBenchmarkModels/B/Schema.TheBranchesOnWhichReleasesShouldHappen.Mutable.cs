...
public readonly partial struct Schema
{
    ...
    public readonly partial struct TheBranchesOnWhichReleasesShouldHappen
    {
...
#endif
        {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.SemanticReleaseBenchmark.Baseline.Schema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.Mutable(Mutable value)
            {
                return Corvus.SemanticReleaseBenchmark.Baseline.Schema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.SemanticReleaseBenchmark.Baseline.Schema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.Mutable value)
            {
                return From(value);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.SemanticReleaseBenchmark.Baseline.Schema.TheBranchesOnWhichReleasesShouldHappen.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
            {
                ...
                {
                    return matchType2EntityArray(Corvus.SemanticReleaseBenchmark.Baseline.Schema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.SemanticReleaseBenchmark.Baseline.Schema.TheBranchesOnWhichReleasesShouldHappen.Mutable, TResult> defaultMatch)
            {
                if (Corvus.SemanticReleaseBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                ...
                if (Corvus.SemanticReleaseBenchmark.Baseline.Schema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchType2EntityArray(Corvus.SemanticReleaseBenchmark.Baseline.Schema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.Mutable.From(this));
                }
            ...
            public bool TryGetAsType2EntityArray(out Corvus.SemanticReleaseBenchmark.Baseline.Schema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray result)
            {
                if (Corvus.SemanticReleaseBenchmark.Baseline.Schema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.SemanticReleaseBenchmark.Baseline.Schema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.SemanticReleaseBenchmark.Baseline.Schema.TheBranchesOnWhichReleasesShouldHappen.ArrayBuilder.Build value) {_arrayBuilder = value; _kind = Kind.ArrayBuilder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.SemanticReleaseBenchmark.Baseline.Schema.TheBranchesOnWhichReleasesShouldHappen.ArrayBuilder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.ArrayBuilder; }
