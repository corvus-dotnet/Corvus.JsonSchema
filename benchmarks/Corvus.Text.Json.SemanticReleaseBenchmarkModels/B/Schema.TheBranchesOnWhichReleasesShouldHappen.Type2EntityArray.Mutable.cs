    ...
    public readonly partial struct TheBranchesOnWhichReleasesShouldHappen
    {
        ...
        public readonly partial struct Type2EntityArray
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(Type2EntityArray instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="Type2EntityArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Type2EntityArray(Mutable instance)
                {
                ...
                public Corvus.SemanticReleaseBenchmark.Baseline.Schema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.Type2Entity.Mutable this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.SemanticReleaseBenchmark.Baseline.Schema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.Type2Entity.Mutable>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.SemanticReleaseBenchmark.Baseline.Schema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.Type2Entity.Mutable> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.SemanticReleaseBenchmark.Baseline.Schema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.Type2Entity.Mutable>(_parent, _idx);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new Type2EntityArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Type2EntityArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetItem(int itemIndex, in Corvus.SemanticReleaseBenchmark.Baseline.Schema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.Type2Entity.Source value)
                {
                    CheckValidInstance();
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void InsertItem(int itemIndex, in Corvus.SemanticReleaseBenchmark.Baseline.Schema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.Type2Entity.Source value)
                {
                    CheckValidInstance();
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void AddItem(in Corvus.SemanticReleaseBenchmark.Baseline.Schema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.Type2Entity.Source value)
                {
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Remove(in Corvus.SemanticReleaseBenchmark.Baseline.Schema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.Type2Entity item)
                {
                    CheckValidInstance();
                    if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.SemanticReleaseBenchmark.Baseline.Schema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.Type2Entity>(this, in item))
                    {
                        return false;
                    }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void RemoveWhere(JsonPredicate<Corvus.SemanticReleaseBenchmark.Baseline.Schema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.Type2Entity> predicate)
                {
                    CheckValidInstance();
                    JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.SemanticReleaseBenchmark.Baseline.Schema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.Type2Entity>(this, predicate);
                    _documentVersion = _parent.Version;
                }
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Replace(in Corvus.SemanticReleaseBenchmark.Baseline.Schema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.Type2Entity oldItem, in Corvus.SemanticReleaseBenchmark.Baseline.Schema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.Type2Entity.Source newItem)
                {
                    CheckValidInstance();
                    ...
                    var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.SemanticReleaseBenchmark.Baseline.Schema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.Type2Entity>(_parent, _idx);

                    while (enumerator.MoveNext())
                    {
                        Corvus.SemanticReleaseBenchmark.Baseline.Schema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.Type2Entity current = enumerator.Current;
                ...
                /// <summary>
                /// Gets a <see cref="Type2EntityArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="Type2EntityArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly Type2EntityArray Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<Type2EntityArray>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="Type2EntityArray"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly Type2EntityArray Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<Type2EntityArray>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.SemanticReleaseBenchmark.Baseline.Schema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(Type2EntityArray instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.SemanticReleaseBenchmark.Baseline.Schema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<Type2EntityArray, Mutable>(this);
            }
        }
    }
}
