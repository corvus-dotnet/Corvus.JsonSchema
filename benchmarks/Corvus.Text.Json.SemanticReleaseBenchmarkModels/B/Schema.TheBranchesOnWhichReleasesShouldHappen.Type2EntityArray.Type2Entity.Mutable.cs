...
public readonly partial struct Schema
{
    ...
    public readonly partial struct TheBranchesOnWhichReleasesShouldHappen
    {
        ...
        /// Generated from JSON Schema.
        /// </summary>
        public readonly partial struct Type2EntityArray
        {
            /// <summary>
            /// Generated from JSON Schema.
            /// </summary>
            [DebuggerDisplay("{DebuggerDisplay,nq}")]
            public readonly partial struct Type2Entity
            {
...
#endif
                {
                    ...
                    public static explicit operator Corvus.SemanticReleaseBenchmark.Baseline.Schema.BranchObject.Mutable(Mutable value)
                    {
                        return Corvus.SemanticReleaseBenchmark.Baseline.Schema.BranchObject.Mutable.From(value);
                    }
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator Mutable(Corvus.SemanticReleaseBenchmark.Baseline.Schema.BranchObject.Mutable value)
                    {
                        return From(value);
                    }
                    ...
                    public static explicit operator Mutable(Type2Entity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="Type2Entity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Type2Entity(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new Type2Entity(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"Type2Entity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="Type2Entity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="Type2Entity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly Type2Entity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<Type2Entity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="Type2Entity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly Type2Entity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<Type2Entity>(_idx);
                    }
                    ...
                    public TResult Match<TContext, TResult>(
                        ...
                        Matcher<Corvus.SemanticReleaseBenchmark.Baseline.Schema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.Type2Entity.Mutable, TContext, TResult> defaultMatch)
...
#endif
                    {
                        ...
                        {
                            return matchJsonString(Corvus.SemanticReleaseBenchmark.Baseline.JsonString.Mutable.From(this), context);
                        }

                        if (Corvus.SemanticReleaseBenchmark.Baseline.Schema.BranchObject.JsonSchema.Evaluate(_parent, _idx))
                        {
                            return matchBranchObject(Corvus.SemanticReleaseBenchmark.Baseline.Schema.BranchObject.Mutable.From(this), context);
                        }
                    ...
                    public TResult Match<TResult>(
                        ...
                        Matcher<Corvus.SemanticReleaseBenchmark.Baseline.Schema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.Type2Entity.Mutable, TResult> defaultMatch)
                    {
                        if (Corvus.SemanticReleaseBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                        {
                            return matchJsonString(Corvus.SemanticReleaseBenchmark.Baseline.JsonString.Mutable.From(this));
                        }

                        if (Corvus.SemanticReleaseBenchmark.Baseline.Schema.BranchObject.JsonSchema.Evaluate(_parent, _idx))
                        {
                            return matchBranchObject(Corvus.SemanticReleaseBenchmark.Baseline.Schema.BranchObject.Mutable.From(this));
                        }
                    ...
                    public bool TryGetAsBranchObject(out Corvus.SemanticReleaseBenchmark.Baseline.Schema.BranchObject result)
                    {
                        if (Corvus.SemanticReleaseBenchmark.Baseline.Schema.BranchObject.JsonSchema.Evaluate(_parent, _idx))
                        {
                            result = Corvus.SemanticReleaseBenchmark.Baseline.Schema.BranchObject.Mutable.From(this);
                            return true;
                        }
                    ...
                    public bool TryGetAsJsonString(out Corvus.SemanticReleaseBenchmark.Baseline.JsonString result)
                    {
                        if (Corvus.SemanticReleaseBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                        {
                            result = Corvus.SemanticReleaseBenchmark.Baseline.JsonString.Mutable.From(this);
                            return true;
                        }
                ...
                public ref struct Source
                {
                    ...
                    private readonly Corvus.SemanticReleaseBenchmark.Baseline.Schema.BranchObject.Builder.Build? _branchObjectBuilderInstance;
                    ...
                    public Source(Corvus.SemanticReleaseBenchmark.Baseline.Schema.BranchObject.Builder.Build value) {_branchObjectBuilderInstance = value; _kind = Kind.BranchObjectBuilder; }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Source(Corvus.SemanticReleaseBenchmark.Baseline.JsonString instance) => new(JsonElement.From(instance));

                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Source(Corvus.SemanticReleaseBenchmark.Baseline.Schema.BranchObject instance) => new(JsonElement.From(instance));
                    ...
                    internal void AddAsProperty(ReadOnlySpan<byte> utf8Name, ref ComplexValueBuilder valueBuilder, bool escapeName = true, bool nameRequiresUnescaping = false)
                    {
                        switch(_kind)
                        {
                            ...
                            case Kind.BranchObjectBuilder:
                                valueBuilder.AddProperty(utf8Name, _branchObjectBuilderInstance!, static (in b, ref o) => Corvus.SemanticReleaseBenchmark.Baseline.Schema.BranchObject.Builder.BuildValue(b, ref o), escapeName, nameRequiresUnescaping);
                                break;
                            default:
                    ...
                    internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
                    {
                        switch(_kind)
                        {
                            ...
                            case Kind.Utf16String:
                                ...
                                break;
                            case Kind.BranchObjectBuilder:
                                valueBuilder.AddProperty(name, _branchObjectBuilderInstance!, static (in b, ref o) => Corvus.SemanticReleaseBenchmark.Baseline.Schema.BranchObject.Builder.BuildValue(b, ref o));
                                break;
                            default:
                                Debug.Fail("Unexpected Kind");
                                break;
                    ...
                    internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
                    {
                        switch(_kind)
                        {
                            ...
                            case Kind.Utf16String:
                                ...
                                break;
                            case Kind.BranchObjectBuilder:
                                valueBuilder.AddItem(_branchObjectBuilderInstance!, static (in b, ref o) => Corvus.SemanticReleaseBenchmark.Baseline.Schema.BranchObject.Builder.BuildValue(b, ref o));
                                break;
                            default:
                                Debug.Fail("Unexpected Kind");
                                break;
                    ...
                    #endif
                {
                    ...
                    TContext _context;
                    Source _source;
                    private readonly Corvus.SemanticReleaseBenchmark.Baseline.Schema.BranchObject.Builder.Build<TContext>? _branchObjectBuilderInstance;
                    ...
                    public Source(scoped in TContext context, Corvus.SemanticReleaseBenchmark.Baseline.Schema.BranchObject.Builder.Build<TContext> value) {_context = context; _branchObjectBuilderInstance = value; _kind = Kind.BranchObjectBuilder; }
                    ...
                    internal void AddAsProperty(ReadOnlySpan<byte> utf8Name, ref ComplexValueBuilder valueBuilder, bool escapeName = true, bool nameRequiresUnescaping = false)
                    {
                        switch(_kind)
                        {
                            ...
                            case Kind.Source:
                                ...
                                break;
                            case Kind.BranchObjectBuilder:
                                valueBuilder.AddProperty(utf8Name, BuildWithContext.Create(_context, _branchObjectBuilderInstance!), static (in b, ref o) => Corvus.SemanticReleaseBenchmark.Baseline.Schema.BranchObject.Builder.BuildValue(b.Context, b.Build, ref o), escapeName, nameRequiresUnescaping);
                                break;
                            default:
                                Debug.Fail("Unexpected Kind");
                                break;
                    ...
                    internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
                    {
                        switch(_kind)
                        {
                            ...
                            case Kind.Source:
                                ...
                                break;
                            case Kind.BranchObjectBuilder:
                                valueBuilder.AddProperty(name, BuildWithContext.Create(_context, _branchObjectBuilderInstance!), static (in b, ref o) => Corvus.SemanticReleaseBenchmark.Baseline.Schema.BranchObject.Builder.BuildValue(b.Context, b.Build, ref o));
                                break;
                            default:
                                Debug.Fail("Unexpected Kind");
                                break;
                    ...
                    internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
                    {
                        switch(_kind)
                        {
                            ...
                            case Kind.Source:
                                ...
                                break;
                            case Kind.BranchObjectBuilder:
                                valueBuilder.AddItem(BuildWithContext.Create(_context, _branchObjectBuilderInstance!), static (in b, ref o) => Corvus.SemanticReleaseBenchmark.Baseline.Schema.BranchObject.Builder.BuildValue(b.Context, b.Build, ref o));
                                break;
                            default:
                                Debug.Fail("Unexpected Kind");
                                break;
                ...
                public static Corvus.SemanticReleaseBenchmark.Baseline.Schema.BranchObject.Source Build(
                    scoped in Corvus.SemanticReleaseBenchmark.Baseline.Schema.BranchObject.Builder.Build buildValue, int initialCapacity = 1)
                {
                    return new Corvus.SemanticReleaseBenchmark.Baseline.Schema.BranchObject.Source(buildValue);
                }
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>The source from which to build the value.</returns>
                public static Corvus.SemanticReleaseBenchmark.Baseline.Schema.BranchObject.Source<TContext> Build<TContext>(
                    scoped in TContext context, scoped in Corvus.SemanticReleaseBenchmark.Baseline.Schema.BranchObject.Builder.Build<TContext> buildValue, int initialCapacity = 1)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
                    return new Corvus.SemanticReleaseBenchmark.Baseline.Schema.BranchObject.Source<TContext>(context, buildValue);
                }
                ...
                /// <returns>An instance of a mutable document initialized with the given value.</returns>
                public static JsonDocumentBuilder<Mutable> CreateBuilder(
                    JsonWorkspace workspace, scoped in Corvus.SemanticReleaseBenchmark.Baseline.Schema.BranchObject.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
                {
                    // Create the document builder without a MetadataDb
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    var source = new Corvus.SemanticReleaseBenchmark.Baseline.Schema.BranchObject.Source(value);
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(
                    JsonWorkspace workspace, scoped in TContext context, scoped in Corvus.SemanticReleaseBenchmark.Baseline.Schema.BranchObject.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
                    ...
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    var source = new Corvus.SemanticReleaseBenchmark.Baseline.Schema.BranchObject.Source<TContext>(context, value);
                    source.AddAsItem(ref cvb);
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
                ...
                {
                    return workspace.CreateBuilder<Type2Entity, Mutable>(this);
                }
            }
        }
    }
