    ...
    public readonly partial struct TheBranchesOnWhichReleasesShouldHappen
    {
        ...
        public readonly partial struct Type2EntityArray
        {
...
#endif
            {
                ...
                public static explicit operator Corvus.SemanticReleaseBenchmark.Baseline.Schema.BranchObject(Type2Entity value)
                {
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Type2Entity(Corvus.SemanticReleaseBenchmark.Baseline.Schema.BranchObject value)
                {
                    return From(value);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.SemanticReleaseBenchmark.Baseline.Schema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.Type2Entity, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.SemanticReleaseBenchmark.Baseline.Schema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.Type2Entity, TResult> defaultMatch)
                {
                    if (Corvus.SemanticReleaseBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                    {
