...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Corvus.SemanticReleaseBenchmark.Baseline.Schema.TheBranchesOnWhichReleasesShouldHappen Branches
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BranchesUtf8, out Corvus.SemanticReleaseBenchmark.Baseline.Schema.TheBranchesOnWhichReleasesShouldHappen value))
            {
                return value;
            }

            return Corvus.SemanticReleaseBenchmark.Baseline.Schema.TheBranchesOnWhichReleasesShouldHappen.DefaultInstance;
        }
    }
    ...
    /// </para>
    /// </remarks>
    public Corvus.SemanticReleaseBenchmark.Baseline.Schema.CiEntity Ci
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CiUtf8, out Corvus.SemanticReleaseBenchmark.Baseline.Schema.CiEntity value))
            {
                return value;
            }

            return Corvus.SemanticReleaseBenchmark.Baseline.Schema.CiEntity.DefaultInstance;
        }
    }
    ...
    /// </para>
    /// </remarks>
    public Corvus.SemanticReleaseBenchmark.Baseline.JsonBoolean DryRun
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DryRunUtf8, out Corvus.SemanticReleaseBenchmark.Baseline.JsonBoolean value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.SemanticReleaseBenchmark.Baseline.Schema.ExtendsEntity Extends
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExtendsUtf8, out Corvus.SemanticReleaseBenchmark.Baseline.Schema.ExtendsEntity value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.SemanticReleaseBenchmark.Baseline.Schema.PluginsEntityArray Plugins
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PluginsUtf8, out Corvus.SemanticReleaseBenchmark.Baseline.Schema.PluginsEntityArray value))
            {
                return value;
            }

            return Corvus.SemanticReleaseBenchmark.Baseline.Schema.PluginsEntityArray.DefaultInstance;
        }
    }
    ...
    /// </para>
    /// </remarks>
    public Corvus.SemanticReleaseBenchmark.Baseline.JsonString RepositoryUrl
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RepositoryUrlUtf8, out Corvus.SemanticReleaseBenchmark.Baseline.JsonString value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.SemanticReleaseBenchmark.Baseline.Schema.TagFormatEntity TagFormat
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TagFormatUtf8, out Corvus.SemanticReleaseBenchmark.Baseline.Schema.TagFormatEntity value))
            {
                return value;
            }

            return Corvus.SemanticReleaseBenchmark.Baseline.Schema.TagFormatEntity.DefaultInstance;
        }
    }
