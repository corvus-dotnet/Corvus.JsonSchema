...
public readonly partial struct SemanticReleaseSchema
{
    ...
    public readonly partial struct BranchObject
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(BranchObject instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="BranchObject"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator BranchObject(Mutable instance)
            {
            ...
            /// </summary>
            public Corvus.SemanticReleaseBenchmark.Current.JsonString.Mutable Channel
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ChannelUtf8, out Corvus.SemanticReleaseBenchmark.Current.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.SemanticReleaseBenchmark.Current.JsonString.Mutable Name
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out Corvus.SemanticReleaseBenchmark.Current.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            /// <summary>
            /// Gets the (optional) <c>prerelease</c> property.
            /// </summary>
            public Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.BranchObject.PrereleaseEntity.Mutable Prerelease
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PrereleaseUtf8, out Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.BranchObject.PrereleaseEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public Corvus.SemanticReleaseBenchmark.Current.JsonString.Mutable Range
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RangeUtf8, out Corvus.SemanticReleaseBenchmark.Current.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new BranchObject(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetPrerelease(scoped in Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.BranchObject.PrereleaseEntity.Source value)
            {
                ...
                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.PrereleaseUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PrereleaseUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Prerelease, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// <summary>
            /// Remove the <c>prerelease</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemovePrerelease()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.PrereleaseUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"BranchObject.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="BranchObject"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="BranchObject"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly BranchObject Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<BranchObject>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="BranchObject"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly BranchObject Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<BranchObject>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.SemanticReleaseBenchmark.Current.JsonString.Source _createArg1;
            private readonly Corvus.SemanticReleaseBenchmark.Current.JsonString.Source _createArg2;
            private readonly Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.BranchObject.PrereleaseEntity.Source _createArg3;
            private readonly Corvus.SemanticReleaseBenchmark.Current.JsonString.Source _createArg4;
            ...
            public static implicit operator Source(BranchObject instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.BranchObject.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="BranchObject"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.SemanticReleaseBenchmark.Current.JsonString.Source name,
                in Corvus.SemanticReleaseBenchmark.Current.JsonString.Source channel = default,
                in Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.BranchObject.PrereleaseEntity.Source prerelease = default,
                in Corvus.SemanticReleaseBenchmark.Current.JsonString.Source range = default)
            {
                ...
                prerelease.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Prerelease, ref builder);
            ...
            public void Create(
                ...
                in Corvus.SemanticReleaseBenchmark.Current.JsonString.Source range = default)
            {
                Create(ref _builder, name, channel, prerelease, range);
            }
        ...
        {
            return workspace.CreateBuilder<BranchObject, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<BranchObject> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<BranchObject>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<BranchObject> Create<TContext>(
        ...
        public static ParsedJsonDocument<BranchObject> Create(in Corvus.SemanticReleaseBenchmark.Current.JsonString.Source name, in Corvus.SemanticReleaseBenchmark.Current.JsonString.Source channel = default, in Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.BranchObject.PrereleaseEntity.Source prerelease = default, in Corvus.SemanticReleaseBenchmark.Current.JsonString.Source range = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
