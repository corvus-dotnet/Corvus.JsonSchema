    ...
    public readonly partial struct BranchObject
    {
...
#endif
        {
            ...
            public void SetChannel(in Corvus.SemanticReleaseBenchmark.Current.JsonString.Source value)
            {
                ...
                else
                {
                    ...
                    value.AddAsProperty(JsonPropertyNamesEscaped.Channel, ref cvb, escapeName: false, nameRequiresUnescaping: false);
            ...
            public void SetPrerelease(in Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.BranchObject.PrereleaseEntity.Source value)
            {
                ...
                {
                    // We are going to insert the new value
                    value.AddAsProperty(JsonPropertyNamesEscaped.Prerelease, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            public void SetRange(in Corvus.SemanticReleaseBenchmark.Current.JsonString.Source value)
            {
                ...
                {
                    // We are going to insert the new value
                    value.AddAsProperty(JsonPropertyNamesEscaped.Range, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
        ...
        public ref struct Builder
        {
                ...
                in Corvus.SemanticReleaseBenchmark.Current.JsonString.Source range = default)
            {
                ...
                channel.AddAsProperty(JsonPropertyNamesEscaped.Channel, ref builder, escapeName: false);
                prerelease.AddAsProperty(JsonPropertyNamesEscaped.Prerelease, ref builder, escapeName: false);
                range.AddAsProperty(JsonPropertyNamesEscaped.Range, ref builder, escapeName: false);
            }
