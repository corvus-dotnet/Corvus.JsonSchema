...
public readonly partial struct SemanticReleaseSchema
{
    ...
    public readonly partial struct BranchObject
    {
        ...
        public readonly partial struct PrereleaseEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(PrereleaseEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="PrereleaseEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator PrereleaseEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new PrereleaseEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"PrereleaseEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="PrereleaseEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="PrereleaseEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly PrereleaseEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<PrereleaseEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="PrereleaseEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly PrereleaseEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<PrereleaseEntity>(_idx);
                }
                ...
                /// <param name="matchJsonBoolean">Match a <see cref="Corvus.SemanticReleaseBenchmark.Current.JsonBoolean"/>.</param>
                ...
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Matcher<Corvus.SemanticReleaseBenchmark.Current.JsonBoolean, TContext, TResult> matchJsonBoolean,
                    Matcher<Corvus.SemanticReleaseBenchmark.Current.JsonString, TContext, TResult> matchJsonString,
                    Matcher<Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.BranchObject.PrereleaseEntity.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
                {
                    if (Corvus.SemanticReleaseBenchmark.Current.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchJsonBoolean(Corvus.SemanticReleaseBenchmark.Current.JsonBoolean.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    Matcher<Corvus.SemanticReleaseBenchmark.Current.JsonBoolean, TResult> matchJsonBoolean,
                    Matcher<Corvus.SemanticReleaseBenchmark.Current.JsonString, TResult> matchJsonString,
                    Matcher<Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.BranchObject.PrereleaseEntity.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.SemanticReleaseBenchmark.Current.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchJsonBoolean(Corvus.SemanticReleaseBenchmark.Current.JsonBoolean.Mutable.From(this));
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.SemanticReleaseBenchmark.Current.JsonBoolean.Mutable" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsJsonBoolean(out Corvus.SemanticReleaseBenchmark.Current.JsonBoolean.Mutable result)
                {
                    if (Corvus.SemanticReleaseBenchmark.Current.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.SemanticReleaseBenchmark.Current.JsonBoolean.Mutable.From(this);
                        return true;
                    }
                ...
                public bool TryGetAsJsonString(out Corvus.SemanticReleaseBenchmark.Current.JsonString.Mutable result)
                {
                    if (Corvus.SemanticReleaseBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.SemanticReleaseBenchmark.Current.JsonString.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(PrereleaseEntity instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.SemanticReleaseBenchmark.Current.JsonBoolean instance) => new(JsonElement.From(instance));

                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.SemanticReleaseBenchmark.Current.JsonString instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<PrereleaseEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<PrereleaseEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<PrereleaseEntity>();
                }
                finally
                {
