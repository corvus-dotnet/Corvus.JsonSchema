...
public readonly partial struct SemanticReleaseSchema
{
    ...
    public readonly partial struct BranchObject
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="PrereleaseEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal PrereleaseEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static PrereleaseEntity DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(PrereleaseEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator bool(PrereleaseEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in PrereleaseEntity left, in PrereleaseEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in PrereleaseEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(PrereleaseEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PrereleaseEntity(JsonElement instance)
            {
                return PrereleaseEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PrereleaseEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PrereleaseEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PrereleaseEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PrereleaseEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PrereleaseEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static PrereleaseEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<PrereleaseEntity>(json, options);
            }
            ...
            /// </exception>
            public static PrereleaseEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<PrereleaseEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out PrereleaseEntity? result)
            {
                return JsonElementHelpers.TryParseValue<PrereleaseEntity>(ref reader, out result);
            }
...
#if NET
            static PrereleaseEntity IJsonElement<PrereleaseEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PrereleaseEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public PrereleaseEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<PrereleaseEntity>(_idx);
                }
            ...
            public bool TryGetAsJsonBoolean(out Corvus.SemanticReleaseBenchmark.Current.JsonBoolean result)
            {
                ...
                {
                    result = Corvus.SemanticReleaseBenchmark.Current.JsonBoolean.From(this);
                    return true;
                }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.BranchObject.PrereleaseEntity, TContext, TResult> defaultMatch)
...
#endif
            {
                if (Corvus.SemanticReleaseBenchmark.Current.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonBoolean(Corvus.SemanticReleaseBenchmark.Current.JsonBoolean.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.BranchObject.PrereleaseEntity, TResult> defaultMatch)
            {
                if (Corvus.SemanticReleaseBenchmark.Current.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonBoolean(Corvus.SemanticReleaseBenchmark.Current.JsonBoolean.From(this));
                }
