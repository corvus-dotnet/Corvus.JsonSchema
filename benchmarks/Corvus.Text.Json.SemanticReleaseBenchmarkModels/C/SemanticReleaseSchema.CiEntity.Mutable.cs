...
public readonly partial struct SemanticReleaseSchema
{
    ...
    public readonly partial struct CiEntity
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<CiEntity, Mutable>(CiEntity.DefaultInstance);
            ...
            public static explicit operator Mutable(CiEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="CiEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator CiEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"CiEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly CiEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly CiEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<CiEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(CiEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<CiEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<CiEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<CiEntity>();
            }
            finally
            {
