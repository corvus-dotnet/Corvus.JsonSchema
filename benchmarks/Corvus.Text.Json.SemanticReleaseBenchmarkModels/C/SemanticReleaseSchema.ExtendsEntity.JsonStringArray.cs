...
public readonly partial struct SemanticReleaseSchema
{
    ...
    public readonly partial struct ExtendsEntity
    {
...
#endif
        {
            ...
            public Corvus.SemanticReleaseBenchmark.Current.JsonString this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.SemanticReleaseBenchmark.Current.JsonString>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.SemanticReleaseBenchmark.Current.JsonString> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.SemanticReleaseBenchmark.Current.JsonString>(_parent, _idx);
            }
