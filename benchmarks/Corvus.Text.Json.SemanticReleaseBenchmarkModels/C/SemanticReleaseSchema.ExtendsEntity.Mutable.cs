...
public readonly partial struct SemanticReleaseSchema
{
    ...
    public readonly partial struct ExtendsEntity
    {
...
#endif
        {
            ...
            /// <summary>
            /// Conversion to <see cref="Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.ExtendsEntity.JsonStringArray"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.ExtendsEntity.JsonStringArray.Mutable(Mutable value)
            {
                return Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.ExtendsEntity.JsonStringArray.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.ExtendsEntity.JsonStringArray"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.ExtendsEntity.JsonStringArray.Mutable value)
            {
                return From(value);
            }
            ...
            /// <param name="matchJsonStringArray">Match a <see cref="Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.ExtendsEntity.JsonStringArray"/>.</param>
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.ExtendsEntity.JsonStringArray, TContext, TResult> matchJsonStringArray,
                Matcher<Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.ExtendsEntity.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
            {
                ...
                if (Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.ExtendsEntity.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonStringArray(Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.ExtendsEntity.JsonStringArray.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.ExtendsEntity.JsonStringArray, TResult> matchJsonStringArray,
                Matcher<Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.ExtendsEntity.Mutable, TResult> defaultMatch)
            {
                if (Corvus.SemanticReleaseBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                ...
                if (Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.ExtendsEntity.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonStringArray(Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.ExtendsEntity.JsonStringArray.Mutable.From(this));
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.ExtendsEntity.JsonStringArray.Mutable" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsJsonStringArray(out Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.ExtendsEntity.JsonStringArray.Mutable result)
            {
                if (Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.ExtendsEntity.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.ExtendsEntity.JsonStringArray.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.ExtendsEntity.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.ExtendsEntity.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        public static ParsedJsonDocument<ExtendsEntity> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ExtendsEntity>();
            }
            finally
            {
