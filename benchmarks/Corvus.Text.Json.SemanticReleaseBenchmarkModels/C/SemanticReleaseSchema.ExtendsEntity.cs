...
public readonly partial struct SemanticReleaseSchema
{
...
#endif
    {
        ...
        public static explicit operator Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.ExtendsEntity.JsonStringArray(ExtendsEntity value)
        {
            return Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.ExtendsEntity.JsonStringArray.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ExtendsEntity(Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.ExtendsEntity.JsonStringArray value)
        {
            return From(value);
        }

        /// <summary>
        /// Conversion from the <see cref="Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.ExtendsEntity.JsonStringArray"/> mutable view.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ExtendsEntity(Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.ExtendsEntity.JsonStringArray.Mutable value)
        {
            return From(value);
        }
        ...
        public bool TryGetAsJsonStringArray(out Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.ExtendsEntity.JsonStringArray result)
        {
            ...
            {
                result = Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.ExtendsEntity.JsonStringArray.From(this);
                return true;
            }
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.ExtendsEntity, TContext, TResult> defaultMatch)
...
#endif
        {
            ...
            if (Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.ExtendsEntity.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchJsonStringArray(Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.ExtendsEntity.JsonStringArray.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.ExtendsEntity, TResult> defaultMatch)
        {
            if (Corvus.SemanticReleaseBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
            {
            ...
            if (Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.ExtendsEntity.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchJsonStringArray(Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.ExtendsEntity.JsonStringArray.From(this));
            }
