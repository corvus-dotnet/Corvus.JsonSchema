...
public readonly partial struct SemanticReleaseSchema
{
    ...
    public readonly partial struct PluginsEntityArray
    {
        ...
        public readonly partial struct PluginsEntity
        {
            ...
            public readonly partial struct AnyOf1Array
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(AnyOf1Array instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="AnyOf1Array"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator AnyOf1Array(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new AnyOf1Array(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"AnyOf1Array.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    /// <summary>
                    ...
                    /// <summary>
                    /// Gets a <see cref="AnyOf1Array"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="AnyOf1Array"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly AnyOf1Array Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<AnyOf1Array>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="AnyOf1Array"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly AnyOf1Array Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<AnyOf1Array>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.PluginsEntityArray.PluginsEntity.AnyOf1Array.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(AnyOf1Array instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.PluginsEntityArray.PluginsEntity.AnyOf1Array.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
                ...
                {
                    return workspace.CreateBuilder<AnyOf1Array, Mutable>(this);
                }
            }
        }
    }
