    ...
    public readonly partial struct PluginsEntityArray
    {
        ...
        public readonly partial struct PluginsEntity
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="AnyOf1Array"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal AnyOf1Array(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static AnyOf1Array DefaultInstance { get; }
                ...
                /// </returns>
                public static bool operator ==(in AnyOf1Array left, in AnyOf1Array right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in AnyOf1Array left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(AnyOf1Array instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AnyOf1Array(JsonElement instance)
                {
                    return AnyOf1Array.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AnyOf1Array From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AnyOf1Array ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<AnyOf1Array>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AnyOf1Array ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<AnyOf1Array>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AnyOf1Array ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<AnyOf1Array>(json, options);
                }
                ...
                /// </exception>
                public static AnyOf1Array ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<AnyOf1Array>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out AnyOf1Array? result)
                {
                    return JsonElementHelpers.TryParseValue<AnyOf1Array>(ref reader, out result);
                }
...
#if NET
                static AnyOf1Array IJsonElement<AnyOf1Array>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AnyOf1Array: ValueKind = {ValueKind} : \"{ToString()}\"";
