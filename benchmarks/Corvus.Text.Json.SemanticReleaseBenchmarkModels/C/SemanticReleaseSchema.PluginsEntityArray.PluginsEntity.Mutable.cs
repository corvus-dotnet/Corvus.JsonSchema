    ...
    public readonly partial struct PluginsEntityArray
    {
        ...
        public readonly partial struct PluginsEntity
        {
...
#endif
            {
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.SemanticReleaseBenchmark.Current.JsonArray.Mutable" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsJsonArray(out Corvus.SemanticReleaseBenchmark.Current.JsonArray.Mutable result)
                {
                    if (Corvus.SemanticReleaseBenchmark.Current.JsonArray.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.PluginsEntityArray.PluginsEntity.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.PluginsEntityArray.PluginsEntity.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
