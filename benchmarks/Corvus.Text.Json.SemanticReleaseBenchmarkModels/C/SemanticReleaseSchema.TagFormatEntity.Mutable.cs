...
public readonly partial struct SemanticReleaseSchema
{
    ...
    public readonly partial struct TagFormatEntity
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<TagFormatEntity, Mutable>(TagFormatEntity.DefaultInstance);
            ...
            public static explicit operator Mutable(TagFormatEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="TagFormatEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TagFormatEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TagFormatEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly TagFormatEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly TagFormatEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<TagFormatEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(TagFormatEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<TagFormatEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<TagFormatEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<TagFormatEntity>();
            }
            finally
            {
