    ...
    public readonly partial struct TheBranchesOnWhichReleasesShouldHappen
    {
        ...
        public readonly partial struct Type2EntityArray
        {
...
#endif
            {
                ...
                public Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.Type2Entity.Mutable this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.Type2Entity.Mutable>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.Type2Entity.Mutable> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.Type2Entity.Mutable>(_parent, _idx);
                }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetItem(int itemIndex, in Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.Type2Entity.Source value)
                {
                    CheckValidInstance();
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Remove(in Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.Type2Entity item)
                {
                    CheckValidInstance();
                    if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.Type2Entity>(this, in item))
                    {
                        return false;
                    }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void RemoveWhere(JsonPredicate<Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.Type2Entity> predicate)
                {
                    CheckValidInstance();
                    JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.Type2Entity>(this, predicate);
                    _documentVersion = _parent.Version;
                }
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Replace(in Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.Type2Entity oldItem, in Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.Type2Entity.Source newItem)
                {
                    CheckValidInstance();
                    ...
                    var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.Type2Entity>(_parent, _idx);

                    while (enumerator.MoveNext())
                    {
                        Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.Type2Entity current = enumerator.Current;
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// Add an item to the array.
                /// </summary>
                public void AddItem<TContext>(in Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.Type2Entity.Source<TContext> value)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
            ...
            public static ParsedJsonDocument<Type2EntityArray> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<Type2EntityArray>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<Type2EntityArray> Create<TContext>(
