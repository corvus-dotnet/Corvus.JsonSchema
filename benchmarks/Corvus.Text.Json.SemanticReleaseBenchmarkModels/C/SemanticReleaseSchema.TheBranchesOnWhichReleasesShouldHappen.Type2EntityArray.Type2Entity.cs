    ...
    public readonly partial struct TheBranchesOnWhichReleasesShouldHappen
    {
        ...
        public readonly partial struct Type2EntityArray
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="Type2Entity"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal Type2Entity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static Type2Entity DefaultInstance { get; }
                ...
                /// <summary>
                /// Conversion to <see cref="Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.BranchObject"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static explicit operator Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.BranchObject(Type2Entity value)
                {
                    return Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.BranchObject.From(value);
                }

                /// <summary>
                /// Conversion from <see cref="Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.BranchObject"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Type2Entity(Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.BranchObject value)
                {
                    return From(value);
                }
                ...
                /// </returns>
                public static bool operator ==(in Type2Entity left, in Type2Entity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in Type2Entity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(Type2Entity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Type2Entity(JsonElement instance)
                {
                    return Type2Entity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Type2Entity From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Type2Entity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<Type2Entity>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Type2Entity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<Type2Entity>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Type2Entity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<Type2Entity>(json, options);
                }
                ...
                /// </exception>
                public static Type2Entity ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<Type2Entity>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out Type2Entity? result)
                {
                    return JsonElementHelpers.TryParseValue<Type2Entity>(ref reader, out result);
                }
...
#if NET
                static Type2Entity IJsonElement<Type2Entity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Type2Entity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                public bool TryGetAsBranchObject(out Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.BranchObject result)
                {
                    ...
                    {
                        result = Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.BranchObject.From(this);
                        return true;
                    }
                ...
                public bool TryGetAsJsonString(out Corvus.SemanticReleaseBenchmark.Current.JsonString result)
                {
                    ...
                    {
                        result = Corvus.SemanticReleaseBenchmark.Current.JsonString.From(this);
                        return true;
                    }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.BranchObject, TContext, TResult> matchBranchObject,
                    Matcher<Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.Type2Entity, TContext, TResult> defaultMatch)
...
#endif
                {
                    ...
                    if (Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.BranchObject.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchBranchObject(Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.BranchObject.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.BranchObject, TResult> matchBranchObject,
                    Matcher<Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.Type2Entity, TResult> defaultMatch)
                {
                    if (Corvus.SemanticReleaseBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                    {
                    ...
                    if (Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.BranchObject.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchBranchObject(Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.BranchObject.From(this));
                    }
