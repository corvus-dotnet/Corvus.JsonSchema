...
public readonly partial struct SemanticReleaseSchema
{
...
#endif
    {
        ...
        public static explicit operator Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.BranchObject(TheBranchesOnWhichReleasesShouldHappen value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator TheBranchesOnWhichReleasesShouldHappen(Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.BranchObject value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray(TheBranchesOnWhichReleasesShouldHappen value)
        {
            return Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.From(value);
        }
        ...
        public bool TryGetAsType2EntityArray(out Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray result)
        {
            ...
            {
                result = Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.From(this);
                return true;
            }
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.TheBranchesOnWhichReleasesShouldHappen, TContext, TResult> defaultMatch)
...
#endif
        {
            ...
            if (Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchType2EntityArray(Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.TheBranchesOnWhichReleasesShouldHappen, TResult> defaultMatch)
        {
            if (Corvus.SemanticReleaseBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
            {
            ...
            if (Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchType2EntityArray(Corvus.SemanticReleaseBenchmark.Current.SemanticReleaseSchema.TheBranchesOnWhichReleasesShouldHappen.Type2EntityArray.From(this));
            }
