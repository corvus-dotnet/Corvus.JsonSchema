    ...
    public readonly partial struct Configuration
    {
        ...
        public readonly partial struct ClosedComment
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ClosedComment instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ClosedComment"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ClosedComment(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ClosedComment.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ClosedComment Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ClosedComment Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ClosedComment>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ClosedComment instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ClosedComment, Mutable>(this);
            }
        }
    }
}
