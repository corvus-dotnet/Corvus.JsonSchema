...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Configuration
    {
        ...
        public readonly partial struct ClosedComment
#if NET8_0_OR_GREATER
            : IJsonElement<ClosedComment>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ClosedComment"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ClosedComment(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ClosedComment DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(ClosedComment value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator bool(ClosedComment value)
            {
            ...
            /// </returns>
            public static bool operator ==(in ClosedComment left, in ClosedComment right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ClosedComment left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ClosedComment instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ClosedComment(JsonElement instance)
            {
                return ClosedComment.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ClosedComment From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ClosedComment ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ClosedComment>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ClosedComment ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ClosedComment>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ClosedComment ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ClosedComment>(json, options);
            }
            ...
            /// </exception>
            public static ClosedComment ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ClosedComment>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ClosedComment? result)
            {
                return JsonElementHelpers.TryParseValue<ClosedComment>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ClosedComment(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static ClosedComment IJsonElement<ClosedComment>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ClosedComment: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ClosedComment"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ClosedComment"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public ClosedComment Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ClosedComment>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ClosedComment"/> that lives for the lifetime of its
