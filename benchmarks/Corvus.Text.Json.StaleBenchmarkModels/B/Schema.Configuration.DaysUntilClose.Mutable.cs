    ...
    public readonly partial struct Configuration
    {
        ...
        public readonly partial struct DaysUntilClose
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(DaysUntilClose instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DaysUntilClose"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DaysUntilClose(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DaysUntilClose.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly DaysUntilClose Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly DaysUntilClose Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DaysUntilClose>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(DaysUntilClose instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<DaysUntilClose, Mutable>(this);
            }
        }
    }
}
