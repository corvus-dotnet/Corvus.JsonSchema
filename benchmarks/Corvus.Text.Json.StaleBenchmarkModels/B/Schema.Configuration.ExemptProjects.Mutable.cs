...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Configuration
    {
        ...
        public readonly partial struct ExemptProjects
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ExemptProjects instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ExemptProjects"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ExemptProjects(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ExemptProjects(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ExemptProjects.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ExemptProjects"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ExemptProjects"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ExemptProjects Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ExemptProjects>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ExemptProjects"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ExemptProjects Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ExemptProjects>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ExemptProjects instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ExemptProjects, Mutable>(this);
            }
        }
    }
}
