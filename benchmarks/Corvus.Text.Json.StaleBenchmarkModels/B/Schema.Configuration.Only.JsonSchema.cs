    ...
    public readonly partial struct Configuration
    {
            ...
            : IJsonElement<Only>
        {
            ...
            private static class Constants
            {
                ...
                /// </summary>
                public static readonly byte[] Enum1 = "issues"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly Only EnumJson1 = ParsedJsonDocument<Only>.StringConstant([.."\"issues\""u8]);
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly byte[] Enum2 = "pulls"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly Only EnumJson2 = ParsedJsonDocument<Only>.StringConstant([.."\"pulls\""u8]);
            }
            ...
            {
                /// <summary>
                /// Gets the string "issues"
                /// as a <see cref="Only"/>.
                /// </summary>
                public static Only Issues { get; } = Constants.EnumJson1;
                /// <summary>
                /// Gets the string "issues"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> IssuesUtf8 => Constants.Enum1;

                /// <summary>
                /// Gets the string "pulls"
                /// as a <see cref="Only"/>.
                /// </summary>
                public static Only Pulls { get; } = Constants.EnumJson2;
                /// <summary>
                /// Gets the string "pulls"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> PullsUtf8 => Constants.Enum2;
            }
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://json.schemastore.org/stale.json#/definitions/configuration/properties/only"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "https://json.schemastore.org/stale.json#/definitions/configuration/properties/only";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://json.schemastore.org/stale.json#/definitions/configuration/properties/only"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    if (tokenType == JsonTokenType.String)
                    {
                        ...
                        if (unescapedUtf8JsonString.Span.SequenceEqual("issues"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }

                        if (unescapedUtf8JsonString.Span.SequenceEqual("pulls"u8))
                        {
                            goto enumShortCircuitSuccess;
                        }
                    }
