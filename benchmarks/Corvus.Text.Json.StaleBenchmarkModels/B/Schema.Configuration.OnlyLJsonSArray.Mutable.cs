    ...
    public readonly partial struct Configuration
    {
        ...
        public readonly partial struct OnlyLJsonSArray
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(OnlyLJsonSArray instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="OnlyLJsonSArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator OnlyLJsonSArray(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"OnlyLJsonSArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </para>
                /// </remarks>
                public readonly OnlyLJsonSArray Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly OnlyLJsonSArray Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<OnlyLJsonSArray>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.StaleBenchmark.Baseline.Schema.Configuration.OnlyLJsonSArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(OnlyLJsonSArray instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.StaleBenchmark.Baseline.Schema.Configuration.OnlyLJsonSArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<OnlyLJsonSArray, Mutable>(this);
            }
        }
    }
}
