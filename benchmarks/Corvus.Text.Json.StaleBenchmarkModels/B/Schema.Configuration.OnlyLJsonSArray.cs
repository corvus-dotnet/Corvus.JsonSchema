...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Configuration
    {
...
#endif
        {
            ...
            public Corvus.StaleBenchmark.Baseline.JsonString this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.StaleBenchmark.Baseline.JsonString>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.StaleBenchmark.Baseline.JsonString> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.StaleBenchmark.Baseline.JsonString>(_parent, _idx);
            }
