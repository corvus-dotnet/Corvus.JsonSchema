...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Configuration
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="StaleLabel"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal StaleLabel(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static StaleLabel DefaultInstance { get; } = ParsedJsonDocument<StaleLabel>.StringConstant([.."\"wontfix\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(StaleLabel value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in StaleLabel left, in StaleLabel right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in StaleLabel left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(StaleLabel instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator StaleLabel(JsonElement instance)
            {
                return StaleLabel.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static StaleLabel From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static StaleLabel ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<StaleLabel>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static StaleLabel ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<StaleLabel>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static StaleLabel ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<StaleLabel>(json, options);
            }
            ...
            /// </exception>
            public static StaleLabel ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<StaleLabel>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out StaleLabel? result)
            {
                return JsonElementHelpers.TryParseValue<StaleLabel>(ref reader, out result);
            }
...
#if NET
            static StaleLabel IJsonElement<StaleLabel>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"StaleLabel: ValueKind = {ValueKind} : \"{ToString()}\"";
