    ...
    public readonly partial struct Configuration
    {
        ...
        public readonly partial struct DaysUntilClose
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DaysUntilClose, Mutable>(DaysUntilClose.DefaultInstance);
            ...
            public static ParsedJsonDocument<DaysUntilClose> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<DaysUntilClose>();
                }
                finally
                {
