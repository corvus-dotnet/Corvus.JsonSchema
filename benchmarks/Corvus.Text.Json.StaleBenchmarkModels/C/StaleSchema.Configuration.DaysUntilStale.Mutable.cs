    ...
    public readonly partial struct Configuration
    {
        ...
        public readonly partial struct DaysUntilStale
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DaysUntilStale, Mutable>(DaysUntilStale.DefaultInstance);
                ...
                public static explicit operator Mutable(DaysUntilStale instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DaysUntilStale"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DaysUntilStale(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DaysUntilStale.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly DaysUntilStale Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly DaysUntilStale Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DaysUntilStale>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(DaysUntilStale instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<DaysUntilStale, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<DaysUntilStale> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<DaysUntilStale>();
                }
                finally
                {
