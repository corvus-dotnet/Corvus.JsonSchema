...
public readonly partial struct StaleSchema
{
    ...
    public readonly partial struct Configuration
    {
        ...
        public readonly partial struct ExemptAssignees
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ExemptAssignees, Mutable>(ExemptAssignees.DefaultInstance);
                ...
                public static explicit operator Mutable(ExemptAssignees instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ExemptAssignees"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ExemptAssignees(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ExemptAssignees(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ExemptAssignees.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ExemptAssignees"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ExemptAssignees"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ExemptAssignees Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ExemptAssignees>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ExemptAssignees"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ExemptAssignees Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ExemptAssignees>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ExemptAssignees instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ExemptAssignees, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ExemptAssignees> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ExemptAssignees>();
                }
                finally
                {
