...
public readonly partial struct StaleSchema
{
    ...
    public readonly partial struct Configuration
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ExemptAssignees"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ExemptAssignees(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ExemptAssignees DefaultInstance { get; } = ParsedJsonDocument<ExemptAssignees>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(ExemptAssignees value)
            {
            ...
            /// </returns>
            public static bool operator ==(in ExemptAssignees left, in ExemptAssignees right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ExemptAssignees left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ExemptAssignees instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ExemptAssignees(JsonElement instance)
            {
                return ExemptAssignees.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ExemptAssignees From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ExemptAssignees ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ExemptAssignees>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ExemptAssignees ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ExemptAssignees>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ExemptAssignees ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ExemptAssignees>(json, options);
            }
            ...
            /// </exception>
            public static ExemptAssignees ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ExemptAssignees>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ExemptAssignees? result)
            {
                return JsonElementHelpers.TryParseValue<ExemptAssignees>(ref reader, out result);
            }
...
#if NET
            static ExemptAssignees IJsonElement<ExemptAssignees>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ExemptAssignees: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public ExemptAssignees Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ExemptAssignees>(_idx);
                }
