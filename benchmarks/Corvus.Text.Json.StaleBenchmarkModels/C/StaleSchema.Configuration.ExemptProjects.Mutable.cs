    ...
    public readonly partial struct Configuration
    {
        ...
        public readonly partial struct ExemptProjects
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ExemptProjects, Mutable>(ExemptProjects.DefaultInstance);
            ...
            public static ParsedJsonDocument<ExemptProjects> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ExemptProjects>();
                }
                finally
                {
