...
public readonly partial struct StaleSchema
{
    ...
    public readonly partial struct Configuration
    {
        ...
        public readonly partial struct LimitPerRun
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<LimitPerRun, Mutable>(LimitPerRun.DefaultInstance);
                ...
                public static explicit operator Mutable(LimitPerRun instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="LimitPerRun"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator LimitPerRun(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new LimitPerRun(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"LimitPerRun.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="LimitPerRun"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="LimitPerRun"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly LimitPerRun Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<LimitPerRun>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="LimitPerRun"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly LimitPerRun Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<LimitPerRun>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(LimitPerRun instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<LimitPerRun, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<LimitPerRun> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<LimitPerRun>();
                }
                finally
                {
