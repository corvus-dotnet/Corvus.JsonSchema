...
public readonly partial struct StaleSchema
{
    ...
    public readonly partial struct Configuration
    {
        ...
        public readonly partial struct MarkComment
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<MarkComment, Mutable>(MarkComment.DefaultInstance);
                ...
                public static explicit operator Mutable(MarkComment instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="MarkComment"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator MarkComment(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new MarkComment(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"MarkComment.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="MarkComment"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="MarkComment"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly MarkComment Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<MarkComment>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="MarkComment"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly MarkComment Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<MarkComment>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(MarkComment instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<MarkComment, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<MarkComment> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<MarkComment>();
                }
                finally
                {
