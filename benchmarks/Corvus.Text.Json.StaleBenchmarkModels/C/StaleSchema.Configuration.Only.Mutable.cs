    ...
    public readonly partial struct Configuration
    {
        ...
        public readonly partial struct Only
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(Only instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="Only"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Only(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Only.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly Only Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<Only>(_idx);
                }
                ...
                public bool TryGetKnownValue(out KnownValues result)
                {
                    if (this.ValueEquals(Constants.Enum1))
                    {
                        result = KnownValues.Issues;
                        return true;
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        result = KnownValues.Pulls;
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(Only instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (Only)value;
            ...
            {
                return workspace.CreateBuilder<Only, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<Only> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<Only>();
                }
                finally
                {
