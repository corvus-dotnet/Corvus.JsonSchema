...
public readonly partial struct StaleSchema
{
    ...
    public readonly partial struct Configuration
    {
        ...
        public readonly partial struct Only
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="Only"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal Only(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static Only DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(Only value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in Only left, in Only right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in Only left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(Only instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Only(JsonElement instance)
            {
                return Only.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Only From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Only ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Only>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Only ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Only>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Only ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Only>(json, options);
            }
            ...
            /// </exception>
            public static Only ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<Only>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out Only? result)
            {
                return JsonElementHelpers.TryParseValue<Only>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Only(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static Only IJsonElement<Only>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Only: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Only"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Only"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            {
                CheckValidInstance();
                return _parent.CloneElement<Only>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Only"/> that lives for the lifetime of its
            ...
            public Only Freeze()
            {
                ...
                {
                    return mutable.FreezeElement<Only>(_idx);
                }
            ...
            /// <param name="matchIssues">Match 1st item.</param>
            /// <param name="matchPulls">Match 2nd item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchIssues,
                Func<TContext, TResult> matchPulls,
...
#endif
            {
                ...
                {
                    return matchIssues(context);
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchPulls(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchIssues,
                Func<TResult> matchPulls,
