    ...
    public readonly partial struct Configuration
    {
        ...
        public readonly partial struct OnlyLJsonSArray
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<OnlyLJsonSArray, Mutable>(OnlyLJsonSArray.DefaultInstance);
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.StaleBenchmark.Current.StaleSchema.Configuration.OnlyLJsonSArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.StaleBenchmark.Current.StaleSchema.Configuration.OnlyLJsonSArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            public static ParsedJsonDocument<OnlyLJsonSArray> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<OnlyLJsonSArray>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<OnlyLJsonSArray> Create<TContext>(
