...
public readonly partial struct StaleSchema
{
    ...
    public readonly partial struct Configuration
    {
        ...
        public readonly partial struct OnlyLJsonSArray
#if NET8_0_OR_GREATER
            : IJsonElement<OnlyLJsonSArray>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="OnlyLJsonSArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal OnlyLJsonSArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            public Corvus.StaleBenchmark.Current.JsonString this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.StaleBenchmark.Current.JsonString>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.StaleBenchmark.Current.JsonString> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.StaleBenchmark.Current.JsonString>(_parent, _idx);
            }
            ...
            /// </returns>
            public static bool operator ==(in OnlyLJsonSArray left, in OnlyLJsonSArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in OnlyLJsonSArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(OnlyLJsonSArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator OnlyLJsonSArray(JsonElement instance)
            {
                return OnlyLJsonSArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OnlyLJsonSArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OnlyLJsonSArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OnlyLJsonSArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OnlyLJsonSArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OnlyLJsonSArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OnlyLJsonSArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OnlyLJsonSArray>(json, options);
            }
            ...
            /// </exception>
            public static OnlyLJsonSArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<OnlyLJsonSArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out OnlyLJsonSArray? result)
            {
                return JsonElementHelpers.TryParseValue<OnlyLJsonSArray>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new OnlyLJsonSArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static OnlyLJsonSArray IJsonElement<OnlyLJsonSArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"OnlyLJsonSArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="OnlyLJsonSArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="OnlyLJsonSArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public OnlyLJsonSArray Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<OnlyLJsonSArray>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="OnlyLJsonSArray"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public OnlyLJsonSArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<OnlyLJsonSArray>(_idx);
                }
