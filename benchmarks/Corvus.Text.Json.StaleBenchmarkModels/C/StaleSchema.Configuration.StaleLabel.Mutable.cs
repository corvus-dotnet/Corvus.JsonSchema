...
public readonly partial struct StaleSchema
{
    ...
    public readonly partial struct Configuration
    {
        ...
        public readonly partial struct StaleLabel
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<StaleLabel, Mutable>(StaleLabel.DefaultInstance);
                ...
                public static explicit operator Mutable(StaleLabel instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="StaleLabel"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator StaleLabel(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new StaleLabel(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"StaleLabel.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="StaleLabel"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="StaleLabel"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly StaleLabel Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<StaleLabel>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="StaleLabel"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly StaleLabel Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<StaleLabel>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(StaleLabel instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<StaleLabel, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<StaleLabel> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<StaleLabel>();
                }
                finally
                {
