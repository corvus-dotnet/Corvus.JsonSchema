    ...
    public readonly partial struct Configuration
    {
        ...
        public readonly partial struct UnmarkComment
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(UnmarkComment instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="UnmarkComment"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator UnmarkComment(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"UnmarkComment.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly UnmarkComment Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly UnmarkComment Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<UnmarkComment>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(UnmarkComment instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<UnmarkComment, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<UnmarkComment> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<UnmarkComment>();
                }
                finally
                {
