...
public readonly partial struct StaleSchema
{
    ...
    public readonly partial struct Configuration
    {
        ...
        public readonly partial struct UnmarkComment
#if NET8_0_OR_GREATER
            : IJsonElement<UnmarkComment>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="UnmarkComment"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal UnmarkComment(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static UnmarkComment DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(UnmarkComment value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator bool(UnmarkComment value)
            {
            ...
            /// </returns>
            public static bool operator ==(in UnmarkComment left, in UnmarkComment right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in UnmarkComment left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(UnmarkComment instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator UnmarkComment(JsonElement instance)
            {
                return UnmarkComment.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static UnmarkComment From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static UnmarkComment ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<UnmarkComment>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static UnmarkComment ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<UnmarkComment>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static UnmarkComment ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<UnmarkComment>(json, options);
            }
            ...
            /// </exception>
            public static UnmarkComment ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<UnmarkComment>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out UnmarkComment? result)
            {
                return JsonElementHelpers.TryParseValue<UnmarkComment>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new UnmarkComment(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static UnmarkComment IJsonElement<UnmarkComment>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"UnmarkComment: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="UnmarkComment"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="UnmarkComment"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public UnmarkComment Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<UnmarkComment>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="UnmarkComment"/> that lives for the lifetime of its
