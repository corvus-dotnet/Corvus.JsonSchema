...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.Mutable Settings
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SettingsUtf8, out Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.Mutable value))
                {
                    return value;
                }
        ...
        public void SetSettings(in Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetSettings<TContext>(in Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.Source<TContext> value)
    ...
    public ref struct Source
    {
        ...
        internal Source(Corvus.StylecopBenchmark.Baseline.Schema.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.StylecopBenchmark.Baseline.Schema.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.Source settings = default)
        {
        ...
        /// Creates an instance of a <see cref="Schema"/>.
        /// </summary>
        public void Create(in Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.Source settings = default)
        {
        ...
        internal static void Create<TContext>(
            ...
            in Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.Source<TContext> settings = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
        ...
        /// Creates an instance of a <see cref="Schema"/>.
        /// </summary>
        public void Create<TContext>(in TContext context, in Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.Source<TContext> settings = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.Source settings = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.Source<TContext> settings = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
