...
public readonly partial struct Schema
{
    ...
    public readonly partial struct SettingsEntity
    {
        ...
        public readonly partial struct ConfigurationForDocumentationRulesSa1600
        {
            ...
            public readonly partial struct DocumentExposedElementsEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(DocumentExposedElementsEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="DocumentExposedElementsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator DocumentExposedElementsEntity(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new DocumentExposedElementsEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"DocumentExposedElementsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="DocumentExposedElementsEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="DocumentExposedElementsEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DocumentExposedElementsEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<DocumentExposedElementsEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="DocumentExposedElementsEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DocumentExposedElementsEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<DocumentExposedElementsEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(DocumentExposedElementsEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<DocumentExposedElementsEntity, Mutable>(this);
                }
            }
        }
    }
