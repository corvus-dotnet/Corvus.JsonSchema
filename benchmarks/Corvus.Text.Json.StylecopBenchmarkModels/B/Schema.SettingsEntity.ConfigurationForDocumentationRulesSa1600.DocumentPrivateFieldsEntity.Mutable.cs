        ...
        public readonly partial struct ConfigurationForDocumentationRulesSa1600
        {
            ...
            public readonly partial struct DocumentPrivateFieldsEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(DocumentPrivateFieldsEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="DocumentPrivateFieldsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator DocumentPrivateFieldsEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"DocumentPrivateFieldsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DocumentPrivateFieldsEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DocumentPrivateFieldsEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<DocumentPrivateFieldsEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(DocumentPrivateFieldsEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<DocumentPrivateFieldsEntity, Mutable>(this);
                }
            }
        }
    }
