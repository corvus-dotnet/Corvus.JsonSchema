...
public readonly partial struct Schema
{
    ...
    public readonly partial struct SettingsEntity
    {
        ...
        public readonly partial struct ConfigurationForDocumentationRulesSa1600
        {
            ...
            public readonly partial struct DocumentPrivateFieldsEntity
#if NET8_0_OR_GREATER
                : IJsonElement<DocumentPrivateFieldsEntity>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="DocumentPrivateFieldsEntity"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal DocumentPrivateFieldsEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static DocumentPrivateFieldsEntity DefaultInstance { get; } = ParsedJsonDocument<DocumentPrivateFieldsEntity>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(DocumentPrivateFieldsEntity value)
                {
                ...
                /// </returns>
                public static bool operator ==(in DocumentPrivateFieldsEntity left, in DocumentPrivateFieldsEntity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in DocumentPrivateFieldsEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(DocumentPrivateFieldsEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DocumentPrivateFieldsEntity(JsonElement instance)
                {
                    return DocumentPrivateFieldsEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DocumentPrivateFieldsEntity From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DocumentPrivateFieldsEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<DocumentPrivateFieldsEntity>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DocumentPrivateFieldsEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<DocumentPrivateFieldsEntity>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DocumentPrivateFieldsEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<DocumentPrivateFieldsEntity>(json, options);
                }
                ...
                /// </exception>
                public static DocumentPrivateFieldsEntity ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<DocumentPrivateFieldsEntity>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out DocumentPrivateFieldsEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<DocumentPrivateFieldsEntity>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new DocumentPrivateFieldsEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static DocumentPrivateFieldsEntity IJsonElement<DocumentPrivateFieldsEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DocumentPrivateFieldsEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="DocumentPrivateFieldsEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="DocumentPrivateFieldsEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public DocumentPrivateFieldsEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<DocumentPrivateFieldsEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="DocumentPrivateFieldsEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public DocumentPrivateFieldsEntity Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<DocumentPrivateFieldsEntity>(_idx);
                    }
