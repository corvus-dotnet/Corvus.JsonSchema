        ...
        public readonly partial struct ConfigurationForDocumentationRulesSa1600
        {
            ...
            public readonly partial struct ExcludeFromPunctuationCheckArray
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(ExcludeFromPunctuationCheckArray instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ExcludeFromPunctuationCheckArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ExcludeFromPunctuationCheckArray(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ExcludeFromPunctuationCheckArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    /// <summary>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ExcludeFromPunctuationCheckArray Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ExcludeFromPunctuationCheckArray Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ExcludeFromPunctuationCheckArray>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForDocumentationRulesSa1600.ExcludeFromPunctuationCheckArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(ExcludeFromPunctuationCheckArray instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForDocumentationRulesSa1600.ExcludeFromPunctuationCheckArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
                ...
                {
                    return workspace.CreateBuilder<ExcludeFromPunctuationCheckArray, Mutable>(this);
                }
            }
        }
    }
