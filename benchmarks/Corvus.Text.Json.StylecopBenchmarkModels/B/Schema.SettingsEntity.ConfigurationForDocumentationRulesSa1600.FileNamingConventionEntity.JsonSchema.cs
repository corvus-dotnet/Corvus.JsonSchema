        ...
        public readonly partial struct ConfigurationForDocumentationRulesSa1600
        {
                ...
                : IJsonElement<FileNamingConventionEntity>
            {
                ...
                private static class Constants
                {
                    ...
                    /// </summary>
                    public static readonly byte[] Enum1 = "stylecop"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly FileNamingConventionEntity EnumJson1 = ParsedJsonDocument<FileNamingConventionEntity>.StringConstant([.."\"stylecop\""u8]);
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly byte[] Enum2 = "metadata"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly FileNamingConventionEntity EnumJson2 = ParsedJsonDocument<FileNamingConventionEntity>.StringConstant([.."\"metadata\""u8]);
                }
                ...
                {
                    /// <summary>
                    /// Gets the string "stylecop"
                    /// as a <see cref="FileNamingConventionEntity"/>.
                    /// </summary>
                    public static FileNamingConventionEntity Stylecop { get; } = Constants.EnumJson1;
                    /// <summary>
                    /// Gets the string "stylecop"
                    /// as a UTF8 byte array.
                    /// </summary>
                    public static ReadOnlySpan<byte> StylecopUtf8 => Constants.Enum1;

                    /// <summary>
                    /// Gets the string "metadata"
                    /// as a <see cref="FileNamingConventionEntity"/>.
                    /// </summary>
                    public static FileNamingConventionEntity Metadata { get; } = Constants.EnumJson2;
                    /// <summary>
                    /// Gets the string "metadata"
                    /// as a UTF8 byte array.
                    /// </summary>
                    public static ReadOnlySpan<byte> MetadataUtf8 => Constants.Enum2;
                }
                ...
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://raw.githubusercontent.com/DotNetAnalyzers/StyleCopAnalyzers/master/StyleCop.Analyzers/StyleCop.Analyzers/Settings/stylecop.schema.json#/properties/settings/properties/documentationRules/properties/fileNamingConvention"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "https://raw.githubusercontent.com/DotNetAnalyzers/StyleCopAnalyzers/master/StyleCop.Analyzers/StyleCop.Analyzers/Settings/stylecop.schema.json#/properties/settings/properties/documentationRules/properties/fileNamingConvention";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://raw.githubusercontent.com/DotNetAnalyzers/StyleCopAnalyzers/master/StyleCop.Analyzers/StyleCop.Analyzers/Settings/stylecop.schema.json#/properties/settings/properties/documentationRules/properties/fileNamingConvention"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        else
                        {
                            ...
                            if (unescapedUtf8JsonString.Span.SequenceEqual("stylecop"u8))
                            {
                                goto enumShortCircuitSuccess;
                            }

                            if (unescapedUtf8JsonString.Span.SequenceEqual("metadata"u8))
                            {
                                goto enumShortCircuitSuccess;
                            }
