        ...
        public readonly partial struct ConfigurationForDocumentationRulesSa1600
        {
            ...
            public readonly partial struct FileNamingConventionEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(FileNamingConventionEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="FileNamingConventionEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator FileNamingConventionEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"FileNamingConventionEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly FileNamingConventionEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly FileNamingConventionEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<FileNamingConventionEntity>(_idx);
                    }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(FileNamingConventionEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<FileNamingConventionEntity, Mutable>(this);
                }
            }
        }
    }
