...
public readonly partial struct Schema
{
    ...
    public readonly partial struct SettingsEntity
    {
        ...
        public readonly partial struct ConfigurationForDocumentationRulesSa1600
        {
            ...
            public readonly partial struct FileNamingConventionEntity
#if NET8_0_OR_GREATER
                : IJsonElement<FileNamingConventionEntity>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="FileNamingConventionEntity"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal FileNamingConventionEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static FileNamingConventionEntity DefaultInstance { get; } = ParsedJsonDocument<FileNamingConventionEntity>.StringConstant([.."\"stylecop\""u8]);
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(FileNamingConventionEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in FileNamingConventionEntity left, in FileNamingConventionEntity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in FileNamingConventionEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(FileNamingConventionEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator FileNamingConventionEntity(JsonElement instance)
                {
                    return FileNamingConventionEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static FileNamingConventionEntity From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static FileNamingConventionEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<FileNamingConventionEntity>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static FileNamingConventionEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<FileNamingConventionEntity>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static FileNamingConventionEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<FileNamingConventionEntity>(json, options);
                }
                ...
                /// </exception>
                public static FileNamingConventionEntity ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<FileNamingConventionEntity>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out FileNamingConventionEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<FileNamingConventionEntity>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new FileNamingConventionEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static FileNamingConventionEntity IJsonElement<FileNamingConventionEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"FileNamingConventionEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="FileNamingConventionEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="FileNamingConventionEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public FileNamingConventionEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<FileNamingConventionEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="FileNamingConventionEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public FileNamingConventionEntity Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<FileNamingConventionEntity>(_idx);
                    }
                ...
                /// <param name="matchStylecop">Match 1st item.</param>
                /// <param name="matchMetadata">Match 2nd item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> matchStylecop,
                    Func<TContext, TResult> matchMetadata,
...
#endif
                {
                    ...
                    {
                        return matchStylecop(context);
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchMetadata(context);
                    }
                ...
                public TResult Match<TResult>(
                    Func<TResult> matchStylecop,
                    Func<TResult> matchMetadata,
                    Func<TResult> defaultMatch)
                {
                    if (this.ValueEquals(Constants.Enum1))
                    {
                        return matchStylecop();
                    }
