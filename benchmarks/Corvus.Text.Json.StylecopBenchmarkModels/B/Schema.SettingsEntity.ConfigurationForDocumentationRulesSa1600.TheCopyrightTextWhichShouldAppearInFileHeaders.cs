...
public readonly partial struct Schema
{
    ...
    public readonly partial struct SettingsEntity
    {
        ...
        public readonly partial struct ConfigurationForDocumentationRulesSa1600
        {
            ...
            public readonly partial struct TheCopyrightTextWhichShouldAppearInFileHeaders
#if NET8_0_OR_GREATER
                : IJsonElement<TheCopyrightTextWhichShouldAppearInFileHeaders>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="TheCopyrightTextWhichShouldAppearInFileHeaders"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal TheCopyrightTextWhichShouldAppearInFileHeaders(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static TheCopyrightTextWhichShouldAppearInFileHeaders DefaultInstance { get; } = ParsedJsonDocument<TheCopyrightTextWhichShouldAppearInFileHeaders>.StringConstant([.."\"Copyright (c) {companyName}. All rights reserved.\""u8]);
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(TheCopyrightTextWhichShouldAppearInFileHeaders value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in TheCopyrightTextWhichShouldAppearInFileHeaders left, in TheCopyrightTextWhichShouldAppearInFileHeaders right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in TheCopyrightTextWhichShouldAppearInFileHeaders left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(TheCopyrightTextWhichShouldAppearInFileHeaders instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TheCopyrightTextWhichShouldAppearInFileHeaders(JsonElement instance)
                {
                    return TheCopyrightTextWhichShouldAppearInFileHeaders.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheCopyrightTextWhichShouldAppearInFileHeaders From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheCopyrightTextWhichShouldAppearInFileHeaders ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TheCopyrightTextWhichShouldAppearInFileHeaders>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheCopyrightTextWhichShouldAppearInFileHeaders ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TheCopyrightTextWhichShouldAppearInFileHeaders>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheCopyrightTextWhichShouldAppearInFileHeaders ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TheCopyrightTextWhichShouldAppearInFileHeaders>(json, options);
                }
                ...
                /// </exception>
                public static TheCopyrightTextWhichShouldAppearInFileHeaders ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<TheCopyrightTextWhichShouldAppearInFileHeaders>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out TheCopyrightTextWhichShouldAppearInFileHeaders? result)
                {
                    return JsonElementHelpers.TryParseValue<TheCopyrightTextWhichShouldAppearInFileHeaders>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new TheCopyrightTextWhichShouldAppearInFileHeaders(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static TheCopyrightTextWhichShouldAppearInFileHeaders IJsonElement<TheCopyrightTextWhichShouldAppearInFileHeaders>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TheCopyrightTextWhichShouldAppearInFileHeaders: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="TheCopyrightTextWhichShouldAppearInFileHeaders"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="TheCopyrightTextWhichShouldAppearInFileHeaders"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public TheCopyrightTextWhichShouldAppearInFileHeaders Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<TheCopyrightTextWhichShouldAppearInFileHeaders>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="TheCopyrightTextWhichShouldAppearInFileHeaders"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public TheCopyrightTextWhichShouldAppearInFileHeaders Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<TheCopyrightTextWhichShouldAppearInFileHeaders>(_idx);
                    }
