        ...
        public readonly partial struct ConfigurationForLayoutRulesSa1500
        {
            ...
            public readonly partial struct AllowConsecutiveUsingsEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(AllowConsecutiveUsingsEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="AllowConsecutiveUsingsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator AllowConsecutiveUsingsEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"AllowConsecutiveUsingsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly AllowConsecutiveUsingsEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly AllowConsecutiveUsingsEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<AllowConsecutiveUsingsEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(AllowConsecutiveUsingsEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<AllowConsecutiveUsingsEntity, Mutable>(this);
                }
            }
        }
    }
