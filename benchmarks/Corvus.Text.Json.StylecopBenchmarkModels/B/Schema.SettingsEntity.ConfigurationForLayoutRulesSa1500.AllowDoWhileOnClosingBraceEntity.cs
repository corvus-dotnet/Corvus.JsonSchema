...
public readonly partial struct Schema
{
    ...
    public readonly partial struct SettingsEntity
    {
        ...
        public readonly partial struct ConfigurationForLayoutRulesSa1500
        {
            ...
            public readonly partial struct AllowDoWhileOnClosingBraceEntity
#if NET8_0_OR_GREATER
                : IJsonElement<AllowDoWhileOnClosingBraceEntity>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="AllowDoWhileOnClosingBraceEntity"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal AllowDoWhileOnClosingBraceEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static AllowDoWhileOnClosingBraceEntity DefaultInstance { get; } = ParsedJsonDocument<AllowDoWhileOnClosingBraceEntity>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(AllowDoWhileOnClosingBraceEntity value)
                {
                ...
                /// </returns>
                public static bool operator ==(in AllowDoWhileOnClosingBraceEntity left, in AllowDoWhileOnClosingBraceEntity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in AllowDoWhileOnClosingBraceEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(AllowDoWhileOnClosingBraceEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AllowDoWhileOnClosingBraceEntity(JsonElement instance)
                {
                    return AllowDoWhileOnClosingBraceEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AllowDoWhileOnClosingBraceEntity From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AllowDoWhileOnClosingBraceEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<AllowDoWhileOnClosingBraceEntity>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AllowDoWhileOnClosingBraceEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<AllowDoWhileOnClosingBraceEntity>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AllowDoWhileOnClosingBraceEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<AllowDoWhileOnClosingBraceEntity>(json, options);
                }
                ...
                /// </exception>
                public static AllowDoWhileOnClosingBraceEntity ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<AllowDoWhileOnClosingBraceEntity>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out AllowDoWhileOnClosingBraceEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<AllowDoWhileOnClosingBraceEntity>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new AllowDoWhileOnClosingBraceEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static AllowDoWhileOnClosingBraceEntity IJsonElement<AllowDoWhileOnClosingBraceEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AllowDoWhileOnClosingBraceEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="AllowDoWhileOnClosingBraceEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="AllowDoWhileOnClosingBraceEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public AllowDoWhileOnClosingBraceEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<AllowDoWhileOnClosingBraceEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="AllowDoWhileOnClosingBraceEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public AllowDoWhileOnClosingBraceEntity Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<AllowDoWhileOnClosingBraceEntity>(_idx);
                    }
