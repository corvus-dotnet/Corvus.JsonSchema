        ...
        public readonly partial struct ConfigurationForLayoutRulesSa1500
        {
            ...
            public readonly partial struct NewlineAtEndOfFileEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(NewlineAtEndOfFileEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="NewlineAtEndOfFileEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator NewlineAtEndOfFileEntity(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new NewlineAtEndOfFileEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"NewlineAtEndOfFileEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="NewlineAtEndOfFileEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="NewlineAtEndOfFileEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly NewlineAtEndOfFileEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<NewlineAtEndOfFileEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="NewlineAtEndOfFileEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly NewlineAtEndOfFileEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<NewlineAtEndOfFileEntity>(_idx);
                    }
                    ...
                    /// <param name="matchRequire">Match 2nd item.</param>
                    /// <param name="matchOmit">Match 3rd item.</param>
                    ...
                    public TResult Match<TContext, TResult>(
                        ...
                        Func<TContext, TResult> matchOmit,
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(NewlineAtEndOfFileEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<NewlineAtEndOfFileEntity, Mutable>(this);
                }
            }
        }
    }
