        ...
        public readonly partial struct ConfigurationForNamingRulesSa1300
        {
            ...
            public readonly partial struct AllowCommonHungarianPrefixesEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(AllowCommonHungarianPrefixesEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="AllowCommonHungarianPrefixesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator AllowCommonHungarianPrefixesEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"AllowCommonHungarianPrefixesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly AllowCommonHungarianPrefixesEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly AllowCommonHungarianPrefixesEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<AllowCommonHungarianPrefixesEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(AllowCommonHungarianPrefixesEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<AllowCommonHungarianPrefixesEntity, Mutable>(this);
                }
            }
        }
    }
