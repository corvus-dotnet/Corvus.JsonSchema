            ...
            public readonly partial struct AllowedHungarianPrefixesEntityArray
            {
                    ...
                    : IJsonElement<AllowedHungarianPrefixesEntity>
                {
                    public static partial class JsonSchema
                    {
                        ...
                        /// </summary>
                        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://raw.githubusercontent.com/DotNetAnalyzers/StyleCopAnalyzers/master/StyleCop.Analyzers/StyleCop.Analyzers/Settings/stylecop.schema.json#/properties/settings/properties/namingRules/properties/allowedHungarianPrefixes/items"u8, buffer, out written);

                        /// <summary>
                        /// Gets the schema location from which this type was generated.
                        /// </summary>
                        public const string SchemaLocation = "https://raw.githubusercontent.com/DotNetAnalyzers/StyleCopAnalyzers/master/StyleCop.Analyzers/StyleCop.Analyzers/Settings/stylecop.schema.json#/properties/settings/properties/namingRules/properties/allowedHungarianPrefixes/items";

                        /// <summary>
                        /// Gets the schema location from which this type was generated as a UTF-8 string.
                        /// </summary>
                        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://raw.githubusercontent.com/DotNetAnalyzers/StyleCopAnalyzers/master/StyleCop.Analyzers/StyleCop.Analyzers/Settings/stylecop.schema.json#/properties/settings/properties/namingRules/properties/allowedHungarianPrefixes/items"u8;
                            ...
                            ref JsonSchemaContext context)
                        {
                            ...
                            {
                                context.IgnoredKeyword(JsonSchemaEvaluation.IgnoredNotTypeArray, "uniqueItems"u8);

                                using UnescapedUtf8JsonString unescapedUtf8JsonString = parentDocument.GetUtf8JsonString(parentIndex, JsonTokenType.String);
                                JsonSchemaEvaluation.MatchRegularExpression(unescapedUtf8JsonString.Span, Pattern,"^[a-z]{1,2}$", "pattern"u8, ref context);
                            }
                            ...
                            {
                                bool uniqueItemsHandlerHasUniqueItems = true;
                                using UniqueItemsHashSet uniqueItemsHandlerHashSet = new UniqueItemsHashSet(parentDocument, parentDocument.GetArrayLength(parentIndex), stackalloc int[UniqueItemsHashSet.StackAllocBucketSize], stackalloc byte[UniqueItemsHashSet.StackAllocEntrySize]);
                                ...
                                while (arrayValidation_enumerator.MoveNext())
                                {
                                    ...
                                    if (uniqueItemsHandlerHasUniqueItems && !uniqueItemsHandlerHashSet.AddItemIfNotExists(arrayValidation_currentIndex))
                                    {
                                        uniqueItemsHandlerHasUniqueItems = false;
                                ...
                                context.EvaluatedKeyword(uniqueItemsHandlerHasUniqueItems, messageProvider: JsonSchemaEvaluation.ExpectedUniqueItems, "uniqueItems"u8);
                            }
                        }
...
#else
                        private static Regex CreatePattern() => new("^[a-z]{1,2}$", RegexOptions.Compiled);
#endif
