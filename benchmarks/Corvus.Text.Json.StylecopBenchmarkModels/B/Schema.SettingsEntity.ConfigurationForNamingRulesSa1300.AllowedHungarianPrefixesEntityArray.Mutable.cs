        ...
        public readonly partial struct ConfigurationForNamingRulesSa1300
        {
            ...
            public readonly partial struct AllowedHungarianPrefixesEntityArray
            {
...
#endif
                {
                    ...
                    public Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForNamingRulesSa1300.AllowedHungarianPrefixesEntityArray.AllowedHungarianPrefixesEntity.Mutable this[int index]
                    {
                        get
                        {
                            CheckValidInstance();
                            return _parent.GetArrayIndexElement<Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForNamingRulesSa1300.AllowedHungarianPrefixesEntityArray.AllowedHungarianPrefixesEntity.Mutable>(_idx, index);
                        }
                    }
                    ...
                    /// </summary>
                    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                    public ArrayEnumerator<Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForNamingRulesSa1300.AllowedHungarianPrefixesEntityArray.AllowedHungarianPrefixesEntity.Mutable> EnumerateArray()
                    {
                        CheckValidInstance();
                        return EnumeratorCreator.CreateArrayEnumerator<Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForNamingRulesSa1300.AllowedHungarianPrefixesEntityArray.AllowedHungarianPrefixesEntity.Mutable>(_parent, _idx);
                    }
                    ...
                    /// </remarks>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void SetItem(int itemIndex, in Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForNamingRulesSa1300.AllowedHungarianPrefixesEntityArray.AllowedHungarianPrefixesEntity.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </remarks>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void InsertItem(int itemIndex, in Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForNamingRulesSa1300.AllowedHungarianPrefixesEntityArray.AllowedHungarianPrefixesEntity.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void AddItem(in Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForNamingRulesSa1300.AllowedHungarianPrefixesEntityArray.AllowedHungarianPrefixesEntity.Source value)
                    {
                    ...
                    ///   The parent <see cref="JsonDocument"/> has been disposed.
                    /// </exception>
                    public bool Remove(in Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForNamingRulesSa1300.AllowedHungarianPrefixesEntityArray.AllowedHungarianPrefixesEntity item)
                    {
                        CheckValidInstance();
                        if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForNamingRulesSa1300.AllowedHungarianPrefixesEntityArray.AllowedHungarianPrefixesEntity>(this, in item))
                        {
                            return false;
                        }
                    ...
                    /// </remarks>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void RemoveWhere(JsonPredicate<Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForNamingRulesSa1300.AllowedHungarianPrefixesEntityArray.AllowedHungarianPrefixesEntity> predicate)
                    {
                        CheckValidInstance();
                        JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForNamingRulesSa1300.AllowedHungarianPrefixesEntityArray.AllowedHungarianPrefixesEntity>(this, predicate);
                        _documentVersion = _parent.Version;
                    }
                    ...
                    public bool Replace(in Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForNamingRulesSa1300.AllowedHungarianPrefixesEntityArray.AllowedHungarianPrefixesEntity oldItem, in Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForNamingRulesSa1300.AllowedHungarianPrefixesEntityArray.AllowedHungarianPrefixesEntity.Source newItem)
                    {
                        ...
                        var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForNamingRulesSa1300.AllowedHungarianPrefixesEntityArray.AllowedHungarianPrefixesEntity>(_parent, _idx);

                        while (enumerator.MoveNext())
                        {
                            Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForNamingRulesSa1300.AllowedHungarianPrefixesEntityArray.AllowedHungarianPrefixesEntity current = enumerator.Current;
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForNamingRulesSa1300.AllowedHungarianPrefixesEntityArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForNamingRulesSa1300.AllowedHungarianPrefixesEntityArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
