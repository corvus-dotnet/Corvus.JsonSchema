        ...
        public readonly partial struct ConfigurationForNamingRulesSa1300
        {
            ...
            public readonly partial struct IncludeInferredTupleElementNamesEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(IncludeInferredTupleElementNamesEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="IncludeInferredTupleElementNamesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator IncludeInferredTupleElementNamesEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"IncludeInferredTupleElementNamesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly IncludeInferredTupleElementNamesEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly IncludeInferredTupleElementNamesEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<IncludeInferredTupleElementNamesEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(IncludeInferredTupleElementNamesEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<IncludeInferredTupleElementNamesEntity, Mutable>(this);
                }
            }
        }
    }
