        ...
        public readonly partial struct ConfigurationForOrderingRulesSa1200
        {
            ...
            public readonly partial struct BlankLinesBetweenUsingGroupsEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(BlankLinesBetweenUsingGroupsEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="BlankLinesBetweenUsingGroupsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator BlankLinesBetweenUsingGroupsEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"BlankLinesBetweenUsingGroupsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly BlankLinesBetweenUsingGroupsEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly BlankLinesBetweenUsingGroupsEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<BlankLinesBetweenUsingGroupsEntity>(_idx);
                    }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(BlankLinesBetweenUsingGroupsEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<BlankLinesBetweenUsingGroupsEntity, Mutable>(this);
                }
            }
        }
    }
