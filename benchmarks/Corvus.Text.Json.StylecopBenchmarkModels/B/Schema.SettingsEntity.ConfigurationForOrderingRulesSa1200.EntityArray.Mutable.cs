        ...
        public readonly partial struct ConfigurationForOrderingRulesSa1200
        {
            ...
            public readonly partial struct EntityArray
            {
...
#endif
                {
                    ...
                    public Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForOrderingRulesSa1200.EntityArray.Entity.Mutable this[int index]
                    {
                        get
                        {
                            CheckValidInstance();
                            return _parent.GetArrayIndexElement<Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForOrderingRulesSa1200.EntityArray.Entity.Mutable>(_idx, index);
                        }
                    }
                    ...
                    /// </summary>
                    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                    public ArrayEnumerator<Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForOrderingRulesSa1200.EntityArray.Entity.Mutable> EnumerateArray()
                    {
                        CheckValidInstance();
                        return EnumeratorCreator.CreateArrayEnumerator<Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForOrderingRulesSa1200.EntityArray.Entity.Mutable>(_parent, _idx);
                    }
                    ...
                    /// </remarks>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void SetItem(int itemIndex, in Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForOrderingRulesSa1200.EntityArray.Entity.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </remarks>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void InsertItem(int itemIndex, in Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForOrderingRulesSa1200.EntityArray.Entity.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void AddItem(in Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForOrderingRulesSa1200.EntityArray.Entity.Source value)
                    {
                    ...
                    ///   The parent <see cref="JsonDocument"/> has been disposed.
                    /// </exception>
                    public bool Remove(in Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForOrderingRulesSa1200.EntityArray.Entity item)
                    {
                        CheckValidInstance();
                        if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForOrderingRulesSa1200.EntityArray.Entity>(this, in item))
                        {
                            return false;
                        }
                    ...
                    /// </remarks>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void RemoveWhere(JsonPredicate<Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForOrderingRulesSa1200.EntityArray.Entity> predicate)
                    {
                        CheckValidInstance();
                        JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForOrderingRulesSa1200.EntityArray.Entity>(this, predicate);
                        _documentVersion = _parent.Version;
                    }
                    ...
                    ///   The parent <see cref="JsonDocument"/> has been disposed.
                    /// </exception>
                    public bool Replace(in Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForOrderingRulesSa1200.EntityArray.Entity oldItem, in Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForOrderingRulesSa1200.EntityArray.Entity.Source newItem)
                    {
                        CheckValidInstance();
                        ...
                        var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForOrderingRulesSa1200.EntityArray.Entity>(_parent, _idx);

                        while (enumerator.MoveNext())
                        {
                            Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForOrderingRulesSa1200.EntityArray.Entity current = enumerator.Current;
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForOrderingRulesSa1200.EntityArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForOrderingRulesSa1200.EntityArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
