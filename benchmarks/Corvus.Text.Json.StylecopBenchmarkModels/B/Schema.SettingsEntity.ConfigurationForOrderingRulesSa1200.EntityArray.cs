    ...
    public readonly partial struct SettingsEntity
    {
        ...
        public readonly partial struct ConfigurationForOrderingRulesSa1200
        {
...
#endif
            {
                ...
                public Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForOrderingRulesSa1200.EntityArray.Entity this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForOrderingRulesSa1200.EntityArray.Entity>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForOrderingRulesSa1200.EntityArray.Entity> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForOrderingRulesSa1200.EntityArray.Entity>(_parent, _idx);
                }
