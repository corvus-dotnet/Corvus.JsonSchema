        ...
        public readonly partial struct ConfigurationForOrderingRulesSa1200
        {
            ...
            public readonly partial struct SystemUsingDirectivesFirstEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(SystemUsingDirectivesFirstEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="SystemUsingDirectivesFirstEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator SystemUsingDirectivesFirstEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"SystemUsingDirectivesFirstEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly SystemUsingDirectivesFirstEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly SystemUsingDirectivesFirstEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<SystemUsingDirectivesFirstEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(SystemUsingDirectivesFirstEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<SystemUsingDirectivesFirstEntity, Mutable>(this);
                }
            }
        }
    }
