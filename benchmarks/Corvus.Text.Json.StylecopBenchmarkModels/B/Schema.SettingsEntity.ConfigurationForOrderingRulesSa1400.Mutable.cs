    ...
    public readonly partial struct SettingsEntity
    {
        ...
        public readonly partial struct ConfigurationForOrderingRulesSa1400
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForOrderingRulesSa1400.TopLevelTypesEntityArray.Mutable TopLevelTypes
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TopLevelTypesUtf8, out Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForOrderingRulesSa1400.TopLevelTypesEntityArray.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetTopLevelTypes(in Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForOrderingRulesSa1400.TopLevelTypesEntityArray.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetTopLevelTypes<TContext>(in Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForOrderingRulesSa1400.TopLevelTypesEntityArray.Source<TContext> value)
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForOrderingRulesSa1400.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForOrderingRulesSa1400.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForOrderingRulesSa1400.TopLevelTypesEntityArray.Source topLevelTypes = default)
                {
                ...
                /// Creates an instance of a <see cref="ConfigurationForOrderingRulesSa1400"/>.
                /// </summary>
                public void Create(in Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForOrderingRulesSa1400.TopLevelTypesEntityArray.Source topLevelTypes = default)
                {
                ...
                internal static void Create<TContext>(
                    ...
                    in Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForOrderingRulesSa1400.TopLevelTypesEntityArray.Source<TContext> topLevelTypes = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
                ...
                /// Creates an instance of a <see cref="ConfigurationForOrderingRulesSa1400"/>.
                /// </summary>
                public void Create<TContext>(in TContext context, in Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForOrderingRulesSa1400.TopLevelTypesEntityArray.Source<TContext> topLevelTypes = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForOrderingRulesSa1400.TopLevelTypesEntityArray.Source topLevelTypes = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForOrderingRulesSa1400.TopLevelTypesEntityArray.Source<TContext> topLevelTypes = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
