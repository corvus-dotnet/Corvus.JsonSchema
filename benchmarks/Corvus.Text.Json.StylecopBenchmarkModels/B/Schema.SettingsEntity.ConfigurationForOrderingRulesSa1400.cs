...
public readonly partial struct Schema
{
    ...
    public readonly partial struct SettingsEntity
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ConfigurationForOrderingRulesSa1400"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ConfigurationForOrderingRulesSa1400(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ConfigurationForOrderingRulesSa1400 DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForOrderingRulesSa1400.TopLevelTypesEntityArray TopLevelTypes
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TopLevelTypesUtf8, out Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForOrderingRulesSa1400.TopLevelTypesEntityArray value))
                    {
                        return value;
                    }

                    return Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForOrderingRulesSa1400.TopLevelTypesEntityArray.DefaultInstance;
                }
            }
            ...
            /// </returns>
            public static bool operator ==(in ConfigurationForOrderingRulesSa1400 left, in ConfigurationForOrderingRulesSa1400 right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ConfigurationForOrderingRulesSa1400 left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(ConfigurationForOrderingRulesSa1400 instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ConfigurationForOrderingRulesSa1400(JsonElement instance)
            {
                return ConfigurationForOrderingRulesSa1400.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ConfigurationForOrderingRulesSa1400 From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ConfigurationForOrderingRulesSa1400 ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ConfigurationForOrderingRulesSa1400>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ConfigurationForOrderingRulesSa1400 ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ConfigurationForOrderingRulesSa1400>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ConfigurationForOrderingRulesSa1400 ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ConfigurationForOrderingRulesSa1400>(json, options);
            }
            ...
            /// </exception>
            public static ConfigurationForOrderingRulesSa1400 ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ConfigurationForOrderingRulesSa1400>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ConfigurationForOrderingRulesSa1400? result)
            {
                return JsonElementHelpers.TryParseValue<ConfigurationForOrderingRulesSa1400>(ref reader, out result);
            }
...
#if NET
            static ConfigurationForOrderingRulesSa1400 IJsonElement<ConfigurationForOrderingRulesSa1400>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ConfigurationForOrderingRulesSa1400: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public ConfigurationForOrderingRulesSa1400 Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public ConfigurationForOrderingRulesSa1400 Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ConfigurationForOrderingRulesSa1400>(_idx);
                }
            ...
            {
                /// <summary>
                /// Gets the JSON property name for <see cref="TopLevelTypes"/>.
                /// </summary>
                public const string TopLevelTypes = "topLevelTypes";

                /// <summary>
                /// Gets the JSON property name for <see cref="TopLevelTypes"/>.
                /// </summary>
                public static ReadOnlySpan<byte> TopLevelTypesUtf8 => "topLevelTypes"u8;
            }
            ...
            {
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="TopLevelTypes"/>.
                /// </summary>
                public static ReadOnlySpan<byte> TopLevelTypes => "topLevelTypes"u8;
            }
        }
    }
}
