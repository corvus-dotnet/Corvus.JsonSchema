...
public readonly partial struct Schema
{
    ...
    public readonly partial struct SettingsEntity
    {
        ...
        public readonly partial struct ConfigurationForReadabilityRulesSa1100
        {
            ...
            public readonly partial struct AllowBuiltInTypeAliasesEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(AllowBuiltInTypeAliasesEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="AllowBuiltInTypeAliasesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator AllowBuiltInTypeAliasesEntity(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new AllowBuiltInTypeAliasesEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"AllowBuiltInTypeAliasesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="AllowBuiltInTypeAliasesEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="AllowBuiltInTypeAliasesEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly AllowBuiltInTypeAliasesEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<AllowBuiltInTypeAliasesEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="AllowBuiltInTypeAliasesEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly AllowBuiltInTypeAliasesEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<AllowBuiltInTypeAliasesEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(AllowBuiltInTypeAliasesEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<AllowBuiltInTypeAliasesEntity, Mutable>(this);
                }
            }
        }
    }
