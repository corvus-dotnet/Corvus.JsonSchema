    ...
    public readonly partial struct SettingsEntity
    {
        ...
        public readonly partial struct ConfigurationForReadabilityRulesSa1100
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="AllowBuiltInTypeAliasesEntity"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal AllowBuiltInTypeAliasesEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static AllowBuiltInTypeAliasesEntity DefaultInstance { get; } = ParsedJsonDocument<AllowBuiltInTypeAliasesEntity>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(AllowBuiltInTypeAliasesEntity value)
                {
                ...
                /// </returns>
                public static bool operator ==(in AllowBuiltInTypeAliasesEntity left, in AllowBuiltInTypeAliasesEntity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in AllowBuiltInTypeAliasesEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(AllowBuiltInTypeAliasesEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AllowBuiltInTypeAliasesEntity(JsonElement instance)
                {
                    return AllowBuiltInTypeAliasesEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AllowBuiltInTypeAliasesEntity From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AllowBuiltInTypeAliasesEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<AllowBuiltInTypeAliasesEntity>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AllowBuiltInTypeAliasesEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<AllowBuiltInTypeAliasesEntity>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AllowBuiltInTypeAliasesEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<AllowBuiltInTypeAliasesEntity>(json, options);
                }
                ...
                /// </exception>
                public static AllowBuiltInTypeAliasesEntity ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<AllowBuiltInTypeAliasesEntity>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out AllowBuiltInTypeAliasesEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<AllowBuiltInTypeAliasesEntity>(ref reader, out result);
                }
...
#if NET
                static AllowBuiltInTypeAliasesEntity IJsonElement<AllowBuiltInTypeAliasesEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AllowBuiltInTypeAliasesEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public AllowBuiltInTypeAliasesEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public AllowBuiltInTypeAliasesEntity Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<AllowBuiltInTypeAliasesEntity>(_idx);
                    }
