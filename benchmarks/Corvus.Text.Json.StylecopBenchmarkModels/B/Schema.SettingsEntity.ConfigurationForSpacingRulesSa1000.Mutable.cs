...
public readonly partial struct Schema
{
    ...
    public readonly partial struct SettingsEntity
    {
        ...
        public readonly partial struct ConfigurationForSpacingRulesSa1000
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ConfigurationForSpacingRulesSa1000 instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ConfigurationForSpacingRulesSa1000"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ConfigurationForSpacingRulesSa1000(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ConfigurationForSpacingRulesSa1000(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ConfigurationForSpacingRulesSa1000.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ConfigurationForSpacingRulesSa1000"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ConfigurationForSpacingRulesSa1000"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ConfigurationForSpacingRulesSa1000 Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ConfigurationForSpacingRulesSa1000>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ConfigurationForSpacingRulesSa1000"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ConfigurationForSpacingRulesSa1000 Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ConfigurationForSpacingRulesSa1000>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForSpacingRulesSa1000.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(ConfigurationForSpacingRulesSa1000 instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.ConfigurationForSpacingRulesSa1000.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<ConfigurationForSpacingRulesSa1000, Mutable>(this);
            }
        }
    }
}
