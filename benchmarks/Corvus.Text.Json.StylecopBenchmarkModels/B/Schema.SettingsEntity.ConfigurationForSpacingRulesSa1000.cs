...
public readonly partial struct Schema
{
    ...
    public readonly partial struct SettingsEntity
    {
        ...
        public readonly partial struct ConfigurationForSpacingRulesSa1000
            ...
            : IJsonElement<ConfigurationForSpacingRulesSa1000>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ConfigurationForSpacingRulesSa1000"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ConfigurationForSpacingRulesSa1000(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ConfigurationForSpacingRulesSa1000 DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in ConfigurationForSpacingRulesSa1000 left, in ConfigurationForSpacingRulesSa1000 right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ConfigurationForSpacingRulesSa1000 left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(ConfigurationForSpacingRulesSa1000 instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ConfigurationForSpacingRulesSa1000(JsonElement instance)
            {
                return ConfigurationForSpacingRulesSa1000.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ConfigurationForSpacingRulesSa1000 From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ConfigurationForSpacingRulesSa1000 ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ConfigurationForSpacingRulesSa1000>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ConfigurationForSpacingRulesSa1000 ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ConfigurationForSpacingRulesSa1000>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ConfigurationForSpacingRulesSa1000 ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ConfigurationForSpacingRulesSa1000>(json, options);
            }
            ...
            /// </exception>
            public static ConfigurationForSpacingRulesSa1000 ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ConfigurationForSpacingRulesSa1000>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ConfigurationForSpacingRulesSa1000? result)
            {
                return JsonElementHelpers.TryParseValue<ConfigurationForSpacingRulesSa1000>(ref reader, out result);
            }
...
#if NET
            static ConfigurationForSpacingRulesSa1000 IJsonElement<ConfigurationForSpacingRulesSa1000>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ConfigurationForSpacingRulesSa1000: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public ConfigurationForSpacingRulesSa1000 Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public ConfigurationForSpacingRulesSa1000 Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ConfigurationForSpacingRulesSa1000>(_idx);
                }
