    ...
    public readonly partial struct SettingsEntity
    {
        ...
        public readonly partial struct IndentationConfiguration
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(IndentationConfiguration instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="IndentationConfiguration"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator IndentationConfiguration(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.IndentationConfiguration.SpecifiesTheIndentationSize.Mutable IndentationSize
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IndentationSizeUtf8, out Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.IndentationConfiguration.SpecifiesTheIndentationSize.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.IndentationConfiguration.SpecifiesTheTabWidth.Mutable TabSize
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TabSizeUtf8, out Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.IndentationConfiguration.SpecifiesTheTabWidth.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.IndentationConfiguration.UseTabsEntity.Mutable UseTabs
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UseTabsUtf8, out Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.IndentationConfiguration.UseTabsEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetIndentationSize(in Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.IndentationConfiguration.SpecifiesTheIndentationSize.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetTabSize(in Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.IndentationConfiguration.SpecifiesTheTabWidth.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetUseTabs(in Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.IndentationConfiguration.UseTabsEntity.Source value)
                {
                    CheckValidInstance();
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"IndentationConfiguration.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly IndentationConfiguration Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly IndentationConfiguration Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<IndentationConfiguration>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.IndentationConfiguration.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.IndentationConfiguration.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="IndentationConfiguration"/>.
                /// </summary>
                internal static void Create(
                    ref ComplexValueBuilder builder,
                    in Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.IndentationConfiguration.SpecifiesTheIndentationSize.Source indentationSize = default,
                    in Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.IndentationConfiguration.SpecifiesTheTabWidth.Source tabSize = default,
                    in Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.IndentationConfiguration.UseTabsEntity.Source useTabs = default)
                {
                ...
                public void Create(
                    ...
                    in Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.IndentationConfiguration.UseTabsEntity.Source useTabs = default)
                {
                    Create(ref _builder, indentationSize, tabSize, useTabs);
                }
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.IndentationConfiguration.SpecifiesTheIndentationSize.Source indentationSize = default, in Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.IndentationConfiguration.SpecifiesTheTabWidth.Source tabSize = default, in Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity.IndentationConfiguration.UseTabsEntity.Source useTabs = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(indentationSize, tabSize, useTabs);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<IndentationConfiguration, Mutable>(this);
            }
        }
    }
}
