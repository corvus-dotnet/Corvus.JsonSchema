    ...
    public readonly partial struct SettingsEntity
    {
        ...
        public readonly partial struct IndentationConfiguration
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="SpecifiesTheTabWidth"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal SpecifiesTheTabWidth(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static SpecifiesTheTabWidth DefaultInstance { get; } = ParsedJsonDocument<SpecifiesTheTabWidth>.NumberConstant([.."4"u8]);
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator long(SpecifiesTheTabWidth value) => value._parent.TryGetValue(value._idx, out long result) ? result : throw new FormatException();

                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator double(SpecifiesTheTabWidth value) => value._parent.TryGetValue(value._idx, out double result) ? result : throw new FormatException();

                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator Corvus.Numerics.BigNumber(SpecifiesTheTabWidth value) => value._parent.TryGetValue(value._idx, out Corvus.Numerics.BigNumber result) ? result : throw new FormatException();

                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator System.Numerics.BigInteger(SpecifiesTheTabWidth value) => value._parent.TryGetValue(value._idx, out System.Numerics.BigInteger result) ? result : throw new FormatException();

                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator decimal(SpecifiesTheTabWidth value) => value._parent.TryGetValue(value._idx, out decimal result) ? result : throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in SpecifiesTheTabWidth left, in SpecifiesTheTabWidth right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in SpecifiesTheTabWidth left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(SpecifiesTheTabWidth instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SpecifiesTheTabWidth(JsonElement instance)
                {
                    return SpecifiesTheTabWidth.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SpecifiesTheTabWidth From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SpecifiesTheTabWidth ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<SpecifiesTheTabWidth>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SpecifiesTheTabWidth ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<SpecifiesTheTabWidth>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SpecifiesTheTabWidth ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<SpecifiesTheTabWidth>(json, options);
                }
                ...
                /// </exception>
                public static SpecifiesTheTabWidth ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<SpecifiesTheTabWidth>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out SpecifiesTheTabWidth? result)
                {
                    return JsonElementHelpers.TryParseValue<SpecifiesTheTabWidth>(ref reader, out result);
                }
...
#if NET
                static SpecifiesTheTabWidth IJsonElement<SpecifiesTheTabWidth>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SpecifiesTheTabWidth: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public SpecifiesTheTabWidth Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public SpecifiesTheTabWidth Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<SpecifiesTheTabWidth>(_idx);
                    }
