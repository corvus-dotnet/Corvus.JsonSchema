...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity Settings
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SettingsUtf8, out Corvus.StylecopBenchmark.Baseline.Schema.SettingsEntity value))
            {
                return value;
            }
