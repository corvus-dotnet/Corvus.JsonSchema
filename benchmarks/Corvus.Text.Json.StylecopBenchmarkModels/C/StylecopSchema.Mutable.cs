...
public readonly partial struct StylecopSchema
{
...
#endif
    {
        ...
        public void SetSettings(in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        internal Source(in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.Source arg1)
        {
            _createArg1 = arg1;
            _kind = Kind.Create;
        }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.Source<TContext> arg1)
        {
            _context = context;
            _createArg1 = arg1;
            _kind = Kind.Create;
    ...
    public ref struct Builder
    {
        ...
        internal static void BuildCreateValue(in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.Source arg1, ref ComplexValueBuilder o)
        {
            o.StartObject();
            Create(ref o, arg1);
            o.EndObject();
        ...
        /// <param name="arg1">The value of the property.</param>
        /// <param name="o">The complex value builder into which to write the object.</param>
        internal static void BuildCreateValue<TContext>(scoped in TContext context, in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.Source<TContext> arg1, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.Source settings = default)
    {
    ...
    /// <param name="settings">The value of the <c>"settings"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.Source<TContext> settings = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
