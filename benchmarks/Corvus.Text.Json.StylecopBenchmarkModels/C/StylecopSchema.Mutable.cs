...
public readonly partial struct StylecopSchema
{
...
#endif
    {
        ...
        public static explicit operator Mutable(StylecopSchema instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="StylecopSchema"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator StylecopSchema(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.Mutable Settings
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SettingsUtf8, out Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.Mutable value))
                {
                    return value;
                }
        ...
        public void SetSettings(scoped in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetSettings<TContext>(in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.Source<TContext> value)
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"StylecopSchema.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly StylecopSchema Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly StylecopSchema Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<StylecopSchema>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.Source _createArg1;
        ...
        internal Source(Corvus.StylecopBenchmark.Current.StylecopSchema.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.Source arg1)
        {
            _createArg1 = arg1;
            _kind = Kind.Create;
        }

        public static implicit operator Source(StylecopSchema instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        private readonly Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.Source<TContext> _createArg1;
        ...
        internal Source(scoped in TContext context, Corvus.StylecopBenchmark.Current.StylecopSchema.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in TContext context, scoped in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.Source<TContext> arg1)
        {
            _context = context;
            _createArg1 = arg1;
            _kind = Kind.Create;
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="StylecopSchema"/>.
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.Source settings = default)
        {
        ...
        /// Creates an instance of a <see cref="StylecopSchema"/>.
        /// </summary>
        public void Create(in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.Source settings = default)
        {
        ...
        internal static void Create<TContext>(
            ...
            in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.Source<TContext> settings = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
        ...
        /// Creates an instance of a <see cref="StylecopSchema"/>.
        /// </summary>
        public void Create<TContext>(in TContext context, in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.Source<TContext> settings = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
        ...
        internal static void BuildCreateValue(scoped in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.Source arg1, ref ComplexValueBuilder o)
        {
            o.StartObject();
            Create(ref o, arg1);
            o.EndObject();
        ...
        /// <param name="arg1">The value of the property.</param>
        /// <param name="o">The complex value builder into which to write the object.</param>
        internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.Source<TContext> arg1, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.Source settings = default)
    {
    ...
    /// <param name="settings">The value of the <c>"settings"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.Source<TContext> settings = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.Source settings = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.Source<TContext> settings = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
    ...
    {
        return workspace.CreateBuilder<StylecopSchema, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<StylecopSchema> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<StylecopSchema>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<StylecopSchema> Create<TContext>(
    ...
    public static ParsedJsonDocument<StylecopSchema> Create(in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.Source settings = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<StylecopSchema> Create<TContext>(in TContext context, in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.Source<TContext> settings = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
