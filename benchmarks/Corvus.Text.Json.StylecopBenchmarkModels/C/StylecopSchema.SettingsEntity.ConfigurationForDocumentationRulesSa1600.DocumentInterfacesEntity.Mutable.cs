...
public readonly partial struct StylecopSchema
{
    ...
    public readonly partial struct SettingsEntity
    {
        ...
        public readonly partial struct ConfigurationForDocumentationRulesSa1600
        {
            ...
            public readonly partial struct DocumentInterfacesEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DocumentInterfacesEntity, Mutable>(DocumentInterfacesEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(DocumentInterfacesEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="DocumentInterfacesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator DocumentInterfacesEntity(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new DocumentInterfacesEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"DocumentInterfacesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="DocumentInterfacesEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="DocumentInterfacesEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DocumentInterfacesEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<DocumentInterfacesEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="DocumentInterfacesEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DocumentInterfacesEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<DocumentInterfacesEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(DocumentInterfacesEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<DocumentInterfacesEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<DocumentInterfacesEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<DocumentInterfacesEntity>();
                    }
                    finally
                    {
