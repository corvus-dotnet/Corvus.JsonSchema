...
public readonly partial struct StylecopSchema
{
    ...
    public readonly partial struct SettingsEntity
    {
        ...
        public readonly partial struct ConfigurationForDocumentationRulesSa1600
        {
            ...
            public readonly partial struct ExcludeFromPunctuationCheckArray
#if NET8_0_OR_GREATER
                : IJsonElement<ExcludeFromPunctuationCheckArray>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="ExcludeFromPunctuationCheckArray"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal ExcludeFromPunctuationCheckArray(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </returns>
                public static bool operator ==(in ExcludeFromPunctuationCheckArray left, in ExcludeFromPunctuationCheckArray right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in ExcludeFromPunctuationCheckArray left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(ExcludeFromPunctuationCheckArray instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ExcludeFromPunctuationCheckArray(JsonElement instance)
                {
                    return ExcludeFromPunctuationCheckArray.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ExcludeFromPunctuationCheckArray From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ExcludeFromPunctuationCheckArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ExcludeFromPunctuationCheckArray>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ExcludeFromPunctuationCheckArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ExcludeFromPunctuationCheckArray>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ExcludeFromPunctuationCheckArray ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ExcludeFromPunctuationCheckArray>(json, options);
                }
                ...
                /// </exception>
                public static ExcludeFromPunctuationCheckArray ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<ExcludeFromPunctuationCheckArray>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out ExcludeFromPunctuationCheckArray? result)
                {
                    return JsonElementHelpers.TryParseValue<ExcludeFromPunctuationCheckArray>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ExcludeFromPunctuationCheckArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static ExcludeFromPunctuationCheckArray IJsonElement<ExcludeFromPunctuationCheckArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ExcludeFromPunctuationCheckArray: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ExcludeFromPunctuationCheckArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ExcludeFromPunctuationCheckArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public ExcludeFromPunctuationCheckArray Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ExcludeFromPunctuationCheckArray>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ExcludeFromPunctuationCheckArray"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public ExcludeFromPunctuationCheckArray Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<ExcludeFromPunctuationCheckArray>(_idx);
                    }
