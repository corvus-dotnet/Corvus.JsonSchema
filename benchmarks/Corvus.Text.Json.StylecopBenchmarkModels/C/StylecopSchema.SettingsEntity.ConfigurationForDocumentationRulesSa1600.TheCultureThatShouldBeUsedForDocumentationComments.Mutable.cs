        ...
        public readonly partial struct ConfigurationForDocumentationRulesSa1600
        {
            ...
            public readonly partial struct TheCultureThatShouldBeUsedForDocumentationComments
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<TheCultureThatShouldBeUsedForDocumentationComments, Mutable>(TheCultureThatShouldBeUsedForDocumentationComments.DefaultInstance);
                    ...
                    public static explicit operator Mutable(TheCultureThatShouldBeUsedForDocumentationComments instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="TheCultureThatShouldBeUsedForDocumentationComments"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator TheCultureThatShouldBeUsedForDocumentationComments(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"TheCultureThatShouldBeUsedForDocumentationComments.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly TheCultureThatShouldBeUsedForDocumentationComments Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly TheCultureThatShouldBeUsedForDocumentationComments Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<TheCultureThatShouldBeUsedForDocumentationComments>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(TheCultureThatShouldBeUsedForDocumentationComments instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<TheCultureThatShouldBeUsedForDocumentationComments, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<TheCultureThatShouldBeUsedForDocumentationComments> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<TheCultureThatShouldBeUsedForDocumentationComments>();
                    }
                    finally
                    {
