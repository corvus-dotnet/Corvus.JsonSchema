...
public readonly partial struct StylecopSchema
{
    ...
    public readonly partial struct SettingsEntity
    {
        ...
        public readonly partial struct ConfigurationForDocumentationRulesSa1600
        {
            ...
            public readonly partial struct TheCultureThatShouldBeUsedForDocumentationComments
#if NET8_0_OR_GREATER
                : IJsonElement<TheCultureThatShouldBeUsedForDocumentationComments>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="TheCultureThatShouldBeUsedForDocumentationComments"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal TheCultureThatShouldBeUsedForDocumentationComments(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static TheCultureThatShouldBeUsedForDocumentationComments DefaultInstance { get; } = ParsedJsonDocument<TheCultureThatShouldBeUsedForDocumentationComments>.StringConstant([.."\"en-US\""u8]);
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(TheCultureThatShouldBeUsedForDocumentationComments value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in TheCultureThatShouldBeUsedForDocumentationComments left, in TheCultureThatShouldBeUsedForDocumentationComments right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in TheCultureThatShouldBeUsedForDocumentationComments left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(TheCultureThatShouldBeUsedForDocumentationComments instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TheCultureThatShouldBeUsedForDocumentationComments(JsonElement instance)
                {
                    return TheCultureThatShouldBeUsedForDocumentationComments.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheCultureThatShouldBeUsedForDocumentationComments From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheCultureThatShouldBeUsedForDocumentationComments ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TheCultureThatShouldBeUsedForDocumentationComments>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheCultureThatShouldBeUsedForDocumentationComments ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TheCultureThatShouldBeUsedForDocumentationComments>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheCultureThatShouldBeUsedForDocumentationComments ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TheCultureThatShouldBeUsedForDocumentationComments>(json, options);
                }
                ...
                /// </exception>
                public static TheCultureThatShouldBeUsedForDocumentationComments ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<TheCultureThatShouldBeUsedForDocumentationComments>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out TheCultureThatShouldBeUsedForDocumentationComments? result)
                {
                    return JsonElementHelpers.TryParseValue<TheCultureThatShouldBeUsedForDocumentationComments>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new TheCultureThatShouldBeUsedForDocumentationComments(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static TheCultureThatShouldBeUsedForDocumentationComments IJsonElement<TheCultureThatShouldBeUsedForDocumentationComments>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TheCultureThatShouldBeUsedForDocumentationComments: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="TheCultureThatShouldBeUsedForDocumentationComments"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="TheCultureThatShouldBeUsedForDocumentationComments"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public TheCultureThatShouldBeUsedForDocumentationComments Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<TheCultureThatShouldBeUsedForDocumentationComments>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="TheCultureThatShouldBeUsedForDocumentationComments"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public TheCultureThatShouldBeUsedForDocumentationComments Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<TheCultureThatShouldBeUsedForDocumentationComments>(_idx);
                    }
