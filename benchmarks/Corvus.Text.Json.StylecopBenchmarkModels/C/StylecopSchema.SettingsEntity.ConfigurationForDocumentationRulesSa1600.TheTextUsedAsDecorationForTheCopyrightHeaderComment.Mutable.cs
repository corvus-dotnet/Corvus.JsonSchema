    ...
    public readonly partial struct SettingsEntity
    {
        ...
        public readonly partial struct ConfigurationForDocumentationRulesSa1600
        {
            ...
            public readonly partial struct TheTextUsedAsDecorationForTheCopyrightHeaderComment
            {
                ...
                public static ParsedJsonDocument<TheTextUsedAsDecorationForTheCopyrightHeaderComment> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<TheTextUsedAsDecorationForTheCopyrightHeaderComment>();
                    }
                    finally
                    {
