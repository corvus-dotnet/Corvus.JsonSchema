...
public readonly partial struct StylecopSchema
{
    ...
    public readonly partial struct SettingsEntity
    {
        ...
        public readonly partial struct ConfigurationForDocumentationRulesSa1600
        {
            ...
            public readonly partial struct TheTextUsedAsDecorationForTheCopyrightHeaderComment
#if NET8_0_OR_GREATER
                : IJsonElement<TheTextUsedAsDecorationForTheCopyrightHeaderComment>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="TheTextUsedAsDecorationForTheCopyrightHeaderComment"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal TheTextUsedAsDecorationForTheCopyrightHeaderComment(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static TheTextUsedAsDecorationForTheCopyrightHeaderComment DefaultInstance { get; } = ParsedJsonDocument<TheTextUsedAsDecorationForTheCopyrightHeaderComment>.Null;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(TheTextUsedAsDecorationForTheCopyrightHeaderComment value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in TheTextUsedAsDecorationForTheCopyrightHeaderComment left, in TheTextUsedAsDecorationForTheCopyrightHeaderComment right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in TheTextUsedAsDecorationForTheCopyrightHeaderComment left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(TheTextUsedAsDecorationForTheCopyrightHeaderComment instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TheTextUsedAsDecorationForTheCopyrightHeaderComment(JsonElement instance)
                {
                    return TheTextUsedAsDecorationForTheCopyrightHeaderComment.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheTextUsedAsDecorationForTheCopyrightHeaderComment From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheTextUsedAsDecorationForTheCopyrightHeaderComment ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TheTextUsedAsDecorationForTheCopyrightHeaderComment>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheTextUsedAsDecorationForTheCopyrightHeaderComment ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TheTextUsedAsDecorationForTheCopyrightHeaderComment>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheTextUsedAsDecorationForTheCopyrightHeaderComment ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TheTextUsedAsDecorationForTheCopyrightHeaderComment>(json, options);
                }
                ...
                /// </exception>
                public static TheTextUsedAsDecorationForTheCopyrightHeaderComment ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<TheTextUsedAsDecorationForTheCopyrightHeaderComment>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out TheTextUsedAsDecorationForTheCopyrightHeaderComment? result)
                {
                    return JsonElementHelpers.TryParseValue<TheTextUsedAsDecorationForTheCopyrightHeaderComment>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new TheTextUsedAsDecorationForTheCopyrightHeaderComment(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static TheTextUsedAsDecorationForTheCopyrightHeaderComment IJsonElement<TheTextUsedAsDecorationForTheCopyrightHeaderComment>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TheTextUsedAsDecorationForTheCopyrightHeaderComment: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="TheTextUsedAsDecorationForTheCopyrightHeaderComment"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="TheTextUsedAsDecorationForTheCopyrightHeaderComment"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public TheTextUsedAsDecorationForTheCopyrightHeaderComment Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<TheTextUsedAsDecorationForTheCopyrightHeaderComment>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="TheTextUsedAsDecorationForTheCopyrightHeaderComment"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public TheTextUsedAsDecorationForTheCopyrightHeaderComment Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<TheTextUsedAsDecorationForTheCopyrightHeaderComment>(_idx);
                    }
