        ...
        public readonly partial struct ConfigurationForDocumentationRulesSa1600
        {
            ...
            public readonly partial struct VariablesEntity
            {
...
#endif
                {
                    ...
                    public bool TryGetProperty(ReadOnlySpan<byte> propertyName, out Corvus.StylecopBenchmark.Current.JsonString.Mutable value)
                    {
                        CheckValidInstance();
                    ...
                    /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
                    /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                    public bool TryGetProperty(ReadOnlySpan<char> propertyName, out Corvus.StylecopBenchmark.Current.JsonString.Mutable value)
                    {
                        CheckValidInstance();
                        return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
                    }
                    ...
                    /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
                    /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                    public bool TryGetProperty(string propertyName, out Corvus.StylecopBenchmark.Current.JsonString.Mutable value)
                    {
                        CheckValidInstance();
                        return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
                    }
                    ...
                    /// </summary>
                    /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                    public ObjectEnumerator<Corvus.StylecopBenchmark.Current.JsonString.Mutable> EnumerateObject()
                    {
                        CheckValidInstance();
                        return EnumeratorCreator.CreateObjectEnumerator<Corvus.StylecopBenchmark.Current.JsonString.Mutable>(_parent, _idx);
                    }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForDocumentationRulesSa1600.VariablesEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForDocumentationRulesSa1600.VariablesEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
