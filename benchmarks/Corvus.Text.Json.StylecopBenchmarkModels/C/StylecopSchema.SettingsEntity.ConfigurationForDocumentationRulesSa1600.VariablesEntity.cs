    ...
    public readonly partial struct SettingsEntity
    {
        ...
        public readonly partial struct ConfigurationForDocumentationRulesSa1600
        {
...
#endif
            {
                ...
                public bool TryGetProperty(ReadOnlySpan<byte> propertyName, out Corvus.StylecopBenchmark.Current.JsonString value)
                {
                    CheckValidInstance();
                ...
                /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public bool TryGetProperty(ReadOnlySpan<char> propertyName, out Corvus.StylecopBenchmark.Current.JsonString value)
                {
                    CheckValidInstance();
                    return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
                }
                ...
                /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public bool TryGetProperty(string propertyName, out Corvus.StylecopBenchmark.Current.JsonString value)
                {
                    CheckValidInstance();
                    return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
                }
                ...
                /// <summary>
                /// Determines if a property name matches '^[a-zA-Z0-9]+$'
                /// for the pattern property producing the type
                /// <see cref="Corvus.StylecopBenchmark.Current.JsonString"/>.
                /// </summary>
                ...
                /// <see cref="Corvus.StylecopBenchmark.Current.JsonString"/>
                /// if the property name matches '^[a-zA-Z0-9]+$'.
                /// </summary>
                /// <param name="propertyName">The unescaped UTF-8 property name.</param>
                /// <param name="value">The property value.</param>
                /// <param name="result">The typed property value, if the name matches.</param>
                /// <returns><see langword="true"/> if the property name matches the pattern, otherwise <see langword="false"/>.</returns>
                public static bool TryAsPatternJsonString(ReadOnlySpan<byte> propertyName, in JsonElement value, out Corvus.StylecopBenchmark.Current.JsonString result)
                {
                    if (MatchesPatternJsonString(propertyName))
                    {
                        result = Corvus.StylecopBenchmark.Current.JsonString.From(value);
                        return true;
                    }
                ...
                {
                    /// <summary>
                    /// Visits a property matching '^[a-zA-Z0-9]+$'.
                    /// </summary>
                    bool VisitPatternJsonString(ReadOnlySpan<byte> name, in Corvus.StylecopBenchmark.Current.JsonString value, ref TState state);
                    ...
                    where TVisitor : IPatternPropertyVisitor<TState>
                {
                    ...
                    foreach (var property in EnumerateObject())
                    {
                        ...
                        {
                            matched = true;
                            Corvus.StylecopBenchmark.Current.JsonString typedValue = Corvus.StylecopBenchmark.Current.JsonString.From(property.Value);
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public ObjectEnumerator<Corvus.StylecopBenchmark.Current.JsonString> EnumerateObject()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateObjectEnumerator<Corvus.StylecopBenchmark.Current.JsonString>(_parent, _idx);
                }
