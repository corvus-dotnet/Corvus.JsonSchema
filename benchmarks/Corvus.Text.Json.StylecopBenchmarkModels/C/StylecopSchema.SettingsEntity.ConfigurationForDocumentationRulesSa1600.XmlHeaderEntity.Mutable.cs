        ...
        public readonly partial struct ConfigurationForDocumentationRulesSa1600
        {
            ...
            public readonly partial struct XmlHeaderEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<XmlHeaderEntity, Mutable>(XmlHeaderEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(XmlHeaderEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="XmlHeaderEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator XmlHeaderEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"XmlHeaderEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly XmlHeaderEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly XmlHeaderEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<XmlHeaderEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(XmlHeaderEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<XmlHeaderEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<XmlHeaderEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<XmlHeaderEntity>();
                    }
                    finally
                    {
