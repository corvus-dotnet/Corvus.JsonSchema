        ...
        public readonly partial struct ConfigurationForLayoutRulesSa1500
        {
            ...
            public readonly partial struct AllowConsecutiveUsingsEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<AllowConsecutiveUsingsEntity, Mutable>(AllowConsecutiveUsingsEntity.DefaultInstance);
                ...
                public static ParsedJsonDocument<AllowConsecutiveUsingsEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<AllowConsecutiveUsingsEntity>();
                    }
                    finally
                    {
