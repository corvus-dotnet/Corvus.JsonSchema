        ...
        public readonly partial struct ConfigurationForLayoutRulesSa1500
        {
            ...
            public readonly partial struct AllowDoWhileOnClosingBraceEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<AllowDoWhileOnClosingBraceEntity, Mutable>(AllowDoWhileOnClosingBraceEntity.DefaultInstance);
                ...
                public static ParsedJsonDocument<AllowDoWhileOnClosingBraceEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<AllowDoWhileOnClosingBraceEntity>();
                    }
                    finally
                    {
