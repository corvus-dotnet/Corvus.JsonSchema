    ...
    public readonly partial struct SettingsEntity
    {
        ...
        public readonly partial struct ConfigurationForLayoutRulesSa1500
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ConfigurationForLayoutRulesSa1500 instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ConfigurationForLayoutRulesSa1500"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ConfigurationForLayoutRulesSa1500(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForLayoutRulesSa1500.AllowConsecutiveUsingsEntity.Mutable AllowConsecutiveUsings
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AllowConsecutiveUsingsUtf8, out Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForLayoutRulesSa1500.AllowConsecutiveUsingsEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForLayoutRulesSa1500.AllowDoWhileOnClosingBraceEntity.Mutable AllowDoWhileOnClosingBrace
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AllowDoWhileOnClosingBraceUtf8, out Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForLayoutRulesSa1500.AllowDoWhileOnClosingBraceEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForLayoutRulesSa1500.NewlineAtEndOfFileEntity.Mutable NewlineAtEndOfFile
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NewlineAtEndOfFileUtf8, out Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForLayoutRulesSa1500.NewlineAtEndOfFileEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetAllowConsecutiveUsings(scoped in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForLayoutRulesSa1500.AllowConsecutiveUsingsEntity.Source value)
                {
                    ...
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.AllowConsecutiveUsingsUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AllowConsecutiveUsingsUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                    ...
                    else
                    {
                        ...
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.AllowConsecutiveUsings, ref cvb);
                ...
                /// <summary>
                /// Remove the <c>allowConsecutiveUsings</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveAllowConsecutiveUsings()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.AllowConsecutiveUsingsUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                public void SetAllowDoWhileOnClosingBrace(scoped in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForLayoutRulesSa1500.AllowDoWhileOnClosingBraceEntity.Source value)
                {
                    ...
                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.AllowDoWhileOnClosingBraceUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AllowDoWhileOnClosingBraceUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.AllowDoWhileOnClosingBrace, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                /// <summary>
                /// Remove the <c>allowDoWhileOnClosingBrace</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveAllowDoWhileOnClosingBrace()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.AllowDoWhileOnClosingBraceUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                public void SetNewlineAtEndOfFile(scoped in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForLayoutRulesSa1500.NewlineAtEndOfFileEntity.Source value)
                {
                    ...
                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.NewlineAtEndOfFileUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NewlineAtEndOfFileUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.NewlineAtEndOfFile, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                /// <summary>
                /// Remove the <c>newlineAtEndOfFile</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveNewlineAtEndOfFile()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.NewlineAtEndOfFileUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ConfigurationForLayoutRulesSa1500.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ConfigurationForLayoutRulesSa1500 Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ConfigurationForLayoutRulesSa1500 Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ConfigurationForLayoutRulesSa1500>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForLayoutRulesSa1500.AllowConsecutiveUsingsEntity.Source _createArg1;
                private readonly Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForLayoutRulesSa1500.AllowDoWhileOnClosingBraceEntity.Source _createArg2;
                private readonly Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForLayoutRulesSa1500.NewlineAtEndOfFileEntity.Source _createArg3;
                ...
                public static implicit operator Source(ConfigurationForLayoutRulesSa1500 instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForLayoutRulesSa1500.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="ConfigurationForLayoutRulesSa1500"/>.
                /// </summary>
                internal static void Create(
                    ref ComplexValueBuilder builder,
                    in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForLayoutRulesSa1500.AllowConsecutiveUsingsEntity.Source allowConsecutiveUsings = default,
                    in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForLayoutRulesSa1500.AllowDoWhileOnClosingBraceEntity.Source allowDoWhileOnClosingBrace = default,
                    in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForLayoutRulesSa1500.NewlineAtEndOfFileEntity.Source newlineAtEndOfFile = default)
                {
                    allowConsecutiveUsings.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.AllowConsecutiveUsings, ref builder);
                    allowDoWhileOnClosingBrace.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.AllowDoWhileOnClosingBrace, ref builder);
                    newlineAtEndOfFile.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.NewlineAtEndOfFile, ref builder);
                }
                ...
                public void Create(
                    ...
                    in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForLayoutRulesSa1500.NewlineAtEndOfFileEntity.Source newlineAtEndOfFile = default)
                {
                    Create(ref _builder, allowConsecutiveUsings, allowDoWhileOnClosingBrace, newlineAtEndOfFile);
                }
            ...
            /// </summary>
            /// <param name="allowConsecutiveUsings">The value of the <c>"allowConsecutiveUsings"</c> property.</param>
            ...
            /// </summary>
            /// <param name="workspace">The JSON workspace.</param>
            /// <param name="allowConsecutiveUsings">The value of the property.</param>
            /// <param name="allowDoWhileOnClosingBrace">The value of the property.</param>
            /// <param name="newlineAtEndOfFile">The value of the property.</param>
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForLayoutRulesSa1500.AllowConsecutiveUsingsEntity.Source allowConsecutiveUsings = default, in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForLayoutRulesSa1500.AllowDoWhileOnClosingBraceEntity.Source allowDoWhileOnClosingBrace = default, in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForLayoutRulesSa1500.NewlineAtEndOfFileEntity.Source newlineAtEndOfFile = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(allowConsecutiveUsings, allowDoWhileOnClosingBrace, newlineAtEndOfFile);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<ConfigurationForLayoutRulesSa1500, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ConfigurationForLayoutRulesSa1500> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ConfigurationForLayoutRulesSa1500>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<ConfigurationForLayoutRulesSa1500> Create<TContext>(
            ...
            public static ParsedJsonDocument<ConfigurationForLayoutRulesSa1500> Create(in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForLayoutRulesSa1500.AllowConsecutiveUsingsEntity.Source allowConsecutiveUsings = default, in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForLayoutRulesSa1500.AllowDoWhileOnClosingBraceEntity.Source allowDoWhileOnClosingBrace = default, in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForLayoutRulesSa1500.NewlineAtEndOfFileEntity.Source newlineAtEndOfFile = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
