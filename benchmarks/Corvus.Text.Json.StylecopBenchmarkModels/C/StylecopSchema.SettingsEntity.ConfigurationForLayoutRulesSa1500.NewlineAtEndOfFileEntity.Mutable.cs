        ...
        public readonly partial struct ConfigurationForLayoutRulesSa1500
        {
            ...
            public readonly partial struct NewlineAtEndOfFileEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<NewlineAtEndOfFileEntity, Mutable>(NewlineAtEndOfFileEntity.DefaultInstance);
                ...
                public ref struct Source
                {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Source(KnownValues value) => (NewlineAtEndOfFileEntity)value;
                ...
                public static ParsedJsonDocument<NewlineAtEndOfFileEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<NewlineAtEndOfFileEntity>();
                    }
                    finally
                    {
