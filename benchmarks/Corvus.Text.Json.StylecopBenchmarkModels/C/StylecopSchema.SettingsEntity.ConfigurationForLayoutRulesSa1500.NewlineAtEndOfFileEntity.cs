    ...
    public readonly partial struct SettingsEntity
    {
        ...
        public readonly partial struct ConfigurationForLayoutRulesSa1500
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="NewlineAtEndOfFileEntity"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal NewlineAtEndOfFileEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static NewlineAtEndOfFileEntity DefaultInstance { get; } = ParsedJsonDocument<NewlineAtEndOfFileEntity>.StringConstant([.."\"allow\""u8]);
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(NewlineAtEndOfFileEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in NewlineAtEndOfFileEntity left, in NewlineAtEndOfFileEntity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in NewlineAtEndOfFileEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(NewlineAtEndOfFileEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator NewlineAtEndOfFileEntity(JsonElement instance)
                {
                    return NewlineAtEndOfFileEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static NewlineAtEndOfFileEntity From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static NewlineAtEndOfFileEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<NewlineAtEndOfFileEntity>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static NewlineAtEndOfFileEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<NewlineAtEndOfFileEntity>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static NewlineAtEndOfFileEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<NewlineAtEndOfFileEntity>(json, options);
                }
                ...
                /// </exception>
                public static NewlineAtEndOfFileEntity ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<NewlineAtEndOfFileEntity>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out NewlineAtEndOfFileEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<NewlineAtEndOfFileEntity>(ref reader, out result);
                }
...
#if NET
                static NewlineAtEndOfFileEntity IJsonElement<NewlineAtEndOfFileEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"NewlineAtEndOfFileEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public NewlineAtEndOfFileEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public NewlineAtEndOfFileEntity Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<NewlineAtEndOfFileEntity>(_idx);
                    }
