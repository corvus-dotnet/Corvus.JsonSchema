            ...
            public readonly partial struct AllowedHungarianPrefixesEntityArray
            {
                ...
                public readonly partial struct AllowedHungarianPrefixesEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(AllowedHungarianPrefixesEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="AllowedHungarianPrefixesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator AllowedHungarianPrefixesEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"AllowedHungarianPrefixesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        /// <summary>
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly AllowedHungarianPrefixesEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly AllowedHungarianPrefixesEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<AllowedHungarianPrefixesEntity>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        internal Source(Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForNamingRulesSa1300.AllowedHungarianPrefixesEntityArray.AllowedHungarianPrefixesEntity.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                        public static implicit operator Source(AllowedHungarianPrefixesEntity instance) => new(JsonElement.From(instance));
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForNamingRulesSa1300.AllowedHungarianPrefixesEntityArray.AllowedHungarianPrefixesEntity.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
                    ...
                    {
                        return workspace.CreateBuilder<AllowedHungarianPrefixesEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<AllowedHungarianPrefixesEntity> Create(
                        scoped in Source value, int initialCapacity = 30)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<AllowedHungarianPrefixesEntity>();
                        }
                        finally
                        {
