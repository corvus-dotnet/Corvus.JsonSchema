        ...
        public readonly partial struct ConfigurationForNamingRulesSa1300
        {
            ...
            public readonly partial struct AllowCommonHungarianPrefixesEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<AllowCommonHungarianPrefixesEntity, Mutable>(AllowCommonHungarianPrefixesEntity.DefaultInstance);
                ...
                public static ParsedJsonDocument<AllowCommonHungarianPrefixesEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<AllowCommonHungarianPrefixesEntity>();
                    }
                    finally
                    {
