    ...
    public readonly partial struct SettingsEntity
    {
        ...
        public readonly partial struct ConfigurationForNamingRulesSa1300
        {
            ...
            public readonly partial struct AllowedHungarianPrefixesEntityArray
                ...
                : IJsonElement<AllowedHungarianPrefixesEntityArray>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="AllowedHungarianPrefixesEntityArray"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal AllowedHungarianPrefixesEntityArray(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                public Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForNamingRulesSa1300.AllowedHungarianPrefixesEntityArray.AllowedHungarianPrefixesEntity this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForNamingRulesSa1300.AllowedHungarianPrefixesEntityArray.AllowedHungarianPrefixesEntity>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForNamingRulesSa1300.AllowedHungarianPrefixesEntityArray.AllowedHungarianPrefixesEntity> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForNamingRulesSa1300.AllowedHungarianPrefixesEntityArray.AllowedHungarianPrefixesEntity>(_parent, _idx);
                }
                ...
                /// </returns>
                public static bool operator ==(in AllowedHungarianPrefixesEntityArray left, in AllowedHungarianPrefixesEntityArray right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in AllowedHungarianPrefixesEntityArray left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(AllowedHungarianPrefixesEntityArray instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AllowedHungarianPrefixesEntityArray(JsonElement instance)
                {
                    return AllowedHungarianPrefixesEntityArray.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AllowedHungarianPrefixesEntityArray From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AllowedHungarianPrefixesEntityArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<AllowedHungarianPrefixesEntityArray>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AllowedHungarianPrefixesEntityArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<AllowedHungarianPrefixesEntityArray>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AllowedHungarianPrefixesEntityArray ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<AllowedHungarianPrefixesEntityArray>(json, options);
                }
                ...
                /// </exception>
                public static AllowedHungarianPrefixesEntityArray ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<AllowedHungarianPrefixesEntityArray>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out AllowedHungarianPrefixesEntityArray? result)
                {
                    return JsonElementHelpers.TryParseValue<AllowedHungarianPrefixesEntityArray>(ref reader, out result);
                }
...
#if NET
                static AllowedHungarianPrefixesEntityArray IJsonElement<AllowedHungarianPrefixesEntityArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AllowedHungarianPrefixesEntityArray: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public AllowedHungarianPrefixesEntityArray Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public AllowedHungarianPrefixesEntityArray Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<AllowedHungarianPrefixesEntityArray>(_idx);
                    }
