        ...
        public readonly partial struct ConfigurationForNamingRulesSa1300
        {
            ...
            public readonly partial struct IncludeInferredTupleElementNamesEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<IncludeInferredTupleElementNamesEntity, Mutable>(IncludeInferredTupleElementNamesEntity.DefaultInstance);
                ...
                public static ParsedJsonDocument<IncludeInferredTupleElementNamesEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<IncludeInferredTupleElementNamesEntity>();
                    }
                    finally
                    {
