...
public readonly partial struct StylecopSchema
{
    ...
    public readonly partial struct SettingsEntity
    {
        ...
        public readonly partial struct ConfigurationForNamingRulesSa1300
        {
            ...
            public readonly partial struct IncludeInferredTupleElementNamesEntity
#if NET8_0_OR_GREATER
                : IJsonElement<IncludeInferredTupleElementNamesEntity>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="IncludeInferredTupleElementNamesEntity"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal IncludeInferredTupleElementNamesEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static IncludeInferredTupleElementNamesEntity DefaultInstance { get; } = ParsedJsonDocument<IncludeInferredTupleElementNamesEntity>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(IncludeInferredTupleElementNamesEntity value)
                {
                ...
                /// </returns>
                public static bool operator ==(in IncludeInferredTupleElementNamesEntity left, in IncludeInferredTupleElementNamesEntity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in IncludeInferredTupleElementNamesEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(IncludeInferredTupleElementNamesEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator IncludeInferredTupleElementNamesEntity(JsonElement instance)
                {
                    return IncludeInferredTupleElementNamesEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static IncludeInferredTupleElementNamesEntity From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static IncludeInferredTupleElementNamesEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<IncludeInferredTupleElementNamesEntity>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static IncludeInferredTupleElementNamesEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<IncludeInferredTupleElementNamesEntity>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static IncludeInferredTupleElementNamesEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<IncludeInferredTupleElementNamesEntity>(json, options);
                }
                ...
                /// </exception>
                public static IncludeInferredTupleElementNamesEntity ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<IncludeInferredTupleElementNamesEntity>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out IncludeInferredTupleElementNamesEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<IncludeInferredTupleElementNamesEntity>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new IncludeInferredTupleElementNamesEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static IncludeInferredTupleElementNamesEntity IJsonElement<IncludeInferredTupleElementNamesEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"IncludeInferredTupleElementNamesEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="IncludeInferredTupleElementNamesEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="IncludeInferredTupleElementNamesEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public IncludeInferredTupleElementNamesEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<IncludeInferredTupleElementNamesEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="IncludeInferredTupleElementNamesEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public IncludeInferredTupleElementNamesEntity Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<IncludeInferredTupleElementNamesEntity>(_idx);
                    }
