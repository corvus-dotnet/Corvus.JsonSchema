        ...
        public readonly partial struct ConfigurationForNamingRulesSa1300
        {
            ...
            public readonly partial struct SpecifiesTheCasingConventionUsedForTupleElementNames
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SpecifiesTheCasingConventionUsedForTupleElementNames, Mutable>(SpecifiesTheCasingConventionUsedForTupleElementNames.DefaultInstance);
                    ...
                    public static explicit operator Mutable(SpecifiesTheCasingConventionUsedForTupleElementNames instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="SpecifiesTheCasingConventionUsedForTupleElementNames"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator SpecifiesTheCasingConventionUsedForTupleElementNames(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"SpecifiesTheCasingConventionUsedForTupleElementNames.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly SpecifiesTheCasingConventionUsedForTupleElementNames Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly SpecifiesTheCasingConventionUsedForTupleElementNames Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<SpecifiesTheCasingConventionUsedForTupleElementNames>(_idx);
                    }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(SpecifiesTheCasingConventionUsedForTupleElementNames instance) => new(JsonElement.From(instance));
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Source(KnownValues value) => (SpecifiesTheCasingConventionUsedForTupleElementNames)value;
                ...
                {
                    return workspace.CreateBuilder<SpecifiesTheCasingConventionUsedForTupleElementNames, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<SpecifiesTheCasingConventionUsedForTupleElementNames> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<SpecifiesTheCasingConventionUsedForTupleElementNames>();
                    }
                    finally
                    {
