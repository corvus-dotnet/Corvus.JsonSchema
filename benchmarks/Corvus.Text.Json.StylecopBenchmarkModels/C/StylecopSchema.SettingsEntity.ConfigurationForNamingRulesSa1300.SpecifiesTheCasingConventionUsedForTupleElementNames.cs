    ...
    public readonly partial struct SettingsEntity
    {
        ...
        public readonly partial struct ConfigurationForNamingRulesSa1300
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="SpecifiesTheCasingConventionUsedForTupleElementNames"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal SpecifiesTheCasingConventionUsedForTupleElementNames(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static SpecifiesTheCasingConventionUsedForTupleElementNames DefaultInstance { get; } = ParsedJsonDocument<SpecifiesTheCasingConventionUsedForTupleElementNames>.StringConstant([.."\"PascalCase\""u8]);
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(SpecifiesTheCasingConventionUsedForTupleElementNames value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in SpecifiesTheCasingConventionUsedForTupleElementNames left, in SpecifiesTheCasingConventionUsedForTupleElementNames right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in SpecifiesTheCasingConventionUsedForTupleElementNames left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(SpecifiesTheCasingConventionUsedForTupleElementNames instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SpecifiesTheCasingConventionUsedForTupleElementNames(JsonElement instance)
                {
                    return SpecifiesTheCasingConventionUsedForTupleElementNames.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SpecifiesTheCasingConventionUsedForTupleElementNames From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SpecifiesTheCasingConventionUsedForTupleElementNames ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<SpecifiesTheCasingConventionUsedForTupleElementNames>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SpecifiesTheCasingConventionUsedForTupleElementNames ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<SpecifiesTheCasingConventionUsedForTupleElementNames>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SpecifiesTheCasingConventionUsedForTupleElementNames ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<SpecifiesTheCasingConventionUsedForTupleElementNames>(json, options);
                }
                ...
                /// </exception>
                public static SpecifiesTheCasingConventionUsedForTupleElementNames ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<SpecifiesTheCasingConventionUsedForTupleElementNames>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out SpecifiesTheCasingConventionUsedForTupleElementNames? result)
                {
                    return JsonElementHelpers.TryParseValue<SpecifiesTheCasingConventionUsedForTupleElementNames>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new SpecifiesTheCasingConventionUsedForTupleElementNames(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static SpecifiesTheCasingConventionUsedForTupleElementNames IJsonElement<SpecifiesTheCasingConventionUsedForTupleElementNames>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SpecifiesTheCasingConventionUsedForTupleElementNames: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="SpecifiesTheCasingConventionUsedForTupleElementNames"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="SpecifiesTheCasingConventionUsedForTupleElementNames"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public SpecifiesTheCasingConventionUsedForTupleElementNames Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<SpecifiesTheCasingConventionUsedForTupleElementNames>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="SpecifiesTheCasingConventionUsedForTupleElementNames"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public SpecifiesTheCasingConventionUsedForTupleElementNames Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<SpecifiesTheCasingConventionUsedForTupleElementNames>(_idx);
                    }
...
#endif
                {
                    ...
                    {
                        return matchPascalCase(context);
                    }
