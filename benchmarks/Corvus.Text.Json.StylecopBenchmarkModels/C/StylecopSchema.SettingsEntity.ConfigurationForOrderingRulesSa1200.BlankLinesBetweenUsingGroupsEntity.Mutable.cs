        ...
        public readonly partial struct ConfigurationForOrderingRulesSa1200
        {
            ...
            public readonly partial struct BlankLinesBetweenUsingGroupsEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<BlankLinesBetweenUsingGroupsEntity, Mutable>(BlankLinesBetweenUsingGroupsEntity.DefaultInstance);
                ...
                public ref struct Source
                {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Source(KnownValues value) => (BlankLinesBetweenUsingGroupsEntity)value;
                ...
                public static ParsedJsonDocument<BlankLinesBetweenUsingGroupsEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<BlankLinesBetweenUsingGroupsEntity>();
                    }
                    finally
                    {
