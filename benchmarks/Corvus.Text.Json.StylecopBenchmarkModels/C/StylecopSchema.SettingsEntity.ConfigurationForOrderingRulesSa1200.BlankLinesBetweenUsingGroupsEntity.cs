    ...
    public readonly partial struct SettingsEntity
    {
        ...
        public readonly partial struct ConfigurationForOrderingRulesSa1200
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="BlankLinesBetweenUsingGroupsEntity"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal BlankLinesBetweenUsingGroupsEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static BlankLinesBetweenUsingGroupsEntity DefaultInstance { get; } = ParsedJsonDocument<BlankLinesBetweenUsingGroupsEntity>.StringConstant([.."\"allow\""u8]);
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(BlankLinesBetweenUsingGroupsEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in BlankLinesBetweenUsingGroupsEntity left, in BlankLinesBetweenUsingGroupsEntity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in BlankLinesBetweenUsingGroupsEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(BlankLinesBetweenUsingGroupsEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator BlankLinesBetweenUsingGroupsEntity(JsonElement instance)
                {
                    return BlankLinesBetweenUsingGroupsEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static BlankLinesBetweenUsingGroupsEntity From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static BlankLinesBetweenUsingGroupsEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<BlankLinesBetweenUsingGroupsEntity>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static BlankLinesBetweenUsingGroupsEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<BlankLinesBetweenUsingGroupsEntity>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static BlankLinesBetweenUsingGroupsEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<BlankLinesBetweenUsingGroupsEntity>(json, options);
                }
                ...
                /// </exception>
                public static BlankLinesBetweenUsingGroupsEntity ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<BlankLinesBetweenUsingGroupsEntity>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out BlankLinesBetweenUsingGroupsEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<BlankLinesBetweenUsingGroupsEntity>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new BlankLinesBetweenUsingGroupsEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static BlankLinesBetweenUsingGroupsEntity IJsonElement<BlankLinesBetweenUsingGroupsEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"BlankLinesBetweenUsingGroupsEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="BlankLinesBetweenUsingGroupsEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="BlankLinesBetweenUsingGroupsEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public BlankLinesBetweenUsingGroupsEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<BlankLinesBetweenUsingGroupsEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="BlankLinesBetweenUsingGroupsEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public BlankLinesBetweenUsingGroupsEntity Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<BlankLinesBetweenUsingGroupsEntity>(_idx);
                    }
