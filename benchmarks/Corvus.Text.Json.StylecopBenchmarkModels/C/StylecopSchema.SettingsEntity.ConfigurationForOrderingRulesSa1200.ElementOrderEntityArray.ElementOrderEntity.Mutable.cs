            ...
            public readonly partial struct ElementOrderEntityArray
            {
                ...
                public readonly partial struct ElementOrderEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(ElementOrderEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="ElementOrderEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator ElementOrderEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"ElementOrderEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly ElementOrderEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly ElementOrderEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<ElementOrderEntity>(_idx);
                        }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(ElementOrderEntity instance) => new(JsonElement.From(instance));
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator Source(KnownValues value) => (ElementOrderEntity)value;
                    ...
                    {
                        return workspace.CreateBuilder<ElementOrderEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<ElementOrderEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<ElementOrderEntity>();
                        }
                        finally
                        {
