        ...
        public readonly partial struct ConfigurationForOrderingRulesSa1200
        {
            ...
            public readonly partial struct EntityArray
            {
...
#endif
                {
                    ...
                    internal Entity(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static Entity DefaultInstance { get; }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static explicit operator string(Entity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in Entity left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator JsonElement(Entity instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Entity(JsonElement instance)
                    {
                        return Entity.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static Entity From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static Entity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<Entity>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static Entity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<Entity>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static Entity ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<Entity>(json, options);
                    }
                    ...
                    /// </exception>
                    public static Entity ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<Entity>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out Entity? result)
                    {
                        return JsonElementHelpers.TryParseValue<Entity>(ref reader, out result);
                    }
...
#if NET
                    static Entity IJsonElement<Entity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"Entity: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    public Entity Freeze()
                    {
                        ...
                        {
                            return mutable.FreezeElement<Entity>(_idx);
                        }
                    ...
                    /// <param name="matchAccessibility">Match 1st item.</param>
                    /// <param name="matchKind">Match 2nd item.</param>
                    /// <param name="matchConstant">Match 3rd item.</param>
                    /// <param name="matchStatic">Match 4th item.</param>
                    /// <param name="matchReadonly">Match 5th item.</param>
                    /// <param name="defaultMatch">Match any other value.</param>
                    /// <returns>An instance of the value returned by the match function.</returns>
                    public TResult Match<TContext, TResult>(
                        in TContext context,
                        Func<TContext, TResult> matchAccessibility,
                        Func<TContext, TResult> matchKind,
                        Func<TContext, TResult> matchConstant,
                        Func<TContext, TResult> matchStatic,
                        Func<TContext, TResult> matchReadonly,
...
#endif
                    {
                        ...
                        {
                            return matchAccessibility(context);
                        }

                        if (this.ValueEquals(Constants.Enum2))
                        {
                            return matchKind(context);
                        }

                        if (this.ValueEquals(Constants.Enum3))
                        {
                            return matchConstant(context);
                        }
                    ...
                    public TResult Match<TResult>(
                        Func<TResult> matchAccessibility,
                        Func<TResult> matchKind,
                        Func<TResult> matchConstant,
                        Func<TResult> matchStatic,
                        Func<TResult> matchReadonly,
