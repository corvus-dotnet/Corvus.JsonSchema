    ...
    public readonly partial struct SettingsEntity
    {
        ...
        public readonly partial struct ConfigurationForOrderingRulesSa1200
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ConfigurationForOrderingRulesSa1200 instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ConfigurationForOrderingRulesSa1200"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ConfigurationForOrderingRulesSa1200(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1200.BlankLinesBetweenUsingGroupsEntity.Mutable BlankLinesBetweenUsingGroups
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BlankLinesBetweenUsingGroupsUtf8, out Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1200.BlankLinesBetweenUsingGroupsEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1200.SystemUsingDirectivesFirstEntity.Mutable SystemUsingDirectivesFirst
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SystemUsingDirectivesFirstUtf8, out Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1200.SystemUsingDirectivesFirstEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1200.UsingDirectivesPlacementEntity.Mutable UsingDirectivesPlacement
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UsingDirectivesPlacementUtf8, out Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1200.UsingDirectivesPlacementEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                /// <summary>
                /// Set the <c>blankLinesBetweenUsingGroups</c> property.
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetBlankLinesBetweenUsingGroups(scoped in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1200.BlankLinesBetweenUsingGroupsEntity.Source value)
                {
                    CheckValidInstance();

                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.BlankLinesBetweenUsingGroupsUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BlankLinesBetweenUsingGroupsUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                    ...
                    else
                    {
                        ...
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.BlankLinesBetweenUsingGroups, ref cvb);
                ...
                /// <summary>
                /// Remove the <c>blankLinesBetweenUsingGroups</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveBlankLinesBetweenUsingGroups()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.BlankLinesBetweenUsingGroupsUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetElementOrder(scoped in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1200.ElementOrderEntityArray.Source value)
                {
                    CheckValidInstance();

                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ElementOrderUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ElementOrderUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ElementOrder, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                /// <summary>
                /// Remove the <c>elementOrder</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveElementOrder()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ElementOrderUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }

                /// <summary>
                /// Set the <c>systemUsingDirectivesFirst</c> property.
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetSystemUsingDirectivesFirst(scoped in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1200.SystemUsingDirectivesFirstEntity.Source value)
                {
                    CheckValidInstance();

                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.SystemUsingDirectivesFirstUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SystemUsingDirectivesFirstUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.SystemUsingDirectivesFirst, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                /// <summary>
                /// Remove the <c>systemUsingDirectivesFirst</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveSystemUsingDirectivesFirst()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.SystemUsingDirectivesFirstUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }

                /// <summary>
                /// Set the <c>usingDirectivesPlacement</c> property.
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetUsingDirectivesPlacement(scoped in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1200.UsingDirectivesPlacementEntity.Source value)
                {
                    CheckValidInstance();

                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.UsingDirectivesPlacementUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UsingDirectivesPlacementUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.UsingDirectivesPlacement, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                /// <summary>
                /// Remove the <c>usingDirectivesPlacement</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveUsingDirectivesPlacement()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.UsingDirectivesPlacementUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ConfigurationForOrderingRulesSa1200.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ConfigurationForOrderingRulesSa1200 Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ConfigurationForOrderingRulesSa1200 Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ConfigurationForOrderingRulesSa1200>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(scoped in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1200.BlankLinesBetweenUsingGroupsEntity.Source arg1, scoped in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1200.ElementOrderEntityArray.Source arg2, scoped in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1200.SystemUsingDirectivesFirstEntity.Source arg3, scoped in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1200.UsingDirectivesPlacementEntity.Source arg4)
                {
                    _createArg1 = arg1;
                    _createArg2 = arg2;
                    _createArg3 = arg3;
                ...
                public static implicit operator Source(ConfigurationForOrderingRulesSa1200 instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, scoped in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1200.BlankLinesBetweenUsingGroupsEntity.Source arg1, scoped in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1200.ElementOrderEntityArray.Source<TContext> arg2, scoped in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1200.SystemUsingDirectivesFirstEntity.Source arg3, scoped in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1200.UsingDirectivesPlacementEntity.Source arg4)
                {
                    _context = context;
                    _createArg1 = arg1;
                    _createArg2 = arg2;
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="ConfigurationForOrderingRulesSa1200"/>.
                /// </summary>
                ...
                {
                    blankLinesBetweenUsingGroups.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.BlankLinesBetweenUsingGroups, ref builder);
                    elementOrder.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ElementOrder, ref builder);
                    systemUsingDirectivesFirst.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.SystemUsingDirectivesFirst, ref builder);
                    usingDirectivesPlacement.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.UsingDirectivesPlacement, ref builder);
                }
                ...
                public void Create(
                    ...
                    in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1200.UsingDirectivesPlacementEntity.Source usingDirectivesPlacement = default)
                {
                    Create(ref _builder, blankLinesBetweenUsingGroups, elementOrder, systemUsingDirectivesFirst, usingDirectivesPlacement);
                }
                ...
                #endif
                {
                    Create(context, ref _builder, blankLinesBetweenUsingGroups, elementOrder, systemUsingDirectivesFirst, usingDirectivesPlacement);
                }
                ...
                internal static void BuildCreateValue(scoped in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1200.BlankLinesBetweenUsingGroupsEntity.Source arg1, scoped in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1200.ElementOrderEntityArray.Source arg2, scoped in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1200.SystemUsingDirectivesFirstEntity.Source arg3, scoped in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1200.UsingDirectivesPlacementEntity.Source arg4, ref ComplexValueBuilder o)
                {
                    o.StartObject();
                ...
                /// <param name="arg4">The value of the property.</param>
                /// <param name="o">The complex value builder into which to write the object.</param>
                internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1200.BlankLinesBetweenUsingGroupsEntity.Source arg1, scoped in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1200.ElementOrderEntityArray.Source<TContext> arg2, scoped in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1200.SystemUsingDirectivesFirstEntity.Source arg3, scoped in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1200.UsingDirectivesPlacementEntity.Source arg4, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
            ...
            /// </summary>
            /// <param name="blankLinesBetweenUsingGroups">The value of the <c>"blankLinesBetweenUsingGroups"</c> property.</param>
            /// <param name="elementOrder">The value of the <c>"elementOrder"</c> property.</param>
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1200.BlankLinesBetweenUsingGroupsEntity.Source blankLinesBetweenUsingGroups = default, scoped in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1200.ElementOrderEntityArray.Source elementOrder = default, scoped in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1200.SystemUsingDirectivesFirstEntity.Source systemUsingDirectivesFirst = default, scoped in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1200.UsingDirectivesPlacementEntity.Source usingDirectivesPlacement = default)
            {
            ...
            /// <param name="usingDirectivesPlacement">The value of the <c>"usingDirectivesPlacement"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1200.BlankLinesBetweenUsingGroupsEntity.Source blankLinesBetweenUsingGroups = default, scoped in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1200.ElementOrderEntityArray.Source<TContext> elementOrder = default, scoped in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1200.SystemUsingDirectivesFirstEntity.Source systemUsingDirectivesFirst = default, scoped in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1200.UsingDirectivesPlacementEntity.Source usingDirectivesPlacement = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                return new Source<TContext>(context, blankLinesBetweenUsingGroups, elementOrder, systemUsingDirectivesFirst, usingDirectivesPlacement);
            }
            ...
            /// </summary>
            /// <param name="workspace">The JSON workspace.</param>
            /// <param name="blankLinesBetweenUsingGroups">The value of the property.</param>
            /// <param name="elementOrder">The value of the property.</param>
            /// <param name="systemUsingDirectivesFirst">The value of the property.</param>
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1200.BlankLinesBetweenUsingGroupsEntity.Source blankLinesBetweenUsingGroups = default, in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1200.ElementOrderEntityArray.Source elementOrder = default, in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1200.SystemUsingDirectivesFirstEntity.Source systemUsingDirectivesFirst = default, in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1200.UsingDirectivesPlacementEntity.Source usingDirectivesPlacement = default, int initialCapacity = 30)
            {
                ...
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(blankLinesBetweenUsingGroups, elementOrder, systemUsingDirectivesFirst, usingDirectivesPlacement);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
                ...
                #endif
            {
                ...
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(context, blankLinesBetweenUsingGroups, elementOrder, systemUsingDirectivesFirst, usingDirectivesPlacement);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<ConfigurationForOrderingRulesSa1200, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ConfigurationForOrderingRulesSa1200> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ConfigurationForOrderingRulesSa1200>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<ConfigurationForOrderingRulesSa1200> Create<TContext>(
            ...
            public static ParsedJsonDocument<ConfigurationForOrderingRulesSa1200> Create(in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1200.BlankLinesBetweenUsingGroupsEntity.Source blankLinesBetweenUsingGroups = default, in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1200.ElementOrderEntityArray.Source elementOrder = default, in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1200.SystemUsingDirectivesFirstEntity.Source systemUsingDirectivesFirst = default, in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1200.UsingDirectivesPlacementEntity.Source usingDirectivesPlacement = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
            public static ParsedJsonDocument<ConfigurationForOrderingRulesSa1200> Create<TContext>(in TContext context, in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1200.BlankLinesBetweenUsingGroupsEntity.Source blankLinesBetweenUsingGroups = default, in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1200.ElementOrderEntityArray.Source<TContext> elementOrder = default, in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1200.SystemUsingDirectivesFirstEntity.Source systemUsingDirectivesFirst = default, in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1200.UsingDirectivesPlacementEntity.Source usingDirectivesPlacement = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
