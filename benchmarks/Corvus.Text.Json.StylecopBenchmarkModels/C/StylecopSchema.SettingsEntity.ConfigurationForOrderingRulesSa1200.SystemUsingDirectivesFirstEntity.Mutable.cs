        ...
        public readonly partial struct ConfigurationForOrderingRulesSa1200
        {
            ...
            public readonly partial struct SystemUsingDirectivesFirstEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SystemUsingDirectivesFirstEntity, Mutable>(SystemUsingDirectivesFirstEntity.DefaultInstance);
                ...
                public static ParsedJsonDocument<SystemUsingDirectivesFirstEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<SystemUsingDirectivesFirstEntity>();
                    }
                    finally
                    {
