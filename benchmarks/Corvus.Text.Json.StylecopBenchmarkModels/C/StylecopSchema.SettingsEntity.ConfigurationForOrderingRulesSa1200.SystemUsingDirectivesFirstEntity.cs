...
public readonly partial struct StylecopSchema
{
    ...
    public readonly partial struct SettingsEntity
    {
        ...
        public readonly partial struct ConfigurationForOrderingRulesSa1200
        {
            ...
            public readonly partial struct SystemUsingDirectivesFirstEntity
#if NET8_0_OR_GREATER
                : IJsonElement<SystemUsingDirectivesFirstEntity>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="SystemUsingDirectivesFirstEntity"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal SystemUsingDirectivesFirstEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static SystemUsingDirectivesFirstEntity DefaultInstance { get; } = ParsedJsonDocument<SystemUsingDirectivesFirstEntity>.True;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(SystemUsingDirectivesFirstEntity value)
                {
                ...
                /// </returns>
                public static bool operator ==(in SystemUsingDirectivesFirstEntity left, in SystemUsingDirectivesFirstEntity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in SystemUsingDirectivesFirstEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(SystemUsingDirectivesFirstEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SystemUsingDirectivesFirstEntity(JsonElement instance)
                {
                    return SystemUsingDirectivesFirstEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SystemUsingDirectivesFirstEntity From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SystemUsingDirectivesFirstEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<SystemUsingDirectivesFirstEntity>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SystemUsingDirectivesFirstEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<SystemUsingDirectivesFirstEntity>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static SystemUsingDirectivesFirstEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<SystemUsingDirectivesFirstEntity>(json, options);
                }
                ...
                /// </exception>
                public static SystemUsingDirectivesFirstEntity ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<SystemUsingDirectivesFirstEntity>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out SystemUsingDirectivesFirstEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<SystemUsingDirectivesFirstEntity>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new SystemUsingDirectivesFirstEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static SystemUsingDirectivesFirstEntity IJsonElement<SystemUsingDirectivesFirstEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SystemUsingDirectivesFirstEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="SystemUsingDirectivesFirstEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="SystemUsingDirectivesFirstEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public SystemUsingDirectivesFirstEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<SystemUsingDirectivesFirstEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="SystemUsingDirectivesFirstEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public SystemUsingDirectivesFirstEntity Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<SystemUsingDirectivesFirstEntity>(_idx);
                    }
