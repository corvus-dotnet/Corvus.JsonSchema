        ...
        public readonly partial struct ConfigurationForOrderingRulesSa1200
        {
            ...
            public readonly partial struct UsingDirectivesPlacementEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<UsingDirectivesPlacementEntity, Mutable>(UsingDirectivesPlacementEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(UsingDirectivesPlacementEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="UsingDirectivesPlacementEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator UsingDirectivesPlacementEntity(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new UsingDirectivesPlacementEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"UsingDirectivesPlacementEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="UsingDirectivesPlacementEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="UsingDirectivesPlacementEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly UsingDirectivesPlacementEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<UsingDirectivesPlacementEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="UsingDirectivesPlacementEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly UsingDirectivesPlacementEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<UsingDirectivesPlacementEntity>(_idx);
                    }
                    ...
                    /// <param name="matchInsideNamespace">Match 1st item.</param>
                    /// <param name="matchOutsideNamespace">Match 2nd item.</param>
                    /// <param name="matchPreserve">Match 3rd item.</param>
                    /// <param name="defaultMatch">Match any other value.</param>
                    /// <returns>An instance of the value returned by the match function.</returns>
                    public TResult Match<TContext, TResult>(
                        in TContext context,
                        Func<TContext, TResult> matchInsideNamespace,
                        Func<TContext, TResult> matchOutsideNamespace,
...
#endif
                    {
                        ...
                        {
                            return matchInsideNamespace(context);
                        }

                        if (this.ValueEquals(Constants.Enum2))
                        {
                            return matchOutsideNamespace(context);
                        }
                    ...
                    public TResult Match<TResult>(
                        Func<TResult> matchInsideNamespace,
                        Func<TResult> matchOutsideNamespace,
                        Func<TResult> matchPreserve,
                        Func<TResult> defaultMatch)
                    {
                        if (this.ValueEquals(Constants.Enum1))
                        {
                            return matchInsideNamespace();
                        }

                        if (this.ValueEquals(Constants.Enum2))
                        {
                            return matchOutsideNamespace();
                        }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(UsingDirectivesPlacementEntity instance) => new(JsonElement.From(instance));
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Source(KnownValues value) => (UsingDirectivesPlacementEntity)value;
                ...
                {
                    return workspace.CreateBuilder<UsingDirectivesPlacementEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<UsingDirectivesPlacementEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<UsingDirectivesPlacementEntity>();
                    }
                    finally
                    {
