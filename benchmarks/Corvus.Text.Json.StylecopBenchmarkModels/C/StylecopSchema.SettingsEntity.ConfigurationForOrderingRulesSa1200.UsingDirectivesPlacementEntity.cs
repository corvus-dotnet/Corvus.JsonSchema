    ...
    public readonly partial struct SettingsEntity
    {
        ...
        public readonly partial struct ConfigurationForOrderingRulesSa1200
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="UsingDirectivesPlacementEntity"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal UsingDirectivesPlacementEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static UsingDirectivesPlacementEntity DefaultInstance { get; } = ParsedJsonDocument<UsingDirectivesPlacementEntity>.StringConstant([.."\"insideNamespace\""u8]);
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(UsingDirectivesPlacementEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in UsingDirectivesPlacementEntity left, in UsingDirectivesPlacementEntity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in UsingDirectivesPlacementEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(UsingDirectivesPlacementEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator UsingDirectivesPlacementEntity(JsonElement instance)
                {
                    return UsingDirectivesPlacementEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static UsingDirectivesPlacementEntity From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static UsingDirectivesPlacementEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<UsingDirectivesPlacementEntity>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static UsingDirectivesPlacementEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<UsingDirectivesPlacementEntity>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static UsingDirectivesPlacementEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<UsingDirectivesPlacementEntity>(json, options);
                }
                ...
                /// </exception>
                public static UsingDirectivesPlacementEntity ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<UsingDirectivesPlacementEntity>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out UsingDirectivesPlacementEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<UsingDirectivesPlacementEntity>(ref reader, out result);
                }
...
#if NET
                static UsingDirectivesPlacementEntity IJsonElement<UsingDirectivesPlacementEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"UsingDirectivesPlacementEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public UsingDirectivesPlacementEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public UsingDirectivesPlacementEntity Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<UsingDirectivesPlacementEntity>(_idx);
                    }
