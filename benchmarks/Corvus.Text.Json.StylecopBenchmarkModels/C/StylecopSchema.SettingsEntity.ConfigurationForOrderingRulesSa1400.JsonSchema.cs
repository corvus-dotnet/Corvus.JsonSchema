    ...
    public readonly partial struct SettingsEntity
    {
            ...
            : IJsonElement<ConfigurationForOrderingRulesSa1400>
        {
            public static partial class JsonSchema
            {
                ...
                private static void MatchTopLevelTypes(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/properties/settings/properties/maintainabilityRules"u8, buffer, out written);
