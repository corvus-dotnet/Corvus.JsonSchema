            ...
            public readonly partial struct TopLevelTypesEntityArray
            {
                ...
                public readonly partial struct TopLevelTypesEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(TopLevelTypesEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="TopLevelTypesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator TopLevelTypesEntity(Mutable instance)
                        {
                        ...
                        {
                            return
                                (obj is IJsonElement value && Equals(new TopLevelTypesEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"TopLevelTypesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// <summary>
                        /// Gets a <see cref="TopLevelTypesEntity"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </summary>
                        /// <returns>
                        /// A <see cref="TopLevelTypesEntity"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </returns>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly TopLevelTypesEntity Clone()
                        {
                            CheckValidInstance();
                            return _parent.CloneElement<TopLevelTypesEntity>(_idx);
                        }
                        ...
                        /// </summary>
                        /// <returns>
                        /// An immutable <see cref="TopLevelTypesEntity"/> that lives for the lifetime of its
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly TopLevelTypesEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<TopLevelTypesEntity>(_idx);
                        }
                        ...
                        /// <param name="matchClass">Match 1st item.</param>
                        /// <param name="matchInterface">Match 2nd item.</param>
                        /// <param name="matchStruct">Match 3rd item.</param>
                        /// <param name="matchDelegate">Match 4th item.</param>
                        /// <param name="matchEnum">Match 5th item.</param>
                        /// <param name="defaultMatch">Match any other value.</param>
                        /// <returns>An instance of the value returned by the match function.</returns>
                        public TResult Match<TContext, TResult>(
                            in TContext context,
                            Func<TContext, TResult> matchClass,
                            Func<TContext, TResult> matchInterface,
                            Func<TContext, TResult> matchStruct,
                            Func<TContext, TResult> matchDelegate,
                            Func<TContext, TResult> matchEnum,
...
#endif
                        {
                            ...
                            {
                                return matchClass(context);
                            }

                            if (this.ValueEquals(Constants.Enum2))
                            {
                                return matchInterface(context);
                            }

                            if (this.ValueEquals(Constants.Enum3))
                            {
                                return matchStruct(context);
                            }

                            if (this.ValueEquals(Constants.Enum4))
                            {
                                return matchDelegate(context);
                            }
                        ...
                        public TResult Match<TResult>(
                            Func<TResult> matchClass,
                            Func<TResult> matchInterface,
                            Func<TResult> matchStruct,
                            Func<TResult> matchDelegate,
                            Func<TResult> matchEnum,
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(TopLevelTypesEntity instance) => new(JsonElement.From(instance));
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator Source(KnownValues value) => (TopLevelTypesEntity)value;
                    ...
                    {
                        return workspace.CreateBuilder<TopLevelTypesEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<TopLevelTypesEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<TopLevelTypesEntity>();
                        }
                        finally
                        {
