    ...
    public readonly partial struct SettingsEntity
    {
        ...
        public readonly partial struct ConfigurationForOrderingRulesSa1400
        {
            ...
            public readonly partial struct TopLevelTypesEntityArray
                ...
                : IJsonElement<TopLevelTypesEntityArray>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="TopLevelTypesEntityArray"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal TopLevelTypesEntityArray(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                public Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1400.TopLevelTypesEntityArray.TopLevelTypesEntity this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1400.TopLevelTypesEntityArray.TopLevelTypesEntity>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1400.TopLevelTypesEntityArray.TopLevelTypesEntity> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForOrderingRulesSa1400.TopLevelTypesEntityArray.TopLevelTypesEntity>(_parent, _idx);
                }
                ...
                /// </returns>
                public static bool operator ==(in TopLevelTypesEntityArray left, in TopLevelTypesEntityArray right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in TopLevelTypesEntityArray left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(TopLevelTypesEntityArray instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TopLevelTypesEntityArray(JsonElement instance)
                {
                    return TopLevelTypesEntityArray.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TopLevelTypesEntityArray From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TopLevelTypesEntityArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TopLevelTypesEntityArray>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TopLevelTypesEntityArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TopLevelTypesEntityArray>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TopLevelTypesEntityArray ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TopLevelTypesEntityArray>(json, options);
                }
                ...
                /// </exception>
                public static TopLevelTypesEntityArray ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<TopLevelTypesEntityArray>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out TopLevelTypesEntityArray? result)
                {
                    return JsonElementHelpers.TryParseValue<TopLevelTypesEntityArray>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new TopLevelTypesEntityArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static TopLevelTypesEntityArray IJsonElement<TopLevelTypesEntityArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TopLevelTypesEntityArray: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="TopLevelTypesEntityArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="TopLevelTypesEntityArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public TopLevelTypesEntityArray Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<TopLevelTypesEntityArray>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="TopLevelTypesEntityArray"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public TopLevelTypesEntityArray Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<TopLevelTypesEntityArray>(_idx);
                    }
