        ...
        public readonly partial struct ConfigurationForReadabilityRulesSa1100
        {
            ...
            public readonly partial struct AllowBuiltInTypeAliasesEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<AllowBuiltInTypeAliasesEntity, Mutable>(AllowBuiltInTypeAliasesEntity.DefaultInstance);
                ...
                public static ParsedJsonDocument<AllowBuiltInTypeAliasesEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<AllowBuiltInTypeAliasesEntity>();
                    }
                    finally
                    {
