...
public readonly partial struct StylecopSchema
{
    ...
    public readonly partial struct SettingsEntity
    {
            ...
            : IJsonElement<ConfigurationForReadabilityRulesSa1100>
        {
            ...
            {
                private static readonly JsonSchemaPathProvider AllowBuiltInTypeAliasesSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/allowBuiltInTypeAliases"u8, buffer, out written);

                private static void MatchAllowBuiltInTypeAliases(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext =
                        Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForReadabilityRulesSa1100.AllowBuiltInTypeAliasesEntity.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.AllowBuiltInTypeAliasesUtf8,
                            evaluationPath: AllowBuiltInTypeAliasesSchemaEvaluationPath);

                    Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForReadabilityRulesSa1100.AllowBuiltInTypeAliasesEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                ...
                [NotNullWhen(true)]
#endif
                out Corvus.StylecopBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator? matcher)
                {
                    if (span.SequenceEqual(JsonPropertyNames.AllowBuiltInTypeAliasesUtf8))
                    {
                        matcher = MatchAllowBuiltInTypeAliases;
                        return true;
                    }
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://raw.githubusercontent.com/DotNetAnalyzers/StyleCopAnalyzers/master/StyleCop.Analyzers/StyleCop.Analyzers/Settings/stylecop.schema.json#/properties/settings/properties/readabilityRules"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "https://raw.githubusercontent.com/DotNetAnalyzers/StyleCopAnalyzers/master/StyleCop.Analyzers/StyleCop.Analyzers/Settings/stylecop.schema.json#/properties/settings/properties/readabilityRules";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://raw.githubusercontent.com/DotNetAnalyzers/StyleCopAnalyzers/master/StyleCop.Analyzers/StyleCop.Analyzers/Settings/stylecop.schema.json#/properties/settings/properties/readabilityRules"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        while (objectValidation_enumerator.MoveNext())
                        {
                            ...
                            if (TryGetNamedMatcher(objectValidation_unescapedPropertyName.Span, out Corvus.StylecopBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator? validator))
                            {
