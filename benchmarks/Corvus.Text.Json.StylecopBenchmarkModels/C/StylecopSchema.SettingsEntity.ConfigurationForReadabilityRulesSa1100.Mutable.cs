...
public readonly partial struct StylecopSchema
{
    ...
    public readonly partial struct SettingsEntity
    {
        ...
        public readonly partial struct ConfigurationForReadabilityRulesSa1100
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ConfigurationForReadabilityRulesSa1100 instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ConfigurationForReadabilityRulesSa1100"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ConfigurationForReadabilityRulesSa1100(Mutable instance)
                {
                ...
                /// <summary>
                /// Gets the (optional) <c>allowBuiltInTypeAliases</c> property.
                /// </summary>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForReadabilityRulesSa1100.AllowBuiltInTypeAliasesEntity.Mutable AllowBuiltInTypeAliases
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AllowBuiltInTypeAliasesUtf8, out Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForReadabilityRulesSa1100.AllowBuiltInTypeAliasesEntity.Mutable value))
                        {
                            return value;
                        }

                        return Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForReadabilityRulesSa1100.AllowBuiltInTypeAliasesEntity.Mutable.DefaultInstance;
                    }
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ConfigurationForReadabilityRulesSa1100(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                public void SetAllowBuiltInTypeAliases(scoped in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForReadabilityRulesSa1100.AllowBuiltInTypeAliasesEntity.Source value)
                {
                    ...
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.AllowBuiltInTypeAliasesUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AllowBuiltInTypeAliasesUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                ...
                /// <summary>
                /// Remove the <c>allowBuiltInTypeAliases</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveAllowBuiltInTypeAliases()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.AllowBuiltInTypeAliasesUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ConfigurationForReadabilityRulesSa1100.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ConfigurationForReadabilityRulesSa1100"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ConfigurationForReadabilityRulesSa1100"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ConfigurationForReadabilityRulesSa1100 Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ConfigurationForReadabilityRulesSa1100>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ConfigurationForReadabilityRulesSa1100"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ConfigurationForReadabilityRulesSa1100 Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ConfigurationForReadabilityRulesSa1100>(_idx);
                }
            }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForReadabilityRulesSa1100.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="ConfigurationForReadabilityRulesSa1100"/>.
                /// </summary>
                ...
                /// Creates an instance of a <see cref="ConfigurationForReadabilityRulesSa1100"/>.
                /// </summary>
                public void Create(in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForReadabilityRulesSa1100.AllowBuiltInTypeAliasesEntity.Source allowBuiltInTypeAliases = default)
                {
                    Create(ref _builder, allowBuiltInTypeAliases);
                }
            ...
            /// </summary>
            /// <param name="workspace">The JSON workspace.</param>
            /// <param name="allowBuiltInTypeAliases">The value of the property.</param>
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForReadabilityRulesSa1100.AllowBuiltInTypeAliasesEntity.Source allowBuiltInTypeAliases = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(allowBuiltInTypeAliases);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<ConfigurationForReadabilityRulesSa1100, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ConfigurationForReadabilityRulesSa1100> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ConfigurationForReadabilityRulesSa1100>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<ConfigurationForReadabilityRulesSa1100> Create<TContext>(
            ...
            public static ParsedJsonDocument<ConfigurationForReadabilityRulesSa1100> Create(in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForReadabilityRulesSa1100.AllowBuiltInTypeAliasesEntity.Source allowBuiltInTypeAliases = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
