            ...
            public readonly partial struct AllowedNamespaceComponentsEntityArray
            {
                ...
                public readonly partial struct AllowedNamespaceComponentsEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(AllowedNamespaceComponentsEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="AllowedNamespaceComponentsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator AllowedNamespaceComponentsEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"AllowedNamespaceComponentsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        /// <summary>
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly AllowedNamespaceComponentsEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly AllowedNamespaceComponentsEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<AllowedNamespaceComponentsEntity>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        internal Source(Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForNamingRulesSa1300.AllowedNamespaceComponentsEntityArray.AllowedNamespaceComponentsEntity.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                        public static implicit operator Source(AllowedNamespaceComponentsEntity instance) => new(JsonElement.From(instance));
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.ConfigurationForNamingRulesSa1300.AllowedNamespaceComponentsEntityArray.AllowedNamespaceComponentsEntity.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
                    ...
                    {
                        return workspace.CreateBuilder<AllowedNamespaceComponentsEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<AllowedNamespaceComponentsEntity> Create(
                        scoped in Source value, int initialCapacity = 30)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<AllowedNamespaceComponentsEntity>();
                        }
                        finally
                        {
