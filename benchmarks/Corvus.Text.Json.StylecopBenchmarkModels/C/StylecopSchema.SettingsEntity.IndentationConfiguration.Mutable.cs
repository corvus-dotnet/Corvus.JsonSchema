    ...
    public readonly partial struct SettingsEntity
    {
        ...
        public readonly partial struct IndentationConfiguration
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.IndentationConfiguration.SpecifiesTheIndentationSize.Mutable IndentationSize
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IndentationSizeUtf8, out Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.IndentationConfiguration.SpecifiesTheIndentationSize.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.IndentationConfiguration.SpecifiesTheTabWidth.Mutable TabSize
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TabSizeUtf8, out Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.IndentationConfiguration.SpecifiesTheTabWidth.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.IndentationConfiguration.UseTabsEntity.Mutable UseTabs
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UseTabsUtf8, out Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.IndentationConfiguration.UseTabsEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.IndentationConfiguration.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.IndentationConfiguration.SpecifiesTheIndentationSize.Source indentationSize = default,
            ...
            public static ParsedJsonDocument<IndentationConfiguration> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<IndentationConfiguration>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<IndentationConfiguration> Create<TContext>(
            ...
            public static ParsedJsonDocument<IndentationConfiguration> Create(in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.IndentationConfiguration.SpecifiesTheIndentationSize.Source indentationSize = default, in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.IndentationConfiguration.SpecifiesTheTabWidth.Source tabSize = default, in Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity.IndentationConfiguration.UseTabsEntity.Source useTabs = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
