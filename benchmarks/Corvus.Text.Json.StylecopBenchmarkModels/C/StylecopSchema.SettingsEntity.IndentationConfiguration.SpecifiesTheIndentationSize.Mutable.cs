        ...
        public readonly partial struct IndentationConfiguration
        {
            ...
            public readonly partial struct SpecifiesTheIndentationSize
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SpecifiesTheIndentationSize, Mutable>(SpecifiesTheIndentationSize.DefaultInstance);
                    ...
                    public static explicit operator Mutable(SpecifiesTheIndentationSize instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="SpecifiesTheIndentationSize"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator SpecifiesTheIndentationSize(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"SpecifiesTheIndentationSize.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly SpecifiesTheIndentationSize Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly SpecifiesTheIndentationSize Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<SpecifiesTheIndentationSize>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(SpecifiesTheIndentationSize instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<SpecifiesTheIndentationSize, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<SpecifiesTheIndentationSize> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<SpecifiesTheIndentationSize>();
                    }
                    finally
                    {
