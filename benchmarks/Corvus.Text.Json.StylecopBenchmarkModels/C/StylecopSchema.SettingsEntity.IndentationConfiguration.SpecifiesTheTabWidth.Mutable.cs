...
public readonly partial struct StylecopSchema
{
    ...
    public readonly partial struct SettingsEntity
    {
        ...
        public readonly partial struct IndentationConfiguration
        {
            ...
            public readonly partial struct SpecifiesTheTabWidth
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SpecifiesTheTabWidth, Mutable>(SpecifiesTheTabWidth.DefaultInstance);
                    ...
                    public static explicit operator Mutable(SpecifiesTheTabWidth instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="SpecifiesTheTabWidth"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator SpecifiesTheTabWidth(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new SpecifiesTheTabWidth(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"SpecifiesTheTabWidth.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="SpecifiesTheTabWidth"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="SpecifiesTheTabWidth"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly SpecifiesTheTabWidth Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<SpecifiesTheTabWidth>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="SpecifiesTheTabWidth"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly SpecifiesTheTabWidth Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<SpecifiesTheTabWidth>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(SpecifiesTheTabWidth instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<SpecifiesTheTabWidth, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<SpecifiesTheTabWidth> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<SpecifiesTheTabWidth>();
                    }
                    finally
                    {
