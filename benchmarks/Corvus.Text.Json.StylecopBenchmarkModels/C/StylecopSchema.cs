...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="StylecopSchema"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal StylecopSchema(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static StylecopSchema DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity Settings
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SettingsUtf8, out Corvus.StylecopBenchmark.Current.StylecopSchema.SettingsEntity value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in StylecopSchema left, in StylecopSchema right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in StylecopSchema left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(StylecopSchema instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator StylecopSchema(JsonElement instance)
    {
        return StylecopSchema.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static StylecopSchema From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static StylecopSchema ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<StylecopSchema>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static StylecopSchema ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<StylecopSchema>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static StylecopSchema ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<StylecopSchema>(json, options);
    }
    ...
    /// </exception>
    public static StylecopSchema ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<StylecopSchema>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out StylecopSchema? result)
    {
        return JsonElementHelpers.TryParseValue<StylecopSchema>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new StylecopSchema(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static StylecopSchema IJsonElement<StylecopSchema>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"StylecopSchema: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="StylecopSchema"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="StylecopSchema"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public StylecopSchema Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<StylecopSchema>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="StylecopSchema"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public StylecopSchema Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<StylecopSchema>(_idx);
        }
