...
public readonly partial struct Schema
{
    ...
    public readonly partial struct NameEntity
    {
...
#endif
        {
            ...
            public static explicit operator Corvus.TmuxinatorBenchmark.Baseline.Schema.NameEntity.OneOf1Entity.Mutable(Mutable value)
            {
                return Corvus.TmuxinatorBenchmark.Baseline.Schema.NameEntity.OneOf1Entity.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.TmuxinatorBenchmark.Baseline.Schema.NameEntity.OneOf1Entity.Mutable value)
            {
                return From(value);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.TmuxinatorBenchmark.Baseline.Schema.NameEntity.Mutable, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                {
                    return matchOneOf1Entity(Corvus.TmuxinatorBenchmark.Baseline.Schema.NameEntity.OneOf1Entity.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.TmuxinatorBenchmark.Baseline.Schema.NameEntity.Mutable, TResult> defaultMatch)
            {
                if (Corvus.TmuxinatorBenchmark.Baseline.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                {
                ...
                if (Corvus.TmuxinatorBenchmark.Baseline.Schema.NameEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchOneOf1Entity(Corvus.TmuxinatorBenchmark.Baseline.Schema.NameEntity.OneOf1Entity.Mutable.From(this));
                }
            ...
            public bool TryGetAsOneOf1Entity(out Corvus.TmuxinatorBenchmark.Baseline.Schema.NameEntity.OneOf1Entity result)
            {
                if (Corvus.TmuxinatorBenchmark.Baseline.Schema.NameEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.TmuxinatorBenchmark.Baseline.Schema.NameEntity.OneOf1Entity.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.TmuxinatorBenchmark.Baseline.Schema.NameEntity.OneOf1Entity instance) => new(JsonElement.From(instance));
