...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Conversion to <see cref="Corvus.TmuxinatorBenchmark.Baseline.Schema.NameEntity.OneOf1Entity"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.TmuxinatorBenchmark.Baseline.Schema.NameEntity.OneOf1Entity(NameEntity value)
        {
            return Corvus.TmuxinatorBenchmark.Baseline.Schema.NameEntity.OneOf1Entity.From(value);
        }

        /// <summary>
        /// Conversion from <see cref="Corvus.TmuxinatorBenchmark.Baseline.Schema.NameEntity.OneOf1Entity"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator NameEntity(Corvus.TmuxinatorBenchmark.Baseline.Schema.NameEntity.OneOf1Entity value)
        {
            return From(value);
        }
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.TmuxinatorBenchmark.Baseline.Schema.NameEntity.OneOf1Entity" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsOneOf1Entity(out Corvus.TmuxinatorBenchmark.Baseline.Schema.NameEntity.OneOf1Entity result)
        {
            if (Corvus.TmuxinatorBenchmark.Baseline.Schema.NameEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.TmuxinatorBenchmark.Baseline.Schema.NameEntity.OneOf1Entity.From(this);
                return true;
            }
        ...
        /// <param name="matchOneOf1Entity">Match a <see cref="Corvus.TmuxinatorBenchmark.Baseline.Schema.NameEntity.OneOf1Entity"/>.</param>
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.TmuxinatorBenchmark.Baseline.Schema.NameEntity.OneOf1Entity, TContext, TResult> matchOneOf1Entity,
            Matcher<Corvus.TmuxinatorBenchmark.Baseline.Schema.NameEntity, TContext, TResult> defaultMatch)
...
#endif
        {
            ...
            if (Corvus.TmuxinatorBenchmark.Baseline.Schema.NameEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchOneOf1Entity(Corvus.TmuxinatorBenchmark.Baseline.Schema.NameEntity.OneOf1Entity.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.TmuxinatorBenchmark.Baseline.Schema.NameEntity.OneOf1Entity, TResult> matchOneOf1Entity,
            Matcher<Corvus.TmuxinatorBenchmark.Baseline.Schema.NameEntity, TResult> defaultMatch)
        {
            if (Corvus.TmuxinatorBenchmark.Baseline.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
            {
            ...
            if (Corvus.TmuxinatorBenchmark.Baseline.Schema.NameEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchOneOf1Entity(Corvus.TmuxinatorBenchmark.Baseline.Schema.NameEntity.OneOf1Entity.From(this));
            }
