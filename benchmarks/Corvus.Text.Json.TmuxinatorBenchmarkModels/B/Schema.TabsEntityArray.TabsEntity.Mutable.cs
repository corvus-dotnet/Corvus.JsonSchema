    ...
    public readonly partial struct TabsEntityArray
    {
        ...
        public readonly partial struct TabsEntity
        {
...
#endif
            {
                ...
                public static explicit operator Corvus.TmuxinatorBenchmark.Baseline.Schema.TabsEntityArray.TabsEntity.OneOf1Entity.Mutable(Mutable value)
                {
                    return Corvus.TmuxinatorBenchmark.Baseline.Schema.TabsEntityArray.TabsEntity.OneOf1Entity.Mutable.From(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.TmuxinatorBenchmark.Baseline.Schema.TabsEntityArray.TabsEntity.OneOf1Entity.Mutable value)
                {
                    return From(value);
                }
                ...
                /// </remarks>
                public void Apply(in Corvus.TmuxinatorBenchmark.Baseline.Schema.TabsEntityArray.TabsEntity.OneOf1Entity value)
                {
                    CheckValidInstance();
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.TmuxinatorBenchmark.Baseline.Schema.TabsEntityArray.TabsEntity.Mutable, TContext, TResult> defaultMatch)
...
#endif
                {
                    ...
                    {
                        return matchJsonString(Corvus.TmuxinatorBenchmark.Baseline.JsonString.Mutable.From(this), context);
                    }

                    if (Corvus.TmuxinatorBenchmark.Baseline.Schema.TabsEntityArray.TabsEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchOneOf1Entity(Corvus.TmuxinatorBenchmark.Baseline.Schema.TabsEntityArray.TabsEntity.OneOf1Entity.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.TmuxinatorBenchmark.Baseline.Schema.TabsEntityArray.TabsEntity.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.TmuxinatorBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchJsonString(Corvus.TmuxinatorBenchmark.Baseline.JsonString.Mutable.From(this));
                    }

                    if (Corvus.TmuxinatorBenchmark.Baseline.Schema.TabsEntityArray.TabsEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchOneOf1Entity(Corvus.TmuxinatorBenchmark.Baseline.Schema.TabsEntityArray.TabsEntity.OneOf1Entity.Mutable.From(this));
                    }
                ...
                public bool TryGetAsJsonString(out Corvus.TmuxinatorBenchmark.Baseline.JsonString result)
                {
                    if (Corvus.TmuxinatorBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.TmuxinatorBenchmark.Baseline.JsonString.Mutable.From(this);
                        return true;
                    }
                ...
                public bool TryGetAsOneOf1Entity(out Corvus.TmuxinatorBenchmark.Baseline.Schema.TabsEntityArray.TabsEntity.OneOf1Entity result)
                {
                    if (Corvus.TmuxinatorBenchmark.Baseline.Schema.TabsEntityArray.TabsEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.TmuxinatorBenchmark.Baseline.Schema.TabsEntityArray.TabsEntity.OneOf1Entity.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.TmuxinatorBenchmark.Baseline.Schema.TabsEntityArray.TabsEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.TmuxinatorBenchmark.Baseline.JsonString instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.TmuxinatorBenchmark.Baseline.Schema.TabsEntityArray.TabsEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
