        ...
        public readonly partial struct TabsEntity
        {
            ...
            public readonly partial struct OneOf1Entity
            {
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.TmuxinatorBenchmark.Baseline.Schema.TabsEntityArray.TabsEntity.OneOf1Entity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.TmuxinatorBenchmark.Baseline.Schema.TabsEntityArray.TabsEntity.OneOf1Entity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
