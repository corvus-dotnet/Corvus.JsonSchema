...
public readonly partial struct Schema
{
    ...
    public readonly partial struct TabsEntityArray
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="TabsEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal TabsEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static TabsEntity DefaultInstance { get; }
            ...
            /// <summary>
            /// Conversion to <see cref="Corvus.TmuxinatorBenchmark.Baseline.Schema.TabsEntityArray.TabsEntity.OneOf1Entity"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.TmuxinatorBenchmark.Baseline.Schema.TabsEntityArray.TabsEntity.OneOf1Entity(TabsEntity value)
            {
                return Corvus.TmuxinatorBenchmark.Baseline.Schema.TabsEntityArray.TabsEntity.OneOf1Entity.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.TmuxinatorBenchmark.Baseline.Schema.TabsEntityArray.TabsEntity.OneOf1Entity"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator TabsEntity(Corvus.TmuxinatorBenchmark.Baseline.Schema.TabsEntityArray.TabsEntity.OneOf1Entity value)
            {
                return From(value);
            }
            ...
            /// </returns>
            public static bool operator ==(in TabsEntity left, in TabsEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in TabsEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(TabsEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TabsEntity(JsonElement instance)
            {
                return TabsEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TabsEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TabsEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TabsEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TabsEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TabsEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TabsEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TabsEntity>(json, options);
            }
            ...
            /// </exception>
            public static TabsEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<TabsEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out TabsEntity? result)
            {
                return JsonElementHelpers.TryParseValue<TabsEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new TabsEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static TabsEntity IJsonElement<TabsEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TabsEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="TabsEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="TabsEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public TabsEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<TabsEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="TabsEntity"/> that lives for the lifetime of its
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.TmuxinatorBenchmark.Baseline.Schema.TabsEntityArray.TabsEntity.OneOf1Entity" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsOneOf1Entity(out Corvus.TmuxinatorBenchmark.Baseline.Schema.TabsEntityArray.TabsEntity.OneOf1Entity result)
            {
                if (Corvus.TmuxinatorBenchmark.Baseline.Schema.TabsEntityArray.TabsEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.TmuxinatorBenchmark.Baseline.Schema.TabsEntityArray.TabsEntity.OneOf1Entity.From(this);
                    return true;
                }
            ...
            /// <param name="matchOneOf1Entity">Match a <see cref="Corvus.TmuxinatorBenchmark.Baseline.Schema.TabsEntityArray.TabsEntity.OneOf1Entity"/>.</param>
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.TmuxinatorBenchmark.Baseline.Schema.TabsEntityArray.TabsEntity.OneOf1Entity, TContext, TResult> matchOneOf1Entity,
                Matcher<Corvus.TmuxinatorBenchmark.Baseline.Schema.TabsEntityArray.TabsEntity, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                if (Corvus.TmuxinatorBenchmark.Baseline.Schema.TabsEntityArray.TabsEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchOneOf1Entity(Corvus.TmuxinatorBenchmark.Baseline.Schema.TabsEntityArray.TabsEntity.OneOf1Entity.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.TmuxinatorBenchmark.Baseline.Schema.TabsEntityArray.TabsEntity.OneOf1Entity, TResult> matchOneOf1Entity,
                Matcher<Corvus.TmuxinatorBenchmark.Baseline.Schema.TabsEntityArray.TabsEntity, TResult> defaultMatch)
            {
                if (Corvus.TmuxinatorBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                ...
                if (Corvus.TmuxinatorBenchmark.Baseline.Schema.TabsEntityArray.TabsEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchOneOf1Entity(Corvus.TmuxinatorBenchmark.Baseline.Schema.TabsEntityArray.TabsEntity.OneOf1Entity.From(this));
                }
