...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        public Corvus.TmuxinatorBenchmark.Baseline.Schema.TabsEntityArray.TabsEntity this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.TmuxinatorBenchmark.Baseline.Schema.TabsEntityArray.TabsEntity>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.TmuxinatorBenchmark.Baseline.Schema.TabsEntityArray.TabsEntity> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.TmuxinatorBenchmark.Baseline.Schema.TabsEntityArray.TabsEntity>(_parent, _idx);
        }
