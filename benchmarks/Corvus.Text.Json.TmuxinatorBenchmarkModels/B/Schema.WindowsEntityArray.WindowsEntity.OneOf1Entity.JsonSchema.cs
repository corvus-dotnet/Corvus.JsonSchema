                ...
                : IJsonElement<OneOf1Entity>
            {
                public static partial class JsonSchema
                {
                    ...
                    private static void MatchLayout(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                    {
                        ...
                        Corvus.TmuxinatorBenchmark.Baseline.JsonString.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                    ...
                    private static void MatchPanes(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                    {
                        ...
                        JsonSchemaContext childContext1 =
                            Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity.PanesEntityArray.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                                parentDocumentIndex,
                                ref context,
                        ...
                        Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity.PanesEntityArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                    ...
                    private static void MatchPre(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                    {
                        ...
                        JsonSchemaContext childContext2 =
                            Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity.JsonStringArray.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                                parentDocumentIndex,
                                ref context,
                        ...
                        Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity.JsonStringArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
