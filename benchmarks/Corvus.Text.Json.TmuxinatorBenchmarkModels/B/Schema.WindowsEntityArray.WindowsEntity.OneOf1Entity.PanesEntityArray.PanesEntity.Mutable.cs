                ...
                public readonly partial struct PanesEntityArray
                {
                    ...
                    public readonly partial struct PanesEntity
                    {
...
#endif
                        {
                            ...
                            public static explicit operator Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity.PanesEntityArray.PanesEntity.OneOf1Entity.Mutable(Mutable value)
                            {
                                return Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity.PanesEntityArray.PanesEntity.OneOf1Entity.Mutable.From(value);
                            }
                            ...
                            /// </summary>
                            /// <param name="value">The value from which to convert.</param>
                            public static implicit operator Mutable(Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity.PanesEntityArray.PanesEntity.OneOf1Entity.Mutable value)
                            {
                                return From(value);
                            }
                            ...
                            /// </summary>
                            /// <param name="value">The value from which to convert.</param>
                            public static explicit operator Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity.PanesEntityArray.PanesEntity.JsonStringArray.Mutable(Mutable value)
                            {
                                return Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity.PanesEntityArray.PanesEntity.JsonStringArray.Mutable.From(value);
                            }
                            ...
                            /// </summary>
                            /// <param name="value">The value from which to convert.</param>
                            public static implicit operator Mutable(Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity.PanesEntityArray.PanesEntity.JsonStringArray.Mutable value)
                            {
                                return From(value);
                            }
                            ...
                            public static explicit operator Mutable(PanesEntity instance)
                            {
                            ...
                            /// <returns>An immutable instance of a <see cref="PanesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator PanesEntity(Mutable instance)
                            {
                            ...
                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            private string DebuggerDisplay => $"PanesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                            /// <summary>
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly PanesEntity Clone()
                            {
                                CheckValidInstance();
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly PanesEntity Freeze()
                            {
                                CheckValidInstance();
                                return _parent.FreezeElement<PanesEntity>(_idx);
                            }
                            ...
                            public TResult Match<TContext, TResult>(
                                ...
                                Matcher<Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity.PanesEntityArray.PanesEntity.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                            where TContext : allows ref struct
#endif
                            {
                                ...
                                {
                                    return matchJsonNumber(Corvus.TmuxinatorBenchmark.Baseline.JsonNumber.Mutable.From(this), context);
                                }
                                ...
                                {
                                    return matchOneOf1Entity(Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity.PanesEntityArray.PanesEntity.OneOf1Entity.Mutable.From(this), context);
                                }
                                ...
                                {
                                    return matchJsonStringArray(Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity.PanesEntityArray.PanesEntity.JsonStringArray.Mutable.From(this), context);
                                }
                            ...
                            public TResult Match<TResult>(
                                ...
                                Matcher<Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity.PanesEntityArray.PanesEntity.Mutable, TResult> defaultMatch)
                            {
                                if (Corvus.TmuxinatorBenchmark.Baseline.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                                {
                                    return matchJsonNumber(Corvus.TmuxinatorBenchmark.Baseline.JsonNumber.Mutable.From(this));
                                }

                                if (Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity.PanesEntityArray.PanesEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                                {
                                    return matchOneOf1Entity(Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity.PanesEntityArray.PanesEntity.OneOf1Entity.Mutable.From(this));
                                }

                                if (Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity.PanesEntityArray.PanesEntity.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                                {
                                    return matchJsonStringArray(Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity.PanesEntityArray.PanesEntity.JsonStringArray.Mutable.From(this));
                                }
                            ...
                            public bool TryGetAsJsonNumber(out Corvus.TmuxinatorBenchmark.Baseline.JsonNumber result)
                            {
                                if (Corvus.TmuxinatorBenchmark.Baseline.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                                {
                                    result = Corvus.TmuxinatorBenchmark.Baseline.JsonNumber.Mutable.From(this);
                                    return true;
                                }
                            ...
                            public bool TryGetAsOneOf1Entity(out Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity.PanesEntityArray.PanesEntity.OneOf1Entity result)
                            {
                                if (Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity.PanesEntityArray.PanesEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                                {
                                    result = Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity.PanesEntityArray.PanesEntity.OneOf1Entity.Mutable.From(this);
                                    return true;
                                }
                            ...
                            public bool TryGetAsJsonStringArray(out Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity.PanesEntityArray.PanesEntity.JsonStringArray result)
                            {
                                if (Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity.PanesEntityArray.PanesEntity.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                                {
                                    result = Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity.PanesEntityArray.PanesEntity.JsonStringArray.Mutable.From(this);
                                    return true;
                                }
                        ...
                        public ref struct Source
                        {
                            ...
                            internal Source(Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity.PanesEntityArray.PanesEntity.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                            public static implicit operator Source(PanesEntity instance) => new(JsonElement.From(instance));
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator Source(Corvus.TmuxinatorBenchmark.Baseline.JsonNumber instance) => new(JsonElement.From(instance));

                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator Source(Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity.PanesEntityArray.PanesEntity.OneOf1Entity instance) => new(JsonElement.From(instance));
                            ...
                            #endif
                        {
                            ...
                            internal Source(scoped in TContext context, Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity.PanesEntityArray.PanesEntity.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
                        ...
                        {
                            return workspace.CreateBuilder<PanesEntity, Mutable>(this);
                        }
                    }
                }
            }
