        ...
        public readonly partial struct WindowsEntity
        {
            ...
            public readonly partial struct OneOf1Entity
            {
...
#endif
                {
                    ...
                    public Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity.PanesEntityArray.PanesEntity this[int index]
                    {
                        get
                        {
                            CheckValidInstance();
                            return _parent.GetArrayIndexElement<Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity.PanesEntityArray.PanesEntity>(_idx, index);
                        }
                    }
                    ...
                    /// </summary>
                    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                    public ArrayEnumerator<Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity.PanesEntityArray.PanesEntity> EnumerateArray()
                    {
                        CheckValidInstance();
                        return EnumeratorCreator.CreateArrayEnumerator<Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity.PanesEntityArray.PanesEntity>(_parent, _idx);
                    }
