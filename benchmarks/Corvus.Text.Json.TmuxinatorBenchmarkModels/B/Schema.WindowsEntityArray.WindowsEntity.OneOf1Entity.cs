    ...
    public readonly partial struct WindowsEntityArray
    {
        ...
        public readonly partial struct WindowsEntity
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.TmuxinatorBenchmark.Baseline.JsonString Layout
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LayoutUtf8, out Corvus.TmuxinatorBenchmark.Baseline.JsonString value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity.PanesEntityArray Panes
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PanesUtf8, out Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity.PanesEntityArray value))
                        {
                            return value;
                        }
                ...
                /// </summary>
                public Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity.JsonStringArray Pre
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PreUtf8, out Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity.JsonStringArray value))
                        {
                            return value;
                        }
