...
public readonly partial struct Schema
{
    ...
    public readonly partial struct WindowsEntityArray
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="WindowsEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal WindowsEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static WindowsEntity DefaultInstance { get; }
            ...
            /// <summary>
            /// Conversion to <see cref="Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity(WindowsEntity value)
            {
                return Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator WindowsEntity(Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity value)
            {
                return From(value);
            }
            ...
            /// </returns>
            public static bool operator ==(in WindowsEntity left, in WindowsEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in WindowsEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(WindowsEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator WindowsEntity(JsonElement instance)
            {
                return WindowsEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WindowsEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WindowsEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<WindowsEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WindowsEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<WindowsEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WindowsEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<WindowsEntity>(json, options);
            }
            ...
            /// </exception>
            public static WindowsEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<WindowsEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out WindowsEntity? result)
            {
                return JsonElementHelpers.TryParseValue<WindowsEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new WindowsEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static WindowsEntity IJsonElement<WindowsEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"WindowsEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="WindowsEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="WindowsEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public WindowsEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<WindowsEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="WindowsEntity"/> that lives for the lifetime of its
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.TmuxinatorBenchmark.Baseline.JsonString" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsJsonString(out Corvus.TmuxinatorBenchmark.Baseline.JsonString result)
            {
                if (Corvus.TmuxinatorBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.TmuxinatorBenchmark.Baseline.JsonString.From(this);
                    return true;
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsOneOf1Entity(out Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity result)
            {
                if (Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity.From(this);
                    return true;
                }
            ...
            /// <param name="matchJsonString">Match a <see cref="Corvus.TmuxinatorBenchmark.Baseline.JsonString"/>.</param>
            /// <param name="matchOneOf1Entity">Match a <see cref="Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity"/>.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Matcher<Corvus.TmuxinatorBenchmark.Baseline.JsonString, TContext, TResult> matchJsonString,
                Matcher<Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity, TContext, TResult> matchOneOf1Entity,
                Matcher<Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity, TContext, TResult> defaultMatch)
...
#endif
            {
                if (Corvus.TmuxinatorBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonString(Corvus.TmuxinatorBenchmark.Baseline.JsonString.From(this), context);
                }

                if (Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchOneOf1Entity(Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                Matcher<Corvus.TmuxinatorBenchmark.Baseline.JsonString, TResult> matchJsonString,
                Matcher<Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity, TResult> matchOneOf1Entity,
                Matcher<Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity, TResult> defaultMatch)
            {
                if (Corvus.TmuxinatorBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonString(Corvus.TmuxinatorBenchmark.Baseline.JsonString.From(this));
                }

                if (Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchOneOf1Entity(Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity.OneOf1Entity.From(this));
                }
