...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        public Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.TmuxinatorBenchmark.Baseline.Schema.WindowsEntityArray.WindowsEntity>(_parent, _idx);
        }
