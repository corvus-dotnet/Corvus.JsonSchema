...
public readonly partial struct TmuxinatorSchema
{
    ...
    public readonly partial struct DefaultsEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(DefaultsEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="DefaultsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DefaultsEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DefaultsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly DefaultsEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly DefaultsEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<DefaultsEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.DefaultsEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(DefaultsEntity instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.DefaultsEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<DefaultsEntity, Mutable>(this);
        }
    }
}
