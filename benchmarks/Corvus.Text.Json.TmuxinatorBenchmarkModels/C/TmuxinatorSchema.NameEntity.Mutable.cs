...
public readonly partial struct TmuxinatorSchema
{
    ...
    public readonly partial struct NameEntity
    {
...
#endif
        {
            ...
            public static explicit operator Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.NameEntity.OneOf1Entity.Mutable(Mutable value)
            {
                return Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.NameEntity.OneOf1Entity.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.NameEntity.OneOf1Entity.Mutable value)
            {
                return From(value);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.NameEntity.Mutable, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                {
                    return matchJsonNumber(Corvus.TmuxinatorBenchmark.Current.JsonNumber.Mutable.From(this), context);
                }

                if (Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.NameEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchOneOf1Entity(Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.NameEntity.OneOf1Entity.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.NameEntity.Mutable, TResult> defaultMatch)
            {
                if (Corvus.TmuxinatorBenchmark.Current.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonNumber(Corvus.TmuxinatorBenchmark.Current.JsonNumber.Mutable.From(this));
                }

                if (Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.NameEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchOneOf1Entity(Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.NameEntity.OneOf1Entity.Mutable.From(this));
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.TmuxinatorBenchmark.Current.JsonNumber.Mutable" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsJsonNumber(out Corvus.TmuxinatorBenchmark.Current.JsonNumber.Mutable result)
            {
                if (Corvus.TmuxinatorBenchmark.Current.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.TmuxinatorBenchmark.Current.JsonNumber.Mutable.From(this);
                    return true;
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.NameEntity.OneOf1Entity.Mutable" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsOneOf1Entity(out Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.NameEntity.OneOf1Entity.Mutable result)
            {
                if (Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.NameEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.NameEntity.OneOf1Entity.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.TmuxinatorBenchmark.Current.JsonNumber instance) => new(JsonElement.From(instance));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.NameEntity.OneOf1Entity instance) => new(JsonElement.From(instance));
