...
public readonly partial struct TmuxinatorSchema
{
    ...
    public readonly partial struct TabsEntityArray
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(TabsEntityArray instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="TabsEntityArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TabsEntityArray(Mutable instance)
            {
            ...
            public Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.TabsEntityArray.TabsEntity.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.TabsEntityArray.TabsEntity.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.TabsEntityArray.TabsEntity.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.TabsEntityArray.TabsEntity.Mutable>(_parent, _idx);
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TabsEntityArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.TabsEntityArray.TabsEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, scoped in Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.TabsEntityArray.TabsEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(scoped in Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.TabsEntityArray.TabsEntity.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.TabsEntityArray.TabsEntity item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.TabsEntityArray.TabsEntity>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.TabsEntityArray.TabsEntity> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.TabsEntityArray.TabsEntity>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.TabsEntityArray.TabsEntity oldItem, in Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.TabsEntityArray.TabsEntity.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.TabsEntityArray.TabsEntity>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.TabsEntityArray.TabsEntity current = enumerator.Current;
            ...
            /// </para>
            /// </remarks>
            public readonly TabsEntityArray Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly TabsEntityArray Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<TabsEntityArray>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.TabsEntityArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(TabsEntityArray instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.TabsEntityArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            public void AddItem(in Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.TabsEntityArray.TabsEntity.Source value)
            {
            ...
            /// Add an item to the array.
            /// </summary>
            public void AddItem<TContext>(in Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.TabsEntityArray.TabsEntity.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        {
            return workspace.CreateBuilder<TabsEntityArray, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<TabsEntityArray> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<TabsEntityArray>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<TabsEntityArray> Create<TContext>(
