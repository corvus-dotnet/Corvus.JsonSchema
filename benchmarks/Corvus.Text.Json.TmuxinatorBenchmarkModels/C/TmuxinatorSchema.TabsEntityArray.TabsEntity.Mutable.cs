    ...
    public readonly partial struct TabsEntityArray
    {
        ...
        public readonly partial struct TabsEntity
        {
...
#endif
            {
                ...
                public static explicit operator Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.TabsEntityArray.TabsEntity.OneOf1Entity.Mutable(Mutable value)
                {
                    return Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.TabsEntityArray.TabsEntity.OneOf1Entity.Mutable.From(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.TabsEntityArray.TabsEntity.OneOf1Entity.Mutable value)
                {
                    return From(value);
                }
                ...
                public static explicit operator Mutable(TabsEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TabsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TabsEntity(Mutable instance)
                {
                ...
                /// </remarks>
                public void Apply(in Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.TabsEntityArray.TabsEntity.OneOf1Entity value)
                {
                    CheckValidInstance();
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TabsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly TabsEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly TabsEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TabsEntity>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.TabsEntityArray.TabsEntity.Mutable, TContext, TResult> defaultMatch)
...
#endif
                {
                    ...
                    {
                        return matchOneOf1Entity(Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.TabsEntityArray.TabsEntity.OneOf1Entity.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.TabsEntityArray.TabsEntity.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.TmuxinatorBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                    {
                    ...
                    if (Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.TabsEntityArray.TabsEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchOneOf1Entity(Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.TabsEntityArray.TabsEntity.OneOf1Entity.Mutable.From(this));
                    }
                ...
                public bool TryGetAsOneOf1Entity(out Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.TabsEntityArray.TabsEntity.OneOf1Entity result)
                {
                    if (Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.TabsEntityArray.TabsEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.TabsEntityArray.TabsEntity.OneOf1Entity.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.TabsEntityArray.TabsEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(TabsEntity instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.TabsEntityArray.TabsEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<TabsEntity, Mutable>(this);
            }
        }
    }
}
