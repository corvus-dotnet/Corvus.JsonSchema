...
public readonly partial struct TmuxinatorSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TabsEntityArray"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal TabsEntityArray(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static TabsEntityArray DefaultInstance { get; }
        ...
        public Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.TabsEntityArray.TabsEntity this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.TabsEntityArray.TabsEntity>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.TabsEntityArray.TabsEntity> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.TabsEntityArray.TabsEntity>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in TabsEntityArray left, in TabsEntityArray right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in TabsEntityArray left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(TabsEntityArray instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TabsEntityArray(JsonElement instance)
        {
            return TabsEntityArray.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TabsEntityArray From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TabsEntityArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TabsEntityArray>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TabsEntityArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TabsEntityArray>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TabsEntityArray ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TabsEntityArray>(json, options);
        }
        ...
        /// </exception>
        public static TabsEntityArray ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<TabsEntityArray>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out TabsEntityArray? result)
        {
            return JsonElementHelpers.TryParseValue<TabsEntityArray>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new TabsEntityArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static TabsEntityArray IJsonElement<TabsEntityArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TabsEntityArray: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="TabsEntityArray"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="TabsEntityArray"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public TabsEntityArray Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<TabsEntityArray>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="TabsEntityArray"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public TabsEntityArray Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<TabsEntityArray>(_idx);
            }
