        ...
        public readonly partial struct WindowsEntity
        {
            ...
            public readonly partial struct OneOf1Entity
            {
...
#endif
                {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.TmuxinatorBenchmark.Current.JsonString.Mutable Layout
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LayoutUtf8, out Corvus.TmuxinatorBenchmark.Current.JsonString.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.WindowsEntityArray.WindowsEntity.OneOf1Entity.PanesEntityArray.Mutable Panes
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PanesUtf8, out Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.WindowsEntityArray.WindowsEntity.OneOf1Entity.PanesEntityArray.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// </summary>
                    public Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.WindowsEntityArray.WindowsEntity.OneOf1Entity.JsonStringArray.Mutable Pre
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PreUtf8, out Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.WindowsEntityArray.WindowsEntity.OneOf1Entity.JsonStringArray.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetPanes<TContext>(in Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.WindowsEntityArray.WindowsEntity.OneOf1Entity.PanesEntityArray.Source<TContext> value)
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetPre<TContext>(in Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.WindowsEntityArray.WindowsEntity.OneOf1Entity.JsonStringArray.Source<TContext> value)
#if NET9_0_OR_GREATER
                        where TContext : allows ref struct
#endif
                    {
                ...
                public ref struct Source
                {
                    ...
                    private readonly Corvus.TmuxinatorBenchmark.Current.JsonString.Source _createArg1;
                    private readonly Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.WindowsEntityArray.WindowsEntity.OneOf1Entity.PanesEntityArray.Source _createArg2;
                    private readonly Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.WindowsEntityArray.WindowsEntity.OneOf1Entity.JsonStringArray.Source _createArg3;
                    ...
                    #endif
                {
                    ...
                    private readonly Corvus.TmuxinatorBenchmark.Current.JsonString.Source _createArg1;
                    private readonly Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.WindowsEntityArray.WindowsEntity.OneOf1Entity.PanesEntityArray.Source<TContext> _createArg2;
                    private readonly Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.WindowsEntityArray.WindowsEntity.OneOf1Entity.JsonStringArray.Source<TContext> _createArg3;
                ...
                public ref struct Builder
                {
                    ...
                    internal static void Create(
                        ...
                        in Corvus.TmuxinatorBenchmark.Current.JsonString.Source layout = default,
                    ...
                    internal static void Create<TContext>(
                        ...
                        ref ComplexValueBuilder builder,
                        in Corvus.TmuxinatorBenchmark.Current.JsonString.Source layout = default,
                        in Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.WindowsEntityArray.WindowsEntity.OneOf1Entity.PanesEntityArray.Source<TContext> panes = default,
                        in Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.WindowsEntityArray.WindowsEntity.OneOf1Entity.JsonStringArray.Source<TContext> pre = default)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                    {
                ...
                /// </summary>
                /// <param name="layout">The value of the <c>"layout"</c> property.</param>
                ...
                public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.TmuxinatorBenchmark.Current.JsonString.Source layout = default, scoped in Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.WindowsEntityArray.WindowsEntity.OneOf1Entity.PanesEntityArray.Source<TContext> panes = default, scoped in Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.WindowsEntityArray.WindowsEntity.OneOf1Entity.JsonStringArray.Source<TContext> pre = default)
                    ...
                    #endif
                {
                    return new Source<TContext>(context, layout, panes, pre);
                }
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.TmuxinatorBenchmark.Current.JsonString.Source layout = default, in Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.WindowsEntityArray.WindowsEntity.OneOf1Entity.PanesEntityArray.Source<TContext> panes = default, in Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.WindowsEntityArray.WindowsEntity.OneOf1Entity.JsonStringArray.Source<TContext> pre = default, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
                ...
                public static ParsedJsonDocument<OneOf1Entity> Create(in Corvus.TmuxinatorBenchmark.Current.JsonString.Source layout = default, in Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.WindowsEntityArray.WindowsEntity.OneOf1Entity.PanesEntityArray.Source panes = default, in Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.WindowsEntityArray.WindowsEntity.OneOf1Entity.JsonStringArray.Source pre = default, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
                public static ParsedJsonDocument<OneOf1Entity> Create<TContext>(in TContext context, in Corvus.TmuxinatorBenchmark.Current.JsonString.Source layout = default, in Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.WindowsEntityArray.WindowsEntity.OneOf1Entity.PanesEntityArray.Source<TContext> panes = default, in Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.WindowsEntityArray.WindowsEntity.OneOf1Entity.JsonStringArray.Source<TContext> pre = default, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
