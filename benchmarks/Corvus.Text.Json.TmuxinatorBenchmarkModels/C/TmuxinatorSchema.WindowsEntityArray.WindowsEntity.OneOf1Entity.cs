    ...
    public readonly partial struct WindowsEntityArray
    {
        ...
        public readonly partial struct WindowsEntity
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.TmuxinatorBenchmark.Current.JsonString Layout
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LayoutUtf8, out Corvus.TmuxinatorBenchmark.Current.JsonString value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.WindowsEntityArray.WindowsEntity.OneOf1Entity.PanesEntityArray Panes
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PanesUtf8, out Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.WindowsEntityArray.WindowsEntity.OneOf1Entity.PanesEntityArray value))
                        {
                            return value;
                        }
                ...
                /// </summary>
                public Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.WindowsEntityArray.WindowsEntity.OneOf1Entity.JsonStringArray Pre
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PreUtf8, out Corvus.TmuxinatorBenchmark.Current.TmuxinatorSchema.WindowsEntityArray.WindowsEntity.OneOf1Entity.JsonStringArray value))
                        {
                            return value;
                        }
                ...
                {
                    /// <summary>
                    /// Gets the JSON property name for <see cref="Layout"/>.
                    /// </summary>
                    public const string Layout = "layout";

                    /// <summary>
                    /// Gets the JSON property name for <see cref="Panes"/>.
                    /// </summary>
                    ...
                    /// Gets the JSON property name for <see cref="Layout"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> LayoutUtf8 => "layout"u8;

                    /// <summary>
                    /// Gets the JSON property name for <see cref="Panes"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> PanesUtf8 => "panes"u8;
                ...
                {
                    /// <summary>
                    /// Gets the escaped UTF-8 JSON property name for <see cref="Layout"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> Layout => "layout"u8;

                    /// <summary>
                    /// Gets the escaped UTF-8 JSON property name for <see cref="Panes"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> Panes => "panes"u8;
                ...
                {
                    /// <summary>
                    /// Gets the pre-baked property name blob for <see cref="Layout"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> Layout => [0x85, 0x00, 0x00, 0x00, 0x22, 0x6C, 0x61, 0x79, 0x6F, 0x75, 0x74, 0x22];

                    /// <summary>
                    /// Gets the pre-baked property name blob for <see cref="Panes"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> Panes => [0x75, 0x00, 0x00, 0x00, 0x22, 0x70, 0x61, 0x6E, 0x65, 0x73, 0x22];
