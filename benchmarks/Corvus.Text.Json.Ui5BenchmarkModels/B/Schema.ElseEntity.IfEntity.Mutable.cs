    ...
    public readonly partial struct ElseEntity
    {
        ...
        public readonly partial struct IfEntity
        {
...
#endif
            {
                ...
                /// </summary>
                public Corvus.Ui5Benchmark.Baseline.Schema.ElseEntity.IfEntity.SpecVersionEntity.Mutable SpecVersion
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SpecVersionUtf8, out Corvus.Ui5Benchmark.Baseline.Schema.ElseEntity.IfEntity.SpecVersionEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetSpecVersion(in Corvus.Ui5Benchmark.Baseline.Schema.ElseEntity.IfEntity.SpecVersionEntity.Source value)
                {
                    CheckValidInstance();
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Ui5Benchmark.Baseline.Schema.ElseEntity.IfEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Ui5Benchmark.Baseline.Schema.ElseEntity.IfEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.Ui5Benchmark.Baseline.Schema.ElseEntity.IfEntity.SpecVersionEntity.Source specVersion = default)
                {
                ...
                /// Creates an instance of a <see cref="IfEntity"/>.
                /// </summary>
                public void Create(in Corvus.Ui5Benchmark.Baseline.Schema.ElseEntity.IfEntity.SpecVersionEntity.Source specVersion = default)
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5Benchmark.Baseline.Schema.ElseEntity.IfEntity.SpecVersionEntity.Source specVersion = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
