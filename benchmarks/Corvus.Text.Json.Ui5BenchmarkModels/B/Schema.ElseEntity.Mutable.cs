    ...
    public readonly partial struct ElseEntity
    {
...
#endif
        {
            ...
            public bool TryGetAsIfEntity(out Corvus.Ui5Benchmark.Baseline.Schema.ElseEntity.IfEntity result)
            {
                if (Corvus.Ui5Benchmark.Baseline.Schema.ElseEntity.IfEntity.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Ui5Benchmark.Baseline.Schema.ElseEntity.IfEntity.Mutable.From(this);
                    return true;
                }
            ...
            public bool TryGetAsThenEntity(out Corvus.Ui5Benchmark.Baseline.Schema.ElseEntity.ThenEntity result)
            {
                ...
                {
                    result = Corvus.Ui5Benchmark.Baseline.Schema.ElseEntity.ThenEntity.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5Benchmark.Baseline.Schema.ElseEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5Benchmark.Baseline.Schema.ElseEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
