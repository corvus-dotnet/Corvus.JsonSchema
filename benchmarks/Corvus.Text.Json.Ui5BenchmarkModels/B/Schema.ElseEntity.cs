...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.Ui5Benchmark.Baseline.Schema.ElseEntity.IfEntity" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsIfEntity(out Corvus.Ui5Benchmark.Baseline.Schema.ElseEntity.IfEntity result)
        {
            if (Corvus.Ui5Benchmark.Baseline.Schema.ElseEntity.IfEntity.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.Ui5Benchmark.Baseline.Schema.ElseEntity.IfEntity.From(this);
                return true;
            }
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.Ui5Benchmark.Baseline.Schema.ElseEntity.ThenEntity" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsThenEntity(out Corvus.Ui5Benchmark.Baseline.Schema.ElseEntity.ThenEntity result)
        {
            if (Corvus.Ui5Benchmark.Baseline.Schema.ElseEntity.ThenEntity.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.Ui5Benchmark.Baseline.Schema.ElseEntity.ThenEntity.From(this);
                return true;
            }
        ...
        /// <param name="matchCorvusUi5BenchmarkBaselineSchemaElseEntityThenEntity">Match a <see cref="Corvus.Ui5Benchmark.Baseline.Schema.ElseEntity.ThenEntity"/>.</param>
        ...
        public TResult Match<TContext, TResult>(
            in TContext context,
            Matcher<Corvus.Ui5Benchmark.Baseline.Schema.ElseEntity.ThenEntity, TContext, TResult> matchCorvusUi5BenchmarkBaselineSchemaElseEntityThenEntity,
...
#endif
        {
            if (Corvus.Ui5Benchmark.Baseline.Schema.ElseEntity.IfEntity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchCorvusUi5BenchmarkBaselineSchemaElseEntityThenEntity(Corvus.Ui5Benchmark.Baseline.Schema.ElseEntity.ThenEntity.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            Matcher<Corvus.Ui5Benchmark.Baseline.Schema.ElseEntity.ThenEntity, TResult> matchCorvusUi5BenchmarkBaselineSchemaElseEntityThenEntity,
            Matcher<ElseEntity, TResult> defaultMatch)
        {
            if (Corvus.Ui5Benchmark.Baseline.Schema.ElseEntity.IfEntity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchCorvusUi5BenchmarkBaselineSchemaElseEntityThenEntity(Corvus.Ui5Benchmark.Baseline.Schema.ElseEntity.ThenEntity.From(this));
            }
