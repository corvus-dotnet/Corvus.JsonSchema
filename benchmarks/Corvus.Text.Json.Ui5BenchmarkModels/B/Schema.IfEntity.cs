...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// </summary>
        public Corvus.Ui5Benchmark.Baseline.Schema.IfEntity.SpecVersionEntity SpecVersion
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SpecVersionUtf8, out Corvus.Ui5Benchmark.Baseline.Schema.IfEntity.SpecVersionEntity value))
                {
                    return value;
                }
