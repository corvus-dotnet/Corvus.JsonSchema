    ...
    public readonly partial struct RequiredSpecVersion
    {
        ...
        public readonly partial struct ElseEntity
        {
...
#endif
            {
                ...
                /// </summary>
                public Corvus.Ui5Benchmark.Baseline.Schema.RequiredSpecVersion.ElseEntity.IfEntity.KindEntity Kind
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.KindUtf8, out Corvus.Ui5Benchmark.Baseline.Schema.RequiredSpecVersion.ElseEntity.IfEntity.KindEntity value))
                        {
                            return value;
                        }
