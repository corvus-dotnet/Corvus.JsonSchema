                    ...
                    public readonly partial struct ElseEntity2
                    {
                        ...
                        public readonly partial struct ThenEntity
                        {
...
#endif
                            {
                                ...
                                /// <summary>
                                /// Initializes a new instance of the <see cref="MiddlewareEntity"/> struct.
                                /// </summary>
                                /// <param name="value">The value from which to construct the instance.</param>
                                internal MiddlewareEntity(IJsonDocument parent, int idx)
                                {
                                    Debug.Assert(idx >= 0);
                                    _parent = parent;
                                    _idx = idx;
                                ...
                                /// </summary>
                                public static MiddlewareEntity DefaultInstance { get; }
                                ...
                                /// </returns>
                                public static bool operator ==(in MiddlewareEntity left, in MiddlewareEntity right)
                                {
                                ...
                                /// <c>True</c> if the values are equal.
                                /// </returns>
                                public static bool operator ==(in MiddlewareEntity left, in JsonElement right)
                                {
                                    return left.Equals(right);
                                }
                                ...
                                public static implicit operator JsonElement(MiddlewareEntity instance)
                                {
                                ...
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static implicit operator MiddlewareEntity(JsonElement instance)
                                {
                                    return MiddlewareEntity.From(instance);
                                }
                                ...
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static MiddlewareEntity From<T>(in T instance)
                                ...
                                /// </exception>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static MiddlewareEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                                {
                                    return JsonElementHelpers.ParseValue<MiddlewareEntity>(utf8Json, options);
                                }
                                ...
                                /// </exception>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static MiddlewareEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                                {
                                    return JsonElementHelpers.ParseValue<MiddlewareEntity>(json, options);
                                }
                                ...
                                /// </exception>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static MiddlewareEntity ParseValue(string json, JsonDocumentOptions options = default)
                                {
                                    return JsonElementHelpers.ParseValue<MiddlewareEntity>(json, options);
                                }
                                ...
                                /// </exception>
                                public static MiddlewareEntity ParseValue(ref Utf8JsonReader reader)
                                {
                                    return JsonElementHelpers.ParseValue<MiddlewareEntity>(ref reader);
                                }
                                ...
                                ///   A value could not be read from the reader.
                                /// </exception>
                                public static bool TryParseValue(ref Utf8JsonReader reader, out MiddlewareEntity? result)
                                {
                                    return JsonElementHelpers.TryParseValue<MiddlewareEntity>(ref reader, out result);
                                }
...
#if NET
                                static MiddlewareEntity IJsonElement<MiddlewareEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                private string DebuggerDisplay => $"MiddlewareEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                                ...
                                /// </para>
                                /// </remarks>
                                public MiddlewareEntity Freeze()
                                {
                                    CheckValidInstance();
                                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                                    {
                                        return mutable.FreezeElement<MiddlewareEntity>(_idx);
                                    }
