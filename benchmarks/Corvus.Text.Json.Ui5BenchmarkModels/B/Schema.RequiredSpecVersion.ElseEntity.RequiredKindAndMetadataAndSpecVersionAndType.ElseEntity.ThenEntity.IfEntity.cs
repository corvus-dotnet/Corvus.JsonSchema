                ...
                public readonly partial struct ElseEntity
                {
                    ...
                    public readonly partial struct ThenEntity
                    {
...
#endif
                        {
                            ...
                            /// </summary>
                            public Corvus.Ui5Benchmark.Baseline.Schema.RequiredSpecVersion.ElseEntity.RequiredKindAndMetadataAndSpecVersionAndType.ElseEntity.ThenEntity.IfEntity.SpecVersionEntity SpecVersion
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SpecVersionUtf8, out Corvus.Ui5Benchmark.Baseline.Schema.RequiredSpecVersion.ElseEntity.RequiredKindAndMetadataAndSpecVersionAndType.ElseEntity.ThenEntity.IfEntity.SpecVersionEntity value))
                                    {
                                        return value;
                                    }
