            ...
            public readonly partial struct RequiredKindAndMetadataAndSpecVersionAndType
            {
                ...
                public readonly partial struct ElseEntity
                {
                    ...
                    public readonly partial struct ThenEntity
                    {
                        ...
                        public readonly partial struct TaskEntity
                        {
...
#endif
                            {
                                ...
                                public static explicit operator Mutable(TaskEntity instance)
                                {
                                ...
                                /// <returns>An immutable instance of a <see cref="TaskEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static implicit operator TaskEntity(Mutable instance)
                                {
                                ...
                                /// </summary>
                                public Corvus.Ui5Benchmark.Baseline.JsonString.Mutable Path
                                {
                                    get
                                    {
                                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PathUtf8, out Corvus.Ui5Benchmark.Baseline.JsonString.Mutable value))
                                        {
                                            return value;
                                        }
                                ...
                                {
                                    return
                                        (obj is IJsonElement value && Equals(new TaskEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                                ...
                                public void SetPath(in Corvus.Ui5Benchmark.Baseline.JsonString.Source value)
                                {
                                    CheckValidInstance();
                                ...
                                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                private string DebuggerDisplay => $"TaskEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                                ...
                                /// <summary>
                                /// Gets a <see cref="TaskEntity"/> which can be safely stored beyond the lifetime of the
                                /// original document.
                                /// </summary>
                                /// <returns>
                                /// A <see cref="TaskEntity"/> which can be safely stored beyond the lifetime of the
                                /// original document.
                                /// </returns>
                                /// <remarks>
                                /// <para>
                                ...
                                /// </para>
                                /// </remarks>
                                public readonly TaskEntity Clone()
                                {
                                    CheckValidInstance();
                                    return _parent.CloneElement<TaskEntity>(_idx);
                                }
                                ...
                                /// </summary>
                                /// <returns>
                                /// An immutable <see cref="TaskEntity"/> that lives for the lifetime of its
                                ...
                                /// </para>
                                /// </remarks>
                                public readonly TaskEntity Freeze()
                                {
                                    CheckValidInstance();
                                    return _parent.FreezeElement<TaskEntity>(_idx);
                                }
                            }
                            ...
                            public ref struct Source
                            {
                                ...
                                internal Source(Corvus.Ui5Benchmark.Baseline.Schema.RequiredSpecVersion.ElseEntity.RequiredKindAndMetadataAndSpecVersionAndType.ElseEntity.ThenEntity.TaskEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                                public static implicit operator Source(TaskEntity instance) => new(JsonElement.From(instance));
                                ...
                                #endif
                            {
                                ...
                                internal Source(scoped in TContext context, Corvus.Ui5Benchmark.Baseline.Schema.RequiredSpecVersion.ElseEntity.RequiredKindAndMetadataAndSpecVersionAndType.ElseEntity.ThenEntity.TaskEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                            ...
                            public ref struct Builder
                            {
                                ...
                                /// <summary>
                                /// Creates an instance of a <see cref="TaskEntity"/>.
                                /// </summary>
                                internal static void Create(ref ComplexValueBuilder builder, in Corvus.Ui5Benchmark.Baseline.JsonString.Source path = default)
                                {
                                ...
                                /// Creates an instance of a <see cref="TaskEntity"/>.
                                /// </summary>
                                public void Create(in Corvus.Ui5Benchmark.Baseline.JsonString.Source path = default)
                                {
                            ...
                            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5Benchmark.Baseline.JsonString.Source path = default, int initialCapacity = 30)
                            {
                                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                                cvb.StartObject();
                            ...
                            {
                                return workspace.CreateBuilder<TaskEntity, Mutable>(this);
                            }
                        }
                    }
                }
