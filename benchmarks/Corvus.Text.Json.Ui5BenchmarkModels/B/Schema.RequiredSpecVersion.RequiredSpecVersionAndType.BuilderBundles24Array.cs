    ...
    public readonly partial struct RequiredSpecVersion
    {
        ...
        public readonly partial struct RequiredSpecVersionAndType
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="BuilderBundles24Array"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal BuilderBundles24Array(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static BuilderBundles24Array DefaultInstance { get; }
                ...
                /// </returns>
                public static bool operator ==(in BuilderBundles24Array left, in BuilderBundles24Array right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in BuilderBundles24Array left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(BuilderBundles24Array instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator BuilderBundles24Array(JsonElement instance)
                {
                    return BuilderBundles24Array.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static BuilderBundles24Array From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static BuilderBundles24Array ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<BuilderBundles24Array>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static BuilderBundles24Array ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<BuilderBundles24Array>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static BuilderBundles24Array ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<BuilderBundles24Array>(json, options);
                }
                ...
                /// </exception>
                public static BuilderBundles24Array ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<BuilderBundles24Array>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out BuilderBundles24Array? result)
                {
                    return JsonElementHelpers.TryParseValue<BuilderBundles24Array>(ref reader, out result);
                }
...
#if NET
                static BuilderBundles24Array IJsonElement<BuilderBundles24Array>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"BuilderBundles24Array: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public BuilderBundles24Array Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public BuilderBundles24Array Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<BuilderBundles24Array>(_idx);
                    }
