            ...
            public readonly partial struct BuilderBundlesBundleOptions30Entity
            {
                ...
                public readonly partial struct NumberOfPartsEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(NumberOfPartsEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="NumberOfPartsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator NumberOfPartsEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"NumberOfPartsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly NumberOfPartsEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly NumberOfPartsEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<NumberOfPartsEntity>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(NumberOfPartsEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<NumberOfPartsEntity, Mutable>(this);
                    }
                }
            }
        }
