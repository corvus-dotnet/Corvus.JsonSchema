        ...
        public readonly partial struct RequiredSpecVersionAndType
        {
            ...
            public readonly partial struct BuilderBundlesBundleOptionsEntity
            {
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="UsePredefineCallsEntity"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal UsePredefineCallsEntity(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static UsePredefineCallsEntity DefaultInstance { get; } = ParsedJsonDocument<UsePredefineCallsEntity>.False;
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator bool(UsePredefineCallsEntity value)
                    {
                    ...
                    /// </returns>
                    public static bool operator ==(in UsePredefineCallsEntity left, in UsePredefineCallsEntity right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in UsePredefineCallsEntity left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator JsonElement(UsePredefineCallsEntity instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator UsePredefineCallsEntity(JsonElement instance)
                    {
                        return UsePredefineCallsEntity.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static UsePredefineCallsEntity From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static UsePredefineCallsEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<UsePredefineCallsEntity>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static UsePredefineCallsEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<UsePredefineCallsEntity>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static UsePredefineCallsEntity ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<UsePredefineCallsEntity>(json, options);
                    }
                    ...
                    /// </exception>
                    public static UsePredefineCallsEntity ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<UsePredefineCallsEntity>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out UsePredefineCallsEntity? result)
                    {
                        return JsonElementHelpers.TryParseValue<UsePredefineCallsEntity>(ref reader, out result);
                    }
...
#if NET
                    static UsePredefineCallsEntity IJsonElement<UsePredefineCallsEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"UsePredefineCallsEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public UsePredefineCallsEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public UsePredefineCallsEntity Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<UsePredefineCallsEntity>(_idx);
                        }
