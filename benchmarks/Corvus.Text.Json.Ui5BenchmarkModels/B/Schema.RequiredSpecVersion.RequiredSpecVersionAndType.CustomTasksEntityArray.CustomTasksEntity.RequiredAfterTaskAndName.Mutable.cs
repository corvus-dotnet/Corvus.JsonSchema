                ...
                public readonly partial struct CustomTasksEntity
                {
                    ...
                    public readonly partial struct RequiredAfterTaskAndName
                    {
...
#endif
                        {
                            ...
                            /// </para>
                            /// </remarks>
                            public Corvus.Ui5Benchmark.Baseline.JsonString.Mutable AfterTask
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AfterTaskUtf8, out Corvus.Ui5Benchmark.Baseline.JsonString.Mutable value))
                                    {
                                        return value;
                                    }
                            ...
                            public void SetAfterTask(in Corvus.Ui5Benchmark.Baseline.JsonString.Source value)
                            {
                                CheckValidInstance();
                        ...
                        public ref struct Source
                        {
                            ...
                            internal Source(Corvus.Ui5Benchmark.Baseline.Schema.RequiredSpecVersion.RequiredSpecVersionAndType.CustomTasksEntityArray.CustomTasksEntity.RequiredAfterTaskAndName.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                            ...
                            #endif
                        {
                            ...
                            internal Source(scoped in TContext context, Corvus.Ui5Benchmark.Baseline.Schema.RequiredSpecVersion.RequiredSpecVersionAndType.CustomTasksEntityArray.CustomTasksEntity.RequiredAfterTaskAndName.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                        ...
                        public ref struct Builder
                        {
                            ...
                            internal static void Create(
                                ...
                                in Corvus.Ui5Benchmark.Baseline.JsonString.Source afterTask,
                        ...
                        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5Benchmark.Baseline.JsonString.Source afterTask, in Corvus.Ui5Benchmark.Baseline.JsonString.Source name, in Corvus.Text.Json.JsonElement.Source configuration = default, int initialCapacity = 30)
                        {
                            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                            cvb.StartObject();
