                ...
                public readonly partial struct CustomTasksEntity
                {
                    ...
                    public readonly partial struct RequiredBeforeTaskAndName
                    {
...
#endif
                        {
                            ...
                            /// </para>
                            /// </remarks>
                            public Corvus.Ui5Benchmark.Baseline.JsonString.Mutable BeforeTask
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BeforeTaskUtf8, out Corvus.Ui5Benchmark.Baseline.JsonString.Mutable value))
                                    {
                                        return value;
                                    }
                            ...
                            public void SetBeforeTask(in Corvus.Ui5Benchmark.Baseline.JsonString.Source value)
                            {
                                CheckValidInstance();
                                ...
                                else
                                {
                                    ...
                                    value.AddAsProperty(JsonPropertyNamesEscaped.BeforeTask, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                        ...
                        public ref struct Source
                        {
                            ...
                            internal Source(Corvus.Ui5Benchmark.Baseline.Schema.RequiredSpecVersion.RequiredSpecVersionAndType.CustomTasksEntityArray.CustomTasksEntity.RequiredBeforeTaskAndName.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                            ...
                            #endif
                        {
                            ...
                            internal Source(scoped in TContext context, Corvus.Ui5Benchmark.Baseline.Schema.RequiredSpecVersion.RequiredSpecVersionAndType.CustomTasksEntityArray.CustomTasksEntity.RequiredBeforeTaskAndName.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                        ...
                        public ref struct Builder
                        {
                            ...
                            internal static void Create(
                                ...
                                in Corvus.Ui5Benchmark.Baseline.JsonString.Source beforeTask,
                                in Corvus.Ui5Benchmark.Baseline.JsonString.Source name,
                                in Corvus.Text.Json.JsonElement.Source configuration = default)
                            {
                                beforeTask.AddAsProperty(JsonPropertyNamesEscaped.BeforeTask, ref builder, escapeName: false);
                        ...
                        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5Benchmark.Baseline.JsonString.Source beforeTask, in Corvus.Ui5Benchmark.Baseline.JsonString.Source name, in Corvus.Text.Json.JsonElement.Source configuration = default, int initialCapacity = 30)
                        {
                            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                            cvb.StartObject();
                        ...
                        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Ui5Benchmark.Baseline.JsonString.Source beforeTask, in Corvus.Ui5Benchmark.Baseline.JsonString.Source name, in Corvus.Text.Json.JsonElement.Source<TContext> configuration = default, int initialCapacity = 30)
                            #if NET9_0_OR_GREATER
                            where TContext : allows ref struct
                            #endif
                        {
