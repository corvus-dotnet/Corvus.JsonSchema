                            ...
                            public readonly partial struct RequiredMetadataAndSpecVersionAndType
                            {
                                ...
                                public readonly partial struct BuilderSpecVersion25Entity
                                {
                                    ...
                                    public ref struct Source
                                    {
                                        ...
                                        internal Source(Corvus.Ui5Benchmark.Baseline.Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ElseEntity.ElseEntity2.ElseEntity.ElseEntity2.RequiredMetadataAndSpecVersionAndType.BuilderSpecVersion25Entity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                                    ...
                                    public ref struct Builder
                                    {
                                        ...
                                        /// </summary>
                                        internal static void Create(ref ComplexValueBuilder builder, in Corvus.Ui5Benchmark.Baseline.Schema.RequiredSpecVersion.RequiredSpecVersionAndType.BuilderSettingsEntity.Source settings = default)
                                        {
                                        ...
                                        /// Creates an instance of a <see cref="BuilderSpecVersion25Entity"/>.
                                        /// </summary>
                                        public void Create(in Corvus.Ui5Benchmark.Baseline.Schema.RequiredSpecVersion.RequiredSpecVersionAndType.BuilderSettingsEntity.Source settings = default)
                                        {
                                        ...
                                        /// Creates an instance of a <see cref="BuilderSpecVersion25Entity"/>.
                                        /// </summary>
                                        public void Create<TContext>(in TContext context, in Corvus.Ui5Benchmark.Baseline.Schema.RequiredSpecVersion.RequiredSpecVersionAndType.BuilderSettingsEntity.Source<TContext> settings = default)
                                        #if NET9_0_OR_GREATER
                                        where TContext : allows ref struct
                                        #endif
                                        {
                                    ...
                                    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5Benchmark.Baseline.Schema.RequiredSpecVersion.RequiredSpecVersionAndType.BuilderSettingsEntity.Source settings = default, int initialCapacity = 30)
                                    {
                                        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                                        cvb.StartObject();
                                    ...
                                    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                                    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                                    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Ui5Benchmark.Baseline.Schema.RequiredSpecVersion.RequiredSpecVersionAndType.BuilderSettingsEntity.Source<TContext> settings = default, int initialCapacity = 30)
                                        #if NET9_0_OR_GREATER
                                        where TContext : allows ref struct
                                        #endif
                                    {
