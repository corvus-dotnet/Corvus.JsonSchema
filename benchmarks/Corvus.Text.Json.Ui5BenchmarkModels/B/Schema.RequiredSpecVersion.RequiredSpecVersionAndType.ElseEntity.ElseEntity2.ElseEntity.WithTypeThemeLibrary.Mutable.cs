                    ...
                    public readonly partial struct ElseEntity
                    {
                        ...
                        public readonly partial struct WithTypeThemeLibrary
                        {
...
#endif
                            {
                                ...
                                public static explicit operator Mutable(WithTypeThemeLibrary instance)
                                {
                                ...
                                /// <returns>An immutable instance of a <see cref="WithTypeThemeLibrary"/>, initialized from the <see cref="Mutable"/> value.</returns>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static implicit operator WithTypeThemeLibrary(Mutable instance)
                                {
                                ...
                                /// </summary>
                                public Corvus.Ui5Benchmark.Baseline.Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ElseEntity.ElseEntity2.ElseEntity.WithTypeThemeLibrary.TypeEntity.Mutable Type
                                {
                                    get
                                    {
                                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Ui5Benchmark.Baseline.Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ElseEntity.ElseEntity2.ElseEntity.WithTypeThemeLibrary.TypeEntity.Mutable value))
                                        {
                                            return value;
                                        }
                                ...
                                public void SetType(in Corvus.Ui5Benchmark.Baseline.Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ElseEntity.ElseEntity2.ElseEntity.WithTypeThemeLibrary.TypeEntity.Source value)
                                {
                                    CheckValidInstance();
                                ...
                                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                private string DebuggerDisplay => $"WithTypeThemeLibrary.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                                ...
                                /// </para>
                                /// </remarks>
                                public readonly WithTypeThemeLibrary Clone()
                                {
                                    CheckValidInstance();
                                ...
                                /// </para>
                                /// </remarks>
                                public readonly WithTypeThemeLibrary Freeze()
                                {
                                    CheckValidInstance();
                                    return _parent.FreezeElement<WithTypeThemeLibrary>(_idx);
                                }
                            }
                            ...
                            public ref struct Source
                            {
                                ...
                                internal Source(Corvus.Ui5Benchmark.Baseline.Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ElseEntity.ElseEntity2.ElseEntity.WithTypeThemeLibrary.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                                public static implicit operator Source(WithTypeThemeLibrary instance) => new(JsonElement.From(instance));
                                ...
                                #endif
                            {
                                ...
                                internal Source(scoped in TContext context, Corvus.Ui5Benchmark.Baseline.Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ElseEntity.ElseEntity2.ElseEntity.WithTypeThemeLibrary.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                            ...
                            public ref struct Builder
                            {
                                ...
                                /// <summary>
                                /// Creates an instance of a <see cref="WithTypeThemeLibrary"/>.
                                /// </summary>
                                internal static void Create(ref ComplexValueBuilder builder, in Corvus.Ui5Benchmark.Baseline.Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ElseEntity.ElseEntity2.ElseEntity.WithTypeThemeLibrary.TypeEntity.Source type = default)
                                {
                                ...
                                /// Creates an instance of a <see cref="WithTypeThemeLibrary"/>.
                                /// </summary>
                                public void Create(in Corvus.Ui5Benchmark.Baseline.Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ElseEntity.ElseEntity2.ElseEntity.WithTypeThemeLibrary.TypeEntity.Source type = default)
                                {
                            ...
                            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5Benchmark.Baseline.Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ElseEntity.ElseEntity2.ElseEntity.WithTypeThemeLibrary.TypeEntity.Source type = default, int initialCapacity = 30)
                            {
                                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                                cvb.StartObject();
                            ...
                            {
                                return workspace.CreateBuilder<WithTypeThemeLibrary, Mutable>(this);
                            }
                        }
                    }
                }
