                    ...
                    public readonly partial struct RequiredMetadataAndSpecVersionAndType
                    {
                        ...
                        public readonly partial struct ElseEntity
                        {
...
#endif
                            {
                                ...
                                /// </summary>
                                public Corvus.Ui5Benchmark.Baseline.Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ElseEntity.ElseEntity2.RequiredMetadataAndSpecVersionAndType.ElseEntity.IfEntity.SpecVersionEntity SpecVersion
                                {
                                    get
                                    {
                                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SpecVersionUtf8, out Corvus.Ui5Benchmark.Baseline.Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ElseEntity.ElseEntity2.RequiredMetadataAndSpecVersionAndType.ElseEntity.IfEntity.SpecVersionEntity value))
                                        {
                                            return value;
                                        }
