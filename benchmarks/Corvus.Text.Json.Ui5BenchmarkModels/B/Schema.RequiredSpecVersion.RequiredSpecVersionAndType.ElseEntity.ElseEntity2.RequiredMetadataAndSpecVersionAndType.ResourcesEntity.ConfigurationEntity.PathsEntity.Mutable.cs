                            ...
                            public readonly partial struct ConfigurationEntity
                            {
                                ...
                                public readonly partial struct PathsEntity
                                {
...
#endif
                                    {
                                        ...
                                        /// </summary>
                                        public Corvus.Ui5Benchmark.Baseline.JsonString.Mutable Src
                                        {
                                            get
                                            {
                                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SrcUtf8, out Corvus.Ui5Benchmark.Baseline.JsonString.Mutable value))
                                                {
                                                    return value;
                                                }
                                        ...
                                        /// </summary>
                                        public Corvus.Ui5Benchmark.Baseline.JsonString.Mutable Test
                                        {
                                            get
                                            {
                                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TestUtf8, out Corvus.Ui5Benchmark.Baseline.JsonString.Mutable value))
                                                {
                                                    return value;
                                                }
                                        ...
                                        public void SetSrc(in Corvus.Ui5Benchmark.Baseline.JsonString.Source value)
                                        {
                                            CheckValidInstance();
                                        ...
                                        /// </summary>
                                        /// <param name="value">The value of the property to add.</param>
                                        public void SetTest(in Corvus.Ui5Benchmark.Baseline.JsonString.Source value)
                                        {
                                            CheckValidInstance();
                                    ...
                                    public ref struct Source
                                    {
                                        ...
                                        internal Source(Corvus.Ui5Benchmark.Baseline.Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ElseEntity.ElseEntity2.RequiredMetadataAndSpecVersionAndType.ResourcesEntity.ConfigurationEntity.PathsEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                                    ...
                                    public ref struct Builder
                                    {
                                        ...
                                        internal static void Create(
                                            ...
                                            in Corvus.Ui5Benchmark.Baseline.JsonString.Source src = default,
                                            in Corvus.Ui5Benchmark.Baseline.JsonString.Source test = default)
                                        {
                                        ...
                                        /// Creates an instance of a <see cref="PathsEntity"/>.
                                        /// </summary>
                                        public void Create(in Corvus.Ui5Benchmark.Baseline.JsonString.Source src = default, in Corvus.Ui5Benchmark.Baseline.JsonString.Source test = default)
                                        {
                                    ...
                                    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5Benchmark.Baseline.JsonString.Source src = default, in Corvus.Ui5Benchmark.Baseline.JsonString.Source test = default, int initialCapacity = 30)
                                    {
                                        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                                        cvb.StartObject();
