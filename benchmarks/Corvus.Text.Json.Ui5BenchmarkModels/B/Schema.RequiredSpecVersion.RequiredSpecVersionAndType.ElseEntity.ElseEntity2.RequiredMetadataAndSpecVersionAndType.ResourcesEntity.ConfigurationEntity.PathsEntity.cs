                        ...
                        public readonly partial struct ResourcesEntity
                        {
                            ...
                            public readonly partial struct ConfigurationEntity
                            {
...
#endif
                                {
                                    ...
                                    /// </summary>
                                    public Corvus.Ui5Benchmark.Baseline.JsonString Src
                                    {
                                        get
                                        {
                                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SrcUtf8, out Corvus.Ui5Benchmark.Baseline.JsonString value))
                                            {
                                                return value;
                                            }
                                    ...
                                    /// </summary>
                                    public Corvus.Ui5Benchmark.Baseline.JsonString Test
                                    {
                                        get
                                        {
                                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TestUtf8, out Corvus.Ui5Benchmark.Baseline.JsonString value))
                                            {
                                                return value;
                                            }
