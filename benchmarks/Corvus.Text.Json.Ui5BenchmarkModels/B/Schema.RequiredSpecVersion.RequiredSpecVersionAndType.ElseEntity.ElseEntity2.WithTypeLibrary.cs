        ...
        public readonly partial struct RequiredSpecVersionAndType
        {
            ...
            public readonly partial struct ElseEntity
            {
                ...
                public readonly partial struct ElseEntity2
                {
                    ...
                    public readonly partial struct WithTypeLibrary
#if NET8_0_OR_GREATER
                        : IJsonElement<WithTypeLibrary>,
                          IFormattable,
                          ISpanFormattable,
...
#endif
                    {
                        ...
                        /// <summary>
                        /// Initializes a new instance of the <see cref="WithTypeLibrary"/> struct.
                        /// </summary>
                        /// <param name="value">The value from which to construct the instance.</param>
                        internal WithTypeLibrary(IJsonDocument parent, int idx)
                        {
                            Debug.Assert(idx >= 0);
                            _parent = parent;
                            _idx = idx;
                        ...
                        /// </summary>
                        public static WithTypeLibrary DefaultInstance { get; }
                        ...
                        /// </summary>
                        public Corvus.Ui5Benchmark.Baseline.Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ElseEntity.ElseEntity2.WithTypeLibrary.TypeEntity Type
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Ui5Benchmark.Baseline.Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ElseEntity.ElseEntity2.WithTypeLibrary.TypeEntity value))
                                {
                                    return value;
                                }
                        ...
                        /// </returns>
                        public static bool operator ==(in WithTypeLibrary left, in WithTypeLibrary right)
                        {
                        ...
                        /// <c>True</c> if the values are equal.
                        /// </returns>
                        public static bool operator ==(in WithTypeLibrary left, in JsonElement right)
                        {
                            return left.Equals(right);
                        }
                        ...
                        public static implicit operator JsonElement(WithTypeLibrary instance)
                        {
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator WithTypeLibrary(JsonElement instance)
                        {
                            return WithTypeLibrary.From(instance);
                        }
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static WithTypeLibrary From<T>(in T instance)
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static WithTypeLibrary ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<WithTypeLibrary>(utf8Json, options);
                        }
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static WithTypeLibrary ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<WithTypeLibrary>(json, options);
                        }
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static WithTypeLibrary ParseValue(string json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<WithTypeLibrary>(json, options);
                        }
                        ...
                        /// </exception>
                        public static WithTypeLibrary ParseValue(ref Utf8JsonReader reader)
                        {
                            return JsonElementHelpers.ParseValue<WithTypeLibrary>(ref reader);
                        }
                        ...
                        ///   A value could not be read from the reader.
                        /// </exception>
                        public static bool TryParseValue(ref Utf8JsonReader reader, out WithTypeLibrary? result)
                        {
                            return JsonElementHelpers.TryParseValue<WithTypeLibrary>(ref reader, out result);
                        }
                        ...
                        {
                            return
                                (obj is IJsonElement value && Equals(new WithTypeLibrary(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                        static WithTypeLibrary IJsonElement<WithTypeLibrary>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"WithTypeLibrary: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// <summary>
                        /// Gets a <see cref="WithTypeLibrary"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </summary>
                        /// <returns>
                        /// A <see cref="WithTypeLibrary"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </returns>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public WithTypeLibrary Clone()
                        {
                            CheckValidInstance();
                            return _parent.CloneElement<WithTypeLibrary>(_idx);
                        }
                        ...
                        /// </summary>
                        /// <returns>
                        /// An immutable <see cref="WithTypeLibrary"/> that lives for the lifetime of its
                        ...
                        /// </para>
                        /// </remarks>
                        public WithTypeLibrary Freeze()
                        {
                            CheckValidInstance();
                            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                            {
                                return mutable.FreezeElement<WithTypeLibrary>(_idx);
                            }
