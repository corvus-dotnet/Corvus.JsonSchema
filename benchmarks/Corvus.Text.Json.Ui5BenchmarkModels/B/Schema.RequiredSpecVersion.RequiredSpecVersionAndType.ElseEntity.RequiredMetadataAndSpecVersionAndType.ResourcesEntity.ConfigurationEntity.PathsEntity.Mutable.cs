                        ...
                        public readonly partial struct ConfigurationEntity
                        {
                            ...
                            public readonly partial struct PathsEntity
                            {
...
#endif
                                {
                                    ...
                                    /// </summary>
                                    public Corvus.Ui5Benchmark.Baseline.JsonString.Mutable Webapp
                                    {
                                        get
                                        {
                                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.WebappUtf8, out Corvus.Ui5Benchmark.Baseline.JsonString.Mutable value))
                                            {
                                                return value;
                                            }
                                    ...
                                    public void SetWebapp(in Corvus.Ui5Benchmark.Baseline.JsonString.Source value)
                                    {
                                        CheckValidInstance();
                                ...
                                public ref struct Source
                                {
                                    ...
                                    internal Source(Corvus.Ui5Benchmark.Baseline.Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ElseEntity.RequiredMetadataAndSpecVersionAndType.ResourcesEntity.ConfigurationEntity.PathsEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                                ...
                                public ref struct Builder
                                {
                                    ...
                                    /// </summary>
                                    internal static void Create(ref ComplexValueBuilder builder, in Corvus.Ui5Benchmark.Baseline.JsonString.Source webapp = default)
                                    {
                                    ...
                                    /// Creates an instance of a <see cref="PathsEntity"/>.
                                    /// </summary>
                                    public void Create(in Corvus.Ui5Benchmark.Baseline.JsonString.Source webapp = default)
                                    {
                                ...
                                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5Benchmark.Baseline.JsonString.Source webapp = default, int initialCapacity = 30)
                                {
                                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                                    cvb.StartObject();
