                        ...
                        public readonly partial struct CachebusterEntity
                        {
                                ...
                                : IJsonElement<SignatureTypeEntity>
                            {
                                ...
                                private static class Constants
                                {
                                    ...
                                    /// </summary>
                                    public static readonly byte[] Enum1 = "time"u8.ToArray();
                                    /// <summary>
                                    /// A constant for the <c>enum</c> keyword.
                                    /// </summary>
                                    public static readonly SignatureTypeEntity EnumJson1 = ParsedJsonDocument<SignatureTypeEntity>.StringConstant([.."\"time\""u8]);
                                    /// <summary>
                                    /// A constant for the <c>enum</c> keyword.
                                    /// </summary>
                                    public static readonly byte[] Enum2 = "hash"u8.ToArray();
                                    /// <summary>
                                    /// A constant for the <c>enum</c> keyword.
                                    /// </summary>
                                    public static readonly SignatureTypeEntity EnumJson2 = ParsedJsonDocument<SignatureTypeEntity>.StringConstant([.."\"hash\""u8]);
                                }
                                ...
                                public static class EnumValues
                                {
                                    ...
                                    /// as a <see cref="SignatureTypeEntity"/>.
                                    /// </summary>
                                    public static SignatureTypeEntity Time { get; } = Constants.EnumJson1;
                                    /// <summary>
                                    /// Gets the string "time"
                                    /// as a UTF8 byte array.
                                    /// </summary>
                                    public static ReadOnlySpan<byte> TimeUtf8 => Constants.Enum1;

                                    /// <summary>
                                    /// Gets the string "hash"
                                    /// as a <see cref="SignatureTypeEntity"/>.
                                    /// </summary>
                                    public static SignatureTypeEntity Hash { get; } = Constants.EnumJson2;
                                    /// <summary>
                                    /// Gets the string "hash"
                                    /// as a UTF8 byte array.
                                    /// </summary>
                                    public static ReadOnlySpan<byte> HashUtf8 => Constants.Enum2;
                                }
                                ...
                                public static partial class JsonSchema
                                {
                                    ...
                                    /// </summary>
                                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("ui5-schema.json#/then/then/else/then/definitions/builder-specVersion-3.0/properties/cachebuster/properties/signatureType"u8, buffer, out written);

                                    /// <summary>
                                    /// Gets the schema location from which this type was generated.
                                    /// </summary>
                                    public const string SchemaLocation = "ui5-schema.json#/then/then/else/then/definitions/builder-specVersion-3.0/properties/cachebuster/properties/signatureType";

                                    /// <summary>
                                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                                    /// </summary>
                                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "ui5-schema.json#/then/then/else/then/definitions/builder-specVersion-3.0/properties/cachebuster/properties/signatureType"u8;
                                        ...
                                        ref JsonSchemaContext context)
                                    {
                                        ...
                                        if (tokenType == JsonTokenType.String)
                                        {
                                            ...
                                            if (unescapedUtf8JsonString.Span.SequenceEqual("time"u8))
                                            {
                                                goto enumShortCircuitSuccess;
                                            }

                                            if (unescapedUtf8JsonString.Span.SequenceEqual("hash"u8))
                                            {
                                                goto enumShortCircuitSuccess;
                                            }
                                        }
