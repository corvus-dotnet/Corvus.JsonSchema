        ...
        public readonly partial struct RequiredSpecVersionAndType
        {
            ...
            public readonly partial struct EncodingOfPropertiesFiles
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(EncodingOfPropertiesFiles instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="EncodingOfPropertiesFiles"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator EncodingOfPropertiesFiles(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"EncodingOfPropertiesFiles.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly EncodingOfPropertiesFiles Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly EncodingOfPropertiesFiles Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<EncodingOfPropertiesFiles>(_idx);
                    }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(EncodingOfPropertiesFiles instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<EncodingOfPropertiesFiles, Mutable>(this);
                }
            }
        }
    }
