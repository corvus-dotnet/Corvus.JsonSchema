                                ...
                                public readonly partial struct AnyOf0Entity
                                {
                                    ...
                                    public readonly partial struct OptionalEntity
                                    {
...
#endif
                                        {
                                            ...
                                            public static explicit operator Mutable(OptionalEntity instance)
                                            {
                                            ...
                                            /// <returns>An immutable instance of a <see cref="OptionalEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                            public static implicit operator OptionalEntity(Mutable instance)
                                            {
                                            ...
                                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                            private string DebuggerDisplay => $"OptionalEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                                            ...
                                            /// </para>
                                            /// </remarks>
                                            public readonly OptionalEntity Clone()
                                            {
                                                CheckValidInstance();
                                            ...
                                            /// </para>
                                            /// </remarks>
                                            public readonly OptionalEntity Freeze()
                                            {
                                                CheckValidInstance();
                                                return _parent.FreezeElement<OptionalEntity>(_idx);
                                            }
                                        ...
                                        public ref struct Source
                                        {
                                            ...
                                            public static implicit operator Source(OptionalEntity instance) => new(JsonElement.From(instance));
                                        ...
                                        {
                                            return workspace.CreateBuilder<OptionalEntity, Mutable>(this);
                                        }
                                    }
                                }
                            }
