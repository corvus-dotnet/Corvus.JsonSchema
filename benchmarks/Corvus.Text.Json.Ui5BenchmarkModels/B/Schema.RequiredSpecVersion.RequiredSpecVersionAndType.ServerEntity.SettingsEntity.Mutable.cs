            ...
            public readonly partial struct ServerEntity
            {
                ...
                public readonly partial struct SettingsEntity
                {
...
#endif
                    {
                        ...
                        /// </summary>
                        public Corvus.Ui5Benchmark.Baseline.JsonNumber.Mutable HttpPort
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HttpPortUtf8, out Corvus.Ui5Benchmark.Baseline.JsonNumber.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        /// </summary>
                        public Corvus.Ui5Benchmark.Baseline.JsonNumber.Mutable HttpsPort
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HttpsPortUtf8, out Corvus.Ui5Benchmark.Baseline.JsonNumber.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        public void SetHttpPort(in Corvus.Ui5Benchmark.Baseline.JsonNumber.Source value)
                        {
                            CheckValidInstance();

                            if (value.IsUndefined)
                            {
                                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.HttpPortUtf8);
                                _documentVersion = _parent.Version;
                                return;
                            }

                            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HttpPortUtf8, out IJsonDocument? elementParent, out int elementIdx))
                            {
                            ...
                            else
                            {
                                ...
                                value.AddAsProperty(JsonPropertyNamesEscaped.HttpPort, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                        ...
                        /// <summary>
                        /// Remove the <c>httpPort</c> property, if present.
                        /// </summary>
                        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                        public bool RemoveHttpPort()
                        {
                            CheckValidInstance();
                            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.HttpPortUtf8);
                            _documentVersion = _parent.Version;
                            return result;
                        }
                        ...
                        /// </summary>
                        /// <param name="value">The value of the property to add.</param>
                        public void SetHttpsPort(in Corvus.Ui5Benchmark.Baseline.JsonNumber.Source value)
                        {
                            CheckValidInstance();

                            if (value.IsUndefined)
                            {
                                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.HttpsPortUtf8);
                                _documentVersion = _parent.Version;
                                return;
                            }

                            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HttpsPortUtf8, out IJsonDocument? elementParent, out int elementIdx))
                            {
                                // We are going to replace just the value
                                value.AddAsItem(ref cvb);
                                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                            ...
                            {
                                // We are going to insert the new value
                                value.AddAsProperty(JsonPropertyNamesEscaped.HttpsPort, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                            }
                        ...
                        /// <summary>
                        /// Remove the <c>httpsPort</c> property, if present.
                        /// </summary>
                        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                        public bool RemoveHttpsPort()
                        {
                            CheckValidInstance();
                            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.HttpsPortUtf8);
                            _documentVersion = _parent.Version;
                            return result;
                        }
                    ...
                    public ref struct Source
                    {
                        ...
                        internal Source(Corvus.Ui5Benchmark.Baseline.Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ServerEntity.SettingsEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.Ui5Benchmark.Baseline.Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ServerEntity.SettingsEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    public ref struct Builder
                    {
                        ...
                        internal static void Create(
                            ...
                            in Corvus.Ui5Benchmark.Baseline.JsonNumber.Source httpPort = default,
                            in Corvus.Ui5Benchmark.Baseline.JsonNumber.Source httpsPort = default)
                        {
                            httpPort.AddAsProperty(JsonPropertyNamesEscaped.HttpPort, ref builder, escapeName: false);
                            httpsPort.AddAsProperty(JsonPropertyNamesEscaped.HttpsPort, ref builder, escapeName: false);
                        }

                        /// <summary>
                        /// Creates an instance of a <see cref="SettingsEntity"/>.
                        /// </summary>
                        public void Create(in Corvus.Ui5Benchmark.Baseline.JsonNumber.Source httpPort = default, in Corvus.Ui5Benchmark.Baseline.JsonNumber.Source httpsPort = default)
                        {
                            Create(ref _builder, httpPort, httpsPort);
                        }
                    ...
                    /// </summary>
                    /// <param name="workspace">The JSON workspace.</param>
                    /// <param name="httpPort">The value of the property.</param>
                    /// <param name="httpsPort">The value of the property.</param>
                    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5Benchmark.Baseline.JsonNumber.Source httpPort = default, in Corvus.Ui5Benchmark.Baseline.JsonNumber.Source httpsPort = default, int initialCapacity = 30)
                    {
                        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                        cvb.StartObject();
                        Builder ovb = new(cvb);
                        ovb.Create(httpPort, httpsPort);
                        cvb = ovb._builder;
                        cvb.EndObject();
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder;
