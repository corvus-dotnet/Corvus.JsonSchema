        ...
        public readonly partial struct RequiredSpecVersionAndType
        {
            ...
            public readonly partial struct ServerEntity
            {
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="SettingsEntity"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal SettingsEntity(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static SettingsEntity DefaultInstance { get; }

                    /// <summary>
                    /// Gets the (optional) <c>httpPort</c> property.
                    /// </summary>
                    public Corvus.Ui5Benchmark.Baseline.JsonNumber HttpPort
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HttpPortUtf8, out Corvus.Ui5Benchmark.Baseline.JsonNumber value))
                            {
                                return value;
                            }
                    ...
                    /// <summary>
                    /// Gets the (optional) <c>httpsPort</c> property.
                    /// </summary>
                    public Corvus.Ui5Benchmark.Baseline.JsonNumber HttpsPort
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HttpsPortUtf8, out Corvus.Ui5Benchmark.Baseline.JsonNumber value))
                            {
                                return value;
                            }
                    ...
                    /// </returns>
                    public static bool operator ==(in SettingsEntity left, in SettingsEntity right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in SettingsEntity left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    public static implicit operator JsonElement(SettingsEntity instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator SettingsEntity(JsonElement instance)
                    {
                        return SettingsEntity.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static SettingsEntity From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static SettingsEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<SettingsEntity>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static SettingsEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<SettingsEntity>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static SettingsEntity ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<SettingsEntity>(json, options);
                    }
                    ...
                    /// </exception>
                    public static SettingsEntity ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<SettingsEntity>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out SettingsEntity? result)
                    {
                        return JsonElementHelpers.TryParseValue<SettingsEntity>(ref reader, out result);
                    }
...
#if NET
                    static SettingsEntity IJsonElement<SettingsEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"SettingsEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="SettingsEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="SettingsEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public SettingsEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<SettingsEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="SettingsEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public SettingsEntity Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<SettingsEntity>(_idx);
                        }
                    ...
                    {
                        /// <summary>
                        /// Gets the JSON property name for <see cref="HttpPort"/>.
                        /// </summary>
                        public const string HttpPort = "httpPort";

                        /// <summary>
                        /// Gets the JSON property name for <see cref="HttpsPort"/>.
                        /// </summary>
                        ...
                        /// Gets the JSON property name for <see cref="HttpPort"/>.
                        /// </summary>
                        public static ReadOnlySpan<byte> HttpPortUtf8 => "httpPort"u8;

                        /// <summary>
                        /// Gets the JSON property name for <see cref="HttpsPort"/>.
                        /// </summary>
                        public static ReadOnlySpan<byte> HttpsPortUtf8 => "httpsPort"u8;
                    }
                    ...
                    {
                        /// <summary>
                        /// Gets the escaped UTF-8 JSON property name for <see cref="HttpPort"/>.
                        /// </summary>
                        public static ReadOnlySpan<byte> HttpPort => "httpPort"u8;

                        /// <summary>
                        /// Gets the escaped UTF-8 JSON property name for <see cref="HttpsPort"/>.
                        /// </summary>
                        public static ReadOnlySpan<byte> HttpsPort => "httpsPort"u8;
                    }
                }
            }
        }
