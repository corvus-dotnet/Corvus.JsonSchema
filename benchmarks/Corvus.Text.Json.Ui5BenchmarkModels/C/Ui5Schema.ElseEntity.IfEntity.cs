...
public readonly partial struct Ui5Schema
{
    ...
    public readonly partial struct ElseEntity
    {
...
#endif
        {
            ...
            /// </summary>
            public Corvus.Ui5Benchmark.Current.Ui5Schema.ElseEntity.IfEntity.SpecVersionEntity SpecVersion
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SpecVersionUtf8, out Corvus.Ui5Benchmark.Current.Ui5Schema.ElseEntity.IfEntity.SpecVersionEntity value))
                    {
                        return value;
                    }
