...
public readonly partial struct Ui5Schema
{
    ...
    public readonly partial struct ElseEntity
    {
...
#endif
        {
            ...
            /// <param name="matchCorvusUi5BenchmarkCurrentUi5SchemaElseEntityThenEntity">Match a <see cref="Corvus.Ui5Benchmark.Current.Ui5Schema.ElseEntity.ThenEntity"/>.</param>
            ...
            public TResult Match<TContext, TResult>(
                in TContext context,
                Matcher<Corvus.Ui5Benchmark.Current.Ui5Schema.ElseEntity.ThenEntity, TContext, TResult> matchCorvusUi5BenchmarkCurrentUi5SchemaElseEntityThenEntity,
                Matcher<ElseEntity, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                {
                    return matchCorvusUi5BenchmarkCurrentUi5SchemaElseEntityThenEntity(Corvus.Ui5Benchmark.Current.Ui5Schema.ElseEntity.ThenEntity.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                Matcher<Corvus.Ui5Benchmark.Current.Ui5Schema.ElseEntity.ThenEntity, TResult> matchCorvusUi5BenchmarkCurrentUi5SchemaElseEntityThenEntity,
                Matcher<ElseEntity, TResult> defaultMatch)
            {
                if (Corvus.Ui5Benchmark.Current.Ui5Schema.ElseEntity.IfEntity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchCorvusUi5BenchmarkCurrentUi5SchemaElseEntityThenEntity(Corvus.Ui5Benchmark.Current.Ui5Schema.ElseEntity.ThenEntity.From(this));
                }
            ...
            public bool TryGetAsIfEntity(out Corvus.Ui5Benchmark.Current.Ui5Schema.ElseEntity.IfEntity.Mutable result)
            {
                if (Corvus.Ui5Benchmark.Current.Ui5Schema.ElseEntity.IfEntity.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Ui5Benchmark.Current.Ui5Schema.ElseEntity.IfEntity.Mutable.From(this);
                    return true;
                }
            ...
            public bool TryGetAsThenEntity(out Corvus.Ui5Benchmark.Current.Ui5Schema.ElseEntity.ThenEntity.Mutable result)
            {
                ...
                {
                    result = Corvus.Ui5Benchmark.Current.Ui5Schema.ElseEntity.ThenEntity.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5Benchmark.Current.Ui5Schema.ElseEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5Benchmark.Current.Ui5Schema.ElseEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
