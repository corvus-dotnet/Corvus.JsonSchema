...
public readonly partial struct Ui5Schema
{
...
#endif
    {
        ...
        /// </summary>
        public Corvus.Ui5Benchmark.Current.Ui5Schema.IfEntity.SpecVersionEntity SpecVersion
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SpecVersionUtf8, out Corvus.Ui5Benchmark.Current.Ui5Schema.IfEntity.SpecVersionEntity value))
                {
                    return value;
                }
