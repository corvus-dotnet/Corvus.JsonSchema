        ...
        public readonly partial struct ElseEntity
        {
            ...
            public readonly partial struct IfEntity
            {
...
#endif
                {
                    ...
                    /// </summary>
                    public Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.ElseEntity.IfEntity.KindEntity.Mutable Kind
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.KindUtf8, out Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.ElseEntity.IfEntity.KindEntity.Mutable value))
                            {
                                return value;
                            }
                    ...
                    public void SetKind(scoped in Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.ElseEntity.IfEntity.KindEntity.Source value)
                    {
                        CheckValidInstance();
                ...
                public ref struct Source
                {
                    ...
                    private readonly Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.ElseEntity.IfEntity.KindEntity.Source _createArg1;
                    ...
                    internal Source(Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.ElseEntity.IfEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    internal Source(scoped in Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.ElseEntity.IfEntity.KindEntity.Source arg1)
                    {
                        _createArg1 = arg1;
                        _kind = Kind.Create;
                    }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.ElseEntity.IfEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// </summary>
                    internal static void Create(ref ComplexValueBuilder builder, in Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.ElseEntity.IfEntity.KindEntity.Source kind = default)
                    {
                    ...
                    /// Creates an instance of a <see cref="IfEntity"/>.
                    /// </summary>
                    public void Create(in Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.ElseEntity.IfEntity.KindEntity.Source kind = default)
                    {
                    ...
                    internal static void BuildCreateValue(scoped in Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.ElseEntity.IfEntity.KindEntity.Source arg1, ref ComplexValueBuilder o)
                    {
                        o.StartObject();
                        Create(ref o, arg1);
                        o.EndObject();
                ...
                /// <returns>The source from which to build the value.</returns>
                public static Source Build(scoped in Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.ElseEntity.IfEntity.KindEntity.Source kind = default)
                {
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.ElseEntity.IfEntity.KindEntity.Source kind = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                ...
                public static ParsedJsonDocument<IfEntity> Create(in Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.ElseEntity.IfEntity.KindEntity.Source kind = default, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
