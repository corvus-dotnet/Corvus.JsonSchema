                ...
                public readonly partial struct ElseEntity
                {
                    ...
                    public readonly partial struct ElseEntity2
                    {
                        ...
                        public readonly partial struct WithTypeServerMiddleware
                        {
                            ...
                            public static ParsedJsonDocument<WithTypeServerMiddleware> Create(
                                scoped in Source value, int initialCapacity = 30)
                            {
                                ...
                                try
                                {
                                    ...
                                    Debug.Assert(cvb.MemberCount == 1);
                                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                    return documentBuilder.ToParsedJsonDocument<WithTypeServerMiddleware>();
                                }
                                finally
                                {
                            ...
                            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                            public static ParsedJsonDocument<WithTypeServerMiddleware> Create<TContext>(
                            ...
                            public static ParsedJsonDocument<WithTypeServerMiddleware> Create(in Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.ElseEntity.RequiredKindAndMetadataAndSpecVersionAndType.ElseEntity.ElseEntity2.WithTypeServerMiddleware.TypeEntity.Source type = default, int initialCapacity = 30)
                            {
                                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                                try
                                {
