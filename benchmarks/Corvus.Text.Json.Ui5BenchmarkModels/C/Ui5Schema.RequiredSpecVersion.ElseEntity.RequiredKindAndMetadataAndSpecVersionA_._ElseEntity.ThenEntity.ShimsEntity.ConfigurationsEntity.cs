                            ...
                            public readonly partial struct ThenEntity
                            {
                                ...
                                public readonly partial struct ShimsEntity
                                {
...
#endif
                                    {
                                        ...
                                        public bool TryGetProperty(ReadOnlySpan<byte> propertyName, out Corvus.Ui5Benchmark.Current.JsonObject value)
                                        {
                                            CheckValidInstance();
                                        ...
                                        /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
                                        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                                        public bool TryGetProperty(ReadOnlySpan<char> propertyName, out Corvus.Ui5Benchmark.Current.JsonObject value)
                                        {
                                            CheckValidInstance();
                                            return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
                                        }
                                        ...
                                        /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
                                        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                                        public bool TryGetProperty(string propertyName, out Corvus.Ui5Benchmark.Current.JsonObject value)
                                        {
                                            CheckValidInstance();
                                            return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
                                        }
                                        ...
                                        /// <see cref="Corvus.Ui5Benchmark.Current.JsonObject"/>.
                                        /// </summary>
                                        ...
                                        /// <returns><see langword="true"/> if the property name matches the pattern, otherwise <see langword="false"/>.</returns>
                                        public static bool TryAsPatternJsonObject(ReadOnlySpan<byte> propertyName, in JsonElement value, out Corvus.Ui5Benchmark.Current.JsonObject result)
                                        {
                                            if (MatchesPatternJsonObject(propertyName))
                                            {
                                                result = Corvus.Ui5Benchmark.Current.JsonObject.From(value);
                                                return true;
                                            }
                                        ...
                                        public interface IPatternPropertyVisitor<TState>
                                        {
                                            ...
                                            /// </summary>
                                            bool VisitPatternJsonObject(ReadOnlySpan<byte> name, in Corvus.Ui5Benchmark.Current.JsonObject value, ref TState state);
                                            ...
                                            where TVisitor : IPatternPropertyVisitor<TState>
                                        {
                                            ...
                                            foreach (var property in EnumerateObject())
                                            {
                                                ...
                                                {
                                                    matched = true;
                                                    Corvus.Ui5Benchmark.Current.JsonObject typedValue = Corvus.Ui5Benchmark.Current.JsonObject.From(property.Value);
                                        ...
                                        /// </summary>
                                        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                                        public ObjectEnumerator<Corvus.Ui5Benchmark.Current.JsonObject> EnumerateObject()
                                        {
                                            CheckValidInstance();
                                            return EnumeratorCreator.CreateObjectEnumerator<Corvus.Ui5Benchmark.Current.JsonObject>(_parent, _idx);
                                        }
