                        ...
                        public readonly partial struct ThenEntity
                        {
                            ...
                            public readonly partial struct MiddlewareEntity
                            {
...
#endif
                                {
                                    ...
                                    public static explicit operator Mutable(MiddlewareEntity instance)
                                    {
                                    ...
                                    /// <returns>An immutable instance of a <see cref="MiddlewareEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                    public static implicit operator MiddlewareEntity(Mutable instance)
                                    {
                                    ...
                                    /// </summary>
                                    public Corvus.Ui5Benchmark.Current.JsonString.Mutable Path
                                    {
                                        get
                                        {
                                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PathUtf8, out Corvus.Ui5Benchmark.Current.JsonString.Mutable value))
                                            {
                                                return value;
                                            }
                                    ...
                                    {
                                        return
                                            (obj is IJsonElement value && Equals(new MiddlewareEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                                    ...
                                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                    private string DebuggerDisplay => $"MiddlewareEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                                    ...
                                    /// <summary>
                                    /// Gets a <see cref="MiddlewareEntity"/> which can be safely stored beyond the lifetime of the
                                    /// original document.
                                    /// </summary>
                                    /// <returns>
                                    /// A <see cref="MiddlewareEntity"/> which can be safely stored beyond the lifetime of the
                                    /// original document.
                                    /// </returns>
                                    /// <remarks>
                                    /// <para>
                                    ...
                                    /// </para>
                                    /// </remarks>
                                    public readonly MiddlewareEntity Clone()
                                    {
                                        CheckValidInstance();
                                        return _parent.CloneElement<MiddlewareEntity>(_idx);
                                    }
                                    ...
                                    /// </summary>
                                    /// <returns>
                                    /// An immutable <see cref="MiddlewareEntity"/> that lives for the lifetime of its
                                    ...
                                    /// </para>
                                    /// </remarks>
                                    public readonly MiddlewareEntity Freeze()
                                    {
                                        CheckValidInstance();
                                        return _parent.FreezeElement<MiddlewareEntity>(_idx);
                                    }
                                }
                                ...
                                public ref struct Source
                                {
                                    ...
                                    internal Source(Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.ElseEntity.RequiredKindAndMetadataAndSpecVersionAndType.ElseEntity.ElseEntity2.ThenEntity.MiddlewareEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                                    ...
                                    public static implicit operator Source(MiddlewareEntity instance) => new(JsonElement.From(instance));
                                    ...
                                    #endif
                                {
                                    ...
                                    internal Source(scoped in TContext context, Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.ElseEntity.RequiredKindAndMetadataAndSpecVersionAndType.ElseEntity.ElseEntity2.ThenEntity.MiddlewareEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                                ...
                                public ref struct Builder
                                {
                                    ...
                                    /// <summary>
                                    /// Creates an instance of a <see cref="MiddlewareEntity"/>.
                                    /// </summary>
                                    internal static void Create(ref ComplexValueBuilder builder, in Corvus.Ui5Benchmark.Current.JsonString.Source path = default)
                                    {
                                    ...
                                    /// Creates an instance of a <see cref="MiddlewareEntity"/>.
                                    /// </summary>
                                    public void Create(in Corvus.Ui5Benchmark.Current.JsonString.Source path = default)
                                    {
                                ...
                                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5Benchmark.Current.JsonString.Source path = default, int initialCapacity = 30)
                                {
                                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                                    cvb.StartObject();
                                ...
                                {
                                    return workspace.CreateBuilder<MiddlewareEntity, Mutable>(this);
                                }
                                ...
                                public static ParsedJsonDocument<MiddlewareEntity> Create(
                                    scoped in Source value, int initialCapacity = 30)
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        Debug.Assert(cvb.MemberCount == 1);
                                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                        return documentBuilder.ToParsedJsonDocument<MiddlewareEntity>();
                                    }
                                    finally
                                    {
                                ...
                                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                                public static ParsedJsonDocument<MiddlewareEntity> Create<TContext>(
                                ...
                                public static ParsedJsonDocument<MiddlewareEntity> Create(in Corvus.Ui5Benchmark.Current.JsonString.Source path = default, int initialCapacity = 30)
                                {
                                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                                    try
                                    {
