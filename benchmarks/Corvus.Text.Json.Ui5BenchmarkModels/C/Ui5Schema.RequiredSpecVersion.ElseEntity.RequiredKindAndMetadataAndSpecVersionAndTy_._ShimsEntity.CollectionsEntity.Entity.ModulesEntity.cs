                                    ...
                                    public readonly partial struct CollectionsEntity
                                    {
                                        ...
                                        public readonly partial struct Entity
                                        {
...
#endif
                                            {
                                                ...
                                                public bool TryGetProperty(ReadOnlySpan<byte> propertyName, out Corvus.Ui5Benchmark.Current.JsonString value)
                                                {
                                                    CheckValidInstance();
                                                ...
                                                /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
                                                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                                                public bool TryGetProperty(ReadOnlySpan<char> propertyName, out Corvus.Ui5Benchmark.Current.JsonString value)
                                                {
                                                    CheckValidInstance();
                                                    return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
                                                }
                                                ...
                                                /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
                                                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                                                public bool TryGetProperty(string propertyName, out Corvus.Ui5Benchmark.Current.JsonString value)
                                                {
                                                    CheckValidInstance();
                                                    return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
                                                }
                                                ...
                                                /// <see cref="Corvus.Ui5Benchmark.Current.JsonString"/>.
                                                /// </summary>
                                                ...
                                                /// <returns><see langword="true"/> if the property name matches the pattern, otherwise <see langword="false"/>.</returns>
                                                public static bool TryAsPatternJsonString(ReadOnlySpan<byte> propertyName, in JsonElement value, out Corvus.Ui5Benchmark.Current.JsonString result)
                                                {
                                                    if (MatchesPatternJsonString(propertyName))
                                                    {
                                                        result = Corvus.Ui5Benchmark.Current.JsonString.From(value);
                                                        return true;
                                                    }
                                                ...
                                                public interface IPatternPropertyVisitor<TState>
                                                {
                                                    ...
                                                    /// </summary>
                                                    bool VisitPatternJsonString(ReadOnlySpan<byte> name, in Corvus.Ui5Benchmark.Current.JsonString value, ref TState state);
                                                    ...
                                                    where TVisitor : IPatternPropertyVisitor<TState>
                                                {
                                                    ...
                                                    foreach (var property in EnumerateObject())
                                                    {
                                                        ...
                                                        {
                                                            matched = true;
                                                            Corvus.Ui5Benchmark.Current.JsonString typedValue = Corvus.Ui5Benchmark.Current.JsonString.From(property.Value);
                                                ...
                                                /// </summary>
                                                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                                                public ObjectEnumerator<Corvus.Ui5Benchmark.Current.JsonString> EnumerateObject()
                                                {
                                                    CheckValidInstance();
                                                    return EnumeratorCreator.CreateObjectEnumerator<Corvus.Ui5Benchmark.Current.JsonString>(_parent, _idx);
                                                }
