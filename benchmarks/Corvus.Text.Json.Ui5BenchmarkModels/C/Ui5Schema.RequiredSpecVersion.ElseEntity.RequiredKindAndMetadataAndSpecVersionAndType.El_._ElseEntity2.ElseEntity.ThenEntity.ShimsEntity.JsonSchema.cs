                            ...
                            public readonly partial struct ThenEntity
                            {
                                    ...
                                    : IJsonElement<ShimsEntity>
                                {
                                    public static partial class JsonSchema
                                    {
                                        ...
                                        private static void MatchCollections(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                                        {
                                        ...
                                        private static void MatchConfigurations(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                                        {
                                            context.AddLocalEvaluatedProperty(propertyCount);
