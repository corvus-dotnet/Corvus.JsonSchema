                            ...
                            public readonly partial struct ThenEntity
                            {
                                ...
                                public readonly partial struct ShimsEntity
                                {
                                    ...
                                    public readonly partial struct ConfigurationsEntity
                                        ...
                                        : IJsonElement<ConfigurationsEntity>,
                                          IFormattable,
                                          ISpanFormattable,
...
#endif
                                    {
                                        ...
                                        /// <summary>
                                        /// Initializes a new instance of the <see cref="ConfigurationsEntity"/> struct.
                                        /// </summary>
                                        /// <param name="value">The value from which to construct the instance.</param>
                                        internal ConfigurationsEntity(IJsonDocument parent, int idx)
                                        {
                                            Debug.Assert(idx >= 0);
                                            _parent = parent;
                                            _idx = idx;
                                        ...
                                        /// </summary>
                                        public static ConfigurationsEntity DefaultInstance { get; }
                                        ...
                                        /// </returns>
                                        public static bool operator ==(in ConfigurationsEntity left, in ConfigurationsEntity right)
                                        {
                                        ...
                                        /// <c>True</c> if the values are equal.
                                        /// </returns>
                                        public static bool operator ==(in ConfigurationsEntity left, in JsonElement right)
                                        {
                                            return left.Equals(right);
                                        }
                                        ...
                                        public static implicit operator JsonElement(ConfigurationsEntity instance)
                                        {
                                        ...
                                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                        public static implicit operator ConfigurationsEntity(JsonElement instance)
                                        {
                                            return ConfigurationsEntity.From(instance);
                                        }
                                        ...
                                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                        public static ConfigurationsEntity From<T>(in T instance)
                                        ...
                                        /// </exception>
                                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                        public static ConfigurationsEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                                        {
                                            return JsonElementHelpers.ParseValue<ConfigurationsEntity>(utf8Json, options);
                                        }
                                        ...
                                        /// </exception>
                                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                        public static ConfigurationsEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                                        {
                                            return JsonElementHelpers.ParseValue<ConfigurationsEntity>(json, options);
                                        }
                                        ...
                                        /// </exception>
                                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                        public static ConfigurationsEntity ParseValue(string json, JsonDocumentOptions options = default)
                                        {
                                            return JsonElementHelpers.ParseValue<ConfigurationsEntity>(json, options);
                                        }
                                        ...
                                        /// </exception>
                                        public static ConfigurationsEntity ParseValue(ref Utf8JsonReader reader)
                                        {
                                            return JsonElementHelpers.ParseValue<ConfigurationsEntity>(ref reader);
                                        }
                                        ...
                                        ///   A value could not be read from the reader.
                                        /// </exception>
                                        public static bool TryParseValue(ref Utf8JsonReader reader, out ConfigurationsEntity? result)
                                        {
                                            return JsonElementHelpers.TryParseValue<ConfigurationsEntity>(ref reader, out result);
                                        }
...
#if NET
                                        static ConfigurationsEntity IJsonElement<ConfigurationsEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                        private string DebuggerDisplay => $"ConfigurationsEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                                        ...
                                        /// </para>
                                        /// </remarks>
                                        public ConfigurationsEntity Clone()
                                        {
                                            CheckValidInstance();
                                        ...
                                        /// </para>
                                        /// </remarks>
                                        public ConfigurationsEntity Freeze()
                                        {
                                            CheckValidInstance();
                                            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                                            {
                                                return mutable.FreezeElement<ConfigurationsEntity>(_idx);
                                            }
