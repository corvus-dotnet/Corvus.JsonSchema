                ...
                public readonly partial struct ElseEntity
                {
                    ...
                    public readonly partial struct ElseEntity2
                    {
                        ...
                        public readonly partial struct ThenEntity
                        {
                            ...
                            public readonly partial struct MiddlewareEntity
                                : IJsonElement<MiddlewareEntity>
                            {
                                public static partial class JsonSchema
                                {
                                    ...
                                    {
                                        if (span.SequenceEqual(JsonPropertyNames.PathUtf8))
                                        {
                                            matcher = MatchPath;
                                            return true;
                                        }
                                    ...
                                    /// </summary>
                                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("ui5-schema.json#/then/else/then/else/else/then/definitions/middleware"u8, buffer, out written);

                                    /// <summary>
                                    /// Gets the schema location from which this type was generated.
                                    /// </summary>
                                    public const string SchemaLocation = "ui5-schema.json#/then/else/then/else/else/then/definitions/middleware";

                                    /// <summary>
                                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                                    /// </summary>
                                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "ui5-schema.json#/then/else/then/else/else/then/definitions/middleware"u8;
