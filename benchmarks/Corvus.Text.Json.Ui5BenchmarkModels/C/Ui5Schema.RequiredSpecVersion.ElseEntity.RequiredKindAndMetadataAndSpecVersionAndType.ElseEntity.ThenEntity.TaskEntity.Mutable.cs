                    ...
                    public readonly partial struct ThenEntity
                    {
                        ...
                        public readonly partial struct TaskEntity
                        {
                                ...
                                #endif
                            {
                                ...
                                internal Source(scoped in TContext context, Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.ElseEntity.RequiredKindAndMetadataAndSpecVersionAndType.ElseEntity.ThenEntity.TaskEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                            ...
                            public static ParsedJsonDocument<TaskEntity> Create(
                                scoped in Source value, int initialCapacity = 30)
                            {
                                ...
                                try
                                {
                                    ...
                                    Debug.Assert(cvb.MemberCount == 1);
                                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                    return documentBuilder.ToParsedJsonDocument<TaskEntity>();
                                }
                                finally
                                {
                            ...
                            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                            public static ParsedJsonDocument<TaskEntity> Create<TContext>(
                            ...
                            public static ParsedJsonDocument<TaskEntity> Create(in Corvus.Ui5Benchmark.Current.JsonString.Source path = default, int initialCapacity = 30)
                            {
                                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                                try
                                {
