                                ...
                                public readonly partial struct ThenEntity
                                {
                                        ...
                                        : IJsonElement<SpecVersionEntity>
                                    {
                                        ...
                                        public static partial class JsonSchema
                                        {
                                            ...
                                            /// </summary>
                                            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("ui5-schema.json#/then/else/then/else/else/then/else/then/properties/specVersion"u8, buffer, out written);

                                            /// <summary>
                                            /// Gets the schema location from which this type was generated.
                                            /// </summary>
                                            public const string SchemaLocation = "ui5-schema.json#/then/else/then/else/else/then/else/then/properties/specVersion";

                                            /// <summary>
                                            /// Gets the schema location from which this type was generated as a UTF-8 string.
                                            /// </summary>
                                            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "ui5-schema.json#/then/else/then/else/else/then/else/then/properties/specVersion"u8;
