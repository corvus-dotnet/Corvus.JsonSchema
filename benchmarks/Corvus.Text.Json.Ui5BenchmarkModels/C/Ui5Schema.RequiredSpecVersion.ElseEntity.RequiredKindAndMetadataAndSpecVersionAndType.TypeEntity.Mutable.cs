            ...
            public readonly partial struct RequiredKindAndMetadataAndSpecVersionAndType
            {
                ...
                public readonly partial struct TypeEntity
                {
...
#endif
                    {
                        ...
                        /// <param name="matchTask">Match 1st item.</param>
                        /// <param name="matchServerMiddleware">Match 2nd item.</param>
                        /// <param name="matchProjectShim">Match 3rd item.</param>
                        /// <param name="defaultMatch">Match any other value.</param>
                        /// <returns>An instance of the value returned by the match function.</returns>
                        public TResult Match<TContext, TResult>(
                            in TContext context,
                            Func<TContext, TResult> matchTask,
                            Func<TContext, TResult> matchServerMiddleware,
                            Func<TContext, TResult> matchProjectShim,
...
#endif
                        {
                            ...
                            {
                                return matchTask(context);
                            }

                            if (this.ValueEquals(Constants.Enum2))
                            {
                                return matchServerMiddleware(context);
                            }

                            if (this.ValueEquals(Constants.Enum3))
                            {
                                return matchProjectShim(context);
                            }
                        ...
                        public TResult Match<TResult>(
                            Func<TResult> matchTask,
                            Func<TResult> matchServerMiddleware,
                            Func<TResult> matchProjectShim,
                            Func<TResult> defaultMatch)
                        {
                            ...
                            if (this.ValueEquals(Constants.Enum2))
                            {
                                return matchServerMiddleware();
                            }

                            if (this.ValueEquals(Constants.Enum3))
                            {
                                return matchProjectShim();
                            }
