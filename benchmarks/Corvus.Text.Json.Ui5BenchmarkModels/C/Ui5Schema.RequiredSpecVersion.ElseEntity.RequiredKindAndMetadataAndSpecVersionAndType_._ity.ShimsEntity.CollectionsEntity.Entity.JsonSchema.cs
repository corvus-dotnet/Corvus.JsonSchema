                                    ...
                                    public readonly partial struct CollectionsEntity
                                    {
                                            ...
                                            : IJsonElement<Entity>
                                        {
                                            public static partial class JsonSchema
                                            {
                                                ...
                                                private static void MatchModules(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                                                {
                                                ...
                                                /// </summary>
                                                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/then/else/then/else/else/else/then/definitions/shims/properties/collections/patternProperties/.+"u8, buffer, out written);
