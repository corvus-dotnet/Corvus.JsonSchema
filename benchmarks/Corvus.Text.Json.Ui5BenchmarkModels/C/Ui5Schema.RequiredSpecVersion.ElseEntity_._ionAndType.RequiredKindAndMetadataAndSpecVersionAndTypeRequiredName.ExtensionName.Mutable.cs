                ...
                public readonly partial struct RequiredKindAndMetadataAndSpecVersionAndTypeRequiredName
                {
                    ...
                    public readonly partial struct ExtensionName
                    {
...
#endif
                        {
                            ...
                            public static explicit operator Mutable(ExtensionName instance)
                            {
                            ...
                            /// <returns>An immutable instance of a <see cref="ExtensionName"/>, initialized from the <see cref="Mutable"/> value.</returns>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator ExtensionName(Mutable instance)
                            {
                            ...
                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            private string DebuggerDisplay => $"ExtensionName.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly ExtensionName Clone()
                            {
                                CheckValidInstance();
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly ExtensionName Freeze()
                            {
                                CheckValidInstance();
                                return _parent.FreezeElement<ExtensionName>(_idx);
                            }
                        }
                        ...
                        public ref struct Source
                        {
                            ...
                            public static implicit operator Source(ExtensionName instance) => new(JsonElement.From(instance));
                        ...
                        {
                            return workspace.CreateBuilder<ExtensionName, Mutable>(this);
                        }
                        ...
                        public static ParsedJsonDocument<ExtensionName> Create(
                            scoped in Source value, int initialCapacity = 1)
                        {
                            ...
                            try
                            {
                                ...
                                Debug.Assert(cvb.MemberCount == 1);
                                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                return documentBuilder.ToParsedJsonDocument<ExtensionName>();
                            }
                            finally
                            {
