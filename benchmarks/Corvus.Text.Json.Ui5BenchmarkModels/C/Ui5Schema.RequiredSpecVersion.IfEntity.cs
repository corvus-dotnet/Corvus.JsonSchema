...
public readonly partial struct Ui5Schema
{
    ...
    public readonly partial struct RequiredSpecVersion
    {
...
#endif
        {
            ...
            /// </summary>
            public Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.IfEntity.KindEntity Kind
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.KindUtf8, out Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.IfEntity.KindEntity value))
                    {
                        return value;
                    }
