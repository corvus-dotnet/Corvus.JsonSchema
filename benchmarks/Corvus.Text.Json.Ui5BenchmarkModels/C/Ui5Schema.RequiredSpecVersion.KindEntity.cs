...
public readonly partial struct Ui5Schema
{
    ...
    public readonly partial struct RequiredSpecVersion
    {
...
#endif
        {
            ...
            /// <param name="matchProject">Match 1st item.</param>
            /// <param name="matchExtension">Match 2nd item.</param>
            /// <param name="matchNull">Match 3rd item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchProject,
                Func<TContext, TResult> matchExtension,
...
#endif
            {
                ...
                {
                    return matchProject(context);
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchExtension(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchProject,
                Func<TResult> matchExtension,
