                ...
                public readonly partial struct RequiredMetadataAndSpecVersionAndType
                {
                    ...
                    public readonly partial struct BuilderSpecVersion24Entity
                    {
                        ...
                        public readonly partial struct CachebusterEntity
                            ...
                            : IJsonElement<CachebusterEntity>,
                              IFormattable,
                              ISpanFormattable,
...
#endif
                        {
                            ...
                            /// <summary>
                            /// Initializes a new instance of the <see cref="CachebusterEntity"/> struct.
                            /// </summary>
                            ...
                            internal CachebusterEntity(IJsonDocument parent, int idx)
                            {
                                Debug.Assert(idx >= 0);
                                _parent = parent;
                                _idx = idx;
                            ...
                            /// </summary>
                            public static CachebusterEntity DefaultInstance { get; }

                            /// <summary>
                            /// Gets the (optional) <c>signatureType</c> property.
                            /// </summary>
                            public Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ElseEntity.RequiredMetadataAndSpecVersionAndType.BuilderSpecVersion24Entity.CachebusterEntity.SignatureTypeEntity SignatureType
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SignatureTypeUtf8, out Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ElseEntity.RequiredMetadataAndSpecVersionAndType.BuilderSpecVersion24Entity.CachebusterEntity.SignatureTypeEntity value))
                                    {
                                        return value;
                                    }
                            ...
                            /// </returns>
                            public static bool operator ==(in CachebusterEntity left, in CachebusterEntity right)
                            {
                            ...
                            /// <c>True</c> if the values are equal.
                            /// </returns>
                            public static bool operator ==(in CachebusterEntity left, in JsonElement right)
                            {
                                return left.Equals(right);
                            }
                            ...
                            public static implicit operator JsonElement(CachebusterEntity instance)
                            {
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator CachebusterEntity(JsonElement instance)
                            {
                                return CachebusterEntity.From(instance);
                            }
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static CachebusterEntity From<T>(in T instance)
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static CachebusterEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                            {
                                #pragma warning disable CS0618 // Type or member is obsolete
                                return JsonElementHelpers.ParseValue<CachebusterEntity>(utf8Json, options);
                            ...
                            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static CachebusterEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                            {
                                #pragma warning disable CS0618 // Type or member is obsolete
                                return JsonElementHelpers.ParseValue<CachebusterEntity>(json, options);
                                #pragma warning restore CS0618
                            }
                            ...
                            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static CachebusterEntity ParseValue(string json, JsonDocumentOptions options = default)
                            {
                                #pragma warning disable CS0618 // Type or member is obsolete
                                return JsonElementHelpers.ParseValue<CachebusterEntity>(json, options);
                                #pragma warning restore CS0618
                            ...
                            /// </exception>
                            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                            public static CachebusterEntity ParseValue(ref Utf8JsonReader reader)
                            {
                                #pragma warning disable CS0618 // Type or member is obsolete
                                return JsonElementHelpers.ParseValue<CachebusterEntity>(ref reader);
                                #pragma warning restore CS0618
                            }
                            ...
                            ///   A value could not be read from the reader.
                            /// </exception>
                            public static bool TryParseValue(ref Utf8JsonReader reader, out CachebusterEntity? result)
                            {
                                return JsonElementHelpers.TryParseValue<CachebusterEntity>(ref reader, out result);
                            }
...
#if NET
                            static CachebusterEntity IJsonElement<CachebusterEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            private string DebuggerDisplay => $"CachebusterEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                            ...
                            /// </para>
                            /// </remarks>
                            public CachebusterEntity Clone()
                            {
                                CheckValidInstance();
                            ...
                            /// </para>
                            /// </remarks>
                            public CachebusterEntity Freeze()
                            {
                                CheckValidInstance();
                                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                                {
                                    return mutable.FreezeElement<CachebusterEntity>(_idx);
                                }
                            ...
                            {
                                /// <summary>
                                /// Gets the JSON property name for <see cref="SignatureType"/>.
                                /// </summary>
                                ...
                                /// Gets the JSON property name for <see cref="SignatureType"/>.
                                /// </summary>
                                public static ReadOnlySpan<byte> SignatureTypeUtf8 => "signatureType"u8;
                            }
                            ...
                            {
                                /// <summary>
                                /// Gets the escaped UTF-8 JSON property name for <see cref="SignatureType"/>.
                                /// </summary>
                                public static ReadOnlySpan<byte> SignatureType => "signatureType"u8;
                            }
                            ...
                            {
                                /// <summary>
                                /// Gets the pre-baked property name blob for <see cref="SignatureType"/>.
                                /// </summary>
                                public static ReadOnlySpan<byte> SignatureType => [0xF5, 0x00, 0x00, 0x00, 0x22, 0x73, 0x69, 0x67, 0x6E, 0x61, 0x74, 0x75, 0x72, 0x65, 0x54, 0x79, 0x70, 0x65, 0x22];
                            }
                        }
                    }
                }
