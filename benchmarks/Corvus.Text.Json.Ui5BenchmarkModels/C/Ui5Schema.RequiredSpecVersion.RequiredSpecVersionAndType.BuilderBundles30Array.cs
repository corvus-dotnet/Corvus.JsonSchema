...
public readonly partial struct Ui5Schema
{
    ...
    public readonly partial struct RequiredSpecVersion
    {
        ...
        public readonly partial struct RequiredSpecVersionAndType
        {
            ...
            public readonly partial struct BuilderBundles30Array
#if NET8_0_OR_GREATER
                : IJsonElement<BuilderBundles30Array>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="BuilderBundles30Array"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal BuilderBundles30Array(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static BuilderBundles30Array DefaultInstance { get; }
                ...
                /// </returns>
                public static bool operator ==(in BuilderBundles30Array left, in BuilderBundles30Array right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in BuilderBundles30Array left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(BuilderBundles30Array instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator BuilderBundles30Array(JsonElement instance)
                {
                    return BuilderBundles30Array.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static BuilderBundles30Array From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static BuilderBundles30Array ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<BuilderBundles30Array>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static BuilderBundles30Array ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<BuilderBundles30Array>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static BuilderBundles30Array ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<BuilderBundles30Array>(json, options);
                }
                ...
                /// </exception>
                public static BuilderBundles30Array ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<BuilderBundles30Array>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out BuilderBundles30Array? result)
                {
                    return JsonElementHelpers.TryParseValue<BuilderBundles30Array>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new BuilderBundles30Array(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static BuilderBundles30Array IJsonElement<BuilderBundles30Array>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"BuilderBundles30Array: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="BuilderBundles30Array"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="BuilderBundles30Array"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public BuilderBundles30Array Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<BuilderBundles30Array>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="BuilderBundles30Array"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public BuilderBundles30Array Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<BuilderBundles30Array>(_idx);
                    }
