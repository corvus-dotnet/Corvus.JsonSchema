    ...
    public readonly partial struct RequiredSpecVersion
    {
        ...
        public readonly partial struct RequiredSpecVersionAndType
        {
            ...
            public readonly partial struct BuilderBundlesArray
                ...
                : IJsonElement<BuilderBundlesArray>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="BuilderBundlesArray"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal BuilderBundlesArray(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static BuilderBundlesArray DefaultInstance { get; }
                ...
                /// </returns>
                public static bool operator ==(in BuilderBundlesArray left, in BuilderBundlesArray right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in BuilderBundlesArray left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(BuilderBundlesArray instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator BuilderBundlesArray(JsonElement instance)
                {
                    return BuilderBundlesArray.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static BuilderBundlesArray From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static BuilderBundlesArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<BuilderBundlesArray>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static BuilderBundlesArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<BuilderBundlesArray>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static BuilderBundlesArray ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<BuilderBundlesArray>(json, options);
                }
                ...
                /// </exception>
                public static BuilderBundlesArray ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<BuilderBundlesArray>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out BuilderBundlesArray? result)
                {
                    return JsonElementHelpers.TryParseValue<BuilderBundlesArray>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new BuilderBundlesArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static BuilderBundlesArray IJsonElement<BuilderBundlesArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"BuilderBundlesArray: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="BuilderBundlesArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="BuilderBundlesArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public BuilderBundlesArray Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<BuilderBundlesArray>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="BuilderBundlesArray"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public BuilderBundlesArray Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<BuilderBundlesArray>(_idx);
                    }
