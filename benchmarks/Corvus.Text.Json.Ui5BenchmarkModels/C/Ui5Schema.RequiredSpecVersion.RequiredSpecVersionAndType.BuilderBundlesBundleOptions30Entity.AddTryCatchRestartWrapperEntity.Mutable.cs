            ...
            public readonly partial struct BuilderBundlesBundleOptions30Entity
            {
                ...
                public readonly partial struct AddTryCatchRestartWrapperEntity
                {
...
#endif
                    {
                        ...
                        /// </remarks>
                        public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<AddTryCatchRestartWrapperEntity, Mutable>(AddTryCatchRestartWrapperEntity.DefaultInstance);
                        ...
                        public static explicit operator Mutable(AddTryCatchRestartWrapperEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="AddTryCatchRestartWrapperEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator AddTryCatchRestartWrapperEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"AddTryCatchRestartWrapperEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly AddTryCatchRestartWrapperEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly AddTryCatchRestartWrapperEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<AddTryCatchRestartWrapperEntity>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(AddTryCatchRestartWrapperEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<AddTryCatchRestartWrapperEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<AddTryCatchRestartWrapperEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<AddTryCatchRestartWrapperEntity>();
                        }
                        finally
                        {
