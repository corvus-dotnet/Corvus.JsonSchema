    ...
    public readonly partial struct RequiredSpecVersion
    {
        ...
        public readonly partial struct RequiredSpecVersionAndType
        {
            ...
            public readonly partial struct BuilderBundlesBundleOptions30Entity
            {
                ...
                public readonly partial struct AddTryCatchRestartWrapperEntity
#if NET8_0_OR_GREATER
                    : IJsonElement<AddTryCatchRestartWrapperEntity>,
                      IFormattable,
                      ISpanFormattable,
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="AddTryCatchRestartWrapperEntity"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal AddTryCatchRestartWrapperEntity(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static AddTryCatchRestartWrapperEntity DefaultInstance { get; } = ParsedJsonDocument<AddTryCatchRestartWrapperEntity>.False;
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator bool(AddTryCatchRestartWrapperEntity value)
                    {
                    ...
                    /// </returns>
                    public static bool operator ==(in AddTryCatchRestartWrapperEntity left, in AddTryCatchRestartWrapperEntity right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in AddTryCatchRestartWrapperEntity left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator JsonElement(AddTryCatchRestartWrapperEntity instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator AddTryCatchRestartWrapperEntity(JsonElement instance)
                    {
                        return AddTryCatchRestartWrapperEntity.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static AddTryCatchRestartWrapperEntity From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static AddTryCatchRestartWrapperEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<AddTryCatchRestartWrapperEntity>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static AddTryCatchRestartWrapperEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<AddTryCatchRestartWrapperEntity>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static AddTryCatchRestartWrapperEntity ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<AddTryCatchRestartWrapperEntity>(json, options);
                    }
                    ...
                    /// </exception>
                    public static AddTryCatchRestartWrapperEntity ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<AddTryCatchRestartWrapperEntity>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out AddTryCatchRestartWrapperEntity? result)
                    {
                        return JsonElementHelpers.TryParseValue<AddTryCatchRestartWrapperEntity>(ref reader, out result);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new AddTryCatchRestartWrapperEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                    static AddTryCatchRestartWrapperEntity IJsonElement<AddTryCatchRestartWrapperEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"AddTryCatchRestartWrapperEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="AddTryCatchRestartWrapperEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="AddTryCatchRestartWrapperEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public AddTryCatchRestartWrapperEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<AddTryCatchRestartWrapperEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="AddTryCatchRestartWrapperEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public AddTryCatchRestartWrapperEntity Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<AddTryCatchRestartWrapperEntity>(_idx);
                        }
