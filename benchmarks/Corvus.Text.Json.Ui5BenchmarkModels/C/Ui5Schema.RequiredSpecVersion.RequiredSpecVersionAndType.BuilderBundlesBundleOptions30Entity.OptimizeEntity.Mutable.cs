            ...
            public readonly partial struct BuilderBundlesBundleOptions30Entity
            {
                ...
                public readonly partial struct OptimizeEntity
                {
...
#endif
                    {
                        ...
                        /// </remarks>
                        public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<OptimizeEntity, Mutable>(OptimizeEntity.DefaultInstance);
                        ...
                        public static explicit operator Mutable(OptimizeEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="OptimizeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator OptimizeEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"OptimizeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(OptimizeEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<OptimizeEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<OptimizeEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<OptimizeEntity>();
                        }
                        finally
                        {
