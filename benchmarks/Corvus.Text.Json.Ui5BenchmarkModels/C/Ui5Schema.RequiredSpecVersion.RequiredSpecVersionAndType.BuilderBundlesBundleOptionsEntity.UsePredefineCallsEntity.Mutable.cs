            ...
            public readonly partial struct BuilderBundlesBundleOptionsEntity
            {
                ...
                public readonly partial struct UsePredefineCallsEntity
                {
...
#endif
                    {
                        ...
                        /// </remarks>
                        public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<UsePredefineCallsEntity, Mutable>(UsePredefineCallsEntity.DefaultInstance);
                        ...
                        public static explicit operator Mutable(UsePredefineCallsEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="UsePredefineCallsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator UsePredefineCallsEntity(Mutable instance)
                        {
                        ...
                        {
                            return
                                (obj is IJsonElement value && Equals(new UsePredefineCallsEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"UsePredefineCallsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// <summary>
                        /// Gets a <see cref="UsePredefineCallsEntity"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </summary>
                        /// <returns>
                        /// A <see cref="UsePredefineCallsEntity"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </returns>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly UsePredefineCallsEntity Clone()
                        {
                            CheckValidInstance();
                            return _parent.CloneElement<UsePredefineCallsEntity>(_idx);
                        }
                        ...
                        /// </summary>
                        /// <returns>
                        /// An immutable <see cref="UsePredefineCallsEntity"/> that lives for the lifetime of its
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly UsePredefineCallsEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<UsePredefineCallsEntity>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(UsePredefineCallsEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<UsePredefineCallsEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<UsePredefineCallsEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<UsePredefineCallsEntity>();
                        }
                        finally
                        {
