            ...
            public readonly partial struct BuilderComponentPreloadSpecVersion23Entity
            {
                ...
                public readonly partial struct NamespacesArray
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(NamespacesArray instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="NamespacesArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator NamespacesArray(Mutable instance)
                        {
                        ...
                        {
                            return
                                (obj is IJsonElement value && Equals(new NamespacesArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"NamespacesArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        /// <summary>
                        ...
                        /// <summary>
                        /// Gets a <see cref="NamespacesArray"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </summary>
                        /// <returns>
                        /// A <see cref="NamespacesArray"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </returns>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly NamespacesArray Clone()
                        {
                            CheckValidInstance();
                            return _parent.CloneElement<NamespacesArray>(_idx);
                        }
                        ...
                        /// </summary>
                        /// <returns>
                        /// An immutable <see cref="NamespacesArray"/> that lives for the lifetime of its
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly NamespacesArray Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<NamespacesArray>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        internal Source(Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.BuilderComponentPreloadSpecVersion23Entity.NamespacesArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                        public static implicit operator Source(NamespacesArray instance) => new(JsonElement.From(instance));
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.BuilderComponentPreloadSpecVersion23Entity.NamespacesArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
                    ...
                    {
                        return workspace.CreateBuilder<NamespacesArray, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<NamespacesArray> Create(
                        scoped in Source value, int initialCapacity = 30)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<NamespacesArray>();
                        }
                        finally
                        {
                    ...
                    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                    public static ParsedJsonDocument<NamespacesArray> Create<TContext>(
