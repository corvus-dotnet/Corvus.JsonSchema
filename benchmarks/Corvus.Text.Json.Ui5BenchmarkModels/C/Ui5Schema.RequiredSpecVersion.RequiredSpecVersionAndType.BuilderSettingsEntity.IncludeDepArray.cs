    ...
    public readonly partial struct RequiredSpecVersion
    {
        ...
        public readonly partial struct RequiredSpecVersionAndType
        {
            ...
            public readonly partial struct BuilderSettingsEntity
            {
                ...
                public readonly partial struct IncludeDepArray
#if NET8_0_OR_GREATER
                    : IJsonElement<IncludeDepArray>,
                      IFormattable,
                      ISpanFormattable,
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="IncludeDepArray"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal IncludeDepArray(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static IncludeDepArray DefaultInstance { get; }
                    ...
                    public Corvus.Ui5Benchmark.Current.JsonString this[int index]
                    {
                        get
                        {
                            CheckValidInstance();
                            return _parent.GetArrayIndexElement<Corvus.Ui5Benchmark.Current.JsonString>(_idx, index);
                        }
                    }
                    ...
                    /// </summary>
                    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                    public ArrayEnumerator<Corvus.Ui5Benchmark.Current.JsonString> EnumerateArray()
                    {
                        CheckValidInstance();
                        return EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5Benchmark.Current.JsonString>(_parent, _idx);
                    }
                    ...
                    /// </returns>
                    public static bool operator ==(in IncludeDepArray left, in IncludeDepArray right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in IncludeDepArray left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    public static implicit operator JsonElement(IncludeDepArray instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator IncludeDepArray(JsonElement instance)
                    {
                        return IncludeDepArray.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static IncludeDepArray From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static IncludeDepArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<IncludeDepArray>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static IncludeDepArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<IncludeDepArray>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static IncludeDepArray ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<IncludeDepArray>(json, options);
                    }
                    ...
                    /// </exception>
                    public static IncludeDepArray ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<IncludeDepArray>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out IncludeDepArray? result)
                    {
                        return JsonElementHelpers.TryParseValue<IncludeDepArray>(ref reader, out result);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new IncludeDepArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                    static IncludeDepArray IJsonElement<IncludeDepArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"IncludeDepArray: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="IncludeDepArray"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="IncludeDepArray"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public IncludeDepArray Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<IncludeDepArray>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="IncludeDepArray"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public IncludeDepArray Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<IncludeDepArray>(_idx);
                        }
