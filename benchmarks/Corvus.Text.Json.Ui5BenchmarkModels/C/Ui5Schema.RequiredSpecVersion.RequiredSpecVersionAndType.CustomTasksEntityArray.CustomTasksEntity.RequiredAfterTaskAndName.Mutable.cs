                ...
                public readonly partial struct CustomTasksEntity
                {
                    ...
                    public readonly partial struct RequiredAfterTaskAndName
                    {
...
#endif
                        {
                            ...
                            public static explicit operator Mutable(RequiredAfterTaskAndName instance)
                            {
                            ...
                            /// <returns>An immutable instance of a <see cref="RequiredAfterTaskAndName"/>, initialized from the <see cref="Mutable"/> value.</returns>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator RequiredAfterTaskAndName(Mutable instance)
                            {
                            ...
                            /// <summary>
                            /// Gets the <c>afterTask</c> property.
                            /// </summary>
                            /// <remarks>
                            /// <para>
                            ...
                            /// </para>
                            /// </remarks>
                            public Corvus.Ui5Benchmark.Current.JsonString.Mutable AfterTask
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AfterTaskUtf8, out Corvus.Ui5Benchmark.Current.JsonString.Mutable value))
                                    {
                                        return value;
                                    }
                            ...
                            {
                                return
                                    (obj is IJsonElement value && Equals(new RequiredAfterTaskAndName(value.ParentDocument, value.ParentDocumentIndex))) ||
                            ...
                            public void SetAfterTask(scoped in Corvus.Ui5Benchmark.Current.JsonString.Source value)
                            {
                                ...
                                {
                                    CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("afterTask");
                                }

                                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AfterTaskUtf8, out IJsonDocument? elementParent, out int elementIdx))
                                {
                                ...
                                else
                                {
                                    ...
                                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.AfterTask, ref cvb);
                            ...
                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            private string DebuggerDisplay => $"RequiredAfterTaskAndName.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                            ...
                            /// <summary>
                            /// Gets a <see cref="RequiredAfterTaskAndName"/> which can be safely stored beyond the lifetime of the
                            /// original document.
                            /// </summary>
                            /// <returns>
                            /// A <see cref="RequiredAfterTaskAndName"/> which can be safely stored beyond the lifetime of the
                            /// original document.
                            /// </returns>
                            /// <remarks>
                            /// <para>
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly RequiredAfterTaskAndName Clone()
                            {
                                CheckValidInstance();
                                return _parent.CloneElement<RequiredAfterTaskAndName>(_idx);
                            }
                            ...
                            /// </summary>
                            /// <returns>
                            /// An immutable <see cref="RequiredAfterTaskAndName"/> that lives for the lifetime of its
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly RequiredAfterTaskAndName Freeze()
                            {
                                CheckValidInstance();
                                return _parent.FreezeElement<RequiredAfterTaskAndName>(_idx);
                            }
                        }
                        ...
                        public ref struct Source
                        {
                            ...
                            public static implicit operator Source(RequiredAfterTaskAndName instance) => new(JsonElement.From(instance));
                        ...
                        public ref struct Builder
                        {
                            ...
                            /// <summary>
                            /// Creates an instance of a <see cref="RequiredAfterTaskAndName"/>.
                            /// </summary>
                            internal static void Create(
                                ref ComplexValueBuilder builder,
                                in Corvus.Ui5Benchmark.Current.JsonString.Source afterTask,
                                in Corvus.Ui5Benchmark.Current.JsonString.Source name,
                                in Corvus.Text.Json.JsonElement.Source configuration = default)
                            {
                                afterTask.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.AfterTask, ref builder);
                            ...
                            public void Create(
                                ...
                                in Corvus.Text.Json.JsonElement.Source configuration = default)
                            {
                                Create(ref _builder, afterTask, name, configuration);
                            }
                            ...
                            #endif
                            {
                                Create(context, ref _builder, afterTask, name, configuration);
                            }
                        ...
                        /// </summary>
                        /// <param name="afterTask">The value of the <c>"afterTask"</c> property.</param>
                        ...
                        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Ui5Benchmark.Current.JsonString.Source afterTask, scoped in Corvus.Ui5Benchmark.Current.JsonString.Source name, scoped in Corvus.Text.Json.JsonElement.Source<TContext> configuration = default)
                            ...
                            #endif
                        {
                            return new Source<TContext>(context, afterTask, name, configuration);
                        }
                        ...
                        /// </summary>
                        /// <param name="workspace">The JSON workspace.</param>
                        /// <param name="afterTask">The value of the property.</param>
                        ...
                        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5Benchmark.Current.JsonString.Source afterTask, in Corvus.Ui5Benchmark.Current.JsonString.Source name, in Corvus.Text.Json.JsonElement.Source configuration = default, int initialCapacity = 30)
                        {
                            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                            cvb.StartObject();
                            Builder ovb = new(cvb);
                            ovb.Create(afterTask, name, configuration);
                            cvb = ovb._builder;
                            cvb.EndObject();
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder;
                        ...
                        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Ui5Benchmark.Current.JsonString.Source afterTask, in Corvus.Ui5Benchmark.Current.JsonString.Source name, in Corvus.Text.Json.JsonElement.Source<TContext> configuration = default, int initialCapacity = 30)
                            #if NET9_0_OR_GREATER
                            where TContext : allows ref struct
                            #endif
                        {
                            ...
                            cvb.StartObject();
                            Builder ovb = new(cvb);
                            ovb.Create(context, afterTask, name, configuration);
                            cvb = ovb._builder;
                            cvb.EndObject();
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder;
                        ...
                        {
                            return workspace.CreateBuilder<RequiredAfterTaskAndName, Mutable>(this);
                        }
                        ...
                        public static ParsedJsonDocument<RequiredAfterTaskAndName> Create(
                            scoped in Source value, int initialCapacity = 30)
                        {
                            ...
                            try
                            {
                                ...
                                Debug.Assert(cvb.MemberCount == 1);
                                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                return documentBuilder.ToParsedJsonDocument<RequiredAfterTaskAndName>();
                            }
                            finally
                            {
                        ...
                        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                        public static ParsedJsonDocument<RequiredAfterTaskAndName> Create<TContext>(
                        ...
                        public static ParsedJsonDocument<RequiredAfterTaskAndName> Create(in Corvus.Ui5Benchmark.Current.JsonString.Source afterTask, in Corvus.Ui5Benchmark.Current.JsonString.Source name, in Corvus.Text.Json.JsonElement.Source configuration = default, int initialCapacity = 30)
                        {
                            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                            try
                            {
                        ...
                        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
                        public static ParsedJsonDocument<RequiredAfterTaskAndName> Create<TContext>(in TContext context, in Corvus.Ui5Benchmark.Current.JsonString.Source afterTask, in Corvus.Ui5Benchmark.Current.JsonString.Source name, in Corvus.Text.Json.JsonElement.Source<TContext> configuration = default, int initialCapacity = 30)
                            #if NET9_0_OR_GREATER
                            where TContext : allows ref struct
                            #endif
                        {
