            ...
            public readonly partial struct CustomTasksEntityArray
            {
                ...
                public readonly partial struct CustomTasksEntity
                {
...
#endif
                    {
                        ...
                        /// <summary>
                        /// Initializes a new instance of the <see cref="RequiredAfterTaskAndName"/> struct.
                        /// </summary>
                        /// <param name="value">The value from which to construct the instance.</param>
                        internal RequiredAfterTaskAndName(IJsonDocument parent, int idx)
                        {
                            Debug.Assert(idx >= 0);
                            _parent = parent;
                            _idx = idx;
                        ...
                        /// </summary>
                        public static RequiredAfterTaskAndName DefaultInstance { get; }
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.Ui5Benchmark.Current.JsonString AfterTask
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AfterTaskUtf8, out Corvus.Ui5Benchmark.Current.JsonString value))
                                {
                                    return value;
                                }
                        ...
                        /// </returns>
                        public static bool operator ==(in RequiredAfterTaskAndName left, in RequiredAfterTaskAndName right)
                        {
                        ...
                        /// <c>True</c> if the values are equal.
                        /// </returns>
                        public static bool operator ==(in RequiredAfterTaskAndName left, in JsonElement right)
                        {
                            return left.Equals(right);
                        }
                        ...
                        public static implicit operator JsonElement(RequiredAfterTaskAndName instance)
                        {
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator RequiredAfterTaskAndName(JsonElement instance)
                        {
                            return RequiredAfterTaskAndName.From(instance);
                        }
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static RequiredAfterTaskAndName From<T>(in T instance)
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static RequiredAfterTaskAndName ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<RequiredAfterTaskAndName>(utf8Json, options);
                        }
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static RequiredAfterTaskAndName ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<RequiredAfterTaskAndName>(json, options);
                        }
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static RequiredAfterTaskAndName ParseValue(string json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<RequiredAfterTaskAndName>(json, options);
                        }
                        ...
                        /// </exception>
                        public static RequiredAfterTaskAndName ParseValue(ref Utf8JsonReader reader)
                        {
                            return JsonElementHelpers.ParseValue<RequiredAfterTaskAndName>(ref reader);
                        }
                        ...
                        ///   A value could not be read from the reader.
                        /// </exception>
                        public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredAfterTaskAndName? result)
                        {
                            return JsonElementHelpers.TryParseValue<RequiredAfterTaskAndName>(ref reader, out result);
                        }
...
#if NET
                        static RequiredAfterTaskAndName IJsonElement<RequiredAfterTaskAndName>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"RequiredAfterTaskAndName: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public RequiredAfterTaskAndName Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public RequiredAfterTaskAndName Freeze()
                        {
                            CheckValidInstance();
                            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                            {
                                return mutable.FreezeElement<RequiredAfterTaskAndName>(_idx);
                            }
                        ...
                        {
                            /// <summary>
                            /// Gets the JSON property name for <see cref="AfterTask"/>.
                            /// </summary>
                            ...
                            /// Gets the JSON property name for <see cref="AfterTask"/>.
                            /// </summary>
                            public static ReadOnlySpan<byte> AfterTaskUtf8 => "afterTask"u8;
                        ...
                        {
                            /// <summary>
                            /// Gets the escaped UTF-8 JSON property name for <see cref="AfterTask"/>.
                            /// </summary>
                            public static ReadOnlySpan<byte> AfterTask => "afterTask"u8;
                        ...
                        {
                            /// <summary>
                            /// Gets the pre-baked property name blob for <see cref="AfterTask"/>.
                            /// </summary>
                            public static ReadOnlySpan<byte> AfterTask => [0xB5, 0x00, 0x00, 0x00, 0x22, 0x61, 0x66, 0x74, 0x65, 0x72, 0x54, 0x61, 0x73, 0x6B, 0x22];
