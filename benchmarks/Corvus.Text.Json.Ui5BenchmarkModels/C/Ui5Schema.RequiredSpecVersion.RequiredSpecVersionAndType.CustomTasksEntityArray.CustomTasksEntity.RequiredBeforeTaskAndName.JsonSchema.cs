            ...
            public readonly partial struct CustomTasksEntityArray
            {
                ...
                public readonly partial struct CustomTasksEntity
                {
                        ...
                        : IJsonElement<RequiredBeforeTaskAndName>
                    {
                        ...
                        {
                            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyBeforeTaskPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("beforeTask"u8, buffer, out written);
                            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyBeforeTaskNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("beforeTask"u8, buffer, out written);

                            private const int RequiredOffsetForBeforeTask = 0;
                            private const uint RequiredBitForBeforeTask = 0b00000000000000000000000000000001;
                            ...
                            private const uint RequiredBitMask0 =
                                RequiredBitForBeforeTask | RequiredBitForName;
                            private static readonly JsonSchemaPathProvider BeforeTaskSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/beforeTask"u8, buffer, out written);
                            ...
                            private static void MatchBeforeTask(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                            {
                                ...
                                JsonSchemaContext childContext =
                                    Corvus.Ui5Benchmark.Current.JsonString.JsonSchema.PushChildContextUnescaped(
                                        ...
                                        parentDocumentIndex,
                                        ref context,
                                        JsonPropertyNames.BeforeTaskUtf8,
                                        evaluationPath: BeforeTaskSchemaEvaluationPath);
                                ...
                                requiredBitBuffer[RequiredOffsetForBeforeTask] |= RequiredBitForBeforeTask;
                            }
                            ...
                            private static PropertySchemaMatchers<Corvus.Ui5Benchmark.Current.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
                            {
                                return new PropertySchemaMatchers<Corvus.Ui5Benchmark.Current.PropertiesValidationHandler_NamedPropertyValidator>([
                                    (static () => JsonPropertyNames.BeforeTaskUtf8, MatchBeforeTask),
                            ...
                            /// </summary>
                            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("ui5-schema.json#/then/then/definitions/customTasks/items/oneOf/0"u8, buffer, out written);

                            /// <summary>
                            /// Gets the schema location from which this type was generated.
                            /// </summary>
                            public const string SchemaLocation = "ui5-schema.json#/then/then/definitions/customTasks/items/oneOf/0";

                            /// <summary>
                            /// Gets the schema location from which this type was generated as a UTF-8 string.
                            /// </summary>
                            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "ui5-schema.json#/then/then/definitions/customTasks/items/oneOf/0"u8;
                                ...
                                ref JsonSchemaContext context)
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyBeforeTaskPresent, "beforeTask"u8, "required"u8);
                                    ...
                                    {
                                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForBeforeTask] & RequiredBitForBeforeTask) == 0)
                                        {
                                            context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyBeforeTaskNotPresent, "beforeTask"u8, "required"u8);
                                        }
                                        else
                                        {
                                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyBeforeTaskPresent, "beforeTask"u8, "required"u8);
