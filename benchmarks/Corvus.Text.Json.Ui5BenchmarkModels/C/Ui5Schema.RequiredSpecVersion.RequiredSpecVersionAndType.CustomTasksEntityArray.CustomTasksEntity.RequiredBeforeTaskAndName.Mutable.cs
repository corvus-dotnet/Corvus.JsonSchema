                ...
                public readonly partial struct CustomTasksEntity
                {
                    ...
                    public readonly partial struct RequiredBeforeTaskAndName
                    {
...
#endif
                        {
                            ...
                            public void SetBeforeTask(in Corvus.Ui5Benchmark.Current.JsonString.Source value)
                            {
                                CheckValidInstance();
                        ...
                        /// <returns>The source from which to build the value.</returns>
                        public static Source Build(in Corvus.Ui5Benchmark.Current.JsonString.Source beforeTask, in Corvus.Ui5Benchmark.Current.JsonString.Source name, in Corvus.Text.Json.JsonElement.Source configuration = default)
                        {
                        ...
                        /// <param name="configuration">The value of the <c>"configuration"</c> property.</param>
                        /// <returns>The source from which to build the value.</returns>
                        public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.Ui5Benchmark.Current.JsonString.Source beforeTask, in Corvus.Ui5Benchmark.Current.JsonString.Source name, in Corvus.Text.Json.JsonElement.Source<TContext> configuration = default)
                            #if NET9_0_OR_GREATER
                            where TContext : allows ref struct
                            #endif
                        {
