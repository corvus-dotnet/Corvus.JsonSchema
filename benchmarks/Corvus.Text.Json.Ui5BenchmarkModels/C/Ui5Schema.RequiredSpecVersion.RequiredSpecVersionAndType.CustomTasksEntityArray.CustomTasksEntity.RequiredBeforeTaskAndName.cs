            ...
            public readonly partial struct CustomTasksEntityArray
            {
                ...
                public readonly partial struct CustomTasksEntity
                {
...
#endif
                    {
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.Ui5Benchmark.Current.JsonString BeforeTask
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BeforeTaskUtf8, out Corvus.Ui5Benchmark.Current.JsonString value))
                                {
                                    return value;
                                }
                        ...
                        {
                            /// <summary>
                            /// Gets the pre-baked property name blob for <see cref="BeforeTask"/>.
                            /// </summary>
                            public static ReadOnlySpan<byte> BeforeTask => [0xC5, 0x00, 0x00, 0x00, 0x22, 0x62, 0x65, 0x66, 0x6F, 0x72, 0x65, 0x54, 0x61, 0x73, 0x6B, 0x22];
