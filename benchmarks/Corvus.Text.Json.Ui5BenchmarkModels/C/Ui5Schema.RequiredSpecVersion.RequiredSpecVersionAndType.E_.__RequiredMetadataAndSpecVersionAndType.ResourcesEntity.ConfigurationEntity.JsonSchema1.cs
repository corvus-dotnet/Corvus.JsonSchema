                        ...
                        public readonly partial struct ResourcesEntity
                        {
                                ...
                                : IJsonElement<ConfigurationEntity>
                            {
                                public static partial class JsonSchema
                                {
                                    ...
                                    private static readonly JsonSchemaPathProvider PropertiesFileSourceEncodingSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/propertiesFileSourceEncoding/$ref"u8, buffer, out written);
                                    ...
                                    private static void MatchPaths(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                                    {
                                        ...
                                        JsonSchemaContext childContext =
                                            Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ElseEntity.ElseEntity2.RequiredMetadataAndSpecVersionAndType.ResourcesEntity.ConfigurationEntity.PathsEntity.JsonSchema.PushChildContextUnescaped(
                                                parentDocument,
                                                parentDocumentIndex,
                                                ref context,
                                        ...
                                        Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ElseEntity.ElseEntity2.RequiredMetadataAndSpecVersionAndType.ResourcesEntity.ConfigurationEntity.PathsEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                                        context.CommitChildContext(childContext.IsMatch, ref childContext);
                                    }

                                    private static void MatchPropertiesFileSourceEncoding(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                                    {
                                        context.AddLocalEvaluatedProperty(propertyCount);
                                        JsonSchemaContext childContext1 =
                                            Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.EncodingOfPropertiesFiles.JsonSchema.PushChildContextUnescaped(
                                                parentDocument,
                                                parentDocumentIndex,
                                                ref context,
                                                JsonPropertyNames.PropertiesFileSourceEncodingUtf8,
                                                evaluationPath: PropertiesFileSourceEncodingSchemaEvaluationPath);

                                        Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.EncodingOfPropertiesFiles.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                                    ...
                                    private static PropertySchemaMatchers<Corvus.Ui5Benchmark.Current.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
                                    {
                                        return new PropertySchemaMatchers<Corvus.Ui5Benchmark.Current.PropertiesValidationHandler_NamedPropertyValidator1>([
                                            ...
                                            (static () => JsonPropertyNames.PropertiesFileSourceEncodingUtf8, MatchPropertiesFileSourceEncoding),
                                        ]);
                                    }
                                    ...
                                    /// </summary>
                                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/then/then/else/else/then/definitions/resources/properties/configuration"u8, buffer, out written);

                                    /// <summary>
                                    /// Gets the schema location from which this type was generated.
                                    /// </summary>
                                    public const string SchemaLocation = "/then/then/else/else/then/definitions/resources/properties/configuration";

                                    /// <summary>
                                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                                    /// </summary>
                                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/then/then/else/else/then/definitions/resources/properties/configuration"u8;
