                        ...
                        public readonly partial struct CachebusterEntity
                        {
                            ...
                            public readonly partial struct SignatureTypeEntity
                            {
...
#endif
                                {
                                    ...
                                    public static explicit operator Mutable(SignatureTypeEntity instance)
                                    {
                                    ...
                                    /// <returns>An immutable instance of a <see cref="SignatureTypeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                    public static implicit operator SignatureTypeEntity(Mutable instance)
                                    {
                                    ...
                                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                    private string DebuggerDisplay => $"SignatureTypeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                                    ...
                                    /// </para>
                                    /// </remarks>
                                    public readonly SignatureTypeEntity Clone()
                                    {
                                        CheckValidInstance();
                                    ...
                                    /// </para>
                                    /// </remarks>
                                    public readonly SignatureTypeEntity Freeze()
                                    {
                                        CheckValidInstance();
                                        return _parent.FreezeElement<SignatureTypeEntity>(_idx);
                                    }
                                    ...
                                    public bool TryGetKnownValue(out KnownValues result)
                                    {
                                        if (this.ValueEquals(Constants.Enum1))
                                        {
                                            result = KnownValues.Time;
                                            return true;
                                        }

                                        if (this.ValueEquals(Constants.Enum2))
                                        {
                                            result = KnownValues.Hash;
                                            return true;
                                        }
                                ...
                                public ref struct Source
                                {
                                    ...
                                    public static implicit operator Source(SignatureTypeEntity instance) => new(JsonElement.From(instance));
                                    ...
                                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                    public static implicit operator Source(KnownValues value) => (SignatureTypeEntity)value;
                                ...
                                {
                                    return workspace.CreateBuilder<SignatureTypeEntity, Mutable>(this);
                                }
                                ...
                                public static ParsedJsonDocument<SignatureTypeEntity> Create(
                                    scoped in Source value, int initialCapacity = 1)
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        Debug.Assert(cvb.MemberCount == 1);
                                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                        return documentBuilder.ToParsedJsonDocument<SignatureTypeEntity>();
                                    }
                                    finally
                                    {
