                                    ...
                                    public readonly partial struct ThenEntity
                                    {
                                        ...
                                        public readonly partial struct CustomConfigurationEntity
                                        {
...
#endif
                                            {
                                                ...
                                                public static explicit operator Mutable(CustomConfigurationEntity instance)
                                                {
                                                ...
                                                /// <returns>An immutable instance of a <see cref="CustomConfigurationEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                                public static implicit operator CustomConfigurationEntity(Mutable instance)
                                                {
                                                ...
                                                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                                private string DebuggerDisplay => $"CustomConfigurationEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                                                ...
                                                /// </para>
                                                /// </remarks>
                                                public readonly CustomConfigurationEntity Clone()
                                                {
                                                    CheckValidInstance();
                                                ...
                                                /// </para>
                                                /// </remarks>
                                                public readonly CustomConfigurationEntity Freeze()
                                                {
                                                    CheckValidInstance();
                                                    return _parent.FreezeElement<CustomConfigurationEntity>(_idx);
                                                }
                                            }
                                            ...
                                            public ref struct Source
                                            {
                                                ...
                                                internal Source(Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ElseEntity.ElseEntity2.ElseEntity.ElseEntity2.RequiredMetadataAndSpecVersionAndType.ElseEntity.ThenEntity.CustomConfigurationEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                                                public static implicit operator Source(CustomConfigurationEntity instance) => new(JsonElement.From(instance));
                                            ...
                                            {
                                                return workspace.CreateBuilder<CustomConfigurationEntity, Mutable>(this);
                                            }
                                            ...
                                            public static ParsedJsonDocument<CustomConfigurationEntity> Create(
                                                scoped in Source value, int initialCapacity = 30)
                                            {
                                                ...
                                                try
                                                {
                                                    ...
                                                    Debug.Assert(cvb.MemberCount == 1);
                                                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                                    return documentBuilder.ToParsedJsonDocument<CustomConfigurationEntity>();
                                                }
                                                finally
                                                {
                                            ...
                                            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                                            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                                            public static ParsedJsonDocument<CustomConfigurationEntity> Create<TContext>(
