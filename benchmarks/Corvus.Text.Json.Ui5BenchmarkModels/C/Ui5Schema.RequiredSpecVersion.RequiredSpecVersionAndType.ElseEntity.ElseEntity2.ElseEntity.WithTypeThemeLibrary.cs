            ...
            public readonly partial struct ElseEntity
            {
                ...
                public readonly partial struct ElseEntity2
                {
                    ...
                    public readonly partial struct ElseEntity
                    {
                        ...
                        public readonly partial struct WithTypeThemeLibrary
#if NET8_0_OR_GREATER
                            : IJsonElement<WithTypeThemeLibrary>,
                              IFormattable,
                              ISpanFormattable,
...
#endif
                        {
                            ...
                            /// <summary>
                            /// Initializes a new instance of the <see cref="WithTypeThemeLibrary"/> struct.
                            /// </summary>
                            /// <param name="value">The value from which to construct the instance.</param>
                            internal WithTypeThemeLibrary(IJsonDocument parent, int idx)
                            {
                                Debug.Assert(idx >= 0);
                                _parent = parent;
                                _idx = idx;
                            ...
                            /// </summary>
                            public static WithTypeThemeLibrary DefaultInstance { get; }
                            ...
                            /// </summary>
                            public Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ElseEntity.ElseEntity2.ElseEntity.WithTypeThemeLibrary.TypeEntity Type
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ElseEntity.ElseEntity2.ElseEntity.WithTypeThemeLibrary.TypeEntity value))
                                    {
                                        return value;
                                    }
                            ...
                            /// </returns>
                            public static bool operator ==(in WithTypeThemeLibrary left, in WithTypeThemeLibrary right)
                            {
                            ...
                            /// <c>True</c> if the values are equal.
                            /// </returns>
                            public static bool operator ==(in WithTypeThemeLibrary left, in JsonElement right)
                            {
                                return left.Equals(right);
                            }
                            ...
                            public static implicit operator JsonElement(WithTypeThemeLibrary instance)
                            {
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator WithTypeThemeLibrary(JsonElement instance)
                            {
                                return WithTypeThemeLibrary.From(instance);
                            }
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static WithTypeThemeLibrary From<T>(in T instance)
                            ...
                            /// </exception>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static WithTypeThemeLibrary ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                            {
                                return JsonElementHelpers.ParseValue<WithTypeThemeLibrary>(utf8Json, options);
                            }
                            ...
                            /// </exception>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static WithTypeThemeLibrary ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                            {
                                return JsonElementHelpers.ParseValue<WithTypeThemeLibrary>(json, options);
                            }
                            ...
                            /// </exception>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static WithTypeThemeLibrary ParseValue(string json, JsonDocumentOptions options = default)
                            {
                                return JsonElementHelpers.ParseValue<WithTypeThemeLibrary>(json, options);
                            }
                            ...
                            /// </exception>
                            public static WithTypeThemeLibrary ParseValue(ref Utf8JsonReader reader)
                            {
                                return JsonElementHelpers.ParseValue<WithTypeThemeLibrary>(ref reader);
                            }
                            ...
                            ///   A value could not be read from the reader.
                            /// </exception>
                            public static bool TryParseValue(ref Utf8JsonReader reader, out WithTypeThemeLibrary? result)
                            {
                                return JsonElementHelpers.TryParseValue<WithTypeThemeLibrary>(ref reader, out result);
                            }
                            ...
                            {
                                return
                                    (obj is IJsonElement value && Equals(new WithTypeThemeLibrary(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                            static WithTypeThemeLibrary IJsonElement<WithTypeThemeLibrary>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            private string DebuggerDisplay => $"WithTypeThemeLibrary: ValueKind = {ValueKind} : \"{ToString()}\"";
                            ...
                            /// <summary>
                            /// Gets a <see cref="WithTypeThemeLibrary"/> which can be safely stored beyond the lifetime of the
                            /// original document.
                            /// </summary>
                            /// <returns>
                            /// A <see cref="WithTypeThemeLibrary"/> which can be safely stored beyond the lifetime of the
                            /// original document.
                            /// </returns>
                            /// <remarks>
                            /// <para>
                            ...
                            /// </para>
                            /// </remarks>
                            public WithTypeThemeLibrary Clone()
                            {
                                CheckValidInstance();
                                return _parent.CloneElement<WithTypeThemeLibrary>(_idx);
                            }
                            ...
                            /// </summary>
                            /// <returns>
                            /// An immutable <see cref="WithTypeThemeLibrary"/> that lives for the lifetime of its
                            ...
                            /// </para>
                            /// </remarks>
                            public WithTypeThemeLibrary Freeze()
                            {
                                CheckValidInstance();
                                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                                {
                                    return mutable.FreezeElement<WithTypeThemeLibrary>(_idx);
                                }
