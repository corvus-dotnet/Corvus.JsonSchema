                ...
                public readonly partial struct ElseEntity2
                {
                    ...
                    public readonly partial struct RequiredMetadataAndSpecVersionAndType
                    {
                        ...
                        public readonly partial struct ThenEntity
                        {
                            ...
                            public readonly partial struct CustomConfigurationEntity
#if NET8_0_OR_GREATER
                                : IJsonElement<CustomConfigurationEntity>,
                                  IFormattable,
                                  ISpanFormattable,
...
#endif
                            {
                                ...
                                /// <summary>
                                /// Initializes a new instance of the <see cref="CustomConfigurationEntity"/> struct.
                                /// </summary>
                                /// <param name="value">The value from which to construct the instance.</param>
                                internal CustomConfigurationEntity(IJsonDocument parent, int idx)
                                {
                                    Debug.Assert(idx >= 0);
                                    _parent = parent;
                                    _idx = idx;
                                ...
                                /// </summary>
                                public static CustomConfigurationEntity DefaultInstance { get; }
                                ...
                                /// </returns>
                                public static bool operator ==(in CustomConfigurationEntity left, in CustomConfigurationEntity right)
                                {
                                ...
                                /// <c>True</c> if the values are equal.
                                /// </returns>
                                public static bool operator ==(in CustomConfigurationEntity left, in JsonElement right)
                                {
                                    return left.Equals(right);
                                }
                                ...
                                public static implicit operator JsonElement(CustomConfigurationEntity instance)
                                {
                                ...
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static implicit operator CustomConfigurationEntity(JsonElement instance)
                                {
                                    return CustomConfigurationEntity.From(instance);
                                }
                                ...
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static CustomConfigurationEntity From<T>(in T instance)
                                ...
                                /// </exception>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static CustomConfigurationEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                                {
                                    return JsonElementHelpers.ParseValue<CustomConfigurationEntity>(utf8Json, options);
                                }
                                ...
                                /// </exception>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static CustomConfigurationEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                                {
                                    return JsonElementHelpers.ParseValue<CustomConfigurationEntity>(json, options);
                                }
                                ...
                                /// </exception>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static CustomConfigurationEntity ParseValue(string json, JsonDocumentOptions options = default)
                                {
                                    return JsonElementHelpers.ParseValue<CustomConfigurationEntity>(json, options);
                                }
                                ...
                                /// </exception>
                                public static CustomConfigurationEntity ParseValue(ref Utf8JsonReader reader)
                                {
                                    return JsonElementHelpers.ParseValue<CustomConfigurationEntity>(ref reader);
                                }
                                ...
                                ///   A value could not be read from the reader.
                                /// </exception>
                                public static bool TryParseValue(ref Utf8JsonReader reader, out CustomConfigurationEntity? result)
                                {
                                    return JsonElementHelpers.TryParseValue<CustomConfigurationEntity>(ref reader, out result);
                                }
                                ...
                                {
                                    return
                                        (obj is IJsonElement value && Equals(new CustomConfigurationEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                                static CustomConfigurationEntity IJsonElement<CustomConfigurationEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                private string DebuggerDisplay => $"CustomConfigurationEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                                ...
                                /// <summary>
                                /// Gets a <see cref="CustomConfigurationEntity"/> which can be safely stored beyond the lifetime of the
                                /// original document.
                                /// </summary>
                                /// <returns>
                                /// A <see cref="CustomConfigurationEntity"/> which can be safely stored beyond the lifetime of the
                                /// original document.
                                /// </returns>
                                /// <remarks>
                                /// <para>
                                ...
                                /// </para>
                                /// </remarks>
                                public CustomConfigurationEntity Clone()
                                {
                                    CheckValidInstance();
                                    return _parent.CloneElement<CustomConfigurationEntity>(_idx);
                                }
                                ...
                                /// </summary>
                                /// <returns>
                                /// An immutable <see cref="CustomConfigurationEntity"/> that lives for the lifetime of its
                                ...
                                /// </para>
                                /// </remarks>
                                public CustomConfigurationEntity Freeze()
                                {
                                    CheckValidInstance();
                                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                                    {
                                        return mutable.FreezeElement<CustomConfigurationEntity>(_idx);
                                    }
