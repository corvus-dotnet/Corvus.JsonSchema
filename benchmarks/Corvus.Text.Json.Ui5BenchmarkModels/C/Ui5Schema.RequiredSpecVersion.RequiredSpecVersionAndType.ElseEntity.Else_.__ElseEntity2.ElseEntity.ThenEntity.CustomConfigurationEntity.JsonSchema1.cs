                                            ...
                                            public readonly partial struct ThenEntity
                                            {
                                                    ...
                                                    : IJsonElement<CustomConfigurationEntity>
                                                {
                                                    public static partial class JsonSchema
                                                    {
                                                        ...
                                                        /// </summary>
                                                        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/then/then/else/else/then/else/else/else/else/else/then/properties/customConfiguration"u8, buffer, out written);
