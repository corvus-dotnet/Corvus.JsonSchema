                ...
                public readonly partial struct RequiredMetadataAndSpecVersionAndType
                {
                    ...
                    public readonly partial struct BuilderSpecVersion25Entity
                    {
                        ...
                        public readonly partial struct CachebusterEntity
                        {
                            ...
                            public readonly partial struct SignatureTypeEntity
#if NET8_0_OR_GREATER
                                : IJsonElement<SignatureTypeEntity>,
                                  IFormattable,
                                  ISpanFormattable,
...
#endif
                            {
                                ...
                                /// <summary>
                                /// Initializes a new instance of the <see cref="SignatureTypeEntity"/> struct.
                                /// </summary>
                                /// <param name="value">The value from which to construct the instance.</param>
                                internal SignatureTypeEntity(IJsonDocument parent, int idx)
                                {
                                    Debug.Assert(idx >= 0);
                                    _parent = parent;
                                    _idx = idx;
                                ...
                                /// </summary>
                                public static SignatureTypeEntity DefaultInstance { get; }
                                ...
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static explicit operator string(SignatureTypeEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                                ...
                                /// </returns>
                                public static bool operator ==(in SignatureTypeEntity left, in SignatureTypeEntity right)
                                {
                                ...
                                /// <c>True</c> if the values are equal.
                                /// </returns>
                                public static bool operator ==(in SignatureTypeEntity left, in JsonElement right)
                                {
                                    return left.Equals(right);
                                }
                                ...
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static implicit operator JsonElement(SignatureTypeEntity instance)
                                {
                                ...
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static implicit operator SignatureTypeEntity(JsonElement instance)
                                {
                                    return SignatureTypeEntity.From(instance);
                                }
                                ...
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static SignatureTypeEntity From<T>(in T instance)
                                ...
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static SignatureTypeEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                                {
                                    #pragma warning disable CS0618 // Type or member is obsolete
                                    return JsonElementHelpers.ParseValue<SignatureTypeEntity>(utf8Json, options);
                                ...
                                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static SignatureTypeEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                                {
                                    #pragma warning disable CS0618 // Type or member is obsolete
                                    return JsonElementHelpers.ParseValue<SignatureTypeEntity>(json, options);
                                    #pragma warning restore CS0618
                                }
                                ...
                                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static SignatureTypeEntity ParseValue(string json, JsonDocumentOptions options = default)
                                {
                                    #pragma warning disable CS0618 // Type or member is obsolete
                                    return JsonElementHelpers.ParseValue<SignatureTypeEntity>(json, options);
                                    #pragma warning restore CS0618
                                ...
                                /// </exception>
                                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                                public static SignatureTypeEntity ParseValue(ref Utf8JsonReader reader)
                                {
                                    #pragma warning disable CS0618 // Type or member is obsolete
                                    return JsonElementHelpers.ParseValue<SignatureTypeEntity>(ref reader);
                                    #pragma warning restore CS0618
                                }
                                ...
                                ///   A value could not be read from the reader.
                                /// </exception>
                                public static bool TryParseValue(ref Utf8JsonReader reader, out SignatureTypeEntity? result)
                                {
                                    return JsonElementHelpers.TryParseValue<SignatureTypeEntity>(ref reader, out result);
                                }
                                ...
                                {
                                    return
                                        (obj is IJsonElement value && Equals(new SignatureTypeEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                                static SignatureTypeEntity IJsonElement<SignatureTypeEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                private string DebuggerDisplay => $"SignatureTypeEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                                ...
                                /// <summary>
                                /// Gets a <see cref="SignatureTypeEntity"/> which can be safely stored beyond the lifetime of the
                                /// original document.
                                /// </summary>
                                /// <returns>
                                /// A <see cref="SignatureTypeEntity"/> which can be safely stored beyond the lifetime of the
                                /// original document.
                                /// </returns>
                                /// <remarks>
                                /// <para>
                                ...
                                /// </para>
                                /// </remarks>
                                public SignatureTypeEntity Clone()
                                {
                                    CheckValidInstance();
                                    return _parent.CloneElement<SignatureTypeEntity>(_idx);
                                }
                                ...
                                /// </summary>
                                /// <returns>
                                /// An immutable <see cref="SignatureTypeEntity"/> that lives for the lifetime of its
                                ...
                                /// </para>
                                /// </remarks>
                                public SignatureTypeEntity Freeze()
                                {
                                    CheckValidInstance();
                                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                                    {
                                        return mutable.FreezeElement<SignatureTypeEntity>(_idx);
                                    }
                                ...
                                /// <param name="matchTime">Match 1st item.</param>
                                /// <param name="matchHash">Match 2nd item.</param>
                                /// <param name="defaultMatch">Match any other value.</param>
                                /// <returns>An instance of the value returned by the match function.</returns>
                                public TResult Match<TContext, TResult>(
                                    in TContext context,
                                    Func<TContext, TResult> matchTime,
                                    Func<TContext, TResult> matchHash,
...
#endif
                                {
                                    ...
                                    {
                                        return matchTime(context);
                                    }

                                    if (this.ValueEquals(Constants.Enum2))
                                    {
                                        return matchHash(context);
                                    }
                                ...
                                public TResult Match<TResult>(
                                    Func<TResult> matchTime,
                                    Func<TResult> matchHash,
