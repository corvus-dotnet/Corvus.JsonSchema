                ...
                public readonly partial struct RequiredMetadataAndSpecVersionAndType
                {
                    ...
                    public readonly partial struct BuilderSpecVersion30Entity
                    {
                            ...
                            : IJsonElement<CachebusterEntity>
                        {
                            ...
                            {
                                private static readonly JsonSchemaPathProvider SignatureTypeSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/signatureType"u8, buffer, out written);

                                private static void MatchSignatureType(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                                {
                                    context.AddLocalEvaluatedProperty(propertyCount);
                                    JsonSchemaContext childContext =
                                        Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ElseEntity.RequiredMetadataAndSpecVersionAndType.BuilderSpecVersion30Entity.CachebusterEntity.SignatureTypeEntity.JsonSchema.PushChildContextUnescaped(
                                            parentDocument,
                                            parentDocumentIndex,
                                            ref context,
                                            JsonPropertyNames.SignatureTypeUtf8,
                                            evaluationPath: SignatureTypeSchemaEvaluationPath);

                                    Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ElseEntity.RequiredMetadataAndSpecVersionAndType.BuilderSpecVersion30Entity.CachebusterEntity.SignatureTypeEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                                ...
                                {
                                    if (span.SequenceEqual(JsonPropertyNames.SignatureTypeUtf8))
                                    {
                                        matcher = MatchSignatureType;
                                        return true;
                                    }
                                ...
                                /// </summary>
                                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("ui5-schema.json#/then/then/else/then/definitions/builder-specVersion-3.0/properties/cachebuster"u8, buffer, out written);

                                /// <summary>
                                /// Gets the schema location from which this type was generated.
                                /// </summary>
                                public const string SchemaLocation = "ui5-schema.json#/then/then/else/then/definitions/builder-specVersion-3.0/properties/cachebuster";

                                /// <summary>
                                /// Gets the schema location from which this type was generated as a UTF-8 string.
                                /// </summary>
                                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "ui5-schema.json#/then/then/else/then/definitions/builder-specVersion-3.0/properties/cachebuster"u8;
