                                    ...
                                    public readonly partial struct ConfigurationEntity
                                    {
                                            ...
                                            : IJsonElement<PathsEntity>
                                        {
                                            public static partial class JsonSchema
                                            {
                                                ...
                                                /// </summary>
                                                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("ui5-schema.json#/then/then/else/else/else/else/then/definitions/resources/properties/configuration/properties/paths"u8, buffer, out written);

                                                /// <summary>
                                                /// Gets the schema location from which this type was generated.
                                                /// </summary>
                                                public const string SchemaLocation = "ui5-schema.json#/then/then/else/else/else/else/then/definitions/resources/properties/configuration/properties/paths";

                                                /// <summary>
                                                /// Gets the schema location from which this type was generated as a UTF-8 string.
                                                /// </summary>
                                                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "ui5-schema.json#/then/then/else/else/else/else/then/definitions/resources/properties/configuration/properties/paths"u8;
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        while (objectValidation_enumerator.MoveNext())
                                                        {
                                                            ...
                                                            if (objectValidation_unescapedPropertyName.Span.Length > 0)
                                                            {
                                                                ...
                                                                Corvus.Ui5Benchmark.Current.JsonString.JsonSchema.Evaluate(parentDocument, objectValidation_currentIndex, ref childContext);
