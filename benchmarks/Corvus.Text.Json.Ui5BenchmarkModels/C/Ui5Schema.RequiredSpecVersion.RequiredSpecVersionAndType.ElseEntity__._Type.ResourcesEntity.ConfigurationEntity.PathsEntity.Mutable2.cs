                ...
                public readonly partial struct RequiredMetadataAndSpecVersionAndType
                {
                    ...
                    public readonly partial struct ResourcesEntity
                    {
                        ...
                        public readonly partial struct ConfigurationEntity
                        {
                            ...
                            public readonly partial struct PathsEntity
                            {
...
#endif
                                {
                                    ...
                                    public static explicit operator Mutable(PathsEntity instance)
                                    {
                                    ...
                                    /// <returns>An immutable instance of a <see cref="PathsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                    public static implicit operator PathsEntity(Mutable instance)
                                    {
                                    ...
                                    /// <summary>
                                    /// Gets the (optional) <c>webapp</c> property.
                                    /// </summary>
                                    public Corvus.Ui5Benchmark.Current.JsonString.Mutable Webapp
                                    {
                                        get
                                        {
                                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.WebappUtf8, out Corvus.Ui5Benchmark.Current.JsonString.Mutable value))
                                            {
                                                return value;
                                            }
                                    ...
                                    {
                                        return
                                            (obj is IJsonElement value && Equals(new PathsEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                                    ...
                                    /// <summary>
                                    /// Set the <c>webapp</c> property.
                                    /// </summary>
                                    /// <param name="value">The value of the property to add.</param>
                                    public void SetWebapp(scoped in Corvus.Ui5Benchmark.Current.JsonString.Source value)
                                    {
                                        CheckValidInstance();

                                        if (value.IsUndefined)
                                        {
                                            JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.WebappUtf8);
                                            _documentVersion = _parent.Version;
                                            return;
                                        }

                                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.WebappUtf8, out IJsonDocument? elementParent, out int elementIdx))
                                        {
                                        ...
                                        else
                                        {
                                            ...
                                            value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Webapp, ref cvb);
                                    ...
                                    /// <summary>
                                    /// Remove the <c>webapp</c> property, if present.
                                    /// </summary>
                                    /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                                    public bool RemoveWebapp()
                                    {
                                        CheckValidInstance();
                                        bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.WebappUtf8);
                                        _documentVersion = _parent.Version;
                                        return result;
                                    }
                                    ...
                                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                    private string DebuggerDisplay => $"PathsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                                    ...
                                    /// <summary>
                                    /// Gets a <see cref="PathsEntity"/> which can be safely stored beyond the lifetime of the
                                    /// original document.
                                    /// </summary>
                                    /// <returns>
                                    /// A <see cref="PathsEntity"/> which can be safely stored beyond the lifetime of the
                                    /// original document.
                                    /// </returns>
                                    /// <remarks>
                                    /// <para>
                                    ...
                                    /// </para>
                                    /// </remarks>
                                    public readonly PathsEntity Clone()
                                    {
                                        CheckValidInstance();
                                        return _parent.CloneElement<PathsEntity>(_idx);
                                    }
                                    ...
                                    /// </summary>
                                    /// <returns>
                                    /// An immutable <see cref="PathsEntity"/> that lives for the lifetime of its
                                    ...
                                    /// </para>
                                    /// </remarks>
                                    public readonly PathsEntity Freeze()
                                    {
                                        CheckValidInstance();
                                        return _parent.FreezeElement<PathsEntity>(_idx);
                                    }
                                }
                                ...
                                public ref struct Source
                                {
                                    ...
                                    internal Source(Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ElseEntity.RequiredMetadataAndSpecVersionAndType.ResourcesEntity.ConfigurationEntity.PathsEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                                    ...
                                    public static implicit operator Source(PathsEntity instance) => new(JsonElement.From(instance));
                                ...
                                public ref struct Builder
                                {
                                    ...
                                    /// <summary>
                                    /// Creates an instance of a <see cref="PathsEntity"/>.
                                    /// </summary>
                                    internal static void Create(ref ComplexValueBuilder builder, in Corvus.Ui5Benchmark.Current.JsonString.Source webapp = default)
                                    {
                                        webapp.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Webapp, ref builder);
                                    }

                                    /// <summary>
                                    /// Creates an instance of a <see cref="PathsEntity"/>.
                                    /// </summary>
                                    public void Create(in Corvus.Ui5Benchmark.Current.JsonString.Source webapp = default)
                                    {
                                        Create(ref _builder, webapp);
                                    }
                                ...
                                /// </summary>
                                /// <param name="webapp">The value of the <c>"webapp"</c> property.</param>
                                /// <returns>The source from which to build the value.</returns>
                                public static Source Build(scoped in Corvus.Ui5Benchmark.Current.JsonString.Source webapp = default)
                                {
                                    return new Source(webapp);
                                }
                                ...
                                /// </summary>
                                /// <param name="workspace">The JSON workspace.</param>
                                /// <param name="webapp">The value of the property.</param>
                                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                                /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5Benchmark.Current.JsonString.Source webapp = default, int initialCapacity = 30)
                                {
                                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                                    cvb.StartObject();
                                ...
                                {
                                    return workspace.CreateBuilder<PathsEntity, Mutable>(this);
                                }
                                ...
                                public static ParsedJsonDocument<PathsEntity> Create(
                                    scoped in Source value, int initialCapacity = 30)
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        Debug.Assert(cvb.MemberCount == 1);
                                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                        return documentBuilder.ToParsedJsonDocument<PathsEntity>();
                                    }
                                    finally
                                    {
                                ...
                                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                                public static ParsedJsonDocument<PathsEntity> Create<TContext>(
                                ...
                                public static ParsedJsonDocument<PathsEntity> Create(in Corvus.Ui5Benchmark.Current.JsonString.Source webapp = default, int initialCapacity = 30)
                                {
                                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                                    try
                                    {
