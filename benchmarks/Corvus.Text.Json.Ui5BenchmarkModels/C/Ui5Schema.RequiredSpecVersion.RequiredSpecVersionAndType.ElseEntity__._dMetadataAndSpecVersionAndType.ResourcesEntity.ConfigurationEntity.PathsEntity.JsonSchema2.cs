                    ...
                    public readonly partial struct ResourcesEntity
                    {
                        ...
                        public readonly partial struct ConfigurationEntity
                        {
                                ...
                                : IJsonElement<PathsEntity>
                            {
                                ...
                                {
                                    private static readonly JsonSchemaPathProvider WebappSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/webapp"u8, buffer, out written);

                                    private static void MatchWebapp(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                                    {
                                        ...
                                        JsonSchemaContext childContext =
                                            Corvus.Ui5Benchmark.Current.JsonString.JsonSchema.PushChildContextUnescaped(
                                                ...
                                                parentDocumentIndex,
                                                ref context,
                                                JsonPropertyNames.WebappUtf8,
                                                evaluationPath: WebappSchemaEvaluationPath);
                                    ...
                                    {
                                        if (span.SequenceEqual(JsonPropertyNames.WebappUtf8))
                                        {
                                            matcher = MatchWebapp;
                                            return true;
                                        }
                                    ...
                                    /// </summary>
                                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/then/then/else/then/definitions/resources/properties/configuration/properties/paths"u8, buffer, out written);

                                    /// <summary>
                                    /// Gets the schema location from which this type was generated.
                                    /// </summary>
                                    public const string SchemaLocation = "/then/then/else/then/definitions/resources/properties/configuration/properties/paths";

                                    /// <summary>
                                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                                    /// </summary>
                                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/then/then/else/then/definitions/resources/properties/configuration/properties/paths"u8;
