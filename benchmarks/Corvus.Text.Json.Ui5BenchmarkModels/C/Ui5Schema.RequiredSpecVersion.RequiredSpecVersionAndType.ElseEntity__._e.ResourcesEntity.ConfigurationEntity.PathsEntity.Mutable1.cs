                            ...
                            public readonly partial struct ConfigurationEntity
                            {
                                ...
                                public readonly partial struct PathsEntity
                                {
...
#endif
                                    {
                                        ...
                                        public void SetSrc(scoped in Corvus.Ui5Benchmark.Current.JsonString.Source value)
                                        {
                                            CheckValidInstance();
                                        ...
                                        /// </summary>
                                        /// <param name="value">The value of the property to add.</param>
                                        public void SetTest(scoped in Corvus.Ui5Benchmark.Current.JsonString.Source value)
                                        {
                                            CheckValidInstance();
                                    ...
                                    /// <param name="test">The value of the <c>"test"</c> property.</param>
                                    /// <returns>The source from which to build the value.</returns>
                                    public static Source Build(scoped in Corvus.Ui5Benchmark.Current.JsonString.Source src = default, scoped in Corvus.Ui5Benchmark.Current.JsonString.Source test = default)
                                    {
                                        return new Source(src, test);
                                    }
