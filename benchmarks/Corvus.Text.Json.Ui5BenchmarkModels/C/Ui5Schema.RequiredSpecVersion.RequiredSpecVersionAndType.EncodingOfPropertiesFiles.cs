    ...
    public readonly partial struct RequiredSpecVersion
    {
        ...
        public readonly partial struct RequiredSpecVersionAndType
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="EncodingOfPropertiesFiles"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal EncodingOfPropertiesFiles(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static EncodingOfPropertiesFiles DefaultInstance { get; } = ParsedJsonDocument<EncodingOfPropertiesFiles>.StringConstant([.."\"UTF-8\""u8]);
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(EncodingOfPropertiesFiles value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in EncodingOfPropertiesFiles left, in EncodingOfPropertiesFiles right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in EncodingOfPropertiesFiles left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(EncodingOfPropertiesFiles instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator EncodingOfPropertiesFiles(JsonElement instance)
                {
                    return EncodingOfPropertiesFiles.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static EncodingOfPropertiesFiles From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static EncodingOfPropertiesFiles ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<EncodingOfPropertiesFiles>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static EncodingOfPropertiesFiles ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<EncodingOfPropertiesFiles>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static EncodingOfPropertiesFiles ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<EncodingOfPropertiesFiles>(json, options);
                }
                ...
                /// </exception>
                public static EncodingOfPropertiesFiles ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<EncodingOfPropertiesFiles>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out EncodingOfPropertiesFiles? result)
                {
                    return JsonElementHelpers.TryParseValue<EncodingOfPropertiesFiles>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new EncodingOfPropertiesFiles(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static EncodingOfPropertiesFiles IJsonElement<EncodingOfPropertiesFiles>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"EncodingOfPropertiesFiles: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="EncodingOfPropertiesFiles"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="EncodingOfPropertiesFiles"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public EncodingOfPropertiesFiles Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<EncodingOfPropertiesFiles>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="EncodingOfPropertiesFiles"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public EncodingOfPropertiesFiles Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<EncodingOfPropertiesFiles>(_idx);
                    }
                ...
                /// <param name="matchUtf8">Match 1st item.</param>
                /// <param name="matchIso88591">Match 2nd item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> matchUtf8,
                    Func<TContext, TResult> matchIso88591,
...
#endif
                {
                    ...
                    {
                        return matchUtf8(context);
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchIso88591(context);
                    }
                ...
                public TResult Match<TResult>(
                    Func<TResult> matchUtf8,
                    Func<TResult> matchIso88591,
