                    ...
                    public readonly partial struct RequiredFiltersAndMode
                    {
                        ...
                        public readonly partial struct SortEntity
                        {
...
#endif
                            {
                                ...
                                /// </remarks>
                                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SortEntity, Mutable>(SortEntity.DefaultInstance);
                                ...
                                public static explicit operator Mutable(SortEntity instance)
                                {
                                ...
                                /// <returns>An immutable instance of a <see cref="SortEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static implicit operator SortEntity(Mutable instance)
                                {
                                ...
                                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                private string DebuggerDisplay => $"SortEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                                ...
                                /// </para>
                                /// </remarks>
                                public readonly SortEntity Clone()
                                {
                                    CheckValidInstance();
                                ...
                                /// </para>
                                /// </remarks>
                                public readonly SortEntity Freeze()
                                {
                                    CheckValidInstance();
                                    return _parent.FreezeElement<SortEntity>(_idx);
                                }
                            }
                            ...
                            public ref struct Source
                            {
                                ...
                                public static implicit operator Source(SortEntity instance) => new(JsonElement.From(instance));
                            ...
                            {
                                return workspace.CreateBuilder<SortEntity, Mutable>(this);
                            }
                            ...
                            public static ParsedJsonDocument<SortEntity> Create(
                                scoped in Source value, int initialCapacity = 1)
                            {
                                ...
                                try
                                {
                                    ...
                                    Debug.Assert(cvb.MemberCount == 1);
                                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                    return documentBuilder.ToParsedJsonDocument<SortEntity>();
                                }
                                finally
                                {
