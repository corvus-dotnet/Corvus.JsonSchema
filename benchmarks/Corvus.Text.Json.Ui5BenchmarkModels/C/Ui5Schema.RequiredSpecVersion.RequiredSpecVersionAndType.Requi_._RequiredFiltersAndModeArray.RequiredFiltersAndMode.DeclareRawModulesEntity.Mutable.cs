            ...
            public readonly partial struct RequiredSpecVersionAndTypeRequiredName3
            {
                ...
                public readonly partial struct RequiredFiltersAndModeArray
                {
                    ...
                    public readonly partial struct RequiredFiltersAndMode
                    {
                        ...
                        public readonly partial struct DeclareRawModulesEntity
                        {
...
#endif
                            {
                                ...
                                /// </remarks>
                                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DeclareRawModulesEntity, Mutable>(DeclareRawModulesEntity.DefaultInstance);
                                ...
                                public static explicit operator Mutable(DeclareRawModulesEntity instance)
                                {
                                ...
                                /// <returns>An immutable instance of a <see cref="DeclareRawModulesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static implicit operator DeclareRawModulesEntity(Mutable instance)
                                {
                                ...
                                {
                                    return
                                        (obj is IJsonElement value && Equals(new DeclareRawModulesEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                                ...
                                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                private string DebuggerDisplay => $"DeclareRawModulesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                                ...
                                /// <summary>
                                /// Gets a <see cref="DeclareRawModulesEntity"/> which can be safely stored beyond the lifetime of the
                                /// original document.
                                /// </summary>
                                /// <returns>
                                /// A <see cref="DeclareRawModulesEntity"/> which can be safely stored beyond the lifetime of the
                                /// original document.
                                /// </returns>
                                /// <remarks>
                                /// <para>
                                ...
                                /// </para>
                                /// </remarks>
                                public readonly DeclareRawModulesEntity Clone()
                                {
                                    CheckValidInstance();
                                    return _parent.CloneElement<DeclareRawModulesEntity>(_idx);
                                }
                                ...
                                /// </summary>
                                /// <returns>
                                /// An immutable <see cref="DeclareRawModulesEntity"/> that lives for the lifetime of its
                                ...
                                /// </para>
                                /// </remarks>
                                public readonly DeclareRawModulesEntity Freeze()
                                {
                                    CheckValidInstance();
                                    return _parent.FreezeElement<DeclareRawModulesEntity>(_idx);
                                }
                            }
                            ...
                            public ref struct Source
                            {
                                ...
                                public static implicit operator Source(DeclareRawModulesEntity instance) => new(JsonElement.From(instance));
                            ...
                            {
                                return workspace.CreateBuilder<DeclareRawModulesEntity, Mutable>(this);
                            }
                            ...
                            public static ParsedJsonDocument<DeclareRawModulesEntity> Create(
                                scoped in Source value, int initialCapacity = 1)
                            {
                                ...
                                try
                                {
                                    ...
                                    Debug.Assert(cvb.MemberCount == 1);
                                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                    return documentBuilder.ToParsedJsonDocument<DeclareRawModulesEntity>();
                                }
                                finally
                                {
