            ...
            public readonly partial struct RequiredName
            {
                ...
                public readonly partial struct AllowSapInternalEntity
                {
...
#endif
                    {
                        ...
                        /// </remarks>
                        public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<AllowSapInternalEntity, Mutable>(AllowSapInternalEntity.DefaultInstance);
                    ...
                    public static ParsedJsonDocument<AllowSapInternalEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<AllowSapInternalEntity>();
                        }
                        finally
                        {
