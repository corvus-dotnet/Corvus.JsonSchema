            ...
            public readonly partial struct RequiredName
            {
                ...
                public readonly partial struct SapInternalEntity
                {
...
#endif
                    {
                        ...
                        /// </remarks>
                        public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SapInternalEntity, Mutable>(SapInternalEntity.DefaultInstance);
                        ...
                        public static explicit operator Mutable(SapInternalEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="SapInternalEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator SapInternalEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"SapInternalEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly SapInternalEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly SapInternalEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<SapInternalEntity>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(SapInternalEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<SapInternalEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<SapInternalEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<SapInternalEntity>();
                        }
                        finally
                        {
