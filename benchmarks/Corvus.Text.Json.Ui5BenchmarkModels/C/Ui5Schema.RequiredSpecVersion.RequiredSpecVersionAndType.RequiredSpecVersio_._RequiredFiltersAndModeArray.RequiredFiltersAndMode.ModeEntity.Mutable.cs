                    ...
                    public readonly partial struct RequiredFiltersAndMode
                    {
                        ...
                        public readonly partial struct ModeEntity
                        {
...
#endif
                            {
                                ...
                                public static explicit operator Mutable(ModeEntity instance)
                                {
                                ...
                                /// <returns>An immutable instance of a <see cref="ModeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static implicit operator ModeEntity(Mutable instance)
                                {
                                ...
                                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                private string DebuggerDisplay => $"ModeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                                ...
                                /// </para>
                                /// </remarks>
                                public readonly ModeEntity Clone()
                                {
                                    CheckValidInstance();
                                ...
                                /// </para>
                                /// </remarks>
                                public readonly ModeEntity Freeze()
                                {
                                    CheckValidInstance();
                            ...
                            public ref struct Source
                            {
                                ...
                                public static implicit operator Source(ModeEntity instance) => new(JsonElement.From(instance));
                            ...
                            {
                                return workspace.CreateBuilder<ModeEntity, Mutable>(this);
                            }
                            ...
                            public static ParsedJsonDocument<ModeEntity> Create(
                                scoped in Source value, int initialCapacity = 1)
                            {
                                ...
                                try
                                {
                                    ...
                                    Debug.Assert(cvb.MemberCount == 1);
                                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                    return documentBuilder.ToParsedJsonDocument<ModeEntity>();
                                }
                                finally
                                {
