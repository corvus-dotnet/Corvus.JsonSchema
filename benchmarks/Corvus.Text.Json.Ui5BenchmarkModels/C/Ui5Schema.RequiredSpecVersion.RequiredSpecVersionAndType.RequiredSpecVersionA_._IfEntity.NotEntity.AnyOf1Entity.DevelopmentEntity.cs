                        ...
                        public readonly partial struct IfEntity
                        {
                            ...
                            public readonly partial struct NotEntity
                            {
                                ...
                                public readonly partial struct AnyOf1Entity
                                {
                                    ...
                                    public readonly partial struct DevelopmentEntity
#if NET8_0_OR_GREATER
                                        : IJsonElement<DevelopmentEntity>,
                                          IFormattable,
                                          ISpanFormattable,
...
#endif
                                    {
                                        ...
                                        /// <summary>
                                        /// Initializes a new instance of the <see cref="DevelopmentEntity"/> struct.
                                        /// </summary>
                                        /// <param name="value">The value from which to construct the instance.</param>
                                        internal DevelopmentEntity(IJsonDocument parent, int idx)
                                        {
                                            Debug.Assert(idx >= 0);
                                            _parent = parent;
                                            _idx = idx;
                                        ...
                                        /// </summary>
                                        public static DevelopmentEntity DefaultInstance { get; }
                                        ...
                                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                        public static explicit operator bool(DevelopmentEntity value)
                                        {
                                        ...
                                        /// </returns>
                                        public static bool operator ==(in DevelopmentEntity left, in DevelopmentEntity right)
                                        {
                                        ...
                                        /// <c>True</c> if the values are equal.
                                        /// </returns>
                                        public static bool operator ==(in DevelopmentEntity left, in JsonElement right)
                                        {
                                            return left.Equals(right);
                                        }
                                        ...
                                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                        public static implicit operator JsonElement(DevelopmentEntity instance)
                                        {
                                        ...
                                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                        public static implicit operator DevelopmentEntity(JsonElement instance)
                                        {
                                            return DevelopmentEntity.From(instance);
                                        }
                                        ...
                                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                        public static DevelopmentEntity From<T>(in T instance)
                                        ...
                                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                        public static DevelopmentEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                                        {
                                            #pragma warning disable CS0618 // Type or member is obsolete
                                            return JsonElementHelpers.ParseValue<DevelopmentEntity>(utf8Json, options);
                                        ...
                                        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                        public static DevelopmentEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                                        {
                                            #pragma warning disable CS0618 // Type or member is obsolete
                                            return JsonElementHelpers.ParseValue<DevelopmentEntity>(json, options);
                                            #pragma warning restore CS0618
                                        }
                                        ...
                                        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                        public static DevelopmentEntity ParseValue(string json, JsonDocumentOptions options = default)
                                        {
                                            #pragma warning disable CS0618 // Type or member is obsolete
                                            return JsonElementHelpers.ParseValue<DevelopmentEntity>(json, options);
                                            #pragma warning restore CS0618
                                        ...
                                        /// </exception>
                                        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                                        public static DevelopmentEntity ParseValue(ref Utf8JsonReader reader)
                                        {
                                            #pragma warning disable CS0618 // Type or member is obsolete
                                            return JsonElementHelpers.ParseValue<DevelopmentEntity>(ref reader);
                                            #pragma warning restore CS0618
                                        }
                                        ...
                                        ///   A value could not be read from the reader.
                                        /// </exception>
                                        public static bool TryParseValue(ref Utf8JsonReader reader, out DevelopmentEntity? result)
                                        {
                                            return JsonElementHelpers.TryParseValue<DevelopmentEntity>(ref reader, out result);
                                        }
                                        ...
                                        {
                                            return
                                                (obj is IJsonElement value && Equals(new DevelopmentEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                                        static DevelopmentEntity IJsonElement<DevelopmentEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                        private string DebuggerDisplay => $"DevelopmentEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                                        ...
                                        /// <summary>
                                        /// Gets a <see cref="DevelopmentEntity"/> which can be safely stored beyond the lifetime of the
                                        /// original document.
                                        /// </summary>
                                        /// <returns>
                                        /// A <see cref="DevelopmentEntity"/> which can be safely stored beyond the lifetime of the
                                        /// original document.
                                        /// </returns>
                                        /// <remarks>
                                        /// <para>
                                        ...
                                        /// </para>
                                        /// </remarks>
                                        public DevelopmentEntity Clone()
                                        {
                                            CheckValidInstance();
                                            return _parent.CloneElement<DevelopmentEntity>(_idx);
                                        }
                                        ...
                                        /// </summary>
                                        /// <returns>
                                        /// An immutable <see cref="DevelopmentEntity"/> that lives for the lifetime of its
                                        ...
                                        /// </para>
                                        /// </remarks>
                                        public DevelopmentEntity Freeze()
                                        {
                                            CheckValidInstance();
                                            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                                            {
                                                return mutable.FreezeElement<DevelopmentEntity>(_idx);
                                            }
                                        ...
                                        /// <param name="matchFalse">Match 1st item.</param>
                                        /// <param name="matchNull">Match 2nd item.</param>
