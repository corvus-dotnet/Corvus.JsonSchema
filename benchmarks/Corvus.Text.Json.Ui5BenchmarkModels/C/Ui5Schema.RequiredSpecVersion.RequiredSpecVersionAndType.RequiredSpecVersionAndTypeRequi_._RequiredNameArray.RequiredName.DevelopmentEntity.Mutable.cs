                    ...
                    public readonly partial struct RequiredName
                    {
                        ...
                        public readonly partial struct DevelopmentEntity
                        {
...
#endif
                            {
                                ...
                                /// </remarks>
                                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DevelopmentEntity, Mutable>(DevelopmentEntity.DefaultInstance);
                                ...
                                public static explicit operator Mutable(DevelopmentEntity instance)
                                {
                                ...
                                /// <returns>An immutable instance of a <see cref="DevelopmentEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static implicit operator DevelopmentEntity(Mutable instance)
                                {
                                ...
                                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                private string DebuggerDisplay => $"DevelopmentEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                                ...
                                /// </para>
                                /// </remarks>
                                public readonly DevelopmentEntity Clone()
                                {
                                    CheckValidInstance();
                                ...
                                /// </para>
                                /// </remarks>
                                public readonly DevelopmentEntity Freeze()
                                {
                                    CheckValidInstance();
                                    return _parent.FreezeElement<DevelopmentEntity>(_idx);
                                }
                            }
                            ...
                            public ref struct Source
                            {
                                ...
                                public static implicit operator Source(DevelopmentEntity instance) => new(JsonElement.From(instance));
                            ...
                            {
                                return workspace.CreateBuilder<DevelopmentEntity, Mutable>(this);
                            }
                            ...
                            public static ParsedJsonDocument<DevelopmentEntity> Create(
                                scoped in Source value, int initialCapacity = 1)
                            {
                                ...
                                try
                                {
                                    ...
                                    Debug.Assert(cvb.MemberCount == 1);
                                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                    return documentBuilder.ToParsedJsonDocument<DevelopmentEntity>();
                                }
                                finally
                                {
