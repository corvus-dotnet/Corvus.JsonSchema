                    ...
                    public readonly partial struct RequiredFiltersAndMode
                    {
                        ...
                        public readonly partial struct ResolveEntity
                        {
...
#endif
                            {
                                ...
                                /// </remarks>
                                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ResolveEntity, Mutable>(ResolveEntity.DefaultInstance);
                                ...
                                public static explicit operator Mutable(ResolveEntity instance)
                                {
                                ...
                                /// <returns>An immutable instance of a <see cref="ResolveEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static implicit operator ResolveEntity(Mutable instance)
                                {
                                ...
                                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                private string DebuggerDisplay => $"ResolveEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                                ...
                                /// </para>
                                /// </remarks>
                                public readonly ResolveEntity Clone()
                                {
                                    CheckValidInstance();
                                ...
                                /// </para>
                                /// </remarks>
                                public readonly ResolveEntity Freeze()
                                {
                                    CheckValidInstance();
                                    return _parent.FreezeElement<ResolveEntity>(_idx);
                                }
                            }
                            ...
                            public ref struct Source
                            {
                                ...
                                public static implicit operator Source(ResolveEntity instance) => new(JsonElement.From(instance));
                            ...
                            {
                                return workspace.CreateBuilder<ResolveEntity, Mutable>(this);
                            }
                            ...
                            public static ParsedJsonDocument<ResolveEntity> Create(
                                scoped in Source value, int initialCapacity = 1)
                            {
                                ...
                                try
                                {
                                    ...
                                    Debug.Assert(cvb.MemberCount == 1);
                                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                    return documentBuilder.ToParsedJsonDocument<ResolveEntity>();
                                }
                                finally
                                {
