    ...
    public readonly partial struct RequiredSpecVersion
    {
        ...
        public readonly partial struct RequiredSpecVersionAndType
        {
            ...
            public readonly partial struct RequiredSpecVersionAndTypeRequiredName
            {
                ...
                /// <remarks>
                /// <para>
                /// Unique identifier for the project, for example: organization.product.project
                /// </para>
                /// </remarks>
                [DebuggerDisplay("{DebuggerDisplay,nq}")]
                public readonly partial struct ProjectName
                    : IJsonElement<ProjectName>
                {
                    public static partial class JsonSchema
                    {
                        ...
                        /// </summary>
                        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("ui5-schema.json#/then/then/definitions/metadata-3.0/properties/name"u8, buffer, out written);

                        /// <summary>
                        /// Gets the schema location from which this type was generated.
                        /// </summary>
                        public const string SchemaLocation = "ui5-schema.json#/then/then/definitions/metadata-3.0/properties/name";

                        /// <summary>
                        /// Gets the schema location from which this type was generated as a UTF-8 string.
                        /// </summary>
                        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "ui5-schema.json#/then/then/definitions/metadata-3.0/properties/name"u8;
                            ...
                            ref JsonSchemaContext context)
                        {
                            ...
                            else
                            {
                                ...
                                JsonSchemaEvaluation.MatchLengthLessThanOrEquals(80,stringLength, "maxLength"u8, ref context);
                                ...
                                JsonSchemaEvaluation.MatchLengthGreaterThanOrEquals(3,stringLength, "minLength"u8, ref context);
                                ...
                                JsonSchemaEvaluation.MatchRegularExpression(unescapedUtf8JsonString.Span, Pattern,"^(?:@[0-9a-z-_.]+\\/)?[a-z][0-9a-z-_.]*$", "pattern"u8, ref context);
                            }
                        }
                        ...
                        [GeneratedRegex("^(?:@[0-9a-z-_.]+\\/)?[a-z][0-9a-z-_.]*$")]
                        private static partial Regex CreatePattern();
#else
                        private static Regex CreatePattern() => new("^(?:@[0-9a-z-_.]+\\/)?[a-z][0-9a-z-_.]*$", RegexOptions.Compiled);
#endif
