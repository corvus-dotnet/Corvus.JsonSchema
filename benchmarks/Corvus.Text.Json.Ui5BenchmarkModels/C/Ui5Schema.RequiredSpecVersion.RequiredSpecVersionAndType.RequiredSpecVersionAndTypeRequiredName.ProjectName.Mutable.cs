            ...
            public readonly partial struct RequiredSpecVersionAndTypeRequiredName
            {
                ...
                public readonly partial struct ProjectName
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(ProjectName instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="ProjectName"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator ProjectName(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"ProjectName.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly ProjectName Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly ProjectName Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<ProjectName>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(ProjectName instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<ProjectName, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<ProjectName> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<ProjectName>();
                        }
                        finally
                        {
