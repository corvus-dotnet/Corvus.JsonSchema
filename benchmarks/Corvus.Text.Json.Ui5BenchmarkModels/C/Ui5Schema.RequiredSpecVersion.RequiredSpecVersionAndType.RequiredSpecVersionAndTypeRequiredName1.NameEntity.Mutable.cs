            ...
            public readonly partial struct RequiredSpecVersionAndTypeRequiredName1
            {
                ...
                public readonly partial struct NameEntity
                {
...
#endif
                    {
                        ...
                        /// <param name="matchOpenUi5">Match 1st item.</param>
                        /// <param name="matchSapui5">Match 2nd item.</param>
                        /// <param name="defaultMatch">Match any other value.</param>
                        /// <returns>An instance of the value returned by the match function.</returns>
                        public TResult Match<TContext, TResult>(
                            in TContext context,
                            Func<TContext, TResult> matchOpenUi5,
                            Func<TContext, TResult> matchSapui5,
...
#endif
                        {
                            ...
                            {
                                return matchOpenUi5(context);
                            }

                            if (this.ValueEquals(Constants.Enum2))
                            {
                                return matchSapui5(context);
                            }
                        ...
                        public TResult Match<TResult>(
                            Func<TResult> matchOpenUi5,
                            Func<TResult> matchSapui5,
                    ...
                    public ref struct Source
                    {
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator Source(KnownValues value) => (NameEntity)value;
