                        ...
                        public readonly partial struct IfEntity
                        {
                            ...
                            public readonly partial struct NotEntity
                            {
                                ...
                                public readonly partial struct AnyOf0Entity
                                {
                                    ...
                                    public readonly partial struct OptionalEntity
#if NET8_0_OR_GREATER
                                        : IJsonElement<OptionalEntity>,
                                          IFormattable,
                                          ISpanFormattable,
...
#endif
                                    {
                                        ...
                                        /// <summary>
                                        /// Initializes a new instance of the <see cref="OptionalEntity"/> struct.
                                        /// </summary>
                                        /// <param name="value">The value from which to construct the instance.</param>
                                        internal OptionalEntity(IJsonDocument parent, int idx)
                                        {
                                            Debug.Assert(idx >= 0);
                                            _parent = parent;
                                            _idx = idx;
                                        ...
                                        /// </summary>
                                        public static OptionalEntity DefaultInstance { get; }
                                        ...
                                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                        public static explicit operator bool(OptionalEntity value)
                                        {
                                        ...
                                        /// </returns>
                                        public static bool operator ==(in OptionalEntity left, in OptionalEntity right)
                                        {
                                        ...
                                        /// <c>True</c> if the values are equal.
                                        /// </returns>
                                        public static bool operator ==(in OptionalEntity left, in JsonElement right)
                                        {
                                            return left.Equals(right);
                                        }
                                        ...
                                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                        public static implicit operator JsonElement(OptionalEntity instance)
                                        {
                                        ...
                                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                        public static implicit operator OptionalEntity(JsonElement instance)
                                        {
                                            return OptionalEntity.From(instance);
                                        }
                                        ...
                                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                        public static OptionalEntity From<T>(in T instance)
                                        ...
                                        /// </exception>
                                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                        public static OptionalEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                                        {
                                            return JsonElementHelpers.ParseValue<OptionalEntity>(utf8Json, options);
                                        }
                                        ...
                                        /// </exception>
                                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                        public static OptionalEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                                        {
                                            return JsonElementHelpers.ParseValue<OptionalEntity>(json, options);
                                        }
                                        ...
                                        /// </exception>
                                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                        public static OptionalEntity ParseValue(string json, JsonDocumentOptions options = default)
                                        {
                                            return JsonElementHelpers.ParseValue<OptionalEntity>(json, options);
                                        }
                                        ...
                                        /// </exception>
                                        public static OptionalEntity ParseValue(ref Utf8JsonReader reader)
                                        {
                                            return JsonElementHelpers.ParseValue<OptionalEntity>(ref reader);
                                        }
                                        ...
                                        ///   A value could not be read from the reader.
                                        /// </exception>
                                        public static bool TryParseValue(ref Utf8JsonReader reader, out OptionalEntity? result)
                                        {
                                            return JsonElementHelpers.TryParseValue<OptionalEntity>(ref reader, out result);
                                        }
                                        ...
                                        {
                                            return
                                                (obj is IJsonElement value && Equals(new OptionalEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                                        static OptionalEntity IJsonElement<OptionalEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                        private string DebuggerDisplay => $"OptionalEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                                        ...
                                        /// <summary>
                                        /// Gets a <see cref="OptionalEntity"/> which can be safely stored beyond the lifetime of the
                                        /// original document.
                                        /// </summary>
                                        /// <returns>
                                        /// A <see cref="OptionalEntity"/> which can be safely stored beyond the lifetime of the
                                        /// original document.
                                        /// </returns>
                                        /// <remarks>
                                        /// <para>
                                        ...
                                        /// </para>
                                        /// </remarks>
                                        public OptionalEntity Clone()
                                        {
                                            CheckValidInstance();
                                            return _parent.CloneElement<OptionalEntity>(_idx);
                                        }
                                        ...
                                        /// </summary>
                                        /// <returns>
                                        /// An immutable <see cref="OptionalEntity"/> that lives for the lifetime of its
                                        ...
                                        /// </para>
                                        /// </remarks>
                                        public OptionalEntity Freeze()
                                        {
                                            CheckValidInstance();
                                            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                                            {
                                                return mutable.FreezeElement<OptionalEntity>(_idx);
                                            }
