                                ...
                                public readonly partial struct AnyOf2Entity
                                {
                                    ...
                                    public readonly partial struct NotEntity
                                    {
...
#endif
                                        {
                                            ...
                                            /// </summary>
                                            public Corvus.Ui5Benchmark.Current.JsonBoolean.Mutable Optional
                                            {
                                                get
                                                {
                                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OptionalUtf8, out Corvus.Ui5Benchmark.Current.JsonBoolean.Mutable value))
                                                    {
                                                        return value;
                                                    }
                                            ...
                                            public void SetOptional(scoped in Corvus.Ui5Benchmark.Current.JsonBoolean.Source value)
                                            {
                                                CheckValidInstance();
                                        ...
                                        public ref struct Source
                                        {
                                            ...
                                            internal Source(Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.RequiredSpecVersionAndTypeRequiredName1.RequiredNameArray.RequiredName.IfEntity.NotEntity.AnyOf2Entity.NotEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                                            ...
                                            #endif
                                        {
                                            ...
                                            internal Source(scoped in TContext context, Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.RequiredSpecVersionAndTypeRequiredName1.RequiredNameArray.RequiredName.IfEntity.NotEntity.AnyOf2Entity.NotEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                                        ...
                                        public ref struct Builder
                                        {
                                            ...
                                            /// </summary>
                                            internal static void Create(ref ComplexValueBuilder builder, in Corvus.Ui5Benchmark.Current.JsonBoolean.Source optional = default)
                                            {
                                            ...
                                            /// Creates an instance of a <see cref="NotEntity"/>.
                                            /// </summary>
                                            public void Create(in Corvus.Ui5Benchmark.Current.JsonBoolean.Source optional = default)
                                            {
                                                Create(ref _builder, optional);
                                            }
                                        ...
                                        /// <returns>The source from which to build the value.</returns>
                                        public static Source Build(scoped in Corvus.Ui5Benchmark.Current.JsonBoolean.Source optional = default)
                                        {
                                            return new Source(optional);
                                        }
                                        ...
                                        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5Benchmark.Current.JsonBoolean.Source optional = default, int initialCapacity = 30)
                                        {
                                            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                                            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                                            cvb.StartObject();
                                        ...
                                        public static ParsedJsonDocument<NotEntity> Create(in Corvus.Ui5Benchmark.Current.JsonBoolean.Source optional = default, int initialCapacity = 30)
                                        {
                                            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                                            try
                                            {
