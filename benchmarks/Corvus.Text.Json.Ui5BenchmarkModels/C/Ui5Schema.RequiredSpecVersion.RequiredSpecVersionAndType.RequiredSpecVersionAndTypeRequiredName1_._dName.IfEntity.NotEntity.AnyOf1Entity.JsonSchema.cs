                        ...
                        public readonly partial struct IfEntity
                        {
                            ...
                            public readonly partial struct NotEntity
                            {
                                    ...
                                    : IJsonElement<AnyOf1Entity>
                                {
                                    ...
                                    {
                                        private static readonly JsonSchemaPathProvider DevelopmentSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/development"u8, buffer, out written);

                                        private static void MatchDevelopment(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                                        {
                                            context.AddLocalEvaluatedProperty(propertyCount);
                                            JsonSchemaContext childContext =
                                                Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.RequiredSpecVersionAndTypeRequiredName1.RequiredNameArray.RequiredName.IfEntity.NotEntity.AnyOf1Entity.DevelopmentEntity.JsonSchema.PushChildContextUnescaped(
                                                    parentDocument,
                                                    parentDocumentIndex,
                                                    ref context,
                                                    JsonPropertyNames.DevelopmentUtf8,
                                                    evaluationPath: DevelopmentSchemaEvaluationPath);

                                            Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.RequiredSpecVersionAndTypeRequiredName1.RequiredNameArray.RequiredName.IfEntity.NotEntity.AnyOf1Entity.DevelopmentEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                                        ...
                                        {
                                            if (span.SequenceEqual(JsonPropertyNames.DevelopmentUtf8))
                                            {
                                                matcher = MatchDevelopment;
                                                return true;
                                            }
                                        ...
                                        /// </summary>
                                        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/then/then/definitions/framework/properties/libraries/items/if/not/anyOf/1"u8, buffer, out written);

                                        /// <summary>
                                        /// Gets the schema location from which this type was generated.
                                        /// </summary>
                                        public const string SchemaLocation = "/then/then/definitions/framework/properties/libraries/items/if/not/anyOf/1";

                                        /// <summary>
                                        /// Gets the schema location from which this type was generated as a UTF-8 string.
                                        /// </summary>
                                        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/then/then/definitions/framework/properties/libraries/items/if/not/anyOf/1"u8;
