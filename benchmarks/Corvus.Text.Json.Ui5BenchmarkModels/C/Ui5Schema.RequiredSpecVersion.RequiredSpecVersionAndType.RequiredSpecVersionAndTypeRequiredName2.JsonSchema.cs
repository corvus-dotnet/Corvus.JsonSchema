        ...
        public readonly partial struct RequiredSpecVersionAndType
        {
                ...
                : IJsonElement<RequiredSpecVersionAndTypeRequiredName2>
            {
                public static partial class JsonSchema
                {
                    ...
                    private static void MatchDefaultFileTypes(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                    {
                    ...
                    private static void MatchSections(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                    {
                        context.AddLocalEvaluatedProperty(propertyCount);
