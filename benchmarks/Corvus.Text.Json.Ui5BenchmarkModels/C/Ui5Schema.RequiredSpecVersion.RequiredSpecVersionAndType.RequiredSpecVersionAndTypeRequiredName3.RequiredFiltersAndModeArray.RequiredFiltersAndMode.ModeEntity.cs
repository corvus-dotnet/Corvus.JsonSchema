                ...
                public readonly partial struct RequiredFiltersAndModeArray
                {
                    ...
                    public readonly partial struct RequiredFiltersAndMode
                    {
...
#endif
                        {
                            ...
                            /// <summary>
                            /// Initializes a new instance of the <see cref="ModeEntity"/> struct.
                            /// </summary>
                            /// <param name="value">The value from which to construct the instance.</param>
                            internal ModeEntity(IJsonDocument parent, int idx)
                            {
                                Debug.Assert(idx >= 0);
                                _parent = parent;
                                _idx = idx;
                            ...
                            /// </returns>
                            public static bool operator ==(in ModeEntity left, in ModeEntity right)
                            {
                            ...
                            /// <c>True</c> if the values are equal.
                            /// </returns>
                            public static bool operator ==(in ModeEntity left, in JsonElement right)
                            {
                                return left.Equals(right);
                            }
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator JsonElement(ModeEntity instance)
                            {
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator ModeEntity(JsonElement instance)
                            {
                                return ModeEntity.From(instance);
                            }
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static ModeEntity From<T>(in T instance)
                            ...
                            /// </exception>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static ModeEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                            {
                                return JsonElementHelpers.ParseValue<ModeEntity>(utf8Json, options);
                            }
                            ...
                            /// </exception>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static ModeEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                            {
                                return JsonElementHelpers.ParseValue<ModeEntity>(json, options);
                            }
                            ...
                            /// </exception>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static ModeEntity ParseValue(string json, JsonDocumentOptions options = default)
                            {
                                return JsonElementHelpers.ParseValue<ModeEntity>(json, options);
                            }
                            ...
                            /// </exception>
                            public static ModeEntity ParseValue(ref Utf8JsonReader reader)
                            {
                                return JsonElementHelpers.ParseValue<ModeEntity>(ref reader);
                            }
                            ...
                            ///   A value could not be read from the reader.
                            /// </exception>
                            public static bool TryParseValue(ref Utf8JsonReader reader, out ModeEntity? result)
                            {
                                return JsonElementHelpers.TryParseValue<ModeEntity>(ref reader, out result);
                            }
                            ...
                            {
                                return
                                    (obj is IJsonElement value && Equals(new ModeEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                            static ModeEntity IJsonElement<ModeEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            private string DebuggerDisplay => $"ModeEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                            ...
                            /// <summary>
                            /// Gets a <see cref="ModeEntity"/> which can be safely stored beyond the lifetime of the
                            /// original document.
                            /// </summary>
                            /// <returns>
                            /// A <see cref="ModeEntity"/> which can be safely stored beyond the lifetime of the
                            /// original document.
                            /// </returns>
                            /// <remarks>
                            /// <para>
                            ...
                            {
                                CheckValidInstance();
                                return _parent.CloneElement<ModeEntity>(_idx);
                            }
                            ...
                            /// </summary>
                            /// <returns>
                            /// An immutable <see cref="ModeEntity"/> that lives for the lifetime of its
                            ...
                            /// <param name="matchRaw">Match 1st item.</param>
                            /// <param name="matchPreload">Match 2nd item.</param>
                            /// <param name="matchRequire">Match 3rd item.</param>
                            /// <param name="matchProvided">Match 4th item.</param>
                            /// <param name="matchBundleInfo">Match 5th item.</param>
                            /// <param name="defaultMatch">Match any other value.</param>
                            /// <returns>An instance of the value returned by the match function.</returns>
                            public TResult Match<TContext, TResult>(
                                in TContext context,
                                Func<TContext, TResult> matchRaw,
                                Func<TContext, TResult> matchPreload,
                                Func<TContext, TResult> matchRequire,
                                Func<TContext, TResult> matchProvided,
                                Func<TContext, TResult> matchBundleInfo,
                            ...
                            public TResult Match<TResult>(
                                Func<TResult> matchRaw,
                                Func<TResult> matchPreload,
                                Func<TResult> matchRequire,
                                Func<TResult> matchProvided,
                                Func<TResult> matchBundleInfo,
                                Func<TResult> defaultMatch)
                            {
                                ...
                                if (this.ValueEquals(Constants.Enum4))
                                {
                                    return matchProvided();
                                }

                                if (this.ValueEquals(Constants.Enum5))
                                {
                                    return matchBundleInfo();
                                }
