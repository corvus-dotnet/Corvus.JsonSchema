            ...
            public readonly partial struct RequiredSpecVersionAndTypeRequiredName3
            {
                ...
                public readonly partial struct RequiredFiltersAndModeArray
                {
                    ...
                    public readonly partial struct RequiredFiltersAndMode
                    {
                        ...
                        public readonly partial struct ResolveEntity
#if NET8_0_OR_GREATER
                            : IJsonElement<ResolveEntity>,
                              IFormattable,
                              ISpanFormattable,
...
#endif
                        {
                            ...
                            /// <summary>
                            /// Initializes a new instance of the <see cref="ResolveEntity"/> struct.
                            /// </summary>
                            /// <param name="value">The value from which to construct the instance.</param>
                            internal ResolveEntity(IJsonDocument parent, int idx)
                            {
                                Debug.Assert(idx >= 0);
                                _parent = parent;
                                _idx = idx;
                            ...
                            /// </summary>
                            public static ResolveEntity DefaultInstance { get; } = ParsedJsonDocument<ResolveEntity>.False;
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator bool(ResolveEntity value)
                            {
                            ...
                            /// </returns>
                            public static bool operator ==(in ResolveEntity left, in ResolveEntity right)
                            {
                            ...
                            /// <c>True</c> if the values are equal.
                            /// </returns>
                            public static bool operator ==(in ResolveEntity left, in JsonElement right)
                            {
                                return left.Equals(right);
                            }
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator JsonElement(ResolveEntity instance)
                            {
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator ResolveEntity(JsonElement instance)
                            {
                                return ResolveEntity.From(instance);
                            }
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static ResolveEntity From<T>(in T instance)
                            ...
                            /// </exception>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static ResolveEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                            {
                                return JsonElementHelpers.ParseValue<ResolveEntity>(utf8Json, options);
                            }
                            ...
                            /// </exception>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static ResolveEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                            {
                                return JsonElementHelpers.ParseValue<ResolveEntity>(json, options);
                            }
                            ...
                            /// </exception>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static ResolveEntity ParseValue(string json, JsonDocumentOptions options = default)
                            {
                                return JsonElementHelpers.ParseValue<ResolveEntity>(json, options);
                            }
                            ...
                            /// </exception>
                            public static ResolveEntity ParseValue(ref Utf8JsonReader reader)
                            {
                                return JsonElementHelpers.ParseValue<ResolveEntity>(ref reader);
                            }
                            ...
                            ///   A value could not be read from the reader.
                            /// </exception>
                            public static bool TryParseValue(ref Utf8JsonReader reader, out ResolveEntity? result)
                            {
                                return JsonElementHelpers.TryParseValue<ResolveEntity>(ref reader, out result);
                            }
                            ...
                            {
                                return
                                    (obj is IJsonElement value && Equals(new ResolveEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                            static ResolveEntity IJsonElement<ResolveEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            private string DebuggerDisplay => $"ResolveEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                            ...
                            /// <summary>
                            /// Gets a <see cref="ResolveEntity"/> which can be safely stored beyond the lifetime of the
                            /// original document.
                            /// </summary>
                            /// <returns>
                            /// A <see cref="ResolveEntity"/> which can be safely stored beyond the lifetime of the
                            /// original document.
                            /// </returns>
                            /// <remarks>
                            /// <para>
                            ...
                            /// </para>
                            /// </remarks>
                            public ResolveEntity Clone()
                            {
                                CheckValidInstance();
                                return _parent.CloneElement<ResolveEntity>(_idx);
                            }
                            ...
                            /// </summary>
                            /// <returns>
                            /// An immutable <see cref="ResolveEntity"/> that lives for the lifetime of its
