                    ...
                    public readonly partial struct CustomMiddlewareEntity
                    {
                            ...
                            : IJsonElement<RequiredBeforeMiddlewareAndName>
                        {
                            public static partial class JsonSchema
                            {
                                ...
                                private static void MatchBeforeMiddleware(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                                {
                                ...
                                private static void MatchMountPath(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                                {
                                    context.AddLocalEvaluatedProperty(propertyCount);
