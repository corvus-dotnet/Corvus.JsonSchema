            ...
            public readonly partial struct ServerEntity
            {
                ...
                public readonly partial struct CustomMiddlewareEntityArray
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(CustomMiddlewareEntityArray instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="CustomMiddlewareEntityArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator CustomMiddlewareEntityArray(Mutable instance)
                        {
                        ...
                        public Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ServerEntity.CustomMiddlewareEntityArray.CustomMiddlewareEntity.Mutable this[int index]
                        {
                            get
                            {
                                CheckValidInstance();
                                return _parent.GetArrayIndexElement<Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ServerEntity.CustomMiddlewareEntityArray.CustomMiddlewareEntity.Mutable>(_idx, index);
                            }
                        }
                        ...
                        /// </summary>
                        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                        public ArrayEnumerator<Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ServerEntity.CustomMiddlewareEntityArray.CustomMiddlewareEntity.Mutable> EnumerateArray()
                        {
                            CheckValidInstance();
                            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ServerEntity.CustomMiddlewareEntityArray.CustomMiddlewareEntity.Mutable>(_parent, _idx);
                        }
                        ...
                        {
                            return
                                (obj is IJsonElement value && Equals(new CustomMiddlewareEntityArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"CustomMiddlewareEntityArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        /// <summary>
                        ...
                        /// </remarks>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public void SetItem(int itemIndex, in Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ServerEntity.CustomMiddlewareEntityArray.CustomMiddlewareEntity.Source value)
                        {
                            CheckValidInstance();
                        ...
                        /// </remarks>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public void InsertItem(int itemIndex, scoped in Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ServerEntity.CustomMiddlewareEntityArray.CustomMiddlewareEntity.Source value)
                        {
                            CheckValidInstance();
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public void AddItem(scoped in Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ServerEntity.CustomMiddlewareEntityArray.CustomMiddlewareEntity.Source value)
                        {
                        ...
                        ///   The parent <see cref="JsonDocument"/> has been disposed.
                        /// </exception>
                        public bool Remove(in Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ServerEntity.CustomMiddlewareEntityArray.CustomMiddlewareEntity item)
                        {
                            CheckValidInstance();
                            if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ServerEntity.CustomMiddlewareEntityArray.CustomMiddlewareEntity>(this, in item))
                            {
                                return false;
                            }
                        ...
                        /// </remarks>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public void RemoveWhere(JsonPredicate<Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ServerEntity.CustomMiddlewareEntityArray.CustomMiddlewareEntity> predicate)
                        {
                            CheckValidInstance();
                            JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ServerEntity.CustomMiddlewareEntityArray.CustomMiddlewareEntity>(this, predicate);
                            _documentVersion = _parent.Version;
                        }
                        ...
                        ///   The parent <see cref="JsonDocument"/> has been disposed.
                        /// </exception>
                        public bool Replace(in Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ServerEntity.CustomMiddlewareEntityArray.CustomMiddlewareEntity oldItem, in Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ServerEntity.CustomMiddlewareEntityArray.CustomMiddlewareEntity.Source newItem)
                        {
                            CheckValidInstance();
                            ...
                            var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ServerEntity.CustomMiddlewareEntityArray.CustomMiddlewareEntity>(_parent, _idx);

                            while (enumerator.MoveNext())
                            {
                                Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ServerEntity.CustomMiddlewareEntityArray.CustomMiddlewareEntity current = enumerator.Current;
                        ...
                        /// <summary>
                        /// Gets a <see cref="CustomMiddlewareEntityArray"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </summary>
                        /// <returns>
                        /// A <see cref="CustomMiddlewareEntityArray"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </returns>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly CustomMiddlewareEntityArray Clone()
                        {
                            CheckValidInstance();
                            return _parent.CloneElement<CustomMiddlewareEntityArray>(_idx);
                        }
                        ...
                        /// </summary>
                        /// <returns>
                        /// An immutable <see cref="CustomMiddlewareEntityArray"/> that lives for the lifetime of its
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly CustomMiddlewareEntityArray Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<CustomMiddlewareEntityArray>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        internal Source(Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ServerEntity.CustomMiddlewareEntityArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                        public static implicit operator Source(CustomMiddlewareEntityArray instance) => new(JsonElement.From(instance));
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ServerEntity.CustomMiddlewareEntityArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
                    ...
                    public ref struct Builder
                    {
                        ...
                        /// </summary>
                        public void AddItem(in Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ServerEntity.CustomMiddlewareEntityArray.CustomMiddlewareEntity.Source value)
                        {
                        ...
                        /// Add an item to the array.
                        /// </summary>
                        public void AddItem<TContext>(in Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ServerEntity.CustomMiddlewareEntityArray.CustomMiddlewareEntity.Source<TContext> value)
#if NET9_0_OR_GREATER
                            where TContext : allows ref struct
#endif
                        {
                    ...
                    {
                        return workspace.CreateBuilder<CustomMiddlewareEntityArray, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<CustomMiddlewareEntityArray> Create(
                        scoped in Source value, int initialCapacity = 30)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<CustomMiddlewareEntityArray>();
                        }
                        finally
                        {
                    ...
                    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                    public static ParsedJsonDocument<CustomMiddlewareEntityArray> Create<TContext>(
