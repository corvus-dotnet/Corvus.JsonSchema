        ...
        public readonly partial struct RequiredSpecVersionAndType
        {
                ...
                : IJsonElement<ServerEntity>
            {
                public static partial class JsonSchema
                {
                    ...
                    private static void MatchCustomMiddleware(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                    {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/then/then/definitions/server"u8, buffer, out written);
