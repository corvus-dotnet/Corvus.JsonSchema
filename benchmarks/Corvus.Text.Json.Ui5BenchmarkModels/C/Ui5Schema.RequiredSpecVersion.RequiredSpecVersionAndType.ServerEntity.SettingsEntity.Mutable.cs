            ...
            public readonly partial struct ServerEntity
            {
                ...
                public readonly partial struct SettingsEntity
                {
...
#endif
                    {
                        ...
                        /// </summary>
                        public Corvus.Ui5Benchmark.Current.JsonNumber.Mutable HttpPort
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HttpPortUtf8, out Corvus.Ui5Benchmark.Current.JsonNumber.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        /// </summary>
                        public Corvus.Ui5Benchmark.Current.JsonNumber.Mutable HttpsPort
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HttpsPortUtf8, out Corvus.Ui5Benchmark.Current.JsonNumber.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        public void SetHttpPort(scoped in Corvus.Ui5Benchmark.Current.JsonNumber.Source value)
                        {
                            ...
                            else
                            {
                                ...
                                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.HttpPort, ref cvb);
                        ...
                        public void SetHttpsPort(scoped in Corvus.Ui5Benchmark.Current.JsonNumber.Source value)
                        {
                            ...
                            {
                                // We are going to insert the new value
                                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.HttpsPort, ref cvb);
                                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                            }
                    ...
                    public ref struct Source
                    {
                        ...
                        private readonly Corvus.Ui5Benchmark.Current.JsonNumber.Source _createArg1;
                        private readonly Corvus.Ui5Benchmark.Current.JsonNumber.Source _createArg2;
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ServerEntity.SettingsEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    public ref struct Builder
                    {
                        ...
                        internal static void Create(
                            ...
                            in Corvus.Ui5Benchmark.Current.JsonNumber.Source httpPort = default,
                            in Corvus.Ui5Benchmark.Current.JsonNumber.Source httpsPort = default)
                        {
                            httpPort.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.HttpPort, ref builder);
                            httpsPort.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.HttpsPort, ref builder);
                        }

                        /// <summary>
                        /// Creates an instance of a <see cref="SettingsEntity"/>.
                        /// </summary>
                        public void Create(in Corvus.Ui5Benchmark.Current.JsonNumber.Source httpPort = default, in Corvus.Ui5Benchmark.Current.JsonNumber.Source httpsPort = default)
                        {
                    ...
                    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5Benchmark.Current.JsonNumber.Source httpPort = default, in Corvus.Ui5Benchmark.Current.JsonNumber.Source httpsPort = default, int initialCapacity = 30)
                    {
                        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                        cvb.StartObject();
                    ...
                    public static ParsedJsonDocument<SettingsEntity> Create(in Corvus.Ui5Benchmark.Current.JsonNumber.Source httpPort = default, in Corvus.Ui5Benchmark.Current.JsonNumber.Source httpsPort = default, int initialCapacity = 30)
                    {
                        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                        try
                        {
