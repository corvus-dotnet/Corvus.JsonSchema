    ...
    public readonly partial struct RequiredSpecVersion
    {
        ...
        public readonly partial struct RequiredSpecVersionAndType
        {
...
#endif
            {
                ...
                /// </summary>
                public Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ServerEntity.CustomMiddlewareEntityArray CustomMiddleware
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CustomMiddlewareUtf8, out Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ServerEntity.CustomMiddlewareEntityArray value))
                        {
                            return value;
                        }
                ...
                /// </summary>
                public Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ServerEntity.SettingsEntity Settings
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SettingsUtf8, out Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ServerEntity.SettingsEntity value))
                        {
                            return value;
                        }
                ...
                {
                    /// <summary>
                    /// Gets the pre-baked property name blob for <see cref="CustomMiddleware"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> CustomMiddleware => [0x25, 0x01, 0x00, 0x00, 0x22, 0x63, 0x75, 0x73, 0x74, 0x6F, 0x6D, 0x4D, 0x69, 0x64, 0x64, 0x6C, 0x65, 0x77, 0x61, 0x72, 0x65, 0x22];
