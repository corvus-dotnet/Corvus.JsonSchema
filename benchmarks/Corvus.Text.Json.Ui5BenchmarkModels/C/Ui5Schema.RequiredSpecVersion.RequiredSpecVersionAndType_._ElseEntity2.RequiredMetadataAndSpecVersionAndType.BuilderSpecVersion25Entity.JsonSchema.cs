                            ...
                            public readonly partial struct RequiredMetadataAndSpecVersionAndType
                            {
                                    ...
                                    : IJsonElement<BuilderSpecVersion25Entity>
                                {
                                    public static partial class JsonSchema
                                    {
                                        ...
                                        /// </summary>
                                        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/then/then/else/else/else/else/then/definitions/builder-specVersion-2.5"u8, buffer, out written);

                                        /// <summary>
                                        /// Gets the schema location from which this type was generated.
                                        /// </summary>
                                        public const string SchemaLocation = "/then/then/else/else/else/else/then/definitions/builder-specVersion-2.5";

                                        /// <summary>
                                        /// Gets the schema location from which this type was generated as a UTF-8 string.
                                        /// </summary>
                                        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/then/then/else/else/else/else/then/definitions/builder-specVersion-2.5"u8;
