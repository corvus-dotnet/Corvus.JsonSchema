            ...
            public readonly partial struct ElseEntity
            {
                ...
                public readonly partial struct RequiredMetadataAndSpecVersionAndType
                {
                    ...
                    public readonly partial struct BuilderEntity
                    {
                        ...
                        public readonly partial struct CachebusterEntity
                        {
...
#endif
                            {
                                ...
                                public static explicit operator Mutable(CachebusterEntity instance)
                                {
                                ...
                                /// <returns>An immutable instance of a <see cref="CachebusterEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static implicit operator CachebusterEntity(Mutable instance)
                                {
                                ...
                                /// <summary>
                                /// Gets the (optional) <c>signatureType</c> property.
                                /// </summary>
                                public Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ElseEntity.RequiredMetadataAndSpecVersionAndType.BuilderEntity.CachebusterEntity.SignatureTypeEntity.Mutable SignatureType
                                {
                                    get
                                    {
                                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SignatureTypeUtf8, out Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ElseEntity.RequiredMetadataAndSpecVersionAndType.BuilderEntity.CachebusterEntity.SignatureTypeEntity.Mutable value))
                                        {
                                            return value;
                                        }
                                ...
                                {
                                    return
                                        (obj is IJsonElement value && Equals(new CachebusterEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                                ...
                                /// <summary>
                                /// Set the <c>signatureType</c> property.
                                /// </summary>
                                /// <param name="value">The value of the property to add.</param>
                                public void SetSignatureType(scoped in Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ElseEntity.RequiredMetadataAndSpecVersionAndType.BuilderEntity.CachebusterEntity.SignatureTypeEntity.Source value)
                                {
                                    CheckValidInstance();

                                    if (value.IsUndefined)
                                    {
                                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.SignatureTypeUtf8);
                                        _documentVersion = _parent.Version;
                                        return;
                                    }

                                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SignatureTypeUtf8, out IJsonDocument? elementParent, out int elementIdx))
                                    {
                                    ...
                                    else
                                    {
                                        ...
                                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.SignatureType, ref cvb);
                                ...
                                /// <summary>
                                /// Remove the <c>signatureType</c> property, if present.
                                /// </summary>
                                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                                public bool RemoveSignatureType()
                                {
                                    CheckValidInstance();
                                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.SignatureTypeUtf8);
                                    _documentVersion = _parent.Version;
                                    return result;
                                }
                                ...
                                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                private string DebuggerDisplay => $"CachebusterEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                                ...
                                /// <summary>
                                /// Gets a <see cref="CachebusterEntity"/> which can be safely stored beyond the lifetime of the
                                /// original document.
                                /// </summary>
                                /// <returns>
                                /// A <see cref="CachebusterEntity"/> which can be safely stored beyond the lifetime of the
                                /// original document.
                                /// </returns>
                                /// <remarks>
                                /// <para>
                                ...
                                /// </para>
                                /// </remarks>
                                public readonly CachebusterEntity Clone()
                                {
                                    CheckValidInstance();
                                    return _parent.CloneElement<CachebusterEntity>(_idx);
                                }
                                ...
                                /// </summary>
                                /// <returns>
                                /// An immutable <see cref="CachebusterEntity"/> that lives for the lifetime of its
                                ...
                                /// </para>
                                /// </remarks>
                                public readonly CachebusterEntity Freeze()
                                {
                                    CheckValidInstance();
                                    return _parent.FreezeElement<CachebusterEntity>(_idx);
                                }
                            }
                            ...
                            public ref struct Source
                            {
                                ...
                                private readonly Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ElseEntity.RequiredMetadataAndSpecVersionAndType.BuilderEntity.CachebusterEntity.SignatureTypeEntity.Source _createArg1;
                                ...
                                internal Source(Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ElseEntity.RequiredMetadataAndSpecVersionAndType.BuilderEntity.CachebusterEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                                internal Source(scoped in Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ElseEntity.RequiredMetadataAndSpecVersionAndType.BuilderEntity.CachebusterEntity.SignatureTypeEntity.Source arg1)
                                {
                                    _createArg1 = arg1;
                                    _kind = Kind.Create;
                                }

                                public static implicit operator Source(CachebusterEntity instance) => new(JsonElement.From(instance));
                                ...
                                #endif
                            {
                                ...
                                internal Source(scoped in TContext context, Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ElseEntity.RequiredMetadataAndSpecVersionAndType.BuilderEntity.CachebusterEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                            ...
                            public ref struct Builder
                            {
                                ...
                                /// <summary>
                                /// Creates an instance of a <see cref="CachebusterEntity"/>.
                                /// </summary>
                                internal static void Create(ref ComplexValueBuilder builder, in Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ElseEntity.RequiredMetadataAndSpecVersionAndType.BuilderEntity.CachebusterEntity.SignatureTypeEntity.Source signatureType = default)
                                {
                                    signatureType.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.SignatureType, ref builder);
                                }

                                /// <summary>
                                /// Creates an instance of a <see cref="CachebusterEntity"/>.
                                /// </summary>
                                public void Create(in Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ElseEntity.RequiredMetadataAndSpecVersionAndType.BuilderEntity.CachebusterEntity.SignatureTypeEntity.Source signatureType = default)
                                {
                                    Create(ref _builder, signatureType);
                                }
                                ...
                                internal static void BuildCreateValue(scoped in Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ElseEntity.RequiredMetadataAndSpecVersionAndType.BuilderEntity.CachebusterEntity.SignatureTypeEntity.Source arg1, ref ComplexValueBuilder o)
                                {
                                    o.StartObject();
                                    Create(ref o, arg1);
                                    o.EndObject();
                            ...
                            /// </summary>
                            /// <param name="signatureType">The value of the <c>"signatureType"</c> property.</param>
                            /// <returns>The source from which to build the value.</returns>
                            public static Source Build(scoped in Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ElseEntity.RequiredMetadataAndSpecVersionAndType.BuilderEntity.CachebusterEntity.SignatureTypeEntity.Source signatureType = default)
                            {
                                return new Source(signatureType);
                            }
                            ...
                            /// </summary>
                            /// <param name="workspace">The JSON workspace.</param>
                            /// <param name="signatureType">The value of the property.</param>
                            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ElseEntity.RequiredMetadataAndSpecVersionAndType.BuilderEntity.CachebusterEntity.SignatureTypeEntity.Source signatureType = default, int initialCapacity = 30)
                            {
                                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                                cvb.StartObject();
                                Builder ovb = new(cvb);
                                ovb.Create(signatureType);
                                cvb = ovb._builder;
                                cvb.EndObject();
                                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                return documentBuilder;
                            ...
                            {
                                return workspace.CreateBuilder<CachebusterEntity, Mutable>(this);
                            }
                            ...
                            public static ParsedJsonDocument<CachebusterEntity> Create(
                                scoped in Source value, int initialCapacity = 30)
                            {
                                ...
                                try
                                {
                                    ...
                                    Debug.Assert(cvb.MemberCount == 1);
                                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                    return documentBuilder.ToParsedJsonDocument<CachebusterEntity>();
                                }
                                finally
                                {
                            ...
                            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                            public static ParsedJsonDocument<CachebusterEntity> Create<TContext>(
                            ...
                            public static ParsedJsonDocument<CachebusterEntity> Create(in Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.ElseEntity.RequiredMetadataAndSpecVersionAndType.BuilderEntity.CachebusterEntity.SignatureTypeEntity.Source signatureType = default, int initialCapacity = 30)
                            {
                                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                                try
                                {
