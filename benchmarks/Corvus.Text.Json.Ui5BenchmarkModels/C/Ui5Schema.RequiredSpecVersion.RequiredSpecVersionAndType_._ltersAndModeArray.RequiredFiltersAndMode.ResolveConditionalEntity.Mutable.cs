                    ...
                    public readonly partial struct RequiredFiltersAndMode
                    {
                        ...
                        public readonly partial struct ResolveConditionalEntity
                        {
...
#endif
                            {
                                ...
                                /// </remarks>
                                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ResolveConditionalEntity, Mutable>(ResolveConditionalEntity.DefaultInstance);
                                ...
                                public static explicit operator Mutable(ResolveConditionalEntity instance)
                                {
                                ...
                                /// <returns>An immutable instance of a <see cref="ResolveConditionalEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static implicit operator ResolveConditionalEntity(Mutable instance)
                                {
                                ...
                                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                private string DebuggerDisplay => $"ResolveConditionalEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                                ...
                                /// </para>
                                /// </remarks>
                                public readonly ResolveConditionalEntity Clone()
                                {
                                    CheckValidInstance();
                                ...
                                /// </para>
                                /// </remarks>
                                public readonly ResolveConditionalEntity Freeze()
                                {
                                    CheckValidInstance();
                                    return _parent.FreezeElement<ResolveConditionalEntity>(_idx);
                                }
                            }
                            ...
                            public ref struct Source
                            {
                                ...
                                public static implicit operator Source(ResolveConditionalEntity instance) => new(JsonElement.From(instance));
                            ...
                            {
                                return workspace.CreateBuilder<ResolveConditionalEntity, Mutable>(this);
                            }
                            ...
                            public static ParsedJsonDocument<ResolveConditionalEntity> Create(
                                scoped in Source value, int initialCapacity = 1)
                            {
                                ...
                                try
                                {
                                    ...
                                    Debug.Assert(cvb.MemberCount == 1);
                                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                    return documentBuilder.ToParsedJsonDocument<ResolveConditionalEntity>();
                                }
                                finally
                                {
