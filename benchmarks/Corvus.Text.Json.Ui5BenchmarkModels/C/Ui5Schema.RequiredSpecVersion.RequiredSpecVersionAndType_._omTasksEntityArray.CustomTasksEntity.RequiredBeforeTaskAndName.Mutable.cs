        ...
        public readonly partial struct RequiredSpecVersionAndType
        {
            ...
            public readonly partial struct CustomTasksEntityArray
            {
                ...
                public readonly partial struct CustomTasksEntity
                {
                    ...
                    public readonly partial struct RequiredBeforeTaskAndName
                    {
...
#endif
                        {
                            ...
                            public static explicit operator Mutable(RequiredBeforeTaskAndName instance)
                            {
                            ...
                            /// <returns>An immutable instance of a <see cref="RequiredBeforeTaskAndName"/>, initialized from the <see cref="Mutable"/> value.</returns>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator RequiredBeforeTaskAndName(Mutable instance)
                            {
                            ...
                            /// <summary>
                            /// Gets the <c>beforeTask</c> property.
                            /// </summary>
                            /// <remarks>
                            /// <para>
                            ...
                            /// </para>
                            /// </remarks>
                            public Corvus.Ui5Benchmark.Current.JsonString.Mutable BeforeTask
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BeforeTaskUtf8, out Corvus.Ui5Benchmark.Current.JsonString.Mutable value))
                                    {
                                        return value;
                                    }
                            ...
                            {
                                return
                                    (obj is IJsonElement value && Equals(new RequiredBeforeTaskAndName(value.ParentDocument, value.ParentDocumentIndex))) ||
                            ...
                            /// <summary>
                            /// Set the <c>beforeTask</c> property.
                            /// </summary>
                            /// <param name="value">The value of the property to add.</param>
                            public void SetBeforeTask(scoped in Corvus.Ui5Benchmark.Current.JsonString.Source value)
                            {
                                CheckValidInstance();

                                if (value.IsUndefined)
                                {
                                    CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("beforeTask");
                                }

                                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BeforeTaskUtf8, out IJsonDocument? elementParent, out int elementIdx))
                                {
                                ...
                                else
                                {
                                    ...
                                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.BeforeTask, ref cvb);
                            ...
                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            private string DebuggerDisplay => $"RequiredBeforeTaskAndName.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                            ...
                            /// <summary>
                            /// Gets a <see cref="RequiredBeforeTaskAndName"/> which can be safely stored beyond the lifetime of the
                            /// original document.
                            /// </summary>
                            /// <returns>
                            /// A <see cref="RequiredBeforeTaskAndName"/> which can be safely stored beyond the lifetime of the
                            /// original document.
                            /// </returns>
                            /// <remarks>
                            /// <para>
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly RequiredBeforeTaskAndName Clone()
                            {
                                CheckValidInstance();
                                return _parent.CloneElement<RequiredBeforeTaskAndName>(_idx);
                            }
                            ...
                            /// </summary>
                            /// <returns>
                            /// An immutable <see cref="RequiredBeforeTaskAndName"/> that lives for the lifetime of its
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly RequiredBeforeTaskAndName Freeze()
                            {
                                CheckValidInstance();
                                return _parent.FreezeElement<RequiredBeforeTaskAndName>(_idx);
                            }
                        }
                        ...
                        public ref struct Source
                        {
                            ...
                            internal Source(Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.CustomTasksEntityArray.CustomTasksEntity.RequiredBeforeTaskAndName.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                            ...
                            public static implicit operator Source(RequiredBeforeTaskAndName instance) => new(JsonElement.From(instance));
                            ...
                            #endif
                        {
                            ...
                            internal Source(scoped in TContext context, Corvus.Ui5Benchmark.Current.Ui5Schema.RequiredSpecVersion.RequiredSpecVersionAndType.CustomTasksEntityArray.CustomTasksEntity.RequiredBeforeTaskAndName.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                        ...
                        public ref struct Builder
                        {
                            ...
                            /// <summary>
                            /// Creates an instance of a <see cref="RequiredBeforeTaskAndName"/>.
                            /// </summary>
                            internal static void Create(
                                ref ComplexValueBuilder builder,
                                in Corvus.Ui5Benchmark.Current.JsonString.Source beforeTask,
                                in Corvus.Ui5Benchmark.Current.JsonString.Source name,
                                in Corvus.Text.Json.JsonElement.Source configuration = default)
                            {
                                beforeTask.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.BeforeTask, ref builder);
                            ...
                            public void Create(
                                ...
                                in Corvus.Text.Json.JsonElement.Source configuration = default)
                            {
                                Create(ref _builder, beforeTask, name, configuration);
                            }
                            ...
                            #endif
                            {
                                Create(context, ref _builder, beforeTask, name, configuration);
                            }
                        ...
                        /// </summary>
                        /// <param name="beforeTask">The value of the <c>"beforeTask"</c> property.</param>
                        ...
                        /// <returns>The source from which to build the value.</returns>
                        public static Source Build(scoped in Corvus.Ui5Benchmark.Current.JsonString.Source beforeTask, scoped in Corvus.Ui5Benchmark.Current.JsonString.Source name, scoped in Corvus.Text.Json.JsonElement.Source configuration = default)
                        {
                            return new Source(beforeTask, name, configuration);
                        }
                        ...
                        /// <param name="configuration">The value of the <c>"configuration"</c> property.</param>
                        /// <returns>The source from which to build the value.</returns>
                        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Ui5Benchmark.Current.JsonString.Source beforeTask, scoped in Corvus.Ui5Benchmark.Current.JsonString.Source name, scoped in Corvus.Text.Json.JsonElement.Source<TContext> configuration = default)
                            #if NET9_0_OR_GREATER
                            where TContext : allows ref struct
                            #endif
                        {
                            return new Source<TContext>(context, beforeTask, name, configuration);
                        }
                        ...
                        /// </summary>
                        /// <param name="workspace">The JSON workspace.</param>
                        /// <param name="beforeTask">The value of the property.</param>
                        ...
                        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5Benchmark.Current.JsonString.Source beforeTask, in Corvus.Ui5Benchmark.Current.JsonString.Source name, in Corvus.Text.Json.JsonElement.Source configuration = default, int initialCapacity = 30)
                        {
                            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                            cvb.StartObject();
                            Builder ovb = new(cvb);
                            ovb.Create(beforeTask, name, configuration);
                            cvb = ovb._builder;
                            cvb.EndObject();
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder;
                        ...
                        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Ui5Benchmark.Current.JsonString.Source beforeTask, in Corvus.Ui5Benchmark.Current.JsonString.Source name, in Corvus.Text.Json.JsonElement.Source<TContext> configuration = default, int initialCapacity = 30)
                            #if NET9_0_OR_GREATER
                            where TContext : allows ref struct
                            #endif
                        {
                            ...
                            cvb.StartObject();
                            Builder ovb = new(cvb);
                            ovb.Create(context, beforeTask, name, configuration);
                            cvb = ovb._builder;
                            cvb.EndObject();
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder;
                        ...
                        {
                            return workspace.CreateBuilder<RequiredBeforeTaskAndName, Mutable>(this);
                        }
                        ...
                        public static ParsedJsonDocument<RequiredBeforeTaskAndName> Create(
                            scoped in Source value, int initialCapacity = 30)
                        {
                            ...
                            try
                            {
                                ...
                                Debug.Assert(cvb.MemberCount == 1);
                                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                return documentBuilder.ToParsedJsonDocument<RequiredBeforeTaskAndName>();
                            }
                            finally
                            {
                        ...
                        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                        public static ParsedJsonDocument<RequiredBeforeTaskAndName> Create<TContext>(
                        ...
                        public static ParsedJsonDocument<RequiredBeforeTaskAndName> Create(in Corvus.Ui5Benchmark.Current.JsonString.Source beforeTask, in Corvus.Ui5Benchmark.Current.JsonString.Source name, in Corvus.Text.Json.JsonElement.Source configuration = default, int initialCapacity = 30)
                        {
                            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                            try
                            {
                        ...
                        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
                        public static ParsedJsonDocument<RequiredBeforeTaskAndName> Create<TContext>(in TContext context, in Corvus.Ui5Benchmark.Current.JsonString.Source beforeTask, in Corvus.Ui5Benchmark.Current.JsonString.Source name, in Corvus.Text.Json.JsonElement.Source<TContext> configuration = default, int initialCapacity = 30)
                            #if NET9_0_OR_GREATER
                            where TContext : allows ref struct
                            #endif
                        {
