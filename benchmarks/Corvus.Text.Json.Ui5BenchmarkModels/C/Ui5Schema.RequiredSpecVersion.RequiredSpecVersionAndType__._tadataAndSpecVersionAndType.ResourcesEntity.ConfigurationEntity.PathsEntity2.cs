                    ...
                    public readonly partial struct ResourcesEntity
                    {
                        ...
                        public readonly partial struct ConfigurationEntity
                        {
...
#endif
                            {
                                ...
                                /// </summary>
                                public Corvus.Ui5Benchmark.Current.JsonString Webapp
                                {
                                    get
                                    {
                                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.WebappUtf8, out Corvus.Ui5Benchmark.Current.JsonString value))
                                        {
                                            return value;
                                        }
                                ...
                                {
                                    /// <summary>
                                    /// Gets the JSON property name for <see cref="Webapp"/>.
                                    /// </summary>
                                    ...
                                    /// Gets the JSON property name for <see cref="Webapp"/>.
                                    /// </summary>
                                    public static ReadOnlySpan<byte> WebappUtf8 => "webapp"u8;
                                }
                                ...
                                {
                                    /// <summary>
                                    /// Gets the escaped UTF-8 JSON property name for <see cref="Webapp"/>.
                                    /// </summary>
                                    public static ReadOnlySpan<byte> Webapp => "webapp"u8;
                                }
                                ...
                                {
                                    /// <summary>
                                    /// Gets the pre-baked property name blob for <see cref="Webapp"/>.
                                    /// </summary>
                                    public static ReadOnlySpan<byte> Webapp => [0x85, 0x00, 0x00, 0x00, 0x22, 0x77, 0x65, 0x62, 0x61, 0x70, 0x70, 0x22];
                                }
                            }
                        }
                    }
