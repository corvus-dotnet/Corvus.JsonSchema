...
public readonly partial struct Ui5Schema
{
    ...
    public readonly partial struct SpecVersionEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(SpecVersionEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="SpecVersionEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SpecVersionEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SpecVersionEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly SpecVersionEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly SpecVersionEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<SpecVersionEntity>(_idx);
            }
            ...
            /// <param name="match11">Match 10th item.</param>
            /// <param name="match10">Match 11th item.</param>
            /// <param name="match01">Match 12th item.</param>
            ...
            public TResult Match<TContext, TResult>(
                ...
                Func<TContext, TResult> match11,
                Func<TContext, TResult> match10,
                Func<TContext, TResult> match01,
            ...
            public TResult Match<TResult>(
                ...
                Func<TResult> match11,
                Func<TResult> match10,
                Func<TResult> match01,
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(SpecVersionEntity instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (SpecVersionEntity)value;
        ...
        {
            return workspace.CreateBuilder<SpecVersionEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<SpecVersionEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<SpecVersionEntity>();
            }
            finally
            {
