...
public readonly partial struct ActionExecute
{
...
#endif
    {
        ...
        public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.ActionExecute.DataEntity.AnyOf1Entity(DataEntity value)
        {
            return Corvus.Ui5ManifestBenchmark.Baseline.ActionExecute.DataEntity.AnyOf1Entity.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator DataEntity(Corvus.Ui5ManifestBenchmark.Baseline.ActionExecute.DataEntity.AnyOf1Entity value)
        {
            return From(value);
        }
        ...
        public bool TryGetAsAnyOf1Entity(out Corvus.Ui5ManifestBenchmark.Baseline.ActionExecute.DataEntity.AnyOf1Entity result)
        {
            ...
            {
                result = Corvus.Ui5ManifestBenchmark.Baseline.ActionExecute.DataEntity.AnyOf1Entity.From(this);
                return true;
            }
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Baseline.ActionExecute.DataEntity, TContext, TResult> defaultMatch)
...
#endif
        {
            ...
            if (Corvus.Ui5ManifestBenchmark.Baseline.ActionExecute.DataEntity.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchAnyOf1Entity(Corvus.Ui5ManifestBenchmark.Baseline.ActionExecute.DataEntity.AnyOf1Entity.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Baseline.ActionExecute.DataEntity, TResult> defaultMatch)
        {
            if (Corvus.Ui5ManifestBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
            {
            ...
            if (Corvus.Ui5ManifestBenchmark.Baseline.ActionExecute.DataEntity.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchAnyOf1Entity(Corvus.Ui5ManifestBenchmark.Baseline.ActionExecute.DataEntity.AnyOf1Entity.From(this));
            }
