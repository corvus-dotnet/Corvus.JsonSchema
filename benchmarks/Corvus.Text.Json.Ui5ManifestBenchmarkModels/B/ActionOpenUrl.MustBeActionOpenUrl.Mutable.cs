...
public readonly partial struct ActionOpenUrl
{
    ...
    public readonly partial struct MustBeActionOpenUrl
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(MustBeActionOpenUrl instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MustBeActionOpenUrl"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MustBeActionOpenUrl(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MustBeActionOpenUrl.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeActionOpenUrl Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeActionOpenUrl Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MustBeActionOpenUrl>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(MustBeActionOpenUrl instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<MustBeActionOpenUrl, Mutable>(this);
        }
    }
}
