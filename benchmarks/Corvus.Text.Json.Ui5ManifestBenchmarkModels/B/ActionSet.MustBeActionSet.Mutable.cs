...
public readonly partial struct ActionSet
{
    ...
    public readonly partial struct MustBeActionSet
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(MustBeActionSet instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MustBeActionSet"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MustBeActionSet(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MustBeActionSet.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeActionSet Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeActionSet Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MustBeActionSet>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(MustBeActionSet instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<MustBeActionSet, Mutable>(this);
        }
    }
}
