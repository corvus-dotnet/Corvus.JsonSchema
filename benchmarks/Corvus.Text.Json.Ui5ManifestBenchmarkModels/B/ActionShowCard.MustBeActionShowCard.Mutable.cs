...
public readonly partial struct ActionShowCard
{
    ...
    public readonly partial struct MustBeActionShowCard
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(MustBeActionShowCard instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MustBeActionShowCard"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MustBeActionShowCard(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MustBeActionShowCard.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeActionShowCard Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeActionShowCard Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MustBeActionShowCard>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(MustBeActionShowCard instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<MustBeActionShowCard, Mutable>(this);
        }
    }
}
