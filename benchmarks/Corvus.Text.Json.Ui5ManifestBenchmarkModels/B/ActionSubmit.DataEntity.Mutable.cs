...
public readonly partial struct ActionSubmit
{
    ...
    public readonly partial struct DataEntity
    {
...
#endif
        {
            ...
            /// <summary>
            /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Baseline.ActionSubmit.DataEntity.AnyOf1Entity"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.ActionSubmit.DataEntity.AnyOf1Entity.Mutable(Mutable value)
            {
                return Corvus.Ui5ManifestBenchmark.Baseline.ActionSubmit.DataEntity.AnyOf1Entity.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Baseline.ActionSubmit.DataEntity.AnyOf1Entity"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Baseline.ActionSubmit.DataEntity.AnyOf1Entity.Mutable value)
            {
                return From(value);
            }
            ...
            public static explicit operator Mutable(DataEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="DataEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DataEntity(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new DataEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            /// </remarks>
            public void Apply(in Corvus.Ui5ManifestBenchmark.Baseline.ActionSubmit.DataEntity.AnyOf1Entity value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DataEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="DataEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="DataEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly DataEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<DataEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="DataEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly DataEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<DataEntity>(_idx);
            }
            ...
            /// <param name="matchAnyOf1Entity">Match a <see cref="Corvus.Ui5ManifestBenchmark.Baseline.ActionSubmit.DataEntity.AnyOf1Entity"/>.</param>
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.ActionSubmit.DataEntity.AnyOf1Entity, TContext, TResult> matchAnyOf1Entity,
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.ActionSubmit.DataEntity.Mutable, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                if (Corvus.Ui5ManifestBenchmark.Baseline.ActionSubmit.DataEntity.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchAnyOf1Entity(Corvus.Ui5ManifestBenchmark.Baseline.ActionSubmit.DataEntity.AnyOf1Entity.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.ActionSubmit.DataEntity.AnyOf1Entity, TResult> matchAnyOf1Entity,
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.ActionSubmit.DataEntity.Mutable, TResult> defaultMatch)
            {
                if (Corvus.Ui5ManifestBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                ...
                if (Corvus.Ui5ManifestBenchmark.Baseline.ActionSubmit.DataEntity.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchAnyOf1Entity(Corvus.Ui5ManifestBenchmark.Baseline.ActionSubmit.DataEntity.AnyOf1Entity.Mutable.From(this));
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Baseline.ActionSubmit.DataEntity.AnyOf1Entity" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsAnyOf1Entity(out Corvus.Ui5ManifestBenchmark.Baseline.ActionSubmit.DataEntity.AnyOf1Entity result)
            {
                if (Corvus.Ui5ManifestBenchmark.Baseline.ActionSubmit.DataEntity.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Ui5ManifestBenchmark.Baseline.ActionSubmit.DataEntity.AnyOf1Entity.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Baseline.ActionSubmit.DataEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.ActionSubmit.DataEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<DataEntity, Mutable>(this);
        }
    }
}
