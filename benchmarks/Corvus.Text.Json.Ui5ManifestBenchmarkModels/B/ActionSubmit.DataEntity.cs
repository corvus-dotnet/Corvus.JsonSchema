...
public readonly partial struct ActionSubmit
{
...
#endif
    {
        ...
        internal DataEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.ActionSubmit.DataEntity.AnyOf1Entity(DataEntity value)
        {
            return Corvus.Ui5ManifestBenchmark.Baseline.ActionSubmit.DataEntity.AnyOf1Entity.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator DataEntity(Corvus.Ui5ManifestBenchmark.Baseline.ActionSubmit.DataEntity.AnyOf1Entity value)
        {
            return From(value);
        }
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in DataEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(DataEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator DataEntity(JsonElement instance)
        {
            return DataEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DataEntity From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DataEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<DataEntity>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DataEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<DataEntity>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DataEntity ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<DataEntity>(json, options);
        }
        ...
        /// </exception>
        public static DataEntity ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<DataEntity>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out DataEntity? result)
        {
            return JsonElementHelpers.TryParseValue<DataEntity>(ref reader, out result);
        }
...
#if NET
        static DataEntity IJsonElement<DataEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"DataEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public bool TryGetAsAnyOf1Entity(out Corvus.Ui5ManifestBenchmark.Baseline.ActionSubmit.DataEntity.AnyOf1Entity result)
        {
            ...
            {
                result = Corvus.Ui5ManifestBenchmark.Baseline.ActionSubmit.DataEntity.AnyOf1Entity.From(this);
                return true;
            }
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Baseline.ActionSubmit.DataEntity, TContext, TResult> defaultMatch)
...
#endif
        {
            ...
            if (Corvus.Ui5ManifestBenchmark.Baseline.ActionSubmit.DataEntity.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchAnyOf1Entity(Corvus.Ui5ManifestBenchmark.Baseline.ActionSubmit.DataEntity.AnyOf1Entity.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Baseline.ActionSubmit.DataEntity, TResult> defaultMatch)
        {
            if (Corvus.Ui5ManifestBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
            {
            ...
            if (Corvus.Ui5ManifestBenchmark.Baseline.ActionSubmit.DataEntity.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchAnyOf1Entity(Corvus.Ui5ManifestBenchmark.Baseline.ActionSubmit.DataEntity.AnyOf1Entity.From(this));
            }
