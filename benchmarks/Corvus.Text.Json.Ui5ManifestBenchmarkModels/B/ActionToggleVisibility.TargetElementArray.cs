...
public readonly partial struct ActionToggleVisibility
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetElementArray"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal TargetElementArray(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static TargetElementArray DefaultInstance { get; }
        ...
        public Corvus.Ui5ManifestBenchmark.Baseline.TargetElement this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Ui5ManifestBenchmark.Baseline.TargetElement>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.TargetElement> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.TargetElement>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in TargetElementArray left, in TargetElementArray right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in TargetElementArray left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(TargetElementArray instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TargetElementArray(JsonElement instance)
        {
            return TargetElementArray.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TargetElementArray From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TargetElementArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TargetElementArray>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TargetElementArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TargetElementArray>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TargetElementArray ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TargetElementArray>(json, options);
        }
        ...
        /// </exception>
        public static TargetElementArray ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<TargetElementArray>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out TargetElementArray? result)
        {
            return JsonElementHelpers.TryParseValue<TargetElementArray>(ref reader, out result);
        }
...
#if NET
        static TargetElementArray IJsonElement<TargetElementArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TargetElementArray: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public TargetElementArray Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public TargetElementArray Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<TargetElementArray>(_idx);
            }
