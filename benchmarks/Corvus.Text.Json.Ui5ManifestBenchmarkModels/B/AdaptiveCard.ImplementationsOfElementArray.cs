...
public readonly partial struct AdaptiveCard
{
    ...
    public readonly partial struct ImplementationsOfElementArray
        ...
        : IJsonElement<ImplementationsOfElementArray>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ImplementationsOfElementArray"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ImplementationsOfElementArray(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ImplementationsOfElementArray DefaultInstance { get; }
        ...
        public Corvus.Ui5ManifestBenchmark.Baseline.ImplementationsOfElement this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Ui5ManifestBenchmark.Baseline.ImplementationsOfElement>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.ImplementationsOfElement> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.ImplementationsOfElement>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in ImplementationsOfElementArray left, in ImplementationsOfElementArray right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ImplementationsOfElementArray left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(ImplementationsOfElementArray instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ImplementationsOfElementArray(JsonElement instance)
        {
            return ImplementationsOfElementArray.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ImplementationsOfElementArray From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ImplementationsOfElementArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ImplementationsOfElementArray>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ImplementationsOfElementArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ImplementationsOfElementArray>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ImplementationsOfElementArray ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ImplementationsOfElementArray>(json, options);
        }
        ...
        /// </exception>
        public static ImplementationsOfElementArray ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ImplementationsOfElementArray>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ImplementationsOfElementArray? result)
        {
            return JsonElementHelpers.TryParseValue<ImplementationsOfElementArray>(ref reader, out result);
        }
...
#if NET
        static ImplementationsOfElementArray IJsonElement<ImplementationsOfElementArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ImplementationsOfElementArray: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public ImplementationsOfElementArray Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public ImplementationsOfElementArray Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ImplementationsOfElementArray>(_idx);
            }
