...
public readonly partial struct AdaptiveCard
{
    ...
    public readonly partial struct SpecifiesTheBackgroundImageOfTheCard
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(SpecifiesTheBackgroundImageOfTheCard instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="SpecifiesTheBackgroundImageOfTheCard"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SpecifiesTheBackgroundImageOfTheCard(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SpecifiesTheBackgroundImageOfTheCard.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.AdaptiveCard.SpecifiesTheBackgroundImageOfTheCard.Mutable, TContext, TResult> defaultMatch)
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.AdaptiveCard.SpecifiesTheBackgroundImageOfTheCard.Mutable, TResult> defaultMatch)
            {
                if (Corvus.Ui5ManifestBenchmark.Baseline.BackgroundImage.JsonSchema.Evaluate(_parent, _idx))
                {
        ...
        {
            return workspace.CreateBuilder<SpecifiesTheBackgroundImageOfTheCard, Mutable>(this);
        }
    }
}
