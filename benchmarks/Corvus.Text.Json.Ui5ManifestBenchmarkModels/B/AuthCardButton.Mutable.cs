...
public readonly partial struct AuthCardButton
{
...
#endif
    {
        ...
        public static explicit operator Mutable(AuthCardButton instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="AuthCardButton"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator AuthCardButton(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Mutable Image
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ImageUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        public void SetImage(in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"AuthCardButton.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly AuthCardButton Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly AuthCardButton Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<AuthCardButton>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(Corvus.Ui5ManifestBenchmark.Baseline.AuthCardButton.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(AuthCardButton instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.AuthCardButton.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="AuthCardButton"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source type,
            in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source value,
            in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source image = default,
        ...
        public void Create(
            ...
            in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source title = default)
        {
            Create(ref _builder, type, value, image, title);
        }
    ...
    {
        return workspace.CreateBuilder<AuthCardButton, Mutable>(this);
    }
}
