...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Corvus.Ui5ManifestBenchmark.Baseline.JsonString Image
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ImageUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.JsonString value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Ui5ManifestBenchmark.Baseline.JsonString Type
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.JsonString value))
            {
                return value;
            }
    ...
    /// <summary>
    /// Gets a <see cref="AuthCardButton"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="AuthCardButton"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public AuthCardButton Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<AuthCardButton>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="AuthCardButton"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public AuthCardButton Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<AuthCardButton>(_idx);
        }
