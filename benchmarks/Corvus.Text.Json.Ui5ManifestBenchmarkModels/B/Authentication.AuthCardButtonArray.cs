...
public readonly partial struct Authentication
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthCardButtonArray"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal AuthCardButtonArray(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static AuthCardButtonArray DefaultInstance { get; }
        ...
        public Corvus.Ui5ManifestBenchmark.Baseline.AuthCardButton this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Ui5ManifestBenchmark.Baseline.AuthCardButton>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.AuthCardButton> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.AuthCardButton>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in AuthCardButtonArray left, in AuthCardButtonArray right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in AuthCardButtonArray left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(AuthCardButtonArray instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator AuthCardButtonArray(JsonElement instance)
        {
            return AuthCardButtonArray.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AuthCardButtonArray From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AuthCardButtonArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AuthCardButtonArray>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AuthCardButtonArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AuthCardButtonArray>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AuthCardButtonArray ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AuthCardButtonArray>(json, options);
        }
        ...
        /// </exception>
        public static AuthCardButtonArray ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<AuthCardButtonArray>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out AuthCardButtonArray? result)
        {
            return JsonElementHelpers.TryParseValue<AuthCardButtonArray>(ref reader, out result);
        }
...
#if NET
        static AuthCardButtonArray IJsonElement<AuthCardButtonArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"AuthCardButtonArray: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public AuthCardButtonArray Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public AuthCardButtonArray Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<AuthCardButtonArray>(_idx);
            }
