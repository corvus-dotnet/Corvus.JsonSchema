...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="BackgroundImage"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal BackgroundImage(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static BackgroundImage DefaultInstance { get; }

    /// <summary>
    /// Gets the (optional) <c>fillMode</c> property.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public Corvus.Ui5ManifestBenchmark.Baseline.ImageFillMode FillMode
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FillModeUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.ImageFillMode value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Ui5ManifestBenchmark.Baseline.HorizontalAlignment HorizontalAlignment
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HorizontalAlignmentUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.HorizontalAlignment value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Ui5ManifestBenchmark.Baseline.BackgroundImage.MustBeBackgroundImage Type
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.BackgroundImage.MustBeBackgroundImage value))
            {
                return value;
            }
    ...
    /// <summary>
    /// Gets the (optional) <c>verticalAlignment</c> property.
    /// </summary>
    /// <remarks>
    /// <para>
    /// Describes how the image should be aligned if it must be cropped or if using repeat fill mode.
    /// </para>
    /// </remarks>
    public Corvus.Ui5ManifestBenchmark.Baseline.VerticalAlignment VerticalAlignment
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VerticalAlignmentUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.VerticalAlignment value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in BackgroundImage left, in BackgroundImage right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in BackgroundImage left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(BackgroundImage instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator BackgroundImage(JsonElement instance)
    {
        return BackgroundImage.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static BackgroundImage From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static BackgroundImage ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<BackgroundImage>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static BackgroundImage ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<BackgroundImage>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static BackgroundImage ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<BackgroundImage>(json, options);
    }
    ...
    /// </exception>
    public static BackgroundImage ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<BackgroundImage>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out BackgroundImage? result)
    {
        return JsonElementHelpers.TryParseValue<BackgroundImage>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new BackgroundImage(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static BackgroundImage IJsonElement<BackgroundImage>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"BackgroundImage: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="BackgroundImage"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="BackgroundImage"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    {
        CheckValidInstance();
        return _parent.CloneElement<BackgroundImage>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="BackgroundImage"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public BackgroundImage Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<BackgroundImage>(_idx);
        }
    ...
    {
        /// <summary>
        /// Gets the JSON property name for <see cref="FillMode"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets the JSON property name for <see cref="VerticalAlignment"/>.
        /// </summary>
        ...
        /// Gets the JSON property name for <see cref="FillMode"/>.
        /// </summary>
        public static ReadOnlySpan<byte> FillModeUtf8 => "fillMode"u8;
        ...
        /// Gets the JSON property name for <see cref="VerticalAlignment"/>.
        /// </summary>
        public static ReadOnlySpan<byte> VerticalAlignmentUtf8 => "verticalAlignment"u8;
    }
    ...
    {
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="FillMode"/>.
        /// </summary>
        public static ReadOnlySpan<byte> FillMode => "fillMode"u8;
        ...
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="VerticalAlignment"/>.
        /// </summary>
        public static ReadOnlySpan<byte> VerticalAlignment => "verticalAlignment"u8;
    }
}
