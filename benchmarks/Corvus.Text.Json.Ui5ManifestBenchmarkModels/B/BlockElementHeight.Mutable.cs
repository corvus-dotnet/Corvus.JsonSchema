...
public readonly partial struct BlockElementHeight
{
...
#endif
    {
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Baseline.BlockElementHeight.Mutable, TContext, TResult> defaultMatch)
...
#endif
        {
            ...
            {
                return matchAnyOf0Entity(Corvus.Ui5ManifestBenchmark.Baseline.BlockElementHeight.AnyOf0Entity.Mutable.From(this), context);
            }

            if (Corvus.Ui5ManifestBenchmark.Baseline.BlockElementHeight.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchAnyOf1Entity(Corvus.Ui5ManifestBenchmark.Baseline.BlockElementHeight.AnyOf1Entity.Mutable.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Baseline.BlockElementHeight.Mutable, TResult> defaultMatch)
        {
            if (Corvus.Ui5ManifestBenchmark.Baseline.BlockElementHeight.AnyOf0Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchAnyOf0Entity(Corvus.Ui5ManifestBenchmark.Baseline.BlockElementHeight.AnyOf0Entity.Mutable.From(this));
            }

            if (Corvus.Ui5ManifestBenchmark.Baseline.BlockElementHeight.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchAnyOf1Entity(Corvus.Ui5ManifestBenchmark.Baseline.BlockElementHeight.AnyOf1Entity.Mutable.From(this));
            }
        ...
        public bool TryGetAsAnyOf0Entity(out Corvus.Ui5ManifestBenchmark.Baseline.BlockElementHeight.AnyOf0Entity result)
        {
            if (Corvus.Ui5ManifestBenchmark.Baseline.BlockElementHeight.AnyOf0Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.Ui5ManifestBenchmark.Baseline.BlockElementHeight.AnyOf0Entity.Mutable.From(this);
                return true;
            }
        ...
        public bool TryGetAsAnyOf1Entity(out Corvus.Ui5ManifestBenchmark.Baseline.BlockElementHeight.AnyOf1Entity result)
        {
            if (Corvus.Ui5ManifestBenchmark.Baseline.BlockElementHeight.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.Ui5ManifestBenchmark.Baseline.BlockElementHeight.AnyOf1Entity.Mutable.From(this);
                return true;
            }
