...
public readonly partial struct Column
{
...
#endif
    {
        ...
        public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.BackgroundImage(BackgroundImageEntity value)
        {
            return Corvus.Ui5ManifestBenchmark.Baseline.BackgroundImage.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator BackgroundImageEntity(Corvus.Ui5ManifestBenchmark.Baseline.BackgroundImage value)
        {
            return From(value);
        }
        ...
        public bool TryGetAsBackgroundImage(out Corvus.Ui5ManifestBenchmark.Baseline.BackgroundImage result)
        {
            ...
            {
                result = Corvus.Ui5ManifestBenchmark.Baseline.BackgroundImage.From(this);
                return true;
            }
        ...
        public bool TryGetAsJsonUriReference(out Corvus.Ui5ManifestBenchmark.Baseline.JsonUriReference result)
        {
            ...
            {
                result = Corvus.Ui5ManifestBenchmark.Baseline.JsonUriReference.From(this);
                return true;
            }
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Column.BackgroundImageEntity, TContext, TResult> defaultMatch)
...
#endif
        {
            if (Corvus.Ui5ManifestBenchmark.Baseline.BackgroundImage.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchBackgroundImage(Corvus.Ui5ManifestBenchmark.Baseline.BackgroundImage.From(this), context);
            }

            if (Corvus.Ui5ManifestBenchmark.Baseline.JsonUriReference.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchJsonUriReference(Corvus.Ui5ManifestBenchmark.Baseline.JsonUriReference.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Column.BackgroundImageEntity, TResult> defaultMatch)
        {
            if (Corvus.Ui5ManifestBenchmark.Baseline.BackgroundImage.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchBackgroundImage(Corvus.Ui5ManifestBenchmark.Baseline.BackgroundImage.From(this));
            }

            if (Corvus.Ui5ManifestBenchmark.Baseline.JsonUriReference.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchJsonUriReference(Corvus.Ui5ManifestBenchmark.Baseline.JsonUriReference.From(this));
            }
