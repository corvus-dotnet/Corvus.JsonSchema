...
public readonly partial struct ExtendableAction
{
    ...
    public readonly partial struct DeterminesWhetherTheActionShouldBeEnabled
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(DeterminesWhetherTheActionShouldBeEnabled instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="DeterminesWhetherTheActionShouldBeEnabled"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DeterminesWhetherTheActionShouldBeEnabled(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DeterminesWhetherTheActionShouldBeEnabled.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly DeterminesWhetherTheActionShouldBeEnabled Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly DeterminesWhetherTheActionShouldBeEnabled Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<DeterminesWhetherTheActionShouldBeEnabled>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(DeterminesWhetherTheActionShouldBeEnabled instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<DeterminesWhetherTheActionShouldBeEnabled, Mutable>(this);
        }
    }
}
