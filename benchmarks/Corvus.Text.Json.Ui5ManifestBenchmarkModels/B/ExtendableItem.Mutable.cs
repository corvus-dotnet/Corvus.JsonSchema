...
public readonly partial struct ExtendableItem
{
...
#endif
    {
        ...
        public static explicit operator Mutable(ExtendableItem instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="ExtendableItem"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ExtendableItem(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.ExtendableItem.RequiresEntity.Mutable Requires
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RequiresUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.ExtendableItem.RequiresEntity.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ExtendableItem(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        public void SetRequires(in Corvus.Ui5ManifestBenchmark.Baseline.ExtendableItem.RequiresEntity.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetRequires<TContext>(in Corvus.Ui5ManifestBenchmark.Baseline.ExtendableItem.RequiresEntity.Source<TContext> value)
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ExtendableItem.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ExtendableItem"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ExtendableItem"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly ExtendableItem Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ExtendableItem>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ExtendableItem"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly ExtendableItem Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<ExtendableItem>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(Corvus.Ui5ManifestBenchmark.Baseline.ExtendableItem.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(ExtendableItem instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.ExtendableItem.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="ExtendableItem"/>.
        /// </summary>
        internal static void Create(ref ComplexValueBuilder builder, in Corvus.Ui5ManifestBenchmark.Baseline.ExtendableItem.RequiresEntity.Source requires = default)
        {
        ...
        /// Creates an instance of a <see cref="ExtendableItem"/>.
        /// </summary>
        public void Create(in Corvus.Ui5ManifestBenchmark.Baseline.ExtendableItem.RequiresEntity.Source requires = default)
        {
            Create(ref _builder, requires);
        }
        ...
        internal static void Create<TContext>(
            ...
            in Corvus.Ui5ManifestBenchmark.Baseline.ExtendableItem.RequiresEntity.Source<TContext> requires = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
        ...
        /// Creates an instance of a <see cref="ExtendableItem"/>.
        /// </summary>
        public void Create<TContext>(in TContext context, in Corvus.Ui5ManifestBenchmark.Baseline.ExtendableItem.RequiresEntity.Source<TContext> requires = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
            Create(context, ref _builder, requires);
        }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.ExtendableItem.RequiresEntity.Source requires = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Ui5ManifestBenchmark.Baseline.ExtendableItem.RequiresEntity.Source<TContext> requires = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
    ...
    {
        return workspace.CreateBuilder<ExtendableItem, Mutable>(this);
    }
}
