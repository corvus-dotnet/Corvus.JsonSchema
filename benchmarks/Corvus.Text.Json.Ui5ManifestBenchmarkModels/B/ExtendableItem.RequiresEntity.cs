...
public readonly partial struct ExtendableItem
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RequiresEntity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal RequiresEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static RequiresEntity DefaultInstance { get; }
        ...
        public Corvus.Ui5ManifestBenchmark.Baseline.JsonString this[ReadOnlySpan<byte> propertyName]
        {
            get
            {
                CheckValidInstance();
                if (!_parent.TryGetNamedPropertyValue(_idx, propertyName, out Corvus.Ui5ManifestBenchmark.Baseline.JsonString value))
                {
                    return default;
                }
        ...
        /// <returns>The value of the property with the given name.</returns>
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public Corvus.Ui5ManifestBenchmark.Baseline.JsonString this[ReadOnlySpan<char> propertyName]
        {
            get
            {
                CheckValidInstance();
        ...
        /// <returns>The value of the property with the given name.</returns>
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public Corvus.Ui5ManifestBenchmark.Baseline.JsonString this[string propertyName]
        {
            get
            {
                CheckValidInstance();
        ...
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public bool TryGetProperty(ReadOnlySpan<byte> propertyName, out Corvus.Ui5ManifestBenchmark.Baseline.JsonString value)
        {
            CheckValidInstance();
        ...
        /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public bool TryGetProperty(ReadOnlySpan<char> propertyName, out Corvus.Ui5ManifestBenchmark.Baseline.JsonString value)
        {
            CheckValidInstance();
            return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
        }
        ...
        /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public bool TryGetProperty(string propertyName, out Corvus.Ui5ManifestBenchmark.Baseline.JsonString value)
        {
            CheckValidInstance();
            return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public ObjectEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.JsonString> EnumerateObject()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateObjectEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.JsonString>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in RequiresEntity left, in RequiresEntity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in RequiresEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(RequiresEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator RequiresEntity(JsonElement instance)
        {
            return RequiresEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiresEntity From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiresEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RequiresEntity>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiresEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RequiresEntity>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiresEntity ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RequiresEntity>(json, options);
        }
        ...
        /// </exception>
        public static RequiresEntity ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<RequiresEntity>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out RequiresEntity? result)
        {
            return JsonElementHelpers.TryParseValue<RequiresEntity>(ref reader, out result);
        }
...
#if NET
        static RequiresEntity IJsonElement<RequiresEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"RequiresEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public RequiresEntity Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<RequiresEntity>(_idx);
            }
