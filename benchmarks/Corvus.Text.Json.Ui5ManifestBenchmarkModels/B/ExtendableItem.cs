...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Corvus.Ui5ManifestBenchmark.Baseline.ExtendableItem.RequiresEntity Requires
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RequiresUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.ExtendableItem.RequiresEntity value))
            {
                return value;
            }
