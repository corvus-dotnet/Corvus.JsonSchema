...
public readonly partial struct ExtendableToggleableItem
{
    ...
    public readonly partial struct IfFalseThisItemWillBeRemovedFromTheVisualTree
#if NET8_0_OR_GREATER
        : IJsonElement<IfFalseThisItemWillBeRemovedFromTheVisualTree>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IfFalseThisItemWillBeRemovedFromTheVisualTree"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal IfFalseThisItemWillBeRemovedFromTheVisualTree(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static IfFalseThisItemWillBeRemovedFromTheVisualTree DefaultInstance { get; } = ParsedJsonDocument<IfFalseThisItemWillBeRemovedFromTheVisualTree>.True;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator bool(IfFalseThisItemWillBeRemovedFromTheVisualTree value)
        {
        ...
        /// </returns>
        public static bool operator ==(in IfFalseThisItemWillBeRemovedFromTheVisualTree left, in IfFalseThisItemWillBeRemovedFromTheVisualTree right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in IfFalseThisItemWillBeRemovedFromTheVisualTree left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(IfFalseThisItemWillBeRemovedFromTheVisualTree instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator IfFalseThisItemWillBeRemovedFromTheVisualTree(JsonElement instance)
        {
            return IfFalseThisItemWillBeRemovedFromTheVisualTree.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IfFalseThisItemWillBeRemovedFromTheVisualTree From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IfFalseThisItemWillBeRemovedFromTheVisualTree ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<IfFalseThisItemWillBeRemovedFromTheVisualTree>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IfFalseThisItemWillBeRemovedFromTheVisualTree ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<IfFalseThisItemWillBeRemovedFromTheVisualTree>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IfFalseThisItemWillBeRemovedFromTheVisualTree ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<IfFalseThisItemWillBeRemovedFromTheVisualTree>(json, options);
        }
        ...
        /// </exception>
        public static IfFalseThisItemWillBeRemovedFromTheVisualTree ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<IfFalseThisItemWillBeRemovedFromTheVisualTree>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out IfFalseThisItemWillBeRemovedFromTheVisualTree? result)
        {
            return JsonElementHelpers.TryParseValue<IfFalseThisItemWillBeRemovedFromTheVisualTree>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new IfFalseThisItemWillBeRemovedFromTheVisualTree(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static IfFalseThisItemWillBeRemovedFromTheVisualTree IJsonElement<IfFalseThisItemWillBeRemovedFromTheVisualTree>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"IfFalseThisItemWillBeRemovedFromTheVisualTree: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="IfFalseThisItemWillBeRemovedFromTheVisualTree"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="IfFalseThisItemWillBeRemovedFromTheVisualTree"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public IfFalseThisItemWillBeRemovedFromTheVisualTree Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<IfFalseThisItemWillBeRemovedFromTheVisualTree>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="IfFalseThisItemWillBeRemovedFromTheVisualTree"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public IfFalseThisItemWillBeRemovedFromTheVisualTree Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<IfFalseThisItemWillBeRemovedFromTheVisualTree>(_idx);
            }
