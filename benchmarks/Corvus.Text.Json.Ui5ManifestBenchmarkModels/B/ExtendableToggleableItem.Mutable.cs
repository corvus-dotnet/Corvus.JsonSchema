...
public readonly partial struct ExtendableToggleableItem
{
...
#endif
    {
        ...
        public static explicit operator Mutable(ExtendableToggleableItem instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="ExtendableToggleableItem"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ExtendableToggleableItem(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.ExtendableToggleableItem.IfFalseThisItemWillBeRemovedFromTheVisualTree.Mutable IsVisible
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IsVisibleUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.ExtendableToggleableItem.IfFalseThisItemWillBeRemovedFromTheVisualTree.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ExtendableToggleableItem(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetIsVisible(in Corvus.Ui5ManifestBenchmark.Baseline.ExtendableToggleableItem.IfFalseThisItemWillBeRemovedFromTheVisualTree.Source value)
        {
            CheckValidInstance();
        ...
        /// </remarks>
        public void Apply(in Corvus.Ui5ManifestBenchmark.Baseline.ExtendableItem value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ExtendableToggleableItem.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ExtendableToggleableItem"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ExtendableToggleableItem"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly ExtendableToggleableItem Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ExtendableToggleableItem>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ExtendableToggleableItem"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly ExtendableToggleableItem Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<ExtendableToggleableItem>(_idx);
        }

        /// <summary>
        /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Baseline.ExtendableItem" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsExtendableItem(out Corvus.Ui5ManifestBenchmark.Baseline.ExtendableItem result)
        {
            if (Corvus.Ui5ManifestBenchmark.Baseline.ExtendableItem.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.Ui5ManifestBenchmark.Baseline.ExtendableItem.Mutable.From(this);
                return true;
            }
    ...
    public ref struct Source
    {
        ...
        internal Source(Corvus.Ui5ManifestBenchmark.Baseline.ExtendableToggleableItem.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(ExtendableToggleableItem instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.ExtendableToggleableItem.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="ExtendableToggleableItem"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source id = default,
            in Corvus.Ui5ManifestBenchmark.Baseline.ExtendableToggleableItem.IfFalseThisItemWillBeRemovedFromTheVisualTree.Source isVisible = default,
        ...
        public void Create(
            ...
            in Corvus.Text.Json.JsonElement.Source requires = default)
        {
            Create(ref _builder, id, isVisible, requires);
        }
        ...
        #endif
        {
            Create(context, ref _builder, id, isVisible, requires);
        }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source id = default, in Corvus.Ui5ManifestBenchmark.Baseline.ExtendableToggleableItem.IfFalseThisItemWillBeRemovedFromTheVisualTree.Source isVisible = default, in Corvus.Text.Json.JsonElement.Source requires = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(id, isVisible, requires);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source id = default, in Corvus.Ui5ManifestBenchmark.Baseline.ExtendableToggleableItem.IfFalseThisItemWillBeRemovedFromTheVisualTree.Source isVisible = default, in Corvus.Text.Json.JsonElement.Source<TContext> requires = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, id, isVisible, requires);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<ExtendableToggleableItem, Mutable>(this);
    }
}
