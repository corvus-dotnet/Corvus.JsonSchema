...
public readonly partial struct ExtendableToggleableItem
    ...
    : IJsonElement<ExtendableToggleableItem>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ExtendableToggleableItem"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal ExtendableToggleableItem(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static ExtendableToggleableItem DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Ui5ManifestBenchmark.Baseline.ExtendableToggleableItem.IfFalseThisItemWillBeRemovedFromTheVisualTree IsVisible
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IsVisibleUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.ExtendableToggleableItem.IfFalseThisItemWillBeRemovedFromTheVisualTree value))
            {
                return value;
            }

            return Corvus.Ui5ManifestBenchmark.Baseline.ExtendableToggleableItem.IfFalseThisItemWillBeRemovedFromTheVisualTree.DefaultInstance;
        }
    }
    ...
    public static implicit operator Corvus.Ui5ManifestBenchmark.Baseline.ExtendableItem(ExtendableToggleableItem value)
    {
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static explicit operator ExtendableToggleableItem(Corvus.Ui5ManifestBenchmark.Baseline.ExtendableItem value)
    {
        return From(value);
    }
    ...
    /// </returns>
    public static bool operator ==(in ExtendableToggleableItem left, in ExtendableToggleableItem right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in ExtendableToggleableItem left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(ExtendableToggleableItem instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator ExtendableToggleableItem(JsonElement instance)
    {
        return ExtendableToggleableItem.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ExtendableToggleableItem From<T>(in T instance)
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out ExtendableToggleableItem? result)
    {
        return JsonElementHelpers.TryParseValue<ExtendableToggleableItem>(ref reader, out result);
    }
...
#if NET
    static ExtendableToggleableItem IJsonElement<ExtendableToggleableItem>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"ExtendableToggleableItem: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public ExtendableToggleableItem Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public ExtendableToggleableItem Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<ExtendableToggleableItem>(_idx);
        }
    ...
    public bool TryGetAsExtendableItem(out Corvus.Ui5ManifestBenchmark.Baseline.ExtendableItem result)
    {
        ...
        {
            result = Corvus.Ui5ManifestBenchmark.Baseline.ExtendableItem.From(this);
            return true;
        }
