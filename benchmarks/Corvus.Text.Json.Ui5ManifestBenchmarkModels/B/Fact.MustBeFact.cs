...
public readonly partial struct Fact
{
    ...
    public readonly partial struct MustBeFact
#if NET8_0_OR_GREATER
        : IJsonElement<MustBeFact>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MustBeFact"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal MustBeFact(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static MustBeFact DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(MustBeFact value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in MustBeFact left, in MustBeFact right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in MustBeFact left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(MustBeFact instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator MustBeFact(JsonElement instance)
        {
            return MustBeFact.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MustBeFact From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MustBeFact ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<MustBeFact>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MustBeFact ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<MustBeFact>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MustBeFact ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<MustBeFact>(json, options);
        }
        ...
        /// </exception>
        public static MustBeFact ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<MustBeFact>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out MustBeFact? result)
        {
            return JsonElementHelpers.TryParseValue<MustBeFact>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new MustBeFact(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static MustBeFact IJsonElement<MustBeFact>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"MustBeFact: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="MustBeFact"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="MustBeFact"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public MustBeFact Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<MustBeFact>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="MustBeFact"/> that lives for the lifetime of its
