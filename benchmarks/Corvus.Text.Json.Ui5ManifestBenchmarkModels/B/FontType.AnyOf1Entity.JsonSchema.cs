...
public readonly partial struct FontType
{
        ...
        : IJsonElement<AnyOf1Entity>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://adaptivecards.io/schemas/adaptive-card.json#/definitions/FontType/anyOf/1"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "https://adaptivecards.io/schemas/adaptive-card.json#/definitions/FontType/anyOf/1";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://adaptivecards.io/schemas/adaptive-card.json#/definitions/FontType/anyOf/1"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                if (tokenType == JsonTokenType.String)
                {
                    ...
                    JsonSchemaEvaluation.MatchRegularExpression(unescapedUtf8JsonString.Span, Pattern,"^([d|D][e|E][f|F][a|A][u|U][l|L][t|T])|([m|M][o|O][n|N][o|O][s|S][p|P][a|A][c|C][e|E])$", "pattern"u8, ref context);
                }
                else
                {
            ...
            [GeneratedRegex("^([d|D][e|E][f|F][a|A][u|U][l|L][t|T])|([m|M][o|O][n|N][o|O][s|S][p|P][a|A][c|C][e|E])$")]
            private static partial Regex CreatePattern();
#else
            private static Regex CreatePattern() => new("^([d|D][e|E][f|F][a|A][u|U][l|L][t|T])|([m|M][o|O][n|N][o|O][s|S][p|P][a|A][c|C][e|E])$", RegexOptions.Compiled);
#endif
