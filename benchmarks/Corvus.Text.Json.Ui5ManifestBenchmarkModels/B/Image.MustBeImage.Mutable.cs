...
public readonly partial struct Image
{
    ...
    public readonly partial struct MustBeImage
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(MustBeImage instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MustBeImage"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MustBeImage(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MustBeImage.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeImage Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeImage Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MustBeImage>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(MustBeImage instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<MustBeImage, Mutable>(this);
        }
    }
}
