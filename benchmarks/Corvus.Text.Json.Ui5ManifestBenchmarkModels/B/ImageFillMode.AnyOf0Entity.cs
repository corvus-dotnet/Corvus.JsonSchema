...
public readonly partial struct ImageFillMode
{
...
#endif
    {
        ...
        /// <param name="matchCover">Match 1st item.</param>
        /// <param name="matchRepeatHorizontally">Match 2nd item.</param>
        /// <param name="matchRepeatVertically">Match 3rd item.</param>
        /// <param name="matchRepeat">Match 4th item.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Func<TContext, TResult> matchCover,
            Func<TContext, TResult> matchRepeatHorizontally,
            Func<TContext, TResult> matchRepeatVertically,
            Func<TContext, TResult> matchRepeat,
...
#endif
        {
            ...
            {
                return matchCover(context);
            }

            if (this.ValueEquals(Constants.Enum2))
            {
                return matchRepeatHorizontally(context);
            }

            if (this.ValueEquals(Constants.Enum3))
            {
                return matchRepeatVertically(context);
            }

            if (this.ValueEquals(Constants.Enum4))
            {
                return matchRepeat(context);
            }
        ...
        public TResult Match<TResult>(
            Func<TResult> matchCover,
            Func<TResult> matchRepeatHorizontally,
            Func<TResult> matchRepeatVertically,
            Func<TResult> matchRepeat,
            Func<TResult> defaultMatch)
        {
            ...
            if (this.ValueEquals(Constants.Enum2))
            {
                return matchRepeatHorizontally();
            }

            if (this.ValueEquals(Constants.Enum3))
            {
                return matchRepeatVertically();
            }
