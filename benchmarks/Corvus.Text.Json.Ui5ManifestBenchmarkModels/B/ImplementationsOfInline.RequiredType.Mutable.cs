...
public readonly partial struct ImplementationsOfInline
{
    ...
    public readonly partial struct RequiredType
    {
...
#endif
        {
            ...
            public static implicit operator Corvus.Ui5ManifestBenchmark.Baseline.TextRun.Mutable(Mutable value)
            {
            ...
            /// </remarks>
            public void Apply(in Corvus.Ui5ManifestBenchmark.Baseline.TextRun value)
            {
                CheckValidInstance();
            ...
            public bool TryGetAsTextRun(out Corvus.Ui5ManifestBenchmark.Baseline.TextRun result)
            {
                ...
                {
                    result = Corvus.Ui5ManifestBenchmark.Baseline.TextRun.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Baseline.ImplementationsOfInline.RequiredType.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.ImplementationsOfInline.RequiredType.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
