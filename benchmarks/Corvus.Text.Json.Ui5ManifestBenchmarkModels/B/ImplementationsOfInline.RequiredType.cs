...
public readonly partial struct ImplementationsOfInline
{
...
#endif
    {
        ...
        public static implicit operator Corvus.Ui5ManifestBenchmark.Baseline.TextRun(RequiredType value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator RequiredType(Corvus.Ui5ManifestBenchmark.Baseline.TextRun value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText(RequiredType value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator RequiredType(Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText value)
        {
            return From(value);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(RequiredType value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Baseline.TextRun" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsTextRun(out Corvus.Ui5ManifestBenchmark.Baseline.TextRun result)
        {
            if (Corvus.Ui5ManifestBenchmark.Baseline.TextRun.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.Ui5ManifestBenchmark.Baseline.TextRun.From(this);
                return true;
            }
