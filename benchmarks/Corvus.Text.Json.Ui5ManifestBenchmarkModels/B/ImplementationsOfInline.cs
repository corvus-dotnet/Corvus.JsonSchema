...
public readonly partial struct ImplementationsOfInline
    ...
    : IJsonElement<ImplementationsOfInline>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ImplementationsOfInline"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal ImplementationsOfInline(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static ImplementationsOfInline DefaultInstance { get; }
    ...
    /// <summary>
    /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Baseline.ImplementationsOfInline.RequiredType"/>.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.ImplementationsOfInline.RequiredType(ImplementationsOfInline value)
    {
        return Corvus.Ui5ManifestBenchmark.Baseline.ImplementationsOfInline.RequiredType.From(value);
    }

    /// <summary>
    /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Baseline.ImplementationsOfInline.RequiredType"/>.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator ImplementationsOfInline(Corvus.Ui5ManifestBenchmark.Baseline.ImplementationsOfInline.RequiredType value)
    {
        return From(value);
    }

    /// <summary>
    /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Baseline.TextRun"/>.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.TextRun(ImplementationsOfInline value)
    {
        return Corvus.Ui5ManifestBenchmark.Baseline.TextRun.From(value);
    }

    /// <summary>
    /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Baseline.TextRun"/>.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static explicit operator ImplementationsOfInline(Corvus.Ui5ManifestBenchmark.Baseline.TextRun value)
    {
        return From(value);
    }
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText(ImplementationsOfInline value)
    {
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static explicit operator ImplementationsOfInline(Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText value)
    {
        return From(value);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator string(ImplementationsOfInline value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
    ...
    /// </returns>
    public static bool operator ==(in ImplementationsOfInline left, in ImplementationsOfInline right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in ImplementationsOfInline left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator JsonElement(ImplementationsOfInline instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator ImplementationsOfInline(JsonElement instance)
    {
        return ImplementationsOfInline.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ImplementationsOfInline From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ImplementationsOfInline ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<ImplementationsOfInline>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ImplementationsOfInline ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<ImplementationsOfInline>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ImplementationsOfInline ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<ImplementationsOfInline>(json, options);
    }
    ...
    /// </exception>
    public static ImplementationsOfInline ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<ImplementationsOfInline>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out ImplementationsOfInline? result)
    {
        return JsonElementHelpers.TryParseValue<ImplementationsOfInline>(ref reader, out result);
    }
...
#if NET
    static ImplementationsOfInline IJsonElement<ImplementationsOfInline>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"ImplementationsOfInline: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public ImplementationsOfInline Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public ImplementationsOfInline Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<ImplementationsOfInline>(_idx);
        }
    ...
    /// <summary>
    /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Baseline.ImplementationsOfInline.RequiredType" />.
    /// </summary>
    /// <param name="result">The result of the conversions.</param>
    /// <returns><see langword="true" /> if the conversion was valid.</returns>
    public bool TryGetAsRequiredType(out Corvus.Ui5ManifestBenchmark.Baseline.ImplementationsOfInline.RequiredType result)
    {
        if (Corvus.Ui5ManifestBenchmark.Baseline.ImplementationsOfInline.RequiredType.JsonSchema.Evaluate(_parent, _idx))
        {
            result = Corvus.Ui5ManifestBenchmark.Baseline.ImplementationsOfInline.RequiredType.From(this);
            return true;
        }
