...
public readonly partial struct InputChoice
{
    ...
    public readonly partial struct MustBeInputChoice
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(MustBeInputChoice instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MustBeInputChoice"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MustBeInputChoice(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MustBeInputChoice.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeInputChoice Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeInputChoice Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MustBeInputChoice>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(MustBeInputChoice instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<MustBeInputChoice, Mutable>(this);
        }
    }
}
