...
public readonly partial struct InputChoice
{
...
#endif
    {
        ...
        public static explicit operator Mutable(InputChoice instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="InputChoice"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator InputChoice(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.InputChoice.MustBeInputChoice.Mutable Type
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.InputChoice.MustBeInputChoice.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new InputChoice(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetType(in Corvus.Ui5ManifestBenchmark.Baseline.InputChoice.MustBeInputChoice.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"InputChoice.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="InputChoice"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="InputChoice"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly InputChoice Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<InputChoice>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="InputChoice"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly InputChoice Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<InputChoice>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(Corvus.Ui5ManifestBenchmark.Baseline.InputChoice.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(InputChoice instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.InputChoice.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="InputChoice"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source title,
            in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source value,
            in Corvus.Ui5ManifestBenchmark.Baseline.InputChoice.MustBeInputChoice.Source type = default)
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source title, in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source value, in Corvus.Ui5ManifestBenchmark.Baseline.InputChoice.MustBeInputChoice.Source type = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    {
        return workspace.CreateBuilder<InputChoice, Mutable>(this);
    }
}
