...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="InputChoice"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal InputChoice(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static InputChoice DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Ui5ManifestBenchmark.Baseline.InputChoice.MustBeInputChoice Type
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.InputChoice.MustBeInputChoice value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in InputChoice left, in InputChoice right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in InputChoice left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(InputChoice instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator InputChoice(JsonElement instance)
    {
        return InputChoice.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static InputChoice From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static InputChoice ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<InputChoice>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static InputChoice ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<InputChoice>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static InputChoice ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<InputChoice>(json, options);
    }
    ...
    /// </exception>
    public static InputChoice ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<InputChoice>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out InputChoice? result)
    {
        return JsonElementHelpers.TryParseValue<InputChoice>(ref reader, out result);
    }
...
#if NET
    static InputChoice IJsonElement<InputChoice>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"InputChoice: ValueKind = {ValueKind} : \"{ToString()}\"";
