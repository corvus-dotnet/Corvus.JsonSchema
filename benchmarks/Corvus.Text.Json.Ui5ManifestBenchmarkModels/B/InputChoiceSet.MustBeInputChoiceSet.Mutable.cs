...
public readonly partial struct InputChoiceSet
{
    ...
    public readonly partial struct MustBeInputChoiceSet
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(MustBeInputChoiceSet instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MustBeInputChoiceSet"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MustBeInputChoiceSet(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MustBeInputChoiceSet.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeInputChoiceSet Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeInputChoiceSet Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MustBeInputChoiceSet>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(MustBeInputChoiceSet instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<MustBeInputChoiceSet, Mutable>(this);
        }
    }
}
