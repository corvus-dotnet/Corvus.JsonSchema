...
public readonly partial struct InputText
{
    ...
    public readonly partial struct IfTrueAllowMultipleLinesOfInput
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(IfTrueAllowMultipleLinesOfInput instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="IfTrueAllowMultipleLinesOfInput"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator IfTrueAllowMultipleLinesOfInput(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new IfTrueAllowMultipleLinesOfInput(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"IfTrueAllowMultipleLinesOfInput.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="IfTrueAllowMultipleLinesOfInput"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="IfTrueAllowMultipleLinesOfInput"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly IfTrueAllowMultipleLinesOfInput Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<IfTrueAllowMultipleLinesOfInput>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="IfTrueAllowMultipleLinesOfInput"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly IfTrueAllowMultipleLinesOfInput Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<IfTrueAllowMultipleLinesOfInput>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(IfTrueAllowMultipleLinesOfInput instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<IfTrueAllowMultipleLinesOfInput, Mutable>(this);
        }
    }
}
