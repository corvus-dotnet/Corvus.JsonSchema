...
public readonly partial struct InputText
{
    ...
    public readonly partial struct IfTrueAllowMultipleLinesOfInput
        ...
        : IJsonElement<IfTrueAllowMultipleLinesOfInput>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IfTrueAllowMultipleLinesOfInput"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal IfTrueAllowMultipleLinesOfInput(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static IfTrueAllowMultipleLinesOfInput DefaultInstance { get; } = ParsedJsonDocument<IfTrueAllowMultipleLinesOfInput>.False;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator bool(IfTrueAllowMultipleLinesOfInput value)
        {
        ...
        /// </returns>
        public static bool operator ==(in IfTrueAllowMultipleLinesOfInput left, in IfTrueAllowMultipleLinesOfInput right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in IfTrueAllowMultipleLinesOfInput left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(IfTrueAllowMultipleLinesOfInput instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator IfTrueAllowMultipleLinesOfInput(JsonElement instance)
        {
            return IfTrueAllowMultipleLinesOfInput.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IfTrueAllowMultipleLinesOfInput From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IfTrueAllowMultipleLinesOfInput ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<IfTrueAllowMultipleLinesOfInput>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IfTrueAllowMultipleLinesOfInput ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<IfTrueAllowMultipleLinesOfInput>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IfTrueAllowMultipleLinesOfInput ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<IfTrueAllowMultipleLinesOfInput>(json, options);
        }
        ...
        /// </exception>
        public static IfTrueAllowMultipleLinesOfInput ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<IfTrueAllowMultipleLinesOfInput>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out IfTrueAllowMultipleLinesOfInput? result)
        {
            return JsonElementHelpers.TryParseValue<IfTrueAllowMultipleLinesOfInput>(ref reader, out result);
        }
...
#if NET
        static IfTrueAllowMultipleLinesOfInput IJsonElement<IfTrueAllowMultipleLinesOfInput>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"IfTrueAllowMultipleLinesOfInput: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public IfTrueAllowMultipleLinesOfInput Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public IfTrueAllowMultipleLinesOfInput Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<IfTrueAllowMultipleLinesOfInput>(_idx);
            }
