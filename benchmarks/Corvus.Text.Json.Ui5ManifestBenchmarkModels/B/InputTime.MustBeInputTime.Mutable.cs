...
public readonly partial struct InputTime
{
    ...
    public readonly partial struct MustBeInputTime
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(MustBeInputTime instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MustBeInputTime"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MustBeInputTime(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MustBeInputTime.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeInputTime Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeInputTime Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MustBeInputTime>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(MustBeInputTime instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<MustBeInputTime, Mutable>(this);
        }
    }
}
