...
public readonly partial struct InputToggle
{
    ...
    public readonly partial struct TheValueWhenToggleIsOff
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(TheValueWhenToggleIsOff instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="TheValueWhenToggleIsOff"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TheValueWhenToggleIsOff(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TheValueWhenToggleIsOff.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly TheValueWhenToggleIsOff Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly TheValueWhenToggleIsOff Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<TheValueWhenToggleIsOff>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(TheValueWhenToggleIsOff instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<TheValueWhenToggleIsOff, Mutable>(this);
        }
    }
}
