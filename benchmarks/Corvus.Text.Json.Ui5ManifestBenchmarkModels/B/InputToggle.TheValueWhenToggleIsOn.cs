...
public readonly partial struct InputToggle
{
    ...
    public readonly partial struct TheValueWhenToggleIsOn
#if NET8_0_OR_GREATER
        : IJsonElement<TheValueWhenToggleIsOn>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TheValueWhenToggleIsOn"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal TheValueWhenToggleIsOn(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static TheValueWhenToggleIsOn DefaultInstance { get; } = ParsedJsonDocument<TheValueWhenToggleIsOn>.StringConstant([.."\"true\""u8]);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(TheValueWhenToggleIsOn value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in TheValueWhenToggleIsOn left, in TheValueWhenToggleIsOn right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in TheValueWhenToggleIsOn left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(TheValueWhenToggleIsOn instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TheValueWhenToggleIsOn(JsonElement instance)
        {
            return TheValueWhenToggleIsOn.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheValueWhenToggleIsOn From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheValueWhenToggleIsOn ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TheValueWhenToggleIsOn>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheValueWhenToggleIsOn ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TheValueWhenToggleIsOn>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheValueWhenToggleIsOn ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TheValueWhenToggleIsOn>(json, options);
        }
        ...
        /// </exception>
        public static TheValueWhenToggleIsOn ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<TheValueWhenToggleIsOn>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out TheValueWhenToggleIsOn? result)
        {
            return JsonElementHelpers.TryParseValue<TheValueWhenToggleIsOn>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new TheValueWhenToggleIsOn(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static TheValueWhenToggleIsOn IJsonElement<TheValueWhenToggleIsOn>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TheValueWhenToggleIsOn: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="TheValueWhenToggleIsOn"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="TheValueWhenToggleIsOn"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public TheValueWhenToggleIsOn Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<TheValueWhenToggleIsOn>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="TheValueWhenToggleIsOn"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public TheValueWhenToggleIsOn Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<TheValueWhenToggleIsOn>(_idx);
            }
