...
public readonly partial struct Media
    : IJsonElement<Media>
{
    public static partial class JsonSchema
    {
        ...
        private const uint RequiredBitForSources = 0b00000000000000000000000000000001;

        private const uint RequiredBitMask0 =
            RequiredBitForSources;
        private static readonly JsonSchemaPathProvider AltTextSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/altText"u8, buffer, out written);
        ...
        private static readonly JsonSchemaPathProvider PosterSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/poster"u8, buffer, out written);
        ...
        private static void MatchAltText(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext =
                Corvus.Ui5ManifestBenchmark.Baseline.JsonString.JsonSchema.PushChildContextUnescaped(
                    ...
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.AltTextUtf8,
                    evaluationPath: AltTextSchemaEvaluationPath);
        ...
        private static void MatchPoster(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext5 =
                Corvus.Ui5ManifestBenchmark.Baseline.JsonUriReference.JsonSchema.PushChildContextUnescaped(
                    ...
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.PosterUtf8,
                    evaluationPath: PosterSchemaEvaluationPath);

            Corvus.Ui5ManifestBenchmark.Baseline.JsonUriReference.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext5);
        ...
        private static void MatchSources(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext8 =
                Corvus.Ui5ManifestBenchmark.Baseline.Media.MediaSourceArray.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.Ui5ManifestBenchmark.Baseline.Media.MediaSourceArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext8);
        ...
        private static void MatchType(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext10 =
                Corvus.Ui5ManifestBenchmark.Baseline.Media.MustBeMedia.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.Ui5ManifestBenchmark.Baseline.Media.MustBeMedia.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext10);
        ...
        private static PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
        {
            return new PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator>([
                (static () => JsonPropertyNames.AltTextUtf8, MatchAltText),
                ...
                (static () => JsonPropertyNames.PosterUtf8, MatchPoster),
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://adaptivecards.io/schemas/adaptive-card.json#/definitions/Media"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "https://adaptivecards.io/schemas/adaptive-card.json#/definitions/Media";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://adaptivecards.io/schemas/adaptive-card.json#/definitions/Media"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            if (tokenType == JsonTokenType.StartObject)
            {
                ...
                {
                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertySourcesPresent, "sources"u8, "required"u8);
                }
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertySourcesNotPresent, "sources"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertySourcesPresent, "sources"u8, "required"u8);
