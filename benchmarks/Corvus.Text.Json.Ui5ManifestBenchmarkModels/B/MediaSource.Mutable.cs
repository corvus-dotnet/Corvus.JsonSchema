...
public readonly partial struct MediaSource
{
...
#endif
    {
        ...
        public static explicit operator Mutable(MediaSource instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="MediaSource"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator MediaSource(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Mutable MimeType
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MimeTypeUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.MediaSource.MustBeMediaSource.Mutable Type
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.MediaSource.MustBeMediaSource.Mutable value))
                {
                    return value;
                }
        ...
        public void SetMimeType(in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source value)
        {
            CheckValidInstance();

            if (value.IsUndefined)
            {
                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("mimeType");
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MimeTypeUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
            ...
            else
            {
                ...
                value.AddAsProperty(JsonPropertyNamesEscaped.MimeType, ref cvb, escapeName: false, nameRequiresUnescaping: false);
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetType(in Corvus.Ui5ManifestBenchmark.Baseline.MediaSource.MustBeMediaSource.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"MediaSource.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly MediaSource Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly MediaSource Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<MediaSource>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(Corvus.Ui5ManifestBenchmark.Baseline.MediaSource.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(MediaSource instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.MediaSource.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="MediaSource"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source mimeType,
            in Corvus.Ui5ManifestBenchmark.Baseline.JsonUriReference.Source url,
            in Corvus.Ui5ManifestBenchmark.Baseline.MediaSource.MustBeMediaSource.Source type = default)
        {
            mimeType.AddAsProperty(JsonPropertyNamesEscaped.MimeType, ref builder, escapeName: false);
        ...
        public void Create(
            ...
            in Corvus.Ui5ManifestBenchmark.Baseline.MediaSource.MustBeMediaSource.Source type = default)
        {
            Create(ref _builder, mimeType, url, type);
        }
    ...
    {
        return workspace.CreateBuilder<MediaSource, Mutable>(this);
    }
}
