...
public readonly partial struct Refresh
{
    ...
    public readonly partial struct MustBeRefresh
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(MustBeRefresh instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MustBeRefresh"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MustBeRefresh(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MustBeRefresh.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeRefresh Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeRefresh Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MustBeRefresh>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(MustBeRefresh instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<MustBeRefresh, Mutable>(this);
        }
    }
}
