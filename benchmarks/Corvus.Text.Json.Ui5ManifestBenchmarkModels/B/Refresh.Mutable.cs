...
public readonly partial struct Refresh
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.ActionExecute.Mutable Action
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ActionUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.ActionExecute.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.Refresh.MustBeRefresh.Mutable Type
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Refresh.MustBeRefresh.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.Refresh.JsonStringArray.Mutable UserIds
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UserIdsUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Refresh.JsonStringArray.Mutable value))
                {
                    return value;
                }
        ...
        public void SetAction(in Corvus.Ui5ManifestBenchmark.Baseline.ActionExecute.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetAction<TContext>(in Corvus.Ui5ManifestBenchmark.Baseline.ActionExecute.Source<TContext> value)
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetType(in Corvus.Ui5ManifestBenchmark.Baseline.Refresh.MustBeRefresh.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetUserIds(in Corvus.Ui5ManifestBenchmark.Baseline.Refresh.JsonStringArray.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetUserIds<TContext>(in Corvus.Ui5ManifestBenchmark.Baseline.Refresh.JsonStringArray.Source<TContext> value)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
        {
    ...
    public ref struct Source
    {
        ...
        internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Refresh.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Refresh.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Corvus.Ui5ManifestBenchmark.Baseline.ActionExecute.Source action = default,
            in Corvus.Ui5ManifestBenchmark.Baseline.Refresh.MustBeRefresh.Source type = default,
            in Corvus.Ui5ManifestBenchmark.Baseline.Refresh.JsonStringArray.Source userIds = default)
        {
        ...
        internal static void Create<TContext>(
            in TContext context,
            ref ComplexValueBuilder builder,
            in Corvus.Ui5ManifestBenchmark.Baseline.ActionExecute.Source<TContext> action = default,
            in Corvus.Ui5ManifestBenchmark.Baseline.Refresh.MustBeRefresh.Source type = default,
            in Corvus.Ui5ManifestBenchmark.Baseline.Refresh.JsonStringArray.Source<TContext> userIds = default)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
        {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.ActionExecute.Source action = default, in Corvus.Ui5ManifestBenchmark.Baseline.Refresh.MustBeRefresh.Source type = default, in Corvus.Ui5ManifestBenchmark.Baseline.Refresh.JsonStringArray.Source userIds = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Ui5ManifestBenchmark.Baseline.ActionExecute.Source<TContext> action = default, in Corvus.Ui5ManifestBenchmark.Baseline.Refresh.MustBeRefresh.Source type = default, in Corvus.Ui5ManifestBenchmark.Baseline.Refresh.JsonStringArray.Source<TContext> userIds = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
