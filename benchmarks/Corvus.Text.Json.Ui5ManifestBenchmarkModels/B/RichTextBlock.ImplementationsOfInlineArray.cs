...
public readonly partial struct RichTextBlock
{
...
#endif
    {
        ...
        public Corvus.Ui5ManifestBenchmark.Baseline.ImplementationsOfInline this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Ui5ManifestBenchmark.Baseline.ImplementationsOfInline>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.ImplementationsOfInline> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.ImplementationsOfInline>(_parent, _idx);
        }
