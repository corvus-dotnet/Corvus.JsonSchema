...
public readonly partial struct RichTextBlock
{
    ...
    public readonly partial struct MustBeRichTextBlock
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(MustBeRichTextBlock instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MustBeRichTextBlock"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MustBeRichTextBlock(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MustBeRichTextBlock.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeRichTextBlock Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeRichTextBlock Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MustBeRichTextBlock>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(MustBeRichTextBlock instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<MustBeRichTextBlock, Mutable>(this);
        }
    }
}
