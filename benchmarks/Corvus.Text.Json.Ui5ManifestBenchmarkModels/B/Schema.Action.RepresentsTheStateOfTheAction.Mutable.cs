...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Action
    {
        ...
        public readonly partial struct RepresentsTheStateOfTheAction
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RepresentsTheStateOfTheAction instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsTheStateOfTheAction"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsTheStateOfTheAction(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new RepresentsTheStateOfTheAction(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsTheStateOfTheAction.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="RepresentsTheStateOfTheAction"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="RepresentsTheStateOfTheAction"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheStateOfTheAction Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<RepresentsTheStateOfTheAction>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="RepresentsTheStateOfTheAction"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheStateOfTheAction Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsTheStateOfTheAction>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.Action.RepresentsTheStateOfTheAction.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.Action.RepresentsTheStateOfTheAction.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsTheStateOfTheAction instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RepresentsTheStateOfTheAction, Mutable>(this);
            }
        }
    }
}
