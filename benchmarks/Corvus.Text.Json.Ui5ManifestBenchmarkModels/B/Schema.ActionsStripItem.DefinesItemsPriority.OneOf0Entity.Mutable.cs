        ...
        public readonly partial struct DefinesItemsPriority
        {
            ...
            public readonly partial struct OneOf0Entity
            {
...
#endif
                {
                    ...
                    /// <param name="matchAlwaysOverflow">Match 1st item.</param>
                    /// <param name="matchDisappear">Match 2nd item.</param>
                    /// <param name="matchHigh">Match 3rd item.</param>
                    /// <param name="matchLow">Match 4th item.</param>
                    /// <param name="matchNeverOverflow">Match 5th item.</param>
                    /// <param name="defaultMatch">Match any other value.</param>
                    /// <returns>An instance of the value returned by the match function.</returns>
                    public TResult Match<TContext, TResult>(
                        in TContext context,
                        Func<TContext, TResult> matchAlwaysOverflow,
                        Func<TContext, TResult> matchDisappear,
                        Func<TContext, TResult> matchHigh,
                        Func<TContext, TResult> matchLow,
                        Func<TContext, TResult> matchNeverOverflow,
...
#endif
                    {
                        ...
                        {
                            return matchAlwaysOverflow(context);
                        }

                        if (this.ValueEquals(Constants.Enum2))
                        {
                            return matchDisappear(context);
                        }

                        if (this.ValueEquals(Constants.Enum3))
                        {
                            return matchHigh(context);
                        }

                        if (this.ValueEquals(Constants.Enum4))
                        {
                            return matchLow(context);
                        }

                        if (this.ValueEquals(Constants.Enum5))
                        {
                            return matchNeverOverflow(context);
                        }
                    ...
                    public TResult Match<TResult>(
                        Func<TResult> matchAlwaysOverflow,
                        Func<TResult> matchDisappear,
                        Func<TResult> matchHigh,
                        Func<TResult> matchLow,
                        Func<TResult> matchNeverOverflow,
                        Func<TResult> defaultMatch)
                    {
                        if (this.ValueEquals(Constants.Enum1))
                        {
                            return matchAlwaysOverflow();
                        }

                        if (this.ValueEquals(Constants.Enum2))
                        {
                            return matchDisappear();
                        }
