        ...
        public readonly partial struct TheTypeOfTheButton
        {
            ...
            public readonly partial struct OneOf0Entity
            {
...
#endif
                {
                    ...
                    /// <param name="matchAccept">Match 1st item.</param>
                    /// <param name="matchAttention">Match 2nd item.</param>
                    /// <param name="matchBack">Match 3rd item.</param>
                    /// <param name="matchCritical">Match 4th item.</param>
                    /// <param name="matchDefault">Match 5th item.</param>
                    /// <param name="matchEmphasized">Match 6th item.</param>
                    /// <param name="matchGhost">Match 7th item.</param>
                    /// <param name="matchNegative">Match 8th item.</param>
                    /// <param name="matchNeutral">Match 9th item.</param>
                    /// <param name="matchReject">Match 10th item.</param>
                    /// <param name="matchSuccess">Match 11th item.</param>
                    /// <param name="matchTransparent">Match 12th item.</param>
                    /// <param name="matchUnstyled">Match 13th item.</param>
                    /// <param name="matchUp">Match 14th item.</param>
                    /// <param name="defaultMatch">Match any other value.</param>
                    /// <returns>An instance of the value returned by the match function.</returns>
                    public TResult Match<TContext, TResult>(
                        in TContext context,
                        Func<TContext, TResult> matchAccept,
                        Func<TContext, TResult> matchAttention,
                        Func<TContext, TResult> matchBack,
                        Func<TContext, TResult> matchCritical,
                        Func<TContext, TResult> matchDefault,
                        Func<TContext, TResult> matchEmphasized,
                        Func<TContext, TResult> matchGhost,
                        Func<TContext, TResult> matchNegative,
                        ...
                        Func<TContext, TResult> matchUnstyled,
                        Func<TContext, TResult> matchUp,
...
#endif
                    {
                        ...
                        {
                            return matchEmphasized(context);
                        }

                        if (this.ValueEquals(Constants.Enum7))
                        {
                            return matchGhost(context);
                        }

                        if (this.ValueEquals(Constants.Enum8))
                        {
                            return matchNegative(context);
                        }
