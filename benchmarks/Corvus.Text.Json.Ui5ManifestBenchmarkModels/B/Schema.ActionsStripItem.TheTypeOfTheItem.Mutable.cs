    ...
    public readonly partial struct ActionsStripItem
    {
        ...
        public readonly partial struct TheTypeOfTheItem
        {
...
#endif
            {
                ...
                public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.Schema.ActionsStripItem.TheTypeOfTheItem.OneOf0Entity.Mutable(Mutable value)
                {
                    return Corvus.Ui5ManifestBenchmark.Baseline.Schema.ActionsStripItem.TheTypeOfTheItem.OneOf0Entity.Mutable.From(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Baseline.Schema.ActionsStripItem.TheTypeOfTheItem.OneOf0Entity.Mutable value)
                {
                    return From(value);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ActionsStripItem.TheTypeOfTheItem.Mutable, TContext, TResult> defaultMatch)
...
#endif
                {
                    ...
                    {
                        return matchOneOf0Entity(Corvus.Ui5ManifestBenchmark.Baseline.Schema.ActionsStripItem.TheTypeOfTheItem.OneOf0Entity.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ActionsStripItem.TheTypeOfTheItem.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.ActionsStripItem.TheTypeOfTheItem.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchOneOf0Entity(Corvus.Ui5ManifestBenchmark.Baseline.Schema.ActionsStripItem.TheTypeOfTheItem.OneOf0Entity.Mutable.From(this));
                    }
                ...
                public bool TryGetAsOneOf0Entity(out Corvus.Ui5ManifestBenchmark.Baseline.Schema.ActionsStripItem.TheTypeOfTheItem.OneOf0Entity result)
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.ActionsStripItem.TheTypeOfTheItem.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.Ui5ManifestBenchmark.Baseline.Schema.ActionsStripItem.TheTypeOfTheItem.OneOf0Entity.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.ActionsStripItem.TheTypeOfTheItem.OneOf0Entity instance) => new(JsonElement.From(instance));
