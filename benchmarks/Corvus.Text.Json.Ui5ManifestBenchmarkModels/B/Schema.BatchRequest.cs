...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.Schema.BatchRequest.RepresentsTheRequestBody Body
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BodyUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.BatchRequest.RepresentsTheRequestBody value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.Schema.BatchRequest.RepresentsHttpHeaders Headers
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HeadersUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.BatchRequest.RepresentsHttpHeaders value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.Schema.BatchRequest.TheHttpMethod Method
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MethodUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.BatchRequest.TheHttpMethod value))
                {
                    return value;
                }
