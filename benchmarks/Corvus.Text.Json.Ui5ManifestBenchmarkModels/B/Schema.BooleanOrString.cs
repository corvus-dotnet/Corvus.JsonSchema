...
public readonly partial struct Schema
{
    ...
    public readonly partial struct BooleanOrString
#if NET8_0_OR_GREATER
        : IJsonElement<BooleanOrString>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BooleanOrString"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal BooleanOrString(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static BooleanOrString DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(BooleanOrString value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator bool(BooleanOrString value)
        {
        ...
        /// </returns>
        public static bool operator ==(in BooleanOrString left, in BooleanOrString right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in BooleanOrString left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(BooleanOrString instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator BooleanOrString(JsonElement instance)
        {
            return BooleanOrString.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BooleanOrString From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BooleanOrString ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BooleanOrString>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BooleanOrString ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BooleanOrString>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BooleanOrString ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BooleanOrString>(json, options);
        }
        ...
        /// </exception>
        public static BooleanOrString ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<BooleanOrString>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out BooleanOrString? result)
        {
            return JsonElementHelpers.TryParseValue<BooleanOrString>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new BooleanOrString(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static BooleanOrString IJsonElement<BooleanOrString>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"BooleanOrString: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="BooleanOrString"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="BooleanOrString"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public BooleanOrString Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<BooleanOrString>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="BooleanOrString"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public BooleanOrString Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<BooleanOrString>(_idx);
            }
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.BooleanOrString, TContext, TResult> defaultMatch)
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.BooleanOrString, TResult> defaultMatch)
        {
            if (Corvus.Ui5ManifestBenchmark.Baseline.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
            {
