    ...
    public readonly partial struct Cache
    {
        ...
        public readonly partial struct ShouldWeShowStaleCacheWhileRevalidating
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ShouldWeShowStaleCacheWhileRevalidating instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ShouldWeShowStaleCacheWhileRevalidating"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ShouldWeShowStaleCacheWhileRevalidating(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ShouldWeShowStaleCacheWhileRevalidating.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ShouldWeShowStaleCacheWhileRevalidating Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ShouldWeShowStaleCacheWhileRevalidating Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ShouldWeShowStaleCacheWhileRevalidating>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ShouldWeShowStaleCacheWhileRevalidating instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ShouldWeShowStaleCacheWhileRevalidating, Mutable>(this);
            }
        }
    }
}
