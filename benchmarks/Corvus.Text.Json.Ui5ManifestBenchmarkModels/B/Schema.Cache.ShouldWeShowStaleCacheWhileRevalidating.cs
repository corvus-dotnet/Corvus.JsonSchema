...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Cache
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ShouldWeShowStaleCacheWhileRevalidating"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ShouldWeShowStaleCacheWhileRevalidating(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ShouldWeShowStaleCacheWhileRevalidating DefaultInstance { get; } = ParsedJsonDocument<ShouldWeShowStaleCacheWhileRevalidating>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(ShouldWeShowStaleCacheWhileRevalidating value)
            {
            ...
            /// </returns>
            public static bool operator ==(in ShouldWeShowStaleCacheWhileRevalidating left, in ShouldWeShowStaleCacheWhileRevalidating right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ShouldWeShowStaleCacheWhileRevalidating left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ShouldWeShowStaleCacheWhileRevalidating instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ShouldWeShowStaleCacheWhileRevalidating(JsonElement instance)
            {
                return ShouldWeShowStaleCacheWhileRevalidating.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ShouldWeShowStaleCacheWhileRevalidating From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ShouldWeShowStaleCacheWhileRevalidating ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ShouldWeShowStaleCacheWhileRevalidating>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ShouldWeShowStaleCacheWhileRevalidating ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ShouldWeShowStaleCacheWhileRevalidating>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ShouldWeShowStaleCacheWhileRevalidating ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ShouldWeShowStaleCacheWhileRevalidating>(json, options);
            }
            ...
            /// </exception>
            public static ShouldWeShowStaleCacheWhileRevalidating ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ShouldWeShowStaleCacheWhileRevalidating>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ShouldWeShowStaleCacheWhileRevalidating? result)
            {
                return JsonElementHelpers.TryParseValue<ShouldWeShowStaleCacheWhileRevalidating>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ShouldWeShowStaleCacheWhileRevalidating(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static ShouldWeShowStaleCacheWhileRevalidating IJsonElement<ShouldWeShowStaleCacheWhileRevalidating>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ShouldWeShowStaleCacheWhileRevalidating: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ShouldWeShowStaleCacheWhileRevalidating"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ShouldWeShowStaleCacheWhileRevalidating"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public ShouldWeShowStaleCacheWhileRevalidating Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ShouldWeShowStaleCacheWhileRevalidating>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ShouldWeShowStaleCacheWhileRevalidating"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public ShouldWeShowStaleCacheWhileRevalidating Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ShouldWeShowStaleCacheWhileRevalidating>(_idx);
                }
