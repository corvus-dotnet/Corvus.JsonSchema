...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Card
...
#endif
    {
        ...
        internal Card(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static Card DefaultInstance { get; }

        /// <summary>
        /// Gets the (optional) <c>model</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.Schema.Card.RepresentsTheModelForTheCard Model
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ModelUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.Card.RepresentsTheModelForTheCard value))
                {
                    return value;
                }
        ...
        /// <summary>
        /// Gets the (optional) <c>sequencePos</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.JsonInteger SequencePos
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SequencePosUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.JsonInteger value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.Schema.CardSetting Settings
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SettingsUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.CardSetting value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.Schema.Card.TabSettingArray Tabs
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TabsUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.Card.TabSettingArray value))
                {
                    return value;
                }
        ...
        /// <summary>
        /// Gets the <c>template</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.Schema.Card.RepresentsTheCardComponentPathToUseForThisCard Template
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TemplateUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.Card.RepresentsTheCardComponentPathToUseForThisCard value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in Card left, in Card right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Card left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(Card instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Card(JsonElement instance)
        {
            return Card.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Card From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Card ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Card>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Card ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Card>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Card ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Card>(json, options);
        }
        ...
        /// </exception>
        public static Card ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<Card>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Card? result)
        {
            return JsonElementHelpers.TryParseValue<Card>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new Card(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static Card IJsonElement<Card>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Card: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="Card"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="Card"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        {
            CheckValidInstance();
            return _parent.CloneElement<Card>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="Card"/> that lives for the lifetime of its
        ...
        public Card Freeze()
        {
            ...
            {
                return mutable.FreezeElement<Card>(_idx);
            }
        ...
        {
            /// <summary>
            /// Gets the JSON property name for <see cref="Model"/>.
            /// </summary>
            public const string Model = "model";

            /// <summary>
            /// Gets the JSON property name for <see cref="SequencePos"/>.
            /// </summary>
            public const string SequencePos = "sequencePos";
            ...
            /// Gets the JSON property name for <see cref="SequencePos"/>.
            /// </summary>
            public static ReadOnlySpan<byte> SequencePosUtf8 => "sequencePos"u8;
        ...
        {
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="Model"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Model => "model"u8;

            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="SequencePos"/>.
            /// </summary>
            public static ReadOnlySpan<byte> SequencePos => "sequencePos"u8;
