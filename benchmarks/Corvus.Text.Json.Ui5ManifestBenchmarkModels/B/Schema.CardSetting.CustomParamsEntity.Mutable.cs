    ...
    public readonly partial struct CardSetting
    {
        ...
        public readonly partial struct CustomParamsEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(CustomParamsEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="CustomParamsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator CustomParamsEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"CustomParamsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly CustomParamsEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly CustomParamsEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<CustomParamsEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(CustomParamsEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<CustomParamsEntity, Mutable>(this);
            }
        }
    }
}
