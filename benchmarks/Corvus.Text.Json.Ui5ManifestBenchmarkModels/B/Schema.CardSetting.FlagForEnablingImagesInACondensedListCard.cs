...
public readonly partial struct Schema
{
    ...
    public readonly partial struct CardSetting
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="FlagForEnablingImagesInACondensedListCard"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal FlagForEnablingImagesInACondensedListCard(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static FlagForEnablingImagesInACondensedListCard DefaultInstance { get; } = ParsedJsonDocument<FlagForEnablingImagesInACondensedListCard>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(FlagForEnablingImagesInACondensedListCard value)
            {
            ...
            /// </returns>
            public static bool operator ==(in FlagForEnablingImagesInACondensedListCard left, in FlagForEnablingImagesInACondensedListCard right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in FlagForEnablingImagesInACondensedListCard left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(FlagForEnablingImagesInACondensedListCard instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator FlagForEnablingImagesInACondensedListCard(JsonElement instance)
            {
                return FlagForEnablingImagesInACondensedListCard.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static FlagForEnablingImagesInACondensedListCard From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static FlagForEnablingImagesInACondensedListCard ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<FlagForEnablingImagesInACondensedListCard>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static FlagForEnablingImagesInACondensedListCard ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<FlagForEnablingImagesInACondensedListCard>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static FlagForEnablingImagesInACondensedListCard ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<FlagForEnablingImagesInACondensedListCard>(json, options);
            }
            ...
            /// </exception>
            public static FlagForEnablingImagesInACondensedListCard ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<FlagForEnablingImagesInACondensedListCard>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out FlagForEnablingImagesInACondensedListCard? result)
            {
                return JsonElementHelpers.TryParseValue<FlagForEnablingImagesInACondensedListCard>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new FlagForEnablingImagesInACondensedListCard(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static FlagForEnablingImagesInACondensedListCard IJsonElement<FlagForEnablingImagesInACondensedListCard>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"FlagForEnablingImagesInACondensedListCard: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="FlagForEnablingImagesInACondensedListCard"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="FlagForEnablingImagesInACondensedListCard"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public FlagForEnablingImagesInACondensedListCard Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<FlagForEnablingImagesInACondensedListCard>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="FlagForEnablingImagesInACondensedListCard"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public FlagForEnablingImagesInACondensedListCard Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<FlagForEnablingImagesInACondensedListCard>(_idx);
                }
