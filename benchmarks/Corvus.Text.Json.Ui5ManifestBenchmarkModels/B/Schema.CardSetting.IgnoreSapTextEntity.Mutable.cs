...
public readonly partial struct Schema
{
    ...
    public readonly partial struct CardSetting
    {
        ...
        public readonly partial struct IgnoreSapTextEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(IgnoreSapTextEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="IgnoreSapTextEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator IgnoreSapTextEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new IgnoreSapTextEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"IgnoreSapTextEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="IgnoreSapTextEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="IgnoreSapTextEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly IgnoreSapTextEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<IgnoreSapTextEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="IgnoreSapTextEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly IgnoreSapTextEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<IgnoreSapTextEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(IgnoreSapTextEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<IgnoreSapTextEntity, Mutable>(this);
            }
        }
    }
}
