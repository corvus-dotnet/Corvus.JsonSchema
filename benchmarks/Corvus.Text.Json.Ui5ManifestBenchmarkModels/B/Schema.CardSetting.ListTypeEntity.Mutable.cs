    ...
    public readonly partial struct CardSetting
    {
        ...
        public readonly partial struct ListTypeEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ListTypeEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ListTypeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ListTypeEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ListTypeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ListTypeEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ListTypeEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ListTypeEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ListTypeEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ListTypeEntity, Mutable>(this);
            }
        }
    }
}
