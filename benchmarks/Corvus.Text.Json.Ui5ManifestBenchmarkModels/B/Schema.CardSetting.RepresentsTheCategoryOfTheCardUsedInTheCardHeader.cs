...
public readonly partial struct Schema
{
    ...
    public readonly partial struct CardSetting
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RepresentsTheCategoryOfTheCardUsedInTheCardHeader"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RepresentsTheCategoryOfTheCardUsedInTheCardHeader(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RepresentsTheCategoryOfTheCardUsedInTheCardHeader DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(RepresentsTheCategoryOfTheCardUsedInTheCardHeader value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in RepresentsTheCategoryOfTheCardUsedInTheCardHeader left, in RepresentsTheCategoryOfTheCardUsedInTheCardHeader right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RepresentsTheCategoryOfTheCardUsedInTheCardHeader left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(RepresentsTheCategoryOfTheCardUsedInTheCardHeader instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RepresentsTheCategoryOfTheCardUsedInTheCardHeader(JsonElement instance)
            {
                return RepresentsTheCategoryOfTheCardUsedInTheCardHeader.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheCategoryOfTheCardUsedInTheCardHeader From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheCategoryOfTheCardUsedInTheCardHeader ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheCategoryOfTheCardUsedInTheCardHeader>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheCategoryOfTheCardUsedInTheCardHeader ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheCategoryOfTheCardUsedInTheCardHeader>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheCategoryOfTheCardUsedInTheCardHeader ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheCategoryOfTheCardUsedInTheCardHeader>(json, options);
            }
            ...
            /// </exception>
            public static RepresentsTheCategoryOfTheCardUsedInTheCardHeader ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheCategoryOfTheCardUsedInTheCardHeader>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsTheCategoryOfTheCardUsedInTheCardHeader? result)
            {
                return JsonElementHelpers.TryParseValue<RepresentsTheCategoryOfTheCardUsedInTheCardHeader>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RepresentsTheCategoryOfTheCardUsedInTheCardHeader(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static RepresentsTheCategoryOfTheCardUsedInTheCardHeader IJsonElement<RepresentsTheCategoryOfTheCardUsedInTheCardHeader>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RepresentsTheCategoryOfTheCardUsedInTheCardHeader: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RepresentsTheCategoryOfTheCardUsedInTheCardHeader"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RepresentsTheCategoryOfTheCardUsedInTheCardHeader"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public RepresentsTheCategoryOfTheCardUsedInTheCardHeader Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RepresentsTheCategoryOfTheCardUsedInTheCardHeader>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RepresentsTheCategoryOfTheCardUsedInTheCardHeader"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public RepresentsTheCategoryOfTheCardUsedInTheCardHeader Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RepresentsTheCategoryOfTheCardUsedInTheCardHeader>(_idx);
                }
