...
public readonly partial struct Schema
{
    ...
    public readonly partial struct CardSetting
    {
        ...
        public readonly partial struct RepresentsTheDataPointAnnotationPath
#if NET8_0_OR_GREATER
            : IJsonElement<RepresentsTheDataPointAnnotationPath>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RepresentsTheDataPointAnnotationPath"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RepresentsTheDataPointAnnotationPath(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RepresentsTheDataPointAnnotationPath DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(RepresentsTheDataPointAnnotationPath value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in RepresentsTheDataPointAnnotationPath left, in RepresentsTheDataPointAnnotationPath right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RepresentsTheDataPointAnnotationPath left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(RepresentsTheDataPointAnnotationPath instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RepresentsTheDataPointAnnotationPath(JsonElement instance)
            {
                return RepresentsTheDataPointAnnotationPath.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheDataPointAnnotationPath From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheDataPointAnnotationPath ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheDataPointAnnotationPath>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheDataPointAnnotationPath ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheDataPointAnnotationPath>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheDataPointAnnotationPath ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheDataPointAnnotationPath>(json, options);
            }
            ...
            /// </exception>
            public static RepresentsTheDataPointAnnotationPath ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheDataPointAnnotationPath>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsTheDataPointAnnotationPath? result)
            {
                return JsonElementHelpers.TryParseValue<RepresentsTheDataPointAnnotationPath>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RepresentsTheDataPointAnnotationPath(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static RepresentsTheDataPointAnnotationPath IJsonElement<RepresentsTheDataPointAnnotationPath>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RepresentsTheDataPointAnnotationPath: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RepresentsTheDataPointAnnotationPath"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RepresentsTheDataPointAnnotationPath"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public RepresentsTheDataPointAnnotationPath Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RepresentsTheDataPointAnnotationPath>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RepresentsTheDataPointAnnotationPath"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public RepresentsTheDataPointAnnotationPath Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RepresentsTheDataPointAnnotationPath>(_idx);
                }
