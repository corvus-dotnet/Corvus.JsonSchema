    ...
    public readonly partial struct CardSetting
    {
        ...
        public readonly partial struct ShowLabelTextEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ShowLabelTextEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ShowLabelTextEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ShowLabelTextEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ShowLabelTextEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ShowLabelTextEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ShowLabelTextEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ShowLabelTextEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ShowLabelTextEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ShowLabelTextEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ShowLabelTextEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ShowLabelTextEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ShowLabelTextEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ShowLabelTextEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ShowLabelTextEntity, Mutable>(this);
            }
        }
    }
}
