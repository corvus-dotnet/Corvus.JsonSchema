    ...
    public readonly partial struct CardSetting
    {
        ...
        public readonly partial struct ShowRefreshEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ShowRefreshEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ShowRefreshEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ShowRefreshEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ShowRefreshEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ShowRefreshEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ShowRefreshEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ShowRefreshEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ShowRefreshEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ShowRefreshEntity, Mutable>(this);
            }
        }
    }
}
