...
public readonly partial struct Schema
{
    ...
    public readonly partial struct CardSetting
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ShowSortingInHeaderEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ShowSortingInHeaderEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ShowSortingInHeaderEntity DefaultInstance { get; } = ParsedJsonDocument<ShowSortingInHeaderEntity>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(ShowSortingInHeaderEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in ShowSortingInHeaderEntity left, in ShowSortingInHeaderEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ShowSortingInHeaderEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ShowSortingInHeaderEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ShowSortingInHeaderEntity(JsonElement instance)
            {
                return ShowSortingInHeaderEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ShowSortingInHeaderEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ShowSortingInHeaderEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ShowSortingInHeaderEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ShowSortingInHeaderEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ShowSortingInHeaderEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ShowSortingInHeaderEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ShowSortingInHeaderEntity>(json, options);
            }
            ...
            /// </exception>
            public static ShowSortingInHeaderEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ShowSortingInHeaderEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ShowSortingInHeaderEntity? result)
            {
                return JsonElementHelpers.TryParseValue<ShowSortingInHeaderEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ShowSortingInHeaderEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static ShowSortingInHeaderEntity IJsonElement<ShowSortingInHeaderEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ShowSortingInHeaderEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ShowSortingInHeaderEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ShowSortingInHeaderEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public ShowSortingInHeaderEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ShowSortingInHeaderEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ShowSortingInHeaderEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public ShowSortingInHeaderEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ShowSortingInHeaderEntity>(_idx);
                }
