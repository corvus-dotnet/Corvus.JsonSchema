...
public readonly partial struct Schema
{
    ...
    public readonly partial struct CardSetting
    {
        ...
        public readonly partial struct StaticContentEntityArray
            ...
            : IJsonElement<StaticContentEntityArray>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="StaticContentEntityArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal StaticContentEntityArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static StaticContentEntityArray DefaultInstance { get; }
            ...
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.CardSetting.StaticContentEntityArray.StaticContentEntity this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Ui5ManifestBenchmark.Baseline.Schema.CardSetting.StaticContentEntityArray.StaticContentEntity>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.Schema.CardSetting.StaticContentEntityArray.StaticContentEntity> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.Schema.CardSetting.StaticContentEntityArray.StaticContentEntity>(_parent, _idx);
            }
            ...
            /// </returns>
            public static bool operator ==(in StaticContentEntityArray left, in StaticContentEntityArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in StaticContentEntityArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(StaticContentEntityArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator StaticContentEntityArray(JsonElement instance)
            {
                return StaticContentEntityArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static StaticContentEntityArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static StaticContentEntityArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<StaticContentEntityArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static StaticContentEntityArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<StaticContentEntityArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static StaticContentEntityArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<StaticContentEntityArray>(json, options);
            }
            ...
            /// </exception>
            public static StaticContentEntityArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<StaticContentEntityArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out StaticContentEntityArray? result)
            {
                return JsonElementHelpers.TryParseValue<StaticContentEntityArray>(ref reader, out result);
            }
...
#if NET
            static StaticContentEntityArray IJsonElement<StaticContentEntityArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"StaticContentEntityArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public StaticContentEntityArray Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public StaticContentEntityArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<StaticContentEntityArray>(_idx);
                }
