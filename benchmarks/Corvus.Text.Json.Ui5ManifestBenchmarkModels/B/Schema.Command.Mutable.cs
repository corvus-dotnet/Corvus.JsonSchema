...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Command
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.Command.ShortcutEntity.Mutable Shortcut
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ShortcutUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.Command.ShortcutEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetShortcut(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Command.ShortcutEntity.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.Command.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.Command.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Command.ShortcutEntity.Source shortcut = default)
            {
            ...
            /// Creates an instance of a <see cref="Command"/>.
            /// </summary>
            public void Create(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Command.ShortcutEntity.Source shortcut = default)
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Command.ShortcutEntity.Source shortcut = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
