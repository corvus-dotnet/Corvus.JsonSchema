    ...
    public readonly partial struct Command
    {
        ...
        public readonly partial struct ShortcutEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ShortcutEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ShortcutEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ShortcutEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ShortcutEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ShortcutEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ShortcutEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ShortcutEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ShortcutEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ShortcutEntity, Mutable>(this);
            }
        }
    }
}
