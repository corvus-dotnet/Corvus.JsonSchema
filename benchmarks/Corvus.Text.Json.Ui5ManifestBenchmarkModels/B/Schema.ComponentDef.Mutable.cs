...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ComponentDef
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ComponentDef instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ComponentDef"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ComponentDef(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.JsonBoolean.Mutable List
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ListUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.JsonBoolean.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.ComponentDef.TheNameOfTheComponent.Mutable Name
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.ComponentDef.TheNameOfTheComponent.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetList(in Corvus.Ui5ManifestBenchmark.Baseline.JsonBoolean.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ListUtf8);
            ...
            /// <summary>
            /// Remove the <c>list</c> property, if present.
            /// </summary>
            ...
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ListUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetName(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ComponentDef.TheNameOfTheComponent.Source value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ComponentDef.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ComponentDef Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ComponentDef Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ComponentDef>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.ComponentDef.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(ComponentDef instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.ComponentDef.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="ComponentDef"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ComponentDef.TheNameOfTheComponent.Source name,
                in Corvus.Ui5ManifestBenchmark.Baseline.JsonBoolean.Source list = default,
            ...
            public void Create(
                ...
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ComponentSettingDef.Source settings = default)
            {
                Create(ref _builder, name, list, settings);
            }
            ...
            #endif
            {
                Create(context, ref _builder, name, list, settings);
            }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ComponentDef.TheNameOfTheComponent.Source name, in Corvus.Ui5ManifestBenchmark.Baseline.JsonBoolean.Source list = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ComponentSettingDef.Source settings = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(name, list, settings);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
            ...
            #endif
        {
            ...
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(context, name, list, settings);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<ComponentDef, Mutable>(this);
        }
    }
}
