...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ComponentDef
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="TheNameOfTheComponent"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal TheNameOfTheComponent(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static TheNameOfTheComponent DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(TheNameOfTheComponent value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in TheNameOfTheComponent left, in TheNameOfTheComponent right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in TheNameOfTheComponent left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(TheNameOfTheComponent instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TheNameOfTheComponent(JsonElement instance)
            {
                return TheNameOfTheComponent.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TheNameOfTheComponent From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TheNameOfTheComponent ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TheNameOfTheComponent>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TheNameOfTheComponent ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TheNameOfTheComponent>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TheNameOfTheComponent ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TheNameOfTheComponent>(json, options);
            }
            ...
            /// </exception>
            public static TheNameOfTheComponent ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<TheNameOfTheComponent>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out TheNameOfTheComponent? result)
            {
                return JsonElementHelpers.TryParseValue<TheNameOfTheComponent>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new TheNameOfTheComponent(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static TheNameOfTheComponent IJsonElement<TheNameOfTheComponent>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TheNameOfTheComponent: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="TheNameOfTheComponent"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="TheNameOfTheComponent"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public TheNameOfTheComponent Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<TheNameOfTheComponent>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="TheNameOfTheComponent"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public TheNameOfTheComponent Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<TheNameOfTheComponent>(_idx);
                }
