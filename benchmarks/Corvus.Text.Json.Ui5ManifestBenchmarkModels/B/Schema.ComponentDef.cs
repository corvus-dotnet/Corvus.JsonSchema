...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ComponentDef
#if NET8_0_OR_GREATER
        : IJsonElement<ComponentDef>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ComponentDef"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ComponentDef(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ComponentDef DefaultInstance { get; }

        /// <summary>
        /// Gets the (optional) <c>list</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.JsonBoolean List
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ListUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.JsonBoolean value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.Schema.ComponentDef.TheNameOfTheComponent Name
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.ComponentDef.TheNameOfTheComponent value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in ComponentDef left, in ComponentDef right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ComponentDef left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(ComponentDef instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ComponentDef(JsonElement instance)
        {
            return ComponentDef.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ComponentDef From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ComponentDef ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ComponentDef>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ComponentDef ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ComponentDef>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ComponentDef ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ComponentDef>(json, options);
        }
        ...
        /// </exception>
        public static ComponentDef ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ComponentDef>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ComponentDef? result)
        {
            return JsonElementHelpers.TryParseValue<ComponentDef>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ComponentDef(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static ComponentDef IJsonElement<ComponentDef>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ComponentDef: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ComponentDef"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ComponentDef"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        {
            CheckValidInstance();
            return _parent.CloneElement<ComponentDef>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ComponentDef"/> that lives for the lifetime of its
        ...
        {
            /// <summary>
            /// Gets the JSON property name for <see cref="List"/>.
            /// </summary>
            ...
            /// Gets the JSON property name for <see cref="List"/>.
            /// </summary>
            public static ReadOnlySpan<byte> ListUtf8 => "list"u8;
        ...
        {
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="List"/>.
            /// </summary>
