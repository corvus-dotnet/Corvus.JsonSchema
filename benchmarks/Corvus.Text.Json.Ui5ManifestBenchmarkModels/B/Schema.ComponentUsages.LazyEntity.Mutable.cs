    ...
    public readonly partial struct ComponentUsages
    {
        ...
        public readonly partial struct LazyEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(LazyEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="LazyEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator LazyEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"LazyEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly LazyEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly LazyEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<LazyEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(LazyEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<LazyEntity, Mutable>(this);
            }
        }
    }
}
