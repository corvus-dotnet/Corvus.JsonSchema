...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.Schema.Config ComponentData
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ComponentDataUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.Config value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.Schema.ComponentUsages.LazyEntity Lazy
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LazyUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.ComponentUsages.LazyEntity value))
                {
                    return value;
                }

                return Corvus.Ui5ManifestBenchmark.Baseline.Schema.ComponentUsages.LazyEntity.DefaultInstance;
            }
        }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.Schema.ComponentUsages.RepresentsNameOfReuseComponent Name
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.ComponentUsages.RepresentsNameOfReuseComponent value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.Schema.Config Settings
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SettingsUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.Config value))
                {
                    return value;
                }
