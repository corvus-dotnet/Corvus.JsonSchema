...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Config
        : IJsonElement<Config>
    {
        public static partial class JsonSchema
        {
                ...
                ref JsonSchemaContext context)
            {
                ...
                JsonSchemaContext oneOfContext0 =
                    Corvus.Ui5ManifestBenchmark.Baseline.Schema.Config.ConfigArray.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf0SchemaEvaluationPath);
                Corvus.Ui5ManifestBenchmark.Baseline.Schema.Config.ConfigArray.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext0);
                ...
                JsonSchemaContext oneOfContext2 =
                    Corvus.Ui5ManifestBenchmark.Baseline.JsonBoolean.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf2SchemaEvaluationPath);
                Corvus.Ui5ManifestBenchmark.Baseline.JsonBoolean.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext2);
                ...
                JsonSchemaContext oneOfContext3 =
                    Corvus.Ui5ManifestBenchmark.Baseline.JsonNumber.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf3SchemaEvaluationPath);
                Corvus.Ui5ManifestBenchmark.Baseline.JsonNumber.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext3);
                ...
                JsonSchemaContext oneOfContext4 =
                    Corvus.Ui5ManifestBenchmark.Baseline.Schema.Config.OneOf4Entity.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf4SchemaEvaluationPath);
                Corvus.Ui5ManifestBenchmark.Baseline.Schema.Config.OneOf4Entity.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext4);
