...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ConfigurationCsrfToken
#if NET8_0_OR_GREATER
        : IJsonElement<ConfigurationCsrfToken>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfigurationCsrfToken"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ConfigurationCsrfToken(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ConfigurationCsrfToken DefaultInstance { get; }
        ...
        /// </returns>
        public static bool operator ==(in ConfigurationCsrfToken left, in ConfigurationCsrfToken right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ConfigurationCsrfToken left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(ConfigurationCsrfToken instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ConfigurationCsrfToken(JsonElement instance)
        {
            return ConfigurationCsrfToken.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ConfigurationCsrfToken From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ConfigurationCsrfToken ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ConfigurationCsrfToken>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ConfigurationCsrfToken ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ConfigurationCsrfToken>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ConfigurationCsrfToken ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ConfigurationCsrfToken>(json, options);
        }
        ...
        /// </exception>
        public static ConfigurationCsrfToken ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ConfigurationCsrfToken>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ConfigurationCsrfToken? result)
        {
            return JsonElementHelpers.TryParseValue<ConfigurationCsrfToken>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ConfigurationCsrfToken(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static ConfigurationCsrfToken IJsonElement<ConfigurationCsrfToken>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ConfigurationCsrfToken: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ConfigurationCsrfToken"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ConfigurationCsrfToken"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public ConfigurationCsrfToken Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ConfigurationCsrfToken>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ConfigurationCsrfToken"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public ConfigurationCsrfToken Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ConfigurationCsrfToken>(_idx);
            }
