...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ConfigurationFilterItem
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ConfigurationFilterItem instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ConfigurationFilterItem"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ConfigurationFilterItem(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Mutable Key
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.KeyUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ConfigurationFilterItem(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetKey(in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ConfigurationFilterItem.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ConfigurationFilterItem"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ConfigurationFilterItem"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly ConfigurationFilterItem Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ConfigurationFilterItem>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ConfigurationFilterItem"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly ConfigurationFilterItem Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ConfigurationFilterItem>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterItem.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(ConfigurationFilterItem instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterItem.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="ConfigurationFilterItem"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source key = default,
            ...
            /// Creates an instance of a <see cref="ConfigurationFilterItem"/>.
            /// </summary>
            public void Create(in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source key = default, in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source title = default)
            {
                Create(ref _builder, key, title);
            }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source key = default, in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source title = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(key, title);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<ConfigurationFilterItem, Mutable>(this);
        }
    }
}
