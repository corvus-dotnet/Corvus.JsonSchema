    ...
    public readonly partial struct ConfigurationFilterTypeDateRange
    {
        ...
        public readonly partial struct OptionsEntityArray
        {
...
#endif
            {
                ...
                public Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterTypeDateRange.OptionsEntityArray.OptionsEntity.Mutable this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterTypeDateRange.OptionsEntityArray.OptionsEntity.Mutable>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterTypeDateRange.OptionsEntityArray.OptionsEntity.Mutable> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterTypeDateRange.OptionsEntityArray.OptionsEntity.Mutable>(_parent, _idx);
                }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetItem(int itemIndex, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterTypeDateRange.OptionsEntityArray.OptionsEntity.Source value)
                {
                    CheckValidInstance();
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void InsertItem(int itemIndex, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterTypeDateRange.OptionsEntityArray.OptionsEntity.Source value)
                {
                    CheckValidInstance();
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void AddItem(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterTypeDateRange.OptionsEntityArray.OptionsEntity.Source value)
                {
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Remove(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterTypeDateRange.OptionsEntityArray.OptionsEntity item)
                {
                    CheckValidInstance();
                    if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterTypeDateRange.OptionsEntityArray.OptionsEntity>(this, in item))
                    {
                        return false;
                    }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void RemoveWhere(JsonPredicate<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterTypeDateRange.OptionsEntityArray.OptionsEntity> predicate)
                {
                    CheckValidInstance();
                    JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterTypeDateRange.OptionsEntityArray.OptionsEntity>(this, predicate);
                    _documentVersion = _parent.Version;
                }
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Replace(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterTypeDateRange.OptionsEntityArray.OptionsEntity oldItem, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterTypeDateRange.OptionsEntityArray.OptionsEntity.Source newItem)
                {
                    CheckValidInstance();
                    ...
                    var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterTypeDateRange.OptionsEntityArray.OptionsEntity>(_parent, _idx);

                    while (enumerator.MoveNext())
                    {
                        Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterTypeDateRange.OptionsEntityArray.OptionsEntity current = enumerator.Current;
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterTypeDateRange.OptionsEntityArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterTypeDateRange.OptionsEntityArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
