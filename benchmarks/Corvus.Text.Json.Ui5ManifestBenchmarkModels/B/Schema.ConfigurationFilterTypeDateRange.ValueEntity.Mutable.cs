    ...
    public readonly partial struct ConfigurationFilterTypeDateRange
    {
        ...
        public readonly partial struct ValueEntity
        {
...
#endif
            {
                ...
                /// </summary>
                public Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterTypeDateRange.ValueEntity.ValuesArray.Mutable Values
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ValuesUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterTypeDateRange.ValueEntity.ValuesArray.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetValues(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterTypeDateRange.ValueEntity.ValuesArray.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetValues<TContext>(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterTypeDateRange.ValueEntity.ValuesArray.Source<TContext> value)
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterTypeDateRange.ValueEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterTypeDateRange.ValueEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterTypeDateRange.ValueEntity.ValuesArray.Source values = default)
                {
                ...
                /// Creates an instance of a <see cref="ValueEntity"/>.
                /// </summary>
                public void Create(in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source option = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterTypeDateRange.ValueEntity.ValuesArray.Source values = default)
                {
                ...
                internal static void Create<TContext>(
                    ...
                    ref ComplexValueBuilder builder,
                    in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source option = default,
                    in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterTypeDateRange.ValueEntity.ValuesArray.Source<TContext> values = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source option = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterTypeDateRange.ValueEntity.ValuesArray.Source<TContext> values = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
