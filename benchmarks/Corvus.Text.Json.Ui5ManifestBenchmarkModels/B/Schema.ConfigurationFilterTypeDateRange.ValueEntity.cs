...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ConfigurationFilterTypeDateRange
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.JsonString Option
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OptionUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.JsonString value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterTypeDateRange.ValueEntity.ValuesArray Values
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ValuesUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterTypeDateRange.ValueEntity.ValuesArray value))
                    {
                        return value;
                    }
            ...
            {
                /// <summary>
                /// Gets the JSON property name for <see cref="Option"/>.
                /// </summary>
                public const string Option = "option";

                /// <summary>
                /// Gets the JSON property name for <see cref="Values"/>.
                /// </summary>
                ...
                /// Gets the JSON property name for <see cref="Option"/>.
                /// </summary>
                public static ReadOnlySpan<byte> OptionUtf8 => "option"u8;
            ...
            {
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="Option"/>.
                /// </summary>
                public static ReadOnlySpan<byte> Option => "option"u8;

                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="Values"/>.
                /// </summary>
