    ...
    public readonly partial struct ConfigurationFilterTypeSelect
    {
        ...
        public readonly partial struct RequiredTemplate
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterTypeSelect.RequiredTemplate.PathEntity.Mutable Path
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PathUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterTypeSelect.RequiredTemplate.PathEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterItem.Mutable Template
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TemplateUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterItem.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetPath(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterTypeSelect.RequiredTemplate.PathEntity.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetTemplate(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterItem.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetTemplate<TContext>(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterItem.Source<TContext> value)
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterTypeSelect.RequiredTemplate.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterTypeSelect.RequiredTemplate.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterItem.Source template,
                    in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterTypeSelect.RequiredTemplate.PathEntity.Source path = default)
                {
                ...
                /// Creates an instance of a <see cref="RequiredTemplate"/>.
                /// </summary>
                public void Create(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterItem.Source template, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterTypeSelect.RequiredTemplate.PathEntity.Source path = default)
                {
                ...
                internal static void Create<TContext>(
                    in TContext context,
                    ref ComplexValueBuilder builder,
                    in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterItem.Source<TContext> template,
                    in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterTypeSelect.RequiredTemplate.PathEntity.Source path = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterItem.Source template, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterTypeSelect.RequiredTemplate.PathEntity.Source path = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterItem.Source<TContext> template, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationFilterTypeSelect.RequiredTemplate.PathEntity.Source path = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
