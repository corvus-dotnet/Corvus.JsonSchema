        ...
        public readonly partial struct ActionableAreaEntity
        {
                ...
                : IJsonElement<OneOf0Entity>
            {
                ...
                private static class Constants
                {
                    ...
                    /// </summary>
                    public static readonly byte[] Enum1 = "Full"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly OneOf0Entity EnumJson1 = ParsedJsonDocument<OneOf0Entity>.StringConstant([.."\"Full\""u8]);
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly byte[] Enum2 = "Chart"u8.ToArray();
                    /// <summary>
                    /// A constant for the <c>enum</c> keyword.
                    /// </summary>
                    public static readonly OneOf0Entity EnumJson2 = ParsedJsonDocument<OneOf0Entity>.StringConstant([.."\"Chart\""u8]);
                }
                ...
                public static class EnumValues
                {
                    ...
                    /// </summary>
                    public static OneOf0Entity Full { get; } = Constants.EnumJson1;
                    /// <summary>
                    /// Gets the string "Full"
                    /// as a UTF8 byte array.
                    /// </summary>
                    public static ReadOnlySpan<byte> FullUtf8 => Constants.Enum1;

                    /// <summary>
                    /// Gets the string "Chart"
                    /// as a <see cref="OneOf0Entity"/>.
                    /// </summary>
                    public static OneOf0Entity Chart { get; } = Constants.EnumJson2;
                    /// <summary>
                    /// Gets the string "Chart"
                    /// as a UTF8 byte array.
                    /// </summary>
                    public static ReadOnlySpan<byte> ChartUtf8 => Constants.Enum2;
                }
                ...
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("ui5-manifest-schema.json#/definitions/ContentType.Analytical/properties/actionableArea/oneOf/0"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "ui5-manifest-schema.json#/definitions/ContentType.Analytical/properties/actionableArea/oneOf/0";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "ui5-manifest-schema.json#/definitions/ContentType.Analytical/properties/actionableArea/oneOf/0"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        if (tokenType == JsonTokenType.String)
                        {
                            ...
                            if (unescapedUtf8JsonString.Span.SequenceEqual("Full"u8))
                            {
                                goto enumShortCircuitSuccess;
                            }

                            if (unescapedUtf8JsonString.Span.SequenceEqual("Chart"u8))
                            {
                                goto enumShortCircuitSuccess;
                            }
                        }
