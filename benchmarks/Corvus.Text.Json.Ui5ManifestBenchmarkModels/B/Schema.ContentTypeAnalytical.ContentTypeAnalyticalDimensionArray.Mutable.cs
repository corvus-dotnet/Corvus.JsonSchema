...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ContentTypeAnalytical
    {
        ...
        public readonly partial struct ContentTypeAnalyticalDimensionArray
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ContentTypeAnalyticalDimensionArray instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ContentTypeAnalyticalDimensionArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ContentTypeAnalyticalDimensionArray(Mutable instance)
                {
                ...
                public Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalyticalDimension.Mutable this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalyticalDimension.Mutable>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalyticalDimension.Mutable> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalyticalDimension.Mutable>(_parent, _idx);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ContentTypeAnalyticalDimensionArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ContentTypeAnalyticalDimensionArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetItem(int itemIndex, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalyticalDimension.Source value)
                {
                    CheckValidInstance();
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void InsertItem(int itemIndex, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalyticalDimension.Source value)
                {
                    CheckValidInstance();
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void AddItem(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalyticalDimension.Source value)
                {
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Remove(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalyticalDimension item)
                {
                    CheckValidInstance();
                    if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalyticalDimension>(this, in item))
                    {
                        return false;
                    }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void RemoveWhere(JsonPredicate<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalyticalDimension> predicate)
                {
                    CheckValidInstance();
                    JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalyticalDimension>(this, predicate);
                    _documentVersion = _parent.Version;
                }
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Replace(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalyticalDimension oldItem, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalyticalDimension.Source newItem)
                {
                    CheckValidInstance();
                    ...
                    var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalyticalDimension>(_parent, _idx);

                    while (enumerator.MoveNext())
                    {
                        Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalyticalDimension current = enumerator.Current;
                ...
                /// <summary>
                /// Gets a <see cref="ContentTypeAnalyticalDimensionArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ContentTypeAnalyticalDimensionArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ContentTypeAnalyticalDimensionArray Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ContentTypeAnalyticalDimensionArray>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ContentTypeAnalyticalDimensionArray"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ContentTypeAnalyticalDimensionArray Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ContentTypeAnalyticalDimensionArray>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalytical.ContentTypeAnalyticalDimensionArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(ContentTypeAnalyticalDimensionArray instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalytical.ContentTypeAnalyticalDimensionArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<ContentTypeAnalyticalDimensionArray, Mutable>(this);
            }
        }
    }
}
