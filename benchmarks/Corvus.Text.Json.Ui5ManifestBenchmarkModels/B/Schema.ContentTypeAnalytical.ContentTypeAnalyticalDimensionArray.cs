...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ContentTypeAnalytical
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ContentTypeAnalyticalDimensionArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ContentTypeAnalyticalDimensionArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ContentTypeAnalyticalDimensionArray DefaultInstance { get; }
            ...
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalyticalDimension this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalyticalDimension>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalyticalDimension> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalyticalDimension>(_parent, _idx);
            }
            ...
            /// </returns>
            public static bool operator ==(in ContentTypeAnalyticalDimensionArray left, in ContentTypeAnalyticalDimensionArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ContentTypeAnalyticalDimensionArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(ContentTypeAnalyticalDimensionArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ContentTypeAnalyticalDimensionArray(JsonElement instance)
            {
                return ContentTypeAnalyticalDimensionArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ContentTypeAnalyticalDimensionArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ContentTypeAnalyticalDimensionArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ContentTypeAnalyticalDimensionArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ContentTypeAnalyticalDimensionArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ContentTypeAnalyticalDimensionArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ContentTypeAnalyticalDimensionArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ContentTypeAnalyticalDimensionArray>(json, options);
            }
            ...
            /// </exception>
            public static ContentTypeAnalyticalDimensionArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ContentTypeAnalyticalDimensionArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ContentTypeAnalyticalDimensionArray? result)
            {
                return JsonElementHelpers.TryParseValue<ContentTypeAnalyticalDimensionArray>(ref reader, out result);
            }
...
#if NET
            static ContentTypeAnalyticalDimensionArray IJsonElement<ContentTypeAnalyticalDimensionArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ContentTypeAnalyticalDimensionArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public ContentTypeAnalyticalDimensionArray Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public ContentTypeAnalyticalDimensionArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ContentTypeAnalyticalDimensionArray>(_idx);
                }
