...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ContentTypeAnalytical
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ContentTypeAnalyticalFieldArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ContentTypeAnalyticalFieldArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ContentTypeAnalyticalFieldArray DefaultInstance { get; }
            ...
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalyticalField this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalyticalField>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalyticalField> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalyticalField>(_parent, _idx);
            }
            ...
            /// </returns>
            public static bool operator ==(in ContentTypeAnalyticalFieldArray left, in ContentTypeAnalyticalFieldArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ContentTypeAnalyticalFieldArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(ContentTypeAnalyticalFieldArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ContentTypeAnalyticalFieldArray(JsonElement instance)
            {
                return ContentTypeAnalyticalFieldArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ContentTypeAnalyticalFieldArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ContentTypeAnalyticalFieldArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ContentTypeAnalyticalFieldArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ContentTypeAnalyticalFieldArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ContentTypeAnalyticalFieldArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ContentTypeAnalyticalFieldArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ContentTypeAnalyticalFieldArray>(json, options);
            }
            ...
            /// </exception>
            public static ContentTypeAnalyticalFieldArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ContentTypeAnalyticalFieldArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ContentTypeAnalyticalFieldArray? result)
            {
                return JsonElementHelpers.TryParseValue<ContentTypeAnalyticalFieldArray>(ref reader, out result);
            }
...
#if NET
            static ContentTypeAnalyticalFieldArray IJsonElement<ContentTypeAnalyticalFieldArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ContentTypeAnalyticalFieldArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public ContentTypeAnalyticalFieldArray Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public ContentTypeAnalyticalFieldArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ContentTypeAnalyticalFieldArray>(_idx);
                }
