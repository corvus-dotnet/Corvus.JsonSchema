    ...
    public readonly partial struct ContentTypeAnalytical
    {
        ...
        public readonly partial struct ExperimentalChartConfiguration
        {
...
#endif
            {
                ...
                /// <summary>
                /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalytical.ExperimentalChartConfiguration.OneOf0Entity"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalytical.ExperimentalChartConfiguration.OneOf0Entity.Mutable(Mutable value)
                {
                    return Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalytical.ExperimentalChartConfiguration.OneOf0Entity.Mutable.From(value);
                }

                /// <summary>
                /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalytical.ExperimentalChartConfiguration.OneOf0Entity"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalytical.ExperimentalChartConfiguration.OneOf0Entity.Mutable value)
                {
                    return From(value);
                }
                ...
                public static explicit operator Mutable(ExperimentalChartConfiguration instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ExperimentalChartConfiguration"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ExperimentalChartConfiguration(Mutable instance)
                {
                ...
                /// </remarks>
                public void Apply(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalytical.ExperimentalChartConfiguration.OneOf0Entity value)
                {
                    CheckValidInstance();
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ExperimentalChartConfiguration.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ExperimentalChartConfiguration Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ExperimentalChartConfiguration Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ExperimentalChartConfiguration>(_idx);
                }
                ...
                /// <param name="matchOneOf0Entity">Match a <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalytical.ExperimentalChartConfiguration.OneOf0Entity"/>.</param>
                ...
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalytical.ExperimentalChartConfiguration.OneOf0Entity, TContext, TResult> matchOneOf0Entity,
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.SimpleBinding, TContext, TResult> matchSimpleBinding,
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalytical.ExperimentalChartConfiguration.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalytical.ExperimentalChartConfiguration.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchOneOf0Entity(Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalytical.ExperimentalChartConfiguration.OneOf0Entity.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalytical.ExperimentalChartConfiguration.OneOf0Entity, TResult> matchOneOf0Entity,
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.SimpleBinding, TResult> matchSimpleBinding,
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalytical.ExperimentalChartConfiguration.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalytical.ExperimentalChartConfiguration.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchOneOf0Entity(Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalytical.ExperimentalChartConfiguration.OneOf0Entity.Mutable.From(this));
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalytical.ExperimentalChartConfiguration.OneOf0Entity" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsOneOf0Entity(out Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalytical.ExperimentalChartConfiguration.OneOf0Entity result)
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalytical.ExperimentalChartConfiguration.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalytical.ExperimentalChartConfiguration.OneOf0Entity.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalytical.ExperimentalChartConfiguration.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(ExperimentalChartConfiguration instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalytical.ExperimentalChartConfiguration.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<ExperimentalChartConfiguration, Mutable>(this);
            }
        }
    }
}
