        ...
        public readonly partial struct PopoverEntity
        {
            ...
            public readonly partial struct ActiveEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalytical.PopoverEntity.ActiveEntity.OneOf0Entity.Mutable(Mutable value)
                    {
                        return Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalytical.PopoverEntity.ActiveEntity.OneOf0Entity.Mutable.From(value);
                    }
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalytical.PopoverEntity.ActiveEntity.OneOf0Entity.Mutable value)
                    {
                        return From(value);
                    }
                    ...
                    public static explicit operator Mutable(ActiveEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ActiveEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ActiveEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ActiveEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ActiveEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ActiveEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ActiveEntity>(_idx);
                    }
                    ...
                    public TResult Match<TContext, TResult>(
                        ...
                        Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalytical.PopoverEntity.ActiveEntity.Mutable, TContext, TResult> defaultMatch)
...
#endif
                    {
                        ...
                        {
                            return matchOneOf0Entity(Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalytical.PopoverEntity.ActiveEntity.OneOf0Entity.Mutable.From(this), context);
                        }
                    ...
                    public TResult Match<TResult>(
                        ...
                        Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalytical.PopoverEntity.ActiveEntity.Mutable, TResult> defaultMatch)
                    {
                        if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalytical.PopoverEntity.ActiveEntity.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                        {
                            return matchOneOf0Entity(Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalytical.PopoverEntity.ActiveEntity.OneOf0Entity.Mutable.From(this));
                        }
                    ...
                    public bool TryGetAsOneOf0Entity(out Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalytical.PopoverEntity.ActiveEntity.OneOf0Entity result)
                    {
                        if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalytical.PopoverEntity.ActiveEntity.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                        {
                            result = Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalytical.PopoverEntity.ActiveEntity.OneOf0Entity.Mutable.From(this);
                            return true;
                        }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(ActiveEntity instance) => new(JsonElement.From(instance));
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalytical.PopoverEntity.ActiveEntity.OneOf0Entity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<ActiveEntity, Mutable>(this);
                }
            }
        }
    }
