    ...
    public readonly partial struct ContentTypeAnalytical
    {
        ...
        public readonly partial struct PopoverEntity
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalytical.PopoverEntity.ActiveEntity.Mutable Active
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ActiveUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalytical.PopoverEntity.ActiveEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetActive(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalytical.PopoverEntity.ActiveEntity.Source value)
                {
                    CheckValidInstance();
                    ...
                    else
                    {
                        ...
                        value.AddAsProperty(JsonPropertyNamesEscaped.Active, ref cvb, escapeName: false, nameRequiresUnescaping: false);
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalytical.PopoverEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalytical.PopoverEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalytical.PopoverEntity.ActiveEntity.Source active = default)
                {
                    active.AddAsProperty(JsonPropertyNamesEscaped.Active, ref builder, escapeName: false);
                }

                /// <summary>
                /// Creates an instance of a <see cref="PopoverEntity"/>.
                /// </summary>
                public void Create(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalytical.PopoverEntity.ActiveEntity.Source active = default)
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalytical.PopoverEntity.ActiveEntity.Source active = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
