...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ContentTypeAnalyticalDataLabel
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.Visibility.Mutable ShowTotal
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ShowTotalUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.Visibility.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetShowTotal(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Visibility.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalyticalDataLabel.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalyticalDataLabel.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Visibility.Source showTotal = default,
            ...
            /// Creates an instance of a <see cref="ContentTypeAnalyticalDataLabel"/>.
            /// </summary>
            public void Create(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Visibility.Source showTotal = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Visibility.Source visible = default)
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Visibility.Source showTotal = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Visibility.Source visible = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
