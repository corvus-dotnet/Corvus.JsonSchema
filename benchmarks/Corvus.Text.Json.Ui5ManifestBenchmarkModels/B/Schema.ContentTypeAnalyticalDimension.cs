...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ContentTypeAnalyticalDimension"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ContentTypeAnalyticalDimension(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ContentTypeAnalyticalDimension DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalyticalDimension.DataTypeEntity DataType
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DataTypeUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalyticalDimension.DataTypeEntity value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in ContentTypeAnalyticalDimension left, in ContentTypeAnalyticalDimension right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ContentTypeAnalyticalDimension left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(ContentTypeAnalyticalDimension instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ContentTypeAnalyticalDimension(JsonElement instance)
        {
            return ContentTypeAnalyticalDimension.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ContentTypeAnalyticalDimension From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ContentTypeAnalyticalDimension ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ContentTypeAnalyticalDimension>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ContentTypeAnalyticalDimension ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ContentTypeAnalyticalDimension>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ContentTypeAnalyticalDimension ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ContentTypeAnalyticalDimension>(json, options);
        }
        ...
        /// </exception>
        public static ContentTypeAnalyticalDimension ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ContentTypeAnalyticalDimension>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ContentTypeAnalyticalDimension? result)
        {
            return JsonElementHelpers.TryParseValue<ContentTypeAnalyticalDimension>(ref reader, out result);
        }
...
#if NET
        static ContentTypeAnalyticalDimension IJsonElement<ContentTypeAnalyticalDimension>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ContentTypeAnalyticalDimension: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public ContentTypeAnalyticalDimension Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public ContentTypeAnalyticalDimension Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ContentTypeAnalyticalDimension>(_idx);
            }
        ...
        {
            /// <summary>
            /// Gets the JSON property name for <see cref="DataType"/>.
            /// </summary>
        ...
        {
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="DataType"/>.
            /// </summary>
