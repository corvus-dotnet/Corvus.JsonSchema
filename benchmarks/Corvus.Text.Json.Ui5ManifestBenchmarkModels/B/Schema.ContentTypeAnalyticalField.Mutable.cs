...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ContentTypeAnalyticalField
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ContentTypeAnalyticalField instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ContentTypeAnalyticalField"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ContentTypeAnalyticalField(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalyticalField.TheTypeOfTheFeed.Mutable Type
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalyticalField.TheTypeOfTheFeed.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Mutable Uid
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UidUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalyticalField.JsonStringArray.Mutable Values
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ValuesUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalyticalField.JsonStringArray.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ContentTypeAnalyticalField(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetType(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalyticalField.TheTypeOfTheFeed.Source value)
            {
                CheckValidInstance();
            ...
            /// <summary>
            /// Set the <c>uid</c> property.
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetUid(in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.UidUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UidUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsProperty(JsonPropertyNamesEscaped.Uid, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// <summary>
            /// Remove the <c>uid</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveUid()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.UidUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetValues(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalyticalField.JsonStringArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetValues<TContext>(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalyticalField.JsonStringArray.Source<TContext> value)
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ContentTypeAnalyticalField.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ContentTypeAnalyticalField"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ContentTypeAnalyticalField"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly ContentTypeAnalyticalField Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ContentTypeAnalyticalField>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ContentTypeAnalyticalField"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly ContentTypeAnalyticalField Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ContentTypeAnalyticalField>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalyticalField.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(ContentTypeAnalyticalField instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalyticalField.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="ContentTypeAnalyticalField"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalyticalField.TheTypeOfTheFeed.Source type = default,
                in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source uid = default,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalyticalField.JsonStringArray.Source values = default)
            {
                type.AddAsProperty(JsonPropertyNamesEscaped.Type, ref builder, escapeName: false);
                uid.AddAsProperty(JsonPropertyNamesEscaped.Uid, ref builder, escapeName: false);
            ...
            public void Create(
                ...
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalyticalField.JsonStringArray.Source values = default)
            {
                Create(ref _builder, type, uid, values);
            }
            ...
            internal static void Create<TContext>(
                ...
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalyticalField.TheTypeOfTheFeed.Source type = default,
                in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source uid = default,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalyticalField.JsonStringArray.Source<TContext> values = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            #endif
            {
                Create(context, ref _builder, type, uid, values);
            }
        ...
        /// <param name="uid">The value of the property.</param>
        /// <param name="values">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalyticalField.TheTypeOfTheFeed.Source type = default, in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source uid = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalyticalField.JsonStringArray.Source values = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(type, uid, values);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalyticalField.TheTypeOfTheFeed.Source type = default, in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source uid = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalyticalField.JsonStringArray.Source<TContext> values = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            ...
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(context, type, uid, values);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<ContentTypeAnalyticalField, Mutable>(this);
        }
    }
}
