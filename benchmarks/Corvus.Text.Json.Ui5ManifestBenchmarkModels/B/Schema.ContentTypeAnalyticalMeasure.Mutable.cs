...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ContentTypeAnalyticalMeasure
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ContentTypeAnalyticalMeasure instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ContentTypeAnalyticalMeasure"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ContentTypeAnalyticalMeasure(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ContentTypeAnalyticalMeasure(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ContentTypeAnalyticalMeasure.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ContentTypeAnalyticalMeasure"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ContentTypeAnalyticalMeasure"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly ContentTypeAnalyticalMeasure Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ContentTypeAnalyticalMeasure>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ContentTypeAnalyticalMeasure"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly ContentTypeAnalyticalMeasure Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ContentTypeAnalyticalMeasure>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalyticalMeasure.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(ContentTypeAnalyticalMeasure instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeAnalyticalMeasure.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="ContentTypeAnalyticalMeasure"/>.
            /// </summary>
            ...
            public void Create(
                ...
                in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source value = default)
            {
                Create(ref _builder, label, name, value);
            }
        ...
        {
            return workspace.CreateBuilder<ContentTypeAnalyticalMeasure, Mutable>(this);
        }
    }
}
