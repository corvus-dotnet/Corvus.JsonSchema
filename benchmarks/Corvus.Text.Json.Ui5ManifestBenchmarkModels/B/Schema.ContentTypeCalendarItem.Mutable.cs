...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ContentTypeCalendarItem
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ContentTypeCalendarItem instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ContentTypeCalendarItem"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ContentTypeCalendarItem(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeCalendarItemTemplate.Mutable Template
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TemplateUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeCalendarItemTemplate.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ContentTypeCalendarItem(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetTemplate(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeCalendarItemTemplate.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetTemplate<TContext>(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeCalendarItemTemplate.Source<TContext> value)
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ContentTypeCalendarItem.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ContentTypeCalendarItem"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ContentTypeCalendarItem"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly ContentTypeCalendarItem Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ContentTypeCalendarItem>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ContentTypeCalendarItem"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly ContentTypeCalendarItem Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ContentTypeCalendarItem>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeCalendarItem.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(ContentTypeCalendarItem instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeCalendarItem.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="ContentTypeCalendarItem"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source path = default,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeCalendarItemTemplate.Source template = default)
            {
            ...
            /// Creates an instance of a <see cref="ContentTypeCalendarItem"/>.
            /// </summary>
            public void Create(in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source path = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeCalendarItemTemplate.Source template = default)
            {
            ...
            internal static void Create<TContext>(
                ...
                ref ComplexValueBuilder builder,
                in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source path = default,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeCalendarItemTemplate.Source<TContext> template = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source path = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeCalendarItemTemplate.Source template = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        {
            return workspace.CreateBuilder<ContentTypeCalendarItem, Mutable>(this);
        }
    }
}
