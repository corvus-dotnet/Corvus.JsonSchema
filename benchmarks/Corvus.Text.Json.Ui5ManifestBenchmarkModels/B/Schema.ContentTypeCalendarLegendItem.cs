...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ContentTypeCalendarLegendItem"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ContentTypeCalendarLegendItem(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ContentTypeCalendarLegendItem DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeCalendarLegendItemTemplate Template
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TemplateUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeCalendarLegendItemTemplate value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in ContentTypeCalendarLegendItem left, in ContentTypeCalendarLegendItem right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ContentTypeCalendarLegendItem left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(ContentTypeCalendarLegendItem instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ContentTypeCalendarLegendItem(JsonElement instance)
        {
            return ContentTypeCalendarLegendItem.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ContentTypeCalendarLegendItem From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ContentTypeCalendarLegendItem ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ContentTypeCalendarLegendItem>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ContentTypeCalendarLegendItem ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ContentTypeCalendarLegendItem>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ContentTypeCalendarLegendItem ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ContentTypeCalendarLegendItem>(json, options);
        }
        ...
        /// </exception>
        public static ContentTypeCalendarLegendItem ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ContentTypeCalendarLegendItem>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ContentTypeCalendarLegendItem? result)
        {
            return JsonElementHelpers.TryParseValue<ContentTypeCalendarLegendItem>(ref reader, out result);
        }
...
#if NET
        static ContentTypeCalendarLegendItem IJsonElement<ContentTypeCalendarLegendItem>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ContentTypeCalendarLegendItem: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public ContentTypeCalendarLegendItem Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public ContentTypeCalendarLegendItem Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ContentTypeCalendarLegendItem>(_idx);
            }
