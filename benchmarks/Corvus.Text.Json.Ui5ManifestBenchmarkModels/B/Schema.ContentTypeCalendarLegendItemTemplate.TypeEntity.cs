...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ContentTypeCalendarLegendItemTemplate
    {
...
#endif
        {
            ...
            /// <summary>
            /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeCalendarLegendItemTemplate.TypeEntity.OneOf0Entity"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeCalendarLegendItemTemplate.TypeEntity.OneOf0Entity(TypeEntity value)
            {
                return Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeCalendarLegendItemTemplate.TypeEntity.OneOf0Entity.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeCalendarLegendItemTemplate.TypeEntity.OneOf0Entity"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator TypeEntity(Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeCalendarLegendItemTemplate.TypeEntity.OneOf0Entity value)
            {
                return From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.Schema.SimpleBinding(TypeEntity value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator TypeEntity(Corvus.Ui5ManifestBenchmark.Baseline.Schema.SimpleBinding value)
            {
                return From(value);
            }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeCalendarLegendItemTemplate.TypeEntity.OneOf0Entity" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsOneOf0Entity(out Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeCalendarLegendItemTemplate.TypeEntity.OneOf0Entity result)
            {
                if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeCalendarLegendItemTemplate.TypeEntity.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeCalendarLegendItemTemplate.TypeEntity.OneOf0Entity.From(this);
                    return true;
                }
            ...
            /// <param name="matchOneOf0Entity">Match a <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeCalendarLegendItemTemplate.TypeEntity.OneOf0Entity"/>.</param>
            ...
            public TResult Match<TContext, TResult>(
                in TContext context,
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeCalendarLegendItemTemplate.TypeEntity.OneOf0Entity, TContext, TResult> matchOneOf0Entity,
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.SimpleBinding, TContext, TResult> matchSimpleBinding,
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeCalendarLegendItemTemplate.TypeEntity, TContext, TResult> defaultMatch)
...
#endif
            {
                if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeCalendarLegendItemTemplate.TypeEntity.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchOneOf0Entity(Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeCalendarLegendItemTemplate.TypeEntity.OneOf0Entity.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeCalendarLegendItemTemplate.TypeEntity.OneOf0Entity, TResult> matchOneOf0Entity,
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.SimpleBinding, TResult> matchSimpleBinding,
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeCalendarLegendItemTemplate.TypeEntity, TResult> defaultMatch)
            {
                if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeCalendarLegendItemTemplate.TypeEntity.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchOneOf0Entity(Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeCalendarLegendItemTemplate.TypeEntity.OneOf0Entity.From(this));
                }
