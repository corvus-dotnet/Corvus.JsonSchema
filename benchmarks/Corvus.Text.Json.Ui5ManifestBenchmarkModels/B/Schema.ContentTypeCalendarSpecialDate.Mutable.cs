...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ContentTypeCalendarSpecialDate
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeCalendarSpecialDateTemplate.Mutable Template
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TemplateUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeCalendarSpecialDateTemplate.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetTemplate(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeCalendarSpecialDateTemplate.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetTemplate<TContext>(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeCalendarSpecialDateTemplate.Source<TContext> value)
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeCalendarSpecialDate.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeCalendarSpecialDate.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeCalendarSpecialDateTemplate.Source template = default)
            {
            ...
            /// Creates an instance of a <see cref="ContentTypeCalendarSpecialDate"/>.
            /// </summary>
            public void Create(in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source path = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeCalendarSpecialDateTemplate.Source template = default)
            {
            ...
            internal static void Create<TContext>(
                ...
                ref ComplexValueBuilder builder,
                in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source path = default,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeCalendarSpecialDateTemplate.Source<TContext> template = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source path = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeCalendarSpecialDateTemplate.Source template = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
