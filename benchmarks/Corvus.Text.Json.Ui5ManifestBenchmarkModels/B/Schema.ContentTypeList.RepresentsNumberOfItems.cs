...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ContentTypeList
    {
...
#endif
        {
            ...
            public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.Schema.SimpleBinding(RepresentsNumberOfItems value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator RepresentsNumberOfItems(Corvus.Ui5ManifestBenchmark.Baseline.Schema.SimpleBinding value)
            {
                return From(value);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeList.RepresentsNumberOfItems, TContext, TResult> defaultMatch)
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeList.RepresentsNumberOfItems, TResult> defaultMatch)
            {
                if (Corvus.Ui5ManifestBenchmark.Baseline.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                {
