...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ContentTypeListItem
    {
        ...
        /// </para>
        /// </remarks>
        public readonly partial struct DefinesTheLayoutTypeOfTheAttributes
        {
            /// <summary>
            /// Generated from JSON Schema.
            /// </summary>
...
#endif
            {
                ...
                /// </summary>
                public static OneOf0Entity DefaultInstance { get; } = ParsedJsonDocument<OneOf0Entity>.StringConstant([.."\"TwoColumns\""u8]);
                ...
                /// <param name="matchOneColumn">Match 1st item.</param>
                /// <param name="matchTwoColumns">Match 2nd item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> matchOneColumn,
                    Func<TContext, TResult> matchTwoColumns,
...
#endif
                {
                    ...
                    {
                        return matchOneColumn(context);
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchTwoColumns(context);
                    }
                ...
                public TResult Match<TResult>(
                    Func<TResult> matchOneColumn,
                    Func<TResult> matchTwoColumns,
                    Func<TResult> defaultMatch)
                {
                    if (this.ValueEquals(Constants.Enum1))
                    {
                        return matchOneColumn();
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchTwoColumns();
                    }
