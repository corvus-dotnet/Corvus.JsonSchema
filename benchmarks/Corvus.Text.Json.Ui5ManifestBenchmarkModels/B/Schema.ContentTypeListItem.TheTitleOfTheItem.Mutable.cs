    ...
    public readonly partial struct ContentTypeListItem
    {
        ...
        public readonly partial struct TheTitleOfTheItem
        {
...
#endif
            {
                ...
                public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.Schema.Field.Mutable(Mutable value)
                {
                    return Corvus.Ui5ManifestBenchmark.Baseline.Schema.Field.Mutable.From(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Baseline.Schema.Field.Mutable value)
                {
                    return From(value);
                }
                ...
                public static explicit operator Mutable(TheTitleOfTheItem instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TheTitleOfTheItem"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TheTitleOfTheItem(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TheTitleOfTheItem.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly TheTitleOfTheItem Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly TheTitleOfTheItem Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TheTitleOfTheItem>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeListItem.TheTitleOfTheItem.Mutable, TContext, TResult> defaultMatch)
...
#endif
                {
                    ...
                    {
                        return matchField(Corvus.Ui5ManifestBenchmark.Baseline.Schema.Field.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeListItem.TheTitleOfTheItem.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.Field.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchField(Corvus.Ui5ManifestBenchmark.Baseline.Schema.Field.Mutable.From(this));
                    }
                ...
                public bool TryGetAsField(out Corvus.Ui5ManifestBenchmark.Baseline.Schema.Field result)
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.Field.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.Ui5ManifestBenchmark.Baseline.Schema.Field.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.Ui5ManifestBenchmark.Baseline.Schema.Field.Builder.Build? _fieldBuilderInstance;
                ...
                public Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.Field.Builder.Build value) {_fieldBuilderInstance = value; _kind = Kind.FieldBuilder; }

                public static implicit operator Source(TheTitleOfTheItem instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.Field instance) => new(JsonElement.From(instance));
                ...
                internal void AddAsProperty(ReadOnlySpan<byte> utf8Name, ref ComplexValueBuilder valueBuilder, bool escapeName = true, bool nameRequiresUnescaping = false)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.FieldBuilder:
                            valueBuilder.AddProperty(utf8Name, _fieldBuilderInstance!, static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Baseline.Schema.Field.Builder.BuildValue(b, ref o), escapeName, nameRequiresUnescaping);
                            break;
                        default:
                ...
                internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.Utf16String:
                            ...
                            break;
                        case Kind.FieldBuilder:
                            valueBuilder.AddProperty(name, _fieldBuilderInstance!, static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Baseline.Schema.Field.Builder.BuildValue(b, ref o));
                            break;
                        default:
                            Debug.Fail("Unexpected Kind");
                            break;
                ...
                internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.Utf16String:
                            ...
                            break;
                        case Kind.FieldBuilder:
                            valueBuilder.AddItem(_fieldBuilderInstance!, static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Baseline.Schema.Field.Builder.BuildValue(b, ref o));
                            break;
                        default:
                            Debug.Fail("Unexpected Kind");
                            break;
                ...
                #endif
            {
                ...
                TContext _context;
                Source _source;
                private readonly Corvus.Ui5ManifestBenchmark.Baseline.Schema.Field.Builder.Build<TContext>? _fieldBuilderInstance;
                ...
                public Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.Field.Builder.Build<TContext> value) {_context = context; _fieldBuilderInstance = value; _kind = Kind.FieldBuilder; }
                ...
                internal void AddAsProperty(ReadOnlySpan<byte> utf8Name, ref ComplexValueBuilder valueBuilder, bool escapeName = true, bool nameRequiresUnescaping = false)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.Source:
                            ...
                            break;
                        case Kind.FieldBuilder:
                            valueBuilder.AddProperty(utf8Name, BuildWithContext.Create(_context, _fieldBuilderInstance!), static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Baseline.Schema.Field.Builder.BuildValue(b.Context, b.Build, ref o), escapeName, nameRequiresUnescaping);
                            break;
                        default:
                            Debug.Fail("Unexpected Kind");
                            break;
                ...
                internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.Source:
                            ...
                            break;
                        case Kind.FieldBuilder:
                            valueBuilder.AddProperty(name, BuildWithContext.Create(_context, _fieldBuilderInstance!), static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Baseline.Schema.Field.Builder.BuildValue(b.Context, b.Build, ref o));
                            break;
                        default:
                            Debug.Fail("Unexpected Kind");
                            break;
                ...
                internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.Source:
                            ...
                            break;
                        case Kind.FieldBuilder:
                            valueBuilder.AddItem(BuildWithContext.Create(_context, _fieldBuilderInstance!), static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Baseline.Schema.Field.Builder.BuildValue(b.Context, b.Build, ref o));
                            break;
                        default:
                            Debug.Fail("Unexpected Kind");
                            break;
            ...
            public static Corvus.Ui5ManifestBenchmark.Baseline.Schema.Field.Source Build(
                scoped in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Field.Builder.Build buildValue, int initialCapacity = 1)
            {
                return new Corvus.Ui5ManifestBenchmark.Baseline.Schema.Field.Source(buildValue);
            }
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Corvus.Ui5ManifestBenchmark.Baseline.Schema.Field.Source<TContext> Build<TContext>(
                scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Field.Builder.Build<TContext> buildValue, int initialCapacity = 1)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                return new Corvus.Ui5ManifestBenchmark.Baseline.Schema.Field.Source<TContext>(context, buildValue);
            }
            ...
            /// <returns>An instance of a mutable document initialized with the given value.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(
                JsonWorkspace workspace, scoped in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Field.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
            {
                // Create the document builder without a MetadataDb
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                var source = new Corvus.Ui5ManifestBenchmark.Baseline.Schema.Field.Source(value);
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(
                JsonWorkspace workspace, scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Field.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                ...
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                var source = new Corvus.Ui5ManifestBenchmark.Baseline.Schema.Field.Source<TContext>(context, value);
                source.AddAsItem(ref cvb);
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<TheTitleOfTheItem, Mutable>(this);
            }
        }
    }
}
