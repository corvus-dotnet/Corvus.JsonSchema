        ...
        public readonly partial struct RepresentsFlagForNoData
        {
            ...
            public readonly partial struct OneOf2Array
            {
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObject.RepresentsFlagForNoData.OneOf2Array.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObject.RepresentsFlagForNoData.OneOf2Array.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
