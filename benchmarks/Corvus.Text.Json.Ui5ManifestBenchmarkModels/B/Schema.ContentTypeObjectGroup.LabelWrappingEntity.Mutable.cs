...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ContentTypeObjectGroup
    {
        ...
        public readonly partial struct LabelWrappingEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(LabelWrappingEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="LabelWrappingEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator LabelWrappingEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new LabelWrappingEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"LabelWrappingEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="LabelWrappingEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="LabelWrappingEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly LabelWrappingEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<LabelWrappingEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="LabelWrappingEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly LabelWrappingEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<LabelWrappingEntity>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectGroup.LabelWrappingEntity.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectGroup.LabelWrappingEntity.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(LabelWrappingEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<LabelWrappingEntity, Mutable>(this);
            }
        }
    }
}
