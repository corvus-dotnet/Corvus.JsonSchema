    ...
    public readonly partial struct ContentTypeObjectItem
    {
        ...
        public readonly partial struct BindingInfoForComboBoxItems
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(BindingInfoForComboBoxItems instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="BindingInfoForComboBoxItems"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator BindingInfoForComboBoxItems(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItem.BindingInfoForComboBoxItems.PathEntity.Mutable Path
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PathUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItem.BindingInfoForComboBoxItems.PathEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItemComboBoxItemTemplate.Mutable Template
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TemplateUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItemComboBoxItemTemplate.Mutable value))
                        {
                            return value;
                        }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new BindingInfoForComboBoxItems(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                public void SetPath(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItem.BindingInfoForComboBoxItems.PathEntity.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetTemplate(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItemComboBoxItemTemplate.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetTemplate<TContext>(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItemComboBoxItemTemplate.Source<TContext> value)
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"BindingInfoForComboBoxItems.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="BindingInfoForComboBoxItems"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="BindingInfoForComboBoxItems"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly BindingInfoForComboBoxItems Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<BindingInfoForComboBoxItems>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="BindingInfoForComboBoxItems"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly BindingInfoForComboBoxItems Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<BindingInfoForComboBoxItems>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItem.BindingInfoForComboBoxItems.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(BindingInfoForComboBoxItems instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItem.BindingInfoForComboBoxItems.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="BindingInfoForComboBoxItems"/>.
                /// </summary>
                internal static void Create(
                    ref ComplexValueBuilder builder,
                    in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItemComboBoxItemTemplate.Source template,
                    in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItem.BindingInfoForComboBoxItems.PathEntity.Source path = default)
                {
                ...
                /// Creates an instance of a <see cref="BindingInfoForComboBoxItems"/>.
                /// </summary>
                public void Create(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItemComboBoxItemTemplate.Source template, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItem.BindingInfoForComboBoxItems.PathEntity.Source path = default)
                {
                    Create(ref _builder, template, path);
                }
                ...
                internal static void Create<TContext>(
                    in TContext context,
                    ref ComplexValueBuilder builder,
                    in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItemComboBoxItemTemplate.Source<TContext> template,
                    in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItem.BindingInfoForComboBoxItems.PathEntity.Source path = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                ...
                #endif
                {
                    Create(context, ref _builder, template, path);
                }
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItemComboBoxItemTemplate.Source template, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItem.BindingInfoForComboBoxItems.PathEntity.Source path = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(template, path);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItemComboBoxItemTemplate.Source<TContext> template, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItem.BindingInfoForComboBoxItems.PathEntity.Source path = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                ...
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(context, template, path);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<BindingInfoForComboBoxItems, Mutable>(this);
            }
        }
    }
}
