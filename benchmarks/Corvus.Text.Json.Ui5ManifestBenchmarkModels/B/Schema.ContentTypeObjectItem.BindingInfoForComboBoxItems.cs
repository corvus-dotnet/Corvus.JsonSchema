...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ContentTypeObjectItem
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="BindingInfoForComboBoxItems"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal BindingInfoForComboBoxItems(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static BindingInfoForComboBoxItems DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItem.BindingInfoForComboBoxItems.PathEntity Path
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PathUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItem.BindingInfoForComboBoxItems.PathEntity value))
                    {
                        return value;
                    }

                    return Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItem.BindingInfoForComboBoxItems.PathEntity.DefaultInstance;
                }
            }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItemComboBoxItemTemplate Template
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TemplateUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItemComboBoxItemTemplate value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in BindingInfoForComboBoxItems left, in BindingInfoForComboBoxItems right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in BindingInfoForComboBoxItems left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(BindingInfoForComboBoxItems instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator BindingInfoForComboBoxItems(JsonElement instance)
            {
                return BindingInfoForComboBoxItems.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static BindingInfoForComboBoxItems From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static BindingInfoForComboBoxItems ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<BindingInfoForComboBoxItems>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static BindingInfoForComboBoxItems ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<BindingInfoForComboBoxItems>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static BindingInfoForComboBoxItems ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<BindingInfoForComboBoxItems>(json, options);
            }
            ...
            /// </exception>
            public static BindingInfoForComboBoxItems ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<BindingInfoForComboBoxItems>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out BindingInfoForComboBoxItems? result)
            {
                return JsonElementHelpers.TryParseValue<BindingInfoForComboBoxItems>(ref reader, out result);
            }
...
#if NET
            static BindingInfoForComboBoxItems IJsonElement<BindingInfoForComboBoxItems>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"BindingInfoForComboBoxItems: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public BindingInfoForComboBoxItems Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public BindingInfoForComboBoxItems Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<BindingInfoForComboBoxItems>(_idx);
                }
