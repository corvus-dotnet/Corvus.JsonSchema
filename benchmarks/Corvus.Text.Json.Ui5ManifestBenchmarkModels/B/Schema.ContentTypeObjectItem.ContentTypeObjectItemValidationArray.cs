...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ContentTypeObjectItem
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ContentTypeObjectItemValidationArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ContentTypeObjectItemValidationArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ContentTypeObjectItemValidationArray DefaultInstance { get; }
            ...
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItemValidation this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItemValidation>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItemValidation> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItemValidation>(_parent, _idx);
            }
            ...
            /// </returns>
            public static bool operator ==(in ContentTypeObjectItemValidationArray left, in ContentTypeObjectItemValidationArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ContentTypeObjectItemValidationArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(ContentTypeObjectItemValidationArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ContentTypeObjectItemValidationArray(JsonElement instance)
            {
                return ContentTypeObjectItemValidationArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ContentTypeObjectItemValidationArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ContentTypeObjectItemValidationArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ContentTypeObjectItemValidationArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ContentTypeObjectItemValidationArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ContentTypeObjectItemValidationArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ContentTypeObjectItemValidationArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ContentTypeObjectItemValidationArray>(json, options);
            }
            ...
            /// </exception>
            public static ContentTypeObjectItemValidationArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ContentTypeObjectItemValidationArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ContentTypeObjectItemValidationArray? result)
            {
                return JsonElementHelpers.TryParseValue<ContentTypeObjectItemValidationArray>(ref reader, out result);
            }
...
#if NET
            static ContentTypeObjectItemValidationArray IJsonElement<ContentTypeObjectItemValidationArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ContentTypeObjectItemValidationArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public ContentTypeObjectItemValidationArray Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public ContentTypeObjectItemValidationArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ContentTypeObjectItemValidationArray>(_idx);
                }
