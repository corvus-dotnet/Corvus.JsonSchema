    ...
    public readonly partial struct ContentTypeObjectItem
    {
        ...
        public readonly partial struct DefinesIfADefaultStateIconIsShown
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(DefinesIfADefaultStateIconIsShown instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DefinesIfADefaultStateIconIsShown"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DefinesIfADefaultStateIconIsShown(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DefinesIfADefaultStateIconIsShown.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly DefinesIfADefaultStateIconIsShown Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly DefinesIfADefaultStateIconIsShown Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DefinesIfADefaultStateIconIsShown>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItem.DefinesIfADefaultStateIconIsShown.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItem.DefinesIfADefaultStateIconIsShown.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(DefinesIfADefaultStateIconIsShown instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<DefinesIfADefaultStateIconIsShown, Mutable>(this);
            }
        }
    }
}
