...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ContentTypeObjectItem
    {
...
#endif
        {
            ...
            public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.Schema.SimpleBinding(MaximumNumberOfLines value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator MaximumNumberOfLines(Corvus.Ui5ManifestBenchmark.Baseline.Schema.SimpleBinding value)
            {
                return From(value);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItem.MaximumNumberOfLines, TContext, TResult> defaultMatch)
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItem.MaximumNumberOfLines, TResult> defaultMatch)
            {
                if (Corvus.Ui5ManifestBenchmark.Baseline.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                {
