    ...
    public readonly partial struct ContentTypeObjectItem
    {
        ...
        public readonly partial struct RepresentsTheTextWhichIsAssociatedWithTheLabel
        {
...
#endif
            {
                ...
                /// </summary>
                public Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItem.RepresentsTheTextWhichIsAssociatedWithTheLabel.OneOf2Entity.ValuesArray Values
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ValuesUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItem.RepresentsTheTextWhichIsAssociatedWithTheLabel.OneOf2Entity.ValuesArray value))
                        {
                            return value;
                        }
