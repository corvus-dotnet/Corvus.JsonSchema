    ...
    public readonly partial struct ContentTypeObjectItem
    {
        ...
        public readonly partial struct TypeEntity
        {
...
#endif
            {
                ...
                /// </summary>
                public static OneOf0Entity DefaultInstance { get; } = ParsedJsonDocument<OneOf0Entity>.StringConstant([.."\"Default\""u8]);
                ...
                /// <param name="matchNumericData">Match 2nd item.</param>
                /// <param name="matchStatus">Match 3rd item.</param>
                /// <param name="matchIconGroup">Match 4th item.</param>
                /// <param name="matchComboBox">Match 5th item.</param>
                /// <param name="matchTextArea">Match 6th item.</param>
                /// <param name="matchInput">Match 7th item.</param>
                /// <param name="matchDuration">Match 8th item.</param>
                /// <param name="matchDateRange">Match 9th item.</param>
                /// <param name="matchRatingIndicator">Match 10th item.</param>
                /// <param name="matchPhone">Match 11th item.</param>
                /// <param name="matchEmail">Match 12th item.</param>
                /// <param name="matchLink">Match 13th item.</param>
                /// <param name="matchText">Match 14th item.</param>
                /// <param name="matchImage">Match 15th item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> matchDefault,
                    Func<TContext, TResult> matchNumericData,
                    Func<TContext, TResult> matchStatus,
                    Func<TContext, TResult> matchIconGroup,
                    Func<TContext, TResult> matchComboBox,
                    Func<TContext, TResult> matchTextArea,
                    Func<TContext, TResult> matchInput,
                    Func<TContext, TResult> matchDuration,
                    Func<TContext, TResult> matchDateRange,
                    Func<TContext, TResult> matchRatingIndicator,
                    Func<TContext, TResult> matchPhone,
                    Func<TContext, TResult> matchEmail,
                    Func<TContext, TResult> matchLink,
...
#endif
                {
                    ...
                    {
                        return matchNumericData(context);
                    }
                    ...
                    {
                        return matchRatingIndicator(context);
                    }

                    if (this.ValueEquals(Constants.Enum11))
                    {
                        return matchPhone(context);
                    }
                ...
                public TResult Match<TResult>(
                    ...
                    Func<TResult> matchNumericData,
                    Func<TResult> matchStatus,
                    Func<TResult> matchIconGroup,
                    Func<TResult> matchComboBox,
                    Func<TResult> matchTextArea,
                    Func<TResult> matchInput,
                    Func<TResult> matchDuration,
                    Func<TResult> matchDateRange,
                    Func<TResult> matchRatingIndicator,
                    Func<TResult> matchPhone,
                    Func<TResult> matchEmail,
                    Func<TResult> matchLink,
