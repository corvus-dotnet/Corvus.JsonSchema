...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ContentTypeObjectItem
    {
...
#endif
        {
            ...
            public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItem.TypeEntity.OneOf0Entity(TypeEntity value)
            {
                return Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItem.TypeEntity.OneOf0Entity.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator TypeEntity(Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItem.TypeEntity.OneOf0Entity value)
            {
                return From(value);
            }
            ...
            public bool TryGetAsOneOf0Entity(out Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItem.TypeEntity.OneOf0Entity result)
            {
                ...
                {
                    result = Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItem.TypeEntity.OneOf0Entity.From(this);
                    return true;
                }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItem.TypeEntity, TContext, TResult> defaultMatch)
...
#endif
            {
                if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItem.TypeEntity.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchOneOf0Entity(Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItem.TypeEntity.OneOf0Entity.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItem.TypeEntity, TResult> defaultMatch)
            {
                if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItem.TypeEntity.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchOneOf0Entity(Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItem.TypeEntity.OneOf0Entity.From(this));
                }
