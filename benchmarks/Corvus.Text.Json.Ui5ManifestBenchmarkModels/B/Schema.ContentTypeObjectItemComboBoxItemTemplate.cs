...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ContentTypeObjectItemComboBoxItemTemplate
#if NET8_0_OR_GREATER
        : IJsonElement<ContentTypeObjectItemComboBoxItemTemplate>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ContentTypeObjectItemComboBoxItemTemplate"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ContentTypeObjectItemComboBoxItemTemplate(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ContentTypeObjectItemComboBoxItemTemplate DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.JsonString Key
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.KeyUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.JsonString value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in ContentTypeObjectItemComboBoxItemTemplate left, in ContentTypeObjectItemComboBoxItemTemplate right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ContentTypeObjectItemComboBoxItemTemplate left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(ContentTypeObjectItemComboBoxItemTemplate instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ContentTypeObjectItemComboBoxItemTemplate(JsonElement instance)
        {
            return ContentTypeObjectItemComboBoxItemTemplate.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ContentTypeObjectItemComboBoxItemTemplate From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ContentTypeObjectItemComboBoxItemTemplate ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ContentTypeObjectItemComboBoxItemTemplate>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ContentTypeObjectItemComboBoxItemTemplate ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ContentTypeObjectItemComboBoxItemTemplate>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ContentTypeObjectItemComboBoxItemTemplate ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ContentTypeObjectItemComboBoxItemTemplate>(json, options);
        }
        ...
        /// </exception>
        public static ContentTypeObjectItemComboBoxItemTemplate ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ContentTypeObjectItemComboBoxItemTemplate>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ContentTypeObjectItemComboBoxItemTemplate? result)
        {
            return JsonElementHelpers.TryParseValue<ContentTypeObjectItemComboBoxItemTemplate>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ContentTypeObjectItemComboBoxItemTemplate(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static ContentTypeObjectItemComboBoxItemTemplate IJsonElement<ContentTypeObjectItemComboBoxItemTemplate>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ContentTypeObjectItemComboBoxItemTemplate: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ContentTypeObjectItemComboBoxItemTemplate"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ContentTypeObjectItemComboBoxItemTemplate"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public ContentTypeObjectItemComboBoxItemTemplate Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ContentTypeObjectItemComboBoxItemTemplate>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ContentTypeObjectItemComboBoxItemTemplate"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public ContentTypeObjectItemComboBoxItemTemplate Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ContentTypeObjectItemComboBoxItemTemplate>(_idx);
            }
