    ...
    public readonly partial struct ContentTypeObjectItemMainIndicator
    {
        ...
        public readonly partial struct SizeEntity
        {
...
#endif
            {
                ...
                /// <summary>
                /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItemMainIndicator.SizeEntity.OneOf0Entity"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItemMainIndicator.SizeEntity.OneOf0Entity.Mutable(Mutable value)
                {
                    return Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItemMainIndicator.SizeEntity.OneOf0Entity.Mutable.From(value);
                }

                /// <summary>
                /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItemMainIndicator.SizeEntity.OneOf0Entity"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItemMainIndicator.SizeEntity.OneOf0Entity.Mutable value)
                {
                    return From(value);
                }
                ...
                public static explicit operator Mutable(SizeEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SizeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SizeEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new SizeEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SizeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="SizeEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="SizeEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly SizeEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<SizeEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="SizeEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly SizeEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SizeEntity>(_idx);
                }
                ...
                /// <param name="matchOneOf0Entity">Match a <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItemMainIndicator.SizeEntity.OneOf0Entity"/>.</param>
                ...
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItemMainIndicator.SizeEntity.OneOf0Entity, TContext, TResult> matchOneOf0Entity,
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.SimpleBinding, TContext, TResult> matchSimpleBinding,
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItemMainIndicator.SizeEntity.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItemMainIndicator.SizeEntity.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchOneOf0Entity(Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItemMainIndicator.SizeEntity.OneOf0Entity.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItemMainIndicator.SizeEntity.OneOf0Entity, TResult> matchOneOf0Entity,
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.SimpleBinding, TResult> matchSimpleBinding,
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItemMainIndicator.SizeEntity.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItemMainIndicator.SizeEntity.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchOneOf0Entity(Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItemMainIndicator.SizeEntity.OneOf0Entity.Mutable.From(this));
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItemMainIndicator.SizeEntity.OneOf0Entity" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsOneOf0Entity(out Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItemMainIndicator.SizeEntity.OneOf0Entity result)
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItemMainIndicator.SizeEntity.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItemMainIndicator.SizeEntity.OneOf0Entity.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SizeEntity instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItemMainIndicator.SizeEntity.OneOf0Entity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<SizeEntity, Mutable>(this);
            }
        }
    }
}
