    ...
    public readonly partial struct ContentTypeObjectItemMainIndicator
    {
        ...
        public readonly partial struct TheStateColorOfTheMainIndicator
        {
...
#endif
            {
                ...
                /// <summary>
                /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.EnumsValueColor"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.Schema.EnumsValueColor.Mutable(Mutable value)
                {
                    return Corvus.Ui5ManifestBenchmark.Baseline.Schema.EnumsValueColor.Mutable.From(value);
                }

                /// <summary>
                /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.EnumsValueColor"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Baseline.Schema.EnumsValueColor.Mutable value)
                {
                    return From(value);
                }
                ...
                public static explicit operator Mutable(TheStateColorOfTheMainIndicator instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TheStateColorOfTheMainIndicator"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TheStateColorOfTheMainIndicator(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TheStateColorOfTheMainIndicator.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly TheStateColorOfTheMainIndicator Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly TheStateColorOfTheMainIndicator Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TheStateColorOfTheMainIndicator>(_idx);
                }
                ...
                /// <param name="matchEnumsValueColor">Match a <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.EnumsValueColor"/>.</param>
                ...
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.EnumsValueColor, TContext, TResult> matchEnumsValueColor,
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.SimpleBinding, TContext, TResult> matchSimpleBinding,
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItemMainIndicator.TheStateColorOfTheMainIndicator.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.EnumsValueColor.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchEnumsValueColor(Corvus.Ui5ManifestBenchmark.Baseline.Schema.EnumsValueColor.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.EnumsValueColor, TResult> matchEnumsValueColor,
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.SimpleBinding, TResult> matchSimpleBinding,
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItemMainIndicator.TheStateColorOfTheMainIndicator.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.EnumsValueColor.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchEnumsValueColor(Corvus.Ui5ManifestBenchmark.Baseline.Schema.EnumsValueColor.Mutable.From(this));
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.EnumsValueColor" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsEnumsValueColor(out Corvus.Ui5ManifestBenchmark.Baseline.Schema.EnumsValueColor result)
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.EnumsValueColor.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.Ui5ManifestBenchmark.Baseline.Schema.EnumsValueColor.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(TheStateColorOfTheMainIndicator instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.EnumsValueColor instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<TheStateColorOfTheMainIndicator, Mutable>(this);
            }
        }
    }
}
