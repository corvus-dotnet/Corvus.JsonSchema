    ...
    public readonly partial struct ContentTypeObjectItemValidation
    {
        ...
        public readonly partial struct DefinesTheMinimumNumberOfCharacters
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(DefinesTheMinimumNumberOfCharacters instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DefinesTheMinimumNumberOfCharacters"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DefinesTheMinimumNumberOfCharacters(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DefinesTheMinimumNumberOfCharacters.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly DefinesTheMinimumNumberOfCharacters Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly DefinesTheMinimumNumberOfCharacters Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DefinesTheMinimumNumberOfCharacters>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItemValidation.DefinesTheMinimumNumberOfCharacters.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeObjectItemValidation.DefinesTheMinimumNumberOfCharacters.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(DefinesTheMinimumNumberOfCharacters instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<DefinesTheMinimumNumberOfCharacters, Mutable>(this);
            }
        }
    }
}
