    ...
    public readonly partial struct ContentTypeTable
    {
        ...
        public readonly partial struct RepresentsNumberOfItems
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RepresentsNumberOfItems instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsNumberOfItems"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsNumberOfItems(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsNumberOfItems.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsNumberOfItems Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsNumberOfItems Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsNumberOfItems>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeTable.RepresentsNumberOfItems.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeTable.RepresentsNumberOfItems.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsNumberOfItems instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RepresentsNumberOfItems, Mutable>(this);
            }
        }
    }
}
