    ...
    public readonly partial struct ContentTypeTable
    {
        ...
        public readonly partial struct RepresentsTheMinimumExpectedNumberOfItems
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RepresentsTheMinimumExpectedNumberOfItems instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsTheMinimumExpectedNumberOfItems"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsTheMinimumExpectedNumberOfItems(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsTheMinimumExpectedNumberOfItems.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheMinimumExpectedNumberOfItems Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheMinimumExpectedNumberOfItems Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsTheMinimumExpectedNumberOfItems>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeTable.RepresentsTheMinimumExpectedNumberOfItems.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeTable.RepresentsTheMinimumExpectedNumberOfItems.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsTheMinimumExpectedNumberOfItems instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RepresentsTheMinimumExpectedNumberOfItems, Mutable>(this);
            }
        }
    }
}
