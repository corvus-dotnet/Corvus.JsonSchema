...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeTable.RepresentsNumberOfItems MaxItems
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MaxItemsUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeTable.RepresentsNumberOfItems value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeTable.RepresentsTheMinimumExpectedNumberOfItems MinItems
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MinItemsUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeTable.RepresentsTheMinimumExpectedNumberOfItems value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeTable.TheTemplateForAllRows Row
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RowUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeTable.TheTemplateForAllRows value))
                {
                    return value;
                }
