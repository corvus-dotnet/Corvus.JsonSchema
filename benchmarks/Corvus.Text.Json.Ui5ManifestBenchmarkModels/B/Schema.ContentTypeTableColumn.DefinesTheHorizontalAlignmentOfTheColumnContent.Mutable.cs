    ...
    public readonly partial struct ContentTypeTableColumn
    {
        ...
        public readonly partial struct DefinesTheHorizontalAlignmentOfTheColumnContent
        {
...
#endif
            {
                ...
                public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.Schema.TextAlign.Mutable(Mutable value)
                {
                    return Corvus.Ui5ManifestBenchmark.Baseline.Schema.TextAlign.Mutable.From(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Baseline.Schema.TextAlign.Mutable value)
                {
                    return From(value);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeTableColumn.DefinesTheHorizontalAlignmentOfTheColumnContent.Mutable, TContext, TResult> defaultMatch)
...
#endif
                {
                    ...
                    {
                        return matchTextAlign(Corvus.Ui5ManifestBenchmark.Baseline.Schema.TextAlign.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeTableColumn.DefinesTheHorizontalAlignmentOfTheColumnContent.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.TextAlign.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchTextAlign(Corvus.Ui5ManifestBenchmark.Baseline.Schema.TextAlign.Mutable.From(this));
                    }
                ...
                public bool TryGetAsTextAlign(out Corvus.Ui5ManifestBenchmark.Baseline.Schema.TextAlign result)
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.TextAlign.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.Ui5ManifestBenchmark.Baseline.Schema.TextAlign.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.TextAlign instance) => new(JsonElement.From(instance));
