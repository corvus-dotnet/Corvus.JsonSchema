...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ContentTypeTableColumn
    {
        ...
        public readonly partial struct DefinesTheStateOfTheColumn
        {
...
#endif
            {
                ...
                /// <summary>
                /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.State"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.Schema.State.Mutable(Mutable value)
                {
                    return Corvus.Ui5ManifestBenchmark.Baseline.Schema.State.Mutable.From(value);
                }

                /// <summary>
                /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.State"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Baseline.Schema.State.Mutable value)
                {
                    return From(value);
                }
                ...
                public static explicit operator Mutable(DefinesTheStateOfTheColumn instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DefinesTheStateOfTheColumn"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DefinesTheStateOfTheColumn(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new DefinesTheStateOfTheColumn(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DefinesTheStateOfTheColumn.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="DefinesTheStateOfTheColumn"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="DefinesTheStateOfTheColumn"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly DefinesTheStateOfTheColumn Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<DefinesTheStateOfTheColumn>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="DefinesTheStateOfTheColumn"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly DefinesTheStateOfTheColumn Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DefinesTheStateOfTheColumn>(_idx);
                }
                ...
                /// <param name="matchState">Match a <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.State"/>.</param>
                ...
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.State, TContext, TResult> matchState,
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.SimpleBinding, TContext, TResult> matchSimpleBinding,
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeTableColumn.DefinesTheStateOfTheColumn.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.State.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchState(Corvus.Ui5ManifestBenchmark.Baseline.Schema.State.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.State, TResult> matchState,
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.SimpleBinding, TResult> matchSimpleBinding,
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeTableColumn.DefinesTheStateOfTheColumn.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.State.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchState(Corvus.Ui5ManifestBenchmark.Baseline.Schema.State.Mutable.From(this));
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.State" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsState(out Corvus.Ui5ManifestBenchmark.Baseline.Schema.State result)
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.State.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.Ui5ManifestBenchmark.Baseline.Schema.State.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(DefinesTheStateOfTheColumn instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.State instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<DefinesTheStateOfTheColumn, Mutable>(this);
            }
        }
    }
}
