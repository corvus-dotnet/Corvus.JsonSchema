    ...
    public readonly partial struct ContentTypeTableColumn
    {
        ...
        public readonly partial struct IdentifierEntity
        {
...
#endif
            {
                ...
                /// <summary>
                /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier.Mutable(Mutable value)
                {
                    return Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier.Mutable.From(value);
                }

                /// <summary>
                /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier.Mutable value)
                {
                    return From(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.Schema.SimpleBinding.Mutable(Mutable value)
                {
                    return Corvus.Ui5ManifestBenchmark.Baseline.Schema.SimpleBinding.Mutable.From(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Baseline.Schema.SimpleBinding.Mutable value)
                {
                    return From(value);
                }

                /// <summary>
                /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier.OneOf0Entity"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier.OneOf0Entity.Mutable(Mutable value)
                {
                    return Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier.OneOf0Entity.Mutable.From(value);
                }

                /// <summary>
                /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier.OneOf0Entity"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier.OneOf0Entity.Mutable value)
                {
                    return From(value);
                }

                /// <summary>
                /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier.Deprecated"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier.Deprecated.Mutable(Mutable value)
                {
                    return Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier.Deprecated.Mutable.From(value);
                }

                /// <summary>
                /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier.Deprecated"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier.Deprecated.Mutable value)
                {
                    return From(value);
                }
                ...
                public static explicit operator Mutable(IdentifierEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="IdentifierEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator IdentifierEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new IdentifierEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                /// </remarks>
                public void Apply(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier value)
                {
                    CheckValidInstance();
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"IdentifierEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="IdentifierEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="IdentifierEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly IdentifierEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<IdentifierEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="IdentifierEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly IdentifierEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<IdentifierEntity>(_idx);
                }
                ...
                /// <param name="matchIdentifier">Match a <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier"/>.</param>
                ...
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier, TContext, TResult> matchIdentifier,
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.SimpleBinding, TContext, TResult> matchSimpleBinding,
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeTableColumn.IdentifierEntity.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchIdentifier(Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier.Mutable.From(this), context);
                    }

                    if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.SimpleBinding.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchSimpleBinding(Corvus.Ui5ManifestBenchmark.Baseline.Schema.SimpleBinding.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier, TResult> matchIdentifier,
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.SimpleBinding, TResult> matchSimpleBinding,
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeTableColumn.IdentifierEntity.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchIdentifier(Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier.Mutable.From(this));
                    }

                    if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.SimpleBinding.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchSimpleBinding(Corvus.Ui5ManifestBenchmark.Baseline.Schema.SimpleBinding.Mutable.From(this));
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsIdentifier(out Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier result)
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier.Mutable.From(this);
                        return true;
                    }
                ...
                public bool TryGetAsSimpleBinding(out Corvus.Ui5ManifestBenchmark.Baseline.Schema.SimpleBinding result)
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.SimpleBinding.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.Ui5ManifestBenchmark.Baseline.Schema.SimpleBinding.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier.Deprecated.Builder.Build? _deprecatedBuilderInstance;
                ...
                public Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier.Deprecated.Builder.Build value) {_deprecatedBuilderInstance = value; _kind = Kind.DeprecatedBuilder; }

                public static implicit operator Source(IdentifierEntity instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier.Deprecated instance) => new(JsonElement.From(instance));

                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier.OneOf0Entity instance) => new(JsonElement.From(instance));

                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.SimpleBinding instance) => new(JsonElement.From(instance));
                ...
                internal void AddAsProperty(ReadOnlySpan<byte> utf8Name, ref ComplexValueBuilder valueBuilder, bool escapeName = true, bool nameRequiresUnescaping = false)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.DeprecatedBuilder:
                            valueBuilder.AddProperty(utf8Name, _deprecatedBuilderInstance!, static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier.Deprecated.Builder.BuildValue(b, ref o), escapeName, nameRequiresUnescaping);
                            break;
                        default:
                ...
                internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.Utf16String:
                            ...
                            break;
                        case Kind.DeprecatedBuilder:
                            valueBuilder.AddProperty(name, _deprecatedBuilderInstance!, static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier.Deprecated.Builder.BuildValue(b, ref o));
                            break;
                        default:
                            Debug.Fail("Unexpected Kind");
                            break;
                ...
                internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.Utf16String:
                            ...
                            break;
                        case Kind.DeprecatedBuilder:
                            valueBuilder.AddItem(_deprecatedBuilderInstance!, static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier.Deprecated.Builder.BuildValue(b, ref o));
                            break;
                        default:
                            Debug.Fail("Unexpected Kind");
                            break;
                ...
                #endif
            {
                ...
                TContext _context;
                Source _source;
                private readonly Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier.Deprecated.Builder.Build<TContext>? _deprecatedBuilderInstance;
                ...
                public Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier.Deprecated.Builder.Build<TContext> value) {_context = context; _deprecatedBuilderInstance = value; _kind = Kind.DeprecatedBuilder; }
                ...
                internal void AddAsProperty(ReadOnlySpan<byte> utf8Name, ref ComplexValueBuilder valueBuilder, bool escapeName = true, bool nameRequiresUnescaping = false)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.Source:
                            ...
                            break;
                        case Kind.DeprecatedBuilder:
                            valueBuilder.AddProperty(utf8Name, BuildWithContext.Create(_context, _deprecatedBuilderInstance!), static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier.Deprecated.Builder.BuildValue(b.Context, b.Build, ref o), escapeName, nameRequiresUnescaping);
                            break;
                        default:
                            Debug.Fail("Unexpected Kind");
                            break;
                ...
                internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.Source:
                            ...
                            break;
                        case Kind.DeprecatedBuilder:
                            valueBuilder.AddProperty(name, BuildWithContext.Create(_context, _deprecatedBuilderInstance!), static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier.Deprecated.Builder.BuildValue(b.Context, b.Build, ref o));
                            break;
                        default:
                            Debug.Fail("Unexpected Kind");
                            break;
                ...
                internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.Source:
                            ...
                            break;
                        case Kind.DeprecatedBuilder:
                            valueBuilder.AddItem(BuildWithContext.Create(_context, _deprecatedBuilderInstance!), static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier.Deprecated.Builder.BuildValue(b.Context, b.Build, ref o));
                            break;
                        default:
                            Debug.Fail("Unexpected Kind");
                            break;
            ...
            public static Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier.Deprecated.Source Build(
                scoped in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier.Deprecated.Builder.Build buildValue, int initialCapacity = 1)
            {
                return new Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier.Deprecated.Source(buildValue);
            }
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier.Deprecated.Source<TContext> Build<TContext>(
                scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier.Deprecated.Builder.Build<TContext> buildValue, int initialCapacity = 1)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                return new Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier.Deprecated.Source<TContext>(context, buildValue);
            }
            ...
            /// <returns>An instance of a mutable document initialized with the given value.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(
                JsonWorkspace workspace, scoped in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier.Deprecated.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
            {
                // Create the document builder without a MetadataDb
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                var source = new Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier.Deprecated.Source(value);
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(
                JsonWorkspace workspace, scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier.Deprecated.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                ...
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                var source = new Corvus.Ui5ManifestBenchmark.Baseline.Schema.Identifier.Deprecated.Source<TContext>(context, value);
                source.AddAsItem(ref cvb);
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<IdentifierEntity, Mutable>(this);
            }
        }
    }
}
