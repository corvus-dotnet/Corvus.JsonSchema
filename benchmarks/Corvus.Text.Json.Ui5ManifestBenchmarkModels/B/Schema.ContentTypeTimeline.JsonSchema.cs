...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ContentTypeTimeline
        : IJsonElement<ContentTypeTimeline>
    {
        public static partial class JsonSchema
        {
            ...
            private static void MatchItemValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                ...
                JsonSchemaContext childContext1 =
                    Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeTimelineItem.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeTimelineItem.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
            ...
            private static void MatchMaxItems(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                ...
                JsonSchemaContext childContext2 =
                    Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeTimeline.RepresentsNumberOfItems.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeTimeline.RepresentsNumberOfItems.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
            ...
            private static void MatchMinItems(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
            {
                ...
                JsonSchemaContext childContext3 =
                    Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeTimeline.RepresentsTheMinimumExpectedNumberOfItems.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeTimeline.RepresentsTheMinimumExpectedNumberOfItems.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext3);
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("ui5-manifest-schema.json#/definitions/ContentType.Timeline"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "ui5-manifest-schema.json#/definitions/ContentType.Timeline";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "ui5-manifest-schema.json#/definitions/ContentType.Timeline"u8;
