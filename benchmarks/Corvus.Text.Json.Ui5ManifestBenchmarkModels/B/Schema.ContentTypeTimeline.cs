...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ContentTypeTimeline"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ContentTypeTimeline(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ContentTypeTimeline DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeTimelineItem ItemValue
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ItemValueUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeTimelineItem value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeTimeline.RepresentsNumberOfItems MaxItems
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MaxItemsUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeTimeline.RepresentsNumberOfItems value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeTimeline.RepresentsTheMinimumExpectedNumberOfItems MinItems
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MinItemsUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeTimeline.RepresentsTheMinimumExpectedNumberOfItems value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in ContentTypeTimeline left, in ContentTypeTimeline right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ContentTypeTimeline left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(ContentTypeTimeline instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ContentTypeTimeline(JsonElement instance)
        {
            return ContentTypeTimeline.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ContentTypeTimeline From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ContentTypeTimeline ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ContentTypeTimeline>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ContentTypeTimeline ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ContentTypeTimeline>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ContentTypeTimeline ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ContentTypeTimeline>(json, options);
        }
        ...
        /// </exception>
        public static ContentTypeTimeline ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ContentTypeTimeline>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ContentTypeTimeline? result)
        {
            return JsonElementHelpers.TryParseValue<ContentTypeTimeline>(ref reader, out result);
        }
...
#if NET
        static ContentTypeTimeline IJsonElement<ContentTypeTimeline>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ContentTypeTimeline: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public ContentTypeTimeline Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public ContentTypeTimeline Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ContentTypeTimeline>(_idx);
            }
