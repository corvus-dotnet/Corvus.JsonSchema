    ...
    public readonly partial struct Contentitem
    {
        ...
        public readonly partial struct WrapsTheChildManifest
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(WrapsTheChildManifest instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="WrapsTheChildManifest"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator WrapsTheChildManifest(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Baseline.Schema.Contentitem.WrapsTheChildManifest.TheArtifactsManifest.Mutable SapArtifact
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SapArtifactUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.Contentitem.WrapsTheChildManifest.TheArtifactsManifest.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetSapArtifact(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Contentitem.WrapsTheChildManifest.TheArtifactsManifest.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetSapArtifact<TContext>(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Contentitem.WrapsTheChildManifest.TheArtifactsManifest.Source<TContext> value)
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"WrapsTheChildManifest.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly WrapsTheChildManifest Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly WrapsTheChildManifest Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<WrapsTheChildManifest>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.Contentitem.WrapsTheChildManifest.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(WrapsTheChildManifest instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.Contentitem.WrapsTheChildManifest.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Contentitem.WrapsTheChildManifest.TheArtifactsManifest.Source sapArtifact = default)
                {
                ...
                /// Creates an instance of a <see cref="WrapsTheChildManifest"/>.
                /// </summary>
                public void Create(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Contentitem.WrapsTheChildManifest.TheArtifactsManifest.Source sapArtifact = default)
                {
                ...
                internal static void Create<TContext>(
                    ...
                    in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Contentitem.WrapsTheChildManifest.TheArtifactsManifest.Source<TContext> sapArtifact = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
                ...
                /// Creates an instance of a <see cref="WrapsTheChildManifest"/>.
                /// </summary>
                public void Create<TContext>(in TContext context, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Contentitem.WrapsTheChildManifest.TheArtifactsManifest.Source<TContext> sapArtifact = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
                    Create(context, ref _builder, sapArtifact);
                }
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Contentitem.WrapsTheChildManifest.TheArtifactsManifest.Source sapArtifact = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(sapArtifact);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Contentitem.WrapsTheChildManifest.TheArtifactsManifest.Source<TContext> sapArtifact = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                ...
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(context, sapArtifact);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<WrapsTheChildManifest, Mutable>(this);
            }
        }
    }
}
