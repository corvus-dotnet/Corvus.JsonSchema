        ...
        public readonly partial struct WrapsTheChildManifest
        {
            ...
            public readonly partial struct TheArtifactsManifest
            {
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.Contentitem.WrapsTheChildManifest.TheArtifactsManifest.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.Contentitem.WrapsTheChildManifest.TheArtifactsManifest.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
