...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Contentitem
    {
        ...
        public readonly partial struct WrapsTheChildManifest
#if NET8_0_OR_GREATER
            : IJsonElement<WrapsTheChildManifest>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="WrapsTheChildManifest"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal WrapsTheChildManifest(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static WrapsTheChildManifest DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.Contentitem.WrapsTheChildManifest.TheArtifactsManifest SapArtifact
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SapArtifactUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.Contentitem.WrapsTheChildManifest.TheArtifactsManifest value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in WrapsTheChildManifest left, in WrapsTheChildManifest right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in WrapsTheChildManifest left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(WrapsTheChildManifest instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator WrapsTheChildManifest(JsonElement instance)
            {
                return WrapsTheChildManifest.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WrapsTheChildManifest From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WrapsTheChildManifest ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<WrapsTheChildManifest>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WrapsTheChildManifest ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<WrapsTheChildManifest>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WrapsTheChildManifest ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<WrapsTheChildManifest>(json, options);
            }
            ...
            /// </exception>
            public static WrapsTheChildManifest ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<WrapsTheChildManifest>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out WrapsTheChildManifest? result)
            {
                return JsonElementHelpers.TryParseValue<WrapsTheChildManifest>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new WrapsTheChildManifest(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static WrapsTheChildManifest IJsonElement<WrapsTheChildManifest>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"WrapsTheChildManifest: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="WrapsTheChildManifest"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="WrapsTheChildManifest"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public WrapsTheChildManifest Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<WrapsTheChildManifest>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="WrapsTheChildManifest"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public WrapsTheChildManifest Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<WrapsTheChildManifest>(_idx);
                }
