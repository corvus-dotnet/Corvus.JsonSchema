...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Contentitem
#if NET8_0_OR_GREATER
        : IJsonElement<Contentitem>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Contentitem"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal Contentitem(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static Contentitem DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.JsonString BaseUrl
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BaseUrlUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.JsonString value))
                {
                    return value;
                }
        ...
        /// <summary>
        /// Gets the (optional) <c>manifest</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.Schema.Contentitem.WrapsTheChildManifest Manifest
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ManifestUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.Contentitem.WrapsTheChildManifest value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in Contentitem left, in Contentitem right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Contentitem left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(Contentitem instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Contentitem(JsonElement instance)
        {
            return Contentitem.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Contentitem From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Contentitem ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Contentitem>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Contentitem ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Contentitem>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Contentitem ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Contentitem>(json, options);
        }
        ...
        /// </exception>
        public static Contentitem ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<Contentitem>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Contentitem? result)
        {
            return JsonElementHelpers.TryParseValue<Contentitem>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new Contentitem(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static Contentitem IJsonElement<Contentitem>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Contentitem: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="Contentitem"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="Contentitem"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        {
            CheckValidInstance();
            return _parent.CloneElement<Contentitem>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="Contentitem"/> that lives for the lifetime of its
        ...
        public static class JsonPropertyNames
        {
            ...
            /// <summary>
            /// Gets the JSON property name for <see cref="Manifest"/>.
            /// </summary>
            ...
            /// Gets the JSON property name for <see cref="Manifest"/>.
            /// </summary>
            public static ReadOnlySpan<byte> ManifestUtf8 => "manifest"u8;
        }
        ...
        private static class JsonPropertyNamesEscaped
        {
            ...
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="Manifest"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Manifest => "manifest"u8;
        }
    }
}
