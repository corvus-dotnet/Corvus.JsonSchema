...
public readonly partial struct Schema
{
    ...
    public readonly partial struct CustomActionsSetting
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="TextDisplayedForExtendedActionsInQuickView"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal TextDisplayedForExtendedActionsInQuickView(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static TextDisplayedForExtendedActionsInQuickView DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(TextDisplayedForExtendedActionsInQuickView value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in TextDisplayedForExtendedActionsInQuickView left, in TextDisplayedForExtendedActionsInQuickView right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in TextDisplayedForExtendedActionsInQuickView left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(TextDisplayedForExtendedActionsInQuickView instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TextDisplayedForExtendedActionsInQuickView(JsonElement instance)
            {
                return TextDisplayedForExtendedActionsInQuickView.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TextDisplayedForExtendedActionsInQuickView From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TextDisplayedForExtendedActionsInQuickView ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TextDisplayedForExtendedActionsInQuickView>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TextDisplayedForExtendedActionsInQuickView ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TextDisplayedForExtendedActionsInQuickView>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TextDisplayedForExtendedActionsInQuickView ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TextDisplayedForExtendedActionsInQuickView>(json, options);
            }
            ...
            /// </exception>
            public static TextDisplayedForExtendedActionsInQuickView ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<TextDisplayedForExtendedActionsInQuickView>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out TextDisplayedForExtendedActionsInQuickView? result)
            {
                return JsonElementHelpers.TryParseValue<TextDisplayedForExtendedActionsInQuickView>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new TextDisplayedForExtendedActionsInQuickView(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static TextDisplayedForExtendedActionsInQuickView IJsonElement<TextDisplayedForExtendedActionsInQuickView>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TextDisplayedForExtendedActionsInQuickView: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="TextDisplayedForExtendedActionsInQuickView"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="TextDisplayedForExtendedActionsInQuickView"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public TextDisplayedForExtendedActionsInQuickView Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<TextDisplayedForExtendedActionsInQuickView>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="TextDisplayedForExtendedActionsInQuickView"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public TextDisplayedForExtendedActionsInQuickView Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<TextDisplayedForExtendedActionsInQuickView>(_idx);
                }
