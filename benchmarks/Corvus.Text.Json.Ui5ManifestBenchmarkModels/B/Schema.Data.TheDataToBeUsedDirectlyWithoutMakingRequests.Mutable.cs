    ...
    public readonly partial struct Data
    {
        ...
        public readonly partial struct TheDataToBeUsedDirectlyWithoutMakingRequests
        {
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.Data.TheDataToBeUsedDirectlyWithoutMakingRequests.ObjectBuilder.Build value) {_objectBuilder = value; _kind = Kind.ObjectBuilder; }

                internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.Data.TheDataToBeUsedDirectlyWithoutMakingRequests.ArrayBuilder.Build value) {_arrayBuilder = value; _kind = Kind.ArrayBuilder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.Data.TheDataToBeUsedDirectlyWithoutMakingRequests.ObjectBuilder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.ObjectBuilder; }

                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.Data.TheDataToBeUsedDirectlyWithoutMakingRequests.ArrayBuilder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.ArrayBuilder; }
