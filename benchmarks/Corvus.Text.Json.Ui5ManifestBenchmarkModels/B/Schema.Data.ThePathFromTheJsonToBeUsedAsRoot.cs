...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Data
    {
        ...
        public readonly partial struct ThePathFromTheJsonToBeUsedAsRoot
#if NET8_0_OR_GREATER
            : IJsonElement<ThePathFromTheJsonToBeUsedAsRoot>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ThePathFromTheJsonToBeUsedAsRoot"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ThePathFromTheJsonToBeUsedAsRoot(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ThePathFromTheJsonToBeUsedAsRoot DefaultInstance { get; } = ParsedJsonDocument<ThePathFromTheJsonToBeUsedAsRoot>.StringConstant([.."\"/\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(ThePathFromTheJsonToBeUsedAsRoot value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in ThePathFromTheJsonToBeUsedAsRoot left, in ThePathFromTheJsonToBeUsedAsRoot right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ThePathFromTheJsonToBeUsedAsRoot left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ThePathFromTheJsonToBeUsedAsRoot instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ThePathFromTheJsonToBeUsedAsRoot(JsonElement instance)
            {
                return ThePathFromTheJsonToBeUsedAsRoot.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ThePathFromTheJsonToBeUsedAsRoot From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ThePathFromTheJsonToBeUsedAsRoot ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ThePathFromTheJsonToBeUsedAsRoot>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ThePathFromTheJsonToBeUsedAsRoot ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ThePathFromTheJsonToBeUsedAsRoot>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ThePathFromTheJsonToBeUsedAsRoot ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ThePathFromTheJsonToBeUsedAsRoot>(json, options);
            }
            ...
            /// </exception>
            public static ThePathFromTheJsonToBeUsedAsRoot ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ThePathFromTheJsonToBeUsedAsRoot>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ThePathFromTheJsonToBeUsedAsRoot? result)
            {
                return JsonElementHelpers.TryParseValue<ThePathFromTheJsonToBeUsedAsRoot>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ThePathFromTheJsonToBeUsedAsRoot(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static ThePathFromTheJsonToBeUsedAsRoot IJsonElement<ThePathFromTheJsonToBeUsedAsRoot>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ThePathFromTheJsonToBeUsedAsRoot: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ThePathFromTheJsonToBeUsedAsRoot"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ThePathFromTheJsonToBeUsedAsRoot"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public ThePathFromTheJsonToBeUsedAsRoot Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ThePathFromTheJsonToBeUsedAsRoot>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ThePathFromTheJsonToBeUsedAsRoot"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public ThePathFromTheJsonToBeUsedAsRoot Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ThePathFromTheJsonToBeUsedAsRoot>(_idx);
                }
