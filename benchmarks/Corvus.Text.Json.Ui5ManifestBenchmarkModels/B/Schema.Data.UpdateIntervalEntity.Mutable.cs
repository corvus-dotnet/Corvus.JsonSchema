    ...
    public readonly partial struct Data
    {
        ...
        public readonly partial struct UpdateIntervalEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(UpdateIntervalEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="UpdateIntervalEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator UpdateIntervalEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"UpdateIntervalEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly UpdateIntervalEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly UpdateIntervalEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<UpdateIntervalEntity>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.Data.UpdateIntervalEntity.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.Data.UpdateIntervalEntity.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(UpdateIntervalEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<UpdateIntervalEntity, Mutable>(this);
            }
        }
    }
}
