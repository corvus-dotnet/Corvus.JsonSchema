...
public readonly partial struct Schema
{
    ...
    public readonly partial struct DefaultSpanDef
    {
        ...
        public readonly partial struct RequiredColsAndRows
        {
            ...
            public readonly partial struct ShowOnlyHeaderEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(ShowOnlyHeaderEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ShowOnlyHeaderEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ShowOnlyHeaderEntity(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new ShowOnlyHeaderEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ShowOnlyHeaderEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="ShowOnlyHeaderEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="ShowOnlyHeaderEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ShowOnlyHeaderEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<ShowOnlyHeaderEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="ShowOnlyHeaderEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ShowOnlyHeaderEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ShowOnlyHeaderEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(ShowOnlyHeaderEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<ShowOnlyHeaderEntity, Mutable>(this);
                }
            }
        }
    }
