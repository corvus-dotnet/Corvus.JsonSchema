...
public readonly partial struct Schema
{
    ...
    public readonly partial struct DefiningRequest
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.DefiningRequest.RepresentsIndicatorWhetherStreamsShouldBeRetrieved.Mutable RetrieveStreams
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RetrieveStreamsUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.DefiningRequest.RepresentsIndicatorWhetherStreamsShouldBeRetrieved.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetRetrieveStreams(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.DefiningRequest.RepresentsIndicatorWhetherStreamsShouldBeRetrieved.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.DefiningRequest.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.DefiningRequest.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source dataSource,
                in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source path,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.DefiningRequest.RepresentsIndicatorWhetherStreamsShouldBeRetrieved.Source retrieveStreams = default)
            {
