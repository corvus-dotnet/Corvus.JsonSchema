...
public readonly partial struct Schema
{
    ...
    /// </summary>
    public readonly partial struct DefiningRequest
    {
        /// <summary>
        /// Generated from JSON Schema.
        /// </summary>
        ...
        public readonly partial struct RepresentsIndicatorWhetherStreamsShouldBeRetrieved
#if NET8_0_OR_GREATER
            : IJsonElement<RepresentsIndicatorWhetherStreamsShouldBeRetrieved>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RepresentsIndicatorWhetherStreamsShouldBeRetrieved"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RepresentsIndicatorWhetherStreamsShouldBeRetrieved(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RepresentsIndicatorWhetherStreamsShouldBeRetrieved DefaultInstance { get; } = ParsedJsonDocument<RepresentsIndicatorWhetherStreamsShouldBeRetrieved>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(RepresentsIndicatorWhetherStreamsShouldBeRetrieved value)
            {
            ...
            /// </returns>
            public static bool operator ==(in RepresentsIndicatorWhetherStreamsShouldBeRetrieved left, in RepresentsIndicatorWhetherStreamsShouldBeRetrieved right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RepresentsIndicatorWhetherStreamsShouldBeRetrieved left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(RepresentsIndicatorWhetherStreamsShouldBeRetrieved instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RepresentsIndicatorWhetherStreamsShouldBeRetrieved(JsonElement instance)
            {
                return RepresentsIndicatorWhetherStreamsShouldBeRetrieved.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsIndicatorWhetherStreamsShouldBeRetrieved From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsIndicatorWhetherStreamsShouldBeRetrieved ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsIndicatorWhetherStreamsShouldBeRetrieved>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsIndicatorWhetherStreamsShouldBeRetrieved ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsIndicatorWhetherStreamsShouldBeRetrieved>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsIndicatorWhetherStreamsShouldBeRetrieved ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsIndicatorWhetherStreamsShouldBeRetrieved>(json, options);
            }
            ...
            /// </exception>
            public static RepresentsIndicatorWhetherStreamsShouldBeRetrieved ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RepresentsIndicatorWhetherStreamsShouldBeRetrieved>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsIndicatorWhetherStreamsShouldBeRetrieved? result)
            {
                return JsonElementHelpers.TryParseValue<RepresentsIndicatorWhetherStreamsShouldBeRetrieved>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RepresentsIndicatorWhetherStreamsShouldBeRetrieved(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static RepresentsIndicatorWhetherStreamsShouldBeRetrieved IJsonElement<RepresentsIndicatorWhetherStreamsShouldBeRetrieved>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RepresentsIndicatorWhetherStreamsShouldBeRetrieved: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RepresentsIndicatorWhetherStreamsShouldBeRetrieved"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RepresentsIndicatorWhetherStreamsShouldBeRetrieved"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public RepresentsIndicatorWhetherStreamsShouldBeRetrieved Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RepresentsIndicatorWhetherStreamsShouldBeRetrieved>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RepresentsIndicatorWhetherStreamsShouldBeRetrieved"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public RepresentsIndicatorWhetherStreamsShouldBeRetrieved Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RepresentsIndicatorWhetherStreamsShouldBeRetrieved>(_idx);
                }
