...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.Schema.DefiningRequest.RepresentsIndicatorWhetherStreamsShouldBeRetrieved RetrieveStreams
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RetrieveStreamsUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.DefiningRequest.RepresentsIndicatorWhetherStreamsShouldBeRetrieved value))
                {
                    return value;
                }

                return Corvus.Ui5ManifestBenchmark.Baseline.Schema.DefiningRequest.RepresentsIndicatorWhetherStreamsShouldBeRetrieved.DefaultInstance;
            }
        }
