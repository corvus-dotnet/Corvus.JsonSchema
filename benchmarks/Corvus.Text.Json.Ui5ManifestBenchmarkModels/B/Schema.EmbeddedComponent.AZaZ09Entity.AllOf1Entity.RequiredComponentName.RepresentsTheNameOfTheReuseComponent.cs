        ...
        public readonly partial struct AZaZ09Entity
        {
            ...
            public readonly partial struct AllOf1Entity
            {
                ...
                public readonly partial struct RequiredComponentName
                {
                    ...
                    public readonly partial struct RepresentsTheNameOfTheReuseComponent
#if NET8_0_OR_GREATER
                        : IJsonElement<RepresentsTheNameOfTheReuseComponent>,
                          IFormattable,
                          ISpanFormattable,
...
#endif
                    {
                        ...
                        /// <summary>
                        /// Initializes a new instance of the <see cref="RepresentsTheNameOfTheReuseComponent"/> struct.
                        /// </summary>
                        /// <param name="value">The value from which to construct the instance.</param>
                        internal RepresentsTheNameOfTheReuseComponent(IJsonDocument parent, int idx)
                        {
                            Debug.Assert(idx >= 0);
                            _parent = parent;
                            _idx = idx;
                        ...
                        /// </summary>
                        public static RepresentsTheNameOfTheReuseComponent DefaultInstance { get; }
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static explicit operator string(RepresentsTheNameOfTheReuseComponent value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                        ...
                        /// </returns>
                        public static bool operator ==(in RepresentsTheNameOfTheReuseComponent left, in RepresentsTheNameOfTheReuseComponent right)
                        {
                        ...
                        /// <c>True</c> if the values are equal.
                        /// </returns>
                        public static bool operator ==(in RepresentsTheNameOfTheReuseComponent left, in JsonElement right)
                        {
                            return left.Equals(right);
                        }
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator JsonElement(RepresentsTheNameOfTheReuseComponent instance)
                        {
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator RepresentsTheNameOfTheReuseComponent(JsonElement instance)
                        {
                            return RepresentsTheNameOfTheReuseComponent.From(instance);
                        }
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static RepresentsTheNameOfTheReuseComponent From<T>(in T instance)
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static RepresentsTheNameOfTheReuseComponent ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<RepresentsTheNameOfTheReuseComponent>(utf8Json, options);
                        }
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static RepresentsTheNameOfTheReuseComponent ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<RepresentsTheNameOfTheReuseComponent>(json, options);
                        }
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static RepresentsTheNameOfTheReuseComponent ParseValue(string json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<RepresentsTheNameOfTheReuseComponent>(json, options);
                        }
                        ...
                        /// </exception>
                        public static RepresentsTheNameOfTheReuseComponent ParseValue(ref Utf8JsonReader reader)
                        {
                            return JsonElementHelpers.ParseValue<RepresentsTheNameOfTheReuseComponent>(ref reader);
                        }
                        ...
                        ///   A value could not be read from the reader.
                        /// </exception>
                        public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsTheNameOfTheReuseComponent? result)
                        {
                            return JsonElementHelpers.TryParseValue<RepresentsTheNameOfTheReuseComponent>(ref reader, out result);
                        }
                        ...
                        {
                            return
                                (obj is IJsonElement value && Equals(new RepresentsTheNameOfTheReuseComponent(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                        static RepresentsTheNameOfTheReuseComponent IJsonElement<RepresentsTheNameOfTheReuseComponent>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"RepresentsTheNameOfTheReuseComponent: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// <summary>
                        /// Gets a <see cref="RepresentsTheNameOfTheReuseComponent"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </summary>
                        /// <returns>
                        /// A <see cref="RepresentsTheNameOfTheReuseComponent"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </returns>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public RepresentsTheNameOfTheReuseComponent Clone()
                        {
                            CheckValidInstance();
                            return _parent.CloneElement<RepresentsTheNameOfTheReuseComponent>(_idx);
                        }
                        ...
                        /// </summary>
                        /// <returns>
                        /// An immutable <see cref="RepresentsTheNameOfTheReuseComponent"/> that lives for the lifetime of its
                        ...
                        /// </para>
                        /// </remarks>
                        public RepresentsTheNameOfTheReuseComponent Freeze()
                        {
                            CheckValidInstance();
                            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                            {
                                return mutable.FreezeElement<RepresentsTheNameOfTheReuseComponent>(_idx);
                            }
