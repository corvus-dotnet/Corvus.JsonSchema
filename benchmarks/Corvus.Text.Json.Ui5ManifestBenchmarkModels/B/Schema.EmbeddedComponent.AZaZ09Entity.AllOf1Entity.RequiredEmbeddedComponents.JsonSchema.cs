    ...
    public readonly partial struct EmbeddedComponent
    {
        ...
        public readonly partial struct AZaZ09Entity
        {
            ...
            public readonly partial struct AllOf1Entity
            {
                ...
                public readonly partial struct RequiredEmbeddedComponents
                    : IJsonElement<RequiredEmbeddedComponents>
                {
                    public static partial class JsonSchema
                    {
                        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyEmbeddedComponentsPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("embeddedComponents"u8, buffer, out written);
                        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyEmbeddedComponentsNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("embeddedComponents"u8, buffer, out written);

                        private const int RequiredOffsetForEmbeddedComponents = 0;
                        private const uint RequiredBitForEmbeddedComponents = 0b00000000000000000000000000000001;

                        private const uint RequiredBitMask0 =
                            RequiredBitForEmbeddedComponents;
                        ...
                        private static void MatchEmbeddedComponents(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                        {
                            ...
                            Corvus.Ui5ManifestBenchmark.Baseline.Schema.EmbeddedComponent.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                            ...
                            requiredBitBuffer[RequiredOffsetForEmbeddedComponents] |= RequiredBitForEmbeddedComponents;
                        }
                        ...
                        {
                            if (span.SequenceEqual(JsonPropertyNames.EmbeddedComponentsUtf8))
                            {
                                matcher = MatchEmbeddedComponents;
                                return true;
                            }
                        ...
                        /// </summary>
                        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("ui5-manifest-schema.json#/definitions/embeddedComponent/patternProperties/^[a-zA-Z0-9_.:-]+$/allOf/1/oneOf/2"u8, buffer, out written);

                        /// <summary>
                        /// Gets the schema location from which this type was generated.
                        /// </summary>
                        public const string SchemaLocation = "ui5-manifest-schema.json#/definitions/embeddedComponent/patternProperties/^[a-zA-Z0-9_.:-]+$/allOf/1/oneOf/2";

                        /// <summary>
                        /// Gets the schema location from which this type was generated as a UTF-8 string.
                        /// </summary>
                        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "ui5-manifest-schema.json#/definitions/embeddedComponent/patternProperties/^[a-zA-Z0-9_.:-]+$/allOf/1/oneOf/2"u8;
                            ...
                            ref JsonSchemaContext context)
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyEmbeddedComponentsPresent, "embeddedComponents"u8, "required"u8);
                                }
                                ...
                                {
                                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForEmbeddedComponents] & RequiredBitForEmbeddedComponents) == 0)
                                    {
                                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyEmbeddedComponentsNotPresent, "embeddedComponents"u8, "required"u8);
                                    }
                                    else
                                    {
                                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyEmbeddedComponentsPresent, "embeddedComponents"u8, "required"u8);
