            ...
            public readonly partial struct AllOf1Entity
            {
                ...
                public readonly partial struct RequiredEmbeddedComponents
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(RequiredEmbeddedComponents instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="RequiredEmbeddedComponents"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator RequiredEmbeddedComponents(Mutable instance)
                        {
                        ...
                        /// <summary>
                        /// Gets the <c>embeddedComponents</c> property.
                        /// </summary>
                        /// <remarks>
                        /// <para>
                        ...
                        {
                            return
                                (obj is IJsonElement value && Equals(new RequiredEmbeddedComponents(value.ParentDocument, value.ParentDocumentIndex))) ||
                        ...
                        public void SetEmbeddedComponents(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.EmbeddedComponent.Source value)
                        {
                            ...
                            {
                                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("embeddedComponents");
                            }
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"RequiredEmbeddedComponents.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// <summary>
                        /// Gets a <see cref="RequiredEmbeddedComponents"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </summary>
                        /// <returns>
                        /// A <see cref="RequiredEmbeddedComponents"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </returns>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RequiredEmbeddedComponents Clone()
                        {
                            CheckValidInstance();
                            return _parent.CloneElement<RequiredEmbeddedComponents>(_idx);
                        }
                        ...
                        /// </summary>
                        /// <returns>
                        /// An immutable <see cref="RequiredEmbeddedComponents"/> that lives for the lifetime of its
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RequiredEmbeddedComponents Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<RequiredEmbeddedComponents>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.EmbeddedComponent.AZaZ09Entity.AllOf1Entity.RequiredEmbeddedComponents.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                        public static implicit operator Source(RequiredEmbeddedComponents instance) => new(JsonElement.From(instance));
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.EmbeddedComponent.AZaZ09Entity.AllOf1Entity.RequiredEmbeddedComponents.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    public ref struct Builder
                    {
                        ...
                        /// <summary>
                        /// Creates an instance of a <see cref="RequiredEmbeddedComponents"/>.
                        /// </summary>
                        internal static void Create(ref ComplexValueBuilder builder, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.EmbeddedComponent.Source embeddedComponents)
                        {
                        ...
                        /// Creates an instance of a <see cref="RequiredEmbeddedComponents"/>.
                        /// </summary>
                        public void Create(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.EmbeddedComponent.Source embeddedComponents)
                        {
                            Create(ref _builder, embeddedComponents);
                        }
                        ...
                        internal static void Create<TContext>(
                            ...
                            in Corvus.Ui5ManifestBenchmark.Baseline.Schema.EmbeddedComponent.Source<TContext> embeddedComponents)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                        {
                        ...
                        /// Creates an instance of a <see cref="RequiredEmbeddedComponents"/>.
                        /// </summary>
                        public void Create<TContext>(in TContext context, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.EmbeddedComponent.Source<TContext> embeddedComponents)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                        {
                            Create(context, ref _builder, embeddedComponents);
                        }
                    ...
                    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.EmbeddedComponent.Source embeddedComponents, int initialCapacity = 30)
                    {
                        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                        cvb.StartObject();
                        Builder ovb = new(cvb);
                        ovb.Create(embeddedComponents);
                        cvb = ovb._builder;
                        cvb.EndObject();
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder;
                    ...
                    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.EmbeddedComponent.Source<TContext> embeddedComponents, int initialCapacity = 30)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                    {
                        ...
                        cvb.StartObject();
                        Builder ovb = new(cvb);
                        ovb.Create(context, embeddedComponents);
                        cvb = ovb._builder;
                        cvb.EndObject();
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder;
                    ...
                    {
                        return workspace.CreateBuilder<RequiredEmbeddedComponents, Mutable>(this);
                    }
                }
            }
        }
