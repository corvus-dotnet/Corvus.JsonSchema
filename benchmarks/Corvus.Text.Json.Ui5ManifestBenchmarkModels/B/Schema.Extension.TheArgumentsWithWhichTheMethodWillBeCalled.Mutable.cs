    ...
    public readonly partial struct Extension
    {
        ...
        public readonly partial struct TheArgumentsWithWhichTheMethodWillBeCalled
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(TheArgumentsWithWhichTheMethodWillBeCalled instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TheArgumentsWithWhichTheMethodWillBeCalled"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TheArgumentsWithWhichTheMethodWillBeCalled(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TheArgumentsWithWhichTheMethodWillBeCalled.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </para>
                /// </remarks>
                public readonly TheArgumentsWithWhichTheMethodWillBeCalled Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly TheArgumentsWithWhichTheMethodWillBeCalled Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TheArgumentsWithWhichTheMethodWillBeCalled>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.Extension.TheArgumentsWithWhichTheMethodWillBeCalled.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(TheArgumentsWithWhichTheMethodWillBeCalled instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.Extension.TheArgumentsWithWhichTheMethodWillBeCalled.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<TheArgumentsWithWhichTheMethodWillBeCalled, Mutable>(this);
            }
        }
    }
}
