...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Field
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Field instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Field"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Field(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.I18nKeyString.Mutable Label
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LabelUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.I18nKeyString.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetLabel(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.I18nKeyString.Source value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Field.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly Field Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Field>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.Field.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(Field instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.Field.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="Field"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.I18nKeyString.Source label = default,
            ...
            public void Create(
                ...
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Visibility.Source visible = default)
            {
                Create(ref _builder, label, value, visible);
            }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.I18nKeyString.Source label = default, in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source value = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Visibility.Source visible = default, int initialCapacity = 30)
        {
            ...
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(label, value, visible);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<Field, Mutable>(this);
        }
    }
}
