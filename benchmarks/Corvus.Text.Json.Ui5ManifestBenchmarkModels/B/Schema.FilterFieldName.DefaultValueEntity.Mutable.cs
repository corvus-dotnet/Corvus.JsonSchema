    ...
    public readonly partial struct FilterFieldName
    {
        ...
        public readonly partial struct DefaultValueEntity
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Mutable Operation
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OperationUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetOperation(in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source value)
                {
                    CheckValidInstance();
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.FilterFieldName.DefaultValueEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.FilterFieldName.DefaultValueEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source operation = default)
                {
                ...
                /// Creates an instance of a <see cref="DefaultValueEntity"/>.
                /// </summary>
                public void Create(in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source operation = default)
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source operation = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
