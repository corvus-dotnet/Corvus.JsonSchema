...
public readonly partial struct Schema
{
    ...
    public readonly partial struct FilterFieldName
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="DefaultValueEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal DefaultValueEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static DefaultValueEntity DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.JsonString Operation
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OperationUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.JsonString value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in DefaultValueEntity left, in DefaultValueEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in DefaultValueEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(DefaultValueEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DefaultValueEntity(JsonElement instance)
            {
                return DefaultValueEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DefaultValueEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DefaultValueEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DefaultValueEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DefaultValueEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DefaultValueEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DefaultValueEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DefaultValueEntity>(json, options);
            }
            ...
            /// </exception>
            public static DefaultValueEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<DefaultValueEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out DefaultValueEntity? result)
            {
                return JsonElementHelpers.TryParseValue<DefaultValueEntity>(ref reader, out result);
            }
...
#if NET
            static DefaultValueEntity IJsonElement<DefaultValueEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DefaultValueEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public DefaultValueEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public DefaultValueEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<DefaultValueEntity>(_idx);
                }
            ...
            {
                /// <summary>
                /// Gets the JSON property name for <see cref="Operation"/>.
                /// </summary>
                ...
                /// Gets the JSON property name for <see cref="Operation"/>.
                /// </summary>
                public static ReadOnlySpan<byte> OperationUtf8 => "operation"u8;
            }
            ...
            {
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="Operation"/>.
                /// </summary>
                public static ReadOnlySpan<byte> Operation => "operation"u8;
            }
        }
    }
}
