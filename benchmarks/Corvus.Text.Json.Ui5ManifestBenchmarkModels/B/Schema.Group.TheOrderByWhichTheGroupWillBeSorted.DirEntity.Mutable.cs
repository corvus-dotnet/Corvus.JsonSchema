        ...
        public readonly partial struct TheOrderByWhichTheGroupWillBeSorted
        {
            ...
            public readonly partial struct DirEntity
            {
...
#endif
                {
                    ...
                    /// <summary>
                    /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.Group.TheOrderByWhichTheGroupWillBeSorted.DirEntity.OneOf0Entity"/>.
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.Schema.Group.TheOrderByWhichTheGroupWillBeSorted.DirEntity.OneOf0Entity.Mutable(Mutable value)
                    {
                        return Corvus.Ui5ManifestBenchmark.Baseline.Schema.Group.TheOrderByWhichTheGroupWillBeSorted.DirEntity.OneOf0Entity.Mutable.From(value);
                    }

                    /// <summary>
                    /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.Group.TheOrderByWhichTheGroupWillBeSorted.DirEntity.OneOf0Entity"/>.
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Baseline.Schema.Group.TheOrderByWhichTheGroupWillBeSorted.DirEntity.OneOf0Entity.Mutable value)
                    {
                        return From(value);
                    }
                    ...
                    public static explicit operator Mutable(DirEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="DirEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator DirEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"DirEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DirEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DirEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<DirEntity>(_idx);
                    }

                    /// <summary>
                    /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.Group.TheOrderByWhichTheGroupWillBeSorted.DirEntity.OneOf0Entity" />.
                    /// </summary>
                    /// <param name="result">The result of the conversions.</param>
                    /// <returns><see langword="true" /> if the conversion was valid.</returns>
                    public bool TryGetAsOneOf0Entity(out Corvus.Ui5ManifestBenchmark.Baseline.Schema.Group.TheOrderByWhichTheGroupWillBeSorted.DirEntity.OneOf0Entity result)
                    {
                        if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.Group.TheOrderByWhichTheGroupWillBeSorted.DirEntity.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                        {
                            result = Corvus.Ui5ManifestBenchmark.Baseline.Schema.Group.TheOrderByWhichTheGroupWillBeSorted.DirEntity.OneOf0Entity.Mutable.From(this);
                            return true;
                        }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(DirEntity instance) => new(JsonElement.From(instance));
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.Group.TheOrderByWhichTheGroupWillBeSorted.DirEntity.OneOf0Entity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<DirEntity, Mutable>(this);
                }
            }
        }
    }
