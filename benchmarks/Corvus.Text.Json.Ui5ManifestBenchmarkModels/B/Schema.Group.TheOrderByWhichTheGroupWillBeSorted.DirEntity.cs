    ...
    public readonly partial struct Group
    {
        ...
        public readonly partial struct TheOrderByWhichTheGroupWillBeSorted
        {
...
#endif
            {
                ...
                public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.Schema.Group.TheOrderByWhichTheGroupWillBeSorted.DirEntity.OneOf0Entity(DirEntity value)
                {
                    return Corvus.Ui5ManifestBenchmark.Baseline.Schema.Group.TheOrderByWhichTheGroupWillBeSorted.DirEntity.OneOf0Entity.From(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator DirEntity(Corvus.Ui5ManifestBenchmark.Baseline.Schema.Group.TheOrderByWhichTheGroupWillBeSorted.DirEntity.OneOf0Entity value)
                {
                    return From(value);
                }
                ...
                public bool TryGetAsOneOf0Entity(out Corvus.Ui5ManifestBenchmark.Baseline.Schema.Group.TheOrderByWhichTheGroupWillBeSorted.DirEntity.OneOf0Entity result)
                {
                    ...
                    {
                        result = Corvus.Ui5ManifestBenchmark.Baseline.Schema.Group.TheOrderByWhichTheGroupWillBeSorted.DirEntity.OneOf0Entity.From(this);
                        return true;
                    }
