...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Group
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="TheOrderByWhichTheGroupWillBeSorted"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal TheOrderByWhichTheGroupWillBeSorted(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static TheOrderByWhichTheGroupWillBeSorted DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.Group.TheOrderByWhichTheGroupWillBeSorted.DirEntity Dir
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DirUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.Group.TheOrderByWhichTheGroupWillBeSorted.DirEntity value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in TheOrderByWhichTheGroupWillBeSorted left, in TheOrderByWhichTheGroupWillBeSorted right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in TheOrderByWhichTheGroupWillBeSorted left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(TheOrderByWhichTheGroupWillBeSorted instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TheOrderByWhichTheGroupWillBeSorted(JsonElement instance)
            {
                return TheOrderByWhichTheGroupWillBeSorted.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TheOrderByWhichTheGroupWillBeSorted From<T>(in T instance)
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out TheOrderByWhichTheGroupWillBeSorted? result)
            {
                return JsonElementHelpers.TryParseValue<TheOrderByWhichTheGroupWillBeSorted>(ref reader, out result);
            }
...
#if NET
            static TheOrderByWhichTheGroupWillBeSorted IJsonElement<TheOrderByWhichTheGroupWillBeSorted>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TheOrderByWhichTheGroupWillBeSorted: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public TheOrderByWhichTheGroupWillBeSorted Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public TheOrderByWhichTheGroupWillBeSorted Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<TheOrderByWhichTheGroupWillBeSorted>(_idx);
                }
            ...
            {
                /// <summary>
                /// Gets the JSON property name for <see cref="Dir"/>.
                /// </summary>
            ...
            {
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="Dir"/>.
                /// </summary>
                public static ReadOnlySpan<byte> Dir => "dir"u8;
