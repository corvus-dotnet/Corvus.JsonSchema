...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.Schema.Group.TheOrderByWhichTheGroupWillBeSorted Order
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OrderUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.Group.TheOrderByWhichTheGroupWillBeSorted value))
                {
                    return value;
                }
