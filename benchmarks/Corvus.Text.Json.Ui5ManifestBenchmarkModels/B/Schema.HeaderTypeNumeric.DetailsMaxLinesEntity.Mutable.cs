    ...
    public readonly partial struct HeaderTypeNumeric
    {
        ...
        public readonly partial struct DetailsMaxLinesEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(DetailsMaxLinesEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DetailsMaxLinesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DetailsMaxLinesEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DetailsMaxLinesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly DetailsMaxLinesEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly DetailsMaxLinesEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DetailsMaxLinesEntity>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.HeaderTypeNumeric.DetailsMaxLinesEntity.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.HeaderTypeNumeric.DetailsMaxLinesEntity.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(DetailsMaxLinesEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<DetailsMaxLinesEntity, Mutable>(this);
            }
        }
    }
}
