    ...
    public readonly partial struct HeaderTypeNumeric
    {
        ...
        public readonly partial struct ExperimentalLimitTheNumberOfLinesForTheTitle
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ExperimentalLimitTheNumberOfLinesForTheTitle instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ExperimentalLimitTheNumberOfLinesForTheTitle"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ExperimentalLimitTheNumberOfLinesForTheTitle(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ExperimentalLimitTheNumberOfLinesForTheTitle.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ExperimentalLimitTheNumberOfLinesForTheTitle Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ExperimentalLimitTheNumberOfLinesForTheTitle Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ExperimentalLimitTheNumberOfLinesForTheTitle>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.HeaderTypeNumeric.ExperimentalLimitTheNumberOfLinesForTheTitle.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.HeaderTypeNumeric.ExperimentalLimitTheNumberOfLinesForTheTitle.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ExperimentalLimitTheNumberOfLinesForTheTitle instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ExperimentalLimitTheNumberOfLinesForTheTitle, Mutable>(this);
            }
        }
    }
}
