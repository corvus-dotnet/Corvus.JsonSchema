...
public readonly partial struct Schema
{
    ...
    public readonly partial struct HeaderTypeNumericSideIndicator
    {
        ...
        /// <remarks>
        /// <para>
        /// Visibility of the side indicator
        /// </para>
        /// </remarks>
        [DebuggerDisplay("{DebuggerDisplay,nq}")]
        public readonly partial struct VisibilityOfTheSideIndicator
            : IJsonElement<VisibilityOfTheSideIndicator>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("ui5-manifest-schema.json#/definitions/HeaderType.Numeric.SideIndicator/properties/visible"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "ui5-manifest-schema.json#/definitions/HeaderType.Numeric.SideIndicator/properties/visible";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "ui5-manifest-schema.json#/definitions/HeaderType.Numeric.SideIndicator/properties/visible"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    JsonSchemaContext oneOfContext0 =
                        Corvus.Ui5ManifestBenchmark.Baseline.Schema.HeaderTypeNumericSideIndicator.VisibilityOfTheSideIndicator.OneOf0Entity.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf0SchemaEvaluationPath);
                    Corvus.Ui5ManifestBenchmark.Baseline.Schema.HeaderTypeNumericSideIndicator.VisibilityOfTheSideIndicator.OneOf0Entity.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext0);
                    ...
                    JsonSchemaContext oneOfContext1 =
                        Corvus.Ui5ManifestBenchmark.Baseline.Schema.SimpleBinding.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: OneOf1SchemaEvaluationPath);
                    Corvus.Ui5ManifestBenchmark.Baseline.Schema.SimpleBinding.JsonSchema.Evaluate(parentDocument, parentIndex, ref oneOfContext1);
