        ...
        public readonly partial struct DependenciesEntity
        {
            ...
            public readonly partial struct AdditionalPropertiesEntity
            {
...
#endif
                {
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.Schema.Http11jsonSchemaOrg1draft071schema.StringArray.Mutable(Mutable value)
                    {
                        return Corvus.Ui5ManifestBenchmark.Baseline.Schema.Http11jsonSchemaOrg1draft071schema.StringArray.Mutable.From(value);
                    }
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Baseline.Schema.Http11jsonSchemaOrg1draft071schema.StringArray.Mutable value)
                    {
                        return From(value);
                    }
                    ...
                    public TResult Match<TContext, TResult>(
                        ...
                        Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.Http11jsonSchemaOrg1draft071schema.DependenciesEntity.AdditionalPropertiesEntity.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                    {
                        ...
                        {
                            return matchStringArray(Corvus.Ui5ManifestBenchmark.Baseline.Schema.Http11jsonSchemaOrg1draft071schema.StringArray.Mutable.From(this), context);
                        }
                    ...
                    public TResult Match<TResult>(
                        ...
                        Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.Http11jsonSchemaOrg1draft071schema.DependenciesEntity.AdditionalPropertiesEntity.Mutable, TResult> defaultMatch)
                    {
                        if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.Http11jsonSchemaOrg1draft071schema.JsonSchema.Evaluate(_parent, _idx))
                        {
                        ...
                        if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.Http11jsonSchemaOrg1draft071schema.StringArray.JsonSchema.Evaluate(_parent, _idx))
                        {
                            return matchStringArray(Corvus.Ui5ManifestBenchmark.Baseline.Schema.Http11jsonSchemaOrg1draft071schema.StringArray.Mutable.From(this));
                        }
                    ...
                    public bool TryGetAsStringArray(out Corvus.Ui5ManifestBenchmark.Baseline.Schema.Http11jsonSchemaOrg1draft071schema.StringArray result)
                    {
                        if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.Http11jsonSchemaOrg1draft071schema.StringArray.JsonSchema.Evaluate(_parent, _idx))
                        {
                            result = Corvus.Ui5ManifestBenchmark.Baseline.Schema.Http11jsonSchemaOrg1draft071schema.StringArray.Mutable.From(this);
                            return true;
                        }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.Http11jsonSchemaOrg1draft071schema.DependenciesEntity.AdditionalPropertiesEntity.ArrayBuilder.Build value) {_arrayBuilder = value; _kind = Kind.ArrayBuilder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.Http11jsonSchemaOrg1draft071schema.DependenciesEntity.AdditionalPropertiesEntity.ArrayBuilder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.ArrayBuilder; }
