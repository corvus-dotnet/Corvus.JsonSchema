...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Http11jsonSchemaOrg1draft071schema
    {
...
#endif
        {
            ...
            public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.Schema.Http11jsonSchemaOrg1draft071schema(ItemsEntity value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator ItemsEntity(Corvus.Ui5ManifestBenchmark.Baseline.Schema.Http11jsonSchemaOrg1draft071schema value)
            {
                return From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.Schema.Http11jsonSchemaOrg1draft071schema.SchemaArray(ItemsEntity value)
            {
                return Corvus.Ui5ManifestBenchmark.Baseline.Schema.Http11jsonSchemaOrg1draft071schema.SchemaArray.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator ItemsEntity(Corvus.Ui5ManifestBenchmark.Baseline.Schema.Http11jsonSchemaOrg1draft071schema.SchemaArray value)
            {
                return From(value);
            }
            ...
            public bool TryGetAsSchemaArray(out Corvus.Ui5ManifestBenchmark.Baseline.Schema.Http11jsonSchemaOrg1draft071schema.SchemaArray result)
            {
                ...
                {
                    result = Corvus.Ui5ManifestBenchmark.Baseline.Schema.Http11jsonSchemaOrg1draft071schema.SchemaArray.From(this);
                    return true;
                }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.Http11jsonSchemaOrg1draft071schema.ItemsEntity, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.Http11jsonSchemaOrg1draft071schema.SchemaArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchSchemaArray(Corvus.Ui5ManifestBenchmark.Baseline.Schema.Http11jsonSchemaOrg1draft071schema.SchemaArray.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.Http11jsonSchemaOrg1draft071schema.ItemsEntity, TResult> defaultMatch)
            {
                if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.Http11jsonSchemaOrg1draft071schema.JsonSchema.Evaluate(_parent, _idx))
                {
                ...
                if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.Http11jsonSchemaOrg1draft071schema.SchemaArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchSchemaArray(Corvus.Ui5ManifestBenchmark.Baseline.Schema.Http11jsonSchemaOrg1draft071schema.SchemaArray.From(this));
                }
