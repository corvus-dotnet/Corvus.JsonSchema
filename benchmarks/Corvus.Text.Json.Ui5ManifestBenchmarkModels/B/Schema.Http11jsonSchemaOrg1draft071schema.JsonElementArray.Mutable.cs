    ...
    public readonly partial struct Http11jsonSchemaOrg1draft071schema
    {
        ...
        public readonly partial struct JsonElementArray
        {
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.Http11jsonSchemaOrg1draft071schema.JsonElementArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.Http11jsonSchemaOrg1draft071schema.JsonElementArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
