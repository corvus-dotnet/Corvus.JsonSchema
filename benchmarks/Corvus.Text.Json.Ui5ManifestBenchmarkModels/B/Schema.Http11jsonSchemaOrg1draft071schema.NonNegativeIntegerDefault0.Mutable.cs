    ...
    public readonly partial struct Http11jsonSchemaOrg1draft071schema
    {
        ...
        public readonly partial struct NonNegativeIntegerDefault0
        {
...
#endif
            {
                ...
                /// <summary>
                /// Gets a <see cref="NonNegativeIntegerDefault0"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="NonNegativeIntegerDefault0"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly NonNegativeIntegerDefault0 Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<NonNegativeIntegerDefault0>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="NonNegativeIntegerDefault0"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly NonNegativeIntegerDefault0 Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<NonNegativeIntegerDefault0>(_idx);
                }
