                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        while (objectValidation_enumerator.MoveNext())
                        {
                            ...
                            using (var fixedJsonString = FixedStringJsonDocument<Corvus.Ui5ManifestBenchmark.Baseline.JsonRegex>.Parse(parentDocument.GetPropertyNameRaw(objectValidation_currentIndex, true), parentDocument.ValueIsEscaped(objectValidation_currentIndex, true)))
                            {
                                JsonSchemaContext childContext =
                                    Corvus.Ui5ManifestBenchmark.Baseline.JsonRegex.JsonSchema.PushChildContext(
                                        fixedJsonString,
                                        0,
                                        ref context,
                                        schemaEvaluationPath: PropertyNamesSchemaEvaluationPath);

                                Corvus.Ui5ManifestBenchmark.Baseline.JsonRegex.JsonSchema.Evaluate(fixedJsonString, 0, ref childContext);
                            ...
                            {
                                JsonSchemaContext childContext1 = Corvus.Ui5ManifestBenchmark.Baseline.Schema.Http11jsonSchemaOrg1draft071schema.JsonSchema.PushChildContextUnescaped(
                                    parentDocument,
                                ...
                                Corvus.Ui5ManifestBenchmark.Baseline.Schema.Http11jsonSchemaOrg1draft071schema.JsonSchema.Evaluate(parentDocument, objectValidation_currentIndex, ref childContext1);
