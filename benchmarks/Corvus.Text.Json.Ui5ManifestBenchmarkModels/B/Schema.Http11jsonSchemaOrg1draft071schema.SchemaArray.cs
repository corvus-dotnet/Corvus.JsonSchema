...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Http11jsonSchemaOrg1draft071schema
    {
...
#endif
        {
            ...
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.Http11jsonSchemaOrg1draft071schema this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Ui5ManifestBenchmark.Baseline.Schema.Http11jsonSchemaOrg1draft071schema>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.Schema.Http11jsonSchemaOrg1draft071schema> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.Schema.Http11jsonSchemaOrg1draft071schema>(_parent, _idx);
            }
