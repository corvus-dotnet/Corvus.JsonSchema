    ...
    public readonly partial struct Http11jsonSchemaOrg1draft071schema
    {
        ...
        public readonly partial struct SimpleTypes
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(SimpleTypes instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SimpleTypes"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SimpleTypes(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SimpleTypes.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly SimpleTypes Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly SimpleTypes Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SimpleTypes>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SimpleTypes instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<SimpleTypes, Mutable>(this);
            }
        }
    }
}
