...
public readonly partial struct Schema
{
    ...
    /// <remarks>
    /// <para>
    /// Parameters for an intent based navigation
    /// </para>
    /// </remarks>
    [DebuggerDisplay("{DebuggerDisplay,nq}")]
    public readonly partial struct IbnActionParameters
#if NET8_0_OR_GREATER
        : IJsonElement<IbnActionParameters>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IbnActionParameters"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal IbnActionParameters(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static IbnActionParameters DefaultInstance { get; }

        /// <summary>
        /// Gets the <c>ibnTarget</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public Corvus.Text.Json.JsonElement IbnTarget
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IbnTargetUtf8, out Corvus.Text.Json.JsonElement value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in IbnActionParameters left, in IbnActionParameters right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in IbnActionParameters left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(IbnActionParameters instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator IbnActionParameters(JsonElement instance)
        {
            return IbnActionParameters.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IbnActionParameters From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IbnActionParameters ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<IbnActionParameters>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IbnActionParameters ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<IbnActionParameters>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IbnActionParameters ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<IbnActionParameters>(json, options);
        }
        ...
        /// </exception>
        public static IbnActionParameters ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<IbnActionParameters>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out IbnActionParameters? result)
        {
            return JsonElementHelpers.TryParseValue<IbnActionParameters>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new IbnActionParameters(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static IbnActionParameters IJsonElement<IbnActionParameters>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"IbnActionParameters: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="IbnActionParameters"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="IbnActionParameters"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public IbnActionParameters Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<IbnActionParameters>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="IbnActionParameters"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public IbnActionParameters Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<IbnActionParameters>(_idx);
            }
        ...
        {
            /// <summary>
            /// Gets the JSON property name for <see cref="IbnTarget"/>.
            /// </summary>
            public const string IbnTarget = "ibnTarget";

            /// <summary>
            /// Gets the JSON property name for <see cref="IbnTarget"/>.
            /// </summary>
            public static ReadOnlySpan<byte> IbnTargetUtf8 => "ibnTarget"u8;
        }
        ...
        {
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="IbnTarget"/>.
            /// </summary>
