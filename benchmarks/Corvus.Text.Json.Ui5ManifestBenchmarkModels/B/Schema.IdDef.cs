...
public readonly partial struct Schema
{
    ...
    public readonly partial struct IdDef
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IdDef"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal IdDef(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static IdDef DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(IdDef value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in IdDef left, in IdDef right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in IdDef left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(IdDef instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator IdDef(JsonElement instance)
        {
            return IdDef.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IdDef From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IdDef ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<IdDef>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IdDef ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<IdDef>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IdDef ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<IdDef>(json, options);
        }
        ...
        /// </exception>
        public static IdDef ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<IdDef>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out IdDef? result)
        {
            return JsonElementHelpers.TryParseValue<IdDef>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new IdDef(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static IdDef IJsonElement<IdDef>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"IdDef: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="IdDef"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="IdDef"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        {
            CheckValidInstance();
            return _parent.CloneElement<IdDef>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="IdDef"/> that lives for the lifetime of its
        ...
        public IdDef Freeze()
        {
            ...
            {
                return mutable.FreezeElement<IdDef>(_idx);
            }
