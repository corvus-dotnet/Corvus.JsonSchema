...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Identifier
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.Target TargetValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TargetValueUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.Target value))
                    {
                        return value;
                    }
