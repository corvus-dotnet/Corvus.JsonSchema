        ...
        public readonly partial struct RequiredComponentName
        {
            ...
            public readonly partial struct ComponentNameEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(ComponentNameEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ComponentNameEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ComponentNameEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ComponentNameEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ComponentNameEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ComponentNameEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ComponentNameEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(ComponentNameEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<ComponentNameEntity, Mutable>(this);
                }
            }
        }
    }
