...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ImplementingComponentDef
    {
        ...
        public readonly partial struct RequiredComponentName
            : IJsonElement<RequiredComponentName>
        {
            public static partial class JsonSchema
            {
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyComponentNamePresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("componentName"u8, buffer, out written);
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyComponentNameNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("componentName"u8, buffer, out written);

                private const int RequiredOffsetForComponentName = 0;
                private const uint RequiredBitForComponentName = 0b00000000000000000000000000000001;

                private const uint RequiredBitMask0 =
                    RequiredBitForComponentName;
                private static readonly JsonSchemaPathProvider BindingSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/binding/$ref"u8, buffer, out written);
                ...
                private static readonly JsonSchemaPathProvider PagesSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/pages/$ref"u8, buffer, out written);
                ...
                private static void MatchBinding(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    ...
                    JsonSchemaContext childContext =
                        Corvus.Ui5ManifestBenchmark.Baseline.JsonString.JsonSchema.PushChildContextUnescaped(
                            ...
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.BindingUtf8,
                            evaluationPath: BindingSchemaEvaluationPath);
                ...
                private static void MatchComponentName(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    ...
                    JsonSchemaContext childContext1 =
                        Corvus.Ui5ManifestBenchmark.Baseline.Schema.ImplementingComponentDef.RequiredComponentName.ComponentNameEntity.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Corvus.Ui5ManifestBenchmark.Baseline.Schema.ImplementingComponentDef.RequiredComponentName.ComponentNameEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                    ...
                    requiredBitBuffer[RequiredOffsetForComponentName] |= RequiredBitForComponentName;
                }
                ...
                private static void MatchPages(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    ...
                    JsonSchemaContext childContext2 =
                        Corvus.Ui5ManifestBenchmark.Baseline.Schema.ComponentPagesDef.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Corvus.Ui5ManifestBenchmark.Baseline.Schema.ComponentPagesDef.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
                    context.CommitChildContext(childContext2.IsMatch, ref childContext2);
                }

                private static void MatchSettings(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext3 =
                        Corvus.Ui5ManifestBenchmark.Baseline.Schema.ComponentSettingDef.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Corvus.Ui5ManifestBenchmark.Baseline.Schema.ComponentSettingDef.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext3);
                ...
                private static PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
                {
                    return new PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator>([
                        (static () => JsonPropertyNames.BindingUtf8, MatchBinding),
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("ui5-manifest-schema.json#/definitions/implementingComponent_def/oneOf/0"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "ui5-manifest-schema.json#/definitions/implementingComponent_def/oneOf/0";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "ui5-manifest-schema.json#/definitions/implementingComponent_def/oneOf/0"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyComponentNamePresent, "componentName"u8, "required"u8);
                        }
                        ...
                        {
                            if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForComponentName] & RequiredBitForComponentName) == 0)
                            {
                                context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyComponentNameNotPresent, "componentName"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyComponentNamePresent, "componentName"u8, "required"u8);
