    ...
    public readonly partial struct JsonSchemaForSapAppNamespace
    {
        ...
        public readonly partial struct OpenSourceArray
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(OpenSourceArray instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="OpenSourceArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator OpenSourceArray(Mutable instance)
                {
                ...
                public Corvus.Ui5ManifestBenchmark.Baseline.Schema.OpenSource.Mutable this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.Ui5ManifestBenchmark.Baseline.Schema.OpenSource.Mutable>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.Schema.OpenSource.Mutable> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.Schema.OpenSource.Mutable>(_parent, _idx);
                }
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"OpenSourceArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetItem(int itemIndex, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.OpenSource.Source value)
                {
                    CheckValidInstance();
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void InsertItem(int itemIndex, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.OpenSource.Source value)
                {
                    CheckValidInstance();
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void AddItem(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.OpenSource.Source value)
                {
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Remove(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.OpenSource item)
                {
                    CheckValidInstance();
                    if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.Ui5ManifestBenchmark.Baseline.Schema.OpenSource>(this, in item))
                    {
                        return false;
                    }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void RemoveWhere(JsonPredicate<Corvus.Ui5ManifestBenchmark.Baseline.Schema.OpenSource> predicate)
                {
                    CheckValidInstance();
                    JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.Ui5ManifestBenchmark.Baseline.Schema.OpenSource>(this, predicate);
                    _documentVersion = _parent.Version;
                }
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Replace(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.OpenSource oldItem, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.OpenSource.Source newItem)
                {
                    CheckValidInstance();
                    ...
                    var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.Schema.OpenSource>(_parent, _idx);

                    while (enumerator.MoveNext())
                    {
                        Corvus.Ui5ManifestBenchmark.Baseline.Schema.OpenSource current = enumerator.Current;
                ...
                /// </para>
                /// </remarks>
                public readonly OpenSourceArray Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly OpenSourceArray Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<OpenSourceArray>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapAppNamespace.OpenSourceArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(OpenSourceArray instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapAppNamespace.OpenSourceArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<OpenSourceArray, Mutable>(this);
            }
        }
    }
}
