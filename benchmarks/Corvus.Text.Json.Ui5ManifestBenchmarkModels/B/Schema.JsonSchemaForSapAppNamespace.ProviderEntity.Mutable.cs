    ...
    public readonly partial struct JsonSchemaForSapAppNamespace
    {
        ...
        public readonly partial struct ProviderEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ProviderEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ProviderEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ProviderEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ProviderEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ProviderEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ProviderEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ProviderEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ProviderEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ProviderEntity, Mutable>(this);
            }
        }
    }
}
