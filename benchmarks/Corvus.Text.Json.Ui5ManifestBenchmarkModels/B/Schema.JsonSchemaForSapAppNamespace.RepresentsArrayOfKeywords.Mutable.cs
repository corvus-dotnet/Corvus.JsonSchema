    ...
    public readonly partial struct JsonSchemaForSapAppNamespace
    {
        ...
        public readonly partial struct RepresentsArrayOfKeywords
        {
...
#endif
            {
                ...
                /// </summary>
                public Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapAppNamespace.RepresentsArrayOfKeywords.TechnicalAttributesEntityArray.Mutable TechnicalAttributes
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TechnicalAttributesUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapAppNamespace.RepresentsArrayOfKeywords.TechnicalAttributesEntityArray.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetTechnicalAttributes(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapAppNamespace.RepresentsArrayOfKeywords.TechnicalAttributesEntityArray.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetTechnicalAttributes<TContext>(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapAppNamespace.RepresentsArrayOfKeywords.TechnicalAttributesEntityArray.Source<TContext> value)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapAppNamespace.RepresentsArrayOfKeywords.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapAppNamespace.RepresentsArrayOfKeywords.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapAppNamespace.RepresentsArrayOfKeywords.TechnicalAttributesEntityArray.Source technicalAttributes = default)
                {
                ...
                /// Creates an instance of a <see cref="RepresentsArrayOfKeywords"/>.
                /// </summary>
                public void Create(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Tag.Source keywords, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapAppNamespace.RepresentsArrayOfKeywords.TechnicalAttributesEntityArray.Source technicalAttributes = default)
                {
                ...
                internal static void Create<TContext>(
                    ...
                    in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapAppNamespace.RepresentsArrayOfKeywords.TechnicalAttributesEntityArray.Source<TContext> technicalAttributes = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Tag.Source keywords, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapAppNamespace.RepresentsArrayOfKeywords.TechnicalAttributesEntityArray.Source technicalAttributes = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
