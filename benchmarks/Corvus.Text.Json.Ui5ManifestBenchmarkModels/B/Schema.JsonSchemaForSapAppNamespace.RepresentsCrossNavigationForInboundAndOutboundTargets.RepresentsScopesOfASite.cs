    ...
    public readonly partial struct JsonSchemaForSapAppNamespace
    {
        ...
        public readonly partial struct RepresentsCrossNavigationForInboundAndOutboundTargets
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="RepresentsScopesOfASite"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal RepresentsScopesOfASite(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static RepresentsScopesOfASite DefaultInstance { get; }
                ...
                /// </returns>
                public static bool operator ==(in RepresentsScopesOfASite left, in RepresentsScopesOfASite right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in RepresentsScopesOfASite left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(RepresentsScopesOfASite instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsScopesOfASite(JsonElement instance)
                {
                    return RepresentsScopesOfASite.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RepresentsScopesOfASite From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RepresentsScopesOfASite ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RepresentsScopesOfASite>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RepresentsScopesOfASite ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RepresentsScopesOfASite>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RepresentsScopesOfASite ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RepresentsScopesOfASite>(json, options);
                }
                ...
                /// </exception>
                public static RepresentsScopesOfASite ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<RepresentsScopesOfASite>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsScopesOfASite? result)
                {
                    return JsonElementHelpers.TryParseValue<RepresentsScopesOfASite>(ref reader, out result);
                }
...
#if NET
                static RepresentsScopesOfASite IJsonElement<RepresentsScopesOfASite>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsScopesOfASite: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public RepresentsScopesOfASite Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public RepresentsScopesOfASite Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<RepresentsScopesOfASite>(_idx);
                    }
