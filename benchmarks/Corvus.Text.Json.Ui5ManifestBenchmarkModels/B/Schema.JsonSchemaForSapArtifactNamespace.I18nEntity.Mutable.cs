    ...
    public readonly partial struct JsonSchemaForSapArtifactNamespace
    {
        ...
        public readonly partial struct I18nEntity
        {
...
#endif
            {
                ...
                public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapArtifactNamespace.I18nEntity.OneOf0Entity.Mutable(Mutable value)
                {
                    return Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapArtifactNamespace.I18nEntity.OneOf0Entity.Mutable.From(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapArtifactNamespace.I18nEntity.OneOf0Entity.Mutable value)
                {
                    return From(value);
                }
                ...
                public bool TryGetAsOneOf0Entity(out Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapArtifactNamespace.I18nEntity.OneOf0Entity result)
                {
                    ...
                    {
                        result = Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapArtifactNamespace.I18nEntity.OneOf0Entity.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapArtifactNamespace.I18nEntity.OneOf0Entity instance) => new(JsonElement.From(instance));
