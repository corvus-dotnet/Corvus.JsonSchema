...
public readonly partial struct Schema
{
    ...
    public readonly partial struct JsonSchemaForSapArtifactNamespace
    {
...
#endif
        {
            ...
            /// <summary>
            /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapArtifactNamespace.I18nEntity.OneOf0Entity"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapArtifactNamespace.I18nEntity.OneOf0Entity(I18nEntity value)
            {
                return Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapArtifactNamespace.I18nEntity.OneOf0Entity.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapArtifactNamespace.I18nEntity.OneOf0Entity"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator I18nEntity(Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapArtifactNamespace.I18nEntity.OneOf0Entity value)
            {
                return From(value);
            }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapArtifactNamespace.I18nEntity.OneOf0Entity" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsOneOf0Entity(out Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapArtifactNamespace.I18nEntity.OneOf0Entity result)
            {
                if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapArtifactNamespace.I18nEntity.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapArtifactNamespace.I18nEntity.OneOf0Entity.From(this);
                    return true;
                }
