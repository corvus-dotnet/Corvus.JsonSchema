    ...
    public readonly partial struct JsonSchemaForSapArtifactNamespace
    {
        ...
        public readonly partial struct RepresentsMandatorySemanticVersionOfTheArtifact
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Baseline.Schema.Semanticversion.Mutable Version
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.Semanticversion.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetVersion(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Semanticversion.Source value)
                {
                    CheckValidInstance();
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapArtifactNamespace.RepresentsMandatorySemanticVersionOfTheArtifact.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapArtifactNamespace.RepresentsMandatorySemanticVersionOfTheArtifact.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Semanticversion.Source version)
                {
                ...
                /// Creates an instance of a <see cref="RepresentsMandatorySemanticVersionOfTheArtifact"/>.
                /// </summary>
                public void Create(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Semanticversion.Source version)
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Semanticversion.Source version, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
