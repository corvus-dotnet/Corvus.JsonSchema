        ...
        public readonly partial struct OutcomesEntityArray
        {
            ...
            public readonly partial struct OutcomesEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(OutcomesEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="OutcomesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator OutcomesEntity(Mutable instance)
                    {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapBpaTaskNamespace.OutcomesEntityArray.OutcomesEntity.RepresentsTheIdOfTheOutcome.Mutable Id
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IdUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapBpaTaskNamespace.OutcomesEntityArray.OutcomesEntity.RepresentsTheIdOfTheOutcome.Mutable value))
                            {
                                return value;
                            }
                    ...
                    public void SetId(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapBpaTaskNamespace.OutcomesEntityArray.OutcomesEntity.RepresentsTheIdOfTheOutcome.Source value)
                    {
                        CheckValidInstance();
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"OutcomesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly OutcomesEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly OutcomesEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<OutcomesEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapBpaTaskNamespace.OutcomesEntityArray.OutcomesEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(OutcomesEntity instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapBpaTaskNamespace.OutcomesEntityArray.OutcomesEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// <summary>
                    /// Creates an instance of a <see cref="OutcomesEntity"/>.
                    /// </summary>
                    internal static void Create(
                        ref ComplexValueBuilder builder,
                        in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapBpaTaskNamespace.OutcomesEntityArray.OutcomesEntity.RepresentsTheIdOfTheOutcome.Source id = default,
                    ...
                    /// Creates an instance of a <see cref="OutcomesEntity"/>.
                    /// </summary>
                    public void Create(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapBpaTaskNamespace.OutcomesEntityArray.OutcomesEntity.RepresentsTheIdOfTheOutcome.Source id = default, in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source label = default)
                    {
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapBpaTaskNamespace.OutcomesEntityArray.OutcomesEntity.RepresentsTheIdOfTheOutcome.Source id = default, in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source label = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                ...
                {
                    return workspace.CreateBuilder<OutcomesEntity, Mutable>(this);
                }
            }
        }
    }
