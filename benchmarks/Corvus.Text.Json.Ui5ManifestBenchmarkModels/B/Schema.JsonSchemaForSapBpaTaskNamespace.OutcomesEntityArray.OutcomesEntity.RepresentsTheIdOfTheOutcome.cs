        ...
        public readonly partial struct OutcomesEntityArray
        {
            ...
            public readonly partial struct OutcomesEntity
            {
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="RepresentsTheIdOfTheOutcome"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal RepresentsTheIdOfTheOutcome(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static RepresentsTheIdOfTheOutcome DefaultInstance { get; }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static explicit operator string(RepresentsTheIdOfTheOutcome value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                    ...
                    /// </returns>
                    public static bool operator ==(in RepresentsTheIdOfTheOutcome left, in RepresentsTheIdOfTheOutcome right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in RepresentsTheIdOfTheOutcome left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator JsonElement(RepresentsTheIdOfTheOutcome instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RepresentsTheIdOfTheOutcome(JsonElement instance)
                    {
                        return RepresentsTheIdOfTheOutcome.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RepresentsTheIdOfTheOutcome From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RepresentsTheIdOfTheOutcome ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RepresentsTheIdOfTheOutcome>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RepresentsTheIdOfTheOutcome ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RepresentsTheIdOfTheOutcome>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RepresentsTheIdOfTheOutcome ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RepresentsTheIdOfTheOutcome>(json, options);
                    }
                    ...
                    /// </exception>
                    public static RepresentsTheIdOfTheOutcome ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<RepresentsTheIdOfTheOutcome>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsTheIdOfTheOutcome? result)
                    {
                        return JsonElementHelpers.TryParseValue<RepresentsTheIdOfTheOutcome>(ref reader, out result);
                    }
...
#if NET
                    static RepresentsTheIdOfTheOutcome IJsonElement<RepresentsTheIdOfTheOutcome>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RepresentsTheIdOfTheOutcome: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public RepresentsTheIdOfTheOutcome Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public RepresentsTheIdOfTheOutcome Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<RepresentsTheIdOfTheOutcome>(_idx);
                        }
