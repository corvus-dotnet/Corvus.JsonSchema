...
public readonly partial struct Schema
{
    ...
    public readonly partial struct JsonSchemaForSapBpaTaskNamespace
    {
        ...
        public readonly partial struct RepresentsTheCategoryOfTheTaskUi
#if NET8_0_OR_GREATER
            : IJsonElement<RepresentsTheCategoryOfTheTaskUi>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RepresentsTheCategoryOfTheTaskUi"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RepresentsTheCategoryOfTheTaskUi(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RepresentsTheCategoryOfTheTaskUi DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(RepresentsTheCategoryOfTheTaskUi value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in RepresentsTheCategoryOfTheTaskUi left, in RepresentsTheCategoryOfTheTaskUi right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RepresentsTheCategoryOfTheTaskUi left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(RepresentsTheCategoryOfTheTaskUi instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RepresentsTheCategoryOfTheTaskUi(JsonElement instance)
            {
                return RepresentsTheCategoryOfTheTaskUi.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheCategoryOfTheTaskUi From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheCategoryOfTheTaskUi ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheCategoryOfTheTaskUi>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheCategoryOfTheTaskUi ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheCategoryOfTheTaskUi>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheCategoryOfTheTaskUi ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheCategoryOfTheTaskUi>(json, options);
            }
            ...
            /// </exception>
            public static RepresentsTheCategoryOfTheTaskUi ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheCategoryOfTheTaskUi>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsTheCategoryOfTheTaskUi? result)
            {
                return JsonElementHelpers.TryParseValue<RepresentsTheCategoryOfTheTaskUi>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RepresentsTheCategoryOfTheTaskUi(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static RepresentsTheCategoryOfTheTaskUi IJsonElement<RepresentsTheCategoryOfTheTaskUi>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RepresentsTheCategoryOfTheTaskUi: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RepresentsTheCategoryOfTheTaskUi"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RepresentsTheCategoryOfTheTaskUi"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public RepresentsTheCategoryOfTheTaskUi Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RepresentsTheCategoryOfTheTaskUi>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RepresentsTheCategoryOfTheTaskUi"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public RepresentsTheCategoryOfTheTaskUi Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RepresentsTheCategoryOfTheTaskUi>(_idx);
                }
