...
public readonly partial struct Schema
{
    ...
    public readonly partial struct JsonSchemaForSapCardNamespace
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeTable Content
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ContentUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeTable value))
                    {
                        return value;
                    }
            ...
            public bool TryGetAsWithTypeTable(out Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf4Entity.WithTypeTable result)
            {
                ...
                {
                    result = Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf4Entity.WithTypeTable.From(this);
                    return true;
                }
            ...
            public bool TryGetAsThenEntity(out Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf4Entity.ThenEntity result)
            {
                ...
                {
                    result = Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf4Entity.ThenEntity.From(this);
                    return true;
                }
