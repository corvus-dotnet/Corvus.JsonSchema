    ...
    public readonly partial struct JsonSchemaForSapCardNamespace
    {
        ...
        public readonly partial struct AllOf6Entity
        {
...
#endif
            {
                ...
                /// <param name="matchCorvusUi5ManifestBenchmarkBaselineSchemaJsonSchemaForSapCardNamespaceAllOf6EntityThenEntity">Match a <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf6Entity.ThenEntity"/>.</param>
                ...
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf6Entity.ThenEntity, TContext, TResult> matchCorvusUi5ManifestBenchmarkBaselineSchemaJsonSchemaForSapCardNamespaceAllOf6EntityThenEntity,
                    Matcher<AllOf6Entity, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf6Entity.WithTypeComponent.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchCorvusUi5ManifestBenchmarkBaselineSchemaJsonSchemaForSapCardNamespaceAllOf6EntityThenEntity(Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf6Entity.ThenEntity.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf6Entity.ThenEntity, TResult> matchCorvusUi5ManifestBenchmarkBaselineSchemaJsonSchemaForSapCardNamespaceAllOf6EntityThenEntity,
                    Matcher<AllOf6Entity, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf6Entity.WithTypeComponent.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchCorvusUi5ManifestBenchmarkBaselineSchemaJsonSchemaForSapCardNamespaceAllOf6EntityThenEntity(Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf6Entity.ThenEntity.From(this));
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf6Entity.WithTypeComponent" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsWithTypeComponent(out Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf6Entity.WithTypeComponent result)
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf6Entity.WithTypeComponent.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf6Entity.WithTypeComponent.Mutable.From(this);
                        return true;
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf6Entity.ThenEntity" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsThenEntity(out Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf6Entity.ThenEntity result)
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf6Entity.ThenEntity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf6Entity.ThenEntity.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf6Entity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf6Entity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
