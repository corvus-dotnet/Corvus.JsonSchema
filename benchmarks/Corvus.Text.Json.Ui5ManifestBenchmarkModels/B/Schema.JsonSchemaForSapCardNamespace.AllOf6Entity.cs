...
public readonly partial struct Schema
{
    ...
    public readonly partial struct JsonSchemaForSapCardNamespace
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeComponent Content
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ContentUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeComponent value))
                    {
                        return value;
                    }
            ...
            public bool TryGetAsWithTypeComponent(out Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf6Entity.WithTypeComponent result)
            {
                ...
                {
                    result = Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf6Entity.WithTypeComponent.From(this);
                    return true;
                }
            ...
            public bool TryGetAsThenEntity(out Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf6Entity.ThenEntity result)
            {
                ...
                {
                    result = Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf6Entity.ThenEntity.From(this);
                    return true;
                }
