...
public readonly partial struct Schema
{
    ...
    public readonly partial struct JsonSchemaForSapCardNamespace
    {
        ...
        public readonly partial struct AllOf7Entity
        {
            ...
            public readonly partial struct WithTypeCalendar
#if NET8_0_OR_GREATER
                : IJsonElement<WithTypeCalendar>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="WithTypeCalendar"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal WithTypeCalendar(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static WithTypeCalendar DefaultInstance { get; }
                ...
                /// </summary>
                public Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf7Entity.WithTypeCalendar.TypeEntity Type
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf7Entity.WithTypeCalendar.TypeEntity value))
                        {
                            return value;
                        }
                ...
                /// </returns>
                public static bool operator ==(in WithTypeCalendar left, in WithTypeCalendar right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in WithTypeCalendar left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(WithTypeCalendar instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator WithTypeCalendar(JsonElement instance)
                {
                    return WithTypeCalendar.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static WithTypeCalendar From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static WithTypeCalendar ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<WithTypeCalendar>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static WithTypeCalendar ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<WithTypeCalendar>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static WithTypeCalendar ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<WithTypeCalendar>(json, options);
                }
                ...
                /// </exception>
                public static WithTypeCalendar ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<WithTypeCalendar>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out WithTypeCalendar? result)
                {
                    return JsonElementHelpers.TryParseValue<WithTypeCalendar>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new WithTypeCalendar(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static WithTypeCalendar IJsonElement<WithTypeCalendar>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"WithTypeCalendar: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="WithTypeCalendar"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="WithTypeCalendar"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public WithTypeCalendar Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<WithTypeCalendar>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="WithTypeCalendar"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public WithTypeCalendar Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<WithTypeCalendar>(_idx);
                    }
