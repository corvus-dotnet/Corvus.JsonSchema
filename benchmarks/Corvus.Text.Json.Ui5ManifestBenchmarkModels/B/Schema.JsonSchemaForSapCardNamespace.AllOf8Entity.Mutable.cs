...
public readonly partial struct Schema
{
    ...
    public readonly partial struct JsonSchemaForSapCardNamespace
    {
        ...
        public readonly partial struct AllOf8Entity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(AllOf8Entity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="AllOf8Entity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AllOf8Entity(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Baseline.AdaptiveCard.Mutable Content
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ContentUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.AdaptiveCard.Mutable value))
                        {
                            return value;
                        }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new AllOf8Entity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                public void SetContent(in Corvus.Ui5ManifestBenchmark.Baseline.AdaptiveCard.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetContent<TContext>(in Corvus.Ui5ManifestBenchmark.Baseline.AdaptiveCard.Source<TContext> value)
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AllOf8Entity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="AllOf8Entity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="AllOf8Entity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly AllOf8Entity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<AllOf8Entity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="AllOf8Entity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly AllOf8Entity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<AllOf8Entity>(_idx);
                }
                ...
                /// <param name="matchCorvusUi5ManifestBenchmarkBaselineSchemaJsonSchemaForSapCardNamespaceAllOf8EntityThenEntity">Match a <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf8Entity.ThenEntity"/>.</param>
                ...
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf8Entity.ThenEntity, TContext, TResult> matchCorvusUi5ManifestBenchmarkBaselineSchemaJsonSchemaForSapCardNamespaceAllOf8EntityThenEntity,
                    Matcher<AllOf8Entity, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf8Entity.WithTypeAdaptiveCard.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchCorvusUi5ManifestBenchmarkBaselineSchemaJsonSchemaForSapCardNamespaceAllOf8EntityThenEntity(Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf8Entity.ThenEntity.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf8Entity.ThenEntity, TResult> matchCorvusUi5ManifestBenchmarkBaselineSchemaJsonSchemaForSapCardNamespaceAllOf8EntityThenEntity,
                    Matcher<AllOf8Entity, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf8Entity.WithTypeAdaptiveCard.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchCorvusUi5ManifestBenchmarkBaselineSchemaJsonSchemaForSapCardNamespaceAllOf8EntityThenEntity(Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf8Entity.ThenEntity.From(this));
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf8Entity.WithTypeAdaptiveCard" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsWithTypeAdaptiveCard(out Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf8Entity.WithTypeAdaptiveCard result)
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf8Entity.WithTypeAdaptiveCard.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf8Entity.WithTypeAdaptiveCard.Mutable.From(this);
                        return true;
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf8Entity.ThenEntity" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsThenEntity(out Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf8Entity.ThenEntity result)
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf8Entity.ThenEntity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf8Entity.ThenEntity.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf8Entity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(AllOf8Entity instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf8Entity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="AllOf8Entity"/>.
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.Ui5ManifestBenchmark.Baseline.AdaptiveCard.Source content = default)
                {
                ...
                /// Creates an instance of a <see cref="AllOf8Entity"/>.
                /// </summary>
                public void Create(in Corvus.Ui5ManifestBenchmark.Baseline.AdaptiveCard.Source content = default)
                {
                ...
                internal static void Create<TContext>(
                    ...
                    in Corvus.Ui5ManifestBenchmark.Baseline.AdaptiveCard.Source<TContext> content = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
                ...
                /// Creates an instance of a <see cref="AllOf8Entity"/>.
                /// </summary>
                public void Create<TContext>(in TContext context, in Corvus.Ui5ManifestBenchmark.Baseline.AdaptiveCard.Source<TContext> content = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.AdaptiveCard.Source content = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Ui5ManifestBenchmark.Baseline.AdaptiveCard.Source<TContext> content = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
            ...
            {
                return workspace.CreateBuilder<AllOf8Entity, Mutable>(this);
            }
        }
    }
}
