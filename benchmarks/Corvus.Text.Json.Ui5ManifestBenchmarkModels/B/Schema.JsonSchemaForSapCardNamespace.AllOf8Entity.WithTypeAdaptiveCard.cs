    ...
    public readonly partial struct JsonSchemaForSapCardNamespace
    {
        ...
        public readonly partial struct AllOf8Entity
        {
            ...
            public readonly partial struct WithTypeAdaptiveCard
                ...
                : IJsonElement<WithTypeAdaptiveCard>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="WithTypeAdaptiveCard"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal WithTypeAdaptiveCard(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static WithTypeAdaptiveCard DefaultInstance { get; }
                ...
                /// </summary>
                public Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf8Entity.WithTypeAdaptiveCard.TypeEntity Type
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf8Entity.WithTypeAdaptiveCard.TypeEntity value))
                        {
                            return value;
                        }
                ...
                /// </returns>
                public static bool operator ==(in WithTypeAdaptiveCard left, in WithTypeAdaptiveCard right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in WithTypeAdaptiveCard left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(WithTypeAdaptiveCard instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator WithTypeAdaptiveCard(JsonElement instance)
                {
                    return WithTypeAdaptiveCard.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static WithTypeAdaptiveCard From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static WithTypeAdaptiveCard ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<WithTypeAdaptiveCard>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static WithTypeAdaptiveCard ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<WithTypeAdaptiveCard>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static WithTypeAdaptiveCard ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<WithTypeAdaptiveCard>(json, options);
                }
                ...
                /// </exception>
                public static WithTypeAdaptiveCard ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<WithTypeAdaptiveCard>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out WithTypeAdaptiveCard? result)
                {
                    return JsonElementHelpers.TryParseValue<WithTypeAdaptiveCard>(ref reader, out result);
                }
...
#if NET
                static WithTypeAdaptiveCard IJsonElement<WithTypeAdaptiveCard>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"WithTypeAdaptiveCard: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public WithTypeAdaptiveCard Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public WithTypeAdaptiveCard Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<WithTypeAdaptiveCard>(_idx);
                    }
