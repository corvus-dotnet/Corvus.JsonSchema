        ...
        public readonly partial struct AllOf9Entity
        {
            ...
            public readonly partial struct ThenEntity
            {
...
#endif
                {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeWebPage.Mutable Content
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ContentUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeWebPage.Mutable value))
                            {
                                return value;
                            }
                    ...
                    public void SetContent(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeWebPage.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetContent<TContext>(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeWebPage.Source<TContext> value)
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf9Entity.ThenEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf9Entity.ThenEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// </summary>
                    internal static void Create(ref ComplexValueBuilder builder, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeWebPage.Source content = default)
                    {
                    ...
                    /// Creates an instance of a <see cref="ThenEntity"/>.
                    /// </summary>
                    public void Create(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeWebPage.Source content = default)
                    {
                    ...
                    internal static void Create<TContext>(
                        ...
                        in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeWebPage.Source<TContext> content = default)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                    {
                    ...
                    /// Creates an instance of a <see cref="ThenEntity"/>.
                    /// </summary>
                    public void Create<TContext>(in TContext context, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeWebPage.Source<TContext> content = default)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                    {
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeWebPage.Source content = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeWebPage.Source<TContext> content = default, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
