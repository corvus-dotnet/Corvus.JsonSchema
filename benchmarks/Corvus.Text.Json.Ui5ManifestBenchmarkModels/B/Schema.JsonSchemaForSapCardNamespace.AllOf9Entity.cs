...
public readonly partial struct Schema
{
    ...
    public readonly partial struct JsonSchemaForSapCardNamespace
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeWebPage Content
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ContentUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.ContentTypeWebPage value))
                    {
                        return value;
                    }
            ...
            public bool TryGetAsWithTypeWebPage(out Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf9Entity.WithTypeWebPage result)
            {
                ...
                {
                    result = Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf9Entity.WithTypeWebPage.From(this);
                    return true;
                }
            ...
            public bool TryGetAsThenEntity(out Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf9Entity.ThenEntity result)
            {
                ...
                {
                    result = Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.AllOf9Entity.ThenEntity.From(this);
                    return true;
                }
