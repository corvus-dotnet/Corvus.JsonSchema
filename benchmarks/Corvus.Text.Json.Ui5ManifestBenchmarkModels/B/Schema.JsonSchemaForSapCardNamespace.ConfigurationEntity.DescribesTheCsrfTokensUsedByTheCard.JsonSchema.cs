                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        else
                        {
                            ...
                            while (objectValidation_enumerator.MoveNext())
                            {
                                ...
                                {
                                    JsonSchemaContext childContext = Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationCsrfToken.JsonSchema.PushChildContextUnescaped(
                                        parentDocument,
                                    ...
                                    Corvus.Ui5ManifestBenchmark.Baseline.Schema.ConfigurationCsrfToken.JsonSchema.Evaluate(parentDocument, objectValidation_currentIndex, ref childContext);
