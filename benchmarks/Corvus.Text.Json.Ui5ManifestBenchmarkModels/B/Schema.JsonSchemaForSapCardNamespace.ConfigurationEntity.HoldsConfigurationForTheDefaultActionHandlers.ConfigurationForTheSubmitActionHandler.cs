...
public readonly partial struct Schema
{
    ...
    public readonly partial struct JsonSchemaForSapCardNamespace
    {
        ...
        public readonly partial struct ConfigurationEntity
        {
            ...
            /// </para>
            /// </remarks>
            public readonly partial struct HoldsConfigurationForTheDefaultActionHandlers
            {
                /// <summary>
                /// Generated from JSON Schema.
                /// </summary>
                ...
                public readonly partial struct ConfigurationForTheSubmitActionHandler
#if NET8_0_OR_GREATER
                    : IJsonElement<ConfigurationForTheSubmitActionHandler>,
                      IFormattable,
                      ISpanFormattable,
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="ConfigurationForTheSubmitActionHandler"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal ConfigurationForTheSubmitActionHandler(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static ConfigurationForTheSubmitActionHandler DefaultInstance { get; }
                    ...
                    /// </returns>
                    public static bool operator ==(in ConfigurationForTheSubmitActionHandler left, in ConfigurationForTheSubmitActionHandler right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in ConfigurationForTheSubmitActionHandler left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    public static implicit operator JsonElement(ConfigurationForTheSubmitActionHandler instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ConfigurationForTheSubmitActionHandler(JsonElement instance)
                    {
                        return ConfigurationForTheSubmitActionHandler.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static ConfigurationForTheSubmitActionHandler From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static ConfigurationForTheSubmitActionHandler ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<ConfigurationForTheSubmitActionHandler>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static ConfigurationForTheSubmitActionHandler ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<ConfigurationForTheSubmitActionHandler>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static ConfigurationForTheSubmitActionHandler ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<ConfigurationForTheSubmitActionHandler>(json, options);
                    }
                    ...
                    /// </exception>
                    public static ConfigurationForTheSubmitActionHandler ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<ConfigurationForTheSubmitActionHandler>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out ConfigurationForTheSubmitActionHandler? result)
                    {
                        return JsonElementHelpers.TryParseValue<ConfigurationForTheSubmitActionHandler>(ref reader, out result);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new ConfigurationForTheSubmitActionHandler(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                    static ConfigurationForTheSubmitActionHandler IJsonElement<ConfigurationForTheSubmitActionHandler>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ConfigurationForTheSubmitActionHandler: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="ConfigurationForTheSubmitActionHandler"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="ConfigurationForTheSubmitActionHandler"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public ConfigurationForTheSubmitActionHandler Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<ConfigurationForTheSubmitActionHandler>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="ConfigurationForTheSubmitActionHandler"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public ConfigurationForTheSubmitActionHandler Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<ConfigurationForTheSubmitActionHandler>(_idx);
                        }
