        ...
        public readonly partial struct ConfigurationEntity
        {
            ...
            public readonly partial struct HoldsConfigurationForTheDefaultActionHandlers
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(HoldsConfigurationForTheDefaultActionHandlers instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="HoldsConfigurationForTheDefaultActionHandlers"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator HoldsConfigurationForTheDefaultActionHandlers(Mutable instance)
                    {
                    ...
                    /// <summary>
                    /// Gets the (optional) <c>submit</c> property.
                    /// </summary>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.ConfigurationEntity.HoldsConfigurationForTheDefaultActionHandlers.ConfigurationForTheSubmitActionHandler.Mutable Submit
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SubmitUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.ConfigurationEntity.HoldsConfigurationForTheDefaultActionHandlers.ConfigurationForTheSubmitActionHandler.Mutable value))
                            {
                                return value;
                            }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new HoldsConfigurationForTheDefaultActionHandlers(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    public void SetSubmit(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.ConfigurationEntity.HoldsConfigurationForTheDefaultActionHandlers.ConfigurationForTheSubmitActionHandler.Source value)
                    {
                        CheckValidInstance();

                        if (value.IsUndefined)
                        {
                            JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.SubmitUtf8);
                            _documentVersion = _parent.Version;
                            return;
                        }

                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SubmitUtf8, out IJsonDocument? elementParent, out int elementIdx))
                        {
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetSubmit<TContext>(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.ConfigurationEntity.HoldsConfigurationForTheDefaultActionHandlers.ConfigurationForTheSubmitActionHandler.Source<TContext> value)
                    ...
                    /// <summary>
                    /// Remove the <c>submit</c> property, if present.
                    /// </summary>
                    /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                    public bool RemoveSubmit()
                    {
                        CheckValidInstance();
                        bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.SubmitUtf8);
                        _documentVersion = _parent.Version;
                        return result;
                    }
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"HoldsConfigurationForTheDefaultActionHandlers.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="HoldsConfigurationForTheDefaultActionHandlers"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="HoldsConfigurationForTheDefaultActionHandlers"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly HoldsConfigurationForTheDefaultActionHandlers Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<HoldsConfigurationForTheDefaultActionHandlers>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="HoldsConfigurationForTheDefaultActionHandlers"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly HoldsConfigurationForTheDefaultActionHandlers Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<HoldsConfigurationForTheDefaultActionHandlers>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.ConfigurationEntity.HoldsConfigurationForTheDefaultActionHandlers.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(HoldsConfigurationForTheDefaultActionHandlers instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.ConfigurationEntity.HoldsConfigurationForTheDefaultActionHandlers.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// </summary>
                    internal static void Create(ref ComplexValueBuilder builder, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.ConfigurationEntity.HoldsConfigurationForTheDefaultActionHandlers.ConfigurationForTheSubmitActionHandler.Source submit = default)
                    {
                    ...
                    /// Creates an instance of a <see cref="HoldsConfigurationForTheDefaultActionHandlers"/>.
                    /// </summary>
                    public void Create(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.ConfigurationEntity.HoldsConfigurationForTheDefaultActionHandlers.ConfigurationForTheSubmitActionHandler.Source submit = default)
                    {
                    ...
                    internal static void Create<TContext>(
                        ...
                        in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.ConfigurationEntity.HoldsConfigurationForTheDefaultActionHandlers.ConfigurationForTheSubmitActionHandler.Source<TContext> submit = default)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                    {
                    ...
                    /// Creates an instance of a <see cref="HoldsConfigurationForTheDefaultActionHandlers"/>.
                    /// </summary>
                    public void Create<TContext>(in TContext context, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.ConfigurationEntity.HoldsConfigurationForTheDefaultActionHandlers.ConfigurationForTheSubmitActionHandler.Source<TContext> submit = default)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                    {
                        Create(context, ref _builder, submit);
                    }
                ...
                {
                    return workspace.CreateBuilder<HoldsConfigurationForTheDefaultActionHandlers, Mutable>(this);
                }
            }
        }
    }
