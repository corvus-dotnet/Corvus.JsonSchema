    ...
    public readonly partial struct JsonSchemaForSapCardNamespace
    {
        ...
        public readonly partial struct RepresentCardFooterAttributes
        {
            ...
            public readonly partial struct ActionsStripItemArray
                ...
                : IJsonElement<ActionsStripItemArray>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="ActionsStripItemArray"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal ActionsStripItemArray(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static ActionsStripItemArray DefaultInstance { get; }
                ...
                public Corvus.Ui5ManifestBenchmark.Baseline.Schema.ActionsStripItem this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ActionsStripItem>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ActionsStripItem> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ActionsStripItem>(_parent, _idx);
                }
                ...
                /// </returns>
                public static bool operator ==(in ActionsStripItemArray left, in ActionsStripItemArray right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in ActionsStripItemArray left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(ActionsStripItemArray instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ActionsStripItemArray(JsonElement instance)
                {
                    return ActionsStripItemArray.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ActionsStripItemArray From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ActionsStripItemArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ActionsStripItemArray>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ActionsStripItemArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ActionsStripItemArray>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ActionsStripItemArray ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ActionsStripItemArray>(json, options);
                }
                ...
                /// </exception>
                public static ActionsStripItemArray ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<ActionsStripItemArray>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out ActionsStripItemArray? result)
                {
                    return JsonElementHelpers.TryParseValue<ActionsStripItemArray>(ref reader, out result);
                }
...
#if NET
                static ActionsStripItemArray IJsonElement<ActionsStripItemArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ActionsStripItemArray: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public ActionsStripItemArray Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public ActionsStripItemArray Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<ActionsStripItemArray>(_idx);
                    }
