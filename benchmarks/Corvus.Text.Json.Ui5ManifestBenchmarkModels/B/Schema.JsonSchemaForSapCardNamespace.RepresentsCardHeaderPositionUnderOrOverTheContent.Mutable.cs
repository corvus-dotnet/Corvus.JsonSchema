    ...
    public readonly partial struct JsonSchemaForSapCardNamespace
    {
        ...
        public readonly partial struct RepresentsCardHeaderPositionUnderOrOverTheContent
        {
...
#endif
            {
                ...
                public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.RepresentsCardHeaderPositionUnderOrOverTheContent.OneOf0Entity.Mutable(Mutable value)
                {
                    return Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.RepresentsCardHeaderPositionUnderOrOverTheContent.OneOf0Entity.Mutable.From(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.RepresentsCardHeaderPositionUnderOrOverTheContent.OneOf0Entity.Mutable value)
                {
                    return From(value);
                }
                ...
                public static explicit operator Mutable(RepresentsCardHeaderPositionUnderOrOverTheContent instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsCardHeaderPositionUnderOrOverTheContent"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsCardHeaderPositionUnderOrOverTheContent(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsCardHeaderPositionUnderOrOverTheContent.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsCardHeaderPositionUnderOrOverTheContent Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsCardHeaderPositionUnderOrOverTheContent Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsCardHeaderPositionUnderOrOverTheContent>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.RepresentsCardHeaderPositionUnderOrOverTheContent.Mutable, TContext, TResult> defaultMatch)
...
#endif
                {
                    ...
                    {
                        return matchOneOf0Entity(Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.RepresentsCardHeaderPositionUnderOrOverTheContent.OneOf0Entity.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.RepresentsCardHeaderPositionUnderOrOverTheContent.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.RepresentsCardHeaderPositionUnderOrOverTheContent.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchOneOf0Entity(Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.RepresentsCardHeaderPositionUnderOrOverTheContent.OneOf0Entity.Mutable.From(this));
                    }
                ...
                public bool TryGetAsOneOf0Entity(out Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.RepresentsCardHeaderPositionUnderOrOverTheContent.OneOf0Entity result)
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.RepresentsCardHeaderPositionUnderOrOverTheContent.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.RepresentsCardHeaderPositionUnderOrOverTheContent.OneOf0Entity.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsCardHeaderPositionUnderOrOverTheContent instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCardNamespace.RepresentsCardHeaderPositionUnderOrOverTheContent.OneOf0Entity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RepresentsCardHeaderPositionUnderOrOverTheContent, Mutable>(this);
            }
        }
    }
}
