...
public readonly partial struct Schema
{
    ...
    public readonly partial struct JsonSchemaForSapCloudNamespace
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCloudNamespace.VersionEntity.Mutable Version
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCloudNamespace.VersionEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCloudNamespace.PublicEntity.Mutable Public
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PublicUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCloudNamespace.PublicEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCloudNamespace.UniqueBusinessServiceIdentifier.Mutable Service
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ServiceUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCloudNamespace.UniqueBusinessServiceIdentifier.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetVersion(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCloudNamespace.VersionEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetPublic(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCloudNamespace.PublicEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetService(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCloudNamespace.UniqueBusinessServiceIdentifier.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCloudNamespace.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCloudNamespace.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCloudNamespace.VersionEntity.Source version = default,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCloudNamespace.PublicEntity.Source publicValue = default,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCloudNamespace.UniqueBusinessServiceIdentifier.Source service = default)
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCloudNamespace.VersionEntity.Source version = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCloudNamespace.PublicEntity.Source publicValue = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCloudNamespace.UniqueBusinessServiceIdentifier.Source service = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
