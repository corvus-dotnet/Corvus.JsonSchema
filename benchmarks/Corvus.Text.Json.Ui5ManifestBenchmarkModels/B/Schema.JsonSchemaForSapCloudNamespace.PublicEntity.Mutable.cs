...
public readonly partial struct Schema
{
    ...
    public readonly partial struct JsonSchemaForSapCloudNamespace
    {
        ...
        public readonly partial struct PublicEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(PublicEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="PublicEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator PublicEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new PublicEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"PublicEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="PublicEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="PublicEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly PublicEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<PublicEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="PublicEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly PublicEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<PublicEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(PublicEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<PublicEntity, Mutable>(this);
            }
        }
    }
}
