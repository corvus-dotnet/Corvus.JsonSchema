...
public readonly partial struct Schema
{
    ...
    public readonly partial struct JsonSchemaForSapCloudPortalNamespace
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(JsonSchemaForSapCloudPortalNamespace instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="JsonSchemaForSapCloudPortalNamespace"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonSchemaForSapCloudPortalNamespace(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new JsonSchemaForSapCloudPortalNamespace(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"JsonSchemaForSapCloudPortalNamespace.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="JsonSchemaForSapCloudPortalNamespace"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="JsonSchemaForSapCloudPortalNamespace"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly JsonSchemaForSapCloudPortalNamespace Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<JsonSchemaForSapCloudPortalNamespace>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="JsonSchemaForSapCloudPortalNamespace"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly JsonSchemaForSapCloudPortalNamespace Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<JsonSchemaForSapCloudPortalNamespace>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCloudPortalNamespace.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(JsonSchemaForSapCloudPortalNamespace instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCloudPortalNamespace.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<JsonSchemaForSapCloudPortalNamespace, Mutable>(this);
        }
    }
}
