...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="JsonSchemaForSapCloudPortalNamespace"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal JsonSchemaForSapCloudPortalNamespace(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static JsonSchemaForSapCloudPortalNamespace DefaultInstance { get; }
        ...
        /// </returns>
        public static bool operator ==(in JsonSchemaForSapCloudPortalNamespace left, in JsonSchemaForSapCloudPortalNamespace right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in JsonSchemaForSapCloudPortalNamespace left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(JsonSchemaForSapCloudPortalNamespace instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonSchemaForSapCloudPortalNamespace(JsonElement instance)
        {
            return JsonSchemaForSapCloudPortalNamespace.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static JsonSchemaForSapCloudPortalNamespace From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static JsonSchemaForSapCloudPortalNamespace ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<JsonSchemaForSapCloudPortalNamespace>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static JsonSchemaForSapCloudPortalNamespace ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<JsonSchemaForSapCloudPortalNamespace>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static JsonSchemaForSapCloudPortalNamespace ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<JsonSchemaForSapCloudPortalNamespace>(json, options);
        }
        ...
        /// </exception>
        public static JsonSchemaForSapCloudPortalNamespace ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<JsonSchemaForSapCloudPortalNamespace>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out JsonSchemaForSapCloudPortalNamespace? result)
        {
            return JsonElementHelpers.TryParseValue<JsonSchemaForSapCloudPortalNamespace>(ref reader, out result);
        }
...
#if NET
        static JsonSchemaForSapCloudPortalNamespace IJsonElement<JsonSchemaForSapCloudPortalNamespace>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"JsonSchemaForSapCloudPortalNamespace: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public JsonSchemaForSapCloudPortalNamespace Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public JsonSchemaForSapCloudPortalNamespace Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<JsonSchemaForSapCloudPortalNamespace>(_idx);
            }
