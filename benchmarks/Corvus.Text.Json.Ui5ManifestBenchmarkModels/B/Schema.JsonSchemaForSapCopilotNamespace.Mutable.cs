...
public readonly partial struct Schema
{
    ...
    public readonly partial struct JsonSchemaForSapCopilotNamespace
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(JsonSchemaForSapCopilotNamespace instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="JsonSchemaForSapCopilotNamespace"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonSchemaForSapCopilotNamespace(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCopilotNamespace.VersionEntity.Mutable Version
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCopilotNamespace.VersionEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCopilotNamespace.SettingsForTheContextAnalysisFeaturesOfSapCoPilot.Mutable ContextAnalysis
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ContextAnalysisUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCopilotNamespace.SettingsForTheContextAnalysisFeaturesOfSapCoPilot.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCopilotNamespace.SettingsForTheDigitalAssistantFeaturesOfSapCoPilot.Mutable DigitalAssistant
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DigitalAssistantUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCopilotNamespace.SettingsForTheDigitalAssistantFeaturesOfSapCoPilot.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetVersion(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCopilotNamespace.VersionEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// <summary>
            /// Set the <c>contextAnalysis</c> property.
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetContextAnalysis(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCopilotNamespace.SettingsForTheContextAnalysisFeaturesOfSapCoPilot.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ContextAnalysisUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ContextAnalysisUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsProperty(JsonPropertyNamesEscaped.ContextAnalysis, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetContextAnalysis<TContext>(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCopilotNamespace.SettingsForTheContextAnalysisFeaturesOfSapCoPilot.Source<TContext> value)
            ...
            /// <summary>
            /// Remove the <c>contextAnalysis</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveContextAnalysis()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ContextAnalysisUtf8);
                _documentVersion = _parent.Version;
                return result;
            }

            /// <summary>
            /// Set the <c>digitalAssistant</c> property.
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetDigitalAssistant(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCopilotNamespace.SettingsForTheDigitalAssistantFeaturesOfSapCoPilot.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.DigitalAssistantUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DigitalAssistantUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsProperty(JsonPropertyNamesEscaped.DigitalAssistant, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetDigitalAssistant<TContext>(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCopilotNamespace.SettingsForTheDigitalAssistantFeaturesOfSapCoPilot.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
            ...
            /// <summary>
            /// Remove the <c>digitalAssistant</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveDigitalAssistant()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.DigitalAssistantUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"JsonSchemaForSapCopilotNamespace.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly JsonSchemaForSapCopilotNamespace Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly JsonSchemaForSapCopilotNamespace Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<JsonSchemaForSapCopilotNamespace>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCopilotNamespace.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(JsonSchemaForSapCopilotNamespace instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCopilotNamespace.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="JsonSchemaForSapCopilotNamespace"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCopilotNamespace.VersionEntity.Source version = default,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCopilotNamespace.SettingsForTheContextAnalysisFeaturesOfSapCoPilot.Source contextAnalysis = default,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCopilotNamespace.SettingsForTheDigitalAssistantFeaturesOfSapCoPilot.Source digitalAssistant = default)
            {
                version.AddAsProperty(JsonPropertyNamesEscaped.Version, ref builder, escapeName: false);
                contextAnalysis.AddAsProperty(JsonPropertyNamesEscaped.ContextAnalysis, ref builder, escapeName: false);
                digitalAssistant.AddAsProperty(JsonPropertyNamesEscaped.DigitalAssistant, ref builder, escapeName: false);
            }
            ...
            public void Create(
                ...
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCopilotNamespace.SettingsForTheDigitalAssistantFeaturesOfSapCoPilot.Source digitalAssistant = default)
            {
                Create(ref _builder, version, contextAnalysis, digitalAssistant);
            }
            ...
            internal static void Create<TContext>(
                ...
                ref ComplexValueBuilder builder,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCopilotNamespace.VersionEntity.Source version = default,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCopilotNamespace.SettingsForTheContextAnalysisFeaturesOfSapCoPilot.Source<TContext> contextAnalysis = default,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCopilotNamespace.SettingsForTheDigitalAssistantFeaturesOfSapCoPilot.Source<TContext> digitalAssistant = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            #endif
            {
                Create(context, ref _builder, version, contextAnalysis, digitalAssistant);
            }
        ...
        /// <param name="contextAnalysis">The value of the property.</param>
        /// <param name="digitalAssistant">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCopilotNamespace.VersionEntity.Source version = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCopilotNamespace.SettingsForTheContextAnalysisFeaturesOfSapCoPilot.Source contextAnalysis = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCopilotNamespace.SettingsForTheDigitalAssistantFeaturesOfSapCoPilot.Source digitalAssistant = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(version, contextAnalysis, digitalAssistant);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCopilotNamespace.VersionEntity.Source version = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCopilotNamespace.SettingsForTheContextAnalysisFeaturesOfSapCoPilot.Source<TContext> contextAnalysis = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCopilotNamespace.SettingsForTheDigitalAssistantFeaturesOfSapCoPilot.Source<TContext> digitalAssistant = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            ...
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(context, version, contextAnalysis, digitalAssistant);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<JsonSchemaForSapCopilotNamespace, Mutable>(this);
        }
    }
}
