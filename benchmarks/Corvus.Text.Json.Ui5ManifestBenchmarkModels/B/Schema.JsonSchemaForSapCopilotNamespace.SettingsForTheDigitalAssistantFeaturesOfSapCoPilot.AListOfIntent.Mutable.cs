        ...
        public readonly partial struct SettingsForTheDigitalAssistantFeaturesOfSapCoPilot
        {
            ...
            public readonly partial struct AListOfIntent
            {
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCopilotNamespace.SettingsForTheDigitalAssistantFeaturesOfSapCoPilot.AListOfIntent.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCopilotNamespace.SettingsForTheDigitalAssistantFeaturesOfSapCoPilot.AListOfIntent.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
