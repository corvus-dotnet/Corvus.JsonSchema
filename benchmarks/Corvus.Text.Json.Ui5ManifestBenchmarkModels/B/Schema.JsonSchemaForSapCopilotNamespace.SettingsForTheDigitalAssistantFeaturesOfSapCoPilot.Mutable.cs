    ...
    public readonly partial struct JsonSchemaForSapCopilotNamespace
    {
        ...
        public readonly partial struct SettingsForTheDigitalAssistantFeaturesOfSapCoPilot
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(SettingsForTheDigitalAssistantFeaturesOfSapCoPilot instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SettingsForTheDigitalAssistantFeaturesOfSapCoPilot"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SettingsForTheDigitalAssistantFeaturesOfSapCoPilot(Mutable instance)
                {
                ...
                /// <summary>
                /// Gets the (optional) <c>intentDefinition</c> property.
                /// </summary>
                /// <remarks>
                /// <para>
                /// A list of Intent
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCopilotNamespace.SettingsForTheDigitalAssistantFeaturesOfSapCoPilot.AListOfIntent.Mutable IntentDefinition
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IntentDefinitionUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCopilotNamespace.SettingsForTheDigitalAssistantFeaturesOfSapCoPilot.AListOfIntent.Mutable value))
                        {
                            return value;
                        }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new SettingsForTheDigitalAssistantFeaturesOfSapCoPilot(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                /// <summary>
                /// Set the <c>intentDefinition</c> property.
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetIntentDefinition(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCopilotNamespace.SettingsForTheDigitalAssistantFeaturesOfSapCoPilot.AListOfIntent.Source value)
                {
                    CheckValidInstance();

                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.IntentDefinitionUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IntentDefinitionUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                    ...
                    else
                    {
                        ...
                        value.AddAsProperty(JsonPropertyNamesEscaped.IntentDefinition, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetIntentDefinition<TContext>(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCopilotNamespace.SettingsForTheDigitalAssistantFeaturesOfSapCoPilot.AListOfIntent.Source<TContext> value)
                ...
                /// <summary>
                /// Remove the <c>intentDefinition</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveIntentDefinition()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.IntentDefinitionUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SettingsForTheDigitalAssistantFeaturesOfSapCoPilot.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="SettingsForTheDigitalAssistantFeaturesOfSapCoPilot"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="SettingsForTheDigitalAssistantFeaturesOfSapCoPilot"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly SettingsForTheDigitalAssistantFeaturesOfSapCoPilot Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<SettingsForTheDigitalAssistantFeaturesOfSapCoPilot>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="SettingsForTheDigitalAssistantFeaturesOfSapCoPilot"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly SettingsForTheDigitalAssistantFeaturesOfSapCoPilot Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SettingsForTheDigitalAssistantFeaturesOfSapCoPilot>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCopilotNamespace.SettingsForTheDigitalAssistantFeaturesOfSapCoPilot.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(SettingsForTheDigitalAssistantFeaturesOfSapCoPilot instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCopilotNamespace.SettingsForTheDigitalAssistantFeaturesOfSapCoPilot.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="SettingsForTheDigitalAssistantFeaturesOfSapCoPilot"/>.
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCopilotNamespace.SettingsForTheDigitalAssistantFeaturesOfSapCoPilot.AListOfIntent.Source intentDefinition = default)
                {
                    intentDefinition.AddAsProperty(JsonPropertyNamesEscaped.IntentDefinition, ref builder, escapeName: false);
                }

                /// <summary>
                /// Creates an instance of a <see cref="SettingsForTheDigitalAssistantFeaturesOfSapCoPilot"/>.
                /// </summary>
                public void Create(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCopilotNamespace.SettingsForTheDigitalAssistantFeaturesOfSapCoPilot.AListOfIntent.Source intentDefinition = default)
                {
                    Create(ref _builder, intentDefinition);
                }
                ...
                internal static void Create<TContext>(
                    ...
                    in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCopilotNamespace.SettingsForTheDigitalAssistantFeaturesOfSapCoPilot.AListOfIntent.Source<TContext> intentDefinition = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
                ...
                /// Creates an instance of a <see cref="SettingsForTheDigitalAssistantFeaturesOfSapCoPilot"/>.
                /// </summary>
                public void Create<TContext>(in TContext context, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCopilotNamespace.SettingsForTheDigitalAssistantFeaturesOfSapCoPilot.AListOfIntent.Source<TContext> intentDefinition = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
                    Create(context, ref _builder, intentDefinition);
                }
            ...
            /// </summary>
            /// <param name="workspace">The JSON workspace.</param>
            /// <param name="intentDefinition">The value of the property.</param>
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapCopilotNamespace.SettingsForTheDigitalAssistantFeaturesOfSapCoPilot.AListOfIntent.Source intentDefinition = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(intentDefinition);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
                ...
                #endif
            {
                ...
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(context, intentDefinition);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<SettingsForTheDigitalAssistantFeaturesOfSapCoPilot, Mutable>(this);
            }
        }
    }
}
