    ...
    public readonly partial struct JsonSchemaForSapFioriNamespace
    {
        ...
        public readonly partial struct ArcheTypeEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ArcheTypeEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ArcheTypeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ArcheTypeEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ArcheTypeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ArcheTypeEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ArcheTypeEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ArcheTypeEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ArcheTypeEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ArcheTypeEntity, Mutable>(this);
            }
        }
    }
}
