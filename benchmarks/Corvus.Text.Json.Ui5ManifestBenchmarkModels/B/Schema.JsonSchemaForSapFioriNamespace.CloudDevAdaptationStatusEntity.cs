...
public readonly partial struct Schema
{
    ...
    public readonly partial struct JsonSchemaForSapFioriNamespace
    {
        ...
        public readonly partial struct CloudDevAdaptationStatusEntity
#if NET8_0_OR_GREATER
            : IJsonElement<CloudDevAdaptationStatusEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="CloudDevAdaptationStatusEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal CloudDevAdaptationStatusEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static CloudDevAdaptationStatusEntity DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(CloudDevAdaptationStatusEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in CloudDevAdaptationStatusEntity left, in CloudDevAdaptationStatusEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in CloudDevAdaptationStatusEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(CloudDevAdaptationStatusEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator CloudDevAdaptationStatusEntity(JsonElement instance)
            {
                return CloudDevAdaptationStatusEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CloudDevAdaptationStatusEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CloudDevAdaptationStatusEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CloudDevAdaptationStatusEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CloudDevAdaptationStatusEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CloudDevAdaptationStatusEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CloudDevAdaptationStatusEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CloudDevAdaptationStatusEntity>(json, options);
            }
            ...
            /// </exception>
            public static CloudDevAdaptationStatusEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<CloudDevAdaptationStatusEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out CloudDevAdaptationStatusEntity? result)
            {
                return JsonElementHelpers.TryParseValue<CloudDevAdaptationStatusEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new CloudDevAdaptationStatusEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static CloudDevAdaptationStatusEntity IJsonElement<CloudDevAdaptationStatusEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"CloudDevAdaptationStatusEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="CloudDevAdaptationStatusEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="CloudDevAdaptationStatusEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public CloudDevAdaptationStatusEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<CloudDevAdaptationStatusEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="CloudDevAdaptationStatusEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public CloudDevAdaptationStatusEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<CloudDevAdaptationStatusEntity>(_idx);
                }
            ...
            /// <param name="matchReleased">Match 1st item.</param>
            /// <param name="matchDeprecated">Match 2nd item.</param>
            /// <param name="matchObsolete">Match 3rd item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchReleased,
                Func<TContext, TResult> matchDeprecated,
                Func<TContext, TResult> matchObsolete,
...
#endif
            {
                ...
                {
                    return matchReleased(context);
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchDeprecated(context);
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchObsolete(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchReleased,
                Func<TResult> matchDeprecated,
                Func<TResult> matchObsolete,
                Func<TResult> defaultMatch)
            {
                if (this.ValueEquals(Constants.Enum1))
                {
                    return matchReleased();
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchDeprecated();
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchObsolete();
                }
