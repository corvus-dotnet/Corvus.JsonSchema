    ...
    public readonly partial struct JsonSchemaForSapFlpNamespace
    {
        ...
        public readonly partial struct RepresentsConfigurationParametersOfTheFlpEntry
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RepresentsConfigurationParametersOfTheFlpEntry instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsConfigurationParametersOfTheFlpEntry"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsConfigurationParametersOfTheFlpEntry(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new RepresentsConfigurationParametersOfTheFlpEntry(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsConfigurationParametersOfTheFlpEntry.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="RepresentsConfigurationParametersOfTheFlpEntry"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="RepresentsConfigurationParametersOfTheFlpEntry"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsConfigurationParametersOfTheFlpEntry Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<RepresentsConfigurationParametersOfTheFlpEntry>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="RepresentsConfigurationParametersOfTheFlpEntry"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsConfigurationParametersOfTheFlpEntry Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsConfigurationParametersOfTheFlpEntry>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapFlpNamespace.RepresentsConfigurationParametersOfTheFlpEntry.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(RepresentsConfigurationParametersOfTheFlpEntry instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapFlpNamespace.RepresentsConfigurationParametersOfTheFlpEntry.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<RepresentsConfigurationParametersOfTheFlpEntry, Mutable>(this);
            }
        }
    }
}
