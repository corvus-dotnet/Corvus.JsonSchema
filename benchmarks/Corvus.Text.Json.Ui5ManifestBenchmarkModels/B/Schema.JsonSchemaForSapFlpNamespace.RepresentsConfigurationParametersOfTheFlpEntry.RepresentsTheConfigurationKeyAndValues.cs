...
public readonly partial struct Schema
{
    ...
    public readonly partial struct JsonSchemaForSapFlpNamespace
    {
        ...
        /// </para>
        /// </remarks>
        public readonly partial struct RepresentsConfigurationParametersOfTheFlpEntry
        {
            /// <summary>
            /// Generated from JSON Schema.
            /// </summary>
            ...
            public readonly partial struct RepresentsTheConfigurationKeyAndValues
#if NET8_0_OR_GREATER
                : IJsonElement<RepresentsTheConfigurationKeyAndValues>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="RepresentsTheConfigurationKeyAndValues"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal RepresentsTheConfigurationKeyAndValues(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static RepresentsTheConfigurationKeyAndValues DefaultInstance { get; }
                ...
                /// </returns>
                public static bool operator ==(in RepresentsTheConfigurationKeyAndValues left, in RepresentsTheConfigurationKeyAndValues right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in RepresentsTheConfigurationKeyAndValues left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(RepresentsTheConfigurationKeyAndValues instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsTheConfigurationKeyAndValues(JsonElement instance)
                {
                    return RepresentsTheConfigurationKeyAndValues.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RepresentsTheConfigurationKeyAndValues From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RepresentsTheConfigurationKeyAndValues ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RepresentsTheConfigurationKeyAndValues>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RepresentsTheConfigurationKeyAndValues ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RepresentsTheConfigurationKeyAndValues>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RepresentsTheConfigurationKeyAndValues ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RepresentsTheConfigurationKeyAndValues>(json, options);
                }
                ...
                /// </exception>
                public static RepresentsTheConfigurationKeyAndValues ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<RepresentsTheConfigurationKeyAndValues>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsTheConfigurationKeyAndValues? result)
                {
                    return JsonElementHelpers.TryParseValue<RepresentsTheConfigurationKeyAndValues>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new RepresentsTheConfigurationKeyAndValues(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static RepresentsTheConfigurationKeyAndValues IJsonElement<RepresentsTheConfigurationKeyAndValues>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsTheConfigurationKeyAndValues: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="RepresentsTheConfigurationKeyAndValues"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="RepresentsTheConfigurationKeyAndValues"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public RepresentsTheConfigurationKeyAndValues Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<RepresentsTheConfigurationKeyAndValues>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="RepresentsTheConfigurationKeyAndValues"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public RepresentsTheConfigurationKeyAndValues Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<RepresentsTheConfigurationKeyAndValues>(_idx);
                    }
