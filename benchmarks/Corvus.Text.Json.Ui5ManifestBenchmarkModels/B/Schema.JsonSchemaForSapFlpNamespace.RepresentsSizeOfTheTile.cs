...
public readonly partial struct Schema
{
    ...
    public readonly partial struct JsonSchemaForSapFlpNamespace
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RepresentsSizeOfTheTile"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RepresentsSizeOfTheTile(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RepresentsSizeOfTheTile DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(RepresentsSizeOfTheTile value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in RepresentsSizeOfTheTile left, in RepresentsSizeOfTheTile right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RepresentsSizeOfTheTile left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(RepresentsSizeOfTheTile instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RepresentsSizeOfTheTile(JsonElement instance)
            {
                return RepresentsSizeOfTheTile.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsSizeOfTheTile From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsSizeOfTheTile ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsSizeOfTheTile>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsSizeOfTheTile ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsSizeOfTheTile>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsSizeOfTheTile ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsSizeOfTheTile>(json, options);
            }
            ...
            /// </exception>
            public static RepresentsSizeOfTheTile ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RepresentsSizeOfTheTile>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsSizeOfTheTile? result)
            {
                return JsonElementHelpers.TryParseValue<RepresentsSizeOfTheTile>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RepresentsSizeOfTheTile(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static RepresentsSizeOfTheTile IJsonElement<RepresentsSizeOfTheTile>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RepresentsSizeOfTheTile: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RepresentsSizeOfTheTile"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RepresentsSizeOfTheTile"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public RepresentsSizeOfTheTile Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RepresentsSizeOfTheTile>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RepresentsSizeOfTheTile"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public RepresentsSizeOfTheTile Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RepresentsSizeOfTheTile>(_idx);
                }
            ...
            /// <param name="match1x1">Match 1st item.</param>
            /// <param name="match1x2">Match 2nd item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> match1x1,
                Func<TContext, TResult> match1x2,
...
#endif
            {
                ...
                {
                    return match1x1(context);
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return match1x2(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> match1x1,
                Func<TResult> match1x2,
