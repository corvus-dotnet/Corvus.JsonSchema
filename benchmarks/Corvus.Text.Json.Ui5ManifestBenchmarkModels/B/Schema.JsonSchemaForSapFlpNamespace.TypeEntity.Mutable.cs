    ...
    public readonly partial struct JsonSchemaForSapFlpNamespace
    {
        ...
        public readonly partial struct TypeEntity
        {
...
#endif
            {
                ...
                /// <param name="matchTile">Match 2nd item.</param>
                /// <param name="matchPlugin">Match 3rd item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> matchApplication,
                    Func<TContext, TResult> matchTile,
                    Func<TContext, TResult> matchPlugin,
...
#endif
                {
                    ...
                    {
                        return matchTile(context);
                    }

                    if (this.ValueEquals(Constants.Enum3))
                    {
                        return matchPlugin(context);
                    }
                ...
                public TResult Match<TResult>(
                    ...
                    Func<TResult> matchTile,
                    Func<TResult> matchPlugin,
