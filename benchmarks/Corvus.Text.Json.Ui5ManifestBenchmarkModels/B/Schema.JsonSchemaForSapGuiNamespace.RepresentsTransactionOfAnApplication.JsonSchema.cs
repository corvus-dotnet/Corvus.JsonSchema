...
public readonly partial struct Schema
{
    ...
    public readonly partial struct JsonSchemaForSapGuiNamespace
    {
        ...
        public readonly partial struct RepresentsTransactionOfAnApplication
            : IJsonElement<RepresentsTransactionOfAnApplication>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("ui5-manifest-schema.json#/properties/sap.gui/properties/transaction"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "ui5-manifest-schema.json#/properties/sap.gui/properties/transaction";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "ui5-manifest-schema.json#/properties/sap.gui/properties/transaction"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        JsonSchemaEvaluation.MatchRegularExpression(unescapedUtf8JsonString.Span, Pattern,"^[a-zA-Z0-9\\/_]{1,20}$", "pattern"u8, ref context);
                    }
                }
...
#else
                private static Regex CreatePattern() => new("^[a-zA-Z0-9\\/_]{1,20}$", RegexOptions.Compiled);
#endif
