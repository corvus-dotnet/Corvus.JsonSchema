    ...
    public readonly partial struct JsonSchemaForSapInsightsNamespace
    {
        ...
        public readonly partial struct FilterEntitySetEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(FilterEntitySetEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="FilterEntitySetEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator FilterEntitySetEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"FilterEntitySetEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly FilterEntitySetEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly FilterEntitySetEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<FilterEntitySetEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(FilterEntitySetEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<FilterEntitySetEntity, Mutable>(this);
            }
        }
    }
}
