    ...
    public readonly partial struct JsonSchemaForSapInsightsNamespace
    {
        ...
        public readonly partial struct RepresentsTheDeletedStateForAUser
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RepresentsTheDeletedStateForAUser instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsTheDeletedStateForAUser"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsTheDeletedStateForAUser(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsTheDeletedStateForAUser.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheDeletedStateForAUser Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheDeletedStateForAUser Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsTheDeletedStateForAUser>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsTheDeletedStateForAUser instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RepresentsTheDeletedStateForAUser, Mutable>(this);
            }
        }
    }
}
