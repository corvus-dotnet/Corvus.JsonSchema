...
public readonly partial struct Schema
{
    ...
    public readonly partial struct JsonSchemaForSapInsightsNamespace
    {
        ...
        public readonly partial struct RepresentsTheStateOfOriginalOrCopiedCard
#if NET8_0_OR_GREATER
            : IJsonElement<RepresentsTheStateOfOriginalOrCopiedCard>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RepresentsTheStateOfOriginalOrCopiedCard"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RepresentsTheStateOfOriginalOrCopiedCard(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RepresentsTheStateOfOriginalOrCopiedCard DefaultInstance { get; } = ParsedJsonDocument<RepresentsTheStateOfOriginalOrCopiedCard>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(RepresentsTheStateOfOriginalOrCopiedCard value)
            {
            ...
            /// </returns>
            public static bool operator ==(in RepresentsTheStateOfOriginalOrCopiedCard left, in RepresentsTheStateOfOriginalOrCopiedCard right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RepresentsTheStateOfOriginalOrCopiedCard left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(RepresentsTheStateOfOriginalOrCopiedCard instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RepresentsTheStateOfOriginalOrCopiedCard(JsonElement instance)
            {
                return RepresentsTheStateOfOriginalOrCopiedCard.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheStateOfOriginalOrCopiedCard From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheStateOfOriginalOrCopiedCard ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheStateOfOriginalOrCopiedCard>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheStateOfOriginalOrCopiedCard ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheStateOfOriginalOrCopiedCard>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheStateOfOriginalOrCopiedCard ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheStateOfOriginalOrCopiedCard>(json, options);
            }
            ...
            /// </exception>
            public static RepresentsTheStateOfOriginalOrCopiedCard ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheStateOfOriginalOrCopiedCard>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsTheStateOfOriginalOrCopiedCard? result)
            {
                return JsonElementHelpers.TryParseValue<RepresentsTheStateOfOriginalOrCopiedCard>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RepresentsTheStateOfOriginalOrCopiedCard(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static RepresentsTheStateOfOriginalOrCopiedCard IJsonElement<RepresentsTheStateOfOriginalOrCopiedCard>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RepresentsTheStateOfOriginalOrCopiedCard: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RepresentsTheStateOfOriginalOrCopiedCard"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RepresentsTheStateOfOriginalOrCopiedCard"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public RepresentsTheStateOfOriginalOrCopiedCard Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RepresentsTheStateOfOriginalOrCopiedCard>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RepresentsTheStateOfOriginalOrCopiedCard"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public RepresentsTheStateOfOriginalOrCopiedCard Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RepresentsTheStateOfOriginalOrCopiedCard>(_idx);
                }
