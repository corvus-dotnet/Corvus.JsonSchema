...
public readonly partial struct Schema
{
    ...
    public readonly partial struct JsonSchemaForSapIntegrationNamespace
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapIntegrationNamespace.VersionEntity.Mutable Version
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapIntegrationNamespace.VersionEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapIntegrationNamespace.RequiredKeyAndValueArray.Mutable Parameters
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ParametersUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapIntegrationNamespace.RequiredKeyAndValueArray.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Mutable UrlTemplateId
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UrlTemplateIdUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetVersion(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapIntegrationNamespace.VersionEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetParameters(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapIntegrationNamespace.RequiredKeyAndValueArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetParameters<TContext>(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapIntegrationNamespace.RequiredKeyAndValueArray.Source<TContext> value)
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetUrlTemplateId(in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapIntegrationNamespace.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapIntegrationNamespace.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapIntegrationNamespace.RequiredKeyAndValueArray.Source parameters,
                in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source urlTemplateId,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapIntegrationNamespace.VersionEntity.Source version = default)
            {
            ...
            internal static void Create<TContext>(
                in TContext context,
                ref ComplexValueBuilder builder,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapIntegrationNamespace.RequiredKeyAndValueArray.Source<TContext> parameters,
                in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source urlTemplateId,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapIntegrationNamespace.VersionEntity.Source version = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapIntegrationNamespace.RequiredKeyAndValueArray.Source parameters, in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source urlTemplateId, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapIntegrationNamespace.VersionEntity.Source version = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapIntegrationNamespace.RequiredKeyAndValueArray.Source<TContext> parameters, in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source urlTemplateId, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapIntegrationNamespace.VersionEntity.Source version = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
