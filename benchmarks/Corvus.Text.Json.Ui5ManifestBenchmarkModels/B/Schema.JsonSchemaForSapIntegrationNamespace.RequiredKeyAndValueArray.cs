...
public readonly partial struct Schema
{
    ...
    public readonly partial struct JsonSchemaForSapIntegrationNamespace
    {
...
#endif
        {
            ...
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapIntegrationNamespace.RequiredKeyAndValueArray.RequiredKeyAndValue this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapIntegrationNamespace.RequiredKeyAndValueArray.RequiredKeyAndValue>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapIntegrationNamespace.RequiredKeyAndValueArray.RequiredKeyAndValue> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapIntegrationNamespace.RequiredKeyAndValueArray.RequiredKeyAndValue>(_parent, _idx);
            }
