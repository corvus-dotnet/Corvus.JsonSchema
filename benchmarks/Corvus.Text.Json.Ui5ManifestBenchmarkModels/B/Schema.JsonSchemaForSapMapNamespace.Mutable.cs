...
public readonly partial struct Schema
{
    ...
    public readonly partial struct JsonSchemaForSapMapNamespace
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(JsonSchemaForSapMapNamespace instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="JsonSchemaForSapMapNamespace"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonSchemaForSapMapNamespace(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new JsonSchemaForSapMapNamespace(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"JsonSchemaForSapMapNamespace.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="JsonSchemaForSapMapNamespace"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="JsonSchemaForSapMapNamespace"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly JsonSchemaForSapMapNamespace Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<JsonSchemaForSapMapNamespace>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="JsonSchemaForSapMapNamespace"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly JsonSchemaForSapMapNamespace Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<JsonSchemaForSapMapNamespace>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapMapNamespace.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(JsonSchemaForSapMapNamespace instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapMapNamespace.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<JsonSchemaForSapMapNamespace, Mutable>(this);
        }
    }
}
