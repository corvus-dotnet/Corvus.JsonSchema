...
public readonly partial struct Schema
{
    ...
    public readonly partial struct JsonSchemaForSapMobileNamespace
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RepresentsMobileSpecificAttributes"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RepresentsMobileSpecificAttributes(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RepresentsMobileSpecificAttributes DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in RepresentsMobileSpecificAttributes left, in RepresentsMobileSpecificAttributes right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RepresentsMobileSpecificAttributes left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(RepresentsMobileSpecificAttributes instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RepresentsMobileSpecificAttributes(JsonElement instance)
            {
                return RepresentsMobileSpecificAttributes.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsMobileSpecificAttributes From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsMobileSpecificAttributes ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsMobileSpecificAttributes>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsMobileSpecificAttributes ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsMobileSpecificAttributes>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsMobileSpecificAttributes ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsMobileSpecificAttributes>(json, options);
            }
            ...
            /// </exception>
            public static RepresentsMobileSpecificAttributes ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RepresentsMobileSpecificAttributes>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsMobileSpecificAttributes? result)
            {
                return JsonElementHelpers.TryParseValue<RepresentsMobileSpecificAttributes>(ref reader, out result);
            }
...
#if NET
            static RepresentsMobileSpecificAttributes IJsonElement<RepresentsMobileSpecificAttributes>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RepresentsMobileSpecificAttributes: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public RepresentsMobileSpecificAttributes Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public RepresentsMobileSpecificAttributes Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RepresentsMobileSpecificAttributes>(_idx);
                }
