    ...
    public readonly partial struct JsonSchemaForSapOvpNamespace
    {
        ...
        public readonly partial struct DataLoadSettingsEntity
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapOvpNamespace.DataLoadSettingsEntity.DataLoadBehaviourOptionsOnApplicationLaunch.Mutable LoadDataOnAppLaunch
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LoadDataOnAppLaunchUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapOvpNamespace.DataLoadSettingsEntity.DataLoadBehaviourOptionsOnApplicationLaunch.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetLoadDataOnAppLaunch(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapOvpNamespace.DataLoadSettingsEntity.DataLoadBehaviourOptionsOnApplicationLaunch.Source value)
                {
                    CheckValidInstance();
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapOvpNamespace.DataLoadSettingsEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapOvpNamespace.DataLoadSettingsEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapOvpNamespace.DataLoadSettingsEntity.DataLoadBehaviourOptionsOnApplicationLaunch.Source loadDataOnAppLaunch = default)
                {
                ...
                /// Creates an instance of a <see cref="DataLoadSettingsEntity"/>.
                /// </summary>
                public void Create(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapOvpNamespace.DataLoadSettingsEntity.DataLoadBehaviourOptionsOnApplicationLaunch.Source loadDataOnAppLaunch = default)
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapOvpNamespace.DataLoadSettingsEntity.DataLoadBehaviourOptionsOnApplicationLaunch.Source loadDataOnAppLaunch = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
