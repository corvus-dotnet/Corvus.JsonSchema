    ...
    public readonly partial struct JsonSchemaForSapOvpNamespace
    {
        ...
        public readonly partial struct EnableLiveFilterEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(EnableLiveFilterEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="EnableLiveFilterEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator EnableLiveFilterEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"EnableLiveFilterEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly EnableLiveFilterEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly EnableLiveFilterEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<EnableLiveFilterEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(EnableLiveFilterEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<EnableLiveFilterEntity, Mutable>(this);
            }
        }
    }
}
