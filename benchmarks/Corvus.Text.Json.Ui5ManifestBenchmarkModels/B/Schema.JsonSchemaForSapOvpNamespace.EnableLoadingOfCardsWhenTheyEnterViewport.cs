...
public readonly partial struct Schema
{
    ...
    public readonly partial struct JsonSchemaForSapOvpNamespace
    {
        ...
        public readonly partial struct EnableLoadingOfCardsWhenTheyEnterViewport
#if NET8_0_OR_GREATER
            : IJsonElement<EnableLoadingOfCardsWhenTheyEnterViewport>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="EnableLoadingOfCardsWhenTheyEnterViewport"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal EnableLoadingOfCardsWhenTheyEnterViewport(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static EnableLoadingOfCardsWhenTheyEnterViewport DefaultInstance { get; } = ParsedJsonDocument<EnableLoadingOfCardsWhenTheyEnterViewport>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(EnableLoadingOfCardsWhenTheyEnterViewport value)
            {
            ...
            /// </returns>
            public static bool operator ==(in EnableLoadingOfCardsWhenTheyEnterViewport left, in EnableLoadingOfCardsWhenTheyEnterViewport right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in EnableLoadingOfCardsWhenTheyEnterViewport left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(EnableLoadingOfCardsWhenTheyEnterViewport instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EnableLoadingOfCardsWhenTheyEnterViewport(JsonElement instance)
            {
                return EnableLoadingOfCardsWhenTheyEnterViewport.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EnableLoadingOfCardsWhenTheyEnterViewport From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EnableLoadingOfCardsWhenTheyEnterViewport ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EnableLoadingOfCardsWhenTheyEnterViewport>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EnableLoadingOfCardsWhenTheyEnterViewport ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EnableLoadingOfCardsWhenTheyEnterViewport>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EnableLoadingOfCardsWhenTheyEnterViewport ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EnableLoadingOfCardsWhenTheyEnterViewport>(json, options);
            }
            ...
            /// </exception>
            public static EnableLoadingOfCardsWhenTheyEnterViewport ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<EnableLoadingOfCardsWhenTheyEnterViewport>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out EnableLoadingOfCardsWhenTheyEnterViewport? result)
            {
                return JsonElementHelpers.TryParseValue<EnableLoadingOfCardsWhenTheyEnterViewport>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new EnableLoadingOfCardsWhenTheyEnterViewport(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static EnableLoadingOfCardsWhenTheyEnterViewport IJsonElement<EnableLoadingOfCardsWhenTheyEnterViewport>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EnableLoadingOfCardsWhenTheyEnterViewport: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="EnableLoadingOfCardsWhenTheyEnterViewport"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="EnableLoadingOfCardsWhenTheyEnterViewport"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public EnableLoadingOfCardsWhenTheyEnterViewport Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<EnableLoadingOfCardsWhenTheyEnterViewport>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="EnableLoadingOfCardsWhenTheyEnterViewport"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public EnableLoadingOfCardsWhenTheyEnterViewport Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<EnableLoadingOfCardsWhenTheyEnterViewport>(_idx);
                }
