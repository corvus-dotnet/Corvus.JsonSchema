...
public readonly partial struct Schema
{
    ...
    public readonly partial struct JsonSchemaForSapOvpNamespace
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RepresentsTheLayoutOfTheCardContainer"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RepresentsTheLayoutOfTheCardContainer(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RepresentsTheLayoutOfTheCardContainer DefaultInstance { get; } = ParsedJsonDocument<RepresentsTheLayoutOfTheCardContainer>.StringConstant([.."\"fixed\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(RepresentsTheLayoutOfTheCardContainer value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in RepresentsTheLayoutOfTheCardContainer left, in RepresentsTheLayoutOfTheCardContainer right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RepresentsTheLayoutOfTheCardContainer left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(RepresentsTheLayoutOfTheCardContainer instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RepresentsTheLayoutOfTheCardContainer(JsonElement instance)
            {
                return RepresentsTheLayoutOfTheCardContainer.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheLayoutOfTheCardContainer From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheLayoutOfTheCardContainer ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheLayoutOfTheCardContainer>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheLayoutOfTheCardContainer ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheLayoutOfTheCardContainer>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheLayoutOfTheCardContainer ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheLayoutOfTheCardContainer>(json, options);
            }
            ...
            /// </exception>
            public static RepresentsTheLayoutOfTheCardContainer ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheLayoutOfTheCardContainer>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsTheLayoutOfTheCardContainer? result)
            {
                return JsonElementHelpers.TryParseValue<RepresentsTheLayoutOfTheCardContainer>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RepresentsTheLayoutOfTheCardContainer(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static RepresentsTheLayoutOfTheCardContainer IJsonElement<RepresentsTheLayoutOfTheCardContainer>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RepresentsTheLayoutOfTheCardContainer: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RepresentsTheLayoutOfTheCardContainer"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RepresentsTheLayoutOfTheCardContainer"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public RepresentsTheLayoutOfTheCardContainer Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RepresentsTheLayoutOfTheCardContainer>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RepresentsTheLayoutOfTheCardContainer"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public RepresentsTheLayoutOfTheCardContainer Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RepresentsTheLayoutOfTheCardContainer>(_idx);
                }
            ...
            /// <param name="matchFixed">Match 1st item.</param>
            /// <param name="matchResizable">Match 2nd item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchFixed,
                Func<TContext, TResult> matchResizable,
            ...
            public TResult Match<TResult>(
                Func<TResult> matchFixed,
                Func<TResult> matchResizable,
