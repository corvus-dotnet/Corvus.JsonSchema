...
public readonly partial struct Schema
{
    ...
    public readonly partial struct JsonSchemaForSapOvpNamespace
    {
        ...
        public readonly partial struct RepresentsTheObjectToStoreAnalyticalChartSettings
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RepresentsTheObjectToStoreAnalyticalChartSettings instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsTheObjectToStoreAnalyticalChartSettings"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsTheObjectToStoreAnalyticalChartSettings(Mutable instance)
                {
                ...
                /// <summary>
                /// Gets the (optional) <c>showDataLabel</c> property.
                /// </summary>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapOvpNamespace.RepresentsTheObjectToStoreAnalyticalChartSettings.FlagToEnableDataLabelsOnAnalyticalCharts.Mutable ShowDataLabel
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ShowDataLabelUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapOvpNamespace.RepresentsTheObjectToStoreAnalyticalChartSettings.FlagToEnableDataLabelsOnAnalyticalCharts.Mutable value))
                        {
                            return value;
                        }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new RepresentsTheObjectToStoreAnalyticalChartSettings(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                /// <summary>
                /// Set the <c>showDataLabel</c> property.
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetShowDataLabel(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapOvpNamespace.RepresentsTheObjectToStoreAnalyticalChartSettings.FlagToEnableDataLabelsOnAnalyticalCharts.Source value)
                {
                    CheckValidInstance();

                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ShowDataLabelUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ShowDataLabelUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                    ...
                    else
                    {
                        ...
                        value.AddAsProperty(JsonPropertyNamesEscaped.ShowDataLabel, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                ...
                /// <summary>
                /// Remove the <c>showDataLabel</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveShowDataLabel()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ShowDataLabelUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsTheObjectToStoreAnalyticalChartSettings.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="RepresentsTheObjectToStoreAnalyticalChartSettings"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="RepresentsTheObjectToStoreAnalyticalChartSettings"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheObjectToStoreAnalyticalChartSettings Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<RepresentsTheObjectToStoreAnalyticalChartSettings>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="RepresentsTheObjectToStoreAnalyticalChartSettings"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheObjectToStoreAnalyticalChartSettings Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsTheObjectToStoreAnalyticalChartSettings>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapOvpNamespace.RepresentsTheObjectToStoreAnalyticalChartSettings.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(RepresentsTheObjectToStoreAnalyticalChartSettings instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapOvpNamespace.RepresentsTheObjectToStoreAnalyticalChartSettings.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="RepresentsTheObjectToStoreAnalyticalChartSettings"/>.
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapOvpNamespace.RepresentsTheObjectToStoreAnalyticalChartSettings.FlagToEnableDataLabelsOnAnalyticalCharts.Source showDataLabel = default)
                {
                    showDataLabel.AddAsProperty(JsonPropertyNamesEscaped.ShowDataLabel, ref builder, escapeName: false);
                }

                /// <summary>
                /// Creates an instance of a <see cref="RepresentsTheObjectToStoreAnalyticalChartSettings"/>.
                /// </summary>
                public void Create(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapOvpNamespace.RepresentsTheObjectToStoreAnalyticalChartSettings.FlagToEnableDataLabelsOnAnalyticalCharts.Source showDataLabel = default)
                {
                    Create(ref _builder, showDataLabel);
                }
            ...
            /// </summary>
            /// <param name="workspace">The JSON workspace.</param>
            /// <param name="showDataLabel">The value of the property.</param>
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapOvpNamespace.RepresentsTheObjectToStoreAnalyticalChartSettings.FlagToEnableDataLabelsOnAnalyticalCharts.Source showDataLabel = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(showDataLabel);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<RepresentsTheObjectToStoreAnalyticalChartSettings, Mutable>(this);
            }
        }
    }
}
