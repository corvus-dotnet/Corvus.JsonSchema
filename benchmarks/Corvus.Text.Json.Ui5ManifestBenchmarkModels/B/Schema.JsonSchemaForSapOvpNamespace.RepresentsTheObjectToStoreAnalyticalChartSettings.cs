...
public readonly partial struct Schema
{
    ...
    public readonly partial struct JsonSchemaForSapOvpNamespace
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RepresentsTheObjectToStoreAnalyticalChartSettings"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RepresentsTheObjectToStoreAnalyticalChartSettings(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RepresentsTheObjectToStoreAnalyticalChartSettings DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapOvpNamespace.RepresentsTheObjectToStoreAnalyticalChartSettings.FlagToEnableDataLabelsOnAnalyticalCharts ShowDataLabel
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ShowDataLabelUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapOvpNamespace.RepresentsTheObjectToStoreAnalyticalChartSettings.FlagToEnableDataLabelsOnAnalyticalCharts value))
                    {
                        return value;
                    }

                    return Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapOvpNamespace.RepresentsTheObjectToStoreAnalyticalChartSettings.FlagToEnableDataLabelsOnAnalyticalCharts.DefaultInstance;
                }
            }
            ...
            /// </returns>
            public static bool operator ==(in RepresentsTheObjectToStoreAnalyticalChartSettings left, in RepresentsTheObjectToStoreAnalyticalChartSettings right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RepresentsTheObjectToStoreAnalyticalChartSettings left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(RepresentsTheObjectToStoreAnalyticalChartSettings instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RepresentsTheObjectToStoreAnalyticalChartSettings(JsonElement instance)
            {
                return RepresentsTheObjectToStoreAnalyticalChartSettings.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheObjectToStoreAnalyticalChartSettings From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheObjectToStoreAnalyticalChartSettings ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheObjectToStoreAnalyticalChartSettings>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheObjectToStoreAnalyticalChartSettings ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheObjectToStoreAnalyticalChartSettings>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheObjectToStoreAnalyticalChartSettings ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheObjectToStoreAnalyticalChartSettings>(json, options);
            }
            ...
            /// </exception>
            public static RepresentsTheObjectToStoreAnalyticalChartSettings ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheObjectToStoreAnalyticalChartSettings>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsTheObjectToStoreAnalyticalChartSettings? result)
            {
                return JsonElementHelpers.TryParseValue<RepresentsTheObjectToStoreAnalyticalChartSettings>(ref reader, out result);
            }
...
#if NET
            static RepresentsTheObjectToStoreAnalyticalChartSettings IJsonElement<RepresentsTheObjectToStoreAnalyticalChartSettings>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RepresentsTheObjectToStoreAnalyticalChartSettings: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public RepresentsTheObjectToStoreAnalyticalChartSettings Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public RepresentsTheObjectToStoreAnalyticalChartSettings Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RepresentsTheObjectToStoreAnalyticalChartSettings>(_idx);
                }
            ...
            {
                /// <summary>
                /// Gets the JSON property name for <see cref="ShowDataLabel"/>.
                /// </summary>
                public const string ShowDataLabel = "showDataLabel";

                /// <summary>
                /// Gets the JSON property name for <see cref="ShowDataLabel"/>.
                /// </summary>
                public static ReadOnlySpan<byte> ShowDataLabelUtf8 => "showDataLabel"u8;
            }
            ...
            {
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="ShowDataLabel"/>.
                /// </summary>
                public static ReadOnlySpan<byte> ShowDataLabel => "showDataLabel"u8;
            }
        }
    }
}
