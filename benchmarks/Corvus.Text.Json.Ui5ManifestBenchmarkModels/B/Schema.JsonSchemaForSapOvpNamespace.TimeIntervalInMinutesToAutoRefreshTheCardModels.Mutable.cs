...
public readonly partial struct Schema
{
    ...
    public readonly partial struct JsonSchemaForSapOvpNamespace
    {
        ...
        public readonly partial struct TimeIntervalInMinutesToAutoRefreshTheCardModels
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(TimeIntervalInMinutesToAutoRefreshTheCardModels instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TimeIntervalInMinutesToAutoRefreshTheCardModels"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TimeIntervalInMinutesToAutoRefreshTheCardModels(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new TimeIntervalInMinutesToAutoRefreshTheCardModels(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TimeIntervalInMinutesToAutoRefreshTheCardModels.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="TimeIntervalInMinutesToAutoRefreshTheCardModels"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="TimeIntervalInMinutesToAutoRefreshTheCardModels"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly TimeIntervalInMinutesToAutoRefreshTheCardModels Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<TimeIntervalInMinutesToAutoRefreshTheCardModels>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="TimeIntervalInMinutesToAutoRefreshTheCardModels"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly TimeIntervalInMinutesToAutoRefreshTheCardModels Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TimeIntervalInMinutesToAutoRefreshTheCardModels>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(TimeIntervalInMinutesToAutoRefreshTheCardModels instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<TimeIntervalInMinutesToAutoRefreshTheCardModels, Mutable>(this);
            }
        }
    }
}
