    ...
    public readonly partial struct JsonSchemaForSapPackageNamespace
    {
        ...
        public readonly partial struct RequiredVersion
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapPackageNamespace.RequiredVersion.UpgradeNotificationEntity.Mutable UpgradeNotification
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UpgradeNotificationUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapPackageNamespace.RequiredVersion.UpgradeNotificationEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetUpgradeNotification(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapPackageNamespace.RequiredVersion.UpgradeNotificationEntity.Source value)
                {
                    CheckValidInstance();
                    ...
                    else
                    {
                        ...
                        value.AddAsProperty(JsonPropertyNamesEscaped.UpgradeNotification, ref cvb, escapeName: false, nameRequiresUnescaping: false);
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapPackageNamespace.RequiredVersion.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapPackageNamespace.RequiredVersion.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Semanticversion.Source version,
                    in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapPackageNamespace.RequiredVersion.UpgradeNotificationEntity.Source upgradeNotification = default)
                {
                    version.AddAsProperty(JsonPropertyNamesEscaped.Version, ref builder, escapeName: false);
                    upgradeNotification.AddAsProperty(JsonPropertyNamesEscaped.UpgradeNotification, ref builder, escapeName: false);
                }

                /// <summary>
                /// Creates an instance of a <see cref="RequiredVersion"/>.
                /// </summary>
                public void Create(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Semanticversion.Source version, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapPackageNamespace.RequiredVersion.UpgradeNotificationEntity.Source upgradeNotification = default)
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Semanticversion.Source version, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapPackageNamespace.RequiredVersion.UpgradeNotificationEntity.Source upgradeNotification = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
