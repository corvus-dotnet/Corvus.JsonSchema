        ...
        public readonly partial struct RequiredVersion
        {
            ...
            public readonly partial struct UpgradeNotificationEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(UpgradeNotificationEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="UpgradeNotificationEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator UpgradeNotificationEntity(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new UpgradeNotificationEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"UpgradeNotificationEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="UpgradeNotificationEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="UpgradeNotificationEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly UpgradeNotificationEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<UpgradeNotificationEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="UpgradeNotificationEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly UpgradeNotificationEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<UpgradeNotificationEntity>(_idx);
                    }
                    ...
                    /// <param name="matchMajor">Match 2nd item.</param>
                    /// <param name="matchMajorMinor">Match 3rd item.</param>
                    ...
                    public TResult Match<TContext, TResult>(
                        ...
                        Func<TContext, TResult> matchMajor,
                        Func<TContext, TResult> matchMajorMinor,
...
#endif
                    {
                        ...
                        {
                            return matchMajor(context);
                        }

                        if (this.ValueEquals(Constants.Enum3))
                        {
                            return matchMajorMinor(context);
                        }
                    ...
                    public TResult Match<TResult>(
                        ...
                        Func<TResult> matchMajor,
                        Func<TResult> matchMajorMinor,
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(UpgradeNotificationEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<UpgradeNotificationEntity, Mutable>(this);
                }
            }
        }
    }
