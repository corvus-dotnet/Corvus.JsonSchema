...
public readonly partial struct Schema
{
    ...
    public readonly partial struct JsonSchemaForSapPackageNamespace
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RequiredVersion"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RequiredVersion(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RequiredVersion DefaultInstance { get; }
            ...
            /// <summary>
            /// Gets the (optional) <c>upgradeNotification</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapPackageNamespace.RequiredVersion.UpgradeNotificationEntity UpgradeNotification
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UpgradeNotificationUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapPackageNamespace.RequiredVersion.UpgradeNotificationEntity value))
                    {
                        return value;
                    }

                    return Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapPackageNamespace.RequiredVersion.UpgradeNotificationEntity.DefaultInstance;
                }
            }
            ...
            /// </returns>
            public static bool operator ==(in RequiredVersion left, in RequiredVersion right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RequiredVersion left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(RequiredVersion instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RequiredVersion(JsonElement instance)
            {
                return RequiredVersion.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredVersion From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredVersion ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredVersion>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredVersion ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredVersion>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredVersion ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredVersion>(json, options);
            }
            ...
            /// </exception>
            public static RequiredVersion ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RequiredVersion>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredVersion? result)
            {
                return JsonElementHelpers.TryParseValue<RequiredVersion>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RequiredVersion(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static RequiredVersion IJsonElement<RequiredVersion>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RequiredVersion: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RequiredVersion"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RequiredVersion"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public RequiredVersion Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RequiredVersion>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RequiredVersion"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public RequiredVersion Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RequiredVersion>(_idx);
                }
            ...
            {
                /// <summary>
                /// Gets the JSON property name for <see cref="UpgradeNotification"/>.
                /// </summary>
                public const string UpgradeNotification = "upgradeNotification";
                ...
                /// Gets the JSON property name for <see cref="UpgradeNotification"/>.
                /// </summary>
                public static ReadOnlySpan<byte> UpgradeNotificationUtf8 => "upgradeNotification"u8;
            ...
            {
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="UpgradeNotification"/>.
                /// </summary>
                public static ReadOnlySpan<byte> UpgradeNotification => "upgradeNotification"u8;
