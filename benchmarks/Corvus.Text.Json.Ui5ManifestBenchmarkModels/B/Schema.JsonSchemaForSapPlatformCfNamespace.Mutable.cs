...
public readonly partial struct Schema
{
    ...
    public readonly partial struct JsonSchemaForSapPlatformCfNamespace
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(JsonSchemaForSapPlatformCfNamespace instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="JsonSchemaForSapPlatformCfNamespace"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonSchemaForSapPlatformCfNamespace(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapPlatformCfNamespace.VersionEntity.Mutable Version
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapPlatformCfNamespace.VersionEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapPlatformCfNamespace.JsonStringArray.Mutable OAuthScopes
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OAuthScopesUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapPlatformCfNamespace.JsonStringArray.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetVersion(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapPlatformCfNamespace.VersionEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// <summary>
            /// Set the <c>oAuthScopes</c> property.
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetOAuthScopes(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapPlatformCfNamespace.JsonStringArray.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.OAuthScopesUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OAuthScopesUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsProperty(JsonPropertyNamesEscaped.OAuthScopes, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetOAuthScopes<TContext>(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapPlatformCfNamespace.JsonStringArray.Source<TContext> value)
            ...
            /// <summary>
            /// Remove the <c>oAuthScopes</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveOAuthScopes()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.OAuthScopesUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"JsonSchemaForSapPlatformCfNamespace.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly JsonSchemaForSapPlatformCfNamespace Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly JsonSchemaForSapPlatformCfNamespace Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<JsonSchemaForSapPlatformCfNamespace>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapPlatformCfNamespace.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(JsonSchemaForSapPlatformCfNamespace instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapPlatformCfNamespace.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="JsonSchemaForSapPlatformCfNamespace"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapPlatformCfNamespace.VersionEntity.Source version = default,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapPlatformCfNamespace.JsonStringArray.Source oAuthScopes = default)
            {
                version.AddAsProperty(JsonPropertyNamesEscaped.Version, ref builder, escapeName: false);
                oAuthScopes.AddAsProperty(JsonPropertyNamesEscaped.OAuthScopes, ref builder, escapeName: false);
            }

            /// <summary>
            /// Creates an instance of a <see cref="JsonSchemaForSapPlatformCfNamespace"/>.
            /// </summary>
            public void Create(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapPlatformCfNamespace.VersionEntity.Source version = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapPlatformCfNamespace.JsonStringArray.Source oAuthScopes = default)
            {
                Create(ref _builder, version, oAuthScopes);
            }
            ...
            internal static void Create<TContext>(
                ...
                ref ComplexValueBuilder builder,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapPlatformCfNamespace.VersionEntity.Source version = default,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapPlatformCfNamespace.JsonStringArray.Source<TContext> oAuthScopes = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            #endif
            {
                Create(context, ref _builder, version, oAuthScopes);
            }
        ...
        /// <param name="oAuthScopes">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapPlatformCfNamespace.VersionEntity.Source version = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapPlatformCfNamespace.JsonStringArray.Source oAuthScopes = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(version, oAuthScopes);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapPlatformCfNamespace.VersionEntity.Source version = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapPlatformCfNamespace.JsonStringArray.Source<TContext> oAuthScopes = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            ...
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(context, version, oAuthScopes);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<JsonSchemaForSapPlatformCfNamespace, Mutable>(this);
        }
    }
}
