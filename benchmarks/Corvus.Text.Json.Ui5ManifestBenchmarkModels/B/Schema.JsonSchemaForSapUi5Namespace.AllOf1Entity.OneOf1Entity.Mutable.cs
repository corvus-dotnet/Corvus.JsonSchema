        ...
        public readonly partial struct AllOf1Entity
        {
            ...
            public readonly partial struct OneOf1Entity
            {
...
#endif
                {
                    ...
                    /// <summary>
                    /// Gets the (optional) <c>flexEnabled</c> property.
                    /// </summary>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUi5Namespace.AllOf1Entity.OneOf1Entity.RepresentsAnIndicatorWhetherAnAppIsFlexEnabled.Mutable FlexEnabled
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FlexEnabledUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUi5Namespace.AllOf1Entity.OneOf1Entity.RepresentsAnIndicatorWhetherAnAppIsFlexEnabled.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDef.Mutable RootView
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RootViewUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDef.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.Ui5ManifestBenchmark.Baseline.Schema.Routing.Mutable RoutingValue
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RoutingValueUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.Routing.Mutable value))
                            {
                                return value;
                            }
                    ...
                    public void SetFlexEnabled(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUi5Namespace.AllOf1Entity.OneOf1Entity.RepresentsAnIndicatorWhetherAnAppIsFlexEnabled.Source value)
                    {
                        CheckValidInstance();

                        if (value.IsUndefined)
                        {
                            JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.FlexEnabledUtf8);
                    ...
                    /// <summary>
                    /// Remove the <c>flexEnabled</c> property, if present.
                    /// </summary>
                    /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                    public bool RemoveFlexEnabled()
                    {
                        CheckValidInstance();
                        bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.FlexEnabledUtf8);
                        _documentVersion = _parent.Version;
                        return result;
                    }
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetRootView(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDef.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetRootView<TContext>(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDef.Source<TContext> value)
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetRoutingValue(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Routing.Source value)
                    {
                        CheckValidInstance();

                        if (value.IsUndefined)
                        {
                            JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.RoutingValueUtf8);
                            _documentVersion = _parent.Version;
                            return;
                        }

                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RoutingValueUtf8, out IJsonDocument? elementParent, out int elementIdx))
                        {
                            // We are going to replace just the value
                            value.AddAsItem(ref cvb);
                            _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                        ...
                        {
                            // We are going to insert the new value
                            value.AddAsProperty(JsonPropertyNamesEscaped.RoutingValue, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                            int endIndex = _idx + _parent.GetDbSize(_idx, false);
                            _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                        }
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetRoutingValue<TContext>(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Routing.Source<TContext> value)
#if NET9_0_OR_GREATER
                        where TContext : allows ref struct
#endif
                    {
                    ...
                    /// </summary>
                    /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                    public bool RemoveRoutingValue()
                    {
                        CheckValidInstance();
                        bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.RoutingValueUtf8);
                        _documentVersion = _parent.Version;
                        return result;
                    }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUi5Namespace.AllOf1Entity.OneOf1Entity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUi5Namespace.AllOf1Entity.OneOf1Entity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    internal static void Create(
                        ...
                        in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUi5Namespace.AllOf1Entity.OneOf1Entity.RepresentsAnIndicatorWhetherAnAppIsFlexEnabled.Source flexEnabled = default,
                        in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDef.Source rootView = default,
                        in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Routing.Source routing = default)
                    {
                        ...
                        routing.AddAsProperty(JsonPropertyNamesEscaped.RoutingValue, ref builder, escapeName: false);
                    }
                    ...
                    internal static void Create<TContext>(
                        ...
                        ref ComplexValueBuilder builder,
                        in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUi5Namespace.AllOf1Entity.OneOf1Entity.RepresentsAnIndicatorWhetherAnAppIsFlexEnabled.Source flexEnabled = default,
                        in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDef.Source<TContext> rootView = default,
                        in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Routing.Source<TContext> routing = default)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                    {
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUi5Namespace.AllOf1Entity.OneOf1Entity.RepresentsAnIndicatorWhetherAnAppIsFlexEnabled.Source flexEnabled = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDef.Source rootView = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Routing.Source routing = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUi5Namespace.AllOf1Entity.OneOf1Entity.RepresentsAnIndicatorWhetherAnAppIsFlexEnabled.Source flexEnabled = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDef.Source<TContext> rootView = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Routing.Source<TContext> routing = default, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
