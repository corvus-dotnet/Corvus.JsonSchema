    ...
    public readonly partial struct JsonSchemaForSapUi5Namespace
    {
        ...
        public readonly partial struct AllOf1Entity
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUi5Namespace.AllOf1Entity.OneOf1Entity.RepresentsAnIndicatorWhetherAnAppIsFlexEnabled FlexEnabled
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FlexEnabledUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUi5Namespace.AllOf1Entity.OneOf1Entity.RepresentsAnIndicatorWhetherAnAppIsFlexEnabled value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDef RootView
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RootViewUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDef value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Baseline.Schema.Routing RoutingValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RoutingValueUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.Routing value))
                        {
                            return value;
                        }
                ...
                public static class JsonPropertyNames
                {
                    ...
                    /// <summary>
                    /// Gets the JSON property name for <see cref="RoutingValue"/>.
                    /// </summary>
                    public const string RoutingValue = "routing";
                    ...
                    /// Gets the JSON property name for <see cref="RoutingValue"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> RoutingValueUtf8 => "routing"u8;
                }
                ...
                private static class JsonPropertyNamesEscaped
                {
                    ...
                    /// <summary>
                    /// Gets the escaped UTF-8 JSON property name for <see cref="RoutingValue"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> RoutingValue => "routing"u8;
                }
            }
        }
    }
