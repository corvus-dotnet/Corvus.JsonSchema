        ...
        public readonly partial struct AllOf1Entity
        {
            ...
            public readonly partial struct RequiredFlexEnabled
            {
...
#endif
                {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUi5Namespace.AllOf1Entity.RequiredFlexEnabled.RepresentsAnIndicatorWhetherAnAppIsFlexEnabled.Mutable FlexEnabled
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FlexEnabledUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUi5Namespace.AllOf1Entity.RequiredFlexEnabled.RepresentsAnIndicatorWhetherAnAppIsFlexEnabled.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDefFlexEnabled.Mutable RootView
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RootViewUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDefFlexEnabled.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled.Mutable Routing
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RoutingUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled.Mutable value))
                            {
                                return value;
                            }
                    ...
                    public void SetFlexEnabled(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUi5Namespace.AllOf1Entity.RequiredFlexEnabled.RepresentsAnIndicatorWhetherAnAppIsFlexEnabled.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetRootView(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDefFlexEnabled.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetRootView<TContext>(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDefFlexEnabled.Source<TContext> value)
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetRouting(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetRouting<TContext>(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled.Source<TContext> value)
#if NET9_0_OR_GREATER
                        where TContext : allows ref struct
#endif
                    {
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUi5Namespace.AllOf1Entity.RequiredFlexEnabled.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUi5Namespace.AllOf1Entity.RequiredFlexEnabled.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    internal static void Create(
                        ...
                        in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUi5Namespace.AllOf1Entity.RequiredFlexEnabled.RepresentsAnIndicatorWhetherAnAppIsFlexEnabled.Source flexEnabled,
                        in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDefFlexEnabled.Source rootView = default,
                        in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled.Source routing = default)
                    {
                    ...
                    internal static void Create<TContext>(
                        ...
                        ref ComplexValueBuilder builder,
                        in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUi5Namespace.AllOf1Entity.RequiredFlexEnabled.RepresentsAnIndicatorWhetherAnAppIsFlexEnabled.Source flexEnabled,
                        in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDefFlexEnabled.Source<TContext> rootView = default,
                        in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled.Source<TContext> routing = default)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                    {
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUi5Namespace.AllOf1Entity.RequiredFlexEnabled.RepresentsAnIndicatorWhetherAnAppIsFlexEnabled.Source flexEnabled, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDefFlexEnabled.Source<TContext> rootView = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled.Source<TContext> routing = default, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
