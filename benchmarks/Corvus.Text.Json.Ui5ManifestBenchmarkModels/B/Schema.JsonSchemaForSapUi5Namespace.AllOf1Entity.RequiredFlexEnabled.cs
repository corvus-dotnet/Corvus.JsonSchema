    ...
    public readonly partial struct JsonSchemaForSapUi5Namespace
    {
        ...
        public readonly partial struct AllOf1Entity
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUi5Namespace.AllOf1Entity.RequiredFlexEnabled.RepresentsAnIndicatorWhetherAnAppIsFlexEnabled FlexEnabled
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FlexEnabledUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUi5Namespace.AllOf1Entity.RequiredFlexEnabled.RepresentsAnIndicatorWhetherAnAppIsFlexEnabled value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDefFlexEnabled RootView
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RootViewUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDefFlexEnabled value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled Routing
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RoutingUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled value))
                        {
                            return value;
                        }
