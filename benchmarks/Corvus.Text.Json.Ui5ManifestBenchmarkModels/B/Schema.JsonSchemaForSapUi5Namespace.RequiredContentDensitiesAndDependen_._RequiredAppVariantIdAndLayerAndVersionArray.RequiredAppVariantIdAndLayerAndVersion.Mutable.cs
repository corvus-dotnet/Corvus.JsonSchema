            ...
            public readonly partial struct RequiredAppVariantIdAndLayerAndVersionArray
            {
                ...
                public readonly partial struct RequiredAppVariantIdAndLayerAndVersion
                {
...
#endif
                    {
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Mutable Layer
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LayerUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        /// </summary>
                        /// <param name="value">The value of the property to add.</param>
                        public void SetLayer(in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source value)
                        {
                            CheckValidInstance();
                            ...
                            {
                                // We are going to insert the new value
                                value.AddAsProperty(JsonPropertyNamesEscaped.Layer, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                            }
                    ...
                    public ref struct Source
                    {
                        ...
                        internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUi5Namespace.RequiredContentDensitiesAndDependencies.RequiredAppVariantIdAndLayerAndVersionArray.RequiredAppVariantIdAndLayerAndVersion.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    public ref struct Builder
                    {
                        ...
                        internal static void Create(
                            ...
                            in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source appVariantId,
                            in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source layer,
                            in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source version)
                        {
                            ...
                            layer.AddAsProperty(JsonPropertyNamesEscaped.Layer, ref builder, escapeName: false);
                    ...
                    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source appVariantId, in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source layer, in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source version, int initialCapacity = 30)
                    {
                        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                        cvb.StartObject();
