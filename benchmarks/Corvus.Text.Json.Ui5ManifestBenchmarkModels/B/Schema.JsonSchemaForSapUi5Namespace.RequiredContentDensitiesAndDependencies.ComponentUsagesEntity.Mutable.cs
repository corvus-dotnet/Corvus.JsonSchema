        ...
        public readonly partial struct RequiredContentDensitiesAndDependencies
        {
            ...
            public readonly partial struct ComponentUsagesEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(ComponentUsagesEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ComponentUsagesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ComponentUsagesEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ComponentUsagesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ComponentUsagesEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ComponentUsagesEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ComponentUsagesEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUi5Namespace.RequiredContentDensitiesAndDependencies.ComponentUsagesEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(ComponentUsagesEntity instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUi5Namespace.RequiredContentDensitiesAndDependencies.ComponentUsagesEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                {
                    return workspace.CreateBuilder<ComponentUsagesEntity, Mutable>(this);
                }
            }
        }
    }
