...
public readonly partial struct Schema
{
    ...
    public readonly partial struct JsonSchemaForSapUi5Namespace
    {
        ...
        public readonly partial struct RequiredContentDensitiesAndDependencies
        {
            ...
            public readonly partial struct IsCloudDevAdaptationEntity
#if NET8_0_OR_GREATER
                : IJsonElement<IsCloudDevAdaptationEntity>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="IsCloudDevAdaptationEntity"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal IsCloudDevAdaptationEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static IsCloudDevAdaptationEntity DefaultInstance { get; } = ParsedJsonDocument<IsCloudDevAdaptationEntity>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(IsCloudDevAdaptationEntity value)
                {
                ...
                /// </returns>
                public static bool operator ==(in IsCloudDevAdaptationEntity left, in IsCloudDevAdaptationEntity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in IsCloudDevAdaptationEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(IsCloudDevAdaptationEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator IsCloudDevAdaptationEntity(JsonElement instance)
                {
                    return IsCloudDevAdaptationEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static IsCloudDevAdaptationEntity From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static IsCloudDevAdaptationEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<IsCloudDevAdaptationEntity>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static IsCloudDevAdaptationEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<IsCloudDevAdaptationEntity>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static IsCloudDevAdaptationEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<IsCloudDevAdaptationEntity>(json, options);
                }
                ...
                /// </exception>
                public static IsCloudDevAdaptationEntity ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<IsCloudDevAdaptationEntity>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out IsCloudDevAdaptationEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<IsCloudDevAdaptationEntity>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new IsCloudDevAdaptationEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static IsCloudDevAdaptationEntity IJsonElement<IsCloudDevAdaptationEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"IsCloudDevAdaptationEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="IsCloudDevAdaptationEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="IsCloudDevAdaptationEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public IsCloudDevAdaptationEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<IsCloudDevAdaptationEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="IsCloudDevAdaptationEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public IsCloudDevAdaptationEntity Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<IsCloudDevAdaptationEntity>(_idx);
                    }
