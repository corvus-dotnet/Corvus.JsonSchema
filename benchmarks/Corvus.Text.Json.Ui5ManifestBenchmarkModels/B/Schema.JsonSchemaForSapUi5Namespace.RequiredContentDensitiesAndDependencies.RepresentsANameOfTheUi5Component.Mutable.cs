        ...
        public readonly partial struct RequiredContentDensitiesAndDependencies
        {
            ...
            public readonly partial struct RepresentsANameOfTheUi5Component
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(RepresentsANameOfTheUi5Component instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="RepresentsANameOfTheUi5Component"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RepresentsANameOfTheUi5Component(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RepresentsANameOfTheUi5Component.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RepresentsANameOfTheUi5Component Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RepresentsANameOfTheUi5Component Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<RepresentsANameOfTheUi5Component>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(RepresentsANameOfTheUi5Component instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<RepresentsANameOfTheUi5Component, Mutable>(this);
                }
            }
        }
    }
