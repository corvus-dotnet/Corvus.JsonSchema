    ...
    public readonly partial struct JsonSchemaForSapUi5Namespace
    {
        ...
        public readonly partial struct RequiredContentDensitiesAndDependencies
        {
            ...
            public readonly partial struct RepresentsTheExtensionOfAnAdditionalComponent
            {
                ...
                public readonly partial struct RepresentsExtensionsOfTheComponent
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(RepresentsExtensionsOfTheComponent instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="RepresentsExtensionsOfTheComponent"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator RepresentsExtensionsOfTheComponent(Mutable instance)
                        {
                        ...
                        {
                            return
                                (obj is IJsonElement value && Equals(new RepresentsExtensionsOfTheComponent(value.ParentDocument, value.ParentDocumentIndex))) ||
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"RepresentsExtensionsOfTheComponent.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    public ref struct Source
                    {
                        ...
                        internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUi5Namespace.RequiredContentDensitiesAndDependencies.RepresentsTheExtensionOfAnAdditionalComponent.RepresentsExtensionsOfTheComponent.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                        public static implicit operator Source(RepresentsExtensionsOfTheComponent instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<RepresentsExtensionsOfTheComponent, Mutable>(this);
                    }
                }
            }
        }
