                    ...
                    public readonly partial struct RequiredBundleName
                    {
                        ...
                        public readonly partial struct EnhanceWithSettingArray
                        {
...
#endif
                            {
                                ...
                                public Corvus.Ui5ManifestBenchmark.Baseline.Schema.EnhanceWithSetting.Mutable this[int index]
                                {
                                    get
                                    {
                                        CheckValidInstance();
                                        return _parent.GetArrayIndexElement<Corvus.Ui5ManifestBenchmark.Baseline.Schema.EnhanceWithSetting.Mutable>(_idx, index);
                                    }
                                }
                                ...
                                /// </summary>
                                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                                public ArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.Schema.EnhanceWithSetting.Mutable> EnumerateArray()
                                {
                                    CheckValidInstance();
                                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.Schema.EnhanceWithSetting.Mutable>(_parent, _idx);
                                }
                                ...
                                /// </remarks>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public void SetItem(int itemIndex, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.EnhanceWithSetting.Source value)
                                {
                                    CheckValidInstance();
                                ...
                                /// </remarks>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public void InsertItem(int itemIndex, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.EnhanceWithSetting.Source value)
                                {
                                    CheckValidInstance();
                                ...
                                /// </exception>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public void AddItem(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.EnhanceWithSetting.Source value)
                                {
                                ...
                                ///   The parent <see cref="JsonDocument"/> has been disposed.
                                /// </exception>
                                public bool Remove(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.EnhanceWithSetting item)
                                {
                                    CheckValidInstance();
                                    if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.Ui5ManifestBenchmark.Baseline.Schema.EnhanceWithSetting>(this, in item))
                                    {
                                        return false;
                                    }
                                ...
                                /// </remarks>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public void RemoveWhere(JsonPredicate<Corvus.Ui5ManifestBenchmark.Baseline.Schema.EnhanceWithSetting> predicate)
                                {
                                    CheckValidInstance();
                                    JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.Ui5ManifestBenchmark.Baseline.Schema.EnhanceWithSetting>(this, predicate);
                                    _documentVersion = _parent.Version;
                                }
                                ...
                                ///   The parent <see cref="JsonDocument"/> has been disposed.
                                /// </exception>
                                public bool Replace(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.EnhanceWithSetting oldItem, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.EnhanceWithSetting.Source newItem)
                                {
                                    CheckValidInstance();
                                    ...
                                    var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.Schema.EnhanceWithSetting>(_parent, _idx);

                                    while (enumerator.MoveNext())
                                    {
                                        Corvus.Ui5ManifestBenchmark.Baseline.Schema.EnhanceWithSetting current = enumerator.Current;
                            ...
                            public ref struct Source
                            {
                                ...
                                internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUi5Namespace.RequiredContentDensitiesAndDependencies.RepresentsUi5LibrarySpecificProperties.I18nEntity.RequiredBundleName.EnhanceWithSettingArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
