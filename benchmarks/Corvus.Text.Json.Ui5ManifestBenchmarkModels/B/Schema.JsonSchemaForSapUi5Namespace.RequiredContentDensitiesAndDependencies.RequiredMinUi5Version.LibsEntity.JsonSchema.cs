        ...
        public readonly partial struct RequiredContentDensitiesAndDependencies
        {
            ...
            public readonly partial struct RequiredMinUi5Version
            {
                ...
                public readonly partial struct LibsEntity
                    : IJsonElement<LibsEntity>
                {
                    public static partial class JsonSchema
                    {
                        private static readonly JsonSchemaPathProvider PatternPropertiesSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/patternProperties/^([a-z][a-z0-9]{0,39})(\\.[a-z][a-z0-9]{0,39})*$/$ref"u8, buffer, out written);
                        ...
                        /// </summary>
                        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("ui5-manifest-schema.json#/properties/sap.ui5/allOf/0/properties/dependencies/properties/libs"u8, buffer, out written);

                        /// <summary>
                        /// Gets the schema location from which this type was generated.
                        /// </summary>
                        public const string SchemaLocation = "ui5-manifest-schema.json#/properties/sap.ui5/allOf/0/properties/dependencies/properties/libs";

                        /// <summary>
                        /// Gets the schema location from which this type was generated as a UTF-8 string.
                        /// </summary>
                        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "ui5-manifest-schema.json#/properties/sap.ui5/allOf/0/properties/dependencies/properties/libs"u8;
                            ...
                            else
                            {
                                ...
                                while (objectValidation_enumerator.MoveNext())
                                {
                                    ...
                                    if (JsonSchemaEvaluation.MatchRegularExpression(objectValidation_unescapedPropertyName.Span, PatternProperties))
                                    {
                                        ...
                                        Corvus.Ui5ManifestBenchmark.Baseline.Schema.Lib.JsonSchema.Evaluate(parentDocument, objectValidation_currentIndex, ref childContext);
                                        context.EvaluatedKeyword(context.IsMatch, "^([a-z][a-z0-9]{0,39})(\\.[a-z][a-z0-9]{0,39})*$", messageProvider: JsonSchemaEvaluation.ExpectedMatchPatternPropertySchema, "patternProperties"u8);
                        ...
                        [GeneratedRegex("^([a-z][a-z0-9]{0,39})(\\.[a-z][a-z0-9]{0,39})*$")]
                        private static partial Regex CreatePatternProperties();
#else
                        private static Regex CreatePatternProperties() => new("^([a-z][a-z0-9]{0,39})(\\.[a-z][a-z0-9]{0,39})*$", RegexOptions.Compiled);
#endif
