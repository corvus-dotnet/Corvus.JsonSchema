                ...
                public readonly partial struct I18nEntity
                {
                    ...
                    public readonly partial struct RequiredBundleUrl
                    {
                        ...
                        public readonly partial struct RepresentsTheListOfSupportedLocales
                            ...
                            : IJsonElement<RepresentsTheListOfSupportedLocales>,
                              IFormattable,
                              ISpanFormattable,
...
#endif
                        {
                            ...
                            /// <summary>
                            /// Initializes a new instance of the <see cref="RepresentsTheListOfSupportedLocales"/> struct.
                            /// </summary>
                            /// <param name="value">The value from which to construct the instance.</param>
                            internal RepresentsTheListOfSupportedLocales(IJsonDocument parent, int idx)
                            {
                                Debug.Assert(idx >= 0);
                                _parent = parent;
                                _idx = idx;
                            ...
                            /// </summary>
                            public static RepresentsTheListOfSupportedLocales DefaultInstance { get; }
                            ...
                            /// </returns>
                            public static bool operator ==(in RepresentsTheListOfSupportedLocales left, in RepresentsTheListOfSupportedLocales right)
                            {
                            ...
                            /// <c>True</c> if the values are equal.
                            /// </returns>
                            public static bool operator ==(in RepresentsTheListOfSupportedLocales left, in JsonElement right)
                            {
                                return left.Equals(right);
                            }
                            ...
                            public static implicit operator JsonElement(RepresentsTheListOfSupportedLocales instance)
                            {
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator RepresentsTheListOfSupportedLocales(JsonElement instance)
                            {
                                return RepresentsTheListOfSupportedLocales.From(instance);
                            }
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static RepresentsTheListOfSupportedLocales From<T>(in T instance)
                            ...
                            /// </exception>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static RepresentsTheListOfSupportedLocales ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                            {
                                return JsonElementHelpers.ParseValue<RepresentsTheListOfSupportedLocales>(utf8Json, options);
                            }
                            ...
                            /// </exception>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static RepresentsTheListOfSupportedLocales ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                            {
                                return JsonElementHelpers.ParseValue<RepresentsTheListOfSupportedLocales>(json, options);
                            }
                            ...
                            /// </exception>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static RepresentsTheListOfSupportedLocales ParseValue(string json, JsonDocumentOptions options = default)
                            {
                                return JsonElementHelpers.ParseValue<RepresentsTheListOfSupportedLocales>(json, options);
                            }
                            ...
                            /// </exception>
                            public static RepresentsTheListOfSupportedLocales ParseValue(ref Utf8JsonReader reader)
                            {
                                return JsonElementHelpers.ParseValue<RepresentsTheListOfSupportedLocales>(ref reader);
                            }
                            ...
                            ///   A value could not be read from the reader.
                            /// </exception>
                            public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsTheListOfSupportedLocales? result)
                            {
                                return JsonElementHelpers.TryParseValue<RepresentsTheListOfSupportedLocales>(ref reader, out result);
                            }
...
#if NET
                            static RepresentsTheListOfSupportedLocales IJsonElement<RepresentsTheListOfSupportedLocales>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            private string DebuggerDisplay => $"RepresentsTheListOfSupportedLocales: ValueKind = {ValueKind} : \"{ToString()}\"";
                            ...
                            /// <summary>
                            /// Gets a <see cref="RepresentsTheListOfSupportedLocales"/> which can be safely stored beyond the lifetime of the
                            /// original document.
                            /// </summary>
                            /// <returns>
                            /// A <see cref="RepresentsTheListOfSupportedLocales"/> which can be safely stored beyond the lifetime of the
                            /// original document.
                            /// </returns>
                            /// <remarks>
                            /// <para>
                            ...
                            /// </para>
                            /// </remarks>
                            public RepresentsTheListOfSupportedLocales Clone()
                            {
                                CheckValidInstance();
                                return _parent.CloneElement<RepresentsTheListOfSupportedLocales>(_idx);
                            }
                            ...
                            /// </summary>
                            /// <returns>
                            /// An immutable <see cref="RepresentsTheListOfSupportedLocales"/> that lives for the lifetime of its
                            ...
                            /// </para>
                            /// </remarks>
                            public RepresentsTheListOfSupportedLocales Freeze()
                            {
                                CheckValidInstance();
                                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                                {
                                    return mutable.FreezeElement<RepresentsTheListOfSupportedLocales>(_idx);
                                }
