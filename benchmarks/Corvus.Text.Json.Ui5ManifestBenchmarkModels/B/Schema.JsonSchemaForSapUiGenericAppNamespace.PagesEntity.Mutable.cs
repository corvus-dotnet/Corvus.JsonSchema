    ...
    public readonly partial struct JsonSchemaForSapUiGenericAppNamespace
    {
        ...
        public readonly partial struct PagesEntity
        {
...
#endif
            {
                ...
                /// <summary>
                /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.PagesArrayArray"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.PagesArrayArray.Mutable(Mutable value)
                {
                    return Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.PagesArrayArray.Mutable.From(value);
                }

                /// <summary>
                /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.PagesArrayArray"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.PagesArrayArray.Mutable value)
                {
                    return From(value);
                }

                /// <summary>
                /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.OneOf1Entity"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.OneOf1Entity.Mutable(Mutable value)
                {
                    return Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.OneOf1Entity.Mutable.From(value);
                }

                /// <summary>
                /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.OneOf1Entity"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.OneOf1Entity.Mutable value)
                {
                    return From(value);
                }
                ...
                public static explicit operator Mutable(PagesEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="PagesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator PagesEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"PagesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </para>
                /// </remarks>
                public readonly PagesEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly PagesEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<PagesEntity>(_idx);
                }
                ...
                /// <param name="matchPagesArrayArray">Match a <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.PagesArrayArray"/>.</param>
                /// <param name="matchOneOf1Entity">Match a <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.OneOf1Entity"/>.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.PagesArrayArray, TContext, TResult> matchPagesArrayArray,
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.OneOf1Entity, TContext, TResult> matchOneOf1Entity,
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.PagesArrayArray.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchPagesArrayArray(Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.PagesArrayArray.Mutable.From(this), context);
                    }

                    if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchOneOf1Entity(Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.OneOf1Entity.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.PagesArrayArray, TResult> matchPagesArrayArray,
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.OneOf1Entity, TResult> matchOneOf1Entity,
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.PagesArrayArray.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchPagesArrayArray(Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.PagesArrayArray.Mutable.From(this));
                    }

                    if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchOneOf1Entity(Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.OneOf1Entity.Mutable.From(this));
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.PagesArrayArray" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsPagesArrayArray(out Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.PagesArrayArray result)
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.PagesArrayArray.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.PagesArrayArray.Mutable.From(this);
                        return true;
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.OneOf1Entity" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsOneOf1Entity(out Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.OneOf1Entity result)
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.OneOf1Entity.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.OneOf1Entity.Builder.Build? _oneOf1EntityBuilderInstance;
                ...
                internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.ArrayBuilder.Build value) {_arrayBuilder = value; _kind = Kind.ArrayBuilder; }

                public Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.OneOf1Entity.Builder.Build value) {_oneOf1EntityBuilderInstance = value; _kind = Kind.OneOf1EntityBuilder; }

                public static implicit operator Source(PagesEntity instance) => new(JsonElement.From(instance));

                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.OneOf1Entity instance) => new(JsonElement.From(instance));
                ...
                internal void AddAsProperty(ReadOnlySpan<byte> utf8Name, ref ComplexValueBuilder valueBuilder, bool escapeName = true, bool nameRequiresUnescaping = false)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.OneOf1EntityBuilder:
                            valueBuilder.AddProperty(utf8Name, _oneOf1EntityBuilderInstance!, static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.OneOf1Entity.Builder.BuildValue(b, ref o), escapeName, nameRequiresUnescaping);
                            break;
                        default:
                ...
                internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.ArrayBuilder:
                            ...
                            break;
                        case Kind.OneOf1EntityBuilder:
                            valueBuilder.AddProperty(name, _oneOf1EntityBuilderInstance!, static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.OneOf1Entity.Builder.BuildValue(b, ref o));
                            break;
                        default:
                            Debug.Fail("Unexpected Kind");
                            break;
                ...
                internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.ArrayBuilder:
                            ...
                            break;
                        case Kind.OneOf1EntityBuilder:
                            valueBuilder.AddItem(_oneOf1EntityBuilderInstance!, static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.OneOf1Entity.Builder.BuildValue(b, ref o));
                            break;
                        default:
                            Debug.Fail("Unexpected Kind");
                            break;
                ...
                #endif
            {
                ...
                private readonly Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.OneOf1Entity.Builder.Build<TContext>? _oneOf1EntityBuilderInstance;
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.ArrayBuilder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.ArrayBuilder; }

                public Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.OneOf1Entity.Builder.Build<TContext> value) {_context = context; _oneOf1EntityBuilderInstance = value; _kind = Kind.OneOf1EntityBuilder; }
                ...
                internal void AddAsProperty(ReadOnlySpan<byte> utf8Name, ref ComplexValueBuilder valueBuilder, bool escapeName = true, bool nameRequiresUnescaping = false)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.ArrayBuilder:
                            ...
                            break;
                        case Kind.OneOf1EntityBuilder:
                            valueBuilder.AddProperty(utf8Name, BuildWithContext.Create(_context, _oneOf1EntityBuilderInstance!), static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.OneOf1Entity.Builder.BuildValue(b.Context, b.Build, ref o), escapeName, nameRequiresUnescaping);
                            break;
                        default:
                            Debug.Fail("Unexpected Kind");
                            break;
                ...
                internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.ArrayBuilder:
                            ...
                            break;
                        case Kind.OneOf1EntityBuilder:
                            valueBuilder.AddProperty(name, BuildWithContext.Create(_context, _oneOf1EntityBuilderInstance!), static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.OneOf1Entity.Builder.BuildValue(b.Context, b.Build, ref o));
                            break;
                        default:
                            Debug.Fail("Unexpected Kind");
                            break;
                ...
                internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.ArrayBuilder:
                            ...
                            break;
                        case Kind.OneOf1EntityBuilder:
                            valueBuilder.AddItem(BuildWithContext.Create(_context, _oneOf1EntityBuilderInstance!), static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.OneOf1Entity.Builder.BuildValue(b.Context, b.Build, ref o));
                            break;
                        default:
                            Debug.Fail("Unexpected Kind");
                            break;
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.OneOf1Entity.Source Build(
                scoped in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.OneOf1Entity.Builder.Build buildValue, int initialCapacity = 1)
            {
                return new Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.OneOf1Entity.Source(buildValue);
            }
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.OneOf1Entity.Source<TContext> Build<TContext>(
                scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.OneOf1Entity.Builder.Build<TContext> buildValue, int initialCapacity = 1)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                return new Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.OneOf1Entity.Source<TContext>(context, buildValue);
            }
            ...
            /// <returns>An instance of a mutable document initialized with the given value.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(
                JsonWorkspace workspace, scoped in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.OneOf1Entity.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
            {
                // Create the document builder without a MetadataDb
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                var source = new Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.OneOf1Entity.Source(value);
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(
                JsonWorkspace workspace, scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.OneOf1Entity.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                ...
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                var source = new Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapUiGenericAppNamespace.PagesEntity.OneOf1Entity.Source<TContext>(context, value);
                source.AddAsItem(ref cvb);
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<PagesEntity, Mutable>(this);
            }
        }
    }
}
