    ...
    public readonly partial struct JsonSchemaForSapUiNamespace
    {
        ...
        public readonly partial struct DeviceTypesEntity
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="RequiredDesktopAndPhoneAndTablet"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal RequiredDesktopAndPhoneAndTablet(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static RequiredDesktopAndPhoneAndTablet DefaultInstance { get; }
                ...
                /// </returns>
                public static bool operator ==(in RequiredDesktopAndPhoneAndTablet left, in RequiredDesktopAndPhoneAndTablet right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in RequiredDesktopAndPhoneAndTablet left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(RequiredDesktopAndPhoneAndTablet instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RequiredDesktopAndPhoneAndTablet(JsonElement instance)
                {
                    return RequiredDesktopAndPhoneAndTablet.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredDesktopAndPhoneAndTablet From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredDesktopAndPhoneAndTablet ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RequiredDesktopAndPhoneAndTablet>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredDesktopAndPhoneAndTablet ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RequiredDesktopAndPhoneAndTablet>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredDesktopAndPhoneAndTablet ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RequiredDesktopAndPhoneAndTablet>(json, options);
                }
                ...
                /// </exception>
                public static RequiredDesktopAndPhoneAndTablet ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<RequiredDesktopAndPhoneAndTablet>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredDesktopAndPhoneAndTablet? result)
                {
                    return JsonElementHelpers.TryParseValue<RequiredDesktopAndPhoneAndTablet>(ref reader, out result);
                }
...
#if NET
                static RequiredDesktopAndPhoneAndTablet IJsonElement<RequiredDesktopAndPhoneAndTablet>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RequiredDesktopAndPhoneAndTablet: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public RequiredDesktopAndPhoneAndTablet Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public RequiredDesktopAndPhoneAndTablet Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<RequiredDesktopAndPhoneAndTablet>(_idx);
                    }
