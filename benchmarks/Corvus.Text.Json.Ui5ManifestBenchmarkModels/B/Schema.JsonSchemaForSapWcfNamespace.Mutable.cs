...
public readonly partial struct Schema
{
    ...
    public readonly partial struct JsonSchemaForSapWcfNamespace
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(JsonSchemaForSapWcfNamespace instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="JsonSchemaForSapWcfNamespace"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonSchemaForSapWcfNamespace(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapWcfNamespace.VersionEntity.Mutable Version
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapWcfNamespace.VersionEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// <summary>
            /// Gets the <c>wcf-target-id</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapWcfNamespace.RepresentsTheTargetTechnicalIdForAWcfApplication.Mutable WcfTargetId
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.WcfTargetIdUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapWcfNamespace.RepresentsTheTargetTechnicalIdForAWcfApplication.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new JsonSchemaForSapWcfNamespace(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetVersion(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapWcfNamespace.VersionEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetWcfTargetId(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapWcfNamespace.RepresentsTheTargetTechnicalIdForAWcfApplication.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("wcf-target-id");
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.WcfTargetIdUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsProperty(JsonPropertyNamesEscaped.WcfTargetId, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"JsonSchemaForSapWcfNamespace.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="JsonSchemaForSapWcfNamespace"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="JsonSchemaForSapWcfNamespace"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly JsonSchemaForSapWcfNamespace Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<JsonSchemaForSapWcfNamespace>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="JsonSchemaForSapWcfNamespace"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly JsonSchemaForSapWcfNamespace Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<JsonSchemaForSapWcfNamespace>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapWcfNamespace.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(JsonSchemaForSapWcfNamespace instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapWcfNamespace.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="JsonSchemaForSapWcfNamespace"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapWcfNamespace.RepresentsTheTargetTechnicalIdForAWcfApplication.Source wcfTargetId,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapWcfNamespace.VersionEntity.Source version = default)
            {
                wcfTargetId.AddAsProperty(JsonPropertyNamesEscaped.WcfTargetId, ref builder, escapeName: false);
            ...
            /// Creates an instance of a <see cref="JsonSchemaForSapWcfNamespace"/>.
            /// </summary>
            public void Create(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapWcfNamespace.RepresentsTheTargetTechnicalIdForAWcfApplication.Source wcfTargetId, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapWcfNamespace.VersionEntity.Source version = default)
            {
                Create(ref _builder, wcfTargetId, version);
            }
        ...
        /// </summary>
        /// <param name="workspace">The JSON workspace.</param>
        /// <param name="wcfTargetId">The value of the property.</param>
        /// <param name="version">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapWcfNamespace.RepresentsTheTargetTechnicalIdForAWcfApplication.Source wcfTargetId, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.JsonSchemaForSapWcfNamespace.VersionEntity.Source version = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(wcfTargetId, version);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<JsonSchemaForSapWcfNamespace, Mutable>(this);
        }
    }
}
