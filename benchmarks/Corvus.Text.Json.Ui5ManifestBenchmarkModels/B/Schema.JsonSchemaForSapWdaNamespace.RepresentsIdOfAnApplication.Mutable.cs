    ...
    public readonly partial struct JsonSchemaForSapWdaNamespace
    {
        ...
        public readonly partial struct RepresentsIdOfAnApplication
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RepresentsIdOfAnApplication instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsIdOfAnApplication"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsIdOfAnApplication(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsIdOfAnApplication.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsIdOfAnApplication Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsIdOfAnApplication Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsIdOfAnApplication>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsIdOfAnApplication instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RepresentsIdOfAnApplication, Mutable>(this);
            }
        }
    }
}
