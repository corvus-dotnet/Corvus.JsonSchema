...
public readonly partial struct Schema
{
    ...
    public readonly partial struct LevelsDef
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(LevelsDef instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="LevelsDef"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator LevelsDef(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new LevelsDef(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"LevelsDef.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// <summary>
            /// Gets a <see cref="LevelsDef"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="LevelsDef"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly LevelsDef Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<LevelsDef>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="LevelsDef"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly LevelsDef Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<LevelsDef>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.LevelsDef.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(LevelsDef instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.LevelsDef.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<LevelsDef, Mutable>(this);
        }
    }
}
