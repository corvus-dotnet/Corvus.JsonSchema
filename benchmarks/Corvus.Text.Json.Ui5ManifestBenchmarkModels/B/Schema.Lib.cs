...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Lib"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal Lib(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static Lib DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.Schema.Lib.RepresentsIndicatorToLazyLoadingLib Lazy
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LazyUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.Lib.RepresentsIndicatorToLazyLoadingLib value))
                {
                    return value;
                }

                return Corvus.Ui5ManifestBenchmark.Baseline.Schema.Lib.RepresentsIndicatorToLazyLoadingLib.DefaultInstance;
            }
        }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.JsonString MinVersion
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MinVersionUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.JsonString value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in Lib left, in Lib right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Lib left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(Lib instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Lib(JsonElement instance)
        {
            return Lib.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Lib From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Lib ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Lib>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Lib ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Lib>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Lib ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Lib>(json, options);
        }
        ...
        /// </exception>
        public static Lib ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<Lib>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Lib? result)
        {
            return JsonElementHelpers.TryParseValue<Lib>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new Lib(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static Lib IJsonElement<Lib>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Lib: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="Lib"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="Lib"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        {
            CheckValidInstance();
            return _parent.CloneElement<Lib>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="Lib"/> that lives for the lifetime of its
        ...
        public Lib Freeze()
        {
            ...
            {
                return mutable.FreezeElement<Lib>(_idx);
            }
