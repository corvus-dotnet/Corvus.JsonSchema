...
public readonly partial struct Schema
{
    ...
    public readonly partial struct MicrochartBullet
    {
        ...
        public readonly partial struct MicrochartBulletThresholdArray
#if NET8_0_OR_GREATER
            : IJsonElement<MicrochartBulletThresholdArray>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="MicrochartBulletThresholdArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal MicrochartBulletThresholdArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static MicrochartBulletThresholdArray DefaultInstance { get; }
            ...
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.MicrochartBulletThreshold this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Ui5ManifestBenchmark.Baseline.Schema.MicrochartBulletThreshold>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.Schema.MicrochartBulletThreshold> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.Schema.MicrochartBulletThreshold>(_parent, _idx);
            }
            ...
            /// </returns>
            public static bool operator ==(in MicrochartBulletThresholdArray left, in MicrochartBulletThresholdArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in MicrochartBulletThresholdArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(MicrochartBulletThresholdArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MicrochartBulletThresholdArray(JsonElement instance)
            {
                return MicrochartBulletThresholdArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MicrochartBulletThresholdArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MicrochartBulletThresholdArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MicrochartBulletThresholdArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MicrochartBulletThresholdArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MicrochartBulletThresholdArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MicrochartBulletThresholdArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MicrochartBulletThresholdArray>(json, options);
            }
            ...
            /// </exception>
            public static MicrochartBulletThresholdArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<MicrochartBulletThresholdArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out MicrochartBulletThresholdArray? result)
            {
                return JsonElementHelpers.TryParseValue<MicrochartBulletThresholdArray>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new MicrochartBulletThresholdArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static MicrochartBulletThresholdArray IJsonElement<MicrochartBulletThresholdArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MicrochartBulletThresholdArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="MicrochartBulletThresholdArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="MicrochartBulletThresholdArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public MicrochartBulletThresholdArray Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<MicrochartBulletThresholdArray>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="MicrochartBulletThresholdArray"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public MicrochartBulletThresholdArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<MicrochartBulletThresholdArray>(_idx);
                }
