    ...
    public readonly partial struct MicrochartBullet
    {
        ...
        public readonly partial struct TheMaximumScaleValueForTheBarChart
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(TheMaximumScaleValueForTheBarChart instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TheMaximumScaleValueForTheBarChart"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TheMaximumScaleValueForTheBarChart(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TheMaximumScaleValueForTheBarChart.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly TheMaximumScaleValueForTheBarChart Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly TheMaximumScaleValueForTheBarChart Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TheMaximumScaleValueForTheBarChart>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.MicrochartBullet.TheMaximumScaleValueForTheBarChart.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.MicrochartBullet.TheMaximumScaleValueForTheBarChart.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(TheMaximumScaleValueForTheBarChart instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<TheMaximumScaleValueForTheBarChart, Mutable>(this);
            }
        }
    }
}
