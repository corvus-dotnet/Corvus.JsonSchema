    ...
    public readonly partial struct MicrochartBullet
    {
        ...
        public readonly partial struct TheTargetValueDisplayedAsAVerticalLineMarker
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(TheTargetValueDisplayedAsAVerticalLineMarker instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TheTargetValueDisplayedAsAVerticalLineMarker"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TheTargetValueDisplayedAsAVerticalLineMarker(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TheTargetValueDisplayedAsAVerticalLineMarker.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly TheTargetValueDisplayedAsAVerticalLineMarker Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly TheTargetValueDisplayedAsAVerticalLineMarker Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TheTargetValueDisplayedAsAVerticalLineMarker>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.MicrochartBullet.TheTargetValueDisplayedAsAVerticalLineMarker.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.MicrochartBullet.TheTargetValueDisplayedAsAVerticalLineMarker.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(TheTargetValueDisplayedAsAVerticalLineMarker instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<TheTargetValueDisplayedAsAVerticalLineMarker, Mutable>(this);
            }
        }
    }
}
