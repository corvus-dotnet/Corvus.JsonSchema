...
public readonly partial struct Schema
{
    ...
    public readonly partial struct MicrochartBulletThreshold
    {
        ...
        public readonly partial struct TheValueOfTheThreshold
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(TheValueOfTheThreshold instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TheValueOfTheThreshold"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TheValueOfTheThreshold(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new TheValueOfTheThreshold(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TheValueOfTheThreshold.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="TheValueOfTheThreshold"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="TheValueOfTheThreshold"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly TheValueOfTheThreshold Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<TheValueOfTheThreshold>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="TheValueOfTheThreshold"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly TheValueOfTheThreshold Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TheValueOfTheThreshold>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.MicrochartBulletThreshold.TheValueOfTheThreshold.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.MicrochartBulletThreshold.TheValueOfTheThreshold.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(TheValueOfTheThreshold instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<TheValueOfTheThreshold, Mutable>(this);
            }
        }
    }
}
