...
public readonly partial struct Schema
{
    ...
    public readonly partial struct MicrochartBulletThreshold
    {
...
#endif
        {
            ...
            public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.Schema.SimpleBinding(TheValueOfTheThreshold value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator TheValueOfTheThreshold(Corvus.Ui5ManifestBenchmark.Baseline.Schema.SimpleBinding value)
            {
                return From(value);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.MicrochartBulletThreshold.TheValueOfTheThreshold, TContext, TResult> defaultMatch)
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.MicrochartBulletThreshold.TheValueOfTheThreshold, TResult> defaultMatch)
            {
                if (Corvus.Ui5ManifestBenchmark.Baseline.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                {
