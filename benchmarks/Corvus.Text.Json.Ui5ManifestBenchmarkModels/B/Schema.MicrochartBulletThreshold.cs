...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MicrochartBulletThreshold"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal MicrochartBulletThreshold(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static MicrochartBulletThreshold DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.Schema.MicrochartBulletThreshold.TheStateColorOfTheThreshold Color
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ColorUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.MicrochartBulletThreshold.TheStateColorOfTheThreshold value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.Schema.MicrochartBulletThreshold.TheValueOfTheThreshold Value
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ValueUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.MicrochartBulletThreshold.TheValueOfTheThreshold value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in MicrochartBulletThreshold left, in MicrochartBulletThreshold right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in MicrochartBulletThreshold left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(MicrochartBulletThreshold instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator MicrochartBulletThreshold(JsonElement instance)
        {
            return MicrochartBulletThreshold.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MicrochartBulletThreshold From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MicrochartBulletThreshold ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<MicrochartBulletThreshold>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MicrochartBulletThreshold ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<MicrochartBulletThreshold>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MicrochartBulletThreshold ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<MicrochartBulletThreshold>(json, options);
        }
        ...
        /// </exception>
        public static MicrochartBulletThreshold ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<MicrochartBulletThreshold>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out MicrochartBulletThreshold? result)
        {
            return JsonElementHelpers.TryParseValue<MicrochartBulletThreshold>(ref reader, out result);
        }
...
#if NET
        static MicrochartBulletThreshold IJsonElement<MicrochartBulletThreshold>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"MicrochartBulletThreshold: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public MicrochartBulletThreshold Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public MicrochartBulletThreshold Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<MicrochartBulletThreshold>(_idx);
            }
