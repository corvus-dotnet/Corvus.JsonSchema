...
public readonly partial struct Schema
{
    ...
    public readonly partial struct MicrochartStackedBar
    {
        ...
        public readonly partial struct RepresentsTheTypeOfTheMicrochart
#if NET8_0_OR_GREATER
            : IJsonElement<RepresentsTheTypeOfTheMicrochart>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RepresentsTheTypeOfTheMicrochart"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RepresentsTheTypeOfTheMicrochart(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RepresentsTheTypeOfTheMicrochart DefaultInstance { get; }

            /// <summary>
            /// Gets the const instance.
            /// </summary>
            public static RepresentsTheTypeOfTheMicrochart ConstInstance => Constants.ConstJson;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(RepresentsTheTypeOfTheMicrochart value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in RepresentsTheTypeOfTheMicrochart left, in RepresentsTheTypeOfTheMicrochart right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RepresentsTheTypeOfTheMicrochart left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(RepresentsTheTypeOfTheMicrochart instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RepresentsTheTypeOfTheMicrochart(JsonElement instance)
            {
                return RepresentsTheTypeOfTheMicrochart.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheTypeOfTheMicrochart From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheTypeOfTheMicrochart ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheTypeOfTheMicrochart>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheTypeOfTheMicrochart ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheTypeOfTheMicrochart>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheTypeOfTheMicrochart ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheTypeOfTheMicrochart>(json, options);
            }
            ...
            /// </exception>
            public static RepresentsTheTypeOfTheMicrochart ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheTypeOfTheMicrochart>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsTheTypeOfTheMicrochart? result)
            {
                return JsonElementHelpers.TryParseValue<RepresentsTheTypeOfTheMicrochart>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RepresentsTheTypeOfTheMicrochart(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static RepresentsTheTypeOfTheMicrochart IJsonElement<RepresentsTheTypeOfTheMicrochart>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RepresentsTheTypeOfTheMicrochart: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RepresentsTheTypeOfTheMicrochart"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RepresentsTheTypeOfTheMicrochart"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public RepresentsTheTypeOfTheMicrochart Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RepresentsTheTypeOfTheMicrochart>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RepresentsTheTypeOfTheMicrochart"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public RepresentsTheTypeOfTheMicrochart Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RepresentsTheTypeOfTheMicrochart>(_idx);
                }
