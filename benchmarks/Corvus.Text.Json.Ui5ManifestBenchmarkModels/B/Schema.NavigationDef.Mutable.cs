...
public readonly partial struct Schema
{
    ...
    public readonly partial struct NavigationDef
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.ActionPropDef.Mutable Create
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CreateUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.ActionPropDef.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.ActionPropDef.Mutable Display
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DisplayUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.ActionPropDef.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.ActionPropDef.Mutable Edit
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EditUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.ActionPropDef.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetCreate(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ActionPropDef.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetCreate<TContext>(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ActionPropDef.Source<TContext> value)
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetDisplay(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ActionPropDef.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetDisplay<TContext>(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ActionPropDef.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetEdit(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ActionPropDef.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetEdit<TContext>(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ActionPropDef.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.NavigationDef.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.NavigationDef.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ActionPropDef.Source create = default,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ActionPropDef.Source display = default,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ActionPropDef.Source edit = default)
            {
            ...
            internal static void Create<TContext>(
                in TContext context,
                ref ComplexValueBuilder builder,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ActionPropDef.Source<TContext> create = default,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ActionPropDef.Source<TContext> display = default,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ActionPropDef.Source<TContext> edit = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ActionPropDef.Source create = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ActionPropDef.Source display = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ActionPropDef.Source edit = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ActionPropDef.Source<TContext> create = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ActionPropDef.Source<TContext> display = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ActionPropDef.Source<TContext> edit = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
