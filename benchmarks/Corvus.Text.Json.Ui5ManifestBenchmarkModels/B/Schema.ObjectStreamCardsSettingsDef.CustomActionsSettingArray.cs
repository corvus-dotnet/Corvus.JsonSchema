...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ObjectStreamCardsSettingsDef
    {
        ...
        public readonly partial struct CustomActionsSettingArray
            ...
            : IJsonElement<CustomActionsSettingArray>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="CustomActionsSettingArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal CustomActionsSettingArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static CustomActionsSettingArray DefaultInstance { get; }
            ...
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.CustomActionsSetting this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Ui5ManifestBenchmark.Baseline.Schema.CustomActionsSetting>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.Schema.CustomActionsSetting> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.Schema.CustomActionsSetting>(_parent, _idx);
            }
            ...
            /// </returns>
            public static bool operator ==(in CustomActionsSettingArray left, in CustomActionsSettingArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in CustomActionsSettingArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(CustomActionsSettingArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator CustomActionsSettingArray(JsonElement instance)
            {
                return CustomActionsSettingArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CustomActionsSettingArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CustomActionsSettingArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CustomActionsSettingArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CustomActionsSettingArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CustomActionsSettingArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static CustomActionsSettingArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<CustomActionsSettingArray>(json, options);
            }
            ...
            /// </exception>
            public static CustomActionsSettingArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<CustomActionsSettingArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out CustomActionsSettingArray? result)
            {
                return JsonElementHelpers.TryParseValue<CustomActionsSettingArray>(ref reader, out result);
            }
...
#if NET
            static CustomActionsSettingArray IJsonElement<CustomActionsSettingArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"CustomActionsSettingArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public CustomActionsSettingArray Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public CustomActionsSettingArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<CustomActionsSettingArray>(_idx);
                }
