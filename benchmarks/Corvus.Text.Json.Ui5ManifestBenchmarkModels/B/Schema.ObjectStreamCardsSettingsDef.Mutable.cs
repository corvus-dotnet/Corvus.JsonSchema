...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ObjectStreamCardsSettingsDef
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ObjectStreamCardsSettingsDef instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ObjectStreamCardsSettingsDef"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ObjectStreamCardsSettingsDef(Mutable instance)
            {
            ...
            /// <summary>
            /// Gets the (optional) <c>customActions</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.ObjectStreamCardsSettingsDef.CustomActionsSettingArray.Mutable CustomActions
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CustomActionsUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.ObjectStreamCardsSettingsDef.CustomActionsSettingArray.Mutable value))
                    {
                        return value;
                    }
            ...
            /// <summary>
            /// Gets the (optional) <c>showFirstActionInFooter</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.ObjectStreamCardsSettingsDef.ShowFirstActionInFooterEntity.Mutable ShowFirstActionInFooter
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ShowFirstActionInFooterUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.ObjectStreamCardsSettingsDef.ShowFirstActionInFooterEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ObjectStreamCardsSettingsDef(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            /// <summary>
            /// Set the <c>customActions</c> property.
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetCustomActions(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ObjectStreamCardsSettingsDef.CustomActionsSettingArray.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.CustomActionsUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CustomActionsUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                ...
                else
                {
                    ...
                    value.AddAsProperty(JsonPropertyNamesEscaped.CustomActions, ref cvb, escapeName: false, nameRequiresUnescaping: false);
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetCustomActions<TContext>(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ObjectStreamCardsSettingsDef.CustomActionsSettingArray.Source<TContext> value)
            ...
            /// <summary>
            /// Remove the <c>customActions</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveCustomActions()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.CustomActionsUtf8);
                _documentVersion = _parent.Version;
                return result;
            }

            /// <summary>
            /// Set the <c>showFirstActionInFooter</c> property.
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetShowFirstActionInFooter(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ObjectStreamCardsSettingsDef.ShowFirstActionInFooterEntity.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ShowFirstActionInFooterUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ShowFirstActionInFooterUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsProperty(JsonPropertyNamesEscaped.ShowFirstActionInFooter, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// <summary>
            /// Remove the <c>showFirstActionInFooter</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveShowFirstActionInFooter()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ShowFirstActionInFooterUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ObjectStreamCardsSettingsDef.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ObjectStreamCardsSettingsDef"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ObjectStreamCardsSettingsDef"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly ObjectStreamCardsSettingsDef Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ObjectStreamCardsSettingsDef>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ObjectStreamCardsSettingsDef"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly ObjectStreamCardsSettingsDef Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ObjectStreamCardsSettingsDef>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.ObjectStreamCardsSettingsDef.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(ObjectStreamCardsSettingsDef instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.ObjectStreamCardsSettingsDef.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="ObjectStreamCardsSettingsDef"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ObjectStreamCardsSettingsDef.CustomActionsSettingArray.Source customActions = default,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ObjectStreamCardsSettingsDef.ShowFirstActionInFooterEntity.Source showFirstActionInFooter = default)
            {
                customActions.AddAsProperty(JsonPropertyNamesEscaped.CustomActions, ref builder, escapeName: false);
                showFirstActionInFooter.AddAsProperty(JsonPropertyNamesEscaped.ShowFirstActionInFooter, ref builder, escapeName: false);
            }

            /// <summary>
            /// Creates an instance of a <see cref="ObjectStreamCardsSettingsDef"/>.
            /// </summary>
            public void Create(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ObjectStreamCardsSettingsDef.CustomActionsSettingArray.Source customActions = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ObjectStreamCardsSettingsDef.ShowFirstActionInFooterEntity.Source showFirstActionInFooter = default)
            {
                Create(ref _builder, customActions, showFirstActionInFooter);
            }
            ...
            internal static void Create<TContext>(
                in TContext context,
                ref ComplexValueBuilder builder,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ObjectStreamCardsSettingsDef.CustomActionsSettingArray.Source<TContext> customActions = default,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ObjectStreamCardsSettingsDef.ShowFirstActionInFooterEntity.Source showFirstActionInFooter = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            ...
            #endif
            {
                Create(context, ref _builder, customActions, showFirstActionInFooter);
            }
        ...
        /// </summary>
        /// <param name="workspace">The JSON workspace.</param>
        /// <param name="customActions">The value of the property.</param>
        /// <param name="showFirstActionInFooter">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ObjectStreamCardsSettingsDef.CustomActionsSettingArray.Source customActions = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ObjectStreamCardsSettingsDef.ShowFirstActionInFooterEntity.Source showFirstActionInFooter = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(customActions, showFirstActionInFooter);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
            ...
            #endif
        {
            ...
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(context, customActions, showFirstActionInFooter);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<ObjectStreamCardsSettingsDef, Mutable>(this);
        }
    }
}
