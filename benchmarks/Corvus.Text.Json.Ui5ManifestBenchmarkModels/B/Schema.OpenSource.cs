...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OpenSource"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal OpenSource(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static OpenSource DefaultInstance { get; }
        ...
        /// <summary>
        /// Gets the (optional) <c>packagedWithMySelf</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.JsonBoolean PackagedWithMySelf
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PackagedWithMySelfUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.JsonBoolean value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in OpenSource left, in OpenSource right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in OpenSource left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(OpenSource instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator OpenSource(JsonElement instance)
        {
            return OpenSource.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static OpenSource From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static OpenSource ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<OpenSource>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static OpenSource ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<OpenSource>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static OpenSource ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<OpenSource>(json, options);
        }
        ...
        /// </exception>
        public static OpenSource ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<OpenSource>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out OpenSource? result)
        {
            return JsonElementHelpers.TryParseValue<OpenSource>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new OpenSource(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static OpenSource IJsonElement<OpenSource>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"OpenSource: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="OpenSource"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="OpenSource"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public OpenSource Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<OpenSource>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="OpenSource"/> that lives for the lifetime of its
        ...
        public static class JsonPropertyNames
        {
            ...
            /// <summary>
            /// Gets the JSON property name for <see cref="PackagedWithMySelf"/>.
            /// </summary>
            public const string PackagedWithMySelf = "packagedWithMySelf";
            ...
            /// Gets the JSON property name for <see cref="PackagedWithMySelf"/>.
            /// </summary>
            public static ReadOnlySpan<byte> PackagedWithMySelfUtf8 => "packagedWithMySelf"u8;
        ...
        private static class JsonPropertyNamesEscaped
        {
            ...
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="PackagedWithMySelf"/>.
            /// </summary>
            public static ReadOnlySpan<byte> PackagedWithMySelf => "packagedWithMySelf"u8;
