        ...
        public readonly partial struct RequiredActionAndSemanticObject
        {
                ...
                : IJsonElement<ActionEntity>
            {
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("ui5-manifest-schema.json#/definitions/outbound/patternProperties/^[\\w\\.\\-]+$/properties/action"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "ui5-manifest-schema.json#/definitions/outbound/patternProperties/^[\\w\\.\\-]+$/properties/action";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "ui5-manifest-schema.json#/definitions/outbound/patternProperties/^[\\w\\.\\-]+$/properties/action"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        else
                        {
                            ...
                            JsonSchemaEvaluation.MatchRegularExpression(unescapedUtf8JsonString.Span, Pattern,"^[\\w\\*]{0,60}$", "pattern"u8, ref context);
                        }
                    }
                    ...
                    [GeneratedRegex("^[\\w\\*]{0,60}$")]
                    private static partial Regex CreatePattern();
#else
                    private static Regex CreatePattern() => new("^[\\w\\*]{0,60}$", RegexOptions.Compiled);
#endif
