    ...
    public readonly partial struct Outbound
    {
        ...
        public readonly partial struct RequiredActionAndSemanticObject
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="RepresentsABusinessEntityEGEmployee"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal RepresentsABusinessEntityEGEmployee(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static RepresentsABusinessEntityEGEmployee DefaultInstance { get; }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(RepresentsABusinessEntityEGEmployee value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in RepresentsABusinessEntityEGEmployee left, in RepresentsABusinessEntityEGEmployee right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in RepresentsABusinessEntityEGEmployee left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(RepresentsABusinessEntityEGEmployee instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsABusinessEntityEGEmployee(JsonElement instance)
                {
                    return RepresentsABusinessEntityEGEmployee.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RepresentsABusinessEntityEGEmployee From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RepresentsABusinessEntityEGEmployee ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RepresentsABusinessEntityEGEmployee>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RepresentsABusinessEntityEGEmployee ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RepresentsABusinessEntityEGEmployee>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RepresentsABusinessEntityEGEmployee ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RepresentsABusinessEntityEGEmployee>(json, options);
                }
                ...
                /// </exception>
                public static RepresentsABusinessEntityEGEmployee ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<RepresentsABusinessEntityEGEmployee>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsABusinessEntityEGEmployee? result)
                {
                    return JsonElementHelpers.TryParseValue<RepresentsABusinessEntityEGEmployee>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new RepresentsABusinessEntityEGEmployee(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static RepresentsABusinessEntityEGEmployee IJsonElement<RepresentsABusinessEntityEGEmployee>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsABusinessEntityEGEmployee: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="RepresentsABusinessEntityEGEmployee"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="RepresentsABusinessEntityEGEmployee"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public RepresentsABusinessEntityEGEmployee Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<RepresentsABusinessEntityEGEmployee>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="RepresentsABusinessEntityEGEmployee"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public RepresentsABusinessEntityEGEmployee Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<RepresentsABusinessEntityEGEmployee>(_idx);
                    }
