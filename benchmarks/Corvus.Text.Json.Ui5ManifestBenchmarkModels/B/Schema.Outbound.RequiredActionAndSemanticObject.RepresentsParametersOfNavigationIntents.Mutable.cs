        ...
        public readonly partial struct RequiredActionAndSemanticObject
        {
            ...
            public readonly partial struct RepresentsParametersOfNavigationIntents
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(RepresentsParametersOfNavigationIntents instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="RepresentsParametersOfNavigationIntents"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RepresentsParametersOfNavigationIntents(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new RepresentsParametersOfNavigationIntents(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RepresentsParametersOfNavigationIntents.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="RepresentsParametersOfNavigationIntents"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="RepresentsParametersOfNavigationIntents"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RepresentsParametersOfNavigationIntents Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<RepresentsParametersOfNavigationIntents>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="RepresentsParametersOfNavigationIntents"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RepresentsParametersOfNavigationIntents Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<RepresentsParametersOfNavigationIntents>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.Outbound.RequiredActionAndSemanticObject.RepresentsParametersOfNavigationIntents.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(RepresentsParametersOfNavigationIntents instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.Outbound.RequiredActionAndSemanticObject.RepresentsParametersOfNavigationIntents.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                {
                    return workspace.CreateBuilder<RepresentsParametersOfNavigationIntents, Mutable>(this);
                }
            }
        }
    }
