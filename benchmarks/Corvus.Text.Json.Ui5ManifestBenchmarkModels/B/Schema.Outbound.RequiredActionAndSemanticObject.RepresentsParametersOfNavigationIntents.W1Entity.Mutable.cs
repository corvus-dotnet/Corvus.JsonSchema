            ...
            public readonly partial struct RepresentsParametersOfNavigationIntents
            {
                ...
                public readonly partial struct W1Entity
                {
...
#endif
                    {
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.Ui5ManifestBenchmark.Baseline.Schema.Outbound.RequiredActionAndSemanticObject.RepresentsParametersOfNavigationIntents.W1Entity.ValueEntity.Mutable Value
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ValueUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.Outbound.RequiredActionAndSemanticObject.RepresentsParametersOfNavigationIntents.W1Entity.ValueEntity.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        /// </summary>
                        /// <param name="value">The value of the property to add.</param>
                        public void SetValue(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Outbound.RequiredActionAndSemanticObject.RepresentsParametersOfNavigationIntents.W1Entity.ValueEntity.Source value)
                        {
                            CheckValidInstance();
                        ...
                        /// </summary>
                        /// <param name="value">The value of the property to add.</param>
                        public void SetValue<TContext>(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Outbound.RequiredActionAndSemanticObject.RepresentsParametersOfNavigationIntents.W1Entity.ValueEntity.Source<TContext> value)
                    ...
                    public ref struct Source
                    {
                        ...
                        internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.Outbound.RequiredActionAndSemanticObject.RepresentsParametersOfNavigationIntents.W1Entity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.Outbound.RequiredActionAndSemanticObject.RepresentsParametersOfNavigationIntents.W1Entity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    public ref struct Builder
                    {
                        ...
                        internal static void Create(
                            ...
                            in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Outbound.RequiredActionAndSemanticObject.RepresentsParametersOfNavigationIntents.W1Entity.ValueEntity.Source value = default)
                        {
                        ...
                        /// Creates an instance of a <see cref="W1Entity"/>.
                        /// </summary>
                        public void Create(in Corvus.Ui5ManifestBenchmark.Baseline.JsonBoolean.Source required = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Outbound.RequiredActionAndSemanticObject.RepresentsParametersOfNavigationIntents.W1Entity.ValueEntity.Source value = default)
                        {
                            Create(ref _builder, required, value);
                        }
                        ...
                        internal static void Create<TContext>(
                            ...
                            ref ComplexValueBuilder builder,
                            in Corvus.Ui5ManifestBenchmark.Baseline.JsonBoolean.Source required = default,
                            in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Outbound.RequiredActionAndSemanticObject.RepresentsParametersOfNavigationIntents.W1Entity.ValueEntity.Source<TContext> value = default)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                        {
                        ...
                        #endif
                        {
                            Create(context, ref _builder, required, value);
                        }
                        ...
                        #endif
                    {
                        ...
                        cvb.StartObject();
                        Builder ovb = new(cvb);
                        ovb.Create(context, required, value);
                        cvb = ovb._builder;
                        cvb.EndObject();
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder;
