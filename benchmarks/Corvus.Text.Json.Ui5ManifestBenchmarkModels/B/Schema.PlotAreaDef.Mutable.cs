...
public readonly partial struct Schema
{
    ...
    public readonly partial struct PlotAreaDef
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.PlotAreaDef.DataLabelEntity.Mutable DataLabel
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DataLabelUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.PlotAreaDef.DataLabelEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.PlotAreaDef.RepresentsWhetherSmootherCurvesAreRequiredOrNot.Mutable IsSmoothed
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IsSmoothedUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.PlotAreaDef.RepresentsWhetherSmootherCurvesAreRequiredOrNot.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.JsonInteger.Mutable MarkerSize
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MarkerSizeUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.JsonInteger.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetDataLabel(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.PlotAreaDef.DataLabelEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetDataLabel<TContext>(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.PlotAreaDef.DataLabelEntity.Source<TContext> value)
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetIsSmoothed(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.PlotAreaDef.RepresentsWhetherSmootherCurvesAreRequiredOrNot.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetMarkerSize(in Corvus.Ui5ManifestBenchmark.Baseline.JsonInteger.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.PlotAreaDef.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.PlotAreaDef.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.PlotAreaDef.DataLabelEntity.Source dataLabel = default,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.PlotAreaDef.RepresentsWhetherSmootherCurvesAreRequiredOrNot.Source isSmoothed = default,
                in Corvus.Ui5ManifestBenchmark.Baseline.JsonInteger.Source markerSize = default)
            {
            ...
            internal static void Create<TContext>(
                in TContext context,
                ref ComplexValueBuilder builder,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.PlotAreaDef.DataLabelEntity.Source<TContext> dataLabel = default,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.PlotAreaDef.RepresentsWhetherSmootherCurvesAreRequiredOrNot.Source isSmoothed = default,
                in Corvus.Ui5ManifestBenchmark.Baseline.JsonInteger.Source markerSize = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.PlotAreaDef.DataLabelEntity.Source dataLabel = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.PlotAreaDef.RepresentsWhetherSmootherCurvesAreRequiredOrNot.Source isSmoothed = default, in Corvus.Ui5ManifestBenchmark.Baseline.JsonInteger.Source markerSize = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
