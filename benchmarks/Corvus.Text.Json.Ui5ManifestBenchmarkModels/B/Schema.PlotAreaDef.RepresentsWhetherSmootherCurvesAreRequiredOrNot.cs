...
public readonly partial struct Schema
{
    ...
    public readonly partial struct PlotAreaDef
    {
        ...
        public readonly partial struct RepresentsWhetherSmootherCurvesAreRequiredOrNot
#if NET8_0_OR_GREATER
            : IJsonElement<RepresentsWhetherSmootherCurvesAreRequiredOrNot>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RepresentsWhetherSmootherCurvesAreRequiredOrNot"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RepresentsWhetherSmootherCurvesAreRequiredOrNot(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RepresentsWhetherSmootherCurvesAreRequiredOrNot DefaultInstance { get; } = ParsedJsonDocument<RepresentsWhetherSmootherCurvesAreRequiredOrNot>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(RepresentsWhetherSmootherCurvesAreRequiredOrNot value)
            {
            ...
            /// </returns>
            public static bool operator ==(in RepresentsWhetherSmootherCurvesAreRequiredOrNot left, in RepresentsWhetherSmootherCurvesAreRequiredOrNot right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RepresentsWhetherSmootherCurvesAreRequiredOrNot left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(RepresentsWhetherSmootherCurvesAreRequiredOrNot instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RepresentsWhetherSmootherCurvesAreRequiredOrNot(JsonElement instance)
            {
                return RepresentsWhetherSmootherCurvesAreRequiredOrNot.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsWhetherSmootherCurvesAreRequiredOrNot From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsWhetherSmootherCurvesAreRequiredOrNot ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsWhetherSmootherCurvesAreRequiredOrNot>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsWhetherSmootherCurvesAreRequiredOrNot ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsWhetherSmootherCurvesAreRequiredOrNot>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsWhetherSmootherCurvesAreRequiredOrNot ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsWhetherSmootherCurvesAreRequiredOrNot>(json, options);
            }
            ...
            /// </exception>
            public static RepresentsWhetherSmootherCurvesAreRequiredOrNot ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RepresentsWhetherSmootherCurvesAreRequiredOrNot>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsWhetherSmootherCurvesAreRequiredOrNot? result)
            {
                return JsonElementHelpers.TryParseValue<RepresentsWhetherSmootherCurvesAreRequiredOrNot>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RepresentsWhetherSmootherCurvesAreRequiredOrNot(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static RepresentsWhetherSmootherCurvesAreRequiredOrNot IJsonElement<RepresentsWhetherSmootherCurvesAreRequiredOrNot>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RepresentsWhetherSmootherCurvesAreRequiredOrNot: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RepresentsWhetherSmootherCurvesAreRequiredOrNot"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RepresentsWhetherSmootherCurvesAreRequiredOrNot"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public RepresentsWhetherSmootherCurvesAreRequiredOrNot Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RepresentsWhetherSmootherCurvesAreRequiredOrNot>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RepresentsWhetherSmootherCurvesAreRequiredOrNot"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public RepresentsWhetherSmootherCurvesAreRequiredOrNot Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RepresentsWhetherSmootherCurvesAreRequiredOrNot>(_idx);
                }
