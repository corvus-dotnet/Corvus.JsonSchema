...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ProgressIndicator
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.ProgressIndicator.RepresentsProgressIndicatorPercentValue.Mutable Percent
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PercentUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.ProgressIndicator.RepresentsProgressIndicatorPercentValue.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.ProgressIndicator.RepresentsStateColor.Mutable State
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StateUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.ProgressIndicator.RepresentsStateColor.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetPercent(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ProgressIndicator.RepresentsProgressIndicatorPercentValue.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetState(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ProgressIndicator.RepresentsStateColor.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.ProgressIndicator.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.ProgressIndicator.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ProgressIndicator.RepresentsProgressIndicatorPercentValue.Source percent = default,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ProgressIndicator.RepresentsStateColor.Source state = default,
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ProgressIndicator.RepresentsProgressIndicatorPercentValue.Source percent = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.ProgressIndicator.RepresentsStateColor.Source state = default, in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source text = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
