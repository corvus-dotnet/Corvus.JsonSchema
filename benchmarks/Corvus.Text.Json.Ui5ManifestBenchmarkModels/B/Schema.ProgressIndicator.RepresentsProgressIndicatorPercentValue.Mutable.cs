...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ProgressIndicator
    {
        ...
        public readonly partial struct RepresentsProgressIndicatorPercentValue
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RepresentsProgressIndicatorPercentValue instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsProgressIndicatorPercentValue"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsProgressIndicatorPercentValue(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new RepresentsProgressIndicatorPercentValue(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsProgressIndicatorPercentValue.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="RepresentsProgressIndicatorPercentValue"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="RepresentsProgressIndicatorPercentValue"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsProgressIndicatorPercentValue Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<RepresentsProgressIndicatorPercentValue>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="RepresentsProgressIndicatorPercentValue"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsProgressIndicatorPercentValue Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsProgressIndicatorPercentValue>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ProgressIndicator.RepresentsProgressIndicatorPercentValue.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.ProgressIndicator.RepresentsProgressIndicatorPercentValue.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsProgressIndicatorPercentValue instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RepresentsProgressIndicatorPercentValue, Mutable>(this);
            }
        }
    }
}
