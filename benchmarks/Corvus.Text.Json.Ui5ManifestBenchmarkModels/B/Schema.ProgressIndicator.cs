...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.Schema.ProgressIndicator.RepresentsProgressIndicatorPercentValue Percent
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PercentUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.ProgressIndicator.RepresentsProgressIndicatorPercentValue value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.Schema.ProgressIndicator.RepresentsStateColor State
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StateUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.ProgressIndicator.RepresentsStateColor value))
                {
                    return value;
                }
