...
public readonly partial struct Schema
{
    ...
    public readonly partial struct RefreshStrategiesPropDef
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(RefreshStrategiesPropDef instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="RefreshStrategiesPropDef"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RefreshStrategiesPropDef(Mutable instance)
            {
            ...
            /// <summary>
            /// Gets the (optional) <c>entitySets</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.RefreshStrategiesPropDef.EntitySetsEntity.Mutable EntitySets
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EntitySetsUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.RefreshStrategiesPropDef.EntitySetsEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RefreshStrategiesPropDef(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetEntitySets(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RefreshStrategiesPropDef.EntitySetsEntity.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.EntitySetsUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EntitySetsUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetEntitySets<TContext>(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RefreshStrategiesPropDef.EntitySetsEntity.Source<TContext> value)
            ...
            /// <summary>
            /// Remove the <c>entitySets</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveEntitySets()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.EntitySetsUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RefreshStrategiesPropDef.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RefreshStrategiesPropDef"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RefreshStrategiesPropDef"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly RefreshStrategiesPropDef Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RefreshStrategiesPropDef>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RefreshStrategiesPropDef"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly RefreshStrategiesPropDef Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<RefreshStrategiesPropDef>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.RefreshStrategiesPropDef.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(RefreshStrategiesPropDef instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.RefreshStrategiesPropDef.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RefreshStrategiesPropDef.EntitySetsEntity.Source entitySets = default)
            {
            ...
            /// Creates an instance of a <see cref="RefreshStrategiesPropDef"/>.
            /// </summary>
            public void Create(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RefreshStrategiesPropDef.EntitySetsEntity.Source entitySets = default)
            {
            ...
            internal static void Create<TContext>(
                ...
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RefreshStrategiesPropDef.EntitySetsEntity.Source<TContext> entitySets = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            /// Creates an instance of a <see cref="RefreshStrategiesPropDef"/>.
            /// </summary>
            public void Create<TContext>(in TContext context, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RefreshStrategiesPropDef.EntitySetsEntity.Source<TContext> entitySets = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
                Create(context, ref _builder, entitySets);
            }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RefreshStrategiesPropDef.EntitySetsEntity.Source entitySets = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(entitySets);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RefreshStrategiesPropDef.EntitySetsEntity.Source<TContext> entitySets = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
        ...
        {
            return workspace.CreateBuilder<RefreshStrategiesPropDef, Mutable>(this);
        }
    }
}
