...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.Schema.RefreshStrategiesPropDef.EntitySetsEntity EntitySets
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EntitySetsUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.RefreshStrategiesPropDef.EntitySetsEntity value))
                {
                    return value;
                }
