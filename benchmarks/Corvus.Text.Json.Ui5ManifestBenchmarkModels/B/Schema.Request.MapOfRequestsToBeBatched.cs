...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Request
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="MapOfRequestsToBeBatched"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal MapOfRequestsToBeBatched(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static MapOfRequestsToBeBatched DefaultInstance { get; }
            ...
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.BatchRequest this[ReadOnlySpan<byte> propertyName]
            {
                get
                {
                    CheckValidInstance();
                    if (!_parent.TryGetNamedPropertyValue(_idx, propertyName, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.BatchRequest value))
                    {
                        return default;
                    }
            ...
            /// <returns>The value of the property with the given name.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.BatchRequest this[ReadOnlySpan<char> propertyName]
            {
                get
                {
                    CheckValidInstance();
            ...
            /// <returns>The value of the property with the given name.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.BatchRequest this[string propertyName]
            {
                get
                {
                    CheckValidInstance();
            ...
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public bool TryGetProperty(ReadOnlySpan<byte> propertyName, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.BatchRequest value)
            {
                CheckValidInstance();
            ...
            /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public bool TryGetProperty(ReadOnlySpan<char> propertyName, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.BatchRequest value)
            {
                CheckValidInstance();
                return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
            }
            ...
            /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public bool TryGetProperty(string propertyName, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.BatchRequest value)
            {
                CheckValidInstance();
                return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public ObjectEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.Schema.BatchRequest> EnumerateObject()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateObjectEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.Schema.BatchRequest>(_parent, _idx);
            }
            ...
            /// </returns>
            public static bool operator ==(in MapOfRequestsToBeBatched left, in MapOfRequestsToBeBatched right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in MapOfRequestsToBeBatched left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(MapOfRequestsToBeBatched instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MapOfRequestsToBeBatched(JsonElement instance)
            {
                return MapOfRequestsToBeBatched.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MapOfRequestsToBeBatched From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MapOfRequestsToBeBatched ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MapOfRequestsToBeBatched>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MapOfRequestsToBeBatched ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MapOfRequestsToBeBatched>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MapOfRequestsToBeBatched ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MapOfRequestsToBeBatched>(json, options);
            }
            ...
            /// </exception>
            public static MapOfRequestsToBeBatched ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<MapOfRequestsToBeBatched>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out MapOfRequestsToBeBatched? result)
            {
                return JsonElementHelpers.TryParseValue<MapOfRequestsToBeBatched>(ref reader, out result);
            }
...
#if NET
            static MapOfRequestsToBeBatched IJsonElement<MapOfRequestsToBeBatched>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MapOfRequestsToBeBatched: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public MapOfRequestsToBeBatched Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public MapOfRequestsToBeBatched Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<MapOfRequestsToBeBatched>(_idx);
                }
