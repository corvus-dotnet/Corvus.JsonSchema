    ...
    public readonly partial struct Request
    {
        ...
        public readonly partial struct RetryAfterEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RetryAfterEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RetryAfterEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RetryAfterEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RetryAfterEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RetryAfterEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RetryAfterEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RetryAfterEntity>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.Request.RetryAfterEntity.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.Request.RetryAfterEntity.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RetryAfterEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RetryAfterEntity, Mutable>(this);
            }
        }
    }
}
