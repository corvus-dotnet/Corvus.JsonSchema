        ...
        public readonly partial struct TheModeOfTheRequest
        {
            ...
            public readonly partial struct OneOf0Entity
            {
...
#endif
                {
                    ...
                    /// <param name="matchNoCors">Match 1st item.</param>
                    /// <param name="matchSameOrigin">Match 2nd item.</param>
                    /// <param name="matchCors">Match 3rd item.</param>
                    /// <param name="defaultMatch">Match any other value.</param>
                    /// <returns>An instance of the value returned by the match function.</returns>
                    public TResult Match<TContext, TResult>(
                        in TContext context,
                        Func<TContext, TResult> matchNoCors,
                        Func<TContext, TResult> matchSameOrigin,
                        Func<TContext, TResult> matchCors,
...
#endif
                    {
                        ...
                        {
                            return matchNoCors(context);
                        }

                        if (this.ValueEquals(Constants.Enum2))
                        {
                            return matchSameOrigin(context);
                        }

                        if (this.ValueEquals(Constants.Enum3))
                        {
                            return matchCors(context);
                        }
                    ...
                    public TResult Match<TResult>(
                        Func<TResult> matchNoCors,
                        Func<TResult> matchSameOrigin,
                        Func<TResult> matchCors,
