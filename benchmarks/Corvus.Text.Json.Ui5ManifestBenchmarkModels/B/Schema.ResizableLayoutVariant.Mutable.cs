...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ResizableLayoutVariant
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ResizableLayoutVariant instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ResizableLayoutVariant"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ResizableLayoutVariant(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ResizableLayoutVariant.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ResizableLayoutVariant Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ResizableLayoutVariant Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ResizableLayoutVariant>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.ResizableLayoutVariant.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(ResizableLayoutVariant instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.ResizableLayoutVariant.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<ResizableLayoutVariant, Mutable>(this);
        }
    }
}
