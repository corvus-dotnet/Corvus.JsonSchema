        ...
        public readonly partial struct JsRequiredUriEntiArray
        {
                ...
                : IJsonElement<RequiredUriEntity>
            {
                public static partial class JsonSchema
                {
                    ...
                    private const uint RequiredBitForUri = 0b00000000000000000000000000000001;
                    ...
                    {
                        if (span.SequenceEqual(JsonPropertyNames.UriValueUtf8))
                        {
                            matcher = MatchUriValue;
                            return true;
                        }
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("ui5-manifest-schema.json#/definitions/resource/properties/js/items"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "ui5-manifest-schema.json#/definitions/resource/properties/js/items";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "ui5-manifest-schema.json#/definitions/resource/properties/js/items"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyUriPresent, "uri"u8, "required"u8);
                            }
                            ...
                            else
                            {
                                ...
                                {
                                    context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyUriNotPresent, "uri"u8, "required"u8);
                                }
                                else
                                {
                                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyUriPresent, "uri"u8, "required"u8);
