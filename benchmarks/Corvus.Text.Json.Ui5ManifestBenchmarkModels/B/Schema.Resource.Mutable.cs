...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Resource
    {
...
#endif
        {
            ...
            /// </summary>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.Resource.RequiredUriEntityArray.Mutable Css
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CssUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.Resource.RequiredUriEntityArray.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.Resource.JsRequiredUriEntiArray.Mutable Js
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.JsUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.Resource.JsRequiredUriEntiArray.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetCss(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Resource.RequiredUriEntityArray.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetCss<TContext>(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Resource.RequiredUriEntityArray.Source<TContext> value)
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetJs(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Resource.JsRequiredUriEntiArray.Source value)
            {
                CheckValidInstance();
                ...
                {
                    // We are going to insert the new value
                    value.AddAsProperty(JsonPropertyNamesEscaped.Js, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetJs<TContext>(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Resource.JsRequiredUriEntiArray.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.Resource.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.Resource.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Resource.RequiredUriEntityArray.Source css = default,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Resource.JsRequiredUriEntiArray.Source js = default)
            {
                css.AddAsProperty(JsonPropertyNamesEscaped.Css, ref builder, escapeName: false);
                js.AddAsProperty(JsonPropertyNamesEscaped.Js, ref builder, escapeName: false);
            }

            /// <summary>
            /// Creates an instance of a <see cref="Resource"/>.
            /// </summary>
            public void Create(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Resource.RequiredUriEntityArray.Source css = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Resource.JsRequiredUriEntiArray.Source js = default)
            {
            ...
            internal static void Create<TContext>(
                in TContext context,
                ref ComplexValueBuilder builder,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Resource.RequiredUriEntityArray.Source<TContext> css = default,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Resource.JsRequiredUriEntiArray.Source<TContext> js = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Resource.RequiredUriEntityArray.Source css = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Resource.JsRequiredUriEntiArray.Source js = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Resource.RequiredUriEntityArray.Source<TContext> css = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Resource.JsRequiredUriEntiArray.Source<TContext> js = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
