...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Resource
    {
        ...
        public readonly partial struct RequiredUriEntityArray
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RequiredUriEntityArray instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RequiredUriEntityArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RequiredUriEntityArray(Mutable instance)
                {
                ...
                public Corvus.Ui5ManifestBenchmark.Baseline.Schema.Resource.RequiredUriEntityArray.RequiredUriEntity.Mutable this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.Ui5ManifestBenchmark.Baseline.Schema.Resource.RequiredUriEntityArray.RequiredUriEntity.Mutable>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.Schema.Resource.RequiredUriEntityArray.RequiredUriEntity.Mutable> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.Schema.Resource.RequiredUriEntityArray.RequiredUriEntity.Mutable>(_parent, _idx);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new RequiredUriEntityArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RequiredUriEntityArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetItem(int itemIndex, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Resource.RequiredUriEntityArray.RequiredUriEntity.Source value)
                {
                    CheckValidInstance();
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void InsertItem(int itemIndex, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Resource.RequiredUriEntityArray.RequiredUriEntity.Source value)
                {
                    CheckValidInstance();
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void AddItem(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Resource.RequiredUriEntityArray.RequiredUriEntity.Source value)
                {
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Remove(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Resource.RequiredUriEntityArray.RequiredUriEntity item)
                {
                    CheckValidInstance();
                    if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.Ui5ManifestBenchmark.Baseline.Schema.Resource.RequiredUriEntityArray.RequiredUriEntity>(this, in item))
                    {
                        return false;
                    }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void RemoveWhere(JsonPredicate<Corvus.Ui5ManifestBenchmark.Baseline.Schema.Resource.RequiredUriEntityArray.RequiredUriEntity> predicate)
                {
                    CheckValidInstance();
                    JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.Ui5ManifestBenchmark.Baseline.Schema.Resource.RequiredUriEntityArray.RequiredUriEntity>(this, predicate);
                    _documentVersion = _parent.Version;
                }
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Replace(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Resource.RequiredUriEntityArray.RequiredUriEntity oldItem, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Resource.RequiredUriEntityArray.RequiredUriEntity.Source newItem)
                {
                    CheckValidInstance();
                    ...
                    var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.Schema.Resource.RequiredUriEntityArray.RequiredUriEntity>(_parent, _idx);

                    while (enumerator.MoveNext())
                    {
                        Corvus.Ui5ManifestBenchmark.Baseline.Schema.Resource.RequiredUriEntityArray.RequiredUriEntity current = enumerator.Current;
                ...
                /// <summary>
                /// Gets a <see cref="RequiredUriEntityArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="RequiredUriEntityArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredUriEntityArray Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<RequiredUriEntityArray>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="RequiredUriEntityArray"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredUriEntityArray Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RequiredUriEntityArray>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.Resource.RequiredUriEntityArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(RequiredUriEntityArray instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.Resource.RequiredUriEntityArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<RequiredUriEntityArray, Mutable>(this);
            }
        }
    }
}
