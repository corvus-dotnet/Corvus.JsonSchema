...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Resource
    {
...
#endif
        {
            ...
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.Resource.RequiredUriEntityArray.RequiredUriEntity this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Ui5ManifestBenchmark.Baseline.Schema.Resource.RequiredUriEntityArray.RequiredUriEntity>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.Schema.Resource.RequiredUriEntityArray.RequiredUriEntity> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.Schema.Resource.RequiredUriEntityArray.RequiredUriEntity>(_parent, _idx);
            }
