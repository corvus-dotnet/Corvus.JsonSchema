...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ResourceRoot
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ResourceRoot instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ResourceRoot"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ResourceRoot(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ResourceRoot.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ResourceRoot Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ResourceRoot Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ResourceRoot>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ResourceRoot instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<ResourceRoot, Mutable>(this);
        }
    }
}
