...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceRoot"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ResourceRoot(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ResourceRoot DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(ResourceRoot value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in ResourceRoot left, in ResourceRoot right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ResourceRoot left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(ResourceRoot instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ResourceRoot(JsonElement instance)
        {
            return ResourceRoot.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ResourceRoot From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ResourceRoot ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ResourceRoot>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ResourceRoot ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ResourceRoot>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ResourceRoot ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ResourceRoot>(json, options);
        }
        ...
        /// </exception>
        public static ResourceRoot ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ResourceRoot>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ResourceRoot? result)
        {
            return JsonElementHelpers.TryParseValue<ResourceRoot>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ResourceRoot(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static ResourceRoot IJsonElement<ResourceRoot>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ResourceRoot: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ResourceRoot"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ResourceRoot"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public ResourceRoot Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ResourceRoot>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ResourceRoot"/> that lives for the lifetime of its
