...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDef.RequiredViewName"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDef.RequiredViewName(RootViewDef value)
        {
            return Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDef.RequiredViewName.From(value);
        }

        /// <summary>
        /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDef.RequiredViewName"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator RootViewDef(Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDef.RequiredViewName value)
        {
            return From(value);
        }
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDef.RequiredViewName" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsRequiredViewName(out Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDef.RequiredViewName result)
        {
            if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDef.RequiredViewName.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDef.RequiredViewName.From(this);
                return true;
            }
        ...
        /// <param name="matchRequiredViewName">Match a <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDef.RequiredViewName"/>.</param>
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDef.RequiredViewName, TContext, TResult> matchRequiredViewName,
            Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDef, TContext, TResult> defaultMatch)
...
#endif
        {
            ...
            if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDef.RequiredViewName.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredViewName(Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDef.RequiredViewName.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDef.RequiredViewName, TResult> matchRequiredViewName,
            Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDef, TResult> defaultMatch)
        {
            if (Corvus.Ui5ManifestBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
            {
            ...
            if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDef.RequiredViewName.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredViewName(Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDef.RequiredViewName.From(this));
            }
