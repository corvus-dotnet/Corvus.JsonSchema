...
public readonly partial struct Schema
{
    ...
    public readonly partial struct RootViewDefFlexEnabled
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ConfigureTheTargetsForAsynchronousLoading"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ConfigureTheTargetsForAsynchronousLoading(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ConfigureTheTargetsForAsynchronousLoading DefaultInstance { get; } = ParsedJsonDocument<ConfigureTheTargetsForAsynchronousLoading>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(ConfigureTheTargetsForAsynchronousLoading value)
            {
            ...
            /// </returns>
            public static bool operator ==(in ConfigureTheTargetsForAsynchronousLoading left, in ConfigureTheTargetsForAsynchronousLoading right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ConfigureTheTargetsForAsynchronousLoading left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ConfigureTheTargetsForAsynchronousLoading instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ConfigureTheTargetsForAsynchronousLoading(JsonElement instance)
            {
                return ConfigureTheTargetsForAsynchronousLoading.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ConfigureTheTargetsForAsynchronousLoading From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ConfigureTheTargetsForAsynchronousLoading ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ConfigureTheTargetsForAsynchronousLoading>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ConfigureTheTargetsForAsynchronousLoading ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ConfigureTheTargetsForAsynchronousLoading>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ConfigureTheTargetsForAsynchronousLoading ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ConfigureTheTargetsForAsynchronousLoading>(json, options);
            }
            ...
            /// </exception>
            public static ConfigureTheTargetsForAsynchronousLoading ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ConfigureTheTargetsForAsynchronousLoading>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ConfigureTheTargetsForAsynchronousLoading? result)
            {
                return JsonElementHelpers.TryParseValue<ConfigureTheTargetsForAsynchronousLoading>(ref reader, out result);
            }
...
#if NET
            static ConfigureTheTargetsForAsynchronousLoading IJsonElement<ConfigureTheTargetsForAsynchronousLoading>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ConfigureTheTargetsForAsynchronousLoading: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public ConfigureTheTargetsForAsynchronousLoading Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public ConfigureTheTargetsForAsynchronousLoading Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ConfigureTheTargetsForAsynchronousLoading>(_idx);
                }
