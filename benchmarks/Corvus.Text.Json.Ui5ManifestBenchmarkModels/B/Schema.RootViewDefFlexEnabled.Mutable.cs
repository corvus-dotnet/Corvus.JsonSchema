...
public readonly partial struct Schema
{
    ...
    public readonly partial struct RootViewDefFlexEnabled
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(RootViewDefFlexEnabled instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="RootViewDefFlexEnabled"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RootViewDefFlexEnabled(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDefFlexEnabled.ConfigureTheTargetsForAsynchronousLoading.Mutable Async
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AsyncUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDefFlexEnabled.ConfigureTheTargetsForAsynchronousLoading.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDefFlexEnabled.TypeEntity.Mutable Type
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDefFlexEnabled.TypeEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RootViewDefFlexEnabled(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetAsync(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDefFlexEnabled.ConfigureTheTargetsForAsynchronousLoading.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetType(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDefFlexEnabled.TypeEntity.Source value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RootViewDefFlexEnabled.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RootViewDefFlexEnabled"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RootViewDefFlexEnabled"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly RootViewDefFlexEnabled Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RootViewDefFlexEnabled>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RootViewDefFlexEnabled"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly RootViewDefFlexEnabled Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<RootViewDefFlexEnabled>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDefFlexEnabled.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(RootViewDefFlexEnabled instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDefFlexEnabled.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="RootViewDefFlexEnabled"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source id,
                in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source viewName,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDefFlexEnabled.ConfigureTheTargetsForAsynchronousLoading.Source async = default,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDefFlexEnabled.TypeEntity.Source type = default)
            {
            ...
            public void Create(
                ...
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDefFlexEnabled.TypeEntity.Source type = default)
            {
                Create(ref _builder, id, viewName, async, type);
            }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source id, in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source viewName, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDefFlexEnabled.ConfigureTheTargetsForAsynchronousLoading.Source async = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RootViewDefFlexEnabled.TypeEntity.Source type = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(id, viewName, async, type);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<RootViewDefFlexEnabled, Mutable>(this);
        }
    }
}
