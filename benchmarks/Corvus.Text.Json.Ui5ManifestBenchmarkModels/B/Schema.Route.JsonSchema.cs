        ...
        public static partial class JsonSchema
        {
                ...
                ref JsonSchemaContext context)
            {
                ...
                JsonSchemaContext hoistedAllOf0_context =
                    Corvus.Ui5ManifestBenchmark.Baseline.Schema.RouteWithoutName.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: AllOf0SchemaEvaluationPath);

                JsonSchemaContext hoistedAllOf1_context =
                    Corvus.Ui5ManifestBenchmark.Baseline.Schema.Route.RequiredName.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: AllOf1SchemaEvaluationPath);
                        ...
                        if (TryGetHoistedPropertyIndex(objectValidation_unescapedPropertyName.Span, out MatchIndex? matchIndex))
                        {
                            switch (matchIndex!.Value)
                            {
                                ...
                                case 2:
                                    ...
                                    Corvus.Ui5ManifestBenchmark.Baseline.Schema.RouteTarget.JsonSchema.Evaluate(parentDocument, objectValidation_currentIndex, ref hoistedChildContext2);
