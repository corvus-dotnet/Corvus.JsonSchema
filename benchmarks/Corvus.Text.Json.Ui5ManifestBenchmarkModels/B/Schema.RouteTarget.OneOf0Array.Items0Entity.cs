    ...
    public readonly partial struct RouteTarget
    {
        ...
        public readonly partial struct OneOf0Array
        {
...
#endif
            {
                ...
                internal Items0Entity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static Items0Entity DefaultInstance { get; }
                ...
                public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.Schema.RouteTargetObject(Items0Entity value)
                {
                    return Corvus.Ui5ManifestBenchmark.Baseline.Schema.RouteTargetObject.From(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Items0Entity(Corvus.Ui5ManifestBenchmark.Baseline.Schema.RouteTargetObject value)
                {
                    return From(value);
                }

                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(Items0Entity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in Items0Entity left, in Items0Entity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in Items0Entity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(Items0Entity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Items0Entity(JsonElement instance)
                {
                    return Items0Entity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Items0Entity From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Items0Entity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<Items0Entity>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Items0Entity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<Items0Entity>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static Items0Entity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<Items0Entity>(json, options);
                }
                ...
                /// </exception>
                public static Items0Entity ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<Items0Entity>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out Items0Entity? result)
                {
                    return JsonElementHelpers.TryParseValue<Items0Entity>(ref reader, out result);
                }
...
#if NET
                static Items0Entity IJsonElement<Items0Entity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"Items0Entity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                public bool TryGetAsRouteTargetObject(out Corvus.Ui5ManifestBenchmark.Baseline.Schema.RouteTargetObject result)
                {
                    ...
                    {
                        result = Corvus.Ui5ManifestBenchmark.Baseline.Schema.RouteTargetObject.From(this);
                        return true;
                    }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.RouteTarget.OneOf0Array.Items0Entity, TContext, TResult> defaultMatch)
...
#endif
                {
                    ...
                    if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.RouteTargetObject.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchRouteTargetObject(Corvus.Ui5ManifestBenchmark.Baseline.Schema.RouteTargetObject.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.RouteTarget.OneOf0Array.Items0Entity, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                    {
                    ...
                    if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.RouteTargetObject.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchRouteTargetObject(Corvus.Ui5ManifestBenchmark.Baseline.Schema.RouteTargetObject.From(this));
                    }
