...
public readonly partial struct Schema
{
    ...
    public readonly partial struct RouteTarget
    {
        ...
        public readonly partial struct OneOf0Array
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(OneOf0Array instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="OneOf0Array"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator OneOf0Array(Mutable instance)
                {
                ...
                /// <exception cref="IndexOutOfRangeException">The index was outside the bounds of the array.</exception>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public Corvus.Ui5ManifestBenchmark.Baseline.Schema.RouteTarget.OneOf0Array.Items0Entity.Mutable Item1
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.Ui5ManifestBenchmark.Baseline.Schema.RouteTarget.OneOf0Array.Items0Entity.Mutable>(_idx, 0);
                    }
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new OneOf0Array(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"OneOf0Array.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// <summary>
                /// Gets a <see cref="OneOf0Array"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="OneOf0Array"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly OneOf0Array Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<OneOf0Array>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="OneOf0Array"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly OneOf0Array Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<OneOf0Array>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.RouteTarget.OneOf0Array.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(OneOf0Array instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.RouteTarget.OneOf0Array.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                public void CreateTuple(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RouteTarget.OneOf0Array.Items0Entity.Source item1)
                {
            ...
            {
                return workspace.CreateBuilder<OneOf0Array, Mutable>(this);
            }
        }
    }
}
