...
public readonly partial struct Schema
{
    ...
    public readonly partial struct RouteTargetObject
    {
...
#endif
        {
            ...
            /// </summary>
            public static PropagateTitleEntity DefaultInstance { get; } = ParsedJsonDocument<PropagateTitleEntity>.StringConstant([.."\"#/definitions/routing/config/propagateTitle\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(PropagateTitleEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator bool(PropagateTitleEntity value)
            {
