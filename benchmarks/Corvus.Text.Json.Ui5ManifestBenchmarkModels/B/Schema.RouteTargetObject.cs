...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RouteTargetObject"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal RouteTargetObject(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static RouteTargetObject DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.JsonString Prefix
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PrefixUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.JsonString value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.Schema.RouteTargetObject.PropagateTitleEntity PropagateTitle
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PropagateTitleUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.RouteTargetObject.PropagateTitleEntity value))
                {
                    return value;
                }

                return Corvus.Ui5ManifestBenchmark.Baseline.Schema.RouteTargetObject.PropagateTitleEntity.DefaultInstance;
            }
        }
        ...
        /// </returns>
        public static bool operator ==(in RouteTargetObject left, in RouteTargetObject right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in RouteTargetObject left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(RouteTargetObject instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator RouteTargetObject(JsonElement instance)
        {
            return RouteTargetObject.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RouteTargetObject From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RouteTargetObject ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RouteTargetObject>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RouteTargetObject ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RouteTargetObject>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RouteTargetObject ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RouteTargetObject>(json, options);
        }
        ...
        /// </exception>
        public static RouteTargetObject ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<RouteTargetObject>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out RouteTargetObject? result)
        {
            return JsonElementHelpers.TryParseValue<RouteTargetObject>(ref reader, out result);
        }
...
#if NET
        static RouteTargetObject IJsonElement<RouteTargetObject>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"RouteTargetObject: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public RouteTargetObject Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public RouteTargetObject Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<RouteTargetObject>(_idx);
            }
