...
public readonly partial struct Schema
{
    ...
    public readonly partial struct RouteWithoutName
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(RouteWithoutName instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="RouteWithoutName"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RouteWithoutName(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.JsonBoolean.Mutable Greedy
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.GreedyUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.JsonBoolean.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.RouteTarget.Mutable Target
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TargetUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.RouteTarget.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Mutable TitleTarget
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TitleTargetUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetGreedy(in Corvus.Ui5ManifestBenchmark.Baseline.JsonBoolean.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetTarget(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RouteTarget.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetTarget<TContext>(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RouteTarget.Source<TContext> value)
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetTitleTarget(in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RouteWithoutName.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RouteWithoutName"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RouteWithoutName"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly RouteWithoutName Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RouteWithoutName>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RouteWithoutName"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly RouteWithoutName Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<RouteWithoutName>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.RouteWithoutName.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(RouteWithoutName instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.RouteWithoutName.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="RouteWithoutName"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.Ui5ManifestBenchmark.Baseline.JsonBoolean.Source greedy = default,
                in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source pattern = default,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RouteTarget.Source target = default,
                in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source titleTarget = default)
            {
            ...
            public void Create(
                ...
                in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source titleTarget = default)
            {
                Create(ref _builder, greedy, pattern, target, titleTarget);
            }
            ...
            internal static void Create<TContext>(
                ...
                in Corvus.Ui5ManifestBenchmark.Baseline.JsonBoolean.Source greedy = default,
                in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source pattern = default,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RouteTarget.Source<TContext> target = default,
                in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source titleTarget = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            ...
            #endif
            {
                Create(context, ref _builder, greedy, pattern, target, titleTarget);
            }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.JsonBoolean.Source greedy = default, in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source pattern = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RouteTarget.Source target = default, in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source titleTarget = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(greedy, pattern, target, titleTarget);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
            ...
            #endif
        {
            ...
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(context, greedy, pattern, target, titleTarget);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<RouteWithoutName, Mutable>(this);
        }
    }
}
