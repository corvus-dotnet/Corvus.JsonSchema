            ...
            public readonly partial struct AllOf0Entity
            {
                ...
                public readonly partial struct RequiredTarget
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(RequiredTarget instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="RequiredTarget"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator RequiredTarget(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"RequiredTarget.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RequiredTarget Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RequiredTarget Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<RequiredTarget>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.Routing.ConfigEntity.AllOf0Entity.RequiredTarget.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                        public static implicit operator Source(RequiredTarget instance) => new(JsonElement.From(instance));
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.Routing.ConfigEntity.AllOf0Entity.RequiredTarget.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    public ref struct Builder
                    {
                        ...
                        /// <summary>
                        /// Creates an instance of a <see cref="RequiredTarget"/>.
                        /// </summary>
                        internal static void Create(ref ComplexValueBuilder builder, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RouteTarget.Source target)
                        {
                        ...
                        /// Creates an instance of a <see cref="RequiredTarget"/>.
                        /// </summary>
                        public void Create(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RouteTarget.Source target)
                        {
                            Create(ref _builder, target);
                        }
                        ...
                        internal static void Create<TContext>(
                            ...
                            in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RouteTarget.Source<TContext> target)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                        {
                        ...
                        /// Creates an instance of a <see cref="RequiredTarget"/>.
                        /// </summary>
                        public void Create<TContext>(in TContext context, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RouteTarget.Source<TContext> target)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                        {
                            Create(context, ref _builder, target);
                        }
                    ...
                    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RouteTarget.Source target, int initialCapacity = 30)
                    {
                        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                        cvb.StartObject();
                    ...
                    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RouteTarget.Source<TContext> target, int initialCapacity = 30)
                        #if NET9_0_OR_GREATER
                        where TContext : allows ref struct
                        #endif
                    {
                    ...
                    {
                        return workspace.CreateBuilder<RequiredTarget, Mutable>(this);
                    }
                }
            }
        }
