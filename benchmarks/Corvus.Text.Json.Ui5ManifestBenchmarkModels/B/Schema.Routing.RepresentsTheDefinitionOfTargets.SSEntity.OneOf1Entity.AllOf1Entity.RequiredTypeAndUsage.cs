                ...
                public readonly partial struct OneOf1Entity
                {
                    ...
                    public readonly partial struct AllOf1Entity
                    {
...
#endif
                        {
                            ...
                            /// </para>
                            /// </remarks>
                            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.Routing.RepresentsTheDefinitionOfTargets.SSEntity.OneOf1Entity.AllOf1Entity.RequiredTypeAndUsage.RepresentsTheTypeOfTheTypeComponent Type
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.Routing.RepresentsTheDefinitionOfTargets.SSEntity.OneOf1Entity.AllOf1Entity.RequiredTypeAndUsage.RepresentsTheTypeOfTheTypeComponent value))
                                    {
                                        return value;
                                    }
                            ...
                            /// </para>
                            /// </remarks>
                            public Corvus.Ui5ManifestBenchmark.Baseline.JsonString Usage
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UsageUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.JsonString value))
                                    {
                                        return value;
                                    }
