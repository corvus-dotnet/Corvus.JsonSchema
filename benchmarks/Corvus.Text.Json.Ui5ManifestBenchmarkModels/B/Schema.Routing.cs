...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Routing"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal Routing(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static Routing DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.Schema.Routing.ConfigEntity Config
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ConfigUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.Routing.ConfigEntity value))
                {
                    return value;
                }
        ...
        /// </summary>
        public Corvus.Ui5ManifestBenchmark.Baseline.Schema.Routing.RoutesEntity Routes
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RoutesUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.Routing.RoutesEntity value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.Schema.Routing.RepresentsTheDefinitionOfTargets Targets
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TargetsUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.Routing.RepresentsTheDefinitionOfTargets value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in Routing left, in Routing right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Routing left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(Routing instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Routing(JsonElement instance)
        {
            return Routing.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Routing From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Routing ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Routing>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Routing ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Routing>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Routing ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Routing>(json, options);
        }
        ...
        /// </exception>
        public static Routing ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<Routing>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Routing? result)
        {
            return JsonElementHelpers.TryParseValue<Routing>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new Routing(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static Routing IJsonElement<Routing>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Routing: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="Routing"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="Routing"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        {
            CheckValidInstance();
            return _parent.CloneElement<Routing>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="Routing"/> that lives for the lifetime of its
