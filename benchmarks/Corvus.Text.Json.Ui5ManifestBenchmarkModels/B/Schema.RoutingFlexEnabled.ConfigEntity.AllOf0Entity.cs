    ...
    public readonly partial struct RoutingFlexEnabled
    {
        ...
        public readonly partial struct ConfigEntity
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled.ConfigEntity.AllOf0Entity.IndicatesWhetherTheViewsInRoutingAreLoadedAsyncly Async
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AsyncUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled.ConfigEntity.AllOf0Entity.IndicatesWhetherTheViewsInRoutingAreLoadedAsyncly value))
                        {
                            return value;
                        }

                        return Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled.ConfigEntity.AllOf0Entity.IndicatesWhetherTheViewsInRoutingAreLoadedAsyncly.DefaultInstance;
                    }
                }
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled.ConfigEntity.AllOf0Entity.RequiredTarget Bypassed
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BypassedUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled.ConfigEntity.AllOf0Entity.RequiredTarget value))
                        {
                            return value;
                        }
