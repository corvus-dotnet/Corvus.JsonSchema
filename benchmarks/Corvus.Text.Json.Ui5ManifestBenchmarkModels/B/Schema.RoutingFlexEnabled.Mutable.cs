...
public readonly partial struct Schema
{
    ...
    public readonly partial struct RoutingFlexEnabled
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled.ConfigEntity.Mutable Config
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ConfigUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled.ConfigEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled.RoutesEntity.Mutable Routes
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RoutesUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled.RoutesEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled.RepresentsTheDefinitionOfTargets.Mutable Targets
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TargetsUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled.RepresentsTheDefinitionOfTargets.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetConfig(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled.ConfigEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetConfig<TContext>(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled.ConfigEntity.Source<TContext> value)
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetRoutes(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled.RoutesEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetRoutes<TContext>(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled.RoutesEntity.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetTargets(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled.RepresentsTheDefinitionOfTargets.Source value)
            {
                CheckValidInstance();
                ...
                {
                    // We are going to insert the new value
                    value.AddAsProperty(JsonPropertyNamesEscaped.Targets, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetTargets<TContext>(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled.RepresentsTheDefinitionOfTargets.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled.ConfigEntity.Source config = default,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled.RoutesEntity.Source routes = default,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled.RepresentsTheDefinitionOfTargets.Source targets = default)
            {
                ...
                targets.AddAsProperty(JsonPropertyNamesEscaped.Targets, ref builder, escapeName: false);
            }
            ...
            internal static void Create<TContext>(
                in TContext context,
                ref ComplexValueBuilder builder,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled.ConfigEntity.Source<TContext> config = default,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled.RoutesEntity.Source<TContext> routes = default,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled.RepresentsTheDefinitionOfTargets.Source<TContext> targets = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled.ConfigEntity.Source config = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled.RoutesEntity.Source routes = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled.RepresentsTheDefinitionOfTargets.Source targets = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled.ConfigEntity.Source<TContext> config = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled.RoutesEntity.Source<TContext> routes = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled.RepresentsTheDefinitionOfTargets.Source<TContext> targets = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
