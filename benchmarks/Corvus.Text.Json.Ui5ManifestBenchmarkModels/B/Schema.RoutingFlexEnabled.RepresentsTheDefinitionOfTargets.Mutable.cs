    ...
    public readonly partial struct RoutingFlexEnabled
    {
        ...
        public readonly partial struct RepresentsTheDefinitionOfTargets
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RepresentsTheDefinitionOfTargets instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsTheDefinitionOfTargets"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsTheDefinitionOfTargets(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new RepresentsTheDefinitionOfTargets(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsTheDefinitionOfTargets.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="RepresentsTheDefinitionOfTargets"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="RepresentsTheDefinitionOfTargets"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheDefinitionOfTargets Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<RepresentsTheDefinitionOfTargets>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="RepresentsTheDefinitionOfTargets"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheDefinitionOfTargets Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsTheDefinitionOfTargets>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled.RepresentsTheDefinitionOfTargets.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(RepresentsTheDefinitionOfTargets instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled.RepresentsTheDefinitionOfTargets.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<RepresentsTheDefinitionOfTargets, Mutable>(this);
            }
        }
    }
}
