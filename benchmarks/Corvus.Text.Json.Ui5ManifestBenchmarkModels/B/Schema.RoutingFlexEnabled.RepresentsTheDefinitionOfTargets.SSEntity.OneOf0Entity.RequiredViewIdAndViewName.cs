        ...
        public readonly partial struct RepresentsTheDefinitionOfTargets
        {
            ...
            public readonly partial struct SSEntity
            {
                ...
                public readonly partial struct OneOf0Entity
                {
                    ...
                    public readonly partial struct RequiredViewIdAndViewName
#if NET8_0_OR_GREATER
                        : IJsonElement<RequiredViewIdAndViewName>,
                          IFormattable,
                          ISpanFormattable,
...
#endif
                    {
                        ...
                        /// <summary>
                        /// Initializes a new instance of the <see cref="RequiredViewIdAndViewName"/> struct.
                        /// </summary>
                        /// <param name="value">The value from which to construct the instance.</param>
                        internal RequiredViewIdAndViewName(IJsonDocument parent, int idx)
                        {
                            Debug.Assert(idx >= 0);
                            _parent = parent;
                            _idx = idx;
                        ...
                        /// </summary>
                        public static RequiredViewIdAndViewName DefaultInstance { get; }
                        ...
                        /// </returns>
                        public static bool operator ==(in RequiredViewIdAndViewName left, in RequiredViewIdAndViewName right)
                        {
                        ...
                        /// <c>True</c> if the values are equal.
                        /// </returns>
                        public static bool operator ==(in RequiredViewIdAndViewName left, in JsonElement right)
                        {
                            return left.Equals(right);
                        }
                        ...
                        public static implicit operator JsonElement(RequiredViewIdAndViewName instance)
                        {
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator RequiredViewIdAndViewName(JsonElement instance)
                        {
                            return RequiredViewIdAndViewName.From(instance);
                        }
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static RequiredViewIdAndViewName From<T>(in T instance)
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static RequiredViewIdAndViewName ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<RequiredViewIdAndViewName>(utf8Json, options);
                        }
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static RequiredViewIdAndViewName ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<RequiredViewIdAndViewName>(json, options);
                        }
                        ...
                        /// </exception>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static RequiredViewIdAndViewName ParseValue(string json, JsonDocumentOptions options = default)
                        {
                            return JsonElementHelpers.ParseValue<RequiredViewIdAndViewName>(json, options);
                        }
                        ...
                        /// </exception>
                        public static RequiredViewIdAndViewName ParseValue(ref Utf8JsonReader reader)
                        {
                            return JsonElementHelpers.ParseValue<RequiredViewIdAndViewName>(ref reader);
                        }
                        ...
                        ///   A value could not be read from the reader.
                        /// </exception>
                        public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredViewIdAndViewName? result)
                        {
                            return JsonElementHelpers.TryParseValue<RequiredViewIdAndViewName>(ref reader, out result);
                        }
                        ...
                        {
                            return
                                (obj is IJsonElement value && Equals(new RequiredViewIdAndViewName(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                        static RequiredViewIdAndViewName IJsonElement<RequiredViewIdAndViewName>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"RequiredViewIdAndViewName: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// <summary>
                        /// Gets a <see cref="RequiredViewIdAndViewName"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </summary>
                        /// <returns>
                        /// A <see cref="RequiredViewIdAndViewName"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </returns>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public RequiredViewIdAndViewName Clone()
                        {
                            CheckValidInstance();
                            return _parent.CloneElement<RequiredViewIdAndViewName>(_idx);
                        }
                        ...
                        /// </summary>
                        /// <returns>
                        /// An immutable <see cref="RequiredViewIdAndViewName"/> that lives for the lifetime of its
                        ...
                        /// </para>
                        /// </remarks>
                        public RequiredViewIdAndViewName Freeze()
                        {
                            CheckValidInstance();
                            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                            {
                                return mutable.FreezeElement<RequiredViewIdAndViewName>(_idx);
                            }
