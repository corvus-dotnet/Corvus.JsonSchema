                    ...
                    public readonly partial struct AllOf1Entity
                    {
                        ...
                        public readonly partial struct RequiredIdAndTypeAndUsage
                        {
...
#endif
                            {
                                ...
                                /// </para>
                                /// </remarks>
                                public Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled.RepresentsTheDefinitionOfTargets.SSEntity.OneOf1Entity.AllOf1Entity.RequiredIdAndTypeAndUsage.RepresentsTheTypeOfTheTypeComponent.Mutable Type
                                {
                                    get
                                    {
                                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled.RepresentsTheDefinitionOfTargets.SSEntity.OneOf1Entity.AllOf1Entity.RequiredIdAndTypeAndUsage.RepresentsTheTypeOfTheTypeComponent.Mutable value))
                                        {
                                            return value;
                                        }
                                ...
                                /// </para>
                                /// </remarks>
                                public Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Mutable Usage
                                {
                                    get
                                    {
                                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UsageUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Mutable value))
                                        {
                                            return value;
                                        }
                                ...
                                /// </summary>
                                /// <param name="value">The value of the property to add.</param>
                                public void SetType(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled.RepresentsTheDefinitionOfTargets.SSEntity.OneOf1Entity.AllOf1Entity.RequiredIdAndTypeAndUsage.RepresentsTheTypeOfTheTypeComponent.Source value)
                                {
                                    CheckValidInstance();
                                ...
                                /// </summary>
                                /// <param name="value">The value of the property to add.</param>
                                public void SetUsage(in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source value)
                                {
                                    CheckValidInstance();
                                    ...
                                    {
                                        // We are going to insert the new value
                                        value.AddAsProperty(JsonPropertyNamesEscaped.Usage, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                                    }
                            ...
                            public ref struct Source
                            {
                                ...
                                internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled.RepresentsTheDefinitionOfTargets.SSEntity.OneOf1Entity.AllOf1Entity.RequiredIdAndTypeAndUsage.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                                ...
                                #endif
                            {
                                ...
                                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled.RepresentsTheDefinitionOfTargets.SSEntity.OneOf1Entity.AllOf1Entity.RequiredIdAndTypeAndUsage.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                            ...
                            public ref struct Builder
                            {
                                ...
                                internal static void Create(
                                    ...
                                    in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled.RepresentsTheDefinitionOfTargets.SSEntity.OneOf1Entity.AllOf1Entity.RequiredIdAndTypeAndUsage.RepresentsTheTypeOfTheTypeComponent.Source type,
                                    in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source usage)
                                {
                                    ...
                                    usage.AddAsProperty(JsonPropertyNamesEscaped.Usage, ref builder, escapeName: false);
                                }
                            ...
                            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source id, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.RoutingFlexEnabled.RepresentsTheDefinitionOfTargets.SSEntity.OneOf1Entity.AllOf1Entity.RequiredIdAndTypeAndUsage.RepresentsTheTypeOfTheTypeComponent.Source type, in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source usage, int initialCapacity = 30)
                            {
                                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                                cvb.StartObject();
