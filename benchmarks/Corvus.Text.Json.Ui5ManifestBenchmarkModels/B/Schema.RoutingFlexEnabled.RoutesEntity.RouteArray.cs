    ...
    public readonly partial struct RoutingFlexEnabled
    {
        ...
        public readonly partial struct RoutesEntity
        {
...
#endif
            {
                ...
                public Corvus.Ui5ManifestBenchmark.Baseline.Schema.Route this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.Ui5ManifestBenchmark.Baseline.Schema.Route>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.Schema.Route> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.Schema.Route>(_parent, _idx);
                }
