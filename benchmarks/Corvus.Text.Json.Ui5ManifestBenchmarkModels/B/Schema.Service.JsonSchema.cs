...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Service
        : IJsonElement<Service>
    {
        public static partial class JsonSchema
        {
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyFactoryNamePresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("factoryName"u8, buffer, out written);
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyFactoryNameNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("factoryName"u8, buffer, out written);

            private const int RequiredOffsetForFactoryName = 0;
            private const uint RequiredBitForFactoryName = 0b00000000000000000000000000000001;

            private const uint RequiredBitMask0 =
                RequiredBitForFactoryName;
            private static readonly JsonSchemaPathProvider FactoryNameSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/factoryName"u8, buffer, out written);
            ...
            private static void MatchFactoryName(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
                JsonSchemaContext childContext =
                    Corvus.Ui5ManifestBenchmark.Baseline.Schema.Service.RepresentsTheNameOfTheServiceFactory.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.FactoryNameUtf8,
                        evaluationPath: FactoryNameSchemaEvaluationPath);

                Corvus.Ui5ManifestBenchmark.Baseline.Schema.Service.RepresentsTheNameOfTheServiceFactory.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                ...
                requiredBitBuffer[RequiredOffsetForFactoryName] |= RequiredBitForFactoryName;
            }
            ...
            private static void MatchOptional(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                ...
                JsonSchemaContext childContext1 =
                    Corvus.Ui5ManifestBenchmark.Baseline.Schema.Service.IndicatesWhetherTheServiceOptionalOrNot.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.Ui5ManifestBenchmark.Baseline.Schema.Service.IndicatesWhetherTheServiceOptionalOrNot.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
            ...
            private static PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
            {
                return new PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator>([
                    (static () => JsonPropertyNames.FactoryNameUtf8, MatchFactoryName),
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("ui5-manifest-schema.json#/definitions/service"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "ui5-manifest-schema.json#/definitions/service";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "ui5-manifest-schema.json#/definitions/service"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyFactoryNamePresent, "factoryName"u8, "required"u8);
                    }
                    ...
                    {
                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForFactoryName] & RequiredBitForFactoryName) == 0)
                        {
                            context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyFactoryNameNotPresent, "factoryName"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyFactoryNamePresent, "factoryName"u8, "required"u8);
