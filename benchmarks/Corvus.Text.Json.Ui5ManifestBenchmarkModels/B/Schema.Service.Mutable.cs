...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Service
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.Service.RepresentsTheNameOfTheServiceFactory.Mutable FactoryName
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FactoryNameUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.Service.RepresentsTheNameOfTheServiceFactory.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.Service.IndicatesWhetherTheServiceOptionalOrNot.Mutable Optional
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OptionalUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.Service.IndicatesWhetherTheServiceOptionalOrNot.Mutable value))
                    {
                        return value;
                    }
            ...
            /// <summary>
            /// Set the <c>factoryName</c> property.
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetFactoryName(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Service.RepresentsTheNameOfTheServiceFactory.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("factoryName");
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FactoryNameUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                ...
                else
                {
                    ...
                    value.AddAsProperty(JsonPropertyNamesEscaped.FactoryName, ref cvb, escapeName: false, nameRequiresUnescaping: false);
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetOptional(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Service.IndicatesWhetherTheServiceOptionalOrNot.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.Service.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.Service.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="Service"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Service.RepresentsTheNameOfTheServiceFactory.Source factoryName,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Service.IndicatesWhetherTheServiceOptionalOrNot.Source optional = default)
            {
                factoryName.AddAsProperty(JsonPropertyNamesEscaped.FactoryName, ref builder, escapeName: false);
            ...
            /// Creates an instance of a <see cref="Service"/>.
            /// </summary>
            public void Create(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Service.RepresentsTheNameOfTheServiceFactory.Source factoryName, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Service.IndicatesWhetherTheServiceOptionalOrNot.Source optional = default)
            {
                Create(ref _builder, factoryName, optional);
            }
        ...
        /// </summary>
        /// <param name="workspace">The JSON workspace.</param>
        /// <param name="factoryName">The value of the property.</param>
        /// <param name="optional">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Service.RepresentsTheNameOfTheServiceFactory.Source factoryName, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Service.IndicatesWhetherTheServiceOptionalOrNot.Source optional = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(factoryName, optional);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
