...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Service"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal Service(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static Service DefaultInstance { get; }
        ...
        /// <summary>
        /// Gets the <c>factoryName</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.Schema.Service.RepresentsTheNameOfTheServiceFactory FactoryName
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FactoryNameUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.Service.RepresentsTheNameOfTheServiceFactory value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.Schema.Service.IndicatesWhetherTheServiceOptionalOrNot Optional
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OptionalUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.Service.IndicatesWhetherTheServiceOptionalOrNot value))
                {
                    return value;
                }

                return Corvus.Ui5ManifestBenchmark.Baseline.Schema.Service.IndicatesWhetherTheServiceOptionalOrNot.DefaultInstance;
            }
        }
        ...
        /// </returns>
        public static bool operator ==(in Service left, in Service right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Service left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(Service instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Service(JsonElement instance)
        {
            return Service.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Service From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Service ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Service>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Service ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Service>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Service ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Service>(json, options);
        }
        ...
        /// </exception>
        public static Service ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<Service>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Service? result)
        {
            return JsonElementHelpers.TryParseValue<Service>(ref reader, out result);
        }
...
#if NET
        static Service IJsonElement<Service>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Service: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public Service Freeze()
        {
            ...
            {
                return mutable.FreezeElement<Service>(_idx);
            }
        ...
        {
            /// <summary>
            /// Gets the JSON property name for <see cref="FactoryName"/>.
            /// </summary>
            ...
            /// Gets the JSON property name for <see cref="FactoryName"/>.
            /// </summary>
            public static ReadOnlySpan<byte> FactoryNameUtf8 => "factoryName"u8;
        ...
        {
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="FactoryName"/>.
            /// </summary>
            public static ReadOnlySpan<byte> FactoryName => "factoryName"u8;
