    ...
    public readonly partial struct Setting
    {
        ...
        public readonly partial struct DictionaryOfCatalogObjectsOfferedByTheDatasource
        {
                ...
                : IJsonElement<ACatalogObjectOfAnInADataSource>
            {
                ...
                {
                    private static readonly JsonSchemaMessageProvider<int> RequiredPropertyObjectNamePresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("objectName"u8, buffer, out written);
                    private static readonly JsonSchemaMessageProvider<int> RequiredPropertyObjectNameNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("objectName"u8, buffer, out written);

                    private const int RequiredOffsetForObjectName = 0;
                    private const uint RequiredBitForObjectName = 0b00000000000000000000000000000001;
                    ...
                    private const uint RequiredBitForObjectType = 0b00000000000000000000000000000010;

                    private const uint RequiredBitMask0 =
                        RequiredBitForObjectName | RequiredBitForObjectType;
                    private static readonly JsonSchemaPathProvider ObjectNameValueSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/objectName/$ref"u8, buffer, out written);
                    private static readonly JsonSchemaPathProvider ObjectTypeValueSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/objectType/$ref"u8, buffer, out written);
                    ...
                    private static void MatchObjectNameValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                    {
                        ...
                        JsonSchemaContext childContext =
                            Corvus.Ui5ManifestBenchmark.Baseline.Schema.ObjectName.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                                parentDocumentIndex,
                                ref context,
                                JsonPropertyNames.ObjectNameValueUtf8,
                                evaluationPath: ObjectNameValueSchemaEvaluationPath);

                        Corvus.Ui5ManifestBenchmark.Baseline.Schema.ObjectName.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                    ...
                    private static void MatchObjectTypeValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                    {
                        ...
                        JsonSchemaContext childContext1 =
                            Corvus.Ui5ManifestBenchmark.Baseline.Schema.ObjectType.JsonSchema.PushChildContextUnescaped(
                                parentDocument,
                                parentDocumentIndex,
                                ref context,
                                JsonPropertyNames.ObjectTypeValueUtf8,
                                evaluationPath: ObjectTypeValueSchemaEvaluationPath);

                        Corvus.Ui5ManifestBenchmark.Baseline.Schema.ObjectType.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                    ...
                    private static void MatchSchemaName(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                    {
                        ...
                        JsonSchemaContext childContext3 =
                            Corvus.Ui5ManifestBenchmark.Baseline.JsonString.JsonSchema.PushChildContextUnescaped(
                                ...
                                parentDocumentIndex,
                                ref context,
                                JsonPropertyNames.SchemaNameUtf8,
                                evaluationPath: SchemaNameSchemaEvaluationPath);
                    ...
                    private static PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
                    {
                        return new PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator>([
                            (static () => JsonPropertyNames.ObjectNameValueUtf8, MatchObjectNameValue),
                            (static () => JsonPropertyNames.ObjectTypeValueUtf8, MatchObjectTypeValue),
                            (static () => JsonPropertyNames.PackageNameUtf8, MatchPackageName),
                            (static () => JsonPropertyNames.SchemaNameUtf8, MatchSchemaName),
                        ]);
                    }
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("ui5-manifest-schema.json#/definitions/setting/properties/objects/additionalProperties"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "ui5-manifest-schema.json#/definitions/setting/properties/objects/additionalProperties";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "ui5-manifest-schema.json#/definitions/setting/properties/objects/additionalProperties"u8;
                        ...
                        ref JsonSchemaContext context)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyObjectNamePresent, "objectName"u8, "required"u8);
                                context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyObjectTypePresent, "objectType"u8, "required"u8);
                            }
                            ...
                            {
                                if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForObjectName] & RequiredBitForObjectName) == 0)
                                {
                                    context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyObjectNameNotPresent, "objectName"u8, "required"u8);
                                }
                                else
                                {
                                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyObjectNamePresent, "objectName"u8, "required"u8);
                                ...
                                {
                                    context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyObjectTypeNotPresent, "objectType"u8, "required"u8);
                                }
                                else
                                {
                                    context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyObjectTypePresent, "objectType"u8, "required"u8);
