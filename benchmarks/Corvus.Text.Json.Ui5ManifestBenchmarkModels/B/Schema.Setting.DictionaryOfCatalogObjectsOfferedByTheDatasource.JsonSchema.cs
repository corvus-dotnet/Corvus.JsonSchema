...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Setting
    {
        ...
        public readonly partial struct DictionaryOfCatalogObjectsOfferedByTheDatasource
            : IJsonElement<DictionaryOfCatalogObjectsOfferedByTheDatasource>
        {
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("ui5-manifest-schema.json#/definitions/setting/properties/objects"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "ui5-manifest-schema.json#/definitions/setting/properties/objects";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "ui5-manifest-schema.json#/definitions/setting/properties/objects"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        while (objectValidation_enumerator.MoveNext())
                        {
                            ...
                            {
                                JsonSchemaContext childContext = Corvus.Ui5ManifestBenchmark.Baseline.Schema.Setting.DictionaryOfCatalogObjectsOfferedByTheDatasource.ACatalogObjectOfAnInADataSource.JsonSchema.PushChildContextUnescaped(
                                    parentDocument,
                                ...
                                Corvus.Ui5ManifestBenchmark.Baseline.Schema.Setting.DictionaryOfCatalogObjectsOfferedByTheDatasource.ACatalogObjectOfAnInADataSource.JsonSchema.Evaluate(parentDocument, objectValidation_currentIndex, ref childContext);
