    ...
    public readonly partial struct Setting
    {
        ...
        public readonly partial struct DictionaryOfCatalogObjectsOfferedByTheDatasource
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(DictionaryOfCatalogObjectsOfferedByTheDatasource instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DictionaryOfCatalogObjectsOfferedByTheDatasource"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DictionaryOfCatalogObjectsOfferedByTheDatasource(Mutable instance)
                {
                ...
                public Corvus.Ui5ManifestBenchmark.Baseline.Schema.Setting.DictionaryOfCatalogObjectsOfferedByTheDatasource.ACatalogObjectOfAnInADataSource.Mutable this[ReadOnlySpan<byte> propertyName]
                {
                    get
                    {
                        CheckValidInstance();
                        if (!_parent.TryGetNamedPropertyValue(_idx, propertyName, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.Setting.DictionaryOfCatalogObjectsOfferedByTheDatasource.ACatalogObjectOfAnInADataSource.Mutable value))
                        {
                            return default;
                        }
                ...
                /// <returns>The value of the property with the given name.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public Corvus.Ui5ManifestBenchmark.Baseline.Schema.Setting.DictionaryOfCatalogObjectsOfferedByTheDatasource.ACatalogObjectOfAnInADataSource.Mutable this[ReadOnlySpan<char> propertyName]
                {
                    get
                    {
                        CheckValidInstance();
                ...
                /// <returns>The value of the property with the given name.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public Corvus.Ui5ManifestBenchmark.Baseline.Schema.Setting.DictionaryOfCatalogObjectsOfferedByTheDatasource.ACatalogObjectOfAnInADataSource.Mutable this[string propertyName]
                {
                    get
                    {
                        CheckValidInstance();
                ...
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public bool TryGetProperty(ReadOnlySpan<byte> propertyName, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.Setting.DictionaryOfCatalogObjectsOfferedByTheDatasource.ACatalogObjectOfAnInADataSource.Mutable value)
                {
                    CheckValidInstance();
                ...
                /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public bool TryGetProperty(ReadOnlySpan<char> propertyName, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.Setting.DictionaryOfCatalogObjectsOfferedByTheDatasource.ACatalogObjectOfAnInADataSource.Mutable value)
                {
                    CheckValidInstance();
                    return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
                }
                ...
                /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public bool TryGetProperty(string propertyName, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.Setting.DictionaryOfCatalogObjectsOfferedByTheDatasource.ACatalogObjectOfAnInADataSource.Mutable value)
                {
                    CheckValidInstance();
                    return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public ObjectEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.Schema.Setting.DictionaryOfCatalogObjectsOfferedByTheDatasource.ACatalogObjectOfAnInADataSource.Mutable> EnumerateObject()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateObjectEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.Schema.Setting.DictionaryOfCatalogObjectsOfferedByTheDatasource.ACatalogObjectOfAnInADataSource.Mutable>(_parent, _idx);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new DictionaryOfCatalogObjectsOfferedByTheDatasource(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DictionaryOfCatalogObjectsOfferedByTheDatasource.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetProperty(string propertyName, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Setting.DictionaryOfCatalogObjectsOfferedByTheDatasource.ACatalogObjectOfAnInADataSource.Source value)
                {
                ...
                ///   </para>
                /// </remarks>
                public void SetProperty(ReadOnlySpan<char> propertyName, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Setting.DictionaryOfCatalogObjectsOfferedByTheDatasource.ACatalogObjectOfAnInADataSource.Source value)
                {
                    CheckValidInstance();
                ...
                ///   </para>
                /// </remarks>
                public void SetProperty(ReadOnlySpan<byte> propertyName, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Setting.DictionaryOfCatalogObjectsOfferedByTheDatasource.ACatalogObjectOfAnInADataSource.Source value)
                {
                    CheckValidInstance();
                ...
                /// <summary>
                /// Gets a <see cref="DictionaryOfCatalogObjectsOfferedByTheDatasource"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="DictionaryOfCatalogObjectsOfferedByTheDatasource"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly DictionaryOfCatalogObjectsOfferedByTheDatasource Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<DictionaryOfCatalogObjectsOfferedByTheDatasource>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="DictionaryOfCatalogObjectsOfferedByTheDatasource"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly DictionaryOfCatalogObjectsOfferedByTheDatasource Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DictionaryOfCatalogObjectsOfferedByTheDatasource>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.Setting.DictionaryOfCatalogObjectsOfferedByTheDatasource.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(DictionaryOfCatalogObjectsOfferedByTheDatasource instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.Setting.DictionaryOfCatalogObjectsOfferedByTheDatasource.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                public void AddProperty(ReadOnlySpan<byte> propertyName, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Setting.DictionaryOfCatalogObjectsOfferedByTheDatasource.ACatalogObjectOfAnInADataSource.Source value)
                {
                ...
                /// <param name="propertyName">The name of the property to add.</param>
                /// <param name="value">The value of the property to add.</param>
                public void AddProperty(ReadOnlySpan<char> propertyName, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Setting.DictionaryOfCatalogObjectsOfferedByTheDatasource.ACatalogObjectOfAnInADataSource.Source value)
                {
                    value.AddAsProperty(propertyName, ref _builder);
                }
                ...
                /// <param name="propertyName">The name of the property to add.</param>
                /// <param name="value">The value of the property to add.</param>
                public void AddProperty(string propertyName, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Setting.DictionaryOfCatalogObjectsOfferedByTheDatasource.ACatalogObjectOfAnInADataSource.Source value)
                {
                    value.AddAsProperty(propertyName, ref _builder);
                }
            ...
            {
                return workspace.CreateBuilder<DictionaryOfCatalogObjectsOfferedByTheDatasource, Mutable>(this);
            }
        }
    }
}
