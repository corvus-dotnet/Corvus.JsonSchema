    ...
    public readonly partial struct Setting
    {
        ...
        public readonly partial struct RepresentsVersionOfOData20IsDefault
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RepresentsVersionOfOData20IsDefault instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsVersionOfOData20IsDefault"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsVersionOfOData20IsDefault(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsVersionOfOData20IsDefault.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsVersionOfOData20IsDefault Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsVersionOfOData20IsDefault Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsVersionOfOData20IsDefault>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsVersionOfOData20IsDefault instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RepresentsVersionOfOData20IsDefault, Mutable>(this);
            }
        }
    }
}
