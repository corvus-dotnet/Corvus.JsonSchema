...
public readonly partial struct Schema
{
    ...
    public readonly partial struct SettingDef
#if NET8_0_OR_GREATER
        : IJsonElement<SettingDef>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SettingDef"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal SettingDef(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static SettingDef DefaultInstance { get; }
        ...
        /// </returns>
        public static bool operator ==(in SettingDef left, in SettingDef right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in SettingDef left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(SettingDef instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator SettingDef(JsonElement instance)
        {
            return SettingDef.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SettingDef From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SettingDef ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SettingDef>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SettingDef ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SettingDef>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SettingDef ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SettingDef>(json, options);
        }
        ...
        /// </exception>
        public static SettingDef ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<SettingDef>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out SettingDef? result)
        {
            return JsonElementHelpers.TryParseValue<SettingDef>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new SettingDef(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static SettingDef IJsonElement<SettingDef>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"SettingDef: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="SettingDef"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="SettingDef"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public SettingDef Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<SettingDef>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="SettingDef"/> that lives for the lifetime of its
