...
public readonly partial struct Schema
{
    ...
    public readonly partial struct SignatureDef
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.SignatureDef.AdditionalParametersEntity.Mutable AdditionalParameters
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AdditionalParametersUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.SignatureDef.AdditionalParametersEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.SignatureDef.ParametersEntity.Mutable Parameters
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ParametersUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.SignatureDef.ParametersEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetAdditionalParameters(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.SignatureDef.AdditionalParametersEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetParameters(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.SignatureDef.ParametersEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetParameters<TContext>(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.SignatureDef.ParametersEntity.Source<TContext> value)
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.SignatureDef.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.SignatureDef.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.SignatureDef.AdditionalParametersEntity.Source additionalParameters,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.SignatureDef.ParametersEntity.Source parameters)
            {
            ...
            /// Creates an instance of a <see cref="SignatureDef"/>.
            /// </summary>
            public void Create(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.SignatureDef.AdditionalParametersEntity.Source additionalParameters, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.SignatureDef.ParametersEntity.Source parameters)
            {
            ...
            internal static void Create<TContext>(
                ...
                ref ComplexValueBuilder builder,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.SignatureDef.AdditionalParametersEntity.Source additionalParameters,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.SignatureDef.ParametersEntity.Source<TContext> parameters)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.SignatureDef.AdditionalParametersEntity.Source additionalParameters, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.SignatureDef.ParametersEntity.Source parameters, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
