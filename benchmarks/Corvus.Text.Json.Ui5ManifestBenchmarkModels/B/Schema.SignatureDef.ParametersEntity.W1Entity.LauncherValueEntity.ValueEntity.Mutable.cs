                ...
                public readonly partial struct LauncherValueEntity
                {
                    ...
                    public readonly partial struct ValueEntity
                    {
...
#endif
                        {
                            ...
                            /// <summary>
                            /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.ValueEntity.JsonStringArray"/>.
                            /// </summary>
                            /// <param name="value">The value from which to convert.</param>
                            public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.Schema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.ValueEntity.JsonStringArray.Mutable(Mutable value)
                            {
                                return Corvus.Ui5ManifestBenchmark.Baseline.Schema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.ValueEntity.JsonStringArray.Mutable.From(value);
                            }

                            /// <summary>
                            /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.ValueEntity.JsonStringArray"/>.
                            /// </summary>
                            /// <param name="value">The value from which to convert.</param>
                            public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Baseline.Schema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.ValueEntity.JsonStringArray.Mutable value)
                            {
                                return From(value);
                            }
                            ...
                            /// <param name="matchJsonStringArray">Match a <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.ValueEntity.JsonStringArray"/>.</param>
                            ...
                            public TResult Match<TContext, TResult>(
                                ...
                                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.ValueEntity.JsonStringArray, TContext, TResult> matchJsonStringArray,
                                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.ValueEntity.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                            where TContext : allows ref struct
#endif
                            {
                                ...
                                if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.ValueEntity.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                                {
                                    return matchJsonStringArray(Corvus.Ui5ManifestBenchmark.Baseline.Schema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.ValueEntity.JsonStringArray.Mutable.From(this), context);
                                }
                            ...
                            public TResult Match<TResult>(
                                ...
                                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.ValueEntity.JsonStringArray, TResult> matchJsonStringArray,
                                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.ValueEntity.Mutable, TResult> defaultMatch)
                            {
                                if (Corvus.Ui5ManifestBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                                {
                                ...
                                if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.ValueEntity.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                                {
                                    return matchJsonStringArray(Corvus.Ui5ManifestBenchmark.Baseline.Schema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.ValueEntity.JsonStringArray.Mutable.From(this));
                                }
                            ...
                            /// <summary>
                            /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Schema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.ValueEntity.JsonStringArray" />.
                            /// </summary>
                            /// <param name="result">The result of the conversions.</param>
                            /// <returns><see langword="true" /> if the conversion was valid.</returns>
                            public bool TryGetAsJsonStringArray(out Corvus.Ui5ManifestBenchmark.Baseline.Schema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.ValueEntity.JsonStringArray result)
                            {
                                if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.ValueEntity.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                                {
                                    result = Corvus.Ui5ManifestBenchmark.Baseline.Schema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.ValueEntity.JsonStringArray.Mutable.From(this);
                                    return true;
                                }
                        ...
                        public ref struct Source
                        {
                            ...
                            internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.ValueEntity.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                            ...
                            #endif
                        {
                            ...
                            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.ValueEntity.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
