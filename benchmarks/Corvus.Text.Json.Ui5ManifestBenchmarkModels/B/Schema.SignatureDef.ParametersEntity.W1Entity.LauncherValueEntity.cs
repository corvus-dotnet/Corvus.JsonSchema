        ...
        public readonly partial struct ParametersEntity
        {
            ...
            public readonly partial struct W1Entity
            {
                ...
                public readonly partial struct LauncherValueEntity
                    ...
                    : IJsonElement<LauncherValueEntity>,
                      IFormattable,
                      ISpanFormattable,
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="LauncherValueEntity"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal LauncherValueEntity(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static LauncherValueEntity DefaultInstance { get; }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.Ui5ManifestBenchmark.Baseline.Schema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.FormatEntity Format
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FormatUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.FormatEntity value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.Ui5ManifestBenchmark.Baseline.JsonBoolean Prompt
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PromptUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.JsonBoolean value))
                            {
                                return value;
                            }
                    ...
                    /// </summary>
                    public Corvus.Ui5ManifestBenchmark.Baseline.Schema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.ValueEntity Value
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ValueUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.ValueEntity value))
                            {
                                return value;
                            }
                    ...
                    /// </returns>
                    public static bool operator ==(in LauncherValueEntity left, in LauncherValueEntity right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in LauncherValueEntity left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    public static implicit operator JsonElement(LauncherValueEntity instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator LauncherValueEntity(JsonElement instance)
                    {
                        return LauncherValueEntity.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static LauncherValueEntity From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static LauncherValueEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<LauncherValueEntity>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static LauncherValueEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<LauncherValueEntity>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static LauncherValueEntity ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<LauncherValueEntity>(json, options);
                    }
                    ...
                    /// </exception>
                    public static LauncherValueEntity ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<LauncherValueEntity>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out LauncherValueEntity? result)
                    {
                        return JsonElementHelpers.TryParseValue<LauncherValueEntity>(ref reader, out result);
                    }
...
#if NET
                    static LauncherValueEntity IJsonElement<LauncherValueEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"LauncherValueEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public LauncherValueEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public LauncherValueEntity Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<LauncherValueEntity>(_idx);
                        }
                    ...
                    public static class JsonPropertyNames
                    {
                        ...
                        /// <summary>
                        /// Gets the JSON property name for <see cref="Prompt"/>.
                        /// </summary>
                    ...
                    private static class JsonPropertyNamesEscaped
                    {
                        ...
                        /// <summary>
                        /// Gets the escaped UTF-8 JSON property name for <see cref="Prompt"/>.
                        /// </summary>
