...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SignatureDef"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal SignatureDef(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static SignatureDef DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.Schema.SignatureDef.AdditionalParametersEntity AdditionalParameters
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AdditionalParametersUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.SignatureDef.AdditionalParametersEntity value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.Schema.SignatureDef.ParametersEntity Parameters
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ParametersUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.SignatureDef.ParametersEntity value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in SignatureDef left, in SignatureDef right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in SignatureDef left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(SignatureDef instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator SignatureDef(JsonElement instance)
        {
            return SignatureDef.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SignatureDef From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SignatureDef ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SignatureDef>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SignatureDef ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SignatureDef>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SignatureDef ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SignatureDef>(json, options);
        }
        ...
        /// </exception>
        public static SignatureDef ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<SignatureDef>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out SignatureDef? result)
        {
            return JsonElementHelpers.TryParseValue<SignatureDef>(ref reader, out result);
        }
...
#if NET
        static SignatureDef IJsonElement<SignatureDef>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"SignatureDef: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        {
            /// <summary>
            /// Gets the JSON property name for <see cref="AdditionalParameters"/>.
            /// </summary>
            ...
            /// Gets the JSON property name for <see cref="AdditionalParameters"/>.
            /// </summary>
            public static ReadOnlySpan<byte> AdditionalParametersUtf8 => "additionalParameters"u8;
        ...
        {
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="AdditionalParameters"/>.
            /// </summary>
            public static ReadOnlySpan<byte> AdditionalParameters => "additionalParameters"u8;
