...
public readonly partial struct Schema
{
    ...
    public readonly partial struct SimpleBinding
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(SimpleBinding instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="SimpleBinding"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SimpleBinding(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SimpleBinding.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly SimpleBinding Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly SimpleBinding Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<SimpleBinding>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(SimpleBinding instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<SimpleBinding, Mutable>(this);
        }
    }
}
