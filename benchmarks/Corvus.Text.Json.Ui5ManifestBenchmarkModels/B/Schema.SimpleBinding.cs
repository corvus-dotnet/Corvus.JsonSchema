...
public readonly partial struct Schema
{
    ...
    public readonly partial struct SimpleBinding
#if NET8_0_OR_GREATER
        : IJsonElement<SimpleBinding>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SimpleBinding"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal SimpleBinding(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static SimpleBinding DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(SimpleBinding value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in SimpleBinding left, in SimpleBinding right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in SimpleBinding left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(SimpleBinding instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator SimpleBinding(JsonElement instance)
        {
            return SimpleBinding.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SimpleBinding From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SimpleBinding ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SimpleBinding>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SimpleBinding ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SimpleBinding>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SimpleBinding ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SimpleBinding>(json, options);
        }
        ...
        /// </exception>
        public static SimpleBinding ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<SimpleBinding>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out SimpleBinding? result)
        {
            return JsonElementHelpers.TryParseValue<SimpleBinding>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new SimpleBinding(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static SimpleBinding IJsonElement<SimpleBinding>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"SimpleBinding: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="SimpleBinding"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="SimpleBinding"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public SimpleBinding Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<SimpleBinding>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="SimpleBinding"/> that lives for the lifetime of its
