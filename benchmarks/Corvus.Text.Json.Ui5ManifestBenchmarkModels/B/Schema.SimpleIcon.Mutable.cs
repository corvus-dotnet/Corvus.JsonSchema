...
public readonly partial struct Schema
{
    ...
    public readonly partial struct SimpleIcon
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(SimpleIcon instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="SimpleIcon"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SimpleIcon(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new SimpleIcon(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SimpleIcon.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="SimpleIcon"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="SimpleIcon"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly SimpleIcon Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<SimpleIcon>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="SimpleIcon"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly SimpleIcon Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<SimpleIcon>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.SimpleIcon.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(SimpleIcon instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.SimpleIcon.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="SimpleIcon"/>.
            /// </summary>
            ...
            /// Creates an instance of a <see cref="SimpleIcon"/>.
            /// </summary>
            public void Create(in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source src = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Visibility.Source visible = default)
            {
                Create(ref _builder, src, visible);
            }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source src = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Visibility.Source visible = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(src, visible);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<SimpleIcon, Mutable>(this);
        }
    }
}
