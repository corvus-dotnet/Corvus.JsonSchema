...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Status
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.Status.RepresentsStatusText.Mutable Text
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TextUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.Status.RepresentsStatusText.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetText(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Status.RepresentsStatusText.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetText<TContext>(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Status.RepresentsStatusText.Source<TContext> value)
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.Status.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.Status.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Status.RepresentsStatusText.Source text = default,
            ...
            /// Creates an instance of a <see cref="Status"/>.
            /// </summary>
            public void Create(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Status.RepresentsStatusText.Source text = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Visibility.Source visible = default)
            {
            ...
            internal static void Create<TContext>(
                in TContext context,
                ref ComplexValueBuilder builder,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Status.RepresentsStatusText.Source<TContext> text = default,
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Visibility.Source visible = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Status.RepresentsStatusText.Source text = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.Visibility.Source visible = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
