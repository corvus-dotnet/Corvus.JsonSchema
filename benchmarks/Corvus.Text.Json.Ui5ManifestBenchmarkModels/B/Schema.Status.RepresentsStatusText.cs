...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Status
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RepresentsStatusText"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RepresentsStatusText(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RepresentsStatusText DefaultInstance { get; }
            ...
            public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.Schema.StatusTextFormatter(RepresentsStatusText value)
            {
                return Corvus.Ui5ManifestBenchmark.Baseline.Schema.StatusTextFormatter.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator RepresentsStatusText(Corvus.Ui5ManifestBenchmark.Baseline.Schema.StatusTextFormatter value)
            {
                return From(value);
            }
            ...
            /// </returns>
            public static bool operator ==(in RepresentsStatusText left, in RepresentsStatusText right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RepresentsStatusText left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(RepresentsStatusText instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RepresentsStatusText(JsonElement instance)
            {
                return RepresentsStatusText.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsStatusText From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsStatusText ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsStatusText>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsStatusText ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsStatusText>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsStatusText ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsStatusText>(json, options);
            }
            ...
            /// </exception>
            public static RepresentsStatusText ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RepresentsStatusText>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsStatusText? result)
            {
                return JsonElementHelpers.TryParseValue<RepresentsStatusText>(ref reader, out result);
            }
...
#if NET
            static RepresentsStatusText IJsonElement<RepresentsStatusText>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RepresentsStatusText: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public RepresentsStatusText Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public RepresentsStatusText Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RepresentsStatusText>(_idx);
                }
            ...
            public bool TryGetAsStatusTextFormatter(out Corvus.Ui5ManifestBenchmark.Baseline.Schema.StatusTextFormatter result)
            {
                ...
                {
                    result = Corvus.Ui5ManifestBenchmark.Baseline.Schema.StatusTextFormatter.From(this);
                    return true;
                }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.Status.RepresentsStatusText, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.StatusTextFormatter.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchStatusTextFormatter(Corvus.Ui5ManifestBenchmark.Baseline.Schema.StatusTextFormatter.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.Status.RepresentsStatusText, TResult> defaultMatch)
            {
                if (Corvus.Ui5ManifestBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                ...
                if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.StatusTextFormatter.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchStatusTextFormatter(Corvus.Ui5ManifestBenchmark.Baseline.Schema.StatusTextFormatter.From(this));
                }
