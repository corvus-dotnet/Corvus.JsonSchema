...
public readonly partial struct Schema
{
    ...
    public readonly partial struct StatusTextFormatter
    {
            ...
            : IJsonElement<DefinesBindingInformation>
        {
            ...
            {
                private static readonly JsonSchemaPathProvider PartsSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/parts"u8, buffer, out written);
                private static readonly JsonSchemaPathProvider TranslationKeySchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/translationKey"u8, buffer, out written);

                private static void MatchParts(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext =
                        Corvus.Ui5ManifestBenchmark.Baseline.Schema.StatusTextFormatter.DefinesBindingInformation.PartsArray.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Corvus.Ui5ManifestBenchmark.Baseline.Schema.StatusTextFormatter.DefinesBindingInformation.PartsArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                    context.CommitChildContext(childContext.IsMatch, ref childContext);
                }

                private static void MatchTranslationKey(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext1 =
                        Corvus.Ui5ManifestBenchmark.Baseline.JsonString.JsonSchema.PushChildContextUnescaped(
                            ...
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.TranslationKeyUtf8,
                            evaluationPath: TranslationKeySchemaEvaluationPath);
                ...
                private static PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
                {
                    return new PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Baseline.PropertiesValidationHandler_NamedPropertyValidator1>([
                        (static () => JsonPropertyNames.PartsUtf8, MatchParts),
                        (static () => JsonPropertyNames.TranslationKeyUtf8, MatchTranslationKey),
                    ]);
                }
