...
public readonly partial struct Schema
{
    ...
    /// </para>
    /// </remarks>
    public readonly partial struct StatusTextFormatter
    {
        /// <summary>
        /// Generated from JSON Schema.
        /// </summary>
        ...
        public readonly partial struct DefinesBindingInformation
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(DefinesBindingInformation instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DefinesBindingInformation"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DefinesBindingInformation(Mutable instance)
                {
                ...
                /// <summary>
                /// Gets the (optional) <c>parts</c> property.
                /// </summary>
                public Corvus.Ui5ManifestBenchmark.Baseline.Schema.StatusTextFormatter.DefinesBindingInformation.PartsArray.Mutable Parts
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PartsUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.StatusTextFormatter.DefinesBindingInformation.PartsArray.Mutable value))
                        {
                            return value;
                        }
                ...
                /// <summary>
                /// Gets the (optional) <c>translationKey</c> property.
                /// </summary>
                public Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Mutable TranslationKey
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TranslationKeyUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new DefinesBindingInformation(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                /// <summary>
                /// Set the <c>parts</c> property.
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetParts(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.StatusTextFormatter.DefinesBindingInformation.PartsArray.Source value)
                {
                    CheckValidInstance();

                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.PartsUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PartsUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                    ...
                    else
                    {
                        ...
                        value.AddAsProperty(JsonPropertyNamesEscaped.Parts, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetParts<TContext>(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.StatusTextFormatter.DefinesBindingInformation.PartsArray.Source<TContext> value)
                ...
                /// <summary>
                /// Remove the <c>parts</c> property, if present.
                /// </summary>
                ...
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.PartsUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }

                /// <summary>
                /// Set the <c>translationKey</c> property.
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetTranslationKey(in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source value)
                {
                    CheckValidInstance();

                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.TranslationKeyUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TranslationKeyUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsProperty(JsonPropertyNamesEscaped.TranslationKey, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                /// <summary>
                /// Remove the <c>translationKey</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveTranslationKey()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.TranslationKeyUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DefinesBindingInformation.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="DefinesBindingInformation"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="DefinesBindingInformation"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly DefinesBindingInformation Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<DefinesBindingInformation>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="DefinesBindingInformation"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly DefinesBindingInformation Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DefinesBindingInformation>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.StatusTextFormatter.DefinesBindingInformation.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(DefinesBindingInformation instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.StatusTextFormatter.DefinesBindingInformation.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="DefinesBindingInformation"/>.
                /// </summary>
                internal static void Create(
                    ref ComplexValueBuilder builder,
                    in Corvus.Ui5ManifestBenchmark.Baseline.Schema.StatusTextFormatter.DefinesBindingInformation.PartsArray.Source parts = default,
                    in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source translationKey = default)
                {
                    parts.AddAsProperty(JsonPropertyNamesEscaped.Parts, ref builder, escapeName: false);
                    translationKey.AddAsProperty(JsonPropertyNamesEscaped.TranslationKey, ref builder, escapeName: false);
                }

                /// <summary>
                /// Creates an instance of a <see cref="DefinesBindingInformation"/>.
                /// </summary>
                public void Create(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.StatusTextFormatter.DefinesBindingInformation.PartsArray.Source parts = default, in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source translationKey = default)
                {
                    Create(ref _builder, parts, translationKey);
                }
                ...
                internal static void Create<TContext>(
                    in TContext context,
                    ref ComplexValueBuilder builder,
                    in Corvus.Ui5ManifestBenchmark.Baseline.Schema.StatusTextFormatter.DefinesBindingInformation.PartsArray.Source<TContext> parts = default,
                    in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source translationKey = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                ...
                #endif
                {
                    Create(context, ref _builder, parts, translationKey);
                }
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.StatusTextFormatter.DefinesBindingInformation.PartsArray.Source parts = default, in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source translationKey = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.StatusTextFormatter.DefinesBindingInformation.PartsArray.Source<TContext> parts = default, in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source translationKey = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
