        ...
        public readonly partial struct DefinesBindingInformation
        {
            ...
            public readonly partial struct PartsArray
            {
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.StatusTextFormatter.DefinesBindingInformation.PartsArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.StatusTextFormatter.DefinesBindingInformation.PartsArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
