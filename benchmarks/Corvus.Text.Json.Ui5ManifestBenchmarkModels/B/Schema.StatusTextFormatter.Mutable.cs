...
public readonly partial struct Schema
{
    ...
    public readonly partial struct StatusTextFormatter
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.Schema.StatusTextFormatter.DefinesBindingInformation.Mutable Format
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FormatUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.StatusTextFormatter.DefinesBindingInformation.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetFormat(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.StatusTextFormatter.DefinesBindingInformation.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetFormat<TContext>(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.StatusTextFormatter.DefinesBindingInformation.Source<TContext> value)
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.StatusTextFormatter.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.StatusTextFormatter.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.StatusTextFormatter.DefinesBindingInformation.Source format = default)
            {
            ...
            /// Creates an instance of a <see cref="StatusTextFormatter"/>.
            /// </summary>
            public void Create(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.StatusTextFormatter.DefinesBindingInformation.Source format = default)
            {
            ...
            internal static void Create<TContext>(
                ...
                in Corvus.Ui5ManifestBenchmark.Baseline.Schema.StatusTextFormatter.DefinesBindingInformation.Source<TContext> format = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            /// Creates an instance of a <see cref="StatusTextFormatter"/>.
            /// </summary>
            public void Create<TContext>(in TContext context, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.StatusTextFormatter.DefinesBindingInformation.Source<TContext> format = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.StatusTextFormatter.DefinesBindingInformation.Source format = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.StatusTextFormatter.DefinesBindingInformation.Source<TContext> format = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
