...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.Schema.StatusTextFormatter.DefinesBindingInformation Format
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FormatUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.StatusTextFormatter.DefinesBindingInformation value))
                {
                    return value;
                }
