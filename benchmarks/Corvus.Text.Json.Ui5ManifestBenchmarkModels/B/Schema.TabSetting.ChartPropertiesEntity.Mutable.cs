...
public readonly partial struct Schema
{
    ...
    public readonly partial struct TabSetting
    {
        ...
        public readonly partial struct ChartPropertiesEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ChartPropertiesEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ChartPropertiesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ChartPropertiesEntity(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Baseline.Schema.PlotAreaDef.Mutable PlotArea
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PlotAreaUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.PlotAreaDef.Mutable value))
                        {
                            return value;
                        }
                ...
                /// <summary>
                /// Gets the (optional) <c>timeAxis</c> property.
                /// </summary>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Baseline.Schema.TimeAxisDef.Mutable TimeAxis
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TimeAxisUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.TimeAxisDef.Mutable value))
                        {
                            return value;
                        }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ChartPropertiesEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                public void SetPlotArea(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.PlotAreaDef.Source value)
                {
                    CheckValidInstance();

                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.PlotAreaUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PlotAreaUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                    ...
                    else
                    {
                        ...
                        value.AddAsProperty(JsonPropertyNamesEscaped.PlotArea, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetPlotArea<TContext>(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.PlotAreaDef.Source<TContext> value)
                ...
                /// <summary>
                /// Remove the <c>plotArea</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemovePlotArea()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.PlotAreaUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }

                /// <summary>
                /// Set the <c>timeAxis</c> property.
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetTimeAxis(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.TimeAxisDef.Source value)
                {
                    CheckValidInstance();

                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.TimeAxisUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TimeAxisUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsProperty(JsonPropertyNamesEscaped.TimeAxis, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetTimeAxis<TContext>(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.TimeAxisDef.Source<TContext> value)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
                ...
                /// <summary>
                /// Remove the <c>timeAxis</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveTimeAxis()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.TimeAxisUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ChartPropertiesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ChartPropertiesEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ChartPropertiesEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ChartPropertiesEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ChartPropertiesEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ChartPropertiesEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ChartPropertiesEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ChartPropertiesEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ChartPropertiesEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(ChartPropertiesEntity instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ChartPropertiesEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="ChartPropertiesEntity"/>.
                /// </summary>
                internal static void Create(
                    ref ComplexValueBuilder builder,
                    in Corvus.Ui5ManifestBenchmark.Baseline.Schema.PlotAreaDef.Source plotArea = default,
                    in Corvus.Ui5ManifestBenchmark.Baseline.Schema.TimeAxisDef.Source timeAxis = default)
                {
                    plotArea.AddAsProperty(JsonPropertyNamesEscaped.PlotArea, ref builder, escapeName: false);
                    timeAxis.AddAsProperty(JsonPropertyNamesEscaped.TimeAxis, ref builder, escapeName: false);
                }

                /// <summary>
                /// Creates an instance of a <see cref="ChartPropertiesEntity"/>.
                /// </summary>
                public void Create(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.PlotAreaDef.Source plotArea = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.TimeAxisDef.Source timeAxis = default)
                {
                    Create(ref _builder, plotArea, timeAxis);
                }
                ...
                internal static void Create<TContext>(
                    in TContext context,
                    ref ComplexValueBuilder builder,
                    in Corvus.Ui5ManifestBenchmark.Baseline.Schema.PlotAreaDef.Source<TContext> plotArea = default,
                    in Corvus.Ui5ManifestBenchmark.Baseline.Schema.TimeAxisDef.Source<TContext> timeAxis = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
                ...
                #endif
                {
                    Create(context, ref _builder, plotArea, timeAxis);
                }
            ...
            /// </summary>
            /// <param name="workspace">The JSON workspace.</param>
            /// <param name="plotArea">The value of the property.</param>
            /// <param name="timeAxis">The value of the property.</param>
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.PlotAreaDef.Source plotArea = default, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.TimeAxisDef.Source timeAxis = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(plotArea, timeAxis);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
                ...
                #endif
            {
                ...
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(context, plotArea, timeAxis);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<ChartPropertiesEntity, Mutable>(this);
            }
        }
    }
}
