    ...
    public readonly partial struct TabSetting
    {
        ...
        public readonly partial struct ColorPaletteEntity
        {
...
#endif
            {
                ...
                public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ColorPaletteEntity.Type0EntityArray.Mutable(Mutable value)
                {
                    return Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ColorPaletteEntity.Type0EntityArray.Mutable.From(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ColorPaletteEntity.Type0EntityArray.Mutable value)
                {
                    return From(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ColorPaletteEntity.OneOf1Entity.Mutable(Mutable value)
                {
                    return Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ColorPaletteEntity.OneOf1Entity.Mutable.From(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ColorPaletteEntity.OneOf1Entity.Mutable value)
                {
                    return From(value);
                }
                ...
                /// </remarks>
                public void Apply(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ColorPaletteEntity.OneOf1Entity value)
                {
                    CheckValidInstance();
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ColorPaletteEntity.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
                {
                    ...
                    {
                        return matchType0EntityArray(Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ColorPaletteEntity.Type0EntityArray.Mutable.From(this), context);
                    }
                    ...
                    {
                        return matchOneOf1Entity(Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ColorPaletteEntity.OneOf1Entity.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ColorPaletteEntity.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ColorPaletteEntity.Type0EntityArray.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchType0EntityArray(Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ColorPaletteEntity.Type0EntityArray.Mutable.From(this));
                    }

                    if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ColorPaletteEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchOneOf1Entity(Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ColorPaletteEntity.OneOf1Entity.Mutable.From(this));
                    }
                ...
                public bool TryGetAsType0EntityArray(out Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ColorPaletteEntity.Type0EntityArray result)
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ColorPaletteEntity.Type0EntityArray.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ColorPaletteEntity.Type0EntityArray.Mutable.From(this);
                        return true;
                    }
                ...
                public bool TryGetAsOneOf1Entity(out Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ColorPaletteEntity.OneOf1Entity result)
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ColorPaletteEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ColorPaletteEntity.OneOf1Entity.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ColorPaletteEntity.ObjectBuilder.Build value) {_objectBuilder = value; _kind = Kind.ObjectBuilder; }

                internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ColorPaletteEntity.ArrayBuilder.Build value) {_arrayBuilder = value; _kind = Kind.ArrayBuilder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ColorPaletteEntity.ObjectBuilder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.ObjectBuilder; }

                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ColorPaletteEntity.ArrayBuilder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.ArrayBuilder; }
