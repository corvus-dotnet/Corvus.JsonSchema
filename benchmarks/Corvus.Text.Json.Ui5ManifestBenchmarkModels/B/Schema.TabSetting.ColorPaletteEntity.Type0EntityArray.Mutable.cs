...
public readonly partial struct Schema
{
    ...
    public readonly partial struct TabSetting
    {
        ...
        public readonly partial struct ColorPaletteEntity
        {
            ...
            public readonly partial struct Type0EntityArray
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(Type0EntityArray instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="Type0EntityArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Type0EntityArray(Mutable instance)
                    {
                    ...
                    public Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ColorPaletteEntity.Type0EntityArray.Type0Entity.Mutable this[int index]
                    {
                        get
                        {
                            CheckValidInstance();
                            return _parent.GetArrayIndexElement<Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ColorPaletteEntity.Type0EntityArray.Type0Entity.Mutable>(_idx, index);
                        }
                    }
                    ...
                    /// </summary>
                    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                    public ArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ColorPaletteEntity.Type0EntityArray.Type0Entity.Mutable> EnumerateArray()
                    {
                        CheckValidInstance();
                        return EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ColorPaletteEntity.Type0EntityArray.Type0Entity.Mutable>(_parent, _idx);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new Type0EntityArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"Type0EntityArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    /// <summary>
                    ...
                    /// </remarks>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void SetItem(int itemIndex, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ColorPaletteEntity.Type0EntityArray.Type0Entity.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </remarks>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void InsertItem(int itemIndex, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ColorPaletteEntity.Type0EntityArray.Type0Entity.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void AddItem(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ColorPaletteEntity.Type0EntityArray.Type0Entity.Source value)
                    {
                    ...
                    ///   The parent <see cref="JsonDocument"/> has been disposed.
                    /// </exception>
                    public bool Remove(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ColorPaletteEntity.Type0EntityArray.Type0Entity item)
                    {
                        CheckValidInstance();
                        if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ColorPaletteEntity.Type0EntityArray.Type0Entity>(this, in item))
                        {
                            return false;
                        }
                    ...
                    /// </remarks>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void RemoveWhere(JsonPredicate<Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ColorPaletteEntity.Type0EntityArray.Type0Entity> predicate)
                    {
                        CheckValidInstance();
                        JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ColorPaletteEntity.Type0EntityArray.Type0Entity>(this, predicate);
                        _documentVersion = _parent.Version;
                    }
                    ...
                    ///   The parent <see cref="JsonDocument"/> has been disposed.
                    /// </exception>
                    public bool Replace(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ColorPaletteEntity.Type0EntityArray.Type0Entity oldItem, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ColorPaletteEntity.Type0EntityArray.Type0Entity.Source newItem)
                    {
                        CheckValidInstance();
                        ...
                        var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ColorPaletteEntity.Type0EntityArray.Type0Entity>(_parent, _idx);

                        while (enumerator.MoveNext())
                        {
                            Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ColorPaletteEntity.Type0EntityArray.Type0Entity current = enumerator.Current;
                    ...
                    /// <summary>
                    /// Gets a <see cref="Type0EntityArray"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="Type0EntityArray"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly Type0EntityArray Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<Type0EntityArray>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="Type0EntityArray"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly Type0EntityArray Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<Type0EntityArray>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ColorPaletteEntity.Type0EntityArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(Type0EntityArray instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ColorPaletteEntity.Type0EntityArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
                ...
                {
                    return workspace.CreateBuilder<Type0EntityArray, Mutable>(this);
                }
            }
        }
    }
