    ...
    public readonly partial struct TabSetting
    {
        ...
        public readonly partial struct ColorPaletteEntity
        {
...
#endif
            {
                ...
                public Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ColorPaletteEntity.Type0EntityArray.Type0Entity this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ColorPaletteEntity.Type0EntityArray.Type0Entity>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ColorPaletteEntity.Type0EntityArray.Type0Entity> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.Schema.TabSetting.ColorPaletteEntity.Type0EntityArray.Type0Entity>(_parent, _idx);
                }
