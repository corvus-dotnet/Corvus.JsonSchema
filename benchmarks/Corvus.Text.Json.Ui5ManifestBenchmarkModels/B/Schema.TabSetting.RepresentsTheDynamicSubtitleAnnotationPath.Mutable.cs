    ...
    public readonly partial struct TabSetting
    {
        ...
        public readonly partial struct RepresentsTheDynamicSubtitleAnnotationPath
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RepresentsTheDynamicSubtitleAnnotationPath instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsTheDynamicSubtitleAnnotationPath"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsTheDynamicSubtitleAnnotationPath(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsTheDynamicSubtitleAnnotationPath.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheDynamicSubtitleAnnotationPath Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheDynamicSubtitleAnnotationPath Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsTheDynamicSubtitleAnnotationPath>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsTheDynamicSubtitleAnnotationPath instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RepresentsTheDynamicSubtitleAnnotationPath, Mutable>(this);
            }
        }
    }
}
