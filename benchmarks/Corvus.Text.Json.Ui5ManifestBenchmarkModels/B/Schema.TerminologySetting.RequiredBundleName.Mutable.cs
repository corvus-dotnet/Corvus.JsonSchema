    ...
    public readonly partial struct TerminologySetting
    {
        ...
        public readonly partial struct RequiredBundleName
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Baseline.Schema.TerminologySetting.RequiredBundleName.RepresentsTheListOfSupportedLocales.Mutable SupportedLocales
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SupportedLocalesUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.TerminologySetting.RequiredBundleName.RepresentsTheListOfSupportedLocales.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetSupportedLocales(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.TerminologySetting.RequiredBundleName.RepresentsTheListOfSupportedLocales.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetSupportedLocales<TContext>(in Corvus.Ui5ManifestBenchmark.Baseline.Schema.TerminologySetting.RequiredBundleName.RepresentsTheListOfSupportedLocales.Source<TContext> value)
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.TerminologySetting.RequiredBundleName.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.TerminologySetting.RequiredBundleName.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.Ui5ManifestBenchmark.Baseline.Schema.TerminologySetting.RequiredBundleName.RepresentsTheListOfSupportedLocales.Source supportedLocales = default)
                {
                ...
                /// Creates an instance of a <see cref="RequiredBundleName"/>.
                /// </summary>
                public void Create(in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source bundleName, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.TerminologySetting.RequiredBundleName.RepresentsTheListOfSupportedLocales.Source supportedLocales = default)
                {
                    Create(ref _builder, bundleName, supportedLocales);
                }
                ...
                internal static void Create<TContext>(
                    ...
                    ref ComplexValueBuilder builder,
                    in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source bundleName,
                    in Corvus.Ui5ManifestBenchmark.Baseline.Schema.TerminologySetting.RequiredBundleName.RepresentsTheListOfSupportedLocales.Source<TContext> supportedLocales = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
                ...
                #endif
                {
                    Create(context, ref _builder, bundleName, supportedLocales);
                }
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source bundleName, in Corvus.Ui5ManifestBenchmark.Baseline.Schema.TerminologySetting.RequiredBundleName.RepresentsTheListOfSupportedLocales.Source<TContext> supportedLocales = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                ...
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(context, bundleName, supportedLocales);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
