        ...
        public readonly partial struct RequiredBundleName
        {
            ...
            public readonly partial struct RepresentsTheListOfSupportedLocales
            {
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.TerminologySetting.RequiredBundleName.RepresentsTheListOfSupportedLocales.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.TerminologySetting.RequiredBundleName.RepresentsTheListOfSupportedLocales.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
