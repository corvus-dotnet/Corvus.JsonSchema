...
public readonly partial struct Schema
{
    ...
    public readonly partial struct TimeAxisDef
#if NET8_0_OR_GREATER
        : IJsonElement<TimeAxisDef>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TimeAxisDef"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal TimeAxisDef(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static TimeAxisDef DefaultInstance { get; }
        ...
        /// <summary>
        /// Gets the (optional) <c>levels</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.Schema.LevelsDef Levels
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LevelsUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.Schema.LevelsDef value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in TimeAxisDef left, in TimeAxisDef right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in TimeAxisDef left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(TimeAxisDef instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TimeAxisDef(JsonElement instance)
        {
            return TimeAxisDef.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TimeAxisDef From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TimeAxisDef ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TimeAxisDef>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TimeAxisDef ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TimeAxisDef>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TimeAxisDef ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TimeAxisDef>(json, options);
        }
        ...
        /// </exception>
        public static TimeAxisDef ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<TimeAxisDef>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out TimeAxisDef? result)
        {
            return JsonElementHelpers.TryParseValue<TimeAxisDef>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new TimeAxisDef(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static TimeAxisDef IJsonElement<TimeAxisDef>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TimeAxisDef: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="TimeAxisDef"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="TimeAxisDef"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public TimeAxisDef Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<TimeAxisDef>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="TimeAxisDef"/> that lives for the lifetime of its
        ...
        {
            /// <summary>
            /// Gets the JSON property name for <see cref="Levels"/>.
            /// </summary>
            ...
            /// Gets the JSON property name for <see cref="Levels"/>.
            /// </summary>
            public static ReadOnlySpan<byte> LevelsUtf8 => "levels"u8;
        }
