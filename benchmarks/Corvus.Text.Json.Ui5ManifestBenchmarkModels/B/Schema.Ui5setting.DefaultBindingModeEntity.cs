...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Ui5setting
    {
        ...
        public readonly partial struct DefaultBindingModeEntity
#if NET8_0_OR_GREATER
            : IJsonElement<DefaultBindingModeEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="DefaultBindingModeEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal DefaultBindingModeEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static DefaultBindingModeEntity DefaultInstance { get; } = ParsedJsonDocument<DefaultBindingModeEntity>.StringConstant([.."\"Default\""u8]);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(DefaultBindingModeEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in DefaultBindingModeEntity left, in DefaultBindingModeEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in DefaultBindingModeEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(DefaultBindingModeEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DefaultBindingModeEntity(JsonElement instance)
            {
                return DefaultBindingModeEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DefaultBindingModeEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DefaultBindingModeEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DefaultBindingModeEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DefaultBindingModeEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DefaultBindingModeEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DefaultBindingModeEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DefaultBindingModeEntity>(json, options);
            }
            ...
            /// </exception>
            public static DefaultBindingModeEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<DefaultBindingModeEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out DefaultBindingModeEntity? result)
            {
                return JsonElementHelpers.TryParseValue<DefaultBindingModeEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new DefaultBindingModeEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static DefaultBindingModeEntity IJsonElement<DefaultBindingModeEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DefaultBindingModeEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="DefaultBindingModeEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="DefaultBindingModeEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public DefaultBindingModeEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<DefaultBindingModeEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="DefaultBindingModeEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public DefaultBindingModeEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<DefaultBindingModeEntity>(_idx);
                }
            ...
            /// <param name="matchDefault">Match 1st item.</param>
            /// <param name="matchOneTime">Match 2nd item.</param>
            /// <param name="matchOneWay">Match 3rd item.</param>
            /// <param name="matchTwoWay">Match 4th item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchDefault,
                Func<TContext, TResult> matchOneTime,
                Func<TContext, TResult> matchOneWay,
                Func<TContext, TResult> matchTwoWay,
...
#endif
            {
                ...
                {
                    return matchDefault(context);
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchOneTime(context);
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchOneWay(context);
                }

                if (this.ValueEquals(Constants.Enum4))
                {
                    return matchTwoWay(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchDefault,
                Func<TResult> matchOneTime,
                Func<TResult> matchOneWay,
                Func<TResult> matchTwoWay,
