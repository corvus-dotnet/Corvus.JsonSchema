...
public readonly partial struct Schema
{
    ...
    public readonly partial struct Vendor
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Vendor instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Vendor"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Vendor(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Mutable LineOfBusiness
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LineOfBusinessUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Baseline.JsonUriTemplate.Mutable Url
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UrlUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.JsonUriTemplate.Mutable value))
                    {
                        return value;
                    }
            ...
            /// <summary>
            /// Set the <c>lineOfBusiness</c> property.
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetLineOfBusiness(in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.LineOfBusinessUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LineOfBusinessUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsProperty(JsonPropertyNamesEscaped.LineOfBusiness, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// <summary>
            /// Remove the <c>lineOfBusiness</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveLineOfBusiness()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.LineOfBusinessUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetUrl(in Corvus.Ui5ManifestBenchmark.Baseline.JsonUriTemplate.Source value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Vendor.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly Vendor Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Vendor>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Baseline.Schema.Vendor.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(Vendor instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.Schema.Vendor.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="Vendor"/>.
            /// </summary>
            internal static void Create(
                ...
                in Corvus.Ui5ManifestBenchmark.Baseline.JsonUriTemplate.Source url,
                in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source lineOfBusiness = default)
            {
                ...
                lineOfBusiness.AddAsProperty(JsonPropertyNamesEscaped.LineOfBusiness, ref builder, escapeName: false);
            }
            ...
            public void Create(
                ...
                in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source lineOfBusiness = default)
            {
                Create(ref _builder, id, name, url, lineOfBusiness);
            }
        ...
        /// <param name="lineOfBusiness">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source id, in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source name, in Corvus.Ui5ManifestBenchmark.Baseline.JsonUriTemplate.Source url, in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source lineOfBusiness = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(id, name, url, lineOfBusiness);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<Vendor, Mutable>(this);
        }
    }
}
