...
public readonly partial struct Spacing
{
...
#endif
    {
        ...
        /// <summary>
        /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Spacing.AnyOf0Entity"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.Spacing.AnyOf0Entity.Mutable(Mutable value)
        {
            return Corvus.Ui5ManifestBenchmark.Baseline.Spacing.AnyOf0Entity.Mutable.From(value);
        }

        /// <summary>
        /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Spacing.AnyOf0Entity"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Baseline.Spacing.AnyOf0Entity.Mutable value)
        {
            return From(value);
        }

        /// <summary>
        /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Spacing.AnyOf1Entity"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.Spacing.AnyOf1Entity.Mutable(Mutable value)
        {
            return Corvus.Ui5ManifestBenchmark.Baseline.Spacing.AnyOf1Entity.Mutable.From(value);
        }

        /// <summary>
        /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Spacing.AnyOf1Entity"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Baseline.Spacing.AnyOf1Entity.Mutable value)
        {
            return From(value);
        }
        ...
        public static explicit operator Mutable(Spacing instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="Spacing"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Spacing(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new Spacing(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Spacing.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="Spacing"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="Spacing"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly Spacing Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<Spacing>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="Spacing"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly Spacing Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<Spacing>(_idx);
        }
        ...
        /// <param name="matchAnyOf0Entity">Match a <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Spacing.AnyOf0Entity"/>.</param>
        /// <param name="matchAnyOf1Entity">Match a <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Spacing.AnyOf1Entity"/>.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Spacing.AnyOf0Entity, TContext, TResult> matchAnyOf0Entity,
            Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Spacing.AnyOf1Entity, TContext, TResult> matchAnyOf1Entity,
            Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Spacing.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
        where TContext : allows ref struct
#endif
        {
            if (Corvus.Ui5ManifestBenchmark.Baseline.Spacing.AnyOf0Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchAnyOf0Entity(Corvus.Ui5ManifestBenchmark.Baseline.Spacing.AnyOf0Entity.Mutable.From(this), context);
            }

            if (Corvus.Ui5ManifestBenchmark.Baseline.Spacing.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchAnyOf1Entity(Corvus.Ui5ManifestBenchmark.Baseline.Spacing.AnyOf1Entity.Mutable.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Spacing.AnyOf0Entity, TResult> matchAnyOf0Entity,
            Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Spacing.AnyOf1Entity, TResult> matchAnyOf1Entity,
            Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Spacing.Mutable, TResult> defaultMatch)
        {
            if (Corvus.Ui5ManifestBenchmark.Baseline.Spacing.AnyOf0Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchAnyOf0Entity(Corvus.Ui5ManifestBenchmark.Baseline.Spacing.AnyOf0Entity.Mutable.From(this));
            }

            if (Corvus.Ui5ManifestBenchmark.Baseline.Spacing.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchAnyOf1Entity(Corvus.Ui5ManifestBenchmark.Baseline.Spacing.AnyOf1Entity.Mutable.From(this));
            }
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Spacing.AnyOf0Entity" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsAnyOf0Entity(out Corvus.Ui5ManifestBenchmark.Baseline.Spacing.AnyOf0Entity result)
        {
            if (Corvus.Ui5ManifestBenchmark.Baseline.Spacing.AnyOf0Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.Ui5ManifestBenchmark.Baseline.Spacing.AnyOf0Entity.Mutable.From(this);
                return true;
            }
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Baseline.Spacing.AnyOf1Entity" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsAnyOf1Entity(out Corvus.Ui5ManifestBenchmark.Baseline.Spacing.AnyOf1Entity result)
        {
            if (Corvus.Ui5ManifestBenchmark.Baseline.Spacing.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.Ui5ManifestBenchmark.Baseline.Spacing.AnyOf1Entity.Mutable.From(this);
                return true;
            }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(Spacing instance) => new(JsonElement.From(instance));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Baseline.Spacing.AnyOf0Entity instance) => new(JsonElement.From(instance));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Baseline.Spacing.AnyOf1Entity instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<Spacing, Mutable>(this);
    }
}
