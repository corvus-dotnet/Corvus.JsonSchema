...
public readonly partial struct Table
{
    ...
    public readonly partial struct GridStyleEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(GridStyleEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="GridStyleEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator GridStyleEntity(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new GridStyleEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"GridStyleEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="GridStyleEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="GridStyleEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly GridStyleEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<GridStyleEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="GridStyleEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly GridStyleEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<GridStyleEntity>(_idx);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Table.GridStyleEntity.Mutable, TContext, TResult> defaultMatch)
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.Table.GridStyleEntity.Mutable, TResult> defaultMatch)
            {
                if (Corvus.Ui5ManifestBenchmark.Baseline.ContainerStyle.JsonSchema.Evaluate(_parent, _idx))
                {
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(GridStyleEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<GridStyleEntity, Mutable>(this);
        }
    }
}
