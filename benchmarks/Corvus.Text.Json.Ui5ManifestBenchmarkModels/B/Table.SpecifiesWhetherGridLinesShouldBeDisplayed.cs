...
public readonly partial struct Table
{
    ...
    public readonly partial struct SpecifiesWhetherGridLinesShouldBeDisplayed
        ...
        : IJsonElement<SpecifiesWhetherGridLinesShouldBeDisplayed>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SpecifiesWhetherGridLinesShouldBeDisplayed"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal SpecifiesWhetherGridLinesShouldBeDisplayed(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static SpecifiesWhetherGridLinesShouldBeDisplayed DefaultInstance { get; } = ParsedJsonDocument<SpecifiesWhetherGridLinesShouldBeDisplayed>.True;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator bool(SpecifiesWhetherGridLinesShouldBeDisplayed value)
        {
        ...
        /// </returns>
        public static bool operator ==(in SpecifiesWhetherGridLinesShouldBeDisplayed left, in SpecifiesWhetherGridLinesShouldBeDisplayed right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in SpecifiesWhetherGridLinesShouldBeDisplayed left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(SpecifiesWhetherGridLinesShouldBeDisplayed instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator SpecifiesWhetherGridLinesShouldBeDisplayed(JsonElement instance)
        {
            return SpecifiesWhetherGridLinesShouldBeDisplayed.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SpecifiesWhetherGridLinesShouldBeDisplayed From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SpecifiesWhetherGridLinesShouldBeDisplayed ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SpecifiesWhetherGridLinesShouldBeDisplayed>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SpecifiesWhetherGridLinesShouldBeDisplayed ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SpecifiesWhetherGridLinesShouldBeDisplayed>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SpecifiesWhetherGridLinesShouldBeDisplayed ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SpecifiesWhetherGridLinesShouldBeDisplayed>(json, options);
        }
        ...
        /// </exception>
        public static SpecifiesWhetherGridLinesShouldBeDisplayed ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<SpecifiesWhetherGridLinesShouldBeDisplayed>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out SpecifiesWhetherGridLinesShouldBeDisplayed? result)
        {
            return JsonElementHelpers.TryParseValue<SpecifiesWhetherGridLinesShouldBeDisplayed>(ref reader, out result);
        }
...
#if NET
        static SpecifiesWhetherGridLinesShouldBeDisplayed IJsonElement<SpecifiesWhetherGridLinesShouldBeDisplayed>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"SpecifiesWhetherGridLinesShouldBeDisplayed: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public SpecifiesWhetherGridLinesShouldBeDisplayed Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public SpecifiesWhetherGridLinesShouldBeDisplayed Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<SpecifiesWhetherGridLinesShouldBeDisplayed>(_idx);
            }
