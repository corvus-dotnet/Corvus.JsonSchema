...
public readonly partial struct Table
{
    ...
    public readonly partial struct TableColumnDefinitionArray
#if NET8_0_OR_GREATER
        : IJsonElement<TableColumnDefinitionArray>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TableColumnDefinitionArray"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal TableColumnDefinitionArray(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static TableColumnDefinitionArray DefaultInstance { get; }
        ...
        public Corvus.Ui5ManifestBenchmark.Baseline.TableColumnDefinition this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Ui5ManifestBenchmark.Baseline.TableColumnDefinition>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.TableColumnDefinition> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Baseline.TableColumnDefinition>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in TableColumnDefinitionArray left, in TableColumnDefinitionArray right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in TableColumnDefinitionArray left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(TableColumnDefinitionArray instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TableColumnDefinitionArray(JsonElement instance)
        {
            return TableColumnDefinitionArray.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TableColumnDefinitionArray From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TableColumnDefinitionArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TableColumnDefinitionArray>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TableColumnDefinitionArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TableColumnDefinitionArray>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TableColumnDefinitionArray ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TableColumnDefinitionArray>(json, options);
        }
        ...
        /// </exception>
        public static TableColumnDefinitionArray ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<TableColumnDefinitionArray>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out TableColumnDefinitionArray? result)
        {
            return JsonElementHelpers.TryParseValue<TableColumnDefinitionArray>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new TableColumnDefinitionArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static TableColumnDefinitionArray IJsonElement<TableColumnDefinitionArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TableColumnDefinitionArray: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="TableColumnDefinitionArray"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="TableColumnDefinitionArray"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public TableColumnDefinitionArray Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<TableColumnDefinitionArray>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="TableColumnDefinitionArray"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public TableColumnDefinitionArray Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<TableColumnDefinitionArray>(_idx);
            }
