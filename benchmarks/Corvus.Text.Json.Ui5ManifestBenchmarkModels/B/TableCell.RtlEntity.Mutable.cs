...
public readonly partial struct TableCell
{
    ...
    public readonly partial struct RtlEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(RtlEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="RtlEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RtlEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RtlEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly RtlEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly RtlEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<RtlEntity>(_idx);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.TableCell.RtlEntity.Mutable, TContext, TResult> defaultMatch)
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.TableCell.RtlEntity.Mutable, TResult> defaultMatch)
            {
                if (Corvus.Ui5ManifestBenchmark.Baseline.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                {
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(RtlEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<RtlEntity, Mutable>(this);
        }
    }
}
