...
public readonly partial struct TableColumnDefinition
{
    ...
    public readonly partial struct HorizontalCellContentAlignmentEntity
    {
...
#endif
        {
            ...
            public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.HorizontalAlignment.Mutable(Mutable value)
            {
                return Corvus.Ui5ManifestBenchmark.Baseline.HorizontalAlignment.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Baseline.HorizontalAlignment.Mutable value)
            {
                return From(value);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.TableColumnDefinition.HorizontalCellContentAlignmentEntity.Mutable, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                {
                    return matchHorizontalAlignment(Corvus.Ui5ManifestBenchmark.Baseline.HorizontalAlignment.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.TableColumnDefinition.HorizontalCellContentAlignmentEntity.Mutable, TResult> defaultMatch)
            {
                if (Corvus.Ui5ManifestBenchmark.Baseline.HorizontalAlignment.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchHorizontalAlignment(Corvus.Ui5ManifestBenchmark.Baseline.HorizontalAlignment.Mutable.From(this));
                }
            ...
            public bool TryGetAsHorizontalAlignment(out Corvus.Ui5ManifestBenchmark.Baseline.HorizontalAlignment result)
            {
                if (Corvus.Ui5ManifestBenchmark.Baseline.HorizontalAlignment.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Ui5ManifestBenchmark.Baseline.HorizontalAlignment.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Baseline.HorizontalAlignment instance) => new(JsonElement.From(instance));
