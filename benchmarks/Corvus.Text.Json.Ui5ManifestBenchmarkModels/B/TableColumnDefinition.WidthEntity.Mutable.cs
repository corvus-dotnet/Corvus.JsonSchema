...
public readonly partial struct TableColumnDefinition
{
    ...
    public readonly partial struct WidthEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(WidthEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="WidthEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator WidthEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"WidthEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly WidthEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly WidthEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<WidthEntity>(_idx);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.TableColumnDefinition.WidthEntity.Mutable, TContext, TResult> defaultMatch)
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.TableColumnDefinition.WidthEntity.Mutable, TResult> defaultMatch)
            {
                if (Corvus.Ui5ManifestBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(WidthEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<WidthEntity, Mutable>(this);
        }
    }
}
