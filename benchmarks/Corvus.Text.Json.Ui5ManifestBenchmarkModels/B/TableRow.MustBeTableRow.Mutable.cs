...
public readonly partial struct TableRow
{
    ...
    public readonly partial struct MustBeTableRow
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(MustBeTableRow instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MustBeTableRow"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MustBeTableRow(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MustBeTableRow.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeTableRow Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeTableRow Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MustBeTableRow>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(MustBeTableRow instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<MustBeTableRow, Mutable>(this);
        }
    }
}
