...
public readonly partial struct TableRow
{
    ...
    public readonly partial struct VerticalCellContentAlignmentEntity
    {
...
#endif
        {
            ...
            public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.VerticalAlignment.Mutable(Mutable value)
            {
                return Corvus.Ui5ManifestBenchmark.Baseline.VerticalAlignment.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Baseline.VerticalAlignment.Mutable value)
            {
                return From(value);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.TableRow.VerticalCellContentAlignmentEntity.Mutable, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                {
                    return matchVerticalAlignment(Corvus.Ui5ManifestBenchmark.Baseline.VerticalAlignment.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.TableRow.VerticalCellContentAlignmentEntity.Mutable, TResult> defaultMatch)
            {
                if (Corvus.Ui5ManifestBenchmark.Baseline.VerticalAlignment.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchVerticalAlignment(Corvus.Ui5ManifestBenchmark.Baseline.VerticalAlignment.Mutable.From(this));
                }
            ...
            public bool TryGetAsVerticalAlignment(out Corvus.Ui5ManifestBenchmark.Baseline.VerticalAlignment result)
            {
                if (Corvus.Ui5ManifestBenchmark.Baseline.VerticalAlignment.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Ui5ManifestBenchmark.Baseline.VerticalAlignment.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Baseline.VerticalAlignment instance) => new(JsonElement.From(instance));
