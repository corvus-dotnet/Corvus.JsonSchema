...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Corvus.Ui5ManifestBenchmark.Baseline.TableRow.TableCellArray Cells
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CellsUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.TableRow.TableCellArray value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Ui5ManifestBenchmark.Baseline.TableRow.HorizontalCellContentAlignmentEntity HorizontalCellContentAlignment
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HorizontalCellContentAlignmentUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.TableRow.HorizontalCellContentAlignmentEntity value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Ui5ManifestBenchmark.Baseline.TableRow.DefinesTheStyleOfTheEntireRow Style
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StyleUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.TableRow.DefinesTheStyleOfTheEntireRow value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Ui5ManifestBenchmark.Baseline.TableRow.MustBeTableRow Type
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.TableRow.MustBeTableRow value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Ui5ManifestBenchmark.Baseline.TableRow.VerticalCellContentAlignmentEntity VerticalCellContentAlignment
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VerticalCellContentAlignmentUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.TableRow.VerticalCellContentAlignmentEntity value))
            {
                return value;
            }
