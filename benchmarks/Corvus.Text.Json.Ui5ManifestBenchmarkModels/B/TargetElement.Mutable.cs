...
public readonly partial struct TargetElement
{
...
#endif
    {
        ...
        /// <summary>
        /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId.Mutable(Mutable value)
        {
            return Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId.Mutable.From(value);
        }

        /// <summary>
        /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId.Mutable value)
        {
            return From(value);
        }
        ...
        public static explicit operator Mutable(TargetElement instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="TargetElement"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TargetElement(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TargetElement.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly TargetElement Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly TargetElement Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<TargetElement>(_idx);
        }
        ...
        /// <param name="matchRequiredElementId">Match a <see cref="Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId"/>.</param>
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId, TContext, TResult> matchRequiredElementId,
            Matcher<Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.Mutable, TContext, TResult> defaultMatch)
...
#endif
        {
            ...
            if (Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredElementId(Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId.Mutable.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId, TResult> matchRequiredElementId,
            Matcher<Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.Mutable, TResult> defaultMatch)
        {
            if (Corvus.Ui5ManifestBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
            {
            ...
            if (Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredElementId(Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId.Mutable.From(this));
            }
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsRequiredElementId(out Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId result)
        {
            if (Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId.Mutable.From(this);
                return true;
            }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId.Builder.Build? _requiredElementIdBuilderInstance;
        ...
        public Source(Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId.Builder.Build value) {_requiredElementIdBuilderInstance = value; _kind = Kind.RequiredElementIdBuilder; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId instance) => new(JsonElement.From(instance));
        ...
        internal void AddAsProperty(ReadOnlySpan<byte> utf8Name, ref ComplexValueBuilder valueBuilder, bool escapeName = true, bool nameRequiresUnescaping = false)
        {
            switch(_kind)
            {
                ...
                case Kind.RequiredElementIdBuilder:
                    valueBuilder.AddProperty(utf8Name, _requiredElementIdBuilderInstance!, static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId.Builder.BuildValue(b, ref o), escapeName, nameRequiresUnescaping);
                    break;
                default:
        ...
        internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
        {
            switch(_kind)
            {
                ...
                case Kind.Utf16String:
                    ...
                    break;
                case Kind.RequiredElementIdBuilder:
                    valueBuilder.AddProperty(name, _requiredElementIdBuilderInstance!, static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId.Builder.BuildValue(b, ref o));
                    break;
                default:
                    Debug.Fail("Unexpected Kind");
                    break;
        ...
        internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
        {
            switch(_kind)
            {
                ...
                case Kind.Utf16String:
                    ...
                    break;
                case Kind.RequiredElementIdBuilder:
                    valueBuilder.AddItem(_requiredElementIdBuilderInstance!, static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId.Builder.BuildValue(b, ref o));
                    break;
                default:
                    Debug.Fail("Unexpected Kind");
                    break;
        ...
        #endif
    {
        ...
        TContext _context;
        Source _source;
        private readonly Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId.Builder.Build<TContext>? _requiredElementIdBuilderInstance;
        ...
        public Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId.Builder.Build<TContext> value) {_context = context; _requiredElementIdBuilderInstance = value; _kind = Kind.RequiredElementIdBuilder; }
        ...
        internal void AddAsProperty(ReadOnlySpan<byte> utf8Name, ref ComplexValueBuilder valueBuilder, bool escapeName = true, bool nameRequiresUnescaping = false)
        {
            switch(_kind)
            {
                ...
                case Kind.Source:
                    ...
                    break;
                case Kind.RequiredElementIdBuilder:
                    valueBuilder.AddProperty(utf8Name, BuildWithContext.Create(_context, _requiredElementIdBuilderInstance!), static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId.Builder.BuildValue(b.Context, b.Build, ref o), escapeName, nameRequiresUnescaping);
                    break;
                default:
                    Debug.Fail("Unexpected Kind");
                    break;
        ...
        internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
        {
            switch(_kind)
            {
                ...
                case Kind.Source:
                    ...
                    break;
                case Kind.RequiredElementIdBuilder:
                    valueBuilder.AddProperty(name, BuildWithContext.Create(_context, _requiredElementIdBuilderInstance!), static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId.Builder.BuildValue(b.Context, b.Build, ref o));
                    break;
                default:
                    Debug.Fail("Unexpected Kind");
                    break;
        ...
        internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
        {
            switch(_kind)
            {
                ...
                case Kind.Source:
                    ...
                    break;
                case Kind.RequiredElementIdBuilder:
                    valueBuilder.AddItem(BuildWithContext.Create(_context, _requiredElementIdBuilderInstance!), static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId.Builder.BuildValue(b.Context, b.Build, ref o));
                    break;
                default:
                    Debug.Fail("Unexpected Kind");
                    break;
    ...
    public static Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId.Source Build(
        scoped in Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId.Builder.Build buildValue, int initialCapacity = 1)
    {
        return new Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId.Source(buildValue);
    }
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId.Source<TContext> Build<TContext>(
        scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId.Builder.Build<TContext> buildValue, int initialCapacity = 1)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        return new Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId.Source<TContext>(context, buildValue);
    }
    ...
    /// <returns>An instance of a mutable document initialized with the given value.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(
        JsonWorkspace workspace, scoped in Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
    {
        // Create the document builder without a MetadataDb
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        var source = new Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId.Source(value);
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(
        JsonWorkspace workspace, scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        ...
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        var source = new Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId.Source<TContext>(context, value);
        source.AddAsItem(ref cvb);
        Debug.Assert(cvb.MemberCount == 1);
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<TargetElement, Mutable>(this);
    }
}
