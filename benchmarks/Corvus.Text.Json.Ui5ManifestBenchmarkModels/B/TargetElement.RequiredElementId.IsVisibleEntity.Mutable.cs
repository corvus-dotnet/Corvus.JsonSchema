...
public readonly partial struct TargetElement
{
    ...
    public readonly partial struct RequiredElementId
    {
        ...
        public readonly partial struct IsVisibleEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(IsVisibleEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="IsVisibleEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator IsVisibleEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new IsVisibleEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"IsVisibleEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="IsVisibleEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="IsVisibleEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly IsVisibleEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<IsVisibleEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="IsVisibleEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly IsVisibleEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<IsVisibleEntity>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId.IsVisibleEntity.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId.IsVisibleEntity.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Baseline.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(IsVisibleEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<IsVisibleEntity, Mutable>(this);
            }
        }
    }
}
