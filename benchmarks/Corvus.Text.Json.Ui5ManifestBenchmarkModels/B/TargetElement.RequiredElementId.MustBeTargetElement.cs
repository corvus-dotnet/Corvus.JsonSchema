...
public readonly partial struct TargetElement
{
    ...
    public readonly partial struct RequiredElementId
    {
        ...
        public readonly partial struct MustBeTargetElement
#if NET8_0_OR_GREATER
            : IJsonElement<MustBeTargetElement>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="MustBeTargetElement"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal MustBeTargetElement(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static MustBeTargetElement DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(MustBeTargetElement value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in MustBeTargetElement left, in MustBeTargetElement right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in MustBeTargetElement left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(MustBeTargetElement instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MustBeTargetElement(JsonElement instance)
            {
                return MustBeTargetElement.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MustBeTargetElement From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MustBeTargetElement ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MustBeTargetElement>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MustBeTargetElement ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MustBeTargetElement>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MustBeTargetElement ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MustBeTargetElement>(json, options);
            }
            ...
            /// </exception>
            public static MustBeTargetElement ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<MustBeTargetElement>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out MustBeTargetElement? result)
            {
                return JsonElementHelpers.TryParseValue<MustBeTargetElement>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new MustBeTargetElement(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static MustBeTargetElement IJsonElement<MustBeTargetElement>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MustBeTargetElement: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="MustBeTargetElement"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="MustBeTargetElement"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public MustBeTargetElement Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<MustBeTargetElement>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="MustBeTargetElement"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public MustBeTargetElement Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<MustBeTargetElement>(_idx);
                }
