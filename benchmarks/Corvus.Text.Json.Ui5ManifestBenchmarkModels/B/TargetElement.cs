...
#endif
{
    ...
    public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId(TargetElement value)
    {
        return Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId.From(value);
    }
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator TargetElement(Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId value)
    {
        return From(value);
    }
    ...
    public bool TryGetAsRequiredElementId(out Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId result)
    {
        ...
        {
            result = Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId.From(this);
            return true;
        }
    ...
    public TResult Match<TContext, TResult>(
        ...
        Matcher<Corvus.Ui5ManifestBenchmark.Baseline.TargetElement, TContext, TResult> defaultMatch)
...
#endif
    {
        ...
        if (Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId.JsonSchema.Evaluate(_parent, _idx))
        {
            return matchRequiredElementId(Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId.From(this), context);
        }
    ...
    public TResult Match<TResult>(
        ...
        Matcher<Corvus.Ui5ManifestBenchmark.Baseline.TargetElement, TResult> defaultMatch)
    {
        if (Corvus.Ui5ManifestBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
        {
        ...
        if (Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId.JsonSchema.Evaluate(_parent, _idx))
        {
            return matchRequiredElementId(Corvus.Ui5ManifestBenchmark.Baseline.TargetElement.RequiredElementId.From(this));
        }
