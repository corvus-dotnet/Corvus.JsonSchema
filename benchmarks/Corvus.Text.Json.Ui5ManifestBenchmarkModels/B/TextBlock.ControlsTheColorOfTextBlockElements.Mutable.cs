...
public readonly partial struct TextBlock
{
    ...
    public readonly partial struct ControlsTheColorOfTextBlockElements
    {
...
#endif
        {
            ...
            public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.Colors.Mutable(Mutable value)
            {
                return Corvus.Ui5ManifestBenchmark.Baseline.Colors.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Baseline.Colors.Mutable value)
            {
                return From(value);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.TextBlock.ControlsTheColorOfTextBlockElements.Mutable, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                {
                    return matchColors(Corvus.Ui5ManifestBenchmark.Baseline.Colors.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.TextBlock.ControlsTheColorOfTextBlockElements.Mutable, TResult> defaultMatch)
            {
                if (Corvus.Ui5ManifestBenchmark.Baseline.Colors.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchColors(Corvus.Ui5ManifestBenchmark.Baseline.Colors.Mutable.From(this));
                }
            ...
            public bool TryGetAsColors(out Corvus.Ui5ManifestBenchmark.Baseline.Colors result)
            {
                if (Corvus.Ui5ManifestBenchmark.Baseline.Colors.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Ui5ManifestBenchmark.Baseline.Colors.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Baseline.Colors instance) => new(JsonElement.From(instance));
