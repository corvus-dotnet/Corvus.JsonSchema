...
public readonly partial struct TextBlock
{
    ...
    public readonly partial struct ControlsTheWeightOfTextBlockElements
    {
...
#endif
        {
            ...
            /// <summary>
            /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Baseline.FontWeight"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.FontWeight.Mutable(Mutable value)
            {
                return Corvus.Ui5ManifestBenchmark.Baseline.FontWeight.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Baseline.FontWeight"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Baseline.FontWeight.Mutable value)
            {
                return From(value);
            }

            /// <summary>
            /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Baseline.FontWeight.AnyOf0Entity"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.FontWeight.AnyOf0Entity.Mutable(Mutable value)
            {
                return Corvus.Ui5ManifestBenchmark.Baseline.FontWeight.AnyOf0Entity.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Baseline.FontWeight.AnyOf0Entity"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Baseline.FontWeight.AnyOf0Entity.Mutable value)
            {
                return From(value);
            }

            /// <summary>
            /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Baseline.FontWeight.AnyOf1Entity"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.FontWeight.AnyOf1Entity.Mutable(Mutable value)
            {
                return Corvus.Ui5ManifestBenchmark.Baseline.FontWeight.AnyOf1Entity.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Baseline.FontWeight.AnyOf1Entity"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Baseline.FontWeight.AnyOf1Entity.Mutable value)
            {
                return From(value);
            }
            ...
            public static explicit operator Mutable(ControlsTheWeightOfTextBlockElements instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ControlsTheWeightOfTextBlockElements"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ControlsTheWeightOfTextBlockElements(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ControlsTheWeightOfTextBlockElements(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ControlsTheWeightOfTextBlockElements.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ControlsTheWeightOfTextBlockElements"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ControlsTheWeightOfTextBlockElements"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly ControlsTheWeightOfTextBlockElements Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ControlsTheWeightOfTextBlockElements>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ControlsTheWeightOfTextBlockElements"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly ControlsTheWeightOfTextBlockElements Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ControlsTheWeightOfTextBlockElements>(_idx);
            }
            ...
            /// <param name="matchFontWeight">Match a <see cref="Corvus.Ui5ManifestBenchmark.Baseline.FontWeight"/>.</param>
            ...
            public TResult Match<TContext, TResult>(
                in TContext context,
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.FontWeight, TContext, TResult> matchFontWeight,
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.JsonNull, TContext, TResult> matchJsonNull,
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.TextBlock.ControlsTheWeightOfTextBlockElements.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
            {
                if (Corvus.Ui5ManifestBenchmark.Baseline.FontWeight.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchFontWeight(Corvus.Ui5ManifestBenchmark.Baseline.FontWeight.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.FontWeight, TResult> matchFontWeight,
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.JsonNull, TResult> matchJsonNull,
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.TextBlock.ControlsTheWeightOfTextBlockElements.Mutable, TResult> defaultMatch)
            {
                if (Corvus.Ui5ManifestBenchmark.Baseline.FontWeight.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchFontWeight(Corvus.Ui5ManifestBenchmark.Baseline.FontWeight.Mutable.From(this));
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Baseline.FontWeight" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsFontWeight(out Corvus.Ui5ManifestBenchmark.Baseline.FontWeight result)
            {
                if (Corvus.Ui5ManifestBenchmark.Baseline.FontWeight.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Ui5ManifestBenchmark.Baseline.FontWeight.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ControlsTheWeightOfTextBlockElements instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Baseline.FontWeight instance) => new(JsonElement.From(instance));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Baseline.FontWeight.AnyOf0Entity instance) => new(JsonElement.From(instance));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Baseline.FontWeight.AnyOf1Entity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<ControlsTheWeightOfTextBlockElements, Mutable>(this);
        }
    }
}
