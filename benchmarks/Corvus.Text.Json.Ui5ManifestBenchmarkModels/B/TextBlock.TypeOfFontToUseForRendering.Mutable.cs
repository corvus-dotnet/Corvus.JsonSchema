...
public readonly partial struct TextBlock
{
    ...
    public readonly partial struct TypeOfFontToUseForRendering
    {
...
#endif
        {
            ...
            /// <summary>
            /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Baseline.FontType"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.FontType.Mutable(Mutable value)
            {
                return Corvus.Ui5ManifestBenchmark.Baseline.FontType.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Baseline.FontType"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Baseline.FontType.Mutable value)
            {
                return From(value);
            }

            /// <summary>
            /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Baseline.FontType.AnyOf0Entity"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.FontType.AnyOf0Entity.Mutable(Mutable value)
            {
                return Corvus.Ui5ManifestBenchmark.Baseline.FontType.AnyOf0Entity.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Baseline.FontType.AnyOf0Entity"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Baseline.FontType.AnyOf0Entity.Mutable value)
            {
                return From(value);
            }

            /// <summary>
            /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Baseline.FontType.AnyOf1Entity"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.FontType.AnyOf1Entity.Mutable(Mutable value)
            {
                return Corvus.Ui5ManifestBenchmark.Baseline.FontType.AnyOf1Entity.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Baseline.FontType.AnyOf1Entity"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Baseline.FontType.AnyOf1Entity.Mutable value)
            {
                return From(value);
            }
            ...
            public static explicit operator Mutable(TypeOfFontToUseForRendering instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="TypeOfFontToUseForRendering"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TypeOfFontToUseForRendering(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TypeOfFontToUseForRendering.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly TypeOfFontToUseForRendering Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly TypeOfFontToUseForRendering Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<TypeOfFontToUseForRendering>(_idx);
            }
            ...
            /// <param name="matchFontType">Match a <see cref="Corvus.Ui5ManifestBenchmark.Baseline.FontType"/>.</param>
            ...
            public TResult Match<TContext, TResult>(
                in TContext context,
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.FontType, TContext, TResult> matchFontType,
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.JsonNull, TContext, TResult> matchJsonNull,
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.TextBlock.TypeOfFontToUseForRendering.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
            {
                if (Corvus.Ui5ManifestBenchmark.Baseline.FontType.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchFontType(Corvus.Ui5ManifestBenchmark.Baseline.FontType.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.FontType, TResult> matchFontType,
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.JsonNull, TResult> matchJsonNull,
                Matcher<Corvus.Ui5ManifestBenchmark.Baseline.TextBlock.TypeOfFontToUseForRendering.Mutable, TResult> defaultMatch)
            {
                if (Corvus.Ui5ManifestBenchmark.Baseline.FontType.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchFontType(Corvus.Ui5ManifestBenchmark.Baseline.FontType.Mutable.From(this));
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Baseline.FontType" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsFontType(out Corvus.Ui5ManifestBenchmark.Baseline.FontType result)
            {
                if (Corvus.Ui5ManifestBenchmark.Baseline.FontType.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Ui5ManifestBenchmark.Baseline.FontType.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(TypeOfFontToUseForRendering instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Baseline.FontType instance) => new(JsonElement.From(instance));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Baseline.FontType.AnyOf0Entity instance) => new(JsonElement.From(instance));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Baseline.FontType.AnyOf1Entity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<TypeOfFontToUseForRendering, Mutable>(this);
        }
    }
}
