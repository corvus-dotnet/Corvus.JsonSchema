...
public readonly partial struct TextRun
{
...
#endif
    {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText.Mutable value)
        {
            return From(value);
        }
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Baseline.TextRun.Mutable, TContext, TResult> defaultMatch)
...
#endif
        {
            ...
            {
                return matchRequiredText(Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText.Mutable.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Baseline.TextRun.Mutable, TResult> defaultMatch)
        {
            if (Corvus.Ui5ManifestBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
            {
            ...
            if (Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredText(Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText.Mutable.From(this));
            }
        ...
        public bool TryGetAsRequiredText(out Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText result)
        {
            if (Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText.Mutable.From(this);
                return true;
            }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText.Builder.Build? _requiredTextBuilderInstance;
        ...
        public Source(Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText.Builder.Build value) {_requiredTextBuilderInstance = value; _kind = Kind.RequiredTextBuilder; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText instance) => new(JsonElement.From(instance));
        ...
        internal void AddAsProperty(ReadOnlySpan<byte> utf8Name, ref ComplexValueBuilder valueBuilder, bool escapeName = true, bool nameRequiresUnescaping = false)
        {
            switch(_kind)
            {
                ...
                case Kind.RequiredTextBuilder:
                    valueBuilder.AddProperty(utf8Name, _requiredTextBuilderInstance!, static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText.Builder.BuildValue(b, ref o), escapeName, nameRequiresUnescaping);
                    break;
                default:
        ...
        internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
        {
            switch(_kind)
            {
                ...
                case Kind.Utf16String:
                    ...
                    break;
                case Kind.RequiredTextBuilder:
                    valueBuilder.AddProperty(name, _requiredTextBuilderInstance!, static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText.Builder.BuildValue(b, ref o));
                    break;
                default:
                    Debug.Fail("Unexpected Kind");
                    break;
        ...
        internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
        {
            switch(_kind)
            {
                ...
                case Kind.Utf16String:
                    ...
                    break;
                case Kind.RequiredTextBuilder:
                    valueBuilder.AddItem(_requiredTextBuilderInstance!, static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText.Builder.BuildValue(b, ref o));
                    break;
                default:
                    Debug.Fail("Unexpected Kind");
                    break;
        ...
        #endif
    {
        ...
        TContext _context;
        Source _source;
        private readonly Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText.Builder.Build<TContext>? _requiredTextBuilderInstance;
        ...
        public Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText.Builder.Build<TContext> value) {_context = context; _requiredTextBuilderInstance = value; _kind = Kind.RequiredTextBuilder; }
        ...
        internal void AddAsProperty(ReadOnlySpan<byte> utf8Name, ref ComplexValueBuilder valueBuilder, bool escapeName = true, bool nameRequiresUnescaping = false)
        {
            switch(_kind)
            {
                ...
                case Kind.Source:
                    ...
                    break;
                case Kind.RequiredTextBuilder:
                    valueBuilder.AddProperty(utf8Name, BuildWithContext.Create(_context, _requiredTextBuilderInstance!), static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText.Builder.BuildValue(b.Context, b.Build, ref o), escapeName, nameRequiresUnescaping);
                    break;
                default:
                    Debug.Fail("Unexpected Kind");
                    break;
        ...
        internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
        {
            switch(_kind)
            {
                ...
                case Kind.Source:
                    ...
                    break;
                case Kind.RequiredTextBuilder:
                    valueBuilder.AddProperty(name, BuildWithContext.Create(_context, _requiredTextBuilderInstance!), static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText.Builder.BuildValue(b.Context, b.Build, ref o));
                    break;
                default:
                    Debug.Fail("Unexpected Kind");
                    break;
        ...
        internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
        {
            switch(_kind)
            {
                ...
                case Kind.Source:
                    ...
                    break;
                case Kind.RequiredTextBuilder:
                    valueBuilder.AddItem(BuildWithContext.Create(_context, _requiredTextBuilderInstance!), static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText.Builder.BuildValue(b.Context, b.Build, ref o));
                    break;
                default:
                    Debug.Fail("Unexpected Kind");
                    break;
    ...
    public static Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText.Source Build(
        scoped in Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText.Builder.Build buildValue, int initialCapacity = 1)
    {
        return new Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText.Source(buildValue);
    }
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText.Source<TContext> Build<TContext>(
        scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText.Builder.Build<TContext> buildValue, int initialCapacity = 1)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        return new Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText.Source<TContext>(context, buildValue);
    }
    ...
    /// <returns>An instance of a mutable document initialized with the given value.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(
        JsonWorkspace workspace, scoped in Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
    {
        // Create the document builder without a MetadataDb
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        var source = new Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText.Source(value);
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(
        JsonWorkspace workspace, scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        ...
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        var source = new Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText.Source<TContext>(context, value);
        source.AddAsItem(ref cvb);
        Debug.Assert(cvb.MemberCount == 1);
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
