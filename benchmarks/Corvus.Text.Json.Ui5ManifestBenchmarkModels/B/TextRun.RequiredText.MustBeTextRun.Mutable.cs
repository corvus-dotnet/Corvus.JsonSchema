...
public readonly partial struct TextRun
{
    ...
    public readonly partial struct RequiredText
    {
        ...
        public readonly partial struct MustBeTextRun
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(MustBeTextRun instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="MustBeTextRun"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator MustBeTextRun(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new MustBeTextRun(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"MustBeTextRun.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="MustBeTextRun"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="MustBeTextRun"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly MustBeTextRun Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<MustBeTextRun>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="MustBeTextRun"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly MustBeTextRun Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<MustBeTextRun>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(MustBeTextRun instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<MustBeTextRun, Mutable>(this);
            }
        }
    }
}
