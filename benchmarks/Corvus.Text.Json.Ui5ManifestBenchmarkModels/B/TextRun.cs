...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="TextRun"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal TextRun(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static TextRun DefaultInstance { get; }
    ...
    /// <summary>
    /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText"/>.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static explicit operator Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText(TextRun value)
    {
        return Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText.From(value);
    }

    /// <summary>
    /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText"/>.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator TextRun(Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText value)
    {
        return From(value);
    }
    ...
    /// </returns>
    public static bool operator ==(in TextRun left, in TextRun right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in TextRun left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator JsonElement(TextRun instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator TextRun(JsonElement instance)
    {
        return TextRun.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TextRun From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TextRun ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<TextRun>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TextRun ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<TextRun>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TextRun ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<TextRun>(json, options);
    }
    ...
    /// </exception>
    public static TextRun ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<TextRun>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out TextRun? result)
    {
        return JsonElementHelpers.TryParseValue<TextRun>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new TextRun(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static TextRun IJsonElement<TextRun>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"TextRun: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="TextRun"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="TextRun"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    {
        CheckValidInstance();
        return _parent.CloneElement<TextRun>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="TextRun"/> that lives for the lifetime of its
    ...
    /// <summary>
    /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText" />.
    /// </summary>
    /// <param name="result">The result of the conversions.</param>
    /// <returns><see langword="true" /> if the conversion was valid.</returns>
    public bool TryGetAsRequiredText(out Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText result)
    {
        if (Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText.JsonSchema.Evaluate(_parent, _idx))
        {
            result = Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText.From(this);
            return true;
        }
    ...
    /// <param name="matchRequiredText">Match a <see cref="Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText"/>.</param>
    ...
    public TResult Match<TContext, TResult>(
        ...
        Matcher<Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText, TContext, TResult> matchRequiredText,
        Matcher<Corvus.Ui5ManifestBenchmark.Baseline.TextRun, TContext, TResult> defaultMatch)
...
#endif
    {
        ...
        if (Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText.JsonSchema.Evaluate(_parent, _idx))
        {
            return matchRequiredText(Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText.From(this), context);
        }
    ...
    public TResult Match<TResult>(
        ...
        Matcher<Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText, TResult> matchRequiredText,
        Matcher<Corvus.Ui5ManifestBenchmark.Baseline.TextRun, TResult> defaultMatch)
    {
        if (Corvus.Ui5ManifestBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
        {
        ...
        if (Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText.JsonSchema.Evaluate(_parent, _idx))
        {
            return matchRequiredText(Corvus.Ui5ManifestBenchmark.Baseline.TextRun.RequiredText.From(this));
        }
