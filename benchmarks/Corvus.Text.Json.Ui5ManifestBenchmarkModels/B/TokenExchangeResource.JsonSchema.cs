...
public readonly partial struct TokenExchangeResource
    : IJsonElement<TokenExchangeResource>
{
    public static partial class JsonSchema
    {
        ...
        private const uint RequiredBitForProviderId = 0b00000000000000000000000000000010;

        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyUriPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("uri"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyUriNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("uri"u8, buffer, out written);

        private const int RequiredOffsetForUri = 0;
        private const uint RequiredBitForUri = 0b00000000000000000000000000000100;

        private const uint RequiredBitMask0 =
            RequiredBitForId | RequiredBitForProviderId | RequiredBitForUri;
        ...
        private static void MatchType(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext2 =
                Corvus.Ui5ManifestBenchmark.Baseline.TokenExchangeResource.MustBeTokenExchangeResource.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.Ui5ManifestBenchmark.Baseline.TokenExchangeResource.MustBeTokenExchangeResource.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
            context.CommitChildContext(childContext2.IsMatch, ref childContext2);
        }

        private static void MatchUriValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            ...
            requiredBitBuffer[RequiredOffsetForUri] |= RequiredBitForUri;
        }
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://adaptivecards.io/schemas/adaptive-card.json#/definitions/TokenExchangeResource"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "https://adaptivecards.io/schemas/adaptive-card.json#/definitions/TokenExchangeResource";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://adaptivecards.io/schemas/adaptive-card.json#/definitions/TokenExchangeResource"u8;
            ...
            else
            {
                ...
                if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                {
                    if (context.HasCollector)
                    {
                        ...
                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyProviderIdPresent, "providerId"u8, "required"u8);
                        context.EvaluatedKeywordForProperty(true, 2, RequiredPropertyUriPresent, "uri"u8, "required"u8);
                    }
                }
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyProviderIdNotPresent, "providerId"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyProviderIdPresent, "providerId"u8, "required"u8);
                    ...
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForUri] & RequiredBitForUri) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 2, RequiredPropertyUriNotPresent, "uri"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 2, RequiredPropertyUriPresent, "uri"u8, "required"u8);
