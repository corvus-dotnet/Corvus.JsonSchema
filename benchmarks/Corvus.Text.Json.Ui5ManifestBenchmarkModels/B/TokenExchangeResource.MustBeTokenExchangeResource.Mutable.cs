...
public readonly partial struct TokenExchangeResource
{
    ...
    public readonly partial struct MustBeTokenExchangeResource
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(MustBeTokenExchangeResource instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MustBeTokenExchangeResource"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MustBeTokenExchangeResource(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new MustBeTokenExchangeResource(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MustBeTokenExchangeResource.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="MustBeTokenExchangeResource"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="MustBeTokenExchangeResource"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeTokenExchangeResource Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<MustBeTokenExchangeResource>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="MustBeTokenExchangeResource"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeTokenExchangeResource Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MustBeTokenExchangeResource>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(MustBeTokenExchangeResource instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<MustBeTokenExchangeResource, Mutable>(this);
        }
    }
}
