...
public readonly partial struct TokenExchangeResource
{
...
#endif
    {
        ...
        public static explicit operator Mutable(TokenExchangeResource instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="TokenExchangeResource"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TokenExchangeResource(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Mutable ProviderId
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ProviderIdUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Baseline.TokenExchangeResource.MustBeTokenExchangeResource.Mutable Type
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.TokenExchangeResource.MustBeTokenExchangeResource.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetProviderId(in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source value)
        {
            CheckValidInstance();
            ...
            {
                // We are going to insert the new value
                value.AddAsProperty(JsonPropertyNamesEscaped.ProviderId, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetType(in Corvus.Ui5ManifestBenchmark.Baseline.TokenExchangeResource.MustBeTokenExchangeResource.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TokenExchangeResource.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly TokenExchangeResource Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly TokenExchangeResource Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<TokenExchangeResource>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(Corvus.Ui5ManifestBenchmark.Baseline.TokenExchangeResource.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(TokenExchangeResource instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Baseline.TokenExchangeResource.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="TokenExchangeResource"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source id,
            in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source providerId,
            in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source uri,
            in Corvus.Ui5ManifestBenchmark.Baseline.TokenExchangeResource.MustBeTokenExchangeResource.Source type = default)
        {
            id.AddAsProperty(JsonPropertyNamesEscaped.Id, ref builder, escapeName: false);
            providerId.AddAsProperty(JsonPropertyNamesEscaped.ProviderId, ref builder, escapeName: false);
        ...
        public void Create(
            ...
            in Corvus.Ui5ManifestBenchmark.Baseline.TokenExchangeResource.MustBeTokenExchangeResource.Source type = default)
        {
            Create(ref _builder, id, providerId, uri, type);
        }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source id, in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source providerId, in Corvus.Ui5ManifestBenchmark.Baseline.JsonString.Source uri, in Corvus.Ui5ManifestBenchmark.Baseline.TokenExchangeResource.MustBeTokenExchangeResource.Source type = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(id, providerId, uri, type);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<TokenExchangeResource, Mutable>(this);
    }
}
