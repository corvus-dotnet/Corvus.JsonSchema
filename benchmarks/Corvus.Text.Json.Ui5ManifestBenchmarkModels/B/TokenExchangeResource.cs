...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Corvus.Ui5ManifestBenchmark.Baseline.JsonString ProviderId
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ProviderIdUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.JsonString value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Ui5ManifestBenchmark.Baseline.TokenExchangeResource.MustBeTokenExchangeResource Type
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Ui5ManifestBenchmark.Baseline.TokenExchangeResource.MustBeTokenExchangeResource value))
            {
                return value;
            }
