...
public readonly partial struct ActionExecute
{
    ...
    public readonly partial struct DataEntity
    {
...
#endif
        {
            ...
            public static explicit operator Corvus.Ui5ManifestBenchmark.Current.ActionExecute.DataEntity.AnyOf1Entity.Mutable(Mutable value)
            {
                return Corvus.Ui5ManifestBenchmark.Current.ActionExecute.DataEntity.AnyOf1Entity.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Current.ActionExecute.DataEntity.AnyOf1Entity.Mutable value)
            {
                return From(value);
            }
            ...
            /// </remarks>
            public void Apply(in Corvus.Ui5ManifestBenchmark.Current.ActionExecute.DataEntity.AnyOf1Entity value)
            {
                CheckValidInstance();
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.ActionExecute.DataEntity.Mutable, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                {
                    return matchAnyOf1Entity(Corvus.Ui5ManifestBenchmark.Current.ActionExecute.DataEntity.AnyOf1Entity.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.ActionExecute.DataEntity.Mutable, TResult> defaultMatch)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                ...
                if (Corvus.Ui5ManifestBenchmark.Current.ActionExecute.DataEntity.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchAnyOf1Entity(Corvus.Ui5ManifestBenchmark.Current.ActionExecute.DataEntity.AnyOf1Entity.Mutable.From(this));
                }
            ...
            public bool TryGetAsAnyOf1Entity(out Corvus.Ui5ManifestBenchmark.Current.ActionExecute.DataEntity.AnyOf1Entity result)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.ActionExecute.DataEntity.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Ui5ManifestBenchmark.Current.ActionExecute.DataEntity.AnyOf1Entity.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Current.ActionExecute.DataEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.ActionExecute.DataEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
