...
public readonly partial struct ActionExecute
{
...
#endif
    {
        ...
        public TAccumulator MatchEvery<TAccumulator>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.JsonObject, TAccumulator, TAccumulator> matchJsonObject,
            Matcher<Corvus.Ui5ManifestBenchmark.Current.ActionExecute.DataEntity, TAccumulator, TAccumulator> defaultMatch)
        {
            bool matched = false;
            ...
            {
                matched = true;
                accumulator = matchJsonObject(Corvus.Ui5ManifestBenchmark.Current.JsonObject.From(this), accumulator);
            }
