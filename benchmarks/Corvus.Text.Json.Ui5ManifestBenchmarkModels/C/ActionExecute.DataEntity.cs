...
public readonly partial struct ActionExecute
{
...
#endif
    {
        ...
        /// <summary>
        /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Current.ActionExecute.DataEntity.AnyOf1Entity"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.Ui5ManifestBenchmark.Current.ActionExecute.DataEntity.AnyOf1Entity(DataEntity value)
        {
            return Corvus.Ui5ManifestBenchmark.Current.ActionExecute.DataEntity.AnyOf1Entity.From(value);
        }

        /// <summary>
        /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Current.ActionExecute.DataEntity.AnyOf1Entity"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator DataEntity(Corvus.Ui5ManifestBenchmark.Current.ActionExecute.DataEntity.AnyOf1Entity value)
        {
            return From(value);
        }
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Current.ActionExecute.DataEntity.AnyOf1Entity" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsAnyOf1Entity(out Corvus.Ui5ManifestBenchmark.Current.ActionExecute.DataEntity.AnyOf1Entity result)
        {
            if (Corvus.Ui5ManifestBenchmark.Current.ActionExecute.DataEntity.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.Ui5ManifestBenchmark.Current.ActionExecute.DataEntity.AnyOf1Entity.From(this);
                return true;
            }
        ...
        /// <param name="matchAnyOf1Entity">Match a <see cref="Corvus.Ui5ManifestBenchmark.Current.ActionExecute.DataEntity.AnyOf1Entity"/>.</param>
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.ActionExecute.DataEntity.AnyOf1Entity, TContext, TResult> matchAnyOf1Entity,
            Matcher<Corvus.Ui5ManifestBenchmark.Current.ActionExecute.DataEntity, TContext, TResult> defaultMatch)
...
#endif
        {
            ...
            if (Corvus.Ui5ManifestBenchmark.Current.ActionExecute.DataEntity.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchAnyOf1Entity(Corvus.Ui5ManifestBenchmark.Current.ActionExecute.DataEntity.AnyOf1Entity.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.ActionExecute.DataEntity.AnyOf1Entity, TResult> matchAnyOf1Entity,
            Matcher<Corvus.Ui5ManifestBenchmark.Current.ActionExecute.DataEntity, TResult> defaultMatch)
        {
            if (Corvus.Ui5ManifestBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
            {
            ...
            if (Corvus.Ui5ManifestBenchmark.Current.ActionExecute.DataEntity.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchAnyOf1Entity(Corvus.Ui5ManifestBenchmark.Current.ActionExecute.DataEntity.AnyOf1Entity.From(this));
            }
