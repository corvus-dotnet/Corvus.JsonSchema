...
public readonly partial struct ActionExecute
{
    ...
    public readonly partial struct MustBeActionExecute
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(MustBeActionExecute instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MustBeActionExecute"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MustBeActionExecute(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MustBeActionExecute.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeActionExecute Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeActionExecute Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MustBeActionExecute>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(MustBeActionExecute instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<MustBeActionExecute, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<MustBeActionExecute> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<MustBeActionExecute>();
            }
            finally
            {
