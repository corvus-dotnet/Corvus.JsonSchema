...
public readonly partial struct ActionMode
{
        ...
        : IJsonElement<AnyOf0Entity>
    {
        ...
        private static class Constants
        {
            ...
            /// </summary>
            public static readonly byte[] Enum1 = "primary"u8.ToArray();
            /// <summary>
            /// A constant for the <c>enum</c> keyword.
            /// </summary>
            public static readonly AnyOf0Entity EnumJson1 = ParsedJsonDocument<AnyOf0Entity>.StringConstant([.."\"primary\""u8]);
            /// <summary>
            /// A constant for the <c>enum</c> keyword.
            /// </summary>
            public static readonly byte[] Enum2 = "secondary"u8.ToArray();
            /// <summary>
            /// A constant for the <c>enum</c> keyword.
            /// </summary>
            public static readonly AnyOf0Entity EnumJson2 = ParsedJsonDocument<AnyOf0Entity>.StringConstant([.."\"secondary\""u8]);
        }
        ...
        {
            /// <summary>
            /// Gets the string "primary"
            /// as a <see cref="AnyOf0Entity"/>.
            /// </summary>
            public static AnyOf0Entity Primary { get; } = Constants.EnumJson1;
            /// <summary>
            /// Gets the string "primary"
            /// as a UTF8 byte array.
            /// </summary>
            public static ReadOnlySpan<byte> PrimaryUtf8 => Constants.Enum1;

            /// <summary>
            /// Gets the string "secondary"
            /// as a <see cref="AnyOf0Entity"/>.
            /// </summary>
            public static AnyOf0Entity Secondary { get; } = Constants.EnumJson2;
            /// <summary>
            /// Gets the string "secondary"
            /// as a UTF8 byte array.
            /// </summary>
            public static ReadOnlySpan<byte> SecondaryUtf8 => Constants.Enum2;
        }
        ...
        {
            /// <summary>
            /// Corresponds to the JSON string "primary".
            /// </summary>
            Primary = 0,
            /// <summary>
            /// Corresponds to the JSON string "secondary".
            /// </summary>
            Secondary = 1,
        }
        ...
        public static implicit operator AnyOf0Entity(KnownValues value)
        {
            return value switch
            {
                KnownValues.Primary => Constants.EnumJson1,
                KnownValues.Secondary => Constants.EnumJson2,
        ...
        public bool TryGetKnownValue(out KnownValues result)
        {
            ...
            {
                result = KnownValues.Primary;
                return true;
            }

            if (this.ValueEquals(Constants.Enum2))
            {
                result = KnownValues.Secondary;
                return true;
            }
        ...
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/https:~1~1adaptivecards.io~1schemas~1adaptive-card.json/definitions/ActionMode/anyOf/0"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated, as a JSON Pointer within <see cref="SchemaDocument"/>.
            /// </summary>
            public const string SchemaLocation = "/definitions/https:~1~1adaptivecards.io~1schemas~1adaptive-card.json/definitions/ActionMode/anyOf/0";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/https:~1~1adaptivecards.io~1schemas~1adaptive-card.json/definitions/ActionMode/anyOf/0"u8;
            ...
            private static readonly global::Corvus.Text.Json.RuntimeEvaluator.JsonSchemaEvaluator Evaluator = global::Corvus.Ui5ManifestBenchmark.Current.CorvusJsonSchemaProgram.Entry(870);
