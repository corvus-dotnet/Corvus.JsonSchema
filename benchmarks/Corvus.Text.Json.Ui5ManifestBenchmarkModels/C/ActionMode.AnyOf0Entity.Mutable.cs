...
public readonly partial struct ActionMode
{
    ...
    public readonly partial struct AnyOf0Entity
    {
...
#endif
        {
            ...
            /// <param name="matchPrimary">Match 1st item.</param>
            /// <param name="matchSecondary">Match 2nd item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchPrimary,
                Func<TContext, TResult> matchSecondary,
...
#endif
            {
                ...
                {
                    return matchPrimary(context);
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchSecondary(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchPrimary,
                Func<TResult> matchSecondary,
