...
public readonly partial struct ActionOpenUrl
{
...
#endif
    {
        ...
        public static explicit operator Mutable(ActionOpenUrl instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="ActionOpenUrl"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ActionOpenUrl(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.ActionOpenUrl.MustBeActionOpenUrl.Mutable Type
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Ui5ManifestBenchmark.Current.ActionOpenUrl.MustBeActionOpenUrl.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ActionOpenUrl(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ActionOpenUrl.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ActionOpenUrl"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ActionOpenUrl"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly ActionOpenUrl Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ActionOpenUrl>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ActionOpenUrl"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly ActionOpenUrl Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<ActionOpenUrl>(_idx);
        }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Ui5ManifestBenchmark.Current.ActionOpenUrl.MustBeActionOpenUrl.Source _createArg11;
        ...
        public static implicit operator Source(ActionOpenUrl instance) => new(JsonElement.From(instance));
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="ActionOpenUrl"/>.
        /// </summary>
        internal static void Create(
            ...
            in Corvus.Ui5ManifestBenchmark.Current.ActionOpenUrl.MustBeActionOpenUrl.Source type = default)
        {
        ...
        public void Create(
            ...
            in Corvus.Ui5ManifestBenchmark.Current.ActionOpenUrl.MustBeActionOpenUrl.Source type = default)
        {
            Create(ref _builder, url, fallback, iconUrl, id, isEnabled, mode, requires, style, title, tooltip, type);
        }
        ...
        #endif
        {
            Create(context, ref _builder, url, fallback, iconUrl, id, isEnabled, mode, requires, style, title, tooltip, type);
        }
    ...
    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonUriReference.Source url, scoped in Corvus.Text.Json.JsonElement.Source<TContext> fallback = default, scoped in Corvus.Text.Json.JsonElement.Source<TContext> iconUrl = default, scoped in Corvus.Text.Json.JsonElement.Source<TContext> id = default, scoped in Corvus.Text.Json.JsonElement.Source<TContext> isEnabled = default, scoped in Corvus.Text.Json.JsonElement.Source<TContext> mode = default, scoped in Corvus.Text.Json.JsonElement.Source<TContext> requires = default, scoped in Corvus.Text.Json.JsonElement.Source<TContext> style = default, scoped in Corvus.Text.Json.JsonElement.Source<TContext> title = default, scoped in Corvus.Text.Json.JsonElement.Source<TContext> tooltip = default, scoped in Corvus.Ui5ManifestBenchmark.Current.ActionOpenUrl.MustBeActionOpenUrl.Source type = default)
        ...
        #endif
    {
        return new Source<TContext>(context, url, fallback, iconUrl, id, isEnabled, mode, requires, style, title, tooltip, type);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.JsonUriReference.Source url, in Corvus.Text.Json.JsonElement.Source fallback = default, in Corvus.Text.Json.JsonElement.Source iconUrl = default, in Corvus.Text.Json.JsonElement.Source id = default, in Corvus.Text.Json.JsonElement.Source isEnabled = default, in Corvus.Text.Json.JsonElement.Source mode = default, in Corvus.Text.Json.JsonElement.Source requires = default, in Corvus.Text.Json.JsonElement.Source style = default, in Corvus.Text.Json.JsonElement.Source title = default, in Corvus.Text.Json.JsonElement.Source tooltip = default, in Corvus.Ui5ManifestBenchmark.Current.ActionOpenUrl.MustBeActionOpenUrl.Source type = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(url, fallback, iconUrl, id, isEnabled, mode, requires, style, title, tooltip, type);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Ui5ManifestBenchmark.Current.JsonUriReference.Source url, in Corvus.Text.Json.JsonElement.Source<TContext> fallback = default, in Corvus.Text.Json.JsonElement.Source<TContext> iconUrl = default, in Corvus.Text.Json.JsonElement.Source<TContext> id = default, in Corvus.Text.Json.JsonElement.Source<TContext> isEnabled = default, in Corvus.Text.Json.JsonElement.Source<TContext> mode = default, in Corvus.Text.Json.JsonElement.Source<TContext> requires = default, in Corvus.Text.Json.JsonElement.Source<TContext> style = default, in Corvus.Text.Json.JsonElement.Source<TContext> title = default, in Corvus.Text.Json.JsonElement.Source<TContext> tooltip = default, in Corvus.Ui5ManifestBenchmark.Current.ActionOpenUrl.MustBeActionOpenUrl.Source type = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, url, fallback, iconUrl, id, isEnabled, mode, requires, style, title, tooltip, type);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<ActionOpenUrl, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<ActionOpenUrl> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<ActionOpenUrl>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<ActionOpenUrl> Create<TContext>(
    ...
    public static ParsedJsonDocument<ActionOpenUrl> Create(in Corvus.Ui5ManifestBenchmark.Current.JsonUriReference.Source url, in Corvus.Text.Json.JsonElement.Source fallback = default, in Corvus.Text.Json.JsonElement.Source iconUrl = default, in Corvus.Text.Json.JsonElement.Source id = default, in Corvus.Text.Json.JsonElement.Source isEnabled = default, in Corvus.Text.Json.JsonElement.Source mode = default, in Corvus.Text.Json.JsonElement.Source requires = default, in Corvus.Text.Json.JsonElement.Source style = default, in Corvus.Text.Json.JsonElement.Source title = default, in Corvus.Text.Json.JsonElement.Source tooltip = default, in Corvus.Ui5ManifestBenchmark.Current.ActionOpenUrl.MustBeActionOpenUrl.Source type = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<ActionOpenUrl> Create<TContext>(in TContext context, in Corvus.Ui5ManifestBenchmark.Current.JsonUriReference.Source url, in Corvus.Text.Json.JsonElement.Source<TContext> fallback = default, in Corvus.Text.Json.JsonElement.Source<TContext> iconUrl = default, in Corvus.Text.Json.JsonElement.Source<TContext> id = default, in Corvus.Text.Json.JsonElement.Source<TContext> isEnabled = default, in Corvus.Text.Json.JsonElement.Source<TContext> mode = default, in Corvus.Text.Json.JsonElement.Source<TContext> requires = default, in Corvus.Text.Json.JsonElement.Source<TContext> style = default, in Corvus.Text.Json.JsonElement.Source<TContext> title = default, in Corvus.Text.Json.JsonElement.Source<TContext> tooltip = default, in Corvus.Ui5ManifestBenchmark.Current.ActionOpenUrl.MustBeActionOpenUrl.Source type = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
