...
public readonly partial struct ActionShowCard
{
    ...
    public readonly partial struct MustBeActionShowCard
#if NET8_0_OR_GREATER
        : IJsonElement<MustBeActionShowCard>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MustBeActionShowCard"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal MustBeActionShowCard(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static MustBeActionShowCard DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(MustBeActionShowCard value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in MustBeActionShowCard left, in MustBeActionShowCard right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in MustBeActionShowCard left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(MustBeActionShowCard instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator MustBeActionShowCard(JsonElement instance)
        {
            return MustBeActionShowCard.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MustBeActionShowCard From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MustBeActionShowCard ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<MustBeActionShowCard>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MustBeActionShowCard ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<MustBeActionShowCard>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MustBeActionShowCard ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<MustBeActionShowCard>(json, options);
        }
        ...
        /// </exception>
        public static MustBeActionShowCard ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<MustBeActionShowCard>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out MustBeActionShowCard? result)
        {
            return JsonElementHelpers.TryParseValue<MustBeActionShowCard>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new MustBeActionShowCard(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static MustBeActionShowCard IJsonElement<MustBeActionShowCard>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"MustBeActionShowCard: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="MustBeActionShowCard"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="MustBeActionShowCard"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public MustBeActionShowCard Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<MustBeActionShowCard>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="MustBeActionShowCard"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public MustBeActionShowCard Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<MustBeActionShowCard>(_idx);
            }
