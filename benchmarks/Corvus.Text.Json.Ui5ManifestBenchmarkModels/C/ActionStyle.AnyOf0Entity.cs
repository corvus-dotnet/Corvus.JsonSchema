...
public readonly partial struct ActionStyle
{
...
#endif
    {
        ...
        /// <param name="matchPositive">Match 2nd item.</param>
        /// <param name="matchDestructive">Match 3rd item.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Func<TContext, TResult> matchDefault,
            Func<TContext, TResult> matchPositive,
            Func<TContext, TResult> matchDestructive,
...
#endif
        {
            ...
            {
                return matchPositive(context);
            }

            if (this.ValueEquals(Constants.Enum3))
            {
                return matchDestructive(context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Func<TResult> matchPositive,
            Func<TResult> matchDestructive,
