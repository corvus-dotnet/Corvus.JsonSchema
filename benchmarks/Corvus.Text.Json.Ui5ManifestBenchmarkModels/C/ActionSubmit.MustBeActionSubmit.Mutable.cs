...
public readonly partial struct ActionSubmit
{
    ...
    public readonly partial struct MustBeActionSubmit
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(MustBeActionSubmit instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MustBeActionSubmit"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MustBeActionSubmit(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MustBeActionSubmit.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeActionSubmit Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeActionSubmit Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MustBeActionSubmit>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(MustBeActionSubmit instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<MustBeActionSubmit, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<MustBeActionSubmit> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<MustBeActionSubmit>();
            }
            finally
            {
