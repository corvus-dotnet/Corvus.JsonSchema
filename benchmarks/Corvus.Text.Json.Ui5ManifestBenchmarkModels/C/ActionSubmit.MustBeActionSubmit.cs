...
public readonly partial struct ActionSubmit
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MustBeActionSubmit"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal MustBeActionSubmit(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static MustBeActionSubmit DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(MustBeActionSubmit value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in MustBeActionSubmit left, in MustBeActionSubmit right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in MustBeActionSubmit left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(MustBeActionSubmit instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator MustBeActionSubmit(JsonElement instance)
        {
            return MustBeActionSubmit.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MustBeActionSubmit From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MustBeActionSubmit ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<MustBeActionSubmit>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MustBeActionSubmit ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<MustBeActionSubmit>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MustBeActionSubmit ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<MustBeActionSubmit>(json, options);
        }
        ...
        /// </exception>
        public static MustBeActionSubmit ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<MustBeActionSubmit>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out MustBeActionSubmit? result)
        {
            return JsonElementHelpers.TryParseValue<MustBeActionSubmit>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new MustBeActionSubmit(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static MustBeActionSubmit IJsonElement<MustBeActionSubmit>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"MustBeActionSubmit: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="MustBeActionSubmit"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="MustBeActionSubmit"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public MustBeActionSubmit Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<MustBeActionSubmit>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="MustBeActionSubmit"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public MustBeActionSubmit Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<MustBeActionSubmit>(_idx);
            }
