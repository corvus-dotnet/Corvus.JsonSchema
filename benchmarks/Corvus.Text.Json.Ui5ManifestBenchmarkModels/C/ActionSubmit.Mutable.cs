...
public readonly partial struct ActionSubmit
{
...
#endif
    {
        ...
        public static explicit operator Mutable(ActionSubmit instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="ActionSubmit"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ActionSubmit(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ActionSubmit(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ActionSubmit.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ActionSubmit"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ActionSubmit"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly ActionSubmit Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ActionSubmit>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ActionSubmit"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly ActionSubmit Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<ActionSubmit>(_idx);
        }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Ui5ManifestBenchmark.Current.AssociatedInputs.Source _createArg1;
        private readonly Corvus.Ui5ManifestBenchmark.Current.ActionSubmit.DataEntity.Source _createArg2;
        ...
        private readonly Corvus.Ui5ManifestBenchmark.Current.ActionSubmit.MustBeActionSubmit.Source _createArg12;
        ...
        public static implicit operator Source(ActionSubmit instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        private readonly Corvus.Ui5ManifestBenchmark.Current.AssociatedInputs.Source _createArg1;
        private readonly Corvus.Ui5ManifestBenchmark.Current.ActionSubmit.DataEntity.Source<TContext> _createArg2;
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="ActionSubmit"/>.
        /// </summary>
        internal static void Create(
            ...
            in Corvus.Ui5ManifestBenchmark.Current.ActionSubmit.MustBeActionSubmit.Source type = default)
        {
        ...
        public void Create(
            ...
            in Corvus.Ui5ManifestBenchmark.Current.ActionSubmit.MustBeActionSubmit.Source type = default)
        {
            Create(ref _builder, associatedInputs, data, fallback, iconUrl, id, isEnabled, mode, requires, style, title, tooltip, type);
        }
        ...
        #endif
        {
            Create(context, ref _builder, associatedInputs, data, fallback, iconUrl, id, isEnabled, mode, requires, style, title, tooltip, type);
        }
    ...
    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Current.AssociatedInputs.Source associatedInputs = default, scoped in Corvus.Ui5ManifestBenchmark.Current.ActionSubmit.DataEntity.Source<TContext> data = default, scoped in Corvus.Text.Json.JsonElement.Source<TContext> fallback = default, scoped in Corvus.Text.Json.JsonElement.Source<TContext> iconUrl = default, scoped in Corvus.Text.Json.JsonElement.Source<TContext> id = default, scoped in Corvus.Text.Json.JsonElement.Source<TContext> isEnabled = default, scoped in Corvus.Text.Json.JsonElement.Source<TContext> mode = default, scoped in Corvus.Text.Json.JsonElement.Source<TContext> requires = default, scoped in Corvus.Text.Json.JsonElement.Source<TContext> style = default, scoped in Corvus.Text.Json.JsonElement.Source<TContext> title = default, scoped in Corvus.Text.Json.JsonElement.Source<TContext> tooltip = default, scoped in Corvus.Ui5ManifestBenchmark.Current.ActionSubmit.MustBeActionSubmit.Source type = default)
        ...
        #endif
    {
        return new Source<TContext>(context, associatedInputs, data, fallback, iconUrl, id, isEnabled, mode, requires, style, title, tooltip, type);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.AssociatedInputs.Source associatedInputs = default, in Corvus.Ui5ManifestBenchmark.Current.ActionSubmit.DataEntity.Source data = default, in Corvus.Text.Json.JsonElement.Source fallback = default, in Corvus.Text.Json.JsonElement.Source iconUrl = default, in Corvus.Text.Json.JsonElement.Source id = default, in Corvus.Text.Json.JsonElement.Source isEnabled = default, in Corvus.Text.Json.JsonElement.Source mode = default, in Corvus.Text.Json.JsonElement.Source requires = default, in Corvus.Text.Json.JsonElement.Source style = default, in Corvus.Text.Json.JsonElement.Source title = default, in Corvus.Text.Json.JsonElement.Source tooltip = default, in Corvus.Ui5ManifestBenchmark.Current.ActionSubmit.MustBeActionSubmit.Source type = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(associatedInputs, data, fallback, iconUrl, id, isEnabled, mode, requires, style, title, tooltip, type);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Ui5ManifestBenchmark.Current.AssociatedInputs.Source associatedInputs = default, in Corvus.Ui5ManifestBenchmark.Current.ActionSubmit.DataEntity.Source<TContext> data = default, in Corvus.Text.Json.JsonElement.Source<TContext> fallback = default, in Corvus.Text.Json.JsonElement.Source<TContext> iconUrl = default, in Corvus.Text.Json.JsonElement.Source<TContext> id = default, in Corvus.Text.Json.JsonElement.Source<TContext> isEnabled = default, in Corvus.Text.Json.JsonElement.Source<TContext> mode = default, in Corvus.Text.Json.JsonElement.Source<TContext> requires = default, in Corvus.Text.Json.JsonElement.Source<TContext> style = default, in Corvus.Text.Json.JsonElement.Source<TContext> title = default, in Corvus.Text.Json.JsonElement.Source<TContext> tooltip = default, in Corvus.Ui5ManifestBenchmark.Current.ActionSubmit.MustBeActionSubmit.Source type = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        ...
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(context, associatedInputs, data, fallback, iconUrl, id, isEnabled, mode, requires, style, title, tooltip, type);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<ActionSubmit, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<ActionSubmit> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<ActionSubmit>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<ActionSubmit> Create<TContext>(
    ...
    public static ParsedJsonDocument<ActionSubmit> Create(in Corvus.Ui5ManifestBenchmark.Current.AssociatedInputs.Source associatedInputs = default, in Corvus.Ui5ManifestBenchmark.Current.ActionSubmit.DataEntity.Source data = default, in Corvus.Text.Json.JsonElement.Source fallback = default, in Corvus.Text.Json.JsonElement.Source iconUrl = default, in Corvus.Text.Json.JsonElement.Source id = default, in Corvus.Text.Json.JsonElement.Source isEnabled = default, in Corvus.Text.Json.JsonElement.Source mode = default, in Corvus.Text.Json.JsonElement.Source requires = default, in Corvus.Text.Json.JsonElement.Source style = default, in Corvus.Text.Json.JsonElement.Source title = default, in Corvus.Text.Json.JsonElement.Source tooltip = default, in Corvus.Ui5ManifestBenchmark.Current.ActionSubmit.MustBeActionSubmit.Source type = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<ActionSubmit> Create<TContext>(in TContext context, in Corvus.Ui5ManifestBenchmark.Current.AssociatedInputs.Source associatedInputs = default, in Corvus.Ui5ManifestBenchmark.Current.ActionSubmit.DataEntity.Source<TContext> data = default, in Corvus.Text.Json.JsonElement.Source<TContext> fallback = default, in Corvus.Text.Json.JsonElement.Source<TContext> iconUrl = default, in Corvus.Text.Json.JsonElement.Source<TContext> id = default, in Corvus.Text.Json.JsonElement.Source<TContext> isEnabled = default, in Corvus.Text.Json.JsonElement.Source<TContext> mode = default, in Corvus.Text.Json.JsonElement.Source<TContext> requires = default, in Corvus.Text.Json.JsonElement.Source<TContext> style = default, in Corvus.Text.Json.JsonElement.Source<TContext> title = default, in Corvus.Text.Json.JsonElement.Source<TContext> tooltip = default, in Corvus.Ui5ManifestBenchmark.Current.ActionSubmit.MustBeActionSubmit.Source type = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
