...
public readonly partial struct ActionToggleVisibility
{
    ...
    public readonly partial struct MustBeActionToggleVisibility
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(MustBeActionToggleVisibility instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MustBeActionToggleVisibility"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MustBeActionToggleVisibility(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MustBeActionToggleVisibility.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeActionToggleVisibility Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeActionToggleVisibility Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MustBeActionToggleVisibility>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(MustBeActionToggleVisibility instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<MustBeActionToggleVisibility, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<MustBeActionToggleVisibility> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<MustBeActionToggleVisibility>();
            }
            finally
            {
