...
public readonly partial struct AdaptiveCard
{
...
#endif
    {
        ...
        public Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfAction this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfAction>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfAction> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfAction>(_parent, _idx);
        }
