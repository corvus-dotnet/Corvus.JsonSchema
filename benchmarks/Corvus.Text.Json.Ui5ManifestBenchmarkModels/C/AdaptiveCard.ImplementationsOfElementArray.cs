...
public readonly partial struct AdaptiveCard
{
...
#endif
    {
        ...
        public Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfElement this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfElement>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfElement> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfElement>(_parent, _idx);
        }
