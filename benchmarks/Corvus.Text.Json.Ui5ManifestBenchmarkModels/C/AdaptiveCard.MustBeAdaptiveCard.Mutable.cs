...
public readonly partial struct AdaptiveCard
{
    ...
    public readonly partial struct MustBeAdaptiveCard
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(MustBeAdaptiveCard instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MustBeAdaptiveCard"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MustBeAdaptiveCard(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MustBeAdaptiveCard.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeAdaptiveCard Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeAdaptiveCard Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MustBeAdaptiveCard>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(MustBeAdaptiveCard instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<MustBeAdaptiveCard, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<MustBeAdaptiveCard> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<MustBeAdaptiveCard>();
            }
            finally
            {
