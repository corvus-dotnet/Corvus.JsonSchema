    ...
    public readonly partial struct SpecifiesTheBackgroundImageOfTheCard
    {
...
#endif
        {
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.AdaptiveCard.SpecifiesTheBackgroundImageOfTheCard.Mutable, TContext, TResult> defaultMatch)
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.AdaptiveCard.SpecifiesTheBackgroundImageOfTheCard.Mutable, TResult> defaultMatch)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.BackgroundImage.JsonSchema.Evaluate(_parent, _idx))
                {
            ...
            public TAccumulator MatchEvery<TAccumulator>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.AdaptiveCard.SpecifiesTheBackgroundImageOfTheCard.Mutable, TAccumulator, TAccumulator> defaultMatch)
            {
                bool matched = false;
        ...
        public static ParsedJsonDocument<SpecifiesTheBackgroundImageOfTheCard> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<SpecifiesTheBackgroundImageOfTheCard>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<SpecifiesTheBackgroundImageOfTheCard> Create<TContext>(
