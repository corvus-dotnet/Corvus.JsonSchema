...
public readonly partial struct AdaptiveCard
{
    ...
    public readonly partial struct SpecifiesTheBackgroundImageOfTheCard
#if NET8_0_OR_GREATER
        : IJsonElement<SpecifiesTheBackgroundImageOfTheCard>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SpecifiesTheBackgroundImageOfTheCard"/> struct.
        /// </summary>
        ...
        internal SpecifiesTheBackgroundImageOfTheCard(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static SpecifiesTheBackgroundImageOfTheCard DefaultInstance { get; }
        ...
        public static explicit operator Corvus.Ui5ManifestBenchmark.Current.BackgroundImage(SpecifiesTheBackgroundImageOfTheCard value)
        {
            return Corvus.Ui5ManifestBenchmark.Current.BackgroundImage.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator SpecifiesTheBackgroundImageOfTheCard(Corvus.Ui5ManifestBenchmark.Current.BackgroundImage value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator SpecifiesTheBackgroundImageOfTheCard(Corvus.Ui5ManifestBenchmark.Current.BackgroundImage.Mutable value)
        {
            return From(value);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(SpecifiesTheBackgroundImageOfTheCard value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Utf8UriReferenceValue(SpecifiesTheBackgroundImageOfTheCard value) => Utf8UriReferenceValue.TryGetValue(value._parent, value._idx, out Utf8UriReferenceValue result) ? result : throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in SpecifiesTheBackgroundImageOfTheCard left, in SpecifiesTheBackgroundImageOfTheCard right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in SpecifiesTheBackgroundImageOfTheCard left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(SpecifiesTheBackgroundImageOfTheCard instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator SpecifiesTheBackgroundImageOfTheCard(JsonElement instance)
        {
            return SpecifiesTheBackgroundImageOfTheCard.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SpecifiesTheBackgroundImageOfTheCard From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SpecifiesTheBackgroundImageOfTheCard ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<SpecifiesTheBackgroundImageOfTheCard>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SpecifiesTheBackgroundImageOfTheCard ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<SpecifiesTheBackgroundImageOfTheCard>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SpecifiesTheBackgroundImageOfTheCard ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<SpecifiesTheBackgroundImageOfTheCard>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static SpecifiesTheBackgroundImageOfTheCard ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<SpecifiesTheBackgroundImageOfTheCard>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out SpecifiesTheBackgroundImageOfTheCard? result)
        {
            return JsonElementHelpers.TryParseValue<SpecifiesTheBackgroundImageOfTheCard>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new SpecifiesTheBackgroundImageOfTheCard(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static SpecifiesTheBackgroundImageOfTheCard IJsonElement<SpecifiesTheBackgroundImageOfTheCard>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"SpecifiesTheBackgroundImageOfTheCard: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="SpecifiesTheBackgroundImageOfTheCard"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="SpecifiesTheBackgroundImageOfTheCard"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public SpecifiesTheBackgroundImageOfTheCard Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<SpecifiesTheBackgroundImageOfTheCard>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="SpecifiesTheBackgroundImageOfTheCard"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public SpecifiesTheBackgroundImageOfTheCard Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<SpecifiesTheBackgroundImageOfTheCard>(_idx);
            }
        ...
        public bool TryGetAsJsonUriReference(out Corvus.Ui5ManifestBenchmark.Current.JsonUriReference result)
        {
            ...
            {
                result = Corvus.Ui5ManifestBenchmark.Current.JsonUriReference.From(this);
                return true;
            }
        ...
        public bool TryGetAsBackgroundImage(out Corvus.Ui5ManifestBenchmark.Current.BackgroundImage result)
        {
            ...
            {
                result = Corvus.Ui5ManifestBenchmark.Current.BackgroundImage.From(this);
                return true;
            }
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.AdaptiveCard.SpecifiesTheBackgroundImageOfTheCard, TContext, TResult> defaultMatch)
...
#endif
        {
            if (Corvus.Ui5ManifestBenchmark.Current.BackgroundImage.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchBackgroundImage(Corvus.Ui5ManifestBenchmark.Current.BackgroundImage.From(this), context);
            }

            if (Corvus.Ui5ManifestBenchmark.Current.JsonUriReference.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchJsonUriReference(Corvus.Ui5ManifestBenchmark.Current.JsonUriReference.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.AdaptiveCard.SpecifiesTheBackgroundImageOfTheCard, TResult> defaultMatch)
        {
            if (Corvus.Ui5ManifestBenchmark.Current.BackgroundImage.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchBackgroundImage(Corvus.Ui5ManifestBenchmark.Current.BackgroundImage.From(this));
            }

            if (Corvus.Ui5ManifestBenchmark.Current.JsonUriReference.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchJsonUriReference(Corvus.Ui5ManifestBenchmark.Current.JsonUriReference.From(this));
            }
        ...
        public TAccumulator MatchEvery<TAccumulator>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.AdaptiveCard.SpecifiesTheBackgroundImageOfTheCard, TAccumulator, TAccumulator> defaultMatch)
        {
            bool matched = false;
