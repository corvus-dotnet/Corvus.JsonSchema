    ...
    : IJsonElement<AuthCardButton>
{
    public static partial class JsonSchema
    {
        ...
        private static void MatchImage(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
