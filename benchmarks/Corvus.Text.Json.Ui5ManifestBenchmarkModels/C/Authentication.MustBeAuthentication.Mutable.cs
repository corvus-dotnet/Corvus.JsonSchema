...
public readonly partial struct Authentication
{
    ...
    public readonly partial struct MustBeAuthentication
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(MustBeAuthentication instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MustBeAuthentication"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MustBeAuthentication(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MustBeAuthentication.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeAuthentication Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeAuthentication Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MustBeAuthentication>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(MustBeAuthentication instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<MustBeAuthentication, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<MustBeAuthentication> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<MustBeAuthentication>();
            }
            finally
            {
