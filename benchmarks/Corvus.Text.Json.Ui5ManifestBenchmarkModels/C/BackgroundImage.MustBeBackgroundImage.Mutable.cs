...
public readonly partial struct BackgroundImage
{
    ...
    public readonly partial struct MustBeBackgroundImage
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(MustBeBackgroundImage instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MustBeBackgroundImage"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MustBeBackgroundImage(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MustBeBackgroundImage.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeBackgroundImage Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeBackgroundImage Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MustBeBackgroundImage>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(MustBeBackgroundImage instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<MustBeBackgroundImage, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<MustBeBackgroundImage> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<MustBeBackgroundImage>();
            }
            finally
            {
