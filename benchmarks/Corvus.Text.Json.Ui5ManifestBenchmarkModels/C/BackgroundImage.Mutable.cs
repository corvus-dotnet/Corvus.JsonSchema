...
public readonly partial struct BackgroundImage
{
...
#endif
    {
        ...
        public static explicit operator Mutable(BackgroundImage instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="BackgroundImage"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator BackgroundImage(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.ImageFillMode.Mutable FillMode
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FillModeUtf8, out Corvus.Ui5ManifestBenchmark.Current.ImageFillMode.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment.Mutable HorizontalAlignment
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HorizontalAlignmentUtf8, out Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.BackgroundImage.MustBeBackgroundImage.Mutable Type
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Ui5ManifestBenchmark.Current.BackgroundImage.MustBeBackgroundImage.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.VerticalAlignment.Mutable VerticalAlignment
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VerticalAlignmentUtf8, out Corvus.Ui5ManifestBenchmark.Current.VerticalAlignment.Mutable value))
                {
                    return value;
                }
        ...
        public void SetFillMode(scoped in Corvus.Ui5ManifestBenchmark.Current.ImageFillMode.Source value)
        {
            ...
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.FillModeUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FillModeUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
        ...
        /// <summary>
        /// Remove the <c>fillMode</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveFillMode()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.FillModeUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        public void SetVerticalAlignment(scoped in Corvus.Ui5ManifestBenchmark.Current.VerticalAlignment.Source value)
        {
            ...
            if (value.IsUndefined)
            {
                JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.VerticalAlignmentUtf8);
                _documentVersion = _parent.Version;
                return;
            }

            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VerticalAlignmentUtf8, out IJsonDocument? elementParent, out int elementIdx))
            {
                // We are going to replace just the value
                value.AddAsItem(ref cvb);
                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
        ...
        /// <summary>
        /// Remove the <c>verticalAlignment</c> property, if present.
        /// </summary>
        /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
        public bool RemoveVerticalAlignment()
        {
            CheckValidInstance();
            bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.VerticalAlignmentUtf8);
            _documentVersion = _parent.Version;
            return result;
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"BackgroundImage.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly BackgroundImage Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly BackgroundImage Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<BackgroundImage>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Ui5ManifestBenchmark.Current.ImageFillMode.Source _createArg2;
        private readonly Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment.Source _createArg3;
        private readonly Corvus.Ui5ManifestBenchmark.Current.BackgroundImage.MustBeBackgroundImage.Source _createArg4;
        private readonly Corvus.Ui5ManifestBenchmark.Current.VerticalAlignment.Source _createArg5;
        ...
        public static implicit operator Source(BackgroundImage instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.BackgroundImage.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="BackgroundImage"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in Corvus.Ui5ManifestBenchmark.Current.JsonUriReference.Source url,
            in Corvus.Ui5ManifestBenchmark.Current.ImageFillMode.Source fillMode = default,
            in Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment.Source horizontalAlignment = default,
        ...
        public void Create(
            ...
            in Corvus.Ui5ManifestBenchmark.Current.VerticalAlignment.Source verticalAlignment = default)
        {
            Create(ref _builder, url, fillMode, horizontalAlignment, type, verticalAlignment);
        }
    ...
    /// <param name="fillMode">The value of the <c>"fillMode"</c> property.</param>
    ...
    /// <param name="fillMode">The value of the property.</param>
    /// <param name="horizontalAlignment">The value of the property.</param>
    /// <param name="type">The value of the property.</param>
    /// <param name="verticalAlignment">The value of the property.</param>
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.JsonUriReference.Source url, in Corvus.Ui5ManifestBenchmark.Current.ImageFillMode.Source fillMode = default, in Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment.Source horizontalAlignment = default, in Corvus.Ui5ManifestBenchmark.Current.BackgroundImage.MustBeBackgroundImage.Source type = default, in Corvus.Ui5ManifestBenchmark.Current.VerticalAlignment.Source verticalAlignment = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(url, fillMode, horizontalAlignment, type, verticalAlignment);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<BackgroundImage, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<BackgroundImage> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<BackgroundImage>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<BackgroundImage> Create<TContext>(
    ...
    public static ParsedJsonDocument<BackgroundImage> Create(in Corvus.Ui5ManifestBenchmark.Current.JsonUriReference.Source url, in Corvus.Ui5ManifestBenchmark.Current.ImageFillMode.Source fillMode = default, in Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment.Source horizontalAlignment = default, in Corvus.Ui5ManifestBenchmark.Current.BackgroundImage.MustBeBackgroundImage.Source type = default, in Corvus.Ui5ManifestBenchmark.Current.VerticalAlignment.Source verticalAlignment = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
