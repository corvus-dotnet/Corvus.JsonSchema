...
public readonly partial struct BlockElementHeight
{
...
#endif
    {
        ...
        public static explicit operator Mutable(BlockElementHeight instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="BlockElementHeight"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator BlockElementHeight(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"BlockElementHeight.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly BlockElementHeight Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly BlockElementHeight Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<BlockElementHeight>(_idx);
        }
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.Mutable, TContext, TResult> defaultMatch)
...
#endif
        {
            ...
            {
                return matchAnyOf0Entity(Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.AnyOf0Entity.Mutable.From(this), context);
            }

            if (Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchAnyOf1Entity(Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.AnyOf1Entity.Mutable.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.Mutable, TResult> defaultMatch)
        {
            if (Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.AnyOf0Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchAnyOf0Entity(Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.AnyOf0Entity.Mutable.From(this));
            }

            if (Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchAnyOf1Entity(Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.AnyOf1Entity.Mutable.From(this));
            }
        ...
        public TAccumulator MatchEvery<TAccumulator>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.Mutable, TAccumulator, TAccumulator> defaultMatch)
        {
            bool matched = false;
            ...
            {
                matched = true;
                accumulator = matchAnyOf0Entity(Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.AnyOf0Entity.Mutable.From(this), accumulator);
            }

            if (Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                matched = true;
                accumulator = matchAnyOf1Entity(Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.AnyOf1Entity.Mutable.From(this), accumulator);
            }
        ...
        public bool TryGetAsAnyOf0Entity(out Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.AnyOf0Entity.Mutable result)
        {
            if (Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.AnyOf0Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.AnyOf0Entity.Mutable.From(this);
                return true;
            }
        ...
        public bool TryGetAsAnyOf1Entity(out Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.AnyOf1Entity.Mutable result)
        {
            if (Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.AnyOf1Entity.Mutable.From(this);
                return true;
            }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(BlockElementHeight instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<BlockElementHeight, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<BlockElementHeight> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<BlockElementHeight>();
        }
        finally
        {
