...
public readonly partial struct ChoiceInputStyle
{
        ...
        : IJsonElement<AnyOf0Entity>
    {
        ...
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/https:~1~1adaptivecards.io~1schemas~1adaptive-card.json/definitions/ChoiceInputStyle/anyOf/0"u8, buffer, out written);
                ...
                ref JsonSchemaContext context)
            {
                ...
                if (tokenType == JsonTokenType.String)
                {
                    ...
                    if (unescapedUtf8JsonString.Span.SequenceEqual("expanded"u8))
                    {
                        goto enumShortCircuitSuccess;
                    }
                }
