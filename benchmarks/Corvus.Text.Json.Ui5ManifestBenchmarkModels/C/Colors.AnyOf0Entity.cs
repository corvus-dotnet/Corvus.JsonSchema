...
public readonly partial struct Colors
{
...
#endif
    {
        ...
        /// <param name="matchDark">Match 2nd item.</param>
        /// <param name="matchLight">Match 3rd item.</param>
        /// <param name="matchAccent">Match 4th item.</param>
        /// <param name="matchGood">Match 5th item.</param>
        /// <param name="matchWarning">Match 6th item.</param>
        /// <param name="matchAttention">Match 7th item.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Func<TContext, TResult> matchDefault,
            Func<TContext, TResult> matchDark,
            Func<TContext, TResult> matchLight,
...
#endif
        {
            ...
            {
                return matchDark(context);
            }

            if (this.ValueEquals(Constants.Enum3))
            {
                return matchLight(context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Func<TResult> matchDark,
            Func<TResult> matchLight,
