...
public readonly partial struct Colors
{
...
#endif
    {
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Colors.Mutable, TContext, TResult> defaultMatch)
...
#endif
        {
            ...
            {
                return matchAnyOf0Entity(Corvus.Ui5ManifestBenchmark.Current.Colors.AnyOf0Entity.Mutable.From(this), context);
            }

            if (Corvus.Ui5ManifestBenchmark.Current.Colors.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchAnyOf1Entity(Corvus.Ui5ManifestBenchmark.Current.Colors.AnyOf1Entity.Mutable.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Colors.Mutable, TResult> defaultMatch)
        {
            if (Corvus.Ui5ManifestBenchmark.Current.Colors.AnyOf0Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchAnyOf0Entity(Corvus.Ui5ManifestBenchmark.Current.Colors.AnyOf0Entity.Mutable.From(this));
            }

            if (Corvus.Ui5ManifestBenchmark.Current.Colors.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchAnyOf1Entity(Corvus.Ui5ManifestBenchmark.Current.Colors.AnyOf1Entity.Mutable.From(this));
            }
        ...
        public TAccumulator MatchEvery<TAccumulator>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Colors.Mutable, TAccumulator, TAccumulator> defaultMatch)
        {
            bool matched = false;
            ...
            {
                matched = true;
                accumulator = matchAnyOf0Entity(Corvus.Ui5ManifestBenchmark.Current.Colors.AnyOf0Entity.Mutable.From(this), accumulator);
            }

            if (Corvus.Ui5ManifestBenchmark.Current.Colors.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                matched = true;
                accumulator = matchAnyOf1Entity(Corvus.Ui5ManifestBenchmark.Current.Colors.AnyOf1Entity.Mutable.From(this), accumulator);
            }
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Current.Colors.AnyOf0Entity.Mutable" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsAnyOf0Entity(out Corvus.Ui5ManifestBenchmark.Current.Colors.AnyOf0Entity.Mutable result)
        {
            if (Corvus.Ui5ManifestBenchmark.Current.Colors.AnyOf0Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.Ui5ManifestBenchmark.Current.Colors.AnyOf0Entity.Mutable.From(this);
                return true;
            }
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Current.Colors.AnyOf1Entity.Mutable" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsAnyOf1Entity(out Corvus.Ui5ManifestBenchmark.Current.Colors.AnyOf1Entity.Mutable result)
        {
            if (Corvus.Ui5ManifestBenchmark.Current.Colors.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.Ui5ManifestBenchmark.Current.Colors.AnyOf1Entity.Mutable.From(this);
                return true;
            }
    ...
    public static ParsedJsonDocument<Colors> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<Colors>();
        }
        finally
        {
