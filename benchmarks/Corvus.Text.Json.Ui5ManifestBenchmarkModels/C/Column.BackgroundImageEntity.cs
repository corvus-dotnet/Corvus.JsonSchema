...
public readonly partial struct Column
{
    ...
    public readonly partial struct BackgroundImageEntity
        ...
        : IJsonElement<BackgroundImageEntity>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BackgroundImageEntity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal BackgroundImageEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static BackgroundImageEntity DefaultInstance { get; }
        ...
        public static explicit operator Corvus.Ui5ManifestBenchmark.Current.BackgroundImage(BackgroundImageEntity value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator BackgroundImageEntity(Corvus.Ui5ManifestBenchmark.Current.BackgroundImage value)
        {
            return From(value);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Utf8UriReferenceValue(BackgroundImageEntity value) => Utf8UriReferenceValue.TryGetValue(value._parent, value._idx, out Utf8UriReferenceValue result) ? result : throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in BackgroundImageEntity left, in BackgroundImageEntity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in BackgroundImageEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(BackgroundImageEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator BackgroundImageEntity(JsonElement instance)
        {
            return BackgroundImageEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BackgroundImageEntity From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BackgroundImageEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<BackgroundImageEntity>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BackgroundImageEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<BackgroundImageEntity>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BackgroundImageEntity ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<BackgroundImageEntity>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static BackgroundImageEntity ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<BackgroundImageEntity>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out BackgroundImageEntity? result)
        {
            return JsonElementHelpers.TryParseValue<BackgroundImageEntity>(ref reader, out result);
        }
...
#if NET
        static BackgroundImageEntity IJsonElement<BackgroundImageEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"BackgroundImageEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public BackgroundImageEntity Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public BackgroundImageEntity Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<BackgroundImageEntity>(_idx);
            }
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Column.BackgroundImageEntity, TContext, TResult> defaultMatch)
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Column.BackgroundImageEntity, TResult> defaultMatch)
        {
            if (Corvus.Ui5ManifestBenchmark.Current.BackgroundImage.JsonSchema.Evaluate(_parent, _idx))
            {
        ...
        public TAccumulator MatchEvery<TAccumulator>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Column.BackgroundImageEntity, TAccumulator, TAccumulator> defaultMatch)
        {
            bool matched = false;
