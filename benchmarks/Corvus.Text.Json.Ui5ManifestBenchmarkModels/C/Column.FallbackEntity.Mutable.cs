...
public readonly partial struct Column
{
    ...
    public readonly partial struct FallbackEntity
    {
...
#endif
        {
            ...
            /// <summary>
            /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Current.Column"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.Ui5ManifestBenchmark.Current.Column.Mutable(Mutable value)
            {
                return Corvus.Ui5ManifestBenchmark.Current.Column.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Current.Column"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Current.Column.Mutable value)
            {
                return From(value);
            }
            ...
            public TResult Match<TContext, TResult>(
                in TContext context,
                Matcher<Corvus.Ui5ManifestBenchmark.Current.Column, TContext, TResult> matchColumn,
                Matcher<Corvus.Ui5ManifestBenchmark.Current.FallbackOption, TContext, TResult> matchFallbackOption,
                Matcher<Corvus.Ui5ManifestBenchmark.Current.Column.FallbackEntity.Mutable, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                {
                    return matchColumn(Corvus.Ui5ManifestBenchmark.Current.Column.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                Matcher<Corvus.Ui5ManifestBenchmark.Current.Column, TResult> matchColumn,
                Matcher<Corvus.Ui5ManifestBenchmark.Current.FallbackOption, TResult> matchFallbackOption,
                Matcher<Corvus.Ui5ManifestBenchmark.Current.Column.FallbackEntity.Mutable, TResult> defaultMatch)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.Column.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchColumn(Corvus.Ui5ManifestBenchmark.Current.Column.Mutable.From(this));
                }
            ...
            public bool TryGetAsColumn(out Corvus.Ui5ManifestBenchmark.Current.Column.Mutable result)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.Column.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Ui5ManifestBenchmark.Current.Column.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.Ui5ManifestBenchmark.Current.Column.Builder.Build? _columnBuilderInstance;
            ...
            public Source(Corvus.Ui5ManifestBenchmark.Current.Column.Builder.Build value) {_columnBuilderInstance = value; _kind = Kind.ColumnBuilder; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Current.Column instance) => new(JsonElement.From(instance));
            ...
            internal void AddAsProperty(ReadOnlySpan<byte> utf8Name, ref ComplexValueBuilder valueBuilder, bool escapeName = true, bool nameRequiresUnescaping = false)
            {
                switch(_kind)
                {
                    ...
                    case Kind.ColumnBuilder:
                        valueBuilder.AddProperty(utf8Name, _columnBuilderInstance!, static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Current.Column.Builder.BuildValue(b, ref o), escapeName, nameRequiresUnescaping);
                        break;
                    default:
            ...
            internal void AddAsPrebakedProperty(ReadOnlySpan<byte> prebakedPropertyName, ref ComplexValueBuilder valueBuilder)
            {
                switch(_kind)
                {
                    ...
                    case Kind.Utf16String:
                        ...
                        break;
                    case Kind.ColumnBuilder:
                        valueBuilder.AddPrebakedProperty(prebakedPropertyName, _columnBuilderInstance!, static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Current.Column.Builder.BuildValue(b, ref o));
                        break;
                    default:
                        Debug.Fail("Unexpected Kind");
                        break;
            ...
            internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
            {
                switch(_kind)
                {
                    ...
                    case Kind.Utf16String:
                        ...
                        break;
                    case Kind.ColumnBuilder:
                        valueBuilder.AddProperty(name, _columnBuilderInstance!, static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Current.Column.Builder.BuildValue(b, ref o));
                        break;
                    default:
                        Debug.Fail("Unexpected Kind");
                        break;
            ...
            internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
            {
                switch(_kind)
                {
                    ...
                    case Kind.Utf16String:
                        ...
                        break;
                    case Kind.ColumnBuilder:
                        valueBuilder.AddItem(_columnBuilderInstance!, static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Current.Column.Builder.BuildValue(b, ref o));
                        break;
                    default:
                        Debug.Fail("Unexpected Kind");
                        break;
            ...
            #endif
        {
            ...
            TContext _context;
            Source _source;
            private readonly Corvus.Ui5ManifestBenchmark.Current.Column.Builder.Build<TContext>? _columnBuilderInstance;
            ...
            public Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Column.Builder.Build<TContext> value) {_context = context; _columnBuilderInstance = value; _kind = Kind.ColumnBuilder; }
            ...
            internal void AddAsProperty(ReadOnlySpan<byte> utf8Name, ref ComplexValueBuilder valueBuilder, bool escapeName = true, bool nameRequiresUnescaping = false)
            {
                switch(_kind)
                {
                    ...
                    case Kind.Source:
                        ...
                        break;
                    case Kind.ColumnBuilder:
                        valueBuilder.AddProperty(utf8Name, BuildWithContext.Create(_context, _columnBuilderInstance!), static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Current.Column.Builder.BuildValue(b.Context, b.Build, ref o), escapeName, nameRequiresUnescaping);
                        break;
                    default:
                        Debug.Fail("Unexpected Kind");
                        break;
            ...
            internal void AddAsPrebakedProperty(ReadOnlySpan<byte> prebakedPropertyName, ref ComplexValueBuilder valueBuilder)
            {
                switch(_kind)
                {
                    ...
                    case Kind.Source:
                        ...
                        break;
                    case Kind.ColumnBuilder:
                        valueBuilder.AddPrebakedProperty(prebakedPropertyName, BuildWithContext.Create(_context, _columnBuilderInstance!), static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Current.Column.Builder.BuildValue(b.Context, b.Build, ref o));
                        break;
                    default:
                        Debug.Fail("Unexpected Kind");
                        break;
            ...
            internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
            {
                switch(_kind)
                {
                    ...
                    case Kind.Source:
                        ...
                        break;
                    case Kind.ColumnBuilder:
                        valueBuilder.AddProperty(name, BuildWithContext.Create(_context, _columnBuilderInstance!), static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Current.Column.Builder.BuildValue(b.Context, b.Build, ref o));
                        break;
                    default:
                        Debug.Fail("Unexpected Kind");
                        break;
            ...
            internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
            {
                switch(_kind)
                {
                    ...
                    case Kind.Source:
                        ...
                        break;
                    case Kind.ColumnBuilder:
                        valueBuilder.AddItem(BuildWithContext.Create(_context, _columnBuilderInstance!), static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Current.Column.Builder.BuildValue(b.Context, b.Build, ref o));
                        break;
                    default:
                        Debug.Fail("Unexpected Kind");
                        break;
        ...
        public static Corvus.Ui5ManifestBenchmark.Current.Column.Source Build(
            scoped in Corvus.Ui5ManifestBenchmark.Current.Column.Builder.Build buildValue, int initialCapacity = 1)
        {
            return new Corvus.Ui5ManifestBenchmark.Current.Column.Source(buildValue);
        }
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Corvus.Ui5ManifestBenchmark.Current.Column.Source<TContext> Build<TContext>(
            scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Current.Column.Builder.Build<TContext> buildValue, int initialCapacity = 1)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            return new Corvus.Ui5ManifestBenchmark.Current.Column.Source<TContext>(context, buildValue);
        }
        ...
        /// <returns>An instance of a mutable document initialized with the given value.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(
            JsonWorkspace workspace, scoped in Corvus.Ui5ManifestBenchmark.Current.Column.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
        {
            // Create the document builder without a MetadataDb
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            var source = new Corvus.Ui5ManifestBenchmark.Current.Column.Source(value);
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(
            JsonWorkspace workspace, scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Current.Column.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            ...
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            var source = new Corvus.Ui5ManifestBenchmark.Current.Column.Source<TContext>(context, value);
            source.AddAsItem(ref cvb);
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<FallbackEntity> Create(
            scoped in Corvus.Ui5ManifestBenchmark.Current.Column.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent(initialValueBufferSize);
            try
            {
        ...
        public static ParsedJsonDocument<FallbackEntity> Create<TContext>(
            scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Current.Column.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
