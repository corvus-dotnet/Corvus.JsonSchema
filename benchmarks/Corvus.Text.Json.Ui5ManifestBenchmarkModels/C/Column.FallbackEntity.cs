...
public readonly partial struct Column
{
...
#endif
    {
        ...
        public static explicit operator Corvus.Ui5ManifestBenchmark.Current.Column(FallbackEntity value)
        {
            return Corvus.Ui5ManifestBenchmark.Current.Column.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator FallbackEntity(Corvus.Ui5ManifestBenchmark.Current.Column value)
        {
            return From(value);
        }
        ...
        public bool TryGetAsColumn(out Corvus.Ui5ManifestBenchmark.Current.Column result)
        {
            ...
            {
                result = Corvus.Ui5ManifestBenchmark.Current.Column.From(this);
                return true;
            }
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Column.FallbackEntity, TContext, TResult> defaultMatch)
...
#endif
        {
            if (Corvus.Ui5ManifestBenchmark.Current.Column.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchColumn(Corvus.Ui5ManifestBenchmark.Current.Column.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Column.FallbackEntity, TResult> defaultMatch)
        {
            if (Corvus.Ui5ManifestBenchmark.Current.Column.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchColumn(Corvus.Ui5ManifestBenchmark.Current.Column.From(this));
            }
        ...
        public TAccumulator MatchEvery<TAccumulator>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Column.FallbackEntity, TAccumulator, TAccumulator> defaultMatch)
        {
            bool matched = false;
            ...
            {
                matched = true;
                accumulator = matchColumn(Corvus.Ui5ManifestBenchmark.Current.Column.From(this), accumulator);
            }
