...
public readonly partial struct Column
{
    ...
    public readonly partial struct MustBeColumn
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(MustBeColumn instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MustBeColumn"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MustBeColumn(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new MustBeColumn(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MustBeColumn.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="MustBeColumn"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="MustBeColumn"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeColumn Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<MustBeColumn>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="MustBeColumn"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeColumn Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MustBeColumn>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(MustBeColumn instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<MustBeColumn, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<MustBeColumn> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<MustBeColumn>();
            }
            finally
            {
