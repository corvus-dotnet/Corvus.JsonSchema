...
public readonly partial struct Column
{
    ...
    public readonly partial struct VerticalContentAlignmentEntity
    {
...
#endif
        {
            ...
            public static explicit operator Corvus.Ui5ManifestBenchmark.Current.VerticalContentAlignment.Mutable(Mutable value)
            {
                return Corvus.Ui5ManifestBenchmark.Current.VerticalContentAlignment.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Current.VerticalContentAlignment.Mutable value)
            {
                return From(value);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.Column.VerticalContentAlignmentEntity.Mutable, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                {
                    return matchVerticalContentAlignment(Corvus.Ui5ManifestBenchmark.Current.VerticalContentAlignment.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.Column.VerticalContentAlignmentEntity.Mutable, TResult> defaultMatch)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.VerticalContentAlignment.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchVerticalContentAlignment(Corvus.Ui5ManifestBenchmark.Current.VerticalContentAlignment.Mutable.From(this));
                }
            ...
            public TAccumulator MatchEvery<TAccumulator>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.Column.VerticalContentAlignmentEntity.Mutable, TAccumulator, TAccumulator> defaultMatch)
            {
                bool matched = false;
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Current.VerticalContentAlignment.Mutable" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsVerticalContentAlignment(out Corvus.Ui5ManifestBenchmark.Current.VerticalContentAlignment.Mutable result)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.VerticalContentAlignment.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Ui5ManifestBenchmark.Current.VerticalContentAlignment.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Current.VerticalContentAlignment instance) => new(JsonElement.From(instance));
        ...
        public static ParsedJsonDocument<VerticalContentAlignmentEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<VerticalContentAlignmentEntity>();
            }
            finally
            {
