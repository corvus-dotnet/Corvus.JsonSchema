...
public readonly partial struct Column
{
...
#endif
    {
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Column.VerticalContentAlignmentEntity, TContext, TResult> defaultMatch)
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Column.VerticalContentAlignmentEntity, TResult> defaultMatch)
        {
            if (Corvus.Ui5ManifestBenchmark.Current.VerticalContentAlignment.JsonSchema.Evaluate(_parent, _idx))
            {
        ...
        public TAccumulator MatchEvery<TAccumulator>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Column.VerticalContentAlignmentEntity, TAccumulator, TAccumulator> defaultMatch)
        {
            bool matched = false;
