...
public readonly partial struct ColumnSet
{
    ...
    public readonly partial struct ColumnArray
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ColumnArray instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ColumnArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ColumnArray(Mutable instance)
            {
            ...
            public Corvus.Ui5ManifestBenchmark.Current.Column.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Ui5ManifestBenchmark.Current.Column.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.Ui5ManifestBenchmark.Current.Column.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Current.Column.Mutable>(_parent, _idx);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ColumnArray(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ColumnArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Corvus.Ui5ManifestBenchmark.Current.Column.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, scoped in Corvus.Ui5ManifestBenchmark.Current.Column.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(scoped in Corvus.Ui5ManifestBenchmark.Current.Column.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Corvus.Ui5ManifestBenchmark.Current.Column item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.Ui5ManifestBenchmark.Current.Column>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Corvus.Ui5ManifestBenchmark.Current.Column> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.Ui5ManifestBenchmark.Current.Column>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Corvus.Ui5ManifestBenchmark.Current.Column oldItem, in Corvus.Ui5ManifestBenchmark.Current.Column.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Current.Column>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Corvus.Ui5ManifestBenchmark.Current.Column current = enumerator.Current;
            ...
            /// <summary>
            /// Gets a <see cref="ColumnArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ColumnArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly ColumnArray Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ColumnArray>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ColumnArray"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly ColumnArray Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ColumnArray>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Current.ColumnSet.ColumnArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(ColumnArray instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.ColumnSet.ColumnArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            public void AddItem(in Corvus.Ui5ManifestBenchmark.Current.Column.Source value)
            {
            ...
            /// Add an item to the array.
            /// </summary>
            public void AddItem<TContext>(in Corvus.Ui5ManifestBenchmark.Current.Column.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        {
            return workspace.CreateBuilder<ColumnArray, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ColumnArray> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ColumnArray>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ColumnArray> Create<TContext>(
