...
public readonly partial struct ColumnSet
{
    ...
    public readonly partial struct MustBeColumnSet
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(MustBeColumnSet instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MustBeColumnSet"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MustBeColumnSet(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new MustBeColumnSet(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MustBeColumnSet.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="MustBeColumnSet"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="MustBeColumnSet"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeColumnSet Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<MustBeColumnSet>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="MustBeColumnSet"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeColumnSet Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MustBeColumnSet>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(MustBeColumnSet instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<MustBeColumnSet, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<MustBeColumnSet> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<MustBeColumnSet>();
            }
            finally
            {
