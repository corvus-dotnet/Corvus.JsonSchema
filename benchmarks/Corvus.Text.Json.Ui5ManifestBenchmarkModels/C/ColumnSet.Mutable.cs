...
public readonly partial struct ColumnSet
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.ColumnSet.ColumnArray.Mutable Columns
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ColumnsUtf8, out Corvus.Ui5ManifestBenchmark.Current.ColumnSet.ColumnArray.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.ColumnSet.HorizontalAlignmentEntity.Mutable HorizontalAlignment
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HorizontalAlignmentUtf8, out Corvus.Ui5ManifestBenchmark.Current.ColumnSet.HorizontalAlignmentEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.ColumnSet.StyleHintForColumnSet.Mutable Style
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StyleUtf8, out Corvus.Ui5ManifestBenchmark.Current.ColumnSet.StyleHintForColumnSet.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.ColumnSet.MustBeColumnSet.Mutable Type
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Ui5ManifestBenchmark.Current.ColumnSet.MustBeColumnSet.Mutable value))
                {
                    return value;
                }
        ...
        public void SetColumns(scoped in Corvus.Ui5ManifestBenchmark.Current.ColumnSet.ColumnArray.Source value)
        {
            ...
            {
                // We are going to insert the new value
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Columns, ref cvb);
                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
            }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetColumns<TContext>(in Corvus.Ui5ManifestBenchmark.Current.ColumnSet.ColumnArray.Source<TContext> value)
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Ui5ManifestBenchmark.Current.ColumnSet.ColumnArray.Source _createArg2;
        ...
        private readonly Corvus.Ui5ManifestBenchmark.Current.ColumnSet.HorizontalAlignmentEntity.Source _createArg5;
        ...
        private readonly Corvus.Ui5ManifestBenchmark.Current.ColumnSet.StyleHintForColumnSet.Source _createArg13;
        private readonly Corvus.Ui5ManifestBenchmark.Current.ColumnSet.MustBeColumnSet.Source _createArg14;
        ...
        #endif
    {
        ...
        private readonly Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source _createArg1;
        private readonly Corvus.Ui5ManifestBenchmark.Current.ColumnSet.ColumnArray.Source<TContext> _createArg2;
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Corvus.Ui5ManifestBenchmark.Current.ColumnSet.ColumnArray.Source columns = default,
            in Corvus.Text.Json.JsonElement.Source fallback = default,
            in Corvus.Text.Json.JsonElement.Source height = default,
            in Corvus.Ui5ManifestBenchmark.Current.ColumnSet.HorizontalAlignmentEntity.Source horizontalAlignment = default,
            ...
            in Corvus.Ui5ManifestBenchmark.Current.ColumnSet.StyleHintForColumnSet.Source style = default,
            in Corvus.Ui5ManifestBenchmark.Current.ColumnSet.MustBeColumnSet.Source type = default)
        {
            bleed.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Bleed, ref builder);
            columns.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Columns, ref builder);
        ...
        internal static void Create<TContext>(
            ...
            ref ComplexValueBuilder builder,
            in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source bleed = default,
            in Corvus.Ui5ManifestBenchmark.Current.ColumnSet.ColumnArray.Source<TContext> columns = default,
    ...
    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source bleed = default, scoped in Corvus.Ui5ManifestBenchmark.Current.ColumnSet.ColumnArray.Source<TContext> columns = default, scoped in Corvus.Text.Json.JsonElement.Source<TContext> fallback = default, scoped in Corvus.Text.Json.JsonElement.Source<TContext> height = default, scoped in Corvus.Ui5ManifestBenchmark.Current.ColumnSet.HorizontalAlignmentEntity.Source horizontalAlignment = default, scoped in Corvus.Text.Json.JsonElement.Source<TContext> id = default, scoped in Corvus.Text.Json.JsonElement.Source<TContext> isVisible = default, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source minHeight = default, scoped in Corvus.Text.Json.JsonElement.Source<TContext> requires = default, scoped in Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfISelectAction.Source<TContext> selectAction = default, scoped in Corvus.Text.Json.JsonElement.Source<TContext> separator = default, scoped in Corvus.Text.Json.JsonElement.Source<TContext> spacing = default, scoped in Corvus.Ui5ManifestBenchmark.Current.ColumnSet.StyleHintForColumnSet.Source style = default, scoped in Corvus.Ui5ManifestBenchmark.Current.ColumnSet.MustBeColumnSet.Source type = default)
        ...
        #endif
    {
        return new Source<TContext>(context, bleed, columns, fallback, height, horizontalAlignment, id, isVisible, minHeight, requires, selectAction, separator, spacing, style, type);
    }
    ...
    public static ParsedJsonDocument<ColumnSet> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<ColumnSet>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<ColumnSet> Create<TContext>(
    ...
    public static ParsedJsonDocument<ColumnSet> Create(in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source bleed = default, in Corvus.Ui5ManifestBenchmark.Current.ColumnSet.ColumnArray.Source columns = default, in Corvus.Text.Json.JsonElement.Source fallback = default, in Corvus.Text.Json.JsonElement.Source height = default, in Corvus.Ui5ManifestBenchmark.Current.ColumnSet.HorizontalAlignmentEntity.Source horizontalAlignment = default, in Corvus.Text.Json.JsonElement.Source id = default, in Corvus.Text.Json.JsonElement.Source isVisible = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source minHeight = default, in Corvus.Text.Json.JsonElement.Source requires = default, in Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfISelectAction.Source selectAction = default, in Corvus.Text.Json.JsonElement.Source separator = default, in Corvus.Text.Json.JsonElement.Source spacing = default, in Corvus.Ui5ManifestBenchmark.Current.ColumnSet.StyleHintForColumnSet.Source style = default, in Corvus.Ui5ManifestBenchmark.Current.ColumnSet.MustBeColumnSet.Source type = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<ColumnSet> Create<TContext>(in TContext context, in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source bleed = default, in Corvus.Ui5ManifestBenchmark.Current.ColumnSet.ColumnArray.Source<TContext> columns = default, in Corvus.Text.Json.JsonElement.Source<TContext> fallback = default, in Corvus.Text.Json.JsonElement.Source<TContext> height = default, in Corvus.Ui5ManifestBenchmark.Current.ColumnSet.HorizontalAlignmentEntity.Source horizontalAlignment = default, in Corvus.Text.Json.JsonElement.Source<TContext> id = default, in Corvus.Text.Json.JsonElement.Source<TContext> isVisible = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source minHeight = default, in Corvus.Text.Json.JsonElement.Source<TContext> requires = default, in Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfISelectAction.Source<TContext> selectAction = default, in Corvus.Text.Json.JsonElement.Source<TContext> separator = default, in Corvus.Text.Json.JsonElement.Source<TContext> spacing = default, in Corvus.Ui5ManifestBenchmark.Current.ColumnSet.StyleHintForColumnSet.Source style = default, in Corvus.Ui5ManifestBenchmark.Current.ColumnSet.MustBeColumnSet.Source type = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
