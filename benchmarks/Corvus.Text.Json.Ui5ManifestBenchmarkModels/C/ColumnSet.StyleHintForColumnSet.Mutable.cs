...
public readonly partial struct ColumnSet
{
    ...
    public readonly partial struct StyleHintForColumnSet
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(StyleHintForColumnSet instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="StyleHintForColumnSet"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator StyleHintForColumnSet(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"StyleHintForColumnSet.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly StyleHintForColumnSet Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly StyleHintForColumnSet Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<StyleHintForColumnSet>(_idx);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.ColumnSet.StyleHintForColumnSet.Mutable, TContext, TResult> defaultMatch)
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.ColumnSet.StyleHintForColumnSet.Mutable, TResult> defaultMatch)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.ContainerStyle.JsonSchema.Evaluate(_parent, _idx))
                {
            ...
            public TAccumulator MatchEvery<TAccumulator>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.ColumnSet.StyleHintForColumnSet.Mutable, TAccumulator, TAccumulator> defaultMatch)
            {
                bool matched = false;
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(StyleHintForColumnSet instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<StyleHintForColumnSet, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<StyleHintForColumnSet> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<StyleHintForColumnSet>();
            }
            finally
            {
