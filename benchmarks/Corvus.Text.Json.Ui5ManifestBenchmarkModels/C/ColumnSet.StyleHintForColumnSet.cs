...
public readonly partial struct ColumnSet
{
    ...
    public readonly partial struct StyleHintForColumnSet
#if NET8_0_OR_GREATER
        : IJsonElement<StyleHintForColumnSet>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StyleHintForColumnSet"/> struct.
        /// </summary>
        ...
        internal StyleHintForColumnSet(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static StyleHintForColumnSet DefaultInstance { get; }
        ...
        public static explicit operator Corvus.Ui5ManifestBenchmark.Current.ContainerStyle(StyleHintForColumnSet value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator StyleHintForColumnSet(Corvus.Ui5ManifestBenchmark.Current.ContainerStyle value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator StyleHintForColumnSet(Corvus.Ui5ManifestBenchmark.Current.ContainerStyle.Mutable value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.Ui5ManifestBenchmark.Current.ContainerStyle.AnyOf0Entity(StyleHintForColumnSet value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator StyleHintForColumnSet(Corvus.Ui5ManifestBenchmark.Current.ContainerStyle.AnyOf0Entity value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator StyleHintForColumnSet(Corvus.Ui5ManifestBenchmark.Current.ContainerStyle.AnyOf0Entity.Mutable value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.Ui5ManifestBenchmark.Current.ContainerStyle.AnyOf1Entity(StyleHintForColumnSet value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator StyleHintForColumnSet(Corvus.Ui5ManifestBenchmark.Current.ContainerStyle.AnyOf1Entity value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator StyleHintForColumnSet(Corvus.Ui5ManifestBenchmark.Current.ContainerStyle.AnyOf1Entity.Mutable value)
        {
            return From(value);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(StyleHintForColumnSet value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in StyleHintForColumnSet left, in StyleHintForColumnSet right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in StyleHintForColumnSet left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(StyleHintForColumnSet instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator StyleHintForColumnSet(JsonElement instance)
        {
            return StyleHintForColumnSet.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static StyleHintForColumnSet From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static StyleHintForColumnSet ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<StyleHintForColumnSet>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static StyleHintForColumnSet ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<StyleHintForColumnSet>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static StyleHintForColumnSet ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<StyleHintForColumnSet>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static StyleHintForColumnSet ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<StyleHintForColumnSet>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out StyleHintForColumnSet? result)
        {
            return JsonElementHelpers.TryParseValue<StyleHintForColumnSet>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new StyleHintForColumnSet(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static StyleHintForColumnSet IJsonElement<StyleHintForColumnSet>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"StyleHintForColumnSet: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="StyleHintForColumnSet"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="StyleHintForColumnSet"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public StyleHintForColumnSet Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<StyleHintForColumnSet>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="StyleHintForColumnSet"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public StyleHintForColumnSet Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<StyleHintForColumnSet>(_idx);
            }
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.ColumnSet.StyleHintForColumnSet, TContext, TResult> defaultMatch)
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.ColumnSet.StyleHintForColumnSet, TResult> defaultMatch)
        {
            if (Corvus.Ui5ManifestBenchmark.Current.ContainerStyle.JsonSchema.Evaluate(_parent, _idx))
            {
        ...
        public TAccumulator MatchEvery<TAccumulator>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.ColumnSet.StyleHintForColumnSet, TAccumulator, TAccumulator> defaultMatch)
        {
            bool matched = false;
