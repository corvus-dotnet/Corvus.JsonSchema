...
public readonly partial struct Container
{
    ...
    public readonly partial struct BackgroundImageEntity
    {
...
#endif
        {
            ...
            /// <summary>
            /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Current.BackgroundImage"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.Ui5ManifestBenchmark.Current.BackgroundImage.Mutable(Mutable value)
            {
                return Corvus.Ui5ManifestBenchmark.Current.BackgroundImage.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Current.BackgroundImage"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Current.BackgroundImage.Mutable value)
            {
                return From(value);
            }
            ...
            /// <summary>
            /// Gets a <see cref="BackgroundImageEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="BackgroundImageEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly BackgroundImageEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<BackgroundImageEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="BackgroundImageEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly BackgroundImageEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<BackgroundImageEntity>(_idx);
            }
            ...
            public TResult Match<TContext, TResult>(
                in TContext context,
                Matcher<Corvus.Ui5ManifestBenchmark.Current.BackgroundImage, TContext, TResult> matchBackgroundImage,
                Matcher<Corvus.Ui5ManifestBenchmark.Current.JsonUriReference, TContext, TResult> matchJsonUriReference,
                Matcher<Corvus.Ui5ManifestBenchmark.Current.Container.BackgroundImageEntity.Mutable, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                {
                    return matchBackgroundImage(Corvus.Ui5ManifestBenchmark.Current.BackgroundImage.Mutable.From(this), context);
                }

                if (Corvus.Ui5ManifestBenchmark.Current.JsonUriReference.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonUriReference(Corvus.Ui5ManifestBenchmark.Current.JsonUriReference.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                Matcher<Corvus.Ui5ManifestBenchmark.Current.BackgroundImage, TResult> matchBackgroundImage,
                Matcher<Corvus.Ui5ManifestBenchmark.Current.JsonUriReference, TResult> matchJsonUriReference,
                Matcher<Corvus.Ui5ManifestBenchmark.Current.Container.BackgroundImageEntity.Mutable, TResult> defaultMatch)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.BackgroundImage.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchBackgroundImage(Corvus.Ui5ManifestBenchmark.Current.BackgroundImage.Mutable.From(this));
                }

                if (Corvus.Ui5ManifestBenchmark.Current.JsonUriReference.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonUriReference(Corvus.Ui5ManifestBenchmark.Current.JsonUriReference.Mutable.From(this));
                }
            ...
            public TAccumulator MatchEvery<TAccumulator>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.Container.BackgroundImageEntity.Mutable, TAccumulator, TAccumulator> defaultMatch)
            {
                bool matched = false;
                ...
                {
                    matched = true;
                    accumulator = matchBackgroundImage(Corvus.Ui5ManifestBenchmark.Current.BackgroundImage.Mutable.From(this), accumulator);
                }

                if (Corvus.Ui5ManifestBenchmark.Current.JsonUriReference.JsonSchema.Evaluate(_parent, _idx))
                {
                    matched = true;
                    accumulator = matchJsonUriReference(Corvus.Ui5ManifestBenchmark.Current.JsonUriReference.Mutable.From(this), accumulator);
                }
            ...
            public bool TryGetAsBackgroundImage(out Corvus.Ui5ManifestBenchmark.Current.BackgroundImage.Mutable result)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.BackgroundImage.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Ui5ManifestBenchmark.Current.BackgroundImage.Mutable.From(this);
                    return true;
                }
            ...
            public bool TryGetAsJsonUriReference(out Corvus.Ui5ManifestBenchmark.Current.JsonUriReference.Mutable result)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.JsonUriReference.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Ui5ManifestBenchmark.Current.JsonUriReference.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Current.JsonUriReference instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            TContext _context;
            Source _source;
            private readonly Corvus.Ui5ManifestBenchmark.Current.BackgroundImage.Builder.Build<TContext>? _backgroundImageBuilderInstance;
            ...
            public Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.BackgroundImage.Builder.Build<TContext> value) {_context = context; _backgroundImageBuilderInstance = value; _kind = Kind.BackgroundImageBuilder; }
            ...
            internal void AddAsProperty(ReadOnlySpan<byte> utf8Name, ref ComplexValueBuilder valueBuilder, bool escapeName = true, bool nameRequiresUnescaping = false)
            {
                switch(_kind)
                {
                    ...
                    case Kind.Source:
                        ...
                        break;
                    case Kind.BackgroundImageBuilder:
                        valueBuilder.AddProperty(utf8Name, BuildWithContext.Create(_context, _backgroundImageBuilderInstance!), static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Current.BackgroundImage.Builder.BuildValue(b.Context, b.Build, ref o), escapeName, nameRequiresUnescaping);
                        break;
                    default:
                        Debug.Fail("Unexpected Kind");
                        break;
            ...
            internal void AddAsPrebakedProperty(ReadOnlySpan<byte> prebakedPropertyName, ref ComplexValueBuilder valueBuilder)
            {
                switch(_kind)
                {
                    ...
                    case Kind.Source:
                        ...
                        break;
                    case Kind.BackgroundImageBuilder:
                        valueBuilder.AddPrebakedProperty(prebakedPropertyName, BuildWithContext.Create(_context, _backgroundImageBuilderInstance!), static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Current.BackgroundImage.Builder.BuildValue(b.Context, b.Build, ref o));
                        break;
                    default:
                        Debug.Fail("Unexpected Kind");
                        break;
            ...
            internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
            {
                switch(_kind)
                {
                    ...
                    case Kind.Source:
                        ...
                        break;
                    case Kind.BackgroundImageBuilder:
                        valueBuilder.AddProperty(name, BuildWithContext.Create(_context, _backgroundImageBuilderInstance!), static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Current.BackgroundImage.Builder.BuildValue(b.Context, b.Build, ref o));
                        break;
                    default:
                        Debug.Fail("Unexpected Kind");
                        break;
            ...
            internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
            {
                switch(_kind)
                {
                    ...
                    case Kind.Source:
                        ...
                        break;
                    case Kind.BackgroundImageBuilder:
                        valueBuilder.AddItem(BuildWithContext.Create(_context, _backgroundImageBuilderInstance!), static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Current.BackgroundImage.Builder.BuildValue(b.Context, b.Build, ref o));
                        break;
                    default:
                        Debug.Fail("Unexpected Kind");
                        break;
        ...
        public static Corvus.Ui5ManifestBenchmark.Current.BackgroundImage.Source Build(
            scoped in Corvus.Ui5ManifestBenchmark.Current.BackgroundImage.Builder.Build buildValue, int initialCapacity = 1)
        {
            return new Corvus.Ui5ManifestBenchmark.Current.BackgroundImage.Source(buildValue);
        }
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Corvus.Ui5ManifestBenchmark.Current.BackgroundImage.Source<TContext> Build<TContext>(
            scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Current.BackgroundImage.Builder.Build<TContext> buildValue, int initialCapacity = 1)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            return new Corvus.Ui5ManifestBenchmark.Current.BackgroundImage.Source<TContext>(context, buildValue);
        }
        ...
        /// <returns>An instance of a mutable document initialized with the given value.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(
            JsonWorkspace workspace, scoped in Corvus.Ui5ManifestBenchmark.Current.BackgroundImage.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
        {
            // Create the document builder without a MetadataDb
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            var source = new Corvus.Ui5ManifestBenchmark.Current.BackgroundImage.Source(value);
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(
            JsonWorkspace workspace, scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Current.BackgroundImage.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            ...
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            var source = new Corvus.Ui5ManifestBenchmark.Current.BackgroundImage.Source<TContext>(context, value);
            source.AddAsItem(ref cvb);
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        public static ParsedJsonDocument<BackgroundImageEntity> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<BackgroundImageEntity>();
            }
            finally
            {
        ...
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<BackgroundImageEntity> Create(
            scoped in Corvus.Ui5ManifestBenchmark.Current.BackgroundImage.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent(initialValueBufferSize);
            try
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<BackgroundImageEntity> Create<TContext>(
            scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Current.BackgroundImage.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
