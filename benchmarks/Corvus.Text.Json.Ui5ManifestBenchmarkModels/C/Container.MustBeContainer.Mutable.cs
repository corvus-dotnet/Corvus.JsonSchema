...
public readonly partial struct Container
{
    ...
    public readonly partial struct MustBeContainer
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(MustBeContainer instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MustBeContainer"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MustBeContainer(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MustBeContainer.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeContainer Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeContainer Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MustBeContainer>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(MustBeContainer instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<MustBeContainer, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<MustBeContainer> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<MustBeContainer>();
            }
            finally
            {
