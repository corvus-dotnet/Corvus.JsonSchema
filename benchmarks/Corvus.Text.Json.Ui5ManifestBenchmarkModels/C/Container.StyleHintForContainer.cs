...
public readonly partial struct Container
{
    ...
    public readonly partial struct StyleHintForContainer
#if NET8_0_OR_GREATER
        : IJsonElement<StyleHintForContainer>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StyleHintForContainer"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal StyleHintForContainer(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static StyleHintForContainer DefaultInstance { get; }
        ...
        /// <summary>
        /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Current.ContainerStyle"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.Ui5ManifestBenchmark.Current.ContainerStyle(StyleHintForContainer value)
        {
            return Corvus.Ui5ManifestBenchmark.Current.ContainerStyle.From(value);
        }

        /// <summary>
        /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Current.ContainerStyle"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator StyleHintForContainer(Corvus.Ui5ManifestBenchmark.Current.ContainerStyle value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator StyleHintForContainer(Corvus.Ui5ManifestBenchmark.Current.ContainerStyle.Mutable value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.Ui5ManifestBenchmark.Current.ContainerStyle.AnyOf0Entity(StyleHintForContainer value)
        {
            return Corvus.Ui5ManifestBenchmark.Current.ContainerStyle.AnyOf0Entity.From(value);
        }

        /// <summary>
        /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Current.ContainerStyle.AnyOf0Entity"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator StyleHintForContainer(Corvus.Ui5ManifestBenchmark.Current.ContainerStyle.AnyOf0Entity value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator StyleHintForContainer(Corvus.Ui5ManifestBenchmark.Current.ContainerStyle.AnyOf0Entity.Mutable value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.Ui5ManifestBenchmark.Current.ContainerStyle.AnyOf1Entity(StyleHintForContainer value)
        {
            return Corvus.Ui5ManifestBenchmark.Current.ContainerStyle.AnyOf1Entity.From(value);
        }

        /// <summary>
        /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Current.ContainerStyle.AnyOf1Entity"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator StyleHintForContainer(Corvus.Ui5ManifestBenchmark.Current.ContainerStyle.AnyOf1Entity value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator StyleHintForContainer(Corvus.Ui5ManifestBenchmark.Current.ContainerStyle.AnyOf1Entity.Mutable value)
        {
            return From(value);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(StyleHintForContainer value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in StyleHintForContainer left, in StyleHintForContainer right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in StyleHintForContainer left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(StyleHintForContainer instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator StyleHintForContainer(JsonElement instance)
        {
            return StyleHintForContainer.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static StyleHintForContainer From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static StyleHintForContainer ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<StyleHintForContainer>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static StyleHintForContainer ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<StyleHintForContainer>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static StyleHintForContainer ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<StyleHintForContainer>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static StyleHintForContainer ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<StyleHintForContainer>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out StyleHintForContainer? result)
        {
            return JsonElementHelpers.TryParseValue<StyleHintForContainer>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new StyleHintForContainer(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static StyleHintForContainer IJsonElement<StyleHintForContainer>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"StyleHintForContainer: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="StyleHintForContainer"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="StyleHintForContainer"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public StyleHintForContainer Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<StyleHintForContainer>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="StyleHintForContainer"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public StyleHintForContainer Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<StyleHintForContainer>(_idx);
            }
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Current.ContainerStyle" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsContainerStyle(out Corvus.Ui5ManifestBenchmark.Current.ContainerStyle result)
        {
            if (Corvus.Ui5ManifestBenchmark.Current.ContainerStyle.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.Ui5ManifestBenchmark.Current.ContainerStyle.From(this);
                return true;
            }
        ...
        /// <param name="matchContainerStyle">Match a <see cref="Corvus.Ui5ManifestBenchmark.Current.ContainerStyle"/>.</param>
        ...
        public TResult Match<TContext, TResult>(
            in TContext context,
            Matcher<Corvus.Ui5ManifestBenchmark.Current.ContainerStyle, TContext, TResult> matchContainerStyle,
            Matcher<Corvus.Ui5ManifestBenchmark.Current.JsonNull, TContext, TResult> matchJsonNull,
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Container.StyleHintForContainer, TContext, TResult> defaultMatch)
...
#endif
        {
            if (Corvus.Ui5ManifestBenchmark.Current.ContainerStyle.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchContainerStyle(Corvus.Ui5ManifestBenchmark.Current.ContainerStyle.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            Matcher<Corvus.Ui5ManifestBenchmark.Current.ContainerStyle, TResult> matchContainerStyle,
            Matcher<Corvus.Ui5ManifestBenchmark.Current.JsonNull, TResult> matchJsonNull,
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Container.StyleHintForContainer, TResult> defaultMatch)
        {
            if (Corvus.Ui5ManifestBenchmark.Current.ContainerStyle.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchContainerStyle(Corvus.Ui5ManifestBenchmark.Current.ContainerStyle.From(this));
            }
        ...
        public TAccumulator MatchEvery<TAccumulator>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.ContainerStyle, TAccumulator, TAccumulator> matchContainerStyle,
            Matcher<Corvus.Ui5ManifestBenchmark.Current.JsonNull, TAccumulator, TAccumulator> matchJsonNull,
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Container.StyleHintForContainer, TAccumulator, TAccumulator> defaultMatch)
        {
            bool matched = false;
            ...
            {
                matched = true;
                accumulator = matchContainerStyle(Corvus.Ui5ManifestBenchmark.Current.ContainerStyle.From(this), accumulator);
            }
