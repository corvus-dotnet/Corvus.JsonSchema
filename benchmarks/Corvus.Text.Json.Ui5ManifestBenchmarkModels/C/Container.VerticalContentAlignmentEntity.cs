...
public readonly partial struct Container
{
    ...
    public readonly partial struct VerticalContentAlignmentEntity
#if NET8_0_OR_GREATER
        : IJsonElement<VerticalContentAlignmentEntity>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VerticalContentAlignmentEntity"/> struct.
        /// </summary>
        ...
        internal VerticalContentAlignmentEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static VerticalContentAlignmentEntity DefaultInstance { get; }
        ...
        /// <summary>
        /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Current.VerticalContentAlignment"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.Ui5ManifestBenchmark.Current.VerticalContentAlignment(VerticalContentAlignmentEntity value)
        {
            return Corvus.Ui5ManifestBenchmark.Current.VerticalContentAlignment.From(value);
        }

        /// <summary>
        /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Current.VerticalContentAlignment"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator VerticalContentAlignmentEntity(Corvus.Ui5ManifestBenchmark.Current.VerticalContentAlignment value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.Ui5ManifestBenchmark.Current.VerticalContentAlignment.AnyOf0Entity(VerticalContentAlignmentEntity value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator VerticalContentAlignmentEntity(Corvus.Ui5ManifestBenchmark.Current.VerticalContentAlignment.AnyOf0Entity value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.Ui5ManifestBenchmark.Current.VerticalContentAlignment.AnyOf1Entity(VerticalContentAlignmentEntity value)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(VerticalContentAlignmentEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in VerticalContentAlignmentEntity left, in VerticalContentAlignmentEntity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in VerticalContentAlignmentEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(VerticalContentAlignmentEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator VerticalContentAlignmentEntity(JsonElement instance)
        {
            return VerticalContentAlignmentEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static VerticalContentAlignmentEntity From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static VerticalContentAlignmentEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<VerticalContentAlignmentEntity>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static VerticalContentAlignmentEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<VerticalContentAlignmentEntity>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static VerticalContentAlignmentEntity ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<VerticalContentAlignmentEntity>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static VerticalContentAlignmentEntity ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<VerticalContentAlignmentEntity>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out VerticalContentAlignmentEntity? result)
        {
            return JsonElementHelpers.TryParseValue<VerticalContentAlignmentEntity>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new VerticalContentAlignmentEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static VerticalContentAlignmentEntity IJsonElement<VerticalContentAlignmentEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"VerticalContentAlignmentEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="VerticalContentAlignmentEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="VerticalContentAlignmentEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public VerticalContentAlignmentEntity Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<VerticalContentAlignmentEntity>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="VerticalContentAlignmentEntity"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public VerticalContentAlignmentEntity Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<VerticalContentAlignmentEntity>(_idx);
            }
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Current.VerticalContentAlignment" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsVerticalContentAlignment(out Corvus.Ui5ManifestBenchmark.Current.VerticalContentAlignment result)
        {
            if (Corvus.Ui5ManifestBenchmark.Current.VerticalContentAlignment.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.Ui5ManifestBenchmark.Current.VerticalContentAlignment.From(this);
                return true;
            }
        ...
        public TResult Match<TContext, TResult>(
            in TContext context,
            Matcher<Corvus.Ui5ManifestBenchmark.Current.VerticalContentAlignment, TContext, TResult> matchVerticalContentAlignment,
            Matcher<Corvus.Ui5ManifestBenchmark.Current.JsonNull, TContext, TResult> matchJsonNull,
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Container.VerticalContentAlignmentEntity, TContext, TResult> defaultMatch)
...
#endif
        {
            if (Corvus.Ui5ManifestBenchmark.Current.VerticalContentAlignment.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchVerticalContentAlignment(Corvus.Ui5ManifestBenchmark.Current.VerticalContentAlignment.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            Matcher<Corvus.Ui5ManifestBenchmark.Current.VerticalContentAlignment, TResult> matchVerticalContentAlignment,
            Matcher<Corvus.Ui5ManifestBenchmark.Current.JsonNull, TResult> matchJsonNull,
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Container.VerticalContentAlignmentEntity, TResult> defaultMatch)
        {
            if (Corvus.Ui5ManifestBenchmark.Current.VerticalContentAlignment.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchVerticalContentAlignment(Corvus.Ui5ManifestBenchmark.Current.VerticalContentAlignment.From(this));
            }
        ...
        public TAccumulator MatchEvery<TAccumulator>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Container.VerticalContentAlignmentEntity, TAccumulator, TAccumulator> defaultMatch)
        {
            bool matched = false;
            ...
            {
                matched = true;
                accumulator = matchVerticalContentAlignment(Corvus.Ui5ManifestBenchmark.Current.VerticalContentAlignment.From(this), accumulator);
            }
