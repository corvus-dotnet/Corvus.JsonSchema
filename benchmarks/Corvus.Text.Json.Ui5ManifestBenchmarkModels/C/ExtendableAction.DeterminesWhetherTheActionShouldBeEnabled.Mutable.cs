...
public readonly partial struct ExtendableAction
{
    ...
    public readonly partial struct DeterminesWhetherTheActionShouldBeEnabled
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DeterminesWhetherTheActionShouldBeEnabled, Mutable>(DeterminesWhetherTheActionShouldBeEnabled.DefaultInstance);
        ...
        public static ParsedJsonDocument<DeterminesWhetherTheActionShouldBeEnabled> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<DeterminesWhetherTheActionShouldBeEnabled>();
            }
            finally
            {
