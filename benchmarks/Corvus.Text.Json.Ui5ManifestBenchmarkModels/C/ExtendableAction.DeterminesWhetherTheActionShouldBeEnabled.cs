...
public readonly partial struct ExtendableAction
{
    ...
    public readonly partial struct DeterminesWhetherTheActionShouldBeEnabled
#if NET8_0_OR_GREATER
        : IJsonElement<DeterminesWhetherTheActionShouldBeEnabled>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeterminesWhetherTheActionShouldBeEnabled"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal DeterminesWhetherTheActionShouldBeEnabled(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static DeterminesWhetherTheActionShouldBeEnabled DefaultInstance { get; } = ParsedJsonDocument<DeterminesWhetherTheActionShouldBeEnabled>.True;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator bool(DeterminesWhetherTheActionShouldBeEnabled value)
        {
        ...
        /// </returns>
        public static bool operator ==(in DeterminesWhetherTheActionShouldBeEnabled left, in DeterminesWhetherTheActionShouldBeEnabled right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in DeterminesWhetherTheActionShouldBeEnabled left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(DeterminesWhetherTheActionShouldBeEnabled instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator DeterminesWhetherTheActionShouldBeEnabled(JsonElement instance)
        {
            return DeterminesWhetherTheActionShouldBeEnabled.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DeterminesWhetherTheActionShouldBeEnabled From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DeterminesWhetherTheActionShouldBeEnabled ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<DeterminesWhetherTheActionShouldBeEnabled>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DeterminesWhetherTheActionShouldBeEnabled ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<DeterminesWhetherTheActionShouldBeEnabled>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DeterminesWhetherTheActionShouldBeEnabled ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<DeterminesWhetherTheActionShouldBeEnabled>(json, options);
        }
        ...
        /// </exception>
        public static DeterminesWhetherTheActionShouldBeEnabled ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<DeterminesWhetherTheActionShouldBeEnabled>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out DeterminesWhetherTheActionShouldBeEnabled? result)
        {
            return JsonElementHelpers.TryParseValue<DeterminesWhetherTheActionShouldBeEnabled>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new DeterminesWhetherTheActionShouldBeEnabled(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static DeterminesWhetherTheActionShouldBeEnabled IJsonElement<DeterminesWhetherTheActionShouldBeEnabled>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"DeterminesWhetherTheActionShouldBeEnabled: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="DeterminesWhetherTheActionShouldBeEnabled"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="DeterminesWhetherTheActionShouldBeEnabled"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public DeterminesWhetherTheActionShouldBeEnabled Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<DeterminesWhetherTheActionShouldBeEnabled>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="DeterminesWhetherTheActionShouldBeEnabled"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public DeterminesWhetherTheActionShouldBeEnabled Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<DeterminesWhetherTheActionShouldBeEnabled>(_idx);
            }
