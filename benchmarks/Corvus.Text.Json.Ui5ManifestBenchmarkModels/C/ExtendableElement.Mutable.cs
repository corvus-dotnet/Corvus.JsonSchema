...
public readonly partial struct ExtendableElement
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.ExtendableElement.FallbackEntity.Mutable Fallback
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FallbackUtf8, out Corvus.Ui5ManifestBenchmark.Current.ExtendableElement.FallbackEntity.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetFallback<TContext>(in Corvus.Ui5ManifestBenchmark.Current.ExtendableElement.FallbackEntity.Source<TContext> value)
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Ui5ManifestBenchmark.Current.ExtendableElement.FallbackEntity.Source _createArg1;
        private readonly Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.Source _createArg2;
        ...
        private readonly Corvus.Ui5ManifestBenchmark.Current.Spacing.Source _createArg7;
        ...
        #endif
    {
        ...
        private readonly Corvus.Ui5ManifestBenchmark.Current.ExtendableElement.FallbackEntity.Source<TContext> _createArg1;
        private readonly Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.Source _createArg2;
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Corvus.Ui5ManifestBenchmark.Current.ExtendableElement.FallbackEntity.Source fallback = default,
        ...
        internal static void Create<TContext>(
            in TContext context,
            ref ComplexValueBuilder builder,
            in Corvus.Ui5ManifestBenchmark.Current.ExtendableElement.FallbackEntity.Source<TContext> fallback = default,
            in Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.Source height = default,
    ...
    public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Current.ExtendableElement.FallbackEntity.Source<TContext> fallback = default, scoped in Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.Source height = default, scoped in Corvus.Text.Json.JsonElement.Source<TContext> id = default, scoped in Corvus.Text.Json.JsonElement.Source<TContext> isVisible = default, scoped in Corvus.Text.Json.JsonElement.Source<TContext> requires = default, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source separator = default, scoped in Corvus.Ui5ManifestBenchmark.Current.Spacing.Source spacing = default)
        ...
        #endif
    {
        return new Source<TContext>(context, fallback, height, id, isVisible, requires, separator, spacing);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.ExtendableElement.FallbackEntity.Source fallback = default, in Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.Source height = default, in Corvus.Text.Json.JsonElement.Source id = default, in Corvus.Text.Json.JsonElement.Source isVisible = default, in Corvus.Text.Json.JsonElement.Source requires = default, in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source separator = default, in Corvus.Ui5ManifestBenchmark.Current.Spacing.Source spacing = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Ui5ManifestBenchmark.Current.ExtendableElement.FallbackEntity.Source<TContext> fallback = default, in Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.Source height = default, in Corvus.Text.Json.JsonElement.Source<TContext> id = default, in Corvus.Text.Json.JsonElement.Source<TContext> isVisible = default, in Corvus.Text.Json.JsonElement.Source<TContext> requires = default, in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source separator = default, in Corvus.Ui5ManifestBenchmark.Current.Spacing.Source spacing = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
    ...
    public static ParsedJsonDocument<ExtendableElement> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<ExtendableElement>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<ExtendableElement> Create<TContext>(
    ...
    public static ParsedJsonDocument<ExtendableElement> Create(in Corvus.Ui5ManifestBenchmark.Current.ExtendableElement.FallbackEntity.Source fallback = default, in Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.Source height = default, in Corvus.Text.Json.JsonElement.Source id = default, in Corvus.Text.Json.JsonElement.Source isVisible = default, in Corvus.Text.Json.JsonElement.Source requires = default, in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source separator = default, in Corvus.Ui5ManifestBenchmark.Current.Spacing.Source spacing = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<ExtendableElement> Create<TContext>(in TContext context, in Corvus.Ui5ManifestBenchmark.Current.ExtendableElement.FallbackEntity.Source<TContext> fallback = default, in Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.Source height = default, in Corvus.Text.Json.JsonElement.Source<TContext> id = default, in Corvus.Text.Json.JsonElement.Source<TContext> isVisible = default, in Corvus.Text.Json.JsonElement.Source<TContext> requires = default, in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source separator = default, in Corvus.Ui5ManifestBenchmark.Current.Spacing.Source spacing = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
