...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ExtendableItem"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal ExtendableItem(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static ExtendableItem DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Ui5ManifestBenchmark.Current.ExtendableItem.RequiresEntity Requires
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RequiresUtf8, out Corvus.Ui5ManifestBenchmark.Current.ExtendableItem.RequiresEntity value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in ExtendableItem left, in ExtendableItem right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in ExtendableItem left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(ExtendableItem instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator ExtendableItem(JsonElement instance)
    {
        return ExtendableItem.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ExtendableItem From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ExtendableItem ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<ExtendableItem>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ExtendableItem ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<ExtendableItem>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ExtendableItem ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<ExtendableItem>(json, options);
    }
    ...
    /// </exception>
    public static ExtendableItem ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<ExtendableItem>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out ExtendableItem? result)
    {
        return JsonElementHelpers.TryParseValue<ExtendableItem>(ref reader, out result);
    }
...
#if NET
    static ExtendableItem IJsonElement<ExtendableItem>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"ExtendableItem: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public ExtendableItem Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<ExtendableItem>(_idx);
        }
