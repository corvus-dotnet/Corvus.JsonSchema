...
#endif
{
    ...
    /// </para>
    /// </remarks>
    public Corvus.Ui5ManifestBenchmark.Current.ExtendableToggleableItem.IfFalseThisItemWillBeRemovedFromTheVisualTree IsVisible
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IsVisibleUtf8, out Corvus.Ui5ManifestBenchmark.Current.ExtendableToggleableItem.IfFalseThisItemWillBeRemovedFromTheVisualTree value))
            {
                return value;
            }

            return Corvus.Ui5ManifestBenchmark.Current.ExtendableToggleableItem.IfFalseThisItemWillBeRemovedFromTheVisualTree.DefaultInstance;
        }
    }
    ...
    public static implicit operator Corvus.Ui5ManifestBenchmark.Current.ExtendableItem(ExtendableToggleableItem value)
    {
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static explicit operator ExtendableToggleableItem(Corvus.Ui5ManifestBenchmark.Current.ExtendableItem value)
    {
        return From(value);
    }
