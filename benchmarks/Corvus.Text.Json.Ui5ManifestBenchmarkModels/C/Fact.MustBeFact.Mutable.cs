...
public readonly partial struct Fact
{
    ...
    public readonly partial struct MustBeFact
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(MustBeFact instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MustBeFact"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MustBeFact(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MustBeFact.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeFact Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeFact Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MustBeFact>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(MustBeFact instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<MustBeFact, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<MustBeFact> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<MustBeFact>();
            }
            finally
            {
