...
public readonly partial struct Fact
{
...
#endif
    {
        ...
        public static explicit operator Mutable(Fact instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="Fact"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Fact(Mutable instance)
        {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.Fact.MustBeFact.Mutable Type
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Ui5ManifestBenchmark.Current.Fact.MustBeFact.Mutable value))
                {
                    return value;
                }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new Fact(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetType(scoped in Corvus.Ui5ManifestBenchmark.Current.Fact.MustBeFact.Source value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Fact.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="Fact"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="Fact"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly Fact Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<Fact>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="Fact"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly Fact Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<Fact>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Ui5ManifestBenchmark.Current.Fact.MustBeFact.Source _createArg3;
        ...
        internal Source(Corvus.Ui5ManifestBenchmark.Current.Fact.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source arg1, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source arg2, scoped in Corvus.Ui5ManifestBenchmark.Current.Fact.MustBeFact.Source arg3)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        public static implicit operator Source(Fact instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Fact.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        /// <summary>
        /// Creates an instance of a <see cref="Fact"/>.
        /// </summary>
        internal static void Create(
            ref ComplexValueBuilder builder,
            in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source title,
            in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source value,
            in Corvus.Ui5ManifestBenchmark.Current.Fact.MustBeFact.Source type = default)
        {
        ...
        public void Create(
            ...
            in Corvus.Ui5ManifestBenchmark.Current.Fact.MustBeFact.Source type = default)
        {
            Create(ref _builder, title, value, type);
        }
        ...
        internal static void BuildCreateValue(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source arg1, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source arg2, scoped in Corvus.Ui5ManifestBenchmark.Current.Fact.MustBeFact.Source arg3, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source title, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source value, scoped in Corvus.Ui5ManifestBenchmark.Current.Fact.MustBeFact.Source type = default)
    {
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source title, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source value, in Corvus.Ui5ManifestBenchmark.Current.Fact.MustBeFact.Source type = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
        Builder ovb = new(cvb);
        ovb.Create(title, value, type);
        cvb = ovb._builder;
        cvb.EndObject();
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<Fact, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<Fact> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<Fact>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<Fact> Create<TContext>(
    ...
    public static ParsedJsonDocument<Fact> Create(in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source title, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source value, in Corvus.Ui5ManifestBenchmark.Current.Fact.MustBeFact.Source type = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
