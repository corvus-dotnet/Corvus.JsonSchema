...
public readonly partial struct FactSet
{
        ...
        : IJsonElement<MustBeFactSet>
    {
        ...
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/https:~1~1adaptivecards.io~1schemas~1adaptive-card.json/definitions/FactSet/properties/type"u8, buffer, out written);
                ...
                ref JsonSchemaContext context)
            {
                ...
                if (tokenType == JsonTokenType.String)
                {
                    ...
                    if (unescapedUtf8JsonString.Span.SequenceEqual("FactSet"u8))
                    {
