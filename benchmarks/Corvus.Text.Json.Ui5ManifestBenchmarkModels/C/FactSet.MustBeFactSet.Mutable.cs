...
public readonly partial struct FactSet
{
    ...
    public readonly partial struct MustBeFactSet
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(MustBeFactSet instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MustBeFactSet"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MustBeFactSet(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MustBeFactSet.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeFactSet Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeFactSet Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MustBeFactSet>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(MustBeFactSet instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<MustBeFactSet, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<MustBeFactSet> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<MustBeFactSet>();
            }
            finally
            {
