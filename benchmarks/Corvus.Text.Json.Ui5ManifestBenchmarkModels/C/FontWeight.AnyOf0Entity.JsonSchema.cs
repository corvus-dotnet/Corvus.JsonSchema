...
public readonly partial struct FontWeight
{
        ...
        : IJsonElement<AnyOf0Entity>
    {
        ...
        private static class Constants
        {
            ...
            /// A constant for the <c>enum</c> keyword.
            /// </summary>
            public static readonly byte[] Enum2 = "lighter"u8.ToArray();
            /// <summary>
            /// A constant for the <c>enum</c> keyword.
            /// </summary>
            public static readonly AnyOf0Entity EnumJson2 = ParsedJsonDocument<AnyOf0Entity>.StringConstant([.."\"lighter\""u8]);
            /// <summary>
            /// A constant for the <c>enum</c> keyword.
            /// </summary>
            public static readonly byte[] Enum3 = "bolder"u8.ToArray();
            /// <summary>
            /// A constant for the <c>enum</c> keyword.
            /// </summary>
            public static readonly AnyOf0Entity EnumJson3 = ParsedJsonDocument<AnyOf0Entity>.StringConstant([.."\"bolder\""u8]);
        }
        ...
        public static class EnumValues
        {
            ...
            /// <summary>
            /// Gets the string "lighter"
            /// as a <see cref="AnyOf0Entity"/>.
            /// </summary>
            public static AnyOf0Entity Lighter { get; } = Constants.EnumJson2;
            /// <summary>
            /// Gets the string "lighter"
            /// as a UTF8 byte array.
            /// </summary>
            public static ReadOnlySpan<byte> LighterUtf8 => Constants.Enum2;

            /// <summary>
            /// Gets the string "bolder"
            /// as a <see cref="AnyOf0Entity"/>.
            /// </summary>
            public static AnyOf0Entity Bolder { get; } = Constants.EnumJson3;
            /// <summary>
            /// Gets the string "bolder"
            /// as a UTF8 byte array.
            /// </summary>
            public static ReadOnlySpan<byte> BolderUtf8 => Constants.Enum3;
        }
        ...
        public enum KnownValues
        {
            ...
            Default = 0,
            /// <summary>
            /// Corresponds to the JSON string "lighter".
            /// </summary>
            Lighter = 1,
            /// <summary>
            /// Corresponds to the JSON string "bolder".
            /// </summary>
            Bolder = 2,
        }
        ...
        public static implicit operator AnyOf0Entity(KnownValues value)
        {
            return value switch
            {
                ...
                KnownValues.Lighter => Constants.EnumJson2,
                KnownValues.Bolder => Constants.EnumJson3,
        ...
        public bool TryGetKnownValue(out KnownValues result)
        {
            ...
            {
                result = KnownValues.Lighter;
                return true;
            }

            if (this.ValueEquals(Constants.Enum3))
            {
                result = KnownValues.Bolder;
                return true;
            }
        ...
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/https:~1~1adaptivecards.io~1schemas~1adaptive-card.json/definitions/FontWeight/anyOf/0"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated, as a JSON Pointer within <see cref="SchemaDocument"/>.
            /// </summary>
            public const string SchemaLocation = "/definitions/https:~1~1adaptivecards.io~1schemas~1adaptive-card.json/definitions/FontWeight/anyOf/0";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/https:~1~1adaptivecards.io~1schemas~1adaptive-card.json/definitions/FontWeight/anyOf/0"u8;
            ...
            private static readonly global::Corvus.Text.Json.RuntimeEvaluator.JsonSchemaEvaluator Evaluator = global::Corvus.Ui5ManifestBenchmark.Current.CorvusJsonSchemaProgram.Entry(954);
