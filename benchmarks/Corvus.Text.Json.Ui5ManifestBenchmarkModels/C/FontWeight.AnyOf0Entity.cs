...
public readonly partial struct FontWeight
{
...
#endif
    {
        ...
        /// <param name="matchLighter">Match 2nd item.</param>
        /// <param name="matchBolder">Match 3rd item.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Func<TContext, TResult> matchDefault,
            Func<TContext, TResult> matchLighter,
            Func<TContext, TResult> matchBolder,
...
#endif
        {
            ...
            {
                return matchLighter(context);
            }

            if (this.ValueEquals(Constants.Enum3))
            {
                return matchBolder(context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Func<TResult> matchLighter,
            Func<TResult> matchBolder,
