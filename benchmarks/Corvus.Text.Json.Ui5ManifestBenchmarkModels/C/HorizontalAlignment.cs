...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="HorizontalAlignment"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal HorizontalAlignment(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static HorizontalAlignment DefaultInstance { get; }
    ...
    public static explicit operator Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment.AnyOf0Entity(HorizontalAlignment value)
    {
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator HorizontalAlignment(Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment.AnyOf0Entity value)
    {
        return From(value);
    }
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static explicit operator Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment.AnyOf1Entity(HorizontalAlignment value)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator string(HorizontalAlignment value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
    ...
    /// </returns>
    public static bool operator ==(in HorizontalAlignment left, in HorizontalAlignment right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in HorizontalAlignment left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator JsonElement(HorizontalAlignment instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator HorizontalAlignment(JsonElement instance)
    {
        return HorizontalAlignment.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static HorizontalAlignment From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static HorizontalAlignment ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<HorizontalAlignment>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static HorizontalAlignment ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<HorizontalAlignment>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static HorizontalAlignment ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<HorizontalAlignment>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static HorizontalAlignment ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<HorizontalAlignment>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out HorizontalAlignment? result)
    {
        return JsonElementHelpers.TryParseValue<HorizontalAlignment>(ref reader, out result);
    }
...
#if NET
    static HorizontalAlignment IJsonElement<HorizontalAlignment>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"HorizontalAlignment: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// </para>
    /// </remarks>
    public HorizontalAlignment Clone()
    {
        CheckValidInstance();
    ...
    /// </para>
    /// </remarks>
    public HorizontalAlignment Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<HorizontalAlignment>(_idx);
        }
    ...
    public bool TryGetAsAnyOf0Entity(out Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment.AnyOf0Entity result)
    {
        ...
        {
            result = Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment.AnyOf0Entity.From(this);
            return true;
        }
    ...
    public bool TryGetAsAnyOf1Entity(out Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment.AnyOf1Entity result)
    {
        ...
        {
            result = Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment.AnyOf1Entity.From(this);
            return true;
        }
    ...
    public TResult Match<TContext, TResult>(
        ...
        Matcher<Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment, TContext, TResult> defaultMatch)
...
#endif
    {
        if (Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment.AnyOf0Entity.JsonSchema.Evaluate(_parent, _idx))
        {
            return matchAnyOf0Entity(Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment.AnyOf0Entity.From(this), context);
        }

        if (Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
        {
            return matchAnyOf1Entity(Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment.AnyOf1Entity.From(this), context);
        }
    ...
    public TResult Match<TResult>(
        ...
        Matcher<Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment, TResult> defaultMatch)
    {
        if (Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment.AnyOf0Entity.JsonSchema.Evaluate(_parent, _idx))
        {
            return matchAnyOf0Entity(Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment.AnyOf0Entity.From(this));
        }

        if (Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
        {
            return matchAnyOf1Entity(Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment.AnyOf1Entity.From(this));
        }
    ...
    public TAccumulator MatchEvery<TAccumulator>(
        ...
        Matcher<Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment, TAccumulator, TAccumulator> defaultMatch)
    {
        bool matched = false;
        ...
        {
            matched = true;
            accumulator = matchAnyOf0Entity(Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment.AnyOf0Entity.From(this), accumulator);
        }

        if (Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
        {
            matched = true;
            accumulator = matchAnyOf1Entity(Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment.AnyOf1Entity.From(this), accumulator);
        }
