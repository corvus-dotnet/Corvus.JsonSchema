...
public readonly partial struct Image
{
    ...
    public readonly partial struct HeightEntity
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<HeightEntity, Mutable>(HeightEntity.DefaultInstance);
            ...
            /// <summary>
            /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.Mutable(Mutable value)
            {
                return Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.Mutable value)
            {
                return From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.AnyOf0Entity.Mutable(Mutable value)
            {
                return Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.AnyOf0Entity.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.AnyOf0Entity"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.AnyOf0Entity.Mutable value)
            {
                return From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.AnyOf1Entity.Mutable(Mutable value)
            {
                return Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.AnyOf1Entity.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.AnyOf1Entity"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.AnyOf1Entity.Mutable value)
            {
                return From(value);
            }
            ...
            /// <param name="matchBlockElementHeight">Match a <see cref="Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight"/>.</param>
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight, TContext, TResult> matchBlockElementHeight,
                Matcher<Corvus.Ui5ManifestBenchmark.Current.Image.HeightEntity.Mutable, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                if (Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchBlockElementHeight(Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight, TResult> matchBlockElementHeight,
                Matcher<Corvus.Ui5ManifestBenchmark.Current.Image.HeightEntity.Mutable, TResult> defaultMatch)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                ...
                if (Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchBlockElementHeight(Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.Mutable.From(this));
                }
            ...
            public TAccumulator MatchEvery<TAccumulator>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight, TAccumulator, TAccumulator> matchBlockElementHeight,
                Matcher<Corvus.Ui5ManifestBenchmark.Current.Image.HeightEntity.Mutable, TAccumulator, TAccumulator> defaultMatch)
            {
                bool matched = false;
                ...
                {
                    matched = true;
                    accumulator = matchJsonString(Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable.From(this), accumulator);
                }

                if (Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.JsonSchema.Evaluate(_parent, _idx))
                {
                    matched = true;
                    accumulator = matchBlockElementHeight(Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.Mutable.From(this), accumulator);
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.Mutable" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsBlockElementHeight(out Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.Mutable result)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight instance) => new(JsonElement.From(instance));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.AnyOf0Entity instance) => new(JsonElement.From(instance));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.AnyOf1Entity instance) => new(JsonElement.From(instance));
        ...
        public static ParsedJsonDocument<HeightEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<HeightEntity>();
            }
            finally
            {
