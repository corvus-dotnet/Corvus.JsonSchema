...
public readonly partial struct Image
{
...
#endif
    {
        ...
        public static explicit operator Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight(HeightEntity value)
        {
            return Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator HeightEntity(Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.AnyOf0Entity(HeightEntity value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator HeightEntity(Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.AnyOf0Entity value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.AnyOf1Entity(HeightEntity value)
        {
        ...
        public bool TryGetAsBlockElementHeight(out Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight result)
        {
            ...
            {
                result = Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.From(this);
                return true;
            }
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Image.HeightEntity, TContext, TResult> defaultMatch)
...
#endif
        {
            ...
            if (Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchBlockElementHeight(Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Image.HeightEntity, TResult> defaultMatch)
        {
            if (Corvus.Ui5ManifestBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
            {
            ...
            if (Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchBlockElementHeight(Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.From(this));
            }
        ...
        public TAccumulator MatchEvery<TAccumulator>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Image.HeightEntity, TAccumulator, TAccumulator> defaultMatch)
        {
            bool matched = false;
            ...
            {
                matched = true;
                accumulator = matchBlockElementHeight(Corvus.Ui5ManifestBenchmark.Current.BlockElementHeight.From(this), accumulator);
            }
