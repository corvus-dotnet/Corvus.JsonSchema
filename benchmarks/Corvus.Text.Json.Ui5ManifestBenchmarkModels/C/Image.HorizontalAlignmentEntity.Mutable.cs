...
public readonly partial struct Image
{
    ...
    public readonly partial struct HorizontalAlignmentEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(HorizontalAlignmentEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="HorizontalAlignmentEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator HorizontalAlignmentEntity(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new HorizontalAlignmentEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"HorizontalAlignmentEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="HorizontalAlignmentEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="HorizontalAlignmentEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly HorizontalAlignmentEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<HorizontalAlignmentEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="HorizontalAlignmentEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly HorizontalAlignmentEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<HorizontalAlignmentEntity>(_idx);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.Image.HorizontalAlignmentEntity.Mutable, TContext, TResult> defaultMatch)
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.Image.HorizontalAlignmentEntity.Mutable, TResult> defaultMatch)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment.JsonSchema.Evaluate(_parent, _idx))
                {
            ...
            public TAccumulator MatchEvery<TAccumulator>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.Image.HorizontalAlignmentEntity.Mutable, TAccumulator, TAccumulator> defaultMatch)
            {
                bool matched = false;
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(HorizontalAlignmentEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<HorizontalAlignmentEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<HorizontalAlignmentEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<HorizontalAlignmentEntity>();
            }
            finally
            {
