...
public readonly partial struct Image
{
    ...
    public readonly partial struct IfFalseThisItemWillBeRemovedFromTheVisualTree
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<IfFalseThisItemWillBeRemovedFromTheVisualTree, Mutable>(IfFalseThisItemWillBeRemovedFromTheVisualTree.DefaultInstance);
        ...
        public static ParsedJsonDocument<IfFalseThisItemWillBeRemovedFromTheVisualTree> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<IfFalseThisItemWillBeRemovedFromTheVisualTree>();
            }
            finally
            {
