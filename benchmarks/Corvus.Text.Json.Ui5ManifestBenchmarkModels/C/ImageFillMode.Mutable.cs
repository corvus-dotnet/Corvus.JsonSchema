...
public readonly partial struct ImageFillMode
{
...
#endif
    {
        ...
        public static explicit operator Corvus.Ui5ManifestBenchmark.Current.ImageFillMode.AnyOf0Entity.Mutable(Mutable value)
        {
            return Corvus.Ui5ManifestBenchmark.Current.ImageFillMode.AnyOf0Entity.Mutable.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Current.ImageFillMode.AnyOf0Entity.Mutable value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.Ui5ManifestBenchmark.Current.ImageFillMode.AnyOf1Entity.Mutable(Mutable value)
        {
            return Corvus.Ui5ManifestBenchmark.Current.ImageFillMode.AnyOf1Entity.Mutable.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Current.ImageFillMode.AnyOf1Entity.Mutable value)
        {
            return From(value);
        }
        ...
        public static explicit operator Mutable(ImageFillMode instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="ImageFillMode"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ImageFillMode(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ImageFillMode.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly ImageFillMode Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly ImageFillMode Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<ImageFillMode>(_idx);
        }
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.ImageFillMode.Mutable, TContext, TResult> defaultMatch)
...
#endif
        {
            ...
            {
                return matchAnyOf0Entity(Corvus.Ui5ManifestBenchmark.Current.ImageFillMode.AnyOf0Entity.Mutable.From(this), context);
            }

            if (Corvus.Ui5ManifestBenchmark.Current.ImageFillMode.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchAnyOf1Entity(Corvus.Ui5ManifestBenchmark.Current.ImageFillMode.AnyOf1Entity.Mutable.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.ImageFillMode.Mutable, TResult> defaultMatch)
        {
            if (Corvus.Ui5ManifestBenchmark.Current.ImageFillMode.AnyOf0Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchAnyOf0Entity(Corvus.Ui5ManifestBenchmark.Current.ImageFillMode.AnyOf0Entity.Mutable.From(this));
            }

            if (Corvus.Ui5ManifestBenchmark.Current.ImageFillMode.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchAnyOf1Entity(Corvus.Ui5ManifestBenchmark.Current.ImageFillMode.AnyOf1Entity.Mutable.From(this));
            }
        ...
        public TAccumulator MatchEvery<TAccumulator>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.ImageFillMode.Mutable, TAccumulator, TAccumulator> defaultMatch)
        {
            bool matched = false;
            ...
            {
                matched = true;
                accumulator = matchAnyOf0Entity(Corvus.Ui5ManifestBenchmark.Current.ImageFillMode.AnyOf0Entity.Mutable.From(this), accumulator);
            }

            if (Corvus.Ui5ManifestBenchmark.Current.ImageFillMode.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                matched = true;
                accumulator = matchAnyOf1Entity(Corvus.Ui5ManifestBenchmark.Current.ImageFillMode.AnyOf1Entity.Mutable.From(this), accumulator);
            }
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Current.ImageFillMode.AnyOf0Entity.Mutable" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsAnyOf0Entity(out Corvus.Ui5ManifestBenchmark.Current.ImageFillMode.AnyOf0Entity.Mutable result)
        {
            if (Corvus.Ui5ManifestBenchmark.Current.ImageFillMode.AnyOf0Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.Ui5ManifestBenchmark.Current.ImageFillMode.AnyOf0Entity.Mutable.From(this);
                return true;
            }
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Current.ImageFillMode.AnyOf1Entity.Mutable" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsAnyOf1Entity(out Corvus.Ui5ManifestBenchmark.Current.ImageFillMode.AnyOf1Entity.Mutable result)
        {
            if (Corvus.Ui5ManifestBenchmark.Current.ImageFillMode.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.Ui5ManifestBenchmark.Current.ImageFillMode.AnyOf1Entity.Mutable.From(this);
                return true;
            }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(ImageFillMode instance) => new(JsonElement.From(instance));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Current.ImageFillMode.AnyOf0Entity instance) => new(JsonElement.From(instance));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Current.ImageFillMode.AnyOf1Entity instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<ImageFillMode, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<ImageFillMode> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<ImageFillMode>();
        }
        finally
        {
