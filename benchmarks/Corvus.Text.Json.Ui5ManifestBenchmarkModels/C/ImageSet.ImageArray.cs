...
public readonly partial struct ImageSet
{
    ...
    public readonly partial struct ImageArray
#if NET8_0_OR_GREATER
        : IJsonElement<ImageArray>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ImageArray"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ImageArray(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ImageArray DefaultInstance { get; }
        ...
        public Corvus.Ui5ManifestBenchmark.Current.Image this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Ui5ManifestBenchmark.Current.Image>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.Ui5ManifestBenchmark.Current.Image> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Current.Image>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in ImageArray left, in ImageArray right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ImageArray left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(ImageArray instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ImageArray(JsonElement instance)
        {
            return ImageArray.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ImageArray From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ImageArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ImageArray>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ImageArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ImageArray>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ImageArray ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ImageArray>(json, options);
        }
        ...
        /// </exception>
        public static ImageArray ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ImageArray>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ImageArray? result)
        {
            return JsonElementHelpers.TryParseValue<ImageArray>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ImageArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static ImageArray IJsonElement<ImageArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ImageArray: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ImageArray"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ImageArray"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public ImageArray Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ImageArray>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ImageArray"/> that lives for the lifetime of its
