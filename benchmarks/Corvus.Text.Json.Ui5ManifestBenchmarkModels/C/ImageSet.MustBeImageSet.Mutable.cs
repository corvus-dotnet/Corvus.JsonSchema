...
public readonly partial struct ImageSet
{
    ...
    public readonly partial struct MustBeImageSet
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(MustBeImageSet instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MustBeImageSet"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MustBeImageSet(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new MustBeImageSet(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MustBeImageSet.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="MustBeImageSet"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="MustBeImageSet"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeImageSet Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<MustBeImageSet>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="MustBeImageSet"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeImageSet Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MustBeImageSet>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(MustBeImageSet instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<MustBeImageSet, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<MustBeImageSet> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<MustBeImageSet>();
            }
            finally
            {
