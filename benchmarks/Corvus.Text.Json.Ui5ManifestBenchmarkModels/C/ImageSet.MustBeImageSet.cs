...
public readonly partial struct ImageSet
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MustBeImageSet"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal MustBeImageSet(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static MustBeImageSet DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(MustBeImageSet value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in MustBeImageSet left, in MustBeImageSet right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in MustBeImageSet left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(MustBeImageSet instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator MustBeImageSet(JsonElement instance)
        {
            return MustBeImageSet.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MustBeImageSet From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MustBeImageSet ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<MustBeImageSet>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MustBeImageSet ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<MustBeImageSet>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MustBeImageSet ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<MustBeImageSet>(json, options);
        }
        ...
        /// </exception>
        public static MustBeImageSet ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<MustBeImageSet>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out MustBeImageSet? result)
        {
            return JsonElementHelpers.TryParseValue<MustBeImageSet>(ref reader, out result);
        }
...
#if NET
        static MustBeImageSet IJsonElement<MustBeImageSet>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"MustBeImageSet: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public MustBeImageSet Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<MustBeImageSet>(_idx);
            }
