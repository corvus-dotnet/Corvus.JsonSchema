...
#endif
{
    ...
    internal ImageSize(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static ImageSize DefaultInstance { get; }
    ...
    /// <summary>
    /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Current.ImageSize.AnyOf0Entity"/>.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static explicit operator Corvus.Ui5ManifestBenchmark.Current.ImageSize.AnyOf0Entity(ImageSize value)
    {
        return Corvus.Ui5ManifestBenchmark.Current.ImageSize.AnyOf0Entity.From(value);
    }

    /// <summary>
    /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Current.ImageSize.AnyOf0Entity"/>.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator ImageSize(Corvus.Ui5ManifestBenchmark.Current.ImageSize.AnyOf0Entity value)
    {
        return From(value);
    }
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static explicit operator Corvus.Ui5ManifestBenchmark.Current.ImageSize.AnyOf1Entity(ImageSize value)
    {
        return Corvus.Ui5ManifestBenchmark.Current.ImageSize.AnyOf1Entity.From(value);
    }

    /// <summary>
    /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Current.ImageSize.AnyOf1Entity"/>.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator string(ImageSize value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
    ...
    /// </returns>
    public static bool operator ==(in ImageSize left, in ImageSize right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in ImageSize left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator JsonElement(ImageSize instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator ImageSize(JsonElement instance)
    {
        return ImageSize.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ImageSize From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ImageSize ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<ImageSize>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ImageSize ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<ImageSize>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ImageSize ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<ImageSize>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static ImageSize ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<ImageSize>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out ImageSize? result)
    {
        return JsonElementHelpers.TryParseValue<ImageSize>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new ImageSize(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static ImageSize IJsonElement<ImageSize>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"ImageSize: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="ImageSize"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="ImageSize"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    {
        CheckValidInstance();
        return _parent.CloneElement<ImageSize>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="ImageSize"/> that lives for the lifetime of its
    ...
    /// <summary>
    /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Current.ImageSize.AnyOf0Entity" />.
    /// </summary>
    /// <param name="result">The result of the conversions.</param>
    /// <returns><see langword="true" /> if the conversion was valid.</returns>
    public bool TryGetAsAnyOf0Entity(out Corvus.Ui5ManifestBenchmark.Current.ImageSize.AnyOf0Entity result)
    {
        if (Corvus.Ui5ManifestBenchmark.Current.ImageSize.AnyOf0Entity.JsonSchema.Evaluate(_parent, _idx))
        {
            result = Corvus.Ui5ManifestBenchmark.Current.ImageSize.AnyOf0Entity.From(this);
            return true;
        }
    ...
    /// <summary>
    /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Current.ImageSize.AnyOf1Entity" />.
    /// </summary>
    /// <param name="result">The result of the conversions.</param>
    /// <returns><see langword="true" /> if the conversion was valid.</returns>
    public bool TryGetAsAnyOf1Entity(out Corvus.Ui5ManifestBenchmark.Current.ImageSize.AnyOf1Entity result)
    {
        if (Corvus.Ui5ManifestBenchmark.Current.ImageSize.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
        {
            result = Corvus.Ui5ManifestBenchmark.Current.ImageSize.AnyOf1Entity.From(this);
            return true;
        }
    ...
    /// <param name="matchAnyOf0Entity">Match a <see cref="Corvus.Ui5ManifestBenchmark.Current.ImageSize.AnyOf0Entity"/>.</param>
    /// <param name="matchAnyOf1Entity">Match a <see cref="Corvus.Ui5ManifestBenchmark.Current.ImageSize.AnyOf1Entity"/>.</param>
    /// <param name="defaultMatch">Match any other value.</param>
    /// <returns>An instance of the value returned by the match function.</returns>
    public TResult Match<TContext, TResult>(
        in TContext context,
        Matcher<Corvus.Ui5ManifestBenchmark.Current.ImageSize.AnyOf0Entity, TContext, TResult> matchAnyOf0Entity,
        Matcher<Corvus.Ui5ManifestBenchmark.Current.ImageSize.AnyOf1Entity, TContext, TResult> matchAnyOf1Entity,
        Matcher<Corvus.Ui5ManifestBenchmark.Current.ImageSize, TContext, TResult> defaultMatch)
...
#endif
    {
        if (Corvus.Ui5ManifestBenchmark.Current.ImageSize.AnyOf0Entity.JsonSchema.Evaluate(_parent, _idx))
        {
            return matchAnyOf0Entity(Corvus.Ui5ManifestBenchmark.Current.ImageSize.AnyOf0Entity.From(this), context);
        }

        if (Corvus.Ui5ManifestBenchmark.Current.ImageSize.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
        {
            return matchAnyOf1Entity(Corvus.Ui5ManifestBenchmark.Current.ImageSize.AnyOf1Entity.From(this), context);
        }
    ...
    public TResult Match<TResult>(
        Matcher<Corvus.Ui5ManifestBenchmark.Current.ImageSize.AnyOf0Entity, TResult> matchAnyOf0Entity,
        Matcher<Corvus.Ui5ManifestBenchmark.Current.ImageSize.AnyOf1Entity, TResult> matchAnyOf1Entity,
        Matcher<Corvus.Ui5ManifestBenchmark.Current.ImageSize, TResult> defaultMatch)
    {
        if (Corvus.Ui5ManifestBenchmark.Current.ImageSize.AnyOf0Entity.JsonSchema.Evaluate(_parent, _idx))
        {
            return matchAnyOf0Entity(Corvus.Ui5ManifestBenchmark.Current.ImageSize.AnyOf0Entity.From(this));
        }

        if (Corvus.Ui5ManifestBenchmark.Current.ImageSize.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
        {
            return matchAnyOf1Entity(Corvus.Ui5ManifestBenchmark.Current.ImageSize.AnyOf1Entity.From(this));
        }
    ...
    public TAccumulator MatchEvery<TAccumulator>(
        ...
        Matcher<Corvus.Ui5ManifestBenchmark.Current.ImageSize.AnyOf0Entity, TAccumulator, TAccumulator> matchAnyOf0Entity,
        Matcher<Corvus.Ui5ManifestBenchmark.Current.ImageSize.AnyOf1Entity, TAccumulator, TAccumulator> matchAnyOf1Entity,
        Matcher<Corvus.Ui5ManifestBenchmark.Current.ImageSize, TAccumulator, TAccumulator> defaultMatch)
    {
        bool matched = false;
        ...
        {
            matched = true;
            accumulator = matchAnyOf0Entity(Corvus.Ui5ManifestBenchmark.Current.ImageSize.AnyOf0Entity.From(this), accumulator);
        }

        if (Corvus.Ui5ManifestBenchmark.Current.ImageSize.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
        {
            matched = true;
            accumulator = matchAnyOf1Entity(Corvus.Ui5ManifestBenchmark.Current.ImageSize.AnyOf1Entity.From(this), accumulator);
        }
