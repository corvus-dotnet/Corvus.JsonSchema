...
public readonly partial struct ImplementationsOfElement
{
    ...
    public readonly partial struct ImplementationsOfElementRequiredType7
    {
...
#endif
        {
            ...
            public static implicit operator Corvus.Ui5ManifestBenchmark.Current.Container.Mutable(Mutable value)
            {
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Current.Container.Mutable" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsContainer(out Corvus.Ui5ManifestBenchmark.Current.Container.Mutable result)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.Container.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Ui5ManifestBenchmark.Current.Container.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.Ui5ManifestBenchmark.Current.Container.MustBeContainer.Source _createArg2;
            private readonly Corvus.Ui5ManifestBenchmark.Current.Container.BackgroundImageEntity.Source _createArg3;
            ...
            private readonly Corvus.Ui5ManifestBenchmark.Current.Container.RtlEntity.Source _createArg11;
            private readonly Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfISelectAction.Source _createArg12;
            ...
            private readonly Corvus.Ui5ManifestBenchmark.Current.Container.StyleHintForContainer.Source _createArg15;
            ...
            #endif
        {
            ...
            private readonly Corvus.Ui5ManifestBenchmark.Current.Container.MustBeContainer.Source _createArg2;
            private readonly Corvus.Ui5ManifestBenchmark.Current.Container.BackgroundImageEntity.Source<TContext> _createArg3;
            private readonly Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source _createArg4;
            ...
            private readonly Corvus.Ui5ManifestBenchmark.Current.Container.RtlEntity.Source _createArg11;
            private readonly Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfISelectAction.Source<TContext> _createArg12;
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.Ui5ManifestBenchmark.Current.Container.MustBeContainer.Source type,
        ...
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Current.Container.ImplementationsOfElementArray.Source<TContext> items, scoped in Corvus.Ui5ManifestBenchmark.Current.Container.MustBeContainer.Source type, scoped in Corvus.Ui5ManifestBenchmark.Current.Container.BackgroundImageEntity.Source<TContext> backgroundImage = default, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source bleed = default, scoped in Corvus.Text.Json.JsonElement.Source<TContext> fallback = default, scoped in Corvus.Text.Json.JsonElement.Source<TContext> height = default, scoped in Corvus.Text.Json.JsonElement.Source<TContext> id = default, scoped in Corvus.Text.Json.JsonElement.Source<TContext> isVisible = default, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source minHeight = default, scoped in Corvus.Text.Json.JsonElement.Source<TContext> requires = default, scoped in Corvus.Ui5ManifestBenchmark.Current.Container.RtlEntity.Source rtl = default, scoped in Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfISelectAction.Source<TContext> selectAction = default, scoped in Corvus.Text.Json.JsonElement.Source<TContext> separator = default, scoped in Corvus.Text.Json.JsonElement.Source<TContext> spacing = default, scoped in Corvus.Ui5ManifestBenchmark.Current.Container.StyleHintForContainer.Source style = default, scoped in Corvus.Ui5ManifestBenchmark.Current.Container.VerticalContentAlignmentEntity.Source verticalContentAlignment = default)
            ...
            #endif
        {
            return new Source<TContext>(context, items, type, backgroundImage, bleed, fallback, height, id, isVisible, minHeight, requires, rtl, selectAction, separator, spacing, style, verticalContentAlignment);
        }
        ...
        public static ParsedJsonDocument<ImplementationsOfElementRequiredType7> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ImplementationsOfElementRequiredType7>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ImplementationsOfElementRequiredType7> Create<TContext>(
        ...
        public static ParsedJsonDocument<ImplementationsOfElementRequiredType7> Create(in Corvus.Ui5ManifestBenchmark.Current.Container.ImplementationsOfElementArray.Source items, in Corvus.Ui5ManifestBenchmark.Current.Container.MustBeContainer.Source type, in Corvus.Ui5ManifestBenchmark.Current.Container.BackgroundImageEntity.Source backgroundImage = default, in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source bleed = default, in Corvus.Text.Json.JsonElement.Source fallback = default, in Corvus.Text.Json.JsonElement.Source height = default, in Corvus.Text.Json.JsonElement.Source id = default, in Corvus.Text.Json.JsonElement.Source isVisible = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source minHeight = default, in Corvus.Text.Json.JsonElement.Source requires = default, in Corvus.Ui5ManifestBenchmark.Current.Container.RtlEntity.Source rtl = default, in Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfISelectAction.Source selectAction = default, in Corvus.Text.Json.JsonElement.Source separator = default, in Corvus.Text.Json.JsonElement.Source spacing = default, in Corvus.Ui5ManifestBenchmark.Current.Container.StyleHintForContainer.Source style = default, in Corvus.Ui5ManifestBenchmark.Current.Container.VerticalContentAlignmentEntity.Source verticalContentAlignment = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ImplementationsOfElementRequiredType7> Create<TContext>(in TContext context, in Corvus.Ui5ManifestBenchmark.Current.Container.ImplementationsOfElementArray.Source<TContext> items, in Corvus.Ui5ManifestBenchmark.Current.Container.MustBeContainer.Source type, in Corvus.Ui5ManifestBenchmark.Current.Container.BackgroundImageEntity.Source<TContext> backgroundImage = default, in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source bleed = default, in Corvus.Text.Json.JsonElement.Source<TContext> fallback = default, in Corvus.Text.Json.JsonElement.Source<TContext> height = default, in Corvus.Text.Json.JsonElement.Source<TContext> id = default, in Corvus.Text.Json.JsonElement.Source<TContext> isVisible = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source minHeight = default, in Corvus.Text.Json.JsonElement.Source<TContext> requires = default, in Corvus.Ui5ManifestBenchmark.Current.Container.RtlEntity.Source rtl = default, in Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfISelectAction.Source<TContext> selectAction = default, in Corvus.Text.Json.JsonElement.Source<TContext> separator = default, in Corvus.Text.Json.JsonElement.Source<TContext> spacing = default, in Corvus.Ui5ManifestBenchmark.Current.Container.StyleHintForContainer.Source style = default, in Corvus.Ui5ManifestBenchmark.Current.Container.VerticalContentAlignmentEntity.Source verticalContentAlignment = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
