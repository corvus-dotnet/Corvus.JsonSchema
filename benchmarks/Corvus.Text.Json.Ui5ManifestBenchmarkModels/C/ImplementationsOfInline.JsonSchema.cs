    ...
    : IJsonElement<ImplementationsOfInline>
{
    public static partial class JsonSchema
    {
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/https:~1~1adaptivecards.io~1schemas~1adaptive-card.json/definitions/ImplementationsOf.Inline"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/definitions/https:~1~1adaptivecards.io~1schemas~1adaptive-card.json/definitions/ImplementationsOf.Inline";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/https:~1~1adaptivecards.io~1schemas~1adaptive-card.json/definitions/ImplementationsOf.Inline"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            JsonSchemaContext anyOfContext0 =
                Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline.RequiredType.JsonSchema.PushChildContext(parentDocument, parentIndex, ref context, schemaEvaluationPath: AnyOf0SchemaEvaluationPath);
            Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline.RequiredType.JsonSchema.Evaluate(parentDocument, parentIndex, ref anyOfContext0);
