...
public readonly partial struct ImplementationsOfInline
{
...
#endif
    {
        ...
        /// <summary>
        /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline.RequiredType"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline.RequiredType.Mutable(Mutable value)
        {
            return Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline.RequiredType.Mutable.From(value);
        }

        /// <summary>
        /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline.RequiredType"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline.RequiredType.Mutable value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.Ui5ManifestBenchmark.Current.TextRun.Mutable(Mutable value)
        {
        ...
        public static explicit operator Mutable(ImplementationsOfInline instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="ImplementationsOfInline"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ImplementationsOfInline(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ImplementationsOfInline(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        /// </remarks>
        public void Apply(in Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline.RequiredType value)
        {
            CheckValidInstance();
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ImplementationsOfInline.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ImplementationsOfInline"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ImplementationsOfInline"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly ImplementationsOfInline Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ImplementationsOfInline>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ImplementationsOfInline"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly ImplementationsOfInline Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<ImplementationsOfInline>(_idx);
        }

        /// <summary>
        /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline.RequiredType.Mutable" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsRequiredType(out Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline.RequiredType.Mutable result)
        {
            if (Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline.RequiredType.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline.RequiredType.Mutable.From(this);
                return true;
            }
        ...
        #endif
    {
        ...
        TContext _context;
        Source _source;
        private readonly Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline.RequiredType.Builder.Build<TContext>? _requiredTypeBuilderInstance;
        ...
        public Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline.RequiredType.Builder.Build<TContext> value) {_context = context; _requiredTypeBuilderInstance = value; _kind = Kind.RequiredTypeBuilder; }
        ...
        internal void AddAsProperty(ReadOnlySpan<byte> utf8Name, ref ComplexValueBuilder valueBuilder, bool escapeName = true, bool nameRequiresUnescaping = false)
        {
            switch(_kind)
            {
                ...
                case Kind.Source:
                    ...
                    break;
                case Kind.RequiredTypeBuilder:
                    valueBuilder.AddProperty(utf8Name, BuildWithContext.Create(_context, _requiredTypeBuilderInstance!), static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline.RequiredType.Builder.BuildValue(b.Context, b.Build, ref o), escapeName, nameRequiresUnescaping);
                    break;
                default:
                    Debug.Fail("Unexpected Kind");
                    break;
        ...
        internal void AddAsPrebakedProperty(ReadOnlySpan<byte> prebakedPropertyName, ref ComplexValueBuilder valueBuilder)
        {
            switch(_kind)
            {
                ...
                case Kind.Source:
                    ...
                    break;
                case Kind.RequiredTypeBuilder:
                    valueBuilder.AddPrebakedProperty(prebakedPropertyName, BuildWithContext.Create(_context, _requiredTypeBuilderInstance!), static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline.RequiredType.Builder.BuildValue(b.Context, b.Build, ref o));
                    break;
                default:
                    Debug.Fail("Unexpected Kind");
                    break;
        ...
        internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
        {
            switch(_kind)
            {
                ...
                case Kind.Source:
                    ...
                    break;
                case Kind.RequiredTypeBuilder:
                    valueBuilder.AddProperty(name, BuildWithContext.Create(_context, _requiredTypeBuilderInstance!), static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline.RequiredType.Builder.BuildValue(b.Context, b.Build, ref o));
                    break;
                default:
                    Debug.Fail("Unexpected Kind");
                    break;
        ...
        internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
        {
            switch(_kind)
            {
                ...
                case Kind.Source:
                    ...
                    break;
                case Kind.RequiredTypeBuilder:
                    valueBuilder.AddItem(BuildWithContext.Create(_context, _requiredTypeBuilderInstance!), static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline.RequiredType.Builder.BuildValue(b.Context, b.Build, ref o));
                    break;
                default:
                    Debug.Fail("Unexpected Kind");
                    break;
    ...
    public static Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline.RequiredType.Source Build(
        scoped in Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline.RequiredType.Builder.Build buildValue, int initialCapacity = 1)
    {
        return new Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline.RequiredType.Source(buildValue);
    }
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline.RequiredType.Source<TContext> Build<TContext>(
        scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline.RequiredType.Builder.Build<TContext> buildValue, int initialCapacity = 1)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        return new Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline.RequiredType.Source<TContext>(context, buildValue);
    }
    ...
    /// <returns>An instance of a mutable document initialized with the given value.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(
        JsonWorkspace workspace, scoped in Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline.RequiredType.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
    {
        // Create the document builder without a MetadataDb
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        var source = new Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline.RequiredType.Source(value);
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(
        JsonWorkspace workspace, scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline.RequiredType.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        ...
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        var source = new Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline.RequiredType.Source<TContext>(context, value);
        source.AddAsItem(ref cvb);
        Debug.Assert(cvb.MemberCount == 1);
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<ImplementationsOfInline, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<ImplementationsOfInline> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<ImplementationsOfInline>();
        }
        finally
        {
    ...
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<ImplementationsOfInline> Create(
        scoped in Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline.RequiredType.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent(initialValueBufferSize);
        try
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<ImplementationsOfInline> Create<TContext>(
        scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline.RequiredType.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
