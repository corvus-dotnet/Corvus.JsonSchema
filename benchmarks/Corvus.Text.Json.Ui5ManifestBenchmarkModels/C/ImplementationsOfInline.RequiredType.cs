...
public readonly partial struct ImplementationsOfInline
{
...
#endif
    {
        ...
        public static implicit operator Corvus.Ui5ManifestBenchmark.Current.TextRun(RequiredType value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator RequiredType(Corvus.Ui5ManifestBenchmark.Current.TextRun value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText(RequiredType value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator RequiredType(Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText value)
        {
            return From(value);
        }
        ...
        public bool TryGetAsTextRun(out Corvus.Ui5ManifestBenchmark.Current.TextRun result)
        {
            ...
            {
                result = Corvus.Ui5ManifestBenchmark.Current.TextRun.From(this);
                return true;
            }
