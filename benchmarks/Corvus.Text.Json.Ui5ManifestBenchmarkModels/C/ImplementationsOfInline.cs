...
#endif
{
    ...
    public static explicit operator Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline.RequiredType(ImplementationsOfInline value)
    {
        return Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline.RequiredType.From(value);
    }
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator ImplementationsOfInline(Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline.RequiredType value)
    {
        return From(value);
    }

    /// <summary>
    /// Conversion from the <see cref="Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline.RequiredType"/> mutable view.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator ImplementationsOfInline(Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline.RequiredType.Mutable value)
    {
        return From(value);
    }
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static explicit operator Corvus.Ui5ManifestBenchmark.Current.TextRun(ImplementationsOfInline value)
    {
        return Corvus.Ui5ManifestBenchmark.Current.TextRun.From(value);
    }
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static explicit operator ImplementationsOfInline(Corvus.Ui5ManifestBenchmark.Current.TextRun value)
    {
        return From(value);
    }
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static explicit operator Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText(ImplementationsOfInline value)
    {
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static explicit operator ImplementationsOfInline(Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText value)
    {
        return From(value);
    }
    ...
    public bool TryGetAsRequiredType(out Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline.RequiredType result)
    {
        ...
        {
            result = Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline.RequiredType.From(this);
            return true;
        }
