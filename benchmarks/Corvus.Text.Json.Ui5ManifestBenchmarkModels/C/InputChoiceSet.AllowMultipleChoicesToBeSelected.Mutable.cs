...
public readonly partial struct InputChoiceSet
{
    ...
    public readonly partial struct AllowMultipleChoicesToBeSelected
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<AllowMultipleChoicesToBeSelected, Mutable>(AllowMultipleChoicesToBeSelected.DefaultInstance);
            ...
            public static explicit operator Mutable(AllowMultipleChoicesToBeSelected instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="AllowMultipleChoicesToBeSelected"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AllowMultipleChoicesToBeSelected(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new AllowMultipleChoicesToBeSelected(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AllowMultipleChoicesToBeSelected.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="AllowMultipleChoicesToBeSelected"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="AllowMultipleChoicesToBeSelected"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly AllowMultipleChoicesToBeSelected Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<AllowMultipleChoicesToBeSelected>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="AllowMultipleChoicesToBeSelected"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly AllowMultipleChoicesToBeSelected Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<AllowMultipleChoicesToBeSelected>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(AllowMultipleChoicesToBeSelected instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<AllowMultipleChoicesToBeSelected, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<AllowMultipleChoicesToBeSelected> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<AllowMultipleChoicesToBeSelected>();
            }
            finally
            {
