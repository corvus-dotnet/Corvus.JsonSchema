...
public readonly partial struct InputChoiceSet
{
    ...
    public readonly partial struct AllowMultipleChoicesToBeSelected
        ...
        : IJsonElement<AllowMultipleChoicesToBeSelected>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AllowMultipleChoicesToBeSelected"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal AllowMultipleChoicesToBeSelected(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static AllowMultipleChoicesToBeSelected DefaultInstance { get; } = ParsedJsonDocument<AllowMultipleChoicesToBeSelected>.False;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator bool(AllowMultipleChoicesToBeSelected value)
        {
        ...
        /// </returns>
        public static bool operator ==(in AllowMultipleChoicesToBeSelected left, in AllowMultipleChoicesToBeSelected right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in AllowMultipleChoicesToBeSelected left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(AllowMultipleChoicesToBeSelected instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator AllowMultipleChoicesToBeSelected(JsonElement instance)
        {
            return AllowMultipleChoicesToBeSelected.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AllowMultipleChoicesToBeSelected From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AllowMultipleChoicesToBeSelected ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AllowMultipleChoicesToBeSelected>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AllowMultipleChoicesToBeSelected ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AllowMultipleChoicesToBeSelected>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AllowMultipleChoicesToBeSelected ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AllowMultipleChoicesToBeSelected>(json, options);
        }
        ...
        /// </exception>
        public static AllowMultipleChoicesToBeSelected ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<AllowMultipleChoicesToBeSelected>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out AllowMultipleChoicesToBeSelected? result)
        {
            return JsonElementHelpers.TryParseValue<AllowMultipleChoicesToBeSelected>(ref reader, out result);
        }
...
#if NET
        static AllowMultipleChoicesToBeSelected IJsonElement<AllowMultipleChoicesToBeSelected>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"AllowMultipleChoicesToBeSelected: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public AllowMultipleChoicesToBeSelected Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public AllowMultipleChoicesToBeSelected Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<AllowMultipleChoicesToBeSelected>(_idx);
            }
