...
public readonly partial struct InputChoiceSet
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InputChoiceArray"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal InputChoiceArray(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static InputChoiceArray DefaultInstance { get; }
        ...
        public Corvus.Ui5ManifestBenchmark.Current.InputChoice this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Ui5ManifestBenchmark.Current.InputChoice>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.Ui5ManifestBenchmark.Current.InputChoice> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Current.InputChoice>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in InputChoiceArray left, in InputChoiceArray right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in InputChoiceArray left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(InputChoiceArray instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator InputChoiceArray(JsonElement instance)
        {
            return InputChoiceArray.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static InputChoiceArray From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static InputChoiceArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<InputChoiceArray>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static InputChoiceArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<InputChoiceArray>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static InputChoiceArray ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<InputChoiceArray>(json, options);
        }
        ...
        /// </exception>
        public static InputChoiceArray ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<InputChoiceArray>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out InputChoiceArray? result)
        {
            return JsonElementHelpers.TryParseValue<InputChoiceArray>(ref reader, out result);
        }
...
#if NET
        static InputChoiceArray IJsonElement<InputChoiceArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"InputChoiceArray: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public InputChoiceArray Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<InputChoiceArray>(_idx);
            }
