...
public readonly partial struct InputDate
{
    ...
    public readonly partial struct MustBeInputDate
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(MustBeInputDate instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MustBeInputDate"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MustBeInputDate(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new MustBeInputDate(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MustBeInputDate.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="MustBeInputDate"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="MustBeInputDate"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeInputDate Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<MustBeInputDate>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="MustBeInputDate"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeInputDate Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MustBeInputDate>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(MustBeInputDate instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<MustBeInputDate, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<MustBeInputDate> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<MustBeInputDate>();
            }
            finally
            {
