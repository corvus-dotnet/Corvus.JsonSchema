...
public readonly partial struct InputDate
{
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Ui5ManifestBenchmark.Current.InputDate.MustBeInputDate.Source _createArg14;
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Corvus.Ui5ManifestBenchmark.Current.InputDate.MustBeInputDate.Source type = default,
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.JsonElement.Source id, in Corvus.Text.Json.JsonElement.Source errorMessage = default, in Corvus.Text.Json.JsonElement.Source fallback = default, in Corvus.Text.Json.JsonElement.Source height = default, in Corvus.Text.Json.JsonElement.Source isRequired = default, in Corvus.Text.Json.JsonElement.Source isVisible = default, in Corvus.Text.Json.JsonElement.Source label = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source max = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source min = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source placeholder = default, in Corvus.Text.Json.JsonElement.Source requires = default, in Corvus.Text.Json.JsonElement.Source separator = default, in Corvus.Text.Json.JsonElement.Source spacing = default, in Corvus.Ui5ManifestBenchmark.Current.InputDate.MustBeInputDate.Source type = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source value = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    public static ParsedJsonDocument<InputDate> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<InputDate>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<InputDate> Create<TContext>(
    ...
    public static ParsedJsonDocument<InputDate> Create(in Corvus.Text.Json.JsonElement.Source id, in Corvus.Text.Json.JsonElement.Source errorMessage = default, in Corvus.Text.Json.JsonElement.Source fallback = default, in Corvus.Text.Json.JsonElement.Source height = default, in Corvus.Text.Json.JsonElement.Source isRequired = default, in Corvus.Text.Json.JsonElement.Source isVisible = default, in Corvus.Text.Json.JsonElement.Source label = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source max = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source min = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source placeholder = default, in Corvus.Text.Json.JsonElement.Source requires = default, in Corvus.Text.Json.JsonElement.Source separator = default, in Corvus.Text.Json.JsonElement.Source spacing = default, in Corvus.Ui5ManifestBenchmark.Current.InputDate.MustBeInputDate.Source type = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source value = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
    public static ParsedJsonDocument<InputDate> Create<TContext>(in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> id, in Corvus.Text.Json.JsonElement.Source<TContext> errorMessage = default, in Corvus.Text.Json.JsonElement.Source<TContext> fallback = default, in Corvus.Text.Json.JsonElement.Source<TContext> height = default, in Corvus.Text.Json.JsonElement.Source<TContext> isRequired = default, in Corvus.Text.Json.JsonElement.Source<TContext> isVisible = default, in Corvus.Text.Json.JsonElement.Source<TContext> label = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source max = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source min = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source placeholder = default, in Corvus.Text.Json.JsonElement.Source<TContext> requires = default, in Corvus.Text.Json.JsonElement.Source<TContext> separator = default, in Corvus.Text.Json.JsonElement.Source<TContext> spacing = default, in Corvus.Ui5ManifestBenchmark.Current.InputDate.MustBeInputDate.Source type = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source value = default, int initialCapacity = 30)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
