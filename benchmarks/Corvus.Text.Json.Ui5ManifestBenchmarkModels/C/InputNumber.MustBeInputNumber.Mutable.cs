...
public readonly partial struct InputNumber
{
    ...
    public readonly partial struct MustBeInputNumber
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(MustBeInputNumber instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MustBeInputNumber"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MustBeInputNumber(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new MustBeInputNumber(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MustBeInputNumber.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="MustBeInputNumber"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="MustBeInputNumber"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeInputNumber Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<MustBeInputNumber>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="MustBeInputNumber"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeInputNumber Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MustBeInputNumber>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(MustBeInputNumber instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<MustBeInputNumber, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<MustBeInputNumber> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<MustBeInputNumber>();
            }
            finally
            {
