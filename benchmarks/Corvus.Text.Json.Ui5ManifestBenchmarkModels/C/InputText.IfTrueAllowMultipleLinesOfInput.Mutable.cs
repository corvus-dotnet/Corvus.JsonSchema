...
public readonly partial struct InputText
{
    ...
    public readonly partial struct IfTrueAllowMultipleLinesOfInput
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<IfTrueAllowMultipleLinesOfInput, Mutable>(IfTrueAllowMultipleLinesOfInput.DefaultInstance);
        ...
        public static ParsedJsonDocument<IfTrueAllowMultipleLinesOfInput> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<IfTrueAllowMultipleLinesOfInput>();
            }
            finally
            {
