...
public readonly partial struct InputText
{
    ...
    public readonly partial struct MustBeInputText
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(MustBeInputText instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MustBeInputText"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MustBeInputText(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new MustBeInputText(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MustBeInputText.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="MustBeInputText"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="MustBeInputText"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeInputText Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<MustBeInputText>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="MustBeInputText"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeInputText Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MustBeInputText>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(MustBeInputText instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<MustBeInputText, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<MustBeInputText> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<MustBeInputText>();
            }
            finally
            {
