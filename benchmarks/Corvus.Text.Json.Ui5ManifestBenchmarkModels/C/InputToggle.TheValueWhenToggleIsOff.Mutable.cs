...
public readonly partial struct InputToggle
{
    ...
    public readonly partial struct TheValueWhenToggleIsOff
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<TheValueWhenToggleIsOff, Mutable>(TheValueWhenToggleIsOff.DefaultInstance);
        ...
        public static ParsedJsonDocument<TheValueWhenToggleIsOff> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<TheValueWhenToggleIsOff>();
            }
            finally
            {
