...
public readonly partial struct InputToggle
{
    ...
    public readonly partial struct TheValueWhenToggleIsOff
#if NET8_0_OR_GREATER
        : IJsonElement<TheValueWhenToggleIsOff>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TheValueWhenToggleIsOff"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal TheValueWhenToggleIsOff(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static TheValueWhenToggleIsOff DefaultInstance { get; } = ParsedJsonDocument<TheValueWhenToggleIsOff>.StringConstant([.."\"false\""u8]);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(TheValueWhenToggleIsOff value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in TheValueWhenToggleIsOff left, in TheValueWhenToggleIsOff right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in TheValueWhenToggleIsOff left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(TheValueWhenToggleIsOff instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TheValueWhenToggleIsOff(JsonElement instance)
        {
            return TheValueWhenToggleIsOff.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheValueWhenToggleIsOff From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheValueWhenToggleIsOff ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TheValueWhenToggleIsOff>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheValueWhenToggleIsOff ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TheValueWhenToggleIsOff>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TheValueWhenToggleIsOff ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TheValueWhenToggleIsOff>(json, options);
        }
        ...
        /// </exception>
        public static TheValueWhenToggleIsOff ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<TheValueWhenToggleIsOff>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out TheValueWhenToggleIsOff? result)
        {
            return JsonElementHelpers.TryParseValue<TheValueWhenToggleIsOff>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new TheValueWhenToggleIsOff(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static TheValueWhenToggleIsOff IJsonElement<TheValueWhenToggleIsOff>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TheValueWhenToggleIsOff: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="TheValueWhenToggleIsOff"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="TheValueWhenToggleIsOff"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public TheValueWhenToggleIsOff Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<TheValueWhenToggleIsOff>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="TheValueWhenToggleIsOff"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public TheValueWhenToggleIsOff Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<TheValueWhenToggleIsOff>(_idx);
            }
