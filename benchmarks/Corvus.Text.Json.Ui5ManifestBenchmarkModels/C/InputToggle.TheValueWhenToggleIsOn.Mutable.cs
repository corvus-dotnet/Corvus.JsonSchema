...
public readonly partial struct InputToggle
{
    ...
    public readonly partial struct TheValueWhenToggleIsOn
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<TheValueWhenToggleIsOn, Mutable>(TheValueWhenToggleIsOn.DefaultInstance);
            ...
            public static explicit operator Mutable(TheValueWhenToggleIsOn instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="TheValueWhenToggleIsOn"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TheValueWhenToggleIsOn(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TheValueWhenToggleIsOn.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly TheValueWhenToggleIsOn Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly TheValueWhenToggleIsOn Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<TheValueWhenToggleIsOn>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(TheValueWhenToggleIsOn instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<TheValueWhenToggleIsOn, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<TheValueWhenToggleIsOn> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<TheValueWhenToggleIsOn>();
            }
            finally
            {
