...
public readonly partial struct JsonArray
{
    ...
    public ref struct Source
    {
        ...
        internal Source(Corvus.Ui5ManifestBenchmark.Current.JsonArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.JsonArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
