...
public readonly partial struct JsonUriTemplate
{
...
#endif
    {
        ...
        public static explicit operator Mutable(JsonUriTemplate instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="JsonUriTemplate"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonUriTemplate(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new JsonUriTemplate(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"JsonUriTemplate.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="JsonUriTemplate"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="JsonUriTemplate"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly JsonUriTemplate Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<JsonUriTemplate>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="JsonUriTemplate"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly JsonUriTemplate Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<JsonUriTemplate>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(JsonUriTemplate instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<JsonUriTemplate, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<JsonUriTemplate> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<JsonUriTemplate>();
        }
        finally
        {
