...
public readonly partial struct Media
{
    ...
    public readonly partial struct MediaSourceArray
#if NET8_0_OR_GREATER
        : IJsonElement<MediaSourceArray>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MediaSourceArray"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal MediaSourceArray(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static MediaSourceArray DefaultInstance { get; }
        ...
        public Corvus.Ui5ManifestBenchmark.Current.MediaSource this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Ui5ManifestBenchmark.Current.MediaSource>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.Ui5ManifestBenchmark.Current.MediaSource> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Current.MediaSource>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in MediaSourceArray left, in MediaSourceArray right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in MediaSourceArray left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(MediaSourceArray instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator MediaSourceArray(JsonElement instance)
        {
            return MediaSourceArray.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MediaSourceArray From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MediaSourceArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<MediaSourceArray>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MediaSourceArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<MediaSourceArray>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MediaSourceArray ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<MediaSourceArray>(json, options);
        }
        ...
        /// </exception>
        public static MediaSourceArray ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<MediaSourceArray>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out MediaSourceArray? result)
        {
            return JsonElementHelpers.TryParseValue<MediaSourceArray>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new MediaSourceArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static MediaSourceArray IJsonElement<MediaSourceArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"MediaSourceArray: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="MediaSourceArray"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="MediaSourceArray"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public MediaSourceArray Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<MediaSourceArray>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="MediaSourceArray"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public MediaSourceArray Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<MediaSourceArray>(_idx);
            }
