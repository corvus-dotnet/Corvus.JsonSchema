...
public readonly partial struct Media
{
    ...
    public readonly partial struct MustBeMedia
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(MustBeMedia instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MustBeMedia"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MustBeMedia(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new MustBeMedia(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MustBeMedia.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="MustBeMedia"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="MustBeMedia"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeMedia Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<MustBeMedia>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="MustBeMedia"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeMedia Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MustBeMedia>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(MustBeMedia instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<MustBeMedia, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<MustBeMedia> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<MustBeMedia>();
            }
            finally
            {
