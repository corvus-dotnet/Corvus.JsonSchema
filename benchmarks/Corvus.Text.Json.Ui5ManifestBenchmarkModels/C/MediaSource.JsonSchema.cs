    ...
    : IJsonElement<MediaSource>
{
    public static partial class JsonSchema
    {
        ...
        private static void MatchMimeType(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
        {
