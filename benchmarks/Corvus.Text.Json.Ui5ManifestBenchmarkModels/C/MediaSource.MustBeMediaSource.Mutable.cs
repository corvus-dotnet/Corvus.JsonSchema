...
public readonly partial struct MediaSource
{
    ...
    public readonly partial struct MustBeMediaSource
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(MustBeMediaSource instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MustBeMediaSource"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MustBeMediaSource(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MustBeMediaSource.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeMediaSource Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeMediaSource Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MustBeMediaSource>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(MustBeMediaSource instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<MustBeMediaSource, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<MustBeMediaSource> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<MustBeMediaSource>();
            }
            finally
            {
