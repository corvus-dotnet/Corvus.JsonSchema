...
public readonly partial struct MediaSource
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable MimeType
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MimeTypeUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.MediaSource.MustBeMediaSource.Mutable Type
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Ui5ManifestBenchmark.Current.MediaSource.MustBeMediaSource.Mutable value))
                {
                    return value;
                }
        ...
        public void SetMimeType(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source value)
        {
            ...
            else
            {
                ...
                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.MimeType, ref cvb);
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Ui5ManifestBenchmark.Current.MediaSource.MustBeMediaSource.Source _createArg3;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.MediaSource.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source mimeType,
            in Corvus.Ui5ManifestBenchmark.Current.JsonUriReference.Source url,
            in Corvus.Ui5ManifestBenchmark.Current.MediaSource.MustBeMediaSource.Source type = default)
        {
            mimeType.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.MimeType, ref builder);
    ...
    /// </summary>
    /// <param name="mimeType">The value of the <c>"mimeType"</c> property.</param>
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source mimeType, in Corvus.Ui5ManifestBenchmark.Current.JsonUriReference.Source url, in Corvus.Ui5ManifestBenchmark.Current.MediaSource.MustBeMediaSource.Source type = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    public static ParsedJsonDocument<MediaSource> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<MediaSource>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<MediaSource> Create<TContext>(
    ...
    public static ParsedJsonDocument<MediaSource> Create(in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source mimeType, in Corvus.Ui5ManifestBenchmark.Current.JsonUriReference.Source url, in Corvus.Ui5ManifestBenchmark.Current.MediaSource.MustBeMediaSource.Source type = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
