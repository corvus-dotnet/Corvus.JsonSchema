...
public readonly partial struct MediaSource
#if NET8_0_OR_GREATER
    : IJsonElement<MediaSource>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="MediaSource"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal MediaSource(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static MediaSource DefaultInstance { get; }

    /// <summary>
    /// Gets the <c>mimeType</c> property.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public Corvus.Ui5ManifestBenchmark.Current.JsonString MimeType
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MimeTypeUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Ui5ManifestBenchmark.Current.MediaSource.MustBeMediaSource Type
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Ui5ManifestBenchmark.Current.MediaSource.MustBeMediaSource value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in MediaSource left, in MediaSource right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in MediaSource left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(MediaSource instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator MediaSource(JsonElement instance)
    {
        return MediaSource.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static MediaSource From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static MediaSource ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<MediaSource>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static MediaSource ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<MediaSource>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static MediaSource ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<MediaSource>(json, options);
    }
    ...
    /// </exception>
    public static MediaSource ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<MediaSource>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out MediaSource? result)
    {
        return JsonElementHelpers.TryParseValue<MediaSource>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new MediaSource(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static MediaSource IJsonElement<MediaSource>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"MediaSource: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="MediaSource"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="MediaSource"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    {
        CheckValidInstance();
        return _parent.CloneElement<MediaSource>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="MediaSource"/> that lives for the lifetime of its
    ...
    {
        /// <summary>
        /// Gets the JSON property name for <see cref="MimeType"/>.
        /// </summary>
        ...
        /// Gets the JSON property name for <see cref="MimeType"/>.
        /// </summary>
        public static ReadOnlySpan<byte> MimeTypeUtf8 => "mimeType"u8;
    ...
    {
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="MimeType"/>.
        /// </summary>
    ...
    {
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="MimeType"/>.
        /// </summary>
        public static ReadOnlySpan<byte> MimeType => [0xA5, 0x00, 0x00, 0x00, 0x22, 0x6D, 0x69, 0x6D, 0x65, 0x54, 0x79, 0x70, 0x65, 0x22];
