...
public readonly partial struct Refresh
#if NET8_0_OR_GREATER
    : IJsonElement<Refresh>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="Refresh"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal Refresh(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static Refresh DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Ui5ManifestBenchmark.Current.ActionExecute Action
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ActionUtf8, out Corvus.Ui5ManifestBenchmark.Current.ActionExecute value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Ui5ManifestBenchmark.Current.Refresh.MustBeRefresh Type
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Ui5ManifestBenchmark.Current.Refresh.MustBeRefresh value))
            {
                return value;
            }
    ...
    /// <summary>
    /// Gets the (optional) <c>userIds</c> property.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public Corvus.Ui5ManifestBenchmark.Current.Refresh.JsonStringArray UserIds
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UserIdsUtf8, out Corvus.Ui5ManifestBenchmark.Current.Refresh.JsonStringArray value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in Refresh left, in Refresh right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in Refresh left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(Refresh instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator Refresh(JsonElement instance)
    {
        return Refresh.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Refresh From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Refresh ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<Refresh>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Refresh ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<Refresh>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Refresh ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<Refresh>(json, options);
    }
    ...
    /// </exception>
    public static Refresh ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<Refresh>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out Refresh? result)
    {
        return JsonElementHelpers.TryParseValue<Refresh>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new Refresh(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static Refresh IJsonElement<Refresh>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"Refresh: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="Refresh"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="Refresh"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    {
        CheckValidInstance();
        return _parent.CloneElement<Refresh>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="Refresh"/> that lives for the lifetime of its
    ...
    public static class JsonPropertyNames
    {
        ...
        /// <summary>
        /// Gets the JSON property name for <see cref="UserIds"/>.
        /// </summary>
        ...
        /// Gets the JSON property name for <see cref="UserIds"/>.
        /// </summary>
        public static ReadOnlySpan<byte> UserIdsUtf8 => "userIds"u8;
    }
    ...
    private static class JsonPropertyNamesEscaped
    {
        ...
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="UserIds"/>.
        /// </summary>
        public static ReadOnlySpan<byte> UserIds => "userIds"u8;
    }
    ...
    private static class JsonPropertyNamesPrebaked
    {
        ...
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="UserIds"/>.
        /// </summary>
        public static ReadOnlySpan<byte> UserIds => [0x95, 0x00, 0x00, 0x00, 0x22, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x73, 0x22];
    }
}
