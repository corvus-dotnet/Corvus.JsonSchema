...
public readonly partial struct RichTextBlock
{
    ...
    public readonly partial struct ImplementationsOfInlineArray
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ImplementationsOfInlineArray instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ImplementationsOfInlineArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ImplementationsOfInlineArray(Mutable instance)
            {
            ...
            public Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline.Mutable>(_parent, _idx);
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ImplementationsOfInlineArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, scoped in Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(scoped in Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline oldItem, in Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline current = enumerator.Current;
            ...
            /// </para>
            /// </remarks>
            public readonly ImplementationsOfInlineArray Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ImplementationsOfInlineArray Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ImplementationsOfInlineArray>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Current.RichTextBlock.ImplementationsOfInlineArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(ImplementationsOfInlineArray instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.RichTextBlock.ImplementationsOfInlineArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            public void AddItem(in Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline.Source value)
            {
            ...
            /// Add an item to the array.
            /// </summary>
            public void AddItem<TContext>(in Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        {
            return workspace.CreateBuilder<ImplementationsOfInlineArray, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ImplementationsOfInlineArray> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ImplementationsOfInlineArray>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ImplementationsOfInlineArray> Create<TContext>(
