...
public readonly partial struct RichTextBlock
{
    ...
    public readonly partial struct ImplementationsOfInlineArray
#if NET8_0_OR_GREATER
        : IJsonElement<ImplementationsOfInlineArray>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ImplementationsOfInlineArray"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ImplementationsOfInlineArray(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ImplementationsOfInlineArray DefaultInstance { get; }
        ...
        public Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Current.ImplementationsOfInline>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in ImplementationsOfInlineArray left, in ImplementationsOfInlineArray right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ImplementationsOfInlineArray left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(ImplementationsOfInlineArray instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ImplementationsOfInlineArray(JsonElement instance)
        {
            return ImplementationsOfInlineArray.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ImplementationsOfInlineArray From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ImplementationsOfInlineArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ImplementationsOfInlineArray>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ImplementationsOfInlineArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ImplementationsOfInlineArray>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ImplementationsOfInlineArray ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ImplementationsOfInlineArray>(json, options);
        }
        ...
        /// </exception>
        public static ImplementationsOfInlineArray ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ImplementationsOfInlineArray>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ImplementationsOfInlineArray? result)
        {
            return JsonElementHelpers.TryParseValue<ImplementationsOfInlineArray>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ImplementationsOfInlineArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static ImplementationsOfInlineArray IJsonElement<ImplementationsOfInlineArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ImplementationsOfInlineArray: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ImplementationsOfInlineArray"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ImplementationsOfInlineArray"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public ImplementationsOfInlineArray Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ImplementationsOfInlineArray>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ImplementationsOfInlineArray"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public ImplementationsOfInlineArray Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ImplementationsOfInlineArray>(_idx);
            }
