...
public readonly partial struct RichTextBlock
    : IJsonElement<RichTextBlock>
{
    public static partial class JsonSchema
    {
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyInlinesPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("inlines"u8, buffer, out written);
        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyInlinesNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("inlines"u8, buffer, out written);

        private const int RequiredOffsetForInlines = 0;
        private const uint RequiredBitForInlines = 0b00000000000000000000000000000001;

        private const uint RequiredBitMask0 =
            RequiredBitForInlines;
        ...
        private static readonly JsonSchemaPathProvider InlinesSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/inlines"u8, buffer, out written);
        ...
        private static void MatchHorizontalAlignment(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext2 =
                Corvus.Ui5ManifestBenchmark.Current.RichTextBlock.HorizontalAlignmentEntity.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.Ui5ManifestBenchmark.Current.RichTextBlock.HorizontalAlignmentEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
        ...
        private static void MatchInlines(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            context.AddLocalEvaluatedProperty(propertyCount);
            JsonSchemaContext childContext4 =
                Corvus.Ui5ManifestBenchmark.Current.RichTextBlock.ImplementationsOfInlineArray.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
                    JsonPropertyNames.InlinesUtf8,
                    evaluationPath: InlinesSchemaEvaluationPath);

            Corvus.Ui5ManifestBenchmark.Current.RichTextBlock.ImplementationsOfInlineArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext4);
            ...
            requiredBitBuffer[RequiredOffsetForInlines] |= RequiredBitForInlines;
        }
        ...
        private static void MatchType(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
        {
            ...
            JsonSchemaContext childContext9 =
                Corvus.Ui5ManifestBenchmark.Current.RichTextBlock.MustBeRichTextBlock.JsonSchema.PushChildContextUnescaped(
                    parentDocument,
                    parentDocumentIndex,
                    ref context,
            ...
            Corvus.Ui5ManifestBenchmark.Current.RichTextBlock.MustBeRichTextBlock.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext9);
        ...
        private static PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
        {
            return new PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator>([
                ...
                (static () => JsonPropertyNames.InlinesUtf8, MatchInlines),
        ...
        /// </summary>
        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/https:~1~1adaptivecards.io~1schemas~1adaptive-card.json/definitions/RichTextBlock"u8, buffer, out written);

        /// <summary>
        /// Gets the schema location from which this type was generated.
        /// </summary>
        public const string SchemaLocation = "/definitions/https:~1~1adaptivecards.io~1schemas~1adaptive-card.json/definitions/RichTextBlock";

        /// <summary>
        /// Gets the schema location from which this type was generated as a UTF-8 string.
        /// </summary>
        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/https:~1~1adaptivecards.io~1schemas~1adaptive-card.json/definitions/RichTextBlock"u8;
            ...
            ref JsonSchemaContext context)
        {
            ...
            if (tokenType == JsonTokenType.StartObject)
            {
                ...
                {
                    context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyInlinesPresent, "inlines"u8, "required"u8);
                }
                ...
                {
                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForInlines] & RequiredBitForInlines) == 0)
                    {
                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyInlinesNotPresent, "inlines"u8, "required"u8);
                    }
                    else
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyInlinesPresent, "inlines"u8, "required"u8);
