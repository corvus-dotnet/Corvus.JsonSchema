...
public readonly partial struct Table
{
    ...
    public readonly partial struct FirstRowAsHeaderEntity
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<FirstRowAsHeaderEntity, Mutable>(FirstRowAsHeaderEntity.DefaultInstance);
            ...
            public static explicit operator Mutable(FirstRowAsHeaderEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="FirstRowAsHeaderEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator FirstRowAsHeaderEntity(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new FirstRowAsHeaderEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"FirstRowAsHeaderEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="FirstRowAsHeaderEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="FirstRowAsHeaderEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly FirstRowAsHeaderEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<FirstRowAsHeaderEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="FirstRowAsHeaderEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly FirstRowAsHeaderEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<FirstRowAsHeaderEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(FirstRowAsHeaderEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<FirstRowAsHeaderEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<FirstRowAsHeaderEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<FirstRowAsHeaderEntity>();
            }
            finally
            {
