...
public readonly partial struct Table
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FirstRowAsHeaderEntity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal FirstRowAsHeaderEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static FirstRowAsHeaderEntity DefaultInstance { get; } = ParsedJsonDocument<FirstRowAsHeaderEntity>.True;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator bool(FirstRowAsHeaderEntity value)
        {
        ...
        /// </returns>
        public static bool operator ==(in FirstRowAsHeaderEntity left, in FirstRowAsHeaderEntity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in FirstRowAsHeaderEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(FirstRowAsHeaderEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator FirstRowAsHeaderEntity(JsonElement instance)
        {
            return FirstRowAsHeaderEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static FirstRowAsHeaderEntity From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static FirstRowAsHeaderEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<FirstRowAsHeaderEntity>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static FirstRowAsHeaderEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<FirstRowAsHeaderEntity>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static FirstRowAsHeaderEntity ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<FirstRowAsHeaderEntity>(json, options);
        }
        ...
        /// </exception>
        public static FirstRowAsHeaderEntity ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<FirstRowAsHeaderEntity>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out FirstRowAsHeaderEntity? result)
        {
            return JsonElementHelpers.TryParseValue<FirstRowAsHeaderEntity>(ref reader, out result);
        }
...
#if NET
        static FirstRowAsHeaderEntity IJsonElement<FirstRowAsHeaderEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"FirstRowAsHeaderEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public FirstRowAsHeaderEntity Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public FirstRowAsHeaderEntity Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<FirstRowAsHeaderEntity>(_idx);
            }
