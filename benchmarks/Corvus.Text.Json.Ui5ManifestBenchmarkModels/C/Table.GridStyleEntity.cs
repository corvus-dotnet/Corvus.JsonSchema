...
public readonly partial struct Table
{
...
#endif
    {
        ...
        public static explicit operator Corvus.Ui5ManifestBenchmark.Current.ContainerStyle(GridStyleEntity value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator GridStyleEntity(Corvus.Ui5ManifestBenchmark.Current.ContainerStyle value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.Ui5ManifestBenchmark.Current.ContainerStyle.AnyOf0Entity(GridStyleEntity value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator GridStyleEntity(Corvus.Ui5ManifestBenchmark.Current.ContainerStyle.AnyOf0Entity value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.Ui5ManifestBenchmark.Current.ContainerStyle.AnyOf1Entity(GridStyleEntity value)
        {
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Table.GridStyleEntity, TContext, TResult> defaultMatch)
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Table.GridStyleEntity, TResult> defaultMatch)
        {
            if (Corvus.Ui5ManifestBenchmark.Current.ContainerStyle.JsonSchema.Evaluate(_parent, _idx))
            {
        ...
        public TAccumulator MatchEvery<TAccumulator>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Table.GridStyleEntity, TAccumulator, TAccumulator> defaultMatch)
        {
            bool matched = false;
