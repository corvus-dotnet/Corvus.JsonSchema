...
public readonly partial struct Table
{
    ...
    public readonly partial struct MustBeTable
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(MustBeTable instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MustBeTable"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MustBeTable(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MustBeTable.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeTable Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeTable Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MustBeTable>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(MustBeTable instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<MustBeTable, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<MustBeTable> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<MustBeTable>();
            }
            finally
            {
