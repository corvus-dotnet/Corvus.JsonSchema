...
public readonly partial struct Table
{
    ...
    public readonly partial struct SpecifiesWhetherGridLinesShouldBeDisplayed
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SpecifiesWhetherGridLinesShouldBeDisplayed, Mutable>(SpecifiesWhetherGridLinesShouldBeDisplayed.DefaultInstance);
        ...
        public static ParsedJsonDocument<SpecifiesWhetherGridLinesShouldBeDisplayed> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<SpecifiesWhetherGridLinesShouldBeDisplayed>();
            }
            finally
            {
