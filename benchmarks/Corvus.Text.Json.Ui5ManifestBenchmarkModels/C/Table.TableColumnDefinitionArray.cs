...
public readonly partial struct Table
{
...
#endif
    {
        ...
        public Corvus.Ui5ManifestBenchmark.Current.TableColumnDefinition this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.Ui5ManifestBenchmark.Current.TableColumnDefinition>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.Ui5ManifestBenchmark.Current.TableColumnDefinition> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Current.TableColumnDefinition>(_parent, _idx);
        }
