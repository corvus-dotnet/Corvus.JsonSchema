...
public readonly partial struct TableCell
{
...
#endif
    {
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.TableCell.BackgroundImageEntity, TContext, TResult> defaultMatch)
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.TableCell.BackgroundImageEntity, TResult> defaultMatch)
        {
            if (Corvus.Ui5ManifestBenchmark.Current.BackgroundImage.JsonSchema.Evaluate(_parent, _idx))
            {
        ...
        public TAccumulator MatchEvery<TAccumulator>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.TableCell.BackgroundImageEntity, TAccumulator, TAccumulator> defaultMatch)
        {
            bool matched = false;
