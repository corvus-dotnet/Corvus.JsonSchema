...
public readonly partial struct TableCell
{
    ...
    public readonly partial struct MustBeTableCell
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(MustBeTableCell instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MustBeTableCell"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MustBeTableCell(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MustBeTableCell.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeTableCell Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeTableCell Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MustBeTableCell>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(MustBeTableCell instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<MustBeTableCell, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<MustBeTableCell> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<MustBeTableCell>();
            }
            finally
            {
