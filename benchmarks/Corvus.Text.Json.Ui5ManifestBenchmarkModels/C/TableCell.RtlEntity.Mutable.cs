    ...
    public readonly partial struct RtlEntity
    {
...
#endif
        {
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.TableCell.RtlEntity.Mutable, TContext, TResult> defaultMatch)
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.TableCell.RtlEntity.Mutable, TResult> defaultMatch)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                {
            ...
            public TAccumulator MatchEvery<TAccumulator>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.TableCell.RtlEntity.Mutable, TAccumulator, TAccumulator> defaultMatch)
            {
                bool matched = false;
