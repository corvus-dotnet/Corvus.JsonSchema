...
public readonly partial struct TableCell
{
    ...
    public readonly partial struct StyleHintForTableCell
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(StyleHintForTableCell instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="StyleHintForTableCell"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator StyleHintForTableCell(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new StyleHintForTableCell(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"StyleHintForTableCell.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="StyleHintForTableCell"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="StyleHintForTableCell"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly StyleHintForTableCell Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<StyleHintForTableCell>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="StyleHintForTableCell"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly StyleHintForTableCell Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<StyleHintForTableCell>(_idx);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.TableCell.StyleHintForTableCell.Mutable, TContext, TResult> defaultMatch)
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.TableCell.StyleHintForTableCell.Mutable, TResult> defaultMatch)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.ContainerStyle.JsonSchema.Evaluate(_parent, _idx))
                {
            ...
            public TAccumulator MatchEvery<TAccumulator>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.TableCell.StyleHintForTableCell.Mutable, TAccumulator, TAccumulator> defaultMatch)
            {
                bool matched = false;
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(StyleHintForTableCell instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<StyleHintForTableCell, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<StyleHintForTableCell> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<StyleHintForTableCell>();
            }
            finally
            {
