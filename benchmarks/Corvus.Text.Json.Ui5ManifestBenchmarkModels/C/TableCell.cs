...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="TableCell"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal TableCell(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static TableCell DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Ui5ManifestBenchmark.Current.TableCell.BackgroundImageEntity BackgroundImage
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BackgroundImageUtf8, out Corvus.Ui5ManifestBenchmark.Current.TableCell.BackgroundImageEntity value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Ui5ManifestBenchmark.Current.TableCell.ImplementationsOfElementArray Items
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ItemsUtf8, out Corvus.Ui5ManifestBenchmark.Current.TableCell.ImplementationsOfElementArray value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Ui5ManifestBenchmark.Current.TableCell.RtlEntity Rtl
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RtlUtf8, out Corvus.Ui5ManifestBenchmark.Current.TableCell.RtlEntity value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Ui5ManifestBenchmark.Current.TableCell.StyleHintForTableCell Style
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StyleUtf8, out Corvus.Ui5ManifestBenchmark.Current.TableCell.StyleHintForTableCell value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Ui5ManifestBenchmark.Current.TableCell.MustBeTableCell Type
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Ui5ManifestBenchmark.Current.TableCell.MustBeTableCell value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Ui5ManifestBenchmark.Current.TableCell.VerticalContentAlignmentEntity VerticalContentAlignment
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VerticalContentAlignmentUtf8, out Corvus.Ui5ManifestBenchmark.Current.TableCell.VerticalContentAlignmentEntity value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in TableCell left, in TableCell right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in TableCell left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(TableCell instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator TableCell(JsonElement instance)
    {
        return TableCell.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TableCell From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TableCell ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<TableCell>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TableCell ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<TableCell>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TableCell ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<TableCell>(json, options);
    }
    ...
    /// </exception>
    public static TableCell ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<TableCell>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out TableCell? result)
    {
        return JsonElementHelpers.TryParseValue<TableCell>(ref reader, out result);
    }
...
#if NET
    static TableCell IJsonElement<TableCell>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"TableCell: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    private static class JsonPropertyNamesPrebaked
    {
        ...
        /// </summary>
        public static ReadOnlySpan<byte> Rtl => [0x65, 0x00, 0x00, 0x00, 0x22, 0x72, 0x74, 0x6C, 0x3F, 0x22];
