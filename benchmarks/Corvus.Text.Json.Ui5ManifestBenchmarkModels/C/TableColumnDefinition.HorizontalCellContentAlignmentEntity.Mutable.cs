    ...
    public readonly partial struct HorizontalCellContentAlignmentEntity
    {
...
#endif
        {
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.TableColumnDefinition.HorizontalCellContentAlignmentEntity.Mutable, TContext, TResult> defaultMatch)
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.TableColumnDefinition.HorizontalCellContentAlignmentEntity.Mutable, TResult> defaultMatch)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment.JsonSchema.Evaluate(_parent, _idx))
                {
            ...
            public TAccumulator MatchEvery<TAccumulator>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.TableColumnDefinition.HorizontalCellContentAlignmentEntity.Mutable, TAccumulator, TAccumulator> defaultMatch)
            {
                bool matched = false;
