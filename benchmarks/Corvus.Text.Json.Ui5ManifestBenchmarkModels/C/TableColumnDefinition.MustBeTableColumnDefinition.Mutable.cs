...
public readonly partial struct TableColumnDefinition
{
    ...
    public readonly partial struct MustBeTableColumnDefinition
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(MustBeTableColumnDefinition instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MustBeTableColumnDefinition"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MustBeTableColumnDefinition(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new MustBeTableColumnDefinition(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MustBeTableColumnDefinition.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="MustBeTableColumnDefinition"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="MustBeTableColumnDefinition"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeTableColumnDefinition Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<MustBeTableColumnDefinition>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="MustBeTableColumnDefinition"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeTableColumnDefinition Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MustBeTableColumnDefinition>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(MustBeTableColumnDefinition instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<MustBeTableColumnDefinition, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<MustBeTableColumnDefinition> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<MustBeTableColumnDefinition>();
            }
            finally
            {
