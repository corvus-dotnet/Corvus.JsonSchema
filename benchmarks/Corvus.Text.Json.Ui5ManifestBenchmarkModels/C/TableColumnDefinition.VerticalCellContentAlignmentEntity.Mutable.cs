...
public readonly partial struct TableColumnDefinition
{
    ...
    public readonly partial struct VerticalCellContentAlignmentEntity
    {
...
#endif
        {
            ...
            public static explicit operator Corvus.Ui5ManifestBenchmark.Current.VerticalAlignment.Mutable(Mutable value)
            {
                return Corvus.Ui5ManifestBenchmark.Current.VerticalAlignment.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Current.VerticalAlignment.Mutable value)
            {
                return From(value);
            }
            ...
            public static explicit operator Mutable(VerticalCellContentAlignmentEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="VerticalCellContentAlignmentEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator VerticalCellContentAlignmentEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"VerticalCellContentAlignmentEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly VerticalCellContentAlignmentEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly VerticalCellContentAlignmentEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<VerticalCellContentAlignmentEntity>(_idx);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.TableColumnDefinition.VerticalCellContentAlignmentEntity.Mutable, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                {
                    return matchVerticalAlignment(Corvus.Ui5ManifestBenchmark.Current.VerticalAlignment.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.TableColumnDefinition.VerticalCellContentAlignmentEntity.Mutable, TResult> defaultMatch)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.VerticalAlignment.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchVerticalAlignment(Corvus.Ui5ManifestBenchmark.Current.VerticalAlignment.Mutable.From(this));
                }
            ...
            public TAccumulator MatchEvery<TAccumulator>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.TableColumnDefinition.VerticalCellContentAlignmentEntity.Mutable, TAccumulator, TAccumulator> defaultMatch)
            {
                bool matched = false;
                ...
                {
                    matched = true;
                    accumulator = matchVerticalAlignment(Corvus.Ui5ManifestBenchmark.Current.VerticalAlignment.Mutable.From(this), accumulator);
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Current.VerticalAlignment.Mutable" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsVerticalAlignment(out Corvus.Ui5ManifestBenchmark.Current.VerticalAlignment.Mutable result)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.VerticalAlignment.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Ui5ManifestBenchmark.Current.VerticalAlignment.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(VerticalCellContentAlignmentEntity instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Current.VerticalAlignment instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<VerticalCellContentAlignmentEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<VerticalCellContentAlignmentEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<VerticalCellContentAlignmentEntity>();
            }
            finally
            {
