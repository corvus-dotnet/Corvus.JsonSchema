...
public readonly partial struct TableColumnDefinition
{
    ...
    public readonly partial struct WidthEntity
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<WidthEntity, Mutable>(WidthEntity.DefaultInstance);
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.TableColumnDefinition.WidthEntity.Mutable, TContext, TResult> defaultMatch)
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.TableColumnDefinition.WidthEntity.Mutable, TResult> defaultMatch)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
            ...
            public TAccumulator MatchEvery<TAccumulator>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.JsonNumber, TAccumulator, TAccumulator> matchJsonNumber,
                Matcher<Corvus.Ui5ManifestBenchmark.Current.TableColumnDefinition.WidthEntity.Mutable, TAccumulator, TAccumulator> defaultMatch)
            {
                bool matched = false;
                ...
                {
                    matched = true;
                    accumulator = matchJsonNumber(Corvus.Ui5ManifestBenchmark.Current.JsonNumber.Mutable.From(this), accumulator);
                }
        ...
        public static ParsedJsonDocument<WidthEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<WidthEntity>();
            }
            finally
            {
