...
public readonly partial struct TableColumnDefinition
    ...
    : IJsonElement<TableColumnDefinition>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="TableColumnDefinition"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal TableColumnDefinition(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static TableColumnDefinition DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Ui5ManifestBenchmark.Current.TableColumnDefinition.HorizontalCellContentAlignmentEntity HorizontalCellContentAlignment
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HorizontalCellContentAlignmentUtf8, out Corvus.Ui5ManifestBenchmark.Current.TableColumnDefinition.HorizontalCellContentAlignmentEntity value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Ui5ManifestBenchmark.Current.TableColumnDefinition.MustBeTableColumnDefinition Type
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Ui5ManifestBenchmark.Current.TableColumnDefinition.MustBeTableColumnDefinition value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Ui5ManifestBenchmark.Current.TableColumnDefinition.VerticalCellContentAlignmentEntity VerticalCellContentAlignment
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VerticalCellContentAlignmentUtf8, out Corvus.Ui5ManifestBenchmark.Current.TableColumnDefinition.VerticalCellContentAlignmentEntity value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Ui5ManifestBenchmark.Current.TableColumnDefinition.WidthEntity Width
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.WidthUtf8, out Corvus.Ui5ManifestBenchmark.Current.TableColumnDefinition.WidthEntity value))
            {
                return value;
            }

            return Corvus.Ui5ManifestBenchmark.Current.TableColumnDefinition.WidthEntity.DefaultInstance;
        }
    }
    ...
    /// </returns>
    public static bool operator ==(in TableColumnDefinition left, in TableColumnDefinition right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in TableColumnDefinition left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(TableColumnDefinition instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator TableColumnDefinition(JsonElement instance)
    {
        return TableColumnDefinition.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TableColumnDefinition From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TableColumnDefinition ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<TableColumnDefinition>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TableColumnDefinition ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<TableColumnDefinition>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TableColumnDefinition ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<TableColumnDefinition>(json, options);
    }
    ...
    /// </exception>
    public static TableColumnDefinition ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<TableColumnDefinition>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out TableColumnDefinition? result)
    {
        return JsonElementHelpers.TryParseValue<TableColumnDefinition>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new TableColumnDefinition(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static TableColumnDefinition IJsonElement<TableColumnDefinition>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"TableColumnDefinition: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="TableColumnDefinition"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="TableColumnDefinition"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public TableColumnDefinition Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<TableColumnDefinition>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="TableColumnDefinition"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public TableColumnDefinition Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<TableColumnDefinition>(_idx);
        }
