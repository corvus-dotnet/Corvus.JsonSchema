...
public readonly partial struct TableRow
{
    ...
    public readonly partial struct DefinesTheStyleOfTheEntireRow
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(DefinesTheStyleOfTheEntireRow instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="DefinesTheStyleOfTheEntireRow"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DefinesTheStyleOfTheEntireRow(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DefinesTheStyleOfTheEntireRow.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly DefinesTheStyleOfTheEntireRow Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly DefinesTheStyleOfTheEntireRow Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<DefinesTheStyleOfTheEntireRow>(_idx);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.TableRow.DefinesTheStyleOfTheEntireRow.Mutable, TContext, TResult> defaultMatch)
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.TableRow.DefinesTheStyleOfTheEntireRow.Mutable, TResult> defaultMatch)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.ContainerStyle.JsonSchema.Evaluate(_parent, _idx))
                {
            ...
            public TAccumulator MatchEvery<TAccumulator>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.TableRow.DefinesTheStyleOfTheEntireRow.Mutable, TAccumulator, TAccumulator> defaultMatch)
            {
                bool matched = false;
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(DefinesTheStyleOfTheEntireRow instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<DefinesTheStyleOfTheEntireRow, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<DefinesTheStyleOfTheEntireRow> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<DefinesTheStyleOfTheEntireRow>();
            }
            finally
            {
