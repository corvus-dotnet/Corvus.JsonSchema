...
public readonly partial struct TableRow
{
    ...
    public readonly partial struct HorizontalCellContentAlignmentEntity
    {
...
#endif
        {
            ...
            /// <summary>
            /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment.Mutable(Mutable value)
            {
                return Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment.Mutable value)
            {
                return From(value);
            }
            ...
            public static explicit operator Mutable(HorizontalCellContentAlignmentEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="HorizontalCellContentAlignmentEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator HorizontalCellContentAlignmentEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"HorizontalCellContentAlignmentEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="HorizontalCellContentAlignmentEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="HorizontalCellContentAlignmentEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly HorizontalCellContentAlignmentEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<HorizontalCellContentAlignmentEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="HorizontalCellContentAlignmentEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly HorizontalCellContentAlignmentEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<HorizontalCellContentAlignmentEntity>(_idx);
            }
            ...
            /// <param name="matchHorizontalAlignment">Match a <see cref="Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment"/>.</param>
            ...
            public TResult Match<TContext, TResult>(
                in TContext context,
                Matcher<Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment, TContext, TResult> matchHorizontalAlignment,
                Matcher<Corvus.Ui5ManifestBenchmark.Current.JsonNull, TContext, TResult> matchJsonNull,
                Matcher<Corvus.Ui5ManifestBenchmark.Current.TableRow.HorizontalCellContentAlignmentEntity.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
            {
                if (Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchHorizontalAlignment(Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment.Mutable.From(this), context);
                }

                if (Corvus.Ui5ManifestBenchmark.Current.JsonNull.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonNull(Corvus.Ui5ManifestBenchmark.Current.JsonNull.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                Matcher<Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment, TResult> matchHorizontalAlignment,
                Matcher<Corvus.Ui5ManifestBenchmark.Current.JsonNull, TResult> matchJsonNull,
                Matcher<Corvus.Ui5ManifestBenchmark.Current.TableRow.HorizontalCellContentAlignmentEntity.Mutable, TResult> defaultMatch)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchHorizontalAlignment(Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment.Mutable.From(this));
                }

                if (Corvus.Ui5ManifestBenchmark.Current.JsonNull.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonNull(Corvus.Ui5ManifestBenchmark.Current.JsonNull.Mutable.From(this));
                }
            ...
            public TAccumulator MatchEvery<TAccumulator>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment, TAccumulator, TAccumulator> matchHorizontalAlignment,
                Matcher<Corvus.Ui5ManifestBenchmark.Current.JsonNull, TAccumulator, TAccumulator> matchJsonNull,
                Matcher<Corvus.Ui5ManifestBenchmark.Current.TableRow.HorizontalCellContentAlignmentEntity.Mutable, TAccumulator, TAccumulator> defaultMatch)
            {
                bool matched = false;
                ...
                {
                    matched = true;
                    accumulator = matchHorizontalAlignment(Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment.Mutable.From(this), accumulator);
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment.Mutable" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsHorizontalAlignment(out Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment.Mutable result)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment.Mutable.From(this);
                    return true;
                }
            ...
            public bool TryGetAsJsonNull(out Corvus.Ui5ManifestBenchmark.Current.JsonNull.Mutable result)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.JsonNull.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Ui5ManifestBenchmark.Current.JsonNull.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(HorizontalCellContentAlignmentEntity instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Current.JsonNull instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<HorizontalCellContentAlignmentEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<HorizontalCellContentAlignmentEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<HorizontalCellContentAlignmentEntity>();
            }
            finally
            {
