...
public readonly partial struct TableRow
{
    ...
    public readonly partial struct HorizontalCellContentAlignmentEntity
    {
...
#endif
        {
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsHorizontalAlignment(out Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment result)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment.JsonSchema.Evaluate(_parent, _idx))
                {
