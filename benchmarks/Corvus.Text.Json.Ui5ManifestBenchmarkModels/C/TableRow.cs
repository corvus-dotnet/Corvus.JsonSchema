...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="TableRow"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal TableRow(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static TableRow DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Ui5ManifestBenchmark.Current.TableRow.TableCellArray Cells
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CellsUtf8, out Corvus.Ui5ManifestBenchmark.Current.TableRow.TableCellArray value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Ui5ManifestBenchmark.Current.TableRow.HorizontalCellContentAlignmentEntity HorizontalCellContentAlignment
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HorizontalCellContentAlignmentUtf8, out Corvus.Ui5ManifestBenchmark.Current.TableRow.HorizontalCellContentAlignmentEntity value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Ui5ManifestBenchmark.Current.TableRow.DefinesTheStyleOfTheEntireRow Style
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StyleUtf8, out Corvus.Ui5ManifestBenchmark.Current.TableRow.DefinesTheStyleOfTheEntireRow value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Ui5ManifestBenchmark.Current.TableRow.MustBeTableRow Type
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Ui5ManifestBenchmark.Current.TableRow.MustBeTableRow value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Ui5ManifestBenchmark.Current.TableRow.VerticalCellContentAlignmentEntity VerticalCellContentAlignment
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VerticalCellContentAlignmentUtf8, out Corvus.Ui5ManifestBenchmark.Current.TableRow.VerticalCellContentAlignmentEntity value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in TableRow left, in TableRow right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in TableRow left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(TableRow instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator TableRow(JsonElement instance)
    {
        return TableRow.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TableRow From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TableRow ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<TableRow>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TableRow ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<TableRow>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TableRow ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<TableRow>(json, options);
    }
    ...
    /// </exception>
    public static TableRow ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<TableRow>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out TableRow? result)
    {
        return JsonElementHelpers.TryParseValue<TableRow>(ref reader, out result);
    }
...
#if NET
    static TableRow IJsonElement<TableRow>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"TableRow: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    {
        /// <summary>
        /// Gets the JSON property name for <see cref="Cells"/>.
        /// </summary>
        ...
        /// Gets the JSON property name for <see cref="Cells"/>.
        /// </summary>
        public static ReadOnlySpan<byte> CellsUtf8 => "cells"u8;
    ...
    {
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="Cells"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Cells => "cells"u8;
    ...
    {
        /// <summary>
        /// Gets the pre-baked property name blob for <see cref="Cells"/>.
        /// </summary>
        public static ReadOnlySpan<byte> Cells => [0x75, 0x00, 0x00, 0x00, 0x22, 0x63, 0x65, 0x6C, 0x6C, 0x73, 0x22];
