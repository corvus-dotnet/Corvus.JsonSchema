...
public readonly partial struct TargetElement
{
    ...
    public readonly partial struct RequiredElementId
        : IJsonElement<RequiredElementId>
    {
        public static partial class JsonSchema
        {
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyElementIdPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("elementId"u8, buffer, out written);
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyElementIdNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("elementId"u8, buffer, out written);

            private const int RequiredOffsetForElementId = 0;
            private const uint RequiredBitForElementId = 0b00000000000000000000000000000001;

            private const uint RequiredBitMask0 =
                RequiredBitForElementId;
            private static readonly JsonSchemaPathProvider ElementIdSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/elementId"u8, buffer, out written);
            ...
            private static void MatchElementId(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                ...
                JsonSchemaContext childContext =
                    Corvus.Ui5ManifestBenchmark.Current.JsonString.JsonSchema.PushChildContextUnescaped(
                        ...
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.ElementIdUtf8,
                        evaluationPath: ElementIdSchemaEvaluationPath);
                ...
                requiredBitBuffer[RequiredOffsetForElementId] |= RequiredBitForElementId;
            }
            ...
            private static void MatchIsVisible(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                ...
                JsonSchemaContext childContext1 =
                    Corvus.Ui5ManifestBenchmark.Current.TargetElement.RequiredElementId.IsVisibleEntity.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.Ui5ManifestBenchmark.Current.TargetElement.RequiredElementId.IsVisibleEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
            ...
            private static void MatchType(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                ...
                JsonSchemaContext childContext2 =
                    Corvus.Ui5ManifestBenchmark.Current.TargetElement.RequiredElementId.MustBeTargetElement.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.Ui5ManifestBenchmark.Current.TargetElement.RequiredElementId.MustBeTargetElement.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
            ...
            private static PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
            {
                return new PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator>([
                    (static () => JsonPropertyNames.ElementIdUtf8, MatchElementId),
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/https:~1~1adaptivecards.io~1schemas~1adaptive-card.json/definitions/TargetElement/anyOf/1"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/definitions/https:~1~1adaptivecards.io~1schemas~1adaptive-card.json/definitions/TargetElement/anyOf/1";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/https:~1~1adaptivecards.io~1schemas~1adaptive-card.json/definitions/TargetElement/anyOf/1"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyElementIdPresent, "elementId"u8, "required"u8);
                    }
                    ...
                    {
                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForElementId] & RequiredBitForElementId) == 0)
                        {
                            context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyElementIdNotPresent, "elementId"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyElementIdPresent, "elementId"u8, "required"u8);
