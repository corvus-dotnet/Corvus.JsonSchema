    ...
    public readonly partial struct RequiredElementId
    {
        ...
        public readonly partial struct MustBeTargetElement
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(MustBeTargetElement instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="MustBeTargetElement"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator MustBeTargetElement(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"MustBeTargetElement.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly MustBeTargetElement Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly MustBeTargetElement Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<MustBeTargetElement>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(MustBeTargetElement instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<MustBeTargetElement, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<MustBeTargetElement> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<MustBeTargetElement>();
                }
                finally
                {
