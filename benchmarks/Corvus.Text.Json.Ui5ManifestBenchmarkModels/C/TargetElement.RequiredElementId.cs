...
public readonly partial struct TargetElement
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RequiredElementId"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal RequiredElementId(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static RequiredElementId DefaultInstance { get; }

        /// <summary>
        /// Gets the <c>elementId</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.JsonString ElementId
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ElementIdUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.TargetElement.RequiredElementId.IsVisibleEntity IsVisible
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IsVisibleUtf8, out Corvus.Ui5ManifestBenchmark.Current.TargetElement.RequiredElementId.IsVisibleEntity value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.TargetElement.RequiredElementId.MustBeTargetElement Type
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Ui5ManifestBenchmark.Current.TargetElement.RequiredElementId.MustBeTargetElement value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in RequiredElementId left, in RequiredElementId right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in RequiredElementId left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(RequiredElementId instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator RequiredElementId(JsonElement instance)
        {
            return RequiredElementId.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiredElementId From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiredElementId ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RequiredElementId>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiredElementId ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RequiredElementId>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiredElementId ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RequiredElementId>(json, options);
        }
        ...
        /// </exception>
        public static RequiredElementId ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<RequiredElementId>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredElementId? result)
        {
            return JsonElementHelpers.TryParseValue<RequiredElementId>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new RequiredElementId(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static RequiredElementId IJsonElement<RequiredElementId>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"RequiredElementId: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="RequiredElementId"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="RequiredElementId"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public RequiredElementId Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<RequiredElementId>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="RequiredElementId"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public RequiredElementId Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<RequiredElementId>(_idx);
            }
        ...
        {
            /// <summary>
            /// Gets the JSON property name for <see cref="ElementId"/>.
            /// </summary>
            ...
            /// Gets the JSON property name for <see cref="ElementId"/>.
            /// </summary>
            public static ReadOnlySpan<byte> ElementIdUtf8 => "elementId"u8;
        ...
        {
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="ElementId"/>.
            /// </summary>
            public static ReadOnlySpan<byte> ElementId => "elementId"u8;
        ...
        {
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="ElementId"/>.
            /// </summary>
            public static ReadOnlySpan<byte> ElementId => [0xB5, 0x00, 0x00, 0x00, 0x22, 0x65, 0x6C, 0x65, 0x6D, 0x65, 0x6E, 0x74, 0x49, 0x64, 0x22];
