...
public readonly partial struct TargetElement
#if NET8_0_OR_GREATER
    : IJsonElement<TargetElement>,
      IFormattable,
      ISpanFormattable,
...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="TargetElement"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal TargetElement(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static TargetElement DefaultInstance { get; }
    ...
    /// <summary>
    /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Current.TargetElement.RequiredElementId"/>.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static explicit operator Corvus.Ui5ManifestBenchmark.Current.TargetElement.RequiredElementId(TargetElement value)
    {
        return Corvus.Ui5ManifestBenchmark.Current.TargetElement.RequiredElementId.From(value);
    }

    /// <summary>
    /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Current.TargetElement.RequiredElementId"/>.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator TargetElement(Corvus.Ui5ManifestBenchmark.Current.TargetElement.RequiredElementId value)
    {
        return From(value);
    }

    /// <summary>
    /// Conversion from the <see cref="Corvus.Ui5ManifestBenchmark.Current.TargetElement.RequiredElementId"/> mutable view.
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator TargetElement(Corvus.Ui5ManifestBenchmark.Current.TargetElement.RequiredElementId.Mutable value)
    {
        return From(value);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator string(TargetElement value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
    ...
    /// </returns>
    public static bool operator ==(in TargetElement left, in TargetElement right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in TargetElement left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator JsonElement(TargetElement instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator TargetElement(JsonElement instance)
    {
        return TargetElement.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TargetElement From<T>(in T instance)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TargetElement ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<TargetElement>(utf8Json, options);
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TargetElement ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<TargetElement>(json, options);
        #pragma warning restore CS0618
    }
    ...
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TargetElement ParseValue(string json, JsonDocumentOptions options = default)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<TargetElement>(json, options);
        #pragma warning restore CS0618
    ...
    /// </exception>
    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
    public static TargetElement ParseValue(ref Utf8JsonReader reader)
    {
        #pragma warning disable CS0618 // Type or member is obsolete
        return JsonElementHelpers.ParseValue<TargetElement>(ref reader);
        #pragma warning restore CS0618
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out TargetElement? result)
    {
        return JsonElementHelpers.TryParseValue<TargetElement>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new TargetElement(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static TargetElement IJsonElement<TargetElement>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"TargetElement: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="TargetElement"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="TargetElement"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public TargetElement Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<TargetElement>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="TargetElement"/> that lives for the lifetime of its
    ...
    /// <summary>
    /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Current.TargetElement.RequiredElementId" />.
    /// </summary>
    /// <param name="result">The result of the conversions.</param>
    /// <returns><see langword="true" /> if the conversion was valid.</returns>
    public bool TryGetAsRequiredElementId(out Corvus.Ui5ManifestBenchmark.Current.TargetElement.RequiredElementId result)
    {
        if (Corvus.Ui5ManifestBenchmark.Current.TargetElement.RequiredElementId.JsonSchema.Evaluate(_parent, _idx))
        {
            result = Corvus.Ui5ManifestBenchmark.Current.TargetElement.RequiredElementId.From(this);
            return true;
        }
    ...
    public TResult Match<TContext, TResult>(
        ...
        Matcher<Corvus.Ui5ManifestBenchmark.Current.TargetElement.RequiredElementId, TContext, TResult> matchRequiredElementId,
        Matcher<Corvus.Ui5ManifestBenchmark.Current.TargetElement, TContext, TResult> defaultMatch)
...
#endif
    {
        ...
        if (Corvus.Ui5ManifestBenchmark.Current.TargetElement.RequiredElementId.JsonSchema.Evaluate(_parent, _idx))
        {
            return matchRequiredElementId(Corvus.Ui5ManifestBenchmark.Current.TargetElement.RequiredElementId.From(this), context);
        }
    ...
    public TResult Match<TResult>(
        ...
        Matcher<Corvus.Ui5ManifestBenchmark.Current.TargetElement.RequiredElementId, TResult> matchRequiredElementId,
        Matcher<Corvus.Ui5ManifestBenchmark.Current.TargetElement, TResult> defaultMatch)
    {
        if (Corvus.Ui5ManifestBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
        {
        ...
        if (Corvus.Ui5ManifestBenchmark.Current.TargetElement.RequiredElementId.JsonSchema.Evaluate(_parent, _idx))
        {
            return matchRequiredElementId(Corvus.Ui5ManifestBenchmark.Current.TargetElement.RequiredElementId.From(this));
        }
