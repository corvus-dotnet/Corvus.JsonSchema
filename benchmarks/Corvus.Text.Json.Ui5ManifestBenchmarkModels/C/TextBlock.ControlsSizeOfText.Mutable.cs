...
public readonly partial struct TextBlock
{
    ...
    public readonly partial struct ControlsSizeOfText
    {
...
#endif
        {
            ...
            public static explicit operator Corvus.Ui5ManifestBenchmark.Current.FontSize.Mutable(Mutable value)
            {
                return Corvus.Ui5ManifestBenchmark.Current.FontSize.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Current.FontSize.Mutable value)
            {
                return From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.Ui5ManifestBenchmark.Current.FontSize.AnyOf0Entity.Mutable(Mutable value)
            {
                return Corvus.Ui5ManifestBenchmark.Current.FontSize.AnyOf0Entity.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Current.FontSize.AnyOf0Entity.Mutable value)
            {
                return From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.Ui5ManifestBenchmark.Current.FontSize.AnyOf1Entity.Mutable(Mutable value)
            {
                return Corvus.Ui5ManifestBenchmark.Current.FontSize.AnyOf1Entity.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Current.FontSize.AnyOf1Entity.Mutable value)
            {
                return From(value);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.TextBlock.ControlsSizeOfText.Mutable, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                {
                    return matchFontSize(Corvus.Ui5ManifestBenchmark.Current.FontSize.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.TextBlock.ControlsSizeOfText.Mutable, TResult> defaultMatch)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.FontSize.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchFontSize(Corvus.Ui5ManifestBenchmark.Current.FontSize.Mutable.From(this));
                }
            ...
            public TAccumulator MatchEvery<TAccumulator>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.TextBlock.ControlsSizeOfText.Mutable, TAccumulator, TAccumulator> defaultMatch)
            {
                bool matched = false;
            ...
            public bool TryGetAsFontSize(out Corvus.Ui5ManifestBenchmark.Current.FontSize.Mutable result)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.FontSize.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Ui5ManifestBenchmark.Current.FontSize.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Current.FontSize instance) => new(JsonElement.From(instance));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Current.FontSize.AnyOf0Entity instance) => new(JsonElement.From(instance));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Current.FontSize.AnyOf1Entity instance) => new(JsonElement.From(instance));
        ...
        public static ParsedJsonDocument<ControlsSizeOfText> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ControlsSizeOfText>();
            }
            finally
            {
