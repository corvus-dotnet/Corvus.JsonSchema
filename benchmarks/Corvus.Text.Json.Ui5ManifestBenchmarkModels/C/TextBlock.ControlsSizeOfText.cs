...
public readonly partial struct TextBlock
{
...
#endif
    {
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.TextBlock.ControlsSizeOfText, TContext, TResult> defaultMatch)
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.TextBlock.ControlsSizeOfText, TResult> defaultMatch)
        {
            if (Corvus.Ui5ManifestBenchmark.Current.FontSize.JsonSchema.Evaluate(_parent, _idx))
            {
        ...
        public TAccumulator MatchEvery<TAccumulator>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.TextBlock.ControlsSizeOfText, TAccumulator, TAccumulator> defaultMatch)
        {
            bool matched = false;
