...
public readonly partial struct TextBlock
{
    ...
    public readonly partial struct ControlsTheColorOfTextBlockElements
    {
...
#endif
        {
            ...
            /// <summary>
            /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Current.Colors"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.Ui5ManifestBenchmark.Current.Colors.Mutable(Mutable value)
            {
                return Corvus.Ui5ManifestBenchmark.Current.Colors.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Current.Colors"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Current.Colors.Mutable value)
            {
                return From(value);
            }

            /// <summary>
            /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Current.Colors.AnyOf0Entity"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.Ui5ManifestBenchmark.Current.Colors.AnyOf0Entity.Mutable(Mutable value)
            {
                return Corvus.Ui5ManifestBenchmark.Current.Colors.AnyOf0Entity.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Current.Colors.AnyOf0Entity"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Current.Colors.AnyOf0Entity.Mutable value)
            {
                return From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.Ui5ManifestBenchmark.Current.Colors.AnyOf1Entity.Mutable(Mutable value)
            {
                return Corvus.Ui5ManifestBenchmark.Current.Colors.AnyOf1Entity.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Current.Colors.AnyOf1Entity"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Current.Colors.AnyOf1Entity.Mutable value)
            {
                return From(value);
            }
            ...
            public static explicit operator Mutable(ControlsTheColorOfTextBlockElements instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ControlsTheColorOfTextBlockElements"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ControlsTheColorOfTextBlockElements(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ControlsTheColorOfTextBlockElements.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ControlsTheColorOfTextBlockElements Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ControlsTheColorOfTextBlockElements Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ControlsTheColorOfTextBlockElements>(_idx);
            }
            ...
            /// <param name="matchColors">Match a <see cref="Corvus.Ui5ManifestBenchmark.Current.Colors"/>.</param>
            ...
            public TResult Match<TContext, TResult>(
                in TContext context,
                Matcher<Corvus.Ui5ManifestBenchmark.Current.Colors, TContext, TResult> matchColors,
                Matcher<Corvus.Ui5ManifestBenchmark.Current.JsonNull, TContext, TResult> matchJsonNull,
                Matcher<Corvus.Ui5ManifestBenchmark.Current.TextBlock.ControlsTheColorOfTextBlockElements.Mutable, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                {
                    return matchColors(Corvus.Ui5ManifestBenchmark.Current.Colors.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                Matcher<Corvus.Ui5ManifestBenchmark.Current.Colors, TResult> matchColors,
                Matcher<Corvus.Ui5ManifestBenchmark.Current.JsonNull, TResult> matchJsonNull,
                Matcher<Corvus.Ui5ManifestBenchmark.Current.TextBlock.ControlsTheColorOfTextBlockElements.Mutable, TResult> defaultMatch)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.Colors.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchColors(Corvus.Ui5ManifestBenchmark.Current.Colors.Mutable.From(this));
                }
            ...
            public TAccumulator MatchEvery<TAccumulator>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.Colors, TAccumulator, TAccumulator> matchColors,
                Matcher<Corvus.Ui5ManifestBenchmark.Current.JsonNull, TAccumulator, TAccumulator> matchJsonNull,
                Matcher<Corvus.Ui5ManifestBenchmark.Current.TextBlock.ControlsTheColorOfTextBlockElements.Mutable, TAccumulator, TAccumulator> defaultMatch)
            {
                bool matched = false;
                ...
                {
                    matched = true;
                    accumulator = matchColors(Corvus.Ui5ManifestBenchmark.Current.Colors.Mutable.From(this), accumulator);
                }
            ...
            public bool TryGetAsColors(out Corvus.Ui5ManifestBenchmark.Current.Colors.Mutable result)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.Colors.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Ui5ManifestBenchmark.Current.Colors.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ControlsTheColorOfTextBlockElements instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Current.Colors instance) => new(JsonElement.From(instance));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Current.Colors.AnyOf0Entity instance) => new(JsonElement.From(instance));

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Current.Colors.AnyOf1Entity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<ControlsTheColorOfTextBlockElements, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ControlsTheColorOfTextBlockElements> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ControlsTheColorOfTextBlockElements>();
            }
            finally
            {
