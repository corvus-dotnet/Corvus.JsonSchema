...
public readonly partial struct TextBlock
{
...
#endif
    {
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.TextBlock.HorizontalAlignmentEntity, TContext, TResult> defaultMatch)
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.TextBlock.HorizontalAlignmentEntity, TResult> defaultMatch)
        {
            if (Corvus.Ui5ManifestBenchmark.Current.HorizontalAlignment.JsonSchema.Evaluate(_parent, _idx))
            {
        ...
        public TAccumulator MatchEvery<TAccumulator>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.TextBlock.HorizontalAlignmentEntity, TAccumulator, TAccumulator> defaultMatch)
        {
            bool matched = false;
