...
public readonly partial struct TextBlock
{
    ...
    public readonly partial struct IfTrueAllowTextToWrapOtherwiseTextIsClipped
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<IfTrueAllowTextToWrapOtherwiseTextIsClipped, Mutable>(IfTrueAllowTextToWrapOtherwiseTextIsClipped.DefaultInstance);
            ...
            public static explicit operator Mutable(IfTrueAllowTextToWrapOtherwiseTextIsClipped instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="IfTrueAllowTextToWrapOtherwiseTextIsClipped"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator IfTrueAllowTextToWrapOtherwiseTextIsClipped(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"IfTrueAllowTextToWrapOtherwiseTextIsClipped.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly IfTrueAllowTextToWrapOtherwiseTextIsClipped Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly IfTrueAllowTextToWrapOtherwiseTextIsClipped Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<IfTrueAllowTextToWrapOtherwiseTextIsClipped>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(IfTrueAllowTextToWrapOtherwiseTextIsClipped instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<IfTrueAllowTextToWrapOtherwiseTextIsClipped, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<IfTrueAllowTextToWrapOtherwiseTextIsClipped> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<IfTrueAllowTextToWrapOtherwiseTextIsClipped>();
            }
            finally
            {
