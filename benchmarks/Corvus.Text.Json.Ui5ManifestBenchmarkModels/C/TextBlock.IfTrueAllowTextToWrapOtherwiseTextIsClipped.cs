...
public readonly partial struct TextBlock
{
    ...
    public readonly partial struct IfTrueAllowTextToWrapOtherwiseTextIsClipped
#if NET8_0_OR_GREATER
        : IJsonElement<IfTrueAllowTextToWrapOtherwiseTextIsClipped>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IfTrueAllowTextToWrapOtherwiseTextIsClipped"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal IfTrueAllowTextToWrapOtherwiseTextIsClipped(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static IfTrueAllowTextToWrapOtherwiseTextIsClipped DefaultInstance { get; } = ParsedJsonDocument<IfTrueAllowTextToWrapOtherwiseTextIsClipped>.False;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator bool(IfTrueAllowTextToWrapOtherwiseTextIsClipped value)
        {
        ...
        /// </returns>
        public static bool operator ==(in IfTrueAllowTextToWrapOtherwiseTextIsClipped left, in IfTrueAllowTextToWrapOtherwiseTextIsClipped right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in IfTrueAllowTextToWrapOtherwiseTextIsClipped left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(IfTrueAllowTextToWrapOtherwiseTextIsClipped instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator IfTrueAllowTextToWrapOtherwiseTextIsClipped(JsonElement instance)
        {
            return IfTrueAllowTextToWrapOtherwiseTextIsClipped.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IfTrueAllowTextToWrapOtherwiseTextIsClipped From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IfTrueAllowTextToWrapOtherwiseTextIsClipped ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<IfTrueAllowTextToWrapOtherwiseTextIsClipped>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IfTrueAllowTextToWrapOtherwiseTextIsClipped ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<IfTrueAllowTextToWrapOtherwiseTextIsClipped>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IfTrueAllowTextToWrapOtherwiseTextIsClipped ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<IfTrueAllowTextToWrapOtherwiseTextIsClipped>(json, options);
        }
        ...
        /// </exception>
        public static IfTrueAllowTextToWrapOtherwiseTextIsClipped ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<IfTrueAllowTextToWrapOtherwiseTextIsClipped>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out IfTrueAllowTextToWrapOtherwiseTextIsClipped? result)
        {
            return JsonElementHelpers.TryParseValue<IfTrueAllowTextToWrapOtherwiseTextIsClipped>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new IfTrueAllowTextToWrapOtherwiseTextIsClipped(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static IfTrueAllowTextToWrapOtherwiseTextIsClipped IJsonElement<IfTrueAllowTextToWrapOtherwiseTextIsClipped>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"IfTrueAllowTextToWrapOtherwiseTextIsClipped: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="IfTrueAllowTextToWrapOtherwiseTextIsClipped"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="IfTrueAllowTextToWrapOtherwiseTextIsClipped"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public IfTrueAllowTextToWrapOtherwiseTextIsClipped Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<IfTrueAllowTextToWrapOtherwiseTextIsClipped>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="IfTrueAllowTextToWrapOtherwiseTextIsClipped"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public IfTrueAllowTextToWrapOtherwiseTextIsClipped Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<IfTrueAllowTextToWrapOtherwiseTextIsClipped>(_idx);
            }
