...
public readonly partial struct TextBlock
{
    ...
    public readonly partial struct IsSubtleEntity
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<IsSubtleEntity, Mutable>(IsSubtleEntity.DefaultInstance);
            ...
            public static explicit operator Mutable(IsSubtleEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="IsSubtleEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator IsSubtleEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"IsSubtleEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly IsSubtleEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly IsSubtleEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<IsSubtleEntity>(_idx);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.TextBlock.IsSubtleEntity.Mutable, TContext, TResult> defaultMatch)
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.TextBlock.IsSubtleEntity.Mutable, TResult> defaultMatch)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                {
            ...
            public TAccumulator MatchEvery<TAccumulator>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.TextBlock.IsSubtleEntity.Mutable, TAccumulator, TAccumulator> defaultMatch)
            {
                bool matched = false;
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(IsSubtleEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<IsSubtleEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<IsSubtleEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<IsSubtleEntity>();
            }
            finally
            {
