...
public readonly partial struct TextBlock
{
    ...
    public readonly partial struct MustBeTextBlock
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(MustBeTextBlock instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MustBeTextBlock"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MustBeTextBlock(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MustBeTextBlock.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeTextBlock Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly MustBeTextBlock Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MustBeTextBlock>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(MustBeTextBlock instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<MustBeTextBlock, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<MustBeTextBlock> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<MustBeTextBlock>();
            }
            finally
            {
