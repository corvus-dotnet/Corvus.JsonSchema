...
public readonly partial struct TextBlock
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MustBeTextBlock"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal MustBeTextBlock(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static MustBeTextBlock DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(MustBeTextBlock value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in MustBeTextBlock left, in MustBeTextBlock right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in MustBeTextBlock left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(MustBeTextBlock instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator MustBeTextBlock(JsonElement instance)
        {
            return MustBeTextBlock.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MustBeTextBlock From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MustBeTextBlock ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<MustBeTextBlock>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MustBeTextBlock ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<MustBeTextBlock>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MustBeTextBlock ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<MustBeTextBlock>(json, options);
        }
        ...
        /// </exception>
        public static MustBeTextBlock ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<MustBeTextBlock>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out MustBeTextBlock? result)
        {
            return JsonElementHelpers.TryParseValue<MustBeTextBlock>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new MustBeTextBlock(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static MustBeTextBlock IJsonElement<MustBeTextBlock>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"MustBeTextBlock: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="MustBeTextBlock"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="MustBeTextBlock"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public MustBeTextBlock Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<MustBeTextBlock>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="MustBeTextBlock"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public MustBeTextBlock Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<MustBeTextBlock>(_idx);
            }
