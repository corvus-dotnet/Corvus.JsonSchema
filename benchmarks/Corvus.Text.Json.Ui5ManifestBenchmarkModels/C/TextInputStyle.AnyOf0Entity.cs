...
public readonly partial struct TextInputStyle
{
...
#endif
    {
        ...
        /// <param name="matchText">Match 1st item.</param>
        /// <param name="matchTel">Match 2nd item.</param>
        /// <param name="matchUrl">Match 3rd item.</param>
        /// <param name="matchEmail">Match 4th item.</param>
        /// <param name="matchPassword">Match 5th item.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Func<TContext, TResult> matchText,
            Func<TContext, TResult> matchTel,
