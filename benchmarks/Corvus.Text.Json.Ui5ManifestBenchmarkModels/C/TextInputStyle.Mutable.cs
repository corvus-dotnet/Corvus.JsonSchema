...
public readonly partial struct TextInputStyle
{
...
#endif
    {
        ...
        /// <summary>
        /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf0Entity"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf0Entity.Mutable(Mutable value)
        {
            return Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf0Entity.Mutable.From(value);
        }

        /// <summary>
        /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf0Entity"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf0Entity.Mutable value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf1Entity.Mutable(Mutable value)
        {
            return Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf1Entity.Mutable.From(value);
        }

        /// <summary>
        /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf1Entity"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf1Entity.Mutable value)
        {
            return From(value);
        }
        ...
        public static explicit operator Mutable(TextInputStyle instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="TextInputStyle"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TextInputStyle(Mutable instance)
        {
        ...
        {
            return
                (obj is IJsonElement value && Equals(new TextInputStyle(value.ParentDocument, value.ParentDocumentIndex))) ||
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TextInputStyle.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="TextInputStyle"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="TextInputStyle"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public readonly TextInputStyle Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<TextInputStyle>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="TextInputStyle"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public readonly TextInputStyle Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<TextInputStyle>(_idx);
        }
        ...
        /// <param name="matchAnyOf0Entity">Match a <see cref="Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf0Entity"/>.</param>
        /// <param name="matchAnyOf1Entity">Match a <see cref="Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf1Entity"/>.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Matcher<Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf0Entity, TContext, TResult> matchAnyOf0Entity,
            Matcher<Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf1Entity, TContext, TResult> matchAnyOf1Entity,
            Matcher<Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
        where TContext : allows ref struct
#endif
        {
            if (Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf0Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchAnyOf0Entity(Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf0Entity.Mutable.From(this), context);
            }

            if (Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchAnyOf1Entity(Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf1Entity.Mutable.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            Matcher<Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf0Entity, TResult> matchAnyOf0Entity,
            Matcher<Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf1Entity, TResult> matchAnyOf1Entity,
            Matcher<Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.Mutable, TResult> defaultMatch)
        {
            if (Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf0Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchAnyOf0Entity(Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf0Entity.Mutable.From(this));
            }

            if (Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchAnyOf1Entity(Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf1Entity.Mutable.From(this));
            }
        ...
        public TAccumulator MatchEvery<TAccumulator>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf0Entity, TAccumulator, TAccumulator> matchAnyOf0Entity,
            Matcher<Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf1Entity, TAccumulator, TAccumulator> matchAnyOf1Entity,
            Matcher<Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.Mutable, TAccumulator, TAccumulator> defaultMatch)
        {
            bool matched = false;
            ...
            {
                matched = true;
                accumulator = matchAnyOf0Entity(Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf0Entity.Mutable.From(this), accumulator);
            }

            if (Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                matched = true;
                accumulator = matchAnyOf1Entity(Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf1Entity.Mutable.From(this), accumulator);
            }
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf0Entity.Mutable" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsAnyOf0Entity(out Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf0Entity.Mutable result)
        {
            if (Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf0Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf0Entity.Mutable.From(this);
                return true;
            }
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf1Entity.Mutable" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsAnyOf1Entity(out Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf1Entity.Mutable result)
        {
            if (Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf1Entity.Mutable.From(this);
                return true;
            }
    ...
    public ref struct Source
    {
        ...
        public static implicit operator Source(TextInputStyle instance) => new(JsonElement.From(instance));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf0Entity instance) => new(JsonElement.From(instance));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf1Entity instance) => new(JsonElement.From(instance));
    ...
    {
        return workspace.CreateBuilder<TextInputStyle, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<TextInputStyle> Create(
        scoped in Source value, int initialCapacity = 1)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<TextInputStyle>();
        }
        finally
        {
