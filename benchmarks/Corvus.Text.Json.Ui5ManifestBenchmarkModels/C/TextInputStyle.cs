...
#endif
{
    ...
    public static explicit operator Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf0Entity(TextInputStyle value)
    {
        return Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf0Entity.From(value);
    }
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator TextInputStyle(Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf0Entity value)
    {
        return From(value);
    }
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static explicit operator Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf1Entity(TextInputStyle value)
    {
        return Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf1Entity.From(value);
    }
    ...
    public bool TryGetAsAnyOf0Entity(out Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf0Entity result)
    {
        ...
        {
            result = Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf0Entity.From(this);
            return true;
        }
    ...
    public bool TryGetAsAnyOf1Entity(out Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf1Entity result)
    {
        ...
        {
            result = Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf1Entity.From(this);
            return true;
        }
    ...
    public TResult Match<TContext, TResult>(
        ...
        Matcher<Corvus.Ui5ManifestBenchmark.Current.TextInputStyle, TContext, TResult> defaultMatch)
...
#endif
    {
        if (Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf0Entity.JsonSchema.Evaluate(_parent, _idx))
        {
            return matchAnyOf0Entity(Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf0Entity.From(this), context);
        }

        if (Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
        {
            return matchAnyOf1Entity(Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf1Entity.From(this), context);
        }
    ...
    public TResult Match<TResult>(
        ...
        Matcher<Corvus.Ui5ManifestBenchmark.Current.TextInputStyle, TResult> defaultMatch)
    {
        if (Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf0Entity.JsonSchema.Evaluate(_parent, _idx))
        {
            return matchAnyOf0Entity(Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf0Entity.From(this));
        }

        if (Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
        {
            return matchAnyOf1Entity(Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf1Entity.From(this));
        }
    ...
    public TAccumulator MatchEvery<TAccumulator>(
        ...
        Matcher<Corvus.Ui5ManifestBenchmark.Current.TextInputStyle, TAccumulator, TAccumulator> defaultMatch)
    {
        bool matched = false;
        ...
        {
            matched = true;
            accumulator = matchAnyOf0Entity(Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf0Entity.From(this), accumulator);
        }

        if (Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
        {
            matched = true;
            accumulator = matchAnyOf1Entity(Corvus.Ui5ManifestBenchmark.Current.TextInputStyle.AnyOf1Entity.From(this), accumulator);
        }
