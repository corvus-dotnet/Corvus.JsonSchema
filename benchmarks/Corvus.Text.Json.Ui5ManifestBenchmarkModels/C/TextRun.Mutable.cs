...
public readonly partial struct TextRun
{
...
#endif
    {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText.Mutable value)
        {
            return From(value);
        }
        ...
        public static explicit operator Mutable(TextRun instance)
        {
        ...
        /// <returns>An immutable instance of a <see cref="TextRun"/>, initialized from the <see cref="Mutable"/> value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TextRun(Mutable instance)
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TextRun.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly TextRun Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<TextRun>(_idx);
        }
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.TextRun.Mutable, TContext, TResult> defaultMatch)
...
#endif
        {
            ...
            {
                return matchRequiredText(Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText.Mutable.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.TextRun.Mutable, TResult> defaultMatch)
        {
            if (Corvus.Ui5ManifestBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
            {
            ...
            if (Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredText(Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText.Mutable.From(this));
            }
        ...
        public TAccumulator MatchEvery<TAccumulator>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.TextRun.Mutable, TAccumulator, TAccumulator> defaultMatch)
        {
            bool matched = false;
            ...
            {
                matched = true;
                accumulator = matchRequiredText(Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText.Mutable.From(this), accumulator);
            }
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText.Mutable" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsRequiredText(out Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText.Mutable result)
        {
            if (Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText.Mutable.From(this);
                return true;
            }
        ...
        #endif
    {
        ...
        TContext _context;
        Source _source;
        private readonly Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText.Builder.Build<TContext>? _requiredTextBuilderInstance;
        ...
        public Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText.Builder.Build<TContext> value) {_context = context; _requiredTextBuilderInstance = value; _kind = Kind.RequiredTextBuilder; }
        ...
        internal void AddAsProperty(ReadOnlySpan<byte> utf8Name, ref ComplexValueBuilder valueBuilder, bool escapeName = true, bool nameRequiresUnescaping = false)
        {
            switch(_kind)
            {
                ...
                case Kind.Source:
                    ...
                    break;
                case Kind.RequiredTextBuilder:
                    valueBuilder.AddProperty(utf8Name, BuildWithContext.Create(_context, _requiredTextBuilderInstance!), static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText.Builder.BuildValue(b.Context, b.Build, ref o), escapeName, nameRequiresUnescaping);
                    break;
                default:
                    Debug.Fail("Unexpected Kind");
                    break;
        ...
        internal void AddAsPrebakedProperty(ReadOnlySpan<byte> prebakedPropertyName, ref ComplexValueBuilder valueBuilder)
        {
            switch(_kind)
            {
                ...
                case Kind.Source:
                    ...
                    break;
                case Kind.RequiredTextBuilder:
                    valueBuilder.AddPrebakedProperty(prebakedPropertyName, BuildWithContext.Create(_context, _requiredTextBuilderInstance!), static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText.Builder.BuildValue(b.Context, b.Build, ref o));
                    break;
                default:
                    Debug.Fail("Unexpected Kind");
                    break;
        ...
        internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
        {
            switch(_kind)
            {
                ...
                case Kind.Source:
                    ...
                    break;
                case Kind.RequiredTextBuilder:
                    valueBuilder.AddProperty(name, BuildWithContext.Create(_context, _requiredTextBuilderInstance!), static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText.Builder.BuildValue(b.Context, b.Build, ref o));
                    break;
                default:
                    Debug.Fail("Unexpected Kind");
                    break;
        ...
        internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
        {
            switch(_kind)
            {
                ...
                case Kind.Source:
                    ...
                    break;
                case Kind.RequiredTextBuilder:
                    valueBuilder.AddItem(BuildWithContext.Create(_context, _requiredTextBuilderInstance!), static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText.Builder.BuildValue(b.Context, b.Build, ref o));
                    break;
                default:
                    Debug.Fail("Unexpected Kind");
                    break;
    ...
    public static Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText.Source Build(
        scoped in Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText.Builder.Build buildValue, int initialCapacity = 1)
    {
        return new Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText.Source(buildValue);
    }
    ...
    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText.Source<TContext> Build<TContext>(
        scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText.Builder.Build<TContext> buildValue, int initialCapacity = 1)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        return new Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText.Source<TContext>(context, buildValue);
    }
    ...
    /// <returns>An instance of a mutable document initialized with the given value.</returns>
    public static JsonDocumentBuilder<Mutable> CreateBuilder(
        JsonWorkspace workspace, scoped in Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
    {
        // Create the document builder without a MetadataDb
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        var source = new Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText.Source(value);
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(
        JsonWorkspace workspace, scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
        ...
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        var source = new Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText.Source<TContext>(context, value);
        source.AddAsItem(ref cvb);
        Debug.Assert(cvb.MemberCount == 1);
        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
        return documentBuilder;
    ...
    {
        return workspace.CreateBuilder<TextRun, Mutable>(this);
    }
    ...
    public static ParsedJsonDocument<TextRun> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<TextRun>();
        }
        finally
        {
    ...
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<TextRun> Create(
        scoped in Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent(initialValueBufferSize);
        try
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<TextRun> Create<TContext>(
        scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
        #if NET9_0_OR_GREATER
        where TContext : allows ref struct
        #endif
    {
