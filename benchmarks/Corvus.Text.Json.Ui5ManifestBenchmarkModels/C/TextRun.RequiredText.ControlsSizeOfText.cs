...
public readonly partial struct TextRun
{
    ...
    public readonly partial struct RequiredText
    {
        ...
        public readonly partial struct ControlsSizeOfText
#if NET8_0_OR_GREATER
            : IJsonElement<ControlsSizeOfText>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ControlsSizeOfText"/> struct.
            /// </summary>
            ...
            internal ControlsSizeOfText(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ControlsSizeOfText DefaultInstance { get; }
            ...
            /// <summary>
            /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Current.FontSize"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.Ui5ManifestBenchmark.Current.FontSize(ControlsSizeOfText value)
            {
                return Corvus.Ui5ManifestBenchmark.Current.FontSize.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Current.FontSize"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator ControlsSizeOfText(Corvus.Ui5ManifestBenchmark.Current.FontSize value)
            {
                return From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.Ui5ManifestBenchmark.Current.FontSize.AnyOf0Entity(ControlsSizeOfText value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator ControlsSizeOfText(Corvus.Ui5ManifestBenchmark.Current.FontSize.AnyOf0Entity value)
            {
                return From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.Ui5ManifestBenchmark.Current.FontSize.AnyOf1Entity(ControlsSizeOfText value)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(ControlsSizeOfText value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in ControlsSizeOfText left, in ControlsSizeOfText right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ControlsSizeOfText left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ControlsSizeOfText instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ControlsSizeOfText(JsonElement instance)
            {
                return ControlsSizeOfText.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ControlsSizeOfText From<T>(in T instance)
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ControlsSizeOfText ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<ControlsSizeOfText>(utf8Json, options);
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ControlsSizeOfText ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<ControlsSizeOfText>(json, options);
                #pragma warning restore CS0618
            }
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ControlsSizeOfText ParseValue(string json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<ControlsSizeOfText>(json, options);
                #pragma warning restore CS0618
            ...
            /// </exception>
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            public static ControlsSizeOfText ParseValue(ref Utf8JsonReader reader)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<ControlsSizeOfText>(ref reader);
                #pragma warning restore CS0618
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ControlsSizeOfText? result)
            {
                return JsonElementHelpers.TryParseValue<ControlsSizeOfText>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ControlsSizeOfText(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static ControlsSizeOfText IJsonElement<ControlsSizeOfText>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ControlsSizeOfText: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ControlsSizeOfText"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ControlsSizeOfText"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public ControlsSizeOfText Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ControlsSizeOfText>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ControlsSizeOfText"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public ControlsSizeOfText Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ControlsSizeOfText>(_idx);
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Current.FontSize" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsFontSize(out Corvus.Ui5ManifestBenchmark.Current.FontSize result)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.FontSize.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Ui5ManifestBenchmark.Current.FontSize.From(this);
                    return true;
                }
            ...
            public TResult Match<TContext, TResult>(
                in TContext context,
                Matcher<Corvus.Ui5ManifestBenchmark.Current.FontSize, TContext, TResult> matchFontSize,
                Matcher<Corvus.Ui5ManifestBenchmark.Current.JsonNull, TContext, TResult> matchJsonNull,
                Matcher<Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText.ControlsSizeOfText, TContext, TResult> defaultMatch)
...
#endif
            {
                if (Corvus.Ui5ManifestBenchmark.Current.FontSize.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchFontSize(Corvus.Ui5ManifestBenchmark.Current.FontSize.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                Matcher<Corvus.Ui5ManifestBenchmark.Current.FontSize, TResult> matchFontSize,
                Matcher<Corvus.Ui5ManifestBenchmark.Current.JsonNull, TResult> matchJsonNull,
                Matcher<Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText.ControlsSizeOfText, TResult> defaultMatch)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.FontSize.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchFontSize(Corvus.Ui5ManifestBenchmark.Current.FontSize.From(this));
                }
            ...
            public TAccumulator MatchEvery<TAccumulator>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText.ControlsSizeOfText, TAccumulator, TAccumulator> defaultMatch)
            {
                bool matched = false;
                ...
                {
                    matched = true;
                    accumulator = matchFontSize(Corvus.Ui5ManifestBenchmark.Current.FontSize.From(this), accumulator);
                }
