    ...
    public readonly partial struct RequiredText
    {
        ...
        public readonly partial struct ControlsTheColorOfTheText
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ControlsTheColorOfTheText instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ControlsTheColorOfTheText"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ControlsTheColorOfTheText(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ControlsTheColorOfTheText.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ControlsTheColorOfTheText Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ControlsTheColorOfTheText Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ControlsTheColorOfTheText>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText.ControlsTheColorOfTheText.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText.ControlsTheColorOfTheText.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.Colors.JsonSchema.Evaluate(_parent, _idx))
                    {
                ...
                public TAccumulator MatchEvery<TAccumulator>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText.ControlsTheColorOfTheText.Mutable, TAccumulator, TAccumulator> defaultMatch)
                {
                    bool matched = false;
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ControlsTheColorOfTheText instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ControlsTheColorOfTheText, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ControlsTheColorOfTheText> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ControlsTheColorOfTheText>();
                }
                finally
                {
