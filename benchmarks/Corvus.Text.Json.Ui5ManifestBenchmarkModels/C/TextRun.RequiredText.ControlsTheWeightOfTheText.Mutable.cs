...
public readonly partial struct TextRun
{
    ...
    public readonly partial struct RequiredText
    {
        ...
        public readonly partial struct ControlsTheWeightOfTheText
        {
...
#endif
            {
                ...
                /// <summary>
                /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Current.FontWeight"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static explicit operator Corvus.Ui5ManifestBenchmark.Current.FontWeight.Mutable(Mutable value)
                {
                    return Corvus.Ui5ManifestBenchmark.Current.FontWeight.Mutable.From(value);
                }

                /// <summary>
                /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Current.FontWeight"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Current.FontWeight.Mutable value)
                {
                    return From(value);
                }
                ...
                public static explicit operator Mutable(ControlsTheWeightOfTheText instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ControlsTheWeightOfTheText"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ControlsTheWeightOfTheText(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ControlsTheWeightOfTheText(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ControlsTheWeightOfTheText.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ControlsTheWeightOfTheText"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ControlsTheWeightOfTheText"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ControlsTheWeightOfTheText Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ControlsTheWeightOfTheText>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ControlsTheWeightOfTheText"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ControlsTheWeightOfTheText Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ControlsTheWeightOfTheText>(_idx);
                }
                ...
                /// <param name="matchFontWeight">Match a <see cref="Corvus.Ui5ManifestBenchmark.Current.FontWeight"/>.</param>
                ...
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.FontWeight, TContext, TResult> matchFontWeight,
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.JsonNull, TContext, TResult> matchJsonNull,
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText.ControlsTheWeightOfTheText.Mutable, TContext, TResult> defaultMatch)
...
#endif
                {
                    ...
                    {
                        return matchFontWeight(Corvus.Ui5ManifestBenchmark.Current.FontWeight.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.FontWeight, TResult> matchFontWeight,
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.JsonNull, TResult> matchJsonNull,
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText.ControlsTheWeightOfTheText.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.FontWeight.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchFontWeight(Corvus.Ui5ManifestBenchmark.Current.FontWeight.Mutable.From(this));
                    }
                ...
                public TAccumulator MatchEvery<TAccumulator>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.FontWeight, TAccumulator, TAccumulator> matchFontWeight,
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.JsonNull, TAccumulator, TAccumulator> matchJsonNull,
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText.ControlsTheWeightOfTheText.Mutable, TAccumulator, TAccumulator> defaultMatch)
                {
                    bool matched = false;
                    ...
                    {
                        matched = true;
                        accumulator = matchFontWeight(Corvus.Ui5ManifestBenchmark.Current.FontWeight.Mutable.From(this), accumulator);
                    }
                ...
                public bool TryGetAsFontWeight(out Corvus.Ui5ManifestBenchmark.Current.FontWeight.Mutable result)
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.FontWeight.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.Ui5ManifestBenchmark.Current.FontWeight.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ControlsTheWeightOfTheText instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Current.FontWeight instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ControlsTheWeightOfTheText, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ControlsTheWeightOfTheText> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ControlsTheWeightOfTheText>();
                }
                finally
                {
