    ...
    public readonly partial struct RequiredText
    {
        ...
        public readonly partial struct TheTypeOfFontToUse
        {
...
#endif
            {
                ...
                public static explicit operator Corvus.Ui5ManifestBenchmark.Current.FontType.Mutable(Mutable value)
                {
                    return Corvus.Ui5ManifestBenchmark.Current.FontType.Mutable.From(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Current.FontType.Mutable value)
                {
                    return From(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static explicit operator Corvus.Ui5ManifestBenchmark.Current.FontType.AnyOf0Entity.Mutable(Mutable value)
                {
                    return Corvus.Ui5ManifestBenchmark.Current.FontType.AnyOf0Entity.Mutable.From(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Current.FontType.AnyOf0Entity.Mutable value)
                {
                    return From(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static explicit operator Corvus.Ui5ManifestBenchmark.Current.FontType.AnyOf1Entity.Mutable(Mutable value)
                {
                    return Corvus.Ui5ManifestBenchmark.Current.FontType.AnyOf1Entity.Mutable.From(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Current.FontType.AnyOf1Entity.Mutable value)
                {
                    return From(value);
                }
                ...
                public static explicit operator Mutable(TheTypeOfFontToUse instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TheTypeOfFontToUse"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TheTypeOfFontToUse(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TheTypeOfFontToUse.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly TheTypeOfFontToUse Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly TheTypeOfFontToUse Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TheTypeOfFontToUse>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText.TheTypeOfFontToUse.Mutable, TContext, TResult> defaultMatch)
...
#endif
                {
                    ...
                    {
                        return matchFontType(Corvus.Ui5ManifestBenchmark.Current.FontType.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText.TheTypeOfFontToUse.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.FontType.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchFontType(Corvus.Ui5ManifestBenchmark.Current.FontType.Mutable.From(this));
                    }
                ...
                public TAccumulator MatchEvery<TAccumulator>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText.TheTypeOfFontToUse.Mutable, TAccumulator, TAccumulator> defaultMatch)
                {
                    bool matched = false;
                    ...
                    {
                        matched = true;
                        accumulator = matchFontType(Corvus.Ui5ManifestBenchmark.Current.FontType.Mutable.From(this), accumulator);
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Current.FontType.Mutable" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsFontType(out Corvus.Ui5ManifestBenchmark.Current.FontType.Mutable result)
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.FontType.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.Ui5ManifestBenchmark.Current.FontType.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(TheTypeOfFontToUse instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Current.FontType instance) => new(JsonElement.From(instance));

                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Current.FontType.AnyOf0Entity instance) => new(JsonElement.From(instance));

                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Current.FontType.AnyOf1Entity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<TheTypeOfFontToUse, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<TheTypeOfFontToUse> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TheTypeOfFontToUse>();
                }
                finally
                {
