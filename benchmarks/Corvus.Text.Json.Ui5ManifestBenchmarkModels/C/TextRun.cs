...
#endif
{
    ...
    public static explicit operator Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText(TextRun value)
    {
        return Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText.From(value);
    }
    ...
    /// </summary>
    /// <param name="value">The value from which to convert.</param>
    public static implicit operator TextRun(Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText value)
    {
        return From(value);
    }
    ...
    /// <summary>
    /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText" />.
    /// </summary>
    /// <param name="result">The result of the conversions.</param>
    /// <returns><see langword="true" /> if the conversion was valid.</returns>
    public bool TryGetAsRequiredText(out Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText result)
    {
        if (Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText.JsonSchema.Evaluate(_parent, _idx))
        {
            result = Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText.From(this);
            return true;
        }
    ...
    /// <param name="matchRequiredText">Match a <see cref="Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText"/>.</param>
    ...
    public TResult Match<TContext, TResult>(
        ...
        Matcher<Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText, TContext, TResult> matchRequiredText,
        Matcher<Corvus.Ui5ManifestBenchmark.Current.TextRun, TContext, TResult> defaultMatch)
...
#endif
    {
        ...
        if (Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText.JsonSchema.Evaluate(_parent, _idx))
        {
            return matchRequiredText(Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText.From(this), context);
        }
    ...
    public TResult Match<TResult>(
        ...
        Matcher<Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText, TResult> matchRequiredText,
        Matcher<Corvus.Ui5ManifestBenchmark.Current.TextRun, TResult> defaultMatch)
    {
        if (Corvus.Ui5ManifestBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
        {
        ...
        if (Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText.JsonSchema.Evaluate(_parent, _idx))
        {
            return matchRequiredText(Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText.From(this));
        }
    ...
    public TAccumulator MatchEvery<TAccumulator>(
        ...
        Matcher<Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText, TAccumulator, TAccumulator> matchRequiredText,
        Matcher<Corvus.Ui5ManifestBenchmark.Current.TextRun, TAccumulator, TAccumulator> defaultMatch)
    {
        bool matched = false;
        ...
        {
            matched = true;
            accumulator = matchRequiredText(Corvus.Ui5ManifestBenchmark.Current.TextRun.RequiredText.From(this), accumulator);
        }
