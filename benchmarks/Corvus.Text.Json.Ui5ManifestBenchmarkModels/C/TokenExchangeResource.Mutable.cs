...
public readonly partial struct TokenExchangeResource
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable ProviderId
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ProviderIdUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.TokenExchangeResource.MustBeTokenExchangeResource.Mutable Type
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Ui5ManifestBenchmark.Current.TokenExchangeResource.MustBeTokenExchangeResource.Mutable value))
                {
                    return value;
                }
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetProviderId(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <param name="value">The value of the property to add.</param>
        public void SetType(scoped in Corvus.Ui5ManifestBenchmark.Current.TokenExchangeResource.MustBeTokenExchangeResource.Source value)
        {
            CheckValidInstance();
    ...
    public ref struct Source
    {
        ...
        private readonly Corvus.Ui5ManifestBenchmark.Current.TokenExchangeResource.MustBeTokenExchangeResource.Source _createArg4;
        ...
        internal Source(Corvus.Ui5ManifestBenchmark.Current.TokenExchangeResource.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        internal Source(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source arg1, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source arg2, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source arg3, scoped in Corvus.Ui5ManifestBenchmark.Current.TokenExchangeResource.MustBeTokenExchangeResource.Source arg4)
        {
            _createArg1 = arg1;
            _createArg2 = arg2;
            _createArg3 = arg3;
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.TokenExchangeResource.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
    ...
    public ref struct Builder
    {
        ...
        internal static void Create(
            ...
            in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source providerId,
            in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source uri,
            in Corvus.Ui5ManifestBenchmark.Current.TokenExchangeResource.MustBeTokenExchangeResource.Source type = default)
        {
        ...
        internal static void BuildCreateValue(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source arg1, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source arg2, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source arg3, scoped in Corvus.Ui5ManifestBenchmark.Current.TokenExchangeResource.MustBeTokenExchangeResource.Source arg4, ref ComplexValueBuilder o)
        {
            o.StartObject();
    ...
    /// <param name="providerId">The value of the <c>"providerId"</c> property.</param>
    /// <param name="uri">The value of the <c>"uri"</c> property.</param>
    /// <param name="type">The value of the <c>"type"</c> property.</param>
    /// <returns>The source from which to build the value.</returns>
    public static Source Build(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source id, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source providerId, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source uri, scoped in Corvus.Ui5ManifestBenchmark.Current.TokenExchangeResource.MustBeTokenExchangeResource.Source type = default)
    {
        return new Source(id, providerId, uri, type);
    }
    ...
    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source id, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source providerId, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source uri, in Corvus.Ui5ManifestBenchmark.Current.TokenExchangeResource.MustBeTokenExchangeResource.Source type = default, int initialCapacity = 30)
    {
        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
        cvb.StartObject();
    ...
    public static ParsedJsonDocument<TokenExchangeResource> Create(
        scoped in Source value, int initialCapacity = 30)
    {
        ...
        try
        {
            ...
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder.ToParsedJsonDocument<TokenExchangeResource>();
        }
        finally
        {
    ...
    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
    public static ParsedJsonDocument<TokenExchangeResource> Create<TContext>(
    ...
    public static ParsedJsonDocument<TokenExchangeResource> Create(in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source id, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source providerId, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source uri, in Corvus.Ui5ManifestBenchmark.Current.TokenExchangeResource.MustBeTokenExchangeResource.Source type = default, int initialCapacity = 30)
    {
        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
        try
        {
