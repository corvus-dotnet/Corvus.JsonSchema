...
#endif
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="TokenExchangeResource"/> struct.
    /// </summary>
    /// <param name="value">The value from which to construct the instance.</param>
    internal TokenExchangeResource(IJsonDocument parent, int idx)
    {
        Debug.Assert(idx >= 0);
        _parent = parent;
        _idx = idx;
    ...
    /// </summary>
    public static TokenExchangeResource DefaultInstance { get; }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Ui5ManifestBenchmark.Current.JsonString ProviderId
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ProviderIdUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString value))
            {
                return value;
            }
    ...
    /// </para>
    /// </remarks>
    public Corvus.Ui5ManifestBenchmark.Current.TokenExchangeResource.MustBeTokenExchangeResource Type
    {
        get
        {
            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Ui5ManifestBenchmark.Current.TokenExchangeResource.MustBeTokenExchangeResource value))
            {
                return value;
            }
    ...
    /// </returns>
    public static bool operator ==(in TokenExchangeResource left, in TokenExchangeResource right)
    {
    ...
    /// <c>True</c> if the values are equal.
    /// </returns>
    public static bool operator ==(in TokenExchangeResource left, in JsonElement right)
    {
        return left.Equals(right);
    }
    ...
    public static implicit operator JsonElement(TokenExchangeResource instance)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator TokenExchangeResource(JsonElement instance)
    {
        return TokenExchangeResource.From(instance);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TokenExchangeResource From<T>(in T instance)
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TokenExchangeResource ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<TokenExchangeResource>(utf8Json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TokenExchangeResource ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<TokenExchangeResource>(json, options);
    }
    ...
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TokenExchangeResource ParseValue(string json, JsonDocumentOptions options = default)
    {
        return JsonElementHelpers.ParseValue<TokenExchangeResource>(json, options);
    }
    ...
    /// </exception>
    public static TokenExchangeResource ParseValue(ref Utf8JsonReader reader)
    {
        return JsonElementHelpers.ParseValue<TokenExchangeResource>(ref reader);
    }
    ...
    ///   A value could not be read from the reader.
    /// </exception>
    public static bool TryParseValue(ref Utf8JsonReader reader, out TokenExchangeResource? result)
    {
        return JsonElementHelpers.TryParseValue<TokenExchangeResource>(ref reader, out result);
    }
    ...
    {
        return
            (obj is IJsonElement value && Equals(new TokenExchangeResource(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
    static TokenExchangeResource IJsonElement<TokenExchangeResource>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private string DebuggerDisplay => $"TokenExchangeResource: ValueKind = {ValueKind} : \"{ToString()}\"";
    ...
    /// <summary>
    /// Gets a <see cref="TokenExchangeResource"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </summary>
    /// <returns>
    /// A <see cref="TokenExchangeResource"/> which can be safely stored beyond the lifetime of the
    /// original document.
    /// </returns>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public TokenExchangeResource Clone()
    {
        CheckValidInstance();
        return _parent.CloneElement<TokenExchangeResource>(_idx);
    }
    ...
    /// </summary>
    /// <returns>
    /// An immutable <see cref="TokenExchangeResource"/> that lives for the lifetime of its
    ...
    /// </para>
    /// </remarks>
    public TokenExchangeResource Freeze()
    {
        CheckValidInstance();
        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
        {
            return mutable.FreezeElement<TokenExchangeResource>(_idx);
        }
    ...
    public static class JsonPropertyNames
    {
        ...
        /// <summary>
        /// Gets the JSON property name for <see cref="ProviderId"/>.
        /// </summary>
        ...
        /// Gets the JSON property name for <see cref="ProviderId"/>.
        /// </summary>
        public static ReadOnlySpan<byte> ProviderIdUtf8 => "providerId"u8;
    ...
    private static class JsonPropertyNamesEscaped
    {
        ...
        /// <summary>
        /// Gets the escaped UTF-8 JSON property name for <see cref="ProviderId"/>.
        /// </summary>
        public static ReadOnlySpan<byte> ProviderId => "providerId"u8;
