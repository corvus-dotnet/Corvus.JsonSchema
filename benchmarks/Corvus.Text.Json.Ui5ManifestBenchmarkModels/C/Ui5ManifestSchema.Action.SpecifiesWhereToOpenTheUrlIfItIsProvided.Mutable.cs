    ...
    public readonly partial struct Action
    {
        ...
        public readonly partial struct SpecifiesWhereToOpenTheUrlIfItIsProvided
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(SpecifiesWhereToOpenTheUrlIfItIsProvided instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SpecifiesWhereToOpenTheUrlIfItIsProvided"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SpecifiesWhereToOpenTheUrlIfItIsProvided(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SpecifiesWhereToOpenTheUrlIfItIsProvided.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly SpecifiesWhereToOpenTheUrlIfItIsProvided Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly SpecifiesWhereToOpenTheUrlIfItIsProvided Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SpecifiesWhereToOpenTheUrlIfItIsProvided>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Action.SpecifiesWhereToOpenTheUrlIfItIsProvided.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Action.SpecifiesWhereToOpenTheUrlIfItIsProvided.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Target.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SpecifiesWhereToOpenTheUrlIfItIsProvided instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<SpecifiesWhereToOpenTheUrlIfItIsProvided, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<SpecifiesWhereToOpenTheUrlIfItIsProvided> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SpecifiesWhereToOpenTheUrlIfItIsProvided>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<SpecifiesWhereToOpenTheUrlIfItIsProvided> Create<TContext>(
