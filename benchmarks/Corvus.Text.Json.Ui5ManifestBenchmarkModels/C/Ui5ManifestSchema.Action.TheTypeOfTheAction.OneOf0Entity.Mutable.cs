        ...
        public readonly partial struct TheTypeOfTheAction
        {
            ...
            public readonly partial struct OneOf0Entity
            {
...
#endif
                {
                    ...
                    /// <param name="matchCustom">Match 1st item.</param>
                    /// <param name="matchNavigation">Match 2nd item.</param>
                    /// <param name="matchSubmit">Match 3rd item.</param>
                    /// <param name="matchShowCard">Match 4th item.</param>
                    /// <param name="matchHideCard">Match 5th item.</param>
                    /// <param name="defaultMatch">Match any other value.</param>
                    /// <returns>An instance of the value returned by the match function.</returns>
                    public TResult Match<TContext, TResult>(
                        in TContext context,
                        Func<TContext, TResult> matchCustom,
                        Func<TContext, TResult> matchNavigation,
                        Func<TContext, TResult> matchSubmit,
                        Func<TContext, TResult> matchShowCard,
                        Func<TContext, TResult> matchHideCard,
...
#endif
                    {
                        ...
                        {
                            return matchNavigation(context);
                        }
                        ...
                        {
                            return matchShowCard(context);
                        }

                        if (this.ValueEquals(Constants.Enum5))
                        {
                            return matchHideCard(context);
                        }
                    ...
                    public TResult Match<TResult>(
                        ...
                        Func<TResult> matchNavigation,
                        Func<TResult> matchSubmit,
                        Func<TResult> matchShowCard,
                        Func<TResult> matchHideCard,
                        Func<TResult> defaultMatch)
                    {
                        ...
                        if (this.ValueEquals(Constants.Enum4))
                        {
                            return matchShowCard();
                        }

                        if (this.ValueEquals(Constants.Enum5))
                        {
                            return matchHideCard();
                        }
                    ...
                    public bool TryGetKnownValue(out KnownValues result)
                    {
                        ...
                        if (this.ValueEquals(Constants.Enum4))
                        {
                            result = KnownValues.ShowCard;
                            return true;
                        }

                        if (this.ValueEquals(Constants.Enum5))
                        {
                            result = KnownValues.HideCard;
                            return true;
                        }
