...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct ActionPropDef
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ActionPropDef instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ActionPropDef"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ActionPropDef(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable Target
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TargetUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ActionPropDef.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ActionPropDef Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ActionPropDef Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ActionPropDef>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RefreshStrategiesPropDef.Source _createArg3;
            ...
            public static implicit operator Source(ActionPropDef instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            private readonly Corvus.Ui5ManifestBenchmark.Current.JsonString.Source _createArg1;
            private readonly Corvus.Ui5ManifestBenchmark.Current.JsonString.Source _createArg2;
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RefreshStrategiesPropDef.Source<TContext> _createArg3;
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="ActionPropDef"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source path,
                in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source target,
            ...
            public void Create(
                ...
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RefreshStrategiesPropDef.Source refreshStrategyOnAppRestore = default)
            {
                Create(ref _builder, path, target, refreshStrategyOnAppRestore);
            }
            ...
            #endif
            {
                Create(context, ref _builder, path, target, refreshStrategyOnAppRestore);
            }
        ...
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source path, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source target, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RefreshStrategiesPropDef.Source<TContext> refreshStrategyOnAppRestore = default)
            ...
            #endif
        {
            return new Source<TContext>(context, path, target, refreshStrategyOnAppRestore);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source path, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source target, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RefreshStrategiesPropDef.Source refreshStrategyOnAppRestore = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(path, target, refreshStrategyOnAppRestore);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source path, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source target, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RefreshStrategiesPropDef.Source<TContext> refreshStrategyOnAppRestore = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            ...
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(context, path, target, refreshStrategyOnAppRestore);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<ActionPropDef, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ActionPropDef> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ActionPropDef>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ActionPropDef> Create<TContext>(
        ...
        public static ParsedJsonDocument<ActionPropDef> Create(in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source path, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source target, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RefreshStrategiesPropDef.Source refreshStrategyOnAppRestore = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ActionPropDef> Create<TContext>(in TContext context, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source path, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source target, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RefreshStrategiesPropDef.Source<TContext> refreshStrategyOnAppRestore = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
