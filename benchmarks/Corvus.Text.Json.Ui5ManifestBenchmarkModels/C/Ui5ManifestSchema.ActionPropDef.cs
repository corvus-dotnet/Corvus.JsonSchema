...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct ActionPropDef
#if NET8_0_OR_GREATER
        : IJsonElement<ActionPropDef>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ActionPropDef"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ActionPropDef(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ActionPropDef DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.JsonString Target
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TargetUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in ActionPropDef left, in ActionPropDef right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ActionPropDef left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(ActionPropDef instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ActionPropDef(JsonElement instance)
        {
            return ActionPropDef.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ActionPropDef From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ActionPropDef ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ActionPropDef>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ActionPropDef ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ActionPropDef>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ActionPropDef ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ActionPropDef>(json, options);
        }
        ...
        /// </exception>
        public static ActionPropDef ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ActionPropDef>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ActionPropDef? result)
        {
            return JsonElementHelpers.TryParseValue<ActionPropDef>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ActionPropDef(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static ActionPropDef IJsonElement<ActionPropDef>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ActionPropDef: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ActionPropDef"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ActionPropDef"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public ActionPropDef Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ActionPropDef>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ActionPropDef"/> that lives for the lifetime of its
