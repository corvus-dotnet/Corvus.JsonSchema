        ...
        public readonly partial struct AriaHasPopupEntity
        {
            ...
            public readonly partial struct OneOf0Entity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<OneOf0Entity, Mutable>(OneOf0Entity.DefaultInstance);
                    ...
                    public bool TryGetKnownValue(out KnownValues result)
                    {
                        if (this.ValueEquals(Constants.Enum1))
                        {
                            result = KnownValues.Dialog;
                            return true;
                        }

                        if (this.ValueEquals(Constants.Enum2))
                        {
                            result = KnownValues.Grid;
                            return true;
                        }

                        if (this.ValueEquals(Constants.Enum3))
                        {
                            result = KnownValues.ListBox;
                            return true;
                        }
