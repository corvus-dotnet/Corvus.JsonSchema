    ...
    public readonly partial struct ActionsStripItem
    {
        ...
        public readonly partial struct AriaHasPopupEntity
        {
...
#endif
            {
                ...
                /// </summary>
                public static OneOf0Entity DefaultInstance { get; } = ParsedJsonDocument<OneOf0Entity>.StringConstant([.."\"None\""u8]);
                ...
                /// <param name="matchDialog">Match 1st item.</param>
                /// <param name="matchGrid">Match 2nd item.</param>
                /// <param name="matchListBox">Match 3rd item.</param>
                /// <param name="matchMenu">Match 4th item.</param>
                /// <param name="matchNone">Match 5th item.</param>
                /// <param name="matchTree">Match 6th item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> matchDialog,
                    Func<TContext, TResult> matchGrid,
                    Func<TContext, TResult> matchListBox,
                    Func<TContext, TResult> matchMenu,
                    Func<TContext, TResult> matchNone,
                    Func<TContext, TResult> matchTree,
                ...
                public TResult Match<TResult>(
                    Func<TResult> matchDialog,
                    Func<TResult> matchGrid,
                    Func<TResult> matchListBox,
                    Func<TResult> matchMenu,
                    Func<TResult> matchNone,
                    Func<TResult> matchTree,
