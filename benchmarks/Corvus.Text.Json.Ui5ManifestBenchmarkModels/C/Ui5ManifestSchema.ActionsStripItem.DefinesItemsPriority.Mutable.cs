    ...
    public readonly partial struct ActionsStripItem
    {
        ...
        public readonly partial struct DefinesItemsPriority
        {
...
#endif
            {
                ...
                /// <summary>
                /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ActionsStripItem.DefinesItemsPriority.OneOf0Entity"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static explicit operator Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ActionsStripItem.DefinesItemsPriority.OneOf0Entity.Mutable(Mutable value)
                {
                    return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ActionsStripItem.DefinesItemsPriority.OneOf0Entity.Mutable.From(value);
                }

                /// <summary>
                /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ActionsStripItem.DefinesItemsPriority.OneOf0Entity"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ActionsStripItem.DefinesItemsPriority.OneOf0Entity.Mutable value)
                {
                    return From(value);
                }
                ...
                public static explicit operator Mutable(DefinesItemsPriority instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DefinesItemsPriority"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DefinesItemsPriority(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DefinesItemsPriority.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly DefinesItemsPriority Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly DefinesItemsPriority Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DefinesItemsPriority>(_idx);
                }
                ...
                /// <param name="matchOneOf0Entity">Match a <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ActionsStripItem.DefinesItemsPriority.OneOf0Entity"/>.</param>
                ...
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ActionsStripItem.DefinesItemsPriority.OneOf0Entity, TContext, TResult> matchOneOf0Entity,
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.SimpleBinding, TContext, TResult> matchSimpleBinding,
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ActionsStripItem.DefinesItemsPriority.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ActionsStripItem.DefinesItemsPriority.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchOneOf0Entity(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ActionsStripItem.DefinesItemsPriority.OneOf0Entity.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ActionsStripItem.DefinesItemsPriority.OneOf0Entity, TResult> matchOneOf0Entity,
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.SimpleBinding, TResult> matchSimpleBinding,
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ActionsStripItem.DefinesItemsPriority.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ActionsStripItem.DefinesItemsPriority.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchOneOf0Entity(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ActionsStripItem.DefinesItemsPriority.OneOf0Entity.Mutable.From(this));
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ActionsStripItem.DefinesItemsPriority.OneOf0Entity.Mutable" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsOneOf0Entity(out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ActionsStripItem.DefinesItemsPriority.OneOf0Entity.Mutable result)
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ActionsStripItem.DefinesItemsPriority.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ActionsStripItem.DefinesItemsPriority.OneOf0Entity.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(DefinesItemsPriority instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ActionsStripItem.DefinesItemsPriority.OneOf0Entity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<DefinesItemsPriority, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<DefinesItemsPriority> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<DefinesItemsPriority>();
                }
                finally
                {
