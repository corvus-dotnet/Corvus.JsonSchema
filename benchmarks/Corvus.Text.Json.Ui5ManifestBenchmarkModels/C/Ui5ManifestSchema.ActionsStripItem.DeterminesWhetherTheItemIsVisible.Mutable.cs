    ...
    public readonly partial struct ActionsStripItem
    {
        ...
        public readonly partial struct DeterminesWhetherTheItemIsVisible
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(DeterminesWhetherTheItemIsVisible instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DeterminesWhetherTheItemIsVisible"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DeterminesWhetherTheItemIsVisible(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new DeterminesWhetherTheItemIsVisible(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DeterminesWhetherTheItemIsVisible.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="DeterminesWhetherTheItemIsVisible"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="DeterminesWhetherTheItemIsVisible"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly DeterminesWhetherTheItemIsVisible Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<DeterminesWhetherTheItemIsVisible>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="DeterminesWhetherTheItemIsVisible"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly DeterminesWhetherTheItemIsVisible Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DeterminesWhetherTheItemIsVisible>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ActionsStripItem.DeterminesWhetherTheItemIsVisible.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ActionsStripItem.DeterminesWhetherTheItemIsVisible.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(DeterminesWhetherTheItemIsVisible instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<DeterminesWhetherTheItemIsVisible, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<DeterminesWhetherTheItemIsVisible> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<DeterminesWhetherTheItemIsVisible>();
                }
                finally
                {
