        ...
        public readonly partial struct TheTypeOfTheItem
        {
            ...
            public readonly partial struct OneOf0Entity
            {
...
#endif
                {
                    ...
                    /// <param name="matchButton">Match 1st item.</param>
                    /// <param name="matchToolbarSpacer">Match 2nd item.</param>
                    /// <param name="matchLink">Match 3rd item.</param>
                    /// <param name="defaultMatch">Match any other value.</param>
                    /// <returns>An instance of the value returned by the match function.</returns>
                    public TResult Match<TContext, TResult>(
                        in TContext context,
                        Func<TContext, TResult> matchButton,
                        Func<TContext, TResult> matchToolbarSpacer,
...
#endif
                    {
                        ...
                        {
                            return matchButton(context);
                        }

                        if (this.ValueEquals(Constants.Enum2))
                        {
                            return matchToolbarSpacer(context);
                        }
                    ...
                    public TResult Match<TResult>(
                        Func<TResult> matchButton,
                        Func<TResult> matchToolbarSpacer,
