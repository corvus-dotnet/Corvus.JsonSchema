...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct BooleanOrString
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(BooleanOrString instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="BooleanOrString"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator BooleanOrString(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"BooleanOrString.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly BooleanOrString Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly BooleanOrString Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<BooleanOrString>(_idx);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.BooleanOrString.Mutable, TContext, TResult> defaultMatch)
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.BooleanOrString.Mutable, TResult> defaultMatch)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                {
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(BooleanOrString instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<BooleanOrString, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<BooleanOrString> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<BooleanOrString>();
            }
            finally
            {
