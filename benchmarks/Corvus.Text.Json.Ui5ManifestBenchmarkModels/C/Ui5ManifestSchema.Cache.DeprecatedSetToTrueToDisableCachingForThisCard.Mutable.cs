    ...
    public readonly partial struct Cache
    {
        ...
        public readonly partial struct DeprecatedSetToTrueToDisableCachingForThisCard
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DeprecatedSetToTrueToDisableCachingForThisCard, Mutable>(DeprecatedSetToTrueToDisableCachingForThisCard.DefaultInstance);
                ...
                public static explicit operator Mutable(DeprecatedSetToTrueToDisableCachingForThisCard instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DeprecatedSetToTrueToDisableCachingForThisCard"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DeprecatedSetToTrueToDisableCachingForThisCard(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DeprecatedSetToTrueToDisableCachingForThisCard.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly DeprecatedSetToTrueToDisableCachingForThisCard Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly DeprecatedSetToTrueToDisableCachingForThisCard Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DeprecatedSetToTrueToDisableCachingForThisCard>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(DeprecatedSetToTrueToDisableCachingForThisCard instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<DeprecatedSetToTrueToDisableCachingForThisCard, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<DeprecatedSetToTrueToDisableCachingForThisCard> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<DeprecatedSetToTrueToDisableCachingForThisCard>();
                }
                finally
                {
