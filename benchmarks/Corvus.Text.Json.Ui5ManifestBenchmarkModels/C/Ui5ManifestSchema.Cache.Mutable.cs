...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct Cache
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Cache.SetToFalseToDisableCachingForThisCard.Mutable Enabled
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EnabledUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Cache.SetToFalseToDisableCachingForThisCard.Mutable value))
                    {
                        return value;
                    }

                    return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Cache.SetToFalseToDisableCachingForThisCard.Mutable.DefaultInstance;
                }
            }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Cache.TheMaximumAgeForWhichTheCacheIsConsideredFresh.Mutable MaxAge
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MaxAgeUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Cache.TheMaximumAgeForWhichTheCacheIsConsideredFresh.Mutable value))
                    {
                        return value;
                    }

                    return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Cache.TheMaximumAgeForWhichTheCacheIsConsideredFresh.Mutable.DefaultInstance;
                }
            }

            /// <summary>
            /// Gets the (optional) <c>noStore</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Cache.DeprecatedSetToTrueToDisableCachingForThisCard.Mutable NoStore
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NoStoreUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Cache.DeprecatedSetToTrueToDisableCachingForThisCard.Mutable value))
                    {
                        return value;
                    }

                    return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Cache.DeprecatedSetToTrueToDisableCachingForThisCard.Mutable.DefaultInstance;
                }
            }

            /// <summary>
            /// Gets the (optional) <c>staleWhileRevalidate</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Cache.ShouldWeShowStaleCacheWhileRevalidating.Mutable StaleWhileRevalidate
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StaleWhileRevalidateUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Cache.ShouldWeShowStaleCacheWhileRevalidating.Mutable value))
                    {
                        return value;
                    }

                    return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Cache.ShouldWeShowStaleCacheWhileRevalidating.Mutable.DefaultInstance;
                }
            }
            ...
            public void SetNoStore(scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Cache.DeprecatedSetToTrueToDisableCachingForThisCard.Source value)
            {
                ...
                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.NoStoreUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NoStoreUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.NoStore, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// <summary>
            /// Remove the <c>noStore</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveNoStore()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.NoStoreUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            public void SetStaleWhileRevalidate(scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Cache.ShouldWeShowStaleCacheWhileRevalidating.Source value)
            {
                ...
                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.StaleWhileRevalidateUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StaleWhileRevalidateUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.StaleWhileRevalidate, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// <summary>
            /// Remove the <c>staleWhileRevalidate</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveStaleWhileRevalidate()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.StaleWhileRevalidateUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Cache.SetToFalseToDisableCachingForThisCard.Source _createArg1;
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Cache.TheMaximumAgeForWhichTheCacheIsConsideredFresh.Source _createArg2;
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Cache.DeprecatedSetToTrueToDisableCachingForThisCard.Source _createArg3;
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Cache.ShouldWeShowStaleCacheWhileRevalidating.Source _createArg4;
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Cache.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="Cache"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Cache.SetToFalseToDisableCachingForThisCard.Source enabled = default,
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Cache.TheMaximumAgeForWhichTheCacheIsConsideredFresh.Source maxAge = default,
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Cache.DeprecatedSetToTrueToDisableCachingForThisCard.Source noStore = default,
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Cache.ShouldWeShowStaleCacheWhileRevalidating.Source staleWhileRevalidate = default)
            {
                ...
                noStore.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.NoStore, ref builder);
                staleWhileRevalidate.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.StaleWhileRevalidate, ref builder);
            }
            ...
            public void Create(
                ...
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Cache.ShouldWeShowStaleCacheWhileRevalidating.Source staleWhileRevalidate = default)
            {
                Create(ref _builder, enabled, maxAge, noStore, staleWhileRevalidate);
            }
        ...
        /// <param name="noStore">The value of the property.</param>
        /// <param name="staleWhileRevalidate">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Cache.SetToFalseToDisableCachingForThisCard.Source enabled = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Cache.TheMaximumAgeForWhichTheCacheIsConsideredFresh.Source maxAge = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Cache.DeprecatedSetToTrueToDisableCachingForThisCard.Source noStore = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Cache.ShouldWeShowStaleCacheWhileRevalidating.Source staleWhileRevalidate = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(enabled, maxAge, noStore, staleWhileRevalidate);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        public static ParsedJsonDocument<Cache> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Cache>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Cache> Create<TContext>(
        ...
        public static ParsedJsonDocument<Cache> Create(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Cache.SetToFalseToDisableCachingForThisCard.Source enabled = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Cache.TheMaximumAgeForWhichTheCacheIsConsideredFresh.Source maxAge = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Cache.DeprecatedSetToTrueToDisableCachingForThisCard.Source noStore = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Cache.ShouldWeShowStaleCacheWhileRevalidating.Source staleWhileRevalidate = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
