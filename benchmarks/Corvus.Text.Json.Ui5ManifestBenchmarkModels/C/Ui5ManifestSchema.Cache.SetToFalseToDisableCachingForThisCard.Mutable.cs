...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct Cache
    {
        ...
        public readonly partial struct SetToFalseToDisableCachingForThisCard
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SetToFalseToDisableCachingForThisCard, Mutable>(SetToFalseToDisableCachingForThisCard.DefaultInstance);
                ...
                public static explicit operator Mutable(SetToFalseToDisableCachingForThisCard instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SetToFalseToDisableCachingForThisCard"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SetToFalseToDisableCachingForThisCard(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new SetToFalseToDisableCachingForThisCard(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SetToFalseToDisableCachingForThisCard.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="SetToFalseToDisableCachingForThisCard"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="SetToFalseToDisableCachingForThisCard"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly SetToFalseToDisableCachingForThisCard Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<SetToFalseToDisableCachingForThisCard>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="SetToFalseToDisableCachingForThisCard"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly SetToFalseToDisableCachingForThisCard Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SetToFalseToDisableCachingForThisCard>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SetToFalseToDisableCachingForThisCard instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<SetToFalseToDisableCachingForThisCard, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<SetToFalseToDisableCachingForThisCard> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SetToFalseToDisableCachingForThisCard>();
                }
                finally
                {
