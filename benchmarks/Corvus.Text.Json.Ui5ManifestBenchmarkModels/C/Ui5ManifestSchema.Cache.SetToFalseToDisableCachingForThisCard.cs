...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct Cache
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="SetToFalseToDisableCachingForThisCard"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal SetToFalseToDisableCachingForThisCard(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static SetToFalseToDisableCachingForThisCard DefaultInstance { get; } = ParsedJsonDocument<SetToFalseToDisableCachingForThisCard>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(SetToFalseToDisableCachingForThisCard value)
            {
            ...
            /// </returns>
            public static bool operator ==(in SetToFalseToDisableCachingForThisCard left, in SetToFalseToDisableCachingForThisCard right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in SetToFalseToDisableCachingForThisCard left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(SetToFalseToDisableCachingForThisCard instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SetToFalseToDisableCachingForThisCard(JsonElement instance)
            {
                return SetToFalseToDisableCachingForThisCard.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SetToFalseToDisableCachingForThisCard From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SetToFalseToDisableCachingForThisCard ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SetToFalseToDisableCachingForThisCard>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SetToFalseToDisableCachingForThisCard ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SetToFalseToDisableCachingForThisCard>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SetToFalseToDisableCachingForThisCard ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SetToFalseToDisableCachingForThisCard>(json, options);
            }
            ...
            /// </exception>
            public static SetToFalseToDisableCachingForThisCard ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<SetToFalseToDisableCachingForThisCard>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out SetToFalseToDisableCachingForThisCard? result)
            {
                return JsonElementHelpers.TryParseValue<SetToFalseToDisableCachingForThisCard>(ref reader, out result);
            }
...
#if NET
            static SetToFalseToDisableCachingForThisCard IJsonElement<SetToFalseToDisableCachingForThisCard>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SetToFalseToDisableCachingForThisCard: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public SetToFalseToDisableCachingForThisCard Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public SetToFalseToDisableCachingForThisCard Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<SetToFalseToDisableCachingForThisCard>(_idx);
                }
