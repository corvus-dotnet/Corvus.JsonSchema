    ...
    public readonly partial struct Cache
    {
        ...
        public readonly partial struct ShouldWeShowStaleCacheWhileRevalidating
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ShouldWeShowStaleCacheWhileRevalidating, Mutable>(ShouldWeShowStaleCacheWhileRevalidating.DefaultInstance);
            ...
            public static ParsedJsonDocument<ShouldWeShowStaleCacheWhileRevalidating> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ShouldWeShowStaleCacheWhileRevalidating>();
                }
                finally
                {
