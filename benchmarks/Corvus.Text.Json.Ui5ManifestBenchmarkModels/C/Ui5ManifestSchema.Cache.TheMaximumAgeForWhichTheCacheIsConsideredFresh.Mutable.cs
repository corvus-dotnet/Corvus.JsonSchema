    ...
    public readonly partial struct Cache
    {
        ...
        public readonly partial struct TheMaximumAgeForWhichTheCacheIsConsideredFresh
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<TheMaximumAgeForWhichTheCacheIsConsideredFresh, Mutable>(TheMaximumAgeForWhichTheCacheIsConsideredFresh.DefaultInstance);
                ...
                public static explicit operator Mutable(TheMaximumAgeForWhichTheCacheIsConsideredFresh instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TheMaximumAgeForWhichTheCacheIsConsideredFresh"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TheMaximumAgeForWhichTheCacheIsConsideredFresh(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TheMaximumAgeForWhichTheCacheIsConsideredFresh.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly TheMaximumAgeForWhichTheCacheIsConsideredFresh Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly TheMaximumAgeForWhichTheCacheIsConsideredFresh Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TheMaximumAgeForWhichTheCacheIsConsideredFresh>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(TheMaximumAgeForWhichTheCacheIsConsideredFresh instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<TheMaximumAgeForWhichTheCacheIsConsideredFresh, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<TheMaximumAgeForWhichTheCacheIsConsideredFresh> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TheMaximumAgeForWhichTheCacheIsConsideredFresh>();
                }
                finally
                {
