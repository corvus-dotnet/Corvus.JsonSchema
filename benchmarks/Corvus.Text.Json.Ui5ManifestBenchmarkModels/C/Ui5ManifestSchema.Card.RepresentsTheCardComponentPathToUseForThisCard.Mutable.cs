    ...
    public readonly partial struct Card
    {
        ...
        public readonly partial struct RepresentsTheCardComponentPathToUseForThisCard
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RepresentsTheCardComponentPathToUseForThisCard instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsTheCardComponentPathToUseForThisCard"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsTheCardComponentPathToUseForThisCard(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsTheCardComponentPathToUseForThisCard.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheCardComponentPathToUseForThisCard Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheCardComponentPathToUseForThisCard Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsTheCardComponentPathToUseForThisCard>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsTheCardComponentPathToUseForThisCard instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RepresentsTheCardComponentPathToUseForThisCard, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RepresentsTheCardComponentPathToUseForThisCard> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RepresentsTheCardComponentPathToUseForThisCard>();
                }
                finally
                {
