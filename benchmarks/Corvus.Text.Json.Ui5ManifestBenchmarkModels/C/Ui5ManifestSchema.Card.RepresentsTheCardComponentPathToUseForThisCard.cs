...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct Card
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RepresentsTheCardComponentPathToUseForThisCard"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RepresentsTheCardComponentPathToUseForThisCard(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RepresentsTheCardComponentPathToUseForThisCard DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(RepresentsTheCardComponentPathToUseForThisCard value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in RepresentsTheCardComponentPathToUseForThisCard left, in RepresentsTheCardComponentPathToUseForThisCard right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RepresentsTheCardComponentPathToUseForThisCard left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(RepresentsTheCardComponentPathToUseForThisCard instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RepresentsTheCardComponentPathToUseForThisCard(JsonElement instance)
            {
                return RepresentsTheCardComponentPathToUseForThisCard.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheCardComponentPathToUseForThisCard From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheCardComponentPathToUseForThisCard ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheCardComponentPathToUseForThisCard>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheCardComponentPathToUseForThisCard ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheCardComponentPathToUseForThisCard>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheCardComponentPathToUseForThisCard ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheCardComponentPathToUseForThisCard>(json, options);
            }
            ...
            /// </exception>
            public static RepresentsTheCardComponentPathToUseForThisCard ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheCardComponentPathToUseForThisCard>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsTheCardComponentPathToUseForThisCard? result)
            {
                return JsonElementHelpers.TryParseValue<RepresentsTheCardComponentPathToUseForThisCard>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RepresentsTheCardComponentPathToUseForThisCard(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static RepresentsTheCardComponentPathToUseForThisCard IJsonElement<RepresentsTheCardComponentPathToUseForThisCard>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RepresentsTheCardComponentPathToUseForThisCard: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RepresentsTheCardComponentPathToUseForThisCard"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RepresentsTheCardComponentPathToUseForThisCard"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public RepresentsTheCardComponentPathToUseForThisCard Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RepresentsTheCardComponentPathToUseForThisCard>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RepresentsTheCardComponentPathToUseForThisCard"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public RepresentsTheCardComponentPathToUseForThisCard Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RepresentsTheCardComponentPathToUseForThisCard>(_idx);
                }
