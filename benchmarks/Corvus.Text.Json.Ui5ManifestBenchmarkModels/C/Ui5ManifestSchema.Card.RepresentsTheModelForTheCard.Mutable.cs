    ...
    public readonly partial struct Card
    {
        ...
        public readonly partial struct RepresentsTheModelForTheCard
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RepresentsTheModelForTheCard instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsTheModelForTheCard"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsTheModelForTheCard(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsTheModelForTheCard.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheModelForTheCard Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheModelForTheCard Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsTheModelForTheCard>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsTheModelForTheCard instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RepresentsTheModelForTheCard, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RepresentsTheModelForTheCard> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RepresentsTheModelForTheCard>();
                }
                finally
                {
