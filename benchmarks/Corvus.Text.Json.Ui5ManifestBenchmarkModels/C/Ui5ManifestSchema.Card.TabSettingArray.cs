...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct Card
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="TabSettingArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal TabSettingArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static TabSettingArray DefaultInstance { get; }
            ...
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.TabSetting this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.TabSetting>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.TabSetting> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.TabSetting>(_parent, _idx);
            }
            ...
            /// </returns>
            public static bool operator ==(in TabSettingArray left, in TabSettingArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in TabSettingArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(TabSettingArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TabSettingArray(JsonElement instance)
            {
                return TabSettingArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TabSettingArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TabSettingArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TabSettingArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TabSettingArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TabSettingArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TabSettingArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TabSettingArray>(json, options);
            }
            ...
            /// </exception>
            public static TabSettingArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<TabSettingArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out TabSettingArray? result)
            {
                return JsonElementHelpers.TryParseValue<TabSettingArray>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new TabSettingArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static TabSettingArray IJsonElement<TabSettingArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TabSettingArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="TabSettingArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="TabSettingArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public TabSettingArray Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<TabSettingArray>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="TabSettingArray"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public TabSettingArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<TabSettingArray>(_idx);
                }
