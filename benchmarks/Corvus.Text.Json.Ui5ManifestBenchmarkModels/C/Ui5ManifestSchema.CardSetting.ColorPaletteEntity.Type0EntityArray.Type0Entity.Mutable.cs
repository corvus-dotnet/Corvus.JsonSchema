            ...
            public readonly partial struct Type0EntityArray
            {
                ...
                public readonly partial struct Type0Entity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(Type0Entity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="Type0Entity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator Type0Entity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"Type0Entity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly Type0Entity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly Type0Entity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<Type0Entity>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.CardSetting.ColorPaletteEntity.Type0EntityArray.Type0Entity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                        public static implicit operator Source(Type0Entity instance) => new(JsonElement.From(instance));
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.CardSetting.ColorPaletteEntity.Type0EntityArray.Type0Entity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    {
                        return workspace.CreateBuilder<Type0Entity, Mutable>(this);
                    }
                }
            }
        }
