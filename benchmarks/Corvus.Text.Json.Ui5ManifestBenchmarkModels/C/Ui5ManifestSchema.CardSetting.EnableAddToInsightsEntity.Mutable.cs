    ...
    public readonly partial struct CardSetting
    {
        ...
        public readonly partial struct EnableAddToInsightsEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<EnableAddToInsightsEntity, Mutable>(EnableAddToInsightsEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(EnableAddToInsightsEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="EnableAddToInsightsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator EnableAddToInsightsEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"EnableAddToInsightsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly EnableAddToInsightsEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly EnableAddToInsightsEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<EnableAddToInsightsEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(EnableAddToInsightsEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<EnableAddToInsightsEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<EnableAddToInsightsEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<EnableAddToInsightsEntity>();
                }
                finally
                {
