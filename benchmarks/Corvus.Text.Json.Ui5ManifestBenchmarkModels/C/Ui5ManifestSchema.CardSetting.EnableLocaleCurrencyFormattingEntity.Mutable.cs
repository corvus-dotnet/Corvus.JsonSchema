    ...
    public readonly partial struct CardSetting
    {
        ...
        public readonly partial struct EnableLocaleCurrencyFormattingEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<EnableLocaleCurrencyFormattingEntity, Mutable>(EnableLocaleCurrencyFormattingEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(EnableLocaleCurrencyFormattingEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="EnableLocaleCurrencyFormattingEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator EnableLocaleCurrencyFormattingEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"EnableLocaleCurrencyFormattingEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly EnableLocaleCurrencyFormattingEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly EnableLocaleCurrencyFormattingEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<EnableLocaleCurrencyFormattingEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(EnableLocaleCurrencyFormattingEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<EnableLocaleCurrencyFormattingEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<EnableLocaleCurrencyFormattingEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<EnableLocaleCurrencyFormattingEntity>();
                }
                finally
                {
