...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct CardSetting
    {
        ...
        public readonly partial struct EnableLocaleCurrencyFormattingEntity
#if NET8_0_OR_GREATER
            : IJsonElement<EnableLocaleCurrencyFormattingEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="EnableLocaleCurrencyFormattingEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal EnableLocaleCurrencyFormattingEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static EnableLocaleCurrencyFormattingEntity DefaultInstance { get; } = ParsedJsonDocument<EnableLocaleCurrencyFormattingEntity>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(EnableLocaleCurrencyFormattingEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in EnableLocaleCurrencyFormattingEntity left, in EnableLocaleCurrencyFormattingEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in EnableLocaleCurrencyFormattingEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(EnableLocaleCurrencyFormattingEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EnableLocaleCurrencyFormattingEntity(JsonElement instance)
            {
                return EnableLocaleCurrencyFormattingEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EnableLocaleCurrencyFormattingEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EnableLocaleCurrencyFormattingEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EnableLocaleCurrencyFormattingEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EnableLocaleCurrencyFormattingEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EnableLocaleCurrencyFormattingEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EnableLocaleCurrencyFormattingEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EnableLocaleCurrencyFormattingEntity>(json, options);
            }
            ...
            /// </exception>
            public static EnableLocaleCurrencyFormattingEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<EnableLocaleCurrencyFormattingEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out EnableLocaleCurrencyFormattingEntity? result)
            {
                return JsonElementHelpers.TryParseValue<EnableLocaleCurrencyFormattingEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new EnableLocaleCurrencyFormattingEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static EnableLocaleCurrencyFormattingEntity IJsonElement<EnableLocaleCurrencyFormattingEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EnableLocaleCurrencyFormattingEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="EnableLocaleCurrencyFormattingEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="EnableLocaleCurrencyFormattingEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public EnableLocaleCurrencyFormattingEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<EnableLocaleCurrencyFormattingEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="EnableLocaleCurrencyFormattingEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public EnableLocaleCurrencyFormattingEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<EnableLocaleCurrencyFormattingEntity>(_idx);
                }
