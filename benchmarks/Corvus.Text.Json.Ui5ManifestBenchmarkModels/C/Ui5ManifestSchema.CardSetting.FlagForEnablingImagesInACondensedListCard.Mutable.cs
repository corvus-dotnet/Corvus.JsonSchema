    ...
    public readonly partial struct CardSetting
    {
        ...
        public readonly partial struct FlagForEnablingImagesInACondensedListCard
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<FlagForEnablingImagesInACondensedListCard, Mutable>(FlagForEnablingImagesInACondensedListCard.DefaultInstance);
                ...
                public static explicit operator Mutable(FlagForEnablingImagesInACondensedListCard instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="FlagForEnablingImagesInACondensedListCard"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator FlagForEnablingImagesInACondensedListCard(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"FlagForEnablingImagesInACondensedListCard.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly FlagForEnablingImagesInACondensedListCard Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly FlagForEnablingImagesInACondensedListCard Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<FlagForEnablingImagesInACondensedListCard>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(FlagForEnablingImagesInACondensedListCard instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<FlagForEnablingImagesInACondensedListCard, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<FlagForEnablingImagesInACondensedListCard> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<FlagForEnablingImagesInACondensedListCard>();
                }
                finally
                {
