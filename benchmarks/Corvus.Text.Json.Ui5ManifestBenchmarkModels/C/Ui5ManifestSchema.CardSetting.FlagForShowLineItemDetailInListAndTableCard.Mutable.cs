    ...
    public readonly partial struct CardSetting
    {
        ...
        public readonly partial struct FlagForShowLineItemDetailInListAndTableCard
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<FlagForShowLineItemDetailInListAndTableCard, Mutable>(FlagForShowLineItemDetailInListAndTableCard.DefaultInstance);
                ...
                public static explicit operator Mutable(FlagForShowLineItemDetailInListAndTableCard instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="FlagForShowLineItemDetailInListAndTableCard"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator FlagForShowLineItemDetailInListAndTableCard(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"FlagForShowLineItemDetailInListAndTableCard.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly FlagForShowLineItemDetailInListAndTableCard Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly FlagForShowLineItemDetailInListAndTableCard Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<FlagForShowLineItemDetailInListAndTableCard>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(FlagForShowLineItemDetailInListAndTableCard instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<FlagForShowLineItemDetailInListAndTableCard, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<FlagForShowLineItemDetailInListAndTableCard> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<FlagForShowLineItemDetailInListAndTableCard>();
                }
                finally
                {
