...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct CardSetting
    {
        ...
        public readonly partial struct FlagForShowLineItemDetailInListAndTableCard
#if NET8_0_OR_GREATER
            : IJsonElement<FlagForShowLineItemDetailInListAndTableCard>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="FlagForShowLineItemDetailInListAndTableCard"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal FlagForShowLineItemDetailInListAndTableCard(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static FlagForShowLineItemDetailInListAndTableCard DefaultInstance { get; } = ParsedJsonDocument<FlagForShowLineItemDetailInListAndTableCard>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(FlagForShowLineItemDetailInListAndTableCard value)
            {
            ...
            /// </returns>
            public static bool operator ==(in FlagForShowLineItemDetailInListAndTableCard left, in FlagForShowLineItemDetailInListAndTableCard right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in FlagForShowLineItemDetailInListAndTableCard left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(FlagForShowLineItemDetailInListAndTableCard instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator FlagForShowLineItemDetailInListAndTableCard(JsonElement instance)
            {
                return FlagForShowLineItemDetailInListAndTableCard.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static FlagForShowLineItemDetailInListAndTableCard From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static FlagForShowLineItemDetailInListAndTableCard ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<FlagForShowLineItemDetailInListAndTableCard>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static FlagForShowLineItemDetailInListAndTableCard ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<FlagForShowLineItemDetailInListAndTableCard>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static FlagForShowLineItemDetailInListAndTableCard ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<FlagForShowLineItemDetailInListAndTableCard>(json, options);
            }
            ...
            /// </exception>
            public static FlagForShowLineItemDetailInListAndTableCard ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<FlagForShowLineItemDetailInListAndTableCard>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out FlagForShowLineItemDetailInListAndTableCard? result)
            {
                return JsonElementHelpers.TryParseValue<FlagForShowLineItemDetailInListAndTableCard>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new FlagForShowLineItemDetailInListAndTableCard(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static FlagForShowLineItemDetailInListAndTableCard IJsonElement<FlagForShowLineItemDetailInListAndTableCard>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"FlagForShowLineItemDetailInListAndTableCard: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="FlagForShowLineItemDetailInListAndTableCard"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="FlagForShowLineItemDetailInListAndTableCard"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public FlagForShowLineItemDetailInListAndTableCard Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<FlagForShowLineItemDetailInListAndTableCard>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="FlagForShowLineItemDetailInListAndTableCard"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public FlagForShowLineItemDetailInListAndTableCard Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<FlagForShowLineItemDetailInListAndTableCard>(_idx);
                }
