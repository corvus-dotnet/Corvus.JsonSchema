    ...
    public readonly partial struct CardSetting
    {
        ...
        public readonly partial struct IgnoreSapTextEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<IgnoreSapTextEntity, Mutable>(IgnoreSapTextEntity.DefaultInstance);
            ...
            public static ParsedJsonDocument<IgnoreSapTextEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<IgnoreSapTextEntity>();
                }
                finally
                {
