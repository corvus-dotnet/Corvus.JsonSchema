    ...
    public readonly partial struct CardSetting
    {
        ...
        public readonly partial struct ListTypeEntity
        {
            ...
            public ref struct Source
            {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (ListTypeEntity)value;
            ...
            public static ParsedJsonDocument<ListTypeEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ListTypeEntity>();
                }
                finally
                {
