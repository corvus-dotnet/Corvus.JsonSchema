    ...
    public readonly partial struct CardSetting
    {
        ...
        public readonly partial struct NavigationEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(NavigationEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="NavigationEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator NavigationEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"NavigationEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly NavigationEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly NavigationEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<NavigationEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(NavigationEntity instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (NavigationEntity)value;
            ...
            {
                return workspace.CreateBuilder<NavigationEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<NavigationEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<NavigationEntity>();
                }
                finally
                {
