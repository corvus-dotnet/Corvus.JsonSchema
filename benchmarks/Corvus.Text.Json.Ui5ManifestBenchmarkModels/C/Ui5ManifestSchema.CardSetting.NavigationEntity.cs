...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct CardSetting
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="NavigationEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal NavigationEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static NavigationEntity DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(NavigationEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in NavigationEntity left, in NavigationEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in NavigationEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(NavigationEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator NavigationEntity(JsonElement instance)
            {
                return NavigationEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NavigationEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NavigationEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<NavigationEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NavigationEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<NavigationEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NavigationEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<NavigationEntity>(json, options);
            }
            ...
            /// </exception>
            public static NavigationEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<NavigationEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out NavigationEntity? result)
            {
                return JsonElementHelpers.TryParseValue<NavigationEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new NavigationEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static NavigationEntity IJsonElement<NavigationEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"NavigationEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="NavigationEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="NavigationEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public NavigationEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<NavigationEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="NavigationEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public NavigationEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<NavigationEntity>(_idx);
                }
            ...
            /// <param name="matchDataPointNav">Match 1st item.</param>
            /// <param name="matchChartNav">Match 2nd item.</param>
            /// <param name="matchHeaderNav">Match 3rd item.</param>
            /// <param name="matchNoHeaderNav">Match 4th item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchDataPointNav,
                Func<TContext, TResult> matchChartNav,
                Func<TContext, TResult> matchHeaderNav,
                Func<TContext, TResult> matchNoHeaderNav,
...
#endif
            {
                ...
                {
                    return matchDataPointNav(context);
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchChartNav(context);
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchHeaderNav(context);
                }

                if (this.ValueEquals(Constants.Enum4))
                {
                    return matchNoHeaderNav(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchDataPointNav,
                Func<TResult> matchChartNav,
                Func<TResult> matchHeaderNav,
                Func<TResult> matchNoHeaderNav,
                Func<TResult> defaultMatch)
            {
                if (this.ValueEquals(Constants.Enum1))
                {
                    return matchDataPointNav();
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchChartNav();
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchHeaderNav();
                }

                if (this.ValueEquals(Constants.Enum4))
                {
                    return matchNoHeaderNav();
                }
