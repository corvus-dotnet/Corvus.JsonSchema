    ...
    public readonly partial struct CardSetting
    {
        ...
        public readonly partial struct RepresentsTheCategoryOfTheCardUsedInTheCardHeader
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RepresentsTheCategoryOfTheCardUsedInTheCardHeader instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsTheCategoryOfTheCardUsedInTheCardHeader"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsTheCategoryOfTheCardUsedInTheCardHeader(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsTheCategoryOfTheCardUsedInTheCardHeader.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheCategoryOfTheCardUsedInTheCardHeader Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheCategoryOfTheCardUsedInTheCardHeader Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsTheCategoryOfTheCardUsedInTheCardHeader>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsTheCategoryOfTheCardUsedInTheCardHeader instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RepresentsTheCategoryOfTheCardUsedInTheCardHeader, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RepresentsTheCategoryOfTheCardUsedInTheCardHeader> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RepresentsTheCategoryOfTheCardUsedInTheCardHeader>();
                }
                finally
                {
