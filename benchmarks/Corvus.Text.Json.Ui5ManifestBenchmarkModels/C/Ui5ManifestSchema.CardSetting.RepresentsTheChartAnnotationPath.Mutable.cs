    ...
    public readonly partial struct CardSetting
    {
        ...
        public readonly partial struct RepresentsTheChartAnnotationPath
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RepresentsTheChartAnnotationPath instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsTheChartAnnotationPath"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsTheChartAnnotationPath(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsTheChartAnnotationPath.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheChartAnnotationPath Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheChartAnnotationPath Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsTheChartAnnotationPath>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsTheChartAnnotationPath instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RepresentsTheChartAnnotationPath, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RepresentsTheChartAnnotationPath> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RepresentsTheChartAnnotationPath>();
                }
                finally
                {
