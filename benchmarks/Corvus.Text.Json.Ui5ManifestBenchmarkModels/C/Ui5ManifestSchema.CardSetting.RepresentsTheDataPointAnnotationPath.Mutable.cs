    ...
    public readonly partial struct CardSetting
    {
        ...
        public readonly partial struct RepresentsTheDataPointAnnotationPath
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RepresentsTheDataPointAnnotationPath instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsTheDataPointAnnotationPath"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsTheDataPointAnnotationPath(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsTheDataPointAnnotationPath.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheDataPointAnnotationPath Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheDataPointAnnotationPath Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsTheDataPointAnnotationPath>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsTheDataPointAnnotationPath instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RepresentsTheDataPointAnnotationPath, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RepresentsTheDataPointAnnotationPath> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RepresentsTheDataPointAnnotationPath>();
                }
                finally
                {
