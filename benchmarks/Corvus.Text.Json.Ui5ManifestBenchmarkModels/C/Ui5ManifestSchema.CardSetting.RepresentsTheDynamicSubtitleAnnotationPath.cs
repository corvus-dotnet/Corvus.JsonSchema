...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct CardSetting
    {
        ...
        public readonly partial struct RepresentsTheDynamicSubtitleAnnotationPath
#if NET8_0_OR_GREATER
            : IJsonElement<RepresentsTheDynamicSubtitleAnnotationPath>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RepresentsTheDynamicSubtitleAnnotationPath"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RepresentsTheDynamicSubtitleAnnotationPath(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RepresentsTheDynamicSubtitleAnnotationPath DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(RepresentsTheDynamicSubtitleAnnotationPath value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in RepresentsTheDynamicSubtitleAnnotationPath left, in RepresentsTheDynamicSubtitleAnnotationPath right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RepresentsTheDynamicSubtitleAnnotationPath left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(RepresentsTheDynamicSubtitleAnnotationPath instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RepresentsTheDynamicSubtitleAnnotationPath(JsonElement instance)
            {
                return RepresentsTheDynamicSubtitleAnnotationPath.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheDynamicSubtitleAnnotationPath From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheDynamicSubtitleAnnotationPath ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheDynamicSubtitleAnnotationPath>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheDynamicSubtitleAnnotationPath ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheDynamicSubtitleAnnotationPath>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheDynamicSubtitleAnnotationPath ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheDynamicSubtitleAnnotationPath>(json, options);
            }
            ...
            /// </exception>
            public static RepresentsTheDynamicSubtitleAnnotationPath ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheDynamicSubtitleAnnotationPath>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsTheDynamicSubtitleAnnotationPath? result)
            {
                return JsonElementHelpers.TryParseValue<RepresentsTheDynamicSubtitleAnnotationPath>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RepresentsTheDynamicSubtitleAnnotationPath(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static RepresentsTheDynamicSubtitleAnnotationPath IJsonElement<RepresentsTheDynamicSubtitleAnnotationPath>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RepresentsTheDynamicSubtitleAnnotationPath: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RepresentsTheDynamicSubtitleAnnotationPath"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RepresentsTheDynamicSubtitleAnnotationPath"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public RepresentsTheDynamicSubtitleAnnotationPath Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RepresentsTheDynamicSubtitleAnnotationPath>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RepresentsTheDynamicSubtitleAnnotationPath"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public RepresentsTheDynamicSubtitleAnnotationPath Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RepresentsTheDynamicSubtitleAnnotationPath>(_idx);
                }
