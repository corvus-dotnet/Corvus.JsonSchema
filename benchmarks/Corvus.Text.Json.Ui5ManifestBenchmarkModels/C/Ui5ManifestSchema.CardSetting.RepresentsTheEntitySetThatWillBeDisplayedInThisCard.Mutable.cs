...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct CardSetting
    {
        ...
        public readonly partial struct RepresentsTheEntitySetThatWillBeDisplayedInThisCard
        {
            ...
            public static ParsedJsonDocument<RepresentsTheEntitySetThatWillBeDisplayedInThisCard> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RepresentsTheEntitySetThatWillBeDisplayedInThisCard>();
                }
                finally
                {
