...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct CardSetting
    {
        ...
        public readonly partial struct RepresentsTheEntitySetThatWillBeDisplayedInThisCard
#if NET8_0_OR_GREATER
            : IJsonElement<RepresentsTheEntitySetThatWillBeDisplayedInThisCard>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RepresentsTheEntitySetThatWillBeDisplayedInThisCard"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RepresentsTheEntitySetThatWillBeDisplayedInThisCard(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RepresentsTheEntitySetThatWillBeDisplayedInThisCard DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(RepresentsTheEntitySetThatWillBeDisplayedInThisCard value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in RepresentsTheEntitySetThatWillBeDisplayedInThisCard left, in RepresentsTheEntitySetThatWillBeDisplayedInThisCard right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RepresentsTheEntitySetThatWillBeDisplayedInThisCard left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(RepresentsTheEntitySetThatWillBeDisplayedInThisCard instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RepresentsTheEntitySetThatWillBeDisplayedInThisCard(JsonElement instance)
            {
                return RepresentsTheEntitySetThatWillBeDisplayedInThisCard.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheEntitySetThatWillBeDisplayedInThisCard From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheEntitySetThatWillBeDisplayedInThisCard ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheEntitySetThatWillBeDisplayedInThisCard>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheEntitySetThatWillBeDisplayedInThisCard ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheEntitySetThatWillBeDisplayedInThisCard>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheEntitySetThatWillBeDisplayedInThisCard ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheEntitySetThatWillBeDisplayedInThisCard>(json, options);
            }
            ...
            /// </exception>
            public static RepresentsTheEntitySetThatWillBeDisplayedInThisCard ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheEntitySetThatWillBeDisplayedInThisCard>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsTheEntitySetThatWillBeDisplayedInThisCard? result)
            {
                return JsonElementHelpers.TryParseValue<RepresentsTheEntitySetThatWillBeDisplayedInThisCard>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RepresentsTheEntitySetThatWillBeDisplayedInThisCard(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static RepresentsTheEntitySetThatWillBeDisplayedInThisCard IJsonElement<RepresentsTheEntitySetThatWillBeDisplayedInThisCard>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RepresentsTheEntitySetThatWillBeDisplayedInThisCard: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RepresentsTheEntitySetThatWillBeDisplayedInThisCard"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RepresentsTheEntitySetThatWillBeDisplayedInThisCard"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public RepresentsTheEntitySetThatWillBeDisplayedInThisCard Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RepresentsTheEntitySetThatWillBeDisplayedInThisCard>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RepresentsTheEntitySetThatWillBeDisplayedInThisCard"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public RepresentsTheEntitySetThatWillBeDisplayedInThisCard Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RepresentsTheEntitySetThatWillBeDisplayedInThisCard>(_idx);
                }
