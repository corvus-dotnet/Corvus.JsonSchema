    ...
    public readonly partial struct CardSetting
    {
        ...
        public readonly partial struct RepresentsTheIdentificationAnnotationPath
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RepresentsTheIdentificationAnnotationPath instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsTheIdentificationAnnotationPath"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsTheIdentificationAnnotationPath(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsTheIdentificationAnnotationPath.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheIdentificationAnnotationPath Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheIdentificationAnnotationPath Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsTheIdentificationAnnotationPath>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsTheIdentificationAnnotationPath instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RepresentsTheIdentificationAnnotationPath, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RepresentsTheIdentificationAnnotationPath> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RepresentsTheIdentificationAnnotationPath>();
                }
                finally
                {
