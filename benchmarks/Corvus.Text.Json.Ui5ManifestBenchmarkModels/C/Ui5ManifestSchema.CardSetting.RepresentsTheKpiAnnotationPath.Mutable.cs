...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct CardSetting
    {
        ...
        public readonly partial struct RepresentsTheKpiAnnotationPath
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RepresentsTheKpiAnnotationPath instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsTheKpiAnnotationPath"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsTheKpiAnnotationPath(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new RepresentsTheKpiAnnotationPath(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsTheKpiAnnotationPath.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="RepresentsTheKpiAnnotationPath"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="RepresentsTheKpiAnnotationPath"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheKpiAnnotationPath Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<RepresentsTheKpiAnnotationPath>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="RepresentsTheKpiAnnotationPath"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheKpiAnnotationPath Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsTheKpiAnnotationPath>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsTheKpiAnnotationPath instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RepresentsTheKpiAnnotationPath, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RepresentsTheKpiAnnotationPath> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RepresentsTheKpiAnnotationPath>();
                }
                finally
                {
