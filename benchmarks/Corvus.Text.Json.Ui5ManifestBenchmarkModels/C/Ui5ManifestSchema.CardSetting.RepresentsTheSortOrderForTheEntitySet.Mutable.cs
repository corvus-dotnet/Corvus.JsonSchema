    ...
    public readonly partial struct CardSetting
    {
        ...
        public readonly partial struct RepresentsTheSortOrderForTheEntitySet
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RepresentsTheSortOrderForTheEntitySet instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsTheSortOrderForTheEntitySet"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsTheSortOrderForTheEntitySet(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new RepresentsTheSortOrderForTheEntitySet(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsTheSortOrderForTheEntitySet.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="RepresentsTheSortOrderForTheEntitySet"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="RepresentsTheSortOrderForTheEntitySet"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheSortOrderForTheEntitySet Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<RepresentsTheSortOrderForTheEntitySet>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="RepresentsTheSortOrderForTheEntitySet"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheSortOrderForTheEntitySet Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsTheSortOrderForTheEntitySet>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsTheSortOrderForTheEntitySet instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (RepresentsTheSortOrderForTheEntitySet)value;
            ...
            {
                return workspace.CreateBuilder<RepresentsTheSortOrderForTheEntitySet, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RepresentsTheSortOrderForTheEntitySet> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RepresentsTheSortOrderForTheEntitySet>();
                }
                finally
                {
