...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct CardSetting
    {
        ...
        public readonly partial struct RepresentsThingsLikePeopleNumberOfItems
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RepresentsThingsLikePeopleNumberOfItems instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsThingsLikePeopleNumberOfItems"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsThingsLikePeopleNumberOfItems(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new RepresentsThingsLikePeopleNumberOfItems(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsThingsLikePeopleNumberOfItems.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="RepresentsThingsLikePeopleNumberOfItems"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="RepresentsThingsLikePeopleNumberOfItems"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsThingsLikePeopleNumberOfItems Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<RepresentsThingsLikePeopleNumberOfItems>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="RepresentsThingsLikePeopleNumberOfItems"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsThingsLikePeopleNumberOfItems Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsThingsLikePeopleNumberOfItems>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsThingsLikePeopleNumberOfItems instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RepresentsThingsLikePeopleNumberOfItems, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RepresentsThingsLikePeopleNumberOfItems> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RepresentsThingsLikePeopleNumberOfItems>();
                }
                finally
                {
