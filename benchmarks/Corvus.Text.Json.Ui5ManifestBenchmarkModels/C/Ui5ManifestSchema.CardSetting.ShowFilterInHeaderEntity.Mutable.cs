    ...
    public readonly partial struct CardSetting
    {
        ...
        public readonly partial struct ShowFilterInHeaderEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ShowFilterInHeaderEntity, Mutable>(ShowFilterInHeaderEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(ShowFilterInHeaderEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ShowFilterInHeaderEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ShowFilterInHeaderEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ShowFilterInHeaderEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ShowFilterInHeaderEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ShowFilterInHeaderEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ShowFilterInHeaderEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ShowFilterInHeaderEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ShowFilterInHeaderEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ShowFilterInHeaderEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ShowFilterInHeaderEntity>();
                }
                finally
                {
