    ...
    public readonly partial struct CardSetting
    {
        ...
        public readonly partial struct ShowLabelTextEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ShowLabelTextEntity, Mutable>(ShowLabelTextEntity.DefaultInstance);
            ...
            public static ParsedJsonDocument<ShowLabelTextEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ShowLabelTextEntity>();
                }
                finally
                {
