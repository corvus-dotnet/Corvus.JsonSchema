...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct CardSetting
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ShowLabelTextEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ShowLabelTextEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ShowLabelTextEntity DefaultInstance { get; } = ParsedJsonDocument<ShowLabelTextEntity>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(ShowLabelTextEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in ShowLabelTextEntity left, in ShowLabelTextEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ShowLabelTextEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ShowLabelTextEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ShowLabelTextEntity(JsonElement instance)
            {
                return ShowLabelTextEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ShowLabelTextEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ShowLabelTextEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ShowLabelTextEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ShowLabelTextEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ShowLabelTextEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ShowLabelTextEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ShowLabelTextEntity>(json, options);
            }
            ...
            /// </exception>
            public static ShowLabelTextEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ShowLabelTextEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ShowLabelTextEntity? result)
            {
                return JsonElementHelpers.TryParseValue<ShowLabelTextEntity>(ref reader, out result);
            }
...
#if NET
            static ShowLabelTextEntity IJsonElement<ShowLabelTextEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ShowLabelTextEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public ShowLabelTextEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public ShowLabelTextEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ShowLabelTextEntity>(_idx);
                }
