    ...
    public readonly partial struct CardSetting
    {
        ...
        public readonly partial struct ShowRefreshEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ShowRefreshEntity, Mutable>(ShowRefreshEntity.DefaultInstance);
            ...
            public static ParsedJsonDocument<ShowRefreshEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ShowRefreshEntity>();
                }
                finally
                {
