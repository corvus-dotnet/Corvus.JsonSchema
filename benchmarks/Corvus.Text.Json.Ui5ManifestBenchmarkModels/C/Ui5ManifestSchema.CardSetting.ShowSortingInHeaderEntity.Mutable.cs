    ...
    public readonly partial struct CardSetting
    {
        ...
        public readonly partial struct ShowSortingInHeaderEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ShowSortingInHeaderEntity, Mutable>(ShowSortingInHeaderEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(ShowSortingInHeaderEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ShowSortingInHeaderEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ShowSortingInHeaderEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ShowSortingInHeaderEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ShowSortingInHeaderEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ShowSortingInHeaderEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ShowSortingInHeaderEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ShowSortingInHeaderEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ShowSortingInHeaderEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ShowSortingInHeaderEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ShowSortingInHeaderEntity>();
                }
                finally
                {
