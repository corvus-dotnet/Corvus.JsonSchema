    ...
    public readonly partial struct CardSetting
    {
        ...
        public readonly partial struct TitleEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(TitleEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TitleEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TitleEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new TitleEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TitleEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="TitleEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="TitleEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly TitleEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<TitleEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="TitleEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly TitleEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TitleEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(TitleEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<TitleEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<TitleEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TitleEntity>();
                }
                finally
                {
