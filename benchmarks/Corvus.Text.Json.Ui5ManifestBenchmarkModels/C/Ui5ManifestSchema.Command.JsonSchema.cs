...
public readonly partial struct Ui5ManifestSchema
{
        ...
        : IJsonElement<Command>
    {
        public static partial class JsonSchema
        {
            ...
            private static void MatchShortcut(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
            {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/command"u8, buffer, out written);
