...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct Command
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Command instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Command"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Command(Mutable instance)
            {
            ...
            /// <summary>
            /// Gets the (optional) <c>shortcut</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Command.ShortcutEntity.Mutable Shortcut
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ShortcutUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Command.ShortcutEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Command(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetShortcut(scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Command.ShortcutEntity.Source value)
            {
                ...
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ShortcutUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ShortcutUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                ...
                else
                {
                    ...
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Shortcut, ref cvb);
            ...
            /// <summary>
            /// Remove the <c>shortcut</c> property, if present.
            /// </summary>
            ...
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ShortcutUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Command.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Command"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Command"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly Command Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<Command>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Command"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly Command Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Command>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Command.ShortcutEntity.Source _createArg1;
            ...
            public static implicit operator Source(Command instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Command.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="Command"/>.
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Command.ShortcutEntity.Source shortcut = default)
            {
                shortcut.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Shortcut, ref builder);
            }

            /// <summary>
            /// Creates an instance of a <see cref="Command"/>.
            /// </summary>
            public void Create(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Command.ShortcutEntity.Source shortcut = default)
            {
                Create(ref _builder, shortcut);
            }
        ...
        /// </summary>
        /// <param name="workspace">The JSON workspace.</param>
        /// <param name="shortcut">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Command.ShortcutEntity.Source shortcut = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        {
            return workspace.CreateBuilder<Command, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<Command> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Command>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Command> Create<TContext>(
        ...
        public static ParsedJsonDocument<Command> Create(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Command.ShortcutEntity.Source shortcut = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
