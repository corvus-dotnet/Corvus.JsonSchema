...
public readonly partial struct Ui5ManifestSchema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Command.ShortcutEntity Shortcut
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ShortcutUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Command.ShortcutEntity value))
                {
                    return value;
                }
        ...
        {
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="Shortcut"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Shortcut => [0xA5, 0x00, 0x00, 0x00, 0x22, 0x73, 0x68, 0x6F, 0x72, 0x74, 0x63, 0x75, 0x74, 0x22];
        }
    }
}
