    ...
    public readonly partial struct Component
    {
        ...
        public readonly partial struct RepresentsIndicatorToLazyLoadingComponent
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<RepresentsIndicatorToLazyLoadingComponent, Mutable>(RepresentsIndicatorToLazyLoadingComponent.DefaultInstance);
            ...
            public static ParsedJsonDocument<RepresentsIndicatorToLazyLoadingComponent> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RepresentsIndicatorToLazyLoadingComponent>();
                }
                finally
                {
