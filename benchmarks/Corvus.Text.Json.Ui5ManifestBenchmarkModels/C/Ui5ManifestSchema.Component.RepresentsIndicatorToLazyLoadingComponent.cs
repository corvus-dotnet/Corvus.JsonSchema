...
public readonly partial struct Ui5ManifestSchema
{
    ...
    /// </para>
    /// </remarks>
    public readonly partial struct Component
    {
        /// <summary>
        /// Generated from JSON Schema.
        /// </summary>
        ...
        public readonly partial struct RepresentsIndicatorToLazyLoadingComponent
#if NET8_0_OR_GREATER
            : IJsonElement<RepresentsIndicatorToLazyLoadingComponent>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RepresentsIndicatorToLazyLoadingComponent"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RepresentsIndicatorToLazyLoadingComponent(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RepresentsIndicatorToLazyLoadingComponent DefaultInstance { get; } = ParsedJsonDocument<RepresentsIndicatorToLazyLoadingComponent>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(RepresentsIndicatorToLazyLoadingComponent value)
            {
            ...
            /// </returns>
            public static bool operator ==(in RepresentsIndicatorToLazyLoadingComponent left, in RepresentsIndicatorToLazyLoadingComponent right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RepresentsIndicatorToLazyLoadingComponent left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(RepresentsIndicatorToLazyLoadingComponent instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RepresentsIndicatorToLazyLoadingComponent(JsonElement instance)
            {
                return RepresentsIndicatorToLazyLoadingComponent.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsIndicatorToLazyLoadingComponent From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsIndicatorToLazyLoadingComponent ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsIndicatorToLazyLoadingComponent>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsIndicatorToLazyLoadingComponent ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsIndicatorToLazyLoadingComponent>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsIndicatorToLazyLoadingComponent ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsIndicatorToLazyLoadingComponent>(json, options);
            }
            ...
            /// </exception>
            public static RepresentsIndicatorToLazyLoadingComponent ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RepresentsIndicatorToLazyLoadingComponent>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsIndicatorToLazyLoadingComponent? result)
            {
                return JsonElementHelpers.TryParseValue<RepresentsIndicatorToLazyLoadingComponent>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RepresentsIndicatorToLazyLoadingComponent(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static RepresentsIndicatorToLazyLoadingComponent IJsonElement<RepresentsIndicatorToLazyLoadingComponent>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RepresentsIndicatorToLazyLoadingComponent: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RepresentsIndicatorToLazyLoadingComponent"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RepresentsIndicatorToLazyLoadingComponent"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public RepresentsIndicatorToLazyLoadingComponent Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RepresentsIndicatorToLazyLoadingComponent>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RepresentsIndicatorToLazyLoadingComponent"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public RepresentsIndicatorToLazyLoadingComponent Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RepresentsIndicatorToLazyLoadingComponent>(_idx);
                }
