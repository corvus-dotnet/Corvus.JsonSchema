...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct ComponentDef
    {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ComponentDef.TheNameOfTheComponent.Source name, in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source list = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ComponentSettingDef.Source settings = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ComponentDef.TheNameOfTheComponent.Source name, in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source list = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ComponentSettingDef.Source<TContext> settings = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
