    ...
    public readonly partial struct ComponentDef
    {
        ...
        public readonly partial struct TheNameOfTheComponent
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(TheNameOfTheComponent instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TheNameOfTheComponent"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TheNameOfTheComponent(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TheNameOfTheComponent.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly TheNameOfTheComponent Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly TheNameOfTheComponent Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TheNameOfTheComponent>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(TheNameOfTheComponent instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<TheNameOfTheComponent, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<TheNameOfTheComponent> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TheNameOfTheComponent>();
                }
                finally
                {
