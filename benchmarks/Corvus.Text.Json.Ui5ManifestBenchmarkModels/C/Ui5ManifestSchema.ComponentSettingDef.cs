...
public readonly partial struct Ui5ManifestSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ComponentSettingDef"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ComponentSettingDef(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ComponentSettingDef DefaultInstance { get; }
        ...
        /// </returns>
        public static bool operator ==(in ComponentSettingDef left, in ComponentSettingDef right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ComponentSettingDef left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(ComponentSettingDef instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ComponentSettingDef(JsonElement instance)
        {
            return ComponentSettingDef.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ComponentSettingDef From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ComponentSettingDef ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ComponentSettingDef>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ComponentSettingDef ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ComponentSettingDef>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ComponentSettingDef ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ComponentSettingDef>(json, options);
        }
        ...
        /// </exception>
        public static ComponentSettingDef ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ComponentSettingDef>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ComponentSettingDef? result)
        {
            return JsonElementHelpers.TryParseValue<ComponentSettingDef>(ref reader, out result);
        }
...
#if NET
        static ComponentSettingDef IJsonElement<ComponentSettingDef>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ComponentSettingDef: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public ComponentSettingDef Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public ComponentSettingDef Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ComponentSettingDef>(_idx);
            }
