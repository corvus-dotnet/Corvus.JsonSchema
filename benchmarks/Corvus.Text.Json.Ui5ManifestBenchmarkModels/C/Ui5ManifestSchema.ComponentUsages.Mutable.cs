...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct ComponentUsages
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ComponentUsages instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ComponentUsages"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ComponentUsages(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Config.Mutable ComponentData
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ComponentDataUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Config.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ComponentUsages.LazyEntity.Mutable Lazy
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LazyUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ComponentUsages.LazyEntity.Mutable value))
                    {
                        return value;
                    }

                    return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ComponentUsages.LazyEntity.Mutable.DefaultInstance;
                }
            }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ComponentUsages.RepresentsNameOfReuseComponent.Mutable Name
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ComponentUsages.RepresentsNameOfReuseComponent.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Config.Mutable Settings
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SettingsUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Config.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetComponentData(scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Config.Source value)
            {
                ...
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ComponentDataUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ComponentDataUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                ...
                else
                {
                    ...
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ComponentData, ref cvb);
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetComponentData<TContext>(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Config.Source<TContext> value)
            ...
            /// <summary>
            /// Remove the <c>componentData</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveComponentData()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ComponentDataUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetSettings<TContext>(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Config.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ComponentUsages.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ComponentUsages Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ComponentUsages Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ComponentUsages>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ComponentUsages.RepresentsNameOfReuseComponent.Source _createArg1;
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Config.Source _createArg2;
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ComponentUsages.LazyEntity.Source _createArg3;
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Config.Source _createArg4;
            ...
            public static implicit operator Source(ComponentUsages instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ComponentUsages.RepresentsNameOfReuseComponent.Source _createArg1;
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Config.Source<TContext> _createArg2;
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ComponentUsages.LazyEntity.Source _createArg3;
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Config.Source<TContext> _createArg4;
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="ComponentUsages"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ComponentUsages.RepresentsNameOfReuseComponent.Source name,
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Config.Source componentData = default,
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ComponentUsages.LazyEntity.Source lazy = default,
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Config.Source settings = default)
            {
                name.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Name, ref builder);
                componentData.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ComponentData, ref builder);
            ...
            public void Create(
                ...
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Config.Source settings = default)
            {
                Create(ref _builder, name, componentData, lazy, settings);
            }
            ...
            internal static void Create<TContext>(
                ...
                ref ComplexValueBuilder builder,
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ComponentUsages.RepresentsNameOfReuseComponent.Source name,
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Config.Source<TContext> componentData = default,
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ComponentUsages.LazyEntity.Source lazy = default,
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Config.Source<TContext> settings = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            #endif
            {
                Create(context, ref _builder, name, componentData, lazy, settings);
            }
        ...
        /// <param name="componentData">The value of the <c>"componentData"</c> property.</param>
        ...
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ComponentUsages.RepresentsNameOfReuseComponent.Source name, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Config.Source<TContext> componentData = default, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ComponentUsages.LazyEntity.Source lazy = default, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Config.Source<TContext> settings = default)
            ...
            #endif
        {
            return new Source<TContext>(context, name, componentData, lazy, settings);
        }
        ...
        /// <param name="componentData">The value of the property.</param>
        /// <param name="lazy">The value of the property.</param>
        /// <param name="settings">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ComponentUsages.RepresentsNameOfReuseComponent.Source name, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Config.Source componentData = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ComponentUsages.LazyEntity.Source lazy = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Config.Source settings = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(name, componentData, lazy, settings);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ComponentUsages.RepresentsNameOfReuseComponent.Source name, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Config.Source<TContext> componentData = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ComponentUsages.LazyEntity.Source lazy = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Config.Source<TContext> settings = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            ...
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(context, name, componentData, lazy, settings);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<ComponentUsages, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ComponentUsages> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ComponentUsages>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ComponentUsages> Create<TContext>(
        ...
        public static ParsedJsonDocument<ComponentUsages> Create(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ComponentUsages.RepresentsNameOfReuseComponent.Source name, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Config.Source componentData = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ComponentUsages.LazyEntity.Source lazy = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Config.Source settings = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ComponentUsages> Create<TContext>(in TContext context, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ComponentUsages.RepresentsNameOfReuseComponent.Source name, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Config.Source<TContext> componentData = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ComponentUsages.LazyEntity.Source lazy = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Config.Source<TContext> settings = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
