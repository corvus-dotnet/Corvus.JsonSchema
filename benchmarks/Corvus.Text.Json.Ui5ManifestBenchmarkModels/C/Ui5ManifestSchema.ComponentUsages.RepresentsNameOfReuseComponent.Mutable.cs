...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct ComponentUsages
    {
        ...
        public readonly partial struct RepresentsNameOfReuseComponent
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RepresentsNameOfReuseComponent instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsNameOfReuseComponent"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsNameOfReuseComponent(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new RepresentsNameOfReuseComponent(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsNameOfReuseComponent.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="RepresentsNameOfReuseComponent"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="RepresentsNameOfReuseComponent"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsNameOfReuseComponent Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<RepresentsNameOfReuseComponent>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="RepresentsNameOfReuseComponent"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsNameOfReuseComponent Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsNameOfReuseComponent>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsNameOfReuseComponent instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RepresentsNameOfReuseComponent, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RepresentsNameOfReuseComponent> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RepresentsNameOfReuseComponent>();
                }
                finally
                {
