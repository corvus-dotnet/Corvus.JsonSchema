...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct ComponentUsages
#if NET8_0_OR_GREATER
        : IJsonElement<ComponentUsages>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ComponentUsages"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ComponentUsages(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ComponentUsages DefaultInstance { get; }

        /// <summary>
        /// Gets the (optional) <c>componentData</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Config ComponentData
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ComponentDataUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Config value))
                {
                    return value;
                }
        ...
        /// <summary>
        /// Gets the (optional) <c>lazy</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ComponentUsages.LazyEntity Lazy
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LazyUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ComponentUsages.LazyEntity value))
                {
                    return value;
                }

                return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ComponentUsages.LazyEntity.DefaultInstance;
            }
        }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ComponentUsages.RepresentsNameOfReuseComponent Name
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ComponentUsages.RepresentsNameOfReuseComponent value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Config Settings
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SettingsUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Config value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in ComponentUsages left, in ComponentUsages right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ComponentUsages left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(ComponentUsages instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ComponentUsages(JsonElement instance)
        {
            return ComponentUsages.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ComponentUsages From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ComponentUsages ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ComponentUsages>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ComponentUsages ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ComponentUsages>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ComponentUsages ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ComponentUsages>(json, options);
        }
        ...
        /// </exception>
        public static ComponentUsages ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ComponentUsages>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ComponentUsages? result)
        {
            return JsonElementHelpers.TryParseValue<ComponentUsages>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ComponentUsages(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static ComponentUsages IJsonElement<ComponentUsages>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ComponentUsages: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ComponentUsages"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ComponentUsages"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public ComponentUsages Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ComponentUsages>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ComponentUsages"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public ComponentUsages Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ComponentUsages>(_idx);
            }
        ...
        {
            /// <summary>
            /// Gets the JSON property name for <see cref="ComponentData"/>.
            /// </summary>
            public const string ComponentData = "componentData";

            /// <summary>
            /// Gets the JSON property name for <see cref="Lazy"/>.
            /// </summary>
            ...
            /// Gets the JSON property name for <see cref="ComponentData"/>.
            /// </summary>
            public static ReadOnlySpan<byte> ComponentDataUtf8 => "componentData"u8;

            /// <summary>
            /// Gets the JSON property name for <see cref="Lazy"/>.
            /// </summary>
            public static ReadOnlySpan<byte> LazyUtf8 => "lazy"u8;
        ...
        {
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="ComponentData"/>.
            /// </summary>
            public static ReadOnlySpan<byte> ComponentData => "componentData"u8;

            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="Lazy"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Lazy => "lazy"u8;
        ...
        {
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="ComponentData"/>.
            /// </summary>
            public static ReadOnlySpan<byte> ComponentData => [0xF5, 0x00, 0x00, 0x00, 0x22, 0x63, 0x6F, 0x6D, 0x70, 0x6F, 0x6E, 0x65, 0x6E, 0x74, 0x44, 0x61, 0x74, 0x61, 0x22];

            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="Lazy"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Lazy => [0x65, 0x00, 0x00, 0x00, 0x22, 0x6C, 0x61, 0x7A, 0x79, 0x22];
