...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct Config
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ConfigArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ConfigArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ConfigArray DefaultInstance { get; }
            ...
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Config this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Config>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Config> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Config>(_parent, _idx);
            }
            ...
            /// </returns>
            public static bool operator ==(in ConfigArray left, in ConfigArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ConfigArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(ConfigArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ConfigArray(JsonElement instance)
            {
                return ConfigArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ConfigArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ConfigArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ConfigArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ConfigArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ConfigArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ConfigArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ConfigArray>(json, options);
            }
            ...
            /// </exception>
            public static ConfigArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ConfigArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ConfigArray? result)
            {
                return JsonElementHelpers.TryParseValue<ConfigArray>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ConfigArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static ConfigArray IJsonElement<ConfigArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ConfigArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ConfigArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ConfigArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            {
                CheckValidInstance();
                return _parent.CloneElement<ConfigArray>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ConfigArray"/> that lives for the lifetime of its
