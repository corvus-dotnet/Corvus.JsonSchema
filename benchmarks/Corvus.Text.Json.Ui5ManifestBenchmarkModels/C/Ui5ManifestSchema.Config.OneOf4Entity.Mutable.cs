    ...
    public readonly partial struct Config
    {
        ...
        public readonly partial struct OneOf4Entity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(OneOf4Entity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="OneOf4Entity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator OneOf4Entity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"OneOf4Entity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly OneOf4Entity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly OneOf4Entity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<OneOf4Entity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Config.OneOf4Entity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(OneOf4Entity instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Config.OneOf4Entity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<OneOf4Entity, Mutable>(this);
            }
        }
    }
}
