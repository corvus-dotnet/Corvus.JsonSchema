...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct Config
    {
...
#endif
        {
            ...
            internal OneOf4Entity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in OneOf4Entity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(OneOf4Entity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator OneOf4Entity(JsonElement instance)
            {
                return OneOf4Entity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OneOf4Entity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OneOf4Entity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OneOf4Entity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OneOf4Entity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OneOf4Entity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OneOf4Entity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OneOf4Entity>(json, options);
            }
            ...
            /// </exception>
            public static OneOf4Entity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<OneOf4Entity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out OneOf4Entity? result)
            {
                return JsonElementHelpers.TryParseValue<OneOf4Entity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new OneOf4Entity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static OneOf4Entity IJsonElement<OneOf4Entity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"OneOf4Entity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="OneOf4Entity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="OneOf4Entity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public OneOf4Entity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<OneOf4Entity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="OneOf4Entity"/> that lives for the lifetime of its
