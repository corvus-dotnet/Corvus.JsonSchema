...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct ConfigurationBasicDataType
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ConfigurationBasicDataType instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ConfigurationBasicDataType"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ConfigurationBasicDataType(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ConfigurationBasicDataType.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ConfigurationBasicDataType Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ConfigurationBasicDataType Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ConfigurationBasicDataType>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ConfigurationBasicDataType instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (ConfigurationBasicDataType)value;
        ...
        {
            return workspace.CreateBuilder<ConfigurationBasicDataType, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ConfigurationBasicDataType> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ConfigurationBasicDataType>();
            }
            finally
            {
