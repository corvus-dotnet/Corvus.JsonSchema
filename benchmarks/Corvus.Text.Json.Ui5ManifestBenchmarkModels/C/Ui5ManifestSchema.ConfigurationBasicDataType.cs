...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct ConfigurationBasicDataType
#if NET8_0_OR_GREATER
        : IJsonElement<ConfigurationBasicDataType>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfigurationBasicDataType"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ConfigurationBasicDataType(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ConfigurationBasicDataType DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(ConfigurationBasicDataType value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in ConfigurationBasicDataType left, in ConfigurationBasicDataType right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ConfigurationBasicDataType left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(ConfigurationBasicDataType instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ConfigurationBasicDataType(JsonElement instance)
        {
            return ConfigurationBasicDataType.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ConfigurationBasicDataType From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ConfigurationBasicDataType ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ConfigurationBasicDataType>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ConfigurationBasicDataType ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ConfigurationBasicDataType>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ConfigurationBasicDataType ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ConfigurationBasicDataType>(json, options);
        }
        ...
        /// </exception>
        public static ConfigurationBasicDataType ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ConfigurationBasicDataType>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ConfigurationBasicDataType? result)
        {
            return JsonElementHelpers.TryParseValue<ConfigurationBasicDataType>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ConfigurationBasicDataType(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static ConfigurationBasicDataType IJsonElement<ConfigurationBasicDataType>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ConfigurationBasicDataType: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ConfigurationBasicDataType"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ConfigurationBasicDataType"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public ConfigurationBasicDataType Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ConfigurationBasicDataType>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ConfigurationBasicDataType"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public ConfigurationBasicDataType Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ConfigurationBasicDataType>(_idx);
            }
        ...
        /// <param name="matchString">Match 1st item.</param>
        /// <param name="matchInteger">Match 2nd item.</param>
        /// <param name="matchNumber">Match 3rd item.</param>
        /// <param name="matchBoolean">Match 4th item.</param>
        /// <param name="matchDate">Match 5th item.</param>
        /// <param name="matchDatetime">Match 6th item.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Func<TContext, TResult> matchString,
            Func<TContext, TResult> matchInteger,
            Func<TContext, TResult> matchNumber,
            Func<TContext, TResult> matchBoolean,
        ...
        public TResult Match<TResult>(
            ...
            Func<TResult> matchInteger,
            Func<TResult> matchNumber,
            Func<TResult> matchBoolean,
