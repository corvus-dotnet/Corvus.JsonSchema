...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct ConfigurationDestinations
    {
...
#endif
        {
            ...
            public void SetDefaultUrl(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source value)
            {
                ...
                else
                {
                    ...
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.DefaultUrl, ref cvb);
            ...
            /// <summary>
            /// Gets a <see cref="ConfigurationDestinations"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ConfigurationDestinations"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly ConfigurationDestinations Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ConfigurationDestinations>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ConfigurationDestinations"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly ConfigurationDestinations Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ConfigurationDestinations>(_idx);
            }
        }
        ...
        public ref struct Builder
        {
            ...
            {
                defaultUrl.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.DefaultUrl, ref builder);
        ...
        /// </summary>
        /// <param name="defaultUrl">The value of the <c>"defaultUrl"</c> property.</param>
        ...
        public static ParsedJsonDocument<ConfigurationDestinations> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ConfigurationDestinations>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ConfigurationDestinations> Create<TContext>(
        ...
        public static ParsedJsonDocument<ConfigurationDestinations> Create(in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source defaultUrl = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source description = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source label = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source name = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
