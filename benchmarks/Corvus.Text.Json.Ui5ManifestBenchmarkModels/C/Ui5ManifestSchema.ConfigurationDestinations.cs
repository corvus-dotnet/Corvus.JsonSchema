...
public readonly partial struct Ui5ManifestSchema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.JsonString DefaultUrl
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DefaultUrlUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString value))
                {
                    return value;
                }
        ...
        {
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="DefaultUrl"/>.
            /// </summary>
            public static ReadOnlySpan<byte> DefaultUrl => [0xC5, 0x00, 0x00, 0x00, 0x22, 0x64, 0x65, 0x66, 0x61, 0x75, 0x6C, 0x74, 0x55, 0x72, 0x6C, 0x22];
