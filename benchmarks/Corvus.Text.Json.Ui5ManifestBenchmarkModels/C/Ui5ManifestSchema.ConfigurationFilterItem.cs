...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct ConfigurationFilterItem
        ...
        : IJsonElement<ConfigurationFilterItem>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfigurationFilterItem"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ConfigurationFilterItem(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ConfigurationFilterItem DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.JsonString Key
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.KeyUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in ConfigurationFilterItem left, in ConfigurationFilterItem right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ConfigurationFilterItem left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(ConfigurationFilterItem instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ConfigurationFilterItem(JsonElement instance)
        {
            return ConfigurationFilterItem.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ConfigurationFilterItem From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ConfigurationFilterItem ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ConfigurationFilterItem>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ConfigurationFilterItem ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ConfigurationFilterItem>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ConfigurationFilterItem ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ConfigurationFilterItem>(json, options);
        }
        ...
        /// </exception>
        public static ConfigurationFilterItem ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ConfigurationFilterItem>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ConfigurationFilterItem? result)
        {
            return JsonElementHelpers.TryParseValue<ConfigurationFilterItem>(ref reader, out result);
        }
...
#if NET
        static ConfigurationFilterItem IJsonElement<ConfigurationFilterItem>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ConfigurationFilterItem: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public ConfigurationFilterItem Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public ConfigurationFilterItem Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ConfigurationFilterItem>(_idx);
            }
