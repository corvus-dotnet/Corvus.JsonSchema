...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct ConfigurationFilterTypeDateRange
    {
        ...
        public readonly partial struct DeterminesWhetherTheFilterIsVisible
#if NET8_0_OR_GREATER
            : IJsonElement<DeterminesWhetherTheFilterIsVisible>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="DeterminesWhetherTheFilterIsVisible"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal DeterminesWhetherTheFilterIsVisible(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static DeterminesWhetherTheFilterIsVisible DefaultInstance { get; }
            ...
            public static explicit operator Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.SimpleBinding(DeterminesWhetherTheFilterIsVisible value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator DeterminesWhetherTheFilterIsVisible(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.SimpleBinding value)
            {
                return From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator DeterminesWhetherTheFilterIsVisible(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.SimpleBinding.Mutable value)
            {
                return From(value);
            }

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(DeterminesWhetherTheFilterIsVisible value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator bool(DeterminesWhetherTheFilterIsVisible value)
            {
            ...
            /// </returns>
            public static bool operator ==(in DeterminesWhetherTheFilterIsVisible left, in DeterminesWhetherTheFilterIsVisible right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in DeterminesWhetherTheFilterIsVisible left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(DeterminesWhetherTheFilterIsVisible instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DeterminesWhetherTheFilterIsVisible(JsonElement instance)
            {
                return DeterminesWhetherTheFilterIsVisible.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DeterminesWhetherTheFilterIsVisible From<T>(in T instance)
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DeterminesWhetherTheFilterIsVisible ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<DeterminesWhetherTheFilterIsVisible>(utf8Json, options);
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DeterminesWhetherTheFilterIsVisible ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<DeterminesWhetherTheFilterIsVisible>(json, options);
                #pragma warning restore CS0618
            }
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DeterminesWhetherTheFilterIsVisible ParseValue(string json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<DeterminesWhetherTheFilterIsVisible>(json, options);
                #pragma warning restore CS0618
            ...
            /// </exception>
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            public static DeterminesWhetherTheFilterIsVisible ParseValue(ref Utf8JsonReader reader)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<DeterminesWhetherTheFilterIsVisible>(ref reader);
                #pragma warning restore CS0618
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out DeterminesWhetherTheFilterIsVisible? result)
            {
                return JsonElementHelpers.TryParseValue<DeterminesWhetherTheFilterIsVisible>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new DeterminesWhetherTheFilterIsVisible(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static DeterminesWhetherTheFilterIsVisible IJsonElement<DeterminesWhetherTheFilterIsVisible>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DeterminesWhetherTheFilterIsVisible: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="DeterminesWhetherTheFilterIsVisible"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="DeterminesWhetherTheFilterIsVisible"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public DeterminesWhetherTheFilterIsVisible Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<DeterminesWhetherTheFilterIsVisible>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="DeterminesWhetherTheFilterIsVisible"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public DeterminesWhetherTheFilterIsVisible Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<DeterminesWhetherTheFilterIsVisible>(_idx);
                }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ConfigurationFilterTypeDateRange.DeterminesWhetherTheFilterIsVisible, TContext, TResult> defaultMatch)
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ConfigurationFilterTypeDateRange.DeterminesWhetherTheFilterIsVisible, TResult> defaultMatch)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                {
