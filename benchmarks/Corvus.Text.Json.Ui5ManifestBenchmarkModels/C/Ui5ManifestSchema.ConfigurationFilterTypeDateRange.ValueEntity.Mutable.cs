    ...
    public readonly partial struct ConfigurationFilterTypeDateRange
    {
        ...
        public readonly partial struct ValueEntity
        {
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ConfigurationFilterTypeDateRange.ValueEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ConfigurationFilterTypeDateRange.ValueEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public static ParsedJsonDocument<ValueEntity> Create(in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source option = default, in Corvus.Ui5ManifestBenchmark.Current.JsonArray.Source values = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
            public static ParsedJsonDocument<ValueEntity> Create<TContext>(in TContext context, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source option = default, in Corvus.Ui5ManifestBenchmark.Current.JsonArray.Source<TContext> values = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
