    ...
    public readonly partial struct ConfigurationFilterTypeSelect
    {
        ...
        public readonly partial struct DeterminesWhetherTheFilterIsVisible
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(DeterminesWhetherTheFilterIsVisible instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DeterminesWhetherTheFilterIsVisible"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DeterminesWhetherTheFilterIsVisible(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DeterminesWhetherTheFilterIsVisible.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly DeterminesWhetherTheFilterIsVisible Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly DeterminesWhetherTheFilterIsVisible Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DeterminesWhetherTheFilterIsVisible>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ConfigurationFilterTypeSelect.DeterminesWhetherTheFilterIsVisible.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ConfigurationFilterTypeSelect.DeterminesWhetherTheFilterIsVisible.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(DeterminesWhetherTheFilterIsVisible instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<DeterminesWhetherTheFilterIsVisible, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<DeterminesWhetherTheFilterIsVisible> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<DeterminesWhetherTheFilterIsVisible>();
                }
                finally
                {
