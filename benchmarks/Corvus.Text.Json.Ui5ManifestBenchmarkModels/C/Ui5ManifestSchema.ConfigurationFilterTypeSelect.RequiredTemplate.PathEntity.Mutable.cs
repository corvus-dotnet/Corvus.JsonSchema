        ...
        public readonly partial struct RequiredTemplate
        {
            ...
            public readonly partial struct PathEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<PathEntity, Mutable>(PathEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(PathEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="PathEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator PathEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"PathEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly PathEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly PathEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<PathEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(PathEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<PathEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<PathEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<PathEntity>();
                    }
                    finally
                    {
