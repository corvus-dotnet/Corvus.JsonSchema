...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct ConfigurationNoData
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ConfigurationNoData instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ConfigurationNoData"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ConfigurationNoData(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable Size
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SizeUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ConfigurationNoData(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetSize(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ConfigurationNoData.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ConfigurationNoData"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ConfigurationNoData"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly ConfigurationNoData Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ConfigurationNoData>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ConfigurationNoData"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly ConfigurationNoData Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ConfigurationNoData>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ConfigurationNoData.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            public static implicit operator Source(ConfigurationNoData instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ConfigurationNoData.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="ConfigurationNoData"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source description = default,
                in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source size = default,
            ...
            public void Create(
                ...
                in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source type = default)
            {
                Create(ref _builder, description, size, title, type);
            }
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source description = default, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source size = default, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source title = default, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source type = default)
        {
            return new Source(description, size, title, type);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source description = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source size = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source title = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source type = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(description, size, title, type);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<ConfigurationNoData, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ConfigurationNoData> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ConfigurationNoData>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ConfigurationNoData> Create<TContext>(
        ...
        public static ParsedJsonDocument<ConfigurationNoData> Create(in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source description = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source size = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source title = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source type = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
