...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct ContentTypeAnalytical
    {
        ...
        /// Generated from JSON Schema.
        /// </summary>
        public readonly partial struct ActionableAreaEntity
        {
            /// <summary>
            /// Generated from JSON Schema.
            /// </summary>
...
#endif
            {
                ...
                /// </summary>
                public static OneOf0Entity DefaultInstance { get; } = ParsedJsonDocument<OneOf0Entity>.StringConstant([.."\"Full\""u8]);
                ...
                /// <param name="matchFull">Match 1st item.</param>
                /// <param name="matchChart">Match 2nd item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> matchFull,
                    Func<TContext, TResult> matchChart,
...
#endif
                {
                    ...
                    {
                        return matchFull(context);
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchChart(context);
                    }
                ...
                public TResult Match<TResult>(
                    Func<TResult> matchFull,
                    Func<TResult> matchChart,
