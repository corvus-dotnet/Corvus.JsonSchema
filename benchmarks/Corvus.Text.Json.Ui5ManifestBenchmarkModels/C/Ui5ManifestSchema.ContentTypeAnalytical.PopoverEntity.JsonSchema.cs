    ...
    public readonly partial struct ContentTypeAnalytical
    {
            ...
            : IJsonElement<PopoverEntity>
        {
            public static partial class JsonSchema
            {
                ...
                private static void MatchActive(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/ContentType.Analytical/properties/popover"u8, buffer, out written);
