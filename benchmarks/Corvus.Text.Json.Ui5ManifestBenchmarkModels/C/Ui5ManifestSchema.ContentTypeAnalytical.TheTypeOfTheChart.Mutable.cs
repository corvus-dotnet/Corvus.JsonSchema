    ...
    public readonly partial struct ContentTypeAnalytical
    {
        ...
        public readonly partial struct TheTypeOfTheChart
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(TheTypeOfTheChart instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TheTypeOfTheChart"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TheTypeOfTheChart(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TheTypeOfTheChart.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly TheTypeOfTheChart Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly TheTypeOfTheChart Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TheTypeOfTheChart>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeAnalytical.TheTypeOfTheChart.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeAnalytical.TheTypeOfTheChart.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(TheTypeOfTheChart instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<TheTypeOfTheChart, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<TheTypeOfTheChart> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TheTypeOfTheChart>();
                }
                finally
                {
