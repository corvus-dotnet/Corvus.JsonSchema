...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct ContentTypeAnalyticalAxisText
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ContentTypeAnalyticalAxisText instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ContentTypeAnalyticalAxisText"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ContentTypeAnalyticalAxisText(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ContentTypeAnalyticalAxisText(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ContentTypeAnalyticalAxisText.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ContentTypeAnalyticalAxisText"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ContentTypeAnalyticalAxisText"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly ContentTypeAnalyticalAxisText Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ContentTypeAnalyticalAxisText>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ContentTypeAnalyticalAxisText"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly ContentTypeAnalyticalAxisText Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ContentTypeAnalyticalAxisText>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeAnalyticalAxisText.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Visibility.Source arg1)
            {
                _createArg1 = arg1;
                _kind = Kind.Create;
            }

            public static implicit operator Source(ContentTypeAnalyticalAxisText instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeAnalyticalAxisText.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="ContentTypeAnalyticalAxisText"/>.
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Visibility.Source visible = default)
            {
            ...
            /// Creates an instance of a <see cref="ContentTypeAnalyticalAxisText"/>.
            /// </summary>
            public void Create(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Visibility.Source visible = default)
            {
                Create(ref _builder, visible);
            }
            ...
            internal static void BuildCreateValue(scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Visibility.Source arg1, ref ComplexValueBuilder o)
            {
                o.StartObject();
                Create(ref o, arg1);
                o.EndObject();
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Visibility.Source visible = default)
        {
            return new Source(visible);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Visibility.Source visible = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        {
            return workspace.CreateBuilder<ContentTypeAnalyticalAxisText, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ContentTypeAnalyticalAxisText> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ContentTypeAnalyticalAxisText>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ContentTypeAnalyticalAxisText> Create<TContext>(
        ...
        public static ParsedJsonDocument<ContentTypeAnalyticalAxisText> Create(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Visibility.Source visible = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
