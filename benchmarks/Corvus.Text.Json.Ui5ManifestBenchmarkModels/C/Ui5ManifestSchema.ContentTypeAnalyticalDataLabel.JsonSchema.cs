...
public readonly partial struct Ui5ManifestSchema
{
        ...
        : IJsonElement<ContentTypeAnalyticalDataLabel>
    {
        public static partial class JsonSchema
        {
            ...
            private static void MatchShowTotal(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
            {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/ContentType.Analytical.DataLabel"u8, buffer, out written);
