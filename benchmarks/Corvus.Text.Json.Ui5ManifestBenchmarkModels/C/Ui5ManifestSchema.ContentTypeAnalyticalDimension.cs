...
public readonly partial struct Ui5ManifestSchema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeAnalyticalDimension.DataTypeEntity DataType
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DataTypeUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeAnalyticalDimension.DataTypeEntity value))
                {
                    return value;
                }
        ...
        {
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="DataType"/>.
            /// </summary>
            public static ReadOnlySpan<byte> DataType => [0xA5, 0x00, 0x00, 0x00, 0x22, 0x64, 0x61, 0x74, 0x61, 0x54, 0x79, 0x70, 0x65, 0x22];
