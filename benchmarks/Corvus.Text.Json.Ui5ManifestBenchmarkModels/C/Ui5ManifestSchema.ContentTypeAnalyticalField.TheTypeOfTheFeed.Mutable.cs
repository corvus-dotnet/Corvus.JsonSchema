    ...
    public readonly partial struct ContentTypeAnalyticalField
    {
        ...
        public readonly partial struct TheTypeOfTheFeed
        {
...
#endif
            {
                ...
                public static explicit operator Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeAnalyticalField.TheTypeOfTheFeed.OneOf0Entity.Mutable(Mutable value)
                {
                    return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeAnalyticalField.TheTypeOfTheFeed.OneOf0Entity.Mutable.From(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeAnalyticalField.TheTypeOfTheFeed.OneOf0Entity.Mutable value)
                {
                    return From(value);
                }
                ...
                public static explicit operator Mutable(TheTypeOfTheFeed instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TheTypeOfTheFeed"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TheTypeOfTheFeed(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TheTypeOfTheFeed.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly TheTypeOfTheFeed Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly TheTypeOfTheFeed Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TheTypeOfTheFeed>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeAnalyticalField.TheTypeOfTheFeed.Mutable, TContext, TResult> defaultMatch)
...
#endif
                {
                    ...
                    {
                        return matchOneOf0Entity(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeAnalyticalField.TheTypeOfTheFeed.OneOf0Entity.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeAnalyticalField.TheTypeOfTheFeed.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeAnalyticalField.TheTypeOfTheFeed.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchOneOf0Entity(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeAnalyticalField.TheTypeOfTheFeed.OneOf0Entity.Mutable.From(this));
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeAnalyticalField.TheTypeOfTheFeed.OneOf0Entity.Mutable" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsOneOf0Entity(out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeAnalyticalField.TheTypeOfTheFeed.OneOf0Entity.Mutable result)
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeAnalyticalField.TheTypeOfTheFeed.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeAnalyticalField.TheTypeOfTheFeed.OneOf0Entity.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(TheTypeOfTheFeed instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeAnalyticalField.TheTypeOfTheFeed.OneOf0Entity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<TheTypeOfTheFeed, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<TheTypeOfTheFeed> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TheTypeOfTheFeed>();
                }
                finally
                {
