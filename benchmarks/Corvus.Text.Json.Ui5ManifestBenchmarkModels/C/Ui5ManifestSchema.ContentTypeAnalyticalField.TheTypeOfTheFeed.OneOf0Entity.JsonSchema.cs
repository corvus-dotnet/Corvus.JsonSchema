    ...
    public readonly partial struct ContentTypeAnalyticalField
    {
        ...
        public readonly partial struct TheTypeOfTheFeed
        {
                ...
                : IJsonElement<OneOf0Entity>
            {
                ...
                {
                    /// <summary>
                    /// Corresponds to the JSON string "Measure".
                    /// </summary>
                    Measure = 0,
                    /// <summary>
                    /// Corresponds to the JSON string "Dimension".
                    /// </summary>
                    Dimension = 1,
                }
                ...
                public static implicit operator OneOf0Entity(KnownValues value)
                {
                    return value switch
                    {
                        KnownValues.Measure => Constants.EnumJson1,
                        KnownValues.Dimension => Constants.EnumJson2,
                ...
                public bool TryGetKnownValue(out KnownValues result)
                {
                    ...
                    {
                        result = KnownValues.Measure;
                        return true;
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        result = KnownValues.Dimension;
                        return true;
                    }
                ...
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/ContentType.Analytical.Field/properties/type/oneOf/0"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated, as a JSON Pointer within <see cref="SchemaDocument"/>.
                    /// </summary>
                    public const string SchemaLocation = "/definitions/ContentType.Analytical.Field/properties/type/oneOf/0";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/ContentType.Analytical.Field/properties/type/oneOf/0"u8;
                    ...
                    private static readonly global::Corvus.Text.Json.RuntimeEvaluator.JsonSchemaEvaluator Evaluator = global::Corvus.Ui5ManifestBenchmark.Current.CorvusJsonSchemaProgram.Entry(44);
