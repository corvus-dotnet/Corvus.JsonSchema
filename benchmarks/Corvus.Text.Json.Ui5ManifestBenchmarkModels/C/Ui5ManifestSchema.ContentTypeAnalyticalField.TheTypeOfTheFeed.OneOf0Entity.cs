    ...
    public readonly partial struct ContentTypeAnalyticalField
    {
        ...
        public readonly partial struct TheTypeOfTheFeed
        {
...
#endif
            {
                ...
                /// <param name="matchMeasure">Match 1st item.</param>
                /// <param name="matchDimension">Match 2nd item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> matchMeasure,
                    Func<TContext, TResult> matchDimension,
...
#endif
                {
                    ...
                    {
                        return matchMeasure(context);
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchDimension(context);
                    }
                ...
                public TResult Match<TResult>(
                    Func<TResult> matchMeasure,
                    Func<TResult> matchDimension,
