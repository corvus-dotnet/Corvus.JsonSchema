...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct ContentTypeAnalyticsCloud
        ...
        : IJsonElement<ContentTypeAnalyticsCloud>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ContentTypeAnalyticsCloud"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ContentTypeAnalyticsCloud(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ContentTypeAnalyticsCloud DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeAnalyticsCloud.ActionArray Actions
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ActionsUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeAnalyticsCloud.ActionArray value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeAnalyticsCloud.OptionsOfTheChart Options
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OptionsUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeAnalyticsCloud.OptionsOfTheChart value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in ContentTypeAnalyticsCloud left, in ContentTypeAnalyticsCloud right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ContentTypeAnalyticsCloud left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(ContentTypeAnalyticsCloud instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ContentTypeAnalyticsCloud(JsonElement instance)
        {
            return ContentTypeAnalyticsCloud.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ContentTypeAnalyticsCloud From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ContentTypeAnalyticsCloud ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ContentTypeAnalyticsCloud>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ContentTypeAnalyticsCloud ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ContentTypeAnalyticsCloud>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ContentTypeAnalyticsCloud ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ContentTypeAnalyticsCloud>(json, options);
        }
        ...
        /// </exception>
        public static ContentTypeAnalyticsCloud ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ContentTypeAnalyticsCloud>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ContentTypeAnalyticsCloud? result)
        {
            return JsonElementHelpers.TryParseValue<ContentTypeAnalyticsCloud>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ContentTypeAnalyticsCloud(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static ContentTypeAnalyticsCloud IJsonElement<ContentTypeAnalyticsCloud>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ContentTypeAnalyticsCloud: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ContentTypeAnalyticsCloud"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ContentTypeAnalyticsCloud"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public ContentTypeAnalyticsCloud Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ContentTypeAnalyticsCloud>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ContentTypeAnalyticsCloud"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public ContentTypeAnalyticsCloud Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ContentTypeAnalyticsCloud>(_idx);
            }
