    ...
    public readonly partial struct ContentTypeCalendar
    {
        ...
        public readonly partial struct MoreItemsEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(MoreItemsEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="MoreItemsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator MoreItemsEntity(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeCalendar.MoreItemsEntity.ActionArray.Mutable Actions
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ActionsUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeCalendar.MoreItemsEntity.ActionArray.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetActions(scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeCalendar.MoreItemsEntity.ActionArray.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetActions<TContext>(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeCalendar.MoreItemsEntity.ActionArray.Source<TContext> value)
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"MoreItemsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly MoreItemsEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly MoreItemsEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<MoreItemsEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeCalendar.MoreItemsEntity.ActionArray.Source _createArg1;
                ...
                internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeCalendar.MoreItemsEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeCalendar.MoreItemsEntity.ActionArray.Source arg1)
                {
                    _createArg1 = arg1;
                    _kind = Kind.Create;
                }

                public static implicit operator Source(MoreItemsEntity instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeCalendar.MoreItemsEntity.ActionArray.Source<TContext> _createArg1;
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeCalendar.MoreItemsEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeCalendar.MoreItemsEntity.ActionArray.Source<TContext> arg1)
                {
                    _context = context;
                    _createArg1 = arg1;
                    _kind = Kind.Create;
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="MoreItemsEntity"/>.
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeCalendar.MoreItemsEntity.ActionArray.Source actions = default)
                {
                ...
                /// Creates an instance of a <see cref="MoreItemsEntity"/>.
                /// </summary>
                public void Create(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeCalendar.MoreItemsEntity.ActionArray.Source actions = default)
                {
                    Create(ref _builder, actions);
                }
                ...
                internal static void Create<TContext>(
                    ...
                    in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeCalendar.MoreItemsEntity.ActionArray.Source<TContext> actions = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
                ...
                /// Creates an instance of a <see cref="MoreItemsEntity"/>.
                /// </summary>
                public void Create<TContext>(in TContext context, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeCalendar.MoreItemsEntity.ActionArray.Source<TContext> actions = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
                    Create(context, ref _builder, actions);
                }
                ...
                internal static void BuildCreateValue(scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeCalendar.MoreItemsEntity.ActionArray.Source arg1, ref ComplexValueBuilder o)
                {
                    o.StartObject();
                    Create(ref o, arg1);
                    o.EndObject();
                ...
                /// <param name="arg1">The value of the property.</param>
                /// <param name="o">The complex value builder into which to write the object.</param>
                internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeCalendar.MoreItemsEntity.ActionArray.Source<TContext> arg1, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeCalendar.MoreItemsEntity.ActionArray.Source actions = default)
            {
                return new Source(actions);
            }
            ...
            /// <param name="actions">The value of the <c>"actions"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeCalendar.MoreItemsEntity.ActionArray.Source<TContext> actions = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                return new Source<TContext>(context, actions);
            }
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeCalendar.MoreItemsEntity.ActionArray.Source actions = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeCalendar.MoreItemsEntity.ActionArray.Source<TContext> actions = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
            ...
            {
                return workspace.CreateBuilder<MoreItemsEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<MoreItemsEntity> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<MoreItemsEntity>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<MoreItemsEntity> Create<TContext>(
            ...
            public static ParsedJsonDocument<MoreItemsEntity> Create(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeCalendar.MoreItemsEntity.ActionArray.Source actions = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
            public static ParsedJsonDocument<MoreItemsEntity> Create<TContext>(in TContext context, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeCalendar.MoreItemsEntity.ActionArray.Source<TContext> actions = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
