...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct ContentTypeCalendar
    {
        ...
        public readonly partial struct RepresentsNumberOfItemsDisplayed
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RepresentsNumberOfItemsDisplayed instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsNumberOfItemsDisplayed"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsNumberOfItemsDisplayed(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new RepresentsNumberOfItemsDisplayed(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsNumberOfItemsDisplayed.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="RepresentsNumberOfItemsDisplayed"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="RepresentsNumberOfItemsDisplayed"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsNumberOfItemsDisplayed Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<RepresentsNumberOfItemsDisplayed>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="RepresentsNumberOfItemsDisplayed"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsNumberOfItemsDisplayed Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsNumberOfItemsDisplayed>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeCalendar.RepresentsNumberOfItemsDisplayed.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeCalendar.RepresentsNumberOfItemsDisplayed.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsNumberOfItemsDisplayed instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RepresentsNumberOfItemsDisplayed, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RepresentsNumberOfItemsDisplayed> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RepresentsNumberOfItemsDisplayed>();
                }
                finally
                {
