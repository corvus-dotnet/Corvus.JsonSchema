...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct ContentTypeCalendar
    {
        ...
        public readonly partial struct RepresentsNumberOfLegendItemsDisplayed
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RepresentsNumberOfLegendItemsDisplayed instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsNumberOfLegendItemsDisplayed"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsNumberOfLegendItemsDisplayed(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new RepresentsNumberOfLegendItemsDisplayed(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsNumberOfLegendItemsDisplayed.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="RepresentsNumberOfLegendItemsDisplayed"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="RepresentsNumberOfLegendItemsDisplayed"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsNumberOfLegendItemsDisplayed Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<RepresentsNumberOfLegendItemsDisplayed>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="RepresentsNumberOfLegendItemsDisplayed"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsNumberOfLegendItemsDisplayed Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsNumberOfLegendItemsDisplayed>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeCalendar.RepresentsNumberOfLegendItemsDisplayed.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeCalendar.RepresentsNumberOfLegendItemsDisplayed.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsNumberOfLegendItemsDisplayed instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RepresentsNumberOfLegendItemsDisplayed, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RepresentsNumberOfLegendItemsDisplayed> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RepresentsNumberOfLegendItemsDisplayed>();
                }
                finally
                {
