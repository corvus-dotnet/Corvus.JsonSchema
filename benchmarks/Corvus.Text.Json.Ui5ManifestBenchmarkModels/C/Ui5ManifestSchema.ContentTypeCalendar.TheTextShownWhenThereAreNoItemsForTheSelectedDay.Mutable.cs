...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct ContentTypeCalendar
    {
        ...
        public readonly partial struct TheTextShownWhenThereAreNoItemsForTheSelectedDay
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(TheTextShownWhenThereAreNoItemsForTheSelectedDay instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TheTextShownWhenThereAreNoItemsForTheSelectedDay"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TheTextShownWhenThereAreNoItemsForTheSelectedDay(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new TheTextShownWhenThereAreNoItemsForTheSelectedDay(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TheTextShownWhenThereAreNoItemsForTheSelectedDay.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="TheTextShownWhenThereAreNoItemsForTheSelectedDay"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="TheTextShownWhenThereAreNoItemsForTheSelectedDay"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly TheTextShownWhenThereAreNoItemsForTheSelectedDay Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<TheTextShownWhenThereAreNoItemsForTheSelectedDay>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="TheTextShownWhenThereAreNoItemsForTheSelectedDay"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly TheTextShownWhenThereAreNoItemsForTheSelectedDay Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TheTextShownWhenThereAreNoItemsForTheSelectedDay>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeCalendar.TheTextShownWhenThereAreNoItemsForTheSelectedDay.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeCalendar.TheTextShownWhenThereAreNoItemsForTheSelectedDay.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(TheTextShownWhenThereAreNoItemsForTheSelectedDay instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<TheTextShownWhenThereAreNoItemsForTheSelectedDay, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<TheTextShownWhenThereAreNoItemsForTheSelectedDay> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TheTextShownWhenThereAreNoItemsForTheSelectedDay>();
                }
                finally
                {
