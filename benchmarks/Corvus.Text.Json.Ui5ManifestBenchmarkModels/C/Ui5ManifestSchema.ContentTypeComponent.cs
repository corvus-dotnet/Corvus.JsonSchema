...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct ContentTypeComponent
#if NET8_0_OR_GREATER
        : IJsonElement<ContentTypeComponent>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ContentTypeComponent"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ContentTypeComponent(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ContentTypeComponent DefaultInstance { get; }
        ...
        /// </returns>
        public static bool operator ==(in ContentTypeComponent left, in ContentTypeComponent right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ContentTypeComponent left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(ContentTypeComponent instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ContentTypeComponent(JsonElement instance)
        {
            return ContentTypeComponent.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ContentTypeComponent From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ContentTypeComponent ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ContentTypeComponent>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ContentTypeComponent ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ContentTypeComponent>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ContentTypeComponent ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ContentTypeComponent>(json, options);
        }
        ...
        /// </exception>
        public static ContentTypeComponent ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ContentTypeComponent>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ContentTypeComponent? result)
        {
            return JsonElementHelpers.TryParseValue<ContentTypeComponent>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ContentTypeComponent(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static ContentTypeComponent IJsonElement<ContentTypeComponent>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ContentTypeComponent: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ContentTypeComponent"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ContentTypeComponent"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public ContentTypeComponent Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ContentTypeComponent>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ContentTypeComponent"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public ContentTypeComponent Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ContentTypeComponent>(_idx);
            }
