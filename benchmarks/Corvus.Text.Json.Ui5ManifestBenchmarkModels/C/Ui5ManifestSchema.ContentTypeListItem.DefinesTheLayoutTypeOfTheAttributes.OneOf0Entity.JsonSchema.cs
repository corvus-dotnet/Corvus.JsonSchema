    ...
    public readonly partial struct ContentTypeListItem
    {
        ...
        public readonly partial struct DefinesTheLayoutTypeOfTheAttributes
        {
                ...
                : IJsonElement<OneOf0Entity>
            {
                ...
                {
                    /// <summary>
                    /// Corresponds to the JSON string "OneColumn".
                    /// </summary>
                    OneColumn = 0,
                    /// <summary>
                    /// Corresponds to the JSON string "TwoColumns".
                    /// </summary>
                    TwoColumns = 1,
                }
                ...
                public static implicit operator OneOf0Entity(KnownValues value)
                {
                    return value switch
                    {
                        KnownValues.OneColumn => Constants.EnumJson1,
                        KnownValues.TwoColumns => Constants.EnumJson2,
                ...
                public bool TryGetKnownValue(out KnownValues result)
                {
                    ...
                    {
                        result = KnownValues.OneColumn;
                        return true;
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        result = KnownValues.TwoColumns;
                        return true;
                    }
                ...
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/ContentType.List.Item/properties/attributesLayoutType/oneOf/0"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated, as a JSON Pointer within <see cref="SchemaDocument"/>.
                    /// </summary>
                    public const string SchemaLocation = "/definitions/ContentType.List.Item/properties/attributesLayoutType/oneOf/0";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/ContentType.List.Item/properties/attributesLayoutType/oneOf/0"u8;
                    ...
                    private static readonly global::Corvus.Text.Json.RuntimeEvaluator.JsonSchemaEvaluator Evaluator = global::Corvus.Ui5ManifestBenchmark.Current.CorvusJsonSchemaProgram.Entry(103);
