    ...
    public readonly partial struct ContentTypeListItem
    {
        ...
        public readonly partial struct TheDescriptionOfTheItem
        {
...
#endif
            {
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Field" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsField(out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Field result)
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Field.JsonSchema.Evaluate(_parent, _idx))
                    {
