    ...
    public readonly partial struct ContentTypeListItem
    {
        ...
        public readonly partial struct TheHighlightStateOfTheItem
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(TheHighlightStateOfTheItem instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TheHighlightStateOfTheItem"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TheHighlightStateOfTheItem(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TheHighlightStateOfTheItem.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly TheHighlightStateOfTheItem Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly TheHighlightStateOfTheItem Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TheHighlightStateOfTheItem>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeListItem.TheHighlightStateOfTheItem.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeListItem.TheHighlightStateOfTheItem.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.State.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(TheHighlightStateOfTheItem instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<TheHighlightStateOfTheItem, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<TheHighlightStateOfTheItem> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TheHighlightStateOfTheItem>();
                }
                finally
                {
