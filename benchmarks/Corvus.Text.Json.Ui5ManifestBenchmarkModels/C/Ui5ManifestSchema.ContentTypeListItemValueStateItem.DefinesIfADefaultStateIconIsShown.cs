    ...
    public readonly partial struct ContentTypeListItemValueStateItem
    {
...
#endif
        {
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeListItemValueStateItem.DefinesIfADefaultStateIconIsShown, TContext, TResult> defaultMatch)
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeListItemValueStateItem.DefinesIfADefaultStateIconIsShown, TResult> defaultMatch)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                {
