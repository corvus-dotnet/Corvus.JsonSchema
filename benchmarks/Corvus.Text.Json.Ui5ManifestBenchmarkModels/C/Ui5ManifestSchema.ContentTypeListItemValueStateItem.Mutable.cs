...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct ContentTypeListItemValueStateItem
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ContentTypeListItemValueStateItem instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ContentTypeListItemValueStateItem"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ContentTypeListItemValueStateItem(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeListItemValueStateItem.DefinesIfADefaultStateIconIsShown.Mutable ShowStateIcon
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ShowStateIconUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeListItemValueStateItem.DefinesIfADefaultStateIconIsShown.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeListItemValueStateItem.TheStateOfTheField.Mutable State
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StateUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeListItemValueStateItem.TheStateOfTheField.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeListItemValueStateItem.VisibilityOfTheItem.Mutable Visible
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VisibleUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeListItemValueStateItem.VisibilityOfTheItem.Mutable value))
                    {
                        return value;
                    }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ContentTypeListItemValueStateItem.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ContentTypeListItemValueStateItem Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ContentTypeListItemValueStateItem Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ContentTypeListItemValueStateItem>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeListItemValueStateItem.DefinesIfADefaultStateIconIsShown.Source _createArg2;
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeListItemValueStateItem.TheStateOfTheField.Source _createArg3;
            ...
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeListItemValueStateItem.VisibilityOfTheItem.Source _createArg6;
            ...
            public static implicit operator Source(ContentTypeListItemValueStateItem instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeListItemValueStateItem.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="ContentTypeListItemValueStateItem"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source customStateIcon = default,
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeListItemValueStateItem.DefinesIfADefaultStateIconIsShown.Source showStateIcon = default,
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeListItemValueStateItem.TheStateOfTheField.Source state = default,
                ...
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeListItemValueStateItem.VisibilityOfTheItem.Source visible = default)
            {
            ...
            public void Create(
                ...
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeListItemValueStateItem.VisibilityOfTheItem.Source visible = default)
            {
                Create(ref _builder, customStateIcon, showStateIcon, state, title, value, visible);
            }
        ...
        {
            return workspace.CreateBuilder<ContentTypeListItemValueStateItem, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ContentTypeListItemValueStateItem> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ContentTypeListItemValueStateItem>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ContentTypeListItemValueStateItem> Create<TContext>(
        ...
        public static ParsedJsonDocument<ContentTypeListItemValueStateItem> Create(in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source customStateIcon = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeListItemValueStateItem.DefinesIfADefaultStateIconIsShown.Source showStateIcon = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeListItemValueStateItem.TheStateOfTheField.Source state = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source title = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source value = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeListItemValueStateItem.VisibilityOfTheItem.Source visible = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
