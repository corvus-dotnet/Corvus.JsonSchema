    ...
    public readonly partial struct ContentTypeListItemValueStateItem
    {
        ...
        public readonly partial struct TheStateOfTheField
        {
...
#endif
            {
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.State" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsState(out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.State result)
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.State.JsonSchema.Evaluate(_parent, _idx))
                    {
