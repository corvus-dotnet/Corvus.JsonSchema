...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct ContentTypeListItemValueStateItem
    {
        ...
        public readonly partial struct TheStateOfTheField
        {
...
#endif
            {
                ...
                /// <summary>
                /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.State"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static explicit operator Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.State.Mutable(Mutable value)
                {
                    return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.State.Mutable.From(value);
                }

                /// <summary>
                /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.State"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.State.Mutable value)
                {
                    return From(value);
                }
                ...
                public static explicit operator Mutable(TheStateOfTheField instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TheStateOfTheField"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TheStateOfTheField(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new TheStateOfTheField(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TheStateOfTheField.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="TheStateOfTheField"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="TheStateOfTheField"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly TheStateOfTheField Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<TheStateOfTheField>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="TheStateOfTheField"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly TheStateOfTheField Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TheStateOfTheField>(_idx);
                }
                ...
                /// <param name="matchState">Match a <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.State"/>.</param>
                ...
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.State, TContext, TResult> matchState,
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.SimpleBinding, TContext, TResult> matchSimpleBinding,
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeListItemValueStateItem.TheStateOfTheField.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.State.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchState(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.State.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.State, TResult> matchState,
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.SimpleBinding, TResult> matchSimpleBinding,
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeListItemValueStateItem.TheStateOfTheField.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.State.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchState(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.State.Mutable.From(this));
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.State.Mutable" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsState(out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.State.Mutable result)
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.State.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.State.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(TheStateOfTheField instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.State instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<TheStateOfTheField, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<TheStateOfTheField> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TheStateOfTheField>();
                }
                finally
                {
