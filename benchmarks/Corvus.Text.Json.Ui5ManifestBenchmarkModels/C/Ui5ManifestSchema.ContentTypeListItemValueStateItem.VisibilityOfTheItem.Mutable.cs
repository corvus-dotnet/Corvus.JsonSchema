...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct ContentTypeListItemValueStateItem
    {
        ...
        public readonly partial struct VisibilityOfTheItem
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(VisibilityOfTheItem instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="VisibilityOfTheItem"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator VisibilityOfTheItem(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new VisibilityOfTheItem(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"VisibilityOfTheItem.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="VisibilityOfTheItem"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="VisibilityOfTheItem"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly VisibilityOfTheItem Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<VisibilityOfTheItem>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="VisibilityOfTheItem"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly VisibilityOfTheItem Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<VisibilityOfTheItem>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeListItemValueStateItem.VisibilityOfTheItem.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeListItemValueStateItem.VisibilityOfTheItem.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(VisibilityOfTheItem instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<VisibilityOfTheItem, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<VisibilityOfTheItem> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<VisibilityOfTheItem>();
                }
                finally
                {
