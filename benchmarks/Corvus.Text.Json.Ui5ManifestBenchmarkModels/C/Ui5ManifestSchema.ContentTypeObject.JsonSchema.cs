...
public readonly partial struct Ui5ManifestSchema
{
        ...
        : IJsonElement<ContentTypeObject>
    {
        public static partial class JsonSchema
        {
            ...
            private static void MatchGroups(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
            ...
            private static void MatchHasData(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
