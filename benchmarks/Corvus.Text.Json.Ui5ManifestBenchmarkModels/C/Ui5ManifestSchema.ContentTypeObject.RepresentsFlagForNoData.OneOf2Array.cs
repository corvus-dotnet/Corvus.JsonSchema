    ...
    public readonly partial struct ContentTypeObject
    {
        ...
        public readonly partial struct RepresentsFlagForNoData
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="OneOf2Array"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal OneOf2Array(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static OneOf2Array DefaultInstance { get; }
                ...
                /// </returns>
                public static bool operator ==(in OneOf2Array left, in OneOf2Array right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in OneOf2Array left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(OneOf2Array instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator OneOf2Array(JsonElement instance)
                {
                    return OneOf2Array.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static OneOf2Array From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static OneOf2Array ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<OneOf2Array>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static OneOf2Array ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<OneOf2Array>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static OneOf2Array ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<OneOf2Array>(json, options);
                }
                ...
                /// </exception>
                public static OneOf2Array ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<OneOf2Array>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out OneOf2Array? result)
                {
                    return JsonElementHelpers.TryParseValue<OneOf2Array>(ref reader, out result);
                }
...
#if NET
                static OneOf2Array IJsonElement<OneOf2Array>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"OneOf2Array: ValueKind = {ValueKind} : \"{ToString()}\"";
