    ...
    public readonly partial struct ContentTypeObjectGroup
    {
        ...
        public readonly partial struct ExperimentalAlignmentOfTheGroup
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ExperimentalAlignmentOfTheGroup, Mutable>(ExperimentalAlignmentOfTheGroup.DefaultInstance);
                ...
                public static explicit operator Mutable(ExperimentalAlignmentOfTheGroup instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ExperimentalAlignmentOfTheGroup"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ExperimentalAlignmentOfTheGroup(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ExperimentalAlignmentOfTheGroup.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ExperimentalAlignmentOfTheGroup Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ExperimentalAlignmentOfTheGroup Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ExperimentalAlignmentOfTheGroup>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ExperimentalAlignmentOfTheGroup instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (ExperimentalAlignmentOfTheGroup)value;
            ...
            {
                return workspace.CreateBuilder<ExperimentalAlignmentOfTheGroup, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ExperimentalAlignmentOfTheGroup> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ExperimentalAlignmentOfTheGroup>();
                }
                finally
                {
