    ...
    public readonly partial struct ContentTypeObjectGroup
    {
        ...
        public readonly partial struct TitleMaxLinesEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<TitleMaxLinesEntity, Mutable>(TitleMaxLinesEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(TitleMaxLinesEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TitleMaxLinesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TitleMaxLinesEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TitleMaxLinesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly TitleMaxLinesEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly TitleMaxLinesEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TitleMaxLinesEntity>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeObjectGroup.TitleMaxLinesEntity.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeObjectGroup.TitleMaxLinesEntity.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(TitleMaxLinesEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<TitleMaxLinesEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<TitleMaxLinesEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TitleMaxLinesEntity>();
                }
                finally
                {
