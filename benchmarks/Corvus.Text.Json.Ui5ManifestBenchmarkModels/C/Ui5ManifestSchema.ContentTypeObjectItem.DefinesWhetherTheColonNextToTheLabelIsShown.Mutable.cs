    ...
    public readonly partial struct ContentTypeObjectItem
    {
        ...
        public readonly partial struct DefinesWhetherTheColonNextToTheLabelIsShown
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(DefinesWhetherTheColonNextToTheLabelIsShown instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DefinesWhetherTheColonNextToTheLabelIsShown"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DefinesWhetherTheColonNextToTheLabelIsShown(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DefinesWhetherTheColonNextToTheLabelIsShown.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly DefinesWhetherTheColonNextToTheLabelIsShown Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly DefinesWhetherTheColonNextToTheLabelIsShown Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DefinesWhetherTheColonNextToTheLabelIsShown>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeObjectItem.DefinesWhetherTheColonNextToTheLabelIsShown.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeObjectItem.DefinesWhetherTheColonNextToTheLabelIsShown.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(DefinesWhetherTheColonNextToTheLabelIsShown instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<DefinesWhetherTheColonNextToTheLabelIsShown, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<DefinesWhetherTheColonNextToTheLabelIsShown> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<DefinesWhetherTheColonNextToTheLabelIsShown>();
                }
                finally
                {
