...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct ContentTypeObjectItem
    {
        ...
        public readonly partial struct DefinesWhetherTheColonNextToTheLabelIsShown
#if NET8_0_OR_GREATER
            : IJsonElement<DefinesWhetherTheColonNextToTheLabelIsShown>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="DefinesWhetherTheColonNextToTheLabelIsShown"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal DefinesWhetherTheColonNextToTheLabelIsShown(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static DefinesWhetherTheColonNextToTheLabelIsShown DefaultInstance { get; }
            ...
            public static explicit operator Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.SimpleBinding(DefinesWhetherTheColonNextToTheLabelIsShown value)
            {
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator DefinesWhetherTheColonNextToTheLabelIsShown(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.SimpleBinding value)
            {
                return From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator DefinesWhetherTheColonNextToTheLabelIsShown(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.SimpleBinding.Mutable value)
            {
                return From(value);
            }

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(DefinesWhetherTheColonNextToTheLabelIsShown value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();

            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator bool(DefinesWhetherTheColonNextToTheLabelIsShown value)
            {
            ...
            /// </returns>
            public static bool operator ==(in DefinesWhetherTheColonNextToTheLabelIsShown left, in DefinesWhetherTheColonNextToTheLabelIsShown right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in DefinesWhetherTheColonNextToTheLabelIsShown left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(DefinesWhetherTheColonNextToTheLabelIsShown instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DefinesWhetherTheColonNextToTheLabelIsShown(JsonElement instance)
            {
                return DefinesWhetherTheColonNextToTheLabelIsShown.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DefinesWhetherTheColonNextToTheLabelIsShown From<T>(in T instance)
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DefinesWhetherTheColonNextToTheLabelIsShown ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<DefinesWhetherTheColonNextToTheLabelIsShown>(utf8Json, options);
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DefinesWhetherTheColonNextToTheLabelIsShown ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<DefinesWhetherTheColonNextToTheLabelIsShown>(json, options);
                #pragma warning restore CS0618
            }
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DefinesWhetherTheColonNextToTheLabelIsShown ParseValue(string json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<DefinesWhetherTheColonNextToTheLabelIsShown>(json, options);
                #pragma warning restore CS0618
            ...
            /// </exception>
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            public static DefinesWhetherTheColonNextToTheLabelIsShown ParseValue(ref Utf8JsonReader reader)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<DefinesWhetherTheColonNextToTheLabelIsShown>(ref reader);
                #pragma warning restore CS0618
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out DefinesWhetherTheColonNextToTheLabelIsShown? result)
            {
                return JsonElementHelpers.TryParseValue<DefinesWhetherTheColonNextToTheLabelIsShown>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new DefinesWhetherTheColonNextToTheLabelIsShown(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static DefinesWhetherTheColonNextToTheLabelIsShown IJsonElement<DefinesWhetherTheColonNextToTheLabelIsShown>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DefinesWhetherTheColonNextToTheLabelIsShown: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="DefinesWhetherTheColonNextToTheLabelIsShown"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="DefinesWhetherTheColonNextToTheLabelIsShown"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public DefinesWhetherTheColonNextToTheLabelIsShown Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<DefinesWhetherTheColonNextToTheLabelIsShown>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="DefinesWhetherTheColonNextToTheLabelIsShown"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public DefinesWhetherTheColonNextToTheLabelIsShown Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<DefinesWhetherTheColonNextToTheLabelIsShown>(_idx);
                }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeObjectItem.DefinesWhetherTheColonNextToTheLabelIsShown, TContext, TResult> defaultMatch)
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeObjectItem.DefinesWhetherTheColonNextToTheLabelIsShown, TResult> defaultMatch)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                {
