...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct ContentTypeObjectItem
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="HeaderTypeNumericSideIndicatorArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal HeaderTypeNumericSideIndicatorArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static HeaderTypeNumericSideIndicatorArray DefaultInstance { get; }
            ...
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.HeaderTypeNumericSideIndicator this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.HeaderTypeNumericSideIndicator>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.HeaderTypeNumericSideIndicator> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.HeaderTypeNumericSideIndicator>(_parent, _idx);
            }
            ...
            /// </returns>
            public static bool operator ==(in HeaderTypeNumericSideIndicatorArray left, in HeaderTypeNumericSideIndicatorArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in HeaderTypeNumericSideIndicatorArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(HeaderTypeNumericSideIndicatorArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator HeaderTypeNumericSideIndicatorArray(JsonElement instance)
            {
                return HeaderTypeNumericSideIndicatorArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HeaderTypeNumericSideIndicatorArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HeaderTypeNumericSideIndicatorArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<HeaderTypeNumericSideIndicatorArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HeaderTypeNumericSideIndicatorArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<HeaderTypeNumericSideIndicatorArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HeaderTypeNumericSideIndicatorArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<HeaderTypeNumericSideIndicatorArray>(json, options);
            }
            ...
            /// </exception>
            public static HeaderTypeNumericSideIndicatorArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<HeaderTypeNumericSideIndicatorArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out HeaderTypeNumericSideIndicatorArray? result)
            {
                return JsonElementHelpers.TryParseValue<HeaderTypeNumericSideIndicatorArray>(ref reader, out result);
            }
...
#if NET
            static HeaderTypeNumericSideIndicatorArray IJsonElement<HeaderTypeNumericSideIndicatorArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"HeaderTypeNumericSideIndicatorArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public HeaderTypeNumericSideIndicatorArray Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public HeaderTypeNumericSideIndicatorArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<HeaderTypeNumericSideIndicatorArray>(_idx);
                }
