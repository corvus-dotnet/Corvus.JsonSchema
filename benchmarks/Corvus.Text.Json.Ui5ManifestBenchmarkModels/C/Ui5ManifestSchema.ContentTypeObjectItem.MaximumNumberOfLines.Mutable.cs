    ...
    public readonly partial struct ContentTypeObjectItem
    {
        ...
        public readonly partial struct MaximumNumberOfLines
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(MaximumNumberOfLines instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="MaximumNumberOfLines"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator MaximumNumberOfLines(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"MaximumNumberOfLines.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly MaximumNumberOfLines Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly MaximumNumberOfLines Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<MaximumNumberOfLines>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeObjectItem.MaximumNumberOfLines.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeObjectItem.MaximumNumberOfLines.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(MaximumNumberOfLines instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<MaximumNumberOfLines, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<MaximumNumberOfLines> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<MaximumNumberOfLines>();
                }
                finally
                {
