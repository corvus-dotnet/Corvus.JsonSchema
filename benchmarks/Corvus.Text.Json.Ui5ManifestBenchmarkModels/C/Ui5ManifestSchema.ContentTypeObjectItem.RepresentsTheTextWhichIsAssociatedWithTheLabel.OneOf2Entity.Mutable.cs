        ...
        public readonly partial struct RepresentsTheTextWhichIsAssociatedWithTheLabel
        {
            ...
            public readonly partial struct OneOf2Entity
            {
...
#endif
                {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable Option
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OptionUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// </summary>
                    public Corvus.Ui5ManifestBenchmark.Current.JsonArray.Mutable Values
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ValuesUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonArray.Mutable value))
                            {
                                return value;
                            }
                    ...
                    public void SetOption(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source value)
                    {
                        CheckValidInstance();
                        ...
                        else
                        {
                            ...
                            value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Option, ref cvb);
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetValues(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonArray.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetValues<TContext>(in Corvus.Ui5ManifestBenchmark.Current.JsonArray.Source<TContext> value)
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeObjectItem.RepresentsTheTextWhichIsAssociatedWithTheLabel.OneOf2Entity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeObjectItem.RepresentsTheTextWhichIsAssociatedWithTheLabel.OneOf2Entity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    internal static void Create(
                        ...
                        in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source option = default,
                        in Corvus.Ui5ManifestBenchmark.Current.JsonArray.Source values = default)
                    {
                        option.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Option, ref builder);
                    ...
                    /// Creates an instance of a <see cref="OneOf2Entity"/>.
                    /// </summary>
                    public void Create(in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source option = default, in Corvus.Ui5ManifestBenchmark.Current.JsonArray.Source values = default)
                    {
                    ...
                    internal static void Create<TContext>(
                        ...
                        ref ComplexValueBuilder builder,
                        in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source option = default,
                        in Corvus.Ui5ManifestBenchmark.Current.JsonArray.Source<TContext> values = default)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                    {
                ...
                /// </summary>
                /// <param name="option">The value of the <c>"option"</c> property.</param>
                /// <param name="values">The value of the <c>"values"</c> property.</param>
                /// <returns>The source from which to build the value.</returns>
                public static Source Build(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source option = default, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonArray.Source values = default)
                {
                    return new Source(option, values);
                }
                ...
                /// <param name="values">The value of the <c>"values"</c> property.</param>
                /// <returns>The source from which to build the value.</returns>
                public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source option = default, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonArray.Source<TContext> values = default)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
                    return new Source<TContext>(context, option, values);
                }
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source option = default, in Corvus.Ui5ManifestBenchmark.Current.JsonArray.Source values = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source option = default, in Corvus.Ui5ManifestBenchmark.Current.JsonArray.Source<TContext> values = default, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
                ...
                public static ParsedJsonDocument<OneOf2Entity> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<OneOf2Entity>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<OneOf2Entity> Create<TContext>(
                ...
                public static ParsedJsonDocument<OneOf2Entity> Create(in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source option = default, in Corvus.Ui5ManifestBenchmark.Current.JsonArray.Source values = default, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
                public static ParsedJsonDocument<OneOf2Entity> Create<TContext>(in TContext context, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source option = default, in Corvus.Ui5ManifestBenchmark.Current.JsonArray.Source<TContext> values = default, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
