    ...
    public readonly partial struct ContentTypeObjectItem
    {
        ...
        public readonly partial struct RepresentsTheTextWhichIsAssociatedWithTheLabel
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Current.JsonString Option
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OptionUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString value))
                        {
                            return value;
                        }
                ...
                /// </summary>
                public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeObjectItem.RepresentsTheTextWhichIsAssociatedWithTheLabel.OneOf2Entity.ValuesArray Values
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ValuesUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeObjectItem.RepresentsTheTextWhichIsAssociatedWithTheLabel.OneOf2Entity.ValuesArray value))
                        {
                            return value;
                        }
