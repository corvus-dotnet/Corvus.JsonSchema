    ...
    public readonly partial struct ContentTypeObjectItem
    {
        ...
        public readonly partial struct RepresentsTheTextWhichIsAssociatedWithTheLabel
        {
...
#endif
            {
                ...
                /// </summary>
                public Corvus.Ui5ManifestBenchmark.Current.JsonArray Values
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ValuesUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonArray value))
                        {
                            return value;
                        }
                ...
                {
                    /// <summary>
                    /// Gets the pre-baked property name blob for <see cref="Option"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> Option => [0x85, 0x00, 0x00, 0x00, 0x22, 0x6F, 0x70, 0x74, 0x69, 0x6F, 0x6E, 0x22];
