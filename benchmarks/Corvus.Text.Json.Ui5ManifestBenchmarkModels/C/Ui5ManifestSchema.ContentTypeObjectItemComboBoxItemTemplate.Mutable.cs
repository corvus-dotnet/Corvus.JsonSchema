...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct ContentTypeObjectItemComboBoxItemTemplate
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ContentTypeObjectItemComboBoxItemTemplate instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ContentTypeObjectItemComboBoxItemTemplate"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ContentTypeObjectItemComboBoxItemTemplate(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ContentTypeObjectItemComboBoxItemTemplate.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly ContentTypeObjectItemComboBoxItemTemplate Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly ContentTypeObjectItemComboBoxItemTemplate Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ContentTypeObjectItemComboBoxItemTemplate>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeObjectItemComboBoxItemTemplate.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            public static implicit operator Source(ContentTypeObjectItemComboBoxItemTemplate instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeObjectItemComboBoxItemTemplate.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="ContentTypeObjectItemComboBoxItemTemplate"/>.
            /// </summary>
        ...
        {
            return workspace.CreateBuilder<ContentTypeObjectItemComboBoxItemTemplate, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ContentTypeObjectItemComboBoxItemTemplate> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ContentTypeObjectItemComboBoxItemTemplate>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ContentTypeObjectItemComboBoxItemTemplate> Create<TContext>(
        ...
        public static ParsedJsonDocument<ContentTypeObjectItemComboBoxItemTemplate> Create(in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source key = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source title = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
