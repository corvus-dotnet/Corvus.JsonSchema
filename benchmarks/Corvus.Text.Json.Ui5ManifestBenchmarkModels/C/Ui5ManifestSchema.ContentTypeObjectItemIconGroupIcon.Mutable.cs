...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct ContentTypeObjectItemIconGroupIcon
    {
        ...
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source alt = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source initials = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source src = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source text = default)
        {
