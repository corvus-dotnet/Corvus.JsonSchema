...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct ContentTypeObjectItemIconGroupIcon
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ContentTypeObjectItemIconGroupIcon instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ContentTypeObjectItemIconGroupIcon"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ContentTypeObjectItemIconGroupIcon(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ContentTypeObjectItemIconGroupIcon(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetInitials(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source value)
            {
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Initials, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ContentTypeObjectItemIconGroupIcon.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ContentTypeObjectItemIconGroupIcon"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ContentTypeObjectItemIconGroupIcon"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly ContentTypeObjectItemIconGroupIcon Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ContentTypeObjectItemIconGroupIcon>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ContentTypeObjectItemIconGroupIcon"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly ContentTypeObjectItemIconGroupIcon Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ContentTypeObjectItemIconGroupIcon>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeObjectItemIconGroupIcon.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            public static implicit operator Source(ContentTypeObjectItemIconGroupIcon instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeObjectItemIconGroupIcon.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="ContentTypeObjectItemIconGroupIcon"/>.
            /// </summary>
                ...
                in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source text = default)
            {
                ...
                initials.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Initials, ref builder);
            ...
            public void Create(
                ...
                in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source text = default)
            {
                Create(ref _builder, alt, initials, src, text);
            }
        ...
        /// </summary>
        /// <param name="alt">The value of the <c>"alt"</c> property.</param>
        /// <param name="initials">The value of the <c>"initials"</c> property.</param>
        /// <param name="src">The value of the <c>"src"</c> property.</param>
        /// <param name="text">The value of the <c>"text"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source alt = default, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source initials = default, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source src = default, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source text = default)
        {
            return new Source(alt, initials, src, text);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source alt = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source initials = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source src = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source text = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(alt, initials, src, text);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<ContentTypeObjectItemIconGroupIcon, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ContentTypeObjectItemIconGroupIcon> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ContentTypeObjectItemIconGroupIcon>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ContentTypeObjectItemIconGroupIcon> Create<TContext>(
        ...
        public static ParsedJsonDocument<ContentTypeObjectItemIconGroupIcon> Create(in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source alt = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source initials = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source src = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source text = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
