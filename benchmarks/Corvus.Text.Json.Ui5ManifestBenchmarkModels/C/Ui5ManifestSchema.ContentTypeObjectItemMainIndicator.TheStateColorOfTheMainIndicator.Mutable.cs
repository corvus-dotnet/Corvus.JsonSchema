        ...
        public readonly partial struct TheStateColorOfTheMainIndicator
        {
...
#endif
            {
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeObjectItemMainIndicator.TheStateColorOfTheMainIndicator.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeObjectItemMainIndicator.TheStateColorOfTheMainIndicator.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnumsValueColor.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public static ParsedJsonDocument<TheStateColorOfTheMainIndicator> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TheStateColorOfTheMainIndicator>();
                }
                finally
                {
