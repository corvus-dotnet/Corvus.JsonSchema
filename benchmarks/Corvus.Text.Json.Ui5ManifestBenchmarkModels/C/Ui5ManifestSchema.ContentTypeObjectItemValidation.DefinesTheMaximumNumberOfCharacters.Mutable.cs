    ...
    public readonly partial struct ContentTypeObjectItemValidation
    {
        ...
        public readonly partial struct DefinesTheMaximumNumberOfCharacters
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(DefinesTheMaximumNumberOfCharacters instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DefinesTheMaximumNumberOfCharacters"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DefinesTheMaximumNumberOfCharacters(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DefinesTheMaximumNumberOfCharacters.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly DefinesTheMaximumNumberOfCharacters Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly DefinesTheMaximumNumberOfCharacters Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DefinesTheMaximumNumberOfCharacters>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeObjectItemValidation.DefinesTheMaximumNumberOfCharacters.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeObjectItemValidation.DefinesTheMaximumNumberOfCharacters.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(DefinesTheMaximumNumberOfCharacters instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<DefinesTheMaximumNumberOfCharacters, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<DefinesTheMaximumNumberOfCharacters> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<DefinesTheMaximumNumberOfCharacters>();
                }
                finally
                {
