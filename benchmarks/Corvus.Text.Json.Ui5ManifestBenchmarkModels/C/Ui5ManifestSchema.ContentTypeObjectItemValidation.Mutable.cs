    ...
    public readonly partial struct ContentTypeObjectItemValidation
    {
...
#endif
        {
            ...
            public void SetRestrictToPredefinedOptions(scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeObjectItemValidation.DefinesWhetherTheValueIsRestrictedToPredefinedOptions.Source value)
            {
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.RestrictToPredefinedOptions, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            public void SetValidate(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source value)
            {
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Validate, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
        ...
        public ref struct Builder
        {
                ...
                in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source validate = default)
            {
                ...
                restrictToPredefinedOptions.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.RestrictToPredefinedOptions, ref builder);
                type.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Type, ref builder);
                validate.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Validate, ref builder);
            }
        ...
        public static ParsedJsonDocument<ContentTypeObjectItemValidation> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ContentTypeObjectItemValidation>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ContentTypeObjectItemValidation> Create<TContext>(
        ...
        public static ParsedJsonDocument<ContentTypeObjectItemValidation> Create(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeObjectItemValidation.DefinesTheMaximumNumberOfCharacters.Source maxLength = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source message = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeObjectItemValidation.DefinesTheMinimumNumberOfCharacters.Source minLength = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source pattern = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeObjectItemValidation.DefinesWhetherTheUserInputIsRequired.Source required = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeObjectItemValidation.DefinesWhetherTheValueIsRestrictedToPredefinedOptions.Source restrictToPredefinedOptions = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeObjectItemValidation.DefinesTheValidationType.Source type = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source validate = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
