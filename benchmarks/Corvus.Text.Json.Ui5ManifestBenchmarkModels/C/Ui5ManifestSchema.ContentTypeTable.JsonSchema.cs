...
public readonly partial struct Ui5ManifestSchema
{
        ...
        : IJsonElement<ContentTypeTable>
    {
        public static partial class JsonSchema
        {
            ...
            private static void MatchGroupValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
            ...
            private static void MatchRow(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
