...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct ContentTypeTable
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ContentTypeTable instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ContentTypeTable"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ContentTypeTable(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Group.Mutable GroupValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.GroupValueUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Group.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeTable.RepresentsNumberOfItems.Mutable MaxItems
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MaxItemsUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeTable.RepresentsNumberOfItems.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeTable.RepresentsTheMinimumExpectedNumberOfItems.Mutable MinItems
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MinItemsUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeTable.RepresentsTheMinimumExpectedNumberOfItems.Mutable value))
                    {
                        return value;
                    }
            ...
            /// <summary>
            /// Gets the (optional) <c>row</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeTable.TheTemplateForAllRows.Mutable Row
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RowUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeTable.TheTemplateForAllRows.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ContentTypeTable(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetGroupValue(scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Group.Source value)
            {
                ...
                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.GroupValueUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.GroupValueUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.GroupValue, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetGroupValue<TContext>(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Group.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
            ...
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveGroupValue()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.GroupValueUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            public void SetRow(scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeTable.TheTemplateForAllRows.Source value)
            {
                ...
                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.RowUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RowUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Row, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetRow<TContext>(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeTable.TheTemplateForAllRows.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
            ...
            /// <summary>
            /// Remove the <c>row</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveRow()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.RowUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ContentTypeTable.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ContentTypeTable"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ContentTypeTable"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly ContentTypeTable Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ContentTypeTable>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ContentTypeTable"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly ContentTypeTable Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ContentTypeTable>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Group.Source _createArg2;
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeTable.RepresentsNumberOfItems.Source _createArg3;
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeTable.RepresentsTheMinimumExpectedNumberOfItems.Source _createArg4;
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeTable.TheTemplateForAllRows.Source _createArg5;
            ...
            public static implicit operator Source(ContentTypeTable instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Group.Source<TContext> _createArg2;
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeTable.RepresentsNumberOfItems.Source _createArg3;
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeTable.RepresentsTheMinimumExpectedNumberOfItems.Source _createArg4;
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeTable.TheTemplateForAllRows.Source<TContext> _createArg5;
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="ContentTypeTable"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Data.Source data = default,
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Group.Source group = default,
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeTable.RepresentsNumberOfItems.Source maxItems = default,
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeTable.RepresentsTheMinimumExpectedNumberOfItems.Source minItems = default,
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeTable.TheTemplateForAllRows.Source row = default)
            {
                data.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.DataValue, ref builder);
                group.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.GroupValue, ref builder);
                ...
                row.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Row, ref builder);
            }
            ...
            public void Create(
                ...
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeTable.TheTemplateForAllRows.Source row = default)
            {
                Create(ref _builder, data, group, maxItems, minItems, row);
            }
            ...
            internal static void Create<TContext>(
                ...
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Group.Source<TContext> group = default,
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeTable.RepresentsNumberOfItems.Source maxItems = default,
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeTable.RepresentsTheMinimumExpectedNumberOfItems.Source minItems = default,
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeTable.TheTemplateForAllRows.Source<TContext> row = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            #endif
            {
                Create(context, ref _builder, data, group, maxItems, minItems, row);
            }
        ...
        /// <param name="group">The value of the <c>"group"</c> property.</param>
        ...
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Data.Source<TContext> data = default, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Group.Source<TContext> group = default, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeTable.RepresentsNumberOfItems.Source maxItems = default, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeTable.RepresentsTheMinimumExpectedNumberOfItems.Source minItems = default, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeTable.TheTemplateForAllRows.Source<TContext> row = default)
            ...
            #endif
        {
            return new Source<TContext>(context, data, group, maxItems, minItems, row);
        }
        ...
        /// <param name="row">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Data.Source data = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Group.Source group = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeTable.RepresentsNumberOfItems.Source maxItems = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeTable.RepresentsTheMinimumExpectedNumberOfItems.Source minItems = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeTable.TheTemplateForAllRows.Source row = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(data, group, maxItems, minItems, row);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Data.Source<TContext> data = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Group.Source<TContext> group = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeTable.RepresentsNumberOfItems.Source maxItems = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeTable.RepresentsTheMinimumExpectedNumberOfItems.Source minItems = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeTable.TheTemplateForAllRows.Source<TContext> row = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            ...
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(context, data, group, maxItems, minItems, row);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<ContentTypeTable, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ContentTypeTable> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ContentTypeTable>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ContentTypeTable> Create<TContext>(
        ...
        public static ParsedJsonDocument<ContentTypeTable> Create(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Data.Source data = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Group.Source group = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeTable.RepresentsNumberOfItems.Source maxItems = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeTable.RepresentsTheMinimumExpectedNumberOfItems.Source minItems = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeTable.TheTemplateForAllRows.Source row = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ContentTypeTable> Create<TContext>(in TContext context, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Data.Source<TContext> data = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Group.Source<TContext> group = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeTable.RepresentsNumberOfItems.Source maxItems = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeTable.RepresentsTheMinimumExpectedNumberOfItems.Source minItems = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeTable.TheTemplateForAllRows.Source<TContext> row = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
