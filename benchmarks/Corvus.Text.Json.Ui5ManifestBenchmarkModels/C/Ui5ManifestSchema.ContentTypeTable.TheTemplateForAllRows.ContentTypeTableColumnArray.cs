    ...
    public readonly partial struct ContentTypeTable
    {
        ...
        public readonly partial struct TheTemplateForAllRows
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="ContentTypeTableColumnArray"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal ContentTypeTableColumnArray(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static ContentTypeTableColumnArray DefaultInstance { get; }
                ...
                public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeTableColumn this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeTableColumn>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeTableColumn> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeTableColumn>(_parent, _idx);
                }
                ...
                /// </returns>
                public static bool operator ==(in ContentTypeTableColumnArray left, in ContentTypeTableColumnArray right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in ContentTypeTableColumnArray left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(ContentTypeTableColumnArray instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ContentTypeTableColumnArray(JsonElement instance)
                {
                    return ContentTypeTableColumnArray.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ContentTypeTableColumnArray From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ContentTypeTableColumnArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ContentTypeTableColumnArray>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ContentTypeTableColumnArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ContentTypeTableColumnArray>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ContentTypeTableColumnArray ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ContentTypeTableColumnArray>(json, options);
                }
                ...
                /// </exception>
                public static ContentTypeTableColumnArray ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<ContentTypeTableColumnArray>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out ContentTypeTableColumnArray? result)
                {
                    return JsonElementHelpers.TryParseValue<ContentTypeTableColumnArray>(ref reader, out result);
                }
...
#if NET
                static ContentTypeTableColumnArray IJsonElement<ContentTypeTableColumnArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ContentTypeTableColumnArray: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public ContentTypeTableColumnArray Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public ContentTypeTableColumnArray Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<ContentTypeTableColumnArray>(_idx);
                    }
