        ...
        public readonly partial struct TheTemplateForAllRows
        {
            ...
            public readonly partial struct TheHighlightStateOfTheRow
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(TheHighlightStateOfTheRow instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="TheHighlightStateOfTheRow"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator TheHighlightStateOfTheRow(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"TheHighlightStateOfTheRow.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly TheHighlightStateOfTheRow Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly TheHighlightStateOfTheRow Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<TheHighlightStateOfTheRow>(_idx);
                    }
                    ...
                    public TResult Match<TContext, TResult>(
                        ...
                        Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeTable.TheTemplateForAllRows.TheHighlightStateOfTheRow.Mutable, TContext, TResult> defaultMatch)
                    ...
                    public TResult Match<TResult>(
                        ...
                        Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeTable.TheTemplateForAllRows.TheHighlightStateOfTheRow.Mutable, TResult> defaultMatch)
                    {
                        if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.State.JsonSchema.Evaluate(_parent, _idx))
                        {
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(TheHighlightStateOfTheRow instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<TheHighlightStateOfTheRow, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<TheHighlightStateOfTheRow> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<TheHighlightStateOfTheRow>();
                    }
                    finally
                    {
