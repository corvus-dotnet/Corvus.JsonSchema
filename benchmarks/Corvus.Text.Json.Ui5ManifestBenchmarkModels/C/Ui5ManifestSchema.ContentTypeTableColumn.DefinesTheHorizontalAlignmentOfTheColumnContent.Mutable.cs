    ...
    public readonly partial struct ContentTypeTableColumn
    {
        ...
        public readonly partial struct DefinesTheHorizontalAlignmentOfTheColumnContent
        {
...
#endif
            {
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.TextAlign" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsTextAlign(out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.TextAlign result)
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.TextAlign.JsonSchema.Evaluate(_parent, _idx))
                    {
