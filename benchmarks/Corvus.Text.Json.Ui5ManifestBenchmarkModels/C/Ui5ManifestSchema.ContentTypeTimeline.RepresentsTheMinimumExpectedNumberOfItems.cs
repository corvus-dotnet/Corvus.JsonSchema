    ...
    public readonly partial struct ContentTypeTimeline
    {
...
#endif
        {
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeTimeline.RepresentsTheMinimumExpectedNumberOfItems, TContext, TResult> defaultMatch)
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeTimeline.RepresentsTheMinimumExpectedNumberOfItems, TResult> defaultMatch)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                {
