...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct ContentTypeTimelineItem
    {
        ...
        public readonly partial struct TheOwnerImageOfTheTimelineItem
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(TheOwnerImageOfTheTimelineItem instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TheOwnerImageOfTheTimelineItem"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TheOwnerImageOfTheTimelineItem(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new TheOwnerImageOfTheTimelineItem(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TheOwnerImageOfTheTimelineItem.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="TheOwnerImageOfTheTimelineItem"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="TheOwnerImageOfTheTimelineItem"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly TheOwnerImageOfTheTimelineItem Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<TheOwnerImageOfTheTimelineItem>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="TheOwnerImageOfTheTimelineItem"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly TheOwnerImageOfTheTimelineItem Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TheOwnerImageOfTheTimelineItem>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeTimelineItem.TheOwnerImageOfTheTimelineItem.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                public static implicit operator Source(TheOwnerImageOfTheTimelineItem instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeTimelineItem.TheOwnerImageOfTheTimelineItem.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="TheOwnerImageOfTheTimelineItem"/>.
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source value = default)
                {
                ...
                /// Creates an instance of a <see cref="TheOwnerImageOfTheTimelineItem"/>.
                /// </summary>
                public void Create(in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source value = default)
                {
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source value = default)
            {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source value = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            {
                return workspace.CreateBuilder<TheOwnerImageOfTheTimelineItem, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<TheOwnerImageOfTheTimelineItem> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TheOwnerImageOfTheTimelineItem>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<TheOwnerImageOfTheTimelineItem> Create<TContext>(
            ...
            public static ParsedJsonDocument<TheOwnerImageOfTheTimelineItem> Create(in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source value = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
