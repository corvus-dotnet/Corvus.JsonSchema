...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct ContentTypeWebPage
#if NET8_0_OR_GREATER
        : IJsonElement<ContentTypeWebPage>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ContentTypeWebPage"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ContentTypeWebPage(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ContentTypeWebPage DefaultInstance { get; }
        ...
        /// <summary>
        /// Gets the (optional) <c>sandbox</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.JsonString Sandbox
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SandboxUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in ContentTypeWebPage left, in ContentTypeWebPage right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ContentTypeWebPage left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(ContentTypeWebPage instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ContentTypeWebPage(JsonElement instance)
        {
            return ContentTypeWebPage.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ContentTypeWebPage From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ContentTypeWebPage ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ContentTypeWebPage>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ContentTypeWebPage ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ContentTypeWebPage>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ContentTypeWebPage ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ContentTypeWebPage>(json, options);
        }
        ...
        /// </exception>
        public static ContentTypeWebPage ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ContentTypeWebPage>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ContentTypeWebPage? result)
        {
            return JsonElementHelpers.TryParseValue<ContentTypeWebPage>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ContentTypeWebPage(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static ContentTypeWebPage IJsonElement<ContentTypeWebPage>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ContentTypeWebPage: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ContentTypeWebPage"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ContentTypeWebPage"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public ContentTypeWebPage Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ContentTypeWebPage>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ContentTypeWebPage"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public ContentTypeWebPage Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ContentTypeWebPage>(_idx);
            }
        ...
        public static class JsonPropertyNames
        {
            ...
            /// <summary>
            /// Gets the JSON property name for <see cref="Sandbox"/>.
            /// </summary>
            ...
            /// Gets the JSON property name for <see cref="Sandbox"/>.
            /// </summary>
            public static ReadOnlySpan<byte> SandboxUtf8 => "sandbox"u8;
        ...
        private static class JsonPropertyNamesEscaped
        {
            ...
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="Sandbox"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Sandbox => "sandbox"u8;
        ...
        private static class JsonPropertyNamesPrebaked
        {
            ...
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="Sandbox"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Sandbox => [0x95, 0x00, 0x00, 0x00, 0x22, 0x73, 0x61, 0x6E, 0x64, 0x62, 0x6F, 0x78, 0x22];
