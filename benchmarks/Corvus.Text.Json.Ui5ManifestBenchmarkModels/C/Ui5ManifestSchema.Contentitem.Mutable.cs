    ...
    public readonly partial struct Contentitem
    {
...
#endif
        {
            ...
            public void SetManifest(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Contentitem.WrapsTheChildManifest.Source value)
            {
                ...
                {
                    // We are going to insert the new value
                    value.AddAsProperty(JsonPropertyNamesEscaped.Manifest, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
        ...
        public ref struct Builder
        {
                ...
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Contentitem.WrapsTheChildManifest.Source manifest = default)
            {
                ...
                manifest.AddAsProperty(JsonPropertyNamesEscaped.Manifest, ref builder, escapeName: false);
            }
