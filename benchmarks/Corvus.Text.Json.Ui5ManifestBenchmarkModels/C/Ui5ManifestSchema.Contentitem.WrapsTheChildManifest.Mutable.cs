...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct Contentitem
    {
        ...
        public readonly partial struct WrapsTheChildManifest
        {
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(in Corvus.Ui5ManifestBenchmark.Current.JsonObject.Source sapArtifact = default)
            {
            ...
            /// <param name="sapArtifact">The value of the <c>"sap.artifact"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.Ui5ManifestBenchmark.Current.JsonObject.Source<TContext> sapArtifact = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
