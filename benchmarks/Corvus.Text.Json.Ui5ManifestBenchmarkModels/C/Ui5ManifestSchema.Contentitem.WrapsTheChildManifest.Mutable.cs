    ...
    public readonly partial struct Contentitem
    {
        ...
        public readonly partial struct WrapsTheChildManifest
        {
...
#endif
            {
                ...
                public void SetSapArtifact(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonObject.Source value)
                {
                    CheckValidInstance();
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Contentitem.WrapsTheChildManifest.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Contentitem.WrapsTheChildManifest.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            /// </summary>
            /// <param name="sapArtifact">The value of the <c>"sap.artifact"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonObject.Source sapArtifact = default)
            {
                return new Source(sapArtifact);
            }
            ...
            /// <param name="sapArtifact">The value of the <c>"sap.artifact"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonObject.Source<TContext> sapArtifact = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                return new Source<TContext>(context, sapArtifact);
            }
            ...
            public static ParsedJsonDocument<WrapsTheChildManifest> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<WrapsTheChildManifest>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<WrapsTheChildManifest> Create<TContext>(
            ...
            public static ParsedJsonDocument<WrapsTheChildManifest> Create(in Corvus.Ui5ManifestBenchmark.Current.JsonObject.Source sapArtifact = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
            public static ParsedJsonDocument<WrapsTheChildManifest> Create<TContext>(in TContext context, in Corvus.Ui5ManifestBenchmark.Current.JsonObject.Source<TContext> sapArtifact = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
