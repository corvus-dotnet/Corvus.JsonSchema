...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct Contentitem
    {
        ...
        public readonly partial struct WrapsTheChildManifest
        {
            ...
            public readonly partial struct TheArtifactsManifest
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(TheArtifactsManifest instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="TheArtifactsManifest"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator TheArtifactsManifest(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new TheArtifactsManifest(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"TheArtifactsManifest.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="TheArtifactsManifest"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="TheArtifactsManifest"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly TheArtifactsManifest Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<TheArtifactsManifest>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="TheArtifactsManifest"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly TheArtifactsManifest Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<TheArtifactsManifest>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Contentitem.WrapsTheChildManifest.TheArtifactsManifest.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(TheArtifactsManifest instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Contentitem.WrapsTheChildManifest.TheArtifactsManifest.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                {
                    return workspace.CreateBuilder<TheArtifactsManifest, Mutable>(this);
                }
            }
        }
    }
