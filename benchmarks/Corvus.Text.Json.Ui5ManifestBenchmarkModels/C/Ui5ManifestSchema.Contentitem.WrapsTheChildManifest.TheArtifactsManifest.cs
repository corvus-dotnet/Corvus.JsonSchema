    ...
    public readonly partial struct Contentitem
    {
        ...
        public readonly partial struct WrapsTheChildManifest
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="TheArtifactsManifest"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal TheArtifactsManifest(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static TheArtifactsManifest DefaultInstance { get; }
                ...
                /// </returns>
                public static bool operator ==(in TheArtifactsManifest left, in TheArtifactsManifest right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in TheArtifactsManifest left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(TheArtifactsManifest instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TheArtifactsManifest(JsonElement instance)
                {
                    return TheArtifactsManifest.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheArtifactsManifest From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheArtifactsManifest ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TheArtifactsManifest>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheArtifactsManifest ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TheArtifactsManifest>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheArtifactsManifest ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TheArtifactsManifest>(json, options);
                }
                ...
                /// </exception>
                public static TheArtifactsManifest ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<TheArtifactsManifest>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out TheArtifactsManifest? result)
                {
                    return JsonElementHelpers.TryParseValue<TheArtifactsManifest>(ref reader, out result);
                }
...
#if NET
                static TheArtifactsManifest IJsonElement<TheArtifactsManifest>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TheArtifactsManifest: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public TheArtifactsManifest Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public TheArtifactsManifest Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<TheArtifactsManifest>(_idx);
                    }
