...
public readonly partial struct Ui5ManifestSchema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.JsonString BaseUrl
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BaseUrlUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Contentitem.WrapsTheChildManifest Manifest
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ManifestUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Contentitem.WrapsTheChildManifest value))
                {
                    return value;
                }
        ...
        private static class JsonPropertyNamesPrebaked
        {
            ...
            /// </summary>
            public static ReadOnlySpan<byte> BaseUrl => [0x95, 0x00, 0x00, 0x00, 0x22, 0x62, 0x61, 0x73, 0x65, 0x55, 0x52, 0x4C, 0x22];

            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="Manifest"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Manifest => [0xA5, 0x00, 0x00, 0x00, 0x22, 0x6D, 0x61, 0x6E, 0x69, 0x66, 0x65, 0x73, 0x74, 0x22];
        }
    }
}
