...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct CustomActionsSetting
    {
        ...
        public readonly partial struct NameOfThePressHandlerForExtendedActionsInQuickView
        {
            ...
            public static ParsedJsonDocument<NameOfThePressHandlerForExtendedActionsInQuickView> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<NameOfThePressHandlerForExtendedActionsInQuickView>();
                }
                finally
                {
