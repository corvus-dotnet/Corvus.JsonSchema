...
public readonly partial struct Ui5ManifestSchema
{
    ...
    /// </para>
    /// </remarks>
    public readonly partial struct CustomActionsSetting
    {
        /// <summary>
        /// Generated from JSON Schema.
        /// </summary>
        ...
        public readonly partial struct NameOfThePressHandlerForExtendedActionsInQuickView
#if NET8_0_OR_GREATER
            : IJsonElement<NameOfThePressHandlerForExtendedActionsInQuickView>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="NameOfThePressHandlerForExtendedActionsInQuickView"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal NameOfThePressHandlerForExtendedActionsInQuickView(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static NameOfThePressHandlerForExtendedActionsInQuickView DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(NameOfThePressHandlerForExtendedActionsInQuickView value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in NameOfThePressHandlerForExtendedActionsInQuickView left, in NameOfThePressHandlerForExtendedActionsInQuickView right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in NameOfThePressHandlerForExtendedActionsInQuickView left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(NameOfThePressHandlerForExtendedActionsInQuickView instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator NameOfThePressHandlerForExtendedActionsInQuickView(JsonElement instance)
            {
                return NameOfThePressHandlerForExtendedActionsInQuickView.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NameOfThePressHandlerForExtendedActionsInQuickView From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NameOfThePressHandlerForExtendedActionsInQuickView ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<NameOfThePressHandlerForExtendedActionsInQuickView>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NameOfThePressHandlerForExtendedActionsInQuickView ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<NameOfThePressHandlerForExtendedActionsInQuickView>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static NameOfThePressHandlerForExtendedActionsInQuickView ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<NameOfThePressHandlerForExtendedActionsInQuickView>(json, options);
            }
            ...
            /// </exception>
            public static NameOfThePressHandlerForExtendedActionsInQuickView ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<NameOfThePressHandlerForExtendedActionsInQuickView>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out NameOfThePressHandlerForExtendedActionsInQuickView? result)
            {
                return JsonElementHelpers.TryParseValue<NameOfThePressHandlerForExtendedActionsInQuickView>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new NameOfThePressHandlerForExtendedActionsInQuickView(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static NameOfThePressHandlerForExtendedActionsInQuickView IJsonElement<NameOfThePressHandlerForExtendedActionsInQuickView>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"NameOfThePressHandlerForExtendedActionsInQuickView: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="NameOfThePressHandlerForExtendedActionsInQuickView"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="NameOfThePressHandlerForExtendedActionsInQuickView"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public NameOfThePressHandlerForExtendedActionsInQuickView Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<NameOfThePressHandlerForExtendedActionsInQuickView>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="NameOfThePressHandlerForExtendedActionsInQuickView"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public NameOfThePressHandlerForExtendedActionsInQuickView Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<NameOfThePressHandlerForExtendedActionsInQuickView>(_idx);
                }
