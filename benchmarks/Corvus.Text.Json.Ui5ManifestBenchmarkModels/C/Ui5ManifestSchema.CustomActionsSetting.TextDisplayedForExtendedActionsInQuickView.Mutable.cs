    ...
    public readonly partial struct CustomActionsSetting
    {
        ...
        public readonly partial struct TextDisplayedForExtendedActionsInQuickView
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(TextDisplayedForExtendedActionsInQuickView instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TextDisplayedForExtendedActionsInQuickView"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TextDisplayedForExtendedActionsInQuickView(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TextDisplayedForExtendedActionsInQuickView.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly TextDisplayedForExtendedActionsInQuickView Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly TextDisplayedForExtendedActionsInQuickView Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TextDisplayedForExtendedActionsInQuickView>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(TextDisplayedForExtendedActionsInQuickView instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<TextDisplayedForExtendedActionsInQuickView, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<TextDisplayedForExtendedActionsInQuickView> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TextDisplayedForExtendedActionsInQuickView>();
                }
                finally
                {
