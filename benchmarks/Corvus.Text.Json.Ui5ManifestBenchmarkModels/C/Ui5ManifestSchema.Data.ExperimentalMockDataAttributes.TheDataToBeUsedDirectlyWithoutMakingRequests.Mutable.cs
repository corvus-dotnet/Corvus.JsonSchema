        ...
        public readonly partial struct ExperimentalMockDataAttributes
        {
            ...
            public readonly partial struct TheDataToBeUsedDirectlyWithoutMakingRequests
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(TheDataToBeUsedDirectlyWithoutMakingRequests instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="TheDataToBeUsedDirectlyWithoutMakingRequests"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator TheDataToBeUsedDirectlyWithoutMakingRequests(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"TheDataToBeUsedDirectlyWithoutMakingRequests.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    /// <summary>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly TheDataToBeUsedDirectlyWithoutMakingRequests Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly TheDataToBeUsedDirectlyWithoutMakingRequests Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<TheDataToBeUsedDirectlyWithoutMakingRequests>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Data.ExperimentalMockDataAttributes.TheDataToBeUsedDirectlyWithoutMakingRequests.ObjectBuilder.Build value) {_objectBuilder = value; _kind = Kind.ObjectBuilder; }

                    internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Data.ExperimentalMockDataAttributes.TheDataToBeUsedDirectlyWithoutMakingRequests.ArrayBuilder.Build value) {_arrayBuilder = value; _kind = Kind.ArrayBuilder; }

                    public static implicit operator Source(TheDataToBeUsedDirectlyWithoutMakingRequests instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Data.ExperimentalMockDataAttributes.TheDataToBeUsedDirectlyWithoutMakingRequests.ObjectBuilder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.ObjectBuilder; }

                    internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Data.ExperimentalMockDataAttributes.TheDataToBeUsedDirectlyWithoutMakingRequests.ArrayBuilder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.ArrayBuilder; }
                ...
                {
                    return workspace.CreateBuilder<TheDataToBeUsedDirectlyWithoutMakingRequests, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<TheDataToBeUsedDirectlyWithoutMakingRequests> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<TheDataToBeUsedDirectlyWithoutMakingRequests>();
                    }
                    finally
                    {
                ...
                public static ParsedJsonDocument<TheDataToBeUsedDirectlyWithoutMakingRequests> CreateArray(
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>An empty <see cref="ParsedJsonDocument{T}"/>. The caller must dispose it.</returns>
                public static ParsedJsonDocument<TheDataToBeUsedDirectlyWithoutMakingRequests> CreateObject(
                    int initialCapacity = 30, int initialValueBufferSize = 8192)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent(initialValueBufferSize);
                    try
