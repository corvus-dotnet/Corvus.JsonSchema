    ...
    public readonly partial struct Data
    {
        ...
        public readonly partial struct ThePathFromTheJsonToBeUsedAsRoot
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ThePathFromTheJsonToBeUsedAsRoot, Mutable>(ThePathFromTheJsonToBeUsedAsRoot.DefaultInstance);
                ...
                public static explicit operator Mutable(ThePathFromTheJsonToBeUsedAsRoot instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ThePathFromTheJsonToBeUsedAsRoot"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ThePathFromTheJsonToBeUsedAsRoot(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ThePathFromTheJsonToBeUsedAsRoot.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ThePathFromTheJsonToBeUsedAsRoot Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ThePathFromTheJsonToBeUsedAsRoot Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ThePathFromTheJsonToBeUsedAsRoot>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ThePathFromTheJsonToBeUsedAsRoot instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ThePathFromTheJsonToBeUsedAsRoot, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ThePathFromTheJsonToBeUsedAsRoot> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ThePathFromTheJsonToBeUsedAsRoot>();
                }
                finally
                {
