...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct DataSource
#if NET8_0_OR_GREATER
        : IJsonElement<DataSource>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        internal DataSource(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static DataSource DefaultInstance { get; }
        ...
        /// <summary>
        /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSourceEnum"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSourceEnum(DataSource value)
        {
            return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSourceEnum.From(value);
        }

        /// <summary>
        /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSourceEnum"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator DataSource(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSourceEnum value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSourceCustom(DataSource value)
        {
            return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSourceCustom.From(value);
        }

        /// <summary>
        /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSourceCustom"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        ...
        /// </returns>
        public static bool operator ==(in DataSource left, in DataSource right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in DataSource left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(DataSource instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator DataSource(JsonElement instance)
        {
            return DataSource.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DataSource From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DataSource ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<DataSource>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DataSource ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<DataSource>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DataSource ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<DataSource>(json, options);
        }
        ...
        /// </exception>
        public static DataSource ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<DataSource>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out DataSource? result)
        {
            return JsonElementHelpers.TryParseValue<DataSource>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new DataSource(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static DataSource IJsonElement<DataSource>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"DataSource: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="DataSource"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="DataSource"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        {
            CheckValidInstance();
            return _parent.CloneElement<DataSource>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="DataSource"/> that lives for the lifetime of its
        ...
        public bool TryGetAsDataSourceCustom(out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSourceCustom result)
        {
            ...
            {
                result = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSourceCustom.From(this);
                return true;
            }
        ...
        public bool TryGetAsDataSourceEnum(out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSourceEnum result)
        {
            ...
            {
                result = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSourceEnum.From(this);
                return true;
            }
        ...
        /// <param name="matchDataSourceEnum">Match a <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSourceEnum"/>.</param>
        /// <param name="matchDataSourceCustom">Match a <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSourceCustom"/>.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSourceEnum, TContext, TResult> matchDataSourceEnum,
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSourceCustom, TContext, TResult> matchDataSourceCustom,
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSource, TContext, TResult> defaultMatch)
...
#endif
        {
            if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSourceEnum.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchDataSourceEnum(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSourceEnum.From(this), context);
            }

            if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSourceCustom.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchDataSourceCustom(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSourceCustom.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSourceEnum, TResult> matchDataSourceEnum,
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSourceCustom, TResult> matchDataSourceCustom,
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSource, TResult> defaultMatch)
        {
            if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSourceEnum.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchDataSourceEnum(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSourceEnum.From(this));
            }

            if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSourceCustom.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchDataSourceCustom(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSourceCustom.From(this));
            }
