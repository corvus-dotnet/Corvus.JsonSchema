        ...
        public readonly partial struct TypeEntity
        {
            ...
            public readonly partial struct NotEntity
            {
...
#endif
                {
                    ...
                    /// <param name="matchOData">Match 1st item.</param>
                    /// <param name="matchODataAnnotation">Match 2nd item.</param>
                    /// <param name="matchIna">Match 3rd item.</param>
                    /// <param name="matchXml">Match 4th item.</param>
                    /// <param name="matchJson">Match 5th item.</param>
                    /// <param name="matchFhir">Match 6th item.</param>
                    /// <param name="matchWebSocket">Match 7th item.</param>
                    /// <param name="matchHttp">Match 8th item.</param>
                    /// <param name="defaultMatch">Match any other value.</param>
                    /// <returns>An instance of the value returned by the match function.</returns>
                    public TResult Match<TContext, TResult>(
                        in TContext context,
                        Func<TContext, TResult> matchOData,
                        Func<TContext, TResult> matchODataAnnotation,
                        Func<TContext, TResult> matchIna,
                        Func<TContext, TResult> matchXml,
                        Func<TContext, TResult> matchJson,
                        Func<TContext, TResult> matchFhir,
                        Func<TContext, TResult> matchWebSocket,
                        Func<TContext, TResult> matchHttp,
...
#endif
                    {
                        ...
                        {
                            return matchOData(context);
                        }

                        if (this.ValueEquals(Constants.Enum2))
                        {
                            return matchODataAnnotation(context);
                        }

                        if (this.ValueEquals(Constants.Enum3))
                        {
                            return matchIna(context);
                        }
                        ...
                        {
                            return matchFhir(context);
                        }

                        if (this.ValueEquals(Constants.Enum7))
                        {
                            return matchWebSocket(context);
                        }
                    ...
                    public TResult Match<TResult>(
                        Func<TResult> matchOData,
                        Func<TResult> matchODataAnnotation,
                        Func<TResult> matchIna,
                        Func<TResult> matchXml,
                        Func<TResult> matchJson,
                        Func<TResult> matchFhir,
                        Func<TResult> matchWebSocket,
                        Func<TResult> matchHttp,
