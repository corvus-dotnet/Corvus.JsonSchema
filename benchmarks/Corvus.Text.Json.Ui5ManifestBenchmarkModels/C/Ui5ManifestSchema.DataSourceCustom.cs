...
public readonly partial struct Ui5ManifestSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DataSourceCustom"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal DataSourceCustom(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static DataSourceCustom DefaultInstance { get; }

        /// <summary>
        /// Gets the <c>customType</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSourceCustom.CustomTypeEntity CustomType
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CustomTypeUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSourceCustom.CustomTypeEntity value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSourceCustom.TypeEntity Type
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSourceCustom.TypeEntity value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in DataSourceCustom left, in DataSourceCustom right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in DataSourceCustom left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(DataSourceCustom instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator DataSourceCustom(JsonElement instance)
        {
            return DataSourceCustom.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DataSourceCustom From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DataSourceCustom ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<DataSourceCustom>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DataSourceCustom ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<DataSourceCustom>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DataSourceCustom ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<DataSourceCustom>(json, options);
        }
        ...
        /// </exception>
        public static DataSourceCustom ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<DataSourceCustom>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out DataSourceCustom? result)
        {
            return JsonElementHelpers.TryParseValue<DataSourceCustom>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new DataSourceCustom(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static DataSourceCustom IJsonElement<DataSourceCustom>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"DataSourceCustom: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="DataSourceCustom"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="DataSourceCustom"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public DataSourceCustom Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<DataSourceCustom>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="DataSourceCustom"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public DataSourceCustom Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<DataSourceCustom>(_idx);
            }
