...
public readonly partial struct Ui5ManifestSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DataSourceEnum"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal DataSourceEnum(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static DataSourceEnum DefaultInstance { get; }

        /// <summary>
        /// Gets the (optional) <c>customType</c> property.
        /// </summary>
        public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSourceEnum.CustomTypeEntity CustomType
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CustomTypeUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSourceEnum.CustomTypeEntity value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting Settings
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SettingsUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSourceEnum.TypeEntity Type
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSourceEnum.TypeEntity value))
                {
                    return value;
                }

                return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSourceEnum.TypeEntity.DefaultInstance;
            }
        }
        ...
        /// </returns>
        public static bool operator ==(in DataSourceEnum left, in DataSourceEnum right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in DataSourceEnum left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(DataSourceEnum instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator DataSourceEnum(JsonElement instance)
        {
            return DataSourceEnum.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DataSourceEnum From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DataSourceEnum ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<DataSourceEnum>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DataSourceEnum ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<DataSourceEnum>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DataSourceEnum ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<DataSourceEnum>(json, options);
        }
        ...
        /// </exception>
        public static DataSourceEnum ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<DataSourceEnum>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out DataSourceEnum? result)
        {
            return JsonElementHelpers.TryParseValue<DataSourceEnum>(ref reader, out result);
        }
...
#if NET
        static DataSourceEnum IJsonElement<DataSourceEnum>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"DataSourceEnum: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public DataSourceEnum Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<DataSourceEnum>(_idx);
            }
        ...
        {
            /// <summary>
            /// Gets the JSON property name for <see cref="CustomType"/>.
            /// </summary>
            ...
            /// Gets the JSON property name for <see cref="CustomType"/>.
            /// </summary>
            public static ReadOnlySpan<byte> CustomTypeUtf8 => "customType"u8;
        ...
        {
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="CustomType"/>.
            /// </summary>
            public static ReadOnlySpan<byte> CustomType => "customType"u8;
        ...
        {
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="CustomType"/>.
            /// </summary>
            public static ReadOnlySpan<byte> CustomType => [0xC5, 0x00, 0x00, 0x00, 0x22, 0x63, 0x75, 0x73, 0x74, 0x6F, 0x6D, 0x54, 0x79, 0x70, 0x65, 0x22];
