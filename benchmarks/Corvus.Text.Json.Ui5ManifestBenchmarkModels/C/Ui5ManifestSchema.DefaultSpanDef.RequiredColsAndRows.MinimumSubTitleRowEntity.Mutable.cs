        ...
        public readonly partial struct RequiredColsAndRows
        {
            ...
            public readonly partial struct MinimumSubTitleRowEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<MinimumSubTitleRowEntity, Mutable>(MinimumSubTitleRowEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(MinimumSubTitleRowEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="MinimumSubTitleRowEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator MinimumSubTitleRowEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"MinimumSubTitleRowEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly MinimumSubTitleRowEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly MinimumSubTitleRowEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<MinimumSubTitleRowEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(MinimumSubTitleRowEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<MinimumSubTitleRowEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<MinimumSubTitleRowEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<MinimumSubTitleRowEntity>();
                    }
                    finally
                    {
