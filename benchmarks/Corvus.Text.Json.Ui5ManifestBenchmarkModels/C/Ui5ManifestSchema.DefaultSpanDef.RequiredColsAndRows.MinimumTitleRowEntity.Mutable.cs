        ...
        public readonly partial struct RequiredColsAndRows
        {
            ...
            public readonly partial struct MinimumTitleRowEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<MinimumTitleRowEntity, Mutable>(MinimumTitleRowEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(MinimumTitleRowEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="MinimumTitleRowEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator MinimumTitleRowEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"MinimumTitleRowEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly MinimumTitleRowEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly MinimumTitleRowEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<MinimumTitleRowEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(MinimumTitleRowEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<MinimumTitleRowEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<MinimumTitleRowEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<MinimumTitleRowEntity>();
                    }
                    finally
                    {
