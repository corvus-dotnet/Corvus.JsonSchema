        ...
        public readonly partial struct RequiredColsAndRows
        {
            ...
            public readonly partial struct ShowOnlyHeaderEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ShowOnlyHeaderEntity, Mutable>(ShowOnlyHeaderEntity.DefaultInstance);
                ...
                public static ParsedJsonDocument<ShowOnlyHeaderEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<ShowOnlyHeaderEntity>();
                    }
                    finally
                    {
