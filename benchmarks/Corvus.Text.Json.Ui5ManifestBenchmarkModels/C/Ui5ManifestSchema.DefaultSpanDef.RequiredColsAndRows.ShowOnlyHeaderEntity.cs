    ...
    public readonly partial struct DefaultSpanDef
    {
        ...
        public readonly partial struct RequiredColsAndRows
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="ShowOnlyHeaderEntity"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal ShowOnlyHeaderEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static ShowOnlyHeaderEntity DefaultInstance { get; } = ParsedJsonDocument<ShowOnlyHeaderEntity>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(ShowOnlyHeaderEntity value)
                {
                ...
                /// </returns>
                public static bool operator ==(in ShowOnlyHeaderEntity left, in ShowOnlyHeaderEntity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in ShowOnlyHeaderEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(ShowOnlyHeaderEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ShowOnlyHeaderEntity(JsonElement instance)
                {
                    return ShowOnlyHeaderEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ShowOnlyHeaderEntity From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ShowOnlyHeaderEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ShowOnlyHeaderEntity>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ShowOnlyHeaderEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ShowOnlyHeaderEntity>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static ShowOnlyHeaderEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<ShowOnlyHeaderEntity>(json, options);
                }
                ...
                /// </exception>
                public static ShowOnlyHeaderEntity ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<ShowOnlyHeaderEntity>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out ShowOnlyHeaderEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<ShowOnlyHeaderEntity>(ref reader, out result);
                }
...
#if NET
                static ShowOnlyHeaderEntity IJsonElement<ShowOnlyHeaderEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ShowOnlyHeaderEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public ShowOnlyHeaderEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public ShowOnlyHeaderEntity Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<ShowOnlyHeaderEntity>(_idx);
                    }
