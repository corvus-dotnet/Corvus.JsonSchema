...
public readonly partial struct Ui5ManifestSchema
{
        ...
        : IJsonElement<DefiningRequest>
    {
        public static partial class JsonSchema
        {
            ...
            private static void MatchRetrieveStreams(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
