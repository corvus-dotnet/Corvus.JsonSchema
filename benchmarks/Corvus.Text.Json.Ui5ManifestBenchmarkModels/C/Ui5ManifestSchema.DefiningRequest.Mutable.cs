...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct DefiningRequest
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(DefiningRequest instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="DefiningRequest"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DefiningRequest(Mutable instance)
            {
            ...
            /// <summary>
            /// Gets the (optional) <c>retrieveStreams</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DefiningRequest.RepresentsIndicatorWhetherStreamsShouldBeRetrieved.Mutable RetrieveStreams
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RetrieveStreamsUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DefiningRequest.RepresentsIndicatorWhetherStreamsShouldBeRetrieved.Mutable value))
                    {
                        return value;
                    }

                    return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DefiningRequest.RepresentsIndicatorWhetherStreamsShouldBeRetrieved.Mutable.DefaultInstance;
                }
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new DefiningRequest(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetRetrieveStreams(scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DefiningRequest.RepresentsIndicatorWhetherStreamsShouldBeRetrieved.Source value)
            {
                ...
                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.RetrieveStreamsUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RetrieveStreamsUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.RetrieveStreams, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// <summary>
            /// Remove the <c>retrieveStreams</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveRetrieveStreams()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.RetrieveStreamsUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DefiningRequest.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="DefiningRequest"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="DefiningRequest"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly DefiningRequest Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<DefiningRequest>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="DefiningRequest"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly DefiningRequest Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<DefiningRequest>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DefiningRequest.RepresentsIndicatorWhetherStreamsShouldBeRetrieved.Source _createArg3;
            ...
            public static implicit operator Source(DefiningRequest instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DefiningRequest.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="DefiningRequest"/>.
            /// </summary>
            internal static void Create(
                ...
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DefiningRequest.RepresentsIndicatorWhetherStreamsShouldBeRetrieved.Source retrieveStreams = default)
            {
                ...
                retrieveStreams.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.RetrieveStreams, ref builder);
            }
            ...
            public void Create(
                ...
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DefiningRequest.RepresentsIndicatorWhetherStreamsShouldBeRetrieved.Source retrieveStreams = default)
            {
                Create(ref _builder, dataSource, path, retrieveStreams);
            }
        ...
        {
            return workspace.CreateBuilder<DefiningRequest, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<DefiningRequest> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<DefiningRequest>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<DefiningRequest> Create<TContext>(
        ...
        public static ParsedJsonDocument<DefiningRequest> Create(in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source dataSource, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source path, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DefiningRequest.RepresentsIndicatorWhetherStreamsShouldBeRetrieved.Source retrieveStreams = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
