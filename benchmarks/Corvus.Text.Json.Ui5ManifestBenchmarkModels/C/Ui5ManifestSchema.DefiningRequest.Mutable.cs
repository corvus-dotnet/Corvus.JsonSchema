    ...
    public readonly partial struct DefiningRequest
    {
...
#endif
        {
            ...
            public void SetRetrieveStreams(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DefiningRequest.RepresentsIndicatorWhetherStreamsShouldBeRetrieved.Source value)
            {
                ...
                {
                    // We are going to insert the new value
                    value.AddAsProperty(JsonPropertyNamesEscaped.RetrieveStreams, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
        ...
        public ref struct Builder
        {
                ...
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DefiningRequest.RepresentsIndicatorWhetherStreamsShouldBeRetrieved.Source retrieveStreams = default)
            {
                ...
                retrieveStreams.AddAsProperty(JsonPropertyNamesEscaped.RetrieveStreams, ref builder, escapeName: false);
            }
