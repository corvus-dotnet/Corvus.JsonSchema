    ...
    public readonly partial struct DefiningRequest
    {
        ...
        public readonly partial struct RepresentsIndicatorWhetherStreamsShouldBeRetrieved
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<RepresentsIndicatorWhetherStreamsShouldBeRetrieved, Mutable>(RepresentsIndicatorWhetherStreamsShouldBeRetrieved.DefaultInstance);
                ...
                public static explicit operator Mutable(RepresentsIndicatorWhetherStreamsShouldBeRetrieved instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsIndicatorWhetherStreamsShouldBeRetrieved"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsIndicatorWhetherStreamsShouldBeRetrieved(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsIndicatorWhetherStreamsShouldBeRetrieved.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsIndicatorWhetherStreamsShouldBeRetrieved Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsIndicatorWhetherStreamsShouldBeRetrieved Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsIndicatorWhetherStreamsShouldBeRetrieved>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsIndicatorWhetherStreamsShouldBeRetrieved instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RepresentsIndicatorWhetherStreamsShouldBeRetrieved, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RepresentsIndicatorWhetherStreamsShouldBeRetrieved> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RepresentsIndicatorWhetherStreamsShouldBeRetrieved>();
                }
                finally
                {
