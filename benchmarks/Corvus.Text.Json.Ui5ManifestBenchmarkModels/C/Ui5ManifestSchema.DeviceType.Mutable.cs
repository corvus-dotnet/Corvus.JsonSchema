...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct DeviceType
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(DeviceType instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="DeviceType"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DeviceType(Mutable instance)
            {
            ...
            /// <summary>
            /// Gets the (optional) <c>desktop</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Mutable Desktop
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DesktopUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Mutable Phone
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PhoneUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Mutable Tablet
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TabletUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new DeviceType(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetDesktop(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source value)
            {
                ...
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.DesktopUtf8);
                ...
                else
                {
                    ...
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Desktop, ref cvb);
            ...
            /// <summary>
            /// Remove the <c>desktop</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveDesktop()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.DesktopUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            public void SetTablet(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source value)
            {
                ...
                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.TabletUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Tablet, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// <summary>
            /// Remove the <c>tablet</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveTablet()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.TabletUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DeviceType.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="DeviceType"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="DeviceType"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly DeviceType Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<DeviceType>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="DeviceType"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly DeviceType Freeze()
            {
                CheckValidInstance();
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DeviceType.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="DeviceType"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source desktop = default,
                in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source phone = default,
                in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source tablet = default)
            {
                desktop.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Desktop, ref builder);
                phone.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Phone, ref builder);
                tablet.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Tablet, ref builder);
            }
        ...
        /// </summary>
        /// <param name="desktop">The value of the <c>"desktop"</c> property.</param>
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source desktop = default, in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source phone = default, in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source tablet = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        {
            return workspace.CreateBuilder<DeviceType, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<DeviceType> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<DeviceType>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<DeviceType> Create<TContext>(
        ...
        public static ParsedJsonDocument<DeviceType> Create(in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source desktop = default, in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source phone = default, in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source tablet = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
