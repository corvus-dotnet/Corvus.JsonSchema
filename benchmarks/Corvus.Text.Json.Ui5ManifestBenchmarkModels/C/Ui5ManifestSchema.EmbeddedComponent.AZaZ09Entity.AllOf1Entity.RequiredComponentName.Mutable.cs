    ...
    public readonly partial struct EmbeddedComponent
    {
        ...
        public readonly partial struct AZaZ09Entity
        {
            ...
            public readonly partial struct AllOf1Entity
            {
                ...
                public readonly partial struct RequiredComponentName
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(RequiredComponentName instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="RequiredComponentName"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator RequiredComponentName(Mutable instance)
                        {
                        ...
                        /// <summary>
                        /// Gets the <c>componentName</c> property.
                        /// </summary>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EmbeddedComponent.AZaZ09Entity.AllOf1Entity.RequiredComponentName.RepresentsTheNameOfTheReuseComponent.Mutable ComponentName
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ComponentNameUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EmbeddedComponent.AZaZ09Entity.AllOf1Entity.RequiredComponentName.RepresentsTheNameOfTheReuseComponent.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        {
                            return
                                (obj is IJsonElement value && Equals(new RequiredComponentName(value.ParentDocument, value.ParentDocumentIndex))) ||
                        ...
                        public void SetComponentName(scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EmbeddedComponent.AZaZ09Entity.AllOf1Entity.RequiredComponentName.RepresentsTheNameOfTheReuseComponent.Source value)
                        {
                            CheckValidInstance();

                            if (value.IsUndefined)
                            {
                                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("componentName");
                            }
                            ...
                            else
                            {
                                ...
                                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ComponentName, ref cvb);
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"RequiredComponentName.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// <summary>
                        /// Gets a <see cref="RequiredComponentName"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </summary>
                        /// <returns>
                        /// A <see cref="RequiredComponentName"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </returns>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RequiredComponentName Clone()
                        {
                            CheckValidInstance();
                            return _parent.CloneElement<RequiredComponentName>(_idx);
                        }
                        ...
                        /// </summary>
                        /// <returns>
                        /// An immutable <see cref="RequiredComponentName"/> that lives for the lifetime of its
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RequiredComponentName Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<RequiredComponentName>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EmbeddedComponent.AZaZ09Entity.AllOf1Entity.RequiredComponentName.RepresentsTheNameOfTheReuseComponent.Source _createArg1;
                        ...
                        internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EmbeddedComponent.AZaZ09Entity.AllOf1Entity.RequiredComponentName.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                        internal Source(scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EmbeddedComponent.AZaZ09Entity.AllOf1Entity.RequiredComponentName.RepresentsTheNameOfTheReuseComponent.Source arg1)
                        {
                            _createArg1 = arg1;
                            _kind = Kind.Create;
                        }

                        public static implicit operator Source(RequiredComponentName instance) => new(JsonElement.From(instance));
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EmbeddedComponent.AZaZ09Entity.AllOf1Entity.RequiredComponentName.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    public ref struct Builder
                    {
                        ...
                        /// <summary>
                        /// Creates an instance of a <see cref="RequiredComponentName"/>.
                        /// </summary>
                        internal static void Create(ref ComplexValueBuilder builder, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EmbeddedComponent.AZaZ09Entity.AllOf1Entity.RequiredComponentName.RepresentsTheNameOfTheReuseComponent.Source componentName)
                        {
                            componentName.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ComponentName, ref builder);
                        }

                        /// <summary>
                        /// Creates an instance of a <see cref="RequiredComponentName"/>.
                        /// </summary>
                        public void Create(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EmbeddedComponent.AZaZ09Entity.AllOf1Entity.RequiredComponentName.RepresentsTheNameOfTheReuseComponent.Source componentName)
                        {
                            Create(ref _builder, componentName);
                        }
                        ...
                        internal static void BuildCreateValue(scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EmbeddedComponent.AZaZ09Entity.AllOf1Entity.RequiredComponentName.RepresentsTheNameOfTheReuseComponent.Source arg1, ref ComplexValueBuilder o)
                        {
                            o.StartObject();
                            Create(ref o, arg1);
                            o.EndObject();
                    ...
                    /// <returns>The source from which to build the value.</returns>
                    public static Source Build(scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EmbeddedComponent.AZaZ09Entity.AllOf1Entity.RequiredComponentName.RepresentsTheNameOfTheReuseComponent.Source componentName)
                    {
                        return new Source(componentName);
                    }
                    ...
                    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EmbeddedComponent.AZaZ09Entity.AllOf1Entity.RequiredComponentName.RepresentsTheNameOfTheReuseComponent.Source componentName, int initialCapacity = 30)
                    {
                        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                        cvb.StartObject();
                        Builder ovb = new(cvb);
                        ovb.Create(componentName);
                        cvb = ovb._builder;
                        cvb.EndObject();
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder;
                    ...
                    {
                        return workspace.CreateBuilder<RequiredComponentName, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<RequiredComponentName> Create(
                        scoped in Source value, int initialCapacity = 30)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<RequiredComponentName>();
                        }
                        finally
                        {
                    ...
                    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                    public static ParsedJsonDocument<RequiredComponentName> Create<TContext>(
                    ...
                    public static ParsedJsonDocument<RequiredComponentName> Create(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EmbeddedComponent.AZaZ09Entity.AllOf1Entity.RequiredComponentName.RepresentsTheNameOfTheReuseComponent.Source componentName, int initialCapacity = 30)
                    {
                        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                        try
                        {
