        ...
        public readonly partial struct AZaZ09Entity
        {
            ...
            public readonly partial struct RequiredIdAndTitle
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(RequiredIdAndTitle instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="RequiredIdAndTitle"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RequiredIdAndTitle(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new RequiredIdAndTitle(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RequiredIdAndTitle.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="RequiredIdAndTitle"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="RequiredIdAndTitle"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RequiredIdAndTitle Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<RequiredIdAndTitle>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="RequiredIdAndTitle"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RequiredIdAndTitle Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<RequiredIdAndTitle>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EmbeddedComponent.AZaZ09Entity.RequiredIdAndTitle.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    public static implicit operator Source(RequiredIdAndTitle instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EmbeddedComponent.AZaZ09Entity.RequiredIdAndTitle.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// <summary>
                    /// Creates an instance of a <see cref="RequiredIdAndTitle"/>.
                    /// </summary>
                ...
                {
                    return workspace.CreateBuilder<RequiredIdAndTitle, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<RequiredIdAndTitle> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<RequiredIdAndTitle>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<RequiredIdAndTitle> Create<TContext>(
                ...
                public static ParsedJsonDocument<RequiredIdAndTitle> Create(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EmbeddedComponent.AZaZ09Entity.RequiredIdAndTitle.IdEntity.Source id, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EmbeddedComponent.AZaZ09Entity.RequiredIdAndTitle.RepresentsTheTitleForTheContentOfTheReuseComponent.Source title, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source binding = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source groupTitle = default, in Corvus.Text.Json.JsonElement.Source hiddenByDefault = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source leadingSectionIdOrPath = default, in Corvus.Ui5ManifestBenchmark.Current.JsonObject.Source settings = default, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
                public static ParsedJsonDocument<RequiredIdAndTitle> Create<TContext>(in TContext context, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EmbeddedComponent.AZaZ09Entity.RequiredIdAndTitle.IdEntity.Source id, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EmbeddedComponent.AZaZ09Entity.RequiredIdAndTitle.RepresentsTheTitleForTheContentOfTheReuseComponent.Source title, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source binding = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source groupTitle = default, in Corvus.Text.Json.JsonElement.Source<TContext> hiddenByDefault = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source leadingSectionIdOrPath = default, in Corvus.Ui5ManifestBenchmark.Current.JsonObject.Source<TContext> settings = default, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
