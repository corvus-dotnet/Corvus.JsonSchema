        ...
        public readonly partial struct AZaZ09Entity
        {
            ...
            public readonly partial struct RequiredIdAndTitle
            {
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="RepresentsAMapToPopulateTheApiOfTheReuseComponent"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal RepresentsAMapToPopulateTheApiOfTheReuseComponent(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static RepresentsAMapToPopulateTheApiOfTheReuseComponent DefaultInstance { get; }
                    ...
                    /// </returns>
                    public static bool operator ==(in RepresentsAMapToPopulateTheApiOfTheReuseComponent left, in RepresentsAMapToPopulateTheApiOfTheReuseComponent right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in RepresentsAMapToPopulateTheApiOfTheReuseComponent left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    public static implicit operator JsonElement(RepresentsAMapToPopulateTheApiOfTheReuseComponent instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RepresentsAMapToPopulateTheApiOfTheReuseComponent(JsonElement instance)
                    {
                        return RepresentsAMapToPopulateTheApiOfTheReuseComponent.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RepresentsAMapToPopulateTheApiOfTheReuseComponent From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RepresentsAMapToPopulateTheApiOfTheReuseComponent ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RepresentsAMapToPopulateTheApiOfTheReuseComponent>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RepresentsAMapToPopulateTheApiOfTheReuseComponent ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RepresentsAMapToPopulateTheApiOfTheReuseComponent>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RepresentsAMapToPopulateTheApiOfTheReuseComponent ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RepresentsAMapToPopulateTheApiOfTheReuseComponent>(json, options);
                    }
                    ...
                    /// </exception>
                    public static RepresentsAMapToPopulateTheApiOfTheReuseComponent ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<RepresentsAMapToPopulateTheApiOfTheReuseComponent>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsAMapToPopulateTheApiOfTheReuseComponent? result)
                    {
                        return JsonElementHelpers.TryParseValue<RepresentsAMapToPopulateTheApiOfTheReuseComponent>(ref reader, out result);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new RepresentsAMapToPopulateTheApiOfTheReuseComponent(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                    static RepresentsAMapToPopulateTheApiOfTheReuseComponent IJsonElement<RepresentsAMapToPopulateTheApiOfTheReuseComponent>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RepresentsAMapToPopulateTheApiOfTheReuseComponent: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="RepresentsAMapToPopulateTheApiOfTheReuseComponent"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="RepresentsAMapToPopulateTheApiOfTheReuseComponent"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public RepresentsAMapToPopulateTheApiOfTheReuseComponent Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<RepresentsAMapToPopulateTheApiOfTheReuseComponent>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="RepresentsAMapToPopulateTheApiOfTheReuseComponent"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public RepresentsAMapToPopulateTheApiOfTheReuseComponent Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<RepresentsAMapToPopulateTheApiOfTheReuseComponent>(_idx);
                        }
