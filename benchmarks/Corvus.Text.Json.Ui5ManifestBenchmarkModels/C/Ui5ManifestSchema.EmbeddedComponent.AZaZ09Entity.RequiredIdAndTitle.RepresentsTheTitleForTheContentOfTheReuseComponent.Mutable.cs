...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct EmbeddedComponent
    {
        ...
        public readonly partial struct AZaZ09Entity
        {
            ...
            /// Generated from JSON Schema.
            /// </summary>
            public readonly partial struct RequiredIdAndTitle
            {
                /// <summary>
                /// Generated from JSON Schema.
                /// </summary>
                ...
                public readonly partial struct RepresentsTheTitleForTheContentOfTheReuseComponent
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(RepresentsTheTitleForTheContentOfTheReuseComponent instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="RepresentsTheTitleForTheContentOfTheReuseComponent"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator RepresentsTheTitleForTheContentOfTheReuseComponent(Mutable instance)
                        {
                        ...
                        {
                            return
                                (obj is IJsonElement value && Equals(new RepresentsTheTitleForTheContentOfTheReuseComponent(value.ParentDocument, value.ParentDocumentIndex))) ||
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"RepresentsTheTitleForTheContentOfTheReuseComponent.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// <summary>
                        /// Gets a <see cref="RepresentsTheTitleForTheContentOfTheReuseComponent"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </summary>
                        /// <returns>
                        /// A <see cref="RepresentsTheTitleForTheContentOfTheReuseComponent"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </returns>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RepresentsTheTitleForTheContentOfTheReuseComponent Clone()
                        {
                            CheckValidInstance();
                            return _parent.CloneElement<RepresentsTheTitleForTheContentOfTheReuseComponent>(_idx);
                        }
                        ...
                        /// </summary>
                        /// <returns>
                        /// An immutable <see cref="RepresentsTheTitleForTheContentOfTheReuseComponent"/> that lives for the lifetime of its
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RepresentsTheTitleForTheContentOfTheReuseComponent Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<RepresentsTheTitleForTheContentOfTheReuseComponent>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(RepresentsTheTitleForTheContentOfTheReuseComponent instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<RepresentsTheTitleForTheContentOfTheReuseComponent, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<RepresentsTheTitleForTheContentOfTheReuseComponent> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<RepresentsTheTitleForTheContentOfTheReuseComponent>();
                        }
                        finally
                        {
