        ...
        public readonly partial struct AZaZ09Entity
        {
            ...
            public readonly partial struct RequiredIdAndTitle
            {
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="RepresentsTheTitleForTheContentOfTheReuseComponent"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal RepresentsTheTitleForTheContentOfTheReuseComponent(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static RepresentsTheTitleForTheContentOfTheReuseComponent DefaultInstance { get; }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static explicit operator string(RepresentsTheTitleForTheContentOfTheReuseComponent value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                    ...
                    /// </returns>
                    public static bool operator ==(in RepresentsTheTitleForTheContentOfTheReuseComponent left, in RepresentsTheTitleForTheContentOfTheReuseComponent right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in RepresentsTheTitleForTheContentOfTheReuseComponent left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator JsonElement(RepresentsTheTitleForTheContentOfTheReuseComponent instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RepresentsTheTitleForTheContentOfTheReuseComponent(JsonElement instance)
                    {
                        return RepresentsTheTitleForTheContentOfTheReuseComponent.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RepresentsTheTitleForTheContentOfTheReuseComponent From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RepresentsTheTitleForTheContentOfTheReuseComponent ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RepresentsTheTitleForTheContentOfTheReuseComponent>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RepresentsTheTitleForTheContentOfTheReuseComponent ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RepresentsTheTitleForTheContentOfTheReuseComponent>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RepresentsTheTitleForTheContentOfTheReuseComponent ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RepresentsTheTitleForTheContentOfTheReuseComponent>(json, options);
                    }
                    ...
                    /// </exception>
                    public static RepresentsTheTitleForTheContentOfTheReuseComponent ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<RepresentsTheTitleForTheContentOfTheReuseComponent>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsTheTitleForTheContentOfTheReuseComponent? result)
                    {
                        return JsonElementHelpers.TryParseValue<RepresentsTheTitleForTheContentOfTheReuseComponent>(ref reader, out result);
                    }
...
#if NET
                    static RepresentsTheTitleForTheContentOfTheReuseComponent IJsonElement<RepresentsTheTitleForTheContentOfTheReuseComponent>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RepresentsTheTitleForTheContentOfTheReuseComponent: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public RepresentsTheTitleForTheContentOfTheReuseComponent Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public RepresentsTheTitleForTheContentOfTheReuseComponent Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<RepresentsTheTitleForTheContentOfTheReuseComponent>(_idx);
                        }
