            ...
            public readonly partial struct AllOf1Entity
            {
                ...
                public readonly partial struct RequiredComponentName
                {
                    ...
                    public readonly partial struct RepresentsTheNameOfTheReuseComponent
                    {
                        ...
                        public static ParsedJsonDocument<RepresentsTheNameOfTheReuseComponent> Create(
                            scoped in Source value, int initialCapacity = 1)
                        {
                            ...
                            try
                            {
                                ...
                                Debug.Assert(cvb.MemberCount == 1);
                                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                return documentBuilder.ToParsedJsonDocument<RepresentsTheNameOfTheReuseComponent>();
                            }
                            finally
                            {
