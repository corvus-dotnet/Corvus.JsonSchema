        ...
        public readonly partial struct RequiredBundleUrl
        {
            ...
            public readonly partial struct BundleUrlRelativeToEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<BundleUrlRelativeToEntity, Mutable>(BundleUrlRelativeToEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(BundleUrlRelativeToEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="BundleUrlRelativeToEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator BundleUrlRelativeToEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"BundleUrlRelativeToEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly BundleUrlRelativeToEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly BundleUrlRelativeToEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<BundleUrlRelativeToEntity>(_idx);
                    }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(BundleUrlRelativeToEntity instance) => new(JsonElement.From(instance));
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Source(KnownValues value) => (BundleUrlRelativeToEntity)value;
                ...
                {
                    return workspace.CreateBuilder<BundleUrlRelativeToEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<BundleUrlRelativeToEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<BundleUrlRelativeToEntity>();
                    }
                    finally
                    {
