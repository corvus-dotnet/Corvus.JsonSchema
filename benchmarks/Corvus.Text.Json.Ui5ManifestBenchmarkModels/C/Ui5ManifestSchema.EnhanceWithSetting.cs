...
public readonly partial struct Ui5ManifestSchema
{
...
#endif
    {
        ...
        public static explicit operator Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnhanceWithSetting.RequiredBundleUrl(EnhanceWithSetting value)
        {
            return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnhanceWithSetting.RequiredBundleUrl.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator EnhanceWithSetting(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnhanceWithSetting.RequiredBundleUrl value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnhanceWithSetting.RequiredBundleName(EnhanceWithSetting value)
        {
            return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnhanceWithSetting.RequiredBundleName.From(value);
        }
        ...
        public bool TryGetAsRequiredBundleUrl(out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnhanceWithSetting.RequiredBundleUrl result)
        {
            ...
            {
                result = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnhanceWithSetting.RequiredBundleUrl.From(this);
                return true;
            }
        ...
        public bool TryGetAsRequiredBundleName(out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnhanceWithSetting.RequiredBundleName result)
        {
            ...
            {
                result = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnhanceWithSetting.RequiredBundleName.From(this);
                return true;
            }
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnhanceWithSetting, TContext, TResult> defaultMatch)
...
#endif
        {
            if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnhanceWithSetting.RequiredBundleUrl.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredBundleUrl(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnhanceWithSetting.RequiredBundleUrl.From(this), context);
            }

            if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnhanceWithSetting.RequiredBundleName.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredBundleName(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnhanceWithSetting.RequiredBundleName.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnhanceWithSetting, TResult> defaultMatch)
        {
            if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnhanceWithSetting.RequiredBundleUrl.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredBundleUrl(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnhanceWithSetting.RequiredBundleUrl.From(this));
            }

            if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnhanceWithSetting.RequiredBundleName.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredBundleName(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnhanceWithSetting.RequiredBundleName.From(this));
            }
