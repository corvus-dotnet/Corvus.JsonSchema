...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct EnumsValueColor
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<EnumsValueColor, Mutable>(EnumsValueColor.DefaultInstance);
            ...
            public static explicit operator Mutable(EnumsValueColor instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="EnumsValueColor"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EnumsValueColor(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EnumsValueColor.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly EnumsValueColor Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly EnumsValueColor Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<EnumsValueColor>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(EnumsValueColor instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (EnumsValueColor)value;
        ...
        {
            return workspace.CreateBuilder<EnumsValueColor, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<EnumsValueColor> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<EnumsValueColor>();
            }
            finally
            {
