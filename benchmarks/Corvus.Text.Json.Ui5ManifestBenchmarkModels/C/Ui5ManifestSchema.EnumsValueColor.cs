...
public readonly partial struct Ui5ManifestSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EnumsValueColor"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal EnumsValueColor(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static EnumsValueColor DefaultInstance { get; } = ParsedJsonDocument<EnumsValueColor>.StringConstant([.."\"Neutral\""u8]);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(EnumsValueColor value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in EnumsValueColor left, in EnumsValueColor right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in EnumsValueColor left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(EnumsValueColor instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator EnumsValueColor(JsonElement instance)
        {
            return EnumsValueColor.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnumsValueColor From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnumsValueColor ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EnumsValueColor>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnumsValueColor ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EnumsValueColor>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EnumsValueColor ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<EnumsValueColor>(json, options);
        }
        ...
        /// </exception>
        public static EnumsValueColor ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<EnumsValueColor>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out EnumsValueColor? result)
        {
            return JsonElementHelpers.TryParseValue<EnumsValueColor>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new EnumsValueColor(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static EnumsValueColor IJsonElement<EnumsValueColor>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"EnumsValueColor: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="EnumsValueColor"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="EnumsValueColor"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public EnumsValueColor Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<EnumsValueColor>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="EnumsValueColor"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public EnumsValueColor Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<EnumsValueColor>(_idx);
            }
        ...
        /// <param name="matchCritical">Match 1st item.</param>
        /// <param name="matchError">Match 2nd item.</param>
        /// <param name="matchGood">Match 3rd item.</param>
        /// <param name="matchNeutral">Match 4th item.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Func<TContext, TResult> matchCritical,
            Func<TContext, TResult> matchError,
            Func<TContext, TResult> matchGood,
            Func<TContext, TResult> matchNeutral,
...
#endif
        {
            ...
            {
                return matchGood(context);
            }

            if (this.ValueEquals(Constants.Enum4))
            {
                return matchNeutral(context);
            }
        ...
        public TResult Match<TResult>(
            Func<TResult> matchCritical,
            Func<TResult> matchError,
            Func<TResult> matchGood,
            Func<TResult> matchNeutral,
