...
public readonly partial struct Ui5ManifestSchema
{
    ...
    /// </para>
    /// </remarks>
    public readonly partial struct Extension
    {
        /// <summary>
        /// Generated from JSON Schema.
        /// </summary>
        ...
        public readonly partial struct TheArgumentsWithWhichTheMethodWillBeCalled
#if NET8_0_OR_GREATER
            : IJsonElement<TheArgumentsWithWhichTheMethodWillBeCalled>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="TheArgumentsWithWhichTheMethodWillBeCalled"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal TheArgumentsWithWhichTheMethodWillBeCalled(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static TheArgumentsWithWhichTheMethodWillBeCalled DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in TheArgumentsWithWhichTheMethodWillBeCalled left, in TheArgumentsWithWhichTheMethodWillBeCalled right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in TheArgumentsWithWhichTheMethodWillBeCalled left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(TheArgumentsWithWhichTheMethodWillBeCalled instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TheArgumentsWithWhichTheMethodWillBeCalled(JsonElement instance)
            {
                return TheArgumentsWithWhichTheMethodWillBeCalled.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TheArgumentsWithWhichTheMethodWillBeCalled From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TheArgumentsWithWhichTheMethodWillBeCalled ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TheArgumentsWithWhichTheMethodWillBeCalled>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TheArgumentsWithWhichTheMethodWillBeCalled ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TheArgumentsWithWhichTheMethodWillBeCalled>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TheArgumentsWithWhichTheMethodWillBeCalled ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<TheArgumentsWithWhichTheMethodWillBeCalled>(json, options);
            }
            ...
            /// </exception>
            public static TheArgumentsWithWhichTheMethodWillBeCalled ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<TheArgumentsWithWhichTheMethodWillBeCalled>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out TheArgumentsWithWhichTheMethodWillBeCalled? result)
            {
                return JsonElementHelpers.TryParseValue<TheArgumentsWithWhichTheMethodWillBeCalled>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new TheArgumentsWithWhichTheMethodWillBeCalled(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static TheArgumentsWithWhichTheMethodWillBeCalled IJsonElement<TheArgumentsWithWhichTheMethodWillBeCalled>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TheArgumentsWithWhichTheMethodWillBeCalled: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="TheArgumentsWithWhichTheMethodWillBeCalled"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="TheArgumentsWithWhichTheMethodWillBeCalled"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public TheArgumentsWithWhichTheMethodWillBeCalled Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<TheArgumentsWithWhichTheMethodWillBeCalled>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="TheArgumentsWithWhichTheMethodWillBeCalled"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public TheArgumentsWithWhichTheMethodWillBeCalled Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<TheArgumentsWithWhichTheMethodWillBeCalled>(_idx);
                }
