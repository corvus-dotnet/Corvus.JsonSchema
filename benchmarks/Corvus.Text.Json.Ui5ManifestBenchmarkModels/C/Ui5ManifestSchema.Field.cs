...
public readonly partial struct Ui5ManifestSchema
{
...
#endif
    {
        ...
        internal Field(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// <remarks>
        /// <para>
        /// Represents a label of the field; to make this property language dependent (recommended), use a key in double curly brackets &#39;{{key}}&#39;
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.I18nKeyString Label
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LabelUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.I18nKeyString value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in Field left, in Field right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Field left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(Field instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Field(JsonElement instance)
        {
            return Field.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Field From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Field ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Field>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Field ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Field>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Field ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Field>(json, options);
        }
        ...
        /// </exception>
        public static Field ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<Field>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Field? result)
        {
            return JsonElementHelpers.TryParseValue<Field>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new Field(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static Field IJsonElement<Field>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Field: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="Field"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="Field"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        {
            CheckValidInstance();
            return _parent.CloneElement<Field>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="Field"/> that lives for the lifetime of its
        ...
        public Field Freeze()
        {
            ...
            {
                return mutable.FreezeElement<Field>(_idx);
            }
