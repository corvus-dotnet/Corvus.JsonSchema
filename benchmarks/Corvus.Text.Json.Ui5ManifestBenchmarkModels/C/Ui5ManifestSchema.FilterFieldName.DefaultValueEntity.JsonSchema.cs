...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct FilterFieldName
    {
        ...
        public readonly partial struct DefaultValueEntity
            : IJsonElement<DefaultValueEntity>
        {
            public static partial class JsonSchema
            {
                private static readonly JsonSchemaPathProvider OperationSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/operation"u8, buffer, out written);

                private static void MatchOperation(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    ...
                    JsonSchemaContext childContext =
                        Corvus.Ui5ManifestBenchmark.Current.JsonString.JsonSchema.PushChildContextUnescaped(
                            ...
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.OperationUtf8,
                            evaluationPath: OperationSchemaEvaluationPath);
                ...
                {
                    if (span.SequenceEqual(JsonPropertyNames.OperationUtf8))
                    {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("ui5-manifest-schema.json#/definitions/filterFieldName/properties/defaultValue"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "ui5-manifest-schema.json#/definitions/filterFieldName/properties/defaultValue";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "ui5-manifest-schema.json#/definitions/filterFieldName/properties/defaultValue"u8;
