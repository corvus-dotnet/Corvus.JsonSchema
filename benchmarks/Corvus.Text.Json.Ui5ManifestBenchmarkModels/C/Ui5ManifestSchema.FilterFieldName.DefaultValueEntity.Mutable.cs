    ...
    public readonly partial struct FilterFieldName
    {
        ...
        public readonly partial struct DefaultValueEntity
        {
...
#endif
            {
                ...
                public void SetOperation(in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source value)
                {
                    CheckValidInstance();
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source operation = default)
            {
