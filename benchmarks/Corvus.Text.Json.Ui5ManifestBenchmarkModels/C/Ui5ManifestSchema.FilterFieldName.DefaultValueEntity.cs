...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct FilterFieldName
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.JsonString Operation
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OperationUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString value))
                    {
                        return value;
                    }
            ...
            {
                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="Operation"/>.
                /// </summary>
                public static ReadOnlySpan<byte> Operation => [0xB5, 0x00, 0x00, 0x00, 0x22, 0x6F, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6F, 0x6E, 0x22];
            }
        }
    }
}
