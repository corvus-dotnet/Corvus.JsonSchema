...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct FilterFieldName
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(FilterFieldName instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="FilterFieldName"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator FilterFieldName(Mutable instance)
            {
            ...
            /// <summary>
            /// Gets the (optional) <c>customDateRangeImplementation</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable CustomDateRangeImplementation
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CustomDateRangeImplementationUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            /// <summary>
            /// Gets the (optional) <c>defaultValue</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.FilterFieldName.DefaultValueEntity.Mutable DefaultValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DefaultValueUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.FilterFieldName.DefaultValueEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.FilterFieldName.FlagToExcludeValuesFromTheDatePicker.Mutable Exclude
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExcludeUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.FilterFieldName.FlagToExcludeValuesFromTheDatePicker.Mutable value))
                    {
                        return value;
                    }

                    return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.FilterFieldName.FlagToExcludeValuesFromTheDatePicker.Mutable.DefaultInstance;
                }
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new FilterFieldName(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetCustomDateRangeImplementation(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source value)
            {
                ...
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.CustomDateRangeImplementationUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CustomDateRangeImplementationUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
            ...
            /// <summary>
            /// Remove the <c>customDateRangeImplementation</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveCustomDateRangeImplementation()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.CustomDateRangeImplementationUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            public void SetDefaultValue(scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.FilterFieldName.DefaultValueEntity.Source value)
            {
                ...
                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.DefaultValueUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DefaultValueUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetDefaultValue<TContext>(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.FilterFieldName.DefaultValueEntity.Source<TContext> value)
            ...
            /// <summary>
            /// Remove the <c>defaultValue</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveDefaultValue()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.DefaultValueUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"FilterFieldName.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="FilterFieldName"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="FilterFieldName"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly FilterFieldName Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<FilterFieldName>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="FilterFieldName"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly FilterFieldName Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<FilterFieldName>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.FilterFieldName.DefaultValueEntity.Source _createArg2;
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.FilterFieldName.FlagToExcludeValuesFromTheDatePicker.Source _createArg3;
            ...
            public static implicit operator Source(FilterFieldName instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            private readonly Corvus.Ui5ManifestBenchmark.Current.JsonString.Source _createArg1;
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.FilterFieldName.DefaultValueEntity.Source<TContext> _createArg2;
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.FilterFieldName.FlagToExcludeValuesFromTheDatePicker.Source _createArg3;
            private readonly Corvus.Ui5ManifestBenchmark.Current.JsonString.Source _createArg4;
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="FilterFieldName"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source customDateRangeImplementation = default,
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.FilterFieldName.DefaultValueEntity.Source defaultValue = default,
            ...
            public void Create(
                ...
                in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source selectedValues = default)
            {
                Create(ref _builder, customDateRangeImplementation, defaultValue, exclude, selectedValues);
            }
            ...
            internal static void Create<TContext>(
                ...
                ref ComplexValueBuilder builder,
                in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source customDateRangeImplementation = default,
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.FilterFieldName.DefaultValueEntity.Source<TContext> defaultValue = default,
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.FilterFieldName.FlagToExcludeValuesFromTheDatePicker.Source exclude = default,
                in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source selectedValues = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            ...
            #endif
            {
                Create(context, ref _builder, customDateRangeImplementation, defaultValue, exclude, selectedValues);
            }
        ...
        /// </summary>
        /// <param name="customDateRangeImplementation">The value of the <c>"customDateRangeImplementation"</c> property.</param>
        /// <param name="defaultValue">The value of the <c>"defaultValue"</c> property.</param>
        ...
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source customDateRangeImplementation = default, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.FilterFieldName.DefaultValueEntity.Source<TContext> defaultValue = default, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.FilterFieldName.FlagToExcludeValuesFromTheDatePicker.Source exclude = default, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source selectedValues = default)
            ...
            #endif
        {
            return new Source<TContext>(context, customDateRangeImplementation, defaultValue, exclude, selectedValues);
        }
        ...
        /// </summary>
        /// <param name="workspace">The JSON workspace.</param>
        /// <param name="customDateRangeImplementation">The value of the property.</param>
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source customDateRangeImplementation = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.FilterFieldName.DefaultValueEntity.Source defaultValue = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.FilterFieldName.FlagToExcludeValuesFromTheDatePicker.Source exclude = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source selectedValues = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(customDateRangeImplementation, defaultValue, exclude, selectedValues);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source customDateRangeImplementation = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.FilterFieldName.DefaultValueEntity.Source<TContext> defaultValue = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.FilterFieldName.FlagToExcludeValuesFromTheDatePicker.Source exclude = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source selectedValues = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            ...
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(context, customDateRangeImplementation, defaultValue, exclude, selectedValues);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<FilterFieldName, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<FilterFieldName> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<FilterFieldName>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<FilterFieldName> Create<TContext>(
        ...
        public static ParsedJsonDocument<FilterFieldName> Create(in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source customDateRangeImplementation = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.FilterFieldName.DefaultValueEntity.Source defaultValue = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.FilterFieldName.FlagToExcludeValuesFromTheDatePicker.Source exclude = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source selectedValues = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<FilterFieldName> Create<TContext>(in TContext context, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source customDateRangeImplementation = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.FilterFieldName.DefaultValueEntity.Source<TContext> defaultValue = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.FilterFieldName.FlagToExcludeValuesFromTheDatePicker.Source exclude = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source selectedValues = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
