...
public readonly partial struct Ui5ManifestSchema
{
        ...
        : IJsonElement<Group>
    {
        public static partial class JsonSchema
        {
            ...
            private static void MatchOrder(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
            {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/group"u8, buffer, out written);
