        ...
        public readonly partial struct TheOrderByWhichTheGroupWillBeSorted
        {
            ...
            public readonly partial struct TheSortingDirectionInWhichTheGroupItemsWillBeOrdered
            {
                    ...
                    : IJsonElement<OneOf0Entity>
                {
                    ...
                    {
                        /// <summary>
                        /// Corresponds to the JSON string "ASC".
                        /// </summary>
                        Asc = 0,
                        /// <summary>
                        /// Corresponds to the JSON string "DESC".
                        /// </summary>
                        Desc = 1,
                    }
                    ...
                    public static implicit operator OneOf0Entity(KnownValues value)
                    {
                        return value switch
                        {
                            KnownValues.Asc => Constants.EnumJson1,
                            KnownValues.Desc => Constants.EnumJson2,
                    ...
                    public bool TryGetKnownValue(out KnownValues result)
                    {
                        ...
                        {
                            result = KnownValues.Asc;
                            return true;
                        }

                        if (this.ValueEquals(Constants.Enum2))
                        {
                            result = KnownValues.Desc;
                            return true;
                        }
                    ...
                    public static partial class JsonSchema
                    {
                        ...
                        /// </summary>
                        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/definitions/group/properties/order/properties/dir/oneOf/0"u8, buffer, out written);
                        ...
                        private static readonly global::Corvus.Text.Json.RuntimeEvaluator.JsonSchemaEvaluator Evaluator = global::Corvus.Ui5ManifestBenchmark.Current.CorvusJsonSchemaProgram.Entry(361);
