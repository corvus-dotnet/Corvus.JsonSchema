...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct Group
    {
        ...
        public readonly partial struct TheOrderByWhichTheGroupWillBeSorted
        {
            ...
            public readonly partial struct DirEntity
#if NET8_0_OR_GREATER
                : IJsonElement<DirEntity>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="DirEntity"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal DirEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static DirEntity DefaultInstance { get; }
                ...
                /// <summary>
                /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Group.TheOrderByWhichTheGroupWillBeSorted.DirEntity.OneOf0Entity"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static explicit operator Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Group.TheOrderByWhichTheGroupWillBeSorted.DirEntity.OneOf0Entity(DirEntity value)
                {
                    return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Group.TheOrderByWhichTheGroupWillBeSorted.DirEntity.OneOf0Entity.From(value);
                }

                /// <summary>
                /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Group.TheOrderByWhichTheGroupWillBeSorted.DirEntity.OneOf0Entity"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator DirEntity(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Group.TheOrderByWhichTheGroupWillBeSorted.DirEntity.OneOf0Entity value)
                {
                    return From(value);
                }

                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(DirEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in DirEntity left, in DirEntity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in DirEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(DirEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DirEntity(JsonElement instance)
                {
                    return DirEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DirEntity From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DirEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<DirEntity>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DirEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<DirEntity>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static DirEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<DirEntity>(json, options);
                }
                ...
                /// </exception>
                public static DirEntity ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<DirEntity>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out DirEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<DirEntity>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new DirEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static DirEntity IJsonElement<DirEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DirEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="DirEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="DirEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                {
                    CheckValidInstance();
                    return _parent.CloneElement<DirEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="DirEntity"/> that lives for the lifetime of its
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Group.TheOrderByWhichTheGroupWillBeSorted.DirEntity.OneOf0Entity" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsOneOf0Entity(out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Group.TheOrderByWhichTheGroupWillBeSorted.DirEntity.OneOf0Entity result)
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Group.TheOrderByWhichTheGroupWillBeSorted.DirEntity.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Group.TheOrderByWhichTheGroupWillBeSorted.DirEntity.OneOf0Entity.From(this);
                        return true;
                    }
