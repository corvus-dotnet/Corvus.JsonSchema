...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct Group
    {
        ...
        public readonly partial struct TheOrderByWhichTheGroupWillBeSorted
        {
            ...
            /// </para>
            /// </remarks>
            public readonly partial struct TheSortingDirectionInWhichTheGroupItemsWillBeOrdered
            {
                /// <summary>
                /// Generated from JSON Schema.
                /// </summary>
                    ...
                    : IJsonElement<OneOf0Entity>
                {
                    ...
                    private static class Constants
                    {
                        ...
                        /// </summary>
                        public static readonly byte[] Enum1 = "ASC"u8.ToArray();
                        /// <summary>
                        /// A constant for the <c>enum</c> keyword.
                        /// </summary>
                        public static readonly OneOf0Entity EnumJson1 = ParsedJsonDocument<OneOf0Entity>.StringConstant([.."\"ASC\""u8]);
                        /// <summary>
                        /// A constant for the <c>enum</c> keyword.
                        /// </summary>
                        public static readonly byte[] Enum2 = "DESC"u8.ToArray();
                        /// <summary>
                        /// A constant for the <c>enum</c> keyword.
                        /// </summary>
                        public static readonly OneOf0Entity EnumJson2 = ParsedJsonDocument<OneOf0Entity>.StringConstant([.."\"DESC\""u8]);
                    }
                    ...
                    public static class EnumValues
                    {
                        ...
                        /// </summary>
                        public static OneOf0Entity Asc { get; } = Constants.EnumJson1;
                        /// <summary>
                        /// Gets the string "ASC"
                        /// as a UTF8 byte array.
                        /// </summary>
                        public static ReadOnlySpan<byte> AscUtf8 => Constants.Enum1;

                        /// <summary>
                        /// Gets the string "DESC"
                        /// as a <see cref="OneOf0Entity"/>.
                        /// </summary>
                        public static OneOf0Entity Desc { get; } = Constants.EnumJson2;
                        /// <summary>
                        /// Gets the string "DESC"
                        /// as a UTF8 byte array.
                        /// </summary>
                        public static ReadOnlySpan<byte> DescUtf8 => Constants.Enum2;
                    }
                    ...
                    public static partial class JsonSchema
                    {
                        ...
                        /// </summary>
                        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/group/properties/order/properties/dir/oneOf/0"u8, buffer, out written);

                        /// <summary>
                        /// Gets the schema location from which this type was generated.
                        /// </summary>
                        public const string SchemaLocation = "/definitions/group/properties/order/properties/dir/oneOf/0";

                        /// <summary>
                        /// Gets the schema location from which this type was generated as a UTF-8 string.
                        /// </summary>
                        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/group/properties/order/properties/dir/oneOf/0"u8;
                            ...
                            ref JsonSchemaContext context)
                        {
                            ...
                            if (tokenType == JsonTokenType.String)
                            {
                                ...
                                if (unescapedUtf8JsonString.Span.SequenceEqual("ASC"u8))
                                {
                                    goto enumShortCircuitSuccess;
                                }

                                if (unescapedUtf8JsonString.Span.SequenceEqual("DESC"u8))
                                {
                                    goto enumShortCircuitSuccess;
                                }
                            }
