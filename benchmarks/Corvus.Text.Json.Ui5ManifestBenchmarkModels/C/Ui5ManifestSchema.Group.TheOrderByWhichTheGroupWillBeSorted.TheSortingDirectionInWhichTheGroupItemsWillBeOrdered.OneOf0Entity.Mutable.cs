            ...
            public readonly partial struct TheSortingDirectionInWhichTheGroupItemsWillBeOrdered
            {
                ...
                public readonly partial struct OneOf0Entity
                {
...
#endif
                    {
                        ...
                        /// <param name="matchAsc">Match 1st item.</param>
                        /// <param name="matchDesc">Match 2nd item.</param>
                        /// <param name="defaultMatch">Match any other value.</param>
                        /// <returns>An instance of the value returned by the match function.</returns>
                        public TResult Match<TContext, TResult>(
                            in TContext context,
                            Func<TContext, TResult> matchAsc,
                            Func<TContext, TResult> matchDesc,
...
#endif
                        {
                            ...
                            {
                                return matchAsc(context);
                            }

                            if (this.ValueEquals(Constants.Enum2))
                            {
                                return matchDesc(context);
                            }
                        ...
                        public TResult Match<TResult>(
                            Func<TResult> matchAsc,
                            Func<TResult> matchDesc,
