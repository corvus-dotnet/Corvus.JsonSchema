    ...
    public readonly partial struct HeaderTypeDefault
    {
        ...
        public readonly partial struct RepresentsTheTypeOfTheHeader
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RepresentsTheTypeOfTheHeader instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsTheTypeOfTheHeader"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsTheTypeOfTheHeader(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsTheTypeOfTheHeader.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheTypeOfTheHeader Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheTypeOfTheHeader Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsTheTypeOfTheHeader>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsTheTypeOfTheHeader instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RepresentsTheTypeOfTheHeader, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RepresentsTheTypeOfTheHeader> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RepresentsTheTypeOfTheHeader>();
                }
                finally
                {
