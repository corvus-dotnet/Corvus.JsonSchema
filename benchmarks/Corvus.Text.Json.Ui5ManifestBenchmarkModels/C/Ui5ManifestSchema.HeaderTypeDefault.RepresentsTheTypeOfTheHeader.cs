...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct HeaderTypeDefault
    {
        ...
        public readonly partial struct RepresentsTheTypeOfTheHeader
#if NET8_0_OR_GREATER
            : IJsonElement<RepresentsTheTypeOfTheHeader>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RepresentsTheTypeOfTheHeader"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RepresentsTheTypeOfTheHeader(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RepresentsTheTypeOfTheHeader DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(RepresentsTheTypeOfTheHeader value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in RepresentsTheTypeOfTheHeader left, in RepresentsTheTypeOfTheHeader right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RepresentsTheTypeOfTheHeader left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(RepresentsTheTypeOfTheHeader instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RepresentsTheTypeOfTheHeader(JsonElement instance)
            {
                return RepresentsTheTypeOfTheHeader.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheTypeOfTheHeader From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheTypeOfTheHeader ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheTypeOfTheHeader>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheTypeOfTheHeader ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheTypeOfTheHeader>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheTypeOfTheHeader ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheTypeOfTheHeader>(json, options);
            }
            ...
            /// </exception>
            public static RepresentsTheTypeOfTheHeader ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheTypeOfTheHeader>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsTheTypeOfTheHeader? result)
            {
                return JsonElementHelpers.TryParseValue<RepresentsTheTypeOfTheHeader>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RepresentsTheTypeOfTheHeader(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static RepresentsTheTypeOfTheHeader IJsonElement<RepresentsTheTypeOfTheHeader>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RepresentsTheTypeOfTheHeader: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RepresentsTheTypeOfTheHeader"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RepresentsTheTypeOfTheHeader"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public RepresentsTheTypeOfTheHeader Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RepresentsTheTypeOfTheHeader>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RepresentsTheTypeOfTheHeader"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public RepresentsTheTypeOfTheHeader Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RepresentsTheTypeOfTheHeader>(_idx);
                }
