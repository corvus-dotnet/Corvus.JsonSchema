    ...
    public readonly partial struct HeaderTypeNumeric
    {
        ...
        public readonly partial struct ExperimentalLimitTheNumberOfLinesForTheDetailsText
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ExperimentalLimitTheNumberOfLinesForTheDetailsText, Mutable>(ExperimentalLimitTheNumberOfLinesForTheDetailsText.DefaultInstance);
                ...
                public static explicit operator Mutable(ExperimentalLimitTheNumberOfLinesForTheDetailsText instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ExperimentalLimitTheNumberOfLinesForTheDetailsText"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ExperimentalLimitTheNumberOfLinesForTheDetailsText(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ExperimentalLimitTheNumberOfLinesForTheDetailsText.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ExperimentalLimitTheNumberOfLinesForTheDetailsText Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ExperimentalLimitTheNumberOfLinesForTheDetailsText Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ExperimentalLimitTheNumberOfLinesForTheDetailsText>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.HeaderTypeNumeric.ExperimentalLimitTheNumberOfLinesForTheDetailsText.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.HeaderTypeNumeric.ExperimentalLimitTheNumberOfLinesForTheDetailsText.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ExperimentalLimitTheNumberOfLinesForTheDetailsText instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ExperimentalLimitTheNumberOfLinesForTheDetailsText, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ExperimentalLimitTheNumberOfLinesForTheDetailsText> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ExperimentalLimitTheNumberOfLinesForTheDetailsText>();
                }
                finally
                {
