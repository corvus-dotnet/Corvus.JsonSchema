...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct HeaderTypeNumeric
    {
        ...
        public readonly partial struct ExperimentalLimitTheNumberOfLinesForTheSubTitle
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ExperimentalLimitTheNumberOfLinesForTheSubTitle, Mutable>(ExperimentalLimitTheNumberOfLinesForTheSubTitle.DefaultInstance);
                ...
                public static explicit operator Mutable(ExperimentalLimitTheNumberOfLinesForTheSubTitle instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ExperimentalLimitTheNumberOfLinesForTheSubTitle"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ExperimentalLimitTheNumberOfLinesForTheSubTitle(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ExperimentalLimitTheNumberOfLinesForTheSubTitle(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ExperimentalLimitTheNumberOfLinesForTheSubTitle.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ExperimentalLimitTheNumberOfLinesForTheSubTitle"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ExperimentalLimitTheNumberOfLinesForTheSubTitle"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ExperimentalLimitTheNumberOfLinesForTheSubTitle Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ExperimentalLimitTheNumberOfLinesForTheSubTitle>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ExperimentalLimitTheNumberOfLinesForTheSubTitle"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ExperimentalLimitTheNumberOfLinesForTheSubTitle Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ExperimentalLimitTheNumberOfLinesForTheSubTitle>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.HeaderTypeNumeric.ExperimentalLimitTheNumberOfLinesForTheSubTitle.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.HeaderTypeNumeric.ExperimentalLimitTheNumberOfLinesForTheSubTitle.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ExperimentalLimitTheNumberOfLinesForTheSubTitle instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ExperimentalLimitTheNumberOfLinesForTheSubTitle, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ExperimentalLimitTheNumberOfLinesForTheSubTitle> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ExperimentalLimitTheNumberOfLinesForTheSubTitle>();
                }
                finally
                {
