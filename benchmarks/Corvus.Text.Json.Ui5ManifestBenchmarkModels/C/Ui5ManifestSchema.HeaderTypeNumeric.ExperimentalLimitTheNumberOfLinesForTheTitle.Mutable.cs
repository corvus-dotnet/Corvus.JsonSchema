    ...
    public readonly partial struct HeaderTypeNumeric
    {
        ...
        public readonly partial struct ExperimentalLimitTheNumberOfLinesForTheTitle
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ExperimentalLimitTheNumberOfLinesForTheTitle, Mutable>(ExperimentalLimitTheNumberOfLinesForTheTitle.DefaultInstance);
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.HeaderTypeNumeric.ExperimentalLimitTheNumberOfLinesForTheTitle.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.HeaderTypeNumeric.ExperimentalLimitTheNumberOfLinesForTheTitle.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public static ParsedJsonDocument<ExperimentalLimitTheNumberOfLinesForTheTitle> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ExperimentalLimitTheNumberOfLinesForTheTitle>();
                }
                finally
                {
