    ...
    public readonly partial struct HeaderTypeNumericSideIndicator
    {
        ...
        public readonly partial struct TheStateColorOfTheSideIndicator
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(TheStateColorOfTheSideIndicator instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TheStateColorOfTheSideIndicator"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TheStateColorOfTheSideIndicator(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TheStateColorOfTheSideIndicator.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly TheStateColorOfTheSideIndicator Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly TheStateColorOfTheSideIndicator Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TheStateColorOfTheSideIndicator>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.HeaderTypeNumericSideIndicator.TheStateColorOfTheSideIndicator.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.HeaderTypeNumericSideIndicator.TheStateColorOfTheSideIndicator.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnumsValueColor.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(TheStateColorOfTheSideIndicator instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<TheStateColorOfTheSideIndicator, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<TheStateColorOfTheSideIndicator> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TheStateColorOfTheSideIndicator>();
                }
                finally
                {
