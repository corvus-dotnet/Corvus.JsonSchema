    ...
    public readonly partial struct HeaderTypeNumericSideIndicator
    {
        ...
        public readonly partial struct VisibilityOfTheSideIndicator
        {
...
#endif
            {
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.HeaderTypeNumericSideIndicator.VisibilityOfTheSideIndicator.OneOf0Entity" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsOneOf0Entity(out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.HeaderTypeNumericSideIndicator.VisibilityOfTheSideIndicator.OneOf0Entity result)
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.HeaderTypeNumericSideIndicator.VisibilityOfTheSideIndicator.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
