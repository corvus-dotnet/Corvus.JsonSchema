    ...
    public readonly partial struct HeaderTypeNumericSideIndicator
    {
        ...
        public readonly partial struct VisibilityOfTheSideIndicator
        {
...
#endif
            {
                ...
                /// <summary>
                /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.HeaderTypeNumericSideIndicator.VisibilityOfTheSideIndicator.OneOf0Entity"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static explicit operator Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.HeaderTypeNumericSideIndicator.VisibilityOfTheSideIndicator.OneOf0Entity.Mutable(Mutable value)
                {
                    return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.HeaderTypeNumericSideIndicator.VisibilityOfTheSideIndicator.OneOf0Entity.Mutable.From(value);
                }

                /// <summary>
                /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.HeaderTypeNumericSideIndicator.VisibilityOfTheSideIndicator.OneOf0Entity"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.HeaderTypeNumericSideIndicator.VisibilityOfTheSideIndicator.OneOf0Entity.Mutable value)
                {
                    return From(value);
                }
                ...
                public static explicit operator Mutable(VisibilityOfTheSideIndicator instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="VisibilityOfTheSideIndicator"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator VisibilityOfTheSideIndicator(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new VisibilityOfTheSideIndicator(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"VisibilityOfTheSideIndicator.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="VisibilityOfTheSideIndicator"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="VisibilityOfTheSideIndicator"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly VisibilityOfTheSideIndicator Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<VisibilityOfTheSideIndicator>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="VisibilityOfTheSideIndicator"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly VisibilityOfTheSideIndicator Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<VisibilityOfTheSideIndicator>(_idx);
                }
                ...
                /// <param name="matchOneOf0Entity">Match a <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.HeaderTypeNumericSideIndicator.VisibilityOfTheSideIndicator.OneOf0Entity"/>.</param>
                ...
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.HeaderTypeNumericSideIndicator.VisibilityOfTheSideIndicator.OneOf0Entity, TContext, TResult> matchOneOf0Entity,
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.SimpleBinding, TContext, TResult> matchSimpleBinding,
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.HeaderTypeNumericSideIndicator.VisibilityOfTheSideIndicator.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.HeaderTypeNumericSideIndicator.VisibilityOfTheSideIndicator.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchOneOf0Entity(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.HeaderTypeNumericSideIndicator.VisibilityOfTheSideIndicator.OneOf0Entity.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.HeaderTypeNumericSideIndicator.VisibilityOfTheSideIndicator.OneOf0Entity, TResult> matchOneOf0Entity,
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.SimpleBinding, TResult> matchSimpleBinding,
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.HeaderTypeNumericSideIndicator.VisibilityOfTheSideIndicator.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.HeaderTypeNumericSideIndicator.VisibilityOfTheSideIndicator.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchOneOf0Entity(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.HeaderTypeNumericSideIndicator.VisibilityOfTheSideIndicator.OneOf0Entity.Mutable.From(this));
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.HeaderTypeNumericSideIndicator.VisibilityOfTheSideIndicator.OneOf0Entity.Mutable" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsOneOf0Entity(out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.HeaderTypeNumericSideIndicator.VisibilityOfTheSideIndicator.OneOf0Entity.Mutable result)
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.HeaderTypeNumericSideIndicator.VisibilityOfTheSideIndicator.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.HeaderTypeNumericSideIndicator.VisibilityOfTheSideIndicator.OneOf0Entity.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(VisibilityOfTheSideIndicator instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.HeaderTypeNumericSideIndicator.VisibilityOfTheSideIndicator.OneOf0Entity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<VisibilityOfTheSideIndicator, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<VisibilityOfTheSideIndicator> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<VisibilityOfTheSideIndicator>();
                }
                finally
                {
