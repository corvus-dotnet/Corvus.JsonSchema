...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct Http11jsonSchemaOrg1draft071schema
    {
...
#endif
        {
            ...
            /// </summary>
            public static ItemsEntity DefaultInstance { get; } = ParsedJsonDocument<ItemsEntity>.True;
            ...
            public static explicit operator Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Http11jsonSchemaOrg1draft071schema(ItemsEntity value)
            {
                return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Http11jsonSchemaOrg1draft071schema.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator ItemsEntity(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Http11jsonSchemaOrg1draft071schema value)
            {
                return From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Http11jsonSchemaOrg1draft071schema.SchemaArray(ItemsEntity value)
            {
                return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Http11jsonSchemaOrg1draft071schema.SchemaArray.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator ItemsEntity(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Http11jsonSchemaOrg1draft071schema.SchemaArray value)
            {
                return From(value);
            }
            ...
            public bool TryGetAsHttp11jsonSchemaOrg1draft071schema(out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Http11jsonSchemaOrg1draft071schema result)
            {
                ...
                {
                    result = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Http11jsonSchemaOrg1draft071schema.From(this);
                    return true;
                }
            ...
            public bool TryGetAsSchemaArray(out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Http11jsonSchemaOrg1draft071schema.SchemaArray result)
            {
                ...
                {
                    result = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Http11jsonSchemaOrg1draft071schema.SchemaArray.From(this);
                    return true;
                }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Http11jsonSchemaOrg1draft071schema.ItemsEntity, TContext, TResult> defaultMatch)
...
#endif
            {
                if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Http11jsonSchemaOrg1draft071schema.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchHttp11jsonSchemaOrg1draft071schema(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Http11jsonSchemaOrg1draft071schema.From(this), context);
                }

                if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Http11jsonSchemaOrg1draft071schema.SchemaArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchSchemaArray(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Http11jsonSchemaOrg1draft071schema.SchemaArray.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Http11jsonSchemaOrg1draft071schema.ItemsEntity, TResult> defaultMatch)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Http11jsonSchemaOrg1draft071schema.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchHttp11jsonSchemaOrg1draft071schema(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Http11jsonSchemaOrg1draft071schema.From(this));
                }

                if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Http11jsonSchemaOrg1draft071schema.SchemaArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchSchemaArray(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Http11jsonSchemaOrg1draft071schema.SchemaArray.From(this));
                }
