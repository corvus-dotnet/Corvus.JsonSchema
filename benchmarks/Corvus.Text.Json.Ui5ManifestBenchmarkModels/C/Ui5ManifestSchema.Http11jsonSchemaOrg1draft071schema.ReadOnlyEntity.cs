...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct Http11jsonSchemaOrg1draft071schema
    {
...
#endif
        {
            ...
            internal ReadOnlyEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ReadOnlyEntity DefaultInstance { get; } = ParsedJsonDocument<ReadOnlyEntity>.False;
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ReadOnlyEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ReadOnlyEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ReadOnlyEntity(JsonElement instance)
            {
                return ReadOnlyEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ReadOnlyEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ReadOnlyEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ReadOnlyEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ReadOnlyEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ReadOnlyEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ReadOnlyEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ReadOnlyEntity>(json, options);
            }
            ...
            /// </exception>
            public static ReadOnlyEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ReadOnlyEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ReadOnlyEntity? result)
            {
                return JsonElementHelpers.TryParseValue<ReadOnlyEntity>(ref reader, out result);
            }
...
#if NET
            static ReadOnlyEntity IJsonElement<ReadOnlyEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ReadOnlyEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public ReadOnlyEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ReadOnlyEntity>(_idx);
                }
