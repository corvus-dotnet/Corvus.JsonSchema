...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct I18nKeyString
#if NET8_0_OR_GREATER
        : IJsonElement<I18nKeyString>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="I18nKeyString"/> struct.
        /// </summary>
        ...
        internal I18nKeyString(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static I18nKeyString DefaultInstance { get; }
        ...
        /// <summary>
        /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.I18nKeyString.AnyOf0Entity"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.I18nKeyString.AnyOf0Entity(I18nKeyString value)
        {
            return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.I18nKeyString.AnyOf0Entity.From(value);
        }

        /// <summary>
        /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.I18nKeyString.AnyOf0Entity"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator I18nKeyString(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.I18nKeyString.AnyOf0Entity value)
        {
            return From(value);
        }
        ...
        /// </returns>
        public static bool operator ==(in I18nKeyString left, in I18nKeyString right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in I18nKeyString left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(I18nKeyString instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator I18nKeyString(JsonElement instance)
        {
            return I18nKeyString.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static I18nKeyString From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static I18nKeyString ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<I18nKeyString>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static I18nKeyString ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<I18nKeyString>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static I18nKeyString ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<I18nKeyString>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static I18nKeyString ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<I18nKeyString>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out I18nKeyString? result)
        {
            return JsonElementHelpers.TryParseValue<I18nKeyString>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new I18nKeyString(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static I18nKeyString IJsonElement<I18nKeyString>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"I18nKeyString: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="I18nKeyString"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="I18nKeyString"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public I18nKeyString Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<I18nKeyString>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="I18nKeyString"/> that lives for the lifetime of its
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.I18nKeyString.AnyOf0Entity" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsAnyOf0Entity(out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.I18nKeyString.AnyOf0Entity result)
        {
            if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.I18nKeyString.AnyOf0Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.I18nKeyString.AnyOf0Entity.From(this);
                return true;
            }
        ...
        /// <param name="matchAnyOf0Entity">Match a <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.I18nKeyString.AnyOf0Entity"/>.</param>
        ...
        public TResult Match<TContext, TResult>(
            in TContext context,
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.I18nKeyString.AnyOf0Entity, TContext, TResult> matchAnyOf0Entity,
            Matcher<Corvus.Ui5ManifestBenchmark.Current.JsonString, TContext, TResult> matchJsonString,
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.I18nKeyString, TContext, TResult> defaultMatch)
...
#endif
        {
            if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.I18nKeyString.AnyOf0Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchAnyOf0Entity(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.I18nKeyString.AnyOf0Entity.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.I18nKeyString.AnyOf0Entity, TResult> matchAnyOf0Entity,
            Matcher<Corvus.Ui5ManifestBenchmark.Current.JsonString, TResult> matchJsonString,
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.I18nKeyString, TResult> defaultMatch)
        {
            if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.I18nKeyString.AnyOf0Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchAnyOf0Entity(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.I18nKeyString.AnyOf0Entity.From(this));
            }
        ...
        public TAccumulator MatchEvery<TAccumulator>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.I18nKeyString.AnyOf0Entity, TAccumulator, TAccumulator> matchAnyOf0Entity,
            Matcher<Corvus.Ui5ManifestBenchmark.Current.JsonString, TAccumulator, TAccumulator> matchJsonString,
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.I18nKeyString, TAccumulator, TAccumulator> defaultMatch)
        {
            bool matched = false;
            ...
            {
                matched = true;
                accumulator = matchAnyOf0Entity(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.I18nKeyString.AnyOf0Entity.From(this), accumulator);
            }
