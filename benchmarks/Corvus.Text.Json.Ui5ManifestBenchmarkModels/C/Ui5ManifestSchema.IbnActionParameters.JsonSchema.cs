...
public readonly partial struct Ui5ManifestSchema
{
        ...
        : IJsonElement<IbnActionParameters>
    {
        ...
        {
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyIbnTargetPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("ibnTarget"u8, buffer, out written);
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyIbnTargetNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("ibnTarget"u8, buffer, out written);

            private const int RequiredOffsetForIbnTarget = 0;
            private const uint RequiredBitForIbnTarget = 0b00000000000000000000000000000001;

            private const uint RequiredBitMask0 =
                RequiredBitForIbnTarget;

            private static void MatchIbnTarget(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                requiredBitBuffer[RequiredOffsetForIbnTarget] |= RequiredBitForIbnTarget;
            }
            ...
            {
                if (span.SequenceEqual(JsonPropertyNames.IbnTargetUtf8))
                {
                    matcher = MatchIbnTarget;
                    return true;
                }
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("ui5-manifest-schema.json#/definitions/ibnActionParameters"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "ui5-manifest-schema.json#/definitions/ibnActionParameters";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "ui5-manifest-schema.json#/definitions/ibnActionParameters"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyIbnTargetPresent, "ibnTarget"u8, "required"u8);
                    }
                    ...
                    {
                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForIbnTarget] & RequiredBitForIbnTarget) == 0)
                        {
                            context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyIbnTargetNotPresent, "ibnTarget"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyIbnTargetPresent, "ibnTarget"u8, "required"u8);
