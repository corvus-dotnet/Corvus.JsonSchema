...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct IbnActionParameters
    {
...
#endif
        {
            ...
            public void SetIbnTarget(scoped in Corvus.Text.Json.JsonElement.Source value)
            {
                CheckValidInstance();
                ...
                else
                {
                    ...
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.IbnTarget, ref cvb);
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.IbnActionParameters.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.IbnActionParameters.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            {
                ibnTarget.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.IbnTarget, ref builder);
            }
        ...
        /// </summary>
        /// <param name="ibnTarget">The value of the <c>"ibnTarget"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.Text.Json.JsonElement.Source ibnTarget)
        {
            return new Source(ibnTarget);
        }
        ...
        /// <param name="ibnTarget">The value of the <c>"ibnTarget"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.JsonElement.Source<TContext> ibnTarget)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            return new Source<TContext>(context, ibnTarget);
        }
        ...
        public static ParsedJsonDocument<IbnActionParameters> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<IbnActionParameters>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<IbnActionParameters> Create<TContext>(
        ...
        public static ParsedJsonDocument<IbnActionParameters> Create(in Corvus.Text.Json.JsonElement.Source ibnTarget, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<IbnActionParameters> Create<TContext>(in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> ibnTarget, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
