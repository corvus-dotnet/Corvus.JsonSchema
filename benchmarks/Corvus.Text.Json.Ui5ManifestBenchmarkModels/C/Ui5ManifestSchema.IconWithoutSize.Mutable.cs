...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct IconWithoutSize
    {
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.IconWithoutSize.RepresentsTheShapeOfTheIcon.Source _createArg4;
            ...
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.IconWithoutSize.VisibilityOfTheIcon.Source _createArg7;
        ...
        public static ParsedJsonDocument<IconWithoutSize> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<IconWithoutSize>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<IconWithoutSize> Create<TContext>(
        ...
        public static ParsedJsonDocument<IconWithoutSize> Create(in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source alt = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.IconBackgroundColor.Source backgroundColor = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source initials = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.IconWithoutSize.RepresentsTheShapeOfTheIcon.Source shape = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source src = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source text = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.IconWithoutSize.VisibilityOfTheIcon.Source visible = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
