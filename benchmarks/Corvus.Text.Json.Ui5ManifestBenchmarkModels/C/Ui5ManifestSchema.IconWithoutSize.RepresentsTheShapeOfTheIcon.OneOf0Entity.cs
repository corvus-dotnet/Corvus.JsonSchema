    ...
    public readonly partial struct IconWithoutSize
    {
        ...
        public readonly partial struct RepresentsTheShapeOfTheIcon
        {
...
#endif
            {
                ...
                /// </summary>
                public static OneOf0Entity DefaultInstance { get; } = ParsedJsonDocument<OneOf0Entity>.StringConstant([.."\"Circle\""u8]);
                ...
                /// <param name="matchSquare">Match 1st item.</param>
                /// <param name="matchCircle">Match 2nd item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> matchSquare,
                    Func<TContext, TResult> matchCircle,
...
#endif
                {
                    ...
                    {
                        return matchSquare(context);
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchCircle(context);
                    }
                ...
                public TResult Match<TResult>(
                    Func<TResult> matchSquare,
                    Func<TResult> matchCircle,
