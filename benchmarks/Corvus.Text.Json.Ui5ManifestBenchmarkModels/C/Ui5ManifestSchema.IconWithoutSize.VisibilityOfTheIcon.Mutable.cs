    ...
    public readonly partial struct IconWithoutSize
    {
        ...
        public readonly partial struct VisibilityOfTheIcon
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(VisibilityOfTheIcon instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="VisibilityOfTheIcon"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator VisibilityOfTheIcon(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"VisibilityOfTheIcon.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly VisibilityOfTheIcon Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly VisibilityOfTheIcon Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<VisibilityOfTheIcon>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.IconWithoutSize.VisibilityOfTheIcon.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.IconWithoutSize.VisibilityOfTheIcon.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(VisibilityOfTheIcon instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<VisibilityOfTheIcon, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<VisibilityOfTheIcon> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<VisibilityOfTheIcon>();
                }
                finally
                {
