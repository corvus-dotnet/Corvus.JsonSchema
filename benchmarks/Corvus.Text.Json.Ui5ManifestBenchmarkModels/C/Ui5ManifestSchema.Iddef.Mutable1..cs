...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct Iddef
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Iddef instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Iddef"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Iddef(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Iddef.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly Iddef Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Iddef>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(Iddef instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<Iddef, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<Iddef> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Iddef>();
            }
            finally
            {
