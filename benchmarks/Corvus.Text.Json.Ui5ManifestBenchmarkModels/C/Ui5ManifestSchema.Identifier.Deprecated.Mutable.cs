    ...
    public readonly partial struct Identifier
    {
        ...
        public readonly partial struct Deprecated
        {
...
#endif
            {
                ...
                public void SetTargetValue(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Target.Source value)
                {
                    CheckValidInstance();
            ...
            public ref struct Source
            {
                ...
                internal Source(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Target.Source arg1, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source arg2)
                {
                    _createArg1 = arg1;
                    _createArg2 = arg2;
                    _kind = Kind.Create;
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Target.Source<TContext> arg1, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source arg2)
                {
                    _context = context;
                    _createArg1 = arg1;
                    _createArg2 = arg2;
            ...
            public ref struct Builder
            {
                ...
                internal static void BuildCreateValue(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Target.Source arg1, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source arg2, ref ComplexValueBuilder o)
                {
                    o.StartObject();
                ...
                /// <param name="arg2">The value of the property.</param>
                /// <param name="o">The complex value builder into which to write the object.</param>
                internal static void BuildCreateValue<TContext>(scoped in TContext context, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Target.Source<TContext> arg1, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source arg2, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Target.Source target = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source url = default)
            {
            ...
            /// <param name="url">The value of the <c>"url"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Target.Source<TContext> target = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source url = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
