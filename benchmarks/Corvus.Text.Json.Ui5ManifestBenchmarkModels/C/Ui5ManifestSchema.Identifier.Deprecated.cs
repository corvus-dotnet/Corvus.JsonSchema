...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct Identifier
    {
        ...
        public readonly partial struct Deprecated
#if NET8_0_OR_GREATER
            : IJsonElement<Deprecated>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="Deprecated"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal Deprecated(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static Deprecated DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Target TargetValue
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TargetValueUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Target value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in Deprecated left, in Deprecated right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in Deprecated left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(Deprecated instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Deprecated(JsonElement instance)
            {
                return Deprecated.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Deprecated From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Deprecated ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Deprecated>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Deprecated ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Deprecated>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Deprecated ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<Deprecated>(json, options);
            }
            ...
            /// </exception>
            public static Deprecated ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<Deprecated>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out Deprecated? result)
            {
                return JsonElementHelpers.TryParseValue<Deprecated>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new Deprecated(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static Deprecated IJsonElement<Deprecated>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Deprecated: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="Deprecated"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="Deprecated"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            {
                CheckValidInstance();
                return _parent.CloneElement<Deprecated>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="Deprecated"/> that lives for the lifetime of its
            ...
            {
                /// <summary>
                /// Gets the JSON property name for <see cref="TargetValue"/>.
                /// </summary>
                ...
                /// Gets the JSON property name for <see cref="TargetValue"/>.
                /// </summary>
                public static ReadOnlySpan<byte> TargetValueUtf8 => "target"u8;
            ...
            {
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="TargetValue"/>.
                /// </summary>
                public static ReadOnlySpan<byte> TargetValue => "target"u8;
            ...
            {
                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="TargetValue"/>.
                /// </summary>
                public static ReadOnlySpan<byte> TargetValue => [0x85, 0x00, 0x00, 0x00, 0x22, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x22];
