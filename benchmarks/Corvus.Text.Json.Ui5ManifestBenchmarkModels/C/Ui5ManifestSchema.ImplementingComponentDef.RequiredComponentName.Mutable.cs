    ...
    public readonly partial struct ImplementingComponentDef
    {
        ...
        public readonly partial struct RequiredComponentName
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ImplementingComponentDef.RequiredComponentName.ComponentNameEntity.Mutable ComponentName
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ComponentNameUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ImplementingComponentDef.RequiredComponentName.ComponentNameEntity.Mutable value))
                        {
                            return value;
                        }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ImplementingComponentDef.RequiredComponentName.ComponentNameEntity.Source _createArg1;
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ImplementingComponentDef.RequiredComponentName.ComponentNameEntity.Source componentName,
            ...
            public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ImplementingComponentDef.RequiredComponentName.ComponentNameEntity.Source componentName, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source binding = default, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ComponentPagesDef.Source<TContext> pages = default, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonObject.Source<TContext> settings = default)
                ...
                #endif
            {
                return new Source<TContext>(context, componentName, binding, pages, settings);
            }
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ImplementingComponentDef.RequiredComponentName.ComponentNameEntity.Source componentName, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source binding = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ComponentPagesDef.Source pages = default, in Corvus.Ui5ManifestBenchmark.Current.JsonObject.Source settings = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ImplementingComponentDef.RequiredComponentName.ComponentNameEntity.Source componentName, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source binding = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ComponentPagesDef.Source<TContext> pages = default, in Corvus.Ui5ManifestBenchmark.Current.JsonObject.Source<TContext> settings = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
            ...
            public static ParsedJsonDocument<RequiredComponentName> Create(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ImplementingComponentDef.RequiredComponentName.ComponentNameEntity.Source componentName, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source binding = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ComponentPagesDef.Source pages = default, in Corvus.Ui5ManifestBenchmark.Current.JsonObject.Source settings = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RequiredComponentName> Create<TContext>(in TContext context, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ImplementingComponentDef.RequiredComponentName.ComponentNameEntity.Source componentName, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source binding = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ComponentPagesDef.Source<TContext> pages = default, in Corvus.Ui5ManifestBenchmark.Current.JsonObject.Source<TContext> settings = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
