...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct ImplementingComponentDef
    {
        ...
        public readonly partial struct RequiredComponentUsage
            : IJsonElement<RequiredComponentUsage>
        {
            public static partial class JsonSchema
            {
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyComponentUsagePresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("componentUsage"u8, buffer, out written);
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyComponentUsageNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("componentUsage"u8, buffer, out written);

                private const int RequiredOffsetForComponentUsage = 0;
                private const uint RequiredBitForComponentUsage = 0b00000000000000000000000000000001;

                private const uint RequiredBitMask0 =
                    RequiredBitForComponentUsage;
                ...
                private static readonly JsonSchemaPathProvider ComponentUsageSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/componentUsage"u8, buffer, out written);
                ...
                private static void MatchComponentUsage(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext1 =
                        Corvus.Ui5ManifestBenchmark.Current.JsonString.JsonSchema.PushChildContextUnescaped(
                            ...
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.ComponentUsageUtf8,
                            evaluationPath: ComponentUsageSchemaEvaluationPath);
                    ...
                    requiredBitBuffer[RequiredOffsetForComponentUsage] |= RequiredBitForComponentUsage;
                }
                ...
                private static void MatchPages(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    ...
                    JsonSchemaContext childContext2 =
                        Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ComponentPagesDef.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                    ...
                    Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ComponentPagesDef.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
                ...
                private static PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
                {
                    return new PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator>([
                        ...
                        (static () => JsonPropertyNames.ComponentUsageUtf8, MatchComponentUsage),
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyComponentUsagePresent, "componentUsage"u8, "required"u8);
                        }
                        ...
                        {
                            if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForComponentUsage] & RequiredBitForComponentUsage) == 0)
                            {
                                context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyComponentUsageNotPresent, "componentUsage"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyComponentUsagePresent, "componentUsage"u8, "required"u8);
