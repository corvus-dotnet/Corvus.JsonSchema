...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct Inbound
    {
        ...
        public readonly partial struct RequiredActionAndSemanticObject
        {
            ...
            public readonly partial struct RepresentsDataSource
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(RepresentsDataSource instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="RepresentsDataSource"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RepresentsDataSource(Mutable instance)
                    {
                    ...
                    /// <summary>
                    /// Gets the <c>dataSource</c> property.
                    /// </summary>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.Ui5ManifestBenchmark.Current.JsonNumber.Mutable Refresh
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RefreshUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonNumber.Mutable value))
                            {
                                return value;
                            }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new RepresentsDataSource(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    public void SetDataSource(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source value)
                    {
                        ...
                        {
                            CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("dataSource");
                        }
                    ...
                    /// </summary>
                    /// <param name="value">The value of the property to add.</param>
                    public void SetRefresh(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonNumber.Source value)
                    {
                        CheckValidInstance();
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RepresentsDataSource.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="RepresentsDataSource"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="RepresentsDataSource"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RepresentsDataSource Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<RepresentsDataSource>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="RepresentsDataSource"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RepresentsDataSource Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<RepresentsDataSource>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    private readonly Corvus.Ui5ManifestBenchmark.Current.JsonNumber.Source _createArg3;
                    ...
                    internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Inbound.RequiredActionAndSemanticObject.RepresentsDataSource.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    internal Source(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source arg1, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source arg2, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonNumber.Source arg3)
                    {
                        _createArg1 = arg1;
                        _createArg2 = arg2;
                        _createArg3 = arg3;
                    ...
                    public static implicit operator Source(RepresentsDataSource instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Inbound.RequiredActionAndSemanticObject.RepresentsDataSource.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// <summary>
                    /// Creates an instance of a <see cref="RepresentsDataSource"/>.
                    /// </summary>
                    internal static void Create(
                        ref ComplexValueBuilder builder,
                        in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source dataSource,
                        in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source path,
                        in Corvus.Ui5ManifestBenchmark.Current.JsonNumber.Source refresh = default)
                    {
                    ...
                    public void Create(
                        ...
                        in Corvus.Ui5ManifestBenchmark.Current.JsonNumber.Source refresh = default)
                    {
                        Create(ref _builder, dataSource, path, refresh);
                    }
                    ...
                    internal static void BuildCreateValue(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source arg1, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source arg2, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonNumber.Source arg3, ref ComplexValueBuilder o)
                    {
                        o.StartObject();
                ...
                /// <param name="refresh">The value of the <c>"refresh"</c> property.</param>
                /// <returns>The source from which to build the value.</returns>
                public static Source Build(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source dataSource, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source path, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonNumber.Source refresh = default)
                {
                    return new Source(dataSource, path, refresh);
                }
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source dataSource, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source path, in Corvus.Ui5ManifestBenchmark.Current.JsonNumber.Source refresh = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                    Builder ovb = new(cvb);
                    ovb.Create(dataSource, path, refresh);
                    cvb = ovb._builder;
                    cvb.EndObject();
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
                ...
                {
                    return workspace.CreateBuilder<RepresentsDataSource, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<RepresentsDataSource> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<RepresentsDataSource>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<RepresentsDataSource> Create<TContext>(
                ...
                public static ParsedJsonDocument<RepresentsDataSource> Create(in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source dataSource, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source path, in Corvus.Ui5ManifestBenchmark.Current.JsonNumber.Source refresh = default, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
