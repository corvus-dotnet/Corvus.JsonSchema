    ...
    public readonly partial struct Inbound
    {
        ...
        public readonly partial struct RequiredActionAndSemanticObject
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="RepresentsDataSource"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal RepresentsDataSource(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static RepresentsDataSource DefaultInstance { get; }
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Current.JsonNumber Refresh
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RefreshUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonNumber value))
                        {
                            return value;
                        }
                ...
                /// </returns>
                public static bool operator ==(in RepresentsDataSource left, in RepresentsDataSource right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in RepresentsDataSource left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(RepresentsDataSource instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsDataSource(JsonElement instance)
                {
                    return RepresentsDataSource.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RepresentsDataSource From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RepresentsDataSource ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RepresentsDataSource>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RepresentsDataSource ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RepresentsDataSource>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RepresentsDataSource ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RepresentsDataSource>(json, options);
                }
                ...
                /// </exception>
                public static RepresentsDataSource ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<RepresentsDataSource>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsDataSource? result)
                {
                    return JsonElementHelpers.TryParseValue<RepresentsDataSource>(ref reader, out result);
                }
...
#if NET
                static RepresentsDataSource IJsonElement<RepresentsDataSource>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsDataSource: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public RepresentsDataSource Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public RepresentsDataSource Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<RepresentsDataSource>(_idx);
                    }
