        ...
        public readonly partial struct RequiredActionAndSemanticObject
        {
            ...
            public readonly partial struct RepresentsSemanticObject
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(RepresentsSemanticObject instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="RepresentsSemanticObject"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RepresentsSemanticObject(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new RepresentsSemanticObject(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RepresentsSemanticObject.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="RepresentsSemanticObject"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="RepresentsSemanticObject"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RepresentsSemanticObject Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<RepresentsSemanticObject>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="RepresentsSemanticObject"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RepresentsSemanticObject Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<RepresentsSemanticObject>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(RepresentsSemanticObject instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<RepresentsSemanticObject, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<RepresentsSemanticObject> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<RepresentsSemanticObject>();
                    }
                    finally
                    {
