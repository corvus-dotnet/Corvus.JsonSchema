        ...
        public readonly partial struct RequiredActionAndSemanticObject
        {
            ...
            public readonly partial struct RepresentsTheDisplayModeOfTheTile
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<RepresentsTheDisplayModeOfTheTile, Mutable>(RepresentsTheDisplayModeOfTheTile.DefaultInstance);
                ...
                public ref struct Source
                {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Source(KnownValues value) => (RepresentsTheDisplayModeOfTheTile)value;
                ...
                public static ParsedJsonDocument<RepresentsTheDisplayModeOfTheTile> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<RepresentsTheDisplayModeOfTheTile>();
                    }
                    finally
                    {
