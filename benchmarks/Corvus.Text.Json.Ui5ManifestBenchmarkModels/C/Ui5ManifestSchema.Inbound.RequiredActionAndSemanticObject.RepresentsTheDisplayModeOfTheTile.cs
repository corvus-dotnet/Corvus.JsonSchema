    ...
    public readonly partial struct Inbound
    {
        ...
        public readonly partial struct RequiredActionAndSemanticObject
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="RepresentsTheDisplayModeOfTheTile"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal RepresentsTheDisplayModeOfTheTile(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static RepresentsTheDisplayModeOfTheTile DefaultInstance { get; } = ParsedJsonDocument<RepresentsTheDisplayModeOfTheTile>.StringConstant([.."\"ContentMode\""u8]);
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(RepresentsTheDisplayModeOfTheTile value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in RepresentsTheDisplayModeOfTheTile left, in RepresentsTheDisplayModeOfTheTile right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in RepresentsTheDisplayModeOfTheTile left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(RepresentsTheDisplayModeOfTheTile instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsTheDisplayModeOfTheTile(JsonElement instance)
                {
                    return RepresentsTheDisplayModeOfTheTile.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RepresentsTheDisplayModeOfTheTile From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RepresentsTheDisplayModeOfTheTile ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RepresentsTheDisplayModeOfTheTile>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RepresentsTheDisplayModeOfTheTile ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RepresentsTheDisplayModeOfTheTile>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RepresentsTheDisplayModeOfTheTile ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RepresentsTheDisplayModeOfTheTile>(json, options);
                }
                ...
                /// </exception>
                public static RepresentsTheDisplayModeOfTheTile ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<RepresentsTheDisplayModeOfTheTile>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsTheDisplayModeOfTheTile? result)
                {
                    return JsonElementHelpers.TryParseValue<RepresentsTheDisplayModeOfTheTile>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new RepresentsTheDisplayModeOfTheTile(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static RepresentsTheDisplayModeOfTheTile IJsonElement<RepresentsTheDisplayModeOfTheTile>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsTheDisplayModeOfTheTile: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="RepresentsTheDisplayModeOfTheTile"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="RepresentsTheDisplayModeOfTheTile"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public RepresentsTheDisplayModeOfTheTile Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<RepresentsTheDisplayModeOfTheTile>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="RepresentsTheDisplayModeOfTheTile"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public RepresentsTheDisplayModeOfTheTile Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<RepresentsTheDisplayModeOfTheTile>(_idx);
                    }
                ...
                /// <param name="matchContentMode">Match 1st item.</param>
                /// <param name="matchHeaderMode">Match 2nd item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> matchContentMode,
                    Func<TContext, TResult> matchHeaderMode,
...
#endif
                {
                    ...
                    {
                        return matchContentMode(context);
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchHeaderMode(context);
                    }
                ...
                public TResult Match<TResult>(
                    Func<TResult> matchContentMode,
                    Func<TResult> matchHeaderMode,
                    Func<TResult> defaultMatch)
                {
                    if (this.ValueEquals(Constants.Enum1))
                    {
                        return matchContentMode();
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchHeaderMode();
                    }
