...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapCopilotNamespace
    {
        ...
        public readonly partial struct SettingsForTheContextAnalysisFeaturesOfSapCoPilot
        {
            ...
            public readonly partial struct AllowAddingObjectsFromAppScreenToCollectionEntity
#if NET8_0_OR_GREATER
                : IJsonElement<AllowAddingObjectsFromAppScreenToCollectionEntity>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="AllowAddingObjectsFromAppScreenToCollectionEntity"/> struct.
                /// </summary>
                ...
                internal AllowAddingObjectsFromAppScreenToCollectionEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static AllowAddingObjectsFromAppScreenToCollectionEntity DefaultInstance { get; } = ParsedJsonDocument<AllowAddingObjectsFromAppScreenToCollectionEntity>.True;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(AllowAddingObjectsFromAppScreenToCollectionEntity value)
                {
                ...
                /// </returns>
                public static bool operator ==(in AllowAddingObjectsFromAppScreenToCollectionEntity left, in AllowAddingObjectsFromAppScreenToCollectionEntity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in AllowAddingObjectsFromAppScreenToCollectionEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(AllowAddingObjectsFromAppScreenToCollectionEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AllowAddingObjectsFromAppScreenToCollectionEntity(JsonElement instance)
                {
                    return AllowAddingObjectsFromAppScreenToCollectionEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AllowAddingObjectsFromAppScreenToCollectionEntity From<T>(in T instance)
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AllowAddingObjectsFromAppScreenToCollectionEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<AllowAddingObjectsFromAppScreenToCollectionEntity>(utf8Json, options);
                ...
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AllowAddingObjectsFromAppScreenToCollectionEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<AllowAddingObjectsFromAppScreenToCollectionEntity>(json, options);
                    #pragma warning restore CS0618
                }
                ...
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AllowAddingObjectsFromAppScreenToCollectionEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<AllowAddingObjectsFromAppScreenToCollectionEntity>(json, options);
                    #pragma warning restore CS0618
                ...
                /// </exception>
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                public static AllowAddingObjectsFromAppScreenToCollectionEntity ParseValue(ref Utf8JsonReader reader)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<AllowAddingObjectsFromAppScreenToCollectionEntity>(ref reader);
                    #pragma warning restore CS0618
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out AllowAddingObjectsFromAppScreenToCollectionEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<AllowAddingObjectsFromAppScreenToCollectionEntity>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new AllowAddingObjectsFromAppScreenToCollectionEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static AllowAddingObjectsFromAppScreenToCollectionEntity IJsonElement<AllowAddingObjectsFromAppScreenToCollectionEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AllowAddingObjectsFromAppScreenToCollectionEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="AllowAddingObjectsFromAppScreenToCollectionEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="AllowAddingObjectsFromAppScreenToCollectionEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public AllowAddingObjectsFromAppScreenToCollectionEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<AllowAddingObjectsFromAppScreenToCollectionEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="AllowAddingObjectsFromAppScreenToCollectionEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public AllowAddingObjectsFromAppScreenToCollectionEntity Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<AllowAddingObjectsFromAppScreenToCollectionEntity>(_idx);
                    }
