    ...
    public readonly partial struct JsonSchemaForSapApfNamespace
    {
        ...
        public readonly partial struct ActivateFilterReductionEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ActivateFilterReductionEntity, Mutable>(ActivateFilterReductionEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(ActivateFilterReductionEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ActivateFilterReductionEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ActivateFilterReductionEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ActivateFilterReductionEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ActivateFilterReductionEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ActivateFilterReductionEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ActivateFilterReductionEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ActivateFilterReductionEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ActivateFilterReductionEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ActivateFilterReductionEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ActivateFilterReductionEntity>();
                }
                finally
                {
