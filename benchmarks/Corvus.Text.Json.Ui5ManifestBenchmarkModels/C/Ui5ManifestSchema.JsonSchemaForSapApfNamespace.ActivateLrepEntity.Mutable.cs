    ...
    public readonly partial struct JsonSchemaForSapApfNamespace
    {
        ...
        public readonly partial struct ActivateLrepEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ActivateLrepEntity, Mutable>(ActivateLrepEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(ActivateLrepEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ActivateLrepEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ActivateLrepEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ActivateLrepEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ActivateLrepEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ActivateLrepEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ActivateLrepEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ActivateLrepEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ActivateLrepEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ActivateLrepEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ActivateLrepEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ActivateLrepEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ActivateLrepEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ActivateLrepEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ActivateLrepEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ActivateLrepEntity>();
                }
                finally
                {
