    ...
    public readonly partial struct JsonSchemaForSapApfNamespace
    {
...
#endif
        {
            ...
            public void SetActivateFilterReduction(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapApfNamespace.ActivateFilterReductionEntity.Source value)
            {
                ...
                {
                    // We are going to insert the new value
                    value.AddAsProperty(JsonPropertyNamesEscaped.ActivateFilterReduction, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            public void SetActivateLrep(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapApfNamespace.ActivateLrepEntity.Source value)
            {
                ...
                {
                    // We are going to insert the new value
                    value.AddAsProperty(JsonPropertyNamesEscaped.ActivateLrep, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            public void SetUseHeadRequestForXsrfToken(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapApfNamespace.UseHeadRequestForXsrfTokenEntity.Source value)
            {
                ...
                {
                    // We are going to insert the new value
                    value.AddAsProperty(JsonPropertyNamesEscaped.UseHeadRequestForXsrfToken, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
        ...
        public ref struct Builder
        {
                ...
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapApfNamespace.UseHeadRequestForXsrfTokenEntity.Source useHeadRequestForXsrfToken = default)
            {
                ...
                activateFilterReduction.AddAsProperty(JsonPropertyNamesEscaped.ActivateFilterReduction, ref builder, escapeName: false);
                activateLrep.AddAsProperty(JsonPropertyNamesEscaped.ActivateLrep, ref builder, escapeName: false);
                useHeadRequestForXsrfToken.AddAsProperty(JsonPropertyNamesEscaped.UseHeadRequestForXsrfToken, ref builder, escapeName: false);
            }
