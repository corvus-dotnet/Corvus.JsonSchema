    ...
    public readonly partial struct JsonSchemaForSapApfNamespace
    {
        ...
        public readonly partial struct UseHeadRequestForXsrfTokenEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<UseHeadRequestForXsrfTokenEntity, Mutable>(UseHeadRequestForXsrfTokenEntity.DefaultInstance);
            ...
            public static ParsedJsonDocument<UseHeadRequestForXsrfTokenEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<UseHeadRequestForXsrfTokenEntity>();
                }
                finally
                {
