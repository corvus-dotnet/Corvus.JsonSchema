...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapApfNamespace
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="UseHeadRequestForXsrfTokenEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal UseHeadRequestForXsrfTokenEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static UseHeadRequestForXsrfTokenEntity DefaultInstance { get; } = ParsedJsonDocument<UseHeadRequestForXsrfTokenEntity>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(UseHeadRequestForXsrfTokenEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in UseHeadRequestForXsrfTokenEntity left, in UseHeadRequestForXsrfTokenEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in UseHeadRequestForXsrfTokenEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(UseHeadRequestForXsrfTokenEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator UseHeadRequestForXsrfTokenEntity(JsonElement instance)
            {
                return UseHeadRequestForXsrfTokenEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static UseHeadRequestForXsrfTokenEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static UseHeadRequestForXsrfTokenEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<UseHeadRequestForXsrfTokenEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static UseHeadRequestForXsrfTokenEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<UseHeadRequestForXsrfTokenEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static UseHeadRequestForXsrfTokenEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<UseHeadRequestForXsrfTokenEntity>(json, options);
            }
            ...
            /// </exception>
            public static UseHeadRequestForXsrfTokenEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<UseHeadRequestForXsrfTokenEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out UseHeadRequestForXsrfTokenEntity? result)
            {
                return JsonElementHelpers.TryParseValue<UseHeadRequestForXsrfTokenEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new UseHeadRequestForXsrfTokenEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static UseHeadRequestForXsrfTokenEntity IJsonElement<UseHeadRequestForXsrfTokenEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"UseHeadRequestForXsrfTokenEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="UseHeadRequestForXsrfTokenEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="UseHeadRequestForXsrfTokenEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public UseHeadRequestForXsrfTokenEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<UseHeadRequestForXsrfTokenEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="UseHeadRequestForXsrfTokenEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public UseHeadRequestForXsrfTokenEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<UseHeadRequestForXsrfTokenEntity>(_idx);
                }
