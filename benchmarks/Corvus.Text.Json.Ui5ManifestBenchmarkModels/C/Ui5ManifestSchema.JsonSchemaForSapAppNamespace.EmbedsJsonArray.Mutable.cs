...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapAppNamespace
    {
        ...
        public readonly partial struct EmbedsJsonArray
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(EmbedsJsonArray instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="EmbedsJsonArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator EmbedsJsonArray(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new EmbedsJsonArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"EmbedsJsonArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// <summary>
                /// Gets a <see cref="EmbedsJsonArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="EmbedsJsonArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly EmbedsJsonArray Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<EmbedsJsonArray>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="EmbedsJsonArray"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly EmbedsJsonArray Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<EmbedsJsonArray>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapAppNamespace.EmbedsJsonArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(EmbedsJsonArray instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapAppNamespace.EmbedsJsonArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<EmbedsJsonArray, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<EmbedsJsonArray> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<EmbedsJsonArray>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<EmbedsJsonArray> Create<TContext>(
