        ...
        public readonly partial struct I18nEntity
        {
            ...
            public readonly partial struct RequiredBundleName
            {
                ...
                public ref struct Source
                {
                    ...
                    private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapAppNamespace.I18nEntity.RequiredBundleName.EnhanceWithSettingArray.Source _createArg2;
                    ...
                    private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapAppNamespace.I18nEntity.RequiredBundleName.RepresentsTerminologiesWithAdditionalPropertiesFiles.Source _createArg5;
                    ...
                    #endif
                {
                    ...
                    private readonly Corvus.Ui5ManifestBenchmark.Current.JsonString.Source _createArg1;
                    private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapAppNamespace.I18nEntity.RequiredBundleName.EnhanceWithSettingArray.Source<TContext> _createArg2;
                    private readonly Corvus.Ui5ManifestBenchmark.Current.JsonString.Source _createArg3;
                    private readonly Corvus.Ui5ManifestBenchmark.Current.JsonArray.Source<TContext> _createArg4;
                    private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapAppNamespace.I18nEntity.RequiredBundleName.RepresentsTerminologiesWithAdditionalPropertiesFiles.Source<TContext> _createArg5;
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
                public static ParsedJsonDocument<RequiredBundleName> Create<TContext>(in TContext context, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source bundleName, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapAppNamespace.I18nEntity.RequiredBundleName.EnhanceWithSettingArray.Source<TContext> enhanceWith = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source fallbackLocale = default, in Corvus.Ui5ManifestBenchmark.Current.JsonArray.Source<TContext> supportedLocales = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapAppNamespace.I18nEntity.RequiredBundleName.RepresentsTerminologiesWithAdditionalPropertiesFiles.Source<TContext> terminologies = default, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
