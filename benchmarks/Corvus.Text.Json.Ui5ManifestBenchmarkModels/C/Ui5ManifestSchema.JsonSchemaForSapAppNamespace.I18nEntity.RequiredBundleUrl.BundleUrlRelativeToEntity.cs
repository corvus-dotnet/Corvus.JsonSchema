        ...
        public readonly partial struct I18nEntity
        {
            ...
            public readonly partial struct RequiredBundleUrl
            {
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="BundleUrlRelativeToEntity"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal BundleUrlRelativeToEntity(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static BundleUrlRelativeToEntity DefaultInstance { get; } = ParsedJsonDocument<BundleUrlRelativeToEntity>.StringConstant([.."\"component\""u8]);
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static explicit operator string(BundleUrlRelativeToEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                    ...
                    /// </returns>
                    public static bool operator ==(in BundleUrlRelativeToEntity left, in BundleUrlRelativeToEntity right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in BundleUrlRelativeToEntity left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator JsonElement(BundleUrlRelativeToEntity instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator BundleUrlRelativeToEntity(JsonElement instance)
                    {
                        return BundleUrlRelativeToEntity.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static BundleUrlRelativeToEntity From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static BundleUrlRelativeToEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<BundleUrlRelativeToEntity>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static BundleUrlRelativeToEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<BundleUrlRelativeToEntity>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static BundleUrlRelativeToEntity ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<BundleUrlRelativeToEntity>(json, options);
                    }
                    ...
                    /// </exception>
                    public static BundleUrlRelativeToEntity ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<BundleUrlRelativeToEntity>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out BundleUrlRelativeToEntity? result)
                    {
                        return JsonElementHelpers.TryParseValue<BundleUrlRelativeToEntity>(ref reader, out result);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new BundleUrlRelativeToEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                    static BundleUrlRelativeToEntity IJsonElement<BundleUrlRelativeToEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"BundleUrlRelativeToEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="BundleUrlRelativeToEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="BundleUrlRelativeToEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public BundleUrlRelativeToEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<BundleUrlRelativeToEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="BundleUrlRelativeToEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public BundleUrlRelativeToEntity Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<BundleUrlRelativeToEntity>(_idx);
                        }
                    ...
                    /// <param name="matchManifest">Match 1st item.</param>
