...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapAppNamespace
    {
        ...
        public readonly partial struct OfflineEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<OfflineEntity, Mutable>(OfflineEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(OfflineEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="OfflineEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator OfflineEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new OfflineEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"OfflineEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="OfflineEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="OfflineEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly OfflineEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<OfflineEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="OfflineEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly OfflineEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<OfflineEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(OfflineEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<OfflineEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<OfflineEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<OfflineEntity>();
                }
                finally
                {
