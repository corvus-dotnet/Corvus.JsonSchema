    ...
    public readonly partial struct JsonSchemaForSapAppNamespace
    {
        ...
        public readonly partial struct RepresentsApplicationComponentHierarchy
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RepresentsApplicationComponentHierarchy instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsApplicationComponentHierarchy"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsApplicationComponentHierarchy(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsApplicationComponentHierarchy.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsApplicationComponentHierarchy Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsApplicationComponentHierarchy Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsApplicationComponentHierarchy>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsApplicationComponentHierarchy instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RepresentsApplicationComponentHierarchy, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RepresentsApplicationComponentHierarchy> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RepresentsApplicationComponentHierarchy>();
                }
                finally
                {
