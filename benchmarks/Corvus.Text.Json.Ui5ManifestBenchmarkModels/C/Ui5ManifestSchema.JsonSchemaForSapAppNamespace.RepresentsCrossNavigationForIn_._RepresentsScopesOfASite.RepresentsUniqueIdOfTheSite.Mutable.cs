            ...
            public readonly partial struct RepresentsScopesOfASite
            {
                ...
                public readonly partial struct RepresentsUniqueIdOfTheSite
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(RepresentsUniqueIdOfTheSite instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="RepresentsUniqueIdOfTheSite"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator RepresentsUniqueIdOfTheSite(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"RepresentsUniqueIdOfTheSite.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RepresentsUniqueIdOfTheSite Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RepresentsUniqueIdOfTheSite Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<RepresentsUniqueIdOfTheSite>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapAppNamespace.RepresentsCrossNavigationForInboundAndOutboundTargets.RepresentsScopesOfASite.RepresentsUniqueIdOfTheSite.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                        ...
                        public static implicit operator Source(RepresentsUniqueIdOfTheSite instance) => new(JsonElement.From(instance));
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapAppNamespace.RepresentsCrossNavigationForInboundAndOutboundTargets.RepresentsScopesOfASite.RepresentsUniqueIdOfTheSite.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    public ref struct Builder
                    {
                        ...
                        /// <summary>
                        /// Creates an instance of a <see cref="RepresentsUniqueIdOfTheSite"/>.
                        /// </summary>
                        internal static void Create(ref ComplexValueBuilder builder, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source value)
                        {
                        ...
                        /// Creates an instance of a <see cref="RepresentsUniqueIdOfTheSite"/>.
                        /// </summary>
                        public void Create(in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source value)
                        {
                    ...
                    /// <returns>The source from which to build the value.</returns>
                    public static Source Build(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source value)
                    {
                    ...
                    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source value, int initialCapacity = 30)
                    {
                        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                        cvb.StartObject();
                    ...
                    {
                        return workspace.CreateBuilder<RepresentsUniqueIdOfTheSite, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<RepresentsUniqueIdOfTheSite> Create(
                        scoped in Source value, int initialCapacity = 30)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<RepresentsUniqueIdOfTheSite>();
                        }
                        finally
                        {
                    ...
                    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                    public static ParsedJsonDocument<RepresentsUniqueIdOfTheSite> Create<TContext>(
                    ...
                    public static ParsedJsonDocument<RepresentsUniqueIdOfTheSite> Create(in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source value, int initialCapacity = 30)
                    {
                        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                        try
                        {
