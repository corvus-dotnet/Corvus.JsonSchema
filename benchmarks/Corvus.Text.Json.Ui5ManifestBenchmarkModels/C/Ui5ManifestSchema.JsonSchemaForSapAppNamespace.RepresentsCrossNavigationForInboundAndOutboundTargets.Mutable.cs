    ...
    public readonly partial struct JsonSchemaForSapAppNamespace
    {
        ...
        public readonly partial struct RepresentsCrossNavigationForInboundAndOutboundTargets
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Inbound.Mutable Inbounds
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.InboundsUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Inbound.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Outbound.Mutable Outbounds
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OutboundsUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Outbound.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapAppNamespace.RepresentsCrossNavigationForInboundAndOutboundTargets.RepresentsScopesOfASite.Mutable Scopes
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ScopesUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapAppNamespace.RepresentsCrossNavigationForInboundAndOutboundTargets.RepresentsScopesOfASite.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetInbounds(scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Inbound.Source value)
                {
                    ...
                    else
                    {
                        ...
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Inbounds, ref cvb);
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetInbounds<TContext>(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Inbound.Source<TContext> value)
                ...
                public void SetOutbounds(scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Outbound.Source value)
                {
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Outbounds, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetOutbounds<TContext>(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Outbound.Source<TContext> value)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetScopes<TContext>(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapAppNamespace.RepresentsCrossNavigationForInboundAndOutboundTargets.RepresentsScopesOfASite.Source<TContext> value)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Inbound.Source _createArg1;
                private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Outbound.Source _createArg2;
                private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapAppNamespace.RepresentsCrossNavigationForInboundAndOutboundTargets.RepresentsScopesOfASite.Source _createArg3;
                ...
                #endif
            {
                ...
                private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Inbound.Source<TContext> _createArg1;
                private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Outbound.Source<TContext> _createArg2;
                private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapAppNamespace.RepresentsCrossNavigationForInboundAndOutboundTargets.RepresentsScopesOfASite.Source<TContext> _createArg3;
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Inbound.Source inbounds,
                    in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Outbound.Source outbounds = default,
                    in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapAppNamespace.RepresentsCrossNavigationForInboundAndOutboundTargets.RepresentsScopesOfASite.Source scopes = default)
                {
                    inbounds.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Inbounds, ref builder);
                    outbounds.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Outbounds, ref builder);
                ...
                internal static void Create<TContext>(
                    in TContext context,
                    ref ComplexValueBuilder builder,
                    in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Inbound.Source<TContext> inbounds,
                    in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Outbound.Source<TContext> outbounds = default,
                    in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapAppNamespace.RepresentsCrossNavigationForInboundAndOutboundTargets.RepresentsScopesOfASite.Source<TContext> scopes = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
            ...
            /// </summary>
            /// <param name="inbounds">The value of the <c>"inbounds"</c> property.</param>
            ...
            public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Inbound.Source<TContext> inbounds, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Outbound.Source<TContext> outbounds = default, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapAppNamespace.RepresentsCrossNavigationForInboundAndOutboundTargets.RepresentsScopesOfASite.Source<TContext> scopes = default)
                ...
                #endif
            {
                return new Source<TContext>(context, inbounds, outbounds, scopes);
            }
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Inbound.Source inbounds, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Outbound.Source outbounds = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapAppNamespace.RepresentsCrossNavigationForInboundAndOutboundTargets.RepresentsScopesOfASite.Source scopes = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Inbound.Source<TContext> inbounds, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Outbound.Source<TContext> outbounds = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapAppNamespace.RepresentsCrossNavigationForInboundAndOutboundTargets.RepresentsScopesOfASite.Source<TContext> scopes = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
            ...
            public static ParsedJsonDocument<RepresentsCrossNavigationForInboundAndOutboundTargets> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RepresentsCrossNavigationForInboundAndOutboundTargets>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RepresentsCrossNavigationForInboundAndOutboundTargets> Create<TContext>(
            ...
            public static ParsedJsonDocument<RepresentsCrossNavigationForInboundAndOutboundTargets> Create(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Inbound.Source inbounds, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Outbound.Source outbounds = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapAppNamespace.RepresentsCrossNavigationForInboundAndOutboundTargets.RepresentsScopesOfASite.Source scopes = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RepresentsCrossNavigationForInboundAndOutboundTargets> Create<TContext>(in TContext context, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Inbound.Source<TContext> inbounds, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Outbound.Source<TContext> outbounds = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapAppNamespace.RepresentsCrossNavigationForInboundAndOutboundTargets.RepresentsScopesOfASite.Source<TContext> scopes = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
