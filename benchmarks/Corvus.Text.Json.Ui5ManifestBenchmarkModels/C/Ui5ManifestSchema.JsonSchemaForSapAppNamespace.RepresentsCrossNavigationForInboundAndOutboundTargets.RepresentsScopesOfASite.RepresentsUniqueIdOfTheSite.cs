    ...
    public readonly partial struct JsonSchemaForSapAppNamespace
    {
        ...
        public readonly partial struct RepresentsCrossNavigationForInboundAndOutboundTargets
        {
            ...
            public readonly partial struct RepresentsScopesOfASite
            {
                ...
                public readonly partial struct RepresentsUniqueIdOfTheSite
#if NET8_0_OR_GREATER
                    : IJsonElement<RepresentsUniqueIdOfTheSite>,
                      IFormattable,
                      ISpanFormattable,
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="RepresentsUniqueIdOfTheSite"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal RepresentsUniqueIdOfTheSite(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static RepresentsUniqueIdOfTheSite DefaultInstance { get; }
                    ...
                    /// </returns>
                    public static bool operator ==(in RepresentsUniqueIdOfTheSite left, in RepresentsUniqueIdOfTheSite right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in RepresentsUniqueIdOfTheSite left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    public static implicit operator JsonElement(RepresentsUniqueIdOfTheSite instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RepresentsUniqueIdOfTheSite(JsonElement instance)
                    {
                        return RepresentsUniqueIdOfTheSite.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RepresentsUniqueIdOfTheSite From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RepresentsUniqueIdOfTheSite ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RepresentsUniqueIdOfTheSite>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RepresentsUniqueIdOfTheSite ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RepresentsUniqueIdOfTheSite>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RepresentsUniqueIdOfTheSite ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RepresentsUniqueIdOfTheSite>(json, options);
                    }
                    ...
                    /// </exception>
                    public static RepresentsUniqueIdOfTheSite ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<RepresentsUniqueIdOfTheSite>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsUniqueIdOfTheSite? result)
                    {
                        return JsonElementHelpers.TryParseValue<RepresentsUniqueIdOfTheSite>(ref reader, out result);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new RepresentsUniqueIdOfTheSite(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                    static RepresentsUniqueIdOfTheSite IJsonElement<RepresentsUniqueIdOfTheSite>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RepresentsUniqueIdOfTheSite: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="RepresentsUniqueIdOfTheSite"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="RepresentsUniqueIdOfTheSite"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public RepresentsUniqueIdOfTheSite Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<RepresentsUniqueIdOfTheSite>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="RepresentsUniqueIdOfTheSite"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public RepresentsUniqueIdOfTheSite Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<RepresentsUniqueIdOfTheSite>(_idx);
                        }
