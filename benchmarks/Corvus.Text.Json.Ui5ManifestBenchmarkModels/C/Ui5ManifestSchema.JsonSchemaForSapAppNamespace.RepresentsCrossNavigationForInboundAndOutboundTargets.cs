...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapAppNamespace
    {
        ...
        public readonly partial struct RepresentsCrossNavigationForInboundAndOutboundTargets
            ...
            : IJsonElement<RepresentsCrossNavigationForInboundAndOutboundTargets>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RepresentsCrossNavigationForInboundAndOutboundTargets"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RepresentsCrossNavigationForInboundAndOutboundTargets(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RepresentsCrossNavigationForInboundAndOutboundTargets DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Inbound Inbounds
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.InboundsUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Inbound value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Outbound Outbounds
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OutboundsUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Outbound value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapAppNamespace.RepresentsCrossNavigationForInboundAndOutboundTargets.RepresentsScopesOfASite Scopes
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ScopesUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapAppNamespace.RepresentsCrossNavigationForInboundAndOutboundTargets.RepresentsScopesOfASite value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in RepresentsCrossNavigationForInboundAndOutboundTargets left, in RepresentsCrossNavigationForInboundAndOutboundTargets right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RepresentsCrossNavigationForInboundAndOutboundTargets left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(RepresentsCrossNavigationForInboundAndOutboundTargets instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RepresentsCrossNavigationForInboundAndOutboundTargets(JsonElement instance)
            {
                return RepresentsCrossNavigationForInboundAndOutboundTargets.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsCrossNavigationForInboundAndOutboundTargets From<T>(in T instance)
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsCrossNavigationForInboundAndOutboundTargets? result)
            {
                return JsonElementHelpers.TryParseValue<RepresentsCrossNavigationForInboundAndOutboundTargets>(ref reader, out result);
            }
...
#if NET
            static RepresentsCrossNavigationForInboundAndOutboundTargets IJsonElement<RepresentsCrossNavigationForInboundAndOutboundTargets>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RepresentsCrossNavigationForInboundAndOutboundTargets: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public RepresentsCrossNavigationForInboundAndOutboundTargets Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public RepresentsCrossNavigationForInboundAndOutboundTargets Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RepresentsCrossNavigationForInboundAndOutboundTargets>(_idx);
                }
            ...
            {
                /// <summary>
                /// Gets the JSON property name for <see cref="Inbounds"/>.
                /// </summary>
                public const string Inbounds = "inbounds";

                /// <summary>
                /// Gets the JSON property name for <see cref="Outbounds"/>.
                /// </summary>
                public const string Outbounds = "outbounds";
                ...
                /// Gets the JSON property name for <see cref="Inbounds"/>.
                /// </summary>
                public static ReadOnlySpan<byte> InboundsUtf8 => "inbounds"u8;

                /// <summary>
                /// Gets the JSON property name for <see cref="Outbounds"/>.
                /// </summary>
                public static ReadOnlySpan<byte> OutboundsUtf8 => "outbounds"u8;
            ...
            {
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="Inbounds"/>.
                /// </summary>
                public static ReadOnlySpan<byte> Inbounds => "inbounds"u8;

                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="Outbounds"/>.
                /// </summary>
                public static ReadOnlySpan<byte> Outbounds => "outbounds"u8;
            ...
            {
                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="Inbounds"/>.
                /// </summary>
                public static ReadOnlySpan<byte> Inbounds => [0xA5, 0x00, 0x00, 0x00, 0x22, 0x69, 0x6E, 0x62, 0x6F, 0x75, 0x6E, 0x64, 0x73, 0x22];

                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="Outbounds"/>.
                /// </summary>
                public static ReadOnlySpan<byte> Outbounds => [0xB5, 0x00, 0x00, 0x00, 0x22, 0x6F, 0x75, 0x74, 0x62, 0x6F, 0x75, 0x6E, 0x64, 0x73, 0x22];
