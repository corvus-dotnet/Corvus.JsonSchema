    ...
    public readonly partial struct JsonSchemaForSapAppNamespace
    {
        ...
        public readonly partial struct RepresentsTheNameOfTheProviderWhichOwnsTheApplication
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RepresentsTheNameOfTheProviderWhichOwnsTheApplication instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsTheNameOfTheProviderWhichOwnsTheApplication"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsTheNameOfTheProviderWhichOwnsTheApplication(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsTheNameOfTheProviderWhichOwnsTheApplication.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheNameOfTheProviderWhichOwnsTheApplication Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheNameOfTheProviderWhichOwnsTheApplication Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsTheNameOfTheProviderWhichOwnsTheApplication>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsTheNameOfTheProviderWhichOwnsTheApplication instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RepresentsTheNameOfTheProviderWhichOwnsTheApplication, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RepresentsTheNameOfTheProviderWhichOwnsTheApplication> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RepresentsTheNameOfTheProviderWhichOwnsTheApplication>();
                }
                finally
                {
