...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapAppNamespace
    {
        ...
        public readonly partial struct RepresentsTheNameOfTheProviderWhichOwnsTheApplication
#if NET8_0_OR_GREATER
            : IJsonElement<RepresentsTheNameOfTheProviderWhichOwnsTheApplication>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RepresentsTheNameOfTheProviderWhichOwnsTheApplication"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RepresentsTheNameOfTheProviderWhichOwnsTheApplication(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RepresentsTheNameOfTheProviderWhichOwnsTheApplication DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(RepresentsTheNameOfTheProviderWhichOwnsTheApplication value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in RepresentsTheNameOfTheProviderWhichOwnsTheApplication left, in RepresentsTheNameOfTheProviderWhichOwnsTheApplication right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RepresentsTheNameOfTheProviderWhichOwnsTheApplication left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(RepresentsTheNameOfTheProviderWhichOwnsTheApplication instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RepresentsTheNameOfTheProviderWhichOwnsTheApplication(JsonElement instance)
            {
                return RepresentsTheNameOfTheProviderWhichOwnsTheApplication.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheNameOfTheProviderWhichOwnsTheApplication From<T>(in T instance)
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheNameOfTheProviderWhichOwnsTheApplication ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<RepresentsTheNameOfTheProviderWhichOwnsTheApplication>(utf8Json, options);
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheNameOfTheProviderWhichOwnsTheApplication ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<RepresentsTheNameOfTheProviderWhichOwnsTheApplication>(json, options);
                #pragma warning restore CS0618
            }
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheNameOfTheProviderWhichOwnsTheApplication ParseValue(string json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<RepresentsTheNameOfTheProviderWhichOwnsTheApplication>(json, options);
                #pragma warning restore CS0618
            ...
            /// </exception>
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            public static RepresentsTheNameOfTheProviderWhichOwnsTheApplication ParseValue(ref Utf8JsonReader reader)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<RepresentsTheNameOfTheProviderWhichOwnsTheApplication>(ref reader);
                #pragma warning restore CS0618
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsTheNameOfTheProviderWhichOwnsTheApplication? result)
            {
                return JsonElementHelpers.TryParseValue<RepresentsTheNameOfTheProviderWhichOwnsTheApplication>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RepresentsTheNameOfTheProviderWhichOwnsTheApplication(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static RepresentsTheNameOfTheProviderWhichOwnsTheApplication IJsonElement<RepresentsTheNameOfTheProviderWhichOwnsTheApplication>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RepresentsTheNameOfTheProviderWhichOwnsTheApplication: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RepresentsTheNameOfTheProviderWhichOwnsTheApplication"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RepresentsTheNameOfTheProviderWhichOwnsTheApplication"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public RepresentsTheNameOfTheProviderWhichOwnsTheApplication Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RepresentsTheNameOfTheProviderWhichOwnsTheApplication>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RepresentsTheNameOfTheProviderWhichOwnsTheApplication"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public RepresentsTheNameOfTheProviderWhichOwnsTheApplication Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RepresentsTheNameOfTheProviderWhichOwnsTheApplication>(_idx);
                }
