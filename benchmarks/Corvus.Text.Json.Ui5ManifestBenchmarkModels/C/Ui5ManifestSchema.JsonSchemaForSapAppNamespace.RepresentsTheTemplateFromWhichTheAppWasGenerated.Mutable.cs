    ...
    public readonly partial struct JsonSchemaForSapAppNamespace
    {
        ...
        public readonly partial struct RepresentsTheTemplateFromWhichTheAppWasGenerated
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RepresentsTheTemplateFromWhichTheAppWasGenerated instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsTheTemplateFromWhichTheAppWasGenerated"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsTheTemplateFromWhichTheAppWasGenerated(Mutable instance)
                {
                ...
                /// <summary>
                /// Gets the (optional) <c>toolsId</c> property.
                /// </summary>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable ToolsId
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ToolsIdUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new RepresentsTheTemplateFromWhichTheAppWasGenerated(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                public void SetToolsId(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source value)
                {
                    ...
                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ToolsIdUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ToolsIdUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ToolsId, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                /// <summary>
                /// Remove the <c>toolsId</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveToolsId()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ToolsIdUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsTheTemplateFromWhichTheAppWasGenerated.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="RepresentsTheTemplateFromWhichTheAppWasGenerated"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="RepresentsTheTemplateFromWhichTheAppWasGenerated"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheTemplateFromWhichTheAppWasGenerated Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<RepresentsTheTemplateFromWhichTheAppWasGenerated>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="RepresentsTheTemplateFromWhichTheAppWasGenerated"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheTemplateFromWhichTheAppWasGenerated Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsTheTemplateFromWhichTheAppWasGenerated>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsTheTemplateFromWhichTheAppWasGenerated instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapAppNamespace.RepresentsTheTemplateFromWhichTheAppWasGenerated.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="RepresentsTheTemplateFromWhichTheAppWasGenerated"/>.
                /// </summary>
                internal static void Create(
                    ...
                    in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source toolsId = default)
                {
                    ...
                    toolsId.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ToolsId, ref builder);
                }
                ...
                public void Create(
                    ...
                    in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source toolsId = default)
                {
                    Create(ref _builder, id, version, toolsId);
                }
            ...
            /// <param name="toolsId">The value of the property.</param>
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source id, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source version, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source toolsId = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(id, version, toolsId);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<RepresentsTheTemplateFromWhichTheAppWasGenerated, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RepresentsTheTemplateFromWhichTheAppWasGenerated> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RepresentsTheTemplateFromWhichTheAppWasGenerated>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RepresentsTheTemplateFromWhichTheAppWasGenerated> Create<TContext>(
            ...
            public static ParsedJsonDocument<RepresentsTheTemplateFromWhichTheAppWasGenerated> Create(in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source id, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source version, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source toolsId = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
