...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapAppNamespace
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RepresentsUsedDataSourcesWithAUniqueKeyAlias"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RepresentsUsedDataSourcesWithAUniqueKeyAlias(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RepresentsUsedDataSourcesWithAUniqueKeyAlias DefaultInstance { get; }
            ...
            public bool TryGetProperty(ReadOnlySpan<byte> propertyName, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSource value)
            {
                CheckValidInstance();
            ...
            /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public bool TryGetProperty(ReadOnlySpan<char> propertyName, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSource value)
            {
                CheckValidInstance();
                return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
            }
            ...
            /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public bool TryGetProperty(string propertyName, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSource value)
            {
                CheckValidInstance();
                return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
            }
            ...
            /// <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSource"/>.
            /// </summary>
            ...
            public static bool MatchesPatternDataSource(ReadOnlySpan<byte> propertyName)
            {
            ...
            /// <returns><see langword="true"/> if the property name matches the pattern, otherwise <see langword="false"/>.</returns>
            public static bool TryAsPatternDataSource(ReadOnlySpan<byte> propertyName, in JsonElement value, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSource result)
            {
                if (MatchesPatternDataSource(propertyName))
                {
                    result = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSource.From(value);
                    return true;
                }
            ...
            public interface IPatternPropertyVisitor<TState>
            {
                ...
                /// </summary>
                bool VisitPatternDataSource(ReadOnlySpan<byte> name, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSource value, ref TState state);
                ...
                where TVisitor : IPatternPropertyVisitor<TState>
            {
                ...
                foreach (var property in EnumerateObject())
                {
                    ...
                    {
                        matched = true;
                        Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSource typedValue = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSource.From(property.Value);
                        if (!visitor.VisitPatternDataSource(propertyName, in typedValue, ref state))
                        {
                            return false;
                        }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public ObjectEnumerator<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSource> EnumerateObject()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateObjectEnumerator<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.DataSource>(_parent, _idx);
            }
            ...
            /// </returns>
            public static bool operator ==(in RepresentsUsedDataSourcesWithAUniqueKeyAlias left, in RepresentsUsedDataSourcesWithAUniqueKeyAlias right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RepresentsUsedDataSourcesWithAUniqueKeyAlias left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(RepresentsUsedDataSourcesWithAUniqueKeyAlias instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RepresentsUsedDataSourcesWithAUniqueKeyAlias(JsonElement instance)
            {
                return RepresentsUsedDataSourcesWithAUniqueKeyAlias.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsUsedDataSourcesWithAUniqueKeyAlias From<T>(in T instance)
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsUsedDataSourcesWithAUniqueKeyAlias ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<RepresentsUsedDataSourcesWithAUniqueKeyAlias>(utf8Json, options);
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsUsedDataSourcesWithAUniqueKeyAlias ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<RepresentsUsedDataSourcesWithAUniqueKeyAlias>(json, options);
                #pragma warning restore CS0618
            }
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsUsedDataSourcesWithAUniqueKeyAlias ParseValue(string json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<RepresentsUsedDataSourcesWithAUniqueKeyAlias>(json, options);
                #pragma warning restore CS0618
            ...
            /// </exception>
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            public static RepresentsUsedDataSourcesWithAUniqueKeyAlias ParseValue(ref Utf8JsonReader reader)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<RepresentsUsedDataSourcesWithAUniqueKeyAlias>(ref reader);
                #pragma warning restore CS0618
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsUsedDataSourcesWithAUniqueKeyAlias? result)
            {
                return JsonElementHelpers.TryParseValue<RepresentsUsedDataSourcesWithAUniqueKeyAlias>(ref reader, out result);
            }
...
#if NET
            static RepresentsUsedDataSourcesWithAUniqueKeyAlias IJsonElement<RepresentsUsedDataSourcesWithAUniqueKeyAlias>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RepresentsUsedDataSourcesWithAUniqueKeyAlias: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public RepresentsUsedDataSourcesWithAUniqueKeyAlias Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public RepresentsUsedDataSourcesWithAUniqueKeyAlias Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RepresentsUsedDataSourcesWithAUniqueKeyAlias>(_idx);
                }
