...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapAppNamespace
    {
        ...
        public readonly partial struct RepresentsCrossNavigationForInboundAndOutboundTargets
        {
            ...
            public readonly partial struct RepresentsScopesOfASite
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(RepresentsScopesOfASite instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="RepresentsScopesOfASite"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RepresentsScopesOfASite(Mutable instance)
                    {
                    ...
                    public bool TryGetProperty(ReadOnlySpan<byte> propertyName, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapAppNamespace.RepresentsCrossNavigationForInboundAndOutboundTargets.RepresentsScopesOfASite.RepresentsUniqueIdOfTheSite.Mutable value)
                    {
                        CheckValidInstance();
                    ...
                    /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
                    /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                    public bool TryGetProperty(ReadOnlySpan<char> propertyName, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapAppNamespace.RepresentsCrossNavigationForInboundAndOutboundTargets.RepresentsScopesOfASite.RepresentsUniqueIdOfTheSite.Mutable value)
                    {
                        CheckValidInstance();
                        return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
                    }
                    ...
                    /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
                    /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                    public bool TryGetProperty(string propertyName, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapAppNamespace.RepresentsCrossNavigationForInboundAndOutboundTargets.RepresentsScopesOfASite.RepresentsUniqueIdOfTheSite.Mutable value)
                    {
                        CheckValidInstance();
                        return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
                    }
                    ...
                    /// </summary>
                    /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                    public ObjectEnumerator<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapAppNamespace.RepresentsCrossNavigationForInboundAndOutboundTargets.RepresentsScopesOfASite.RepresentsUniqueIdOfTheSite.Mutable> EnumerateObject()
                    {
                        CheckValidInstance();
                        return EnumeratorCreator.CreateObjectEnumerator<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapAppNamespace.RepresentsCrossNavigationForInboundAndOutboundTargets.RepresentsScopesOfASite.RepresentsUniqueIdOfTheSite.Mutable>(_parent, _idx);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new RepresentsScopesOfASite(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RepresentsScopesOfASite.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </remarks>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void SetProperty(string propertyName, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapAppNamespace.RepresentsCrossNavigationForInboundAndOutboundTargets.RepresentsScopesOfASite.RepresentsUniqueIdOfTheSite.Source value)
                    {
                    ...
                    ///   </para>
                    /// </remarks>
                    public void SetProperty(ReadOnlySpan<char> propertyName, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapAppNamespace.RepresentsCrossNavigationForInboundAndOutboundTargets.RepresentsScopesOfASite.RepresentsUniqueIdOfTheSite.Source value)
                    {
                        CheckValidInstance();
                    ...
                    ///   </para>
                    /// </remarks>
                    public void SetProperty(ReadOnlySpan<byte> propertyName, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapAppNamespace.RepresentsCrossNavigationForInboundAndOutboundTargets.RepresentsScopesOfASite.RepresentsUniqueIdOfTheSite.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// <summary>
                    /// Gets a <see cref="RepresentsScopesOfASite"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="RepresentsScopesOfASite"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RepresentsScopesOfASite Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<RepresentsScopesOfASite>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="RepresentsScopesOfASite"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RepresentsScopesOfASite Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<RepresentsScopesOfASite>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapAppNamespace.RepresentsCrossNavigationForInboundAndOutboundTargets.RepresentsScopesOfASite.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(RepresentsScopesOfASite instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapAppNamespace.RepresentsCrossNavigationForInboundAndOutboundTargets.RepresentsScopesOfASite.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                {
                    return workspace.CreateBuilder<RepresentsScopesOfASite, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<RepresentsScopesOfASite> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<RepresentsScopesOfASite>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<RepresentsScopesOfASite> Create<TContext>(
