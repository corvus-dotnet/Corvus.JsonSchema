    ...
    public readonly partial struct JsonSchemaForSapArtifactNamespace
    {
        ...
        public readonly partial struct RepresentsArrayOfKeywordsUsedToFindTheArtifact
        {
...
#endif
            {
                ...
                public void SetKeywords(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Tag.Source value)
                {
                    ...
                    else
                    {
                        ...
                        value.AddAsProperty(JsonPropertyNamesEscaped.Keywords, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                ...
                public void SetTechnicalAttributes(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapArtifactNamespace.RepresentsArrayOfKeywordsUsedToFindTheArtifact.TechnicalAttributesEntityArray.Source value)
                {
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsProperty(JsonPropertyNamesEscaped.TechnicalAttributes, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
            ...
            public ref struct Builder
            {
                ...
                {
                    keywords.AddAsProperty(JsonPropertyNamesEscaped.Keywords, ref builder, escapeName: false);
                    technicalAttributes.AddAsProperty(JsonPropertyNamesEscaped.TechnicalAttributes, ref builder, escapeName: false);
                }
