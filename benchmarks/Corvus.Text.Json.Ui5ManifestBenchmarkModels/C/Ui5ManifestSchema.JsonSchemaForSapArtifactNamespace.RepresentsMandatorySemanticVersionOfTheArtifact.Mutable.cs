    ...
    public readonly partial struct JsonSchemaForSapArtifactNamespace
    {
        ...
        public readonly partial struct RepresentsMandatorySemanticVersionOfTheArtifact
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RepresentsMandatorySemanticVersionOfTheArtifact instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsMandatorySemanticVersionOfTheArtifact"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsMandatorySemanticVersionOfTheArtifact(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Semanticversion.Mutable Version
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Semanticversion.Mutable value))
                        {
                            return value;
                        }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new RepresentsMandatorySemanticVersionOfTheArtifact(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsMandatorySemanticVersionOfTheArtifact.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="RepresentsMandatorySemanticVersionOfTheArtifact"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="RepresentsMandatorySemanticVersionOfTheArtifact"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsMandatorySemanticVersionOfTheArtifact Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<RepresentsMandatorySemanticVersionOfTheArtifact>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="RepresentsMandatorySemanticVersionOfTheArtifact"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsMandatorySemanticVersionOfTheArtifact Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsMandatorySemanticVersionOfTheArtifact>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Semanticversion.Source _createArg1;
                ...
                internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapArtifactNamespace.RepresentsMandatorySemanticVersionOfTheArtifact.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Semanticversion.Source arg1)
                {
                    _createArg1 = arg1;
                    _kind = Kind.Create;
                }

                public static implicit operator Source(RepresentsMandatorySemanticVersionOfTheArtifact instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapArtifactNamespace.RepresentsMandatorySemanticVersionOfTheArtifact.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="RepresentsMandatorySemanticVersionOfTheArtifact"/>.
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Semanticversion.Source version)
                {
                ...
                /// Creates an instance of a <see cref="RepresentsMandatorySemanticVersionOfTheArtifact"/>.
                /// </summary>
                public void Create(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Semanticversion.Source version)
                {
                    Create(ref _builder, version);
                }
                ...
                internal static void BuildCreateValue(scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Semanticversion.Source arg1, ref ComplexValueBuilder o)
                {
                    o.StartObject();
                    Create(ref o, arg1);
                    o.EndObject();
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Semanticversion.Source version)
            {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Semanticversion.Source version, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            {
                return workspace.CreateBuilder<RepresentsMandatorySemanticVersionOfTheArtifact, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RepresentsMandatorySemanticVersionOfTheArtifact> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RepresentsMandatorySemanticVersionOfTheArtifact>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RepresentsMandatorySemanticVersionOfTheArtifact> Create<TContext>(
            ...
            public static ParsedJsonDocument<RepresentsMandatorySemanticVersionOfTheArtifact> Create(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Semanticversion.Source version, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
