...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapArtifactNamespace
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RepresentsMandatorySemanticVersionOfTheArtifact"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RepresentsMandatorySemanticVersionOfTheArtifact(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RepresentsMandatorySemanticVersionOfTheArtifact DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Semanticversion Version
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Semanticversion value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in RepresentsMandatorySemanticVersionOfTheArtifact left, in RepresentsMandatorySemanticVersionOfTheArtifact right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RepresentsMandatorySemanticVersionOfTheArtifact left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(RepresentsMandatorySemanticVersionOfTheArtifact instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RepresentsMandatorySemanticVersionOfTheArtifact(JsonElement instance)
            {
                return RepresentsMandatorySemanticVersionOfTheArtifact.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsMandatorySemanticVersionOfTheArtifact From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsMandatorySemanticVersionOfTheArtifact ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsMandatorySemanticVersionOfTheArtifact>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsMandatorySemanticVersionOfTheArtifact ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsMandatorySemanticVersionOfTheArtifact>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsMandatorySemanticVersionOfTheArtifact ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsMandatorySemanticVersionOfTheArtifact>(json, options);
            }
            ...
            /// </exception>
            public static RepresentsMandatorySemanticVersionOfTheArtifact ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RepresentsMandatorySemanticVersionOfTheArtifact>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsMandatorySemanticVersionOfTheArtifact? result)
            {
                return JsonElementHelpers.TryParseValue<RepresentsMandatorySemanticVersionOfTheArtifact>(ref reader, out result);
            }
...
#if NET
            static RepresentsMandatorySemanticVersionOfTheArtifact IJsonElement<RepresentsMandatorySemanticVersionOfTheArtifact>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RepresentsMandatorySemanticVersionOfTheArtifact: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public RepresentsMandatorySemanticVersionOfTheArtifact Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public RepresentsMandatorySemanticVersionOfTheArtifact Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RepresentsMandatorySemanticVersionOfTheArtifact>(_idx);
                }
