    ...
    public readonly partial struct JsonSchemaForSapArtifactNamespace
    {
            ...
            : IJsonElement<TypeEntity>
        {
            ...
            private static class Constants
            {
                ...
                /// </summary>
                public static readonly byte[] Enum1 = "card"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly TypeEntity EnumJson1 = ParsedJsonDocument<TypeEntity>.StringConstant([.."\"card\""u8]);
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly byte[] Enum2 = "workflow"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly TypeEntity EnumJson2 = ParsedJsonDocument<TypeEntity>.StringConstant([.."\"workflow\""u8]);
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly byte[] Enum3 = "workspace-template"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly TypeEntity EnumJson3 = ParsedJsonDocument<TypeEntity>.StringConstant([.."\"workspace-template\""u8]);
            }
            ...
            {
                /// <summary>
                /// Gets the string "card"
                /// as a <see cref="TypeEntity"/>.
                /// </summary>
                public static TypeEntity Card { get; } = Constants.EnumJson1;
                /// <summary>
                /// Gets the string "card"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> CardUtf8 => Constants.Enum1;

                /// <summary>
                /// Gets the string "workflow"
                /// as a <see cref="TypeEntity"/>.
                /// </summary>
                public static TypeEntity Workflow { get; } = Constants.EnumJson2;
                /// <summary>
                /// Gets the string "workflow"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> WorkflowUtf8 => Constants.Enum2;

                /// <summary>
                /// Gets the string "workspace-template"
                /// as a <see cref="TypeEntity"/>.
                /// </summary>
                public static TypeEntity WorkspaceTemplate { get; } = Constants.EnumJson3;
                /// <summary>
                /// Gets the string "workspace-template"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> WorkspaceTemplateUtf8 => Constants.Enum3;
            }
            ...
            {
                /// <summary>
                /// Corresponds to the JSON string "card".
                /// </summary>
                Card = 0,
                /// <summary>
                ...
                Workflow = 1,
                /// <summary>
                /// Corresponds to the JSON string "workspace-template".
                /// </summary>
                WorkspaceTemplate = 2,
            }
            ...
            public static implicit operator TypeEntity(KnownValues value)
            {
                return value switch
                {
                    KnownValues.Card => Constants.EnumJson1,
                    KnownValues.Workflow => Constants.EnumJson2,
                    KnownValues.WorkspaceTemplate => Constants.EnumJson3,
            ...
            public bool TryGetKnownValue(out KnownValues result)
            {
                ...
                {
                    result = KnownValues.WorkspaceTemplate;
                    return true;
                }
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/properties/sap.artifact/properties/type"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated, as a JSON Pointer within <see cref="SchemaDocument"/>.
                /// </summary>
                public const string SchemaLocation = "/properties/sap.artifact/properties/type";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/properties/sap.artifact/properties/type"u8;
                ...
                private static readonly global::Corvus.Text.Json.RuntimeEvaluator.JsonSchemaEvaluator Evaluator = global::Corvus.Ui5ManifestBenchmark.Current.CorvusJsonSchemaProgram.Entry(610);
