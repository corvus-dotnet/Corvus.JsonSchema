    ...
    public readonly partial struct JsonSchemaForSapArtifactNamespace
    {
        ...
        public readonly partial struct TypeEntity
        {
...
#endif
            {
                ...
                /// <param name="matchCard">Match 1st item.</param>
                /// <param name="matchWorkflow">Match 2nd item.</param>
                /// <param name="matchWorkspaceTemplate">Match 3rd item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> matchCard,
                    Func<TContext, TResult> matchWorkflow,
                    Func<TContext, TResult> matchWorkspaceTemplate,
...
#endif
                {
                    ...
                    {
                        return matchWorkflow(context);
                    }

                    if (this.ValueEquals(Constants.Enum3))
                    {
                        return matchWorkspaceTemplate(context);
                    }
                ...
                public TResult Match<TResult>(
                    Func<TResult> matchCard,
                    Func<TResult> matchWorkflow,
                    Func<TResult> matchWorkspaceTemplate,
