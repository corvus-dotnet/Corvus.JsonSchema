...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapBpaTaskNamespace
    {
...
#endif
        {
            ...
            /// <summary>
            /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.RequiredInputsAndOutputs"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.RequiredInputsAndOutputs.Mutable(Mutable value)
            {
                return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.RequiredInputsAndOutputs.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.RequiredInputsAndOutputs"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.RequiredInputsAndOutputs.Mutable value)
            {
                return From(value);
            }
            ...
            public static explicit operator Mutable(JsonSchemaForSapBpaTaskNamespace instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="JsonSchemaForSapBpaTaskNamespace"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonSchemaForSapBpaTaskNamespace(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.VersionEntity.Mutable Version
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.VersionEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.RepresentsTheCategoryOfTheTaskUi.Mutable Category
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CategoryUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.RepresentsTheCategoryOfTheTaskUi.Mutable value))
                    {
                        return value;
                    }
            ...
            /// <summary>
            /// Gets the <c>outcomes</c> property.
            /// outcomes
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.OutcomesEntityArray.Mutable Outcomes
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OutcomesUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.OutcomesEntityArray.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new JsonSchemaForSapBpaTaskNamespace(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            public void SetCategory(scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.RepresentsTheCategoryOfTheTaskUi.Source value)
            {
                ...
                if (value.IsUndefined)
                {
                    CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("category");
                }
            ...
            public void SetInputs(scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Schema.Source value)
            {
                ...
                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.InputsUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.InputsUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            /// <summary>
            /// Remove the <c>inputs</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveInputs()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.InputsUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            public void SetOutcomes(scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.OutcomesEntityArray.Source value)
            {
                ...
                if (value.IsUndefined)
                {
                    CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("outcomes");
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OutcomesUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetOutcomes<TContext>(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.OutcomesEntityArray.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
            ...
            /// </remarks>
            public void Apply(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.RequiredInputsAndOutputs value)
            {
                CheckValidInstance();
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"JsonSchemaForSapBpaTaskNamespace.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="JsonSchemaForSapBpaTaskNamespace"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="JsonSchemaForSapBpaTaskNamespace"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly JsonSchemaForSapBpaTaskNamespace Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<JsonSchemaForSapBpaTaskNamespace>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="JsonSchemaForSapBpaTaskNamespace"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly JsonSchemaForSapBpaTaskNamespace Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<JsonSchemaForSapBpaTaskNamespace>(_idx);
            }

            /// <summary>
            /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.RequiredInputsAndOutputs.Mutable" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsRequiredInputsAndOutputs(out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.RequiredInputsAndOutputs.Mutable result)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.RequiredInputsAndOutputs.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.RequiredInputsAndOutputs.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            private enum Kind
            {
                Unknown,
                JsonElement,
                RequiredInputsAndOutputsBuilder,
                Create,
                Builder,
            }
            ...
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.VersionEntity.Source _createArg1;
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.RepresentsTheCategoryOfTheTaskUi.Source _createArg2;
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.OutcomesEntityArray.Source _createArg3;
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Schema.Source _createArg4;
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Schema.Source _createArg5;
            ...
            public static implicit operator Source(JsonSchemaForSapBpaTaskNamespace instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.VersionEntity.Source _createArg1;
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.RepresentsTheCategoryOfTheTaskUi.Source _createArg2;
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.OutcomesEntityArray.Source<TContext> _createArg3;
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Schema.Source<TContext> _createArg4;
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Schema.Source<TContext> _createArg5;
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="JsonSchemaForSapBpaTaskNamespace"/>.
            /// </summary>
            ...
            #endif
            {
                Create(context, ref _builder, version, category, outcomes, inputs, outputs);
            }
        ...
        /// <param name="category">The value of the <c>"category"</c> property.</param>
        /// <param name="outcomes">The value of the <c>"outcomes"</c> property.</param>
        ...
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.VersionEntity.Source version, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.RepresentsTheCategoryOfTheTaskUi.Source category, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.OutcomesEntityArray.Source<TContext> outcomes, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Schema.Source<TContext> inputs = default, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Schema.Source<TContext> outputs = default)
            ...
            #endif
        {
            return new Source<TContext>(context, version, category, outcomes, inputs, outputs);
        }
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.RequiredInputsAndOutputs.Source Build(
            scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.RequiredInputsAndOutputs.Builder.Build buildValue, int initialCapacity = 1)
        {
            return new Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.RequiredInputsAndOutputs.Source(buildValue);
        }
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.RequiredInputsAndOutputs.Source<TContext> Build<TContext>(
            scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.RequiredInputsAndOutputs.Builder.Build<TContext> buildValue, int initialCapacity = 1)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            return new Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.RequiredInputsAndOutputs.Source<TContext>(context, buildValue);
        }
        ...
        /// <returns>An instance of a mutable document initialized with the given value.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(
            JsonWorkspace workspace, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.RequiredInputsAndOutputs.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
        {
            // Create the document builder without a MetadataDb
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            var source = new Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.RequiredInputsAndOutputs.Source(value);
            source.AddAsItem(ref cvb);
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        /// <returns>An instance of a mutable document initialized with the given value.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(
            JsonWorkspace workspace, scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.RequiredInputsAndOutputs.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            ...
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            var source = new Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.RequiredInputsAndOutputs.Source<TContext>(context, value);
            source.AddAsItem(ref cvb);
            Debug.Assert(cvb.MemberCount == 1);
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        /// <param name="outcomes">The value of the property.</param>
        /// <param name="inputs">The value of the property.</param>
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.VersionEntity.Source version, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.RepresentsTheCategoryOfTheTaskUi.Source category, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.OutcomesEntityArray.Source outcomes, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Schema.Source inputs = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Schema.Source outputs = default, int initialCapacity = 30)
        {
            ...
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(version, category, outcomes, inputs, outputs);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
            ...
            #endif
        {
            ...
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(context, version, category, outcomes, inputs, outputs);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<JsonSchemaForSapBpaTaskNamespace, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<JsonSchemaForSapBpaTaskNamespace> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<JsonSchemaForSapBpaTaskNamespace>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<JsonSchemaForSapBpaTaskNamespace> Create<TContext>(
        ...
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<JsonSchemaForSapBpaTaskNamespace> Create(
            scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.RequiredInputsAndOutputs.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent(initialValueBufferSize);
            try
            {
        ...
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<JsonSchemaForSapBpaTaskNamespace> Create<TContext>(
            scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.RequiredInputsAndOutputs.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
        ...
        public static ParsedJsonDocument<JsonSchemaForSapBpaTaskNamespace> Create(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.VersionEntity.Source version, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.RepresentsTheCategoryOfTheTaskUi.Source category, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.OutcomesEntityArray.Source outcomes, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Schema.Source inputs = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Schema.Source outputs = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<JsonSchemaForSapBpaTaskNamespace> Create<TContext>(in TContext context, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.VersionEntity.Source version, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.RepresentsTheCategoryOfTheTaskUi.Source category, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.OutcomesEntityArray.Source<TContext> outcomes, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Schema.Source<TContext> inputs = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Schema.Source<TContext> outputs = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
