            ...
            public readonly partial struct OutcomesEntity
            {
                ...
                public readonly partial struct RepresentsTheIdOfTheOutcome
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(RepresentsTheIdOfTheOutcome instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="RepresentsTheIdOfTheOutcome"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator RepresentsTheIdOfTheOutcome(Mutable instance)
                        {
                        ...
                        {
                            return
                                (obj is IJsonElement value && Equals(new RepresentsTheIdOfTheOutcome(value.ParentDocument, value.ParentDocumentIndex))) ||
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"RepresentsTheIdOfTheOutcome.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// <summary>
                        /// Gets a <see cref="RepresentsTheIdOfTheOutcome"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </summary>
                        /// <returns>
                        /// A <see cref="RepresentsTheIdOfTheOutcome"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </returns>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RepresentsTheIdOfTheOutcome Clone()
                        {
                            CheckValidInstance();
                            return _parent.CloneElement<RepresentsTheIdOfTheOutcome>(_idx);
                        }
                        ...
                        /// </summary>
                        /// <returns>
                        /// An immutable <see cref="RepresentsTheIdOfTheOutcome"/> that lives for the lifetime of its
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RepresentsTheIdOfTheOutcome Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<RepresentsTheIdOfTheOutcome>(_idx);
                        }
                        ...
                        /// <param name="matchApprove">Match 1st item.</param>
                        /// <param name="matchReject">Match 2nd item.</param>
                        /// <param name="matchSubmit">Match 3rd item.</param>
                        /// <param name="defaultMatch">Match any other value.</param>
                        /// <returns>An instance of the value returned by the match function.</returns>
                        public TResult Match<TContext, TResult>(
                            in TContext context,
                            Func<TContext, TResult> matchApprove,
                            Func<TContext, TResult> matchReject,
                            Func<TContext, TResult> matchSubmit,
...
#endif
                        {
                            ...
                            {
                                return matchApprove(context);
                            }

                            if (this.ValueEquals(Constants.Enum2))
                            {
                                return matchReject(context);
                            }

                            if (this.ValueEquals(Constants.Enum3))
                            {
                                return matchSubmit(context);
                            }
                        ...
                        public TResult Match<TResult>(
                            Func<TResult> matchApprove,
                            Func<TResult> matchReject,
                            Func<TResult> matchSubmit,
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(RepresentsTheIdOfTheOutcome instance) => new(JsonElement.From(instance));
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator Source(KnownValues value) => (RepresentsTheIdOfTheOutcome)value;
                    ...
                    {
                        return workspace.CreateBuilder<RepresentsTheIdOfTheOutcome, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<RepresentsTheIdOfTheOutcome> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<RepresentsTheIdOfTheOutcome>();
                        }
                        finally
                        {
