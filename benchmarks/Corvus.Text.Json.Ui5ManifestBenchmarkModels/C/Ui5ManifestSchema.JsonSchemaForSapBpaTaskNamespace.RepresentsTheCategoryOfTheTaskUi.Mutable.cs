    ...
    public readonly partial struct JsonSchemaForSapBpaTaskNamespace
    {
        ...
        public readonly partial struct RepresentsTheCategoryOfTheTaskUi
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RepresentsTheCategoryOfTheTaskUi instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsTheCategoryOfTheTaskUi"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsTheCategoryOfTheTaskUi(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsTheCategoryOfTheTaskUi.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheCategoryOfTheTaskUi Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheCategoryOfTheTaskUi Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsTheCategoryOfTheTaskUi>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsTheCategoryOfTheTaskUi instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (RepresentsTheCategoryOfTheTaskUi)value;
            ...
            {
                return workspace.CreateBuilder<RepresentsTheCategoryOfTheTaskUi, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RepresentsTheCategoryOfTheTaskUi> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RepresentsTheCategoryOfTheTaskUi>();
                }
                finally
                {
