    ...
    public readonly partial struct JsonSchemaForSapBpaTaskNamespace
    {
        ...
        public readonly partial struct RequiredInputsAndOutputs
        {
...
#endif
            {
                ...
                public void SetInputs(in Corvus.Text.Json.JsonElement.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetOutputs(in Corvus.Text.Json.JsonElement.Source value)
                {
                    CheckValidInstance();
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(in Corvus.Text.Json.JsonElement.Source inputs, in Corvus.Text.Json.JsonElement.Source outputs)
            {
            ...
            /// <param name="outputs">The value of the <c>"outputs"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> inputs, in Corvus.Text.Json.JsonElement.Source<TContext> outputs)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
