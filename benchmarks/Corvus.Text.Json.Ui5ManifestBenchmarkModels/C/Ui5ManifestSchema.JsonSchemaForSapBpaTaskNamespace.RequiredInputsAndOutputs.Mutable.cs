    ...
    public readonly partial struct JsonSchemaForSapBpaTaskNamespace
    {
        ...
        public readonly partial struct RequiredInputsAndOutputs
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RequiredInputsAndOutputs instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RequiredInputsAndOutputs"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RequiredInputsAndOutputs(Mutable instance)
                {
                ...
                public void SetInputs(scoped in Corvus.Text.Json.JsonElement.Source value)
                {
                    ...
                    {
                        CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("inputs");
                    }
                ...
                public void SetOutputs(scoped in Corvus.Text.Json.JsonElement.Source value)
                {
                    ...
                    if (value.IsUndefined)
                    {
                        CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("outputs");
                    }
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RequiredInputsAndOutputs.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredInputsAndOutputs Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredInputsAndOutputs Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RequiredInputsAndOutputs>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.RequiredInputsAndOutputs.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                public static implicit operator Source(RequiredInputsAndOutputs instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapBpaTaskNamespace.RequiredInputsAndOutputs.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="RequiredInputsAndOutputs"/>.
                /// </summary>
                internal static void Create(
                    ref ComplexValueBuilder builder,
                    in Corvus.Text.Json.JsonElement.Source inputs,
                    in Corvus.Text.Json.JsonElement.Source outputs)
                {
                ...
                /// Creates an instance of a <see cref="RequiredInputsAndOutputs"/>.
                /// </summary>
                public void Create(in Corvus.Text.Json.JsonElement.Source inputs, in Corvus.Text.Json.JsonElement.Source outputs)
                {
                    Create(ref _builder, inputs, outputs);
                }
                ...
                internal static void Create<TContext>(
                    in TContext context,
                    ref ComplexValueBuilder builder,
                    in Corvus.Text.Json.JsonElement.Source<TContext> inputs,
                    in Corvus.Text.Json.JsonElement.Source<TContext> outputs)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                {
                ...
                #endif
                {
                    Create(context, ref _builder, inputs, outputs);
                }
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.Text.Json.JsonElement.Source inputs, scoped in Corvus.Text.Json.JsonElement.Source outputs)
            {
                return new Source(inputs, outputs);
            }
            ...
            /// <param name="outputs">The value of the <c>"outputs"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.JsonElement.Source<TContext> inputs, scoped in Corvus.Text.Json.JsonElement.Source<TContext> outputs)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                return new Source<TContext>(context, inputs, outputs);
            }
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Text.Json.JsonElement.Source inputs, in Corvus.Text.Json.JsonElement.Source outputs, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(inputs, outputs);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> inputs, in Corvus.Text.Json.JsonElement.Source<TContext> outputs, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                ...
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(context, inputs, outputs);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<RequiredInputsAndOutputs, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RequiredInputsAndOutputs> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RequiredInputsAndOutputs>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RequiredInputsAndOutputs> Create<TContext>(
            ...
            public static ParsedJsonDocument<RequiredInputsAndOutputs> Create(in Corvus.Text.Json.JsonElement.Source inputs, in Corvus.Text.Json.JsonElement.Source outputs, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RequiredInputsAndOutputs> Create<TContext>(in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> inputs, in Corvus.Text.Json.JsonElement.Source<TContext> outputs, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
