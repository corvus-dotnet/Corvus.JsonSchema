...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapBpaTaskNamespace
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RequiredInputsAndOutputs"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RequiredInputsAndOutputs(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RequiredInputsAndOutputs DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in RequiredInputsAndOutputs left, in RequiredInputsAndOutputs right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RequiredInputsAndOutputs left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(RequiredInputsAndOutputs instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RequiredInputsAndOutputs(JsonElement instance)
            {
                return RequiredInputsAndOutputs.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredInputsAndOutputs From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredInputsAndOutputs ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredInputsAndOutputs>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredInputsAndOutputs ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredInputsAndOutputs>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredInputsAndOutputs ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredInputsAndOutputs>(json, options);
            }
            ...
            /// </exception>
            public static RequiredInputsAndOutputs ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RequiredInputsAndOutputs>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredInputsAndOutputs? result)
            {
                return JsonElementHelpers.TryParseValue<RequiredInputsAndOutputs>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RequiredInputsAndOutputs(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static RequiredInputsAndOutputs IJsonElement<RequiredInputsAndOutputs>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RequiredInputsAndOutputs: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RequiredInputsAndOutputs"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RequiredInputsAndOutputs"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public RequiredInputsAndOutputs Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RequiredInputsAndOutputs>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RequiredInputsAndOutputs"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public RequiredInputsAndOutputs Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RequiredInputsAndOutputs>(_idx);
                }
