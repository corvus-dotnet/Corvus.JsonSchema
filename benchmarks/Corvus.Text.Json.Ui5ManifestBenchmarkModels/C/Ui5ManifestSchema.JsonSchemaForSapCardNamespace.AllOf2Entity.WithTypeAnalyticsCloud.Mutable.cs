...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapCardNamespace
    {
        ...
        public readonly partial struct AllOf2Entity
        {
            ...
            public readonly partial struct WithTypeAnalyticsCloud
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(WithTypeAnalyticsCloud instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="WithTypeAnalyticsCloud"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator WithTypeAnalyticsCloud(Mutable instance)
                    {
                    ...
                    /// </summary>
                    public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf2Entity.WithTypeAnalyticsCloud.TypeEntity.Mutable Type
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf2Entity.WithTypeAnalyticsCloud.TypeEntity.Mutable value))
                            {
                                return value;
                            }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new WithTypeAnalyticsCloud(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    public void SetType(scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf2Entity.WithTypeAnalyticsCloud.TypeEntity.Source value)
                    {
                        CheckValidInstance();
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"WithTypeAnalyticsCloud.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="WithTypeAnalyticsCloud"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="WithTypeAnalyticsCloud"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly WithTypeAnalyticsCloud Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<WithTypeAnalyticsCloud>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="WithTypeAnalyticsCloud"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly WithTypeAnalyticsCloud Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<WithTypeAnalyticsCloud>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf2Entity.WithTypeAnalyticsCloud.TypeEntity.Source _createArg1;
                    ...
                    internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf2Entity.WithTypeAnalyticsCloud.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    internal Source(scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf2Entity.WithTypeAnalyticsCloud.TypeEntity.Source arg1)
                    {
                        _createArg1 = arg1;
                        _kind = Kind.Create;
                    }

                    public static implicit operator Source(WithTypeAnalyticsCloud instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf2Entity.WithTypeAnalyticsCloud.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// <summary>
                    /// Creates an instance of a <see cref="WithTypeAnalyticsCloud"/>.
                    /// </summary>
                    internal static void Create(ref ComplexValueBuilder builder, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf2Entity.WithTypeAnalyticsCloud.TypeEntity.Source type = default)
                    {
                    ...
                    /// Creates an instance of a <see cref="WithTypeAnalyticsCloud"/>.
                    /// </summary>
                    public void Create(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf2Entity.WithTypeAnalyticsCloud.TypeEntity.Source type = default)
                    {
                    ...
                    internal static void BuildCreateValue(scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf2Entity.WithTypeAnalyticsCloud.TypeEntity.Source arg1, ref ComplexValueBuilder o)
                    {
                        o.StartObject();
                        Create(ref o, arg1);
                        o.EndObject();
                ...
                /// <returns>The source from which to build the value.</returns>
                public static Source Build(scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf2Entity.WithTypeAnalyticsCloud.TypeEntity.Source type = default)
                {
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf2Entity.WithTypeAnalyticsCloud.TypeEntity.Source type = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                ...
                {
                    return workspace.CreateBuilder<WithTypeAnalyticsCloud, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<WithTypeAnalyticsCloud> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<WithTypeAnalyticsCloud>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<WithTypeAnalyticsCloud> Create<TContext>(
                ...
                public static ParsedJsonDocument<WithTypeAnalyticsCloud> Create(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf2Entity.WithTypeAnalyticsCloud.TypeEntity.Source type = default, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
