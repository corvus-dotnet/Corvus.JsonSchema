        ...
        public readonly partial struct AllOf4Entity
        {
            ...
            public readonly partial struct WithTypeTable
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(WithTypeTable instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="WithTypeTable"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator WithTypeTable(Mutable instance)
                    {
                    ...
                    /// </summary>
                    public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf4Entity.WithTypeTable.TypeEntity.Mutable Type
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf4Entity.WithTypeTable.TypeEntity.Mutable value))
                            {
                                return value;
                            }
                    ...
                    public void SetType(scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf4Entity.WithTypeTable.TypeEntity.Source value)
                    {
                        CheckValidInstance();
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"WithTypeTable.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly WithTypeTable Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly WithTypeTable Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<WithTypeTable>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf4Entity.WithTypeTable.TypeEntity.Source _createArg1;
                    ...
                    internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf4Entity.WithTypeTable.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    internal Source(scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf4Entity.WithTypeTable.TypeEntity.Source arg1)
                    {
                        _createArg1 = arg1;
                        _kind = Kind.Create;
                    }

                    public static implicit operator Source(WithTypeTable instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf4Entity.WithTypeTable.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// <summary>
                    /// Creates an instance of a <see cref="WithTypeTable"/>.
                    /// </summary>
                    internal static void Create(ref ComplexValueBuilder builder, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf4Entity.WithTypeTable.TypeEntity.Source type = default)
                    {
                    ...
                    /// Creates an instance of a <see cref="WithTypeTable"/>.
                    /// </summary>
                    public void Create(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf4Entity.WithTypeTable.TypeEntity.Source type = default)
                    {
                    ...
                    internal static void BuildCreateValue(scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf4Entity.WithTypeTable.TypeEntity.Source arg1, ref ComplexValueBuilder o)
                    {
                        o.StartObject();
                        Create(ref o, arg1);
                        o.EndObject();
                ...
                /// <returns>The source from which to build the value.</returns>
                public static Source Build(scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf4Entity.WithTypeTable.TypeEntity.Source type = default)
                {
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf4Entity.WithTypeTable.TypeEntity.Source type = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                ...
                {
                    return workspace.CreateBuilder<WithTypeTable, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<WithTypeTable> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<WithTypeTable>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<WithTypeTable> Create<TContext>(
                ...
                public static ParsedJsonDocument<WithTypeTable> Create(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf4Entity.WithTypeTable.TypeEntity.Source type = default, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
