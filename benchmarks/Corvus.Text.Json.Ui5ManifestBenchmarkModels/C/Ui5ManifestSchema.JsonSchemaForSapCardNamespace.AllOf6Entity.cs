...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapCardNamespace
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeComponent Content
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ContentUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ContentTypeComponent value))
                    {
                        return value;
                    }
            ...
            public bool TryGetAsWithTypeComponent(out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf6Entity.WithTypeComponent result)
            {
                ...
                {
                    result = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf6Entity.WithTypeComponent.From(this);
                    return true;
                }
            ...
            public bool TryGetAsThenEntity(out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf6Entity.ThenEntity result)
            {
                ...
                {
                    result = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf6Entity.ThenEntity.From(this);
                    return true;
                }
