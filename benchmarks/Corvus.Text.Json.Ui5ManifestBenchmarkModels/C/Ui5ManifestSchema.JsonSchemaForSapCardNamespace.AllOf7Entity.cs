...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapCardNamespace
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="AllOf7Entity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal AllOf7Entity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static AllOf7Entity DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in AllOf7Entity left, in AllOf7Entity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in AllOf7Entity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(AllOf7Entity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AllOf7Entity(JsonElement instance)
            {
                return AllOf7Entity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AllOf7Entity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AllOf7Entity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AllOf7Entity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AllOf7Entity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AllOf7Entity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AllOf7Entity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AllOf7Entity>(json, options);
            }
            ...
            /// </exception>
            public static AllOf7Entity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<AllOf7Entity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out AllOf7Entity? result)
            {
                return JsonElementHelpers.TryParseValue<AllOf7Entity>(ref reader, out result);
            }
...
#if NET
            static AllOf7Entity IJsonElement<AllOf7Entity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AllOf7Entity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            public bool TryGetAsWithTypeCalendar(out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf7Entity.WithTypeCalendar result)
            {
                ...
                {
                    result = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf7Entity.WithTypeCalendar.From(this);
                    return true;
                }
            ...
            public bool TryGetAsThenEntity(out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf7Entity.ThenEntity result)
            {
                ...
                {
                    result = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf7Entity.ThenEntity.From(this);
                    return true;
                }
