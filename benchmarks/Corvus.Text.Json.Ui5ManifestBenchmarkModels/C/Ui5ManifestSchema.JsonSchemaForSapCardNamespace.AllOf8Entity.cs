...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapCardNamespace
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="AllOf8Entity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal AllOf8Entity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static AllOf8Entity DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.AdaptiveCard Content
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ContentUtf8, out Corvus.Ui5ManifestBenchmark.Current.AdaptiveCard value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in AllOf8Entity left, in AllOf8Entity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in AllOf8Entity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(AllOf8Entity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AllOf8Entity(JsonElement instance)
            {
                return AllOf8Entity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AllOf8Entity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AllOf8Entity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AllOf8Entity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AllOf8Entity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AllOf8Entity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AllOf8Entity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AllOf8Entity>(json, options);
            }
            ...
            /// </exception>
            public static AllOf8Entity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<AllOf8Entity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out AllOf8Entity? result)
            {
                return JsonElementHelpers.TryParseValue<AllOf8Entity>(ref reader, out result);
            }
...
#if NET
            static AllOf8Entity IJsonElement<AllOf8Entity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AllOf8Entity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf8Entity.WithTypeAdaptiveCard" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsWithTypeAdaptiveCard(out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf8Entity.WithTypeAdaptiveCard result)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf8Entity.WithTypeAdaptiveCard.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf8Entity.WithTypeAdaptiveCard.From(this);
                    return true;
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf8Entity.ThenEntity" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsThenEntity(out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf8Entity.ThenEntity result)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf8Entity.ThenEntity.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf8Entity.ThenEntity.From(this);
                    return true;
                }
            ...
            /// <param name="matchCorvusUi5ManifestBenchmarkCurrentUi5ManifestSchemaJsonSchemaForSapCardNamespaceAllOf8EntityThenEntity">Match a <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf8Entity.ThenEntity"/>.</param>
            ...
            public TResult Match<TContext, TResult>(
                in TContext context,
                Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf8Entity.ThenEntity, TContext, TResult> matchCorvusUi5ManifestBenchmarkCurrentUi5ManifestSchemaJsonSchemaForSapCardNamespaceAllOf8EntityThenEntity,
...
#endif
            {
                if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf8Entity.WithTypeAdaptiveCard.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchCorvusUi5ManifestBenchmarkCurrentUi5ManifestSchemaJsonSchemaForSapCardNamespaceAllOf8EntityThenEntity(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf8Entity.ThenEntity.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf8Entity.ThenEntity, TResult> matchCorvusUi5ManifestBenchmarkCurrentUi5ManifestSchemaJsonSchemaForSapCardNamespaceAllOf8EntityThenEntity,
                Matcher<AllOf8Entity, TResult> defaultMatch)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf8Entity.WithTypeAdaptiveCard.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchCorvusUi5ManifestBenchmarkCurrentUi5ManifestSchemaJsonSchemaForSapCardNamespaceAllOf8EntityThenEntity(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.AllOf8Entity.ThenEntity.From(this));
                }
