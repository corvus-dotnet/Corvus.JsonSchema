        ...
        public readonly partial struct ConfigurationEntity
        {
            ...
            public readonly partial struct DescribesTheCsrfTokensUsedByTheCard
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(DescribesTheCsrfTokensUsedByTheCard instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="DescribesTheCsrfTokensUsedByTheCard"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator DescribesTheCsrfTokensUsedByTheCard(Mutable instance)
                    {
                    ...
                    public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ConfigurationCsrfToken.Mutable this[ReadOnlySpan<byte> propertyName]
                    {
                        get
                        {
                            CheckValidInstance();
                            if (!_parent.TryGetNamedPropertyValue(_idx, propertyName, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ConfigurationCsrfToken.Mutable value))
                            {
                                return default;
                            }
                    ...
                    /// <returns>The value of the property with the given name.</returns>
                    /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                    public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ConfigurationCsrfToken.Mutable this[ReadOnlySpan<char> propertyName]
                    {
                        get
                        {
                            CheckValidInstance();
                    ...
                    /// <returns>The value of the property with the given name.</returns>
                    /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                    public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ConfigurationCsrfToken.Mutable this[string propertyName]
                    {
                        get
                        {
                            CheckValidInstance();
                    ...
                    /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                    public bool TryGetProperty(ReadOnlySpan<byte> propertyName, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ConfigurationCsrfToken.Mutable value)
                    {
                        CheckValidInstance();
                    ...
                    /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
                    /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                    public bool TryGetProperty(ReadOnlySpan<char> propertyName, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ConfigurationCsrfToken.Mutable value)
                    {
                        CheckValidInstance();
                        return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
                    }
                    ...
                    /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
                    /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                    public bool TryGetProperty(string propertyName, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ConfigurationCsrfToken.Mutable value)
                    {
                        CheckValidInstance();
                        return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
                    }
                    ...
                    /// </summary>
                    /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                    public ObjectEnumerator<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ConfigurationCsrfToken.Mutable> EnumerateObject()
                    {
                        CheckValidInstance();
                        return EnumeratorCreator.CreateObjectEnumerator<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ConfigurationCsrfToken.Mutable>(_parent, _idx);
                    }
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"DescribesTheCsrfTokensUsedByTheCard.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </remarks>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void SetProperty(string propertyName, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ConfigurationCsrfToken.Source value)
                    {
                    ...
                    ///   </para>
                    /// </remarks>
                    public void SetProperty(ReadOnlySpan<char> propertyName, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ConfigurationCsrfToken.Source value)
                    {
                        CheckValidInstance();
                    ...
                    ///   </para>
                    /// </remarks>
                    public void SetProperty(ReadOnlySpan<byte> propertyName, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ConfigurationCsrfToken.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DescribesTheCsrfTokensUsedByTheCard Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DescribesTheCsrfTokensUsedByTheCard Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<DescribesTheCsrfTokensUsedByTheCard>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.ConfigurationEntity.DescribesTheCsrfTokensUsedByTheCard.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(DescribesTheCsrfTokensUsedByTheCard instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.ConfigurationEntity.DescribesTheCsrfTokensUsedByTheCard.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    public void AddProperty(ReadOnlySpan<byte> propertyName, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ConfigurationCsrfToken.Source value)
                    {
                    ...
                    /// <param name="propertyName">The name of the property to add.</param>
                    /// <param name="value">The value of the property to add.</param>
                    public void AddProperty<TContext>(ReadOnlySpan<byte> propertyName, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ConfigurationCsrfToken.Source<TContext> value)
#if NET9_0_OR_GREATER
                        where TContext : allows ref struct
#endif
                    {
                    ...
                    /// <param name="propertyName">The name of the property to add.</param>
                    /// <param name="value">The value of the property to add.</param>
                    public void AddProperty(ReadOnlySpan<char> propertyName, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ConfigurationCsrfToken.Source value)
                    {
                        value.AddAsProperty(propertyName, ref _builder);
                    }
                    ...
                    /// <param name="propertyName">The name of the property to add.</param>
                    /// <param name="value">The value of the property to add.</param>
                    public void AddProperty<TContext>(ReadOnlySpan<char> propertyName, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ConfigurationCsrfToken.Source<TContext> value)
#if NET9_0_OR_GREATER
                        where TContext : allows ref struct
#endif
                    {
                    ...
                    /// <param name="propertyName">The name of the property to add.</param>
                    /// <param name="value">The value of the property to add.</param>
                    public void AddProperty(string propertyName, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ConfigurationCsrfToken.Source value)
                    {
                        value.AddAsProperty(propertyName, ref _builder);
                    }
                    ...
                    /// <param name="propertyName">The name of the property to add.</param>
                    /// <param name="value">The value of the property to add.</param>
                    public void AddProperty<TContext>(string propertyName, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ConfigurationCsrfToken.Source<TContext> value)
#if NET9_0_OR_GREATER
                        where TContext : allows ref struct
#endif
                    {
                ...
                {
                    return workspace.CreateBuilder<DescribesTheCsrfTokensUsedByTheCard, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<DescribesTheCsrfTokensUsedByTheCard> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<DescribesTheCsrfTokensUsedByTheCard>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<DescribesTheCsrfTokensUsedByTheCard> Create<TContext>(
