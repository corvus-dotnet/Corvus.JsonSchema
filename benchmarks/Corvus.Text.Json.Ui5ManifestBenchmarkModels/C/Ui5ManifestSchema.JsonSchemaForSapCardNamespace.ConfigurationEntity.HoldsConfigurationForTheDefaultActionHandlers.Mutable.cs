        ...
        public readonly partial struct ConfigurationEntity
        {
            ...
            public readonly partial struct HoldsConfigurationForTheDefaultActionHandlers
            {
                ...
                public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonObject.Source<TContext> submit = default)
                    ...
                    #endif
                {
                    return new Source<TContext>(context, submit);
                }
                ...
                public static ParsedJsonDocument<HoldsConfigurationForTheDefaultActionHandlers> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<HoldsConfigurationForTheDefaultActionHandlers>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<HoldsConfigurationForTheDefaultActionHandlers> Create<TContext>(
                ...
                public static ParsedJsonDocument<HoldsConfigurationForTheDefaultActionHandlers> Create(in Corvus.Ui5ManifestBenchmark.Current.JsonObject.Source submit = default, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
                public static ParsedJsonDocument<HoldsConfigurationForTheDefaultActionHandlers> Create<TContext>(in TContext context, in Corvus.Ui5ManifestBenchmark.Current.JsonObject.Source<TContext> submit = default, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
