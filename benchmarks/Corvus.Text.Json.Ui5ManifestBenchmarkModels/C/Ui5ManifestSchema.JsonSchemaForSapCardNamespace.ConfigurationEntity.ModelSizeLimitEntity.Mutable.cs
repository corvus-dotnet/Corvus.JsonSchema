        ...
        public readonly partial struct ConfigurationEntity
        {
            ...
            public readonly partial struct ModelSizeLimitEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ModelSizeLimitEntity, Mutable>(ModelSizeLimitEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(ModelSizeLimitEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ModelSizeLimitEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ModelSizeLimitEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ModelSizeLimitEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ModelSizeLimitEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ModelSizeLimitEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ModelSizeLimitEntity>(_idx);
                    }
                    ...
                    public TResult Match<TContext, TResult>(
                        ...
                        Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.ConfigurationEntity.ModelSizeLimitEntity.Mutable, TContext, TResult> defaultMatch)
                    ...
                    public TResult Match<TResult>(
                        ...
                        Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.ConfigurationEntity.ModelSizeLimitEntity.Mutable, TResult> defaultMatch)
                    {
                        if (Corvus.Ui5ManifestBenchmark.Current.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                        {
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(ModelSizeLimitEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<ModelSizeLimitEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<ModelSizeLimitEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<ModelSizeLimitEntity>();
                    }
                    finally
                    {
