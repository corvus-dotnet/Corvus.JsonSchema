...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapCardNamespace
    {
        ...
        public readonly partial struct RepresentCardFooterAttributes
        {
            ...
            public readonly partial struct ExperimentalDescribesThePaginator
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(ExperimentalDescribesThePaginator instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ExperimentalDescribesThePaginator"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ExperimentalDescribesThePaginator(Mutable instance)
                    {
                    ...
                    /// <summary>
                    /// Gets the (optional) <c>pageSize</c> property.
                    /// </summary>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.RepresentCardFooterAttributes.ExperimentalDescribesThePaginator.RepresentsTheNumberOfTheItemsInOnePage.Mutable PageSize
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PageSizeUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.RepresentCardFooterAttributes.ExperimentalDescribesThePaginator.RepresentsTheNumberOfTheItemsInOnePage.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// <summary>
                    /// Gets the (optional) <c>totalCount</c> property.
                    /// </summary>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.RepresentCardFooterAttributes.ExperimentalDescribesThePaginator.RepresentsTheTotalCountOfTheItemsInAllPages.Mutable TotalCount
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TotalCountUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.RepresentCardFooterAttributes.ExperimentalDescribesThePaginator.RepresentsTheTotalCountOfTheItemsInAllPages.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// <remarks>
                    /// <para>
                    /// Represents the visibility of the paginator
                    /// </para>
                    /// </remarks>
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new ExperimentalDescribesThePaginator(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    public void SetPageSize(scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.RepresentCardFooterAttributes.ExperimentalDescribesThePaginator.RepresentsTheNumberOfTheItemsInOnePage.Source value)
                    {
                        ...
                        {
                            JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.PageSizeUtf8);
                            _documentVersion = _parent.Version;
                            return;
                        }

                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PageSizeUtf8, out IJsonDocument? elementParent, out int elementIdx))
                        {
                        ...
                        else
                        {
                            ...
                            value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.PageSize, ref cvb);
                    ...
                    /// <summary>
                    /// Remove the <c>pageSize</c> property, if present.
                    /// </summary>
                    /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                    public bool RemovePageSize()
                    {
                        CheckValidInstance();
                        bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.PageSizeUtf8);
                        _documentVersion = _parent.Version;
                        return result;
                    }
                    ...
                    public void SetTotalCount(scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.RepresentCardFooterAttributes.ExperimentalDescribesThePaginator.RepresentsTheTotalCountOfTheItemsInAllPages.Source value)
                    {
                        ...
                        if (value.IsUndefined)
                        {
                            JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.TotalCountUtf8);
                            _documentVersion = _parent.Version;
                            return;
                        }

                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TotalCountUtf8, out IJsonDocument? elementParent, out int elementIdx))
                        {
                            // We are going to replace just the value
                            value.AddAsItem(ref cvb);
                            _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                        ...
                        {
                            // We are going to insert the new value
                            value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.TotalCount, ref cvb);
                            int endIndex = _idx + _parent.GetDbSize(_idx, false);
                            _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                        }
                    ...
                    /// <summary>
                    /// Remove the <c>totalCount</c> property, if present.
                    /// </summary>
                    /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                    public bool RemoveTotalCount()
                    {
                        CheckValidInstance();
                        bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.TotalCountUtf8);
                        _documentVersion = _parent.Version;
                        return result;
                    }
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ExperimentalDescribesThePaginator.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="ExperimentalDescribesThePaginator"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="ExperimentalDescribesThePaginator"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ExperimentalDescribesThePaginator Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<ExperimentalDescribesThePaginator>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="ExperimentalDescribesThePaginator"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ExperimentalDescribesThePaginator Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ExperimentalDescribesThePaginator>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.RepresentCardFooterAttributes.ExperimentalDescribesThePaginator.RepresentsTheNumberOfTheItemsInOnePage.Source _createArg1;
                    private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.RepresentCardFooterAttributes.ExperimentalDescribesThePaginator.RepresentsTheTotalCountOfTheItemsInAllPages.Source _createArg2;
                    private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Visibility.Source _createArg3;
                    ...
                    public static implicit operator Source(ExperimentalDescribesThePaginator instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.RepresentCardFooterAttributes.ExperimentalDescribesThePaginator.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// <summary>
                    /// Creates an instance of a <see cref="ExperimentalDescribesThePaginator"/>.
                    /// </summary>
                    internal static void Create(
                        ref ComplexValueBuilder builder,
                        in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.RepresentCardFooterAttributes.ExperimentalDescribesThePaginator.RepresentsTheNumberOfTheItemsInOnePage.Source pageSize = default,
                        in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.RepresentCardFooterAttributes.ExperimentalDescribesThePaginator.RepresentsTheTotalCountOfTheItemsInAllPages.Source totalCount = default,
                        in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Visibility.Source visible = default)
                    {
                        pageSize.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.PageSize, ref builder);
                        totalCount.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.TotalCount, ref builder);
                    ...
                    public void Create(
                        ...
                        in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Visibility.Source visible = default)
                    {
                        Create(ref _builder, pageSize, totalCount, visible);
                    }
                ...
                /// </summary>
                /// <param name="pageSize">The value of the <c>"pageSize"</c> property.</param>
                ...
                /// </summary>
                /// <param name="workspace">The JSON workspace.</param>
                /// <param name="pageSize">The value of the property.</param>
                /// <param name="totalCount">The value of the property.</param>
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.RepresentCardFooterAttributes.ExperimentalDescribesThePaginator.RepresentsTheNumberOfTheItemsInOnePage.Source pageSize = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.RepresentCardFooterAttributes.ExperimentalDescribesThePaginator.RepresentsTheTotalCountOfTheItemsInAllPages.Source totalCount = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Visibility.Source visible = default, int initialCapacity = 30)
                {
                    ...
                    cvb.StartObject();
                    Builder ovb = new(cvb);
                    ovb.Create(pageSize, totalCount, visible);
                    cvb = ovb._builder;
                    cvb.EndObject();
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
                ...
                {
                    return workspace.CreateBuilder<ExperimentalDescribesThePaginator, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<ExperimentalDescribesThePaginator> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<ExperimentalDescribesThePaginator>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<ExperimentalDescribesThePaginator> Create<TContext>(
                ...
                public static ParsedJsonDocument<ExperimentalDescribesThePaginator> Create(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.RepresentCardFooterAttributes.ExperimentalDescribesThePaginator.RepresentsTheNumberOfTheItemsInOnePage.Source pageSize = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.RepresentCardFooterAttributes.ExperimentalDescribesThePaginator.RepresentsTheTotalCountOfTheItemsInAllPages.Source totalCount = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Visibility.Source visible = default, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
