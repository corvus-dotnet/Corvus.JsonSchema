        ...
        public readonly partial struct RepresentCardFooterAttributes
        {
            ...
            public readonly partial struct ExperimentalDescribesThePaginator
            {
...
#endif
                {
                    ...
                    public void SetPageSize(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.RepresentCardFooterAttributes.ExperimentalDescribesThePaginator.RepresentsTheNumberOfTheItemsInOnePage.Source value)
                    {
                        ...
                        else
                        {
                            ...
                            value.AddAsProperty(JsonPropertyNamesEscaped.PageSize, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    ...
                    public void SetTotalCount(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.RepresentCardFooterAttributes.ExperimentalDescribesThePaginator.RepresentsTheTotalCountOfTheItemsInAllPages.Source value)
                    {
                        ...
                        {
                            // We are going to insert the new value
                            value.AddAsProperty(JsonPropertyNamesEscaped.TotalCount, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                            int endIndex = _idx + _parent.GetDbSize(_idx, false);
                            _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                        }
                ...
                public ref struct Builder
                {
                    ...
                    {
                        pageSize.AddAsProperty(JsonPropertyNamesEscaped.PageSize, ref builder, escapeName: false);
                        totalCount.AddAsProperty(JsonPropertyNamesEscaped.TotalCount, ref builder, escapeName: false);
