...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapCardNamespace
    {
        ...
        /// </para>
        /// </remarks>
        public readonly partial struct RepresentsCardHeaderPositionUnderOrOverTheContent
        {
            /// <summary>
            /// Generated from JSON Schema.
            /// </summary>
...
#endif
            {
                ...
                /// </summary>
                public static OneOf0Entity DefaultInstance { get; } = ParsedJsonDocument<OneOf0Entity>.StringConstant([.."\"Top\""u8]);
                ...
                /// <param name="matchTop">Match 1st item.</param>
                /// <param name="matchBottom">Match 2nd item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> matchTop,
                    Func<TContext, TResult> matchBottom,
...
#endif
                {
                    ...
                    {
                        return matchTop(context);
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchBottom(context);
                    }
                ...
                public TResult Match<TResult>(
                    Func<TResult> matchTop,
                    Func<TResult> matchBottom,
