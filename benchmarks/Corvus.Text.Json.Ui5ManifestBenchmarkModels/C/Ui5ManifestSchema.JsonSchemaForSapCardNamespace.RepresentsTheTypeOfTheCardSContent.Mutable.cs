    ...
    public readonly partial struct JsonSchemaForSapCardNamespace
    {
        ...
        public readonly partial struct RepresentsTheTypeOfTheCardSContent
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RepresentsTheTypeOfTheCardSContent instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsTheTypeOfTheCardSContent"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsTheTypeOfTheCardSContent(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new RepresentsTheTypeOfTheCardSContent(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsTheTypeOfTheCardSContent.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="RepresentsTheTypeOfTheCardSContent"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="RepresentsTheTypeOfTheCardSContent"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheTypeOfTheCardSContent Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<RepresentsTheTypeOfTheCardSContent>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="RepresentsTheTypeOfTheCardSContent"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheTypeOfTheCardSContent Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsTheTypeOfTheCardSContent>(_idx);
                }
                ...
                /// <param name="matchAdaptiveCard">Match 1st item.</param>
                /// <param name="matchAnalytical">Match 2nd item.</param>
                /// <param name="matchAnalyticsCloud">Match 3rd item.</param>
                /// <param name="matchCalendar">Match 4th item.</param>
                /// <param name="matchComponent">Match 5th item.</param>
                /// <param name="matchList">Match 6th item.</param>
                /// <param name="matchObject">Match 7th item.</param>
                /// <param name="matchTable">Match 8th item.</param>
                /// <param name="matchTimeline">Match 9th item.</param>
                /// <param name="matchWebPage">Match 10th item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> matchAdaptiveCard,
                    Func<TContext, TResult> matchAnalytical,
                    Func<TContext, TResult> matchAnalyticsCloud,
                    Func<TContext, TResult> matchCalendar,
                    Func<TContext, TResult> matchComponent,
                    Func<TContext, TResult> matchList,
                    Func<TContext, TResult> matchObject,
                    Func<TContext, TResult> matchTable,
                    Func<TContext, TResult> matchTimeline,
                    Func<TContext, TResult> matchWebPage,
...
#endif
                {
                    ...
                    {
                        return matchAdaptiveCard(context);
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchAnalytical(context);
                    }

                    if (this.ValueEquals(Constants.Enum3))
                    {
                        return matchAnalyticsCloud(context);
                    }

                    if (this.ValueEquals(Constants.Enum4))
                    {
                        return matchCalendar(context);
                    }
                    ...
                    {
                        return matchTable(context);
                    }

                    if (this.ValueEquals(Constants.Enum9))
                    {
                        return matchTimeline(context);
                    }

                    if (this.ValueEquals(Constants.Enum10))
                    {
                        return matchWebPage(context);
                    }
                ...
                public TResult Match<TResult>(
                    Func<TResult> matchAdaptiveCard,
                    Func<TResult> matchAnalytical,
                    Func<TResult> matchAnalyticsCloud,
                    Func<TResult> matchCalendar,
                    Func<TResult> matchComponent,
                    Func<TResult> matchList,
                    Func<TResult> matchObject,
                    Func<TResult> matchTable,
                    Func<TResult> matchTimeline,
                    Func<TResult> matchWebPage,
                    Func<TResult> defaultMatch)
                {
                    if (this.ValueEquals(Constants.Enum1))
                    {
                        return matchAdaptiveCard();
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchAnalytical();
                    }

                    if (this.ValueEquals(Constants.Enum3))
                    {
                        return matchAnalyticsCloud();
                    }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsTheTypeOfTheCardSContent instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RepresentsTheTypeOfTheCardSContent, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RepresentsTheTypeOfTheCardSContent> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RepresentsTheTypeOfTheCardSContent>();
                }
                finally
                {
