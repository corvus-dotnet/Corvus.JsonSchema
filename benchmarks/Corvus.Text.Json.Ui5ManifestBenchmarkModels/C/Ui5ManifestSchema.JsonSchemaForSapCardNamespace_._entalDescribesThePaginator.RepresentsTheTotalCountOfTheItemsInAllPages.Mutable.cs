        ...
        public readonly partial struct RepresentCardFooterAttributes
        {
            ...
            public readonly partial struct ExperimentalDescribesThePaginator
            {
                ...
                public readonly partial struct RepresentsTheTotalCountOfTheItemsInAllPages
                {
                    ...
                    public static ParsedJsonDocument<RepresentsTheTotalCountOfTheItemsInAllPages> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<RepresentsTheTotalCountOfTheItemsInAllPages>();
                        }
                        finally
                        {
