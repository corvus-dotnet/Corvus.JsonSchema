            ...
            public readonly partial struct ExperimentalDescribesThePaginator
            {
                ...
                public readonly partial struct RepresentsTheNumberOfTheItemsInOnePage
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(RepresentsTheNumberOfTheItemsInOnePage instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="RepresentsTheNumberOfTheItemsInOnePage"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator RepresentsTheNumberOfTheItemsInOnePage(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"RepresentsTheNumberOfTheItemsInOnePage.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RepresentsTheNumberOfTheItemsInOnePage Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RepresentsTheNumberOfTheItemsInOnePage Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<RepresentsTheNumberOfTheItemsInOnePage>(_idx);
                        }
                        ...
                        public TResult Match<TContext, TResult>(
                            ...
                            Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.RepresentCardFooterAttributes.ExperimentalDescribesThePaginator.RepresentsTheNumberOfTheItemsInOnePage.Mutable, TContext, TResult> defaultMatch)
                        ...
                        public TResult Match<TResult>(
                            ...
                            Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCardNamespace.RepresentCardFooterAttributes.ExperimentalDescribesThePaginator.RepresentsTheNumberOfTheItemsInOnePage.Mutable, TResult> defaultMatch)
                        {
                            if (Corvus.Ui5ManifestBenchmark.Current.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                            {
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(RepresentsTheNumberOfTheItemsInOnePage instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<RepresentsTheNumberOfTheItemsInOnePage, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<RepresentsTheNumberOfTheItemsInOnePage> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<RepresentsTheNumberOfTheItemsInOnePage>();
                        }
                        finally
                        {
