    ...
    public readonly partial struct JsonSchemaForSapCloudNamespace
    {
        ...
        public readonly partial struct UniqueBusinessServiceIdentifier
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(UniqueBusinessServiceIdentifier instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="UniqueBusinessServiceIdentifier"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator UniqueBusinessServiceIdentifier(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"UniqueBusinessServiceIdentifier.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly UniqueBusinessServiceIdentifier Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly UniqueBusinessServiceIdentifier Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<UniqueBusinessServiceIdentifier>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(UniqueBusinessServiceIdentifier instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<UniqueBusinessServiceIdentifier, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<UniqueBusinessServiceIdentifier> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<UniqueBusinessServiceIdentifier>();
                }
                finally
                {
