...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapCloudNamespace
    {
        ...
        public readonly partial struct UniqueBusinessServiceIdentifier
#if NET8_0_OR_GREATER
            : IJsonElement<UniqueBusinessServiceIdentifier>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="UniqueBusinessServiceIdentifier"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal UniqueBusinessServiceIdentifier(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static UniqueBusinessServiceIdentifier DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(UniqueBusinessServiceIdentifier value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in UniqueBusinessServiceIdentifier left, in UniqueBusinessServiceIdentifier right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in UniqueBusinessServiceIdentifier left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(UniqueBusinessServiceIdentifier instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator UniqueBusinessServiceIdentifier(JsonElement instance)
            {
                return UniqueBusinessServiceIdentifier.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static UniqueBusinessServiceIdentifier From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static UniqueBusinessServiceIdentifier ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<UniqueBusinessServiceIdentifier>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static UniqueBusinessServiceIdentifier ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<UniqueBusinessServiceIdentifier>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static UniqueBusinessServiceIdentifier ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<UniqueBusinessServiceIdentifier>(json, options);
            }
            ...
            /// </exception>
            public static UniqueBusinessServiceIdentifier ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<UniqueBusinessServiceIdentifier>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out UniqueBusinessServiceIdentifier? result)
            {
                return JsonElementHelpers.TryParseValue<UniqueBusinessServiceIdentifier>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new UniqueBusinessServiceIdentifier(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static UniqueBusinessServiceIdentifier IJsonElement<UniqueBusinessServiceIdentifier>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"UniqueBusinessServiceIdentifier: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="UniqueBusinessServiceIdentifier"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="UniqueBusinessServiceIdentifier"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public UniqueBusinessServiceIdentifier Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<UniqueBusinessServiceIdentifier>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="UniqueBusinessServiceIdentifier"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public UniqueBusinessServiceIdentifier Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<UniqueBusinessServiceIdentifier>(_idx);
                }
