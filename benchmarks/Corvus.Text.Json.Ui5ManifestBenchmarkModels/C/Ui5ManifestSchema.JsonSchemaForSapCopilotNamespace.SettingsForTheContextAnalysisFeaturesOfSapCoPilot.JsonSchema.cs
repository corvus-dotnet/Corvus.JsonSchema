    ...
    public readonly partial struct JsonSchemaForSapCopilotNamespace
    {
            ...
            : IJsonElement<SettingsForTheContextAnalysisFeaturesOfSapCoPilot>
        {
            public static partial class JsonSchema
            {
                ...
                private static void MatchAllowAddingObjectsFromAppScreenToCollection(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                {
                ...
                private static void MatchWhitelistedEntityTypes(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
