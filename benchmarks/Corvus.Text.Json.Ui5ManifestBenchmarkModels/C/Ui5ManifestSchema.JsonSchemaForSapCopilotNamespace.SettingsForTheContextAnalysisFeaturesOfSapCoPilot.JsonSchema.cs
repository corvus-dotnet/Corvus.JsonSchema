...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapCopilotNamespace
    {
        ...
        public readonly partial struct SettingsForTheContextAnalysisFeaturesOfSapCoPilot
            : IJsonElement<SettingsForTheContextAnalysisFeaturesOfSapCoPilot>
        {
            public static partial class JsonSchema
            {
                private static readonly JsonSchemaPathProvider AllowAddingObjectsFromAppScreenToCollectionSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/allowAddingObjectsFromAppScreenToCollection"u8, buffer, out written);
                private static readonly JsonSchemaPathProvider WhitelistedEntityTypesSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/whitelistedEntityTypes"u8, buffer, out written);

                private static void MatchAllowAddingObjectsFromAppScreenToCollection(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext =
                        Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCopilotNamespace.SettingsForTheContextAnalysisFeaturesOfSapCoPilot.AllowAddingObjectsFromAppScreenToCollectionEntity.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.AllowAddingObjectsFromAppScreenToCollectionUtf8,
                            evaluationPath: AllowAddingObjectsFromAppScreenToCollectionSchemaEvaluationPath);

                    Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCopilotNamespace.SettingsForTheContextAnalysisFeaturesOfSapCoPilot.AllowAddingObjectsFromAppScreenToCollectionEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                    context.CommitChildContext(childContext.IsMatch, ref childContext);
                }

                private static void MatchWhitelistedEntityTypes(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext1 =
                        Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCopilotNamespace.SettingsForTheContextAnalysisFeaturesOfSapCoPilot.JsonStringArray.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.WhitelistedEntityTypesUtf8,
                            evaluationPath: WhitelistedEntityTypesSchemaEvaluationPath);

                    Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCopilotNamespace.SettingsForTheContextAnalysisFeaturesOfSapCoPilot.JsonStringArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                ...
                private static PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator1> MatchersBuilder()
                {
                    return new PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator1>([
                        (static () => JsonPropertyNames.AllowAddingObjectsFromAppScreenToCollectionUtf8, MatchAllowAddingObjectsFromAppScreenToCollection),
                        (static () => JsonPropertyNames.WhitelistedEntityTypesUtf8, MatchWhitelistedEntityTypes),
                    ]);
                }
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("ui5-manifest-schema.json#/properties/sap.copilot/properties/contextAnalysis"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "ui5-manifest-schema.json#/properties/sap.copilot/properties/contextAnalysis";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "ui5-manifest-schema.json#/properties/sap.copilot/properties/contextAnalysis"u8;
