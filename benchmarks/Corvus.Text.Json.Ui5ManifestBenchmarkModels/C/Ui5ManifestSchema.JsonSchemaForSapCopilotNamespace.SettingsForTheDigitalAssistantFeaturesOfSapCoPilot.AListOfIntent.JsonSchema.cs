    ...
    public readonly partial struct JsonSchemaForSapCopilotNamespace
    {
        ...
        public readonly partial struct SettingsForTheDigitalAssistantFeaturesOfSapCoPilot
        {
            ...
            public readonly partial struct AListOfIntent
                : IJsonElement<AListOfIntent>
            {
                public static partial class JsonSchema
                {
                    private static readonly JsonSchemaPathProvider PatternPropertiesSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/patternProperties/^[a-zA-Z0-9_\\.\\-]*$"u8, buffer, out written);
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("ui5-manifest-schema.json#/properties/sap.copilot/properties/digitalAssistant/properties/intentDefinition"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "ui5-manifest-schema.json#/properties/sap.copilot/properties/digitalAssistant/properties/intentDefinition";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "ui5-manifest-schema.json#/properties/sap.copilot/properties/digitalAssistant/properties/intentDefinition"u8;
                        ...
                        else
                        {
                            ...
                            while (objectValidation_enumerator.MoveNext())
                            {
                                ...
                                if (JsonSchemaEvaluation.MatchRegularExpression(objectValidation_unescapedPropertyName.Span, PatternProperties))
                                {
                                    ...
                                    Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapCopilotNamespace.SettingsForTheDigitalAssistantFeaturesOfSapCoPilot.AListOfIntent.AZaZ09Entity.JsonSchema.Evaluate(parentDocument, objectValidation_currentIndex, ref childContext);
