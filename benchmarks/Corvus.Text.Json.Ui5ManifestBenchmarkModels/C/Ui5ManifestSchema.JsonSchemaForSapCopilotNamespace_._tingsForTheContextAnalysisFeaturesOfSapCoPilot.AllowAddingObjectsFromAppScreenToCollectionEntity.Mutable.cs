        ...
        public readonly partial struct SettingsForTheContextAnalysisFeaturesOfSapCoPilot
        {
            ...
            public readonly partial struct AllowAddingObjectsFromAppScreenToCollectionEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(AllowAddingObjectsFromAppScreenToCollectionEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="AllowAddingObjectsFromAppScreenToCollectionEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator AllowAddingObjectsFromAppScreenToCollectionEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"AllowAddingObjectsFromAppScreenToCollectionEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly AllowAddingObjectsFromAppScreenToCollectionEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly AllowAddingObjectsFromAppScreenToCollectionEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<AllowAddingObjectsFromAppScreenToCollectionEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(AllowAddingObjectsFromAppScreenToCollectionEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<AllowAddingObjectsFromAppScreenToCollectionEntity, Mutable>(this);
                }
            }
        }
    }
