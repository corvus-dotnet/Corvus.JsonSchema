        ...
        public readonly partial struct SettingsForTheContextAnalysisFeaturesOfSapCoPilot
        {
            ...
            public readonly partial struct AllowAddingObjectsFromAppScreenToCollectionEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<AllowAddingObjectsFromAppScreenToCollectionEntity, Mutable>(AllowAddingObjectsFromAppScreenToCollectionEntity.DefaultInstance);
                ...
                public static ParsedJsonDocument<AllowAddingObjectsFromAppScreenToCollectionEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<AllowAddingObjectsFromAppScreenToCollectionEntity>();
                    }
                    finally
                    {
