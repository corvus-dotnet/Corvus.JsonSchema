...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapFeNamespace
#if NET8_0_OR_GREATER
        : IJsonElement<JsonSchemaForSapFeNamespace>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="JsonSchemaForSapFeNamespace"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal JsonSchemaForSapFeNamespace(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static JsonSchemaForSapFeNamespace DefaultInstance { get; }
        ...
        /// </returns>
        public static bool operator ==(in JsonSchemaForSapFeNamespace left, in JsonSchemaForSapFeNamespace right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in JsonSchemaForSapFeNamespace left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(JsonSchemaForSapFeNamespace instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonSchemaForSapFeNamespace(JsonElement instance)
        {
            return JsonSchemaForSapFeNamespace.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static JsonSchemaForSapFeNamespace From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static JsonSchemaForSapFeNamespace ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<JsonSchemaForSapFeNamespace>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static JsonSchemaForSapFeNamespace ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<JsonSchemaForSapFeNamespace>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static JsonSchemaForSapFeNamespace ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<JsonSchemaForSapFeNamespace>(json, options);
        }
        ...
        /// </exception>
        public static JsonSchemaForSapFeNamespace ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<JsonSchemaForSapFeNamespace>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out JsonSchemaForSapFeNamespace? result)
        {
            return JsonElementHelpers.TryParseValue<JsonSchemaForSapFeNamespace>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new JsonSchemaForSapFeNamespace(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static JsonSchemaForSapFeNamespace IJsonElement<JsonSchemaForSapFeNamespace>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"JsonSchemaForSapFeNamespace: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="JsonSchemaForSapFeNamespace"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="JsonSchemaForSapFeNamespace"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public JsonSchemaForSapFeNamespace Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<JsonSchemaForSapFeNamespace>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="JsonSchemaForSapFeNamespace"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public JsonSchemaForSapFeNamespace Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<JsonSchemaForSapFeNamespace>(_idx);
            }
