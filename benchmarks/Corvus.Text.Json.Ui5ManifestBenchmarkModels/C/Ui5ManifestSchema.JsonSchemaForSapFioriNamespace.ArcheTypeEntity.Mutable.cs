    ...
    public readonly partial struct JsonSchemaForSapFioriNamespace
    {
        ...
        public readonly partial struct ArcheTypeEntity
        {
            ...
            public ref struct Source
            {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (ArcheTypeEntity)value;
            ...
            public static ParsedJsonDocument<ArcheTypeEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ArcheTypeEntity>();
                }
                finally
                {
