...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapFioriNamespace
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ArcheTypeEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ArcheTypeEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ArcheTypeEntity DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(ArcheTypeEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in ArcheTypeEntity left, in ArcheTypeEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ArcheTypeEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ArcheTypeEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ArcheTypeEntity(JsonElement instance)
            {
                return ArcheTypeEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ArcheTypeEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ArcheTypeEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ArcheTypeEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ArcheTypeEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ArcheTypeEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ArcheTypeEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ArcheTypeEntity>(json, options);
            }
            ...
            /// </exception>
            public static ArcheTypeEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ArcheTypeEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ArcheTypeEntity? result)
            {
                return JsonElementHelpers.TryParseValue<ArcheTypeEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ArcheTypeEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static ArcheTypeEntity IJsonElement<ArcheTypeEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ArcheTypeEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ArcheTypeEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ArcheTypeEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public ArcheTypeEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ArcheTypeEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ArcheTypeEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public ArcheTypeEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ArcheTypeEntity>(_idx);
                }
            ...
            /// <param name="matchTransactional">Match 1st item.</param>
            /// <param name="matchAnalytical">Match 2nd item.</param>
            /// <param name="matchFactsheet">Match 3rd item.</param>
            /// <param name="matchReusecomponent">Match 4th item.</param>
            /// <param name="matchFpmwebdynpro">Match 5th item.</param>
            /// <param name="matchDesignstudio">Match 6th item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchTransactional,
                Func<TContext, TResult> matchAnalytical,
                Func<TContext, TResult> matchFactsheet,
                Func<TContext, TResult> matchReusecomponent,
                Func<TContext, TResult> matchFpmwebdynpro,
                Func<TContext, TResult> matchDesignstudio,
...
#endif
            {
                ...
                {
                    return matchTransactional(context);
                }
                ...
                {
                    return matchFactsheet(context);
                }

                if (this.ValueEquals(Constants.Enum4))
                {
                    return matchReusecomponent(context);
                }

                if (this.ValueEquals(Constants.Enum5))
                {
                    return matchFpmwebdynpro(context);
                }

                if (this.ValueEquals(Constants.Enum6))
                {
                    return matchDesignstudio(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchTransactional,
                Func<TResult> matchAnalytical,
                Func<TResult> matchFactsheet,
                Func<TResult> matchReusecomponent,
                Func<TResult> matchFpmwebdynpro,
                Func<TResult> matchDesignstudio,
                Func<TResult> defaultMatch)
            {
                if (this.ValueEquals(Constants.Enum1))
                {
                    return matchTransactional();
                }
                ...
                if (this.ValueEquals(Constants.Enum4))
                {
                    return matchReusecomponent();
                }

                if (this.ValueEquals(Constants.Enum5))
                {
                    return matchFpmwebdynpro();
                }

                if (this.ValueEquals(Constants.Enum6))
                {
                    return matchDesignstudio();
                }
