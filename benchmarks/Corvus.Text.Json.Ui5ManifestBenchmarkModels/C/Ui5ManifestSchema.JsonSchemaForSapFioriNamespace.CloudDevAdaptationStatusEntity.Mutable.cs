    ...
    public readonly partial struct JsonSchemaForSapFioriNamespace
    {
        ...
        public readonly partial struct CloudDevAdaptationStatusEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(CloudDevAdaptationStatusEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="CloudDevAdaptationStatusEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator CloudDevAdaptationStatusEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"CloudDevAdaptationStatusEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly CloudDevAdaptationStatusEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly CloudDevAdaptationStatusEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<CloudDevAdaptationStatusEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(CloudDevAdaptationStatusEntity instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (CloudDevAdaptationStatusEntity)value;
            ...
            {
                return workspace.CreateBuilder<CloudDevAdaptationStatusEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<CloudDevAdaptationStatusEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<CloudDevAdaptationStatusEntity>();
                }
                finally
                {
