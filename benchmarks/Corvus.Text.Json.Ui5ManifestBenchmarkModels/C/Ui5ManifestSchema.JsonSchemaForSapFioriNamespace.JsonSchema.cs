...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapFioriNamespace
        : IJsonElement<JsonSchemaForSapFioriNamespace>
    {
        public static partial class JsonSchema
        {
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyArcheTypePresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("archeType"u8, buffer, out written);
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyArcheTypeNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("archeType"u8, buffer, out written);

            private const int RequiredOffsetForArcheType = 0;
            private const uint RequiredBitForArcheType = 0b00000000000000000000000000000001;

            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyRegistrationIdsPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("registrationIds"u8, buffer, out written);
            private static readonly JsonSchemaMessageProvider<int> RequiredPropertyRegistrationIdsNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("registrationIds"u8, buffer, out written);

            private const int RequiredOffsetForRegistrationIds = 0;
            private const uint RequiredBitForRegistrationIds = 0b00000000000000000000000000000010;

            private const uint RequiredBitMask0 =
                RequiredBitForArcheType | RequiredBitForRegistrationIds;
            ...
            private static readonly JsonSchemaPathProvider AbstractSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/abstract"u8, buffer, out written);
            private static readonly JsonSchemaPathProvider ArcheTypeSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/archeType"u8, buffer, out written);
            ...
            private static void MatchVersion(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                ...
                JsonSchemaContext childContext =
                    Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapFioriNamespace.VersionEntity.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                ...
                Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapFioriNamespace.VersionEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
            ...
            private static void MatchAbstract(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                ...
                JsonSchemaContext childContext1 =
                    Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.JsonSchema.PushChildContextUnescaped(
                        ...
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.AbstractUtf8,
                        evaluationPath: AbstractSchemaEvaluationPath);
            ...
            private static void MatchArcheType(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                ...
                JsonSchemaContext childContext2 =
                    Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapFioriNamespace.ArcheTypeEntity.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.ArcheTypeUtf8,
                        evaluationPath: ArcheTypeSchemaEvaluationPath);

                Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapFioriNamespace.ArcheTypeEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext2);
            ...
            private static void MatchCloudDevAdaptationStatus(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                ...
                JsonSchemaContext childContext3 =
                    Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapFioriNamespace.CloudDevAdaptationStatusEntity.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.CloudDevAdaptationStatusUtf8,
                        evaluationPath: CloudDevAdaptationStatusSchemaEvaluationPath);

                Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapFioriNamespace.CloudDevAdaptationStatusEntity.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext3);
            ...
            private static void MatchRegistrationIds(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
            {
                ...
                JsonSchemaContext childContext4 =
                    Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapFioriNamespace.JsonStringArray.JsonSchema.PushChildContextUnescaped(
                        parentDocument,
                        parentDocumentIndex,
                        ref context,
                        JsonPropertyNames.RegistrationIdsUtf8,
                        evaluationPath: RegistrationIdsSchemaEvaluationPath);

                Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapFioriNamespace.JsonStringArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext4);
                ...
                requiredBitBuffer[RequiredOffsetForRegistrationIds] |= RequiredBitForRegistrationIds;
            }
            ...
            private static PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
            {
                return new PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator>([
                    ...
                    (static () => JsonPropertyNames.AbstractUtf8, MatchAbstract),
                    (static () => JsonPropertyNames.ArcheTypeUtf8, MatchArcheType),
                    (static () => JsonPropertyNames.CloudDevAdaptationStatusUtf8, MatchCloudDevAdaptationStatus),
                    (static () => JsonPropertyNames.RegistrationIdsUtf8, MatchRegistrationIds),
                ]);
            }
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("ui5-manifest-schema.json#/properties/sap.fiori"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "ui5-manifest-schema.json#/properties/sap.fiori";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "ui5-manifest-schema.json#/properties/sap.fiori"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    {
                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyArcheTypePresent, "archeType"u8, "required"u8);
                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyRegistrationIdsPresent, "registrationIds"u8, "required"u8);
                    }
                    ...
                    {
                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForArcheType] & RequiredBitForArcheType) == 0)
                        {
                            context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyArcheTypeNotPresent, "archeType"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyArcheTypePresent, "archeType"u8, "required"u8);
                        ...
                        if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForRegistrationIds] & RequiredBitForRegistrationIds) == 0)
                        {
                            context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyRegistrationIdsNotPresent, "registrationIds"u8, "required"u8);
                        }
                        else
                        {
                            context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyRegistrationIdsPresent, "registrationIds"u8, "required"u8);
