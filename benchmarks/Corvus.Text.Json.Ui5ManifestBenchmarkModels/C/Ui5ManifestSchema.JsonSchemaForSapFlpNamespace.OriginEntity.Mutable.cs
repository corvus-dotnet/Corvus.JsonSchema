    ...
    public readonly partial struct JsonSchemaForSapFlpNamespace
    {
        ...
        public readonly partial struct OriginEntity
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable TargetMappingId
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TargetMappingIdUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable TileId
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TileIdUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetTargetMappingId(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source value)
                {
                    ...
                    else
                    {
                        ...
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.TargetMappingId, ref cvb);
                ...
                public void SetTileId(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source value)
                {
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.TileId, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapFlpNamespace.OriginEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source targetMappingId = default,
                    in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source tileId = default)
                {
                    targetMappingId.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.TargetMappingId, ref builder);
                    tileId.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.TileId, ref builder);
                }

                /// <summary>
                /// Creates an instance of a <see cref="OriginEntity"/>.
                /// </summary>
                public void Create(in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source targetMappingId = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source tileId = default)
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source targetMappingId = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source tileId = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            public static ParsedJsonDocument<OriginEntity> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<OriginEntity>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<OriginEntity> Create<TContext>(
            ...
            public static ParsedJsonDocument<OriginEntity> Create(in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source targetMappingId = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source tileId = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
