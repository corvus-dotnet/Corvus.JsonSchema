...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapFlpNamespace
    {
        ...
        public readonly partial struct OriginEntity
#if NET8_0_OR_GREATER
            : IJsonElement<OriginEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="OriginEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal OriginEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static OriginEntity DefaultInstance { get; }

            /// <summary>
            /// Gets the (optional) <c>targetMappingId</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.JsonString TargetMappingId
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TargetMappingIdUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString value))
                    {
                        return value;
                    }
            ...
            /// <summary>
            /// Gets the (optional) <c>tileId</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.JsonString TileId
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TileIdUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in OriginEntity left, in OriginEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in OriginEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(OriginEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator OriginEntity(JsonElement instance)
            {
                return OriginEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OriginEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OriginEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OriginEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OriginEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OriginEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static OriginEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<OriginEntity>(json, options);
            }
            ...
            /// </exception>
            public static OriginEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<OriginEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out OriginEntity? result)
            {
                return JsonElementHelpers.TryParseValue<OriginEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new OriginEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static OriginEntity IJsonElement<OriginEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"OriginEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="OriginEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="OriginEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public OriginEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<OriginEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="OriginEntity"/> that lives for the lifetime of its
            ...
            {
                /// <summary>
                /// Gets the JSON property name for <see cref="TargetMappingId"/>.
                /// </summary>
                public const string TargetMappingId = "targetMappingId";

                /// <summary>
                /// Gets the JSON property name for <see cref="TileId"/>.
                /// </summary>
                ...
                /// Gets the JSON property name for <see cref="TargetMappingId"/>.
                /// </summary>
                public static ReadOnlySpan<byte> TargetMappingIdUtf8 => "targetMappingId"u8;

                /// <summary>
                /// Gets the JSON property name for <see cref="TileId"/>.
                /// </summary>
                public static ReadOnlySpan<byte> TileIdUtf8 => "tileId"u8;
            }
            ...
            {
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="TargetMappingId"/>.
                /// </summary>
                public static ReadOnlySpan<byte> TargetMappingId => "targetMappingId"u8;

                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="TileId"/>.
                /// </summary>
                public static ReadOnlySpan<byte> TileId => "tileId"u8;
            }
            ...
            {
                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="TargetMappingId"/>.
                /// </summary>
                public static ReadOnlySpan<byte> TargetMappingId => [0x15, 0x01, 0x00, 0x00, 0x22, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x4D, 0x61, 0x70, 0x70, 0x69, 0x6E, 0x67, 0x49, 0x64, 0x22];

                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="TileId"/>.
                /// </summary>
                public static ReadOnlySpan<byte> TileId => [0x85, 0x00, 0x00, 0x00, 0x22, 0x74, 0x69, 0x6C, 0x65, 0x49, 0x64, 0x22];
            }
        }
    }
}
