        ...
        public readonly partial struct RepresentsConfigurationParametersOfTheFlpEntry
        {
            ...
            public readonly partial struct RepresentsTheConfigurationKeyAndValues
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(RepresentsTheConfigurationKeyAndValues instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="RepresentsTheConfigurationKeyAndValues"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RepresentsTheConfigurationKeyAndValues(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RepresentsTheConfigurationKeyAndValues.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RepresentsTheConfigurationKeyAndValues Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RepresentsTheConfigurationKeyAndValues Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<RepresentsTheConfigurationKeyAndValues>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapFlpNamespace.RepresentsConfigurationParametersOfTheFlpEntry.RepresentsTheConfigurationKeyAndValues.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(RepresentsTheConfigurationKeyAndValues instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapFlpNamespace.RepresentsConfigurationParametersOfTheFlpEntry.RepresentsTheConfigurationKeyAndValues.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                {
                    return workspace.CreateBuilder<RepresentsTheConfigurationKeyAndValues, Mutable>(this);
                }
            }
        }
    }
