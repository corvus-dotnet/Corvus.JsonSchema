    ...
    public readonly partial struct JsonSchemaForSapFlpNamespace
    {
        ...
        public readonly partial struct RepresentsSizeOfTheTile
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RepresentsSizeOfTheTile instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsSizeOfTheTile"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsSizeOfTheTile(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsSizeOfTheTile.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsSizeOfTheTile Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsSizeOfTheTile Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsSizeOfTheTile>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsSizeOfTheTile instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (RepresentsSizeOfTheTile)value;
            ...
            {
                return workspace.CreateBuilder<RepresentsSizeOfTheTile, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RepresentsSizeOfTheTile> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RepresentsSizeOfTheTile>();
                }
                finally
                {
