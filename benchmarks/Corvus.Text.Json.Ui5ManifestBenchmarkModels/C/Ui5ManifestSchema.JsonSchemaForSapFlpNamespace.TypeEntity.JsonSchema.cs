    ...
    public readonly partial struct JsonSchemaForSapFlpNamespace
    {
            ...
            : IJsonElement<TypeEntity>
        {
            ...
            private static class Constants
            {
                ...
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly byte[] Enum2 = "tile"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly TypeEntity EnumJson2 = ParsedJsonDocument<TypeEntity>.StringConstant([.."\"tile\""u8]);
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly byte[] Enum3 = "plugin"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly TypeEntity EnumJson3 = ParsedJsonDocument<TypeEntity>.StringConstant([.."\"plugin\""u8]);
            }
            ...
            public static class EnumValues
            {
                ...
                /// <summary>
                /// Gets the string "tile"
                /// as a <see cref="TypeEntity"/>.
                /// </summary>
                public static TypeEntity Tile { get; } = Constants.EnumJson2;
                /// <summary>
                /// Gets the string "tile"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> TileUtf8 => Constants.Enum2;

                /// <summary>
                /// Gets the string "plugin"
                /// as a <see cref="TypeEntity"/>.
                /// </summary>
                public static TypeEntity Plugin { get; } = Constants.EnumJson3;
                /// <summary>
                /// Gets the string "plugin"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> PluginUtf8 => Constants.Enum3;
            }
            ...
            public enum KnownValues
            {
                ...
                Application = 0,
                /// <summary>
                /// Corresponds to the JSON string "tile".
                /// </summary>
                Tile = 1,
                /// <summary>
                /// Corresponds to the JSON string "plugin".
                /// </summary>
                Plugin = 2,
            }
            ...
            public static implicit operator TypeEntity(KnownValues value)
            {
                return value switch
                {
                    ...
                    KnownValues.Tile => Constants.EnumJson2,
                    KnownValues.Plugin => Constants.EnumJson3,
            ...
            public bool TryGetKnownValue(out KnownValues result)
            {
                ...
                {
                    result = KnownValues.Tile;
                    return true;
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    result = KnownValues.Plugin;
                    return true;
                }
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/properties/sap.flp/properties/type"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated, as a JSON Pointer within <see cref="SchemaDocument"/>.
                /// </summary>
                public const string SchemaLocation = "/properties/sap.flp/properties/type";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/properties/sap.flp/properties/type"u8;
                ...
                private static readonly global::Corvus.Text.Json.RuntimeEvaluator.JsonSchemaEvaluator Evaluator = global::Corvus.Ui5ManifestBenchmark.Current.CorvusJsonSchemaProgram.Entry(702);
