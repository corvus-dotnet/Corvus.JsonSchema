...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapGuiNamespace
    {
        ...
        public readonly partial struct RepresentsSapScreenPersonasFlavorId
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RepresentsSapScreenPersonasFlavorId instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsSapScreenPersonasFlavorId"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsSapScreenPersonasFlavorId(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new RepresentsSapScreenPersonasFlavorId(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsSapScreenPersonasFlavorId.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="RepresentsSapScreenPersonasFlavorId"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="RepresentsSapScreenPersonasFlavorId"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsSapScreenPersonasFlavorId Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<RepresentsSapScreenPersonasFlavorId>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="RepresentsSapScreenPersonasFlavorId"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsSapScreenPersonasFlavorId Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsSapScreenPersonasFlavorId>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsSapScreenPersonasFlavorId instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RepresentsSapScreenPersonasFlavorId, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RepresentsSapScreenPersonasFlavorId> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RepresentsSapScreenPersonasFlavorId>();
                }
                finally
                {
