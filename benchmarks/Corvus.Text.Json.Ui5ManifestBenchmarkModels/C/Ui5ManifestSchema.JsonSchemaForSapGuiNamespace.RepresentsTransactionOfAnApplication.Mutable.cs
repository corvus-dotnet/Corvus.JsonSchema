    ...
    public readonly partial struct JsonSchemaForSapGuiNamespace
    {
        ...
        public readonly partial struct RepresentsTransactionOfAnApplication
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RepresentsTransactionOfAnApplication instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsTransactionOfAnApplication"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsTransactionOfAnApplication(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsTransactionOfAnApplication.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTransactionOfAnApplication Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTransactionOfAnApplication Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsTransactionOfAnApplication>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsTransactionOfAnApplication instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RepresentsTransactionOfAnApplication, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RepresentsTransactionOfAnApplication> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RepresentsTransactionOfAnApplication>();
                }
                finally
                {
