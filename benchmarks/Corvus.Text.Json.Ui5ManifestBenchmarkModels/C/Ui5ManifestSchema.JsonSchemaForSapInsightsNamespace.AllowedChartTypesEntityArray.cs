...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapInsightsNamespace
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="AllowedChartTypesEntityArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal AllowedChartTypesEntityArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static AllowedChartTypesEntityArray DefaultInstance { get; }
            ...
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapInsightsNamespace.AllowedChartTypesEntityArray.AllowedChartTypesEntity this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapInsightsNamespace.AllowedChartTypesEntityArray.AllowedChartTypesEntity>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapInsightsNamespace.AllowedChartTypesEntityArray.AllowedChartTypesEntity> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapInsightsNamespace.AllowedChartTypesEntityArray.AllowedChartTypesEntity>(_parent, _idx);
            }
            ...
            /// </returns>
            public static bool operator ==(in AllowedChartTypesEntityArray left, in AllowedChartTypesEntityArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in AllowedChartTypesEntityArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(AllowedChartTypesEntityArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AllowedChartTypesEntityArray(JsonElement instance)
            {
                return AllowedChartTypesEntityArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AllowedChartTypesEntityArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AllowedChartTypesEntityArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AllowedChartTypesEntityArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AllowedChartTypesEntityArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AllowedChartTypesEntityArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static AllowedChartTypesEntityArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<AllowedChartTypesEntityArray>(json, options);
            }
            ...
            /// </exception>
            public static AllowedChartTypesEntityArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<AllowedChartTypesEntityArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out AllowedChartTypesEntityArray? result)
            {
                return JsonElementHelpers.TryParseValue<AllowedChartTypesEntityArray>(ref reader, out result);
            }
...
#if NET
            static AllowedChartTypesEntityArray IJsonElement<AllowedChartTypesEntityArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AllowedChartTypesEntityArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public AllowedChartTypesEntityArray Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public AllowedChartTypesEntityArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<AllowedChartTypesEntityArray>(_idx);
                }
