...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapInsightsNamespace
    {
        ...
        public readonly partial struct RepresentsTheDeletedStateForAUser
#if NET8_0_OR_GREATER
            : IJsonElement<RepresentsTheDeletedStateForAUser>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RepresentsTheDeletedStateForAUser"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RepresentsTheDeletedStateForAUser(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RepresentsTheDeletedStateForAUser DefaultInstance { get; } = ParsedJsonDocument<RepresentsTheDeletedStateForAUser>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(RepresentsTheDeletedStateForAUser value)
            {
            ...
            /// </returns>
            public static bool operator ==(in RepresentsTheDeletedStateForAUser left, in RepresentsTheDeletedStateForAUser right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RepresentsTheDeletedStateForAUser left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(RepresentsTheDeletedStateForAUser instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RepresentsTheDeletedStateForAUser(JsonElement instance)
            {
                return RepresentsTheDeletedStateForAUser.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheDeletedStateForAUser From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheDeletedStateForAUser ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheDeletedStateForAUser>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheDeletedStateForAUser ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheDeletedStateForAUser>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheDeletedStateForAUser ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheDeletedStateForAUser>(json, options);
            }
            ...
            /// </exception>
            public static RepresentsTheDeletedStateForAUser ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheDeletedStateForAUser>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsTheDeletedStateForAUser? result)
            {
                return JsonElementHelpers.TryParseValue<RepresentsTheDeletedStateForAUser>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RepresentsTheDeletedStateForAUser(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static RepresentsTheDeletedStateForAUser IJsonElement<RepresentsTheDeletedStateForAUser>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RepresentsTheDeletedStateForAUser: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RepresentsTheDeletedStateForAUser"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RepresentsTheDeletedStateForAUser"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public RepresentsTheDeletedStateForAUser Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RepresentsTheDeletedStateForAUser>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RepresentsTheDeletedStateForAUser"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public RepresentsTheDeletedStateForAUser Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RepresentsTheDeletedStateForAUser>(_idx);
                }
