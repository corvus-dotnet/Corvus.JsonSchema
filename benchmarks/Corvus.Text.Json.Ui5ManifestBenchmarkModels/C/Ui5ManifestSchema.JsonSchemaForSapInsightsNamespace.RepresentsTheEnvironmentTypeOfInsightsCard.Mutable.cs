...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapInsightsNamespace
    {
        ...
        public readonly partial struct RepresentsTheEnvironmentTypeOfInsightsCard
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RepresentsTheEnvironmentTypeOfInsightsCard instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsTheEnvironmentTypeOfInsightsCard"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsTheEnvironmentTypeOfInsightsCard(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new RepresentsTheEnvironmentTypeOfInsightsCard(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsTheEnvironmentTypeOfInsightsCard.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="RepresentsTheEnvironmentTypeOfInsightsCard"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="RepresentsTheEnvironmentTypeOfInsightsCard"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheEnvironmentTypeOfInsightsCard Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<RepresentsTheEnvironmentTypeOfInsightsCard>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="RepresentsTheEnvironmentTypeOfInsightsCard"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheEnvironmentTypeOfInsightsCard Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsTheEnvironmentTypeOfInsightsCard>(_idx);
                }
                ...
                /// <param name="matchDt">Match 1st item.</param>
                /// <param name="matchRt">Match 2nd item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> matchDt,
                    Func<TContext, TResult> matchRt,
...
#endif
                {
                    ...
                    {
                        return matchDt(context);
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchRt(context);
                    }
                ...
                public TResult Match<TResult>(
                    Func<TResult> matchDt,
                    Func<TResult> matchRt,
                ...
                public bool TryGetKnownValue(out KnownValues result)
                {
                    if (this.ValueEquals(Constants.Enum1))
                    {
                        result = KnownValues.Dt;
                        return true;
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        result = KnownValues.Rt;
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsTheEnvironmentTypeOfInsightsCard instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (RepresentsTheEnvironmentTypeOfInsightsCard)value;
            ...
            {
                return workspace.CreateBuilder<RepresentsTheEnvironmentTypeOfInsightsCard, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RepresentsTheEnvironmentTypeOfInsightsCard> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RepresentsTheEnvironmentTypeOfInsightsCard>();
                }
                finally
                {
