    ...
    public readonly partial struct JsonSchemaForSapInsightsNamespace
    {
        ...
        public readonly partial struct RepresentsTheStateOfOriginalOrCopiedCard
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<RepresentsTheStateOfOriginalOrCopiedCard, Mutable>(RepresentsTheStateOfOriginalOrCopiedCard.DefaultInstance);
                ...
                public static explicit operator Mutable(RepresentsTheStateOfOriginalOrCopiedCard instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsTheStateOfOriginalOrCopiedCard"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsTheStateOfOriginalOrCopiedCard(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsTheStateOfOriginalOrCopiedCard.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheStateOfOriginalOrCopiedCard Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheStateOfOriginalOrCopiedCard Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsTheStateOfOriginalOrCopiedCard>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsTheStateOfOriginalOrCopiedCard instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RepresentsTheStateOfOriginalOrCopiedCard, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RepresentsTheStateOfOriginalOrCopiedCard> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RepresentsTheStateOfOriginalOrCopiedCard>();
                }
                finally
                {
