...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapInsightsNamespace
    {
        ...
        public readonly partial struct RepresentsTheTemplateNameFromWhereManifestIsGenerated
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RepresentsTheTemplateNameFromWhereManifestIsGenerated instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsTheTemplateNameFromWhereManifestIsGenerated"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsTheTemplateNameFromWhereManifestIsGenerated(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new RepresentsTheTemplateNameFromWhereManifestIsGenerated(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsTheTemplateNameFromWhereManifestIsGenerated.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="RepresentsTheTemplateNameFromWhereManifestIsGenerated"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="RepresentsTheTemplateNameFromWhereManifestIsGenerated"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheTemplateNameFromWhereManifestIsGenerated Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<RepresentsTheTemplateNameFromWhereManifestIsGenerated>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="RepresentsTheTemplateNameFromWhereManifestIsGenerated"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheTemplateNameFromWhereManifestIsGenerated Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsTheTemplateNameFromWhereManifestIsGenerated>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsTheTemplateNameFromWhereManifestIsGenerated instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RepresentsTheTemplateNameFromWhereManifestIsGenerated, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RepresentsTheTemplateNameFromWhereManifestIsGenerated> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RepresentsTheTemplateNameFromWhereManifestIsGenerated>();
                }
                finally
                {
