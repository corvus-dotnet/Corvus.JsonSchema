...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapInsightsNamespace
    {
        ...
        public readonly partial struct RepresentsTheTemplateNameFromWhereManifestIsGenerated
            ...
            : IJsonElement<RepresentsTheTemplateNameFromWhereManifestIsGenerated>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RepresentsTheTemplateNameFromWhereManifestIsGenerated"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RepresentsTheTemplateNameFromWhereManifestIsGenerated(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RepresentsTheTemplateNameFromWhereManifestIsGenerated DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(RepresentsTheTemplateNameFromWhereManifestIsGenerated value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in RepresentsTheTemplateNameFromWhereManifestIsGenerated left, in RepresentsTheTemplateNameFromWhereManifestIsGenerated right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RepresentsTheTemplateNameFromWhereManifestIsGenerated left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(RepresentsTheTemplateNameFromWhereManifestIsGenerated instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RepresentsTheTemplateNameFromWhereManifestIsGenerated(JsonElement instance)
            {
                return RepresentsTheTemplateNameFromWhereManifestIsGenerated.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheTemplateNameFromWhereManifestIsGenerated From<T>(in T instance)
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheTemplateNameFromWhereManifestIsGenerated ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<RepresentsTheTemplateNameFromWhereManifestIsGenerated>(utf8Json, options);
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheTemplateNameFromWhereManifestIsGenerated ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<RepresentsTheTemplateNameFromWhereManifestIsGenerated>(json, options);
                #pragma warning restore CS0618
            }
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheTemplateNameFromWhereManifestIsGenerated ParseValue(string json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<RepresentsTheTemplateNameFromWhereManifestIsGenerated>(json, options);
                #pragma warning restore CS0618
            ...
            /// </exception>
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            public static RepresentsTheTemplateNameFromWhereManifestIsGenerated ParseValue(ref Utf8JsonReader reader)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<RepresentsTheTemplateNameFromWhereManifestIsGenerated>(ref reader);
                #pragma warning restore CS0618
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsTheTemplateNameFromWhereManifestIsGenerated? result)
            {
                return JsonElementHelpers.TryParseValue<RepresentsTheTemplateNameFromWhereManifestIsGenerated>(ref reader, out result);
            }
...
#if NET
            static RepresentsTheTemplateNameFromWhereManifestIsGenerated IJsonElement<RepresentsTheTemplateNameFromWhereManifestIsGenerated>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RepresentsTheTemplateNameFromWhereManifestIsGenerated: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public RepresentsTheTemplateNameFromWhereManifestIsGenerated Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public RepresentsTheTemplateNameFromWhereManifestIsGenerated Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RepresentsTheTemplateNameFromWhereManifestIsGenerated>(_idx);
                }
