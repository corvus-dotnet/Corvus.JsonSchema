    ...
    public readonly partial struct JsonSchemaForSapInsightsNamespace
    {
        ...
        public readonly partial struct RepresentsTheVisibilityTypeOfInsightsCard
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<RepresentsTheVisibilityTypeOfInsightsCard, Mutable>(RepresentsTheVisibilityTypeOfInsightsCard.DefaultInstance);
                ...
                public static explicit operator Mutable(RepresentsTheVisibilityTypeOfInsightsCard instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsTheVisibilityTypeOfInsightsCard"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsTheVisibilityTypeOfInsightsCard(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsTheVisibilityTypeOfInsightsCard.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheVisibilityTypeOfInsightsCard Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheVisibilityTypeOfInsightsCard Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsTheVisibilityTypeOfInsightsCard>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsTheVisibilityTypeOfInsightsCard instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RepresentsTheVisibilityTypeOfInsightsCard, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RepresentsTheVisibilityTypeOfInsightsCard> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RepresentsTheVisibilityTypeOfInsightsCard>();
                }
                finally
                {
