...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapInsightsNamespace
    {
        ...
        public readonly partial struct RepresentsTheVisibilityTypeOfInsightsCard
#if NET8_0_OR_GREATER
            : IJsonElement<RepresentsTheVisibilityTypeOfInsightsCard>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RepresentsTheVisibilityTypeOfInsightsCard"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RepresentsTheVisibilityTypeOfInsightsCard(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RepresentsTheVisibilityTypeOfInsightsCard DefaultInstance { get; } = ParsedJsonDocument<RepresentsTheVisibilityTypeOfInsightsCard>.True;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(RepresentsTheVisibilityTypeOfInsightsCard value)
            {
            ...
            /// </returns>
            public static bool operator ==(in RepresentsTheVisibilityTypeOfInsightsCard left, in RepresentsTheVisibilityTypeOfInsightsCard right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RepresentsTheVisibilityTypeOfInsightsCard left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(RepresentsTheVisibilityTypeOfInsightsCard instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RepresentsTheVisibilityTypeOfInsightsCard(JsonElement instance)
            {
                return RepresentsTheVisibilityTypeOfInsightsCard.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheVisibilityTypeOfInsightsCard From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheVisibilityTypeOfInsightsCard ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheVisibilityTypeOfInsightsCard>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheVisibilityTypeOfInsightsCard ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheVisibilityTypeOfInsightsCard>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheVisibilityTypeOfInsightsCard ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheVisibilityTypeOfInsightsCard>(json, options);
            }
            ...
            /// </exception>
            public static RepresentsTheVisibilityTypeOfInsightsCard ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheVisibilityTypeOfInsightsCard>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsTheVisibilityTypeOfInsightsCard? result)
            {
                return JsonElementHelpers.TryParseValue<RepresentsTheVisibilityTypeOfInsightsCard>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RepresentsTheVisibilityTypeOfInsightsCard(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static RepresentsTheVisibilityTypeOfInsightsCard IJsonElement<RepresentsTheVisibilityTypeOfInsightsCard>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RepresentsTheVisibilityTypeOfInsightsCard: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RepresentsTheVisibilityTypeOfInsightsCard"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RepresentsTheVisibilityTypeOfInsightsCard"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public RepresentsTheVisibilityTypeOfInsightsCard Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RepresentsTheVisibilityTypeOfInsightsCard>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RepresentsTheVisibilityTypeOfInsightsCard"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public RepresentsTheVisibilityTypeOfInsightsCard Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RepresentsTheVisibilityTypeOfInsightsCard>(_idx);
                }
