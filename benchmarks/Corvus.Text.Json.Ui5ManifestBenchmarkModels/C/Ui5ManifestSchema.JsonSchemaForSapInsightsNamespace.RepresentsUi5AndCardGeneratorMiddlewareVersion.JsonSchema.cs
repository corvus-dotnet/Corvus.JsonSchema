    ...
    public readonly partial struct JsonSchemaForSapInsightsNamespace
    {
            ...
            : IJsonElement<RepresentsUi5AndCardGeneratorMiddlewareVersion>
        {
            public static partial class JsonSchema
            {
                ...
                private static void MatchDtMiddleware(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                {
                ...
                private static void MatchUi5(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
