    ...
    public readonly partial struct JsonSchemaForSapInsightsNamespace
    {
        ...
        public readonly partial struct RepresentsUi5AndCardGeneratorMiddlewareVersion
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RepresentsUi5AndCardGeneratorMiddlewareVersion instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsUi5AndCardGeneratorMiddlewareVersion"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsUi5AndCardGeneratorMiddlewareVersion(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable DtMiddleware
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DtMiddlewareUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable Ui5
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.Ui5Utf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                /// <summary>
                /// Set the <c>dtMiddleware</c> property.
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetDtMiddleware(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source value)
                {
                    CheckValidInstance();

                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.DtMiddlewareUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DtMiddlewareUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                    ...
                    else
                    {
                        ...
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.DtMiddleware, ref cvb);
                ...
                /// <summary>
                /// Remove the <c>dtMiddleware</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveDtMiddleware()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.DtMiddlewareUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }

                /// <summary>
                /// Set the <c>ui5</c> property.
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetUi5(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source value)
                {
                    CheckValidInstance();

                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.Ui5Utf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.Ui5Utf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Ui5, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                /// <summary>
                /// Remove the <c>ui5</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveUi5()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.Ui5Utf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsUi5AndCardGeneratorMiddlewareVersion.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsUi5AndCardGeneratorMiddlewareVersion Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsUi5AndCardGeneratorMiddlewareVersion Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsUi5AndCardGeneratorMiddlewareVersion>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapInsightsNamespace.RepresentsUi5AndCardGeneratorMiddlewareVersion.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                public static implicit operator Source(RepresentsUi5AndCardGeneratorMiddlewareVersion instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapInsightsNamespace.RepresentsUi5AndCardGeneratorMiddlewareVersion.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="RepresentsUi5AndCardGeneratorMiddlewareVersion"/>.
                /// </summary>
                internal static void Create(
                    ref ComplexValueBuilder builder,
                    in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source dtMiddleware = default,
                    in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source ui5 = default)
                {
                    dtMiddleware.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.DtMiddleware, ref builder);
                    ui5.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Ui5, ref builder);
                }

                /// <summary>
                /// Creates an instance of a <see cref="RepresentsUi5AndCardGeneratorMiddlewareVersion"/>.
                /// </summary>
                public void Create(in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source dtMiddleware = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source ui5 = default)
                {
                    Create(ref _builder, dtMiddleware, ui5);
                }
            ...
            /// </summary>
            /// <param name="dtMiddleware">The value of the <c>"dtMiddleware"</c> property.</param>
            /// <param name="ui5">The value of the <c>"ui5"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source dtMiddleware = default, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source ui5 = default)
            {
                return new Source(dtMiddleware, ui5);
            }
            ...
            /// </summary>
            /// <param name="workspace">The JSON workspace.</param>
            /// <param name="dtMiddleware">The value of the property.</param>
            /// <param name="ui5">The value of the property.</param>
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source dtMiddleware = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source ui5 = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(dtMiddleware, ui5);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<RepresentsUi5AndCardGeneratorMiddlewareVersion, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RepresentsUi5AndCardGeneratorMiddlewareVersion> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RepresentsUi5AndCardGeneratorMiddlewareVersion>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RepresentsUi5AndCardGeneratorMiddlewareVersion> Create<TContext>(
            ...
            public static ParsedJsonDocument<RepresentsUi5AndCardGeneratorMiddlewareVersion> Create(in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source dtMiddleware = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source ui5 = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
