    ...
    public readonly partial struct JsonSchemaForSapInsightsNamespace
    {
        ...
        public readonly partial struct RepresentsUi5AndCardGeneratorMiddlewareVersion
        {
...
#endif
            {
                ...
                public void SetDtMiddleware(in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source value)
                {
                    ...
                    else
                    {
                        ...
                        value.AddAsProperty(JsonPropertyNamesEscaped.DtMiddleware, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                ...
                public void SetUi5(in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source value)
                {
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsProperty(JsonPropertyNamesEscaped.Ui5, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
            ...
            public ref struct Builder
            {
                ...
                {
                    dtMiddleware.AddAsProperty(JsonPropertyNamesEscaped.DtMiddleware, ref builder, escapeName: false);
                    ui5.AddAsProperty(JsonPropertyNamesEscaped.Ui5, ref builder, escapeName: false);
                }
