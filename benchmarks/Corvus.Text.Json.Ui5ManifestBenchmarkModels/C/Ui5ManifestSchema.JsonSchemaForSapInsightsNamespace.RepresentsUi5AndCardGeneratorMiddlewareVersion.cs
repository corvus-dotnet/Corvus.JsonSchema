...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapInsightsNamespace
    {
        ...
        public readonly partial struct RepresentsUi5AndCardGeneratorMiddlewareVersion
#if NET8_0_OR_GREATER
            : IJsonElement<RepresentsUi5AndCardGeneratorMiddlewareVersion>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RepresentsUi5AndCardGeneratorMiddlewareVersion"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RepresentsUi5AndCardGeneratorMiddlewareVersion(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RepresentsUi5AndCardGeneratorMiddlewareVersion DefaultInstance { get; }
            ...
            /// <summary>
            /// Gets the (optional) <c>dtMiddleware</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.JsonString DtMiddleware
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DtMiddlewareUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString value))
                    {
                        return value;
                    }
            ...
            /// <summary>
            /// Gets the (optional) <c>ui5</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.JsonString Ui5
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.Ui5Utf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in RepresentsUi5AndCardGeneratorMiddlewareVersion left, in RepresentsUi5AndCardGeneratorMiddlewareVersion right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RepresentsUi5AndCardGeneratorMiddlewareVersion left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(RepresentsUi5AndCardGeneratorMiddlewareVersion instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RepresentsUi5AndCardGeneratorMiddlewareVersion(JsonElement instance)
            {
                return RepresentsUi5AndCardGeneratorMiddlewareVersion.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsUi5AndCardGeneratorMiddlewareVersion From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsUi5AndCardGeneratorMiddlewareVersion ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsUi5AndCardGeneratorMiddlewareVersion>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsUi5AndCardGeneratorMiddlewareVersion ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsUi5AndCardGeneratorMiddlewareVersion>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsUi5AndCardGeneratorMiddlewareVersion ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsUi5AndCardGeneratorMiddlewareVersion>(json, options);
            }
            ...
            /// </exception>
            public static RepresentsUi5AndCardGeneratorMiddlewareVersion ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RepresentsUi5AndCardGeneratorMiddlewareVersion>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsUi5AndCardGeneratorMiddlewareVersion? result)
            {
                return JsonElementHelpers.TryParseValue<RepresentsUi5AndCardGeneratorMiddlewareVersion>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RepresentsUi5AndCardGeneratorMiddlewareVersion(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static RepresentsUi5AndCardGeneratorMiddlewareVersion IJsonElement<RepresentsUi5AndCardGeneratorMiddlewareVersion>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RepresentsUi5AndCardGeneratorMiddlewareVersion: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RepresentsUi5AndCardGeneratorMiddlewareVersion"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RepresentsUi5AndCardGeneratorMiddlewareVersion"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public RepresentsUi5AndCardGeneratorMiddlewareVersion Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RepresentsUi5AndCardGeneratorMiddlewareVersion>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RepresentsUi5AndCardGeneratorMiddlewareVersion"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public RepresentsUi5AndCardGeneratorMiddlewareVersion Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RepresentsUi5AndCardGeneratorMiddlewareVersion>(_idx);
                }
            ...
            {
                /// <summary>
                /// Gets the JSON property name for <see cref="DtMiddleware"/>.
                /// </summary>
                public const string DtMiddleware = "dtMiddleware";

                /// <summary>
                /// Gets the JSON property name for <see cref="Ui5"/>.
                /// </summary>
                public const string Ui5 = "ui5";

                /// <summary>
                /// Gets the JSON property name for <see cref="DtMiddleware"/>.
                /// </summary>
                public static ReadOnlySpan<byte> DtMiddlewareUtf8 => "dtMiddleware"u8;

                /// <summary>
                /// Gets the JSON property name for <see cref="Ui5"/>.
                /// </summary>
                public static ReadOnlySpan<byte> Ui5Utf8 => "ui5"u8;
            }
            ...
            {
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="DtMiddleware"/>.
                /// </summary>
                public static ReadOnlySpan<byte> DtMiddleware => "dtMiddleware"u8;

                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="Ui5"/>.
                /// </summary>
