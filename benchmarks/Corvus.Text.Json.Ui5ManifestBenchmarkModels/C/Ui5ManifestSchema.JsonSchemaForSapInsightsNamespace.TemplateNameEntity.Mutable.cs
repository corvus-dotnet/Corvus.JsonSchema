    ...
    public readonly partial struct JsonSchemaForSapInsightsNamespace
    {
        ...
        public readonly partial struct TemplateNameEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(TemplateNameEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TemplateNameEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TemplateNameEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TemplateNameEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly TemplateNameEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly TemplateNameEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TemplateNameEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(TemplateNameEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<TemplateNameEntity, Mutable>(this);
            }
        }
    }
}
