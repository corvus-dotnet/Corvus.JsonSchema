    ...
    public readonly partial struct JsonSchemaForSapIntegrationNamespace
    {
...
#endif
        {
            ...
            public void SetUrlTemplateId(in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source value)
            {
                ...
                {
                    // We are going to insert the new value
                    value.AddAsProperty(JsonPropertyNamesEscaped.UrlTemplateId, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
        ...
        public ref struct Builder
        {
                ...
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapIntegrationNamespace.VersionEntity.Source version = default)
            {
                ...
                urlTemplateId.AddAsProperty(JsonPropertyNamesEscaped.UrlTemplateId, ref builder, escapeName: false);
