...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapMobileNamespace
        ...
        : IJsonElement<JsonSchemaForSapMobileNamespace>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="JsonSchemaForSapMobileNamespace"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal JsonSchemaForSapMobileNamespace(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static JsonSchemaForSapMobileNamespace DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapMobileNamespace.VersionEntity Version
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapMobileNamespace.VersionEntity value))
                {
                    return value;
                }
        ...
        /// <summary>
        /// Gets the <c>definingRequests</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapMobileNamespace.RepresentsMobileSpecificAttributes DefiningRequests
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DefiningRequestsUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapMobileNamespace.RepresentsMobileSpecificAttributes value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in JsonSchemaForSapMobileNamespace left, in JsonSchemaForSapMobileNamespace right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in JsonSchemaForSapMobileNamespace left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(JsonSchemaForSapMobileNamespace instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonSchemaForSapMobileNamespace(JsonElement instance)
        {
            return JsonSchemaForSapMobileNamespace.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static JsonSchemaForSapMobileNamespace From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static JsonSchemaForSapMobileNamespace ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<JsonSchemaForSapMobileNamespace>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static JsonSchemaForSapMobileNamespace ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<JsonSchemaForSapMobileNamespace>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static JsonSchemaForSapMobileNamespace ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<JsonSchemaForSapMobileNamespace>(json, options);
        }
        ...
        /// </exception>
        public static JsonSchemaForSapMobileNamespace ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<JsonSchemaForSapMobileNamespace>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out JsonSchemaForSapMobileNamespace? result)
        {
            return JsonElementHelpers.TryParseValue<JsonSchemaForSapMobileNamespace>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new JsonSchemaForSapMobileNamespace(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static JsonSchemaForSapMobileNamespace IJsonElement<JsonSchemaForSapMobileNamespace>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"JsonSchemaForSapMobileNamespace: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="JsonSchemaForSapMobileNamespace"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="JsonSchemaForSapMobileNamespace"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public JsonSchemaForSapMobileNamespace Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<JsonSchemaForSapMobileNamespace>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="JsonSchemaForSapMobileNamespace"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public JsonSchemaForSapMobileNamespace Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<JsonSchemaForSapMobileNamespace>(_idx);
            }
        ...
        public static class JsonPropertyNames
        {
            ...
            /// <summary>
            /// Gets the JSON property name for <see cref="DefiningRequests"/>.
            /// </summary>
            public const string DefiningRequests = "definingRequests";
            ...
            /// Gets the JSON property name for <see cref="DefiningRequests"/>.
            /// </summary>
            public static ReadOnlySpan<byte> DefiningRequestsUtf8 => "definingRequests"u8;
        }
        ...
        private static class JsonPropertyNamesEscaped
        {
            ...
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="DefiningRequests"/>.
            /// </summary>
            public static ReadOnlySpan<byte> DefiningRequests => "definingRequests"u8;
        }
        ...
        private static class JsonPropertyNamesPrebaked
        {
            ...
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="DefiningRequests"/>.
            /// </summary>
            public static ReadOnlySpan<byte> DefiningRequests => [0x25, 0x01, 0x00, 0x00, 0x22, 0x64, 0x65, 0x66, 0x69, 0x6E, 0x69, 0x6E, 0x67, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x73, 0x22];
        }
    }
}
