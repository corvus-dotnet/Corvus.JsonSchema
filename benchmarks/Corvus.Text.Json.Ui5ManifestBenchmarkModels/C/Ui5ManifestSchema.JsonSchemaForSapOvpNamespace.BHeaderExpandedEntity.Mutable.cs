    ...
    public readonly partial struct JsonSchemaForSapOvpNamespace
    {
        ...
        public readonly partial struct BHeaderExpandedEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<BHeaderExpandedEntity, Mutable>(BHeaderExpandedEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(BHeaderExpandedEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="BHeaderExpandedEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator BHeaderExpandedEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"BHeaderExpandedEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly BHeaderExpandedEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly BHeaderExpandedEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<BHeaderExpandedEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(BHeaderExpandedEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<BHeaderExpandedEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<BHeaderExpandedEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<BHeaderExpandedEntity>();
                }
                finally
                {
