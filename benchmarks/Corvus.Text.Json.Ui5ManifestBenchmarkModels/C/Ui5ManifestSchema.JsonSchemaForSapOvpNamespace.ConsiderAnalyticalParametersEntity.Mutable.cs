    ...
    public readonly partial struct JsonSchemaForSapOvpNamespace
    {
        ...
        public readonly partial struct ConsiderAnalyticalParametersEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ConsiderAnalyticalParametersEntity, Mutable>(ConsiderAnalyticalParametersEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(ConsiderAnalyticalParametersEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ConsiderAnalyticalParametersEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ConsiderAnalyticalParametersEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ConsiderAnalyticalParametersEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ConsiderAnalyticalParametersEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ConsiderAnalyticalParametersEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ConsiderAnalyticalParametersEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ConsiderAnalyticalParametersEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ConsiderAnalyticalParametersEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ConsiderAnalyticalParametersEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ConsiderAnalyticalParametersEntity>();
                }
                finally
                {
