...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapOvpNamespace
    {
        ...
        public readonly partial struct ConsiderAnalyticalParametersEntity
#if NET8_0_OR_GREATER
            : IJsonElement<ConsiderAnalyticalParametersEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ConsiderAnalyticalParametersEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ConsiderAnalyticalParametersEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ConsiderAnalyticalParametersEntity DefaultInstance { get; } = ParsedJsonDocument<ConsiderAnalyticalParametersEntity>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(ConsiderAnalyticalParametersEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in ConsiderAnalyticalParametersEntity left, in ConsiderAnalyticalParametersEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ConsiderAnalyticalParametersEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ConsiderAnalyticalParametersEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ConsiderAnalyticalParametersEntity(JsonElement instance)
            {
                return ConsiderAnalyticalParametersEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ConsiderAnalyticalParametersEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ConsiderAnalyticalParametersEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ConsiderAnalyticalParametersEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ConsiderAnalyticalParametersEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ConsiderAnalyticalParametersEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ConsiderAnalyticalParametersEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ConsiderAnalyticalParametersEntity>(json, options);
            }
            ...
            /// </exception>
            public static ConsiderAnalyticalParametersEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ConsiderAnalyticalParametersEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ConsiderAnalyticalParametersEntity? result)
            {
                return JsonElementHelpers.TryParseValue<ConsiderAnalyticalParametersEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ConsiderAnalyticalParametersEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static ConsiderAnalyticalParametersEntity IJsonElement<ConsiderAnalyticalParametersEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ConsiderAnalyticalParametersEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ConsiderAnalyticalParametersEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ConsiderAnalyticalParametersEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public ConsiderAnalyticalParametersEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ConsiderAnalyticalParametersEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ConsiderAnalyticalParametersEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public ConsiderAnalyticalParametersEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ConsiderAnalyticalParametersEntity>(_idx);
                }
