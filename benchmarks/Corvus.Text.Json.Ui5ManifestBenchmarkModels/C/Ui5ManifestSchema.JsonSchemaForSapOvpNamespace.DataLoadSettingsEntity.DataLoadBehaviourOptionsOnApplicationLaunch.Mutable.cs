        ...
        public readonly partial struct DataLoadSettingsEntity
        {
            ...
            public readonly partial struct DataLoadBehaviourOptionsOnApplicationLaunch
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DataLoadBehaviourOptionsOnApplicationLaunch, Mutable>(DataLoadBehaviourOptionsOnApplicationLaunch.DefaultInstance);
                    ...
                    public static explicit operator Mutable(DataLoadBehaviourOptionsOnApplicationLaunch instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="DataLoadBehaviourOptionsOnApplicationLaunch"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator DataLoadBehaviourOptionsOnApplicationLaunch(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new DataLoadBehaviourOptionsOnApplicationLaunch(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"DataLoadBehaviourOptionsOnApplicationLaunch.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="DataLoadBehaviourOptionsOnApplicationLaunch"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="DataLoadBehaviourOptionsOnApplicationLaunch"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DataLoadBehaviourOptionsOnApplicationLaunch Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<DataLoadBehaviourOptionsOnApplicationLaunch>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="DataLoadBehaviourOptionsOnApplicationLaunch"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DataLoadBehaviourOptionsOnApplicationLaunch Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<DataLoadBehaviourOptionsOnApplicationLaunch>(_idx);
                    }
                    ...
                    /// <param name="matchAlways">Match 1st item.</param>
                    /// <param name="matchNever">Match 2nd item.</param>
                    /// <param name="matchIfAnyFilterExist">Match 3rd item.</param>
                    ...
                    public TResult Match<TContext, TResult>(
                        ...
                        Func<TContext, TResult> matchIfAnyFilterExist,
...
#endif
                    {
                        ...
                        {
                            return matchIfAnyFilterExist(context);
                        }
                    ...
                    public TResult Match<TResult>(
                        ...
                        Func<TResult> matchIfAnyFilterExist,
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(DataLoadBehaviourOptionsOnApplicationLaunch instance) => new(JsonElement.From(instance));
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Source(KnownValues value) => (DataLoadBehaviourOptionsOnApplicationLaunch)value;
                ...
                {
                    return workspace.CreateBuilder<DataLoadBehaviourOptionsOnApplicationLaunch, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<DataLoadBehaviourOptionsOnApplicationLaunch> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<DataLoadBehaviourOptionsOnApplicationLaunch>();
                    }
                    finally
                    {
