...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapOvpNamespace
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="DataLoadSettingsEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal DataLoadSettingsEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static DataLoadSettingsEntity DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapOvpNamespace.DataLoadSettingsEntity.DataLoadBehaviourOptionsOnApplicationLaunch LoadDataOnAppLaunch
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LoadDataOnAppLaunchUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapOvpNamespace.DataLoadSettingsEntity.DataLoadBehaviourOptionsOnApplicationLaunch value))
                    {
                        return value;
                    }

                    return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapOvpNamespace.DataLoadSettingsEntity.DataLoadBehaviourOptionsOnApplicationLaunch.DefaultInstance;
                }
            }
            ...
            /// </returns>
            public static bool operator ==(in DataLoadSettingsEntity left, in DataLoadSettingsEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in DataLoadSettingsEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(DataLoadSettingsEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DataLoadSettingsEntity(JsonElement instance)
            {
                return DataLoadSettingsEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DataLoadSettingsEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DataLoadSettingsEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DataLoadSettingsEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DataLoadSettingsEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DataLoadSettingsEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DataLoadSettingsEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DataLoadSettingsEntity>(json, options);
            }
            ...
            /// </exception>
            public static DataLoadSettingsEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<DataLoadSettingsEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out DataLoadSettingsEntity? result)
            {
                return JsonElementHelpers.TryParseValue<DataLoadSettingsEntity>(ref reader, out result);
            }
...
#if NET
            static DataLoadSettingsEntity IJsonElement<DataLoadSettingsEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DataLoadSettingsEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public DataLoadSettingsEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public DataLoadSettingsEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<DataLoadSettingsEntity>(_idx);
                }
            ...
            {
                /// <summary>
                /// Gets the JSON property name for <see cref="LoadDataOnAppLaunch"/>.
                /// </summary>
                public const string LoadDataOnAppLaunch = "loadDataOnAppLaunch";

                /// <summary>
                /// Gets the JSON property name for <see cref="LoadDataOnAppLaunch"/>.
                /// </summary>
                public static ReadOnlySpan<byte> LoadDataOnAppLaunchUtf8 => "loadDataOnAppLaunch"u8;
            }
            ...
            {
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="LoadDataOnAppLaunch"/>.
                /// </summary>
