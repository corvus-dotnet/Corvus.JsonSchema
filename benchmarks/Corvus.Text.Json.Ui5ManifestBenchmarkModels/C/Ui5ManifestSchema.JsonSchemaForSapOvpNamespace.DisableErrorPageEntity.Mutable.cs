    ...
    public readonly partial struct JsonSchemaForSapOvpNamespace
    {
        ...
        public readonly partial struct DisableErrorPageEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DisableErrorPageEntity, Mutable>(DisableErrorPageEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(DisableErrorPageEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DisableErrorPageEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DisableErrorPageEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DisableErrorPageEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly DisableErrorPageEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly DisableErrorPageEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DisableErrorPageEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(DisableErrorPageEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<DisableErrorPageEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<DisableErrorPageEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<DisableErrorPageEntity>();
                }
                finally
                {
