    ...
    public readonly partial struct JsonSchemaForSapOvpNamespace
    {
        ...
        public readonly partial struct DisableTableCardFlexibilityEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DisableTableCardFlexibilityEntity, Mutable>(DisableTableCardFlexibilityEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(DisableTableCardFlexibilityEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DisableTableCardFlexibilityEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DisableTableCardFlexibilityEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DisableTableCardFlexibilityEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly DisableTableCardFlexibilityEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly DisableTableCardFlexibilityEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DisableTableCardFlexibilityEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(DisableTableCardFlexibilityEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<DisableTableCardFlexibilityEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<DisableTableCardFlexibilityEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<DisableTableCardFlexibilityEntity>();
                }
                finally
                {
