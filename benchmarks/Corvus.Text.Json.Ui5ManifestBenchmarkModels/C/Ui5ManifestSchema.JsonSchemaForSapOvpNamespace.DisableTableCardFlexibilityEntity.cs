...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapOvpNamespace
    {
        ...
        public readonly partial struct DisableTableCardFlexibilityEntity
#if NET8_0_OR_GREATER
            : IJsonElement<DisableTableCardFlexibilityEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="DisableTableCardFlexibilityEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal DisableTableCardFlexibilityEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static DisableTableCardFlexibilityEntity DefaultInstance { get; } = ParsedJsonDocument<DisableTableCardFlexibilityEntity>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(DisableTableCardFlexibilityEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in DisableTableCardFlexibilityEntity left, in DisableTableCardFlexibilityEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in DisableTableCardFlexibilityEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(DisableTableCardFlexibilityEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DisableTableCardFlexibilityEntity(JsonElement instance)
            {
                return DisableTableCardFlexibilityEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DisableTableCardFlexibilityEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DisableTableCardFlexibilityEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DisableTableCardFlexibilityEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DisableTableCardFlexibilityEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DisableTableCardFlexibilityEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DisableTableCardFlexibilityEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DisableTableCardFlexibilityEntity>(json, options);
            }
            ...
            /// </exception>
            public static DisableTableCardFlexibilityEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<DisableTableCardFlexibilityEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out DisableTableCardFlexibilityEntity? result)
            {
                return JsonElementHelpers.TryParseValue<DisableTableCardFlexibilityEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new DisableTableCardFlexibilityEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static DisableTableCardFlexibilityEntity IJsonElement<DisableTableCardFlexibilityEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DisableTableCardFlexibilityEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="DisableTableCardFlexibilityEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="DisableTableCardFlexibilityEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public DisableTableCardFlexibilityEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<DisableTableCardFlexibilityEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="DisableTableCardFlexibilityEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public DisableTableCardFlexibilityEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<DisableTableCardFlexibilityEntity>(_idx);
                }
