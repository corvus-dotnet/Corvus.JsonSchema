...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapOvpNamespace
    {
        ...
        public readonly partial struct EnableLiveFilterEntity
#if NET8_0_OR_GREATER
            : IJsonElement<EnableLiveFilterEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="EnableLiveFilterEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal EnableLiveFilterEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static EnableLiveFilterEntity DefaultInstance { get; } = ParsedJsonDocument<EnableLiveFilterEntity>.True;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(EnableLiveFilterEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in EnableLiveFilterEntity left, in EnableLiveFilterEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in EnableLiveFilterEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(EnableLiveFilterEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EnableLiveFilterEntity(JsonElement instance)
            {
                return EnableLiveFilterEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EnableLiveFilterEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EnableLiveFilterEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EnableLiveFilterEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EnableLiveFilterEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EnableLiveFilterEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static EnableLiveFilterEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<EnableLiveFilterEntity>(json, options);
            }
            ...
            /// </exception>
            public static EnableLiveFilterEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<EnableLiveFilterEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out EnableLiveFilterEntity? result)
            {
                return JsonElementHelpers.TryParseValue<EnableLiveFilterEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new EnableLiveFilterEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static EnableLiveFilterEntity IJsonElement<EnableLiveFilterEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EnableLiveFilterEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="EnableLiveFilterEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="EnableLiveFilterEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public EnableLiveFilterEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<EnableLiveFilterEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="EnableLiveFilterEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public EnableLiveFilterEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<EnableLiveFilterEntity>(_idx);
                }
