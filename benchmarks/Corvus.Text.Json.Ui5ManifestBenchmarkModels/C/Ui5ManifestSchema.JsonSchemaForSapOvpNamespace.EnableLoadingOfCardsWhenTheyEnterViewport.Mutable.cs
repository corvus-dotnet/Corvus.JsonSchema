    ...
    public readonly partial struct JsonSchemaForSapOvpNamespace
    {
        ...
        public readonly partial struct EnableLoadingOfCardsWhenTheyEnterViewport
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<EnableLoadingOfCardsWhenTheyEnterViewport, Mutable>(EnableLoadingOfCardsWhenTheyEnterViewport.DefaultInstance);
                ...
                public static explicit operator Mutable(EnableLoadingOfCardsWhenTheyEnterViewport instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="EnableLoadingOfCardsWhenTheyEnterViewport"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator EnableLoadingOfCardsWhenTheyEnterViewport(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"EnableLoadingOfCardsWhenTheyEnterViewport.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly EnableLoadingOfCardsWhenTheyEnterViewport Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly EnableLoadingOfCardsWhenTheyEnterViewport Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<EnableLoadingOfCardsWhenTheyEnterViewport>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(EnableLoadingOfCardsWhenTheyEnterViewport instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<EnableLoadingOfCardsWhenTheyEnterViewport, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<EnableLoadingOfCardsWhenTheyEnterViewport> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<EnableLoadingOfCardsWhenTheyEnterViewport>();
                }
                finally
                {
