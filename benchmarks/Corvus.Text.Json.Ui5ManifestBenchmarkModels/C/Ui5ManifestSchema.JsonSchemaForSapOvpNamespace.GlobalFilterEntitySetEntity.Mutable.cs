    ...
    public readonly partial struct JsonSchemaForSapOvpNamespace
    {
        ...
        public readonly partial struct GlobalFilterEntitySetEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(GlobalFilterEntitySetEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="GlobalFilterEntitySetEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator GlobalFilterEntitySetEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"GlobalFilterEntitySetEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly GlobalFilterEntitySetEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly GlobalFilterEntitySetEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<GlobalFilterEntitySetEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(GlobalFilterEntitySetEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<GlobalFilterEntitySetEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<GlobalFilterEntitySetEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<GlobalFilterEntitySetEntity>();
                }
                finally
                {
