    ...
    public readonly partial struct JsonSchemaForSapOvpNamespace
    {
        ...
        public readonly partial struct GlobalFilterEntityTypeEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(GlobalFilterEntityTypeEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="GlobalFilterEntityTypeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator GlobalFilterEntityTypeEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"GlobalFilterEntityTypeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly GlobalFilterEntityTypeEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly GlobalFilterEntityTypeEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<GlobalFilterEntityTypeEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(GlobalFilterEntityTypeEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<GlobalFilterEntityTypeEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<GlobalFilterEntityTypeEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<GlobalFilterEntityTypeEntity>();
                }
                finally
                {
