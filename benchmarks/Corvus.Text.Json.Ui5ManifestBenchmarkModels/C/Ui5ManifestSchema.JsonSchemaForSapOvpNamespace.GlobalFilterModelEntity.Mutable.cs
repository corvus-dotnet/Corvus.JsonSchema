    ...
    public readonly partial struct JsonSchemaForSapOvpNamespace
    {
        ...
        public readonly partial struct GlobalFilterModelEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(GlobalFilterModelEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="GlobalFilterModelEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator GlobalFilterModelEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"GlobalFilterModelEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly GlobalFilterModelEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly GlobalFilterModelEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<GlobalFilterModelEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(GlobalFilterModelEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<GlobalFilterModelEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<GlobalFilterModelEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<GlobalFilterModelEntity>();
                }
                finally
                {
