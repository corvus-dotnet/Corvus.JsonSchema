...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapOvpNamespace
    {
        ...
        public readonly partial struct RepresentsTheLayoutOfTheCardContainer
            : IJsonElement<RepresentsTheLayoutOfTheCardContainer>
        {
            /// <summary>
            ...
            private static class Constants
            {
                ...
                /// </summary>
                public static readonly byte[] Enum1 = "fixed"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly RepresentsTheLayoutOfTheCardContainer EnumJson1 = ParsedJsonDocument<RepresentsTheLayoutOfTheCardContainer>.StringConstant([.."\"fixed\""u8]);
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly byte[] Enum2 = "resizable"u8.ToArray();
                /// <summary>
                /// A constant for the <c>enum</c> keyword.
                /// </summary>
                public static readonly RepresentsTheLayoutOfTheCardContainer EnumJson2 = ParsedJsonDocument<RepresentsTheLayoutOfTheCardContainer>.StringConstant([.."\"resizable\""u8]);
            }
            ...
            public static class EnumValues
            {
                ...
                /// as a <see cref="RepresentsTheLayoutOfTheCardContainer"/>.
                /// </summary>
                public static RepresentsTheLayoutOfTheCardContainer Fixed { get; } = Constants.EnumJson1;
                /// <summary>
                /// Gets the string "fixed"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> FixedUtf8 => Constants.Enum1;

                /// <summary>
                /// Gets the string "resizable"
                /// as a <see cref="RepresentsTheLayoutOfTheCardContainer"/>.
                /// </summary>
                public static RepresentsTheLayoutOfTheCardContainer Resizable { get; } = Constants.EnumJson2;
                /// <summary>
                /// Gets the string "resizable"
                /// as a UTF8 byte array.
                /// </summary>
                public static ReadOnlySpan<byte> ResizableUtf8 => Constants.Enum2;
            }
            ...
            {
                /// <summary>
                /// Corresponds to the JSON string "fixed".
                /// </summary>
                Fixed = 0,
                /// <summary>
                /// Corresponds to the JSON string "resizable".
                /// </summary>
                Resizable = 1,
            }
            ...
            public static implicit operator RepresentsTheLayoutOfTheCardContainer(KnownValues value)
            {
                return value switch
                {
                    KnownValues.Fixed => Constants.EnumJson1,
                    KnownValues.Resizable => Constants.EnumJson2,
            ...
            public static implicit operator KnownValues(RepresentsTheLayoutOfTheCardContainer value)
            {
            ...
            public bool TryGetKnownValue(out KnownValues result)
            {
                ...
                {
                    result = KnownValues.Fixed;
                    return true;
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    result = KnownValues.Resizable;
                    return true;
                }
            ...
            public static partial class JsonSchema
            {
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyMessage("/properties/sap.ovp/properties/containerLayout"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated, as a JSON Pointer within <see cref="SchemaDocument"/>.
                /// </summary>
                public const string SchemaLocation = "/properties/sap.ovp/properties/containerLayout";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/properties/sap.ovp/properties/containerLayout"u8;
                ...
                private static readonly global::Corvus.Text.Json.RuntimeEvaluator.JsonSchemaEvaluator Evaluator = global::Corvus.Ui5ManifestBenchmark.Current.CorvusJsonSchemaProgram.Entry(732);
