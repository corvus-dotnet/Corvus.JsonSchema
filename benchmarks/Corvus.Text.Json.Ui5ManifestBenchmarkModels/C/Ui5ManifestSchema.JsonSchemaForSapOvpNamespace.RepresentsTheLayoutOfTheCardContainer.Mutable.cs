    ...
    public readonly partial struct JsonSchemaForSapOvpNamespace
    {
        ...
        public readonly partial struct RepresentsTheLayoutOfTheCardContainer
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<RepresentsTheLayoutOfTheCardContainer, Mutable>(RepresentsTheLayoutOfTheCardContainer.DefaultInstance);
                ...
                public static explicit operator Mutable(RepresentsTheLayoutOfTheCardContainer instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsTheLayoutOfTheCardContainer"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsTheLayoutOfTheCardContainer(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsTheLayoutOfTheCardContainer.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheLayoutOfTheCardContainer Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheLayoutOfTheCardContainer Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsTheLayoutOfTheCardContainer>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsTheLayoutOfTheCardContainer instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (RepresentsTheLayoutOfTheCardContainer)value;
            ...
            {
                return workspace.CreateBuilder<RepresentsTheLayoutOfTheCardContainer, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RepresentsTheLayoutOfTheCardContainer> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RepresentsTheLayoutOfTheCardContainer>();
                }
                finally
                {
