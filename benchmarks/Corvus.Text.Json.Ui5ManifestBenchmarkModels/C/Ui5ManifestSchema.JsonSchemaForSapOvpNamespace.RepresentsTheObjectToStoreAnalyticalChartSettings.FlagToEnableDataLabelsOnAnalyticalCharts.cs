...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapOvpNamespace
    {
        ...
        public readonly partial struct RepresentsTheObjectToStoreAnalyticalChartSettings
        {
            ...
            public readonly partial struct FlagToEnableDataLabelsOnAnalyticalCharts
#if NET8_0_OR_GREATER
                : IJsonElement<FlagToEnableDataLabelsOnAnalyticalCharts>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="FlagToEnableDataLabelsOnAnalyticalCharts"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal FlagToEnableDataLabelsOnAnalyticalCharts(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static FlagToEnableDataLabelsOnAnalyticalCharts DefaultInstance { get; } = ParsedJsonDocument<FlagToEnableDataLabelsOnAnalyticalCharts>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(FlagToEnableDataLabelsOnAnalyticalCharts value)
                {
                ...
                /// </returns>
                public static bool operator ==(in FlagToEnableDataLabelsOnAnalyticalCharts left, in FlagToEnableDataLabelsOnAnalyticalCharts right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in FlagToEnableDataLabelsOnAnalyticalCharts left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(FlagToEnableDataLabelsOnAnalyticalCharts instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator FlagToEnableDataLabelsOnAnalyticalCharts(JsonElement instance)
                {
                    return FlagToEnableDataLabelsOnAnalyticalCharts.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static FlagToEnableDataLabelsOnAnalyticalCharts From<T>(in T instance)
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out FlagToEnableDataLabelsOnAnalyticalCharts? result)
                {
                    return JsonElementHelpers.TryParseValue<FlagToEnableDataLabelsOnAnalyticalCharts>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new FlagToEnableDataLabelsOnAnalyticalCharts(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static FlagToEnableDataLabelsOnAnalyticalCharts IJsonElement<FlagToEnableDataLabelsOnAnalyticalCharts>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"FlagToEnableDataLabelsOnAnalyticalCharts: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="FlagToEnableDataLabelsOnAnalyticalCharts"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="FlagToEnableDataLabelsOnAnalyticalCharts"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public FlagToEnableDataLabelsOnAnalyticalCharts Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<FlagToEnableDataLabelsOnAnalyticalCharts>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="FlagToEnableDataLabelsOnAnalyticalCharts"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public FlagToEnableDataLabelsOnAnalyticalCharts Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<FlagToEnableDataLabelsOnAnalyticalCharts>(_idx);
                    }
