...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapOvpNamespace
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RepresentsTheObjectToStoreFilterBarConfiguration"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RepresentsTheObjectToStoreFilterBarConfiguration(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RepresentsTheObjectToStoreFilterBarConfiguration DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapOvpNamespace.RepresentsTheObjectToStoreFilterBarConfiguration.DateSettingsEntity DateSettings
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DateSettingsUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapOvpNamespace.RepresentsTheObjectToStoreFilterBarConfiguration.DateSettingsEntity value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in RepresentsTheObjectToStoreFilterBarConfiguration left, in RepresentsTheObjectToStoreFilterBarConfiguration right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RepresentsTheObjectToStoreFilterBarConfiguration left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(RepresentsTheObjectToStoreFilterBarConfiguration instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RepresentsTheObjectToStoreFilterBarConfiguration(JsonElement instance)
            {
                return RepresentsTheObjectToStoreFilterBarConfiguration.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheObjectToStoreFilterBarConfiguration From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheObjectToStoreFilterBarConfiguration ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheObjectToStoreFilterBarConfiguration>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheObjectToStoreFilterBarConfiguration ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheObjectToStoreFilterBarConfiguration>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheObjectToStoreFilterBarConfiguration ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheObjectToStoreFilterBarConfiguration>(json, options);
            }
            ...
            /// </exception>
            public static RepresentsTheObjectToStoreFilterBarConfiguration ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheObjectToStoreFilterBarConfiguration>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsTheObjectToStoreFilterBarConfiguration? result)
            {
                return JsonElementHelpers.TryParseValue<RepresentsTheObjectToStoreFilterBarConfiguration>(ref reader, out result);
            }
...
#if NET
            static RepresentsTheObjectToStoreFilterBarConfiguration IJsonElement<RepresentsTheObjectToStoreFilterBarConfiguration>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RepresentsTheObjectToStoreFilterBarConfiguration: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public RepresentsTheObjectToStoreFilterBarConfiguration Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public RepresentsTheObjectToStoreFilterBarConfiguration Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RepresentsTheObjectToStoreFilterBarConfiguration>(_idx);
                }
            ...
            {
                /// <summary>
                /// Gets the JSON property name for <see cref="DateSettings"/>.
                /// </summary>
                ...
                /// Gets the JSON property name for <see cref="DateSettings"/>.
                /// </summary>
                public static ReadOnlySpan<byte> DateSettingsUtf8 => "dateSettings"u8;
            }
            ...
            {
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="DateSettings"/>.
                /// </summary>
                public static ReadOnlySpan<byte> DateSettings => "dateSettings"u8;
            }
            ...
            {
                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="DateSettings"/>.
                /// </summary>
                public static ReadOnlySpan<byte> DateSettings => [0xE5, 0x00, 0x00, 0x00, 0x22, 0x64, 0x61, 0x74, 0x65, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6E, 0x67, 0x73, 0x22];
            }
        }
    }
}
