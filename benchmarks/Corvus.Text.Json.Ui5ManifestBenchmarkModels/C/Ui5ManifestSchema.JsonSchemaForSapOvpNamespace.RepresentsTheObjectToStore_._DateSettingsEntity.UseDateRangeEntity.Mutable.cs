            ...
            public readonly partial struct DateSettingsEntity
            {
                ...
                public readonly partial struct UseDateRangeEntity
                {
...
#endif
                    {
                        ...
                        /// </remarks>
                        public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<UseDateRangeEntity, Mutable>(UseDateRangeEntity.DefaultInstance);
                        ...
                        public static explicit operator Mutable(UseDateRangeEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="UseDateRangeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator UseDateRangeEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"UseDateRangeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly UseDateRangeEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly UseDateRangeEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<UseDateRangeEntity>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(UseDateRangeEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<UseDateRangeEntity, Mutable>(this);
                    }
                }
            }
        }
