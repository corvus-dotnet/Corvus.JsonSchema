    ...
    public readonly partial struct JsonSchemaForSapOvpNamespace
    {
        ...
        public readonly partial struct ShowBasicSearchEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ShowBasicSearchEntity, Mutable>(ShowBasicSearchEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(ShowBasicSearchEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ShowBasicSearchEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ShowBasicSearchEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ShowBasicSearchEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ShowBasicSearchEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ShowBasicSearchEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ShowBasicSearchEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ShowBasicSearchEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ShowBasicSearchEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ShowBasicSearchEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ShowBasicSearchEntity>();
                }
                finally
                {
