    ...
    public readonly partial struct JsonSchemaForSapOvpNamespace
    {
        ...
        public readonly partial struct SmartVariantRequiredEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<SmartVariantRequiredEntity, Mutable>(SmartVariantRequiredEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(SmartVariantRequiredEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="SmartVariantRequiredEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator SmartVariantRequiredEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"SmartVariantRequiredEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly SmartVariantRequiredEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly SmartVariantRequiredEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<SmartVariantRequiredEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(SmartVariantRequiredEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<SmartVariantRequiredEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<SmartVariantRequiredEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<SmartVariantRequiredEntity>();
                }
                finally
                {
