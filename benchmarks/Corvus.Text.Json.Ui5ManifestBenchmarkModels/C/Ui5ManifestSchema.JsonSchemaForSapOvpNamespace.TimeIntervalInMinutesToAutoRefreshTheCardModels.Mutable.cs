    ...
    public readonly partial struct JsonSchemaForSapOvpNamespace
    {
        ...
        public readonly partial struct TimeIntervalInMinutesToAutoRefreshTheCardModels
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<TimeIntervalInMinutesToAutoRefreshTheCardModels, Mutable>(TimeIntervalInMinutesToAutoRefreshTheCardModels.DefaultInstance);
            ...
            public static ParsedJsonDocument<TimeIntervalInMinutesToAutoRefreshTheCardModels> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TimeIntervalInMinutesToAutoRefreshTheCardModels>();
                }
                finally
                {
