    ...
    public readonly partial struct JsonSchemaForSapOvpNamespace
    {
        ...
        public readonly partial struct UseDateRangeTypeEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<UseDateRangeTypeEntity, Mutable>(UseDateRangeTypeEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(UseDateRangeTypeEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="UseDateRangeTypeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator UseDateRangeTypeEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"UseDateRangeTypeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly UseDateRangeTypeEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly UseDateRangeTypeEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<UseDateRangeTypeEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(UseDateRangeTypeEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<UseDateRangeTypeEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<UseDateRangeTypeEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<UseDateRangeTypeEntity>();
                }
                finally
                {
