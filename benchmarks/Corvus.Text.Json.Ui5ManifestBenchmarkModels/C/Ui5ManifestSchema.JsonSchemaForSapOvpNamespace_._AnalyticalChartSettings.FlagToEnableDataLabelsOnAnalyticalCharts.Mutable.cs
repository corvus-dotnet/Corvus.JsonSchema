        ...
        public readonly partial struct RepresentsTheObjectToStoreAnalyticalChartSettings
        {
            ...
            public readonly partial struct FlagToEnableDataLabelsOnAnalyticalCharts
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<FlagToEnableDataLabelsOnAnalyticalCharts, Mutable>(FlagToEnableDataLabelsOnAnalyticalCharts.DefaultInstance);
                    ...
                    public static explicit operator Mutable(FlagToEnableDataLabelsOnAnalyticalCharts instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="FlagToEnableDataLabelsOnAnalyticalCharts"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator FlagToEnableDataLabelsOnAnalyticalCharts(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"FlagToEnableDataLabelsOnAnalyticalCharts.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly FlagToEnableDataLabelsOnAnalyticalCharts Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly FlagToEnableDataLabelsOnAnalyticalCharts Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<FlagToEnableDataLabelsOnAnalyticalCharts>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(FlagToEnableDataLabelsOnAnalyticalCharts instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<FlagToEnableDataLabelsOnAnalyticalCharts, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<FlagToEnableDataLabelsOnAnalyticalCharts> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<FlagToEnableDataLabelsOnAnalyticalCharts>();
                    }
                    finally
                    {
