    ...
    public readonly partial struct JsonSchemaForSapOvpNamespace
    {
        ...
        public readonly partial struct RepresentsTheObjectToStoreFilterBarConfiguration
        {
            ...
            public readonly partial struct DateSettingsEntity
            {
                ...
                public readonly partial struct RepresentsTheFilterFieldDefinitionForEachField
#if NET8_0_OR_GREATER
                    : IJsonElement<RepresentsTheFilterFieldDefinitionForEachField>,
                      IFormattable,
                      ISpanFormattable,
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="RepresentsTheFilterFieldDefinitionForEachField"/> struct.
                    /// </summary>
                    ...
                    internal RepresentsTheFilterFieldDefinitionForEachField(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static RepresentsTheFilterFieldDefinitionForEachField DefaultInstance { get; }
                    ...
                    /// <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.FilterFieldName"/>.
                    /// </summary>
                    ...
                    public static bool MatchesPatternFilterFieldName(ReadOnlySpan<byte> propertyName)
                    {
                    ...
                    /// <returns><see langword="true"/> if the property name matches the pattern, otherwise <see langword="false"/>.</returns>
                    public static bool TryAsPatternFilterFieldName(ReadOnlySpan<byte> propertyName, in JsonElement value, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.FilterFieldName result)
                    {
                        if (MatchesPatternFilterFieldName(propertyName))
                        {
                            result = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.FilterFieldName.From(value);
                            return true;
                        }
                    ...
                    public interface IPatternPropertyVisitor<TState>
                    {
                        ...
                        /// </summary>
                        bool VisitPatternFilterFieldName(ReadOnlySpan<byte> name, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.FilterFieldName value, ref TState state);
                        ...
                        where TVisitor : IPatternPropertyVisitor<TState>
                    {
                        ...
                        foreach (var property in EnumerateObject())
                        {
                            ...
                            {
                                matched = true;
                                Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.FilterFieldName typedValue = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.FilterFieldName.From(property.Value);
                                if (!visitor.VisitPatternFilterFieldName(propertyName, in typedValue, ref state))
                                {
                                    return false;
                                }
                    ...
                    /// </returns>
                    public static bool operator ==(in RepresentsTheFilterFieldDefinitionForEachField left, in RepresentsTheFilterFieldDefinitionForEachField right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in RepresentsTheFilterFieldDefinitionForEachField left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    public static implicit operator JsonElement(RepresentsTheFilterFieldDefinitionForEachField instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RepresentsTheFilterFieldDefinitionForEachField(JsonElement instance)
                    {
                        return RepresentsTheFilterFieldDefinitionForEachField.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RepresentsTheFilterFieldDefinitionForEachField From<T>(in T instance)
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RepresentsTheFilterFieldDefinitionForEachField ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        #pragma warning disable CS0618 // Type or member is obsolete
                        return JsonElementHelpers.ParseValue<RepresentsTheFilterFieldDefinitionForEachField>(utf8Json, options);
                    ...
                    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RepresentsTheFilterFieldDefinitionForEachField ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        #pragma warning disable CS0618 // Type or member is obsolete
                        return JsonElementHelpers.ParseValue<RepresentsTheFilterFieldDefinitionForEachField>(json, options);
                        #pragma warning restore CS0618
                    }
                    ...
                    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RepresentsTheFilterFieldDefinitionForEachField ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        #pragma warning disable CS0618 // Type or member is obsolete
                        return JsonElementHelpers.ParseValue<RepresentsTheFilterFieldDefinitionForEachField>(json, options);
                        #pragma warning restore CS0618
                    ...
                    /// </exception>
                    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                    public static RepresentsTheFilterFieldDefinitionForEachField ParseValue(ref Utf8JsonReader reader)
                    {
                        #pragma warning disable CS0618 // Type or member is obsolete
                        return JsonElementHelpers.ParseValue<RepresentsTheFilterFieldDefinitionForEachField>(ref reader);
                        #pragma warning restore CS0618
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsTheFilterFieldDefinitionForEachField? result)
                    {
                        return JsonElementHelpers.TryParseValue<RepresentsTheFilterFieldDefinitionForEachField>(ref reader, out result);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new RepresentsTheFilterFieldDefinitionForEachField(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                    static RepresentsTheFilterFieldDefinitionForEachField IJsonElement<RepresentsTheFilterFieldDefinitionForEachField>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RepresentsTheFilterFieldDefinitionForEachField: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="RepresentsTheFilterFieldDefinitionForEachField"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="RepresentsTheFilterFieldDefinitionForEachField"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public RepresentsTheFilterFieldDefinitionForEachField Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<RepresentsTheFilterFieldDefinitionForEachField>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="RepresentsTheFilterFieldDefinitionForEachField"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public RepresentsTheFilterFieldDefinitionForEachField Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<RepresentsTheFilterFieldDefinitionForEachField>(_idx);
                        }
