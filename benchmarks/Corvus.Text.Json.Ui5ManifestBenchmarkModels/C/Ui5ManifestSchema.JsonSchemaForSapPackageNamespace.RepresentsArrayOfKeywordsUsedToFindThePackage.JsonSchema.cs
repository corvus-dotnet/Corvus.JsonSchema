...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapPackageNamespace
    {
        ...
        public readonly partial struct RepresentsArrayOfKeywordsUsedToFindThePackage
            : IJsonElement<RepresentsArrayOfKeywordsUsedToFindThePackage>
        {
            public static partial class JsonSchema
            {
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyKeywordsPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("keywords"u8, buffer, out written);
                private static readonly JsonSchemaMessageProvider<int> RequiredPropertyKeywordsNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("keywords"u8, buffer, out written);

                private const int RequiredOffsetForKeywords = 0;
                private const uint RequiredBitForKeywords = 0b00000000000000000000000000000001;

                private const uint RequiredBitMask0 =
                    RequiredBitForKeywords;
                private static readonly JsonSchemaPathProvider KeywordsSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/keywords/$ref"u8, buffer, out written);
                private static readonly JsonSchemaPathProvider TechnicalAttributesSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/technicalAttributes"u8, buffer, out written);

                private static void MatchKeywords(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext =
                        Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Tag.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.KeywordsUtf8,
                            evaluationPath: KeywordsSchemaEvaluationPath);

                    Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Tag.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext);
                    ...
                    requiredBitBuffer[RequiredOffsetForKeywords] |= RequiredBitForKeywords;
                }

                private static void MatchTechnicalAttributes(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
                    JsonSchemaContext childContext1 =
                        Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapPackageNamespace.RepresentsArrayOfKeywordsUsedToFindThePackage.TechnicalAttributesEntityArray.JsonSchema.PushChildContextUnescaped(
                            parentDocument,
                            parentDocumentIndex,
                            ref context,
                            JsonPropertyNames.TechnicalAttributesUtf8,
                            evaluationPath: TechnicalAttributesSchemaEvaluationPath);

                    Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapPackageNamespace.RepresentsArrayOfKeywordsUsedToFindThePackage.TechnicalAttributesEntityArray.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                ...
                private static PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
                {
                    return new PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator>([
                        (static () => JsonPropertyNames.KeywordsUtf8, MatchKeywords),
                        (static () => JsonPropertyNames.TechnicalAttributesUtf8, MatchTechnicalAttributes),
                    ]);
                }
                ...
                /// </summary>
                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("ui5-manifest-schema.json#/properties/sap.package/properties/tags"u8, buffer, out written);

                /// <summary>
                /// Gets the schema location from which this type was generated.
                /// </summary>
                public const string SchemaLocation = "ui5-manifest-schema.json#/properties/sap.package/properties/tags";

                /// <summary>
                /// Gets the schema location from which this type was generated as a UTF-8 string.
                /// </summary>
                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "ui5-manifest-schema.json#/properties/sap.package/properties/tags"u8;
                    ...
                    ref JsonSchemaContext context)
                {
                    ...
                    else
                    {
                        ...
                        {
                            context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyKeywordsPresent, "keywords"u8, "required"u8);
                        }
                        ...
                        {
                            if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForKeywords] & RequiredBitForKeywords) == 0)
                            {
                                context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyKeywordsNotPresent, "keywords"u8, "required"u8);
                            }
                            else
                            {
                                context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyKeywordsPresent, "keywords"u8, "required"u8);
