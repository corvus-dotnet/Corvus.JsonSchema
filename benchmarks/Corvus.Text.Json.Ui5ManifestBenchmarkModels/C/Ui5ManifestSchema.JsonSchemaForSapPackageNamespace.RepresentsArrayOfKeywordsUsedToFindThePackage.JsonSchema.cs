    ...
    public readonly partial struct JsonSchemaForSapPackageNamespace
    {
            ...
            : IJsonElement<RepresentsArrayOfKeywordsUsedToFindThePackage>
        {
            public static partial class JsonSchema
            {
                ...
                private static void MatchKeywords(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                {
                ...
                private static void MatchTechnicalAttributes(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                {
                    context.AddLocalEvaluatedProperty(propertyCount);
