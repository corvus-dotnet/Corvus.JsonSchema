        ...
        public readonly partial struct RequiredVersion
        {
            ...
            public readonly partial struct UpgradeNotificationEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<UpgradeNotificationEntity, Mutable>(UpgradeNotificationEntity.DefaultInstance);
                ...
                public ref struct Source
                {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Source(KnownValues value) => (UpgradeNotificationEntity)value;
                ...
                public static ParsedJsonDocument<UpgradeNotificationEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<UpgradeNotificationEntity>();
                    }
                    finally
                    {
