...
public readonly partial struct Ui5ManifestSchema
{
        ...
        : IJsonElement<JsonSchemaForSapPlatformAbapNamespace>
    {
        public static partial class JsonSchema
        {
            ...
            private static void MatchUriValue(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
            ...
            private static void MatchUriNwbc(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
