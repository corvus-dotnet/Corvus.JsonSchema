    ...
    public readonly partial struct JsonSchemaForSapPlatformHcpNamespace
    {
        ...
        public readonly partial struct RepresentsTheHtml5ApplicationName
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RepresentsTheHtml5ApplicationName instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsTheHtml5ApplicationName"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsTheHtml5ApplicationName(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsTheHtml5ApplicationName.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheHtml5ApplicationName Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheHtml5ApplicationName Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsTheHtml5ApplicationName>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsTheHtml5ApplicationName instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RepresentsTheHtml5ApplicationName, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RepresentsTheHtml5ApplicationName> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RepresentsTheHtml5ApplicationName>();
                }
                finally
                {
