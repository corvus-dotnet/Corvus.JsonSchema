...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapPlatformMobilecardsNamespace
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(JsonSchemaForSapPlatformMobilecardsNamespace instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="JsonSchemaForSapPlatformMobilecardsNamespace"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonSchemaForSapPlatformMobilecardsNamespace(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapPlatformMobilecardsNamespace.VersionEntity.Mutable Version
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapPlatformMobilecardsNamespace.VersionEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Mutable Compatible
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CompatibleUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetCompatible(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source value)
            {
                ...
                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.CompatibleUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CompatibleUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Compatible, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// <summary>
            /// Remove the <c>compatible</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveCompatible()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.CompatibleUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"JsonSchemaForSapPlatformMobilecardsNamespace.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly JsonSchemaForSapPlatformMobilecardsNamespace Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly JsonSchemaForSapPlatformMobilecardsNamespace Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<JsonSchemaForSapPlatformMobilecardsNamespace>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapPlatformMobilecardsNamespace.VersionEntity.Source _createArg1;
            ...
            public static implicit operator Source(JsonSchemaForSapPlatformMobilecardsNamespace instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapPlatformMobilecardsNamespace.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="JsonSchemaForSapPlatformMobilecardsNamespace"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapPlatformMobilecardsNamespace.VersionEntity.Source version = default,
                in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source compatible = default)
            {
                version.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Version, ref builder);
                compatible.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Compatible, ref builder);
            }

            /// <summary>
            /// Creates an instance of a <see cref="JsonSchemaForSapPlatformMobilecardsNamespace"/>.
            /// </summary>
            public void Create(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapPlatformMobilecardsNamespace.VersionEntity.Source version = default, in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source compatible = default)
            {
                Create(ref _builder, version, compatible);
            }
        ...
        /// <param name="compatible">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapPlatformMobilecardsNamespace.VersionEntity.Source version = default, in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source compatible = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(version, compatible);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<JsonSchemaForSapPlatformMobilecardsNamespace, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<JsonSchemaForSapPlatformMobilecardsNamespace> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<JsonSchemaForSapPlatformMobilecardsNamespace>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<JsonSchemaForSapPlatformMobilecardsNamespace> Create<TContext>(
        ...
        public static ParsedJsonDocument<JsonSchemaForSapPlatformMobilecardsNamespace> Create(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapPlatformMobilecardsNamespace.VersionEntity.Source version = default, in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source compatible = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
