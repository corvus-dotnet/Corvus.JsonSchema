            ...
            public readonly partial struct RequiredFlexEnabled
            {
                ...
                public readonly partial struct RepresentsAnIndicatorWhetherAnAppIsFlexEnabled
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(RepresentsAnIndicatorWhetherAnAppIsFlexEnabled instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="RepresentsAnIndicatorWhetherAnAppIsFlexEnabled"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator RepresentsAnIndicatorWhetherAnAppIsFlexEnabled(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"RepresentsAnIndicatorWhetherAnAppIsFlexEnabled.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RepresentsAnIndicatorWhetherAnAppIsFlexEnabled Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RepresentsAnIndicatorWhetherAnAppIsFlexEnabled Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<RepresentsAnIndicatorWhetherAnAppIsFlexEnabled>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(RepresentsAnIndicatorWhetherAnAppIsFlexEnabled instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<RepresentsAnIndicatorWhetherAnAppIsFlexEnabled, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<RepresentsAnIndicatorWhetherAnAppIsFlexEnabled> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<RepresentsAnIndicatorWhetherAnAppIsFlexEnabled>();
                        }
                        finally
                        {
