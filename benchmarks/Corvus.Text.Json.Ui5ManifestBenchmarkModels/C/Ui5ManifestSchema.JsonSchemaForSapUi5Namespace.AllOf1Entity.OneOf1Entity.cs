    ...
    public readonly partial struct JsonSchemaForSapUi5Namespace
    {
        ...
        public readonly partial struct AllOf1Entity
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapUi5Namespace.AllOf1Entity.OneOf1Entity.RepresentsAnIndicatorWhetherAnAppIsFlexEnabled FlexEnabled
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FlexEnabledUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapUi5Namespace.AllOf1Entity.OneOf1Entity.RepresentsAnIndicatorWhetherAnAppIsFlexEnabled value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RootViewDef RootView
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RootViewUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RootViewDef value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Routing RoutingValue
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RoutingValueUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Routing value))
                        {
                            return value;
                        }
                ...
                private static class JsonPropertyNamesPrebaked
                {
                    ...
                    /// <summary>
                    /// Gets the pre-baked property name blob for <see cref="RoutingValue"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> RoutingValue => [0x95, 0x00, 0x00, 0x00, 0x22, 0x72, 0x6F, 0x75, 0x74, 0x69, 0x6E, 0x67, 0x22];
                }
            }
        }
    }
