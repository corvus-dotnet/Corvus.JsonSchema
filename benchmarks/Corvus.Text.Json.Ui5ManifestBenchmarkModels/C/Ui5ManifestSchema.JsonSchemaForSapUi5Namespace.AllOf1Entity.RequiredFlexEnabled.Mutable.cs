        ...
        public readonly partial struct AllOf1Entity
        {
            ...
            public readonly partial struct RequiredFlexEnabled
            {
...
#endif
                {
                    ...
                    public void SetFlexEnabled(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapUi5Namespace.AllOf1Entity.RequiredFlexEnabled.RepresentsAnIndicatorWhetherAnAppIsFlexEnabled.Source value)
                    {
                        ...
                        else
                        {
                            ...
                            value.AddAsProperty(JsonPropertyNamesEscaped.FlexEnabled, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    ...
                    public void SetRootView(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RootViewDefFlexEnabled.Source value)
                    {
                        ...
                        {
                            // We are going to insert the new value
                            value.AddAsProperty(JsonPropertyNamesEscaped.RootView, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                            int endIndex = _idx + _parent.GetDbSize(_idx, false);
                            _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                        }
                    ...
                    public void SetRouting(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RoutingFlexEnabled.Source value)
                    {
                        ...
                        {
                            // We are going to insert the new value
                            value.AddAsProperty(JsonPropertyNamesEscaped.Routing, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                            int endIndex = _idx + _parent.GetDbSize(_idx, false);
                            _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                        }
                ...
                public ref struct Builder
                {
                    ...
                    {
                        flexEnabled.AddAsProperty(JsonPropertyNamesEscaped.FlexEnabled, ref builder, escapeName: false);
                        rootView.AddAsProperty(JsonPropertyNamesEscaped.RootView, ref builder, escapeName: false);
                        routing.AddAsProperty(JsonPropertyNamesEscaped.Routing, ref builder, escapeName: false);
                    }
