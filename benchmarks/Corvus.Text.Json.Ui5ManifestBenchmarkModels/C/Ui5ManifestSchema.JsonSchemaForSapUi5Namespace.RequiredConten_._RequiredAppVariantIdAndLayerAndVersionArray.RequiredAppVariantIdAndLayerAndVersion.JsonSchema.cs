        ...
        public readonly partial struct RequiredContentDensitiesAndDependencies
        {
            ...
            public readonly partial struct RequiredAppVariantIdAndLayerAndVersionArray
            {
                ...
                public readonly partial struct RequiredAppVariantIdAndLayerAndVersion
                    : IJsonElement<RequiredAppVariantIdAndLayerAndVersion>
                {
                    public static partial class JsonSchema
                    {
                        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyAppVariantIdPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("appVariantId"u8, buffer, out written);
                        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyAppVariantIdNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("appVariantId"u8, buffer, out written);

                        private const int RequiredOffsetForAppVariantId = 0;
                        private const uint RequiredBitForAppVariantId = 0b00000000000000000000000000000001;

                        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyLayerPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyPresent("layer"u8, buffer, out written);
                        private static readonly JsonSchemaMessageProvider<int> RequiredPropertyLayerNotPresent = static (_, buffer, out written) => JsonSchemaEvaluation.RequiredPropertyNotPresent("layer"u8, buffer, out written);

                        private const int RequiredOffsetForLayer = 0;
                        private const uint RequiredBitForLayer = 0b00000000000000000000000000000010;
                        ...
                        private const uint RequiredBitMask0 =
                            RequiredBitForAppVariantId | RequiredBitForLayer | RequiredBitForVersion;
                        ...
                        private static readonly JsonSchemaPathProvider LayerSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/layer"u8, buffer, out written);
                        ...
                        private static void MatchAppVariantId(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                        {
                            ...
                            requiredBitBuffer[RequiredOffsetForAppVariantId] |= RequiredBitForAppVariantId;
                        }

                        private static void MatchLayer(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                        {
                            context.AddLocalEvaluatedProperty(propertyCount);
                            JsonSchemaContext childContext1 =
                                Corvus.Ui5ManifestBenchmark.Current.JsonString.JsonSchema.PushChildContextUnescaped(
                                    ...
                                    parentDocumentIndex,
                                    ref context,
                                    JsonPropertyNames.LayerUtf8,
                                    evaluationPath: LayerSchemaEvaluationPath);
                            ...
                            requiredBitBuffer[RequiredOffsetForLayer] |= RequiredBitForLayer;
                        }
                        ...
                        private static PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator> MatchersBuilder()
                        {
                            return new PropertySchemaMatchers<Corvus.Ui5ManifestBenchmark.Current.PropertiesValidationHandler_NamedPropertyValidator>([
                                ...
                                (static () => JsonPropertyNames.LayerUtf8, MatchLayer),
                        ...
                        /// </summary>
                        public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/properties/sap.ui5/allOf/0/properties/appVariantIdHierarchy/items"u8, buffer, out written);

                        /// <summary>
                        /// Gets the schema location from which this type was generated.
                        /// </summary>
                        public const string SchemaLocation = "/properties/sap.ui5/allOf/0/properties/appVariantIdHierarchy/items";

                        /// <summary>
                        /// Gets the schema location from which this type was generated as a UTF-8 string.
                        /// </summary>
                        public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/properties/sap.ui5/allOf/0/properties/appVariantIdHierarchy/items"u8;
                            ...
                            ref JsonSchemaContext context)
                        {
                            ...
                            else
                            {
                                ...
                                if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                                {
                                    if (context.HasCollector)
                                    {
                                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyAppVariantIdPresent, "appVariantId"u8, "required"u8);
                                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyLayerPresent, "layer"u8, "required"u8);
                                ...
                                {
                                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForAppVariantId] & RequiredBitForAppVariantId) == 0)
                                    {
                                        context.EvaluatedKeywordForProperty(false, 0, RequiredPropertyAppVariantIdNotPresent, "appVariantId"u8, "required"u8);
                                    }
                                    else
                                    {
                                        context.EvaluatedKeywordForProperty(true, 0, RequiredPropertyAppVariantIdPresent, "appVariantId"u8, "required"u8);
                                    ...
                                    if ((requiredPropertyChildHandler_seenItems[RequiredOffsetForLayer] & RequiredBitForLayer) == 0)
                                    {
                                        context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyLayerNotPresent, "layer"u8, "required"u8);
                                    }
                                    else
                                    {
                                        context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyLayerPresent, "layer"u8, "required"u8);
