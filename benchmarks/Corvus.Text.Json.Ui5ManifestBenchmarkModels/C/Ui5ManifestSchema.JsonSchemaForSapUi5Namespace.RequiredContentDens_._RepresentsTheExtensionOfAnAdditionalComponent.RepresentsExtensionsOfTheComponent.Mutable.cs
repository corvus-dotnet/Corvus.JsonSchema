            ...
            public readonly partial struct RepresentsTheExtensionOfAnAdditionalComponent
            {
                ...
                public readonly partial struct RepresentsExtensionsOfTheComponent
                {
...
#endif
                    {
                        ...
                        /// <summary>
                        /// Gets a <see cref="RepresentsExtensionsOfTheComponent"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </summary>
                        /// <returns>
                        /// A <see cref="RepresentsExtensionsOfTheComponent"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </returns>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RepresentsExtensionsOfTheComponent Clone()
                        {
                            CheckValidInstance();
                            return _parent.CloneElement<RepresentsExtensionsOfTheComponent>(_idx);
                        }
                        ...
                        /// </summary>
                        /// <returns>
                        /// An immutable <see cref="RepresentsExtensionsOfTheComponent"/> that lives for the lifetime of its
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RepresentsExtensionsOfTheComponent Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<RepresentsExtensionsOfTheComponent>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapUi5Namespace.RequiredContentDensitiesAndDependencies.RepresentsTheExtensionOfAnAdditionalComponent.RepresentsExtensionsOfTheComponent.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapUi5Namespace.RequiredContentDensitiesAndDependencies.RepresentsTheExtensionOfAnAdditionalComponent.RepresentsExtensionsOfTheComponent.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
