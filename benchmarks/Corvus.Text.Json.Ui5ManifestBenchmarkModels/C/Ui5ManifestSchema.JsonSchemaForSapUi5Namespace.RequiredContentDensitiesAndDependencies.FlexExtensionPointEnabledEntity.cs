    ...
    public readonly partial struct JsonSchemaForSapUi5Namespace
    {
        ...
        public readonly partial struct RequiredContentDensitiesAndDependencies
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="FlexExtensionPointEnabledEntity"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal FlexExtensionPointEnabledEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static FlexExtensionPointEnabledEntity DefaultInstance { get; } = ParsedJsonDocument<FlexExtensionPointEnabledEntity>.False;
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator bool(FlexExtensionPointEnabledEntity value)
                {
                ...
                /// </returns>
                public static bool operator ==(in FlexExtensionPointEnabledEntity left, in FlexExtensionPointEnabledEntity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in FlexExtensionPointEnabledEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(FlexExtensionPointEnabledEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator FlexExtensionPointEnabledEntity(JsonElement instance)
                {
                    return FlexExtensionPointEnabledEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static FlexExtensionPointEnabledEntity From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static FlexExtensionPointEnabledEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<FlexExtensionPointEnabledEntity>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static FlexExtensionPointEnabledEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<FlexExtensionPointEnabledEntity>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static FlexExtensionPointEnabledEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<FlexExtensionPointEnabledEntity>(json, options);
                }
                ...
                /// </exception>
                public static FlexExtensionPointEnabledEntity ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<FlexExtensionPointEnabledEntity>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out FlexExtensionPointEnabledEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<FlexExtensionPointEnabledEntity>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new FlexExtensionPointEnabledEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static FlexExtensionPointEnabledEntity IJsonElement<FlexExtensionPointEnabledEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"FlexExtensionPointEnabledEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="FlexExtensionPointEnabledEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="FlexExtensionPointEnabledEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public FlexExtensionPointEnabledEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<FlexExtensionPointEnabledEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="FlexExtensionPointEnabledEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public FlexExtensionPointEnabledEntity Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<FlexExtensionPointEnabledEntity>(_idx);
                    }
