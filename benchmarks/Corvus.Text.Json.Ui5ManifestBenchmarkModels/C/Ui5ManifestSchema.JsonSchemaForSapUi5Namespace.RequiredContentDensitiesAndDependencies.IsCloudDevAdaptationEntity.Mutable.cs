        ...
        public readonly partial struct RequiredContentDensitiesAndDependencies
        {
            ...
            public readonly partial struct IsCloudDevAdaptationEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<IsCloudDevAdaptationEntity, Mutable>(IsCloudDevAdaptationEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(IsCloudDevAdaptationEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="IsCloudDevAdaptationEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator IsCloudDevAdaptationEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"IsCloudDevAdaptationEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly IsCloudDevAdaptationEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly IsCloudDevAdaptationEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<IsCloudDevAdaptationEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(IsCloudDevAdaptationEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<IsCloudDevAdaptationEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<IsCloudDevAdaptationEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<IsCloudDevAdaptationEntity>();
                    }
                    finally
                    {
