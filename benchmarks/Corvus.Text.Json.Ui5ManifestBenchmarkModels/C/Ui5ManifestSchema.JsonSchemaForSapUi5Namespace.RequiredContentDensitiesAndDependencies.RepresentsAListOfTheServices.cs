...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapUi5Namespace
    {
        ...
        public readonly partial struct RequiredContentDensitiesAndDependencies
        {
            ...
            public readonly partial struct RepresentsAListOfTheServices
#if NET8_0_OR_GREATER
                : IJsonElement<RepresentsAListOfTheServices>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="RepresentsAListOfTheServices"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal RepresentsAListOfTheServices(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static RepresentsAListOfTheServices DefaultInstance { get; }
                ...
                public bool TryGetProperty(ReadOnlySpan<byte> propertyName, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Service value)
                {
                    CheckValidInstance();
                ...
                /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public bool TryGetProperty(ReadOnlySpan<char> propertyName, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Service value)
                {
                    CheckValidInstance();
                    return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
                }
                ...
                /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public bool TryGetProperty(string propertyName, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Service value)
                {
                    CheckValidInstance();
                    return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
                }
                ...
                /// <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Service"/>.
                /// </summary>
                ...
                public static bool MatchesPatternService(ReadOnlySpan<byte> propertyName)
                {
                    return true;
                }
                ...
                /// <returns><see langword="true"/> if the property name matches the pattern, otherwise <see langword="false"/>.</returns>
                public static bool TryAsPatternService(ReadOnlySpan<byte> propertyName, in JsonElement value, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Service result)
                {
                    if (MatchesPatternService(propertyName))
                    {
                        result = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Service.From(value);
                        return true;
                    }
                ...
                public interface IPatternPropertyVisitor<TState>
                {
                    ...
                    /// </summary>
                    bool VisitPatternService(ReadOnlySpan<byte> name, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Service value, ref TState state);
                    ...
                    where TVisitor : IPatternPropertyVisitor<TState>
                {
                    ...
                    foreach (var property in EnumerateObject())
                    {
                        ...
                        {
                            matched = true;
                            Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Service typedValue = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Service.From(property.Value);
                            if (!visitor.VisitPatternService(propertyName, in typedValue, ref state))
                            {
                                return false;
                            }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public ObjectEnumerator<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Service> EnumerateObject()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateObjectEnumerator<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Service>(_parent, _idx);
                }
                ...
                /// </returns>
                public static bool operator ==(in RepresentsAListOfTheServices left, in RepresentsAListOfTheServices right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in RepresentsAListOfTheServices left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(RepresentsAListOfTheServices instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsAListOfTheServices(JsonElement instance)
                {
                    return RepresentsAListOfTheServices.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RepresentsAListOfTheServices From<T>(in T instance)
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RepresentsAListOfTheServices ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<RepresentsAListOfTheServices>(utf8Json, options);
                ...
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RepresentsAListOfTheServices ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<RepresentsAListOfTheServices>(json, options);
                    #pragma warning restore CS0618
                }
                ...
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RepresentsAListOfTheServices ParseValue(string json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<RepresentsAListOfTheServices>(json, options);
                    #pragma warning restore CS0618
                ...
                /// </exception>
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                public static RepresentsAListOfTheServices ParseValue(ref Utf8JsonReader reader)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<RepresentsAListOfTheServices>(ref reader);
                    #pragma warning restore CS0618
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsAListOfTheServices? result)
                {
                    return JsonElementHelpers.TryParseValue<RepresentsAListOfTheServices>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new RepresentsAListOfTheServices(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static RepresentsAListOfTheServices IJsonElement<RepresentsAListOfTheServices>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsAListOfTheServices: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="RepresentsAListOfTheServices"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="RepresentsAListOfTheServices"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public RepresentsAListOfTheServices Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<RepresentsAListOfTheServices>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="RepresentsAListOfTheServices"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public RepresentsAListOfTheServices Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<RepresentsAListOfTheServices>(_idx);
                    }
