    ...
    public readonly partial struct JsonSchemaForSapUi5Namespace
    {
        ...
        public readonly partial struct RequiredContentDensitiesAndDependencies
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="RepresentsAListOfUi5ShortcutCommands"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal RepresentsAListOfUi5ShortcutCommands(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static RepresentsAListOfUi5ShortcutCommands DefaultInstance { get; }
                ...
                public bool TryGetProperty(ReadOnlySpan<byte> propertyName, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Command value)
                {
                    CheckValidInstance();
                ...
                /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public bool TryGetProperty(ReadOnlySpan<char> propertyName, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Command value)
                {
                    CheckValidInstance();
                    return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
                }
                ...
                /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public bool TryGetProperty(string propertyName, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Command value)
                {
                    CheckValidInstance();
                    return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
                }
                ...
                /// <summary>
                /// Determines if a property name matches '^[A-Za-z_][A-Za-z0-9_\-\|@]+$'
                /// for the pattern property producing the type
                /// <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Command"/>.
                /// </summary>
                ...
                public static bool MatchesPatternCommand(ReadOnlySpan<byte> propertyName)
                {
                ...
                /// <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Command"/>
                /// if the property name matches '^[A-Za-z_][A-Za-z0-9_\-\|@]+$'.
                /// </summary>
                /// <param name="propertyName">The unescaped UTF-8 property name.</param>
                /// <param name="value">The property value.</param>
                /// <param name="result">The typed property value, if the name matches.</param>
                /// <returns><see langword="true"/> if the property name matches the pattern, otherwise <see langword="false"/>.</returns>
                public static bool TryAsPatternCommand(ReadOnlySpan<byte> propertyName, in JsonElement value, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Command result)
                {
                    if (MatchesPatternCommand(propertyName))
                    {
                        result = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Command.From(value);
                        return true;
                    }
                ...
                {
                    /// <summary>
                    /// Visits a property matching '^[A-Za-z_][A-Za-z0-9_\-\|@]+$'.
                    /// </summary>
                    bool VisitPatternCommand(ReadOnlySpan<byte> name, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Command value, ref TState state);
                    ...
                    where TVisitor : IPatternPropertyVisitor<TState>
                {
                    ...
                    foreach (var property in EnumerateObject())
                    {
                        ...
                        {
                            matched = true;
                            Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Command typedValue = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Command.From(property.Value);
                            if (!visitor.VisitPatternCommand(propertyName, in typedValue, ref state))
                            {
                                return false;
                            }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                public ObjectEnumerator<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Command> EnumerateObject()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateObjectEnumerator<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Command>(_parent, _idx);
                }
                ...
                /// </returns>
                public static bool operator ==(in RepresentsAListOfUi5ShortcutCommands left, in RepresentsAListOfUi5ShortcutCommands right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in RepresentsAListOfUi5ShortcutCommands left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(RepresentsAListOfUi5ShortcutCommands instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsAListOfUi5ShortcutCommands(JsonElement instance)
                {
                    return RepresentsAListOfUi5ShortcutCommands.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RepresentsAListOfUi5ShortcutCommands From<T>(in T instance)
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RepresentsAListOfUi5ShortcutCommands ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<RepresentsAListOfUi5ShortcutCommands>(utf8Json, options);
                ...
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RepresentsAListOfUi5ShortcutCommands ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<RepresentsAListOfUi5ShortcutCommands>(json, options);
                    #pragma warning restore CS0618
                }
                ...
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RepresentsAListOfUi5ShortcutCommands ParseValue(string json, JsonDocumentOptions options = default)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<RepresentsAListOfUi5ShortcutCommands>(json, options);
                    #pragma warning restore CS0618
                ...
                /// </exception>
                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                public static RepresentsAListOfUi5ShortcutCommands ParseValue(ref Utf8JsonReader reader)
                {
                    #pragma warning disable CS0618 // Type or member is obsolete
                    return JsonElementHelpers.ParseValue<RepresentsAListOfUi5ShortcutCommands>(ref reader);
                    #pragma warning restore CS0618
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsAListOfUi5ShortcutCommands? result)
                {
                    return JsonElementHelpers.TryParseValue<RepresentsAListOfUi5ShortcutCommands>(ref reader, out result);
                }
...
#if NET
                static RepresentsAListOfUi5ShortcutCommands IJsonElement<RepresentsAListOfUi5ShortcutCommands>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsAListOfUi5ShortcutCommands: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public RepresentsAListOfUi5ShortcutCommands Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public RepresentsAListOfUi5ShortcutCommands Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<RepresentsAListOfUi5ShortcutCommands>(_idx);
                    }
