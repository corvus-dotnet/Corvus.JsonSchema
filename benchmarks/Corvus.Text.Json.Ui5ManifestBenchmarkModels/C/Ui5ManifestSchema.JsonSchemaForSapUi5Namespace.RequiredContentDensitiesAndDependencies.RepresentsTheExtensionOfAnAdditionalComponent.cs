    ...
    public readonly partial struct JsonSchemaForSapUi5Namespace
    {
        ...
        public readonly partial struct RequiredContentDensitiesAndDependencies
        {
            ...
            public readonly partial struct RepresentsTheExtensionOfAnAdditionalComponent
                ...
                : IJsonElement<RepresentsTheExtensionOfAnAdditionalComponent>,
                  IFormattable,
                  ISpanFormattable,
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="RepresentsTheExtensionOfAnAdditionalComponent"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal RepresentsTheExtensionOfAnAdditionalComponent(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static RepresentsTheExtensionOfAnAdditionalComponent DefaultInstance { get; }
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.IdDef Component
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ComponentUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.IdDef value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Current.JsonString MinVersion
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MinVersionUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString value))
                        {
                            return value;
                        }
                ...
                /// </returns>
                public static bool operator ==(in RepresentsTheExtensionOfAnAdditionalComponent left, in RepresentsTheExtensionOfAnAdditionalComponent right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in RepresentsTheExtensionOfAnAdditionalComponent left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(RepresentsTheExtensionOfAnAdditionalComponent instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsTheExtensionOfAnAdditionalComponent(JsonElement instance)
                {
                    return RepresentsTheExtensionOfAnAdditionalComponent.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RepresentsTheExtensionOfAnAdditionalComponent From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RepresentsTheExtensionOfAnAdditionalComponent ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RepresentsTheExtensionOfAnAdditionalComponent>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RepresentsTheExtensionOfAnAdditionalComponent ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RepresentsTheExtensionOfAnAdditionalComponent>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RepresentsTheExtensionOfAnAdditionalComponent ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RepresentsTheExtensionOfAnAdditionalComponent>(json, options);
                }
                ...
                /// </exception>
                public static RepresentsTheExtensionOfAnAdditionalComponent ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<RepresentsTheExtensionOfAnAdditionalComponent>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsTheExtensionOfAnAdditionalComponent? result)
                {
                    return JsonElementHelpers.TryParseValue<RepresentsTheExtensionOfAnAdditionalComponent>(ref reader, out result);
                }
...
#if NET
                static RepresentsTheExtensionOfAnAdditionalComponent IJsonElement<RepresentsTheExtensionOfAnAdditionalComponent>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsTheExtensionOfAnAdditionalComponent: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public RepresentsTheExtensionOfAnAdditionalComponent Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public RepresentsTheExtensionOfAnAdditionalComponent Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<RepresentsTheExtensionOfAnAdditionalComponent>(_idx);
                    }
                ...
                public static class JsonPropertyNames
                {
                    ...
                    /// Gets the JSON property name for <see cref="MinVersion"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> MinVersionUtf8 => "minVersion"u8;
                }
