        ...
        public readonly partial struct RequiredContentDensitiesAndDependencies
        {
            ...
            public readonly partial struct RequiredCompactAndCozy
            {
...
#endif
                {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Mutable Compact
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CompactUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Mutable Cozy
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CozyUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Mutable value))
                            {
                                return value;
                            }
                    ...
                    public void SetCozy(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source value)
                    {
                        ...
                        {
                            // We are going to insert the new value
                            value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Cozy, ref cvb);
                            int endIndex = _idx + _parent.GetDbSize(_idx, false);
                            _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                        }
                    ...
                    public bool TryGetFlags(out Flags result)
                    {
                        ...
                        if (element.TryGetProperty(JsonPropertyNames.CompactUtf8, out propertyValue) && propertyValue.ValueKind == JsonValueKind.True)
                        {
                            flags |= Flags.Compact;
                        }

                        if (element.TryGetProperty(JsonPropertyNames.CozyUtf8, out propertyValue) && propertyValue.ValueKind == JsonValueKind.True)
                        {
                            flags |= Flags.Cozy;
                        }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(Flags value) => RequiredCompactAndCozy.Build((value & Flags.Compact) != 0, (value & Flags.Cozy) != 0);
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapUi5Namespace.RequiredContentDensitiesAndDependencies.RequiredCompactAndCozy.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    internal static void Create(
                        ...
                        in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source compact,
                        in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source cozy)
                    {
                        compact.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Compact, ref builder);
                        cozy.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Cozy, ref builder);
                    }

                    /// <summary>
                    /// Creates an instance of a <see cref="RequiredCompactAndCozy"/>.
                    /// </summary>
                    public void Create(in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source compact, in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source cozy)
                    {
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source compact, in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source cozy, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                ...
                public static ParsedJsonDocument<RequiredCompactAndCozy> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<RequiredCompactAndCozy>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<RequiredCompactAndCozy> Create<TContext>(
                ...
                public static ParsedJsonDocument<RequiredCompactAndCozy> Create(in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source compact, in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source cozy, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
