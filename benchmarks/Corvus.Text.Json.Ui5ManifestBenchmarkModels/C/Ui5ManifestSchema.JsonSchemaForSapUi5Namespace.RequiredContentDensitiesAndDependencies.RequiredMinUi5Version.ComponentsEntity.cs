        ...
        public readonly partial struct RequiredContentDensitiesAndDependencies
        {
            ...
            public readonly partial struct RequiredMinUi5Version
            {
...
#endif
                {
                    ...
                    public bool TryGetProperty(ReadOnlySpan<byte> propertyName, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Component value)
                    {
                        CheckValidInstance();
                    ...
                    /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
                    /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                    public bool TryGetProperty(ReadOnlySpan<char> propertyName, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Component value)
                    {
                        CheckValidInstance();
                        return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
                    }
                    ...
                    /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
                    /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                    public bool TryGetProperty(string propertyName, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Component value)
                    {
                        CheckValidInstance();
                        return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
                    }
                    ...
                    /// <summary>
                    /// Determines if a property name matches '^([a-zA-Z_$][a-zA-Z0-9_$]{0,39}\.)*([a-zA-Z_$][a-zA-Z0-9_$]{0,39})$'
                    /// for the pattern property producing the type
                    /// <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Component"/>.
                    /// </summary>
                    ...
                    public static bool MatchesPatternComponent(ReadOnlySpan<byte> propertyName)
                    {
                    ...
                    /// <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Component"/>
                    /// if the property name matches '^([a-zA-Z_$][a-zA-Z0-9_$]{0,39}\.)*([a-zA-Z_$][a-zA-Z0-9_$]{0,39})$'.
                    /// </summary>
                    /// <param name="propertyName">The unescaped UTF-8 property name.</param>
                    /// <param name="value">The property value.</param>
                    /// <param name="result">The typed property value, if the name matches.</param>
                    /// <returns><see langword="true"/> if the property name matches the pattern, otherwise <see langword="false"/>.</returns>
                    public static bool TryAsPatternComponent(ReadOnlySpan<byte> propertyName, in JsonElement value, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Component result)
                    {
                        if (MatchesPatternComponent(propertyName))
                        {
                            result = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Component.From(value);
                            return true;
                        }
                    ...
                    {
                        /// <summary>
                        /// Visits a property matching '^([a-zA-Z_$][a-zA-Z0-9_$]{0,39}\.)*([a-zA-Z_$][a-zA-Z0-9_$]{0,39})$'.
                        /// </summary>
                        bool VisitPatternComponent(ReadOnlySpan<byte> name, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Component value, ref TState state);
                        ...
                        where TVisitor : IPatternPropertyVisitor<TState>
                    {
                        ...
                        foreach (var property in EnumerateObject())
                        {
                            ...
                            {
                                matched = true;
                                Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Component typedValue = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Component.From(property.Value);
                                if (!visitor.VisitPatternComponent(propertyName, in typedValue, ref state))
                                {
                                    return false;
                                }
                    ...
                    /// </summary>
                    /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                    public ObjectEnumerator<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Component> EnumerateObject()
                    {
                        CheckValidInstance();
                        return EnumeratorCreator.CreateObjectEnumerator<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Component>(_parent, _idx);
                    }
