        ...
        public readonly partial struct RequiredContentDensitiesAndDependencies
        {
            ...
            public readonly partial struct ResourceRootsEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(ResourceRootsEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ResourceRootsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ResourceRootsEntity(Mutable instance)
                    {
                    ...
                    public bool TryGetProperty(ReadOnlySpan<byte> propertyName, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ResourceRoot.Mutable value)
                    {
                        CheckValidInstance();
                    ...
                    /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
                    /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                    public bool TryGetProperty(ReadOnlySpan<char> propertyName, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ResourceRoot.Mutable value)
                    {
                        CheckValidInstance();
                        return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
                    }
                    ...
                    /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
                    /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                    public bool TryGetProperty(string propertyName, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ResourceRoot.Mutable value)
                    {
                        CheckValidInstance();
                        return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
                    }
                    ...
                    /// </summary>
                    /// <exception cref="InvalidOperationException">The value is not an object.</exception>
                    public ObjectEnumerator<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ResourceRoot.Mutable> EnumerateObject()
                    {
                        CheckValidInstance();
                        return EnumeratorCreator.CreateObjectEnumerator<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ResourceRoot.Mutable>(_parent, _idx);
                    }
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ResourceRootsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </remarks>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public void SetProperty(string propertyName, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ResourceRoot.Source value)
                    {
                    ...
                    ///   </para>
                    /// </remarks>
                    public void SetProperty(ReadOnlySpan<char> propertyName, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ResourceRoot.Source value)
                    {
                        CheckValidInstance();
                    ...
                    ///   </para>
                    /// </remarks>
                    public void SetProperty(ReadOnlySpan<byte> propertyName, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ResourceRoot.Source value)
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ResourceRootsEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ResourceRootsEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ResourceRootsEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapUi5Namespace.RequiredContentDensitiesAndDependencies.ResourceRootsEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(ResourceRootsEntity instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapUi5Namespace.RequiredContentDensitiesAndDependencies.ResourceRootsEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                {
                    return workspace.CreateBuilder<ResourceRootsEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<ResourceRootsEntity> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<ResourceRootsEntity>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<ResourceRootsEntity> Create<TContext>(
