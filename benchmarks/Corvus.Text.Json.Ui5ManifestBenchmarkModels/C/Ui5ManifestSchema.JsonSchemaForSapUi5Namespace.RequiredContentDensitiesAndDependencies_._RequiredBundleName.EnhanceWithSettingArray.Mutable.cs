            ...
            public readonly partial struct RepresentsUi5LibrarySpecificProperties
            {
                ...
                public readonly partial struct I18nEntity
                {
                    ...
                    public readonly partial struct RequiredBundleName
                    {
                        ...
                        public readonly partial struct EnhanceWithSettingArray
                        {
...
#endif
                            {
                                ...
                                public static explicit operator Mutable(EnhanceWithSettingArray instance)
                                {
                                ...
                                /// <returns>An immutable instance of a <see cref="EnhanceWithSettingArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static implicit operator EnhanceWithSettingArray(Mutable instance)
                                {
                                ...
                                public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnhanceWithSetting.Mutable this[int index]
                                {
                                    get
                                    {
                                        CheckValidInstance();
                                        return _parent.GetArrayIndexElement<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnhanceWithSetting.Mutable>(_idx, index);
                                    }
                                }
                                ...
                                /// </summary>
                                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                                public ArrayEnumerator<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnhanceWithSetting.Mutable> EnumerateArray()
                                {
                                    CheckValidInstance();
                                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnhanceWithSetting.Mutable>(_parent, _idx);
                                }
                                ...
                                {
                                    return
                                        (obj is IJsonElement value && Equals(new EnhanceWithSettingArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                                ...
                                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                private string DebuggerDisplay => $"EnhanceWithSettingArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                                /// <summary>
                                ...
                                /// </remarks>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public void SetItem(int itemIndex, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnhanceWithSetting.Source value)
                                {
                                    CheckValidInstance();
                                ...
                                ///   The parent <see cref="JsonDocument"/> has been disposed.
                                /// </exception>
                                public bool Remove(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnhanceWithSetting item)
                                {
                                    CheckValidInstance();
                                    if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnhanceWithSetting>(this, in item))
                                    {
                                        return false;
                                    }
                                ...
                                /// </remarks>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public void RemoveWhere(JsonPredicate<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnhanceWithSetting> predicate)
                                {
                                    CheckValidInstance();
                                    JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnhanceWithSetting>(this, predicate);
                                    _documentVersion = _parent.Version;
                                }
                                ...
                                ///   The parent <see cref="JsonDocument"/> has been disposed.
                                /// </exception>
                                public bool Replace(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnhanceWithSetting oldItem, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnhanceWithSetting.Source newItem)
                                {
                                    CheckValidInstance();
                                    ...
                                    var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnhanceWithSetting>(_parent, _idx);

                                    while (enumerator.MoveNext())
                                    {
                                        Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnhanceWithSetting current = enumerator.Current;
                                ...
                                /// <summary>
                                /// Gets a <see cref="EnhanceWithSettingArray"/> which can be safely stored beyond the lifetime of the
                                /// original document.
                                /// </summary>
                                /// <returns>
                                /// A <see cref="EnhanceWithSettingArray"/> which can be safely stored beyond the lifetime of the
                                /// original document.
                                /// </returns>
                                /// <remarks>
                                /// <para>
                                ...
                                /// </para>
                                /// </remarks>
                                public readonly EnhanceWithSettingArray Clone()
                                {
                                    CheckValidInstance();
                                    return _parent.CloneElement<EnhanceWithSettingArray>(_idx);
                                }
                                ...
                                /// </summary>
                                /// <returns>
                                /// An immutable <see cref="EnhanceWithSettingArray"/> that lives for the lifetime of its
                                ...
                                /// </para>
                                /// </remarks>
                                public readonly EnhanceWithSettingArray Freeze()
                                {
                                    CheckValidInstance();
                                    return _parent.FreezeElement<EnhanceWithSettingArray>(_idx);
                                }
                            }
                            ...
                            public ref struct Source
                            {
                                ...
                                internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapUi5Namespace.RequiredContentDensitiesAndDependencies.RepresentsUi5LibrarySpecificProperties.I18nEntity.RequiredBundleName.EnhanceWithSettingArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                                public static implicit operator Source(EnhanceWithSettingArray instance) => new(JsonElement.From(instance));
                            ...
                            public ref struct Builder
                            {
                                ...
                                /// Add an item to the array.
                                /// </summary>
                                public void AddItem<TContext>(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnhanceWithSetting.Source<TContext> value)
#if NET9_0_OR_GREATER
                                    where TContext : allows ref struct
#endif
                                {
                            ...
                            {
                                return workspace.CreateBuilder<EnhanceWithSettingArray, Mutable>(this);
                            }
                            ...
                            public static ParsedJsonDocument<EnhanceWithSettingArray> Create(
                                scoped in Source value, int initialCapacity = 30)
                            {
                                ...
                                try
                                {
                                    ...
                                    Debug.Assert(cvb.MemberCount == 1);
                                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                    return documentBuilder.ToParsedJsonDocument<EnhanceWithSettingArray>();
                                }
                                finally
                                {
                            ...
                            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                            public static ParsedJsonDocument<EnhanceWithSettingArray> Create<TContext>(
