        ...
        public readonly partial struct RequiredContentDensitiesAndDependencies
        {
                ...
                : IJsonElement<RepresentsAListOfUi5ShortcutCommands>
            {
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/properties/sap.ui5/allOf/0/properties/commands"u8, buffer, out written);
                        ...
                        else
                        {
                            ...
                            while (objectValidation_enumerator.MoveNext())
                            {
                                ...
                                if (JsonSchemaEvaluation.MatchRegularExpression(objectValidation_unescapedPropertyName.Span, PatternProperties))
                                {
                                    ...
                                    Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Command.JsonSchema.Evaluate(parentDocument, objectValidation_currentIndex, ref childContext);
