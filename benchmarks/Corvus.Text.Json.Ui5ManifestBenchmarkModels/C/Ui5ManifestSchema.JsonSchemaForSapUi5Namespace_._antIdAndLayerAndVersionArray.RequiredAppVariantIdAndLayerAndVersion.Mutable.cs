...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapUi5Namespace
    {
        ...
        public readonly partial struct RequiredContentDensitiesAndDependencies
        {
            ...
            /// </para>
            /// </remarks>
            public readonly partial struct RequiredAppVariantIdAndLayerAndVersionArray
            {
                /// <summary>
                /// Generated from JSON Schema.
                /// </summary>
                [DebuggerDisplay("{DebuggerDisplay,nq}")]
                public readonly partial struct RequiredAppVariantIdAndLayerAndVersion
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(RequiredAppVariantIdAndLayerAndVersion instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="RequiredAppVariantIdAndLayerAndVersion"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator RequiredAppVariantIdAndLayerAndVersion(Mutable instance)
                        {
                        ...
                        /// <summary>
                        /// Gets the <c>appVariantId</c> property.
                        /// </summary>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable AppVariantId
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AppVariantIdUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable Layer
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LayerUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable Version
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.VersionUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable value))
                                {
                                    return value;
                                }
                        ...
                        {
                            return
                                (obj is IJsonElement value && Equals(new RequiredAppVariantIdAndLayerAndVersion(value.ParentDocument, value.ParentDocumentIndex))) ||
                        ...
                        public void SetAppVariantId(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source value)
                        {
                            CheckValidInstance();

                            if (value.IsUndefined)
                            {
                                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("appVariantId");
                            }
                            ...
                            else
                            {
                                ...
                                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.AppVariantId, ref cvb);
                        ...
                        /// <summary>
                        /// Set the <c>layer</c> property.
                        /// </summary>
                        /// <param name="value">The value of the property to add.</param>
                        public void SetLayer(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source value)
                        {
                            CheckValidInstance();

                            if (value.IsUndefined)
                            {
                                CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("layer");
                            }

                            ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LayerUtf8, out IJsonDocument? elementParent, out int elementIdx))
                            {
                                // We are going to replace just the value
                                value.AddAsItem(ref cvb);
                                _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                            ...
                            {
                                // We are going to insert the new value
                                value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Layer, ref cvb);
                                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                            }
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"RequiredAppVariantIdAndLayerAndVersion.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// <summary>
                        /// Gets a <see cref="RequiredAppVariantIdAndLayerAndVersion"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </summary>
                        /// <returns>
                        /// A <see cref="RequiredAppVariantIdAndLayerAndVersion"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </returns>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RequiredAppVariantIdAndLayerAndVersion Clone()
                        {
                            CheckValidInstance();
                            return _parent.CloneElement<RequiredAppVariantIdAndLayerAndVersion>(_idx);
                        }
                        ...
                        /// </summary>
                        /// <returns>
                        /// An immutable <see cref="RequiredAppVariantIdAndLayerAndVersion"/> that lives for the lifetime of its
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly RequiredAppVariantIdAndLayerAndVersion Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<RequiredAppVariantIdAndLayerAndVersion>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapUi5Namespace.RequiredContentDensitiesAndDependencies.RequiredAppVariantIdAndLayerAndVersionArray.RequiredAppVariantIdAndLayerAndVersion.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                        ...
                        public static implicit operator Source(RequiredAppVariantIdAndLayerAndVersion instance) => new(JsonElement.From(instance));
                        ...
                        #endif
                    {
                        ...
                        internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapUi5Namespace.RequiredContentDensitiesAndDependencies.RequiredAppVariantIdAndLayerAndVersionArray.RequiredAppVariantIdAndLayerAndVersion.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    public ref struct Builder
                    {
                        ...
                        /// <summary>
                        /// Creates an instance of a <see cref="RequiredAppVariantIdAndLayerAndVersion"/>.
                        /// </summary>
                        internal static void Create(
                            ref ComplexValueBuilder builder,
                            in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source appVariantId,
                            in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source layer,
                            in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source version)
                        {
                            appVariantId.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.AppVariantId, ref builder);
                            layer.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Layer, ref builder);
                        ...
                        public void Create(
                            ...
                            in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source version)
                        {
                            Create(ref _builder, appVariantId, layer, version);
                        }
                    ...
                    /// <param name="layer">The value of the <c>"layer"</c> property.</param>
                    /// <param name="version">The value of the <c>"version"</c> property.</param>
                    /// <returns>The source from which to build the value.</returns>
                    public static Source Build(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source appVariantId, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source layer, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source version)
                    {
                        return new Source(appVariantId, layer, version);
                    }
                    ...
                    /// <param name="layer">The value of the property.</param>
                    /// <param name="version">The value of the property.</param>
                    /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                    /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                    public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source appVariantId, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source layer, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source version, int initialCapacity = 30)
                    {
                        JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                        ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                        cvb.StartObject();
                        Builder ovb = new(cvb);
                        ovb.Create(appVariantId, layer, version);
                        cvb = ovb._builder;
                        cvb.EndObject();
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder;
                    ...
                    {
                        return workspace.CreateBuilder<RequiredAppVariantIdAndLayerAndVersion, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<RequiredAppVariantIdAndLayerAndVersion> Create(
                        scoped in Source value, int initialCapacity = 30)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<RequiredAppVariantIdAndLayerAndVersion>();
                        }
                        finally
                        {
                    ...
                    /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                    /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                    public static ParsedJsonDocument<RequiredAppVariantIdAndLayerAndVersion> Create<TContext>(
                    ...
                    public static ParsedJsonDocument<RequiredAppVariantIdAndLayerAndVersion> Create(in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source appVariantId, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source layer, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source version, int initialCapacity = 30)
                    {
                        ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                        try
                        {
