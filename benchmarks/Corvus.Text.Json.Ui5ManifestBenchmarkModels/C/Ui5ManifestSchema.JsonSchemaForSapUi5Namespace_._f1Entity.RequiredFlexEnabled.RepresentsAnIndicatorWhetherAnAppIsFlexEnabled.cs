    ...
    public readonly partial struct JsonSchemaForSapUi5Namespace
    {
        ...
        public readonly partial struct AllOf1Entity
        {
            ...
            public readonly partial struct RequiredFlexEnabled
            {
                ...
                public readonly partial struct RepresentsAnIndicatorWhetherAnAppIsFlexEnabled
#if NET8_0_OR_GREATER
                    : IJsonElement<RepresentsAnIndicatorWhetherAnAppIsFlexEnabled>,
                      IFormattable,
                      ISpanFormattable,
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="RepresentsAnIndicatorWhetherAnAppIsFlexEnabled"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal RepresentsAnIndicatorWhetherAnAppIsFlexEnabled(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static RepresentsAnIndicatorWhetherAnAppIsFlexEnabled DefaultInstance { get; }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator bool(RepresentsAnIndicatorWhetherAnAppIsFlexEnabled value)
                    {
                    ...
                    /// </returns>
                    public static bool operator ==(in RepresentsAnIndicatorWhetherAnAppIsFlexEnabled left, in RepresentsAnIndicatorWhetherAnAppIsFlexEnabled right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in RepresentsAnIndicatorWhetherAnAppIsFlexEnabled left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator JsonElement(RepresentsAnIndicatorWhetherAnAppIsFlexEnabled instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RepresentsAnIndicatorWhetherAnAppIsFlexEnabled(JsonElement instance)
                    {
                        return RepresentsAnIndicatorWhetherAnAppIsFlexEnabled.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RepresentsAnIndicatorWhetherAnAppIsFlexEnabled From<T>(in T instance)
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RepresentsAnIndicatorWhetherAnAppIsFlexEnabled ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        #pragma warning disable CS0618 // Type or member is obsolete
                        return JsonElementHelpers.ParseValue<RepresentsAnIndicatorWhetherAnAppIsFlexEnabled>(utf8Json, options);
                    ...
                    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RepresentsAnIndicatorWhetherAnAppIsFlexEnabled ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        #pragma warning disable CS0618 // Type or member is obsolete
                        return JsonElementHelpers.ParseValue<RepresentsAnIndicatorWhetherAnAppIsFlexEnabled>(json, options);
                        #pragma warning restore CS0618
                    }
                    ...
                    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RepresentsAnIndicatorWhetherAnAppIsFlexEnabled ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        #pragma warning disable CS0618 // Type or member is obsolete
                        return JsonElementHelpers.ParseValue<RepresentsAnIndicatorWhetherAnAppIsFlexEnabled>(json, options);
                        #pragma warning restore CS0618
                    ...
                    /// </exception>
                    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                    public static RepresentsAnIndicatorWhetherAnAppIsFlexEnabled ParseValue(ref Utf8JsonReader reader)
                    {
                        #pragma warning disable CS0618 // Type or member is obsolete
                        return JsonElementHelpers.ParseValue<RepresentsAnIndicatorWhetherAnAppIsFlexEnabled>(ref reader);
                        #pragma warning restore CS0618
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsAnIndicatorWhetherAnAppIsFlexEnabled? result)
                    {
                        return JsonElementHelpers.TryParseValue<RepresentsAnIndicatorWhetherAnAppIsFlexEnabled>(ref reader, out result);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new RepresentsAnIndicatorWhetherAnAppIsFlexEnabled(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                    static RepresentsAnIndicatorWhetherAnAppIsFlexEnabled IJsonElement<RepresentsAnIndicatorWhetherAnAppIsFlexEnabled>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RepresentsAnIndicatorWhetherAnAppIsFlexEnabled: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="RepresentsAnIndicatorWhetherAnAppIsFlexEnabled"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="RepresentsAnIndicatorWhetherAnAppIsFlexEnabled"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public RepresentsAnIndicatorWhetherAnAppIsFlexEnabled Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<RepresentsAnIndicatorWhetherAnAppIsFlexEnabled>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="RepresentsAnIndicatorWhetherAnAppIsFlexEnabled"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public RepresentsAnIndicatorWhetherAnAppIsFlexEnabled Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<RepresentsAnIndicatorWhetherAnAppIsFlexEnabled>(_idx);
                        }
