        ...
        public readonly partial struct RequiredContentDensitiesAndDependencies
        {
            ...
            public readonly partial struct FlexExtensionPointEnabledEntity
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<FlexExtensionPointEnabledEntity, Mutable>(FlexExtensionPointEnabledEntity.DefaultInstance);
                    ...
                    public static explicit operator Mutable(FlexExtensionPointEnabledEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="FlexExtensionPointEnabledEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator FlexExtensionPointEnabledEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"FlexExtensionPointEnabledEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly FlexExtensionPointEnabledEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly FlexExtensionPointEnabledEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<FlexExtensionPointEnabledEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(FlexExtensionPointEnabledEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<FlexExtensionPointEnabledEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<FlexExtensionPointEnabledEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<FlexExtensionPointEnabledEntity>();
                    }
                    finally
                    {
