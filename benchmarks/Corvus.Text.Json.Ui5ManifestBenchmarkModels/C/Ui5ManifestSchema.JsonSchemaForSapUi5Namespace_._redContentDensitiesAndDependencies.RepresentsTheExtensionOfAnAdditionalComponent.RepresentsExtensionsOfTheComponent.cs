        ...
        public readonly partial struct RequiredContentDensitiesAndDependencies
        {
            ...
            public readonly partial struct RepresentsTheExtensionOfAnAdditionalComponent
            {
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="RepresentsExtensionsOfTheComponent"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal RepresentsExtensionsOfTheComponent(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static RepresentsExtensionsOfTheComponent DefaultInstance { get; }
                    ...
                    /// </returns>
                    public static bool operator ==(in RepresentsExtensionsOfTheComponent left, in RepresentsExtensionsOfTheComponent right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in RepresentsExtensionsOfTheComponent left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    public static implicit operator JsonElement(RepresentsExtensionsOfTheComponent instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RepresentsExtensionsOfTheComponent(JsonElement instance)
                    {
                        return RepresentsExtensionsOfTheComponent.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RepresentsExtensionsOfTheComponent From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RepresentsExtensionsOfTheComponent ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RepresentsExtensionsOfTheComponent>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RepresentsExtensionsOfTheComponent ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RepresentsExtensionsOfTheComponent>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RepresentsExtensionsOfTheComponent ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RepresentsExtensionsOfTheComponent>(json, options);
                    }
                    ...
                    /// </exception>
                    public static RepresentsExtensionsOfTheComponent ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<RepresentsExtensionsOfTheComponent>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsExtensionsOfTheComponent? result)
                    {
                        return JsonElementHelpers.TryParseValue<RepresentsExtensionsOfTheComponent>(ref reader, out result);
                    }
...
#if NET
                    static RepresentsExtensionsOfTheComponent IJsonElement<RepresentsExtensionsOfTheComponent>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RepresentsExtensionsOfTheComponent: ValueKind = {ValueKind} : \"{ToString()}\"";
