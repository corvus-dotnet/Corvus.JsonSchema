...
public readonly partial struct Ui5ManifestSchema
{
        ...
        : IJsonElement<JsonSchemaForSapUiGenericAppNamespace>
    {
        public static partial class JsonSchema
        {
            ...
            private static void MatchPages(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/properties/sap.ui.generic.app"u8, buffer, out written);
