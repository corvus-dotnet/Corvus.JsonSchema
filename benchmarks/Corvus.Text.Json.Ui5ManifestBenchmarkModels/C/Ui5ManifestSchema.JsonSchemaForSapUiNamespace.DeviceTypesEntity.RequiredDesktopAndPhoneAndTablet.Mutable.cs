        ...
        public readonly partial struct DeviceTypesEntity
        {
            ...
            public readonly partial struct RequiredDesktopAndPhoneAndTablet
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(RequiredDesktopAndPhoneAndTablet instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="RequiredDesktopAndPhoneAndTablet"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RequiredDesktopAndPhoneAndTablet(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new RequiredDesktopAndPhoneAndTablet(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RequiredDesktopAndPhoneAndTablet.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="RequiredDesktopAndPhoneAndTablet"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="RequiredDesktopAndPhoneAndTablet"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RequiredDesktopAndPhoneAndTablet Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<RequiredDesktopAndPhoneAndTablet>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="RequiredDesktopAndPhoneAndTablet"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RequiredDesktopAndPhoneAndTablet Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<RequiredDesktopAndPhoneAndTablet>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapUiNamespace.DeviceTypesEntity.RequiredDesktopAndPhoneAndTablet.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    public static implicit operator Source(RequiredDesktopAndPhoneAndTablet instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapUiNamespace.DeviceTypesEntity.RequiredDesktopAndPhoneAndTablet.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// <summary>
                    /// Creates an instance of a <see cref="RequiredDesktopAndPhoneAndTablet"/>.
                    /// </summary>
                ...
                public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Text.Json.JsonElement.Source<TContext> desktop, scoped in Corvus.Text.Json.JsonElement.Source<TContext> phone, scoped in Corvus.Text.Json.JsonElement.Source<TContext> tablet)
                    ...
                    #endif
                {
                    return new Source<TContext>(context, desktop, phone, tablet);
                }
                ...
                {
                    return workspace.CreateBuilder<RequiredDesktopAndPhoneAndTablet, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<RequiredDesktopAndPhoneAndTablet> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<RequiredDesktopAndPhoneAndTablet>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<RequiredDesktopAndPhoneAndTablet> Create<TContext>(
                ...
                public static ParsedJsonDocument<RequiredDesktopAndPhoneAndTablet> Create(in Corvus.Text.Json.JsonElement.Source desktop, in Corvus.Text.Json.JsonElement.Source phone, in Corvus.Text.Json.JsonElement.Source tablet, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
                public static ParsedJsonDocument<RequiredDesktopAndPhoneAndTablet> Create<TContext>(in TContext context, in Corvus.Text.Json.JsonElement.Source<TContext> desktop, in Corvus.Text.Json.JsonElement.Source<TContext> phone, in Corvus.Text.Json.JsonElement.Source<TContext> tablet, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
