    ...
    public readonly partial struct JsonSchemaForSapUiNamespace
    {
        ...
        public readonly partial struct RepresentsIconsWhichUsedInApplication
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RepresentsIconsWhichUsedInApplication instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsIconsWhichUsedInApplication"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsIconsWhichUsedInApplication(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable FavIcon
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FavIconUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable Phone
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PhoneUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable Phone2
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.Phone2Utf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable Tablet
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TabletUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable Tablet2
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.Tablet2Utf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetFavIcon(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source value)
                {
                    ...
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.FavIconUtf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FavIconUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                    ...
                    else
                    {
                        ...
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.FavIcon, ref cvb);
                ...
                /// <summary>
                /// Remove the <c>favIcon</c> property, if present.
                /// </summary>
                ...
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.FavIconUtf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                public void SetPhone2(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source value)
                {
                    ...
                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.Phone2Utf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.Phone2Utf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Phone2, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                /// <summary>
                /// Remove the <c>phone@2</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemovePhone2()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.Phone2Utf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                public void SetTablet2(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source value)
                {
                    ...
                    if (value.IsUndefined)
                    {
                        JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.Tablet2Utf8);
                        _documentVersion = _parent.Version;
                        return;
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.Tablet2Utf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Tablet2, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                /// <summary>
                /// Remove the <c>tablet@2</c> property, if present.
                /// </summary>
                /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
                public bool RemoveTablet2()
                {
                    CheckValidInstance();
                    bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.Tablet2Utf8);
                    _documentVersion = _parent.Version;
                    return result;
                }
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsIconsWhichUsedInApplication.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsIconsWhichUsedInApplication Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsIconsWhichUsedInApplication Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsIconsWhichUsedInApplication>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsIconsWhichUsedInApplication instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapUiNamespace.RepresentsIconsWhichUsedInApplication.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="RepresentsIconsWhichUsedInApplication"/>.
                /// </summary>
                internal static void Create(
                    ref ComplexValueBuilder builder,
                    in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source favIcon = default,
                    in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source icon = default,
                    in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source phone = default,
                    in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source phone2 = default,
                    in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source tablet = default,
                    in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source tablet2 = default)
                {
                    favIcon.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.FavIcon, ref builder);
                    ...
                    phone2.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Phone2, ref builder);
                    tablet.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Tablet, ref builder);
                    tablet2.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Tablet2, ref builder);
                }
                ...
                public void Create(
                    ...
                    in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source tablet2 = default)
                {
                    Create(ref _builder, favIcon, icon, phone, phone2, tablet, tablet2);
                }
            ...
            /// </summary>
            /// <param name="favIcon">The value of the <c>"favIcon"</c> property.</param>
            /// <param name="icon">The value of the <c>"icon"</c> property.</param>
            /// <param name="phone">The value of the <c>"phone"</c> property.</param>
            /// <param name="phone2">The value of the <c>"phone@2"</c> property.</param>
            ...
            /// </summary>
            /// <param name="workspace">The JSON workspace.</param>
            /// <param name="favIcon">The value of the property.</param>
            /// <param name="icon">The value of the property.</param>
            /// <param name="phone">The value of the property.</param>
            /// <param name="phone2">The value of the property.</param>
            /// <param name="tablet">The value of the property.</param>
            /// <param name="tablet2">The value of the property.</param>
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source favIcon = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source icon = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source phone = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source phone2 = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source tablet = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source tablet2 = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(favIcon, icon, phone, phone2, tablet, tablet2);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<RepresentsIconsWhichUsedInApplication, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RepresentsIconsWhichUsedInApplication> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RepresentsIconsWhichUsedInApplication>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RepresentsIconsWhichUsedInApplication> Create<TContext>(
            ...
            public static ParsedJsonDocument<RepresentsIconsWhichUsedInApplication> Create(in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source favIcon = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source icon = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source phone = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source phone2 = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source tablet = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source tablet2 = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
