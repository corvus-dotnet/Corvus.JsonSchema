    ...
    public readonly partial struct JsonSchemaForSapUiNamespace
    {
        ...
        public readonly partial struct TechnologyEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<TechnologyEntity, Mutable>(TechnologyEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(TechnologyEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TechnologyEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TechnologyEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TechnologyEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly TechnologyEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly TechnologyEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TechnologyEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(TechnologyEntity instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (TechnologyEntity)value;
            ...
            {
                return workspace.CreateBuilder<TechnologyEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<TechnologyEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TechnologyEntity>();
                }
                finally
                {
