...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapUiNamespace
    {
...
#endif
        {
            ...
            /// <summary>
            /// Gets a <see cref="TechnologyEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="TechnologyEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public TechnologyEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<TechnologyEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="TechnologyEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public TechnologyEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<TechnologyEntity>(_idx);
                }
