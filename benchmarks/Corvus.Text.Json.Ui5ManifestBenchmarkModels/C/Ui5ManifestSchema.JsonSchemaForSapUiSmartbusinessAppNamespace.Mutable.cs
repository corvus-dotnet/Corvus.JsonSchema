...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapUiSmartbusinessAppNamespace
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(JsonSchemaForSapUiSmartbusinessAppNamespace instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="JsonSchemaForSapUiSmartbusinessAppNamespace"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonSchemaForSapUiSmartbusinessAppNamespace(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"JsonSchemaForSapUiSmartbusinessAppNamespace.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly JsonSchemaForSapUiSmartbusinessAppNamespace Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly JsonSchemaForSapUiSmartbusinessAppNamespace Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<JsonSchemaForSapUiSmartbusinessAppNamespace>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapUiSmartbusinessAppNamespace.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(JsonSchemaForSapUiSmartbusinessAppNamespace instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapUiSmartbusinessAppNamespace.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<JsonSchemaForSapUiSmartbusinessAppNamespace, Mutable>(this);
        }
    }
}
