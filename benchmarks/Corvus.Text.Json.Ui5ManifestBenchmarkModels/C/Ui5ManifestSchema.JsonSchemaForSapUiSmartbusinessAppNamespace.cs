...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapUiSmartbusinessAppNamespace
#if NET8_0_OR_GREATER
        : IJsonElement<JsonSchemaForSapUiSmartbusinessAppNamespace>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="JsonSchemaForSapUiSmartbusinessAppNamespace"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal JsonSchemaForSapUiSmartbusinessAppNamespace(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static JsonSchemaForSapUiSmartbusinessAppNamespace DefaultInstance { get; }
        ...
        /// </returns>
        public static bool operator ==(in JsonSchemaForSapUiSmartbusinessAppNamespace left, in JsonSchemaForSapUiSmartbusinessAppNamespace right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in JsonSchemaForSapUiSmartbusinessAppNamespace left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(JsonSchemaForSapUiSmartbusinessAppNamespace instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonSchemaForSapUiSmartbusinessAppNamespace(JsonElement instance)
        {
            return JsonSchemaForSapUiSmartbusinessAppNamespace.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static JsonSchemaForSapUiSmartbusinessAppNamespace From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static JsonSchemaForSapUiSmartbusinessAppNamespace ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<JsonSchemaForSapUiSmartbusinessAppNamespace>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static JsonSchemaForSapUiSmartbusinessAppNamespace ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<JsonSchemaForSapUiSmartbusinessAppNamespace>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static JsonSchemaForSapUiSmartbusinessAppNamespace ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<JsonSchemaForSapUiSmartbusinessAppNamespace>(json, options);
        }
        ...
        /// </exception>
        public static JsonSchemaForSapUiSmartbusinessAppNamespace ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<JsonSchemaForSapUiSmartbusinessAppNamespace>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out JsonSchemaForSapUiSmartbusinessAppNamespace? result)
        {
            return JsonElementHelpers.TryParseValue<JsonSchemaForSapUiSmartbusinessAppNamespace>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new JsonSchemaForSapUiSmartbusinessAppNamespace(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static JsonSchemaForSapUiSmartbusinessAppNamespace IJsonElement<JsonSchemaForSapUiSmartbusinessAppNamespace>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"JsonSchemaForSapUiSmartbusinessAppNamespace: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="JsonSchemaForSapUiSmartbusinessAppNamespace"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="JsonSchemaForSapUiSmartbusinessAppNamespace"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public JsonSchemaForSapUiSmartbusinessAppNamespace Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<JsonSchemaForSapUiSmartbusinessAppNamespace>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="JsonSchemaForSapUiSmartbusinessAppNamespace"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public JsonSchemaForSapUiSmartbusinessAppNamespace Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<JsonSchemaForSapUiSmartbusinessAppNamespace>(_idx);
            }
