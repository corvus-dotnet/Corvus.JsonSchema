...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapWcfNamespace
    {
        ...
        public readonly partial struct RepresentsTheTargetTechnicalIdForAWcfApplication
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RepresentsTheTargetTechnicalIdForAWcfApplication instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsTheTargetTechnicalIdForAWcfApplication"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsTheTargetTechnicalIdForAWcfApplication(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new RepresentsTheTargetTechnicalIdForAWcfApplication(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsTheTargetTechnicalIdForAWcfApplication.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="RepresentsTheTargetTechnicalIdForAWcfApplication"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="RepresentsTheTargetTechnicalIdForAWcfApplication"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheTargetTechnicalIdForAWcfApplication Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<RepresentsTheTargetTechnicalIdForAWcfApplication>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="RepresentsTheTargetTechnicalIdForAWcfApplication"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheTargetTechnicalIdForAWcfApplication Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsTheTargetTechnicalIdForAWcfApplication>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsTheTargetTechnicalIdForAWcfApplication instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RepresentsTheTargetTechnicalIdForAWcfApplication, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RepresentsTheTargetTechnicalIdForAWcfApplication> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RepresentsTheTargetTechnicalIdForAWcfApplication>();
                }
                finally
                {
