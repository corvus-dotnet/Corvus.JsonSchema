    ...
    public readonly partial struct JsonSchemaForSapWdaNamespace
    {
        ...
        public readonly partial struct CompatibilityModeEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<CompatibilityModeEntity, Mutable>(CompatibilityModeEntity.DefaultInstance);
            ...
            public static ParsedJsonDocument<CompatibilityModeEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<CompatibilityModeEntity>();
                }
                finally
                {
