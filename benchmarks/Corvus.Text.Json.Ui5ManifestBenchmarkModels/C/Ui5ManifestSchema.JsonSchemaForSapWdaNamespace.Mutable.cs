    ...
    public readonly partial struct JsonSchemaForSapWdaNamespace
    {
...
#endif
        {
            ...
            public void SetCompatibilityMode(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapWdaNamespace.CompatibilityModeEntity.Source value)
            {
                ...
                {
                    // We are going to insert the new value
                    value.AddAsProperty(JsonPropertyNamesEscaped.CompatibilityMode, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            public void SetConfigId(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapWdaNamespace.RepresentsIdOfAnApplicationConfiguration.Source value)
            {
                ...
                {
                    // We are going to insert the new value
                    value.AddAsProperty(JsonPropertyNamesEscaped.ConfigId, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            public void SetFlavorId(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapWdaNamespace.RepresentsSapScreenPersonasFlavorId.Source value)
            {
                ...
                {
                    // We are going to insert the new value
                    value.AddAsProperty(JsonPropertyNamesEscaped.FlavorId, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
        ...
        public ref struct Builder
        {
                ...
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.JsonSchemaForSapWdaNamespace.RepresentsSapScreenPersonasFlavorId.Source flavorId = default)
            {
                ...
                compatibilityMode.AddAsProperty(JsonPropertyNamesEscaped.CompatibilityMode, ref builder, escapeName: false);
                configId.AddAsProperty(JsonPropertyNamesEscaped.ConfigId, ref builder, escapeName: false);
                flavorId.AddAsProperty(JsonPropertyNamesEscaped.FlavorId, ref builder, escapeName: false);
            }
