    ...
    public readonly partial struct JsonSchemaForSapWdaNamespace
    {
        ...
        public readonly partial struct RepresentsIdOfAnApplicationConfiguration
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RepresentsIdOfAnApplicationConfiguration instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsIdOfAnApplicationConfiguration"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsIdOfAnApplicationConfiguration(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsIdOfAnApplicationConfiguration.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsIdOfAnApplicationConfiguration Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsIdOfAnApplicationConfiguration Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsIdOfAnApplicationConfiguration>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsIdOfAnApplicationConfiguration instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RepresentsIdOfAnApplicationConfiguration, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RepresentsIdOfAnApplicationConfiguration> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RepresentsIdOfAnApplicationConfiguration>();
                }
                finally
                {
