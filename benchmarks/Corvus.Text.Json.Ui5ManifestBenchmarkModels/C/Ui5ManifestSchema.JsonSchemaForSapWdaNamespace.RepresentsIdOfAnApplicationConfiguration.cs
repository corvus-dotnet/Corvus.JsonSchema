...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct JsonSchemaForSapWdaNamespace
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RepresentsIdOfAnApplicationConfiguration"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RepresentsIdOfAnApplicationConfiguration(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RepresentsIdOfAnApplicationConfiguration DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(RepresentsIdOfAnApplicationConfiguration value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in RepresentsIdOfAnApplicationConfiguration left, in RepresentsIdOfAnApplicationConfiguration right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RepresentsIdOfAnApplicationConfiguration left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(RepresentsIdOfAnApplicationConfiguration instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RepresentsIdOfAnApplicationConfiguration(JsonElement instance)
            {
                return RepresentsIdOfAnApplicationConfiguration.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsIdOfAnApplicationConfiguration From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsIdOfAnApplicationConfiguration ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsIdOfAnApplicationConfiguration>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsIdOfAnApplicationConfiguration ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsIdOfAnApplicationConfiguration>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsIdOfAnApplicationConfiguration ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsIdOfAnApplicationConfiguration>(json, options);
            }
            ...
            /// </exception>
            public static RepresentsIdOfAnApplicationConfiguration ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RepresentsIdOfAnApplicationConfiguration>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsIdOfAnApplicationConfiguration? result)
            {
                return JsonElementHelpers.TryParseValue<RepresentsIdOfAnApplicationConfiguration>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RepresentsIdOfAnApplicationConfiguration(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static RepresentsIdOfAnApplicationConfiguration IJsonElement<RepresentsIdOfAnApplicationConfiguration>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RepresentsIdOfAnApplicationConfiguration: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RepresentsIdOfAnApplicationConfiguration"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RepresentsIdOfAnApplicationConfiguration"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public RepresentsIdOfAnApplicationConfiguration Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RepresentsIdOfAnApplicationConfiguration>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RepresentsIdOfAnApplicationConfiguration"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public RepresentsIdOfAnApplicationConfiguration Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RepresentsIdOfAnApplicationConfiguration>(_idx);
                }
