    ...
    public readonly partial struct Lib
    {
        ...
        public readonly partial struct RepresentsIndicatorToLazyLoadingLib
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<RepresentsIndicatorToLazyLoadingLib, Mutable>(RepresentsIndicatorToLazyLoadingLib.DefaultInstance);
                ...
                public static explicit operator Mutable(RepresentsIndicatorToLazyLoadingLib instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsIndicatorToLazyLoadingLib"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsIndicatorToLazyLoadingLib(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsIndicatorToLazyLoadingLib.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsIndicatorToLazyLoadingLib Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsIndicatorToLazyLoadingLib Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsIndicatorToLazyLoadingLib>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsIndicatorToLazyLoadingLib instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RepresentsIndicatorToLazyLoadingLib, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RepresentsIndicatorToLazyLoadingLib> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RepresentsIndicatorToLazyLoadingLib>();
                }
                finally
                {
