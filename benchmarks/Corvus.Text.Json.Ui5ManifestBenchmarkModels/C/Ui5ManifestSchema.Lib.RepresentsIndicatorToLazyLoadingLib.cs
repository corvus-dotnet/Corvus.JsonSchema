...
public readonly partial struct Ui5ManifestSchema
{
    ...
    /// </para>
    /// </remarks>
    public readonly partial struct Lib
    {
        /// <summary>
        /// Generated from JSON Schema.
        /// </summary>
        ...
        public readonly partial struct RepresentsIndicatorToLazyLoadingLib
#if NET8_0_OR_GREATER
            : IJsonElement<RepresentsIndicatorToLazyLoadingLib>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RepresentsIndicatorToLazyLoadingLib"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RepresentsIndicatorToLazyLoadingLib(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RepresentsIndicatorToLazyLoadingLib DefaultInstance { get; } = ParsedJsonDocument<RepresentsIndicatorToLazyLoadingLib>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(RepresentsIndicatorToLazyLoadingLib value)
            {
            ...
            /// </returns>
            public static bool operator ==(in RepresentsIndicatorToLazyLoadingLib left, in RepresentsIndicatorToLazyLoadingLib right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RepresentsIndicatorToLazyLoadingLib left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(RepresentsIndicatorToLazyLoadingLib instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RepresentsIndicatorToLazyLoadingLib(JsonElement instance)
            {
                return RepresentsIndicatorToLazyLoadingLib.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsIndicatorToLazyLoadingLib From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsIndicatorToLazyLoadingLib ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsIndicatorToLazyLoadingLib>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsIndicatorToLazyLoadingLib ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsIndicatorToLazyLoadingLib>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsIndicatorToLazyLoadingLib ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsIndicatorToLazyLoadingLib>(json, options);
            }
            ...
            /// </exception>
            public static RepresentsIndicatorToLazyLoadingLib ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RepresentsIndicatorToLazyLoadingLib>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsIndicatorToLazyLoadingLib? result)
            {
                return JsonElementHelpers.TryParseValue<RepresentsIndicatorToLazyLoadingLib>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RepresentsIndicatorToLazyLoadingLib(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static RepresentsIndicatorToLazyLoadingLib IJsonElement<RepresentsIndicatorToLazyLoadingLib>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RepresentsIndicatorToLazyLoadingLib: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RepresentsIndicatorToLazyLoadingLib"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RepresentsIndicatorToLazyLoadingLib"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public RepresentsIndicatorToLazyLoadingLib Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RepresentsIndicatorToLazyLoadingLib>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RepresentsIndicatorToLazyLoadingLib"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public RepresentsIndicatorToLazyLoadingLib Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RepresentsIndicatorToLazyLoadingLib>(_idx);
                }
