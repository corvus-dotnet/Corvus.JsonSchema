...
public readonly partial struct Ui5ManifestSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Microchart"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal Microchart(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static Microchart DefaultInstance { get; }
        ...
        public static explicit operator Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartBullet(Microchart value)
        {
            return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartBullet.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Microchart(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartBullet value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartStackedBar(Microchart value)
        {
            return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartStackedBar.From(value);
        }
        ...
        /// </returns>
        public static bool operator ==(in Microchart left, in Microchart right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Microchart left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(Microchart instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Microchart(JsonElement instance)
        {
            return Microchart.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Microchart From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Microchart ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Microchart>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Microchart ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Microchart>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Microchart ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Microchart>(json, options);
        }
        ...
        /// </exception>
        public static Microchart ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<Microchart>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Microchart? result)
        {
            return JsonElementHelpers.TryParseValue<Microchart>(ref reader, out result);
        }
...
#if NET
        static Microchart IJsonElement<Microchart>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Microchart: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public bool TryGetAsMicrochartBullet(out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartBullet result)
        {
            ...
            {
                result = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartBullet.From(this);
                return true;
            }
        ...
        public bool TryGetAsMicrochartStackedBar(out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartStackedBar result)
        {
            ...
            {
                result = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartStackedBar.From(this);
                return true;
            }
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Microchart, TContext, TResult> defaultMatch)
...
#endif
        {
            if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartBullet.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchMicrochartBullet(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartBullet.From(this), context);
            }

            if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartStackedBar.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchMicrochartStackedBar(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartStackedBar.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Microchart, TResult> defaultMatch)
        {
            if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartBullet.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchMicrochartBullet(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartBullet.From(this));
            }

            if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartStackedBar.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchMicrochartStackedBar(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartStackedBar.From(this));
            }
