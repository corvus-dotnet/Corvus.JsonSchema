...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct MicrochartBullet
    {
...
#endif
        {
            ...
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartBulletThreshold this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartBulletThreshold>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartBulletThreshold> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartBulletThreshold>(_parent, _idx);
            }
