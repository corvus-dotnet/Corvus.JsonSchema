    ...
    public readonly partial struct MicrochartBullet
    {
        ...
        public readonly partial struct TheActualValueShownAsAColoredHorizontalBar
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(TheActualValueShownAsAColoredHorizontalBar instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TheActualValueShownAsAColoredHorizontalBar"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TheActualValueShownAsAColoredHorizontalBar(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TheActualValueShownAsAColoredHorizontalBar.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly TheActualValueShownAsAColoredHorizontalBar Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly TheActualValueShownAsAColoredHorizontalBar Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TheActualValueShownAsAColoredHorizontalBar>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartBullet.TheActualValueShownAsAColoredHorizontalBar.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartBullet.TheActualValueShownAsAColoredHorizontalBar.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(TheActualValueShownAsAColoredHorizontalBar instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<TheActualValueShownAsAColoredHorizontalBar, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<TheActualValueShownAsAColoredHorizontalBar> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TheActualValueShownAsAColoredHorizontalBar>();
                }
                finally
                {
