...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct MicrochartBullet
    {
        ...
        public readonly partial struct TheStateColorOfTheBar
        {
...
#endif
            {
                ...
                public static explicit operator Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnumsValueColor.Mutable(Mutable value)
                {
                    return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnumsValueColor.Mutable.From(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnumsValueColor.Mutable value)
                {
                    return From(value);
                }
                ...
                public static explicit operator Mutable(TheStateColorOfTheBar instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TheStateColorOfTheBar"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TheStateColorOfTheBar(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new TheStateColorOfTheBar(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TheStateColorOfTheBar.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="TheStateColorOfTheBar"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="TheStateColorOfTheBar"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly TheStateColorOfTheBar Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<TheStateColorOfTheBar>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="TheStateColorOfTheBar"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly TheStateColorOfTheBar Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TheStateColorOfTheBar>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartBullet.TheStateColorOfTheBar.Mutable, TContext, TResult> defaultMatch)
...
#endif
                {
                    ...
                    {
                        return matchEnumsValueColor(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnumsValueColor.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartBullet.TheStateColorOfTheBar.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnumsValueColor.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchEnumsValueColor(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnumsValueColor.Mutable.From(this));
                    }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnumsValueColor.Mutable" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsEnumsValueColor(out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnumsValueColor.Mutable result)
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnumsValueColor.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnumsValueColor.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(TheStateColorOfTheBar instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnumsValueColor instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<TheStateColorOfTheBar, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<TheStateColorOfTheBar> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TheStateColorOfTheBar>();
                }
                finally
                {
