        ...
        public readonly partial struct TheTargetValueDisplayedAsAVerticalLineMarker
        {
...
#endif
            {
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartBullet.TheTargetValueDisplayedAsAVerticalLineMarker.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartBullet.TheTargetValueDisplayedAsAVerticalLineMarker.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.JsonNumber.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public static ParsedJsonDocument<TheTargetValueDisplayedAsAVerticalLineMarker> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TheTargetValueDisplayedAsAVerticalLineMarker>();
                }
                finally
                {
