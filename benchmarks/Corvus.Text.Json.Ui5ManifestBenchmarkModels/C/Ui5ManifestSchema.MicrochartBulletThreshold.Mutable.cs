...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct MicrochartBulletThreshold
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(MicrochartBulletThreshold instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="MicrochartBulletThreshold"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MicrochartBulletThreshold(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartBulletThreshold.TheStateColorOfTheThreshold.Mutable Color
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ColorUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartBulletThreshold.TheStateColorOfTheThreshold.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartBulletThreshold.TheValueOfTheThreshold.Mutable Value
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ValueUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartBulletThreshold.TheValueOfTheThreshold.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new MicrochartBulletThreshold(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MicrochartBulletThreshold.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="MicrochartBulletThreshold"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="MicrochartBulletThreshold"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly MicrochartBulletThreshold Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<MicrochartBulletThreshold>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="MicrochartBulletThreshold"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly MicrochartBulletThreshold Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<MicrochartBulletThreshold>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartBulletThreshold.TheStateColorOfTheThreshold.Source _createArg1;
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartBulletThreshold.TheValueOfTheThreshold.Source _createArg2;
            ...
            public static implicit operator Source(MicrochartBulletThreshold instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartBulletThreshold.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="MicrochartBulletThreshold"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartBulletThreshold.TheStateColorOfTheThreshold.Source color = default,
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartBulletThreshold.TheValueOfTheThreshold.Source value = default)
            {
            ...
            /// Creates an instance of a <see cref="MicrochartBulletThreshold"/>.
            /// </summary>
            public void Create(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartBulletThreshold.TheStateColorOfTheThreshold.Source color = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartBulletThreshold.TheValueOfTheThreshold.Source value = default)
            {
                Create(ref _builder, color, value);
            }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartBulletThreshold.TheStateColorOfTheThreshold.Source color = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartBulletThreshold.TheValueOfTheThreshold.Source value = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(color, value);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<MicrochartBulletThreshold, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<MicrochartBulletThreshold> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<MicrochartBulletThreshold>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<MicrochartBulletThreshold> Create<TContext>(
        ...
        public static ParsedJsonDocument<MicrochartBulletThreshold> Create(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartBulletThreshold.TheStateColorOfTheThreshold.Source color = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartBulletThreshold.TheValueOfTheThreshold.Source value = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
