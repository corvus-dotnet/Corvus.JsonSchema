    ...
    public readonly partial struct MicrochartBulletThreshold
    {
        ...
        public readonly partial struct TheStateColorOfTheThreshold
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(TheStateColorOfTheThreshold instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TheStateColorOfTheThreshold"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TheStateColorOfTheThreshold(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TheStateColorOfTheThreshold.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly TheStateColorOfTheThreshold Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly TheStateColorOfTheThreshold Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TheStateColorOfTheThreshold>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartBulletThreshold.TheStateColorOfTheThreshold.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartBulletThreshold.TheStateColorOfTheThreshold.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnumsValueColor.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(TheStateColorOfTheThreshold instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<TheStateColorOfTheThreshold, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<TheStateColorOfTheThreshold> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TheStateColorOfTheThreshold>();
                }
                finally
                {
