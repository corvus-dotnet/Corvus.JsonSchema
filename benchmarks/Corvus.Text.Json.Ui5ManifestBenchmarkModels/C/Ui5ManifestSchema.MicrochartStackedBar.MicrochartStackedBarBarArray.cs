...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct MicrochartStackedBar
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="MicrochartStackedBarBarArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal MicrochartStackedBarBarArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static MicrochartStackedBarBarArray DefaultInstance { get; }
            ...
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartStackedBarBar this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartStackedBarBar>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartStackedBarBar> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartStackedBarBar>(_parent, _idx);
            }
            ...
            /// </returns>
            public static bool operator ==(in MicrochartStackedBarBarArray left, in MicrochartStackedBarBarArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in MicrochartStackedBarBarArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(MicrochartStackedBarBarArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator MicrochartStackedBarBarArray(JsonElement instance)
            {
                return MicrochartStackedBarBarArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MicrochartStackedBarBarArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MicrochartStackedBarBarArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MicrochartStackedBarBarArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MicrochartStackedBarBarArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MicrochartStackedBarBarArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static MicrochartStackedBarBarArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<MicrochartStackedBarBarArray>(json, options);
            }
            ...
            /// </exception>
            public static MicrochartStackedBarBarArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<MicrochartStackedBarBarArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out MicrochartStackedBarBarArray? result)
            {
                return JsonElementHelpers.TryParseValue<MicrochartStackedBarBarArray>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new MicrochartStackedBarBarArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static MicrochartStackedBarBarArray IJsonElement<MicrochartStackedBarBarArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"MicrochartStackedBarBarArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="MicrochartStackedBarBarArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="MicrochartStackedBarBarArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public MicrochartStackedBarBarArray Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<MicrochartStackedBarBarArray>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="MicrochartStackedBarBarArray"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public MicrochartStackedBarBarArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<MicrochartStackedBarBarArray>(_idx);
                }
