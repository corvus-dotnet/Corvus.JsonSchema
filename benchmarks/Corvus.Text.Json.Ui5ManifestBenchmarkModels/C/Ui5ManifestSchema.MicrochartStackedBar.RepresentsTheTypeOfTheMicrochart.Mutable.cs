    ...
    public readonly partial struct MicrochartStackedBar
    {
        ...
        public readonly partial struct RepresentsTheTypeOfTheMicrochart
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RepresentsTheTypeOfTheMicrochart instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsTheTypeOfTheMicrochart"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsTheTypeOfTheMicrochart(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsTheTypeOfTheMicrochart.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheTypeOfTheMicrochart Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheTypeOfTheMicrochart Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsTheTypeOfTheMicrochart>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsTheTypeOfTheMicrochart instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RepresentsTheTypeOfTheMicrochart, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RepresentsTheTypeOfTheMicrochart> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RepresentsTheTypeOfTheMicrochart>();
                }
                finally
                {
