    ...
    public readonly partial struct MicrochartStackedBarBar
    {
        ...
        public readonly partial struct TheColorOfTheBar
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(TheColorOfTheBar instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="TheColorOfTheBar"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TheColorOfTheBar(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new TheColorOfTheBar(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TheColorOfTheBar.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="TheColorOfTheBar"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="TheColorOfTheBar"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly TheColorOfTheBar Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<TheColorOfTheBar>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="TheColorOfTheBar"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly TheColorOfTheBar Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<TheColorOfTheBar>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartStackedBarBar.TheColorOfTheBar.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.MicrochartStackedBarBar.TheColorOfTheBar.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.EnumsValueColor.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(TheColorOfTheBar instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<TheColorOfTheBar, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<TheColorOfTheBar> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<TheColorOfTheBar>();
                }
                finally
                {
