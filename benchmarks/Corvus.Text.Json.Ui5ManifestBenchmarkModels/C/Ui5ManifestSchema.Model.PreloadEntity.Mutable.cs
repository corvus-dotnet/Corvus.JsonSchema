...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct Model
    {
        ...
        public readonly partial struct PreloadEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<PreloadEntity, Mutable>(PreloadEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(PreloadEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="PreloadEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator PreloadEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new PreloadEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"PreloadEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="PreloadEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="PreloadEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly PreloadEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<PreloadEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="PreloadEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly PreloadEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<PreloadEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(PreloadEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<PreloadEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<PreloadEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<PreloadEntity>();
                }
                finally
                {
