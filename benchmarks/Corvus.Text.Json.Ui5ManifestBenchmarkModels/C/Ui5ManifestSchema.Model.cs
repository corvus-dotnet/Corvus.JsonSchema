...
public readonly partial struct Ui5ManifestSchema
{
...
#endif
    {
        ...
        internal Model(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static Model DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.JsonString DataSource
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DataSourceUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Model.PreloadEntity Preload
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PreloadUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Model.PreloadEntity value))
                {
                    return value;
                }

                return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Model.PreloadEntity.DefaultInstance;
            }
        }
        ...
        /// </summary>
        public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Ui5setting Settings
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SettingsUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Ui5setting value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in Model left, in Model right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Model left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(Model instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Model(JsonElement instance)
        {
            return Model.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Model From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Model ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Model>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Model ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Model>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Model ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Model>(json, options);
        }
        ...
        /// </exception>
        public static Model ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<Model>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Model? result)
        {
            return JsonElementHelpers.TryParseValue<Model>(ref reader, out result);
        }
...
#if NET
        static Model IJsonElement<Model>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Model: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public Model Freeze()
        {
            ...
            {
                return mutable.FreezeElement<Model>(_idx);
            }
        ...
        {
            /// <summary>
            /// Gets the JSON property name for <see cref="DataSource"/>.
            /// </summary>
            public const string DataSource = "dataSource";

            /// <summary>
            /// Gets the JSON property name for <see cref="Preload"/>.
            /// </summary>
            ...
            /// Gets the JSON property name for <see cref="DataSource"/>.
            /// </summary>
            public static ReadOnlySpan<byte> DataSourceUtf8 => "dataSource"u8;

            /// <summary>
            /// Gets the JSON property name for <see cref="Preload"/>.
            /// </summary>
            public static ReadOnlySpan<byte> PreloadUtf8 => "preload"u8;
        ...
        {
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="DataSource"/>.
            /// </summary>
            public static ReadOnlySpan<byte> DataSource => "dataSource"u8;

            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="Preload"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Preload => "preload"u8;
        ...
        {
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="DataSource"/>.
            /// </summary>
            public static ReadOnlySpan<byte> DataSource => [0xC5, 0x00, 0x00, 0x00, 0x22, 0x64, 0x61, 0x74, 0x61, 0x53, 0x6F, 0x75, 0x72, 0x63, 0x65, 0x22];

            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="Preload"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Preload => [0x95, 0x00, 0x00, 0x00, 0x22, 0x70, 0x72, 0x65, 0x6C, 0x6F, 0x61, 0x64, 0x22];
