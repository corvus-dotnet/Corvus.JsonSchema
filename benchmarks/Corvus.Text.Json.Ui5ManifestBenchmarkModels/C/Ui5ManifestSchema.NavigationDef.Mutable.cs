...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct NavigationDef
    {
...
#endif
        {
            ...
            public void SetCreate(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ActionPropDef.Source value)
            {
                ...
                else
                {
                    ...
                    value.AddAsProperty(JsonPropertyNamesEscaped.Create, ref cvb, escapeName: false, nameRequiresUnescaping: false);
            ...
            public void SetDisplay(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ActionPropDef.Source value)
            {
                ...
                {
                    // We are going to insert the new value
                    value.AddAsProperty(JsonPropertyNamesEscaped.Display, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
        ...
        public ref struct Builder
        {
            ...
            {
                create.AddAsProperty(JsonPropertyNamesEscaped.Create, ref builder, escapeName: false);
                display.AddAsProperty(JsonPropertyNamesEscaped.Display, ref builder, escapeName: false);
