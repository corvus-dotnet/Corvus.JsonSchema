...
public readonly partial struct Ui5ManifestSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NavigationDef"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal NavigationDef(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static NavigationDef DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ActionPropDef Display
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DisplayUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ActionPropDef value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ActionPropDef Edit
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EditUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ActionPropDef value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in NavigationDef left, in NavigationDef right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in NavigationDef left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(NavigationDef instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator NavigationDef(JsonElement instance)
        {
            return NavigationDef.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static NavigationDef From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static NavigationDef ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<NavigationDef>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static NavigationDef ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<NavigationDef>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static NavigationDef ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<NavigationDef>(json, options);
        }
        ...
        /// </exception>
        public static NavigationDef ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<NavigationDef>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out NavigationDef? result)
        {
            return JsonElementHelpers.TryParseValue<NavigationDef>(ref reader, out result);
        }
...
#if NET
        static NavigationDef IJsonElement<NavigationDef>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"NavigationDef: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        private static class JsonPropertyNamesPrebaked
        {
            ...
            /// </summary>
            public static ReadOnlySpan<byte> Display => [0x95, 0x00, 0x00, 0x00, 0x22, 0x64, 0x69, 0x73, 0x70, 0x6C, 0x61, 0x79, 0x22];

            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="Edit"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Edit => [0x65, 0x00, 0x00, 0x00, 0x22, 0x65, 0x64, 0x69, 0x74, 0x22];
        }
    }
}
