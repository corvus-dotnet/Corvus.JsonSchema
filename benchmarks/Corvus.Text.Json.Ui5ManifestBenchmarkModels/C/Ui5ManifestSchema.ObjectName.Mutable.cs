...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct ObjectName
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ObjectName instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ObjectName"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ObjectName(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ObjectName(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ObjectName.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ObjectName"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ObjectName"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly ObjectName Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ObjectName>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ObjectName"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly ObjectName Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ObjectName>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ObjectName instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<ObjectName, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ObjectName> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ObjectName>();
            }
            finally
            {
