...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct ObjectStreamCardsSettingsDef
    {
        ...
        public readonly partial struct ShowFirstActionInFooterEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ShowFirstActionInFooterEntity, Mutable>(ShowFirstActionInFooterEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(ShowFirstActionInFooterEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ShowFirstActionInFooterEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ShowFirstActionInFooterEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ShowFirstActionInFooterEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ShowFirstActionInFooterEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ShowFirstActionInFooterEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ShowFirstActionInFooterEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ShowFirstActionInFooterEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ShowFirstActionInFooterEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ShowFirstActionInFooterEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ShowFirstActionInFooterEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ShowFirstActionInFooterEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ShowFirstActionInFooterEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ShowFirstActionInFooterEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ShowFirstActionInFooterEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ShowFirstActionInFooterEntity>();
                }
                finally
                {
