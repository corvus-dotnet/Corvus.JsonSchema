...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct ObjectStreamCardsSettingsDef
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ShowFirstActionInFooterEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ShowFirstActionInFooterEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ShowFirstActionInFooterEntity DefaultInstance { get; } = ParsedJsonDocument<ShowFirstActionInFooterEntity>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(ShowFirstActionInFooterEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in ShowFirstActionInFooterEntity left, in ShowFirstActionInFooterEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ShowFirstActionInFooterEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ShowFirstActionInFooterEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ShowFirstActionInFooterEntity(JsonElement instance)
            {
                return ShowFirstActionInFooterEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ShowFirstActionInFooterEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ShowFirstActionInFooterEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ShowFirstActionInFooterEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ShowFirstActionInFooterEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ShowFirstActionInFooterEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ShowFirstActionInFooterEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ShowFirstActionInFooterEntity>(json, options);
            }
            ...
            /// </exception>
            public static ShowFirstActionInFooterEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ShowFirstActionInFooterEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ShowFirstActionInFooterEntity? result)
            {
                return JsonElementHelpers.TryParseValue<ShowFirstActionInFooterEntity>(ref reader, out result);
            }
...
#if NET
            static ShowFirstActionInFooterEntity IJsonElement<ShowFirstActionInFooterEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ShowFirstActionInFooterEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public ShowFirstActionInFooterEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public ShowFirstActionInFooterEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ShowFirstActionInFooterEntity>(_idx);
                }
