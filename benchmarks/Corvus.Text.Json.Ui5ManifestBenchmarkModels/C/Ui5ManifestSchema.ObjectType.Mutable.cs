...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct ObjectType
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(ObjectType instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="ObjectType"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ObjectType(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ObjectType(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ObjectType.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ObjectType"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ObjectType"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly ObjectType Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ObjectType>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ObjectType"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly ObjectType Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<ObjectType>(_idx);
            }
            ...
            /// <param name="matchQuery">Match 1st item.</param>
            /// <param name="matchCdsprojectionview">Match 2nd item.</param>
            /// <param name="matchView">Match 3rd item.</param>
            /// <param name="matchInamodel">Match 4th item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchQuery,
                Func<TContext, TResult> matchCdsprojectionview,
                Func<TContext, TResult> matchView,
                Func<TContext, TResult> matchInamodel,
...
#endif
            {
                ...
                {
                    return matchCdsprojectionview(context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Func<TResult> matchCdsprojectionview,
                Func<TResult> matchView,
                Func<TResult> matchInamodel,
            ...
            public bool TryGetKnownValue(out KnownValues result)
            {
                ...
                if (this.ValueEquals(Constants.Enum2))
                {
                    result = KnownValues.Cdsprojectionview;
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(ObjectType instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (ObjectType)value;
        ...
        {
            return workspace.CreateBuilder<ObjectType, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<ObjectType> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ObjectType>();
            }
            finally
            {
