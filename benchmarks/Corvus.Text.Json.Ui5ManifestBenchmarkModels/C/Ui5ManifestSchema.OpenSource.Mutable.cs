...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct OpenSource
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(OpenSource instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="OpenSource"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator OpenSource(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Mutable PackagedWithMySelf
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PackagedWithMySelfUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Mutable value))
                    {
                        return value;
                    }
            ...
            /// <summary>
            /// Set the <c>packagedWithMySelf</c> property.
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetPackagedWithMySelf(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.PackagedWithMySelfUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PackagedWithMySelfUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.PackagedWithMySelf, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// <summary>
            /// Remove the <c>packagedWithMySelf</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemovePackagedWithMySelf()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.PackagedWithMySelfUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"OpenSource.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly OpenSource Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly OpenSource Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<OpenSource>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.OpenSource.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source arg1, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source arg2, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source arg3)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _createArg3 = arg3;
            ...
            public static implicit operator Source(OpenSource instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.OpenSource.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="OpenSource"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source name,
                in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source packagedWithMySelf = default,
                in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source version = default)
            {
                ...
                packagedWithMySelf.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.PackagedWithMySelf, ref builder);
            ...
            public void Create(
                ...
                in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source version = default)
            {
                Create(ref _builder, name, packagedWithMySelf, version);
            }
            ...
            internal static void BuildCreateValue(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source arg1, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source arg2, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source arg3, ref ComplexValueBuilder o)
            {
                o.StartObject();
        ...
        /// <param name="packagedWithMySelf">The value of the <c>"packagedWithMySelf"</c> property.</param>
        /// <param name="version">The value of the <c>"version"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source name, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source packagedWithMySelf = default, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source version = default)
        {
            return new Source(name, packagedWithMySelf, version);
        }
        ...
        /// <param name="packagedWithMySelf">The value of the property.</param>
        /// <param name="version">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source name, in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source packagedWithMySelf = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source version = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(name, packagedWithMySelf, version);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<OpenSource, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<OpenSource> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<OpenSource>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<OpenSource> Create<TContext>(
        ...
        public static ParsedJsonDocument<OpenSource> Create(in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source name, in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source packagedWithMySelf = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source version = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
