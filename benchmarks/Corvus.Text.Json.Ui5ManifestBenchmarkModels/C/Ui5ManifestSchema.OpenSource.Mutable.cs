    ...
    public readonly partial struct OpenSource
    {
...
#endif
        {
            ...
            public void SetPackagedWithMySelf(in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source value)
            {
                ...
                {
                    // We are going to insert the new value
                    value.AddAsProperty(JsonPropertyNamesEscaped.PackagedWithMySelf, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
        ...
        public ref struct Builder
        {
                ...
                in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source version = default)
            {
                ...
                packagedWithMySelf.AddAsProperty(JsonPropertyNamesEscaped.PackagedWithMySelf, ref builder, escapeName: false);
