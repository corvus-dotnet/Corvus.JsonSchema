...
public readonly partial struct Ui5ManifestSchema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.JsonBoolean PackagedWithMySelf
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PackagedWithMySelfUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonBoolean value))
                {
                    return value;
                }
        ...
        private static class JsonPropertyNamesPrebaked
        {
            ...
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="PackagedWithMySelf"/>.
            /// </summary>
            public static ReadOnlySpan<byte> PackagedWithMySelf => [0x45, 0x01, 0x00, 0x00, 0x22, 0x70, 0x61, 0x63, 0x6B, 0x61, 0x67, 0x65, 0x64, 0x57, 0x69, 0x74, 0x68, 0x4D, 0x79, 0x53, 0x65, 0x6C, 0x66, 0x22];
