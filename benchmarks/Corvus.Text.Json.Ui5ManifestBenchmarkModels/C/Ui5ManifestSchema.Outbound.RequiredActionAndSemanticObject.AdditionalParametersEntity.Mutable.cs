        ...
        public readonly partial struct RequiredActionAndSemanticObject
        {
            ...
            public readonly partial struct AdditionalParametersEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(AdditionalParametersEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="AdditionalParametersEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator AdditionalParametersEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"AdditionalParametersEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly AdditionalParametersEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly AdditionalParametersEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<AdditionalParametersEntity>(_idx);
                    }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(AdditionalParametersEntity instance) => new(JsonElement.From(instance));
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Source(KnownValues value) => (AdditionalParametersEntity)value;
                ...
                {
                    return workspace.CreateBuilder<AdditionalParametersEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<AdditionalParametersEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<AdditionalParametersEntity>();
                    }
                    finally
                    {
