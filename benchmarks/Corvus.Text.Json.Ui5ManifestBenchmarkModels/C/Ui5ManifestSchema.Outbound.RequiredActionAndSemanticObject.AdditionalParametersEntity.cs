    ...
    public readonly partial struct Outbound
    {
        ...
        public readonly partial struct RequiredActionAndSemanticObject
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="AdditionalParametersEntity"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal AdditionalParametersEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static AdditionalParametersEntity DefaultInstance { get; }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(AdditionalParametersEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in AdditionalParametersEntity left, in AdditionalParametersEntity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in AdditionalParametersEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(AdditionalParametersEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator AdditionalParametersEntity(JsonElement instance)
                {
                    return AdditionalParametersEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AdditionalParametersEntity From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AdditionalParametersEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<AdditionalParametersEntity>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AdditionalParametersEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<AdditionalParametersEntity>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static AdditionalParametersEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<AdditionalParametersEntity>(json, options);
                }
                ...
                /// </exception>
                public static AdditionalParametersEntity ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<AdditionalParametersEntity>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out AdditionalParametersEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<AdditionalParametersEntity>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new AdditionalParametersEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static AdditionalParametersEntity IJsonElement<AdditionalParametersEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"AdditionalParametersEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="AdditionalParametersEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="AdditionalParametersEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public AdditionalParametersEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<AdditionalParametersEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="AdditionalParametersEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public AdditionalParametersEntity Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<AdditionalParametersEntity>(_idx);
                    }
                ...
                /// <param name="matchNotallowed">Match 1st item.</param>
                /// <param name="matchIgnored">Match 2nd item.</param>
                /// <param name="matchAllowed">Match 3rd item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> matchNotallowed,
                    Func<TContext, TResult> matchIgnored,
...
#endif
                {
                    ...
                    {
                        return matchNotallowed(context);
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchIgnored(context);
                    }
                ...
                public TResult Match<TResult>(
                    Func<TResult> matchNotallowed,
                    Func<TResult> matchIgnored,
                    Func<TResult> matchAllowed,
                    Func<TResult> defaultMatch)
                {
                    if (this.ValueEquals(Constants.Enum1))
                    {
                        return matchNotallowed();
                    }
