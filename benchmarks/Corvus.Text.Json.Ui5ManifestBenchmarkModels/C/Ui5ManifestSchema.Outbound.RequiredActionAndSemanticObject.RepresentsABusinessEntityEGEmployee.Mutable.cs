        ...
        public readonly partial struct RequiredActionAndSemanticObject
        {
            ...
            public readonly partial struct RepresentsABusinessEntityEGEmployee
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(RepresentsABusinessEntityEGEmployee instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="RepresentsABusinessEntityEGEmployee"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RepresentsABusinessEntityEGEmployee(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RepresentsABusinessEntityEGEmployee.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RepresentsABusinessEntityEGEmployee Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RepresentsABusinessEntityEGEmployee Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<RepresentsABusinessEntityEGEmployee>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(RepresentsABusinessEntityEGEmployee instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<RepresentsABusinessEntityEGEmployee, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<RepresentsABusinessEntityEGEmployee> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<RepresentsABusinessEntityEGEmployee>();
                    }
                    finally
                    {
