                    ...
                    public readonly partial struct ValueEntity
                    {
                        ...
                        public readonly partial struct FormatEntity
                        {
...
#endif
                            {
                                ...
                                public static explicit operator Mutable(FormatEntity instance)
                                {
                                ...
                                /// <returns>An immutable instance of a <see cref="FormatEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static implicit operator FormatEntity(Mutable instance)
                                {
                                ...
                                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                private string DebuggerDisplay => $"FormatEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                                ...
                                /// </para>
                                /// </remarks>
                                public readonly FormatEntity Clone()
                                {
                                    CheckValidInstance();
                                ...
                                /// </para>
                                /// </remarks>
                                public readonly FormatEntity Freeze()
                                {
                                    CheckValidInstance();
                                    return _parent.FreezeElement<FormatEntity>(_idx);
                                }
                            ...
                            public ref struct Source
                            {
                                ...
                                public static implicit operator Source(FormatEntity instance) => new(JsonElement.From(instance));
                            ...
                            {
                                return workspace.CreateBuilder<FormatEntity, Mutable>(this);
                            }
                            ...
                            public static ParsedJsonDocument<FormatEntity> Create(
                                scoped in Source value, int initialCapacity = 1)
                            {
                                ...
                                try
                                {
                                    ...
                                    Debug.Assert(cvb.MemberCount == 1);
                                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                    return documentBuilder.ToParsedJsonDocument<FormatEntity>();
                                }
                                finally
                                {
