        ...
        public readonly partial struct RequiredActionAndSemanticObject
        {
            ...
            public readonly partial struct RepresentsParametersOfNavigationIntents
            {
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="W1Entity"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal W1Entity(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static W1Entity DefaultInstance { get; }

                    /// <summary>
                    /// Gets the (optional) <c>required</c> property.
                    /// </summary>
                    public Corvus.Ui5ManifestBenchmark.Current.JsonBoolean Required
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RequiredUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonBoolean value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Outbound.RequiredActionAndSemanticObject.RepresentsParametersOfNavigationIntents.W1Entity.ValueEntity Value
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ValueUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Outbound.RequiredActionAndSemanticObject.RepresentsParametersOfNavigationIntents.W1Entity.ValueEntity value))
                            {
                                return value;
                            }
                    ...
                    /// </returns>
                    public static bool operator ==(in W1Entity left, in W1Entity right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in W1Entity left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    public static implicit operator JsonElement(W1Entity instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator W1Entity(JsonElement instance)
                    {
                        return W1Entity.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static W1Entity From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static W1Entity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<W1Entity>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static W1Entity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<W1Entity>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static W1Entity ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<W1Entity>(json, options);
                    }
                    ...
                    /// </exception>
                    public static W1Entity ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<W1Entity>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out W1Entity? result)
                    {
                        return JsonElementHelpers.TryParseValue<W1Entity>(ref reader, out result);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new W1Entity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                    static W1Entity IJsonElement<W1Entity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"W1Entity: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="W1Entity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="W1Entity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public W1Entity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<W1Entity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="W1Entity"/> that lives for the lifetime of its
