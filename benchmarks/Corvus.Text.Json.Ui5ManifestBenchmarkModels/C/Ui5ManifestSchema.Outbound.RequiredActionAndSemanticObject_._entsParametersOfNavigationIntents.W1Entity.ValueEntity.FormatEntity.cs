                ...
                public readonly partial struct W1Entity
                {
                    ...
                    public readonly partial struct ValueEntity
                    {
...
#endif
                        {
                            ...
                            /// <summary>
                            /// Initializes a new instance of the <see cref="FormatEntity"/> struct.
                            /// </summary>
                            ...
                            internal FormatEntity(IJsonDocument parent, int idx)
                            {
                                Debug.Assert(idx >= 0);
                                _parent = parent;
                                _idx = idx;
                            ...
                            /// </summary>
                            public static FormatEntity DefaultInstance { get; }
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static explicit operator string(FormatEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                            ...
                            /// </returns>
                            public static bool operator ==(in FormatEntity left, in FormatEntity right)
                            {
                            ...
                            /// <c>True</c> if the values are equal.
                            /// </returns>
                            public static bool operator ==(in FormatEntity left, in JsonElement right)
                            {
                                return left.Equals(right);
                            }
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator JsonElement(FormatEntity instance)
                            {
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator FormatEntity(JsonElement instance)
                            {
                                return FormatEntity.From(instance);
                            }
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static FormatEntity From<T>(in T instance)
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static FormatEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                            {
                                #pragma warning disable CS0618 // Type or member is obsolete
                                return JsonElementHelpers.ParseValue<FormatEntity>(utf8Json, options);
                            ...
                            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static FormatEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                            {
                                #pragma warning disable CS0618 // Type or member is obsolete
                                return JsonElementHelpers.ParseValue<FormatEntity>(json, options);
                                #pragma warning restore CS0618
                            }
                            ...
                            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static FormatEntity ParseValue(string json, JsonDocumentOptions options = default)
                            {
                                #pragma warning disable CS0618 // Type or member is obsolete
                                return JsonElementHelpers.ParseValue<FormatEntity>(json, options);
                                #pragma warning restore CS0618
                            ...
                            /// </exception>
                            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                            public static FormatEntity ParseValue(ref Utf8JsonReader reader)
                            {
                                #pragma warning disable CS0618 // Type or member is obsolete
                                return JsonElementHelpers.ParseValue<FormatEntity>(ref reader);
                                #pragma warning restore CS0618
                            }
                            ...
                            ///   A value could not be read from the reader.
                            /// </exception>
                            public static bool TryParseValue(ref Utf8JsonReader reader, out FormatEntity? result)
                            {
                                return JsonElementHelpers.TryParseValue<FormatEntity>(ref reader, out result);
                            }
                            ...
                            {
                                return
                                    (obj is IJsonElement value && Equals(new FormatEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                            static FormatEntity IJsonElement<FormatEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            private string DebuggerDisplay => $"FormatEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                            ...
                            /// <summary>
                            /// Gets a <see cref="FormatEntity"/> which can be safely stored beyond the lifetime of the
                            /// original document.
                            /// </summary>
                            /// <returns>
                            /// A <see cref="FormatEntity"/> which can be safely stored beyond the lifetime of the
                            /// original document.
                            /// </returns>
                            /// <remarks>
                            /// <para>
                            ...
                            /// </para>
                            /// </remarks>
                            public FormatEntity Clone()
                            {
                                CheckValidInstance();
                                return _parent.CloneElement<FormatEntity>(_idx);
                            }
                            ...
                            /// </summary>
                            /// <returns>
                            /// An immutable <see cref="FormatEntity"/> that lives for the lifetime of its
                            ...
                            /// <param name="matchRegexp">Match 2nd item.</param>
                            /// <param name="matchReference">Match 3rd item.</param>
                            /// <param name="matchBinding">Match 4th item.</param>
                            /// <param name="defaultMatch">Match any other value.</param>
                            /// <returns>An instance of the value returned by the match function.</returns>
                            public TResult Match<TContext, TResult>(
                                in TContext context,
                                Func<TContext, TResult> matchPlain,
                                Func<TContext, TResult> matchRegexp,
                                Func<TContext, TResult> matchReference,
                                Func<TContext, TResult> matchBinding,
...
#endif
                            {
                                ...
                                {
                                    return matchRegexp(context);
                                }

                                if (this.ValueEquals(Constants.Enum3))
                                {
                                    return matchReference(context);
                                }

                                if (this.ValueEquals(Constants.Enum4))
                                {
                                    return matchBinding(context);
                                }
                            ...
                            public TResult Match<TResult>(
                                Func<TResult> matchPlain,
                                Func<TResult> matchRegexp,
                                Func<TResult> matchReference,
                                Func<TResult> matchBinding,
