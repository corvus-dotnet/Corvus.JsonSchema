...
public readonly partial struct Ui5ManifestSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Outbound"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal Outbound(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static Outbound DefaultInstance { get; }
        ...
        public bool TryGetProperty(ReadOnlySpan<byte> propertyName, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Outbound.RequiredActionAndSemanticObject value)
        {
            CheckValidInstance();
        ...
        /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public bool TryGetProperty(ReadOnlySpan<char> propertyName, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Outbound.RequiredActionAndSemanticObject value)
        {
            CheckValidInstance();
            return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
        }
        ...
        /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public bool TryGetProperty(string propertyName, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Outbound.RequiredActionAndSemanticObject value)
        {
            CheckValidInstance();
            return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
        }
        ...
        /// <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Outbound.RequiredActionAndSemanticObject"/>.
        /// </summary>
        ...
        public static bool MatchesPatternRequiredActionAndSemanticObject(ReadOnlySpan<byte> propertyName)
        {
        ...
        /// <returns><see langword="true"/> if the property name matches the pattern, otherwise <see langword="false"/>.</returns>
        public static bool TryAsPatternRequiredActionAndSemanticObject(ReadOnlySpan<byte> propertyName, in JsonElement value, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Outbound.RequiredActionAndSemanticObject result)
        {
            if (MatchesPatternRequiredActionAndSemanticObject(propertyName))
            {
                result = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Outbound.RequiredActionAndSemanticObject.From(value);
                return true;
            }
        ...
        public interface IPatternPropertyVisitor<TState>
        {
            ...
            /// </summary>
            bool VisitPatternRequiredActionAndSemanticObject(ReadOnlySpan<byte> name, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Outbound.RequiredActionAndSemanticObject value, ref TState state);
            ...
            where TVisitor : IPatternPropertyVisitor<TState>
        {
            ...
            foreach (var property in EnumerateObject())
            {
                ...
                {
                    matched = true;
                    Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Outbound.RequiredActionAndSemanticObject typedValue = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Outbound.RequiredActionAndSemanticObject.From(property.Value);
                    if (!visitor.VisitPatternRequiredActionAndSemanticObject(propertyName, in typedValue, ref state))
                    {
                        return false;
                    }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public ObjectEnumerator<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Outbound.RequiredActionAndSemanticObject> EnumerateObject()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateObjectEnumerator<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Outbound.RequiredActionAndSemanticObject>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in Outbound left, in Outbound right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Outbound left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(Outbound instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Outbound(JsonElement instance)
        {
            return Outbound.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Outbound From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Outbound ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<Outbound>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Outbound ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<Outbound>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Outbound ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<Outbound>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static Outbound ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<Outbound>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Outbound? result)
        {
            return JsonElementHelpers.TryParseValue<Outbound>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new Outbound(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static Outbound IJsonElement<Outbound>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Outbound: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="Outbound"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="Outbound"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        {
            CheckValidInstance();
            return _parent.CloneElement<Outbound>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="Outbound"/> that lives for the lifetime of its
