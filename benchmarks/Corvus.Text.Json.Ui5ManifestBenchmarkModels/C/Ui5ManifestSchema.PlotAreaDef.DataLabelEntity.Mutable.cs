...
public readonly partial struct Ui5ManifestSchema
{
    ...
    /// </para>
    /// </remarks>
    public readonly partial struct PlotAreaDef
    {
        /// <summary>
        /// Generated from JSON Schema.
        /// </summary>
        ...
        public readonly partial struct DataLabelEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(DataLabelEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DataLabelEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DataLabelEntity(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.PlotAreaDef.DataLabelEntity.TypeEntity.Mutable Type
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.PlotAreaDef.DataLabelEntity.TypeEntity.Mutable value))
                        {
                            return value;
                        }

                        return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.PlotAreaDef.DataLabelEntity.TypeEntity.Mutable.DefaultInstance;
                    }
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new DataLabelEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                public void SetType(scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.PlotAreaDef.DataLabelEntity.TypeEntity.Source value)
                {
                    CheckValidInstance();
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DataLabelEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="DataLabelEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="DataLabelEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly DataLabelEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<DataLabelEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="DataLabelEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly DataLabelEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DataLabelEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.PlotAreaDef.DataLabelEntity.TypeEntity.Source _createArg1;
                ...
                internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.PlotAreaDef.DataLabelEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.PlotAreaDef.DataLabelEntity.TypeEntity.Source arg1)
                {
                    _createArg1 = arg1;
                    _kind = Kind.Create;
                }

                public static implicit operator Source(DataLabelEntity instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.PlotAreaDef.DataLabelEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="DataLabelEntity"/>.
                /// </summary>
                internal static void Create(ref ComplexValueBuilder builder, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.PlotAreaDef.DataLabelEntity.TypeEntity.Source type = default)
                {
                ...
                /// Creates an instance of a <see cref="DataLabelEntity"/>.
                /// </summary>
                public void Create(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.PlotAreaDef.DataLabelEntity.TypeEntity.Source type = default)
                {
                ...
                internal static void BuildCreateValue(scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.PlotAreaDef.DataLabelEntity.TypeEntity.Source arg1, ref ComplexValueBuilder o)
                {
                    o.StartObject();
                    Create(ref o, arg1);
                    o.EndObject();
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.PlotAreaDef.DataLabelEntity.TypeEntity.Source type = default)
            {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.PlotAreaDef.DataLabelEntity.TypeEntity.Source type = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            {
                return workspace.CreateBuilder<DataLabelEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<DataLabelEntity> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<DataLabelEntity>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<DataLabelEntity> Create<TContext>(
            ...
            public static ParsedJsonDocument<DataLabelEntity> Create(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.PlotAreaDef.DataLabelEntity.TypeEntity.Source type = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
