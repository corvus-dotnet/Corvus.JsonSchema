...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct PlotAreaDef
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(PlotAreaDef instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="PlotAreaDef"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PlotAreaDef(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.PlotAreaDef.DataLabelEntity.Mutable DataLabel
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DataLabelUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.PlotAreaDef.DataLabelEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.PlotAreaDef.RepresentsWhetherSmootherCurvesAreRequiredOrNot.Mutable IsSmoothed
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IsSmoothedUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.PlotAreaDef.RepresentsWhetherSmootherCurvesAreRequiredOrNot.Mutable value))
                    {
                        return value;
                    }

                    return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.PlotAreaDef.RepresentsWhetherSmootherCurvesAreRequiredOrNot.Mutable.DefaultInstance;
                }
            }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.JsonInteger.Mutable MarkerSize
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MarkerSizeUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonInteger.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetDataLabel<TContext>(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.PlotAreaDef.DataLabelEntity.Source<TContext> value)
            ...
            public void SetIsSmoothed(scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.PlotAreaDef.RepresentsWhetherSmootherCurvesAreRequiredOrNot.Source value)
            {
                ...
                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.IsSmoothedUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IsSmoothedUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            /// <summary>
            /// Remove the <c>isSmoothed</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveIsSmoothed()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.IsSmoothedUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            public void SetMarkerSize(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonInteger.Source value)
            {
                ...
                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.MarkerSizeUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MarkerSizeUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
            ...
            /// <summary>
            /// Remove the <c>markerSize</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveMarkerSize()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.MarkerSizeUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PlotAreaDef.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly PlotAreaDef Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly PlotAreaDef Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<PlotAreaDef>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.PlotAreaDef.DataLabelEntity.Source _createArg1;
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.PlotAreaDef.RepresentsWhetherSmootherCurvesAreRequiredOrNot.Source _createArg2;
            ...
            public static implicit operator Source(PlotAreaDef instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.PlotAreaDef.DataLabelEntity.Source<TContext> _createArg1;
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.PlotAreaDef.RepresentsWhetherSmootherCurvesAreRequiredOrNot.Source _createArg2;
            private readonly Corvus.Ui5ManifestBenchmark.Current.JsonInteger.Source _createArg3;
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="PlotAreaDef"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.PlotAreaDef.DataLabelEntity.Source dataLabel = default,
            ...
            public void Create(
                ...
                in Corvus.Ui5ManifestBenchmark.Current.JsonInteger.Source markerSize = default)
            {
                Create(ref _builder, dataLabel, isSmoothed, markerSize);
            }
            ...
            internal static void Create<TContext>(
                in TContext context,
                ref ComplexValueBuilder builder,
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.PlotAreaDef.DataLabelEntity.Source<TContext> dataLabel = default,
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.PlotAreaDef.RepresentsWhetherSmootherCurvesAreRequiredOrNot.Source isSmoothed = default,
                in Corvus.Ui5ManifestBenchmark.Current.JsonInteger.Source markerSize = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            ...
            #endif
            {
                Create(context, ref _builder, dataLabel, isSmoothed, markerSize);
            }
        ...
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.PlotAreaDef.DataLabelEntity.Source<TContext> dataLabel = default, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.PlotAreaDef.RepresentsWhetherSmootherCurvesAreRequiredOrNot.Source isSmoothed = default, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonInteger.Source markerSize = default)
            ...
            #endif
        {
            return new Source<TContext>(context, dataLabel, isSmoothed, markerSize);
        }
        ...
        /// <param name="isSmoothed">The value of the property.</param>
        /// <param name="markerSize">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.PlotAreaDef.DataLabelEntity.Source dataLabel = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.PlotAreaDef.RepresentsWhetherSmootherCurvesAreRequiredOrNot.Source isSmoothed = default, in Corvus.Ui5ManifestBenchmark.Current.JsonInteger.Source markerSize = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(dataLabel, isSmoothed, markerSize);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.PlotAreaDef.DataLabelEntity.Source<TContext> dataLabel = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.PlotAreaDef.RepresentsWhetherSmootherCurvesAreRequiredOrNot.Source isSmoothed = default, in Corvus.Ui5ManifestBenchmark.Current.JsonInteger.Source markerSize = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            ...
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(context, dataLabel, isSmoothed, markerSize);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<PlotAreaDef, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<PlotAreaDef> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<PlotAreaDef>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<PlotAreaDef> Create<TContext>(
        ...
        public static ParsedJsonDocument<PlotAreaDef> Create(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.PlotAreaDef.DataLabelEntity.Source dataLabel = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.PlotAreaDef.RepresentsWhetherSmootherCurvesAreRequiredOrNot.Source isSmoothed = default, in Corvus.Ui5ManifestBenchmark.Current.JsonInteger.Source markerSize = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<PlotAreaDef> Create<TContext>(in TContext context, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.PlotAreaDef.DataLabelEntity.Source<TContext> dataLabel = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.PlotAreaDef.RepresentsWhetherSmootherCurvesAreRequiredOrNot.Source isSmoothed = default, in Corvus.Ui5ManifestBenchmark.Current.JsonInteger.Source markerSize = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
