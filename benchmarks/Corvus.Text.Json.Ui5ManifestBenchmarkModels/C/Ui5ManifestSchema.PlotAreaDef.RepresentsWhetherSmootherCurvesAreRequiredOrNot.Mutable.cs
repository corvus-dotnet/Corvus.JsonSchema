    ...
    public readonly partial struct PlotAreaDef
    {
        ...
        public readonly partial struct RepresentsWhetherSmootherCurvesAreRequiredOrNot
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<RepresentsWhetherSmootherCurvesAreRequiredOrNot, Mutable>(RepresentsWhetherSmootherCurvesAreRequiredOrNot.DefaultInstance);
                ...
                public static explicit operator Mutable(RepresentsWhetherSmootherCurvesAreRequiredOrNot instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsWhetherSmootherCurvesAreRequiredOrNot"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsWhetherSmootherCurvesAreRequiredOrNot(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsWhetherSmootherCurvesAreRequiredOrNot.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsWhetherSmootherCurvesAreRequiredOrNot Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsWhetherSmootherCurvesAreRequiredOrNot Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsWhetherSmootherCurvesAreRequiredOrNot>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsWhetherSmootherCurvesAreRequiredOrNot instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RepresentsWhetherSmootherCurvesAreRequiredOrNot, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RepresentsWhetherSmootherCurvesAreRequiredOrNot> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RepresentsWhetherSmootherCurvesAreRequiredOrNot>();
                }
                finally
                {
