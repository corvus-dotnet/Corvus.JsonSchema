    ...
    public readonly partial struct ProgressIndicator
    {
        ...
        public readonly partial struct RepresentsStateColor
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RepresentsStateColor instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsStateColor"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsStateColor(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsStateColor.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsStateColor Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsStateColor Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsStateColor>(_idx);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ProgressIndicator.RepresentsStateColor.Mutable, TContext, TResult> defaultMatch)
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ProgressIndicator.RepresentsStateColor.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.State.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsStateColor instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RepresentsStateColor, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RepresentsStateColor> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RepresentsStateColor>();
                }
                finally
                {
