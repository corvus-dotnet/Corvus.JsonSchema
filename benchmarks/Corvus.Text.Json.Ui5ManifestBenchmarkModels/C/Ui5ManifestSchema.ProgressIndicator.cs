...
public readonly partial struct Ui5ManifestSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProgressIndicator"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ProgressIndicator(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ProgressIndicator DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ProgressIndicator.RepresentsProgressIndicatorPercentValue Percent
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PercentUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ProgressIndicator.RepresentsProgressIndicatorPercentValue value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ProgressIndicator.RepresentsStateColor State
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.StateUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ProgressIndicator.RepresentsStateColor value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in ProgressIndicator left, in ProgressIndicator right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ProgressIndicator left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(ProgressIndicator instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ProgressIndicator(JsonElement instance)
        {
            return ProgressIndicator.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ProgressIndicator From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ProgressIndicator ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ProgressIndicator>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ProgressIndicator ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ProgressIndicator>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ProgressIndicator ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ProgressIndicator>(json, options);
        }
        ...
        /// </exception>
        public static ProgressIndicator ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ProgressIndicator>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ProgressIndicator? result)
        {
            return JsonElementHelpers.TryParseValue<ProgressIndicator>(ref reader, out result);
        }
...
#if NET
        static ProgressIndicator IJsonElement<ProgressIndicator>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ProgressIndicator: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public ProgressIndicator Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public ProgressIndicator Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ProgressIndicator>(_idx);
            }
        ...
        {
            /// <summary>
            /// Gets the JSON property name for <see cref="Percent"/>.
            /// </summary>
        ...
        {
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="Percent"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Percent => "percent"u8;
        ...
        {
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="Percent"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Percent => [0x95, 0x00, 0x00, 0x00, 0x22, 0x70, 0x65, 0x72, 0x63, 0x65, 0x6E, 0x74, 0x22];
