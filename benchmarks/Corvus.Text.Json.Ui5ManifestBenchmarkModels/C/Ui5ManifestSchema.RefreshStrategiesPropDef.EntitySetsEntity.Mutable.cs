...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct RefreshStrategiesPropDef
    {
        ...
        public readonly partial struct EntitySetsEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(EntitySetsEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="EntitySetsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator EntitySetsEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new EntitySetsEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"EntitySetsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="EntitySetsEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="EntitySetsEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly EntitySetsEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<EntitySetsEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="EntitySetsEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly EntitySetsEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<EntitySetsEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RefreshStrategiesPropDef.EntitySetsEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(EntitySetsEntity instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RefreshStrategiesPropDef.EntitySetsEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<EntitySetsEntity, Mutable>(this);
            }
        }
    }
}
