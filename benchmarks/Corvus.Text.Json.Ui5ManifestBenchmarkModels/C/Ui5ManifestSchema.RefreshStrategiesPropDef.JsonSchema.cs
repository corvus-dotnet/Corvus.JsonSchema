...
public readonly partial struct Ui5ManifestSchema
{
        ...
        : IJsonElement<RefreshStrategiesPropDef>
    {
        public static partial class JsonSchema
        {
            ...
            private static void MatchEntitySets(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
            {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/refreshStrategies_prop_def"u8, buffer, out written);
