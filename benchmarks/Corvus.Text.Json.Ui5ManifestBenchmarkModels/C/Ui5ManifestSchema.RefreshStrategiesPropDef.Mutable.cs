...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct RefreshStrategiesPropDef
    {
        ...
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonObject.Source<TContext> entitySets = default)
            ...
            #endif
        {
            return new Source<TContext>(context, entitySets);
        }
        ...
        public static ParsedJsonDocument<RefreshStrategiesPropDef> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<RefreshStrategiesPropDef>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<RefreshStrategiesPropDef> Create<TContext>(
        ...
        public static ParsedJsonDocument<RefreshStrategiesPropDef> Create(in Corvus.Ui5ManifestBenchmark.Current.JsonObject.Source entitySets = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<RefreshStrategiesPropDef> Create<TContext>(in TContext context, in Corvus.Ui5ManifestBenchmark.Current.JsonObject.Source<TContext> entitySets = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
