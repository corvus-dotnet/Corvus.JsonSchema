...
public readonly partial struct Ui5ManifestSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RefreshStrategiesPropDef"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal RefreshStrategiesPropDef(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static RefreshStrategiesPropDef DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.JsonObject EntitySets
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EntitySetsUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonObject value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in RefreshStrategiesPropDef left, in RefreshStrategiesPropDef right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in RefreshStrategiesPropDef left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(RefreshStrategiesPropDef instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator RefreshStrategiesPropDef(JsonElement instance)
        {
            return RefreshStrategiesPropDef.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RefreshStrategiesPropDef From<T>(in T instance)
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out RefreshStrategiesPropDef? result)
        {
            return JsonElementHelpers.TryParseValue<RefreshStrategiesPropDef>(ref reader, out result);
        }
...
#if NET
        static RefreshStrategiesPropDef IJsonElement<RefreshStrategiesPropDef>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"RefreshStrategiesPropDef: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public RefreshStrategiesPropDef Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public RefreshStrategiesPropDef Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<RefreshStrategiesPropDef>(_idx);
            }
        ...
        {
            /// <summary>
            /// Gets the JSON property name for <see cref="EntitySets"/>.
            /// </summary>
            ...
            /// Gets the JSON property name for <see cref="EntitySets"/>.
            /// </summary>
            public static ReadOnlySpan<byte> EntitySetsUtf8 => "entitySets"u8;
        }
        ...
        {
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="EntitySets"/>.
            /// </summary>
            public static ReadOnlySpan<byte> EntitySets => "entitySets"u8;
        }
        ...
        {
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="EntitySets"/>.
            /// </summary>
            public static ReadOnlySpan<byte> EntitySets => [0xC5, 0x00, 0x00, 0x00, 0x22, 0x65, 0x6E, 0x74, 0x69, 0x74, 0x79, 0x53, 0x65, 0x74, 0x73, 0x22];
        }
    }
}
