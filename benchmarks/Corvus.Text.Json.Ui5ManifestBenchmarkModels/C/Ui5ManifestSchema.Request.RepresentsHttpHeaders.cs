...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct Request
    {
        ...
        public readonly partial struct RepresentsHttpHeaders
#if NET8_0_OR_GREATER
            : IJsonElement<RepresentsHttpHeaders>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RepresentsHttpHeaders"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RepresentsHttpHeaders(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RepresentsHttpHeaders DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in RepresentsHttpHeaders left, in RepresentsHttpHeaders right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RepresentsHttpHeaders left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(RepresentsHttpHeaders instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RepresentsHttpHeaders(JsonElement instance)
            {
                return RepresentsHttpHeaders.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsHttpHeaders From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsHttpHeaders ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsHttpHeaders>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsHttpHeaders ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsHttpHeaders>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsHttpHeaders ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsHttpHeaders>(json, options);
            }
            ...
            /// </exception>
            public static RepresentsHttpHeaders ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RepresentsHttpHeaders>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsHttpHeaders? result)
            {
                return JsonElementHelpers.TryParseValue<RepresentsHttpHeaders>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RepresentsHttpHeaders(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static RepresentsHttpHeaders IJsonElement<RepresentsHttpHeaders>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RepresentsHttpHeaders: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RepresentsHttpHeaders"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RepresentsHttpHeaders"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public RepresentsHttpHeaders Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RepresentsHttpHeaders>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RepresentsHttpHeaders"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public RepresentsHttpHeaders Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RepresentsHttpHeaders>(_idx);
                }
