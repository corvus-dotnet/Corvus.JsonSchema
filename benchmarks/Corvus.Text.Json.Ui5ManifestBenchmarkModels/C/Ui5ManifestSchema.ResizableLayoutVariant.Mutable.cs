...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct ResizableLayoutVariant
    {
...
#endif
        {
            ...
            public bool TryGetProperty(ReadOnlySpan<byte> propertyName, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ResizableLayoutVariantCardProperties.Mutable value)
            {
                CheckValidInstance();
            ...
            /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public bool TryGetProperty(ReadOnlySpan<char> propertyName, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ResizableLayoutVariantCardProperties.Mutable value)
            {
                CheckValidInstance();
                return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
            }
            ...
            /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public bool TryGetProperty(string propertyName, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ResizableLayoutVariantCardProperties.Mutable value)
            {
                CheckValidInstance();
                return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public ObjectEnumerator<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ResizableLayoutVariantCardProperties.Mutable> EnumerateObject()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateObjectEnumerator<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ResizableLayoutVariantCardProperties.Mutable>(_parent, _idx);
            }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetProperty(string propertyName, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ResizableLayoutVariantCardProperties.Source value)
            {
            ...
            ///   </para>
            /// </remarks>
            public void SetProperty(ReadOnlySpan<char> propertyName, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ResizableLayoutVariantCardProperties.Source value)
            {
                CheckValidInstance();
            ...
            ///   </para>
            /// </remarks>
            public void SetProperty(ReadOnlySpan<byte> propertyName, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ResizableLayoutVariantCardProperties.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ResizableLayoutVariant.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ResizableLayoutVariant.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public static ParsedJsonDocument<ResizableLayoutVariant> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<ResizableLayoutVariant>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<ResizableLayoutVariant> Create<TContext>(
