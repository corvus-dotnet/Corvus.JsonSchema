...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct ResizableLayoutVariant
#if NET8_0_OR_GREATER
        : IJsonElement<ResizableLayoutVariant>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ResizableLayoutVariant"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ResizableLayoutVariant(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ResizableLayoutVariant DefaultInstance { get; }
        ...
        public bool TryGetProperty(ReadOnlySpan<byte> propertyName, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ResizableLayoutVariantCardProperties value)
        {
            CheckValidInstance();
        ...
        /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public bool TryGetProperty(ReadOnlySpan<char> propertyName, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ResizableLayoutVariantCardProperties value)
        {
            CheckValidInstance();
            return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
        }
        ...
        /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public bool TryGetProperty(string propertyName, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ResizableLayoutVariantCardProperties value)
        {
            CheckValidInstance();
            return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
        }
        ...
        /// <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ResizableLayoutVariantCardProperties"/>.
        /// </summary>
        ...
        public static bool MatchesPatternResizableLayoutVariantCardProperties(ReadOnlySpan<byte> propertyName)
        {
        ...
        /// <returns><see langword="true"/> if the property name matches the pattern, otherwise <see langword="false"/>.</returns>
        public static bool TryAsPatternResizableLayoutVariantCardProperties(ReadOnlySpan<byte> propertyName, in JsonElement value, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ResizableLayoutVariantCardProperties result)
        {
            if (MatchesPatternResizableLayoutVariantCardProperties(propertyName))
            {
                result = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ResizableLayoutVariantCardProperties.From(value);
                return true;
            }
        ...
        public interface IPatternPropertyVisitor<TState>
        {
            ...
            /// </summary>
            bool VisitPatternResizableLayoutVariantCardProperties(ReadOnlySpan<byte> name, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ResizableLayoutVariantCardProperties value, ref TState state);
            ...
            where TVisitor : IPatternPropertyVisitor<TState>
        {
            ...
            foreach (var property in EnumerateObject())
            {
                ...
                {
                    matched = true;
                    Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ResizableLayoutVariantCardProperties typedValue = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ResizableLayoutVariantCardProperties.From(property.Value);
                    if (!visitor.VisitPatternResizableLayoutVariantCardProperties(propertyName, in typedValue, ref state))
                    {
                        return false;
                    }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public ObjectEnumerator<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ResizableLayoutVariantCardProperties> EnumerateObject()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateObjectEnumerator<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.ResizableLayoutVariantCardProperties>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in ResizableLayoutVariant left, in ResizableLayoutVariant right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ResizableLayoutVariant left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(ResizableLayoutVariant instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ResizableLayoutVariant(JsonElement instance)
        {
            return ResizableLayoutVariant.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ResizableLayoutVariant From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ResizableLayoutVariant ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ResizableLayoutVariant>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ResizableLayoutVariant ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ResizableLayoutVariant>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ResizableLayoutVariant ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ResizableLayoutVariant>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static ResizableLayoutVariant ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<ResizableLayoutVariant>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ResizableLayoutVariant? result)
        {
            return JsonElementHelpers.TryParseValue<ResizableLayoutVariant>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new ResizableLayoutVariant(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static ResizableLayoutVariant IJsonElement<ResizableLayoutVariant>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ResizableLayoutVariant: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="ResizableLayoutVariant"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="ResizableLayoutVariant"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public ResizableLayoutVariant Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<ResizableLayoutVariant>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="ResizableLayoutVariant"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public ResizableLayoutVariant Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ResizableLayoutVariant>(_idx);
            }
