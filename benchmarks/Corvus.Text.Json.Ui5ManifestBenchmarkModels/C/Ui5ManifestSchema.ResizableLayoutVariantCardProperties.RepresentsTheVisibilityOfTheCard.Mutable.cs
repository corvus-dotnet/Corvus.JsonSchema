...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct ResizableLayoutVariantCardProperties
    {
        ...
        public readonly partial struct RepresentsTheVisibilityOfTheCard
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<RepresentsTheVisibilityOfTheCard, Mutable>(RepresentsTheVisibilityOfTheCard.DefaultInstance);
                ...
                public static explicit operator Mutable(RepresentsTheVisibilityOfTheCard instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsTheVisibilityOfTheCard"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsTheVisibilityOfTheCard(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new RepresentsTheVisibilityOfTheCard(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsTheVisibilityOfTheCard.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="RepresentsTheVisibilityOfTheCard"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="RepresentsTheVisibilityOfTheCard"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheVisibilityOfTheCard Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<RepresentsTheVisibilityOfTheCard>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="RepresentsTheVisibilityOfTheCard"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheVisibilityOfTheCard Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsTheVisibilityOfTheCard>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsTheVisibilityOfTheCard instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RepresentsTheVisibilityOfTheCard, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RepresentsTheVisibilityOfTheCard> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RepresentsTheVisibilityOfTheCard>();
                }
                finally
                {
