...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct ResizableLayoutVariantCardProperties
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RepresentsTheVisibilityOfTheCard"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RepresentsTheVisibilityOfTheCard(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RepresentsTheVisibilityOfTheCard DefaultInstance { get; } = ParsedJsonDocument<RepresentsTheVisibilityOfTheCard>.True;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(RepresentsTheVisibilityOfTheCard value)
            {
            ...
            /// </returns>
            public static bool operator ==(in RepresentsTheVisibilityOfTheCard left, in RepresentsTheVisibilityOfTheCard right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RepresentsTheVisibilityOfTheCard left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(RepresentsTheVisibilityOfTheCard instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RepresentsTheVisibilityOfTheCard(JsonElement instance)
            {
                return RepresentsTheVisibilityOfTheCard.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheVisibilityOfTheCard From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheVisibilityOfTheCard ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheVisibilityOfTheCard>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheVisibilityOfTheCard ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheVisibilityOfTheCard>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheVisibilityOfTheCard ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheVisibilityOfTheCard>(json, options);
            }
            ...
            /// </exception>
            public static RepresentsTheVisibilityOfTheCard ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheVisibilityOfTheCard>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsTheVisibilityOfTheCard? result)
            {
                return JsonElementHelpers.TryParseValue<RepresentsTheVisibilityOfTheCard>(ref reader, out result);
            }
...
#if NET
            static RepresentsTheVisibilityOfTheCard IJsonElement<RepresentsTheVisibilityOfTheCard>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RepresentsTheVisibilityOfTheCard: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public RepresentsTheVisibilityOfTheCard Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public RepresentsTheVisibilityOfTheCard Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RepresentsTheVisibilityOfTheCard>(_idx);
                }
