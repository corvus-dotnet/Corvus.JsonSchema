...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct Resource
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="JsRequiredUriEntiArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal JsRequiredUriEntiArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static JsRequiredUriEntiArray DefaultInstance { get; }
            ...
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Resource.JsRequiredUriEntiArray.RequiredUriEntity this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Resource.JsRequiredUriEntiArray.RequiredUriEntity>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Resource.JsRequiredUriEntiArray.RequiredUriEntity> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Resource.JsRequiredUriEntiArray.RequiredUriEntity>(_parent, _idx);
            }
            ...
            /// </returns>
            public static bool operator ==(in JsRequiredUriEntiArray left, in JsRequiredUriEntiArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in JsRequiredUriEntiArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(JsRequiredUriEntiArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsRequiredUriEntiArray(JsonElement instance)
            {
                return JsRequiredUriEntiArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static JsRequiredUriEntiArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static JsRequiredUriEntiArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<JsRequiredUriEntiArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static JsRequiredUriEntiArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<JsRequiredUriEntiArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static JsRequiredUriEntiArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<JsRequiredUriEntiArray>(json, options);
            }
            ...
            /// </exception>
            public static JsRequiredUriEntiArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<JsRequiredUriEntiArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out JsRequiredUriEntiArray? result)
            {
                return JsonElementHelpers.TryParseValue<JsRequiredUriEntiArray>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new JsRequiredUriEntiArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static JsRequiredUriEntiArray IJsonElement<JsRequiredUriEntiArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"JsRequiredUriEntiArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="JsRequiredUriEntiArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="JsRequiredUriEntiArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public JsRequiredUriEntiArray Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<JsRequiredUriEntiArray>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="JsRequiredUriEntiArray"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public JsRequiredUriEntiArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<JsRequiredUriEntiArray>(_idx);
                }
