...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct Resource
    {
...
#endif
        {
            ...
            /// </summary>
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Resource.RequiredUriEntityArray.Mutable Css
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.CssUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Resource.RequiredUriEntityArray.Mutable value))
                    {
                        return value;
                    }
            ...
            /// <summary>
            /// Gets the (optional) <c>js</c> property.
            /// </summary>
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Resource.JsRequiredUriEntiArray.Mutable Js
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.JsUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Resource.JsRequiredUriEntiArray.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetCss<TContext>(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Resource.RequiredUriEntityArray.Source<TContext> value)
            ...
            public void SetJs(scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Resource.JsRequiredUriEntiArray.Source value)
            {
                ...
                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.JsUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.JsUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Js, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetJs<TContext>(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Resource.JsRequiredUriEntiArray.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
            ...
            /// <summary>
            /// Remove the <c>js</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveJs()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.JsUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Resource.RequiredUriEntityArray.Source _createArg1;
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Resource.JsRequiredUriEntiArray.Source _createArg2;
            ...
            #endif
        {
            ...
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Resource.RequiredUriEntityArray.Source<TContext> _createArg1;
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Resource.JsRequiredUriEntiArray.Source<TContext> _createArg2;
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Resource.RequiredUriEntityArray.Source css = default,
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Resource.JsRequiredUriEntiArray.Source js = default)
            {
                css.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Css, ref builder);
                js.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Js, ref builder);
            }

            /// <summary>
            /// Creates an instance of a <see cref="Resource"/>.
            /// </summary>
            public void Create(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Resource.RequiredUriEntityArray.Source css = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Resource.JsRequiredUriEntiArray.Source js = default)
            {
                Create(ref _builder, css, js);
            }
            ...
            internal static void Create<TContext>(
                in TContext context,
                ref ComplexValueBuilder builder,
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Resource.RequiredUriEntityArray.Source<TContext> css = default,
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Resource.JsRequiredUriEntiArray.Source<TContext> js = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            #endif
            {
                Create(context, ref _builder, css, js);
            }
        ...
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Resource.RequiredUriEntityArray.Source<TContext> css = default, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Resource.JsRequiredUriEntiArray.Source<TContext> js = default)
            ...
            #endif
        {
            return new Source<TContext>(context, css, js);
        }
        ...
        /// <param name="js">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Resource.RequiredUriEntityArray.Source css = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Resource.JsRequiredUriEntiArray.Source js = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Resource.RequiredUriEntityArray.Source<TContext> css = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Resource.JsRequiredUriEntiArray.Source<TContext> js = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
        ...
        public static ParsedJsonDocument<Resource> Create(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Resource.RequiredUriEntityArray.Source css = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Resource.JsRequiredUriEntiArray.Source js = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Resource> Create<TContext>(in TContext context, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Resource.RequiredUriEntityArray.Source<TContext> css = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Resource.JsRequiredUriEntiArray.Source<TContext> js = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
