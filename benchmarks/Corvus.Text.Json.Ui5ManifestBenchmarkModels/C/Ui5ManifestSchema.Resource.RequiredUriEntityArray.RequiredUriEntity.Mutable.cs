...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct Resource
    {
        ...
        public readonly partial struct RequiredUriEntityArray
        {
            ...
            public readonly partial struct RequiredUriEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(RequiredUriEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="RequiredUriEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RequiredUriEntity(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new RequiredUriEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RequiredUriEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="RequiredUriEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="RequiredUriEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RequiredUriEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<RequiredUriEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="RequiredUriEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RequiredUriEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<RequiredUriEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Resource.RequiredUriEntityArray.RequiredUriEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    public static implicit operator Source(RequiredUriEntity instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Resource.RequiredUriEntityArray.RequiredUriEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// <summary>
                    /// Creates an instance of a <see cref="RequiredUriEntity"/>.
                    /// </summary>
                    ...
                    /// Creates an instance of a <see cref="RequiredUriEntity"/>.
                    /// </summary>
                    public void Create(in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source uri, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source id = default)
                    {
                        Create(ref _builder, uri, id);
                    }
                ...
                /// <returns>The source from which to build the value.</returns>
                public static Source Build(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source uri, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source id = default)
                {
                    return new Source(uri, id);
                }
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source uri, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source id = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                ...
                {
                    return workspace.CreateBuilder<RequiredUriEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<RequiredUriEntity> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<RequiredUriEntity>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<RequiredUriEntity> Create<TContext>(
                ...
                public static ParsedJsonDocument<RequiredUriEntity> Create(in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source uri, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source id = default, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
