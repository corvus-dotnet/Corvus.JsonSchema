...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct RootViewDef
    {
...
#endif
        {
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RootViewDef.RequiredViewName" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsRequiredViewName(out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RootViewDef.RequiredViewName result)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RootViewDef.RequiredViewName.JsonSchema.Evaluate(_parent, _idx))
                {
