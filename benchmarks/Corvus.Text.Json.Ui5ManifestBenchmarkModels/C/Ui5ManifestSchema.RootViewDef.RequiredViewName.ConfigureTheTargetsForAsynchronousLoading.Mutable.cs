...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct RootViewDef
    {
        ...
        public readonly partial struct RequiredViewName
        {
            ...
            public readonly partial struct ConfigureTheTargetsForAsynchronousLoading
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<ConfigureTheTargetsForAsynchronousLoading, Mutable>(ConfigureTheTargetsForAsynchronousLoading.DefaultInstance);
                    ...
                    public static explicit operator Mutable(ConfigureTheTargetsForAsynchronousLoading instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ConfigureTheTargetsForAsynchronousLoading"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ConfigureTheTargetsForAsynchronousLoading(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new ConfigureTheTargetsForAsynchronousLoading(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ConfigureTheTargetsForAsynchronousLoading.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="ConfigureTheTargetsForAsynchronousLoading"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="ConfigureTheTargetsForAsynchronousLoading"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ConfigureTheTargetsForAsynchronousLoading Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<ConfigureTheTargetsForAsynchronousLoading>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="ConfigureTheTargetsForAsynchronousLoading"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ConfigureTheTargetsForAsynchronousLoading Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ConfigureTheTargetsForAsynchronousLoading>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(ConfigureTheTargetsForAsynchronousLoading instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<ConfigureTheTargetsForAsynchronousLoading, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<ConfigureTheTargetsForAsynchronousLoading> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<ConfigureTheTargetsForAsynchronousLoading>();
                    }
                    finally
                    {
