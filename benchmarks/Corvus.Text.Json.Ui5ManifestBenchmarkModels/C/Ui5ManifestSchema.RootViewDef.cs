...
public readonly partial struct Ui5ManifestSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RootViewDef"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal RootViewDef(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static RootViewDef DefaultInstance { get; }
        ...
        public static explicit operator Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RootViewDef.RequiredViewName(RootViewDef value)
        {
            return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RootViewDef.RequiredViewName.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator RootViewDef(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RootViewDef.RequiredViewName value)
        {
            return From(value);
        }

        /// <summary>
        /// Conversion from the <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RootViewDef.RequiredViewName"/> mutable view.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator RootViewDef(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RootViewDef.RequiredViewName.Mutable value)
        {
            return From(value);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(RootViewDef value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in RootViewDef left, in RootViewDef right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in RootViewDef left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(RootViewDef instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator RootViewDef(JsonElement instance)
        {
            return RootViewDef.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RootViewDef From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RootViewDef ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<RootViewDef>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RootViewDef ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<RootViewDef>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RootViewDef ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<RootViewDef>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static RootViewDef ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<RootViewDef>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out RootViewDef? result)
        {
            return JsonElementHelpers.TryParseValue<RootViewDef>(ref reader, out result);
        }
...
#if NET
        static RootViewDef IJsonElement<RootViewDef>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"RootViewDef: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public bool TryGetAsRequiredViewName(out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RootViewDef.RequiredViewName result)
        {
            ...
            {
                result = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RootViewDef.RequiredViewName.From(this);
                return true;
            }
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RootViewDef, TContext, TResult> defaultMatch)
...
#endif
        {
            ...
            if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RootViewDef.RequiredViewName.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredViewName(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RootViewDef.RequiredViewName.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RootViewDef, TResult> defaultMatch)
        {
            if (Corvus.Ui5ManifestBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
            {
            ...
            if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RootViewDef.RequiredViewName.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredViewName(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RootViewDef.RequiredViewName.From(this));
            }
