...
public readonly partial struct Ui5ManifestSchema
{
        ...
        : IJsonElement<RootViewDefFlexEnabled>
    {
        public static partial class JsonSchema
        {
            ...
            private static void MatchAsync(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
            {
            ...
            private static void MatchViewName(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
            {
                context.AddLocalEvaluatedProperty(propertyCount);
