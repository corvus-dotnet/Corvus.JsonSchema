...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct RootViewDefFlexEnabled
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RootViewDefFlexEnabled.ConfigureTheTargetsForAsynchronousLoading.Mutable Async
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AsyncUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RootViewDefFlexEnabled.ConfigureTheTargetsForAsynchronousLoading.Mutable value))
                    {
                        return value;
                    }

                    return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RootViewDefFlexEnabled.ConfigureTheTargetsForAsynchronousLoading.Mutable.DefaultInstance;
                }
            }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RootViewDefFlexEnabled.TypeEntity.Mutable Type
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RootViewDefFlexEnabled.TypeEntity.Mutable value))
                    {
                        return value;
                    }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RootViewDefFlexEnabled.ConfigureTheTargetsForAsynchronousLoading.Source _createArg3;
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RootViewDefFlexEnabled.TypeEntity.Source _createArg4;
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RootViewDefFlexEnabled.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RootViewDefFlexEnabled.ConfigureTheTargetsForAsynchronousLoading.Source async = default,
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RootViewDefFlexEnabled.TypeEntity.Source type = default)
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source id, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source viewName, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RootViewDefFlexEnabled.ConfigureTheTargetsForAsynchronousLoading.Source async = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RootViewDefFlexEnabled.TypeEntity.Source type = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        public static ParsedJsonDocument<RootViewDefFlexEnabled> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<RootViewDefFlexEnabled>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<RootViewDefFlexEnabled> Create<TContext>(
        ...
        public static ParsedJsonDocument<RootViewDefFlexEnabled> Create(in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source id, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source viewName, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RootViewDefFlexEnabled.ConfigureTheTargetsForAsynchronousLoading.Source async = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RootViewDefFlexEnabled.TypeEntity.Source type = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
