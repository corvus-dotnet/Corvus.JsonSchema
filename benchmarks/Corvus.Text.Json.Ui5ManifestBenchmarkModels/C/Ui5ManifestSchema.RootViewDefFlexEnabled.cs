...
public readonly partial struct Ui5ManifestSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RootViewDefFlexEnabled"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal RootViewDefFlexEnabled(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static RootViewDefFlexEnabled DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RootViewDefFlexEnabled.ConfigureTheTargetsForAsynchronousLoading Async
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AsyncUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RootViewDefFlexEnabled.ConfigureTheTargetsForAsynchronousLoading value))
                {
                    return value;
                }

                return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RootViewDefFlexEnabled.ConfigureTheTargetsForAsynchronousLoading.DefaultInstance;
            }
        }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RootViewDefFlexEnabled.TypeEntity Type
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RootViewDefFlexEnabled.TypeEntity value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in RootViewDefFlexEnabled left, in RootViewDefFlexEnabled right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in RootViewDefFlexEnabled left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(RootViewDefFlexEnabled instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator RootViewDefFlexEnabled(JsonElement instance)
        {
            return RootViewDefFlexEnabled.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RootViewDefFlexEnabled From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RootViewDefFlexEnabled ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RootViewDefFlexEnabled>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RootViewDefFlexEnabled ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RootViewDefFlexEnabled>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RootViewDefFlexEnabled ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RootViewDefFlexEnabled>(json, options);
        }
        ...
        /// </exception>
        public static RootViewDefFlexEnabled ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<RootViewDefFlexEnabled>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out RootViewDefFlexEnabled? result)
        {
            return JsonElementHelpers.TryParseValue<RootViewDefFlexEnabled>(ref reader, out result);
        }
...
#if NET
        static RootViewDefFlexEnabled IJsonElement<RootViewDefFlexEnabled>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"RootViewDefFlexEnabled: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public RootViewDefFlexEnabled Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public RootViewDefFlexEnabled Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<RootViewDefFlexEnabled>(_idx);
            }
