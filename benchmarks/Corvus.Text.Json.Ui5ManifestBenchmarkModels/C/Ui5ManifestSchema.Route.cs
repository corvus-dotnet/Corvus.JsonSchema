...
public readonly partial struct Ui5ManifestSchema
{
...
#endif
    {
        ...
        internal Route(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static Route DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.JsonBoolean Greedy
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.GreedyUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonBoolean value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.JsonString Name
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.NameUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.JsonString Pattern
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PatternUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTarget Target
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TargetUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTarget value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.JsonString TitleTarget
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TitleTargetUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString value))
                {
                    return value;
                }
        ...
        /// <summary>
        /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteWithoutName"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteWithoutName(Route value)
        {
            return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteWithoutName.From(value);
        }

        /// <summary>
        /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteWithoutName"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Route(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteWithoutName value)
        {
            return From(value);
        }

        /// <summary>
        /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Route.RequiredName"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Route.RequiredName(Route value)
        {
            return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Route.RequiredName.From(value);
        }

        /// <summary>
        /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Route.RequiredName"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Route(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Route.RequiredName value)
        {
            return From(value);
        }
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Route left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(Route instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Route(JsonElement instance)
        {
            return Route.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Route From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Route ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Route>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Route ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Route>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Route ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Route>(json, options);
        }
        ...
        /// </exception>
        public static Route ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<Route>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Route? result)
        {
            return JsonElementHelpers.TryParseValue<Route>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new Route(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static Route IJsonElement<Route>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Route: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="Route"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="Route"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        {
            CheckValidInstance();
            return _parent.CloneElement<Route>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="Route"/> that lives for the lifetime of its
        ...
        public Route Freeze()
        {
            ...
            {
                return mutable.FreezeElement<Route>(_idx);
            }
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Route.RequiredName" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsRequiredName(out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Route.RequiredName result)
        {
            if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Route.RequiredName.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Route.RequiredName.From(this);
                return true;
            }
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteWithoutName" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsRouteWithoutName(out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteWithoutName result)
        {
            if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteWithoutName.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteWithoutName.From(this);
                return true;
            }
        ...
        /// <param name="matchRouteWithoutName">Match a <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteWithoutName"/>.</param>
        /// <param name="matchRequiredName">Match a <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Route.RequiredName"/>.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteWithoutName, TContext, TResult> matchRouteWithoutName,
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Route.RequiredName, TContext, TResult> matchRequiredName,
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Route, TContext, TResult> defaultMatch)
...
#endif
        {
            if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteWithoutName.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRouteWithoutName(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteWithoutName.From(this), context);
            }

            if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Route.RequiredName.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredName(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Route.RequiredName.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteWithoutName, TResult> matchRouteWithoutName,
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Route.RequiredName, TResult> matchRequiredName,
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Route, TResult> defaultMatch)
        {
            if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteWithoutName.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRouteWithoutName(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteWithoutName.From(this));
            }

            if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Route.RequiredName.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRequiredName(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Route.RequiredName.From(this));
            }
