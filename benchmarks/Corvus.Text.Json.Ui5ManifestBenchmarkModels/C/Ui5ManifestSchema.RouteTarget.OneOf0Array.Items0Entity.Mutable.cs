        ...
        public readonly partial struct OneOf0Array
        {
            ...
            public readonly partial struct Items0Entity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(Items0Entity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="Items0Entity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Items0Entity(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new Items0Entity(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"Items0Entity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="Items0Entity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="Items0Entity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly Items0Entity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<Items0Entity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="Items0Entity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly Items0Entity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<Items0Entity>(_idx);
                    }
                    ...
                    public TResult Match<TContext, TResult>(
                        ...
                        Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTarget.OneOf0Array.Items0Entity.Mutable, TContext, TResult> defaultMatch)
                    ...
                    public TResult Match<TResult>(
                        ...
                        Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTarget.OneOf0Array.Items0Entity.Mutable, TResult> defaultMatch)
                    {
                        if (Corvus.Ui5ManifestBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                        {
                ...
                {
                    return workspace.CreateBuilder<Items0Entity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<Items0Entity> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<Items0Entity>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<Items0Entity> Create<TContext>(
