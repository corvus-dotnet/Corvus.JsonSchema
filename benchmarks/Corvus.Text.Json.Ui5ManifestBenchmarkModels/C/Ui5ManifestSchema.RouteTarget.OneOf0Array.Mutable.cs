    ...
    public readonly partial struct RouteTarget
    {
        ...
        public readonly partial struct OneOf0Array
        {
...
#endif
            {
                ...
                /// <exception cref="IndexOutOfRangeException">The index was outside the bounds of the array.</exception>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTarget.OneOf0Array.Items0Entity.Mutable Item1
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTarget.OneOf0Array.Items0Entity.Mutable>(_idx, 0);
                    }
                }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTarget.OneOf0Array.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTarget.OneOf0Array.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                public void CreateTuple(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTarget.OneOf0Array.Items0Entity.Source item1)
                {
            ...
            public static ParsedJsonDocument<OneOf0Array> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<OneOf0Array>();
                }
                finally
                {
