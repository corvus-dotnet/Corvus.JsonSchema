...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct RouteTarget
#if NET8_0_OR_GREATER
        : IJsonElement<RouteTarget>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RouteTarget"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal RouteTarget(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static RouteTarget DefaultInstance { get; }
        ...
        /// <summary>
        /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTarget.OneOf0Array"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTarget.OneOf0Array(RouteTarget value)
        {
            return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTarget.OneOf0Array.From(value);
        }

        /// <summary>
        /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTarget.OneOf0Array"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator RouteTarget(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTarget.OneOf0Array value)
        {
            return From(value);
        }

        /// <summary>
        /// Conversion from the <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTarget.OneOf0Array"/> mutable view.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator RouteTarget(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTarget.OneOf0Array.Mutable value)
        {
            return From(value);
        }

        /// <summary>
        /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTargetObject"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTargetObject(RouteTarget value)
        {
            return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTargetObject.From(value);
        }

        /// <summary>
        /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTargetObject"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator RouteTarget(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTargetObject value)
        {
            return From(value);
        }

        /// <summary>
        /// Conversion from the <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTargetObject"/> mutable view.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator RouteTarget(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTargetObject.Mutable value)
        {
            return From(value);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(RouteTarget value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in RouteTarget left, in RouteTarget right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in RouteTarget left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(RouteTarget instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator RouteTarget(JsonElement instance)
        {
            return RouteTarget.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RouteTarget From<T>(in T instance)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RouteTarget ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<RouteTarget>(utf8Json, options);
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RouteTarget ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<RouteTarget>(json, options);
            #pragma warning restore CS0618
        }
        ...
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RouteTarget ParseValue(string json, JsonDocumentOptions options = default)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<RouteTarget>(json, options);
            #pragma warning restore CS0618
        ...
        /// </exception>
        [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
        public static RouteTarget ParseValue(ref Utf8JsonReader reader)
        {
            #pragma warning disable CS0618 // Type or member is obsolete
            return JsonElementHelpers.ParseValue<RouteTarget>(ref reader);
            #pragma warning restore CS0618
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out RouteTarget? result)
        {
            return JsonElementHelpers.TryParseValue<RouteTarget>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new RouteTarget(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static RouteTarget IJsonElement<RouteTarget>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"RouteTarget: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="RouteTarget"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="RouteTarget"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public RouteTarget Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<RouteTarget>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="RouteTarget"/> that lives for the lifetime of its
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTarget.OneOf0Array" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsOneOf0Array(out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTarget.OneOf0Array result)
        {
            if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTarget.OneOf0Array.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTarget.OneOf0Array.From(this);
                return true;
            }
        ...
        /// <summary>
        /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTargetObject" />.
        /// </summary>
        /// <param name="result">The result of the conversions.</param>
        /// <returns><see langword="true" /> if the conversion was valid.</returns>
        public bool TryGetAsRouteTargetObject(out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTargetObject result)
        {
            if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTargetObject.JsonSchema.Evaluate(_parent, _idx))
            {
                result = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTargetObject.From(this);
                return true;
            }
        ...
        /// <param name="matchOneOf0Array">Match a <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTarget.OneOf0Array"/>.</param>
        /// <param name="matchJsonString">Match a <see cref="Corvus.Ui5ManifestBenchmark.Current.JsonString"/>.</param>
        /// <param name="matchRouteTargetObject">Match a <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTargetObject"/>.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTarget.OneOf0Array, TContext, TResult> matchOneOf0Array,
            Matcher<Corvus.Ui5ManifestBenchmark.Current.JsonString, TContext, TResult> matchJsonString,
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTargetObject, TContext, TResult> matchRouteTargetObject,
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTarget, TContext, TResult> defaultMatch)
...
#endif
        {
            if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTarget.OneOf0Array.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchOneOf0Array(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTarget.OneOf0Array.From(this), context);
            }
            ...
            if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTargetObject.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRouteTargetObject(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTargetObject.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTarget.OneOf0Array, TResult> matchOneOf0Array,
            Matcher<Corvus.Ui5ManifestBenchmark.Current.JsonString, TResult> matchJsonString,
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTargetObject, TResult> matchRouteTargetObject,
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTarget, TResult> defaultMatch)
        {
            if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTarget.OneOf0Array.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchOneOf0Array(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTarget.OneOf0Array.From(this));
            }
            ...
            if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTargetObject.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchRouteTargetObject(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTargetObject.From(this));
            }
