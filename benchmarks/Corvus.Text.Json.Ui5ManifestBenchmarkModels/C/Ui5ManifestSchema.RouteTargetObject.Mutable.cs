...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct RouteTargetObject
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(RouteTargetObject instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="RouteTargetObject"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RouteTargetObject(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable Prefix
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PrefixUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTargetObject.PropagateTitleEntity.Mutable PropagateTitle
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PropagateTitleUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTargetObject.PropagateTitleEntity.Mutable value))
                    {
                        return value;
                    }

                    return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTargetObject.PropagateTitleEntity.Mutable.DefaultInstance;
                }
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RouteTargetObject(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RouteTargetObject.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RouteTargetObject"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RouteTargetObject"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly RouteTargetObject Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RouteTargetObject>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RouteTargetObject"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly RouteTargetObject Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<RouteTargetObject>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTargetObject.PropagateTitleEntity.Source _createArg3;
            ...
            public static implicit operator Source(RouteTargetObject instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTargetObject.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="RouteTargetObject"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source name = default,
                in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source prefix = default,
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTargetObject.PropagateTitleEntity.Source propagateTitle = default)
            {
            ...
            public void Create(
                ...
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTargetObject.PropagateTitleEntity.Source propagateTitle = default)
            {
                Create(ref _builder, name, prefix, propagateTitle);
            }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source name = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source prefix = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTargetObject.PropagateTitleEntity.Source propagateTitle = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(name, prefix, propagateTitle);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<RouteTargetObject, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<RouteTargetObject> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<RouteTargetObject>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<RouteTargetObject> Create<TContext>(
        ...
        public static ParsedJsonDocument<RouteTargetObject> Create(in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source name = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source prefix = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteTargetObject.PropagateTitleEntity.Source propagateTitle = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
