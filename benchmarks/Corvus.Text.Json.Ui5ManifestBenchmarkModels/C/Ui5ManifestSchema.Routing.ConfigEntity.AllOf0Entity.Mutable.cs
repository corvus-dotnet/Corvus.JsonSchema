        ...
        public readonly partial struct ConfigEntity
        {
            ...
            public readonly partial struct AllOf0Entity
            {
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Routing.ConfigEntity.AllOf0Entity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Routing.ConfigEntity.AllOf0Entity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    public void Create(
                        ...
                        in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source viewPath = default)
                    {
                        Create(ref _builder, async, bypassed, propagateTitle, routerClass, viewPath);
                    }
                    ...
                    #endif
                    {
                        Create(context, ref _builder, async, bypassed, propagateTitle, routerClass, viewPath);
                    }
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Routing.ConfigEntity.AllOf0Entity.IndicatesWhetherTheViewsInRoutingAreLoadedAsyncly.Source async = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Routing.ConfigEntity.AllOf0Entity.RequiredTarget.Source bypassed = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Routing.ConfigEntity.AllOf0Entity.PropagateTitleEntity.Source propagateTitle = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source routerClass = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source viewPath = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                    Builder ovb = new(cvb);
                    ovb.Create(async, bypassed, propagateTitle, routerClass, viewPath);
                    cvb = ovb._builder;
                    cvb.EndObject();
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
                ...
                /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
                /// <returns>An instance of a mutable document initialized with the given property values.</returns>
                public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Routing.ConfigEntity.AllOf0Entity.IndicatesWhetherTheViewsInRoutingAreLoadedAsyncly.Source async = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Routing.ConfigEntity.AllOf0Entity.RequiredTarget.Source<TContext> bypassed = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Routing.ConfigEntity.AllOf0Entity.PropagateTitleEntity.Source propagateTitle = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source routerClass = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source viewPath = default, int initialCapacity = 30)
                    #if NET9_0_OR_GREATER
                    where TContext : allows ref struct
                    #endif
                {
                    ...
                    cvb.StartObject();
                    Builder ovb = new(cvb);
                    ovb.Create(context, async, bypassed, propagateTitle, routerClass, viewPath);
                    cvb = ovb._builder;
                    cvb.EndObject();
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder;
