    ...
    public readonly partial struct Routing
    {
        ...
        public readonly partial struct ConfigEntity
        {
            ...
            public readonly partial struct AllOf0Entity
            {
                ...
                public readonly partial struct PropagateTitleEntity
#if NET8_0_OR_GREATER
                    : IJsonElement<PropagateTitleEntity>,
                      IFormattable,
                      ISpanFormattable,
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="PropagateTitleEntity"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal PropagateTitleEntity(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static PropagateTitleEntity DefaultInstance { get; } = ParsedJsonDocument<PropagateTitleEntity>.False;
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator bool(PropagateTitleEntity value)
                    {
                    ...
                    /// </returns>
                    public static bool operator ==(in PropagateTitleEntity left, in PropagateTitleEntity right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in PropagateTitleEntity left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator JsonElement(PropagateTitleEntity instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator PropagateTitleEntity(JsonElement instance)
                    {
                        return PropagateTitleEntity.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static PropagateTitleEntity From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static PropagateTitleEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<PropagateTitleEntity>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static PropagateTitleEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<PropagateTitleEntity>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static PropagateTitleEntity ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<PropagateTitleEntity>(json, options);
                    }
                    ...
                    /// </exception>
                    public static PropagateTitleEntity ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<PropagateTitleEntity>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out PropagateTitleEntity? result)
                    {
                        return JsonElementHelpers.TryParseValue<PropagateTitleEntity>(ref reader, out result);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new PropagateTitleEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                    static PropagateTitleEntity IJsonElement<PropagateTitleEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"PropagateTitleEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="PropagateTitleEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="PropagateTitleEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public PropagateTitleEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<PropagateTitleEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="PropagateTitleEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public PropagateTitleEntity Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<PropagateTitleEntity>(_idx);
                        }
