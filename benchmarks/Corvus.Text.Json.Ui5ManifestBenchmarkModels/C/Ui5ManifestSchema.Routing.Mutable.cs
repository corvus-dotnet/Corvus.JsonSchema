...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct Routing
    {
...
#endif
        {
            ...
            public void SetConfig(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Routing.RepresentsTheDefaultPropertiesDefinedForRouteAndTarget.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetRoutes(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Routing.RoutesEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetTargets(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Routing.RepresentsTheDefinitionOfTargets.Source value)
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            internal Source(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Routing.RepresentsTheDefaultPropertiesDefinedForRouteAndTarget.Source arg1, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Routing.RoutesEntity.Source arg2, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Routing.RepresentsTheDefinitionOfTargets.Source arg3)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _createArg3 = arg3;
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Routing.RepresentsTheDefaultPropertiesDefinedForRouteAndTarget.Source<TContext> arg1, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Routing.RoutesEntity.Source<TContext> arg2, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Routing.RepresentsTheDefinitionOfTargets.Source<TContext> arg3)
            {
                _context = context;
                _createArg1 = arg1;
                _createArg2 = arg2;
