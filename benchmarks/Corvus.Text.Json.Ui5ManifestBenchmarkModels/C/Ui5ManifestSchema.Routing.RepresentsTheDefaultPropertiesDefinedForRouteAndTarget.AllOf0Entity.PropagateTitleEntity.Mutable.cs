            ...
            public readonly partial struct AllOf0Entity
            {
                ...
                public readonly partial struct PropagateTitleEntity
                {
...
#endif
                    {
                        ...
                        /// </remarks>
                        public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<PropagateTitleEntity, Mutable>(PropagateTitleEntity.DefaultInstance);
                    ...
                    public static ParsedJsonDocument<PropagateTitleEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<PropagateTitleEntity>();
                        }
                        finally
                        {
