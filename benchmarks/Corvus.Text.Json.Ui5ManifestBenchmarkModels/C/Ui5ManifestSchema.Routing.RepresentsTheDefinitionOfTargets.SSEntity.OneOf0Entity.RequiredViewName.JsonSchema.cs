                ...
                public readonly partial struct OneOf0Entity
                {
                        ...
                        : IJsonElement<RequiredViewName>
                    {
                        public static partial class JsonSchema
                        {
                            ...
                            private static void MatchViewId(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                            {
                            ...
                            private static void MatchViewPath(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                            {
                                context.AddLocalEvaluatedProperty(propertyCount);
