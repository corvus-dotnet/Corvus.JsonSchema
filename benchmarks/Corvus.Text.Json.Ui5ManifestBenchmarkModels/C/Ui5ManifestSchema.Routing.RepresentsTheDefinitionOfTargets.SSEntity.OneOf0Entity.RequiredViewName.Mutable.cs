                ...
                public readonly partial struct OneOf0Entity
                {
                    ...
                    public readonly partial struct RequiredViewName
                    {
...
#endif
                        {
                            ...
                            public static explicit operator Mutable(RequiredViewName instance)
                            {
                            ...
                            /// <returns>An immutable instance of a <see cref="RequiredViewName"/>, initialized from the <see cref="Mutable"/> value.</returns>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator RequiredViewName(Mutable instance)
                            {
                            ...
                            /// </para>
                            /// </remarks>
                            public Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable ViewId
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ViewIdUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable value))
                                    {
                                        return value;
                                    }
                            ...
                            /// </para>
                            /// </remarks>
                            public Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable ViewName
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ViewNameUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable value))
                                    {
                                        return value;
                                    }
                            ...
                            public void SetViewId(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source value)
                            {
                                CheckValidInstance();
                                ...
                                else
                                {
                                    ...
                                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ViewId, ref cvb);
                            ...
                            public void SetViewName(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source value)
                            {
                                ...
                                {
                                    // We are going to insert the new value
                                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ViewName, ref cvb);
                                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                                }
                            ...
                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            private string DebuggerDisplay => $"RequiredViewName.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly RequiredViewName Clone()
                            {
                                CheckValidInstance();
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly RequiredViewName Freeze()
                            {
                                CheckValidInstance();
                                return _parent.FreezeElement<RequiredViewName>(_idx);
                            }
                        }
                        ...
                        public ref struct Source
                        {
                            ...
                            internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Routing.RepresentsTheDefinitionOfTargets.SSEntity.OneOf0Entity.RequiredViewName.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                            ...
                            #endif
                        {
                            ...
                            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Routing.RepresentsTheDefinitionOfTargets.SSEntity.OneOf0Entity.RequiredViewName.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                        ...
                        public ref struct Builder
                        {
                            ...
                            /// <summary>
                            /// Creates an instance of a <see cref="RequiredViewName"/>.
                            /// </summary>
                            internal static void Create(
                                ref ComplexValueBuilder builder,
                                in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source viewName,
                                in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source viewId = default,
                                in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source viewPath = default)
                            {
                                viewName.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ViewName, ref builder);
                                viewId.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ViewId, ref builder);
                            ...
                            public void Create(
                                ...
                                in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source viewPath = default)
                            {
                                Create(ref _builder, viewName, viewId, viewPath);
                            }
                        ...
                        /// <param name="viewId">The value of the <c>"viewId"</c> property.</param>
                        /// <param name="viewPath">The value of the <c>"viewPath"</c> property.</param>
                        /// <returns>The source from which to build the value.</returns>
                        public static Source Build(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source viewName, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source viewId = default, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source viewPath = default)
                        {
                            return new Source(viewName, viewId, viewPath);
                        }
                        ...
                        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source viewName, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source viewId = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source viewPath = default, int initialCapacity = 30)
                        {
                            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                            cvb.StartObject();
                            Builder ovb = new(cvb);
                            ovb.Create(viewName, viewId, viewPath);
                            cvb = ovb._builder;
                            cvb.EndObject();
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder;
                        ...
                        {
                            return workspace.CreateBuilder<RequiredViewName, Mutable>(this);
                        }
                        ...
                        public static ParsedJsonDocument<RequiredViewName> Create(
                            scoped in Source value, int initialCapacity = 30)
                        {
                            ...
                            try
                            {
                                ...
                                Debug.Assert(cvb.MemberCount == 1);
                                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                return documentBuilder.ToParsedJsonDocument<RequiredViewName>();
                            }
                            finally
                            {
                        ...
                        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                        public static ParsedJsonDocument<RequiredViewName> Create<TContext>(
                        ...
                        public static ParsedJsonDocument<RequiredViewName> Create(in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source viewName, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source viewId = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source viewPath = default, int initialCapacity = 30)
                        {
                            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                            try
                            {
