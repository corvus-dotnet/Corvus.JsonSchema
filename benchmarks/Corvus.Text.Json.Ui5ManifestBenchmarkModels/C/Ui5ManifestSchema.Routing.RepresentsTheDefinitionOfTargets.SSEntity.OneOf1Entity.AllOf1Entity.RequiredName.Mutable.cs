                    ...
                    public readonly partial struct AllOf1Entity
                    {
                        ...
                        public readonly partial struct RequiredName
                        {
...
#endif
                            {
                                ...
                                /// </para>
                                /// </remarks>
                                public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Routing.RepresentsTheDefinitionOfTargets.SSEntity.OneOf1Entity.AllOf1Entity.RequiredName.RepresentsTheTypeOfTheTypeViewOrComponent.Mutable Type
                                {
                                    get
                                    {
                                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Routing.RepresentsTheDefinitionOfTargets.SSEntity.OneOf1Entity.AllOf1Entity.RequiredName.RepresentsTheTypeOfTheTypeViewOrComponent.Mutable value))
                                        {
                                            return value;
                                        }
                            ...
                            public ref struct Source
                            {
                                ...
                                private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Routing.RepresentsTheDefinitionOfTargets.SSEntity.OneOf1Entity.AllOf1Entity.RequiredName.RepresentsTheTypeOfTheTypeViewOrComponent.Source _createArg4;
                                ...
                                #endif
                            {
                                ...
                                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Routing.RepresentsTheDefinitionOfTargets.SSEntity.OneOf1Entity.AllOf1Entity.RequiredName.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                            ...
                            public ref struct Builder
                            {
                                ...
                                internal static void Create(
                                    ...
                                    in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Routing.RepresentsTheDefinitionOfTargets.SSEntity.OneOf1Entity.AllOf1Entity.RequiredName.RepresentsTheTypeOfTheTypeViewOrComponent.Source type = default)
                                {
                                ...
                                public void Create(
                                    ...
                                    in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Routing.RepresentsTheDefinitionOfTargets.SSEntity.OneOf1Entity.AllOf1Entity.RequiredName.RepresentsTheTypeOfTheTypeViewOrComponent.Source type = default)
                                {
                                    Create(ref _builder, name, id, path, type);
                                }
                            ...
                            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source name, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source id = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source path = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Routing.RepresentsTheDefinitionOfTargets.SSEntity.OneOf1Entity.AllOf1Entity.RequiredName.RepresentsTheTypeOfTheTypeViewOrComponent.Source type = default, int initialCapacity = 30)
                            {
                                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                                cvb.StartObject();
                                Builder ovb = new(cvb);
                                ovb.Create(name, id, path, type);
                                cvb = ovb._builder;
                                cvb.EndObject();
                                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                return documentBuilder;
                            ...
                            public static ParsedJsonDocument<RequiredName> Create(in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source name, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source id = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source path = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Routing.RepresentsTheDefinitionOfTargets.SSEntity.OneOf1Entity.AllOf1Entity.RequiredName.RepresentsTheTypeOfTheTypeViewOrComponent.Source type = default, int initialCapacity = 30)
                            {
                                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                                try
                                {
