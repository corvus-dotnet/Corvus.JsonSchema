            ...
            public readonly partial struct SSEntity
            {
                ...
                public readonly partial struct OneOf1Entity
                {
                    ...
                    public readonly partial struct AllOf1Entity
                    {
                        ...
                        public readonly partial struct RequiredTypeAndUsage
                            : IJsonElement<RequiredTypeAndUsage>
                        {
                            public static partial class JsonSchema
                            {
                                ...
                                private const uint RequiredBitMask0 =
                                    RequiredBitForType | RequiredBitForUsage;
                                ...
                                private static void MatchType(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                                {
                                    ...
                                    JsonSchemaContext childContext1 =
                                        Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Routing.RepresentsTheDefinitionOfTargets.SSEntity.OneOf1Entity.AllOf1Entity.RequiredTypeAndUsage.RepresentsTheTypeOfTheTypeComponent.JsonSchema.PushChildContextUnescaped(
                                            parentDocument,
                                            parentDocumentIndex,
                                            ref context,
                                    ...
                                    Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Routing.RepresentsTheDefinitionOfTargets.SSEntity.OneOf1Entity.AllOf1Entity.RequiredTypeAndUsage.RepresentsTheTypeOfTheTypeComponent.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                                ...
                                private static void MatchUsage(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, int depdendentSchemasChildHandler_propertyParentDocumentIndex, Span<uint> requiredBitBuffer)
                                {
                                    context.AddLocalEvaluatedProperty(propertyCount);
                                ...
                                /// </summary>
                                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("ui5-manifest-schema.json#/definitions/routing/properties/targets/patternProperties/[\\s\\S]*/oneOf/1/allOf/1/oneOf/1"u8, buffer, out written);

                                /// <summary>
                                /// Gets the schema location from which this type was generated.
                                /// </summary>
                                public const string SchemaLocation = "ui5-manifest-schema.json#/definitions/routing/properties/targets/patternProperties/[\\s\\S]*/oneOf/1/allOf/1/oneOf/1";

                                /// <summary>
                                /// Gets the schema location from which this type was generated as a UTF-8 string.
                                /// </summary>
                                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "ui5-manifest-schema.json#/definitions/routing/properties/targets/patternProperties/[\\s\\S]*/oneOf/1/allOf/1/oneOf/1"u8;
                                    ...
                                    ref JsonSchemaContext context)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                                        {
                                            ...
                                            context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyUsagePresent, "usage"u8, "required"u8);
                                        }
                                        ...
                                        else
                                        {
                                            ...
                                            {
                                                context.EvaluatedKeywordForProperty(false, 1, RequiredPropertyUsageNotPresent, "usage"u8, "required"u8);
                                            }
                                            else
                                            {
                                                context.EvaluatedKeywordForProperty(true, 1, RequiredPropertyUsagePresent, "usage"u8, "required"u8);
