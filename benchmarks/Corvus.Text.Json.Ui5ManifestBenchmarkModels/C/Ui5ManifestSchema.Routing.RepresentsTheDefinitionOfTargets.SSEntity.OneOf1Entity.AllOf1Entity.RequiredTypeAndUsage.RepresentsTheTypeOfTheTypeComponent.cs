                    ...
                    public readonly partial struct AllOf1Entity
                    {
                        ...
                        public readonly partial struct RequiredTypeAndUsage
                        {
...
#endif
                            {
                                ...
                                /// <summary>
                                /// Initializes a new instance of the <see cref="RepresentsTheTypeOfTheTypeComponent"/> struct.
                                /// </summary>
                                /// <param name="value">The value from which to construct the instance.</param>
                                internal RepresentsTheTypeOfTheTypeComponent(IJsonDocument parent, int idx)
                                {
                                    Debug.Assert(idx >= 0);
                                    _parent = parent;
                                    _idx = idx;
                                ...
                                /// </summary>
                                public static RepresentsTheTypeOfTheTypeComponent DefaultInstance { get; }
                                ...
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static explicit operator string(RepresentsTheTypeOfTheTypeComponent value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                                ...
                                /// </returns>
                                public static bool operator ==(in RepresentsTheTypeOfTheTypeComponent left, in RepresentsTheTypeOfTheTypeComponent right)
                                {
                                ...
                                /// <c>True</c> if the values are equal.
                                /// </returns>
                                public static bool operator ==(in RepresentsTheTypeOfTheTypeComponent left, in JsonElement right)
                                {
                                    return left.Equals(right);
                                }
                                ...
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static implicit operator JsonElement(RepresentsTheTypeOfTheTypeComponent instance)
                                {
                                ...
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static implicit operator RepresentsTheTypeOfTheTypeComponent(JsonElement instance)
                                {
                                    return RepresentsTheTypeOfTheTypeComponent.From(instance);
                                }
                                ...
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static RepresentsTheTypeOfTheTypeComponent From<T>(in T instance)
                                ...
                                /// </exception>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static RepresentsTheTypeOfTheTypeComponent ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                                {
                                    return JsonElementHelpers.ParseValue<RepresentsTheTypeOfTheTypeComponent>(utf8Json, options);
                                }
                                ...
                                /// </exception>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static RepresentsTheTypeOfTheTypeComponent ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                                {
                                    return JsonElementHelpers.ParseValue<RepresentsTheTypeOfTheTypeComponent>(json, options);
                                }
                                ...
                                /// </exception>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static RepresentsTheTypeOfTheTypeComponent ParseValue(string json, JsonDocumentOptions options = default)
                                {
                                    return JsonElementHelpers.ParseValue<RepresentsTheTypeOfTheTypeComponent>(json, options);
                                }
                                ...
                                /// </exception>
                                public static RepresentsTheTypeOfTheTypeComponent ParseValue(ref Utf8JsonReader reader)
                                {
                                    return JsonElementHelpers.ParseValue<RepresentsTheTypeOfTheTypeComponent>(ref reader);
                                }
                                ...
                                ///   A value could not be read from the reader.
                                /// </exception>
                                public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsTheTypeOfTheTypeComponent? result)
                                {
                                    return JsonElementHelpers.TryParseValue<RepresentsTheTypeOfTheTypeComponent>(ref reader, out result);
                                }
                                ...
                                {
                                    return
                                        (obj is IJsonElement value && Equals(new RepresentsTheTypeOfTheTypeComponent(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                                static RepresentsTheTypeOfTheTypeComponent IJsonElement<RepresentsTheTypeOfTheTypeComponent>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                private string DebuggerDisplay => $"RepresentsTheTypeOfTheTypeComponent: ValueKind = {ValueKind} : \"{ToString()}\"";
                                ...
                                /// <summary>
                                /// Gets a <see cref="RepresentsTheTypeOfTheTypeComponent"/> which can be safely stored beyond the lifetime of the
                                /// original document.
                                /// </summary>
                                /// <returns>
                                /// A <see cref="RepresentsTheTypeOfTheTypeComponent"/> which can be safely stored beyond the lifetime of the
                                /// original document.
                                /// </returns>
                                /// <remarks>
                                /// <para>
                                ...
                                /// </para>
                                /// </remarks>
                                public RepresentsTheTypeOfTheTypeComponent Clone()
                                {
                                    CheckValidInstance();
                                    return _parent.CloneElement<RepresentsTheTypeOfTheTypeComponent>(_idx);
                                }
                                ...
                                /// </summary>
                                /// <returns>
                                /// An immutable <see cref="RepresentsTheTypeOfTheTypeComponent"/> that lives for the lifetime of its
                                ...
                                /// </para>
                                /// </remarks>
                                public RepresentsTheTypeOfTheTypeComponent Freeze()
                                {
                                    CheckValidInstance();
                                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                                    {
                                        return mutable.FreezeElement<RepresentsTheTypeOfTheTypeComponent>(_idx);
                                    }
