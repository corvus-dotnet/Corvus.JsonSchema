                ...
                public readonly partial struct OneOf1Entity
                {
                    ...
                    public readonly partial struct AllOf1Entity
                    {
...
#endif
                        {
                            ...
                            /// <summary>
                            /// Initializes a new instance of the <see cref="RequiredTypeAndUsage"/> struct.
                            /// </summary>
                            /// <param name="value">The value from which to construct the instance.</param>
                            internal RequiredTypeAndUsage(IJsonDocument parent, int idx)
                            {
                                Debug.Assert(idx >= 0);
                                _parent = parent;
                                _idx = idx;
                            ...
                            /// </summary>
                            public static RequiredTypeAndUsage DefaultInstance { get; }
                            ...
                            /// </para>
                            /// </remarks>
                            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Routing.RepresentsTheDefinitionOfTargets.SSEntity.OneOf1Entity.AllOf1Entity.RequiredTypeAndUsage.RepresentsTheTypeOfTheTypeComponent Type
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Routing.RepresentsTheDefinitionOfTargets.SSEntity.OneOf1Entity.AllOf1Entity.RequiredTypeAndUsage.RepresentsTheTypeOfTheTypeComponent value))
                                    {
                                        return value;
                                    }
                            ...
                            /// </returns>
                            public static bool operator ==(in RequiredTypeAndUsage left, in RequiredTypeAndUsage right)
                            {
                            ...
                            /// <c>True</c> if the values are equal.
                            /// </returns>
                            public static bool operator ==(in RequiredTypeAndUsage left, in JsonElement right)
                            {
                                return left.Equals(right);
                            }
                            ...
                            public static implicit operator JsonElement(RequiredTypeAndUsage instance)
                            {
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator RequiredTypeAndUsage(JsonElement instance)
                            {
                                return RequiredTypeAndUsage.From(instance);
                            }
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static RequiredTypeAndUsage From<T>(in T instance)
                            ...
                            /// </exception>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static RequiredTypeAndUsage ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                            {
                                return JsonElementHelpers.ParseValue<RequiredTypeAndUsage>(utf8Json, options);
                            }
                            ...
                            /// </exception>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static RequiredTypeAndUsage ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                            {
                                return JsonElementHelpers.ParseValue<RequiredTypeAndUsage>(json, options);
                            }
                            ...
                            /// </exception>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static RequiredTypeAndUsage ParseValue(string json, JsonDocumentOptions options = default)
                            {
                                return JsonElementHelpers.ParseValue<RequiredTypeAndUsage>(json, options);
                            }
                            ...
                            /// </exception>
                            public static RequiredTypeAndUsage ParseValue(ref Utf8JsonReader reader)
                            {
                                return JsonElementHelpers.ParseValue<RequiredTypeAndUsage>(ref reader);
                            }
                            ...
                            ///   A value could not be read from the reader.
                            /// </exception>
                            public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredTypeAndUsage? result)
                            {
                                return JsonElementHelpers.TryParseValue<RequiredTypeAndUsage>(ref reader, out result);
                            }
                            ...
                            {
                                return
                                    (obj is IJsonElement value && Equals(new RequiredTypeAndUsage(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                            static RequiredTypeAndUsage IJsonElement<RequiredTypeAndUsage>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            private string DebuggerDisplay => $"RequiredTypeAndUsage: ValueKind = {ValueKind} : \"{ToString()}\"";
                            ...
                            /// <summary>
                            /// Gets a <see cref="RequiredTypeAndUsage"/> which can be safely stored beyond the lifetime of the
                            /// original document.
                            /// </summary>
                            /// <returns>
                            /// A <see cref="RequiredTypeAndUsage"/> which can be safely stored beyond the lifetime of the
                            /// original document.
                            /// </returns>
                            /// <remarks>
                            /// <para>
                            ...
                            /// </para>
                            /// </remarks>
                            public RequiredTypeAndUsage Clone()
                            {
                                CheckValidInstance();
                                return _parent.CloneElement<RequiredTypeAndUsage>(_idx);
                            }
                            ...
                            /// </summary>
                            /// <returns>
                            /// An immutable <see cref="RequiredTypeAndUsage"/> that lives for the lifetime of its
                            ...
                            /// </para>
                            /// </remarks>
                            public RequiredTypeAndUsage Freeze()
                            {
                                CheckValidInstance();
                                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                                {
                                    return mutable.FreezeElement<RequiredTypeAndUsage>(_idx);
                                }
