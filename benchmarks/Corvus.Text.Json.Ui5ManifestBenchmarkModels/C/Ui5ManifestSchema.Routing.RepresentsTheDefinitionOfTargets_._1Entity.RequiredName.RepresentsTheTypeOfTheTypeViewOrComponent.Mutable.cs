                        ...
                        public readonly partial struct RequiredName
                        {
                            ...
                            public readonly partial struct RepresentsTheTypeOfTheTypeViewOrComponent
                            {
...
#endif
                                {
                                    ...
                                    public static explicit operator Mutable(RepresentsTheTypeOfTheTypeViewOrComponent instance)
                                    {
                                    ...
                                    /// <returns>An immutable instance of a <see cref="RepresentsTheTypeOfTheTypeViewOrComponent"/>, initialized from the <see cref="Mutable"/> value.</returns>
                                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                    public static implicit operator RepresentsTheTypeOfTheTypeViewOrComponent(Mutable instance)
                                    {
                                    ...
                                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                    private string DebuggerDisplay => $"RepresentsTheTypeOfTheTypeViewOrComponent.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                                    ...
                                    /// </para>
                                    /// </remarks>
                                    public readonly RepresentsTheTypeOfTheTypeViewOrComponent Clone()
                                    {
                                        CheckValidInstance();
                                    ...
                                    /// </para>
                                    /// </remarks>
                                    public readonly RepresentsTheTypeOfTheTypeViewOrComponent Freeze()
                                    {
                                        CheckValidInstance();
                                        return _parent.FreezeElement<RepresentsTheTypeOfTheTypeViewOrComponent>(_idx);
                                    }
                                ...
                                public ref struct Source
                                {
                                    ...
                                    public static implicit operator Source(RepresentsTheTypeOfTheTypeViewOrComponent instance) => new(JsonElement.From(instance));
                                    ...
                                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                    public static implicit operator Source(KnownValues value) => (RepresentsTheTypeOfTheTypeViewOrComponent)value;
                                ...
                                {
                                    return workspace.CreateBuilder<RepresentsTheTypeOfTheTypeViewOrComponent, Mutable>(this);
                                }
                                ...
                                public static ParsedJsonDocument<RepresentsTheTypeOfTheTypeViewOrComponent> Create(
                                    scoped in Source value, int initialCapacity = 1)
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        Debug.Assert(cvb.MemberCount == 1);
                                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                        return documentBuilder.ToParsedJsonDocument<RepresentsTheTypeOfTheTypeViewOrComponent>();
                                    }
                                    finally
                                    {
