                    ...
                    public readonly partial struct AllOf1Entity
                    {
                        ...
                        public readonly partial struct RequiredTypeAndUsage
                        {
                            ...
                            public readonly partial struct RepresentsTheTypeOfTheTypeComponent
                            {
                                ...
                                public static ParsedJsonDocument<RepresentsTheTypeOfTheTypeComponent> Create(
                                    scoped in Source value, int initialCapacity = 1)
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        Debug.Assert(cvb.MemberCount == 1);
                                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                        return documentBuilder.ToParsedJsonDocument<RepresentsTheTypeOfTheTypeComponent>();
                                    }
                                    finally
                                    {
