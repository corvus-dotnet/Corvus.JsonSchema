                    ...
                    public readonly partial struct AllOf1Entity
                    {
                        ...
                        public readonly partial struct RequiredName
                        {
...
#endif
                            {
                                ...
                                /// <summary>
                                /// Initializes a new instance of the <see cref="RepresentsTheTypeOfTheTypeViewOrComponent"/> struct.
                                /// </summary>
                                ...
                                internal RepresentsTheTypeOfTheTypeViewOrComponent(IJsonDocument parent, int idx)
                                {
                                    Debug.Assert(idx >= 0);
                                    _parent = parent;
                                    _idx = idx;
                                ...
                                /// </summary>
                                public static RepresentsTheTypeOfTheTypeViewOrComponent DefaultInstance { get; }
                                ...
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static explicit operator string(RepresentsTheTypeOfTheTypeViewOrComponent value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                                ...
                                /// </returns>
                                public static bool operator ==(in RepresentsTheTypeOfTheTypeViewOrComponent left, in RepresentsTheTypeOfTheTypeViewOrComponent right)
                                {
                                ...
                                /// <c>True</c> if the values are equal.
                                /// </returns>
                                public static bool operator ==(in RepresentsTheTypeOfTheTypeViewOrComponent left, in JsonElement right)
                                {
                                    return left.Equals(right);
                                }
                                ...
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static implicit operator JsonElement(RepresentsTheTypeOfTheTypeViewOrComponent instance)
                                {
                                ...
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static implicit operator RepresentsTheTypeOfTheTypeViewOrComponent(JsonElement instance)
                                {
                                    return RepresentsTheTypeOfTheTypeViewOrComponent.From(instance);
                                }
                                ...
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static RepresentsTheTypeOfTheTypeViewOrComponent From<T>(in T instance)
                                ...
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static RepresentsTheTypeOfTheTypeViewOrComponent ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                                {
                                    #pragma warning disable CS0618 // Type or member is obsolete
                                    return JsonElementHelpers.ParseValue<RepresentsTheTypeOfTheTypeViewOrComponent>(utf8Json, options);
                                ...
                                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static RepresentsTheTypeOfTheTypeViewOrComponent ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                                {
                                    #pragma warning disable CS0618 // Type or member is obsolete
                                    return JsonElementHelpers.ParseValue<RepresentsTheTypeOfTheTypeViewOrComponent>(json, options);
                                    #pragma warning restore CS0618
                                }
                                ...
                                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static RepresentsTheTypeOfTheTypeViewOrComponent ParseValue(string json, JsonDocumentOptions options = default)
                                {
                                    #pragma warning disable CS0618 // Type or member is obsolete
                                    return JsonElementHelpers.ParseValue<RepresentsTheTypeOfTheTypeViewOrComponent>(json, options);
                                    #pragma warning restore CS0618
                                ...
                                /// </exception>
                                [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                                public static RepresentsTheTypeOfTheTypeViewOrComponent ParseValue(ref Utf8JsonReader reader)
                                {
                                    #pragma warning disable CS0618 // Type or member is obsolete
                                    return JsonElementHelpers.ParseValue<RepresentsTheTypeOfTheTypeViewOrComponent>(ref reader);
                                    #pragma warning restore CS0618
                                }
                                ...
                                ///   A value could not be read from the reader.
                                /// </exception>
                                public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsTheTypeOfTheTypeViewOrComponent? result)
                                {
                                    return JsonElementHelpers.TryParseValue<RepresentsTheTypeOfTheTypeViewOrComponent>(ref reader, out result);
                                }
                                ...
                                {
                                    return
                                        (obj is IJsonElement value && Equals(new RepresentsTheTypeOfTheTypeViewOrComponent(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                                static RepresentsTheTypeOfTheTypeViewOrComponent IJsonElement<RepresentsTheTypeOfTheTypeViewOrComponent>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                private string DebuggerDisplay => $"RepresentsTheTypeOfTheTypeViewOrComponent: ValueKind = {ValueKind} : \"{ToString()}\"";
                                ...
                                /// <summary>
                                /// Gets a <see cref="RepresentsTheTypeOfTheTypeViewOrComponent"/> which can be safely stored beyond the lifetime of the
                                /// original document.
                                /// </summary>
                                /// <returns>
                                /// A <see cref="RepresentsTheTypeOfTheTypeViewOrComponent"/> which can be safely stored beyond the lifetime of the
                                /// original document.
                                /// </returns>
                                /// <remarks>
                                /// <para>
                                ...
                                /// </para>
                                /// </remarks>
                                public RepresentsTheTypeOfTheTypeViewOrComponent Clone()
                                {
                                    CheckValidInstance();
                                    return _parent.CloneElement<RepresentsTheTypeOfTheTypeViewOrComponent>(_idx);
                                }
                                ...
                                /// </summary>
                                /// <returns>
                                /// An immutable <see cref="RepresentsTheTypeOfTheTypeViewOrComponent"/> that lives for the lifetime of its
                                ...
                                /// </para>
                                /// </remarks>
                                public RepresentsTheTypeOfTheTypeViewOrComponent Freeze()
                                {
                                    CheckValidInstance();
                                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                                    {
                                        return mutable.FreezeElement<RepresentsTheTypeOfTheTypeViewOrComponent>(_idx);
                                    }
                                ...
                                /// <param name="matchView">Match 1st item.</param>
                                /// <param name="matchComponent">Match 2nd item.</param>
                                /// <param name="defaultMatch">Match any other value.</param>
                                /// <returns>An instance of the value returned by the match function.</returns>
                                public TResult Match<TContext, TResult>(
                                    in TContext context,
                                    Func<TContext, TResult> matchView,
                                    Func<TContext, TResult> matchComponent,
...
#endif
                                {
                                    ...
                                    {
                                        return matchView(context);
                                    }

                                    if (this.ValueEquals(Constants.Enum2))
                                    {
                                        return matchComponent(context);
                                    }
                                ...
                                public TResult Match<TResult>(
                                    Func<TResult> matchView,
                                    Func<TResult> matchComponent,
