    ...
    public readonly partial struct Routing
    {
        ...
        public readonly partial struct RoutesEntity
        {
...
#endif
            {
                ...
                /// <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteWithoutName"/>.
                /// </summary>
                ...
                public static bool MatchesPatternRouteWithoutName(ReadOnlySpan<byte> propertyName)
                {
                    return true;
                }
                ...
                /// <returns><see langword="true"/> if the property name matches the pattern, otherwise <see langword="false"/>.</returns>
                public static bool TryAsPatternRouteWithoutName(ReadOnlySpan<byte> propertyName, in JsonElement value, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteWithoutName result)
                {
                    if (MatchesPatternRouteWithoutName(propertyName))
                    {
                        result = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteWithoutName.From(value);
                        return true;
                    }
                ...
                public interface IPatternPropertyVisitor<TState>
                {
                    ...
                    /// </summary>
                    bool VisitPatternRouteWithoutName(ReadOnlySpan<byte> name, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteWithoutName value, ref TState state);
                    ...
                    where TVisitor : IPatternPropertyVisitor<TState>
                {
                    ...
                    foreach (var property in EnumerateObject())
                    {
                        ...
                        {
                            matched = true;
                            Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteWithoutName typedValue = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RouteWithoutName.From(property.Value);
                            if (!visitor.VisitPatternRouteWithoutName(propertyName, in typedValue, ref state))
                            {
                                return false;
                            }
