...
public readonly partial struct Ui5ManifestSchema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Routing.ConfigEntity Config
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ConfigUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Routing.ConfigEntity value))
                {
                    return value;
                }
