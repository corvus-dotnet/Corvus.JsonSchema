    ...
    public readonly partial struct RoutingFlexEnabled
    {
        ...
        public readonly partial struct ConfigEntity
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RoutingFlexEnabled.ConfigEntity.AllOf0Entity.IndicatesWhetherTheViewsInRoutingAreLoadedAsyncly Async
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AsyncUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RoutingFlexEnabled.ConfigEntity.AllOf0Entity.IndicatesWhetherTheViewsInRoutingAreLoadedAsyncly value))
                        {
                            return value;
                        }

                        return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RoutingFlexEnabled.ConfigEntity.AllOf0Entity.IndicatesWhetherTheViewsInRoutingAreLoadedAsyncly.DefaultInstance;
                    }
                }
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RoutingFlexEnabled.ConfigEntity.AllOf0Entity.RequiredTarget Bypassed
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.BypassedUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RoutingFlexEnabled.ConfigEntity.AllOf0Entity.RequiredTarget value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Current.JsonString RouterClass
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RouterClassUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.Ui5ManifestBenchmark.Current.JsonString ViewPath
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ViewPathUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString value))
                        {
                            return value;
                        }
                ...
                {
                    /// <summary>
                    /// Gets the pre-baked property name blob for <see cref="Async"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> Async => [0x75, 0x00, 0x00, 0x00, 0x22, 0x61, 0x73, 0x79, 0x6E, 0x63, 0x22];

                    /// <summary>
                    /// Gets the pre-baked property name blob for <see cref="Bypassed"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> Bypassed => [0xA5, 0x00, 0x00, 0x00, 0x22, 0x62, 0x79, 0x70, 0x61, 0x73, 0x73, 0x65, 0x64, 0x22];

                    /// <summary>
                    /// Gets the pre-baked property name blob for <see cref="RouterClass"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> RouterClass => [0xD5, 0x00, 0x00, 0x00, 0x22, 0x72, 0x6F, 0x75, 0x74, 0x65, 0x72, 0x43, 0x6C, 0x61, 0x73, 0x73, 0x22];
