        ...
        public readonly partial struct RepresentsTheDefaultPropertiesDefinedForRouteAndTarget
        {
            ...
            public readonly partial struct AllOf0Entity
            {
                ...
                public readonly partial struct IndicatesWhetherTheViewsInRoutingAreLoadedAsyncly
                {
                    ...
                    public static ParsedJsonDocument<IndicatesWhetherTheViewsInRoutingAreLoadedAsyncly> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<IndicatesWhetherTheViewsInRoutingAreLoadedAsyncly>();
                        }
                        finally
                        {
