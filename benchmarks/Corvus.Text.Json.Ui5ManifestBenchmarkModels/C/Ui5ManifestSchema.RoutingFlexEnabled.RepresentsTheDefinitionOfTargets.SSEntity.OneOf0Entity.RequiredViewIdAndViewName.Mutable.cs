            ...
            public readonly partial struct SSEntity
            {
                ...
                public readonly partial struct OneOf0Entity
                {
                    ...
                    public readonly partial struct RequiredViewIdAndViewName
                    {
                        ...
                        public static ParsedJsonDocument<RequiredViewIdAndViewName> Create(
                            scoped in Source value, int initialCapacity = 30)
                        {
                            ...
                            try
                            {
                                ...
                                Debug.Assert(cvb.MemberCount == 1);
                                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                return documentBuilder.ToParsedJsonDocument<RequiredViewIdAndViewName>();
                            }
                            finally
                            {
                        ...
                        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                        public static ParsedJsonDocument<RequiredViewIdAndViewName> Create<TContext>(
                        ...
                        public static ParsedJsonDocument<RequiredViewIdAndViewName> Create(in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source viewId, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source viewName, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source viewPath = default, int initialCapacity = 30)
                        {
                            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                            try
                            {
