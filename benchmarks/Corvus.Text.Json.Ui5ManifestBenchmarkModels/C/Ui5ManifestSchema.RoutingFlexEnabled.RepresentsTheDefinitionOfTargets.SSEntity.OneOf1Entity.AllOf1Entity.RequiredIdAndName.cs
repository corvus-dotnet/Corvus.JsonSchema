                ...
                public readonly partial struct OneOf1Entity
                {
                    ...
                    public readonly partial struct AllOf1Entity
                    {
                        ...
                        public readonly partial struct RequiredIdAndName
                            ...
                            : IJsonElement<RequiredIdAndName>,
                              IFormattable,
                              ISpanFormattable,
...
#endif
                        {
                            ...
                            /// <summary>
                            /// Initializes a new instance of the <see cref="RequiredIdAndName"/> struct.
                            /// </summary>
                            /// <param name="value">The value from which to construct the instance.</param>
                            internal RequiredIdAndName(IJsonDocument parent, int idx)
                            {
                                Debug.Assert(idx >= 0);
                                _parent = parent;
                                _idx = idx;
                            ...
                            /// </summary>
                            public static RequiredIdAndName DefaultInstance { get; }
                            ...
                            /// </para>
                            /// </remarks>
                            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RoutingFlexEnabled.RepresentsTheDefinitionOfTargets.SSEntity.OneOf1Entity.AllOf1Entity.RequiredIdAndName.RepresentsTheTypeOfTheTypeViewOrComponent Type
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RoutingFlexEnabled.RepresentsTheDefinitionOfTargets.SSEntity.OneOf1Entity.AllOf1Entity.RequiredIdAndName.RepresentsTheTypeOfTheTypeViewOrComponent value))
                                    {
                                        return value;
                                    }
                            ...
                            /// </returns>
                            public static bool operator ==(in RequiredIdAndName left, in RequiredIdAndName right)
                            {
                            ...
                            /// <c>True</c> if the values are equal.
                            /// </returns>
                            public static bool operator ==(in RequiredIdAndName left, in JsonElement right)
                            {
                                return left.Equals(right);
                            }
                            ...
                            public static implicit operator JsonElement(RequiredIdAndName instance)
                            {
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator RequiredIdAndName(JsonElement instance)
                            {
                                return RequiredIdAndName.From(instance);
                            }
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static RequiredIdAndName From<T>(in T instance)
                            ...
                            /// </exception>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static RequiredIdAndName ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                            {
                                return JsonElementHelpers.ParseValue<RequiredIdAndName>(utf8Json, options);
                            }
                            ...
                            /// </exception>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static RequiredIdAndName ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                            {
                                return JsonElementHelpers.ParseValue<RequiredIdAndName>(json, options);
                            }
                            ...
                            /// </exception>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static RequiredIdAndName ParseValue(string json, JsonDocumentOptions options = default)
                            {
                                return JsonElementHelpers.ParseValue<RequiredIdAndName>(json, options);
                            }
                            ...
                            /// </exception>
                            public static RequiredIdAndName ParseValue(ref Utf8JsonReader reader)
                            {
                                return JsonElementHelpers.ParseValue<RequiredIdAndName>(ref reader);
                            }
                            ...
                            ///   A value could not be read from the reader.
                            /// </exception>
                            public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredIdAndName? result)
                            {
                                return JsonElementHelpers.TryParseValue<RequiredIdAndName>(ref reader, out result);
                            }
                            ...
                            {
                                return
                                    (obj is IJsonElement value && Equals(new RequiredIdAndName(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                            static RequiredIdAndName IJsonElement<RequiredIdAndName>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            private string DebuggerDisplay => $"RequiredIdAndName: ValueKind = {ValueKind} : \"{ToString()}\"";
                            ...
                            /// <summary>
                            /// Gets a <see cref="RequiredIdAndName"/> which can be safely stored beyond the lifetime of the
                            /// original document.
                            /// </summary>
                            /// <returns>
                            /// A <see cref="RequiredIdAndName"/> which can be safely stored beyond the lifetime of the
                            /// original document.
                            /// </returns>
                            /// <remarks>
                            /// <para>
                            ...
                            /// </para>
                            /// </remarks>
                            public RequiredIdAndName Clone()
                            {
                                CheckValidInstance();
                                return _parent.CloneElement<RequiredIdAndName>(_idx);
                            }
                            ...
                            /// </summary>
                            /// <returns>
                            /// An immutable <see cref="RequiredIdAndName"/> that lives for the lifetime of its
                            ...
                            /// </para>
                            /// </remarks>
                            public RequiredIdAndName Freeze()
                            {
                                CheckValidInstance();
                                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                                {
                                    return mutable.FreezeElement<RequiredIdAndName>(_idx);
                                }
