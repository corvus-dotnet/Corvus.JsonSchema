                ...
                public readonly partial struct OneOf1Entity
                {
                    ...
                    public readonly partial struct AllOf1Entity
                    {
...
#endif
                        {
                            ...
                            /// <summary>
                            /// Initializes a new instance of the <see cref="RequiredIdAndTypeAndUsage"/> struct.
                            /// </summary>
                            /// <param name="value">The value from which to construct the instance.</param>
                            internal RequiredIdAndTypeAndUsage(IJsonDocument parent, int idx)
                            {
                                Debug.Assert(idx >= 0);
                                _parent = parent;
                                _idx = idx;
                            ...
                            /// </summary>
                            public static RequiredIdAndTypeAndUsage DefaultInstance { get; }
                            ...
                            /// </para>
                            /// </remarks>
                            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RoutingFlexEnabled.RepresentsTheDefinitionOfTargets.SSEntity.OneOf1Entity.AllOf1Entity.RequiredIdAndTypeAndUsage.RepresentsTheTypeOfTheTypeComponent Type
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RoutingFlexEnabled.RepresentsTheDefinitionOfTargets.SSEntity.OneOf1Entity.AllOf1Entity.RequiredIdAndTypeAndUsage.RepresentsTheTypeOfTheTypeComponent value))
                                    {
                                        return value;
                                    }
                            ...
                            /// </para>
                            /// </remarks>
                            public Corvus.Ui5ManifestBenchmark.Current.JsonString Usage
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UsageUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString value))
                                    {
                                        return value;
                                    }
                            ...
                            /// </returns>
                            public static bool operator ==(in RequiredIdAndTypeAndUsage left, in RequiredIdAndTypeAndUsage right)
                            {
                            ...
                            /// <c>True</c> if the values are equal.
                            /// </returns>
                            public static bool operator ==(in RequiredIdAndTypeAndUsage left, in JsonElement right)
                            {
                                return left.Equals(right);
                            }
                            ...
                            public static implicit operator JsonElement(RequiredIdAndTypeAndUsage instance)
                            {
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator RequiredIdAndTypeAndUsage(JsonElement instance)
                            {
                                return RequiredIdAndTypeAndUsage.From(instance);
                            }
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static RequiredIdAndTypeAndUsage From<T>(in T instance)
                            ...
                            /// </exception>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static RequiredIdAndTypeAndUsage ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                            {
                                return JsonElementHelpers.ParseValue<RequiredIdAndTypeAndUsage>(utf8Json, options);
                            }
                            ...
                            /// </exception>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static RequiredIdAndTypeAndUsage ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                            {
                                return JsonElementHelpers.ParseValue<RequiredIdAndTypeAndUsage>(json, options);
                            }
                            ...
                            /// </exception>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static RequiredIdAndTypeAndUsage ParseValue(string json, JsonDocumentOptions options = default)
                            {
                                return JsonElementHelpers.ParseValue<RequiredIdAndTypeAndUsage>(json, options);
                            }
                            ...
                            /// </exception>
                            public static RequiredIdAndTypeAndUsage ParseValue(ref Utf8JsonReader reader)
                            {
                                return JsonElementHelpers.ParseValue<RequiredIdAndTypeAndUsage>(ref reader);
                            }
                            ...
                            ///   A value could not be read from the reader.
                            /// </exception>
                            public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredIdAndTypeAndUsage? result)
                            {
                                return JsonElementHelpers.TryParseValue<RequiredIdAndTypeAndUsage>(ref reader, out result);
                            }
...
#if NET
                            static RequiredIdAndTypeAndUsage IJsonElement<RequiredIdAndTypeAndUsage>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            private string DebuggerDisplay => $"RequiredIdAndTypeAndUsage: ValueKind = {ValueKind} : \"{ToString()}\"";
                            ...
                            /// </para>
                            /// </remarks>
                            public RequiredIdAndTypeAndUsage Clone()
                            {
                                CheckValidInstance();
                            ...
                            /// </para>
                            /// </remarks>
                            public RequiredIdAndTypeAndUsage Freeze()
                            {
                                CheckValidInstance();
                                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                                {
                                    return mutable.FreezeElement<RequiredIdAndTypeAndUsage>(_idx);
                                }
