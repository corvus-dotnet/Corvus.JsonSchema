                ...
                public readonly partial struct OneOf1Entity
                {
                    ...
                    public readonly partial struct AllOf1Entity
                    {
                        ...
                        public readonly partial struct RequiredIdAndTypeAndUsage
                            : IJsonElement<RequiredIdAndTypeAndUsage>
                        {
                            public static partial class JsonSchema
                            {
                                ...
                                private const int RequiredOffsetForUsage = 0;
                                private const uint RequiredBitForUsage = 0b00000000000000000000000000000100;

                                private const uint RequiredBitMask0 =
                                    RequiredBitForId | RequiredBitForType | RequiredBitForUsage;
                                ...
                                private static readonly JsonSchemaPathProvider UsageSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/properties/usage"u8, buffer, out written);
                                ...
                                private static void MatchType(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                                {
                                    ...
                                    JsonSchemaContext childContext1 =
                                        Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RoutingFlexEnabled.RepresentsTheDefinitionOfTargets.SSEntity.OneOf1Entity.AllOf1Entity.RequiredIdAndTypeAndUsage.RepresentsTheTypeOfTheTypeComponent.JsonSchema.PushChildContextUnescaped(
                                            parentDocument,
                                            parentDocumentIndex,
                                            ref context,
                                    ...
                                    Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RoutingFlexEnabled.RepresentsTheDefinitionOfTargets.SSEntity.OneOf1Entity.AllOf1Entity.RequiredIdAndTypeAndUsage.RepresentsTheTypeOfTheTypeComponent.JsonSchema.Evaluate(parentDocument, parentDocumentIndex, ref childContext1);
                                ...
                                /// </summary>
                                public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/routing_flexEnabled/properties/targets/patternProperties/[\\s\\S]*/oneOf/1/allOf/1/oneOf/1"u8, buffer, out written);

                                /// <summary>
                                /// Gets the schema location from which this type was generated.
                                /// </summary>
                                public const string SchemaLocation = "/definitions/routing_flexEnabled/properties/targets/patternProperties/[\\s\\S]*/oneOf/1/allOf/1/oneOf/1";

                                /// <summary>
                                /// Gets the schema location from which this type was generated as a UTF-8 string.
                                /// </summary>
                                public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/definitions/routing_flexEnabled/properties/targets/patternProperties/[\\s\\S]*/oneOf/1/allOf/1/oneOf/1"u8;
                                    ...
                                    else
                                    {
                                        ...
                                        if ((~(requiredPropertyChildHandler_seenItems[0]) & RequiredBitMask0) == 0)
                                        {
                                            if (context.HasCollector)
                                            {
                                                ...
                                                context.EvaluatedKeywordForProperty(true, 2, RequiredPropertyUsagePresent, "usage"u8, "required"u8);
                                            }
                                        }
                                        ...
                                        else
                                        {
                                            ...
                                            {
                                                context.EvaluatedKeywordForProperty(false, 2, RequiredPropertyUsageNotPresent, "usage"u8, "required"u8);
                                            }
                                            else
                                            {
                                                context.EvaluatedKeywordForProperty(true, 2, RequiredPropertyUsagePresent, "usage"u8, "required"u8);
