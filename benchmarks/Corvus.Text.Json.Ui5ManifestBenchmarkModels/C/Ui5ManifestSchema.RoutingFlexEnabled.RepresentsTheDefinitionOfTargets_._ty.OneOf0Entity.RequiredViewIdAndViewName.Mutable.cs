                ...
                public readonly partial struct OneOf0Entity
                {
                    ...
                    public readonly partial struct RequiredViewIdAndViewName
                    {
...
#endif
                        {
                            ...
                            public static explicit operator Mutable(RequiredViewIdAndViewName instance)
                            {
                            ...
                            /// <returns>An immutable instance of a <see cref="RequiredViewIdAndViewName"/>, initialized from the <see cref="Mutable"/> value.</returns>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator RequiredViewIdAndViewName(Mutable instance)
                            {
                            ...
                            public void SetViewId(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source value)
                            {
                                ...
                                {
                                    CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("viewId");
                                }
                            ...
                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            private string DebuggerDisplay => $"RequiredViewIdAndViewName.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly RequiredViewIdAndViewName Clone()
                            {
                                CheckValidInstance();
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly RequiredViewIdAndViewName Freeze()
                            {
                                CheckValidInstance();
                                return _parent.FreezeElement<RequiredViewIdAndViewName>(_idx);
                            }
                        }
                        ...
                        public ref struct Source
                        {
                            ...
                            internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RoutingFlexEnabled.RepresentsTheDefinitionOfTargets.SSEntity.OneOf0Entity.RequiredViewIdAndViewName.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                            ...
                            public static implicit operator Source(RequiredViewIdAndViewName instance) => new(JsonElement.From(instance));
                            ...
                            #endif
                        {
                            ...
                            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RoutingFlexEnabled.RepresentsTheDefinitionOfTargets.SSEntity.OneOf0Entity.RequiredViewIdAndViewName.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                        ...
                        public ref struct Builder
                        {
                            ...
                            /// <summary>
                            /// Creates an instance of a <see cref="RequiredViewIdAndViewName"/>.
                            /// </summary>
                            internal static void Create(
                                ref ComplexValueBuilder builder,
                                in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source viewId,
                            ...
                            public void Create(
                                ...
                                in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source viewPath = default)
                            {
                                Create(ref _builder, viewId, viewName, viewPath);
                            }
                        ...
                        /// <returns>The source from which to build the value.</returns>
                        public static Source Build(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source viewId, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source viewName, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source viewPath = default)
                        {
                            return new Source(viewId, viewName, viewPath);
                        }
                        ...
                        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source viewId, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source viewName, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source viewPath = default, int initialCapacity = 30)
                        {
                            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                            cvb.StartObject();
                            Builder ovb = new(cvb);
                            ovb.Create(viewId, viewName, viewPath);
                            cvb = ovb._builder;
                            cvb.EndObject();
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder;
                        ...
                        {
                            return workspace.CreateBuilder<RequiredViewIdAndViewName, Mutable>(this);
                        }
                    }
                }
            }
