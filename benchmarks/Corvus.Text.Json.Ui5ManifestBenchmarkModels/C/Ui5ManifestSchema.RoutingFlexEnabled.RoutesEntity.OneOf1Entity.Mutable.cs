...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct RoutingFlexEnabled
    {
        ...
        public readonly partial struct RoutesEntity
        {
            ...
            /// <remarks>
            /// <para>
            /// Represents the definition of routes by providing an object with the route&#39;s name as the key and other route options in an object as the value
            /// </para>
            /// </remarks>
            ...
            public readonly partial struct OneOf1Entity
            {
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RoutingFlexEnabled.RoutesEntity.OneOf1Entity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RoutingFlexEnabled.RoutesEntity.OneOf1Entity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
