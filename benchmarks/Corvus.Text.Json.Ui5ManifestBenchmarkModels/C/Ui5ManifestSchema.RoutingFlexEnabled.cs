...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct RoutingFlexEnabled
        ...
        : IJsonElement<RoutingFlexEnabled>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RoutingFlexEnabled"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal RoutingFlexEnabled(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static RoutingFlexEnabled DefaultInstance { get; }
        ...
        /// </summary>
        public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RoutingFlexEnabled.RoutesEntity Routes
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RoutesUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RoutingFlexEnabled.RoutesEntity value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RoutingFlexEnabled.RepresentsTheDefinitionOfTargets Targets
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TargetsUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.RoutingFlexEnabled.RepresentsTheDefinitionOfTargets value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in RoutingFlexEnabled left, in RoutingFlexEnabled right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in RoutingFlexEnabled left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(RoutingFlexEnabled instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator RoutingFlexEnabled(JsonElement instance)
        {
            return RoutingFlexEnabled.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RoutingFlexEnabled From<T>(in T instance)
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out RoutingFlexEnabled? result)
        {
            return JsonElementHelpers.TryParseValue<RoutingFlexEnabled>(ref reader, out result);
        }
...
#if NET
        static RoutingFlexEnabled IJsonElement<RoutingFlexEnabled>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"RoutingFlexEnabled: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public RoutingFlexEnabled Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public RoutingFlexEnabled Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<RoutingFlexEnabled>(_idx);
            }
        ...
        private static class JsonPropertyNamesPrebaked
        {
            ...
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="Routes"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Routes => [0x85, 0x00, 0x00, 0x00, 0x22, 0x72, 0x6F, 0x75, 0x74, 0x65, 0x73, 0x22];
