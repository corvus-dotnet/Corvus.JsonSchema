    ...
    public readonly partial struct RoutingFlexEnabled
    {
        ...
        public readonly partial struct RepresentsTheDefaultPropertiesDefinedForRouteAndTarget
        {
            ...
            public readonly partial struct AllOf0Entity
            {
                ...
                public readonly partial struct IndicatesWhetherTheViewsInRoutingAreLoadedAsyncly
#if NET8_0_OR_GREATER
                    : IJsonElement<IndicatesWhetherTheViewsInRoutingAreLoadedAsyncly>,
                      IFormattable,
                      ISpanFormattable,
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="IndicatesWhetherTheViewsInRoutingAreLoadedAsyncly"/> struct.
                    /// </summary>
                    ...
                    internal IndicatesWhetherTheViewsInRoutingAreLoadedAsyncly(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static IndicatesWhetherTheViewsInRoutingAreLoadedAsyncly DefaultInstance { get; } = ParsedJsonDocument<IndicatesWhetherTheViewsInRoutingAreLoadedAsyncly>.False;
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator bool(IndicatesWhetherTheViewsInRoutingAreLoadedAsyncly value)
                    {
                    ...
                    /// </returns>
                    public static bool operator ==(in IndicatesWhetherTheViewsInRoutingAreLoadedAsyncly left, in IndicatesWhetherTheViewsInRoutingAreLoadedAsyncly right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in IndicatesWhetherTheViewsInRoutingAreLoadedAsyncly left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator JsonElement(IndicatesWhetherTheViewsInRoutingAreLoadedAsyncly instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator IndicatesWhetherTheViewsInRoutingAreLoadedAsyncly(JsonElement instance)
                    {
                        return IndicatesWhetherTheViewsInRoutingAreLoadedAsyncly.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static IndicatesWhetherTheViewsInRoutingAreLoadedAsyncly From<T>(in T instance)
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static IndicatesWhetherTheViewsInRoutingAreLoadedAsyncly ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        #pragma warning disable CS0618 // Type or member is obsolete
                        return JsonElementHelpers.ParseValue<IndicatesWhetherTheViewsInRoutingAreLoadedAsyncly>(utf8Json, options);
                    ...
                    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static IndicatesWhetherTheViewsInRoutingAreLoadedAsyncly ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        #pragma warning disable CS0618 // Type or member is obsolete
                        return JsonElementHelpers.ParseValue<IndicatesWhetherTheViewsInRoutingAreLoadedAsyncly>(json, options);
                        #pragma warning restore CS0618
                    }
                    ...
                    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static IndicatesWhetherTheViewsInRoutingAreLoadedAsyncly ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        #pragma warning disable CS0618 // Type or member is obsolete
                        return JsonElementHelpers.ParseValue<IndicatesWhetherTheViewsInRoutingAreLoadedAsyncly>(json, options);
                        #pragma warning restore CS0618
                    ...
                    /// </exception>
                    [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
                    public static IndicatesWhetherTheViewsInRoutingAreLoadedAsyncly ParseValue(ref Utf8JsonReader reader)
                    {
                        #pragma warning disable CS0618 // Type or member is obsolete
                        return JsonElementHelpers.ParseValue<IndicatesWhetherTheViewsInRoutingAreLoadedAsyncly>(ref reader);
                        #pragma warning restore CS0618
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out IndicatesWhetherTheViewsInRoutingAreLoadedAsyncly? result)
                    {
                        return JsonElementHelpers.TryParseValue<IndicatesWhetherTheViewsInRoutingAreLoadedAsyncly>(ref reader, out result);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new IndicatesWhetherTheViewsInRoutingAreLoadedAsyncly(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                    static IndicatesWhetherTheViewsInRoutingAreLoadedAsyncly IJsonElement<IndicatesWhetherTheViewsInRoutingAreLoadedAsyncly>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"IndicatesWhetherTheViewsInRoutingAreLoadedAsyncly: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="IndicatesWhetherTheViewsInRoutingAreLoadedAsyncly"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="IndicatesWhetherTheViewsInRoutingAreLoadedAsyncly"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public IndicatesWhetherTheViewsInRoutingAreLoadedAsyncly Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<IndicatesWhetherTheViewsInRoutingAreLoadedAsyncly>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="IndicatesWhetherTheViewsInRoutingAreLoadedAsyncly"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public IndicatesWhetherTheViewsInRoutingAreLoadedAsyncly Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<IndicatesWhetherTheViewsInRoutingAreLoadedAsyncly>(_idx);
                        }
