        ...
        public readonly partial struct DependenciesEntity
        {
            ...
            public readonly partial struct AdditionalPropertiesEntity
            {
...
#endif
                {
                    ...
                    /// <summary>
                    /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Schema" />.
                    /// </summary>
                    /// <param name="result">The result of the conversions.</param>
                    /// <returns><see langword="true" /> if the conversion was valid.</returns>
                    public bool TryGetAsSchema(out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Schema result)
                    {
                        if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Schema.JsonSchema.Evaluate(_parent, _idx))
                        {
                    ...
                    /// <summary>
                    /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Schema.StringArray" />.
                    /// </summary>
                    /// <param name="result">The result of the conversions.</param>
                    /// <returns><see langword="true" /> if the conversion was valid.</returns>
                    public bool TryGetAsStringArray(out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Schema.StringArray result)
                    {
                        if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Schema.StringArray.JsonSchema.Evaluate(_parent, _idx))
                        {
