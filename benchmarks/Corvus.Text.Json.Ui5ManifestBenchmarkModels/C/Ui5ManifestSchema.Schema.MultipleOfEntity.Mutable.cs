    ...
    public readonly partial struct Schema
    {
        ...
        public readonly partial struct MultipleOfEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(MultipleOfEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="MultipleOfEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator MultipleOfEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"MultipleOfEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly MultipleOfEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly MultipleOfEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<MultipleOfEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(MultipleOfEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<MultipleOfEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<MultipleOfEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<MultipleOfEntity>();
                }
                finally
                {
