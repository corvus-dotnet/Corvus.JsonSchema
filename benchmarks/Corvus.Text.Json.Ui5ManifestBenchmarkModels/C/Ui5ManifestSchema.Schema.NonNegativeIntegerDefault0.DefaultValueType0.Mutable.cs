        ...
        public readonly partial struct NonNegativeIntegerDefault0
        {
            ...
            public readonly partial struct DefaultValueType0
            {
...
#endif
                {
                    ...
                    /// </remarks>
                    public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DefaultValueType0, Mutable>(DefaultValueType0.DefaultInstance);
                    ...
                    public static explicit operator Mutable(DefaultValueType0 instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="DefaultValueType0"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator DefaultValueType0(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"DefaultValueType0.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DefaultValueType0 Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DefaultValueType0 Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<DefaultValueType0>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(DefaultValueType0 instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<DefaultValueType0, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<DefaultValueType0> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<DefaultValueType0>();
                    }
                    finally
                    {
