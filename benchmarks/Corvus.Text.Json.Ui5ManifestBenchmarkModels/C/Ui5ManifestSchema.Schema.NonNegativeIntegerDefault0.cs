...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct Schema
    {
...
#endif
        {
            ...
            public static implicit operator Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Schema.NonNegativeInteger(NonNegativeIntegerDefault0 value)
            {
                return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Schema.NonNegativeInteger.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator NonNegativeIntegerDefault0(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Schema.NonNegativeInteger value)
            {
                return From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Schema.NonNegativeIntegerDefault0.DefaultValueType0(NonNegativeIntegerDefault0 value)
            {
                return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Schema.NonNegativeIntegerDefault0.DefaultValueType0.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator NonNegativeIntegerDefault0(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Schema.NonNegativeIntegerDefault0.DefaultValueType0 value)
            {
                return From(value);
            }
            ...
            public bool TryGetAsNonNegativeInteger(out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Schema.NonNegativeInteger result)
            {
                ...
                {
                    result = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Schema.NonNegativeInteger.From(this);
                    return true;
                }
            ...
            public bool TryGetAsDefaultValueType0(out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Schema.NonNegativeIntegerDefault0.DefaultValueType0 result)
            {
                ...
                {
                    result = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Schema.NonNegativeIntegerDefault0.DefaultValueType0.From(this);
                    return true;
                }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Schema.NonNegativeIntegerDefault0, TContext, TResult> defaultMatch)
...
#endif
            {
                if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Schema.NonNegativeInteger.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchNonNegativeInteger(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Schema.NonNegativeInteger.From(this), context);
                }

                if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Schema.NonNegativeIntegerDefault0.DefaultValueType0.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchDefaultValueType0(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Schema.NonNegativeIntegerDefault0.DefaultValueType0.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Schema.NonNegativeIntegerDefault0, TResult> defaultMatch)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Schema.NonNegativeInteger.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchNonNegativeInteger(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Schema.NonNegativeInteger.From(this));
                }

                if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Schema.NonNegativeIntegerDefault0.DefaultValueType0.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchDefaultValueType0(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Schema.NonNegativeIntegerDefault0.DefaultValueType0.From(this));
                }
