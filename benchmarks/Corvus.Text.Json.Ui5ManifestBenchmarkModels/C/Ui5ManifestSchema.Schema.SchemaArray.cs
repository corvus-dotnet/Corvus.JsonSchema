...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct Schema
    {
...
#endif
        {
            ...
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Schema this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Schema>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Schema> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Schema>(_parent, _idx);
            }
