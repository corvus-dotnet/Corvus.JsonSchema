...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct Schema
    {
...
#endif
        {
            ...
            internal SimpleTypes(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(SimpleTypes value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in SimpleTypes left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(SimpleTypes instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator SimpleTypes(JsonElement instance)
            {
                return SimpleTypes.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SimpleTypes From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SimpleTypes ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SimpleTypes>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SimpleTypes ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SimpleTypes>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static SimpleTypes ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<SimpleTypes>(json, options);
            }
            ...
            /// </exception>
            public static SimpleTypes ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<SimpleTypes>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out SimpleTypes? result)
            {
                return JsonElementHelpers.TryParseValue<SimpleTypes>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new SimpleTypes(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static SimpleTypes IJsonElement<SimpleTypes>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"SimpleTypes: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="SimpleTypes"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="SimpleTypes"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public SimpleTypes Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<SimpleTypes>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="SimpleTypes"/> that lives for the lifetime of its
            ...
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchArray,
