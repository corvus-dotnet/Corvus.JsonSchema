    ...
    public readonly partial struct Schema
    {
        ...
        public readonly partial struct UniqueItemsEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<UniqueItemsEntity, Mutable>(UniqueItemsEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(UniqueItemsEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="UniqueItemsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator UniqueItemsEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"UniqueItemsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly UniqueItemsEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly UniqueItemsEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<UniqueItemsEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(UniqueItemsEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<UniqueItemsEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<UniqueItemsEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<UniqueItemsEntity>();
                }
                finally
                {
