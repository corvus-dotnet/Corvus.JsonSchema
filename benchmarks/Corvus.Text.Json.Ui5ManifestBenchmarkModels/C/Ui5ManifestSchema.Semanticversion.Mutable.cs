...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct Semanticversion
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Semanticversion instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Semanticversion"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Semanticversion(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Semanticversion.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly Semanticversion Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly Semanticversion Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Semanticversion>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(Semanticversion instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<Semanticversion, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<Semanticversion> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Semanticversion>();
            }
            finally
            {
