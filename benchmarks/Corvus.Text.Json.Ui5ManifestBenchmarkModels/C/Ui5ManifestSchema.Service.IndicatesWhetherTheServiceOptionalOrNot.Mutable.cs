    ...
    public readonly partial struct Service
    {
        ...
        public readonly partial struct IndicatesWhetherTheServiceOptionalOrNot
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<IndicatesWhetherTheServiceOptionalOrNot, Mutable>(IndicatesWhetherTheServiceOptionalOrNot.DefaultInstance);
            ...
            public static ParsedJsonDocument<IndicatesWhetherTheServiceOptionalOrNot> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<IndicatesWhetherTheServiceOptionalOrNot>();
                }
                finally
                {
