...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct Service
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="IndicatesWhetherTheServiceOptionalOrNot"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal IndicatesWhetherTheServiceOptionalOrNot(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static IndicatesWhetherTheServiceOptionalOrNot DefaultInstance { get; } = ParsedJsonDocument<IndicatesWhetherTheServiceOptionalOrNot>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(IndicatesWhetherTheServiceOptionalOrNot value)
            {
            ...
            /// </returns>
            public static bool operator ==(in IndicatesWhetherTheServiceOptionalOrNot left, in IndicatesWhetherTheServiceOptionalOrNot right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in IndicatesWhetherTheServiceOptionalOrNot left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(IndicatesWhetherTheServiceOptionalOrNot instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator IndicatesWhetherTheServiceOptionalOrNot(JsonElement instance)
            {
                return IndicatesWhetherTheServiceOptionalOrNot.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static IndicatesWhetherTheServiceOptionalOrNot From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static IndicatesWhetherTheServiceOptionalOrNot ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<IndicatesWhetherTheServiceOptionalOrNot>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static IndicatesWhetherTheServiceOptionalOrNot ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<IndicatesWhetherTheServiceOptionalOrNot>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static IndicatesWhetherTheServiceOptionalOrNot ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<IndicatesWhetherTheServiceOptionalOrNot>(json, options);
            }
            ...
            /// </exception>
            public static IndicatesWhetherTheServiceOptionalOrNot ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<IndicatesWhetherTheServiceOptionalOrNot>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out IndicatesWhetherTheServiceOptionalOrNot? result)
            {
                return JsonElementHelpers.TryParseValue<IndicatesWhetherTheServiceOptionalOrNot>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new IndicatesWhetherTheServiceOptionalOrNot(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static IndicatesWhetherTheServiceOptionalOrNot IJsonElement<IndicatesWhetherTheServiceOptionalOrNot>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"IndicatesWhetherTheServiceOptionalOrNot: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="IndicatesWhetherTheServiceOptionalOrNot"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="IndicatesWhetherTheServiceOptionalOrNot"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public IndicatesWhetherTheServiceOptionalOrNot Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<IndicatesWhetherTheServiceOptionalOrNot>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="IndicatesWhetherTheServiceOptionalOrNot"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public IndicatesWhetherTheServiceOptionalOrNot Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<IndicatesWhetherTheServiceOptionalOrNot>(_idx);
                }
