    ...
    public readonly partial struct Service
    {
        ...
        public readonly partial struct RepresentsTheNameOfTheServiceFactory
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RepresentsTheNameOfTheServiceFactory instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsTheNameOfTheServiceFactory"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsTheNameOfTheServiceFactory(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsTheNameOfTheServiceFactory.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheNameOfTheServiceFactory Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheNameOfTheServiceFactory Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsTheNameOfTheServiceFactory>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsTheNameOfTheServiceFactory instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RepresentsTheNameOfTheServiceFactory, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RepresentsTheNameOfTheServiceFactory> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RepresentsTheNameOfTheServiceFactory>();
                }
                finally
                {
