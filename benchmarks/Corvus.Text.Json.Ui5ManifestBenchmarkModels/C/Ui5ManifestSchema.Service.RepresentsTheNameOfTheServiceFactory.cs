...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct Service
    {
        ...
        public readonly partial struct RepresentsTheNameOfTheServiceFactory
#if NET8_0_OR_GREATER
            : IJsonElement<RepresentsTheNameOfTheServiceFactory>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RepresentsTheNameOfTheServiceFactory"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RepresentsTheNameOfTheServiceFactory(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RepresentsTheNameOfTheServiceFactory DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(RepresentsTheNameOfTheServiceFactory value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in RepresentsTheNameOfTheServiceFactory left, in RepresentsTheNameOfTheServiceFactory right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RepresentsTheNameOfTheServiceFactory left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(RepresentsTheNameOfTheServiceFactory instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RepresentsTheNameOfTheServiceFactory(JsonElement instance)
            {
                return RepresentsTheNameOfTheServiceFactory.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheNameOfTheServiceFactory From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheNameOfTheServiceFactory ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheNameOfTheServiceFactory>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheNameOfTheServiceFactory ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheNameOfTheServiceFactory>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheNameOfTheServiceFactory ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheNameOfTheServiceFactory>(json, options);
            }
            ...
            /// </exception>
            public static RepresentsTheNameOfTheServiceFactory ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheNameOfTheServiceFactory>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsTheNameOfTheServiceFactory? result)
            {
                return JsonElementHelpers.TryParseValue<RepresentsTheNameOfTheServiceFactory>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RepresentsTheNameOfTheServiceFactory(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static RepresentsTheNameOfTheServiceFactory IJsonElement<RepresentsTheNameOfTheServiceFactory>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RepresentsTheNameOfTheServiceFactory: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RepresentsTheNameOfTheServiceFactory"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RepresentsTheNameOfTheServiceFactory"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public RepresentsTheNameOfTheServiceFactory Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RepresentsTheNameOfTheServiceFactory>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RepresentsTheNameOfTheServiceFactory"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public RepresentsTheNameOfTheServiceFactory Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RepresentsTheNameOfTheServiceFactory>(_idx);
                }
