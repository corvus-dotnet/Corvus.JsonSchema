    ...
    public readonly partial struct Setting
    {
        ...
        public readonly partial struct MaxAgeEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(MaxAgeEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="MaxAgeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator MaxAgeEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"MaxAgeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly MaxAgeEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly MaxAgeEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<MaxAgeEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(MaxAgeEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<MaxAgeEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<MaxAgeEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<MaxAgeEntity>();
                }
                finally
                {
