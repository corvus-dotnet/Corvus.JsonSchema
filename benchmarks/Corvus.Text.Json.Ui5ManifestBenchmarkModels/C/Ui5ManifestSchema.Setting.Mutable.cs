...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct Setting
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(Setting instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="Setting"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Setting(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting.JsonStringArray.Mutable Annotations
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AnnotationsUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting.JsonStringArray.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Mutable IgnoreAnnotationsFromMetadata
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IgnoreAnnotationsFromMetadataUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable LocalUri
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LocalUriUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting.MaxAgeEntity.Mutable MaxAge
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MaxAgeUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting.MaxAgeEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting.DictionaryOfCatalogObjectsOfferedByTheDatasource.Mutable Objects
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ObjectsUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting.DictionaryOfCatalogObjectsOfferedByTheDatasource.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting.RepresentsVersionOfOData20IsDefault.Mutable OdataVersion
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OdataVersionUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting.RepresentsVersionOfOData20IsDefault.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetAnnotations(scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting.JsonStringArray.Source value)
            {
                ...
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.AnnotationsUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AnnotationsUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                ...
                else
                {
                    ...
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Annotations, ref cvb);
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetAnnotations<TContext>(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting.JsonStringArray.Source<TContext> value)
            ...
            /// <summary>
            /// Remove the <c>annotations</c> property, if present.
            /// </summary>
            ...
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.AnnotationsUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            public void SetIgnoreAnnotationsFromMetadata(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source value)
            {
                ...
                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.IgnoreAnnotationsFromMetadataUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IgnoreAnnotationsFromMetadataUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.IgnoreAnnotationsFromMetadata, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// <summary>
            /// Remove the <c>ignoreAnnotationsFromMetadata</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveIgnoreAnnotationsFromMetadata()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.IgnoreAnnotationsFromMetadataUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            public void SetLocalUri(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source value)
            {
                ...
                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.LocalUriUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LocalUriUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.LocalUri, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// <summary>
            /// Remove the <c>localUri</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveLocalUri()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.LocalUriUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            public void SetObjects(scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting.DictionaryOfCatalogObjectsOfferedByTheDatasource.Source value)
            {
                ...
                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ObjectsUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ObjectsUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Objects, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetObjects<TContext>(in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting.DictionaryOfCatalogObjectsOfferedByTheDatasource.Source<TContext> value)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
            ...
            /// <summary>
            /// Remove the <c>objects</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveObjects()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.ObjectsUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            public void SetOdataVersion(scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting.RepresentsVersionOfOData20IsDefault.Source value)
            {
                ...
                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.OdataVersionUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.OdataVersionUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.OdataVersion, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// <summary>
            /// Remove the <c>odataVersion</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveOdataVersion()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.OdataVersionUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"Setting.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly Setting Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<Setting>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting.JsonStringArray.Source _createArg1;
            ...
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting.MaxAgeEntity.Source _createArg4;
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting.DictionaryOfCatalogObjectsOfferedByTheDatasource.Source _createArg5;
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting.RepresentsVersionOfOData20IsDefault.Source _createArg6;
            ...
            public static implicit operator Source(Setting instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting.JsonStringArray.Source<TContext> _createArg1;
            private readonly Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source _createArg2;
            private readonly Corvus.Ui5ManifestBenchmark.Current.JsonString.Source _createArg3;
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting.MaxAgeEntity.Source _createArg4;
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting.DictionaryOfCatalogObjectsOfferedByTheDatasource.Source<TContext> _createArg5;
            private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting.RepresentsVersionOfOData20IsDefault.Source _createArg6;
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="Setting"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting.JsonStringArray.Source annotations = default,
                in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source ignoreAnnotationsFromMetadata = default,
                in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source localUri = default,
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting.MaxAgeEntity.Source maxAge = default,
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting.DictionaryOfCatalogObjectsOfferedByTheDatasource.Source objects = default,
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting.RepresentsVersionOfOData20IsDefault.Source odataVersion = default)
            {
                annotations.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Annotations, ref builder);
                ignoreAnnotationsFromMetadata.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.IgnoreAnnotationsFromMetadata, ref builder);
                localUri.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.LocalUri, ref builder);
                maxAge.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.MaxAge, ref builder);
                objects.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Objects, ref builder);
                odataVersion.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.OdataVersion, ref builder);
            }
            ...
            public void Create(
                ...
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting.RepresentsVersionOfOData20IsDefault.Source odataVersion = default)
            {
                Create(ref _builder, annotations, ignoreAnnotationsFromMetadata, localUri, maxAge, objects, odataVersion);
            }
            ...
            internal static void Create<TContext>(
                in TContext context,
                ref ComplexValueBuilder builder,
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting.JsonStringArray.Source<TContext> annotations = default,
                in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source ignoreAnnotationsFromMetadata = default,
                in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source localUri = default,
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting.MaxAgeEntity.Source maxAge = default,
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting.DictionaryOfCatalogObjectsOfferedByTheDatasource.Source<TContext> objects = default,
                in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting.RepresentsVersionOfOData20IsDefault.Source odataVersion = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            ...
            #endif
            {
                Create(context, ref _builder, annotations, ignoreAnnotationsFromMetadata, localUri, maxAge, objects, odataVersion);
            }
        ...
        /// </summary>
        /// <param name="annotations">The value of the <c>"annotations"</c> property.</param>
        /// <param name="ignoreAnnotationsFromMetadata">The value of the <c>"ignoreAnnotationsFromMetadata"</c> property.</param>
        /// <param name="localUri">The value of the <c>"localUri"</c> property.</param>
        ...
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting.JsonStringArray.Source<TContext> annotations = default, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source ignoreAnnotationsFromMetadata = default, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source localUri = default, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting.MaxAgeEntity.Source maxAge = default, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting.DictionaryOfCatalogObjectsOfferedByTheDatasource.Source<TContext> objects = default, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting.RepresentsVersionOfOData20IsDefault.Source odataVersion = default)
            ...
            #endif
        {
            return new Source<TContext>(context, annotations, ignoreAnnotationsFromMetadata, localUri, maxAge, objects, odataVersion);
        }
        ...
        /// </summary>
        /// <param name="workspace">The JSON workspace.</param>
        /// <param name="annotations">The value of the property.</param>
        /// <param name="ignoreAnnotationsFromMetadata">The value of the property.</param>
        /// <param name="localUri">The value of the property.</param>
        /// <param name="maxAge">The value of the property.</param>
        /// <param name="objects">The value of the property.</param>
        /// <param name="odataVersion">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting.JsonStringArray.Source annotations = default, in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source ignoreAnnotationsFromMetadata = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source localUri = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting.MaxAgeEntity.Source maxAge = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting.DictionaryOfCatalogObjectsOfferedByTheDatasource.Source objects = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting.RepresentsVersionOfOData20IsDefault.Source odataVersion = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(annotations, ignoreAnnotationsFromMetadata, localUri, maxAge, objects, odataVersion);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting.JsonStringArray.Source<TContext> annotations = default, in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source ignoreAnnotationsFromMetadata = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source localUri = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting.MaxAgeEntity.Source maxAge = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting.DictionaryOfCatalogObjectsOfferedByTheDatasource.Source<TContext> objects = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting.RepresentsVersionOfOData20IsDefault.Source odataVersion = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            ...
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(context, annotations, ignoreAnnotationsFromMetadata, localUri, maxAge, objects, odataVersion);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<Setting, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<Setting> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Setting>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Setting> Create<TContext>(
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Setting> Create<TContext>(in TContext context, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting.JsonStringArray.Source<TContext> annotations = default, in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source ignoreAnnotationsFromMetadata = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source localUri = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting.MaxAgeEntity.Source maxAge = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting.DictionaryOfCatalogObjectsOfferedByTheDatasource.Source<TContext> objects = default, in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Setting.RepresentsVersionOfOData20IsDefault.Source odataVersion = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
