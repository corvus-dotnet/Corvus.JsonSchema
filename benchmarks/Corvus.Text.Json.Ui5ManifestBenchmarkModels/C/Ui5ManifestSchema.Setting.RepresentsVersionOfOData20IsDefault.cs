...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct Setting
    {
        ...
        public readonly partial struct RepresentsVersionOfOData20IsDefault
#if NET8_0_OR_GREATER
            : IJsonElement<RepresentsVersionOfOData20IsDefault>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RepresentsVersionOfOData20IsDefault"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RepresentsVersionOfOData20IsDefault(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RepresentsVersionOfOData20IsDefault DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(RepresentsVersionOfOData20IsDefault value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in RepresentsVersionOfOData20IsDefault left, in RepresentsVersionOfOData20IsDefault right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RepresentsVersionOfOData20IsDefault left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(RepresentsVersionOfOData20IsDefault instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RepresentsVersionOfOData20IsDefault(JsonElement instance)
            {
                return RepresentsVersionOfOData20IsDefault.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsVersionOfOData20IsDefault From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsVersionOfOData20IsDefault ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsVersionOfOData20IsDefault>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsVersionOfOData20IsDefault ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsVersionOfOData20IsDefault>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsVersionOfOData20IsDefault ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsVersionOfOData20IsDefault>(json, options);
            }
            ...
            /// </exception>
            public static RepresentsVersionOfOData20IsDefault ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RepresentsVersionOfOData20IsDefault>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsVersionOfOData20IsDefault? result)
            {
                return JsonElementHelpers.TryParseValue<RepresentsVersionOfOData20IsDefault>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RepresentsVersionOfOData20IsDefault(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static RepresentsVersionOfOData20IsDefault IJsonElement<RepresentsVersionOfOData20IsDefault>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RepresentsVersionOfOData20IsDefault: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RepresentsVersionOfOData20IsDefault"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RepresentsVersionOfOData20IsDefault"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public RepresentsVersionOfOData20IsDefault Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RepresentsVersionOfOData20IsDefault>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RepresentsVersionOfOData20IsDefault"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public RepresentsVersionOfOData20IsDefault Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RepresentsVersionOfOData20IsDefault>(_idx);
                }
