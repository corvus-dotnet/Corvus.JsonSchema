                ...
                public readonly partial struct LauncherValueEntity
                {
...
#endif
                    {
                        ...
                        public void SetPrompt(in Corvus.Ui5ManifestBenchmark.Current.JsonBoolean.Source value)
                        {
                            ...
                            {
                                // We are going to insert the new value
                                value.AddAsProperty(JsonPropertyNamesEscaped.Prompt, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                                int endIndex = _idx + _parent.GetDbSize(_idx, false);
                                _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                            }
                    ...
                    public ref struct Builder
                    {
                            ...
                            in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.ValueEntity.Source value = default)
                        {
                            ...
                            prompt.AddAsProperty(JsonPropertyNamesEscaped.Prompt, ref builder, escapeName: false);
