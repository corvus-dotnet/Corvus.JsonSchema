            ...
            public readonly partial struct W1Entity
            {
                ...
                public readonly partial struct LauncherValueEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.ValueEntity.JsonStringArray(ValueEntity value)
                        {
                            return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.ValueEntity.JsonStringArray.From(value);
                        }
                        ...
                        /// </summary>
                        /// <param name="value">The value from which to convert.</param>
                        public static implicit operator ValueEntity(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.ValueEntity.JsonStringArray value)
                        {
                            return From(value);
                        }

                        /// <summary>
                        /// Conversion from the <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.ValueEntity.JsonStringArray"/> mutable view.
                        /// </summary>
                        /// <param name="value">The value from which to convert.</param>
                        public static implicit operator ValueEntity(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.ValueEntity.JsonStringArray.Mutable value)
                        {
                            return From(value);
                        }
                        ...
                        public bool TryGetAsJsonStringArray(out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.ValueEntity.JsonStringArray result)
                        {
                            ...
                            {
                                result = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.ValueEntity.JsonStringArray.From(this);
                                return true;
                            }
                        ...
                        public TResult Match<TContext, TResult>(
                            ...
                            Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.ValueEntity, TContext, TResult> defaultMatch)
...
#endif
                        {
                            ...
                            if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.ValueEntity.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                            {
                                return matchJsonStringArray(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.ValueEntity.JsonStringArray.From(this), context);
                            }
                        ...
                        public TResult Match<TResult>(
                            ...
                            Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.ValueEntity, TResult> defaultMatch)
                        {
                            if (Corvus.Ui5ManifestBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                            {
                            ...
                            if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.ValueEntity.JsonStringArray.JsonSchema.Evaluate(_parent, _idx))
                            {
                                return matchJsonStringArray(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.ValueEntity.JsonStringArray.From(this));
                            }
