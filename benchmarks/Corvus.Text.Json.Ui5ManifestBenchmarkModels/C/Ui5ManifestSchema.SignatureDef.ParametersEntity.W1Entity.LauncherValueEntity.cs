        ...
        public readonly partial struct ParametersEntity
        {
            ...
            public readonly partial struct W1Entity
            {
...
#endif
                {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.FormatEntity Format
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FormatUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.FormatEntity value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.Ui5ManifestBenchmark.Current.JsonBoolean Prompt
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PromptUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonBoolean value))
                            {
                                return value;
                            }
                    ...
                    /// </summary>
                    public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.ValueEntity Value
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ValueUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.SignatureDef.ParametersEntity.W1Entity.LauncherValueEntity.ValueEntity value))
                            {
                                return value;
                            }
                    ...
                    private static class JsonPropertyNamesPrebaked
                    {
                        ...
                        /// <summary>
                        /// Gets the pre-baked property name blob for <see cref="Prompt"/>.
                        /// </summary>
                        public static ReadOnlySpan<byte> Prompt => [0x85, 0x00, 0x00, 0x00, 0x22, 0x70, 0x72, 0x6F, 0x6D, 0x70, 0x74, 0x22];
