                ...
                public readonly partial struct RepresentsAFilterOnlyIfInputParameterMatchesFilter
                {
                        ...
                        : IJsonElement<FormatEntity>
                    {
                        ...
                        public static partial class JsonSchema
                        {
                            ...
                            /// </summary>
                            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/signature_def/properties/parameters/patternProperties/^[\\w\\.\\-\\~1]+$/properties/filter/properties/format"u8, buffer, out written);
                                ...
                                ref JsonSchemaContext context)
                            {
                                ...
                                else
                                {
                                    ...
                                    if (unescapedUtf8JsonString.Span.SequenceEqual("plain"u8))
                                    {
                                        goto enumShortCircuitSuccess;
                                    }

                                    if (unescapedUtf8JsonString.Span.SequenceEqual("regexp"u8))
                                    {
                                        goto enumShortCircuitSuccess;
                                    }

                                    if (unescapedUtf8JsonString.Span.SequenceEqual("reference"u8))
                                    {
                                        goto enumShortCircuitSuccess;
                                    }
