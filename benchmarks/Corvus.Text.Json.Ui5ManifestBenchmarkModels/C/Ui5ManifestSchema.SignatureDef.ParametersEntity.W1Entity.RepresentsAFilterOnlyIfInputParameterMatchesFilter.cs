        ...
        public readonly partial struct ParametersEntity
        {
            ...
            public readonly partial struct W1Entity
            {
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="RepresentsAFilterOnlyIfInputParameterMatchesFilter"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal RepresentsAFilterOnlyIfInputParameterMatchesFilter(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static RepresentsAFilterOnlyIfInputParameterMatchesFilter DefaultInstance { get; }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.SignatureDef.ParametersEntity.W1Entity.RepresentsAFilterOnlyIfInputParameterMatchesFilter.FormatEntity Format
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FormatUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.SignatureDef.ParametersEntity.W1Entity.RepresentsAFilterOnlyIfInputParameterMatchesFilter.FormatEntity value))
                            {
                                return value;
                            }
                    ...
                    /// </returns>
                    public static bool operator ==(in RepresentsAFilterOnlyIfInputParameterMatchesFilter left, in RepresentsAFilterOnlyIfInputParameterMatchesFilter right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in RepresentsAFilterOnlyIfInputParameterMatchesFilter left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    public static implicit operator JsonElement(RepresentsAFilterOnlyIfInputParameterMatchesFilter instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator RepresentsAFilterOnlyIfInputParameterMatchesFilter(JsonElement instance)
                    {
                        return RepresentsAFilterOnlyIfInputParameterMatchesFilter.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RepresentsAFilterOnlyIfInputParameterMatchesFilter From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RepresentsAFilterOnlyIfInputParameterMatchesFilter ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RepresentsAFilterOnlyIfInputParameterMatchesFilter>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RepresentsAFilterOnlyIfInputParameterMatchesFilter ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RepresentsAFilterOnlyIfInputParameterMatchesFilter>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static RepresentsAFilterOnlyIfInputParameterMatchesFilter ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<RepresentsAFilterOnlyIfInputParameterMatchesFilter>(json, options);
                    }
                    ...
                    /// </exception>
                    public static RepresentsAFilterOnlyIfInputParameterMatchesFilter ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<RepresentsAFilterOnlyIfInputParameterMatchesFilter>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsAFilterOnlyIfInputParameterMatchesFilter? result)
                    {
                        return JsonElementHelpers.TryParseValue<RepresentsAFilterOnlyIfInputParameterMatchesFilter>(ref reader, out result);
                    }
...
#if NET
                    static RepresentsAFilterOnlyIfInputParameterMatchesFilter IJsonElement<RepresentsAFilterOnlyIfInputParameterMatchesFilter>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"RepresentsAFilterOnlyIfInputParameterMatchesFilter: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public RepresentsAFilterOnlyIfInputParameterMatchesFilter Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public RepresentsAFilterOnlyIfInputParameterMatchesFilter Freeze()
                    {
                        CheckValidInstance();
                        if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                        {
                            return mutable.FreezeElement<RepresentsAFilterOnlyIfInputParameterMatchesFilter>(_idx);
                        }
