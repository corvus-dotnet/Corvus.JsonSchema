...
public readonly partial struct Ui5ManifestSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SimpleIcon"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal SimpleIcon(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static SimpleIcon DefaultInstance { get; }
        ...
        /// </returns>
        public static bool operator ==(in SimpleIcon left, in SimpleIcon right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in SimpleIcon left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(SimpleIcon instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator SimpleIcon(JsonElement instance)
        {
            return SimpleIcon.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SimpleIcon From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SimpleIcon ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SimpleIcon>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SimpleIcon ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SimpleIcon>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SimpleIcon ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<SimpleIcon>(json, options);
        }
        ...
        /// </exception>
        public static SimpleIcon ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<SimpleIcon>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out SimpleIcon? result)
        {
            return JsonElementHelpers.TryParseValue<SimpleIcon>(ref reader, out result);
        }
...
#if NET
        static SimpleIcon IJsonElement<SimpleIcon>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"SimpleIcon: ValueKind = {ValueKind} : \"{ToString()}\"";
