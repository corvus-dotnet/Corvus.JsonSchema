...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct State
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<State, Mutable>(State.DefaultInstance);
            ...
            public static explicit operator Mutable(State instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="State"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator State(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"State.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly State Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<State>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(State instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (State)value;
        ...
        {
            return workspace.CreateBuilder<State, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<State> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<State>();
            }
            finally
            {
