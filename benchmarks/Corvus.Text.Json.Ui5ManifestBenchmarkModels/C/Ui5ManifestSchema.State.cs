...
public readonly partial struct Ui5ManifestSchema
{
...
#endif
    {
        ...
        internal State(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static State DefaultInstance { get; } = ParsedJsonDocument<State>.StringConstant([.."\"None\""u8]);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(State value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in State left, in State right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in State left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(State instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator State(JsonElement instance)
        {
            return State.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static State From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static State ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<State>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static State ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<State>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static State ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<State>(json, options);
        }
        ...
        /// </exception>
        public static State ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<State>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out State? result)
        {
            return JsonElementHelpers.TryParseValue<State>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new State(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static State IJsonElement<State>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"State: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="State"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="State"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        {
            CheckValidInstance();
            return _parent.CloneElement<State>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="State"/> that lives for the lifetime of its
        ...
        public State Freeze()
        {
            ...
            {
                return mutable.FreezeElement<State>(_idx);
            }
        ...
        /// <param name="matchSuccess">Match 2nd item.</param>
        /// <param name="matchWarning">Match 3rd item.</param>
        /// <param name="matchNone">Match 4th item.</param>
        /// <param name="matchInformation">Match 5th item.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Func<TContext, TResult> matchError,
            Func<TContext, TResult> matchSuccess,
            Func<TContext, TResult> matchWarning,
            Func<TContext, TResult> matchNone,
            Func<TContext, TResult> matchInformation,
...
#endif
        {
            ...
            {
                return matchInformation(context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Func<TResult> matchSuccess,
            Func<TResult> matchWarning,
            Func<TResult> matchNone,
            Func<TResult> matchInformation,
