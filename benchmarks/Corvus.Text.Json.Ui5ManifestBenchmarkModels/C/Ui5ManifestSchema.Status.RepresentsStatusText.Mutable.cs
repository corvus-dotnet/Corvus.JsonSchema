    ...
    public readonly partial struct Status
    {
        ...
        public readonly partial struct RepresentsStatusText
        {
...
#endif
            {
                ...
                /// <summary>
                /// Conversion to <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static explicit operator Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.Mutable(Mutable value)
                {
                    return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.Mutable.From(value);
                }

                /// <summary>
                /// Conversion from <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter"/>.
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.Mutable value)
                {
                    return From(value);
                }
                ...
                public static explicit operator Mutable(RepresentsStatusText instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsStatusText"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsStatusText(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new RepresentsStatusText(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsStatusText.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="RepresentsStatusText"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="RepresentsStatusText"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsStatusText Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<RepresentsStatusText>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="RepresentsStatusText"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsStatusText Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsStatusText>(_idx);
                }
                ...
                /// <param name="matchStatusTextFormatter">Match a <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter"/>.</param>
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter, TContext, TResult> matchStatusTextFormatter,
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Status.RepresentsStatusText.Mutable, TContext, TResult> defaultMatch)
...
#endif
                {
                    ...
                    {
                        return matchStatusTextFormatter(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter, TResult> matchStatusTextFormatter,
                    Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Status.RepresentsStatusText.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                    {
                    ...
                    if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchStatusTextFormatter(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.Mutable.From(this));
                    }
                ...
                public bool TryGetAsStatusTextFormatter(out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.Mutable result)
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.Mutable.From(this);
                        return true;
                    }
            ...
            public ref struct Source
            {
                private enum Kind
                {
                    Unknown,
                    JsonElement,
                    StatusTextFormatterBuilder,
                    StatusTextFormatterSource,
                ...
                private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.Builder.Build? _statusTextFormatterBuilderInstance;
                private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.Source _statusTextFormatterSourceInstance;
                ...
                public Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.Builder.Build value) {_statusTextFormatterBuilderInstance = value; _kind = Kind.StatusTextFormatterBuilder; }

                public Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.Source value) { _statusTextFormatterSourceInstance = value; _kind = Kind.StatusTextFormatterSource; }

                public static implicit operator Source(RepresentsStatusText instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter instance) => new(JsonElement.From(instance));

                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.Source value) => new(value);
                ...
                internal void AddAsProperty(ReadOnlySpan<byte> utf8Name, ref ComplexValueBuilder valueBuilder, bool escapeName = true, bool nameRequiresUnescaping = false)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.Utf16String:
                            ...
                            break;
                        case Kind.StatusTextFormatterBuilder:
                            valueBuilder.AddProperty(utf8Name, _statusTextFormatterBuilderInstance!, static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.Builder.BuildValue(b, ref o), escapeName, nameRequiresUnescaping);
                            break;
                        case Kind.StatusTextFormatterSource:
                            _statusTextFormatterSourceInstance.AddAsProperty(utf8Name, ref valueBuilder, escapeName, nameRequiresUnescaping);
                            break;
                        default:
                ...
                internal void AddAsPrebakedProperty(ReadOnlySpan<byte> prebakedPropertyName, ref ComplexValueBuilder valueBuilder)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.Utf16String:
                            ...
                            break;
                        case Kind.StatusTextFormatterBuilder:
                            valueBuilder.AddPrebakedProperty(prebakedPropertyName, _statusTextFormatterBuilderInstance!, static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.Builder.BuildValue(b, ref o));
                            break;
                        case Kind.StatusTextFormatterSource:
                            _statusTextFormatterSourceInstance.AddAsPrebakedProperty(prebakedPropertyName, ref valueBuilder);
                            break;
                        default:
                            Debug.Fail("Unexpected Kind");
                            break;
                ...
                internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.Utf16String:
                            ...
                            break;
                        case Kind.StatusTextFormatterBuilder:
                            valueBuilder.AddProperty(name, _statusTextFormatterBuilderInstance!, static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.Builder.BuildValue(b, ref o));
                            break;
                        case Kind.StatusTextFormatterSource:
                            _statusTextFormatterSourceInstance.AddAsProperty(name, ref valueBuilder);
                            break;
                        default:
                            Debug.Fail("Unexpected Kind");
                            break;
                ...
                internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.Utf16String:
                            ...
                            break;
                        case Kind.StatusTextFormatterBuilder:
                            valueBuilder.AddItem(_statusTextFormatterBuilderInstance!, static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.Builder.BuildValue(b, ref o));
                            break;
                        case Kind.StatusTextFormatterSource:
                            _statusTextFormatterSourceInstance.AddAsItem(ref valueBuilder);
                            break;
                        default:
                            Debug.Fail("Unexpected Kind");
                            break;
                ...
                #endif
            {
                ...
                TContext _context;
                Source _source;
                private readonly Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.Builder.Build<TContext>? _statusTextFormatterBuilderInstance;
                ...
                public Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.Builder.Build<TContext> value) {_context = context; _statusTextFormatterBuilderInstance = value; _kind = Kind.StatusTextFormatterBuilder; }
                ...
                internal void AddAsProperty(ReadOnlySpan<byte> utf8Name, ref ComplexValueBuilder valueBuilder, bool escapeName = true, bool nameRequiresUnescaping = false)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.Source:
                            ...
                            break;
                        case Kind.StatusTextFormatterBuilder:
                            valueBuilder.AddProperty(utf8Name, BuildWithContext.Create(_context, _statusTextFormatterBuilderInstance!), static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.Builder.BuildValue(b.Context, b.Build, ref o), escapeName, nameRequiresUnescaping);
                            break;
                        default:
                            Debug.Fail("Unexpected Kind");
                            break;
                ...
                internal void AddAsPrebakedProperty(ReadOnlySpan<byte> prebakedPropertyName, ref ComplexValueBuilder valueBuilder)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.Source:
                            ...
                            break;
                        case Kind.StatusTextFormatterBuilder:
                            valueBuilder.AddPrebakedProperty(prebakedPropertyName, BuildWithContext.Create(_context, _statusTextFormatterBuilderInstance!), static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.Builder.BuildValue(b.Context, b.Build, ref o));
                            break;
                        default:
                            Debug.Fail("Unexpected Kind");
                            break;
                ...
                internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.Source:
                            ...
                            break;
                        case Kind.StatusTextFormatterBuilder:
                            valueBuilder.AddProperty(name, BuildWithContext.Create(_context, _statusTextFormatterBuilderInstance!), static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.Builder.BuildValue(b.Context, b.Build, ref o));
                            break;
                        default:
                            Debug.Fail("Unexpected Kind");
                            break;
                ...
                internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.Source:
                            ...
                            break;
                        case Kind.StatusTextFormatterBuilder:
                            valueBuilder.AddItem(BuildWithContext.Create(_context, _statusTextFormatterBuilderInstance!), static (in b, ref o) => Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.Builder.BuildValue(b.Context, b.Build, ref o));
                            break;
                        default:
                            Debug.Fail("Unexpected Kind");
                            break;
            ...
            public static Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.Source Build(
                scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.Builder.Build buildValue, int initialCapacity = 1)
            {
                return new Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.Source(buildValue);
            }
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.Source<TContext> Build<TContext>(
                scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.Builder.Build<TContext> buildValue, int initialCapacity = 1)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                return new Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.Source<TContext>(context, buildValue);
            }
            ...
            /// <returns>An instance of a mutable document initialized with the given value.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(
                JsonWorkspace workspace, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
            {
                // Create the document builder without a MetadataDb
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                var source = new Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.Source(value);
            ...
            /// <returns>An instance of a mutable document initialized with the given value.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(
                JsonWorkspace workspace, scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                ...
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                var source = new Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.Source<TContext>(context, value);
                source.AddAsItem(ref cvb);
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<RepresentsStatusText, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RepresentsStatusText> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RepresentsStatusText>();
                }
                finally
                {
            ...
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RepresentsStatusText> Create(
                scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent(initialValueBufferSize);
                try
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RepresentsStatusText> Create<TContext>(
                scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
