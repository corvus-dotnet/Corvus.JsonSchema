...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct Status
    {
...
#endif
        {
            ...
            public static explicit operator Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter(RepresentsStatusText value)
            {
                return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator RepresentsStatusText(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter value)
            {
                return From(value);
            }
            ...
            public bool TryGetAsStatusTextFormatter(out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter result)
            {
                ...
                {
                    result = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.From(this);
                    return true;
                }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Status.RepresentsStatusText, TContext, TResult> defaultMatch)
...
#endif
            {
                ...
                if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchStatusTextFormatter(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Status.RepresentsStatusText, TResult> defaultMatch)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                ...
                if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchStatusTextFormatter(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.From(this));
                }
