...
public readonly partial struct Ui5ManifestSchema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Status.RepresentsStatusText Text
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TextUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Status.RepresentsStatusText value))
                {
                    return value;
                }
