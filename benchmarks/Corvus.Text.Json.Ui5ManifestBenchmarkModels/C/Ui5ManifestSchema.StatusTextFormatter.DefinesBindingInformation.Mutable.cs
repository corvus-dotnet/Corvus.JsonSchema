    ...
    public readonly partial struct StatusTextFormatter
    {
        ...
        public readonly partial struct DefinesBindingInformation
        {
...
#endif
            {
                ...
                /// </summary>
                public Corvus.Ui5ManifestBenchmark.Current.JsonArray.Mutable Parts
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PartsUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonArray.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </summary>
                public Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable TranslationKey
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TranslationKeyUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetParts(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonArray.Source value)
                {
                    CheckValidInstance();
                    ...
                    else
                    {
                        ...
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Parts, ref cvb);
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetParts<TContext>(in Corvus.Ui5ManifestBenchmark.Current.JsonArray.Source<TContext> value)
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetTranslationKey(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source value)
                {
                    CheckValidInstance();
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.TranslationKey, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.DefinesBindingInformation.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonArray.Source arg1, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source arg2)
                {
                    _createArg1 = arg1;
                    _createArg2 = arg2;
                    _kind = Kind.Create;
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.DefinesBindingInformation.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonArray.Source<TContext> arg1, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source arg2)
                {
                    _context = context;
                    _createArg1 = arg1;
                    _createArg2 = arg2;
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.Ui5ManifestBenchmark.Current.JsonArray.Source parts = default,
                    in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source translationKey = default)
                {
                    parts.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Parts, ref builder);
                    translationKey.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.TranslationKey, ref builder);
                }

                /// <summary>
                /// Creates an instance of a <see cref="DefinesBindingInformation"/>.
                /// </summary>
                public void Create(in Corvus.Ui5ManifestBenchmark.Current.JsonArray.Source parts = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source translationKey = default)
                {
                ...
                internal static void Create<TContext>(
                    in TContext context,
                    ref ComplexValueBuilder builder,
                    in Corvus.Ui5ManifestBenchmark.Current.JsonArray.Source<TContext> parts = default,
                    in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source translationKey = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
                ...
                internal static void BuildCreateValue(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonArray.Source arg1, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source arg2, ref ComplexValueBuilder o)
                {
                    o.StartObject();
                ...
                /// <param name="arg2">The value of the property.</param>
                /// <param name="o">The complex value builder into which to write the object.</param>
                internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonArray.Source<TContext> arg1, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source arg2, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                    where TContext : allows ref struct
#endif
                {
            ...
            /// </summary>
            /// <param name="parts">The value of the <c>"parts"</c> property.</param>
            /// <param name="translationKey">The value of the <c>"translationKey"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonArray.Source parts = default, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source translationKey = default)
            {
                return new Source(parts, translationKey);
            }
            ...
            /// <param name="translationKey">The value of the <c>"translationKey"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonArray.Source<TContext> parts = default, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source translationKey = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                return new Source<TContext>(context, parts, translationKey);
            }
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.JsonArray.Source parts = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source translationKey = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Ui5ManifestBenchmark.Current.JsonArray.Source<TContext> parts = default, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source translationKey = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
