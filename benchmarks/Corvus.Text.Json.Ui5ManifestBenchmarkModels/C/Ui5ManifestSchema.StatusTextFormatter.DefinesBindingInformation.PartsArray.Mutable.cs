...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct StatusTextFormatter
    {
        ...
        public readonly partial struct DefinesBindingInformation
        {
            ...
            public readonly partial struct PartsArray
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(PartsArray instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="PartsArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator PartsArray(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new PartsArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"PartsArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    /// <summary>
                    ...
                    /// <summary>
                    /// Gets a <see cref="PartsArray"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="PartsArray"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly PartsArray Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<PartsArray>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="PartsArray"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly PartsArray Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<PartsArray>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.DefinesBindingInformation.PartsArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(PartsArray instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.DefinesBindingInformation.PartsArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
                ...
                {
                    return workspace.CreateBuilder<PartsArray, Mutable>(this);
                }
            }
        }
    }
