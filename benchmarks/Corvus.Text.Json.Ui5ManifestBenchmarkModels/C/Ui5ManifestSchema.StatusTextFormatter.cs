...
public readonly partial struct Ui5ManifestSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StatusTextFormatter"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal StatusTextFormatter(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static StatusTextFormatter DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.DefinesBindingInformation Format
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.FormatUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.StatusTextFormatter.DefinesBindingInformation value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in StatusTextFormatter left, in StatusTextFormatter right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in StatusTextFormatter left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(StatusTextFormatter instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator StatusTextFormatter(JsonElement instance)
        {
            return StatusTextFormatter.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static StatusTextFormatter From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static StatusTextFormatter ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<StatusTextFormatter>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static StatusTextFormatter ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<StatusTextFormatter>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static StatusTextFormatter ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<StatusTextFormatter>(json, options);
        }
        ...
        /// </exception>
        public static StatusTextFormatter ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<StatusTextFormatter>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out StatusTextFormatter? result)
        {
            return JsonElementHelpers.TryParseValue<StatusTextFormatter>(ref reader, out result);
        }
...
#if NET
        static StatusTextFormatter IJsonElement<StatusTextFormatter>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"StatusTextFormatter: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public StatusTextFormatter Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public StatusTextFormatter Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<StatusTextFormatter>(_idx);
            }
