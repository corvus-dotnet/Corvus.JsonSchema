...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct TabSetting
    {
        ...
        public readonly partial struct ChartPropertiesEntity
            ...
            : IJsonElement<ChartPropertiesEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ChartPropertiesEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ChartPropertiesEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ChartPropertiesEntity DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.PlotAreaDef PlotArea
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PlotAreaUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.PlotAreaDef value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.TimeAxisDef TimeAxis
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TimeAxisUtf8, out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.TimeAxisDef value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in ChartPropertiesEntity left, in ChartPropertiesEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ChartPropertiesEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(ChartPropertiesEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ChartPropertiesEntity(JsonElement instance)
            {
                return ChartPropertiesEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ChartPropertiesEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ChartPropertiesEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ChartPropertiesEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ChartPropertiesEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ChartPropertiesEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ChartPropertiesEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ChartPropertiesEntity>(json, options);
            }
            ...
            /// </exception>
            public static ChartPropertiesEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ChartPropertiesEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ChartPropertiesEntity? result)
            {
                return JsonElementHelpers.TryParseValue<ChartPropertiesEntity>(ref reader, out result);
            }
...
#if NET
            static ChartPropertiesEntity IJsonElement<ChartPropertiesEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ChartPropertiesEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public ChartPropertiesEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public ChartPropertiesEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ChartPropertiesEntity>(_idx);
                }
            ...
            public static class JsonPropertyNames
            {
                ...
                /// <summary>
                /// Gets the JSON property name for <see cref="TimeAxis"/>.
                /// </summary>
                public const string TimeAxis = "timeAxis";
                ...
                /// Gets the JSON property name for <see cref="TimeAxis"/>.
                /// </summary>
                public static ReadOnlySpan<byte> TimeAxisUtf8 => "timeAxis"u8;
            }
            ...
            private static class JsonPropertyNamesEscaped
            {
                ...
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="TimeAxis"/>.
                /// </summary>
                public static ReadOnlySpan<byte> TimeAxis => "timeAxis"u8;
            }
            ...
            {
                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="PlotArea"/>.
                /// </summary>
                public static ReadOnlySpan<byte> PlotArea => [0xA5, 0x00, 0x00, 0x00, 0x22, 0x70, 0x6C, 0x6F, 0x74, 0x41, 0x72, 0x65, 0x61, 0x22];

                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="TimeAxis"/>.
                /// </summary>
                public static ReadOnlySpan<byte> TimeAxis => [0xA5, 0x00, 0x00, 0x00, 0x22, 0x74, 0x69, 0x6D, 0x65, 0x41, 0x78, 0x69, 0x73, 0x22];
            }
        }
    }
}
