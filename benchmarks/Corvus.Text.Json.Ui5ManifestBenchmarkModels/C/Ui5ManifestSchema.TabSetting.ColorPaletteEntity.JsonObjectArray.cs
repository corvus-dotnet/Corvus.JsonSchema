    ...
    public readonly partial struct TabSetting
    {
        ...
        public readonly partial struct ColorPaletteEntity
        {
...
#endif
            {
                ...
                public Corvus.Ui5ManifestBenchmark.Current.JsonObject this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.Ui5ManifestBenchmark.Current.JsonObject>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.Ui5ManifestBenchmark.Current.JsonObject> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.Ui5ManifestBenchmark.Current.JsonObject>(_parent, _idx);
                }
