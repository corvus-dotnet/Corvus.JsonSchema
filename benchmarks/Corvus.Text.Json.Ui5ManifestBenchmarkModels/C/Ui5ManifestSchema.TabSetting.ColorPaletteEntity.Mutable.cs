    ...
    public readonly partial struct TabSetting
    {
        ...
        public readonly partial struct ColorPaletteEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ColorPaletteEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ColorPaletteEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ColorPaletteEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ColorPaletteEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </para>
                /// </remarks>
                public readonly ColorPaletteEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ColorPaletteEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ColorPaletteEntity>(_idx);
                }
                ...
                /// <summary>
                /// Gets the value as a <see cref="Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.TabSetting.ColorPaletteEntity.JsonObjectArray.Mutable" />.
                /// </summary>
                /// <param name="result">The result of the conversions.</param>
                /// <returns><see langword="true" /> if the conversion was valid.</returns>
                public bool TryGetAsJsonObjectArray(out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.TabSetting.ColorPaletteEntity.JsonObjectArray.Mutable result)
                {
                    if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.TabSetting.ColorPaletteEntity.JsonObjectArray.JsonSchema.Evaluate(_parent, _idx))
                    {
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.TabSetting.ColorPaletteEntity.ObjectBuilder.Build value) {_objectBuilder = value; _kind = Kind.ObjectBuilder; }

                internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.TabSetting.ColorPaletteEntity.ArrayBuilder.Build value) {_arrayBuilder = value; _kind = Kind.ArrayBuilder; }

                public static implicit operator Source(ColorPaletteEntity instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.TabSetting.ColorPaletteEntity.ObjectBuilder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.ObjectBuilder; }

                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.TabSetting.ColorPaletteEntity.ArrayBuilder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.ArrayBuilder; }
            ...
            {
                return workspace.CreateBuilder<ColorPaletteEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ColorPaletteEntity> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ColorPaletteEntity>();
                }
                finally
                {
            ...
            public static ParsedJsonDocument<ColorPaletteEntity> CreateArray(
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>An empty <see cref="ParsedJsonDocument{T}"/>. The caller must dispose it.</returns>
            public static ParsedJsonDocument<ColorPaletteEntity> CreateObject(
                int initialCapacity = 30, int initialValueBufferSize = 8192)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent(initialValueBufferSize);
                try
