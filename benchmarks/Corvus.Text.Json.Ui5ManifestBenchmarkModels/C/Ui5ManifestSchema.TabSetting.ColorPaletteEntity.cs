...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct TabSetting
    {
        ...
        public readonly partial struct ColorPaletteEntity
#if NET8_0_OR_GREATER
            : IJsonElement<ColorPaletteEntity>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ColorPaletteEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ColorPaletteEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ColorPaletteEntity DefaultInstance { get; }
            ...
            public static explicit operator Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.TabSetting.ColorPaletteEntity.Type0EntityArray(ColorPaletteEntity value)
            {
                return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.TabSetting.ColorPaletteEntity.Type0EntityArray.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator ColorPaletteEntity(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.TabSetting.ColorPaletteEntity.Type0EntityArray value)
            {
                return From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.TabSetting.ColorPaletteEntity.OneOf1Entity(ColorPaletteEntity value)
            {
                return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.TabSetting.ColorPaletteEntity.OneOf1Entity.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator ColorPaletteEntity(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.TabSetting.ColorPaletteEntity.OneOf1Entity value)
            {
                return From(value);
            }
            ...
            /// </returns>
            public static bool operator ==(in ColorPaletteEntity left, in ColorPaletteEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ColorPaletteEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(ColorPaletteEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ColorPaletteEntity(JsonElement instance)
            {
                return ColorPaletteEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ColorPaletteEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ColorPaletteEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ColorPaletteEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ColorPaletteEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ColorPaletteEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ColorPaletteEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ColorPaletteEntity>(json, options);
            }
            ...
            /// </exception>
            public static ColorPaletteEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ColorPaletteEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ColorPaletteEntity? result)
            {
                return JsonElementHelpers.TryParseValue<ColorPaletteEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new ColorPaletteEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static ColorPaletteEntity IJsonElement<ColorPaletteEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ColorPaletteEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="ColorPaletteEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="ColorPaletteEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public ColorPaletteEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<ColorPaletteEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="ColorPaletteEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public ColorPaletteEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ColorPaletteEntity>(_idx);
                }
            ...
            public bool TryGetAsType0EntityArray(out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.TabSetting.ColorPaletteEntity.Type0EntityArray result)
            {
                ...
                {
                    result = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.TabSetting.ColorPaletteEntity.Type0EntityArray.From(this);
                    return true;
                }
            ...
            public bool TryGetAsOneOf1Entity(out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.TabSetting.ColorPaletteEntity.OneOf1Entity result)
            {
                ...
                {
                    result = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.TabSetting.ColorPaletteEntity.OneOf1Entity.From(this);
                    return true;
                }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.TabSetting.ColorPaletteEntity, TContext, TResult> defaultMatch)
...
#endif
            {
                if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.TabSetting.ColorPaletteEntity.Type0EntityArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchType0EntityArray(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.TabSetting.ColorPaletteEntity.Type0EntityArray.From(this), context);
                }

                if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.TabSetting.ColorPaletteEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchOneOf1Entity(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.TabSetting.ColorPaletteEntity.OneOf1Entity.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.TabSetting.ColorPaletteEntity, TResult> defaultMatch)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.TabSetting.ColorPaletteEntity.Type0EntityArray.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchType0EntityArray(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.TabSetting.ColorPaletteEntity.Type0EntityArray.From(this));
                }

                if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.TabSetting.ColorPaletteEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchOneOf1Entity(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.TabSetting.ColorPaletteEntity.OneOf1Entity.From(this));
                }
