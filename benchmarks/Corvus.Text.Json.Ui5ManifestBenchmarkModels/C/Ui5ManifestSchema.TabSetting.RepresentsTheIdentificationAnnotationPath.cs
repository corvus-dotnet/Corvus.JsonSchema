...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct TabSetting
    {
        ...
        public readonly partial struct RepresentsTheIdentificationAnnotationPath
#if NET8_0_OR_GREATER
            : IJsonElement<RepresentsTheIdentificationAnnotationPath>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RepresentsTheIdentificationAnnotationPath"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RepresentsTheIdentificationAnnotationPath(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RepresentsTheIdentificationAnnotationPath DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(RepresentsTheIdentificationAnnotationPath value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in RepresentsTheIdentificationAnnotationPath left, in RepresentsTheIdentificationAnnotationPath right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RepresentsTheIdentificationAnnotationPath left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(RepresentsTheIdentificationAnnotationPath instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RepresentsTheIdentificationAnnotationPath(JsonElement instance)
            {
                return RepresentsTheIdentificationAnnotationPath.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheIdentificationAnnotationPath From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheIdentificationAnnotationPath ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheIdentificationAnnotationPath>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheIdentificationAnnotationPath ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheIdentificationAnnotationPath>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheIdentificationAnnotationPath ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheIdentificationAnnotationPath>(json, options);
            }
            ...
            /// </exception>
            public static RepresentsTheIdentificationAnnotationPath ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheIdentificationAnnotationPath>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsTheIdentificationAnnotationPath? result)
            {
                return JsonElementHelpers.TryParseValue<RepresentsTheIdentificationAnnotationPath>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RepresentsTheIdentificationAnnotationPath(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static RepresentsTheIdentificationAnnotationPath IJsonElement<RepresentsTheIdentificationAnnotationPath>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RepresentsTheIdentificationAnnotationPath: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RepresentsTheIdentificationAnnotationPath"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RepresentsTheIdentificationAnnotationPath"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public RepresentsTheIdentificationAnnotationPath Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RepresentsTheIdentificationAnnotationPath>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RepresentsTheIdentificationAnnotationPath"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public RepresentsTheIdentificationAnnotationPath Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RepresentsTheIdentificationAnnotationPath>(_idx);
                }
