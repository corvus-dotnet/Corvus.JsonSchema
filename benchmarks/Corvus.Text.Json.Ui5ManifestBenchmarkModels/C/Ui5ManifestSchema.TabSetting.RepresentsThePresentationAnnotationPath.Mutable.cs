    ...
    public readonly partial struct TabSetting
    {
        ...
        public readonly partial struct RepresentsThePresentationAnnotationPath
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RepresentsThePresentationAnnotationPath instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsThePresentationAnnotationPath"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsThePresentationAnnotationPath(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsThePresentationAnnotationPath.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsThePresentationAnnotationPath Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsThePresentationAnnotationPath Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsThePresentationAnnotationPath>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsThePresentationAnnotationPath instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RepresentsThePresentationAnnotationPath, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RepresentsThePresentationAnnotationPath> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RepresentsThePresentationAnnotationPath>();
                }
                finally
                {
