    ...
    public readonly partial struct Target
    {
        ...
        public readonly partial struct RepresentsTheTypeOfViewThatIsGoingToBeCreated
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RepresentsTheTypeOfViewThatIsGoingToBeCreated instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RepresentsTheTypeOfViewThatIsGoingToBeCreated"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RepresentsTheTypeOfViewThatIsGoingToBeCreated(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RepresentsTheTypeOfViewThatIsGoingToBeCreated.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheTypeOfViewThatIsGoingToBeCreated Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly RepresentsTheTypeOfViewThatIsGoingToBeCreated Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RepresentsTheTypeOfViewThatIsGoingToBeCreated>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RepresentsTheTypeOfViewThatIsGoingToBeCreated instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (RepresentsTheTypeOfViewThatIsGoingToBeCreated)value;
            ...
            {
                return workspace.CreateBuilder<RepresentsTheTypeOfViewThatIsGoingToBeCreated, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RepresentsTheTypeOfViewThatIsGoingToBeCreated> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RepresentsTheTypeOfViewThatIsGoingToBeCreated>();
                }
                finally
                {
