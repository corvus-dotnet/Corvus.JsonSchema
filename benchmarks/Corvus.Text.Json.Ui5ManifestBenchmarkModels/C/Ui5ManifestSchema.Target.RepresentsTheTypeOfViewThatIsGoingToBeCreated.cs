...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct Target
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RepresentsTheTypeOfViewThatIsGoingToBeCreated"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RepresentsTheTypeOfViewThatIsGoingToBeCreated(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RepresentsTheTypeOfViewThatIsGoingToBeCreated DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(RepresentsTheTypeOfViewThatIsGoingToBeCreated value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in RepresentsTheTypeOfViewThatIsGoingToBeCreated left, in RepresentsTheTypeOfViewThatIsGoingToBeCreated right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RepresentsTheTypeOfViewThatIsGoingToBeCreated left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(RepresentsTheTypeOfViewThatIsGoingToBeCreated instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RepresentsTheTypeOfViewThatIsGoingToBeCreated(JsonElement instance)
            {
                return RepresentsTheTypeOfViewThatIsGoingToBeCreated.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheTypeOfViewThatIsGoingToBeCreated From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheTypeOfViewThatIsGoingToBeCreated ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheTypeOfViewThatIsGoingToBeCreated>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheTypeOfViewThatIsGoingToBeCreated ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheTypeOfViewThatIsGoingToBeCreated>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RepresentsTheTypeOfViewThatIsGoingToBeCreated ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheTypeOfViewThatIsGoingToBeCreated>(json, options);
            }
            ...
            /// </exception>
            public static RepresentsTheTypeOfViewThatIsGoingToBeCreated ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RepresentsTheTypeOfViewThatIsGoingToBeCreated>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RepresentsTheTypeOfViewThatIsGoingToBeCreated? result)
            {
                return JsonElementHelpers.TryParseValue<RepresentsTheTypeOfViewThatIsGoingToBeCreated>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RepresentsTheTypeOfViewThatIsGoingToBeCreated(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static RepresentsTheTypeOfViewThatIsGoingToBeCreated IJsonElement<RepresentsTheTypeOfViewThatIsGoingToBeCreated>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RepresentsTheTypeOfViewThatIsGoingToBeCreated: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="RepresentsTheTypeOfViewThatIsGoingToBeCreated"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RepresentsTheTypeOfViewThatIsGoingToBeCreated"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public RepresentsTheTypeOfViewThatIsGoingToBeCreated Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RepresentsTheTypeOfViewThatIsGoingToBeCreated>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RepresentsTheTypeOfViewThatIsGoingToBeCreated"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public RepresentsTheTypeOfViewThatIsGoingToBeCreated Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RepresentsTheTypeOfViewThatIsGoingToBeCreated>(_idx);
                }
            ...
            /// <param name="matchXml">Match 1st item.</param>
            /// <param name="matchJson">Match 2nd item.</param>
            /// <param name="matchJs">Match 3rd item.</param>
            /// <param name="matchHtml">Match 4th item.</param>
            /// <param name="matchTemplate">Match 5th item.</param>
            ...
            public TResult Match<TContext, TResult>(
                ...
                Func<TContext, TResult> matchJs,
                Func<TContext, TResult> matchHtml,
                Func<TContext, TResult> matchTemplate,
            ...
            public TResult Match<TResult>(
                ...
                Func<TResult> matchJs,
                Func<TResult> matchHtml,
                Func<TResult> matchTemplate,
