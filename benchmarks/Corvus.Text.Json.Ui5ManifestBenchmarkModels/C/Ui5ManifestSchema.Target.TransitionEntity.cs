...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct Target
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="TransitionEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal TransitionEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static TransitionEntity DefaultInstance { get; }
            ...
            public static explicit operator Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Target.TransitionEntity.AnyOf0Entity(TransitionEntity value)
            {
                return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Target.TransitionEntity.AnyOf0Entity.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator TransitionEntity(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Target.TransitionEntity.AnyOf0Entity value)
            {
                return From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Target.TransitionEntity.AnyOf1Entity(TransitionEntity value)
            {
                return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Target.TransitionEntity.AnyOf1Entity.From(value);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(TransitionEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in TransitionEntity left, in TransitionEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in TransitionEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(TransitionEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TransitionEntity(JsonElement instance)
            {
                return TransitionEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TransitionEntity From<T>(in T instance)
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TransitionEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<TransitionEntity>(utf8Json, options);
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TransitionEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<TransitionEntity>(json, options);
                #pragma warning restore CS0618
            }
            ...
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static TransitionEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<TransitionEntity>(json, options);
                #pragma warning restore CS0618
            ...
            /// </exception>
            [Obsolete("Use ParsedJsonDocument<T>.Parse() for pooled-memory parsing, or Clone() for a standalone copy. ParseValue allocates without pooling.")]
            public static TransitionEntity ParseValue(ref Utf8JsonReader reader)
            {
                #pragma warning disable CS0618 // Type or member is obsolete
                return JsonElementHelpers.ParseValue<TransitionEntity>(ref reader);
                #pragma warning restore CS0618
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out TransitionEntity? result)
            {
                return JsonElementHelpers.TryParseValue<TransitionEntity>(ref reader, out result);
            }
...
#if NET
            static TransitionEntity IJsonElement<TransitionEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TransitionEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public TransitionEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<TransitionEntity>(_idx);
                }
            ...
            public bool TryGetAsAnyOf0Entity(out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Target.TransitionEntity.AnyOf0Entity result)
            {
                ...
                {
                    result = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Target.TransitionEntity.AnyOf0Entity.From(this);
                    return true;
                }
            ...
            public bool TryGetAsAnyOf1Entity(out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Target.TransitionEntity.AnyOf1Entity result)
            {
                ...
                {
                    result = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Target.TransitionEntity.AnyOf1Entity.From(this);
                    return true;
                }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Target.TransitionEntity, TContext, TResult> defaultMatch)
...
#endif
            {
                if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Target.TransitionEntity.AnyOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchAnyOf0Entity(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Target.TransitionEntity.AnyOf0Entity.From(this), context);
                }

                if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Target.TransitionEntity.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchAnyOf1Entity(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Target.TransitionEntity.AnyOf1Entity.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Target.TransitionEntity, TResult> defaultMatch)
            {
                if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Target.TransitionEntity.AnyOf0Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchAnyOf0Entity(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Target.TransitionEntity.AnyOf0Entity.From(this));
                }

                if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Target.TransitionEntity.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchAnyOf1Entity(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Target.TransitionEntity.AnyOf1Entity.From(this));
                }
            ...
            public TAccumulator MatchEvery<TAccumulator>(
                ...
                Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Target.TransitionEntity, TAccumulator, TAccumulator> defaultMatch)
            {
                bool matched = false;
                ...
                {
                    matched = true;
                    accumulator = matchAnyOf0Entity(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Target.TransitionEntity.AnyOf0Entity.From(this), accumulator);
                }

                if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Target.TransitionEntity.AnyOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    matched = true;
                    accumulator = matchAnyOf1Entity(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Target.TransitionEntity.AnyOf1Entity.From(this), accumulator);
                }
