    ...
    public readonly partial struct Target
    {
        ...
        public readonly partial struct ViewLevelEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ViewLevelEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ViewLevelEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ViewLevelEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ViewLevelEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ViewLevelEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ViewLevelEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ViewLevelEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ViewLevelEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ViewLevelEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ViewLevelEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ViewLevelEntity>();
                }
                finally
                {
