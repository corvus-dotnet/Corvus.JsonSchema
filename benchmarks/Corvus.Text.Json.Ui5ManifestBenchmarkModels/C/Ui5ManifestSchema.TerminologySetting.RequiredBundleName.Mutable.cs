...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct TerminologySetting
    {
        ...
        public readonly partial struct RequiredBundleName
        {
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source bundleName, in Corvus.Ui5ManifestBenchmark.Current.JsonArray.Source supportedLocales = default)
            {
            ...
            /// <param name="supportedLocales">The value of the <c>"supportedLocales"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source bundleName, in Corvus.Ui5ManifestBenchmark.Current.JsonArray.Source<TContext> supportedLocales = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
