    ...
    public readonly partial struct TerminologySetting
    {
        ...
        public readonly partial struct RequiredBundleName
        {
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.Ui5ManifestBenchmark.Current.JsonArray.Source _createArg2;
                ...
                internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.TerminologySetting.RequiredBundleName.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                private readonly Corvus.Ui5ManifestBenchmark.Current.JsonString.Source _createArg1;
                private readonly Corvus.Ui5ManifestBenchmark.Current.JsonArray.Source<TContext> _createArg2;
                ...
                internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.TerminologySetting.RequiredBundleName.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// Creates an instance of a <see cref="RequiredBundleName"/>.
                /// </summary>
                public void Create(in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source bundleName, in Corvus.Ui5ManifestBenchmark.Current.JsonArray.Source supportedLocales = default)
                {
            ...
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source bundleName, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonArray.Source supportedLocales = default)
            {
                return new Source(bundleName, supportedLocales);
            }
            ...
            /// <param name="supportedLocales">The value of the <c>"supportedLocales"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source bundleName, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonArray.Source<TContext> supportedLocales = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                return new Source<TContext>(context, bundleName, supportedLocales);
            }
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source bundleName, in Corvus.Ui5ManifestBenchmark.Current.JsonArray.Source supportedLocales = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source bundleName, in Corvus.Ui5ManifestBenchmark.Current.JsonArray.Source<TContext> supportedLocales = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
            ...
            public static ParsedJsonDocument<RequiredBundleName> Create(in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source bundleName, in Corvus.Ui5ManifestBenchmark.Current.JsonArray.Source supportedLocales = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RequiredBundleName> Create<TContext>(in TContext context, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source bundleName, in Corvus.Ui5ManifestBenchmark.Current.JsonArray.Source<TContext> supportedLocales = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
