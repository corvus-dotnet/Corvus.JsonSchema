        ...
        public readonly partial struct RequiredBundleUrl
        {
            ...
            public readonly partial struct RepresentsTheListOfSupportedLocales
            {
...
#endif
                {
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RepresentsTheListOfSupportedLocales Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly RepresentsTheListOfSupportedLocales Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<RepresentsTheListOfSupportedLocales>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.TerminologySetting.RequiredBundleUrl.RepresentsTheListOfSupportedLocales.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.TerminologySetting.RequiredBundleUrl.RepresentsTheListOfSupportedLocales.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
