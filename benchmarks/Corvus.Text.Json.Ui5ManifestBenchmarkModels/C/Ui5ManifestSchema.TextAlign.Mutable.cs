...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct TextAlign
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<TextAlign, Mutable>(TextAlign.DefaultInstance);
            ...
            public static explicit operator Mutable(TextAlign instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="TextAlign"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator TextAlign(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"TextAlign.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly TextAlign Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly TextAlign Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<TextAlign>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(TextAlign instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (TextAlign)value;
        ...
        {
            return workspace.CreateBuilder<TextAlign, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<TextAlign> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<TextAlign>();
            }
            finally
            {
