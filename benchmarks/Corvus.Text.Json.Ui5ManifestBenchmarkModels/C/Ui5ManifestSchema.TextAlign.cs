...
public readonly partial struct Ui5ManifestSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TextAlign"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal TextAlign(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static TextAlign DefaultInstance { get; } = ParsedJsonDocument<TextAlign>.StringConstant([.."\"Begin\""u8]);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(TextAlign value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in TextAlign left, in TextAlign right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in TextAlign left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(TextAlign instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator TextAlign(JsonElement instance)
        {
            return TextAlign.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TextAlign From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TextAlign ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TextAlign>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TextAlign ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TextAlign>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TextAlign ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<TextAlign>(json, options);
        }
        ...
        /// </exception>
        public static TextAlign ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<TextAlign>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out TextAlign? result)
        {
            return JsonElementHelpers.TryParseValue<TextAlign>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new TextAlign(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static TextAlign IJsonElement<TextAlign>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"TextAlign: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="TextAlign"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="TextAlign"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        {
            CheckValidInstance();
            return _parent.CloneElement<TextAlign>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="TextAlign"/> that lives for the lifetime of its
        ...
        /// <param name="matchBegin">Match 1st item.</param>
        /// <param name="matchCenter">Match 2nd item.</param>
        /// <param name="matchEnd">Match 3rd item.</param>
        /// <param name="matchInitial">Match 4th item.</param>
        /// <param name="matchLeft">Match 5th item.</param>
        /// <param name="matchRight">Match 6th item.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Func<TContext, TResult> matchBegin,
            Func<TContext, TResult> matchCenter,
            Func<TContext, TResult> matchEnd,
            Func<TContext, TResult> matchInitial,
        ...
        public TResult Match<TResult>(
            Func<TResult> matchBegin,
            Func<TResult> matchCenter,
            Func<TResult> matchEnd,
            Func<TResult> matchInitial,
