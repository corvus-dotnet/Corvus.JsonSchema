...
public readonly partial struct Ui5ManifestSchema
{
        ...
        : IJsonElement<TimeAxisDef>
    {
        public static partial class JsonSchema
        {
            ...
            private static void MatchLevels(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context)
            {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/definitions/timeAxisDef"u8, buffer, out written);
