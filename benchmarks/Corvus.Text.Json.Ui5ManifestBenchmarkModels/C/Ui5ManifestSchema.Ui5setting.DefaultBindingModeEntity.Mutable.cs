    ...
    public readonly partial struct Ui5setting
    {
        ...
        public readonly partial struct DefaultBindingModeEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DefaultBindingModeEntity, Mutable>(DefaultBindingModeEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(DefaultBindingModeEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DefaultBindingModeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DefaultBindingModeEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DefaultBindingModeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly DefaultBindingModeEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly DefaultBindingModeEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DefaultBindingModeEntity>(_idx);
                }
                ...
                public bool TryGetKnownValue(out KnownValues result)
                {
                    ...
                    if (this.ValueEquals(Constants.Enum2))
                    {
                        result = KnownValues.OneTime;
                        return true;
                    }

                    if (this.ValueEquals(Constants.Enum3))
                    {
                        result = KnownValues.OneWay;
                        return true;
                    }

                    if (this.ValueEquals(Constants.Enum4))
                    {
                        result = KnownValues.TwoWay;
                        return true;
                    }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(DefaultBindingModeEntity instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (DefaultBindingModeEntity)value;
            ...
            {
                return workspace.CreateBuilder<DefaultBindingModeEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<DefaultBindingModeEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<DefaultBindingModeEntity>();
                }
                finally
                {
