...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct Vendor
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable LineOfBusiness
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LineOfBusinessUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetLineOfBusiness(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source value)
            {
                CheckValidInstance();
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.LineOfBusiness, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.Ui5ManifestBenchmark.Current.JsonUriTemplate.Source _createArg3;
            ...
            internal Source(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Vendor.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source arg1, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source arg2, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonUriTemplate.Source arg3, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source arg4)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _createArg3 = arg3;
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Vendor.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source lineOfBusiness = default)
            {
                ...
                lineOfBusiness.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.LineOfBusiness, ref builder);
            }
            ...
            internal static void BuildCreateValue(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source arg1, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source arg2, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonUriTemplate.Source arg3, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source arg4, ref ComplexValueBuilder o)
            {
                o.StartObject();
        ...
        /// <param name="lineOfBusiness">The value of the <c>"lineOfBusiness"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source id, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source name, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonUriTemplate.Source url, scoped in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source lineOfBusiness = default)
        {
            return new Source(id, name, url, lineOfBusiness);
        }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source id, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source name, in Corvus.Ui5ManifestBenchmark.Current.JsonUriTemplate.Source url, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source lineOfBusiness = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        public static ParsedJsonDocument<Vendor> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<Vendor>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<Vendor> Create<TContext>(
        ...
        public static ParsedJsonDocument<Vendor> Create(in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source id, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source name, in Corvus.Ui5ManifestBenchmark.Current.JsonUriTemplate.Source url, in Corvus.Ui5ManifestBenchmark.Current.JsonString.Source lineOfBusiness = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
