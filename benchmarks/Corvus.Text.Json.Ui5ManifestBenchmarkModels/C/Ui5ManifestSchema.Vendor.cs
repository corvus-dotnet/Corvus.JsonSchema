...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct Vendor
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Vendor"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal Vendor(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static Vendor DefaultInstance { get; }
        ...
        /// <summary>
        /// Gets the (optional) <c>lineOfBusiness</c> property.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.JsonString LineOfBusiness
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.LineOfBusinessUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonString value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.Ui5ManifestBenchmark.Current.JsonUriTemplate Url
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UrlUtf8, out Corvus.Ui5ManifestBenchmark.Current.JsonUriTemplate value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in Vendor left, in Vendor right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Vendor left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(Vendor instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Vendor(JsonElement instance)
        {
            return Vendor.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vendor From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vendor ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Vendor>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vendor ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Vendor>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vendor ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Vendor>(json, options);
        }
        ...
        /// </exception>
        public static Vendor ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<Vendor>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Vendor? result)
        {
            return JsonElementHelpers.TryParseValue<Vendor>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new Vendor(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static Vendor IJsonElement<Vendor>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Vendor: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="Vendor"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="Vendor"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        {
            CheckValidInstance();
            return _parent.CloneElement<Vendor>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="Vendor"/> that lives for the lifetime of its
        ...
        public static class JsonPropertyNames
        {
            ...
            /// <summary>
            /// Gets the JSON property name for <see cref="LineOfBusiness"/>.
            /// </summary>
            ...
            /// Gets the JSON property name for <see cref="LineOfBusiness"/>.
            /// </summary>
            public static ReadOnlySpan<byte> LineOfBusinessUtf8 => "lineOfBusiness"u8;
        ...
        private static class JsonPropertyNamesEscaped
        {
            ...
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="LineOfBusiness"/>.
            /// </summary>
            public static ReadOnlySpan<byte> LineOfBusiness => "lineOfBusiness"u8;
        ...
        private static class JsonPropertyNamesPrebaked
        {
            ...
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="LineOfBusiness"/>.
            /// </summary>
            public static ReadOnlySpan<byte> LineOfBusiness => [0x05, 0x01, 0x00, 0x00, 0x22, 0x6C, 0x69, 0x6E, 0x65, 0x4F, 0x66, 0x42, 0x75, 0x73, 0x69, 0x6E, 0x65, 0x73, 0x73, 0x22];
