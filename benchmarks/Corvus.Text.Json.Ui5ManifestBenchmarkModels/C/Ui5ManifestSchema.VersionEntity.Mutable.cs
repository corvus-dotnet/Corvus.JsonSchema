...
public readonly partial struct Ui5ManifestSchema
{
    ...
    public readonly partial struct VersionEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(VersionEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="VersionEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator VersionEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"VersionEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly VersionEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly VersionEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<VersionEntity>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(VersionEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<VersionEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<VersionEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<VersionEntity>();
            }
            finally
            {
