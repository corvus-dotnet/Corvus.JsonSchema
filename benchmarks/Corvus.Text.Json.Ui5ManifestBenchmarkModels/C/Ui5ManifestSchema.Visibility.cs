...
public readonly partial struct Ui5ManifestSchema
{
...
#endif
    {
        ...
        internal Visibility(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static Visibility DefaultInstance { get; }
        ...
        public static explicit operator Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Visibility.OneOf0Entity(Visibility value)
        {
            return Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Visibility.OneOf0Entity.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator Visibility(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Visibility.OneOf0Entity value)
        {
            return From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.SimpleBinding(Visibility value)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(Visibility value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator bool(Visibility value)
        {
        ...
        /// </returns>
        public static bool operator ==(in Visibility left, in Visibility right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in Visibility left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(Visibility instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Visibility(JsonElement instance)
        {
            return Visibility.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Visibility From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Visibility ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Visibility>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Visibility ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Visibility>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Visibility ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<Visibility>(json, options);
        }
        ...
        /// </exception>
        public static Visibility ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<Visibility>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out Visibility? result)
        {
            return JsonElementHelpers.TryParseValue<Visibility>(ref reader, out result);
        }
...
#if NET
        static Visibility IJsonElement<Visibility>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"Visibility: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public bool TryGetAsOneOf0Entity(out Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Visibility.OneOf0Entity result)
        {
            ...
            {
                result = Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Visibility.OneOf0Entity.From(this);
                return true;
            }
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Visibility, TContext, TResult> defaultMatch)
...
#endif
        {
            if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Visibility.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchOneOf0Entity(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Visibility.OneOf0Entity.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Visibility, TResult> defaultMatch)
        {
            if (Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Visibility.OneOf0Entity.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchOneOf0Entity(Corvus.Ui5ManifestBenchmark.Current.Ui5ManifestSchema.Visibility.OneOf0Entity.From(this));
            }
