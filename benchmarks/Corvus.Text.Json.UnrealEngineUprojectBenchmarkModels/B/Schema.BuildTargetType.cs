...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BuildTargetType"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal BuildTargetType(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static BuildTargetType DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(BuildTargetType value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in BuildTargetType left, in BuildTargetType right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in BuildTargetType left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(BuildTargetType instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator BuildTargetType(JsonElement instance)
        {
            return BuildTargetType.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BuildTargetType From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BuildTargetType ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BuildTargetType>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BuildTargetType ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BuildTargetType>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BuildTargetType ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BuildTargetType>(json, options);
        }
        ...
        /// </exception>
        public static BuildTargetType ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<BuildTargetType>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out BuildTargetType? result)
        {
            return JsonElementHelpers.TryParseValue<BuildTargetType>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new BuildTargetType(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static BuildTargetType IJsonElement<BuildTargetType>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"BuildTargetType: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public BuildTargetType Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<BuildTargetType>(_idx);
            }
        ...
        /// <param name="matchGame">Match 2nd item.</param>
        /// <param name="matchServer">Match 3rd item.</param>
        /// <param name="matchClient">Match 4th item.</param>
        /// <param name="matchEditor">Match 5th item.</param>
        /// <param name="matchProgram">Match 6th item.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Func<TContext, TResult> matchUnknown,
            Func<TContext, TResult> matchGame,
            Func<TContext, TResult> matchServer,
            Func<TContext, TResult> matchClient,
...
#endif
        {
            ...
            {
                return matchGame(context);
            }

            if (this.ValueEquals(Constants.Enum3))
            {
                return matchServer(context);
            }

            if (this.ValueEquals(Constants.Enum4))
            {
                return matchClient(context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Func<TResult> matchGame,
            Func<TResult> matchServer,
            Func<TResult> matchClient,
