...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DescriptorVersionNumber"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal DescriptorVersionNumber(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static DescriptorVersionNumber DefaultInstance { get; } = ParsedJsonDocument<DescriptorVersionNumber>.NumberConstant([.."3"u8]);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator long(DescriptorVersionNumber value) => value._parent.TryGetValue(value._idx, out long result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator double(DescriptorVersionNumber value) => value._parent.TryGetValue(value._idx, out double result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Corvus.Numerics.BigNumber(DescriptorVersionNumber value) => value._parent.TryGetValue(value._idx, out Corvus.Numerics.BigNumber result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator System.Numerics.BigInteger(DescriptorVersionNumber value) => value._parent.TryGetValue(value._idx, out System.Numerics.BigInteger result) ? result : throw new FormatException();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator decimal(DescriptorVersionNumber value) => value._parent.TryGetValue(value._idx, out decimal result) ? result : throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in DescriptorVersionNumber left, in DescriptorVersionNumber right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in DescriptorVersionNumber left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(DescriptorVersionNumber instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator DescriptorVersionNumber(JsonElement instance)
        {
            return DescriptorVersionNumber.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DescriptorVersionNumber From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DescriptorVersionNumber ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<DescriptorVersionNumber>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DescriptorVersionNumber ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<DescriptorVersionNumber>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DescriptorVersionNumber ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<DescriptorVersionNumber>(json, options);
        }
        ...
        /// </exception>
        public static DescriptorVersionNumber ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<DescriptorVersionNumber>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out DescriptorVersionNumber? result)
        {
            return JsonElementHelpers.TryParseValue<DescriptorVersionNumber>(ref reader, out result);
        }
...
#if NET
        static DescriptorVersionNumber IJsonElement<DescriptorVersionNumber>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"DescriptorVersionNumber: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public DescriptorVersionNumber Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public DescriptorVersionNumber Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<DescriptorVersionNumber>(_idx);
            }
