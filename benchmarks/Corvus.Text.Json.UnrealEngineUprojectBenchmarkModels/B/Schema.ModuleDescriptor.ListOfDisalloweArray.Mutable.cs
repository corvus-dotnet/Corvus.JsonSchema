...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ModuleDescriptor
    {
        ...
        public readonly partial struct ListOfDisalloweArray
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ListOfDisalloweArray instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ListOfDisalloweArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ListOfDisalloweArray(Mutable instance)
                {
                ...
                public Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.BuildTargetType.Mutable this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.BuildTargetType.Mutable>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.BuildTargetType.Mutable> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.BuildTargetType.Mutable>(_parent, _idx);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ListOfDisalloweArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ListOfDisalloweArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetItem(int itemIndex, in Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.BuildTargetType.Source value)
                {
                    CheckValidInstance();
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void InsertItem(int itemIndex, in Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.BuildTargetType.Source value)
                {
                    CheckValidInstance();
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void AddItem(in Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.BuildTargetType.Source value)
                {
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Remove(in Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.BuildTargetType item)
                {
                    CheckValidInstance();
                    if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.BuildTargetType>(this, in item))
                    {
                        return false;
                    }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void RemoveWhere(JsonPredicate<Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.BuildTargetType> predicate)
                {
                    CheckValidInstance();
                    JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.BuildTargetType>(this, predicate);
                    _documentVersion = _parent.Version;
                }
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Replace(in Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.BuildTargetType oldItem, in Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.BuildTargetType.Source newItem)
                {
                    CheckValidInstance();
                    ...
                    var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.BuildTargetType>(_parent, _idx);

                    while (enumerator.MoveNext())
                    {
                        Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.BuildTargetType current = enumerator.Current;
                ...
                /// <summary>
                /// Gets a <see cref="ListOfDisalloweArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ListOfDisalloweArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ListOfDisalloweArray Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ListOfDisalloweArray>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ListOfDisalloweArray"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ListOfDisalloweArray Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ListOfDisalloweArray>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.ModuleDescriptor.ListOfDisalloweArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(ListOfDisalloweArray instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.ModuleDescriptor.ListOfDisalloweArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<ListOfDisalloweArray, Mutable>(this);
            }
        }
    }
}
