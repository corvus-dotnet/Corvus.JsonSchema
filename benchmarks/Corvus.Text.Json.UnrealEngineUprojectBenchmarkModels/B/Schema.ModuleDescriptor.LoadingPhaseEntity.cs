...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ModuleDescriptor
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="LoadingPhaseEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal LoadingPhaseEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static LoadingPhaseEntity DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(LoadingPhaseEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// </returns>
            public static bool operator ==(in LoadingPhaseEntity left, in LoadingPhaseEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in LoadingPhaseEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(LoadingPhaseEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator LoadingPhaseEntity(JsonElement instance)
            {
                return LoadingPhaseEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LoadingPhaseEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LoadingPhaseEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<LoadingPhaseEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LoadingPhaseEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<LoadingPhaseEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static LoadingPhaseEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<LoadingPhaseEntity>(json, options);
            }
            ...
            /// </exception>
            public static LoadingPhaseEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<LoadingPhaseEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out LoadingPhaseEntity? result)
            {
                return JsonElementHelpers.TryParseValue<LoadingPhaseEntity>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new LoadingPhaseEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static LoadingPhaseEntity IJsonElement<LoadingPhaseEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"LoadingPhaseEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="LoadingPhaseEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="LoadingPhaseEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public LoadingPhaseEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<LoadingPhaseEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="LoadingPhaseEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public LoadingPhaseEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<LoadingPhaseEntity>(_idx);
                }
            ...
            /// <param name="matchEarliestPossible">Match 1st item.</param>
            /// <param name="matchPostConfigInit">Match 2nd item.</param>
            /// <param name="matchPostSplashScreen">Match 3rd item.</param>
            /// <param name="matchPreEarlyLoadingScreen">Match 4th item.</param>
            /// <param name="matchPreLoadingScreen">Match 5th item.</param>
            /// <param name="matchPreDefault">Match 6th item.</param>
            /// <param name="matchDefault">Match 7th item.</param>
            /// <param name="matchPostDefault">Match 8th item.</param>
            /// <param name="matchPostEngineInit">Match 9th item.</param>
            /// <param name="matchNone">Match 10th item.</param>
            /// <param name="matchMax">Match 11th item.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Func<TContext, TResult> matchEarliestPossible,
                Func<TContext, TResult> matchPostConfigInit,
                Func<TContext, TResult> matchPostSplashScreen,
                Func<TContext, TResult> matchPreEarlyLoadingScreen,
                Func<TContext, TResult> matchPreLoadingScreen,
                Func<TContext, TResult> matchPreDefault,
                Func<TContext, TResult> matchDefault,
                Func<TContext, TResult> matchPostDefault,
                Func<TContext, TResult> matchPostEngineInit,
...
#endif
            {
                ...
                {
                    return matchEarliestPossible(context);
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchPostConfigInit(context);
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchPostSplashScreen(context);
                }

                if (this.ValueEquals(Constants.Enum4))
                {
                    return matchPreEarlyLoadingScreen(context);
                }

                if (this.ValueEquals(Constants.Enum5))
                {
                    return matchPreLoadingScreen(context);
                }

                if (this.ValueEquals(Constants.Enum6))
                {
                    return matchPreDefault(context);
                }
                ...
                {
                    return matchPostDefault(context);
                }

                if (this.ValueEquals(Constants.Enum9))
                {
                    return matchPostEngineInit(context);
                }
            ...
            public TResult Match<TResult>(
                Func<TResult> matchEarliestPossible,
                Func<TResult> matchPostConfigInit,
                Func<TResult> matchPostSplashScreen,
                Func<TResult> matchPreEarlyLoadingScreen,
                Func<TResult> matchPreLoadingScreen,
                Func<TResult> matchPreDefault,
                Func<TResult> matchDefault,
                Func<TResult> matchPostDefault,
                Func<TResult> matchPostEngineInit,
                ...
                Func<TResult> defaultMatch)
            {
                if (this.ValueEquals(Constants.Enum1))
                {
                    return matchEarliestPossible();
                }

                if (this.ValueEquals(Constants.Enum2))
                {
                    return matchPostConfigInit();
                }

                if (this.ValueEquals(Constants.Enum3))
                {
                    return matchPostSplashScreen();
                }

                if (this.ValueEquals(Constants.Enum4))
                {
                    return matchPreEarlyLoadingScreen();
                }

                if (this.ValueEquals(Constants.Enum5))
                {
                    return matchPreLoadingScreen();
                }

                if (this.ValueEquals(Constants.Enum6))
                {
                    return matchPreDefault();
                }
                ...
                if (this.ValueEquals(Constants.Enum8))
                {
                    return matchPostDefault();
                }

                if (this.ValueEquals(Constants.Enum9))
                {
                    return matchPostEngineInit();
                }
