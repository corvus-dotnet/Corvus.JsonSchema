    ...
    public readonly partial struct ModuleDescriptor
    {
        ...
        public readonly partial struct UsageTypeOfModule
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(UsageTypeOfModule instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="UsageTypeOfModule"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator UsageTypeOfModule(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"UsageTypeOfModule.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly UsageTypeOfModule Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly UsageTypeOfModule Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<UsageTypeOfModule>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(UsageTypeOfModule instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<UsageTypeOfModule, Mutable>(this);
            }
        }
    }
}
