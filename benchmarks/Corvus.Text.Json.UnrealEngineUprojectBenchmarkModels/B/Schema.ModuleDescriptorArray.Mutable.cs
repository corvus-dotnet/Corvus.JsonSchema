...
public readonly partial struct Schema
{
    ...
    public readonly partial struct ModuleDescriptorArray
    {
...
#endif
        {
            ...
            public Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.ModuleDescriptor.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.ModuleDescriptor.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.ModuleDescriptor.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.ModuleDescriptor.Mutable>(_parent, _idx);
            }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.ModuleDescriptor.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, in Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.ModuleDescriptor.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(in Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.ModuleDescriptor.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.ModuleDescriptor item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.ModuleDescriptor>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.ModuleDescriptor> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.ModuleDescriptor>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.ModuleDescriptor oldItem, in Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.ModuleDescriptor.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.ModuleDescriptor>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.ModuleDescriptor current = enumerator.Current;
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.ModuleDescriptorArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.ModuleDescriptorArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
