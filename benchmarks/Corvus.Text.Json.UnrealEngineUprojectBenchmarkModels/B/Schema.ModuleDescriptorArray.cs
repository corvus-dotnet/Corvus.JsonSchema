...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        public Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.ModuleDescriptor this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.ModuleDescriptor>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.ModuleDescriptor> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.ModuleDescriptor>(_parent, _idx);
        }
