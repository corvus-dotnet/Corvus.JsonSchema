    ...
    public readonly partial struct PluginReferenceDescriptor
    {
        ...
        public readonly partial struct BuildConfigurationArray
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(BuildConfigurationArray instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="BuildConfigurationArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator BuildConfigurationArray(Mutable instance)
                {
                ...
                public Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.BuildConfiguration.Mutable this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.BuildConfiguration.Mutable>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.BuildConfiguration.Mutable> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.BuildConfiguration.Mutable>(_parent, _idx);
                }
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"BuildConfigurationArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetItem(int itemIndex, in Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.BuildConfiguration.Source value)
                {
                    CheckValidInstance();
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void InsertItem(int itemIndex, in Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.BuildConfiguration.Source value)
                {
                    CheckValidInstance();
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void AddItem(in Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.BuildConfiguration.Source value)
                {
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Remove(in Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.BuildConfiguration item)
                {
                    CheckValidInstance();
                    if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.BuildConfiguration>(this, in item))
                    {
                        return false;
                    }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void RemoveWhere(JsonPredicate<Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.BuildConfiguration> predicate)
                {
                    CheckValidInstance();
                    JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.BuildConfiguration>(this, predicate);
                    _documentVersion = _parent.Version;
                }
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Replace(in Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.BuildConfiguration oldItem, in Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.BuildConfiguration.Source newItem)
                {
                    CheckValidInstance();
                    ...
                    var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.BuildConfiguration>(_parent, _idx);

                    while (enumerator.MoveNext())
                    {
                        Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.BuildConfiguration current = enumerator.Current;
                ...
                /// </para>
                /// </remarks>
                public readonly BuildConfigurationArray Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly BuildConfigurationArray Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<BuildConfigurationArray>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.PluginReferenceDescriptor.BuildConfigurationArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(BuildConfigurationArray instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.PluginReferenceDescriptor.BuildConfigurationArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<BuildConfigurationArray, Mutable>(this);
            }
        }
    }
}
