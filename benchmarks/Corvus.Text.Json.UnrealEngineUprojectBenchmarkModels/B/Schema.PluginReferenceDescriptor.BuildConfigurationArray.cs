...
public readonly partial struct Schema
{
    ...
    public readonly partial struct PluginReferenceDescriptor
    {
        ...
        public readonly partial struct BuildConfigurationArray
#if NET8_0_OR_GREATER
            : IJsonElement<BuildConfigurationArray>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="BuildConfigurationArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal BuildConfigurationArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static BuildConfigurationArray DefaultInstance { get; }
            ...
            public Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.BuildConfiguration this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.BuildConfiguration>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.BuildConfiguration> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.BuildConfiguration>(_parent, _idx);
            }
            ...
            /// </returns>
            public static bool operator ==(in BuildConfigurationArray left, in BuildConfigurationArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in BuildConfigurationArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(BuildConfigurationArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator BuildConfigurationArray(JsonElement instance)
            {
                return BuildConfigurationArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static BuildConfigurationArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static BuildConfigurationArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<BuildConfigurationArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static BuildConfigurationArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<BuildConfigurationArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static BuildConfigurationArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<BuildConfigurationArray>(json, options);
            }
            ...
            /// </exception>
            public static BuildConfigurationArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<BuildConfigurationArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out BuildConfigurationArray? result)
            {
                return JsonElementHelpers.TryParseValue<BuildConfigurationArray>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new BuildConfigurationArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static BuildConfigurationArray IJsonElement<BuildConfigurationArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"BuildConfigurationArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="BuildConfigurationArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="BuildConfigurationArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public BuildConfigurationArray Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<BuildConfigurationArray>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="BuildConfigurationArray"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public BuildConfigurationArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<BuildConfigurationArray>(_idx);
                }
