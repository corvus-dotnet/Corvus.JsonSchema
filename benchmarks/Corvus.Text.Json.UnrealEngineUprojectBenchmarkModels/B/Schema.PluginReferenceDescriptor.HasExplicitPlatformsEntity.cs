...
public readonly partial struct Schema
{
    ...
    public readonly partial struct PluginReferenceDescriptor
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="HasExplicitPlatformsEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal HasExplicitPlatformsEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static HasExplicitPlatformsEntity DefaultInstance { get; } = ParsedJsonDocument<HasExplicitPlatformsEntity>.False;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(HasExplicitPlatformsEntity value)
            {
            ...
            /// </returns>
            public static bool operator ==(in HasExplicitPlatformsEntity left, in HasExplicitPlatformsEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in HasExplicitPlatformsEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(HasExplicitPlatformsEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator HasExplicitPlatformsEntity(JsonElement instance)
            {
                return HasExplicitPlatformsEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HasExplicitPlatformsEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HasExplicitPlatformsEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<HasExplicitPlatformsEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HasExplicitPlatformsEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<HasExplicitPlatformsEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static HasExplicitPlatformsEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<HasExplicitPlatformsEntity>(json, options);
            }
            ...
            /// </exception>
            public static HasExplicitPlatformsEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<HasExplicitPlatformsEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out HasExplicitPlatformsEntity? result)
            {
                return JsonElementHelpers.TryParseValue<HasExplicitPlatformsEntity>(ref reader, out result);
            }
...
#if NET
            static HasExplicitPlatformsEntity IJsonElement<HasExplicitPlatformsEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"HasExplicitPlatformsEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public HasExplicitPlatformsEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public HasExplicitPlatformsEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<HasExplicitPlatformsEntity>(_idx);
                }
