...
public readonly partial struct Schema
{
    ...
    public readonly partial struct PluginReferenceDescriptor
    {
...
#endif
        {
            ...
            public Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.BuildTargetType this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.BuildTargetType>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.BuildTargetType> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.BuildTargetType>(_parent, _idx);
            }
