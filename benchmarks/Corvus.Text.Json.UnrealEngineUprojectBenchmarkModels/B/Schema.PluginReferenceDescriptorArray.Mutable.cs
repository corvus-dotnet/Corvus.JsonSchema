...
public readonly partial struct Schema
{
    ...
    public readonly partial struct PluginReferenceDescriptorArray
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(PluginReferenceDescriptorArray instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="PluginReferenceDescriptorArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PluginReferenceDescriptorArray(Mutable instance)
            {
            ...
            public Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.PluginReferenceDescriptor.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.PluginReferenceDescriptor.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.PluginReferenceDescriptor.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.PluginReferenceDescriptor.Mutable>(_parent, _idx);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new PluginReferenceDescriptorArray(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PluginReferenceDescriptorArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.PluginReferenceDescriptor.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, in Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.PluginReferenceDescriptor.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(in Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.PluginReferenceDescriptor.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.PluginReferenceDescriptor item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.PluginReferenceDescriptor>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.PluginReferenceDescriptor> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.PluginReferenceDescriptor>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.PluginReferenceDescriptor oldItem, in Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.PluginReferenceDescriptor.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.PluginReferenceDescriptor>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.PluginReferenceDescriptor current = enumerator.Current;
            ...
            /// <summary>
            /// Gets a <see cref="PluginReferenceDescriptorArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="PluginReferenceDescriptorArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly PluginReferenceDescriptorArray Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<PluginReferenceDescriptorArray>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="PluginReferenceDescriptorArray"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly PluginReferenceDescriptorArray Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<PluginReferenceDescriptorArray>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.PluginReferenceDescriptorArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(PluginReferenceDescriptorArray instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.PluginReferenceDescriptorArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<PluginReferenceDescriptorArray, Mutable>(this);
        }
    }
}
