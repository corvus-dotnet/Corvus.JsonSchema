...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        public Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.PluginReferenceDescriptor this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.PluginReferenceDescriptor>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.PluginReferenceDescriptor> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.UnrealEngineUprojectBenchmark.Baseline.Schema.PluginReferenceDescriptor>(_parent, _idx);
        }
