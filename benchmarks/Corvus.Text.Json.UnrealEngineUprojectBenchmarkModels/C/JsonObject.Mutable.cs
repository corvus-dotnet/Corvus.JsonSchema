...
public readonly partial struct JsonObject
{
...
#endif
    {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"JsonObject.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public readonly JsonObject Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public readonly JsonObject Freeze()
        {
            CheckValidInstance();
            return _parent.FreezeElement<JsonObject>(_idx);
        }
    }
    ...
    public ref struct Source
    {
        ...
        internal Source(Corvus.UnrealEngineUprojectBenchmark.Current.JsonObject.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

        public static implicit operator Source(JsonObject instance) => new(JsonElement.From(instance));
        ...
        #endif
    {
        ...
        internal Source(scoped in TContext context, Corvus.UnrealEngineUprojectBenchmark.Current.JsonObject.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
