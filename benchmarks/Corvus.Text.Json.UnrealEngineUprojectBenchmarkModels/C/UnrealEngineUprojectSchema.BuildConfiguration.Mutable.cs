...
public readonly partial struct UnrealEngineUprojectSchema
{
    ...
    public readonly partial struct BuildConfiguration
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(BuildConfiguration instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="BuildConfiguration"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator BuildConfiguration(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"BuildConfiguration.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly BuildConfiguration Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly BuildConfiguration Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<BuildConfiguration>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(BuildConfiguration instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (BuildConfiguration)value;
        ...
        {
            return workspace.CreateBuilder<BuildConfiguration, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<BuildConfiguration> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<BuildConfiguration>();
            }
            finally
            {
