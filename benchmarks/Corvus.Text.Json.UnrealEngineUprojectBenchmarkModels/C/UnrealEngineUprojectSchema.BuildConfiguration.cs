...
public readonly partial struct UnrealEngineUprojectSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BuildConfiguration"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal BuildConfiguration(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static BuildConfiguration DefaultInstance { get; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator string(BuildConfiguration value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
        ...
        /// </returns>
        public static bool operator ==(in BuildConfiguration left, in BuildConfiguration right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in BuildConfiguration left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(BuildConfiguration instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator BuildConfiguration(JsonElement instance)
        {
            return BuildConfiguration.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BuildConfiguration From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BuildConfiguration ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BuildConfiguration>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BuildConfiguration ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BuildConfiguration>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BuildConfiguration ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<BuildConfiguration>(json, options);
        }
        ...
        /// </exception>
        public static BuildConfiguration ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<BuildConfiguration>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out BuildConfiguration? result)
        {
            return JsonElementHelpers.TryParseValue<BuildConfiguration>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new BuildConfiguration(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static BuildConfiguration IJsonElement<BuildConfiguration>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"BuildConfiguration: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="BuildConfiguration"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="BuildConfiguration"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        {
            CheckValidInstance();
            return _parent.CloneElement<BuildConfiguration>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="BuildConfiguration"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public BuildConfiguration Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<BuildConfiguration>(_idx);
            }
        ...
        /// <param name="matchUnknown">Match 1st item.</param>
        /// <param name="matchDebug">Match 2nd item.</param>
        /// <param name="matchDebugGame">Match 3rd item.</param>
        /// <param name="matchDevelopment">Match 4th item.</param>
        /// <param name="matchShipping">Match 5th item.</param>
        /// <param name="matchTest">Match 6th item.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Func<TContext, TResult> matchUnknown,
            Func<TContext, TResult> matchDebug,
            Func<TContext, TResult> matchDebugGame,
            Func<TContext, TResult> matchDevelopment,
            Func<TContext, TResult> matchShipping,
            Func<TContext, TResult> matchTest,
        ...
        public TResult Match<TResult>(
            Func<TResult> matchUnknown,
            Func<TResult> matchDebug,
            Func<TResult> matchDebugGame,
            Func<TResult> matchDevelopment,
            Func<TResult> matchShipping,
            Func<TResult> matchTest,
            Func<TResult> defaultMatch)
        {
            ...
            if (this.ValueEquals(Constants.Enum3))
            {
                return matchDebugGame();
            }

            if (this.ValueEquals(Constants.Enum4))
            {
                return matchDevelopment();
            }
