...
public readonly partial struct UnrealEngineUprojectSchema
{
    ...
    public readonly partial struct BuildTargetType
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(BuildTargetType instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="BuildTargetType"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator BuildTargetType(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"BuildTargetType.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(BuildTargetType instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(KnownValues value) => (BuildTargetType)value;
        ...
        {
            return workspace.CreateBuilder<BuildTargetType, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<BuildTargetType> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<BuildTargetType>();
            }
            finally
            {
