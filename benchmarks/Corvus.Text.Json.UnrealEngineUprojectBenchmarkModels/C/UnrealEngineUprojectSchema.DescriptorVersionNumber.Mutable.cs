...
public readonly partial struct UnrealEngineUprojectSchema
{
    ...
    public readonly partial struct DescriptorVersionNumber
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DescriptorVersionNumber, Mutable>(DescriptorVersionNumber.DefaultInstance);
            ...
            public static explicit operator Mutable(DescriptorVersionNumber instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="DescriptorVersionNumber"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DescriptorVersionNumber(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new DescriptorVersionNumber(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DescriptorVersionNumber.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="DescriptorVersionNumber"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="DescriptorVersionNumber"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly DescriptorVersionNumber Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<DescriptorVersionNumber>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="DescriptorVersionNumber"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly DescriptorVersionNumber Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<DescriptorVersionNumber>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(DescriptorVersionNumber instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<DescriptorVersionNumber, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<DescriptorVersionNumber> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<DescriptorVersionNumber>();
            }
            finally
            {
