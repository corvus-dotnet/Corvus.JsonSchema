...
public readonly partial struct UnrealEngineUprojectSchema
{
    ...
    public readonly partial struct DisableEnginePluginsByDefaultEntity
    {
...
#endif
        {
            ...
            /// </remarks>
            public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<DisableEnginePluginsByDefaultEntity, Mutable>(DisableEnginePluginsByDefaultEntity.DefaultInstance);
            ...
            public static explicit operator Mutable(DisableEnginePluginsByDefaultEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="DisableEnginePluginsByDefaultEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DisableEnginePluginsByDefaultEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DisableEnginePluginsByDefaultEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly DisableEnginePluginsByDefaultEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly DisableEnginePluginsByDefaultEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<DisableEnginePluginsByDefaultEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(DisableEnginePluginsByDefaultEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<DisableEnginePluginsByDefaultEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<DisableEnginePluginsByDefaultEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<DisableEnginePluginsByDefaultEntity>();
            }
            finally
            {
