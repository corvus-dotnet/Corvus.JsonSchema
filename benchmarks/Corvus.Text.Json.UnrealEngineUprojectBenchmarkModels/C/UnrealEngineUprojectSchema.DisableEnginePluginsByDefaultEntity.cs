...
public readonly partial struct UnrealEngineUprojectSchema
{
    ...
    public readonly partial struct DisableEnginePluginsByDefaultEntity
#if NET8_0_OR_GREATER
        : IJsonElement<DisableEnginePluginsByDefaultEntity>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DisableEnginePluginsByDefaultEntity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal DisableEnginePluginsByDefaultEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static DisableEnginePluginsByDefaultEntity DefaultInstance { get; } = ParsedJsonDocument<DisableEnginePluginsByDefaultEntity>.False;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator bool(DisableEnginePluginsByDefaultEntity value)
        {
        ...
        /// </returns>
        public static bool operator ==(in DisableEnginePluginsByDefaultEntity left, in DisableEnginePluginsByDefaultEntity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in DisableEnginePluginsByDefaultEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(DisableEnginePluginsByDefaultEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator DisableEnginePluginsByDefaultEntity(JsonElement instance)
        {
            return DisableEnginePluginsByDefaultEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DisableEnginePluginsByDefaultEntity From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DisableEnginePluginsByDefaultEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<DisableEnginePluginsByDefaultEntity>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DisableEnginePluginsByDefaultEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<DisableEnginePluginsByDefaultEntity>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DisableEnginePluginsByDefaultEntity ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<DisableEnginePluginsByDefaultEntity>(json, options);
        }
        ...
        /// </exception>
        public static DisableEnginePluginsByDefaultEntity ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<DisableEnginePluginsByDefaultEntity>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out DisableEnginePluginsByDefaultEntity? result)
        {
            return JsonElementHelpers.TryParseValue<DisableEnginePluginsByDefaultEntity>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new DisableEnginePluginsByDefaultEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static DisableEnginePluginsByDefaultEntity IJsonElement<DisableEnginePluginsByDefaultEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"DisableEnginePluginsByDefaultEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="DisableEnginePluginsByDefaultEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="DisableEnginePluginsByDefaultEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public DisableEnginePluginsByDefaultEntity Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<DisableEnginePluginsByDefaultEntity>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="DisableEnginePluginsByDefaultEntity"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public DisableEnginePluginsByDefaultEntity Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<DisableEnginePluginsByDefaultEntity>(_idx);
            }
