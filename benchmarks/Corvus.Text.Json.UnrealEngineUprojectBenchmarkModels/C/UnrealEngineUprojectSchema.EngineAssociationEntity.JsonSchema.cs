...
public readonly partial struct UnrealEngineUprojectSchema
{
        ...
        : IJsonElement<EngineAssociationEntity>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("https://json.schemastore.org/uproject.json#/properties/EngineAssociation"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "https://json.schemastore.org/uproject.json#/properties/EngineAssociation";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "https://json.schemastore.org/uproject.json#/properties/EngineAssociation"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    JsonSchemaEvaluation.MatchRegularExpression(unescapedUtf8JsonString.Span, Pattern,"(^([0-9]+)\\.([0-9]+)$)|(^\\{[A-F0-9]{8}(-[A-F0-9]{4}){3}-[A-F0-9]{12}\\}$)", "pattern"u8, ref context);
                }
            }
            ...
            [GeneratedRegex("(^([0-9]+)\\.([0-9]+)$)|(^\\{[A-F0-9]{8}(-[A-F0-9]{4}){3}-[A-F0-9]{12}\\}$)")]
            private static partial Regex CreatePattern();
#else
            private static Regex CreatePattern() => new("(^([0-9]+)\\.([0-9]+)$)|(^\\{[A-F0-9]{8}(-[A-F0-9]{4}){3}-[A-F0-9]{12}\\}$)", RegexOptions.Compiled);
#endif
