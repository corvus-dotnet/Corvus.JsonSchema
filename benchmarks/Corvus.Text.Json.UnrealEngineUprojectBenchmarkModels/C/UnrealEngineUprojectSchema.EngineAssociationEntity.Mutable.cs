...
public readonly partial struct UnrealEngineUprojectSchema
{
    ...
    public readonly partial struct EngineAssociationEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(EngineAssociationEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="EngineAssociationEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator EngineAssociationEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"EngineAssociationEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly EngineAssociationEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly EngineAssociationEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<EngineAssociationEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(EngineAssociationEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<EngineAssociationEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<EngineAssociationEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<EngineAssociationEntity>();
            }
            finally
            {
