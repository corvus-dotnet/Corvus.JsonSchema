...
public readonly partial struct UnrealEngineUprojectSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IndicatesIfThisProjectIsAnEnterpriseProject"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal IndicatesIfThisProjectIsAnEnterpriseProject(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static IndicatesIfThisProjectIsAnEnterpriseProject DefaultInstance { get; } = ParsedJsonDocument<IndicatesIfThisProjectIsAnEnterpriseProject>.False;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator bool(IndicatesIfThisProjectIsAnEnterpriseProject value)
        {
        ...
        /// </returns>
        public static bool operator ==(in IndicatesIfThisProjectIsAnEnterpriseProject left, in IndicatesIfThisProjectIsAnEnterpriseProject right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in IndicatesIfThisProjectIsAnEnterpriseProject left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(IndicatesIfThisProjectIsAnEnterpriseProject instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator IndicatesIfThisProjectIsAnEnterpriseProject(JsonElement instance)
        {
            return IndicatesIfThisProjectIsAnEnterpriseProject.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IndicatesIfThisProjectIsAnEnterpriseProject From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IndicatesIfThisProjectIsAnEnterpriseProject ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<IndicatesIfThisProjectIsAnEnterpriseProject>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IndicatesIfThisProjectIsAnEnterpriseProject ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<IndicatesIfThisProjectIsAnEnterpriseProject>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IndicatesIfThisProjectIsAnEnterpriseProject ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<IndicatesIfThisProjectIsAnEnterpriseProject>(json, options);
        }
        ...
        /// </exception>
        public static IndicatesIfThisProjectIsAnEnterpriseProject ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<IndicatesIfThisProjectIsAnEnterpriseProject>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out IndicatesIfThisProjectIsAnEnterpriseProject? result)
        {
            return JsonElementHelpers.TryParseValue<IndicatesIfThisProjectIsAnEnterpriseProject>(ref reader, out result);
        }
...
#if NET
        static IndicatesIfThisProjectIsAnEnterpriseProject IJsonElement<IndicatesIfThisProjectIsAnEnterpriseProject>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"IndicatesIfThisProjectIsAnEnterpriseProject: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public IndicatesIfThisProjectIsAnEnterpriseProject Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public IndicatesIfThisProjectIsAnEnterpriseProject Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<IndicatesIfThisProjectIsAnEnterpriseProject>(_idx);
            }
