...
public readonly partial struct UnrealEngineUprojectSchema
{
    ...
    public readonly partial struct ModuleDescriptor
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="BuildTargetTypeArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal BuildTargetTypeArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static BuildTargetTypeArray DefaultInstance { get; }
            ...
            /// </returns>
            public static bool operator ==(in BuildTargetTypeArray left, in BuildTargetTypeArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in BuildTargetTypeArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(BuildTargetTypeArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator BuildTargetTypeArray(JsonElement instance)
            {
                return BuildTargetTypeArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static BuildTargetTypeArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static BuildTargetTypeArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<BuildTargetTypeArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static BuildTargetTypeArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<BuildTargetTypeArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static BuildTargetTypeArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<BuildTargetTypeArray>(json, options);
            }
            ...
            /// </exception>
            public static BuildTargetTypeArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<BuildTargetTypeArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out BuildTargetTypeArray? result)
            {
                return JsonElementHelpers.TryParseValue<BuildTargetTypeArray>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new BuildTargetTypeArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static BuildTargetTypeArray IJsonElement<BuildTargetTypeArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"BuildTargetTypeArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="BuildTargetTypeArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="BuildTargetTypeArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public BuildTargetTypeArray Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<BuildTargetTypeArray>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="BuildTargetTypeArray"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public BuildTargetTypeArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<BuildTargetTypeArray>(_idx);
                }
