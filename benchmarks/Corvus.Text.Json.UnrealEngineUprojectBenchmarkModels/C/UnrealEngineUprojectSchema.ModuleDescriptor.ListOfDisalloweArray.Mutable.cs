    ...
    public readonly partial struct ModuleDescriptor
    {
        ...
        public readonly partial struct ListOfDisalloweArray
        {
...
#endif
            {
                ...
                public Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.BuildTargetType.Mutable this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.BuildTargetType.Mutable>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.BuildTargetType.Mutable> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.BuildTargetType.Mutable>(_parent, _idx);
                }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetItem(int itemIndex, in Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.BuildTargetType.Source value)
                {
                    CheckValidInstance();
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void InsertItem(int itemIndex, scoped in Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.BuildTargetType.Source value)
                {
                    CheckValidInstance();
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void AddItem(scoped in Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.BuildTargetType.Source value)
                {
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Remove(in Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.BuildTargetType item)
                {
                    CheckValidInstance();
                    if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.BuildTargetType>(this, in item))
                    {
                        return false;
                    }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void RemoveWhere(JsonPredicate<Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.BuildTargetType> predicate)
                {
                    CheckValidInstance();
                    JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.BuildTargetType>(this, predicate);
                    _documentVersion = _parent.Version;
                }
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Replace(in Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.BuildTargetType oldItem, in Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.BuildTargetType.Source newItem)
                {
                    CheckValidInstance();
                    ...
                    var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.BuildTargetType>(_parent, _idx);

                    while (enumerator.MoveNext())
                    {
                        Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.BuildTargetType current = enumerator.Current;
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.ModuleDescriptor.ListOfDisalloweArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.ModuleDescriptor.ListOfDisalloweArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// </summary>
                public void AddItem(in Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.BuildTargetType.Source value)
                {
            ...
            public static ParsedJsonDocument<ListOfDisalloweArray> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ListOfDisalloweArray>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<ListOfDisalloweArray> Create<TContext>(
