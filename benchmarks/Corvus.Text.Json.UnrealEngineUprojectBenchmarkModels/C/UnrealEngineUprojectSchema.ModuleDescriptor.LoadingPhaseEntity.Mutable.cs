    ...
    public readonly partial struct ModuleDescriptor
    {
        ...
        public readonly partial struct LoadingPhaseEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(LoadingPhaseEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="LoadingPhaseEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator LoadingPhaseEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"LoadingPhaseEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly LoadingPhaseEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly LoadingPhaseEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<LoadingPhaseEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(LoadingPhaseEntity instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (LoadingPhaseEntity)value;
            ...
            {
                return workspace.CreateBuilder<LoadingPhaseEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<LoadingPhaseEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<LoadingPhaseEntity>();
                }
                finally
                {
