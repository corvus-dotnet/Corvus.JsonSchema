    ...
    public readonly partial struct ModuleDescriptor
    {
        ...
        public readonly partial struct UsageTypeOfModule
        {
            ...
            public ref struct Source
            {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (UsageTypeOfModule)value;
            ...
            public static ParsedJsonDocument<UsageTypeOfModule> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<UsageTypeOfModule>();
                }
                finally
                {
