...
public readonly partial struct UnrealEngineUprojectSchema
{
    ...
    public readonly partial struct ModuleDescriptor
    {
...
#endif
        {
            ...
            /// <summary>
            /// Gets a <see cref="UsageTypeOfModule"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="UsageTypeOfModule"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public UsageTypeOfModule Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<UsageTypeOfModule>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="UsageTypeOfModule"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public UsageTypeOfModule Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<UsageTypeOfModule>(_idx);
                }
