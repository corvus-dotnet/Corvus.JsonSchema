...
public readonly partial struct UnrealEngineUprojectSchema
{
    ...
    public readonly partial struct ModuleDescriptorArray
        ...
        : IJsonElement<ModuleDescriptorArray>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ModuleDescriptorArray"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal ModuleDescriptorArray(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static ModuleDescriptorArray DefaultInstance { get; }
        ...
        public Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.ModuleDescriptor this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.ModuleDescriptor>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.ModuleDescriptor> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.ModuleDescriptor>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in ModuleDescriptorArray left, in ModuleDescriptorArray right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in ModuleDescriptorArray left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(ModuleDescriptorArray instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ModuleDescriptorArray(JsonElement instance)
        {
            return ModuleDescriptorArray.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ModuleDescriptorArray From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ModuleDescriptorArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ModuleDescriptorArray>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ModuleDescriptorArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ModuleDescriptorArray>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ModuleDescriptorArray ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<ModuleDescriptorArray>(json, options);
        }
        ...
        /// </exception>
        public static ModuleDescriptorArray ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<ModuleDescriptorArray>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out ModuleDescriptorArray? result)
        {
            return JsonElementHelpers.TryParseValue<ModuleDescriptorArray>(ref reader, out result);
        }
...
#if NET
        static ModuleDescriptorArray IJsonElement<ModuleDescriptorArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"ModuleDescriptorArray: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public ModuleDescriptorArray Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public ModuleDescriptorArray Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<ModuleDescriptorArray>(_idx);
            }
