...
public readonly partial struct UnrealEngineUprojectSchema
{
    ...
    public readonly partial struct PluginReferenceDescriptor
    {
        ...
        public readonly partial struct HasExplicitPlatformsEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<HasExplicitPlatformsEntity, Mutable>(HasExplicitPlatformsEntity.DefaultInstance);
                ...
                public static explicit operator Mutable(HasExplicitPlatformsEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="HasExplicitPlatformsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator HasExplicitPlatformsEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new HasExplicitPlatformsEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"HasExplicitPlatformsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="HasExplicitPlatformsEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="HasExplicitPlatformsEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly HasExplicitPlatformsEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<HasExplicitPlatformsEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="HasExplicitPlatformsEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly HasExplicitPlatformsEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<HasExplicitPlatformsEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(HasExplicitPlatformsEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<HasExplicitPlatformsEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<HasExplicitPlatformsEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<HasExplicitPlatformsEntity>();
                }
                finally
                {
