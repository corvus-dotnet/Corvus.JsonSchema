...
public readonly partial struct UnrealEngineUprojectSchema
{
    ...
    public readonly partial struct PluginReferenceDescriptor
    {
        ...
        public readonly partial struct ListOfDisallowedTaArray
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ListOfDisallowedTaArray instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ListOfDisallowedTaArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ListOfDisallowedTaArray(Mutable instance)
                {
                ...
                public Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.BuildConfiguration.Mutable this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.BuildConfiguration.Mutable>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.BuildConfiguration.Mutable> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.BuildConfiguration.Mutable>(_parent, _idx);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ListOfDisallowedTaArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ListOfDisallowedTaArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetItem(int itemIndex, in Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.BuildConfiguration.Source value)
                {
                    CheckValidInstance();
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void InsertItem(int itemIndex, scoped in Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.BuildConfiguration.Source value)
                {
                    CheckValidInstance();
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void AddItem(scoped in Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.BuildConfiguration.Source value)
                {
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Remove(in Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.BuildConfiguration item)
                {
                    CheckValidInstance();
                    if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.BuildConfiguration>(this, in item))
                    {
                        return false;
                    }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void RemoveWhere(JsonPredicate<Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.BuildConfiguration> predicate)
                {
                    CheckValidInstance();
                    JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.BuildConfiguration>(this, predicate);
                    _documentVersion = _parent.Version;
                }
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Replace(in Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.BuildConfiguration oldItem, in Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.BuildConfiguration.Source newItem)
                {
                    CheckValidInstance();
                    ...
                    var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.BuildConfiguration>(_parent, _idx);

                    while (enumerator.MoveNext())
                    {
                        Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.BuildConfiguration current = enumerator.Current;
                ...
                /// <summary>
                /// Gets a <see cref="ListOfDisallowedTaArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ListOfDisallowedTaArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ListOfDisallowedTaArray Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ListOfDisallowedTaArray>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ListOfDisallowedTaArray"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ListOfDisallowedTaArray Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ListOfDisallowedTaArray>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.PluginReferenceDescriptor.ListOfDisallowedTaArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(ListOfDisallowedTaArray instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.PluginReferenceDescriptor.ListOfDisallowedTaArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// </summary>
                public void AddItem(in Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.BuildConfiguration.Source value)
                {
            ...
            {
                return workspace.CreateBuilder<ListOfDisallowedTaArray, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ListOfDisallowedTaArray> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ListOfDisallowedTaArray>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<ListOfDisallowedTaArray> Create<TContext>(
