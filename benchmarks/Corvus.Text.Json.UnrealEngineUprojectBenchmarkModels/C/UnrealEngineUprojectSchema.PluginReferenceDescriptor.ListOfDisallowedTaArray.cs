...
public readonly partial struct UnrealEngineUprojectSchema
{
    ...
    public readonly partial struct PluginReferenceDescriptor
    {
        ...
        public readonly partial struct ListOfDisallowedTaArray
            ...
            : IJsonElement<ListOfDisallowedTaArray>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ListOfDisallowedTaArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal ListOfDisallowedTaArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ListOfDisallowedTaArray DefaultInstance { get; }
            ...
            public Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.BuildConfiguration this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.BuildConfiguration>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.BuildConfiguration> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.BuildConfiguration>(_parent, _idx);
            }
            ...
            /// </returns>
            public static bool operator ==(in ListOfDisallowedTaArray left, in ListOfDisallowedTaArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ListOfDisallowedTaArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(ListOfDisallowedTaArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ListOfDisallowedTaArray(JsonElement instance)
            {
                return ListOfDisallowedTaArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ListOfDisallowedTaArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ListOfDisallowedTaArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ListOfDisallowedTaArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ListOfDisallowedTaArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ListOfDisallowedTaArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ListOfDisallowedTaArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ListOfDisallowedTaArray>(json, options);
            }
            ...
            /// </exception>
            public static ListOfDisallowedTaArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ListOfDisallowedTaArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ListOfDisallowedTaArray? result)
            {
                return JsonElementHelpers.TryParseValue<ListOfDisallowedTaArray>(ref reader, out result);
            }
...
#if NET
            static ListOfDisallowedTaArray IJsonElement<ListOfDisallowedTaArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ListOfDisallowedTaArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public ListOfDisallowedTaArray Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public ListOfDisallowedTaArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ListOfDisallowedTaArray>(_idx);
                }
