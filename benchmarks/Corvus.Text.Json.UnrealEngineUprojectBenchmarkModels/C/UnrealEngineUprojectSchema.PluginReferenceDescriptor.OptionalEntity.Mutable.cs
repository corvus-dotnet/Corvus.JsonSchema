    ...
    public readonly partial struct PluginReferenceDescriptor
    {
        ...
        public readonly partial struct OptionalEntity
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<OptionalEntity, Mutable>(OptionalEntity.DefaultInstance);
            ...
            public static ParsedJsonDocument<OptionalEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<OptionalEntity>();
                }
                finally
                {
