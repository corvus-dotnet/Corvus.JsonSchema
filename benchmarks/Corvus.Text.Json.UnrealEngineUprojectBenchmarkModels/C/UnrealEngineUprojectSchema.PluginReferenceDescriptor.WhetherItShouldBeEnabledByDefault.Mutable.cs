    ...
    public readonly partial struct PluginReferenceDescriptor
    {
        ...
        public readonly partial struct WhetherItShouldBeEnabledByDefault
        {
...
#endif
            {
                ...
                /// </remarks>
                public static Mutable DefaultInstance { get; } = JsonElementHelpers.CreateDefaultValueElement<WhetherItShouldBeEnabledByDefault, Mutable>(WhetherItShouldBeEnabledByDefault.DefaultInstance);
                ...
                public static explicit operator Mutable(WhetherItShouldBeEnabledByDefault instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="WhetherItShouldBeEnabledByDefault"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator WhetherItShouldBeEnabledByDefault(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"WhetherItShouldBeEnabledByDefault.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly WhetherItShouldBeEnabledByDefault Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly WhetherItShouldBeEnabledByDefault Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<WhetherItShouldBeEnabledByDefault>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(WhetherItShouldBeEnabledByDefault instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<WhetherItShouldBeEnabledByDefault, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<WhetherItShouldBeEnabledByDefault> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<WhetherItShouldBeEnabledByDefault>();
                }
                finally
                {
