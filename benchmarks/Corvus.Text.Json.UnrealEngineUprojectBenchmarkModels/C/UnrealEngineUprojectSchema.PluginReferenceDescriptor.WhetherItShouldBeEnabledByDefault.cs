...
public readonly partial struct UnrealEngineUprojectSchema
{
    ...
    public readonly partial struct PluginReferenceDescriptor
    {
        ...
        public readonly partial struct WhetherItShouldBeEnabledByDefault
#if NET8_0_OR_GREATER
            : IJsonElement<WhetherItShouldBeEnabledByDefault>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="WhetherItShouldBeEnabledByDefault"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal WhetherItShouldBeEnabledByDefault(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static WhetherItShouldBeEnabledByDefault DefaultInstance { get; } = ParsedJsonDocument<WhetherItShouldBeEnabledByDefault>.True;
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator bool(WhetherItShouldBeEnabledByDefault value)
            {
            ...
            /// </returns>
            public static bool operator ==(in WhetherItShouldBeEnabledByDefault left, in WhetherItShouldBeEnabledByDefault right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in WhetherItShouldBeEnabledByDefault left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(WhetherItShouldBeEnabledByDefault instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator WhetherItShouldBeEnabledByDefault(JsonElement instance)
            {
                return WhetherItShouldBeEnabledByDefault.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WhetherItShouldBeEnabledByDefault From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WhetherItShouldBeEnabledByDefault ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<WhetherItShouldBeEnabledByDefault>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WhetherItShouldBeEnabledByDefault ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<WhetherItShouldBeEnabledByDefault>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static WhetherItShouldBeEnabledByDefault ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<WhetherItShouldBeEnabledByDefault>(json, options);
            }
            ...
            /// </exception>
            public static WhetherItShouldBeEnabledByDefault ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<WhetherItShouldBeEnabledByDefault>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out WhetherItShouldBeEnabledByDefault? result)
            {
                return JsonElementHelpers.TryParseValue<WhetherItShouldBeEnabledByDefault>(ref reader, out result);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new WhetherItShouldBeEnabledByDefault(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
            static WhetherItShouldBeEnabledByDefault IJsonElement<WhetherItShouldBeEnabledByDefault>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"WhetherItShouldBeEnabledByDefault: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="WhetherItShouldBeEnabledByDefault"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="WhetherItShouldBeEnabledByDefault"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public WhetherItShouldBeEnabledByDefault Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<WhetherItShouldBeEnabledByDefault>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="WhetherItShouldBeEnabledByDefault"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public WhetherItShouldBeEnabledByDefault Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<WhetherItShouldBeEnabledByDefault>(_idx);
                }
