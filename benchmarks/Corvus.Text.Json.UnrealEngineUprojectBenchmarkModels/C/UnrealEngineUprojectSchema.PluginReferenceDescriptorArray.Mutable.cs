...
public readonly partial struct UnrealEngineUprojectSchema
{
    ...
    public readonly partial struct PluginReferenceDescriptorArray
    {
...
#endif
        {
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, in Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.PluginReferenceDescriptor.Source value)
            {
                CheckValidInstance();
