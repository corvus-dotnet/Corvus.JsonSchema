...
public readonly partial struct UnrealEngineUprojectSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PluginReferenceDescriptorArray"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal PluginReferenceDescriptorArray(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static PluginReferenceDescriptorArray DefaultInstance { get; }
        ...
        public Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.PluginReferenceDescriptor this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.PluginReferenceDescriptor>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.PluginReferenceDescriptor> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.PluginReferenceDescriptor>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in PluginReferenceDescriptorArray left, in PluginReferenceDescriptorArray right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in PluginReferenceDescriptorArray left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(PluginReferenceDescriptorArray instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator PluginReferenceDescriptorArray(JsonElement instance)
        {
            return PluginReferenceDescriptorArray.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PluginReferenceDescriptorArray From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PluginReferenceDescriptorArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PluginReferenceDescriptorArray>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PluginReferenceDescriptorArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PluginReferenceDescriptorArray>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PluginReferenceDescriptorArray ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<PluginReferenceDescriptorArray>(json, options);
        }
        ...
        /// </exception>
        public static PluginReferenceDescriptorArray ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<PluginReferenceDescriptorArray>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out PluginReferenceDescriptorArray? result)
        {
            return JsonElementHelpers.TryParseValue<PluginReferenceDescriptorArray>(ref reader, out result);
        }
...
#if NET
        static PluginReferenceDescriptorArray IJsonElement<PluginReferenceDescriptorArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"PluginReferenceDescriptorArray: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public PluginReferenceDescriptorArray Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public PluginReferenceDescriptorArray Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<PluginReferenceDescriptorArray>(_idx);
            }
