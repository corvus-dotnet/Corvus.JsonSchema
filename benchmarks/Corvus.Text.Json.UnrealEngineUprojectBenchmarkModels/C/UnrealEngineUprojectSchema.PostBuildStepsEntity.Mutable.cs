...
public readonly partial struct UnrealEngineUprojectSchema
{
    ...
    public readonly partial struct PostBuildStepsEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(PostBuildStepsEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="PostBuildStepsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PostBuildStepsEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PostBuildStepsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly PostBuildStepsEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly PostBuildStepsEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<PostBuildStepsEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.PostBuildStepsEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(PostBuildStepsEntity instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.PostBuildStepsEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<PostBuildStepsEntity, Mutable>(this);
        }
    }
}
