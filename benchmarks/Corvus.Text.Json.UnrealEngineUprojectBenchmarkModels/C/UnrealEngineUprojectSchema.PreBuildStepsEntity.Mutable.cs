...
public readonly partial struct UnrealEngineUprojectSchema
{
    ...
    public readonly partial struct PreBuildStepsEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(PreBuildStepsEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="PreBuildStepsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator PreBuildStepsEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"PreBuildStepsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly PreBuildStepsEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly PreBuildStepsEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<PreBuildStepsEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.PreBuildStepsEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(PreBuildStepsEntity instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.UnrealEngineUprojectBenchmark.Current.UnrealEngineUprojectSchema.PreBuildStepsEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<PreBuildStepsEntity, Mutable>(this);
        }
    }
}
