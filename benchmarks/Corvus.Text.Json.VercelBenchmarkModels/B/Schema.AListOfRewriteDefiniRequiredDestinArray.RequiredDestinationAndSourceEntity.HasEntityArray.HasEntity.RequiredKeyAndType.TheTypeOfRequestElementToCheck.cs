                ...
                public readonly partial struct HasEntity
                {
                    ...
                    public readonly partial struct RequiredKeyAndType
                    {
...
#endif
                        {
                            ...
                            /// <summary>
                            /// Initializes a new instance of the <see cref="TheTypeOfRequestElementToCheck"/> struct.
                            /// </summary>
                            /// <param name="value">The value from which to construct the instance.</param>
                            internal TheTypeOfRequestElementToCheck(IJsonDocument parent, int idx)
                            {
                                Debug.Assert(idx >= 0);
                                _parent = parent;
                                _idx = idx;
                            ...
                            /// </summary>
                            public static TheTypeOfRequestElementToCheck DefaultInstance { get; }
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static explicit operator string(TheTypeOfRequestElementToCheck value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                            ...
                            /// </returns>
                            public static bool operator ==(in TheTypeOfRequestElementToCheck left, in TheTypeOfRequestElementToCheck right)
                            {
                            ...
                            /// <c>True</c> if the values are equal.
                            /// </returns>
                            public static bool operator ==(in TheTypeOfRequestElementToCheck left, in JsonElement right)
                            {
                                return left.Equals(right);
                            }
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator JsonElement(TheTypeOfRequestElementToCheck instance)
                            {
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator TheTypeOfRequestElementToCheck(JsonElement instance)
                            {
                                return TheTypeOfRequestElementToCheck.From(instance);
                            }
                            ...
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static TheTypeOfRequestElementToCheck From<T>(in T instance)
                            ...
                            /// </exception>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static TheTypeOfRequestElementToCheck ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                            {
                                return JsonElementHelpers.ParseValue<TheTypeOfRequestElementToCheck>(utf8Json, options);
                            }
                            ...
                            /// </exception>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static TheTypeOfRequestElementToCheck ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                            {
                                return JsonElementHelpers.ParseValue<TheTypeOfRequestElementToCheck>(json, options);
                            }
                            ...
                            /// </exception>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static TheTypeOfRequestElementToCheck ParseValue(string json, JsonDocumentOptions options = default)
                            {
                                return JsonElementHelpers.ParseValue<TheTypeOfRequestElementToCheck>(json, options);
                            }
                            ...
                            /// </exception>
                            public static TheTypeOfRequestElementToCheck ParseValue(ref Utf8JsonReader reader)
                            {
                                return JsonElementHelpers.ParseValue<TheTypeOfRequestElementToCheck>(ref reader);
                            }
                            ...
                            ///   A value could not be read from the reader.
                            /// </exception>
                            public static bool TryParseValue(ref Utf8JsonReader reader, out TheTypeOfRequestElementToCheck? result)
                            {
                                return JsonElementHelpers.TryParseValue<TheTypeOfRequestElementToCheck>(ref reader, out result);
                            }
                            ...
                            {
                                return
                                    (obj is IJsonElement value && Equals(new TheTypeOfRequestElementToCheck(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                            static TheTypeOfRequestElementToCheck IJsonElement<TheTypeOfRequestElementToCheck>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            private string DebuggerDisplay => $"TheTypeOfRequestElementToCheck: ValueKind = {ValueKind} : \"{ToString()}\"";
                            ...
                            /// <summary>
                            /// Gets a <see cref="TheTypeOfRequestElementToCheck"/> which can be safely stored beyond the lifetime of the
                            /// original document.
                            /// </summary>
                            /// <returns>
                            /// A <see cref="TheTypeOfRequestElementToCheck"/> which can be safely stored beyond the lifetime of the
                            /// original document.
                            /// </returns>
                            /// <remarks>
                            /// <para>
                            ...
                            /// </para>
                            /// </remarks>
                            public TheTypeOfRequestElementToCheck Clone()
                            {
                                CheckValidInstance();
                                return _parent.CloneElement<TheTypeOfRequestElementToCheck>(_idx);
                            }
                            ...
                            /// </summary>
                            /// <returns>
                            /// An immutable <see cref="TheTypeOfRequestElementToCheck"/> that lives for the lifetime of its
                            ...
                            /// </para>
                            /// </remarks>
                            public TheTypeOfRequestElementToCheck Freeze()
                            {
                                CheckValidInstance();
                                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                                {
                                    return mutable.FreezeElement<TheTypeOfRequestElementToCheck>(_idx);
                                }
                            ...
                            /// <param name="matchCookie">Match 2nd item.</param>
                            /// <param name="matchQuery">Match 3rd item.</param>
                            /// <param name="defaultMatch">Match any other value.</param>
                            /// <returns>An instance of the value returned by the match function.</returns>
                            public TResult Match<TContext, TResult>(
                                in TContext context,
                                Func<TContext, TResult> matchHeader,
                                Func<TContext, TResult> matchCookie,
                                Func<TContext, TResult> matchQuery,
                            ...
                            public TResult Match<TResult>(
                                ...
                                Func<TResult> matchCookie,
                                Func<TResult> matchQuery,
