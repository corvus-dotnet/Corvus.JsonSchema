                ...
                public readonly partial struct HasEntity
                {
                    ...
                    public readonly partial struct RequiredTypeAndValue
                    {
...
#endif
                        {
                            ...
                            /// </para>
                            /// </remarks>
                            public Corvus.VercelBenchmark.Baseline.Schema.AListOfRewriteDefiniRequiredDestinArray.RequiredDestinationAndSourceEntity.HasEntityArray.HasEntity.RequiredTypeAndValue.TheTypeOfRequestElementToCheck.Mutable Type
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.VercelBenchmark.Baseline.Schema.AListOfRewriteDefiniRequiredDestinArray.RequiredDestinationAndSourceEntity.HasEntityArray.HasEntity.RequiredTypeAndValue.TheTypeOfRequestElementToCheck.Mutable value))
                                    {
                                        return value;
                                    }
                            ...
                            /// </para>
                            /// </remarks>
                            public Corvus.VercelBenchmark.Baseline.Schema.AListOfRewriteDefiniRequiredDestinArray.RequiredDestinationAndSourceEntity.HasEntityArray.HasEntity.RequiredTypeAndValue.ValueEntity.Mutable Value
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ValueUtf8, out Corvus.VercelBenchmark.Baseline.Schema.AListOfRewriteDefiniRequiredDestinArray.RequiredDestinationAndSourceEntity.HasEntityArray.HasEntity.RequiredTypeAndValue.ValueEntity.Mutable value))
                                    {
                                        return value;
                                    }
                            ...
                            public void SetType(in Corvus.VercelBenchmark.Baseline.Schema.AListOfRewriteDefiniRequiredDestinArray.RequiredDestinationAndSourceEntity.HasEntityArray.HasEntity.RequiredTypeAndValue.TheTypeOfRequestElementToCheck.Source value)
                            {
                                CheckValidInstance();
                            ...
                            /// </summary>
                            /// <param name="value">The value of the property to add.</param>
                            public void SetValue(in Corvus.VercelBenchmark.Baseline.Schema.AListOfRewriteDefiniRequiredDestinArray.RequiredDestinationAndSourceEntity.HasEntityArray.HasEntity.RequiredTypeAndValue.ValueEntity.Source value)
                            {
                                CheckValidInstance();
                        ...
                        public ref struct Source
                        {
                            ...
                            internal Source(Corvus.VercelBenchmark.Baseline.Schema.AListOfRewriteDefiniRequiredDestinArray.RequiredDestinationAndSourceEntity.HasEntityArray.HasEntity.RequiredTypeAndValue.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                            ...
                            #endif
                        {
                            ...
                            internal Source(scoped in TContext context, Corvus.VercelBenchmark.Baseline.Schema.AListOfRewriteDefiniRequiredDestinArray.RequiredDestinationAndSourceEntity.HasEntityArray.HasEntity.RequiredTypeAndValue.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                        ...
                        public ref struct Builder
                        {
                            ...
                            /// </summary>
                            internal static void Create(ref ComplexValueBuilder builder, in Corvus.VercelBenchmark.Baseline.Schema.AListOfRewriteDefiniRequiredDestinArray.RequiredDestinationAndSourceEntity.HasEntityArray.HasEntity.RequiredTypeAndValue.ValueEntity.Source value)
                            {
                                builder.AddProperty(JsonPropertyNamesEscaped.Type, Corvus.VercelBenchmark.Baseline.Schema.AListOfRewriteDefiniRequiredDestinArray.RequiredDestinationAndSourceEntity.HasEntityArray.HasEntity.RequiredTypeAndValue.TheTypeOfRequestElementToCheck.ConstInstance);
                            ...
                            /// Creates an instance of a <see cref="RequiredTypeAndValue"/>.
                            /// </summary>
                            public void Create(in Corvus.VercelBenchmark.Baseline.Schema.AListOfRewriteDefiniRequiredDestinArray.RequiredDestinationAndSourceEntity.HasEntityArray.HasEntity.RequiredTypeAndValue.ValueEntity.Source value)
                            {
                        ...
                        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.VercelBenchmark.Baseline.Schema.AListOfRewriteDefiniRequiredDestinArray.RequiredDestinationAndSourceEntity.HasEntityArray.HasEntity.RequiredTypeAndValue.ValueEntity.Source value, int initialCapacity = 30)
                        {
                            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                            cvb.StartObject();
