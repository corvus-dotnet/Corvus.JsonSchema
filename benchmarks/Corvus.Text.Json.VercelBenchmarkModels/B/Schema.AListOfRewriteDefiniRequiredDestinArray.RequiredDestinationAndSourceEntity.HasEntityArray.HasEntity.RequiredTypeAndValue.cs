            ...
            public readonly partial struct HasEntityArray
            {
                ...
                public readonly partial struct HasEntity
                {
...
#endif
                    {
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.VercelBenchmark.Baseline.Schema.AListOfRewriteDefiniRequiredDestinArray.RequiredDestinationAndSourceEntity.HasEntityArray.HasEntity.RequiredTypeAndValue.TheTypeOfRequestElementToCheck Type
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.VercelBenchmark.Baseline.Schema.AListOfRewriteDefiniRequiredDestinArray.RequiredDestinationAndSourceEntity.HasEntityArray.HasEntity.RequiredTypeAndValue.TheTypeOfRequestElementToCheck value))
                                {
                                    return value;
                                }
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.VercelBenchmark.Baseline.Schema.AListOfRewriteDefiniRequiredDestinArray.RequiredDestinationAndSourceEntity.HasEntityArray.HasEntity.RequiredTypeAndValue.ValueEntity Value
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ValueUtf8, out Corvus.VercelBenchmark.Baseline.Schema.AListOfRewriteDefiniRequiredDestinArray.RequiredDestinationAndSourceEntity.HasEntityArray.HasEntity.RequiredTypeAndValue.ValueEntity value))
                                {
                                    return value;
                                }
