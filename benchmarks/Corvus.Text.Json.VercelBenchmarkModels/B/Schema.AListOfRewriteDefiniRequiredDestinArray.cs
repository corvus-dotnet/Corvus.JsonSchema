...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AListOfRewriteDefiniRequiredDestinArray"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal AListOfRewriteDefiniRequiredDestinArray(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static AListOfRewriteDefiniRequiredDestinArray DefaultInstance { get; }
        ...
        public Corvus.VercelBenchmark.Baseline.Schema.AListOfRewriteDefiniRequiredDestinArray.RequiredDestinationAndSourceEntity this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.VercelBenchmark.Baseline.Schema.AListOfRewriteDefiniRequiredDestinArray.RequiredDestinationAndSourceEntity>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.VercelBenchmark.Baseline.Schema.AListOfRewriteDefiniRequiredDestinArray.RequiredDestinationAndSourceEntity> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.VercelBenchmark.Baseline.Schema.AListOfRewriteDefiniRequiredDestinArray.RequiredDestinationAndSourceEntity>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in AListOfRewriteDefiniRequiredDestinArray left, in AListOfRewriteDefiniRequiredDestinArray right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in AListOfRewriteDefiniRequiredDestinArray left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(AListOfRewriteDefiniRequiredDestinArray instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator AListOfRewriteDefiniRequiredDestinArray(JsonElement instance)
        {
            return AListOfRewriteDefiniRequiredDestinArray.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AListOfRewriteDefiniRequiredDestinArray From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AListOfRewriteDefiniRequiredDestinArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AListOfRewriteDefiniRequiredDestinArray>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AListOfRewriteDefiniRequiredDestinArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AListOfRewriteDefiniRequiredDestinArray>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AListOfRewriteDefiniRequiredDestinArray ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AListOfRewriteDefiniRequiredDestinArray>(json, options);
        }
        ...
        /// </exception>
        public static AListOfRewriteDefiniRequiredDestinArray ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<AListOfRewriteDefiniRequiredDestinArray>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out AListOfRewriteDefiniRequiredDestinArray? result)
        {
            return JsonElementHelpers.TryParseValue<AListOfRewriteDefiniRequiredDestinArray>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new AListOfRewriteDefiniRequiredDestinArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static AListOfRewriteDefiniRequiredDestinArray IJsonElement<AListOfRewriteDefiniRequiredDestinArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"AListOfRewriteDefiniRequiredDestinArray: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="AListOfRewriteDefiniRequiredDestinArray"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="AListOfRewriteDefiniRequiredDestinArray"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public AListOfRewriteDefiniRequiredDestinArray Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<AListOfRewriteDefiniRequiredDestinArray>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="AListOfRewriteDefiniRequiredDestinArray"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public AListOfRewriteDefiniRequiredDestinArray Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<AListOfRewriteDefiniRequiredDestinArray>(_idx);
            }
