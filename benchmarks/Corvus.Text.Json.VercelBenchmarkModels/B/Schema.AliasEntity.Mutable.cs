...
public readonly partial struct Schema
{
    ...
    public readonly partial struct AliasEntity
    {
...
#endif
        {
            ...
            /// <summary>
            /// Conversion to <see cref="Corvus.VercelBenchmark.Baseline.Schema.AliasEntity.OneOf1Array"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.VercelBenchmark.Baseline.Schema.AliasEntity.OneOf1Array.Mutable(Mutable value)
            {
                return Corvus.VercelBenchmark.Baseline.Schema.AliasEntity.OneOf1Array.Mutable.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.VercelBenchmark.Baseline.Schema.AliasEntity.OneOf1Array"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.VercelBenchmark.Baseline.Schema.AliasEntity.OneOf1Array.Mutable value)
            {
                return From(value);
            }
            ...
            public static explicit operator Mutable(AliasEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="AliasEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator AliasEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"AliasEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </para>
            /// </remarks>
            public readonly AliasEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly AliasEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<AliasEntity>(_idx);
            }
            ...
            /// <param name="matchJsonString">Match a <see cref="Corvus.VercelBenchmark.Baseline.JsonString"/>.</param>
            /// <param name="matchOneOf1Array">Match a <see cref="Corvus.VercelBenchmark.Baseline.Schema.AliasEntity.OneOf1Array"/>.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Matcher<Corvus.VercelBenchmark.Baseline.JsonString, TContext, TResult> matchJsonString,
                Matcher<Corvus.VercelBenchmark.Baseline.Schema.AliasEntity.OneOf1Array, TContext, TResult> matchOneOf1Array,
                Matcher<Corvus.VercelBenchmark.Baseline.Schema.AliasEntity.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
            {
                if (Corvus.VercelBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonString(Corvus.VercelBenchmark.Baseline.JsonString.Mutable.From(this), context);
                }

                if (Corvus.VercelBenchmark.Baseline.Schema.AliasEntity.OneOf1Array.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchOneOf1Array(Corvus.VercelBenchmark.Baseline.Schema.AliasEntity.OneOf1Array.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                Matcher<Corvus.VercelBenchmark.Baseline.JsonString, TResult> matchJsonString,
                Matcher<Corvus.VercelBenchmark.Baseline.Schema.AliasEntity.OneOf1Array, TResult> matchOneOf1Array,
                Matcher<Corvus.VercelBenchmark.Baseline.Schema.AliasEntity.Mutable, TResult> defaultMatch)
            {
                if (Corvus.VercelBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonString(Corvus.VercelBenchmark.Baseline.JsonString.Mutable.From(this));
                }

                if (Corvus.VercelBenchmark.Baseline.Schema.AliasEntity.OneOf1Array.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchOneOf1Array(Corvus.VercelBenchmark.Baseline.Schema.AliasEntity.OneOf1Array.Mutable.From(this));
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.VercelBenchmark.Baseline.JsonString" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsJsonString(out Corvus.VercelBenchmark.Baseline.JsonString result)
            {
                if (Corvus.VercelBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.VercelBenchmark.Baseline.JsonString.Mutable.From(this);
                    return true;
                }
            ...
            /// <summary>
            /// Gets the value as a <see cref="Corvus.VercelBenchmark.Baseline.Schema.AliasEntity.OneOf1Array" />.
            /// </summary>
            /// <param name="result">The result of the conversions.</param>
            /// <returns><see langword="true" /> if the conversion was valid.</returns>
            public bool TryGetAsOneOf1Array(out Corvus.VercelBenchmark.Baseline.Schema.AliasEntity.OneOf1Array result)
            {
                if (Corvus.VercelBenchmark.Baseline.Schema.AliasEntity.OneOf1Array.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.VercelBenchmark.Baseline.Schema.AliasEntity.OneOf1Array.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.VercelBenchmark.Baseline.Schema.AliasEntity.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(AliasEntity instance) => new(JsonElement.From(instance));
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.VercelBenchmark.Baseline.JsonString instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.VercelBenchmark.Baseline.Schema.AliasEntity.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<AliasEntity, Mutable>(this);
        }
    }
}
