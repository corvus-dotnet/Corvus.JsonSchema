    ...
    public readonly partial struct AliasEntity
    {
        ...
        public readonly partial struct OneOf1Array
        {
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.VercelBenchmark.Baseline.Schema.AliasEntity.OneOf1Array.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.VercelBenchmark.Baseline.Schema.AliasEntity.OneOf1Array.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
