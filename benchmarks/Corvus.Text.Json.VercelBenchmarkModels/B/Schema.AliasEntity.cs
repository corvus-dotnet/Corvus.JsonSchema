...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        public static explicit operator Corvus.VercelBenchmark.Baseline.Schema.AliasEntity.OneOf1Array(AliasEntity value)
        {
            return Corvus.VercelBenchmark.Baseline.Schema.AliasEntity.OneOf1Array.From(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator AliasEntity(Corvus.VercelBenchmark.Baseline.Schema.AliasEntity.OneOf1Array value)
        {
            return From(value);
        }
        ...
        public bool TryGetAsJsonString(out Corvus.VercelBenchmark.Baseline.JsonString result)
        {
            ...
            {
                result = Corvus.VercelBenchmark.Baseline.JsonString.From(this);
                return true;
            }
        ...
        public bool TryGetAsOneOf1Array(out Corvus.VercelBenchmark.Baseline.Schema.AliasEntity.OneOf1Array result)
        {
            ...
            {
                result = Corvus.VercelBenchmark.Baseline.Schema.AliasEntity.OneOf1Array.From(this);
                return true;
            }
        ...
        public TResult Match<TContext, TResult>(
            ...
            Matcher<Corvus.VercelBenchmark.Baseline.Schema.AliasEntity, TContext, TResult> defaultMatch)
...
#endif
        {
            if (Corvus.VercelBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchJsonString(Corvus.VercelBenchmark.Baseline.JsonString.From(this), context);
            }

            if (Corvus.VercelBenchmark.Baseline.Schema.AliasEntity.OneOf1Array.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchOneOf1Array(Corvus.VercelBenchmark.Baseline.Schema.AliasEntity.OneOf1Array.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            ...
            Matcher<Corvus.VercelBenchmark.Baseline.Schema.AliasEntity, TResult> defaultMatch)
        {
            if (Corvus.VercelBenchmark.Baseline.JsonString.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchJsonString(Corvus.VercelBenchmark.Baseline.JsonString.From(this));
            }

            if (Corvus.VercelBenchmark.Baseline.Schema.AliasEntity.OneOf1Array.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchOneOf1Array(Corvus.VercelBenchmark.Baseline.Schema.AliasEntity.OneOf1Array.From(this));
            }
