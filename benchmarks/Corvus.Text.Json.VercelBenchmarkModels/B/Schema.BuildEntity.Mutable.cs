...
public readonly partial struct Schema
{
    ...
    public readonly partial struct BuildEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(BuildEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="BuildEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator BuildEntity(Mutable instance)
            {
            ...
            /// </para>
            /// </remarks>
            public Corvus.VercelBenchmark.Baseline.Schema.BuildEntity.EnvEntity.Mutable Env
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EnvUtf8, out Corvus.VercelBenchmark.Baseline.Schema.BuildEntity.EnvEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetEnv(in Corvus.VercelBenchmark.Baseline.Schema.BuildEntity.EnvEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetEnv<TContext>(in Corvus.VercelBenchmark.Baseline.Schema.BuildEntity.EnvEntity.Source<TContext> value)
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"BuildEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly BuildEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly BuildEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<BuildEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.VercelBenchmark.Baseline.Schema.BuildEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(BuildEntity instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.VercelBenchmark.Baseline.Schema.BuildEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="BuildEntity"/>.
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.VercelBenchmark.Baseline.Schema.BuildEntity.EnvEntity.Source env = default)
            {
            ...
            /// Creates an instance of a <see cref="BuildEntity"/>.
            /// </summary>
            public void Create(in Corvus.VercelBenchmark.Baseline.Schema.BuildEntity.EnvEntity.Source env = default)
            {
            ...
            internal static void Create<TContext>(
                ...
                in Corvus.VercelBenchmark.Baseline.Schema.BuildEntity.EnvEntity.Source<TContext> env = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            /// Creates an instance of a <see cref="BuildEntity"/>.
            /// </summary>
            public void Create<TContext>(in TContext context, in Corvus.VercelBenchmark.Baseline.Schema.BuildEntity.EnvEntity.Source<TContext> env = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.VercelBenchmark.Baseline.Schema.BuildEntity.EnvEntity.Source env = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.VercelBenchmark.Baseline.Schema.BuildEntity.EnvEntity.Source<TContext> env = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
        ...
        {
            return workspace.CreateBuilder<BuildEntity, Mutable>(this);
        }
    }
}
