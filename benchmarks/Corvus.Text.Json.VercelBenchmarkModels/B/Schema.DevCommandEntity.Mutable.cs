...
public readonly partial struct Schema
{
    ...
    public readonly partial struct DevCommandEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(DevCommandEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="DevCommandEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DevCommandEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DevCommandEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly DevCommandEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly DevCommandEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<DevCommandEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(DevCommandEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<DevCommandEntity, Mutable>(this);
        }
    }
}
