...
public readonly partial struct Schema
{
    ...
    public readonly partial struct FunctionsEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(FunctionsEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="FunctionsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator FunctionsEntity(Mutable instance)
            {
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new FunctionsEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"FunctionsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="FunctionsEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="FunctionsEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly FunctionsEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<FunctionsEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="FunctionsEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly FunctionsEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<FunctionsEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.VercelBenchmark.Baseline.Schema.FunctionsEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(FunctionsEntity instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.VercelBenchmark.Baseline.Schema.FunctionsEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<FunctionsEntity, Mutable>(this);
        }
    }
}
