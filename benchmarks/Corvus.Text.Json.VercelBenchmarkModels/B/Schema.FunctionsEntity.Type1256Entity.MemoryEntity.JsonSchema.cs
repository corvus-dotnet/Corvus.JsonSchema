        ...
        public readonly partial struct Type1256Entity
        {
                ...
                : IJsonElement<MemoryEntity>
            {
                public static partial class JsonSchema
                {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("vercel-schema.json#/properties/functions/patternProperties/^.{1,256}$/properties/memory"u8, buffer, out written);

                    /// <summary>
                    /// Gets the schema location from which this type was generated.
                    /// </summary>
                    public const string SchemaLocation = "vercel-schema.json#/properties/functions/patternProperties/^.{1,256}$/properties/memory";

                    /// <summary>
                    /// Gets the schema location from which this type was generated as a UTF-8 string.
                    /// </summary>
                    public static ReadOnlySpan<byte> SchemaLocationUtf8 => "vercel-schema.json#/properties/functions/patternProperties/^.{1,256}$/properties/memory"u8;
