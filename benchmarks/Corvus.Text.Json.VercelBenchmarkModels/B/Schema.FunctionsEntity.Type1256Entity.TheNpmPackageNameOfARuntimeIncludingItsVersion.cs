    ...
    public readonly partial struct FunctionsEntity
    {
        ...
        public readonly partial struct Type1256Entity
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="TheNpmPackageNameOfARuntimeIncludingItsVersion"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal TheNpmPackageNameOfARuntimeIncludingItsVersion(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static TheNpmPackageNameOfARuntimeIncludingItsVersion DefaultInstance { get; }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(TheNpmPackageNameOfARuntimeIncludingItsVersion value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in TheNpmPackageNameOfARuntimeIncludingItsVersion left, in TheNpmPackageNameOfARuntimeIncludingItsVersion right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in TheNpmPackageNameOfARuntimeIncludingItsVersion left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(TheNpmPackageNameOfARuntimeIncludingItsVersion instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator TheNpmPackageNameOfARuntimeIncludingItsVersion(JsonElement instance)
                {
                    return TheNpmPackageNameOfARuntimeIncludingItsVersion.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheNpmPackageNameOfARuntimeIncludingItsVersion From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheNpmPackageNameOfARuntimeIncludingItsVersion ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TheNpmPackageNameOfARuntimeIncludingItsVersion>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheNpmPackageNameOfARuntimeIncludingItsVersion ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TheNpmPackageNameOfARuntimeIncludingItsVersion>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static TheNpmPackageNameOfARuntimeIncludingItsVersion ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<TheNpmPackageNameOfARuntimeIncludingItsVersion>(json, options);
                }
                ...
                /// </exception>
                public static TheNpmPackageNameOfARuntimeIncludingItsVersion ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<TheNpmPackageNameOfARuntimeIncludingItsVersion>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out TheNpmPackageNameOfARuntimeIncludingItsVersion? result)
                {
                    return JsonElementHelpers.TryParseValue<TheNpmPackageNameOfARuntimeIncludingItsVersion>(ref reader, out result);
                }
...
#if NET
                static TheNpmPackageNameOfARuntimeIncludingItsVersion IJsonElement<TheNpmPackageNameOfARuntimeIncludingItsVersion>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"TheNpmPackageNameOfARuntimeIncludingItsVersion: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public TheNpmPackageNameOfARuntimeIncludingItsVersion Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public TheNpmPackageNameOfARuntimeIncludingItsVersion Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<TheNpmPackageNameOfARuntimeIncludingItsVersion>(_idx);
                    }
