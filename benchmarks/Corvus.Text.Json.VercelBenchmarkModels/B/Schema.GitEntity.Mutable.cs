...
public readonly partial struct Schema
{
    ...
    public readonly partial struct GitEntity
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.VercelBenchmark.Baseline.Schema.GitEntity.DeploymentEnabledEntity.Mutable DeploymentEnabled
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DeploymentEnabledUtf8, out Corvus.VercelBenchmark.Baseline.Schema.GitEntity.DeploymentEnabledEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetDeploymentEnabled(in Corvus.VercelBenchmark.Baseline.Schema.GitEntity.DeploymentEnabledEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetDeploymentEnabled<TContext>(in Corvus.VercelBenchmark.Baseline.Schema.GitEntity.DeploymentEnabledEntity.Source<TContext> value)
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.VercelBenchmark.Baseline.Schema.GitEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.VercelBenchmark.Baseline.Schema.GitEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.VercelBenchmark.Baseline.Schema.GitEntity.DeploymentEnabledEntity.Source deploymentEnabled = default)
            {
            ...
            /// Creates an instance of a <see cref="GitEntity"/>.
            /// </summary>
            public void Create(in Corvus.VercelBenchmark.Baseline.Schema.GitEntity.DeploymentEnabledEntity.Source deploymentEnabled = default)
            {
            ...
            internal static void Create<TContext>(
                ...
                in Corvus.VercelBenchmark.Baseline.Schema.GitEntity.DeploymentEnabledEntity.Source<TContext> deploymentEnabled = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            /// Creates an instance of a <see cref="GitEntity"/>.
            /// </summary>
            public void Create<TContext>(in TContext context, in Corvus.VercelBenchmark.Baseline.Schema.GitEntity.DeploymentEnabledEntity.Source<TContext> deploymentEnabled = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.VercelBenchmark.Baseline.Schema.GitEntity.DeploymentEnabledEntity.Source deploymentEnabled = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.VercelBenchmark.Baseline.Schema.GitEntity.DeploymentEnabledEntity.Source<TContext> deploymentEnabled = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
