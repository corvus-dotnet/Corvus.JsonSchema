...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// </para>
        /// </remarks>
        public Corvus.VercelBenchmark.Baseline.Schema.GitEntity.DeploymentEnabledEntity DeploymentEnabled
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DeploymentEnabledUtf8, out Corvus.VercelBenchmark.Baseline.Schema.GitEntity.DeploymentEnabledEntity value))
                {
                    return value;
                }
