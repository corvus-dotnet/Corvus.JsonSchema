...
public readonly partial struct Schema
{
    ...
    public readonly partial struct GithubEntity
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.VercelBenchmark.Baseline.JsonBoolean.Mutable AutoAlias
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AutoAliasUtf8, out Corvus.VercelBenchmark.Baseline.JsonBoolean.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.VercelBenchmark.Baseline.JsonBoolean.Mutable AutoJobCancelation
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AutoJobCancelationUtf8, out Corvus.VercelBenchmark.Baseline.JsonBoolean.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.VercelBenchmark.Baseline.JsonBoolean.Mutable Enabled
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EnabledUtf8, out Corvus.VercelBenchmark.Baseline.JsonBoolean.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.VercelBenchmark.Baseline.JsonBoolean.Mutable Silent
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SilentUtf8, out Corvus.VercelBenchmark.Baseline.JsonBoolean.Mutable value))
                    {
                        return value;
                    }
            ...
            public void SetAutoAlias(in Corvus.VercelBenchmark.Baseline.JsonBoolean.Source value)
            {
                CheckValidInstance();
                ...
                else
                {
                    ...
                    value.AddAsProperty(JsonPropertyNamesEscaped.AutoAlias, ref cvb, escapeName: false, nameRequiresUnescaping: false);
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetAutoJobCancelation(in Corvus.VercelBenchmark.Baseline.JsonBoolean.Source value)
            {
                CheckValidInstance();
                ...
                {
                    // We are going to insert the new value
                    value.AddAsProperty(JsonPropertyNamesEscaped.AutoJobCancelation, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetEnabled(in Corvus.VercelBenchmark.Baseline.JsonBoolean.Source value)
            {
                CheckValidInstance();
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetSilent(in Corvus.VercelBenchmark.Baseline.JsonBoolean.Source value)
            {
                CheckValidInstance();
                ...
                {
                    // We are going to insert the new value
                    value.AddAsProperty(JsonPropertyNamesEscaped.Silent, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.VercelBenchmark.Baseline.Schema.GithubEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.VercelBenchmark.Baseline.Schema.GithubEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            internal static void Create(
                ...
                in Corvus.VercelBenchmark.Baseline.JsonBoolean.Source autoAlias = default,
                in Corvus.VercelBenchmark.Baseline.JsonBoolean.Source autoJobCancelation = default,
                in Corvus.VercelBenchmark.Baseline.JsonBoolean.Source enabled = default,
                in Corvus.VercelBenchmark.Baseline.JsonBoolean.Source silent = default)
            {
                autoAlias.AddAsProperty(JsonPropertyNamesEscaped.AutoAlias, ref builder, escapeName: false);
                autoJobCancelation.AddAsProperty(JsonPropertyNamesEscaped.AutoJobCancelation, ref builder, escapeName: false);
                enabled.AddAsProperty(JsonPropertyNamesEscaped.Enabled, ref builder, escapeName: false);
                silent.AddAsProperty(JsonPropertyNamesEscaped.Silent, ref builder, escapeName: false);
            }
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.VercelBenchmark.Baseline.JsonBoolean.Source autoAlias = default, in Corvus.VercelBenchmark.Baseline.JsonBoolean.Source autoJobCancelation = default, in Corvus.VercelBenchmark.Baseline.JsonBoolean.Source enabled = default, in Corvus.VercelBenchmark.Baseline.JsonBoolean.Source silent = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
