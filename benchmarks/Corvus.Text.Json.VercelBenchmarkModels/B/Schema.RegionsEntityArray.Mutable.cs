...
public readonly partial struct Schema
{
    ...
    public readonly partial struct RegionsEntityArray
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(RegionsEntityArray instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="RegionsEntityArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RegionsEntityArray(Mutable instance)
            {
            ...
            public Corvus.VercelBenchmark.Baseline.Schema.RegionsEntityArray.RegionsEntity.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.VercelBenchmark.Baseline.Schema.RegionsEntityArray.RegionsEntity.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.VercelBenchmark.Baseline.Schema.RegionsEntityArray.RegionsEntity.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.VercelBenchmark.Baseline.Schema.RegionsEntityArray.RegionsEntity.Mutable>(_parent, _idx);
            }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new RegionsEntityArray(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RegionsEntityArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            /// <summary>
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Corvus.VercelBenchmark.Baseline.Schema.RegionsEntityArray.RegionsEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, in Corvus.VercelBenchmark.Baseline.Schema.RegionsEntityArray.RegionsEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(in Corvus.VercelBenchmark.Baseline.Schema.RegionsEntityArray.RegionsEntity.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Corvus.VercelBenchmark.Baseline.Schema.RegionsEntityArray.RegionsEntity item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.VercelBenchmark.Baseline.Schema.RegionsEntityArray.RegionsEntity>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Corvus.VercelBenchmark.Baseline.Schema.RegionsEntityArray.RegionsEntity> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.VercelBenchmark.Baseline.Schema.RegionsEntityArray.RegionsEntity>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Corvus.VercelBenchmark.Baseline.Schema.RegionsEntityArray.RegionsEntity oldItem, in Corvus.VercelBenchmark.Baseline.Schema.RegionsEntityArray.RegionsEntity.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.VercelBenchmark.Baseline.Schema.RegionsEntityArray.RegionsEntity>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Corvus.VercelBenchmark.Baseline.Schema.RegionsEntityArray.RegionsEntity current = enumerator.Current;
            ...
            /// <summary>
            /// Gets a <see cref="RegionsEntityArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RegionsEntityArray"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly RegionsEntityArray Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RegionsEntityArray>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RegionsEntityArray"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly RegionsEntityArray Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<RegionsEntityArray>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.VercelBenchmark.Baseline.Schema.RegionsEntityArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

            public static implicit operator Source(RegionsEntityArray instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.VercelBenchmark.Baseline.Schema.RegionsEntityArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        {
            return workspace.CreateBuilder<RegionsEntityArray, Mutable>(this);
        }
    }
}
