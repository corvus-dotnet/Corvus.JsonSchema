    ...
    public readonly partial struct RequiredDomainAndValueArray
    {
        ...
        public readonly partial struct RequiredDomainAndValue
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.VercelBenchmark.Baseline.Schema.RequiredDomainAndValueArray.RequiredDomainAndValue.DomainEntity.Mutable Domain
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DomainUtf8, out Corvus.VercelBenchmark.Baseline.Schema.RequiredDomainAndValueArray.RequiredDomainAndValue.DomainEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.VercelBenchmark.Baseline.Schema.RequiredDomainAndValueArray.RequiredDomainAndValue.ValueEntity.Mutable Value
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ValueUtf8, out Corvus.VercelBenchmark.Baseline.Schema.RequiredDomainAndValueArray.RequiredDomainAndValue.ValueEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetDomain(in Corvus.VercelBenchmark.Baseline.Schema.RequiredDomainAndValueArray.RequiredDomainAndValue.DomainEntity.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetValue(in Corvus.VercelBenchmark.Baseline.Schema.RequiredDomainAndValueArray.RequiredDomainAndValue.ValueEntity.Source value)
                {
                    CheckValidInstance();
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.VercelBenchmark.Baseline.Schema.RequiredDomainAndValueArray.RequiredDomainAndValue.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.VercelBenchmark.Baseline.Schema.RequiredDomainAndValueArray.RequiredDomainAndValue.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.VercelBenchmark.Baseline.Schema.RequiredDomainAndValueArray.RequiredDomainAndValue.DomainEntity.Source domain,
                    in Corvus.VercelBenchmark.Baseline.Schema.RequiredDomainAndValueArray.RequiredDomainAndValue.ValueEntity.Source value)
                {
                ...
                /// Creates an instance of a <see cref="RequiredDomainAndValue"/>.
                /// </summary>
                public void Create(in Corvus.VercelBenchmark.Baseline.Schema.RequiredDomainAndValueArray.RequiredDomainAndValue.DomainEntity.Source domain, in Corvus.VercelBenchmark.Baseline.Schema.RequiredDomainAndValueArray.RequiredDomainAndValue.ValueEntity.Source value)
                {
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.VercelBenchmark.Baseline.Schema.RequiredDomainAndValueArray.RequiredDomainAndValue.DomainEntity.Source domain, in Corvus.VercelBenchmark.Baseline.Schema.RequiredDomainAndValueArray.RequiredDomainAndValue.ValueEntity.Source value, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
