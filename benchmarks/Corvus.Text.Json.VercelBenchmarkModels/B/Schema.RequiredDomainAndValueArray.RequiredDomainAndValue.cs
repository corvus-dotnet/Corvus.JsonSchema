...
public readonly partial struct Schema
{
    ...
    public readonly partial struct RequiredDomainAndValueArray
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RequiredDomainAndValue"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RequiredDomainAndValue(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RequiredDomainAndValue DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.VercelBenchmark.Baseline.Schema.RequiredDomainAndValueArray.RequiredDomainAndValue.DomainEntity Domain
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DomainUtf8, out Corvus.VercelBenchmark.Baseline.Schema.RequiredDomainAndValueArray.RequiredDomainAndValue.DomainEntity value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.VercelBenchmark.Baseline.Schema.RequiredDomainAndValueArray.RequiredDomainAndValue.ValueEntity Value
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ValueUtf8, out Corvus.VercelBenchmark.Baseline.Schema.RequiredDomainAndValueArray.RequiredDomainAndValue.ValueEntity value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in RequiredDomainAndValue left, in RequiredDomainAndValue right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RequiredDomainAndValue left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(RequiredDomainAndValue instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RequiredDomainAndValue(JsonElement instance)
            {
                return RequiredDomainAndValue.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredDomainAndValue From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredDomainAndValue ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredDomainAndValue>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredDomainAndValue ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredDomainAndValue>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredDomainAndValue ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredDomainAndValue>(json, options);
            }
            ...
            /// </exception>
            public static RequiredDomainAndValue ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RequiredDomainAndValue>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredDomainAndValue? result)
            {
                return JsonElementHelpers.TryParseValue<RequiredDomainAndValue>(ref reader, out result);
            }
...
#if NET
            static RequiredDomainAndValue IJsonElement<RequiredDomainAndValue>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RequiredDomainAndValue: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public RequiredDomainAndValue Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public RequiredDomainAndValue Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RequiredDomainAndValue>(_idx);
                }
