...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        public Corvus.VercelBenchmark.Baseline.Schema.RequiredDomainAndValueArray.RequiredDomainAndValue this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.VercelBenchmark.Baseline.Schema.RequiredDomainAndValueArray.RequiredDomainAndValue>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.VercelBenchmark.Baseline.Schema.RequiredDomainAndValueArray.RequiredDomainAndValue> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.VercelBenchmark.Baseline.Schema.RequiredDomainAndValueArray.RequiredDomainAndValue>(_parent, _idx);
        }
