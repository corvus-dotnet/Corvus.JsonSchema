...
public readonly partial struct Schema
{
    ...
    public readonly partial struct RequiredHeadersAndSourceEntityArray
    {
...
#endif
        {
            ...
            public Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.Mutable>(_parent, _idx);
            }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, in Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(in Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity oldItem, in Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity current = enumerator.Current;
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
