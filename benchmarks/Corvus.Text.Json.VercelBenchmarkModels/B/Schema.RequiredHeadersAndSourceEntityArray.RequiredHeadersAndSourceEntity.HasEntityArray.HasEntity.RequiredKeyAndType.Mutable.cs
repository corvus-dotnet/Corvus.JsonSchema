                ...
                public readonly partial struct HasEntity
                {
                    ...
                    public readonly partial struct RequiredKeyAndType
                    {
...
#endif
                        {
                            ...
                            /// </para>
                            /// </remarks>
                            public Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.HasEntityArray.HasEntity.RequiredKeyAndType.TheNameOfTheElementContainedInTheParticularType.Mutable Key
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.KeyUtf8, out Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.HasEntityArray.HasEntity.RequiredKeyAndType.TheNameOfTheElementContainedInTheParticularType.Mutable value))
                                    {
                                        return value;
                                    }
                            ...
                            /// </para>
                            /// </remarks>
                            public Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.HasEntityArray.HasEntity.RequiredKeyAndType.TheTypeOfRequestElementToCheck.Mutable Type
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.HasEntityArray.HasEntity.RequiredKeyAndType.TheTypeOfRequestElementToCheck.Mutable value))
                                    {
                                        return value;
                                    }
                            ...
                            /// </para>
                            /// </remarks>
                            public Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.HasEntityArray.HasEntity.RequiredKeyAndType.ValueEntity.Mutable Value
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ValueUtf8, out Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.HasEntityArray.HasEntity.RequiredKeyAndType.ValueEntity.Mutable value))
                                    {
                                        return value;
                                    }
                            ...
                            public void SetKey(in Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.HasEntityArray.HasEntity.RequiredKeyAndType.TheNameOfTheElementContainedInTheParticularType.Source value)
                            {
                                CheckValidInstance();
                            ...
                            /// </summary>
                            /// <param name="value">The value of the property to add.</param>
                            public void SetType(in Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.HasEntityArray.HasEntity.RequiredKeyAndType.TheTypeOfRequestElementToCheck.Source value)
                            {
                                CheckValidInstance();
                            ...
                            /// </summary>
                            /// <param name="value">The value of the property to add.</param>
                            public void SetValue(in Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.HasEntityArray.HasEntity.RequiredKeyAndType.ValueEntity.Source value)
                            {
                                CheckValidInstance();
                        ...
                        public ref struct Source
                        {
                            ...
                            internal Source(Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.HasEntityArray.HasEntity.RequiredKeyAndType.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                            ...
                            #endif
                        {
                            ...
                            internal Source(scoped in TContext context, Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.HasEntityArray.HasEntity.RequiredKeyAndType.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                        ...
                        public ref struct Builder
                        {
                            ...
                            internal static void Create(
                                ...
                                in Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.HasEntityArray.HasEntity.RequiredKeyAndType.TheNameOfTheElementContainedInTheParticularType.Source key,
                                in Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.HasEntityArray.HasEntity.RequiredKeyAndType.TheTypeOfRequestElementToCheck.Source type,
                                in Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.HasEntityArray.HasEntity.RequiredKeyAndType.ValueEntity.Source value = default)
                            {
                        ...
                        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.HasEntityArray.HasEntity.RequiredKeyAndType.TheNameOfTheElementContainedInTheParticularType.Source key, in Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.HasEntityArray.HasEntity.RequiredKeyAndType.TheTypeOfRequestElementToCheck.Source type, in Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.HasEntityArray.HasEntity.RequiredKeyAndType.ValueEntity.Source value = default, int initialCapacity = 30)
                        {
                            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                            cvb.StartObject();
