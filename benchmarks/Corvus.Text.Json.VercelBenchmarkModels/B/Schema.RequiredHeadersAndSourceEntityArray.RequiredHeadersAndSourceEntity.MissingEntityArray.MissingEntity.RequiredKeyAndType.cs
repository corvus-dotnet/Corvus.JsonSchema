            ...
            public readonly partial struct MissingEntityArray
            {
                ...
                public readonly partial struct MissingEntity
                {
...
#endif
                    {
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.MissingEntityArray.MissingEntity.RequiredKeyAndType.TheNameOfTheElementContainedInTheParticularType Key
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.KeyUtf8, out Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.MissingEntityArray.MissingEntity.RequiredKeyAndType.TheNameOfTheElementContainedInTheParticularType value))
                                {
                                    return value;
                                }
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.MissingEntityArray.MissingEntity.RequiredKeyAndType.TheTypeOfRequestElementToCheck Type
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.MissingEntityArray.MissingEntity.RequiredKeyAndType.TheTypeOfRequestElementToCheck value))
                                {
                                    return value;
                                }
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.MissingEntityArray.MissingEntity.RequiredKeyAndType.ValueEntity Value
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ValueUtf8, out Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.MissingEntityArray.MissingEntity.RequiredKeyAndType.ValueEntity value))
                                {
                                    return value;
                                }
