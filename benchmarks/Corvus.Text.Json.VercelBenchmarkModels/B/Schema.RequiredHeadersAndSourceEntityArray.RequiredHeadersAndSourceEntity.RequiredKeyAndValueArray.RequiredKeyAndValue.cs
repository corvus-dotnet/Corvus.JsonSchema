        ...
        public readonly partial struct RequiredHeadersAndSourceEntity
        {
            ...
            public readonly partial struct RequiredKeyAndValueArray
            {
...
#endif
                {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.RequiredKeyAndValueArray.RequiredKeyAndValue.KeyEntity Key
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.KeyUtf8, out Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.RequiredKeyAndValueArray.RequiredKeyAndValue.KeyEntity value))
                            {
                                return value;
                            }
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.RequiredKeyAndValueArray.RequiredKeyAndValue.ValueEntity Value
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ValueUtf8, out Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.RequiredKeyAndValueArray.RequiredKeyAndValue.ValueEntity value))
                            {
                                return value;
                            }
