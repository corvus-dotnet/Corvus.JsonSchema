    ...
    public readonly partial struct RequiredHeadersAndSourceEntityArray
    {
        ...
        public readonly partial struct RequiredHeadersAndSourceEntity
        {
...
#endif
            {
                ...
                public Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.RequiredKeyAndValueArray.RequiredKeyAndValue this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.RequiredKeyAndValueArray.RequiredKeyAndValue>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.RequiredKeyAndValueArray.RequiredKeyAndValue> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.VercelBenchmark.Baseline.Schema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.RequiredKeyAndValueArray.RequiredKeyAndValue>(_parent, _idx);
                }
