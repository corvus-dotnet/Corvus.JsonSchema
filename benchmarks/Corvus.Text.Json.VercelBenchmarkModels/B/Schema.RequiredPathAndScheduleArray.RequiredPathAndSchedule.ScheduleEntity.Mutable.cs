        ...
        public readonly partial struct RequiredPathAndSchedule
        {
            ...
            public readonly partial struct ScheduleEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(ScheduleEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ScheduleEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ScheduleEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ScheduleEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ScheduleEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ScheduleEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ScheduleEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(ScheduleEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<ScheduleEntity, Mutable>(this);
                }
            }
        }
    }
