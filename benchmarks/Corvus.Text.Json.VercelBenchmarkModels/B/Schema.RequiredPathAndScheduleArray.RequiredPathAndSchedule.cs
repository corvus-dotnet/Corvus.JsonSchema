...
public readonly partial struct Schema
{
    ...
    public readonly partial struct RequiredPathAndScheduleArray
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RequiredPathAndSchedule"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RequiredPathAndSchedule(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RequiredPathAndSchedule DefaultInstance { get; }
            ...
            /// </para>
            /// </remarks>
            public Corvus.VercelBenchmark.Baseline.Schema.RequiredPathAndScheduleArray.RequiredPathAndSchedule.PathEntity Path
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PathUtf8, out Corvus.VercelBenchmark.Baseline.Schema.RequiredPathAndScheduleArray.RequiredPathAndSchedule.PathEntity value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.VercelBenchmark.Baseline.Schema.RequiredPathAndScheduleArray.RequiredPathAndSchedule.ScheduleEntity Schedule
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ScheduleUtf8, out Corvus.VercelBenchmark.Baseline.Schema.RequiredPathAndScheduleArray.RequiredPathAndSchedule.ScheduleEntity value))
                    {
                        return value;
                    }
            ...
            /// </returns>
            public static bool operator ==(in RequiredPathAndSchedule left, in RequiredPathAndSchedule right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RequiredPathAndSchedule left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(RequiredPathAndSchedule instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RequiredPathAndSchedule(JsonElement instance)
            {
                return RequiredPathAndSchedule.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredPathAndSchedule From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredPathAndSchedule ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredPathAndSchedule>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredPathAndSchedule ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredPathAndSchedule>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredPathAndSchedule ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredPathAndSchedule>(json, options);
            }
            ...
            /// </exception>
            public static RequiredPathAndSchedule ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RequiredPathAndSchedule>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredPathAndSchedule? result)
            {
                return JsonElementHelpers.TryParseValue<RequiredPathAndSchedule>(ref reader, out result);
            }
...
#if NET
            static RequiredPathAndSchedule IJsonElement<RequiredPathAndSchedule>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RequiredPathAndSchedule: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public RequiredPathAndSchedule Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public RequiredPathAndSchedule Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RequiredPathAndSchedule>(_idx);
                }
            ...
            public static class JsonPropertyNames
            {
                ...
                /// <summary>
                /// Gets the JSON property name for <see cref="Schedule"/>.
                /// </summary>
                ...
                /// Gets the JSON property name for <see cref="Schedule"/>.
                /// </summary>
                public static ReadOnlySpan<byte> ScheduleUtf8 => "schedule"u8;
            }
            ...
            private static class JsonPropertyNamesEscaped
            {
                ...
                /// <summary>
                /// Gets the escaped UTF-8 JSON property name for <see cref="Schedule"/>.
                /// </summary>
