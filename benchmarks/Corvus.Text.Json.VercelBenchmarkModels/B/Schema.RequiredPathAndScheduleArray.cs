...
public readonly partial struct Schema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RequiredPathAndScheduleArray"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal RequiredPathAndScheduleArray(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static RequiredPathAndScheduleArray DefaultInstance { get; }
        ...
        public Corvus.VercelBenchmark.Baseline.Schema.RequiredPathAndScheduleArray.RequiredPathAndSchedule this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.VercelBenchmark.Baseline.Schema.RequiredPathAndScheduleArray.RequiredPathAndSchedule>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.VercelBenchmark.Baseline.Schema.RequiredPathAndScheduleArray.RequiredPathAndSchedule> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.VercelBenchmark.Baseline.Schema.RequiredPathAndScheduleArray.RequiredPathAndSchedule>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in RequiredPathAndScheduleArray left, in RequiredPathAndScheduleArray right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in RequiredPathAndScheduleArray left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(RequiredPathAndScheduleArray instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator RequiredPathAndScheduleArray(JsonElement instance)
        {
            return RequiredPathAndScheduleArray.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiredPathAndScheduleArray From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiredPathAndScheduleArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RequiredPathAndScheduleArray>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiredPathAndScheduleArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RequiredPathAndScheduleArray>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiredPathAndScheduleArray ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RequiredPathAndScheduleArray>(json, options);
        }
        ...
        /// </exception>
        public static RequiredPathAndScheduleArray ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<RequiredPathAndScheduleArray>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredPathAndScheduleArray? result)
        {
            return JsonElementHelpers.TryParseValue<RequiredPathAndScheduleArray>(ref reader, out result);
        }
...
#if NET
        static RequiredPathAndScheduleArray IJsonElement<RequiredPathAndScheduleArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"RequiredPathAndScheduleArray: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// </para>
        /// </remarks>
        public RequiredPathAndScheduleArray Clone()
        {
            CheckValidInstance();
        ...
        /// </para>
        /// </remarks>
        public RequiredPathAndScheduleArray Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<RequiredPathAndScheduleArray>(_idx);
            }
