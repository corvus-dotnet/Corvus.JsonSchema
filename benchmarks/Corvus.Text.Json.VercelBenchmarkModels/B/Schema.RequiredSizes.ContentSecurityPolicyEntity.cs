...
public readonly partial struct Schema
{
    ...
    public readonly partial struct RequiredSizes
    {
...
#endif
        {
            ...
            internal ContentSecurityPolicyEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static ContentSecurityPolicyEntity DefaultInstance { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static explicit operator string(ContentSecurityPolicyEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in ContentSecurityPolicyEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(ContentSecurityPolicyEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ContentSecurityPolicyEntity(JsonElement instance)
            {
                return ContentSecurityPolicyEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ContentSecurityPolicyEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ContentSecurityPolicyEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ContentSecurityPolicyEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ContentSecurityPolicyEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ContentSecurityPolicyEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static ContentSecurityPolicyEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<ContentSecurityPolicyEntity>(json, options);
            }
            ...
            /// </exception>
            public static ContentSecurityPolicyEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<ContentSecurityPolicyEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out ContentSecurityPolicyEntity? result)
            {
                return JsonElementHelpers.TryParseValue<ContentSecurityPolicyEntity>(ref reader, out result);
            }
...
#if NET
            static ContentSecurityPolicyEntity IJsonElement<ContentSecurityPolicyEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"ContentSecurityPolicyEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public ContentSecurityPolicyEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public ContentSecurityPolicyEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<ContentSecurityPolicyEntity>(_idx);
                }
