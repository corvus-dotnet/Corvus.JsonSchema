        ...
        public readonly partial struct DomainsEntityArray
        {
            ...
            public readonly partial struct DomainsEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(DomainsEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="DomainsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator DomainsEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"DomainsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DomainsEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DomainsEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<DomainsEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(DomainsEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<DomainsEntity, Mutable>(this);
                }
            }
        }
    }
