...
public readonly partial struct Schema
{
    ...
    public readonly partial struct RequiredSizes
    {
...
#endif
        {
            ...
            public Corvus.VercelBenchmark.Baseline.Schema.RequiredSizes.DomainsEntityArray.DomainsEntity this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.VercelBenchmark.Baseline.Schema.RequiredSizes.DomainsEntityArray.DomainsEntity>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.VercelBenchmark.Baseline.Schema.RequiredSizes.DomainsEntityArray.DomainsEntity> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.VercelBenchmark.Baseline.Schema.RequiredSizes.DomainsEntityArray.DomainsEntity>(_parent, _idx);
            }
