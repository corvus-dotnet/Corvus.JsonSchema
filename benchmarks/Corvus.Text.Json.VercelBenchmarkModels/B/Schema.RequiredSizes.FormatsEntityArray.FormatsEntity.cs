    ...
    public readonly partial struct RequiredSizes
    {
        ...
        public readonly partial struct FormatsEntityArray
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="FormatsEntity"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal FormatsEntity(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static FormatsEntity DefaultInstance { get; }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static explicit operator string(FormatsEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                ...
                /// </returns>
                public static bool operator ==(in FormatsEntity left, in FormatsEntity right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in FormatsEntity left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator JsonElement(FormatsEntity instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator FormatsEntity(JsonElement instance)
                {
                    return FormatsEntity.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static FormatsEntity From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static FormatsEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<FormatsEntity>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static FormatsEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<FormatsEntity>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static FormatsEntity ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<FormatsEntity>(json, options);
                }
                ...
                /// </exception>
                public static FormatsEntity ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<FormatsEntity>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out FormatsEntity? result)
                {
                    return JsonElementHelpers.TryParseValue<FormatsEntity>(ref reader, out result);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new FormatsEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                static FormatsEntity IJsonElement<FormatsEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"FormatsEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="FormatsEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="FormatsEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public FormatsEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<FormatsEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="FormatsEntity"/> that lives for the lifetime of its
                ...
                /// <param name="matchImageAvif">Match 1st item.</param>
                /// <param name="matchImageWebp">Match 2nd item.</param>
                /// <param name="matchImageJpeg">Match 3rd item.</param>
                /// <param name="matchImagePng">Match 4th item.</param>
                /// <param name="defaultMatch">Match any other value.</param>
                /// <returns>An instance of the value returned by the match function.</returns>
                public TResult Match<TContext, TResult>(
                    in TContext context,
                    Func<TContext, TResult> matchImageAvif,
                    Func<TContext, TResult> matchImageWebp,
                    Func<TContext, TResult> matchImageJpeg,
                    Func<TContext, TResult> matchImagePng,
...
#endif
                {
                    ...
                    {
                        return matchImageAvif(context);
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchImageWebp(context);
                    }

                    if (this.ValueEquals(Constants.Enum3))
                    {
                        return matchImageJpeg(context);
                    }

                    if (this.ValueEquals(Constants.Enum4))
                    {
                        return matchImagePng(context);
                    }
                ...
                public TResult Match<TResult>(
                    Func<TResult> matchImageAvif,
                    Func<TResult> matchImageWebp,
                    Func<TResult> matchImageJpeg,
                    Func<TResult> matchImagePng,
                    Func<TResult> defaultMatch)
                {
                    if (this.ValueEquals(Constants.Enum1))
                    {
                        return matchImageAvif();
                    }

                    if (this.ValueEquals(Constants.Enum2))
                    {
                        return matchImageWebp();
                    }

                    if (this.ValueEquals(Constants.Enum3))
                    {
                        return matchImageJpeg();
                    }

                    if (this.ValueEquals(Constants.Enum4))
                    {
                        return matchImagePng();
                    }
