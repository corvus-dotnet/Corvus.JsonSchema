    ...
    public readonly partial struct RequiredSizes
    {
        ...
        public readonly partial struct JsonNumberArray
        {
...
#endif
            {
                ...
                public Corvus.VercelBenchmark.Baseline.JsonNumber.Mutable this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.VercelBenchmark.Baseline.JsonNumber.Mutable>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.VercelBenchmark.Baseline.JsonNumber.Mutable> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.VercelBenchmark.Baseline.JsonNumber.Mutable>(_parent, _idx);
                }
                ...
                public bool TryGetNumericValues(Span<double> items, out int written)
                {
                    CheckValidInstance();
                    written = 0;
                    foreach (Corvus.VercelBenchmark.Baseline.JsonNumber.Mutable item in EnumerateArray())
                    {
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetItem(int itemIndex, in Corvus.VercelBenchmark.Baseline.JsonNumber.Source value)
                {
                    CheckValidInstance();
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void InsertItem(int itemIndex, in Corvus.VercelBenchmark.Baseline.JsonNumber.Source value)
                {
                    CheckValidInstance();
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void AddItem(in Corvus.VercelBenchmark.Baseline.JsonNumber.Source value)
                {
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Remove(in Corvus.VercelBenchmark.Baseline.JsonNumber item)
                {
                    CheckValidInstance();
                    if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.VercelBenchmark.Baseline.JsonNumber>(this, in item))
                    {
                        return false;
                    }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void RemoveWhere(JsonPredicate<Corvus.VercelBenchmark.Baseline.JsonNumber> predicate)
                {
                    CheckValidInstance();
                    JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.VercelBenchmark.Baseline.JsonNumber>(this, predicate);
                    _documentVersion = _parent.Version;
                }
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Replace(in Corvus.VercelBenchmark.Baseline.JsonNumber oldItem, in Corvus.VercelBenchmark.Baseline.JsonNumber.Source newItem)
                {
                    CheckValidInstance();
                    ...
                    var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.VercelBenchmark.Baseline.JsonNumber>(_parent, _idx);

                    while (enumerator.MoveNext())
                    {
                        Corvus.VercelBenchmark.Baseline.JsonNumber current = enumerator.Current;
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.VercelBenchmark.Baseline.Schema.RequiredSizes.JsonNumberArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.VercelBenchmark.Baseline.Schema.RequiredSizes.JsonNumberArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
