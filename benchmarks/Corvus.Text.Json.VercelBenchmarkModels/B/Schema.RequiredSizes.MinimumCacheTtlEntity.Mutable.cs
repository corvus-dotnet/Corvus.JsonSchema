    ...
    public readonly partial struct RequiredSizes
    {
        ...
        public readonly partial struct MinimumCacheTtlEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(MinimumCacheTtlEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="MinimumCacheTtlEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator MinimumCacheTtlEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"MinimumCacheTtlEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly MinimumCacheTtlEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly MinimumCacheTtlEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<MinimumCacheTtlEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(MinimumCacheTtlEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<MinimumCacheTtlEntity, Mutable>(this);
            }
        }
    }
}
