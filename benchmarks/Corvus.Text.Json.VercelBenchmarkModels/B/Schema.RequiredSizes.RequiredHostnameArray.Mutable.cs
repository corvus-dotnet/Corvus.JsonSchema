    ...
    public readonly partial struct RequiredSizes
    {
        ...
        public readonly partial struct RequiredHostnameArray
        {
...
#endif
            {
                ...
                public Corvus.VercelBenchmark.Baseline.Schema.RequiredSizes.RequiredHostnameArray.RequiredHostname.Mutable this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.VercelBenchmark.Baseline.Schema.RequiredSizes.RequiredHostnameArray.RequiredHostname.Mutable>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.VercelBenchmark.Baseline.Schema.RequiredSizes.RequiredHostnameArray.RequiredHostname.Mutable> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.VercelBenchmark.Baseline.Schema.RequiredSizes.RequiredHostnameArray.RequiredHostname.Mutable>(_parent, _idx);
                }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetItem(int itemIndex, in Corvus.VercelBenchmark.Baseline.Schema.RequiredSizes.RequiredHostnameArray.RequiredHostname.Source value)
                {
                    CheckValidInstance();
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void InsertItem(int itemIndex, in Corvus.VercelBenchmark.Baseline.Schema.RequiredSizes.RequiredHostnameArray.RequiredHostname.Source value)
                {
                    CheckValidInstance();
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void AddItem(in Corvus.VercelBenchmark.Baseline.Schema.RequiredSizes.RequiredHostnameArray.RequiredHostname.Source value)
                {
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Remove(in Corvus.VercelBenchmark.Baseline.Schema.RequiredSizes.RequiredHostnameArray.RequiredHostname item)
                {
                    CheckValidInstance();
                    if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.VercelBenchmark.Baseline.Schema.RequiredSizes.RequiredHostnameArray.RequiredHostname>(this, in item))
                    {
                        return false;
                    }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void RemoveWhere(JsonPredicate<Corvus.VercelBenchmark.Baseline.Schema.RequiredSizes.RequiredHostnameArray.RequiredHostname> predicate)
                {
                    CheckValidInstance();
                    JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.VercelBenchmark.Baseline.Schema.RequiredSizes.RequiredHostnameArray.RequiredHostname>(this, predicate);
                    _documentVersion = _parent.Version;
                }
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Replace(in Corvus.VercelBenchmark.Baseline.Schema.RequiredSizes.RequiredHostnameArray.RequiredHostname oldItem, in Corvus.VercelBenchmark.Baseline.Schema.RequiredSizes.RequiredHostnameArray.RequiredHostname.Source newItem)
                {
                    CheckValidInstance();
                    ...
                    var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.VercelBenchmark.Baseline.Schema.RequiredSizes.RequiredHostnameArray.RequiredHostname>(_parent, _idx);

                    while (enumerator.MoveNext())
                    {
                        Corvus.VercelBenchmark.Baseline.Schema.RequiredSizes.RequiredHostnameArray.RequiredHostname current = enumerator.Current;
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.VercelBenchmark.Baseline.Schema.RequiredSizes.RequiredHostnameArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.VercelBenchmark.Baseline.Schema.RequiredSizes.RequiredHostnameArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
