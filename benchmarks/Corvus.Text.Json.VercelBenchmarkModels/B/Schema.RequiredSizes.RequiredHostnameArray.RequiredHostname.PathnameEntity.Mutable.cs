            ...
            public readonly partial struct RequiredHostname
            {
                ...
                public readonly partial struct PathnameEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(PathnameEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="PathnameEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator PathnameEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"PathnameEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly PathnameEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly PathnameEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<PathnameEntity>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(PathnameEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<PathnameEntity, Mutable>(this);
                    }
                }
            }
        }
