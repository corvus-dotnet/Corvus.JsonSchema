...
public readonly partial struct Schema
{
    ...
    public readonly partial struct RequiredSizes
    {
        ...
        public readonly partial struct RequiredHostnameArray
            ...
            : IJsonElement<RequiredHostnameArray>,
              IFormattable,
              ISpanFormattable,
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="RequiredHostnameArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal RequiredHostnameArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static RequiredHostnameArray DefaultInstance { get; }
            ...
            public Corvus.VercelBenchmark.Baseline.Schema.RequiredSizes.RequiredHostnameArray.RequiredHostname this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.VercelBenchmark.Baseline.Schema.RequiredSizes.RequiredHostnameArray.RequiredHostname>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.VercelBenchmark.Baseline.Schema.RequiredSizes.RequiredHostnameArray.RequiredHostname> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.VercelBenchmark.Baseline.Schema.RequiredSizes.RequiredHostnameArray.RequiredHostname>(_parent, _idx);
            }
            ...
            /// </returns>
            public static bool operator ==(in RequiredHostnameArray left, in RequiredHostnameArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in RequiredHostnameArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(RequiredHostnameArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator RequiredHostnameArray(JsonElement instance)
            {
                return RequiredHostnameArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredHostnameArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredHostnameArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredHostnameArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredHostnameArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredHostnameArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static RequiredHostnameArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<RequiredHostnameArray>(json, options);
            }
            ...
            /// </exception>
            public static RequiredHostnameArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<RequiredHostnameArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredHostnameArray? result)
            {
                return JsonElementHelpers.TryParseValue<RequiredHostnameArray>(ref reader, out result);
            }
...
#if NET
            static RequiredHostnameArray IJsonElement<RequiredHostnameArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"RequiredHostnameArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public RequiredHostnameArray Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public RequiredHostnameArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<RequiredHostnameArray>(_idx);
                }
