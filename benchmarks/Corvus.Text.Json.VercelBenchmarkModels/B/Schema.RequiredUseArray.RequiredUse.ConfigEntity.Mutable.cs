        ...
        public readonly partial struct RequiredUse
        {
            ...
            public readonly partial struct ConfigEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(ConfigEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ConfigEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ConfigEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ConfigEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ConfigEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ConfigEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ConfigEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.VercelBenchmark.Baseline.Schema.RequiredUseArray.RequiredUse.ConfigEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                    public static implicit operator Source(ConfigEntity instance) => new(JsonElement.From(instance));
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.VercelBenchmark.Baseline.Schema.RequiredUseArray.RequiredUse.ConfigEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                {
                    return workspace.CreateBuilder<ConfigEntity, Mutable>(this);
                }
            }
        }
    }
