    ...
    public readonly partial struct RequiredUseArray
    {
        ...
        public readonly partial struct RequiredUse
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.VercelBenchmark.Baseline.Schema.RequiredUseArray.RequiredUse.ConfigEntity.Mutable Config
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ConfigUtf8, out Corvus.VercelBenchmark.Baseline.Schema.RequiredUseArray.RequiredUse.ConfigEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.VercelBenchmark.Baseline.Schema.RequiredUseArray.RequiredUse.SrcEntity.Mutable Src
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SrcUtf8, out Corvus.VercelBenchmark.Baseline.Schema.RequiredUseArray.RequiredUse.SrcEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.VercelBenchmark.Baseline.Schema.RequiredUseArray.RequiredUse.UseEntity.Mutable Use
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UseUtf8, out Corvus.VercelBenchmark.Baseline.Schema.RequiredUseArray.RequiredUse.UseEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetConfig(in Corvus.VercelBenchmark.Baseline.Schema.RequiredUseArray.RequiredUse.ConfigEntity.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetConfig<TContext>(in Corvus.VercelBenchmark.Baseline.Schema.RequiredUseArray.RequiredUse.ConfigEntity.Source<TContext> value)
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetSrc(in Corvus.VercelBenchmark.Baseline.Schema.RequiredUseArray.RequiredUse.SrcEntity.Source value)
                {
                    CheckValidInstance();
                ...
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetUse(in Corvus.VercelBenchmark.Baseline.Schema.RequiredUseArray.RequiredUse.UseEntity.Source value)
                {
                    CheckValidInstance();
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.VercelBenchmark.Baseline.Schema.RequiredUseArray.RequiredUse.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.VercelBenchmark.Baseline.Schema.RequiredUseArray.RequiredUse.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.VercelBenchmark.Baseline.Schema.RequiredUseArray.RequiredUse.UseEntity.Source use,
                    in Corvus.VercelBenchmark.Baseline.Schema.RequiredUseArray.RequiredUse.ConfigEntity.Source config = default,
                    in Corvus.VercelBenchmark.Baseline.Schema.RequiredUseArray.RequiredUse.SrcEntity.Source src = default)
                {
                ...
                internal static void Create<TContext>(
                    ...
                    ref ComplexValueBuilder builder,
                    in Corvus.VercelBenchmark.Baseline.Schema.RequiredUseArray.RequiredUse.UseEntity.Source use,
                    in Corvus.VercelBenchmark.Baseline.Schema.RequiredUseArray.RequiredUse.ConfigEntity.Source<TContext> config = default,
                    in Corvus.VercelBenchmark.Baseline.Schema.RequiredUseArray.RequiredUse.SrcEntity.Source src = default)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.VercelBenchmark.Baseline.Schema.RequiredUseArray.RequiredUse.UseEntity.Source use, in Corvus.VercelBenchmark.Baseline.Schema.RequiredUseArray.RequiredUse.ConfigEntity.Source config = default, in Corvus.VercelBenchmark.Baseline.Schema.RequiredUseArray.RequiredUse.SrcEntity.Source src = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.VercelBenchmark.Baseline.Schema.RequiredUseArray.RequiredUse.UseEntity.Source use, in Corvus.VercelBenchmark.Baseline.Schema.RequiredUseArray.RequiredUse.ConfigEntity.Source<TContext> config = default, in Corvus.VercelBenchmark.Baseline.Schema.RequiredUseArray.RequiredUse.SrcEntity.Source src = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
