        ...
        public readonly partial struct RoutesEntity
        {
            ...
            public readonly partial struct RequiredHandle
            {
...
#endif
                {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.VercelBenchmark.Baseline.Schema.RoutesEntityArray.RoutesEntity.RequiredHandle.HandleEntity.Mutable Handle
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HandleUtf8, out Corvus.VercelBenchmark.Baseline.Schema.RoutesEntityArray.RoutesEntity.RequiredHandle.HandleEntity.Mutable value))
                            {
                                return value;
                            }
                    ...
                    public void SetHandle(in Corvus.VercelBenchmark.Baseline.Schema.RoutesEntityArray.RoutesEntity.RequiredHandle.HandleEntity.Source value)
                    {
                        CheckValidInstance();
                        ...
                        else
                        {
                            ...
                            value.AddAsProperty(JsonPropertyNamesEscaped.Handle, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                ...
                public ref struct Source
                {
                    ...
                    internal Source(Corvus.VercelBenchmark.Baseline.Schema.RoutesEntityArray.RoutesEntity.RequiredHandle.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.VercelBenchmark.Baseline.Schema.RoutesEntityArray.RoutesEntity.RequiredHandle.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    /// </summary>
                    internal static void Create(ref ComplexValueBuilder builder, in Corvus.VercelBenchmark.Baseline.Schema.RoutesEntityArray.RoutesEntity.RequiredHandle.HandleEntity.Source handle)
                    {
                        handle.AddAsProperty(JsonPropertyNamesEscaped.Handle, ref builder, escapeName: false);
                    }

                    /// <summary>
                    /// Creates an instance of a <see cref="RequiredHandle"/>.
                    /// </summary>
                    public void Create(in Corvus.VercelBenchmark.Baseline.Schema.RoutesEntityArray.RoutesEntity.RequiredHandle.HandleEntity.Source handle)
                    {
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.VercelBenchmark.Baseline.Schema.RoutesEntityArray.RoutesEntity.RequiredHandle.HandleEntity.Source handle, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
