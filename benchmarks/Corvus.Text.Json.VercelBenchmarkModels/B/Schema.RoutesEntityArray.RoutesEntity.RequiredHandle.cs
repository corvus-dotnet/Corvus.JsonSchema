    ...
    public readonly partial struct RoutesEntityArray
    {
        ...
        public readonly partial struct RoutesEntity
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.VercelBenchmark.Baseline.Schema.RoutesEntityArray.RoutesEntity.RequiredHandle.HandleEntity Handle
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HandleUtf8, out Corvus.VercelBenchmark.Baseline.Schema.RoutesEntityArray.RoutesEntity.RequiredHandle.HandleEntity value))
                        {
                            return value;
                        }
