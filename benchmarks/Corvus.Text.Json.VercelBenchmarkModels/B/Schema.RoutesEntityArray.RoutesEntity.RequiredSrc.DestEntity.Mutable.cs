            ...
            public readonly partial struct RequiredSrc
            {
                ...
                public readonly partial struct DestEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(DestEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="DestEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator DestEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"DestEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly DestEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly DestEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<DestEntity>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(DestEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<DestEntity, Mutable>(this);
                    }
                }
            }
        }
