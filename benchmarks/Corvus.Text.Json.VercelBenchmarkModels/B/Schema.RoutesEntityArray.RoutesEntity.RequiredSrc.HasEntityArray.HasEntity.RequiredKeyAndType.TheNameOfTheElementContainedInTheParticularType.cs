                ...
                public readonly partial struct HasEntityArray
                {
                    ...
                    public readonly partial struct HasEntity
                    {
                        ...
                        public readonly partial struct RequiredKeyAndType
                        {
                            ...
                            public readonly partial struct TheNameOfTheElementContainedInTheParticularType
#if NET8_0_OR_GREATER
                                : IJsonElement<TheNameOfTheElementContainedInTheParticularType>,
                                  IFormattable,
                                  ISpanFormattable,
...
#endif
                            {
                                ...
                                /// <summary>
                                /// Initializes a new instance of the <see cref="TheNameOfTheElementContainedInTheParticularType"/> struct.
                                /// </summary>
                                /// <param name="value">The value from which to construct the instance.</param>
                                internal TheNameOfTheElementContainedInTheParticularType(IJsonDocument parent, int idx)
                                {
                                    Debug.Assert(idx >= 0);
                                    _parent = parent;
                                    _idx = idx;
                                ...
                                /// </summary>
                                public static TheNameOfTheElementContainedInTheParticularType DefaultInstance { get; }
                                ...
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static explicit operator string(TheNameOfTheElementContainedInTheParticularType value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                                ...
                                /// </returns>
                                public static bool operator ==(in TheNameOfTheElementContainedInTheParticularType left, in TheNameOfTheElementContainedInTheParticularType right)
                                {
                                ...
                                /// <c>True</c> if the values are equal.
                                /// </returns>
                                public static bool operator ==(in TheNameOfTheElementContainedInTheParticularType left, in JsonElement right)
                                {
                                    return left.Equals(right);
                                }
                                ...
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static implicit operator JsonElement(TheNameOfTheElementContainedInTheParticularType instance)
                                {
                                ...
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static implicit operator TheNameOfTheElementContainedInTheParticularType(JsonElement instance)
                                {
                                    return TheNameOfTheElementContainedInTheParticularType.From(instance);
                                }
                                ...
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static TheNameOfTheElementContainedInTheParticularType From<T>(in T instance)
                                ...
                                /// </exception>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static TheNameOfTheElementContainedInTheParticularType ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                                {
                                    return JsonElementHelpers.ParseValue<TheNameOfTheElementContainedInTheParticularType>(utf8Json, options);
                                }
                                ...
                                /// </exception>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static TheNameOfTheElementContainedInTheParticularType ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                                {
                                    return JsonElementHelpers.ParseValue<TheNameOfTheElementContainedInTheParticularType>(json, options);
                                }
                                ...
                                /// </exception>
                                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                public static TheNameOfTheElementContainedInTheParticularType ParseValue(string json, JsonDocumentOptions options = default)
                                {
                                    return JsonElementHelpers.ParseValue<TheNameOfTheElementContainedInTheParticularType>(json, options);
                                }
                                ...
                                /// </exception>
                                public static TheNameOfTheElementContainedInTheParticularType ParseValue(ref Utf8JsonReader reader)
                                {
                                    return JsonElementHelpers.ParseValue<TheNameOfTheElementContainedInTheParticularType>(ref reader);
                                }
                                ...
                                ///   A value could not be read from the reader.
                                /// </exception>
                                public static bool TryParseValue(ref Utf8JsonReader reader, out TheNameOfTheElementContainedInTheParticularType? result)
                                {
                                    return JsonElementHelpers.TryParseValue<TheNameOfTheElementContainedInTheParticularType>(ref reader, out result);
                                }
                                ...
                                {
                                    return
                                        (obj is IJsonElement value && Equals(new TheNameOfTheElementContainedInTheParticularType(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                                static TheNameOfTheElementContainedInTheParticularType IJsonElement<TheNameOfTheElementContainedInTheParticularType>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                private string DebuggerDisplay => $"TheNameOfTheElementContainedInTheParticularType: ValueKind = {ValueKind} : \"{ToString()}\"";
                                ...
                                /// </para>
                                /// </remarks>
                                public TheNameOfTheElementContainedInTheParticularType Clone()
                                {
                                    CheckValidInstance();
                                ...
                                /// </para>
                                /// </remarks>
                                public TheNameOfTheElementContainedInTheParticularType Freeze()
                                {
                                    CheckValidInstance();
                                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                                    {
                                        return mutable.FreezeElement<TheNameOfTheElementContainedInTheParticularType>(_idx);
                                    }
