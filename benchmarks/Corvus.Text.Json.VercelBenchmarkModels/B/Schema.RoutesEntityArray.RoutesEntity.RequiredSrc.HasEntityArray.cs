        ...
        public readonly partial struct RoutesEntity
        {
            ...
            public readonly partial struct RequiredSrc
            {
...
#endif
                {
                    ...
                    public Corvus.VercelBenchmark.Baseline.Schema.RoutesEntityArray.RoutesEntity.RequiredSrc.HasEntityArray.HasEntity this[int index]
                    {
                        get
                        {
                            CheckValidInstance();
                            return _parent.GetArrayIndexElement<Corvus.VercelBenchmark.Baseline.Schema.RoutesEntityArray.RoutesEntity.RequiredSrc.HasEntityArray.HasEntity>(_idx, index);
                        }
                    }
                    ...
                    /// </summary>
                    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                    public ArrayEnumerator<Corvus.VercelBenchmark.Baseline.Schema.RoutesEntityArray.RoutesEntity.RequiredSrc.HasEntityArray.HasEntity> EnumerateArray()
                    {
                        CheckValidInstance();
                        return EnumeratorCreator.CreateArrayEnumerator<Corvus.VercelBenchmark.Baseline.Schema.RoutesEntityArray.RoutesEntity.RequiredSrc.HasEntityArray.HasEntity>(_parent, _idx);
                    }
