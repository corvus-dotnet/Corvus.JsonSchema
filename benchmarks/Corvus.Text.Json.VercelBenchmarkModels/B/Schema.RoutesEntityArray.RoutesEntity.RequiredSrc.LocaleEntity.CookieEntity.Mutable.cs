        ...
        public readonly partial struct RoutesEntity
        {
            ...
            public readonly partial struct RequiredSrc
            {
                ...
                public readonly partial struct LocaleEntity
                {
                    ...
                    public readonly partial struct CookieEntity
                    {
...
#endif
                        {
                            ...
                            public static explicit operator Mutable(CookieEntity instance)
                            {
                            ...
                            /// <returns>An immutable instance of a <see cref="CookieEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                            [MethodImpl(MethodImplOptions.AggressiveInlining)]
                            public static implicit operator CookieEntity(Mutable instance)
                            {
                            ...
                            {
                                return
                                    (obj is IJsonElement value && Equals(new CookieEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                            ...
                            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                            private string DebuggerDisplay => $"CookieEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                            ...
                            /// <summary>
                            /// Gets a <see cref="CookieEntity"/> which can be safely stored beyond the lifetime of the
                            /// original document.
                            /// </summary>
                            /// <returns>
                            /// A <see cref="CookieEntity"/> which can be safely stored beyond the lifetime of the
                            /// original document.
                            /// </returns>
                            /// <remarks>
                            /// <para>
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly CookieEntity Clone()
                            {
                                CheckValidInstance();
                                return _parent.CloneElement<CookieEntity>(_idx);
                            }
                            ...
                            /// </summary>
                            /// <returns>
                            /// An immutable <see cref="CookieEntity"/> that lives for the lifetime of its
                            ...
                            /// </para>
                            /// </remarks>
                            public readonly CookieEntity Freeze()
                            {
                                CheckValidInstance();
                                return _parent.FreezeElement<CookieEntity>(_idx);
                            }
                        }
                        ...
                        public ref struct Source
                        {
                            ...
                            public static implicit operator Source(CookieEntity instance) => new(JsonElement.From(instance));
                        ...
                        {
                            return workspace.CreateBuilder<CookieEntity, Mutable>(this);
                        }
                    }
                }
            }
