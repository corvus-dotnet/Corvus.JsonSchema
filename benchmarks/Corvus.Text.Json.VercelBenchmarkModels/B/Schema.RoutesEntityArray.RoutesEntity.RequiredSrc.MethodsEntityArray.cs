        ...
        public readonly partial struct RoutesEntity
        {
            ...
            public readonly partial struct RequiredSrc
            {
...
#endif
                {
                    ...
                    public Corvus.VercelBenchmark.Baseline.Schema.RoutesEntityArray.RoutesEntity.RequiredSrc.MethodsEntityArray.MethodsEntity this[int index]
                    {
                        get
                        {
                            CheckValidInstance();
                            return _parent.GetArrayIndexElement<Corvus.VercelBenchmark.Baseline.Schema.RoutesEntityArray.RoutesEntity.RequiredSrc.MethodsEntityArray.MethodsEntity>(_idx, index);
                        }
                    }
                    ...
                    /// </summary>
                    /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                    public ArrayEnumerator<Corvus.VercelBenchmark.Baseline.Schema.RoutesEntityArray.RoutesEntity.RequiredSrc.MethodsEntityArray.MethodsEntity> EnumerateArray()
                    {
                        CheckValidInstance();
                        return EnumeratorCreator.CreateArrayEnumerator<Corvus.VercelBenchmark.Baseline.Schema.RoutesEntityArray.RoutesEntity.RequiredSrc.MethodsEntityArray.MethodsEntity>(_parent, _idx);
                    }
