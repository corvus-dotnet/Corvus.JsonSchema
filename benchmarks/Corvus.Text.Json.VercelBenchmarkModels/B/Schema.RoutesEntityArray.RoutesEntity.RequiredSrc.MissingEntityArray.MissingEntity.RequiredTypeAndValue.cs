                ...
                public readonly partial struct MissingEntityArray
                {
                    ...
                    public readonly partial struct MissingEntity
                    {
...
#endif
                        {
                            ...
                            /// </para>
                            /// </remarks>
                            public Corvus.VercelBenchmark.Baseline.Schema.RoutesEntityArray.RoutesEntity.RequiredSrc.MissingEntityArray.MissingEntity.RequiredTypeAndValue.TheTypeOfRequestElementToCheck Type
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.VercelBenchmark.Baseline.Schema.RoutesEntityArray.RoutesEntity.RequiredSrc.MissingEntityArray.MissingEntity.RequiredTypeAndValue.TheTypeOfRequestElementToCheck value))
                                    {
                                        return value;
                                    }
                            ...
                            /// </para>
                            /// </remarks>
                            public Corvus.VercelBenchmark.Baseline.Schema.RoutesEntityArray.RoutesEntity.RequiredSrc.MissingEntityArray.MissingEntity.RequiredTypeAndValue.ValueEntity Value
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ValueUtf8, out Corvus.VercelBenchmark.Baseline.Schema.RoutesEntityArray.RoutesEntity.RequiredSrc.MissingEntityArray.MissingEntity.RequiredTypeAndValue.ValueEntity value))
                                    {
                                        return value;
                                    }
