            ...
            public readonly partial struct RequiredSrc
            {
                ...
                public readonly partial struct SrcEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(SrcEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="SrcEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator SrcEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"SrcEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly SrcEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly SrcEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<SrcEntity>(_idx);
                        }
                    }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(SrcEntity instance) => new(JsonElement.From(instance));
                    ...
                    {
                        return workspace.CreateBuilder<SrcEntity, Mutable>(this);
                    }
                }
            }
        }
