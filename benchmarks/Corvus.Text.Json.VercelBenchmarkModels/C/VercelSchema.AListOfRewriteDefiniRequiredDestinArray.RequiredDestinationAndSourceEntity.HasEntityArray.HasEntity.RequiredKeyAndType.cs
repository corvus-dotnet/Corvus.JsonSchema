            ...
            public readonly partial struct HasEntityArray
            {
                ...
                public readonly partial struct HasEntity
                {
...
#endif
                    {
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.VercelBenchmark.Current.VercelSchema.AListOfRewriteDefiniRequiredDestinArray.RequiredDestinationAndSourceEntity.HasEntityArray.HasEntity.RequiredKeyAndType.TheNameOfTheElementContainedInTheParticularType Key
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.KeyUtf8, out Corvus.VercelBenchmark.Current.VercelSchema.AListOfRewriteDefiniRequiredDestinArray.RequiredDestinationAndSourceEntity.HasEntityArray.HasEntity.RequiredKeyAndType.TheNameOfTheElementContainedInTheParticularType value))
                                {
                                    return value;
                                }
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.VercelBenchmark.Current.VercelSchema.AListOfRewriteDefiniRequiredDestinArray.RequiredDestinationAndSourceEntity.HasEntityArray.HasEntity.RequiredKeyAndType.TheTypeOfRequestElementToCheck Type
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.VercelBenchmark.Current.VercelSchema.AListOfRewriteDefiniRequiredDestinArray.RequiredDestinationAndSourceEntity.HasEntityArray.HasEntity.RequiredKeyAndType.TheTypeOfRequestElementToCheck value))
                                {
                                    return value;
                                }
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.VercelBenchmark.Current.VercelSchema.AListOfRewriteDefiniRequiredDestinArray.RequiredDestinationAndSourceEntity.HasEntityArray.HasEntity.RequiredKeyAndType.ValueEntity Value
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ValueUtf8, out Corvus.VercelBenchmark.Current.VercelSchema.AListOfRewriteDefiniRequiredDestinArray.RequiredDestinationAndSourceEntity.HasEntityArray.HasEntity.RequiredKeyAndType.ValueEntity value))
                                {
                                    return value;
                                }
