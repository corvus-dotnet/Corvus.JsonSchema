                ...
                public readonly partial struct HasEntity
                {
                    ...
                    public readonly partial struct RequiredTypeAndValue
                    {
...
#endif
                        {
                            ...
                            public void SetType(in Corvus.VercelBenchmark.Current.VercelSchema.AListOfRewriteDefiniRequiredDestinArray.RequiredDestinationAndSourceEntity.HasEntityArray.HasEntity.RequiredTypeAndValue.TheTypeOfRequestElementToCheck.Source value)
                            {
                                CheckValidInstance();
                            ...
                            /// </summary>
                            /// <param name="value">The value of the property to add.</param>
                            public void SetValue(in Corvus.VercelBenchmark.Current.VercelSchema.AListOfRewriteDefiniRequiredDestinArray.RequiredDestinationAndSourceEntity.HasEntityArray.HasEntity.RequiredTypeAndValue.ValueEntity.Source value)
                            {
                                CheckValidInstance();
                        ...
                        public ref struct Source
                        {
                            ...
                            internal Source(in Corvus.VercelBenchmark.Current.VercelSchema.AListOfRewriteDefiniRequiredDestinArray.RequiredDestinationAndSourceEntity.HasEntityArray.HasEntity.RequiredTypeAndValue.ValueEntity.Source arg1)
                            {
                                _createArg1 = arg1;
                                _kind = Kind.Create;
                            }
                        ...
                        public ref struct Builder
                        {
                            ...
                            internal static void BuildCreateValue(in Corvus.VercelBenchmark.Current.VercelSchema.AListOfRewriteDefiniRequiredDestinArray.RequiredDestinationAndSourceEntity.HasEntityArray.HasEntity.RequiredTypeAndValue.ValueEntity.Source arg1, ref ComplexValueBuilder o)
                            {
                                o.StartObject();
                                Create(ref o, arg1);
                                o.EndObject();
                        ...
                        /// <returns>The source from which to build the value.</returns>
                        public static Source Build(in Corvus.VercelBenchmark.Current.VercelSchema.AListOfRewriteDefiniRequiredDestinArray.RequiredDestinationAndSourceEntity.HasEntityArray.HasEntity.RequiredTypeAndValue.ValueEntity.Source value)
                        {
