...
public readonly partial struct VercelSchema
{
    ...
    public readonly partial struct AliasEntity
    {
...
#endif
        {
            ...
            public static explicit operator Corvus.VercelBenchmark.Current.VercelSchema.AliasEntity.OneOf1Array.Mutable(Mutable value)
            {
                return Corvus.VercelBenchmark.Current.VercelSchema.AliasEntity.OneOf1Array.Mutable.From(value);
            }
            ...
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator Mutable(Corvus.VercelBenchmark.Current.VercelSchema.AliasEntity.OneOf1Array.Mutable value)
            {
                return From(value);
            }
            ...
            public TResult Match<TContext, TResult>(
                ...
                Matcher<Corvus.VercelBenchmark.Current.VercelSchema.AliasEntity.Mutable, TContext, TResult> defaultMatch)
#if NET9_0_OR_GREATER
            where TContext : allows ref struct
#endif
            {
                ...
                {
                    return matchJsonString(Corvus.VercelBenchmark.Current.JsonString.Mutable.From(this), context);
                }

                if (Corvus.VercelBenchmark.Current.VercelSchema.AliasEntity.OneOf1Array.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchOneOf1Array(Corvus.VercelBenchmark.Current.VercelSchema.AliasEntity.OneOf1Array.Mutable.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                ...
                Matcher<Corvus.VercelBenchmark.Current.VercelSchema.AliasEntity.Mutable, TResult> defaultMatch)
            {
                if (Corvus.VercelBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonString(Corvus.VercelBenchmark.Current.JsonString.Mutable.From(this));
                }

                if (Corvus.VercelBenchmark.Current.VercelSchema.AliasEntity.OneOf1Array.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchOneOf1Array(Corvus.VercelBenchmark.Current.VercelSchema.AliasEntity.OneOf1Array.Mutable.From(this));
                }
            ...
            public bool TryGetAsJsonString(out Corvus.VercelBenchmark.Current.JsonString.Mutable result)
            {
                if (Corvus.VercelBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.VercelBenchmark.Current.JsonString.Mutable.From(this);
                    return true;
                }
            ...
            public bool TryGetAsOneOf1Array(out Corvus.VercelBenchmark.Current.VercelSchema.AliasEntity.OneOf1Array.Mutable result)
            {
                if (Corvus.VercelBenchmark.Current.VercelSchema.AliasEntity.OneOf1Array.JsonSchema.Evaluate(_parent, _idx))
                {
                    result = Corvus.VercelBenchmark.Current.VercelSchema.AliasEntity.OneOf1Array.Mutable.From(this);
                    return true;
                }
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.VercelBenchmark.Current.VercelSchema.AliasEntity.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator Source(Corvus.VercelBenchmark.Current.JsonString instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.VercelBenchmark.Current.VercelSchema.AliasEntity.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        public static ParsedJsonDocument<AliasEntity> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<AliasEntity>();
            }
            finally
            {
