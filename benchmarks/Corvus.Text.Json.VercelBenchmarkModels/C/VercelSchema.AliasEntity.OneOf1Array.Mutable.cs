...
public readonly partial struct VercelSchema
{
    ...
    /// </para>
    /// </remarks>
    public readonly partial struct AliasEntity
    {
        /// <summary>
        /// Generated from JSON Schema.
        /// </summary>
        [DebuggerDisplay("{DebuggerDisplay,nq}")]
        public readonly partial struct OneOf1Array
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(OneOf1Array instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="OneOf1Array"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator OneOf1Array(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new OneOf1Array(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"OneOf1Array.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// <summary>
                /// Gets a <see cref="OneOf1Array"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="OneOf1Array"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly OneOf1Array Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<OneOf1Array>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="OneOf1Array"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly OneOf1Array Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<OneOf1Array>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.VercelBenchmark.Current.VercelSchema.AliasEntity.OneOf1Array.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(OneOf1Array instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.VercelBenchmark.Current.VercelSchema.AliasEntity.OneOf1Array.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            {
                return workspace.CreateBuilder<OneOf1Array, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<OneOf1Array> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<OneOf1Array>();
                }
                finally
                {
