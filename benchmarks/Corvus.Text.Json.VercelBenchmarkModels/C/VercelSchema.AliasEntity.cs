...
public readonly partial struct VercelSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AliasEntity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal AliasEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static AliasEntity DefaultInstance { get; }
        ...
        /// <summary>
        /// Conversion to <see cref="Corvus.VercelBenchmark.Current.VercelSchema.AliasEntity.OneOf1Array"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static explicit operator Corvus.VercelBenchmark.Current.VercelSchema.AliasEntity.OneOf1Array(AliasEntity value)
        {
            return Corvus.VercelBenchmark.Current.VercelSchema.AliasEntity.OneOf1Array.From(value);
        }

        /// <summary>
        /// Conversion from <see cref="Corvus.VercelBenchmark.Current.VercelSchema.AliasEntity.OneOf1Array"/>.
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator AliasEntity(Corvus.VercelBenchmark.Current.VercelSchema.AliasEntity.OneOf1Array value)
        {
            return From(value);
        }
        ...
        /// </returns>
        public static bool operator ==(in AliasEntity left, in AliasEntity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in AliasEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator JsonElement(AliasEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator AliasEntity(JsonElement instance)
        {
            return AliasEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AliasEntity From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AliasEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AliasEntity>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AliasEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AliasEntity>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AliasEntity ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<AliasEntity>(json, options);
        }
        ...
        /// </exception>
        public static AliasEntity ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<AliasEntity>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out AliasEntity? result)
        {
            return JsonElementHelpers.TryParseValue<AliasEntity>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new AliasEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static AliasEntity IJsonElement<AliasEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"AliasEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="AliasEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="AliasEntity"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public AliasEntity Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<AliasEntity>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="AliasEntity"/> that lives for the lifetime of its
        ...
        public bool TryGetAsJsonString(out Corvus.VercelBenchmark.Current.JsonString result)
        {
            ...
            {
                result = Corvus.VercelBenchmark.Current.JsonString.From(this);
                return true;
            }
        ...
        public bool TryGetAsOneOf1Array(out Corvus.VercelBenchmark.Current.VercelSchema.AliasEntity.OneOf1Array result)
        {
            ...
            {
                result = Corvus.VercelBenchmark.Current.VercelSchema.AliasEntity.OneOf1Array.From(this);
                return true;
            }
        ...
        /// <param name="matchJsonString">Match a <see cref="Corvus.VercelBenchmark.Current.JsonString"/>.</param>
        /// <param name="matchOneOf1Array">Match a <see cref="Corvus.VercelBenchmark.Current.VercelSchema.AliasEntity.OneOf1Array"/>.</param>
        /// <param name="defaultMatch">Match any other value.</param>
        /// <returns>An instance of the value returned by the match function.</returns>
        public TResult Match<TContext, TResult>(
            in TContext context,
            Matcher<Corvus.VercelBenchmark.Current.JsonString, TContext, TResult> matchJsonString,
            Matcher<Corvus.VercelBenchmark.Current.VercelSchema.AliasEntity.OneOf1Array, TContext, TResult> matchOneOf1Array,
            Matcher<Corvus.VercelBenchmark.Current.VercelSchema.AliasEntity, TContext, TResult> defaultMatch)
...
#endif
        {
            if (Corvus.VercelBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchJsonString(Corvus.VercelBenchmark.Current.JsonString.From(this), context);
            }

            if (Corvus.VercelBenchmark.Current.VercelSchema.AliasEntity.OneOf1Array.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchOneOf1Array(Corvus.VercelBenchmark.Current.VercelSchema.AliasEntity.OneOf1Array.From(this), context);
            }
        ...
        public TResult Match<TResult>(
            Matcher<Corvus.VercelBenchmark.Current.JsonString, TResult> matchJsonString,
            Matcher<Corvus.VercelBenchmark.Current.VercelSchema.AliasEntity.OneOf1Array, TResult> matchOneOf1Array,
            Matcher<Corvus.VercelBenchmark.Current.VercelSchema.AliasEntity, TResult> defaultMatch)
        {
            if (Corvus.VercelBenchmark.Current.JsonString.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchJsonString(Corvus.VercelBenchmark.Current.JsonString.From(this));
            }

            if (Corvus.VercelBenchmark.Current.VercelSchema.AliasEntity.OneOf1Array.JsonSchema.Evaluate(_parent, _idx))
            {
                return matchOneOf1Array(Corvus.VercelBenchmark.Current.VercelSchema.AliasEntity.OneOf1Array.From(this));
            }
