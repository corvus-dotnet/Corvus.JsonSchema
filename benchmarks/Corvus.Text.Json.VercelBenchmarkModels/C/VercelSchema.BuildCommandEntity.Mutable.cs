...
public readonly partial struct VercelSchema
{
    ...
    public readonly partial struct BuildCommandEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(BuildCommandEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="BuildCommandEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator BuildCommandEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"BuildCommandEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly BuildCommandEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly BuildCommandEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<BuildCommandEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(BuildCommandEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<BuildCommandEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<BuildCommandEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<BuildCommandEntity>();
            }
            finally
            {
