...
public readonly partial struct VercelSchema
{
    ...
    public readonly partial struct BuildEntity
    {
...
#endif
        {
            ...
            public bool TryGetProperty(ReadOnlySpan<byte> propertyName, out Corvus.VercelBenchmark.Current.VercelSchema.BuildEntity.EnvEntity.Entity value)
            {
                CheckValidInstance();
            ...
            /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public bool TryGetProperty(ReadOnlySpan<char> propertyName, out Corvus.VercelBenchmark.Current.VercelSchema.BuildEntity.EnvEntity.Entity value)
            {
                CheckValidInstance();
                return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
            }
            ...
            /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public bool TryGetProperty(string propertyName, out Corvus.VercelBenchmark.Current.VercelSchema.BuildEntity.EnvEntity.Entity value)
            {
                CheckValidInstance();
                return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
            }
            ...
            /// <see cref="Corvus.VercelBenchmark.Current.VercelSchema.BuildEntity.EnvEntity.Entity"/>.
            /// </summary>
            ...
            /// <returns><see langword="true"/> if the property name matches the pattern, otherwise <see langword="false"/>.</returns>
            public static bool TryAsPatternEntity(ReadOnlySpan<byte> propertyName, in JsonElement value, out Corvus.VercelBenchmark.Current.VercelSchema.BuildEntity.EnvEntity.Entity result)
            {
                if (MatchesPatternEntity(propertyName))
                {
                    result = Corvus.VercelBenchmark.Current.VercelSchema.BuildEntity.EnvEntity.Entity.From(value);
                    return true;
                }
            ...
            public interface IPatternPropertyVisitor<TState>
            {
                ...
                /// </summary>
                bool VisitPatternEntity(ReadOnlySpan<byte> name, in Corvus.VercelBenchmark.Current.VercelSchema.BuildEntity.EnvEntity.Entity value, ref TState state);
                ...
                where TVisitor : IPatternPropertyVisitor<TState>
            {
                ...
                foreach (var property in EnumerateObject())
                {
                    ...
                    {
                        matched = true;
                        Corvus.VercelBenchmark.Current.VercelSchema.BuildEntity.EnvEntity.Entity typedValue = Corvus.VercelBenchmark.Current.VercelSchema.BuildEntity.EnvEntity.Entity.From(property.Value);
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an object.</exception>
            public ObjectEnumerator<Corvus.VercelBenchmark.Current.VercelSchema.BuildEntity.EnvEntity.Entity> EnumerateObject()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateObjectEnumerator<Corvus.VercelBenchmark.Current.VercelSchema.BuildEntity.EnvEntity.Entity>(_parent, _idx);
            }
