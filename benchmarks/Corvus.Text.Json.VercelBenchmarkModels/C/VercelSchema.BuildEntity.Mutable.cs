...
public readonly partial struct VercelSchema
{
    ...
    public readonly partial struct BuildEntity
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.VercelBenchmark.Current.VercelSchema.BuildEntity.EnvEntity.Mutable Env
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EnvUtf8, out Corvus.VercelBenchmark.Current.VercelSchema.BuildEntity.EnvEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetEnv<TContext>(in Corvus.VercelBenchmark.Current.VercelSchema.BuildEntity.EnvEntity.Source<TContext> value)
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.VercelBenchmark.Current.VercelSchema.BuildEntity.EnvEntity.Source _createArg1;
            ...
            #endif
        {
            ...
            private readonly Corvus.VercelBenchmark.Current.VercelSchema.BuildEntity.EnvEntity.Source<TContext> _createArg1;
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.VercelBenchmark.Current.VercelSchema.BuildEntity.EnvEntity.Source env = default)
            {
            ...
            /// Creates an instance of a <see cref="BuildEntity"/>.
            /// </summary>
            public void Create(in Corvus.VercelBenchmark.Current.VercelSchema.BuildEntity.EnvEntity.Source env = default)
            {
            ...
            internal static void Create<TContext>(
                ...
                in Corvus.VercelBenchmark.Current.VercelSchema.BuildEntity.EnvEntity.Source<TContext> env = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            /// Creates an instance of a <see cref="BuildEntity"/>.
            /// </summary>
            public void Create<TContext>(in TContext context, in Corvus.VercelBenchmark.Current.VercelSchema.BuildEntity.EnvEntity.Source<TContext> env = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
        ...
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.VercelBenchmark.Current.VercelSchema.BuildEntity.EnvEntity.Source env = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.VercelBenchmark.Current.VercelSchema.BuildEntity.EnvEntity.Source<TContext> env = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
        ...
        public static ParsedJsonDocument<BuildEntity> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<BuildEntity>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<BuildEntity> Create<TContext>(
        ...
        public static ParsedJsonDocument<BuildEntity> Create(in Corvus.VercelBenchmark.Current.VercelSchema.BuildEntity.EnvEntity.Source env = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<BuildEntity> Create<TContext>(in TContext context, in Corvus.VercelBenchmark.Current.VercelSchema.BuildEntity.EnvEntity.Source<TContext> env = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
