...
public readonly partial struct VercelSchema
{
...
#endif
    {
        ...
        public bool TryGetProperty(ReadOnlySpan<byte> propertyName, out Corvus.VercelBenchmark.Current.VercelSchema.EnvEntity.Entity value)
        {
            CheckValidInstance();
        ...
        /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public bool TryGetProperty(ReadOnlySpan<char> propertyName, out Corvus.VercelBenchmark.Current.VercelSchema.EnvEntity.Entity value)
        {
            CheckValidInstance();
            return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
        }
        ...
        /// <returns><see langword="true"/> if the property was found, otherwise <see langword="false"/>.</returns>
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public bool TryGetProperty(string propertyName, out Corvus.VercelBenchmark.Current.VercelSchema.EnvEntity.Entity value)
        {
            CheckValidInstance();
            return _parent.TryGetNamedPropertyValue(_idx, propertyName, out value);
        }
        ...
        /// <see cref="Corvus.VercelBenchmark.Current.VercelSchema.EnvEntity.Entity"/>.
        /// </summary>
        ...
        public static bool MatchesPatternEntity(ReadOnlySpan<byte> propertyName)
        {
        ...
        /// <returns><see langword="true"/> if the property name matches the pattern, otherwise <see langword="false"/>.</returns>
        public static bool TryAsPatternEntity(ReadOnlySpan<byte> propertyName, in JsonElement value, out Corvus.VercelBenchmark.Current.VercelSchema.EnvEntity.Entity result)
        {
            if (MatchesPatternEntity(propertyName))
            {
                result = Corvus.VercelBenchmark.Current.VercelSchema.EnvEntity.Entity.From(value);
                return true;
            }
        ...
        public interface IPatternPropertyVisitor<TState>
        {
            ...
            /// </summary>
            bool VisitPatternEntity(ReadOnlySpan<byte> name, in Corvus.VercelBenchmark.Current.VercelSchema.EnvEntity.Entity value, ref TState state);
            ...
            where TVisitor : IPatternPropertyVisitor<TState>
        {
            ...
            foreach (var property in EnumerateObject())
            {
                ...
                {
                    matched = true;
                    Corvus.VercelBenchmark.Current.VercelSchema.EnvEntity.Entity typedValue = Corvus.VercelBenchmark.Current.VercelSchema.EnvEntity.Entity.From(property.Value);
                    if (!visitor.VisitPatternEntity(propertyName, in typedValue, ref state))
                    {
                        return false;
                    }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an object.</exception>
        public ObjectEnumerator<Corvus.VercelBenchmark.Current.VercelSchema.EnvEntity.Entity> EnumerateObject()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateObjectEnumerator<Corvus.VercelBenchmark.Current.VercelSchema.EnvEntity.Entity>(_parent, _idx);
        }
