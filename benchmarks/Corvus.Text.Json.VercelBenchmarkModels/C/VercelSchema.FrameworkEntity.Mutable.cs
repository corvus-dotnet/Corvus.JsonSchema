...
public readonly partial struct VercelSchema
{
    ...
    public readonly partial struct FrameworkEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(FrameworkEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="FrameworkEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator FrameworkEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"FrameworkEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly FrameworkEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly FrameworkEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<FrameworkEntity>(_idx);
            }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(FrameworkEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<FrameworkEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<FrameworkEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<FrameworkEntity>();
            }
            finally
            {
