...
public readonly partial struct VercelSchema
{
    ...
    public readonly partial struct FunctionsEntity
        : IJsonElement<FunctionsEntity>
    {
        public static partial class JsonSchema
        {
            private static readonly JsonSchemaPathProvider PatternPropertiesSchemaEvaluationPath = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("#/patternProperties/^.{1,256}$"u8, buffer, out written);
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("vercel-schema.json#/properties/functions"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "vercel-schema.json#/properties/functions";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "vercel-schema.json#/properties/functions"u8;
                ...
                else
                {
                    ...
                    while (objectValidation_enumerator.MoveNext())
                    {
                        ...
                        if (JsonSchemaEvaluation.MatchRangeRegularExpression(objectValidation_unescapedPropertyName.Span, 1, 256))
                        {
                            ...
                            Corvus.VercelBenchmark.Current.VercelSchema.FunctionsEntity.Type1256Entity.JsonSchema.Evaluate(parentDocument, objectValidation_currentIndex, ref childContext);
                            context.EvaluatedKeyword(context.IsMatch, "^.{1,256}$", messageProvider: JsonSchemaEvaluation.ExpectedMatchPatternPropertySchema, "patternProperties"u8);
                    ...
                    JsonSchemaEvaluation.MatchPropertyCountLessThanOrEquals(50,objectValidation_propertyCount, "maxProperties"u8, ref context);
