        ...
        public readonly partial struct Type1256Entity
        {
            ...
            public readonly partial struct ExcludeFilesEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(ExcludeFilesEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="ExcludeFilesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator ExcludeFilesEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"ExcludeFilesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ExcludeFilesEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly ExcludeFilesEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<ExcludeFilesEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(ExcludeFilesEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<ExcludeFilesEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<ExcludeFilesEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<ExcludeFilesEntity>();
                    }
                    finally
                    {
