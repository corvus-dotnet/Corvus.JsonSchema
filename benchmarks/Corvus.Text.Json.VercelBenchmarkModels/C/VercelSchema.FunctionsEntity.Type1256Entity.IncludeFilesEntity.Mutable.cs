        ...
        public readonly partial struct Type1256Entity
        {
            ...
            public readonly partial struct IncludeFilesEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(IncludeFilesEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="IncludeFilesEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator IncludeFilesEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"IncludeFilesEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly IncludeFilesEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly IncludeFilesEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<IncludeFilesEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(IncludeFilesEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<IncludeFilesEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<IncludeFilesEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<IncludeFilesEntity>();
                    }
                    finally
                    {
