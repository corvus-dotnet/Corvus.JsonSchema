        ...
        public readonly partial struct Type1256Entity
        {
            ...
            public readonly partial struct MaxDurationEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(MaxDurationEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="MaxDurationEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator MaxDurationEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"MaxDurationEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly MaxDurationEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly MaxDurationEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<MaxDurationEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(MaxDurationEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<MaxDurationEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<MaxDurationEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<MaxDurationEntity>();
                    }
                    finally
                    {
