        ...
        public readonly partial struct Type1256Entity
        {
            ...
            public readonly partial struct MemoryEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(MemoryEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="MemoryEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator MemoryEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"MemoryEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly MemoryEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly MemoryEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<MemoryEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(MemoryEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<MemoryEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<MemoryEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<MemoryEntity>();
                    }
                    finally
                    {
