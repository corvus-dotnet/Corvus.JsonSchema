    ...
    public readonly partial struct FunctionsEntity
    {
        ...
        public readonly partial struct Type1256Entity
        {
...
#endif
            {
                ...
                /// </para>
                /// </remarks>
                public Corvus.VercelBenchmark.Current.VercelSchema.FunctionsEntity.Type1256Entity.ExcludeFilesEntity.Mutable ExcludeFiles
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ExcludeFilesUtf8, out Corvus.VercelBenchmark.Current.VercelSchema.FunctionsEntity.Type1256Entity.ExcludeFilesEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.VercelBenchmark.Current.VercelSchema.FunctionsEntity.Type1256Entity.IncludeFilesEntity.Mutable IncludeFiles
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.IncludeFilesUtf8, out Corvus.VercelBenchmark.Current.VercelSchema.FunctionsEntity.Type1256Entity.IncludeFilesEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.VercelBenchmark.Current.VercelSchema.FunctionsEntity.Type1256Entity.MaxDurationEntity.Mutable MaxDuration
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MaxDurationUtf8, out Corvus.VercelBenchmark.Current.VercelSchema.FunctionsEntity.Type1256Entity.MaxDurationEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.VercelBenchmark.Current.VercelSchema.FunctionsEntity.Type1256Entity.MemoryEntity.Mutable Memory
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.MemoryUtf8, out Corvus.VercelBenchmark.Current.VercelSchema.FunctionsEntity.Type1256Entity.MemoryEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.VercelBenchmark.Current.VercelSchema.FunctionsEntity.Type1256Entity.TheNpmPackageNameOfARuntimeIncludingItsVersion.Mutable Runtime
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.RuntimeUtf8, out Corvus.VercelBenchmark.Current.VercelSchema.FunctionsEntity.Type1256Entity.TheNpmPackageNameOfARuntimeIncludingItsVersion.Mutable value))
                        {
                            return value;
                        }
                ...
                public void SetIncludeFiles(scoped in Corvus.VercelBenchmark.Current.VercelSchema.FunctionsEntity.Type1256Entity.IncludeFilesEntity.Source value)
                {
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.IncludeFiles, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                public void SetMaxDuration(scoped in Corvus.VercelBenchmark.Current.VercelSchema.FunctionsEntity.Type1256Entity.MaxDurationEntity.Source value)
                {
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.MaxDuration, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                public void SetMemory(scoped in Corvus.VercelBenchmark.Current.VercelSchema.FunctionsEntity.Type1256Entity.MemoryEntity.Source value)
                {
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Memory, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.VercelBenchmark.Current.VercelSchema.FunctionsEntity.Type1256Entity.ExcludeFilesEntity.Source _createArg1;
                private readonly Corvus.VercelBenchmark.Current.VercelSchema.FunctionsEntity.Type1256Entity.IncludeFilesEntity.Source _createArg2;
                private readonly Corvus.VercelBenchmark.Current.VercelSchema.FunctionsEntity.Type1256Entity.MaxDurationEntity.Source _createArg3;
                private readonly Corvus.VercelBenchmark.Current.VercelSchema.FunctionsEntity.Type1256Entity.MemoryEntity.Source _createArg4;
                private readonly Corvus.VercelBenchmark.Current.VercelSchema.FunctionsEntity.Type1256Entity.TheNpmPackageNameOfARuntimeIncludingItsVersion.Source _createArg5;
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.VercelBenchmark.Current.VercelSchema.FunctionsEntity.Type1256Entity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                internal static void Create(
                    ...
                    in Corvus.VercelBenchmark.Current.VercelSchema.FunctionsEntity.Type1256Entity.ExcludeFilesEntity.Source excludeFiles = default,
                    in Corvus.VercelBenchmark.Current.VercelSchema.FunctionsEntity.Type1256Entity.IncludeFilesEntity.Source includeFiles = default,
                    in Corvus.VercelBenchmark.Current.VercelSchema.FunctionsEntity.Type1256Entity.MaxDurationEntity.Source maxDuration = default,
                    in Corvus.VercelBenchmark.Current.VercelSchema.FunctionsEntity.Type1256Entity.MemoryEntity.Source memory = default,
                    in Corvus.VercelBenchmark.Current.VercelSchema.FunctionsEntity.Type1256Entity.TheNpmPackageNameOfARuntimeIncludingItsVersion.Source runtime = default)
                {
                    excludeFiles.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ExcludeFiles, ref builder);
                    includeFiles.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.IncludeFiles, ref builder);
                    maxDuration.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.MaxDuration, ref builder);
                    memory.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Memory, ref builder);
            ...
            /// <param name="includeFiles">The value of the <c>"includeFiles"</c> property.</param>
            /// <param name="maxDuration">The value of the <c>"maxDuration"</c> property.</param>
            ...
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.VercelBenchmark.Current.VercelSchema.FunctionsEntity.Type1256Entity.ExcludeFilesEntity.Source excludeFiles = default, in Corvus.VercelBenchmark.Current.VercelSchema.FunctionsEntity.Type1256Entity.IncludeFilesEntity.Source includeFiles = default, in Corvus.VercelBenchmark.Current.VercelSchema.FunctionsEntity.Type1256Entity.MaxDurationEntity.Source maxDuration = default, in Corvus.VercelBenchmark.Current.VercelSchema.FunctionsEntity.Type1256Entity.MemoryEntity.Source memory = default, in Corvus.VercelBenchmark.Current.VercelSchema.FunctionsEntity.Type1256Entity.TheNpmPackageNameOfARuntimeIncludingItsVersion.Source runtime = default, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<Type1256Entity> Create<TContext>(
            ...
            public static ParsedJsonDocument<Type1256Entity> Create(in Corvus.VercelBenchmark.Current.VercelSchema.FunctionsEntity.Type1256Entity.ExcludeFilesEntity.Source excludeFiles = default, in Corvus.VercelBenchmark.Current.VercelSchema.FunctionsEntity.Type1256Entity.IncludeFilesEntity.Source includeFiles = default, in Corvus.VercelBenchmark.Current.VercelSchema.FunctionsEntity.Type1256Entity.MaxDurationEntity.Source maxDuration = default, in Corvus.VercelBenchmark.Current.VercelSchema.FunctionsEntity.Type1256Entity.MemoryEntity.Source memory = default, in Corvus.VercelBenchmark.Current.VercelSchema.FunctionsEntity.Type1256Entity.TheNpmPackageNameOfARuntimeIncludingItsVersion.Source runtime = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
