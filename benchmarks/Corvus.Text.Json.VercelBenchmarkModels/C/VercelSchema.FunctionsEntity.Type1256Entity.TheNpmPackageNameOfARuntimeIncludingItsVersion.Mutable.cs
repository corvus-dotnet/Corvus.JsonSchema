...
public readonly partial struct VercelSchema
{
    ...
    public readonly partial struct FunctionsEntity
    {
        ...
        public readonly partial struct Type1256Entity
        {
            ...
            public readonly partial struct TheNpmPackageNameOfARuntimeIncludingItsVersion
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(TheNpmPackageNameOfARuntimeIncludingItsVersion instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="TheNpmPackageNameOfARuntimeIncludingItsVersion"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator TheNpmPackageNameOfARuntimeIncludingItsVersion(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new TheNpmPackageNameOfARuntimeIncludingItsVersion(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"TheNpmPackageNameOfARuntimeIncludingItsVersion.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="TheNpmPackageNameOfARuntimeIncludingItsVersion"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="TheNpmPackageNameOfARuntimeIncludingItsVersion"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly TheNpmPackageNameOfARuntimeIncludingItsVersion Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<TheNpmPackageNameOfARuntimeIncludingItsVersion>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="TheNpmPackageNameOfARuntimeIncludingItsVersion"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly TheNpmPackageNameOfARuntimeIncludingItsVersion Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<TheNpmPackageNameOfARuntimeIncludingItsVersion>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(TheNpmPackageNameOfARuntimeIncludingItsVersion instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<TheNpmPackageNameOfARuntimeIncludingItsVersion, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<TheNpmPackageNameOfARuntimeIncludingItsVersion> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<TheNpmPackageNameOfARuntimeIncludingItsVersion>();
                    }
                    finally
                    {
