...
public readonly partial struct VercelSchema
{
    ...
    public readonly partial struct GitEntity
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="DeploymentEnabledEntity"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal DeploymentEnabledEntity(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static DeploymentEnabledEntity DefaultInstance { get; }
            ...
            /// <summary>
            /// Conversion to <see cref="Corvus.VercelBenchmark.Current.VercelSchema.GitEntity.DeploymentEnabledEntity.OneOf1Entity"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static explicit operator Corvus.VercelBenchmark.Current.VercelSchema.GitEntity.DeploymentEnabledEntity.OneOf1Entity(DeploymentEnabledEntity value)
            {
                return Corvus.VercelBenchmark.Current.VercelSchema.GitEntity.DeploymentEnabledEntity.OneOf1Entity.From(value);
            }

            /// <summary>
            /// Conversion from <see cref="Corvus.VercelBenchmark.Current.VercelSchema.GitEntity.DeploymentEnabledEntity.OneOf1Entity"/>.
            /// </summary>
            /// <param name="value">The value from which to convert.</param>
            public static implicit operator DeploymentEnabledEntity(Corvus.VercelBenchmark.Current.VercelSchema.GitEntity.DeploymentEnabledEntity.OneOf1Entity value)
            {
                return From(value);
            }
            ...
            /// </returns>
            public static bool operator ==(in DeploymentEnabledEntity left, in DeploymentEnabledEntity right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in DeploymentEnabledEntity left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator JsonElement(DeploymentEnabledEntity instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DeploymentEnabledEntity(JsonElement instance)
            {
                return DeploymentEnabledEntity.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DeploymentEnabledEntity From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DeploymentEnabledEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DeploymentEnabledEntity>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DeploymentEnabledEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DeploymentEnabledEntity>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DeploymentEnabledEntity ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DeploymentEnabledEntity>(json, options);
            }
            ...
            /// </exception>
            public static DeploymentEnabledEntity ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<DeploymentEnabledEntity>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out DeploymentEnabledEntity? result)
            {
                return JsonElementHelpers.TryParseValue<DeploymentEnabledEntity>(ref reader, out result);
            }
...
#if NET
            static DeploymentEnabledEntity IJsonElement<DeploymentEnabledEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DeploymentEnabledEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public DeploymentEnabledEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public DeploymentEnabledEntity Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<DeploymentEnabledEntity>(_idx);
                }
            ...
            public bool TryGetAsJsonBoolean(out Corvus.VercelBenchmark.Current.JsonBoolean result)
            {
                ...
                {
                    result = Corvus.VercelBenchmark.Current.JsonBoolean.From(this);
                    return true;
                }
            ...
            public bool TryGetAsOneOf1Entity(out Corvus.VercelBenchmark.Current.VercelSchema.GitEntity.DeploymentEnabledEntity.OneOf1Entity result)
            {
                ...
                {
                    result = Corvus.VercelBenchmark.Current.VercelSchema.GitEntity.DeploymentEnabledEntity.OneOf1Entity.From(this);
                    return true;
                }
            ...
            /// <param name="matchJsonBoolean">Match a <see cref="Corvus.VercelBenchmark.Current.JsonBoolean"/>.</param>
            /// <param name="matchOneOf1Entity">Match a <see cref="Corvus.VercelBenchmark.Current.VercelSchema.GitEntity.DeploymentEnabledEntity.OneOf1Entity"/>.</param>
            /// <param name="defaultMatch">Match any other value.</param>
            /// <returns>An instance of the value returned by the match function.</returns>
            public TResult Match<TContext, TResult>(
                in TContext context,
                Matcher<Corvus.VercelBenchmark.Current.JsonBoolean, TContext, TResult> matchJsonBoolean,
                Matcher<Corvus.VercelBenchmark.Current.VercelSchema.GitEntity.DeploymentEnabledEntity.OneOf1Entity, TContext, TResult> matchOneOf1Entity,
                Matcher<Corvus.VercelBenchmark.Current.VercelSchema.GitEntity.DeploymentEnabledEntity, TContext, TResult> defaultMatch)
...
#endif
            {
                if (Corvus.VercelBenchmark.Current.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonBoolean(Corvus.VercelBenchmark.Current.JsonBoolean.From(this), context);
                }

                if (Corvus.VercelBenchmark.Current.VercelSchema.GitEntity.DeploymentEnabledEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchOneOf1Entity(Corvus.VercelBenchmark.Current.VercelSchema.GitEntity.DeploymentEnabledEntity.OneOf1Entity.From(this), context);
                }
            ...
            public TResult Match<TResult>(
                Matcher<Corvus.VercelBenchmark.Current.JsonBoolean, TResult> matchJsonBoolean,
                Matcher<Corvus.VercelBenchmark.Current.VercelSchema.GitEntity.DeploymentEnabledEntity.OneOf1Entity, TResult> matchOneOf1Entity,
                Matcher<Corvus.VercelBenchmark.Current.VercelSchema.GitEntity.DeploymentEnabledEntity, TResult> defaultMatch)
            {
                if (Corvus.VercelBenchmark.Current.JsonBoolean.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchJsonBoolean(Corvus.VercelBenchmark.Current.JsonBoolean.From(this));
                }

                if (Corvus.VercelBenchmark.Current.VercelSchema.GitEntity.DeploymentEnabledEntity.OneOf1Entity.JsonSchema.Evaluate(_parent, _idx))
                {
                    return matchOneOf1Entity(Corvus.VercelBenchmark.Current.VercelSchema.GitEntity.DeploymentEnabledEntity.OneOf1Entity.From(this));
                }
