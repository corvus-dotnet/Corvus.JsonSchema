...
public readonly partial struct VercelSchema
{
    ...
    public readonly partial struct GitEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(GitEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="GitEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator GitEntity(Mutable instance)
            {
            ...
            /// <summary>
            /// Gets the (optional) <c>deploymentEnabled</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.VercelBenchmark.Current.VercelSchema.GitEntity.DeploymentEnabledEntity.Mutable DeploymentEnabled
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DeploymentEnabledUtf8, out Corvus.VercelBenchmark.Current.VercelSchema.GitEntity.DeploymentEnabledEntity.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new GitEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            /// <summary>
            /// Set the <c>deploymentEnabled</c> property.
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetDeploymentEnabled(scoped in Corvus.VercelBenchmark.Current.VercelSchema.GitEntity.DeploymentEnabledEntity.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.DeploymentEnabledUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DeploymentEnabledUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                ...
                else
                {
                    ...
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.DeploymentEnabled, ref cvb);
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetDeploymentEnabled<TContext>(in Corvus.VercelBenchmark.Current.VercelSchema.GitEntity.DeploymentEnabledEntity.Source<TContext> value)
            ...
            /// <summary>
            /// Remove the <c>deploymentEnabled</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveDeploymentEnabled()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.DeploymentEnabledUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"GitEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="GitEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="GitEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly GitEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<GitEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="GitEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly GitEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<GitEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.VercelBenchmark.Current.VercelSchema.GitEntity.DeploymentEnabledEntity.Source _createArg1;
            ...
            internal Source(Corvus.VercelBenchmark.Current.VercelSchema.GitEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.VercelBenchmark.Current.VercelSchema.GitEntity.DeploymentEnabledEntity.Source arg1)
            {
                _createArg1 = arg1;
                _kind = Kind.Create;
            }

            public static implicit operator Source(GitEntity instance) => new(JsonElement.From(instance));
            ...
            #endif
        {
            ...
            private readonly Corvus.VercelBenchmark.Current.VercelSchema.GitEntity.DeploymentEnabledEntity.Source<TContext> _createArg1;
            ...
            internal Source(scoped in TContext context, Corvus.VercelBenchmark.Current.VercelSchema.GitEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in TContext context, scoped in Corvus.VercelBenchmark.Current.VercelSchema.GitEntity.DeploymentEnabledEntity.Source<TContext> arg1)
            {
                _context = context;
                _createArg1 = arg1;
                _kind = Kind.Create;
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="GitEntity"/>.
            /// </summary>
            internal static void Create(ref ComplexValueBuilder builder, in Corvus.VercelBenchmark.Current.VercelSchema.GitEntity.DeploymentEnabledEntity.Source deploymentEnabled = default)
            {
                deploymentEnabled.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.DeploymentEnabled, ref builder);
            }

            /// <summary>
            /// Creates an instance of a <see cref="GitEntity"/>.
            /// </summary>
            public void Create(in Corvus.VercelBenchmark.Current.VercelSchema.GitEntity.DeploymentEnabledEntity.Source deploymentEnabled = default)
            {
                Create(ref _builder, deploymentEnabled);
            }
            ...
            internal static void Create<TContext>(
                ...
                in Corvus.VercelBenchmark.Current.VercelSchema.GitEntity.DeploymentEnabledEntity.Source<TContext> deploymentEnabled = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
            ...
            /// Creates an instance of a <see cref="GitEntity"/>.
            /// </summary>
            public void Create<TContext>(in TContext context, in Corvus.VercelBenchmark.Current.VercelSchema.GitEntity.DeploymentEnabledEntity.Source<TContext> deploymentEnabled = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
            {
                Create(context, ref _builder, deploymentEnabled);
            }
            ...
            internal static void BuildCreateValue(scoped in Corvus.VercelBenchmark.Current.VercelSchema.GitEntity.DeploymentEnabledEntity.Source arg1, ref ComplexValueBuilder o)
            {
                o.StartObject();
                Create(ref o, arg1);
                o.EndObject();
            ...
            /// <param name="arg1">The value of the property.</param>
            /// <param name="o">The complex value builder into which to write the object.</param>
            internal static void BuildCreateValue<TContext>(scoped in TContext context, scoped in Corvus.VercelBenchmark.Current.VercelSchema.GitEntity.DeploymentEnabledEntity.Source<TContext> arg1, ref ComplexValueBuilder o)
#if NET9_0_OR_GREATER
                where TContext : allows ref struct
#endif
            {
        ...
        /// </summary>
        /// <param name="deploymentEnabled">The value of the <c>"deploymentEnabled"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.VercelBenchmark.Current.VercelSchema.GitEntity.DeploymentEnabledEntity.Source deploymentEnabled = default)
        {
            return new Source(deploymentEnabled);
        }
        ...
        /// <param name="deploymentEnabled">The value of the <c>"deploymentEnabled"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.VercelBenchmark.Current.VercelSchema.GitEntity.DeploymentEnabledEntity.Source<TContext> deploymentEnabled = default)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            return new Source<TContext>(context, deploymentEnabled);
        }
        ...
        /// </summary>
        /// <param name="workspace">The JSON workspace.</param>
        /// <param name="deploymentEnabled">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.VercelBenchmark.Current.VercelSchema.GitEntity.DeploymentEnabledEntity.Source deploymentEnabled = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(deploymentEnabled);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(JsonWorkspace workspace, in TContext context, in Corvus.VercelBenchmark.Current.VercelSchema.GitEntity.DeploymentEnabledEntity.Source<TContext> deploymentEnabled = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
            ...
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(context, deploymentEnabled);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<GitEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<GitEntity> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<GitEntity>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<GitEntity> Create<TContext>(
        ...
        public static ParsedJsonDocument<GitEntity> Create(in Corvus.VercelBenchmark.Current.VercelSchema.GitEntity.DeploymentEnabledEntity.Source deploymentEnabled = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<GitEntity> Create<TContext>(in TContext context, in Corvus.VercelBenchmark.Current.VercelSchema.GitEntity.DeploymentEnabledEntity.Source<TContext> deploymentEnabled = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
