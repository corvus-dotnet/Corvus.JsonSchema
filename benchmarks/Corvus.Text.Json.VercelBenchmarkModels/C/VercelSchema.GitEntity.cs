...
public readonly partial struct VercelSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GitEntity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal GitEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static GitEntity DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.VercelBenchmark.Current.VercelSchema.GitEntity.DeploymentEnabledEntity DeploymentEnabled
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DeploymentEnabledUtf8, out Corvus.VercelBenchmark.Current.VercelSchema.GitEntity.DeploymentEnabledEntity value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in GitEntity left, in GitEntity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in GitEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(GitEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GitEntity(JsonElement instance)
        {
            return GitEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GitEntity From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GitEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<GitEntity>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GitEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<GitEntity>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GitEntity ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<GitEntity>(json, options);
        }
        ...
        /// </exception>
        public static GitEntity ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<GitEntity>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out GitEntity? result)
        {
            return JsonElementHelpers.TryParseValue<GitEntity>(ref reader, out result);
        }
...
#if NET
        static GitEntity IJsonElement<GitEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GitEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        {
            /// <summary>
            /// Gets the JSON property name for <see cref="DeploymentEnabled"/>.
            /// </summary>
            public const string DeploymentEnabled = "deploymentEnabled";

            /// <summary>
            /// Gets the JSON property name for <see cref="DeploymentEnabled"/>.
            /// </summary>
            public static ReadOnlySpan<byte> DeploymentEnabledUtf8 => "deploymentEnabled"u8;
        }
        ...
        {
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="DeploymentEnabled"/>.
            /// </summary>
            public static ReadOnlySpan<byte> DeploymentEnabled => "deploymentEnabled"u8;
        }
        ...
        {
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="DeploymentEnabled"/>.
            /// </summary>
            public static ReadOnlySpan<byte> DeploymentEnabled => [0x35, 0x01, 0x00, 0x00, 0x22, 0x64, 0x65, 0x70, 0x6C, 0x6F, 0x79, 0x6D, 0x65, 0x6E, 0x74, 0x45, 0x6E, 0x61, 0x62, 0x6C, 0x65, 0x64, 0x22];
        }
    }
}
