...
public readonly partial struct VercelSchema
{
    ...
    public readonly partial struct GithubEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(GithubEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="GithubEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator GithubEntity(Mutable instance)
            {
            ...
            /// <summary>
            /// Gets the (optional) <c>autoAlias</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.VercelBenchmark.Current.JsonBoolean.Mutable AutoAlias
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AutoAliasUtf8, out Corvus.VercelBenchmark.Current.JsonBoolean.Mutable value))
                    {
                        return value;
                    }
            ...
            /// <summary>
            /// Gets the (optional) <c>autoJobCancelation</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.VercelBenchmark.Current.JsonBoolean.Mutable AutoJobCancelation
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AutoJobCancelationUtf8, out Corvus.VercelBenchmark.Current.JsonBoolean.Mutable value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.VercelBenchmark.Current.JsonBoolean.Mutable Enabled
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EnabledUtf8, out Corvus.VercelBenchmark.Current.JsonBoolean.Mutable value))
                    {
                        return value;
                    }
            ...
            /// <summary>
            /// Gets the (optional) <c>silent</c> property.
            /// </summary>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public Corvus.VercelBenchmark.Current.JsonBoolean.Mutable Silent
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SilentUtf8, out Corvus.VercelBenchmark.Current.JsonBoolean.Mutable value))
                    {
                        return value;
                    }
            ...
            {
                return
                    (obj is IJsonElement value && Equals(new GithubEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
            ...
            /// <summary>
            /// Set the <c>autoAlias</c> property.
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetAutoAlias(scoped in Corvus.VercelBenchmark.Current.JsonBoolean.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.AutoAliasUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AutoAliasUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                ...
                else
                {
                    ...
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.AutoAlias, ref cvb);
            ...
            /// <summary>
            /// Remove the <c>autoAlias</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveAutoAlias()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.AutoAliasUtf8);
                _documentVersion = _parent.Version;
                return result;
            }

            /// <summary>
            /// Set the <c>autoJobCancelation</c> property.
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetAutoJobCancelation(scoped in Corvus.VercelBenchmark.Current.JsonBoolean.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.AutoJobCancelationUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AutoJobCancelationUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.AutoJobCancelation, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// <summary>
            /// Remove the <c>autoJobCancelation</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveAutoJobCancelation()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.AutoJobCancelationUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetEnabled(scoped in Corvus.VercelBenchmark.Current.JsonBoolean.Source value)
            {
                CheckValidInstance();
            ...
            /// <summary>
            /// Set the <c>silent</c> property.
            /// </summary>
            /// <param name="value">The value of the property to add.</param>
            public void SetSilent(scoped in Corvus.VercelBenchmark.Current.JsonBoolean.Source value)
            {
                CheckValidInstance();

                if (value.IsUndefined)
                {
                    JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.SilentUtf8);
                    _documentVersion = _parent.Version;
                    return;
                }

                ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SilentUtf8, out IJsonDocument? elementParent, out int elementIdx))
                {
                    // We are going to replace just the value
                    value.AddAsItem(ref cvb);
                    _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Silent, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// <summary>
            /// Remove the <c>silent</c> property, if present.
            /// </summary>
            /// <returns><see langword="true"/> if the property was found and removed; otherwise, <see langword="false"/>.</returns>
            public bool RemoveSilent()
            {
                CheckValidInstance();
                bool result = JsonElementHelpers.RemovePropertyUnsafe(_parent, _idx, JsonPropertyNames.SilentUtf8);
                _documentVersion = _parent.Version;
                return result;
            }
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"GithubEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// <summary>
            /// Gets a <see cref="GithubEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="GithubEntity"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly GithubEntity Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<GithubEntity>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="GithubEntity"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly GithubEntity Freeze()
            {
                CheckValidInstance();
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.VercelBenchmark.Current.JsonBoolean.Source _createArg1;
            ...
            internal Source(Corvus.VercelBenchmark.Current.VercelSchema.GithubEntity.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

            internal Source(scoped in Corvus.VercelBenchmark.Current.JsonBoolean.Source arg1, scoped in Corvus.VercelBenchmark.Current.JsonBoolean.Source arg2, scoped in Corvus.VercelBenchmark.Current.JsonBoolean.Source arg3, scoped in Corvus.VercelBenchmark.Current.JsonBoolean.Source arg4)
            {
                _createArg1 = arg1;
                _createArg2 = arg2;
                _createArg3 = arg3;
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.VercelBenchmark.Current.VercelSchema.GithubEntity.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// <summary>
            /// Creates an instance of a <see cref="GithubEntity"/>.
            /// </summary>
            internal static void Create(
                ref ComplexValueBuilder builder,
                in Corvus.VercelBenchmark.Current.JsonBoolean.Source autoAlias = default,
                in Corvus.VercelBenchmark.Current.JsonBoolean.Source autoJobCancelation = default,
                in Corvus.VercelBenchmark.Current.JsonBoolean.Source enabled = default,
                in Corvus.VercelBenchmark.Current.JsonBoolean.Source silent = default)
            {
                autoAlias.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.AutoAlias, ref builder);
                autoJobCancelation.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.AutoJobCancelation, ref builder);
                enabled.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Enabled, ref builder);
                silent.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Silent, ref builder);
            }
            ...
            public void Create(
                ...
                in Corvus.VercelBenchmark.Current.JsonBoolean.Source silent = default)
            {
                Create(ref _builder, autoAlias, autoJobCancelation, enabled, silent);
            }
            ...
            internal static void BuildCreateValue(scoped in Corvus.VercelBenchmark.Current.JsonBoolean.Source arg1, scoped in Corvus.VercelBenchmark.Current.JsonBoolean.Source arg2, scoped in Corvus.VercelBenchmark.Current.JsonBoolean.Source arg3, scoped in Corvus.VercelBenchmark.Current.JsonBoolean.Source arg4, ref ComplexValueBuilder o)
            {
                o.StartObject();
        ...
        /// </summary>
        /// <param name="autoAlias">The value of the <c>"autoAlias"</c> property.</param>
        /// <param name="autoJobCancelation">The value of the <c>"autoJobCancelation"</c> property.</param>
        /// <param name="enabled">The value of the <c>"enabled"</c> property.</param>
        /// <param name="silent">The value of the <c>"silent"</c> property.</param>
        /// <returns>The source from which to build the value.</returns>
        public static Source Build(scoped in Corvus.VercelBenchmark.Current.JsonBoolean.Source autoAlias = default, scoped in Corvus.VercelBenchmark.Current.JsonBoolean.Source autoJobCancelation = default, scoped in Corvus.VercelBenchmark.Current.JsonBoolean.Source enabled = default, scoped in Corvus.VercelBenchmark.Current.JsonBoolean.Source silent = default)
        {
            return new Source(autoAlias, autoJobCancelation, enabled, silent);
        }
        ...
        /// </summary>
        /// <param name="workspace">The JSON workspace.</param>
        /// <param name="autoAlias">The value of the property.</param>
        /// <param name="autoJobCancelation">The value of the property.</param>
        /// <param name="enabled">The value of the property.</param>
        /// <param name="silent">The value of the property.</param>
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>An instance of a mutable document initialized with the given property values.</returns>
        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.VercelBenchmark.Current.JsonBoolean.Source autoAlias = default, in Corvus.VercelBenchmark.Current.JsonBoolean.Source autoJobCancelation = default, in Corvus.VercelBenchmark.Current.JsonBoolean.Source enabled = default, in Corvus.VercelBenchmark.Current.JsonBoolean.Source silent = default, int initialCapacity = 30)
        {
            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
            cvb.StartObject();
            Builder ovb = new(cvb);
            ovb.Create(autoAlias, autoJobCancelation, enabled, silent);
            cvb = ovb._builder;
            cvb.EndObject();
            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
            return documentBuilder;
        ...
        {
            return workspace.CreateBuilder<GithubEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<GithubEntity> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<GithubEntity>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<GithubEntity> Create<TContext>(
        ...
        public static ParsedJsonDocument<GithubEntity> Create(in Corvus.VercelBenchmark.Current.JsonBoolean.Source autoAlias = default, in Corvus.VercelBenchmark.Current.JsonBoolean.Source autoJobCancelation = default, in Corvus.VercelBenchmark.Current.JsonBoolean.Source enabled = default, in Corvus.VercelBenchmark.Current.JsonBoolean.Source silent = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
