...
public readonly partial struct VercelSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GithubEntity"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal GithubEntity(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static GithubEntity DefaultInstance { get; }
        ...
        /// </para>
        /// </remarks>
        public Corvus.VercelBenchmark.Current.JsonBoolean AutoAlias
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AutoAliasUtf8, out Corvus.VercelBenchmark.Current.JsonBoolean value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.VercelBenchmark.Current.JsonBoolean AutoJobCancelation
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.AutoJobCancelationUtf8, out Corvus.VercelBenchmark.Current.JsonBoolean value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.VercelBenchmark.Current.JsonBoolean Enabled
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.EnabledUtf8, out Corvus.VercelBenchmark.Current.JsonBoolean value))
                {
                    return value;
                }
        ...
        /// </para>
        /// </remarks>
        public Corvus.VercelBenchmark.Current.JsonBoolean Silent
        {
            get
            {
                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SilentUtf8, out Corvus.VercelBenchmark.Current.JsonBoolean value))
                {
                    return value;
                }
        ...
        /// </returns>
        public static bool operator ==(in GithubEntity left, in GithubEntity right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in GithubEntity left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(GithubEntity instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator GithubEntity(JsonElement instance)
        {
            return GithubEntity.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GithubEntity From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GithubEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<GithubEntity>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GithubEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<GithubEntity>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static GithubEntity ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<GithubEntity>(json, options);
        }
        ...
        /// </exception>
        public static GithubEntity ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<GithubEntity>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out GithubEntity? result)
        {
            return JsonElementHelpers.TryParseValue<GithubEntity>(ref reader, out result);
        }
...
#if NET
        static GithubEntity IJsonElement<GithubEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"GithubEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        {
            /// <summary>
            /// Gets the JSON property name for <see cref="AutoAlias"/>.
            /// </summary>
            public const string AutoAlias = "autoAlias";

            /// <summary>
            /// Gets the JSON property name for <see cref="AutoJobCancelation"/>.
            /// </summary>
            public const string AutoJobCancelation = "autoJobCancelation";
            ...
            /// <summary>
            /// Gets the JSON property name for <see cref="Silent"/>.
            /// </summary>
            ...
            /// Gets the JSON property name for <see cref="AutoAlias"/>.
            /// </summary>
            public static ReadOnlySpan<byte> AutoAliasUtf8 => "autoAlias"u8;

            /// <summary>
            /// Gets the JSON property name for <see cref="AutoJobCancelation"/>.
            /// </summary>
            public static ReadOnlySpan<byte> AutoJobCancelationUtf8 => "autoJobCancelation"u8;
            ...
            /// Gets the JSON property name for <see cref="Silent"/>.
            /// </summary>
            public static ReadOnlySpan<byte> SilentUtf8 => "silent"u8;
        }
        ...
        {
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="AutoAlias"/>.
            /// </summary>
            public static ReadOnlySpan<byte> AutoAlias => "autoAlias"u8;

            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="AutoJobCancelation"/>.
            /// </summary>
            public static ReadOnlySpan<byte> AutoJobCancelation => "autoJobCancelation"u8;
            ...
            /// <summary>
            /// Gets the escaped UTF-8 JSON property name for <see cref="Silent"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Silent => "silent"u8;
        }
        ...
        {
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="AutoAlias"/>.
            /// </summary>
            public static ReadOnlySpan<byte> AutoAlias => [0xB5, 0x00, 0x00, 0x00, 0x22, 0x61, 0x75, 0x74, 0x6F, 0x41, 0x6C, 0x69, 0x61, 0x73, 0x22];

            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="AutoJobCancelation"/>.
            /// </summary>
            public static ReadOnlySpan<byte> AutoJobCancelation => [0x45, 0x01, 0x00, 0x00, 0x22, 0x61, 0x75, 0x74, 0x6F, 0x4A, 0x6F, 0x62, 0x43, 0x61, 0x6E, 0x63, 0x65, 0x6C, 0x61, 0x74, 0x69, 0x6F, 0x6E, 0x22];
            ...
            /// <summary>
            /// Gets the pre-baked property name blob for <see cref="Silent"/>.
            /// </summary>
            public static ReadOnlySpan<byte> Silent => [0x85, 0x00, 0x00, 0x00, 0x22, 0x73, 0x69, 0x6C, 0x65, 0x6E, 0x74, 0x22];
        }
    }
}
