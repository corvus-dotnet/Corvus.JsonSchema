...
public readonly partial struct VercelSchema
{
    ...
    public readonly partial struct IgnoreCommandEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(IgnoreCommandEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="IgnoreCommandEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator IgnoreCommandEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"IgnoreCommandEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly IgnoreCommandEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly IgnoreCommandEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<IgnoreCommandEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(IgnoreCommandEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<IgnoreCommandEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<IgnoreCommandEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<IgnoreCommandEntity>();
            }
            finally
            {
