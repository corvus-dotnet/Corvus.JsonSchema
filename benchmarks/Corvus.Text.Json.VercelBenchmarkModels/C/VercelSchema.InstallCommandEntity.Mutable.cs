...
public readonly partial struct VercelSchema
{
    ...
    public readonly partial struct InstallCommandEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(InstallCommandEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="InstallCommandEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator InstallCommandEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"InstallCommandEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly InstallCommandEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly InstallCommandEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<InstallCommandEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(InstallCommandEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<InstallCommandEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<InstallCommandEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<InstallCommandEntity>();
            }
            finally
            {
