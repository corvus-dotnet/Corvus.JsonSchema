...
public readonly partial struct VercelSchema
{
    ...
    public readonly partial struct OutputDirectoryEntity
    {
...
#endif
        {
            ...
            public static explicit operator Mutable(OutputDirectoryEntity instance)
            {
            ...
            /// <returns>An immutable instance of a <see cref="OutputDirectoryEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator OutputDirectoryEntity(Mutable instance)
            {
            ...
            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"OutputDirectoryEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public readonly OutputDirectoryEntity Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public readonly OutputDirectoryEntity Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<OutputDirectoryEntity>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            public static implicit operator Source(OutputDirectoryEntity instance) => new(JsonElement.From(instance));
        ...
        {
            return workspace.CreateBuilder<OutputDirectoryEntity, Mutable>(this);
        }
        ...
        public static ParsedJsonDocument<OutputDirectoryEntity> Create(
            scoped in Source value, int initialCapacity = 1)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<OutputDirectoryEntity>();
            }
            finally
            {
