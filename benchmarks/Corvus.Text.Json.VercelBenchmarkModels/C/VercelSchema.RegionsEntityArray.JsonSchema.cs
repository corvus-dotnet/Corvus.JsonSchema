...
public readonly partial struct VercelSchema
{
        ...
        : IJsonElement<RegionsEntityArray>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/properties/regions"u8, buffer, out written);
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    while (arrayValidation_enumerator.MoveNext())
                    {
                        ...
                        JsonSchemaContext childContext = Corvus.VercelBenchmark.Current.VercelSchema.RegionsEntityArray.RegionsEntity.JsonSchema.PushChildContext(
                            parentDocument,
                        ...
                        Corvus.VercelBenchmark.Current.VercelSchema.RegionsEntityArray.RegionsEntity.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
