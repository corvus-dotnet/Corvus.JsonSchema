...
public readonly partial struct VercelSchema
{
    ...
    public readonly partial struct RegionsEntityArray
    {
...
#endif
        {
            ...
            public Corvus.VercelBenchmark.Current.VercelSchema.RegionsEntityArray.RegionsEntity.Mutable this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.VercelBenchmark.Current.VercelSchema.RegionsEntityArray.RegionsEntity.Mutable>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.VercelBenchmark.Current.VercelSchema.RegionsEntityArray.RegionsEntity.Mutable> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.VercelBenchmark.Current.VercelSchema.RegionsEntityArray.RegionsEntity.Mutable>(_parent, _idx);
            }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void SetItem(int itemIndex, in Corvus.VercelBenchmark.Current.VercelSchema.RegionsEntityArray.RegionsEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, scoped in Corvus.VercelBenchmark.Current.VercelSchema.RegionsEntityArray.RegionsEntity.Source value)
            {
                CheckValidInstance();
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void AddItem(scoped in Corvus.VercelBenchmark.Current.VercelSchema.RegionsEntityArray.RegionsEntity.Source value)
            {
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Remove(in Corvus.VercelBenchmark.Current.VercelSchema.RegionsEntityArray.RegionsEntity item)
            {
                CheckValidInstance();
                if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.VercelBenchmark.Current.VercelSchema.RegionsEntityArray.RegionsEntity>(this, in item))
                {
                    return false;
                }
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void RemoveWhere(JsonPredicate<Corvus.VercelBenchmark.Current.VercelSchema.RegionsEntityArray.RegionsEntity> predicate)
            {
                CheckValidInstance();
                JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.VercelBenchmark.Current.VercelSchema.RegionsEntityArray.RegionsEntity>(this, predicate);
                _documentVersion = _parent.Version;
            }
            ...
            ///   The parent <see cref="JsonDocument"/> has been disposed.
            /// </exception>
            public bool Replace(in Corvus.VercelBenchmark.Current.VercelSchema.RegionsEntityArray.RegionsEntity oldItem, in Corvus.VercelBenchmark.Current.VercelSchema.RegionsEntityArray.RegionsEntity.Source newItem)
            {
                CheckValidInstance();
                ...
                var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.VercelBenchmark.Current.VercelSchema.RegionsEntityArray.RegionsEntity>(_parent, _idx);

                while (enumerator.MoveNext())
                {
                    Corvus.VercelBenchmark.Current.VercelSchema.RegionsEntityArray.RegionsEntity current = enumerator.Current;
        ...
        public ref struct Source
        {
            ...
            internal Source(Corvus.VercelBenchmark.Current.VercelSchema.RegionsEntityArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }
            ...
            #endif
        {
            ...
            internal Source(scoped in TContext context, Corvus.VercelBenchmark.Current.VercelSchema.RegionsEntityArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
        ...
        public ref struct Builder
        {
            ...
            /// </summary>
            public void AddItem(in Corvus.VercelBenchmark.Current.VercelSchema.RegionsEntityArray.RegionsEntity.Source value)
            {
        ...
        public static ParsedJsonDocument<RegionsEntityArray> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<RegionsEntityArray>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<RegionsEntityArray> Create<TContext>(
