    ...
    public readonly partial struct RegionsEntityArray
    {
        ...
        public readonly partial struct RegionsEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RegionsEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RegionsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RegionsEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new RegionsEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RegionsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="RegionsEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="RegionsEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly RegionsEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<RegionsEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="RegionsEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly RegionsEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RegionsEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(RegionsEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<RegionsEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RegionsEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RegionsEntity>();
                }
                finally
                {
