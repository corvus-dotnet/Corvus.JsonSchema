...
public readonly partial struct VercelSchema
{
    ...
    public readonly partial struct RequiredDestinationAndSourceEntityArray
    {
...
#endif
        {
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, in Corvus.VercelBenchmark.Current.VercelSchema.RequiredDestinationAndSourceEntityArray.RequiredDestinationAndSourceEntity.Source value)
            {
                CheckValidInstance();
