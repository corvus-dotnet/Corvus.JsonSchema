            ...
            public readonly partial struct MissingEntityArray
            {
                ...
                public readonly partial struct MissingEntity
                {
...
#endif
                    {
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.VercelBenchmark.Current.VercelSchema.RequiredDestinationAndSourceEntityArray.RequiredDestinationAndSourceEntity.MissingEntityArray.MissingEntity.RequiredTypeAndValue.TheTypeOfRequestElementToCheck Type
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.VercelBenchmark.Current.VercelSchema.RequiredDestinationAndSourceEntityArray.RequiredDestinationAndSourceEntity.MissingEntityArray.MissingEntity.RequiredTypeAndValue.TheTypeOfRequestElementToCheck value))
                                {
                                    return value;
                                }
                        ...
                        /// </para>
                        /// </remarks>
                        public Corvus.VercelBenchmark.Current.VercelSchema.RequiredDestinationAndSourceEntityArray.RequiredDestinationAndSourceEntity.MissingEntityArray.MissingEntity.RequiredTypeAndValue.ValueEntity Value
                        {
                            get
                            {
                                if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ValueUtf8, out Corvus.VercelBenchmark.Current.VercelSchema.RequiredDestinationAndSourceEntityArray.RequiredDestinationAndSourceEntity.MissingEntityArray.MissingEntity.RequiredTypeAndValue.ValueEntity value))
                                {
                                    return value;
                                }
                        ...
                        /// </para>
                        /// </remarks>
                        public RequiredTypeAndValue Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public RequiredTypeAndValue Freeze()
                        {
                            CheckValidInstance();
                            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                            {
                                return mutable.FreezeElement<RequiredTypeAndValue>(_idx);
                            }
