...
public readonly partial struct VercelSchema
{
    ...
    public readonly partial struct RequiredDestinationAndSourceEntityArray
    {
        ...
        public readonly partial struct RequiredDestinationAndSourceEntity
        {
            ...
            public readonly partial struct DestinationEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(DestinationEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="DestinationEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator DestinationEntity(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new DestinationEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"DestinationEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="DestinationEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="DestinationEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DestinationEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<DestinationEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="DestinationEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DestinationEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<DestinationEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(DestinationEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<DestinationEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<DestinationEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<DestinationEntity>();
                    }
                    finally
                    {
