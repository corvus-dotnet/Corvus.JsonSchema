                ...
                public readonly partial struct HasEntity
                {
                    ...
                    public readonly partial struct RequiredKeyAndType
                    {
...
#endif
                        {
                            ...
                            public void SetKey(in Corvus.VercelBenchmark.Current.VercelSchema.RequiredDestinationAndSourceEntityArray.RequiredDestinationAndSourceEntity.HasEntityArray.HasEntity.RequiredKeyAndType.TheNameOfTheElementContainedInTheParticularType.Source value)
                            {
                                CheckValidInstance();
                            ...
                            /// </summary>
                            /// <param name="value">The value of the property to add.</param>
                            public void SetType(in Corvus.VercelBenchmark.Current.VercelSchema.RequiredDestinationAndSourceEntityArray.RequiredDestinationAndSourceEntity.HasEntityArray.HasEntity.RequiredKeyAndType.TheTypeOfRequestElementToCheck.Source value)
                            {
                                CheckValidInstance();
                            ...
                            /// </summary>
                            /// <param name="value">The value of the property to add.</param>
                            public void SetValue(in Corvus.VercelBenchmark.Current.VercelSchema.RequiredDestinationAndSourceEntityArray.RequiredDestinationAndSourceEntity.HasEntityArray.HasEntity.RequiredKeyAndType.ValueEntity.Source value)
                            {
                                CheckValidInstance();
                        ...
                        public ref struct Source
                        {
                            ...
                            internal Source(in Corvus.VercelBenchmark.Current.VercelSchema.RequiredDestinationAndSourceEntityArray.RequiredDestinationAndSourceEntity.HasEntityArray.HasEntity.RequiredKeyAndType.TheNameOfTheElementContainedInTheParticularType.Source arg1, in Corvus.VercelBenchmark.Current.VercelSchema.RequiredDestinationAndSourceEntityArray.RequiredDestinationAndSourceEntity.HasEntityArray.HasEntity.RequiredKeyAndType.TheTypeOfRequestElementToCheck.Source arg2, in Corvus.VercelBenchmark.Current.VercelSchema.RequiredDestinationAndSourceEntityArray.RequiredDestinationAndSourceEntity.HasEntityArray.HasEntity.RequiredKeyAndType.ValueEntity.Source arg3)
                            {
                                _createArg1 = arg1;
                                _createArg2 = arg2;
                                _createArg3 = arg3;
                        ...
                        public ref struct Builder
                        {
                            ...
                            internal static void BuildCreateValue(in Corvus.VercelBenchmark.Current.VercelSchema.RequiredDestinationAndSourceEntityArray.RequiredDestinationAndSourceEntity.HasEntityArray.HasEntity.RequiredKeyAndType.TheNameOfTheElementContainedInTheParticularType.Source arg1, in Corvus.VercelBenchmark.Current.VercelSchema.RequiredDestinationAndSourceEntityArray.RequiredDestinationAndSourceEntity.HasEntityArray.HasEntity.RequiredKeyAndType.TheTypeOfRequestElementToCheck.Source arg2, in Corvus.VercelBenchmark.Current.VercelSchema.RequiredDestinationAndSourceEntityArray.RequiredDestinationAndSourceEntity.HasEntityArray.HasEntity.RequiredKeyAndType.ValueEntity.Source arg3, ref ComplexValueBuilder o)
                            {
                                o.StartObject();
                        ...
                        /// <returns>The source from which to build the value.</returns>
                        public static Source Build(in Corvus.VercelBenchmark.Current.VercelSchema.RequiredDestinationAndSourceEntityArray.RequiredDestinationAndSourceEntity.HasEntityArray.HasEntity.RequiredKeyAndType.TheNameOfTheElementContainedInTheParticularType.Source key, in Corvus.VercelBenchmark.Current.VercelSchema.RequiredDestinationAndSourceEntityArray.RequiredDestinationAndSourceEntity.HasEntityArray.HasEntity.RequiredKeyAndType.TheTypeOfRequestElementToCheck.Source type, in Corvus.VercelBenchmark.Current.VercelSchema.RequiredDestinationAndSourceEntityArray.RequiredDestinationAndSourceEntity.HasEntityArray.HasEntity.RequiredKeyAndType.ValueEntity.Source value = default)
                        {
