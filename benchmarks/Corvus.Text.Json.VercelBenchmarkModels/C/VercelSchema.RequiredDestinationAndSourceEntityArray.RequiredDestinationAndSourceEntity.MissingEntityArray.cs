    ...
    public readonly partial struct RequiredDestinationAndSourceEntityArray
    {
        ...
        public readonly partial struct RequiredDestinationAndSourceEntity
        {
...
#endif
            {
                ...
                public Corvus.VercelBenchmark.Current.VercelSchema.RequiredDestinationAndSourceEntityArray.RequiredDestinationAndSourceEntity.MissingEntityArray.MissingEntity this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.VercelBenchmark.Current.VercelSchema.RequiredDestinationAndSourceEntityArray.RequiredDestinationAndSourceEntity.MissingEntityArray.MissingEntity>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.VercelBenchmark.Current.VercelSchema.RequiredDestinationAndSourceEntityArray.RequiredDestinationAndSourceEntity.MissingEntityArray.MissingEntity> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.VercelBenchmark.Current.VercelSchema.RequiredDestinationAndSourceEntityArray.RequiredDestinationAndSourceEntity.MissingEntityArray.MissingEntity>(_parent, _idx);
                }
