        ...
        public readonly partial struct RequiredDestinationAndSourceEntity
        {
            ...
            public readonly partial struct StatusCodeEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(StatusCodeEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="StatusCodeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator StatusCodeEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"StatusCodeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly StatusCodeEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly StatusCodeEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<StatusCodeEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(StatusCodeEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<StatusCodeEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<StatusCodeEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<StatusCodeEntity>();
                    }
                    finally
                    {
