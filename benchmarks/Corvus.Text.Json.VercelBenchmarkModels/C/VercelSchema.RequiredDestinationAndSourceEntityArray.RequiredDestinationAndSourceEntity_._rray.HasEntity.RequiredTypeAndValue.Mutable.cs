            ...
            public readonly partial struct HasEntityArray
            {
                ...
                public readonly partial struct HasEntity
                {
                    ...
                    public readonly partial struct RequiredTypeAndValue
                    {
                        ...
                        public static ParsedJsonDocument<RequiredTypeAndValue> Create(in Corvus.VercelBenchmark.Current.VercelSchema.RequiredDestinationAndSourceEntityArray.RequiredDestinationAndSourceEntity.HasEntityArray.HasEntity.RequiredTypeAndValue.ValueEntity.Source value, int initialCapacity = 30)
                        {
                            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                            try
                            {
