...
public readonly partial struct VercelSchema
{
    ...
    public readonly partial struct RequiredDomainAndValueArray
    {
        ...
        /// Generated from JSON Schema.
        /// </summary>
        public readonly partial struct RequiredDomainAndValue
        {
            /// <summary>
            /// Generated from JSON Schema.
            /// </summary>
            [DebuggerDisplay("{DebuggerDisplay,nq}")]
            public readonly partial struct DomainEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(DomainEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="DomainEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator DomainEntity(Mutable instance)
                    {
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new DomainEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"DomainEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="DomainEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="DomainEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DomainEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<DomainEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="DomainEntity"/> that lives for the lifetime of its
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly DomainEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<DomainEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(DomainEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<DomainEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<DomainEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<DomainEntity>();
                    }
                    finally
                    {
