...
public readonly partial struct VercelSchema
{
    ...
    public readonly partial struct RequiredDomainAndValueArray
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.VercelBenchmark.Current.VercelSchema.RequiredDomainAndValueArray.RequiredDomainAndValue.DomainEntity Domain
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.DomainUtf8, out Corvus.VercelBenchmark.Current.VercelSchema.RequiredDomainAndValueArray.RequiredDomainAndValue.DomainEntity value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.VercelBenchmark.Current.VercelSchema.RequiredDomainAndValueArray.RequiredDomainAndValue.ValueEntity Value
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ValueUtf8, out Corvus.VercelBenchmark.Current.VercelSchema.RequiredDomainAndValueArray.RequiredDomainAndValue.ValueEntity value))
                    {
                        return value;
                    }
