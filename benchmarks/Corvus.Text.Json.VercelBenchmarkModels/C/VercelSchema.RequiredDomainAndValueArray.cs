...
public readonly partial struct VercelSchema
{
    ...
    public readonly partial struct RequiredDomainAndValueArray
#if NET8_0_OR_GREATER
        : IJsonElement<RequiredDomainAndValueArray>,
          IFormattable,
          ISpanFormattable,
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RequiredDomainAndValueArray"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal RequiredDomainAndValueArray(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static RequiredDomainAndValueArray DefaultInstance { get; }
        ...
        public Corvus.VercelBenchmark.Current.VercelSchema.RequiredDomainAndValueArray.RequiredDomainAndValue this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.VercelBenchmark.Current.VercelSchema.RequiredDomainAndValueArray.RequiredDomainAndValue>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.VercelBenchmark.Current.VercelSchema.RequiredDomainAndValueArray.RequiredDomainAndValue> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.VercelBenchmark.Current.VercelSchema.RequiredDomainAndValueArray.RequiredDomainAndValue>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in RequiredDomainAndValueArray left, in RequiredDomainAndValueArray right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in RequiredDomainAndValueArray left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(RequiredDomainAndValueArray instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator RequiredDomainAndValueArray(JsonElement instance)
        {
            return RequiredDomainAndValueArray.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiredDomainAndValueArray From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiredDomainAndValueArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RequiredDomainAndValueArray>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiredDomainAndValueArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RequiredDomainAndValueArray>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiredDomainAndValueArray ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RequiredDomainAndValueArray>(json, options);
        }
        ...
        /// </exception>
        public static RequiredDomainAndValueArray ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<RequiredDomainAndValueArray>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredDomainAndValueArray? result)
        {
            return JsonElementHelpers.TryParseValue<RequiredDomainAndValueArray>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new RequiredDomainAndValueArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static RequiredDomainAndValueArray IJsonElement<RequiredDomainAndValueArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"RequiredDomainAndValueArray: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="RequiredDomainAndValueArray"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="RequiredDomainAndValueArray"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public RequiredDomainAndValueArray Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<RequiredDomainAndValueArray>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="RequiredDomainAndValueArray"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public RequiredDomainAndValueArray Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<RequiredDomainAndValueArray>(_idx);
            }
