...
public readonly partial struct VercelSchema
{
    ...
    public readonly partial struct RequiredHeadersAndSourceEntityArray
    {
...
#endif
        {
            ...
            /// </remarks>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public void InsertItem(int itemIndex, in Corvus.VercelBenchmark.Current.VercelSchema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.Source value)
            {
                CheckValidInstance();
