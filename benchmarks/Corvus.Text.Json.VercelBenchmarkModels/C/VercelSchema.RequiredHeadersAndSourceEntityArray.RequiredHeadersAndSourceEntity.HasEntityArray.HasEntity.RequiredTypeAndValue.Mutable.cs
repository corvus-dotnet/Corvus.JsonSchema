                ...
                public readonly partial struct HasEntity
                {
                    ...
                    public readonly partial struct RequiredTypeAndValue
                    {
...
#endif
                        {
                            ...
                            /// </para>
                            /// </remarks>
                            public Corvus.VercelBenchmark.Current.VercelSchema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.HasEntityArray.HasEntity.RequiredTypeAndValue.TheTypeOfRequestElementToCheck.Mutable Type
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.TypeUtf8, out Corvus.VercelBenchmark.Current.VercelSchema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.HasEntityArray.HasEntity.RequiredTypeAndValue.TheTypeOfRequestElementToCheck.Mutable value))
                                    {
                                        return value;
                                    }
                            ...
                            /// </para>
                            /// </remarks>
                            public Corvus.VercelBenchmark.Current.VercelSchema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.HasEntityArray.HasEntity.RequiredTypeAndValue.ValueEntity.Mutable Value
                            {
                                get
                                {
                                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ValueUtf8, out Corvus.VercelBenchmark.Current.VercelSchema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.HasEntityArray.HasEntity.RequiredTypeAndValue.ValueEntity.Mutable value))
                                    {
                                        return value;
                                    }
                            ...
                            public void SetType(scoped in Corvus.VercelBenchmark.Current.VercelSchema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.HasEntityArray.HasEntity.RequiredTypeAndValue.TheTypeOfRequestElementToCheck.Source value)
                            {
                                CheckValidInstance();
                            ...
                            /// </summary>
                            /// <param name="value">The value of the property to add.</param>
                            public void SetValue(scoped in Corvus.VercelBenchmark.Current.VercelSchema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.HasEntityArray.HasEntity.RequiredTypeAndValue.ValueEntity.Source value)
                            {
                                CheckValidInstance();
                        ...
                        public ref struct Source
                        {
                            ...
                            private readonly Corvus.VercelBenchmark.Current.VercelSchema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.HasEntityArray.HasEntity.RequiredTypeAndValue.ValueEntity.Source _createArg1;
                            ...
                            internal Source(Corvus.VercelBenchmark.Current.VercelSchema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.HasEntityArray.HasEntity.RequiredTypeAndValue.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                            internal Source(scoped in Corvus.VercelBenchmark.Current.VercelSchema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.HasEntityArray.HasEntity.RequiredTypeAndValue.ValueEntity.Source arg1)
                            {
                                _createArg1 = arg1;
                                _kind = Kind.Create;
                            }
                            ...
                            #endif
                        {
                            ...
                            internal Source(scoped in TContext context, Corvus.VercelBenchmark.Current.VercelSchema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.HasEntityArray.HasEntity.RequiredTypeAndValue.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                        ...
                        public ref struct Builder
                        {
                            ...
                            /// </summary>
                            internal static void Create(ref ComplexValueBuilder builder, in Corvus.VercelBenchmark.Current.VercelSchema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.HasEntityArray.HasEntity.RequiredTypeAndValue.ValueEntity.Source value)
                            {
                                builder.AddPrebakedProperty(JsonPropertyNamesPrebaked.Type, Corvus.VercelBenchmark.Current.VercelSchema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.HasEntityArray.HasEntity.RequiredTypeAndValue.TheTypeOfRequestElementToCheck.ConstInstance);
                            ...
                            /// Creates an instance of a <see cref="RequiredTypeAndValue"/>.
                            /// </summary>
                            public void Create(in Corvus.VercelBenchmark.Current.VercelSchema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.HasEntityArray.HasEntity.RequiredTypeAndValue.ValueEntity.Source value)
                            {
                            ...
                            internal static void BuildCreateValue(scoped in Corvus.VercelBenchmark.Current.VercelSchema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.HasEntityArray.HasEntity.RequiredTypeAndValue.ValueEntity.Source arg1, ref ComplexValueBuilder o)
                            {
                                o.StartObject();
                                Create(ref o, arg1);
                                o.EndObject();
                        ...
                        /// <returns>The source from which to build the value.</returns>
                        public static Source Build(scoped in Corvus.VercelBenchmark.Current.VercelSchema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.HasEntityArray.HasEntity.RequiredTypeAndValue.ValueEntity.Source value)
                        {
                        ...
                        public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.VercelBenchmark.Current.VercelSchema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.HasEntityArray.HasEntity.RequiredTypeAndValue.ValueEntity.Source value, int initialCapacity = 30)
                        {
                            JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                            ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                            cvb.StartObject();
                        ...
                        public static ParsedJsonDocument<RequiredTypeAndValue> Create(in Corvus.VercelBenchmark.Current.VercelSchema.RequiredHeadersAndSourceEntityArray.RequiredHeadersAndSourceEntity.HasEntityArray.HasEntity.RequiredTypeAndValue.ValueEntity.Source value, int initialCapacity = 30)
                        {
                            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                            try
                            {
