        ...
        public readonly partial struct RequiredPathAndSchedule
        {
...
#endif
            {
                ...
                public void SetSchedule(in Corvus.VercelBenchmark.Current.VercelSchema.RequiredPathAndScheduleArray.RequiredPathAndSchedule.ScheduleEntity.Source value)
                {
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsProperty(JsonPropertyNamesEscaped.Schedule, ref cvb, escapeName: false, nameRequiresUnescaping: false);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
            ...
            public ref struct Builder
            {
                    ...
                    in Corvus.VercelBenchmark.Current.VercelSchema.RequiredPathAndScheduleArray.RequiredPathAndSchedule.ScheduleEntity.Source schedule)
                {
                    ...
                    schedule.AddAsProperty(JsonPropertyNamesEscaped.Schedule, ref builder, escapeName: false);
                }
