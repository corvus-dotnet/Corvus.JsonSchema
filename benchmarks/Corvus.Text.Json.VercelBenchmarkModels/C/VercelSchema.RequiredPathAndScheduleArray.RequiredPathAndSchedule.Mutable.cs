    ...
    public readonly partial struct RequiredPathAndScheduleArray
    {
        ...
        public readonly partial struct RequiredPathAndSchedule
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RequiredPathAndSchedule instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RequiredPathAndSchedule"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RequiredPathAndSchedule(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.VercelBenchmark.Current.VercelSchema.RequiredPathAndScheduleArray.RequiredPathAndSchedule.PathEntity.Mutable Path
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PathUtf8, out Corvus.VercelBenchmark.Current.VercelSchema.RequiredPathAndScheduleArray.RequiredPathAndSchedule.PathEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                /// <summary>
                /// Gets the <c>schedule</c> property.
                /// </summary>
                /// <remarks>
                /// <para>
                /// If the instance is valid, this property will not be <see cref="JsonValueKind.Undefined"/>.
                /// </para>
                /// </remarks>
                public Corvus.VercelBenchmark.Current.VercelSchema.RequiredPathAndScheduleArray.RequiredPathAndSchedule.ScheduleEntity.Mutable Schedule
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ScheduleUtf8, out Corvus.VercelBenchmark.Current.VercelSchema.RequiredPathAndScheduleArray.RequiredPathAndSchedule.ScheduleEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new RequiredPathAndSchedule(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                public void SetPath(scoped in Corvus.VercelBenchmark.Current.VercelSchema.RequiredPathAndScheduleArray.RequiredPathAndSchedule.PathEntity.Source value)
                {
                    CheckValidInstance();
                ...
                /// <summary>
                /// Set the <c>schedule</c> property.
                /// </summary>
                /// <param name="value">The value of the property to add.</param>
                public void SetSchedule(scoped in Corvus.VercelBenchmark.Current.VercelSchema.RequiredPathAndScheduleArray.RequiredPathAndSchedule.ScheduleEntity.Source value)
                {
                    CheckValidInstance();

                    if (value.IsUndefined)
                    {
                        CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("schedule");
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ScheduleUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                    ...
                    {
                        // We are going to insert the new value
                        value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Schedule, ref cvb);
                        int endIndex = _idx + _parent.GetDbSize(_idx, false);
                        _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                    }
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RequiredPathAndSchedule.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="RequiredPathAndSchedule"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="RequiredPathAndSchedule"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredPathAndSchedule Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<RequiredPathAndSchedule>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="RequiredPathAndSchedule"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredPathAndSchedule Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RequiredPathAndSchedule>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.VercelBenchmark.Current.VercelSchema.RequiredPathAndScheduleArray.RequiredPathAndSchedule.PathEntity.Source _createArg1;
                private readonly Corvus.VercelBenchmark.Current.VercelSchema.RequiredPathAndScheduleArray.RequiredPathAndSchedule.ScheduleEntity.Source _createArg2;
                ...
                internal Source(Corvus.VercelBenchmark.Current.VercelSchema.RequiredPathAndScheduleArray.RequiredPathAndSchedule.Builder.Build value) {_objectBuilder = value; _kind = Kind.Builder; }

                internal Source(scoped in Corvus.VercelBenchmark.Current.VercelSchema.RequiredPathAndScheduleArray.RequiredPathAndSchedule.PathEntity.Source arg1, scoped in Corvus.VercelBenchmark.Current.VercelSchema.RequiredPathAndScheduleArray.RequiredPathAndSchedule.ScheduleEntity.Source arg2)
                {
                    _createArg1 = arg1;
                    _createArg2 = arg2;
                    _kind = Kind.Create;
                ...
                public static implicit operator Source(RequiredPathAndSchedule instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.VercelBenchmark.Current.VercelSchema.RequiredPathAndScheduleArray.RequiredPathAndSchedule.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="RequiredPathAndSchedule"/>.
                /// </summary>
                internal static void Create(
                    ref ComplexValueBuilder builder,
                    in Corvus.VercelBenchmark.Current.VercelSchema.RequiredPathAndScheduleArray.RequiredPathAndSchedule.PathEntity.Source path,
                    in Corvus.VercelBenchmark.Current.VercelSchema.RequiredPathAndScheduleArray.RequiredPathAndSchedule.ScheduleEntity.Source schedule)
                {
                    path.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Path, ref builder);
                    schedule.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Schedule, ref builder);
                }

                /// <summary>
                /// Creates an instance of a <see cref="RequiredPathAndSchedule"/>.
                /// </summary>
                public void Create(in Corvus.VercelBenchmark.Current.VercelSchema.RequiredPathAndScheduleArray.RequiredPathAndSchedule.PathEntity.Source path, in Corvus.VercelBenchmark.Current.VercelSchema.RequiredPathAndScheduleArray.RequiredPathAndSchedule.ScheduleEntity.Source schedule)
                {
                    Create(ref _builder, path, schedule);
                }
                ...
                internal static void BuildCreateValue(scoped in Corvus.VercelBenchmark.Current.VercelSchema.RequiredPathAndScheduleArray.RequiredPathAndSchedule.PathEntity.Source arg1, scoped in Corvus.VercelBenchmark.Current.VercelSchema.RequiredPathAndScheduleArray.RequiredPathAndSchedule.ScheduleEntity.Source arg2, ref ComplexValueBuilder o)
                {
                    o.StartObject();
            ...
            /// <param name="schedule">The value of the <c>"schedule"</c> property.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Source Build(scoped in Corvus.VercelBenchmark.Current.VercelSchema.RequiredPathAndScheduleArray.RequiredPathAndSchedule.PathEntity.Source path, scoped in Corvus.VercelBenchmark.Current.VercelSchema.RequiredPathAndScheduleArray.RequiredPathAndSchedule.ScheduleEntity.Source schedule)
            {
                return new Source(path, schedule);
            }
            ...
            /// <param name="schedule">The value of the property.</param>
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>An instance of a mutable document initialized with the given property values.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.VercelBenchmark.Current.VercelSchema.RequiredPathAndScheduleArray.RequiredPathAndSchedule.PathEntity.Source path, in Corvus.VercelBenchmark.Current.VercelSchema.RequiredPathAndScheduleArray.RequiredPathAndSchedule.ScheduleEntity.Source schedule, int initialCapacity = 30)
            {
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(path, schedule);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<RequiredPathAndSchedule, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RequiredPathAndSchedule> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RequiredPathAndSchedule>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RequiredPathAndSchedule> Create<TContext>(
            ...
            public static ParsedJsonDocument<RequiredPathAndSchedule> Create(in Corvus.VercelBenchmark.Current.VercelSchema.RequiredPathAndScheduleArray.RequiredPathAndSchedule.PathEntity.Source path, in Corvus.VercelBenchmark.Current.VercelSchema.RequiredPathAndScheduleArray.RequiredPathAndSchedule.ScheduleEntity.Source schedule, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
