...
public readonly partial struct VercelSchema
{
    ...
    public readonly partial struct RequiredPathAndScheduleArray
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.VercelBenchmark.Current.VercelSchema.RequiredPathAndScheduleArray.RequiredPathAndSchedule.PathEntity Path
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PathUtf8, out Corvus.VercelBenchmark.Current.VercelSchema.RequiredPathAndScheduleArray.RequiredPathAndSchedule.PathEntity value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.VercelBenchmark.Current.VercelSchema.RequiredPathAndScheduleArray.RequiredPathAndSchedule.ScheduleEntity Schedule
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ScheduleUtf8, out Corvus.VercelBenchmark.Current.VercelSchema.RequiredPathAndScheduleArray.RequiredPathAndSchedule.ScheduleEntity value))
                    {
                        return value;
                    }
            ...
            private static class JsonPropertyNamesPrebaked
            {
                ...
                /// <summary>
                /// Gets the pre-baked property name blob for <see cref="Schedule"/>.
                /// </summary>
                public static ReadOnlySpan<byte> Schedule => [0xA5, 0x00, 0x00, 0x00, 0x22, 0x73, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6C, 0x65, 0x22];
            }
        }
    }
}
