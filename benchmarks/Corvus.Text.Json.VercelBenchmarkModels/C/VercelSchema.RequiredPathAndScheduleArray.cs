...
public readonly partial struct VercelSchema
{
...
#endif
    {
        ...
        public Corvus.VercelBenchmark.Current.VercelSchema.RequiredPathAndScheduleArray.RequiredPathAndSchedule this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.VercelBenchmark.Current.VercelSchema.RequiredPathAndScheduleArray.RequiredPathAndSchedule>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.VercelBenchmark.Current.VercelSchema.RequiredPathAndScheduleArray.RequiredPathAndSchedule> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.VercelBenchmark.Current.VercelSchema.RequiredPathAndScheduleArray.RequiredPathAndSchedule>(_parent, _idx);
        }
