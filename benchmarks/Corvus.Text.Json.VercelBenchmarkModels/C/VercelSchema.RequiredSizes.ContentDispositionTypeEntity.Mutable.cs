    ...
    public readonly partial struct RequiredSizes
    {
        ...
        public readonly partial struct ContentDispositionTypeEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ContentDispositionTypeEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ContentDispositionTypeEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ContentDispositionTypeEntity(Mutable instance)
                {
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ContentDispositionTypeEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public readonly ContentDispositionTypeEntity Clone()
                {
                    CheckValidInstance();
                ...
                /// </para>
                /// </remarks>
                public readonly ContentDispositionTypeEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ContentDispositionTypeEntity>(_idx);
                }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ContentDispositionTypeEntity instance) => new(JsonElement.From(instance));
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator Source(KnownValues value) => (ContentDispositionTypeEntity)value;
            ...
            {
                return workspace.CreateBuilder<ContentDispositionTypeEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ContentDispositionTypeEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ContentDispositionTypeEntity>();
                }
                finally
                {
