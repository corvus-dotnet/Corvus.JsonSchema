    ...
    public readonly partial struct RequiredSizes
    {
        ...
        public readonly partial struct ContentSecurityPolicyEntity
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(ContentSecurityPolicyEntity instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="ContentSecurityPolicyEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator ContentSecurityPolicyEntity(Mutable instance)
                {
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new ContentSecurityPolicyEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"ContentSecurityPolicyEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="ContentSecurityPolicyEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="ContentSecurityPolicyEntity"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly ContentSecurityPolicyEntity Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<ContentSecurityPolicyEntity>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="ContentSecurityPolicyEntity"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly ContentSecurityPolicyEntity Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<ContentSecurityPolicyEntity>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                public static implicit operator Source(ContentSecurityPolicyEntity instance) => new(JsonElement.From(instance));
            ...
            {
                return workspace.CreateBuilder<ContentSecurityPolicyEntity, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<ContentSecurityPolicyEntity> Create(
                scoped in Source value, int initialCapacity = 1)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<ContentSecurityPolicyEntity>();
                }
                finally
                {
