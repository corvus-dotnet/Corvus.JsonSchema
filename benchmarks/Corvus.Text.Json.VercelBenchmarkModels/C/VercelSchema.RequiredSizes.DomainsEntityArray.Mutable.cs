    ...
    public readonly partial struct RequiredSizes
    {
        ...
        public readonly partial struct DomainsEntityArray
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(DomainsEntityArray instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="DomainsEntityArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator DomainsEntityArray(Mutable instance)
                {
                ...
                public Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.DomainsEntityArray.DomainsEntity.Mutable this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.DomainsEntityArray.DomainsEntity.Mutable>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.DomainsEntityArray.DomainsEntity.Mutable> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.DomainsEntityArray.DomainsEntity.Mutable>(_parent, _idx);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new DomainsEntityArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"DomainsEntityArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetItem(int itemIndex, in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.DomainsEntityArray.DomainsEntity.Source value)
                {
                    CheckValidInstance();
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void InsertItem(int itemIndex, scoped in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.DomainsEntityArray.DomainsEntity.Source value)
                {
                    CheckValidInstance();
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void AddItem(scoped in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.DomainsEntityArray.DomainsEntity.Source value)
                {
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Remove(in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.DomainsEntityArray.DomainsEntity item)
                {
                    CheckValidInstance();
                    if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.DomainsEntityArray.DomainsEntity>(this, in item))
                    {
                        return false;
                    }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void RemoveWhere(JsonPredicate<Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.DomainsEntityArray.DomainsEntity> predicate)
                {
                    CheckValidInstance();
                    JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.DomainsEntityArray.DomainsEntity>(this, predicate);
                    _documentVersion = _parent.Version;
                }
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Replace(in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.DomainsEntityArray.DomainsEntity oldItem, in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.DomainsEntityArray.DomainsEntity.Source newItem)
                {
                    CheckValidInstance();
                    ...
                    var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.DomainsEntityArray.DomainsEntity>(_parent, _idx);

                    while (enumerator.MoveNext())
                    {
                        Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.DomainsEntityArray.DomainsEntity current = enumerator.Current;
                ...
                /// <summary>
                /// Gets a <see cref="DomainsEntityArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="DomainsEntityArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly DomainsEntityArray Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<DomainsEntityArray>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="DomainsEntityArray"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly DomainsEntityArray Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<DomainsEntityArray>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.DomainsEntityArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(DomainsEntityArray instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.DomainsEntityArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// </summary>
                public void AddItem(in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.DomainsEntityArray.DomainsEntity.Source value)
                {
            ...
            {
                return workspace.CreateBuilder<DomainsEntityArray, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<DomainsEntityArray> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<DomainsEntityArray>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<DomainsEntityArray> Create<TContext>(
