...
public readonly partial struct VercelSchema
{
    ...
    public readonly partial struct RequiredSizes
    {
...
#endif
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="DomainsEntityArray"/> struct.
            /// </summary>
            /// <param name="value">The value from which to construct the instance.</param>
            internal DomainsEntityArray(IJsonDocument parent, int idx)
            {
                Debug.Assert(idx >= 0);
                _parent = parent;
                _idx = idx;
            ...
            /// </summary>
            public static DomainsEntityArray DefaultInstance { get; }
            ...
            public Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.DomainsEntityArray.DomainsEntity this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.DomainsEntityArray.DomainsEntity>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.DomainsEntityArray.DomainsEntity> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.DomainsEntityArray.DomainsEntity>(_parent, _idx);
            }
            ...
            /// </returns>
            public static bool operator ==(in DomainsEntityArray left, in DomainsEntityArray right)
            {
            ...
            /// <c>True</c> if the values are equal.
            /// </returns>
            public static bool operator ==(in DomainsEntityArray left, in JsonElement right)
            {
                return left.Equals(right);
            }
            ...
            public static implicit operator JsonElement(DomainsEntityArray instance)
            {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator DomainsEntityArray(JsonElement instance)
            {
                return DomainsEntityArray.From(instance);
            }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DomainsEntityArray From<T>(in T instance)
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DomainsEntityArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DomainsEntityArray>(utf8Json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DomainsEntityArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DomainsEntityArray>(json, options);
            }
            ...
            /// </exception>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static DomainsEntityArray ParseValue(string json, JsonDocumentOptions options = default)
            {
                return JsonElementHelpers.ParseValue<DomainsEntityArray>(json, options);
            }
            ...
            /// </exception>
            public static DomainsEntityArray ParseValue(ref Utf8JsonReader reader)
            {
                return JsonElementHelpers.ParseValue<DomainsEntityArray>(ref reader);
            }
            ...
            ///   A value could not be read from the reader.
            /// </exception>
            public static bool TryParseValue(ref Utf8JsonReader reader, out DomainsEntityArray? result)
            {
                return JsonElementHelpers.TryParseValue<DomainsEntityArray>(ref reader, out result);
            }
...
#if NET
            static DomainsEntityArray IJsonElement<DomainsEntityArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

            [DebuggerBrowsable(DebuggerBrowsableState.Never)]
            private string DebuggerDisplay => $"DomainsEntityArray: ValueKind = {ValueKind} : \"{ToString()}\"";
            ...
            /// </para>
            /// </remarks>
            public DomainsEntityArray Clone()
            {
                CheckValidInstance();
            ...
            /// </para>
            /// </remarks>
            public DomainsEntityArray Freeze()
            {
                CheckValidInstance();
                if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                {
                    return mutable.FreezeElement<DomainsEntityArray>(_idx);
                }
