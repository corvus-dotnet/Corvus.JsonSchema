        ...
        public readonly partial struct FormatsEntityArray
        {
            ...
            public readonly partial struct FormatsEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(FormatsEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="FormatsEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator FormatsEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"FormatsEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly FormatsEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly FormatsEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<FormatsEntity>(_idx);
                    }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(FormatsEntity instance) => new(JsonElement.From(instance));
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator Source(KnownValues value) => (FormatsEntity)value;
                ...
                {
                    return workspace.CreateBuilder<FormatsEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<FormatsEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<FormatsEntity>();
                    }
                    finally
                    {
