    ...
    public readonly partial struct RequiredSizes
    {
        ...
        public readonly partial struct FormatsEntityArray
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(FormatsEntityArray instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="FormatsEntityArray"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator FormatsEntityArray(Mutable instance)
                {
                ...
                public Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.FormatsEntityArray.FormatsEntity.Mutable this[int index]
                {
                    get
                    {
                        CheckValidInstance();
                        return _parent.GetArrayIndexElement<Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.FormatsEntityArray.FormatsEntity.Mutable>(_idx, index);
                    }
                }
                ...
                /// </summary>
                /// <exception cref="InvalidOperationException">The value is not an array.</exception>
                public ArrayEnumerator<Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.FormatsEntityArray.FormatsEntity.Mutable> EnumerateArray()
                {
                    CheckValidInstance();
                    return EnumeratorCreator.CreateArrayEnumerator<Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.FormatsEntityArray.FormatsEntity.Mutable>(_parent, _idx);
                }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new FormatsEntityArray(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"FormatsEntityArray.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                /// <summary>
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void SetItem(int itemIndex, in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.FormatsEntityArray.FormatsEntity.Source value)
                {
                    CheckValidInstance();
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void InsertItem(int itemIndex, scoped in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.FormatsEntityArray.FormatsEntity.Source value)
                {
                    CheckValidInstance();
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void AddItem(scoped in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.FormatsEntityArray.FormatsEntity.Source value)
                {
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Remove(in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.FormatsEntityArray.FormatsEntity item)
                {
                    CheckValidInstance();
                    if (!JsonElementHelpers.RemoveFirstUnsafe<Mutable, Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.FormatsEntityArray.FormatsEntity>(this, in item))
                    {
                        return false;
                    }
                ...
                /// </remarks>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public void RemoveWhere(JsonPredicate<Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.FormatsEntityArray.FormatsEntity> predicate)
                {
                    CheckValidInstance();
                    JsonElementHelpers.RemoveWhereUnsafe<Mutable, Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.FormatsEntityArray.FormatsEntity>(this, predicate);
                    _documentVersion = _parent.Version;
                }
                ...
                ///   The parent <see cref="JsonDocument"/> has been disposed.
                /// </exception>
                public bool Replace(in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.FormatsEntityArray.FormatsEntity oldItem, in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.FormatsEntityArray.FormatsEntity.Source newItem)
                {
                    CheckValidInstance();
                    ...
                    var enumerator = EnumeratorCreator.CreateArrayEnumerator<Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.FormatsEntityArray.FormatsEntity>(_parent, _idx);

                    while (enumerator.MoveNext())
                    {
                        Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.FormatsEntityArray.FormatsEntity current = enumerator.Current;
                ...
                /// <summary>
                /// Gets a <see cref="FormatsEntityArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="FormatsEntityArray"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly FormatsEntityArray Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<FormatsEntityArray>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="FormatsEntityArray"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly FormatsEntityArray Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<FormatsEntityArray>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                internal Source(Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.FormatsEntityArray.Builder.Build value) {_arrayBuilder = value; _kind = Kind.Builder; }

                public static implicit operator Source(FormatsEntityArray instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                internal Source(scoped in TContext context, Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.FormatsEntityArray.Builder.Build<TContext> value) {_context = context; _arrayBuilder = value; _kind = Kind.Builder; }
            ...
            public ref struct Builder
            {
                ...
                /// </summary>
                public void AddItem(in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.FormatsEntityArray.FormatsEntity.Source value)
                {
            ...
            {
                return workspace.CreateBuilder<FormatsEntityArray, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<FormatsEntityArray> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<FormatsEntityArray>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<FormatsEntityArray> Create<TContext>(
