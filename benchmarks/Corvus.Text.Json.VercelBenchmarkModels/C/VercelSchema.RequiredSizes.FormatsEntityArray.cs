...
public readonly partial struct VercelSchema
{
    ...
    public readonly partial struct RequiredSizes
    {
...
#endif
        {
            ...
            public Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.FormatsEntityArray.FormatsEntity this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.FormatsEntityArray.FormatsEntity>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.FormatsEntityArray.FormatsEntity> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.FormatsEntityArray.FormatsEntity>(_parent, _idx);
            }
