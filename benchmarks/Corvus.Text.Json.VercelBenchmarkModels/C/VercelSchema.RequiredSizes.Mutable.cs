...
public readonly partial struct VercelSchema
{
    ...
    public readonly partial struct RequiredSizes
    {
...
#endif
        {
            ...
            public void SetContentDispositionType(scoped in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.ContentDispositionTypeEntity.Source value)
            {
                ...
                else
                {
                    ...
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ContentDispositionType, ref cvb);
            ...
            public void SetDangerouslyAllowSvg(scoped in Corvus.VercelBenchmark.Current.JsonBoolean.Source value)
            {
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.DangerouslyAllowSvg, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            public void SetDomains(scoped in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.DomainsEntityArray.Source value)
            {
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Domains, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            public void SetFormats(scoped in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.FormatsEntityArray.Source value)
            {
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Formats, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            public void SetMinimumCacheTtl(scoped in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.MinimumCacheTtlEntity.Source value)
            {
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.MinimumCacheTtl, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            public void SetRemotePatterns(scoped in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.RequiredHostnameArray.Source value)
            {
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.RemotePatterns, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            public void SetSizes(scoped in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.JsonNumberArray.Source value)
            {
                ...
                {
                    // We are going to insert the new value
                    value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Sizes, ref cvb);
                    int endIndex = _idx + _parent.GetDbSize(_idx, false);
                    _parent.InsertAndDispose(_idx, endIndex, ref cvb);
                }
            ...
            /// <summary>
            /// Gets a <see cref="RequiredSizes"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </summary>
            /// <returns>
            /// A <see cref="RequiredSizes"/> which can be safely stored beyond the lifetime of the
            /// original document.
            /// </returns>
            /// <remarks>
            /// <para>
            ...
            /// </para>
            /// </remarks>
            public readonly RequiredSizes Clone()
            {
                CheckValidInstance();
                return _parent.CloneElement<RequiredSizes>(_idx);
            }
            ...
            /// </summary>
            /// <returns>
            /// An immutable <see cref="RequiredSizes"/> that lives for the lifetime of its
            ...
            /// </para>
            /// </remarks>
            public readonly RequiredSizes Freeze()
            {
                CheckValidInstance();
                return _parent.FreezeElement<RequiredSizes>(_idx);
            }
        }
        ...
        public ref struct Source
        {
            ...
            private readonly Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.JsonNumberArray.Source _createArg1;
            private readonly Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.ContentDispositionTypeEntity.Source _createArg2;
            private readonly Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.ContentSecurityPolicyEntity.Source _createArg3;
            private readonly Corvus.VercelBenchmark.Current.JsonBoolean.Source _createArg4;
            private readonly Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.DomainsEntityArray.Source _createArg5;
            private readonly Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.FormatsEntityArray.Source _createArg6;
            private readonly Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.MinimumCacheTtlEntity.Source _createArg7;
            private readonly Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.RequiredHostnameArray.Source _createArg8;
            ...
            #endif
        {
            ...
            private readonly Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.JsonNumberArray.Source<TContext> _createArg1;
            private readonly Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.ContentDispositionTypeEntity.Source _createArg2;
            private readonly Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.ContentSecurityPolicyEntity.Source _createArg3;
            private readonly Corvus.VercelBenchmark.Current.JsonBoolean.Source _createArg4;
            private readonly Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.DomainsEntityArray.Source<TContext> _createArg5;
            private readonly Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.FormatsEntityArray.Source<TContext> _createArg6;
            private readonly Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.MinimumCacheTtlEntity.Source _createArg7;
            private readonly Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.RequiredHostnameArray.Source<TContext> _createArg8;
        ...
        public ref struct Builder
        {
            ...
            {
                sizes.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Sizes, ref builder);
                contentDispositionType.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ContentDispositionType, ref builder);
                contentSecurityPolicy.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.ContentSecurityPolicy, ref builder);
                dangerouslyAllowSvg.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.DangerouslyAllowSvg, ref builder);
                domains.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Domains, ref builder);
                formats.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Formats, ref builder);
                minimumCacheTtl.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.MinimumCacheTtl, ref builder);
                remotePatterns.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.RemotePatterns, ref builder);
            }
        ...
        /// </summary>
        /// <param name="sizes">The value of the <c>"sizes"</c> property.</param>
        /// <param name="contentDispositionType">The value of the <c>"contentDispositionType"</c> property.</param>
        /// <param name="contentSecurityPolicy">The value of the <c>"contentSecurityPolicy"</c> property.</param>
        /// <param name="dangerouslyAllowSvg">The value of the <c>"dangerouslyAllowSVG"</c> property.</param>
        /// <param name="domains">The value of the <c>"domains"</c> property.</param>
        /// <param name="formats">The value of the <c>"formats"</c> property.</param>
        ...
        public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.JsonNumberArray.Source<TContext> sizes, scoped in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.ContentDispositionTypeEntity.Source contentDispositionType = default, scoped in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.ContentSecurityPolicyEntity.Source contentSecurityPolicy = default, scoped in Corvus.VercelBenchmark.Current.JsonBoolean.Source dangerouslyAllowSvg = default, scoped in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.DomainsEntityArray.Source<TContext> domains = default, scoped in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.FormatsEntityArray.Source<TContext> formats = default, scoped in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.MinimumCacheTtlEntity.Source minimumCacheTtl = default, scoped in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.RequiredHostnameArray.Source<TContext> remotePatterns = default)
            ...
            #endif
        {
            return new Source<TContext>(context, sizes, contentDispositionType, contentSecurityPolicy, dangerouslyAllowSvg, domains, formats, minimumCacheTtl, remotePatterns);
        }
        ...
        public static ParsedJsonDocument<RequiredSizes> Create(
            scoped in Source value, int initialCapacity = 30)
        {
            ...
            try
            {
                ...
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder.ToParsedJsonDocument<RequiredSizes>();
            }
            finally
            {
        ...
        /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
        public static ParsedJsonDocument<RequiredSizes> Create<TContext>(
        ...
        public static ParsedJsonDocument<RequiredSizes> Create(in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.JsonNumberArray.Source sizes, in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.ContentDispositionTypeEntity.Source contentDispositionType = default, in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.ContentSecurityPolicyEntity.Source contentSecurityPolicy = default, in Corvus.VercelBenchmark.Current.JsonBoolean.Source dangerouslyAllowSvg = default, in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.DomainsEntityArray.Source domains = default, in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.FormatsEntityArray.Source formats = default, in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.MinimumCacheTtlEntity.Source minimumCacheTtl = default, in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.RequiredHostnameArray.Source remotePatterns = default, int initialCapacity = 30)
        {
            ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
            try
            {
        ...
        /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
        /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
        public static ParsedJsonDocument<RequiredSizes> Create<TContext>(in TContext context, in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.JsonNumberArray.Source<TContext> sizes, in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.ContentDispositionTypeEntity.Source contentDispositionType = default, in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.ContentSecurityPolicyEntity.Source contentSecurityPolicy = default, in Corvus.VercelBenchmark.Current.JsonBoolean.Source dangerouslyAllowSvg = default, in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.DomainsEntityArray.Source<TContext> domains = default, in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.FormatsEntityArray.Source<TContext> formats = default, in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.MinimumCacheTtlEntity.Source minimumCacheTtl = default, in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.RequiredHostnameArray.Source<TContext> remotePatterns = default, int initialCapacity = 30)
            #if NET9_0_OR_GREATER
            where TContext : allows ref struct
            #endif
        {
