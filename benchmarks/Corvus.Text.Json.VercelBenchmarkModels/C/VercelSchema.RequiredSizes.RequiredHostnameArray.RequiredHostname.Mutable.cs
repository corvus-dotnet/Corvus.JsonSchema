        ...
        public readonly partial struct RequiredHostnameArray
        {
            ...
            public readonly partial struct RequiredHostname
            {
...
#endif
                {
                    ...
                    /// </para>
                    /// </remarks>
                    public Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.RequiredHostnameArray.RequiredHostname.HostnameEntity.Mutable Hostname
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HostnameUtf8, out Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.RequiredHostnameArray.RequiredHostname.HostnameEntity.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// </summary>
                    public Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.RequiredHostnameArray.RequiredHostname.PathnameEntity.Mutable Pathname
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PathnameUtf8, out Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.RequiredHostnameArray.RequiredHostname.PathnameEntity.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// </summary>
                    public Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.RequiredHostnameArray.RequiredHostname.PortEntity.Mutable Port
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.PortUtf8, out Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.RequiredHostnameArray.RequiredHostname.PortEntity.Mutable value))
                            {
                                return value;
                            }
                    ...
                    /// </summary>
                    public Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.RequiredHostnameArray.RequiredHostname.ProtocolEntity.Mutable Protocol
                    {
                        get
                        {
                            if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.ProtocolUtf8, out Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.RequiredHostnameArray.RequiredHostname.ProtocolEntity.Mutable value))
                            {
                                return value;
                            }
                    ...
                    public void SetHostname(scoped in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.RequiredHostnameArray.RequiredHostname.HostnameEntity.Source value)
                    {
                        ...
                        else
                        {
                            ...
                            value.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Hostname, ref cvb);
                    ...
                    #endif
                {
                    ...
                    internal Source(scoped in TContext context, Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.RequiredHostnameArray.RequiredHostname.Builder.Build<TContext> value) {_context = context; _objectBuilder = value; _kind = Kind.Builder; }
                ...
                public ref struct Builder
                {
                    ...
                    internal static void Create(
                        ...
                        in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.RequiredHostnameArray.RequiredHostname.HostnameEntity.Source hostname,
                        in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.RequiredHostnameArray.RequiredHostname.PathnameEntity.Source pathname = default,
                        in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.RequiredHostnameArray.RequiredHostname.PortEntity.Source port = default,
                        in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.RequiredHostnameArray.RequiredHostname.ProtocolEntity.Source protocol = default)
                    {
                        hostname.AddAsPrebakedProperty(JsonPropertyNamesPrebaked.Hostname, ref builder);
                ...
                public static JsonDocumentBuilder<Mutable> CreateBuilder(JsonWorkspace workspace, in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.RequiredHostnameArray.RequiredHostname.HostnameEntity.Source hostname, in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.RequiredHostnameArray.RequiredHostname.PathnameEntity.Source pathname = default, in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.RequiredHostnameArray.RequiredHostname.PortEntity.Source port = default, in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.RequiredHostnameArray.RequiredHostname.ProtocolEntity.Source protocol = default, int initialCapacity = 30)
                {
                    JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1);
                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                    cvb.StartObject();
                ...
                public static ParsedJsonDocument<RequiredHostname> Create(
                    scoped in Source value, int initialCapacity = 30)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<RequiredHostname>();
                    }
                    finally
                    {
                ...
                /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
                /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
                public static ParsedJsonDocument<RequiredHostname> Create<TContext>(
                ...
                public static ParsedJsonDocument<RequiredHostname> Create(in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.RequiredHostnameArray.RequiredHostname.HostnameEntity.Source hostname, in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.RequiredHostnameArray.RequiredHostname.PathnameEntity.Source pathname = default, in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.RequiredHostnameArray.RequiredHostname.PortEntity.Source port = default, in Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.RequiredHostnameArray.RequiredHostname.ProtocolEntity.Source protocol = default, int initialCapacity = 30)
                {
                    ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                    try
                    {
