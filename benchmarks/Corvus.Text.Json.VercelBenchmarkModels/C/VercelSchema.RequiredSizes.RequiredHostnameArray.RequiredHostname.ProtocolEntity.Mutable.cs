    ...
    public readonly partial struct RequiredSizes
    {
        ...
        public readonly partial struct RequiredHostnameArray
        {
            ...
            public readonly partial struct RequiredHostname
            {
                ...
                public readonly partial struct ProtocolEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(ProtocolEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="ProtocolEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator ProtocolEntity(Mutable instance)
                        {
                        ...
                        {
                            return
                                (obj is IJsonElement value && Equals(new ProtocolEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"ProtocolEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// <summary>
                        /// Gets a <see cref="ProtocolEntity"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </summary>
                        /// <returns>
                        /// A <see cref="ProtocolEntity"/> which can be safely stored beyond the lifetime of the
                        /// original document.
                        /// </returns>
                        /// <remarks>
                        /// <para>
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly ProtocolEntity Clone()
                        {
                            CheckValidInstance();
                            return _parent.CloneElement<ProtocolEntity>(_idx);
                        }
                        ...
                        /// </summary>
                        /// <returns>
                        /// An immutable <see cref="ProtocolEntity"/> that lives for the lifetime of its
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly ProtocolEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<ProtocolEntity>(_idx);
                        }
                        ...
                        /// <param name="matchHttp">Match 1st item.</param>
                        /// <param name="matchHttps">Match 2nd item.</param>
                        /// <param name="defaultMatch">Match any other value.</param>
                        /// <returns>An instance of the value returned by the match function.</returns>
                        public TResult Match<TContext, TResult>(
                            in TContext context,
                            Func<TContext, TResult> matchHttp,
                            Func<TContext, TResult> matchHttps,
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(ProtocolEntity instance) => new(JsonElement.From(instance));
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator Source(KnownValues value) => (ProtocolEntity)value;
                    ...
                    {
                        return workspace.CreateBuilder<ProtocolEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<ProtocolEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<ProtocolEntity>();
                        }
                        finally
                        {
