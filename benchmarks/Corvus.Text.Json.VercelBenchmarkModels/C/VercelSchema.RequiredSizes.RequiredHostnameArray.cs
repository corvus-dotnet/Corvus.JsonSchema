...
public readonly partial struct VercelSchema
{
    ...
    public readonly partial struct RequiredSizes
    {
...
#endif
        {
            ...
            public Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.RequiredHostnameArray.RequiredHostname this[int index]
            {
                get
                {
                    CheckValidInstance();
                    return _parent.GetArrayIndexElement<Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.RequiredHostnameArray.RequiredHostname>(_idx, index);
                }
            }
            ...
            /// </summary>
            /// <exception cref="InvalidOperationException">The value is not an array.</exception>
            public ArrayEnumerator<Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.RequiredHostnameArray.RequiredHostname> EnumerateArray()
            {
                CheckValidInstance();
                return EnumeratorCreator.CreateArrayEnumerator<Corvus.VercelBenchmark.Current.VercelSchema.RequiredSizes.RequiredHostnameArray.RequiredHostname>(_parent, _idx);
            }
