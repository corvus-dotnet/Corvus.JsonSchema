    ...
    public readonly partial struct RequiredUseArray
    {
        ...
        public readonly partial struct RequiredUse
        {
...
#endif
            {
                ...
                public static explicit operator Mutable(RequiredUse instance)
                {
                ...
                /// <returns>An immutable instance of a <see cref="RequiredUse"/>, initialized from the <see cref="Mutable"/> value.</returns>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RequiredUse(Mutable instance)
                {
                ...
                /// </para>
                /// </remarks>
                public Corvus.VercelBenchmark.Current.VercelSchema.RequiredUseArray.RequiredUse.SrcEntity.Mutable Src
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SrcUtf8, out Corvus.VercelBenchmark.Current.VercelSchema.RequiredUseArray.RequiredUse.SrcEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                /// </para>
                /// </remarks>
                public Corvus.VercelBenchmark.Current.VercelSchema.RequiredUseArray.RequiredUse.UseEntity.Mutable Use
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UseUtf8, out Corvus.VercelBenchmark.Current.VercelSchema.RequiredUseArray.RequiredUse.UseEntity.Mutable value))
                        {
                            return value;
                        }
                ...
                {
                    return
                        (obj is IJsonElement value && Equals(new RequiredUse(value.ParentDocument, value.ParentDocumentIndex))) ||
                ...
                public void SetUse(scoped in Corvus.VercelBenchmark.Current.VercelSchema.RequiredUseArray.RequiredUse.UseEntity.Source value)
                {
                    ...
                    if (value.IsUndefined)
                    {
                        CodeGenThrowHelper.ThrowInvalidOperationException_SetRequiredPropertyToUndefined("use");
                    }

                    ComplexValueBuilder cvb = ComplexValueBuilder.Create(_parent, 2);
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UseUtf8, out IJsonDocument? elementParent, out int elementIdx))
                    {
                        // We are going to replace just the value
                        value.AddAsItem(ref cvb);
                        _parent.OverwriteAndDispose(_idx, elementIdx, elementIdx + elementParent.GetDbSize(elementIdx, true), 1, ref cvb);
                ...
                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RequiredUse.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// <summary>
                /// Gets a <see cref="RequiredUse"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </summary>
                /// <returns>
                /// A <see cref="RequiredUse"/> which can be safely stored beyond the lifetime of the
                /// original document.
                /// </returns>
                /// <remarks>
                /// <para>
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredUse Clone()
                {
                    CheckValidInstance();
                    return _parent.CloneElement<RequiredUse>(_idx);
                }
                ...
                /// </summary>
                /// <returns>
                /// An immutable <see cref="RequiredUse"/> that lives for the lifetime of its
                ...
                /// </para>
                /// </remarks>
                public readonly RequiredUse Freeze()
                {
                    CheckValidInstance();
                    return _parent.FreezeElement<RequiredUse>(_idx);
                }
            }
            ...
            public ref struct Source
            {
                ...
                private readonly Corvus.VercelBenchmark.Current.VercelSchema.RequiredUseArray.RequiredUse.UseEntity.Source _createArg1;
                private readonly Corvus.VercelBenchmark.Current.JsonObject.Source _createArg2;
                private readonly Corvus.VercelBenchmark.Current.VercelSchema.RequiredUseArray.RequiredUse.SrcEntity.Source _createArg3;
                ...
                public static implicit operator Source(RequiredUse instance) => new(JsonElement.From(instance));
                ...
                #endif
            {
                ...
                private readonly Corvus.VercelBenchmark.Current.VercelSchema.RequiredUseArray.RequiredUse.UseEntity.Source _createArg1;
                private readonly Corvus.VercelBenchmark.Current.JsonObject.Source<TContext> _createArg2;
                private readonly Corvus.VercelBenchmark.Current.VercelSchema.RequiredUseArray.RequiredUse.SrcEntity.Source _createArg3;
            ...
            public ref struct Builder
            {
                ...
                /// <summary>
                /// Creates an instance of a <see cref="RequiredUse"/>.
                /// </summary>
                ...
                #endif
                {
                    Create(context, ref _builder, use, config, src);
                }
            ...
            /// </summary>
            /// <param name="use">The value of the <c>"use"</c> property.</param>
            ...
            public static Source<TContext> Build<TContext>(scoped in TContext context, scoped in Corvus.VercelBenchmark.Current.VercelSchema.RequiredUseArray.RequiredUse.UseEntity.Source use, scoped in Corvus.VercelBenchmark.Current.JsonObject.Source<TContext> config = default, scoped in Corvus.VercelBenchmark.Current.VercelSchema.RequiredUseArray.RequiredUse.SrcEntity.Source src = default)
                ...
                #endif
            {
                return new Source<TContext>(context, use, config, src);
            }
            ...
            /// </summary>
            /// <param name="workspace">The JSON workspace.</param>
            /// <param name="use">The value of the property.</param>
                ...
                #endif
            {
                ...
                cvb.StartObject();
                Builder ovb = new(cvb);
                ovb.Create(context, use, config, src);
                cvb = ovb._builder;
                cvb.EndObject();
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            {
                return workspace.CreateBuilder<RequiredUse, Mutable>(this);
            }
            ...
            public static ParsedJsonDocument<RequiredUse> Create(
                scoped in Source value, int initialCapacity = 30)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(cvb.MemberCount == 1);
                    ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                    return documentBuilder.ToParsedJsonDocument<RequiredUse>();
                }
                finally
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RequiredUse> Create<TContext>(
            ...
            public static ParsedJsonDocument<RequiredUse> Create(in Corvus.VercelBenchmark.Current.VercelSchema.RequiredUseArray.RequiredUse.UseEntity.Source use, in Corvus.VercelBenchmark.Current.JsonObject.Source config = default, in Corvus.VercelBenchmark.Current.VercelSchema.RequiredUseArray.RequiredUse.SrcEntity.Source src = default, int initialCapacity = 30)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent();
                try
                {
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given property values. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RequiredUse> Create<TContext>(in TContext context, in Corvus.VercelBenchmark.Current.VercelSchema.RequiredUseArray.RequiredUse.UseEntity.Source use, in Corvus.VercelBenchmark.Current.JsonObject.Source<TContext> config = default, in Corvus.VercelBenchmark.Current.VercelSchema.RequiredUseArray.RequiredUse.SrcEntity.Source src = default, int initialCapacity = 30)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
