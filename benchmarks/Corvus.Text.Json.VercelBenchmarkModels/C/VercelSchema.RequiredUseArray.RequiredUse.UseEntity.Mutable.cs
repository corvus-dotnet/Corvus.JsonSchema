        ...
        public readonly partial struct RequiredUse
        {
            ...
            public readonly partial struct UseEntity
            {
...
#endif
                {
                    ...
                    public static explicit operator Mutable(UseEntity instance)
                    {
                    ...
                    /// <returns>An immutable instance of a <see cref="UseEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator UseEntity(Mutable instance)
                    {
                    ...
                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"UseEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly UseEntity Clone()
                    {
                        CheckValidInstance();
                    ...
                    /// </para>
                    /// </remarks>
                    public readonly UseEntity Freeze()
                    {
                        CheckValidInstance();
                        return _parent.FreezeElement<UseEntity>(_idx);
                    }
                }
                ...
                public ref struct Source
                {
                    ...
                    public static implicit operator Source(UseEntity instance) => new(JsonElement.From(instance));
                ...
                {
                    return workspace.CreateBuilder<UseEntity, Mutable>(this);
                }
                ...
                public static ParsedJsonDocument<UseEntity> Create(
                    scoped in Source value, int initialCapacity = 1)
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(cvb.MemberCount == 1);
                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                        return documentBuilder.ToParsedJsonDocument<UseEntity>();
                    }
                    finally
                    {
