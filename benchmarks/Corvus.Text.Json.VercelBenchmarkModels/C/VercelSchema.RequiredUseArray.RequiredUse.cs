...
public readonly partial struct VercelSchema
{
    ...
    public readonly partial struct RequiredUseArray
    {
...
#endif
        {
            ...
            /// </para>
            /// </remarks>
            public Corvus.VercelBenchmark.Current.VercelSchema.RequiredUseArray.RequiredUse.SrcEntity Src
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.SrcUtf8, out Corvus.VercelBenchmark.Current.VercelSchema.RequiredUseArray.RequiredUse.SrcEntity value))
                    {
                        return value;
                    }
            ...
            /// </para>
            /// </remarks>
            public Corvus.VercelBenchmark.Current.VercelSchema.RequiredUseArray.RequiredUse.UseEntity Use
            {
                get
                {
                    if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.UseUtf8, out Corvus.VercelBenchmark.Current.VercelSchema.RequiredUseArray.RequiredUse.UseEntity value))
                    {
                        return value;
                    }
