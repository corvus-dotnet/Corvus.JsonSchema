...
public readonly partial struct VercelSchema
{
...
#endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RequiredUseArray"/> struct.
        /// </summary>
        /// <param name="value">The value from which to construct the instance.</param>
        internal RequiredUseArray(IJsonDocument parent, int idx)
        {
            Debug.Assert(idx >= 0);
            _parent = parent;
            _idx = idx;
        ...
        /// </summary>
        public static RequiredUseArray DefaultInstance { get; }
        ...
        public Corvus.VercelBenchmark.Current.VercelSchema.RequiredUseArray.RequiredUse this[int index]
        {
            get
            {
                CheckValidInstance();
                return _parent.GetArrayIndexElement<Corvus.VercelBenchmark.Current.VercelSchema.RequiredUseArray.RequiredUse>(_idx, index);
            }
        }
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The value is not an array.</exception>
        public ArrayEnumerator<Corvus.VercelBenchmark.Current.VercelSchema.RequiredUseArray.RequiredUse> EnumerateArray()
        {
            CheckValidInstance();
            return EnumeratorCreator.CreateArrayEnumerator<Corvus.VercelBenchmark.Current.VercelSchema.RequiredUseArray.RequiredUse>(_parent, _idx);
        }
        ...
        /// </returns>
        public static bool operator ==(in RequiredUseArray left, in RequiredUseArray right)
        {
        ...
        /// <c>True</c> if the values are equal.
        /// </returns>
        public static bool operator ==(in RequiredUseArray left, in JsonElement right)
        {
            return left.Equals(right);
        }
        ...
        public static implicit operator JsonElement(RequiredUseArray instance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator RequiredUseArray(JsonElement instance)
        {
            return RequiredUseArray.From(instance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiredUseArray From<T>(in T instance)
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiredUseArray ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RequiredUseArray>(utf8Json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiredUseArray ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RequiredUseArray>(json, options);
        }
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RequiredUseArray ParseValue(string json, JsonDocumentOptions options = default)
        {
            return JsonElementHelpers.ParseValue<RequiredUseArray>(json, options);
        }
        ...
        /// </exception>
        public static RequiredUseArray ParseValue(ref Utf8JsonReader reader)
        {
            return JsonElementHelpers.ParseValue<RequiredUseArray>(ref reader);
        }
        ...
        ///   A value could not be read from the reader.
        /// </exception>
        public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredUseArray? result)
        {
            return JsonElementHelpers.TryParseValue<RequiredUseArray>(ref reader, out result);
        }
        ...
        {
            return
                (obj is IJsonElement value && Equals(new RequiredUseArray(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
        static RequiredUseArray IJsonElement<RequiredUseArray>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private string DebuggerDisplay => $"RequiredUseArray: ValueKind = {ValueKind} : \"{ToString()}\"";
        ...
        /// <summary>
        /// Gets a <see cref="RequiredUseArray"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </summary>
        /// <returns>
        /// A <see cref="RequiredUseArray"/> which can be safely stored beyond the lifetime of the
        /// original document.
        /// </returns>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public RequiredUseArray Clone()
        {
            CheckValidInstance();
            return _parent.CloneElement<RequiredUseArray>(_idx);
        }
        ...
        /// </summary>
        /// <returns>
        /// An immutable <see cref="RequiredUseArray"/> that lives for the lifetime of its
        ...
        /// </para>
        /// </remarks>
        public RequiredUseArray Freeze()
        {
            CheckValidInstance();
            if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
            {
                return mutable.FreezeElement<RequiredUseArray>(_idx);
            }
