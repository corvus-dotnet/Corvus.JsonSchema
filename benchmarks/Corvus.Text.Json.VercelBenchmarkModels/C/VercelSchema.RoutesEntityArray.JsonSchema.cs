...
public readonly partial struct VercelSchema
{
        ...
        : IJsonElement<RoutesEntityArray>
    {
        public static partial class JsonSchema
        {
            ...
            /// </summary>
            public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/properties/routes"u8, buffer, out written);

            /// <summary>
            /// Gets the schema location from which this type was generated.
            /// </summary>
            public const string SchemaLocation = "/properties/routes";

            /// <summary>
            /// Gets the schema location from which this type was generated as a UTF-8 string.
            /// </summary>
            public static ReadOnlySpan<byte> SchemaLocationUtf8 => "/properties/routes"u8;
                ...
                ref JsonSchemaContext context)
            {
                ...
                else
                {
                    ...
                    while (arrayValidation_enumerator.MoveNext())
                    {
                        ...
                        JsonSchemaContext childContext = Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.JsonSchema.PushChildContext(
                            parentDocument,
                        ...
                        Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.JsonSchema.Evaluate(parentDocument, arrayValidation_currentIndex, ref childContext);
