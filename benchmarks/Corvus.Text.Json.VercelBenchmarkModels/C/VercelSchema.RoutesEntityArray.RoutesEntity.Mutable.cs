    ...
    public readonly partial struct RoutesEntityArray
    {
        ...
        public readonly partial struct RoutesEntity
        {
...
#endif
            {
                ...
                public static explicit operator Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.Mutable(Mutable value)
                {
                    return Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.Mutable.From(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.Mutable value)
                {
                    return From(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static explicit operator Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle.Mutable(Mutable value)
                {
                    return Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle.Mutable.From(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator Mutable(Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle.Mutable value)
                {
                    return From(value);
                }
                ...
                public TResult Match<TContext, TResult>(
                    ...
                    Matcher<Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.Mutable, TContext, TResult> defaultMatch)
...
#endif
                {
                    ...
                    {
                        return matchRequiredSrc(Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.Mutable.From(this), context);
                    }
                    ...
                    {
                        return matchRequiredHandle(Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle.Mutable.From(this), context);
                    }
                ...
                public TResult Match<TResult>(
                    ...
                    Matcher<Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.Mutable, TResult> defaultMatch)
                {
                    if (Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchRequiredSrc(Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.Mutable.From(this));
                    }

                    if (Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle.JsonSchema.Evaluate(_parent, _idx))
                    {
                        return matchRequiredHandle(Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle.Mutable.From(this));
                    }
                ...
                public TAccumulator MatchEvery<TAccumulator>(
                    ...
                    Matcher<Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.Mutable, TAccumulator, TAccumulator> defaultMatch)
                {
                    bool matched = false;
                    ...
                    {
                        matched = true;
                        accumulator = matchRequiredSrc(Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.Mutable.From(this), accumulator);
                    }

                    if (Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle.JsonSchema.Evaluate(_parent, _idx))
                    {
                        matched = true;
                        accumulator = matchRequiredHandle(Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle.Mutable.From(this), accumulator);
                    }
                ...
                public bool TryGetAsRequiredSrc(out Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.Mutable result)
                {
                    if (Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.Mutable.From(this);
                        return true;
                    }
                ...
                public bool TryGetAsRequiredHandle(out Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle.Mutable result)
                {
                    if (Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle.JsonSchema.Evaluate(_parent, _idx))
                    {
                        result = Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle.Mutable.From(this);
                        return true;
                    }
                ...
                #endif
            {
                ...
                TContext _context;
                Source _source;
                private readonly Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle.Builder.Build<TContext>? _requiredHandleBuilderInstance;
                private readonly Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.Builder.Build<TContext>? _requiredSrcBuilderInstance;
                ...
                public Source(scoped in TContext context, Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle.Builder.Build<TContext> value) {_context = context; _requiredHandleBuilderInstance = value; _kind = Kind.RequiredHandleBuilder; }

                public Source(scoped in TContext context, Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.Builder.Build<TContext> value) {_context = context; _requiredSrcBuilderInstance = value; _kind = Kind.RequiredSrcBuilder; }
                ...
                internal void AddAsProperty(ReadOnlySpan<byte> utf8Name, ref ComplexValueBuilder valueBuilder, bool escapeName = true, bool nameRequiresUnescaping = false)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.Source:
                            ...
                            break;
                        case Kind.RequiredHandleBuilder:
                            valueBuilder.AddProperty(utf8Name, BuildWithContext.Create(_context, _requiredHandleBuilderInstance!), static (in b, ref o) => Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle.Builder.BuildValue(b.Context, b.Build, ref o), escapeName, nameRequiresUnescaping);
                            break;
                        case Kind.RequiredSrcBuilder:
                            valueBuilder.AddProperty(utf8Name, BuildWithContext.Create(_context, _requiredSrcBuilderInstance!), static (in b, ref o) => Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.Builder.BuildValue(b.Context, b.Build, ref o), escapeName, nameRequiresUnescaping);
                            break;
                        default:
                            Debug.Fail("Unexpected Kind");
                            break;
                ...
                internal void AddAsPrebakedProperty(ReadOnlySpan<byte> prebakedPropertyName, ref ComplexValueBuilder valueBuilder)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.Source:
                            ...
                            break;
                        case Kind.RequiredHandleBuilder:
                            valueBuilder.AddPrebakedProperty(prebakedPropertyName, BuildWithContext.Create(_context, _requiredHandleBuilderInstance!), static (in b, ref o) => Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle.Builder.BuildValue(b.Context, b.Build, ref o));
                            break;
                        case Kind.RequiredSrcBuilder:
                            valueBuilder.AddPrebakedProperty(prebakedPropertyName, BuildWithContext.Create(_context, _requiredSrcBuilderInstance!), static (in b, ref o) => Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.Builder.BuildValue(b.Context, b.Build, ref o));
                            break;
                        default:
                            Debug.Fail("Unexpected Kind");
                            break;
                ...
                internal void AddAsProperty(ReadOnlySpan<char> name, ref ComplexValueBuilder valueBuilder)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.Source:
                            ...
                            break;
                        case Kind.RequiredHandleBuilder:
                            valueBuilder.AddProperty(name, BuildWithContext.Create(_context, _requiredHandleBuilderInstance!), static (in b, ref o) => Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle.Builder.BuildValue(b.Context, b.Build, ref o));
                            break;
                        case Kind.RequiredSrcBuilder:
                            valueBuilder.AddProperty(name, BuildWithContext.Create(_context, _requiredSrcBuilderInstance!), static (in b, ref o) => Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.Builder.BuildValue(b.Context, b.Build, ref o));
                            break;
                        default:
                            Debug.Fail("Unexpected Kind");
                            break;
                ...
                internal void AddAsItem(ref ComplexValueBuilder valueBuilder)
                {
                    switch(_kind)
                    {
                        ...
                        case Kind.Source:
                            ...
                            break;
                        case Kind.RequiredHandleBuilder:
                            valueBuilder.AddItem(BuildWithContext.Create(_context, _requiredHandleBuilderInstance!), static (in b, ref o) => Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle.Builder.BuildValue(b.Context, b.Build, ref o));
                            break;
                        case Kind.RequiredSrcBuilder:
                            valueBuilder.AddItem(BuildWithContext.Create(_context, _requiredSrcBuilderInstance!), static (in b, ref o) => Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.Builder.BuildValue(b.Context, b.Build, ref o));
                            break;
                        default:
                            Debug.Fail("Unexpected Kind");
                            break;
            ...
            public static Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle.Source Build(
                scoped in Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle.Builder.Build buildValue, int initialCapacity = 1)
            {
                return new Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle.Source(buildValue);
            }
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle.Source<TContext> Build<TContext>(
                scoped in TContext context, scoped in Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle.Builder.Build<TContext> buildValue, int initialCapacity = 1)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                return new Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle.Source<TContext>(context, buildValue);
            }
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.Source Build(
                scoped in Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.Builder.Build buildValue, int initialCapacity = 1)
            {
                return new Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.Source(buildValue);
            }
            ...
            /// <param name="initialCapacity">The (optional) estimate of the capacity to reserve for the document.</param>
            /// <returns>The source from which to build the value.</returns>
            public static Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.Source<TContext> Build<TContext>(
                scoped in TContext context, scoped in Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.Builder.Build<TContext> buildValue, int initialCapacity = 1)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                return new Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.Source<TContext>(context, buildValue);
            }
            ...
            /// <returns>An instance of a mutable document initialized with the given value.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(
                JsonWorkspace workspace, scoped in Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
            {
                // Create the document builder without a MetadataDb
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                var source = new Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle.Source(value);
            ...
            /// <returns>An instance of a mutable document initialized with the given value.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(
                JsonWorkspace workspace, scoped in TContext context, scoped in Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                ...
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                var source = new Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle.Source<TContext>(context, value);
                source.AddAsItem(ref cvb);
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            /// <returns>An instance of a mutable document initialized with the given value.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder(
                JsonWorkspace workspace, scoped in Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
            {
                // Create the document builder without a MetadataDb
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                var source = new Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.Source(value);
                source.AddAsItem(ref cvb);
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            /// <returns>An instance of a mutable document initialized with the given value.</returns>
            public static JsonDocumentBuilder<Mutable> CreateBuilder<TContext>(
                JsonWorkspace workspace, scoped in TContext context, scoped in Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
                ...
                JsonDocumentBuilder<Mutable> documentBuilder = workspace.CreateBuilder<Mutable>(-1, initialValueBufferSize);
                ComplexValueBuilder cvb = ComplexValueBuilder.Create(documentBuilder, initialCapacity);
                var source = new Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.Source<TContext>(context, value);
                source.AddAsItem(ref cvb);
                Debug.Assert(cvb.MemberCount == 1);
                ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                return documentBuilder;
            ...
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RoutesEntity> Create(
                scoped in Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent(initialValueBufferSize);
                try
                {
            ...
            /// <param name="initialValueBufferSize">The initial size in bytes of the value buffer.</param>
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RoutesEntity> Create<TContext>(
                scoped in TContext context, scoped in Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
            ...
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RoutesEntity> Create(
                scoped in Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.Builder.Build value, int initialCapacity = 30, int initialValueBufferSize = 8192)
            {
                ParsedJsonDocumentBuilder documentBuilder = ParsedJsonDocumentBuilder.Rent(initialValueBufferSize);
                try
                {
            ...
            /// <returns>A <see cref="ParsedJsonDocument{T}"/> containing the given value. The caller must dispose it.</returns>
            public static ParsedJsonDocument<RoutesEntity> Create<TContext>(
                scoped in TContext context, scoped in Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.Builder.Build<TContext> value, int initialCapacity = 30, int initialValueBufferSize = 8192)
                #if NET9_0_OR_GREATER
                where TContext : allows ref struct
                #endif
            {
