                        ...
                        public readonly partial struct RequiredKeyAndType
                        {
                            ...
                            public readonly partial struct TheNameOfTheElementContainedInTheParticularType
                            {
...
#endif
                                {
                                    ...
                                    public static explicit operator Mutable(TheNameOfTheElementContainedInTheParticularType instance)
                                    {
                                    ...
                                    /// <returns>An immutable instance of a <see cref="TheNameOfTheElementContainedInTheParticularType"/>, initialized from the <see cref="Mutable"/> value.</returns>
                                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                                    public static implicit operator TheNameOfTheElementContainedInTheParticularType(Mutable instance)
                                    {
                                    ...
                                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                                    private string DebuggerDisplay => $"TheNameOfTheElementContainedInTheParticularType.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                                ...
                                public ref struct Source
                                {
                                    ...
                                    public static implicit operator Source(TheNameOfTheElementContainedInTheParticularType instance) => new(JsonElement.From(instance));
                                ...
                                {
                                    return workspace.CreateBuilder<TheNameOfTheElementContainedInTheParticularType, Mutable>(this);
                                }
                                ...
                                public static ParsedJsonDocument<TheNameOfTheElementContainedInTheParticularType> Create(
                                    scoped in Source value, int initialCapacity = 1)
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        Debug.Assert(cvb.MemberCount == 1);
                                        ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                                        return documentBuilder.ToParsedJsonDocument<TheNameOfTheElementContainedInTheParticularType>();
                                    }
                                    finally
                                    {
