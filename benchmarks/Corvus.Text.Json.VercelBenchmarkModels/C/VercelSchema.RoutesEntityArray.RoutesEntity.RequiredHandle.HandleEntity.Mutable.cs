            ...
            public readonly partial struct RequiredHandle
            {
                ...
                public readonly partial struct HandleEntity
                {
...
#endif
                    {
                        ...
                        public static explicit operator Mutable(HandleEntity instance)
                        {
                        ...
                        /// <returns>An immutable instance of a <see cref="HandleEntity"/>, initialized from the <see cref="Mutable"/> value.</returns>
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator HandleEntity(Mutable instance)
                        {
                        ...
                        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                        private string DebuggerDisplay => $"HandleEntity.Mutable: ValueKind = {ValueKind} : \"{ToString()}\"";
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly HandleEntity Clone()
                        {
                            CheckValidInstance();
                        ...
                        /// </para>
                        /// </remarks>
                        public readonly HandleEntity Freeze()
                        {
                            CheckValidInstance();
                            return _parent.FreezeElement<HandleEntity>(_idx);
                        }
                    ...
                    public ref struct Source
                    {
                        ...
                        public static implicit operator Source(HandleEntity instance) => new(JsonElement.From(instance));
                        ...
                        [MethodImpl(MethodImplOptions.AggressiveInlining)]
                        public static implicit operator Source(KnownValues value) => (HandleEntity)value;
                    ...
                    {
                        return workspace.CreateBuilder<HandleEntity, Mutable>(this);
                    }
                    ...
                    public static ParsedJsonDocument<HandleEntity> Create(
                        scoped in Source value, int initialCapacity = 1)
                    {
                        ...
                        try
                        {
                            ...
                            Debug.Assert(cvb.MemberCount == 1);
                            ((IMutableJsonDocument)documentBuilder).SetAndDispose(ref cvb);
                            return documentBuilder.ToParsedJsonDocument<HandleEntity>();
                        }
                        finally
                        {
