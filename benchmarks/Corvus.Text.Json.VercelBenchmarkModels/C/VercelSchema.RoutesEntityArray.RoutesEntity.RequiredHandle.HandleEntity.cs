        ...
        public readonly partial struct RoutesEntity
        {
            ...
            public readonly partial struct RequiredHandle
            {
...
#endif
                {
                    ...
                    /// <summary>
                    /// Initializes a new instance of the <see cref="HandleEntity"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    internal HandleEntity(IJsonDocument parent, int idx)
                    {
                        Debug.Assert(idx >= 0);
                        _parent = parent;
                        _idx = idx;
                    ...
                    /// </summary>
                    public static HandleEntity DefaultInstance { get; }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static explicit operator string(HandleEntity value) => value._parent.GetString(value._idx, JsonTokenType.String) ?? throw new FormatException();
                    ...
                    /// </returns>
                    public static bool operator ==(in HandleEntity left, in HandleEntity right)
                    {
                    ...
                    /// <c>True</c> if the values are equal.
                    /// </returns>
                    public static bool operator ==(in HandleEntity left, in JsonElement right)
                    {
                        return left.Equals(right);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator JsonElement(HandleEntity instance)
                    {
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static implicit operator HandleEntity(JsonElement instance)
                    {
                        return HandleEntity.From(instance);
                    }
                    ...
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static HandleEntity From<T>(in T instance)
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static HandleEntity ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<HandleEntity>(utf8Json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static HandleEntity ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<HandleEntity>(json, options);
                    }
                    ...
                    /// </exception>
                    [MethodImpl(MethodImplOptions.AggressiveInlining)]
                    public static HandleEntity ParseValue(string json, JsonDocumentOptions options = default)
                    {
                        return JsonElementHelpers.ParseValue<HandleEntity>(json, options);
                    }
                    ...
                    /// </exception>
                    public static HandleEntity ParseValue(ref Utf8JsonReader reader)
                    {
                        return JsonElementHelpers.ParseValue<HandleEntity>(ref reader);
                    }
                    ...
                    ///   A value could not be read from the reader.
                    /// </exception>
                    public static bool TryParseValue(ref Utf8JsonReader reader, out HandleEntity? result)
                    {
                        return JsonElementHelpers.TryParseValue<HandleEntity>(ref reader, out result);
                    }
                    ...
                    {
                        return
                            (obj is IJsonElement value && Equals(new HandleEntity(value.ParentDocument, value.ParentDocumentIndex))) ||
...
#if NET
                    static HandleEntity IJsonElement<HandleEntity>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                    private string DebuggerDisplay => $"HandleEntity: ValueKind = {ValueKind} : \"{ToString()}\"";
                    ...
                    /// <summary>
                    /// Gets a <see cref="HandleEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </summary>
                    /// <returns>
                    /// A <see cref="HandleEntity"/> which can be safely stored beyond the lifetime of the
                    /// original document.
                    /// </returns>
                    /// <remarks>
                    /// <para>
                    ...
                    /// </para>
                    /// </remarks>
                    public HandleEntity Clone()
                    {
                        CheckValidInstance();
                        return _parent.CloneElement<HandleEntity>(_idx);
                    }
                    ...
                    /// </summary>
                    /// <returns>
                    /// An immutable <see cref="HandleEntity"/> that lives for the lifetime of its
                    ...
                    /// <param name="matchError">Match 1st item.</param>
                    /// <param name="matchFilesystem">Match 2nd item.</param>
                    /// <param name="matchHit">Match 3rd item.</param>
                    /// <param name="matchMiss">Match 4th item.</param>
                    /// <param name="matchResource">Match 5th item.</param>
                    /// <param name="matchRewrite">Match 6th item.</param>
                    /// <param name="defaultMatch">Match any other value.</param>
                    /// <returns>An instance of the value returned by the match function.</returns>
                    public TResult Match<TContext, TResult>(
                        in TContext context,
                        Func<TContext, TResult> matchError,
                        Func<TContext, TResult> matchFilesystem,
                        Func<TContext, TResult> matchHit,
                        Func<TContext, TResult> matchMiss,
                        Func<TContext, TResult> matchResource,
                        Func<TContext, TResult> matchRewrite,
                    ...
                    public TResult Match<TResult>(
                        ...
                        Func<TResult> matchFilesystem,
                        Func<TResult> matchHit,
                        Func<TResult> matchMiss,
                        Func<TResult> matchResource,
                        Func<TResult> matchRewrite,
