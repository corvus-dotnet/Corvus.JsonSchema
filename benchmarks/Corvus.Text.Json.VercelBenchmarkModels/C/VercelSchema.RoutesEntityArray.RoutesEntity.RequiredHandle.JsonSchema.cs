        ...
        public readonly partial struct RoutesEntity
        {
                ...
                : IJsonElement<RequiredHandle>
            {
                public static partial class JsonSchema
                {
                    ...
                    private static void MatchHandle(IJsonDocument parentDocument, int parentDocumentIndex, int propertyCount, ref JsonSchemaContext context, Span<uint> requiredBitBuffer)
                    {
                    ...
                    /// </summary>
                    public static readonly JsonSchemaPathProvider SchemaLocationProvider = static (buffer, out written) => JsonSchemaEvaluation.TryCopyPath("/properties/routes/items/anyOf/1"u8, buffer, out written);
