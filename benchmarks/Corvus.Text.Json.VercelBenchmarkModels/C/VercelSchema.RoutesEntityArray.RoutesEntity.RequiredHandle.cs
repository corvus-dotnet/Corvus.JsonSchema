    ...
    public readonly partial struct RoutesEntityArray
    {
        ...
        public readonly partial struct RoutesEntity
        {
...
#endif
            {
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="RequiredHandle"/> struct.
                /// </summary>
                /// <param name="value">The value from which to construct the instance.</param>
                internal RequiredHandle(IJsonDocument parent, int idx)
                {
                    Debug.Assert(idx >= 0);
                    _parent = parent;
                    _idx = idx;
                ...
                /// </summary>
                public static RequiredHandle DefaultInstance { get; }
                ...
                /// </para>
                /// </remarks>
                public Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle.HandleEntity Handle
                {
                    get
                    {
                        if (_parent.TryGetNamedPropertyValue(_idx, JsonPropertyNames.HandleUtf8, out Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredHandle.HandleEntity value))
                        {
                            return value;
                        }
                ...
                /// </returns>
                public static bool operator ==(in RequiredHandle left, in RequiredHandle right)
                {
                ...
                /// <c>True</c> if the values are equal.
                /// </returns>
                public static bool operator ==(in RequiredHandle left, in JsonElement right)
                {
                    return left.Equals(right);
                }
                ...
                public static implicit operator JsonElement(RequiredHandle instance)
                {
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static implicit operator RequiredHandle(JsonElement instance)
                {
                    return RequiredHandle.From(instance);
                }
                ...
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredHandle From<T>(in T instance)
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredHandle ParseValue(ReadOnlySpan<byte> utf8Json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RequiredHandle>(utf8Json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredHandle ParseValue(ReadOnlySpan<char> json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RequiredHandle>(json, options);
                }
                ...
                /// </exception>
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                public static RequiredHandle ParseValue(string json, JsonDocumentOptions options = default)
                {
                    return JsonElementHelpers.ParseValue<RequiredHandle>(json, options);
                }
                ...
                /// </exception>
                public static RequiredHandle ParseValue(ref Utf8JsonReader reader)
                {
                    return JsonElementHelpers.ParseValue<RequiredHandle>(ref reader);
                }
                ...
                ///   A value could not be read from the reader.
                /// </exception>
                public static bool TryParseValue(ref Utf8JsonReader reader, out RequiredHandle? result)
                {
                    return JsonElementHelpers.TryParseValue<RequiredHandle>(ref reader, out result);
                }
...
#if NET
                static RequiredHandle IJsonElement<RequiredHandle>.CreateInstance(IJsonDocument parentDocument, int parentDocumentIndex) => new(parentDocument, parentDocumentIndex);
#endif

                [DebuggerBrowsable(DebuggerBrowsableState.Never)]
                private string DebuggerDisplay => $"RequiredHandle: ValueKind = {ValueKind} : \"{ToString()}\"";
                ...
                /// </para>
                /// </remarks>
                public RequiredHandle Freeze()
                {
                    CheckValidInstance();
                    if (_parent is global::Corvus.Text.Json.Internal.IMutableJsonDocument mutable)
                    {
                        return mutable.FreezeElement<RequiredHandle>(_idx);
                    }
                ...
                {
                    /// <summary>
                    /// Gets the JSON property name for <see cref="Handle"/>.
                    /// </summary>
                    ...
                    /// Gets the JSON property name for <see cref="Handle"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> HandleUtf8 => "handle"u8;
                }
                ...
                {
                    /// <summary>
                    /// Gets the escaped UTF-8 JSON property name for <see cref="Handle"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> Handle => "handle"u8;
                }
                ...
                {
                    /// <summary>
                    /// Gets the pre-baked property name blob for <see cref="Handle"/>.
                    /// </summary>
                    public static ReadOnlySpan<byte> Handle => [0x85, 0x00, 0x00, 0x00, 0x22, 0x68, 0x61, 0x6E, 0x64, 0x6C, 0x65, 0x22];
                }
            }
        }
    }
