            ...
            public readonly partial struct RequiredSrc
            {
                ...
                public readonly partial struct HasEntityArray
                {
...
#endif
                    {
                        ...
                        public static explicit operator Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.HasEntityArray.HasEntity.RequiredTypeAndValue(HasEntity value)
                        {
                            return Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.HasEntityArray.HasEntity.RequiredTypeAndValue.From(value);
                        }
                        ...
                        /// </summary>
                        /// <param name="value">The value from which to convert.</param>
                        public static implicit operator HasEntity(Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.HasEntityArray.HasEntity.RequiredTypeAndValue value)
                        {
                            return From(value);
                        }
                        ...
                        /// </summary>
                        /// <param name="value">The value from which to convert.</param>
                        public static explicit operator Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.HasEntityArray.HasEntity.RequiredKeyAndType(HasEntity value)
                        {
                            return Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.HasEntityArray.HasEntity.RequiredKeyAndType.From(value);
                        }
                        ...
                        public bool TryGetAsRequiredTypeAndValue(out Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.HasEntityArray.HasEntity.RequiredTypeAndValue result)
                        {
                            ...
                            {
                                result = Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.HasEntityArray.HasEntity.RequiredTypeAndValue.From(this);
                                return true;
                            }
                        ...
                        public bool TryGetAsRequiredKeyAndType(out Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.HasEntityArray.HasEntity.RequiredKeyAndType result)
                        {
                            ...
                            {
                                result = Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.HasEntityArray.HasEntity.RequiredKeyAndType.From(this);
                                return true;
                            }
                        ...
                        public TResult Match<TContext, TResult>(
                            ...
                            Matcher<Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.HasEntityArray.HasEntity, TContext, TResult> defaultMatch)
...
#endif
                        {
                            if (Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.HasEntityArray.HasEntity.RequiredTypeAndValue.JsonSchema.Evaluate(_parent, _idx))
                            {
                                return matchRequiredTypeAndValue(Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.HasEntityArray.HasEntity.RequiredTypeAndValue.From(this), context);
                            }

                            if (Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.HasEntityArray.HasEntity.RequiredKeyAndType.JsonSchema.Evaluate(_parent, _idx))
                            {
                                return matchRequiredKeyAndType(Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.HasEntityArray.HasEntity.RequiredKeyAndType.From(this), context);
                            }
                        ...
                        public TResult Match<TResult>(
                            ...
                            Matcher<Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.HasEntityArray.HasEntity, TResult> defaultMatch)
                        {
                            if (Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.HasEntityArray.HasEntity.RequiredTypeAndValue.JsonSchema.Evaluate(_parent, _idx))
                            {
                                return matchRequiredTypeAndValue(Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.HasEntityArray.HasEntity.RequiredTypeAndValue.From(this));
                            }

                            if (Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.HasEntityArray.HasEntity.RequiredKeyAndType.JsonSchema.Evaluate(_parent, _idx))
                            {
                                return matchRequiredKeyAndType(Corvus.VercelBenchmark.Current.VercelSchema.RoutesEntityArray.RoutesEntity.RequiredSrc.HasEntityArray.HasEntity.RequiredKeyAndType.From(this));
                            }
